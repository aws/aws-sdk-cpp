...
class GetInstanceSnapshotsResult {
 public:
  ...
  void SetInstanceSnapshots(InstanceSnapshotsT&& value) {
    m_instanceSnapshotsHasBeenSet = true;
    m_instanceSnapshots = std::forward<InstanceSnapshotsT>(value);
  }
  template <typename InstanceSnapshotsT = Aws::Vector<InstanceSnapshot>>
  GetInstanceSnapshotsResult& WithInstanceSnapshots(InstanceSnapshotsT&& value) {
    SetInstanceSnapshots(std::forward<InstanceSnapshotsT>(value));
    return *this;
  }
  ...
  GetInstanceSnapshotsResult& AddInstanceSnapshots(InstanceSnapshotsT&& value) {
    m_instanceSnapshotsHasBeenSet = true;
    m_instanceSnapshots.emplace_back(std::forward<InstanceSnapshotsT>(value));
    return *this;
  }
  ///@}
