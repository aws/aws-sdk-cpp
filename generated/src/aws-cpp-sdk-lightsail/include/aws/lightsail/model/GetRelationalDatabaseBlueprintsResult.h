...
class GetRelationalDatabaseBlueprintsResult {
 public:
  ...
  AWS_LIGHTSAIL_API GetRelationalDatabaseBlueprintsResult& operator=(
  ...
  template <typename BlueprintsT = Aws::Vector<RelationalDatabaseBlueprint>>
  GetRelationalDatabaseBlueprintsResult& WithBlueprints(BlueprintsT&& value) {
    SetBlueprints(std::forward<BlueprintsT>(value));
    return *this;
  }
  template <typename BlueprintsT = RelationalDatabaseBlueprint>
  GetRelationalDatabaseBlueprintsResult& AddBlueprints(BlueprintsT&& value) {
    m_blueprintsHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  GetRelationalDatabaseBlueprintsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRelationalDatabaseBlueprintsResult& WithRequestId(RequestIdT&& value) {
