...
namespace Model
{
  ...
  public:
    ...
    template<typename PortInfoT = PortInfo>
    CloseInstancePublicPortsRequest& WithPortInfo(PortInfoT&& value) { SetPortInfo(std::forward<PortInfoT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceNameT = Aws::String>
    CloseInstancePublicPortsRequest& WithInstanceName(InstanceNameT&& value) { SetInstanceName(std::forward<InstanceNameT>(value)); return *this;}
    ///@}
  private:
