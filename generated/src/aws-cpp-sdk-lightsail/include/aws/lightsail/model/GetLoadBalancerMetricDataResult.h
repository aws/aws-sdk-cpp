...
class GetLoadBalancerMetricDataResult {
 public:
  ...
  inline GetLoadBalancerMetricDataResult& WithMetricName(LoadBalancerMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricDataT = Aws::Vector<MetricDatapoint>>
  GetLoadBalancerMetricDataResult& WithMetricData(MetricDataT&& value) {
    SetMetricData(std::forward<MetricDataT>(value));
    return *this;
  }
  template <typename MetricDataT = MetricDatapoint>
  GetLoadBalancerMetricDataResult& AddMetricData(MetricDataT&& value) {
    m_metricDataHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetLoadBalancerMetricDataResult& WithRequestId(RequestIdT&& value) {
