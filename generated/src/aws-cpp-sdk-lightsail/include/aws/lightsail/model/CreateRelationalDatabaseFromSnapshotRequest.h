...
class CreateRelationalDatabaseFromSnapshotRequest : public LightsailRequest {
 public:
  ...
  inline CreateRelationalDatabaseFromSnapshotRequest& WithPubliclyAccessible(bool value) {
  ...
  void SetSourceRelationalDatabaseName(SourceRelationalDatabaseNameT&& value) {
    m_sourceRelationalDatabaseNameHasBeenSet = true;
    m_sourceRelationalDatabaseName = std::forward<SourceRelationalDatabaseNameT>(value);
  }
  template <typename SourceRelationalDatabaseNameT = Aws::String>
  CreateRelationalDatabaseFromSnapshotRequest& WithSourceRelationalDatabaseName(SourceRelationalDatabaseNameT&& value) {
    SetSourceRelationalDatabaseName(std::forward<SourceRelationalDatabaseNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateRelationalDatabaseFromSnapshotRequest& WithUseLatestRestorableTime(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRelationalDatabaseFromSnapshotRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRelationalDatabaseFromSnapshotRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
