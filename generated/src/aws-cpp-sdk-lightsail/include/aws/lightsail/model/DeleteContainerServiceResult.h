...
namespace Model
{
  ...
  public:
    ...
    inline DeleteContainerServiceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteContainerServiceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteContainerServiceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
