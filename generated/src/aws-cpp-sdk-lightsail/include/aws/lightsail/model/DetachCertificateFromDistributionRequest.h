...
class DetachCertificateFromDistributionRequest : public LightsailRequest {
 public:
  AWS_LIGHTSAIL_API DetachCertificateFromDistributionRequest() = default;
  ...
  template <typename DistributionNameT = Aws::String>
  DetachCertificateFromDistributionRequest& WithDistributionName(DistributionNameT&& value) {
