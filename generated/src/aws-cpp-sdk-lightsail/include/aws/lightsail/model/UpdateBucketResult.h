...
class UpdateBucketResult {
 public:
  ...
  template <typename BucketT = Bucket>
  UpdateBucketResult& WithBucket(BucketT&& value) {
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  UpdateBucketResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  UpdateBucketResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBucketResult& WithRequestId(RequestIdT&& value) {
