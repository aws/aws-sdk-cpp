...
class CreateRelationalDatabaseResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateRelationalDatabaseResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateRelationalDatabaseResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateRelationalDatabaseResult& WithRequestId(RequestIdT&& value) {
