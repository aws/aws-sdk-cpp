...
class GetBucketMetricDataResult {
 public:
  ...
  inline GetBucketMetricDataResult& WithMetricName(BucketMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricDataT = Aws::Vector<MetricDatapoint>>
  GetBucketMetricDataResult& WithMetricData(MetricDataT&& value) {
    SetMetricData(std::forward<MetricDataT>(value));
    return *this;
  }
  template <typename MetricDataT = MetricDatapoint>
  GetBucketMetricDataResult& AddMetricData(MetricDataT&& value) {
    m_metricDataHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetBucketMetricDataResult& WithRequestId(RequestIdT&& value) {
