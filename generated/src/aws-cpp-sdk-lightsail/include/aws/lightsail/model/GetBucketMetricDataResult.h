...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetBucketMetricDataResult() = default;
    ...
    inline GetBucketMetricDataResult& WithMetricName(BucketMetricName value) { SetMetricName(value); return *this;}
    ///@}
    ...
    template<typename MetricDataT = Aws::Vector<MetricDatapoint>>
    GetBucketMetricDataResult& WithMetricData(MetricDataT&& value) { SetMetricData(std::forward<MetricDataT>(value)); return *this;}
    template<typename MetricDataT = MetricDatapoint>
    GetBucketMetricDataResult& AddMetricData(MetricDataT&& value) { m_metricDataHasBeenSet = true; m_metricData.emplace_back(std::forward<MetricDataT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetBucketMetricDataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
