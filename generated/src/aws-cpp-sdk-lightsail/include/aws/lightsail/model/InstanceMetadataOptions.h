...
class InstanceMetadataOptions {
 public:
  ...
  inline void SetState(InstanceMetadataState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InstanceMetadataOptions& WithState(InstanceMetadataState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataOptions& WithHttpTokens(HttpTokens value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataOptions& WithHttpEndpoint(HttpEndpoint value) {
  ...
  inline InstanceMetadataOptions& WithHttpProtocolIpv6(HttpProtocolIpv6 value) {
