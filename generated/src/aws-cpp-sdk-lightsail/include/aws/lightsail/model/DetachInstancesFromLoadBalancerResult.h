...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DetachInstancesFromLoadBalancerResult();
    ...
    inline DetachInstancesFromLoadBalancerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DetachInstancesFromLoadBalancerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DetachInstancesFromLoadBalancerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
