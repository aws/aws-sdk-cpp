...
class DetachInstancesFromLoadBalancerResult {
 public:
  ...
  AWS_LIGHTSAIL_API DetachInstancesFromLoadBalancerResult& operator=(
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DetachInstancesFromLoadBalancerResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DetachInstancesFromLoadBalancerResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DetachInstancesFromLoadBalancerResult& WithRequestId(RequestIdT&& value) {
