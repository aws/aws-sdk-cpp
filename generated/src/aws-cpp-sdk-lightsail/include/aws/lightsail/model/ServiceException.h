...
namespace Model
{
  ...
  /**
   * <p>A general service exception.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/ServiceException">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline ServiceException& WithCode(const Aws::String& value) { SetCode(value); return *this;}
    inline ServiceException& WithCode(Aws::String&& value) { SetCode(std::move(value)); return *this;}
    inline ServiceException& WithCode(const char* value) { SetCode(value); return *this;}
    ///@}
    ...
    inline ServiceException& WithDocs(const Aws::String& value) { SetDocs(value); return *this;}
    inline ServiceException& WithDocs(Aws::String&& value) { SetDocs(std::move(value)); return *this;}
    inline ServiceException& WithDocs(const char* value) { SetDocs(value); return *this;}
    ///@}
    ...
    inline ServiceException& WithTip(const Aws::String& value) { SetTip(value); return *this;}
    inline ServiceException& WithTip(Aws::String&& value) { SetTip(std::move(value)); return *this;}
    inline ServiceException& WithTip(const char* value) { SetTip(value); return *this;}
    ///@}
  private:
