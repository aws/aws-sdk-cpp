...
namespace Model
{
  ...
  public:
    ...
    inline DetachStaticIpResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DetachStaticIpResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DetachStaticIpResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
