...
namespace Model
{
  ...
  /**
   */
  class GetCloudFormationStackRecordsRequest : public LightsailRequest
  {
  public:
    AWS_LIGHTSAIL_API GetCloudFormationStackRecordsRequest() = default;
    ...
    template<typename PageTokenT = Aws::String>
    GetCloudFormationStackRecordsRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
  private:
