...
class DeleteInstanceRequest : public LightsailRequest {
 public:
  ...
  template <typename InstanceNameT = Aws::String>
  DeleteInstanceRequest& WithInstanceName(InstanceNameT&& value) {
  ...
  inline void SetForceDeleteAddOns(bool value) {
    m_forceDeleteAddOnsHasBeenSet = true;
    m_forceDeleteAddOns = value;
  }
  inline DeleteInstanceRequest& WithForceDeleteAddOns(bool value) {
    SetForceDeleteAddOns(value);
    return *this;
  }
  ///@}
 private:
