...
class SendContactMethodVerificationResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  SendContactMethodVerificationResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  SendContactMethodVerificationResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  SendContactMethodVerificationResult& WithRequestId(RequestIdT&& value) {
