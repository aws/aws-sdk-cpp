...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API SendContactMethodVerificationResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    SendContactMethodVerificationResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    SendContactMethodVerificationResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SendContactMethodVerificationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
