...
class CookieObject {
 public:
  ...
  inline CookieObject& WithOption(ForwardValues value) {
    SetOption(value);
    return *this;
  }
  ///@}
  ...
  void SetCookiesAllowList(CookiesAllowListT&& value) {
    ...
    m_cookiesAllowList = std::forward<CookiesAllowListT>(value);
  }
  template <typename CookiesAllowListT = Aws::Vector<Aws::String>>
  CookieObject& WithCookiesAllowList(CookiesAllowListT&& value) {
    SetCookiesAllowList(std::forward<CookiesAllowListT>(value));
    return *this;
  }
  template <typename CookiesAllowListT = Aws::String>
  CookieObject& AddCookiesAllowList(CookiesAllowListT&& value) {
    m_cookiesAllowListHasBeenSet = true;
    m_cookiesAllowList.emplace_back(std::forward<CookiesAllowListT>(value));
    return *this;
  }
  ///@}
 private:
