...
class DeleteBucketAccessKeyResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteBucketAccessKeyResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteBucketAccessKeyResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBucketAccessKeyResult& WithRequestId(RequestIdT&& value) {
