...
class UpdateLoadBalancerAttributeResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  UpdateLoadBalancerAttributeResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  UpdateLoadBalancerAttributeResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateLoadBalancerAttributeResult& WithRequestId(RequestIdT&& value) {
