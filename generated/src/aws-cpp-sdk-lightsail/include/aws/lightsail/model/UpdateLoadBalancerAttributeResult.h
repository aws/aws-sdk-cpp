...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API UpdateLoadBalancerAttributeResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    UpdateLoadBalancerAttributeResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    UpdateLoadBalancerAttributeResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLoadBalancerAttributeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
