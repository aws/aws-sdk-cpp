...
class DeleteContactMethodResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteContactMethodResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteContactMethodResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteContactMethodResult& WithRequestId(RequestIdT&& value) {
