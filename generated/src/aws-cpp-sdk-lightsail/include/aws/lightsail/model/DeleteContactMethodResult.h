...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteContactMethodResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    DeleteContactMethodResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    DeleteContactMethodResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteContactMethodResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
