...
class RelationalDatabaseParameter {
 public:
  ...
  void SetApplyMethod(ApplyMethodT&& value) {
    ...
    m_applyMethod = std::forward<ApplyMethodT>(value);
  }
  template <typename ApplyMethodT = Aws::String>
  RelationalDatabaseParameter& WithApplyMethod(ApplyMethodT&& value) {
    SetApplyMethod(std::forward<ApplyMethodT>(value));
    return *this;
  }
  ///@}
  ...
  inline RelationalDatabaseParameter& WithIsModifiable(bool value) {
