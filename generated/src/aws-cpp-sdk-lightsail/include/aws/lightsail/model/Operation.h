...
class Operation {
 public:
  ...
  inline Operation& WithResourceType(ResourceType value) {
  ...
  inline Operation& WithIsTerminal(bool value) {
    SetIsTerminal(value);
    return *this;
  }
  ///@}
  ...
  inline Operation& WithOperationType(OperationType value) {
  ...
  void SetStatusChangedAt(StatusChangedAtT&& value) {
    ...
    m_statusChangedAt = std::forward<StatusChangedAtT>(value);
  }
  template <typename StatusChangedAtT = Aws::Utils::DateTime>
  Operation& WithStatusChangedAt(StatusChangedAtT&& value) {
    SetStatusChangedAt(std::forward<StatusChangedAtT>(value));
    return *this;
  }
  ///@}
