...
class GetDistributionMetricDataRequest : public LightsailRequest {
 public:
  ...
  inline GetDistributionMetricDataRequest& WithMetricName(DistributionMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline GetDistributionMetricDataRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline GetDistributionMetricDataRequest& WithUnit(MetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline GetDistributionMetricDataRequest& AddStatistics(MetricStatistic value) {
    m_statisticsHasBeenSet = true;
