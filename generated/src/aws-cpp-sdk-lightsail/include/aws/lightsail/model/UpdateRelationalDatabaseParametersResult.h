...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API UpdateRelationalDatabaseParametersResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    UpdateRelationalDatabaseParametersResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    UpdateRelationalDatabaseParametersResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRelationalDatabaseParametersResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
