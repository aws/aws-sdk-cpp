...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API CreateDiskResult();
    ...
    inline CreateDiskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDiskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDiskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
