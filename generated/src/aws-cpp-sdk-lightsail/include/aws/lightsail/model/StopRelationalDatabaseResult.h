...
class StopRelationalDatabaseResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  StopRelationalDatabaseResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  StopRelationalDatabaseResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StopRelationalDatabaseResult& WithRequestId(RequestIdT&& value) {
