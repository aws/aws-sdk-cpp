...
/**
 * <p>Describes ports to open on an instance, the IP addresses allowed to connect
 * to the instance through the ports, and the protocol.</p><p><h3>See Also:</h3>
 * <a
...
class PortInfo {
 public:
  ...
  inline PortInfo& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline PortInfo& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  inline PortInfo& WithProtocol(NetworkProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
   ...
   * allowed to connect to an instance.</p>  <p>Examples:</p> <ul> <li> <p>To
   * allow the IP address <code>192.0.2.44</code>, specify <code>192.0.2.44</code> or
   * <code>192.0.2.44/32</code>. </p> </li> <li> <p>To allow the IP addresses
   * <code>192.0.2.0</code> to <code>192.0.2.255</code>, specify
   * <code>192.0.2.0/24</code>.</p> </li> </ul> <p>For more information about CIDR
   * block notation, see <a
