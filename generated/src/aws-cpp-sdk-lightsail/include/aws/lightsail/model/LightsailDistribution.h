...
class LightsailDistribution {
 public:
  ...
  inline LightsailDistribution& WithResourceType(ResourceType value) {
  ...
  void SetAlternativeDomainNames(AlternativeDomainNamesT&& value) {
    ...
    m_alternativeDomainNames = std::forward<AlternativeDomainNamesT>(value);
  }
  template <typename AlternativeDomainNamesT = Aws::Vector<Aws::String>>
  LightsailDistribution& WithAlternativeDomainNames(AlternativeDomainNamesT&& value) {
    SetAlternativeDomainNames(std::forward<AlternativeDomainNamesT>(value));
    return *this;
  }
  ...
  LightsailDistribution& AddAlternativeDomainNames(AlternativeDomainNamesT&& value) {
    m_alternativeDomainNamesHasBeenSet = true;
    m_alternativeDomainNames.emplace_back(std::forward<AlternativeDomainNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline LightsailDistribution& WithIsEnabled(bool value) {
    SetIsEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetOriginPublicDNS(OriginPublicDNST&& value) {
    ...
    m_originPublicDNS = std::forward<OriginPublicDNST>(value);
  }
  template <typename OriginPublicDNST = Aws::String>
  LightsailDistribution& WithOriginPublicDNS(OriginPublicDNST&& value) {
    SetOriginPublicDNS(std::forward<OriginPublicDNST>(value));
    return *this;
  }
  ///@}
  ...
  inline LightsailDistribution& WithAbleToUpdateBundle(bool value) {
  ...
  inline LightsailDistribution& WithIpAddressType(IpAddressType value) {
  ...
  void SetViewerMinimumTlsProtocolVersion(ViewerMinimumTlsProtocolVersionT&& value) {
    ...
    m_viewerMinimumTlsProtocolVersion = std::forward<ViewerMinimumTlsProtocolVersionT>(value);
  }
  template <typename ViewerMinimumTlsProtocolVersionT = Aws::String>
  LightsailDistribution& WithViewerMinimumTlsProtocolVersion(ViewerMinimumTlsProtocolVersionT&& value) {
    SetViewerMinimumTlsProtocolVersion(std::forward<ViewerMinimumTlsProtocolVersionT>(value));
    return *this;
  }
  ///@}
 private:
