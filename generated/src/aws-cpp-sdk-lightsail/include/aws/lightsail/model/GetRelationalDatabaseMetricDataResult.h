...
class GetRelationalDatabaseMetricDataResult {
 public:
  ...
  AWS_LIGHTSAIL_API GetRelationalDatabaseMetricDataResult& operator=(
  ...
  inline void SetMetricName(RelationalDatabaseMetricName value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline GetRelationalDatabaseMetricDataResult& WithMetricName(RelationalDatabaseMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricDataT = Aws::Vector<MetricDatapoint>>
  GetRelationalDatabaseMetricDataResult& WithMetricData(MetricDataT&& value) {
    SetMetricData(std::forward<MetricDataT>(value));
    return *this;
  }
  template <typename MetricDataT = MetricDatapoint>
  GetRelationalDatabaseMetricDataResult& AddMetricData(MetricDataT&& value) {
    m_metricDataHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetRelationalDatabaseMetricDataResult& WithRequestId(RequestIdT&& value) {
