...
class CreateContactMethodResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateContactMethodResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateContactMethodResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateContactMethodResult& WithRequestId(RequestIdT&& value) {
