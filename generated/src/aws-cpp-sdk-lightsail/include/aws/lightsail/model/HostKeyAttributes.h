...
class HostKeyAttributes {
 public:
  ...
  void SetAlgorithm(AlgorithmT&& value) {
    ...
    m_algorithm = std::forward<AlgorithmT>(value);
  }
  template <typename AlgorithmT = Aws::String>
  HostKeyAttributes& WithAlgorithm(AlgorithmT&& value) {
    SetAlgorithm(std::forward<AlgorithmT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWitnessedAt(WitnessedAtT&& value) {
    ...
    m_witnessedAt = std::forward<WitnessedAtT>(value);
  }
  template <typename WitnessedAtT = Aws::Utils::DateTime>
  HostKeyAttributes& WithWitnessedAt(WitnessedAtT&& value) {
    SetWitnessedAt(std::forward<WitnessedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFingerprintSHA1(FingerprintSHA1T&& value) {
    ...
    m_fingerprintSHA1 = std::forward<FingerprintSHA1T>(value);
  }
  template <typename FingerprintSHA1T = Aws::String>
  HostKeyAttributes& WithFingerprintSHA1(FingerprintSHA1T&& value) {
    SetFingerprintSHA1(std::forward<FingerprintSHA1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetFingerprintSHA256(FingerprintSHA256T&& value) {
    ...
    m_fingerprintSHA256 = std::forward<FingerprintSHA256T>(value);
  }
  template <typename FingerprintSHA256T = Aws::String>
  HostKeyAttributes& WithFingerprintSHA256(FingerprintSHA256T&& value) {
    SetFingerprintSHA256(std::forward<FingerprintSHA256T>(value));
    return *this;
  }
  ///@}
