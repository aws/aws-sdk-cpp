...
class GetDistributionLatestCacheResetResult {
 public:
  ...
  AWS_LIGHTSAIL_API GetDistributionLatestCacheResetResult& operator=(
  ...
  template <typename StatusT = Aws::String>
  GetDistributionLatestCacheResetResult& WithStatus(StatusT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  GetDistributionLatestCacheResetResult& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDistributionLatestCacheResetResult& WithRequestId(RequestIdT&& value) {
