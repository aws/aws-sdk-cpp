...
class ExportSnapshotRecordSourceInfo {
 public:
  ...
  inline void SetResourceType(ExportSnapshotRecordSourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ExportSnapshotRecordSourceInfo& WithResourceType(ExportSnapshotRecordSourceType value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ExportSnapshotRecordSourceInfo& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename NameT = Aws::String>
  ExportSnapshotRecordSourceInfo& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ExportSnapshotRecordSourceInfo& WithArn(ArnT&& value) {
  ...
  void SetFromResourceName(FromResourceNameT&& value) {
    m_fromResourceNameHasBeenSet = true;
    m_fromResourceName = std::forward<FromResourceNameT>(value);
  }
  template <typename FromResourceNameT = Aws::String>
  ExportSnapshotRecordSourceInfo& WithFromResourceName(FromResourceNameT&& value) {
    SetFromResourceName(std::forward<FromResourceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromResourceArn(FromResourceArnT&& value) {
    m_fromResourceArnHasBeenSet = true;
    m_fromResourceArn = std::forward<FromResourceArnT>(value);
  }
  template <typename FromResourceArnT = Aws::String>
  ExportSnapshotRecordSourceInfo& WithFromResourceArn(FromResourceArnT&& value) {
    SetFromResourceArn(std::forward<FromResourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceSnapshotInfo(InstanceSnapshotInfoT&& value) {
    m_instanceSnapshotInfoHasBeenSet = true;
    m_instanceSnapshotInfo = std::forward<InstanceSnapshotInfoT>(value);
  }
  template <typename InstanceSnapshotInfoT = InstanceSnapshotInfo>
  ExportSnapshotRecordSourceInfo& WithInstanceSnapshotInfo(InstanceSnapshotInfoT&& value) {
    SetInstanceSnapshotInfo(std::forward<InstanceSnapshotInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiskSnapshotInfo(DiskSnapshotInfoT&& value) {
    m_diskSnapshotInfoHasBeenSet = true;
    m_diskSnapshotInfo = std::forward<DiskSnapshotInfoT>(value);
  }
  template <typename DiskSnapshotInfoT = DiskSnapshotInfo>
  ExportSnapshotRecordSourceInfo& WithDiskSnapshotInfo(DiskSnapshotInfoT&& value) {
    SetDiskSnapshotInfo(std::forward<DiskSnapshotInfoT>(value));
    return *this;
  }
  ///@}
 private:
