...
class Certificate {
 public:
  ...
  void SetRequestFailureReason(RequestFailureReasonT&& value) {
    ...
    m_requestFailureReason = std::forward<RequestFailureReasonT>(value);
  }
  template <typename RequestFailureReasonT = Aws::String>
  Certificate& WithRequestFailureReason(RequestFailureReasonT&& value) {
    SetRequestFailureReason(std::forward<RequestFailureReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInUseResourceCount(int value) {
    m_inUseResourceCountHasBeenSet = true;
    m_inUseResourceCount = value;
  }
  inline Certificate& WithInUseResourceCount(int value) {
    SetInUseResourceCount(value);
    return *this;
  }
  ///@}
  ...
  void SetIssuerCA(IssuerCAT&& value) {
    ...
    m_issuerCA = std::forward<IssuerCAT>(value);
  }
  template <typename IssuerCAT = Aws::String>
  Certificate& WithIssuerCA(IssuerCAT&& value) {
    SetIssuerCA(std::forward<IssuerCAT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEligibleToRenew(EligibleToRenewT&& value) {
    ...
    m_eligibleToRenew = std::forward<EligibleToRenewT>(value);
  }
  template <typename EligibleToRenewT = Aws::String>
  Certificate& WithEligibleToRenew(EligibleToRenewT&& value) {
    SetEligibleToRenew(std::forward<EligibleToRenewT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRevocationReason(RevocationReasonT&& value) {
    ...
    m_revocationReason = std::forward<RevocationReasonT>(value);
  }
  template <typename RevocationReasonT = Aws::String>
  Certificate& WithRevocationReason(RevocationReasonT&& value) {
    SetRevocationReason(std::forward<RevocationReasonT>(value));
    return *this;
  }
  ///@}
