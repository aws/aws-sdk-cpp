...
class ContainerServicePower {
 public:
  ...
  inline ContainerServicePower& WithPrice(double value) {
    SetPrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCpuCount(double value) {
    m_cpuCountHasBeenSet = true;
    m_cpuCount = value;
  }
  inline ContainerServicePower& WithCpuCount(double value) {
    SetCpuCount(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerServicePower& WithRamSizeInGb(double value) {
  ...
  inline ContainerServicePower& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
