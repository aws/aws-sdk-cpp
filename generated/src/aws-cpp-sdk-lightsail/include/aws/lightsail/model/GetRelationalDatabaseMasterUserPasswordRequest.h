...
class GetRelationalDatabaseMasterUserPasswordRequest : public LightsailRequest {
 public:
  ...
  template <typename RelationalDatabaseNameT = Aws::String>
  GetRelationalDatabaseMasterUserPasswordRequest& WithRelationalDatabaseName(RelationalDatabaseNameT&& value) {
  ...
  inline void SetPasswordVersion(RelationalDatabasePasswordVersion value) {
    m_passwordVersionHasBeenSet = true;
    m_passwordVersion = value;
  }
  inline GetRelationalDatabaseMasterUserPasswordRequest& WithPasswordVersion(RelationalDatabasePasswordVersion value) {
    SetPasswordVersion(value);
    return *this;
  }
  ///@}
 private:
