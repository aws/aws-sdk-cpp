...
class RelationalDatabase {
 public:
  ...
  inline RelationalDatabase& WithResourceType(ResourceType value) {
  ...
  void SetRelationalDatabaseBlueprintId(RelationalDatabaseBlueprintIdT&& value) {
    ...
    m_relationalDatabaseBlueprintId = std::forward<RelationalDatabaseBlueprintIdT>(value);
  }
  template <typename RelationalDatabaseBlueprintIdT = Aws::String>
  RelationalDatabase& WithRelationalDatabaseBlueprintId(RelationalDatabaseBlueprintIdT&& value) {
    SetRelationalDatabaseBlueprintId(std::forward<RelationalDatabaseBlueprintIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelationalDatabaseBundleId(RelationalDatabaseBundleIdT&& value) {
    ...
    m_relationalDatabaseBundleId = std::forward<RelationalDatabaseBundleIdT>(value);
  }
  template <typename RelationalDatabaseBundleIdT = Aws::String>
  RelationalDatabase& WithRelationalDatabaseBundleId(RelationalDatabaseBundleIdT&& value) {
    SetRelationalDatabaseBundleId(std::forward<RelationalDatabaseBundleIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterDatabaseName(MasterDatabaseNameT&& value) {
    ...
    m_masterDatabaseName = std::forward<MasterDatabaseNameT>(value);
  }
  template <typename MasterDatabaseNameT = Aws::String>
  RelationalDatabase& WithMasterDatabaseName(MasterDatabaseNameT&& value) {
    SetMasterDatabaseName(std::forward<MasterDatabaseNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHardware(HardwareT&& value) {
    ...
    m_hardware = std::forward<HardwareT>(value);
  }
  template <typename HardwareT = RelationalDatabaseHardware>
  RelationalDatabase& WithHardware(HardwareT&& value) {
    SetHardware(std::forward<HardwareT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBackupRetentionEnabled(bool value) {
    m_backupRetentionEnabledHasBeenSet = true;
    m_backupRetentionEnabled = value;
  }
  inline RelationalDatabase& WithBackupRetentionEnabled(bool value) {
    SetBackupRetentionEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline RelationalDatabase& WithPubliclyAccessible(bool value) {
  ...
  void SetMasterEndpoint(MasterEndpointT&& value) {
    ...
    m_masterEndpoint = std::forward<MasterEndpointT>(value);
  }
  template <typename MasterEndpointT = RelationalDatabaseEndpoint>
  RelationalDatabase& WithMasterEndpoint(MasterEndpointT&& value) {
    SetMasterEndpoint(std::forward<MasterEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingMaintenanceActions(PendingMaintenanceActionsT&& value) {
    ...
    m_pendingMaintenanceActions = std::forward<PendingMaintenanceActionsT>(value);
  }
  template <typename PendingMaintenanceActionsT = Aws::Vector<PendingMaintenanceAction>>
  RelationalDatabase& WithPendingMaintenanceActions(PendingMaintenanceActionsT&& value) {
    SetPendingMaintenanceActions(std::forward<PendingMaintenanceActionsT>(value));
    return *this;
  }
  ...
  RelationalDatabase& AddPendingMaintenanceActions(PendingMaintenanceActionsT&& value) {
    m_pendingMaintenanceActionsHasBeenSet = true;
    m_pendingMaintenanceActions.emplace_back(std::forward<PendingMaintenanceActionsT>(value));
    return *this;
  }
  ///@}
