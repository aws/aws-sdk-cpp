...
class UpdateRelationalDatabaseResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  UpdateRelationalDatabaseResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  UpdateRelationalDatabaseResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateRelationalDatabaseResult& WithRequestId(RequestIdT&& value) {
