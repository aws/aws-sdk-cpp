...
class GetBundlesRequest : public LightsailRequest {
 public:
  ...
  inline void SetIncludeInactive(bool value) {
    m_includeInactiveHasBeenSet = true;
    m_includeInactive = value;
  }
  inline GetBundlesRequest& WithIncludeInactive(bool value) {
  ...
  inline void SetAppCategory(AppCategory value) {
    m_appCategoryHasBeenSet = true;
    m_appCategory = value;
  }
  inline GetBundlesRequest& WithAppCategory(AppCategory value) {
