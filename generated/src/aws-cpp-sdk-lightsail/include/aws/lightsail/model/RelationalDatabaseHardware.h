...
class RelationalDatabaseHardware {
 public:
  ...
  inline RelationalDatabaseHardware& WithCpuCount(int value) {
    SetCpuCount(value);
    return *this;
  }
  ///@}
  ...
  inline RelationalDatabaseHardware& WithDiskSizeInGb(int value) {
  ...
  inline RelationalDatabaseHardware& WithRamSizeInGb(double value) {
