...
class PutAlarmRequest : public LightsailRequest {
 public:
  ...
  inline PutAlarmRequest& WithMetricName(MetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  void SetMonitoredResourceName(MonitoredResourceNameT&& value) {
    ...
    m_monitoredResourceName = std::forward<MonitoredResourceNameT>(value);
  }
  template <typename MonitoredResourceNameT = Aws::String>
  PutAlarmRequest& WithMonitoredResourceName(MonitoredResourceNameT&& value) {
    SetMonitoredResourceName(std::forward<MonitoredResourceNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline PutAlarmRequest& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline PutAlarmRequest& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline PutAlarmRequest& WithEvaluationPeriods(int value) {
  ...
  inline PutAlarmRequest& WithDatapointsToAlarm(int value) {
  ...
  inline PutAlarmRequest& WithTreatMissingData(TreatMissingData value) {
  ...
  inline PutAlarmRequest& AddContactProtocols(ContactProtocol value) {
    m_contactProtocolsHasBeenSet = true;
  ...
  inline PutAlarmRequest& AddNotificationTriggers(AlarmState value) {
    m_notificationTriggersHasBeenSet = true;
  ...
  inline PutAlarmRequest& WithNotificationEnabled(bool value) {
