...
class DeleteInstanceSnapshotResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteInstanceSnapshotResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteInstanceSnapshotResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteInstanceSnapshotResult& WithRequestId(RequestIdT&& value) {
