...
class DeleteLoadBalancerTlsCertificateResult {
 public:
  ...
  AWS_LIGHTSAIL_API DeleteLoadBalancerTlsCertificateResult& operator=(
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteLoadBalancerTlsCertificateResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteLoadBalancerTlsCertificateResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteLoadBalancerTlsCertificateResult& WithRequestId(RequestIdT&& value) {
