...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteLoadBalancerTlsCertificateResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    DeleteLoadBalancerTlsCertificateResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    DeleteLoadBalancerTlsCertificateResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteLoadBalancerTlsCertificateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
