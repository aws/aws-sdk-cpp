...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetInstanceMetricDataResult() = default;
    ...
    template<typename MetricDataT = Aws::Vector<MetricDatapoint>>
    GetInstanceMetricDataResult& WithMetricData(MetricDataT&& value) { SetMetricData(std::forward<MetricDataT>(value)); return *this;}
    template<typename MetricDataT = MetricDatapoint>
    GetInstanceMetricDataResult& AddMetricData(MetricDataT&& value) { m_metricDataHasBeenSet = true; m_metricData.emplace_back(std::forward<MetricDataT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetInstanceMetricDataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
