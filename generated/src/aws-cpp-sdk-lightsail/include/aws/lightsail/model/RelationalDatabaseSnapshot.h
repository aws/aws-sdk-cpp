...
class RelationalDatabaseSnapshot {
 public:
  ...
  inline RelationalDatabaseSnapshot& WithResourceType(ResourceType value) {
  ...
  inline RelationalDatabaseSnapshot& WithSizeInGb(int value) {
    SetSizeInGb(value);
    return *this;
  }
  ///@}
  ...
  void SetFromRelationalDatabaseName(FromRelationalDatabaseNameT&& value) {
    ...
    m_fromRelationalDatabaseName = std::forward<FromRelationalDatabaseNameT>(value);
  }
  template <typename FromRelationalDatabaseNameT = Aws::String>
  RelationalDatabaseSnapshot& WithFromRelationalDatabaseName(FromRelationalDatabaseNameT&& value) {
    SetFromRelationalDatabaseName(std::forward<FromRelationalDatabaseNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromRelationalDatabaseArn(FromRelationalDatabaseArnT&& value) {
    ...
    m_fromRelationalDatabaseArn = std::forward<FromRelationalDatabaseArnT>(value);
  }
  template <typename FromRelationalDatabaseArnT = Aws::String>
  RelationalDatabaseSnapshot& WithFromRelationalDatabaseArn(FromRelationalDatabaseArnT&& value) {
    SetFromRelationalDatabaseArn(std::forward<FromRelationalDatabaseArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromRelationalDatabaseBundleId(FromRelationalDatabaseBundleIdT&& value) {
    ...
    m_fromRelationalDatabaseBundleId = std::forward<FromRelationalDatabaseBundleIdT>(value);
  }
  template <typename FromRelationalDatabaseBundleIdT = Aws::String>
  RelationalDatabaseSnapshot& WithFromRelationalDatabaseBundleId(FromRelationalDatabaseBundleIdT&& value) {
    SetFromRelationalDatabaseBundleId(std::forward<FromRelationalDatabaseBundleIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromRelationalDatabaseBlueprintId(FromRelationalDatabaseBlueprintIdT&& value) {
    ...
    m_fromRelationalDatabaseBlueprintId = std::forward<FromRelationalDatabaseBlueprintIdT>(value);
  }
  template <typename FromRelationalDatabaseBlueprintIdT = Aws::String>
  RelationalDatabaseSnapshot& WithFromRelationalDatabaseBlueprintId(FromRelationalDatabaseBlueprintIdT&& value) {
    SetFromRelationalDatabaseBlueprintId(std::forward<FromRelationalDatabaseBlueprintIdT>(value));
    return *this;
  }
  ///@}
 private:
