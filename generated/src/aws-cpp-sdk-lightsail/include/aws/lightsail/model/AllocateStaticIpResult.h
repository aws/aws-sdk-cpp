...
class AllocateStaticIpResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  AllocateStaticIpResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  AllocateStaticIpResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AllocateStaticIpResult& WithRequestId(RequestIdT&& value) {
