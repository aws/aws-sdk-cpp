...
namespace Model
{
  ...
  public:
    ...
    inline DeleteBucketResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteBucketResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteBucketResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
