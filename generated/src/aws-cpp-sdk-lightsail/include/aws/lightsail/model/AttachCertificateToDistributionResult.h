...
namespace Model
{
  ...
  public:
    ...
    template<typename OperationT = Operation>
    AttachCertificateToDistributionResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AttachCertificateToDistributionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
