...
namespace Model
{
  ...
  /**
   */
  class ReleaseStaticIpRequest : public LightsailRequest
  {
  public:
    AWS_LIGHTSAIL_API ReleaseStaticIpRequest() = default;
    ...
    template<typename StaticIpNameT = Aws::String>
    ReleaseStaticIpRequest& WithStaticIpName(StaticIpNameT&& value) { SetStaticIpName(std::forward<StaticIpNameT>(value)); return *this;}
    ///@}
  private:
