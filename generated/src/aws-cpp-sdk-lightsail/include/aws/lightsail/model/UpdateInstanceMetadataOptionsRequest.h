...
class UpdateInstanceMetadataOptionsRequest : public LightsailRequest {
 public:
  ...
  inline void SetHttpTokens(HttpTokens value) {
    m_httpTokensHasBeenSet = true;
    m_httpTokens = value;
  }
  inline UpdateInstanceMetadataOptionsRequest& WithHttpTokens(HttpTokens value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHttpEndpoint(HttpEndpoint value) {
    m_httpEndpointHasBeenSet = true;
    m_httpEndpoint = value;
  }
  inline UpdateInstanceMetadataOptionsRequest& WithHttpEndpoint(HttpEndpoint value) {
  ...
  inline UpdateInstanceMetadataOptionsRequest& WithHttpPutResponseHopLimit(int value) {
  ...
  inline void SetHttpProtocolIpv6(HttpProtocolIpv6 value) {
    m_httpProtocolIpv6HasBeenSet = true;
    m_httpProtocolIpv6 = value;
  }
  inline UpdateInstanceMetadataOptionsRequest& WithHttpProtocolIpv6(HttpProtocolIpv6 value) {
