...
class CreateCertificateResult {
 public:
  ...
  template <typename CertificateT = CertificateSummary>
  CreateCertificateResult& WithCertificate(CertificateT&& value) {
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateCertificateResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateCertificateResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateCertificateResult& WithRequestId(RequestIdT&& value) {
