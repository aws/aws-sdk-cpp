...
class CreateDistributionResult {
 public:
  ...
  template <typename DistributionT = LightsailDistribution>
  CreateDistributionResult& WithDistribution(DistributionT&& value) {
  ...
  template <typename OperationT = Operation>
  CreateDistributionResult& WithOperation(OperationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDistributionResult& WithRequestId(RequestIdT&& value) {
