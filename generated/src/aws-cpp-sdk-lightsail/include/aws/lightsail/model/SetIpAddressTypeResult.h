...
namespace Model
{
  ...
  public:
    ...
    inline SetIpAddressTypeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline SetIpAddressTypeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline SetIpAddressTypeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
