...
class GetContainerImagesResult {
 public:
  ...
  template <typename ContainerImagesT = Aws::Vector<ContainerImage>>
  GetContainerImagesResult& WithContainerImages(ContainerImagesT&& value) {
    SetContainerImages(std::forward<ContainerImagesT>(value));
    return *this;
  }
  template <typename ContainerImagesT = ContainerImage>
  GetContainerImagesResult& AddContainerImages(ContainerImagesT&& value) {
    m_containerImagesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetContainerImagesResult& WithRequestId(RequestIdT&& value) {
