...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API DeleteRelationalDatabaseSnapshotResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    DeleteRelationalDatabaseSnapshotResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    DeleteRelationalDatabaseSnapshotResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRelationalDatabaseSnapshotResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
