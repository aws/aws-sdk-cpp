...
class MonthlyTransfer {
 public:
  ...
  inline void SetGbPerMonthAllocated(int value) {
    m_gbPerMonthAllocatedHasBeenSet = true;
    m_gbPerMonthAllocated = value;
  }
  inline MonthlyTransfer& WithGbPerMonthAllocated(int value) {
    SetGbPerMonthAllocated(value);
    return *this;
  }
  ///@}
 private:
