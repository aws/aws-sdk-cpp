...
class GetRelationalDatabaseMetricDataRequest : public LightsailRequest {
 public:
  ...
  inline GetRelationalDatabaseMetricDataRequest& WithMetricName(RelationalDatabaseMetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline GetRelationalDatabaseMetricDataRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline GetRelationalDatabaseMetricDataRequest& WithUnit(MetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline GetRelationalDatabaseMetricDataRequest& AddStatistics(MetricStatistic value) {
    m_statisticsHasBeenSet = true;
