...
class InstancePortState {
 public:
  ...
  inline InstancePortState& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline InstancePortState& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  inline InstancePortState& WithProtocol(NetworkProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(PortState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InstancePortState& WithState(PortState value) {
    SetState(value);
    return *this;
  }
  ///@}
