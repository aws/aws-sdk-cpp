...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    BucketCorsRule& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename AllowedMethodsT = Aws::Vector<Aws::String>>
    BucketCorsRule& WithAllowedMethods(AllowedMethodsT&& value) { SetAllowedMethods(std::forward<AllowedMethodsT>(value)); return *this;}
    template<typename AllowedMethodsT = Aws::String>
    BucketCorsRule& AddAllowedMethods(AllowedMethodsT&& value) { m_allowedMethodsHasBeenSet = true; m_allowedMethods.emplace_back(std::forward<AllowedMethodsT>(value)); return *this; }
    ///@}
    ...
    template<typename AllowedOriginsT = Aws::Vector<Aws::String>>
    BucketCorsRule& WithAllowedOrigins(AllowedOriginsT&& value) { SetAllowedOrigins(std::forward<AllowedOriginsT>(value)); return *this;}
    template<typename AllowedOriginsT = Aws::String>
    BucketCorsRule& AddAllowedOrigins(AllowedOriginsT&& value) { m_allowedOriginsHasBeenSet = true; m_allowedOrigins.emplace_back(std::forward<AllowedOriginsT>(value)); return *this; }
    ///@}
    ...
    template<typename AllowedHeadersT = Aws::Vector<Aws::String>>
    BucketCorsRule& WithAllowedHeaders(AllowedHeadersT&& value) { SetAllowedHeaders(std::forward<AllowedHeadersT>(value)); return *this;}
    template<typename AllowedHeadersT = Aws::String>
    BucketCorsRule& AddAllowedHeaders(AllowedHeadersT&& value) { m_allowedHeadersHasBeenSet = true; m_allowedHeaders.emplace_back(std::forward<AllowedHeadersT>(value)); return *this; }
    ///@}
    ...
    template<typename ExposeHeadersT = Aws::Vector<Aws::String>>
    BucketCorsRule& WithExposeHeaders(ExposeHeadersT&& value) { SetExposeHeaders(std::forward<ExposeHeadersT>(value)); return *this;}
    template<typename ExposeHeadersT = Aws::String>
    BucketCorsRule& AddExposeHeaders(ExposeHeadersT&& value) { m_exposeHeadersHasBeenSet = true; m_exposeHeaders.emplace_back(std::forward<ExposeHeadersT>(value)); return *this; }
    ///@}
    ...
    inline BucketCorsRule& WithMaxAgeSeconds(int value) { SetMaxAgeSeconds(value); return *this;}
    ///@}
  private:
