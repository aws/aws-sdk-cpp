...
class CreateRelationalDatabaseSnapshotResult {
 public:
  ...
  AWS_LIGHTSAIL_API CreateRelationalDatabaseSnapshotResult& operator=(
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateRelationalDatabaseSnapshotResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateRelationalDatabaseSnapshotResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateRelationalDatabaseSnapshotResult& WithRequestId(RequestIdT&& value) {
