...
class GetRelationalDatabaseEventsResult {
 public:
  ...
  void SetRelationalDatabaseEvents(RelationalDatabaseEventsT&& value) {
    m_relationalDatabaseEventsHasBeenSet = true;
    m_relationalDatabaseEvents = std::forward<RelationalDatabaseEventsT>(value);
  }
  template <typename RelationalDatabaseEventsT = Aws::Vector<RelationalDatabaseEvent>>
  GetRelationalDatabaseEventsResult& WithRelationalDatabaseEvents(RelationalDatabaseEventsT&& value) {
    SetRelationalDatabaseEvents(std::forward<RelationalDatabaseEventsT>(value));
    return *this;
  }
  template <typename RelationalDatabaseEventsT = RelationalDatabaseEvent>
  GetRelationalDatabaseEventsResult& AddRelationalDatabaseEvents(RelationalDatabaseEventsT&& value) {
    m_relationalDatabaseEventsHasBeenSet = true;
    m_relationalDatabaseEvents.emplace_back(std::forward<RelationalDatabaseEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetRelationalDatabaseEventsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRelationalDatabaseEventsResult& WithRequestId(RequestIdT&& value) {
