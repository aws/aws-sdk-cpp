...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketNameT = Aws::String>
    DeleteBucketAccessKeyRequest& WithBucketName(BucketNameT&& value) { SetBucketName(std::forward<BucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AccessKeyIdT = Aws::String>
    DeleteBucketAccessKeyRequest& WithAccessKeyId(AccessKeyIdT&& value) { SetAccessKeyId(std::forward<AccessKeyIdT>(value)); return *this;}
    ///@}
  private:
