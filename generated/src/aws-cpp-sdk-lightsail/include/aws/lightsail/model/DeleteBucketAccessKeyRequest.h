...
class DeleteBucketAccessKeyRequest : public LightsailRequest {
 public:
  AWS_LIGHTSAIL_API DeleteBucketAccessKeyRequest() = default;
  ...
  template <typename BucketNameT = Aws::String>
  DeleteBucketAccessKeyRequest& WithBucketName(BucketNameT&& value) {
  ...
  template <typename AccessKeyIdT = Aws::String>
  DeleteBucketAccessKeyRequest& WithAccessKeyId(AccessKeyIdT&& value) {
