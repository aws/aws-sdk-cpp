...
class EstimateByTime {
 public:
  ...
  inline void SetUsageCost(double value) {
    m_usageCostHasBeenSet = true;
    m_usageCost = value;
  }
  inline EstimateByTime& WithUsageCost(double value) {
    SetUsageCost(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPricingUnit(PricingUnit value) {
    m_pricingUnitHasBeenSet = true;
    m_pricingUnit = value;
  }
  inline EstimateByTime& WithPricingUnit(PricingUnit value) {
  ...
  inline void SetUnit(double value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline EstimateByTime& WithUnit(double value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline EstimateByTime& WithCurrency(Currency value) {
    SetCurrency(value);
    return *this;
  }
  ///@}
