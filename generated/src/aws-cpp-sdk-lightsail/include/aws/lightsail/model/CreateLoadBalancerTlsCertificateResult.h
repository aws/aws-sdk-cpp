...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API CreateLoadBalancerTlsCertificateResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    CreateLoadBalancerTlsCertificateResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    CreateLoadBalancerTlsCertificateResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateLoadBalancerTlsCertificateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
