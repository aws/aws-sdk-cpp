...
class CreateLoadBalancerTlsCertificateResult {
 public:
  ...
  AWS_LIGHTSAIL_API CreateLoadBalancerTlsCertificateResult& operator=(
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateLoadBalancerTlsCertificateResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateLoadBalancerTlsCertificateResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateLoadBalancerTlsCertificateResult& WithRequestId(RequestIdT&& value) {
