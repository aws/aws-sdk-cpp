...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetSetupHistoryRequest() = default;
    ...
    template<typename ResourceNameT = Aws::String>
    GetSetupHistoryRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PageTokenT = Aws::String>
    GetSetupHistoryRequest& WithPageToken(PageTokenT&& value) { SetPageToken(std::forward<PageTokenT>(value)); return *this;}
    ///@}
  private:
