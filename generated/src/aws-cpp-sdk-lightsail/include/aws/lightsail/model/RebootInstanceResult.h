...
class RebootInstanceResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  RebootInstanceResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  RebootInstanceResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RebootInstanceResult& WithRequestId(RequestIdT&& value) {
