...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API RebootInstanceResult();
    ...
    inline RebootInstanceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RebootInstanceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RebootInstanceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
