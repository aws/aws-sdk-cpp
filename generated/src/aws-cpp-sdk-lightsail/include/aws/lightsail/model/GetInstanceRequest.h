...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API GetInstanceRequest() = default;
    ...
    template<typename InstanceNameT = Aws::String>
    GetInstanceRequest& WithInstanceName(InstanceNameT&& value) { SetInstanceName(std::forward<InstanceNameT>(value)); return *this;}
    ///@}
  private:
