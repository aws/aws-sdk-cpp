...
class GetInstancePortStatesResult {
 public:
  ...
  void SetPortStates(PortStatesT&& value) {
    m_portStatesHasBeenSet = true;
    m_portStates = std::forward<PortStatesT>(value);
  }
  template <typename PortStatesT = Aws::Vector<InstancePortState>>
  GetInstancePortStatesResult& WithPortStates(PortStatesT&& value) {
    SetPortStates(std::forward<PortStatesT>(value));
    return *this;
  }
  template <typename PortStatesT = InstancePortState>
  GetInstancePortStatesResult& AddPortStates(PortStatesT&& value) {
    m_portStatesHasBeenSet = true;
    m_portStates.emplace_back(std::forward<PortStatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetInstancePortStatesResult& WithRequestId(RequestIdT&& value) {
