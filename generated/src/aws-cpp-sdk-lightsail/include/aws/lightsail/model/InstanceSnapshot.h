...
class InstanceSnapshot {
 public:
  ...
  inline InstanceSnapshot& WithResourceType(ResourceType value) {
  ...
  inline void SetState(InstanceSnapshotState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline InstanceSnapshot& WithState(InstanceSnapshotState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetFromAttachedDisks(FromAttachedDisksT&& value) {
    ...
    m_fromAttachedDisks = std::forward<FromAttachedDisksT>(value);
  }
  template <typename FromAttachedDisksT = Aws::Vector<Disk>>
  InstanceSnapshot& WithFromAttachedDisks(FromAttachedDisksT&& value) {
    SetFromAttachedDisks(std::forward<FromAttachedDisksT>(value));
    return *this;
  }
  template <typename FromAttachedDisksT = Disk>
  InstanceSnapshot& AddFromAttachedDisks(FromAttachedDisksT&& value) {
    m_fromAttachedDisksHasBeenSet = true;
    m_fromAttachedDisks.emplace_back(std::forward<FromAttachedDisksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromInstanceName(FromInstanceNameT&& value) {
    ...
    m_fromInstanceName = std::forward<FromInstanceNameT>(value);
  }
  template <typename FromInstanceNameT = Aws::String>
  InstanceSnapshot& WithFromInstanceName(FromInstanceNameT&& value) {
    SetFromInstanceName(std::forward<FromInstanceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromInstanceArn(FromInstanceArnT&& value) {
    ...
    m_fromInstanceArn = std::forward<FromInstanceArnT>(value);
  }
  template <typename FromInstanceArnT = Aws::String>
  InstanceSnapshot& WithFromInstanceArn(FromInstanceArnT&& value) {
    SetFromInstanceArn(std::forward<FromInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromBlueprintId(FromBlueprintIdT&& value) {
    ...
    m_fromBlueprintId = std::forward<FromBlueprintIdT>(value);
  }
  template <typename FromBlueprintIdT = Aws::String>
  InstanceSnapshot& WithFromBlueprintId(FromBlueprintIdT&& value) {
    SetFromBlueprintId(std::forward<FromBlueprintIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromBundleId(FromBundleIdT&& value) {
    ...
    m_fromBundleId = std::forward<FromBundleIdT>(value);
  }
  template <typename FromBundleIdT = Aws::String>
  InstanceSnapshot& WithFromBundleId(FromBundleIdT&& value) {
    SetFromBundleId(std::forward<FromBundleIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsFromAutoSnapshot(bool value) {
    m_isFromAutoSnapshotHasBeenSet = true;
    m_isFromAutoSnapshot = value;
  }
  inline InstanceSnapshot& WithIsFromAutoSnapshot(bool value) {
    SetIsFromAutoSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceSnapshot& WithSizeInGb(int value) {
    SetSizeInGb(value);
    return *this;
  }
  ///@}
