...
class DeleteKnownHostKeysResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteKnownHostKeysResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteKnownHostKeysResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteKnownHostKeysResult& WithRequestId(RequestIdT&& value) {
