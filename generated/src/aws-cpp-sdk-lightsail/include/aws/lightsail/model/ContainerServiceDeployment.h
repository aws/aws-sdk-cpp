...
class ContainerServiceDeployment {
 public:
  ...
  inline ContainerServiceDeployment& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(ContainerServiceDeploymentState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ContainerServiceDeployment& WithState(ContainerServiceDeploymentState value) {
    SetState(value);
    return *this;
  }
  ///@}
