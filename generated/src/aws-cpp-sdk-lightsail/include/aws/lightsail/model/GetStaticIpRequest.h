...
class GetStaticIpRequest : public LightsailRequest {
 public:
  ...
  void SetStaticIpName(StaticIpNameT&& value) {
    m_staticIpNameHasBeenSet = true;
    m_staticIpName = std::forward<StaticIpNameT>(value);
  }
  template <typename StaticIpNameT = Aws::String>
  GetStaticIpRequest& WithStaticIpName(StaticIpNameT&& value) {
    SetStaticIpName(std::forward<StaticIpNameT>(value));
    return *this;
  }
  ///@}
 private:
