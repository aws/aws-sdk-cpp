...
class GetExportSnapshotRecordsResult {
 public:
  ...
  void SetExportSnapshotRecords(ExportSnapshotRecordsT&& value) {
    m_exportSnapshotRecordsHasBeenSet = true;
    m_exportSnapshotRecords = std::forward<ExportSnapshotRecordsT>(value);
  }
  template <typename ExportSnapshotRecordsT = Aws::Vector<ExportSnapshotRecord>>
  GetExportSnapshotRecordsResult& WithExportSnapshotRecords(ExportSnapshotRecordsT&& value) {
    SetExportSnapshotRecords(std::forward<ExportSnapshotRecordsT>(value));
    return *this;
  }
  template <typename ExportSnapshotRecordsT = ExportSnapshotRecord>
  GetExportSnapshotRecordsResult& AddExportSnapshotRecords(ExportSnapshotRecordsT&& value) {
    m_exportSnapshotRecordsHasBeenSet = true;
    m_exportSnapshotRecords.emplace_back(std::forward<ExportSnapshotRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetExportSnapshotRecordsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetExportSnapshotRecordsResult& WithRequestId(RequestIdT&& value) {
