...
class AddOnRequest {
 public:
  ...
  inline void SetAddOnType(AddOnType value) {
    m_addOnTypeHasBeenSet = true;
    m_addOnType = value;
  }
  inline AddOnRequest& WithAddOnType(AddOnType value) {
    SetAddOnType(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoSnapshotAddOnRequest(AutoSnapshotAddOnRequestT&& value) {
    ...
    m_autoSnapshotAddOnRequest = std::forward<AutoSnapshotAddOnRequestT>(value);
  }
  template <typename AutoSnapshotAddOnRequestT = AutoSnapshotAddOnRequest>
  AddOnRequest& WithAutoSnapshotAddOnRequest(AutoSnapshotAddOnRequestT&& value) {
    SetAutoSnapshotAddOnRequest(std::forward<AutoSnapshotAddOnRequestT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStopInstanceOnIdleRequest(StopInstanceOnIdleRequestT&& value) {
    ...
    m_stopInstanceOnIdleRequest = std::forward<StopInstanceOnIdleRequestT>(value);
  }
  template <typename StopInstanceOnIdleRequestT = StopInstanceOnIdleRequest>
  AddOnRequest& WithStopInstanceOnIdleRequest(StopInstanceOnIdleRequestT&& value) {
    SetStopInstanceOnIdleRequest(std::forward<StopInstanceOnIdleRequestT>(value));
    return *this;
  }
  ///@}
 private:
