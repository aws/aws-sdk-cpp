...
namespace Model
{
  ...
  /**
   */
  class StartInstanceRequest : public LightsailRequest
  {
  public:
    AWS_LIGHTSAIL_API StartInstanceRequest() = default;
    ...
    template<typename InstanceNameT = Aws::String>
    StartInstanceRequest& WithInstanceName(InstanceNameT&& value) { SetInstanceName(std::forward<InstanceNameT>(value)); return *this;}
    ///@}
  private:
