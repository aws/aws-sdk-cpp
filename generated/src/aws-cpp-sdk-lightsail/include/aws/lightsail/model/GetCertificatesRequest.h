...
class GetCertificatesRequest : public LightsailRequest {
 public:
  ...
  template <typename CertificateStatusesT = Aws::Vector<CertificateStatus>>
  GetCertificatesRequest& WithCertificateStatuses(CertificateStatusesT&& value) {
    SetCertificateStatuses(std::forward<CertificateStatusesT>(value));
    return *this;
  }
  inline GetCertificatesRequest& AddCertificateStatuses(CertificateStatus value) {
    m_certificateStatusesHasBeenSet = true;
  ...
  inline void SetIncludeCertificateDetails(bool value) {
    m_includeCertificateDetailsHasBeenSet = true;
    m_includeCertificateDetails = value;
  }
  inline GetCertificatesRequest& WithIncludeCertificateDetails(bool value) {
    SetIncludeCertificateDetails(value);
    return *this;
  }
  ///@}
  ...
  template <typename CertificateNameT = Aws::String>
  GetCertificatesRequest& WithCertificateName(CertificateNameT&& value) {
  ...
  template <typename PageTokenT = Aws::String>
  GetCertificatesRequest& WithPageToken(PageTokenT&& value) {
