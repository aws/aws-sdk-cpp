...
class AttachLoadBalancerTlsCertificateRequest : public LightsailRequest {
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  AttachLoadBalancerTlsCertificateRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename CertificateNameT = Aws::String>
  AttachLoadBalancerTlsCertificateRequest& WithCertificateName(CertificateNameT&& value) {
