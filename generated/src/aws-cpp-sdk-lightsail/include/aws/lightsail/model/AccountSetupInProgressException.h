...
class AccountSetupInProgressException {
 public:
  ...
  template <typename CodeT = Aws::String>
  AccountSetupInProgressException& WithCode(CodeT&& value) {
  ...
  template <typename DocsT = Aws::String>
  AccountSetupInProgressException& WithDocs(DocsT&& value) {
  ...
  template <typename MessageT = Aws::String>
  AccountSetupInProgressException& WithMessage(MessageT&& value) {
  ...
  template <typename TipT = Aws::String>
  AccountSetupInProgressException& WithTip(TipT&& value) {
