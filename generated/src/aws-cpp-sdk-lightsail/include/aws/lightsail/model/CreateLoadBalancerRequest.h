...
class CreateLoadBalancerRequest : public LightsailRequest {
 public:
  ...
  inline CreateLoadBalancerRequest& WithInstancePort(int value) {
  ...
  void SetCertificateDomainName(CertificateDomainNameT&& value) {
    m_certificateDomainNameHasBeenSet = true;
    m_certificateDomainName = std::forward<CertificateDomainNameT>(value);
  }
  template <typename CertificateDomainNameT = Aws::String>
  CreateLoadBalancerRequest& WithCertificateDomainName(CertificateDomainNameT&& value) {
    SetCertificateDomainName(std::forward<CertificateDomainNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCertificateAlternativeNames(CertificateAlternativeNamesT&& value) {
    m_certificateAlternativeNamesHasBeenSet = true;
    m_certificateAlternativeNames = std::forward<CertificateAlternativeNamesT>(value);
  }
  template <typename CertificateAlternativeNamesT = Aws::Vector<Aws::String>>
  CreateLoadBalancerRequest& WithCertificateAlternativeNames(CertificateAlternativeNamesT&& value) {
    SetCertificateAlternativeNames(std::forward<CertificateAlternativeNamesT>(value));
    return *this;
  }
  ...
  CreateLoadBalancerRequest& AddCertificateAlternativeNames(CertificateAlternativeNamesT&& value) {
    m_certificateAlternativeNamesHasBeenSet = true;
    m_certificateAlternativeNames.emplace_back(std::forward<CertificateAlternativeNamesT>(value));
    return *this;
  }
  ///@}
