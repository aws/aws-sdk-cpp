...
class CreateDiskSnapshotResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateDiskSnapshotResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateDiskSnapshotResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateDiskSnapshotResult& WithRequestId(RequestIdT&& value) {
