...
class InstanceHealthSummary {
 public:
  ...
  inline void SetInstanceHealth(InstanceHealthState value) {
    m_instanceHealthHasBeenSet = true;
    m_instanceHealth = value;
  }
  inline InstanceHealthSummary& WithInstanceHealth(InstanceHealthState value) {
  ...
  inline void SetInstanceHealthReason(InstanceHealthReason value) {
    m_instanceHealthReasonHasBeenSet = true;
    m_instanceHealthReason = value;
  }
  inline InstanceHealthSummary& WithInstanceHealthReason(InstanceHealthReason value) {
    SetInstanceHealthReason(value);
    return *this;
  }
  ///@}
 private:
