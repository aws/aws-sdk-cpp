...
class DeleteLoadBalancerTlsCertificateRequest : public LightsailRequest {
 public:
  ...
  template <typename LoadBalancerNameT = Aws::String>
  DeleteLoadBalancerTlsCertificateRequest& WithLoadBalancerName(LoadBalancerNameT&& value) {
  ...
  template <typename CertificateNameT = Aws::String>
  DeleteLoadBalancerTlsCertificateRequest& WithCertificateName(CertificateNameT&& value) {
  ...
  inline DeleteLoadBalancerTlsCertificateRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
