...
class GetCloudFormationStackRecordsResult {
 public:
  ...
  void SetCloudFormationStackRecords(CloudFormationStackRecordsT&& value) {
    m_cloudFormationStackRecordsHasBeenSet = true;
    m_cloudFormationStackRecords = std::forward<CloudFormationStackRecordsT>(value);
  }
  template <typename CloudFormationStackRecordsT = Aws::Vector<CloudFormationStackRecord>>
  GetCloudFormationStackRecordsResult& WithCloudFormationStackRecords(CloudFormationStackRecordsT&& value) {
    SetCloudFormationStackRecords(std::forward<CloudFormationStackRecordsT>(value));
    return *this;
  }
  template <typename CloudFormationStackRecordsT = CloudFormationStackRecord>
  GetCloudFormationStackRecordsResult& AddCloudFormationStackRecords(CloudFormationStackRecordsT&& value) {
    m_cloudFormationStackRecordsHasBeenSet = true;
    m_cloudFormationStackRecords.emplace_back(std::forward<CloudFormationStackRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetCloudFormationStackRecordsResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCloudFormationStackRecordsResult& WithRequestId(RequestIdT&& value) {
