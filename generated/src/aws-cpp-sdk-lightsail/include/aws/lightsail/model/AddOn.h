...
class AddOn {
 public:
  ...
  void SetSnapshotTimeOfDay(SnapshotTimeOfDayT&& value) {
    ...
    m_snapshotTimeOfDay = std::forward<SnapshotTimeOfDayT>(value);
  }
  template <typename SnapshotTimeOfDayT = Aws::String>
  AddOn& WithSnapshotTimeOfDay(SnapshotTimeOfDayT&& value) {
    SetSnapshotTimeOfDay(std::forward<SnapshotTimeOfDayT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextSnapshotTimeOfDay(NextSnapshotTimeOfDayT&& value) {
    ...
    m_nextSnapshotTimeOfDay = std::forward<NextSnapshotTimeOfDayT>(value);
  }
  template <typename NextSnapshotTimeOfDayT = Aws::String>
  AddOn& WithNextSnapshotTimeOfDay(NextSnapshotTimeOfDayT&& value) {
    SetNextSnapshotTimeOfDay(std::forward<NextSnapshotTimeOfDayT>(value));
    return *this;
  }
  ///@}
