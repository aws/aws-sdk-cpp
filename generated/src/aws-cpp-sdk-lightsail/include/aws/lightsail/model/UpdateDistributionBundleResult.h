...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDistributionBundleResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDistributionBundleResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDistributionBundleResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
