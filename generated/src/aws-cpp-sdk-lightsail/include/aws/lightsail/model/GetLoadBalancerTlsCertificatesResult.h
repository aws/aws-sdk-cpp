...
class GetLoadBalancerTlsCertificatesResult {
 public:
  ...
  void SetTlsCertificates(TlsCertificatesT&& value) {
    m_tlsCertificatesHasBeenSet = true;
    m_tlsCertificates = std::forward<TlsCertificatesT>(value);
  }
  template <typename TlsCertificatesT = Aws::Vector<LoadBalancerTlsCertificate>>
  GetLoadBalancerTlsCertificatesResult& WithTlsCertificates(TlsCertificatesT&& value) {
    SetTlsCertificates(std::forward<TlsCertificatesT>(value));
    return *this;
  }
  template <typename TlsCertificatesT = LoadBalancerTlsCertificate>
  GetLoadBalancerTlsCertificatesResult& AddTlsCertificates(TlsCertificatesT&& value) {
    m_tlsCertificatesHasBeenSet = true;
    m_tlsCertificates.emplace_back(std::forward<TlsCertificatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetLoadBalancerTlsCertificatesResult& WithRequestId(RequestIdT&& value) {
