...
class RenewalSummary {
 public:
  ...
  void SetDomainValidationRecords(DomainValidationRecordsT&& value) {
    ...
    m_domainValidationRecords = std::forward<DomainValidationRecordsT>(value);
  }
  template <typename DomainValidationRecordsT = Aws::Vector<DomainValidationRecord>>
  RenewalSummary& WithDomainValidationRecords(DomainValidationRecordsT&& value) {
    SetDomainValidationRecords(std::forward<DomainValidationRecordsT>(value));
    return *this;
  }
  ...
  RenewalSummary& AddDomainValidationRecords(DomainValidationRecordsT&& value) {
    m_domainValidationRecordsHasBeenSet = true;
    m_domainValidationRecords.emplace_back(std::forward<DomainValidationRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  inline RenewalSummary& WithRenewalStatus(RenewalStatus value) {
  ...
  void SetRenewalStatusReason(RenewalStatusReasonT&& value) {
    ...
    m_renewalStatusReason = std::forward<RenewalStatusReasonT>(value);
  }
  template <typename RenewalStatusReasonT = Aws::String>
  RenewalSummary& WithRenewalStatusReason(RenewalStatusReasonT&& value) {
    SetRenewalStatusReason(std::forward<RenewalStatusReasonT>(value));
    return *this;
  }
  ///@}
