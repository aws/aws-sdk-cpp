...
class SetupInstanceHttpsRequest : public LightsailRequest {
 public:
  ...
  template <typename InstanceNameT = Aws::String>
  SetupInstanceHttpsRequest& WithInstanceName(InstanceNameT&& value) {
  ...
  template <typename EmailAddressT = Aws::String>
  SetupInstanceHttpsRequest& WithEmailAddress(EmailAddressT&& value) {
  ...
  template <typename DomainNamesT = Aws::Vector<Aws::String>>
  SetupInstanceHttpsRequest& WithDomainNames(DomainNamesT&& value) {
    SetDomainNames(std::forward<DomainNamesT>(value));
    return *this;
  }
  template <typename DomainNamesT = Aws::String>
  SetupInstanceHttpsRequest& AddDomainNames(DomainNamesT&& value) {
    m_domainNamesHasBeenSet = true;
    m_domainNames.emplace_back(std::forward<DomainNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCertificateProvider(CertificateProvider value) {
    m_certificateProviderHasBeenSet = true;
    m_certificateProvider = value;
  }
  inline SetupInstanceHttpsRequest& WithCertificateProvider(CertificateProvider value) {
    SetCertificateProvider(value);
    return *this;
  }
  ///@}
 private:
