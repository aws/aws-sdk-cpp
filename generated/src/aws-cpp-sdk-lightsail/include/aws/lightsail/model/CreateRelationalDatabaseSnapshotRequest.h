...
class CreateRelationalDatabaseSnapshotRequest : public LightsailRequest {
 public:
  ...
  template <typename RelationalDatabaseNameT = Aws::String>
  CreateRelationalDatabaseSnapshotRequest& WithRelationalDatabaseName(RelationalDatabaseNameT&& value) {
  ...
  template <typename RelationalDatabaseSnapshotNameT = Aws::String>
  CreateRelationalDatabaseSnapshotRequest& WithRelationalDatabaseSnapshotName(RelationalDatabaseSnapshotNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRelationalDatabaseSnapshotRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRelationalDatabaseSnapshotRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
