...
class GetLoadBalancerTlsPoliciesResult {
 public:
  ...
  void SetTlsPolicies(TlsPoliciesT&& value) {
    m_tlsPoliciesHasBeenSet = true;
    m_tlsPolicies = std::forward<TlsPoliciesT>(value);
  }
  template <typename TlsPoliciesT = Aws::Vector<LoadBalancerTlsPolicy>>
  GetLoadBalancerTlsPoliciesResult& WithTlsPolicies(TlsPoliciesT&& value) {
    SetTlsPolicies(std::forward<TlsPoliciesT>(value));
    return *this;
  }
  template <typename TlsPoliciesT = LoadBalancerTlsPolicy>
  GetLoadBalancerTlsPoliciesResult& AddTlsPolicies(TlsPoliciesT&& value) {
    m_tlsPoliciesHasBeenSet = true;
    m_tlsPolicies.emplace_back(std::forward<TlsPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextPageTokenT = Aws::String>
  GetLoadBalancerTlsPoliciesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLoadBalancerTlsPoliciesResult& WithRequestId(RequestIdT&& value) {
