...
class UpdateDistributionRequest : public LightsailRequest {
 public:
  ...
  void SetDefaultCacheBehavior(DefaultCacheBehaviorT&& value) {
    ...
    m_defaultCacheBehavior = std::forward<DefaultCacheBehaviorT>(value);
  }
  template <typename DefaultCacheBehaviorT = CacheBehavior>
  UpdateDistributionRequest& WithDefaultCacheBehavior(DefaultCacheBehaviorT&& value) {
    SetDefaultCacheBehavior(std::forward<DefaultCacheBehaviorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheBehaviorSettings(CacheBehaviorSettingsT&& value) {
    ...
    m_cacheBehaviorSettings = std::forward<CacheBehaviorSettingsT>(value);
  }
  template <typename CacheBehaviorSettingsT = CacheSettings>
  UpdateDistributionRequest& WithCacheBehaviorSettings(CacheBehaviorSettingsT&& value) {
    SetCacheBehaviorSettings(std::forward<CacheBehaviorSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateDistributionRequest& WithIsEnabled(bool value) {
    SetIsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetViewerMinimumTlsProtocolVersion(ViewerMinimumTlsProtocolVersionEnum value) {
    m_viewerMinimumTlsProtocolVersionHasBeenSet = true;
    m_viewerMinimumTlsProtocolVersion = value;
  }
  inline UpdateDistributionRequest& WithViewerMinimumTlsProtocolVersion(ViewerMinimumTlsProtocolVersionEnum value) {
    SetViewerMinimumTlsProtocolVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseDefaultCertificate(bool value) {
    m_useDefaultCertificateHasBeenSet = true;
    m_useDefaultCertificate = value;
  }
  inline UpdateDistributionRequest& WithUseDefaultCertificate(bool value) {
    SetUseDefaultCertificate(value);
    return *this;
  }
  ///@}
   ...
   * accessible objects directly from the bucket's endpoint.</p>  <p>When you
   * include this parameter, you must also include the <code>origin</code> parameter
   * with the resource name, even if the origin is not changing.</p> <p>You can
  ...
  inline UpdateDistributionRequest& WithEnablePrivateOriginAccess(bool value) {
