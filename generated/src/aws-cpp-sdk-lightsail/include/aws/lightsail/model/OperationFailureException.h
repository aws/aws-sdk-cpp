...
class OperationFailureException {
 public:
  ...
  template <typename CodeT = Aws::String>
  OperationFailureException& WithCode(CodeT&& value) {
  ...
  template <typename DocsT = Aws::String>
  OperationFailureException& WithDocs(DocsT&& value) {
  ...
  template <typename MessageT = Aws::String>
  OperationFailureException& WithMessage(MessageT&& value) {
  ...
  template <typename TipT = Aws::String>
  OperationFailureException& WithTip(TipT&& value) {
