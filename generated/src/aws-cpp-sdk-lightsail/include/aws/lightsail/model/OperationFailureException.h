...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API OperationFailureException() = default;
    ...
    template<typename CodeT = Aws::String>
    OperationFailureException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename DocsT = Aws::String>
    OperationFailureException& WithDocs(DocsT&& value) { SetDocs(std::forward<DocsT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    OperationFailureException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename TipT = Aws::String>
    OperationFailureException& WithTip(TipT&& value) { SetTip(std::forward<TipT>(value)); return *this;}
    ///@}
  private:
