...
class GetKeyPairsRequest : public LightsailRequest {
 public:
  ...
  template <typename PageTokenT = Aws::String>
  GetKeyPairsRequest& WithPageToken(PageTokenT&& value) {
  ...
  inline void SetIncludeDefaultKeyPair(bool value) {
    m_includeDefaultKeyPairHasBeenSet = true;
    m_includeDefaultKeyPair = value;
  }
  inline GetKeyPairsRequest& WithIncludeDefaultKeyPair(bool value) {
    SetIncludeDefaultKeyPair(value);
    return *this;
  }
  ///@}
 private:
