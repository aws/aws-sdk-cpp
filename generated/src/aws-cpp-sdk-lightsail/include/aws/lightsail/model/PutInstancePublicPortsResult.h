...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API PutInstancePublicPortsResult() = default;
    ...
    template<typename OperationT = Operation>
    PutInstancePublicPortsResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutInstancePublicPortsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
