...
class Bucket {
 public:
  ...
  void SetObjectVersioning(ObjectVersioningT&& value) {
    ...
    m_objectVersioning = std::forward<ObjectVersioningT>(value);
  }
  template <typename ObjectVersioningT = Aws::String>
  Bucket& WithObjectVersioning(ObjectVersioningT&& value) {
    SetObjectVersioning(std::forward<ObjectVersioningT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAbleToUpdateBundle(bool value) {
    m_ableToUpdateBundleHasBeenSet = true;
    m_ableToUpdateBundle = value;
  }
  inline Bucket& WithAbleToUpdateBundle(bool value) {
    SetAbleToUpdateBundle(value);
    return *this;
  }
  ///@}
  ...
  void SetResourcesReceivingAccess(ResourcesReceivingAccessT&& value) {
    ...
    m_resourcesReceivingAccess = std::forward<ResourcesReceivingAccessT>(value);
  }
  template <typename ResourcesReceivingAccessT = Aws::Vector<ResourceReceivingAccess>>
  Bucket& WithResourcesReceivingAccess(ResourcesReceivingAccessT&& value) {
    SetResourcesReceivingAccess(std::forward<ResourcesReceivingAccessT>(value));
    return *this;
  }
  ...
  Bucket& AddResourcesReceivingAccess(ResourcesReceivingAccessT&& value) {
    m_resourcesReceivingAccessHasBeenSet = true;
    m_resourcesReceivingAccess.emplace_back(std::forward<ResourcesReceivingAccessT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>An array of cross-origin resource sharing (CORS) rules that identify origins
   ...
   * CORS configuration. For more information, see <a
