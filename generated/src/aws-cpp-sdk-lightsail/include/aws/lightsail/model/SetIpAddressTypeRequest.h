...
class SetIpAddressTypeRequest : public LightsailRequest {
 public:
  ...
  inline SetIpAddressTypeRequest& WithResourceType(ResourceType value) {
  ...
  template <typename ResourceNameT = Aws::String>
  SetIpAddressTypeRequest& WithResourceName(ResourceNameT&& value) {
  ...
  inline SetIpAddressTypeRequest& WithIpAddressType(IpAddressType value) {
  ...
  inline void SetAcceptBundleUpdate(bool value) {
    m_acceptBundleUpdateHasBeenSet = true;
    m_acceptBundleUpdate = value;
  }
  inline SetIpAddressTypeRequest& WithAcceptBundleUpdate(bool value) {
    SetAcceptBundleUpdate(value);
    return *this;
  }
  ///@}
 private:
