...
class QueryStringObject {
 public:
  ...
  inline void SetOption(bool value) {
    m_optionHasBeenSet = true;
    m_option = value;
  }
  inline QueryStringObject& WithOption(bool value) {
    SetOption(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryStringsAllowList(QueryStringsAllowListT&& value) {
    ...
    m_queryStringsAllowList = std::forward<QueryStringsAllowListT>(value);
  }
  template <typename QueryStringsAllowListT = Aws::Vector<Aws::String>>
  QueryStringObject& WithQueryStringsAllowList(QueryStringsAllowListT&& value) {
    SetQueryStringsAllowList(std::forward<QueryStringsAllowListT>(value));
    return *this;
  }
  ...
  QueryStringObject& AddQueryStringsAllowList(QueryStringsAllowListT&& value) {
    m_queryStringsAllowListHasBeenSet = true;
    m_queryStringsAllowList.emplace_back(std::forward<QueryStringsAllowListT>(value));
    return *this;
  }
  ///@}
 private:
