...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API UpdateDomainEntryResult() = default;
    ...
    template<typename OperationsT = Aws::Vector<Operation>>
    UpdateDomainEntryResult& WithOperations(OperationsT&& value) { SetOperations(std::forward<OperationsT>(value)); return *this;}
    template<typename OperationsT = Operation>
    UpdateDomainEntryResult& AddOperations(OperationsT&& value) { m_operationsHasBeenSet = true; m_operations.emplace_back(std::forward<OperationsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDomainEntryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
