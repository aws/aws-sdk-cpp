...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDomainEntryResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDomainEntryResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDomainEntryResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
