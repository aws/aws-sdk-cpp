...
class UpdateBucketRequest : public LightsailRequest {
 public:
  ...
  template <typename BucketNameT = Aws::String>
  UpdateBucketRequest& WithBucketName(BucketNameT&& value) {
  ...
  void SetAccessRules(AccessRulesT&& value) {
    ...
    m_accessRules = std::forward<AccessRulesT>(value);
  }
  template <typename AccessRulesT = AccessRules>
  UpdateBucketRequest& WithAccessRules(AccessRulesT&& value) {
    SetAccessRules(std::forward<AccessRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVersioning(VersioningT&& value) {
    m_versioningHasBeenSet = true;
    m_versioning = std::forward<VersioningT>(value);
  }
  template <typename VersioningT = Aws::String>
  UpdateBucketRequest& WithVersioning(VersioningT&& value) {
    SetVersioning(std::forward<VersioningT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadonlyAccessAccounts(ReadonlyAccessAccountsT&& value) {
    ...
    m_readonlyAccessAccounts = std::forward<ReadonlyAccessAccountsT>(value);
  }
  template <typename ReadonlyAccessAccountsT = Aws::Vector<Aws::String>>
  UpdateBucketRequest& WithReadonlyAccessAccounts(ReadonlyAccessAccountsT&& value) {
    SetReadonlyAccessAccounts(std::forward<ReadonlyAccessAccountsT>(value));
    return *this;
  }
  template <typename ReadonlyAccessAccountsT = Aws::String>
  UpdateBucketRequest& AddReadonlyAccessAccounts(ReadonlyAccessAccountsT&& value) {
    m_readonlyAccessAccountsHasBeenSet = true;
    m_readonlyAccessAccounts.emplace_back(std::forward<ReadonlyAccessAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccessLogConfig(AccessLogConfigT&& value) {
    ...
    m_accessLogConfig = std::forward<AccessLogConfigT>(value);
  }
  template <typename AccessLogConfigT = BucketAccessLogConfig>
  UpdateBucketRequest& WithAccessLogConfig(AccessLogConfigT&& value) {
    SetAccessLogConfig(std::forward<AccessLogConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCors(CorsT&& value) {
    ...
    m_cors = std::forward<CorsT>(value);
  }
  template <typename CorsT = BucketCorsConfig>
  UpdateBucketRequest& WithCors(CorsT&& value) {
    SetCors(std::forward<CorsT>(value));
    return *this;
  }
  ///@}
 private:
