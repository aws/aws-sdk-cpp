...
class ImportKeyPairRequest : public LightsailRequest {
 public:
  ...
  void SetKeyPairName(KeyPairNameT&& value) {
    ...
    m_keyPairName = std::forward<KeyPairNameT>(value);
  }
  template <typename KeyPairNameT = Aws::String>
  ImportKeyPairRequest& WithKeyPairName(KeyPairNameT&& value) {
    SetKeyPairName(std::forward<KeyPairNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublicKeyBase64(PublicKeyBase64T&& value) {
    ...
    m_publicKeyBase64 = std::forward<PublicKeyBase64T>(value);
  }
  template <typename PublicKeyBase64T = Aws::String>
  ImportKeyPairRequest& WithPublicKeyBase64(PublicKeyBase64T&& value) {
    SetPublicKeyBase64(std::forward<PublicKeyBase64T>(value));
    return *this;
  }
  ///@}
 private:
