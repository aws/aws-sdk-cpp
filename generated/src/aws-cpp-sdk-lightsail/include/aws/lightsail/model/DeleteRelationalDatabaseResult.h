...
class DeleteRelationalDatabaseResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  DeleteRelationalDatabaseResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  DeleteRelationalDatabaseResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteRelationalDatabaseResult& WithRequestId(RequestIdT&& value) {
