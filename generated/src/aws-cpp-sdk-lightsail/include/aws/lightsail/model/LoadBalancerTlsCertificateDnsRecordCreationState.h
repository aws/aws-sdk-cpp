...
class LoadBalancerTlsCertificateDnsRecordCreationState {
 public:
  ...
  inline void SetCode(LoadBalancerTlsCertificateDnsRecordCreationStateCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline LoadBalancerTlsCertificateDnsRecordCreationState& WithCode(LoadBalancerTlsCertificateDnsRecordCreationStateCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  LoadBalancerTlsCertificateDnsRecordCreationState& WithMessage(MessageT&& value) {
