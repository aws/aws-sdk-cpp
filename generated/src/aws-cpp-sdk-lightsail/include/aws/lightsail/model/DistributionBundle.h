...
class DistributionBundle {
 public:
  ...
  inline DistributionBundle& WithPrice(double value) {
    SetPrice(value);
    return *this;
  }
  ///@}
  ...
  inline DistributionBundle& WithTransferPerMonthInGb(int value) {
  ...
  inline DistributionBundle& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
