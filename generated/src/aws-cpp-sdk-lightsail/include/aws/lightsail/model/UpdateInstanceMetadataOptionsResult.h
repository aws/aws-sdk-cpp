...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API UpdateInstanceMetadataOptionsResult() = default;
    ...
    template<typename OperationT = Operation>
    UpdateInstanceMetadataOptionsResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateInstanceMetadataOptionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
