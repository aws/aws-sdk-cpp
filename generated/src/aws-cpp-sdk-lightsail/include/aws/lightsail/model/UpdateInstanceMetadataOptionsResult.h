...
namespace Model
{
  ...
  public:
    ...
    inline UpdateInstanceMetadataOptionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateInstanceMetadataOptionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateInstanceMetadataOptionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
