...
class CreateCloudFormationStackResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  CreateCloudFormationStackResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  CreateCloudFormationStackResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateCloudFormationStackResult& WithRequestId(RequestIdT&& value) {
