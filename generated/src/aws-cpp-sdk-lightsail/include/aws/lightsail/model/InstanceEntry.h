...
class InstanceEntry {
 public:
  ...
  inline void SetPortInfoSource(PortInfoSourceType value) {
    m_portInfoSourceHasBeenSet = true;
    m_portInfoSource = value;
  }
  inline InstanceEntry& WithPortInfoSource(PortInfoSourceType value) {
    SetPortInfoSource(value);
    return *this;
  }
  ///@}
