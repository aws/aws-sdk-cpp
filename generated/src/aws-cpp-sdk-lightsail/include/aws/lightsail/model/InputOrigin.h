...
class InputOrigin {
 public:
  ...
  template <typename NameT = Aws::String>
  InputOrigin& WithName(NameT&& value) {
  ...
  inline InputOrigin& WithRegionName(RegionName value) {
    SetRegionName(value);
    return *this;
  }
  ///@}
  ...
  inline InputOrigin& WithProtocolPolicy(OriginProtocolPolicyEnum value) {
  ...
  inline InputOrigin& WithResponseTimeout(int value) {
