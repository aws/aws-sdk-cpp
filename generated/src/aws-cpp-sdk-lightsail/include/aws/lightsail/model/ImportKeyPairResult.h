...
namespace Model
{
  ...
  public:
    ...
    inline ImportKeyPairResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ImportKeyPairResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ImportKeyPairResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
