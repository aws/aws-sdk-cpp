...
namespace Model
{
  ...
  {
  public:
    AWS_LIGHTSAIL_API ImportKeyPairResult() = default;
    ...
    template<typename OperationT = Operation>
    ImportKeyPairResult& WithOperation(OperationT&& value) { SetOperation(std::forward<OperationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportKeyPairResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
