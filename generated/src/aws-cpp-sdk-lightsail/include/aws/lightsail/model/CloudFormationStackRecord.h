...
class CloudFormationStackRecord {
 public:
  ...
  template <typename NameT = Aws::String>
  CloudFormationStackRecord& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CloudFormationStackRecord& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CloudFormationStackRecord& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LocationT = ResourceLocation>
  CloudFormationStackRecord& WithLocation(LocationT&& value) {
  ...
  inline CloudFormationStackRecord& WithResourceType(ResourceType value) {
  ...
  inline void SetState(RecordState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CloudFormationStackRecord& WithState(RecordState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceInfoT = Aws::Vector<CloudFormationStackRecordSourceInfo>>
  CloudFormationStackRecord& WithSourceInfo(SourceInfoT&& value) {
    SetSourceInfo(std::forward<SourceInfoT>(value));
    return *this;
  }
  template <typename SourceInfoT = CloudFormationStackRecordSourceInfo>
  CloudFormationStackRecord& AddSourceInfo(SourceInfoT&& value) {
    m_sourceInfoHasBeenSet = true;
    m_sourceInfo.emplace_back(std::forward<SourceInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationInfo(DestinationInfoT&& value) {
    m_destinationInfoHasBeenSet = true;
    m_destinationInfo = std::forward<DestinationInfoT>(value);
  }
  template <typename DestinationInfoT = DestinationInfo>
  CloudFormationStackRecord& WithDestinationInfo(DestinationInfoT&& value) {
    SetDestinationInfo(std::forward<DestinationInfoT>(value));
    return *this;
  }
  ///@}
 private:
