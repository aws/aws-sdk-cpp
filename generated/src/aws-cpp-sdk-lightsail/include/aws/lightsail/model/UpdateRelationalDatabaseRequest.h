...
class UpdateRelationalDatabaseRequest : public LightsailRequest {
 public:
  ...
  inline UpdateRelationalDatabaseRequest& WithRotateMasterUserPassword(bool value) {
  ...
  inline void SetEnableBackupRetention(bool value) {
    m_enableBackupRetentionHasBeenSet = true;
    m_enableBackupRetention = value;
  }
  inline UpdateRelationalDatabaseRequest& WithEnableBackupRetention(bool value) {
    SetEnableBackupRetention(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDisableBackupRetention(bool value) {
    m_disableBackupRetentionHasBeenSet = true;
    m_disableBackupRetention = value;
  }
  inline UpdateRelationalDatabaseRequest& WithDisableBackupRetention(bool value) {
    SetDisableBackupRetention(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRelationalDatabaseRequest& WithPubliclyAccessible(bool value) {
  ...
  inline UpdateRelationalDatabaseRequest& WithApplyImmediately(bool value) {
