...
namespace Model
{
  ...
  public:
    ...
    inline UnpeerVpcResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UnpeerVpcResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UnpeerVpcResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
