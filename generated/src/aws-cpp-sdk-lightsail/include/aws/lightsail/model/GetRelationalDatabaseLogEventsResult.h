...
class GetRelationalDatabaseLogEventsResult {
 public:
  ...
  void SetResourceLogEvents(ResourceLogEventsT&& value) {
    m_resourceLogEventsHasBeenSet = true;
    m_resourceLogEvents = std::forward<ResourceLogEventsT>(value);
  }
  template <typename ResourceLogEventsT = Aws::Vector<LogEvent>>
  GetRelationalDatabaseLogEventsResult& WithResourceLogEvents(ResourceLogEventsT&& value) {
    SetResourceLogEvents(std::forward<ResourceLogEventsT>(value));
    return *this;
  }
  template <typename ResourceLogEventsT = LogEvent>
  GetRelationalDatabaseLogEventsResult& AddResourceLogEvents(ResourceLogEventsT&& value) {
    m_resourceLogEventsHasBeenSet = true;
    m_resourceLogEvents.emplace_back(std::forward<ResourceLogEventsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextBackwardToken(NextBackwardTokenT&& value) {
    m_nextBackwardTokenHasBeenSet = true;
    m_nextBackwardToken = std::forward<NextBackwardTokenT>(value);
  }
  template <typename NextBackwardTokenT = Aws::String>
  GetRelationalDatabaseLogEventsResult& WithNextBackwardToken(NextBackwardTokenT&& value) {
    SetNextBackwardToken(std::forward<NextBackwardTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextForwardToken(NextForwardTokenT&& value) {
    m_nextForwardTokenHasBeenSet = true;
    m_nextForwardToken = std::forward<NextForwardTokenT>(value);
  }
  template <typename NextForwardTokenT = Aws::String>
  GetRelationalDatabaseLogEventsResult& WithNextForwardToken(NextForwardTokenT&& value) {
    SetNextForwardToken(std::forward<NextForwardTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRelationalDatabaseLogEventsResult& WithRequestId(RequestIdT&& value) {
