...
class ReleaseStaticIpResult {
 public:
  ...
  template <typename OperationsT = Aws::Vector<Operation>>
  ReleaseStaticIpResult& WithOperations(OperationsT&& value) {
    SetOperations(std::forward<OperationsT>(value));
    return *this;
  }
  template <typename OperationsT = Operation>
  ReleaseStaticIpResult& AddOperations(OperationsT&& value) {
    m_operationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ReleaseStaticIpResult& WithRequestId(RequestIdT&& value) {
