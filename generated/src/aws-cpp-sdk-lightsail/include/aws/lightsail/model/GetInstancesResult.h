...
class GetInstancesResult {
 public:
  AWS_LIGHTSAIL_API GetInstancesResult() = default;
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  GetInstancesResult& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  GetInstancesResult& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename NextPageTokenT = Aws::String>
  GetInstancesResult& WithNextPageToken(NextPageTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetInstancesResult& WithRequestId(RequestIdT&& value) {
