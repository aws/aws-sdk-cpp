...
class CopySnapshotRequest : public LightsailRequest {
 public:
  ...
  inline CopySnapshotRequest& WithUseLatestRestorableAutoSnapshot(bool value) {
  ...
  inline void SetSourceRegion(RegionName value) {
    m_sourceRegionHasBeenSet = true;
    m_sourceRegion = value;
  }
  inline CopySnapshotRequest& WithSourceRegion(RegionName value) {
    SetSourceRegion(value);
    return *this;
  }
  ///@}
 private:
