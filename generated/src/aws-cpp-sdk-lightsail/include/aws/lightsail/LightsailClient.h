...
class AWS_LIGHTSAIL_API LightsailClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  LightsailClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<LightsailEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AllocateStaticIp that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AllocateStaticIp that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AllocateStaticIpRequestT = Model::AllocateStaticIpRequest>
  void AllocateStaticIpAsync(const AllocateStaticIpRequestT& request, const AllocateStaticIpResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AttachCertificateToDistributionOutcome AttachCertificateToDistribution(
      const Model::AttachCertificateToDistributionRequest& request) const;

  /**
   * A Callable wrapper for AttachCertificateToDistribution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AttachCertificateToDistributionRequestT = Model::AttachCertificateToDistributionRequest>
  Model::AttachCertificateToDistributionOutcomeCallable AttachCertificateToDistributionCallable(
      const AttachCertificateToDistributionRequestT& request) const {
    return SubmitCallable(&LightsailClient::AttachCertificateToDistribution, request);
  }

  /**
   * An Async wrapper for AttachCertificateToDistribution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AttachCertificateToDistributionRequestT = Model::AttachCertificateToDistributionRequest>
  void AttachCertificateToDistributionAsync(const AttachCertificateToDistributionRequestT& request,
  ...
  /**
   * An Async wrapper for AttachDisk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AttachDiskRequestT = Model::AttachDiskRequest>
  void AttachDiskAsync(const AttachDiskRequestT& request, const AttachDiskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AttachInstancesToLoadBalancerOutcome AttachInstancesToLoadBalancer(
      const Model::AttachInstancesToLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for AttachInstancesToLoadBalancer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AttachInstancesToLoadBalancerRequestT = Model::AttachInstancesToLoadBalancerRequest>
  Model::AttachInstancesToLoadBalancerOutcomeCallable AttachInstancesToLoadBalancerCallable(
      const AttachInstancesToLoadBalancerRequestT& request) const {
    return SubmitCallable(&LightsailClient::AttachInstancesToLoadBalancer, request);
  }

  /**
   * An Async wrapper for AttachInstancesToLoadBalancer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachInstancesToLoadBalancerRequestT = Model::AttachInstancesToLoadBalancerRequest>
  void AttachInstancesToLoadBalancerAsync(const AttachInstancesToLoadBalancerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AttachLoadBalancerTlsCertificateOutcome AttachLoadBalancerTlsCertificate(
      const Model::AttachLoadBalancerTlsCertificateRequest& request) const;

  /**
   * A Callable wrapper for AttachLoadBalancerTlsCertificate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AttachLoadBalancerTlsCertificateRequestT = Model::AttachLoadBalancerTlsCertificateRequest>
  Model::AttachLoadBalancerTlsCertificateOutcomeCallable AttachLoadBalancerTlsCertificateCallable(
      const AttachLoadBalancerTlsCertificateRequestT& request) const {
    return SubmitCallable(&LightsailClient::AttachLoadBalancerTlsCertificate, request);
  }

  /**
   * An Async wrapper for AttachLoadBalancerTlsCertificate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AttachLoadBalancerTlsCertificateRequestT = Model::AttachLoadBalancerTlsCertificateRequest>
  void AttachLoadBalancerTlsCertificateAsync(const AttachLoadBalancerTlsCertificateRequestT& request,
  ...
  /**
   * An Async wrapper for AttachStaticIp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AttachStaticIpRequestT = Model::AttachStaticIpRequest>
  void AttachStaticIpAsync(const AttachStaticIpRequestT& request, const AttachStaticIpResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CloseInstancePublicPorts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CloseInstancePublicPorts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CloseInstancePublicPortsRequestT = Model::CloseInstancePublicPortsRequest>
  void CloseInstancePublicPortsAsync(const CloseInstancePublicPortsRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateBucketAccessKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBucketAccessKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBucketAccessKeyRequestT = Model::CreateBucketAccessKeyRequest>
  void CreateBucketAccessKeyAsync(const CreateBucketAccessKeyRequestT& request, const CreateBucketAccessKeyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCertificate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCertificate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCertificateRequestT = Model::CreateCertificateRequest>
  void CreateCertificateAsync(const CreateCertificateRequestT& request, const CreateCertificateResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCloudFormationStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateCloudFormationStackRequestT = Model::CreateCloudFormationStackRequest>
  Model::CreateCloudFormationStackOutcomeCallable CreateCloudFormationStackCallable(
      const CreateCloudFormationStackRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateCloudFormationStack, request);
  }

  /**
   * An Async wrapper for CreateCloudFormationStack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCloudFormationStackRequestT = Model::CreateCloudFormationStackRequest>
  void CreateCloudFormationStackAsync(const CreateCloudFormationStackRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateContactMethod that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContactMethod that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateContactMethodRequestT = Model::CreateContactMethodRequest>
  void CreateContactMethodAsync(const CreateContactMethodRequestT& request, const CreateContactMethodResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateContainerService that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContainerService that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateContainerServiceRequestT = Model::CreateContainerServiceRequest>
  void CreateContainerServiceAsync(const CreateContainerServiceRequestT& request,
  ...
  virtual Model::CreateContainerServiceDeploymentOutcome CreateContainerServiceDeployment(
      const Model::CreateContainerServiceDeploymentRequest& request) const;

  /**
   * A Callable wrapper for CreateContainerServiceDeployment that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateContainerServiceDeploymentRequestT = Model::CreateContainerServiceDeploymentRequest>
  Model::CreateContainerServiceDeploymentOutcomeCallable CreateContainerServiceDeploymentCallable(
      const CreateContainerServiceDeploymentRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateContainerServiceDeployment, request);
  }

  /**
   * An Async wrapper for CreateContainerServiceDeployment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateContainerServiceDeploymentRequestT = Model::CreateContainerServiceDeploymentRequest>
  void CreateContainerServiceDeploymentAsync(const CreateContainerServiceDeploymentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateContainerServiceRegistryLoginOutcome CreateContainerServiceRegistryLogin(
      const Model::CreateContainerServiceRegistryLoginRequest& request = {}) const;

  /**
   * A Callable wrapper for CreateContainerServiceRegistryLogin that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateContainerServiceRegistryLoginRequestT = Model::CreateContainerServiceRegistryLoginRequest>
  Model::CreateContainerServiceRegistryLoginOutcomeCallable CreateContainerServiceRegistryLoginCallable(
      const CreateContainerServiceRegistryLoginRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::CreateContainerServiceRegistryLogin, request);
  }

  /**
   * An Async wrapper for CreateContainerServiceRegistryLogin that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateContainerServiceRegistryLoginRequestT = Model::CreateContainerServiceRegistryLoginRequest>
  void CreateContainerServiceRegistryLoginAsync(const CreateContainerServiceRegistryLoginResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateDisk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDiskRequestT = Model::CreateDiskRequest>
  void CreateDiskAsync(const CreateDiskRequestT& request, const CreateDiskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDiskFromSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDiskFromSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDiskFromSnapshotRequestT = Model::CreateDiskFromSnapshotRequest>
  void CreateDiskFromSnapshotAsync(const CreateDiskFromSnapshotRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDiskSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDiskSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDiskSnapshotRequestT = Model::CreateDiskSnapshotRequest>
  void CreateDiskSnapshotAsync(const CreateDiskSnapshotRequestT& request, const CreateDiskSnapshotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDistribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDistribution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDistributionRequestT = Model::CreateDistributionRequest>
  void CreateDistributionAsync(const CreateDistributionRequestT& request, const CreateDistributionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDomainEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDomainEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDomainEntryRequestT = Model::CreateDomainEntryRequest>
  void CreateDomainEntryAsync(const CreateDomainEntryRequestT& request, const CreateDomainEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateGUISessionAccessDetailsOutcome CreateGUISessionAccessDetails(
      const Model::CreateGUISessionAccessDetailsRequest& request) const;

  /**
   * A Callable wrapper for CreateGUISessionAccessDetails that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateGUISessionAccessDetailsRequestT = Model::CreateGUISessionAccessDetailsRequest>
  Model::CreateGUISessionAccessDetailsOutcomeCallable CreateGUISessionAccessDetailsCallable(
      const CreateGUISessionAccessDetailsRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateGUISessionAccessDetails, request);
  }

  /**
   * An Async wrapper for CreateGUISessionAccessDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGUISessionAccessDetailsRequestT = Model::CreateGUISessionAccessDetailsRequest>
  void CreateGUISessionAccessDetailsAsync(const CreateGUISessionAccessDetailsRequestT& request,
                                          const CreateGUISessionAccessDetailsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInstanceSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInstanceSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInstanceSnapshotRequestT = Model::CreateInstanceSnapshotRequest>
  void CreateInstanceSnapshotAsync(const CreateInstanceSnapshotRequestT& request,
  ...
  /**
   * An Async wrapper for CreateInstances that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateInstancesRequestT = Model::CreateInstancesRequest>
  void CreateInstancesAsync(const CreateInstancesRequestT& request, const CreateInstancesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateInstancesFromSnapshotOutcome CreateInstancesFromSnapshot(
      const Model::CreateInstancesFromSnapshotRequest& request) const;

  /**
   * A Callable wrapper for CreateInstancesFromSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateInstancesFromSnapshotRequestT = Model::CreateInstancesFromSnapshotRequest>
  Model::CreateInstancesFromSnapshotOutcomeCallable CreateInstancesFromSnapshotCallable(
      const CreateInstancesFromSnapshotRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateInstancesFromSnapshot, request);
  }

  /**
   * An Async wrapper for CreateInstancesFromSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInstancesFromSnapshotRequestT = Model::CreateInstancesFromSnapshotRequest>
  void CreateInstancesFromSnapshotAsync(const CreateInstancesFromSnapshotRequestT& request,
  ...
  /**
   * An Async wrapper for CreateKeyPair that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateKeyPairRequestT = Model::CreateKeyPairRequest>
  void CreateKeyPairAsync(const CreateKeyPairRequestT& request, const CreateKeyPairResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * your Lightsail instances for load balancing</a>. You can create up to 10 load
  ...
  virtual Model::CreateLoadBalancerTlsCertificateOutcome CreateLoadBalancerTlsCertificate(
      const Model::CreateLoadBalancerTlsCertificateRequest& request) const;

  /**
   * A Callable wrapper for CreateLoadBalancerTlsCertificate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateLoadBalancerTlsCertificateRequestT = Model::CreateLoadBalancerTlsCertificateRequest>
  Model::CreateLoadBalancerTlsCertificateOutcomeCallable CreateLoadBalancerTlsCertificateCallable(
      const CreateLoadBalancerTlsCertificateRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateLoadBalancerTlsCertificate, request);
  }

  /**
   * An Async wrapper for CreateLoadBalancerTlsCertificate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateLoadBalancerTlsCertificateRequestT = Model::CreateLoadBalancerTlsCertificateRequest>
  void CreateLoadBalancerTlsCertificateAsync(const CreateLoadBalancerTlsCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRelationalDatabaseRequestT = Model::CreateRelationalDatabaseRequest>
  void CreateRelationalDatabaseAsync(const CreateRelationalDatabaseRequestT& request,
  ...
  virtual Model::CreateRelationalDatabaseFromSnapshotOutcome CreateRelationalDatabaseFromSnapshot(
      const Model::CreateRelationalDatabaseFromSnapshotRequest& request) const;

  /**
   * A Callable wrapper for CreateRelationalDatabaseFromSnapshot that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateRelationalDatabaseFromSnapshotRequestT = Model::CreateRelationalDatabaseFromSnapshotRequest>
  Model::CreateRelationalDatabaseFromSnapshotOutcomeCallable CreateRelationalDatabaseFromSnapshotCallable(
      const CreateRelationalDatabaseFromSnapshotRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateRelationalDatabaseFromSnapshot, request);
  }

  /**
   * An Async wrapper for CreateRelationalDatabaseFromSnapshot that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateRelationalDatabaseFromSnapshotRequestT = Model::CreateRelationalDatabaseFromSnapshotRequest>
  void CreateRelationalDatabaseFromSnapshotAsync(const CreateRelationalDatabaseFromSnapshotRequestT& request,
  ...
  virtual Model::CreateRelationalDatabaseSnapshotOutcome CreateRelationalDatabaseSnapshot(
      const Model::CreateRelationalDatabaseSnapshotRequest& request) const;

  /**
   * A Callable wrapper for CreateRelationalDatabaseSnapshot that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateRelationalDatabaseSnapshotRequestT = Model::CreateRelationalDatabaseSnapshotRequest>
  Model::CreateRelationalDatabaseSnapshotOutcomeCallable CreateRelationalDatabaseSnapshotCallable(
      const CreateRelationalDatabaseSnapshotRequestT& request) const {
    return SubmitCallable(&LightsailClient::CreateRelationalDatabaseSnapshot, request);
  }

  /**
   * An Async wrapper for CreateRelationalDatabaseSnapshot that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateRelationalDatabaseSnapshotRequestT = Model::CreateRelationalDatabaseSnapshotRequest>
  void CreateRelationalDatabaseSnapshotAsync(const CreateRelationalDatabaseSnapshotRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAlarmRequestT = Model::DeleteAlarmRequest>
  void DeleteAlarmAsync(const DeleteAlarmRequestT& request, const DeleteAlarmResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAutoSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAutoSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAutoSnapshotRequestT = Model::DeleteAutoSnapshotRequest>
  void DeleteAutoSnapshotAsync(const DeleteAutoSnapshotRequestT& request, const DeleteAutoSnapshotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBucketAccessKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBucketAccessKey that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBucketAccessKeyRequestT = Model::DeleteBucketAccessKeyRequest>
  void DeleteBucketAccessKeyAsync(const DeleteBucketAccessKeyRequestT& request, const DeleteBucketAccessKeyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContactMethod that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContactMethod that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteContactMethodRequestT = Model::DeleteContactMethodRequest>
  void DeleteContactMethodAsync(const DeleteContactMethodRequestT& request, const DeleteContactMethodResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContainerImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContainerImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContainerImageRequestT = Model::DeleteContainerImageRequest>
  void DeleteContainerImageAsync(const DeleteContainerImageRequestT& request, const DeleteContainerImageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContainerService that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContainerService that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContainerServiceRequestT = Model::DeleteContainerServiceRequest>
  void DeleteContainerServiceAsync(const DeleteContainerServiceRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteDisk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDiskRequestT = Model::DeleteDiskRequest>
  void DeleteDiskAsync(const DeleteDiskRequestT& request, const DeleteDiskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDiskSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDiskSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDiskSnapshotRequestT = Model::DeleteDiskSnapshotRequest>
  void DeleteDiskSnapshotAsync(const DeleteDiskSnapshotRequestT& request, const DeleteDiskSnapshotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDistribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDistribution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDistributionRequestT = Model::DeleteDistributionRequest>
  void DeleteDistributionAsync(const DeleteDistributionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DeleteDistributionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteDomainEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDomainEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDomainEntryRequestT = Model::DeleteDomainEntryRequest>
  void DeleteDomainEntryAsync(const DeleteDomainEntryRequestT& request, const DeleteDomainEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInstanceSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInstanceSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInstanceSnapshotRequestT = Model::DeleteInstanceSnapshotRequest>
  void DeleteInstanceSnapshotAsync(const DeleteInstanceSnapshotRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteKeyPair that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteKeyPairRequestT = Model::DeleteKeyPairRequest>
  void DeleteKeyPairAsync(const DeleteKeyPairRequestT& request, const DeleteKeyPairResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteKnownHostKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteKnownHostKeys that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteKnownHostKeysRequestT = Model::DeleteKnownHostKeysRequest>
  void DeleteKnownHostKeysAsync(const DeleteKnownHostKeysRequestT& request, const DeleteKnownHostKeysResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteLoadBalancerTlsCertificateOutcome DeleteLoadBalancerTlsCertificate(
      const Model::DeleteLoadBalancerTlsCertificateRequest& request) const;

  /**
   * A Callable wrapper for DeleteLoadBalancerTlsCertificate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteLoadBalancerTlsCertificateRequestT = Model::DeleteLoadBalancerTlsCertificateRequest>
  Model::DeleteLoadBalancerTlsCertificateOutcomeCallable DeleteLoadBalancerTlsCertificateCallable(
      const DeleteLoadBalancerTlsCertificateRequestT& request) const {
    return SubmitCallable(&LightsailClient::DeleteLoadBalancerTlsCertificate, request);
  }

  /**
   * An Async wrapper for DeleteLoadBalancerTlsCertificate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteLoadBalancerTlsCertificateRequestT = Model::DeleteLoadBalancerTlsCertificateRequest>
  void DeleteLoadBalancerTlsCertificateAsync(const DeleteLoadBalancerTlsCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRelationalDatabaseRequestT = Model::DeleteRelationalDatabaseRequest>
  void DeleteRelationalDatabaseAsync(const DeleteRelationalDatabaseRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRelationalDatabaseSnapshotOutcome DeleteRelationalDatabaseSnapshot(
      const Model::DeleteRelationalDatabaseSnapshotRequest& request) const;

  /**
   * A Callable wrapper for DeleteRelationalDatabaseSnapshot that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteRelationalDatabaseSnapshotRequestT = Model::DeleteRelationalDatabaseSnapshotRequest>
  Model::DeleteRelationalDatabaseSnapshotOutcomeCallable DeleteRelationalDatabaseSnapshotCallable(
      const DeleteRelationalDatabaseSnapshotRequestT& request) const {
    return SubmitCallable(&LightsailClient::DeleteRelationalDatabaseSnapshot, request);
  }

  /**
   * An Async wrapper for DeleteRelationalDatabaseSnapshot that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteRelationalDatabaseSnapshotRequestT = Model::DeleteRelationalDatabaseSnapshotRequest>
  void DeleteRelationalDatabaseSnapshotAsync(const DeleteRelationalDatabaseSnapshotRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DetachCertificateFromDistributionOutcome DetachCertificateFromDistribution(
      const Model::DetachCertificateFromDistributionRequest& request) const;

  /**
   * A Callable wrapper for DetachCertificateFromDistribution that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DetachCertificateFromDistributionRequestT = Model::DetachCertificateFromDistributionRequest>
  Model::DetachCertificateFromDistributionOutcomeCallable DetachCertificateFromDistributionCallable(
      const DetachCertificateFromDistributionRequestT& request) const {
    return SubmitCallable(&LightsailClient::DetachCertificateFromDistribution, request);
  }

  /**
   * An Async wrapper for DetachCertificateFromDistribution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DetachCertificateFromDistributionRequestT = Model::DetachCertificateFromDistributionRequest>
  void DetachCertificateFromDistributionAsync(const DetachCertificateFromDistributionRequestT& request,
  ...
  /**
   * An Async wrapper for DetachDisk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetachDiskRequestT = Model::DetachDiskRequest>
  void DetachDiskAsync(const DetachDiskRequestT& request, const DetachDiskResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DetachInstancesFromLoadBalancerOutcome DetachInstancesFromLoadBalancer(
      const Model::DetachInstancesFromLoadBalancerRequest& request) const;

  /**
   * A Callable wrapper for DetachInstancesFromLoadBalancer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DetachInstancesFromLoadBalancerRequestT = Model::DetachInstancesFromLoadBalancerRequest>
  Model::DetachInstancesFromLoadBalancerOutcomeCallable DetachInstancesFromLoadBalancerCallable(
      const DetachInstancesFromLoadBalancerRequestT& request) const {
    return SubmitCallable(&LightsailClient::DetachInstancesFromLoadBalancer, request);
  }

  /**
   * An Async wrapper for DetachInstancesFromLoadBalancer that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DetachInstancesFromLoadBalancerRequestT = Model::DetachInstancesFromLoadBalancerRequest>
  void DetachInstancesFromLoadBalancerAsync(const DetachInstancesFromLoadBalancerRequestT& request,
  ...
  /**
   * An Async wrapper for DetachStaticIp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetachStaticIpRequestT = Model::DetachStaticIpRequest>
  void DetachStaticIpAsync(const DetachStaticIpRequestT& request, const DetachStaticIpResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DisableAddOn that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableAddOnRequestT = Model::DisableAddOnRequest>
  void DisableAddOnAsync(const DisableAddOnRequestT& request, const DisableAddOnResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DownloadDefaultKeyPair that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DownloadDefaultKeyPair that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DownloadDefaultKeyPairRequestT = Model::DownloadDefaultKeyPairRequest>
  void DownloadDefaultKeyPairAsync(const DownloadDefaultKeyPairResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DownloadDefaultKeyPairRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for EnableAddOn that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableAddOnRequestT = Model::EnableAddOnRequest>
  void EnableAddOnAsync(const EnableAddOnRequestT& request, const EnableAddOnResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ExportSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExportSnapshotRequestT = Model::ExportSnapshotRequest>
  void ExportSnapshotAsync(const ExportSnapshotRequestT& request, const ExportSnapshotResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetActiveNames that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetActiveNamesRequestT = Model::GetActiveNamesRequest>
  void GetActiveNamesAsync(const GetActiveNamesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetActiveNamesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetAlarms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAlarmsRequestT = Model::GetAlarmsRequest>
  void GetAlarmsAsync(const GetAlarmsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetAlarmsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetAutoSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAutoSnapshots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAutoSnapshotsRequestT = Model::GetAutoSnapshotsRequest>
  void GetAutoSnapshotsAsync(const GetAutoSnapshotsRequestT& request, const GetAutoSnapshotsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBlueprints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBlueprintsRequestT = Model::GetBlueprintsRequest>
  void GetBlueprintsAsync(const GetBlueprintsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetBlueprintsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBucketAccessKeys that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketAccessKeys that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketAccessKeysRequestT = Model::GetBucketAccessKeysRequest>
  void GetBucketAccessKeysAsync(const GetBucketAccessKeysRequestT& request, const GetBucketAccessKeysResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBucketBundles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketBundles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketBundlesRequestT = Model::GetBucketBundlesRequest>
  void GetBucketBundlesAsync(const GetBucketBundlesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetBucketBundlesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBucketMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBucketMetricData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBucketMetricDataRequestT = Model::GetBucketMetricDataRequest>
  void GetBucketMetricDataAsync(const GetBucketMetricDataRequestT& request, const GetBucketMetricDataResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetBuckets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBucketsRequestT = Model::GetBucketsRequest>
  void GetBucketsAsync(const GetBucketsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetBucketsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetBundles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBundlesRequestT = Model::GetBundlesRequest>
  void GetBundlesAsync(const GetBundlesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetBundlesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetCertificates that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCertificatesRequestT = Model::GetCertificatesRequest>
  void GetCertificatesAsync(const GetCertificatesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetCertificatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCloudFormationStackRecordsOutcome GetCloudFormationStackRecords(
      const Model::GetCloudFormationStackRecordsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetCloudFormationStackRecords that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCloudFormationStackRecordsRequestT = Model::GetCloudFormationStackRecordsRequest>
  Model::GetCloudFormationStackRecordsOutcomeCallable GetCloudFormationStackRecordsCallable(
      const GetCloudFormationStackRecordsRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetCloudFormationStackRecords, request);
  }

  /**
   * An Async wrapper for GetCloudFormationStackRecords that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCloudFormationStackRecordsRequestT = Model::GetCloudFormationStackRecordsRequest>
  void GetCloudFormationStackRecordsAsync(const GetCloudFormationStackRecordsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const GetCloudFormationStackRecordsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetContactMethods that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContactMethods that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetContactMethodsRequestT = Model::GetContactMethodsRequest>
  void GetContactMethodsAsync(const GetContactMethodsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetContactMethodsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetContainerAPIMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContainerAPIMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContainerAPIMetadataRequestT = Model::GetContainerAPIMetadataRequest>
  void GetContainerAPIMetadataAsync(const GetContainerAPIMetadataResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetContainerAPIMetadataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetContainerImages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContainerImages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetContainerImagesRequestT = Model::GetContainerImagesRequest>
  void GetContainerImagesAsync(const GetContainerImagesRequestT& request, const GetContainerImagesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetContainerLog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetContainerLogRequestT = Model::GetContainerLogRequest>
  void GetContainerLogAsync(const GetContainerLogRequestT& request, const GetContainerLogResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetContainerServiceDeploymentsOutcome GetContainerServiceDeployments(
      const Model::GetContainerServiceDeploymentsRequest& request) const;

  /**
   * A Callable wrapper for GetContainerServiceDeployments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetContainerServiceDeploymentsRequestT = Model::GetContainerServiceDeploymentsRequest>
  Model::GetContainerServiceDeploymentsOutcomeCallable GetContainerServiceDeploymentsCallable(
      const GetContainerServiceDeploymentsRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetContainerServiceDeployments, request);
  }

  /**
   * An Async wrapper for GetContainerServiceDeployments that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetContainerServiceDeploymentsRequestT = Model::GetContainerServiceDeploymentsRequest>
  void GetContainerServiceDeploymentsAsync(const GetContainerServiceDeploymentsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetContainerServiceMetricDataOutcome GetContainerServiceMetricData(
      const Model::GetContainerServiceMetricDataRequest& request) const;

  /**
   * A Callable wrapper for GetContainerServiceMetricData that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetContainerServiceMetricDataRequestT = Model::GetContainerServiceMetricDataRequest>
  Model::GetContainerServiceMetricDataOutcomeCallable GetContainerServiceMetricDataCallable(
      const GetContainerServiceMetricDataRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetContainerServiceMetricData, request);
  }

  /**
   * An Async wrapper for GetContainerServiceMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContainerServiceMetricDataRequestT = Model::GetContainerServiceMetricDataRequest>
  void GetContainerServiceMetricDataAsync(const GetContainerServiceMetricDataRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetContainerServicePowersOutcome GetContainerServicePowers(
      const Model::GetContainerServicePowersRequest& request = {}) const;

  /**
   * A Callable wrapper for GetContainerServicePowers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetContainerServicePowersRequestT = Model::GetContainerServicePowersRequest>
  Model::GetContainerServicePowersOutcomeCallable GetContainerServicePowersCallable(
      const GetContainerServicePowersRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetContainerServicePowers, request);
  }

  /**
   * An Async wrapper for GetContainerServicePowers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContainerServicePowersRequestT = Model::GetContainerServicePowersRequest>
  void GetContainerServicePowersAsync(const GetContainerServicePowersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GetContainerServicePowersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetContainerServices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContainerServices that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContainerServicesRequestT = Model::GetContainerServicesRequest>
  void GetContainerServicesAsync(const GetContainerServicesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetContainerServicesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetCostEstimate that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCostEstimateRequestT = Model::GetCostEstimateRequest>
  void GetCostEstimateAsync(const GetCostEstimateRequestT& request, const GetCostEstimateResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDisk that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDiskRequestT = Model::GetDiskRequest>
  void GetDiskAsync(const GetDiskRequestT& request, const GetDiskResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDiskSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDiskSnapshotRequestT = Model::GetDiskSnapshotRequest>
  void GetDiskSnapshotAsync(const GetDiskSnapshotRequestT& request, const GetDiskSnapshotResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDiskSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDiskSnapshots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDiskSnapshotsRequestT = Model::GetDiskSnapshotsRequest>
  void GetDiskSnapshotsAsync(const GetDiskSnapshotsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetDiskSnapshotsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDisks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDisksRequestT = Model::GetDisksRequest>
  void GetDisksAsync(const GetDisksResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const GetDisksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDistributionBundles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDistributionBundles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDistributionBundlesRequestT = Model::GetDistributionBundlesRequest>
  void GetDistributionBundlesAsync(const GetDistributionBundlesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetDistributionBundlesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDistributionLatestCacheResetOutcome GetDistributionLatestCacheReset(
      const Model::GetDistributionLatestCacheResetRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDistributionLatestCacheReset that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDistributionLatestCacheResetRequestT = Model::GetDistributionLatestCacheResetRequest>
  Model::GetDistributionLatestCacheResetOutcomeCallable GetDistributionLatestCacheResetCallable(
      const GetDistributionLatestCacheResetRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetDistributionLatestCacheReset, request);
  }

  /**
   * An Async wrapper for GetDistributionLatestCacheReset that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDistributionLatestCacheResetRequestT = Model::GetDistributionLatestCacheResetRequest>
  void GetDistributionLatestCacheResetAsync(const GetDistributionLatestCacheResetResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const GetDistributionLatestCacheResetRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDistributionMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetDistributionMetricDataRequestT = Model::GetDistributionMetricDataRequest>
  Model::GetDistributionMetricDataOutcomeCallable GetDistributionMetricDataCallable(
      const GetDistributionMetricDataRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetDistributionMetricData, request);
  }

  /**
   * An Async wrapper for GetDistributionMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDistributionMetricDataRequestT = Model::GetDistributionMetricDataRequest>
  void GetDistributionMetricDataAsync(const GetDistributionMetricDataRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDistributions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDistributions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDistributionsRequestT = Model::GetDistributionsRequest>
  void GetDistributionsAsync(const GetDistributionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetDistributionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDomains that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDomainsRequestT = Model::GetDomainsRequest>
  void GetDomainsAsync(const GetDomainsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetDomainsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetExportSnapshotRecords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetExportSnapshotRecordsRequestT = Model::GetExportSnapshotRecordsRequest>
  Model::GetExportSnapshotRecordsOutcomeCallable GetExportSnapshotRecordsCallable(
      const GetExportSnapshotRecordsRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetExportSnapshotRecords, request);
  }

  /**
   * An Async wrapper for GetExportSnapshotRecords that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetExportSnapshotRecordsRequestT = Model::GetExportSnapshotRecordsRequest>
  void GetExportSnapshotRecordsAsync(const GetExportSnapshotRecordsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const GetExportSnapshotRecordsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetInstanceAccessDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceAccessDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInstanceAccessDetailsRequestT = Model::GetInstanceAccessDetailsRequest>
  void GetInstanceAccessDetailsAsync(const GetInstanceAccessDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for GetInstanceMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInstanceMetricDataRequestT = Model::GetInstanceMetricDataRequest>
  void GetInstanceMetricDataAsync(const GetInstanceMetricDataRequestT& request, const GetInstanceMetricDataResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInstancePortStates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstancePortStates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInstancePortStatesRequestT = Model::GetInstancePortStatesRequest>
  void GetInstancePortStatesAsync(const GetInstancePortStatesRequestT& request, const GetInstancePortStatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInstanceSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInstanceSnapshotRequestT = Model::GetInstanceSnapshotRequest>
  void GetInstanceSnapshotAsync(const GetInstanceSnapshotRequestT& request, const GetInstanceSnapshotResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInstanceSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInstanceSnapshotsRequestT = Model::GetInstanceSnapshotsRequest>
  void GetInstanceSnapshotsAsync(const GetInstanceSnapshotsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetInstanceSnapshotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetInstanceState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInstanceState that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInstanceStateRequestT = Model::GetInstanceStateRequest>
  void GetInstanceStateAsync(const GetInstanceStateRequestT& request, const GetInstanceStateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetInstances that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetInstancesRequestT = Model::GetInstancesRequest>
  void GetInstancesAsync(const GetInstancesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetInstancesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetKeyPair that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKeyPairRequestT = Model::GetKeyPairRequest>
  void GetKeyPairAsync(const GetKeyPairRequestT& request, const GetKeyPairResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetKeyPairs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetKeyPairsRequestT = Model::GetKeyPairsRequest>
  void GetKeyPairsAsync(const GetKeyPairsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetKeyPairsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetLoadBalancer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLoadBalancerRequestT = Model::GetLoadBalancerRequest>
  void GetLoadBalancerAsync(const GetLoadBalancerRequestT& request, const GetLoadBalancerResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLoadBalancerMetricData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetLoadBalancerMetricDataRequestT = Model::GetLoadBalancerMetricDataRequest>
  Model::GetLoadBalancerMetricDataOutcomeCallable GetLoadBalancerMetricDataCallable(
      const GetLoadBalancerMetricDataRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetLoadBalancerMetricData, request);
  }

  /**
   * An Async wrapper for GetLoadBalancerMetricData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLoadBalancerMetricDataRequestT = Model::GetLoadBalancerMetricDataRequest>
  void GetLoadBalancerMetricDataAsync(const GetLoadBalancerMetricDataRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetLoadBalancerTlsCertificatesOutcome GetLoadBalancerTlsCertificates(
      const Model::GetLoadBalancerTlsCertificatesRequest& request) const;

  /**
   * A Callable wrapper for GetLoadBalancerTlsCertificates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetLoadBalancerTlsCertificatesRequestT = Model::GetLoadBalancerTlsCertificatesRequest>
  Model::GetLoadBalancerTlsCertificatesOutcomeCallable GetLoadBalancerTlsCertificatesCallable(
      const GetLoadBalancerTlsCertificatesRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetLoadBalancerTlsCertificates, request);
  }

  /**
   * An Async wrapper for GetLoadBalancerTlsCertificates that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetLoadBalancerTlsCertificatesRequestT = Model::GetLoadBalancerTlsCertificatesRequest>
  void GetLoadBalancerTlsCertificatesAsync(const GetLoadBalancerTlsCertificatesRequestT& request,
  ...
  virtual Model::GetLoadBalancerTlsPoliciesOutcome GetLoadBalancerTlsPolicies(
      const Model::GetLoadBalancerTlsPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetLoadBalancerTlsPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetLoadBalancerTlsPoliciesRequestT = Model::GetLoadBalancerTlsPoliciesRequest>
  Model::GetLoadBalancerTlsPoliciesOutcomeCallable GetLoadBalancerTlsPoliciesCallable(
      const GetLoadBalancerTlsPoliciesRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetLoadBalancerTlsPolicies, request);
  }

  /**
   * An Async wrapper for GetLoadBalancerTlsPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLoadBalancerTlsPoliciesRequestT = Model::GetLoadBalancerTlsPoliciesRequest>
  void GetLoadBalancerTlsPoliciesAsync(const GetLoadBalancerTlsPoliciesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const GetLoadBalancerTlsPoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetLoadBalancers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLoadBalancers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLoadBalancersRequestT = Model::GetLoadBalancersRequest>
  void GetLoadBalancersAsync(const GetLoadBalancersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetLoadBalancersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetOperations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOperationsRequestT = Model::GetOperationsRequest>
  void GetOperationsAsync(const GetOperationsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetOperationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetOperationsForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOperationsForResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOperationsForResourceRequestT = Model::GetOperationsForResourceRequest>
  void GetOperationsForResourceAsync(const GetOperationsForResourceRequestT& request,
  ...
  /**
   * An Async wrapper for GetRegions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRegionsRequestT = Model::GetRegionsRequest>
  void GetRegionsAsync(const GetRegionsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetRegionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRelationalDatabaseRequestT = Model::GetRelationalDatabaseRequest>
  void GetRelationalDatabaseAsync(const GetRelationalDatabaseRequestT& request, const GetRelationalDatabaseResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetRelationalDatabaseBlueprintsOutcome GetRelationalDatabaseBlueprints(
      const Model::GetRelationalDatabaseBlueprintsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseBlueprints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseBlueprintsRequestT = Model::GetRelationalDatabaseBlueprintsRequest>
  Model::GetRelationalDatabaseBlueprintsOutcomeCallable GetRelationalDatabaseBlueprintsCallable(
      const GetRelationalDatabaseBlueprintsRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseBlueprints, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseBlueprints that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseBlueprintsRequestT = Model::GetRelationalDatabaseBlueprintsRequest>
  void GetRelationalDatabaseBlueprintsAsync(const GetRelationalDatabaseBlueprintsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const GetRelationalDatabaseBlueprintsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseBundlesOutcome GetRelationalDatabaseBundles(
      const Model::GetRelationalDatabaseBundlesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseBundles that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseBundlesRequestT = Model::GetRelationalDatabaseBundlesRequest>
  Model::GetRelationalDatabaseBundlesOutcomeCallable GetRelationalDatabaseBundlesCallable(
      const GetRelationalDatabaseBundlesRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseBundles, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseBundles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRelationalDatabaseBundlesRequestT = Model::GetRelationalDatabaseBundlesRequest>
  void GetRelationalDatabaseBundlesAsync(const GetRelationalDatabaseBundlesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const GetRelationalDatabaseBundlesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseEventsOutcome GetRelationalDatabaseEvents(
      const Model::GetRelationalDatabaseEventsRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseEvents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseEventsRequestT = Model::GetRelationalDatabaseEventsRequest>
  Model::GetRelationalDatabaseEventsOutcomeCallable GetRelationalDatabaseEventsCallable(
      const GetRelationalDatabaseEventsRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseEvents, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRelationalDatabaseEventsRequestT = Model::GetRelationalDatabaseEventsRequest>
  void GetRelationalDatabaseEventsAsync(const GetRelationalDatabaseEventsRequestT& request,
  ...
  virtual Model::GetRelationalDatabaseLogEventsOutcome GetRelationalDatabaseLogEvents(
      const Model::GetRelationalDatabaseLogEventsRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseLogEvents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseLogEventsRequestT = Model::GetRelationalDatabaseLogEventsRequest>
  Model::GetRelationalDatabaseLogEventsOutcomeCallable GetRelationalDatabaseLogEventsCallable(
      const GetRelationalDatabaseLogEventsRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseLogEvents, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseLogEvents that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseLogEventsRequestT = Model::GetRelationalDatabaseLogEventsRequest>
  void GetRelationalDatabaseLogEventsAsync(const GetRelationalDatabaseLogEventsRequestT& request,
  ...
  virtual Model::GetRelationalDatabaseLogStreamsOutcome GetRelationalDatabaseLogStreams(
      const Model::GetRelationalDatabaseLogStreamsRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseLogStreams that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseLogStreamsRequestT = Model::GetRelationalDatabaseLogStreamsRequest>
  Model::GetRelationalDatabaseLogStreamsOutcomeCallable GetRelationalDatabaseLogStreamsCallable(
      const GetRelationalDatabaseLogStreamsRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseLogStreams, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseLogStreams that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseLogStreamsRequestT = Model::GetRelationalDatabaseLogStreamsRequest>
  void GetRelationalDatabaseLogStreamsAsync(const GetRelationalDatabaseLogStreamsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseMasterUserPasswordOutcome GetRelationalDatabaseMasterUserPassword(
      const Model::GetRelationalDatabaseMasterUserPasswordRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseMasterUserPassword that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetRelationalDatabaseMasterUserPasswordRequestT = Model::GetRelationalDatabaseMasterUserPasswordRequest>
  Model::GetRelationalDatabaseMasterUserPasswordOutcomeCallable GetRelationalDatabaseMasterUserPasswordCallable(
      const GetRelationalDatabaseMasterUserPasswordRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseMasterUserPassword, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseMasterUserPassword that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetRelationalDatabaseMasterUserPasswordRequestT = Model::GetRelationalDatabaseMasterUserPasswordRequest>
  void GetRelationalDatabaseMasterUserPasswordAsync(const GetRelationalDatabaseMasterUserPasswordRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseMetricDataOutcome GetRelationalDatabaseMetricData(
      const Model::GetRelationalDatabaseMetricDataRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseMetricData that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseMetricDataRequestT = Model::GetRelationalDatabaseMetricDataRequest>
  Model::GetRelationalDatabaseMetricDataOutcomeCallable GetRelationalDatabaseMetricDataCallable(
      const GetRelationalDatabaseMetricDataRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseMetricData, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseMetricData that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseMetricDataRequestT = Model::GetRelationalDatabaseMetricDataRequest>
  void GetRelationalDatabaseMetricDataAsync(const GetRelationalDatabaseMetricDataRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseParametersOutcome GetRelationalDatabaseParameters(
      const Model::GetRelationalDatabaseParametersRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseParameters that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseParametersRequestT = Model::GetRelationalDatabaseParametersRequest>
  Model::GetRelationalDatabaseParametersOutcomeCallable GetRelationalDatabaseParametersCallable(
      const GetRelationalDatabaseParametersRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseParameters, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseParameters that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseParametersRequestT = Model::GetRelationalDatabaseParametersRequest>
  void GetRelationalDatabaseParametersAsync(const GetRelationalDatabaseParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseSnapshotOutcome GetRelationalDatabaseSnapshot(
      const Model::GetRelationalDatabaseSnapshotRequest& request) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseSnapshotRequestT = Model::GetRelationalDatabaseSnapshotRequest>
  Model::GetRelationalDatabaseSnapshotOutcomeCallable GetRelationalDatabaseSnapshotCallable(
      const GetRelationalDatabaseSnapshotRequestT& request) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseSnapshot, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRelationalDatabaseSnapshotRequestT = Model::GetRelationalDatabaseSnapshotRequest>
  void GetRelationalDatabaseSnapshotAsync(const GetRelationalDatabaseSnapshotRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRelationalDatabaseSnapshotsOutcome GetRelationalDatabaseSnapshots(
      const Model::GetRelationalDatabaseSnapshotsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetRelationalDatabaseSnapshots that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRelationalDatabaseSnapshotsRequestT = Model::GetRelationalDatabaseSnapshotsRequest>
  Model::GetRelationalDatabaseSnapshotsOutcomeCallable GetRelationalDatabaseSnapshotsCallable(
      const GetRelationalDatabaseSnapshotsRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::GetRelationalDatabaseSnapshots, request);
  }

  /**
   * An Async wrapper for GetRelationalDatabaseSnapshots that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRelationalDatabaseSnapshotsRequestT = Model::GetRelationalDatabaseSnapshotsRequest>
  void GetRelationalDatabaseSnapshotsAsync(const GetRelationalDatabaseSnapshotsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const GetRelationalDatabaseSnapshotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRelationalDatabases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRelationalDatabases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRelationalDatabasesRequestT = Model::GetRelationalDatabasesRequest>
  void GetRelationalDatabasesAsync(const GetRelationalDatabasesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetRelationalDatabasesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSetupHistory that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSetupHistoryRequestT = Model::GetSetupHistoryRequest>
  void GetSetupHistoryAsync(const GetSetupHistoryRequestT& request, const GetSetupHistoryResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStaticIp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStaticIpRequestT = Model::GetStaticIpRequest>
  void GetStaticIpAsync(const GetStaticIpRequestT& request, const GetStaticIpResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStaticIps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStaticIpsRequestT = Model::GetStaticIpsRequest>
  void GetStaticIpsAsync(const GetStaticIpsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetStaticIpsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ImportKeyPair that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportKeyPairRequestT = Model::ImportKeyPairRequest>
  void ImportKeyPairAsync(const ImportKeyPairRequestT& request, const ImportKeyPairResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for IsVpcPeered that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename IsVpcPeeredRequestT = Model::IsVpcPeeredRequest>
  void IsVpcPeeredAsync(const IsVpcPeeredResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const IsVpcPeeredRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for OpenInstancePublicPorts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for OpenInstancePublicPorts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename OpenInstancePublicPortsRequestT = Model::OpenInstancePublicPortsRequest>
  void OpenInstancePublicPortsAsync(const OpenInstancePublicPortsRequestT& request,
                                    const OpenInstancePublicPortsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PeerVpc that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PeerVpcRequestT = Model::PeerVpcRequest>
  void PeerVpcAsync(const PeerVpcResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const PeerVpcRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAlarmRequestT = Model::PutAlarmRequest>
  void PutAlarmAsync(const PutAlarmRequestT& request, const PutAlarmResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutInstancePublicPorts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutInstancePublicPorts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutInstancePublicPortsRequestT = Model::PutInstancePublicPortsRequest>
  void PutInstancePublicPortsAsync(const PutInstancePublicPortsRequestT& request,
                                   const PutInstancePublicPortsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RebootInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RebootInstanceRequestT = Model::RebootInstanceRequest>
  void RebootInstanceAsync(const RebootInstanceRequestT& request, const RebootInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RebootRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebootRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RebootRelationalDatabaseRequestT = Model::RebootRelationalDatabaseRequest>
  void RebootRelationalDatabaseAsync(const RebootRelationalDatabaseRequestT& request,
                                     const RebootRelationalDatabaseResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterContainerImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterContainerImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterContainerImageRequestT = Model::RegisterContainerImageRequest>
  void RegisterContainerImageAsync(const RegisterContainerImageRequestT& request,
                                   const RegisterContainerImageResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReleaseStaticIp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReleaseStaticIpRequestT = Model::ReleaseStaticIpRequest>
  void ReleaseStaticIpAsync(const ReleaseStaticIpRequestT& request, const ReleaseStaticIpResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResetDistributionCache that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetDistributionCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetDistributionCacheRequestT = Model::ResetDistributionCacheRequest>
  void ResetDistributionCacheAsync(const ResetDistributionCacheResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ResetDistributionCacheRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SendContactMethodVerificationOutcome SendContactMethodVerification(
      const Model::SendContactMethodVerificationRequest& request) const;

  /**
   * A Callable wrapper for SendContactMethodVerification that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SendContactMethodVerificationRequestT = Model::SendContactMethodVerificationRequest>
  Model::SendContactMethodVerificationOutcomeCallable SendContactMethodVerificationCallable(
      const SendContactMethodVerificationRequestT& request) const {
    return SubmitCallable(&LightsailClient::SendContactMethodVerification, request);
  }

  /**
   * An Async wrapper for SendContactMethodVerification that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendContactMethodVerificationRequestT = Model::SendContactMethodVerificationRequest>
  void SendContactMethodVerificationAsync(const SendContactMethodVerificationRequestT& request,
                                          const SendContactMethodVerificationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetResourceAccessForBucketOutcome SetResourceAccessForBucket(
      const Model::SetResourceAccessForBucketRequest& request) const;

  /**
   * A Callable wrapper for SetResourceAccessForBucket that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetResourceAccessForBucketRequestT = Model::SetResourceAccessForBucketRequest>
  Model::SetResourceAccessForBucketOutcomeCallable SetResourceAccessForBucketCallable(
      const SetResourceAccessForBucketRequestT& request) const {
    return SubmitCallable(&LightsailClient::SetResourceAccessForBucket, request);
  }

  /**
   * An Async wrapper for SetResourceAccessForBucket that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetResourceAccessForBucketRequestT = Model::SetResourceAccessForBucketRequest>
  void SetResourceAccessForBucketAsync(const SetResourceAccessForBucketRequestT& request,
                                       const SetResourceAccessForBucketResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetupInstanceHttps that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetupInstanceHttps that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetupInstanceHttpsRequestT = Model::SetupInstanceHttpsRequest>
  void SetupInstanceHttpsAsync(const SetupInstanceHttpsRequestT& request, const SetupInstanceHttpsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartGUISession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartGUISessionRequestT = Model::StartGUISessionRequest>
  void StartGUISessionAsync(const StartGUISessionRequestT& request, const StartGUISessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartInstanceRequestT = Model::StartInstanceRequest>
  void StartInstanceAsync(const StartInstanceRequestT& request, const StartInstanceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartRelationalDatabaseRequestT = Model::StartRelationalDatabaseRequest>
  void StartRelationalDatabaseAsync(const StartRelationalDatabaseRequestT& request,
                                    const StartRelationalDatabaseResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopGUISession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopGUISessionRequestT = Model::StopGUISessionRequest>
  void StopGUISessionAsync(const StopGUISessionRequestT& request, const StopGUISessionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopInstanceRequestT = Model::StopInstanceRequest>
  void StopInstanceAsync(const StopInstanceRequestT& request, const StopInstanceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopRelationalDatabaseRequestT = Model::StopRelationalDatabaseRequest>
  void StopRelationalDatabaseAsync(const StopRelationalDatabaseRequestT& request,
                                   const StopRelationalDatabaseResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TestAlarm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestAlarmRequestT = Model::TestAlarmRequest>
  void TestAlarmAsync(const TestAlarmRequestT& request, const TestAlarmResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UnpeerVpc that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UnpeerVpcRequestT = Model::UnpeerVpcRequest>
  void UnpeerVpcAsync(const UnpeerVpcResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const UnpeerVpcRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateBucket that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateBucketRequestT = Model::UpdateBucketRequest>
  void UpdateBucketAsync(const UpdateBucketRequestT& request, const UpdateBucketResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBucketBundle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBucketBundle that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBucketBundleRequestT = Model::UpdateBucketBundleRequest>
  void UpdateBucketBundleAsync(const UpdateBucketBundleRequestT& request, const UpdateBucketBundleResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContainerService that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContainerService that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContainerServiceRequestT = Model::UpdateContainerServiceRequest>
  void UpdateContainerServiceAsync(const UpdateContainerServiceRequestT& request,
                                   const UpdateContainerServiceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDistribution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDistribution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDistributionRequestT = Model::UpdateDistributionRequest>
  void UpdateDistributionAsync(const UpdateDistributionRequestT& request, const UpdateDistributionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDistributionBundle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateDistributionBundleRequestT = Model::UpdateDistributionBundleRequest>
  Model::UpdateDistributionBundleOutcomeCallable UpdateDistributionBundleCallable(
      const UpdateDistributionBundleRequestT& request = {}) const {
    return SubmitCallable(&LightsailClient::UpdateDistributionBundle, request);
  }

  /**
   * An Async wrapper for UpdateDistributionBundle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDistributionBundleRequestT = Model::UpdateDistributionBundleRequest>
  void UpdateDistributionBundleAsync(const UpdateDistributionBundleResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const UpdateDistributionBundleRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainEntry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainEntry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDomainEntryRequestT = Model::UpdateDomainEntryRequest>
  void UpdateDomainEntryAsync(const UpdateDomainEntryRequestT& request, const UpdateDomainEntryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateInstanceMetadataOptionsOutcome UpdateInstanceMetadataOptions(
      const Model::UpdateInstanceMetadataOptionsRequest& request) const;

  /**
   * A Callable wrapper for UpdateInstanceMetadataOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateInstanceMetadataOptionsRequestT = Model::UpdateInstanceMetadataOptionsRequest>
  Model::UpdateInstanceMetadataOptionsOutcomeCallable UpdateInstanceMetadataOptionsCallable(
      const UpdateInstanceMetadataOptionsRequestT& request) const {
    return SubmitCallable(&LightsailClient::UpdateInstanceMetadataOptions, request);
  }

  /**
   * An Async wrapper for UpdateInstanceMetadataOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInstanceMetadataOptionsRequestT = Model::UpdateInstanceMetadataOptionsRequest>
  void UpdateInstanceMetadataOptionsAsync(const UpdateInstanceMetadataOptionsRequestT& request,
                                          const UpdateInstanceMetadataOptionsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateLoadBalancerAttributeOutcome UpdateLoadBalancerAttribute(
      const Model::UpdateLoadBalancerAttributeRequest& request) const;

  /**
   * A Callable wrapper for UpdateLoadBalancerAttribute that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateLoadBalancerAttributeRequestT = Model::UpdateLoadBalancerAttributeRequest>
  Model::UpdateLoadBalancerAttributeOutcomeCallable UpdateLoadBalancerAttributeCallable(
      const UpdateLoadBalancerAttributeRequestT& request) const {
    return SubmitCallable(&LightsailClient::UpdateLoadBalancerAttribute, request);
  }

  /**
   * An Async wrapper for UpdateLoadBalancerAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateLoadBalancerAttributeRequestT = Model::UpdateLoadBalancerAttributeRequest>
  void UpdateLoadBalancerAttributeAsync(const UpdateLoadBalancerAttributeRequestT& request,
                                        const UpdateLoadBalancerAttributeResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRelationalDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRelationalDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRelationalDatabaseRequestT = Model::UpdateRelationalDatabaseRequest>
  void UpdateRelationalDatabaseAsync(const UpdateRelationalDatabaseRequestT& request,
                                     const UpdateRelationalDatabaseResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateRelationalDatabaseParametersOutcome UpdateRelationalDatabaseParameters(
      const Model::UpdateRelationalDatabaseParametersRequest& request) const;

  /**
   * A Callable wrapper for UpdateRelationalDatabaseParameters that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateRelationalDatabaseParametersRequestT = Model::UpdateRelationalDatabaseParametersRequest>
  Model::UpdateRelationalDatabaseParametersOutcomeCallable UpdateRelationalDatabaseParametersCallable(
      const UpdateRelationalDatabaseParametersRequestT& request) const {
    return SubmitCallable(&LightsailClient::UpdateRelationalDatabaseParameters, request);
  }

  /**
   * An Async wrapper for UpdateRelationalDatabaseParameters that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateRelationalDatabaseParametersRequestT = Model::UpdateRelationalDatabaseParametersRequest>
  void UpdateRelationalDatabaseParametersAsync(const UpdateRelationalDatabaseParametersRequestT& request,
                                               const UpdateRelationalDatabaseParametersResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
