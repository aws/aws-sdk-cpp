...
Bucket::Bucket(JsonView jsonValue) { *this = jsonValue; }
...
Bucket& Bucket::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("readonlyAccessAccounts")) {
    ...
    for (unsigned readonlyAccessAccountsIndex = 0; readonlyAccessAccountsIndex < readonlyAccessAccountsJsonList.GetLength();
         ++readonlyAccessAccountsIndex) {
  ...
  if (jsonValue.ValueExists("resourcesReceivingAccess")) {
    ...
    for (unsigned resourcesReceivingAccessIndex = 0; resourcesReceivingAccessIndex < resourcesReceivingAccessJsonList.GetLength();
         ++resourcesReceivingAccessIndex) {
...
JsonValue Bucket::Jsonize() const {
  ...
  if (m_resourcesReceivingAccessHasBeenSet) {
    ...
    for (unsigned resourcesReceivingAccessIndex = 0; resourcesReceivingAccessIndex < resourcesReceivingAccessJsonList.GetLength();
         ++resourcesReceivingAccessIndex) {
      resourcesReceivingAccessJsonList[resourcesReceivingAccessIndex].AsObject(
          m_resourcesReceivingAccess[resourcesReceivingAccessIndex].Jsonize());
    }
