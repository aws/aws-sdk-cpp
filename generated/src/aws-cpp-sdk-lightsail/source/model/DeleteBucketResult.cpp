...
DeleteBucketResult::DeleteBucketResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteBucketResult& DeleteBucketResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
