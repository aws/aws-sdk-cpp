...
StopGUISessionResult::StopGUISessionResult()
{
}

StopGUISessionResult::StopGUISessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

StopGUISessionResult& StopGUISessionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
