...
TestAlarmResult::TestAlarmResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

TestAlarmResult& TestAlarmResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
