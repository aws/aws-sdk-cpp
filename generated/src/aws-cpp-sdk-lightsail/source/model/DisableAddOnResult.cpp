...
DisableAddOnResult::DisableAddOnResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DisableAddOnResult& DisableAddOnResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
