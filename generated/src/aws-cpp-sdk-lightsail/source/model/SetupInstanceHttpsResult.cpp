...
SetupInstanceHttpsResult::SetupInstanceHttpsResult()
{
}

SetupInstanceHttpsResult::SetupInstanceHttpsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

SetupInstanceHttpsResult& SetupInstanceHttpsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
