...
GetOperationsResult::GetOperationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetOperationsResult& GetOperationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
