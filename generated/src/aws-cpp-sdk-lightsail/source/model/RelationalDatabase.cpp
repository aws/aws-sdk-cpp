...
RelationalDatabase::RelationalDatabase(JsonView jsonValue) { *this = jsonValue; }
...
RelationalDatabase& RelationalDatabase::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("pendingMaintenanceActions")) {
    ...
    for (unsigned pendingMaintenanceActionsIndex = 0; pendingMaintenanceActionsIndex < pendingMaintenanceActionsJsonList.GetLength();
         ++pendingMaintenanceActionsIndex) {
...
JsonValue RelationalDatabase::Jsonize() const {
  ...
  if (m_pendingMaintenanceActionsHasBeenSet) {
    ...
    for (unsigned pendingMaintenanceActionsIndex = 0; pendingMaintenanceActionsIndex < pendingMaintenanceActionsJsonList.GetLength();
         ++pendingMaintenanceActionsIndex) {
      pendingMaintenanceActionsJsonList[pendingMaintenanceActionsIndex].AsObject(
          m_pendingMaintenanceActions[pendingMaintenanceActionsIndex].Jsonize());
    }
