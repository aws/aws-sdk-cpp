...
CreateBucketResult::CreateBucketResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateBucketResult& CreateBucketResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
