...
EnableAddOnResult::EnableAddOnResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

EnableAddOnResult& EnableAddOnResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
