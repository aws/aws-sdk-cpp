...
DeleteLoadBalancerResult::DeleteLoadBalancerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteLoadBalancerResult& DeleteLoadBalancerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
