...
DeleteInstanceSnapshotResult::DeleteInstanceSnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteInstanceSnapshotResult& DeleteInstanceSnapshotResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
