...
Region& Region::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("relationalDatabaseAvailabilityZones")) {
    ...
    for (unsigned relationalDatabaseAvailabilityZonesIndex = 0;
         relationalDatabaseAvailabilityZonesIndex < relationalDatabaseAvailabilityZonesJsonList.GetLength();
         ++relationalDatabaseAvailabilityZonesIndex) {
      m_relationalDatabaseAvailabilityZones.push_back(
          relationalDatabaseAvailabilityZonesJsonList[relationalDatabaseAvailabilityZonesIndex].AsObject());
    }
...
JsonValue Region::Jsonize() const {
  ...
  if (m_relationalDatabaseAvailabilityZonesHasBeenSet) {
    ...
    for (unsigned relationalDatabaseAvailabilityZonesIndex = 0;
         ...
         ++relationalDatabaseAvailabilityZonesIndex) {
      relationalDatabaseAvailabilityZonesJsonList[relationalDatabaseAvailabilityZonesIndex].AsObject(
          m_relationalDatabaseAvailabilityZones[relationalDatabaseAvailabilityZonesIndex].Jsonize());
    }
