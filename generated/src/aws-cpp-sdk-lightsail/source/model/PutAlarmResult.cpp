...
PutAlarmResult::PutAlarmResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

PutAlarmResult& PutAlarmResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
