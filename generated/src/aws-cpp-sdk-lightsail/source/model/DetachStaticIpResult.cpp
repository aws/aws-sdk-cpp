...
DetachStaticIpResult::DetachStaticIpResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DetachStaticIpResult& DetachStaticIpResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
