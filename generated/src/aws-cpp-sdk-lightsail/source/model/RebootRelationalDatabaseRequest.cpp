...
Aws::Http::HeaderValueCollection RebootRelationalDatabaseRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "Lightsail_20161128.RebootRelationalDatabase"));
  return headers;
