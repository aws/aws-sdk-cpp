...
DeleteLoadBalancerTlsCertificateResult::DeleteLoadBalancerTlsCertificateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DeleteLoadBalancerTlsCertificateResult& DeleteLoadBalancerTlsCertificateResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
