...
class ServiceSettings {
 public:
  ...
  void SetExplorerEnablingRoleArn(ExplorerEnablingRoleArnT&& value) {
    m_explorerEnablingRoleArnHasBeenSet = true;
    m_explorerEnablingRoleArn = std::forward<ExplorerEnablingRoleArnT>(value);
  }
  template <typename ExplorerEnablingRoleArnT = Aws::String>
  ServiceSettings& WithExplorerEnablingRoleArn(ExplorerEnablingRoleArnT&& value) {
    SetExplorerEnablingRoleArn(std::forward<ExplorerEnablingRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
