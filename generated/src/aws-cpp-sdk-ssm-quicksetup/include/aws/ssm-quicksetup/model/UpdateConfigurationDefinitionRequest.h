...
class UpdateConfigurationDefinitionRequest : public SSMQuickSetupRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateConfigurationDefinitionRequest& WithId(IdT&& value) {
  ...
  void SetLocalDeploymentAdministrationRoleArn(LocalDeploymentAdministrationRoleArnT&& value) {
    m_localDeploymentAdministrationRoleArnHasBeenSet = true;
    m_localDeploymentAdministrationRoleArn = std::forward<LocalDeploymentAdministrationRoleArnT>(value);
  }
  template <typename LocalDeploymentAdministrationRoleArnT = Aws::String>
  UpdateConfigurationDefinitionRequest& WithLocalDeploymentAdministrationRoleArn(LocalDeploymentAdministrationRoleArnT&& value) {
    SetLocalDeploymentAdministrationRoleArn(std::forward<LocalDeploymentAdministrationRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalDeploymentExecutionRoleName(LocalDeploymentExecutionRoleNameT&& value) {
    m_localDeploymentExecutionRoleNameHasBeenSet = true;
    m_localDeploymentExecutionRoleName = std::forward<LocalDeploymentExecutionRoleNameT>(value);
  }
  template <typename LocalDeploymentExecutionRoleNameT = Aws::String>
  UpdateConfigurationDefinitionRequest& WithLocalDeploymentExecutionRoleName(LocalDeploymentExecutionRoleNameT&& value) {
    SetLocalDeploymentExecutionRoleName(std::forward<LocalDeploymentExecutionRoleNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ManagerArnT = Aws::String>
  UpdateConfigurationDefinitionRequest& WithManagerArn(ManagerArnT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  UpdateConfigurationDefinitionRequest& WithParameters(ParametersT&& value) {
  ...
  template <typename TypeVersionT = Aws::String>
  UpdateConfigurationDefinitionRequest& WithTypeVersion(TypeVersionT&& value) {
