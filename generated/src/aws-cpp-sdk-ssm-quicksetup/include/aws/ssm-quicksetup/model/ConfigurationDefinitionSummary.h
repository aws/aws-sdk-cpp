...
class ConfigurationDefinitionSummary {
 public:
  ...
  template <typename FirstClassParametersT = Aws::Map<Aws::String, Aws::String>>
  ConfigurationDefinitionSummary& WithFirstClassParameters(FirstClassParametersT&& value) {
  ...
  template <typename IdT = Aws::String>
  ConfigurationDefinitionSummary& WithId(IdT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ConfigurationDefinitionSummary& WithType(TypeT&& value) {
  ...
  template <typename TypeVersionT = Aws::String>
  ConfigurationDefinitionSummary& WithTypeVersion(TypeVersionT&& value) {
