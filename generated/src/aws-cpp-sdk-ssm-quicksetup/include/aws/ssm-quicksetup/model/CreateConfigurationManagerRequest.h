...
class CreateConfigurationManagerRequest : public SSMQuickSetupRequest {
 public:
  ...
  template <typename ConfigurationDefinitionsT = Aws::Vector<ConfigurationDefinitionInput>>
  CreateConfigurationManagerRequest& WithConfigurationDefinitions(ConfigurationDefinitionsT&& value) {
  ...
  CreateConfigurationManagerRequest& AddConfigurationDefinitions(ConfigurationDefinitionsT&& value) {
    m_configurationDefinitionsHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  CreateConfigurationManagerRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateConfigurationManagerRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateConfigurationManagerRequest& WithTags(TagsT&& value) {
