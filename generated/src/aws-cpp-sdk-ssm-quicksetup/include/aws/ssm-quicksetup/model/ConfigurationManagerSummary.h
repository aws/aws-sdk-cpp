...
class ConfigurationManagerSummary {
 public:
   ...
   */
  inline const Aws::Vector<ConfigurationDefinitionSummary>& GetConfigurationDefinitionSummaries() const {
    return m_configurationDefinitionSummaries;
  }
  ...
  void SetConfigurationDefinitionSummaries(ConfigurationDefinitionSummariesT&& value) {
    m_configurationDefinitionSummariesHasBeenSet = true;
    m_configurationDefinitionSummaries = std::forward<ConfigurationDefinitionSummariesT>(value);
  }
  template <typename ConfigurationDefinitionSummariesT = Aws::Vector<ConfigurationDefinitionSummary>>
  ConfigurationManagerSummary& WithConfigurationDefinitionSummaries(ConfigurationDefinitionSummariesT&& value) {
    SetConfigurationDefinitionSummaries(std::forward<ConfigurationDefinitionSummariesT>(value));
    return *this;
  }
  template <typename ConfigurationDefinitionSummariesT = ConfigurationDefinitionSummary>
  ConfigurationManagerSummary& AddConfigurationDefinitionSummaries(ConfigurationDefinitionSummariesT&& value) {
    m_configurationDefinitionSummariesHasBeenSet = true;
    m_configurationDefinitionSummaries.emplace_back(std::forward<ConfigurationDefinitionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ConfigurationManagerSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename ManagerArnT = Aws::String>
  ConfigurationManagerSummary& WithManagerArn(ManagerArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ConfigurationManagerSummary& WithName(NameT&& value) {
  ...
  template <typename StatusSummariesT = Aws::Vector<StatusSummary>>
  ConfigurationManagerSummary& WithStatusSummaries(StatusSummariesT&& value) {
    SetStatusSummaries(std::forward<StatusSummariesT>(value));
    return *this;
  }
  template <typename StatusSummariesT = StatusSummary>
  ConfigurationManagerSummary& AddStatusSummaries(StatusSummariesT&& value) {
    m_statusSummariesHasBeenSet = true;
