...
class ListConfigurationManagersResult {
 public:
  ...
  void SetConfigurationManagersList(ConfigurationManagersListT&& value) {
    m_configurationManagersListHasBeenSet = true;
    m_configurationManagersList = std::forward<ConfigurationManagersListT>(value);
  }
  template <typename ConfigurationManagersListT = Aws::Vector<ConfigurationManagerSummary>>
  ListConfigurationManagersResult& WithConfigurationManagersList(ConfigurationManagersListT&& value) {
    SetConfigurationManagersList(std::forward<ConfigurationManagersListT>(value));
    return *this;
  }
  template <typename ConfigurationManagersListT = ConfigurationManagerSummary>
  ListConfigurationManagersResult& AddConfigurationManagersList(ConfigurationManagersListT&& value) {
    m_configurationManagersListHasBeenSet = true;
    m_configurationManagersList.emplace_back(std::forward<ConfigurationManagersListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationManagersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationManagersResult& WithRequestId(RequestIdT&& value) {
