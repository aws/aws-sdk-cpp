...
class ListConfigurationsRequest : public SSMQuickSetupRequest {
 public:
  ...
  template <typename ConfigurationDefinitionIdT = Aws::String>
  ListConfigurationsRequest& WithConfigurationDefinitionId(ConfigurationDefinitionIdT&& value) {
  ...
  template <typename ManagerArnT = Aws::String>
  ListConfigurationsRequest& WithManagerArn(ManagerArnT&& value) {
  ...
  inline ListConfigurationsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
