...
class ConfigurationDefinition {
 public:
  ...
  template <typename IdT = Aws::String>
  ConfigurationDefinition& WithId(IdT&& value) {
  ...
  template <typename LocalDeploymentAdministrationRoleArnT = Aws::String>
  ConfigurationDefinition& WithLocalDeploymentAdministrationRoleArn(LocalDeploymentAdministrationRoleArnT&& value) {
  ...
  template <typename LocalDeploymentExecutionRoleNameT = Aws::String>
  ConfigurationDefinition& WithLocalDeploymentExecutionRoleName(LocalDeploymentExecutionRoleNameT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  ConfigurationDefinition& WithParameters(ParametersT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ConfigurationDefinition& WithType(TypeT&& value) {
  ...
  template <typename TypeVersionT = Aws::String>
  ConfigurationDefinition& WithTypeVersion(TypeVersionT&& value) {
