...
class StatusSummary {
 public:
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  StatusSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline StatusSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = Aws::Map<Aws::String, Aws::String>>
  StatusSummary& WithStatusDetails(StatusDetailsT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  StatusSummary& WithStatusMessage(StatusMessageT&& value) {
  ...
  inline void SetStatusType(StatusType value) {
    m_statusTypeHasBeenSet = true;
    m_statusType = value;
  }
  inline StatusSummary& WithStatusType(StatusType value) {
    SetStatusType(value);
    return *this;
  }
  ///@}
