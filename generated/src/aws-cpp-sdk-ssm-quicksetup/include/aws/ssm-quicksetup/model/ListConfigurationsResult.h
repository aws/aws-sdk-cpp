...
class ListConfigurationsResult {
 public:
  ...
  void SetConfigurationsList(ConfigurationsListT&& value) {
    m_configurationsListHasBeenSet = true;
    m_configurationsList = std::forward<ConfigurationsListT>(value);
  }
  template <typename ConfigurationsListT = Aws::Vector<ConfigurationSummary>>
  ListConfigurationsResult& WithConfigurationsList(ConfigurationsListT&& value) {
    SetConfigurationsList(std::forward<ConfigurationsListT>(value));
    return *this;
  }
  template <typename ConfigurationsListT = ConfigurationSummary>
  ListConfigurationsResult& AddConfigurationsList(ConfigurationsListT&& value) {
    m_configurationsListHasBeenSet = true;
    m_configurationsList.emplace_back(std::forward<ConfigurationsListT>(value));
    return *this;
  }
  ///@}
