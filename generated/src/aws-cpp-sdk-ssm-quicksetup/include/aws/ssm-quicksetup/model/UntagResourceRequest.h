...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public SSMQuickSetupRequest
  {
  public:
    AWS_SSMQUICKSETUP_API UntagResourceRequest() = default;
    ...
    AWS_SSMQUICKSETUP_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
