...
class ConfigurationDefinitionInput {
 public:
  ...
  template <typename LocalDeploymentAdministrationRoleArnT = Aws::String>
  ConfigurationDefinitionInput& WithLocalDeploymentAdministrationRoleArn(LocalDeploymentAdministrationRoleArnT&& value) {
  ...
  template <typename LocalDeploymentExecutionRoleNameT = Aws::String>
  ConfigurationDefinitionInput& WithLocalDeploymentExecutionRoleName(LocalDeploymentExecutionRoleNameT&& value) {
  ...
  template <typename ParametersT = Aws::Map<Aws::String, Aws::String>>
  ConfigurationDefinitionInput& WithParameters(ParametersT&& value) {
  ...
  template <typename TypeT = Aws::String>
  ConfigurationDefinitionInput& WithType(TypeT&& value) {
  ...
  template <typename TypeVersionT = Aws::String>
  ConfigurationDefinitionInput& WithTypeVersion(TypeVersionT&& value) {
