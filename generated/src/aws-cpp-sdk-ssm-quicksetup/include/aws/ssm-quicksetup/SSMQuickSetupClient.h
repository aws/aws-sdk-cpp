...
namespace SSMQuickSetup
{
   ...
   */
  class AWS_SSMQUICKSETUP_API SSMQuickSetupClient : Aws::Client::ClientWithAsyncTemplateMethods<SSMQuickSetupClient>,
    smithy::client::AwsSmithyClientT<Aws::SSMQuickSetup::SERVICE_NAME,
