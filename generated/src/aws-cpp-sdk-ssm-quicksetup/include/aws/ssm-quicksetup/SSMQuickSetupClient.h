...
class AWS_SSMQUICKSETUP_API SSMQuickSetupClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SSMQuickSetupClient(const Aws::SSMQuickSetup::SSMQuickSetupClientConfiguration& clientConfiguration =
  ...
  SSMQuickSetupClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<SSMQuickSetupEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::SSMQuickSetup::SSMQuickSetupClientConfiguration& clientConfiguration =
                          Aws::SSMQuickSetup::SSMQuickSetupClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  SSMQuickSetupClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfigurationManagerOutcome CreateConfigurationManager(
      const Model::CreateConfigurationManagerRequest& request) const;

  /**
   * A Callable wrapper for CreateConfigurationManager that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConfigurationManagerRequestT = Model::CreateConfigurationManagerRequest>
  Model::CreateConfigurationManagerOutcomeCallable CreateConfigurationManagerCallable(
      const CreateConfigurationManagerRequestT& request) const {
    return SubmitCallable(&SSMQuickSetupClient::CreateConfigurationManager, request);
  }

  /**
   * An Async wrapper for CreateConfigurationManager that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConfigurationManagerRequestT = Model::CreateConfigurationManagerRequest>
  void CreateConfigurationManagerAsync(const CreateConfigurationManagerRequestT& request,
                                       const CreateConfigurationManagerResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfigurationManagerOutcome DeleteConfigurationManager(
      const Model::DeleteConfigurationManagerRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfigurationManager that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfigurationManagerRequestT = Model::DeleteConfigurationManagerRequest>
  Model::DeleteConfigurationManagerOutcomeCallable DeleteConfigurationManagerCallable(
      const DeleteConfigurationManagerRequestT& request) const {
    return SubmitCallable(&SSMQuickSetupClient::DeleteConfigurationManager, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationManager that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfigurationManagerRequestT = Model::DeleteConfigurationManagerRequest>
  void DeleteConfigurationManagerAsync(const DeleteConfigurationManagerRequestT& request,
                                       const DeleteConfigurationManagerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConfigurationManager that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConfigurationManager that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConfigurationManagerRequestT = Model::GetConfigurationManagerRequest>
  void GetConfigurationManagerAsync(const GetConfigurationManagerRequestT& request,
                                    const GetConfigurationManagerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfigurationManagersOutcome ListConfigurationManagers(
      const Model::ListConfigurationManagersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfigurationManagers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListConfigurationManagersRequestT = Model::ListConfigurationManagersRequest>
  Model::ListConfigurationManagersOutcomeCallable ListConfigurationManagersCallable(
      const ListConfigurationManagersRequestT& request = {}) const {
    return SubmitCallable(&SSMQuickSetupClient::ListConfigurationManagers, request);
  }

  /**
   * An Async wrapper for ListConfigurationManagers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfigurationManagersRequestT = Model::ListConfigurationManagersRequest>
  void ListConfigurationManagersAsync(const ListConfigurationManagersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListConfigurationManagersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListQuickSetupTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQuickSetupTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQuickSetupTypesRequestT = Model::ListQuickSetupTypesRequest>
  void ListQuickSetupTypesAsync(const ListQuickSetupTypesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListQuickSetupTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfigurationDefinitionOutcome UpdateConfigurationDefinition(
      const Model::UpdateConfigurationDefinitionRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConfigurationDefinitionRequestT = Model::UpdateConfigurationDefinitionRequest>
  Model::UpdateConfigurationDefinitionOutcomeCallable UpdateConfigurationDefinitionCallable(
      const UpdateConfigurationDefinitionRequestT& request) const {
    return SubmitCallable(&SSMQuickSetupClient::UpdateConfigurationDefinition, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfigurationDefinitionRequestT = Model::UpdateConfigurationDefinitionRequest>
  void UpdateConfigurationDefinitionAsync(const UpdateConfigurationDefinitionRequestT& request,
                                          const UpdateConfigurationDefinitionResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfigurationManagerOutcome UpdateConfigurationManager(
      const Model::UpdateConfigurationManagerRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationManager that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConfigurationManagerRequestT = Model::UpdateConfigurationManagerRequest>
  Model::UpdateConfigurationManagerOutcomeCallable UpdateConfigurationManagerCallable(
      const UpdateConfigurationManagerRequestT& request) const {
    return SubmitCallable(&SSMQuickSetupClient::UpdateConfigurationManager, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationManager that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfigurationManagerRequestT = Model::UpdateConfigurationManagerRequest>
  void UpdateConfigurationManagerAsync(const UpdateConfigurationManagerRequestT& request,
                                       const UpdateConfigurationManagerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<SSMQuickSetupEndpointProviderBase>& accessEndpointProvider();
