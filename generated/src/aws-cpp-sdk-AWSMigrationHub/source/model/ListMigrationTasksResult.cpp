...
ListMigrationTasksResult::ListMigrationTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMigrationTasksResult& ListMigrationTasksResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MigrationTaskSummaryList")) {
    ...
    for (unsigned migrationTaskSummaryListIndex = 0; migrationTaskSummaryListIndex < migrationTaskSummaryListJsonList.GetLength();
         ++migrationTaskSummaryListIndex) {
