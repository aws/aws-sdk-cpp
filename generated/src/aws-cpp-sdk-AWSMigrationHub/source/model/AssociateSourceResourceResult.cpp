...
AssociateSourceResourceResult::AssociateSourceResourceResult()
{
}

AssociateSourceResourceResult::AssociateSourceResourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
