...
ListMigrationTaskUpdatesResult::ListMigrationTaskUpdatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMigrationTaskUpdatesResult& ListMigrationTaskUpdatesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MigrationTaskUpdateList")) {
    ...
    for (unsigned migrationTaskUpdateListIndex = 0; migrationTaskUpdateListIndex < migrationTaskUpdateListJsonList.GetLength();
         ++migrationTaskUpdateListIndex) {
