...
ListSourceResourcesResult::ListSourceResourcesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListSourceResourcesResult& ListSourceResourcesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SourceResourceList")) {
    ...
    for (unsigned sourceResourceListIndex = 0; sourceResourceListIndex < sourceResourceListJsonList.GetLength();
         ++sourceResourceListIndex) {
      m_sourceResourceList.push_back(sourceResourceListJsonList[sourceResourceListIndex].AsObject());
    }
    m_sourceResourceListHasBeenSet = true;
  }
