...
DisassociateSourceResourceResult::DisassociateSourceResourceResult()
{
}

DisassociateSourceResourceResult::DisassociateSourceResourceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
