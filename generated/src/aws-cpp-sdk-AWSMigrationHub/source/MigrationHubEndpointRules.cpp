...
{
const size_t MigrationHubEndpointRules::RulesBlobStrLen = 3460;
const size_t MigrationHubEndpointRules::RulesBlobSize = 3461;
...
':','/','/','m','g','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'p','s',':','/','/','m','g','h','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* MigrationHubEndpointRules::GetRulesBlob()
{
