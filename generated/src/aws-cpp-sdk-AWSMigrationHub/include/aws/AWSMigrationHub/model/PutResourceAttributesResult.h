...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUB_API PutResourceAttributesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutResourceAttributesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
