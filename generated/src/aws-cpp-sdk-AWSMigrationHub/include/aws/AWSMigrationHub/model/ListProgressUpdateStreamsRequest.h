...
class ListProgressUpdateStreamsRequest : public MigrationHubRequest {
 public:
  AWS_MIGRATIONHUB_API ListProgressUpdateStreamsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListProgressUpdateStreamsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProgressUpdateStreamsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
