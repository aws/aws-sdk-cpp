...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUB_API AssociateDiscoveredResourceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateDiscoveredResourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
