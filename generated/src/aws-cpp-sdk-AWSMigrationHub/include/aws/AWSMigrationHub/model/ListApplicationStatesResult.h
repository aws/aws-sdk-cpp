...
class ListApplicationStatesResult {
 public:
  ...
  void SetApplicationStateList(ApplicationStateListT&& value) {
    m_applicationStateListHasBeenSet = true;
    m_applicationStateList = std::forward<ApplicationStateListT>(value);
  }
  template <typename ApplicationStateListT = Aws::Vector<ApplicationState>>
  ListApplicationStatesResult& WithApplicationStateList(ApplicationStateListT&& value) {
    SetApplicationStateList(std::forward<ApplicationStateListT>(value));
    return *this;
  }
  template <typename ApplicationStateListT = ApplicationState>
  ListApplicationStatesResult& AddApplicationStateList(ApplicationStateListT&& value) {
    m_applicationStateListHasBeenSet = true;
    m_applicationStateList.emplace_back(std::forward<ApplicationStateListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationStatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationStatesResult& WithRequestId(RequestIdT&& value) {
