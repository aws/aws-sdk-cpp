...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUB_API DisassociateCreatedArtifactResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateCreatedArtifactResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
