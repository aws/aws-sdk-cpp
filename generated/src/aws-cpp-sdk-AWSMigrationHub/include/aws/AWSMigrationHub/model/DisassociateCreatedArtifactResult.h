...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateCreatedArtifactResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateCreatedArtifactResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateCreatedArtifactResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
