...
class ListDiscoveredResourcesResult {
 public:
  ...
  void SetDiscoveredResourceList(DiscoveredResourceListT&& value) {
    m_discoveredResourceListHasBeenSet = true;
    m_discoveredResourceList = std::forward<DiscoveredResourceListT>(value);
  }
  template <typename DiscoveredResourceListT = Aws::Vector<DiscoveredResource>>
  ListDiscoveredResourcesResult& WithDiscoveredResourceList(DiscoveredResourceListT&& value) {
    SetDiscoveredResourceList(std::forward<DiscoveredResourceListT>(value));
    return *this;
  }
  template <typename DiscoveredResourceListT = DiscoveredResource>
  ListDiscoveredResourcesResult& AddDiscoveredResourceList(DiscoveredResourceListT&& value) {
    m_discoveredResourceListHasBeenSet = true;
    m_discoveredResourceList.emplace_back(std::forward<DiscoveredResourceListT>(value));
    return *this;
  }
  ///@}
