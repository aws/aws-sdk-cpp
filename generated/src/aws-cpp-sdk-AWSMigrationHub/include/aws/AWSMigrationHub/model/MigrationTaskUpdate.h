...
class MigrationTaskUpdate {
 public:
  ...
  inline void SetUpdateType(UpdateType value) {
    m_updateTypeHasBeenSet = true;
    m_updateType = value;
  }
  inline MigrationTaskUpdate& WithUpdateType(UpdateType value) {
    SetUpdateType(value);
    return *this;
  }
  ///@}
  ...
  void SetMigrationTaskState(MigrationTaskStateT&& value) {
    ...
    m_migrationTaskState = std::forward<MigrationTaskStateT>(value);
  }
  template <typename MigrationTaskStateT = Task>
  MigrationTaskUpdate& WithMigrationTaskState(MigrationTaskStateT&& value) {
    SetMigrationTaskState(std::forward<MigrationTaskStateT>(value));
    return *this;
  }
  ///@}
 private:
