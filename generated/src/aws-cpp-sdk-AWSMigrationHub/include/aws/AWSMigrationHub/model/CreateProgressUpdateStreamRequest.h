...
namespace Model
{
  ...
  public:
    ...
    template<typename ProgressUpdateStreamNameT = Aws::String>
    CreateProgressUpdateStreamRequest& WithProgressUpdateStreamName(ProgressUpdateStreamNameT&& value) { SetProgressUpdateStreamName(std::forward<ProgressUpdateStreamNameT>(value)); return *this;}
    ///@}
