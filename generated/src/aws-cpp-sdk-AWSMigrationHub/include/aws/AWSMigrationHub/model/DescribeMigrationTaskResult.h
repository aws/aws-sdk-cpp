...
class DescribeMigrationTaskResult {
 public:
  ...
  void SetMigrationTask(MigrationTaskT&& value) {
    m_migrationTaskHasBeenSet = true;
    m_migrationTask = std::forward<MigrationTaskT>(value);
  }
  template <typename MigrationTaskT = MigrationTask>
  DescribeMigrationTaskResult& WithMigrationTask(MigrationTaskT&& value) {
    SetMigrationTask(std::forward<MigrationTaskT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMigrationTaskResult& WithRequestId(RequestIdT&& value) {
