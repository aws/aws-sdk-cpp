...
class ListSourceResourcesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetSourceResourceList(SourceResourceListT&& value) {
    m_sourceResourceListHasBeenSet = true;
    m_sourceResourceList = std::forward<SourceResourceListT>(value);
  }
  template <typename SourceResourceListT = Aws::Vector<SourceResource>>
  ListSourceResourcesResult& WithSourceResourceList(SourceResourceListT&& value) {
    SetSourceResourceList(std::forward<SourceResourceListT>(value));
    return *this;
  }
  template <typename SourceResourceListT = SourceResource>
  ListSourceResourcesResult& AddSourceResourceList(SourceResourceListT&& value) {
    m_sourceResourceListHasBeenSet = true;
    m_sourceResourceList.emplace_back(std::forward<SourceResourceListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceResourcesResult& WithRequestId(RequestIdT&& value) {
