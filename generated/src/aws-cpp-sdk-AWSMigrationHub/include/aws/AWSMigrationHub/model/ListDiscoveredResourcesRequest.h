...
class ListDiscoveredResourcesRequest : public MigrationHubRequest {
 public:
  ...
  template <typename ProgressUpdateStreamT = Aws::String>
  ListDiscoveredResourcesRequest& WithProgressUpdateStream(ProgressUpdateStreamT&& value) {
  ...
  template <typename MigrationTaskNameT = Aws::String>
  ListDiscoveredResourcesRequest& WithMigrationTaskName(MigrationTaskNameT&& value) {
