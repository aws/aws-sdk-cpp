...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUB_API NotifyApplicationStateResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    NotifyApplicationStateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
