...
class ListProgressUpdateStreamsResult {
 public:
   ...
   * input.</p>
   */
  inline const Aws::Vector<ProgressUpdateStreamSummary>& GetProgressUpdateStreamSummaryList() const {
    return m_progressUpdateStreamSummaryList;
  }
  template <typename ProgressUpdateStreamSummaryListT = Aws::Vector<ProgressUpdateStreamSummary>>
  void SetProgressUpdateStreamSummaryList(ProgressUpdateStreamSummaryListT&& value) {
    m_progressUpdateStreamSummaryListHasBeenSet = true;
    m_progressUpdateStreamSummaryList = std::forward<ProgressUpdateStreamSummaryListT>(value);
  }
  template <typename ProgressUpdateStreamSummaryListT = Aws::Vector<ProgressUpdateStreamSummary>>
  ListProgressUpdateStreamsResult& WithProgressUpdateStreamSummaryList(ProgressUpdateStreamSummaryListT&& value) {
    SetProgressUpdateStreamSummaryList(std::forward<ProgressUpdateStreamSummaryListT>(value));
    return *this;
  }
  template <typename ProgressUpdateStreamSummaryListT = ProgressUpdateStreamSummary>
  ListProgressUpdateStreamsResult& AddProgressUpdateStreamSummaryList(ProgressUpdateStreamSummaryListT&& value) {
    m_progressUpdateStreamSummaryListHasBeenSet = true;
    m_progressUpdateStreamSummaryList.emplace_back(std::forward<ProgressUpdateStreamSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProgressUpdateStreamsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProgressUpdateStreamsResult& WithRequestId(RequestIdT&& value) {
