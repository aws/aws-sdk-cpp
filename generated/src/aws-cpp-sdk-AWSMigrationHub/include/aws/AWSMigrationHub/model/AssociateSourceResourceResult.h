...
namespace Model
{
  ...
  {
  public:
    AWS_MIGRATIONHUB_API AssociateSourceResourceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateSourceResourceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
