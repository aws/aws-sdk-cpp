...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateDiscoveredResourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateDiscoveredResourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateDiscoveredResourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
