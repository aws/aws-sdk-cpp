...
class ListMigrationTaskUpdatesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMigrationTaskUpdatesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetMigrationTaskUpdateList(MigrationTaskUpdateListT&& value) {
    m_migrationTaskUpdateListHasBeenSet = true;
    m_migrationTaskUpdateList = std::forward<MigrationTaskUpdateListT>(value);
  }
  template <typename MigrationTaskUpdateListT = Aws::Vector<MigrationTaskUpdate>>
  ListMigrationTaskUpdatesResult& WithMigrationTaskUpdateList(MigrationTaskUpdateListT&& value) {
    SetMigrationTaskUpdateList(std::forward<MigrationTaskUpdateListT>(value));
    return *this;
  }
  template <typename MigrationTaskUpdateListT = MigrationTaskUpdate>
  ListMigrationTaskUpdatesResult& AddMigrationTaskUpdateList(MigrationTaskUpdateListT&& value) {
    m_migrationTaskUpdateListHasBeenSet = true;
    m_migrationTaskUpdateList.emplace_back(std::forward<MigrationTaskUpdateListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMigrationTaskUpdatesResult& WithRequestId(RequestIdT&& value) {
