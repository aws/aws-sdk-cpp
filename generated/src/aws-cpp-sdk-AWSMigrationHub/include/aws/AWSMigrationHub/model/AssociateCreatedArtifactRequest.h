...
class AssociateCreatedArtifactRequest : public MigrationHubRequest {
 public:
  ...
  void SetCreatedArtifact(CreatedArtifactT&& value) {
    m_createdArtifactHasBeenSet = true;
    m_createdArtifact = std::forward<CreatedArtifactT>(value);
  }
  template <typename CreatedArtifactT = CreatedArtifact>
  AssociateCreatedArtifactRequest& WithCreatedArtifact(CreatedArtifactT&& value) {
    SetCreatedArtifact(std::forward<CreatedArtifactT>(value));
    return *this;
  }
  ///@}
  ...
  inline AssociateCreatedArtifactRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
