...
class AWS_MIGRATIONHUB_API MigrationHubClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MigrationHubClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<MigrationHubEndpointProviderBase> endpointProvider = nullptr,
      const Aws::MigrationHub::MigrationHubClientConfiguration& clientConfiguration = Aws::MigrationHub::MigrationHubClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateCreatedArtifact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateCreatedArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateCreatedArtifactRequestT = Model::AssociateCreatedArtifactRequest>
  void AssociateCreatedArtifactAsync(const AssociateCreatedArtifactRequestT& request,
                                     const AssociateCreatedArtifactResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateDiscoveredResourceOutcome AssociateDiscoveredResource(
      const Model::AssociateDiscoveredResourceRequest& request) const;

  /**
   * A Callable wrapper for AssociateDiscoveredResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateDiscoveredResourceRequestT = Model::AssociateDiscoveredResourceRequest>
  Model::AssociateDiscoveredResourceOutcomeCallable AssociateDiscoveredResourceCallable(
      const AssociateDiscoveredResourceRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::AssociateDiscoveredResource, request);
  }

  /**
   * An Async wrapper for AssociateDiscoveredResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDiscoveredResourceRequestT = Model::AssociateDiscoveredResourceRequest>
  void AssociateDiscoveredResourceAsync(const AssociateDiscoveredResourceRequestT& request,
                                        const AssociateDiscoveredResourceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateSourceResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateSourceResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateSourceResourceRequestT = Model::AssociateSourceResourceRequest>
  void AssociateSourceResourceAsync(const AssociateSourceResourceRequestT& request,
                                    const AssociateSourceResourceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateProgressUpdateStreamOutcome CreateProgressUpdateStream(
      const Model::CreateProgressUpdateStreamRequest& request) const;

  /**
   * A Callable wrapper for CreateProgressUpdateStream that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateProgressUpdateStreamRequestT = Model::CreateProgressUpdateStreamRequest>
  Model::CreateProgressUpdateStreamOutcomeCallable CreateProgressUpdateStreamCallable(
      const CreateProgressUpdateStreamRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::CreateProgressUpdateStream, request);
  }

  /**
   * An Async wrapper for CreateProgressUpdateStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProgressUpdateStreamRequestT = Model::CreateProgressUpdateStreamRequest>
  void CreateProgressUpdateStreamAsync(const CreateProgressUpdateStreamRequestT& request,
                                       const CreateProgressUpdateStreamResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteProgressUpdateStreamOutcome DeleteProgressUpdateStream(
      const Model::DeleteProgressUpdateStreamRequest& request) const;

  /**
   * A Callable wrapper for DeleteProgressUpdateStream that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteProgressUpdateStreamRequestT = Model::DeleteProgressUpdateStreamRequest>
  Model::DeleteProgressUpdateStreamOutcomeCallable DeleteProgressUpdateStreamCallable(
      const DeleteProgressUpdateStreamRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::DeleteProgressUpdateStream, request);
  }

  /**
   * An Async wrapper for DeleteProgressUpdateStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProgressUpdateStreamRequestT = Model::DeleteProgressUpdateStreamRequest>
  void DeleteProgressUpdateStreamAsync(const DeleteProgressUpdateStreamRequestT& request,
                                       const DeleteProgressUpdateStreamResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeApplicationState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeApplicationState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeApplicationStateRequestT = Model::DescribeApplicationStateRequest>
  void DescribeApplicationStateAsync(const DescribeApplicationStateRequestT& request,
                                     const DescribeApplicationStateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeMigrationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMigrationTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMigrationTaskRequestT = Model::DescribeMigrationTaskRequest>
  void DescribeMigrationTaskAsync(const DescribeMigrationTaskRequestT& request, const DescribeMigrationTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateCreatedArtifactOutcome DisassociateCreatedArtifact(
      const Model::DisassociateCreatedArtifactRequest& request) const;

  /**
   * A Callable wrapper for DisassociateCreatedArtifact that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateCreatedArtifactRequestT = Model::DisassociateCreatedArtifactRequest>
  Model::DisassociateCreatedArtifactOutcomeCallable DisassociateCreatedArtifactCallable(
      const DisassociateCreatedArtifactRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::DisassociateCreatedArtifact, request);
  }

  /**
   * An Async wrapper for DisassociateCreatedArtifact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateCreatedArtifactRequestT = Model::DisassociateCreatedArtifactRequest>
  void DisassociateCreatedArtifactAsync(const DisassociateCreatedArtifactRequestT& request,
                                        const DisassociateCreatedArtifactResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateDiscoveredResourceOutcome DisassociateDiscoveredResource(
      const Model::DisassociateDiscoveredResourceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateDiscoveredResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateDiscoveredResourceRequestT = Model::DisassociateDiscoveredResourceRequest>
  Model::DisassociateDiscoveredResourceOutcomeCallable DisassociateDiscoveredResourceCallable(
      const DisassociateDiscoveredResourceRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::DisassociateDiscoveredResource, request);
  }

  /**
   * An Async wrapper for DisassociateDiscoveredResource that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateDiscoveredResourceRequestT = Model::DisassociateDiscoveredResourceRequest>
  void DisassociateDiscoveredResourceAsync(const DisassociateDiscoveredResourceRequestT& request,
                                           const DisassociateDiscoveredResourceResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateSourceResourceOutcome DisassociateSourceResource(
      const Model::DisassociateSourceResourceRequest& request) const;

  /**
   * A Callable wrapper for DisassociateSourceResource that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateSourceResourceRequestT = Model::DisassociateSourceResourceRequest>
  Model::DisassociateSourceResourceOutcomeCallable DisassociateSourceResourceCallable(
      const DisassociateSourceResourceRequestT& request) const {
    return SubmitCallable(&MigrationHubClient::DisassociateSourceResource, request);
  }

  /**
   * An Async wrapper for DisassociateSourceResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateSourceResourceRequestT = Model::DisassociateSourceResourceRequest>
  void DisassociateSourceResourceAsync(const DisassociateSourceResourceRequestT& request,
                                       const DisassociateSourceResourceResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportMigrationTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportMigrationTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportMigrationTaskRequestT = Model::ImportMigrationTaskRequest>
  void ImportMigrationTaskAsync(const ImportMigrationTaskRequestT& request, const ImportMigrationTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApplicationStates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListApplicationStates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApplicationStatesRequestT = Model::ListApplicationStatesRequest>
  void ListApplicationStatesAsync(const ListApplicationStatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListApplicationStatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCreatedArtifacts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCreatedArtifacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCreatedArtifactsRequestT = Model::ListCreatedArtifactsRequest>
  void ListCreatedArtifactsAsync(const ListCreatedArtifactsRequestT& request, const ListCreatedArtifactsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMigrationTaskUpdates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMigrationTaskUpdates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMigrationTaskUpdatesRequestT = Model::ListMigrationTaskUpdatesRequest>
  void ListMigrationTaskUpdatesAsync(const ListMigrationTaskUpdatesRequestT& request,
                                     const ListMigrationTaskUpdatesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMigrationTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMigrationTasks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMigrationTasksRequestT = Model::ListMigrationTasksRequest>
  void ListMigrationTasksAsync(const ListMigrationTasksResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListMigrationTasksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProgressUpdateStreamsOutcome ListProgressUpdateStreams(
      const Model::ListProgressUpdateStreamsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListProgressUpdateStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProgressUpdateStreamsRequestT = Model::ListProgressUpdateStreamsRequest>
  Model::ListProgressUpdateStreamsOutcomeCallable ListProgressUpdateStreamsCallable(
      const ListProgressUpdateStreamsRequestT& request = {}) const {
    return SubmitCallable(&MigrationHubClient::ListProgressUpdateStreams, request);
  }

  /**
   * An Async wrapper for ListProgressUpdateStreams that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProgressUpdateStreamsRequestT = Model::ListProgressUpdateStreamsRequest>
  void ListProgressUpdateStreamsAsync(const ListProgressUpdateStreamsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListProgressUpdateStreamsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSourceResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSourceResources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSourceResourcesRequestT = Model::ListSourceResourcesRequest>
  void ListSourceResourcesAsync(const ListSourceResourcesRequestT& request, const ListSourceResourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for NotifyApplicationState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for NotifyApplicationState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename NotifyApplicationStateRequestT = Model::NotifyApplicationStateRequest>
  void NotifyApplicationStateAsync(const NotifyApplicationStateRequestT& request,
                                   const NotifyApplicationStateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for NotifyMigrationTaskState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for NotifyMigrationTaskState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename NotifyMigrationTaskStateRequestT = Model::NotifyMigrationTaskStateRequest>
  void NotifyMigrationTaskStateAsync(const NotifyMigrationTaskStateRequestT& request,
                                     const NotifyMigrationTaskStateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutResourceAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutResourceAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutResourceAttributesRequestT = Model::PutResourceAttributesRequest>
  void PutResourceAttributesAsync(const PutResourceAttributesRequestT& request, const PutResourceAttributesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
