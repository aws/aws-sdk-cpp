...
/**
 * <p>Thrown when the request contains invalid parameters or fails input validation
 * requirements.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-benefits-2018-05-10/ValidationException">AWS
 * API Reference</a></p>
 */
