...
/**
 */
class RecallBenefitApplicationRequest : public PartnerCentralBenefitsRequest {
 public:
  AWS_PARTNERCENTRALBENEFITS_API RecallBenefitApplicationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "RecallBenefitApplication"; }
  ...
  template <typename CatalogT = Aws::String>
  RecallBenefitApplicationRequest& WithCatalog(CatalogT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  RecallBenefitApplicationRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  RecallBenefitApplicationRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  RecallBenefitApplicationRequest& WithReason(ReasonT&& value) {
