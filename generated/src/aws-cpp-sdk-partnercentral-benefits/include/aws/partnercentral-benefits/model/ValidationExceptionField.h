...
/**
 * <p>Represents a field-specific validation error with detailed
 * information.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/partnercentral-benefits-2018-05-10/ValidationExceptionField">AWS
 * API Reference</a></p>
 */
class ValidationExceptionField {
 public:
  ...
  inline ValidationExceptionField& WithCode(ValidationExceptionErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
