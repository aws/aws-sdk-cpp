...
namespace Model {
class CreateBenefitApplicationResult {
 public:
  ...
  AWS_PARTNERCENTRALBENEFITS_API CreateBenefitApplicationResult& operator=(
  ...
  template <typename IdT = Aws::String>
  CreateBenefitApplicationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateBenefitApplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename RevisionT = Aws::String>
  CreateBenefitApplicationResult& WithRevision(RevisionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBenefitApplicationResult& WithRequestId(RequestIdT&& value) {
