...
namespace Model {
class RecallBenefitApplicationResult {
 public:
  ...
  AWS_PARTNERCENTRALBENEFITS_API RecallBenefitApplicationResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  RecallBenefitApplicationResult& WithRequestId(RequestIdT&& value) {
