...
class AWS_PARTNERCENTRALBENEFITS_API PartnerCentralBenefitsRequest : public Aws::AmazonSerializableWebServiceRequest {
 public:
  using EndpointParameter = Aws::Endpoint::EndpointParameter;
  using EndpointParameters = Aws::Endpoint::EndpointParameters;

  virtual ~PartnerCentralBenefitsRequest() {}
