...
using ListExadbVmClustersPaginator = Aws::Utils::Pagination::Paginator<OdbClient, Model::ListExadbVmClustersRequest,
                                                                       Pagination::ListExadbVmClustersPaginationTraits<OdbClient>>;
