...
namespace odb {
namespace Model {
class UpdateExadbVmClusterResult {
 public:
  AWS_ODB_API UpdateExadbVmClusterResult() = default;
  AWS_ODB_API UpdateExadbVmClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API UpdateExadbVmClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateExadbVmClusterResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline UpdateExadbVmClusterResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateExadbVmClusterResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ExadbVmClusterIdT = Aws::String>
  UpdateExadbVmClusterResult& WithExadbVmClusterId(ExadbVmClusterIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateExadbVmClusterResult& WithRequestId(RequestIdT&& value) {
