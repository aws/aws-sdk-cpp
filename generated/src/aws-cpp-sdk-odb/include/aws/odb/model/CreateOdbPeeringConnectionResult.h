...
class CreateOdbPeeringConnectionResult {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  CreateOdbPeeringConnectionResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateOdbPeeringConnectionResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateOdbPeeringConnectionResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename OdbPeeringConnectionIdT = Aws::String>
  CreateOdbPeeringConnectionResult& WithOdbPeeringConnectionId(OdbPeeringConnectionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOdbPeeringConnectionResult& WithRequestId(RequestIdT&& value) {
