...
namespace odb {
namespace Model {
class SwitchoverAutonomousDatabaseResult {
 public:
  AWS_ODB_API SwitchoverAutonomousDatabaseResult() = default;
  AWS_ODB_API SwitchoverAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API SwitchoverAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  SwitchoverAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  SwitchoverAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the Autonomous Database after the switchover
   * operation.</p>
   */
  ...
  inline SwitchoverAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  SwitchoverAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SwitchoverAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
