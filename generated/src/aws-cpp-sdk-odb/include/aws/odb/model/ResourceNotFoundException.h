...
namespace Model
{
  ...
  /**
   * <p>The operation tried to access a resource that doesn't exist. Make sure you
   * provided the correct resource and try again.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_ODB_API ResourceNotFoundException() = default;
    AWS_ODB_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ODB_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
