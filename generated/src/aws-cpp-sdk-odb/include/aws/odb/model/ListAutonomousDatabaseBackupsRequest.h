...
/**
 */
class ListAutonomousDatabaseBackupsRequest : public OdbRequest {
 public:
  AWS_ODB_API ListAutonomousDatabaseBackupsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAutonomousDatabaseBackups"; }
  ...
  inline ListAutonomousDatabaseBackupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutonomousDatabaseBackupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the Autonomous Database whose backups you want to
   * list.</p>
   */
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  ListAutonomousDatabaseBackupsRequest& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  inline ListAutonomousDatabaseBackupsRequest& WithStatus(AutonomousDatabaseBackupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListAutonomousDatabaseBackupsRequest& WithType(AutonomousDatabaseBackupType value) {
    SetType(value);
    return *this;
  }
  ///@}
