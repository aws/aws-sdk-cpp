...
class ManagedS3BackupAccess {
 public:
  ...
  inline ManagedS3BackupAccess& WithStatus(ManagedResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename Ipv4AddressesT = Aws::Vector<Aws::String>>
  ManagedS3BackupAccess& WithIpv4Addresses(Ipv4AddressesT&& value) {
    SetIpv4Addresses(std::forward<Ipv4AddressesT>(value));
    return *this;
  }
  template <typename Ipv4AddressesT = Aws::String>
  ManagedS3BackupAccess& AddIpv4Addresses(Ipv4AddressesT&& value) {
    m_ipv4AddressesHasBeenSet = true;
