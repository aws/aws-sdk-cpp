...
class CreateCloudVmClusterResult {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  CreateCloudVmClusterResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateCloudVmClusterResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateCloudVmClusterResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename CloudVmClusterIdT = Aws::String>
  CreateCloudVmClusterResult& WithCloudVmClusterId(CloudVmClusterIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCloudVmClusterResult& WithRequestId(RequestIdT&& value) {
