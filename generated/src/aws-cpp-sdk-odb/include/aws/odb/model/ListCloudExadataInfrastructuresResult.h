...
class ListCloudExadataInfrastructuresResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudExadataInfrastructuresResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<CloudExadataInfrastructureSummary>& GetCloudExadataInfrastructures() const {
    return m_cloudExadataInfrastructures;
  }
  template <typename CloudExadataInfrastructuresT = Aws::Vector<CloudExadataInfrastructureSummary>>
  void SetCloudExadataInfrastructures(CloudExadataInfrastructuresT&& value) {
    m_cloudExadataInfrastructuresHasBeenSet = true;
    m_cloudExadataInfrastructures = std::forward<CloudExadataInfrastructuresT>(value);
  }
  template <typename CloudExadataInfrastructuresT = Aws::Vector<CloudExadataInfrastructureSummary>>
  ListCloudExadataInfrastructuresResult& WithCloudExadataInfrastructures(CloudExadataInfrastructuresT&& value) {
    SetCloudExadataInfrastructures(std::forward<CloudExadataInfrastructuresT>(value));
    return *this;
  }
  template <typename CloudExadataInfrastructuresT = CloudExadataInfrastructureSummary>
  ListCloudExadataInfrastructuresResult& AddCloudExadataInfrastructures(CloudExadataInfrastructuresT&& value) {
    m_cloudExadataInfrastructuresHasBeenSet = true;
    m_cloudExadataInfrastructures.emplace_back(std::forward<CloudExadataInfrastructuresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCloudExadataInfrastructuresResult& WithRequestId(RequestIdT&& value) {
