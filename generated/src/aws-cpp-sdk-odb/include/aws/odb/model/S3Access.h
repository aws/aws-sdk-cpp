...
class S3Access {
 public:
  ...
  inline S3Access& WithStatus(ManagedResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename Ipv4AddressesT = Aws::Vector<Aws::String>>
  S3Access& WithIpv4Addresses(Ipv4AddressesT&& value) {
    SetIpv4Addresses(std::forward<Ipv4AddressesT>(value));
    return *this;
  }
  template <typename Ipv4AddressesT = Aws::String>
  S3Access& AddIpv4Addresses(Ipv4AddressesT&& value) {
    m_ipv4AddressesHasBeenSet = true;
  ...
  template <typename DomainNameT = Aws::String>
  S3Access& WithDomainName(DomainNameT&& value) {
  ...
  template <typename S3PolicyDocumentT = Aws::String>
  S3Access& WithS3PolicyDocument(S3PolicyDocumentT&& value) {
