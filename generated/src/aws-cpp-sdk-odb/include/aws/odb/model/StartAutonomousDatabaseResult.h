...
namespace odb {
namespace Model {
class StartAutonomousDatabaseResult {
 public:
  AWS_ODB_API StartAutonomousDatabaseResult() = default;
  AWS_ODB_API StartAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API StartAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  StartAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  StartAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline StartAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  StartAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
