...
namespace odb {
namespace Model {
class UpdateExascaleDbStorageVaultResult {
 public:
  AWS_ODB_API UpdateExascaleDbStorageVaultResult() = default;
  AWS_ODB_API UpdateExascaleDbStorageVaultResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API UpdateExascaleDbStorageVaultResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateExascaleDbStorageVaultResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline UpdateExascaleDbStorageVaultResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateExascaleDbStorageVaultResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ExascaleDbStorageVaultIdT = Aws::String>
  UpdateExascaleDbStorageVaultResult& WithExascaleDbStorageVaultId(ExascaleDbStorageVaultIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateExascaleDbStorageVaultResult& WithRequestId(RequestIdT&& value) {
