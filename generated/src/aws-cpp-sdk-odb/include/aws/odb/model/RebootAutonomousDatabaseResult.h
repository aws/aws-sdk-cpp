...
namespace odb {
namespace Model {
class RebootAutonomousDatabaseResult {
 public:
  AWS_ODB_API RebootAutonomousDatabaseResult() = default;
  AWS_ODB_API RebootAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API RebootAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  RebootAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  RebootAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline RebootAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  RebootAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RebootAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
