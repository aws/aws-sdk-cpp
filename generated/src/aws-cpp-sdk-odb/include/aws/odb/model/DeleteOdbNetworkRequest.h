...
class DeleteOdbNetworkRequest : public OdbRequest {
 public:
  ...
  template <typename OdbNetworkIdT = Aws::String>
  DeleteOdbNetworkRequest& WithOdbNetworkId(OdbNetworkIdT&& value) {
  ...
  inline void SetDeleteAssociatedResources(bool value) {
    m_deleteAssociatedResourcesHasBeenSet = true;
    m_deleteAssociatedResources = value;
  }
  inline DeleteOdbNetworkRequest& WithDeleteAssociatedResources(bool value) {
    SetDeleteAssociatedResources(value);
    return *this;
  }
  ///@}
 private:
