...
class GetCloudVmClusterResult {
 public:
  ...
  void SetCloudVmCluster(CloudVmClusterT&& value) {
    m_cloudVmClusterHasBeenSet = true;
    m_cloudVmCluster = std::forward<CloudVmClusterT>(value);
  }
  template <typename CloudVmClusterT = CloudVmCluster>
  GetCloudVmClusterResult& WithCloudVmCluster(CloudVmClusterT&& value) {
    SetCloudVmCluster(std::forward<CloudVmClusterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCloudVmClusterResult& WithRequestId(RequestIdT&& value) {
