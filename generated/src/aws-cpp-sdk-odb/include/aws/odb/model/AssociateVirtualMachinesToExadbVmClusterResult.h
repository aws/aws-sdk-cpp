...
namespace odb {
namespace Model {
class AssociateVirtualMachinesToExadbVmClusterResult {
 public:
  AWS_ODB_API AssociateVirtualMachinesToExadbVmClusterResult() = default;
  AWS_ODB_API AssociateVirtualMachinesToExadbVmClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API AssociateVirtualMachinesToExadbVmClusterResult& operator=(
  ...
  template <typename DisplayNameT = Aws::String>
  AssociateVirtualMachinesToExadbVmClusterResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline AssociateVirtualMachinesToExadbVmClusterResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  AssociateVirtualMachinesToExadbVmClusterResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ExadbVmClusterIdT = Aws::String>
  AssociateVirtualMachinesToExadbVmClusterResult& WithExadbVmClusterId(ExadbVmClusterIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateVirtualMachinesToExadbVmClusterResult& WithRequestId(RequestIdT&& value) {
