...
class GetOdbPeeringConnectionResult {
 public:
  ...
  void SetOdbPeeringConnection(OdbPeeringConnectionT&& value) {
    m_odbPeeringConnectionHasBeenSet = true;
    m_odbPeeringConnection = std::forward<OdbPeeringConnectionT>(value);
  }
  template <typename OdbPeeringConnectionT = OdbPeeringConnection>
  GetOdbPeeringConnectionResult& WithOdbPeeringConnection(OdbPeeringConnectionT&& value) {
    SetOdbPeeringConnection(std::forward<OdbPeeringConnectionT>(value));
    return *this;
  }
  ///@}
