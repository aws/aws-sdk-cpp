...
namespace odb {
namespace Model {
class UpdateAutonomousDatabaseResult {
 public:
  AWS_ODB_API UpdateAutonomousDatabaseResult() = default;
  AWS_ODB_API UpdateAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API UpdateAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  UpdateAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline UpdateAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
