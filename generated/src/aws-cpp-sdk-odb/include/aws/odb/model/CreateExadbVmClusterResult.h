...
namespace odb {
namespace Model {
class CreateExadbVmClusterResult {
 public:
  AWS_ODB_API CreateExadbVmClusterResult() = default;
  AWS_ODB_API CreateExadbVmClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API CreateExadbVmClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayNameT = Aws::String>
  CreateExadbVmClusterResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateExadbVmClusterResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateExadbVmClusterResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ExadbVmClusterIdT = Aws::String>
  CreateExadbVmClusterResult& WithExadbVmClusterId(ExadbVmClusterIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateExadbVmClusterResult& WithRequestId(RequestIdT&& value) {
