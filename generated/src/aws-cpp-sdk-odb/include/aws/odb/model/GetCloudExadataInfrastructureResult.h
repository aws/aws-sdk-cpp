...
class GetCloudExadataInfrastructureResult {
 public:
  ...
  void SetCloudExadataInfrastructure(CloudExadataInfrastructureT&& value) {
    m_cloudExadataInfrastructureHasBeenSet = true;
    m_cloudExadataInfrastructure = std::forward<CloudExadataInfrastructureT>(value);
  }
  template <typename CloudExadataInfrastructureT = CloudExadataInfrastructure>
  GetCloudExadataInfrastructureResult& WithCloudExadataInfrastructure(CloudExadataInfrastructureT&& value) {
    SetCloudExadataInfrastructure(std::forward<CloudExadataInfrastructureT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCloudExadataInfrastructureResult& WithRequestId(RequestIdT&& value) {
