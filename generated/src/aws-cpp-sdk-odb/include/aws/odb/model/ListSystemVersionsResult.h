...
class ListSystemVersionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSystemVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SystemVersionsT = Aws::Vector<SystemVersionSummary>>
  ListSystemVersionsResult& WithSystemVersions(SystemVersionsT&& value) {
    SetSystemVersions(std::forward<SystemVersionsT>(value));
    return *this;
  }
  template <typename SystemVersionsT = SystemVersionSummary>
  ListSystemVersionsResult& AddSystemVersions(SystemVersionsT&& value) {
    m_systemVersionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSystemVersionsResult& WithRequestId(RequestIdT&& value) {
