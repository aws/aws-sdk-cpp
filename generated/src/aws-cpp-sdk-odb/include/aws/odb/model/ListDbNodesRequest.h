...
class ListDbNodesRequest : public OdbRequest {
 public:
  ...
  inline ListDbNodesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDbNodesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CloudVmClusterIdT = Aws::String>
  ListDbNodesRequest& WithCloudVmClusterId(CloudVmClusterIdT&& value) {
