...
class ListDbServersRequest : public OdbRequest {
 public:
  ...
  template <typename CloudExadataInfrastructureIdT = Aws::String>
  ListDbServersRequest& WithCloudExadataInfrastructureId(CloudExadataInfrastructureIdT&& value) {
  ...
  inline ListDbServersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDbServersRequest& WithNextToken(NextTokenT&& value) {
