...
namespace Model
{
  ...
  public:
    ...
    template<typename CloudVmClusterIdT = Aws::String>
    StartDbNodeRequest& WithCloudVmClusterId(CloudVmClusterIdT&& value) { SetCloudVmClusterId(std::forward<CloudVmClusterIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DbNodeIdT = Aws::String>
    StartDbNodeRequest& WithDbNodeId(DbNodeIdT&& value) { SetDbNodeId(std::forward<DbNodeIdT>(value)); return *this;}
    ///@}
  private:
