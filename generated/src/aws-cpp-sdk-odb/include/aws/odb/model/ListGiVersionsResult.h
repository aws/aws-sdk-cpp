...
class ListGiVersionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListGiVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetGiVersions(GiVersionsT&& value) {
    m_giVersionsHasBeenSet = true;
    m_giVersions = std::forward<GiVersionsT>(value);
  }
  template <typename GiVersionsT = Aws::Vector<GiVersionSummary>>
  ListGiVersionsResult& WithGiVersions(GiVersionsT&& value) {
    SetGiVersions(std::forward<GiVersionsT>(value));
    return *this;
  }
  template <typename GiVersionsT = GiVersionSummary>
  ListGiVersionsResult& AddGiVersions(GiVersionsT&& value) {
    m_giVersionsHasBeenSet = true;
    m_giVersions.emplace_back(std::forward<GiVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListGiVersionsResult& WithRequestId(RequestIdT&& value) {
