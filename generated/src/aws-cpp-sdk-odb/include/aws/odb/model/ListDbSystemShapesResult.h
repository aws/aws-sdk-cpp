...
class ListDbSystemShapesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDbSystemShapesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetDbSystemShapes(DbSystemShapesT&& value) {
    m_dbSystemShapesHasBeenSet = true;
    m_dbSystemShapes = std::forward<DbSystemShapesT>(value);
  }
  template <typename DbSystemShapesT = Aws::Vector<DbSystemShapeSummary>>
  ListDbSystemShapesResult& WithDbSystemShapes(DbSystemShapesT&& value) {
    SetDbSystemShapes(std::forward<DbSystemShapesT>(value));
    return *this;
  }
  template <typename DbSystemShapesT = DbSystemShapeSummary>
  ListDbSystemShapesResult& AddDbSystemShapes(DbSystemShapesT&& value) {
    m_dbSystemShapesHasBeenSet = true;
    m_dbSystemShapes.emplace_back(std::forward<DbSystemShapesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListDbSystemShapesResult& WithRequestId(RequestIdT&& value) {
