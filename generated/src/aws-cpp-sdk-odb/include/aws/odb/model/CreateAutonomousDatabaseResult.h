...
namespace odb {
namespace Model {
class CreateAutonomousDatabaseResult {
 public:
  AWS_ODB_API CreateAutonomousDatabaseResult() = default;
  AWS_ODB_API CreateAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API CreateAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  CreateAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  CreateAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
