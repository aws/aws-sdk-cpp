...
class OciDnsForwardingConfig {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  OciDnsForwardingConfig& WithDomainName(DomainNameT&& value) {
  ...
  void SetOciDnsListenerIp(OciDnsListenerIpT&& value) {
    m_ociDnsListenerIpHasBeenSet = true;
    m_ociDnsListenerIp = std::forward<OciDnsListenerIpT>(value);
  }
  template <typename OciDnsListenerIpT = Aws::String>
  OciDnsForwardingConfig& WithOciDnsListenerIp(OciDnsListenerIpT&& value) {
    SetOciDnsListenerIp(std::forward<OciDnsListenerIpT>(value));
    return *this;
  }
  ///@}
 private:
