...
class CreateCloudAutonomousVmClusterRequest : public OdbRequest {
 public:
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithAutonomousDataStorageSizeInTBs(double value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithCpuCoreCountPerNode(int value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithIsMtlsEnabledVmCluster(bool value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithLicenseModel(LicenseModel value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithMemoryPerOracleComputeUnitInGBs(int value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithScanListenerPortNonTls(int value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithScanListenerPortTls(int value) {
  ...
  inline CreateCloudAutonomousVmClusterRequest& WithTotalContainerDatabases(int value) {
