...
/**
 */
class AssociateIamRoleToResourceRequest : public OdbRequest {
 public:
  AWS_ODB_API AssociateIamRoleToResourceRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "AssociateIamRoleToResource"; }
   ...
   * Management (IAM) service role to associate with the resource.</p>
   */
  ...
  template <typename IamRoleArnT = Aws::String>
  AssociateIamRoleToResourceRequest& WithIamRoleArn(IamRoleArnT&& value) {
   ...
   * Services Identity and Access Management (IAM) service role association.</p>
   */
  ...
  inline AssociateIamRoleToResourceRequest& WithAwsIntegration(SupportedAwsIntegration value) {
  ...
  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the target resource to associate with the
   * Amazon Web Services Identity and Access Management (IAM) service role.</p>
   */
  ...
  template <typename ResourceArnT = Aws::String>
  AssociateIamRoleToResourceRequest& WithResourceArn(ResourceArnT&& value) {
