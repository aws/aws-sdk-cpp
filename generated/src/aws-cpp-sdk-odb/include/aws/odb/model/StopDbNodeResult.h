...
class StopDbNodeResult {
 public:
  ...
  template <typename DbNodeIdT = Aws::String>
  StopDbNodeResult& WithDbNodeId(DbNodeIdT&& value) {
  ...
  inline StopDbNodeResult& WithStatus(DbNodeResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  StopDbNodeResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopDbNodeResult& WithRequestId(RequestIdT&& value) {
