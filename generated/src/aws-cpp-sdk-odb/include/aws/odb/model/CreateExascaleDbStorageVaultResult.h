...
namespace odb {
namespace Model {
class CreateExascaleDbStorageVaultResult {
 public:
  AWS_ODB_API CreateExascaleDbStorageVaultResult() = default;
  AWS_ODB_API CreateExascaleDbStorageVaultResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API CreateExascaleDbStorageVaultResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayNameT = Aws::String>
  CreateExascaleDbStorageVaultResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateExascaleDbStorageVaultResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateExascaleDbStorageVaultResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename ExascaleDbStorageVaultIdT = Aws::String>
  CreateExascaleDbStorageVaultResult& WithExascaleDbStorageVaultId(ExascaleDbStorageVaultIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateExascaleDbStorageVaultResult& WithRequestId(RequestIdT&& value) {
