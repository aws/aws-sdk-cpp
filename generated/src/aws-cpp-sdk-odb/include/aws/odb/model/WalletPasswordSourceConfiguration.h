...
/**
 * <p>The configuration of the wallet password source. This is a union, so only one
 * of the following members can be specified.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/WalletPasswordSourceConfiguration">AWS
 * API Reference</a></p>
 */
class WalletPasswordSourceConfiguration {
 public:
   ...
   * secret used as the wallet password source.</p>
   */
