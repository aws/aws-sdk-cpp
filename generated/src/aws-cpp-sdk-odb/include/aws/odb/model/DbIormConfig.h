...
class DbIormConfig {
 public:
  ...
  void SetFlashCacheLimit(FlashCacheLimitT&& value) {
    ...
    m_flashCacheLimit = std::forward<FlashCacheLimitT>(value);
  }
  template <typename FlashCacheLimitT = Aws::String>
  DbIormConfig& WithFlashCacheLimit(FlashCacheLimitT&& value) {
    SetFlashCacheLimit(std::forward<FlashCacheLimitT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetShare(int value) {
    m_shareHasBeenSet = true;
    m_share = value;
  }
  inline DbIormConfig& WithShare(int value) {
    SetShare(value);
    return *this;
  }
  ///@}
