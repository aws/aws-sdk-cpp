...
class ListCloudVmClustersResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudVmClustersResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCloudVmClusters(CloudVmClustersT&& value) {
    m_cloudVmClustersHasBeenSet = true;
    m_cloudVmClusters = std::forward<CloudVmClustersT>(value);
  }
  template <typename CloudVmClustersT = Aws::Vector<CloudVmClusterSummary>>
  ListCloudVmClustersResult& WithCloudVmClusters(CloudVmClustersT&& value) {
    SetCloudVmClusters(std::forward<CloudVmClustersT>(value));
    return *this;
  }
  template <typename CloudVmClustersT = CloudVmClusterSummary>
  ListCloudVmClustersResult& AddCloudVmClusters(CloudVmClustersT&& value) {
    m_cloudVmClustersHasBeenSet = true;
    m_cloudVmClusters.emplace_back(std::forward<CloudVmClustersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCloudVmClustersResult& WithRequestId(RequestIdT&& value) {
