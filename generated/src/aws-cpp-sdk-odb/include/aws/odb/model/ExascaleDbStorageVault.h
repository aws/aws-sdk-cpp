...
/**
 * <p>Information about an Exascale storage vault.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/ExascaleDbStorageVault">AWS
 * API Reference</a></p>
 */
class ExascaleDbStorageVault {
 public:
  ...
  inline ExascaleDbStorageVault& WithAdditionalFlashCacheInPercent(int value) {
  ...
  inline ExascaleDbStorageVault& AddAttachedShapeAttributes(ShapeAttribute value) {
    m_attachedShapeAttributesHasBeenSet = true;
  ...
  inline ExascaleDbStorageVault& WithAutoscaleLimitInGBs(int value) {
  ...
  inline ExascaleDbStorageVault& WithVmClusterCount(int value) {
  ...
  inline ExascaleDbStorageVault& WithIsAutoscaleEnabled(bool value) {
  ...
  inline ExascaleDbStorageVault& WithPercentProgress(double value) {
  ...
  inline ExascaleDbStorageVault& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
