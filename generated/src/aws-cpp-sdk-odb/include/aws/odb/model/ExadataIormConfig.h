...
class ExadataIormConfig {
 public:
  ...
  void SetLifecycleDetails(LifecycleDetailsT&& value) {
    ...
    m_lifecycleDetails = std::forward<LifecycleDetailsT>(value);
  }
  template <typename LifecycleDetailsT = Aws::String>
  ExadataIormConfig& WithLifecycleDetails(LifecycleDetailsT&& value) {
    SetLifecycleDetails(std::forward<LifecycleDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLifecycleState(IormLifecycleState value) {
    m_lifecycleStateHasBeenSet = true;
    m_lifecycleState = value;
  }
  inline ExadataIormConfig& WithLifecycleState(IormLifecycleState value) {
  ...
  inline void SetObjective(Objective value) {
    m_objectiveHasBeenSet = true;
    m_objective = value;
  }
  inline ExadataIormConfig& WithObjective(Objective value) {
    SetObjective(value);
    return *this;
  }
  ///@}
