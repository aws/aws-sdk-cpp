...
class GetCloudExadataInfrastructureUnallocatedResourcesRequest : public OdbRequest {
 public:
  ...
  template <typename CloudExadataInfrastructureIdT = Aws::String>
  GetCloudExadataInfrastructureUnallocatedResourcesRequest& WithCloudExadataInfrastructureId(CloudExadataInfrastructureIdT&& value) {
  ...
  template <typename DbServersT = Aws::Vector<Aws::String>>
  GetCloudExadataInfrastructureUnallocatedResourcesRequest& WithDbServers(DbServersT&& value) {
    SetDbServers(std::forward<DbServersT>(value));
    return *this;
  }
  template <typename DbServersT = Aws::String>
  GetCloudExadataInfrastructureUnallocatedResourcesRequest& AddDbServers(DbServersT&& value) {
    m_dbServersHasBeenSet = true;
