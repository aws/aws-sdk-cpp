...
class DbServerPatchingDetails {
 public:
  ...
  inline void SetEstimatedPatchDuration(int value) {
    m_estimatedPatchDurationHasBeenSet = true;
    m_estimatedPatchDuration = value;
  }
  inline DbServerPatchingDetails& WithEstimatedPatchDuration(int value) {
    SetEstimatedPatchDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPatchingStatus(DbServerPatchingStatus value) {
    m_patchingStatusHasBeenSet = true;
    m_patchingStatus = value;
  }
  inline DbServerPatchingDetails& WithPatchingStatus(DbServerPatchingStatus value) {
    SetPatchingStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTimePatchingEnded(TimePatchingEndedT&& value) {
    ...
    m_timePatchingEnded = std::forward<TimePatchingEndedT>(value);
  }
  template <typename TimePatchingEndedT = Aws::String>
  DbServerPatchingDetails& WithTimePatchingEnded(TimePatchingEndedT&& value) {
    SetTimePatchingEnded(std::forward<TimePatchingEndedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimePatchingStarted(TimePatchingStartedT&& value) {
    ...
    m_timePatchingStarted = std::forward<TimePatchingStartedT>(value);
  }
  template <typename TimePatchingStartedT = Aws::String>
  DbServerPatchingDetails& WithTimePatchingStarted(TimePatchingStartedT&& value) {
    SetTimePatchingStarted(std::forward<TimePatchingStartedT>(value));
    return *this;
  }
  ///@}
 private:
