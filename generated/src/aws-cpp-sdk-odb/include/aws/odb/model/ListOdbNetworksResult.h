...
class ListOdbNetworksResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOdbNetworksResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetOdbNetworks(OdbNetworksT&& value) {
    m_odbNetworksHasBeenSet = true;
    m_odbNetworks = std::forward<OdbNetworksT>(value);
  }
  template <typename OdbNetworksT = Aws::Vector<OdbNetworkSummary>>
  ListOdbNetworksResult& WithOdbNetworks(OdbNetworksT&& value) {
    SetOdbNetworks(std::forward<OdbNetworksT>(value));
    return *this;
  }
  template <typename OdbNetworksT = OdbNetworkSummary>
  ListOdbNetworksResult& AddOdbNetworks(OdbNetworksT&& value) {
    m_odbNetworksHasBeenSet = true;
    m_odbNetworks.emplace_back(std::forward<OdbNetworksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListOdbNetworksResult& WithRequestId(RequestIdT&& value) {
