...
/**
 */
class ListExadbVmClustersRequest : public OdbRequest {
 public:
  AWS_ODB_API ListExadbVmClustersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListExadbVmClusters"; }
  ...
  ///@{
  /**
   * <p>The unique identifier of the Exascale storage vault to list the associated
   * Exascale VM clusters.</p>
   */
  ...
  template <typename ExascaleDbStorageVaultIdT = Aws::String>
  ListExadbVmClustersRequest& WithExascaleDbStorageVaultId(ExascaleDbStorageVaultIdT&& value) {
  ...
  inline ListExadbVmClustersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExadbVmClustersRequest& WithNextToken(NextTokenT&& value) {
