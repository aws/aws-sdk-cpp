...
namespace Model
{
  ...
  public:
    ...
    template<typename CloudVmClusterIdT = Aws::String>
    RebootDbNodeRequest& WithCloudVmClusterId(CloudVmClusterIdT&& value) { SetCloudVmClusterId(std::forward<CloudVmClusterIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DbNodeIdT = Aws::String>
    RebootDbNodeRequest& WithDbNodeId(DbNodeIdT&& value) { SetDbNodeId(std::forward<DbNodeIdT>(value)); return *this;}
    ///@}
  private:
