...
/**
 */
class RebootDbNodeRequest : public OdbRequest {
 public:
  AWS_ODB_API RebootDbNodeRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "RebootDbNode"; }
  ...
  ///@{
  /**
   * <p>The unique identifier of the VM cluster that contains the DB node to reboot.
   * You must specify either this parameter or <code>exadbVmClusterId</code>.</p>
   */
  ...
  template <typename CloudVmClusterIdT = Aws::String>
  RebootDbNodeRequest& WithCloudVmClusterId(CloudVmClusterIdT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the Exascale VM cluster that contains the DB node to
   * reboot. You must specify either this parameter or
   * <code>cloudVmClusterId</code>.</p>
   */
  ...
  template <typename ExadbVmClusterIdT = Aws::String>
  RebootDbNodeRequest& WithExadbVmClusterId(ExadbVmClusterIdT&& value) {
  ...
  void SetDbNodeId(DbNodeIdT&& value) {
    ...
    m_dbNodeId = std::forward<DbNodeIdT>(value);
  }
  template <typename DbNodeIdT = Aws::String>
  RebootDbNodeRequest& WithDbNodeId(DbNodeIdT&& value) {
    SetDbNodeId(std::forward<DbNodeIdT>(value));
    return *this;
  }
  ///@}
 private:
