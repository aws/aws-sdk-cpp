...
class OdbPeeringConnectionSummary {
 public:
  ...
  inline OdbPeeringConnectionSummary& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetOdbPeeringConnectionArn(OdbPeeringConnectionArnT&& value) {
    ...
    m_odbPeeringConnectionArn = std::forward<OdbPeeringConnectionArnT>(value);
  }
  template <typename OdbPeeringConnectionArnT = Aws::String>
  OdbPeeringConnectionSummary& WithOdbPeeringConnectionArn(OdbPeeringConnectionArnT&& value) {
    SetOdbPeeringConnectionArn(std::forward<OdbPeeringConnectionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPeerNetworkArn(PeerNetworkArnT&& value) {
    ...
    m_peerNetworkArn = std::forward<PeerNetworkArnT>(value);
  }
  template <typename PeerNetworkArnT = Aws::String>
  OdbPeeringConnectionSummary& WithPeerNetworkArn(PeerNetworkArnT&& value) {
    SetPeerNetworkArn(std::forward<PeerNetworkArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOdbPeeringConnectionType(OdbPeeringConnectionTypeT&& value) {
    ...
    m_odbPeeringConnectionType = std::forward<OdbPeeringConnectionTypeT>(value);
  }
  template <typename OdbPeeringConnectionTypeT = Aws::String>
  OdbPeeringConnectionSummary& WithOdbPeeringConnectionType(OdbPeeringConnectionTypeT&& value) {
    SetOdbPeeringConnectionType(std::forward<OdbPeeringConnectionTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline OdbPeeringConnectionSummary& WithPercentProgress(double value) {
