...
class CloudAutonomousVmClusterResourceDetails {
 public:
  ...
  template <typename CloudAutonomousVmClusterIdT = Aws::String>
  CloudAutonomousVmClusterResourceDetails& WithCloudAutonomousVmClusterId(CloudAutonomousVmClusterIdT&& value) {
  ...
  inline void SetUnallocatedAdbStorageInTBs(double value) {
    m_unallocatedAdbStorageInTBsHasBeenSet = true;
    m_unallocatedAdbStorageInTBs = value;
  }
  inline CloudAutonomousVmClusterResourceDetails& WithUnallocatedAdbStorageInTBs(double value) {
    SetUnallocatedAdbStorageInTBs(value);
    return *this;
  }
  ///@}
 private:
