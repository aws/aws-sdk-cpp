 ...
 * encryption key to use for an Autonomous Database.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/AwsEncryptionKeyConfigurationInput">AWS
 * API Reference</a></p>
 */
class AwsEncryptionKeyConfigurationInput {
 public:
  AWS_ODB_API AwsEncryptionKeyConfigurationInput() = default;
  ...
  inline AwsEncryptionKeyConfigurationInput& WithExternalIdType(ExternalIdType value) {
  ...
  ///@{
  /**
   * <p>The identifier or ARN of the Amazon Web Services KMS key to use for
   * encryption.</p>
   */
