 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/CloudVmClusterSummary">AWS
 * API Reference</a></p>
 */
class CloudVmClusterSummary {
 public:
  ...
  inline CloudVmClusterSummary& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CloudVmClusterSummary& WithCpuCoreCount(int value) {
  ...
  inline CloudVmClusterSummary& WithDataStorageSizeInTBs(double value) {
  ...
  inline CloudVmClusterSummary& WithDbNodeStorageSizeInGBs(int value) {
  ...
  inline CloudVmClusterSummary& WithDiskRedundancy(DiskRedundancy value) {
  ...
  inline CloudVmClusterSummary& WithIsLocalBackupEnabled(bool value) {
  ...
  inline CloudVmClusterSummary& WithIsSparseDiskgroupEnabled(bool value) {
  ...
  inline CloudVmClusterSummary& WithLicenseModel(LicenseModel value) {
  ...
  inline CloudVmClusterSummary& WithListenerPort(int value) {
  ...
  inline CloudVmClusterSummary& WithMemorySizeInGBs(int value) {
  ...
  inline CloudVmClusterSummary& WithNodeCount(int value) {
    SetNodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline CloudVmClusterSummary& WithStorageSizeInGBs(int value) {
  ...
  inline CloudVmClusterSummary& WithPercentProgress(double value) {
  ...
  inline CloudVmClusterSummary& WithComputeModel(ComputeModel value) {
