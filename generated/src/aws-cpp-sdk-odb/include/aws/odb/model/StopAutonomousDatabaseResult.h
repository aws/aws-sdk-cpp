...
namespace odb {
namespace Model {
class StopAutonomousDatabaseResult {
 public:
  AWS_ODB_API StopAutonomousDatabaseResult() = default;
  AWS_ODB_API StopAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API StopAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  StopAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  StopAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline StopAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  StopAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
