...
class MaintenanceWindow {
 public:
  ...
  inline void SetCustomActionTimeoutInMins(int value) {
    m_customActionTimeoutInMinsHasBeenSet = true;
    m_customActionTimeoutInMins = value;
  }
  inline MaintenanceWindow& WithCustomActionTimeoutInMins(int value) {
    SetCustomActionTimeoutInMins(value);
    return *this;
  }
  ///@}
  ...
  MaintenanceWindow& AddDaysOfWeek(DaysOfWeekT&& value) {
    m_daysOfWeekHasBeenSet = true;
    m_daysOfWeek.emplace_back(std::forward<DaysOfWeekT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHoursOfDay(HoursOfDayT&& value) {
    ...
    m_hoursOfDay = std::forward<HoursOfDayT>(value);
  }
  template <typename HoursOfDayT = Aws::Vector<int>>
  MaintenanceWindow& WithHoursOfDay(HoursOfDayT&& value) {
    SetHoursOfDay(std::forward<HoursOfDayT>(value));
    return *this;
  }
  inline MaintenanceWindow& AddHoursOfDay(int value) {
    m_hoursOfDayHasBeenSet = true;
    m_hoursOfDay.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsCustomActionTimeoutEnabled(bool value) {
    m_isCustomActionTimeoutEnabledHasBeenSet = true;
    m_isCustomActionTimeoutEnabled = value;
  }
  inline MaintenanceWindow& WithIsCustomActionTimeoutEnabled(bool value) {
    SetIsCustomActionTimeoutEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLeadTimeInWeeks(int value) {
    m_leadTimeInWeeksHasBeenSet = true;
    m_leadTimeInWeeks = value;
  }
  inline MaintenanceWindow& WithLeadTimeInWeeks(int value) {
    SetLeadTimeInWeeks(value);
    return *this;
  }
  ///@}
  ...
  void SetMonths(MonthsT&& value) {
    ...
    m_months = std::forward<MonthsT>(value);
  }
  template <typename MonthsT = Aws::Vector<Month>>
  MaintenanceWindow& WithMonths(MonthsT&& value) {
    SetMonths(std::forward<MonthsT>(value));
    return *this;
  }
  template <typename MonthsT = Month>
  MaintenanceWindow& AddMonths(MonthsT&& value) {
    m_monthsHasBeenSet = true;
    m_months.emplace_back(std::forward<MonthsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPatchingMode(PatchingModeType value) {
    m_patchingModeHasBeenSet = true;
    m_patchingMode = value;
  }
  inline MaintenanceWindow& WithPatchingMode(PatchingModeType value) {
    SetPatchingMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreference(PreferenceType value) {
    m_preferenceHasBeenSet = true;
    m_preference = value;
  }
  inline MaintenanceWindow& WithPreference(PreferenceType value) {
    SetPreference(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkipRu(bool value) {
    m_skipRuHasBeenSet = true;
    m_skipRu = value;
  }
  inline MaintenanceWindow& WithSkipRu(bool value) {
    SetSkipRu(value);
    return *this;
  }
  ///@}
  ...
  void SetWeeksOfMonth(WeeksOfMonthT&& value) {
    ...
    m_weeksOfMonth = std::forward<WeeksOfMonthT>(value);
  }
  template <typename WeeksOfMonthT = Aws::Vector<int>>
  MaintenanceWindow& WithWeeksOfMonth(WeeksOfMonthT&& value) {
    SetWeeksOfMonth(std::forward<WeeksOfMonthT>(value));
    return *this;
  }
  inline MaintenanceWindow& AddWeeksOfMonth(int value) {
    m_weeksOfMonthHasBeenSet = true;
    m_weeksOfMonth.push_back(value);
    return *this;
  }
  ///@}
 private:
