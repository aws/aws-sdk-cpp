...
namespace Model
{
  ...
  public:
    ...
    template<typename DisplayNameT = Aws::String>
    UpdateCloudExadataInfrastructureResult& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateCloudExadataInfrastructureResult& WithStatus(ResourceStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusReasonT = Aws::String>
    UpdateCloudExadataInfrastructureResult& WithStatusReason(StatusReasonT&& value) { SetStatusReason(std::forward<StatusReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename CloudExadataInfrastructureIdT = Aws::String>
    UpdateCloudExadataInfrastructureResult& WithCloudExadataInfrastructureId(CloudExadataInfrastructureIdT&& value) { SetCloudExadataInfrastructureId(std::forward<CloudExadataInfrastructureIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCloudExadataInfrastructureResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
