...
namespace odb {
namespace Model {
class RestoreAutonomousDatabaseResult {
 public:
  AWS_ODB_API RestoreAutonomousDatabaseResult() = default;
  AWS_ODB_API RestoreAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API RestoreAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  RestoreAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  RestoreAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the Autonomous Database after the restore
   * operation.</p>
   */
  ...
  inline RestoreAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  RestoreAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RestoreAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
