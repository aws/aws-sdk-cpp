...
/**
 * <p>Information about an Autonomous Database backup.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/AutonomousDatabaseBackup">AWS
 * API Reference</a></p>
 */
class AutonomousDatabaseBackup {
 public:
  ...
  inline AutonomousDatabaseBackup& WithStatus(AutonomousDatabaseBackupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AutonomousDatabaseBackup& WithIsAutomatic(bool value) {
  ...
  inline AutonomousDatabaseBackup& WithRetentionPeriodInDays(int value) {
  ...
  inline AutonomousDatabaseBackup& WithSizeInTBs(double value) {
    SetSizeInTBs(value);
    return *this;
  }
  ///@}
  ...
  inline AutonomousDatabaseBackup& WithType(AutonomousDatabaseBackupType value) {
    SetType(value);
    return *this;
  }
  ///@}
