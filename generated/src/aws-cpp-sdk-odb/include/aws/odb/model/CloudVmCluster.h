...
class CloudVmCluster {
 public:
  ...
  void SetCloudVmClusterId(CloudVmClusterIdT&& value) {
    ...
    m_cloudVmClusterId = std::forward<CloudVmClusterIdT>(value);
  }
  template <typename CloudVmClusterIdT = Aws::String>
  ...
  inline CloudVmCluster& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCloudVmClusterArn(CloudVmClusterArnT&& value) {
    ...
    m_cloudVmClusterArn = std::forward<CloudVmClusterArnT>(value);
  }
  template <typename CloudVmClusterArnT = Aws::String>
  CloudVmCluster& WithCloudVmClusterArn(CloudVmClusterArnT&& value) {
    SetCloudVmClusterArn(std::forward<CloudVmClusterArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CloudVmCluster& WithCpuCoreCount(int value) {
  ...
  inline CloudVmCluster& WithDataStorageSizeInTBs(double value) {
  ...
  inline CloudVmCluster& WithDbNodeStorageSizeInGBs(int value) {
  ...
  inline void SetDiskRedundancy(DiskRedundancy value) {
    m_diskRedundancyHasBeenSet = true;
    m_diskRedundancy = value;
  }
  inline CloudVmCluster& WithDiskRedundancy(DiskRedundancy value) {
    SetDiskRedundancy(value);
    return *this;
  }
  ///@}
  ...
  inline CloudVmCluster& WithIsLocalBackupEnabled(bool value) {
  ...
  inline CloudVmCluster& WithIsSparseDiskgroupEnabled(bool value) {
  ...
  inline CloudVmCluster& WithLicenseModel(LicenseModel value) {
  ...
  inline CloudVmCluster& WithListenerPort(int value) {
  ...
  inline CloudVmCluster& WithMemorySizeInGBs(int value) {
  ...
  inline CloudVmCluster& WithNodeCount(int value) {
    SetNodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageSizeInGBs(int value) {
    m_storageSizeInGBsHasBeenSet = true;
    m_storageSizeInGBs = value;
  }
  inline CloudVmCluster& WithStorageSizeInGBs(int value) {
    SetStorageSizeInGBs(value);
    return *this;
  }
  ///@}
  ...
  inline CloudVmCluster& WithPercentProgress(double value) {
  ...
  inline CloudVmCluster& WithComputeModel(ComputeModel value) {
   ...
   * associated with the VM cluster.</p>
   */
