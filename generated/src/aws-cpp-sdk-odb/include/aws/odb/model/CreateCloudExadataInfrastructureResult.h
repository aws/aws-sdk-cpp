...
class CreateCloudExadataInfrastructureResult {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  CreateCloudExadataInfrastructureResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateCloudExadataInfrastructureResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateCloudExadataInfrastructureResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename CloudExadataInfrastructureIdT = Aws::String>
  CreateCloudExadataInfrastructureResult& WithCloudExadataInfrastructureId(CloudExadataInfrastructureIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCloudExadataInfrastructureResult& WithRequestId(RequestIdT&& value) {
