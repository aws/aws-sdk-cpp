...
class UpdateOdbNetworkResult {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateOdbNetworkResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline UpdateOdbNetworkResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateOdbNetworkResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename OdbNetworkIdT = Aws::String>
  UpdateOdbNetworkResult& WithOdbNetworkId(OdbNetworkIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOdbNetworkResult& WithRequestId(RequestIdT&& value) {
