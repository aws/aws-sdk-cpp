...
class ListCloudAutonomousVmClustersResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudAutonomousVmClustersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CloudAutonomousVmClustersT = Aws::Vector<CloudAutonomousVmClusterSummary>>
  ListCloudAutonomousVmClustersResult& WithCloudAutonomousVmClusters(CloudAutonomousVmClustersT&& value) {
  ...
  ListCloudAutonomousVmClustersResult& AddCloudAutonomousVmClusters(CloudAutonomousVmClustersT&& value) {
    m_cloudAutonomousVmClustersHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListCloudAutonomousVmClustersResult& WithRequestId(RequestIdT&& value) {
