...
class ListCloudVmClustersRequest : public OdbRequest {
 public:
  ...
  inline ListCloudVmClustersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCloudVmClustersRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CloudExadataInfrastructureIdT = Aws::String>
  ListCloudVmClustersRequest& WithCloudExadataInfrastructureId(CloudExadataInfrastructureIdT&& value) {
