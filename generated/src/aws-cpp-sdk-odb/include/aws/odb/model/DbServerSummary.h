...
namespace Model
{
  ...
  public:
    ...
    template<typename DbServerIdT = Aws::String>
    DbServerSummary& WithDbServerId(DbServerIdT&& value) { SetDbServerId(std::forward<DbServerIdT>(value)); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithStatus(ResourceStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusReasonT = Aws::String>
    DbServerSummary& WithStatusReason(StatusReasonT&& value) { SetStatusReason(std::forward<StatusReasonT>(value)); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithCpuCoreCount(int value) { SetCpuCoreCount(value); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithDbNodeStorageSizeInGBs(int value) { SetDbNodeStorageSizeInGBs(value); return *this;}
    ///@}
    ...
    template<typename DbServerPatchingDetailsT = DbServerPatchingDetails>
    DbServerSummary& WithDbServerPatchingDetails(DbServerPatchingDetailsT&& value) { SetDbServerPatchingDetails(std::forward<DbServerPatchingDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayNameT = Aws::String>
    DbServerSummary& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ExadataInfrastructureIdT = Aws::String>
    DbServerSummary& WithExadataInfrastructureId(ExadataInfrastructureIdT&& value) { SetExadataInfrastructureId(std::forward<ExadataInfrastructureIdT>(value)); return *this;}
    ///@}
    ...
    template<typename OcidT = Aws::String>
    DbServerSummary& WithOcid(OcidT&& value) { SetOcid(std::forward<OcidT>(value)); return *this;}
    ///@}
    ...
    template<typename OciResourceAnchorNameT = Aws::String>
    DbServerSummary& WithOciResourceAnchorName(OciResourceAnchorNameT&& value) { SetOciResourceAnchorName(std::forward<OciResourceAnchorNameT>(value)); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithMaxCpuCount(int value) { SetMaxCpuCount(value); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithMaxDbNodeStorageInGBs(int value) { SetMaxDbNodeStorageInGBs(value); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithMaxMemoryInGBs(int value) { SetMaxMemoryInGBs(value); return *this;}
    ///@}
    ...
    inline DbServerSummary& WithMemorySizeInGBs(int value) { SetMemorySizeInGBs(value); return *this;}
    ///@}
    ...
    template<typename ShapeT = Aws::String>
    DbServerSummary& WithShape(ShapeT&& value) { SetShape(std::forward<ShapeT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    DbServerSummary& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename VmClusterIdsT = Aws::Vector<Aws::String>>
    DbServerSummary& WithVmClusterIds(VmClusterIdsT&& value) { SetVmClusterIds(std::forward<VmClusterIdsT>(value)); return *this;}
    template<typename VmClusterIdsT = Aws::String>
    DbServerSummary& AddVmClusterIds(VmClusterIdsT&& value) { m_vmClusterIdsHasBeenSet = true; m_vmClusterIds.emplace_back(std::forward<VmClusterIdsT>(value)); return *this; }
    ///@}
    ...
    inline DbServerSummary& WithComputeModel(ComputeModel value) { SetComputeModel(value); return *this;}
    ///@}
    ...
    template<typename AutonomousVmClusterIdsT = Aws::Vector<Aws::String>>
    DbServerSummary& WithAutonomousVmClusterIds(AutonomousVmClusterIdsT&& value) { SetAutonomousVmClusterIds(std::forward<AutonomousVmClusterIdsT>(value)); return *this;}
    template<typename AutonomousVmClusterIdsT = Aws::String>
    DbServerSummary& AddAutonomousVmClusterIds(AutonomousVmClusterIdsT&& value) { m_autonomousVmClusterIdsHasBeenSet = true; m_autonomousVmClusterIds.emplace_back(std::forward<AutonomousVmClusterIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename AutonomousVirtualMachineIdsT = Aws::Vector<Aws::String>>
    DbServerSummary& WithAutonomousVirtualMachineIds(AutonomousVirtualMachineIdsT&& value) { SetAutonomousVirtualMachineIds(std::forward<AutonomousVirtualMachineIdsT>(value)); return *this;}
    template<typename AutonomousVirtualMachineIdsT = Aws::String>
    DbServerSummary& AddAutonomousVirtualMachineIds(AutonomousVirtualMachineIdsT&& value) { m_autonomousVirtualMachineIdsHasBeenSet = true; m_autonomousVirtualMachineIds.emplace_back(std::forward<AutonomousVirtualMachineIdsT>(value)); return *this; }
    ///@}
  private:
