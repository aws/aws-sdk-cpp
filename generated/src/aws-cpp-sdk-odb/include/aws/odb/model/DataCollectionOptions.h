...
class DataCollectionOptions {
 public:
  ...
  inline void SetIsDiagnosticsEventsEnabled(bool value) {
    m_isDiagnosticsEventsEnabledHasBeenSet = true;
    m_isDiagnosticsEventsEnabled = value;
  }
  inline DataCollectionOptions& WithIsDiagnosticsEventsEnabled(bool value) {
    SetIsDiagnosticsEventsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsHealthMonitoringEnabled(bool value) {
    m_isHealthMonitoringEnabledHasBeenSet = true;
    m_isHealthMonitoringEnabled = value;
  }
  inline DataCollectionOptions& WithIsHealthMonitoringEnabled(bool value) {
    SetIsHealthMonitoringEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsIncidentLogsEnabled(bool value) {
    m_isIncidentLogsEnabledHasBeenSet = true;
    m_isIncidentLogsEnabled = value;
  }
  inline DataCollectionOptions& WithIsIncidentLogsEnabled(bool value) {
    SetIsIncidentLogsEnabled(value);
    return *this;
  }
  ///@}
 private:
