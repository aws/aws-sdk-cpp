...
namespace odb {
namespace Model {
class UpdateAutonomousDatabaseBackupResult {
 public:
  AWS_ODB_API UpdateAutonomousDatabaseBackupResult() = default;
  AWS_ODB_API UpdateAutonomousDatabaseBackupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API UpdateAutonomousDatabaseBackupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DisplayNameT = Aws::String>
  UpdateAutonomousDatabaseBackupResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline UpdateAutonomousDatabaseBackupResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  UpdateAutonomousDatabaseBackupResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename AutonomousDatabaseBackupIdT = Aws::String>
  UpdateAutonomousDatabaseBackupResult& WithAutonomousDatabaseBackupId(AutonomousDatabaseBackupIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAutonomousDatabaseBackupResult& WithRequestId(RequestIdT&& value) {
