...
class CreateOdbNetworkResult {
 public:
  ...
  template <typename DisplayNameT = Aws::String>
  CreateOdbNetworkResult& WithDisplayName(DisplayNameT&& value) {
  ...
  inline CreateOdbNetworkResult& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  CreateOdbNetworkResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename OdbNetworkIdT = Aws::String>
  CreateOdbNetworkResult& WithOdbNetworkId(OdbNetworkIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOdbNetworkResult& WithRequestId(RequestIdT&& value) {
