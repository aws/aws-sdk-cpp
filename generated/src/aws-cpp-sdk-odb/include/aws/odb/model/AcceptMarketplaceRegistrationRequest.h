...
class AcceptMarketplaceRegistrationRequest : public OdbRequest {
 public:
  ...
  void SetMarketplaceRegistrationToken(MarketplaceRegistrationTokenT&& value) {
    m_marketplaceRegistrationTokenHasBeenSet = true;
    m_marketplaceRegistrationToken = std::forward<MarketplaceRegistrationTokenT>(value);
  }
  template <typename MarketplaceRegistrationTokenT = Aws::String>
  AcceptMarketplaceRegistrationRequest& WithMarketplaceRegistrationToken(MarketplaceRegistrationTokenT&& value) {
    SetMarketplaceRegistrationToken(std::forward<MarketplaceRegistrationTokenT>(value));
    return *this;
  }
  ///@}
 private:
