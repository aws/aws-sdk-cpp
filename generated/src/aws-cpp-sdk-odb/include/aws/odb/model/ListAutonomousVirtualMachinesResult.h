...
class ListAutonomousVirtualMachinesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAutonomousVirtualMachinesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAutonomousVirtualMachines(AutonomousVirtualMachinesT&& value) {
    m_autonomousVirtualMachinesHasBeenSet = true;
    m_autonomousVirtualMachines = std::forward<AutonomousVirtualMachinesT>(value);
  }
  template <typename AutonomousVirtualMachinesT = Aws::Vector<AutonomousVirtualMachineSummary>>
  ListAutonomousVirtualMachinesResult& WithAutonomousVirtualMachines(AutonomousVirtualMachinesT&& value) {
    SetAutonomousVirtualMachines(std::forward<AutonomousVirtualMachinesT>(value));
    return *this;
  }
  template <typename AutonomousVirtualMachinesT = AutonomousVirtualMachineSummary>
  ListAutonomousVirtualMachinesResult& AddAutonomousVirtualMachines(AutonomousVirtualMachinesT&& value) {
    m_autonomousVirtualMachinesHasBeenSet = true;
    m_autonomousVirtualMachines.emplace_back(std::forward<AutonomousVirtualMachinesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAutonomousVirtualMachinesResult& WithRequestId(RequestIdT&& value) {
