...
class GetCloudAutonomousVmClusterResult {
 public:
  ...
  void SetCloudAutonomousVmCluster(CloudAutonomousVmClusterT&& value) {
    m_cloudAutonomousVmClusterHasBeenSet = true;
    m_cloudAutonomousVmCluster = std::forward<CloudAutonomousVmClusterT>(value);
  }
  template <typename CloudAutonomousVmClusterT = CloudAutonomousVmCluster>
  GetCloudAutonomousVmClusterResult& WithCloudAutonomousVmCluster(CloudAutonomousVmClusterT&& value) {
    SetCloudAutonomousVmCluster(std::forward<CloudAutonomousVmClusterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCloudAutonomousVmClusterResult& WithRequestId(RequestIdT&& value) {
