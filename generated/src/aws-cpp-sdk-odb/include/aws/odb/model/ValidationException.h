...
namespace Model
{
  ...
  /**
   * <p>The request has failed validation because it is missing required fields or
   * has invalid inputs.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_ODB_API ValidationException() = default;
    AWS_ODB_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_ODB_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
