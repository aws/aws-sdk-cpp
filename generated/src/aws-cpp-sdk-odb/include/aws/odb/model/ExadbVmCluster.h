...
/**
 * <p>Information about an Exascale VM cluster.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/odb-2024-08-20/ExadbVmCluster">AWS
 * API Reference</a></p>
 */
class ExadbVmCluster {
 public:
  ...
  inline ExadbVmCluster& WithEnabledEcpuCount(int value) {
  ...
  inline ExadbVmCluster& WithGridImageType(GridImageType value) {
  ...
  inline ExadbVmCluster& WithLicenseModel(LicenseModel value) {
  ...
  inline ExadbVmCluster& WithListenerPort(int value) {
  ...
  inline ExadbVmCluster& WithMemorySizeInGBs(int value) {
  ...
  inline ExadbVmCluster& WithNodeCount(int value) {
    SetNodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline ExadbVmCluster& WithPercentProgress(double value) {
  ...
  inline ExadbVmCluster& WithScanListenerPortTcp(int value) {
  ...
  inline ExadbVmCluster& WithScanListenerPortTcpSsl(int value) {
  ...
  inline ExadbVmCluster& WithShapeAttribute(ShapeAttribute value) {
  ...
  inline ExadbVmCluster& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ExadbVmCluster& WithTotalEcpuCount(int value) {
