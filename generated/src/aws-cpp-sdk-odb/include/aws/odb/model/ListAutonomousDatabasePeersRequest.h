...
/**
 */
class ListAutonomousDatabasePeersRequest : public OdbRequest {
 public:
  AWS_ODB_API ListAutonomousDatabasePeersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAutonomousDatabasePeers"; }
  ...
  inline ListAutonomousDatabasePeersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutonomousDatabasePeersRequest& WithNextToken(NextTokenT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the Autonomous Database whose peer databases you
   * want to list.</p>
   */
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  ListAutonomousDatabasePeersRequest& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
