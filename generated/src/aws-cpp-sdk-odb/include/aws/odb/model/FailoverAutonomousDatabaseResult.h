...
namespace odb {
namespace Model {
class FailoverAutonomousDatabaseResult {
 public:
  AWS_ODB_API FailoverAutonomousDatabaseResult() = default;
  AWS_ODB_API FailoverAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ODB_API FailoverAutonomousDatabaseResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AutonomousDatabaseIdT = Aws::String>
  FailoverAutonomousDatabaseResult& WithAutonomousDatabaseId(AutonomousDatabaseIdT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  FailoverAutonomousDatabaseResult& WithDisplayName(DisplayNameT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the Autonomous Database after the failover
   * operation.</p>
   */
  ...
  inline FailoverAutonomousDatabaseResult& WithStatus(AutonomousDatabaseResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  FailoverAutonomousDatabaseResult& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  FailoverAutonomousDatabaseResult& WithRequestId(RequestIdT&& value) {
