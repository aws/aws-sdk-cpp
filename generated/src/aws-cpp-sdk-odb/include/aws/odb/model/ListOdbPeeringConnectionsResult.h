...
class ListOdbPeeringConnectionsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOdbPeeringConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetOdbPeeringConnections(OdbPeeringConnectionsT&& value) {
    m_odbPeeringConnectionsHasBeenSet = true;
    m_odbPeeringConnections = std::forward<OdbPeeringConnectionsT>(value);
  }
  template <typename OdbPeeringConnectionsT = Aws::Vector<OdbPeeringConnectionSummary>>
  ListOdbPeeringConnectionsResult& WithOdbPeeringConnections(OdbPeeringConnectionsT&& value) {
    SetOdbPeeringConnections(std::forward<OdbPeeringConnectionsT>(value));
    return *this;
  }
  template <typename OdbPeeringConnectionsT = OdbPeeringConnectionSummary>
  ListOdbPeeringConnectionsResult& AddOdbPeeringConnections(OdbPeeringConnectionsT&& value) {
    m_odbPeeringConnectionsHasBeenSet = true;
    m_odbPeeringConnections.emplace_back(std::forward<OdbPeeringConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListOdbPeeringConnectionsResult& WithRequestId(RequestIdT&& value) {
