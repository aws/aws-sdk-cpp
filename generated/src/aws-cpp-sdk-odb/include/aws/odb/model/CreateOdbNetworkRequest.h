...
class CreateOdbNetworkRequest : public OdbRequest {
 public:
  ...
  inline CreateOdbNetworkRequest& WithS3Access(Access value) {
    SetS3Access(value);
    return *this;
  }
  ///@}
  ...
  inline CreateOdbNetworkRequest& WithZeroEtlAccess(Access value) {
  ...
  inline CreateOdbNetworkRequest& WithStsAccess(Access value) {
    SetStsAccess(value);
    return *this;
  }
  ///@}
  ...
  inline CreateOdbNetworkRequest& WithKmsAccess(Access value) {
    SetKmsAccess(value);
    return *this;
  }
  ///@}
