...
class DbServer {
 public:
  ...
  inline DbServer& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DbServer& WithCpuCoreCount(int value) {
  ...
  inline DbServer& WithDbNodeStorageSizeInGBs(int value) {
  ...
  inline DbServer& WithMaxCpuCount(int value) {
  ...
  inline DbServer& WithMaxDbNodeStorageInGBs(int value) {
  ...
  inline DbServer& WithMaxMemoryInGBs(int value) {
  ...
  inline DbServer& WithMemorySizeInGBs(int value) {
  ...
  inline DbServer& WithComputeModel(ComputeModel value) {
