...
class ListOdbPeeringConnectionsRequest : public OdbRequest {
 public:
  ...
  inline ListOdbPeeringConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOdbPeeringConnectionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename OdbNetworkIdT = Aws::String>
  ListOdbPeeringConnectionsRequest& WithOdbNetworkId(OdbNetworkIdT&& value) {
