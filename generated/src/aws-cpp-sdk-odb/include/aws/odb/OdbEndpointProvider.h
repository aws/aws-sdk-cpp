 ...
 */
using OdbEndpointProviderBase = EndpointProviderBase<OdbClientConfiguration, OdbBuiltInParameters, OdbClientContextParameters>;

using OdbDefaultEpProviderBase = DefaultEndpointProvider<OdbClientConfiguration, OdbBuiltInParameters, OdbClientContextParameters>;
...
class AWS_ODB_API OdbEndpointProvider : public OdbDefaultEpProviderBase {
 public:
  ...
  OdbEndpointProvider() : OdbDefaultEpProviderBase(Aws::odb::OdbEndpointRules::GetRulesBlob(), Aws::odb::OdbEndpointRules::RulesBlobSize) {}
