...
UpdateCloudExadataInfrastructureResult::UpdateCloudExadataInfrastructureResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateCloudExadataInfrastructureResult& UpdateCloudExadataInfrastructureResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
