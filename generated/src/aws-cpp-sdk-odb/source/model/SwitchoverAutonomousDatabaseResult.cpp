...
SwitchoverAutonomousDatabaseResult::SwitchoverAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

SwitchoverAutonomousDatabaseResult& SwitchoverAutonomousDatabaseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
