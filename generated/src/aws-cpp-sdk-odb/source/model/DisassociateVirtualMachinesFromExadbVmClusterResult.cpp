...
DisassociateVirtualMachinesFromExadbVmClusterResult::DisassociateVirtualMachinesFromExadbVmClusterResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DisassociateVirtualMachinesFromExadbVmClusterResult& DisassociateVirtualMachinesFromExadbVmClusterResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
