...
UpdateExadbVmClusterResult::UpdateExadbVmClusterResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateExadbVmClusterResult& UpdateExadbVmClusterResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
