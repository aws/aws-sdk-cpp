...
DbNodeSummary::DbNodeSummary(JsonView jsonValue) { *this = jsonValue; }

DbNodeSummary& DbNodeSummary::operator=(JsonView jsonValue) {
...
JsonValue DbNodeSummary::Jsonize() const {
  JsonValue payload;
