...
AutonomousDatabaseBackup::AutonomousDatabaseBackup(JsonView jsonValue) { *this = jsonValue; }

AutonomousDatabaseBackup& AutonomousDatabaseBackup::operator=(JsonView jsonValue) {
...
JsonValue AutonomousDatabaseBackup::Jsonize() const {
  JsonValue payload;
