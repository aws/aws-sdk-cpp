...
ShrinkAutonomousDatabaseResult::ShrinkAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ShrinkAutonomousDatabaseResult& ShrinkAutonomousDatabaseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
