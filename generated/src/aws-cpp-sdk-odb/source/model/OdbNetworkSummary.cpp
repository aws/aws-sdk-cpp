...
OdbNetworkSummary::OdbNetworkSummary(JsonView jsonValue) { *this = jsonValue; }

OdbNetworkSummary& OdbNetworkSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ociDnsForwardingConfigs")) {
    ...
    for (unsigned ociDnsForwardingConfigsIndex = 0; ociDnsForwardingConfigsIndex < ociDnsForwardingConfigsJsonList.GetLength();
         ++ociDnsForwardingConfigsIndex) {
...
JsonValue OdbNetworkSummary::Jsonize() const {
  JsonValue payload;
  ...
  if (m_ociDnsForwardingConfigsHasBeenSet) {
    ...
    for (unsigned ociDnsForwardingConfigsIndex = 0; ociDnsForwardingConfigsIndex < ociDnsForwardingConfigsJsonList.GetLength();
         ++ociDnsForwardingConfigsIndex) {
      ociDnsForwardingConfigsJsonList[ociDnsForwardingConfigsIndex].AsObject(
          m_ociDnsForwardingConfigs[ociDnsForwardingConfigsIndex].Jsonize());
    }
