...
UpdateExascaleDbStorageVaultResult::UpdateExascaleDbStorageVaultResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateExascaleDbStorageVaultResult& UpdateExascaleDbStorageVaultResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
