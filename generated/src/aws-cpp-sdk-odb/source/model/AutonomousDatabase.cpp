...
AutonomousDatabase::AutonomousDatabase(JsonView jsonValue) { *this = jsonValue; }

AutonomousDatabase& AutonomousDatabase::operator=(JsonView jsonValue) {
...
JsonValue AutonomousDatabase::Jsonize() const {
  JsonValue payload;
