...
AssociateVirtualMachinesToExadbVmClusterResult::AssociateVirtualMachinesToExadbVmClusterResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

AssociateVirtualMachinesToExadbVmClusterResult& AssociateVirtualMachinesToExadbVmClusterResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
