...
DbServerSummary::DbServerSummary(JsonView jsonValue) { *this = jsonValue; }
...
DbServerSummary& DbServerSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("autonomousVmClusterIds")) {
    ...
    for (unsigned autonomousVmClusterIdsIndex = 0; autonomousVmClusterIdsIndex < autonomousVmClusterIdsJsonList.GetLength();
         ++autonomousVmClusterIdsIndex) {
  ...
  if (jsonValue.ValueExists("autonomousVirtualMachineIds")) {
    ...
    for (unsigned autonomousVirtualMachineIdsIndex = 0; autonomousVirtualMachineIdsIndex < autonomousVirtualMachineIdsJsonList.GetLength();
         ++autonomousVirtualMachineIdsIndex) {
...
JsonValue DbServerSummary::Jsonize() const {
  ...
  if (m_autonomousVirtualMachineIdsHasBeenSet) {
    ...
    for (unsigned autonomousVirtualMachineIdsIndex = 0; autonomousVirtualMachineIdsIndex < autonomousVirtualMachineIdsJsonList.GetLength();
         ++autonomousVirtualMachineIdsIndex) {
      autonomousVirtualMachineIdsJsonList[autonomousVirtualMachineIdsIndex].AsString(
          m_autonomousVirtualMachineIds[autonomousVirtualMachineIdsIndex]);
    }
