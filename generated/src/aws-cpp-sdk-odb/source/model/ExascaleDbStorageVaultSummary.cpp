...
ExascaleDbStorageVaultSummary::ExascaleDbStorageVaultSummary(JsonView jsonValue) { *this = jsonValue; }

ExascaleDbStorageVaultSummary& ExascaleDbStorageVaultSummary::operator=(JsonView jsonValue) {
...
JsonValue ExascaleDbStorageVaultSummary::Jsonize() const {
  JsonValue payload;
