...
Aws::String UpdateOdbPeeringConnectionRequest::SerializePayload() const
{
  ...
  if(m_peerNetworkCidrsToBeRemovedHasBeenSet)
  {
   ...
   for(unsigned peerNetworkCidrsToBeRemovedIndex = 0; peerNetworkCidrsToBeRemovedIndex < peerNetworkCidrsToBeRemovedJsonList.GetLength(); ++peerNetworkCidrsToBeRemovedIndex)
   {
     peerNetworkCidrsToBeRemovedJsonList[peerNetworkCidrsToBeRemovedIndex].AsString(m_peerNetworkCidrsToBeRemoved[peerNetworkCidrsToBeRemovedIndex]);
   }
