...
ExadbVmCluster::ExadbVmCluster(JsonView jsonValue) { *this = jsonValue; }

ExadbVmCluster& ExadbVmCluster::operator=(JsonView jsonValue) {
...
JsonValue ExadbVmCluster::Jsonize() const {
  JsonValue payload;
