...
OdbPeeringConnectionSummary::OdbPeeringConnectionSummary(JsonView jsonValue) { *this = jsonValue; }

OdbPeeringConnectionSummary& OdbPeeringConnectionSummary::operator=(JsonView jsonValue) {
...
JsonValue OdbPeeringConnectionSummary::Jsonize() const {
  JsonValue payload;
