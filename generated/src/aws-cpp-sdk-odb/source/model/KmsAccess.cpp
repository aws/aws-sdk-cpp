...
KmsAccess::KmsAccess(JsonView jsonValue) { *this = jsonValue; }

KmsAccess& KmsAccess::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("kmsPolicyDocument")) {
    m_kmsPolicyDocument = jsonValue.GetString("kmsPolicyDocument");
    m_kmsPolicyDocumentHasBeenSet = true;
  }
  return *this;
}

JsonValue KmsAccess::Jsonize() const {
  JsonValue payload;
