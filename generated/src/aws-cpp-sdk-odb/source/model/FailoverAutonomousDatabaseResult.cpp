...
FailoverAutonomousDatabaseResult::FailoverAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

FailoverAutonomousDatabaseResult& FailoverAutonomousDatabaseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
