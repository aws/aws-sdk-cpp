...
CreateAutonomousDatabaseBackupResult::CreateAutonomousDatabaseBackupResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateAutonomousDatabaseBackupResult& CreateAutonomousDatabaseBackupResult::operator=(
