...
UpdateOdbNetworkResult::UpdateOdbNetworkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateOdbNetworkResult& UpdateOdbNetworkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
