...
ListCloudExadataInfrastructuresResult& ListCloudExadataInfrastructuresResult::operator=(
  ...
  if (jsonValue.ValueExists("cloudExadataInfrastructures")) {
    ...
    for (unsigned cloudExadataInfrastructuresIndex = 0; cloudExadataInfrastructuresIndex < cloudExadataInfrastructuresJsonList.GetLength();
         ++cloudExadataInfrastructuresIndex) {
