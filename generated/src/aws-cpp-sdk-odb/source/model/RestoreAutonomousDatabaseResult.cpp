...
RestoreAutonomousDatabaseResult::RestoreAutonomousDatabaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RestoreAutonomousDatabaseResult& RestoreAutonomousDatabaseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
