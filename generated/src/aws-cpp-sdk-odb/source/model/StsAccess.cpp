...
StsAccess::StsAccess(JsonView jsonValue) { *this = jsonValue; }

StsAccess& StsAccess::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("stsPolicyDocument")) {
    m_stsPolicyDocument = jsonValue.GetString("stsPolicyDocument");
    m_stsPolicyDocumentHasBeenSet = true;
  }
  return *this;
}

JsonValue StsAccess::Jsonize() const {
  JsonValue payload;
