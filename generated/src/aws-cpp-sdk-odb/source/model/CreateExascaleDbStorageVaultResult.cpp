...
CreateExascaleDbStorageVaultResult::CreateExascaleDbStorageVaultResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateExascaleDbStorageVaultResult& CreateExascaleDbStorageVaultResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
