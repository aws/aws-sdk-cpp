...
CreateExadbVmClusterResult::CreateExadbVmClusterResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateExadbVmClusterResult& CreateExadbVmClusterResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
