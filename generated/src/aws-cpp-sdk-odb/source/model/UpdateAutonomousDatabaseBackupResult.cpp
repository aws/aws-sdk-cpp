...
UpdateAutonomousDatabaseBackupResult::UpdateAutonomousDatabaseBackupResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateAutonomousDatabaseBackupResult& UpdateAutonomousDatabaseBackupResult::operator=(
