...
CloudVmCluster::CloudVmCluster(JsonView jsonValue) { *this = jsonValue; }

CloudVmCluster& CloudVmCluster::operator=(JsonView jsonValue) {
...
JsonValue CloudVmCluster::Jsonize() const {
  JsonValue payload;
