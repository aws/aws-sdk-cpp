...
CloudAutonomousVmClusterSummary::CloudAutonomousVmClusterSummary(JsonView jsonValue) { *this = jsonValue; }

CloudAutonomousVmClusterSummary& CloudAutonomousVmClusterSummary::operator=(JsonView jsonValue) {
...
JsonValue CloudAutonomousVmClusterSummary::Jsonize() const {
  JsonValue payload;
  ...
  if (m_timeDatabaseSslCertificateExpiresHasBeenSet) {
    payload.WithString("timeDatabaseSslCertificateExpires",
                       m_timeDatabaseSslCertificateExpires.ToGmtString(Aws::Utils::DateFormat::ISO_8601));
  }
