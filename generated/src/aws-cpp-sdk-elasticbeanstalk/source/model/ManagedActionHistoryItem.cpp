...
ManagedActionHistoryItem::ManagedActionHistoryItem(const XmlNode& xmlNode) { *this = xmlNode; }
...
ManagedActionHistoryItem& ManagedActionHistoryItem::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!actionTypeNode.IsNull()) {
      m_actionType = ActionTypeMapper::GetActionTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(actionTypeNode.GetText()).c_str()));
    ...
    if (!failureTypeNode.IsNull()) {
      m_failureType = FailureTypeMapper::GetFailureTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(failureTypeNode.GetText()).c_str()));
      m_failureTypeHasBeenSet = true;
    }
    XmlNode statusNode = resultNode.FirstChild("Status");
    if (!statusNode.IsNull()) {
      m_status = ActionHistoryStatusMapper::GetActionHistoryStatusForName(
    ...
    if (!executedTimeNode.IsNull()) {
      m_executedTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(executedTimeNode.GetText()).c_str()).c_str(),
                                Aws::Utils::DateFormat::ISO_8601);
      m_executedTimeHasBeenSet = true;
    }
    XmlNode finishedTimeNode = resultNode.FirstChild("FinishedTime");
    if (!finishedTimeNode.IsNull()) {
      m_finishedTime = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(finishedTimeNode.GetText()).c_str()).c_str(),
                                Aws::Utils::DateFormat::ISO_8601);
...
void ManagedActionHistoryItem::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_actionTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ActionType=" << StringUtils::URLEncode(ActionTypeMapper::GetNameForActionType(m_actionType)) << "&";
  }
  ...
  if (m_failureTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".FailureType=" << StringUtils::URLEncode(FailureTypeMapper::GetNameForFailureType(m_failureType)) << "&";
  }

  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(ActionHistoryStatusMapper::GetNameForActionHistoryStatus(m_status)) << "&";
  }
  ...
  if (m_executedTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ExecutedTime=" << StringUtils::URLEncode(m_executedTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_finishedTimeHasBeenSet) {
    oStream << location << index << locationValue
            << ".FinishedTime=" << StringUtils::URLEncode(m_finishedTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
}
