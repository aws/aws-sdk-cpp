...
DescribeEnvironmentManagedActionHistoryResult& DescribeEnvironmentManagedActionHistoryResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!managedActionHistoryItemsNode.IsNull()) {
      ...
      m_managedActionHistoryItemsHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticBeanstalk::Model::DescribeEnvironmentManagedActionHistoryResult",
