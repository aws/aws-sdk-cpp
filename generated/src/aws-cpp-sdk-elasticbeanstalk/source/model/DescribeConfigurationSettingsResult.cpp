...
DescribeConfigurationSettingsResult& DescribeConfigurationSettingsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticBeanstalk::Model::DescribeConfigurationSettingsResult",
