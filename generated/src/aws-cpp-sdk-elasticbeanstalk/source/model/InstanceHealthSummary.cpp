...
InstanceHealthSummary::InstanceHealthSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
InstanceHealthSummary& InstanceHealthSummary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!noDataNode.IsNull()) {
      m_noData =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(noDataNode.GetText()).c_str()).c_str());
      m_noDataHasBeenSet = true;
    }
    XmlNode unknownNode = resultNode.FirstChild("Unknown");
    if (!unknownNode.IsNull()) {
      m_unknown =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(unknownNode.GetText()).c_str()).c_str());
      m_unknownHasBeenSet = true;
    }
    XmlNode pendingNode = resultNode.FirstChild("Pending");
    if (!pendingNode.IsNull()) {
      m_pending =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(pendingNode.GetText()).c_str()).c_str());
    ...
    if (!warningNode.IsNull()) {
      m_warning =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(warningNode.GetText()).c_str()).c_str());
      m_warningHasBeenSet = true;
    }
    XmlNode degradedNode = resultNode.FirstChild("Degraded");
    if (!degradedNode.IsNull()) {
      m_degraded =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(degradedNode.GetText()).c_str()).c_str());
      m_degradedHasBeenSet = true;
    }
    XmlNode severeNode = resultNode.FirstChild("Severe");
    if (!severeNode.IsNull()) {
      m_severe =
          StringUtils::ConvertToInt32(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(severeNode.GetText()).c_str()).c_str());
