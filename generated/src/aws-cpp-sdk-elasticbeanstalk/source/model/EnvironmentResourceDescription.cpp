...
EnvironmentResourceDescription::EnvironmentResourceDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void EnvironmentResourceDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
