...
ConfigurationOptionSetting::ConfigurationOptionSetting(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ConfigurationOptionSetting::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
