...
ApplicationVersionDescription::ApplicationVersionDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
ApplicationVersionDescription& ApplicationVersionDescription::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = ApplicationVersionStatusMapper::GetApplicationVersionStatusForName(
...
void ApplicationVersionDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(ApplicationVersionStatusMapper::GetNameForApplicationVersionStatus(m_status)) << "&";
  }
}
