...
UpdateApplicationVersionResult::UpdateApplicationVersionResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
UpdateApplicationVersionResult& UpdateApplicationVersionResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticBeanstalk::Model::UpdateApplicationVersionResult",
