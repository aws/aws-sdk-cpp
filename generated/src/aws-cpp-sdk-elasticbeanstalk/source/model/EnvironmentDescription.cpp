...
EnvironmentDescription::EnvironmentDescription(const XmlNode& xmlNode) { *this = xmlNode; }
...
void EnvironmentDescription::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(EnvironmentStatusMapper::GetNameForEnvironmentStatus(m_status)) << "&";
  }
  ...
  if (m_healthHasBeenSet) {
    oStream << location << index << locationValue
            << ".Health=" << StringUtils::URLEncode(EnvironmentHealthMapper::GetNameForEnvironmentHealth(m_health)) << "&";
  }

  if (m_healthStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".HealthStatus=" << StringUtils::URLEncode(EnvironmentHealthStatusMapper::GetNameForEnvironmentHealthStatus(m_healthStatus))
            << "&";
  }
