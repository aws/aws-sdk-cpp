...
PlatformProgrammingLanguage::PlatformProgrammingLanguage(const XmlNode& xmlNode) { *this = xmlNode; }
...
void PlatformProgrammingLanguage::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
