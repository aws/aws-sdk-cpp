...
ApplyEnvironmentManagedActionResult& ApplyEnvironmentManagedActionResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElasticBeanstalk::Model::ApplyEnvironmentManagedActionResult",
