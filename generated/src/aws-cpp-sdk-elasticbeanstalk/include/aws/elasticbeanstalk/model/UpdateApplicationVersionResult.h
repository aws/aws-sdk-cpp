...
class UpdateApplicationVersionResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API UpdateApplicationVersionResult& operator=(
  ...
  template <typename ApplicationVersionT = ApplicationVersionDescription>
  UpdateApplicationVersionResult& WithApplicationVersion(ApplicationVersionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UpdateApplicationVersionResult& WithResponseMetadata(ResponseMetadataT&& value) {
