...
class ResourceQuotas {
 public:
  ...
  void SetApplicationQuota(ApplicationQuotaT&& value) {
    ...
    m_applicationQuota = std::forward<ApplicationQuotaT>(value);
  }
  template <typename ApplicationQuotaT = ResourceQuota>
  ResourceQuotas& WithApplicationQuota(ApplicationQuotaT&& value) {
    SetApplicationQuota(std::forward<ApplicationQuotaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationVersionQuota(ApplicationVersionQuotaT&& value) {
    ...
    m_applicationVersionQuota = std::forward<ApplicationVersionQuotaT>(value);
  }
  template <typename ApplicationVersionQuotaT = ResourceQuota>
  ResourceQuotas& WithApplicationVersionQuota(ApplicationVersionQuotaT&& value) {
    SetApplicationVersionQuota(std::forward<ApplicationVersionQuotaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnvironmentQuota(EnvironmentQuotaT&& value) {
    ...
    m_environmentQuota = std::forward<EnvironmentQuotaT>(value);
  }
  template <typename EnvironmentQuotaT = ResourceQuota>
  ResourceQuotas& WithEnvironmentQuota(EnvironmentQuotaT&& value) {
    SetEnvironmentQuota(std::forward<EnvironmentQuotaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfigurationTemplateQuota(ConfigurationTemplateQuotaT&& value) {
    ...
    m_configurationTemplateQuota = std::forward<ConfigurationTemplateQuotaT>(value);
  }
  template <typename ConfigurationTemplateQuotaT = ResourceQuota>
  ResourceQuotas& WithConfigurationTemplateQuota(ConfigurationTemplateQuotaT&& value) {
    SetConfigurationTemplateQuota(std::forward<ConfigurationTemplateQuotaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomPlatformQuota(CustomPlatformQuotaT&& value) {
    ...
    m_customPlatformQuota = std::forward<CustomPlatformQuotaT>(value);
  }
  template <typename CustomPlatformQuotaT = ResourceQuota>
  ResourceQuotas& WithCustomPlatformQuota(CustomPlatformQuotaT&& value) {
    SetCustomPlatformQuota(std::forward<CustomPlatformQuotaT>(value));
    return *this;
  }
  ///@}
 private:
