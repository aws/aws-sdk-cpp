...
class ManagedAction {
 public:
  ...
  inline ManagedAction& WithActionType(ActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  inline ManagedAction& WithStatus(ActionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetWindowStartTime(WindowStartTimeT&& value) {
    ...
    m_windowStartTime = std::forward<WindowStartTimeT>(value);
  }
  template <typename WindowStartTimeT = Aws::Utils::DateTime>
  ManagedAction& WithWindowStartTime(WindowStartTimeT&& value) {
    SetWindowStartTime(std::forward<WindowStartTimeT>(value));
    return *this;
  }
  ///@}
 private:
