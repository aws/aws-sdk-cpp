...
class CreateConfigurationTemplateResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API CreateConfigurationTemplateResult& operator=(
  ...
  inline void SetDeploymentStatus(ConfigurationDeploymentStatus value) {
    m_deploymentStatusHasBeenSet = true;
    m_deploymentStatus = value;
  }
  inline CreateConfigurationTemplateResult& WithDeploymentStatus(ConfigurationDeploymentStatus value) {
