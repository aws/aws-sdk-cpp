...
class DescribeEnvironmentHealthRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename EnvironmentNameT = Aws::String>
  DescribeEnvironmentHealthRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DescribeEnvironmentHealthRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename AttributeNamesT = Aws::Vector<EnvironmentHealthAttribute>>
  DescribeEnvironmentHealthRequest& WithAttributeNames(AttributeNamesT&& value) {
    SetAttributeNames(std::forward<AttributeNamesT>(value));
    return *this;
  }
  inline DescribeEnvironmentHealthRequest& AddAttributeNames(EnvironmentHealthAttribute value) {
    m_attributeNamesHasBeenSet = true;
