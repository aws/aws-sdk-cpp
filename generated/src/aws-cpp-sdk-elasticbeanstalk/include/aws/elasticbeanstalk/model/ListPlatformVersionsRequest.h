...
class ListPlatformVersionsRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename FiltersT = Aws::Vector<PlatformFilter>>
  ListPlatformVersionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = PlatformFilter>
  ListPlatformVersionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListPlatformVersionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlatformVersionsRequest& WithNextToken(NextTokenT&& value) {
