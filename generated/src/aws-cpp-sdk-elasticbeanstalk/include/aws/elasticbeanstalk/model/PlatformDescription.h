...
class PlatformDescription {
 public:
  ...
  void SetPlatformOwner(PlatformOwnerT&& value) {
    ...
    m_platformOwner = std::forward<PlatformOwnerT>(value);
  }
  template <typename PlatformOwnerT = Aws::String>
  PlatformDescription& WithPlatformOwner(PlatformOwnerT&& value) {
    SetPlatformOwner(std::forward<PlatformOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPlatformStatus(PlatformStatus value) {
    m_platformStatusHasBeenSet = true;
    m_platformStatus = value;
  }
  inline PlatformDescription& WithPlatformStatus(PlatformStatus value) {
  ...
  void SetDateUpdated(DateUpdatedT&& value) {
    ...
    m_dateUpdated = std::forward<DateUpdatedT>(value);
  }
  template <typename DateUpdatedT = Aws::Utils::DateTime>
  PlatformDescription& WithDateUpdated(DateUpdatedT&& value) {
    SetDateUpdated(std::forward<DateUpdatedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformCategory(PlatformCategoryT&& value) {
    ...
    m_platformCategory = std::forward<PlatformCategoryT>(value);
  }
  template <typename PlatformCategoryT = Aws::String>
  PlatformDescription& WithPlatformCategory(PlatformCategoryT&& value) {
    SetPlatformCategory(std::forward<PlatformCategoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaintainer(MaintainerT&& value) {
    m_maintainerHasBeenSet = true;
    m_maintainer = std::forward<MaintainerT>(value);
  }
  template <typename MaintainerT = Aws::String>
  PlatformDescription& WithMaintainer(MaintainerT&& value) {
    SetMaintainer(std::forward<MaintainerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProgrammingLanguages(ProgrammingLanguagesT&& value) {
    ...
    m_programmingLanguages = std::forward<ProgrammingLanguagesT>(value);
  }
  template <typename ProgrammingLanguagesT = Aws::Vector<PlatformProgrammingLanguage>>
  PlatformDescription& WithProgrammingLanguages(ProgrammingLanguagesT&& value) {
    SetProgrammingLanguages(std::forward<ProgrammingLanguagesT>(value));
    return *this;
  }
  ...
  PlatformDescription& AddProgrammingLanguages(ProgrammingLanguagesT&& value) {
    m_programmingLanguagesHasBeenSet = true;
    m_programmingLanguages.emplace_back(std::forward<ProgrammingLanguagesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomAmiList(CustomAmiListT&& value) {
    m_customAmiListHasBeenSet = true;
    m_customAmiList = std::forward<CustomAmiListT>(value);
  }
  template <typename CustomAmiListT = Aws::Vector<CustomAmi>>
  PlatformDescription& WithCustomAmiList(CustomAmiListT&& value) {
    SetCustomAmiList(std::forward<CustomAmiListT>(value));
    return *this;
  }
  template <typename CustomAmiListT = CustomAmi>
  PlatformDescription& AddCustomAmiList(CustomAmiListT&& value) {
    m_customAmiListHasBeenSet = true;
    m_customAmiList.emplace_back(std::forward<CustomAmiListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedTierList(SupportedTierListT&& value) {
    ...
    m_supportedTierList = std::forward<SupportedTierListT>(value);
  }
  template <typename SupportedTierListT = Aws::Vector<Aws::String>>
  PlatformDescription& WithSupportedTierList(SupportedTierListT&& value) {
    SetSupportedTierList(std::forward<SupportedTierListT>(value));
    return *this;
  }
  template <typename SupportedTierListT = Aws::String>
  PlatformDescription& AddSupportedTierList(SupportedTierListT&& value) {
    m_supportedTierListHasBeenSet = true;
    m_supportedTierList.emplace_back(std::forward<SupportedTierListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedAddonList(SupportedAddonListT&& value) {
    ...
    m_supportedAddonList = std::forward<SupportedAddonListT>(value);
  }
  template <typename SupportedAddonListT = Aws::Vector<Aws::String>>
  PlatformDescription& WithSupportedAddonList(SupportedAddonListT&& value) {
    SetSupportedAddonList(std::forward<SupportedAddonListT>(value));
    return *this;
  }
  template <typename SupportedAddonListT = Aws::String>
  PlatformDescription& AddSupportedAddonList(SupportedAddonListT&& value) {
    m_supportedAddonListHasBeenSet = true;
    m_supportedAddonList.emplace_back(std::forward<SupportedAddonListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformLifecycleState(PlatformLifecycleStateT&& value) {
    ...
    m_platformLifecycleState = std::forward<PlatformLifecycleStateT>(value);
  }
  template <typename PlatformLifecycleStateT = Aws::String>
  PlatformDescription& WithPlatformLifecycleState(PlatformLifecycleStateT&& value) {
    SetPlatformLifecycleState(std::forward<PlatformLifecycleStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformBranchName(PlatformBranchNameT&& value) {
    ...
    m_platformBranchName = std::forward<PlatformBranchNameT>(value);
  }
  template <typename PlatformBranchNameT = Aws::String>
  PlatformDescription& WithPlatformBranchName(PlatformBranchNameT&& value) {
    SetPlatformBranchName(std::forward<PlatformBranchNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformBranchLifecycleState(PlatformBranchLifecycleStateT&& value) {
    ...
    m_platformBranchLifecycleState = std::forward<PlatformBranchLifecycleStateT>(value);
  }
  template <typename PlatformBranchLifecycleStateT = Aws::String>
  PlatformDescription& WithPlatformBranchLifecycleState(PlatformBranchLifecycleStateT&& value) {
    SetPlatformBranchLifecycleState(std::forward<PlatformBranchLifecycleStateT>(value));
    return *this;
  }
  ///@}
 private:
