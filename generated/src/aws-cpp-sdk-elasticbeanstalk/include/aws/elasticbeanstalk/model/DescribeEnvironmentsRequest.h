...
class DescribeEnvironmentsRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  inline void SetIncludeDeleted(bool value) {
    m_includeDeletedHasBeenSet = true;
    m_includeDeleted = value;
  }
  inline DescribeEnvironmentsRequest& WithIncludeDeleted(bool value) {
  ...
  void SetIncludedDeletedBackTo(IncludedDeletedBackToT&& value) {
    m_includedDeletedBackToHasBeenSet = true;
    m_includedDeletedBackTo = std::forward<IncludedDeletedBackToT>(value);
  }
  template <typename IncludedDeletedBackToT = Aws::Utils::DateTime>
  DescribeEnvironmentsRequest& WithIncludedDeletedBackTo(IncludedDeletedBackToT&& value) {
    SetIncludedDeletedBackTo(std::forward<IncludedDeletedBackToT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeEnvironmentsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
