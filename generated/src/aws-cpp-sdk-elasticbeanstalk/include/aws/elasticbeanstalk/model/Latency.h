...
class Latency {
 public:
  ...
  inline void SetP999(double value) {
    m_p999HasBeenSet = true;
    m_p999 = value;
  }
  inline Latency& WithP999(double value) {
    SetP999(value);
    return *this;
  }
  ///@}
  ...
  inline void SetP99(double value) {
    m_p99HasBeenSet = true;
    m_p99 = value;
  }
  inline Latency& WithP99(double value) {
    SetP99(value);
    return *this;
  }
  ///@}
  ...
  inline Latency& WithP95(double value) {
    SetP95(value);
    return *this;
  }
  ///@}
  ...
  inline Latency& WithP90(double value) {
    SetP90(value);
    return *this;
  }
  ///@}
  ...
  inline void SetP85(double value) {
    m_p85HasBeenSet = true;
    m_p85 = value;
  }
  inline Latency& WithP85(double value) {
    SetP85(value);
    return *this;
  }
  ///@}
  ...
  inline Latency& WithP75(double value) {
    SetP75(value);
    return *this;
  }
  ///@}
  ...
  inline Latency& WithP50(double value) {
    SetP50(value);
    return *this;
  }
  ///@}
  ...
  inline void SetP10(double value) {
    m_p10HasBeenSet = true;
    m_p10 = value;
  }
  inline Latency& WithP10(double value) {
    SetP10(value);
    return *this;
  }
  ///@}
