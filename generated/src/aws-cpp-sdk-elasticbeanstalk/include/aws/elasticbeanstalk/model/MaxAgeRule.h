...
class MaxAgeRule {
 public:
  ...
  inline MaxAgeRule& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAgeInDays(int value) {
    m_maxAgeInDaysHasBeenSet = true;
    m_maxAgeInDays = value;
  }
  inline MaxAgeRule& WithMaxAgeInDays(int value) {
    SetMaxAgeInDays(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteSourceFromS3(bool value) {
    m_deleteSourceFromS3HasBeenSet = true;
    m_deleteSourceFromS3 = value;
  }
  inline MaxAgeRule& WithDeleteSourceFromS3(bool value) {
    SetDeleteSourceFromS3(value);
    return *this;
  }
  ///@}
 private:
