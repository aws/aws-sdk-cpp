...
class DescribeEnvironmentManagedActionsRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename EnvironmentNameT = Aws::String>
  DescribeEnvironmentManagedActionsRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  DescribeEnvironmentManagedActionsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline DescribeEnvironmentManagedActionsRequest& WithStatus(ActionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
