...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    PlatformFramework& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    PlatformFramework& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
