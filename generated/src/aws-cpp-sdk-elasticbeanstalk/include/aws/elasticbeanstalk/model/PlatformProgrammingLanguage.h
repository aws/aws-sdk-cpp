...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    PlatformProgrammingLanguage& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    PlatformProgrammingLanguage& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
