...
class ApplicationVersionLifecycleConfig {
 public:
  ...
  void SetMaxCountRule(MaxCountRuleT&& value) {
    ...
    m_maxCountRule = std::forward<MaxCountRuleT>(value);
  }
  template <typename MaxCountRuleT = MaxCountRule>
  ApplicationVersionLifecycleConfig& WithMaxCountRule(MaxCountRuleT&& value) {
    SetMaxCountRule(std::forward<MaxCountRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxAgeRule(MaxAgeRuleT&& value) {
    ...
    m_maxAgeRule = std::forward<MaxAgeRuleT>(value);
  }
  template <typename MaxAgeRuleT = MaxAgeRule>
  ApplicationVersionLifecycleConfig& WithMaxAgeRule(MaxAgeRuleT&& value) {
    SetMaxAgeRule(std::forward<MaxAgeRuleT>(value));
    return *this;
  }
  ///@}
 private:
