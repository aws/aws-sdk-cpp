...
class DescribeEnvironmentManagedActionHistoryRequest : public ElasticBeanstalkRequest {
 public:
  AWS_ELASTICBEANSTALK_API DescribeEnvironmentManagedActionHistoryRequest() = default;
 ...
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  DescribeEnvironmentManagedActionHistoryRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  DescribeEnvironmentManagedActionHistoryRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEnvironmentManagedActionHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeEnvironmentManagedActionHistoryRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
