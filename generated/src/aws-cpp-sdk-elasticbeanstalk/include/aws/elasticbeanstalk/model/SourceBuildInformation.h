...
class SourceBuildInformation {
 public:
  ...
  inline SourceBuildInformation& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSourceRepository(SourceRepository value) {
    m_sourceRepositoryHasBeenSet = true;
    m_sourceRepository = value;
  }
  inline SourceBuildInformation& WithSourceRepository(SourceRepository value) {
