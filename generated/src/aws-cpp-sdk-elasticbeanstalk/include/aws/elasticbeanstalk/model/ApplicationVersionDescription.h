...
class ApplicationVersionDescription {
 public:
  ...
  void SetApplicationVersionArn(ApplicationVersionArnT&& value) {
    ...
    m_applicationVersionArn = std::forward<ApplicationVersionArnT>(value);
  }
  template <typename ApplicationVersionArnT = Aws::String>
  ApplicationVersionDescription& WithApplicationVersionArn(ApplicationVersionArnT&& value) {
    SetApplicationVersionArn(std::forward<ApplicationVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceBuildInformation(SourceBuildInformationT&& value) {
    ...
    m_sourceBuildInformation = std::forward<SourceBuildInformationT>(value);
  }
  template <typename SourceBuildInformationT = SourceBuildInformation>
  ApplicationVersionDescription& WithSourceBuildInformation(SourceBuildInformationT&& value) {
    SetSourceBuildInformation(std::forward<SourceBuildInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceBundle(SourceBundleT&& value) {
    ...
    m_sourceBundle = std::forward<SourceBundleT>(value);
  }
  template <typename SourceBundleT = S3Location>
  ...
  inline void SetStatus(ApplicationVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ApplicationVersionDescription& WithStatus(ApplicationVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
