...
class EnvironmentInfoDescription {
 public:
  ...
  inline EnvironmentInfoDescription& WithInfoType(EnvironmentInfoType value) {
    SetInfoType(value);
    return *this;
  }
  ///@}
  ...
  void SetSampleTimestamp(SampleTimestampT&& value) {
    ...
    m_sampleTimestamp = std::forward<SampleTimestampT>(value);
  }
  template <typename SampleTimestampT = Aws::Utils::DateTime>
  EnvironmentInfoDescription& WithSampleTimestamp(SampleTimestampT&& value) {
    SetSampleTimestamp(std::forward<SampleTimestampT>(value));
    return *this;
  }
  ///@}
