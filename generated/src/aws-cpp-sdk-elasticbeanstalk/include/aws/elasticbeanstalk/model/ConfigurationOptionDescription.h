...
class ConfigurationOptionDescription {
 public:
  ...
  void SetChangeSeverity(ChangeSeverityT&& value) {
    ...
    m_changeSeverity = std::forward<ChangeSeverityT>(value);
  }
  template <typename ChangeSeverityT = Aws::String>
  ConfigurationOptionDescription& WithChangeSeverity(ChangeSeverityT&& value) {
    SetChangeSeverity(std::forward<ChangeSeverityT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUserDefined(bool value) {
    m_userDefinedHasBeenSet = true;
    m_userDefined = value;
  }
  inline ConfigurationOptionDescription& WithUserDefined(bool value) {
    SetUserDefined(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValueType(ConfigurationOptionValueType value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = value;
  }
  inline ConfigurationOptionDescription& WithValueType(ConfigurationOptionValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
  ...
  inline ConfigurationOptionDescription& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline ConfigurationOptionDescription& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline ConfigurationOptionDescription& WithMaxLength(int value) {
    SetMaxLength(value);
    return *this;
  }
  ///@}
