...
class DeleteConfigurationTemplateRequest : public ElasticBeanstalkRequest {
 public:
  AWS_ELASTICBEANSTALK_API DeleteConfigurationTemplateRequest() = default;
 ...
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DeleteConfigurationTemplateRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  DeleteConfigurationTemplateRequest& WithTemplateName(TemplateNameT&& value) {
