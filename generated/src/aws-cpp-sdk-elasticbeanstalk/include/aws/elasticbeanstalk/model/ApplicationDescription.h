...
class ApplicationDescription {
 public:
  ...
  void SetConfigurationTemplates(ConfigurationTemplatesT&& value) {
    ...
    m_configurationTemplates = std::forward<ConfigurationTemplatesT>(value);
  }
  template <typename ConfigurationTemplatesT = Aws::Vector<Aws::String>>
  ApplicationDescription& WithConfigurationTemplates(ConfigurationTemplatesT&& value) {
    SetConfigurationTemplates(std::forward<ConfigurationTemplatesT>(value));
    return *this;
  }
  ...
  ApplicationDescription& AddConfigurationTemplates(ConfigurationTemplatesT&& value) {
    m_configurationTemplatesHasBeenSet = true;
    m_configurationTemplates.emplace_back(std::forward<ConfigurationTemplatesT>(value));
    return *this;
  }
  ///@}
