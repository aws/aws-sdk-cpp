...
class ListPlatformBranchesResult {
 public:
  ...
  void SetPlatformBranchSummaryList(PlatformBranchSummaryListT&& value) {
    m_platformBranchSummaryListHasBeenSet = true;
    m_platformBranchSummaryList = std::forward<PlatformBranchSummaryListT>(value);
  }
  template <typename PlatformBranchSummaryListT = Aws::Vector<PlatformBranchSummary>>
  ListPlatformBranchesResult& WithPlatformBranchSummaryList(PlatformBranchSummaryListT&& value) {
    SetPlatformBranchSummaryList(std::forward<PlatformBranchSummaryListT>(value));
    return *this;
  }
  template <typename PlatformBranchSummaryListT = PlatformBranchSummary>
  ListPlatformBranchesResult& AddPlatformBranchSummaryList(PlatformBranchSummaryListT&& value) {
    m_platformBranchSummaryListHasBeenSet = true;
    m_platformBranchSummaryList.emplace_back(std::forward<PlatformBranchSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlatformBranchesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPlatformBranchesResult& WithResponseMetadata(ResponseMetadataT&& value) {
