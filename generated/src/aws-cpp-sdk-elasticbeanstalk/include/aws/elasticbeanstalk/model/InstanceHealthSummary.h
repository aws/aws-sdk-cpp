...
class InstanceHealthSummary {
 public:
  ...
  inline void SetNoData(int value) {
    m_noDataHasBeenSet = true;
    m_noData = value;
  }
  inline InstanceHealthSummary& WithNoData(int value) {
    SetNoData(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceHealthSummary& WithUnknown(int value) {
    SetUnknown(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceHealthSummary& WithPending(int value) {
    SetPending(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceHealthSummary& WithOk(int value) {
    SetOk(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInfo(int value) {
    m_infoHasBeenSet = true;
    m_info = value;
  }
  inline InstanceHealthSummary& WithInfo(int value) {
    SetInfo(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWarning(int value) {
    m_warningHasBeenSet = true;
    m_warning = value;
  }
  inline InstanceHealthSummary& WithWarning(int value) {
    SetWarning(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDegraded(int value) {
    m_degradedHasBeenSet = true;
    m_degraded = value;
  }
  inline InstanceHealthSummary& WithDegraded(int value) {
    SetDegraded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSevere(int value) {
    m_severeHasBeenSet = true;
    m_severe = value;
  }
  inline InstanceHealthSummary& WithSevere(int value) {
    SetSevere(value);
    return *this;
  }
  ///@}
