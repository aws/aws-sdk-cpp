...
class Deployment {
 public:
  ...
  inline void SetDeploymentId(long long value) {
    m_deploymentIdHasBeenSet = true;
    m_deploymentId = value;
  }
  inline Deployment& WithDeploymentId(long long value) {
  ...
  void SetDeploymentTime(DeploymentTimeT&& value) {
    ...
    m_deploymentTime = std::forward<DeploymentTimeT>(value);
  }
  template <typename DeploymentTimeT = Aws::Utils::DateTime>
  Deployment& WithDeploymentTime(DeploymentTimeT&& value) {
    SetDeploymentTime(std::forward<DeploymentTimeT>(value));
    return *this;
  }
  ///@}
 private:
