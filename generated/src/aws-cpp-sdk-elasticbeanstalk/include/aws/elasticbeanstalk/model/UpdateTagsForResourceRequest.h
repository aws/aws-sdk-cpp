...
class UpdateTagsForResourceRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateTagsForResourceRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename TagsToAddT = Aws::Vector<Tag>>
  UpdateTagsForResourceRequest& WithTagsToAdd(TagsToAddT&& value) {
    SetTagsToAdd(std::forward<TagsToAddT>(value));
    return *this;
  }
  template <typename TagsToAddT = Tag>
  UpdateTagsForResourceRequest& AddTagsToAdd(TagsToAddT&& value) {
    m_tagsToAddHasBeenSet = true;
  ...
  void SetTagsToRemove(TagsToRemoveT&& value) {
    m_tagsToRemoveHasBeenSet = true;
    m_tagsToRemove = std::forward<TagsToRemoveT>(value);
  }
  template <typename TagsToRemoveT = Aws::Vector<Aws::String>>
  UpdateTagsForResourceRequest& WithTagsToRemove(TagsToRemoveT&& value) {
    SetTagsToRemove(std::forward<TagsToRemoveT>(value));
    return *this;
  }
  template <typename TagsToRemoveT = Aws::String>
  UpdateTagsForResourceRequest& AddTagsToRemove(TagsToRemoveT&& value) {
    m_tagsToRemoveHasBeenSet = true;
    m_tagsToRemove.emplace_back(std::forward<TagsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
