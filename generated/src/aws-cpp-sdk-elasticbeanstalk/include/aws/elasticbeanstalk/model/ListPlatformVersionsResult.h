...
class ListPlatformVersionsResult {
 public:
  ...
  void SetPlatformSummaryList(PlatformSummaryListT&& value) {
    m_platformSummaryListHasBeenSet = true;
    m_platformSummaryList = std::forward<PlatformSummaryListT>(value);
  }
  template <typename PlatformSummaryListT = Aws::Vector<PlatformSummary>>
  ListPlatformVersionsResult& WithPlatformSummaryList(PlatformSummaryListT&& value) {
    SetPlatformSummaryList(std::forward<PlatformSummaryListT>(value));
    return *this;
  }
  template <typename PlatformSummaryListT = PlatformSummary>
  ListPlatformVersionsResult& AddPlatformSummaryList(PlatformSummaryListT&& value) {
    m_platformSummaryListHasBeenSet = true;
    m_platformSummaryList.emplace_back(std::forward<PlatformSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlatformVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPlatformVersionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
