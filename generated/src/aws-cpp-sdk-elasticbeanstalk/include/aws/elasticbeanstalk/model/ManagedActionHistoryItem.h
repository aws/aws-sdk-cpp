...
class ManagedActionHistoryItem {
 public:
  ...
  inline ManagedActionHistoryItem& WithActionType(ActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureType(FailureType value) {
    m_failureTypeHasBeenSet = true;
    m_failureType = value;
  }
  inline ManagedActionHistoryItem& WithFailureType(FailureType value) {
  ...
  inline void SetStatus(ActionHistoryStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ManagedActionHistoryItem& WithStatus(ActionHistoryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExecutedTime(ExecutedTimeT&& value) {
    ...
    m_executedTime = std::forward<ExecutedTimeT>(value);
  }
  template <typename ExecutedTimeT = Aws::Utils::DateTime>
  ManagedActionHistoryItem& WithExecutedTime(ExecutedTimeT&& value) {
    SetExecutedTime(std::forward<ExecutedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFinishedTime(FinishedTimeT&& value) {
    ...
    m_finishedTime = std::forward<FinishedTimeT>(value);
  }
  template <typename FinishedTimeT = Aws::Utils::DateTime>
  ManagedActionHistoryItem& WithFinishedTime(FinishedTimeT&& value) {
    SetFinishedTime(std::forward<FinishedTimeT>(value));
    return *this;
  }
  ///@}
 private:
