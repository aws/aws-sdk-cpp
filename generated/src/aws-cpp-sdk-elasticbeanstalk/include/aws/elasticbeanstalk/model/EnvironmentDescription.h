...
class EnvironmentDescription {
 public:
  ...
  inline EnvironmentDescription& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline EnvironmentDescription& WithAbortableOperationInProgress(bool value) {
  ...
  inline EnvironmentDescription& WithHealth(EnvironmentHealth value) {
    SetHealth(value);
    return *this;
  }
  ///@}
  ...
  inline EnvironmentDescription& WithHealthStatus(EnvironmentHealthStatus value) {
