...
class UpdateEnvironmentResult {
 public:
  ...
  inline UpdateEnvironmentResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentResult& WithAbortableOperationInProgress(bool value) {
  ...
  inline UpdateEnvironmentResult& WithHealth(EnvironmentHealth value) {
    SetHealth(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateEnvironmentResult& WithHealthStatus(EnvironmentHealthStatus value) {
