...
class DescribeConfigurationSettingsRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DescribeConfigurationSettingsRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  DescribeConfigurationSettingsRequest& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  DescribeConfigurationSettingsRequest& WithEnvironmentName(EnvironmentNameT&& value) {
