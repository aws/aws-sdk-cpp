...
class ListPlatformBranchesRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename FiltersT = Aws::Vector<SearchFilter>>
  ListPlatformBranchesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = SearchFilter>
  ListPlatformBranchesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListPlatformBranchesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlatformBranchesRequest& WithNextToken(NextTokenT&& value) {
