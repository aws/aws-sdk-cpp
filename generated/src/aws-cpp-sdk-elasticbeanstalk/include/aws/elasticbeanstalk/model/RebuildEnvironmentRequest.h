...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICBEANSTALK_API RebuildEnvironmentRequest() = default;
  ...
  public:
    ...
    template<typename EnvironmentIdT = Aws::String>
    RebuildEnvironmentRequest& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentNameT = Aws::String>
    RebuildEnvironmentRequest& WithEnvironmentName(EnvironmentNameT&& value) { SetEnvironmentName(std::forward<EnvironmentNameT>(value)); return *this;}
    ///@}
  private:
