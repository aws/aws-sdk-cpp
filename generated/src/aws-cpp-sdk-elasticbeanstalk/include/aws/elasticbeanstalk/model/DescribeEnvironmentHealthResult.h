...
class DescribeEnvironmentHealthResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API DescribeEnvironmentHealthResult& operator=(
  ...
  inline void SetStatus(EnvironmentHealth value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeEnvironmentHealthResult& WithStatus(EnvironmentHealth value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetApplicationMetrics(ApplicationMetricsT&& value) {
    ...
    m_applicationMetrics = std::forward<ApplicationMetricsT>(value);
  }
  template <typename ApplicationMetricsT = ApplicationMetrics>
  DescribeEnvironmentHealthResult& WithApplicationMetrics(ApplicationMetricsT&& value) {
    SetApplicationMetrics(std::forward<ApplicationMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstancesHealth(InstancesHealthT&& value) {
    ...
    m_instancesHealth = std::forward<InstancesHealthT>(value);
  }
  template <typename InstancesHealthT = InstanceHealthSummary>
  DescribeEnvironmentHealthResult& WithInstancesHealth(InstancesHealthT&& value) {
    SetInstancesHealth(std::forward<InstancesHealthT>(value));
    return *this;
  }
  ///@}
