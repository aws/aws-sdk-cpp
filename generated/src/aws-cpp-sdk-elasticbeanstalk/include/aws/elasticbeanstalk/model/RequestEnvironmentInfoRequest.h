...
class RequestEnvironmentInfoRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  RequestEnvironmentInfoRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  RequestEnvironmentInfoRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  inline void SetInfoType(EnvironmentInfoType value) {
    m_infoTypeHasBeenSet = true;
    m_infoType = value;
  }
  inline RequestEnvironmentInfoRequest& WithInfoType(EnvironmentInfoType value) {
    SetInfoType(value);
    return *this;
  }
  ///@}
