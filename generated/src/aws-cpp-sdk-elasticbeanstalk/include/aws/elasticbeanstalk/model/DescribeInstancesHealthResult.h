...
class DescribeInstancesHealthResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API DescribeInstancesHealthResult& operator=(
  ...
  void SetInstanceHealthList(InstanceHealthListT&& value) {
    m_instanceHealthListHasBeenSet = true;
    m_instanceHealthList = std::forward<InstanceHealthListT>(value);
  }
  template <typename InstanceHealthListT = Aws::Vector<SingleInstanceHealth>>
  DescribeInstancesHealthResult& WithInstanceHealthList(InstanceHealthListT&& value) {
    SetInstanceHealthList(std::forward<InstanceHealthListT>(value));
    return *this;
  }
  template <typename InstanceHealthListT = SingleInstanceHealth>
  DescribeInstancesHealthResult& AddInstanceHealthList(InstanceHealthListT&& value) {
    m_instanceHealthListHasBeenSet = true;
    m_instanceHealthList.emplace_back(std::forward<InstanceHealthListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRefreshedAt(RefreshedAtT&& value) {
    ...
    m_refreshedAt = std::forward<RefreshedAtT>(value);
  }
  template <typename RefreshedAtT = Aws::Utils::DateTime>
  DescribeInstancesHealthResult& WithRefreshedAt(RefreshedAtT&& value) {
    SetRefreshedAt(std::forward<RefreshedAtT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstancesHealthResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeInstancesHealthResult& WithResponseMetadata(ResponseMetadataT&& value) {
