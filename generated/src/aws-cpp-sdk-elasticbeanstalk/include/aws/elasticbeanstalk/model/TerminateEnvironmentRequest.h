...
class TerminateEnvironmentRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  TerminateEnvironmentRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  TerminateEnvironmentRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  inline void SetTerminateResources(bool value) {
    m_terminateResourcesHasBeenSet = true;
    m_terminateResources = value;
  }
  inline TerminateEnvironmentRequest& WithTerminateResources(bool value) {
    SetTerminateResources(value);
    return *this;
  }
  ///@}
  ...
  inline void SetForceTerminate(bool value) {
    m_forceTerminateHasBeenSet = true;
    m_forceTerminate = value;
  }
  inline TerminateEnvironmentRequest& WithForceTerminate(bool value) {
    SetForceTerminate(value);
    return *this;
  }
  ///@}
 private:
