...
class CreateEnvironmentResult {
 public:
  ...
  inline CreateEnvironmentResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentResult& WithAbortableOperationInProgress(bool value) {
  ...
  inline CreateEnvironmentResult& WithHealth(EnvironmentHealth value) {
    SetHealth(value);
    return *this;
  }
  ///@}
  ...
  inline CreateEnvironmentResult& WithHealthStatus(EnvironmentHealthStatus value) {
