...
class AbortEnvironmentUpdateRequest : public ElasticBeanstalkRequest {
 public:
  AWS_ELASTICBEANSTALK_API AbortEnvironmentUpdateRequest() = default;
 ...
 public:
  ...
  template <typename EnvironmentIdT = Aws::String>
  AbortEnvironmentUpdateRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  AbortEnvironmentUpdateRequest& WithEnvironmentName(EnvironmentNameT&& value) {
