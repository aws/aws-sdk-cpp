...
class StatusCodes {
 public:
  ...
  inline void SetStatus2xx(int value) {
    m_status2xxHasBeenSet = true;
    m_status2xx = value;
  }
  inline StatusCodes& WithStatus2xx(int value) {
    SetStatus2xx(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus3xx(int value) {
    m_status3xxHasBeenSet = true;
    m_status3xx = value;
  }
  inline StatusCodes& WithStatus3xx(int value) {
    SetStatus3xx(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus4xx(int value) {
    m_status4xxHasBeenSet = true;
    m_status4xx = value;
  }
  inline StatusCodes& WithStatus4xx(int value) {
    SetStatus4xx(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus5xx(int value) {
    m_status5xxHasBeenSet = true;
    m_status5xx = value;
  }
  inline StatusCodes& WithStatus5xx(int value) {
    SetStatus5xx(value);
    return *this;
  }
  ///@}
