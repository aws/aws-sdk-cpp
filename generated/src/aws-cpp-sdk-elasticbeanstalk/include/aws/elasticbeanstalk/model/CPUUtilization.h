...
class CPUUtilization {
 public:
  ...
  inline void SetUser(double value) {
    m_userHasBeenSet = true;
    m_user = value;
  }
  inline CPUUtilization& WithUser(double value) {
    SetUser(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNice(double value) {
    m_niceHasBeenSet = true;
    m_nice = value;
  }
  inline CPUUtilization& WithNice(double value) {
    SetNice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSystem(double value) {
    m_systemHasBeenSet = true;
    m_system = value;
  }
  inline CPUUtilization& WithSystem(double value) {
    SetSystem(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIdle(double value) {
    m_idleHasBeenSet = true;
    m_idle = value;
  }
  inline CPUUtilization& WithIdle(double value) {
    SetIdle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIOWait(double value) {
    m_iOWaitHasBeenSet = true;
    m_iOWait = value;
  }
  inline CPUUtilization& WithIOWait(double value) {
    SetIOWait(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIRQ(double value) {
    m_iRQHasBeenSet = true;
    m_iRQ = value;
  }
  inline CPUUtilization& WithIRQ(double value) {
    SetIRQ(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSoftIRQ(double value) {
    m_softIRQHasBeenSet = true;
    m_softIRQ = value;
  }
  inline CPUUtilization& WithSoftIRQ(double value) {
    SetSoftIRQ(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrivileged(double value) {
    m_privilegedHasBeenSet = true;
    m_privileged = value;
  }
  inline CPUUtilization& WithPrivileged(double value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
