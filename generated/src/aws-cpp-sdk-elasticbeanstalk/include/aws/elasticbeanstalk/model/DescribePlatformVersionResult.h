...
class DescribePlatformVersionResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API DescribePlatformVersionResult& operator=(
  ...
  void SetPlatformDescription(PlatformDescriptionT&& value) {
    m_platformDescriptionHasBeenSet = true;
    m_platformDescription = std::forward<PlatformDescriptionT>(value);
  }
  template <typename PlatformDescriptionT = PlatformDescription>
  DescribePlatformVersionResult& WithPlatformDescription(PlatformDescriptionT&& value) {
    SetPlatformDescription(std::forward<PlatformDescriptionT>(value));
    return *this;
  }
  ///@}
