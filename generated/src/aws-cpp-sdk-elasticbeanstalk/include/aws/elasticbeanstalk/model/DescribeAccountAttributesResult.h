...
class DescribeAccountAttributesResult {
 public:
  ...
  AWS_ELASTICBEANSTALK_API DescribeAccountAttributesResult& operator=(
  ...
  void SetResourceQuotas(ResourceQuotasT&& value) {
    m_resourceQuotasHasBeenSet = true;
    m_resourceQuotas = std::forward<ResourceQuotasT>(value);
  }
  template <typename ResourceQuotasT = ResourceQuotas>
  DescribeAccountAttributesResult& WithResourceQuotas(ResourceQuotasT&& value) {
    SetResourceQuotas(std::forward<ResourceQuotasT>(value));
    return *this;
  }
  ///@}
