...
class DeleteEnvironmentConfigurationRequest : public ElasticBeanstalkRequest {
 ...
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DeleteEnvironmentConfigurationRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  DeleteEnvironmentConfigurationRequest& WithEnvironmentName(EnvironmentNameT&& value) {
