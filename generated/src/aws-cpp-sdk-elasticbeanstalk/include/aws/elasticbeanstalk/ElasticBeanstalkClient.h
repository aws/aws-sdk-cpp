...
class AWS_ELASTICBEANSTALK_API ElasticBeanstalkClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  ElasticBeanstalkClient(const Aws::ElasticBeanstalk::ElasticBeanstalkClientConfiguration& clientConfiguration =
                             Aws::ElasticBeanstalk::ElasticBeanstalkClientConfiguration(),
  ...
  ElasticBeanstalkClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<ElasticBeanstalkEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::ElasticBeanstalk::ElasticBeanstalkClientConfiguration& clientConfiguration =
                             Aws::ElasticBeanstalk::ElasticBeanstalkClientConfiguration());
  ...
  /**
   * A Callable wrapper for AbortEnvironmentUpdate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AbortEnvironmentUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AbortEnvironmentUpdateRequestT = Model::AbortEnvironmentUpdateRequest>
  void AbortEnvironmentUpdateAsync(const AbortEnvironmentUpdateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const AbortEnvironmentUpdateRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ApplyEnvironmentManagedActionOutcome ApplyEnvironmentManagedAction(
      const Model::ApplyEnvironmentManagedActionRequest& request) const;

  /**
   * A Callable wrapper for ApplyEnvironmentManagedAction that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ApplyEnvironmentManagedActionRequestT = Model::ApplyEnvironmentManagedActionRequest>
  Model::ApplyEnvironmentManagedActionOutcomeCallable ApplyEnvironmentManagedActionCallable(
      const ApplyEnvironmentManagedActionRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::ApplyEnvironmentManagedAction, request);
  }

  /**
   * An Async wrapper for ApplyEnvironmentManagedAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ApplyEnvironmentManagedActionRequestT = Model::ApplyEnvironmentManagedActionRequest>
  void ApplyEnvironmentManagedActionAsync(const ApplyEnvironmentManagedActionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateEnvironmentOperationsRoleOutcome AssociateEnvironmentOperationsRole(
      const Model::AssociateEnvironmentOperationsRoleRequest& request) const;

  /**
   * A Callable wrapper for AssociateEnvironmentOperationsRole that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateEnvironmentOperationsRoleRequestT = Model::AssociateEnvironmentOperationsRoleRequest>
  Model::AssociateEnvironmentOperationsRoleOutcomeCallable AssociateEnvironmentOperationsRoleCallable(
      const AssociateEnvironmentOperationsRoleRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::AssociateEnvironmentOperationsRole, request);
  }

  /**
   * An Async wrapper for AssociateEnvironmentOperationsRole that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateEnvironmentOperationsRoleRequestT = Model::AssociateEnvironmentOperationsRoleRequest>
  void AssociateEnvironmentOperationsRoleAsync(const AssociateEnvironmentOperationsRoleRequestT& request,
  ...
  /**
   * A Callable wrapper for CheckDNSAvailability that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckDNSAvailability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CheckDNSAvailabilityRequestT = Model::CheckDNSAvailabilityRequest>
  void CheckDNSAvailabilityAsync(const CheckDNSAvailabilityRequestT& request, const CheckDNSAvailabilityResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ComposeEnvironments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ComposeEnvironments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ComposeEnvironmentsRequestT = Model::ComposeEnvironmentsRequest>
  void ComposeEnvironmentsAsync(const ComposeEnvironmentsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ComposeEnvironmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfigurationTemplateOutcome CreateConfigurationTemplate(
      const Model::CreateConfigurationTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreateConfigurationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConfigurationTemplateRequestT = Model::CreateConfigurationTemplateRequest>
  Model::CreateConfigurationTemplateOutcomeCallable CreateConfigurationTemplateCallable(
      const CreateConfigurationTemplateRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::CreateConfigurationTemplate, request);
  }

  /**
   * An Async wrapper for CreateConfigurationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConfigurationTemplateRequestT = Model::CreateConfigurationTemplateRequest>
  void CreateConfigurationTemplateAsync(const CreateConfigurationTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for CreatePlatformVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePlatformVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePlatformVersionRequestT = Model::CreatePlatformVersionRequest>
  void CreatePlatformVersionAsync(const CreatePlatformVersionRequestT& request, const CreatePlatformVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStorageLocation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStorageLocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStorageLocationRequestT = Model::CreateStorageLocationRequest>
  void CreateStorageLocationAsync(const CreateStorageLocationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const CreateStorageLocationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteApplicationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteApplicationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteApplicationVersionRequestT = Model::DeleteApplicationVersionRequest>
  void DeleteApplicationVersionAsync(const DeleteApplicationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfigurationTemplateOutcome DeleteConfigurationTemplate(
      const Model::DeleteConfigurationTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfigurationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfigurationTemplateRequestT = Model::DeleteConfigurationTemplateRequest>
  Model::DeleteConfigurationTemplateOutcomeCallable DeleteConfigurationTemplateCallable(
      const DeleteConfigurationTemplateRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::DeleteConfigurationTemplate, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfigurationTemplateRequestT = Model::DeleteConfigurationTemplateRequest>
  void DeleteConfigurationTemplateAsync(const DeleteConfigurationTemplateRequestT& request,
  ...
  virtual Model::DeleteEnvironmentConfigurationOutcome DeleteEnvironmentConfiguration(
      const Model::DeleteEnvironmentConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteEnvironmentConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEnvironmentConfigurationRequestT = Model::DeleteEnvironmentConfigurationRequest>
  Model::DeleteEnvironmentConfigurationOutcomeCallable DeleteEnvironmentConfigurationCallable(
      const DeleteEnvironmentConfigurationRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::DeleteEnvironmentConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteEnvironmentConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteEnvironmentConfigurationRequestT = Model::DeleteEnvironmentConfigurationRequest>
  void DeleteEnvironmentConfigurationAsync(const DeleteEnvironmentConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeletePlatformVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePlatformVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePlatformVersionRequestT = Model::DeletePlatformVersionRequest>
  void DeletePlatformVersionAsync(const DeletePlatformVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DeletePlatformVersionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicationVersionsOutcome DescribeApplicationVersions(
      const Model::DescribeApplicationVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeApplicationVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeApplicationVersionsRequestT = Model::DescribeApplicationVersionsRequest>
  Model::DescribeApplicationVersionsOutcomeCallable DescribeApplicationVersionsCallable(
      const DescribeApplicationVersionsRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeApplicationVersions, request);
  }

  /**
   * An Async wrapper for DescribeApplicationVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeApplicationVersionsRequestT = Model::DescribeApplicationVersionsRequest>
  void DescribeApplicationVersionsAsync(const DescribeApplicationVersionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeApplicationVersionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigurationOptionsOutcome DescribeConfigurationOptions(
      const Model::DescribeConfigurationOptionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConfigurationOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConfigurationOptionsRequestT = Model::DescribeConfigurationOptionsRequest>
  Model::DescribeConfigurationOptionsOutcomeCallable DescribeConfigurationOptionsCallable(
      const DescribeConfigurationOptionsRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeConfigurationOptions, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConfigurationOptionsRequestT = Model::DescribeConfigurationOptionsRequest>
  void DescribeConfigurationOptionsAsync(const DescribeConfigurationOptionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeConfigurationOptionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConfigurationSettingsOutcome DescribeConfigurationSettings(
      const Model::DescribeConfigurationSettingsRequest& request) const;

  /**
   * A Callable wrapper for DescribeConfigurationSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConfigurationSettingsRequestT = Model::DescribeConfigurationSettingsRequest>
  Model::DescribeConfigurationSettingsOutcomeCallable DescribeConfigurationSettingsCallable(
      const DescribeConfigurationSettingsRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeConfigurationSettings, request);
  }

  /**
   * An Async wrapper for DescribeConfigurationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConfigurationSettingsRequestT = Model::DescribeConfigurationSettingsRequest>
  void DescribeConfigurationSettingsAsync(const DescribeConfigurationSettingsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEnvironmentHealthOutcome DescribeEnvironmentHealth(
      const Model::DescribeEnvironmentHealthRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEnvironmentHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeEnvironmentHealthRequestT = Model::DescribeEnvironmentHealthRequest>
  Model::DescribeEnvironmentHealthOutcomeCallable DescribeEnvironmentHealthCallable(
      const DescribeEnvironmentHealthRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeEnvironmentHealth, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEnvironmentHealthRequestT = Model::DescribeEnvironmentHealthRequest>
  void DescribeEnvironmentHealthAsync(const DescribeEnvironmentHealthResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeEnvironmentHealthRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEnvironmentManagedActionHistoryOutcome DescribeEnvironmentManagedActionHistory(
      const Model::DescribeEnvironmentManagedActionHistoryRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEnvironmentManagedActionHistory that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeEnvironmentManagedActionHistoryOutcomeCallable DescribeEnvironmentManagedActionHistoryCallable(
      const DescribeEnvironmentManagedActionHistoryRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeEnvironmentManagedActionHistory, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentManagedActionHistory that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEnvironmentManagedActionHistoryRequestT = Model::DescribeEnvironmentManagedActionHistoryRequest>
  void DescribeEnvironmentManagedActionHistoryAsync(const DescribeEnvironmentManagedActionHistoryResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const DescribeEnvironmentManagedActionHistoryRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEnvironmentManagedActionsOutcome DescribeEnvironmentManagedActions(
      const Model::DescribeEnvironmentManagedActionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEnvironmentManagedActions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeEnvironmentManagedActionsRequestT = Model::DescribeEnvironmentManagedActionsRequest>
  Model::DescribeEnvironmentManagedActionsOutcomeCallable DescribeEnvironmentManagedActionsCallable(
      const DescribeEnvironmentManagedActionsRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeEnvironmentManagedActions, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentManagedActions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEnvironmentManagedActionsRequestT = Model::DescribeEnvironmentManagedActionsRequest>
  void DescribeEnvironmentManagedActionsAsync(const DescribeEnvironmentManagedActionsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeEnvironmentManagedActionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEnvironmentResourcesOutcome DescribeEnvironmentResources(
      const Model::DescribeEnvironmentResourcesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEnvironmentResources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEnvironmentResourcesRequestT = Model::DescribeEnvironmentResourcesRequest>
  Model::DescribeEnvironmentResourcesOutcomeCallable DescribeEnvironmentResourcesCallable(
      const DescribeEnvironmentResourcesRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::DescribeEnvironmentResources, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEnvironmentResourcesRequestT = Model::DescribeEnvironmentResourcesRequest>
  void DescribeEnvironmentResourcesAsync(const DescribeEnvironmentResourcesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeEnvironmentResourcesRequestT& request = {}) const {
   ...
   */
  template <typename DescribeEnvironmentsRequestT = Model::DescribeEnvironmentsRequest>
  void DescribeEnvironmentsAsync(const DescribeEnvironmentsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeEnvironmentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeInstancesHealth that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeInstancesHealth that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInstancesHealthRequestT = Model::DescribeInstancesHealthRequest>
  void DescribeInstancesHealthAsync(const DescribeInstancesHealthResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeInstancesHealthRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePlatformVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePlatformVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePlatformVersionRequestT = Model::DescribePlatformVersionRequest>
  void DescribePlatformVersionAsync(const DescribePlatformVersionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribePlatformVersionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateEnvironmentOperationsRoleOutcome DisassociateEnvironmentOperationsRole(
      const Model::DisassociateEnvironmentOperationsRoleRequest& request) const;

  /**
   * A Callable wrapper for DisassociateEnvironmentOperationsRole that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateEnvironmentOperationsRoleRequestT = Model::DisassociateEnvironmentOperationsRoleRequest>
  Model::DisassociateEnvironmentOperationsRoleOutcomeCallable DisassociateEnvironmentOperationsRoleCallable(
      const DisassociateEnvironmentOperationsRoleRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::DisassociateEnvironmentOperationsRole, request);
  }

  /**
   * An Async wrapper for DisassociateEnvironmentOperationsRole that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateEnvironmentOperationsRoleRequestT = Model::DisassociateEnvironmentOperationsRoleRequest>
  void DisassociateEnvironmentOperationsRoleAsync(const DisassociateEnvironmentOperationsRoleRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableSolutionStacksOutcome ListAvailableSolutionStacks(
      const Model::ListAvailableSolutionStacksRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAvailableSolutionStacks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailableSolutionStacksRequestT = Model::ListAvailableSolutionStacksRequest>
  Model::ListAvailableSolutionStacksOutcomeCallable ListAvailableSolutionStacksCallable(
      const ListAvailableSolutionStacksRequestT& request = {}) const {
    return SubmitCallable(&ElasticBeanstalkClient::ListAvailableSolutionStacks, request);
  }

  /**
   * An Async wrapper for ListAvailableSolutionStacks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAvailableSolutionStacksRequestT = Model::ListAvailableSolutionStacksRequest>
  void ListAvailableSolutionStacksAsync(const ListAvailableSolutionStacksResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListAvailableSolutionStacksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPlatformBranches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPlatformBranches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPlatformBranchesRequestT = Model::ListPlatformBranchesRequest>
  void ListPlatformBranchesAsync(const ListPlatformBranchesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListPlatformBranchesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPlatformVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPlatformVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPlatformVersionsRequestT = Model::ListPlatformVersionsRequest>
  void ListPlatformVersionsAsync(const ListPlatformVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListPlatformVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RebuildEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebuildEnvironment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebuildEnvironmentRequestT = Model::RebuildEnvironmentRequest>
  void RebuildEnvironmentAsync(const RebuildEnvironmentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const RebuildEnvironmentRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RequestEnvironmentInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RequestEnvironmentInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RequestEnvironmentInfoRequestT = Model::RequestEnvironmentInfoRequest>
  void RequestEnvironmentInfoAsync(const RequestEnvironmentInfoRequestT& request,
  ...
  /**
   * A Callable wrapper for RestartAppServer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestartAppServer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RestartAppServerRequestT = Model::RestartAppServerRequest>
  void RestartAppServerAsync(const RestartAppServerResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const RestartAppServerRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RetrieveEnvironmentInfo that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RetrieveEnvironmentInfo that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RetrieveEnvironmentInfoRequestT = Model::RetrieveEnvironmentInfoRequest>
  void RetrieveEnvironmentInfoAsync(const RetrieveEnvironmentInfoRequestT& request,
  ...
  /**
   * A Callable wrapper for SwapEnvironmentCNAMEs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SwapEnvironmentCNAMEs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SwapEnvironmentCNAMEsRequestT = Model::SwapEnvironmentCNAMEsRequest>
  void SwapEnvironmentCNAMEsAsync(const SwapEnvironmentCNAMEsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const SwapEnvironmentCNAMEsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for TerminateEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TerminateEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TerminateEnvironmentRequestT = Model::TerminateEnvironmentRequest>
  void TerminateEnvironmentAsync(const TerminateEnvironmentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const TerminateEnvironmentRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateApplicationResourceLifecycleOutcome UpdateApplicationResourceLifecycle(
      const Model::UpdateApplicationResourceLifecycleRequest& request) const;

  /**
   * A Callable wrapper for UpdateApplicationResourceLifecycle that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateApplicationResourceLifecycleRequestT = Model::UpdateApplicationResourceLifecycleRequest>
  Model::UpdateApplicationResourceLifecycleOutcomeCallable UpdateApplicationResourceLifecycleCallable(
      const UpdateApplicationResourceLifecycleRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::UpdateApplicationResourceLifecycle, request);
  }

  /**
   * An Async wrapper for UpdateApplicationResourceLifecycle that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateApplicationResourceLifecycleRequestT = Model::UpdateApplicationResourceLifecycleRequest>
  void UpdateApplicationResourceLifecycleAsync(const UpdateApplicationResourceLifecycleRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateApplicationVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateApplicationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateApplicationVersionRequestT = Model::UpdateApplicationVersionRequest>
  void UpdateApplicationVersionAsync(const UpdateApplicationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfigurationTemplateOutcome UpdateConfigurationTemplate(
      const Model::UpdateConfigurationTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfigurationTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConfigurationTemplateRequestT = Model::UpdateConfigurationTemplateRequest>
  Model::UpdateConfigurationTemplateOutcomeCallable UpdateConfigurationTemplateCallable(
      const UpdateConfigurationTemplateRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::UpdateConfigurationTemplate, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfigurationTemplateRequestT = Model::UpdateConfigurationTemplateRequest>
  void UpdateConfigurationTemplateAsync(const UpdateConfigurationTemplateRequestT& request,
   ...
   */
  template <typename UpdateEnvironmentRequestT = Model::UpdateEnvironmentRequest>
  void UpdateEnvironmentAsync(const UpdateEnvironmentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const UpdateEnvironmentRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateTagsForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTagsForResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTagsForResourceRequestT = Model::UpdateTagsForResourceRequest>
  void UpdateTagsForResourceAsync(const UpdateTagsForResourceRequestT& request, const UpdateTagsForResourceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ValidateConfigurationSettingsOutcome ValidateConfigurationSettings(
      const Model::ValidateConfigurationSettingsRequest& request) const;

  /**
   * A Callable wrapper for ValidateConfigurationSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ValidateConfigurationSettingsRequestT = Model::ValidateConfigurationSettingsRequest>
  Model::ValidateConfigurationSettingsOutcomeCallable ValidateConfigurationSettingsCallable(
      const ValidateConfigurationSettingsRequestT& request) const {
    return SubmitCallable(&ElasticBeanstalkClient::ValidateConfigurationSettings, request);
  }

  /**
   * An Async wrapper for ValidateConfigurationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ValidateConfigurationSettingsRequestT = Model::ValidateConfigurationSettingsRequest>
  void ValidateConfigurationSettingsAsync(const ValidateConfigurationSettingsRequestT& request,
