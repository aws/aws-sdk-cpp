...
class ListDomainsResult {
 public:
  AWS_CONNECTHEALTH_API ListDomainsResult() = default;
  AWS_CONNECTHEALTH_API ListDomainsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CONNECTHEALTH_API ListDomainsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
