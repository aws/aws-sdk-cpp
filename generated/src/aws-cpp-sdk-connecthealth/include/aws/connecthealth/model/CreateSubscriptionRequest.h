...
/**
 */
class CreateSubscriptionRequest : public ConnectHealthRequest {
 public:
  AWS_CONNECTHEALTH_API CreateSubscriptionRequest() = default;
  ...
  template <typename DomainIdT = Aws::String>
  CreateSubscriptionRequest& WithDomainId(DomainIdT&& value) {
