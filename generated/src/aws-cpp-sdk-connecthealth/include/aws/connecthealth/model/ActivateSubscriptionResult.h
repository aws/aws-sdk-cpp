...
class ActivateSubscriptionResult {
 public:
  AWS_CONNECTHEALTH_API ActivateSubscriptionResult() = default;
  AWS_CONNECTHEALTH_API ActivateSubscriptionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CONNECTHEALTH_API ActivateSubscriptionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SubscriptionT = SubscriptionDescription>
  ActivateSubscriptionResult& WithSubscription(SubscriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ActivateSubscriptionResult& WithRequestId(RequestIdT&& value) {
