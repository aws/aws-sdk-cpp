...
NoteTemplateSettings::NoteTemplateSettings(JsonView jsonValue) { *this = jsonValue; }

NoteTemplateSettings& NoteTemplateSettings::operator=(JsonView jsonValue) {
...
JsonValue NoteTemplateSettings::Jsonize() const {
  JsonValue payload;
