...
ManagedTemplateResponse::ManagedTemplateResponse(JsonView jsonValue) { *this = jsonValue; }

ManagedTemplateResponse& ManagedTemplateResponse::operator=(JsonView jsonValue) {
...
JsonValue ManagedTemplateResponse::Jsonize() const {
  JsonValue payload;
