...
namespace Model
{
  ...
  public:
    ...
    inline ListS3ResourcesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListS3ResourcesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListS3ResourcesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
