...
namespace Model
{
  ...
  {
  public:
    AWS_MACIE_API InternalException();
    AWS_MACIE_API InternalException(Aws::Utils::Json::JsonView jsonValue);
    AWS_MACIE_API InternalException& operator=(Aws::Utils::Json::JsonView jsonValue);
