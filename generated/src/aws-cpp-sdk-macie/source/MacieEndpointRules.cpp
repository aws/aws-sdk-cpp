...
namespace Macie
{
const size_t MacieEndpointRules::RulesBlobStrLen = 3450;
const size_t MacieEndpointRules::RulesBlobSize = 3451;

using RulesBlobT = Aws::Array<const char, MacieEndpointRules::RulesBlobSize>;
...
'a','c','i','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
's',':','/','/','m','a','c','i','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
't','i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p',
'r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{',
'}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}',
'\0'
...
const char* MacieEndpointRules::GetRulesBlob()
{
