...
namespace Macie
{
const size_t MacieEndpointRules::RulesBlobStrLen = 3468;
const size_t MacieEndpointRules::RulesBlobSize = 3469;
...
'"',':','"','h','t','t','p','s',':','/','/','m','a','c','i','e','-','f','i','p','s','.','{','R','e',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','a','c','i','e','.','{','R','e','g','i',
