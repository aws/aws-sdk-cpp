...
Aws::String DescribeDBSnapshotTenantDatabasesRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DescribeDBSnapshotTenantDatabases&";
...
void DescribeDBSnapshotTenantDatabasesRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
