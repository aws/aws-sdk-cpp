...
SourceRegion::SourceRegion(const XmlNode& xmlNode) { *this = xmlNode; }
...
SourceRegion& SourceRegion::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!supportsDBInstanceAutomatedBackupsReplicationNode.IsNull()) {
      m_supportsDBInstanceAutomatedBackupsReplication = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsDBInstanceAutomatedBackupsReplicationNode.GetText()).c_str())
              .c_str());
...
void SourceRegion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_supportsDBInstanceAutomatedBackupsReplicationHasBeenSet) {
    oStream << location << index << locationValue << ".SupportsDBInstanceAutomatedBackupsReplication=" << std::boolalpha
            << m_supportsDBInstanceAutomatedBackupsReplication << "&";
  }
}
...
void SourceRegion::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_supportsDBInstanceAutomatedBackupsReplicationHasBeenSet) {
    oStream << location << ".SupportsDBInstanceAutomatedBackupsReplication=" << std::boolalpha
            << m_supportsDBInstanceAutomatedBackupsReplication << "&";
  }
}
