...
OptionGroupOptionSetting::OptionGroupOptionSetting(const XmlNode& xmlNode) { *this = xmlNode; }
...
OptionGroupOptionSetting& OptionGroupOptionSetting::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!minimumEngineVersionPerAllowedValueNode.IsNull()) {
      XmlNode minimumEngineVersionPerAllowedValueMember =
          minimumEngineVersionPerAllowedValueNode.FirstChild("MinimumEngineVersionPerAllowedValue");
      ...
      while (!minimumEngineVersionPerAllowedValueMember.IsNull()) {
        ...
        minimumEngineVersionPerAllowedValueMember =
            minimumEngineVersionPerAllowedValueMember.NextNode("MinimumEngineVersionPerAllowedValue");
      }
...
void OptionGroupOptionSetting::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_minimumEngineVersionPerAllowedValueHasBeenSet) {
    ...
    for (auto& item : m_minimumEngineVersionPerAllowedValue) {
      ...
      minimumEngineVersionPerAllowedValueSs << location << index << locationValue
                                            << ".MinimumEngineVersionPerAllowedValue.MinimumEngineVersionPerAllowedValue."
                                            << minimumEngineVersionPerAllowedValueIdx++;
...
void OptionGroupOptionSetting::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_minimumEngineVersionPerAllowedValueHasBeenSet) {
    ...
    for (auto& item : m_minimumEngineVersionPerAllowedValue) {
      Aws::StringStream minimumEngineVersionPerAllowedValueSs;
      minimumEngineVersionPerAllowedValueSs << location << ".MinimumEngineVersionPerAllowedValue.MinimumEngineVersionPerAllowedValue."
                                            << minimumEngineVersionPerAllowedValueIdx++;
      item.OutputToStream(oStream, minimumEngineVersionPerAllowedValueSs.str().c_str());
    }
  }
