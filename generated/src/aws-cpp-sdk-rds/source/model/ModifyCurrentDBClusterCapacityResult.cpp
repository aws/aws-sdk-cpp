...
ModifyCurrentDBClusterCapacityResult& ModifyCurrentDBClusterCapacityResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!pendingCapacityNode.IsNull()) {
      m_pendingCapacity = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(pendingCapacityNode.GetText()).c_str()).c_str());
    ...
    if (!currentCapacityNode.IsNull()) {
      m_currentCapacity = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentCapacityNode.GetText()).c_str()).c_str());
    ...
    if (!secondsBeforeTimeoutNode.IsNull()) {
      m_secondsBeforeTimeout = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(secondsBeforeTimeoutNode.GetText()).c_str()).c_str());
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::RDS::Model::ModifyCurrentDBClusterCapacityResult",
