...
DBClusterAssociatedRole::DBClusterAssociatedRole(const XmlNode& xmlNode) { *this = xmlNode; }

DBClusterAssociatedRole& DBClusterAssociatedRole::operator=(const XmlNode& xmlNode) {
...
void DBClusterAssociatedRole::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void DBClusterAssociatedRole::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_roleArnHasBeenSet) {
