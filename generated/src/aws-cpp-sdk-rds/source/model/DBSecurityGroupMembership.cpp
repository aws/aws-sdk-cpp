...
DBSecurityGroupMembership::DBSecurityGroupMembership(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DBSecurityGroupMembership::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
