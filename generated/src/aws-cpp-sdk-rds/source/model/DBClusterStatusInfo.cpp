...
DBClusterStatusInfo::DBClusterStatusInfo(const XmlNode& xmlNode) { *this = xmlNode; }

DBClusterStatusInfo& DBClusterStatusInfo::operator=(const XmlNode& xmlNode) {
...
void DBClusterStatusInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
...
void DBClusterStatusInfo::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_statusTypeHasBeenSet) {
