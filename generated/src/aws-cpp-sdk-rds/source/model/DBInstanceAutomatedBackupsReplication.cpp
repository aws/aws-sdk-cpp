...
DBInstanceAutomatedBackupsReplication::DBInstanceAutomatedBackupsReplication(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DBInstanceAutomatedBackupsReplication::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
