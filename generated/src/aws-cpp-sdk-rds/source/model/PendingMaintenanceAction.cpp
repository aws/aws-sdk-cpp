...
PendingMaintenanceAction::PendingMaintenanceAction(const XmlNode& xmlNode) { *this = xmlNode; }
...
PendingMaintenanceAction& PendingMaintenanceAction::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!autoAppliedAfterDateNode.IsNull()) {
      m_autoAppliedAfterDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(autoAppliedAfterDateNode.GetText()).c_str()).c_str(),
    ...
    if (!forcedApplyDateNode.IsNull()) {
      m_forcedApplyDate = DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(forcedApplyDateNode.GetText()).c_str()).c_str(),
                                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!currentApplyDateNode.IsNull()) {
      m_currentApplyDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentApplyDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void PendingMaintenanceAction::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_autoAppliedAfterDateHasBeenSet) {
    oStream << location << index << locationValue << ".AutoAppliedAfterDate="
            << StringUtils::URLEncode(m_autoAppliedAfterDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_forcedApplyDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".ForcedApplyDate=" << StringUtils::URLEncode(m_forcedApplyDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
  ...
  if (m_currentApplyDateHasBeenSet) {
    oStream << location << index << locationValue
            << ".CurrentApplyDate=" << StringUtils::URLEncode(m_currentApplyDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str())
            << "&";
  }
...
void PendingMaintenanceAction::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_autoAppliedAfterDateHasBeenSet) {
    oStream << location << ".AutoAppliedAfterDate="
            << StringUtils::URLEncode(m_autoAppliedAfterDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_forcedApplyDateHasBeenSet) {
    oStream << location
