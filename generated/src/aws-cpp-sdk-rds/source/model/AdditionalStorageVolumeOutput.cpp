...
AdditionalStorageVolumeOutput::AdditionalStorageVolumeOutput(const XmlNode& xmlNode) { *this = xmlNode; }

AdditionalStorageVolumeOutput& AdditionalStorageVolumeOutput::operator=(const XmlNode& xmlNode) {
...
void AdditionalStorageVolumeOutput::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
...
void AdditionalStorageVolumeOutput::OutputToStream(Aws::OStream& oStream, const char* location) const {
  if (m_volumeNameHasBeenSet) {
