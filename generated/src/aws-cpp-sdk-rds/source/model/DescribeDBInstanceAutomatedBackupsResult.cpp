...
DescribeDBInstanceAutomatedBackupsResult& DescribeDBInstanceAutomatedBackupsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::RDS::Model::DescribeDBInstanceAutomatedBackupsResult",
