...
DescribeDBSnapshotTenantDatabasesResult& DescribeDBSnapshotTenantDatabasesResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!dBSnapshotTenantDatabasesNode.IsNull()) {
      ...
      m_dBSnapshotTenantDatabasesHasBeenSet = !dBSnapshotTenantDatabasesMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::RDS::Model::DescribeDBSnapshotTenantDatabasesResult",
