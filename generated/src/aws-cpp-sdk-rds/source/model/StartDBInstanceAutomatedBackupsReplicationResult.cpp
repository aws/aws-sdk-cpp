...
StartDBInstanceAutomatedBackupsReplicationResult& StartDBInstanceAutomatedBackupsReplicationResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::RDS::Model::StartDBInstanceAutomatedBackupsReplicationResult",
