...
DBProxy::DBProxy(const XmlNode& xmlNode) { *this = xmlNode; }
...
DBProxy& DBProxy::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = DBProxyStatusMapper::GetDBProxyStatusForName(
    ...
    if (!requireTLSNode.IsNull()) {
      m_requireTLS =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(requireTLSNode.GetText()).c_str()).c_str());
    ...
    if (!idleClientTimeoutNode.IsNull()) {
      m_idleClientTimeout = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(idleClientTimeoutNode.GetText()).c_str()).c_str());
      m_idleClientTimeoutHasBeenSet = true;
    }
    XmlNode debugLoggingNode = resultNode.FirstChild("DebugLogging");
    if (!debugLoggingNode.IsNull()) {
      m_debugLogging =
          StringUtils::ConvertToBool(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(debugLoggingNode.GetText()).c_str()).c_str());
    ...
    if (!targetConnectionNetworkTypeNode.IsNull()) {
      m_targetConnectionNetworkType = TargetConnectionNetworkTypeMapper::GetTargetConnectionNetworkTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(targetConnectionNetworkTypeNode.GetText()).c_str()));
...
void DBProxy::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(DBProxyStatusMapper::GetNameForDBProxyStatus(m_status)) << "&";
  }
  ...
  if (m_targetConnectionNetworkTypeHasBeenSet) {
    oStream << location << index << locationValue << ".TargetConnectionNetworkType="
            << StringUtils::URLEncode(
                   TargetConnectionNetworkTypeMapper::GetNameForTargetConnectionNetworkType(m_targetConnectionNetworkType))
            << "&";
  }
}
...
void DBProxy::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_targetConnectionNetworkTypeHasBeenSet) {
    oStream << location << ".TargetConnectionNetworkType="
            << StringUtils::URLEncode(
                   TargetConnectionNetworkTypeMapper::GetNameForTargetConnectionNetworkType(m_targetConnectionNetworkType))
            << "&";
  }
