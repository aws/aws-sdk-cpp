...
OrderableDBInstanceOption& OrderableDBInstanceOption::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!multiAZCapableNode.IsNull()) {
      m_multiAZCapable = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(multiAZCapableNode.GetText()).c_str()).c_str());
    ...
    if (!readReplicaCapableNode.IsNull()) {
      m_readReplicaCapable = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(readReplicaCapableNode.GetText()).c_str()).c_str());
    ...
    if (!supportsStorageEncryptionNode.IsNull()) {
      m_supportsStorageEncryption = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsStorageEncryptionNode.GetText()).c_str()).c_str());
    ...
    if (!supportsEnhancedMonitoringNode.IsNull()) {
      m_supportsEnhancedMonitoring = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsEnhancedMonitoringNode.GetText()).c_str()).c_str());
    ...
    if (!supportsIAMDatabaseAuthenticationNode.IsNull()) {
      m_supportsIAMDatabaseAuthentication = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsIAMDatabaseAuthenticationNode.GetText()).c_str()).c_str());
    ...
    if (!supportsPerformanceInsightsNode.IsNull()) {
      m_supportsPerformanceInsights = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsPerformanceInsightsNode.GetText()).c_str()).c_str());
    ...
    if (!minIopsPerDbInstanceNode.IsNull()) {
      m_minIopsPerDbInstance = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(minIopsPerDbInstanceNode.GetText()).c_str()).c_str());
    ...
    if (!maxIopsPerDbInstanceNode.IsNull()) {
      m_maxIopsPerDbInstance = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxIopsPerDbInstanceNode.GetText()).c_str()).c_str());
    ...
    if (!minStorageThroughputPerDbInstanceNode.IsNull()) {
      m_minStorageThroughputPerDbInstance = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(minStorageThroughputPerDbInstanceNode.GetText()).c_str()).c_str());
    ...
    if (!maxStorageThroughputPerDbInstanceNode.IsNull()) {
      m_maxStorageThroughputPerDbInstance = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxStorageThroughputPerDbInstanceNode.GetText()).c_str()).c_str());
    ...
    if (!minStorageThroughputPerIopsNode.IsNull()) {
      m_minStorageThroughputPerIops = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(minStorageThroughputPerIopsNode.GetText()).c_str()).c_str());
    ...
    if (!maxStorageThroughputPerIopsNode.IsNull()) {
      m_maxStorageThroughputPerIops = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(maxStorageThroughputPerIopsNode.GetText()).c_str()).c_str());
    ...
    if (!supportsKerberosAuthenticationNode.IsNull()) {
      m_supportsKerberosAuthentication = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsKerberosAuthenticationNode.GetText()).c_str()).c_str());
    ...
    if (!outpostCapableNode.IsNull()) {
      m_outpostCapable = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(outpostCapableNode.GetText()).c_str()).c_str());
    ...
    if (!supportsClustersNode.IsNull()) {
      m_supportsClusters = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(supportsClustersNode.GetText()).c_str()).c_str());
...
void OrderableDBInstanceOption::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_supportsIAMDatabaseAuthenticationHasBeenSet) {
    oStream << location << index << locationValue << ".SupportsIAMDatabaseAuthentication=" << std::boolalpha
            << m_supportsIAMDatabaseAuthentication << "&";
  }
  ...
  if (m_minStorageThroughputPerIopsHasBeenSet) {
    oStream << location << index << locationValue
            << ".MinStorageThroughputPerIops=" << StringUtils::URLEncode(m_minStorageThroughputPerIops) << "&";
  }

  if (m_maxStorageThroughputPerIopsHasBeenSet) {
    oStream << location << index << locationValue
            << ".MaxStorageThroughputPerIops=" << StringUtils::URLEncode(m_maxStorageThroughputPerIops) << "&";
  }
  ...
  if (m_availableProcessorFeaturesHasBeenSet) {
    ...
    for (auto& item : m_availableProcessorFeatures) {
      ...
      availableProcessorFeaturesSs << location << index << locationValue << ".AvailableProcessorFeatures.AvailableProcessorFeature."
                                   << availableProcessorFeaturesIdx++;
  ...
  if (m_supportsKerberosAuthenticationHasBeenSet) {
    oStream << location << index << locationValue << ".SupportsKerberosAuthentication=" << std::boolalpha
            << m_supportsKerberosAuthentication << "&";
  }
  ...
  if (m_supportedActivityStreamModesHasBeenSet) {
    ...
    for (auto& item : m_supportedActivityStreamModes) {
      oStream << location << index << locationValue << ".SupportedActivityStreamModes.member." << supportedActivityStreamModesIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
...
void OrderableDBInstanceOption::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_availableProcessorFeaturesHasBeenSet) {
    ...
    for (auto& item : m_availableProcessorFeatures) {
      Aws::StringStream availableProcessorFeaturesSs;
      availableProcessorFeaturesSs << location << ".AvailableProcessorFeatures.AvailableProcessorFeature."
                                   << availableProcessorFeaturesIdx++;
      item.OutputToStream(oStream, availableProcessorFeaturesSs.str().c_str());
    }
  }
  ...
  if (m_supportedActivityStreamModesHasBeenSet) {
    unsigned supportedActivityStreamModesIdx = 1;
    for (auto& item : m_supportedActivityStreamModes) {
      oStream << location << ".SupportedActivityStreamModes.member." << supportedActivityStreamModesIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  if (m_supportsGlobalDatabasesHasBeenSet) {
