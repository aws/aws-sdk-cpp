...
DeleteDBClusterEndpointResult::DeleteDBClusterEndpointResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DeleteDBClusterEndpointResult& DeleteDBClusterEndpointResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::RDS::Model::DeleteDBClusterEndpointResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId());
  }
  return *this;
}
