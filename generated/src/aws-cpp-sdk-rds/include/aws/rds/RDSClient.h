...
class AWS_RDS_API RDSClient : public Aws::Client::AWSXMLClient, public Aws::Client::ClientWithAsyncTemplateMethods<RDSClient> {
 public:
   ...
   */
  RDSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<RDSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AddRoleToDBInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddRoleToDBInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AddRoleToDBInstanceRequestT = Model::AddRoleToDBInstanceRequest>
  void AddRoleToDBInstanceAsync(const AddRoleToDBInstanceRequestT& request, const AddRoleToDBInstanceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::AuthorizeDBSecurityGroupIngressOutcome AuthorizeDBSecurityGroupIngress(
      const Model::AuthorizeDBSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for AuthorizeDBSecurityGroupIngress that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AuthorizeDBSecurityGroupIngressRequestT = Model::AuthorizeDBSecurityGroupIngressRequest>
  Model::AuthorizeDBSecurityGroupIngressOutcomeCallable AuthorizeDBSecurityGroupIngressCallable(
      const AuthorizeDBSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&RDSClient::AuthorizeDBSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for AuthorizeDBSecurityGroupIngress that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AuthorizeDBSecurityGroupIngressRequestT = Model::AuthorizeDBSecurityGroupIngressRequest>
  void AuthorizeDBSecurityGroupIngressAsync(const AuthorizeDBSecurityGroupIngressRequestT& request,
  ...
  /**
   * A Callable wrapper for BacktrackDBCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BacktrackDBCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BacktrackDBClusterRequestT = Model::BacktrackDBClusterRequest>
  void BacktrackDBClusterAsync(const BacktrackDBClusterRequestT& request, const BacktrackDBClusterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopyDBSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyDBSnapshotRequestT = Model::CopyDBSnapshotRequest>
  void CopyDBSnapshotAsync(const CopyDBSnapshotRequestT& request, const CopyDBSnapshotResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopyOptionGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopyOptionGroupRequestT = Model::CopyOptionGroupRequest>
  void CopyOptionGroupAsync(const CopyOptionGroupRequestT& request, const CopyOptionGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBlueGreenDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateBlueGreenDeploymentRequestT = Model::CreateBlueGreenDeploymentRequest>
  Model::CreateBlueGreenDeploymentOutcomeCallable CreateBlueGreenDeploymentCallable(
      const CreateBlueGreenDeploymentRequestT& request) const {
    return SubmitCallable(&RDSClient::CreateBlueGreenDeployment, request);
  }

  /**
   * An Async wrapper for CreateBlueGreenDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBlueGreenDeploymentRequestT = Model::CreateBlueGreenDeploymentRequest>
  void CreateBlueGreenDeploymentAsync(const CreateBlueGreenDeploymentRequestT& request,
                                      const CreateBlueGreenDeploymentResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomDBEngineVersionOutcome CreateCustomDBEngineVersion(
      const Model::CreateCustomDBEngineVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomDBEngineVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomDBEngineVersionRequestT = Model::CreateCustomDBEngineVersionRequest>
  Model::CreateCustomDBEngineVersionOutcomeCallable CreateCustomDBEngineVersionCallable(
      const CreateCustomDBEngineVersionRequestT& request) const {
    return SubmitCallable(&RDSClient::CreateCustomDBEngineVersion, request);
  }

  /**
   * An Async wrapper for CreateCustomDBEngineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomDBEngineVersionRequestT = Model::CreateCustomDBEngineVersionRequest>
  void CreateCustomDBEngineVersionAsync(const CreateCustomDBEngineVersionRequestT& request,
                                        const CreateCustomDBEngineVersionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDBInstanceReadReplicaOutcome CreateDBInstanceReadReplica(
      const Model::CreateDBInstanceReadReplicaRequest& request) const;

  /**
   * A Callable wrapper for CreateDBInstanceReadReplica that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDBInstanceReadReplicaRequestT = Model::CreateDBInstanceReadReplicaRequest>
  Model::CreateDBInstanceReadReplicaOutcomeCallable CreateDBInstanceReadReplicaCallable(
      const CreateDBInstanceReadReplicaRequestT& request) const {
    return SubmitCallable(&RDSClient::CreateDBInstanceReadReplica, request);
  }

  /**
   * An Async wrapper for CreateDBInstanceReadReplica that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDBInstanceReadReplicaRequestT = Model::CreateDBInstanceReadReplicaRequest>
  void CreateDBInstanceReadReplicaAsync(const CreateDBInstanceReadReplicaRequestT& request,
   ...
   * effect.</p> <p>This command doesn't apply to RDS Custom.</p><p><h3>See
   * Also:</h3>   <a
  ...
  /**
   * An Async wrapper for CreateDBProxy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDBProxyRequestT = Model::CreateDBProxyRequest>
  void CreateDBProxyAsync(const CreateDBProxyRequestT& request, const CreateDBProxyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDBProxyEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDBProxyEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDBProxyEndpointRequestT = Model::CreateDBProxyEndpointRequest>
  void CreateDBProxyEndpointAsync(const CreateDBProxyEndpointRequestT& request, const CreateDBProxyEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDBSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDBSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDBSecurityGroupRequestT = Model::CreateDBSecurityGroupRequest>
  void CreateDBSecurityGroupAsync(const CreateDBSecurityGroupRequestT& request, const CreateDBSecurityGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDBShardGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDBShardGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDBShardGroupRequestT = Model::CreateDBShardGroupRequest>
  void CreateDBShardGroupAsync(const CreateDBShardGroupRequestT& request, const CreateDBShardGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDBSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDBSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDBSnapshotRequestT = Model::CreateDBSnapshotRequest>
  void CreateDBSnapshotAsync(const CreateDBSnapshotRequestT& request, const CreateDBSnapshotResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateOptionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOptionGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateOptionGroupRequestT = Model::CreateOptionGroupRequest>
  void CreateOptionGroupAsync(const CreateOptionGroupRequestT& request, const CreateOptionGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTenantDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTenantDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTenantDatabaseRequestT = Model::CreateTenantDatabaseRequest>
  void CreateTenantDatabaseAsync(const CreateTenantDatabaseRequestT& request, const CreateTenantDatabaseResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBlueGreenDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteBlueGreenDeploymentRequestT = Model::DeleteBlueGreenDeploymentRequest>
  Model::DeleteBlueGreenDeploymentOutcomeCallable DeleteBlueGreenDeploymentCallable(
      const DeleteBlueGreenDeploymentRequestT& request) const {
    return SubmitCallable(&RDSClient::DeleteBlueGreenDeployment, request);
  }

  /**
   * An Async wrapper for DeleteBlueGreenDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBlueGreenDeploymentRequestT = Model::DeleteBlueGreenDeploymentRequest>
  void DeleteBlueGreenDeploymentAsync(const DeleteBlueGreenDeploymentRequestT& request,
                                      const DeleteBlueGreenDeploymentResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomDBEngineVersionOutcome DeleteCustomDBEngineVersion(
      const Model::DeleteCustomDBEngineVersionRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomDBEngineVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomDBEngineVersionRequestT = Model::DeleteCustomDBEngineVersionRequest>
  Model::DeleteCustomDBEngineVersionOutcomeCallable DeleteCustomDBEngineVersionCallable(
      const DeleteCustomDBEngineVersionRequestT& request) const {
    return SubmitCallable(&RDSClient::DeleteCustomDBEngineVersion, request);
  }

  /**
   * An Async wrapper for DeleteCustomDBEngineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomDBEngineVersionRequestT = Model::DeleteCustomDBEngineVersionRequest>
  void DeleteCustomDBEngineVersionAsync(const DeleteCustomDBEngineVersionRequestT& request,
                                        const DeleteCustomDBEngineVersionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDBClusterAutomatedBackupOutcome DeleteDBClusterAutomatedBackup(
      const Model::DeleteDBClusterAutomatedBackupRequest& request) const;

  /**
   * A Callable wrapper for DeleteDBClusterAutomatedBackup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDBClusterAutomatedBackupRequestT = Model::DeleteDBClusterAutomatedBackupRequest>
  Model::DeleteDBClusterAutomatedBackupOutcomeCallable DeleteDBClusterAutomatedBackupCallable(
      const DeleteDBClusterAutomatedBackupRequestT& request) const {
    return SubmitCallable(&RDSClient::DeleteDBClusterAutomatedBackup, request);
  }

  /**
   * An Async wrapper for DeleteDBClusterAutomatedBackup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDBClusterAutomatedBackupRequestT = Model::DeleteDBClusterAutomatedBackupRequest>
  void DeleteDBClusterAutomatedBackupAsync(const DeleteDBClusterAutomatedBackupRequestT& request,
                                           const DeleteDBClusterAutomatedBackupResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDBInstanceAutomatedBackupOutcome DeleteDBInstanceAutomatedBackup(
      const Model::DeleteDBInstanceAutomatedBackupRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteDBInstanceAutomatedBackup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDBInstanceAutomatedBackupRequestT = Model::DeleteDBInstanceAutomatedBackupRequest>
  Model::DeleteDBInstanceAutomatedBackupOutcomeCallable DeleteDBInstanceAutomatedBackupCallable(
      const DeleteDBInstanceAutomatedBackupRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DeleteDBInstanceAutomatedBackup, request);
  }

  /**
   * An Async wrapper for DeleteDBInstanceAutomatedBackup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDBInstanceAutomatedBackupRequestT = Model::DeleteDBInstanceAutomatedBackupRequest>
  void DeleteDBInstanceAutomatedBackupAsync(const DeleteDBInstanceAutomatedBackupResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteDBProxy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDBProxyRequestT = Model::DeleteDBProxyRequest>
  void DeleteDBProxyAsync(const DeleteDBProxyRequestT& request, const DeleteDBProxyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDBProxyEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDBProxyEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDBProxyEndpointRequestT = Model::DeleteDBProxyEndpointRequest>
  void DeleteDBProxyEndpointAsync(const DeleteDBProxyEndpointRequestT& request, const DeleteDBProxyEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDBSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDBSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDBSecurityGroupRequestT = Model::DeleteDBSecurityGroupRequest>
  void DeleteDBSecurityGroupAsync(const DeleteDBSecurityGroupRequestT& request, const DeleteDBSecurityGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDBShardGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDBShardGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDBShardGroupRequestT = Model::DeleteDBShardGroupRequest>
  void DeleteDBShardGroupAsync(const DeleteDBShardGroupRequestT& request, const DeleteDBShardGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDBSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDBSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDBSnapshotRequestT = Model::DeleteDBSnapshotRequest>
  void DeleteDBSnapshotAsync(const DeleteDBSnapshotRequestT& request, const DeleteDBSnapshotResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteOptionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOptionGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteOptionGroupRequestT = Model::DeleteOptionGroupRequest>
  void DeleteOptionGroupAsync(const DeleteOptionGroupRequestT& request, const DeleteOptionGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTenantDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTenantDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTenantDatabaseRequestT = Model::DeleteTenantDatabaseRequest>
  void DeleteTenantDatabaseAsync(const DeleteTenantDatabaseRequestT& request, const DeleteTenantDatabaseResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterDBProxyTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterDBProxyTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterDBProxyTargetsRequestT = Model::DeregisterDBProxyTargetsRequest>
  void DeregisterDBProxyTargetsAsync(const DeregisterDBProxyTargetsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeBlueGreenDeploymentsOutcome DescribeBlueGreenDeployments(
      const Model::DescribeBlueGreenDeploymentsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeBlueGreenDeployments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeBlueGreenDeploymentsRequestT = Model::DescribeBlueGreenDeploymentsRequest>
  Model::DescribeBlueGreenDeploymentsOutcomeCallable DescribeBlueGreenDeploymentsCallable(
      const DescribeBlueGreenDeploymentsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeBlueGreenDeployments, request);
  }

  /**
   * An Async wrapper for DescribeBlueGreenDeployments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBlueGreenDeploymentsRequestT = Model::DescribeBlueGreenDeploymentsRequest>
  void DescribeBlueGreenDeploymentsAsync(const DescribeBlueGreenDeploymentsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeBlueGreenDeploymentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBClusterAutomatedBackupsOutcome DescribeDBClusterAutomatedBackups(
      const Model::DescribeDBClusterAutomatedBackupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDBClusterAutomatedBackups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDBClusterAutomatedBackupsRequestT = Model::DescribeDBClusterAutomatedBackupsRequest>
  Model::DescribeDBClusterAutomatedBackupsOutcomeCallable DescribeDBClusterAutomatedBackupsCallable(
      const DescribeDBClusterAutomatedBackupsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBClusterAutomatedBackups, request);
  }

  /**
   * An Async wrapper for DescribeDBClusterAutomatedBackups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDBClusterAutomatedBackupsRequestT = Model::DescribeDBClusterAutomatedBackupsRequest>
  void DescribeDBClusterAutomatedBackupsAsync(const DescribeDBClusterAutomatedBackupsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeDBClusterAutomatedBackupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBClusterBacktracksOutcome DescribeDBClusterBacktracks(
      const Model::DescribeDBClusterBacktracksRequest& request) const;

  /**
   * A Callable wrapper for DescribeDBClusterBacktracks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDBClusterBacktracksRequestT = Model::DescribeDBClusterBacktracksRequest>
  Model::DescribeDBClusterBacktracksOutcomeCallable DescribeDBClusterBacktracksCallable(
      const DescribeDBClusterBacktracksRequestT& request) const {
    return SubmitCallable(&RDSClient::DescribeDBClusterBacktracks, request);
  }

  /**
   * An Async wrapper for DescribeDBClusterBacktracks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBClusterBacktracksRequestT = Model::DescribeDBClusterBacktracksRequest>
  void DescribeDBClusterBacktracksAsync(const DescribeDBClusterBacktracksRequestT& request,
  ...
  virtual Model::DescribeDBInstanceAutomatedBackupsOutcome DescribeDBInstanceAutomatedBackups(
      const Model::DescribeDBInstanceAutomatedBackupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDBInstanceAutomatedBackups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDBInstanceAutomatedBackupsRequestT = Model::DescribeDBInstanceAutomatedBackupsRequest>
  Model::DescribeDBInstanceAutomatedBackupsOutcomeCallable DescribeDBInstanceAutomatedBackupsCallable(
      const DescribeDBInstanceAutomatedBackupsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBInstanceAutomatedBackups, request);
  }

  /**
   * An Async wrapper for DescribeDBInstanceAutomatedBackups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDBInstanceAutomatedBackupsRequestT = Model::DescribeDBInstanceAutomatedBackupsRequest>
  void DescribeDBInstanceAutomatedBackupsAsync(const DescribeDBInstanceAutomatedBackupsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeDBInstanceAutomatedBackupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBLogFiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDBLogFiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDBLogFilesRequestT = Model::DescribeDBLogFilesRequest>
  void DescribeDBLogFilesAsync(const DescribeDBLogFilesRequestT& request, const DescribeDBLogFilesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBMajorEngineVersionsOutcome DescribeDBMajorEngineVersions(
      const Model::DescribeDBMajorEngineVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDBMajorEngineVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDBMajorEngineVersionsRequestT = Model::DescribeDBMajorEngineVersionsRequest>
  Model::DescribeDBMajorEngineVersionsOutcomeCallable DescribeDBMajorEngineVersionsCallable(
      const DescribeDBMajorEngineVersionsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBMajorEngineVersions, request);
  }

  /**
   * An Async wrapper for DescribeDBMajorEngineVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBMajorEngineVersionsRequestT = Model::DescribeDBMajorEngineVersionsRequest>
  void DescribeDBMajorEngineVersionsAsync(const DescribeDBMajorEngineVersionsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeDBMajorEngineVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBProxies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDBProxies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDBProxiesRequestT = Model::DescribeDBProxiesRequest>
  void DescribeDBProxiesAsync(const DescribeDBProxiesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeDBProxiesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBProxyEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDBProxyEndpointsRequestT = Model::DescribeDBProxyEndpointsRequest>
  Model::DescribeDBProxyEndpointsOutcomeCallable DescribeDBProxyEndpointsCallable(
      const DescribeDBProxyEndpointsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBProxyEndpoints, request);
  }

  /**
   * An Async wrapper for DescribeDBProxyEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBProxyEndpointsRequestT = Model::DescribeDBProxyEndpointsRequest>
  void DescribeDBProxyEndpointsAsync(const DescribeDBProxyEndpointsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeDBProxyEndpointsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBProxyTargetGroupsOutcome DescribeDBProxyTargetGroups(
      const Model::DescribeDBProxyTargetGroupsRequest& request) const;

  /**
   * A Callable wrapper for DescribeDBProxyTargetGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDBProxyTargetGroupsRequestT = Model::DescribeDBProxyTargetGroupsRequest>
  Model::DescribeDBProxyTargetGroupsOutcomeCallable DescribeDBProxyTargetGroupsCallable(
      const DescribeDBProxyTargetGroupsRequestT& request) const {
    return SubmitCallable(&RDSClient::DescribeDBProxyTargetGroups, request);
  }

  /**
   * An Async wrapper for DescribeDBProxyTargetGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBProxyTargetGroupsRequestT = Model::DescribeDBProxyTargetGroupsRequest>
  void DescribeDBProxyTargetGroupsAsync(const DescribeDBProxyTargetGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeDBProxyTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDBProxyTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBProxyTargetsRequestT = Model::DescribeDBProxyTargetsRequest>
  void DescribeDBProxyTargetsAsync(const DescribeDBProxyTargetsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBRecommendationsOutcome DescribeDBRecommendations(
      const Model::DescribeDBRecommendationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDBRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDBRecommendationsRequestT = Model::DescribeDBRecommendationsRequest>
  Model::DescribeDBRecommendationsOutcomeCallable DescribeDBRecommendationsCallable(
      const DescribeDBRecommendationsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBRecommendations, request);
  }

  /**
   * An Async wrapper for DescribeDBRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBRecommendationsRequestT = Model::DescribeDBRecommendationsRequest>
  void DescribeDBRecommendationsAsync(const DescribeDBRecommendationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeDBRecommendationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBSecurityGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDBSecurityGroupsRequestT = Model::DescribeDBSecurityGroupsRequest>
  Model::DescribeDBSecurityGroupsOutcomeCallable DescribeDBSecurityGroupsCallable(
      const DescribeDBSecurityGroupsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBSecurityGroups, request);
  }

  /**
   * An Async wrapper for DescribeDBSecurityGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBSecurityGroupsRequestT = Model::DescribeDBSecurityGroupsRequest>
  void DescribeDBSecurityGroupsAsync(const DescribeDBSecurityGroupsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeDBSecurityGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBShardGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDBShardGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBShardGroupsRequestT = Model::DescribeDBShardGroupsRequest>
  void DescribeDBShardGroupsAsync(const DescribeDBShardGroupsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeDBShardGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBSnapshotAttributesOutcome DescribeDBSnapshotAttributes(
      const Model::DescribeDBSnapshotAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeDBSnapshotAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDBSnapshotAttributesRequestT = Model::DescribeDBSnapshotAttributesRequest>
  Model::DescribeDBSnapshotAttributesOutcomeCallable DescribeDBSnapshotAttributesCallable(
      const DescribeDBSnapshotAttributesRequestT& request) const {
    return SubmitCallable(&RDSClient::DescribeDBSnapshotAttributes, request);
  }

  /**
   * An Async wrapper for DescribeDBSnapshotAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDBSnapshotAttributesRequestT = Model::DescribeDBSnapshotAttributesRequest>
  void DescribeDBSnapshotAttributesAsync(const DescribeDBSnapshotAttributesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDBSnapshotTenantDatabasesOutcome DescribeDBSnapshotTenantDatabases(
      const Model::DescribeDBSnapshotTenantDatabasesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDBSnapshotTenantDatabases that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDBSnapshotTenantDatabasesRequestT = Model::DescribeDBSnapshotTenantDatabasesRequest>
  Model::DescribeDBSnapshotTenantDatabasesOutcomeCallable DescribeDBSnapshotTenantDatabasesCallable(
      const DescribeDBSnapshotTenantDatabasesRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeDBSnapshotTenantDatabases, request);
  }

  /**
   * An Async wrapper for DescribeDBSnapshotTenantDatabases that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDBSnapshotTenantDatabasesRequestT = Model::DescribeDBSnapshotTenantDatabasesRequest>
  void DescribeDBSnapshotTenantDatabasesAsync(const DescribeDBSnapshotTenantDatabasesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeDBSnapshotTenantDatabasesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDBSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDBSnapshots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDBSnapshotsRequestT = Model::DescribeDBSnapshotsRequest>
  void DescribeDBSnapshotsAsync(const DescribeDBSnapshotsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeDBSnapshotsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOptionGroupOptionsOutcome DescribeOptionGroupOptions(
      const Model::DescribeOptionGroupOptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeOptionGroupOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOptionGroupOptionsRequestT = Model::DescribeOptionGroupOptionsRequest>
  Model::DescribeOptionGroupOptionsOutcomeCallable DescribeOptionGroupOptionsCallable(
      const DescribeOptionGroupOptionsRequestT& request) const {
    return SubmitCallable(&RDSClient::DescribeOptionGroupOptions, request);
  }

  /**
   * An Async wrapper for DescribeOptionGroupOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOptionGroupOptionsRequestT = Model::DescribeOptionGroupOptionsRequest>
  void DescribeOptionGroupOptionsAsync(const DescribeOptionGroupOptionsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeOptionGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOptionGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOptionGroupsRequestT = Model::DescribeOptionGroupsRequest>
  void DescribeOptionGroupsAsync(const DescribeOptionGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeOptionGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReservedDBInstancesOutcome DescribeReservedDBInstances(
      const Model::DescribeReservedDBInstancesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedDBInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReservedDBInstancesRequestT = Model::DescribeReservedDBInstancesRequest>
  Model::DescribeReservedDBInstancesOutcomeCallable DescribeReservedDBInstancesCallable(
      const DescribeReservedDBInstancesRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeReservedDBInstances, request);
  }

  /**
   * An Async wrapper for DescribeReservedDBInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReservedDBInstancesRequestT = Model::DescribeReservedDBInstancesRequest>
  void DescribeReservedDBInstancesAsync(const DescribeReservedDBInstancesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeReservedDBInstancesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReservedDBInstancesOfferingsOutcome DescribeReservedDBInstancesOfferings(
      const Model::DescribeReservedDBInstancesOfferingsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedDBInstancesOfferings that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeReservedDBInstancesOfferingsRequestT = Model::DescribeReservedDBInstancesOfferingsRequest>
  Model::DescribeReservedDBInstancesOfferingsOutcomeCallable DescribeReservedDBInstancesOfferingsCallable(
      const DescribeReservedDBInstancesOfferingsRequestT& request = {}) const {
    return SubmitCallable(&RDSClient::DescribeReservedDBInstancesOfferings, request);
  }

  /**
   * An Async wrapper for DescribeReservedDBInstancesOfferings that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeReservedDBInstancesOfferingsRequestT = Model::DescribeReservedDBInstancesOfferingsRequest>
  void DescribeReservedDBInstancesOfferingsAsync(const DescribeReservedDBInstancesOfferingsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const DescribeReservedDBInstancesOfferingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSourceRegions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSourceRegions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSourceRegionsRequestT = Model::DescribeSourceRegionsRequest>
  void DescribeSourceRegionsAsync(const DescribeSourceRegionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeSourceRegionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeTenantDatabases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTenantDatabases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTenantDatabasesRequestT = Model::DescribeTenantDatabasesRequest>
  void DescribeTenantDatabasesAsync(const DescribeTenantDatabasesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeTenantDatabasesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisableHttpEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableHttpEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableHttpEndpointRequestT = Model::DisableHttpEndpointRequest>
  void DisableHttpEndpointAsync(const DisableHttpEndpointRequestT& request, const DisableHttpEndpointResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DownloadDBLogFilePortion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DownloadDBLogFilePortion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DownloadDBLogFilePortionRequestT = Model::DownloadDBLogFilePortionRequest>
  void DownloadDBLogFilePortionAsync(const DownloadDBLogFilePortionRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableHttpEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableHttpEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableHttpEndpointRequestT = Model::EnableHttpEndpointRequest>
  void EnableHttpEndpointAsync(const EnableHttpEndpointRequestT& request, const EnableHttpEndpointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename FailoverDBClusterRequestT = Model::FailoverDBClusterRequest>
  void FailoverDBClusterAsync(const FailoverDBClusterRequestT& request, const FailoverDBClusterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyActivityStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyActivityStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyActivityStreamRequestT = Model::ModifyActivityStreamRequest>
  void ModifyActivityStreamAsync(const ModifyActivityStreamResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ModifyActivityStreamRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ModifyCertificates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyCertificates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyCertificatesRequestT = Model::ModifyCertificatesRequest>
  void ModifyCertificatesAsync(const ModifyCertificatesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ModifyCertificatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyCurrentDBClusterCapacityOutcome ModifyCurrentDBClusterCapacity(
      const Model::ModifyCurrentDBClusterCapacityRequest& request) const;

  /**
   * A Callable wrapper for ModifyCurrentDBClusterCapacity that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyCurrentDBClusterCapacityRequestT = Model::ModifyCurrentDBClusterCapacityRequest>
  Model::ModifyCurrentDBClusterCapacityOutcomeCallable ModifyCurrentDBClusterCapacityCallable(
      const ModifyCurrentDBClusterCapacityRequestT& request) const {
    return SubmitCallable(&RDSClient::ModifyCurrentDBClusterCapacity, request);
  }

  /**
   * An Async wrapper for ModifyCurrentDBClusterCapacity that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ModifyCurrentDBClusterCapacityRequestT = Model::ModifyCurrentDBClusterCapacityRequest>
  void ModifyCurrentDBClusterCapacityAsync(const ModifyCurrentDBClusterCapacityRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyCustomDBEngineVersionOutcome ModifyCustomDBEngineVersion(
      const Model::ModifyCustomDBEngineVersionRequest& request) const;

  /**
   * A Callable wrapper for ModifyCustomDBEngineVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyCustomDBEngineVersionRequestT = Model::ModifyCustomDBEngineVersionRequest>
  Model::ModifyCustomDBEngineVersionOutcomeCallable ModifyCustomDBEngineVersionCallable(
      const ModifyCustomDBEngineVersionRequestT& request) const {
    return SubmitCallable(&RDSClient::ModifyCustomDBEngineVersion, request);
  }

  /**
   * An Async wrapper for ModifyCustomDBEngineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyCustomDBEngineVersionRequestT = Model::ModifyCustomDBEngineVersionRequest>
  void ModifyCustomDBEngineVersionAsync(const ModifyCustomDBEngineVersionRequestT& request,
                                        const ModifyCustomDBEngineVersionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * parameters can be modified in a single request.</p>  <p>There are two
   * types of parameters - dynamic parameters and static parameters. Changes to
   * dynamic parameters are applied to the DB cluster immediately without a reboot.
   * Changes to static parameters are applied only after the DB cluster is rebooted,
   * which can be done using <code>RebootDBCluster</code> operation. You can use the
   ...
   * cluster parameter group has been created or modified.</p>  <p>For
  ...
  /**
   * An Async wrapper for ModifyDBProxy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyDBProxyRequestT = Model::ModifyDBProxyRequest>
  void ModifyDBProxyAsync(const ModifyDBProxyRequestT& request, const ModifyDBProxyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDBProxyEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDBProxyEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyDBProxyEndpointRequestT = Model::ModifyDBProxyEndpointRequest>
  void ModifyDBProxyEndpointAsync(const ModifyDBProxyEndpointRequestT& request, const ModifyDBProxyEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDBProxyTargetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDBProxyTargetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyDBProxyTargetGroupRequestT = Model::ModifyDBProxyTargetGroupRequest>
  void ModifyDBProxyTargetGroupAsync(const ModifyDBProxyTargetGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyDBRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDBRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyDBRecommendationRequestT = Model::ModifyDBRecommendationRequest>
  void ModifyDBRecommendationAsync(const ModifyDBRecommendationRequestT& request,
                                   const ModifyDBRecommendationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDBShardGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDBShardGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyDBShardGroupRequestT = Model::ModifyDBShardGroupRequest>
  void ModifyDBShardGroupAsync(const ModifyDBShardGroupRequestT& request, const ModifyDBShardGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDBSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyDBSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyDBSnapshotRequestT = Model::ModifyDBSnapshotRequest>
  void ModifyDBSnapshotAsync(const ModifyDBSnapshotRequestT& request, const ModifyDBSnapshotResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyDBSnapshotAttribute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyDBSnapshotAttributeRequestT = Model::ModifyDBSnapshotAttributeRequest>
  Model::ModifyDBSnapshotAttributeOutcomeCallable ModifyDBSnapshotAttributeCallable(
      const ModifyDBSnapshotAttributeRequestT& request) const {
    return SubmitCallable(&RDSClient::ModifyDBSnapshotAttribute, request);
  }

  /**
   * An Async wrapper for ModifyDBSnapshotAttribute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyDBSnapshotAttributeRequestT = Model::ModifyDBSnapshotAttributeRequest>
  void ModifyDBSnapshotAttributeAsync(const ModifyDBSnapshotAttributeRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyOptionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyOptionGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyOptionGroupRequestT = Model::ModifyOptionGroupRequest>
  void ModifyOptionGroupAsync(const ModifyOptionGroupRequestT& request, const ModifyOptionGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyTenantDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyTenantDatabase that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyTenantDatabaseRequestT = Model::ModifyTenantDatabaseRequest>
  void ModifyTenantDatabaseAsync(const ModifyTenantDatabaseRequestT& request, const ModifyTenantDatabaseResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PromoteReadReplica that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PromoteReadReplica that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PromoteReadReplicaRequestT = Model::PromoteReadReplicaRequest>
  void PromoteReadReplicaAsync(const PromoteReadReplicaRequestT& request, const PromoteReadReplicaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PurchaseReservedDBInstancesOfferingOutcome PurchaseReservedDBInstancesOffering(
      const Model::PurchaseReservedDBInstancesOfferingRequest& request) const;

  /**
   * A Callable wrapper for PurchaseReservedDBInstancesOffering that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PurchaseReservedDBInstancesOfferingRequestT = Model::PurchaseReservedDBInstancesOfferingRequest>
  Model::PurchaseReservedDBInstancesOfferingOutcomeCallable PurchaseReservedDBInstancesOfferingCallable(
      const PurchaseReservedDBInstancesOfferingRequestT& request) const {
    return SubmitCallable(&RDSClient::PurchaseReservedDBInstancesOffering, request);
  }

  /**
   * An Async wrapper for PurchaseReservedDBInstancesOffering that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PurchaseReservedDBInstancesOfferingRequestT = Model::PurchaseReservedDBInstancesOfferingRequest>
  void PurchaseReservedDBInstancesOfferingAsync(const PurchaseReservedDBInstancesOfferingRequestT& request,
  ...
  /**
   * A Callable wrapper for RebootDBShardGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebootDBShardGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebootDBShardGroupRequestT = Model::RebootDBShardGroupRequest>
  void RebootDBShardGroupAsync(const RebootDBShardGroupRequestT& request, const RebootDBShardGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterDBProxyTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterDBProxyTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterDBProxyTargetsRequestT = Model::RegisterDBProxyTargetsRequest>
  void RegisterDBProxyTargetsAsync(const RegisterDBProxyTargetsRequestT& request,
  ...
  /**
   * A Callable wrapper for RemoveRoleFromDBInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveRoleFromDBInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveRoleFromDBInstanceRequestT = Model::RemoveRoleFromDBInstanceRequest>
  void RemoveRoleFromDBInstanceAsync(const RemoveRoleFromDBInstanceRequestT& request,
  ...
  /**
   * A Callable wrapper for RestoreDBClusterFromS3 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreDBClusterFromS3 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreDBClusterFromS3RequestT = Model::RestoreDBClusterFromS3Request>
  void RestoreDBClusterFromS3Async(const RestoreDBClusterFromS3RequestT& request,
                                   const RestoreDBClusterFromS3ResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreDBInstanceFromDBSnapshotOutcome RestoreDBInstanceFromDBSnapshot(
      const Model::RestoreDBInstanceFromDBSnapshotRequest& request) const;

  /**
   * A Callable wrapper for RestoreDBInstanceFromDBSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreDBInstanceFromDBSnapshotRequestT = Model::RestoreDBInstanceFromDBSnapshotRequest>
  Model::RestoreDBInstanceFromDBSnapshotOutcomeCallable RestoreDBInstanceFromDBSnapshotCallable(
      const RestoreDBInstanceFromDBSnapshotRequestT& request) const {
    return SubmitCallable(&RDSClient::RestoreDBInstanceFromDBSnapshot, request);
  }

  /**
   * An Async wrapper for RestoreDBInstanceFromDBSnapshot that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RestoreDBInstanceFromDBSnapshotRequestT = Model::RestoreDBInstanceFromDBSnapshotRequest>
  void RestoreDBInstanceFromDBSnapshotAsync(const RestoreDBInstanceFromDBSnapshotRequestT& request,
                                            const RestoreDBInstanceFromDBSnapshotResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreDBInstanceFromS3 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreDBInstanceFromS3 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreDBInstanceFromS3RequestT = Model::RestoreDBInstanceFromS3Request>
  void RestoreDBInstanceFromS3Async(const RestoreDBInstanceFromS3RequestT& request,
                                    const RestoreDBInstanceFromS3ResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreDBInstanceToPointInTimeOutcome RestoreDBInstanceToPointInTime(
      const Model::RestoreDBInstanceToPointInTimeRequest& request) const;

  /**
   * A Callable wrapper for RestoreDBInstanceToPointInTime that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreDBInstanceToPointInTimeRequestT = Model::RestoreDBInstanceToPointInTimeRequest>
  Model::RestoreDBInstanceToPointInTimeOutcomeCallable RestoreDBInstanceToPointInTimeCallable(
      const RestoreDBInstanceToPointInTimeRequestT& request) const {
    return SubmitCallable(&RDSClient::RestoreDBInstanceToPointInTime, request);
  }

  /**
   * An Async wrapper for RestoreDBInstanceToPointInTime that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RestoreDBInstanceToPointInTimeRequestT = Model::RestoreDBInstanceToPointInTimeRequest>
  void RestoreDBInstanceToPointInTimeAsync(const RestoreDBInstanceToPointInTimeRequestT& request,
                                           const RestoreDBInstanceToPointInTimeResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RevokeDBSecurityGroupIngressOutcome RevokeDBSecurityGroupIngress(
      const Model::RevokeDBSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for RevokeDBSecurityGroupIngress that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RevokeDBSecurityGroupIngressRequestT = Model::RevokeDBSecurityGroupIngressRequest>
  Model::RevokeDBSecurityGroupIngressOutcomeCallable RevokeDBSecurityGroupIngressCallable(
      const RevokeDBSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&RDSClient::RevokeDBSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for RevokeDBSecurityGroupIngress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RevokeDBSecurityGroupIngressRequestT = Model::RevokeDBSecurityGroupIngressRequest>
  void RevokeDBSecurityGroupIngressAsync(const RevokeDBSecurityGroupIngressRequestT& request,
                                         const RevokeDBSecurityGroupIngressResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartActivityStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartActivityStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartActivityStreamRequestT = Model::StartActivityStreamRequest>
  void StartActivityStreamAsync(const StartActivityStreamRequestT& request, const StartActivityStreamResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartDBInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartDBInstanceRequestT = Model::StartDBInstanceRequest>
  void StartDBInstanceAsync(const StartDBInstanceRequestT& request, const StartDBInstanceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDBInstanceAutomatedBackupsReplicationOutcome StartDBInstanceAutomatedBackupsReplication(
      const Model::StartDBInstanceAutomatedBackupsReplicationRequest& request) const;

  /**
   * A Callable wrapper for StartDBInstanceAutomatedBackupsReplication that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::StartDBInstanceAutomatedBackupsReplicationOutcomeCallable StartDBInstanceAutomatedBackupsReplicationCallable(
      const StartDBInstanceAutomatedBackupsReplicationRequestT& request) const {
    return SubmitCallable(&RDSClient::StartDBInstanceAutomatedBackupsReplication, request);
  }

  /**
   * An Async wrapper for StartDBInstanceAutomatedBackupsReplication that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartDBInstanceAutomatedBackupsReplicationRequestT = Model::StartDBInstanceAutomatedBackupsReplicationRequest>
  void StartDBInstanceAutomatedBackupsReplicationAsync(
      const StartDBInstanceAutomatedBackupsReplicationRequestT& request,
      const StartDBInstanceAutomatedBackupsReplicationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * data from RDS Custom DB instances. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RDS_Fea_Regions_DB-eng.Feature.ExportSnapshotToS3.html">
   * Supported Regions and DB engines for exporting snapshots to S3 in Amazon
   * RDS</a>.</p> <p>For more information on exporting DB snapshot data, see <a
  ...
  /**
   * A Callable wrapper for StopActivityStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopActivityStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopActivityStreamRequestT = Model::StopActivityStreamRequest>
  void StopActivityStreamAsync(const StopActivityStreamRequestT& request, const StopActivityStreamResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopDBInstance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopDBInstanceRequestT = Model::StopDBInstanceRequest>
  void StopDBInstanceAsync(const StopDBInstanceRequestT& request, const StopDBInstanceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StopDBInstanceAutomatedBackupsReplicationOutcome StopDBInstanceAutomatedBackupsReplication(
      const Model::StopDBInstanceAutomatedBackupsReplicationRequest& request) const;

  /**
   * A Callable wrapper for StopDBInstanceAutomatedBackupsReplication that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::StopDBInstanceAutomatedBackupsReplicationOutcomeCallable StopDBInstanceAutomatedBackupsReplicationCallable(
      const StopDBInstanceAutomatedBackupsReplicationRequestT& request) const {
    return SubmitCallable(&RDSClient::StopDBInstanceAutomatedBackupsReplication, request);
  }

  /**
   * An Async wrapper for StopDBInstanceAutomatedBackupsReplication that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StopDBInstanceAutomatedBackupsReplicationRequestT = Model::StopDBInstanceAutomatedBackupsReplicationRequest>
  void StopDBInstanceAutomatedBackupsReplicationAsync(
      const StopDBInstanceAutomatedBackupsReplicationRequestT& request,
      const StopDBInstanceAutomatedBackupsReplicationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SwitchoverBlueGreenDeploymentOutcome SwitchoverBlueGreenDeployment(
      const Model::SwitchoverBlueGreenDeploymentRequest& request) const;

  /**
   * A Callable wrapper for SwitchoverBlueGreenDeployment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SwitchoverBlueGreenDeploymentRequestT = Model::SwitchoverBlueGreenDeploymentRequest>
  Model::SwitchoverBlueGreenDeploymentOutcomeCallable SwitchoverBlueGreenDeploymentCallable(
      const SwitchoverBlueGreenDeploymentRequestT& request) const {
    return SubmitCallable(&RDSClient::SwitchoverBlueGreenDeployment, request);
  }

  /**
   * An Async wrapper for SwitchoverBlueGreenDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SwitchoverBlueGreenDeploymentRequestT = Model::SwitchoverBlueGreenDeploymentRequest>
  void SwitchoverBlueGreenDeploymentAsync(const SwitchoverBlueGreenDeploymentRequestT& request,
                                          const SwitchoverBlueGreenDeploymentResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SwitchoverReadReplica that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SwitchoverReadReplica that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SwitchoverReadReplicaRequestT = Model::SwitchoverReadReplicaRequest>
  void SwitchoverReadReplicaAsync(const SwitchoverReadReplicaRequestT& request, const SwitchoverReadReplicaResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
