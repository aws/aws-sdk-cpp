...
class TenantDatabase {
 public:
  ...
  void SetTenantDatabaseARN(TenantDatabaseARNT&& value) {
    ...
    m_tenantDatabaseARN = std::forward<TenantDatabaseARNT>(value);
  }
  template <typename TenantDatabaseARNT = Aws::String>
  TenantDatabase& WithTenantDatabaseARN(TenantDatabaseARNT&& value) {
    SetTenantDatabaseARN(std::forward<TenantDatabaseARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline TenantDatabase& WithDeletionProtection(bool value) {
