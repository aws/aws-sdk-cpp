...
class StopActivityStreamResult {
 public:
  ...
  template <typename KmsKeyIdT = Aws::String>
  StopActivityStreamResult& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename KinesisStreamNameT = Aws::String>
  StopActivityStreamResult& WithKinesisStreamName(KinesisStreamNameT&& value) {
  ...
  inline StopActivityStreamResult& WithStatus(ActivityStreamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StopActivityStreamResult& WithResponseMetadata(ResponseMetadataT&& value) {
