...
class DBRecommendation {
 public:
  ...
  void SetTypeId(TypeIdT&& value) {
    ...
    m_typeId = std::forward<TypeIdT>(value);
  }
  template <typename TypeIdT = Aws::String>
  DBRecommendation& WithTypeId(TypeIdT&& value) {
    SetTypeId(std::forward<TypeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTypeDetection(TypeDetectionT&& value) {
    ...
    m_typeDetection = std::forward<TypeDetectionT>(value);
  }
  template <typename TypeDetectionT = Aws::String>
  DBRecommendation& WithTypeDetection(TypeDetectionT&& value) {
    SetTypeDetection(std::forward<TypeDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTypeRecommendation(TypeRecommendationT&& value) {
    ...
    m_typeRecommendation = std::forward<TypeRecommendationT>(value);
  }
  template <typename TypeRecommendationT = Aws::String>
  DBRecommendation& WithTypeRecommendation(TypeRecommendationT&& value) {
    SetTypeRecommendation(std::forward<TypeRecommendationT>(value));
    return *this;
  }
  ///@}
