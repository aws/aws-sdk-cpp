...
class MetricReference {
 public:
  ...
  template <typename NameT = Aws::String>
  MetricReference& WithName(NameT&& value) {
  ...
  void SetReferenceDetails(ReferenceDetailsT&& value) {
    m_referenceDetailsHasBeenSet = true;
    m_referenceDetails = std::forward<ReferenceDetailsT>(value);
  }
  template <typename ReferenceDetailsT = ReferenceDetails>
  MetricReference& WithReferenceDetails(ReferenceDetailsT&& value) {
    SetReferenceDetails(std::forward<ReferenceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
