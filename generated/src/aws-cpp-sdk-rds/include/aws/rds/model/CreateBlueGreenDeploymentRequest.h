...
class CreateBlueGreenDeploymentRequest : public RDSRequest {
 ...
 public:
  ...
  void SetTargetEngineVersion(TargetEngineVersionT&& value) {
    m_targetEngineVersionHasBeenSet = true;
    m_targetEngineVersion = std::forward<TargetEngineVersionT>(value);
  }
  template <typename TargetEngineVersionT = Aws::String>
  CreateBlueGreenDeploymentRequest& WithTargetEngineVersion(TargetEngineVersionT&& value) {
    SetTargetEngineVersion(std::forward<TargetEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBParameterGroupName(TargetDBParameterGroupNameT&& value) {
    m_targetDBParameterGroupNameHasBeenSet = true;
    m_targetDBParameterGroupName = std::forward<TargetDBParameterGroupNameT>(value);
  }
  template <typename TargetDBParameterGroupNameT = Aws::String>
  CreateBlueGreenDeploymentRequest& WithTargetDBParameterGroupName(TargetDBParameterGroupNameT&& value) {
    SetTargetDBParameterGroupName(std::forward<TargetDBParameterGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBClusterParameterGroupName(TargetDBClusterParameterGroupNameT&& value) {
    m_targetDBClusterParameterGroupNameHasBeenSet = true;
    m_targetDBClusterParameterGroupName = std::forward<TargetDBClusterParameterGroupNameT>(value);
  }
  template <typename TargetDBClusterParameterGroupNameT = Aws::String>
  CreateBlueGreenDeploymentRequest& WithTargetDBClusterParameterGroupName(TargetDBClusterParameterGroupNameT&& value) {
    SetTargetDBClusterParameterGroupName(std::forward<TargetDBClusterParameterGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetDBInstanceClass(TargetDBInstanceClassT&& value) {
    m_targetDBInstanceClassHasBeenSet = true;
    m_targetDBInstanceClass = std::forward<TargetDBInstanceClassT>(value);
  }
  template <typename TargetDBInstanceClassT = Aws::String>
  CreateBlueGreenDeploymentRequest& WithTargetDBInstanceClass(TargetDBInstanceClassT&& value) {
    SetTargetDBInstanceClass(std::forward<TargetDBInstanceClassT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUpgradeTargetStorageConfig(bool value) {
    m_upgradeTargetStorageConfigHasBeenSet = true;
    m_upgradeTargetStorageConfig = value;
  }
  inline CreateBlueGreenDeploymentRequest& WithUpgradeTargetStorageConfig(bool value) {
    SetUpgradeTargetStorageConfig(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetIops(int value) {
    m_targetIopsHasBeenSet = true;
    m_targetIops = value;
  }
  inline CreateBlueGreenDeploymentRequest& WithTargetIops(int value) {
    SetTargetIops(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetStorageType(TargetStorageTypeT&& value) {
    m_targetStorageTypeHasBeenSet = true;
    m_targetStorageType = std::forward<TargetStorageTypeT>(value);
  }
  template <typename TargetStorageTypeT = Aws::String>
  CreateBlueGreenDeploymentRequest& WithTargetStorageType(TargetStorageTypeT&& value) {
    SetTargetStorageType(std::forward<TargetStorageTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetAllocatedStorage(int value) {
    m_targetAllocatedStorageHasBeenSet = true;
    m_targetAllocatedStorage = value;
  }
  inline CreateBlueGreenDeploymentRequest& WithTargetAllocatedStorage(int value) {
    SetTargetAllocatedStorage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetStorageThroughput(int value) {
    m_targetStorageThroughputHasBeenSet = true;
    m_targetStorageThroughput = value;
  }
  inline CreateBlueGreenDeploymentRequest& WithTargetStorageThroughput(int value) {
    SetTargetStorageThroughput(value);
    return *this;
  }
  ///@}
 private:
