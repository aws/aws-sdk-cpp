...
class OptionGroupOption {
 public:
  ...
  void SetMinimumRequiredMinorEngineVersion(MinimumRequiredMinorEngineVersionT&& value) {
    ...
    m_minimumRequiredMinorEngineVersion = std::forward<MinimumRequiredMinorEngineVersionT>(value);
  }
  template <typename MinimumRequiredMinorEngineVersionT = Aws::String>
  OptionGroupOption& WithMinimumRequiredMinorEngineVersion(MinimumRequiredMinorEngineVersionT&& value) {
    SetMinimumRequiredMinorEngineVersion(std::forward<MinimumRequiredMinorEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPortRequired(bool value) {
    m_portRequiredHasBeenSet = true;
    m_portRequired = value;
  }
  inline OptionGroupOption& WithPortRequired(bool value) {
    SetPortRequired(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultPort(int value) {
    m_defaultPortHasBeenSet = true;
    m_defaultPort = value;
  }
  inline OptionGroupOption& WithDefaultPort(int value) {
  ...
  void SetOptionsDependedOn(OptionsDependedOnT&& value) {
    ...
    m_optionsDependedOn = std::forward<OptionsDependedOnT>(value);
  }
  template <typename OptionsDependedOnT = Aws::Vector<Aws::String>>
  OptionGroupOption& WithOptionsDependedOn(OptionsDependedOnT&& value) {
    SetOptionsDependedOn(std::forward<OptionsDependedOnT>(value));
    return *this;
  }
  template <typename OptionsDependedOnT = Aws::String>
  OptionGroupOption& AddOptionsDependedOn(OptionsDependedOnT&& value) {
    m_optionsDependedOnHasBeenSet = true;
    m_optionsDependedOn.emplace_back(std::forward<OptionsDependedOnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptionsConflictsWith(OptionsConflictsWithT&& value) {
    ...
    m_optionsConflictsWith = std::forward<OptionsConflictsWithT>(value);
  }
  template <typename OptionsConflictsWithT = Aws::Vector<Aws::String>>
  OptionGroupOption& WithOptionsConflictsWith(OptionsConflictsWithT&& value) {
    SetOptionsConflictsWith(std::forward<OptionsConflictsWithT>(value));
    return *this;
  }
  template <typename OptionsConflictsWithT = Aws::String>
  OptionGroupOption& AddOptionsConflictsWith(OptionsConflictsWithT&& value) {
    m_optionsConflictsWithHasBeenSet = true;
    m_optionsConflictsWith.emplace_back(std::forward<OptionsConflictsWithT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPersistent(bool value) {
    m_persistentHasBeenSet = true;
    m_persistent = value;
  }
  inline OptionGroupOption& WithPersistent(bool value) {
    SetPersistent(value);
    return *this;
  }
  ///@}
  ...
  inline OptionGroupOption& WithPermanent(bool value) {
    SetPermanent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequiresAutoMinorEngineVersionUpgrade(bool value) {
    m_requiresAutoMinorEngineVersionUpgradeHasBeenSet = true;
    m_requiresAutoMinorEngineVersionUpgrade = value;
  }
  inline OptionGroupOption& WithRequiresAutoMinorEngineVersionUpgrade(bool value) {
    SetRequiresAutoMinorEngineVersionUpgrade(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVpcOnly(bool value) {
    m_vpcOnlyHasBeenSet = true;
    m_vpcOnly = value;
  }
  inline OptionGroupOption& WithVpcOnly(bool value) {
    SetVpcOnly(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSupportsOptionVersionDowngrade(bool value) {
    m_supportsOptionVersionDowngradeHasBeenSet = true;
    m_supportsOptionVersionDowngrade = value;
  }
  inline OptionGroupOption& WithSupportsOptionVersionDowngrade(bool value) {
    SetSupportsOptionVersionDowngrade(value);
    return *this;
  }
  ///@}
  ...
  void SetOptionGroupOptionSettings(OptionGroupOptionSettingsT&& value) {
    ...
    m_optionGroupOptionSettings = std::forward<OptionGroupOptionSettingsT>(value);
  }
  template <typename OptionGroupOptionSettingsT = Aws::Vector<OptionGroupOptionSetting>>
  OptionGroupOption& WithOptionGroupOptionSettings(OptionGroupOptionSettingsT&& value) {
    SetOptionGroupOptionSettings(std::forward<OptionGroupOptionSettingsT>(value));
    return *this;
  }
  ...
  OptionGroupOption& AddOptionGroupOptionSettings(OptionGroupOptionSettingsT&& value) {
    m_optionGroupOptionSettingsHasBeenSet = true;
    m_optionGroupOptionSettings.emplace_back(std::forward<OptionGroupOptionSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptionGroupOptionVersions(OptionGroupOptionVersionsT&& value) {
    ...
    m_optionGroupOptionVersions = std::forward<OptionGroupOptionVersionsT>(value);
  }
  template <typename OptionGroupOptionVersionsT = Aws::Vector<OptionVersion>>
  OptionGroupOption& WithOptionGroupOptionVersions(OptionGroupOptionVersionsT&& value) {
    SetOptionGroupOptionVersions(std::forward<OptionGroupOptionVersionsT>(value));
    return *this;
  }
  ...
  OptionGroupOption& AddOptionGroupOptionVersions(OptionGroupOptionVersionsT&& value) {
    m_optionGroupOptionVersionsHasBeenSet = true;
    m_optionGroupOptionVersions.emplace_back(std::forward<OptionGroupOptionVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCopyableCrossAccount(bool value) {
    m_copyableCrossAccountHasBeenSet = true;
    m_copyableCrossAccount = value;
  }
  inline OptionGroupOption& WithCopyableCrossAccount(bool value) {
    SetCopyableCrossAccount(value);
    return *this;
  }
  ///@}
 private:
