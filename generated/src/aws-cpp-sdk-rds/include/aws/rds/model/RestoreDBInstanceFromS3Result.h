...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API RestoreDBInstanceFromS3Result() = default;
    ...
    template<typename DBInstanceT = DBInstance>
    RestoreDBInstanceFromS3Result& WithDBInstance(DBInstanceT&& value) { SetDBInstance(std::forward<DBInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RestoreDBInstanceFromS3Result& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
