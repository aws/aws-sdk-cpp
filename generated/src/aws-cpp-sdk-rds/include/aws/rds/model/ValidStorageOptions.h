...
class ValidStorageOptions {
 public:
  ...
  void SetProvisionedStorageThroughput(ProvisionedStorageThroughputT&& value) {
    ...
    m_provisionedStorageThroughput = std::forward<ProvisionedStorageThroughputT>(value);
  }
  template <typename ProvisionedStorageThroughputT = Aws::Vector<Range>>
  ValidStorageOptions& WithProvisionedStorageThroughput(ProvisionedStorageThroughputT&& value) {
    SetProvisionedStorageThroughput(std::forward<ProvisionedStorageThroughputT>(value));
    return *this;
  }
  ...
  ValidStorageOptions& AddProvisionedStorageThroughput(ProvisionedStorageThroughputT&& value) {
    m_provisionedStorageThroughputHasBeenSet = true;
    m_provisionedStorageThroughput.emplace_back(std::forward<ProvisionedStorageThroughputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStorageThroughputToIopsRatio(StorageThroughputToIopsRatioT&& value) {
    ...
    m_storageThroughputToIopsRatio = std::forward<StorageThroughputToIopsRatioT>(value);
  }
  template <typename StorageThroughputToIopsRatioT = Aws::Vector<DoubleRange>>
  ValidStorageOptions& WithStorageThroughputToIopsRatio(StorageThroughputToIopsRatioT&& value) {
    SetStorageThroughputToIopsRatio(std::forward<StorageThroughputToIopsRatioT>(value));
    return *this;
  }
  ...
  ValidStorageOptions& AddStorageThroughputToIopsRatio(StorageThroughputToIopsRatioT&& value) {
    m_storageThroughputToIopsRatioHasBeenSet = true;
    m_storageThroughputToIopsRatio.emplace_back(std::forward<StorageThroughputToIopsRatioT>(value));
    return *this;
  }
  ///@}
  ...
  inline ValidStorageOptions& WithSupportsStorageAutoscaling(bool value) {
