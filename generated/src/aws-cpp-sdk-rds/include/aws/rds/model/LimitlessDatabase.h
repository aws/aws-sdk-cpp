...
class LimitlessDatabase {
 public:
  ...
  inline void SetStatus(LimitlessDatabaseStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LimitlessDatabase& WithStatus(LimitlessDatabaseStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinRequiredACU(double value) {
    m_minRequiredACUHasBeenSet = true;
    m_minRequiredACU = value;
  }
  inline LimitlessDatabase& WithMinRequiredACU(double value) {
    SetMinRequiredACU(value);
    return *this;
  }
  ///@}
 private:
