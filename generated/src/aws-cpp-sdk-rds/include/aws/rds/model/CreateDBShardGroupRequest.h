...
class CreateDBShardGroupRequest : public RDSRequest {
 ...
 public:
  ...
  inline CreateDBShardGroupRequest& WithComputeRedundancy(int value) {
  ...
  inline CreateDBShardGroupRequest& WithMaxACU(double value) {
    SetMaxACU(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBShardGroupRequest& WithMinACU(double value) {
    SetMinACU(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBShardGroupRequest& WithPubliclyAccessible(bool value) {
