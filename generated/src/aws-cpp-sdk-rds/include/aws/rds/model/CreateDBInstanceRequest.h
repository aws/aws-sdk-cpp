...
class CreateDBInstanceRequest : public RDSRequest {
 ...
 public:
  ...
  inline CreateDBInstanceRequest& WithStorageThroughput(int value) {
   ...
   * DB instance is controlled by its security group settings.</p> <p>When the DB
   * instance isn't publicly accessible, it is an internal DB instance with a DNS
   * name that resolves to a private IP address.</p> <p>The default behavior when
   ...
   * isn't specified, <code>PubliclyAccessible</code> defaults to <code>false</code>
   * for Aurora instances and <code>true</code> for non-Aurora instances.</p> <p>If
   * <code>DBSubnetGroup</code> is specified, <code>PubliclyAccessible</code>
   * defaults to <code>false</code> unless the value of <code>DBSubnetGroup</code> is
   * <code>default</code>, in which case <code>PubliclyAccessible</code> defaults to
   * <code>true</code>.</p> <p>If <code>PubliclyAccessible</code> is true and the VPC
   * that the <code>DBSubnetGroup</code> is in doesn't have an internet gateway
   * attached to it, Amazon RDS returns an error.</p>
   */
  ...
  inline CreateDBInstanceRequest& WithDatabaseInsightsMode(DatabaseInsightsMode value) {
  ...
  inline CreateDBInstanceRequest& WithPerformanceInsightsRetentionPeriod(int value) {
  ...
  inline CreateDBInstanceRequest& WithMaxAllocatedStorage(int value) {
  ...
  inline CreateDBInstanceRequest& WithEnableCustomerOwnedIp(bool value) {
  ...
  inline CreateDBInstanceRequest& WithManageMasterUserPassword(bool value) {
  ...
  inline CreateDBInstanceRequest& WithMultiTenant(bool value) {
  ...
  inline CreateDBInstanceRequest& WithDedicatedLogVolume(bool value) {
   ...
   * for PostgreSQL. For Amazon Aurora DB instances, the engine lifecycle support is
   * managed by the DB cluster.</p> <p>You can use this setting to enroll your DB
   * instance into Amazon RDS Extended Support. With RDS Extended Support, you can
   * run the selected major engine version on your DB instance past the end of
