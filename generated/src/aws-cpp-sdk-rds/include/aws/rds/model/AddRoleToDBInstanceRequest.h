...
class AddRoleToDBInstanceRequest : public RDSRequest {
 public:
  AWS_RDS_API AddRoleToDBInstanceRequest() = default;
 ...
 public:
  ...
  template <typename DBInstanceIdentifierT = Aws::String>
  AddRoleToDBInstanceRequest& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  AddRoleToDBInstanceRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename FeatureNameT = Aws::String>
  AddRoleToDBInstanceRequest& WithFeatureName(FeatureNameT&& value) {
