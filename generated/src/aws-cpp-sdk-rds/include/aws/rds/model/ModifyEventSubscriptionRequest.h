...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ModifyEventSubscriptionRequest : public RDSRequest
  {
  public:
    AWS_RDS_API ModifyEventSubscriptionRequest();
  ...
  public:
     ...
     * value isn't specified, all events are returned.</p> <p>Valid Values:<code>
