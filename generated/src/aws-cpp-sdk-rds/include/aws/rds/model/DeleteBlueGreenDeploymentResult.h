...
namespace Model
{
  ...
  public:
    ...
    template<typename BlueGreenDeploymentT = BlueGreenDeployment>
    DeleteBlueGreenDeploymentResult& WithBlueGreenDeployment(BlueGreenDeploymentT&& value) { SetBlueGreenDeployment(std::forward<BlueGreenDeploymentT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteBlueGreenDeploymentResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
