...
class DescribeOptionGroupsResult {
 public:
  ...
  void SetOptionGroupsList(OptionGroupsListT&& value) {
    m_optionGroupsListHasBeenSet = true;
    m_optionGroupsList = std::forward<OptionGroupsListT>(value);
  }
  template <typename OptionGroupsListT = Aws::Vector<OptionGroup>>
  DescribeOptionGroupsResult& WithOptionGroupsList(OptionGroupsListT&& value) {
    SetOptionGroupsList(std::forward<OptionGroupsListT>(value));
    return *this;
  }
  template <typename OptionGroupsListT = OptionGroup>
  DescribeOptionGroupsResult& AddOptionGroupsList(OptionGroupsListT&& value) {
    m_optionGroupsListHasBeenSet = true;
    m_optionGroupsList.emplace_back(std::forward<OptionGroupsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeOptionGroupsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeOptionGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
