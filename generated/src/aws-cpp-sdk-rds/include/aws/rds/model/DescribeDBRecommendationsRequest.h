...
class DescribeDBRecommendationsRequest : public RDSRequest {
 ...
 public:
  ...
  void SetLastUpdatedAfter(LastUpdatedAfterT&& value) {
    m_lastUpdatedAfterHasBeenSet = true;
    m_lastUpdatedAfter = std::forward<LastUpdatedAfterT>(value);
  }
  template <typename LastUpdatedAfterT = Aws::Utils::DateTime>
  DescribeDBRecommendationsRequest& WithLastUpdatedAfter(LastUpdatedAfterT&& value) {
    SetLastUpdatedAfter(std::forward<LastUpdatedAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastUpdatedBefore(LastUpdatedBeforeT&& value) {
    m_lastUpdatedBeforeHasBeenSet = true;
    m_lastUpdatedBefore = std::forward<LastUpdatedBeforeT>(value);
  }
  template <typename LastUpdatedBeforeT = Aws::Utils::DateTime>
  DescribeDBRecommendationsRequest& WithLastUpdatedBefore(LastUpdatedBeforeT&& value) {
    SetLastUpdatedBefore(std::forward<LastUpdatedBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDBRecommendationsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
