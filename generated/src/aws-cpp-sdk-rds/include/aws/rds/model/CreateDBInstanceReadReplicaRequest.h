...
class CreateDBInstanceReadReplicaRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBInstanceIdentifierT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) {
  ...
  void SetSourceDBInstanceIdentifier(SourceDBInstanceIdentifierT&& value) {
    m_sourceDBInstanceIdentifierHasBeenSet = true;
    m_sourceDBInstanceIdentifier = std::forward<SourceDBInstanceIdentifierT>(value);
  }
  template <typename SourceDBInstanceIdentifierT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithSourceDBInstanceIdentifier(SourceDBInstanceIdentifierT&& value) {
    SetSourceDBInstanceIdentifier(std::forward<SourceDBInstanceIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DBInstanceClassT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDBInstanceClass(DBInstanceClassT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithStorageThroughput(int value) {
  ...
  template <typename OptionGroupNameT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithOptionGroupName(OptionGroupNameT&& value) {
  ...
  template <typename DBParameterGroupNameT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDBParameterGroupName(DBParameterGroupNameT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithPubliclyAccessible(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDBInstanceReadReplicaRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDBInstanceReadReplicaRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename DBSubnetGroupNameT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDBSubnetGroupName(DBSubnetGroupNameT&& value) {
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  CreateDBInstanceReadReplicaRequest& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  CreateDBInstanceReadReplicaRequest& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  template <typename StorageTypeT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithStorageType(StorageTypeT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithCopyTagsToSnapshot(bool value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithMonitoringInterval(int value) {
  ...
  template <typename MonitoringRoleArnT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithMonitoringRoleArn(MonitoringRoleArnT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename PreSignedUrlT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithPreSignedUrl(PreSignedUrlT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithDatabaseInsightsMode(DatabaseInsightsMode value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithEnablePerformanceInsights(bool value) {
  ...
  template <typename PerformanceInsightsKMSKeyIdT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithPerformanceInsightsKMSKeyId(PerformanceInsightsKMSKeyIdT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithPerformanceInsightsRetentionPeriod(int value) {
  ...
  template <typename EnableCloudwatchLogsExportsT = Aws::Vector<Aws::String>>
  CreateDBInstanceReadReplicaRequest& WithEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
  ...
  CreateDBInstanceReadReplicaRequest& AddEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
    m_enableCloudwatchLogsExportsHasBeenSet = true;
  ...
  template <typename ProcessorFeaturesT = Aws::Vector<ProcessorFeature>>
  CreateDBInstanceReadReplicaRequest& WithProcessorFeatures(ProcessorFeaturesT&& value) {
    SetProcessorFeatures(std::forward<ProcessorFeaturesT>(value));
    return *this;
  }
  template <typename ProcessorFeaturesT = ProcessorFeature>
  CreateDBInstanceReadReplicaRequest& AddProcessorFeatures(ProcessorFeaturesT&& value) {
    m_processorFeaturesHasBeenSet = true;
  ...
  inline void SetUseDefaultProcessorFeatures(bool value) {
    m_useDefaultProcessorFeaturesHasBeenSet = true;
    m_useDefaultProcessorFeatures = value;
  }
  inline CreateDBInstanceReadReplicaRequest& WithUseDefaultProcessorFeatures(bool value) {
    SetUseDefaultProcessorFeatures(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithDeletionProtection(bool value) {
  ...
  template <typename DomainT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainIAMRoleNameT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDomainIAMRoleName(DomainIAMRoleNameT&& value) {
  ...
  void SetDomainFqdn(DomainFqdnT&& value) {
    m_domainFqdnHasBeenSet = true;
    m_domainFqdn = std::forward<DomainFqdnT>(value);
  }
  template <typename DomainFqdnT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDomainFqdn(DomainFqdnT&& value) {
    SetDomainFqdn(std::forward<DomainFqdnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainOu(DomainOuT&& value) {
    m_domainOuHasBeenSet = true;
    m_domainOu = std::forward<DomainOuT>(value);
  }
  template <typename DomainOuT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDomainOu(DomainOuT&& value) {
    SetDomainOu(std::forward<DomainOuT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainAuthSecretArn(DomainAuthSecretArnT&& value) {
    m_domainAuthSecretArnHasBeenSet = true;
    m_domainAuthSecretArn = std::forward<DomainAuthSecretArnT>(value);
  }
  template <typename DomainAuthSecretArnT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithDomainAuthSecretArn(DomainAuthSecretArnT&& value) {
    SetDomainAuthSecretArn(std::forward<DomainAuthSecretArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainDnsIps(DomainDnsIpsT&& value) {
    m_domainDnsIpsHasBeenSet = true;
    m_domainDnsIps = std::forward<DomainDnsIpsT>(value);
  }
  template <typename DomainDnsIpsT = Aws::Vector<Aws::String>>
  CreateDBInstanceReadReplicaRequest& WithDomainDnsIps(DomainDnsIpsT&& value) {
    SetDomainDnsIps(std::forward<DomainDnsIpsT>(value));
    return *this;
  }
  template <typename DomainDnsIpsT = Aws::String>
  CreateDBInstanceReadReplicaRequest& AddDomainDnsIps(DomainDnsIpsT&& value) {
    m_domainDnsIpsHasBeenSet = true;
    m_domainDnsIps.emplace_back(std::forward<DomainDnsIpsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithReplicaMode(ReplicaMode value) {
  ...
  inline void SetEnableCustomerOwnedIp(bool value) {
    m_enableCustomerOwnedIpHasBeenSet = true;
    m_enableCustomerOwnedIp = value;
  }
  inline CreateDBInstanceReadReplicaRequest& WithEnableCustomerOwnedIp(bool value) {
    SetEnableCustomerOwnedIp(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkTypeT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithNetworkType(NetworkTypeT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithMaxAllocatedStorage(int value) {
  ...
  template <typename BackupTargetT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithBackupTarget(BackupTargetT&& value) {
  ...
  template <typename CustomIamInstanceProfileT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithCustomIamInstanceProfile(CustomIamInstanceProfileT&& value) {
  ...
  inline CreateDBInstanceReadReplicaRequest& WithAllocatedStorage(int value) {
  ...
  void SetSourceDBClusterIdentifier(SourceDBClusterIdentifierT&& value) {
    m_sourceDBClusterIdentifierHasBeenSet = true;
    m_sourceDBClusterIdentifier = std::forward<SourceDBClusterIdentifierT>(value);
  }
  template <typename SourceDBClusterIdentifierT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithSourceDBClusterIdentifier(SourceDBClusterIdentifierT&& value) {
    SetSourceDBClusterIdentifier(std::forward<SourceDBClusterIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateDBInstanceReadReplicaRequest& WithDedicatedLogVolume(bool value) {
  ...
  inline void SetUpgradeStorageConfig(bool value) {
    m_upgradeStorageConfigHasBeenSet = true;
    m_upgradeStorageConfig = value;
  }
  inline CreateDBInstanceReadReplicaRequest& WithUpgradeStorageConfig(bool value) {
    SetUpgradeStorageConfig(value);
    return *this;
  }
  ///@}
  ...
  template <typename CACertificateIdentifierT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithCACertificateIdentifier(CACertificateIdentifierT&& value) {
  ...
  template <typename AdditionalStorageVolumesT = Aws::Vector<AdditionalStorageVolume>>
  CreateDBInstanceReadReplicaRequest& WithAdditionalStorageVolumes(AdditionalStorageVolumesT&& value) {
  ...
  template <typename SourceRegionT = Aws::String>
  CreateDBInstanceReadReplicaRequest& WithSourceRegion(SourceRegionT&& value) {
