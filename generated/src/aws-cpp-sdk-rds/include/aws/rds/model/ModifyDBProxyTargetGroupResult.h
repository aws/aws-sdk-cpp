...
class ModifyDBProxyTargetGroupResult {
 public:
  ...
  void SetDBProxyTargetGroup(DBProxyTargetGroupT&& value) {
    m_dBProxyTargetGroupHasBeenSet = true;
    m_dBProxyTargetGroup = std::forward<DBProxyTargetGroupT>(value);
  }
  template <typename DBProxyTargetGroupT = DBProxyTargetGroup>
  ModifyDBProxyTargetGroupResult& WithDBProxyTargetGroup(DBProxyTargetGroupT&& value) {
    SetDBProxyTargetGroup(std::forward<DBProxyTargetGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBProxyTargetGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
