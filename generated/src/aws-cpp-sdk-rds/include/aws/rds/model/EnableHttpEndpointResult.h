...
class EnableHttpEndpointResult {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  EnableHttpEndpointResult& WithResourceArn(ResourceArnT&& value) {
  ...
  inline EnableHttpEndpointResult& WithHttpEndpointEnabled(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableHttpEndpointResult& WithResponseMetadata(ResponseMetadataT&& value) {
