...
class ModifyActivityStreamRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  ModifyActivityStreamRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline void SetAuditPolicyState(AuditPolicyState value) {
    m_auditPolicyStateHasBeenSet = true;
    m_auditPolicyState = value;
  }
  inline ModifyActivityStreamRequest& WithAuditPolicyState(AuditPolicyState value) {
    SetAuditPolicyState(value);
    return *this;
  }
  ///@}
 private:
