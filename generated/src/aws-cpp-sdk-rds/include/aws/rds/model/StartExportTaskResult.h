...
namespace Model
{
  ...
  public:
    ...
    template<typename ExportTaskIdentifierT = Aws::String>
    StartExportTaskResult& WithExportTaskIdentifier(ExportTaskIdentifierT&& value) { SetExportTaskIdentifier(std::forward<ExportTaskIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceArnT = Aws::String>
    StartExportTaskResult& WithSourceArn(SourceArnT&& value) { SetSourceArn(std::forward<SourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ExportOnlyT = Aws::Vector<Aws::String>>
    StartExportTaskResult& WithExportOnly(ExportOnlyT&& value) { SetExportOnly(std::forward<ExportOnlyT>(value)); return *this;}
    template<typename ExportOnlyT = Aws::String>
    StartExportTaskResult& AddExportOnly(ExportOnlyT&& value) { m_exportOnlyHasBeenSet = true; m_exportOnly.emplace_back(std::forward<ExportOnlyT>(value)); return *this; }
    ///@}
    ...
    template<typename SnapshotTimeT = Aws::Utils::DateTime>
    StartExportTaskResult& WithSnapshotTime(SnapshotTimeT&& value) { SetSnapshotTime(std::forward<SnapshotTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename TaskStartTimeT = Aws::Utils::DateTime>
    StartExportTaskResult& WithTaskStartTime(TaskStartTimeT&& value) { SetTaskStartTime(std::forward<TaskStartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename TaskEndTimeT = Aws::Utils::DateTime>
    StartExportTaskResult& WithTaskEndTime(TaskEndTimeT&& value) { SetTaskEndTime(std::forward<TaskEndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename S3BucketT = Aws::String>
    StartExportTaskResult& WithS3Bucket(S3BucketT&& value) { SetS3Bucket(std::forward<S3BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename S3PrefixT = Aws::String>
    StartExportTaskResult& WithS3Prefix(S3PrefixT&& value) { SetS3Prefix(std::forward<S3PrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename IamRoleArnT = Aws::String>
    StartExportTaskResult& WithIamRoleArn(IamRoleArnT&& value) { SetIamRoleArn(std::forward<IamRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdT = Aws::String>
    StartExportTaskResult& WithKmsKeyId(KmsKeyIdT&& value) { SetKmsKeyId(std::forward<KmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    StartExportTaskResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename FailureCauseT = Aws::String>
    StartExportTaskResult& WithFailureCause(FailureCauseT&& value) { SetFailureCause(std::forward<FailureCauseT>(value)); return *this;}
    ///@}
    ...
    template<typename WarningMessageT = Aws::String>
    StartExportTaskResult& WithWarningMessage(WarningMessageT&& value) { SetWarningMessage(std::forward<WarningMessageT>(value)); return *this;}
    ///@}
    ...
    inline StartExportTaskResult& WithSourceType(ExportSourceType value) { SetSourceType(value); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    StartExportTaskResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
