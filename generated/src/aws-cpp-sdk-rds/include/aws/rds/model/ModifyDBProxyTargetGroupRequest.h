...
class ModifyDBProxyTargetGroupRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename TargetGroupNameT = Aws::String>
  ModifyDBProxyTargetGroupRequest& WithTargetGroupName(TargetGroupNameT&& value) {
  ...
  template <typename DBProxyNameT = Aws::String>
  ModifyDBProxyTargetGroupRequest& WithDBProxyName(DBProxyNameT&& value) {
  ...
  void SetConnectionPoolConfig(ConnectionPoolConfigT&& value) {
    ...
    m_connectionPoolConfig = std::forward<ConnectionPoolConfigT>(value);
  }
  template <typename ConnectionPoolConfigT = ConnectionPoolConfiguration>
  ModifyDBProxyTargetGroupRequest& WithConnectionPoolConfig(ConnectionPoolConfigT&& value) {
    SetConnectionPoolConfig(std::forward<ConnectionPoolConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NewNameT = Aws::String>
  ModifyDBProxyTargetGroupRequest& WithNewName(NewNameT&& value) {
