...
class ModifyDBClusterParameterGroupResult {
 public:
  AWS_RDS_API ModifyDBClusterParameterGroupResult() = default;
  ...
  template <typename DBClusterParameterGroupNameT = Aws::String>
  ModifyDBClusterParameterGroupResult& WithDBClusterParameterGroupName(DBClusterParameterGroupNameT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBClusterParameterGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
