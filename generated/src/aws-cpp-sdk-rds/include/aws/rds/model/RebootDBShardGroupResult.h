...
class RebootDBShardGroupResult {
 public:
  ...
  template <typename DBShardGroupResourceIdT = Aws::String>
  RebootDBShardGroupResult& WithDBShardGroupResourceId(DBShardGroupResourceIdT&& value) {
  ...
  template <typename DBShardGroupIdentifierT = Aws::String>
  RebootDBShardGroupResult& WithDBShardGroupIdentifier(DBShardGroupIdentifierT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  RebootDBShardGroupResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  inline RebootDBShardGroupResult& WithMaxACU(double value) {
    SetMaxACU(value);
    return *this;
  }
  ///@}
  ...
  inline RebootDBShardGroupResult& WithMinACU(double value) {
    SetMinACU(value);
    return *this;
  }
  ///@}
  ...
  inline RebootDBShardGroupResult& WithComputeRedundancy(int value) {
  ...
  template <typename StatusT = Aws::String>
  RebootDBShardGroupResult& WithStatus(StatusT&& value) {
  ...
  inline RebootDBShardGroupResult& WithPubliclyAccessible(bool value) {
  ...
  template <typename EndpointT = Aws::String>
  RebootDBShardGroupResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename DBShardGroupArnT = Aws::String>
  RebootDBShardGroupResult& WithDBShardGroupArn(DBShardGroupArnT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  RebootDBShardGroupResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  RebootDBShardGroupResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RebootDBShardGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
