...
class ModifyCurrentDBClusterCapacityRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  ModifyCurrentDBClusterCapacityRequest& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  inline ModifyCurrentDBClusterCapacityRequest& WithCapacity(int value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyCurrentDBClusterCapacityRequest& WithSecondsBeforeTimeout(int value) {
  ...
  template <typename TimeoutActionT = Aws::String>
  ModifyCurrentDBClusterCapacityRequest& WithTimeoutAction(TimeoutActionT&& value) {
