...
class DescribeEngineDefaultParametersRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBParameterGroupFamilyT = Aws::String>
  DescribeEngineDefaultParametersRequest& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeEngineDefaultParametersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeEngineDefaultParametersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
