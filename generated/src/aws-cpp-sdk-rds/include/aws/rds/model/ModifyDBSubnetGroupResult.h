...
class ModifyDBSubnetGroupResult {
 public:
  AWS_RDS_API ModifyDBSubnetGroupResult() = default;
  AWS_RDS_API ModifyDBSubnetGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_RDS_API ModifyDBSubnetGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename DBSubnetGroupT = DBSubnetGroup>
  ModifyDBSubnetGroupResult& WithDBSubnetGroup(DBSubnetGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBSubnetGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
