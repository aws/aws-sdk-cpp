...
class DescribeDBProxyTargetGroupsResult {
 public:
  ...
  template <typename TargetGroupsT = Aws::Vector<DBProxyTargetGroup>>
  DescribeDBProxyTargetGroupsResult& WithTargetGroups(TargetGroupsT&& value) {
    SetTargetGroups(std::forward<TargetGroupsT>(value));
    return *this;
  }
  template <typename TargetGroupsT = DBProxyTargetGroup>
  DescribeDBProxyTargetGroupsResult& AddTargetGroups(TargetGroupsT&& value) {
    m_targetGroupsHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxyTargetGroupsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBProxyTargetGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
