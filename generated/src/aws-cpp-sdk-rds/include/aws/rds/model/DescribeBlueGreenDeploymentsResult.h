...
class DescribeBlueGreenDeploymentsResult {
 public:
  ...
  void SetBlueGreenDeployments(BlueGreenDeploymentsT&& value) {
    m_blueGreenDeploymentsHasBeenSet = true;
    m_blueGreenDeployments = std::forward<BlueGreenDeploymentsT>(value);
  }
  template <typename BlueGreenDeploymentsT = Aws::Vector<BlueGreenDeployment>>
  DescribeBlueGreenDeploymentsResult& WithBlueGreenDeployments(BlueGreenDeploymentsT&& value) {
    SetBlueGreenDeployments(std::forward<BlueGreenDeploymentsT>(value));
    return *this;
  }
  template <typename BlueGreenDeploymentsT = BlueGreenDeployment>
  DescribeBlueGreenDeploymentsResult& AddBlueGreenDeployments(BlueGreenDeploymentsT&& value) {
    m_blueGreenDeploymentsHasBeenSet = true;
    m_blueGreenDeployments.emplace_back(std::forward<BlueGreenDeploymentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeBlueGreenDeploymentsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeBlueGreenDeploymentsResult& WithResponseMetadata(ResponseMetadataT&& value) {
