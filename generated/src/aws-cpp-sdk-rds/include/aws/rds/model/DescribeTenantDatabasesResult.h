...
class DescribeTenantDatabasesResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeTenantDatabasesResult& WithMarker(MarkerT&& value) {
  ...
  void SetTenantDatabases(TenantDatabasesT&& value) {
    m_tenantDatabasesHasBeenSet = true;
    m_tenantDatabases = std::forward<TenantDatabasesT>(value);
  }
  template <typename TenantDatabasesT = Aws::Vector<TenantDatabase>>
  DescribeTenantDatabasesResult& WithTenantDatabases(TenantDatabasesT&& value) {
    SetTenantDatabases(std::forward<TenantDatabasesT>(value));
    return *this;
  }
  template <typename TenantDatabasesT = TenantDatabase>
  DescribeTenantDatabasesResult& AddTenantDatabases(TenantDatabasesT&& value) {
    m_tenantDatabasesHasBeenSet = true;
    m_tenantDatabases.emplace_back(std::forward<TenantDatabasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTenantDatabasesResult& WithResponseMetadata(ResponseMetadataT&& value) {
