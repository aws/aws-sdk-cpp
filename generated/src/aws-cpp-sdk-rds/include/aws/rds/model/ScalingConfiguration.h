...
class ScalingConfiguration {
 public:
  ...
  inline ScalingConfiguration& WithMinCapacity(int value) {
  ...
  inline ScalingConfiguration& WithMaxCapacity(int value) {
  ...
  inline ScalingConfiguration& WithAutoPause(bool value) {
    SetAutoPause(value);
    return *this;
  }
  ///@}
  ...
  inline ScalingConfiguration& WithSecondsUntilAutoPause(int value) {
  ...
  inline ScalingConfiguration& WithSecondsBeforeTimeout(int value) {
