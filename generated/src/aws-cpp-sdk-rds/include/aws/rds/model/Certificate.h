...
class Certificate {
 public:
  ...
  inline void SetCustomerOverride(bool value) {
    m_customerOverrideHasBeenSet = true;
    m_customerOverride = value;
  }
  inline Certificate& WithCustomerOverride(bool value) {
  ...
  void SetCustomerOverrideValidTill(CustomerOverrideValidTillT&& value) {
    ...
    m_customerOverrideValidTill = std::forward<CustomerOverrideValidTillT>(value);
  }
  template <typename CustomerOverrideValidTillT = Aws::Utils::DateTime>
  Certificate& WithCustomerOverrideValidTill(CustomerOverrideValidTillT&& value) {
    SetCustomerOverrideValidTill(std::forward<CustomerOverrideValidTillT>(value));
    return *this;
  }
  ///@}
 private:
