...
class RevokeDBSecurityGroupIngressResult {
 public:
  AWS_RDS_API RevokeDBSecurityGroupIngressResult() = default;
  ...
  void SetDBSecurityGroup(DBSecurityGroupT&& value) {
    m_dBSecurityGroupHasBeenSet = true;
    m_dBSecurityGroup = std::forward<DBSecurityGroupT>(value);
  }
  template <typename DBSecurityGroupT = DBSecurityGroup>
  RevokeDBSecurityGroupIngressResult& WithDBSecurityGroup(DBSecurityGroupT&& value) {
    SetDBSecurityGroup(std::forward<DBSecurityGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RevokeDBSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadataT&& value) {
