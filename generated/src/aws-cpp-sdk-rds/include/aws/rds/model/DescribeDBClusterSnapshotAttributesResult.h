...
class DescribeDBClusterSnapshotAttributesResult {
 public:
  ...
  template <typename DBClusterSnapshotAttributesResultT = DBClusterSnapshotAttributesResult>
  DescribeDBClusterSnapshotAttributesResult& WithDBClusterSnapshotAttributesResult(DBClusterSnapshotAttributesResultT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBClusterSnapshotAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
