...
class DeleteDBShardGroupResult {
 public:
  ...
  template <typename DBShardGroupResourceIdT = Aws::String>
  DeleteDBShardGroupResult& WithDBShardGroupResourceId(DBShardGroupResourceIdT&& value) {
  ...
  template <typename DBShardGroupIdentifierT = Aws::String>
  DeleteDBShardGroupResult& WithDBShardGroupIdentifier(DBShardGroupIdentifierT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  DeleteDBShardGroupResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  inline DeleteDBShardGroupResult& WithMaxACU(double value) {
    SetMaxACU(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDBShardGroupResult& WithMinACU(double value) {
    SetMinACU(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteDBShardGroupResult& WithComputeRedundancy(int value) {
  ...
  template <typename StatusT = Aws::String>
  DeleteDBShardGroupResult& WithStatus(StatusT&& value) {
  ...
  inline DeleteDBShardGroupResult& WithPubliclyAccessible(bool value) {
  ...
  template <typename EndpointT = Aws::String>
  DeleteDBShardGroupResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename DBShardGroupArnT = Aws::String>
  DeleteDBShardGroupResult& WithDBShardGroupArn(DBShardGroupArnT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  DeleteDBShardGroupResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  DeleteDBShardGroupResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteDBShardGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
