...
class SupportedEngineLifecycle {
 public:
  ...
  inline void SetLifecycleSupportName(LifecycleSupportName value) {
    m_lifecycleSupportNameHasBeenSet = true;
    m_lifecycleSupportName = value;
  }
  inline SupportedEngineLifecycle& WithLifecycleSupportName(LifecycleSupportName value) {
    SetLifecycleSupportName(value);
    return *this;
  }
  ///@}
  ...
  void SetLifecycleSupportStartDate(LifecycleSupportStartDateT&& value) {
    ...
    m_lifecycleSupportStartDate = std::forward<LifecycleSupportStartDateT>(value);
  }
  template <typename LifecycleSupportStartDateT = Aws::Utils::DateTime>
  SupportedEngineLifecycle& WithLifecycleSupportStartDate(LifecycleSupportStartDateT&& value) {
    SetLifecycleSupportStartDate(std::forward<LifecycleSupportStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLifecycleSupportEndDate(LifecycleSupportEndDateT&& value) {
    ...
    m_lifecycleSupportEndDate = std::forward<LifecycleSupportEndDateT>(value);
  }
  template <typename LifecycleSupportEndDateT = Aws::Utils::DateTime>
  SupportedEngineLifecycle& WithLifecycleSupportEndDate(LifecycleSupportEndDateT&& value) {
    SetLifecycleSupportEndDate(std::forward<LifecycleSupportEndDateT>(value));
    return *this;
  }
  ///@}
 private:
