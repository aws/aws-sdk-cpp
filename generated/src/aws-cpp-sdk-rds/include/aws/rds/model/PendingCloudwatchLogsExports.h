...
class PendingCloudwatchLogsExports {
 public:
  ...
  void SetLogTypesToDisable(LogTypesToDisableT&& value) {
    ...
    m_logTypesToDisable = std::forward<LogTypesToDisableT>(value);
  }
  template <typename LogTypesToDisableT = Aws::Vector<Aws::String>>
  PendingCloudwatchLogsExports& WithLogTypesToDisable(LogTypesToDisableT&& value) {
    SetLogTypesToDisable(std::forward<LogTypesToDisableT>(value));
    return *this;
  }
  ...
  PendingCloudwatchLogsExports& AddLogTypesToDisable(LogTypesToDisableT&& value) {
    m_logTypesToDisableHasBeenSet = true;
    m_logTypesToDisable.emplace_back(std::forward<LogTypesToDisableT>(value));
    return *this;
  }
  ///@}
 private:
