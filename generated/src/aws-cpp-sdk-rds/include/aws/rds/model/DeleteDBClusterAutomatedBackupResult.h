...
class DeleteDBClusterAutomatedBackupResult {
 public:
  ...
  void SetDBClusterAutomatedBackup(DBClusterAutomatedBackupT&& value) {
    m_dBClusterAutomatedBackupHasBeenSet = true;
    m_dBClusterAutomatedBackup = std::forward<DBClusterAutomatedBackupT>(value);
  }
  template <typename DBClusterAutomatedBackupT = DBClusterAutomatedBackup>
  DeleteDBClusterAutomatedBackupResult& WithDBClusterAutomatedBackup(DBClusterAutomatedBackupT&& value) {
    SetDBClusterAutomatedBackup(std::forward<DBClusterAutomatedBackupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteDBClusterAutomatedBackupResult& WithResponseMetadata(ResponseMetadataT&& value) {
