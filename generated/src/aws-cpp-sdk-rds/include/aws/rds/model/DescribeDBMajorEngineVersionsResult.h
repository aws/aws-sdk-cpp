...
class DescribeDBMajorEngineVersionsResult {
 public:
  ...
  void SetDBMajorEngineVersions(DBMajorEngineVersionsT&& value) {
    m_dBMajorEngineVersionsHasBeenSet = true;
    m_dBMajorEngineVersions = std::forward<DBMajorEngineVersionsT>(value);
  }
  template <typename DBMajorEngineVersionsT = Aws::Vector<DBMajorEngineVersion>>
  DescribeDBMajorEngineVersionsResult& WithDBMajorEngineVersions(DBMajorEngineVersionsT&& value) {
    SetDBMajorEngineVersions(std::forward<DBMajorEngineVersionsT>(value));
    return *this;
  }
  template <typename DBMajorEngineVersionsT = DBMajorEngineVersion>
  DescribeDBMajorEngineVersionsResult& AddDBMajorEngineVersions(DBMajorEngineVersionsT&& value) {
    m_dBMajorEngineVersionsHasBeenSet = true;
    m_dBMajorEngineVersions.emplace_back(std::forward<DBMajorEngineVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBMajorEngineVersionsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBMajorEngineVersionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
