...
class StartActivityStreamResult {
 public:
  ...
  inline StartActivityStreamResult& WithStatus(ActivityStreamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StartActivityStreamResult& WithMode(ActivityStreamMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline StartActivityStreamResult& WithEngineNativeAuditFieldsIncluded(bool value) {
  ...
  inline StartActivityStreamResult& WithApplyImmediately(bool value) {
