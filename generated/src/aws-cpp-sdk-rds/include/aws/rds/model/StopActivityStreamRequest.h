...
class StopActivityStreamRequest : public RDSRequest {
 public:
  AWS_RDS_API StopActivityStreamRequest() = default;
 ...
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  StopActivityStreamRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline StopActivityStreamRequest& WithApplyImmediately(bool value) {
