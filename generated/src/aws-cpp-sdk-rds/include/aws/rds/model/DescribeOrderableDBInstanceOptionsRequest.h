...
class DescribeOrderableDBInstanceOptionsRequest : public RDSRequest {
 ...
 public:
  ...
  void SetAvailabilityZoneGroup(AvailabilityZoneGroupT&& value) {
    ...
    m_availabilityZoneGroup = std::forward<AvailabilityZoneGroupT>(value);
  }
  template <typename AvailabilityZoneGroupT = Aws::String>
  DescribeOrderableDBInstanceOptionsRequest& WithAvailabilityZoneGroup(AvailabilityZoneGroupT&& value) {
    SetAvailabilityZoneGroup(std::forward<AvailabilityZoneGroupT>(value));
    return *this;
  }
  ///@}
