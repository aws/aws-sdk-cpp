...
class DescribeDBClusterSnapshotAttributesRequest : public RDSRequest {
 public:
  AWS_RDS_API DescribeDBClusterSnapshotAttributesRequest() = default;
 ...
 public:
  ...
  template <typename DBClusterSnapshotIdentifierT = Aws::String>
  DescribeDBClusterSnapshotAttributesRequest& WithDBClusterSnapshotIdentifier(DBClusterSnapshotIdentifierT&& value) {
