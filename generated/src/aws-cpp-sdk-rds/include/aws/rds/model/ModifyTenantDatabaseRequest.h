...
class ModifyTenantDatabaseRequest : public RDSRequest {
 ...
 public:
  ...
  void SetNewTenantDBName(NewTenantDBNameT&& value) {
    m_newTenantDBNameHasBeenSet = true;
    m_newTenantDBName = std::forward<NewTenantDBNameT>(value);
  }
  template <typename NewTenantDBNameT = Aws::String>
  ModifyTenantDatabaseRequest& WithNewTenantDBName(NewTenantDBNameT&& value) {
    SetNewTenantDBName(std::forward<NewTenantDBNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyTenantDatabaseRequest& WithManageMasterUserPassword(bool value) {
  ...
  inline ModifyTenantDatabaseRequest& WithRotateMasterUserPassword(bool value) {
