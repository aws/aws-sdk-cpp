...
class DescribeReservedDBInstancesOfferingsResult {
 public:
  ...
  AWS_RDS_API DescribeReservedDBInstancesOfferingsResult& operator=(
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedDBInstancesOfferingsResult& WithMarker(MarkerT&& value) {
  ...
  void SetReservedDBInstancesOfferings(ReservedDBInstancesOfferingsT&& value) {
    m_reservedDBInstancesOfferingsHasBeenSet = true;
    m_reservedDBInstancesOfferings = std::forward<ReservedDBInstancesOfferingsT>(value);
  }
  template <typename ReservedDBInstancesOfferingsT = Aws::Vector<ReservedDBInstancesOffering>>
  DescribeReservedDBInstancesOfferingsResult& WithReservedDBInstancesOfferings(ReservedDBInstancesOfferingsT&& value) {
    SetReservedDBInstancesOfferings(std::forward<ReservedDBInstancesOfferingsT>(value));
    return *this;
  }
  template <typename ReservedDBInstancesOfferingsT = ReservedDBInstancesOffering>
  DescribeReservedDBInstancesOfferingsResult& AddReservedDBInstancesOfferings(ReservedDBInstancesOfferingsT&& value) {
    m_reservedDBInstancesOfferingsHasBeenSet = true;
    m_reservedDBInstancesOfferings.emplace_back(std::forward<ReservedDBInstancesOfferingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedDBInstancesOfferingsResult& WithResponseMetadata(ResponseMetadataT&& value) {
