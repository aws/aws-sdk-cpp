...
class ModifyDBProxyEndpointRequest : public RDSRequest {
 ...
 public:
  ...
  void SetNewDBProxyEndpointName(NewDBProxyEndpointNameT&& value) {
    m_newDBProxyEndpointNameHasBeenSet = true;
    m_newDBProxyEndpointName = std::forward<NewDBProxyEndpointNameT>(value);
  }
  template <typename NewDBProxyEndpointNameT = Aws::String>
  ModifyDBProxyEndpointRequest& WithNewDBProxyEndpointName(NewDBProxyEndpointNameT&& value) {
    SetNewDBProxyEndpointName(std::forward<NewDBProxyEndpointNameT>(value));
    return *this;
  }
  ///@}
