...
namespace Model
{
  ...
  public:
    ...
    template<typename DBSnapshotIdentifierT = Aws::String>
    DBSnapshot& WithDBSnapshotIdentifier(DBSnapshotIdentifierT&& value) { SetDBSnapshotIdentifier(std::forward<DBSnapshotIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DBInstanceIdentifierT = Aws::String>
    DBSnapshot& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) { SetDBInstanceIdentifier(std::forward<DBInstanceIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename SnapshotCreateTimeT = Aws::Utils::DateTime>
    DBSnapshot& WithSnapshotCreateTime(SnapshotCreateTimeT&& value) { SetSnapshotCreateTime(std::forward<SnapshotCreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EngineT = Aws::String>
    DBSnapshot& WithEngine(EngineT&& value) { SetEngine(std::forward<EngineT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    DBSnapshot& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename AvailabilityZoneT = Aws::String>
    DBSnapshot& WithAvailabilityZone(AvailabilityZoneT&& value) { SetAvailabilityZone(std::forward<AvailabilityZoneT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    DBSnapshot& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceCreateTimeT = Aws::Utils::DateTime>
    DBSnapshot& WithInstanceCreateTime(InstanceCreateTimeT&& value) { SetInstanceCreateTime(std::forward<InstanceCreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename MasterUsernameT = Aws::String>
    DBSnapshot& WithMasterUsername(MasterUsernameT&& value) { SetMasterUsername(std::forward<MasterUsernameT>(value)); return *this;}
    ///@}
    ...
    template<typename EngineVersionT = Aws::String>
    DBSnapshot& WithEngineVersion(EngineVersionT&& value) { SetEngineVersion(std::forward<EngineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename LicenseModelT = Aws::String>
    DBSnapshot& WithLicenseModel(LicenseModelT&& value) { SetLicenseModel(std::forward<LicenseModelT>(value)); return *this;}
    ///@}
    ...
    template<typename SnapshotTypeT = Aws::String>
    DBSnapshot& WithSnapshotType(SnapshotTypeT&& value) { SetSnapshotType(std::forward<SnapshotTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename OptionGroupNameT = Aws::String>
    DBSnapshot& WithOptionGroupName(OptionGroupNameT&& value) { SetOptionGroupName(std::forward<OptionGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceRegionT = Aws::String>
    DBSnapshot& WithSourceRegion(SourceRegionT&& value) { SetSourceRegion(std::forward<SourceRegionT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceDBSnapshotIdentifierT = Aws::String>
    DBSnapshot& WithSourceDBSnapshotIdentifier(SourceDBSnapshotIdentifierT&& value) { SetSourceDBSnapshotIdentifier(std::forward<SourceDBSnapshotIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename StorageTypeT = Aws::String>
    DBSnapshot& WithStorageType(StorageTypeT&& value) { SetStorageType(std::forward<StorageTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename TdeCredentialArnT = Aws::String>
    DBSnapshot& WithTdeCredentialArn(TdeCredentialArnT&& value) { SetTdeCredentialArn(std::forward<TdeCredentialArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyIdT = Aws::String>
    DBSnapshot& WithKmsKeyId(KmsKeyIdT&& value) { SetKmsKeyId(std::forward<KmsKeyIdT>(value)); return *this;}
    ///@}
    ...
    void SetDBSnapshotArn(DBSnapshotArnT&& value) { m_dBSnapshotArnHasBeenSet = true; m_dBSnapshotArn = std::forward<DBSnapshotArnT>(value); }
    template<typename DBSnapshotArnT = Aws::String>
    DBSnapshot& WithDBSnapshotArn(DBSnapshotArnT&& value) { SetDBSnapshotArn(std::forward<DBSnapshotArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TimezoneT = Aws::String>
    DBSnapshot& WithTimezone(TimezoneT&& value) { SetTimezone(std::forward<TimezoneT>(value)); return *this;}
    ///@}
    ...
    template<typename ProcessorFeaturesT = Aws::Vector<ProcessorFeature>>
    DBSnapshot& WithProcessorFeatures(ProcessorFeaturesT&& value) { SetProcessorFeatures(std::forward<ProcessorFeaturesT>(value)); return *this;}
    template<typename ProcessorFeaturesT = ProcessorFeature>
    DBSnapshot& AddProcessorFeatures(ProcessorFeaturesT&& value) { m_processorFeaturesHasBeenSet = true; m_processorFeatures.emplace_back(std::forward<ProcessorFeaturesT>(value)); return *this; }
    ///@}
    ...
    template<typename DbiResourceIdT = Aws::String>
    DBSnapshot& WithDbiResourceId(DbiResourceIdT&& value) { SetDbiResourceId(std::forward<DbiResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagListT = Aws::Vector<Tag>>
    DBSnapshot& WithTagList(TagListT&& value) { SetTagList(std::forward<TagListT>(value)); return *this;}
    template<typename TagListT = Tag>
    DBSnapshot& AddTagList(TagListT&& value) { m_tagListHasBeenSet = true; m_tagList.emplace_back(std::forward<TagListT>(value)); return *this; }
    ///@}
    ...
    void SetOriginalSnapshotCreateTime(OriginalSnapshotCreateTimeT&& value) { m_originalSnapshotCreateTimeHasBeenSet = true; m_originalSnapshotCreateTime = std::forward<OriginalSnapshotCreateTimeT>(value); }
    template<typename OriginalSnapshotCreateTimeT = Aws::Utils::DateTime>
    DBSnapshot& WithOriginalSnapshotCreateTime(OriginalSnapshotCreateTimeT&& value) { SetOriginalSnapshotCreateTime(std::forward<OriginalSnapshotCreateTimeT>(value)); return *this;}
    ///@}
    ...
    void SetSnapshotDatabaseTime(SnapshotDatabaseTimeT&& value) { m_snapshotDatabaseTimeHasBeenSet = true; m_snapshotDatabaseTime = std::forward<SnapshotDatabaseTimeT>(value); }
    template<typename SnapshotDatabaseTimeT = Aws::Utils::DateTime>
    DBSnapshot& WithSnapshotDatabaseTime(SnapshotDatabaseTimeT&& value) { SetSnapshotDatabaseTime(std::forward<SnapshotDatabaseTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DBSystemIdT = Aws::String>
    DBSnapshot& WithDBSystemId(DBSystemIdT&& value) { SetDBSystemId(std::forward<DBSystemIdT>(value)); return *this;}
    ///@}
