...
class DescribeDBSnapshotTenantDatabasesResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBSnapshotTenantDatabasesResult& WithMarker(MarkerT&& value) {
  ...
  void SetDBSnapshotTenantDatabases(DBSnapshotTenantDatabasesT&& value) {
    m_dBSnapshotTenantDatabasesHasBeenSet = true;
    m_dBSnapshotTenantDatabases = std::forward<DBSnapshotTenantDatabasesT>(value);
  }
  template <typename DBSnapshotTenantDatabasesT = Aws::Vector<DBSnapshotTenantDatabase>>
  DescribeDBSnapshotTenantDatabasesResult& WithDBSnapshotTenantDatabases(DBSnapshotTenantDatabasesT&& value) {
    SetDBSnapshotTenantDatabases(std::forward<DBSnapshotTenantDatabasesT>(value));
    return *this;
  }
  template <typename DBSnapshotTenantDatabasesT = DBSnapshotTenantDatabase>
  DescribeDBSnapshotTenantDatabasesResult& AddDBSnapshotTenantDatabases(DBSnapshotTenantDatabasesT&& value) {
    m_dBSnapshotTenantDatabasesHasBeenSet = true;
    m_dBSnapshotTenantDatabases.emplace_back(std::forward<DBSnapshotTenantDatabasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBSnapshotTenantDatabasesResult& WithResponseMetadata(ResponseMetadataT&& value) {
