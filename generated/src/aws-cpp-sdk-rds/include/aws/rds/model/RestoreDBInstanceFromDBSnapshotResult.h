...
class RestoreDBInstanceFromDBSnapshotResult {
 public:
  ...
  template <typename DBInstanceT = DBInstance>
  RestoreDBInstanceFromDBSnapshotResult& WithDBInstance(DBInstanceT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RestoreDBInstanceFromDBSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) {
