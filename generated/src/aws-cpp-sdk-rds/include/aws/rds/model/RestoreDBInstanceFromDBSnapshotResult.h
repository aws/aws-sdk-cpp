...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API RestoreDBInstanceFromDBSnapshotResult() = default;
    ...
    template<typename DBInstanceT = DBInstance>
    RestoreDBInstanceFromDBSnapshotResult& WithDBInstance(DBInstanceT&& value) { SetDBInstance(std::forward<DBInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RestoreDBInstanceFromDBSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
