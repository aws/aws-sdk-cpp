...
class ResetDBParameterGroupResult {
 public:
  ...
  template <typename DBParameterGroupNameT = Aws::String>
  ResetDBParameterGroupResult& WithDBParameterGroupName(DBParameterGroupNameT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ResetDBParameterGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
