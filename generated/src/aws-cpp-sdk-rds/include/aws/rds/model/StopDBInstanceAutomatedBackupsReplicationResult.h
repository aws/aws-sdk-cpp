...
class StopDBInstanceAutomatedBackupsReplicationResult {
 public:
  ...
  AWS_RDS_API StopDBInstanceAutomatedBackupsReplicationResult& operator=(
  ...
  template <typename DBInstanceAutomatedBackupT = DBInstanceAutomatedBackup>
  StopDBInstanceAutomatedBackupsReplicationResult& WithDBInstanceAutomatedBackup(DBInstanceAutomatedBackupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StopDBInstanceAutomatedBackupsReplicationResult& WithResponseMetadata(ResponseMetadataT&& value) {
