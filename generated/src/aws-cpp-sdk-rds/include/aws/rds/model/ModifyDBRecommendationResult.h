...
class ModifyDBRecommendationResult {
 public:
  ...
  void SetDBRecommendation(DBRecommendationT&& value) {
    m_dBRecommendationHasBeenSet = true;
    m_dBRecommendation = std::forward<DBRecommendationT>(value);
  }
  template <typename DBRecommendationT = DBRecommendation>
  ModifyDBRecommendationResult& WithDBRecommendation(DBRecommendationT&& value) {
    SetDBRecommendation(std::forward<DBRecommendationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBRecommendationResult& WithResponseMetadata(ResponseMetadataT&& value) {
