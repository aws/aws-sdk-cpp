...
class RestoreDBClusterFromS3Request : public RDSRequest {
 ...
 public:
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromS3Request& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  RestoreDBClusterFromS3Request& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  inline RestoreDBClusterFromS3Request& WithBackupRetentionPeriod(int value) {
  ...
  template <typename CharacterSetNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithCharacterSetName(CharacterSetNameT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  RestoreDBClusterFromS3Request& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  template <typename DBClusterParameterGroupNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithDBClusterParameterGroupName(DBClusterParameterGroupNameT&& value) {
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromS3Request& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  RestoreDBClusterFromS3Request& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  template <typename DBSubnetGroupNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithDBSubnetGroupName(DBSubnetGroupNameT&& value) {
  ...
  template <typename EngineT = Aws::String>
  RestoreDBClusterFromS3Request& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  RestoreDBClusterFromS3Request& WithEngineVersion(EngineVersionT&& value) {
  ...
  inline RestoreDBClusterFromS3Request& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename MasterUsernameT = Aws::String>
  RestoreDBClusterFromS3Request& WithMasterUsername(MasterUsernameT&& value) {
  ...
  template <typename MasterUserPasswordT = Aws::String>
  RestoreDBClusterFromS3Request& WithMasterUserPassword(MasterUserPasswordT&& value) {
  ...
  template <typename OptionGroupNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithOptionGroupName(OptionGroupNameT&& value) {
  ...
  template <typename PreferredBackupWindowT = Aws::String>
  RestoreDBClusterFromS3Request& WithPreferredBackupWindow(PreferredBackupWindowT&& value) {
  ...
  template <typename PreferredMaintenanceWindowT = Aws::String>
  RestoreDBClusterFromS3Request& WithPreferredMaintenanceWindow(PreferredMaintenanceWindowT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RestoreDBClusterFromS3Request& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RestoreDBClusterFromS3Request& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline RestoreDBClusterFromS3Request& WithStorageEncrypted(bool value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  RestoreDBClusterFromS3Request& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline RestoreDBClusterFromS3Request& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  void SetSourceEngine(SourceEngineT&& value) {
    m_sourceEngineHasBeenSet = true;
    m_sourceEngine = std::forward<SourceEngineT>(value);
  }
  template <typename SourceEngineT = Aws::String>
  RestoreDBClusterFromS3Request& WithSourceEngine(SourceEngineT&& value) {
    SetSourceEngine(std::forward<SourceEngineT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceEngineVersion(SourceEngineVersionT&& value) {
    m_sourceEngineVersionHasBeenSet = true;
    m_sourceEngineVersion = std::forward<SourceEngineVersionT>(value);
  }
  template <typename SourceEngineVersionT = Aws::String>
  RestoreDBClusterFromS3Request& WithSourceEngineVersion(SourceEngineVersionT&& value) {
    SetSourceEngineVersion(std::forward<SourceEngineVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename S3BucketNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithS3BucketName(S3BucketNameT&& value) {
  ...
  template <typename S3PrefixT = Aws::String>
  RestoreDBClusterFromS3Request& WithS3Prefix(S3PrefixT&& value) {
  ...
  void SetS3IngestionRoleArn(S3IngestionRoleArnT&& value) {
    m_s3IngestionRoleArnHasBeenSet = true;
    m_s3IngestionRoleArn = std::forward<S3IngestionRoleArnT>(value);
  }
  template <typename S3IngestionRoleArnT = Aws::String>
  RestoreDBClusterFromS3Request& WithS3IngestionRoleArn(S3IngestionRoleArnT&& value) {
    SetS3IngestionRoleArn(std::forward<S3IngestionRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline RestoreDBClusterFromS3Request& WithBacktrackWindow(long long value) {
  ...
  template <typename EnableCloudwatchLogsExportsT = Aws::Vector<Aws::String>>
  RestoreDBClusterFromS3Request& WithEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
  ...
  RestoreDBClusterFromS3Request& AddEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
    m_enableCloudwatchLogsExportsHasBeenSet = true;
  ...
  inline RestoreDBClusterFromS3Request& WithDeletionProtection(bool value) {
  ...
  inline RestoreDBClusterFromS3Request& WithCopyTagsToSnapshot(bool value) {
  ...
  template <typename DomainT = Aws::String>
  RestoreDBClusterFromS3Request& WithDomain(DomainT&& value) {
  ...
  template <typename DomainIAMRoleNameT = Aws::String>
  RestoreDBClusterFromS3Request& WithDomainIAMRoleName(DomainIAMRoleNameT&& value) {
  ...
  template <typename StorageTypeT = Aws::String>
  RestoreDBClusterFromS3Request& WithStorageType(StorageTypeT&& value) {
  ...
  template <typename NetworkTypeT = Aws::String>
  RestoreDBClusterFromS3Request& WithNetworkType(NetworkTypeT&& value) {
  ...
  template <typename ServerlessV2ScalingConfigurationT = ServerlessV2ScalingConfiguration>
  RestoreDBClusterFromS3Request& WithServerlessV2ScalingConfiguration(ServerlessV2ScalingConfigurationT&& value) {
  ...
  inline RestoreDBClusterFromS3Request& WithManageMasterUserPassword(bool value) {
  ...
  template <typename MasterUserSecretKmsKeyIdT = Aws::String>
  RestoreDBClusterFromS3Request& WithMasterUserSecretKmsKeyId(MasterUserSecretKmsKeyIdT&& value) {
  ...
  template <typename EngineLifecycleSupportT = Aws::String>
  RestoreDBClusterFromS3Request& WithEngineLifecycleSupport(EngineLifecycleSupportT&& value) {
