...
class ModifyDBSnapshotAttributeResult {
 public:
  ...
  template <typename DBSnapshotAttributesResultT = DBSnapshotAttributesResult>
  ModifyDBSnapshotAttributeResult& WithDBSnapshotAttributesResult(DBSnapshotAttributesResultT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBSnapshotAttributeResult& WithResponseMetadata(ResponseMetadataT&& value) {
