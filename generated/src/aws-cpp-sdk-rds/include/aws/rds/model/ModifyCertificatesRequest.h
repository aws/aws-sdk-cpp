...
class ModifyCertificatesRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename CertificateIdentifierT = Aws::String>
  ModifyCertificatesRequest& WithCertificateIdentifier(CertificateIdentifierT&& value) {
  ...
  inline void SetRemoveCustomerOverride(bool value) {
    m_removeCustomerOverrideHasBeenSet = true;
    m_removeCustomerOverride = value;
  }
  inline ModifyCertificatesRequest& WithRemoveCustomerOverride(bool value) {
    SetRemoveCustomerOverride(value);
    return *this;
  }
  ///@}
 private:
