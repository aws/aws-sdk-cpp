...
class ModifyDBRecommendationRequest : public RDSRequest {
 ...
 public:
  ...
  void SetRecommendedActionUpdates(RecommendedActionUpdatesT&& value) {
    m_recommendedActionUpdatesHasBeenSet = true;
    m_recommendedActionUpdates = std::forward<RecommendedActionUpdatesT>(value);
  }
  template <typename RecommendedActionUpdatesT = Aws::Vector<RecommendedActionUpdate>>
  ModifyDBRecommendationRequest& WithRecommendedActionUpdates(RecommendedActionUpdatesT&& value) {
    SetRecommendedActionUpdates(std::forward<RecommendedActionUpdatesT>(value));
    return *this;
  }
  ...
  ModifyDBRecommendationRequest& AddRecommendedActionUpdates(RecommendedActionUpdatesT&& value) {
    m_recommendedActionUpdatesHasBeenSet = true;
    m_recommendedActionUpdates.emplace_back(std::forward<RecommendedActionUpdatesT>(value));
    return *this;
  }
  ///@}
 private:
