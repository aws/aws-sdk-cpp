...
class DescribeDBSnapshotTenantDatabasesRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBInstanceIdentifierT = Aws::String>
  DescribeDBSnapshotTenantDatabasesRequest& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) {
  ...
  template <typename DBSnapshotIdentifierT = Aws::String>
  DescribeDBSnapshotTenantDatabasesRequest& WithDBSnapshotIdentifier(DBSnapshotIdentifierT&& value) {
  ...
  template <typename SnapshotTypeT = Aws::String>
  DescribeDBSnapshotTenantDatabasesRequest& WithSnapshotType(SnapshotTypeT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDBSnapshotTenantDatabasesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDBSnapshotTenantDatabasesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDBSnapshotTenantDatabasesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBSnapshotTenantDatabasesRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename DbiResourceIdT = Aws::String>
  DescribeDBSnapshotTenantDatabasesRequest& WithDbiResourceId(DbiResourceIdT&& value) {
