...
class ModifyCurrentDBClusterCapacityResult {
 public:
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  ModifyCurrentDBClusterCapacityResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  inline void SetPendingCapacity(int value) {
    m_pendingCapacityHasBeenSet = true;
    m_pendingCapacity = value;
  }
  inline ModifyCurrentDBClusterCapacityResult& WithPendingCapacity(int value) {
  ...
  inline void SetCurrentCapacity(int value) {
    m_currentCapacityHasBeenSet = true;
    m_currentCapacity = value;
  }
  inline ModifyCurrentDBClusterCapacityResult& WithCurrentCapacity(int value) {
  ...
  inline ModifyCurrentDBClusterCapacityResult& WithSecondsBeforeTimeout(int value) {
  ...
  template <typename TimeoutActionT = Aws::String>
  ModifyCurrentDBClusterCapacityResult& WithTimeoutAction(TimeoutActionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyCurrentDBClusterCapacityResult& WithResponseMetadata(ResponseMetadataT&& value) {
