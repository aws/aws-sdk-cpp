...
namespace Model
{
  ...
  public:
    ...
    template<typename ImageT = CustomDBEngineVersionAMI>
    DBEngineVersion& WithImage(ImageT&& value) { SetImage(std::forward<ImageT>(value)); return *this;}
    ///@}
    ...
    template<typename SupportedNcharCharacterSetsT = Aws::Vector<CharacterSet>>
    DBEngineVersion& WithSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) { SetSupportedNcharCharacterSets(std::forward<SupportedNcharCharacterSetsT>(value)); return *this;}
    template<typename SupportedNcharCharacterSetsT = CharacterSet>
    DBEngineVersion& AddSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) { m_supportedNcharCharacterSetsHasBeenSet = true; m_supportedNcharCharacterSets.emplace_back(std::forward<SupportedNcharCharacterSetsT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedEngineModesT = Aws::Vector<Aws::String>>
    DBEngineVersion& WithSupportedEngineModes(SupportedEngineModesT&& value) { SetSupportedEngineModes(std::forward<SupportedEngineModesT>(value)); return *this;}
    template<typename SupportedEngineModesT = Aws::String>
    DBEngineVersion& AddSupportedEngineModes(SupportedEngineModesT&& value) { m_supportedEngineModesHasBeenSet = true; m_supportedEngineModes.emplace_back(std::forward<SupportedEngineModesT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedFeatureNamesT = Aws::Vector<Aws::String>>
    DBEngineVersion& WithSupportedFeatureNames(SupportedFeatureNamesT&& value) { SetSupportedFeatureNames(std::forward<SupportedFeatureNamesT>(value)); return *this;}
    template<typename SupportedFeatureNamesT = Aws::String>
    DBEngineVersion& AddSupportedFeatureNames(SupportedFeatureNamesT&& value) { m_supportedFeatureNamesHasBeenSet = true; m_supportedFeatureNames.emplace_back(std::forward<SupportedFeatureNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename StatusT = Aws::String>
    DBEngineVersion& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename TagListT = Aws::Vector<Tag>>
    DBEngineVersion& WithTagList(TagListT&& value) { SetTagList(std::forward<TagListT>(value)); return *this;}
    template<typename TagListT = Tag>
    DBEngineVersion& AddTagList(TagListT&& value) { m_tagListHasBeenSet = true; m_tagList.emplace_back(std::forward<TagListT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DBEngineVersion& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
