...
class PurchaseReservedDBInstancesOfferingRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename ReservedDBInstancesOfferingIdT = Aws::String>
  PurchaseReservedDBInstancesOfferingRequest& WithReservedDBInstancesOfferingId(ReservedDBInstancesOfferingIdT&& value) {
  ...
  template <typename ReservedDBInstanceIdT = Aws::String>
  PurchaseReservedDBInstancesOfferingRequest& WithReservedDBInstanceId(ReservedDBInstanceIdT&& value) {
  ...
  inline PurchaseReservedDBInstancesOfferingRequest& WithDBInstanceCount(int value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  PurchaseReservedDBInstancesOfferingRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  PurchaseReservedDBInstancesOfferingRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
