...
class ModifyGlobalClusterRequest : public RDSRequest {
 ...
 public:
  ...
  void SetNewGlobalClusterIdentifier(NewGlobalClusterIdentifierT&& value) {
    m_newGlobalClusterIdentifierHasBeenSet = true;
    m_newGlobalClusterIdentifier = std::forward<NewGlobalClusterIdentifierT>(value);
  }
  template <typename NewGlobalClusterIdentifierT = Aws::String>
  ModifyGlobalClusterRequest& WithNewGlobalClusterIdentifier(NewGlobalClusterIdentifierT&& value) {
    SetNewGlobalClusterIdentifier(std::forward<NewGlobalClusterIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyGlobalClusterRequest& WithDeletionProtection(bool value) {
  ...
  inline ModifyGlobalClusterRequest& WithAllowMajorVersionUpgrade(bool value) {
