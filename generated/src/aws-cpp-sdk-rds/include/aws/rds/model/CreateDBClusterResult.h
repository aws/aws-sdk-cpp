...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API CreateDBClusterResult() = default;
    AWS_RDS_API CreateDBClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_RDS_API CreateDBClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
