...
class RestoreDBInstanceToPointInTimeRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename SourceDBInstanceIdentifierT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithSourceDBInstanceIdentifier(SourceDBInstanceIdentifierT&& value) {
  ...
  template <typename TargetDBInstanceIdentifierT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithTargetDBInstanceIdentifier(TargetDBInstanceIdentifierT&& value) {
  ...
  void SetRestoreTime(RestoreTimeT&& value) {
    m_restoreTimeHasBeenSet = true;
    m_restoreTime = std::forward<RestoreTimeT>(value);
  }
  template <typename RestoreTimeT = Aws::Utils::DateTime>
  RestoreDBInstanceToPointInTimeRequest& WithRestoreTime(RestoreTimeT&& value) {
    SetRestoreTime(std::forward<RestoreTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithUseLatestRestorableTime(bool value) {
  ...
  template <typename DBInstanceClassT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDBInstanceClass(DBInstanceClassT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename AvailabilityZoneT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename DBSubnetGroupNameT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDBSubnetGroupName(DBSubnetGroupNameT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithPubliclyAccessible(bool value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  template <typename LicenseModelT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithLicenseModel(LicenseModelT&& value) {
  ...
  template <typename DBNameT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDBName(DBNameT&& value) {
  ...
  template <typename EngineT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithEngine(EngineT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithStorageThroughput(int value) {
  ...
  template <typename OptionGroupNameT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithOptionGroupName(OptionGroupNameT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithCopyTagsToSnapshot(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RestoreDBInstanceToPointInTimeRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RestoreDBInstanceToPointInTimeRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename StorageTypeT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithStorageType(StorageTypeT&& value) {
  ...
  template <typename TdeCredentialArnT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithTdeCredentialArn(TdeCredentialArnT&& value) {
  ...
  template <typename TdeCredentialPasswordT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithTdeCredentialPassword(TdeCredentialPasswordT&& value) {
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  RestoreDBInstanceToPointInTimeRequest& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
  ...
  template <typename DomainT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainIAMRoleNameT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDomainIAMRoleName(DomainIAMRoleNameT&& value) {
  ...
  template <typename DomainFqdnT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDomainFqdn(DomainFqdnT&& value) {
  ...
  template <typename DomainOuT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDomainOu(DomainOuT&& value) {
  ...
  template <typename DomainAuthSecretArnT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDomainAuthSecretArn(DomainAuthSecretArnT&& value) {
  ...
  template <typename DomainDnsIpsT = Aws::Vector<Aws::String>>
  RestoreDBInstanceToPointInTimeRequest& WithDomainDnsIps(DomainDnsIpsT&& value) {
    SetDomainDnsIps(std::forward<DomainDnsIpsT>(value));
    return *this;
  }
  template <typename DomainDnsIpsT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& AddDomainDnsIps(DomainDnsIpsT&& value) {
    m_domainDnsIpsHasBeenSet = true;
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  template <typename EnableCloudwatchLogsExportsT = Aws::Vector<Aws::String>>
  RestoreDBInstanceToPointInTimeRequest& WithEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
  ...
  RestoreDBInstanceToPointInTimeRequest& AddEnableCloudwatchLogsExports(EnableCloudwatchLogsExportsT&& value) {
    m_enableCloudwatchLogsExportsHasBeenSet = true;
  ...
  template <typename ProcessorFeaturesT = Aws::Vector<ProcessorFeature>>
  RestoreDBInstanceToPointInTimeRequest& WithProcessorFeatures(ProcessorFeaturesT&& value) {
    SetProcessorFeatures(std::forward<ProcessorFeaturesT>(value));
    return *this;
  }
  template <typename ProcessorFeaturesT = ProcessorFeature>
  RestoreDBInstanceToPointInTimeRequest& AddProcessorFeatures(ProcessorFeaturesT&& value) {
    m_processorFeaturesHasBeenSet = true;
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithUseDefaultProcessorFeatures(bool value) {
  ...
  template <typename DBParameterGroupNameT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithDBParameterGroupName(DBParameterGroupNameT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithDeletionProtection(bool value) {
  ...
  void SetSourceDbiResourceId(SourceDbiResourceIdT&& value) {
    m_sourceDbiResourceIdHasBeenSet = true;
    m_sourceDbiResourceId = std::forward<SourceDbiResourceIdT>(value);
  }
  template <typename SourceDbiResourceIdT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithSourceDbiResourceId(SourceDbiResourceIdT&& value) {
    SetSourceDbiResourceId(std::forward<SourceDbiResourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithMaxAllocatedStorage(int value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithEnableCustomerOwnedIp(bool value) {
  ...
  template <typename NetworkTypeT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithNetworkType(NetworkTypeT&& value) {
  ...
  void SetSourceDBInstanceAutomatedBackupsArn(SourceDBInstanceAutomatedBackupsArnT&& value) {
    m_sourceDBInstanceAutomatedBackupsArnHasBeenSet = true;
    m_sourceDBInstanceAutomatedBackupsArn = std::forward<SourceDBInstanceAutomatedBackupsArnT>(value);
  }
  template <typename SourceDBInstanceAutomatedBackupsArnT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithSourceDBInstanceAutomatedBackupsArn(SourceDBInstanceAutomatedBackupsArnT&& value) {
    SetSourceDBInstanceAutomatedBackupsArn(std::forward<SourceDBInstanceAutomatedBackupsArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BackupTargetT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithBackupTarget(BackupTargetT&& value) {
  ...
  template <typename CustomIamInstanceProfileT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithCustomIamInstanceProfile(CustomIamInstanceProfileT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithAllocatedStorage(int value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithBackupRetentionPeriod(int value) {
  ...
  template <typename PreferredBackupWindowT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithPreferredBackupWindow(PreferredBackupWindowT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithDedicatedLogVolume(bool value) {
  ...
  template <typename CACertificateIdentifierT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithCACertificateIdentifier(CACertificateIdentifierT&& value) {
  ...
  template <typename EngineLifecycleSupportT = Aws::String>
  RestoreDBInstanceToPointInTimeRequest& WithEngineLifecycleSupport(EngineLifecycleSupportT&& value) {
  ...
  inline RestoreDBInstanceToPointInTimeRequest& WithManageMasterUserPassword(bool value) {
