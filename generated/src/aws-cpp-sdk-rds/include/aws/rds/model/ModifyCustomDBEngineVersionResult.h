...
namespace Model
{
  ...
  public:
    ...
    template<typename EngineT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithEngine(EngineT&& value) { SetEngine(std::forward<EngineT>(value)); return *this;}
    ///@}
    ...
    template<typename EngineVersionT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithEngineVersion(EngineVersionT&& value) { SetEngineVersion(std::forward<EngineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename DBParameterGroupFamilyT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) { SetDBParameterGroupFamily(std::forward<DBParameterGroupFamilyT>(value)); return *this;}
    ///@}
    ...
    template<typename DBEngineDescriptionT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDBEngineDescription(DBEngineDescriptionT&& value) { SetDBEngineDescription(std::forward<DBEngineDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DBEngineVersionDescriptionT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDBEngineVersionDescription(DBEngineVersionDescriptionT&& value) { SetDBEngineVersionDescription(std::forward<DBEngineVersionDescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultCharacterSetT = CharacterSet>
    ModifyCustomDBEngineVersionResult& WithDefaultCharacterSet(DefaultCharacterSetT&& value) { SetDefaultCharacterSet(std::forward<DefaultCharacterSetT>(value)); return *this;}
    ///@}
    ...
    template<typename ImageT = CustomDBEngineVersionAMI>
    ModifyCustomDBEngineVersionResult& WithImage(ImageT&& value) { SetImage(std::forward<ImageT>(value)); return *this;}
    ///@}
    ...
    template<typename DBEngineMediaTypeT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDBEngineMediaType(DBEngineMediaTypeT&& value) { SetDBEngineMediaType(std::forward<DBEngineMediaTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename SupportedCharacterSetsT = Aws::Vector<CharacterSet>>
    ModifyCustomDBEngineVersionResult& WithSupportedCharacterSets(SupportedCharacterSetsT&& value) { SetSupportedCharacterSets(std::forward<SupportedCharacterSetsT>(value)); return *this;}
    template<typename SupportedCharacterSetsT = CharacterSet>
    ModifyCustomDBEngineVersionResult& AddSupportedCharacterSets(SupportedCharacterSetsT&& value) { m_supportedCharacterSetsHasBeenSet = true; m_supportedCharacterSets.emplace_back(std::forward<SupportedCharacterSetsT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedNcharCharacterSetsT = Aws::Vector<CharacterSet>>
    ModifyCustomDBEngineVersionResult& WithSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) { SetSupportedNcharCharacterSets(std::forward<SupportedNcharCharacterSetsT>(value)); return *this;}
    template<typename SupportedNcharCharacterSetsT = CharacterSet>
    ModifyCustomDBEngineVersionResult& AddSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) { m_supportedNcharCharacterSetsHasBeenSet = true; m_supportedNcharCharacterSets.emplace_back(std::forward<SupportedNcharCharacterSetsT>(value)); return *this; }
    ///@}
    ...
    template<typename ValidUpgradeTargetT = Aws::Vector<UpgradeTarget>>
    ModifyCustomDBEngineVersionResult& WithValidUpgradeTarget(ValidUpgradeTargetT&& value) { SetValidUpgradeTarget(std::forward<ValidUpgradeTargetT>(value)); return *this;}
    template<typename ValidUpgradeTargetT = UpgradeTarget>
    ModifyCustomDBEngineVersionResult& AddValidUpgradeTarget(ValidUpgradeTargetT&& value) { m_validUpgradeTargetHasBeenSet = true; m_validUpgradeTarget.emplace_back(std::forward<ValidUpgradeTargetT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedTimezonesT = Aws::Vector<Timezone>>
    ModifyCustomDBEngineVersionResult& WithSupportedTimezones(SupportedTimezonesT&& value) { SetSupportedTimezones(std::forward<SupportedTimezonesT>(value)); return *this;}
    template<typename SupportedTimezonesT = Timezone>
    ModifyCustomDBEngineVersionResult& AddSupportedTimezones(SupportedTimezonesT&& value) { m_supportedTimezonesHasBeenSet = true; m_supportedTimezones.emplace_back(std::forward<SupportedTimezonesT>(value)); return *this; }
    ///@}
    ...
    template<typename ExportableLogTypesT = Aws::Vector<Aws::String>>
    ModifyCustomDBEngineVersionResult& WithExportableLogTypes(ExportableLogTypesT&& value) { SetExportableLogTypes(std::forward<ExportableLogTypesT>(value)); return *this;}
    template<typename ExportableLogTypesT = Aws::String>
    ModifyCustomDBEngineVersionResult& AddExportableLogTypes(ExportableLogTypesT&& value) { m_exportableLogTypesHasBeenSet = true; m_exportableLogTypes.emplace_back(std::forward<ExportableLogTypesT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedEngineModesT = Aws::Vector<Aws::String>>
    ModifyCustomDBEngineVersionResult& WithSupportedEngineModes(SupportedEngineModesT&& value) { SetSupportedEngineModes(std::forward<SupportedEngineModesT>(value)); return *this;}
    template<typename SupportedEngineModesT = Aws::String>
    ModifyCustomDBEngineVersionResult& AddSupportedEngineModes(SupportedEngineModesT&& value) { m_supportedEngineModesHasBeenSet = true; m_supportedEngineModes.emplace_back(std::forward<SupportedEngineModesT>(value)); return *this; }
    ///@}
    ...
    template<typename SupportedFeatureNamesT = Aws::Vector<Aws::String>>
    ModifyCustomDBEngineVersionResult& WithSupportedFeatureNames(SupportedFeatureNamesT&& value) { SetSupportedFeatureNames(std::forward<SupportedFeatureNamesT>(value)); return *this;}
    template<typename SupportedFeatureNamesT = Aws::String>
    ModifyCustomDBEngineVersionResult& AddSupportedFeatureNames(SupportedFeatureNamesT&& value) { m_supportedFeatureNamesHasBeenSet = true; m_supportedFeatureNames.emplace_back(std::forward<SupportedFeatureNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename StatusT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename MajorEngineVersionT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithMajorEngineVersion(MajorEngineVersionT&& value) { SetMajorEngineVersion(std::forward<MajorEngineVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseInstallationFilesS3BucketNameT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDatabaseInstallationFilesS3BucketName(DatabaseInstallationFilesS3BucketNameT&& value) { SetDatabaseInstallationFilesS3BucketName(std::forward<DatabaseInstallationFilesS3BucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseInstallationFilesS3PrefixT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDatabaseInstallationFilesS3Prefix(DatabaseInstallationFilesS3PrefixT&& value) { SetDatabaseInstallationFilesS3Prefix(std::forward<DatabaseInstallationFilesS3PrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename DBEngineVersionArnT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithDBEngineVersionArn(DBEngineVersionArnT&& value) { SetDBEngineVersionArn(std::forward<DBEngineVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyIdT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithKMSKeyId(KMSKeyIdT&& value) { SetKMSKeyId(std::forward<KMSKeyIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    ModifyCustomDBEngineVersionResult& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename TagListT = Aws::Vector<Tag>>
    ModifyCustomDBEngineVersionResult& WithTagList(TagListT&& value) { SetTagList(std::forward<TagListT>(value)); return *this;}
    template<typename TagListT = Tag>
    ModifyCustomDBEngineVersionResult& AddTagList(TagListT&& value) { m_tagListHasBeenSet = true; m_tagList.emplace_back(std::forward<TagListT>(value)); return *this; }
    ///@}
    ...
    template<typename CustomDBEngineVersionManifestT = Aws::String>
    ModifyCustomDBEngineVersionResult& WithCustomDBEngineVersionManifest(CustomDBEngineVersionManifestT&& value) { SetCustomDBEngineVersionManifest(std::forward<CustomDBEngineVersionManifestT>(value)); return *this;}
    ///@}
    ...
    template<typename SupportedCACertificateIdentifiersT = Aws::Vector<Aws::String>>
    ModifyCustomDBEngineVersionResult& WithSupportedCACertificateIdentifiers(SupportedCACertificateIdentifiersT&& value) { SetSupportedCACertificateIdentifiers(std::forward<SupportedCACertificateIdentifiersT>(value)); return *this;}
    template<typename SupportedCACertificateIdentifiersT = Aws::String>
    ModifyCustomDBEngineVersionResult& AddSupportedCACertificateIdentifiers(SupportedCACertificateIdentifiersT&& value) { m_supportedCACertificateIdentifiersHasBeenSet = true; m_supportedCACertificateIdentifiers.emplace_back(std::forward<SupportedCACertificateIdentifiersT>(value)); return *this; }
    ///@}
    ...
    template<typename ServerlessV2FeaturesSupportT = ServerlessV2FeaturesSupport>
    ModifyCustomDBEngineVersionResult& WithServerlessV2FeaturesSupport(ServerlessV2FeaturesSupportT&& value) { SetServerlessV2FeaturesSupport(std::forward<ServerlessV2FeaturesSupportT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyCustomDBEngineVersionResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
