...
class ServerlessV2ScalingConfigurationInfo {
 public:
  ...
  inline ServerlessV2ScalingConfigurationInfo& WithMinCapacity(double value) {
  ...
  inline ServerlessV2ScalingConfigurationInfo& WithMaxCapacity(double value) {
  ...
  inline ServerlessV2ScalingConfigurationInfo& WithSecondsUntilAutoPause(int value) {
