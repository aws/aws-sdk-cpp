...
class DBProxyEndpoint {
 public:
  ...
  void SetDBProxyEndpointArn(DBProxyEndpointArnT&& value) {
    ...
    m_dBProxyEndpointArn = std::forward<DBProxyEndpointArnT>(value);
  }
  template <typename DBProxyEndpointArnT = Aws::String>
  DBProxyEndpoint& WithDBProxyEndpointArn(DBProxyEndpointArnT&& value) {
    SetDBProxyEndpointArn(std::forward<DBProxyEndpointArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DBProxyEndpointStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DBProxyEndpoint& WithStatus(DBProxyEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetRole(DBProxyEndpointTargetRole value) {
    m_targetRoleHasBeenSet = true;
    m_targetRole = value;
  }
  inline DBProxyEndpoint& WithTargetRole(DBProxyEndpointTargetRole value) {
    SetTargetRole(value);
    return *this;
  }
  ///@}
  ...
  inline DBProxyEndpoint& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline DBProxyEndpoint& WithEndpointNetworkType(EndpointNetworkType value) {
