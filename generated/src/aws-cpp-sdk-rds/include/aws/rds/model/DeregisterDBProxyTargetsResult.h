...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API DeregisterDBProxyTargetsResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeregisterDBProxyTargetsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
