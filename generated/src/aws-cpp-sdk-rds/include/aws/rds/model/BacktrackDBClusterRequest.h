...
class BacktrackDBClusterRequest : public RDSRequest {
 ...
 public:
  ...
  inline BacktrackDBClusterRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUseEarliestTimeOnPointInTimeUnavailable(bool value) {
    m_useEarliestTimeOnPointInTimeUnavailableHasBeenSet = true;
    m_useEarliestTimeOnPointInTimeUnavailable = value;
  }
  inline BacktrackDBClusterRequest& WithUseEarliestTimeOnPointInTimeUnavailable(bool value) {
    SetUseEarliestTimeOnPointInTimeUnavailable(value);
    return *this;
  }
  ///@}
 private:
