...
class SwitchoverDetail {
 public:
  ...
  void SetSourceMember(SourceMemberT&& value) {
    m_sourceMemberHasBeenSet = true;
    m_sourceMember = std::forward<SourceMemberT>(value);
  }
  template <typename SourceMemberT = Aws::String>
  SwitchoverDetail& WithSourceMember(SourceMemberT&& value) {
    SetSourceMember(std::forward<SourceMemberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetMember(TargetMemberT&& value) {
    m_targetMemberHasBeenSet = true;
    m_targetMember = std::forward<TargetMemberT>(value);
  }
  template <typename TargetMemberT = Aws::String>
  SwitchoverDetail& WithTargetMember(TargetMemberT&& value) {
    SetTargetMember(std::forward<TargetMemberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  SwitchoverDetail& WithStatus(StatusT&& value) {
