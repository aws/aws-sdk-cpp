...
class ModifyActivityStreamResult {
 public:
  ...
  void SetKinesisStreamName(KinesisStreamNameT&& value) {
    ...
    m_kinesisStreamName = std::forward<KinesisStreamNameT>(value);
  }
  template <typename KinesisStreamNameT = Aws::String>
  ModifyActivityStreamResult& WithKinesisStreamName(KinesisStreamNameT&& value) {
    SetKinesisStreamName(std::forward<KinesisStreamNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ActivityStreamStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ModifyActivityStreamResult& WithStatus(ActivityStreamStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMode(ActivityStreamMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ModifyActivityStreamResult& WithMode(ActivityStreamMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEngineNativeAuditFieldsIncluded(bool value) {
    m_engineNativeAuditFieldsIncludedHasBeenSet = true;
    m_engineNativeAuditFieldsIncluded = value;
  }
  inline ModifyActivityStreamResult& WithEngineNativeAuditFieldsIncluded(bool value) {
    SetEngineNativeAuditFieldsIncluded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPolicyStatus(ActivityStreamPolicyStatus value) {
    m_policyStatusHasBeenSet = true;
    m_policyStatus = value;
  }
  inline ModifyActivityStreamResult& WithPolicyStatus(ActivityStreamPolicyStatus value) {
