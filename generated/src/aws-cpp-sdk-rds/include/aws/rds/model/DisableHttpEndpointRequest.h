...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API DisableHttpEndpointRequest() = default;
  ...
  public:
    ...
    template<typename ResourceArnT = Aws::String>
    DisableHttpEndpointRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
