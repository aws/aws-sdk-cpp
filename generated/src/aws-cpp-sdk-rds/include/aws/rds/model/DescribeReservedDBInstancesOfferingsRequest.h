...
class DescribeReservedDBInstancesOfferingsRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename ReservedDBInstancesOfferingIdT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithReservedDBInstancesOfferingId(ReservedDBInstancesOfferingIdT&& value) {
  ...
  template <typename DBInstanceClassT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithDBInstanceClass(DBInstanceClassT&& value) {
  ...
  template <typename DurationT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithDuration(DurationT&& value) {
  ...
  template <typename ProductDescriptionT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithProductDescription(ProductDescriptionT&& value) {
  ...
  template <typename OfferingTypeT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithOfferingType(OfferingTypeT&& value) {
  ...
  inline DescribeReservedDBInstancesOfferingsRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeReservedDBInstancesOfferingsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeReservedDBInstancesOfferingsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeReservedDBInstancesOfferingsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedDBInstancesOfferingsRequest& WithMarker(MarkerT&& value) {
