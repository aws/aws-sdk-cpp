...
class DescribeDBInstanceAutomatedBackupsRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DbiResourceIdT = Aws::String>
  DescribeDBInstanceAutomatedBackupsRequest& WithDbiResourceId(DbiResourceIdT&& value) {
  ...
  template <typename DBInstanceIdentifierT = Aws::String>
  DescribeDBInstanceAutomatedBackupsRequest& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDBInstanceAutomatedBackupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDBInstanceAutomatedBackupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDBInstanceAutomatedBackupsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBInstanceAutomatedBackupsRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename DBInstanceAutomatedBackupsArnT = Aws::String>
  DescribeDBInstanceAutomatedBackupsRequest& WithDBInstanceAutomatedBackupsArn(DBInstanceAutomatedBackupsArnT&& value) {
