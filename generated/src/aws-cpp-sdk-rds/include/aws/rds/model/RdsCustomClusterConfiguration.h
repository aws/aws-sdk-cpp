...
class RdsCustomClusterConfiguration {
 public:
  ...
  void SetInterconnectSubnetId(InterconnectSubnetIdT&& value) {
    m_interconnectSubnetIdHasBeenSet = true;
    m_interconnectSubnetId = std::forward<InterconnectSubnetIdT>(value);
  }
  template <typename InterconnectSubnetIdT = Aws::String>
  RdsCustomClusterConfiguration& WithInterconnectSubnetId(InterconnectSubnetIdT&& value) {
    SetInterconnectSubnetId(std::forward<InterconnectSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  RdsCustomClusterConfiguration& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  inline RdsCustomClusterConfiguration& WithReplicaMode(ReplicaMode value) {
