...
class ReservedDBInstance {
 public:
  ...
  void SetReservedDBInstanceId(ReservedDBInstanceIdT&& value) {
    ...
    m_reservedDBInstanceId = std::forward<ReservedDBInstanceIdT>(value);
  }
  template <typename ReservedDBInstanceIdT = Aws::String>
  ReservedDBInstance& WithReservedDBInstanceId(ReservedDBInstanceIdT&& value) {
    SetReservedDBInstanceId(std::forward<ReservedDBInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReservedDBInstance& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedDBInstance& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedDBInstance& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDBInstanceCount(int value) {
    m_dBInstanceCountHasBeenSet = true;
    m_dBInstanceCount = value;
  }
  inline ReservedDBInstance& WithDBInstanceCount(int value) {
    SetDBInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedDBInstance& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  void SetReservedDBInstanceArn(ReservedDBInstanceArnT&& value) {
    ...
    m_reservedDBInstanceArn = std::forward<ReservedDBInstanceArnT>(value);
  }
  template <typename ReservedDBInstanceArnT = Aws::String>
  ReservedDBInstance& WithReservedDBInstanceArn(ReservedDBInstanceArnT&& value) {
    SetReservedDBInstanceArn(std::forward<ReservedDBInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLeaseId(LeaseIdT&& value) {
    ...
    m_leaseId = std::forward<LeaseIdT>(value);
  }
  template <typename LeaseIdT = Aws::String>
  ReservedDBInstance& WithLeaseId(LeaseIdT&& value) {
    SetLeaseId(std::forward<LeaseIdT>(value));
    return *this;
  }
  ///@}
 private:
