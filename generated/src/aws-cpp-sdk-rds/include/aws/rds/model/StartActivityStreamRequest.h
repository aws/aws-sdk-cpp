...
class StartActivityStreamRequest : public RDSRequest {
 ...
 public:
  ...
  inline StartActivityStreamRequest& WithMode(ActivityStreamMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline StartActivityStreamRequest& WithApplyImmediately(bool value) {
  ...
  inline StartActivityStreamRequest& WithEngineNativeAuditFieldsIncluded(bool value) {
