...
class StartDBInstanceAutomatedBackupsReplicationResult {
 public:
  ...
  AWS_RDS_API StartDBInstanceAutomatedBackupsReplicationResult& operator=(
  ...
  void SetDBInstanceAutomatedBackup(DBInstanceAutomatedBackupT&& value) {
    m_dBInstanceAutomatedBackupHasBeenSet = true;
    m_dBInstanceAutomatedBackup = std::forward<DBInstanceAutomatedBackupT>(value);
  }
  template <typename DBInstanceAutomatedBackupT = DBInstanceAutomatedBackup>
  StartDBInstanceAutomatedBackupsReplicationResult& WithDBInstanceAutomatedBackup(DBInstanceAutomatedBackupT&& value) {
    SetDBInstanceAutomatedBackup(std::forward<DBInstanceAutomatedBackupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartDBInstanceAutomatedBackupsReplicationResult& WithResponseMetadata(ResponseMetadataT&& value) {
