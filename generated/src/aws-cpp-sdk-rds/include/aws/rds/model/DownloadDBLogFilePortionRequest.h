...
class DownloadDBLogFilePortionRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBInstanceIdentifierT = Aws::String>
  DownloadDBLogFilePortionRequest& WithDBInstanceIdentifier(DBInstanceIdentifierT&& value) {
  ...
  void SetLogFileName(LogFileNameT&& value) {
    ...
    m_logFileName = std::forward<LogFileNameT>(value);
  }
  template <typename LogFileNameT = Aws::String>
  DownloadDBLogFilePortionRequest& WithLogFileName(LogFileNameT&& value) {
    SetLogFileName(std::forward<LogFileNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DownloadDBLogFilePortionRequest& WithMarker(MarkerT&& value) {
  ...
  inline void SetNumberOfLines(int value) {
    m_numberOfLinesHasBeenSet = true;
    m_numberOfLines = value;
  }
  inline DownloadDBLogFilePortionRequest& WithNumberOfLines(int value) {
