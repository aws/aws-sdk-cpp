...
class DescribeDBProxiesRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBProxyNameT = Aws::String>
  DescribeDBProxiesRequest& WithDBProxyName(DBProxyNameT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDBProxiesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDBProxiesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxiesRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeDBProxiesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
