...
class DescribeDBInstanceAutomatedBackupsResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBInstanceAutomatedBackupsResult& WithMarker(MarkerT&& value) {
  ...
  void SetDBInstanceAutomatedBackups(DBInstanceAutomatedBackupsT&& value) {
    m_dBInstanceAutomatedBackupsHasBeenSet = true;
    m_dBInstanceAutomatedBackups = std::forward<DBInstanceAutomatedBackupsT>(value);
  }
  template <typename DBInstanceAutomatedBackupsT = Aws::Vector<DBInstanceAutomatedBackup>>
  DescribeDBInstanceAutomatedBackupsResult& WithDBInstanceAutomatedBackups(DBInstanceAutomatedBackupsT&& value) {
    SetDBInstanceAutomatedBackups(std::forward<DBInstanceAutomatedBackupsT>(value));
    return *this;
  }
  template <typename DBInstanceAutomatedBackupsT = DBInstanceAutomatedBackup>
  DescribeDBInstanceAutomatedBackupsResult& AddDBInstanceAutomatedBackups(DBInstanceAutomatedBackupsT&& value) {
    m_dBInstanceAutomatedBackupsHasBeenSet = true;
    m_dBInstanceAutomatedBackups.emplace_back(std::forward<DBInstanceAutomatedBackupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBInstanceAutomatedBackupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
