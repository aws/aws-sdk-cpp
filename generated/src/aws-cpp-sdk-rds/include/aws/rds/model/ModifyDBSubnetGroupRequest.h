...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/ModifyDBSubnetGroupMessage">AWS
   * API Reference</a></p>
   */
  class ModifyDBSubnetGroupRequest : public RDSRequest
  {
  public:
    AWS_RDS_API ModifyDBSubnetGroupRequest();
