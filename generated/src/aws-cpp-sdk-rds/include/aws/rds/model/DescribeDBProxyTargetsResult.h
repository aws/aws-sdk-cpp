...
class DescribeDBProxyTargetsResult {
 public:
  ...
  template <typename TargetsT = Aws::Vector<DBProxyTarget>>
  DescribeDBProxyTargetsResult& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = DBProxyTarget>
  DescribeDBProxyTargetsResult& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxyTargetsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBProxyTargetsResult& WithResponseMetadata(ResponseMetadataT&& value) {
