...
class ModifyDBInstanceRequest : public RDSRequest {
 ...
 public:
  ...
  inline ModifyDBInstanceRequest& WithAllocatedStorage(int value) {
  ...
  inline ModifyDBInstanceRequest& WithBackupRetentionPeriod(int value) {
  ...
  inline ModifyDBInstanceRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithAllowMajorVersionUpgrade(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithStorageThroughput(int value) {
  ...
  inline void SetDisableDomain(bool value) {
    m_disableDomainHasBeenSet = true;
    m_disableDomain = value;
  }
  inline ModifyDBInstanceRequest& WithDisableDomain(bool value) {
    SetDisableDomain(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithMonitoringInterval(int value) {
  ...
  inline void SetDBPortNumber(int value) {
    m_dBPortNumberHasBeenSet = true;
    m_dBPortNumber = value;
  }
  inline ModifyDBInstanceRequest& WithDBPortNumber(int value) {
    SetDBPortNumber(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithPubliclyAccessible(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithDatabaseInsightsMode(DatabaseInsightsMode value) {
  ...
  inline ModifyDBInstanceRequest& WithPerformanceInsightsRetentionPeriod(int value) {
  ...
  inline ModifyDBInstanceRequest& WithUseDefaultProcessorFeatures(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithDeletionProtection(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithMaxAllocatedStorage(int value) {
   ...
   * <p>Standby DB replicas are included in Db2 Advanced Edition (AE), Db2 Community
   ...
   * connections, a standby replica can't serve a read-only workload.</p> <p>You can
   * create a combination of standby and read-only DB replicas for the same primary
  ...
  inline ModifyDBInstanceRequest& WithReplicaMode(ReplicaMode value) {
  ...
  inline ModifyDBInstanceRequest& WithAutomationMode(AutomationMode value) {
  ...
  inline void SetResumeFullAutomationModeMinutes(int value) {
    m_resumeFullAutomationModeMinutesHasBeenSet = true;
    m_resumeFullAutomationModeMinutes = value;
  }
  inline ModifyDBInstanceRequest& WithResumeFullAutomationModeMinutes(int value) {
    SetResumeFullAutomationModeMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBInstanceRequest& WithEnableCustomerOwnedIp(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithManageMasterUserPassword(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithRotateMasterUserPassword(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithMultiTenant(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithDedicatedLogVolume(bool value) {
  ...
  inline ModifyDBInstanceRequest& WithMasterUserAuthenticationType(MasterUserAuthenticationType value) {
