...
namespace Model
{
  ...
  public:
     ...
     * Web Services Secrets Manager.</p> <p>If the DB instance doesn't manage the
     * master user password with Amazon Web Services Secrets Manager, you can turn on
     * this management. In this case, you can't specify
     * <code>MasterUserPassword</code>.</p> <p>If the DB instance already manages the
     ...
     * Manager, then you must specify <code>MasterUserPassword</code>. In this case,
     * RDS deletes the secret and uses the new password for the master user specified
     * by <code>MasterUserPassword</code>.</p> <p>For more information, see <a
