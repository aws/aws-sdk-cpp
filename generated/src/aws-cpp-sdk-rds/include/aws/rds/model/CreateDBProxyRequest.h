...
class CreateDBProxyRequest : public RDSRequest {
 ...
 public:
  ...
  inline void SetEngineFamily(EngineFamily value) {
    m_engineFamilyHasBeenSet = true;
    m_engineFamily = value;
  }
  inline CreateDBProxyRequest& WithEngineFamily(EngineFamily value) {
    SetEngineFamily(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBProxyRequest& WithDefaultAuthScheme(DefaultAuthScheme value) {
  ...
  inline CreateDBProxyRequest& WithRequireTLS(bool value) {
    SetRequireTLS(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBProxyRequest& WithIdleClientTimeout(int value) {
  ...
  inline CreateDBProxyRequest& WithDebugLogging(bool value) {
  ...
  inline CreateDBProxyRequest& WithEndpointNetworkType(EndpointNetworkType value) {
  ...
  inline CreateDBProxyRequest& WithTargetConnectionNetworkType(TargetConnectionNetworkType value) {
