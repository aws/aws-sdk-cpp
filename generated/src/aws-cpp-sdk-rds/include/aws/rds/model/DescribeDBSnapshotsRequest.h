...
class DescribeDBSnapshotsRequest : public RDSRequest {
 ...
 public:
  ...
  inline DescribeDBSnapshotsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDBSnapshotsRequest& WithIncludeShared(bool value) {
  ...
  inline DescribeDBSnapshotsRequest& WithIncludePublic(bool value) {
