...
class CopyOptionGroupResult {
 public:
  AWS_RDS_API CopyOptionGroupResult() = default;
  ...
  template <typename OptionGroupT = OptionGroup>
  CopyOptionGroupResult& WithOptionGroup(OptionGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CopyOptionGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
