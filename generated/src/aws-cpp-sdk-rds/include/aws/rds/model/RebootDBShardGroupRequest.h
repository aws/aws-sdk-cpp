...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API RebootDBShardGroupRequest() = default;
  ...
  public:
    ...
    template<typename DBShardGroupIdentifierT = Aws::String>
    RebootDBShardGroupRequest& WithDBShardGroupIdentifier(DBShardGroupIdentifierT&& value) { SetDBShardGroupIdentifier(std::forward<DBShardGroupIdentifierT>(value)); return *this;}
    ///@}
  private:
