...
class DescribeDBProxyTargetGroupsRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBProxyNameT = Aws::String>
  DescribeDBProxyTargetGroupsRequest& WithDBProxyName(DBProxyNameT&& value) {
  ...
  template <typename TargetGroupNameT = Aws::String>
  DescribeDBProxyTargetGroupsRequest& WithTargetGroupName(TargetGroupNameT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDBProxyTargetGroupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDBProxyTargetGroupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxyTargetGroupsRequest& WithMarker(MarkerT&& value) {
  ...
  inline DescribeDBProxyTargetGroupsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
