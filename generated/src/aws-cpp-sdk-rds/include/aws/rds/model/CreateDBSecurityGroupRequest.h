...
class CreateDBSecurityGroupRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBSecurityGroupNameT = Aws::String>
  CreateDBSecurityGroupRequest& WithDBSecurityGroupName(DBSecurityGroupNameT&& value) {
  ...
  void SetDBSecurityGroupDescription(DBSecurityGroupDescriptionT&& value) {
    ...
    m_dBSecurityGroupDescription = std::forward<DBSecurityGroupDescriptionT>(value);
  }
  template <typename DBSecurityGroupDescriptionT = Aws::String>
  CreateDBSecurityGroupRequest& WithDBSecurityGroupDescription(DBSecurityGroupDescriptionT&& value) {
    SetDBSecurityGroupDescription(std::forward<DBSecurityGroupDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateDBSecurityGroupRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateDBSecurityGroupRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
