...
class DescribeDBClusterBacktracksResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBClusterBacktracksResult& WithMarker(MarkerT&& value) {
  ...
  void SetDBClusterBacktracks(DBClusterBacktracksT&& value) {
    m_dBClusterBacktracksHasBeenSet = true;
    m_dBClusterBacktracks = std::forward<DBClusterBacktracksT>(value);
  }
  template <typename DBClusterBacktracksT = Aws::Vector<DBClusterBacktrack>>
  DescribeDBClusterBacktracksResult& WithDBClusterBacktracks(DBClusterBacktracksT&& value) {
    SetDBClusterBacktracks(std::forward<DBClusterBacktracksT>(value));
    return *this;
  }
  template <typename DBClusterBacktracksT = DBClusterBacktrack>
  DescribeDBClusterBacktracksResult& AddDBClusterBacktracks(DBClusterBacktracksT&& value) {
    m_dBClusterBacktracksHasBeenSet = true;
    m_dBClusterBacktracks.emplace_back(std::forward<DBClusterBacktracksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBClusterBacktracksResult& WithResponseMetadata(ResponseMetadataT&& value) {
