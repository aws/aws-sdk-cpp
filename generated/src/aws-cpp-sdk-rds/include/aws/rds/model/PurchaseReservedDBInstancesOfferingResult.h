...
class PurchaseReservedDBInstancesOfferingResult {
 public:
  ...
  void SetReservedDBInstance(ReservedDBInstanceT&& value) {
    m_reservedDBInstanceHasBeenSet = true;
    m_reservedDBInstance = std::forward<ReservedDBInstanceT>(value);
  }
  template <typename ReservedDBInstanceT = ReservedDBInstance>
  PurchaseReservedDBInstancesOfferingResult& WithReservedDBInstance(ReservedDBInstanceT&& value) {
    SetReservedDBInstance(std::forward<ReservedDBInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  PurchaseReservedDBInstancesOfferingResult& WithResponseMetadata(ResponseMetadataT&& value) {
