...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API DeleteDBSnapshotResult() = default;
    ...
    template<typename DBSnapshotT = DBSnapshot>
    DeleteDBSnapshotResult& WithDBSnapshot(DBSnapshotT&& value) { SetDBSnapshot(std::forward<DBSnapshotT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteDBSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
