...
class ScalingConfigurationInfo {
 public:
  ...
  inline ScalingConfigurationInfo& WithMinCapacity(int value) {
  ...
  inline ScalingConfigurationInfo& WithMaxCapacity(int value) {
  ...
  inline void SetAutoPause(bool value) {
    m_autoPauseHasBeenSet = true;
    m_autoPause = value;
  }
  inline ScalingConfigurationInfo& WithAutoPause(bool value) {
    SetAutoPause(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSecondsUntilAutoPause(int value) {
    m_secondsUntilAutoPauseHasBeenSet = true;
    m_secondsUntilAutoPause = value;
  }
  inline ScalingConfigurationInfo& WithSecondsUntilAutoPause(int value) {
    SetSecondsUntilAutoPause(value);
    return *this;
  }
  ///@}
  ...
  void SetTimeoutAction(TimeoutActionT&& value) {
    ...
    m_timeoutAction = std::forward<TimeoutActionT>(value);
  }
  template <typename TimeoutActionT = Aws::String>
  ScalingConfigurationInfo& WithTimeoutAction(TimeoutActionT&& value) {
    SetTimeoutAction(std::forward<TimeoutActionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSecondsBeforeTimeout(int value) {
    m_secondsBeforeTimeoutHasBeenSet = true;
    m_secondsBeforeTimeout = value;
  }
  inline ScalingConfigurationInfo& WithSecondsBeforeTimeout(int value) {
    SetSecondsBeforeTimeout(value);
    return *this;
  }
  ///@}
 private:
