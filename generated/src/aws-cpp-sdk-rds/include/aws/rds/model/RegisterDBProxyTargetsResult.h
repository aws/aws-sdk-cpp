...
class RegisterDBProxyTargetsResult {
 public:
  ...
  void SetDBProxyTargets(DBProxyTargetsT&& value) {
    m_dBProxyTargetsHasBeenSet = true;
    m_dBProxyTargets = std::forward<DBProxyTargetsT>(value);
  }
  template <typename DBProxyTargetsT = Aws::Vector<DBProxyTarget>>
  RegisterDBProxyTargetsResult& WithDBProxyTargets(DBProxyTargetsT&& value) {
    SetDBProxyTargets(std::forward<DBProxyTargetsT>(value));
    return *this;
  }
  template <typename DBProxyTargetsT = DBProxyTarget>
  RegisterDBProxyTargetsResult& AddDBProxyTargets(DBProxyTargetsT&& value) {
    m_dBProxyTargetsHasBeenSet = true;
    m_dBProxyTargets.emplace_back(std::forward<DBProxyTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RegisterDBProxyTargetsResult& WithResponseMetadata(ResponseMetadataT&& value) {
