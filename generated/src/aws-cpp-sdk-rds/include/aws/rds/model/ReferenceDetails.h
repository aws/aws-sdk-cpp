...
class ReferenceDetails {
 public:
  ...
  void SetScalarReferenceDetails(ScalarReferenceDetailsT&& value) {
    m_scalarReferenceDetailsHasBeenSet = true;
    m_scalarReferenceDetails = std::forward<ScalarReferenceDetailsT>(value);
  }
  template <typename ScalarReferenceDetailsT = ScalarReferenceDetails>
  ReferenceDetails& WithScalarReferenceDetails(ScalarReferenceDetailsT&& value) {
    SetScalarReferenceDetails(std::forward<ScalarReferenceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
