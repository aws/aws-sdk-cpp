...
class DBClusterMember {
 public:
  ...
  inline void SetIsClusterWriter(bool value) {
    m_isClusterWriterHasBeenSet = true;
    m_isClusterWriter = value;
  }
  inline DBClusterMember& WithIsClusterWriter(bool value) {
    SetIsClusterWriter(value);
    return *this;
  }
  ///@}
  ...
  void SetDBClusterParameterGroupStatus(DBClusterParameterGroupStatusT&& value) {
    ...
    m_dBClusterParameterGroupStatus = std::forward<DBClusterParameterGroupStatusT>(value);
  }
  template <typename DBClusterParameterGroupStatusT = Aws::String>
  DBClusterMember& WithDBClusterParameterGroupStatus(DBClusterParameterGroupStatusT&& value) {
    SetDBClusterParameterGroupStatus(std::forward<DBClusterParameterGroupStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline DBClusterMember& WithPromotionTier(int value) {
