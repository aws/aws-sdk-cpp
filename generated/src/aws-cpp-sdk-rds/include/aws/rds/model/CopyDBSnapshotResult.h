...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API CopyDBSnapshotResult() = default;
    ...
    template<typename DBSnapshotT = DBSnapshot>
    CopyDBSnapshotResult& WithDBSnapshot(DBSnapshotT&& value) { SetDBSnapshot(std::forward<DBSnapshotT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CopyDBSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
