...
class UserAuthConfigInfo {
 public:
  ...
  inline void SetAuthScheme(AuthScheme value) {
    m_authSchemeHasBeenSet = true;
    m_authScheme = value;
  }
  inline UserAuthConfigInfo& WithAuthScheme(AuthScheme value) {
    SetAuthScheme(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIAMAuth(IAMAuthMode value) {
    m_iAMAuthHasBeenSet = true;
    m_iAMAuth = value;
  }
  inline UserAuthConfigInfo& WithIAMAuth(IAMAuthMode value) {
    SetIAMAuth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClientPasswordAuthType(ClientPasswordAuthType value) {
    m_clientPasswordAuthTypeHasBeenSet = true;
    m_clientPasswordAuthType = value;
  }
  inline UserAuthConfigInfo& WithClientPasswordAuthType(ClientPasswordAuthType value) {
    SetClientPasswordAuthType(value);
    return *this;
  }
  ///@}
 private:
