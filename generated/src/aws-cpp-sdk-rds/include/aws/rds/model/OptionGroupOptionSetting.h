...
class OptionGroupOptionSetting {
 public:
  ...
  void SetSettingName(SettingNameT&& value) {
    ...
    m_settingName = std::forward<SettingNameT>(value);
  }
  template <typename SettingNameT = Aws::String>
  OptionGroupOptionSetting& WithSettingName(SettingNameT&& value) {
    SetSettingName(std::forward<SettingNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSettingDescription(SettingDescriptionT&& value) {
    ...
    m_settingDescription = std::forward<SettingDescriptionT>(value);
  }
  template <typename SettingDescriptionT = Aws::String>
  OptionGroupOptionSetting& WithSettingDescription(SettingDescriptionT&& value) {
    SetSettingDescription(std::forward<SettingDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline OptionGroupOptionSetting& WithIsModifiable(bool value) {
  ...
  inline OptionGroupOptionSetting& WithIsRequired(bool value) {
    SetIsRequired(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<MinimumEngineVersionPerAllowedValue>& GetMinimumEngineVersionPerAllowedValue() const {
    return m_minimumEngineVersionPerAllowedValue;
  }
  ...
  void SetMinimumEngineVersionPerAllowedValue(MinimumEngineVersionPerAllowedValueT&& value) {
    ...
    m_minimumEngineVersionPerAllowedValue = std::forward<MinimumEngineVersionPerAllowedValueT>(value);
  }
  template <typename MinimumEngineVersionPerAllowedValueT = Aws::Vector<MinimumEngineVersionPerAllowedValue>>
  OptionGroupOptionSetting& WithMinimumEngineVersionPerAllowedValue(MinimumEngineVersionPerAllowedValueT&& value) {
    SetMinimumEngineVersionPerAllowedValue(std::forward<MinimumEngineVersionPerAllowedValueT>(value));
    return *this;
  }
  ...
  OptionGroupOptionSetting& AddMinimumEngineVersionPerAllowedValue(MinimumEngineVersionPerAllowedValueT&& value) {
    m_minimumEngineVersionPerAllowedValueHasBeenSet = true;
    m_minimumEngineVersionPerAllowedValue.emplace_back(std::forward<MinimumEngineVersionPerAllowedValueT>(value));
    return *this;
  }
  ///@}
 private:
