...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API RestoreDBClusterFromS3Result() = default;
    ...
    template<typename DBClusterT = DBCluster>
    RestoreDBClusterFromS3Result& WithDBCluster(DBClusterT&& value) { SetDBCluster(std::forward<DBClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RestoreDBClusterFromS3Result& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
