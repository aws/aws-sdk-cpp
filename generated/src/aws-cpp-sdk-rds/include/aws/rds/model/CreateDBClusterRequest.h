...
class CreateDBClusterRequest : public RDSRequest {
 ...
 public:
  ...
  inline CreateDBClusterRequest& WithEnableIAMDatabaseAuthentication(bool value) {
  ...
  inline CreateDBClusterRequest& WithBacktrackWindow(long long value) {
  ...
  inline CreateDBClusterRequest& WithAllocatedStorage(int value) {
  ...
  inline CreateDBClusterRequest& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>Specifies whether the DB cluster is publicly accessible.</p> <p>Valid for
   * Cluster Type: Multi-AZ DB clusters only</p> <p>When the DB cluster is publicly
   * accessible and you connect from outside of the DB cluster's virtual private
   * cloud (VPC), its domain name system (DNS) endpoint resolves to the public IP
   * address. When you connect from within the same VPC as the DB cluster, the
   * endpoint resolves to the private IP address. Access to the DB cluster is
   * controlled by its security group settings.</p> <p>When the DB cluster isn't
   * publicly accessible, it is an internal DB cluster with a DNS name that resolves
   * to a private IP address.</p> <p>The default behavior when
   * <code>PubliclyAccessible</code> is not specified depends on whether a
   * <code>DBSubnetGroup</code> is specified.</p> <p>If <code>DBSubnetGroup</code>
   * isn't specified, <code>PubliclyAccessible</code> defaults to
   * <code>true</code>.</p> <p>If <code>DBSubnetGroup</code> is specified,
   * <code>PubliclyAccessible</code> defaults to <code>false</code> unless the value
   * of <code>DBSubnetGroup</code> is <code>default</code>, in which case
   * <code>PubliclyAccessible</code> defaults to <code>true</code>.</p> <p>If
   * <code>PubliclyAccessible</code> is true and the VPC that the
   * <code>DBSubnetGroup</code> is in doesn't have an internet gateway attached to
   * it, Amazon RDS returns an error.</p>
   */
  ...
  inline CreateDBClusterRequest& WithPubliclyAccessible(bool value) {
  ...
  inline CreateDBClusterRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline void SetEnableHttpEndpoint(bool value) {
    m_enableHttpEndpointHasBeenSet = true;
    m_enableHttpEndpoint = value;
  }
  inline CreateDBClusterRequest& WithEnableHttpEndpoint(bool value) {
    SetEnableHttpEndpoint(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableGlobalWriteForwarding(bool value) {
    m_enableGlobalWriteForwardingHasBeenSet = true;
    m_enableGlobalWriteForwarding = value;
  }
  inline CreateDBClusterRequest& WithEnableGlobalWriteForwarding(bool value) {
    SetEnableGlobalWriteForwarding(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBClusterRequest& WithMonitoringInterval(int value) {
  ...
  inline CreateDBClusterRequest& WithDatabaseInsightsMode(DatabaseInsightsMode value) {
  ...
  inline CreateDBClusterRequest& WithEnablePerformanceInsights(bool value) {
  ...
  inline CreateDBClusterRequest& WithPerformanceInsightsRetentionPeriod(int value) {
  ...
  inline void SetEnableLimitlessDatabase(bool value) {
    m_enableLimitlessDatabaseHasBeenSet = true;
    m_enableLimitlessDatabase = value;
  }
  inline CreateDBClusterRequest& WithEnableLimitlessDatabase(bool value) {
    SetEnableLimitlessDatabase(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDBClusterRequest& WithClusterScalabilityType(ClusterScalabilityType value) {
  ...
  inline void SetEnableLocalWriteForwarding(bool value) {
    m_enableLocalWriteForwardingHasBeenSet = true;
    m_enableLocalWriteForwarding = value;
  }
  inline CreateDBClusterRequest& WithEnableLocalWriteForwarding(bool value) {
    SetEnableLocalWriteForwarding(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMasterUserAuthenticationType(MasterUserAuthenticationType value) {
    m_masterUserAuthenticationTypeHasBeenSet = true;
    m_masterUserAuthenticationType = value;
  }
  inline CreateDBClusterRequest& WithMasterUserAuthenticationType(MasterUserAuthenticationType value) {
