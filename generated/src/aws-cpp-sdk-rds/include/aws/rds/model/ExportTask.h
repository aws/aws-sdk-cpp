...
class ExportTask {
 public:
  ...
  inline ExportTask& WithPercentProgress(int value) {
  ...
  inline ExportTask& WithTotalExtractedDataInGB(int value) {
  ...
  inline ExportTask& WithSourceType(ExportSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
