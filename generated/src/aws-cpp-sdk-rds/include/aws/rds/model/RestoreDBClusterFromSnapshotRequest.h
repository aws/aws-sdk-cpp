...
class RestoreDBClusterFromSnapshotRequest : public RDSRequest {
 ...
 public:
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithBacktrackWindow(long long value) {
  ...
  template <typename EngineModeT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithEngineMode(EngineModeT&& value) {
  ...
  template <typename ScalingConfigurationT = ScalingConfiguration>
  RestoreDBClusterFromSnapshotRequest& WithScalingConfiguration(ScalingConfigurationT&& value) {
  ...
  template <typename DomainT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainIAMRoleNameT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDomainIAMRoleName(DomainIAMRoleNameT&& value) {
  ...
  template <typename DBClusterInstanceClassT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithDBClusterInstanceClass(DBClusterInstanceClassT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithPubliclyAccessible(bool value) {
  ...
  template <typename RdsCustomClusterConfigurationT = RdsCustomClusterConfiguration>
  RestoreDBClusterFromSnapshotRequest& WithRdsCustomClusterConfiguration(RdsCustomClusterConfigurationT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithMonitoringInterval(int value) {
  ...
  template <typename MonitoringRoleArnT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithMonitoringRoleArn(MonitoringRoleArnT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithEnablePerformanceInsights(bool value) {
  ...
  template <typename PerformanceInsightsKMSKeyIdT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithPerformanceInsightsKMSKeyId(PerformanceInsightsKMSKeyIdT&& value) {
  ...
  inline RestoreDBClusterFromSnapshotRequest& WithPerformanceInsightsRetentionPeriod(int value) {
  ...
  template <typename EngineLifecycleSupportT = Aws::String>
  RestoreDBClusterFromSnapshotRequest& WithEngineLifecycleSupport(EngineLifecycleSupportT&& value) {
