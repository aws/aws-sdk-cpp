...
class DeleteCustomDBEngineVersionResult {
 public:
  ...
  template <typename EngineT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithEngine(EngineT&& value) {
  ...
  template <typename MajorEngineVersionT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithMajorEngineVersion(MajorEngineVersionT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename DatabaseInstallationFilesS3BucketNameT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDatabaseInstallationFilesS3BucketName(DatabaseInstallationFilesS3BucketNameT&& value) {
  ...
  template <typename DatabaseInstallationFilesS3PrefixT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDatabaseInstallationFilesS3Prefix(DatabaseInstallationFilesS3PrefixT&& value) {
  ...
  template <typename CustomDBEngineVersionManifestT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithCustomDBEngineVersionManifest(CustomDBEngineVersionManifestT&& value) {
  ...
  template <typename DBParameterGroupFamilyT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDBParameterGroupFamily(DBParameterGroupFamilyT&& value) {
  ...
  template <typename DBEngineDescriptionT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDBEngineDescription(DBEngineDescriptionT&& value) {
  ...
  template <typename DBEngineVersionArnT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDBEngineVersionArn(DBEngineVersionArnT&& value) {
  ...
  template <typename DBEngineVersionDescriptionT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDBEngineVersionDescription(DBEngineVersionDescriptionT&& value) {
  ...
  template <typename DefaultCharacterSetT = CharacterSet>
  DeleteCustomDBEngineVersionResult& WithDefaultCharacterSet(DefaultCharacterSetT&& value) {
  ...
  template <typename ImageT = CustomDBEngineVersionAMI>
  DeleteCustomDBEngineVersionResult& WithImage(ImageT&& value) {
  ...
  template <typename DBEngineMediaTypeT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithDBEngineMediaType(DBEngineMediaTypeT&& value) {
  ...
  template <typename KMSKeyIdT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithKMSKeyId(KMSKeyIdT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  DeleteCustomDBEngineVersionResult& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename SupportedCharacterSetsT = Aws::Vector<CharacterSet>>
  DeleteCustomDBEngineVersionResult& WithSupportedCharacterSets(SupportedCharacterSetsT&& value) {
  ...
  DeleteCustomDBEngineVersionResult& AddSupportedCharacterSets(SupportedCharacterSetsT&& value) {
    m_supportedCharacterSetsHasBeenSet = true;
  ...
  template <typename SupportedNcharCharacterSetsT = Aws::Vector<CharacterSet>>
  DeleteCustomDBEngineVersionResult& WithSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) {
  ...
  DeleteCustomDBEngineVersionResult& AddSupportedNcharCharacterSets(SupportedNcharCharacterSetsT&& value) {
    m_supportedNcharCharacterSetsHasBeenSet = true;
  ...
  template <typename ValidUpgradeTargetT = Aws::Vector<UpgradeTarget>>
  DeleteCustomDBEngineVersionResult& WithValidUpgradeTarget(ValidUpgradeTargetT&& value) {
    SetValidUpgradeTarget(std::forward<ValidUpgradeTargetT>(value));
    return *this;
  }
  template <typename ValidUpgradeTargetT = UpgradeTarget>
  DeleteCustomDBEngineVersionResult& AddValidUpgradeTarget(ValidUpgradeTargetT&& value) {
    m_validUpgradeTargetHasBeenSet = true;
  ...
  template <typename SupportedTimezonesT = Aws::Vector<Timezone>>
  DeleteCustomDBEngineVersionResult& WithSupportedTimezones(SupportedTimezonesT&& value) {
    SetSupportedTimezones(std::forward<SupportedTimezonesT>(value));
    return *this;
  }
  template <typename SupportedTimezonesT = Timezone>
  DeleteCustomDBEngineVersionResult& AddSupportedTimezones(SupportedTimezonesT&& value) {
    m_supportedTimezonesHasBeenSet = true;
  ...
  template <typename ExportableLogTypesT = Aws::Vector<Aws::String>>
  DeleteCustomDBEngineVersionResult& WithExportableLogTypes(ExportableLogTypesT&& value) {
    SetExportableLogTypes(std::forward<ExportableLogTypesT>(value));
    return *this;
  }
  template <typename ExportableLogTypesT = Aws::String>
  DeleteCustomDBEngineVersionResult& AddExportableLogTypes(ExportableLogTypesT&& value) {
    m_exportableLogTypesHasBeenSet = true;
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsLogExportsToCloudwatchLogs(bool value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsReadReplica(bool value) {
  ...
  template <typename SupportedEngineModesT = Aws::Vector<Aws::String>>
  DeleteCustomDBEngineVersionResult& WithSupportedEngineModes(SupportedEngineModesT&& value) {
    SetSupportedEngineModes(std::forward<SupportedEngineModesT>(value));
    return *this;
  }
  template <typename SupportedEngineModesT = Aws::String>
  DeleteCustomDBEngineVersionResult& AddSupportedEngineModes(SupportedEngineModesT&& value) {
    m_supportedEngineModesHasBeenSet = true;
  ...
  template <typename SupportedFeatureNamesT = Aws::Vector<Aws::String>>
  DeleteCustomDBEngineVersionResult& WithSupportedFeatureNames(SupportedFeatureNamesT&& value) {
    SetSupportedFeatureNames(std::forward<SupportedFeatureNamesT>(value));
    return *this;
  }
  template <typename SupportedFeatureNamesT = Aws::String>
  DeleteCustomDBEngineVersionResult& AddSupportedFeatureNames(SupportedFeatureNamesT&& value) {
    m_supportedFeatureNamesHasBeenSet = true;
  ...
  template <typename StatusT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithStatus(StatusT&& value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsParallelQuery(bool value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsGlobalDatabases(bool value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  DeleteCustomDBEngineVersionResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  DeleteCustomDBEngineVersionResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsBabelfish(bool value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsLimitlessDatabase(bool value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsCertificateRotationWithoutRestart(bool value) {
  ...
  template <typename SupportedCACertificateIdentifiersT = Aws::Vector<Aws::String>>
  DeleteCustomDBEngineVersionResult& WithSupportedCACertificateIdentifiers(SupportedCACertificateIdentifiersT&& value) {
  ...
  DeleteCustomDBEngineVersionResult& AddSupportedCACertificateIdentifiers(SupportedCACertificateIdentifiersT&& value) {
    m_supportedCACertificateIdentifiersHasBeenSet = true;
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsLocalWriteForwarding(bool value) {
  ...
  inline DeleteCustomDBEngineVersionResult& WithSupportsIntegrations(bool value) {
  ...
  template <typename ServerlessV2FeaturesSupportT = ServerlessV2FeaturesSupport>
  DeleteCustomDBEngineVersionResult& WithServerlessV2FeaturesSupport(ServerlessV2FeaturesSupportT&& value) {
  ...
  template <typename DatabaseInstallationFilesT = Aws::Vector<Aws::String>>
  DeleteCustomDBEngineVersionResult& WithDatabaseInstallationFiles(DatabaseInstallationFilesT&& value) {
  ...
  DeleteCustomDBEngineVersionResult& AddDatabaseInstallationFiles(DatabaseInstallationFilesT&& value) {
    m_databaseInstallationFilesHasBeenSet = true;
  ...
  template <typename FailureReasonT = Aws::String>
  DeleteCustomDBEngineVersionResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteCustomDBEngineVersionResult& WithResponseMetadata(ResponseMetadataT&& value) {
