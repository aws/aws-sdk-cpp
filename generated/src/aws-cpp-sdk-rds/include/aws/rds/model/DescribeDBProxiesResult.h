...
class DescribeDBProxiesResult {
 public:
  ...
  void SetDBProxies(DBProxiesT&& value) {
    m_dBProxiesHasBeenSet = true;
    m_dBProxies = std::forward<DBProxiesT>(value);
  }
  template <typename DBProxiesT = Aws::Vector<DBProxy>>
  DescribeDBProxiesResult& WithDBProxies(DBProxiesT&& value) {
    SetDBProxies(std::forward<DBProxiesT>(value));
    return *this;
  }
  template <typename DBProxiesT = DBProxy>
  DescribeDBProxiesResult& AddDBProxies(DBProxiesT&& value) {
    m_dBProxiesHasBeenSet = true;
    m_dBProxies.emplace_back(std::forward<DBProxiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxiesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBProxiesResult& WithResponseMetadata(ResponseMetadataT&& value) {
