...
class DescribeDBLogFilesDetails {
 public:
  ...
  inline void SetLastWritten(long long value) {
    m_lastWrittenHasBeenSet = true;
    m_lastWritten = value;
  }
  inline DescribeDBLogFilesDetails& WithLastWritten(long long value) {
  ...
  inline DescribeDBLogFilesDetails& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
