...
class ModifyCustomDBEngineVersionRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename EngineT = Aws::String>
  ModifyCustomDBEngineVersionRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  ModifyCustomDBEngineVersionRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ModifyCustomDBEngineVersionRequest& WithDescription(DescriptionT&& value) {
  ...
  inline void SetStatus(CustomEngineVersionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ModifyCustomDBEngineVersionRequest& WithStatus(CustomEngineVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
