...
class DescribeDBSnapshotAttributesResult {
 public:
  ...
  void SetDBSnapshotAttributesResult(DBSnapshotAttributesResultT&& value) {
    m_dBSnapshotAttributesResultHasBeenSet = true;
    m_dBSnapshotAttributesResult = std::forward<DBSnapshotAttributesResultT>(value);
  }
  template <typename DBSnapshotAttributesResultT = DBSnapshotAttributesResult>
  DescribeDBSnapshotAttributesResult& WithDBSnapshotAttributesResult(DBSnapshotAttributesResultT&& value) {
    SetDBSnapshotAttributesResult(std::forward<DBSnapshotAttributesResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBSnapshotAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
