...
class ModifyTenantDatabaseResult {
 public:
  ...
  void SetTenantDatabase(TenantDatabaseT&& value) {
    m_tenantDatabaseHasBeenSet = true;
    m_tenantDatabase = std::forward<TenantDatabaseT>(value);
  }
  template <typename TenantDatabaseT = TenantDatabase>
  ModifyTenantDatabaseResult& WithTenantDatabase(TenantDatabaseT&& value) {
    SetTenantDatabase(std::forward<TenantDatabaseT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyTenantDatabaseResult& WithResponseMetadata(ResponseMetadataT&& value) {
