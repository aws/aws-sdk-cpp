...
class UserAuthConfig {
 public:
  ...
  inline UserAuthConfig& WithAuthScheme(AuthScheme value) {
    SetAuthScheme(value);
    return *this;
  }
  ///@}
  ...
  inline UserAuthConfig& WithIAMAuth(IAMAuthMode value) {
    SetIAMAuth(value);
    return *this;
  }
  ///@}
  ...
  inline UserAuthConfig& WithClientPasswordAuthType(ClientPasswordAuthType value) {
