...
class DeleteBlueGreenDeploymentRequest : public RDSRequest {
 ...
 public:
  ...
  void SetBlueGreenDeploymentIdentifier(BlueGreenDeploymentIdentifierT&& value) {
    ...
    m_blueGreenDeploymentIdentifier = std::forward<BlueGreenDeploymentIdentifierT>(value);
  }
  template <typename BlueGreenDeploymentIdentifierT = Aws::String>
  DeleteBlueGreenDeploymentRequest& WithBlueGreenDeploymentIdentifier(BlueGreenDeploymentIdentifierT&& value) {
    SetBlueGreenDeploymentIdentifier(std::forward<BlueGreenDeploymentIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteTarget(bool value) {
    m_deleteTargetHasBeenSet = true;
    m_deleteTarget = value;
  }
  inline DeleteBlueGreenDeploymentRequest& WithDeleteTarget(bool value) {
