...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API ModifyDBShardGroupResult();
    AWS_RDS_API ModifyDBShardGroupResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    AWS_RDS_API ModifyDBShardGroupResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    inline ModifyDBShardGroupResult& WithDBShardGroupResourceId(const Aws::String& value) { SetDBShardGroupResourceId(value); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupResourceId(Aws::String&& value) { SetDBShardGroupResourceId(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupResourceId(const char* value) { SetDBShardGroupResourceId(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithDBShardGroupIdentifier(const Aws::String& value) { SetDBShardGroupIdentifier(value); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupIdentifier(Aws::String&& value) { SetDBShardGroupIdentifier(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupIdentifier(const char* value) { SetDBShardGroupIdentifier(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithDBClusterIdentifier(const Aws::String& value) { SetDBClusterIdentifier(value); return *this;}
    inline ModifyDBShardGroupResult& WithDBClusterIdentifier(Aws::String&& value) { SetDBClusterIdentifier(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithDBClusterIdentifier(const char* value) { SetDBClusterIdentifier(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithMaxACU(double value) { SetMaxACU(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithMinACU(double value) { SetMinACU(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithComputeRedundancy(int value) { SetComputeRedundancy(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithStatus(const Aws::String& value) { SetStatus(value); return *this;}
    inline ModifyDBShardGroupResult& WithStatus(Aws::String&& value) { SetStatus(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithStatus(const char* value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithPubliclyAccessible(bool value) { SetPubliclyAccessible(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithEndpoint(const Aws::String& value) { SetEndpoint(value); return *this;}
    inline ModifyDBShardGroupResult& WithEndpoint(Aws::String&& value) { SetEndpoint(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithEndpoint(const char* value) { SetEndpoint(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithDBShardGroupArn(const Aws::String& value) { SetDBShardGroupArn(value); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupArn(Aws::String&& value) { SetDBShardGroupArn(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& WithDBShardGroupArn(const char* value) { SetDBShardGroupArn(value); return *this;}
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithTagList(const Aws::Vector<Tag>& value) { SetTagList(value); return *this;}
    inline ModifyDBShardGroupResult& WithTagList(Aws::Vector<Tag>&& value) { SetTagList(std::move(value)); return *this;}
    inline ModifyDBShardGroupResult& AddTagList(const Tag& value) { m_tagList.push_back(value); return *this; }
    inline ModifyDBShardGroupResult& AddTagList(Tag&& value) { m_tagList.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline ModifyDBShardGroupResult& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}
    inline ModifyDBShardGroupResult& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
    ///@}
  private:
