...
class ModifyDBShardGroupResult {
 public:
  ...
  template <typename DBShardGroupResourceIdT = Aws::String>
  ModifyDBShardGroupResult& WithDBShardGroupResourceId(DBShardGroupResourceIdT&& value) {
  ...
  template <typename DBShardGroupIdentifierT = Aws::String>
  ModifyDBShardGroupResult& WithDBShardGroupIdentifier(DBShardGroupIdentifierT&& value) {
  ...
  template <typename DBClusterIdentifierT = Aws::String>
  ModifyDBShardGroupResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) {
  ...
  inline ModifyDBShardGroupResult& WithMaxACU(double value) {
    SetMaxACU(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBShardGroupResult& WithMinACU(double value) {
    SetMinACU(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBShardGroupResult& WithComputeRedundancy(int value) {
  ...
  template <typename StatusT = Aws::String>
  ModifyDBShardGroupResult& WithStatus(StatusT&& value) {
  ...
  inline ModifyDBShardGroupResult& WithPubliclyAccessible(bool value) {
  ...
  template <typename EndpointT = Aws::String>
  ModifyDBShardGroupResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename DBShardGroupArnT = Aws::String>
  ModifyDBShardGroupResult& WithDBShardGroupArn(DBShardGroupArnT&& value) {
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  ModifyDBShardGroupResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  ModifyDBShardGroupResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyDBShardGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
