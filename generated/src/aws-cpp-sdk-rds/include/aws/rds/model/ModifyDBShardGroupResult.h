...
namespace Model
{
  ...
  {
  public:
    AWS_RDS_API ModifyDBShardGroupResult() = default;
    ...
    template<typename DBShardGroupResourceIdT = Aws::String>
    ModifyDBShardGroupResult& WithDBShardGroupResourceId(DBShardGroupResourceIdT&& value) { SetDBShardGroupResourceId(std::forward<DBShardGroupResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DBShardGroupIdentifierT = Aws::String>
    ModifyDBShardGroupResult& WithDBShardGroupIdentifier(DBShardGroupIdentifierT&& value) { SetDBShardGroupIdentifier(std::forward<DBShardGroupIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DBClusterIdentifierT = Aws::String>
    ModifyDBShardGroupResult& WithDBClusterIdentifier(DBClusterIdentifierT&& value) { SetDBClusterIdentifier(std::forward<DBClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    ModifyDBShardGroupResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointT = Aws::String>
    ModifyDBShardGroupResult& WithEndpoint(EndpointT&& value) { SetEndpoint(std::forward<EndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename DBShardGroupArnT = Aws::String>
    ModifyDBShardGroupResult& WithDBShardGroupArn(DBShardGroupArnT&& value) { SetDBShardGroupArn(std::forward<DBShardGroupArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TagListT = Aws::Vector<Tag>>
    ModifyDBShardGroupResult& WithTagList(TagListT&& value) { SetTagList(std::forward<TagListT>(value)); return *this;}
    template<typename TagListT = Tag>
    ModifyDBShardGroupResult& AddTagList(TagListT&& value) { m_tagListHasBeenSet = true; m_tagList.emplace_back(std::forward<TagListT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyDBShardGroupResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
