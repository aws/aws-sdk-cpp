...
class DescribeDBSecurityGroupsRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename DBSecurityGroupNameT = Aws::String>
  DescribeDBSecurityGroupsRequest& WithDBSecurityGroupName(DBSecurityGroupNameT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeDBSecurityGroupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeDBSecurityGroupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeDBSecurityGroupsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBSecurityGroupsRequest& WithMarker(MarkerT&& value) {
