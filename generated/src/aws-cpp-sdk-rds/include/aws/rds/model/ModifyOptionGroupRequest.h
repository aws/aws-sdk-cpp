...
class ModifyOptionGroupRequest : public RDSRequest {
 ...
 public:
  ...
  template <typename OptionGroupNameT = Aws::String>
  ModifyOptionGroupRequest& WithOptionGroupName(OptionGroupNameT&& value) {
  ...
  void SetOptionsToInclude(OptionsToIncludeT&& value) {
    m_optionsToIncludeHasBeenSet = true;
    m_optionsToInclude = std::forward<OptionsToIncludeT>(value);
  }
  template <typename OptionsToIncludeT = Aws::Vector<OptionConfiguration>>
  ModifyOptionGroupRequest& WithOptionsToInclude(OptionsToIncludeT&& value) {
    SetOptionsToInclude(std::forward<OptionsToIncludeT>(value));
    return *this;
  }
  template <typename OptionsToIncludeT = OptionConfiguration>
  ModifyOptionGroupRequest& AddOptionsToInclude(OptionsToIncludeT&& value) {
    m_optionsToIncludeHasBeenSet = true;
    m_optionsToInclude.emplace_back(std::forward<OptionsToIncludeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OptionsToRemoveT = Aws::Vector<Aws::String>>
  ModifyOptionGroupRequest& WithOptionsToRemove(OptionsToRemoveT&& value) {
    SetOptionsToRemove(std::forward<OptionsToRemoveT>(value));
    return *this;
  }
  template <typename OptionsToRemoveT = Aws::String>
  ModifyOptionGroupRequest& AddOptionsToRemove(OptionsToRemoveT&& value) {
    m_optionsToRemoveHasBeenSet = true;
  ...
  inline ModifyOptionGroupRequest& WithApplyImmediately(bool value) {
