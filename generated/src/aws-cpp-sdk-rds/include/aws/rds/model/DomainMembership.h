...
class DomainMembership {
 public:
  ...
  void SetIAMRoleName(IAMRoleNameT&& value) {
    ...
    m_iAMRoleName = std::forward<IAMRoleNameT>(value);
  }
  template <typename IAMRoleNameT = Aws::String>
  DomainMembership& WithIAMRoleName(IAMRoleNameT&& value) {
    SetIAMRoleName(std::forward<IAMRoleNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOU(OUT&& value) {
    m_oUHasBeenSet = true;
    m_oU = std::forward<OUT>(value);
  }
  template <typename OUT = Aws::String>
  DomainMembership& WithOU(OUT&& value) {
    SetOU(std::forward<OUT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthSecretArn(AuthSecretArnT&& value) {
    ...
    m_authSecretArn = std::forward<AuthSecretArnT>(value);
  }
  template <typename AuthSecretArnT = Aws::String>
  DomainMembership& WithAuthSecretArn(AuthSecretArnT&& value) {
    SetAuthSecretArn(std::forward<AuthSecretArnT>(value));
    return *this;
  }
  ///@}
