...
class DescribeGlobalClustersResult {
 public:
  ...
  void SetGlobalClusters(GlobalClustersT&& value) {
    m_globalClustersHasBeenSet = true;
    m_globalClusters = std::forward<GlobalClustersT>(value);
  }
  template <typename GlobalClustersT = Aws::Vector<GlobalCluster>>
  DescribeGlobalClustersResult& WithGlobalClusters(GlobalClustersT&& value) {
    SetGlobalClusters(std::forward<GlobalClustersT>(value));
    return *this;
  }
  template <typename GlobalClustersT = GlobalCluster>
  DescribeGlobalClustersResult& AddGlobalClusters(GlobalClustersT&& value) {
    m_globalClustersHasBeenSet = true;
    m_globalClusters.emplace_back(std::forward<GlobalClustersT>(value));
    return *this;
  }
  ///@}
