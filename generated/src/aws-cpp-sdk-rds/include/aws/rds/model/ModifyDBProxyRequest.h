...
class ModifyDBProxyRequest : public RDSRequest {
 ...
 public:
  ...
  void SetNewDBProxyName(NewDBProxyNameT&& value) {
    m_newDBProxyNameHasBeenSet = true;
    m_newDBProxyName = std::forward<NewDBProxyNameT>(value);
  }
  template <typename NewDBProxyNameT = Aws::String>
  ModifyDBProxyRequest& WithNewDBProxyName(NewDBProxyNameT&& value) {
    SetNewDBProxyName(std::forward<NewDBProxyNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultAuthScheme(DefaultAuthScheme value) {
    m_defaultAuthSchemeHasBeenSet = true;
    m_defaultAuthScheme = value;
  }
  inline ModifyDBProxyRequest& WithDefaultAuthScheme(DefaultAuthScheme value) {
    SetDefaultAuthScheme(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBProxyRequest& WithRequireTLS(bool value) {
    SetRequireTLS(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyDBProxyRequest& WithIdleClientTimeout(int value) {
  ...
  inline ModifyDBProxyRequest& WithDebugLogging(bool value) {
