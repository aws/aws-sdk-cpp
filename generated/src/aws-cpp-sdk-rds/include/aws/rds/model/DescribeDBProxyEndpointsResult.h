...
class DescribeDBProxyEndpointsResult {
 public:
  ...
  void SetDBProxyEndpoints(DBProxyEndpointsT&& value) {
    m_dBProxyEndpointsHasBeenSet = true;
    m_dBProxyEndpoints = std::forward<DBProxyEndpointsT>(value);
  }
  template <typename DBProxyEndpointsT = Aws::Vector<DBProxyEndpoint>>
  DescribeDBProxyEndpointsResult& WithDBProxyEndpoints(DBProxyEndpointsT&& value) {
    SetDBProxyEndpoints(std::forward<DBProxyEndpointsT>(value));
    return *this;
  }
  template <typename DBProxyEndpointsT = DBProxyEndpoint>
  DescribeDBProxyEndpointsResult& AddDBProxyEndpoints(DBProxyEndpointsT&& value) {
    m_dBProxyEndpointsHasBeenSet = true;
    m_dBProxyEndpoints.emplace_back(std::forward<DBProxyEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDBProxyEndpointsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDBProxyEndpointsResult& WithResponseMetadata(ResponseMetadataT&& value) {
