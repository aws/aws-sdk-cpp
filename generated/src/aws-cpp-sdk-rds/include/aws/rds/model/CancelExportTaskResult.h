...
class CancelExportTaskResult {
 public:
  ...
  inline CancelExportTaskResult& WithPercentProgress(int value) {
  ...
  inline CancelExportTaskResult& WithTotalExtractedDataInGB(int value) {
  ...
  inline CancelExportTaskResult& WithSourceType(ExportSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
