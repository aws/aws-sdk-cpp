...
class DeleteDBProxyEndpointResult {
 public:
  ...
  void SetDBProxyEndpoint(DBProxyEndpointT&& value) {
    m_dBProxyEndpointHasBeenSet = true;
    m_dBProxyEndpoint = std::forward<DBProxyEndpointT>(value);
  }
  template <typename DBProxyEndpointT = DBProxyEndpoint>
  DeleteDBProxyEndpointResult& WithDBProxyEndpoint(DBProxyEndpointT&& value) {
    SetDBProxyEndpoint(std::forward<DBProxyEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteDBProxyEndpointResult& WithResponseMetadata(ResponseMetadataT&& value) {
