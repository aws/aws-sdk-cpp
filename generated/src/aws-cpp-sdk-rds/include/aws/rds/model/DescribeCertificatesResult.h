...
class DescribeCertificatesResult {
 public:
  ...
  void SetDefaultCertificateForNewLaunches(DefaultCertificateForNewLaunchesT&& value) {
    m_defaultCertificateForNewLaunchesHasBeenSet = true;
    m_defaultCertificateForNewLaunches = std::forward<DefaultCertificateForNewLaunchesT>(value);
  }
  template <typename DefaultCertificateForNewLaunchesT = Aws::String>
  DescribeCertificatesResult& WithDefaultCertificateForNewLaunches(DefaultCertificateForNewLaunchesT&& value) {
    SetDefaultCertificateForNewLaunches(std::forward<DefaultCertificateForNewLaunchesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCertificatesResult& WithResponseMetadata(ResponseMetadataT&& value) {
