...
ResourceDetail::ResourceDetail(const XmlNode& xmlNode) { *this = xmlNode; }
...
ResourceDetail& ResourceDetail::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!resourceStatusNode.IsNull()) {
      m_resourceStatus = GeneratedTemplateResourceStatusMapper::GetGeneratedTemplateResourceStatusForName(
...
void ResourceDetail::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_resourceStatusHasBeenSet) {
    oStream << location << index << locationValue << ".ResourceStatus="
            << StringUtils::URLEncode(GeneratedTemplateResourceStatusMapper::GetNameForGeneratedTemplateResourceStatus(m_resourceStatus))
            << "&";
  }
...
void ResourceDetail::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_resourceStatusHasBeenSet) {
    oStream << location << ".ResourceStatus="
            << StringUtils::URLEncode(GeneratedTemplateResourceStatusMapper::GetNameForGeneratedTemplateResourceStatus(m_resourceStatus))
            << "&";
  }
  if (m_resourceStatusReasonHasBeenSet) {
