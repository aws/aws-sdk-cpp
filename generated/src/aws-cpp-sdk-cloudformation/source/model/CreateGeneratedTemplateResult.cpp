...
CreateGeneratedTemplateResult::CreateGeneratedTemplateResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
CreateGeneratedTemplateResult& CreateGeneratedTemplateResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::CreateGeneratedTemplateResult",
