...
StackSetAutoDeploymentTargetSummary::StackSetAutoDeploymentTargetSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
void StackSetAutoDeploymentTargetSummary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
