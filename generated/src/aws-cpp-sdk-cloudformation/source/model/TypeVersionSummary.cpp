...
TypeVersionSummary::TypeVersionSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
void TypeVersionSummary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_timeCreatedHasBeenSet) {
    oStream << location << index << locationValue
            << ".TimeCreated=" << StringUtils::URLEncode(m_timeCreated.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
