...
DetectStackSetDriftResult::DetectStackSetDriftResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DetectStackSetDriftResult& DetectStackSetDriftResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::DetectStackSetDriftResult",
