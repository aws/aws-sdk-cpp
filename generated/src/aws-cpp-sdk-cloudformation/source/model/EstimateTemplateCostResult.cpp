...
EstimateTemplateCostResult::EstimateTemplateCostResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
EstimateTemplateCostResult& EstimateTemplateCostResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::EstimateTemplateCostResult",
