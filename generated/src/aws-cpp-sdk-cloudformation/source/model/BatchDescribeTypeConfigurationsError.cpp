...
BatchDescribeTypeConfigurationsError::BatchDescribeTypeConfigurationsError(const XmlNode& xmlNode) { *this = xmlNode; }
...
void BatchDescribeTypeConfigurationsError::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
