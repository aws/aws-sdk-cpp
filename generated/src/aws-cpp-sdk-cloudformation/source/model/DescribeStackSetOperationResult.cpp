...
DescribeStackSetOperationResult::DescribeStackSetOperationResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeStackSetOperationResult& DescribeStackSetOperationResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::DescribeStackSetOperationResult",
