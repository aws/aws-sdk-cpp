...
DescribePublisherResult::DescribePublisherResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribePublisherResult& DescribePublisherResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!publisherStatusNode.IsNull()) {
      m_publisherStatus = PublisherStatusMapper::GetPublisherStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(publisherStatusNode.GetText()).c_str()));
    ...
    if (!identityProviderNode.IsNull()) {
      m_identityProvider = IdentityProviderMapper::GetIdentityProviderForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(identityProviderNode.GetText()).c_str()));
