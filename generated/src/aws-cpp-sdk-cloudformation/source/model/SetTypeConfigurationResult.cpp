...
SetTypeConfigurationResult::SetTypeConfigurationResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
SetTypeConfigurationResult& SetTypeConfigurationResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::SetTypeConfigurationResult",
