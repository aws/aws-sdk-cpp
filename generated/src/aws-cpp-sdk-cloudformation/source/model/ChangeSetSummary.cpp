...
ChangeSetSummary::ChangeSetSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ChangeSetSummary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_executionStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".ExecutionStatus=" << StringUtils::URLEncode(ExecutionStatusMapper::GetNameForExecutionStatus(m_executionStatus)) << "&";
  }

  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(ChangeSetStatusMapper::GetNameForChangeSetStatus(m_status)) << "&";
  }
