...
CreateStackInstancesResult::CreateStackInstancesResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
CreateStackInstancesResult& CreateStackInstancesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::CreateStackInstancesResult",
