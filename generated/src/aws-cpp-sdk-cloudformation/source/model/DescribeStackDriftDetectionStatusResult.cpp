...
DescribeStackDriftDetectionStatusResult& DescribeStackDriftDetectionStatusResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!detectionStatusNode.IsNull()) {
      m_detectionStatus = StackDriftDetectionStatusMapper::GetStackDriftDetectionStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(detectionStatusNode.GetText()).c_str()));
    ...
    if (!driftedStackResourceCountNode.IsNull()) {
      m_driftedStackResourceCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(driftedStackResourceCountNode.GetText()).c_str()).c_str());
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::DescribeStackDriftDetectionStatusResult",
