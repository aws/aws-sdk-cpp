...
DeactivateOrganizationsAccessResult& DeactivateOrganizationsAccessResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::DeactivateOrganizationsAccessResult",
