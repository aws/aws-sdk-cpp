...
DeleteStackInstancesResult::DeleteStackInstancesResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DeleteStackInstancesResult& DeleteStackInstancesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudFormation::Model::DeleteStackInstancesResult",
