...
ListChangeSetsResult::ListChangeSetsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
ListChangeSetsResult& ListChangeSetsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "ListChangeSetsResult")) {
    resultNode = rootNode.FirstChild("ListChangeSetsResult");
  }
