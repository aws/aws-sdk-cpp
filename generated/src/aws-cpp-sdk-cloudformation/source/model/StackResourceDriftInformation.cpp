...
StackResourceDriftInformation::StackResourceDriftInformation(const XmlNode& xmlNode) { *this = xmlNode; }
...
void StackResourceDriftInformation::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
