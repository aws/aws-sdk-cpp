...
TemplateProgress::TemplateProgress(const XmlNode& xmlNode) { *this = xmlNode; }
...
TemplateProgress& TemplateProgress::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!resourcesSucceededNode.IsNull()) {
      m_resourcesSucceeded = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourcesSucceededNode.GetText()).c_str()).c_str());
    ...
    if (!resourcesFailedNode.IsNull()) {
      m_resourcesFailed = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourcesFailedNode.GetText()).c_str()).c_str());
    ...
    if (!resourcesProcessingNode.IsNull()) {
      m_resourcesProcessing = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourcesProcessingNode.GetText()).c_str()).c_str());
    ...
    if (!resourcesPendingNode.IsNull()) {
      m_resourcesPending = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(resourcesPendingNode.GetText()).c_str()).c_str());
