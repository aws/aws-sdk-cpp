...
WarningDetail::WarningDetail(const XmlNode& xmlNode) { *this = xmlNode; }
...
WarningDetail& WarningDetail::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!typeNode.IsNull()) {
      m_type =
          WarningTypeMapper::GetWarningTypeForName(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(typeNode.GetText()).c_str()));
