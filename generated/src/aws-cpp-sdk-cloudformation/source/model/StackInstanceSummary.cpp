...
StackInstanceSummary::StackInstanceSummary(const XmlNode& xmlNode) { *this = xmlNode; }
...
StackInstanceSummary& StackInstanceSummary::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = StackInstanceStatusMapper::GetStackInstanceStatusForName(
...
void StackInstanceSummary::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(StackInstanceStatusMapper::GetNameForStackInstanceStatus(m_status)) << "&";
  }
