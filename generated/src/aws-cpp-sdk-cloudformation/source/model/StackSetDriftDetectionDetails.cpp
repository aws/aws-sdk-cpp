...
StackSetDriftDetectionDetails::StackSetDriftDetectionDetails(const XmlNode& xmlNode) { *this = xmlNode; }
...
StackSetDriftDetectionDetails& StackSetDriftDetectionDetails::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!driftStatusNode.IsNull()) {
      m_driftStatus = StackSetDriftStatusMapper::GetStackSetDriftStatusForName(
    ...
    if (!driftDetectionStatusNode.IsNull()) {
      m_driftDetectionStatus = StackSetDriftDetectionStatusMapper::GetStackSetDriftDetectionStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(driftDetectionStatusNode.GetText()).c_str()));
    ...
    if (!totalStackInstancesCountNode.IsNull()) {
      m_totalStackInstancesCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalStackInstancesCountNode.GetText()).c_str()).c_str());
    ...
    if (!driftedStackInstancesCountNode.IsNull()) {
      m_driftedStackInstancesCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(driftedStackInstancesCountNode.GetText()).c_str()).c_str());
    ...
    if (!inSyncStackInstancesCountNode.IsNull()) {
      m_inSyncStackInstancesCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(inSyncStackInstancesCountNode.GetText()).c_str()).c_str());
    ...
    if (!inProgressStackInstancesCountNode.IsNull()) {
      m_inProgressStackInstancesCount = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(inProgressStackInstancesCountNode.GetText()).c_str()).c_str());
...
void StackSetDriftDetectionDetails::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                   const char* locationValue) const {
  if (m_driftStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".DriftStatus=" << StringUtils::URLEncode(StackSetDriftStatusMapper::GetNameForStackSetDriftStatus(m_driftStatus)) << "&";
  }

  if (m_driftDetectionStatusHasBeenSet) {
    oStream << location << index << locationValue << ".DriftDetectionStatus="
            << StringUtils::URLEncode(StackSetDriftDetectionStatusMapper::GetNameForStackSetDriftDetectionStatus(m_driftDetectionStatus))
            << "&";
  }
...
void StackSetDriftDetectionDetails::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_driftDetectionStatusHasBeenSet) {
    oStream << location << ".DriftDetectionStatus="
            << StringUtils::URLEncode(StackSetDriftDetectionStatusMapper::GetNameForStackSetDriftDetectionStatus(m_driftDetectionStatus))
            << "&";
  }
  if (m_lastDriftCheckTimestampHasBeenSet) {
