 ...
 * Notification Service, ELB, and Amazon EC2 Auto Scaling to build highly reliable,
 * highly scalable, cost-effective applications without creating or configuring the
 * underlying Amazon Web Services infrastructure.</p> <p>With CloudFormation, you
 * declare all your resources and dependencies in a template file. The template
 * defines a collection of resources as a single unit called a stack.
 * CloudFormation creates and deletes all member resources of the stack together
 * and manages all dependencies between the resources for you.</p> <p>For more
...
class AWS_CLOUDFORMATION_API CloudFormationClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  CloudFormationClient(const Aws::CloudFormation::CloudFormationClientConfiguration& clientConfiguration =
                           Aws::CloudFormation::CloudFormationClientConfiguration(),
  ...
  CloudFormationClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<CloudFormationEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::CloudFormation::CloudFormationClientConfiguration& clientConfiguration =
                           Aws::CloudFormation::CloudFormationClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::ActivateOrganizationsAccessOutcome ActivateOrganizationsAccess(
      const Model::ActivateOrganizationsAccessRequest& request = {}) const;

  /**
   * A Callable wrapper for ActivateOrganizationsAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ActivateOrganizationsAccessRequestT = Model::ActivateOrganizationsAccessRequest>
  Model::ActivateOrganizationsAccessOutcomeCallable ActivateOrganizationsAccessCallable(
      const ActivateOrganizationsAccessRequestT& request = {}) const {
    return SubmitCallable(&CloudFormationClient::ActivateOrganizationsAccess, request);
  }

  /**
   * An Async wrapper for ActivateOrganizationsAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateOrganizationsAccessRequestT = Model::ActivateOrganizationsAccessRequest>
  void ActivateOrganizationsAccessAsync(const ActivateOrganizationsAccessResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for ActivateType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ActivateTypeRequestT = Model::ActivateTypeRequest>
  void ActivateTypeAsync(const ActivateTypeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ActivateTypeRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDescribeTypeConfigurationsOutcome BatchDescribeTypeConfigurations(
      const Model::BatchDescribeTypeConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for BatchDescribeTypeConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDescribeTypeConfigurationsRequestT = Model::BatchDescribeTypeConfigurationsRequest>
  Model::BatchDescribeTypeConfigurationsOutcomeCallable BatchDescribeTypeConfigurationsCallable(
      const BatchDescribeTypeConfigurationsRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::BatchDescribeTypeConfigurations, request);
  }

  /**
   * An Async wrapper for BatchDescribeTypeConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDescribeTypeConfigurationsRequestT = Model::BatchDescribeTypeConfigurationsRequest>
  void BatchDescribeTypeConfigurationsAsync(const BatchDescribeTypeConfigurationsRequestT& request,
                                            const BatchDescribeTypeConfigurationsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelUpdateStack that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelUpdateStack that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelUpdateStackRequestT = Model::CancelUpdateStackRequest>
  void CancelUpdateStackAsync(const CancelUpdateStackRequestT& request, const CancelUpdateStackResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ContinueUpdateRollback that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ContinueUpdateRollback that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ContinueUpdateRollbackRequestT = Model::ContinueUpdateRollbackRequest>
  void ContinueUpdateRollbackAsync(const ContinueUpdateRollbackRequestT& request,
  ...
  /**
   * An Async wrapper for CreateChangeSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateChangeSetRequestT = Model::CreateChangeSetRequest>
  void CreateChangeSetAsync(const CreateChangeSetRequestT& request, const CreateChangeSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGeneratedTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGeneratedTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGeneratedTemplateRequestT = Model::CreateGeneratedTemplateRequest>
  void CreateGeneratedTemplateAsync(const CreateGeneratedTemplateRequestT& request,
                                    const CreateGeneratedTemplateResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStackInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStackInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStackInstancesRequestT = Model::CreateStackInstancesRequest>
  void CreateStackInstancesAsync(const CreateStackInstancesRequestT& request, const CreateStackInstancesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStackRefactor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStackRefactor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateStackRefactorRequestT = Model::CreateStackRefactorRequest>
  void CreateStackRefactorAsync(const CreateStackRefactorRequestT& request, const CreateStackRefactorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateStackSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateStackSetRequestT = Model::CreateStackSetRequest>
  void CreateStackSetAsync(const CreateStackSetRequestT& request, const CreateStackSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeactivateOrganizationsAccessOutcome DeactivateOrganizationsAccess(
      const Model::DeactivateOrganizationsAccessRequest& request = {}) const;

  /**
   * A Callable wrapper for DeactivateOrganizationsAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeactivateOrganizationsAccessRequestT = Model::DeactivateOrganizationsAccessRequest>
  Model::DeactivateOrganizationsAccessOutcomeCallable DeactivateOrganizationsAccessCallable(
      const DeactivateOrganizationsAccessRequestT& request = {}) const {
    return SubmitCallable(&CloudFormationClient::DeactivateOrganizationsAccess, request);
  }

  /**
   * An Async wrapper for DeactivateOrganizationsAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeactivateOrganizationsAccessRequestT = Model::DeactivateOrganizationsAccessRequest>
  void DeactivateOrganizationsAccessAsync(const DeactivateOrganizationsAccessResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DeactivateOrganizationsAccessRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DeactivateType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeactivateTypeRequestT = Model::DeactivateTypeRequest>
  void DeactivateTypeAsync(const DeactivateTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DeactivateTypeRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DeleteChangeSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteChangeSetRequestT = Model::DeleteChangeSetRequest>
  void DeleteChangeSetAsync(const DeleteChangeSetRequestT& request, const DeleteChangeSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteGeneratedTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGeneratedTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGeneratedTemplateRequestT = Model::DeleteGeneratedTemplateRequest>
  void DeleteGeneratedTemplateAsync(const DeleteGeneratedTemplateRequestT& request,
                                    const DeleteGeneratedTemplateResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStackInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStackInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStackInstancesRequestT = Model::DeleteStackInstancesRequest>
  void DeleteStackInstancesAsync(const DeleteStackInstancesRequestT& request, const DeleteStackInstancesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteStackSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteStackSetRequestT = Model::DeleteStackSetRequest>
  void DeleteStackSetAsync(const DeleteStackSetRequestT& request, const DeleteStackSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeregisterType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeregisterTypeRequestT = Model::DeregisterTypeRequest>
  void DeregisterTypeAsync(const DeregisterTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DeregisterTypeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeChangeSetHooks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeChangeSetHooks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeChangeSetHooksRequestT = Model::DescribeChangeSetHooksRequest>
  void DescribeChangeSetHooksAsync(const DescribeChangeSetHooksRequestT& request,
                                   const DescribeChangeSetHooksResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeGeneratedTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeGeneratedTemplateRequestT = Model::DescribeGeneratedTemplateRequest>
  Model::DescribeGeneratedTemplateOutcomeCallable DescribeGeneratedTemplateCallable(
      const DescribeGeneratedTemplateRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::DescribeGeneratedTemplate, request);
  }

  /**
   * An Async wrapper for DescribeGeneratedTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGeneratedTemplateRequestT = Model::DescribeGeneratedTemplateRequest>
  void DescribeGeneratedTemplateAsync(const DescribeGeneratedTemplateRequestT& request,
                                      const DescribeGeneratedTemplateResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeOrganizationsAccessOutcome DescribeOrganizationsAccess(
      const Model::DescribeOrganizationsAccessRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrganizationsAccess that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOrganizationsAccessRequestT = Model::DescribeOrganizationsAccessRequest>
  Model::DescribeOrganizationsAccessOutcomeCallable DescribeOrganizationsAccessCallable(
      const DescribeOrganizationsAccessRequestT& request = {}) const {
    return SubmitCallable(&CloudFormationClient::DescribeOrganizationsAccess, request);
  }

  /**
   * An Async wrapper for DescribeOrganizationsAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOrganizationsAccessRequestT = Model::DescribeOrganizationsAccessRequest>
  void DescribeOrganizationsAccessAsync(const DescribeOrganizationsAccessResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeOrganizationsAccessRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePublisher that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePublisher that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePublisherRequestT = Model::DescribePublisherRequest>
  void DescribePublisherAsync(const DescribePublisherResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribePublisherRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeResourceScan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeResourceScan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeResourceScanRequestT = Model::DescribeResourceScanRequest>
  void DescribeResourceScanAsync(const DescribeResourceScanRequestT& request, const DescribeResourceScanResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeStackDriftDetectionStatusOutcome DescribeStackDriftDetectionStatus(
      const Model::DescribeStackDriftDetectionStatusRequest& request) const;

  /**
   * A Callable wrapper for DescribeStackDriftDetectionStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeStackDriftDetectionStatusRequestT = Model::DescribeStackDriftDetectionStatusRequest>
  Model::DescribeStackDriftDetectionStatusOutcomeCallable DescribeStackDriftDetectionStatusCallable(
      const DescribeStackDriftDetectionStatusRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::DescribeStackDriftDetectionStatus, request);
  }

  /**
   * An Async wrapper for DescribeStackDriftDetectionStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeStackDriftDetectionStatusRequestT = Model::DescribeStackDriftDetectionStatusRequest>
  void DescribeStackDriftDetectionStatusAsync(const DescribeStackDriftDetectionStatusRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeStackEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeStackEventsRequestT = Model::DescribeStackEventsRequest>
  ...
  /**
   * A Callable wrapper for DescribeStackInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStackInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackInstanceRequestT = Model::DescribeStackInstanceRequest>
  void DescribeStackInstanceAsync(const DescribeStackInstanceRequestT& request, const DescribeStackInstanceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeStackRefactor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStackRefactor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackRefactorRequestT = Model::DescribeStackRefactorRequest>
  void DescribeStackRefactorAsync(const DescribeStackRefactorRequestT& request, const DescribeStackRefactorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeStackResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStackResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackResourceRequestT = Model::DescribeStackResourceRequest>
  void DescribeStackResourceAsync(const DescribeStackResourceRequestT& request, const DescribeStackResourceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeStackResourceDriftsOutcome DescribeStackResourceDrifts(
      const Model::DescribeStackResourceDriftsRequest& request) const;

  /**
   * A Callable wrapper for DescribeStackResourceDrifts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeStackResourceDriftsRequestT = Model::DescribeStackResourceDriftsRequest>
  Model::DescribeStackResourceDriftsOutcomeCallable DescribeStackResourceDriftsCallable(
      const DescribeStackResourceDriftsRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::DescribeStackResourceDrifts, request);
  }

  /**
   * An Async wrapper for DescribeStackResourceDrifts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackResourceDriftsRequestT = Model::DescribeStackResourceDriftsRequest>
  void DescribeStackResourceDriftsAsync(const DescribeStackResourceDriftsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeStackResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStackResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackResourcesRequestT = Model::DescribeStackResourcesRequest>
  void DescribeStackResourcesAsync(const DescribeStackResourcesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeStackResourcesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStackSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStackSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeStackSetRequestT = Model::DescribeStackSetRequest>
  void DescribeStackSetAsync(const DescribeStackSetRequestT& request, const DescribeStackSetResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeStackSetOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeStackSetOperationRequestT = Model::DescribeStackSetOperationRequest>
  Model::DescribeStackSetOperationOutcomeCallable DescribeStackSetOperationCallable(
      const DescribeStackSetOperationRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::DescribeStackSetOperation, request);
  }

  /**
   * An Async wrapper for DescribeStackSetOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStackSetOperationRequestT = Model::DescribeStackSetOperationRequest>
  void DescribeStackSetOperationAsync(const DescribeStackSetOperationRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTypeRequestT = Model::DescribeTypeRequest>
  void DescribeTypeAsync(const DescribeTypeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const DescribeTypeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeTypeRegistration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTypeRegistration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTypeRegistrationRequestT = Model::DescribeTypeRegistrationRequest>
  void DescribeTypeRegistrationAsync(const DescribeTypeRegistrationRequestT& request,
  ...
  /**
   * A Callable wrapper for DetectStackDrift that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectStackDrift that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectStackDriftRequestT = Model::DetectStackDriftRequest>
  void DetectStackDriftAsync(const DetectStackDriftRequestT& request, const DetectStackDriftResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectStackResourceDrift that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectStackResourceDrift that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectStackResourceDriftRequestT = Model::DetectStackResourceDriftRequest>
  void DetectStackResourceDriftAsync(const DetectStackResourceDriftRequestT& request,
  ...
  /**
   * A Callable wrapper for DetectStackSetDrift that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectStackSetDrift that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectStackSetDriftRequestT = Model::DetectStackSetDriftRequest>
  void DetectStackSetDriftAsync(const DetectStackSetDriftRequestT& request, const DetectStackSetDriftResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EstimateTemplateCost that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EstimateTemplateCost that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EstimateTemplateCostRequestT = Model::EstimateTemplateCostRequest>
  void EstimateTemplateCostAsync(const EstimateTemplateCostResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const EstimateTemplateCostRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ExecuteChangeSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteChangeSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ExecuteChangeSetRequestT = Model::ExecuteChangeSetRequest>
  void ExecuteChangeSetAsync(const ExecuteChangeSetRequestT& request, const ExecuteChangeSetResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExecuteStackRefactor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteStackRefactor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteStackRefactorRequestT = Model::ExecuteStackRefactorRequest>
  void ExecuteStackRefactorAsync(const ExecuteStackRefactorRequestT& request, const ExecuteStackRefactorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetGeneratedTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGeneratedTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetGeneratedTemplateRequestT = Model::GetGeneratedTemplateRequest>
  ...
  /**
   * An Async wrapper for GetStackPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStackPolicyRequestT = Model::GetStackPolicyRequest>
  void GetStackPolicyAsync(const GetStackPolicyRequestT& request, const GetStackPolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetTemplateRequestT = Model::GetTemplateRequest>
  void GetTemplateAsync(const GetTemplateResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetTemplateRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetTemplateSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTemplateSummary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTemplateSummaryRequestT = Model::GetTemplateSummaryRequest>
  void GetTemplateSummaryAsync(const GetTemplateSummaryResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetTemplateSummaryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ImportStacksToStackSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportStacksToStackSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportStacksToStackSetRequestT = Model::ImportStacksToStackSetRequest>
  void ImportStacksToStackSetAsync(const ImportStacksToStackSetRequestT& request,
                                   const ImportStacksToStackSetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListGeneratedTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGeneratedTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListGeneratedTemplatesRequestT = Model::ListGeneratedTemplatesRequest>
  void ListGeneratedTemplatesAsync(const ListGeneratedTemplatesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListGeneratedTemplatesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListHookResults that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHookResultsRequestT = Model::ListHookResultsRequest>
  void ListHookResultsAsync(const ListHookResultsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListHookResultsRequestT& request = {}) const {
   ...
   */
  template <typename ListImportsRequestT = Model::ListImportsRequest>
  void ListImportsAsync(const ListImportsRequestT& request, const ListImportsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourceScanRelatedResourcesOutcome ListResourceScanRelatedResources(
      const Model::ListResourceScanRelatedResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListResourceScanRelatedResources that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListResourceScanRelatedResourcesRequestT = Model::ListResourceScanRelatedResourcesRequest>
  Model::ListResourceScanRelatedResourcesOutcomeCallable ListResourceScanRelatedResourcesCallable(
      const ListResourceScanRelatedResourcesRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::ListResourceScanRelatedResources, request);
  }

  /**
   * An Async wrapper for ListResourceScanRelatedResources that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResourceScanRelatedResourcesRequestT = Model::ListResourceScanRelatedResourcesRequest>
  void ListResourceScanRelatedResourcesAsync(const ListResourceScanRelatedResourcesRequestT& request,
                                             const ListResourceScanRelatedResourcesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceScanResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListResourceScanResourcesRequestT = Model::ListResourceScanResourcesRequest>
  Model::ListResourceScanResourcesOutcomeCallable ListResourceScanResourcesCallable(
      const ListResourceScanResourcesRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::ListResourceScanResources, request);
  }

  /**
   * An Async wrapper for ListResourceScanResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceScanResourcesRequestT = Model::ListResourceScanResourcesRequest>
  void ListResourceScanResourcesAsync(const ListResourceScanResourcesRequestT& request,
                                      const ListResourceScanResourcesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListResourceScans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceScans that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListResourceScansRequestT = Model::ListResourceScansRequest>
  void ListResourceScansAsync(const ListResourceScansResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListResourceScansRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStackInstanceResourceDriftsOutcome ListStackInstanceResourceDrifts(
      const Model::ListStackInstanceResourceDriftsRequest& request) const;

  /**
   * A Callable wrapper for ListStackInstanceResourceDrifts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStackInstanceResourceDriftsRequestT = Model::ListStackInstanceResourceDriftsRequest>
  Model::ListStackInstanceResourceDriftsOutcomeCallable ListStackInstanceResourceDriftsCallable(
      const ListStackInstanceResourceDriftsRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::ListStackInstanceResourceDrifts, request);
  }

  /**
   * An Async wrapper for ListStackInstanceResourceDrifts that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListStackInstanceResourceDriftsRequestT = Model::ListStackInstanceResourceDriftsRequest>
  void ListStackInstanceResourceDriftsAsync(const ListStackInstanceResourceDriftsRequestT& request,
                                            const ListStackInstanceResourceDriftsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStackInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStackInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStackInstancesRequestT = Model::ListStackInstancesRequest>
  void ListStackInstancesAsync(const ListStackInstancesRequestT& request, const ListStackInstancesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStackRefactorActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStackRefactorActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStackRefactorActionsRequestT = Model::ListStackRefactorActionsRequest>
  void ListStackRefactorActionsAsync(const ListStackRefactorActionsRequestT& request,
                                     const ListStackRefactorActionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStackRefactors that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStackRefactors that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStackRefactorsRequestT = Model::ListStackRefactorsRequest>
  void ListStackRefactorsAsync(const ListStackRefactorsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListStackRefactorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListStackResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStackResources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStackResourcesRequestT = Model::ListStackResourcesRequest>
  void ListStackResourcesAsync(const ListStackResourcesRequestT& request, const ListStackResourcesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStackSetAutoDeploymentTargetsOutcome ListStackSetAutoDeploymentTargets(
      const Model::ListStackSetAutoDeploymentTargetsRequest& request) const;

  /**
   * A Callable wrapper for ListStackSetAutoDeploymentTargets that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListStackSetAutoDeploymentTargetsRequestT = Model::ListStackSetAutoDeploymentTargetsRequest>
  Model::ListStackSetAutoDeploymentTargetsOutcomeCallable ListStackSetAutoDeploymentTargetsCallable(
      const ListStackSetAutoDeploymentTargetsRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::ListStackSetAutoDeploymentTargets, request);
  }

  /**
   * An Async wrapper for ListStackSetAutoDeploymentTargets that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListStackSetAutoDeploymentTargetsRequestT = Model::ListStackSetAutoDeploymentTargetsRequest>
  void ListStackSetAutoDeploymentTargetsAsync(const ListStackSetAutoDeploymentTargetsRequestT& request,
                                              const ListStackSetAutoDeploymentTargetsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStackSetOperationResultsOutcome ListStackSetOperationResults(
      const Model::ListStackSetOperationResultsRequest& request) const;

  /**
   * A Callable wrapper for ListStackSetOperationResults that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStackSetOperationResultsRequestT = Model::ListStackSetOperationResultsRequest>
  Model::ListStackSetOperationResultsOutcomeCallable ListStackSetOperationResultsCallable(
      const ListStackSetOperationResultsRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::ListStackSetOperationResults, request);
  }

  /**
   * An Async wrapper for ListStackSetOperationResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStackSetOperationResultsRequestT = Model::ListStackSetOperationResultsRequest>
  void ListStackSetOperationResultsAsync(const ListStackSetOperationResultsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListStackSetOperations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStackSetOperations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStackSetOperationsRequestT = Model::ListStackSetOperationsRequest>
  void ListStackSetOperationsAsync(const ListStackSetOperationsRequestT& request,
  ...
  /**
   * An Async wrapper for ListStackSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStackSetsRequestT = Model::ListStackSetsRequest>
  void ListStackSetsAsync(const ListStackSetsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListStackSetsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListStacks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStacksRequestT = Model::ListStacksRequest>
  void ListStacksAsync(const ListStacksResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListStacksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTypeRegistrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTypeRegistrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTypeRegistrationsRequestT = Model::ListTypeRegistrationsRequest>
  void ListTypeRegistrationsAsync(const ListTypeRegistrationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListTypeRegistrationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTypeVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTypeVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTypeVersionsRequestT = Model::ListTypeVersionsRequest>
  void ListTypeVersionsAsync(const ListTypeVersionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListTypeVersionsRequestT& request = {}) const {
   ...
   */
  template <typename ListTypesRequestT = Model::ListTypesRequest>
  void ListTypesAsync(const ListTypesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PublishType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PublishTypeRequestT = Model::PublishTypeRequest>
  void PublishTypeAsync(const PublishTypeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const PublishTypeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RecordHandlerProgress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RecordHandlerProgress that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RecordHandlerProgressRequestT = Model::RecordHandlerProgressRequest>
  void RecordHandlerProgressAsync(const RecordHandlerProgressRequestT& request, const RecordHandlerProgressResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterPublisher that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterPublisher that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterPublisherRequestT = Model::RegisterPublisherRequest>
  void RegisterPublisherAsync(const RegisterPublisherResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const RegisterPublisherRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for RegisterType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterTypeRequestT = Model::RegisterTypeRequest>
  void RegisterTypeAsync(const RegisterTypeRequestT& request, const RegisterTypeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RollbackStack that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RollbackStackRequestT = Model::RollbackStackRequest>
  void RollbackStackAsync(const RollbackStackRequestT& request, const RollbackStackResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SetStackPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SetStackPolicyRequestT = Model::SetStackPolicyRequest>
  void SetStackPolicyAsync(const SetStackPolicyRequestT& request, const SetStackPolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetTypeConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetTypeConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetTypeConfigurationRequestT = Model::SetTypeConfigurationRequest>
  void SetTypeConfigurationAsync(const SetTypeConfigurationRequestT& request, const SetTypeConfigurationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetTypeDefaultVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetTypeDefaultVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetTypeDefaultVersionRequestT = Model::SetTypeDefaultVersionRequest>
  void SetTypeDefaultVersionAsync(const SetTypeDefaultVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const SetTypeDefaultVersionRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for SignalResource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SignalResourceRequestT = Model::SignalResourceRequest>
  void SignalResourceAsync(const SignalResourceRequestT& request, const SignalResourceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartResourceScan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartResourceScan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartResourceScanRequestT = Model::StartResourceScanRequest>
  void StartResourceScanAsync(const StartResourceScanResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const StartResourceScanRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StopStackSetOperation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopStackSetOperation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopStackSetOperationRequestT = Model::StopStackSetOperationRequest>
  void StopStackSetOperationAsync(const StopStackSetOperationRequestT& request, const StopStackSetOperationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TestType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestTypeRequestT = Model::TestTypeRequest>
  void TestTypeAsync(const TestTypeResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const TestTypeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateGeneratedTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGeneratedTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateGeneratedTemplateRequestT = Model::UpdateGeneratedTemplateRequest>
  void UpdateGeneratedTemplateAsync(const UpdateGeneratedTemplateRequestT& request,
                                    const UpdateGeneratedTemplateResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStackInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStackInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStackInstancesRequestT = Model::UpdateStackInstancesRequest>
  void UpdateStackInstancesAsync(const UpdateStackInstancesRequestT& request, const UpdateStackInstancesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateStackSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStackSetRequestT = Model::UpdateStackSetRequest>
  void UpdateStackSetAsync(const UpdateStackSetRequestT& request, const UpdateStackSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateTerminationProtectionOutcome UpdateTerminationProtection(
      const Model::UpdateTerminationProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateTerminationProtection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateTerminationProtectionRequestT = Model::UpdateTerminationProtectionRequest>
  Model::UpdateTerminationProtectionOutcomeCallable UpdateTerminationProtectionCallable(
      const UpdateTerminationProtectionRequestT& request) const {
    return SubmitCallable(&CloudFormationClient::UpdateTerminationProtection, request);
  }

  /**
   * An Async wrapper for UpdateTerminationProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTerminationProtectionRequestT = Model::UpdateTerminationProtectionRequest>
  void UpdateTerminationProtectionAsync(const UpdateTerminationProtectionRequestT& request,
  ...
  /**
   * A Callable wrapper for ValidateTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ValidateTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ValidateTemplateRequestT = Model::ValidateTemplateRequest>
  void ValidateTemplateAsync(const ValidateTemplateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ValidateTemplateRequestT& request = {}) const {
