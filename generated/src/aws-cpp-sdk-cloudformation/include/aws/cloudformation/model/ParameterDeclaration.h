...
class ParameterDeclaration {
 public:
  ...
  void SetParameterKey(ParameterKeyT&& value) {
    ...
    m_parameterKey = std::forward<ParameterKeyT>(value);
  }
  template <typename ParameterKeyT = Aws::String>
  ParameterDeclaration& WithParameterKey(ParameterKeyT&& value) {
    SetParameterKey(std::forward<ParameterKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParameterType(ParameterTypeT&& value) {
    ...
    m_parameterType = std::forward<ParameterTypeT>(value);
  }
  template <typename ParameterTypeT = Aws::String>
  ParameterDeclaration& WithParameterType(ParameterTypeT&& value) {
    SetParameterType(std::forward<ParameterTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ParameterDeclaration& WithNoEcho(bool value) {
    SetNoEcho(value);
    return *this;
  }
  ///@}
  ...
  void SetParameterConstraints(ParameterConstraintsT&& value) {
    ...
    m_parameterConstraints = std::forward<ParameterConstraintsT>(value);
  }
  template <typename ParameterConstraintsT = ParameterConstraints>
  ParameterDeclaration& WithParameterConstraints(ParameterConstraintsT&& value) {
    SetParameterConstraints(std::forward<ParameterConstraintsT>(value));
    return *this;
  }
  ///@}
 private:
