...
class CreateStackRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline CreateStackRequest& WithDisableRollback(bool value) {
  ...
  inline CreateStackRequest& WithTimeoutInMinutes(int value) {
  ...
  inline CreateStackRequest& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  inline void SetOnFailure(OnFailure value) {
    m_onFailureHasBeenSet = true;
    m_onFailure = value;
  }
  inline CreateStackRequest& WithOnFailure(OnFailure value) {
    SetOnFailure(value);
    return *this;
  }
  ///@}
  ...
  inline CreateStackRequest& WithEnableTerminationProtection(bool value) {
  ...
  inline CreateStackRequest& WithRetainExceptOnCreate(bool value) {
