...
class StartResourceScanRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartResourceScanRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename ScanFiltersT = Aws::Vector<ScanFilter>>
  StartResourceScanRequest& WithScanFilters(ScanFiltersT&& value) {
    SetScanFilters(std::forward<ScanFiltersT>(value));
    return *this;
  }
  template <typename ScanFiltersT = ScanFilter>
  StartResourceScanRequest& AddScanFilters(ScanFiltersT&& value) {
    m_scanFiltersHasBeenSet = true;
