...
class Warnings {
 public:
  ...
  void SetUnrecognizedResourceTypes(UnrecognizedResourceTypesT&& value) {
    m_unrecognizedResourceTypesHasBeenSet = true;
    m_unrecognizedResourceTypes = std::forward<UnrecognizedResourceTypesT>(value);
  }
  template <typename UnrecognizedResourceTypesT = Aws::Vector<Aws::String>>
  Warnings& WithUnrecognizedResourceTypes(UnrecognizedResourceTypesT&& value) {
    SetUnrecognizedResourceTypes(std::forward<UnrecognizedResourceTypesT>(value));
    return *this;
  }
  template <typename UnrecognizedResourceTypesT = Aws::String>
  Warnings& AddUnrecognizedResourceTypes(UnrecognizedResourceTypesT&& value) {
    m_unrecognizedResourceTypesHasBeenSet = true;
    m_unrecognizedResourceTypes.emplace_back(std::forward<UnrecognizedResourceTypesT>(value));
    return *this;
  }
  ///@}
 private:
