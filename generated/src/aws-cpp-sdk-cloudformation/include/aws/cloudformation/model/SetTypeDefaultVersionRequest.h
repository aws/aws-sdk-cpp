...
class SetTypeDefaultVersionRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename ArnT = Aws::String>
  SetTypeDefaultVersionRequest& WithArn(ArnT&& value) {
  ...
  inline SetTypeDefaultVersionRequest& WithType(RegistryType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeNameT = Aws::String>
  SetTypeDefaultVersionRequest& WithTypeName(TypeNameT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  SetTypeDefaultVersionRequest& WithVersionId(VersionIdT&& value) {
