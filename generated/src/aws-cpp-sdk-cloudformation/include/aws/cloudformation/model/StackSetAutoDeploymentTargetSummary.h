...
class StackSetAutoDeploymentTargetSummary {
 public:
  ...
  template <typename OrganizationalUnitIdT = Aws::String>
  StackSetAutoDeploymentTargetSummary& WithOrganizationalUnitId(OrganizationalUnitIdT&& value) {
  ...
  template <typename RegionsT = Aws::Vector<Aws::String>>
  StackSetAutoDeploymentTargetSummary& WithRegions(RegionsT&& value) {
    SetRegions(std::forward<RegionsT>(value));
    return *this;
  }
  template <typename RegionsT = Aws::String>
  StackSetAutoDeploymentTargetSummary& AddRegions(RegionsT&& value) {
    m_regionsHasBeenSet = true;
