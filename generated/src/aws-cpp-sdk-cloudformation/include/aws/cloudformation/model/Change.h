...
class Change {
 public:
  ...
  inline Change& WithType(ChangeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHookInvocationCount(int value) {
    m_hookInvocationCountHasBeenSet = true;
    m_hookInvocationCount = value;
  }
  inline Change& WithHookInvocationCount(int value) {
    SetHookInvocationCount(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceChange(ResourceChangeT&& value) {
    ...
    m_resourceChange = std::forward<ResourceChangeT>(value);
  }
  template <typename ResourceChangeT = ResourceChange>
  Change& WithResourceChange(ResourceChangeT&& value) {
    SetResourceChange(std::forward<ResourceChangeT>(value));
    return *this;
  }
  ///@}
 private:
