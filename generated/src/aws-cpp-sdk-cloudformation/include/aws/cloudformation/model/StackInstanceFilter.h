...
class StackInstanceFilter {
 public:
  ...
  inline void SetName(StackInstanceFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline StackInstanceFilter& WithName(StackInstanceFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::String>
  StackInstanceFilter& WithValues(ValuesT&& value) {
