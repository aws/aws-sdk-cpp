...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API RecordHandlerProgressResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RecordHandlerProgressResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
