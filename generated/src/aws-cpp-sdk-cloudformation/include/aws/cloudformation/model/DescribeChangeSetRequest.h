...
class DescribeChangeSetRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline void SetIncludePropertyValues(bool value) {
    m_includePropertyValuesHasBeenSet = true;
    m_includePropertyValues = value;
  }
  inline DescribeChangeSetRequest& WithIncludePropertyValues(bool value) {
    SetIncludePropertyValues(value);
    return *this;
  }
  ///@}
 private:
