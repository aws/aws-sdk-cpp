...
struct DescribeStackResourceDriftsPaginationTraits {
  using RequestType = Model::DescribeStackResourceDriftsRequest;
  using ResultType = Model::DescribeStackResourceDriftsResult;
  using OutcomeType = Model::DescribeStackResourceDriftsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->DescribeStackResourceDrifts(request); }
