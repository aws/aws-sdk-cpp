...
class ListTypeRegistrationsResult {
 public:
  ...
  void SetRegistrationTokenList(RegistrationTokenListT&& value) {
    m_registrationTokenListHasBeenSet = true;
    m_registrationTokenList = std::forward<RegistrationTokenListT>(value);
  }
  template <typename RegistrationTokenListT = Aws::Vector<Aws::String>>
  ListTypeRegistrationsResult& WithRegistrationTokenList(RegistrationTokenListT&& value) {
    SetRegistrationTokenList(std::forward<RegistrationTokenListT>(value));
    return *this;
  }
  template <typename RegistrationTokenListT = Aws::String>
  ListTypeRegistrationsResult& AddRegistrationTokenList(RegistrationTokenListT&& value) {
    m_registrationTokenListHasBeenSet = true;
    m_registrationTokenList.emplace_back(std::forward<RegistrationTokenListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTypeRegistrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListTypeRegistrationsResult& WithResponseMetadata(ResponseMetadataT&& value) {
