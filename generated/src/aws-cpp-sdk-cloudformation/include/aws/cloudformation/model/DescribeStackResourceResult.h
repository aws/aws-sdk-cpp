...
class DescribeStackResourceResult {
 public:
  ...
  void SetStackResourceDetail(StackResourceDetailT&& value) {
    m_stackResourceDetailHasBeenSet = true;
    m_stackResourceDetail = std::forward<StackResourceDetailT>(value);
  }
  template <typename StackResourceDetailT = StackResourceDetail>
  DescribeStackResourceResult& WithStackResourceDetail(StackResourceDetailT&& value) {
    SetStackResourceDetail(std::forward<StackResourceDetailT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackResourceResult& WithResponseMetadata(ResponseMetadataT&& value) {
