...
class ChangeSetHookTargetDetails {
 public:
  ...
  inline ChangeSetHookTargetDetails& WithTargetType(HookTargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceTargetDetails(ResourceTargetDetailsT&& value) {
    m_resourceTargetDetailsHasBeenSet = true;
    m_resourceTargetDetails = std::forward<ResourceTargetDetailsT>(value);
  }
  template <typename ResourceTargetDetailsT = ChangeSetHookResourceTargetDetails>
  ChangeSetHookTargetDetails& WithResourceTargetDetails(ResourceTargetDetailsT&& value) {
    SetResourceTargetDetails(std::forward<ResourceTargetDetailsT>(value));
    return *this;
  }
  ///@}
 private:
