...
class ListResourceScanResourcesResult {
 public:
  ...
  AWS_CLOUDFORMATION_API ListResourceScanResourcesResult& operator=(
  ...
  template <typename ResourcesT = Aws::Vector<ScannedResource>>
  ListResourceScanResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ScannedResource>
  ListResourceScanResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceScanResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListResourceScanResourcesResult& WithResponseMetadata(ResponseMetadataT&& value) {
