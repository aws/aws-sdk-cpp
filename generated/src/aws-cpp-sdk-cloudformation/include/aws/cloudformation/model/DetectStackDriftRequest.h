...
class DetectStackDriftRequest : public CloudFormationRequest {
 ...
 public:
  ...
  void SetLogicalResourceIds(LogicalResourceIdsT&& value) {
    m_logicalResourceIdsHasBeenSet = true;
    m_logicalResourceIds = std::forward<LogicalResourceIdsT>(value);
  }
  template <typename LogicalResourceIdsT = Aws::Vector<Aws::String>>
  DetectStackDriftRequest& WithLogicalResourceIds(LogicalResourceIdsT&& value) {
    SetLogicalResourceIds(std::forward<LogicalResourceIdsT>(value));
    return *this;
  }
  template <typename LogicalResourceIdsT = Aws::String>
  DetectStackDriftRequest& AddLogicalResourceIds(LogicalResourceIdsT&& value) {
    m_logicalResourceIdsHasBeenSet = true;
    m_logicalResourceIds.emplace_back(std::forward<LogicalResourceIdsT>(value));
    return *this;
  }
  ///@}
 private:
