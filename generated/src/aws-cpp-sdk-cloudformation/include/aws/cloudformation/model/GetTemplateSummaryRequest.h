...
class GetTemplateSummaryRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline GetTemplateSummaryRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
  ...
  void SetTemplateSummaryConfig(TemplateSummaryConfigT&& value) {
    m_templateSummaryConfigHasBeenSet = true;
    m_templateSummaryConfig = std::forward<TemplateSummaryConfigT>(value);
  }
  template <typename TemplateSummaryConfigT = TemplateSummaryConfig>
  GetTemplateSummaryRequest& WithTemplateSummaryConfig(TemplateSummaryConfigT&& value) {
    SetTemplateSummaryConfig(std::forward<TemplateSummaryConfigT>(value));
    return *this;
  }
  ///@}
 private:
