...
class DescribeStackSetResult {
 public:
  ...
  void SetStackSet(StackSetT&& value) {
    m_stackSetHasBeenSet = true;
    m_stackSet = std::forward<StackSetT>(value);
  }
  template <typename StackSetT = StackSet>
  DescribeStackSetResult& WithStackSet(StackSetT&& value) {
    SetStackSet(std::forward<StackSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackSetResult& WithResponseMetadata(ResponseMetadataT&& value) {
