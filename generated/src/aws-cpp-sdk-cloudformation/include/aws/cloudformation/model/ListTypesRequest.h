...
class ListTypesRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline ListTypesRequest& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline ListTypesRequest& WithProvisioningType(ProvisioningType value) {
  ...
  inline ListTypesRequest& WithDeprecatedStatus(DeprecatedStatus value) {
  ...
  inline ListTypesRequest& WithType(RegistryType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = TypeFilters>
  ListTypesRequest& WithFilters(FiltersT&& value) {
