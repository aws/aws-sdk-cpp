...
class ResourceChangeDetail {
 public:
  ...
  inline void SetEvaluation(EvaluationType value) {
    m_evaluationHasBeenSet = true;
    m_evaluation = value;
  }
  inline ResourceChangeDetail& WithEvaluation(EvaluationType value) {
    SetEvaluation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChangeSource(ChangeSource value) {
    m_changeSourceHasBeenSet = true;
    m_changeSource = value;
  }
  inline ResourceChangeDetail& WithChangeSource(ChangeSource value) {
  ...
  void SetCausingEntity(CausingEntityT&& value) {
    ...
    m_causingEntity = std::forward<CausingEntityT>(value);
  }
  template <typename CausingEntityT = Aws::String>
  ResourceChangeDetail& WithCausingEntity(CausingEntityT&& value) {
    SetCausingEntity(std::forward<CausingEntityT>(value));
    return *this;
  }
  ///@}
 private:
