...
class DescribeStackInstanceResult {
 public:
  ...
  void SetStackInstance(StackInstanceT&& value) {
    m_stackInstanceHasBeenSet = true;
    m_stackInstance = std::forward<StackInstanceT>(value);
  }
  template <typename StackInstanceT = StackInstance>
  DescribeStackInstanceResult& WithStackInstance(StackInstanceT&& value) {
    SetStackInstance(std::forward<StackInstanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackInstanceResult& WithResponseMetadata(ResponseMetadataT&& value) {
