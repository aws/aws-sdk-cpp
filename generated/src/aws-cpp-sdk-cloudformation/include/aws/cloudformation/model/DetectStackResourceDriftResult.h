...
class DetectStackResourceDriftResult {
 public:
  ...
  void SetStackResourceDrift(StackResourceDriftT&& value) {
    m_stackResourceDriftHasBeenSet = true;
    m_stackResourceDrift = std::forward<StackResourceDriftT>(value);
  }
  template <typename StackResourceDriftT = StackResourceDrift>
  DetectStackResourceDriftResult& WithStackResourceDrift(StackResourceDriftT&& value) {
    SetStackResourceDrift(std::forward<StackResourceDriftT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DetectStackResourceDriftResult& WithResponseMetadata(ResponseMetadataT&& value) {
