...
class ListStackSetOperationsRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  ListStackSetOperationsRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStackSetOperationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackSetOperationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListStackSetOperationsRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
