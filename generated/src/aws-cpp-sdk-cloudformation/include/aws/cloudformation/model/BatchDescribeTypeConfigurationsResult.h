...
class BatchDescribeTypeConfigurationsResult {
 public:
  ...
  AWS_CLOUDFORMATION_API BatchDescribeTypeConfigurationsResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<BatchDescribeTypeConfigurationsError>>
  BatchDescribeTypeConfigurationsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDescribeTypeConfigurationsError>
  BatchDescribeTypeConfigurationsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
   ...
   */
  inline const Aws::Vector<TypeConfigurationIdentifier>& GetUnprocessedTypeConfigurations() const {
    return m_unprocessedTypeConfigurations;
  }
  template <typename UnprocessedTypeConfigurationsT = Aws::Vector<TypeConfigurationIdentifier>>
  void SetUnprocessedTypeConfigurations(UnprocessedTypeConfigurationsT&& value) {
    m_unprocessedTypeConfigurationsHasBeenSet = true;
    m_unprocessedTypeConfigurations = std::forward<UnprocessedTypeConfigurationsT>(value);
  }
  template <typename UnprocessedTypeConfigurationsT = Aws::Vector<TypeConfigurationIdentifier>>
  BatchDescribeTypeConfigurationsResult& WithUnprocessedTypeConfigurations(UnprocessedTypeConfigurationsT&& value) {
    SetUnprocessedTypeConfigurations(std::forward<UnprocessedTypeConfigurationsT>(value));
    return *this;
  }
  template <typename UnprocessedTypeConfigurationsT = TypeConfigurationIdentifier>
  BatchDescribeTypeConfigurationsResult& AddUnprocessedTypeConfigurations(UnprocessedTypeConfigurationsT&& value) {
    m_unprocessedTypeConfigurationsHasBeenSet = true;
    m_unprocessedTypeConfigurations.emplace_back(std::forward<UnprocessedTypeConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTypeConfigurations(TypeConfigurationsT&& value) {
    m_typeConfigurationsHasBeenSet = true;
    m_typeConfigurations = std::forward<TypeConfigurationsT>(value);
  }
  template <typename TypeConfigurationsT = Aws::Vector<TypeConfigurationDetails>>
  BatchDescribeTypeConfigurationsResult& WithTypeConfigurations(TypeConfigurationsT&& value) {
    SetTypeConfigurations(std::forward<TypeConfigurationsT>(value));
    return *this;
  }
  template <typename TypeConfigurationsT = TypeConfigurationDetails>
  BatchDescribeTypeConfigurationsResult& AddTypeConfigurations(TypeConfigurationsT&& value) {
    m_typeConfigurationsHasBeenSet = true;
    m_typeConfigurations.emplace_back(std::forward<TypeConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  BatchDescribeTypeConfigurationsResult& WithResponseMetadata(ResponseMetadataT&& value) {
