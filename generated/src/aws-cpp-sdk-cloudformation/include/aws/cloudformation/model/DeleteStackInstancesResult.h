...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API DeleteStackInstancesResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    DeleteStackInstancesResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteStackInstancesResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
