...
class StackResourceDrift {
 public:
   ...
   */
  inline const Aws::Vector<PhysicalResourceIdContextKeyValuePair>& GetPhysicalResourceIdContext() const {
    return m_physicalResourceIdContext;
  }
  ...
  void SetPhysicalResourceIdContext(PhysicalResourceIdContextT&& value) {
    ...
    m_physicalResourceIdContext = std::forward<PhysicalResourceIdContextT>(value);
  }
  template <typename PhysicalResourceIdContextT = Aws::Vector<PhysicalResourceIdContextKeyValuePair>>
  StackResourceDrift& WithPhysicalResourceIdContext(PhysicalResourceIdContextT&& value) {
    SetPhysicalResourceIdContext(std::forward<PhysicalResourceIdContextT>(value));
    return *this;
  }
  ...
  StackResourceDrift& AddPhysicalResourceIdContext(PhysicalResourceIdContextT&& value) {
    m_physicalResourceIdContextHasBeenSet = true;
    m_physicalResourceIdContext.emplace_back(std::forward<PhysicalResourceIdContextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedProperties(ExpectedPropertiesT&& value) {
    ...
    m_expectedProperties = std::forward<ExpectedPropertiesT>(value);
  }
  template <typename ExpectedPropertiesT = Aws::String>
  StackResourceDrift& WithExpectedProperties(ExpectedPropertiesT&& value) {
    SetExpectedProperties(std::forward<ExpectedPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualProperties(ActualPropertiesT&& value) {
    ...
    m_actualProperties = std::forward<ActualPropertiesT>(value);
  }
  template <typename ActualPropertiesT = Aws::String>
  StackResourceDrift& WithActualProperties(ActualPropertiesT&& value) {
    SetActualProperties(std::forward<ActualPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPropertyDifferences(PropertyDifferencesT&& value) {
    ...
    m_propertyDifferences = std::forward<PropertyDifferencesT>(value);
  }
  template <typename PropertyDifferencesT = Aws::Vector<PropertyDifference>>
  StackResourceDrift& WithPropertyDifferences(PropertyDifferencesT&& value) {
    SetPropertyDifferences(std::forward<PropertyDifferencesT>(value));
    return *this;
  }
  ...
  StackResourceDrift& AddPropertyDifferences(PropertyDifferencesT&& value) {
    m_propertyDifferencesHasBeenSet = true;
    m_propertyDifferences.emplace_back(std::forward<PropertyDifferencesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStackResourceDriftStatus(StackResourceDriftStatus value) {
    m_stackResourceDriftStatusHasBeenSet = true;
    m_stackResourceDriftStatus = value;
  }
  inline StackResourceDrift& WithStackResourceDriftStatus(StackResourceDriftStatus value) {
    SetStackResourceDriftStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDriftStatusReason(DriftStatusReasonT&& value) {
    ...
    m_driftStatusReason = std::forward<DriftStatusReasonT>(value);
  }
  template <typename DriftStatusReasonT = Aws::String>
  StackResourceDrift& WithDriftStatusReason(DriftStatusReasonT&& value) {
    SetDriftStatusReason(std::forward<DriftStatusReasonT>(value));
    return *this;
  }
  ///@}
 private:
