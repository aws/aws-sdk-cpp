...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API ActivateTypeResult() = default;
    ...
    template<typename ArnT = Aws::String>
    ActivateTypeResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ActivateTypeResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
