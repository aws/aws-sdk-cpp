...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API DeleteChangeSetResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteChangeSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
