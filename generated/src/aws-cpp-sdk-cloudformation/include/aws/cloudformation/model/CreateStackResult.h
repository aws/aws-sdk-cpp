...
class CreateStackResult {
 public:
  AWS_CLOUDFORMATION_API CreateStackResult() = default;
  ...
  template <typename StackIdT = Aws::String>
  CreateStackResult& WithStackId(StackIdT&& value) {
  ...
  ///@{
  /**
   * <p>A unique identifier for this stack operation that can be used to track the
  ...
  template <typename OperationIdT = Aws::String>
  CreateStackResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateStackResult& WithResponseMetadata(ResponseMetadataT&& value) {
