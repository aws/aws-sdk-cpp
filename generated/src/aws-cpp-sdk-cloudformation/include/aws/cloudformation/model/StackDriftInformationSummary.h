...
class StackDriftInformationSummary {
 public:
  ...
  inline StackDriftInformationSummary& WithStackDriftStatus(StackDriftStatus value) {
  ...
  template <typename LastCheckTimestampT = Aws::Utils::DateTime>
  StackDriftInformationSummary& WithLastCheckTimestamp(LastCheckTimestampT&& value) {
