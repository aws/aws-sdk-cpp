...
class ListStackSetsRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStackSetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListStackSetsRequest& WithStatus(StackSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListStackSetsRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
