...
class ValidateTemplateResult {
 public:
  ...
  template <typename ParametersT = Aws::Vector<TemplateParameter>>
  ValidateTemplateResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = TemplateParameter>
  ValidateTemplateResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename DescriptionT = Aws::String>
  ValidateTemplateResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CapabilitiesT = Aws::Vector<Capability>>
  ValidateTemplateResult& WithCapabilities(CapabilitiesT&& value) {
    SetCapabilities(std::forward<CapabilitiesT>(value));
    return *this;
  }
  inline ValidateTemplateResult& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  void SetCapabilitiesReason(CapabilitiesReasonT&& value) {
    m_capabilitiesReasonHasBeenSet = true;
    m_capabilitiesReason = std::forward<CapabilitiesReasonT>(value);
  }
  template <typename CapabilitiesReasonT = Aws::String>
  ValidateTemplateResult& WithCapabilitiesReason(CapabilitiesReasonT&& value) {
    SetCapabilitiesReason(std::forward<CapabilitiesReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeclaredTransforms(DeclaredTransformsT&& value) {
    m_declaredTransformsHasBeenSet = true;
    m_declaredTransforms = std::forward<DeclaredTransformsT>(value);
  }
  template <typename DeclaredTransformsT = Aws::Vector<Aws::String>>
  ValidateTemplateResult& WithDeclaredTransforms(DeclaredTransformsT&& value) {
    SetDeclaredTransforms(std::forward<DeclaredTransformsT>(value));
    return *this;
  }
  template <typename DeclaredTransformsT = Aws::String>
  ValidateTemplateResult& AddDeclaredTransforms(DeclaredTransformsT&& value) {
    m_declaredTransformsHasBeenSet = true;
    m_declaredTransforms.emplace_back(std::forward<DeclaredTransformsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ValidateTemplateResult& WithResponseMetadata(ResponseMetadataT&& value) {
