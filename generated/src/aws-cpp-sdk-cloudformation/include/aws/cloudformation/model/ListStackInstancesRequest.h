...
class ListStackInstancesRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  ListStackInstancesRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStackInstancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<StackInstanceFilter>>
  ListStackInstancesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = StackInstanceFilter>
  ListStackInstancesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename StackInstanceAccountT = Aws::String>
  ListStackInstancesRequest& WithStackInstanceAccount(StackInstanceAccountT&& value) {
  ...
  template <typename StackInstanceRegionT = Aws::String>
  ListStackInstancesRequest& WithStackInstanceRegion(StackInstanceRegionT&& value) {
  ...
  inline ListStackInstancesRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
