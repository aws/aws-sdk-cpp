...
class TypeConfigurationIdentifier {
 public:
  ...
  template <typename TypeArnT = Aws::String>
  TypeConfigurationIdentifier& WithTypeArn(TypeArnT&& value) {
  ...
  void SetTypeConfigurationAlias(TypeConfigurationAliasT&& value) {
    m_typeConfigurationAliasHasBeenSet = true;
    m_typeConfigurationAlias = std::forward<TypeConfigurationAliasT>(value);
  }
  template <typename TypeConfigurationAliasT = Aws::String>
  TypeConfigurationIdentifier& WithTypeConfigurationAlias(TypeConfigurationAliasT&& value) {
    SetTypeConfigurationAlias(std::forward<TypeConfigurationAliasT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTypeConfigurationArn(TypeConfigurationArnT&& value) {
    m_typeConfigurationArnHasBeenSet = true;
    m_typeConfigurationArn = std::forward<TypeConfigurationArnT>(value);
  }
  template <typename TypeConfigurationArnT = Aws::String>
  TypeConfigurationIdentifier& WithTypeConfigurationArn(TypeConfigurationArnT&& value) {
    SetTypeConfigurationArn(std::forward<TypeConfigurationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline TypeConfigurationIdentifier& WithType(ThirdPartyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeNameT = Aws::String>
  TypeConfigurationIdentifier& WithTypeName(TypeNameT&& value) {
