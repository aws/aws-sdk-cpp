...
class DescribeStackResourcesResult {
 public:
  ...
  void SetStackResources(StackResourcesT&& value) {
    m_stackResourcesHasBeenSet = true;
    m_stackResources = std::forward<StackResourcesT>(value);
  }
  template <typename StackResourcesT = Aws::Vector<StackResource>>
  DescribeStackResourcesResult& WithStackResources(StackResourcesT&& value) {
    SetStackResources(std::forward<StackResourcesT>(value));
    return *this;
  }
  template <typename StackResourcesT = StackResource>
  DescribeStackResourcesResult& AddStackResources(StackResourcesT&& value) {
    m_stackResourcesHasBeenSet = true;
    m_stackResources.emplace_back(std::forward<StackResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackResourcesResult& WithResponseMetadata(ResponseMetadataT&& value) {
