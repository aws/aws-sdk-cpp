...
class ListGeneratedTemplatesResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<TemplateSummary>>
  ListGeneratedTemplatesResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = TemplateSummary>
  ListGeneratedTemplatesResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGeneratedTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListGeneratedTemplatesResult& WithResponseMetadata(ResponseMetadataT&& value) {
