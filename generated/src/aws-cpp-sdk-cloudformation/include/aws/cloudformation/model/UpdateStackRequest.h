...
class UpdateStackRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline UpdateStackRequest& WithUsePreviousTemplate(bool value) {
  ...
  void SetStackPolicyDuringUpdateBody(StackPolicyDuringUpdateBodyT&& value) {
    m_stackPolicyDuringUpdateBodyHasBeenSet = true;
    m_stackPolicyDuringUpdateBody = std::forward<StackPolicyDuringUpdateBodyT>(value);
  }
  template <typename StackPolicyDuringUpdateBodyT = Aws::String>
  UpdateStackRequest& WithStackPolicyDuringUpdateBody(StackPolicyDuringUpdateBodyT&& value) {
    SetStackPolicyDuringUpdateBody(std::forward<StackPolicyDuringUpdateBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStackPolicyDuringUpdateURL(StackPolicyDuringUpdateURLT&& value) {
    m_stackPolicyDuringUpdateURLHasBeenSet = true;
    m_stackPolicyDuringUpdateURL = std::forward<StackPolicyDuringUpdateURLT>(value);
  }
  template <typename StackPolicyDuringUpdateURLT = Aws::String>
  UpdateStackRequest& WithStackPolicyDuringUpdateURL(StackPolicyDuringUpdateURLT&& value) {
    SetStackPolicyDuringUpdateURL(std::forward<StackPolicyDuringUpdateURLT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateStackRequest& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  void SetStackPolicyBody(StackPolicyBodyT&& value) {
    ...
    m_stackPolicyBody = std::forward<StackPolicyBodyT>(value);
  }
  template <typename StackPolicyBodyT = Aws::String>
  UpdateStackRequest& WithStackPolicyBody(StackPolicyBodyT&& value) {
    SetStackPolicyBody(std::forward<StackPolicyBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStackPolicyURL(StackPolicyURLT&& value) {
    m_stackPolicyURLHasBeenSet = true;
    m_stackPolicyURL = std::forward<StackPolicyURLT>(value);
  }
  template <typename StackPolicyURLT = Aws::String>
  UpdateStackRequest& WithStackPolicyURL(StackPolicyURLT&& value) {
    SetStackPolicyURL(std::forward<StackPolicyURLT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateStackRequest& WithDisableRollback(bool value) {
  ...
  inline UpdateStackRequest& WithRetainExceptOnCreate(bool value) {
  ...
  template <typename DeploymentConfigT = DeploymentConfig>
  UpdateStackRequest& WithDeploymentConfig(DeploymentConfigT&& value) {
  ...
  inline UpdateStackRequest& WithDisableValidation(bool value) {
