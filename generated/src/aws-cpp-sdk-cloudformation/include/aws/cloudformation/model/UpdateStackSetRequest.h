...
class UpdateStackSetRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline UpdateStackSetRequest& WithUsePreviousTemplate(bool value) {
  ...
  inline UpdateStackSetRequest& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  inline UpdateStackSetRequest& WithPermissionModel(PermissionModels value) {
  ...
  inline UpdateStackSetRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
