...
class ImportStacksToStackSetRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  ImportStacksToStackSetRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  void SetStackIds(StackIdsT&& value) {
    m_stackIdsHasBeenSet = true;
    m_stackIds = std::forward<StackIdsT>(value);
  }
  template <typename StackIdsT = Aws::Vector<Aws::String>>
  ImportStacksToStackSetRequest& WithStackIds(StackIdsT&& value) {
    SetStackIds(std::forward<StackIdsT>(value));
    return *this;
  }
  template <typename StackIdsT = Aws::String>
  ImportStacksToStackSetRequest& AddStackIds(StackIdsT&& value) {
    m_stackIdsHasBeenSet = true;
    m_stackIds.emplace_back(std::forward<StackIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStackIdsUrl(StackIdsUrlT&& value) {
    m_stackIdsUrlHasBeenSet = true;
    m_stackIdsUrl = std::forward<StackIdsUrlT>(value);
  }
  template <typename StackIdsUrlT = Aws::String>
  ImportStacksToStackSetRequest& WithStackIdsUrl(StackIdsUrlT&& value) {
    SetStackIdsUrl(std::forward<StackIdsUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrganizationalUnitIds(OrganizationalUnitIdsT&& value) {
    ...
    m_organizationalUnitIds = std::forward<OrganizationalUnitIdsT>(value);
  }
  template <typename OrganizationalUnitIdsT = Aws::Vector<Aws::String>>
  ImportStacksToStackSetRequest& WithOrganizationalUnitIds(OrganizationalUnitIdsT&& value) {
    SetOrganizationalUnitIds(std::forward<OrganizationalUnitIdsT>(value));
    return *this;
  }
  template <typename OrganizationalUnitIdsT = Aws::String>
  ImportStacksToStackSetRequest& AddOrganizationalUnitIds(OrganizationalUnitIdsT&& value) {
    m_organizationalUnitIdsHasBeenSet = true;
    m_organizationalUnitIds.emplace_back(std::forward<OrganizationalUnitIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperationPreferences(OperationPreferencesT&& value) {
    ...
    m_operationPreferences = std::forward<OperationPreferencesT>(value);
  }
  template <typename OperationPreferencesT = StackSetOperationPreferences>
  ImportStacksToStackSetRequest& WithOperationPreferences(OperationPreferencesT&& value) {
    SetOperationPreferences(std::forward<OperationPreferencesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OperationIdT = Aws::String>
  ImportStacksToStackSetRequest& WithOperationId(OperationIdT&& value) {
  ...
  inline ImportStacksToStackSetRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
