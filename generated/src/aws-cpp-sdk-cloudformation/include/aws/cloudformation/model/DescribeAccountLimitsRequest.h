...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API DescribeAccountLimitsRequest() = default;
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    DescribeAccountLimitsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
