...
class ListStackSetAutoDeploymentTargetsRequest : public CloudFormationRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListStackSetAutoDeploymentTargets"; }
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  ListStackSetAutoDeploymentTargetsRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStackSetAutoDeploymentTargetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackSetAutoDeploymentTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListStackSetAutoDeploymentTargetsRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
