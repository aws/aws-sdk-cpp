...
class StackSet {
 public:
  ...
  inline StackSet& WithStatus(StackSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StackSet& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  void SetStackSetARN(StackSetARNT&& value) {
    ...
    m_stackSetARN = std::forward<StackSetARNT>(value);
  }
  template <typename StackSetARNT = Aws::String>
  StackSet& WithStackSetARN(StackSetARNT&& value) {
    SetStackSetARN(std::forward<StackSetARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline StackSet& WithPermissionModel(PermissionModels value) {
