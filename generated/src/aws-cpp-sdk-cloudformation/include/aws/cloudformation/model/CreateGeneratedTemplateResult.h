...
class CreateGeneratedTemplateResult {
 public:
  ...
  template <typename GeneratedTemplateIdT = Aws::String>
  CreateGeneratedTemplateResult& WithGeneratedTemplateId(GeneratedTemplateIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateGeneratedTemplateResult& WithResponseMetadata(ResponseMetadataT&& value) {
