...
class ListHookResultsResult {
 public:
  ...
  inline ListHookResultsResult& WithTargetType(ListHookResultsTargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TargetIdT = Aws::String>
  ListHookResultsResult& WithTargetId(TargetIdT&& value) {
  ...
  void SetHookResults(HookResultsT&& value) {
    m_hookResultsHasBeenSet = true;
    m_hookResults = std::forward<HookResultsT>(value);
  }
  template <typename HookResultsT = Aws::Vector<HookResultSummary>>
  ListHookResultsResult& WithHookResults(HookResultsT&& value) {
    SetHookResults(std::forward<HookResultsT>(value));
    return *this;
  }
  template <typename HookResultsT = HookResultSummary>
  ListHookResultsResult& AddHookResults(HookResultsT&& value) {
    m_hookResultsHasBeenSet = true;
    m_hookResults.emplace_back(std::forward<HookResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHookResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListHookResultsResult& WithResponseMetadata(ResponseMetadataT&& value) {
