...
class ListResourceScanRelatedResourcesResult {
 public:
  ...
  AWS_CLOUDFORMATION_API ListResourceScanRelatedResourcesResult& operator=(
  ...
  template <typename RelatedResourcesT = Aws::Vector<ScannedResource>>
  ListResourceScanRelatedResourcesResult& WithRelatedResources(RelatedResourcesT&& value) {
    SetRelatedResources(std::forward<RelatedResourcesT>(value));
    return *this;
  }
  template <typename RelatedResourcesT = ScannedResource>
  ListResourceScanRelatedResourcesResult& AddRelatedResources(RelatedResourcesT&& value) {
    m_relatedResourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceScanRelatedResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListResourceScanRelatedResourcesResult& WithResponseMetadata(ResponseMetadataT&& value) {
