...
class ListResourceScanRelatedResourcesRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename ResourceScanIdT = Aws::String>
  ListResourceScanRelatedResourcesRequest& WithResourceScanId(ResourceScanIdT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<ScannedResourceIdentifier>>
  ListResourceScanRelatedResourcesRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ScannedResourceIdentifier>
  ListResourceScanRelatedResourcesRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceScanRelatedResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceScanRelatedResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
