...
class ActivateTypeRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline ActivateTypeRequest& WithType(ThirdPartyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename PublicTypeArnT = Aws::String>
  ActivateTypeRequest& WithPublicTypeArn(PublicTypeArnT&& value) {
  ...
  template <typename PublisherIdT = Aws::String>
  ActivateTypeRequest& WithPublisherId(PublisherIdT&& value) {
  ...
  template <typename TypeNameT = Aws::String>
  ActivateTypeRequest& WithTypeName(TypeNameT&& value) {
  ...
  template <typename TypeNameAliasT = Aws::String>
  ActivateTypeRequest& WithTypeNameAlias(TypeNameAliasT&& value) {
  ...
  inline ActivateTypeRequest& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  template <typename LoggingConfigT = LoggingConfig>
  ActivateTypeRequest& WithLoggingConfig(LoggingConfigT&& value) {
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  ActivateTypeRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  inline void SetVersionBump(VersionBump value) {
    m_versionBumpHasBeenSet = true;
    m_versionBump = value;
  }
  inline ActivateTypeRequest& WithVersionBump(VersionBump value) {
    SetVersionBump(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMajorVersion(long long value) {
    m_majorVersionHasBeenSet = true;
    m_majorVersion = value;
  }
  inline ActivateTypeRequest& WithMajorVersion(long long value) {
