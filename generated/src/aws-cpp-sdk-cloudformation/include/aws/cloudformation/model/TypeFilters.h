...
class TypeFilters {
 public:
  ...
  inline TypeFilters& WithCategory(Category value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  template <typename PublisherIdT = Aws::String>
  TypeFilters& WithPublisherId(PublisherIdT&& value) {
  ...
  void SetTypeNamePrefix(TypeNamePrefixT&& value) {
    m_typeNamePrefixHasBeenSet = true;
    m_typeNamePrefix = std::forward<TypeNamePrefixT>(value);
  }
  template <typename TypeNamePrefixT = Aws::String>
  TypeFilters& WithTypeNamePrefix(TypeNamePrefixT&& value) {
    SetTypeNamePrefix(std::forward<TypeNamePrefixT>(value));
    return *this;
  }
  ///@}
 private:
