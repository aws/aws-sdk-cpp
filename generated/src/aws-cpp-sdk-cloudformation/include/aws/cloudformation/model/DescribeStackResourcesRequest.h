...
class DescribeStackResourcesRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackNameT = Aws::String>
  DescribeStackResourcesRequest& WithStackName(StackNameT&& value) {
  ...
  template <typename LogicalResourceIdT = Aws::String>
  DescribeStackResourcesRequest& WithLogicalResourceId(LogicalResourceIdT&& value) {
  ...
  template <typename PhysicalResourceIdT = Aws::String>
  DescribeStackResourcesRequest& WithPhysicalResourceId(PhysicalResourceIdT&& value) {
