...
class ListStackRefactorActionsRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackRefactorIdT = Aws::String>
  ListStackRefactorActionsRequest& WithStackRefactorId(StackRefactorIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStackRefactorActionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackRefactorActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
