...
class ListStackRefactorsRequest : public CloudFormationRequest {
 ...
 public:
  ...
  void SetExecutionStatusFilter(ExecutionStatusFilterT&& value) {
    m_executionStatusFilterHasBeenSet = true;
    m_executionStatusFilter = std::forward<ExecutionStatusFilterT>(value);
  }
  template <typename ExecutionStatusFilterT = Aws::Vector<StackRefactorExecutionStatus>>
  ListStackRefactorsRequest& WithExecutionStatusFilter(ExecutionStatusFilterT&& value) {
    SetExecutionStatusFilter(std::forward<ExecutionStatusFilterT>(value));
    return *this;
  }
  inline ListStackRefactorsRequest& AddExecutionStatusFilter(StackRefactorExecutionStatus value) {
    m_executionStatusFilterHasBeenSet = true;
    m_executionStatusFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStackRefactorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStackRefactorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
