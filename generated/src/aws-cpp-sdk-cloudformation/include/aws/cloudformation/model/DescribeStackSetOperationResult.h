...
class DescribeStackSetOperationResult {
 public:
  ...
  AWS_CLOUDFORMATION_API DescribeStackSetOperationResult& operator=(
  ...
  void SetStackSetOperation(StackSetOperationT&& value) {
    m_stackSetOperationHasBeenSet = true;
    m_stackSetOperation = std::forward<StackSetOperationT>(value);
  }
  template <typename StackSetOperationT = StackSetOperation>
  DescribeStackSetOperationResult& WithStackSetOperation(StackSetOperationT&& value) {
    SetStackSetOperation(std::forward<StackSetOperationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackSetOperationResult& WithResponseMetadata(ResponseMetadataT&& value) {
