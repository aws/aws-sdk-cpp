...
class DescribeTypeRegistrationResult {
 public:
  ...
  inline void SetProgressStatus(RegistrationStatus value) {
    m_progressStatusHasBeenSet = true;
    m_progressStatus = value;
  }
  inline DescribeTypeRegistrationResult& WithProgressStatus(RegistrationStatus value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeTypeRegistrationResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename TypeArnT = Aws::String>
  DescribeTypeRegistrationResult& WithTypeArn(TypeArnT&& value) {
  ...
  template <typename TypeVersionArnT = Aws::String>
  DescribeTypeRegistrationResult& WithTypeVersionArn(TypeVersionArnT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTypeRegistrationResult& WithResponseMetadata(ResponseMetadataT&& value) {
