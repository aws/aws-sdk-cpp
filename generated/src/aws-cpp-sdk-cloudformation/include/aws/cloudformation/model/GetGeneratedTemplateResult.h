...
class GetGeneratedTemplateResult {
 public:
  ...
  inline GetGeneratedTemplateResult& WithStatus(GeneratedTemplateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TemplateBodyT = Aws::String>
  GetGeneratedTemplateResult& WithTemplateBody(TemplateBodyT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetGeneratedTemplateResult& WithResponseMetadata(ResponseMetadataT&& value) {
