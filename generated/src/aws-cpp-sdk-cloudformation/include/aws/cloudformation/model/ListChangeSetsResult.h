...
class ListChangeSetsResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<ChangeSetSummary>>
  ListChangeSetsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = ChangeSetSummary>
  ListChangeSetsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListChangeSetsResult& WithResponseMetadata(ResponseMetadataT&& value) {
