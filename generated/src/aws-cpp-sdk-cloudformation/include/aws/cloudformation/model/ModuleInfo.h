...
class ModuleInfo {
 public:
  ...
  void SetTypeHierarchy(TypeHierarchyT&& value) {
    m_typeHierarchyHasBeenSet = true;
    m_typeHierarchy = std::forward<TypeHierarchyT>(value);
  }
  template <typename TypeHierarchyT = Aws::String>
  ModuleInfo& WithTypeHierarchy(TypeHierarchyT&& value) {
    SetTypeHierarchy(std::forward<TypeHierarchyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogicalIdHierarchy(LogicalIdHierarchyT&& value) {
    m_logicalIdHierarchyHasBeenSet = true;
    m_logicalIdHierarchy = std::forward<LogicalIdHierarchyT>(value);
  }
  template <typename LogicalIdHierarchyT = Aws::String>
  ModuleInfo& WithLogicalIdHierarchy(LogicalIdHierarchyT&& value) {
    SetLogicalIdHierarchy(std::forward<LogicalIdHierarchyT>(value));
    return *this;
  }
  ///@}
 private:
