...
class CreateChangeSetRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline void SetUsePreviousTemplate(bool value) {
    m_usePreviousTemplateHasBeenSet = true;
    m_usePreviousTemplate = value;
  }
  inline CreateChangeSetRequest& WithUsePreviousTemplate(bool value) {
    SetUsePreviousTemplate(value);
    return *this;
  }
  ///@}
  ...
  inline CreateChangeSetRequest& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  void SetRollbackConfiguration(RollbackConfigurationT&& value) {
    ...
    m_rollbackConfiguration = std::forward<RollbackConfigurationT>(value);
  }
  template <typename RollbackConfigurationT = RollbackConfiguration>
  CreateChangeSetRequest& WithRollbackConfiguration(RollbackConfigurationT&& value) {
    SetRollbackConfiguration(std::forward<RollbackConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetChangeSetType(ChangeSetType value) {
    m_changeSetTypeHasBeenSet = true;
    m_changeSetType = value;
  }
  inline CreateChangeSetRequest& WithChangeSetType(ChangeSetType value) {
    SetChangeSetType(value);
    return *this;
  }
  ///@}
  ...
  void SetResourcesToImport(ResourcesToImportT&& value) {
    m_resourcesToImportHasBeenSet = true;
    m_resourcesToImport = std::forward<ResourcesToImportT>(value);
  }
  template <typename ResourcesToImportT = Aws::Vector<ResourceToImport>>
  CreateChangeSetRequest& WithResourcesToImport(ResourcesToImportT&& value) {
    SetResourcesToImport(std::forward<ResourcesToImportT>(value));
    return *this;
  }
  ...
  CreateChangeSetRequest& AddResourcesToImport(ResourcesToImportT&& value) {
    m_resourcesToImportHasBeenSet = true;
    m_resourcesToImport.emplace_back(std::forward<ResourcesToImportT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeNestedStacks(bool value) {
    m_includeNestedStacksHasBeenSet = true;
    m_includeNestedStacks = value;
  }
  inline CreateChangeSetRequest& WithIncludeNestedStacks(bool value) {
    SetIncludeNestedStacks(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOnStackFailure(OnStackFailure value) {
    m_onStackFailureHasBeenSet = true;
    m_onStackFailure = value;
  }
  inline CreateChangeSetRequest& WithOnStackFailure(OnStackFailure value) {
    SetOnStackFailure(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImportExistingResources(bool value) {
    m_importExistingResourcesHasBeenSet = true;
    m_importExistingResources = value;
  }
  inline CreateChangeSetRequest& WithImportExistingResources(bool value) {
    SetImportExistingResources(value);
    return *this;
  }
  ///@}
