...
class ListStackInstancesResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<StackInstanceSummary>>
  ListStackInstancesResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = StackInstanceSummary>
  ListStackInstancesResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStackInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListStackInstancesResult& WithResponseMetadata(ResponseMetadataT&& value) {
