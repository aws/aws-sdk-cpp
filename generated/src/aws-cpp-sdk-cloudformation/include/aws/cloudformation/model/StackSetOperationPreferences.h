...
class StackSetOperationPreferences {
 public:
  ...
  inline void SetRegionConcurrencyType(RegionConcurrencyType value) {
    m_regionConcurrencyTypeHasBeenSet = true;
    m_regionConcurrencyType = value;
  }
  inline StackSetOperationPreferences& WithRegionConcurrencyType(RegionConcurrencyType value) {
    SetRegionConcurrencyType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureToleranceCount(int value) {
    m_failureToleranceCountHasBeenSet = true;
    m_failureToleranceCount = value;
  }
  inline StackSetOperationPreferences& WithFailureToleranceCount(int value) {
    SetFailureToleranceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureTolerancePercentage(int value) {
    m_failureTolerancePercentageHasBeenSet = true;
    m_failureTolerancePercentage = value;
  }
  inline StackSetOperationPreferences& WithFailureTolerancePercentage(int value) {
    SetFailureTolerancePercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentCount(int value) {
    m_maxConcurrentCountHasBeenSet = true;
    m_maxConcurrentCount = value;
  }
  inline StackSetOperationPreferences& WithMaxConcurrentCount(int value) {
    SetMaxConcurrentCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentPercentage(int value) {
    m_maxConcurrentPercentageHasBeenSet = true;
    m_maxConcurrentPercentage = value;
  }
  inline StackSetOperationPreferences& WithMaxConcurrentPercentage(int value) {
    SetMaxConcurrentPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConcurrencyMode(ConcurrencyMode value) {
    m_concurrencyModeHasBeenSet = true;
    m_concurrencyMode = value;
  }
  inline StackSetOperationPreferences& WithConcurrencyMode(ConcurrencyMode value) {
    SetConcurrencyMode(value);
    return *this;
  }
  ///@}
 private:
