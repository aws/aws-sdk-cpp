...
class DescribeStackDriftDetectionStatusResult {
 public:
  ...
  AWS_CLOUDFORMATION_API DescribeStackDriftDetectionStatusResult& operator=(
  ...
  template <typename StackIdT = Aws::String>
  DescribeStackDriftDetectionStatusResult& WithStackId(StackIdT&& value) {
  ...
  void SetStackDriftDetectionId(StackDriftDetectionIdT&& value) {
    ...
    m_stackDriftDetectionId = std::forward<StackDriftDetectionIdT>(value);
  }
  template <typename StackDriftDetectionIdT = Aws::String>
  DescribeStackDriftDetectionStatusResult& WithStackDriftDetectionId(StackDriftDetectionIdT&& value) {
    SetStackDriftDetectionId(std::forward<StackDriftDetectionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeStackDriftDetectionStatusResult& WithStackDriftStatus(StackDriftStatus value) {
  ...
  inline void SetDetectionStatus(StackDriftDetectionStatus value) {
    m_detectionStatusHasBeenSet = true;
    m_detectionStatus = value;
  }
  inline DescribeStackDriftDetectionStatusResult& WithDetectionStatus(StackDriftDetectionStatus value) {
  ...
  void SetDetectionStatusReason(DetectionStatusReasonT&& value) {
    m_detectionStatusReasonHasBeenSet = true;
    m_detectionStatusReason = std::forward<DetectionStatusReasonT>(value);
  }
  template <typename DetectionStatusReasonT = Aws::String>
  DescribeStackDriftDetectionStatusResult& WithDetectionStatusReason(DetectionStatusReasonT&& value) {
    SetDetectionStatusReason(std::forward<DetectionStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDriftedStackResourceCount(int value) {
    m_driftedStackResourceCountHasBeenSet = true;
    m_driftedStackResourceCount = value;
  }
  inline DescribeStackDriftDetectionStatusResult& WithDriftedStackResourceCount(int value) {
    SetDriftedStackResourceCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  DescribeStackDriftDetectionStatusResult& WithTimestamp(TimestampT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackDriftDetectionStatusResult& WithResponseMetadata(ResponseMetadataT&& value) {
