...
class ChangeSetHook {
 public:
  ...
  inline ChangeSetHook& WithInvocationPoint(HookInvocationPoint value) {
  ...
  inline ChangeSetHook& WithFailureMode(HookFailureMode value) {
  ...
  void SetTargetDetails(TargetDetailsT&& value) {
    ...
    m_targetDetails = std::forward<TargetDetailsT>(value);
  }
  template <typename TargetDetailsT = ChangeSetHookTargetDetails>
  ChangeSetHook& WithTargetDetails(TargetDetailsT&& value) {
    SetTargetDetails(std::forward<TargetDetailsT>(value));
    return *this;
  }
  ///@}
 private:
