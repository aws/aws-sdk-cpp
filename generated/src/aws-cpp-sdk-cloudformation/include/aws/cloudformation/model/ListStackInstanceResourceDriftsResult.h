...
namespace Model
{
  ...
  public:
    ...
    template<typename SummariesT = Aws::Vector<StackInstanceResourceDriftsSummary>>
    ListStackInstanceResourceDriftsResult& WithSummaries(SummariesT&& value) { SetSummaries(std::forward<SummariesT>(value)); return *this;}
    template<typename SummariesT = StackInstanceResourceDriftsSummary>
    ListStackInstanceResourceDriftsResult& AddSummaries(SummariesT&& value) { m_summariesHasBeenSet = true; m_summaries.emplace_back(std::forward<SummariesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListStackInstanceResourceDriftsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ListStackInstanceResourceDriftsResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
