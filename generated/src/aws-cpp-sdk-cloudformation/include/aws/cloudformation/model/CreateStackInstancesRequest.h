...
class CreateStackInstancesRequest : public CloudFormationRequest {
 ...
 public:
  ...
  void SetDeploymentTargets(DeploymentTargetsT&& value) {
    ...
    m_deploymentTargets = std::forward<DeploymentTargetsT>(value);
  }
  template <typename DeploymentTargetsT = DeploymentTargets>
  CreateStackInstancesRequest& WithDeploymentTargets(DeploymentTargetsT&& value) {
    SetDeploymentTargets(std::forward<DeploymentTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateStackInstancesRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
