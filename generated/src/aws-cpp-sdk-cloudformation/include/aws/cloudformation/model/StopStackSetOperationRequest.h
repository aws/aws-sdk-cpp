...
class StopStackSetOperationRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  StopStackSetOperationRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  template <typename OperationIdT = Aws::String>
  StopStackSetOperationRequest& WithOperationId(OperationIdT&& value) {
  ...
  inline StopStackSetOperationRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
