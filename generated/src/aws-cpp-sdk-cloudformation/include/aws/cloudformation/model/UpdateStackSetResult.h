...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API UpdateStackSetResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    UpdateStackSetResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    UpdateStackSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
