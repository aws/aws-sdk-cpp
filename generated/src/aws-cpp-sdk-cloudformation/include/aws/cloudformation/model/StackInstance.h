...
class StackInstance {
 public:
  ...
  inline void SetStatus(StackInstanceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StackInstance& WithStatus(StackInstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStackInstanceStatus(StackInstanceStatusT&& value) {
    ...
    m_stackInstanceStatus = std::forward<StackInstanceStatusT>(value);
  }
  template <typename StackInstanceStatusT = StackInstanceComprehensiveStatus>
  StackInstance& WithStackInstanceStatus(StackInstanceStatusT&& value) {
    SetStackInstanceStatus(std::forward<StackInstanceStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline StackInstance& WithDriftStatus(StackDriftStatus value) {
  ...
  void SetLastOperationId(LastOperationIdT&& value) {
    ...
    m_lastOperationId = std::forward<LastOperationIdT>(value);
  }
  template <typename LastOperationIdT = Aws::String>
  StackInstance& WithLastOperationId(LastOperationIdT&& value) {
    SetLastOperationId(std::forward<LastOperationIdT>(value));
    return *this;
  }
  ///@}
 private:
