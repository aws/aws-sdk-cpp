...
class DescribeChangeSetHooksRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename ChangeSetNameT = Aws::String>
  DescribeChangeSetHooksRequest& WithChangeSetName(ChangeSetNameT&& value) {
  ...
  template <typename StackNameT = Aws::String>
  DescribeChangeSetHooksRequest& WithStackName(StackNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeChangeSetHooksRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename LogicalResourceIdT = Aws::String>
  DescribeChangeSetHooksRequest& WithLogicalResourceId(LogicalResourceIdT&& value) {
