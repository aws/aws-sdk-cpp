...
class ListResourceScansRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceScansRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListResourceScansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScanTypeFilter(ScanType value) {
    m_scanTypeFilterHasBeenSet = true;
    m_scanTypeFilter = value;
  }
  inline ListResourceScansRequest& WithScanTypeFilter(ScanType value) {
