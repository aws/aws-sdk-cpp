...
/**
 * <p>The <code>Stack</code> data type.</p><p><h3>See Also:</h3>   <a
...
class Stack {
 public:
  ...
  inline void SetStackStatus(StackStatus value) {
    m_stackStatusHasBeenSet = true;
    m_stackStatus = value;
  }
  inline Stack& WithStackStatus(StackStatus value) {
    SetStackStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStackStatusReason(StackStatusReasonT&& value) {
    ...
    m_stackStatusReason = std::forward<StackStatusReasonT>(value);
  }
  template <typename StackStatusReasonT = Aws::String>
  Stack& WithStackStatusReason(StackStatusReasonT&& value) {
    SetStackStatusReason(std::forward<StackStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline Stack& WithTimeoutInMinutes(int value) {
  ...
  inline Stack& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  inline Stack& WithEnableTerminationProtection(bool value) {
  ...
  inline Stack& WithRetainExceptOnCreate(bool value) {
  ...
  inline Stack& WithDeletionMode(DeletionMode value) {
  ...
  inline Stack& WithDetailedStatus(DetailedStatus value) {
