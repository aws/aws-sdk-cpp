...
class StackSetOperationResultSummary {
 public:
  ...
  inline void SetStatus(StackSetOperationResultStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StackSetOperationResultSummary& WithStatus(StackSetOperationResultStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAccountGateResult(AccountGateResultT&& value) {
    m_accountGateResultHasBeenSet = true;
    m_accountGateResult = std::forward<AccountGateResultT>(value);
  }
  template <typename AccountGateResultT = AccountGateResult>
  StackSetOperationResultSummary& WithAccountGateResult(AccountGateResultT&& value) {
    SetAccountGateResult(std::forward<AccountGateResultT>(value));
    return *this;
  }
  ///@}
