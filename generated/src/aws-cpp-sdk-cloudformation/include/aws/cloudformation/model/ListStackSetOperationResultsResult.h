...
class ListStackSetOperationResultsResult {
 public:
  ...
  AWS_CLOUDFORMATION_API ListStackSetOperationResultsResult& operator=(
  ...
  template <typename SummariesT = Aws::Vector<StackSetOperationResultSummary>>
  ListStackSetOperationResultsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = StackSetOperationResultSummary>
  ListStackSetOperationResultsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStackSetOperationResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListStackSetOperationResultsResult& WithResponseMetadata(ResponseMetadataT&& value) {
