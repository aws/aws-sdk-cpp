...
class DescribeStackEventsRequest : public CloudFormationRequest {
 public:
  AWS_CLOUDFORMATION_API DescribeStackEventsRequest() = default;
 ...
 public:
  ...
  template <typename StackNameT = Aws::String>
  DescribeStackEventsRequest& WithStackName(StackNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeStackEventsRequest& WithNextToken(NextTokenT&& value) {
