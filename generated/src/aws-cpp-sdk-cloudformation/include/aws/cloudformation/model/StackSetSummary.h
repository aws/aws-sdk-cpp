...
class StackSetSummary {
 public:
  ...
  void SetStackSetId(StackSetIdT&& value) {
    ...
    m_stackSetId = std::forward<StackSetIdT>(value);
  }
  template <typename StackSetIdT = Aws::String>
  StackSetSummary& WithStackSetId(StackSetIdT&& value) {
    SetStackSetId(std::forward<StackSetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(StackSetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StackSetSummary& WithStatus(StackSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoDeployment(AutoDeploymentT&& value) {
    ...
    m_autoDeployment = std::forward<AutoDeploymentT>(value);
  }
  template <typename AutoDeploymentT = AutoDeployment>
  StackSetSummary& WithAutoDeployment(AutoDeploymentT&& value) {
    SetAutoDeployment(std::forward<AutoDeploymentT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPermissionModel(PermissionModels value) {
    m_permissionModelHasBeenSet = true;
    m_permissionModel = value;
  }
  inline StackSetSummary& WithPermissionModel(PermissionModels value) {
    SetPermissionModel(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDriftStatus(StackDriftStatus value) {
    m_driftStatusHasBeenSet = true;
    m_driftStatus = value;
  }
  inline StackSetSummary& WithDriftStatus(StackDriftStatus value) {
  ...
  void SetLastDriftCheckTimestamp(LastDriftCheckTimestampT&& value) {
    ...
    m_lastDriftCheckTimestamp = std::forward<LastDriftCheckTimestampT>(value);
  }
  template <typename LastDriftCheckTimestampT = Aws::Utils::DateTime>
  StackSetSummary& WithLastDriftCheckTimestamp(LastDriftCheckTimestampT&& value) {
    SetLastDriftCheckTimestamp(std::forward<LastDriftCheckTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedExecution(ManagedExecutionT&& value) {
    ...
    m_managedExecution = std::forward<ManagedExecutionT>(value);
  }
  template <typename ManagedExecutionT = ManagedExecution>
  StackSetSummary& WithManagedExecution(ManagedExecutionT&& value) {
    SetManagedExecution(std::forward<ManagedExecutionT>(value));
    return *this;
  }
  ///@}
 private:
