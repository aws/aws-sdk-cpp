...
class ListStackRefactorsResult {
 public:
  ...
  void SetStackRefactorSummaries(StackRefactorSummariesT&& value) {
    m_stackRefactorSummariesHasBeenSet = true;
    m_stackRefactorSummaries = std::forward<StackRefactorSummariesT>(value);
  }
  template <typename StackRefactorSummariesT = Aws::Vector<StackRefactorSummary>>
  ListStackRefactorsResult& WithStackRefactorSummaries(StackRefactorSummariesT&& value) {
    SetStackRefactorSummaries(std::forward<StackRefactorSummariesT>(value));
    return *this;
  }
  template <typename StackRefactorSummariesT = StackRefactorSummary>
  ListStackRefactorsResult& AddStackRefactorSummaries(StackRefactorSummariesT&& value) {
    m_stackRefactorSummariesHasBeenSet = true;
    m_stackRefactorSummaries.emplace_back(std::forward<StackRefactorSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStackRefactorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListStackRefactorsResult& WithResponseMetadata(ResponseMetadataT&& value) {
