...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API DeleteStackSetResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteStackSetResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
