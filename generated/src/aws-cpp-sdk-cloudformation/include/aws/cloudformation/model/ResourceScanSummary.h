...
class ResourceScanSummary {
 public:
  ...
  inline ResourceScanSummary& WithStatus(ResourceScanStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceScanSummary& WithPercentageCompleted(double value) {
  ...
  inline ResourceScanSummary& WithScanType(ScanType value) {
    SetScanType(value);
    return *this;
  }
  ///@}
