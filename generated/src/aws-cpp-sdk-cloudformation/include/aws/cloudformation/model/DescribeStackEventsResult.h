...
class DescribeStackEventsResult {
 public:
  ...
  void SetStackEvents(StackEventsT&& value) {
    m_stackEventsHasBeenSet = true;
    m_stackEvents = std::forward<StackEventsT>(value);
  }
  template <typename StackEventsT = Aws::Vector<StackEvent>>
  DescribeStackEventsResult& WithStackEvents(StackEventsT&& value) {
    SetStackEvents(std::forward<StackEventsT>(value));
    return *this;
  }
  template <typename StackEventsT = StackEvent>
  DescribeStackEventsResult& AddStackEvents(StackEventsT&& value) {
    m_stackEventsHasBeenSet = true;
    m_stackEvents.emplace_back(std::forward<StackEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeStackEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStackEventsResult& WithResponseMetadata(ResponseMetadataT&& value) {
