...
class StackSetOperation {
 public:
  ...
  inline StackSetOperation& WithAction(StackSetOperationAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline StackSetOperation& WithStatus(StackSetOperationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetainStacks(bool value) {
    m_retainStacksHasBeenSet = true;
    m_retainStacks = value;
  }
  inline StackSetOperation& WithRetainStacks(bool value) {
    SetRetainStacks(value);
    return *this;
  }
  ///@}
  ...
  void SetStackSetDriftDetectionDetails(StackSetDriftDetectionDetailsT&& value) {
    ...
    m_stackSetDriftDetectionDetails = std::forward<StackSetDriftDetectionDetailsT>(value);
  }
  template <typename StackSetDriftDetectionDetailsT = StackSetDriftDetectionDetails>
  StackSetOperation& WithStackSetDriftDetectionDetails(StackSetDriftDetectionDetailsT&& value) {
    SetStackSetDriftDetectionDetails(std::forward<StackSetDriftDetectionDetailsT>(value));
    return *this;
  }
  ///@}
