...
class ListResourceScansResult {
 public:
  ...
  void SetResourceScanSummaries(ResourceScanSummariesT&& value) {
    m_resourceScanSummariesHasBeenSet = true;
    m_resourceScanSummaries = std::forward<ResourceScanSummariesT>(value);
  }
  template <typename ResourceScanSummariesT = Aws::Vector<ResourceScanSummary>>
  ListResourceScansResult& WithResourceScanSummaries(ResourceScanSummariesT&& value) {
    SetResourceScanSummaries(std::forward<ResourceScanSummariesT>(value));
    return *this;
  }
  template <typename ResourceScanSummariesT = ResourceScanSummary>
  ListResourceScansResult& AddResourceScanSummaries(ResourceScanSummariesT&& value) {
    m_resourceScanSummariesHasBeenSet = true;
    m_resourceScanSummaries.emplace_back(std::forward<ResourceScanSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceScansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListResourceScansResult& WithResponseMetadata(ResponseMetadataT&& value) {
