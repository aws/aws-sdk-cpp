...
class TemplateConfiguration {
 public:
  ...
  inline void SetDeletionPolicy(GeneratedTemplateDeletionPolicy value) {
    m_deletionPolicyHasBeenSet = true;
    m_deletionPolicy = value;
  }
  inline TemplateConfiguration& WithDeletionPolicy(GeneratedTemplateDeletionPolicy value) {
  ...
  inline void SetUpdateReplacePolicy(GeneratedTemplateUpdateReplacePolicy value) {
    m_updateReplacePolicyHasBeenSet = true;
    m_updateReplacePolicy = value;
  }
  inline TemplateConfiguration& WithUpdateReplacePolicy(GeneratedTemplateUpdateReplacePolicy value) {
