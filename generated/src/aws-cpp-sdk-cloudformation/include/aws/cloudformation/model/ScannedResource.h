...
class ScannedResource {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  ScannedResource& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceIdentifierT = Aws::Map<Aws::String, Aws::String>>
  ScannedResource& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  ScannedResource& AddResourceIdentifier(ResourceIdentifierKeyT&& key, ResourceIdentifierValueT&& value) {
    m_resourceIdentifierHasBeenSet = true;
    m_resourceIdentifier.emplace(std::forward<ResourceIdentifierKeyT>(key), std::forward<ResourceIdentifierValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManagedByStack(bool value) {
    m_managedByStackHasBeenSet = true;
    m_managedByStack = value;
  }
  inline ScannedResource& WithManagedByStack(bool value) {
    SetManagedByStack(value);
    return *this;
  }
  ///@}
 private:
