...
class CreateStackRefactorRequest : public CloudFormationRequest {
 ...
 public:
  ...
  inline void SetEnableStackCreation(bool value) {
    m_enableStackCreationHasBeenSet = true;
    m_enableStackCreation = value;
  }
  inline CreateStackRefactorRequest& WithEnableStackCreation(bool value) {
    SetEnableStackCreation(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceMappings(ResourceMappingsT&& value) {
    m_resourceMappingsHasBeenSet = true;
    m_resourceMappings = std::forward<ResourceMappingsT>(value);
  }
  template <typename ResourceMappingsT = Aws::Vector<ResourceMapping>>
  CreateStackRefactorRequest& WithResourceMappings(ResourceMappingsT&& value) {
    SetResourceMappings(std::forward<ResourceMappingsT>(value));
    return *this;
  }
  ...
  CreateStackRefactorRequest& AddResourceMappings(ResourceMappingsT&& value) {
    m_resourceMappingsHasBeenSet = true;
    m_resourceMappings.emplace_back(std::forward<ResourceMappingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStackDefinitions(StackDefinitionsT&& value) {
    m_stackDefinitionsHasBeenSet = true;
    m_stackDefinitions = std::forward<StackDefinitionsT>(value);
  }
  template <typename StackDefinitionsT = Aws::Vector<StackDefinition>>
  CreateStackRefactorRequest& WithStackDefinitions(StackDefinitionsT&& value) {
    SetStackDefinitions(std::forward<StackDefinitionsT>(value));
    return *this;
  }
  ...
  CreateStackRefactorRequest& AddStackDefinitions(StackDefinitionsT&& value) {
    m_stackDefinitionsHasBeenSet = true;
    m_stackDefinitions.emplace_back(std::forward<StackDefinitionsT>(value));
    return *this;
  }
  ///@}
 private:
