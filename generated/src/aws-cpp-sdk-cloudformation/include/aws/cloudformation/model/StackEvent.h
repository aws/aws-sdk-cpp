...
/**
 * <p>The <code>StackEvent</code> data type.</p><p><h3>See Also:</h3>   <a
...
class StackEvent {
 public:
  ...
  inline StackEvent& WithResourceStatus(ResourceStatus value) {
  ...
  inline StackEvent& WithHookStatus(HookStatus value) {
    SetHookStatus(value);
    return *this;
  }
  ///@}
  ...
  inline StackEvent& WithHookInvocationPoint(HookInvocationPoint value) {
  ...
  void SetHookInvocationId(HookInvocationIdT&& value) {
    m_hookInvocationIdHasBeenSet = true;
    m_hookInvocationId = std::forward<HookInvocationIdT>(value);
  }
  template <typename HookInvocationIdT = Aws::String>
  StackEvent& WithHookInvocationId(HookInvocationIdT&& value) {
    SetHookInvocationId(std::forward<HookInvocationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline StackEvent& WithHookFailureMode(HookFailureMode value) {
  ...
  inline StackEvent& WithDetailedStatus(DetailedStatus value) {
