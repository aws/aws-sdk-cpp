...
class DescribeStackRefactorRequest : public CloudFormationRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeStackRefactor"; }
 ...
 public:
  ...
  template <typename StackRefactorIdT = Aws::String>
  DescribeStackRefactorRequest& WithStackRefactorId(StackRefactorIdT&& value) {
