...
struct ListResourceScanRelatedResourcesPaginationTraits {
  using RequestType = Model::ListResourceScanRelatedResourcesRequest;
  using ResultType = Model::ListResourceScanRelatedResourcesResult;
  using OutcomeType = Model::ListResourceScanRelatedResourcesOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListResourceScanRelatedResources(request); }
