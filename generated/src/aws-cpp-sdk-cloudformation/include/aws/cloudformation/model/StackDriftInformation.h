...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API StackDriftInformation() = default;
    ...
    inline StackDriftInformation& WithStackDriftStatus(StackDriftStatus value) { SetStackDriftStatus(value); return *this;}
    ///@}
    ...
    template<typename LastCheckTimestampT = Aws::Utils::DateTime>
    StackDriftInformation& WithLastCheckTimestamp(LastCheckTimestampT&& value) { SetLastCheckTimestamp(std::forward<LastCheckTimestampT>(value)); return *this;}
    ///@}
  private:
