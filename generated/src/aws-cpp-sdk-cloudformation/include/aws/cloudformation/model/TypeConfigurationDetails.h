...
class TypeConfigurationDetails {
 public:
  ...
  template <typename ArnT = Aws::String>
  TypeConfigurationDetails& WithArn(ArnT&& value) {
  ...
  template <typename AliasT = Aws::String>
  TypeConfigurationDetails& WithAlias(AliasT&& value) {
  ...
  template <typename ConfigurationT = Aws::String>
  TypeConfigurationDetails& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  TypeConfigurationDetails& WithLastUpdated(LastUpdatedT&& value) {
  ...
  template <typename TypeArnT = Aws::String>
  TypeConfigurationDetails& WithTypeArn(TypeArnT&& value) {
  ...
  template <typename TypeNameT = Aws::String>
  TypeConfigurationDetails& WithTypeName(TypeNameT&& value) {
  ...
  inline void SetIsDefaultConfiguration(bool value) {
    m_isDefaultConfigurationHasBeenSet = true;
    m_isDefaultConfiguration = value;
  }
  inline TypeConfigurationDetails& WithIsDefaultConfiguration(bool value) {
    SetIsDefaultConfiguration(value);
    return *this;
  }
  ///@}
 private:
