...
class BatchDescribeTypeConfigurationsRequest : public CloudFormationRequest {
 ...
 public:
  ...
  void SetTypeConfigurationIdentifiers(TypeConfigurationIdentifiersT&& value) {
    m_typeConfigurationIdentifiersHasBeenSet = true;
    m_typeConfigurationIdentifiers = std::forward<TypeConfigurationIdentifiersT>(value);
  }
  template <typename TypeConfigurationIdentifiersT = Aws::Vector<TypeConfigurationIdentifier>>
  BatchDescribeTypeConfigurationsRequest& WithTypeConfigurationIdentifiers(TypeConfigurationIdentifiersT&& value) {
    SetTypeConfigurationIdentifiers(std::forward<TypeConfigurationIdentifiersT>(value));
    return *this;
  }
  template <typename TypeConfigurationIdentifiersT = TypeConfigurationIdentifier>
  BatchDescribeTypeConfigurationsRequest& AddTypeConfigurationIdentifiers(TypeConfigurationIdentifiersT&& value) {
    m_typeConfigurationIdentifiersHasBeenSet = true;
    m_typeConfigurationIdentifiers.emplace_back(std::forward<TypeConfigurationIdentifiersT>(value));
    return *this;
  }
  ///@}
 private:
