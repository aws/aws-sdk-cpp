...
class DescribeTypeResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeTypeResult& WithArn(ArnT&& value) {
  ...
  inline DescribeTypeResult& WithType(RegistryType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TypeNameT = Aws::String>
  DescribeTypeResult& WithTypeName(TypeNameT&& value) {
  ...
  template <typename DefaultVersionIdT = Aws::String>
  DescribeTypeResult& WithDefaultVersionId(DefaultVersionIdT&& value) {
  ...
  inline DescribeTypeResult& WithIsDefaultVersion(bool value) {
  ...
  inline void SetTypeTestsStatus(TypeTestsStatus value) {
    m_typeTestsStatusHasBeenSet = true;
    m_typeTestsStatus = value;
  }
  inline DescribeTypeResult& WithTypeTestsStatus(TypeTestsStatus value) {
    SetTypeTestsStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTypeTestsStatusDescription(TypeTestsStatusDescriptionT&& value) {
    m_typeTestsStatusDescriptionHasBeenSet = true;
    m_typeTestsStatusDescription = std::forward<TypeTestsStatusDescriptionT>(value);
  }
  template <typename TypeTestsStatusDescriptionT = Aws::String>
  DescribeTypeResult& WithTypeTestsStatusDescription(TypeTestsStatusDescriptionT&& value) {
    SetTypeTestsStatusDescription(std::forward<TypeTestsStatusDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  DescribeTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename SchemaT = Aws::String>
  DescribeTypeResult& WithSchema(SchemaT&& value) {
  ...
  inline void SetProvisioningType(ProvisioningType value) {
    m_provisioningTypeHasBeenSet = true;
    m_provisioningType = value;
  }
  inline DescribeTypeResult& WithProvisioningType(ProvisioningType value) {
    SetProvisioningType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeprecatedStatus(DeprecatedStatus value) {
    m_deprecatedStatusHasBeenSet = true;
    m_deprecatedStatus = value;
  }
  inline DescribeTypeResult& WithDeprecatedStatus(DeprecatedStatus value) {
    SetDeprecatedStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LoggingConfigT = LoggingConfig>
  DescribeTypeResult& WithLoggingConfig(LoggingConfigT&& value) {
  ...
  void SetRequiredActivatedTypes(RequiredActivatedTypesT&& value) {
    m_requiredActivatedTypesHasBeenSet = true;
    m_requiredActivatedTypes = std::forward<RequiredActivatedTypesT>(value);
  }
  template <typename RequiredActivatedTypesT = Aws::Vector<RequiredActivatedType>>
  DescribeTypeResult& WithRequiredActivatedTypes(RequiredActivatedTypesT&& value) {
    SetRequiredActivatedTypes(std::forward<RequiredActivatedTypesT>(value));
    return *this;
  }
  template <typename RequiredActivatedTypesT = RequiredActivatedType>
  DescribeTypeResult& AddRequiredActivatedTypes(RequiredActivatedTypesT&& value) {
    m_requiredActivatedTypesHasBeenSet = true;
    m_requiredActivatedTypes.emplace_back(std::forward<RequiredActivatedTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  DescribeTypeResult& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
  ...
  inline DescribeTypeResult& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceUrlT = Aws::String>
  DescribeTypeResult& WithSourceUrl(SourceUrlT&& value) {
  ...
  template <typename DocumentationUrlT = Aws::String>
  DescribeTypeResult& WithDocumentationUrl(DocumentationUrlT&& value) {
  ...
  template <typename LastUpdatedT = Aws::Utils::DateTime>
  DescribeTypeResult& WithLastUpdated(LastUpdatedT&& value) {
  ...
  template <typename TimeCreatedT = Aws::Utils::DateTime>
  DescribeTypeResult& WithTimeCreated(TimeCreatedT&& value) {
  ...
  void SetConfigurationSchema(ConfigurationSchemaT&& value) {
    m_configurationSchemaHasBeenSet = true;
    m_configurationSchema = std::forward<ConfigurationSchemaT>(value);
  }
  template <typename ConfigurationSchemaT = Aws::String>
  DescribeTypeResult& WithConfigurationSchema(ConfigurationSchemaT&& value) {
    SetConfigurationSchema(std::forward<ConfigurationSchemaT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PublisherIdT = Aws::String>
  DescribeTypeResult& WithPublisherId(PublisherIdT&& value) {
  ...
  template <typename OriginalTypeNameT = Aws::String>
  DescribeTypeResult& WithOriginalTypeName(OriginalTypeNameT&& value) {
  ...
  void SetOriginalTypeArn(OriginalTypeArnT&& value) {
    m_originalTypeArnHasBeenSet = true;
    m_originalTypeArn = std::forward<OriginalTypeArnT>(value);
  }
  template <typename OriginalTypeArnT = Aws::String>
  DescribeTypeResult& WithOriginalTypeArn(OriginalTypeArnT&& value) {
    SetOriginalTypeArn(std::forward<OriginalTypeArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PublicVersionNumberT = Aws::String>
  DescribeTypeResult& WithPublicVersionNumber(PublicVersionNumberT&& value) {
  ...
  void SetLatestPublicVersion(LatestPublicVersionT&& value) {
    m_latestPublicVersionHasBeenSet = true;
    m_latestPublicVersion = std::forward<LatestPublicVersionT>(value);
  }
  template <typename LatestPublicVersionT = Aws::String>
  DescribeTypeResult& WithLatestPublicVersion(LatestPublicVersionT&& value) {
    SetLatestPublicVersion(std::forward<LatestPublicVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsActivated(bool value) {
    m_isActivatedHasBeenSet = true;
    m_isActivated = value;
  }
  inline DescribeTypeResult& WithIsActivated(bool value) {
  ...
  inline DescribeTypeResult& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTypeResult& WithResponseMetadata(ResponseMetadataT&& value) {
