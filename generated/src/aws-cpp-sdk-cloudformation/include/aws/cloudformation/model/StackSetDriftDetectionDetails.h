 ...
 * included.</p> <p>For StackSet operations, includes information about drift
 * operations currently being performed on the StackSet.</p> <p>For more
 * information, see <a
...
class StackSetDriftDetectionDetails {
 public:
   ...
   * checked the StackSet for drift.</p> </li> <li> <p> <code>IN_SYNC</code>: All of
   * the stack instances belonging to the StackSet stack match the expected template
   * and parameter configuration.</p> </li> </ul>
   */
  ...
  inline void SetDriftStatus(StackSetDriftStatus value) {
    m_driftStatusHasBeenSet = true;
    m_driftStatus = value;
  }
  inline StackSetDriftDetectionDetails& WithDriftStatus(StackSetDriftStatus value) {
  ...
  ///@{
  /**
   * <p>The status of the StackSet drift detection operation.</p> <ul> <li> <p>
  ...
  inline void SetDriftDetectionStatus(StackSetDriftDetectionStatus value) {
    m_driftDetectionStatusHasBeenSet = true;
    m_driftDetectionStatus = value;
  }
  inline StackSetDriftDetectionDetails& WithDriftDetectionStatus(StackSetDriftDetectionStatus value) {
    SetDriftDetectionStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The total number of stack instances belonging to this StackSet.</p> <p>The
   * total number of stack instances is equal to the total of:</p> <ul> <li> <p>Stack
   * instances that match the StackSet configuration.</p> </li> <li> <p>Stack
   * instances that have drifted from the StackSet configuration.</p> </li> <li>
  ...
  inline void SetTotalStackInstancesCount(int value) {
    m_totalStackInstancesCountHasBeenSet = true;
    m_totalStackInstancesCount = value;
  }
  inline StackSetDriftDetectionDetails& WithTotalStackInstancesCount(int value) {
    SetTotalStackInstancesCount(value);
    return *this;
  }
  ///@}
   ...
   * and parameter configuration of the StackSet. A stack instance is considered to
  ...
  inline void SetDriftedStackInstancesCount(int value) {
    m_driftedStackInstancesCountHasBeenSet = true;
    m_driftedStackInstancesCount = value;
  }
  inline StackSetDriftDetectionDetails& WithDriftedStackInstancesCount(int value) {
    SetDriftedStackInstancesCount(value);
    return *this;
  }
  ///@}
   ...
   * configuration of the StackSet.</p>
   */
  ...
  inline void SetInSyncStackInstancesCount(int value) {
    m_inSyncStackInstancesCountHasBeenSet = true;
    m_inSyncStackInstancesCount = value;
  }
  inline StackSetDriftDetectionDetails& WithInSyncStackInstancesCount(int value) {
    SetInSyncStackInstancesCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInProgressStackInstancesCount(int value) {
    m_inProgressStackInstancesCountHasBeenSet = true;
    m_inProgressStackInstancesCount = value;
  }
  inline StackSetDriftDetectionDetails& WithInProgressStackInstancesCount(int value) {
    SetInProgressStackInstancesCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedStackInstancesCount(int value) {
    m_failedStackInstancesCountHasBeenSet = true;
    m_failedStackInstancesCount = value;
  }
  inline StackSetDriftDetectionDetails& WithFailedStackInstancesCount(int value) {
    SetFailedStackInstancesCount(value);
    return *this;
  }
  ///@}
 private:
