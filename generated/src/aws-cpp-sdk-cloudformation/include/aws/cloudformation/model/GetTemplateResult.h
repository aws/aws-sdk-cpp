...
class GetTemplateResult {
 public:
  ...
  template <typename TemplateBodyT = Aws::String>
  GetTemplateResult& WithTemplateBody(TemplateBodyT&& value) {
  ...
  void SetStagesAvailable(StagesAvailableT&& value) {
    m_stagesAvailableHasBeenSet = true;
    m_stagesAvailable = std::forward<StagesAvailableT>(value);
  }
  template <typename StagesAvailableT = Aws::Vector<TemplateStage>>
  GetTemplateResult& WithStagesAvailable(StagesAvailableT&& value) {
    SetStagesAvailable(std::forward<StagesAvailableT>(value));
    return *this;
  }
  inline GetTemplateResult& AddStagesAvailable(TemplateStage value) {
    m_stagesAvailableHasBeenSet = true;
    m_stagesAvailable.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetTemplateResult& WithResponseMetadata(ResponseMetadataT&& value) {
