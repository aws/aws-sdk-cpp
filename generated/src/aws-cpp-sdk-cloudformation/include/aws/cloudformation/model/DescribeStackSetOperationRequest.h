...
class DescribeStackSetOperationRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename StackSetNameT = Aws::String>
  DescribeStackSetOperationRequest& WithStackSetName(StackSetNameT&& value) {
  ...
  template <typename OperationIdT = Aws::String>
  DescribeStackSetOperationRequest& WithOperationId(OperationIdT&& value) {
  ...
  inline DescribeStackSetOperationRequest& WithCallAs(CallAs value) {
    SetCallAs(value);
    return *this;
  }
  ///@}
