...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDFORMATION_API DescribeStackSetOperationRequest() = default;
  ...
  public:
    ...
    template<typename StackSetNameT = Aws::String>
    DescribeStackSetOperationRequest& WithStackSetName(StackSetNameT&& value) { SetStackSetName(std::forward<StackSetNameT>(value)); return *this;}
    ///@}
    ...
    template<typename OperationIdT = Aws::String>
    DescribeStackSetOperationRequest& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    inline DescribeStackSetOperationRequest& WithCallAs(CallAs value) { SetCallAs(value); return *this;}
    ///@}
  private:
