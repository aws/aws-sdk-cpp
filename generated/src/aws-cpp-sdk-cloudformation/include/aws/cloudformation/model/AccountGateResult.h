...
class AccountGateResult {
 public:
  ...
  inline void SetStatus(AccountGateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AccountGateResult& WithStatus(AccountGateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  AccountGateResult& WithStatusReason(StatusReasonT&& value) {
