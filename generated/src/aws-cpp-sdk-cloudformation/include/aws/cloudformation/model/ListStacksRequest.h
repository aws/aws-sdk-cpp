...
class ListStacksRequest : public CloudFormationRequest {
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStacksRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetStackStatusFilter(StackStatusFilterT&& value) {
    m_stackStatusFilterHasBeenSet = true;
    m_stackStatusFilter = std::forward<StackStatusFilterT>(value);
  }
  template <typename StackStatusFilterT = Aws::Vector<StackStatus>>
  ListStacksRequest& WithStackStatusFilter(StackStatusFilterT&& value) {
    SetStackStatusFilter(std::forward<StackStatusFilterT>(value));
    return *this;
  }
  inline ListStacksRequest& AddStackStatusFilter(StackStatus value) {
    m_stackStatusFilterHasBeenSet = true;
    m_stackStatusFilter.push_back(value);
    return *this;
  }
  ///@}
 private:
