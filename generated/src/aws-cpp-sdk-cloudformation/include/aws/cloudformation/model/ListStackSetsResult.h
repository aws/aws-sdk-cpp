...
class ListStackSetsResult {
 public:
  ...
  template <typename SummariesT = Aws::Vector<StackSetSummary>>
  ListStackSetsResult& WithSummaries(SummariesT&& value) {
    SetSummaries(std::forward<SummariesT>(value));
    return *this;
  }
  template <typename SummariesT = StackSetSummary>
  ListStackSetsResult& AddSummaries(SummariesT&& value) {
    m_summariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListStackSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListStackSetsResult& WithResponseMetadata(ResponseMetadataT&& value) {
