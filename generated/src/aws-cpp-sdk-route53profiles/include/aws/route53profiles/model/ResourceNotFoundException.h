...
namespace Model
{
  ...
  /**
   * <p> The resource you are associating is not found. </p><p><h3>See Also:</h3>  
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/route53profiles-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_ROUTE53PROFILES_API ResourceNotFoundException() = default;
