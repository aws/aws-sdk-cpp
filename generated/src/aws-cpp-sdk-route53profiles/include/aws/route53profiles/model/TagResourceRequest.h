...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public Route53ProfilesRequest
  {
  public:
    AWS_ROUTE53PROFILES_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p> The Amazon Resource Name (ARN) for the resource that you want to add tags
     * to. </p>
     */
