...
class AssociateProfileResult {
 public:
  ...
  void SetProfileAssociation(ProfileAssociationT&& value) {
    m_profileAssociationHasBeenSet = true;
    m_profileAssociation = std::forward<ProfileAssociationT>(value);
  }
  template <typename ProfileAssociationT = ProfileAssociation>
  AssociateProfileResult& WithProfileAssociation(ProfileAssociationT&& value) {
    SetProfileAssociation(std::forward<ProfileAssociationT>(value));
    return *this;
  }
  ///@}
