...
class GetProfileResourceAssociationResult {
 public:
  ...
  AWS_ROUTE53PROFILES_API GetProfileResourceAssociationResult& operator=(
  ...
  template <typename ProfileResourceAssociationT = ProfileResourceAssociation>
  GetProfileResourceAssociationResult& WithProfileResourceAssociation(ProfileResourceAssociationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetProfileResourceAssociationResult& WithRequestId(RequestIdT&& value) {
