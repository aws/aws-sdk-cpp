...
namespace Model
{
  ...
  public:
    ...
    template<typename ProfileResourceAssociationT = ProfileResourceAssociation>
    AssociateResourceToProfileResult& WithProfileResourceAssociation(ProfileResourceAssociationT&& value) { SetProfileResourceAssociation(std::forward<ProfileResourceAssociationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateResourceToProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
