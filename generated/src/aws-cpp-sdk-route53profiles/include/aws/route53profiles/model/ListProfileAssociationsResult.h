...
class ListProfileAssociationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetProfileAssociations(ProfileAssociationsT&& value) {
    m_profileAssociationsHasBeenSet = true;
    m_profileAssociations = std::forward<ProfileAssociationsT>(value);
  }
  template <typename ProfileAssociationsT = Aws::Vector<ProfileAssociation>>
  ListProfileAssociationsResult& WithProfileAssociations(ProfileAssociationsT&& value) {
    SetProfileAssociations(std::forward<ProfileAssociationsT>(value));
    return *this;
  }
  template <typename ProfileAssociationsT = ProfileAssociation>
  ListProfileAssociationsResult& AddProfileAssociations(ProfileAssociationsT&& value) {
    m_profileAssociationsHasBeenSet = true;
    m_profileAssociations.emplace_back(std::forward<ProfileAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileAssociationsResult& WithRequestId(RequestIdT&& value) {
