...
class ListProfileResourceAssociationsRequest : public Route53ProfilesRequest {
 public:
  ...
  inline ListProfileResourceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileResourceAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  ListProfileResourceAssociationsRequest& WithProfileId(ProfileIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ListProfileResourceAssociationsRequest& WithResourceType(ResourceTypeT&& value) {
