...
class ListProfileResourceAssociationsResult {
 public:
  ...
  AWS_ROUTE53PROFILES_API ListProfileResourceAssociationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileResourceAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetProfileResourceAssociations(ProfileResourceAssociationsT&& value) {
    m_profileResourceAssociationsHasBeenSet = true;
    m_profileResourceAssociations = std::forward<ProfileResourceAssociationsT>(value);
  }
  template <typename ProfileResourceAssociationsT = Aws::Vector<ProfileResourceAssociation>>
  ListProfileResourceAssociationsResult& WithProfileResourceAssociations(ProfileResourceAssociationsT&& value) {
    SetProfileResourceAssociations(std::forward<ProfileResourceAssociationsT>(value));
    return *this;
  }
  template <typename ProfileResourceAssociationsT = ProfileResourceAssociation>
  ListProfileResourceAssociationsResult& AddProfileResourceAssociations(ProfileResourceAssociationsT&& value) {
    m_profileResourceAssociationsHasBeenSet = true;
    m_profileResourceAssociations.emplace_back(std::forward<ProfileResourceAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileResourceAssociationsResult& WithRequestId(RequestIdT&& value) {
