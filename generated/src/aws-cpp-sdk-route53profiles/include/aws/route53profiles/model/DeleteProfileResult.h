...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53PROFILES_API DeleteProfileResult() = default;
    ...
    template<typename ProfileT = Profile>
    DeleteProfileResult& WithProfile(ProfileT&& value) { SetProfile(std::forward<ProfileT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
