...
namespace Route53Profiles
{
   ...
   */
  class AWS_ROUTE53PROFILES_API Route53ProfilesClient : Aws::Client::ClientWithAsyncTemplateMethods<Route53ProfilesClient>,
    smithy::client::AwsSmithyClientT<Aws::Route53Profiles::SERVICE_NAME,
