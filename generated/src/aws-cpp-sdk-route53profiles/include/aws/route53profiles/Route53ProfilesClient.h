...
class AWS_ROUTE53PROFILES_API Route53ProfilesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Route53ProfilesClient(const Aws::Route53Profiles::Route53ProfilesClientConfiguration& clientConfiguration =
  ...
  Route53ProfilesClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<Route53ProfilesEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::Route53Profiles::Route53ProfilesClientConfiguration& clientConfiguration =
                            Aws::Route53Profiles::Route53ProfilesClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateProfileRequestT = Model::AssociateProfileRequest>
  void AssociateProfileAsync(const AssociateProfileRequestT& request, const AssociateProfileResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateResourceToProfileOutcome AssociateResourceToProfile(
      const Model::AssociateResourceToProfileRequest& request) const;

  /**
   * A Callable wrapper for AssociateResourceToProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateResourceToProfileRequestT = Model::AssociateResourceToProfileRequest>
  Model::AssociateResourceToProfileOutcomeCallable AssociateResourceToProfileCallable(
      const AssociateResourceToProfileRequestT& request) const {
    return SubmitCallable(&Route53ProfilesClient::AssociateResourceToProfile, request);
  }

  /**
   * An Async wrapper for AssociateResourceToProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateResourceToProfileRequestT = Model::AssociateResourceToProfileRequest>
  void AssociateResourceToProfileAsync(const AssociateResourceToProfileRequestT& request,
                                       const AssociateResourceToProfileResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateProfileRequestT = Model::DisassociateProfileRequest>
  void DisassociateProfileAsync(const DisassociateProfileRequestT& request, const DisassociateProfileResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateResourceFromProfileOutcome DisassociateResourceFromProfile(
      const Model::DisassociateResourceFromProfileRequest& request) const;

  /**
   * A Callable wrapper for DisassociateResourceFromProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateResourceFromProfileRequestT = Model::DisassociateResourceFromProfileRequest>
  Model::DisassociateResourceFromProfileOutcomeCallable DisassociateResourceFromProfileCallable(
      const DisassociateResourceFromProfileRequestT& request) const {
    return SubmitCallable(&Route53ProfilesClient::DisassociateResourceFromProfile, request);
  }

  /**
   * An Async wrapper for DisassociateResourceFromProfile that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateResourceFromProfileRequestT = Model::DisassociateResourceFromProfileRequest>
  void DisassociateResourceFromProfileAsync(const DisassociateResourceFromProfileRequestT& request,
                                            const DisassociateResourceFromProfileResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetProfileRequestT = Model::GetProfileRequest>
  void GetProfileAsync(const GetProfileRequestT& request, const GetProfileResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProfileAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProfileAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProfileAssociationRequestT = Model::GetProfileAssociationRequest>
  void GetProfileAssociationAsync(const GetProfileAssociationRequestT& request, const GetProfileAssociationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetProfileResourceAssociationOutcome GetProfileResourceAssociation(
      const Model::GetProfileResourceAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetProfileResourceAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetProfileResourceAssociationRequestT = Model::GetProfileResourceAssociationRequest>
  Model::GetProfileResourceAssociationOutcomeCallable GetProfileResourceAssociationCallable(
      const GetProfileResourceAssociationRequestT& request) const {
    return SubmitCallable(&Route53ProfilesClient::GetProfileResourceAssociation, request);
  }

  /**
   * An Async wrapper for GetProfileResourceAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProfileResourceAssociationRequestT = Model::GetProfileResourceAssociationRequest>
  void GetProfileResourceAssociationAsync(const GetProfileResourceAssociationRequestT& request,
                                          const GetProfileResourceAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfileAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfileAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfileAssociationsRequestT = Model::ListProfileAssociationsRequest>
  void ListProfileAssociationsAsync(const ListProfileAssociationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListProfileAssociationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProfileResourceAssociationsOutcome ListProfileResourceAssociations(
      const Model::ListProfileResourceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListProfileResourceAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListProfileResourceAssociationsRequestT = Model::ListProfileResourceAssociationsRequest>
  Model::ListProfileResourceAssociationsOutcomeCallable ListProfileResourceAssociationsCallable(
      const ListProfileResourceAssociationsRequestT& request) const {
    return SubmitCallable(&Route53ProfilesClient::ListProfileResourceAssociations, request);
  }

  /**
   * An Async wrapper for ListProfileResourceAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListProfileResourceAssociationsRequestT = Model::ListProfileResourceAssociationsRequest>
  void ListProfileResourceAssociationsAsync(const ListProfileResourceAssociationsRequestT& request,
                                            const ListProfileResourceAssociationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateProfileResourceAssociationOutcome UpdateProfileResourceAssociation(
      const Model::UpdateProfileResourceAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateProfileResourceAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateProfileResourceAssociationRequestT = Model::UpdateProfileResourceAssociationRequest>
  Model::UpdateProfileResourceAssociationOutcomeCallable UpdateProfileResourceAssociationCallable(
      const UpdateProfileResourceAssociationRequestT& request) const {
    return SubmitCallable(&Route53ProfilesClient::UpdateProfileResourceAssociation, request);
  }

  /**
   * An Async wrapper for UpdateProfileResourceAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateProfileResourceAssociationRequestT = Model::UpdateProfileResourceAssociationRequest>
  void UpdateProfileResourceAssociationAsync(const UpdateProfileResourceAssociationRequestT& request,
                                             const UpdateProfileResourceAssociationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&Route53ProfilesClient::UpdateProfileResourceAssociation, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<Route53ProfilesEndpointProviderBase>& accessEndpointProvider();
