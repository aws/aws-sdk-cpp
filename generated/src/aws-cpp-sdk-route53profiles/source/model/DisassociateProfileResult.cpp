...
DisassociateProfileResult::DisassociateProfileResult()
{
}

DisassociateProfileResult::DisassociateProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
