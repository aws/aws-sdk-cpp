...
AssociateResourceToProfileResult::AssociateResourceToProfileResult()
{
}

AssociateResourceToProfileResult::AssociateResourceToProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
