...
GetProfileResourceAssociationResult::GetProfileResourceAssociationResult()
{
}

GetProfileResourceAssociationResult::GetProfileResourceAssociationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
