...
template <>
AWS_ROUTE53PROFILES_API ResourceExistsException Route53ProfilesError::GetModeledError() {
  assert(this->GetErrorType() == Route53ProfilesErrors::RESOURCE_EXISTS);
  return ResourceExistsException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53PROFILES_API ResourceNotFoundException Route53ProfilesError::GetModeledError() {
  assert(this->GetErrorType() == Route53ProfilesErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_ROUTE53PROFILES_API InvalidParameterException Route53ProfilesError::GetModeledError() {
...
template <>
AWS_ROUTE53PROFILES_API LimitExceededException Route53ProfilesError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == RESOURCE_EXISTS_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(Route53ProfilesErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
