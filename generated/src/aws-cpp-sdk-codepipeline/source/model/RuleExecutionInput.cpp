...
RuleExecutionInput::RuleExecutionInput(JsonView jsonValue) { *this = jsonValue; }

RuleExecutionInput& RuleExecutionInput::operator=(JsonView jsonValue) {
...
JsonValue RuleExecutionInput::Jsonize() const {
  JsonValue payload;
