...
GitTagFilterCriteria::GitTagFilterCriteria(JsonView jsonValue) { *this = jsonValue; }

GitTagFilterCriteria& GitTagFilterCriteria::operator=(JsonView jsonValue) {
...
JsonValue GitTagFilterCriteria::Jsonize() const {
  JsonValue payload;
