...
RuleExecutionFilter::RuleExecutionFilter(JsonView jsonValue) { *this = jsonValue; }

RuleExecutionFilter& RuleExecutionFilter::operator=(JsonView jsonValue) {
...
JsonValue RuleExecutionFilter::Jsonize() const {
  JsonValue payload;
