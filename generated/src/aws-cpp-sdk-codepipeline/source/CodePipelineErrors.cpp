...
static const int CONCURRENT_PIPELINE_EXECUTIONS_LIMIT_EXCEEDED_HASH =
    HashingUtils::HashString("ConcurrentPipelineExecutionsLimitExceededException");
...
static const int INVALID_WEBHOOK_AUTHENTICATION_PARAMETERS_HASH =
    HashingUtils::HashString("InvalidWebhookAuthenticationParametersException");
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodePipelineErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodePipelineErrors::CONCURRENT_PIPELINE_EXECUTIONS_LIMIT_EXCEEDED),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodePipelineErrors::PIPELINE_EXECUTION_NOT_STOPPABLE),
                                RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(CodePipelineErrors::INVALID_WEBHOOK_AUTHENTICATION_PARAMETERS),
                                RetryableType::NOT_RETRYABLE);
