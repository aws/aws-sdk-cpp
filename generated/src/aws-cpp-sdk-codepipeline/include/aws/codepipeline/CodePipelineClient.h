...
class AWS_CODEPIPELINE_API CodePipelineClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodePipelineClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CodePipelineEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CodePipeline::CodePipelineClientConfiguration& clientConfiguration = Aws::CodePipeline::CodePipelineClientConfiguration());
  ...
  /**
   * An Async wrapper for AcknowledgeJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AcknowledgeJobRequestT = Model::AcknowledgeJobRequest>
  void AcknowledgeJobAsync(const AcknowledgeJobRequestT& request, const AcknowledgeJobResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AcknowledgeThirdPartyJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcknowledgeThirdPartyJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcknowledgeThirdPartyJobRequestT = Model::AcknowledgeThirdPartyJobRequest>
  void AcknowledgeThirdPartyJobAsync(const AcknowledgeThirdPartyJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCustomActionType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomActionType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomActionTypeRequestT = Model::CreateCustomActionTypeRequest>
  void CreateCustomActionTypeAsync(const CreateCustomActionTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCustomActionType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomActionType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomActionTypeRequestT = Model::DeleteCustomActionTypeRequest>
  void DeleteCustomActionTypeAsync(const DeleteCustomActionTypeRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterWebhookWithThirdPartyOutcome DeregisterWebhookWithThirdParty(
      const Model::DeregisterWebhookWithThirdPartyRequest& request = {}) const;

  /**
   * A Callable wrapper for DeregisterWebhookWithThirdParty that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterWebhookWithThirdPartyRequestT = Model::DeregisterWebhookWithThirdPartyRequest>
  Model::DeregisterWebhookWithThirdPartyOutcomeCallable DeregisterWebhookWithThirdPartyCallable(
      const DeregisterWebhookWithThirdPartyRequestT& request = {}) const {
    return SubmitCallable(&CodePipelineClient::DeregisterWebhookWithThirdParty, request);
  }

  /**
   * An Async wrapper for DeregisterWebhookWithThirdParty that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeregisterWebhookWithThirdPartyRequestT = Model::DeregisterWebhookWithThirdPartyRequest>
  void DeregisterWebhookWithThirdPartyAsync(const DeregisterWebhookWithThirdPartyResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DisableStageTransition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableStageTransition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableStageTransitionRequestT = Model::DisableStageTransitionRequest>
  void DisableStageTransitionAsync(const DisableStageTransitionRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableStageTransition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableStageTransition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableStageTransitionRequestT = Model::EnableStageTransitionRequest>
  void EnableStageTransitionAsync(const EnableStageTransitionRequestT& request, const EnableStageTransitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetActionType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetActionTypeRequestT = Model::GetActionTypeRequest>
  void GetActionTypeAsync(const GetActionTypeRequestT& request, const GetActionTypeResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobDetails that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobDetailsRequestT = Model::GetJobDetailsRequest>
  void GetJobDetailsAsync(const GetJobDetailsRequestT& request, const GetJobDetailsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPipeline that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPipelineRequestT = Model::GetPipelineRequest>
  void GetPipelineAsync(const GetPipelineRequestT& request, const GetPipelineResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPipelineExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPipelineExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPipelineExecutionRequestT = Model::GetPipelineExecutionRequest>
  void GetPipelineExecutionAsync(const GetPipelineExecutionRequestT& request, const GetPipelineExecutionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPipelineState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPipelineState that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPipelineStateRequestT = Model::GetPipelineStateRequest>
  void GetPipelineStateAsync(const GetPipelineStateRequestT& request, const GetPipelineStateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetThirdPartyJobDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetThirdPartyJobDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetThirdPartyJobDetailsRequestT = Model::GetThirdPartyJobDetailsRequest>
  void GetThirdPartyJobDetailsAsync(const GetThirdPartyJobDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListActionExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListActionExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListActionExecutionsRequestT = Model::ListActionExecutionsRequest>
  void ListActionExecutionsAsync(const ListActionExecutionsRequestT& request, const ListActionExecutionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListActionTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListActionTypesRequestT = Model::ListActionTypesRequest>
  void ListActionTypesAsync(const ListActionTypesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListActionTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDeployActionExecutionTargetsOutcome ListDeployActionExecutionTargets(
      const Model::ListDeployActionExecutionTargetsRequest& request) const;

  /**
   * A Callable wrapper for ListDeployActionExecutionTargets that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListDeployActionExecutionTargetsRequestT = Model::ListDeployActionExecutionTargetsRequest>
  Model::ListDeployActionExecutionTargetsOutcomeCallable ListDeployActionExecutionTargetsCallable(
      const ListDeployActionExecutionTargetsRequestT& request) const {
    return SubmitCallable(&CodePipelineClient::ListDeployActionExecutionTargets, request);
  }

  /**
   * An Async wrapper for ListDeployActionExecutionTargets that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDeployActionExecutionTargetsRequestT = Model::ListDeployActionExecutionTargetsRequest>
  void ListDeployActionExecutionTargetsAsync(const ListDeployActionExecutionTargetsRequestT& request,
                                             const ListDeployActionExecutionTargetsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRuleExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRuleExecutions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRuleExecutionsRequestT = Model::ListRuleExecutionsRequest>
  void ListRuleExecutionsAsync(const ListRuleExecutionsRequestT& request, const ListRuleExecutionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListRuleTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRuleTypesRequestT = Model::ListRuleTypesRequest>
  void ListRuleTypesAsync(const ListRuleTypesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListRuleTypesRequestT& request = {}) const {
   ...
   */
  template <typename ListWebhooksRequestT = Model::ListWebhooksRequest>
  void ListWebhooksAsync(const ListWebhooksResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListWebhooksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for OverrideStageCondition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for OverrideStageCondition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename OverrideStageConditionRequestT = Model::OverrideStageConditionRequest>
  void OverrideStageConditionAsync(const OverrideStageConditionRequestT& request,
                                   const OverrideStageConditionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PollForJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PollForJobsRequestT = Model::PollForJobsRequest>
  void PollForJobsAsync(const PollForJobsRequestT& request, const PollForJobsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PollForThirdPartyJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PollForThirdPartyJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PollForThirdPartyJobsRequestT = Model::PollForThirdPartyJobsRequest>
  void PollForThirdPartyJobsAsync(const PollForThirdPartyJobsRequestT& request, const PollForThirdPartyJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutActionRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutActionRevision that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutActionRevisionRequestT = Model::PutActionRevisionRequest>
  void PutActionRevisionAsync(const PutActionRevisionRequestT& request, const PutActionRevisionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutApprovalResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutApprovalResult that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutApprovalResultRequestT = Model::PutApprovalResultRequest>
  void PutApprovalResultAsync(const PutApprovalResultRequestT& request, const PutApprovalResultResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutJobFailureResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutJobFailureResult that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutJobFailureResultRequestT = Model::PutJobFailureResultRequest>
  void PutJobFailureResultAsync(const PutJobFailureResultRequestT& request, const PutJobFailureResultResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutJobSuccessResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutJobSuccessResult that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutJobSuccessResultRequestT = Model::PutJobSuccessResultRequest>
  void PutJobSuccessResultAsync(const PutJobSuccessResultRequestT& request, const PutJobSuccessResultResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutThirdPartyJobFailureResultOutcome PutThirdPartyJobFailureResult(
      const Model::PutThirdPartyJobFailureResultRequest& request) const;

  /**
   * A Callable wrapper for PutThirdPartyJobFailureResult that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutThirdPartyJobFailureResultRequestT = Model::PutThirdPartyJobFailureResultRequest>
  Model::PutThirdPartyJobFailureResultOutcomeCallable PutThirdPartyJobFailureResultCallable(
      const PutThirdPartyJobFailureResultRequestT& request) const {
    return SubmitCallable(&CodePipelineClient::PutThirdPartyJobFailureResult, request);
  }

  /**
   * An Async wrapper for PutThirdPartyJobFailureResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutThirdPartyJobFailureResultRequestT = Model::PutThirdPartyJobFailureResultRequest>
  void PutThirdPartyJobFailureResultAsync(const PutThirdPartyJobFailureResultRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutThirdPartyJobSuccessResultOutcome PutThirdPartyJobSuccessResult(
      const Model::PutThirdPartyJobSuccessResultRequest& request) const;

  /**
   * A Callable wrapper for PutThirdPartyJobSuccessResult that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutThirdPartyJobSuccessResultRequestT = Model::PutThirdPartyJobSuccessResultRequest>
  Model::PutThirdPartyJobSuccessResultOutcomeCallable PutThirdPartyJobSuccessResultCallable(
      const PutThirdPartyJobSuccessResultRequestT& request) const {
    return SubmitCallable(&CodePipelineClient::PutThirdPartyJobSuccessResult, request);
  }

  /**
   * An Async wrapper for PutThirdPartyJobSuccessResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutThirdPartyJobSuccessResultRequestT = Model::PutThirdPartyJobSuccessResultRequest>
  void PutThirdPartyJobSuccessResultAsync(const PutThirdPartyJobSuccessResultRequestT& request,
  ...
  /**
   * An Async wrapper for PutWebhook that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutWebhookRequestT = Model::PutWebhookRequest>
  void PutWebhookAsync(const PutWebhookRequestT& request, const PutWebhookResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterWebhookWithThirdPartyOutcome RegisterWebhookWithThirdParty(
      const Model::RegisterWebhookWithThirdPartyRequest& request = {}) const;

  /**
   * A Callable wrapper for RegisterWebhookWithThirdParty that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterWebhookWithThirdPartyRequestT = Model::RegisterWebhookWithThirdPartyRequest>
  Model::RegisterWebhookWithThirdPartyOutcomeCallable RegisterWebhookWithThirdPartyCallable(
      const RegisterWebhookWithThirdPartyRequestT& request = {}) const {
    return SubmitCallable(&CodePipelineClient::RegisterWebhookWithThirdParty, request);
  }

  /**
   * An Async wrapper for RegisterWebhookWithThirdParty that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterWebhookWithThirdPartyRequestT = Model::RegisterWebhookWithThirdPartyRequest>
  void RegisterWebhookWithThirdPartyAsync(const RegisterWebhookWithThirdPartyResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const RegisterWebhookWithThirdPartyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RetryStageExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RetryStageExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RetryStageExecutionRequestT = Model::RetryStageExecutionRequest>
  void RetryStageExecutionAsync(const RetryStageExecutionRequestT& request, const RetryStageExecutionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RollbackStage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RollbackStageRequestT = Model::RollbackStageRequest>
  void RollbackStageAsync(const RollbackStageRequestT& request, const RollbackStageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateActionType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateActionType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateActionTypeRequestT = Model::UpdateActionTypeRequest>
  void UpdateActionTypeAsync(const UpdateActionTypeRequestT& request, const UpdateActionTypeResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
