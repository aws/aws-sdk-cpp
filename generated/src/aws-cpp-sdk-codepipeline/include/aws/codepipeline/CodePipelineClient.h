...
namespace CodePipeline
{
   ...
   * success.</p> </li> </ul>
   */
  class AWS_CODEPIPELINE_API CodePipelineClient : Aws::Client::ClientWithAsyncTemplateMethods<CodePipelineClient>,
    smithy::client::AwsSmithyClientT<Aws::CodePipeline::SERVICE_NAME,
