...
class ListRuleTypesRequest : public CodePipelineRequest {
 public:
  ...
  inline void SetRuleOwnerFilter(RuleOwner value) {
    m_ruleOwnerFilterHasBeenSet = true;
    m_ruleOwnerFilter = value;
  }
  inline ListRuleTypesRequest& WithRuleOwnerFilter(RuleOwner value) {
    SetRuleOwnerFilter(value);
    return *this;
  }
  ///@}
  ...
  template <typename RegionFilterT = Aws::String>
  ListRuleTypesRequest& WithRegionFilter(RegionFilterT&& value) {
