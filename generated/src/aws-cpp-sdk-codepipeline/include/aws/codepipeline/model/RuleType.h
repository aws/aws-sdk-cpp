...
class RuleType {
 public:
  ...
  template <typename SettingsT = RuleTypeSettings>
  RuleType& WithSettings(SettingsT&& value) {
  ...
  void SetRuleConfigurationProperties(RuleConfigurationPropertiesT&& value) {
    m_ruleConfigurationPropertiesHasBeenSet = true;
    m_ruleConfigurationProperties = std::forward<RuleConfigurationPropertiesT>(value);
  }
  template <typename RuleConfigurationPropertiesT = Aws::Vector<RuleConfigurationProperty>>
  RuleType& WithRuleConfigurationProperties(RuleConfigurationPropertiesT&& value) {
    SetRuleConfigurationProperties(std::forward<RuleConfigurationPropertiesT>(value));
    return *this;
  }
  template <typename RuleConfigurationPropertiesT = RuleConfigurationProperty>
  RuleType& AddRuleConfigurationProperties(RuleConfigurationPropertiesT&& value) {
    m_ruleConfigurationPropertiesHasBeenSet = true;
    m_ruleConfigurationProperties.emplace_back(std::forward<RuleConfigurationPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InputArtifactDetailsT = ArtifactDetails>
  RuleType& WithInputArtifactDetails(InputArtifactDetailsT&& value) {
