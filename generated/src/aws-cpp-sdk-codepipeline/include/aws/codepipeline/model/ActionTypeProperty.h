...
class ActionTypeProperty {
 public:
  ...
  template <typename NameT = Aws::String>
  ActionTypeProperty& WithName(NameT&& value) {
  ...
  inline ActionTypeProperty& WithOptional(bool value) {
    SetOptional(value);
    return *this;
  }
  ///@}
  ...
  inline ActionTypeProperty& WithKey(bool value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  inline ActionTypeProperty& WithNoEcho(bool value) {
    SetNoEcho(value);
    return *this;
  }
  ///@}
  ...
  inline ActionTypeProperty& WithQueryable(bool value) {
    SetQueryable(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  ActionTypeProperty& WithDescription(DescriptionT&& value) {
