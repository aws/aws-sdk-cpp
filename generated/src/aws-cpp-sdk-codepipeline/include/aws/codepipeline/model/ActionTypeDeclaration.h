...
class ActionTypeDeclaration {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  ActionTypeDeclaration& WithDescription(DescriptionT&& value) {
  ...
  void SetExecutor(ExecutorT&& value) {
    ...
    m_executor = std::forward<ExecutorT>(value);
  }
  template <typename ExecutorT = ActionTypeExecutor>
  ActionTypeDeclaration& WithExecutor(ExecutorT&& value) {
    SetExecutor(std::forward<ExecutorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = ActionTypeIdentifier>
  ActionTypeDeclaration& WithId(IdT&& value) {
  ...
  template <typename InputArtifactDetailsT = ActionTypeArtifactDetails>
  ActionTypeDeclaration& WithInputArtifactDetails(InputArtifactDetailsT&& value) {
  ...
  template <typename OutputArtifactDetailsT = ActionTypeArtifactDetails>
  ActionTypeDeclaration& WithOutputArtifactDetails(OutputArtifactDetailsT&& value) {
  ...
  template <typename PermissionsT = ActionTypePermissions>
  ActionTypeDeclaration& WithPermissions(PermissionsT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<ActionTypeProperty>>
  ActionTypeDeclaration& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  template <typename PropertiesT = ActionTypeProperty>
  ActionTypeDeclaration& AddProperties(PropertiesT&& value) {
    m_propertiesHasBeenSet = true;
  ...
  template <typename UrlsT = ActionTypeUrls>
  ActionTypeDeclaration& WithUrls(UrlsT&& value) {
