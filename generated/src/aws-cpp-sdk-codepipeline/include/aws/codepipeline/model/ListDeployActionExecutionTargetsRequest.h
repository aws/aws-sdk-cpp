...
class ListDeployActionExecutionTargetsRequest : public CodePipelineRequest {
 public:
  ...
  template <typename PipelineNameT = Aws::String>
  ListDeployActionExecutionTargetsRequest& WithPipelineName(PipelineNameT&& value) {
  ...
  template <typename ActionExecutionIdT = Aws::String>
  ListDeployActionExecutionTargetsRequest& WithActionExecutionId(ActionExecutionIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<TargetFilter>>
  ListDeployActionExecutionTargetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = TargetFilter>
  ListDeployActionExecutionTargetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListDeployActionExecutionTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeployActionExecutionTargetsRequest& WithNextToken(NextTokenT&& value) {
