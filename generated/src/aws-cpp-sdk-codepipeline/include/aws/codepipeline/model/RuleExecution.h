...
class RuleExecution {
 public:
  ...
  void SetRuleExecutionId(RuleExecutionIdT&& value) {
    ...
    m_ruleExecutionId = std::forward<RuleExecutionIdT>(value);
  }
  template <typename RuleExecutionIdT = Aws::String>
  RuleExecution& WithRuleExecutionId(RuleExecutionIdT&& value) {
    SetRuleExecutionId(std::forward<RuleExecutionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(RuleExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RuleExecution& WithStatus(RuleExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
