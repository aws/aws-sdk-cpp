...
class WebhookAuthConfiguration {
 public:
  ...
  void SetAllowedIPRange(AllowedIPRangeT&& value) {
    ...
    m_allowedIPRange = std::forward<AllowedIPRangeT>(value);
  }
  template <typename AllowedIPRangeT = Aws::String>
  WebhookAuthConfiguration& WithAllowedIPRange(AllowedIPRangeT&& value) {
    SetAllowedIPRange(std::forward<AllowedIPRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretToken(SecretTokenT&& value) {
    ...
    m_secretToken = std::forward<SecretTokenT>(value);
  }
  template <typename SecretTokenT = Aws::String>
  WebhookAuthConfiguration& WithSecretToken(SecretTokenT&& value) {
    SetSecretToken(std::forward<SecretTokenT>(value));
    return *this;
  }
  ///@}
 private:
