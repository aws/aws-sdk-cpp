...
class ActionExecutionFilter {
 public:
  ...
  template <typename PipelineExecutionIdT = Aws::String>
  ActionExecutionFilter& WithPipelineExecutionId(PipelineExecutionIdT&& value) {
  ...
  template <typename LatestInPipelineExecutionT = LatestInPipelineExecutionFilter>
  ActionExecutionFilter& WithLatestInPipelineExecution(LatestInPipelineExecutionT&& value) {
