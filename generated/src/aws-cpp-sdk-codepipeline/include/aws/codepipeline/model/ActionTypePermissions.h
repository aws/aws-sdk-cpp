...
class ActionTypePermissions {
 public:
  ...
  void SetAllowedAccounts(AllowedAccountsT&& value) {
    m_allowedAccountsHasBeenSet = true;
    m_allowedAccounts = std::forward<AllowedAccountsT>(value);
  }
  template <typename AllowedAccountsT = Aws::Vector<Aws::String>>
  ActionTypePermissions& WithAllowedAccounts(AllowedAccountsT&& value) {
    SetAllowedAccounts(std::forward<AllowedAccountsT>(value));
    return *this;
  }
  template <typename AllowedAccountsT = Aws::String>
  ActionTypePermissions& AddAllowedAccounts(AllowedAccountsT&& value) {
    m_allowedAccountsHasBeenSet = true;
    m_allowedAccounts.emplace_back(std::forward<AllowedAccountsT>(value));
    return *this;
  }
  ///@}
 private:
