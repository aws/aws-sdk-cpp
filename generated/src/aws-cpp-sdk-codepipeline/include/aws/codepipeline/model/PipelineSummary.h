...
class PipelineSummary {
 public:
  ...
  inline PipelineSummary& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline PipelineSummary& WithPipelineType(PipelineType value) {
  ...
  inline PipelineSummary& WithExecutionMode(ExecutionMode value) {
