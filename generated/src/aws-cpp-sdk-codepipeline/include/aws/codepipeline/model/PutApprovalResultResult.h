...
class PutApprovalResultResult {
 public:
  ...
  void SetApprovedAt(ApprovedAtT&& value) {
    m_approvedAtHasBeenSet = true;
    m_approvedAt = std::forward<ApprovedAtT>(value);
  }
  template <typename ApprovedAtT = Aws::Utils::DateTime>
  PutApprovalResultResult& WithApprovedAt(ApprovedAtT&& value) {
    SetApprovedAt(std::forward<ApprovedAtT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutApprovalResultResult& WithRequestId(RequestIdT&& value) {
