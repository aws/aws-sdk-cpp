...
class DeleteCustomActionTypeRequest : public CodePipelineRequest {
 public:
  ...
  inline DeleteCustomActionTypeRequest& WithCategory(ActionCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProviderT = Aws::String>
  DeleteCustomActionTypeRequest& WithProvider(ProviderT&& value) {
  ...
  template <typename VersionT = Aws::String>
  DeleteCustomActionTypeRequest& WithVersion(VersionT&& value) {
