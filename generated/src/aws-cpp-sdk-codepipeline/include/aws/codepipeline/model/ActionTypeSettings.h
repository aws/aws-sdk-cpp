...
class ActionTypeSettings {
 public:
  ...
  void SetThirdPartyConfigurationUrl(ThirdPartyConfigurationUrlT&& value) {
    m_thirdPartyConfigurationUrlHasBeenSet = true;
    m_thirdPartyConfigurationUrl = std::forward<ThirdPartyConfigurationUrlT>(value);
  }
  template <typename ThirdPartyConfigurationUrlT = Aws::String>
  ActionTypeSettings& WithThirdPartyConfigurationUrl(ThirdPartyConfigurationUrlT&& value) {
    SetThirdPartyConfigurationUrl(std::forward<ThirdPartyConfigurationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EntityUrlTemplateT = Aws::String>
  ActionTypeSettings& WithEntityUrlTemplate(EntityUrlTemplateT&& value) {
  ...
  template <typename ExecutionUrlTemplateT = Aws::String>
  ActionTypeSettings& WithExecutionUrlTemplate(ExecutionUrlTemplateT&& value) {
  ...
  template <typename RevisionUrlTemplateT = Aws::String>
  ActionTypeSettings& WithRevisionUrlTemplate(RevisionUrlTemplateT&& value) {
