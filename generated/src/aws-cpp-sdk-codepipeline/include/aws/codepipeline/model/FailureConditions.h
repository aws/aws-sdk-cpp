...
class FailureConditions {
 public:
  ...
  inline void SetResult(Result value) {
    m_resultHasBeenSet = true;
    m_result = value;
  }
  inline FailureConditions& WithResult(Result value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  void SetRetryConfiguration(RetryConfigurationT&& value) {
    ...
    m_retryConfiguration = std::forward<RetryConfigurationT>(value);
  }
  template <typename RetryConfigurationT = RetryConfiguration>
  FailureConditions& WithRetryConfiguration(RetryConfigurationT&& value) {
    SetRetryConfiguration(std::forward<RetryConfigurationT>(value));
    return *this;
  }
  ///@}
