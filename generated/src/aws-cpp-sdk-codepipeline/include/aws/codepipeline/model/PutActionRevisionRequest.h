...
class PutActionRevisionRequest : public CodePipelineRequest {
 public:
  ...
  void SetActionRevision(ActionRevisionT&& value) {
    m_actionRevisionHasBeenSet = true;
    m_actionRevision = std::forward<ActionRevisionT>(value);
  }
  template <typename ActionRevisionT = ActionRevision>
  PutActionRevisionRequest& WithActionRevision(ActionRevisionT&& value) {
    SetActionRevision(std::forward<ActionRevisionT>(value));
    return *this;
  }
  ///@}
 private:
