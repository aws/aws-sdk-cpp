...
class RuleTypeId {
 public:
  ...
  inline void SetCategory(RuleCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline RuleTypeId& WithCategory(RuleCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOwner(RuleOwner value) {
    m_ownerHasBeenSet = true;
    m_owner = value;
  }
  inline RuleTypeId& WithOwner(RuleOwner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProviderT = Aws::String>
  RuleTypeId& WithProvider(ProviderT&& value) {
  ...
  template <typename VersionT = Aws::String>
  RuleTypeId& WithVersion(VersionT&& value) {
