...
class RuleExecutionFilter {
 public:
  ...
  template <typename PipelineExecutionIdT = Aws::String>
  RuleExecutionFilter& WithPipelineExecutionId(PipelineExecutionIdT&& value) {
  ...
  void SetLatestInPipelineExecution(LatestInPipelineExecutionT&& value) {
    m_latestInPipelineExecutionHasBeenSet = true;
    m_latestInPipelineExecution = std::forward<LatestInPipelineExecutionT>(value);
  }
  template <typename LatestInPipelineExecutionT = LatestInPipelineExecutionFilter>
  RuleExecutionFilter& WithLatestInPipelineExecution(LatestInPipelineExecutionT&& value) {
    SetLatestInPipelineExecution(std::forward<LatestInPipelineExecutionT>(value));
    return *this;
  }
  ///@}
 private:
