...
class ActionDeclaration {
 public:
  ...
  void SetActionTypeId(ActionTypeIdT&& value) {
    ...
    m_actionTypeId = std::forward<ActionTypeIdT>(value);
  }
  template <typename ActionTypeIdT = ActionTypeId>
  ActionDeclaration& WithActionTypeId(ActionTypeIdT&& value) {
    SetActionTypeId(std::forward<ActionTypeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRunOrder(int value) {
    m_runOrderHasBeenSet = true;
    m_runOrder = value;
  }
  inline ActionDeclaration& WithRunOrder(int value) {
    SetRunOrder(value);
    return *this;
  }
  ///@}
  ...
  ActionDeclaration& AddConfiguration(ConfigurationKeyT&& key, ConfigurationValueT&& value) {
    m_configurationHasBeenSet = true;
    m_configuration.emplace(std::forward<ConfigurationKeyT>(key), std::forward<ConfigurationValueT>(value));
    return *this;
  }
  ///@}
  ...
  ActionDeclaration& AddOutputArtifacts(OutputArtifactsT&& value) {
    m_outputArtifactsHasBeenSet = true;
    m_outputArtifacts.emplace_back(std::forward<OutputArtifactsT>(value));
    return *this;
  }
  ///@}
  ...
  ActionDeclaration& AddInputArtifacts(InputArtifactsT&& value) {
    m_inputArtifactsHasBeenSet = true;
    m_inputArtifacts.emplace_back(std::forward<InputArtifactsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputVariables(OutputVariablesT&& value) {
    ...
    m_outputVariables = std::forward<OutputVariablesT>(value);
  }
  template <typename OutputVariablesT = Aws::Vector<Aws::String>>
  ActionDeclaration& WithOutputVariables(OutputVariablesT&& value) {
    SetOutputVariables(std::forward<OutputVariablesT>(value));
    return *this;
  }
  template <typename OutputVariablesT = Aws::String>
  ActionDeclaration& AddOutputVariables(OutputVariablesT&& value) {
    m_outputVariablesHasBeenSet = true;
    m_outputVariables.emplace_back(std::forward<OutputVariablesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ActionDeclaration& WithTimeoutInMinutes(int value) {
