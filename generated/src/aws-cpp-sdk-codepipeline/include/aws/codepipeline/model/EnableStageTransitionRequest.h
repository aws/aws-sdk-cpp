...
class EnableStageTransitionRequest : public CodePipelineRequest {
 public:
  ...
  template <typename PipelineNameT = Aws::String>
  EnableStageTransitionRequest& WithPipelineName(PipelineNameT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  EnableStageTransitionRequest& WithStageName(StageNameT&& value) {
  ...
  inline EnableStageTransitionRequest& WithTransitionType(StageTransitionType value) {
