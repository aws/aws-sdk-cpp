...
class PipelineExecution {
 public:
  ...
  inline PipelineExecution& WithPipelineVersion(int value) {
  ...
  inline void SetStatus(PipelineExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PipelineExecution& WithStatus(PipelineExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetArtifactRevisions(ArtifactRevisionsT&& value) {
    ...
    m_artifactRevisions = std::forward<ArtifactRevisionsT>(value);
  }
  template <typename ArtifactRevisionsT = Aws::Vector<ArtifactRevision>>
  PipelineExecution& WithArtifactRevisions(ArtifactRevisionsT&& value) {
    SetArtifactRevisions(std::forward<ArtifactRevisionsT>(value));
    return *this;
  }
  template <typename ArtifactRevisionsT = ArtifactRevision>
  PipelineExecution& AddArtifactRevisions(ArtifactRevisionsT&& value) {
    m_artifactRevisionsHasBeenSet = true;
    m_artifactRevisions.emplace_back(std::forward<ArtifactRevisionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipelineExecution& WithExecutionMode(ExecutionMode value) {
  ...
  inline PipelineExecution& WithExecutionType(ExecutionType value) {
  ...
  void SetRollbackMetadata(RollbackMetadataT&& value) {
    ...
    m_rollbackMetadata = std::forward<RollbackMetadataT>(value);
  }
  template <typename RollbackMetadataT = PipelineRollbackMetadata>
  PipelineExecution& WithRollbackMetadata(RollbackMetadataT&& value) {
    SetRollbackMetadata(std::forward<RollbackMetadataT>(value));
    return *this;
  }
  ///@}
 private:
