 ...
 * API Reference</a></p>
 */
class ListPipelinesRequest : public CodePipelineRequest {
 public:
  AWS_CODEPIPELINE_API ListPipelinesRequest() = default;
  ...
  inline ListPipelinesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
