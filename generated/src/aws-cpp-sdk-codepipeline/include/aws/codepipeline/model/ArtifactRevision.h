...
class ArtifactRevision {
 public:
  ...
  template <typename NameT = Aws::String>
  ArtifactRevision& WithName(NameT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  ArtifactRevision& WithRevisionId(RevisionIdT&& value) {
  ...
  void SetRevisionChangeIdentifier(RevisionChangeIdentifierT&& value) {
    m_revisionChangeIdentifierHasBeenSet = true;
    m_revisionChangeIdentifier = std::forward<RevisionChangeIdentifierT>(value);
  }
  template <typename RevisionChangeIdentifierT = Aws::String>
  ArtifactRevision& WithRevisionChangeIdentifier(RevisionChangeIdentifierT&& value) {
    SetRevisionChangeIdentifier(std::forward<RevisionChangeIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRevisionSummary(RevisionSummaryT&& value) {
    ...
    m_revisionSummary = std::forward<RevisionSummaryT>(value);
  }
  template <typename RevisionSummaryT = Aws::String>
  ArtifactRevision& WithRevisionSummary(RevisionSummaryT&& value) {
    SetRevisionSummary(std::forward<RevisionSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedT = Aws::Utils::DateTime>
  ArtifactRevision& WithCreated(CreatedT&& value) {
  ...
  void SetRevisionUrl(RevisionUrlT&& value) {
    ...
    m_revisionUrl = std::forward<RevisionUrlT>(value);
  }
  template <typename RevisionUrlT = Aws::String>
  ArtifactRevision& WithRevisionUrl(RevisionUrlT&& value) {
    SetRevisionUrl(std::forward<RevisionUrlT>(value));
    return *this;
  }
  ///@}
 private:
