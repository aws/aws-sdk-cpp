...
class ListActionTypesRequest : public CodePipelineRequest {
 public:
  ...
  inline void SetActionOwnerFilter(ActionOwner value) {
    m_actionOwnerFilterHasBeenSet = true;
    m_actionOwnerFilter = value;
  }
  inline ListActionTypesRequest& WithActionOwnerFilter(ActionOwner value) {
    SetActionOwnerFilter(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListActionTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetRegionFilter(RegionFilterT&& value) {
    m_regionFilterHasBeenSet = true;
    m_regionFilter = std::forward<RegionFilterT>(value);
  }
  template <typename RegionFilterT = Aws::String>
  ListActionTypesRequest& WithRegionFilter(RegionFilterT&& value) {
    SetRegionFilter(std::forward<RegionFilterT>(value));
    return *this;
  }
  ///@}
 private:
