...
class TargetFilter {
 public:
  ...
  inline void SetName(TargetFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline TargetFilter& WithName(TargetFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  TargetFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  TargetFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
