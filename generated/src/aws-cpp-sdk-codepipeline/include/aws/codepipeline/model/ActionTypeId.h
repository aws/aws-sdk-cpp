...
class ActionTypeId {
 public:
  ...
  inline ActionTypeId& WithCategory(ActionCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOwner(ActionOwner value) {
    m_ownerHasBeenSet = true;
    m_owner = value;
  }
  inline ActionTypeId& WithOwner(ActionOwner value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProviderT = Aws::String>
  ActionTypeId& WithProvider(ProviderT&& value) {
  ...
  template <typename VersionT = Aws::String>
  ActionTypeId& WithVersion(VersionT&& value) {
