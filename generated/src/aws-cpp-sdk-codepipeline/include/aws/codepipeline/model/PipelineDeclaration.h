...
class PipelineDeclaration {
 public:
  ...
  void SetArtifactStore(ArtifactStoreT&& value) {
    ...
    m_artifactStore = std::forward<ArtifactStoreT>(value);
  }
  template <typename ArtifactStoreT = ArtifactStore>
  PipelineDeclaration& WithArtifactStore(ArtifactStoreT&& value) {
    SetArtifactStore(std::forward<ArtifactStoreT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArtifactStores(ArtifactStoresT&& value) {
    ...
    m_artifactStores = std::forward<ArtifactStoresT>(value);
  }
  template <typename ArtifactStoresT = Aws::Map<Aws::String, ArtifactStore>>
  PipelineDeclaration& WithArtifactStores(ArtifactStoresT&& value) {
    SetArtifactStores(std::forward<ArtifactStoresT>(value));
    return *this;
  }
  ...
  PipelineDeclaration& AddArtifactStores(ArtifactStoresKeyT&& key, ArtifactStoresValueT&& value) {
    m_artifactStoresHasBeenSet = true;
    m_artifactStores.emplace(std::forward<ArtifactStoresKeyT>(key), std::forward<ArtifactStoresValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipelineDeclaration& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline PipelineDeclaration& WithExecutionMode(ExecutionMode value) {
  ...
  inline void SetPipelineType(PipelineType value) {
    m_pipelineTypeHasBeenSet = true;
    m_pipelineType = value;
  }
  inline PipelineDeclaration& WithPipelineType(PipelineType value) {
