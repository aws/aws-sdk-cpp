...
class RuleTypeSettings {
 public:
  ...
  template <typename ThirdPartyConfigurationUrlT = Aws::String>
  RuleTypeSettings& WithThirdPartyConfigurationUrl(ThirdPartyConfigurationUrlT&& value) {
  ...
  template <typename EntityUrlTemplateT = Aws::String>
  RuleTypeSettings& WithEntityUrlTemplate(EntityUrlTemplateT&& value) {
  ...
  template <typename ExecutionUrlTemplateT = Aws::String>
  RuleTypeSettings& WithExecutionUrlTemplate(ExecutionUrlTemplateT&& value) {
  ...
  template <typename RevisionUrlTemplateT = Aws::String>
  RuleTypeSettings& WithRevisionUrlTemplate(RevisionUrlTemplateT&& value) {
