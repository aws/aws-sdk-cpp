...
namespace Model
{
  ...
  {
  public:
    AWS_CODEPIPELINE_API RuleRevision();
    ...
    inline RuleRevision& WithRevisionId(const Aws::String& value) { SetRevisionId(value); return *this;}
    inline RuleRevision& WithRevisionId(Aws::String&& value) { SetRevisionId(std::move(value)); return *this;}
    inline RuleRevision& WithRevisionId(const char* value) { SetRevisionId(value); return *this;}
    ///@}
    ...
    inline RuleRevision& WithRevisionChangeId(const Aws::String& value) { SetRevisionChangeId(value); return *this;}
    inline RuleRevision& WithRevisionChangeId(Aws::String&& value) { SetRevisionChangeId(std::move(value)); return *this;}
    inline RuleRevision& WithRevisionChangeId(const char* value) { SetRevisionChangeId(value); return *this;}
    ///@}
    ...
    inline RuleRevision& WithCreated(const Aws::Utils::DateTime& value) { SetCreated(value); return *this;}
    inline RuleRevision& WithCreated(Aws::Utils::DateTime&& value) { SetCreated(std::move(value)); return *this;}
    ///@}
  private:
