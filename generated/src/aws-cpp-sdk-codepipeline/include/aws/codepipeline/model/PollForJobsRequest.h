...
class PollForJobsRequest : public CodePipelineRequest {
 public:
  ...
  inline PollForJobsRequest& WithMaxBatchSize(int value) {
  ...
  void SetQueryParam(QueryParamT&& value) {
    ...
    m_queryParam = std::forward<QueryParamT>(value);
  }
  template <typename QueryParamT = Aws::Map<Aws::String, Aws::String>>
  PollForJobsRequest& WithQueryParam(QueryParamT&& value) {
    SetQueryParam(std::forward<QueryParamT>(value));
    return *this;
  }
  ...
  PollForJobsRequest& AddQueryParam(QueryParamKeyT&& key, QueryParamValueT&& value) {
    m_queryParamHasBeenSet = true;
    m_queryParam.emplace(std::forward<QueryParamKeyT>(key), std::forward<QueryParamValueT>(value));
    return *this;
  }
  ///@}
 private:
