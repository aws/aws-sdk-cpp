...
class RollbackStageRequest : public CodePipelineRequest {
 public:
  ...
  template <typename PipelineNameT = Aws::String>
  RollbackStageRequest& WithPipelineName(PipelineNameT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  RollbackStageRequest& WithStageName(StageNameT&& value) {
  ...
  void SetTargetPipelineExecutionId(TargetPipelineExecutionIdT&& value) {
    m_targetPipelineExecutionIdHasBeenSet = true;
    m_targetPipelineExecutionId = std::forward<TargetPipelineExecutionIdT>(value);
  }
  template <typename TargetPipelineExecutionIdT = Aws::String>
  RollbackStageRequest& WithTargetPipelineExecutionId(TargetPipelineExecutionIdT&& value) {
    SetTargetPipelineExecutionId(std::forward<TargetPipelineExecutionIdT>(value));
    return *this;
  }
  ///@}
 private:
