...
class ExecutionTrigger {
 public:
  ...
  inline ExecutionTrigger& WithTriggerType(TriggerType value) {
  ...
  void SetTriggerDetail(TriggerDetailT&& value) {
    m_triggerDetailHasBeenSet = true;
    m_triggerDetail = std::forward<TriggerDetailT>(value);
  }
  template <typename TriggerDetailT = Aws::String>
  ExecutionTrigger& WithTriggerDetail(TriggerDetailT&& value) {
    SetTriggerDetail(std::forward<TriggerDetailT>(value));
    return *this;
  }
  ///@}
 private:
