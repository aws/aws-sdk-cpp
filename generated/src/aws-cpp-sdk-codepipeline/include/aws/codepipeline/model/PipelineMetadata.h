...
class PipelineMetadata {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  PipelineMetadata& WithPipelineArn(PipelineArnT&& value) {
  ...
  template <typename CreatedT = Aws::Utils::DateTime>
  PipelineMetadata& WithCreated(CreatedT&& value) {
  ...
  void SetUpdated(UpdatedT&& value) {
    ...
    m_updated = std::forward<UpdatedT>(value);
  }
  template <typename UpdatedT = Aws::Utils::DateTime>
  PipelineMetadata& WithUpdated(UpdatedT&& value) {
    SetUpdated(std::forward<UpdatedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPollingDisabledAt(PollingDisabledAtT&& value) {
    m_pollingDisabledAtHasBeenSet = true;
    m_pollingDisabledAt = std::forward<PollingDisabledAtT>(value);
  }
  template <typename PollingDisabledAtT = Aws::Utils::DateTime>
  PipelineMetadata& WithPollingDisabledAt(PollingDisabledAtT&& value) {
    SetPollingDisabledAt(std::forward<PollingDisabledAtT>(value));
    return *this;
  }
  ///@}
 private:
