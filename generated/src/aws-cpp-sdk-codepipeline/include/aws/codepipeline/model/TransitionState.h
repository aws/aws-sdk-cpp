...
class TransitionState {
 public:
  ...
  inline TransitionState& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetLastChangedBy(LastChangedByT&& value) {
    ...
    m_lastChangedBy = std::forward<LastChangedByT>(value);
  }
  template <typename LastChangedByT = Aws::String>
  TransitionState& WithLastChangedBy(LastChangedByT&& value) {
    SetLastChangedBy(std::forward<LastChangedByT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastChangedAt(LastChangedAtT&& value) {
    ...
    m_lastChangedAt = std::forward<LastChangedAtT>(value);
  }
  template <typename LastChangedAtT = Aws::Utils::DateTime>
  TransitionState& WithLastChangedAt(LastChangedAtT&& value) {
    SetLastChangedAt(std::forward<LastChangedAtT>(value));
    return *this;
  }
  ///@}
