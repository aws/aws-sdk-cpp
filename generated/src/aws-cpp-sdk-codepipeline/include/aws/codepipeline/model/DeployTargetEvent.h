...
/**
 * <p>A lifecycle event for the deploy action.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/DeployTargetEvent">AWS
 * API Reference</a></p>
 */
class DeployTargetEvent {
 public:
   ...
   */
  inline const DeployTargetEventContext& GetContext() const { return m_context; }
  inline bool ContextHasBeenSet() const { return m_contextHasBeenSet; }
  template <typename ContextT = DeployTargetEventContext>
 ...
 private:
  ...
  DeployTargetEventContext m_context;
