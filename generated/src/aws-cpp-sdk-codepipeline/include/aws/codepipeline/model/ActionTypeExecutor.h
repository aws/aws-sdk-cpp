...
class ActionTypeExecutor {
 public:
  ...
  template <typename ConfigurationT = ExecutorConfiguration>
  ActionTypeExecutor& WithConfiguration(ConfigurationT&& value) {
  ...
  inline void SetType(ExecutorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ActionTypeExecutor& WithType(ExecutorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetPolicyStatementsTemplate(PolicyStatementsTemplateT&& value) {
    m_policyStatementsTemplateHasBeenSet = true;
    m_policyStatementsTemplate = std::forward<PolicyStatementsTemplateT>(value);
  }
  template <typename PolicyStatementsTemplateT = Aws::String>
  ActionTypeExecutor& WithPolicyStatementsTemplate(PolicyStatementsTemplateT&& value) {
    SetPolicyStatementsTemplate(std::forward<PolicyStatementsTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJobTimeout(int value) {
    m_jobTimeoutHasBeenSet = true;
    m_jobTimeout = value;
  }
  inline ActionTypeExecutor& WithJobTimeout(int value) {
    SetJobTimeout(value);
    return *this;
  }
  ///@}
