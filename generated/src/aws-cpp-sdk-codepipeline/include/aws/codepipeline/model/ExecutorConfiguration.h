...
class ExecutorConfiguration {
 public:
  ...
  void SetLambdaExecutorConfiguration(LambdaExecutorConfigurationT&& value) {
    ...
    m_lambdaExecutorConfiguration = std::forward<LambdaExecutorConfigurationT>(value);
  }
  template <typename LambdaExecutorConfigurationT = LambdaExecutorConfiguration>
  ExecutorConfiguration& WithLambdaExecutorConfiguration(LambdaExecutorConfigurationT&& value) {
    SetLambdaExecutorConfiguration(std::forward<LambdaExecutorConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobWorkerExecutorConfiguration(JobWorkerExecutorConfigurationT&& value) {
    ...
    m_jobWorkerExecutorConfiguration = std::forward<JobWorkerExecutorConfigurationT>(value);
  }
  template <typename JobWorkerExecutorConfigurationT = JobWorkerExecutorConfiguration>
  ExecutorConfiguration& WithJobWorkerExecutorConfiguration(JobWorkerExecutorConfigurationT&& value) {
    SetJobWorkerExecutorConfiguration(std::forward<JobWorkerExecutorConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
