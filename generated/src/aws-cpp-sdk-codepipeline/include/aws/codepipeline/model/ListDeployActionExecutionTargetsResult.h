...
class ListDeployActionExecutionTargetsResult {
 public:
  ...
  AWS_CODEPIPELINE_API ListDeployActionExecutionTargetsResult& operator=(
  ...
  template <typename TargetsT = Aws::Vector<DeployActionExecutionTarget>>
  ListDeployActionExecutionTargetsResult& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = DeployActionExecutionTarget>
  ListDeployActionExecutionTargetsResult& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDeployActionExecutionTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeployActionExecutionTargetsResult& WithRequestId(RequestIdT&& value) {
