...
namespace Model
{
  ...
  public:
    ...
    template<typename PipelineNameT = Aws::String>
    OverrideStageConditionRequest& WithPipelineName(PipelineNameT&& value) { SetPipelineName(std::forward<PipelineNameT>(value)); return *this;}
    ///@}
    ...
    template<typename StageNameT = Aws::String>
    OverrideStageConditionRequest& WithStageName(StageNameT&& value) { SetStageName(std::forward<StageNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PipelineExecutionIdT = Aws::String>
    OverrideStageConditionRequest& WithPipelineExecutionId(PipelineExecutionIdT&& value) { SetPipelineExecutionId(std::forward<PipelineExecutionIdT>(value)); return *this;}
    ///@}
    ...
    inline OverrideStageConditionRequest& WithConditionType(ConditionType value) { SetConditionType(value); return *this;}
    ///@}
  private:
