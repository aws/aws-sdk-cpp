...
class RuleConfigurationProperty {
 public:
  ...
  inline RuleConfigurationProperty& WithRequired(bool value) {
    SetRequired(value);
    return *this;
  }
  ///@}
  ...
  inline void SetKey(bool value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline RuleConfigurationProperty& WithKey(bool value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSecret(bool value) {
    m_secretHasBeenSet = true;
    m_secret = value;
  }
  inline RuleConfigurationProperty& WithSecret(bool value) {
    SetSecret(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQueryable(bool value) {
    m_queryableHasBeenSet = true;
    m_queryable = value;
  }
  inline RuleConfigurationProperty& WithQueryable(bool value) {
    SetQueryable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(RuleConfigurationPropertyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RuleConfigurationProperty& WithType(RuleConfigurationPropertyType value) {
    SetType(value);
    return *this;
  }
  ///@}
