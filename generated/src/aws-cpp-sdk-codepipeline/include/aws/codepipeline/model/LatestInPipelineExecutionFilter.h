...
class LatestInPipelineExecutionFilter {
 public:
  ...
  template <typename PipelineExecutionIdT = Aws::String>
  LatestInPipelineExecutionFilter& WithPipelineExecutionId(PipelineExecutionIdT&& value) {
  ...
  inline void SetStartTimeRange(StartTimeRange value) {
    m_startTimeRangeHasBeenSet = true;
    m_startTimeRange = value;
  }
  inline LatestInPipelineExecutionFilter& WithStartTimeRange(StartTimeRange value) {
    SetStartTimeRange(value);
    return *this;
  }
  ///@}
 private:
