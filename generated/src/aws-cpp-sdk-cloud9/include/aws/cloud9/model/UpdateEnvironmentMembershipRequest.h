...
class UpdateEnvironmentMembershipRequest : public Cloud9Request {
 public:
  AWS_CLOUD9_API UpdateEnvironmentMembershipRequest() = default;
  ...
  template <typename EnvironmentIdT = Aws::String>
  UpdateEnvironmentMembershipRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename UserArnT = Aws::String>
  UpdateEnvironmentMembershipRequest& WithUserArn(UserArnT&& value) {
  ...
  inline UpdateEnvironmentMembershipRequest& WithPermissions(MemberPermissions value) {
