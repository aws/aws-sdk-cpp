...
class DescribeEnvironmentMembershipsResult {
 public:
  ...
  template <typename MembershipsT = Aws::Vector<EnvironmentMember>>
  DescribeEnvironmentMembershipsResult& WithMemberships(MembershipsT&& value) {
    SetMemberships(std::forward<MembershipsT>(value));
    return *this;
  }
  template <typename MembershipsT = EnvironmentMember>
  DescribeEnvironmentMembershipsResult& AddMemberships(MembershipsT&& value) {
    m_membershipsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEnvironmentMembershipsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEnvironmentMembershipsResult& WithRequestId(RequestIdT&& value) {
