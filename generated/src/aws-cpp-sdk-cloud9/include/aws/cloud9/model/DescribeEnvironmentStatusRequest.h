...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUD9_API DescribeEnvironmentStatusRequest() = default;
    ...
    template<typename EnvironmentIdT = Aws::String>
    DescribeEnvironmentStatusRequest& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
  private:
