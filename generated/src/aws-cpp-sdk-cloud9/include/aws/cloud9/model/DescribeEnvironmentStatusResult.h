...
class DescribeEnvironmentStatusResult {
 public:
  ...
  inline DescribeEnvironmentStatusResult& WithStatus(EnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  DescribeEnvironmentStatusResult& WithMessage(MessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEnvironmentStatusResult& WithRequestId(RequestIdT&& value) {
