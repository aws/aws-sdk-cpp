...
class Environment {
 public:
  ...
  inline void SetType(EnvironmentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Environment& WithType(EnvironmentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Environment& WithConnectionType(ConnectionType value) {
  ...
  void SetOwnerArn(OwnerArnT&& value) {
    ...
    m_ownerArn = std::forward<OwnerArnT>(value);
  }
  template <typename OwnerArnT = Aws::String>
  Environment& WithOwnerArn(OwnerArnT&& value) {
    SetOwnerArn(std::forward<OwnerArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManagedCredentialsStatus(ManagedCredentialsStatus value) {
    m_managedCredentialsStatusHasBeenSet = true;
    m_managedCredentialsStatus = value;
  }
  inline Environment& WithManagedCredentialsStatus(ManagedCredentialsStatus value) {
    SetManagedCredentialsStatus(value);
    return *this;
  }
  ///@}
 private:
