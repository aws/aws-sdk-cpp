...
class AWS_CLOUD9_API Cloud9Client : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Cloud9Client(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<Cloud9EndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateEnvironmentEC2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEnvironmentEC2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEnvironmentEC2RequestT = Model::CreateEnvironmentEC2Request>
  void CreateEnvironmentEC2Async(const CreateEnvironmentEC2RequestT& request, const CreateEnvironmentEC2ResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEnvironmentMembershipOutcome CreateEnvironmentMembership(
      const Model::CreateEnvironmentMembershipRequest& request) const;

  /**
   * A Callable wrapper for CreateEnvironmentMembership that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEnvironmentMembershipRequestT = Model::CreateEnvironmentMembershipRequest>
  Model::CreateEnvironmentMembershipOutcomeCallable CreateEnvironmentMembershipCallable(
      const CreateEnvironmentMembershipRequestT& request) const {
    return SubmitCallable(&Cloud9Client::CreateEnvironmentMembership, request);
  }

  /**
   * An Async wrapper for CreateEnvironmentMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEnvironmentMembershipRequestT = Model::CreateEnvironmentMembershipRequest>
  void CreateEnvironmentMembershipAsync(const CreateEnvironmentMembershipRequestT& request,
                                        const CreateEnvironmentMembershipResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEnvironmentMembershipOutcome DeleteEnvironmentMembership(
      const Model::DeleteEnvironmentMembershipRequest& request) const;

  /**
   * A Callable wrapper for DeleteEnvironmentMembership that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEnvironmentMembershipRequestT = Model::DeleteEnvironmentMembershipRequest>
  Model::DeleteEnvironmentMembershipOutcomeCallable DeleteEnvironmentMembershipCallable(
      const DeleteEnvironmentMembershipRequestT& request) const {
    return SubmitCallable(&Cloud9Client::DeleteEnvironmentMembership, request);
  }

  /**
   * An Async wrapper for DeleteEnvironmentMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEnvironmentMembershipRequestT = Model::DeleteEnvironmentMembershipRequest>
  void DeleteEnvironmentMembershipAsync(const DeleteEnvironmentMembershipRequestT& request,
                                        const DeleteEnvironmentMembershipResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEnvironmentMembershipsOutcome DescribeEnvironmentMemberships(
      const Model::DescribeEnvironmentMembershipsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEnvironmentMemberships that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEnvironmentMembershipsRequestT = Model::DescribeEnvironmentMembershipsRequest>
  Model::DescribeEnvironmentMembershipsOutcomeCallable DescribeEnvironmentMembershipsCallable(
      const DescribeEnvironmentMembershipsRequestT& request = {}) const {
    return SubmitCallable(&Cloud9Client::DescribeEnvironmentMemberships, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentMemberships that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEnvironmentMembershipsRequestT = Model::DescribeEnvironmentMembershipsRequest>
  void DescribeEnvironmentMembershipsAsync(const DescribeEnvironmentMembershipsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeEnvironmentStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeEnvironmentStatusRequestT = Model::DescribeEnvironmentStatusRequest>
  Model::DescribeEnvironmentStatusOutcomeCallable DescribeEnvironmentStatusCallable(
      const DescribeEnvironmentStatusRequestT& request) const {
    return SubmitCallable(&Cloud9Client::DescribeEnvironmentStatus, request);
  }

  /**
   * An Async wrapper for DescribeEnvironmentStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEnvironmentStatusRequestT = Model::DescribeEnvironmentStatusRequest>
  void DescribeEnvironmentStatusAsync(const DescribeEnvironmentStatusRequestT& request,
                                      const DescribeEnvironmentStatusResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEnvironments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEnvironments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEnvironmentsRequestT = Model::DescribeEnvironmentsRequest>
  void DescribeEnvironmentsAsync(const DescribeEnvironmentsRequestT& request, const DescribeEnvironmentsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEnvironmentMembershipOutcome UpdateEnvironmentMembership(
      const Model::UpdateEnvironmentMembershipRequest& request) const;

  /**
   * A Callable wrapper for UpdateEnvironmentMembership that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEnvironmentMembershipRequestT = Model::UpdateEnvironmentMembershipRequest>
  Model::UpdateEnvironmentMembershipOutcomeCallable UpdateEnvironmentMembershipCallable(
      const UpdateEnvironmentMembershipRequestT& request) const {
    return SubmitCallable(&Cloud9Client::UpdateEnvironmentMembership, request);
  }

  /**
   * An Async wrapper for UpdateEnvironmentMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnvironmentMembershipRequestT = Model::UpdateEnvironmentMembershipRequest>
  void UpdateEnvironmentMembershipAsync(const UpdateEnvironmentMembershipRequestT& request,
                                        const UpdateEnvironmentMembershipResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
