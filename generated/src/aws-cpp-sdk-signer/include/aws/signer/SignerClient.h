...
class AWS_SIGNER_API SignerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SignerClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SignerEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AddProfilePermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddProfilePermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddProfilePermissionRequestT = Model::AddProfilePermissionRequest>
  void AddProfilePermissionAsync(const AddProfilePermissionRequestT& request, const AddProfilePermissionResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelSigningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelSigningProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelSigningProfileRequestT = Model::CancelSigningProfileRequest>
  void CancelSigningProfileAsync(const CancelSigningProfileRequestT& request, const CancelSigningProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSigningJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSigningJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSigningJobRequestT = Model::DescribeSigningJobRequest>
  void DescribeSigningJobAsync(const DescribeSigningJobRequestT& request, const DescribeSigningJobResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSigningPlatform that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSigningPlatform that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSigningPlatformRequestT = Model::GetSigningPlatformRequest>
  void GetSigningPlatformAsync(const GetSigningPlatformRequestT& request, const GetSigningPlatformResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSigningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSigningProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSigningProfileRequestT = Model::GetSigningProfileRequest>
  void GetSigningProfileAsync(const GetSigningProfileRequestT& request, const GetSigningProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfilePermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfilePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfilePermissionsRequestT = Model::ListProfilePermissionsRequest>
  void ListProfilePermissionsAsync(const ListProfilePermissionsRequestT& request,
  ...
  /**
   * An Async wrapper for ListSigningJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSigningJobsRequestT = Model::ListSigningJobsRequest>
  void ListSigningJobsAsync(const ListSigningJobsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListSigningJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSigningPlatforms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSigningPlatforms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSigningPlatformsRequestT = Model::ListSigningPlatformsRequest>
  void ListSigningPlatformsAsync(const ListSigningPlatformsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListSigningPlatformsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSigningProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSigningProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSigningProfilesRequestT = Model::ListSigningProfilesRequest>
  void ListSigningProfilesAsync(const ListSigningProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListSigningProfilesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutSigningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutSigningProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutSigningProfileRequestT = Model::PutSigningProfileRequest>
  void PutSigningProfileAsync(const PutSigningProfileRequestT& request, const PutSigningProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveProfilePermission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveProfilePermission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveProfilePermissionRequestT = Model::RemoveProfilePermissionRequest>
  void RemoveProfilePermissionAsync(const RemoveProfilePermissionRequestT& request,
  ...
  /**
   * An Async wrapper for RevokeSignature that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RevokeSignatureRequestT = Model::RevokeSignatureRequest>
  void RevokeSignatureAsync(const RevokeSignatureRequestT& request, const RevokeSignatureResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RevokeSigningProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RevokeSigningProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RevokeSigningProfileRequestT = Model::RevokeSigningProfileRequest>
  void RevokeSigningProfileAsync(const RevokeSigningProfileRequestT& request, const RevokeSigningProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SignPayload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SignPayloadRequestT = Model::SignPayloadRequest>
  void SignPayloadAsync(const SignPayloadRequestT& request, const SignPayloadResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartSigningJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartSigningJobRequestT = Model::StartSigningJobRequest>
  void StartSigningJobAsync(const StartSigningJobRequestT& request, const StartSigningJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
