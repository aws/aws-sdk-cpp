...
namespace signer
{
  AWS_SIGNER_API extern const char SERVICE_NAME[];
  /**
   ...
   */
  class AWS_SIGNER_API SignerClient : Aws::Client::ClientWithAsyncTemplateMethods<SignerClient>,
    smithy::client::AwsSmithyClientT<Aws::signer::SERVICE_NAME,
      ...
      Aws::Client::SignerErrorMarshaller>
  {
    public:
      static const char* GetServiceName();
      static const char* GetAllocationTag();
      inline const char* GetServiceClientName() const override { return "signer"; }
