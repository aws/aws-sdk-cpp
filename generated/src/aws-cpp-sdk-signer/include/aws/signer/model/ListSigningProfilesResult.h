...
class ListSigningProfilesResult {
 public:
  ...
  template <typename ProfilesT = Aws::Vector<SigningProfile>>
  ListSigningProfilesResult& WithProfiles(ProfilesT&& value) {
    SetProfiles(std::forward<ProfilesT>(value));
    return *this;
  }
  template <typename ProfilesT = SigningProfile>
  ListSigningProfilesResult& AddProfiles(ProfilesT&& value) {
    m_profilesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSigningProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSigningProfilesResult& WithRequestId(RequestIdT&& value) {
