...
class GetSigningPlatformResult {
 public:
  ...
  inline GetSigningPlatformResult& WithCategory(Category value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline GetSigningPlatformResult& WithMaxSizeInMB(int value) {
  ...
  inline GetSigningPlatformResult& WithRevocationSupported(bool value) {
