...
class ListSigningJobsRequest : public SignerRequest {
 public:
  ...
  inline ListSigningJobsRequest& WithStatus(SigningStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListSigningJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsRevoked(bool value) {
    m_isRevokedHasBeenSet = true;
    m_isRevoked = value;
  }
  inline ListSigningJobsRequest& WithIsRevoked(bool value) {
    SetIsRevoked(value);
    return *this;
  }
  ///@}
  ...
  void SetSignatureExpiresBefore(SignatureExpiresBeforeT&& value) {
    m_signatureExpiresBeforeHasBeenSet = true;
    m_signatureExpiresBefore = std::forward<SignatureExpiresBeforeT>(value);
  }
  template <typename SignatureExpiresBeforeT = Aws::Utils::DateTime>
  ListSigningJobsRequest& WithSignatureExpiresBefore(SignatureExpiresBeforeT&& value) {
    SetSignatureExpiresBefore(std::forward<SignatureExpiresBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSignatureExpiresAfter(SignatureExpiresAfterT&& value) {
    m_signatureExpiresAfterHasBeenSet = true;
    m_signatureExpiresAfter = std::forward<SignatureExpiresAfterT>(value);
  }
  template <typename SignatureExpiresAfterT = Aws::Utils::DateTime>
  ListSigningJobsRequest& WithSignatureExpiresAfter(SignatureExpiresAfterT&& value) {
    SetSignatureExpiresAfter(std::forward<SignatureExpiresAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobInvoker(JobInvokerT&& value) {
    ...
    m_jobInvoker = std::forward<JobInvokerT>(value);
  }
  template <typename JobInvokerT = Aws::String>
  ListSigningJobsRequest& WithJobInvoker(JobInvokerT&& value) {
    SetJobInvoker(std::forward<JobInvokerT>(value));
    return *this;
  }
  ///@}
 private:
