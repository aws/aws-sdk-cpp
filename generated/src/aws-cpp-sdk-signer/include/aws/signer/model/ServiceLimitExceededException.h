...
namespace Model
{
  ...
  /**
   * <p>The client is making a request that exceeds service limits.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/signer-2017-08-25/ServiceLimitExceededException">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    inline ServiceLimitExceededException& WithCode(const Aws::String& value) { SetCode(value); return *this;}

    
    inline ServiceLimitExceededException& WithCode(Aws::String&& value) { SetCode(std::move(value)); return *this;}

    
    inline ServiceLimitExceededException& WithCode(const char* value) { SetCode(value); return *this;}
