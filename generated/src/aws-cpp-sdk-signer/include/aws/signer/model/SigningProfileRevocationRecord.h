...
class SigningProfileRevocationRecord {
 public:
  ...
  void SetRevocationEffectiveFrom(RevocationEffectiveFromT&& value) {
    m_revocationEffectiveFromHasBeenSet = true;
    m_revocationEffectiveFrom = std::forward<RevocationEffectiveFromT>(value);
  }
  template <typename RevocationEffectiveFromT = Aws::Utils::DateTime>
  SigningProfileRevocationRecord& WithRevocationEffectiveFrom(RevocationEffectiveFromT&& value) {
    SetRevocationEffectiveFrom(std::forward<RevocationEffectiveFromT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RevokedAtT = Aws::Utils::DateTime>
  SigningProfileRevocationRecord& WithRevokedAt(RevokedAtT&& value) {
  ...
  void SetRevokedBy(RevokedByT&& value) {
    m_revokedByHasBeenSet = true;
    m_revokedBy = std::forward<RevokedByT>(value);
  }
  template <typename RevokedByT = Aws::String>
  SigningProfileRevocationRecord& WithRevokedBy(RevokedByT&& value) {
    SetRevokedBy(std::forward<RevokedByT>(value));
    return *this;
  }
  ///@}
 private:
