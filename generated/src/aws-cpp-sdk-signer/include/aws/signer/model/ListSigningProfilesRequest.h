...
class ListSigningProfilesRequest : public SignerRequest {
 public:
  ...
  inline void SetIncludeCanceled(bool value) {
    m_includeCanceledHasBeenSet = true;
    m_includeCanceled = value;
  }
  inline ListSigningProfilesRequest& WithIncludeCanceled(bool value) {
    SetIncludeCanceled(value);
    return *this;
  }
  ///@}
  ...
  inline ListSigningProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListSigningProfilesRequest& AddStatuses(SigningProfileStatus value) {
    m_statusesHasBeenSet = true;
