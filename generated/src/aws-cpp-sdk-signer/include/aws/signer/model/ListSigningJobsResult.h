...
class ListSigningJobsResult {
 public:
  AWS_SIGNER_API ListSigningJobsResult() = default;
  ...
  template <typename JobsT = Aws::Vector<SigningJob>>
  void SetJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
    m_jobs = std::forward<JobsT>(value);
  }
  template <typename JobsT = Aws::Vector<SigningJob>>
  ListSigningJobsResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = SigningJob>
  ListSigningJobsResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSigningJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSigningJobsResult& WithRequestId(RequestIdT&& value) {
