...
class SigningPlatformOverrides {
 public:
  ...
  inline void SetSigningImageFormat(ImageFormat value) {
    m_signingImageFormatHasBeenSet = true;
    m_signingImageFormat = value;
  }
  inline SigningPlatformOverrides& WithSigningImageFormat(ImageFormat value) {
    SetSigningImageFormat(value);
    return *this;
  }
  ///@}
 private:
