...
class EncryptionAlgorithmOptions {
 public:
  ...
  inline EncryptionAlgorithmOptions& AddAllowedValues(EncryptionAlgorithm value) {
    m_allowedValuesHasBeenSet = true;
  ...
  inline void SetDefaultValue(EncryptionAlgorithm value) {
    m_defaultValueHasBeenSet = true;
    m_defaultValue = value;
  }
  inline EncryptionAlgorithmOptions& WithDefaultValue(EncryptionAlgorithm value) {
