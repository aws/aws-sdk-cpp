...
namespace Model
{
  ...
  public:
    ...
    template<typename MessageT = Aws::String>
    InternalServiceErrorException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    InternalServiceErrorException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
