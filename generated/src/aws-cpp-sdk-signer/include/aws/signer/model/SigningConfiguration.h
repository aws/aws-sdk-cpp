...
class SigningConfiguration {
 public:
  ...
  void SetEncryptionAlgorithmOptions(EncryptionAlgorithmOptionsT&& value) {
    ...
    m_encryptionAlgorithmOptions = std::forward<EncryptionAlgorithmOptionsT>(value);
  }
  template <typename EncryptionAlgorithmOptionsT = EncryptionAlgorithmOptions>
  SigningConfiguration& WithEncryptionAlgorithmOptions(EncryptionAlgorithmOptionsT&& value) {
    SetEncryptionAlgorithmOptions(std::forward<EncryptionAlgorithmOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHashAlgorithmOptions(HashAlgorithmOptionsT&& value) {
    ...
    m_hashAlgorithmOptions = std::forward<HashAlgorithmOptionsT>(value);
  }
  template <typename HashAlgorithmOptionsT = HashAlgorithmOptions>
  SigningConfiguration& WithHashAlgorithmOptions(HashAlgorithmOptionsT&& value) {
    SetHashAlgorithmOptions(std::forward<HashAlgorithmOptionsT>(value));
    return *this;
  }
  ///@}
 private:
