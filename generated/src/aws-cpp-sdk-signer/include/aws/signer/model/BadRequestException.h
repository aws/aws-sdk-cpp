...
namespace Model
{
  ...
  {
  public:
    AWS_SIGNER_API BadRequestException() = default;
    AWS_SIGNER_API BadRequestException(Aws::Utils::Json::JsonView jsonValue);
    AWS_SIGNER_API BadRequestException& operator=(Aws::Utils::Json::JsonView jsonValue);
