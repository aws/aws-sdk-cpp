...
class HashAlgorithmOptions {
 public:
  ...
  inline HashAlgorithmOptions& AddAllowedValues(HashAlgorithm value) {
    m_allowedValuesHasBeenSet = true;
  ...
  inline void SetDefaultValue(HashAlgorithm value) {
    m_defaultValueHasBeenSet = true;
    m_defaultValue = value;
  }
  inline HashAlgorithmOptions& WithDefaultValue(HashAlgorithm value) {
