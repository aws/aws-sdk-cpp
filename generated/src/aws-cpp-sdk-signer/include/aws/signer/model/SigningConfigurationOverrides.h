...
class SigningConfigurationOverrides {
 public:
  ...
  inline SigningConfigurationOverrides& WithEncryptionAlgorithm(EncryptionAlgorithm value) {
  ...
  inline SigningConfigurationOverrides& WithHashAlgorithm(HashAlgorithm value) {
