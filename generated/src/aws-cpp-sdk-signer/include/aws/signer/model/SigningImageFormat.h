...
class SigningImageFormat {
 public:
  ...
  void SetSupportedFormats(SupportedFormatsT&& value) {
    ...
    m_supportedFormats = std::forward<SupportedFormatsT>(value);
  }
  template <typename SupportedFormatsT = Aws::Vector<ImageFormat>>
  SigningImageFormat& WithSupportedFormats(SupportedFormatsT&& value) {
    SetSupportedFormats(std::forward<SupportedFormatsT>(value));
    return *this;
  }
  inline SigningImageFormat& AddSupportedFormats(ImageFormat value) {
    m_supportedFormatsHasBeenSet = true;
    m_supportedFormats.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultFormat(ImageFormat value) {
    m_defaultFormatHasBeenSet = true;
    m_defaultFormat = value;
  }
  inline SigningImageFormat& WithDefaultFormat(ImageFormat value) {
