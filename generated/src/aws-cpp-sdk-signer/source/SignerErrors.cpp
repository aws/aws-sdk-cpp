...
namespace signer {
template <>
AWS_SIGNER_API ConflictException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API ThrottlingException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API NotFoundException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::NOT_FOUND);
  return NotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API ResourceNotFoundException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API ValidationException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API AccessDeniedException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::ACCESS_DENIED);
  return AccessDeniedException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API TooManyRequestsException SignerError::GetModeledError() {
  assert(this->GetErrorType() == SignerErrors::TOO_MANY_REQUESTS);
  return TooManyRequestsException(this->GetJsonPayload().View());
}

template <>
AWS_SIGNER_API ServiceLimitExceededException SignerError::GetModeledError() {
...
template <>
AWS_SIGNER_API InternalServiceErrorException SignerError::GetModeledError() {
...
template <>
AWS_SIGNER_API BadRequestException SignerError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SignerErrors::CONFLICT), RetryableType::NOT_RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SignerErrors::INTERNAL_SERVICE_ERROR), RetryableType::RETRYABLE);
  } else if (hashCode == BAD_REQUEST_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(SignerErrors::BAD_REQUEST), RetryableType::NOT_RETRYABLE);
  }
