...
namespace signer
{
const size_t SignerEndpointRules::RulesBlobStrLen = 3412;
const size_t SignerEndpointRules::RulesBlobSize = 3413;
...
':','"','h','t','t','p','s',':','/','/','s','i','g','n','e','r','-','f','i','p','s','.','{','R','e',
...
's',':','/','/','s','i','g','n','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
