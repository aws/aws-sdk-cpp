...
ListSizeConstraintSetsResult::ListSizeConstraintSetsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListSizeConstraintSetsResult& ListSizeConstraintSetsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SizeConstraintSets")) {
    ...
    for (unsigned sizeConstraintSetsIndex = 0; sizeConstraintSetsIndex < sizeConstraintSetsJsonList.GetLength();
         ++sizeConstraintSetsIndex) {
