...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API TagInfoForResource() = default;
    AWS_WAFREGIONAL_API TagInfoForResource(Aws::Utils::Json::JsonView jsonValue);
    AWS_WAFREGIONAL_API TagInfoForResource& operator=(Aws::Utils::Json::JsonView jsonValue);
