...
class ListResourcesForWebACLResult {
 public:
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  ListResourcesForWebACLResult& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  ListResourcesForWebACLResult& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListResourcesForWebACLResult& WithRequestId(RequestIdT&& value) {
