...
class ByteMatchTuple {
 public:
  ...
  void SetTargetString(TargetStringT&& value) {
    ...
    m_targetString = std::forward<TargetStringT>(value);
  }
  template <typename TargetStringT = Aws::Utils::ByteBuffer>
  ByteMatchTuple& WithTargetString(TargetStringT&& value) {
    SetTargetString(std::forward<TargetStringT>(value));
    return *this;
  }
  ///@}
  ...
  inline ByteMatchTuple& WithTextTransformation(TextTransformation value) {
  ...
  inline void SetPositionalConstraint(PositionalConstraint value) {
    m_positionalConstraintHasBeenSet = true;
    m_positionalConstraint = value;
  }
  inline ByteMatchTuple& WithPositionalConstraint(PositionalConstraint value) {
    SetPositionalConstraint(value);
    return *this;
  }
  ///@}
 private:
