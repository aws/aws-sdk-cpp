...
class SizeConstraintSetUpdate {
 public:
  ...
  inline SizeConstraintSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetSizeConstraint(SizeConstraintT&& value) {
    ...
    m_sizeConstraint = std::forward<SizeConstraintT>(value);
  }
  template <typename SizeConstraintT = SizeConstraint>
  SizeConstraintSetUpdate& WithSizeConstraint(SizeConstraintT&& value) {
    SetSizeConstraint(std::forward<SizeConstraintT>(value));
    return *this;
  }
  ///@}
 private:
