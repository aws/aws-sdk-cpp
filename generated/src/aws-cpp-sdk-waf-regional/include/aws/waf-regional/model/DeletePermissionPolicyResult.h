...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API DeletePermissionPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePermissionPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
