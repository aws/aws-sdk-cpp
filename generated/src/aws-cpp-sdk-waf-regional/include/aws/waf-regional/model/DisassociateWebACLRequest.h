...
namespace Model
{
  ...
  /**
   */
  class DisassociateWebACLRequest : public WAFRegionalRequest
  {
  public:
    AWS_WAFREGIONAL_API DisassociateWebACLRequest() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    DisassociateWebACLRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
