...
class ListActivatedRulesInRuleGroupRequest : public WAFRegionalRequest {
 public:
  ...
  template <typename RuleGroupIdT = Aws::String>
  ListActivatedRulesInRuleGroupRequest& WithRuleGroupId(RuleGroupIdT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  ListActivatedRulesInRuleGroupRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListActivatedRulesInRuleGroupRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
