...
class UpdateSizeConstraintSetRequest : public WAFRegionalRequest {
 public:
  ...
  void SetSizeConstraintSetId(SizeConstraintSetIdT&& value) {
    ...
    m_sizeConstraintSetId = std::forward<SizeConstraintSetIdT>(value);
  }
  template <typename SizeConstraintSetIdT = Aws::String>
  UpdateSizeConstraintSetRequest& WithSizeConstraintSetId(SizeConstraintSetIdT&& value) {
    SetSizeConstraintSetId(std::forward<SizeConstraintSetIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ChangeTokenT = Aws::String>
  UpdateSizeConstraintSetRequest& WithChangeToken(ChangeTokenT&& value) {
  ...
  template <typename UpdatesT = Aws::Vector<SizeConstraintSetUpdate>>
  UpdateSizeConstraintSetRequest& WithUpdates(UpdatesT&& value) {
    SetUpdates(std::forward<UpdatesT>(value));
    return *this;
  }
  template <typename UpdatesT = SizeConstraintSetUpdate>
  UpdateSizeConstraintSetRequest& AddUpdates(UpdatesT&& value) {
    m_updatesHasBeenSet = true;
