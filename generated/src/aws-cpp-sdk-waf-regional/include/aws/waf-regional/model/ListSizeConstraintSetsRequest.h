...
namespace Model
{
  ...
  /**
   */
  class ListSizeConstraintSetsRequest : public WAFRegionalRequest
  {
  public:
    AWS_WAFREGIONAL_API ListSizeConstraintSetsRequest() = default;
    ...
    template<typename NextMarkerT = Aws::String>
    ListSizeConstraintSetsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
