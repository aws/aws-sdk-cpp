 ...
 * web request that you want AWS WAF to inspect for snippets of malicious SQL code
 * and, if you want AWS WAF to inspect a header, the name of the
 * header.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/SqlInjectionMatchTuple">AWS
 * API Reference</a></p>
 */
class SqlInjectionMatchTuple {
 public:
  ...
  inline void SetTextTransformation(TextTransformation value) {
    m_textTransformationHasBeenSet = true;
    m_textTransformation = value;
  }
  inline SqlInjectionMatchTuple& WithTextTransformation(TextTransformation value) {
