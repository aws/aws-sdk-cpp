...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API DisassociateWebACLResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateWebACLResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
