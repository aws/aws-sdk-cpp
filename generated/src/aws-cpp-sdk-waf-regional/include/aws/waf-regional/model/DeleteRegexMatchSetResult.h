...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API DeleteRegexMatchSetResult() = default;
    ...
    template<typename ChangeTokenT = Aws::String>
    DeleteRegexMatchSetResult& WithChangeToken(ChangeTokenT&& value) { SetChangeToken(std::forward<ChangeTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRegexMatchSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
