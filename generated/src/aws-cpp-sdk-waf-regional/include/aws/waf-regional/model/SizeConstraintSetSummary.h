...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API SizeConstraintSetSummary() = default;
    AWS_WAFREGIONAL_API SizeConstraintSetSummary(Aws::Utils::Json::JsonView jsonValue);
    AWS_WAFREGIONAL_API SizeConstraintSetSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
