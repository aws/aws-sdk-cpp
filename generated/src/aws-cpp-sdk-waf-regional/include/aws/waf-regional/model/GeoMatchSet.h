...
class GeoMatchSet {
 public:
  ...
  void SetGeoMatchConstraints(GeoMatchConstraintsT&& value) {
    ...
    m_geoMatchConstraints = std::forward<GeoMatchConstraintsT>(value);
  }
  template <typename GeoMatchConstraintsT = Aws::Vector<GeoMatchConstraint>>
  GeoMatchSet& WithGeoMatchConstraints(GeoMatchConstraintsT&& value) {
    SetGeoMatchConstraints(std::forward<GeoMatchConstraintsT>(value));
    return *this;
  }
  template <typename GeoMatchConstraintsT = GeoMatchConstraint>
  GeoMatchSet& AddGeoMatchConstraints(GeoMatchConstraintsT&& value) {
    m_geoMatchConstraintsHasBeenSet = true;
    m_geoMatchConstraints.emplace_back(std::forward<GeoMatchConstraintsT>(value));
    return *this;
  }
  ///@}
 private:
