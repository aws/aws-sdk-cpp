...
namespace Model
{
  ...
  {
  public:
    AWS_WAFREGIONAL_API UpdateRegexPatternSetResult() = default;
    ...
    template<typename ChangeTokenT = Aws::String>
    UpdateRegexPatternSetResult& WithChangeToken(ChangeTokenT&& value) { SetChangeToken(std::forward<ChangeTokenT>(value)); return *this;}
    ///@}
