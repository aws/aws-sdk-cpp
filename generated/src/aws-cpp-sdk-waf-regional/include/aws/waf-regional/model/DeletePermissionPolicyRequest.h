...
/**
 */
class DeletePermissionPolicyRequest : public WAFRegionalRequest {
 public:
  AWS_WAFREGIONAL_API DeletePermissionPolicyRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  DeletePermissionPolicyRequest& WithResourceArn(ResourceArnT&& value) {
