...
class GeoMatchSetUpdate {
 public:
  ...
  inline GeoMatchSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetGeoMatchConstraint(GeoMatchConstraintT&& value) {
    ...
    m_geoMatchConstraint = std::forward<GeoMatchConstraintT>(value);
  }
  template <typename GeoMatchConstraintT = GeoMatchConstraint>
  GeoMatchSetUpdate& WithGeoMatchConstraint(GeoMatchConstraintT&& value) {
    SetGeoMatchConstraint(std::forward<GeoMatchConstraintT>(value));
    return *this;
  }
  ///@}
 private:
