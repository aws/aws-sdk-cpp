...
class ListByteMatchSetsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListByteMatchSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetByteMatchSets(ByteMatchSetsT&& value) {
    m_byteMatchSetsHasBeenSet = true;
    m_byteMatchSets = std::forward<ByteMatchSetsT>(value);
  }
  template <typename ByteMatchSetsT = Aws::Vector<ByteMatchSetSummary>>
  ListByteMatchSetsResult& WithByteMatchSets(ByteMatchSetsT&& value) {
    SetByteMatchSets(std::forward<ByteMatchSetsT>(value));
    return *this;
  }
  template <typename ByteMatchSetsT = ByteMatchSetSummary>
  ListByteMatchSetsResult& AddByteMatchSets(ByteMatchSetsT&& value) {
    m_byteMatchSetsHasBeenSet = true;
    m_byteMatchSets.emplace_back(std::forward<ByteMatchSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListByteMatchSetsResult& WithRequestId(RequestIdT&& value) {
