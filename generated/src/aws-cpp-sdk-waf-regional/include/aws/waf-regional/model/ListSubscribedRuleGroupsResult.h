...
class ListSubscribedRuleGroupsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListSubscribedRuleGroupsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RuleGroupsT = Aws::Vector<SubscribedRuleGroupSummary>>
  ListSubscribedRuleGroupsResult& WithRuleGroups(RuleGroupsT&& value) {
    SetRuleGroups(std::forward<RuleGroupsT>(value));
    return *this;
  }
  template <typename RuleGroupsT = SubscribedRuleGroupSummary>
  ListSubscribedRuleGroupsResult& AddRuleGroups(RuleGroupsT&& value) {
    m_ruleGroupsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscribedRuleGroupsResult& WithRequestId(RequestIdT&& value) {
