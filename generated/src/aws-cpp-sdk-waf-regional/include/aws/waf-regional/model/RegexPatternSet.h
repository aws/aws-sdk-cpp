...
class RegexPatternSet {
 public:
  ...
  void SetRegexPatternStrings(RegexPatternStringsT&& value) {
    ...
    m_regexPatternStrings = std::forward<RegexPatternStringsT>(value);
  }
  template <typename RegexPatternStringsT = Aws::Vector<Aws::String>>
  RegexPatternSet& WithRegexPatternStrings(RegexPatternStringsT&& value) {
    SetRegexPatternStrings(std::forward<RegexPatternStringsT>(value));
    return *this;
  }
  template <typename RegexPatternStringsT = Aws::String>
  RegexPatternSet& AddRegexPatternStrings(RegexPatternStringsT&& value) {
    m_regexPatternStringsHasBeenSet = true;
    m_regexPatternStrings.emplace_back(std::forward<RegexPatternStringsT>(value));
    return *this;
  }
  ///@}
 private:
