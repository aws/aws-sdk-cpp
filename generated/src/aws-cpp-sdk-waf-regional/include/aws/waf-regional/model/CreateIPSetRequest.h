...
namespace Model
{
  ...
  /**
   */
  class CreateIPSetRequest : public WAFRegionalRequest
  {
  public:
    AWS_WAFREGIONAL_API CreateIPSetRequest() = default;
    ...
    template<typename ChangeTokenT = Aws::String>
    CreateIPSetRequest& WithChangeToken(ChangeTokenT&& value) { SetChangeToken(std::forward<ChangeTokenT>(value)); return *this;}
    ///@}
  private:
