...
namespace Model
{
  ...
  /**
   */
  class ListRuleGroupsRequest : public WAFRegionalRequest
  {
  public:
    AWS_WAFREGIONAL_API ListRuleGroupsRequest() = default;
    ...
    template<typename NextMarkerT = Aws::String>
    ListRuleGroupsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
