...
/**
 */
class GetChangeTokenStatusRequest : public WAFRegionalRequest {
 public:
  AWS_WAFREGIONAL_API GetChangeTokenStatusRequest() = default;
  ...
  template <typename ChangeTokenT = Aws::String>
  GetChangeTokenStatusRequest& WithChangeToken(ChangeTokenT&& value) {
