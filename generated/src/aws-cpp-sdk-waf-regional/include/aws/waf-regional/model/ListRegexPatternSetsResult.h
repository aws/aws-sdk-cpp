...
class ListRegexPatternSetsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListRegexPatternSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetRegexPatternSets(RegexPatternSetsT&& value) {
    m_regexPatternSetsHasBeenSet = true;
    m_regexPatternSets = std::forward<RegexPatternSetsT>(value);
  }
  template <typename RegexPatternSetsT = Aws::Vector<RegexPatternSetSummary>>
  ListRegexPatternSetsResult& WithRegexPatternSets(RegexPatternSetsT&& value) {
    SetRegexPatternSets(std::forward<RegexPatternSetsT>(value));
    return *this;
  }
  template <typename RegexPatternSetsT = RegexPatternSetSummary>
  ListRegexPatternSetsResult& AddRegexPatternSets(RegexPatternSetsT&& value) {
    m_regexPatternSetsHasBeenSet = true;
    m_regexPatternSets.emplace_back(std::forward<RegexPatternSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListRegexPatternSetsResult& WithRequestId(RequestIdT&& value) {
