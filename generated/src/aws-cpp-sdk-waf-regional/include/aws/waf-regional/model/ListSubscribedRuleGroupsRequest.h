...
class ListSubscribedRuleGroupsRequest : public WAFRegionalRequest {
 public:
  AWS_WAFREGIONAL_API ListSubscribedRuleGroupsRequest() = default;
  ...
  template <typename NextMarkerT = Aws::String>
  ListSubscribedRuleGroupsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListSubscribedRuleGroupsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
