...
/**
 */
class ListByteMatchSetsRequest : public WAFRegionalRequest {
 public:
  AWS_WAFREGIONAL_API ListByteMatchSetsRequest() = default;
  ...
  template <typename NextMarkerT = Aws::String>
  ListByteMatchSetsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListByteMatchSetsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
