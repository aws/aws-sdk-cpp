...
class XssMatchSetUpdate {
 public:
  ...
  inline XssMatchSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetXssMatchTuple(XssMatchTupleT&& value) {
    ...
    m_xssMatchTuple = std::forward<XssMatchTupleT>(value);
  }
  template <typename XssMatchTupleT = XssMatchTuple>
  XssMatchSetUpdate& WithXssMatchTuple(XssMatchTupleT&& value) {
    SetXssMatchTuple(std::forward<XssMatchTupleT>(value));
    return *this;
  }
  ///@}
 private:
