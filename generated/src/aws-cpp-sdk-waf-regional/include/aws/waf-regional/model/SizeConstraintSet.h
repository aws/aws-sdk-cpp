...
class SizeConstraintSet {
 public:
  AWS_WAFREGIONAL_API SizeConstraintSet() = default;
  AWS_WAFREGIONAL_API SizeConstraintSet(Aws::Utils::Json::JsonView jsonValue);
  AWS_WAFREGIONAL_API SizeConstraintSet& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  void SetSizeConstraints(SizeConstraintsT&& value) {
    ...
    m_sizeConstraints = std::forward<SizeConstraintsT>(value);
  }
  template <typename SizeConstraintsT = Aws::Vector<SizeConstraint>>
  SizeConstraintSet& WithSizeConstraints(SizeConstraintsT&& value) {
    SetSizeConstraints(std::forward<SizeConstraintsT>(value));
    return *this;
  }
  template <typename SizeConstraintsT = SizeConstraint>
  SizeConstraintSet& AddSizeConstraints(SizeConstraintsT&& value) {
    m_sizeConstraintsHasBeenSet = true;
    m_sizeConstraints.emplace_back(std::forward<SizeConstraintsT>(value));
    return *this;
  }
  ///@}
 private:
