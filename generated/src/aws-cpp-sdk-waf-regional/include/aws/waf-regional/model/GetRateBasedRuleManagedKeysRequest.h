...
class GetRateBasedRuleManagedKeysRequest : public WAFRegionalRequest {
 public:
  AWS_WAFREGIONAL_API GetRateBasedRuleManagedKeysRequest() = default;
  ...
  template <typename RuleIdT = Aws::String>
  GetRateBasedRuleManagedKeysRequest& WithRuleId(RuleIdT&& value) {
  ...
  template <typename NextMarkerT = Aws::String>
  GetRateBasedRuleManagedKeysRequest& WithNextMarker(NextMarkerT&& value) {
