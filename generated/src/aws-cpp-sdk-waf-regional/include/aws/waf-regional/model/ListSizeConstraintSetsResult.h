...
class ListSizeConstraintSetsResult {
 public:
  AWS_WAFREGIONAL_API ListSizeConstraintSetsResult() = default;
  ...
  template <typename NextMarkerT = Aws::String>
  ListSizeConstraintSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetSizeConstraintSets(SizeConstraintSetsT&& value) {
    m_sizeConstraintSetsHasBeenSet = true;
    m_sizeConstraintSets = std::forward<SizeConstraintSetsT>(value);
  }
  template <typename SizeConstraintSetsT = Aws::Vector<SizeConstraintSetSummary>>
  ListSizeConstraintSetsResult& WithSizeConstraintSets(SizeConstraintSetsT&& value) {
    SetSizeConstraintSets(std::forward<SizeConstraintSetsT>(value));
    return *this;
  }
  template <typename SizeConstraintSetsT = SizeConstraintSetSummary>
  ListSizeConstraintSetsResult& AddSizeConstraintSets(SizeConstraintSetsT&& value) {
    m_sizeConstraintSetsHasBeenSet = true;
    m_sizeConstraintSets.emplace_back(std::forward<SizeConstraintSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListSizeConstraintSetsResult& WithRequestId(RequestIdT&& value) {
