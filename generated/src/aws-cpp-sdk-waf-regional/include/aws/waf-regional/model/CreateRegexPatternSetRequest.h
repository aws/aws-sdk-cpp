...
namespace Model
{
  ...
  /**
   */
  class CreateRegexPatternSetRequest : public WAFRegionalRequest
  {
  public:
    AWS_WAFREGIONAL_API CreateRegexPatternSetRequest() = default;
    ...
    template<typename ChangeTokenT = Aws::String>
    CreateRegexPatternSetRequest& WithChangeToken(ChangeTokenT&& value) { SetChangeToken(std::forward<ChangeTokenT>(value)); return *this;}
    ///@}
  private:
