...
class CreateRateBasedRuleResult {
 public:
  ...
  template <typename RuleT = RateBasedRule>
  CreateRateBasedRuleResult& WithRule(RuleT&& value) {
  ...
  template <typename ChangeTokenT = Aws::String>
  CreateRateBasedRuleResult& WithChangeToken(ChangeTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRateBasedRuleResult& WithRequestId(RequestIdT&& value) {
