...
class DeleteSqlInjectionMatchSetResult {
 public:
  AWS_WAFREGIONAL_API DeleteSqlInjectionMatchSetResult() = default;
  ...
  template <typename ChangeTokenT = Aws::String>
  DeleteSqlInjectionMatchSetResult& WithChangeToken(ChangeTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteSqlInjectionMatchSetResult& WithRequestId(RequestIdT&& value) {
