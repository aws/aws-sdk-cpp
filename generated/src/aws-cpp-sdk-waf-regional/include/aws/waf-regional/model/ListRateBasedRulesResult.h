...
class ListRateBasedRulesResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListRateBasedRulesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RulesT = Aws::Vector<RuleSummary>>
  ListRateBasedRulesResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = RuleSummary>
  ListRateBasedRulesResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListRateBasedRulesResult& WithRequestId(RequestIdT&& value) {
