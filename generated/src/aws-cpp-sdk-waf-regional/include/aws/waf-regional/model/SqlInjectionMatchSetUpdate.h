...
class SqlInjectionMatchSetUpdate {
 public:
  ...
  inline SqlInjectionMatchSetUpdate& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetSqlInjectionMatchTuple(SqlInjectionMatchTupleT&& value) {
    ...
    m_sqlInjectionMatchTuple = std::forward<SqlInjectionMatchTupleT>(value);
  }
  template <typename SqlInjectionMatchTupleT = SqlInjectionMatchTuple>
  SqlInjectionMatchSetUpdate& WithSqlInjectionMatchTuple(SqlInjectionMatchTupleT&& value) {
    SetSqlInjectionMatchTuple(std::forward<SqlInjectionMatchTupleT>(value));
    return *this;
  }
  ///@}
 private:
