...
class AWS_WAFREGIONAL_API WAFRegionalClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WAFRegionalClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<WAFRegionalEndpointProviderBase> endpointProvider = nullptr,
      const Aws::WAFRegional::WAFRegionalClientConfiguration& clientConfiguration = Aws::WAFRegional::WAFRegionalClientConfiguration());
  ...
  Model::AssociateWebACLOutcomeCallable AssociateWebACLCallable(const AssociateWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::AssociateWebACL, request);
  }

  /**
   * An Async wrapper for AssociateWebACL that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateWebACLRequestT = Model::AssociateWebACLRequest>
  void AssociateWebACLAsync(const AssociateWebACLRequestT& request, const AssociateWebACLResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::AssociateWebACL, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateByteMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateByteMatchSetOutcomeCallable CreateByteMatchSetCallable(const CreateByteMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateByteMatchSet, request);
  }

  /**
   * An Async wrapper for CreateByteMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateByteMatchSetRequestT = Model::CreateByteMatchSetRequest>
  void CreateByteMatchSetAsync(const CreateByteMatchSetRequestT& request, const CreateByteMatchSetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateByteMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateGeoMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateGeoMatchSetOutcomeCallable CreateGeoMatchSetCallable(const CreateGeoMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateGeoMatchSet, request);
  }

  /**
   * An Async wrapper for CreateGeoMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGeoMatchSetRequestT = Model::CreateGeoMatchSetRequest>
  void CreateGeoMatchSetAsync(const CreateGeoMatchSetRequestT& request, const CreateGeoMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateGeoMatchSet, request, handler, context);
  }
  ...
  Model::CreateIPSetOutcomeCallable CreateIPSetCallable(const CreateIPSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateIPSet, request);
  }

  /**
   * An Async wrapper for CreateIPSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateIPSetRequestT = Model::CreateIPSetRequest>
  void CreateIPSetAsync(const CreateIPSetRequestT& request, const CreateIPSetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateIPSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateRateBasedRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateRateBasedRuleOutcomeCallable CreateRateBasedRuleCallable(const CreateRateBasedRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateRateBasedRule, request);
  }

  /**
   * An Async wrapper for CreateRateBasedRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateRateBasedRuleRequestT = Model::CreateRateBasedRuleRequest>
  void CreateRateBasedRuleAsync(const CreateRateBasedRuleRequestT& request, const CreateRateBasedRuleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateRateBasedRule, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateRegexMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateRegexMatchSetOutcomeCallable CreateRegexMatchSetCallable(const CreateRegexMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateRegexMatchSet, request);
  }

  /**
   * An Async wrapper for CreateRegexMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateRegexMatchSetRequestT = Model::CreateRegexMatchSetRequest>
  void CreateRegexMatchSetAsync(const CreateRegexMatchSetRequestT& request, const CreateRegexMatchSetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateRegexMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateRegexPatternSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateRegexPatternSetOutcomeCallable CreateRegexPatternSetCallable(const CreateRegexPatternSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateRegexPatternSet, request);
  }

  /**
   * An Async wrapper for CreateRegexPatternSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRegexPatternSetRequestT = Model::CreateRegexPatternSetRequest>
  void CreateRegexPatternSetAsync(const CreateRegexPatternSetRequestT& request, const CreateRegexPatternSetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateRegexPatternSet, request, handler, context);
  }
  ...
  Model::CreateRuleOutcomeCallable CreateRuleCallable(const CreateRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateRule, request);
  }
  ...
  void CreateRuleAsync(const CreateRuleRequestT& request, const CreateRuleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateRule, request, handler, context);
  }
  ...
  Model::CreateRuleGroupOutcomeCallable CreateRuleGroupCallable(const CreateRuleGroupRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateRuleGroup, request);
  }

  /**
   * An Async wrapper for CreateRuleGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateRuleGroupRequestT = Model::CreateRuleGroupRequest>
  void CreateRuleGroupAsync(const CreateRuleGroupRequestT& request, const CreateRuleGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateRuleGroup, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateSizeConstraintSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateSizeConstraintSetOutcomeCallable CreateSizeConstraintSetCallable(const CreateSizeConstraintSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateSizeConstraintSet, request);
  }

  /**
   * An Async wrapper for CreateSizeConstraintSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSizeConstraintSetRequestT = Model::CreateSizeConstraintSetRequest>
  void CreateSizeConstraintSetAsync(const CreateSizeConstraintSetRequestT& request,
                                    const CreateSizeConstraintSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateSizeConstraintSet, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateSqlInjectionMatchSetOutcome CreateSqlInjectionMatchSet(
      const Model::CreateSqlInjectionMatchSetRequest& request) const;

  /**
   * A Callable wrapper for CreateSqlInjectionMatchSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateSqlInjectionMatchSetRequestT = Model::CreateSqlInjectionMatchSetRequest>
  Model::CreateSqlInjectionMatchSetOutcomeCallable CreateSqlInjectionMatchSetCallable(
      const CreateSqlInjectionMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateSqlInjectionMatchSet, request);
  }

  /**
   * An Async wrapper for CreateSqlInjectionMatchSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSqlInjectionMatchSetRequestT = Model::CreateSqlInjectionMatchSetRequest>
  void CreateSqlInjectionMatchSetAsync(const CreateSqlInjectionMatchSetRequestT& request,
                                       const CreateSqlInjectionMatchSetResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateSqlInjectionMatchSet, request, handler, context);
  }
  ...
  Model::CreateWebACLOutcomeCallable CreateWebACLCallable(const CreateWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateWebACL, request);
  }

  /**
   * An Async wrapper for CreateWebACL that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWebACLRequestT = Model::CreateWebACLRequest>
  void CreateWebACLAsync(const CreateWebACLRequestT& request, const CreateWebACLResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateWebACL, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateWebACLMigrationStackOutcome CreateWebACLMigrationStack(
      const Model::CreateWebACLMigrationStackRequest& request) const;

  /**
   * A Callable wrapper for CreateWebACLMigrationStack that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateWebACLMigrationStackRequestT = Model::CreateWebACLMigrationStackRequest>
  Model::CreateWebACLMigrationStackOutcomeCallable CreateWebACLMigrationStackCallable(
      const CreateWebACLMigrationStackRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateWebACLMigrationStack, request);
  }

  /**
   * An Async wrapper for CreateWebACLMigrationStack that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWebACLMigrationStackRequestT = Model::CreateWebACLMigrationStackRequest>
  void CreateWebACLMigrationStackAsync(const CreateWebACLMigrationStackRequestT& request,
                                       const CreateWebACLMigrationStackResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateWebACLMigrationStack, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for CreateXssMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CreateXssMatchSetOutcomeCallable CreateXssMatchSetCallable(const CreateXssMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::CreateXssMatchSet, request);
  }

  /**
   * An Async wrapper for CreateXssMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateXssMatchSetRequestT = Model::CreateXssMatchSetRequest>
  void CreateXssMatchSetAsync(const CreateXssMatchSetRequestT& request, const CreateXssMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::CreateXssMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteByteMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteByteMatchSetOutcomeCallable DeleteByteMatchSetCallable(const DeleteByteMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteByteMatchSet, request);
  }

  /**
   * An Async wrapper for DeleteByteMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteByteMatchSetRequestT = Model::DeleteByteMatchSetRequest>
  void DeleteByteMatchSetAsync(const DeleteByteMatchSetRequestT& request, const DeleteByteMatchSetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteByteMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteGeoMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteGeoMatchSetOutcomeCallable DeleteGeoMatchSetCallable(const DeleteGeoMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteGeoMatchSet, request);
  }

  /**
   * An Async wrapper for DeleteGeoMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteGeoMatchSetRequestT = Model::DeleteGeoMatchSetRequest>
  void DeleteGeoMatchSetAsync(const DeleteGeoMatchSetRequestT& request, const DeleteGeoMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteGeoMatchSet, request, handler, context);
  }
  ...
  Model::DeleteIPSetOutcomeCallable DeleteIPSetCallable(const DeleteIPSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteIPSet, request);
  }

  /**
   * An Async wrapper for DeleteIPSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteIPSetRequestT = Model::DeleteIPSetRequest>
  void DeleteIPSetAsync(const DeleteIPSetRequestT& request, const DeleteIPSetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteIPSet, request, handler, context);
  }
  ...
  Model::DeleteLoggingConfigurationOutcomeCallable DeleteLoggingConfigurationCallable(
    ...
    return SubmitCallable(&WAFRegionalClient::DeleteLoggingConfiguration, request);
  }
  ...
  void DeleteLoggingConfigurationAsync(const DeleteLoggingConfigurationRequestT& request,
                                       ...
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteLoggingConfiguration, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeletePermissionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeletePermissionPolicyOutcomeCallable DeletePermissionPolicyCallable(const DeletePermissionPolicyRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeletePermissionPolicy, request);
  }

  /**
   * An Async wrapper for DeletePermissionPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePermissionPolicyRequestT = Model::DeletePermissionPolicyRequest>
  void DeletePermissionPolicyAsync(const DeletePermissionPolicyRequestT& request,
                                   const DeletePermissionPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeletePermissionPolicy, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteRateBasedRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteRateBasedRuleOutcomeCallable DeleteRateBasedRuleCallable(const DeleteRateBasedRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteRateBasedRule, request);
  }

  /**
   * An Async wrapper for DeleteRateBasedRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRateBasedRuleRequestT = Model::DeleteRateBasedRuleRequest>
  void DeleteRateBasedRuleAsync(const DeleteRateBasedRuleRequestT& request, const DeleteRateBasedRuleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteRateBasedRule, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteRegexMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteRegexMatchSetOutcomeCallable DeleteRegexMatchSetCallable(const DeleteRegexMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteRegexMatchSet, request);
  }

  /**
   * An Async wrapper for DeleteRegexMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteRegexMatchSetRequestT = Model::DeleteRegexMatchSetRequest>
  void DeleteRegexMatchSetAsync(const DeleteRegexMatchSetRequestT& request, const DeleteRegexMatchSetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteRegexMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteRegexPatternSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteRegexPatternSetOutcomeCallable DeleteRegexPatternSetCallable(const DeleteRegexPatternSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteRegexPatternSet, request);
  }

  /**
   * An Async wrapper for DeleteRegexPatternSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRegexPatternSetRequestT = Model::DeleteRegexPatternSetRequest>
  void DeleteRegexPatternSetAsync(const DeleteRegexPatternSetRequestT& request, const DeleteRegexPatternSetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteRegexPatternSet, request, handler, context);
  }
  ...
  Model::DeleteRuleOutcomeCallable DeleteRuleCallable(const DeleteRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteRule, request);
  }
  ...
  void DeleteRuleAsync(const DeleteRuleRequestT& request, const DeleteRuleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteRule, request, handler, context);
  }
  ...
  Model::DeleteRuleGroupOutcomeCallable DeleteRuleGroupCallable(const DeleteRuleGroupRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteRuleGroup, request);
  }

  /**
   * An Async wrapper for DeleteRuleGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRuleGroupRequestT = Model::DeleteRuleGroupRequest>
  void DeleteRuleGroupAsync(const DeleteRuleGroupRequestT& request, const DeleteRuleGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteRuleGroup, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteSizeConstraintSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteSizeConstraintSetOutcomeCallable DeleteSizeConstraintSetCallable(const DeleteSizeConstraintSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteSizeConstraintSet, request);
  }

  /**
   * An Async wrapper for DeleteSizeConstraintSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSizeConstraintSetRequestT = Model::DeleteSizeConstraintSetRequest>
  void DeleteSizeConstraintSetAsync(const DeleteSizeConstraintSetRequestT& request,
                                    const DeleteSizeConstraintSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteSizeConstraintSet, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSqlInjectionMatchSetOutcome DeleteSqlInjectionMatchSet(
      const Model::DeleteSqlInjectionMatchSetRequest& request) const;

  /**
   * A Callable wrapper for DeleteSqlInjectionMatchSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteSqlInjectionMatchSetRequestT = Model::DeleteSqlInjectionMatchSetRequest>
  Model::DeleteSqlInjectionMatchSetOutcomeCallable DeleteSqlInjectionMatchSetCallable(
      const DeleteSqlInjectionMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteSqlInjectionMatchSet, request);
  }

  /**
   * An Async wrapper for DeleteSqlInjectionMatchSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSqlInjectionMatchSetRequestT = Model::DeleteSqlInjectionMatchSetRequest>
  void DeleteSqlInjectionMatchSetAsync(const DeleteSqlInjectionMatchSetRequestT& request,
                                       const DeleteSqlInjectionMatchSetResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteSqlInjectionMatchSet, request, handler, context);
  }
  ...
  Model::DeleteWebACLOutcomeCallable DeleteWebACLCallable(const DeleteWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteWebACL, request);
  }

  /**
   * An Async wrapper for DeleteWebACL that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWebACLRequestT = Model::DeleteWebACLRequest>
  void DeleteWebACLAsync(const DeleteWebACLRequestT& request, const DeleteWebACLResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteWebACL, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DeleteXssMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DeleteXssMatchSetOutcomeCallable DeleteXssMatchSetCallable(const DeleteXssMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DeleteXssMatchSet, request);
  }

  /**
   * An Async wrapper for DeleteXssMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteXssMatchSetRequestT = Model::DeleteXssMatchSetRequest>
  void DeleteXssMatchSetAsync(const DeleteXssMatchSetRequestT& request, const DeleteXssMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DeleteXssMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DisassociateWebACL that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::DisassociateWebACLOutcomeCallable DisassociateWebACLCallable(const DisassociateWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::DisassociateWebACL, request);
  }

  /**
   * An Async wrapper for DisassociateWebACL that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateWebACLRequestT = Model::DisassociateWebACLRequest>
  void DisassociateWebACLAsync(const DisassociateWebACLRequestT& request, const DisassociateWebACLResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::DisassociateWebACL, request, handler, context);
  }
  ...
  Model::GetByteMatchSetOutcomeCallable GetByteMatchSetCallable(const GetByteMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetByteMatchSet, request);
  }

  /**
   * An Async wrapper for GetByteMatchSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetByteMatchSetRequestT = Model::GetByteMatchSetRequest>
  void GetByteMatchSetAsync(const GetByteMatchSetRequestT& request, const GetByteMatchSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetByteMatchSet, request, handler, context);
  }
  ...
  Model::GetChangeTokenOutcomeCallable GetChangeTokenCallable(const GetChangeTokenRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::GetChangeToken, request);
  }

  /**
   * An Async wrapper for GetChangeToken that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetChangeTokenRequestT = Model::GetChangeTokenRequest>
  void GetChangeTokenAsync(const GetChangeTokenResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetChangeTokenRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::GetChangeToken, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetChangeTokenStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetChangeTokenStatusOutcomeCallable GetChangeTokenStatusCallable(const GetChangeTokenStatusRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetChangeTokenStatus, request);
  }

  /**
   * An Async wrapper for GetChangeTokenStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChangeTokenStatusRequestT = Model::GetChangeTokenStatusRequest>
  void GetChangeTokenStatusAsync(const GetChangeTokenStatusRequestT& request, const GetChangeTokenStatusResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetChangeTokenStatus, request, handler, context);
  }
  ...
  Model::GetGeoMatchSetOutcomeCallable GetGeoMatchSetCallable(const GetGeoMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetGeoMatchSet, request);
  }

  /**
   * An Async wrapper for GetGeoMatchSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGeoMatchSetRequestT = Model::GetGeoMatchSetRequest>
  void GetGeoMatchSetAsync(const GetGeoMatchSetRequestT& request, const GetGeoMatchSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetGeoMatchSet, request, handler, context);
  }
  ...
  Model::GetIPSetOutcomeCallable GetIPSetCallable(const GetIPSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetIPSet, request);
  }

  /**
   * An Async wrapper for GetIPSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetIPSetRequestT = Model::GetIPSetRequest>
  void GetIPSetAsync(const GetIPSetRequestT& request, const GetIPSetResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetIPSet, request, handler, context);
  }
  ...
  Model::GetLoggingConfigurationOutcomeCallable GetLoggingConfigurationCallable(const GetLoggingConfigurationRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetLoggingConfiguration, request);
  }
  ...
  void GetLoggingConfigurationAsync(const GetLoggingConfigurationRequestT& request,
                                    ...
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetLoggingConfiguration, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetPermissionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetPermissionPolicyOutcomeCallable GetPermissionPolicyCallable(const GetPermissionPolicyRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetPermissionPolicy, request);
  }

  /**
   * An Async wrapper for GetPermissionPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPermissionPolicyRequestT = Model::GetPermissionPolicyRequest>
  void GetPermissionPolicyAsync(const GetPermissionPolicyRequestT& request, const GetPermissionPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetPermissionPolicy, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetRateBasedRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetRateBasedRuleOutcomeCallable GetRateBasedRuleCallable(const GetRateBasedRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRateBasedRule, request);
  }

  /**
   * An Async wrapper for GetRateBasedRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRateBasedRuleRequestT = Model::GetRateBasedRuleRequest>
  void GetRateBasedRuleAsync(const GetRateBasedRuleRequestT& request, const GetRateBasedRuleResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRateBasedRule, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRateBasedRuleManagedKeysOutcome GetRateBasedRuleManagedKeys(
      const Model::GetRateBasedRuleManagedKeysRequest& request) const;

  /**
   * A Callable wrapper for GetRateBasedRuleManagedKeys that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRateBasedRuleManagedKeysRequestT = Model::GetRateBasedRuleManagedKeysRequest>
  Model::GetRateBasedRuleManagedKeysOutcomeCallable GetRateBasedRuleManagedKeysCallable(
      const GetRateBasedRuleManagedKeysRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRateBasedRuleManagedKeys, request);
  }

  /**
   * An Async wrapper for GetRateBasedRuleManagedKeys that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRateBasedRuleManagedKeysRequestT = Model::GetRateBasedRuleManagedKeysRequest>
  void GetRateBasedRuleManagedKeysAsync(const GetRateBasedRuleManagedKeysRequestT& request,
                                        const GetRateBasedRuleManagedKeysResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRateBasedRuleManagedKeys, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetRegexMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetRegexMatchSetOutcomeCallable GetRegexMatchSetCallable(const GetRegexMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRegexMatchSet, request);
  }

  /**
   * An Async wrapper for GetRegexMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRegexMatchSetRequestT = Model::GetRegexMatchSetRequest>
  void GetRegexMatchSetAsync(const GetRegexMatchSetRequestT& request, const GetRegexMatchSetResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRegexMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetRegexPatternSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetRegexPatternSetOutcomeCallable GetRegexPatternSetCallable(const GetRegexPatternSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRegexPatternSet, request);
  }

  /**
   * An Async wrapper for GetRegexPatternSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRegexPatternSetRequestT = Model::GetRegexPatternSetRequest>
  void GetRegexPatternSetAsync(const GetRegexPatternSetRequestT& request, const GetRegexPatternSetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRegexPatternSet, request, handler, context);
  }
  ...
  Model::GetRuleOutcomeCallable GetRuleCallable(const GetRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRule, request);
  }
  ...
  void GetRuleAsync(const GetRuleRequestT& request, const GetRuleResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRule, request, handler, context);
  }
  ...
  Model::GetRuleGroupOutcomeCallable GetRuleGroupCallable(const GetRuleGroupRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetRuleGroup, request);
  }

  /**
   * An Async wrapper for GetRuleGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRuleGroupRequestT = Model::GetRuleGroupRequest>
  void GetRuleGroupAsync(const GetRuleGroupRequestT& request, const GetRuleGroupResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetRuleGroup, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetSampledRequests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetSampledRequestsOutcomeCallable GetSampledRequestsCallable(const GetSampledRequestsRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetSampledRequests, request);
  }

  /**
   * An Async wrapper for GetSampledRequests that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSampledRequestsRequestT = Model::GetSampledRequestsRequest>
  void GetSampledRequestsAsync(const GetSampledRequestsRequestT& request, const GetSampledRequestsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetSampledRequests, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetSizeConstraintSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetSizeConstraintSetOutcomeCallable GetSizeConstraintSetCallable(const GetSizeConstraintSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetSizeConstraintSet, request);
  }

  /**
   * An Async wrapper for GetSizeConstraintSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSizeConstraintSetRequestT = Model::GetSizeConstraintSetRequest>
  void GetSizeConstraintSetAsync(const GetSizeConstraintSetRequestT& request, const GetSizeConstraintSetResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetSizeConstraintSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetSqlInjectionMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetSqlInjectionMatchSetOutcomeCallable GetSqlInjectionMatchSetCallable(const GetSqlInjectionMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetSqlInjectionMatchSet, request);
  }

  /**
   * An Async wrapper for GetSqlInjectionMatchSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSqlInjectionMatchSetRequestT = Model::GetSqlInjectionMatchSetRequest>
  void GetSqlInjectionMatchSetAsync(const GetSqlInjectionMatchSetRequestT& request,
                                    const GetSqlInjectionMatchSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetSqlInjectionMatchSet, request, handler, context);
  }
  ...
  Model::GetWebACLOutcomeCallable GetWebACLCallable(const GetWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetWebACL, request);
  }

  /**
   * An Async wrapper for GetWebACL that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWebACLRequestT = Model::GetWebACLRequest>
  void GetWebACLAsync(const GetWebACLRequestT& request, const GetWebACLResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetWebACL, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for GetWebACLForResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::GetWebACLForResourceOutcomeCallable GetWebACLForResourceCallable(const GetWebACLForResourceRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetWebACLForResource, request);
  }

  /**
   * An Async wrapper for GetWebACLForResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWebACLForResourceRequestT = Model::GetWebACLForResourceRequest>
  void GetWebACLForResourceAsync(const GetWebACLForResourceRequestT& request, const GetWebACLForResourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetWebACLForResource, request, handler, context);
  }
  ...
  Model::GetXssMatchSetOutcomeCallable GetXssMatchSetCallable(const GetXssMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::GetXssMatchSet, request);
  }

  /**
   * An Async wrapper for GetXssMatchSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetXssMatchSetRequestT = Model::GetXssMatchSetRequest>
  void GetXssMatchSetAsync(const GetXssMatchSetRequestT& request, const GetXssMatchSetResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::GetXssMatchSet, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::ListActivatedRulesInRuleGroupOutcome ListActivatedRulesInRuleGroup(
      const Model::ListActivatedRulesInRuleGroupRequest& request = {}) const;

  /**
   * A Callable wrapper for ListActivatedRulesInRuleGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListActivatedRulesInRuleGroupRequestT = Model::ListActivatedRulesInRuleGroupRequest>
  Model::ListActivatedRulesInRuleGroupOutcomeCallable ListActivatedRulesInRuleGroupCallable(
      const ListActivatedRulesInRuleGroupRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListActivatedRulesInRuleGroup, request);
  }

  /**
   * An Async wrapper for ListActivatedRulesInRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListActivatedRulesInRuleGroupRequestT = Model::ListActivatedRulesInRuleGroupRequest>
  void ListActivatedRulesInRuleGroupAsync(const ListActivatedRulesInRuleGroupResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListActivatedRulesInRuleGroupRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListActivatedRulesInRuleGroup, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListByteMatchSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListByteMatchSetsOutcomeCallable ListByteMatchSetsCallable(const ListByteMatchSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListByteMatchSets, request);
  }

  /**
   * An Async wrapper for ListByteMatchSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListByteMatchSetsRequestT = Model::ListByteMatchSetsRequest>
  void ListByteMatchSetsAsync(const ListByteMatchSetsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListByteMatchSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListByteMatchSets, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListGeoMatchSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListGeoMatchSetsOutcomeCallable ListGeoMatchSetsCallable(const ListGeoMatchSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListGeoMatchSets, request);
  }

  /**
   * An Async wrapper for ListGeoMatchSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGeoMatchSetsRequestT = Model::ListGeoMatchSetsRequest>
  void ListGeoMatchSetsAsync(const ListGeoMatchSetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListGeoMatchSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListGeoMatchSets, request, handler, context);
  }
  ...
  Model::ListIPSetsOutcomeCallable ListIPSetsCallable(const ListIPSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListIPSets, request);
  }

  /**
   * An Async wrapper for ListIPSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIPSetsRequestT = Model::ListIPSetsRequest>
  void ListIPSetsAsync(const ListIPSetsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListIPSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListIPSets, request, handler, context);
  }
  ...
  Model::ListLoggingConfigurationsOutcomeCallable ListLoggingConfigurationsCallable(
    ...
    return SubmitCallable(&WAFRegionalClient::ListLoggingConfigurations, request);
  }
  ...
  void ListLoggingConfigurationsAsync(const ListLoggingConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListLoggingConfigurationsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListLoggingConfigurations, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListRateBasedRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListRateBasedRulesOutcomeCallable ListRateBasedRulesCallable(const ListRateBasedRulesRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListRateBasedRules, request);
  }

  /**
   * An Async wrapper for ListRateBasedRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRateBasedRulesRequestT = Model::ListRateBasedRulesRequest>
  void ListRateBasedRulesAsync(const ListRateBasedRulesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListRateBasedRulesRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListRateBasedRules, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListRegexMatchSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListRegexMatchSetsOutcomeCallable ListRegexMatchSetsCallable(const ListRegexMatchSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListRegexMatchSets, request);
  }

  /**
   * An Async wrapper for ListRegexMatchSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListRegexMatchSetsRequestT = Model::ListRegexMatchSetsRequest>
  void ListRegexMatchSetsAsync(const ListRegexMatchSetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListRegexMatchSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListRegexMatchSets, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListRegexPatternSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListRegexPatternSetsOutcomeCallable ListRegexPatternSetsCallable(const ListRegexPatternSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListRegexPatternSets, request);
  }

  /**
   * An Async wrapper for ListRegexPatternSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRegexPatternSetsRequestT = Model::ListRegexPatternSetsRequest>
  void ListRegexPatternSetsAsync(const ListRegexPatternSetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListRegexPatternSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListRegexPatternSets, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListResourcesForWebACL that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListResourcesForWebACLOutcomeCallable ListResourcesForWebACLCallable(const ListResourcesForWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::ListResourcesForWebACL, request);
  }

  /**
   * An Async wrapper for ListResourcesForWebACL that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourcesForWebACLRequestT = Model::ListResourcesForWebACLRequest>
  void ListResourcesForWebACLAsync(const ListResourcesForWebACLRequestT& request,
                                   const ListResourcesForWebACLResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::ListResourcesForWebACL, request, handler, context);
  }
  ...
  Model::ListRuleGroupsOutcomeCallable ListRuleGroupsCallable(const ListRuleGroupsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListRuleGroups, request);
  }

  /**
   * An Async wrapper for ListRuleGroups that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRuleGroupsRequestT = Model::ListRuleGroupsRequest>
  void ListRuleGroupsAsync(const ListRuleGroupsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListRuleGroupsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListRuleGroups, request, handler, context);
  }
  ...
  Model::ListRulesOutcomeCallable ListRulesCallable(const ListRulesRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListRules, request);
  }
  ...
  void ListRulesAsync(const ListRulesResponseReceivedHandler& handler,
    ...
    return SubmitAsync(&WAFRegionalClient::ListRules, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListSizeConstraintSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListSizeConstraintSetsOutcomeCallable ListSizeConstraintSetsCallable(const ListSizeConstraintSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListSizeConstraintSets, request);
  }

  /**
   * An Async wrapper for ListSizeConstraintSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSizeConstraintSetsRequestT = Model::ListSizeConstraintSetsRequest>
  void ListSizeConstraintSetsAsync(const ListSizeConstraintSetsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListSizeConstraintSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListSizeConstraintSets, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSqlInjectionMatchSetsOutcome ListSqlInjectionMatchSets(
      const Model::ListSqlInjectionMatchSetsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSqlInjectionMatchSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSqlInjectionMatchSetsRequestT = Model::ListSqlInjectionMatchSetsRequest>
  Model::ListSqlInjectionMatchSetsOutcomeCallable ListSqlInjectionMatchSetsCallable(
      const ListSqlInjectionMatchSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListSqlInjectionMatchSets, request);
  }

  /**
   * An Async wrapper for ListSqlInjectionMatchSets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSqlInjectionMatchSetsRequestT = Model::ListSqlInjectionMatchSetsRequest>
  void ListSqlInjectionMatchSetsAsync(const ListSqlInjectionMatchSetsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListSqlInjectionMatchSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListSqlInjectionMatchSets, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListSubscribedRuleGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSubscribedRuleGroupsRequestT = Model::ListSubscribedRuleGroupsRequest>
  Model::ListSubscribedRuleGroupsOutcomeCallable ListSubscribedRuleGroupsCallable(
      const ListSubscribedRuleGroupsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListSubscribedRuleGroups, request);
  }

  /**
   * An Async wrapper for ListSubscribedRuleGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscribedRuleGroupsRequestT = Model::ListSubscribedRuleGroupsRequest>
  void ListSubscribedRuleGroupsAsync(const ListSubscribedRuleGroupsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListSubscribedRuleGroupsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListSubscribedRuleGroups, request, handler, context);
  }
  ...
  Model::ListTagsForResourceOutcomeCallable ListTagsForResourceCallable(const ListTagsForResourceRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::ListTagsForResource, request);
  }
  ...
  void ListTagsForResourceAsync(const ListTagsForResourceRequestT& request, const ListTagsForResourceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::ListTagsForResource, request, handler, context);
  }
  ...
  Model::ListWebACLsOutcomeCallable ListWebACLsCallable(const ListWebACLsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListWebACLs, request);
  }

  /**
   * An Async wrapper for ListWebACLs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWebACLsRequestT = Model::ListWebACLsRequest>
  void ListWebACLsAsync(const ListWebACLsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListWebACLsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListWebACLs, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListXssMatchSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::ListXssMatchSetsOutcomeCallable ListXssMatchSetsCallable(const ListXssMatchSetsRequestT& request = {}) const {
    return SubmitCallable(&WAFRegionalClient::ListXssMatchSets, request);
  }

  /**
   * An Async wrapper for ListXssMatchSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListXssMatchSetsRequestT = Model::ListXssMatchSetsRequest>
  void ListXssMatchSetsAsync(const ListXssMatchSetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListXssMatchSetsRequestT& request = {}) const {
    return SubmitAsync(&WAFRegionalClient::ListXssMatchSets, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for PutLoggingConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::PutLoggingConfigurationOutcomeCallable PutLoggingConfigurationCallable(const PutLoggingConfigurationRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::PutLoggingConfiguration, request);
  }

  /**
   * An Async wrapper for PutLoggingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutLoggingConfigurationRequestT = Model::PutLoggingConfigurationRequest>
  void PutLoggingConfigurationAsync(const PutLoggingConfigurationRequestT& request,
                                    const PutLoggingConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::PutLoggingConfiguration, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for PutPermissionPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::PutPermissionPolicyOutcomeCallable PutPermissionPolicyCallable(const PutPermissionPolicyRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::PutPermissionPolicy, request);
  }

  /**
   * An Async wrapper for PutPermissionPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutPermissionPolicyRequestT = Model::PutPermissionPolicyRequest>
  void PutPermissionPolicyAsync(const PutPermissionPolicyRequestT& request, const PutPermissionPolicyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::PutPermissionPolicy, request, handler, context);
  }
  ...
  Model::TagResourceOutcomeCallable TagResourceCallable(const TagResourceRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::TagResource, request);
  }
  ...
  void TagResourceAsync(const TagResourceRequestT& request, const TagResourceResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::TagResource, request, handler, context);
  }
  ...
  Model::UntagResourceOutcomeCallable UntagResourceCallable(const UntagResourceRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UntagResource, request);
  }
  ...
  void UntagResourceAsync(const UntagResourceRequestT& request, const UntagResourceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UntagResource, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateByteMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateByteMatchSetOutcomeCallable UpdateByteMatchSetCallable(const UpdateByteMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateByteMatchSet, request);
  }

  /**
   * An Async wrapper for UpdateByteMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateByteMatchSetRequestT = Model::UpdateByteMatchSetRequest>
  void UpdateByteMatchSetAsync(const UpdateByteMatchSetRequestT& request, const UpdateByteMatchSetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateByteMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateGeoMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateGeoMatchSetOutcomeCallable UpdateGeoMatchSetCallable(const UpdateGeoMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateGeoMatchSet, request);
  }

  /**
   * An Async wrapper for UpdateGeoMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateGeoMatchSetRequestT = Model::UpdateGeoMatchSetRequest>
  void UpdateGeoMatchSetAsync(const UpdateGeoMatchSetRequestT& request, const UpdateGeoMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateGeoMatchSet, request, handler, context);
  }
  ...
  Model::UpdateIPSetOutcomeCallable UpdateIPSetCallable(const UpdateIPSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateIPSet, request);
  }

  /**
   * An Async wrapper for UpdateIPSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateIPSetRequestT = Model::UpdateIPSetRequest>
  void UpdateIPSetAsync(const UpdateIPSetRequestT& request, const UpdateIPSetResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateIPSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateRateBasedRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateRateBasedRuleOutcomeCallable UpdateRateBasedRuleCallable(const UpdateRateBasedRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateRateBasedRule, request);
  }

  /**
   * An Async wrapper for UpdateRateBasedRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateRateBasedRuleRequestT = Model::UpdateRateBasedRuleRequest>
  void UpdateRateBasedRuleAsync(const UpdateRateBasedRuleRequestT& request, const UpdateRateBasedRuleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateRateBasedRule, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateRegexMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateRegexMatchSetOutcomeCallable UpdateRegexMatchSetCallable(const UpdateRegexMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateRegexMatchSet, request);
  }

  /**
   * An Async wrapper for UpdateRegexMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateRegexMatchSetRequestT = Model::UpdateRegexMatchSetRequest>
  void UpdateRegexMatchSetAsync(const UpdateRegexMatchSetRequestT& request, const UpdateRegexMatchSetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateRegexMatchSet, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateRegexPatternSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateRegexPatternSetOutcomeCallable UpdateRegexPatternSetCallable(const UpdateRegexPatternSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateRegexPatternSet, request);
  }

  /**
   * An Async wrapper for UpdateRegexPatternSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRegexPatternSetRequestT = Model::UpdateRegexPatternSetRequest>
  void UpdateRegexPatternSetAsync(const UpdateRegexPatternSetRequestT& request, const UpdateRegexPatternSetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateRegexPatternSet, request, handler, context);
  }
  ...
  Model::UpdateRuleOutcomeCallable UpdateRuleCallable(const UpdateRuleRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateRule, request);
  }
  ...
  void UpdateRuleAsync(const UpdateRuleRequestT& request, const UpdateRuleResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateRule, request, handler, context);
  }
  ...
  Model::UpdateRuleGroupOutcomeCallable UpdateRuleGroupCallable(const UpdateRuleGroupRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateRuleGroup, request);
  }

  /**
   * An Async wrapper for UpdateRuleGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateRuleGroupRequestT = Model::UpdateRuleGroupRequest>
  void UpdateRuleGroupAsync(const UpdateRuleGroupRequestT& request, const UpdateRuleGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateRuleGroup, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateSizeConstraintSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateSizeConstraintSetOutcomeCallable UpdateSizeConstraintSetCallable(const UpdateSizeConstraintSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateSizeConstraintSet, request);
  }

  /**
   * An Async wrapper for UpdateSizeConstraintSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSizeConstraintSetRequestT = Model::UpdateSizeConstraintSetRequest>
  void UpdateSizeConstraintSetAsync(const UpdateSizeConstraintSetRequestT& request,
                                    const UpdateSizeConstraintSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateSizeConstraintSet, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSqlInjectionMatchSetOutcome UpdateSqlInjectionMatchSet(
      const Model::UpdateSqlInjectionMatchSetRequest& request) const;

  /**
   * A Callable wrapper for UpdateSqlInjectionMatchSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSqlInjectionMatchSetRequestT = Model::UpdateSqlInjectionMatchSetRequest>
  Model::UpdateSqlInjectionMatchSetOutcomeCallable UpdateSqlInjectionMatchSetCallable(
      const UpdateSqlInjectionMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateSqlInjectionMatchSet, request);
  }

  /**
   * An Async wrapper for UpdateSqlInjectionMatchSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSqlInjectionMatchSetRequestT = Model::UpdateSqlInjectionMatchSetRequest>
  void UpdateSqlInjectionMatchSetAsync(const UpdateSqlInjectionMatchSetRequestT& request,
                                       const UpdateSqlInjectionMatchSetResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateSqlInjectionMatchSet, request, handler, context);
  }
  ...
  Model::UpdateWebACLOutcomeCallable UpdateWebACLCallable(const UpdateWebACLRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateWebACL, request);
  }

  /**
   * An Async wrapper for UpdateWebACL that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWebACLRequestT = Model::UpdateWebACLRequest>
  void UpdateWebACLAsync(const UpdateWebACLRequestT& request, const UpdateWebACLResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateWebACL, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateXssMatchSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::UpdateXssMatchSetOutcomeCallable UpdateXssMatchSetCallable(const UpdateXssMatchSetRequestT& request) const {
    return SubmitCallable(&WAFRegionalClient::UpdateXssMatchSet, request);
  }

  /**
   * An Async wrapper for UpdateXssMatchSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateXssMatchSetRequestT = Model::UpdateXssMatchSetRequest>
  void UpdateXssMatchSetAsync(const UpdateXssMatchSetRequestT& request, const UpdateXssMatchSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WAFRegionalClient::UpdateXssMatchSet, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<WAFRegionalEndpointProviderBase>& accessEndpointProvider();
