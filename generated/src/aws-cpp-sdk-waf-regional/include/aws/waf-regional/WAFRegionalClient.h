...
namespace WAFRegional
{
   ...
   */
  class AWS_WAFREGIONAL_API WAFRegionalClient : smithy::client::AwsSmithyClientT<Aws::WAFRegional::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<WAFRegionalClient>
  {
    public:
