...
class LoRaWANConnectionStatusResourceTypeEventConfiguration {
 public:
  ...
  inline void SetWirelessGatewayEventTopic(EventNotificationTopicStatus value) {
    m_wirelessGatewayEventTopicHasBeenSet = true;
    m_wirelessGatewayEventTopic = value;
  }
  inline LoRaWANConnectionStatusResourceTypeEventConfiguration& WithWirelessGatewayEventTopic(EventNotificationTopicStatus value) {
    SetWirelessGatewayEventTopic(value);
    return *this;
  }
  ///@}
 private:
