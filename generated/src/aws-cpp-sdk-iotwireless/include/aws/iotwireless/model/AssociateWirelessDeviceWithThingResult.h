...
namespace Model
{
  ...
  public:
    ...
    inline AssociateWirelessDeviceWithThingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateWirelessDeviceWithThingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateWirelessDeviceWithThingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
