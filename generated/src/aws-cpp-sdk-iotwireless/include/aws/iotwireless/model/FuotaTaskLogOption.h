...
namespace Model
{
  ...
  public:
    ...
    inline void SetType(FuotaTaskType value) { m_typeHasBeenSet = true; m_type = value; }
    inline FuotaTaskLogOption& WithType(FuotaTaskType value) { SetType(value); return *this;}
    ///@}
    ...
    inline FuotaTaskLogOption& WithLogLevel(LogLevel value) { SetLogLevel(value); return *this;}
    ///@}
    ...
    template<typename EventsT = Aws::Vector<FuotaTaskEventLogOption>>
    void SetEvents(EventsT&& value) { m_eventsHasBeenSet = true; m_events = std::forward<EventsT>(value); }
    template<typename EventsT = Aws::Vector<FuotaTaskEventLogOption>>
    FuotaTaskLogOption& WithEvents(EventsT&& value) { SetEvents(std::forward<EventsT>(value)); return *this;}
    template<typename EventsT = FuotaTaskEventLogOption>
    FuotaTaskLogOption& AddEvents(EventsT&& value) { m_eventsHasBeenSet = true; m_events.emplace_back(std::forward<EventsT>(value)); return *this; }
    ///@}
  private:
