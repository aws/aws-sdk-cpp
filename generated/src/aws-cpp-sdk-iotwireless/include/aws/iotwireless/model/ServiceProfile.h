...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API ServiceProfile() = default;
    ...
    template<typename ArnT = Aws::String>
    ServiceProfile& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ServiceProfile& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    ServiceProfile& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
