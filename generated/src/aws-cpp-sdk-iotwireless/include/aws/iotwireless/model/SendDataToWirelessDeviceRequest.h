...
class SendDataToWirelessDeviceRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  SendDataToWirelessDeviceRequest& WithId(IdT&& value) {
  ...
  inline SendDataToWirelessDeviceRequest& WithTransmitMode(int value) {
  ...
  void SetPayloadData(PayloadDataT&& value) {
    m_payloadDataHasBeenSet = true;
    m_payloadData = std::forward<PayloadDataT>(value);
  }
  template <typename PayloadDataT = Aws::String>
  SendDataToWirelessDeviceRequest& WithPayloadData(PayloadDataT&& value) {
    SetPayloadData(std::forward<PayloadDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessMetadata(WirelessMetadataT&& value) {
    m_wirelessMetadataHasBeenSet = true;
    m_wirelessMetadata = std::forward<WirelessMetadataT>(value);
  }
  template <typename WirelessMetadataT = WirelessMetadata>
  SendDataToWirelessDeviceRequest& WithWirelessMetadata(WirelessMetadataT&& value) {
    SetWirelessMetadata(std::forward<WirelessMetadataT>(value));
    return *this;
  }
  ///@}
 private:
