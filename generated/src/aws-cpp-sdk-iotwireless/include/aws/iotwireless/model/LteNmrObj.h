...
class LteNmrObj {
 public:
  ...
  inline LteNmrObj& WithPci(int value) {
    SetPci(value);
    return *this;
  }
  ///@}
  ...
  inline LteNmrObj& WithEarfcn(int value) {
    SetEarfcn(value);
    return *this;
  }
  ///@}
  ...
  inline LteNmrObj& WithEutranCid(int value) {
    SetEutranCid(value);
    return *this;
  }
  ///@}
  ...
  inline LteNmrObj& WithRsrp(int value) {
    SetRsrp(value);
    return *this;
  }
  ///@}
  ...
  inline LteNmrObj& WithRsrq(double value) {
    SetRsrq(value);
    return *this;
  }
  ///@}
