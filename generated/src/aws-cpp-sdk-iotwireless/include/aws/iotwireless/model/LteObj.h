...
class LteObj {
 public:
  ...
  inline LteObj& WithMcc(int value) {
    SetMcc(value);
    return *this;
  }
  ///@}
  ...
  inline LteObj& WithMnc(int value) {
    SetMnc(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEutranCid(int value) {
    m_eutranCidHasBeenSet = true;
    m_eutranCid = value;
  }
  inline LteObj& WithEutranCid(int value) {
    SetEutranCid(value);
    return *this;
  }
  ///@}
  ...
  inline LteObj& WithTac(int value) {
    SetTac(value);
    return *this;
  }
  ///@}
  ...
  void SetLteLocalId(LteLocalIdT&& value) {
    ...
    m_lteLocalId = std::forward<LteLocalIdT>(value);
  }
  template <typename LteLocalIdT = LteLocalId>
  LteObj& WithLteLocalId(LteLocalIdT&& value) {
    SetLteLocalId(std::forward<LteLocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLteTimingAdvance(int value) {
    m_lteTimingAdvanceHasBeenSet = true;
    m_lteTimingAdvance = value;
  }
  inline LteObj& WithLteTimingAdvance(int value) {
    SetLteTimingAdvance(value);
    return *this;
  }
  ///@}
  ...
  inline LteObj& WithRsrp(int value) {
    SetRsrp(value);
    return *this;
  }
  ///@}
  ...
  inline LteObj& WithRsrq(double value) {
    SetRsrq(value);
    return *this;
  }
  ///@}
  ...
  inline LteObj& WithNrCapable(bool value) {
    SetNrCapable(value);
    return *this;
  }
  ///@}
  ...
  void SetLteNmr(LteNmrT&& value) {
    ...
    m_lteNmr = std::forward<LteNmrT>(value);
  }
  template <typename LteNmrT = Aws::Vector<LteNmrObj>>
  LteObj& WithLteNmr(LteNmrT&& value) {
    SetLteNmr(std::forward<LteNmrT>(value));
    return *this;
  }
  template <typename LteNmrT = LteNmrObj>
  LteObj& AddLteNmr(LteNmrT&& value) {
    m_lteNmrHasBeenSet = true;
    m_lteNmr.emplace_back(std::forward<LteNmrT>(value));
    return *this;
  }
  ///@}
 private:
