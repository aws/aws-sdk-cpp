...
class AssociateAwsAccountWithPartnerAccountRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename SidewalkT = SidewalkAccountInfo>
  AssociateAwsAccountWithPartnerAccountRequest& WithSidewalk(SidewalkT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  AssociateAwsAccountWithPartnerAccountRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssociateAwsAccountWithPartnerAccountRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssociateAwsAccountWithPartnerAccountRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
