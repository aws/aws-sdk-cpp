...
class LteLocalId {
 public:
  AWS_IOTWIRELESS_API LteLocalId() = default;
  ...
  inline void SetPci(int value) {
    m_pciHasBeenSet = true;
    m_pci = value;
  }
  inline LteLocalId& WithPci(int value) {
    SetPci(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEarfcn(int value) {
    m_earfcnHasBeenSet = true;
    m_earfcn = value;
  }
  inline LteLocalId& WithEarfcn(int value) {
    SetEarfcn(value);
    return *this;
  }
  ///@}
