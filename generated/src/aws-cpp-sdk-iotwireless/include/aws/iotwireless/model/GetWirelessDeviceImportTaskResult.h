...
class GetWirelessDeviceImportTaskResult {
 public:
  ...
  template <typename IdT = Aws::String>
  GetWirelessDeviceImportTaskResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetWirelessDeviceImportTaskResult& WithArn(ArnT&& value) {
  ...
  template <typename DestinationNameT = Aws::String>
  GetWirelessDeviceImportTaskResult& WithDestinationName(DestinationNameT&& value) {
  ...
  inline GetWirelessDeviceImportTaskResult& WithPositioning(PositioningConfigStatus value) {
  ...
  template <typename SidewalkT = SidewalkGetStartImportInfo>
  GetWirelessDeviceImportTaskResult& WithSidewalk(SidewalkT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  GetWirelessDeviceImportTaskResult& WithCreationTime(CreationTimeT&& value) {
  ...
  inline GetWirelessDeviceImportTaskResult& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  GetWirelessDeviceImportTaskResult& WithStatusReason(StatusReasonT&& value) {
  ...
  inline void SetInitializedImportedDeviceCount(long long value) {
    m_initializedImportedDeviceCountHasBeenSet = true;
    m_initializedImportedDeviceCount = value;
  }
  inline GetWirelessDeviceImportTaskResult& WithInitializedImportedDeviceCount(long long value) {
    SetInitializedImportedDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPendingImportedDeviceCount(long long value) {
    m_pendingImportedDeviceCountHasBeenSet = true;
    m_pendingImportedDeviceCount = value;
  }
  inline GetWirelessDeviceImportTaskResult& WithPendingImportedDeviceCount(long long value) {
    SetPendingImportedDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOnboardedImportedDeviceCount(long long value) {
    m_onboardedImportedDeviceCountHasBeenSet = true;
    m_onboardedImportedDeviceCount = value;
  }
  inline GetWirelessDeviceImportTaskResult& WithOnboardedImportedDeviceCount(long long value) {
    SetOnboardedImportedDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedImportedDeviceCount(long long value) {
    m_failedImportedDeviceCountHasBeenSet = true;
    m_failedImportedDeviceCount = value;
  }
  inline GetWirelessDeviceImportTaskResult& WithFailedImportedDeviceCount(long long value) {
    SetFailedImportedDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetWirelessDeviceImportTaskResult& WithRequestId(RequestIdT&& value) {
