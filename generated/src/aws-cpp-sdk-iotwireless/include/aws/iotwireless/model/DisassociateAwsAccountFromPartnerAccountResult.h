...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateAwsAccountFromPartnerAccountResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateAwsAccountFromPartnerAccountResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateAwsAccountFromPartnerAccountResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
