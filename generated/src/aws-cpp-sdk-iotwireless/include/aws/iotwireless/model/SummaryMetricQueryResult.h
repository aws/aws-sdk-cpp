...
class SummaryMetricQueryResult {
 public:
  ...
  inline void SetQueryStatus(MetricQueryStatus value) {
    m_queryStatusHasBeenSet = true;
    m_queryStatus = value;
  }
  inline SummaryMetricQueryResult& WithQueryStatus(MetricQueryStatus value) {
  ...
  inline SummaryMetricQueryResult& WithMetricName(MetricName value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline SummaryMetricQueryResult& WithAggregationPeriod(AggregationPeriod value) {
