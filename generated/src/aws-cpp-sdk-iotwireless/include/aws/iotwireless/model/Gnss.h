...
class Gnss {
 public:
  ...
  inline Gnss& WithCaptureTime(double value) {
  ...
  inline Gnss& WithCaptureTimeAccuracy(double value) {
  ...
  inline Gnss& AddAssistPosition(double value) {
    m_assistPositionHasBeenSet = true;
  ...
  inline Gnss& WithAssistAltitude(double value) {
  ...
  inline Gnss& WithUse2DSolver(bool value) {
