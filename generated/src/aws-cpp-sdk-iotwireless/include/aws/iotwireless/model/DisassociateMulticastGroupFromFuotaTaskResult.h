...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateMulticastGroupFromFuotaTaskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateMulticastGroupFromFuotaTaskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateMulticastGroupFromFuotaTaskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
