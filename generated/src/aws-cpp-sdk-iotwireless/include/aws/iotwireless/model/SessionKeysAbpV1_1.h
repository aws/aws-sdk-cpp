...
class SessionKeysAbpV1_1 {
 public:
  ...
  void SetFNwkSIntKey(FNwkSIntKeyT&& value) {
    ...
    m_fNwkSIntKey = std::forward<FNwkSIntKeyT>(value);
  }
  template <typename FNwkSIntKeyT = Aws::String>
  SessionKeysAbpV1_1& WithFNwkSIntKey(FNwkSIntKeyT&& value) {
    SetFNwkSIntKey(std::forward<FNwkSIntKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSNwkSIntKey(SNwkSIntKeyT&& value) {
    ...
    m_sNwkSIntKey = std::forward<SNwkSIntKeyT>(value);
  }
  template <typename SNwkSIntKeyT = Aws::String>
  SessionKeysAbpV1_1& WithSNwkSIntKey(SNwkSIntKeyT&& value) {
    SetSNwkSIntKey(std::forward<SNwkSIntKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNwkSEncKey(NwkSEncKeyT&& value) {
    ...
    m_nwkSEncKey = std::forward<NwkSEncKeyT>(value);
  }
  template <typename NwkSEncKeyT = Aws::String>
  SessionKeysAbpV1_1& WithNwkSEncKey(NwkSEncKeyT&& value) {
    SetNwkSEncKey(std::forward<NwkSEncKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppSKey(AppSKeyT&& value) {
    ...
    m_appSKey = std::forward<AppSKeyT>(value);
  }
  template <typename AppSKeyT = Aws::String>
  SessionKeysAbpV1_1& WithAppSKey(AppSKeyT&& value) {
    SetAppSKey(std::forward<AppSKeyT>(value));
    return *this;
  }
  ///@}
 private:
