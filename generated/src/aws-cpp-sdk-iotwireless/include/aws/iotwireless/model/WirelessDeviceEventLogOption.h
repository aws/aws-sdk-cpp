...
class WirelessDeviceEventLogOption {
 public:
  ...
  inline void SetEvent(WirelessDeviceEvent value) {
    m_eventHasBeenSet = true;
    m_event = value;
  }
  inline WirelessDeviceEventLogOption& WithEvent(WirelessDeviceEvent value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline WirelessDeviceEventLogOption& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
