...
class LoRaWANDevice {
 public:
  ...
  void SetOtaaV1_1(OtaaV1_1T&& value) {
    ...
    m_otaaV1_1 = std::forward<OtaaV1_1T>(value);
  }
  template <typename OtaaV1_1T = OtaaV1_1>
  LoRaWANDevice& WithOtaaV1_1(OtaaV1_1T&& value) {
    SetOtaaV1_1(std::forward<OtaaV1_1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetOtaaV1_0_x(OtaaV1_0_xT&& value) {
    ...
    m_otaaV1_0_x = std::forward<OtaaV1_0_xT>(value);
  }
  template <typename OtaaV1_0_xT = OtaaV1_0_x>
  LoRaWANDevice& WithOtaaV1_0_x(OtaaV1_0_xT&& value) {
    SetOtaaV1_0_x(std::forward<OtaaV1_0_xT>(value));
    return *this;
  }
  ///@}
