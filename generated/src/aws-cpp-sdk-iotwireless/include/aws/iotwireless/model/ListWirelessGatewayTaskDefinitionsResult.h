...
class ListWirelessGatewayTaskDefinitionsResult {
 public:
  ...
  AWS_IOTWIRELESS_API ListWirelessGatewayTaskDefinitionsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListWirelessGatewayTaskDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TaskDefinitionsT = Aws::Vector<UpdateWirelessGatewayTaskEntry>>
  ListWirelessGatewayTaskDefinitionsResult& WithTaskDefinitions(TaskDefinitionsT&& value) {
    SetTaskDefinitions(std::forward<TaskDefinitionsT>(value));
    return *this;
  }
  template <typename TaskDefinitionsT = UpdateWirelessGatewayTaskEntry>
  ListWirelessGatewayTaskDefinitionsResult& AddTaskDefinitions(TaskDefinitionsT&& value) {
    m_taskDefinitionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListWirelessGatewayTaskDefinitionsResult& WithRequestId(RequestIdT&& value) {
