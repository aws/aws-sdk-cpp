...
class CreateDestinationResult {
 public:
  AWS_IOTWIRELESS_API CreateDestinationResult() = default;
  ...
  template <typename ArnT = Aws::String>
  CreateDestinationResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateDestinationResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDestinationResult& WithRequestId(RequestIdT&& value) {
