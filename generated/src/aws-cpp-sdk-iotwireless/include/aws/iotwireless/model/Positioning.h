...
class Positioning {
 public:
  ...
  inline Positioning& WithClockSync(int value) {
    SetClockSync(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStream(int value) {
    m_streamHasBeenSet = true;
    m_stream = value;
  }
  inline Positioning& WithStream(int value) {
    SetStream(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGnss(int value) {
    m_gnssHasBeenSet = true;
    m_gnss = value;
  }
  inline Positioning& WithGnss(int value) {
    SetGnss(value);
    return *this;
  }
  ///@}
