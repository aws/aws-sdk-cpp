...
namespace Model
{
  ...
  public:
    ...
    inline StartBulkDisassociateWirelessDeviceFromMulticastGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartBulkDisassociateWirelessDeviceFromMulticastGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartBulkDisassociateWirelessDeviceFromMulticastGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
