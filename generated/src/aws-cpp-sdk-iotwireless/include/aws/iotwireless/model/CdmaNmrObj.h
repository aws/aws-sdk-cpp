...
class CdmaNmrObj {
 public:
  ...
  inline void SetPnOffset(int value) {
    m_pnOffsetHasBeenSet = true;
    m_pnOffset = value;
  }
  inline CdmaNmrObj& WithPnOffset(int value) {
    SetPnOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCdmaChannel(int value) {
    m_cdmaChannelHasBeenSet = true;
    m_cdmaChannel = value;
  }
  inline CdmaNmrObj& WithCdmaChannel(int value) {
    SetCdmaChannel(value);
    return *this;
  }
  ///@}
  ...
  inline CdmaNmrObj& WithPilotPower(int value) {
    SetPilotPower(value);
    return *this;
  }
  ///@}
  ...
  inline CdmaNmrObj& WithBaseStationId(int value) {
