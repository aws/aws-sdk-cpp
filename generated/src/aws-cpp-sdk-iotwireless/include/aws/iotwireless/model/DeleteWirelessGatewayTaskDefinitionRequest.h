...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeleteWirelessGatewayTaskDefinitionRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteWirelessGatewayTaskDefinitionRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
