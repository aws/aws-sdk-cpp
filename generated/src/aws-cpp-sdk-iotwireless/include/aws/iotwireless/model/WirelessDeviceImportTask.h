...
class WirelessDeviceImportTask {
 public:
  ...
  inline WirelessDeviceImportTask& WithStatus(ImportTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline WirelessDeviceImportTask& WithInitializedImportedDeviceCount(long long value) {
  ...
  inline WirelessDeviceImportTask& WithPendingImportedDeviceCount(long long value) {
  ...
  inline WirelessDeviceImportTask& WithOnboardedImportedDeviceCount(long long value) {
  ...
  inline WirelessDeviceImportTask& WithFailedImportedDeviceCount(long long value) {
