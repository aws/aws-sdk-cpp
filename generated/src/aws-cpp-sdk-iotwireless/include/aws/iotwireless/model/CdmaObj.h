...
class CdmaObj {
 public:
  ...
  inline void SetSystemId(int value) {
    m_systemIdHasBeenSet = true;
    m_systemId = value;
  }
  inline CdmaObj& WithSystemId(int value) {
    SetSystemId(value);
    return *this;
  }
  ///@}
  ...
  inline CdmaObj& WithNetworkId(int value) {
    SetNetworkId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBaseStationId(int value) {
    m_baseStationIdHasBeenSet = true;
    m_baseStationId = value;
  }
  inline CdmaObj& WithBaseStationId(int value) {
    SetBaseStationId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRegistrationZone(int value) {
    m_registrationZoneHasBeenSet = true;
    m_registrationZone = value;
  }
  inline CdmaObj& WithRegistrationZone(int value) {
    SetRegistrationZone(value);
    return *this;
  }
  ///@}
  ...
  void SetCdmaLocalId(CdmaLocalIdT&& value) {
    ...
    m_cdmaLocalId = std::forward<CdmaLocalIdT>(value);
  }
  template <typename CdmaLocalIdT = CdmaLocalId>
  CdmaObj& WithCdmaLocalId(CdmaLocalIdT&& value) {
    SetCdmaLocalId(std::forward<CdmaLocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPilotPower(int value) {
    m_pilotPowerHasBeenSet = true;
    m_pilotPower = value;
  }
  inline CdmaObj& WithPilotPower(int value) {
    SetPilotPower(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBaseLat(double value) {
    m_baseLatHasBeenSet = true;
    m_baseLat = value;
  }
  inline CdmaObj& WithBaseLat(double value) {
    SetBaseLat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBaseLng(double value) {
    m_baseLngHasBeenSet = true;
    m_baseLng = value;
  }
  inline CdmaObj& WithBaseLng(double value) {
    SetBaseLng(value);
    return *this;
  }
  ///@}
  ...
  void SetCdmaNmr(CdmaNmrT&& value) {
    ...
    m_cdmaNmr = std::forward<CdmaNmrT>(value);
  }
  template <typename CdmaNmrT = Aws::Vector<CdmaNmrObj>>
  CdmaObj& WithCdmaNmr(CdmaNmrT&& value) {
    SetCdmaNmr(std::forward<CdmaNmrT>(value));
    return *this;
  }
  template <typename CdmaNmrT = CdmaNmrObj>
  CdmaObj& AddCdmaNmr(CdmaNmrT&& value) {
    m_cdmaNmrHasBeenSet = true;
    m_cdmaNmr.emplace_back(std::forward<CdmaNmrT>(value));
    return *this;
  }
  ///@}
 private:
