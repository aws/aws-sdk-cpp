...
class ParticipatingGateways {
 public:
  ...
  inline void SetDownlinkMode(DownlinkMode value) {
    m_downlinkModeHasBeenSet = true;
    m_downlinkMode = value;
  }
  inline ParticipatingGateways& WithDownlinkMode(DownlinkMode value) {
    SetDownlinkMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransmissionInterval(int value) {
    m_transmissionIntervalHasBeenSet = true;
    m_transmissionInterval = value;
  }
  inline ParticipatingGateways& WithTransmissionInterval(int value) {
    SetTransmissionInterval(value);
    return *this;
  }
  ///@}
 private:
