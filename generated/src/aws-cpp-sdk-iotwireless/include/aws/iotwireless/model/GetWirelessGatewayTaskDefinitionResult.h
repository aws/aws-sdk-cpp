...
class GetWirelessGatewayTaskDefinitionResult {
 public:
  ...
  AWS_IOTWIRELESS_API GetWirelessGatewayTaskDefinitionResult& operator=(
  ...
  inline void SetAutoCreateTasks(bool value) {
    m_autoCreateTasksHasBeenSet = true;
    m_autoCreateTasks = value;
  }
  inline GetWirelessGatewayTaskDefinitionResult& WithAutoCreateTasks(bool value) {
    SetAutoCreateTasks(value);
    return *this;
  }
  ///@}
