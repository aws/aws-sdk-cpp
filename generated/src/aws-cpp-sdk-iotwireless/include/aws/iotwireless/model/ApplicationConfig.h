...
class ApplicationConfig {
 public:
  ...
  inline void SetFPort(int value) {
    m_fPortHasBeenSet = true;
    m_fPort = value;
  }
  inline ApplicationConfig& WithFPort(int value) {
    SetFPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ApplicationConfigType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ApplicationConfig& WithType(ApplicationConfigType value) {
    SetType(value);
    return *this;
  }
  ///@}
