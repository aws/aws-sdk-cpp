...
class AbpV1_1 {
 public:
  ...
  void SetDevAddr(DevAddrT&& value) {
    ...
    m_devAddr = std::forward<DevAddrT>(value);
  }
  template <typename DevAddrT = Aws::String>
  AbpV1_1& WithDevAddr(DevAddrT&& value) {
    SetDevAddr(std::forward<DevAddrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionKeys(SessionKeysT&& value) {
    ...
    m_sessionKeys = std::forward<SessionKeysT>(value);
  }
  template <typename SessionKeysT = SessionKeysAbpV1_1>
  AbpV1_1& WithSessionKeys(SessionKeysT&& value) {
    SetSessionKeys(std::forward<SessionKeysT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFCntStart(int value) {
    m_fCntStartHasBeenSet = true;
    m_fCntStart = value;
  }
  inline AbpV1_1& WithFCntStart(int value) {
    SetFCntStart(value);
    return *this;
  }
  ///@}
