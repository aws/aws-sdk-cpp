...
namespace Model
{
  ...
  public:
    ...
    inline DeleteWirelessGatewayResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteWirelessGatewayResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteWirelessGatewayResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
