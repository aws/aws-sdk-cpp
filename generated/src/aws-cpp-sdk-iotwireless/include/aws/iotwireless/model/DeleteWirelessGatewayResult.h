...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeleteWirelessGatewayResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteWirelessGatewayResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
