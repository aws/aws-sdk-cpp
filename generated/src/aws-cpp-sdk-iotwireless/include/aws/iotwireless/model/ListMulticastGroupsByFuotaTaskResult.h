...
class ListMulticastGroupsByFuotaTaskResult {
 public:
  ...
  AWS_IOTWIRELESS_API ListMulticastGroupsByFuotaTaskResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListMulticastGroupsByFuotaTaskResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename MulticastGroupListT = Aws::Vector<MulticastGroupByFuotaTask>>
  ListMulticastGroupsByFuotaTaskResult& WithMulticastGroupList(MulticastGroupListT&& value) {
  ...
  ListMulticastGroupsByFuotaTaskResult& AddMulticastGroupList(MulticastGroupListT&& value) {
    m_multicastGroupListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListMulticastGroupsByFuotaTaskResult& WithRequestId(RequestIdT&& value) {
