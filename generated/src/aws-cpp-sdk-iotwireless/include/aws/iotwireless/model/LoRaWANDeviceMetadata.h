...
class LoRaWANDeviceMetadata {
 public:
  ...
  void SetDevEui(DevEuiT&& value) {
    ...
    m_devEui = std::forward<DevEuiT>(value);
  }
  template <typename DevEuiT = Aws::String>
  LoRaWANDeviceMetadata& WithDevEui(DevEuiT&& value) {
    SetDevEui(std::forward<DevEuiT>(value));
    return *this;
  }
  ///@}
  ...
  inline LoRaWANDeviceMetadata& WithFPort(int value) {
    SetFPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataRate(int value) {
    m_dataRateHasBeenSet = true;
    m_dataRate = value;
  }
  inline LoRaWANDeviceMetadata& WithDataRate(int value) {
    SetDataRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFrequency(int value) {
    m_frequencyHasBeenSet = true;
    m_frequency = value;
  }
  inline LoRaWANDeviceMetadata& WithFrequency(int value) {
    SetFrequency(value);
    return *this;
  }
  ///@}
  ...
  template <typename TimestampT = Aws::String>
  LoRaWANDeviceMetadata& WithTimestamp(TimestampT&& value) {
  ...
  template <typename GatewaysT = Aws::Vector<LoRaWANGatewayMetadata>>
  LoRaWANDeviceMetadata& WithGateways(GatewaysT&& value) {
    SetGateways(std::forward<GatewaysT>(value));
    return *this;
  }
  template <typename GatewaysT = LoRaWANGatewayMetadata>
  LoRaWANDeviceMetadata& AddGateways(GatewaysT&& value) {
    m_gatewaysHasBeenSet = true;
  ...
  void SetPublicGateways(PublicGatewaysT&& value) {
    m_publicGatewaysHasBeenSet = true;
    m_publicGateways = std::forward<PublicGatewaysT>(value);
  }
  template <typename PublicGatewaysT = Aws::Vector<LoRaWANPublicGatewayMetadata>>
  LoRaWANDeviceMetadata& WithPublicGateways(PublicGatewaysT&& value) {
    SetPublicGateways(std::forward<PublicGatewaysT>(value));
    return *this;
  }
  template <typename PublicGatewaysT = LoRaWANPublicGatewayMetadata>
  LoRaWANDeviceMetadata& AddPublicGateways(PublicGatewaysT&& value) {
    m_publicGatewaysHasBeenSet = true;
    m_publicGateways.emplace_back(std::forward<PublicGatewaysT>(value));
    return *this;
  }
  ///@}
 private:
