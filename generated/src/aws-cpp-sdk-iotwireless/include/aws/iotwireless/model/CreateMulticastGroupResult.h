...
class CreateMulticastGroupResult {
 public:
  AWS_IOTWIRELESS_API CreateMulticastGroupResult() = default;
  ...
  template <typename ArnT = Aws::String>
  CreateMulticastGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateMulticastGroupResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMulticastGroupResult& WithRequestId(RequestIdT&& value) {
