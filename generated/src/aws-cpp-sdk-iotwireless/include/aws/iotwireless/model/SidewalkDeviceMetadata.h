...
class SidewalkDeviceMetadata {
 public:
  ...
  inline void SetRssi(int value) {
    m_rssiHasBeenSet = true;
    m_rssi = value;
  }
  inline SidewalkDeviceMetadata& WithRssi(int value) {
    SetRssi(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBatteryLevel(BatteryLevel value) {
    m_batteryLevelHasBeenSet = true;
    m_batteryLevel = value;
  }
  inline SidewalkDeviceMetadata& WithBatteryLevel(BatteryLevel value) {
  ...
  inline void SetEvent(Event value) {
    m_eventHasBeenSet = true;
    m_event = value;
  }
  inline SidewalkDeviceMetadata& WithEvent(Event value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeviceState(DeviceState value) {
    m_deviceStateHasBeenSet = true;
    m_deviceState = value;
  }
  inline SidewalkDeviceMetadata& WithDeviceState(DeviceState value) {
