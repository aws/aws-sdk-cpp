...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API UpdateWirelessDeviceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateWirelessDeviceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
