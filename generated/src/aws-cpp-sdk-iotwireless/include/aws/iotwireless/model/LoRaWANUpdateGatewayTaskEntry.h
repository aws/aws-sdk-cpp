...
class LoRaWANUpdateGatewayTaskEntry {
 public:
  ...
  template <typename CurrentVersionT = LoRaWANGatewayVersion>
  LoRaWANUpdateGatewayTaskEntry& WithCurrentVersion(CurrentVersionT&& value) {
  ...
  void SetUpdateVersion(UpdateVersionT&& value) {
    m_updateVersionHasBeenSet = true;
    m_updateVersion = std::forward<UpdateVersionT>(value);
  }
  template <typename UpdateVersionT = LoRaWANGatewayVersion>
  LoRaWANUpdateGatewayTaskEntry& WithUpdateVersion(UpdateVersionT&& value) {
    SetUpdateVersion(std::forward<UpdateVersionT>(value));
    return *this;
  }
  ///@}
 private:
