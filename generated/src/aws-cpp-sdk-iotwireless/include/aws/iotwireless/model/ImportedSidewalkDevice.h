...
class ImportedSidewalkDevice {
 public:
  ...
  template <typename SidewalkManufacturingSnT = Aws::String>
  ImportedSidewalkDevice& WithSidewalkManufacturingSn(SidewalkManufacturingSnT&& value) {
  ...
  inline void SetOnboardingStatus(OnboardStatus value) {
    m_onboardingStatusHasBeenSet = true;
    m_onboardingStatus = value;
  }
  inline ImportedSidewalkDevice& WithOnboardingStatus(OnboardStatus value) {
  ...
  void SetOnboardingStatusReason(OnboardingStatusReasonT&& value) {
    m_onboardingStatusReasonHasBeenSet = true;
    m_onboardingStatusReason = std::forward<OnboardingStatusReasonT>(value);
  }
  template <typename OnboardingStatusReasonT = Aws::String>
  ImportedSidewalkDevice& WithOnboardingStatusReason(OnboardingStatusReasonT&& value) {
    SetOnboardingStatusReason(std::forward<OnboardingStatusReasonT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdateTimeT = Aws::Utils::DateTime>
  ImportedSidewalkDevice& WithLastUpdateTime(LastUpdateTimeT&& value) {
