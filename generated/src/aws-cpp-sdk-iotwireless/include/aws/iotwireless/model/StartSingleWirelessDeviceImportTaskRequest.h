...
class StartSingleWirelessDeviceImportTaskRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename DestinationNameT = Aws::String>
  StartSingleWirelessDeviceImportTaskRequest& WithDestinationName(DestinationNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartSingleWirelessDeviceImportTaskRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename DeviceNameT = Aws::String>
  StartSingleWirelessDeviceImportTaskRequest& WithDeviceName(DeviceNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  StartSingleWirelessDeviceImportTaskRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  StartSingleWirelessDeviceImportTaskRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename SidewalkT = SidewalkSingleStartImportInfo>
  StartSingleWirelessDeviceImportTaskRequest& WithSidewalk(SidewalkT&& value) {
