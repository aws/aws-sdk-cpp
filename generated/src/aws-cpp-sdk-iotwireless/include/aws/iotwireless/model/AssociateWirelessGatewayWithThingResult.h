...
namespace Model
{
  ...
  public:
    ...
    inline AssociateWirelessGatewayWithThingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateWirelessGatewayWithThingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateWirelessGatewayWithThingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
