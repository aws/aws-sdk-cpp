...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API UpdatePartnerAccountResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdatePartnerAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
