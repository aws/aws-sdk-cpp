...
class DisassociateMulticastGroupFromFuotaTaskRequest : public IoTWirelessRequest {
 public:
  AWS_IOTWIRELESS_API DisassociateMulticastGroupFromFuotaTaskRequest() = default;
  ...
  template <typename IdT = Aws::String>
  DisassociateMulticastGroupFromFuotaTaskRequest& WithId(IdT&& value) {
  ...
  void SetMulticastGroupId(MulticastGroupIdT&& value) {
    m_multicastGroupIdHasBeenSet = true;
    m_multicastGroupId = std::forward<MulticastGroupIdT>(value);
  }
  template <typename MulticastGroupIdT = Aws::String>
  DisassociateMulticastGroupFromFuotaTaskRequest& WithMulticastGroupId(MulticastGroupIdT&& value) {
    SetMulticastGroupId(std::forward<MulticastGroupIdT>(value));
    return *this;
  }
  ///@}
 private:
