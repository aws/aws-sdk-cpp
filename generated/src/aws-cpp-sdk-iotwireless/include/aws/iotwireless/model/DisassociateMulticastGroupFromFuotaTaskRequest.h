...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    DisassociateMulticastGroupFromFuotaTaskRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MulticastGroupIdT = Aws::String>
    DisassociateMulticastGroupFromFuotaTaskRequest& WithMulticastGroupId(MulticastGroupIdT&& value) { SetMulticastGroupId(std::forward<MulticastGroupIdT>(value)); return *this;}
    ///@}
  private:
