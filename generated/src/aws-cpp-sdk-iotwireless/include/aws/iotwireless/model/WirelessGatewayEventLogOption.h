...
class WirelessGatewayEventLogOption {
 public:
  ...
  inline void SetEvent(WirelessGatewayEvent value) {
    m_eventHasBeenSet = true;
    m_event = value;
  }
  inline WirelessGatewayEventLogOption& WithEvent(WirelessGatewayEvent value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline WirelessGatewayEventLogOption& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
