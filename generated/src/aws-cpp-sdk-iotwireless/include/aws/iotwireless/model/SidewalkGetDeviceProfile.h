...
class SidewalkGetDeviceProfile {
 public:
  ...
  void SetApplicationServerPublicKey(ApplicationServerPublicKeyT&& value) {
    ...
    m_applicationServerPublicKey = std::forward<ApplicationServerPublicKeyT>(value);
  }
  template <typename ApplicationServerPublicKeyT = Aws::String>
  SidewalkGetDeviceProfile& WithApplicationServerPublicKey(ApplicationServerPublicKeyT&& value) {
    SetApplicationServerPublicKey(std::forward<ApplicationServerPublicKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQualificationStatus(bool value) {
    m_qualificationStatusHasBeenSet = true;
    m_qualificationStatus = value;
  }
  inline SidewalkGetDeviceProfile& WithQualificationStatus(bool value) {
    SetQualificationStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDakCertificateMetadata(DakCertificateMetadataT&& value) {
    ...
    m_dakCertificateMetadata = std::forward<DakCertificateMetadataT>(value);
  }
  template <typename DakCertificateMetadataT = Aws::Vector<DakCertificateMetadata>>
  SidewalkGetDeviceProfile& WithDakCertificateMetadata(DakCertificateMetadataT&& value) {
    SetDakCertificateMetadata(std::forward<DakCertificateMetadataT>(value));
    return *this;
  }
  ...
  SidewalkGetDeviceProfile& AddDakCertificateMetadata(DakCertificateMetadataT&& value) {
    m_dakCertificateMetadataHasBeenSet = true;
    m_dakCertificateMetadata.emplace_back(std::forward<DakCertificateMetadataT>(value));
    return *this;
  }
  ///@}
 private:
