...
namespace Model
{
  ...
  public:
    ...
    inline AssociateMulticastGroupWithFuotaTaskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateMulticastGroupWithFuotaTaskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateMulticastGroupWithFuotaTaskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
