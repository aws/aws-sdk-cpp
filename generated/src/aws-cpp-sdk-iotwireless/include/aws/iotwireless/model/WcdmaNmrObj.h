...
class WcdmaNmrObj {
 public:
  ...
  inline WcdmaNmrObj& WithUarfcndl(int value) {
    SetUarfcndl(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaNmrObj& WithPsc(int value) {
    SetPsc(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaNmrObj& WithUtranCid(int value) {
    SetUtranCid(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaNmrObj& WithRscp(int value) {
    SetRscp(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaNmrObj& WithPathLoss(int value) {
    SetPathLoss(value);
    return *this;
  }
  ///@}
