...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListWirelessGatewayTaskDefinitionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline void SetTaskDefinitionType(WirelessGatewayTaskDefinitionType value) { m_taskDefinitionTypeHasBeenSet = true; m_taskDefinitionType = value; }
    inline ListWirelessGatewayTaskDefinitionsRequest& WithTaskDefinitionType(WirelessGatewayTaskDefinitionType value) { SetTaskDefinitionType(value); return *this;}
    ///@}
  private:
