...
class GetWirelessGatewayFirmwareInformationResult {
 public:
  ...
  AWS_IOTWIRELESS_API GetWirelessGatewayFirmwareInformationResult& operator=(
  ...
  template <typename LoRaWANT = LoRaWANGatewayCurrentVersion>
  GetWirelessGatewayFirmwareInformationResult& WithLoRaWAN(LoRaWANT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWirelessGatewayFirmwareInformationResult& WithRequestId(RequestIdT&& value) {
