...
class LoRaWANUpdateGatewayTaskCreate {
 public:
  ...
  void SetUpdateSignature(UpdateSignatureT&& value) {
    m_updateSignatureHasBeenSet = true;
    m_updateSignature = std::forward<UpdateSignatureT>(value);
  }
  template <typename UpdateSignatureT = Aws::String>
  LoRaWANUpdateGatewayTaskCreate& WithUpdateSignature(UpdateSignatureT&& value) {
    SetUpdateSignature(std::forward<UpdateSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSigKeyCrc(long long value) {
    m_sigKeyCrcHasBeenSet = true;
    m_sigKeyCrc = value;
  }
  inline LoRaWANUpdateGatewayTaskCreate& WithSigKeyCrc(long long value) {
    SetSigKeyCrc(value);
    return *this;
  }
  ///@}
  ...
  template <typename CurrentVersionT = LoRaWANGatewayVersion>
  LoRaWANUpdateGatewayTaskCreate& WithCurrentVersion(CurrentVersionT&& value) {
  ...
  template <typename UpdateVersionT = LoRaWANGatewayVersion>
  LoRaWANUpdateGatewayTaskCreate& WithUpdateVersion(UpdateVersionT&& value) {
