...
class AssociateAwsAccountWithPartnerAccountResult {
 public:
  ...
  AWS_IOTWIRELESS_API AssociateAwsAccountWithPartnerAccountResult& operator=(
  ...
  template <typename SidewalkT = SidewalkAccountInfo>
  AssociateAwsAccountWithPartnerAccountResult& WithSidewalk(SidewalkT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AssociateAwsAccountWithPartnerAccountResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateAwsAccountWithPartnerAccountResult& WithRequestId(RequestIdT&& value) {
