...
class SidewalkEventNotificationConfigurations {
 public:
  ...
  inline void SetAmazonIdEventTopic(EventNotificationTopicStatus value) {
    m_amazonIdEventTopicHasBeenSet = true;
    m_amazonIdEventTopic = value;
  }
  inline SidewalkEventNotificationConfigurations& WithAmazonIdEventTopic(EventNotificationTopicStatus value) {
    SetAmazonIdEventTopic(value);
    return *this;
  }
  ///@}
 private:
