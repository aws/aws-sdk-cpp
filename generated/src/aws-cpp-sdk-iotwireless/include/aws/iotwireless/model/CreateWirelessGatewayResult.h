...
namespace Model
{
  ...
  public:
    ...
    inline CreateWirelessGatewayResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateWirelessGatewayResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateWirelessGatewayResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
