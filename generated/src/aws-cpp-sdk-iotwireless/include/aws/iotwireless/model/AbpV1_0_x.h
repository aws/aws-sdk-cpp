...
namespace Model
{
  ...
  public:
    ...
    template<typename DevAddrT = Aws::String>
    AbpV1_0_x& WithDevAddr(DevAddrT&& value) { SetDevAddr(std::forward<DevAddrT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionKeysT = SessionKeysAbpV1_0_x>
    void SetSessionKeys(SessionKeysT&& value) { m_sessionKeysHasBeenSet = true; m_sessionKeys = std::forward<SessionKeysT>(value); }
    template<typename SessionKeysT = SessionKeysAbpV1_0_x>
    AbpV1_0_x& WithSessionKeys(SessionKeysT&& value) { SetSessionKeys(std::forward<SessionKeysT>(value)); return *this;}
    ///@}
