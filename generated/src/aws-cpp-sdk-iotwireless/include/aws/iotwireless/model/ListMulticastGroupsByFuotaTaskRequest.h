...
class ListMulticastGroupsByFuotaTaskRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListMulticastGroupsByFuotaTaskRequest& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMulticastGroupsByFuotaTaskRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMulticastGroupsByFuotaTaskRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
