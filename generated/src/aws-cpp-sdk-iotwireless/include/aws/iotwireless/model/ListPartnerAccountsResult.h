...
class ListPartnerAccountsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPartnerAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SidewalkT = Aws::Vector<SidewalkAccountInfoWithFingerprint>>
  ListPartnerAccountsResult& WithSidewalk(SidewalkT&& value) {
    SetSidewalk(std::forward<SidewalkT>(value));
    return *this;
  }
  template <typename SidewalkT = SidewalkAccountInfoWithFingerprint>
  ListPartnerAccountsResult& AddSidewalk(SidewalkT&& value) {
    m_sidewalkHasBeenSet = true;
    m_sidewalk.emplace_back(std::forward<SidewalkT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPartnerAccountsResult& WithRequestId(RequestIdT&& value) {
