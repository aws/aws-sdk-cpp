...
namespace Model
{
  ...
  public:
    ...
    inline DeleteDeviceProfileResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteDeviceProfileResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteDeviceProfileResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
