...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeleteDeviceProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDeviceProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
