...
namespace Model
{
  ...
  public:
    ...
    inline StartBulkAssociateWirelessDeviceWithMulticastGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartBulkAssociateWirelessDeviceWithMulticastGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartBulkAssociateWirelessDeviceWithMulticastGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
