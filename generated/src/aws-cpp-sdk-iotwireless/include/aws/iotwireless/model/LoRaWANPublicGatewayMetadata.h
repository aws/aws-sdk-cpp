...
class LoRaWANPublicGatewayMetadata {
 public:
  ...
  void SetProviderNetId(ProviderNetIdT&& value) {
    m_providerNetIdHasBeenSet = true;
    m_providerNetId = std::forward<ProviderNetIdT>(value);
  }
  template <typename ProviderNetIdT = Aws::String>
  LoRaWANPublicGatewayMetadata& WithProviderNetId(ProviderNetIdT&& value) {
    SetProviderNetId(std::forward<ProviderNetIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  LoRaWANPublicGatewayMetadata& WithId(IdT&& value) {
  ...
  inline void SetRssi(double value) {
    m_rssiHasBeenSet = true;
    m_rssi = value;
  }
  inline LoRaWANPublicGatewayMetadata& WithRssi(double value) {
    SetRssi(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSnr(double value) {
    m_snrHasBeenSet = true;
    m_snr = value;
  }
  inline LoRaWANPublicGatewayMetadata& WithSnr(double value) {
    SetSnr(value);
    return *this;
  }
  ///@}
  ...
  template <typename RfRegionT = Aws::String>
  LoRaWANPublicGatewayMetadata& WithRfRegion(RfRegionT&& value) {
  ...
  inline void SetDlAllowed(bool value) {
    m_dlAllowedHasBeenSet = true;
    m_dlAllowed = value;
  }
  inline LoRaWANPublicGatewayMetadata& WithDlAllowed(bool value) {
    SetDlAllowed(value);
    return *this;
  }
  ///@}
