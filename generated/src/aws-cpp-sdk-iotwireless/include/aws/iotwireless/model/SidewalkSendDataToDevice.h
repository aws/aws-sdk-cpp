...
class SidewalkSendDataToDevice {
 public:
  ...
  inline SidewalkSendDataToDevice& WithSeq(int value) {
    SetSeq(value);
    return *this;
  }
  ///@}
  ...
  inline SidewalkSendDataToDevice& WithMessageType(MessageType value) {
  ...
  inline void SetAckModeRetryDurationSecs(int value) {
    m_ackModeRetryDurationSecsHasBeenSet = true;
    m_ackModeRetryDurationSecs = value;
  }
  inline SidewalkSendDataToDevice& WithAckModeRetryDurationSecs(int value) {
    SetAckModeRetryDurationSecs(value);
    return *this;
  }
  ///@}
 private:
