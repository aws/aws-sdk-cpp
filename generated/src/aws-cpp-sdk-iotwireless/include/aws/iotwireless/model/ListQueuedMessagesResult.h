...
class ListQueuedMessagesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListQueuedMessagesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetDownlinkQueueMessagesList(DownlinkQueueMessagesListT&& value) {
    m_downlinkQueueMessagesListHasBeenSet = true;
    m_downlinkQueueMessagesList = std::forward<DownlinkQueueMessagesListT>(value);
  }
  template <typename DownlinkQueueMessagesListT = Aws::Vector<DownlinkQueueMessage>>
  ListQueuedMessagesResult& WithDownlinkQueueMessagesList(DownlinkQueueMessagesListT&& value) {
    SetDownlinkQueueMessagesList(std::forward<DownlinkQueueMessagesListT>(value));
    return *this;
  }
  template <typename DownlinkQueueMessagesListT = DownlinkQueueMessage>
  ListQueuedMessagesResult& AddDownlinkQueueMessagesList(DownlinkQueueMessagesListT&& value) {
    m_downlinkQueueMessagesListHasBeenSet = true;
    m_downlinkQueueMessagesList.emplace_back(std::forward<DownlinkQueueMessagesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListQueuedMessagesResult& WithRequestId(RequestIdT&& value) {
