...
class LoRaWANJoinEventNotificationConfigurations {
 public:
  ...
  inline void SetDevEuiEventTopic(EventNotificationTopicStatus value) {
    m_devEuiEventTopicHasBeenSet = true;
    m_devEuiEventTopic = value;
  }
  inline LoRaWANJoinEventNotificationConfigurations& WithDevEuiEventTopic(EventNotificationTopicStatus value) {
    SetDevEuiEventTopic(value);
    return *this;
  }
  ///@}
 private:
