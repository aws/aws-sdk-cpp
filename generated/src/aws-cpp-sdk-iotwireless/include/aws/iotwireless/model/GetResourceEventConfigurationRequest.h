...
class GetResourceEventConfigurationRequest : public IoTWirelessRequest {
 public:
  ...
  inline GetResourceEventConfigurationRequest& WithIdentifierType(IdentifierType value) {
  ...
  inline GetResourceEventConfigurationRequest& WithPartnerType(EventNotificationPartnerType value) {
