...
class GetWirelessGatewayCertificateResult {
 public:
  ...
  AWS_IOTWIRELESS_API GetWirelessGatewayCertificateResult& operator=(
  ...
  void SetLoRaWANNetworkServerCertificateId(LoRaWANNetworkServerCertificateIdT&& value) {
    ...
    m_loRaWANNetworkServerCertificateId = std::forward<LoRaWANNetworkServerCertificateIdT>(value);
  }
  template <typename LoRaWANNetworkServerCertificateIdT = Aws::String>
  GetWirelessGatewayCertificateResult& WithLoRaWANNetworkServerCertificateId(LoRaWANNetworkServerCertificateIdT&& value) {
    SetLoRaWANNetworkServerCertificateId(std::forward<LoRaWANNetworkServerCertificateIdT>(value));
    return *this;
  }
  ///@}
