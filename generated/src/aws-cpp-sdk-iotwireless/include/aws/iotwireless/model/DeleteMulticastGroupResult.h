...
namespace Model
{
  ...
  public:
    ...
    inline DeleteMulticastGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteMulticastGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteMulticastGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
