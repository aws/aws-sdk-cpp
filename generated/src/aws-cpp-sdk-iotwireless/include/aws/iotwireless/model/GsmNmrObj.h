...
class GsmNmrObj {
 public:
  ...
  inline GsmNmrObj& WithBsic(int value) {
    SetBsic(value);
    return *this;
  }
  ///@}
  ...
  inline GsmNmrObj& WithBcch(int value) {
    SetBcch(value);
    return *this;
  }
  ///@}
  ...
  inline GsmNmrObj& WithRxLevel(int value) {
    SetRxLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetGlobalIdentity(GlobalIdentityT&& value) {
    ...
    m_globalIdentity = std::forward<GlobalIdentityT>(value);
  }
  template <typename GlobalIdentityT = GlobalIdentity>
  GsmNmrObj& WithGlobalIdentity(GlobalIdentityT&& value) {
    SetGlobalIdentity(std::forward<GlobalIdentityT>(value));
    return *this;
  }
  ///@}
 private:
