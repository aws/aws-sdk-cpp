...
class UpdateNetworkAnalyzerConfigurationRequest : public IoTWirelessRequest {
 public:
  ...
  void SetWirelessDevicesToAdd(WirelessDevicesToAddT&& value) {
    m_wirelessDevicesToAddHasBeenSet = true;
    m_wirelessDevicesToAdd = std::forward<WirelessDevicesToAddT>(value);
  }
  template <typename WirelessDevicesToAddT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithWirelessDevicesToAdd(WirelessDevicesToAddT&& value) {
    SetWirelessDevicesToAdd(std::forward<WirelessDevicesToAddT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddWirelessDevicesToAdd(WirelessDevicesToAddT&& value) {
    m_wirelessDevicesToAddHasBeenSet = true;
    m_wirelessDevicesToAdd.emplace_back(std::forward<WirelessDevicesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessDevicesToRemove(WirelessDevicesToRemoveT&& value) {
    m_wirelessDevicesToRemoveHasBeenSet = true;
    m_wirelessDevicesToRemove = std::forward<WirelessDevicesToRemoveT>(value);
  }
  template <typename WirelessDevicesToRemoveT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithWirelessDevicesToRemove(WirelessDevicesToRemoveT&& value) {
    SetWirelessDevicesToRemove(std::forward<WirelessDevicesToRemoveT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddWirelessDevicesToRemove(WirelessDevicesToRemoveT&& value) {
    m_wirelessDevicesToRemoveHasBeenSet = true;
    m_wirelessDevicesToRemove.emplace_back(std::forward<WirelessDevicesToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessGatewaysToAdd(WirelessGatewaysToAddT&& value) {
    m_wirelessGatewaysToAddHasBeenSet = true;
    m_wirelessGatewaysToAdd = std::forward<WirelessGatewaysToAddT>(value);
  }
  template <typename WirelessGatewaysToAddT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithWirelessGatewaysToAdd(WirelessGatewaysToAddT&& value) {
    SetWirelessGatewaysToAdd(std::forward<WirelessGatewaysToAddT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddWirelessGatewaysToAdd(WirelessGatewaysToAddT&& value) {
    m_wirelessGatewaysToAddHasBeenSet = true;
    m_wirelessGatewaysToAdd.emplace_back(std::forward<WirelessGatewaysToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessGatewaysToRemove(WirelessGatewaysToRemoveT&& value) {
    m_wirelessGatewaysToRemoveHasBeenSet = true;
    m_wirelessGatewaysToRemove = std::forward<WirelessGatewaysToRemoveT>(value);
  }
  template <typename WirelessGatewaysToRemoveT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithWirelessGatewaysToRemove(WirelessGatewaysToRemoveT&& value) {
    SetWirelessGatewaysToRemove(std::forward<WirelessGatewaysToRemoveT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddWirelessGatewaysToRemove(WirelessGatewaysToRemoveT&& value) {
    m_wirelessGatewaysToRemoveHasBeenSet = true;
    m_wirelessGatewaysToRemove.emplace_back(std::forward<WirelessGatewaysToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMulticastGroupsToAdd(MulticastGroupsToAddT&& value) {
    m_multicastGroupsToAddHasBeenSet = true;
    m_multicastGroupsToAdd = std::forward<MulticastGroupsToAddT>(value);
  }
  template <typename MulticastGroupsToAddT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithMulticastGroupsToAdd(MulticastGroupsToAddT&& value) {
    SetMulticastGroupsToAdd(std::forward<MulticastGroupsToAddT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddMulticastGroupsToAdd(MulticastGroupsToAddT&& value) {
    m_multicastGroupsToAddHasBeenSet = true;
    m_multicastGroupsToAdd.emplace_back(std::forward<MulticastGroupsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMulticastGroupsToRemove(MulticastGroupsToRemoveT&& value) {
    m_multicastGroupsToRemoveHasBeenSet = true;
    m_multicastGroupsToRemove = std::forward<MulticastGroupsToRemoveT>(value);
  }
  template <typename MulticastGroupsToRemoveT = Aws::Vector<Aws::String>>
  UpdateNetworkAnalyzerConfigurationRequest& WithMulticastGroupsToRemove(MulticastGroupsToRemoveT&& value) {
    SetMulticastGroupsToRemove(std::forward<MulticastGroupsToRemoveT>(value));
    return *this;
  }
  ...
  UpdateNetworkAnalyzerConfigurationRequest& AddMulticastGroupsToRemove(MulticastGroupsToRemoveT&& value) {
    m_multicastGroupsToRemoveHasBeenSet = true;
    m_multicastGroupsToRemove.emplace_back(std::forward<MulticastGroupsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
