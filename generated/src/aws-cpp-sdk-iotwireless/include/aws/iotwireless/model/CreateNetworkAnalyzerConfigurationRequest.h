...
class CreateNetworkAnalyzerConfigurationRequest : public IoTWirelessRequest {
 public:
  ...
  void SetTraceContent(TraceContentT&& value) {
    ...
    m_traceContent = std::forward<TraceContentT>(value);
  }
  template <typename TraceContentT = TraceContent>
  CreateNetworkAnalyzerConfigurationRequest& WithTraceContent(TraceContentT&& value) {
    SetTraceContent(std::forward<TraceContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessDevices(WirelessDevicesT&& value) {
    ...
    m_wirelessDevices = std::forward<WirelessDevicesT>(value);
  }
  template <typename WirelessDevicesT = Aws::Vector<Aws::String>>
  CreateNetworkAnalyzerConfigurationRequest& WithWirelessDevices(WirelessDevicesT&& value) {
    SetWirelessDevices(std::forward<WirelessDevicesT>(value));
    return *this;
  }
  ...
  CreateNetworkAnalyzerConfigurationRequest& AddWirelessDevices(WirelessDevicesT&& value) {
    m_wirelessDevicesHasBeenSet = true;
    m_wirelessDevices.emplace_back(std::forward<WirelessDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWirelessGateways(WirelessGatewaysT&& value) {
    ...
    m_wirelessGateways = std::forward<WirelessGatewaysT>(value);
  }
  template <typename WirelessGatewaysT = Aws::Vector<Aws::String>>
  CreateNetworkAnalyzerConfigurationRequest& WithWirelessGateways(WirelessGatewaysT&& value) {
    SetWirelessGateways(std::forward<WirelessGatewaysT>(value));
    return *this;
  }
  ...
  CreateNetworkAnalyzerConfigurationRequest& AddWirelessGateways(WirelessGatewaysT&& value) {
    m_wirelessGatewaysHasBeenSet = true;
    m_wirelessGateways.emplace_back(std::forward<WirelessGatewaysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMulticastGroups(MulticastGroupsT&& value) {
    ...
    m_multicastGroups = std::forward<MulticastGroupsT>(value);
  }
  template <typename MulticastGroupsT = Aws::Vector<Aws::String>>
  CreateNetworkAnalyzerConfigurationRequest& WithMulticastGroups(MulticastGroupsT&& value) {
    SetMulticastGroups(std::forward<MulticastGroupsT>(value));
    return *this;
  }
  ...
  CreateNetworkAnalyzerConfigurationRequest& AddMulticastGroups(MulticastGroupsT&& value) {
    m_multicastGroupsHasBeenSet = true;
    m_multicastGroups.emplace_back(std::forward<MulticastGroupsT>(value));
    return *this;
  }
  ///@}
 private:
