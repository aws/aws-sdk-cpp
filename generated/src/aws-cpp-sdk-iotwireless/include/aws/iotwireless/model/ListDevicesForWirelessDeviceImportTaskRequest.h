...
class ListDevicesForWirelessDeviceImportTaskRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListDevicesForWirelessDeviceImportTaskRequest& WithId(IdT&& value) {
  ...
  inline ListDevicesForWirelessDeviceImportTaskRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDevicesForWirelessDeviceImportTaskRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetStatus(OnboardStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListDevicesForWirelessDeviceImportTaskRequest& WithStatus(OnboardStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
