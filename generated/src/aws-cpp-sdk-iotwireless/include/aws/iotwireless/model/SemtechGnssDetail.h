...
class SemtechGnssDetail {
 public:
  ...
  inline void SetProvider(PositionSolverProvider value) {
    m_providerHasBeenSet = true;
    m_provider = value;
  }
  inline SemtechGnssDetail& WithProvider(PositionSolverProvider value) {
    SetProvider(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(PositionSolverType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SemtechGnssDetail& WithType(PositionSolverType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PositionConfigurationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SemtechGnssDetail& WithStatus(PositionConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFec(PositionConfigurationFec value) {
    m_fecHasBeenSet = true;
    m_fec = value;
  }
  inline SemtechGnssDetail& WithFec(PositionConfigurationFec value) {
    SetFec(value);
    return *this;
  }
  ///@}
