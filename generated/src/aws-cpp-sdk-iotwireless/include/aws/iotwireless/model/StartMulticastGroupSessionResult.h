...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API StartMulticastGroupSessionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartMulticastGroupSessionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
