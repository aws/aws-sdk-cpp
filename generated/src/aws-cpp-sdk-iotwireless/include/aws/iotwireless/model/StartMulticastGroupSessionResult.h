...
namespace Model
{
  ...
  public:
    ...
    inline StartMulticastGroupSessionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartMulticastGroupSessionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartMulticastGroupSessionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
