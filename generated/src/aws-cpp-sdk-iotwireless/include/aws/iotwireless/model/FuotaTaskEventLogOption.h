...
class FuotaTaskEventLogOption {
 public:
  ...
  inline void SetEvent(FuotaTaskEvent value) {
    m_eventHasBeenSet = true;
    m_event = value;
  }
  inline FuotaTaskEventLogOption& WithEvent(FuotaTaskEvent value) {
    SetEvent(value);
    return *this;
  }
  ///@}
  ...
  inline FuotaTaskEventLogOption& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
