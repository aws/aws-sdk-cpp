...
class GetFuotaTaskResult {
 public:
  ...
  inline void SetStatus(FuotaTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetFuotaTaskResult& WithStatus(FuotaTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetFuotaTaskResult& WithRedundancyPercent(int value) {
  ...
  inline GetFuotaTaskResult& WithFragmentSizeBytes(int value) {
  ...
  inline GetFuotaTaskResult& WithFragmentIntervalMS(int value) {
