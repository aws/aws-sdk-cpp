...
class GsmObj {
 public:
  ...
  inline GsmObj& WithMcc(int value) {
    SetMcc(value);
    return *this;
  }
  ///@}
  ...
  inline GsmObj& WithMnc(int value) {
    SetMnc(value);
    return *this;
  }
  ///@}
  ...
  inline GsmObj& WithLac(int value) {
    SetLac(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGeranCid(int value) {
    m_geranCidHasBeenSet = true;
    m_geranCid = value;
  }
  inline GsmObj& WithGeranCid(int value) {
    SetGeranCid(value);
    return *this;
  }
  ///@}
  ...
  void SetGsmLocalId(GsmLocalIdT&& value) {
    ...
    m_gsmLocalId = std::forward<GsmLocalIdT>(value);
  }
  template <typename GsmLocalIdT = GsmLocalId>
  GsmObj& WithGsmLocalId(GsmLocalIdT&& value) {
    SetGsmLocalId(std::forward<GsmLocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGsmTimingAdvance(int value) {
    m_gsmTimingAdvanceHasBeenSet = true;
    m_gsmTimingAdvance = value;
  }
  inline GsmObj& WithGsmTimingAdvance(int value) {
    SetGsmTimingAdvance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRxLevel(int value) {
    m_rxLevelHasBeenSet = true;
    m_rxLevel = value;
  }
  inline GsmObj& WithRxLevel(int value) {
    SetRxLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetGsmNmr(GsmNmrT&& value) {
    ...
    m_gsmNmr = std::forward<GsmNmrT>(value);
  }
  template <typename GsmNmrT = Aws::Vector<GsmNmrObj>>
  GsmObj& WithGsmNmr(GsmNmrT&& value) {
    SetGsmNmr(std::forward<GsmNmrT>(value));
    return *this;
  }
  template <typename GsmNmrT = GsmNmrObj>
  GsmObj& AddGsmNmr(GsmNmrT&& value) {
    m_gsmNmrHasBeenSet = true;
    m_gsmNmr.emplace_back(std::forward<GsmNmrT>(value));
    return *this;
  }
  ///@}
 private:
