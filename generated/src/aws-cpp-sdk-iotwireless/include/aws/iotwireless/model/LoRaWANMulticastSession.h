...
class LoRaWANMulticastSession {
 public:
  ...
  inline LoRaWANMulticastSession& WithDlDr(int value) {
    SetDlDr(value);
    return *this;
  }
  ///@}
  ...
  inline LoRaWANMulticastSession& WithDlFreq(int value) {
    SetDlFreq(value);
    return *this;
  }
  ///@}
  ...
  template <typename SessionStartTimeT = Aws::Utils::DateTime>
  LoRaWANMulticastSession& WithSessionStartTime(SessionStartTimeT&& value) {
  ...
  inline void SetSessionTimeout(int value) {
    m_sessionTimeoutHasBeenSet = true;
    m_sessionTimeout = value;
  }
  inline LoRaWANMulticastSession& WithSessionTimeout(int value) {
  ...
  inline LoRaWANMulticastSession& WithPingSlotPeriod(int value) {
