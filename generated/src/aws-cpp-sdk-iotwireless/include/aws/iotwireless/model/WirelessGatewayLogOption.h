...
class WirelessGatewayLogOption {
 public:
  ...
  inline void SetType(WirelessGatewayType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline WirelessGatewayLogOption& WithType(WirelessGatewayType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline WirelessGatewayLogOption& WithLogLevel(LogLevel value) {
    SetLogLevel(value);
    return *this;
  }
  ///@}
