...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeregisterWirelessDeviceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterWirelessDeviceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
