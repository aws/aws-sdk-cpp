...
class ListQueuedMessagesRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListQueuedMessagesRequest& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQueuedMessagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQueuedMessagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListQueuedMessagesRequest& WithWirelessDeviceType(WirelessDeviceType value) {
