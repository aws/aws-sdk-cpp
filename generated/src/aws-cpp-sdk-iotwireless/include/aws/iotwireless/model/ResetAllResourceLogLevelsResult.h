...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API ResetAllResourceLogLevelsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ResetAllResourceLogLevelsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
