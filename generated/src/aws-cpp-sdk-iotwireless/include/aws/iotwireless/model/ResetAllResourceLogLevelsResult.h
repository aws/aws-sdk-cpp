...
namespace Model
{
  ...
  public:
    ...
    inline ResetAllResourceLogLevelsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ResetAllResourceLogLevelsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ResetAllResourceLogLevelsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
