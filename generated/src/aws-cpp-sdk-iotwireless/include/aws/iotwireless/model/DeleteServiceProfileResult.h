...
namespace Model
{
  ...
  public:
    ...
    inline DeleteServiceProfileResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteServiceProfileResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteServiceProfileResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
