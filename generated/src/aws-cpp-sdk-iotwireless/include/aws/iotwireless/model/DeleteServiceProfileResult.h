...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeleteServiceProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteServiceProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
