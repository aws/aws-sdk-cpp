...
class LoRaWANGatewayVersion {
 public:
  ...
  template <typename PackageVersionT = Aws::String>
  LoRaWANGatewayVersion& WithPackageVersion(PackageVersionT&& value) {
  ...
  template <typename ModelT = Aws::String>
  LoRaWANGatewayVersion& WithModel(ModelT&& value) {
  ...
  void SetStation(StationT&& value) {
    m_stationHasBeenSet = true;
    m_station = std::forward<StationT>(value);
  }
  template <typename StationT = Aws::String>
  LoRaWANGatewayVersion& WithStation(StationT&& value) {
    SetStation(std::forward<StationT>(value));
    return *this;
  }
  ///@}
 private:
