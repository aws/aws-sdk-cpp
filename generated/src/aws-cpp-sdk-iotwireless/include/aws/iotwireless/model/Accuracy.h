...
class Accuracy {
 public:
  ...
  inline void SetHorizontalAccuracy(double value) {
    m_horizontalAccuracyHasBeenSet = true;
    m_horizontalAccuracy = value;
  }
  inline Accuracy& WithHorizontalAccuracy(double value) {
  ...
  inline void SetVerticalAccuracy(double value) {
    m_verticalAccuracyHasBeenSet = true;
    m_verticalAccuracy = value;
  }
  inline Accuracy& WithVerticalAccuracy(double value) {
