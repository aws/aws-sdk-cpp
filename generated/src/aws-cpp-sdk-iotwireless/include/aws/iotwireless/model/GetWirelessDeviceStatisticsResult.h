...
class GetWirelessDeviceStatisticsResult {
 public:
  ...
  template <typename WirelessDeviceIdT = Aws::String>
  GetWirelessDeviceStatisticsResult& WithWirelessDeviceId(WirelessDeviceIdT&& value) {
  ...
  template <typename LastUplinkReceivedAtT = Aws::String>
  GetWirelessDeviceStatisticsResult& WithLastUplinkReceivedAt(LastUplinkReceivedAtT&& value) {
  ...
  template <typename LoRaWANT = LoRaWANDeviceMetadata>
  GetWirelessDeviceStatisticsResult& WithLoRaWAN(LoRaWANT&& value) {
  ...
  template <typename SidewalkT = SidewalkDeviceMetadata>
  GetWirelessDeviceStatisticsResult& WithSidewalk(SidewalkT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWirelessDeviceStatisticsResult& WithRequestId(RequestIdT&& value) {
