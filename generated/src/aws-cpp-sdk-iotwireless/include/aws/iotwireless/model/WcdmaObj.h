...
class WcdmaObj {
 public:
  ...
  inline WcdmaObj& WithMcc(int value) {
    SetMcc(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaObj& WithMnc(int value) {
    SetMnc(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaObj& WithLac(int value) {
    SetLac(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaObj& WithUtranCid(int value) {
    SetUtranCid(value);
    return *this;
  }
  ///@}
  ...
  void SetWcdmaLocalId(WcdmaLocalIdT&& value) {
    ...
    m_wcdmaLocalId = std::forward<WcdmaLocalIdT>(value);
  }
  template <typename WcdmaLocalIdT = WcdmaLocalId>
  WcdmaObj& WithWcdmaLocalId(WcdmaLocalIdT&& value) {
    SetWcdmaLocalId(std::forward<WcdmaLocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline WcdmaObj& WithRscp(int value) {
    SetRscp(value);
    return *this;
  }
  ///@}
  ...
  inline WcdmaObj& WithPathLoss(int value) {
    SetPathLoss(value);
    return *this;
  }
  ///@}
  ...
  void SetWcdmaNmr(WcdmaNmrT&& value) {
    ...
    m_wcdmaNmr = std::forward<WcdmaNmrT>(value);
  }
  template <typename WcdmaNmrT = Aws::Vector<WcdmaNmrObj>>
  WcdmaObj& WithWcdmaNmr(WcdmaNmrT&& value) {
    SetWcdmaNmr(std::forward<WcdmaNmrT>(value));
    return *this;
  }
  template <typename WcdmaNmrT = WcdmaNmrObj>
  WcdmaObj& AddWcdmaNmr(WcdmaNmrT&& value) {
    m_wcdmaNmrHasBeenSet = true;
    m_wcdmaNmr.emplace_back(std::forward<WcdmaNmrT>(value));
    return *this;
  }
  ///@}
 private:
