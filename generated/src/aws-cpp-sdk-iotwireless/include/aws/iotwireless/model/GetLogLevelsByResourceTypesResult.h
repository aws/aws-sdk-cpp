...
class GetLogLevelsByResourceTypesResult {
 public:
  ...
  inline GetLogLevelsByResourceTypesResult& WithDefaultLogLevel(LogLevel value) {
  ...
  template <typename WirelessGatewayLogOptionsT = Aws::Vector<WirelessGatewayLogOption>>
  GetLogLevelsByResourceTypesResult& WithWirelessGatewayLogOptions(WirelessGatewayLogOptionsT&& value) {
  ...
  GetLogLevelsByResourceTypesResult& AddWirelessGatewayLogOptions(WirelessGatewayLogOptionsT&& value) {
    m_wirelessGatewayLogOptionsHasBeenSet = true;
  ...
  template <typename WirelessDeviceLogOptionsT = Aws::Vector<WirelessDeviceLogOption>>
  GetLogLevelsByResourceTypesResult& WithWirelessDeviceLogOptions(WirelessDeviceLogOptionsT&& value) {
  ...
  GetLogLevelsByResourceTypesResult& AddWirelessDeviceLogOptions(WirelessDeviceLogOptionsT&& value) {
    m_wirelessDeviceLogOptionsHasBeenSet = true;
  ...
  template <typename FuotaTaskLogOptionsT = Aws::Vector<FuotaTaskLogOption>>
  GetLogLevelsByResourceTypesResult& WithFuotaTaskLogOptions(FuotaTaskLogOptionsT&& value) {
    SetFuotaTaskLogOptions(std::forward<FuotaTaskLogOptionsT>(value));
    return *this;
  }
  template <typename FuotaTaskLogOptionsT = FuotaTaskLogOption>
  GetLogLevelsByResourceTypesResult& AddFuotaTaskLogOptions(FuotaTaskLogOptionsT&& value) {
    m_fuotaTaskLogOptionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetLogLevelsByResourceTypesResult& WithRequestId(RequestIdT&& value) {
