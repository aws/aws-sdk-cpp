...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API FuotaTask() = default;
    ...
    template<typename IdT = Aws::String>
    FuotaTask& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    FuotaTask& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    FuotaTask& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
