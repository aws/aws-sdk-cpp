...
class SidewalkResourceTypeEventConfiguration {
 public:
  ...
  inline void SetWirelessDeviceEventTopic(EventNotificationTopicStatus value) {
    m_wirelessDeviceEventTopicHasBeenSet = true;
    m_wirelessDeviceEventTopic = value;
  }
  inline SidewalkResourceTypeEventConfiguration& WithWirelessDeviceEventTopic(EventNotificationTopicStatus value) {
    SetWirelessDeviceEventTopic(value);
    return *this;
  }
  ///@}
 private:
