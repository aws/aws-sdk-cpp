...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API UpdateDestinationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
