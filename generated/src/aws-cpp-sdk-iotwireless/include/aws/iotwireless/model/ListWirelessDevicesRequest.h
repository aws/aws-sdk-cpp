...
class ListWirelessDevicesRequest : public IoTWirelessRequest {
 public:
  ...
  inline ListWirelessDevicesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListWirelessDevicesRequest& WithWirelessDeviceType(WirelessDeviceType value) {
  ...
  void SetFuotaTaskId(FuotaTaskIdT&& value) {
    m_fuotaTaskIdHasBeenSet = true;
    m_fuotaTaskId = std::forward<FuotaTaskIdT>(value);
  }
  template <typename FuotaTaskIdT = Aws::String>
  ListWirelessDevicesRequest& WithFuotaTaskId(FuotaTaskIdT&& value) {
    SetFuotaTaskId(std::forward<FuotaTaskIdT>(value));
    return *this;
  }
  ///@}
