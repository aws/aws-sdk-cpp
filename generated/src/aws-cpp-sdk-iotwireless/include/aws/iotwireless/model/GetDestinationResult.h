...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    GetDestinationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ExpressionT = Aws::String>
    GetDestinationResult& WithExpression(ExpressionT&& value) { SetExpression(std::forward<ExpressionT>(value)); return *this;}
    ///@}
    ...
    inline GetDestinationResult& WithExpressionType(ExpressionType value) { SetExpressionType(value); return *this;}
    ///@}
