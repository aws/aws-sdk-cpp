...
class UpdateWirelessGatewayTaskCreate {
 public:
  ...
  void SetUpdateDataSource(UpdateDataSourceT&& value) {
    ...
    m_updateDataSource = std::forward<UpdateDataSourceT>(value);
  }
  template <typename UpdateDataSourceT = Aws::String>
  UpdateWirelessGatewayTaskCreate& WithUpdateDataSource(UpdateDataSourceT&& value) {
    SetUpdateDataSource(std::forward<UpdateDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateDataRole(UpdateDataRoleT&& value) {
    ...
    m_updateDataRole = std::forward<UpdateDataRoleT>(value);
  }
  template <typename UpdateDataRoleT = Aws::String>
  UpdateWirelessGatewayTaskCreate& WithUpdateDataRole(UpdateDataRoleT&& value) {
    SetUpdateDataRole(std::forward<UpdateDataRoleT>(value));
    return *this;
  }
  ///@}
