...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API AssociateWirelessDeviceWithThingRequest() = default;
    ...
    template<typename IdT = Aws::String>
    AssociateWirelessDeviceWithThingRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ThingArnT = Aws::String>
    AssociateWirelessDeviceWithThingRequest& WithThingArn(ThingArnT&& value) { SetThingArn(std::forward<ThingArnT>(value)); return *this;}
    ///@}
  private:
