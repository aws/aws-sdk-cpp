...
class GetServiceEndpointResult {
 public:
  ...
  inline GetServiceEndpointResult& WithServiceType(WirelessGatewayServiceType value) {
  ...
  void SetServiceEndpoint(ServiceEndpointT&& value) {
    ...
    m_serviceEndpoint = std::forward<ServiceEndpointT>(value);
  }
  template <typename ServiceEndpointT = Aws::String>
  GetServiceEndpointResult& WithServiceEndpoint(ServiceEndpointT&& value) {
    SetServiceEndpoint(std::forward<ServiceEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServerTrust(ServerTrustT&& value) {
    ...
    m_serverTrust = std::forward<ServerTrustT>(value);
  }
  template <typename ServerTrustT = Aws::String>
  GetServiceEndpointResult& WithServerTrust(ServerTrustT&& value) {
    SetServerTrust(std::forward<ServerTrustT>(value));
    return *this;
  }
  ///@}
