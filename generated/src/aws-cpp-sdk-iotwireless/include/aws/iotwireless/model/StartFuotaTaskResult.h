...
namespace Model
{
  ...
  public:
    ...
    inline StartFuotaTaskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartFuotaTaskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartFuotaTaskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
