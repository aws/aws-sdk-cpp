...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API StartFuotaTaskResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartFuotaTaskResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
