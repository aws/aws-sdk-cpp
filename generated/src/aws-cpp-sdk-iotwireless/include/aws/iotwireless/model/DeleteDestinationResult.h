...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API DeleteDestinationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
