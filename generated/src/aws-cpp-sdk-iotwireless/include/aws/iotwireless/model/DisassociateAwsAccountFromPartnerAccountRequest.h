...
class DisassociateAwsAccountFromPartnerAccountRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename PartnerAccountIdT = Aws::String>
  DisassociateAwsAccountFromPartnerAccountRequest& WithPartnerAccountId(PartnerAccountIdT&& value) {
  ...
  inline DisassociateAwsAccountFromPartnerAccountRequest& WithPartnerType(PartnerType value) {
