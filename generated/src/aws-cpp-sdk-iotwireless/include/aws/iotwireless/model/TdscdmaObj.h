...
class TdscdmaObj {
 public:
  ...
  inline TdscdmaObj& WithMcc(int value) {
    SetMcc(value);
    return *this;
  }
  ///@}
  ...
  inline TdscdmaObj& WithMnc(int value) {
    SetMnc(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLac(int value) {
    m_lacHasBeenSet = true;
    m_lac = value;
  }
  inline TdscdmaObj& WithLac(int value) {
    SetLac(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUtranCid(int value) {
    m_utranCidHasBeenSet = true;
    m_utranCid = value;
  }
  inline TdscdmaObj& WithUtranCid(int value) {
    SetUtranCid(value);
    return *this;
  }
  ///@}
  ...
  void SetTdscdmaLocalId(TdscdmaLocalIdT&& value) {
    ...
    m_tdscdmaLocalId = std::forward<TdscdmaLocalIdT>(value);
  }
  template <typename TdscdmaLocalIdT = TdscdmaLocalId>
  TdscdmaObj& WithTdscdmaLocalId(TdscdmaLocalIdT&& value) {
    SetTdscdmaLocalId(std::forward<TdscdmaLocalIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTdscdmaTimingAdvance(int value) {
    m_tdscdmaTimingAdvanceHasBeenSet = true;
    m_tdscdmaTimingAdvance = value;
  }
  inline TdscdmaObj& WithTdscdmaTimingAdvance(int value) {
    SetTdscdmaTimingAdvance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRscp(int value) {
    m_rscpHasBeenSet = true;
    m_rscp = value;
  }
  inline TdscdmaObj& WithRscp(int value) {
    SetRscp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPathLoss(int value) {
    m_pathLossHasBeenSet = true;
    m_pathLoss = value;
  }
  inline TdscdmaObj& WithPathLoss(int value) {
    SetPathLoss(value);
    return *this;
  }
  ///@}
  ...
  void SetTdscdmaNmr(TdscdmaNmrT&& value) {
    ...
    m_tdscdmaNmr = std::forward<TdscdmaNmrT>(value);
  }
  template <typename TdscdmaNmrT = Aws::Vector<TdscdmaNmrObj>>
  TdscdmaObj& WithTdscdmaNmr(TdscdmaNmrT&& value) {
    SetTdscdmaNmr(std::forward<TdscdmaNmrT>(value));
    return *this;
  }
  template <typename TdscdmaNmrT = TdscdmaNmrObj>
  TdscdmaObj& AddTdscdmaNmr(TdscdmaNmrT&& value) {
    m_tdscdmaNmrHasBeenSet = true;
    m_tdscdmaNmr.emplace_back(std::forward<TdscdmaNmrT>(value));
    return *this;
  }
  ///@}
 private:
