...
class ConnectionStatusEventConfiguration {
 public:
  ...
  inline void SetWirelessGatewayIdEventTopic(EventNotificationTopicStatus value) {
    m_wirelessGatewayIdEventTopicHasBeenSet = true;
    m_wirelessGatewayIdEventTopic = value;
  }
  inline ConnectionStatusEventConfiguration& WithWirelessGatewayIdEventTopic(EventNotificationTopicStatus value) {
    SetWirelessGatewayIdEventTopic(value);
    return *this;
  }
  ///@}
 private:
