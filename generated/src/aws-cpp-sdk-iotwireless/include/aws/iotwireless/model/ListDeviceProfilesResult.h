...
class ListDeviceProfilesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetDeviceProfileList(DeviceProfileListT&& value) {
    m_deviceProfileListHasBeenSet = true;
    m_deviceProfileList = std::forward<DeviceProfileListT>(value);
  }
  template <typename DeviceProfileListT = Aws::Vector<DeviceProfile>>
  ListDeviceProfilesResult& WithDeviceProfileList(DeviceProfileListT&& value) {
    SetDeviceProfileList(std::forward<DeviceProfileListT>(value));
    return *this;
  }
  template <typename DeviceProfileListT = DeviceProfile>
  ListDeviceProfilesResult& AddDeviceProfileList(DeviceProfileListT&& value) {
    m_deviceProfileListHasBeenSet = true;
    m_deviceProfileList.emplace_back(std::forward<DeviceProfileListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceProfilesResult& WithRequestId(RequestIdT&& value) {
