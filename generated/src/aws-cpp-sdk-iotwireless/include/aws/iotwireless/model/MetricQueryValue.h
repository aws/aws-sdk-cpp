...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>The minimum of the values of the all data points collected during the
     * period.</p>
     */
    ...
    /**
     * <p>The maximum of the values of the all data points collected during the
     * period.</p>
     */
    ...
    /**
     * <p>The average of the values of the all data points collected during the
     * period.</p>
     */
    ...
    /**
     * <p>The standard deviation of the values of the all data points collected during
     * the period.</p>
     */
    ...
    /**
     * <p>The 90th percentile of the values of the all data points collected during the
     * period.</p>
     */
