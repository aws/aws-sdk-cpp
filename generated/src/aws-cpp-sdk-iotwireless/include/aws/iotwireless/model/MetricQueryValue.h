...
class MetricQueryValue {
 public:
  ...
  inline MetricQueryValue& WithMin(double value) {
    SetMin(value);
    return *this;
  }
  ///@}
  ...
  inline MetricQueryValue& WithMax(double value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline MetricQueryValue& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline MetricQueryValue& WithAvg(double value) {
    SetAvg(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStd(double value) {
    m_stdHasBeenSet = true;
    m_std = value;
  }
  inline MetricQueryValue& WithStd(double value) {
    SetStd(value);
    return *this;
  }
  ///@}
  ...
  inline void SetP90(double value) {
    m_p90HasBeenSet = true;
    m_p90 = value;
  }
  inline MetricQueryValue& WithP90(double value) {
    SetP90(value);
    return *this;
  }
  ///@}
