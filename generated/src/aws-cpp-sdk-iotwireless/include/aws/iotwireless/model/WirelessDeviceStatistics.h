...
class WirelessDeviceStatistics {
 public:
  ...
  inline WirelessDeviceStatistics& WithType(WirelessDeviceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFuotaDeviceStatus(FuotaDeviceStatus value) {
    m_fuotaDeviceStatusHasBeenSet = true;
    m_fuotaDeviceStatus = value;
  }
  inline WirelessDeviceStatistics& WithFuotaDeviceStatus(FuotaDeviceStatus value) {
    SetFuotaDeviceStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetMulticastDeviceStatus(MulticastDeviceStatusT&& value) {
    ...
    m_multicastDeviceStatus = std::forward<MulticastDeviceStatusT>(value);
  }
  template <typename MulticastDeviceStatusT = Aws::String>
  WirelessDeviceStatistics& WithMulticastDeviceStatus(MulticastDeviceStatusT&& value) {
    SetMulticastDeviceStatus(std::forward<MulticastDeviceStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMcGroupId(int value) {
    m_mcGroupIdHasBeenSet = true;
    m_mcGroupId = value;
  }
  inline WirelessDeviceStatistics& WithMcGroupId(int value) {
    SetMcGroupId(value);
    return *this;
  }
  ///@}
