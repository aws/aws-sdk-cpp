...
class OtaaV1_0_x {
 public:
  ...
  void SetAppKey(AppKeyT&& value) {
    ...
    m_appKey = std::forward<AppKeyT>(value);
  }
  template <typename AppKeyT = Aws::String>
  OtaaV1_0_x& WithAppKey(AppKeyT&& value) {
    SetAppKey(std::forward<AppKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppEui(AppEuiT&& value) {
    ...
    m_appEui = std::forward<AppEuiT>(value);
  }
  template <typename AppEuiT = Aws::String>
  OtaaV1_0_x& WithAppEui(AppEuiT&& value) {
    SetAppEui(std::forward<AppEuiT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJoinEui(JoinEuiT&& value) {
    ...
    m_joinEui = std::forward<JoinEuiT>(value);
  }
  template <typename JoinEuiT = Aws::String>
  OtaaV1_0_x& WithJoinEui(JoinEuiT&& value) {
    SetJoinEui(std::forward<JoinEuiT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGenAppKey(GenAppKeyT&& value) {
    ...
    m_genAppKey = std::forward<GenAppKeyT>(value);
  }
  template <typename GenAppKeyT = Aws::String>
  OtaaV1_0_x& WithGenAppKey(GenAppKeyT&& value) {
    SetGenAppKey(std::forward<GenAppKeyT>(value));
    return *this;
  }
  ///@}
 private:
