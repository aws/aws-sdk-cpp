...
namespace Model
{
  ...
  {
  public:
    AWS_IOTWIRELESS_API AssociateWirelessDeviceWithMulticastGroupRequest() = default;
    ...
    template<typename IdT = Aws::String>
    AssociateWirelessDeviceWithMulticastGroupRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename WirelessDeviceIdT = Aws::String>
    AssociateWirelessDeviceWithMulticastGroupRequest& WithWirelessDeviceId(WirelessDeviceIdT&& value) { SetWirelessDeviceId(std::forward<WirelessDeviceIdT>(value)); return *this;}
    ///@}
  private:
