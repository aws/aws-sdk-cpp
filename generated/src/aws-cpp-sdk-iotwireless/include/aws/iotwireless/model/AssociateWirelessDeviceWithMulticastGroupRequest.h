...
class AssociateWirelessDeviceWithMulticastGroupRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  AssociateWirelessDeviceWithMulticastGroupRequest& WithId(IdT&& value) {
  ...
  template <typename WirelessDeviceIdT = Aws::String>
  AssociateWirelessDeviceWithMulticastGroupRequest& WithWirelessDeviceId(WirelessDeviceIdT&& value) {
