...
class DakCertificateMetadata {
 public:
  ...
  inline void SetMaxAllowedSignature(int value) {
    m_maxAllowedSignatureHasBeenSet = true;
    m_maxAllowedSignature = value;
  }
  inline DakCertificateMetadata& WithMaxAllowedSignature(int value) {
    SetMaxAllowedSignature(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFactorySupport(bool value) {
    m_factorySupportHasBeenSet = true;
    m_factorySupport = value;
  }
  inline DakCertificateMetadata& WithFactorySupport(bool value) {
    SetFactorySupport(value);
    return *this;
  }
  ///@}
  ...
  void SetApId(ApIdT&& value) {
    m_apIdHasBeenSet = true;
    m_apId = std::forward<ApIdT>(value);
  }
  template <typename ApIdT = Aws::String>
  DakCertificateMetadata& WithApId(ApIdT&& value) {
    SetApId(std::forward<ApIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceTypeId(DeviceTypeIdT&& value) {
    m_deviceTypeIdHasBeenSet = true;
    m_deviceTypeId = std::forward<DeviceTypeIdT>(value);
  }
  template <typename DeviceTypeIdT = Aws::String>
  DakCertificateMetadata& WithDeviceTypeId(DeviceTypeIdT&& value) {
    SetDeviceTypeId(std::forward<DeviceTypeIdT>(value));
    return *this;
  }
  ///@}
 private:
