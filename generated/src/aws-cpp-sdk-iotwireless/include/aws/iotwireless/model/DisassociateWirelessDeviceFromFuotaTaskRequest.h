...
class DisassociateWirelessDeviceFromFuotaTaskRequest : public IoTWirelessRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  DisassociateWirelessDeviceFromFuotaTaskRequest& WithId(IdT&& value) {
  ...
  template <typename WirelessDeviceIdT = Aws::String>
  DisassociateWirelessDeviceFromFuotaTaskRequest& WithWirelessDeviceId(WirelessDeviceIdT&& value) {
