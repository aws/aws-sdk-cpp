...
class LoRaWANGatewayMetadata {
 public:
  ...
  void SetGatewayEui(GatewayEuiT&& value) {
    ...
    m_gatewayEui = std::forward<GatewayEuiT>(value);
  }
  template <typename GatewayEuiT = Aws::String>
  LoRaWANGatewayMetadata& WithGatewayEui(GatewayEuiT&& value) {
    SetGatewayEui(std::forward<GatewayEuiT>(value));
    return *this;
  }
  ///@}
  ...
  inline LoRaWANGatewayMetadata& WithSnr(double value) {
    SetSnr(value);
    return *this;
  }
  ///@}
  ...
  inline LoRaWANGatewayMetadata& WithRssi(double value) {
    SetRssi(value);
    return *this;
  }
  ///@}
