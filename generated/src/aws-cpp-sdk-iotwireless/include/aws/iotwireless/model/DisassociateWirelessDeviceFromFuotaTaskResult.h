...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateWirelessDeviceFromFuotaTaskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateWirelessDeviceFromFuotaTaskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateWirelessDeviceFromFuotaTaskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
