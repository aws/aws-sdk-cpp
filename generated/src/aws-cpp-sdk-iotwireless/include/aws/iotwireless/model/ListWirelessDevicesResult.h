...
class ListWirelessDevicesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWirelessDevicesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetWirelessDeviceList(WirelessDeviceListT&& value) {
    m_wirelessDeviceListHasBeenSet = true;
    m_wirelessDeviceList = std::forward<WirelessDeviceListT>(value);
  }
  template <typename WirelessDeviceListT = Aws::Vector<WirelessDeviceStatistics>>
  ListWirelessDevicesResult& WithWirelessDeviceList(WirelessDeviceListT&& value) {
    SetWirelessDeviceList(std::forward<WirelessDeviceListT>(value));
    return *this;
  }
  template <typename WirelessDeviceListT = WirelessDeviceStatistics>
  ListWirelessDevicesResult& AddWirelessDeviceList(WirelessDeviceListT&& value) {
    m_wirelessDeviceListHasBeenSet = true;
    m_wirelessDeviceList.emplace_back(std::forward<WirelessDeviceListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWirelessDevicesResult& WithRequestId(RequestIdT&& value) {
