...
namespace Model
{
  ...
  public:
    ...
    inline ListWirelessDevicesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListWirelessDevicesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListWirelessDevicesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
