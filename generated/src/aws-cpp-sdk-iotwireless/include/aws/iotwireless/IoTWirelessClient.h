 ...
 * devices to AWS IoT, use the IoT Wireless API. These wireless devices use the Low
 * Power Wide Area Networking (LPWAN) communication protocol to communicate with
 * AWS IoT. </p> <p>Using the API, you can perform create, read, update, and delete
 * operations for your wireless devices, gateways, destinations, and profiles.
 * After onboarding your devices, you can use the API operations to set log levels
 * and monitor your devices with CloudWatch.</p> <p>You can also use the API
 ...
 * devices in a multicast group.</p> <p>To connect to the AWS IoT Wireless Service,
 * use the Service endpoints as described in <a
...
class AWS_IOTWIRELESS_API IoTWirelessClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTWirelessClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IoTWirelessEndpointProviderBase> endpointProvider = nullptr,
      const Aws::IoTWireless::IoTWirelessClientConfiguration& clientConfiguration = Aws::IoTWireless::IoTWirelessClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateAwsAccountWithPartnerAccountOutcome AssociateAwsAccountWithPartnerAccount(
      const Model::AssociateAwsAccountWithPartnerAccountRequest& request) const;

  /**
   * A Callable wrapper for AssociateAwsAccountWithPartnerAccount that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateAwsAccountWithPartnerAccountRequestT = Model::AssociateAwsAccountWithPartnerAccountRequest>
  Model::AssociateAwsAccountWithPartnerAccountOutcomeCallable AssociateAwsAccountWithPartnerAccountCallable(
      const AssociateAwsAccountWithPartnerAccountRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateAwsAccountWithPartnerAccount, request);
  }

  /**
   * An Async wrapper for AssociateAwsAccountWithPartnerAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateAwsAccountWithPartnerAccountRequestT = Model::AssociateAwsAccountWithPartnerAccountRequest>
  void AssociateAwsAccountWithPartnerAccountAsync(const AssociateAwsAccountWithPartnerAccountRequestT& request,
                                                  const AssociateAwsAccountWithPartnerAccountResponseReceivedHandler& handler,
  ...
  virtual Model::AssociateMulticastGroupWithFuotaTaskOutcome AssociateMulticastGroupWithFuotaTask(
      const Model::AssociateMulticastGroupWithFuotaTaskRequest& request) const;

  /**
   * A Callable wrapper for AssociateMulticastGroupWithFuotaTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateMulticastGroupWithFuotaTaskRequestT = Model::AssociateMulticastGroupWithFuotaTaskRequest>
  Model::AssociateMulticastGroupWithFuotaTaskOutcomeCallable AssociateMulticastGroupWithFuotaTaskCallable(
      const AssociateMulticastGroupWithFuotaTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateMulticastGroupWithFuotaTask, request);
  }

  /**
   * An Async wrapper for AssociateMulticastGroupWithFuotaTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateMulticastGroupWithFuotaTaskRequestT = Model::AssociateMulticastGroupWithFuotaTaskRequest>
  void AssociateMulticastGroupWithFuotaTaskAsync(const AssociateMulticastGroupWithFuotaTaskRequestT& request,
                                                 const AssociateMulticastGroupWithFuotaTaskResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateWirelessDeviceWithFuotaTaskOutcome AssociateWirelessDeviceWithFuotaTask(
      const Model::AssociateWirelessDeviceWithFuotaTaskRequest& request) const;

  /**
   * A Callable wrapper for AssociateWirelessDeviceWithFuotaTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateWirelessDeviceWithFuotaTaskRequestT = Model::AssociateWirelessDeviceWithFuotaTaskRequest>
  Model::AssociateWirelessDeviceWithFuotaTaskOutcomeCallable AssociateWirelessDeviceWithFuotaTaskCallable(
      const AssociateWirelessDeviceWithFuotaTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateWirelessDeviceWithFuotaTask, request);
  }

  /**
   * An Async wrapper for AssociateWirelessDeviceWithFuotaTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateWirelessDeviceWithFuotaTaskRequestT = Model::AssociateWirelessDeviceWithFuotaTaskRequest>
  void AssociateWirelessDeviceWithFuotaTaskAsync(const AssociateWirelessDeviceWithFuotaTaskRequestT& request,
                                                 const AssociateWirelessDeviceWithFuotaTaskResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateWirelessDeviceWithMulticastGroupOutcome AssociateWirelessDeviceWithMulticastGroup(
      const Model::AssociateWirelessDeviceWithMulticastGroupRequest& request) const;

  /**
   * A Callable wrapper for AssociateWirelessDeviceWithMulticastGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::AssociateWirelessDeviceWithMulticastGroupOutcomeCallable AssociateWirelessDeviceWithMulticastGroupCallable(
      const AssociateWirelessDeviceWithMulticastGroupRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateWirelessDeviceWithMulticastGroup, request);
  }

  /**
   * An Async wrapper for AssociateWirelessDeviceWithMulticastGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateWirelessDeviceWithMulticastGroupRequestT = Model::AssociateWirelessDeviceWithMulticastGroupRequest>
  void AssociateWirelessDeviceWithMulticastGroupAsync(
      const AssociateWirelessDeviceWithMulticastGroupRequestT& request,
      const AssociateWirelessDeviceWithMulticastGroupResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::AssociateWirelessDeviceWithThingOutcome AssociateWirelessDeviceWithThing(
      const Model::AssociateWirelessDeviceWithThingRequest& request) const;

  /**
   * A Callable wrapper for AssociateWirelessDeviceWithThing that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateWirelessDeviceWithThingRequestT = Model::AssociateWirelessDeviceWithThingRequest>
  Model::AssociateWirelessDeviceWithThingOutcomeCallable AssociateWirelessDeviceWithThingCallable(
      const AssociateWirelessDeviceWithThingRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateWirelessDeviceWithThing, request);
  }

  /**
   * An Async wrapper for AssociateWirelessDeviceWithThing that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateWirelessDeviceWithThingRequestT = Model::AssociateWirelessDeviceWithThingRequest>
  void AssociateWirelessDeviceWithThingAsync(const AssociateWirelessDeviceWithThingRequestT& request,
                                             const AssociateWirelessDeviceWithThingResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateWirelessGatewayWithCertificateOutcome AssociateWirelessGatewayWithCertificate(
      const Model::AssociateWirelessGatewayWithCertificateRequest& request) const;

  /**
   * A Callable wrapper for AssociateWirelessGatewayWithCertificate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateWirelessGatewayWithCertificateRequestT = Model::AssociateWirelessGatewayWithCertificateRequest>
  Model::AssociateWirelessGatewayWithCertificateOutcomeCallable AssociateWirelessGatewayWithCertificateCallable(
      const AssociateWirelessGatewayWithCertificateRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateWirelessGatewayWithCertificate, request);
  }

  /**
   * An Async wrapper for AssociateWirelessGatewayWithCertificate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateWirelessGatewayWithCertificateRequestT = Model::AssociateWirelessGatewayWithCertificateRequest>
  void AssociateWirelessGatewayWithCertificateAsync(const AssociateWirelessGatewayWithCertificateRequestT& request,
                                                    const AssociateWirelessGatewayWithCertificateResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateWirelessGatewayWithThingOutcome AssociateWirelessGatewayWithThing(
      const Model::AssociateWirelessGatewayWithThingRequest& request) const;

  /**
   * A Callable wrapper for AssociateWirelessGatewayWithThing that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateWirelessGatewayWithThingRequestT = Model::AssociateWirelessGatewayWithThingRequest>
  Model::AssociateWirelessGatewayWithThingOutcomeCallable AssociateWirelessGatewayWithThingCallable(
      const AssociateWirelessGatewayWithThingRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::AssociateWirelessGatewayWithThing, request);
  }

  /**
   * An Async wrapper for AssociateWirelessGatewayWithThing that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateWirelessGatewayWithThingRequestT = Model::AssociateWirelessGatewayWithThingRequest>
  void AssociateWirelessGatewayWithThingAsync(const AssociateWirelessGatewayWithThingRequestT& request,
                                              const AssociateWirelessGatewayWithThingResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelMulticastGroupSessionOutcome CancelMulticastGroupSession(
      const Model::CancelMulticastGroupSessionRequest& request) const;

  /**
   * A Callable wrapper for CancelMulticastGroupSession that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelMulticastGroupSessionRequestT = Model::CancelMulticastGroupSessionRequest>
  Model::CancelMulticastGroupSessionOutcomeCallable CancelMulticastGroupSessionCallable(
      const CancelMulticastGroupSessionRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::CancelMulticastGroupSession, request);
  }

  /**
   * An Async wrapper for CancelMulticastGroupSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMulticastGroupSessionRequestT = Model::CancelMulticastGroupSessionRequest>
  void CancelMulticastGroupSessionAsync(const CancelMulticastGroupSessionRequestT& request,
                                        const CancelMulticastGroupSessionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDeviceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeviceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDeviceProfileRequestT = Model::CreateDeviceProfileRequest>
  void CreateDeviceProfileAsync(const CreateDeviceProfileResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const CreateDeviceProfileRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for CreateFuotaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFuotaTaskRequestT = Model::CreateFuotaTaskRequest>
  void CreateFuotaTaskAsync(const CreateFuotaTaskRequestT& request, const CreateFuotaTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMulticastGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMulticastGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMulticastGroupRequestT = Model::CreateMulticastGroupRequest>
  void CreateMulticastGroupAsync(const CreateMulticastGroupRequestT& request, const CreateMulticastGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateNetworkAnalyzerConfigurationOutcome CreateNetworkAnalyzerConfiguration(
      const Model::CreateNetworkAnalyzerConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateNetworkAnalyzerConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateNetworkAnalyzerConfigurationRequestT = Model::CreateNetworkAnalyzerConfigurationRequest>
  Model::CreateNetworkAnalyzerConfigurationOutcomeCallable CreateNetworkAnalyzerConfigurationCallable(
      const CreateNetworkAnalyzerConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::CreateNetworkAnalyzerConfiguration, request);
  }

  /**
   * An Async wrapper for CreateNetworkAnalyzerConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateNetworkAnalyzerConfigurationRequestT = Model::CreateNetworkAnalyzerConfigurationRequest>
  void CreateNetworkAnalyzerConfigurationAsync(const CreateNetworkAnalyzerConfigurationRequestT& request,
                                               const CreateNetworkAnalyzerConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateServiceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateServiceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServiceProfileRequestT = Model::CreateServiceProfileRequest>
  void CreateServiceProfileAsync(const CreateServiceProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const CreateServiceProfileRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWirelessDevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWirelessDeviceRequestT = Model::CreateWirelessDeviceRequest>
  void CreateWirelessDeviceAsync(const CreateWirelessDeviceRequestT& request, const CreateWirelessDeviceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWirelessGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWirelessGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWirelessGatewayRequestT = Model::CreateWirelessGatewayRequest>
  void CreateWirelessGatewayAsync(const CreateWirelessGatewayRequestT& request, const CreateWirelessGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWirelessGatewayTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateWirelessGatewayTaskRequestT = Model::CreateWirelessGatewayTaskRequest>
  Model::CreateWirelessGatewayTaskOutcomeCallable CreateWirelessGatewayTaskCallable(
      const CreateWirelessGatewayTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::CreateWirelessGatewayTask, request);
  }

  /**
   * An Async wrapper for CreateWirelessGatewayTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWirelessGatewayTaskRequestT = Model::CreateWirelessGatewayTaskRequest>
  void CreateWirelessGatewayTaskAsync(const CreateWirelessGatewayTaskRequestT& request,
                                      const CreateWirelessGatewayTaskResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateWirelessGatewayTaskDefinitionOutcome CreateWirelessGatewayTaskDefinition(
      const Model::CreateWirelessGatewayTaskDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateWirelessGatewayTaskDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateWirelessGatewayTaskDefinitionRequestT = Model::CreateWirelessGatewayTaskDefinitionRequest>
  Model::CreateWirelessGatewayTaskDefinitionOutcomeCallable CreateWirelessGatewayTaskDefinitionCallable(
      const CreateWirelessGatewayTaskDefinitionRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::CreateWirelessGatewayTaskDefinition, request);
  }

  /**
   * An Async wrapper for CreateWirelessGatewayTaskDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateWirelessGatewayTaskDefinitionRequestT = Model::CreateWirelessGatewayTaskDefinitionRequest>
  void CreateWirelessGatewayTaskDefinitionAsync(const CreateWirelessGatewayTaskDefinitionRequestT& request,
                                                const CreateWirelessGatewayTaskDefinitionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDeviceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeviceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDeviceProfileRequestT = Model::DeleteDeviceProfileRequest>
  void DeleteDeviceProfileAsync(const DeleteDeviceProfileRequestT& request, const DeleteDeviceProfileResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteFuotaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteFuotaTaskRequestT = Model::DeleteFuotaTaskRequest>
  void DeleteFuotaTaskAsync(const DeleteFuotaTaskRequestT& request, const DeleteFuotaTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMulticastGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMulticastGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMulticastGroupRequestT = Model::DeleteMulticastGroupRequest>
  void DeleteMulticastGroupAsync(const DeleteMulticastGroupRequestT& request, const DeleteMulticastGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNetworkAnalyzerConfigurationOutcome DeleteNetworkAnalyzerConfiguration(
      const Model::DeleteNetworkAnalyzerConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteNetworkAnalyzerConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteNetworkAnalyzerConfigurationRequestT = Model::DeleteNetworkAnalyzerConfigurationRequest>
  Model::DeleteNetworkAnalyzerConfigurationOutcomeCallable DeleteNetworkAnalyzerConfigurationCallable(
      const DeleteNetworkAnalyzerConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DeleteNetworkAnalyzerConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteNetworkAnalyzerConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteNetworkAnalyzerConfigurationRequestT = Model::DeleteNetworkAnalyzerConfigurationRequest>
  void DeleteNetworkAnalyzerConfigurationAsync(const DeleteNetworkAnalyzerConfigurationRequestT& request,
                                               const DeleteNetworkAnalyzerConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteQueuedMessages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteQueuedMessages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQueuedMessagesRequestT = Model::DeleteQueuedMessagesRequest>
  void DeleteQueuedMessagesAsync(const DeleteQueuedMessagesRequestT& request, const DeleteQueuedMessagesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteServiceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServiceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServiceProfileRequestT = Model::DeleteServiceProfileRequest>
  void DeleteServiceProfileAsync(const DeleteServiceProfileRequestT& request, const DeleteServiceProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWirelessDevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWirelessDeviceRequestT = Model::DeleteWirelessDeviceRequest>
  void DeleteWirelessDeviceAsync(const DeleteWirelessDeviceRequestT& request, const DeleteWirelessDeviceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteWirelessDeviceImportTaskOutcome DeleteWirelessDeviceImportTask(
      const Model::DeleteWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for DeleteWirelessDeviceImportTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteWirelessDeviceImportTaskRequestT = Model::DeleteWirelessDeviceImportTaskRequest>
  Model::DeleteWirelessDeviceImportTaskOutcomeCallable DeleteWirelessDeviceImportTaskCallable(
      const DeleteWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DeleteWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for DeleteWirelessDeviceImportTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteWirelessDeviceImportTaskRequestT = Model::DeleteWirelessDeviceImportTaskRequest>
  void DeleteWirelessDeviceImportTaskAsync(const DeleteWirelessDeviceImportTaskRequestT& request,
                                           const DeleteWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWirelessGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWirelessGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWirelessGatewayRequestT = Model::DeleteWirelessGatewayRequest>
  void DeleteWirelessGatewayAsync(const DeleteWirelessGatewayRequestT& request, const DeleteWirelessGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWirelessGatewayTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteWirelessGatewayTaskRequestT = Model::DeleteWirelessGatewayTaskRequest>
  Model::DeleteWirelessGatewayTaskOutcomeCallable DeleteWirelessGatewayTaskCallable(
      const DeleteWirelessGatewayTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DeleteWirelessGatewayTask, request);
  }

  /**
   * An Async wrapper for DeleteWirelessGatewayTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWirelessGatewayTaskRequestT = Model::DeleteWirelessGatewayTaskRequest>
  void DeleteWirelessGatewayTaskAsync(const DeleteWirelessGatewayTaskRequestT& request,
                                      const DeleteWirelessGatewayTaskResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteWirelessGatewayTaskDefinitionOutcome DeleteWirelessGatewayTaskDefinition(
      const Model::DeleteWirelessGatewayTaskDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteWirelessGatewayTaskDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteWirelessGatewayTaskDefinitionRequestT = Model::DeleteWirelessGatewayTaskDefinitionRequest>
  Model::DeleteWirelessGatewayTaskDefinitionOutcomeCallable DeleteWirelessGatewayTaskDefinitionCallable(
      const DeleteWirelessGatewayTaskDefinitionRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DeleteWirelessGatewayTaskDefinition, request);
  }

  /**
   * An Async wrapper for DeleteWirelessGatewayTaskDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteWirelessGatewayTaskDefinitionRequestT = Model::DeleteWirelessGatewayTaskDefinitionRequest>
  void DeleteWirelessGatewayTaskDefinitionAsync(const DeleteWirelessGatewayTaskDefinitionRequestT& request,
                                                const DeleteWirelessGatewayTaskDefinitionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterWirelessDevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterWirelessDeviceRequestT = Model::DeregisterWirelessDeviceRequest>
  void DeregisterWirelessDeviceAsync(const DeregisterWirelessDeviceRequestT& request,
                                     const DeregisterWirelessDeviceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisassociateAwsAccountFromPartnerAccountOutcome DisassociateAwsAccountFromPartnerAccount(
      const Model::DisassociateAwsAccountFromPartnerAccountRequest& request) const;

  /**
   * A Callable wrapper for DisassociateAwsAccountFromPartnerAccount that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateAwsAccountFromPartnerAccountRequestT = Model::DisassociateAwsAccountFromPartnerAccountRequest>
  Model::DisassociateAwsAccountFromPartnerAccountOutcomeCallable DisassociateAwsAccountFromPartnerAccountCallable(
      const DisassociateAwsAccountFromPartnerAccountRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateAwsAccountFromPartnerAccount, request);
  }

  /**
   * An Async wrapper for DisassociateAwsAccountFromPartnerAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateAwsAccountFromPartnerAccountRequestT = Model::DisassociateAwsAccountFromPartnerAccountRequest>
  void DisassociateAwsAccountFromPartnerAccountAsync(
      const DisassociateAwsAccountFromPartnerAccountRequestT& request,
      const DisassociateAwsAccountFromPartnerAccountResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateMulticastGroupFromFuotaTaskOutcome DisassociateMulticastGroupFromFuotaTask(
      const Model::DisassociateMulticastGroupFromFuotaTaskRequest& request) const;

  /**
   * A Callable wrapper for DisassociateMulticastGroupFromFuotaTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateMulticastGroupFromFuotaTaskRequestT = Model::DisassociateMulticastGroupFromFuotaTaskRequest>
  Model::DisassociateMulticastGroupFromFuotaTaskOutcomeCallable DisassociateMulticastGroupFromFuotaTaskCallable(
      const DisassociateMulticastGroupFromFuotaTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateMulticastGroupFromFuotaTask, request);
  }

  /**
   * An Async wrapper for DisassociateMulticastGroupFromFuotaTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateMulticastGroupFromFuotaTaskRequestT = Model::DisassociateMulticastGroupFromFuotaTaskRequest>
  void DisassociateMulticastGroupFromFuotaTaskAsync(const DisassociateMulticastGroupFromFuotaTaskRequestT& request,
                                                    const DisassociateMulticastGroupFromFuotaTaskResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWirelessDeviceFromFuotaTaskOutcome DisassociateWirelessDeviceFromFuotaTask(
      const Model::DisassociateWirelessDeviceFromFuotaTaskRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWirelessDeviceFromFuotaTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateWirelessDeviceFromFuotaTaskRequestT = Model::DisassociateWirelessDeviceFromFuotaTaskRequest>
  Model::DisassociateWirelessDeviceFromFuotaTaskOutcomeCallable DisassociateWirelessDeviceFromFuotaTaskCallable(
      const DisassociateWirelessDeviceFromFuotaTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateWirelessDeviceFromFuotaTask, request);
  }

  /**
   * An Async wrapper for DisassociateWirelessDeviceFromFuotaTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateWirelessDeviceFromFuotaTaskRequestT = Model::DisassociateWirelessDeviceFromFuotaTaskRequest>
  void DisassociateWirelessDeviceFromFuotaTaskAsync(const DisassociateWirelessDeviceFromFuotaTaskRequestT& request,
                                                    const DisassociateWirelessDeviceFromFuotaTaskResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWirelessDeviceFromMulticastGroupOutcome DisassociateWirelessDeviceFromMulticastGroup(
      const Model::DisassociateWirelessDeviceFromMulticastGroupRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWirelessDeviceFromMulticastGroup that returns a future to the operation so that it can be executed
  ...
  Model::DisassociateWirelessDeviceFromMulticastGroupOutcomeCallable DisassociateWirelessDeviceFromMulticastGroupCallable(
      const DisassociateWirelessDeviceFromMulticastGroupRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateWirelessDeviceFromMulticastGroup, request);
  }

  /**
   * An Async wrapper for DisassociateWirelessDeviceFromMulticastGroup that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DisassociateWirelessDeviceFromMulticastGroupRequestT = Model::DisassociateWirelessDeviceFromMulticastGroupRequest>
  void DisassociateWirelessDeviceFromMulticastGroupAsync(
      const DisassociateWirelessDeviceFromMulticastGroupRequestT& request,
      const DisassociateWirelessDeviceFromMulticastGroupResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWirelessDeviceFromThingOutcome DisassociateWirelessDeviceFromThing(
      const Model::DisassociateWirelessDeviceFromThingRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWirelessDeviceFromThing that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateWirelessDeviceFromThingRequestT = Model::DisassociateWirelessDeviceFromThingRequest>
  Model::DisassociateWirelessDeviceFromThingOutcomeCallable DisassociateWirelessDeviceFromThingCallable(
      const DisassociateWirelessDeviceFromThingRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateWirelessDeviceFromThing, request);
  }

  /**
   * An Async wrapper for DisassociateWirelessDeviceFromThing that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateWirelessDeviceFromThingRequestT = Model::DisassociateWirelessDeviceFromThingRequest>
  void DisassociateWirelessDeviceFromThingAsync(const DisassociateWirelessDeviceFromThingRequestT& request,
                                                const DisassociateWirelessDeviceFromThingResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWirelessGatewayFromCertificateOutcome DisassociateWirelessGatewayFromCertificate(
      const Model::DisassociateWirelessGatewayFromCertificateRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWirelessGatewayFromCertificate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DisassociateWirelessGatewayFromCertificateOutcomeCallable DisassociateWirelessGatewayFromCertificateCallable(
      const DisassociateWirelessGatewayFromCertificateRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateWirelessGatewayFromCertificate, request);
  }

  /**
   * An Async wrapper for DisassociateWirelessGatewayFromCertificate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateWirelessGatewayFromCertificateRequestT = Model::DisassociateWirelessGatewayFromCertificateRequest>
  void DisassociateWirelessGatewayFromCertificateAsync(
      const DisassociateWirelessGatewayFromCertificateRequestT& request,
      const DisassociateWirelessGatewayFromCertificateResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWirelessGatewayFromThingOutcome DisassociateWirelessGatewayFromThing(
      const Model::DisassociateWirelessGatewayFromThingRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWirelessGatewayFromThing that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateWirelessGatewayFromThingRequestT = Model::DisassociateWirelessGatewayFromThingRequest>
  Model::DisassociateWirelessGatewayFromThingOutcomeCallable DisassociateWirelessGatewayFromThingCallable(
      const DisassociateWirelessGatewayFromThingRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::DisassociateWirelessGatewayFromThing, request);
  }

  /**
   * An Async wrapper for DisassociateWirelessGatewayFromThing that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateWirelessGatewayFromThingRequestT = Model::DisassociateWirelessGatewayFromThingRequest>
  void DisassociateWirelessGatewayFromThingAsync(const DisassociateWirelessGatewayFromThingRequestT& request,
                                                 const DisassociateWirelessGatewayFromThingResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDeviceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeviceProfileRequestT = Model::GetDeviceProfileRequest>
  void GetDeviceProfileAsync(const GetDeviceProfileRequestT& request, const GetDeviceProfileResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEventConfigurationByResourceTypesOutcome GetEventConfigurationByResourceTypes(
      const Model::GetEventConfigurationByResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetEventConfigurationByResourceTypes that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetEventConfigurationByResourceTypesRequestT = Model::GetEventConfigurationByResourceTypesRequest>
  Model::GetEventConfigurationByResourceTypesOutcomeCallable GetEventConfigurationByResourceTypesCallable(
      const GetEventConfigurationByResourceTypesRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::GetEventConfigurationByResourceTypes, request);
  }

  /**
   * An Async wrapper for GetEventConfigurationByResourceTypes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetEventConfigurationByResourceTypesRequestT = Model::GetEventConfigurationByResourceTypesRequest>
  void GetEventConfigurationByResourceTypesAsync(const GetEventConfigurationByResourceTypesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const GetEventConfigurationByResourceTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetFuotaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFuotaTaskRequestT = Model::GetFuotaTaskRequest>
  void GetFuotaTaskAsync(const GetFuotaTaskRequestT& request, const GetFuotaTaskResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetLogLevelsByResourceTypesOutcome GetLogLevelsByResourceTypes(
      const Model::GetLogLevelsByResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for GetLogLevelsByResourceTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetLogLevelsByResourceTypesRequestT = Model::GetLogLevelsByResourceTypesRequest>
  Model::GetLogLevelsByResourceTypesOutcomeCallable GetLogLevelsByResourceTypesCallable(
      const GetLogLevelsByResourceTypesRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::GetLogLevelsByResourceTypes, request);
  }

  /**
   * An Async wrapper for GetLogLevelsByResourceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLogLevelsByResourceTypesRequestT = Model::GetLogLevelsByResourceTypesRequest>
  void GetLogLevelsByResourceTypesAsync(const GetLogLevelsByResourceTypesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const GetLogLevelsByResourceTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetMetricConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetricConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMetricConfigurationRequestT = Model::GetMetricConfigurationRequest>
  void GetMetricConfigurationAsync(const GetMetricConfigurationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetMetricConfigurationRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMetrics that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMetricsRequestT = Model::GetMetricsRequest>
  void GetMetricsAsync(const GetMetricsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const GetMetricsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetMulticastGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMulticastGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMulticastGroupRequestT = Model::GetMulticastGroupRequest>
  void GetMulticastGroupAsync(const GetMulticastGroupRequestT& request, const GetMulticastGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMulticastGroupSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMulticastGroupSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMulticastGroupSessionRequestT = Model::GetMulticastGroupSessionRequest>
  void GetMulticastGroupSessionAsync(const GetMulticastGroupSessionRequestT& request,
                                     const GetMulticastGroupSessionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetNetworkAnalyzerConfigurationOutcome GetNetworkAnalyzerConfiguration(
      const Model::GetNetworkAnalyzerConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetNetworkAnalyzerConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetNetworkAnalyzerConfigurationRequestT = Model::GetNetworkAnalyzerConfigurationRequest>
  Model::GetNetworkAnalyzerConfigurationOutcomeCallable GetNetworkAnalyzerConfigurationCallable(
      const GetNetworkAnalyzerConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetNetworkAnalyzerConfiguration, request);
  }

  /**
   * An Async wrapper for GetNetworkAnalyzerConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetNetworkAnalyzerConfigurationRequestT = Model::GetNetworkAnalyzerConfigurationRequest>
  void GetNetworkAnalyzerConfigurationAsync(const GetNetworkAnalyzerConfigurationRequestT& request,
                                            const GetNetworkAnalyzerConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPartnerAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPartnerAccount that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPartnerAccountRequestT = Model::GetPartnerAccountRequest>
  void GetPartnerAccountAsync(const GetPartnerAccountRequestT& request, const GetPartnerAccountResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPositionEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPositionEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPositionEstimateRequestT = Model::GetPositionEstimateRequest>
  void GetPositionEstimateAsync(const GetPositionEstimateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetPositionEstimateRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetResourceEventConfigurationOutcome GetResourceEventConfiguration(
      const Model::GetResourceEventConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetResourceEventConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetResourceEventConfigurationRequestT = Model::GetResourceEventConfigurationRequest>
  Model::GetResourceEventConfigurationOutcomeCallable GetResourceEventConfigurationCallable(
      const GetResourceEventConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetResourceEventConfiguration, request);
  }

  /**
   * An Async wrapper for GetResourceEventConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourceEventConfigurationRequestT = Model::GetResourceEventConfigurationRequest>
  void GetResourceEventConfigurationAsync(const GetResourceEventConfigurationRequestT& request,
                                          const GetResourceEventConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourceLogLevel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourceLogLevel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourceLogLevelRequestT = Model::GetResourceLogLevelRequest>
  void GetResourceLogLevelAsync(const GetResourceLogLevelRequestT& request, const GetResourceLogLevelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourcePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourcePosition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourcePositionRequestT = Model::GetResourcePositionRequest>
  void GetResourcePositionAsync(const GetResourcePositionRequestT& request, const GetResourcePositionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetServiceEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetServiceEndpointRequestT = Model::GetServiceEndpointRequest>
  void GetServiceEndpointAsync(const GetServiceEndpointResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetServiceEndpointRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetServiceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetServiceProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetServiceProfileRequestT = Model::GetServiceProfileRequest>
  void GetServiceProfileAsync(const GetServiceProfileRequestT& request, const GetServiceProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWirelessDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWirelessDeviceRequestT = Model::GetWirelessDeviceRequest>
  void GetWirelessDeviceAsync(const GetWirelessDeviceRequestT& request, const GetWirelessDeviceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWirelessDeviceImportTaskOutcome GetWirelessDeviceImportTask(
      const Model::GetWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessDeviceImportTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWirelessDeviceImportTaskRequestT = Model::GetWirelessDeviceImportTaskRequest>
  Model::GetWirelessDeviceImportTaskOutcomeCallable GetWirelessDeviceImportTaskCallable(
      const GetWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for GetWirelessDeviceImportTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWirelessDeviceImportTaskRequestT = Model::GetWirelessDeviceImportTaskRequest>
  void GetWirelessDeviceImportTaskAsync(const GetWirelessDeviceImportTaskRequestT& request,
                                        const GetWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWirelessDeviceStatisticsOutcome GetWirelessDeviceStatistics(
      const Model::GetWirelessDeviceStatisticsRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessDeviceStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWirelessDeviceStatisticsRequestT = Model::GetWirelessDeviceStatisticsRequest>
  Model::GetWirelessDeviceStatisticsOutcomeCallable GetWirelessDeviceStatisticsCallable(
      const GetWirelessDeviceStatisticsRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessDeviceStatistics, request);
  }

  /**
   * An Async wrapper for GetWirelessDeviceStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWirelessDeviceStatisticsRequestT = Model::GetWirelessDeviceStatisticsRequest>
  void GetWirelessDeviceStatisticsAsync(const GetWirelessDeviceStatisticsRequestT& request,
                                        const GetWirelessDeviceStatisticsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWirelessGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWirelessGateway that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWirelessGatewayRequestT = Model::GetWirelessGatewayRequest>
  void GetWirelessGatewayAsync(const GetWirelessGatewayRequestT& request, const GetWirelessGatewayResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWirelessGatewayCertificateOutcome GetWirelessGatewayCertificate(
      const Model::GetWirelessGatewayCertificateRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessGatewayCertificate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWirelessGatewayCertificateRequestT = Model::GetWirelessGatewayCertificateRequest>
  Model::GetWirelessGatewayCertificateOutcomeCallable GetWirelessGatewayCertificateCallable(
      const GetWirelessGatewayCertificateRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessGatewayCertificate, request);
  }

  /**
   * An Async wrapper for GetWirelessGatewayCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWirelessGatewayCertificateRequestT = Model::GetWirelessGatewayCertificateRequest>
  void GetWirelessGatewayCertificateAsync(const GetWirelessGatewayCertificateRequestT& request,
                                          const GetWirelessGatewayCertificateResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetWirelessGatewayFirmwareInformationOutcome GetWirelessGatewayFirmwareInformation(
      const Model::GetWirelessGatewayFirmwareInformationRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessGatewayFirmwareInformation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetWirelessGatewayFirmwareInformationRequestT = Model::GetWirelessGatewayFirmwareInformationRequest>
  Model::GetWirelessGatewayFirmwareInformationOutcomeCallable GetWirelessGatewayFirmwareInformationCallable(
      const GetWirelessGatewayFirmwareInformationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessGatewayFirmwareInformation, request);
  }

  /**
   * An Async wrapper for GetWirelessGatewayFirmwareInformation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetWirelessGatewayFirmwareInformationRequestT = Model::GetWirelessGatewayFirmwareInformationRequest>
  void GetWirelessGatewayFirmwareInformationAsync(const GetWirelessGatewayFirmwareInformationRequestT& request,
                                                  const GetWirelessGatewayFirmwareInformationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWirelessGatewayStatisticsOutcome GetWirelessGatewayStatistics(
      const Model::GetWirelessGatewayStatisticsRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessGatewayStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetWirelessGatewayStatisticsRequestT = Model::GetWirelessGatewayStatisticsRequest>
  Model::GetWirelessGatewayStatisticsOutcomeCallable GetWirelessGatewayStatisticsCallable(
      const GetWirelessGatewayStatisticsRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessGatewayStatistics, request);
  }

  /**
   * An Async wrapper for GetWirelessGatewayStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWirelessGatewayStatisticsRequestT = Model::GetWirelessGatewayStatisticsRequest>
  void GetWirelessGatewayStatisticsAsync(const GetWirelessGatewayStatisticsRequestT& request,
                                         const GetWirelessGatewayStatisticsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWirelessGatewayTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWirelessGatewayTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWirelessGatewayTaskRequestT = Model::GetWirelessGatewayTaskRequest>
  void GetWirelessGatewayTaskAsync(const GetWirelessGatewayTaskRequestT& request,
                                   const GetWirelessGatewayTaskResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetWirelessGatewayTaskDefinitionOutcome GetWirelessGatewayTaskDefinition(
      const Model::GetWirelessGatewayTaskDefinitionRequest& request) const;

  /**
   * A Callable wrapper for GetWirelessGatewayTaskDefinition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetWirelessGatewayTaskDefinitionRequestT = Model::GetWirelessGatewayTaskDefinitionRequest>
  Model::GetWirelessGatewayTaskDefinitionOutcomeCallable GetWirelessGatewayTaskDefinitionCallable(
      const GetWirelessGatewayTaskDefinitionRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::GetWirelessGatewayTaskDefinition, request);
  }

  /**
   * An Async wrapper for GetWirelessGatewayTaskDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetWirelessGatewayTaskDefinitionRequestT = Model::GetWirelessGatewayTaskDefinitionRequest>
  void GetWirelessGatewayTaskDefinitionAsync(const GetWirelessGatewayTaskDefinitionRequestT& request,
                                             const GetWirelessGatewayTaskDefinitionResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDeviceProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeviceProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDeviceProfilesRequestT = Model::ListDeviceProfilesRequest>
  void ListDeviceProfilesAsync(const ListDeviceProfilesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListDeviceProfilesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDevicesForWirelessDeviceImportTaskOutcome ListDevicesForWirelessDeviceImportTask(
      const Model::ListDevicesForWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for ListDevicesForWirelessDeviceImportTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDevicesForWirelessDeviceImportTaskRequestT = Model::ListDevicesForWirelessDeviceImportTaskRequest>
  Model::ListDevicesForWirelessDeviceImportTaskOutcomeCallable ListDevicesForWirelessDeviceImportTaskCallable(
      const ListDevicesForWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::ListDevicesForWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for ListDevicesForWirelessDeviceImportTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDevicesForWirelessDeviceImportTaskRequestT = Model::ListDevicesForWirelessDeviceImportTaskRequest>
  void ListDevicesForWirelessDeviceImportTaskAsync(const ListDevicesForWirelessDeviceImportTaskRequestT& request,
                                                   const ListDevicesForWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEventConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEventConfigurationsRequestT = Model::ListEventConfigurationsRequest>
  void ListEventConfigurationsAsync(const ListEventConfigurationsRequestT& request,
                                    const ListEventConfigurationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListFuotaTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListFuotaTasksRequestT = Model::ListFuotaTasksRequest>
  void ListFuotaTasksAsync(const ListFuotaTasksResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListFuotaTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMulticastGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMulticastGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMulticastGroupsRequestT = Model::ListMulticastGroupsRequest>
  void ListMulticastGroupsAsync(const ListMulticastGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListMulticastGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMulticastGroupsByFuotaTaskOutcome ListMulticastGroupsByFuotaTask(
      const Model::ListMulticastGroupsByFuotaTaskRequest& request) const;

  /**
   * A Callable wrapper for ListMulticastGroupsByFuotaTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMulticastGroupsByFuotaTaskRequestT = Model::ListMulticastGroupsByFuotaTaskRequest>
  Model::ListMulticastGroupsByFuotaTaskOutcomeCallable ListMulticastGroupsByFuotaTaskCallable(
      const ListMulticastGroupsByFuotaTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::ListMulticastGroupsByFuotaTask, request);
  }

  /**
   * An Async wrapper for ListMulticastGroupsByFuotaTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListMulticastGroupsByFuotaTaskRequestT = Model::ListMulticastGroupsByFuotaTaskRequest>
  void ListMulticastGroupsByFuotaTaskAsync(const ListMulticastGroupsByFuotaTaskRequestT& request,
                                           const ListMulticastGroupsByFuotaTaskResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListNetworkAnalyzerConfigurationsOutcome ListNetworkAnalyzerConfigurations(
      const Model::ListNetworkAnalyzerConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListNetworkAnalyzerConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListNetworkAnalyzerConfigurationsRequestT = Model::ListNetworkAnalyzerConfigurationsRequest>
  Model::ListNetworkAnalyzerConfigurationsOutcomeCallable ListNetworkAnalyzerConfigurationsCallable(
      const ListNetworkAnalyzerConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::ListNetworkAnalyzerConfigurations, request);
  }

  /**
   * An Async wrapper for ListNetworkAnalyzerConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListNetworkAnalyzerConfigurationsRequestT = Model::ListNetworkAnalyzerConfigurationsRequest>
  void ListNetworkAnalyzerConfigurationsAsync(const ListNetworkAnalyzerConfigurationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const ListNetworkAnalyzerConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPartnerAccounts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPartnerAccounts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPartnerAccountsRequestT = Model::ListPartnerAccountsRequest>
  void ListPartnerAccountsAsync(const ListPartnerAccountsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListPartnerAccountsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListQueuedMessages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQueuedMessages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQueuedMessagesRequestT = Model::ListQueuedMessagesRequest>
  void ListQueuedMessagesAsync(const ListQueuedMessagesRequestT& request, const ListQueuedMessagesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServiceProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListServiceProfilesRequestT = Model::ListServiceProfilesRequest>
  void ListServiceProfilesAsync(const ListServiceProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListServiceProfilesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWirelessDeviceImportTasksOutcome ListWirelessDeviceImportTasks(
      const Model::ListWirelessDeviceImportTasksRequest& request = {}) const;

  /**
   * A Callable wrapper for ListWirelessDeviceImportTasks that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListWirelessDeviceImportTasksRequestT = Model::ListWirelessDeviceImportTasksRequest>
  Model::ListWirelessDeviceImportTasksOutcomeCallable ListWirelessDeviceImportTasksCallable(
      const ListWirelessDeviceImportTasksRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::ListWirelessDeviceImportTasks, request);
  }

  /**
   * An Async wrapper for ListWirelessDeviceImportTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWirelessDeviceImportTasksRequestT = Model::ListWirelessDeviceImportTasksRequest>
  void ListWirelessDeviceImportTasksAsync(const ListWirelessDeviceImportTasksResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListWirelessDeviceImportTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWirelessDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWirelessDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWirelessDevicesRequestT = Model::ListWirelessDevicesRequest>
  void ListWirelessDevicesAsync(const ListWirelessDevicesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListWirelessDevicesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWirelessGatewayTaskDefinitionsOutcome ListWirelessGatewayTaskDefinitions(
      const Model::ListWirelessGatewayTaskDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListWirelessGatewayTaskDefinitions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListWirelessGatewayTaskDefinitionsRequestT = Model::ListWirelessGatewayTaskDefinitionsRequest>
  Model::ListWirelessGatewayTaskDefinitionsOutcomeCallable ListWirelessGatewayTaskDefinitionsCallable(
      const ListWirelessGatewayTaskDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::ListWirelessGatewayTaskDefinitions, request);
  }

  /**
   * An Async wrapper for ListWirelessGatewayTaskDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListWirelessGatewayTaskDefinitionsRequestT = Model::ListWirelessGatewayTaskDefinitionsRequest>
  void ListWirelessGatewayTaskDefinitionsAsync(const ListWirelessGatewayTaskDefinitionsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const ListWirelessGatewayTaskDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWirelessGateways that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWirelessGateways that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWirelessGatewaysRequestT = Model::ListWirelessGatewaysRequest>
  void ListWirelessGatewaysAsync(const ListWirelessGatewaysResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListWirelessGatewaysRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutResourceLogLevel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutResourceLogLevel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutResourceLogLevelRequestT = Model::PutResourceLogLevelRequest>
  void PutResourceLogLevelAsync(const PutResourceLogLevelRequestT& request, const PutResourceLogLevelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResetAllResourceLogLevelsOutcome ResetAllResourceLogLevels(
      const Model::ResetAllResourceLogLevelsRequest& request = {}) const;

  /**
   * A Callable wrapper for ResetAllResourceLogLevels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ResetAllResourceLogLevelsRequestT = Model::ResetAllResourceLogLevelsRequest>
  Model::ResetAllResourceLogLevelsOutcomeCallable ResetAllResourceLogLevelsCallable(
      const ResetAllResourceLogLevelsRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::ResetAllResourceLogLevels, request);
  }

  /**
   * An Async wrapper for ResetAllResourceLogLevels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetAllResourceLogLevelsRequestT = Model::ResetAllResourceLogLevelsRequest>
  void ResetAllResourceLogLevelsAsync(const ResetAllResourceLogLevelsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ResetAllResourceLogLevelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ResetResourceLogLevel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetResourceLogLevel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetResourceLogLevelRequestT = Model::ResetResourceLogLevelRequest>
  void ResetResourceLogLevelAsync(const ResetResourceLogLevelRequestT& request, const ResetResourceLogLevelResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendDataToMulticastGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendDataToMulticastGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendDataToMulticastGroupRequestT = Model::SendDataToMulticastGroupRequest>
  void SendDataToMulticastGroupAsync(const SendDataToMulticastGroupRequestT& request,
                                     const SendDataToMulticastGroupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendDataToWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendDataToWirelessDevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendDataToWirelessDeviceRequestT = Model::SendDataToWirelessDeviceRequest>
  void SendDataToWirelessDeviceAsync(const SendDataToWirelessDeviceRequestT& request,
                                     const SendDataToWirelessDeviceResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StartBulkAssociateWirelessDeviceWithMulticastGroupOutcome StartBulkAssociateWirelessDeviceWithMulticastGroup(
      const Model::StartBulkAssociateWirelessDeviceWithMulticastGroupRequest& request) const;

  /**
   * A Callable wrapper for StartBulkAssociateWirelessDeviceWithMulticastGroup that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename StartBulkAssociateWirelessDeviceWithMulticastGroupRequestT =
                Model::StartBulkAssociateWirelessDeviceWithMulticastGroupRequest>
  Model::StartBulkAssociateWirelessDeviceWithMulticastGroupOutcomeCallable StartBulkAssociateWirelessDeviceWithMulticastGroupCallable(
      const StartBulkAssociateWirelessDeviceWithMulticastGroupRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::StartBulkAssociateWirelessDeviceWithMulticastGroup, request);
  }

  /**
   * An Async wrapper for StartBulkAssociateWirelessDeviceWithMulticastGroup that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename StartBulkAssociateWirelessDeviceWithMulticastGroupRequestT =
                Model::StartBulkAssociateWirelessDeviceWithMulticastGroupRequest>
  void StartBulkAssociateWirelessDeviceWithMulticastGroupAsync(
      const StartBulkAssociateWirelessDeviceWithMulticastGroupRequestT& request,
      const StartBulkAssociateWirelessDeviceWithMulticastGroupResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartBulkDisassociateWirelessDeviceFromMulticastGroupOutcome StartBulkDisassociateWirelessDeviceFromMulticastGroup(
      const Model::StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest& request) const;

  /**
   * A Callable wrapper for StartBulkDisassociateWirelessDeviceFromMulticastGroup that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename StartBulkDisassociateWirelessDeviceFromMulticastGroupRequestT =
                Model::StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest>
  Model::StartBulkDisassociateWirelessDeviceFromMulticastGroupOutcomeCallable StartBulkDisassociateWirelessDeviceFromMulticastGroupCallable(
      const StartBulkDisassociateWirelessDeviceFromMulticastGroupRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::StartBulkDisassociateWirelessDeviceFromMulticastGroup, request);
  }

  /**
   * An Async wrapper for StartBulkDisassociateWirelessDeviceFromMulticastGroup that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename StartBulkDisassociateWirelessDeviceFromMulticastGroupRequestT =
                Model::StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest>
  void StartBulkDisassociateWirelessDeviceFromMulticastGroupAsync(
      const StartBulkDisassociateWirelessDeviceFromMulticastGroupRequestT& request,
      const StartBulkDisassociateWirelessDeviceFromMulticastGroupResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartFuotaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartFuotaTaskRequestT = Model::StartFuotaTaskRequest>
  void StartFuotaTaskAsync(const StartFuotaTaskRequestT& request, const StartFuotaTaskResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMulticastGroupSessionOutcome StartMulticastGroupSession(
      const Model::StartMulticastGroupSessionRequest& request) const;

  /**
   * A Callable wrapper for StartMulticastGroupSession that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartMulticastGroupSessionRequestT = Model::StartMulticastGroupSessionRequest>
  Model::StartMulticastGroupSessionOutcomeCallable StartMulticastGroupSessionCallable(
      const StartMulticastGroupSessionRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::StartMulticastGroupSession, request);
  }

  /**
   * An Async wrapper for StartMulticastGroupSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMulticastGroupSessionRequestT = Model::StartMulticastGroupSessionRequest>
  void StartMulticastGroupSessionAsync(const StartMulticastGroupSessionRequestT& request,
                                       const StartMulticastGroupSessionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartSingleWirelessDeviceImportTaskOutcome StartSingleWirelessDeviceImportTask(
      const Model::StartSingleWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for StartSingleWirelessDeviceImportTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartSingleWirelessDeviceImportTaskRequestT = Model::StartSingleWirelessDeviceImportTaskRequest>
  Model::StartSingleWirelessDeviceImportTaskOutcomeCallable StartSingleWirelessDeviceImportTaskCallable(
      const StartSingleWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::StartSingleWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for StartSingleWirelessDeviceImportTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartSingleWirelessDeviceImportTaskRequestT = Model::StartSingleWirelessDeviceImportTaskRequest>
  void StartSingleWirelessDeviceImportTaskAsync(const StartSingleWirelessDeviceImportTaskRequestT& request,
                                                const StartSingleWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartWirelessDeviceImportTaskOutcome StartWirelessDeviceImportTask(
      const Model::StartWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for StartWirelessDeviceImportTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartWirelessDeviceImportTaskRequestT = Model::StartWirelessDeviceImportTaskRequest>
  Model::StartWirelessDeviceImportTaskOutcomeCallable StartWirelessDeviceImportTaskCallable(
      const StartWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::StartWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for StartWirelessDeviceImportTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartWirelessDeviceImportTaskRequestT = Model::StartWirelessDeviceImportTaskRequest>
  void StartWirelessDeviceImportTaskAsync(const StartWirelessDeviceImportTaskRequestT& request,
                                          const StartWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TestWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TestWirelessDevice that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TestWirelessDeviceRequestT = Model::TestWirelessDeviceRequest>
  void TestWirelessDeviceAsync(const TestWirelessDeviceRequestT& request, const TestWirelessDeviceResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEventConfigurationByResourceTypesOutcome UpdateEventConfigurationByResourceTypes(
      const Model::UpdateEventConfigurationByResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateEventConfigurationByResourceTypes that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateEventConfigurationByResourceTypesRequestT = Model::UpdateEventConfigurationByResourceTypesRequest>
  Model::UpdateEventConfigurationByResourceTypesOutcomeCallable UpdateEventConfigurationByResourceTypesCallable(
      const UpdateEventConfigurationByResourceTypesRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::UpdateEventConfigurationByResourceTypes, request);
  }

  /**
   * An Async wrapper for UpdateEventConfigurationByResourceTypes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateEventConfigurationByResourceTypesRequestT = Model::UpdateEventConfigurationByResourceTypesRequest>
  void UpdateEventConfigurationByResourceTypesAsync(const UpdateEventConfigurationByResourceTypesResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const UpdateEventConfigurationByResourceTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateFuotaTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFuotaTaskRequestT = Model::UpdateFuotaTaskRequest>
  void UpdateFuotaTaskAsync(const UpdateFuotaTaskRequestT& request, const UpdateFuotaTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateLogLevelsByResourceTypesOutcome UpdateLogLevelsByResourceTypes(
      const Model::UpdateLogLevelsByResourceTypesRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateLogLevelsByResourceTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateLogLevelsByResourceTypesRequestT = Model::UpdateLogLevelsByResourceTypesRequest>
  Model::UpdateLogLevelsByResourceTypesOutcomeCallable UpdateLogLevelsByResourceTypesCallable(
      const UpdateLogLevelsByResourceTypesRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::UpdateLogLevelsByResourceTypes, request);
  }

  /**
   * An Async wrapper for UpdateLogLevelsByResourceTypes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateLogLevelsByResourceTypesRequestT = Model::UpdateLogLevelsByResourceTypesRequest>
  void UpdateLogLevelsByResourceTypesAsync(const UpdateLogLevelsByResourceTypesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const UpdateLogLevelsByResourceTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMetricConfigurationOutcome UpdateMetricConfiguration(
      const Model::UpdateMetricConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateMetricConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateMetricConfigurationRequestT = Model::UpdateMetricConfigurationRequest>
  Model::UpdateMetricConfigurationOutcomeCallable UpdateMetricConfigurationCallable(
      const UpdateMetricConfigurationRequestT& request = {}) const {
    return SubmitCallable(&IoTWirelessClient::UpdateMetricConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateMetricConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMetricConfigurationRequestT = Model::UpdateMetricConfigurationRequest>
  void UpdateMetricConfigurationAsync(const UpdateMetricConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const UpdateMetricConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateMulticastGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMulticastGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMulticastGroupRequestT = Model::UpdateMulticastGroupRequest>
  void UpdateMulticastGroupAsync(const UpdateMulticastGroupRequestT& request, const UpdateMulticastGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateNetworkAnalyzerConfigurationOutcome UpdateNetworkAnalyzerConfiguration(
      const Model::UpdateNetworkAnalyzerConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateNetworkAnalyzerConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateNetworkAnalyzerConfigurationRequestT = Model::UpdateNetworkAnalyzerConfigurationRequest>
  Model::UpdateNetworkAnalyzerConfigurationOutcomeCallable UpdateNetworkAnalyzerConfigurationCallable(
      const UpdateNetworkAnalyzerConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::UpdateNetworkAnalyzerConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateNetworkAnalyzerConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateNetworkAnalyzerConfigurationRequestT = Model::UpdateNetworkAnalyzerConfigurationRequest>
  void UpdateNetworkAnalyzerConfigurationAsync(const UpdateNetworkAnalyzerConfigurationRequestT& request,
                                               const UpdateNetworkAnalyzerConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePartnerAccount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePartnerAccount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePartnerAccountRequestT = Model::UpdatePartnerAccountRequest>
  void UpdatePartnerAccountAsync(const UpdatePartnerAccountRequestT& request, const UpdatePartnerAccountResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateResourceEventConfigurationOutcome UpdateResourceEventConfiguration(
      const Model::UpdateResourceEventConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateResourceEventConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateResourceEventConfigurationRequestT = Model::UpdateResourceEventConfigurationRequest>
  Model::UpdateResourceEventConfigurationOutcomeCallable UpdateResourceEventConfigurationCallable(
      const UpdateResourceEventConfigurationRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::UpdateResourceEventConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateResourceEventConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateResourceEventConfigurationRequestT = Model::UpdateResourceEventConfigurationRequest>
  void UpdateResourceEventConfigurationAsync(const UpdateResourceEventConfigurationRequestT& request,
                                             const UpdateResourceEventConfigurationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResourcePosition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourcePosition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourcePositionRequestT = Model::UpdateResourcePositionRequest>
  void UpdateResourcePositionAsync(const UpdateResourcePositionRequestT& request,
                                   const UpdateResourcePositionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWirelessDevice that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWirelessDevice that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWirelessDeviceRequestT = Model::UpdateWirelessDeviceRequest>
  void UpdateWirelessDeviceAsync(const UpdateWirelessDeviceRequestT& request, const UpdateWirelessDeviceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateWirelessDeviceImportTaskOutcome UpdateWirelessDeviceImportTask(
      const Model::UpdateWirelessDeviceImportTaskRequest& request) const;

  /**
   * A Callable wrapper for UpdateWirelessDeviceImportTask that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateWirelessDeviceImportTaskRequestT = Model::UpdateWirelessDeviceImportTaskRequest>
  Model::UpdateWirelessDeviceImportTaskOutcomeCallable UpdateWirelessDeviceImportTaskCallable(
      const UpdateWirelessDeviceImportTaskRequestT& request) const {
    return SubmitCallable(&IoTWirelessClient::UpdateWirelessDeviceImportTask, request);
  }

  /**
   * An Async wrapper for UpdateWirelessDeviceImportTask that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateWirelessDeviceImportTaskRequestT = Model::UpdateWirelessDeviceImportTaskRequest>
  void UpdateWirelessDeviceImportTaskAsync(const UpdateWirelessDeviceImportTaskRequestT& request,
                                           const UpdateWirelessDeviceImportTaskResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWirelessGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWirelessGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWirelessGatewayRequestT = Model::UpdateWirelessGatewayRequest>
  void UpdateWirelessGatewayAsync(const UpdateWirelessGatewayRequestT& request, const UpdateWirelessGatewayResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
