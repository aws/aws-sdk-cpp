...
namespace IoTWireless
{
   ...
   */
  class AWS_IOTWIRELESS_API IoTWirelessClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTWirelessClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTWireless::SERVICE_NAME,
