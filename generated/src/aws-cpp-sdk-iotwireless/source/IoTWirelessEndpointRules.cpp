...
{
const size_t IoTWirelessEndpointRules::RulesBlobStrLen = 4745;
const size_t IoTWirelessEndpointRules::RulesBlobSize = 4746;
...
'p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','.','{','R','e','g',
...
't','p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','.','a','p','-',
'n','o','r','t','h','e','a','s','t','-','1','.','a','m','a','z','o','n','a','w','s','.','c','o','m',
...
'r','e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','e','u','-','w','e','s','t','-','1',
'"',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h',
't','t','p','s',':','/','/','a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','.','e','u',
...
'a','p','i','.','i','o','t','w','i','r','e','l','e','s','s','.','u','s','-','e','a','s','t','-','1',
...
const char* IoTWirelessEndpointRules::GetRulesBlob()
{
