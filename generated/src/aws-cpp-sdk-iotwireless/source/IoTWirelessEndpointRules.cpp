...
{
const size_t IoTWirelessEndpointRules::RulesBlobStrLen = 3760;
const size_t IoTWirelessEndpointRules::RulesBlobSize = 3761;
...
'"','t','y','p','e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[','{','"',
'c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n','t','"',
':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','.','i','o','t','w',
'i','r','e','l','e','s','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
