...
LoRaWANJoinEventNotificationConfigurations::LoRaWANJoinEventNotificationConfigurations(JsonView jsonValue) { *this = jsonValue; }
...
LoRaWANJoinEventNotificationConfigurations& LoRaWANJoinEventNotificationConfigurations::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DevEuiEventTopic")) {
    m_devEuiEventTopic =
        EventNotificationTopicStatusMapper::GetEventNotificationTopicStatusForName(jsonValue.GetString("DevEuiEventTopic"));
