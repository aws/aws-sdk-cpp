...
ListMulticastGroupsByFuotaTaskResult& ListMulticastGroupsByFuotaTaskResult::operator=(
  ...
  if (jsonValue.ValueExists("MulticastGroupList")) {
    ...
    for (unsigned multicastGroupListIndex = 0; multicastGroupListIndex < multicastGroupListJsonList.GetLength();
         ++multicastGroupListIndex) {
