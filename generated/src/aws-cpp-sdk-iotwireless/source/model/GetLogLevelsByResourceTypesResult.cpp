...
GetLogLevelsByResourceTypesResult& GetLogLevelsByResourceTypesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("WirelessGatewayLogOptions")) {
    ...
    for (unsigned wirelessGatewayLogOptionsIndex = 0; wirelessGatewayLogOptionsIndex < wirelessGatewayLogOptionsJsonList.GetLength();
         ++wirelessGatewayLogOptionsIndex) {
  ...
  if (jsonValue.ValueExists("WirelessDeviceLogOptions")) {
    ...
    for (unsigned wirelessDeviceLogOptionsIndex = 0; wirelessDeviceLogOptionsIndex < wirelessDeviceLogOptionsJsonList.GetLength();
         ++wirelessDeviceLogOptionsIndex) {
  ...
  if (jsonValue.ValueExists("FuotaTaskLogOptions")) {
    ...
    for (unsigned fuotaTaskLogOptionsIndex = 0; fuotaTaskLogOptionsIndex < fuotaTaskLogOptionsJsonList.GetLength();
         ++fuotaTaskLogOptionsIndex) {
