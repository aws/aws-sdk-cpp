...
LoRaWANDeviceProfile::LoRaWANDeviceProfile(JsonView jsonValue) { *this = jsonValue; }
...
LoRaWANDeviceProfile& LoRaWANDeviceProfile::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FactoryPresetFreqsList")) {
    ...
    for (unsigned factoryPresetFreqsListIndex = 0; factoryPresetFreqsListIndex < factoryPresetFreqsListJsonList.GetLength();
