...
Aws::String UpdateLogLevelsByResourceTypesRequest::SerializePayload() const {
  ...
  if (m_wirelessDeviceLogOptionsHasBeenSet) {
    ...
    for (unsigned wirelessDeviceLogOptionsIndex = 0; wirelessDeviceLogOptionsIndex < wirelessDeviceLogOptionsJsonList.GetLength();
      ...
      wirelessDeviceLogOptionsJsonList[wirelessDeviceLogOptionsIndex].AsObject(
          m_wirelessDeviceLogOptions[wirelessDeviceLogOptionsIndex].Jsonize());
    }
  ...
  if (m_wirelessGatewayLogOptionsHasBeenSet) {
    ...
    for (unsigned wirelessGatewayLogOptionsIndex = 0; wirelessGatewayLogOptionsIndex < wirelessGatewayLogOptionsJsonList.GetLength();
      ...
      wirelessGatewayLogOptionsJsonList[wirelessGatewayLogOptionsIndex].AsObject(
          m_wirelessGatewayLogOptions[wirelessGatewayLogOptionsIndex].Jsonize());
    }
