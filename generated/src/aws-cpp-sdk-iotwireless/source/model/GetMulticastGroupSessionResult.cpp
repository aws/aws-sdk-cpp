...
GetMulticastGroupSessionResult::GetMulticastGroupSessionResult()
{
}

GetMulticastGroupSessionResult::GetMulticastGroupSessionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
