...
SidewalkDevice::SidewalkDevice(JsonView jsonValue) { *this = jsonValue; }
...
SidewalkDevice& SidewalkDevice::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DeviceCertificates")) {
    ...
    for (unsigned deviceCertificatesIndex = 0; deviceCertificatesIndex < deviceCertificatesJsonList.GetLength();
         ++deviceCertificatesIndex) {
