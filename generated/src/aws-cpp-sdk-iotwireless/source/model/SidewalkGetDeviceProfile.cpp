...
SidewalkGetDeviceProfile::SidewalkGetDeviceProfile(JsonView jsonValue) { *this = jsonValue; }
...
SidewalkGetDeviceProfile& SidewalkGetDeviceProfile::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DakCertificateMetadata")) {
    ...
    for (unsigned dakCertificateMetadataIndex = 0; dakCertificateMetadataIndex < dakCertificateMetadataJsonList.GetLength();
         ++dakCertificateMetadataIndex) {
