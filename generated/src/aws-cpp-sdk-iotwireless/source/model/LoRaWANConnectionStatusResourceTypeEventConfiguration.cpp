...
LoRaWANConnectionStatusResourceTypeEventConfiguration& LoRaWANConnectionStatusResourceTypeEventConfiguration::operator=(
    JsonView jsonValue) {
  if (jsonValue.ValueExists("WirelessGatewayEventTopic")) {
    m_wirelessGatewayEventTopic =
        EventNotificationTopicStatusMapper::GetEventNotificationTopicStatusForName(jsonValue.GetString("WirelessGatewayEventTopic"));
...
JsonValue LoRaWANConnectionStatusResourceTypeEventConfiguration::Jsonize() const {
  ...
  if (m_wirelessGatewayEventTopicHasBeenSet) {
    payload.WithString("WirelessGatewayEventTopic",
                       EventNotificationTopicStatusMapper::GetNameForEventNotificationTopicStatus(m_wirelessGatewayEventTopic));
  }
