...
SidewalkGetStartImportInfo::SidewalkGetStartImportInfo(JsonView jsonValue) { *this = jsonValue; }
...
SidewalkGetStartImportInfo& SidewalkGetStartImportInfo::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DeviceCreationFileList")) {
    ...
    for (unsigned deviceCreationFileListIndex = 0; deviceCreationFileListIndex < deviceCreationFileListJsonList.GetLength();
         ++deviceCreationFileListIndex) {
