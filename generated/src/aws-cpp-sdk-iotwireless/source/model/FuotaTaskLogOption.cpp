...
FuotaTaskLogOption::FuotaTaskLogOption() : 
    m_type(FuotaTaskType::NOT_SET),
...
FuotaTaskLogOption::FuotaTaskLogOption(JsonView jsonValue)
  : FuotaTaskLogOption()
{
  *this = jsonValue;
}

FuotaTaskLogOption& FuotaTaskLogOption::operator =(JsonView jsonValue)
{
  if(jsonValue.ValueExists("Type"))
  {
    m_type = FuotaTaskTypeMapper::GetFuotaTaskTypeForName(jsonValue.GetString("Type"));
...
JsonValue FuotaTaskLogOption::Jsonize() const
{
  JsonValue payload;

  if(m_typeHasBeenSet)
  {
   payload.WithString("Type", FuotaTaskTypeMapper::GetNameForFuotaTaskType(m_type));
  }
