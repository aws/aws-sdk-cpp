...
Aws::String RunJobFlowRequest::SerializePayload() const {
  ...
  if (m_newSupportedProductsHasBeenSet) {
    ...
    for (unsigned newSupportedProductsIndex = 0; newSupportedProductsIndex < newSupportedProductsJsonList.GetLength();
         ++newSupportedProductsIndex) {
  ...
  if (m_placementGroupConfigsHasBeenSet) {
    ...
    for (unsigned placementGroupConfigsIndex = 0; placementGroupConfigsIndex < placementGroupConfigsJsonList.GetLength();
         ++placementGroupConfigsIndex) {
