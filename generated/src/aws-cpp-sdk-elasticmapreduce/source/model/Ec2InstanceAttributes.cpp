...
Ec2InstanceAttributes::Ec2InstanceAttributes(JsonView jsonValue) { *this = jsonValue; }
...
Ec2InstanceAttributes& Ec2InstanceAttributes::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RequestedEc2SubnetIds")) {
    ...
    for (unsigned requestedEc2SubnetIdsIndex = 0; requestedEc2SubnetIdsIndex < requestedEc2SubnetIdsJsonList.GetLength();
         ++requestedEc2SubnetIdsIndex) {
  ...
  if (jsonValue.ValueExists("RequestedEc2AvailabilityZones")) {
    ...
    for (unsigned requestedEc2AvailabilityZonesIndex = 0;
         requestedEc2AvailabilityZonesIndex < requestedEc2AvailabilityZonesJsonList.GetLength(); ++requestedEc2AvailabilityZonesIndex) {
  ...
  if (jsonValue.ValueExists("AdditionalMasterSecurityGroups")) {
    ...
    for (unsigned additionalMasterSecurityGroupsIndex = 0;
         additionalMasterSecurityGroupsIndex < additionalMasterSecurityGroupsJsonList.GetLength(); ++additionalMasterSecurityGroupsIndex) {
  ...
  if (jsonValue.ValueExists("AdditionalSlaveSecurityGroups")) {
    ...
    for (unsigned additionalSlaveSecurityGroupsIndex = 0;
         additionalSlaveSecurityGroupsIndex < additionalSlaveSecurityGroupsJsonList.GetLength(); ++additionalSlaveSecurityGroupsIndex) {
...
JsonValue Ec2InstanceAttributes::Jsonize() const {
  ...
  if (m_requestedEc2AvailabilityZonesHasBeenSet) {
    ...
    for (unsigned requestedEc2AvailabilityZonesIndex = 0;
         requestedEc2AvailabilityZonesIndex < requestedEc2AvailabilityZonesJsonList.GetLength(); ++requestedEc2AvailabilityZonesIndex) {
      requestedEc2AvailabilityZonesJsonList[requestedEc2AvailabilityZonesIndex].AsString(
          m_requestedEc2AvailabilityZones[requestedEc2AvailabilityZonesIndex]);
    }
  ...
  if (m_additionalMasterSecurityGroupsHasBeenSet) {
    ...
    for (unsigned additionalMasterSecurityGroupsIndex = 0;
         additionalMasterSecurityGroupsIndex < additionalMasterSecurityGroupsJsonList.GetLength(); ++additionalMasterSecurityGroupsIndex) {
      additionalMasterSecurityGroupsJsonList[additionalMasterSecurityGroupsIndex].AsString(
          m_additionalMasterSecurityGroups[additionalMasterSecurityGroupsIndex]);
    }
  ...
  if (m_additionalSlaveSecurityGroupsHasBeenSet) {
    ...
    for (unsigned additionalSlaveSecurityGroupsIndex = 0;
         additionalSlaveSecurityGroupsIndex < additionalSlaveSecurityGroupsJsonList.GetLength(); ++additionalSlaveSecurityGroupsIndex) {
      additionalSlaveSecurityGroupsJsonList[additionalSlaveSecurityGroupsIndex].AsString(
          m_additionalSlaveSecurityGroups[additionalSlaveSecurityGroupsIndex]);
    }
