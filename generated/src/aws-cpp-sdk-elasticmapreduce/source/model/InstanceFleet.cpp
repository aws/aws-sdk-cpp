...
InstanceFleet::InstanceFleet(JsonView jsonValue) { *this = jsonValue; }
...
InstanceFleet& InstanceFleet::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("InstanceTypeSpecifications")) {
    ...
    for (unsigned instanceTypeSpecificationsIndex = 0; instanceTypeSpecificationsIndex < instanceTypeSpecificationsJsonList.GetLength();
         ++instanceTypeSpecificationsIndex) {
...
JsonValue InstanceFleet::Jsonize() const {
  ...
  if (m_instanceTypeSpecificationsHasBeenSet) {
    ...
    for (unsigned instanceTypeSpecificationsIndex = 0; instanceTypeSpecificationsIndex < instanceTypeSpecificationsJsonList.GetLength();
         ++instanceTypeSpecificationsIndex) {
      instanceTypeSpecificationsJsonList[instanceTypeSpecificationsIndex].AsObject(
          m_instanceTypeSpecifications[instanceTypeSpecificationsIndex].Jsonize());
    }
