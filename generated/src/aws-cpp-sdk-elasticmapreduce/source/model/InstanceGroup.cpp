...
InstanceGroup& InstanceGroup::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LastSuccessfullyAppliedConfigurations")) {
    ...
    for (unsigned lastSuccessfullyAppliedConfigurationsIndex = 0;
         lastSuccessfullyAppliedConfigurationsIndex < lastSuccessfullyAppliedConfigurationsJsonList.GetLength();
         ++lastSuccessfullyAppliedConfigurationsIndex) {
      m_lastSuccessfullyAppliedConfigurations.push_back(
          lastSuccessfullyAppliedConfigurationsJsonList[lastSuccessfullyAppliedConfigurationsIndex].AsObject());
    }
...
JsonValue InstanceGroup::Jsonize() const {
  ...
  if (m_lastSuccessfullyAppliedConfigurationsHasBeenSet) {
    ...
    for (unsigned lastSuccessfullyAppliedConfigurationsIndex = 0;
         ...
         ++lastSuccessfullyAppliedConfigurationsIndex) {
      lastSuccessfullyAppliedConfigurationsJsonList[lastSuccessfullyAppliedConfigurationsIndex].AsObject(
          m_lastSuccessfullyAppliedConfigurations[lastSuccessfullyAppliedConfigurationsIndex].Jsonize());
    }
