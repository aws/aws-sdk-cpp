...
SessionCloudWatchLoggingConfiguration::SessionCloudWatchLoggingConfiguration(JsonView jsonValue) { *this = jsonValue; }

SessionCloudWatchLoggingConfiguration& SessionCloudWatchLoggingConfiguration::operator=(JsonView jsonValue) {
...
JsonValue SessionCloudWatchLoggingConfiguration::Jsonize() const {
  JsonValue payload;
