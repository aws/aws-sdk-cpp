...
InstanceGroupModifyConfig::InstanceGroupModifyConfig(JsonView jsonValue) { *this = jsonValue; }
...
InstanceGroupModifyConfig& InstanceGroupModifyConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EC2InstanceIdsToTerminate")) {
    ...
    for (unsigned eC2InstanceIdsToTerminateIndex = 0; eC2InstanceIdsToTerminateIndex < eC2InstanceIdsToTerminateJsonList.GetLength();
         ++eC2InstanceIdsToTerminateIndex) {
...
JsonValue InstanceGroupModifyConfig::Jsonize() const {
  ...
  if (m_eC2InstanceIdsToTerminateHasBeenSet) {
    ...
    for (unsigned eC2InstanceIdsToTerminateIndex = 0; eC2InstanceIdsToTerminateIndex < eC2InstanceIdsToTerminateJsonList.GetLength();
         ++eC2InstanceIdsToTerminateIndex) {
      eC2InstanceIdsToTerminateJsonList[eC2InstanceIdsToTerminateIndex].AsString(
          m_eC2InstanceIdsToTerminate[eC2InstanceIdsToTerminateIndex]);
    }
