...
class CloudWatchAlarmDefinition {
 public:
  ...
  inline CloudWatchAlarmDefinition& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline CloudWatchAlarmDefinition& WithEvaluationPeriods(int value) {
  ...
  inline CloudWatchAlarmDefinition& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmDefinition& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmDefinition& WithThreshold(double value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  inline CloudWatchAlarmDefinition& WithUnit(Unit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
