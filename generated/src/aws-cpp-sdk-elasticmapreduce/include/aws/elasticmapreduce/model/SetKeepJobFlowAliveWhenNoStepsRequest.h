...
class SetKeepJobFlowAliveWhenNoStepsRequest : public EMRRequest {
 public:
  ...
  template <typename JobFlowIdsT = Aws::Vector<Aws::String>>
  SetKeepJobFlowAliveWhenNoStepsRequest& WithJobFlowIds(JobFlowIdsT&& value) {
    SetJobFlowIds(std::forward<JobFlowIdsT>(value));
    return *this;
  }
  template <typename JobFlowIdsT = Aws::String>
  SetKeepJobFlowAliveWhenNoStepsRequest& AddJobFlowIds(JobFlowIdsT&& value) {
    m_jobFlowIdsHasBeenSet = true;
  ...
  inline SetKeepJobFlowAliveWhenNoStepsRequest& WithKeepJobFlowAliveWhenNoSteps(bool value) {
