...
namespace Model
{
  ...
  {
  public:
    AWS_EMR_API DeleteSecurityConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSecurityConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
