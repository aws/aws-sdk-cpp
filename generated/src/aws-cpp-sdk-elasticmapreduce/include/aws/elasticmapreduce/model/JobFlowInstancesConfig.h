...
class JobFlowInstancesConfig {
 public:
  ...
  inline JobFlowInstancesConfig& WithInstanceCount(int value) {
  ...
  inline JobFlowInstancesConfig& WithKeepJobFlowAliveWhenNoSteps(bool value) {
  ...
  inline JobFlowInstancesConfig& WithTerminationProtected(bool value) {
  ...
  inline JobFlowInstancesConfig& WithUnhealthyNodeReplacement(bool value) {
