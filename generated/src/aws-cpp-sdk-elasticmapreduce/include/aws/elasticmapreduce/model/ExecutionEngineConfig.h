...
class ExecutionEngineConfig {
 public:
  ...
  template <typename IdT = Aws::String>
  ExecutionEngineConfig& WithId(IdT&& value) {
  ...
  inline void SetType(ExecutionEngineType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ExecutionEngineConfig& WithType(ExecutionEngineType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetMasterInstanceSecurityGroupId(MasterInstanceSecurityGroupIdT&& value) {
    m_masterInstanceSecurityGroupIdHasBeenSet = true;
    m_masterInstanceSecurityGroupId = std::forward<MasterInstanceSecurityGroupIdT>(value);
  }
  template <typename MasterInstanceSecurityGroupIdT = Aws::String>
  ExecutionEngineConfig& WithMasterInstanceSecurityGroupId(MasterInstanceSecurityGroupIdT&& value) {
    SetMasterInstanceSecurityGroupId(std::forward<MasterInstanceSecurityGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  ExecutionEngineConfig& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
