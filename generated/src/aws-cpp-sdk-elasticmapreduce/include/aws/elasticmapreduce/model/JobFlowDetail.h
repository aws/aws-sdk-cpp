...
class JobFlowDetail {
 public:
  ...
  void SetJobFlowId(JobFlowIdT&& value) {
    ...
    m_jobFlowId = std::forward<JobFlowIdT>(value);
  }
  template <typename JobFlowIdT = Aws::String>
  JobFlowDetail& WithJobFlowId(JobFlowIdT&& value) {
    SetJobFlowId(std::forward<JobFlowIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecutionStatusDetail(ExecutionStatusDetailT&& value) {
    ...
    m_executionStatusDetail = std::forward<ExecutionStatusDetailT>(value);
  }
  template <typename ExecutionStatusDetailT = JobFlowExecutionStatusDetail>
  JobFlowDetail& WithExecutionStatusDetail(ExecutionStatusDetailT&& value) {
    SetExecutionStatusDetail(std::forward<ExecutionStatusDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobFlowDetail& WithVisibleToAllUsers(bool value) {
  ...
  inline JobFlowDetail& WithScaleDownBehavior(ScaleDownBehavior value) {
