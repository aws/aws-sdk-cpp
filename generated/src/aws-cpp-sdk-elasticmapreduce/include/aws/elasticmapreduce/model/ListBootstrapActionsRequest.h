...
namespace Model
{
  ...
  public:
    ...
    template<typename ClusterIdT = Aws::String>
    ListBootstrapActionsRequest& WithClusterId(ClusterIdT&& value) { SetClusterId(std::forward<ClusterIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MarkerT = Aws::String>
    ListBootstrapActionsRequest& WithMarker(MarkerT&& value) { SetMarker(std::forward<MarkerT>(value)); return *this;}
    ///@}
  private:
