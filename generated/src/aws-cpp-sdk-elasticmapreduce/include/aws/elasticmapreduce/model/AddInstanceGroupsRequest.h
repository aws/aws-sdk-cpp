...
class AddInstanceGroupsRequest : public EMRRequest {
 public:
  ...
  template <typename InstanceGroupsT = Aws::Vector<InstanceGroupConfig>>
  AddInstanceGroupsRequest& WithInstanceGroups(InstanceGroupsT&& value) {
    SetInstanceGroups(std::forward<InstanceGroupsT>(value));
    return *this;
  }
  template <typename InstanceGroupsT = InstanceGroupConfig>
  AddInstanceGroupsRequest& AddInstanceGroups(InstanceGroupsT&& value) {
    m_instanceGroupsHasBeenSet = true;
  ...
  template <typename JobFlowIdT = Aws::String>
  AddInstanceGroupsRequest& WithJobFlowId(JobFlowIdT&& value) {
