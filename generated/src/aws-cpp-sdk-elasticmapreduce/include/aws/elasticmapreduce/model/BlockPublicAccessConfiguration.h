...
class BlockPublicAccessConfiguration {
 public:
  ...
  inline void SetBlockPublicSecurityGroupRules(bool value) {
    m_blockPublicSecurityGroupRulesHasBeenSet = true;
    m_blockPublicSecurityGroupRules = value;
  }
  inline BlockPublicAccessConfiguration& WithBlockPublicSecurityGroupRules(bool value) {
    SetBlockPublicSecurityGroupRules(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<PortRange>& GetPermittedPublicSecurityGroupRuleRanges() const {
    return m_permittedPublicSecurityGroupRuleRanges;
  }
  ...
  void SetPermittedPublicSecurityGroupRuleRanges(PermittedPublicSecurityGroupRuleRangesT&& value) {
    ...
    m_permittedPublicSecurityGroupRuleRanges = std::forward<PermittedPublicSecurityGroupRuleRangesT>(value);
  }
  template <typename PermittedPublicSecurityGroupRuleRangesT = Aws::Vector<PortRange>>
  BlockPublicAccessConfiguration& WithPermittedPublicSecurityGroupRuleRanges(PermittedPublicSecurityGroupRuleRangesT&& value) {
    SetPermittedPublicSecurityGroupRuleRanges(std::forward<PermittedPublicSecurityGroupRuleRangesT>(value));
    return *this;
  }
  ...
  BlockPublicAccessConfiguration& AddPermittedPublicSecurityGroupRuleRanges(PermittedPublicSecurityGroupRuleRangesT&& value) {
    m_permittedPublicSecurityGroupRuleRangesHasBeenSet = true;
    m_permittedPublicSecurityGroupRuleRanges.emplace_back(std::forward<PermittedPublicSecurityGroupRuleRangesT>(value));
    return *this;
  }
  ///@}
 private:
