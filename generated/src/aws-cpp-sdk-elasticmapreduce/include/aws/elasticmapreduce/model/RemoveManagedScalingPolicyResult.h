...
namespace Model
{
  ...
  {
  public:
    AWS_EMR_API RemoveManagedScalingPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveManagedScalingPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
