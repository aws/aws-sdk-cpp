...
class ListNotebookExecutionsRequest : public EMRRequest {
 public:
  ...
  void SetEditorId(EditorIdT&& value) {
    ...
    m_editorId = std::forward<EditorIdT>(value);
  }
  template <typename EditorIdT = Aws::String>
  ListNotebookExecutionsRequest& WithEditorId(EditorIdT&& value) {
    SetEditorId(std::forward<EditorIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(NotebookExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListNotebookExecutionsRequest& WithStatus(NotebookExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExecutionEngineId(ExecutionEngineIdT&& value) {
    ...
    m_executionEngineId = std::forward<ExecutionEngineIdT>(value);
  }
  template <typename ExecutionEngineIdT = Aws::String>
  ListNotebookExecutionsRequest& WithExecutionEngineId(ExecutionEngineIdT&& value) {
    SetExecutionEngineId(std::forward<ExecutionEngineIdT>(value));
    return *this;
  }
  ///@}
 private:
