 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/elasticmapreduce-2009-03-31/NotebookS3LocationFromInput">AWS
 * API Reference</a></p>
 */
class NotebookS3LocationFromInput {
 public:
  ...
  template <typename BucketT = Aws::String>
  NotebookS3LocationFromInput& WithBucket(BucketT&& value) {
  ...
  template <typename KeyT = Aws::String>
  NotebookS3LocationFromInput& WithKey(KeyT&& value) {
