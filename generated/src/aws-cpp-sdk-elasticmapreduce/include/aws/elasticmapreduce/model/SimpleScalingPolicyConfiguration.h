...
class SimpleScalingPolicyConfiguration {
 public:
  ...
  inline void SetAdjustmentType(AdjustmentType value) {
    m_adjustmentTypeHasBeenSet = true;
    m_adjustmentType = value;
  }
  inline SimpleScalingPolicyConfiguration& WithAdjustmentType(AdjustmentType value) {
  ...
  inline SimpleScalingPolicyConfiguration& WithScalingAdjustment(int value) {
  ...
  inline SimpleScalingPolicyConfiguration& WithCoolDown(int value) {
    SetCoolDown(value);
    return *this;
  }
  ///@}
