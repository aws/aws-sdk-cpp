...
namespace Model
{
  ...
  {
  public:
    AWS_EMR_API UpdateStudioSessionMappingRequest() = default;
    ...
    template<typename StudioIdT = Aws::String>
    UpdateStudioSessionMappingRequest& WithStudioId(StudioIdT&& value) { SetStudioId(std::forward<StudioIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentityIdT = Aws::String>
    UpdateStudioSessionMappingRequest& WithIdentityId(IdentityIdT&& value) { SetIdentityId(std::forward<IdentityIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentityNameT = Aws::String>
    UpdateStudioSessionMappingRequest& WithIdentityName(IdentityNameT&& value) { SetIdentityName(std::forward<IdentityNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateStudioSessionMappingRequest& WithIdentityType(IdentityType value) { SetIdentityType(value); return *this;}
    ///@}
    ...
    template<typename SessionPolicyArnT = Aws::String>
    UpdateStudioSessionMappingRequest& WithSessionPolicyArn(SessionPolicyArnT&& value) { SetSessionPolicyArn(std::forward<SessionPolicyArnT>(value)); return *this;}
    ///@}
  private:
