...
class InstanceGroupDetail {
 public:
  ...
  inline InstanceGroupDetail& WithMarket(MarketType value) {
    SetMarket(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceGroupDetail& WithInstanceRole(InstanceRoleType value) {
  ...
  inline void SetInstanceRequestCount(int value) {
    m_instanceRequestCountHasBeenSet = true;
    m_instanceRequestCount = value;
  }
  inline InstanceGroupDetail& WithInstanceRequestCount(int value) {
    SetInstanceRequestCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceRunningCount(int value) {
    m_instanceRunningCountHasBeenSet = true;
    m_instanceRunningCount = value;
  }
  inline InstanceGroupDetail& WithInstanceRunningCount(int value) {
    SetInstanceRunningCount(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceGroupDetail& WithState(InstanceGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
