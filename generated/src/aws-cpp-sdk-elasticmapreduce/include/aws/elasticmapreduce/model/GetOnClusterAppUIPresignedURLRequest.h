...
class GetOnClusterAppUIPresignedURLRequest : public EMRRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  GetOnClusterAppUIPresignedURLRequest& WithClusterId(ClusterIdT&& value) {
  ...
  inline void SetOnClusterAppUIType(OnClusterAppUIType value) {
    m_onClusterAppUITypeHasBeenSet = true;
    m_onClusterAppUIType = value;
  }
  inline GetOnClusterAppUIPresignedURLRequest& WithOnClusterAppUIType(OnClusterAppUIType value) {
    SetOnClusterAppUIType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationIdT = Aws::String>
  GetOnClusterAppUIPresignedURLRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline GetOnClusterAppUIPresignedURLRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  GetOnClusterAppUIPresignedURLRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
