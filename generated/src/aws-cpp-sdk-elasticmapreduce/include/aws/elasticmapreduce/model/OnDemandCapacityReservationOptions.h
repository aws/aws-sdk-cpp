...
class OnDemandCapacityReservationOptions {
 public:
  ...
  inline void SetUsageStrategy(OnDemandCapacityReservationUsageStrategy value) {
    m_usageStrategyHasBeenSet = true;
    m_usageStrategy = value;
  }
  inline OnDemandCapacityReservationOptions& WithUsageStrategy(OnDemandCapacityReservationUsageStrategy value) {
  ...
  inline void SetCapacityReservationPreference(OnDemandCapacityReservationPreference value) {
    m_capacityReservationPreferenceHasBeenSet = true;
    m_capacityReservationPreference = value;
  }
  inline OnDemandCapacityReservationOptions& WithCapacityReservationPreference(OnDemandCapacityReservationPreference value) {
