...
class ListClustersRequest : public EMRRequest {
 public:
  ...
  void SetClusterStates(ClusterStatesT&& value) {
    m_clusterStatesHasBeenSet = true;
    m_clusterStates = std::forward<ClusterStatesT>(value);
  }
  template <typename ClusterStatesT = Aws::Vector<ClusterState>>
  ListClustersRequest& WithClusterStates(ClusterStatesT&& value) {
    SetClusterStates(std::forward<ClusterStatesT>(value));
    return *this;
  }
  inline ListClustersRequest& AddClusterStates(ClusterState value) {
    m_clusterStatesHasBeenSet = true;
    m_clusterStates.push_back(value);
    return *this;
  }
  ///@}
