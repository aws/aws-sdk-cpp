...
class InstanceFleet {
 public:
  ...
  inline InstanceFleet& WithInstanceFleetType(InstanceFleetType value) {
  ...
  inline InstanceFleet& WithTargetOnDemandCapacity(int value) {
  ...
  inline InstanceFleet& WithTargetSpotCapacity(int value) {
  ...
  inline void SetProvisionedOnDemandCapacity(int value) {
    m_provisionedOnDemandCapacityHasBeenSet = true;
    m_provisionedOnDemandCapacity = value;
  }
  inline InstanceFleet& WithProvisionedOnDemandCapacity(int value) {
    SetProvisionedOnDemandCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProvisionedSpotCapacity(int value) {
    m_provisionedSpotCapacityHasBeenSet = true;
    m_provisionedSpotCapacity = value;
  }
  inline InstanceFleet& WithProvisionedSpotCapacity(int value) {
    SetProvisionedSpotCapacity(value);
    return *this;
  }
  ///@}
