...
class JobFlowInstancesDetail {
 public:
  ...
  void SetMasterInstanceType(MasterInstanceTypeT&& value) {
    ...
    m_masterInstanceType = std::forward<MasterInstanceTypeT>(value);
  }
  template <typename MasterInstanceTypeT = Aws::String>
  JobFlowInstancesDetail& WithMasterInstanceType(MasterInstanceTypeT&& value) {
    SetMasterInstanceType(std::forward<MasterInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterPublicDnsName(MasterPublicDnsNameT&& value) {
    ...
    m_masterPublicDnsName = std::forward<MasterPublicDnsNameT>(value);
  }
  template <typename MasterPublicDnsNameT = Aws::String>
  JobFlowInstancesDetail& WithMasterPublicDnsName(MasterPublicDnsNameT&& value) {
    SetMasterPublicDnsName(std::forward<MasterPublicDnsNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterInstanceId(MasterInstanceIdT&& value) {
    ...
    m_masterInstanceId = std::forward<MasterInstanceIdT>(value);
  }
  template <typename MasterInstanceIdT = Aws::String>
  JobFlowInstancesDetail& WithMasterInstanceId(MasterInstanceIdT&& value) {
    SetMasterInstanceId(std::forward<MasterInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlaveInstanceType(SlaveInstanceTypeT&& value) {
    ...
    m_slaveInstanceType = std::forward<SlaveInstanceTypeT>(value);
  }
  template <typename SlaveInstanceTypeT = Aws::String>
  JobFlowInstancesDetail& WithSlaveInstanceType(SlaveInstanceTypeT&& value) {
    SetSlaveInstanceType(std::forward<SlaveInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobFlowInstancesDetail& WithInstanceCount(int value) {
  ...
  inline void SetNormalizedInstanceHours(int value) {
    m_normalizedInstanceHoursHasBeenSet = true;
    m_normalizedInstanceHours = value;
  }
  inline JobFlowInstancesDetail& WithNormalizedInstanceHours(int value) {
    SetNormalizedInstanceHours(value);
    return *this;
  }
  ///@}
  ...
  void SetEc2KeyName(Ec2KeyNameT&& value) {
    ...
    m_ec2KeyName = std::forward<Ec2KeyNameT>(value);
  }
  template <typename Ec2KeyNameT = Aws::String>
  JobFlowInstancesDetail& WithEc2KeyName(Ec2KeyNameT&& value) {
    SetEc2KeyName(std::forward<Ec2KeyNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEc2SubnetId(Ec2SubnetIdT&& value) {
    ...
    m_ec2SubnetId = std::forward<Ec2SubnetIdT>(value);
  }
  template <typename Ec2SubnetIdT = Aws::String>
  JobFlowInstancesDetail& WithEc2SubnetId(Ec2SubnetIdT&& value) {
    SetEc2SubnetId(std::forward<Ec2SubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetKeepJobFlowAliveWhenNoSteps(bool value) {
    m_keepJobFlowAliveWhenNoStepsHasBeenSet = true;
    m_keepJobFlowAliveWhenNoSteps = value;
  }
  inline JobFlowInstancesDetail& WithKeepJobFlowAliveWhenNoSteps(bool value) {
  ...
  inline void SetTerminationProtected(bool value) {
    m_terminationProtectedHasBeenSet = true;
    m_terminationProtected = value;
  }
  inline JobFlowInstancesDetail& WithTerminationProtected(bool value) {
    SetTerminationProtected(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnhealthyNodeReplacement(bool value) {
    m_unhealthyNodeReplacementHasBeenSet = true;
    m_unhealthyNodeReplacement = value;
  }
  inline JobFlowInstancesDetail& WithUnhealthyNodeReplacement(bool value) {
    SetUnhealthyNodeReplacement(value);
    return *this;
  }
  ///@}
  ...
  void SetHadoopVersion(HadoopVersionT&& value) {
    ...
    m_hadoopVersion = std::forward<HadoopVersionT>(value);
  }
  template <typename HadoopVersionT = Aws::String>
  JobFlowInstancesDetail& WithHadoopVersion(HadoopVersionT&& value) {
    SetHadoopVersion(std::forward<HadoopVersionT>(value));
    return *this;
  }
  ///@}
 private:
