...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketT = Aws::String>
    NotebookS3LocationForOutput& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyT = Aws::String>
    NotebookS3LocationForOutput& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
  private:
