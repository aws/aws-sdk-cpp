...
class ListReleaseLabelsResult {
 public:
  ...
  void SetReleaseLabels(ReleaseLabelsT&& value) {
    m_releaseLabelsHasBeenSet = true;
    m_releaseLabels = std::forward<ReleaseLabelsT>(value);
  }
  template <typename ReleaseLabelsT = Aws::Vector<Aws::String>>
  ListReleaseLabelsResult& WithReleaseLabels(ReleaseLabelsT&& value) {
    SetReleaseLabels(std::forward<ReleaseLabelsT>(value));
    return *this;
  }
  template <typename ReleaseLabelsT = Aws::String>
  ListReleaseLabelsResult& AddReleaseLabels(ReleaseLabelsT&& value) {
    m_releaseLabelsHasBeenSet = true;
    m_releaseLabels.emplace_back(std::forward<ReleaseLabelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReleaseLabelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReleaseLabelsResult& WithRequestId(RequestIdT&& value) {
