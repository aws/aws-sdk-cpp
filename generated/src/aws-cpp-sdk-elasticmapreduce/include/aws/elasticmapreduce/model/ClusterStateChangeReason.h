...
class ClusterStateChangeReason {
 public:
  ...
  inline void SetCode(ClusterStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClusterStateChangeReason& WithCode(ClusterStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClusterStateChangeReason& WithMessage(MessageT&& value) {
