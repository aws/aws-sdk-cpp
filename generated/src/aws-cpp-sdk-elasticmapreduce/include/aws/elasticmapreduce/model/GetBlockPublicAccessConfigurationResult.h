...
class GetBlockPublicAccessConfigurationResult {
 public:
  ...
  void SetBlockPublicAccessConfiguration(BlockPublicAccessConfigurationT&& value) {
    m_blockPublicAccessConfigurationHasBeenSet = true;
    m_blockPublicAccessConfiguration = std::forward<BlockPublicAccessConfigurationT>(value);
  }
  template <typename BlockPublicAccessConfigurationT = BlockPublicAccessConfiguration>
  GetBlockPublicAccessConfigurationResult& WithBlockPublicAccessConfiguration(BlockPublicAccessConfigurationT&& value) {
    SetBlockPublicAccessConfiguration(std::forward<BlockPublicAccessConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const BlockPublicAccessConfigurationMetadata& GetBlockPublicAccessConfigurationMetadata() const {
    return m_blockPublicAccessConfigurationMetadata;
  }
  template <typename BlockPublicAccessConfigurationMetadataT = BlockPublicAccessConfigurationMetadata>
  void SetBlockPublicAccessConfigurationMetadata(BlockPublicAccessConfigurationMetadataT&& value) {
    m_blockPublicAccessConfigurationMetadataHasBeenSet = true;
    m_blockPublicAccessConfigurationMetadata = std::forward<BlockPublicAccessConfigurationMetadataT>(value);
  }
  template <typename BlockPublicAccessConfigurationMetadataT = BlockPublicAccessConfigurationMetadata>
  GetBlockPublicAccessConfigurationResult& WithBlockPublicAccessConfigurationMetadata(BlockPublicAccessConfigurationMetadataT&& value) {
    SetBlockPublicAccessConfigurationMetadata(std::forward<BlockPublicAccessConfigurationMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBlockPublicAccessConfigurationResult& WithRequestId(RequestIdT&& value) {
