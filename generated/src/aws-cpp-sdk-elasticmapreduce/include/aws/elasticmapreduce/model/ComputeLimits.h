...
class ComputeLimits {
 public:
  ...
  inline void SetUnitType(ComputeLimitsUnitType value) {
    m_unitTypeHasBeenSet = true;
    m_unitType = value;
  }
  inline ComputeLimits& WithUnitType(ComputeLimitsUnitType value) {
    SetUnitType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumCapacityUnits(int value) {
    m_minimumCapacityUnitsHasBeenSet = true;
    m_minimumCapacityUnits = value;
  }
  inline ComputeLimits& WithMinimumCapacityUnits(int value) {
    SetMinimumCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumCapacityUnits(int value) {
    m_maximumCapacityUnitsHasBeenSet = true;
    m_maximumCapacityUnits = value;
  }
  inline ComputeLimits& WithMaximumCapacityUnits(int value) {
    SetMaximumCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumOnDemandCapacityUnits(int value) {
    m_maximumOnDemandCapacityUnitsHasBeenSet = true;
    m_maximumOnDemandCapacityUnits = value;
  }
  inline ComputeLimits& WithMaximumOnDemandCapacityUnits(int value) {
    SetMaximumOnDemandCapacityUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumCoreCapacityUnits(int value) {
    m_maximumCoreCapacityUnitsHasBeenSet = true;
    m_maximumCoreCapacityUnits = value;
  }
  inline ComputeLimits& WithMaximumCoreCapacityUnits(int value) {
    SetMaximumCoreCapacityUnits(value);
    return *this;
  }
  ///@}
 private:
