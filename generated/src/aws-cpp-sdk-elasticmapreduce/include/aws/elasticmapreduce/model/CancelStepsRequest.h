...
class CancelStepsRequest : public EMRRequest {
 public:
  ...
  inline void SetStepCancellationOption(StepCancellationOption value) {
    m_stepCancellationOptionHasBeenSet = true;
    m_stepCancellationOption = value;
  }
  inline CancelStepsRequest& WithStepCancellationOption(StepCancellationOption value) {
    SetStepCancellationOption(value);
    return *this;
  }
  ///@}
 private:
