...
class DeleteStudioSessionMappingRequest : public EMRRequest {
 public:
  ...
  template <typename StudioIdT = Aws::String>
  DeleteStudioSessionMappingRequest& WithStudioId(StudioIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  DeleteStudioSessionMappingRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename IdentityNameT = Aws::String>
  DeleteStudioSessionMappingRequest& WithIdentityName(IdentityNameT&& value) {
  ...
  inline DeleteStudioSessionMappingRequest& WithIdentityType(IdentityType value) {
