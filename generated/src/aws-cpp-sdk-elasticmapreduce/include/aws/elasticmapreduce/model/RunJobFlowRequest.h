...
namespace Model
{
  ...
  public:
     ...
     * EMR releases 5.30.0 and higher, excluding Amazon EMR 6.0.0.</p>
     */
     ...
     * higher, use Applications.</p>  <p>A list of strings that indicates
    ...
    /**
     * <p>For Amazon EMR releases 4.0 and higher. The list of configurations supplied
