...
class RunJobFlowRequest : public EMRRequest {
 public:
  ...
  void SetLogEncryptionKmsKeyId(LogEncryptionKmsKeyIdT&& value) {
    ...
    m_logEncryptionKmsKeyId = std::forward<LogEncryptionKmsKeyIdT>(value);
  }
  template <typename LogEncryptionKmsKeyIdT = Aws::String>
  RunJobFlowRequest& WithLogEncryptionKmsKeyId(LogEncryptionKmsKeyIdT&& value) {
    SetLogEncryptionKmsKeyId(std::forward<LogEncryptionKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmiVersion(AmiVersionT&& value) {
    ...
    m_amiVersion = std::forward<AmiVersionT>(value);
  }
  template <typename AmiVersionT = Aws::String>
  RunJobFlowRequest& WithAmiVersion(AmiVersionT&& value) {
    SetAmiVersion(std::forward<AmiVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedProducts(SupportedProductsT&& value) {
    ...
    m_supportedProducts = std::forward<SupportedProductsT>(value);
  }
  template <typename SupportedProductsT = Aws::Vector<Aws::String>>
  RunJobFlowRequest& WithSupportedProducts(SupportedProductsT&& value) {
    SetSupportedProducts(std::forward<SupportedProductsT>(value));
    return *this;
  }
  template <typename SupportedProductsT = Aws::String>
  RunJobFlowRequest& AddSupportedProducts(SupportedProductsT&& value) {
    m_supportedProductsHasBeenSet = true;
    m_supportedProducts.emplace_back(std::forward<SupportedProductsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewSupportedProducts(NewSupportedProductsT&& value) {
    m_newSupportedProductsHasBeenSet = true;
    m_newSupportedProducts = std::forward<NewSupportedProductsT>(value);
  }
  template <typename NewSupportedProductsT = Aws::Vector<SupportedProductConfig>>
  RunJobFlowRequest& WithNewSupportedProducts(NewSupportedProductsT&& value) {
    SetNewSupportedProducts(std::forward<NewSupportedProductsT>(value));
    return *this;
  }
  ...
  RunJobFlowRequest& AddNewSupportedProducts(NewSupportedProductsT&& value) {
    m_newSupportedProductsHasBeenSet = true;
    m_newSupportedProducts.emplace_back(std::forward<NewSupportedProductsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVisibleToAllUsers(bool value) {
    m_visibleToAllUsersHasBeenSet = true;
    m_visibleToAllUsers = value;
  }
  inline RunJobFlowRequest& WithVisibleToAllUsers(bool value) {
    SetVisibleToAllUsers(value);
    return *this;
  }
  ///@}
  ...
  void SetJobFlowRole(JobFlowRoleT&& value) {
    ...
    m_jobFlowRole = std::forward<JobFlowRoleT>(value);
  }
  template <typename JobFlowRoleT = Aws::String>
  RunJobFlowRequest& WithJobFlowRole(JobFlowRoleT&& value) {
    SetJobFlowRole(std::forward<JobFlowRoleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoScalingRole(AutoScalingRoleT&& value) {
    ...
    m_autoScalingRole = std::forward<AutoScalingRoleT>(value);
  }
  template <typename AutoScalingRoleT = Aws::String>
  RunJobFlowRequest& WithAutoScalingRole(AutoScalingRoleT&& value) {
    SetAutoScalingRole(std::forward<AutoScalingRoleT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScaleDownBehavior(ScaleDownBehavior value) {
    m_scaleDownBehaviorHasBeenSet = true;
    m_scaleDownBehavior = value;
  }
  inline RunJobFlowRequest& WithScaleDownBehavior(ScaleDownBehavior value) {
    SetScaleDownBehavior(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomAmiId(CustomAmiIdT&& value) {
    ...
    m_customAmiId = std::forward<CustomAmiIdT>(value);
  }
  template <typename CustomAmiIdT = Aws::String>
  RunJobFlowRequest& WithCustomAmiId(CustomAmiIdT&& value) {
    SetCustomAmiId(std::forward<CustomAmiIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEbsRootVolumeSize(int value) {
    m_ebsRootVolumeSizeHasBeenSet = true;
    m_ebsRootVolumeSize = value;
  }
  inline RunJobFlowRequest& WithEbsRootVolumeSize(int value) {
    SetEbsRootVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRepoUpgradeOnBoot(RepoUpgradeOnBoot value) {
    m_repoUpgradeOnBootHasBeenSet = true;
    m_repoUpgradeOnBoot = value;
  }
  inline RunJobFlowRequest& WithRepoUpgradeOnBoot(RepoUpgradeOnBoot value) {
    SetRepoUpgradeOnBoot(value);
    return *this;
  }
  ///@}
  ...
  void SetKerberosAttributes(KerberosAttributesT&& value) {
    ...
    m_kerberosAttributes = std::forward<KerberosAttributesT>(value);
  }
  template <typename KerberosAttributesT = KerberosAttributes>
  RunJobFlowRequest& WithKerberosAttributes(KerberosAttributesT&& value) {
    SetKerberosAttributes(std::forward<KerberosAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStepConcurrencyLevel(int value) {
    m_stepConcurrencyLevelHasBeenSet = true;
    m_stepConcurrencyLevel = value;
  }
  inline RunJobFlowRequest& WithStepConcurrencyLevel(int value) {
    SetStepConcurrencyLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetManagedScalingPolicy(ManagedScalingPolicyT&& value) {
    m_managedScalingPolicyHasBeenSet = true;
    m_managedScalingPolicy = std::forward<ManagedScalingPolicyT>(value);
  }
  template <typename ManagedScalingPolicyT = ManagedScalingPolicy>
  RunJobFlowRequest& WithManagedScalingPolicy(ManagedScalingPolicyT&& value) {
    SetManagedScalingPolicy(std::forward<ManagedScalingPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlacementGroupConfigs(PlacementGroupConfigsT&& value) {
    m_placementGroupConfigsHasBeenSet = true;
    m_placementGroupConfigs = std::forward<PlacementGroupConfigsT>(value);
  }
  template <typename PlacementGroupConfigsT = Aws::Vector<PlacementGroupConfig>>
  RunJobFlowRequest& WithPlacementGroupConfigs(PlacementGroupConfigsT&& value) {
    SetPlacementGroupConfigs(std::forward<PlacementGroupConfigsT>(value));
    return *this;
  }
  ...
  RunJobFlowRequest& AddPlacementGroupConfigs(PlacementGroupConfigsT&& value) {
    m_placementGroupConfigsHasBeenSet = true;
    m_placementGroupConfigs.emplace_back(std::forward<PlacementGroupConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoTerminationPolicy(AutoTerminationPolicyT&& value) {
    ...
    m_autoTerminationPolicy = std::forward<AutoTerminationPolicyT>(value);
  }
  template <typename AutoTerminationPolicyT = AutoTerminationPolicy>
  RunJobFlowRequest& WithAutoTerminationPolicy(AutoTerminationPolicyT&& value) {
    SetAutoTerminationPolicy(std::forward<AutoTerminationPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOSReleaseLabel(OSReleaseLabelT&& value) {
    ...
    m_oSReleaseLabel = std::forward<OSReleaseLabelT>(value);
  }
  template <typename OSReleaseLabelT = Aws::String>
  RunJobFlowRequest& WithOSReleaseLabel(OSReleaseLabelT&& value) {
    SetOSReleaseLabel(std::forward<OSReleaseLabelT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEbsRootVolumeIops(int value) {
    m_ebsRootVolumeIopsHasBeenSet = true;
    m_ebsRootVolumeIops = value;
  }
  inline RunJobFlowRequest& WithEbsRootVolumeIops(int value) {
    SetEbsRootVolumeIops(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEbsRootVolumeThroughput(int value) {
    m_ebsRootVolumeThroughputHasBeenSet = true;
    m_ebsRootVolumeThroughput = value;
  }
  inline RunJobFlowRequest& WithEbsRootVolumeThroughput(int value) {
    SetEbsRootVolumeThroughput(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExtendedSupport(bool value) {
    m_extendedSupportHasBeenSet = true;
    m_extendedSupport = value;
  }
  inline RunJobFlowRequest& WithExtendedSupport(bool value) {
    SetExtendedSupport(value);
    return *this;
  }
  ///@}
 private:
