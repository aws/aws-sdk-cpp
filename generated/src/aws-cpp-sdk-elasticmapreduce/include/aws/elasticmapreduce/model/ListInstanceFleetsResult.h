...
class ListInstanceFleetsResult {
 public:
  ...
  template <typename InstanceFleetsT = Aws::Vector<InstanceFleet>>
  ListInstanceFleetsResult& WithInstanceFleets(InstanceFleetsT&& value) {
    SetInstanceFleets(std::forward<InstanceFleetsT>(value));
    return *this;
  }
  template <typename InstanceFleetsT = InstanceFleet>
  ListInstanceFleetsResult& AddInstanceFleets(InstanceFleetsT&& value) {
    m_instanceFleetsHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  ListInstanceFleetsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInstanceFleetsResult& WithRequestId(RequestIdT&& value) {
