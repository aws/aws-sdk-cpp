...
class InstanceGroupTimeline {
 public:
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  InstanceGroupTimeline& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename ReadyDateTimeT = Aws::Utils::DateTime>
  InstanceGroupTimeline& WithReadyDateTime(ReadyDateTimeT&& value) {
  ...
  template <typename EndDateTimeT = Aws::Utils::DateTime>
  InstanceGroupTimeline& WithEndDateTime(EndDateTimeT&& value) {
