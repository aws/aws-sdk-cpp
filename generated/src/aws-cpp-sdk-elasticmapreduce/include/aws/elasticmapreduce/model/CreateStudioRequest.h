...
class CreateStudioRequest : public EMRRequest {
 public:
  ...
  inline CreateStudioRequest& WithAuthMode(AuthMode value) {
    SetAuthMode(value);
    return *this;
  }
  ///@}
  ...
  void SetEngineSecurityGroupId(EngineSecurityGroupIdT&& value) {
    ...
    m_engineSecurityGroupId = std::forward<EngineSecurityGroupIdT>(value);
  }
  template <typename EngineSecurityGroupIdT = Aws::String>
  CreateStudioRequest& WithEngineSecurityGroupId(EngineSecurityGroupIdT&& value) {
    SetEngineSecurityGroupId(std::forward<EngineSecurityGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdpAuthUrl(IdpAuthUrlT&& value) {
    ...
    m_idpAuthUrl = std::forward<IdpAuthUrlT>(value);
  }
  template <typename IdpAuthUrlT = Aws::String>
  CreateStudioRequest& WithIdpAuthUrl(IdpAuthUrlT&& value) {
    SetIdpAuthUrl(std::forward<IdpAuthUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdpRelayStateParameterName(IdpRelayStateParameterNameT&& value) {
    ...
    m_idpRelayStateParameterName = std::forward<IdpRelayStateParameterNameT>(value);
  }
  template <typename IdpRelayStateParameterNameT = Aws::String>
  CreateStudioRequest& WithIdpRelayStateParameterName(IdpRelayStateParameterNameT&& value) {
    SetIdpRelayStateParameterName(std::forward<IdpRelayStateParameterNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrustedIdentityPropagationEnabled(bool value) {
    m_trustedIdentityPropagationEnabledHasBeenSet = true;
    m_trustedIdentityPropagationEnabled = value;
  }
  inline CreateStudioRequest& WithTrustedIdentityPropagationEnabled(bool value) {
    SetTrustedIdentityPropagationEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIdcUserAssignment(IdcUserAssignment value) {
    m_idcUserAssignmentHasBeenSet = true;
    m_idcUserAssignment = value;
  }
  inline CreateStudioRequest& WithIdcUserAssignment(IdcUserAssignment value) {
    SetIdcUserAssignment(value);
    return *this;
  }
  ///@}
