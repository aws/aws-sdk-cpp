...
class OnDemandResizingSpecification {
 public:
  ...
  inline OnDemandResizingSpecification& WithTimeoutDurationMinutes(int value) {
  ...
  inline void SetAllocationStrategy(OnDemandProvisioningAllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline OnDemandResizingSpecification& WithAllocationStrategy(OnDemandProvisioningAllocationStrategy value) {
  ...
  void SetCapacityReservationOptions(CapacityReservationOptionsT&& value) {
    ...
    m_capacityReservationOptions = std::forward<CapacityReservationOptionsT>(value);
  }
  template <typename CapacityReservationOptionsT = OnDemandCapacityReservationOptions>
  OnDemandResizingSpecification& WithCapacityReservationOptions(CapacityReservationOptionsT&& value) {
    SetCapacityReservationOptions(std::forward<CapacityReservationOptionsT>(value));
    return *this;
  }
  ///@}
 private:
