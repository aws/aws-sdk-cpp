...
class GetPersistentAppUIPresignedURLResult {
 public:
  ...
  inline GetPersistentAppUIPresignedURLResult& WithPresignedURLReady(bool value) {
  ...
  template <typename PresignedURLT = Aws::String>
  GetPersistentAppUIPresignedURLResult& WithPresignedURL(PresignedURLT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPersistentAppUIPresignedURLResult& WithRequestId(RequestIdT&& value) {
