...
class SupportedInstanceType {
 public:
  ...
  template <typename TypeT = Aws::String>
  SupportedInstanceType& WithType(TypeT&& value) {
  ...
  inline void SetMemoryGB(double value) {
    m_memoryGBHasBeenSet = true;
    m_memoryGB = value;
  }
  inline SupportedInstanceType& WithMemoryGB(double value) {
    SetMemoryGB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStorageGB(int value) {
    m_storageGBHasBeenSet = true;
    m_storageGB = value;
  }
  inline SupportedInstanceType& WithStorageGB(int value) {
    SetStorageGB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVCPU(int value) {
    m_vCPUHasBeenSet = true;
    m_vCPU = value;
  }
  inline SupportedInstanceType& WithVCPU(int value) {
    SetVCPU(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIs64BitsOnly(bool value) {
    m_is64BitsOnlyHasBeenSet = true;
    m_is64BitsOnly = value;
  }
  inline SupportedInstanceType& WithIs64BitsOnly(bool value) {
    SetIs64BitsOnly(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceFamilyId(InstanceFamilyIdT&& value) {
    m_instanceFamilyIdHasBeenSet = true;
    m_instanceFamilyId = std::forward<InstanceFamilyIdT>(value);
  }
  template <typename InstanceFamilyIdT = Aws::String>
  SupportedInstanceType& WithInstanceFamilyId(InstanceFamilyIdT&& value) {
    SetInstanceFamilyId(std::forward<InstanceFamilyIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEbsOptimizedAvailable(bool value) {
    m_ebsOptimizedAvailableHasBeenSet = true;
    m_ebsOptimizedAvailable = value;
  }
  inline SupportedInstanceType& WithEbsOptimizedAvailable(bool value) {
    SetEbsOptimizedAvailable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEbsOptimizedByDefault(bool value) {
    m_ebsOptimizedByDefaultHasBeenSet = true;
    m_ebsOptimizedByDefault = value;
  }
  inline SupportedInstanceType& WithEbsOptimizedByDefault(bool value) {
    SetEbsOptimizedByDefault(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfDisks(int value) {
    m_numberOfDisksHasBeenSet = true;
    m_numberOfDisks = value;
  }
  inline SupportedInstanceType& WithNumberOfDisks(int value) {
  ...
  inline void SetEbsStorageOnly(bool value) {
    m_ebsStorageOnlyHasBeenSet = true;
    m_ebsStorageOnly = value;
  }
  inline SupportedInstanceType& WithEbsStorageOnly(bool value) {
    SetEbsStorageOnly(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArchitectureT = Aws::String>
  SupportedInstanceType& WithArchitecture(ArchitectureT&& value) {
