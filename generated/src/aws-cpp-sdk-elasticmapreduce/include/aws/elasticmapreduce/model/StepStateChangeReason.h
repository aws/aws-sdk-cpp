...
class StepStateChangeReason {
 public:
  ...
  inline void SetCode(StepStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline StepStateChangeReason& WithCode(StepStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  StepStateChangeReason& WithMessage(MessageT&& value) {
