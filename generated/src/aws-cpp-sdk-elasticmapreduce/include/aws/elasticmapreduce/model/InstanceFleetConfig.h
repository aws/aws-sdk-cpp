...
class InstanceFleetConfig {
 public:
  ...
  inline void SetInstanceFleetType(InstanceFleetType value) {
    m_instanceFleetTypeHasBeenSet = true;
    m_instanceFleetType = value;
  }
  inline InstanceFleetConfig& WithInstanceFleetType(InstanceFleetType value) {
    SetInstanceFleetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetOnDemandCapacity(int value) {
    m_targetOnDemandCapacityHasBeenSet = true;
    m_targetOnDemandCapacity = value;
  }
  inline InstanceFleetConfig& WithTargetOnDemandCapacity(int value) {
    SetTargetOnDemandCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetSpotCapacity(int value) {
    m_targetSpotCapacityHasBeenSet = true;
    m_targetSpotCapacity = value;
  }
  inline InstanceFleetConfig& WithTargetSpotCapacity(int value) {
    SetTargetSpotCapacity(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceTypeConfigs(InstanceTypeConfigsT&& value) {
    ...
    m_instanceTypeConfigs = std::forward<InstanceTypeConfigsT>(value);
  }
  template <typename InstanceTypeConfigsT = Aws::Vector<InstanceTypeConfig>>
  InstanceFleetConfig& WithInstanceTypeConfigs(InstanceTypeConfigsT&& value) {
    SetInstanceTypeConfigs(std::forward<InstanceTypeConfigsT>(value));
    return *this;
  }
  ...
  InstanceFleetConfig& AddInstanceTypeConfigs(InstanceTypeConfigsT&& value) {
    m_instanceTypeConfigsHasBeenSet = true;
    m_instanceTypeConfigs.emplace_back(std::forward<InstanceTypeConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLaunchSpecifications(LaunchSpecificationsT&& value) {
    ...
    m_launchSpecifications = std::forward<LaunchSpecificationsT>(value);
  }
  template <typename LaunchSpecificationsT = InstanceFleetProvisioningSpecifications>
  InstanceFleetConfig& WithLaunchSpecifications(LaunchSpecificationsT&& value) {
    SetLaunchSpecifications(std::forward<LaunchSpecificationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResizeSpecifications(ResizeSpecificationsT&& value) {
    ...
    m_resizeSpecifications = std::forward<ResizeSpecificationsT>(value);
  }
  template <typename ResizeSpecificationsT = InstanceFleetResizingSpecifications>
  InstanceFleetConfig& WithResizeSpecifications(ResizeSpecificationsT&& value) {
    SetResizeSpecifications(std::forward<ResizeSpecificationsT>(value));
    return *this;
  }
  ///@}
