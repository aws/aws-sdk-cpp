...
class ManagedScalingPolicy {
 public:
  ...
  void SetComputeLimits(ComputeLimitsT&& value) {
    m_computeLimitsHasBeenSet = true;
    m_computeLimits = std::forward<ComputeLimitsT>(value);
  }
  template <typename ComputeLimitsT = ComputeLimits>
  ManagedScalingPolicy& WithComputeLimits(ComputeLimitsT&& value) {
    SetComputeLimits(std::forward<ComputeLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUtilizationPerformanceIndex(int value) {
    m_utilizationPerformanceIndexHasBeenSet = true;
    m_utilizationPerformanceIndex = value;
  }
  inline ManagedScalingPolicy& WithUtilizationPerformanceIndex(int value) {
    SetUtilizationPerformanceIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScalingStrategy(ScalingStrategy value) {
    m_scalingStrategyHasBeenSet = true;
    m_scalingStrategy = value;
  }
  inline ManagedScalingPolicy& WithScalingStrategy(ScalingStrategy value) {
    SetScalingStrategy(value);
    return *this;
  }
  ///@}
 private:
