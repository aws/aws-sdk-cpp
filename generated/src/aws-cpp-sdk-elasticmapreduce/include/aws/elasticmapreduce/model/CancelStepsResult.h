...
class CancelStepsResult {
 public:
  ...
  void SetCancelStepsInfoList(CancelStepsInfoListT&& value) {
    m_cancelStepsInfoListHasBeenSet = true;
    m_cancelStepsInfoList = std::forward<CancelStepsInfoListT>(value);
  }
  template <typename CancelStepsInfoListT = Aws::Vector<CancelStepsInfo>>
  CancelStepsResult& WithCancelStepsInfoList(CancelStepsInfoListT&& value) {
    SetCancelStepsInfoList(std::forward<CancelStepsInfoListT>(value));
    return *this;
  }
  template <typename CancelStepsInfoListT = CancelStepsInfo>
  CancelStepsResult& AddCancelStepsInfoList(CancelStepsInfoListT&& value) {
    m_cancelStepsInfoListHasBeenSet = true;
    m_cancelStepsInfoList.emplace_back(std::forward<CancelStepsInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CancelStepsResult& WithRequestId(RequestIdT&& value) {
