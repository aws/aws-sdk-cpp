...
class DescribeReleaseLabelResult {
 public:
  ...
  void SetAvailableOSReleases(AvailableOSReleasesT&& value) {
    ...
    m_availableOSReleases = std::forward<AvailableOSReleasesT>(value);
  }
  template <typename AvailableOSReleasesT = Aws::Vector<OSRelease>>
  DescribeReleaseLabelResult& WithAvailableOSReleases(AvailableOSReleasesT&& value) {
    SetAvailableOSReleases(std::forward<AvailableOSReleasesT>(value));
    return *this;
  }
  ...
  DescribeReleaseLabelResult& AddAvailableOSReleases(AvailableOSReleasesT&& value) {
    m_availableOSReleasesHasBeenSet = true;
    m_availableOSReleases.emplace_back(std::forward<AvailableOSReleasesT>(value));
    return *this;
  }
  ///@}
