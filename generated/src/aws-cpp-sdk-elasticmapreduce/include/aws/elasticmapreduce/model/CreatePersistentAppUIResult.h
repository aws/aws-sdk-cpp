...
class CreatePersistentAppUIResult {
 public:
  ...
  template <typename PersistentAppUIIdT = Aws::String>
  CreatePersistentAppUIResult& WithPersistentAppUIId(PersistentAppUIIdT&& value) {
  ...
  inline void SetRuntimeRoleEnabledCluster(bool value) {
    m_runtimeRoleEnabledClusterHasBeenSet = true;
    m_runtimeRoleEnabledCluster = value;
  }
  inline CreatePersistentAppUIResult& WithRuntimeRoleEnabledCluster(bool value) {
    SetRuntimeRoleEnabledCluster(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreatePersistentAppUIResult& WithRequestId(RequestIdT&& value) {
