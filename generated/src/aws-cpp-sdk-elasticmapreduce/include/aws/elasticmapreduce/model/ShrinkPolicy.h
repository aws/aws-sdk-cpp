...
class ShrinkPolicy {
 public:
  ...
  inline void SetDecommissionTimeout(int value) {
    m_decommissionTimeoutHasBeenSet = true;
    m_decommissionTimeout = value;
  }
  inline ShrinkPolicy& WithDecommissionTimeout(int value) {
    SetDecommissionTimeout(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceResizePolicy(InstanceResizePolicyT&& value) {
    ...
    m_instanceResizePolicy = std::forward<InstanceResizePolicyT>(value);
  }
  template <typename InstanceResizePolicyT = InstanceResizePolicy>
  ShrinkPolicy& WithInstanceResizePolicy(InstanceResizePolicyT&& value) {
    SetInstanceResizePolicy(std::forward<InstanceResizePolicyT>(value));
    return *this;
  }
  ///@}
 private:
