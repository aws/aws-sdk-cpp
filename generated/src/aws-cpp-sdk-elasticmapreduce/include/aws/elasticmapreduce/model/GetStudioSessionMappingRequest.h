...
class GetStudioSessionMappingRequest : public EMRRequest {
 public:
  ...
  template <typename StudioIdT = Aws::String>
  GetStudioSessionMappingRequest& WithStudioId(StudioIdT&& value) {
  ...
  template <typename IdentityIdT = Aws::String>
  GetStudioSessionMappingRequest& WithIdentityId(IdentityIdT&& value) {
  ...
  template <typename IdentityNameT = Aws::String>
  GetStudioSessionMappingRequest& WithIdentityName(IdentityNameT&& value) {
  ...
  inline GetStudioSessionMappingRequest& WithIdentityType(IdentityType value) {
