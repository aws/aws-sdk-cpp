...
namespace Model
{
  ...
  {
  public:
    AWS_EMR_API PutBlockPublicAccessConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutBlockPublicAccessConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
