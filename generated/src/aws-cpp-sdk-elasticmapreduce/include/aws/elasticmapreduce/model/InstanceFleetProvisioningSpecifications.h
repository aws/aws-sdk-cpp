...
class InstanceFleetProvisioningSpecifications {
 public:
  ...
  void SetSpotSpecification(SpotSpecificationT&& value) {
    ...
    m_spotSpecification = std::forward<SpotSpecificationT>(value);
  }
  template <typename SpotSpecificationT = SpotProvisioningSpecification>
  InstanceFleetProvisioningSpecifications& WithSpotSpecification(SpotSpecificationT&& value) {
    SetSpotSpecification(std::forward<SpotSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnDemandSpecification(OnDemandSpecificationT&& value) {
    ...
    m_onDemandSpecification = std::forward<OnDemandSpecificationT>(value);
  }
  template <typename OnDemandSpecificationT = OnDemandProvisioningSpecification>
  InstanceFleetProvisioningSpecifications& WithOnDemandSpecification(OnDemandSpecificationT&& value) {
    SetOnDemandSpecification(std::forward<OnDemandSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
