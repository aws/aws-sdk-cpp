...
class AutoScalingPolicyStateChangeReason {
 public:
  ...
  inline void SetCode(AutoScalingPolicyStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline AutoScalingPolicyStateChangeReason& WithCode(AutoScalingPolicyStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  AutoScalingPolicyStateChangeReason& WithMessage(MessageT&& value) {
