...
class EbsConfiguration {
 public:
  ...
  void SetEbsBlockDeviceConfigs(EbsBlockDeviceConfigsT&& value) {
    m_ebsBlockDeviceConfigsHasBeenSet = true;
    m_ebsBlockDeviceConfigs = std::forward<EbsBlockDeviceConfigsT>(value);
  }
  template <typename EbsBlockDeviceConfigsT = Aws::Vector<EbsBlockDeviceConfig>>
  EbsConfiguration& WithEbsBlockDeviceConfigs(EbsBlockDeviceConfigsT&& value) {
    SetEbsBlockDeviceConfigs(std::forward<EbsBlockDeviceConfigsT>(value));
    return *this;
  }
  template <typename EbsBlockDeviceConfigsT = EbsBlockDeviceConfig>
  EbsConfiguration& AddEbsBlockDeviceConfigs(EbsBlockDeviceConfigsT&& value) {
    m_ebsBlockDeviceConfigsHasBeenSet = true;
    m_ebsBlockDeviceConfigs.emplace_back(std::forward<EbsBlockDeviceConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  inline EbsConfiguration& WithEbsOptimized(bool value) {
