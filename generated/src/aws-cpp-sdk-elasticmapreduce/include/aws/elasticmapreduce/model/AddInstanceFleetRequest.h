...
class AddInstanceFleetRequest : public EMRRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  AddInstanceFleetRequest& WithClusterId(ClusterIdT&& value) {
  ...
  void SetInstanceFleet(InstanceFleetT&& value) {
    m_instanceFleetHasBeenSet = true;
    m_instanceFleet = std::forward<InstanceFleetT>(value);
  }
  template <typename InstanceFleetT = InstanceFleetConfig>
  AddInstanceFleetRequest& WithInstanceFleet(InstanceFleetT&& value) {
    SetInstanceFleet(std::forward<InstanceFleetT>(value));
    return *this;
  }
  ///@}
 private:
