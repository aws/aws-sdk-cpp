...
class GetClusterSessionCredentialsResult {
 public:
  ...
  template <typename CredentialsT = Credentials>
  GetClusterSessionCredentialsResult& WithCredentials(CredentialsT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  GetClusterSessionCredentialsResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetClusterSessionCredentialsResult& WithRequestId(RequestIdT&& value) {
