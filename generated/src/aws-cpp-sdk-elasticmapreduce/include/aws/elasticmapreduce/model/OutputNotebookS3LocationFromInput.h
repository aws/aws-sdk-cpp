...
class OutputNotebookS3LocationFromInput {
 public:
  AWS_EMR_API OutputNotebookS3LocationFromInput() = default;
  ...
  template <typename BucketT = Aws::String>
  OutputNotebookS3LocationFromInput& WithBucket(BucketT&& value) {
  ...
  template <typename KeyT = Aws::String>
  OutputNotebookS3LocationFromInput& WithKey(KeyT&& value) {
