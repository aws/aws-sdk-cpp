...
class InstanceFleetStateChangeReason {
 public:
  ...
  inline void SetCode(InstanceFleetStateChangeReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline InstanceFleetStateChangeReason& WithCode(InstanceFleetStateChangeReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  InstanceFleetStateChangeReason& WithMessage(MessageT&& value) {
