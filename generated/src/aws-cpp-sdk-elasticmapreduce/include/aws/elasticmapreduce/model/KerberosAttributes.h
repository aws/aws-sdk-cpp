...
class KerberosAttributes {
 public:
  ...
  void SetKdcAdminPassword(KdcAdminPasswordT&& value) {
    ...
    m_kdcAdminPassword = std::forward<KdcAdminPasswordT>(value);
  }
  template <typename KdcAdminPasswordT = Aws::String>
  KerberosAttributes& WithKdcAdminPassword(KdcAdminPasswordT&& value) {
    SetKdcAdminPassword(std::forward<KdcAdminPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrossRealmTrustPrincipalPassword(CrossRealmTrustPrincipalPasswordT&& value) {
    ...
    m_crossRealmTrustPrincipalPassword = std::forward<CrossRealmTrustPrincipalPasswordT>(value);
  }
  template <typename CrossRealmTrustPrincipalPasswordT = Aws::String>
  KerberosAttributes& WithCrossRealmTrustPrincipalPassword(CrossRealmTrustPrincipalPasswordT&& value) {
    SetCrossRealmTrustPrincipalPassword(std::forward<CrossRealmTrustPrincipalPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetADDomainJoinUser(ADDomainJoinUserT&& value) {
    ...
    m_aDDomainJoinUser = std::forward<ADDomainJoinUserT>(value);
  }
  template <typename ADDomainJoinUserT = Aws::String>
  KerberosAttributes& WithADDomainJoinUser(ADDomainJoinUserT&& value) {
    SetADDomainJoinUser(std::forward<ADDomainJoinUserT>(value));
    return *this;
  }
  ///@}
  ...
  void SetADDomainJoinPassword(ADDomainJoinPasswordT&& value) {
    ...
    m_aDDomainJoinPassword = std::forward<ADDomainJoinPasswordT>(value);
  }
  template <typename ADDomainJoinPasswordT = Aws::String>
  KerberosAttributes& WithADDomainJoinPassword(ADDomainJoinPasswordT&& value) {
    SetADDomainJoinPassword(std::forward<ADDomainJoinPasswordT>(value));
    return *this;
  }
  ///@}
 private:
