...
class ListStudioSessionMappingsRequest : public EMRRequest {
 public:
  ...
  template <typename StudioIdT = Aws::String>
  ListStudioSessionMappingsRequest& WithStudioId(StudioIdT&& value) {
  ...
  inline ListStudioSessionMappingsRequest& WithIdentityType(IdentityType value) {
  ...
  template <typename MarkerT = Aws::String>
  ListStudioSessionMappingsRequest& WithMarker(MarkerT&& value) {
