...
class GetPersistentAppUIPresignedURLRequest : public EMRRequest {
 public:
  ...
  template <typename PersistentAppUIIdT = Aws::String>
  GetPersistentAppUIPresignedURLRequest& WithPersistentAppUIId(PersistentAppUIIdT&& value) {
  ...
  inline void SetPersistentAppUIType(PersistentAppUIType value) {
    m_persistentAppUITypeHasBeenSet = true;
    m_persistentAppUIType = value;
  }
  inline GetPersistentAppUIPresignedURLRequest& WithPersistentAppUIType(PersistentAppUIType value) {
    SetPersistentAppUIType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationIdT = Aws::String>
  GetPersistentAppUIPresignedURLRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  inline void SetAuthProxyCall(bool value) {
    m_authProxyCallHasBeenSet = true;
    m_authProxyCall = value;
  }
  inline GetPersistentAppUIPresignedURLRequest& WithAuthProxyCall(bool value) {
    SetAuthProxyCall(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExecutionRoleArnT = Aws::String>
  GetPersistentAppUIPresignedURLRequest& WithExecutionRoleArn(ExecutionRoleArnT&& value) {
