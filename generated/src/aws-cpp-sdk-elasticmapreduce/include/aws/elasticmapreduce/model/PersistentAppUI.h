...
class PersistentAppUI {
 public:
  ...
  void SetPersistentAppUIId(PersistentAppUIIdT&& value) {
    ...
    m_persistentAppUIId = std::forward<PersistentAppUIIdT>(value);
  }
  template <typename PersistentAppUIIdT = Aws::String>
  PersistentAppUI& WithPersistentAppUIId(PersistentAppUIIdT&& value) {
    SetPersistentAppUIId(std::forward<PersistentAppUIIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPersistentAppUITypeList(PersistentAppUITypeListT&& value) {
    ...
    m_persistentAppUITypeList = std::forward<PersistentAppUITypeListT>(value);
  }
  template <typename PersistentAppUITypeListT = Aws::Vector<PersistentAppUIType>>
  PersistentAppUI& WithPersistentAppUITypeList(PersistentAppUITypeListT&& value) {
    SetPersistentAppUITypeList(std::forward<PersistentAppUITypeListT>(value));
    return *this;
  }
  inline PersistentAppUI& AddPersistentAppUITypeList(PersistentAppUIType value) {
    m_persistentAppUITypeListHasBeenSet = true;
    m_persistentAppUITypeList.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetPersistentAppUIStatus(PersistentAppUIStatusT&& value) {
    ...
    m_persistentAppUIStatus = std::forward<PersistentAppUIStatusT>(value);
  }
  template <typename PersistentAppUIStatusT = Aws::String>
  PersistentAppUI& WithPersistentAppUIStatus(PersistentAppUIStatusT&& value) {
    SetPersistentAppUIStatus(std::forward<PersistentAppUIStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorId(AuthorIdT&& value) {
    ...
    m_authorId = std::forward<AuthorIdT>(value);
  }
  template <typename AuthorIdT = Aws::String>
  PersistentAppUI& WithAuthorId(AuthorIdT&& value) {
    SetAuthorId(std::forward<AuthorIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastStateChangeReason(LastStateChangeReasonT&& value) {
    ...
    m_lastStateChangeReason = std::forward<LastStateChangeReasonT>(value);
  }
  template <typename LastStateChangeReasonT = Aws::String>
  PersistentAppUI& WithLastStateChangeReason(LastStateChangeReasonT&& value) {
    SetLastStateChangeReason(std::forward<LastStateChangeReasonT>(value));
    return *this;
  }
  ///@}
