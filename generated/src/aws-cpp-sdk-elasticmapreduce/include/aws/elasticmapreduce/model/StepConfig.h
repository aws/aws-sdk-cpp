...
class StepConfig {
 public:
  ...
  inline StepConfig& WithActionOnFailure(ActionOnFailure value) {
  ...
  void SetHadoopJarStep(HadoopJarStepT&& value) {
    ...
    m_hadoopJarStep = std::forward<HadoopJarStepT>(value);
  }
  template <typename HadoopJarStepT = HadoopJarStepConfig>
  StepConfig& WithHadoopJarStep(HadoopJarStepT&& value) {
    SetHadoopJarStep(std::forward<HadoopJarStepT>(value));
    return *this;
  }
  ///@}
 private:
