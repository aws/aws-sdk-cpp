...
class InstanceTypeConfig {
 public:
  ...
  template <typename InstanceTypeT = Aws::String>
  InstanceTypeConfig& WithInstanceType(InstanceTypeT&& value) {
  ...
  inline InstanceTypeConfig& WithWeightedCapacity(int value) {
  ...
  template <typename BidPriceT = Aws::String>
  InstanceTypeConfig& WithBidPrice(BidPriceT&& value) {
  ...
  inline InstanceTypeConfig& WithBidPriceAsPercentageOfOnDemandPrice(double value) {
  ...
  template <typename EbsConfigurationT = EbsConfiguration>
  InstanceTypeConfig& WithEbsConfiguration(EbsConfigurationT&& value) {
  ...
  template <typename ConfigurationsT = Aws::Vector<Configuration>>
  InstanceTypeConfig& WithConfigurations(ConfigurationsT&& value) {
    SetConfigurations(std::forward<ConfigurationsT>(value));
    return *this;
  }
  template <typename ConfigurationsT = Configuration>
  InstanceTypeConfig& AddConfigurations(ConfigurationsT&& value) {
    m_configurationsHasBeenSet = true;
  ...
  template <typename CustomAmiIdT = Aws::String>
  InstanceTypeConfig& WithCustomAmiId(CustomAmiIdT&& value) {
  ...
  inline InstanceTypeConfig& WithPriority(double value) {
    SetPriority(value);
    return *this;
  }
  ///@}
