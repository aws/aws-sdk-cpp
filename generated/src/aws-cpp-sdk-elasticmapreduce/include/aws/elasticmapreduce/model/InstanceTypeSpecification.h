...
class InstanceTypeSpecification {
 public:
  ...
  template <typename InstanceTypeT = Aws::String>
  InstanceTypeSpecification& WithInstanceType(InstanceTypeT&& value) {
  ...
  inline void SetWeightedCapacity(int value) {
    m_weightedCapacityHasBeenSet = true;
    m_weightedCapacity = value;
  }
  inline InstanceTypeSpecification& WithWeightedCapacity(int value) {
  ...
  template <typename BidPriceT = Aws::String>
  InstanceTypeSpecification& WithBidPrice(BidPriceT&& value) {
  ...
  inline void SetBidPriceAsPercentageOfOnDemandPrice(double value) {
    m_bidPriceAsPercentageOfOnDemandPriceHasBeenSet = true;
    m_bidPriceAsPercentageOfOnDemandPrice = value;
  }
  inline InstanceTypeSpecification& WithBidPriceAsPercentageOfOnDemandPrice(double value) {
    SetBidPriceAsPercentageOfOnDemandPrice(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationsT = Aws::Vector<Configuration>>
  InstanceTypeSpecification& WithConfigurations(ConfigurationsT&& value) {
    SetConfigurations(std::forward<ConfigurationsT>(value));
    return *this;
  }
  template <typename ConfigurationsT = Configuration>
  InstanceTypeSpecification& AddConfigurations(ConfigurationsT&& value) {
    m_configurationsHasBeenSet = true;
  ...
  template <typename EbsBlockDevicesT = Aws::Vector<EbsBlockDevice>>
  InstanceTypeSpecification& WithEbsBlockDevices(EbsBlockDevicesT&& value) {
    SetEbsBlockDevices(std::forward<EbsBlockDevicesT>(value));
    return *this;
  }
  template <typename EbsBlockDevicesT = EbsBlockDevice>
  InstanceTypeSpecification& AddEbsBlockDevices(EbsBlockDevicesT&& value) {
    m_ebsBlockDevicesHasBeenSet = true;
  ...
  inline InstanceTypeSpecification& WithEbsOptimized(bool value) {
  ...
  template <typename CustomAmiIdT = Aws::String>
  InstanceTypeSpecification& WithCustomAmiId(CustomAmiIdT&& value) {
  ...
  inline InstanceTypeSpecification& WithPriority(double value) {
    SetPriority(value);
    return *this;
  }
  ///@}
