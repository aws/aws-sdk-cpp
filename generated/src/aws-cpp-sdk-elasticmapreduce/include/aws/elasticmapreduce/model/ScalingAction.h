...
class ScalingAction {
 public:
  ...
  inline ScalingAction& WithMarket(MarketType value) {
    SetMarket(value);
    return *this;
  }
  ///@}
  ...
  void SetSimpleScalingPolicyConfiguration(SimpleScalingPolicyConfigurationT&& value) {
    m_simpleScalingPolicyConfigurationHasBeenSet = true;
    m_simpleScalingPolicyConfiguration = std::forward<SimpleScalingPolicyConfigurationT>(value);
  }
  template <typename SimpleScalingPolicyConfigurationT = SimpleScalingPolicyConfiguration>
  ScalingAction& WithSimpleScalingPolicyConfiguration(SimpleScalingPolicyConfigurationT&& value) {
    SetSimpleScalingPolicyConfiguration(std::forward<SimpleScalingPolicyConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
