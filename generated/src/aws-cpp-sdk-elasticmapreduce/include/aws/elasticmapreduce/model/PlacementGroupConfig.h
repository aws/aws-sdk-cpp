...
class PlacementGroupConfig {
 public:
  ...
  inline PlacementGroupConfig& WithInstanceRole(InstanceRoleType value) {
  ...
  inline void SetPlacementStrategy(PlacementGroupStrategy value) {
    m_placementStrategyHasBeenSet = true;
    m_placementStrategy = value;
  }
  inline PlacementGroupConfig& WithPlacementStrategy(PlacementGroupStrategy value) {
