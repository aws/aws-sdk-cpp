...
class PutAutoScalingPolicyResult {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  PutAutoScalingPolicyResult& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename InstanceGroupIdT = Aws::String>
  PutAutoScalingPolicyResult& WithInstanceGroupId(InstanceGroupIdT&& value) {
  ...
  template <typename AutoScalingPolicyT = AutoScalingPolicyDescription>
  PutAutoScalingPolicyResult& WithAutoScalingPolicy(AutoScalingPolicyT&& value) {
  ...
  template <typename ClusterArnT = Aws::String>
  PutAutoScalingPolicyResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutAutoScalingPolicyResult& WithRequestId(RequestIdT&& value) {
