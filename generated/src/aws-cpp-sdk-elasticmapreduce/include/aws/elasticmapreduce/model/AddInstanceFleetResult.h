...
class AddInstanceFleetResult {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  AddInstanceFleetResult& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename InstanceFleetIdT = Aws::String>
  AddInstanceFleetResult& WithInstanceFleetId(InstanceFleetIdT&& value) {
  ...
  template <typename ClusterArnT = Aws::String>
  AddInstanceFleetResult& WithClusterArn(ClusterArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AddInstanceFleetResult& WithRequestId(RequestIdT&& value) {
