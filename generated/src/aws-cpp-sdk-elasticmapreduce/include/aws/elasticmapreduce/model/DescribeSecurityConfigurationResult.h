...
class DescribeSecurityConfigurationResult {
 public:
  AWS_EMR_API DescribeSecurityConfigurationResult() = default;
  ...
  template <typename NameT = Aws::String>
  DescribeSecurityConfigurationResult& WithName(NameT&& value) {
  ...
  template <typename SecurityConfigurationT = Aws::String>
  DescribeSecurityConfigurationResult& WithSecurityConfiguration(SecurityConfigurationT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  DescribeSecurityConfigurationResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSecurityConfigurationResult& WithRequestId(RequestIdT&& value) {
