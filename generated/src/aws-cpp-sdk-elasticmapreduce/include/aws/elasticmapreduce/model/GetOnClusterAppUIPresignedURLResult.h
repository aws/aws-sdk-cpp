...
class GetOnClusterAppUIPresignedURLResult {
 public:
  ...
  inline void SetPresignedURLReady(bool value) {
    m_presignedURLReadyHasBeenSet = true;
    m_presignedURLReady = value;
  }
  inline GetOnClusterAppUIPresignedURLResult& WithPresignedURLReady(bool value) {
    SetPresignedURLReady(value);
    return *this;
  }
  ///@}
  ...
  template <typename PresignedURLT = Aws::String>
  GetOnClusterAppUIPresignedURLResult& WithPresignedURL(PresignedURLT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOnClusterAppUIPresignedURLResult& WithRequestId(RequestIdT&& value) {
