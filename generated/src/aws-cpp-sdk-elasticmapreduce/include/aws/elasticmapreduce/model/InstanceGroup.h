...
class InstanceGroup {
 public:
  ...
  inline void SetMarket(MarketType value) {
    m_marketHasBeenSet = true;
    m_market = value;
  }
  inline InstanceGroup& WithMarket(MarketType value) {
    SetMarket(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceGroupType(InstanceGroupType value) {
    m_instanceGroupTypeHasBeenSet = true;
    m_instanceGroupType = value;
  }
  inline InstanceGroup& WithInstanceGroupType(InstanceGroupType value) {
    SetInstanceGroupType(value);
    return *this;
  }
  ///@}
  ...
  void SetBidPrice(BidPriceT&& value) {
    ...
    m_bidPrice = std::forward<BidPriceT>(value);
  }
  template <typename BidPriceT = Aws::String>
  InstanceGroup& WithBidPrice(BidPriceT&& value) {
    SetBidPrice(std::forward<BidPriceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRequestedInstanceCount(int value) {
    m_requestedInstanceCountHasBeenSet = true;
    m_requestedInstanceCount = value;
  }
  inline InstanceGroup& WithRequestedInstanceCount(int value) {
    SetRequestedInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceGroup& WithRunningInstanceCount(int value) {
  ...
  inline void SetConfigurationsVersion(long long value) {
    m_configurationsVersionHasBeenSet = true;
    m_configurationsVersion = value;
  }
  inline InstanceGroup& WithConfigurationsVersion(long long value) {
    SetConfigurationsVersion(value);
    return *this;
  }
  ///@}
   ...
   * last time.</p>
   */
  inline const Aws::Vector<Configuration>& GetLastSuccessfullyAppliedConfigurations() const {
    return m_lastSuccessfullyAppliedConfigurations;
  }
  ...
  void SetLastSuccessfullyAppliedConfigurations(LastSuccessfullyAppliedConfigurationsT&& value) {
    ...
    m_lastSuccessfullyAppliedConfigurations = std::forward<LastSuccessfullyAppliedConfigurationsT>(value);
  }
  template <typename LastSuccessfullyAppliedConfigurationsT = Aws::Vector<Configuration>>
  InstanceGroup& WithLastSuccessfullyAppliedConfigurations(LastSuccessfullyAppliedConfigurationsT&& value) {
    SetLastSuccessfullyAppliedConfigurations(std::forward<LastSuccessfullyAppliedConfigurationsT>(value));
    return *this;
  }
  ...
  InstanceGroup& AddLastSuccessfullyAppliedConfigurations(LastSuccessfullyAppliedConfigurationsT&& value) {
    m_lastSuccessfullyAppliedConfigurationsHasBeenSet = true;
    m_lastSuccessfullyAppliedConfigurations.emplace_back(std::forward<LastSuccessfullyAppliedConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline bool LastSuccessfullyAppliedConfigurationsVersionHasBeenSet() const {
    return m_lastSuccessfullyAppliedConfigurationsVersionHasBeenSet;
  }
  inline void SetLastSuccessfullyAppliedConfigurationsVersion(long long value) {
    m_lastSuccessfullyAppliedConfigurationsVersionHasBeenSet = true;
    m_lastSuccessfullyAppliedConfigurationsVersion = value;
  }
  inline InstanceGroup& WithLastSuccessfullyAppliedConfigurationsVersion(long long value) {
    SetLastSuccessfullyAppliedConfigurationsVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetEbsBlockDevices(EbsBlockDevicesT&& value) {
    ...
    m_ebsBlockDevices = std::forward<EbsBlockDevicesT>(value);
  }
  template <typename EbsBlockDevicesT = Aws::Vector<EbsBlockDevice>>
  InstanceGroup& WithEbsBlockDevices(EbsBlockDevicesT&& value) {
    SetEbsBlockDevices(std::forward<EbsBlockDevicesT>(value));
    return *this;
  }
  template <typename EbsBlockDevicesT = EbsBlockDevice>
  InstanceGroup& AddEbsBlockDevices(EbsBlockDevicesT&& value) {
    m_ebsBlockDevicesHasBeenSet = true;
    m_ebsBlockDevices.emplace_back(std::forward<EbsBlockDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline InstanceGroup& WithEbsOptimized(bool value) {
  ...
  void SetShrinkPolicy(ShrinkPolicyT&& value) {
    ...
    m_shrinkPolicy = std::forward<ShrinkPolicyT>(value);
  }
  template <typename ShrinkPolicyT = ShrinkPolicy>
  InstanceGroup& WithShrinkPolicy(ShrinkPolicyT&& value) {
    SetShrinkPolicy(std::forward<ShrinkPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoScalingPolicy(AutoScalingPolicyT&& value) {
    ...
    m_autoScalingPolicy = std::forward<AutoScalingPolicyT>(value);
  }
  template <typename AutoScalingPolicyT = AutoScalingPolicyDescription>
  InstanceGroup& WithAutoScalingPolicy(AutoScalingPolicyT&& value) {
    SetAutoScalingPolicy(std::forward<AutoScalingPolicyT>(value));
    return *this;
  }
  ///@}
