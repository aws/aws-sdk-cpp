...
class SpotResizingSpecification {
 public:
  ...
  inline SpotResizingSpecification& WithTimeoutDurationMinutes(int value) {
  ...
  inline SpotResizingSpecification& WithAllocationStrategy(SpotProvisioningAllocationStrategy value) {
