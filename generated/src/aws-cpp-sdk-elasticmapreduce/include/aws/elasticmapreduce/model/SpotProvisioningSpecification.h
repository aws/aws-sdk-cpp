...
namespace Model
{
   ...
   * Amazon EMR releases 4.8.0 and higher, excluding 5.0.x versions. Spot Instance
   * allocation strategy is available in Amazon EMR releases 5.12.1 and higher.</p>
