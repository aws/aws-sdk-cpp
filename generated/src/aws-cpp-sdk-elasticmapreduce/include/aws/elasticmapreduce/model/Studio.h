...
class Studio {
 public:
  ...
  void SetStudioArn(StudioArnT&& value) {
    ...
    m_studioArn = std::forward<StudioArnT>(value);
  }
  template <typename StudioArnT = Aws::String>
  Studio& WithStudioArn(StudioArnT&& value) {
    SetStudioArn(std::forward<StudioArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline Studio& WithAuthMode(AuthMode value) {
    SetAuthMode(value);
    return *this;
  }
  ///@}
  ...
  inline Studio& WithTrustedIdentityPropagationEnabled(bool value) {
  ...
  inline Studio& WithIdcUserAssignment(IdcUserAssignment value) {
