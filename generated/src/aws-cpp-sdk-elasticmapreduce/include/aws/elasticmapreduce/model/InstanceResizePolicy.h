...
class InstanceResizePolicy {
 public:
  ...
  void SetInstancesToTerminate(InstancesToTerminateT&& value) {
    ...
    m_instancesToTerminate = std::forward<InstancesToTerminateT>(value);
  }
  template <typename InstancesToTerminateT = Aws::Vector<Aws::String>>
  InstanceResizePolicy& WithInstancesToTerminate(InstancesToTerminateT&& value) {
    SetInstancesToTerminate(std::forward<InstancesToTerminateT>(value));
    return *this;
  }
  ...
  InstanceResizePolicy& AddInstancesToTerminate(InstancesToTerminateT&& value) {
    m_instancesToTerminateHasBeenSet = true;
    m_instancesToTerminate.emplace_back(std::forward<InstancesToTerminateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstancesToProtect(InstancesToProtectT&& value) {
    ...
    m_instancesToProtect = std::forward<InstancesToProtectT>(value);
  }
  template <typename InstancesToProtectT = Aws::Vector<Aws::String>>
  InstanceResizePolicy& WithInstancesToProtect(InstancesToProtectT&& value) {
    SetInstancesToProtect(std::forward<InstancesToProtectT>(value));
    return *this;
  }
  template <typename InstancesToProtectT = Aws::String>
  InstanceResizePolicy& AddInstancesToProtect(InstancesToProtectT&& value) {
    m_instancesToProtectHasBeenSet = true;
    m_instancesToProtect.emplace_back(std::forward<InstancesToProtectT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceTerminationTimeout(int value) {
    m_instanceTerminationTimeoutHasBeenSet = true;
    m_instanceTerminationTimeout = value;
  }
  inline InstanceResizePolicy& WithInstanceTerminationTimeout(int value) {
    SetInstanceTerminationTimeout(value);
    return *this;
  }
  ///@}
 private:
