...
/**
 * <p>Input to the <code>TerminateSession</code> operation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/elasticmapreduce-2009-03-31/TerminateSessionInput">AWS
 * API Reference</a></p>
 */
class TerminateSessionRequest : public EMRRequest {
 public:
  AWS_EMR_API TerminateSessionRequest() = default;
  ...
  template <typename ClusterIdT = Aws::String>
  TerminateSessionRequest& WithClusterId(ClusterIdT&& value) {
