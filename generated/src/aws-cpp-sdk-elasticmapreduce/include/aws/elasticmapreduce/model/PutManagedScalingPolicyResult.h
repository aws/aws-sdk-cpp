...
namespace Model
{
  ...
  {
  public:
    AWS_EMR_API PutManagedScalingPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutManagedScalingPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
