...
class ListInstancesRequest : public EMRRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  ListInstancesRequest& WithClusterId(ClusterIdT&& value) {
  ...
  template <typename InstanceGroupIdT = Aws::String>
  ListInstancesRequest& WithInstanceGroupId(InstanceGroupIdT&& value) {
  ...
  void SetInstanceGroupTypes(InstanceGroupTypesT&& value) {
    m_instanceGroupTypesHasBeenSet = true;
    m_instanceGroupTypes = std::forward<InstanceGroupTypesT>(value);
  }
  template <typename InstanceGroupTypesT = Aws::Vector<InstanceGroupType>>
  ListInstancesRequest& WithInstanceGroupTypes(InstanceGroupTypesT&& value) {
    SetInstanceGroupTypes(std::forward<InstanceGroupTypesT>(value));
    return *this;
  }
  inline ListInstancesRequest& AddInstanceGroupTypes(InstanceGroupType value) {
    m_instanceGroupTypesHasBeenSet = true;
    m_instanceGroupTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceFleetIdT = Aws::String>
  ListInstancesRequest& WithInstanceFleetId(InstanceFleetIdT&& value) {
  ...
  inline ListInstancesRequest& WithInstanceFleetType(InstanceFleetType value) {
  ...
  template <typename InstanceStatesT = Aws::Vector<InstanceState>>
  ListInstancesRequest& WithInstanceStates(InstanceStatesT&& value) {
    SetInstanceStates(std::forward<InstanceStatesT>(value));
    return *this;
  }
  inline ListInstancesRequest& AddInstanceStates(InstanceState value) {
    m_instanceStatesHasBeenSet = true;
    m_instanceStates.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListInstancesRequest& WithMarker(MarkerT&& value) {
