...
class AWS_EMR_API EMRClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EMRClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<EMREndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AddInstanceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddInstanceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AddInstanceFleetRequestT = Model::AddInstanceFleetRequest>
  void AddInstanceFleetAsync(const AddInstanceFleetRequestT& request, const AddInstanceFleetResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AddInstanceGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddInstanceGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AddInstanceGroupsRequestT = Model::AddInstanceGroupsRequest>
  void AddInstanceGroupsAsync(const AddInstanceGroupsRequestT& request, const AddInstanceGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AddJobFlowSteps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddJobFlowStepsRequestT = Model::AddJobFlowStepsRequest>
  void AddJobFlowStepsAsync(const AddJobFlowStepsRequestT& request, const AddJobFlowStepsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelSteps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelStepsRequestT = Model::CancelStepsRequest>
  void CancelStepsAsync(const CancelStepsRequestT& request, const CancelStepsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePersistentAppUI that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePersistentAppUI that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePersistentAppUIRequestT = Model::CreatePersistentAppUIRequest>
  void CreatePersistentAppUIAsync(const CreatePersistentAppUIRequestT& request, const CreatePersistentAppUIResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateStudio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateStudioRequestT = Model::CreateStudioRequest>
  void CreateStudioAsync(const CreateStudioRequestT& request, const CreateStudioResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateStudioSessionMappingOutcome CreateStudioSessionMapping(
      const Model::CreateStudioSessionMappingRequest& request) const;

  /**
   * A Callable wrapper for CreateStudioSessionMapping that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateStudioSessionMappingRequestT = Model::CreateStudioSessionMappingRequest>
  Model::CreateStudioSessionMappingOutcomeCallable CreateStudioSessionMappingCallable(
      const CreateStudioSessionMappingRequestT& request) const {
    return SubmitCallable(&EMRClient::CreateStudioSessionMapping, request);
  }

  /**
   * An Async wrapper for CreateStudioSessionMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStudioSessionMappingRequestT = Model::CreateStudioSessionMappingRequest>
  void CreateStudioSessionMappingAsync(const CreateStudioSessionMappingRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteStudio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteStudioRequestT = Model::DeleteStudioRequest>
  void DeleteStudioAsync(const DeleteStudioRequestT& request, const DeleteStudioResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteStudioSessionMappingOutcome DeleteStudioSessionMapping(
      const Model::DeleteStudioSessionMappingRequest& request) const;

  /**
   * A Callable wrapper for DeleteStudioSessionMapping that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteStudioSessionMappingRequestT = Model::DeleteStudioSessionMappingRequest>
  Model::DeleteStudioSessionMappingOutcomeCallable DeleteStudioSessionMappingCallable(
      const DeleteStudioSessionMappingRequestT& request) const {
    return SubmitCallable(&EMRClient::DeleteStudioSessionMapping, request);
  }

  /**
   * An Async wrapper for DeleteStudioSessionMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStudioSessionMappingRequestT = Model::DeleteStudioSessionMappingRequest>
  void DeleteStudioSessionMappingAsync(const DeleteStudioSessionMappingRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeNotebookExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeNotebookExecutionRequestT = Model::DescribeNotebookExecutionRequest>
  Model::DescribeNotebookExecutionOutcomeCallable DescribeNotebookExecutionCallable(
      const DescribeNotebookExecutionRequestT& request) const {
    return SubmitCallable(&EMRClient::DescribeNotebookExecution, request);
  }

  /**
   * An Async wrapper for DescribeNotebookExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNotebookExecutionRequestT = Model::DescribeNotebookExecutionRequest>
  void DescribeNotebookExecutionAsync(const DescribeNotebookExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribePersistentAppUI that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePersistentAppUI that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePersistentAppUIRequestT = Model::DescribePersistentAppUIRequest>
  void DescribePersistentAppUIAsync(const DescribePersistentAppUIRequestT& request,
                                    const DescribePersistentAppUIResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeReleaseLabel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReleaseLabel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReleaseLabelRequestT = Model::DescribeReleaseLabelRequest>
  void DescribeReleaseLabelAsync(const DescribeReleaseLabelResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeReleaseLabelRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeStep that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeStepRequestT = Model::DescribeStepRequest>
  void DescribeStepAsync(const DescribeStepRequestT& request, const DescribeStepResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeStudio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeStudioRequestT = Model::DescribeStudioRequest>
  void DescribeStudioAsync(const DescribeStudioRequestT& request, const DescribeStudioResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAutoTerminationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAutoTerminationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAutoTerminationPolicyRequestT = Model::GetAutoTerminationPolicyRequest>
  void GetAutoTerminationPolicyAsync(const GetAutoTerminationPolicyRequestT& request,
                                     const GetAutoTerminationPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetBlockPublicAccessConfigurationOutcome GetBlockPublicAccessConfiguration(
      const Model::GetBlockPublicAccessConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetBlockPublicAccessConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetBlockPublicAccessConfigurationRequestT = Model::GetBlockPublicAccessConfigurationRequest>
  Model::GetBlockPublicAccessConfigurationOutcomeCallable GetBlockPublicAccessConfigurationCallable(
      const GetBlockPublicAccessConfigurationRequestT& request = {}) const {
    return SubmitCallable(&EMRClient::GetBlockPublicAccessConfiguration, request);
  }

  /**
   * An Async wrapper for GetBlockPublicAccessConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetBlockPublicAccessConfigurationRequestT = Model::GetBlockPublicAccessConfigurationRequest>
  void GetBlockPublicAccessConfigurationAsync(const GetBlockPublicAccessConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const GetBlockPublicAccessConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetClusterSessionCredentialsOutcome GetClusterSessionCredentials(
      const Model::GetClusterSessionCredentialsRequest& request) const;

  /**
   * A Callable wrapper for GetClusterSessionCredentials that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetClusterSessionCredentialsRequestT = Model::GetClusterSessionCredentialsRequest>
  Model::GetClusterSessionCredentialsOutcomeCallable GetClusterSessionCredentialsCallable(
      const GetClusterSessionCredentialsRequestT& request) const {
    return SubmitCallable(&EMRClient::GetClusterSessionCredentials, request);
  }

  /**
   * An Async wrapper for GetClusterSessionCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClusterSessionCredentialsRequestT = Model::GetClusterSessionCredentialsRequest>
  void GetClusterSessionCredentialsAsync(const GetClusterSessionCredentialsRequestT& request,
                                         const GetClusterSessionCredentialsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetManagedScalingPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetManagedScalingPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetManagedScalingPolicyRequestT = Model::GetManagedScalingPolicyRequest>
  void GetManagedScalingPolicyAsync(const GetManagedScalingPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOnClusterAppUIPresignedURLOutcome GetOnClusterAppUIPresignedURL(
      const Model::GetOnClusterAppUIPresignedURLRequest& request) const;

  /**
   * A Callable wrapper for GetOnClusterAppUIPresignedURL that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetOnClusterAppUIPresignedURLRequestT = Model::GetOnClusterAppUIPresignedURLRequest>
  Model::GetOnClusterAppUIPresignedURLOutcomeCallable GetOnClusterAppUIPresignedURLCallable(
      const GetOnClusterAppUIPresignedURLRequestT& request) const {
    return SubmitCallable(&EMRClient::GetOnClusterAppUIPresignedURL, request);
  }

  /**
   * An Async wrapper for GetOnClusterAppUIPresignedURL that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOnClusterAppUIPresignedURLRequestT = Model::GetOnClusterAppUIPresignedURLRequest>
  void GetOnClusterAppUIPresignedURLAsync(const GetOnClusterAppUIPresignedURLRequestT& request,
                                          const GetOnClusterAppUIPresignedURLResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPersistentAppUIPresignedURLOutcome GetPersistentAppUIPresignedURL(
      const Model::GetPersistentAppUIPresignedURLRequest& request) const;

  /**
   * A Callable wrapper for GetPersistentAppUIPresignedURL that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPersistentAppUIPresignedURLRequestT = Model::GetPersistentAppUIPresignedURLRequest>
  Model::GetPersistentAppUIPresignedURLOutcomeCallable GetPersistentAppUIPresignedURLCallable(
      const GetPersistentAppUIPresignedURLRequestT& request) const {
    return SubmitCallable(&EMRClient::GetPersistentAppUIPresignedURL, request);
  }

  /**
   * An Async wrapper for GetPersistentAppUIPresignedURL that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetPersistentAppUIPresignedURLRequestT = Model::GetPersistentAppUIPresignedURLRequest>
  void GetPersistentAppUIPresignedURLAsync(const GetPersistentAppUIPresignedURLRequestT& request,
                                           const GetPersistentAppUIPresignedURLResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetStudioSessionMapping that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetStudioSessionMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetStudioSessionMappingRequestT = Model::GetStudioSessionMappingRequest>
  void GetStudioSessionMappingAsync(const GetStudioSessionMappingRequestT& request,
  ...
  /**
   * A Callable wrapper for ListBootstrapActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBootstrapActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBootstrapActionsRequestT = Model::ListBootstrapActionsRequest>
  void ListBootstrapActionsAsync(const ListBootstrapActionsRequestT& request, const ListBootstrapActionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInstanceFleets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceFleets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInstanceFleetsRequestT = Model::ListInstanceFleetsRequest>
  void ListInstanceFleetsAsync(const ListInstanceFleetsRequestT& request, const ListInstanceFleetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInstanceGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInstanceGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListInstanceGroupsRequestT = Model::ListInstanceGroupsRequest>
  void ListInstanceGroupsAsync(const ListInstanceGroupsRequestT& request, const ListInstanceGroupsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNotebookExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotebookExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotebookExecutionsRequestT = Model::ListNotebookExecutionsRequest>
  void ListNotebookExecutionsAsync(const ListNotebookExecutionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListNotebookExecutionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListReleaseLabels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReleaseLabels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReleaseLabelsRequestT = Model::ListReleaseLabelsRequest>
  void ListReleaseLabelsAsync(const ListReleaseLabelsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListReleaseLabelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStudioSessionMappingsOutcome ListStudioSessionMappings(
      const Model::ListStudioSessionMappingsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListStudioSessionMappings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListStudioSessionMappingsRequestT = Model::ListStudioSessionMappingsRequest>
  Model::ListStudioSessionMappingsOutcomeCallable ListStudioSessionMappingsCallable(
      const ListStudioSessionMappingsRequestT& request = {}) const {
    return SubmitCallable(&EMRClient::ListStudioSessionMappings, request);
  }

  /**
   * An Async wrapper for ListStudioSessionMappings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStudioSessionMappingsRequestT = Model::ListStudioSessionMappingsRequest>
  void ListStudioSessionMappingsAsync(const ListStudioSessionMappingsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListStudioSessionMappingsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListStudios that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStudiosRequestT = Model::ListStudiosRequest>
  void ListStudiosAsync(const ListStudiosResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListStudiosRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSupportedInstanceTypesOutcome ListSupportedInstanceTypes(
      const Model::ListSupportedInstanceTypesRequest& request) const;

  /**
   * A Callable wrapper for ListSupportedInstanceTypes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSupportedInstanceTypesRequestT = Model::ListSupportedInstanceTypesRequest>
  Model::ListSupportedInstanceTypesOutcomeCallable ListSupportedInstanceTypesCallable(
      const ListSupportedInstanceTypesRequestT& request) const {
    return SubmitCallable(&EMRClient::ListSupportedInstanceTypes, request);
  }

  /**
   * An Async wrapper for ListSupportedInstanceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSupportedInstanceTypesRequestT = Model::ListSupportedInstanceTypesRequest>
  void ListSupportedInstanceTypesAsync(const ListSupportedInstanceTypesRequestT& request,
                                       const ListSupportedInstanceTypesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyInstanceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyInstanceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyInstanceFleetRequestT = Model::ModifyInstanceFleetRequest>
  void ModifyInstanceFleetAsync(const ModifyInstanceFleetRequestT& request, const ModifyInstanceFleetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyInstanceGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyInstanceGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyInstanceGroupsRequestT = Model::ModifyInstanceGroupsRequest>
  void ModifyInstanceGroupsAsync(const ModifyInstanceGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ModifyInstanceGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutAutoScalingPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAutoScalingPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAutoScalingPolicyRequestT = Model::PutAutoScalingPolicyRequest>
  void PutAutoScalingPolicyAsync(const PutAutoScalingPolicyRequestT& request, const PutAutoScalingPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutAutoTerminationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAutoTerminationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAutoTerminationPolicyRequestT = Model::PutAutoTerminationPolicyRequest>
  void PutAutoTerminationPolicyAsync(const PutAutoTerminationPolicyRequestT& request,
                                     const PutAutoTerminationPolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutBlockPublicAccessConfigurationOutcome PutBlockPublicAccessConfiguration(
      const Model::PutBlockPublicAccessConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutBlockPublicAccessConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutBlockPublicAccessConfigurationRequestT = Model::PutBlockPublicAccessConfigurationRequest>
  Model::PutBlockPublicAccessConfigurationOutcomeCallable PutBlockPublicAccessConfigurationCallable(
      const PutBlockPublicAccessConfigurationRequestT& request) const {
    return SubmitCallable(&EMRClient::PutBlockPublicAccessConfiguration, request);
  }

  /**
   * An Async wrapper for PutBlockPublicAccessConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutBlockPublicAccessConfigurationRequestT = Model::PutBlockPublicAccessConfigurationRequest>
  void PutBlockPublicAccessConfigurationAsync(const PutBlockPublicAccessConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for PutManagedScalingPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutManagedScalingPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutManagedScalingPolicyRequestT = Model::PutManagedScalingPolicyRequest>
  void PutManagedScalingPolicyAsync(const PutManagedScalingPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for RemoveAutoScalingPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveAutoScalingPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveAutoScalingPolicyRequestT = Model::RemoveAutoScalingPolicyRequest>
  void RemoveAutoScalingPolicyAsync(const RemoveAutoScalingPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveAutoTerminationPolicyOutcome RemoveAutoTerminationPolicy(
      const Model::RemoveAutoTerminationPolicyRequest& request) const;

  /**
   * A Callable wrapper for RemoveAutoTerminationPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveAutoTerminationPolicyRequestT = Model::RemoveAutoTerminationPolicyRequest>
  Model::RemoveAutoTerminationPolicyOutcomeCallable RemoveAutoTerminationPolicyCallable(
      const RemoveAutoTerminationPolicyRequestT& request) const {
    return SubmitCallable(&EMRClient::RemoveAutoTerminationPolicy, request);
  }

  /**
   * An Async wrapper for RemoveAutoTerminationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveAutoTerminationPolicyRequestT = Model::RemoveAutoTerminationPolicyRequest>
  void RemoveAutoTerminationPolicyAsync(const RemoveAutoTerminationPolicyRequestT& request,
                                        const RemoveAutoTerminationPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveManagedScalingPolicyOutcome RemoveManagedScalingPolicy(
      const Model::RemoveManagedScalingPolicyRequest& request) const;

  /**
   * A Callable wrapper for RemoveManagedScalingPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveManagedScalingPolicyRequestT = Model::RemoveManagedScalingPolicyRequest>
  Model::RemoveManagedScalingPolicyOutcomeCallable RemoveManagedScalingPolicyCallable(
      const RemoveManagedScalingPolicyRequestT& request) const {
    return SubmitCallable(&EMRClient::RemoveManagedScalingPolicy, request);
  }

  /**
   * An Async wrapper for RemoveManagedScalingPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveManagedScalingPolicyRequestT = Model::RemoveManagedScalingPolicyRequest>
  void RemoveManagedScalingPolicyAsync(const RemoveManagedScalingPolicyRequestT& request,
  ...
  /**
   * An Async wrapper for RunJobFlow that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RunJobFlowRequestT = Model::RunJobFlowRequest>
  void RunJobFlowAsync(const RunJobFlowRequestT& request, const RunJobFlowResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SetKeepJobFlowAliveWhenNoStepsOutcome SetKeepJobFlowAliveWhenNoSteps(
      const Model::SetKeepJobFlowAliveWhenNoStepsRequest& request) const;

  /**
   * A Callable wrapper for SetKeepJobFlowAliveWhenNoSteps that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetKeepJobFlowAliveWhenNoStepsRequestT = Model::SetKeepJobFlowAliveWhenNoStepsRequest>
  Model::SetKeepJobFlowAliveWhenNoStepsOutcomeCallable SetKeepJobFlowAliveWhenNoStepsCallable(
      const SetKeepJobFlowAliveWhenNoStepsRequestT& request) const {
    return SubmitCallable(&EMRClient::SetKeepJobFlowAliveWhenNoSteps, request);
  }

  /**
   * An Async wrapper for SetKeepJobFlowAliveWhenNoSteps that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SetKeepJobFlowAliveWhenNoStepsRequestT = Model::SetKeepJobFlowAliveWhenNoStepsRequest>
  void SetKeepJobFlowAliveWhenNoStepsAsync(const SetKeepJobFlowAliveWhenNoStepsRequestT& request,
                                           const SetKeepJobFlowAliveWhenNoStepsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetTerminationProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetTerminationProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetTerminationProtectionRequestT = Model::SetTerminationProtectionRequest>
  void SetTerminationProtectionAsync(const SetTerminationProtectionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SetUnhealthyNodeReplacementOutcome SetUnhealthyNodeReplacement(
      const Model::SetUnhealthyNodeReplacementRequest& request) const;

  /**
   * A Callable wrapper for SetUnhealthyNodeReplacement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SetUnhealthyNodeReplacementRequestT = Model::SetUnhealthyNodeReplacementRequest>
  Model::SetUnhealthyNodeReplacementOutcomeCallable SetUnhealthyNodeReplacementCallable(
      const SetUnhealthyNodeReplacementRequestT& request) const {
    return SubmitCallable(&EMRClient::SetUnhealthyNodeReplacement, request);
  }

  /**
   * An Async wrapper for SetUnhealthyNodeReplacement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetUnhealthyNodeReplacementRequestT = Model::SetUnhealthyNodeReplacementRequest>
  void SetUnhealthyNodeReplacementAsync(const SetUnhealthyNodeReplacementRequestT& request,
                                        const SetUnhealthyNodeReplacementResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetVisibleToAllUsers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetVisibleToAllUsers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SetVisibleToAllUsersRequestT = Model::SetVisibleToAllUsersRequest>
  void SetVisibleToAllUsersAsync(const SetVisibleToAllUsersRequestT& request, const SetVisibleToAllUsersResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartNotebookExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartNotebookExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartNotebookExecutionRequestT = Model::StartNotebookExecutionRequest>
  void StartNotebookExecutionAsync(const StartNotebookExecutionRequestT& request,
  ...
  /**
   * A Callable wrapper for StopNotebookExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopNotebookExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopNotebookExecutionRequestT = Model::StopNotebookExecutionRequest>
  void StopNotebookExecutionAsync(const StopNotebookExecutionRequestT& request, const StopNotebookExecutionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TerminateJobFlows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TerminateJobFlows that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TerminateJobFlowsRequestT = Model::TerminateJobFlowsRequest>
  ...
  /**
   * An Async wrapper for UpdateStudio that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateStudioRequestT = Model::UpdateStudioRequest>
  void UpdateStudioAsync(const UpdateStudioRequestT& request, const UpdateStudioResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateStudioSessionMappingOutcome UpdateStudioSessionMapping(
      const Model::UpdateStudioSessionMappingRequest& request) const;

  /**
   * A Callable wrapper for UpdateStudioSessionMapping that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateStudioSessionMappingRequestT = Model::UpdateStudioSessionMappingRequest>
  Model::UpdateStudioSessionMappingOutcomeCallable UpdateStudioSessionMappingCallable(
      const UpdateStudioSessionMappingRequestT& request) const {
    return SubmitCallable(&EMRClient::UpdateStudioSessionMapping, request);
  }

  /**
   * An Async wrapper for UpdateStudioSessionMapping that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStudioSessionMappingRequestT = Model::UpdateStudioSessionMappingRequest>
  void UpdateStudioSessionMappingAsync(const UpdateStudioSessionMappingRequestT& request,
