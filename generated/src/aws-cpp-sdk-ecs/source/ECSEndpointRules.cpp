...
namespace ECS
{
const size_t ECSEndpointRules::RulesBlobStrLen = 3460;
const size_t ECSEndpointRules::RulesBlobSize = 3461;
...
'"','h','t','t','p','s',':','/','/','e','c','s','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'e','c','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
...
'h','t','t','p','s',':','/','/','e','c','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* ECSEndpointRules::GetRulesBlob()
{
