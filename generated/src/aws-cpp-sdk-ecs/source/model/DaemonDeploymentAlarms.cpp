...
DaemonDeploymentAlarms::DaemonDeploymentAlarms(JsonView jsonValue) { *this = jsonValue; }

DaemonDeploymentAlarms& DaemonDeploymentAlarms::operator=(JsonView jsonValue) {
...
JsonValue DaemonDeploymentAlarms::Jsonize() const {
  JsonValue payload;
