...
ManagedLoadBalancer::ManagedLoadBalancer(JsonView jsonValue) { *this = jsonValue; }

ManagedLoadBalancer& ManagedLoadBalancer::operator=(JsonView jsonValue) {
...
JsonValue ManagedLoadBalancer::Jsonize() const {
  JsonValue payload;
