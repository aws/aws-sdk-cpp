...
ServiceCurrentRevisionSummary::ServiceCurrentRevisionSummary(JsonView jsonValue) { *this = jsonValue; }

ServiceCurrentRevisionSummary& ServiceCurrentRevisionSummary::operator=(JsonView jsonValue) {
...
JsonValue ServiceCurrentRevisionSummary::Jsonize() const {
  JsonValue payload;
