...
ManagedMetricAlarm::ManagedMetricAlarm(JsonView jsonValue) { *this = jsonValue; }

ManagedMetricAlarm& ManagedMetricAlarm::operator=(JsonView jsonValue) {
...
JsonValue ManagedMetricAlarm::Jsonize() const {
  JsonValue payload;
