...
DescribeDaemonDeploymentsResult::DescribeDaemonDeploymentsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DescribeDaemonDeploymentsResult& DescribeDaemonDeploymentsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
