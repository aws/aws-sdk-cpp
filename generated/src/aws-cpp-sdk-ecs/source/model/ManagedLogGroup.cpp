...
ManagedLogGroup::ManagedLogGroup(JsonView jsonValue) { *this = jsonValue; }

ManagedLogGroup& ManagedLogGroup::operator=(JsonView jsonValue) {
...
JsonValue ManagedLogGroup::Jsonize() const {
  JsonValue payload;
