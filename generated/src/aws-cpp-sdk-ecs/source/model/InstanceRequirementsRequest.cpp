...
InstanceRequirementsRequest::InstanceRequirementsRequest(JsonView jsonValue)
{
  *this = jsonValue;
}
...
InstanceRequirementsRequest& InstanceRequirementsRequest::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("cpuManufacturers"))
  {
    ...
    {
      m_cpuManufacturers.push_back(CpuManufacturerMapper::GetCpuManufacturerForName(cpuManufacturersJsonList[cpuManufacturersIndex].AsString()));
    }
  ...
  if(jsonValue.ValueExists("instanceGenerations"))
  {
    ...
    {
      m_instanceGenerations.push_back(InstanceGenerationMapper::GetInstanceGenerationForName(instanceGenerationsJsonList[instanceGenerationsIndex].AsString()));
    }
  ...
  if(jsonValue.ValueExists("localStorageTypes"))
  {
    ...
    {
      m_localStorageTypes.push_back(LocalStorageTypeMapper::GetLocalStorageTypeForName(localStorageTypesJsonList[localStorageTypesIndex].AsString()));
    }
  ...
  if(jsonValue.ValueExists("acceleratorManufacturers"))
  {
    ...
    {
      m_acceleratorManufacturers.push_back(AcceleratorManufacturerMapper::GetAcceleratorManufacturerForName(acceleratorManufacturersJsonList[acceleratorManufacturersIndex].AsString()));
    }
  ...
  if(jsonValue.ValueExists("acceleratorNames"))
  {
    ...
    {
      m_acceleratorNames.push_back(AcceleratorNameMapper::GetAcceleratorNameForName(acceleratorNamesJsonList[acceleratorNamesIndex].AsString()));
    }
...
JsonValue InstanceRequirementsRequest::Jsonize() const
{
  ...
  if(m_cpuManufacturersHasBeenSet)
  {
   ...
   for(unsigned cpuManufacturersIndex = 0; cpuManufacturersIndex < cpuManufacturersJsonList.GetLength(); ++cpuManufacturersIndex)
   {
     cpuManufacturersJsonList[cpuManufacturersIndex].AsString(CpuManufacturerMapper::GetNameForCpuManufacturer(m_cpuManufacturers[cpuManufacturersIndex]));
   }
  ...
  if(m_instanceGenerationsHasBeenSet)
  {
   ...
   for(unsigned instanceGenerationsIndex = 0; instanceGenerationsIndex < instanceGenerationsJsonList.GetLength(); ++instanceGenerationsIndex)
   {
     instanceGenerationsJsonList[instanceGenerationsIndex].AsString(InstanceGenerationMapper::GetNameForInstanceGeneration(m_instanceGenerations[instanceGenerationsIndex]));
   }
  ...
  if(m_localStorageTypesHasBeenSet)
  {
   ...
   for(unsigned localStorageTypesIndex = 0; localStorageTypesIndex < localStorageTypesJsonList.GetLength(); ++localStorageTypesIndex)
   {
     localStorageTypesJsonList[localStorageTypesIndex].AsString(LocalStorageTypeMapper::GetNameForLocalStorageType(m_localStorageTypes[localStorageTypesIndex]));
   }
  ...
  if(m_acceleratorManufacturersHasBeenSet)
  {
   ...
   for(unsigned acceleratorManufacturersIndex = 0; acceleratorManufacturersIndex < acceleratorManufacturersJsonList.GetLength(); ++acceleratorManufacturersIndex)
   {
     acceleratorManufacturersJsonList[acceleratorManufacturersIndex].AsString(AcceleratorManufacturerMapper::GetNameForAcceleratorManufacturer(m_acceleratorManufacturers[acceleratorManufacturersIndex]));
   }
  ...
  if(m_acceleratorNamesHasBeenSet)
  {
   ...
   for(unsigned acceleratorNamesIndex = 0; acceleratorNamesIndex < acceleratorNamesJsonList.GetLength(); ++acceleratorNamesIndex)
   {
     acceleratorNamesJsonList[acceleratorNamesIndex].AsString(AcceleratorNameMapper::GetNameForAcceleratorName(m_acceleratorNames[acceleratorNamesIndex]));
   }
