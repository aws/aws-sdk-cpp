...
ManagedListener::ManagedListener(JsonView jsonValue) { *this = jsonValue; }

ManagedListener& ManagedListener::operator=(JsonView jsonValue) {
...
JsonValue ManagedListener::Jsonize() const {
  JsonValue payload;
