...
#include <aws/ecs/model/DeleteDaemonResult.h>
...
DeleteDaemonResult::DeleteDaemonResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteDaemonResult& DeleteDaemonResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
