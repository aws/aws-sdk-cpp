...
#include <aws/ecs/model/UpdateDaemonResult.h>
...
UpdateDaemonResult::UpdateDaemonResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateDaemonResult& UpdateDaemonResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
