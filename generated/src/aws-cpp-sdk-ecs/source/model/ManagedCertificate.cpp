...
ManagedCertificate::ManagedCertificate(JsonView jsonValue) { *this = jsonValue; }

ManagedCertificate& ManagedCertificate::operator=(JsonView jsonValue) {
...
JsonValue ManagedCertificate::Jsonize() const {
  JsonValue payload;
