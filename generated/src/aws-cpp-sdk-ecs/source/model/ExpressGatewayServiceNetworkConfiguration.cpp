...
ExpressGatewayServiceNetworkConfiguration::ExpressGatewayServiceNetworkConfiguration(JsonView jsonValue) { *this = jsonValue; }

ExpressGatewayServiceNetworkConfiguration& ExpressGatewayServiceNetworkConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ExpressGatewayServiceNetworkConfiguration::Jsonize() const {
  JsonValue payload;
