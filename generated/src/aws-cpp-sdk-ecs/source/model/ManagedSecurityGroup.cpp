...
ManagedSecurityGroup::ManagedSecurityGroup(JsonView jsonValue) { *this = jsonValue; }

ManagedSecurityGroup& ManagedSecurityGroup::operator=(JsonView jsonValue) {
...
JsonValue ManagedSecurityGroup::Jsonize() const {
  JsonValue payload;
