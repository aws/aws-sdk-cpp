...
AutoScalingGroupProviderUpdate::AutoScalingGroupProviderUpdate(JsonView jsonValue) { *this = jsonValue; }
...
AutoScalingGroupProviderUpdate& AutoScalingGroupProviderUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("managedTerminationProtection")) {
    m_managedTerminationProtection =
        ManagedTerminationProtectionMapper::GetManagedTerminationProtectionForName(jsonValue.GetString("managedTerminationProtection"));
...
JsonValue AutoScalingGroupProviderUpdate::Jsonize() const {
  ...
  if (m_managedTerminationProtectionHasBeenSet) {
    payload.WithString("managedTerminationProtection",
                       ManagedTerminationProtectionMapper::GetNameForManagedTerminationProtection(m_managedTerminationProtection));
  }
