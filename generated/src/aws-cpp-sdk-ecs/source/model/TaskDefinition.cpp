...
TaskDefinition::TaskDefinition(JsonView jsonValue) { *this = jsonValue; }
...
TaskDefinition& TaskDefinition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("requiresAttributes")) {
    ...
    for (unsigned requiresAttributesIndex = 0; requiresAttributesIndex < requiresAttributesJsonList.GetLength();
         ++requiresAttributesIndex) {
  ...
  if (jsonValue.ValueExists("requiresCompatibilities")) {
    ...
    for (unsigned requiresCompatibilitiesIndex = 0; requiresCompatibilitiesIndex < requiresCompatibilitiesJsonList.GetLength();
      ...
      m_requiresCompatibilities.push_back(
          CompatibilityMapper::GetCompatibilityForName(requiresCompatibilitiesJsonList[requiresCompatibilitiesIndex].AsString()));
    }
...
JsonValue TaskDefinition::Jsonize() const {
  ...
  if (m_compatibilitiesHasBeenSet) {
    ...
    for (unsigned compatibilitiesIndex = 0; compatibilitiesIndex < compatibilitiesJsonList.GetLength(); ++compatibilitiesIndex) {
      compatibilitiesJsonList[compatibilitiesIndex].AsString(
          CompatibilityMapper::GetNameForCompatibility(m_compatibilities[compatibilitiesIndex]));
    }
