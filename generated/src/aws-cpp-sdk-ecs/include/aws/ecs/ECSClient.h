    ...
    public:
      ...
      typedef ECSEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * action.</p>  <p>The following change began on March 21, 2024. When the
         * task definition revision is not specified, Amazon ECS resolves the task
         * definition revision before it authorizes the task definition.</p>  <p>In
         ...
         * Guide</i> </p> <p>Starting April 15, 2023, Amazon Web Services will not onboard
         * new customers to Amazon Elastic Inference (EI), and will help current customers
         ...
         * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-types.html">Amazon
         * ECS deployment types</a> in the <i>Amazon Elastic Container Service Developer
         * Guide</i>.</p>  <p>The following change began on March 21, 2024. When the
         * task definition revision is not specified, Amazon ECS resolves the task
         * definition revision before it authorizes the task definition.</p>  <p>For
         * information about the maximum number of task sets and otther quotas, see <a
        ...
        /**
         * <p>Starts a new task using the specified task definition.</p>  <p>The
         ...
         * authorizes the task definition.</p>  <p>You can allow Amazon ECS to place
         ...
         * place tasks manually on specific container instances.</p> <p>Starting April 15,
         ...
         * customers and will be able to continue using the service. </p> <p>You can attach
         ...
         * container instance or instances.</p>  <p>The following change began on
         * March 21, 2024. When the task definition revision is not specified, Amazon ECS
         * resolves the task definition revision before it authorizes the task
         * definition.</p>  <p>Starting April 15, 2023, Amazon Web Services will not
         ...
         * using the service. </p> <p>Alternatively, you can use <a>RunTask</a> to place
         * tasks for you. For more information, see <a
         * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/scheduling_tasks.html">Scheduling
         * Tasks</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
        ...
        /**
         * <p>Modifies the parameters of a service.</p>  <p>The following change
         ...
         * definition.</p>  <p>For services using the rolling update
         * (<code>ECS</code>) you can update the desired count, deployment configuration,
         ...
         * new tasks with the new configuration. </p> <p>You can attach Amazon EBS volumes
