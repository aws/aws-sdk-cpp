...
class AWS_ECS_API ECSClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<ECSClient> {
 public:
   ...
   */
  ECSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ECSEndpointProviderBase> endpointProvider = nullptr,
   ...
   * for the following scenarios:</p> <ul> <li> <p>Gradual service updates: You need
   * to update your service incrementally without taking the entire service offline
   * at once.</p> </li> <li> <p>Limited resource requirements: You want to avoid the
   ...
   * roll back if needed. For more information, see <a
   * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-type-blue-green.html">Amazon
   * ECS blue/green deployments</a> in the <i>Amazon Elastic Container Service
   * Developer Guide</i>.</p> <p>Amazon ECS blue/green deployments are best suited
   ...
   * Balancer, or Service Connect</p> </li> </ul> </li> <li> <p> <code>LINEAR</code>:
   * A <i>linear</i> deployment strategy (<code>LINEAR</code>) gradually shifts
   * traffic from the current production environment to a new environment in equal
   * percentage increments over a specified time period. With Amazon ECS linear
   * deployments, you can control the pace of traffic shifting and validate new
   * service revisions with increasing amounts of production traffic.</p> <p>Linear
   * deployments are best suited for the following scenarios:</p> <ul> <li>
   * <p>Gradual validation: When you want to gradually validate your new service
   * version with increasing traffic</p> </li> <li> <p>Performance monitoring: When
   * you need time to monitor metrics and performance during the deployment</p> </li>
   * <li> <p>Risk minimization: When you want to minimize risk by exposing the new
   * version to production traffic incrementally</p> </li> <li> <p>Load balancer
   * requirement: When your service uses Application Load Balancer, Network Load
   * Balancer, or Service Connect</p> </li> </ul> </li> <li> <p> <code>CANARY</code>:
   * A <i>canary</i> deployment strategy (<code>CANARY</code>) shifts a small
   * percentage of traffic to the new service revision first, then shifts the
   * remaining traffic all at once after a specified time period. This allows you to
   * test the new version with a subset of users before full deployment.</p>
   * <p>Canary deployments are best suited for the following scenarios:</p> <ul> <li>
   * <p>Feature testing: When you want to test new features with a small subset of
   * users before full rollout</p> </li> <li> <p>Production validation: When you need
   * to validate performance and functionality with real production traffic</p> </li>
   * <li> <p>Blast radius control: When you want to minimize blast radius if issues
   * are discovered in the new version</p> </li> <li> <p>Load balancer requirement:
   * When your service uses Application Load Balancer, Network Load Balancer, or
   * Service Connect</p> </li> </ul> </li> </ul> </li> <li> <p>External</p> <p>Use a
   * third-party deployment controller.</p> </li> <li> <p>Blue/green deployment
   * (powered by CodeDeploy)</p> <p>CodeDeploy installs an updated version of the
   * application as a new replacement task set and reroutes production traffic from
   * the original application task set to the replacement task set. The original task
   * set is terminated after a successful deployment. Use this deployment controller
   * to verify a new deployment of a service before sending production traffic to
   * it.</p> </li> </ul> <p>When creating a service that uses the
  ...
  /**
   * An Async wrapper for CreateTaskSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTaskSetRequestT = Model::CreateTaskSetRequest>
  void CreateTaskSetAsync(const CreateTaskSetRequestT& request, const CreateTaskSetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccountSetting that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccountSetting that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccountSettingRequestT = Model::DeleteAccountSettingRequest>
  void DeleteAccountSettingAsync(const DeleteAccountSettingRequestT& request, const DeleteAccountSettingResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAttributes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAttributesRequestT = Model::DeleteAttributesRequest>
  void DeleteAttributesAsync(const DeleteAttributesRequestT& request, const DeleteAttributesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTaskDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTaskDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTaskDefinitionsRequestT = Model::DeleteTaskDefinitionsRequest>
  void DeleteTaskDefinitionsAsync(const DeleteTaskDefinitionsRequestT& request, const DeleteTaskDefinitionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTaskSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTaskSetRequestT = Model::DeleteTaskSetRequest>
  void DeleteTaskSetAsync(const DeleteTaskSetRequestT& request, const DeleteTaskSetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterContainerInstanceOutcome DeregisterContainerInstance(
      const Model::DeregisterContainerInstanceRequest& request) const;

  /**
   * A Callable wrapper for DeregisterContainerInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterContainerInstanceRequestT = Model::DeregisterContainerInstanceRequest>
  Model::DeregisterContainerInstanceOutcomeCallable DeregisterContainerInstanceCallable(
      const DeregisterContainerInstanceRequestT& request) const {
    return SubmitCallable(&ECSClient::DeregisterContainerInstance, request);
  }

  /**
   * An Async wrapper for DeregisterContainerInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterContainerInstanceRequestT = Model::DeregisterContainerInstanceRequest>
  void DeregisterContainerInstanceAsync(const DeregisterContainerInstanceRequestT& request,
  ...
  /**
   * A Callable wrapper for DeregisterTaskDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterTaskDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterTaskDefinitionRequestT = Model::DeregisterTaskDefinitionRequest>
  void DeregisterTaskDefinitionAsync(const DeregisterTaskDefinitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCapacityProvidersOutcome DescribeCapacityProviders(
      const Model::DescribeCapacityProvidersRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCapacityProviders that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeCapacityProvidersRequestT = Model::DescribeCapacityProvidersRequest>
  Model::DescribeCapacityProvidersOutcomeCallable DescribeCapacityProvidersCallable(
      const DescribeCapacityProvidersRequestT& request = {}) const {
    return SubmitCallable(&ECSClient::DescribeCapacityProviders, request);
  }

  /**
   * An Async wrapper for DescribeCapacityProviders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCapacityProvidersRequestT = Model::DescribeCapacityProvidersRequest>
  void DescribeCapacityProvidersAsync(const DescribeCapacityProvidersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeCapacityProvidersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeContainerInstancesOutcome DescribeContainerInstances(
      const Model::DescribeContainerInstancesRequest& request) const;

  /**
   * A Callable wrapper for DescribeContainerInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeContainerInstancesRequestT = Model::DescribeContainerInstancesRequest>
  Model::DescribeContainerInstancesOutcomeCallable DescribeContainerInstancesCallable(
      const DescribeContainerInstancesRequestT& request) const {
    return SubmitCallable(&ECSClient::DescribeContainerInstances, request);
  }

  /**
   * An Async wrapper for DescribeContainerInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeContainerInstancesRequestT = Model::DescribeContainerInstancesRequest>
  void DescribeContainerInstancesAsync(const DescribeContainerInstancesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeServiceDeploymentsOutcome DescribeServiceDeployments(
      const Model::DescribeServiceDeploymentsRequest& request) const;

  /**
   * A Callable wrapper for DescribeServiceDeployments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeServiceDeploymentsRequestT = Model::DescribeServiceDeploymentsRequest>
  Model::DescribeServiceDeploymentsOutcomeCallable DescribeServiceDeploymentsCallable(
      const DescribeServiceDeploymentsRequestT& request) const {
    return SubmitCallable(&ECSClient::DescribeServiceDeployments, request);
  }

  /**
   * An Async wrapper for DescribeServiceDeployments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceDeploymentsRequestT = Model::DescribeServiceDeploymentsRequest>
  void DescribeServiceDeploymentsAsync(const DescribeServiceDeploymentsRequestT& request,
                                       const DescribeServiceDeploymentsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeServiceRevisions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeServiceRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceRevisionsRequestT = Model::DescribeServiceRevisionsRequest>
  void DescribeServiceRevisionsAsync(const DescribeServiceRevisionsRequestT& request,
                                     const DescribeServiceRevisionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DescribeServicesRequestT = Model::DescribeServicesRequest>
  void DescribeServicesAsync(const DescribeServicesRequestT& request, const DescribeServicesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTaskDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTaskDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTaskDefinitionRequestT = Model::DescribeTaskDefinitionRequest>
  void DescribeTaskDefinitionAsync(const DescribeTaskDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeTaskSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTaskSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeTaskSetsRequestT = Model::DescribeTaskSetsRequest>
  void DescribeTaskSetsAsync(const DescribeTaskSetsRequestT& request, const DescribeTaskSetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeTasks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTasksRequestT = Model::DescribeTasksRequest>
  void DescribeTasksAsync(const DescribeTasksRequestT& request, const DescribeTasksResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DiscoverPollEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DiscoverPollEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DiscoverPollEndpointRequestT = Model::DiscoverPollEndpointRequest>
  void DiscoverPollEndpointAsync(const DiscoverPollEndpointResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DiscoverPollEndpointRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ExecuteCommand that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ExecuteCommandRequestT = Model::ExecuteCommandRequest>
  void ExecuteCommandAsync(const ExecuteCommandRequestT& request, const ExecuteCommandResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTaskProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTaskProtection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTaskProtectionRequestT = Model::GetTaskProtectionRequest>
  void GetTaskProtectionAsync(const GetTaskProtectionRequestT& request, const GetTaskProtectionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountSettings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccountSettingsRequestT = Model::ListAccountSettingsRequest>
  void ListAccountSettingsAsync(const ListAccountSettingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListAccountSettingsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAttributes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAttributesRequestT = Model::ListAttributesRequest>
  void ListAttributesAsync(const ListAttributesRequestT& request, const ListAttributesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContainerInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContainerInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContainerInstancesRequestT = Model::ListContainerInstancesRequest>
  void ListContainerInstancesAsync(const ListContainerInstancesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListContainerInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListServiceDeployments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServiceDeployments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServiceDeploymentsRequestT = Model::ListServiceDeploymentsRequest>
  void ListServiceDeploymentsAsync(const ListServiceDeploymentsRequestT& request,
                                   const ListServiceDeploymentsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListServicesByNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListServicesByNamespace that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListServicesByNamespaceRequestT = Model::ListServicesByNamespaceRequest>
  void ListServicesByNamespaceAsync(const ListServicesByNamespaceRequestT& request,
                                    const ListServicesByNamespaceResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTaskDefinitionFamiliesOutcome ListTaskDefinitionFamilies(
      const Model::ListTaskDefinitionFamiliesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListTaskDefinitionFamilies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTaskDefinitionFamiliesRequestT = Model::ListTaskDefinitionFamiliesRequest>
  Model::ListTaskDefinitionFamiliesOutcomeCallable ListTaskDefinitionFamiliesCallable(
      const ListTaskDefinitionFamiliesRequestT& request = {}) const {
    return SubmitCallable(&ECSClient::ListTaskDefinitionFamilies, request);
  }

  /**
   * An Async wrapper for ListTaskDefinitionFamilies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTaskDefinitionFamiliesRequestT = Model::ListTaskDefinitionFamiliesRequest>
  void ListTaskDefinitionFamiliesAsync(const ListTaskDefinitionFamiliesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListTaskDefinitionFamiliesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTaskDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTaskDefinitions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTaskDefinitionsRequestT = Model::ListTaskDefinitionsRequest>
  void ListTaskDefinitionsAsync(const ListTaskDefinitionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListTaskDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutAccountSettingDefault that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAccountSettingDefault that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAccountSettingDefaultRequestT = Model::PutAccountSettingDefaultRequest>
  void PutAccountSettingDefaultAsync(const PutAccountSettingDefaultRequestT& request,
  ...
  /**
   * An Async wrapper for PutAttributes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutAttributesRequestT = Model::PutAttributesRequest>
  void PutAttributesAsync(const PutAttributesRequestT& request, const PutAttributesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutClusterCapacityProvidersOutcome PutClusterCapacityProviders(
      const Model::PutClusterCapacityProvidersRequest& request) const;

  /**
   * A Callable wrapper for PutClusterCapacityProviders that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutClusterCapacityProvidersRequestT = Model::PutClusterCapacityProvidersRequest>
  Model::PutClusterCapacityProvidersOutcomeCallable PutClusterCapacityProvidersCallable(
      const PutClusterCapacityProvidersRequestT& request) const {
    return SubmitCallable(&ECSClient::PutClusterCapacityProviders, request);
  }

  /**
   * An Async wrapper for PutClusterCapacityProviders that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutClusterCapacityProvidersRequestT = Model::PutClusterCapacityProvidersRequest>
  void PutClusterCapacityProvidersAsync(const PutClusterCapacityProvidersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterContainerInstanceOutcome RegisterContainerInstance(
      const Model::RegisterContainerInstanceRequest& request = {}) const;

  /**
   * A Callable wrapper for RegisterContainerInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RegisterContainerInstanceRequestT = Model::RegisterContainerInstanceRequest>
  Model::RegisterContainerInstanceOutcomeCallable RegisterContainerInstanceCallable(
      const RegisterContainerInstanceRequestT& request = {}) const {
    return SubmitCallable(&ECSClient::RegisterContainerInstance, request);
  }

  /**
   * An Async wrapper for RegisterContainerInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterContainerInstanceRequestT = Model::RegisterContainerInstanceRequest>
  void RegisterContainerInstanceAsync(const RegisterContainerInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const RegisterContainerInstanceRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RegisterTaskDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterTaskDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterTaskDefinitionRequestT = Model::RegisterTaskDefinitionRequest>
  void RegisterTaskDefinitionAsync(const RegisterTaskDefinitionRequestT& request,
   ...
   * time.</p> </li> </ul> <p>If you get a <code>ConflictException</code> error, the
   * <code>RunTask</code> request could not be processed due to conflicts. The
   ...
   * <code>clientToken</code> and the original set of parameters</p> </li> </ul>
   * <p>If you get a <code>ClientException</code>error, the <code>RunTask</code>
   * could not be processed because you use managed scaling and there is a capacity
   * error because the quota of tasks in the <code>PROVISIONING</code> per cluster
   * has been reached. For information about the service quotas, see <a
   * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-quotas.html">Amazon
   * ECS service quotas</a>.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * An Async wrapper for RunTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RunTaskRequestT = Model::RunTaskRequest>
  void RunTaskAsync(const RunTaskRequestT& request, const RunTaskResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartTaskRequestT = Model::StartTaskRequest>
  void StartTaskAsync(const StartTaskRequestT& request, const StartTaskResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopServiceDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopServiceDeployment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopServiceDeploymentRequestT = Model::StopServiceDeploymentRequest>
  void StopServiceDeploymentAsync(const StopServiceDeploymentRequestT& request, const StopServiceDeploymentResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopTaskRequestT = Model::StopTaskRequest>
  void StopTaskAsync(const StopTaskRequestT& request, const StopTaskResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SubmitAttachmentStateChangesOutcome SubmitAttachmentStateChanges(
      const Model::SubmitAttachmentStateChangesRequest& request) const;

  /**
   * A Callable wrapper for SubmitAttachmentStateChanges that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SubmitAttachmentStateChangesRequestT = Model::SubmitAttachmentStateChangesRequest>
  Model::SubmitAttachmentStateChangesOutcomeCallable SubmitAttachmentStateChangesCallable(
      const SubmitAttachmentStateChangesRequestT& request) const {
    return SubmitCallable(&ECSClient::SubmitAttachmentStateChanges, request);
  }

  /**
   * An Async wrapper for SubmitAttachmentStateChanges that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SubmitAttachmentStateChangesRequestT = Model::SubmitAttachmentStateChangesRequest>
  void SubmitAttachmentStateChangesAsync(const SubmitAttachmentStateChangesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::SubmitContainerStateChangeOutcome SubmitContainerStateChange(
      const Model::SubmitContainerStateChangeRequest& request = {}) const;

  /**
   * A Callable wrapper for SubmitContainerStateChange that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SubmitContainerStateChangeRequestT = Model::SubmitContainerStateChangeRequest>
  Model::SubmitContainerStateChangeOutcomeCallable SubmitContainerStateChangeCallable(
      const SubmitContainerStateChangeRequestT& request = {}) const {
    return SubmitCallable(&ECSClient::SubmitContainerStateChange, request);
  }

  /**
   * An Async wrapper for SubmitContainerStateChange that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SubmitContainerStateChangeRequestT = Model::SubmitContainerStateChangeRequest>
  void SubmitContainerStateChangeAsync(const SubmitContainerStateChangeResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const SubmitContainerStateChangeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for SubmitTaskStateChange that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SubmitTaskStateChange that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SubmitTaskStateChangeRequestT = Model::SubmitTaskStateChangeRequest>
  void SubmitTaskStateChangeAsync(const SubmitTaskStateChangeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const SubmitTaskStateChangeRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateClusterSettings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClusterSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterSettingsRequestT = Model::UpdateClusterSettingsRequest>
  void UpdateClusterSettingsAsync(const UpdateClusterSettingsRequestT& request, const UpdateClusterSettingsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateContainerAgent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateContainerAgent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContainerAgentRequestT = Model::UpdateContainerAgentRequest>
  void UpdateContainerAgentAsync(const UpdateContainerAgentRequestT& request, const UpdateContainerAgentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateContainerInstancesStateOutcome UpdateContainerInstancesState(
      const Model::UpdateContainerInstancesStateRequest& request) const;

  /**
   * A Callable wrapper for UpdateContainerInstancesState that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateContainerInstancesStateRequestT = Model::UpdateContainerInstancesStateRequest>
  Model::UpdateContainerInstancesStateOutcomeCallable UpdateContainerInstancesStateCallable(
      const UpdateContainerInstancesStateRequestT& request) const {
    return SubmitCallable(&ECSClient::UpdateContainerInstancesState, request);
  }

  /**
   * An Async wrapper for UpdateContainerInstancesState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateContainerInstancesStateRequestT = Model::UpdateContainerInstancesStateRequest>
  void UpdateContainerInstancesStateAsync(const UpdateContainerInstancesStateRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateServicePrimaryTaskSetOutcome UpdateServicePrimaryTaskSet(
      const Model::UpdateServicePrimaryTaskSetRequest& request) const;

  /**
   * A Callable wrapper for UpdateServicePrimaryTaskSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateServicePrimaryTaskSetRequestT = Model::UpdateServicePrimaryTaskSetRequest>
  Model::UpdateServicePrimaryTaskSetOutcomeCallable UpdateServicePrimaryTaskSetCallable(
      const UpdateServicePrimaryTaskSetRequestT& request) const {
    return SubmitCallable(&ECSClient::UpdateServicePrimaryTaskSet, request);
  }

  /**
   * An Async wrapper for UpdateServicePrimaryTaskSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServicePrimaryTaskSetRequestT = Model::UpdateServicePrimaryTaskSetRequest>
  void UpdateServicePrimaryTaskSetAsync(const UpdateServicePrimaryTaskSetRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateTaskProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTaskProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTaskProtectionRequestT = Model::UpdateTaskProtectionRequest>
  void UpdateTaskProtectionAsync(const UpdateTaskProtectionRequestT& request, const UpdateTaskProtectionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTaskSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTaskSetRequestT = Model::UpdateTaskSetRequest>
  void UpdateTaskSetAsync(const UpdateTaskSetRequestT& request, const UpdateTaskSetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
