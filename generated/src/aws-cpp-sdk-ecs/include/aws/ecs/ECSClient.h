...
class AWS_ECS_API ECSClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<ECSClient> {
 public:
   ...
   * sending production traffic to it.</p> </li> </ul> <p>When creating a service
   * that uses the <code>EXTERNAL</code> deployment controller, you can specify only
   * parameters that aren't controlled at the task set level. The only required
   * parameter is the service name. You control your services using the <a
