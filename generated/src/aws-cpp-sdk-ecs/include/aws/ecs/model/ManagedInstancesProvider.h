...
namespace Model
{
  ...
  public:
    ...
    template<typename InfrastructureRoleArnT = Aws::String>
    ManagedInstancesProvider& WithInfrastructureRoleArn(InfrastructureRoleArnT&& value) { SetInfrastructureRoleArn(std::forward<InfrastructureRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceLaunchTemplateT = InstanceLaunchTemplate>
    ManagedInstancesProvider& WithInstanceLaunchTemplate(InstanceLaunchTemplateT&& value) { SetInstanceLaunchTemplate(std::forward<InstanceLaunchTemplateT>(value)); return *this;}
    ///@}
    ...
    inline ManagedInstancesProvider& WithPropagateTags(PropagateMITags value) { SetPropagateTags(value); return *this;}
    ///@}
  private:
