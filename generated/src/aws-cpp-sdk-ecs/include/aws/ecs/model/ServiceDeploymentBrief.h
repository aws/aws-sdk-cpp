...
class ServiceDeploymentBrief {
 public:
  ...
  void SetTargetServiceRevisionArn(TargetServiceRevisionArnT&& value) {
    ...
    m_targetServiceRevisionArn = std::forward<TargetServiceRevisionArnT>(value);
  }
  template <typename TargetServiceRevisionArnT = Aws::String>
  ServiceDeploymentBrief& WithTargetServiceRevisionArn(TargetServiceRevisionArnT&& value) {
    SetTargetServiceRevisionArn(std::forward<TargetServiceRevisionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ServiceDeploymentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ServiceDeploymentBrief& WithStatus(ServiceDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
