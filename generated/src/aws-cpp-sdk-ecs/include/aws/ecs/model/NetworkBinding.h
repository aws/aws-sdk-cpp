...
class NetworkBinding {
 public:
  ...
  void SetBindIP(BindIPT&& value) {
    ...
    m_bindIP = std::forward<BindIPT>(value);
  }
  template <typename BindIPT = Aws::String>
  NetworkBinding& WithBindIP(BindIPT&& value) {
    SetBindIP(std::forward<BindIPT>(value));
    return *this;
  }
  ///@}
  ...
  inline NetworkBinding& WithContainerPort(int value) {
  ...
  inline void SetHostPort(int value) {
    m_hostPortHasBeenSet = true;
    m_hostPort = value;
  }
  inline NetworkBinding& WithHostPort(int value) {
    SetHostPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(TransportProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline NetworkBinding& WithProtocol(TransportProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  void SetContainerPortRange(ContainerPortRangeT&& value) {
    ...
    m_containerPortRange = std::forward<ContainerPortRangeT>(value);
  }
  template <typename ContainerPortRangeT = Aws::String>
  NetworkBinding& WithContainerPortRange(ContainerPortRangeT&& value) {
    SetContainerPortRange(std::forward<ContainerPortRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHostPortRange(HostPortRangeT&& value) {
    ...
    m_hostPortRange = std::forward<HostPortRangeT>(value);
  }
  template <typename HostPortRangeT = Aws::String>
  NetworkBinding& WithHostPortRange(HostPortRangeT&& value) {
    SetHostPortRange(std::forward<HostPortRangeT>(value));
    return *this;
  }
  ///@}
 private:
