 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListTaskDefinitionFamiliesRequest">AWS
 * API Reference</a></p>
 */
class ListTaskDefinitionFamiliesRequest : public ECSRequest {
 public:
  ...
  template <typename FamilyPrefixT = Aws::String>
  ListTaskDefinitionFamiliesRequest& WithFamilyPrefix(FamilyPrefixT&& value) {
  ...
  inline void SetStatus(TaskDefinitionFamilyStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListTaskDefinitionFamiliesRequest& WithStatus(TaskDefinitionFamilyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTaskDefinitionFamiliesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTaskDefinitionFamiliesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
