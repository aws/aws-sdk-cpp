...
class ClusterConfiguration {
 public:
  ...
  void SetManagedStorageConfiguration(ManagedStorageConfigurationT&& value) {
    ...
    m_managedStorageConfiguration = std::forward<ManagedStorageConfigurationT>(value);
  }
  template <typename ManagedStorageConfigurationT = ManagedStorageConfiguration>
  ClusterConfiguration& WithManagedStorageConfiguration(ManagedStorageConfigurationT&& value) {
    SetManagedStorageConfiguration(std::forward<ManagedStorageConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
