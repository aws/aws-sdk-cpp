 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DescribeContainerInstancesResponse">AWS
 * API Reference</a></p>
 */
class DescribeContainerInstancesResult {
 public:
  ...
  template <typename ContainerInstancesT = Aws::Vector<ContainerInstance>>
  DescribeContainerInstancesResult& WithContainerInstances(ContainerInstancesT&& value) {
    SetContainerInstances(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  template <typename ContainerInstancesT = ContainerInstance>
  DescribeContainerInstancesResult& AddContainerInstances(ContainerInstancesT&& value) {
    m_containerInstancesHasBeenSet = true;
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  DescribeContainerInstancesResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  DescribeContainerInstancesResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeContainerInstancesResult& WithRequestId(RequestIdT&& value) {
