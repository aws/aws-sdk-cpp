 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DescribeContainerInstancesRequest">AWS
 * API Reference</a></p>
 */
class DescribeContainerInstancesRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  DescribeContainerInstancesRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename ContainerInstancesT = Aws::Vector<Aws::String>>
  DescribeContainerInstancesRequest& WithContainerInstances(ContainerInstancesT&& value) {
    SetContainerInstances(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  template <typename ContainerInstancesT = Aws::String>
  DescribeContainerInstancesRequest& AddContainerInstances(ContainerInstancesT&& value) {
    m_containerInstancesHasBeenSet = true;
  ...
  template <typename IncludeT = Aws::Vector<ContainerInstanceField>>
  DescribeContainerInstancesRequest& WithInclude(IncludeT&& value) {
    SetInclude(std::forward<IncludeT>(value));
    return *this;
  }
  inline DescribeContainerInstancesRequest& AddInclude(ContainerInstanceField value) {
    m_includeHasBeenSet = true;
