 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DeleteServiceRequest">AWS
 * API Reference</a></p>
 */
class DeleteServiceRequest : public ECSRequest {
 public:
  ...
  inline DeleteServiceRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
