...
class ServiceDeployment {
 public:
  ...
  void SetSourceServiceRevisions(SourceServiceRevisionsT&& value) {
    ...
    m_sourceServiceRevisions = std::forward<SourceServiceRevisionsT>(value);
  }
  template <typename SourceServiceRevisionsT = Aws::Vector<ServiceRevisionSummary>>
  ServiceDeployment& WithSourceServiceRevisions(SourceServiceRevisionsT&& value) {
    SetSourceServiceRevisions(std::forward<SourceServiceRevisionsT>(value));
    return *this;
  }
  ...
  ServiceDeployment& AddSourceServiceRevisions(SourceServiceRevisionsT&& value) {
    m_sourceServiceRevisionsHasBeenSet = true;
    m_sourceServiceRevisions.emplace_back(std::forward<SourceServiceRevisionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetServiceRevision(TargetServiceRevisionT&& value) {
    ...
    m_targetServiceRevision = std::forward<TargetServiceRevisionT>(value);
  }
  template <typename TargetServiceRevisionT = ServiceRevisionSummary>
  ServiceDeployment& WithTargetServiceRevision(TargetServiceRevisionT&& value) {
    SetTargetServiceRevision(std::forward<TargetServiceRevisionT>(value));
    return *this;
  }
  ///@}
  ...
  inline ServiceDeployment& WithStatus(ServiceDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLifecycleStage(ServiceDeploymentLifecycleStage value) {
    m_lifecycleStageHasBeenSet = true;
    m_lifecycleStage = value;
  }
  inline ServiceDeployment& WithLifecycleStage(ServiceDeploymentLifecycleStage value) {
