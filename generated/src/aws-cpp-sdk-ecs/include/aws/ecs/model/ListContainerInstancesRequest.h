 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListContainerInstancesRequest">AWS
 * API Reference</a></p>
 */
class ListContainerInstancesRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  ListContainerInstancesRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename FilterT = Aws::String>
  ListContainerInstancesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListContainerInstancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListContainerInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ContainerInstanceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListContainerInstancesRequest& WithStatus(ContainerInstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
