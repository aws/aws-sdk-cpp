...
class FSxWindowsFileServerAuthorizationConfig {
 public:
  ...
  template <typename CredentialsParameterT = Aws::String>
  FSxWindowsFileServerAuthorizationConfig& WithCredentialsParameter(CredentialsParameterT&& value) {
  ...
  template <typename DomainT = Aws::String>
  FSxWindowsFileServerAuthorizationConfig& WithDomain(DomainT&& value) {
