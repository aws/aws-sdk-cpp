...
class ServiceConnectService {
 public:
  ...
  inline void SetIngressPortOverride(int value) {
    m_ingressPortOverrideHasBeenSet = true;
    m_ingressPortOverride = value;
  }
  inline ServiceConnectService& WithIngressPortOverride(int value) {
    SetIngressPortOverride(value);
    return *this;
  }
  ///@}
