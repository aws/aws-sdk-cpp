...
class RunTaskRequest : public ECSRequest {
 public:
  ...
  inline RunTaskRequest& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline RunTaskRequest& WithEnableECSManagedTags(bool value) {
  ...
  inline RunTaskRequest& WithEnableExecuteCommand(bool value) {
  ...
  inline RunTaskRequest& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline RunTaskRequest& WithPropagateTags(PropagateTags value) {
