...
class ServiceManagedEBSVolumeConfiguration {
 public:
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  ServiceManagedEBSVolumeConfiguration& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename VolumeTypeT = Aws::String>
  ServiceManagedEBSVolumeConfiguration& WithVolumeType(VolumeTypeT&& value) {
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithSizeInGiB(int value) {
    SetSizeInGiB(value);
    return *this;
  }
  ///@}
  ...
  template <typename SnapshotIdT = Aws::String>
  ServiceManagedEBSVolumeConfiguration& WithSnapshotId(SnapshotIdT&& value) {
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithVolumeInitializationRate(int value) {
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithThroughput(int value) {
    SetThroughput(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagSpecificationsT = Aws::Vector<EBSTagSpecification>>
  ServiceManagedEBSVolumeConfiguration& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = EBSTagSpecification>
  ServiceManagedEBSVolumeConfiguration& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename RoleArnT = Aws::String>
  ServiceManagedEBSVolumeConfiguration& WithRoleArn(RoleArnT&& value) {
  ...
  inline ServiceManagedEBSVolumeConfiguration& WithFilesystemType(TaskFilesystemType value) {
