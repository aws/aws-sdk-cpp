...
namespace ECS {
namespace Model {
class ContinueServiceDeploymentResult {
 public:
  AWS_ECS_API ContinueServiceDeploymentResult() = default;
  AWS_ECS_API ContinueServiceDeploymentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ECS_API ContinueServiceDeploymentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ServiceDeploymentArnT = Aws::String>
  ContinueServiceDeploymentResult& WithServiceDeploymentArn(ServiceDeploymentArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ContinueServiceDeploymentResult& WithRequestId(RequestIdT&& value) {
