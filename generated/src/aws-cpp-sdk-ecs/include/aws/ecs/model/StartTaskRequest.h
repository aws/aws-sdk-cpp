 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/StartTaskRequest">AWS
 * API Reference</a></p>
 */
class StartTaskRequest : public ECSRequest {
 public:
  ...
  void SetContainerInstances(ContainerInstancesT&& value) {
    ...
    m_containerInstances = std::forward<ContainerInstancesT>(value);
  }
  template <typename ContainerInstancesT = Aws::Vector<Aws::String>>
  StartTaskRequest& WithContainerInstances(ContainerInstancesT&& value) {
    SetContainerInstances(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  template <typename ContainerInstancesT = Aws::String>
  StartTaskRequest& AddContainerInstances(ContainerInstancesT&& value) {
    m_containerInstancesHasBeenSet = true;
    m_containerInstances.emplace_back(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartTaskRequest& WithEnableECSManagedTags(bool value) {
  ...
  inline StartTaskRequest& WithEnableExecuteCommand(bool value) {
  ...
  inline StartTaskRequest& WithPropagateTags(PropagateTags value) {
