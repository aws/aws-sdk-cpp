...
class UpdateTaskProtectionResult {
 public:
  ...
  template <typename ProtectedTasksT = Aws::Vector<ProtectedTask>>
  UpdateTaskProtectionResult& WithProtectedTasks(ProtectedTasksT&& value) {
    SetProtectedTasks(std::forward<ProtectedTasksT>(value));
    return *this;
  }
  template <typename ProtectedTasksT = ProtectedTask>
  UpdateTaskProtectionResult& AddProtectedTasks(ProtectedTasksT&& value) {
    m_protectedTasksHasBeenSet = true;
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  UpdateTaskProtectionResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  UpdateTaskProtectionResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTaskProtectionResult& WithRequestId(RequestIdT&& value) {
