...
class RuntimePlatform {
 public:
  ...
  inline void SetCpuArchitecture(CPUArchitecture value) {
    m_cpuArchitectureHasBeenSet = true;
    m_cpuArchitecture = value;
  }
  inline RuntimePlatform& WithCpuArchitecture(CPUArchitecture value) {
  ...
  inline void SetOperatingSystemFamily(OSFamily value) {
    m_operatingSystemFamilyHasBeenSet = true;
    m_operatingSystemFamily = value;
  }
  inline RuntimePlatform& WithOperatingSystemFamily(OSFamily value) {
    SetOperatingSystemFamily(value);
    return *this;
  }
  ///@}
 private:
