...
/**
 * <p>The listeners associated with the Express service's Application Load
 * Balancer.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ManagedListener">AWS
 * API Reference</a></p>
 */
class ManagedListener {
 public:
  AWS_ECS_API ManagedListener() = default;
  AWS_ECS_API ManagedListener(Aws::Utils::Json::JsonView jsonValue);
  AWS_ECS_API ManagedListener& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ArnT = Aws::String>
  ManagedListener& WithArn(ArnT&& value) {
  ...
  inline ManagedListener& WithStatus(ManagedResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  ManagedListener& WithStatusReason(StatusReasonT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  ManagedListener& WithUpdatedAt(UpdatedAtT&& value) {
