...
class TaskDefinitionPlacementConstraint {
 public:
  ...
  inline void SetType(TaskDefinitionPlacementConstraintType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TaskDefinitionPlacementConstraint& WithType(TaskDefinitionPlacementConstraintType value) {
    SetType(value);
    return *this;
  }
  ///@}
