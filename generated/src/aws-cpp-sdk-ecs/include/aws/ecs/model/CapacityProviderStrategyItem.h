...
class CapacityProviderStrategyItem {
 public:
   ...
   * after the base value is satisfied</p> </li> <li> <p>The default value is
   * <code>0</code> if not specified</p> </li> <li> <p>The valid range is 0 to
   * 1,000</p> </li> <li> <p>At least one capacity provider must have a weight
   * greater than zero</p> </li> <li> <p>Capacity providers with weight of
   * <code>0</code> cannot place tasks</p> </li> </ul> <p>Task distribution
   * logic:</p> <ol> <li> <p>Base satisfaction: The minimum number of tasks specified
   * by the base value are placed on that capacity provider</p> </li> <li> <p>Weight
   * distribution: After base requirements are met, additional tasks are distributed
   * according to weight ratios</p> </li> </ol> <p>Examples:</p> <p>Equal
   * Distribution: Two capacity providers both with weight <code>1</code> will split
   * tasks evenly after base requirements are met.</p> <p>Weighted Distribution: If
   * capacityProviderA has weight <code>1</code> and capacityProviderB has weight
   * <code>4</code>, then for every 1 task on A, 4 tasks will run on B.</p>
   */
  ...
  inline CapacityProviderStrategyItem& WithWeight(int value) {
    SetWeight(value);
    return *this;
  }
  ///@}
   ...
   * have a base defined</p> </li> <li> <p>The default value is <code>0</code> if not
   * specified</p> </li> <li> <p>The valid range is 0 to 100,000</p> </li> <li>
  ...
  inline void SetBase(int value) {
    m_baseHasBeenSet = true;
    m_base = value;
  }
  inline CapacityProviderStrategyItem& WithBase(int value) {
    SetBase(value);
    return *this;
  }
  ///@}
