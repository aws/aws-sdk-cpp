...
class DeploymentLifecycleHook {
 public:
  ...
  void SetHookTargetArn(HookTargetArnT&& value) {
    ...
    m_hookTargetArn = std::forward<HookTargetArnT>(value);
  }
  template <typename HookTargetArnT = Aws::String>
  DeploymentLifecycleHook& WithHookTargetArn(HookTargetArnT&& value) {
    SetHookTargetArn(std::forward<HookTargetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLifecycleStages(LifecycleStagesT&& value) {
    ...
    m_lifecycleStages = std::forward<LifecycleStagesT>(value);
  }
  template <typename LifecycleStagesT = Aws::Vector<DeploymentLifecycleHookStage>>
  DeploymentLifecycleHook& WithLifecycleStages(LifecycleStagesT&& value) {
    SetLifecycleStages(std::forward<LifecycleStagesT>(value));
    return *this;
  }
  inline DeploymentLifecycleHook& AddLifecycleStages(DeploymentLifecycleHookStage value) {
    m_lifecycleStagesHasBeenSet = true;
    m_lifecycleStages.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetHookDetails(HookDetailsT&& value) {
    ...
    m_hookDetails = std::forward<HookDetailsT>(value);
  }
  template <typename HookDetailsT = Aws::Utils::Document>
  DeploymentLifecycleHook& WithHookDetails(HookDetailsT&& value) {
    SetHookDetails(std::forward<HookDetailsT>(value));
    return *this;
  }
  ///@}
 private:
