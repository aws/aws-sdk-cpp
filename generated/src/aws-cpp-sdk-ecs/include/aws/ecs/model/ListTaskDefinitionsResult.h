 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListTaskDefinitionsResponse">AWS
 * API Reference</a></p>
 */
class ListTaskDefinitionsResult {
 public:
  ...
  void SetTaskDefinitionArns(TaskDefinitionArnsT&& value) {
    m_taskDefinitionArnsHasBeenSet = true;
    m_taskDefinitionArns = std::forward<TaskDefinitionArnsT>(value);
  }
  template <typename TaskDefinitionArnsT = Aws::Vector<Aws::String>>
  ListTaskDefinitionsResult& WithTaskDefinitionArns(TaskDefinitionArnsT&& value) {
    SetTaskDefinitionArns(std::forward<TaskDefinitionArnsT>(value));
    return *this;
  }
  template <typename TaskDefinitionArnsT = Aws::String>
  ListTaskDefinitionsResult& AddTaskDefinitionArns(TaskDefinitionArnsT&& value) {
    m_taskDefinitionArnsHasBeenSet = true;
    m_taskDefinitionArns.emplace_back(std::forward<TaskDefinitionArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTaskDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTaskDefinitionsResult& WithRequestId(RequestIdT&& value) {
