 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DescribeClustersResponse">AWS
 * API Reference</a></p>
 */
class DescribeClustersResult {
 public:
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  DescribeClustersResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  DescribeClustersResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
