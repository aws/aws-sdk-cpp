...
class Container {
 public:
  ...
  void SetContainerArn(ContainerArnT&& value) {
    ...
    m_containerArn = std::forward<ContainerArnT>(value);
  }
  template <typename ContainerArnT = Aws::String>
  Container& WithContainerArn(ContainerArnT&& value) {
    SetContainerArn(std::forward<ContainerArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeId(RuntimeIdT&& value) {
    ...
    m_runtimeId = std::forward<RuntimeIdT>(value);
  }
  template <typename RuntimeIdT = Aws::String>
  Container& WithRuntimeId(RuntimeIdT&& value) {
    SetRuntimeId(std::forward<RuntimeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastStatus(LastStatusT&& value) {
    ...
    m_lastStatus = std::forward<LastStatusT>(value);
  }
  template <typename LastStatusT = Aws::String>
  Container& WithLastStatus(LastStatusT&& value) {
    SetLastStatus(std::forward<LastStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline Container& WithExitCode(int value) {
    SetExitCode(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkBindings(NetworkBindingsT&& value) {
    ...
    m_networkBindings = std::forward<NetworkBindingsT>(value);
  }
  template <typename NetworkBindingsT = Aws::Vector<NetworkBinding>>
  Container& WithNetworkBindings(NetworkBindingsT&& value) {
    SetNetworkBindings(std::forward<NetworkBindingsT>(value));
    return *this;
  }
  template <typename NetworkBindingsT = NetworkBinding>
  Container& AddNetworkBindings(NetworkBindingsT&& value) {
    m_networkBindingsHasBeenSet = true;
    m_networkBindings.emplace_back(std::forward<NetworkBindingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHealthStatus(HealthStatus value) {
    m_healthStatusHasBeenSet = true;
    m_healthStatus = value;
  }
  inline Container& WithHealthStatus(HealthStatus value) {
  ...
  void SetManagedAgents(ManagedAgentsT&& value) {
    ...
    m_managedAgents = std::forward<ManagedAgentsT>(value);
  }
  template <typename ManagedAgentsT = Aws::Vector<ManagedAgent>>
  Container& WithManagedAgents(ManagedAgentsT&& value) {
    SetManagedAgents(std::forward<ManagedAgentsT>(value));
    return *this;
  }
  template <typename ManagedAgentsT = ManagedAgent>
  Container& AddManagedAgents(ManagedAgentsT&& value) {
    m_managedAgentsHasBeenSet = true;
    m_managedAgents.emplace_back(std::forward<ManagedAgentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMemoryReservation(MemoryReservationT&& value) {
    ...
    m_memoryReservation = std::forward<MemoryReservationT>(value);
  }
  template <typename MemoryReservationT = Aws::String>
  Container& WithMemoryReservation(MemoryReservationT&& value) {
    SetMemoryReservation(std::forward<MemoryReservationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGpuIds(GpuIdsT&& value) {
    ...
    m_gpuIds = std::forward<GpuIdsT>(value);
  }
  template <typename GpuIdsT = Aws::Vector<Aws::String>>
  Container& WithGpuIds(GpuIdsT&& value) {
    SetGpuIds(std::forward<GpuIdsT>(value));
    return *this;
  }
  template <typename GpuIdsT = Aws::String>
  Container& AddGpuIds(GpuIdsT&& value) {
    m_gpuIdsHasBeenSet = true;
    m_gpuIds.emplace_back(std::forward<GpuIdsT>(value));
    return *this;
  }
  ///@}
 private:
