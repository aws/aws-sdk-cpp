...
class UpdateServicePrimaryTaskSetRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  UpdateServicePrimaryTaskSetRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename ServiceT = Aws::String>
  UpdateServicePrimaryTaskSetRequest& WithService(ServiceT&& value) {
  ...
  void SetPrimaryTaskSet(PrimaryTaskSetT&& value) {
    m_primaryTaskSetHasBeenSet = true;
    m_primaryTaskSet = std::forward<PrimaryTaskSetT>(value);
  }
  template <typename PrimaryTaskSetT = Aws::String>
  UpdateServicePrimaryTaskSetRequest& WithPrimaryTaskSet(PrimaryTaskSetT&& value) {
    SetPrimaryTaskSet(std::forward<PrimaryTaskSetT>(value));
    return *this;
  }
  ///@}
 private:
