...
namespace Model
{
  ...
  public:
    ...
    inline ListServicesByNamespaceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListServicesByNamespaceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListServicesByNamespaceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
