...
class ListServicesByNamespaceResult {
 public:
  ...
  template <typename ServiceArnsT = Aws::Vector<Aws::String>>
  ListServicesByNamespaceResult& WithServiceArns(ServiceArnsT&& value) {
    SetServiceArns(std::forward<ServiceArnsT>(value));
    return *this;
  }
  template <typename ServiceArnsT = Aws::String>
  ListServicesByNamespaceResult& AddServiceArns(ServiceArnsT&& value) {
    m_serviceArnsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServicesByNamespaceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServicesByNamespaceResult& WithRequestId(RequestIdT&& value) {
