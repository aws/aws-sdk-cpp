...
class ManagedStorageConfiguration {
 public:
  ...
  template <typename KmsKeyIdT = Aws::String>
  ManagedStorageConfiguration& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  void SetFargateEphemeralStorageKmsKeyId(FargateEphemeralStorageKmsKeyIdT&& value) {
    m_fargateEphemeralStorageKmsKeyIdHasBeenSet = true;
    m_fargateEphemeralStorageKmsKeyId = std::forward<FargateEphemeralStorageKmsKeyIdT>(value);
  }
  template <typename FargateEphemeralStorageKmsKeyIdT = Aws::String>
  ManagedStorageConfiguration& WithFargateEphemeralStorageKmsKeyId(FargateEphemeralStorageKmsKeyIdT&& value) {
    SetFargateEphemeralStorageKmsKeyId(std::forward<FargateEphemeralStorageKmsKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
