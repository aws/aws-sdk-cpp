...
class ServiceConnectServiceResource {
 public:
  ...
  void SetDiscoveryName(DiscoveryNameT&& value) {
    ...
    m_discoveryName = std::forward<DiscoveryNameT>(value);
  }
  template <typename DiscoveryNameT = Aws::String>
  ServiceConnectServiceResource& WithDiscoveryName(DiscoveryNameT&& value) {
    SetDiscoveryName(std::forward<DiscoveryNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiscoveryArn(DiscoveryArnT&& value) {
    m_discoveryArnHasBeenSet = true;
    m_discoveryArn = std::forward<DiscoveryArnT>(value);
  }
  template <typename DiscoveryArnT = Aws::String>
  ServiceConnectServiceResource& WithDiscoveryArn(DiscoveryArnT&& value) {
    SetDiscoveryArn(std::forward<DiscoveryArnT>(value));
    return *this;
  }
  ///@}
 private:
