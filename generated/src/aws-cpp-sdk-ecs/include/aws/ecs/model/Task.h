...
class Task {
 public:
  ...
  inline void SetConnectivity(Connectivity value) {
    m_connectivityHasBeenSet = true;
    m_connectivity = value;
  }
  inline Task& WithConnectivity(Connectivity value) {
  ...
  void SetConnectivityAt(ConnectivityAtT&& value) {
    ...
    m_connectivityAt = std::forward<ConnectivityAtT>(value);
  }
  template <typename ConnectivityAtT = Aws::Utils::DateTime>
  Task& WithConnectivityAt(ConnectivityAtT&& value) {
    SetConnectivityAt(std::forward<ConnectivityAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDesiredStatus(DesiredStatusT&& value) {
    ...
    m_desiredStatus = std::forward<DesiredStatusT>(value);
  }
  template <typename DesiredStatusT = Aws::String>
  Task& WithDesiredStatus(DesiredStatusT&& value) {
    SetDesiredStatus(std::forward<DesiredStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline Task& WithEnableExecuteCommand(bool value) {
  ...
  inline Task& WithHealthStatus(HealthStatus value) {
  ...
  inline Task& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStopCode(TaskStopCode value) {
    m_stopCodeHasBeenSet = true;
    m_stopCode = value;
  }
  inline Task& WithStopCode(TaskStopCode value) {
    SetStopCode(value);
    return *this;
  }
  ///@}
  ...
  void SetStoppedReason(StoppedReasonT&& value) {
    ...
    m_stoppedReason = std::forward<StoppedReasonT>(value);
  }
  template <typename StoppedReasonT = Aws::String>
  Task& WithStoppedReason(StoppedReasonT&& value) {
    SetStoppedReason(std::forward<StoppedReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStoppingAt(StoppingAtT&& value) {
    ...
    m_stoppingAt = std::forward<StoppingAtT>(value);
  }
  template <typename StoppingAtT = Aws::Utils::DateTime>
  Task& WithStoppingAt(StoppingAtT&& value) {
    SetStoppingAt(std::forward<StoppingAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline Task& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
