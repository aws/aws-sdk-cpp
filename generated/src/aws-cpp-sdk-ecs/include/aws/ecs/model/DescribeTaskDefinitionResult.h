 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DescribeTaskDefinitionResponse">AWS
 * API Reference</a></p>
 */
class DescribeTaskDefinitionResult {
 public:
  AWS_ECS_API DescribeTaskDefinitionResult() = default;
  ...
  template <typename TaskDefinitionT = TaskDefinition>
  DescribeTaskDefinitionResult& WithTaskDefinition(TaskDefinitionT&& value) {
  ...
  ///@{
  /**
   * <p>The metadata that's applied to the task definition to help you categorize and
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  DescribeTaskDefinitionResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  DescribeTaskDefinitionResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTaskDefinitionResult& WithRequestId(RequestIdT&& value) {
