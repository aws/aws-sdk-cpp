...
class TaskDefinition {
 public:
  ...
  inline void SetNetworkMode(NetworkMode value) {
    m_networkModeHasBeenSet = true;
    m_networkMode = value;
  }
  inline TaskDefinition& WithNetworkMode(NetworkMode value) {
  ...
  inline TaskDefinition& WithRevision(int value) {
    SetRevision(value);
    return *this;
  }
  ///@}
  ...
  inline TaskDefinition& WithStatus(TaskDefinitionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRequiresAttributes(RequiresAttributesT&& value) {
    ...
    m_requiresAttributes = std::forward<RequiresAttributesT>(value);
  }
  template <typename RequiresAttributesT = Aws::Vector<Attribute>>
  TaskDefinition& WithRequiresAttributes(RequiresAttributesT&& value) {
    SetRequiresAttributes(std::forward<RequiresAttributesT>(value));
    return *this;
  }
  template <typename RequiresAttributesT = Attribute>
  TaskDefinition& AddRequiresAttributes(RequiresAttributesT&& value) {
    m_requiresAttributesHasBeenSet = true;
    m_requiresAttributes.emplace_back(std::forward<RequiresAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  inline TaskDefinition& AddCompatibilities(Compatibility value) {
    m_compatibilitiesHasBeenSet = true;
    m_compatibilities.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline TaskDefinition& AddRequiresCompatibilities(Compatibility value) {
    m_requiresCompatibilitiesHasBeenSet = true;
    m_requiresCompatibilities.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPidMode(PidMode value) {
    m_pidModeHasBeenSet = true;
    m_pidMode = value;
  }
  inline TaskDefinition& WithPidMode(PidMode value) {
    SetPidMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIpcMode(IpcMode value) {
    m_ipcModeHasBeenSet = true;
    m_ipcMode = value;
  }
  inline TaskDefinition& WithIpcMode(IpcMode value) {
    SetIpcMode(value);
    return *this;
  }
  ///@}
  ...
  void SetDeregisteredAt(DeregisteredAtT&& value) {
    ...
    m_deregisteredAt = std::forward<DeregisteredAtT>(value);
  }
  template <typename DeregisteredAtT = Aws::Utils::DateTime>
  TaskDefinition& WithDeregisteredAt(DeregisteredAtT&& value) {
    SetDeregisteredAt(std::forward<DeregisteredAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableFaultInjection(bool value) {
    m_enableFaultInjectionHasBeenSet = true;
    m_enableFaultInjection = value;
  }
  inline TaskDefinition& WithEnableFaultInjection(bool value) {
    SetEnableFaultInjection(value);
    return *this;
  }
  ///@}
 private:
