...
class ExecuteCommandLogConfiguration {
 public:
  ...
  inline ExecuteCommandLogConfiguration& WithCloudWatchEncryptionEnabled(bool value) {
  ...
  inline ExecuteCommandLogConfiguration& WithS3EncryptionEnabled(bool value) {
