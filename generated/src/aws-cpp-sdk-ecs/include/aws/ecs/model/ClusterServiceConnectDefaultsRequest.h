...
class ClusterServiceConnectDefaultsRequest {
 public:
  AWS_ECS_API ClusterServiceConnectDefaultsRequest() = default;
   ...
   * (&lt;), double quotation marks ("), or slash (/).</p> <p>If you enter an
   * existing namespace name or ARN, then that namespace will be used. Any namespace
   * type is supported. The namespace must be in this account and this Amazon Web
   * Services Region.</p> <p>If you enter a new name, a Cloud Map namespace will be
   * created. Amazon ECS creates a Cloud Map namespace with the "API calls" method of
   * instance discovery only. This instance discovery method is the "HTTP" namespace
   * type in the Command Line Interface. Other types of instance discovery aren't
   * used by Service Connect.</p> <p>If you update the cluster with an empty string
  ...
  template <typename NamespaceT = Aws::String>
  ClusterServiceConnectDefaultsRequest& WithNamespace(NamespaceT&& value) {
