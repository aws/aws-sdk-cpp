...
class DescribeTasksResult {
 public:
  ...
  template <typename TasksT = Aws::Vector<Task>>
  DescribeTasksResult& WithTasks(TasksT&& value) {
    SetTasks(std::forward<TasksT>(value));
    return *this;
  }
  template <typename TasksT = Task>
  DescribeTasksResult& AddTasks(TasksT&& value) {
    m_tasksHasBeenSet = true;
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  DescribeTasksResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  DescribeTasksResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTasksResult& WithRequestId(RequestIdT&& value) {
