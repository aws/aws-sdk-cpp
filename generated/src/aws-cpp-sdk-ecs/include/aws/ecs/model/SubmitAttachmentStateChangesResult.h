...
class SubmitAttachmentStateChangesResult {
 public:
  ...
  void SetAcknowledgment(AcknowledgmentT&& value) {
    m_acknowledgmentHasBeenSet = true;
    m_acknowledgment = std::forward<AcknowledgmentT>(value);
  }
  template <typename AcknowledgmentT = Aws::String>
  SubmitAttachmentStateChangesResult& WithAcknowledgment(AcknowledgmentT&& value) {
    SetAcknowledgment(std::forward<AcknowledgmentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  SubmitAttachmentStateChangesResult& WithRequestId(RequestIdT&& value) {
