...
class ListAccountSettingsResult {
 public:
  ...
  template <typename SettingsT = Aws::Vector<Setting>>
  ListAccountSettingsResult& WithSettings(SettingsT&& value) {
    SetSettings(std::forward<SettingsT>(value));
    return *this;
  }
  template <typename SettingsT = Setting>
  ListAccountSettingsResult& AddSettings(SettingsT&& value) {
    m_settingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountSettingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountSettingsResult& WithRequestId(RequestIdT&& value) {
