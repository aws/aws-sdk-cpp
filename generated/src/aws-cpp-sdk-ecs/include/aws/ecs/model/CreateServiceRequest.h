 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/CreateServiceRequest">AWS
 * API Reference</a></p>
 */
class CreateServiceRequest : public ECSRequest {
 public:
  ...
  inline CreateServiceRequest& WithAvailabilityZoneRebalancing(AvailabilityZoneRebalancing value) {
  ...
  inline CreateServiceRequest& WithDesiredCount(int value) {
  ...
  inline CreateServiceRequest& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The capacity provider strategy to use for the service.</p>  <p>If you
   ...
   * checks, then <code>healthCheckGracePeriodSeconds</code> is unused.</p> <p>If
   * your service has more running tasks than desired, unhealthy tasks in the grace
  ...
  inline CreateServiceRequest& WithHealthCheckGracePeriodSeconds(int value) {
  ...
  inline CreateServiceRequest& WithSchedulingStrategy(SchedulingStrategy value) {
  ...
  inline CreateServiceRequest& WithEnableECSManagedTags(bool value) {
  ...
  inline CreateServiceRequest& WithPropagateTags(PropagateTags value) {
  ...
  inline CreateServiceRequest& WithEnableExecuteCommand(bool value) {
  ...
  template <typename MonitoringT = MonitoringConfiguration>
  CreateServiceRequest& WithMonitoring(MonitoringT&& value) {
