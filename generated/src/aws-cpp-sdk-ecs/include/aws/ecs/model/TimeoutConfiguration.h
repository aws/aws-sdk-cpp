...
class TimeoutConfiguration {
 public:
  ...
  inline TimeoutConfiguration& WithIdleTimeoutSeconds(int value) {
  ...
  inline void SetPerRequestTimeoutSeconds(int value) {
    m_perRequestTimeoutSecondsHasBeenSet = true;
    m_perRequestTimeoutSeconds = value;
  }
  inline TimeoutConfiguration& WithPerRequestTimeoutSeconds(int value) {
    SetPerRequestTimeoutSeconds(value);
    return *this;
  }
  ///@}
 private:
