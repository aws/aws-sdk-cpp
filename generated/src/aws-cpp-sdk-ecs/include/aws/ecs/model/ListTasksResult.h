 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListTasksResponse">AWS
 * API Reference</a></p>
 */
class ListTasksResult {
 public:
  ...
  void SetTaskArns(TaskArnsT&& value) {
    m_taskArnsHasBeenSet = true;
    m_taskArns = std::forward<TaskArnsT>(value);
  }
  template <typename TaskArnsT = Aws::Vector<Aws::String>>
  ListTasksResult& WithTaskArns(TaskArnsT&& value) {
    SetTaskArns(std::forward<TaskArnsT>(value));
    return *this;
  }
  template <typename TaskArnsT = Aws::String>
  ListTasksResult& AddTaskArns(TaskArnsT&& value) {
    m_taskArnsHasBeenSet = true;
    m_taskArns.emplace_back(std::forward<TaskArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTasksResult& WithRequestId(RequestIdT&& value) {
