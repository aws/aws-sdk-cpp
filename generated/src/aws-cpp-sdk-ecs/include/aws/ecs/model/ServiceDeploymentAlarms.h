...
class ServiceDeploymentAlarms {
 public:
  ...
  inline void SetStatus(ServiceDeploymentRollbackMonitorsStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ServiceDeploymentAlarms& WithStatus(ServiceDeploymentRollbackMonitorsStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
