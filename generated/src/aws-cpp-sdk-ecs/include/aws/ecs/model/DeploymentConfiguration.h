...
class DeploymentConfiguration {
 public:
  ...
  void SetDeploymentCircuitBreaker(DeploymentCircuitBreakerT&& value) {
    ...
    m_deploymentCircuitBreaker = std::forward<DeploymentCircuitBreakerT>(value);
  }
  template <typename DeploymentCircuitBreakerT = DeploymentCircuitBreaker>
  DeploymentConfiguration& WithDeploymentCircuitBreaker(DeploymentCircuitBreakerT&& value) {
    SetDeploymentCircuitBreaker(std::forward<DeploymentCircuitBreakerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumPercent(int value) {
    m_maximumPercentHasBeenSet = true;
    m_maximumPercent = value;
  }
  inline DeploymentConfiguration& WithMaximumPercent(int value) {
    SetMaximumPercent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumHealthyPercent(int value) {
    m_minimumHealthyPercentHasBeenSet = true;
    m_minimumHealthyPercent = value;
  }
  inline DeploymentConfiguration& WithMinimumHealthyPercent(int value) {
    SetMinimumHealthyPercent(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStrategy(DeploymentStrategy value) {
    m_strategyHasBeenSet = true;
    m_strategy = value;
  }
  inline DeploymentConfiguration& WithStrategy(DeploymentStrategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentConfiguration& WithBakeTimeInMinutes(int value) {
