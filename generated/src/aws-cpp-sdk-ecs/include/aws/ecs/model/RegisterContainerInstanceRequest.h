 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/RegisterContainerInstanceRequest">AWS
 * API Reference</a></p>
 */
class RegisterContainerInstanceRequest : public ECSRequest {
 public:
  ...
  void SetInstanceIdentityDocument(InstanceIdentityDocumentT&& value) {
    m_instanceIdentityDocumentHasBeenSet = true;
    m_instanceIdentityDocument = std::forward<InstanceIdentityDocumentT>(value);
  }
  template <typename InstanceIdentityDocumentT = Aws::String>
  RegisterContainerInstanceRequest& WithInstanceIdentityDocument(InstanceIdentityDocumentT&& value) {
    SetInstanceIdentityDocument(std::forward<InstanceIdentityDocumentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceIdentityDocumentSignature(InstanceIdentityDocumentSignatureT&& value) {
    m_instanceIdentityDocumentSignatureHasBeenSet = true;
    m_instanceIdentityDocumentSignature = std::forward<InstanceIdentityDocumentSignatureT>(value);
  }
  template <typename InstanceIdentityDocumentSignatureT = Aws::String>
  RegisterContainerInstanceRequest& WithInstanceIdentityDocumentSignature(InstanceIdentityDocumentSignatureT&& value) {
    SetInstanceIdentityDocumentSignature(std::forward<InstanceIdentityDocumentSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPlatformDevices(PlatformDevicesT&& value) {
    m_platformDevicesHasBeenSet = true;
    m_platformDevices = std::forward<PlatformDevicesT>(value);
  }
  template <typename PlatformDevicesT = Aws::Vector<PlatformDevice>>
  RegisterContainerInstanceRequest& WithPlatformDevices(PlatformDevicesT&& value) {
    SetPlatformDevices(std::forward<PlatformDevicesT>(value));
    return *this;
  }
  ...
  RegisterContainerInstanceRequest& AddPlatformDevices(PlatformDevicesT&& value) {
    m_platformDevicesHasBeenSet = true;
    m_platformDevices.emplace_back(std::forward<PlatformDevicesT>(value));
    return *this;
  }
  ///@}
