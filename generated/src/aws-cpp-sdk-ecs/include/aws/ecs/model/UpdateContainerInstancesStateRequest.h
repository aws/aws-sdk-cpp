 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/UpdateContainerInstancesStateRequest">AWS
 * API Reference</a></p>
 */
class UpdateContainerInstancesStateRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  UpdateContainerInstancesStateRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename ContainerInstancesT = Aws::Vector<Aws::String>>
  UpdateContainerInstancesStateRequest& WithContainerInstances(ContainerInstancesT&& value) {
    SetContainerInstances(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  template <typename ContainerInstancesT = Aws::String>
  UpdateContainerInstancesStateRequest& AddContainerInstances(ContainerInstancesT&& value) {
    m_containerInstancesHasBeenSet = true;
  ...
  inline UpdateContainerInstancesStateRequest& WithStatus(ContainerInstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
