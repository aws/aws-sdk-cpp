...
class EBSTagSpecification {
 public:
  ...
  inline void SetResourceType(EBSResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline EBSTagSpecification& WithResourceType(EBSResourceType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  EBSTagSpecification& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  EBSTagSpecification& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline EBSTagSpecification& WithPropagateTags(PropagateTags value) {
