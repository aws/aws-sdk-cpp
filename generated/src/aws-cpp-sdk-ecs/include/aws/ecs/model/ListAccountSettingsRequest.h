...
class ListAccountSettingsRequest : public ECSRequest {
 public:
  ...
  inline void SetName(SettingName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ListAccountSettingsRequest& WithName(SettingName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEffectiveSettings(bool value) {
    m_effectiveSettingsHasBeenSet = true;
    m_effectiveSettings = value;
  }
  inline ListAccountSettingsRequest& WithEffectiveSettings(bool value) {
    SetEffectiveSettings(value);
    return *this;
  }
  ///@}
  ...
  inline ListAccountSettingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
