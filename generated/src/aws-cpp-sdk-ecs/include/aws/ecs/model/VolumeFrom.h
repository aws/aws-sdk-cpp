...
class VolumeFrom {
 public:
  ...
  void SetSourceContainer(SourceContainerT&& value) {
    m_sourceContainerHasBeenSet = true;
    m_sourceContainer = std::forward<SourceContainerT>(value);
  }
  template <typename SourceContainerT = Aws::String>
  VolumeFrom& WithSourceContainer(SourceContainerT&& value) {
    SetSourceContainer(std::forward<SourceContainerT>(value));
    return *this;
  }
  ///@}
  ...
  inline VolumeFrom& WithReadOnly(bool value) {
    SetReadOnly(value);
    return *this;
  }
  ///@}
