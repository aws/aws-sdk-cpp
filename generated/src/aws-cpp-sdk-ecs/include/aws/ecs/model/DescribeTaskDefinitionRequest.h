 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DescribeTaskDefinitionRequest">AWS
 * API Reference</a></p>
 */
class DescribeTaskDefinitionRequest : public ECSRequest {
 public:
  ...
  template <typename TaskDefinitionT = Aws::String>
  DescribeTaskDefinitionRequest& WithTaskDefinition(TaskDefinitionT&& value) {
  ...
  template <typename IncludeT = Aws::Vector<TaskDefinitionField>>
  DescribeTaskDefinitionRequest& WithInclude(IncludeT&& value) {
    SetInclude(std::forward<IncludeT>(value));
    return *this;
  }
  inline DescribeTaskDefinitionRequest& AddInclude(TaskDefinitionField value) {
    m_includeHasBeenSet = true;
