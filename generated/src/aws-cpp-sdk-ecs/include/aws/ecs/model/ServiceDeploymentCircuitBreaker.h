...
class ServiceDeploymentCircuitBreaker {
 public:
  ...
  inline ServiceDeploymentCircuitBreaker& WithStatus(ServiceDeploymentRollbackMonitorsStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceDeploymentCircuitBreaker& WithFailureCount(int value) {
  ...
  inline ServiceDeploymentCircuitBreaker& WithThreshold(int value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
