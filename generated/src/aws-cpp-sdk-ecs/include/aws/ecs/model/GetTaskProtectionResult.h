...
class GetTaskProtectionResult {
 public:
  AWS_ECS_API GetTaskProtectionResult() = default;
  ...
  void SetProtectedTasks(ProtectedTasksT&& value) {
    m_protectedTasksHasBeenSet = true;
    m_protectedTasks = std::forward<ProtectedTasksT>(value);
  }
  template <typename ProtectedTasksT = Aws::Vector<ProtectedTask>>
  GetTaskProtectionResult& WithProtectedTasks(ProtectedTasksT&& value) {
    SetProtectedTasks(std::forward<ProtectedTasksT>(value));
    return *this;
  }
  template <typename ProtectedTasksT = ProtectedTask>
  GetTaskProtectionResult& AddProtectedTasks(ProtectedTasksT&& value) {
    m_protectedTasksHasBeenSet = true;
    m_protectedTasks.emplace_back(std::forward<ProtectedTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  GetTaskProtectionResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  GetTaskProtectionResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetTaskProtectionResult& WithRequestId(RequestIdT&& value) {
