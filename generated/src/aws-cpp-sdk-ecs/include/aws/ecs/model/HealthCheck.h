...
class HealthCheck {
 public:
  ...
  inline HealthCheck& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheck& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheck& WithRetries(int value) {
    SetRetries(value);
    return *this;
  }
  ///@}
  ...
  inline HealthCheck& WithStartPeriod(int value) {
