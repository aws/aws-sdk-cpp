...
class AutoScalingGroupProvider {
 public:
  ...
  inline AutoScalingGroupProvider& WithManagedTerminationProtection(ManagedTerminationProtection value) {
  ...
  inline AutoScalingGroupProvider& WithManagedDraining(ManagedDraining value) {
