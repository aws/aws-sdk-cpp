 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/UpdateContainerAgentRequest">AWS
 * API Reference</a></p>
 */
class UpdateContainerAgentRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  UpdateContainerAgentRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename ContainerInstanceT = Aws::String>
  UpdateContainerAgentRequest& WithContainerInstance(ContainerInstanceT&& value) {
