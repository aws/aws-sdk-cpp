...
class ManagedAgent {
 public:
  ...
  void SetLastStartedAt(LastStartedAtT&& value) {
    ...
    m_lastStartedAt = std::forward<LastStartedAtT>(value);
  }
  template <typename LastStartedAtT = Aws::Utils::DateTime>
  ManagedAgent& WithLastStartedAt(LastStartedAtT&& value) {
    SetLastStartedAt(std::forward<LastStartedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetName(ManagedAgentName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ManagedAgent& WithName(ManagedAgentName value) {
    SetName(value);
    return *this;
  }
  ///@}
