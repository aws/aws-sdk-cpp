...
class Cluster {
 public:
  ...
  inline Cluster& WithRegisteredContainerInstancesCount(int value) {
  ...
  inline Cluster& WithRunningTasksCount(int value) {
  ...
  inline Cluster& WithPendingTasksCount(int value) {
  ...
  inline Cluster& WithActiveServicesCount(int value) {
  ...
  void SetAttachmentsStatus(AttachmentsStatusT&& value) {
    ...
    m_attachmentsStatus = std::forward<AttachmentsStatusT>(value);
  }
  template <typename AttachmentsStatusT = Aws::String>
  Cluster& WithAttachmentsStatus(AttachmentsStatusT&& value) {
    SetAttachmentsStatus(std::forward<AttachmentsStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceConnectDefaults(ServiceConnectDefaultsT&& value) {
    ...
    m_serviceConnectDefaults = std::forward<ServiceConnectDefaultsT>(value);
  }
  template <typename ServiceConnectDefaultsT = ClusterServiceConnectDefaults>
  Cluster& WithServiceConnectDefaults(ServiceConnectDefaultsT&& value) {
    SetServiceConnectDefaults(std::forward<ServiceConnectDefaultsT>(value));
    return *this;
  }
  ///@}
 private:
