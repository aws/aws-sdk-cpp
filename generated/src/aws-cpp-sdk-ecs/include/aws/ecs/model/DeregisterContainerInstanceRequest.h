 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DeregisterContainerInstanceRequest">AWS
 * API Reference</a></p>
 */
class DeregisterContainerInstanceRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  DeregisterContainerInstanceRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename ContainerInstanceT = Aws::String>
  DeregisterContainerInstanceRequest& WithContainerInstance(ContainerInstanceT&& value) {
  ...
  inline DeregisterContainerInstanceRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
