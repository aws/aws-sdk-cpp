...
class CapacityProvider {
 public:
  ...
  template <typename NameT = Aws::String>
  CapacityProvider& WithName(NameT&& value) {
  ...
  template <typename ClusterT = Aws::String>
  CapacityProvider& WithCluster(ClusterT&& value) {
  ...
  inline CapacityProvider& WithStatus(CapacityProviderStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename AutoScalingGroupProviderT = AutoScalingGroupProvider>
  CapacityProvider& WithAutoScalingGroupProvider(AutoScalingGroupProviderT&& value) {
  ...
  template <typename ManagedInstancesProviderT = ManagedInstancesProvider>
  CapacityProvider& WithManagedInstancesProvider(ManagedInstancesProviderT&& value) {
  ...
  inline void SetUpdateStatus(CapacityProviderUpdateStatus value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus = value;
  }
  inline CapacityProvider& WithUpdateStatus(CapacityProviderUpdateStatus value) {
  ...
  template <typename UpdateStatusReasonT = Aws::String>
  CapacityProvider& WithUpdateStatusReason(UpdateStatusReasonT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CapacityProvider& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CapacityProvider& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline void SetType(CapacityProviderType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CapacityProvider& WithType(CapacityProviderType value) {
    SetType(value);
    return *this;
  }
  ///@}
