...
class Resource {
 public:
  ...
  inline Resource& WithDoubleValue(double value) {
  ...
  inline Resource& WithLongValue(long long value) {
    SetLongValue(value);
    return *this;
  }
  ///@}
  ...
  inline Resource& WithIntegerValue(int value) {
  ...
  void SetStringSetValue(StringSetValueT&& value) {
    ...
    m_stringSetValue = std::forward<StringSetValueT>(value);
  }
  template <typename StringSetValueT = Aws::Vector<Aws::String>>
  Resource& WithStringSetValue(StringSetValueT&& value) {
    SetStringSetValue(std::forward<StringSetValueT>(value));
    return *this;
  }
  template <typename StringSetValueT = Aws::String>
  Resource& AddStringSetValue(StringSetValueT&& value) {
    m_stringSetValueHasBeenSet = true;
    m_stringSetValue.emplace_back(std::forward<StringSetValueT>(value));
    return *this;
  }
  ///@}
 private:
