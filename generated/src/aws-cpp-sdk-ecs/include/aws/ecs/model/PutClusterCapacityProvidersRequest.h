...
class PutClusterCapacityProvidersRequest : public ECSRequest {
 public:
  ...
  template <typename ClusterT = Aws::String>
  PutClusterCapacityProvidersRequest& WithCluster(ClusterT&& value) {
  ...
  template <typename CapacityProvidersT = Aws::Vector<Aws::String>>
  PutClusterCapacityProvidersRequest& WithCapacityProviders(CapacityProvidersT&& value) {
    SetCapacityProviders(std::forward<CapacityProvidersT>(value));
    return *this;
  }
  template <typename CapacityProvidersT = Aws::String>
  PutClusterCapacityProvidersRequest& AddCapacityProviders(CapacityProvidersT&& value) {
    m_capacityProvidersHasBeenSet = true;
   ...
   * associated with a cluster to be used.</p>
   */
  inline const Aws::Vector<CapacityProviderStrategyItem>& GetDefaultCapacityProviderStrategy() const {
    return m_defaultCapacityProviderStrategy;
  }
  ...
  void SetDefaultCapacityProviderStrategy(DefaultCapacityProviderStrategyT&& value) {
    ...
    m_defaultCapacityProviderStrategy = std::forward<DefaultCapacityProviderStrategyT>(value);
  }
  template <typename DefaultCapacityProviderStrategyT = Aws::Vector<CapacityProviderStrategyItem>>
  PutClusterCapacityProvidersRequest& WithDefaultCapacityProviderStrategy(DefaultCapacityProviderStrategyT&& value) {
    SetDefaultCapacityProviderStrategy(std::forward<DefaultCapacityProviderStrategyT>(value));
    return *this;
  }
  template <typename DefaultCapacityProviderStrategyT = CapacityProviderStrategyItem>
  PutClusterCapacityProvidersRequest& AddDefaultCapacityProviderStrategy(DefaultCapacityProviderStrategyT&& value) {
    m_defaultCapacityProviderStrategyHasBeenSet = true;
    m_defaultCapacityProviderStrategy.emplace_back(std::forward<DefaultCapacityProviderStrategyT>(value));
    return *this;
  }
  ///@}
 private:
