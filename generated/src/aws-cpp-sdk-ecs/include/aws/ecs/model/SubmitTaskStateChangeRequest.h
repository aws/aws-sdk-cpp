 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/SubmitTaskStateChangeRequest">AWS
 * API Reference</a></p>
 */
class SubmitTaskStateChangeRequest : public ECSRequest {
 public:
  ...
  void SetPullStartedAt(PullStartedAtT&& value) {
    ...
    m_pullStartedAt = std::forward<PullStartedAtT>(value);
  }
  template <typename PullStartedAtT = Aws::Utils::DateTime>
  SubmitTaskStateChangeRequest& WithPullStartedAt(PullStartedAtT&& value) {
    SetPullStartedAt(std::forward<PullStartedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPullStoppedAt(PullStoppedAtT&& value) {
    ...
    m_pullStoppedAt = std::forward<PullStoppedAtT>(value);
  }
  template <typename PullStoppedAtT = Aws::Utils::DateTime>
  SubmitTaskStateChangeRequest& WithPullStoppedAt(PullStoppedAtT&& value) {
    SetPullStoppedAt(std::forward<PullStoppedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecutionStoppedAt(ExecutionStoppedAtT&& value) {
    ...
    m_executionStoppedAt = std::forward<ExecutionStoppedAtT>(value);
  }
  template <typename ExecutionStoppedAtT = Aws::Utils::DateTime>
  SubmitTaskStateChangeRequest& WithExecutionStoppedAt(ExecutionStoppedAtT&& value) {
    SetExecutionStoppedAt(std::forward<ExecutionStoppedAtT>(value));
    return *this;
  }
  ///@}
 private:
