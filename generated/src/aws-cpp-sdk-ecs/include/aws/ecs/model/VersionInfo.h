...
class VersionInfo {
 public:
  ...
  void SetAgentHash(AgentHashT&& value) {
    ...
    m_agentHash = std::forward<AgentHashT>(value);
  }
  template <typename AgentHashT = Aws::String>
  VersionInfo& WithAgentHash(AgentHashT&& value) {
    SetAgentHash(std::forward<AgentHashT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDockerVersion(DockerVersionT&& value) {
    ...
    m_dockerVersion = std::forward<DockerVersionT>(value);
  }
  template <typename DockerVersionT = Aws::String>
  VersionInfo& WithDockerVersion(DockerVersionT&& value) {
    SetDockerVersion(std::forward<DockerVersionT>(value));
    return *this;
  }
  ///@}
 private:
