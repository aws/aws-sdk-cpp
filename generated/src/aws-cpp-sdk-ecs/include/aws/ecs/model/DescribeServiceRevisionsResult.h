...
class DescribeServiceRevisionsResult {
 public:
  ...
  void SetServiceRevisions(ServiceRevisionsT&& value) {
    m_serviceRevisionsHasBeenSet = true;
    m_serviceRevisions = std::forward<ServiceRevisionsT>(value);
  }
  template <typename ServiceRevisionsT = Aws::Vector<ServiceRevision>>
  DescribeServiceRevisionsResult& WithServiceRevisions(ServiceRevisionsT&& value) {
    SetServiceRevisions(std::forward<ServiceRevisionsT>(value));
    return *this;
  }
  template <typename ServiceRevisionsT = ServiceRevision>
  DescribeServiceRevisionsResult& AddServiceRevisions(ServiceRevisionsT&& value) {
    m_serviceRevisionsHasBeenSet = true;
    m_serviceRevisions.emplace_back(std::forward<ServiceRevisionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  DescribeServiceRevisionsResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  DescribeServiceRevisionsResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeServiceRevisionsResult& WithRequestId(RequestIdT&& value) {
