 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListClustersResponse">AWS
 * API Reference</a></p>
 */
class ListClustersResult {
 public:
  ...
  void SetClusterArns(ClusterArnsT&& value) {
    m_clusterArnsHasBeenSet = true;
    m_clusterArns = std::forward<ClusterArnsT>(value);
  }
  template <typename ClusterArnsT = Aws::Vector<Aws::String>>
  ListClustersResult& WithClusterArns(ClusterArnsT&& value) {
    SetClusterArns(std::forward<ClusterArnsT>(value));
    return *this;
  }
  template <typename ClusterArnsT = Aws::String>
  ListClustersResult& AddClusterArns(ClusterArnsT&& value) {
    m_clusterArnsHasBeenSet = true;
    m_clusterArns.emplace_back(std::forward<ClusterArnsT>(value));
    return *this;
  }
  ///@}
