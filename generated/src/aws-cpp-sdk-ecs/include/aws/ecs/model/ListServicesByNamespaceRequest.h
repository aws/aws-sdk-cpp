...
class ListServicesByNamespaceRequest : public ECSRequest {
 public:
  AWS_ECS_API ListServicesByNamespaceRequest() = default;
  ...
  template <typename NamespaceT = Aws::String>
  ListServicesByNamespaceRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListServicesByNamespaceRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListServicesByNamespaceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
