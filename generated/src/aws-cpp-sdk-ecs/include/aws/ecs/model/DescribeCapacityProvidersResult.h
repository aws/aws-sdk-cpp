...
class DescribeCapacityProvidersResult {
 public:
  ...
  template <typename CapacityProvidersT = Aws::Vector<CapacityProvider>>
  DescribeCapacityProvidersResult& WithCapacityProviders(CapacityProvidersT&& value) {
    SetCapacityProviders(std::forward<CapacityProvidersT>(value));
    return *this;
  }
  template <typename CapacityProvidersT = CapacityProvider>
  DescribeCapacityProvidersResult& AddCapacityProviders(CapacityProvidersT&& value) {
    m_capacityProvidersHasBeenSet = true;
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  DescribeCapacityProvidersResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  DescribeCapacityProvidersResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityProvidersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCapacityProvidersResult& WithRequestId(RequestIdT&& value) {
