 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/RegisterTaskDefinitionRequest">AWS
 * API Reference</a></p>
 */
class RegisterTaskDefinitionRequest : public ECSRequest {
 public:
  ...
  inline RegisterTaskDefinitionRequest& WithNetworkMode(NetworkMode value) {
  ...
  inline RegisterTaskDefinitionRequest& AddRequiresCompatibilities(Compatibility value) {
    m_requiresCompatibilitiesHasBeenSet = true;
  ...
  inline RegisterTaskDefinitionRequest& WithPidMode(PidMode value) {
    SetPidMode(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterTaskDefinitionRequest& WithIpcMode(IpcMode value) {
    SetIpcMode(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterTaskDefinitionRequest& WithEnableFaultInjection(bool value) {
