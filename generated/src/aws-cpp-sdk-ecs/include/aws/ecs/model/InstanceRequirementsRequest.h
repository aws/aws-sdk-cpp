...
class InstanceRequirementsRequest {
 public:
  ...
  void SetVCpuCount(VCpuCountT&& value) {
    ...
    m_vCpuCount = std::forward<VCpuCountT>(value);
  }
  template <typename VCpuCountT = VCpuCountRangeRequest>
  InstanceRequirementsRequest& WithVCpuCount(VCpuCountT&& value) {
    SetVCpuCount(std::forward<VCpuCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMemoryMiB(MemoryMiBT&& value) {
    ...
    m_memoryMiB = std::forward<MemoryMiBT>(value);
  }
  template <typename MemoryMiBT = MemoryMiBRequest>
  InstanceRequirementsRequest& WithMemoryMiB(MemoryMiBT&& value) {
    SetMemoryMiB(std::forward<MemoryMiBT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCpuManufacturers(CpuManufacturersT&& value) {
    ...
    m_cpuManufacturers = std::forward<CpuManufacturersT>(value);
  }
  template <typename CpuManufacturersT = Aws::Vector<CpuManufacturer>>
  InstanceRequirementsRequest& WithCpuManufacturers(CpuManufacturersT&& value) {
    SetCpuManufacturers(std::forward<CpuManufacturersT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddCpuManufacturers(CpuManufacturer value) {
    m_cpuManufacturersHasBeenSet = true;
    m_cpuManufacturers.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetMemoryGiBPerVCpu(MemoryGiBPerVCpuT&& value) {
    ...
    m_memoryGiBPerVCpu = std::forward<MemoryGiBPerVCpuT>(value);
  }
  template <typename MemoryGiBPerVCpuT = MemoryGiBPerVCpuRequest>
  InstanceRequirementsRequest& WithMemoryGiBPerVCpu(MemoryGiBPerVCpuT&& value) {
    SetMemoryGiBPerVCpu(std::forward<MemoryGiBPerVCpuT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceGenerations(InstanceGenerationsT&& value) {
    ...
    m_instanceGenerations = std::forward<InstanceGenerationsT>(value);
  }
  template <typename InstanceGenerationsT = Aws::Vector<InstanceGeneration>>
  InstanceRequirementsRequest& WithInstanceGenerations(InstanceGenerationsT&& value) {
    SetInstanceGenerations(std::forward<InstanceGenerationsT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddInstanceGenerations(InstanceGeneration value) {
    m_instanceGenerationsHasBeenSet = true;
    m_instanceGenerations.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpotMaxPricePercentageOverLowestPrice(int value) {
    m_spotMaxPricePercentageOverLowestPriceHasBeenSet = true;
    m_spotMaxPricePercentageOverLowestPrice = value;
  }
  inline InstanceRequirementsRequest& WithSpotMaxPricePercentageOverLowestPrice(int value) {
    SetSpotMaxPricePercentageOverLowestPrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOnDemandMaxPricePercentageOverLowestPrice(int value) {
    m_onDemandMaxPricePercentageOverLowestPriceHasBeenSet = true;
    m_onDemandMaxPricePercentageOverLowestPrice = value;
  }
  inline InstanceRequirementsRequest& WithOnDemandMaxPricePercentageOverLowestPrice(int value) {
    SetOnDemandMaxPricePercentageOverLowestPrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBareMetal(BareMetal value) {
    m_bareMetalHasBeenSet = true;
    m_bareMetal = value;
  }
  inline InstanceRequirementsRequest& WithBareMetal(BareMetal value) {
    SetBareMetal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBurstablePerformance(BurstablePerformance value) {
    m_burstablePerformanceHasBeenSet = true;
    m_burstablePerformance = value;
  }
  inline InstanceRequirementsRequest& WithBurstablePerformance(BurstablePerformance value) {
    SetBurstablePerformance(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRequireHibernateSupport(bool value) {
    m_requireHibernateSupportHasBeenSet = true;
    m_requireHibernateSupport = value;
  }
  inline InstanceRequirementsRequest& WithRequireHibernateSupport(bool value) {
    SetRequireHibernateSupport(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkInterfaceCount(NetworkInterfaceCountT&& value) {
    ...
    m_networkInterfaceCount = std::forward<NetworkInterfaceCountT>(value);
  }
  template <typename NetworkInterfaceCountT = NetworkInterfaceCountRequest>
  InstanceRequirementsRequest& WithNetworkInterfaceCount(NetworkInterfaceCountT&& value) {
    SetNetworkInterfaceCount(std::forward<NetworkInterfaceCountT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLocalStorage(LocalStorage value) {
    m_localStorageHasBeenSet = true;
    m_localStorage = value;
  }
  inline InstanceRequirementsRequest& WithLocalStorage(LocalStorage value) {
  ...
  void SetLocalStorageTypes(LocalStorageTypesT&& value) {
    ...
    m_localStorageTypes = std::forward<LocalStorageTypesT>(value);
  }
  template <typename LocalStorageTypesT = Aws::Vector<LocalStorageType>>
  InstanceRequirementsRequest& WithLocalStorageTypes(LocalStorageTypesT&& value) {
    SetLocalStorageTypes(std::forward<LocalStorageTypesT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddLocalStorageTypes(LocalStorageType value) {
    m_localStorageTypesHasBeenSet = true;
    m_localStorageTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTotalLocalStorageGB(TotalLocalStorageGBT&& value) {
    ...
    m_totalLocalStorageGB = std::forward<TotalLocalStorageGBT>(value);
  }
  template <typename TotalLocalStorageGBT = TotalLocalStorageGBRequest>
  InstanceRequirementsRequest& WithTotalLocalStorageGB(TotalLocalStorageGBT&& value) {
    SetTotalLocalStorageGB(std::forward<TotalLocalStorageGBT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBaselineEbsBandwidthMbps(BaselineEbsBandwidthMbpsT&& value) {
    ...
    m_baselineEbsBandwidthMbps = std::forward<BaselineEbsBandwidthMbpsT>(value);
  }
  template <typename BaselineEbsBandwidthMbpsT = BaselineEbsBandwidthMbpsRequest>
  InstanceRequirementsRequest& WithBaselineEbsBandwidthMbps(BaselineEbsBandwidthMbpsT&& value) {
    SetBaselineEbsBandwidthMbps(std::forward<BaselineEbsBandwidthMbpsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAcceleratorTypes(AcceleratorTypesT&& value) {
    ...
    m_acceleratorTypes = std::forward<AcceleratorTypesT>(value);
  }
  template <typename AcceleratorTypesT = Aws::Vector<AcceleratorType>>
  InstanceRequirementsRequest& WithAcceleratorTypes(AcceleratorTypesT&& value) {
    SetAcceleratorTypes(std::forward<AcceleratorTypesT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddAcceleratorTypes(AcceleratorType value) {
    m_acceleratorTypesHasBeenSet = true;
    m_acceleratorTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAcceleratorCount(AcceleratorCountT&& value) {
    ...
    m_acceleratorCount = std::forward<AcceleratorCountT>(value);
  }
  template <typename AcceleratorCountT = AcceleratorCountRequest>
  InstanceRequirementsRequest& WithAcceleratorCount(AcceleratorCountT&& value) {
    SetAcceleratorCount(std::forward<AcceleratorCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAcceleratorManufacturers(AcceleratorManufacturersT&& value) {
    ...
    m_acceleratorManufacturers = std::forward<AcceleratorManufacturersT>(value);
  }
  template <typename AcceleratorManufacturersT = Aws::Vector<AcceleratorManufacturer>>
  InstanceRequirementsRequest& WithAcceleratorManufacturers(AcceleratorManufacturersT&& value) {
    SetAcceleratorManufacturers(std::forward<AcceleratorManufacturersT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddAcceleratorManufacturers(AcceleratorManufacturer value) {
    m_acceleratorManufacturersHasBeenSet = true;
    m_acceleratorManufacturers.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAcceleratorNames(AcceleratorNamesT&& value) {
    ...
    m_acceleratorNames = std::forward<AcceleratorNamesT>(value);
  }
  template <typename AcceleratorNamesT = Aws::Vector<AcceleratorName>>
  InstanceRequirementsRequest& WithAcceleratorNames(AcceleratorNamesT&& value) {
    SetAcceleratorNames(std::forward<AcceleratorNamesT>(value));
    return *this;
  }
  inline InstanceRequirementsRequest& AddAcceleratorNames(AcceleratorName value) {
    m_acceleratorNamesHasBeenSet = true;
    m_acceleratorNames.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAcceleratorTotalMemoryMiB(AcceleratorTotalMemoryMiBT&& value) {
    ...
    m_acceleratorTotalMemoryMiB = std::forward<AcceleratorTotalMemoryMiBT>(value);
  }
  template <typename AcceleratorTotalMemoryMiBT = AcceleratorTotalMemoryMiBRequest>
  InstanceRequirementsRequest& WithAcceleratorTotalMemoryMiB(AcceleratorTotalMemoryMiBT&& value) {
    SetAcceleratorTotalMemoryMiB(std::forward<AcceleratorTotalMemoryMiBT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkBandwidthGbps(NetworkBandwidthGbpsT&& value) {
    ...
    m_networkBandwidthGbps = std::forward<NetworkBandwidthGbpsT>(value);
  }
  template <typename NetworkBandwidthGbpsT = NetworkBandwidthGbpsRequest>
  InstanceRequirementsRequest& WithNetworkBandwidthGbps(NetworkBandwidthGbpsT&& value) {
    SetNetworkBandwidthGbps(std::forward<NetworkBandwidthGbpsT>(value));
    return *this;
  }
  ///@}
  ...
  inline bool MaxSpotPriceAsPercentageOfOptimalOnDemandPriceHasBeenSet() const {
    return m_maxSpotPriceAsPercentageOfOptimalOnDemandPriceHasBeenSet;
  }
  inline void SetMaxSpotPriceAsPercentageOfOptimalOnDemandPrice(int value) {
    m_maxSpotPriceAsPercentageOfOptimalOnDemandPriceHasBeenSet = true;
    m_maxSpotPriceAsPercentageOfOptimalOnDemandPrice = value;
  }
  inline InstanceRequirementsRequest& WithMaxSpotPriceAsPercentageOfOptimalOnDemandPrice(int value) {
    SetMaxSpotPriceAsPercentageOfOptimalOnDemandPrice(value);
    return *this;
  }
  ///@}
 private:
