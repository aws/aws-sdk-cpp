...
class ContainerDefinition {
 public:
  ...
  inline ContainerDefinition& WithCpu(int value) {
    SetCpu(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDefinition& WithMemory(int value) {
    SetMemory(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDefinition& WithMemoryReservation(int value) {
  ...
  inline ContainerDefinition& WithEssential(bool value) {
    SetEssential(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDefinition& WithStartTimeout(int value) {
  ...
  inline ContainerDefinition& WithStopTimeout(int value) {
  ...
  inline void SetVersionConsistency(VersionConsistency value) {
    m_versionConsistencyHasBeenSet = true;
    m_versionConsistency = value;
  }
  inline ContainerDefinition& WithVersionConsistency(VersionConsistency value) {
    SetVersionConsistency(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDefinition& WithDisableNetworking(bool value) {
  ...
  inline ContainerDefinition& WithPrivileged(bool value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDefinition& WithReadonlyRootFilesystem(bool value) {
  ...
  inline ContainerDefinition& WithInteractive(bool value) {
  ...
  inline ContainerDefinition& WithPseudoTerminal(bool value) {
  ...
  void SetCredentialSpecs(CredentialSpecsT&& value) {
    ...
    m_credentialSpecs = std::forward<CredentialSpecsT>(value);
  }
  template <typename CredentialSpecsT = Aws::Vector<Aws::String>>
  ContainerDefinition& WithCredentialSpecs(CredentialSpecsT&& value) {
    SetCredentialSpecs(std::forward<CredentialSpecsT>(value));
    return *this;
  }
  template <typename CredentialSpecsT = Aws::String>
  ContainerDefinition& AddCredentialSpecs(CredentialSpecsT&& value) {
    m_credentialSpecsHasBeenSet = true;
    m_credentialSpecs.emplace_back(std::forward<CredentialSpecsT>(value));
    return *this;
  }
  ///@}
 private:
