 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/DiscoverPollEndpointRequest">AWS
 * API Reference</a></p>
 */
class DiscoverPollEndpointRequest : public ECSRequest {
 public:
  ...
  template <typename ContainerInstanceT = Aws::String>
  DiscoverPollEndpointRequest& WithContainerInstance(ContainerInstanceT&& value) {
  ...
  template <typename ClusterT = Aws::String>
  DiscoverPollEndpointRequest& WithCluster(ClusterT&& value) {
