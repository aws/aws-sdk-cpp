...
class UpdateServiceRequest : public ECSRequest {
 public:
  ...
  inline UpdateServiceRequest& WithDesiredCount(int value) {
  ...
  inline UpdateServiceRequest& WithAvailabilityZoneRebalancing(AvailabilityZoneRebalancing value) {
  ...
  inline void SetForceNewDeployment(bool value) {
    m_forceNewDeploymentHasBeenSet = true;
    m_forceNewDeployment = value;
  }
  inline UpdateServiceRequest& WithForceNewDeployment(bool value) {
    SetForceNewDeployment(value);
    return *this;
  }
  ///@}
   ...
   * up.</p> <p>If your service has more running tasks than desired, unhealthy tasks
   * in the grace period might be stopped to reach the desired count.</p> <p>This
   * parameter doesn't trigger a new service deployment.</p>
   */
  ...
  inline UpdateServiceRequest& WithHealthCheckGracePeriodSeconds(int value) {
  ...
  inline UpdateServiceRequest& WithEnableExecuteCommand(bool value) {
  ...
  inline UpdateServiceRequest& WithEnableECSManagedTags(bool value) {
  ...
  inline UpdateServiceRequest& WithPropagateTags(PropagateTags value) {
