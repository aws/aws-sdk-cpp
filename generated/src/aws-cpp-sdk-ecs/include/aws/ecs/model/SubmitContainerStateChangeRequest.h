 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/SubmitContainerStateChangeRequest">AWS
 * API Reference</a></p>
 */
class SubmitContainerStateChangeRequest : public ECSRequest {
 public:
  ...
  inline SubmitContainerStateChangeRequest& WithExitCode(int value) {
    SetExitCode(value);
    return *this;
  }
  ///@}
