...
class ContainerInstance {
 public:
  ...
  inline ContainerInstance& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetVersionInfo(VersionInfoT&& value) {
    ...
    m_versionInfo = std::forward<VersionInfoT>(value);
  }
  template <typename VersionInfoT = VersionInfo>
  ContainerInstance& WithVersionInfo(VersionInfoT&& value) {
    SetVersionInfo(std::forward<VersionInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemainingResources(RemainingResourcesT&& value) {
    ...
    m_remainingResources = std::forward<RemainingResourcesT>(value);
  }
  template <typename RemainingResourcesT = Aws::Vector<Resource>>
  ContainerInstance& WithRemainingResources(RemainingResourcesT&& value) {
    SetRemainingResources(std::forward<RemainingResourcesT>(value));
    return *this;
  }
  template <typename RemainingResourcesT = Resource>
  ContainerInstance& AddRemainingResources(RemainingResourcesT&& value) {
    m_remainingResourcesHasBeenSet = true;
    m_remainingResources.emplace_back(std::forward<RemainingResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegisteredResources(RegisteredResourcesT&& value) {
    ...
    m_registeredResources = std::forward<RegisteredResourcesT>(value);
  }
  template <typename RegisteredResourcesT = Aws::Vector<Resource>>
  ContainerInstance& WithRegisteredResources(RegisteredResourcesT&& value) {
    SetRegisteredResources(std::forward<RegisteredResourcesT>(value));
    return *this;
  }
  template <typename RegisteredResourcesT = Resource>
  ContainerInstance& AddRegisteredResources(RegisteredResourcesT&& value) {
    m_registeredResourcesHasBeenSet = true;
    m_registeredResources.emplace_back(std::forward<RegisteredResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAgentConnected(bool value) {
    m_agentConnectedHasBeenSet = true;
    m_agentConnected = value;
  }
  inline ContainerInstance& WithAgentConnected(bool value) {
  ...
  inline void SetRunningTasksCount(int value) {
    m_runningTasksCountHasBeenSet = true;
    m_runningTasksCount = value;
  }
  inline ContainerInstance& WithRunningTasksCount(int value) {
    SetRunningTasksCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPendingTasksCount(int value) {
    m_pendingTasksCountHasBeenSet = true;
    m_pendingTasksCount = value;
  }
  inline ContainerInstance& WithPendingTasksCount(int value) {
    SetPendingTasksCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAgentUpdateStatus(AgentUpdateStatus value) {
    m_agentUpdateStatusHasBeenSet = true;
    m_agentUpdateStatus = value;
  }
  inline ContainerInstance& WithAgentUpdateStatus(AgentUpdateStatus value) {
    SetAgentUpdateStatus(value);
    return *this;
  }
  ///@}
