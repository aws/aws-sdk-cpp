...
class ServiceConnectClientAlias {
 public:
  ...
  inline ServiceConnectClientAlias& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetTestTrafficRules(TestTrafficRulesT&& value) {
    ...
    m_testTrafficRules = std::forward<TestTrafficRulesT>(value);
  }
  template <typename TestTrafficRulesT = ServiceConnectTestTrafficRules>
  ServiceConnectClientAlias& WithTestTrafficRules(TestTrafficRulesT&& value) {
    SetTestTrafficRules(std::forward<TestTrafficRulesT>(value));
    return *this;
  }
  ///@}
 private:
