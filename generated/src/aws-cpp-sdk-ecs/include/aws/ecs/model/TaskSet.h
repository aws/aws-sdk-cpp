...
class TaskSet {
 public:
  ...
  void SetTaskSetArn(TaskSetArnT&& value) {
    ...
    m_taskSetArn = std::forward<TaskSetArnT>(value);
  }
  template <typename TaskSetArnT = Aws::String>
  TaskSet& WithTaskSetArn(TaskSetArnT&& value) {
    SetTaskSetArn(std::forward<TaskSetArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComputedDesiredCount(int value) {
    m_computedDesiredCountHasBeenSet = true;
    m_computedDesiredCount = value;
  }
  inline TaskSet& WithComputedDesiredCount(int value) {
    SetComputedDesiredCount(value);
    return *this;
  }
  ///@}
  ...
  inline TaskSet& WithPendingCount(int value) {
  ...
  inline TaskSet& WithRunningCount(int value) {
  ...
  inline TaskSet& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStabilityStatus(StabilityStatus value) {
    m_stabilityStatusHasBeenSet = true;
    m_stabilityStatus = value;
  }
  inline TaskSet& WithStabilityStatus(StabilityStatus value) {
    SetStabilityStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetStabilityStatusAt(StabilityStatusAtT&& value) {
    ...
    m_stabilityStatusAt = std::forward<StabilityStatusAtT>(value);
  }
  template <typename StabilityStatusAtT = Aws::Utils::DateTime>
  TaskSet& WithStabilityStatusAt(StabilityStatusAtT&& value) {
    SetStabilityStatusAt(std::forward<StabilityStatusAtT>(value));
    return *this;
  }
  ///@}
