...
class PortMapping {
 public:
  ...
  inline PortMapping& WithContainerPort(int value) {
  ...
  inline PortMapping& WithHostPort(int value) {
    SetHostPort(value);
    return *this;
  }
  ///@}
  ...
  inline PortMapping& WithProtocol(TransportProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAppProtocol(ApplicationProtocol value) {
    m_appProtocolHasBeenSet = true;
    m_appProtocol = value;
  }
  inline PortMapping& WithAppProtocol(ApplicationProtocol value) {
