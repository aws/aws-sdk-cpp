 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListTaskDefinitionsRequest">AWS
 * API Reference</a></p>
 */
class ListTaskDefinitionsRequest : public ECSRequest {
 public:
  ...
  inline void SetStatus(TaskDefinitionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListTaskDefinitionsRequest& WithStatus(TaskDefinitionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListTaskDefinitionsRequest& WithSort(SortOrder value) {
    SetSort(value);
    return *this;
  }
  ///@}
  ...
  inline ListTaskDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
