 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListServicesRequest">AWS
 * API Reference</a></p>
 */
class ListServicesRequest : public ECSRequest {
 public:
  ...
  inline ListServicesRequest& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
  ...
  inline ListServicesRequest& WithSchedulingStrategy(SchedulingStrategy value) {
