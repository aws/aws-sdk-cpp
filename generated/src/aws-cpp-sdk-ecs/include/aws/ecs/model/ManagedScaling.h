...
class ManagedScaling {
 public:
  ...
  inline void SetStatus(ManagedScalingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ManagedScaling& WithStatus(ManagedScalingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTargetCapacity(int value) {
    m_targetCapacityHasBeenSet = true;
    m_targetCapacity = value;
  }
  inline ManagedScaling& WithTargetCapacity(int value) {
  ...
  inline void SetMinimumScalingStepSize(int value) {
    m_minimumScalingStepSizeHasBeenSet = true;
    m_minimumScalingStepSize = value;
  }
  inline ManagedScaling& WithMinimumScalingStepSize(int value) {
    SetMinimumScalingStepSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumScalingStepSize(int value) {
    m_maximumScalingStepSizeHasBeenSet = true;
    m_maximumScalingStepSize = value;
  }
  inline ManagedScaling& WithMaximumScalingStepSize(int value) {
    SetMaximumScalingStepSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceWarmupPeriod(int value) {
    m_instanceWarmupPeriodHasBeenSet = true;
    m_instanceWarmupPeriod = value;
  }
  inline ManagedScaling& WithInstanceWarmupPeriod(int value) {
    SetInstanceWarmupPeriod(value);
    return *this;
  }
  ///@}
 private:
