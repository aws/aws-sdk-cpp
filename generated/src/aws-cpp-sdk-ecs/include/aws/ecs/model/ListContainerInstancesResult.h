 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListContainerInstancesResponse">AWS
 * API Reference</a></p>
 */
class ListContainerInstancesResult {
 public:
  ...
  void SetContainerInstanceArns(ContainerInstanceArnsT&& value) {
    m_containerInstanceArnsHasBeenSet = true;
    m_containerInstanceArns = std::forward<ContainerInstanceArnsT>(value);
  }
  template <typename ContainerInstanceArnsT = Aws::Vector<Aws::String>>
  ListContainerInstancesResult& WithContainerInstanceArns(ContainerInstanceArnsT&& value) {
    SetContainerInstanceArns(std::forward<ContainerInstanceArnsT>(value));
    return *this;
  }
  template <typename ContainerInstanceArnsT = Aws::String>
  ListContainerInstancesResult& AddContainerInstanceArns(ContainerInstanceArnsT&& value) {
    m_containerInstanceArnsHasBeenSet = true;
    m_containerInstanceArns.emplace_back(std::forward<ContainerInstanceArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContainerInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContainerInstancesResult& WithRequestId(RequestIdT&& value) {
