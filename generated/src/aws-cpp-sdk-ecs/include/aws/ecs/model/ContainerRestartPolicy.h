...
class ContainerRestartPolicy {
 public:
  ...
  inline ContainerRestartPolicy& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetIgnoredExitCodes(IgnoredExitCodesT&& value) {
    ...
    m_ignoredExitCodes = std::forward<IgnoredExitCodesT>(value);
  }
  template <typename IgnoredExitCodesT = Aws::Vector<int>>
  ContainerRestartPolicy& WithIgnoredExitCodes(IgnoredExitCodesT&& value) {
    SetIgnoredExitCodes(std::forward<IgnoredExitCodesT>(value));
    return *this;
  }
  inline ContainerRestartPolicy& AddIgnoredExitCodes(int value) {
    m_ignoredExitCodesHasBeenSet = true;
    m_ignoredExitCodes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRestartAttemptPeriod(int value) {
    m_restartAttemptPeriodHasBeenSet = true;
    m_restartAttemptPeriod = value;
  }
  inline ContainerRestartPolicy& WithRestartAttemptPeriod(int value) {
    SetRestartAttemptPeriod(value);
    return *this;
  }
  ///@}
 private:
