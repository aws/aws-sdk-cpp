...
class ListServiceDeploymentsResult {
 public:
  ...
  void SetServiceDeployments(ServiceDeploymentsT&& value) {
    m_serviceDeploymentsHasBeenSet = true;
    m_serviceDeployments = std::forward<ServiceDeploymentsT>(value);
  }
  template <typename ServiceDeploymentsT = Aws::Vector<ServiceDeploymentBrief>>
  ListServiceDeploymentsResult& WithServiceDeployments(ServiceDeploymentsT&& value) {
    SetServiceDeployments(std::forward<ServiceDeploymentsT>(value));
    return *this;
  }
  template <typename ServiceDeploymentsT = ServiceDeploymentBrief>
  ListServiceDeploymentsResult& AddServiceDeployments(ServiceDeploymentsT&& value) {
    m_serviceDeploymentsHasBeenSet = true;
    m_serviceDeployments.emplace_back(std::forward<ServiceDeploymentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceDeploymentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceDeploymentsResult& WithRequestId(RequestIdT&& value) {
