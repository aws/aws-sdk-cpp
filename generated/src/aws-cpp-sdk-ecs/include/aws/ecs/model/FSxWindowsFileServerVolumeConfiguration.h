...
class FSxWindowsFileServerVolumeConfiguration {
 public:
  ...
  template <typename FileSystemIdT = Aws::String>
  FSxWindowsFileServerVolumeConfiguration& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename RootDirectoryT = Aws::String>
  FSxWindowsFileServerVolumeConfiguration& WithRootDirectory(RootDirectoryT&& value) {
  ...
  template <typename AuthorizationConfigT = FSxWindowsFileServerAuthorizationConfig>
  FSxWindowsFileServerVolumeConfiguration& WithAuthorizationConfig(AuthorizationConfigT&& value) {
