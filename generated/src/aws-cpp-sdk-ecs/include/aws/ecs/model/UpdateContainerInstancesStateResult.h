 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/UpdateContainerInstancesStateResponse">AWS
 * API Reference</a></p>
 */
class UpdateContainerInstancesStateResult {
 public:
  ...
  template <typename ContainerInstancesT = Aws::Vector<ContainerInstance>>
  UpdateContainerInstancesStateResult& WithContainerInstances(ContainerInstancesT&& value) {
    SetContainerInstances(std::forward<ContainerInstancesT>(value));
    return *this;
  }
  template <typename ContainerInstancesT = ContainerInstance>
  UpdateContainerInstancesStateResult& AddContainerInstances(ContainerInstancesT&& value) {
    m_containerInstancesHasBeenSet = true;
  ...
  template <typename FailuresT = Aws::Vector<Failure>>
  UpdateContainerInstancesStateResult& WithFailures(FailuresT&& value) {
    SetFailures(std::forward<FailuresT>(value));
    return *this;
  }
  template <typename FailuresT = Failure>
  UpdateContainerInstancesStateResult& AddFailures(FailuresT&& value) {
    m_failuresHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateContainerInstancesStateResult& WithRequestId(RequestIdT&& value) {
