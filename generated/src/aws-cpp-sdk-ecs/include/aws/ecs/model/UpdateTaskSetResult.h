...
namespace Model
{
  ...
  {
  public:
    AWS_ECS_API UpdateTaskSetResult() = default;
    ...
    template<typename TaskSetT = TaskSet>
    UpdateTaskSetResult& WithTaskSet(TaskSetT&& value) { SetTaskSet(std::forward<TaskSetT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTaskSetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
