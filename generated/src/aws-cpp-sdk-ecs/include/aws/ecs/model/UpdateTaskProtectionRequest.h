...
class UpdateTaskProtectionRequest : public ECSRequest {
 public:
  ...
  inline UpdateTaskProtectionRequest& WithProtectionEnabled(bool value) {
  ...
  inline void SetExpiresInMinutes(int value) {
    m_expiresInMinutesHasBeenSet = true;
    m_expiresInMinutes = value;
  }
  inline UpdateTaskProtectionRequest& WithExpiresInMinutes(int value) {
