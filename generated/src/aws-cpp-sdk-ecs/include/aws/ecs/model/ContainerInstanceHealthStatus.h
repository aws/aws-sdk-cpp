...
class ContainerInstanceHealthStatus {
 public:
  ...
  inline void SetOverallStatus(InstanceHealthCheckState value) {
    m_overallStatusHasBeenSet = true;
    m_overallStatus = value;
  }
  inline ContainerInstanceHealthStatus& WithOverallStatus(InstanceHealthCheckState value) {
  ...
  template <typename DetailsT = Aws::Vector<InstanceHealthCheckResult>>
  ContainerInstanceHealthStatus& WithDetails(DetailsT&& value) {
    SetDetails(std::forward<DetailsT>(value));
    return *this;
  }
  template <typename DetailsT = InstanceHealthCheckResult>
  ContainerInstanceHealthStatus& AddDetails(DetailsT&& value) {
    m_detailsHasBeenSet = true;
