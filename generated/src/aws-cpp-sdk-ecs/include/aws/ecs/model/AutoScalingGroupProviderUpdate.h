...
class AutoScalingGroupProviderUpdate {
 public:
  ...
  void SetManagedScaling(ManagedScalingT&& value) {
    ...
    m_managedScaling = std::forward<ManagedScalingT>(value);
  }
  template <typename ManagedScalingT = ManagedScaling>
  AutoScalingGroupProviderUpdate& WithManagedScaling(ManagedScalingT&& value) {
    SetManagedScaling(std::forward<ManagedScalingT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManagedTerminationProtection(ManagedTerminationProtection value) {
    m_managedTerminationProtectionHasBeenSet = true;
    m_managedTerminationProtection = value;
  }
  inline AutoScalingGroupProviderUpdate& WithManagedTerminationProtection(ManagedTerminationProtection value) {
    SetManagedTerminationProtection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetManagedDraining(ManagedDraining value) {
    m_managedDrainingHasBeenSet = true;
    m_managedDraining = value;
  }
  inline AutoScalingGroupProviderUpdate& WithManagedDraining(ManagedDraining value) {
    SetManagedDraining(value);
    return *this;
  }
  ///@}
 private:
