...
namespace Model
{
  ...
  public:
    ...
    template<typename ManagedScalingT = ManagedScaling>
    AutoScalingGroupProviderUpdate& WithManagedScaling(ManagedScalingT&& value) { SetManagedScaling(std::forward<ManagedScalingT>(value)); return *this;}
    ///@}
    ...
    inline AutoScalingGroupProviderUpdate& WithManagedTerminationProtection(ManagedTerminationProtection value) { SetManagedTerminationProtection(value); return *this;}
    ///@}
    ...
    inline AutoScalingGroupProviderUpdate& WithManagedDraining(ManagedDraining value) { SetManagedDraining(value); return *this;}
    ///@}
  private:
