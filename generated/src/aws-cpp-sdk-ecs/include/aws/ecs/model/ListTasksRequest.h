 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ListTasksRequest">AWS
 * API Reference</a></p>
 */
class ListTasksRequest : public ECSRequest {
 public:
  ...
  inline void SetDesiredStatus(DesiredStatus value) {
    m_desiredStatusHasBeenSet = true;
    m_desiredStatus = value;
  }
  inline ListTasksRequest& WithDesiredStatus(DesiredStatus value) {
  ...
  inline ListTasksRequest& WithLaunchType(LaunchType value) {
    SetLaunchType(value);
    return *this;
  }
  ///@}
