...
class Volume {
 public:
  ...
  void SetDockerVolumeConfiguration(DockerVolumeConfigurationT&& value) {
    ...
    m_dockerVolumeConfiguration = std::forward<DockerVolumeConfigurationT>(value);
  }
  template <typename DockerVolumeConfigurationT = DockerVolumeConfiguration>
  Volume& WithDockerVolumeConfiguration(DockerVolumeConfigurationT&& value) {
    SetDockerVolumeConfiguration(std::forward<DockerVolumeConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const FSxWindowsFileServerVolumeConfiguration& GetFsxWindowsFileServerVolumeConfiguration() const {
    return m_fsxWindowsFileServerVolumeConfiguration;
  }
  ...
  void SetFsxWindowsFileServerVolumeConfiguration(FsxWindowsFileServerVolumeConfigurationT&& value) {
    ...
    m_fsxWindowsFileServerVolumeConfiguration = std::forward<FsxWindowsFileServerVolumeConfigurationT>(value);
  }
  template <typename FsxWindowsFileServerVolumeConfigurationT = FSxWindowsFileServerVolumeConfiguration>
  Volume& WithFsxWindowsFileServerVolumeConfiguration(FsxWindowsFileServerVolumeConfigurationT&& value) {
    SetFsxWindowsFileServerVolumeConfiguration(std::forward<FsxWindowsFileServerVolumeConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConfiguredAtLaunch(bool value) {
    m_configuredAtLaunchHasBeenSet = true;
    m_configuredAtLaunch = value;
  }
  inline Volume& WithConfiguredAtLaunch(bool value) {
    SetConfiguredAtLaunch(value);
    return *this;
  }
  ///@}
 private:
