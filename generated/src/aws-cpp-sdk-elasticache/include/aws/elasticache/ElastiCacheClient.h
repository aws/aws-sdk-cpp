...
class AWS_ELASTICACHE_API ElastiCacheClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  ElastiCacheClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ElastiCacheEndpointProviderBase> endpointProvider = nullptr,
      const Aws::ElastiCache::ElastiCacheClientConfiguration& clientConfiguration = Aws::ElastiCache::ElastiCacheClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddTagsToResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AddTagsToResource that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AddTagsToResourceRequestT = Model::AddTagsToResourceRequest>
  void AddTagsToResourceAsync(const AddTagsToResourceRequestT& request, const AddTagsToResourceResponseReceivedHandler& handler,
  ...
  virtual Model::AuthorizeCacheSecurityGroupIngressOutcome AuthorizeCacheSecurityGroupIngress(
      const Model::AuthorizeCacheSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for AuthorizeCacheSecurityGroupIngress that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AuthorizeCacheSecurityGroupIngressRequestT = Model::AuthorizeCacheSecurityGroupIngressRequest>
  Model::AuthorizeCacheSecurityGroupIngressOutcomeCallable AuthorizeCacheSecurityGroupIngressCallable(
      const AuthorizeCacheSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::AuthorizeCacheSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for AuthorizeCacheSecurityGroupIngress that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AuthorizeCacheSecurityGroupIngressRequestT = Model::AuthorizeCacheSecurityGroupIngressRequest>
  void AuthorizeCacheSecurityGroupIngressAsync(const AuthorizeCacheSecurityGroupIngressRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchApplyUpdateAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchApplyUpdateAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchApplyUpdateActionRequestT = Model::BatchApplyUpdateActionRequest>
  void BatchApplyUpdateActionAsync(const BatchApplyUpdateActionRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchStopUpdateAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchStopUpdateAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchStopUpdateActionRequestT = Model::BatchStopUpdateActionRequest>
  void BatchStopUpdateActionAsync(const BatchStopUpdateActionRequestT& request, const BatchStopUpdateActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CompleteMigration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CompleteMigration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CompleteMigrationRequestT = Model::CompleteMigrationRequest>
  void CompleteMigrationAsync(const CompleteMigrationRequestT& request, const CompleteMigrationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CopyServerlessCacheSnapshotOutcome CopyServerlessCacheSnapshot(
      const Model::CopyServerlessCacheSnapshotRequest& request) const;

  /**
   * A Callable wrapper for CopyServerlessCacheSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CopyServerlessCacheSnapshotRequestT = Model::CopyServerlessCacheSnapshotRequest>
  Model::CopyServerlessCacheSnapshotOutcomeCallable CopyServerlessCacheSnapshotCallable(
      const CopyServerlessCacheSnapshotRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::CopyServerlessCacheSnapshot, request);
  }

  /**
   * An Async wrapper for CopyServerlessCacheSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CopyServerlessCacheSnapshotRequestT = Model::CopyServerlessCacheSnapshotRequest>
  void CopyServerlessCacheSnapshotAsync(const CopyServerlessCacheSnapshotRequestT& request,
                                        const CopyServerlessCacheSnapshotResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CopySnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CopySnapshotRequestT = Model::CopySnapshotRequest>
  void CopySnapshotAsync(const CopySnapshotRequestT& request, const CopySnapshotResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCacheCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCacheCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCacheClusterRequestT = Model::CreateCacheClusterRequest>
  void CreateCacheClusterAsync(const CreateCacheClusterRequestT& request, const CreateCacheClusterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCacheParameterGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateCacheParameterGroupRequestT = Model::CreateCacheParameterGroupRequest>
  Model::CreateCacheParameterGroupOutcomeCallable CreateCacheParameterGroupCallable(
      const CreateCacheParameterGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::CreateCacheParameterGroup, request);
  }

  /**
   * An Async wrapper for CreateCacheParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCacheParameterGroupRequestT = Model::CreateCacheParameterGroupRequest>
  void CreateCacheParameterGroupAsync(const CreateCacheParameterGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCacheSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCacheSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCacheSecurityGroupRequestT = Model::CreateCacheSecurityGroupRequest>
  void CreateCacheSecurityGroupAsync(const CreateCacheSecurityGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateCacheSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCacheSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCacheSubnetGroupRequestT = Model::CreateCacheSubnetGroupRequest>
  void CreateCacheSubnetGroupAsync(const CreateCacheSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateGlobalReplicationGroupOutcome CreateGlobalReplicationGroup(
      const Model::CreateGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateGlobalReplicationGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateGlobalReplicationGroupRequestT = Model::CreateGlobalReplicationGroupRequest>
  Model::CreateGlobalReplicationGroupOutcomeCallable CreateGlobalReplicationGroupCallable(
      const CreateGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::CreateGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for CreateGlobalReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateGlobalReplicationGroupRequestT = Model::CreateGlobalReplicationGroupRequest>
  void CreateGlobalReplicationGroupAsync(const CreateGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateReplicationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateReplicationGroupRequestT = Model::CreateReplicationGroupRequest>
  void CreateReplicationGroupAsync(const CreateReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateServerlessCache that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateServerlessCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServerlessCacheRequestT = Model::CreateServerlessCacheRequest>
  void CreateServerlessCacheAsync(const CreateServerlessCacheRequestT& request, const CreateServerlessCacheResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateServerlessCacheSnapshotOutcome CreateServerlessCacheSnapshot(
      const Model::CreateServerlessCacheSnapshotRequest& request) const;

  /**
   * A Callable wrapper for CreateServerlessCacheSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateServerlessCacheSnapshotRequestT = Model::CreateServerlessCacheSnapshotRequest>
  Model::CreateServerlessCacheSnapshotOutcomeCallable CreateServerlessCacheSnapshotCallable(
      const CreateServerlessCacheSnapshotRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::CreateServerlessCacheSnapshot, request);
  }

  /**
   * An Async wrapper for CreateServerlessCacheSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateServerlessCacheSnapshotRequestT = Model::CreateServerlessCacheSnapshotRequest>
  void CreateServerlessCacheSnapshotAsync(const CreateServerlessCacheSnapshotRequestT& request,
                                          const CreateServerlessCacheSnapshotResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSnapshotRequestT = Model::CreateSnapshotRequest>
  void CreateSnapshotAsync(const CreateSnapshotRequestT& request, const CreateSnapshotResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUserRequestT = Model::CreateUserRequest>
  void CreateUserAsync(const CreateUserRequestT& request, const CreateUserResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUserGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUserGroupRequestT = Model::CreateUserGroupRequest>
  void CreateUserGroupAsync(const CreateUserGroupRequestT& request, const CreateUserGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DecreaseNodeGroupsInGlobalReplicationGroupOutcome DecreaseNodeGroupsInGlobalReplicationGroup(
      const Model::DecreaseNodeGroupsInGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for DecreaseNodeGroupsInGlobalReplicationGroup that returns a future to the operation so that it can be executed in
  ...
  Model::DecreaseNodeGroupsInGlobalReplicationGroupOutcomeCallable DecreaseNodeGroupsInGlobalReplicationGroupCallable(
      const DecreaseNodeGroupsInGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DecreaseNodeGroupsInGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for DecreaseNodeGroupsInGlobalReplicationGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DecreaseNodeGroupsInGlobalReplicationGroupRequestT = Model::DecreaseNodeGroupsInGlobalReplicationGroupRequest>
  void DecreaseNodeGroupsInGlobalReplicationGroupAsync(
      const DecreaseNodeGroupsInGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DecreaseReplicaCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DecreaseReplicaCount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DecreaseReplicaCountRequestT = Model::DecreaseReplicaCountRequest>
  void DecreaseReplicaCountAsync(const DecreaseReplicaCountRequestT& request, const DecreaseReplicaCountResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCacheCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCacheCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCacheClusterRequestT = Model::DeleteCacheClusterRequest>
  void DeleteCacheClusterAsync(const DeleteCacheClusterRequestT& request, const DeleteCacheClusterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCacheParameterGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteCacheParameterGroupRequestT = Model::DeleteCacheParameterGroupRequest>
  Model::DeleteCacheParameterGroupOutcomeCallable DeleteCacheParameterGroupCallable(
      const DeleteCacheParameterGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DeleteCacheParameterGroup, request);
  }

  /**
   * An Async wrapper for DeleteCacheParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCacheParameterGroupRequestT = Model::DeleteCacheParameterGroupRequest>
  void DeleteCacheParameterGroupAsync(const DeleteCacheParameterGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCacheSecurityGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCacheSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCacheSecurityGroupRequestT = Model::DeleteCacheSecurityGroupRequest>
  void DeleteCacheSecurityGroupAsync(const DeleteCacheSecurityGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteCacheSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCacheSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCacheSubnetGroupRequestT = Model::DeleteCacheSubnetGroupRequest>
  void DeleteCacheSubnetGroupAsync(const DeleteCacheSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteGlobalReplicationGroupOutcome DeleteGlobalReplicationGroup(
      const Model::DeleteGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteGlobalReplicationGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteGlobalReplicationGroupRequestT = Model::DeleteGlobalReplicationGroupRequest>
  Model::DeleteGlobalReplicationGroupOutcomeCallable DeleteGlobalReplicationGroupCallable(
      const DeleteGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DeleteGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for DeleteGlobalReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGlobalReplicationGroupRequestT = Model::DeleteGlobalReplicationGroupRequest>
  void DeleteGlobalReplicationGroupAsync(const DeleteGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteReplicationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteReplicationGroupRequestT = Model::DeleteReplicationGroupRequest>
  void DeleteReplicationGroupAsync(const DeleteReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteServerlessCache that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteServerlessCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServerlessCacheRequestT = Model::DeleteServerlessCacheRequest>
  void DeleteServerlessCacheAsync(const DeleteServerlessCacheRequestT& request, const DeleteServerlessCacheResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteServerlessCacheSnapshotOutcome DeleteServerlessCacheSnapshot(
      const Model::DeleteServerlessCacheSnapshotRequest& request) const;

  /**
   * A Callable wrapper for DeleteServerlessCacheSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteServerlessCacheSnapshotRequestT = Model::DeleteServerlessCacheSnapshotRequest>
  Model::DeleteServerlessCacheSnapshotOutcomeCallable DeleteServerlessCacheSnapshotCallable(
      const DeleteServerlessCacheSnapshotRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DeleteServerlessCacheSnapshot, request);
  }

  /**
   * An Async wrapper for DeleteServerlessCacheSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteServerlessCacheSnapshotRequestT = Model::DeleteServerlessCacheSnapshotRequest>
  void DeleteServerlessCacheSnapshotAsync(const DeleteServerlessCacheSnapshotRequestT& request,
                                          const DeleteServerlessCacheSnapshotResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSnapshotRequestT = Model::DeleteSnapshotRequest>
  void DeleteSnapshotAsync(const DeleteSnapshotRequestT& request, const DeleteSnapshotResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteUserRequestT = Model::DeleteUserRequest>
  void DeleteUserAsync(const DeleteUserRequestT& request, const DeleteUserResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteUserGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteUserGroupRequestT = Model::DeleteUserGroupRequest>
  void DeleteUserGroupAsync(const DeleteUserGroupRequestT& request, const DeleteUserGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCacheClusters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCacheClusters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheClustersRequestT = Model::DescribeCacheClustersRequest>
  void DescribeCacheClustersAsync(const DescribeCacheClustersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeCacheClustersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCacheEngineVersionsOutcome DescribeCacheEngineVersions(
      const Model::DescribeCacheEngineVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCacheEngineVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCacheEngineVersionsRequestT = Model::DescribeCacheEngineVersionsRequest>
  Model::DescribeCacheEngineVersionsOutcomeCallable DescribeCacheEngineVersionsCallable(
      const DescribeCacheEngineVersionsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeCacheEngineVersions, request);
  }

  /**
   * An Async wrapper for DescribeCacheEngineVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheEngineVersionsRequestT = Model::DescribeCacheEngineVersionsRequest>
  void DescribeCacheEngineVersionsAsync(const DescribeCacheEngineVersionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeCacheEngineVersionsRequestT& request = {}) const {
  ...
  virtual Model::DescribeCacheParameterGroupsOutcome DescribeCacheParameterGroups(
      const Model::DescribeCacheParameterGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCacheParameterGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCacheParameterGroupsRequestT = Model::DescribeCacheParameterGroupsRequest>
  Model::DescribeCacheParameterGroupsOutcomeCallable DescribeCacheParameterGroupsCallable(
      const DescribeCacheParameterGroupsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeCacheParameterGroups, request);
  }

  /**
   * An Async wrapper for DescribeCacheParameterGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheParameterGroupsRequestT = Model::DescribeCacheParameterGroupsRequest>
  void DescribeCacheParameterGroupsAsync(const DescribeCacheParameterGroupsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeCacheParameterGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeCacheParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCacheParameters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheParametersRequestT = Model::DescribeCacheParametersRequest>
  void DescribeCacheParametersAsync(const DescribeCacheParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCacheSecurityGroupsOutcome DescribeCacheSecurityGroups(
      const Model::DescribeCacheSecurityGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCacheSecurityGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCacheSecurityGroupsRequestT = Model::DescribeCacheSecurityGroupsRequest>
  Model::DescribeCacheSecurityGroupsOutcomeCallable DescribeCacheSecurityGroupsCallable(
      const DescribeCacheSecurityGroupsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeCacheSecurityGroups, request);
  }

  /**
   * An Async wrapper for DescribeCacheSecurityGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheSecurityGroupsRequestT = Model::DescribeCacheSecurityGroupsRequest>
  void DescribeCacheSecurityGroupsAsync(const DescribeCacheSecurityGroupsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeCacheSecurityGroupsRequestT& request = {}) const {
  ...
  virtual Model::DescribeCacheSubnetGroupsOutcome DescribeCacheSubnetGroups(
      const Model::DescribeCacheSubnetGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCacheSubnetGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeCacheSubnetGroupsRequestT = Model::DescribeCacheSubnetGroupsRequest>
  Model::DescribeCacheSubnetGroupsOutcomeCallable DescribeCacheSubnetGroupsCallable(
      const DescribeCacheSubnetGroupsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeCacheSubnetGroups, request);
  }

  /**
   * An Async wrapper for DescribeCacheSubnetGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCacheSubnetGroupsRequestT = Model::DescribeCacheSubnetGroupsRequest>
  void DescribeCacheSubnetGroupsAsync(const DescribeCacheSubnetGroupsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeCacheSubnetGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEngineDefaultParametersOutcome DescribeEngineDefaultParameters(
      const Model::DescribeEngineDefaultParametersRequest& request) const;

  /**
   * A Callable wrapper for DescribeEngineDefaultParameters that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEngineDefaultParametersRequestT = Model::DescribeEngineDefaultParametersRequest>
  Model::DescribeEngineDefaultParametersOutcomeCallable DescribeEngineDefaultParametersCallable(
      const DescribeEngineDefaultParametersRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DescribeEngineDefaultParameters, request);
  }

  /**
   * An Async wrapper for DescribeEngineDefaultParameters that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEngineDefaultParametersRequestT = Model::DescribeEngineDefaultParametersRequest>
  void DescribeEngineDefaultParametersAsync(const DescribeEngineDefaultParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeGlobalReplicationGroupsOutcome DescribeGlobalReplicationGroups(
      const Model::DescribeGlobalReplicationGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeGlobalReplicationGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeGlobalReplicationGroupsRequestT = Model::DescribeGlobalReplicationGroupsRequest>
  Model::DescribeGlobalReplicationGroupsOutcomeCallable DescribeGlobalReplicationGroupsCallable(
      const DescribeGlobalReplicationGroupsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeGlobalReplicationGroups, request);
  }

  /**
   * An Async wrapper for DescribeGlobalReplicationGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeGlobalReplicationGroupsRequestT = Model::DescribeGlobalReplicationGroupsRequest>
  void DescribeGlobalReplicationGroupsAsync(const DescribeGlobalReplicationGroupsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeGlobalReplicationGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationGroupsOutcome DescribeReplicationGroups(
      const Model::DescribeReplicationGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeReplicationGroupsRequestT = Model::DescribeReplicationGroupsRequest>
  Model::DescribeReplicationGroupsOutcomeCallable DescribeReplicationGroupsCallable(
      const DescribeReplicationGroupsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeReplicationGroups, request);
  }

  /**
   * An Async wrapper for DescribeReplicationGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReplicationGroupsRequestT = Model::DescribeReplicationGroupsRequest>
  void DescribeReplicationGroupsAsync(const DescribeReplicationGroupsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeReplicationGroupsRequestT& request = {}) const {
  ...
  virtual Model::DescribeReservedCacheNodesOutcome DescribeReservedCacheNodes(
      const Model::DescribeReservedCacheNodesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedCacheNodes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReservedCacheNodesRequestT = Model::DescribeReservedCacheNodesRequest>
  Model::DescribeReservedCacheNodesOutcomeCallable DescribeReservedCacheNodesCallable(
      const DescribeReservedCacheNodesRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeReservedCacheNodes, request);
  }

  /**
   * An Async wrapper for DescribeReservedCacheNodes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReservedCacheNodesRequestT = Model::DescribeReservedCacheNodesRequest>
  void DescribeReservedCacheNodesAsync(const DescribeReservedCacheNodesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeReservedCacheNodesRequestT& request = {}) const {
  ...
  virtual Model::DescribeReservedCacheNodesOfferingsOutcome DescribeReservedCacheNodesOfferings(
      const Model::DescribeReservedCacheNodesOfferingsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedCacheNodesOfferings that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeReservedCacheNodesOfferingsRequestT = Model::DescribeReservedCacheNodesOfferingsRequest>
  Model::DescribeReservedCacheNodesOfferingsOutcomeCallable DescribeReservedCacheNodesOfferingsCallable(
      const DescribeReservedCacheNodesOfferingsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeReservedCacheNodesOfferings, request);
  }

  /**
   * An Async wrapper for DescribeReservedCacheNodesOfferings that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeReservedCacheNodesOfferingsRequestT = Model::DescribeReservedCacheNodesOfferingsRequest>
  void DescribeReservedCacheNodesOfferingsAsync(const DescribeReservedCacheNodesOfferingsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const DescribeReservedCacheNodesOfferingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeServerlessCacheSnapshotsOutcome DescribeServerlessCacheSnapshots(
      const Model::DescribeServerlessCacheSnapshotsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeServerlessCacheSnapshots that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeServerlessCacheSnapshotsRequestT = Model::DescribeServerlessCacheSnapshotsRequest>
  Model::DescribeServerlessCacheSnapshotsOutcomeCallable DescribeServerlessCacheSnapshotsCallable(
      const DescribeServerlessCacheSnapshotsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeServerlessCacheSnapshots, request);
  }

  /**
   * An Async wrapper for DescribeServerlessCacheSnapshots that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeServerlessCacheSnapshotsRequestT = Model::DescribeServerlessCacheSnapshotsRequest>
  void DescribeServerlessCacheSnapshotsAsync(const DescribeServerlessCacheSnapshotsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeServerlessCacheSnapshotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeServerlessCaches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeServerlessCachesRequestT = Model::DescribeServerlessCachesRequest>
  Model::DescribeServerlessCachesOutcomeCallable DescribeServerlessCachesCallable(
      const DescribeServerlessCachesRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::DescribeServerlessCaches, request);
  }

  /**
   * An Async wrapper for DescribeServerlessCaches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServerlessCachesRequestT = Model::DescribeServerlessCachesRequest>
  void DescribeServerlessCachesAsync(const DescribeServerlessCachesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeServerlessCachesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeServiceUpdates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeServiceUpdates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceUpdatesRequestT = Model::DescribeServiceUpdatesRequest>
  void DescribeServiceUpdatesAsync(const DescribeServiceUpdatesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeServiceUpdatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSnapshots that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSnapshotsRequestT = Model::DescribeSnapshotsRequest>
  void DescribeSnapshotsAsync(const DescribeSnapshotsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeSnapshotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeUpdateActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUpdateActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeUpdateActionsRequestT = Model::DescribeUpdateActionsRequest>
  void DescribeUpdateActionsAsync(const DescribeUpdateActionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeUpdateActionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeUserGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUserGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeUserGroupsRequestT = Model::DescribeUserGroupsRequest>
  void DescribeUserGroupsAsync(const DescribeUserGroupsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeUserGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeUsers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeUsersRequestT = Model::DescribeUsersRequest>
  void DescribeUsersAsync(const DescribeUsersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const DescribeUsersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateGlobalReplicationGroupOutcome DisassociateGlobalReplicationGroup(
      const Model::DisassociateGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for DisassociateGlobalReplicationGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateGlobalReplicationGroupRequestT = Model::DisassociateGlobalReplicationGroupRequest>
  Model::DisassociateGlobalReplicationGroupOutcomeCallable DisassociateGlobalReplicationGroupCallable(
      const DisassociateGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::DisassociateGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for DisassociateGlobalReplicationGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateGlobalReplicationGroupRequestT = Model::DisassociateGlobalReplicationGroupRequest>
  void DisassociateGlobalReplicationGroupAsync(const DisassociateGlobalReplicationGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ExportServerlessCacheSnapshotOutcome ExportServerlessCacheSnapshot(
      const Model::ExportServerlessCacheSnapshotRequest& request) const;

  /**
   * A Callable wrapper for ExportServerlessCacheSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExportServerlessCacheSnapshotRequestT = Model::ExportServerlessCacheSnapshotRequest>
  Model::ExportServerlessCacheSnapshotOutcomeCallable ExportServerlessCacheSnapshotCallable(
      const ExportServerlessCacheSnapshotRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::ExportServerlessCacheSnapshot, request);
  }

  /**
   * An Async wrapper for ExportServerlessCacheSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportServerlessCacheSnapshotRequestT = Model::ExportServerlessCacheSnapshotRequest>
  void ExportServerlessCacheSnapshotAsync(const ExportServerlessCacheSnapshotRequestT& request,
                                          const ExportServerlessCacheSnapshotResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::FailoverGlobalReplicationGroupOutcome FailoverGlobalReplicationGroup(
      const Model::FailoverGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for FailoverGlobalReplicationGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename FailoverGlobalReplicationGroupRequestT = Model::FailoverGlobalReplicationGroupRequest>
  Model::FailoverGlobalReplicationGroupOutcomeCallable FailoverGlobalReplicationGroupCallable(
      const FailoverGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::FailoverGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for FailoverGlobalReplicationGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename FailoverGlobalReplicationGroupRequestT = Model::FailoverGlobalReplicationGroupRequest>
  void FailoverGlobalReplicationGroupAsync(const FailoverGlobalReplicationGroupRequestT& request,
  ...
  virtual Model::IncreaseNodeGroupsInGlobalReplicationGroupOutcome IncreaseNodeGroupsInGlobalReplicationGroup(
      const Model::IncreaseNodeGroupsInGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for IncreaseNodeGroupsInGlobalReplicationGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::IncreaseNodeGroupsInGlobalReplicationGroupOutcomeCallable IncreaseNodeGroupsInGlobalReplicationGroupCallable(
      const IncreaseNodeGroupsInGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::IncreaseNodeGroupsInGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for IncreaseNodeGroupsInGlobalReplicationGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename IncreaseNodeGroupsInGlobalReplicationGroupRequestT = Model::IncreaseNodeGroupsInGlobalReplicationGroupRequest>
  void IncreaseNodeGroupsInGlobalReplicationGroupAsync(
      const IncreaseNodeGroupsInGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for IncreaseReplicaCount that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for IncreaseReplicaCount that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename IncreaseReplicaCountRequestT = Model::IncreaseReplicaCountRequest>
  void IncreaseReplicaCountAsync(const IncreaseReplicaCountRequestT& request, const IncreaseReplicaCountResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAllowedNodeTypeModificationsOutcome ListAllowedNodeTypeModifications(
      const Model::ListAllowedNodeTypeModificationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAllowedNodeTypeModifications that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAllowedNodeTypeModificationsRequestT = Model::ListAllowedNodeTypeModificationsRequest>
  Model::ListAllowedNodeTypeModificationsOutcomeCallable ListAllowedNodeTypeModificationsCallable(
      const ListAllowedNodeTypeModificationsRequestT& request = {}) const {
    return SubmitCallable(&ElastiCacheClient::ListAllowedNodeTypeModifications, request);
  }

  /**
   * An Async wrapper for ListAllowedNodeTypeModifications that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAllowedNodeTypeModificationsRequestT = Model::ListAllowedNodeTypeModificationsRequest>
  void ListAllowedNodeTypeModificationsAsync(const ListAllowedNodeTypeModificationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListAllowedNodeTypeModificationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ModifyCacheCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyCacheCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyCacheClusterRequestT = Model::ModifyCacheClusterRequest>
  void ModifyCacheClusterAsync(const ModifyCacheClusterRequestT& request, const ModifyCacheClusterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyCacheParameterGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyCacheParameterGroupRequestT = Model::ModifyCacheParameterGroupRequest>
  Model::ModifyCacheParameterGroupOutcomeCallable ModifyCacheParameterGroupCallable(
      const ModifyCacheParameterGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::ModifyCacheParameterGroup, request);
  }

  /**
   * An Async wrapper for ModifyCacheParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyCacheParameterGroupRequestT = Model::ModifyCacheParameterGroupRequest>
  void ModifyCacheParameterGroupAsync(const ModifyCacheParameterGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyCacheSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyCacheSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyCacheSubnetGroupRequestT = Model::ModifyCacheSubnetGroupRequest>
  void ModifyCacheSubnetGroupAsync(const ModifyCacheSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyGlobalReplicationGroupOutcome ModifyGlobalReplicationGroup(
      const Model::ModifyGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for ModifyGlobalReplicationGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyGlobalReplicationGroupRequestT = Model::ModifyGlobalReplicationGroupRequest>
  Model::ModifyGlobalReplicationGroupOutcomeCallable ModifyGlobalReplicationGroupCallable(
      const ModifyGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::ModifyGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for ModifyGlobalReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyGlobalReplicationGroupRequestT = Model::ModifyGlobalReplicationGroupRequest>
  void ModifyGlobalReplicationGroupAsync(const ModifyGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyReplicationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyReplicationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyReplicationGroupRequestT = Model::ModifyReplicationGroupRequest>
  void ModifyReplicationGroupAsync(const ModifyReplicationGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyReplicationGroupShardConfigurationOutcome ModifyReplicationGroupShardConfiguration(
      const Model::ModifyReplicationGroupShardConfigurationRequest& request) const;

  /**
   * A Callable wrapper for ModifyReplicationGroupShardConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ModifyReplicationGroupShardConfigurationRequestT = Model::ModifyReplicationGroupShardConfigurationRequest>
  Model::ModifyReplicationGroupShardConfigurationOutcomeCallable ModifyReplicationGroupShardConfigurationCallable(
      const ModifyReplicationGroupShardConfigurationRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::ModifyReplicationGroupShardConfiguration, request);
  }

  /**
   * An Async wrapper for ModifyReplicationGroupShardConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ModifyReplicationGroupShardConfigurationRequestT = Model::ModifyReplicationGroupShardConfigurationRequest>
  void ModifyReplicationGroupShardConfigurationAsync(
      const ModifyReplicationGroupShardConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyServerlessCache that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyServerlessCache that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyServerlessCacheRequestT = Model::ModifyServerlessCacheRequest>
  void ModifyServerlessCacheAsync(const ModifyServerlessCacheRequestT& request, const ModifyServerlessCacheResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyUserRequestT = Model::ModifyUserRequest>
  void ModifyUserAsync(const ModifyUserRequestT& request, const ModifyUserResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyUserGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyUserGroupRequestT = Model::ModifyUserGroupRequest>
  void ModifyUserGroupAsync(const ModifyUserGroupRequestT& request, const ModifyUserGroupResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PurchaseReservedCacheNodesOfferingOutcome PurchaseReservedCacheNodesOffering(
      const Model::PurchaseReservedCacheNodesOfferingRequest& request) const;

  /**
   * A Callable wrapper for PurchaseReservedCacheNodesOffering that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PurchaseReservedCacheNodesOfferingRequestT = Model::PurchaseReservedCacheNodesOfferingRequest>
  Model::PurchaseReservedCacheNodesOfferingOutcomeCallable PurchaseReservedCacheNodesOfferingCallable(
      const PurchaseReservedCacheNodesOfferingRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::PurchaseReservedCacheNodesOffering, request);
  }

  /**
   * An Async wrapper for PurchaseReservedCacheNodesOffering that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PurchaseReservedCacheNodesOfferingRequestT = Model::PurchaseReservedCacheNodesOfferingRequest>
  void PurchaseReservedCacheNodesOfferingAsync(const PurchaseReservedCacheNodesOfferingRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RebalanceSlotsInGlobalReplicationGroupOutcome RebalanceSlotsInGlobalReplicationGroup(
      const Model::RebalanceSlotsInGlobalReplicationGroupRequest& request) const;

  /**
   * A Callable wrapper for RebalanceSlotsInGlobalReplicationGroup that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename RebalanceSlotsInGlobalReplicationGroupRequestT = Model::RebalanceSlotsInGlobalReplicationGroupRequest>
  Model::RebalanceSlotsInGlobalReplicationGroupOutcomeCallable RebalanceSlotsInGlobalReplicationGroupCallable(
      const RebalanceSlotsInGlobalReplicationGroupRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::RebalanceSlotsInGlobalReplicationGroup, request);
  }

  /**
   * An Async wrapper for RebalanceSlotsInGlobalReplicationGroup that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RebalanceSlotsInGlobalReplicationGroupRequestT = Model::RebalanceSlotsInGlobalReplicationGroupRequest>
  void RebalanceSlotsInGlobalReplicationGroupAsync(const RebalanceSlotsInGlobalReplicationGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for RebootCacheCluster that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebootCacheCluster that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebootCacheClusterRequestT = Model::RebootCacheClusterRequest>
  void RebootCacheClusterAsync(const RebootCacheClusterRequestT& request, const RebootCacheClusterResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveTagsFromResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveTagsFromResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveTagsFromResourceRequestT = Model::RemoveTagsFromResourceRequest>
  void RemoveTagsFromResourceAsync(const RemoveTagsFromResourceRequestT& request,
  ...
  /**
   * A Callable wrapper for ResetCacheParameterGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetCacheParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetCacheParameterGroupRequestT = Model::ResetCacheParameterGroupRequest>
  void ResetCacheParameterGroupAsync(const ResetCacheParameterGroupRequestT& request,
  ...
  virtual Model::RevokeCacheSecurityGroupIngressOutcome RevokeCacheSecurityGroupIngress(
      const Model::RevokeCacheSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for RevokeCacheSecurityGroupIngress that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RevokeCacheSecurityGroupIngressRequestT = Model::RevokeCacheSecurityGroupIngressRequest>
  Model::RevokeCacheSecurityGroupIngressOutcomeCallable RevokeCacheSecurityGroupIngressCallable(
      const RevokeCacheSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&ElastiCacheClient::RevokeCacheSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for RevokeCacheSecurityGroupIngress that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RevokeCacheSecurityGroupIngressRequestT = Model::RevokeCacheSecurityGroupIngressRequest>
  void RevokeCacheSecurityGroupIngressAsync(const RevokeCacheSecurityGroupIngressRequestT& request,
  ...
  /**
   * An Async wrapper for TestFailover that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestFailoverRequestT = Model::TestFailoverRequest>
  void TestFailoverAsync(const TestFailoverRequestT& request, const TestFailoverResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TestMigration that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestMigrationRequestT = Model::TestMigrationRequest>
  void TestMigrationAsync(const TestMigrationRequestT& request, const TestMigrationResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
