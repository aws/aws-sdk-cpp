...
class ModifyReplicationGroupShardConfigurationResult {
 public:
  ...
  AWS_ELASTICACHE_API ModifyReplicationGroupShardConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ReplicationGroupT = ReplicationGroup>
  ModifyReplicationGroupShardConfigurationResult& WithReplicationGroup(ReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyReplicationGroupShardConfigurationResult& WithResponseMetadata(ResponseMetadataT&& value) {
