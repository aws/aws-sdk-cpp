...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API ModifyReplicationGroupShardConfigurationResult() = default;
    ...
    template<typename ReplicationGroupT = ReplicationGroup>
    ModifyReplicationGroupShardConfigurationResult& WithReplicationGroup(ReplicationGroupT&& value) { SetReplicationGroup(std::forward<ReplicationGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyReplicationGroupShardConfigurationResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
