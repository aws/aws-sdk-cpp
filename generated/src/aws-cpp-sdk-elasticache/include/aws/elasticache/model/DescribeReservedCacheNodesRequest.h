...
class DescribeReservedCacheNodesRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  void SetReservedCacheNodeId(ReservedCacheNodeIdT&& value) {
    ...
    m_reservedCacheNodeId = std::forward<ReservedCacheNodeIdT>(value);
  }
  template <typename ReservedCacheNodeIdT = Aws::String>
  DescribeReservedCacheNodesRequest& WithReservedCacheNodeId(ReservedCacheNodeIdT&& value) {
    SetReservedCacheNodeId(std::forward<ReservedCacheNodeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeReservedCacheNodesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
