...
class RebalanceSlotsInGlobalReplicationGroupResult {
 public:
  ...
  AWS_ELASTICACHE_API RebalanceSlotsInGlobalReplicationGroupResult& operator=(
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  RebalanceSlotsInGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RebalanceSlotsInGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
