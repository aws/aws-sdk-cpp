...
class LogDeliveryConfiguration {
 public:
  ...
  inline LogDeliveryConfiguration& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  inline LogDeliveryConfiguration& WithDestinationType(DestinationType value) {
  ...
  inline LogDeliveryConfiguration& WithLogFormat(LogFormat value) {
    SetLogFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(LogDeliveryConfigurationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LogDeliveryConfiguration& WithStatus(LogDeliveryConfigurationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
