...
class CacheParameterGroupStatus {
 public:
  ...
  void SetCacheNodeIdsToReboot(CacheNodeIdsToRebootT&& value) {
    ...
    m_cacheNodeIdsToReboot = std::forward<CacheNodeIdsToRebootT>(value);
  }
  template <typename CacheNodeIdsToRebootT = Aws::Vector<Aws::String>>
  CacheParameterGroupStatus& WithCacheNodeIdsToReboot(CacheNodeIdsToRebootT&& value) {
    SetCacheNodeIdsToReboot(std::forward<CacheNodeIdsToRebootT>(value));
    return *this;
  }
  ...
  CacheParameterGroupStatus& AddCacheNodeIdsToReboot(CacheNodeIdsToRebootT&& value) {
    m_cacheNodeIdsToRebootHasBeenSet = true;
    m_cacheNodeIdsToReboot.emplace_back(std::forward<CacheNodeIdsToRebootT>(value));
    return *this;
  }
  ///@}
 private:
