...
class ModifyReplicationGroupShardConfigurationRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline ModifyReplicationGroupShardConfigurationRequest& WithNodeGroupCount(int value) {
  ...
  inline ModifyReplicationGroupShardConfigurationRequest& WithApplyImmediately(bool value) {
  ...
  void SetNodeGroupsToRemove(NodeGroupsToRemoveT&& value) {
    m_nodeGroupsToRemoveHasBeenSet = true;
    m_nodeGroupsToRemove = std::forward<NodeGroupsToRemoveT>(value);
  }
  template <typename NodeGroupsToRemoveT = Aws::Vector<Aws::String>>
  ModifyReplicationGroupShardConfigurationRequest& WithNodeGroupsToRemove(NodeGroupsToRemoveT&& value) {
    SetNodeGroupsToRemove(std::forward<NodeGroupsToRemoveT>(value));
    return *this;
  }
  ...
  ModifyReplicationGroupShardConfigurationRequest& AddNodeGroupsToRemove(NodeGroupsToRemoveT&& value) {
    m_nodeGroupsToRemoveHasBeenSet = true;
    m_nodeGroupsToRemove.emplace_back(std::forward<NodeGroupsToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeGroupsToRetain(NodeGroupsToRetainT&& value) {
    m_nodeGroupsToRetainHasBeenSet = true;
    m_nodeGroupsToRetain = std::forward<NodeGroupsToRetainT>(value);
  }
  template <typename NodeGroupsToRetainT = Aws::Vector<Aws::String>>
  ModifyReplicationGroupShardConfigurationRequest& WithNodeGroupsToRetain(NodeGroupsToRetainT&& value) {
    SetNodeGroupsToRetain(std::forward<NodeGroupsToRetainT>(value));
    return *this;
  }
  ...
  ModifyReplicationGroupShardConfigurationRequest& AddNodeGroupsToRetain(NodeGroupsToRetainT&& value) {
    m_nodeGroupsToRetainHasBeenSet = true;
    m_nodeGroupsToRetain.emplace_back(std::forward<NodeGroupsToRetainT>(value));
    return *this;
  }
  ///@}
 private:
