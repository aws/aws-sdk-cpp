...
class RegionalConfiguration {
 public:
  ...
  template <typename ReplicationGroupIdT = Aws::String>
  RegionalConfiguration& WithReplicationGroupId(ReplicationGroupIdT&& value) {
  ...
  template <typename ReplicationGroupRegionT = Aws::String>
  RegionalConfiguration& WithReplicationGroupRegion(ReplicationGroupRegionT&& value) {
  ...
  void SetReshardingConfiguration(ReshardingConfigurationT&& value) {
    ...
    m_reshardingConfiguration = std::forward<ReshardingConfigurationT>(value);
  }
  template <typename ReshardingConfigurationT = Aws::Vector<ReshardingConfiguration>>
  RegionalConfiguration& WithReshardingConfiguration(ReshardingConfigurationT&& value) {
    SetReshardingConfiguration(std::forward<ReshardingConfigurationT>(value));
    return *this;
  }
  template <typename ReshardingConfigurationT = ReshardingConfiguration>
  RegionalConfiguration& AddReshardingConfiguration(ReshardingConfigurationT&& value) {
    m_reshardingConfigurationHasBeenSet = true;
    m_reshardingConfiguration.emplace_back(std::forward<ReshardingConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
