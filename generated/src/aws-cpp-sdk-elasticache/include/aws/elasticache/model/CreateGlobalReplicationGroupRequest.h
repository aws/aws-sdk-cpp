...
class CreateGlobalReplicationGroupRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  void SetGlobalReplicationGroupIdSuffix(GlobalReplicationGroupIdSuffixT&& value) {
    m_globalReplicationGroupIdSuffixHasBeenSet = true;
    m_globalReplicationGroupIdSuffix = std::forward<GlobalReplicationGroupIdSuffixT>(value);
  }
  template <typename GlobalReplicationGroupIdSuffixT = Aws::String>
  CreateGlobalReplicationGroupRequest& WithGlobalReplicationGroupIdSuffix(GlobalReplicationGroupIdSuffixT&& value) {
    SetGlobalReplicationGroupIdSuffix(std::forward<GlobalReplicationGroupIdSuffixT>(value));
    return *this;
  }
  ///@}
