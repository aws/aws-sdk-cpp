...
namespace Model
{
  ...
  public:
    ...
    inline PendingLogDeliveryConfiguration& WithLogType(LogType value) { SetLogType(value); return *this;}
    ///@}
    ...
    inline PendingLogDeliveryConfiguration& WithDestinationType(DestinationType value) { SetDestinationType(value); return *this;}
    ///@}
    ...
    template<typename DestinationDetailsT = DestinationDetails>
    PendingLogDeliveryConfiguration& WithDestinationDetails(DestinationDetailsT&& value) { SetDestinationDetails(std::forward<DestinationDetailsT>(value)); return *this;}
    ///@}
    ...
    inline PendingLogDeliveryConfiguration& WithLogFormat(LogFormat value) { SetLogFormat(value); return *this;}
    ///@}
  private:
