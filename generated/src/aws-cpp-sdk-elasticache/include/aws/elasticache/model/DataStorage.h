...
class DataStorage {
 public:
  ...
  inline DataStorage& WithMaximum(int value) {
    SetMaximum(value);
    return *this;
  }
  ///@}
  ...
  inline DataStorage& WithMinimum(int value) {
    SetMinimum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(DataStorageUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline DataStorage& WithUnit(DataStorageUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
