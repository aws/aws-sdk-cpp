...
class CacheNodeTypeSpecificParameter {
 public:
  ...
  template <typename ParameterNameT = Aws::String>
  CacheNodeTypeSpecificParameter& WithParameterName(ParameterNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CacheNodeTypeSpecificParameter& WithDescription(DescriptionT&& value) {
  ...
  template <typename SourceT = Aws::String>
  CacheNodeTypeSpecificParameter& WithSource(SourceT&& value) {
  ...
  template <typename DataTypeT = Aws::String>
  CacheNodeTypeSpecificParameter& WithDataType(DataTypeT&& value) {
  ...
  template <typename AllowedValuesT = Aws::String>
  CacheNodeTypeSpecificParameter& WithAllowedValues(AllowedValuesT&& value) {
  ...
  inline CacheNodeTypeSpecificParameter& WithIsModifiable(bool value) {
  ...
  template <typename MinimumEngineVersionT = Aws::String>
  CacheNodeTypeSpecificParameter& WithMinimumEngineVersion(MinimumEngineVersionT&& value) {
  ...
  void SetCacheNodeTypeSpecificValues(CacheNodeTypeSpecificValuesT&& value) {
    m_cacheNodeTypeSpecificValuesHasBeenSet = true;
    m_cacheNodeTypeSpecificValues = std::forward<CacheNodeTypeSpecificValuesT>(value);
  }
  template <typename CacheNodeTypeSpecificValuesT = Aws::Vector<CacheNodeTypeSpecificValue>>
  CacheNodeTypeSpecificParameter& WithCacheNodeTypeSpecificValues(CacheNodeTypeSpecificValuesT&& value) {
    SetCacheNodeTypeSpecificValues(std::forward<CacheNodeTypeSpecificValuesT>(value));
    return *this;
  }
  template <typename CacheNodeTypeSpecificValuesT = CacheNodeTypeSpecificValue>
  CacheNodeTypeSpecificParameter& AddCacheNodeTypeSpecificValues(CacheNodeTypeSpecificValuesT&& value) {
    m_cacheNodeTypeSpecificValuesHasBeenSet = true;
    m_cacheNodeTypeSpecificValues.emplace_back(std::forward<CacheNodeTypeSpecificValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline CacheNodeTypeSpecificParameter& WithChangeType(ChangeType value) {
    SetChangeType(value);
    return *this;
  }
  ///@}
