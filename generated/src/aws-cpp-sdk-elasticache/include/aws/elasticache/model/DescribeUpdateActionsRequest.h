...
class DescribeUpdateActionsRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline DescribeUpdateActionsRequest& AddServiceUpdateStatus(ServiceUpdateStatus value) {
    m_serviceUpdateStatusHasBeenSet = true;
  ...
  void SetServiceUpdateTimeRange(ServiceUpdateTimeRangeT&& value) {
    m_serviceUpdateTimeRangeHasBeenSet = true;
    m_serviceUpdateTimeRange = std::forward<ServiceUpdateTimeRangeT>(value);
  }
  template <typename ServiceUpdateTimeRangeT = TimeRangeFilter>
  DescribeUpdateActionsRequest& WithServiceUpdateTimeRange(ServiceUpdateTimeRangeT&& value) {
    SetServiceUpdateTimeRange(std::forward<ServiceUpdateTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateActionStatus(UpdateActionStatusT&& value) {
    ...
    m_updateActionStatus = std::forward<UpdateActionStatusT>(value);
  }
  template <typename UpdateActionStatusT = Aws::Vector<UpdateActionStatus>>
  DescribeUpdateActionsRequest& WithUpdateActionStatus(UpdateActionStatusT&& value) {
    SetUpdateActionStatus(std::forward<UpdateActionStatusT>(value));
    return *this;
  }
  inline DescribeUpdateActionsRequest& AddUpdateActionStatus(UpdateActionStatus value) {
    m_updateActionStatusHasBeenSet = true;
    m_updateActionStatus.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShowNodeLevelUpdateStatus(bool value) {
    m_showNodeLevelUpdateStatusHasBeenSet = true;
    m_showNodeLevelUpdateStatus = value;
  }
  inline DescribeUpdateActionsRequest& WithShowNodeLevelUpdateStatus(bool value) {
    SetShowNodeLevelUpdateStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeUpdateActionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
