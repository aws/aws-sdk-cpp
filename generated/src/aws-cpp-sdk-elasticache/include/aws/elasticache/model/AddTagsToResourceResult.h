...
class AddTagsToResourceResult {
 public:
  AWS_ELASTICACHE_API AddTagsToResourceResult() = default;
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  AddTagsToResourceResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  AddTagsToResourceResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AddTagsToResourceResult& WithResponseMetadata(ResponseMetadataT&& value) {
