...
class PurchaseReservedCacheNodesOfferingResult {
 public:
  ...
  AWS_ELASTICACHE_API PurchaseReservedCacheNodesOfferingResult& operator=(
  ...
  void SetReservedCacheNode(ReservedCacheNodeT&& value) {
    m_reservedCacheNodeHasBeenSet = true;
    m_reservedCacheNode = std::forward<ReservedCacheNodeT>(value);
  }
  template <typename ReservedCacheNodeT = ReservedCacheNode>
  PurchaseReservedCacheNodesOfferingResult& WithReservedCacheNode(ReservedCacheNodeT&& value) {
    SetReservedCacheNode(std::forward<ReservedCacheNodeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  PurchaseReservedCacheNodesOfferingResult& WithResponseMetadata(ResponseMetadataT&& value) {
