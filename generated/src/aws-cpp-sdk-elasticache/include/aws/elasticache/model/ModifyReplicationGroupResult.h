...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API ModifyReplicationGroupResult() = default;
    ...
    template<typename ReplicationGroupT = ReplicationGroup>
    ModifyReplicationGroupResult& WithReplicationGroup(ReplicationGroupT&& value) { SetReplicationGroup(std::forward<ReplicationGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
