...
class DecreaseNodeGroupsInGlobalReplicationGroupResult {
 public:
  ...
  AWS_ELASTICACHE_API DecreaseNodeGroupsInGlobalReplicationGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  DecreaseNodeGroupsInGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DecreaseNodeGroupsInGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
