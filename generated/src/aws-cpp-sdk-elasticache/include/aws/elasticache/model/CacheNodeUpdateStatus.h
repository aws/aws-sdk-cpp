...
class CacheNodeUpdateStatus {
 public:
  ...
  inline CacheNodeUpdateStatus& WithNodeUpdateStatus(NodeUpdateStatus value) {
  ...
  inline CacheNodeUpdateStatus& WithNodeUpdateInitiatedBy(NodeUpdateInitiatedBy value) {
