...
namespace Model
{
  ...
  public:
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    TimeRangeFilter& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    TimeRangeFilter& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
  private:
