...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API CreateServerlessCacheResult() = default;
    ...
    template<typename ServerlessCacheT = ServerlessCache>
    CreateServerlessCacheResult& WithServerlessCache(ServerlessCacheT&& value) { SetServerlessCache(std::forward<ServerlessCacheT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateServerlessCacheResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
