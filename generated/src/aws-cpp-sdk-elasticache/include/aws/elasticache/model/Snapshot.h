...
class Snapshot {
 public:
  ...
  void SetReplicationGroupDescription(ReplicationGroupDescriptionT&& value) {
    ...
    m_replicationGroupDescription = std::forward<ReplicationGroupDescriptionT>(value);
  }
  template <typename ReplicationGroupDescriptionT = Aws::String>
  Snapshot& WithReplicationGroupDescription(ReplicationGroupDescriptionT&& value) {
    SetReplicationGroupDescription(std::forward<ReplicationGroupDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotStatus(SnapshotStatusT&& value) {
    ...
    m_snapshotStatus = std::forward<SnapshotStatusT>(value);
  }
  template <typename SnapshotStatusT = Aws::String>
  Snapshot& WithSnapshotStatus(SnapshotStatusT&& value) {
    SetSnapshotStatus(std::forward<SnapshotStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnapshotSource(SnapshotSourceT&& value) {
    ...
    m_snapshotSource = std::forward<SnapshotSourceT>(value);
  }
  template <typename SnapshotSourceT = Aws::String>
  Snapshot& WithSnapshotSource(SnapshotSourceT&& value) {
    SetSnapshotSource(std::forward<SnapshotSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheNodeType(CacheNodeTypeT&& value) {
    ...
    m_cacheNodeType = std::forward<CacheNodeTypeT>(value);
  }
  template <typename CacheNodeTypeT = Aws::String>
  Snapshot& WithCacheNodeType(CacheNodeTypeT&& value) {
    SetCacheNodeType(std::forward<CacheNodeTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumCacheNodes(int value) {
    m_numCacheNodesHasBeenSet = true;
    m_numCacheNodes = value;
  }
  inline Snapshot& WithNumCacheNodes(int value) {
    SetNumCacheNodes(value);
    return *this;
  }
  ///@}
  ...
  void SetPreferredAvailabilityZone(PreferredAvailabilityZoneT&& value) {
    ...
    m_preferredAvailabilityZone = std::forward<PreferredAvailabilityZoneT>(value);
  }
  template <typename PreferredAvailabilityZoneT = Aws::String>
  Snapshot& WithPreferredAvailabilityZone(PreferredAvailabilityZoneT&& value) {
    SetPreferredAvailabilityZone(std::forward<PreferredAvailabilityZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreferredOutpostArn(PreferredOutpostArnT&& value) {
    ...
    m_preferredOutpostArn = std::forward<PreferredOutpostArnT>(value);
  }
  template <typename PreferredOutpostArnT = Aws::String>
  Snapshot& WithPreferredOutpostArn(PreferredOutpostArnT&& value) {
    SetPreferredOutpostArn(std::forward<PreferredOutpostArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheClusterCreateTime(CacheClusterCreateTimeT&& value) {
    ...
    m_cacheClusterCreateTime = std::forward<CacheClusterCreateTimeT>(value);
  }
  template <typename CacheClusterCreateTimeT = Aws::Utils::DateTime>
  Snapshot& WithCacheClusterCreateTime(CacheClusterCreateTimeT&& value) {
    SetCacheClusterCreateTime(std::forward<CacheClusterCreateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline Snapshot& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline Snapshot& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline void SetSnapshotRetentionLimit(int value) {
    m_snapshotRetentionLimitHasBeenSet = true;
    m_snapshotRetentionLimit = value;
  }
  inline Snapshot& WithSnapshotRetentionLimit(int value) {
    SetSnapshotRetentionLimit(value);
    return *this;
  }
  ///@}
  ...
  void SetSnapshotWindow(SnapshotWindowT&& value) {
    ...
    m_snapshotWindow = std::forward<SnapshotWindowT>(value);
  }
  template <typename SnapshotWindowT = Aws::String>
  Snapshot& WithSnapshotWindow(SnapshotWindowT&& value) {
    SetSnapshotWindow(std::forward<SnapshotWindowT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumNodeGroups(int value) {
    m_numNodeGroupsHasBeenSet = true;
    m_numNodeGroups = value;
  }
  inline Snapshot& WithNumNodeGroups(int value) {
    SetNumNodeGroups(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAutomaticFailover(AutomaticFailoverStatus value) {
    m_automaticFailoverHasBeenSet = true;
    m_automaticFailover = value;
  }
  inline Snapshot& WithAutomaticFailover(AutomaticFailoverStatus value) {
    SetAutomaticFailover(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeSnapshots(NodeSnapshotsT&& value) {
    ...
    m_nodeSnapshots = std::forward<NodeSnapshotsT>(value);
  }
  template <typename NodeSnapshotsT = Aws::Vector<NodeSnapshot>>
  Snapshot& WithNodeSnapshots(NodeSnapshotsT&& value) {
    SetNodeSnapshots(std::forward<NodeSnapshotsT>(value));
    return *this;
  }
  template <typename NodeSnapshotsT = NodeSnapshot>
  Snapshot& AddNodeSnapshots(NodeSnapshotsT&& value) {
    m_nodeSnapshotsHasBeenSet = true;
    m_nodeSnapshots.emplace_back(std::forward<NodeSnapshotsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataTiering(DataTieringStatus value) {
    m_dataTieringHasBeenSet = true;
    m_dataTiering = value;
  }
  inline Snapshot& WithDataTiering(DataTieringStatus value) {
    SetDataTiering(value);
    return *this;
  }
  ///@}
 private:
