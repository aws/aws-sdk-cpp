...
class DescribeReservedCacheNodesResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedCacheNodesResult& WithMarker(MarkerT&& value) {
  ...
  void SetReservedCacheNodes(ReservedCacheNodesT&& value) {
    m_reservedCacheNodesHasBeenSet = true;
    m_reservedCacheNodes = std::forward<ReservedCacheNodesT>(value);
  }
  template <typename ReservedCacheNodesT = Aws::Vector<ReservedCacheNode>>
  DescribeReservedCacheNodesResult& WithReservedCacheNodes(ReservedCacheNodesT&& value) {
    SetReservedCacheNodes(std::forward<ReservedCacheNodesT>(value));
    return *this;
  }
  template <typename ReservedCacheNodesT = ReservedCacheNode>
  DescribeReservedCacheNodesResult& AddReservedCacheNodes(ReservedCacheNodesT&& value) {
    m_reservedCacheNodesHasBeenSet = true;
    m_reservedCacheNodes.emplace_back(std::forward<ReservedCacheNodesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedCacheNodesResult& WithResponseMetadata(ResponseMetadataT&& value) {
