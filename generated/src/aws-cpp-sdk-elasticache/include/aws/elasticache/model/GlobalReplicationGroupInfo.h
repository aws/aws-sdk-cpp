...
class GlobalReplicationGroupInfo {
 public:
  ...
  template <typename GlobalReplicationGroupIdT = Aws::String>
  GlobalReplicationGroupInfo& WithGlobalReplicationGroupId(GlobalReplicationGroupIdT&& value) {
  ...
  void SetGlobalReplicationGroupMemberRole(GlobalReplicationGroupMemberRoleT&& value) {
    m_globalReplicationGroupMemberRoleHasBeenSet = true;
    m_globalReplicationGroupMemberRole = std::forward<GlobalReplicationGroupMemberRoleT>(value);
  }
  template <typename GlobalReplicationGroupMemberRoleT = Aws::String>
  GlobalReplicationGroupInfo& WithGlobalReplicationGroupMemberRole(GlobalReplicationGroupMemberRoleT&& value) {
    SetGlobalReplicationGroupMemberRole(std::forward<GlobalReplicationGroupMemberRoleT>(value));
    return *this;
  }
  ///@}
 private:
