...
class DeleteReplicationGroupRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  template <typename ReplicationGroupIdT = Aws::String>
  DeleteReplicationGroupRequest& WithReplicationGroupId(ReplicationGroupIdT&& value) {
  ...
  inline void SetRetainPrimaryCluster(bool value) {
    m_retainPrimaryClusterHasBeenSet = true;
    m_retainPrimaryCluster = value;
  }
  inline DeleteReplicationGroupRequest& WithRetainPrimaryCluster(bool value) {
    SetRetainPrimaryCluster(value);
    return *this;
  }
  ///@}
  ...
  void SetFinalSnapshotIdentifier(FinalSnapshotIdentifierT&& value) {
    m_finalSnapshotIdentifierHasBeenSet = true;
    m_finalSnapshotIdentifier = std::forward<FinalSnapshotIdentifierT>(value);
  }
  template <typename FinalSnapshotIdentifierT = Aws::String>
  DeleteReplicationGroupRequest& WithFinalSnapshotIdentifier(FinalSnapshotIdentifierT&& value) {
    SetFinalSnapshotIdentifier(std::forward<FinalSnapshotIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
