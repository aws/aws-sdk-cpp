...
class ModifyCacheClusterRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline ModifyCacheClusterRequest& WithNumCacheNodes(int value) {
  ...
  void SetCacheNodeIdsToRemove(CacheNodeIdsToRemoveT&& value) {
    ...
    m_cacheNodeIdsToRemove = std::forward<CacheNodeIdsToRemoveT>(value);
  }
  template <typename CacheNodeIdsToRemoveT = Aws::Vector<Aws::String>>
  ModifyCacheClusterRequest& WithCacheNodeIdsToRemove(CacheNodeIdsToRemoveT&& value) {
    SetCacheNodeIdsToRemove(std::forward<CacheNodeIdsToRemoveT>(value));
    return *this;
  }
  ...
  ModifyCacheClusterRequest& AddCacheNodeIdsToRemove(CacheNodeIdsToRemoveT&& value) {
    m_cacheNodeIdsToRemoveHasBeenSet = true;
    m_cacheNodeIdsToRemove.emplace_back(std::forward<CacheNodeIdsToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAZMode(AZMode value) {
    m_aZModeHasBeenSet = true;
    m_aZMode = value;
  }
  inline ModifyCacheClusterRequest& WithAZMode(AZMode value) {
    SetAZMode(value);
    return *this;
  }
  ///@}
  ...
  void SetNewAvailabilityZones(NewAvailabilityZonesT&& value) {
    m_newAvailabilityZonesHasBeenSet = true;
    m_newAvailabilityZones = std::forward<NewAvailabilityZonesT>(value);
  }
  template <typename NewAvailabilityZonesT = Aws::Vector<Aws::String>>
  ModifyCacheClusterRequest& WithNewAvailabilityZones(NewAvailabilityZonesT&& value) {
    SetNewAvailabilityZones(std::forward<NewAvailabilityZonesT>(value));
    return *this;
  }
  ...
  ModifyCacheClusterRequest& AddNewAvailabilityZones(NewAvailabilityZonesT&& value) {
    m_newAvailabilityZonesHasBeenSet = true;
    m_newAvailabilityZones.emplace_back(std::forward<NewAvailabilityZonesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheSecurityGroupNames(CacheSecurityGroupNamesT&& value) {
    m_cacheSecurityGroupNamesHasBeenSet = true;
    m_cacheSecurityGroupNames = std::forward<CacheSecurityGroupNamesT>(value);
  }
  template <typename CacheSecurityGroupNamesT = Aws::Vector<Aws::String>>
  ModifyCacheClusterRequest& WithCacheSecurityGroupNames(CacheSecurityGroupNamesT&& value) {
    SetCacheSecurityGroupNames(std::forward<CacheSecurityGroupNamesT>(value));
    return *this;
  }
  ...
  ModifyCacheClusterRequest& AddCacheSecurityGroupNames(CacheSecurityGroupNamesT&& value) {
    m_cacheSecurityGroupNamesHasBeenSet = true;
    m_cacheSecurityGroupNames.emplace_back(std::forward<CacheSecurityGroupNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyCacheClusterRequest& WithApplyImmediately(bool value) {
  ...
  inline ModifyCacheClusterRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline ModifyCacheClusterRequest& WithSnapshotRetentionLimit(int value) {
  ...
  inline void SetAuthTokenUpdateStrategy(AuthTokenUpdateStrategyType value) {
    m_authTokenUpdateStrategyHasBeenSet = true;
    m_authTokenUpdateStrategy = value;
  }
  inline ModifyCacheClusterRequest& WithAuthTokenUpdateStrategy(AuthTokenUpdateStrategyType value) {
    SetAuthTokenUpdateStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetLogDeliveryConfigurations(LogDeliveryConfigurationsT&& value) {
    ...
    m_logDeliveryConfigurations = std::forward<LogDeliveryConfigurationsT>(value);
  }
  template <typename LogDeliveryConfigurationsT = Aws::Vector<LogDeliveryConfigurationRequest>>
  ModifyCacheClusterRequest& WithLogDeliveryConfigurations(LogDeliveryConfigurationsT&& value) {
    SetLogDeliveryConfigurations(std::forward<LogDeliveryConfigurationsT>(value));
    return *this;
  }
  ...
  ModifyCacheClusterRequest& AddLogDeliveryConfigurations(LogDeliveryConfigurationsT&& value) {
    m_logDeliveryConfigurationsHasBeenSet = true;
    m_logDeliveryConfigurations.emplace_back(std::forward<LogDeliveryConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyCacheClusterRequest& WithIpDiscovery(IpDiscovery value) {
  ...
  void SetScaleConfig(ScaleConfigT&& value) {
    ...
    m_scaleConfig = std::forward<ScaleConfigT>(value);
  }
  template <typename ScaleConfigT = ScaleConfig>
  ModifyCacheClusterRequest& WithScaleConfig(ScaleConfigT&& value) {
    SetScaleConfig(std::forward<ScaleConfigT>(value));
    return *this;
  }
  ///@}
 private:
