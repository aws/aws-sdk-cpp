...
class DecreaseReplicaCountRequest : public ElastiCacheRequest {
 public:
  AWS_ELASTICACHE_API DecreaseReplicaCountRequest() = default;
 ...
 public:
  ...
  template <typename ReplicationGroupIdT = Aws::String>
  DecreaseReplicaCountRequest& WithReplicationGroupId(ReplicationGroupIdT&& value) {
  ...
  inline void SetNewReplicaCount(int value) {
    m_newReplicaCountHasBeenSet = true;
    m_newReplicaCount = value;
  }
  inline DecreaseReplicaCountRequest& WithNewReplicaCount(int value) {
    SetNewReplicaCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReplicaConfigurationT = Aws::Vector<ConfigureShard>>
  DecreaseReplicaCountRequest& WithReplicaConfiguration(ReplicaConfigurationT&& value) {
    SetReplicaConfiguration(std::forward<ReplicaConfigurationT>(value));
    return *this;
  }
  template <typename ReplicaConfigurationT = ConfigureShard>
  DecreaseReplicaCountRequest& AddReplicaConfiguration(ReplicaConfigurationT&& value) {
    m_replicaConfigurationHasBeenSet = true;
    m_replicaConfiguration.emplace_back(std::forward<ReplicaConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ReplicasToRemoveT = Aws::Vector<Aws::String>>
  void SetReplicasToRemove(ReplicasToRemoveT&& value) {
    m_replicasToRemoveHasBeenSet = true;
    m_replicasToRemove = std::forward<ReplicasToRemoveT>(value);
  }
  template <typename ReplicasToRemoveT = Aws::Vector<Aws::String>>
  DecreaseReplicaCountRequest& WithReplicasToRemove(ReplicasToRemoveT&& value) {
    SetReplicasToRemove(std::forward<ReplicasToRemoveT>(value));
    return *this;
  }
  template <typename ReplicasToRemoveT = Aws::String>
  DecreaseReplicaCountRequest& AddReplicasToRemove(ReplicasToRemoveT&& value) {
    m_replicasToRemoveHasBeenSet = true;
    m_replicasToRemove.emplace_back(std::forward<ReplicasToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetApplyImmediately(bool value) {
    m_applyImmediatelyHasBeenSet = true;
    m_applyImmediately = value;
  }
  inline DecreaseReplicaCountRequest& WithApplyImmediately(bool value) {
    SetApplyImmediately(value);
    return *this;
  }
  ///@}
 private:
