...
class DescribeCacheParametersResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeCacheParametersResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  DescribeCacheParametersResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  DescribeCacheParametersResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename CacheNodeTypeSpecificParametersT = Aws::Vector<CacheNodeTypeSpecificParameter>>
  DescribeCacheParametersResult& WithCacheNodeTypeSpecificParameters(CacheNodeTypeSpecificParametersT&& value) {
  ...
  DescribeCacheParametersResult& AddCacheNodeTypeSpecificParameters(CacheNodeTypeSpecificParametersT&& value) {
    m_cacheNodeTypeSpecificParametersHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCacheParametersResult& WithResponseMetadata(ResponseMetadataT&& value) {
