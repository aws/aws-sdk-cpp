 ...
 * your ElastiCache resources. When you add or remove tags on replication groups,
 * those actions will be replicated to all nodes in the replication group. A tag
 * with a null Value is permitted.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/elasticache-2015-02-02/Tag">AWS API
 * Reference</a></p>
 */
class Tag {
 public:
  AWS_ELASTICACHE_API Tag() = default;
