...
class DescribeReservedCacheNodesOfferingsResult {
 public:
  ...
  AWS_ELASTICACHE_API DescribeReservedCacheNodesOfferingsResult& operator=(
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedCacheNodesOfferingsResult& WithMarker(MarkerT&& value) {
  ...
  void SetReservedCacheNodesOfferings(ReservedCacheNodesOfferingsT&& value) {
    m_reservedCacheNodesOfferingsHasBeenSet = true;
    m_reservedCacheNodesOfferings = std::forward<ReservedCacheNodesOfferingsT>(value);
  }
  template <typename ReservedCacheNodesOfferingsT = Aws::Vector<ReservedCacheNodesOffering>>
  DescribeReservedCacheNodesOfferingsResult& WithReservedCacheNodesOfferings(ReservedCacheNodesOfferingsT&& value) {
    SetReservedCacheNodesOfferings(std::forward<ReservedCacheNodesOfferingsT>(value));
    return *this;
  }
  template <typename ReservedCacheNodesOfferingsT = ReservedCacheNodesOffering>
  DescribeReservedCacheNodesOfferingsResult& AddReservedCacheNodesOfferings(ReservedCacheNodesOfferingsT&& value) {
    m_reservedCacheNodesOfferingsHasBeenSet = true;
    m_reservedCacheNodesOfferings.emplace_back(std::forward<ReservedCacheNodesOfferingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedCacheNodesOfferingsResult& WithResponseMetadata(ResponseMetadataT&& value) {
