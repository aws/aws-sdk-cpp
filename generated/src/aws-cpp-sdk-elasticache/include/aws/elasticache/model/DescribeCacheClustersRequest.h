...
class DescribeCacheClustersRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline DescribeCacheClustersRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShowCacheNodeInfo(bool value) {
    m_showCacheNodeInfoHasBeenSet = true;
    m_showCacheNodeInfo = value;
  }
  inline DescribeCacheClustersRequest& WithShowCacheNodeInfo(bool value) {
  ...
  inline void SetShowCacheClustersNotInReplicationGroups(bool value) {
    m_showCacheClustersNotInReplicationGroupsHasBeenSet = true;
    m_showCacheClustersNotInReplicationGroups = value;
  }
  inline DescribeCacheClustersRequest& WithShowCacheClustersNotInReplicationGroups(bool value) {
    SetShowCacheClustersNotInReplicationGroups(value);
    return *this;
  }
  ///@}
 private:
