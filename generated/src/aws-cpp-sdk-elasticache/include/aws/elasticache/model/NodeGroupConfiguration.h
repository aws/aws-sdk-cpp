...
class NodeGroupConfiguration {
 public:
  ...
  inline NodeGroupConfiguration& WithReplicaCount(int value) {
  ...
  void SetPrimaryAvailabilityZone(PrimaryAvailabilityZoneT&& value) {
    ...
    m_primaryAvailabilityZone = std::forward<PrimaryAvailabilityZoneT>(value);
  }
  template <typename PrimaryAvailabilityZoneT = Aws::String>
  NodeGroupConfiguration& WithPrimaryAvailabilityZone(PrimaryAvailabilityZoneT&& value) {
    SetPrimaryAvailabilityZone(std::forward<PrimaryAvailabilityZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplicaAvailabilityZones(ReplicaAvailabilityZonesT&& value) {
    ...
    m_replicaAvailabilityZones = std::forward<ReplicaAvailabilityZonesT>(value);
  }
  template <typename ReplicaAvailabilityZonesT = Aws::Vector<Aws::String>>
  NodeGroupConfiguration& WithReplicaAvailabilityZones(ReplicaAvailabilityZonesT&& value) {
    SetReplicaAvailabilityZones(std::forward<ReplicaAvailabilityZonesT>(value));
    return *this;
  }
  ...
  NodeGroupConfiguration& AddReplicaAvailabilityZones(ReplicaAvailabilityZonesT&& value) {
    m_replicaAvailabilityZonesHasBeenSet = true;
    m_replicaAvailabilityZones.emplace_back(std::forward<ReplicaAvailabilityZonesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrimaryOutpostArn(PrimaryOutpostArnT&& value) {
    ...
    m_primaryOutpostArn = std::forward<PrimaryOutpostArnT>(value);
  }
  template <typename PrimaryOutpostArnT = Aws::String>
  NodeGroupConfiguration& WithPrimaryOutpostArn(PrimaryOutpostArnT&& value) {
    SetPrimaryOutpostArn(std::forward<PrimaryOutpostArnT>(value));
    return *this;
  }
  ///@}
