...
class CreateCacheSecurityGroupResult {
 public:
  ...
  template <typename CacheSecurityGroupT = CacheSecurityGroup>
  CreateCacheSecurityGroupResult& WithCacheSecurityGroup(CacheSecurityGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateCacheSecurityGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
