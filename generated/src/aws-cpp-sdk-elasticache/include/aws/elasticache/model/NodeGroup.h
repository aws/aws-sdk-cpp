...
class NodeGroup {
 public:
  ...
  void SetPrimaryEndpoint(PrimaryEndpointT&& value) {
    ...
    m_primaryEndpoint = std::forward<PrimaryEndpointT>(value);
  }
  template <typename PrimaryEndpointT = Endpoint>
  NodeGroup& WithPrimaryEndpoint(PrimaryEndpointT&& value) {
    SetPrimaryEndpoint(std::forward<PrimaryEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeGroupMembers(NodeGroupMembersT&& value) {
    ...
    m_nodeGroupMembers = std::forward<NodeGroupMembersT>(value);
  }
  template <typename NodeGroupMembersT = Aws::Vector<NodeGroupMember>>
  NodeGroup& WithNodeGroupMembers(NodeGroupMembersT&& value) {
    SetNodeGroupMembers(std::forward<NodeGroupMembersT>(value));
    return *this;
  }
  template <typename NodeGroupMembersT = NodeGroupMember>
  NodeGroup& AddNodeGroupMembers(NodeGroupMembersT&& value) {
    m_nodeGroupMembersHasBeenSet = true;
    m_nodeGroupMembers.emplace_back(std::forward<NodeGroupMembersT>(value));
    return *this;
  }
  ///@}
 private:
