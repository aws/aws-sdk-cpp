...
class DescribeCacheParameterGroupsResult {
 public:
  ...
  AWS_ELASTICACHE_API DescribeCacheParameterGroupsResult& operator=(
  ...
  void SetCacheParameterGroups(CacheParameterGroupsT&& value) {
    ...
    m_cacheParameterGroups = std::forward<CacheParameterGroupsT>(value);
  }
  template <typename CacheParameterGroupsT = Aws::Vector<CacheParameterGroup>>
  DescribeCacheParameterGroupsResult& WithCacheParameterGroups(CacheParameterGroupsT&& value) {
    SetCacheParameterGroups(std::forward<CacheParameterGroupsT>(value));
    return *this;
  }
  ...
  DescribeCacheParameterGroupsResult& AddCacheParameterGroups(CacheParameterGroupsT&& value) {
    m_cacheParameterGroupsHasBeenSet = true;
    m_cacheParameterGroups.emplace_back(std::forward<CacheParameterGroupsT>(value));
    return *this;
  }
  ///@}
