...
class DescribeCacheEngineVersionsResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeCacheEngineVersionsResult& WithMarker(MarkerT&& value) {
  ...
  void SetCacheEngineVersions(CacheEngineVersionsT&& value) {
    m_cacheEngineVersionsHasBeenSet = true;
    m_cacheEngineVersions = std::forward<CacheEngineVersionsT>(value);
  }
  template <typename CacheEngineVersionsT = Aws::Vector<CacheEngineVersion>>
  DescribeCacheEngineVersionsResult& WithCacheEngineVersions(CacheEngineVersionsT&& value) {
    SetCacheEngineVersions(std::forward<CacheEngineVersionsT>(value));
    return *this;
  }
  template <typename CacheEngineVersionsT = CacheEngineVersion>
  DescribeCacheEngineVersionsResult& AddCacheEngineVersions(CacheEngineVersionsT&& value) {
    m_cacheEngineVersionsHasBeenSet = true;
    m_cacheEngineVersions.emplace_back(std::forward<CacheEngineVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCacheEngineVersionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
