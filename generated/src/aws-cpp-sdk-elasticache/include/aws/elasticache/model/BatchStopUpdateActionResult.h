...
class BatchStopUpdateActionResult {
 public:
  ...
  template <typename ProcessedUpdateActionsT = Aws::Vector<ProcessedUpdateAction>>
  BatchStopUpdateActionResult& WithProcessedUpdateActions(ProcessedUpdateActionsT&& value) {
  ...
  BatchStopUpdateActionResult& AddProcessedUpdateActions(ProcessedUpdateActionsT&& value) {
    m_processedUpdateActionsHasBeenSet = true;
  ...
  template <typename UnprocessedUpdateActionsT = Aws::Vector<UnprocessedUpdateAction>>
  BatchStopUpdateActionResult& WithUnprocessedUpdateActions(UnprocessedUpdateActionsT&& value) {
  ...
  BatchStopUpdateActionResult& AddUnprocessedUpdateActions(UnprocessedUpdateActionsT&& value) {
    m_unprocessedUpdateActionsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  BatchStopUpdateActionResult& WithResponseMetadata(ResponseMetadataT&& value) {
