...
class CreateReplicationGroupRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline CreateReplicationGroupRequest& WithAutomaticFailoverEnabled(bool value) {
  ...
  inline CreateReplicationGroupRequest& WithMultiAZEnabled(bool value) {
  ...
  inline void SetNumCacheClusters(int value) {
    m_numCacheClustersHasBeenSet = true;
    m_numCacheClusters = value;
  }
  inline CreateReplicationGroupRequest& WithNumCacheClusters(int value) {
    SetNumCacheClusters(value);
    return *this;
  }
  ///@}
  ...
  void SetPreferredCacheClusterAZs(PreferredCacheClusterAZsT&& value) {
    m_preferredCacheClusterAZsHasBeenSet = true;
    m_preferredCacheClusterAZs = std::forward<PreferredCacheClusterAZsT>(value);
  }
  template <typename PreferredCacheClusterAZsT = Aws::Vector<Aws::String>>
  CreateReplicationGroupRequest& WithPreferredCacheClusterAZs(PreferredCacheClusterAZsT&& value) {
    SetPreferredCacheClusterAZs(std::forward<PreferredCacheClusterAZsT>(value));
    return *this;
  }
  ...
  CreateReplicationGroupRequest& AddPreferredCacheClusterAZs(PreferredCacheClusterAZsT&& value) {
    m_preferredCacheClusterAZsHasBeenSet = true;
    m_preferredCacheClusterAZs.emplace_back(std::forward<PreferredCacheClusterAZsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateReplicationGroupRequest& WithNumNodeGroups(int value) {
  ...
  inline void SetReplicasPerNodeGroup(int value) {
    m_replicasPerNodeGroupHasBeenSet = true;
    m_replicasPerNodeGroup = value;
  }
  inline CreateReplicationGroupRequest& WithReplicasPerNodeGroup(int value) {
    SetReplicasPerNodeGroup(value);
    return *this;
  }
  ///@}
  ...
  CreateReplicationGroupRequest& AddNodeGroupConfiguration(NodeGroupConfigurationT&& value) {
    m_nodeGroupConfigurationHasBeenSet = true;
    m_nodeGroupConfiguration.emplace_back(std::forward<NodeGroupConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateReplicationGroupRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateReplicationGroupRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline CreateReplicationGroupRequest& WithSnapshotRetentionLimit(int value) {
  ...
  inline CreateReplicationGroupRequest& WithTransitEncryptionEnabled(bool value) {
  ...
  inline CreateReplicationGroupRequest& WithAtRestEncryptionEnabled(bool value) {
  ...
  inline void SetDataTieringEnabled(bool value) {
    m_dataTieringEnabledHasBeenSet = true;
    m_dataTieringEnabled = value;
  }
  inline CreateReplicationGroupRequest& WithDataTieringEnabled(bool value) {
    SetDataTieringEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline CreateReplicationGroupRequest& WithNetworkType(NetworkType value) {
  ...
  inline CreateReplicationGroupRequest& WithIpDiscovery(IpDiscovery value) {
  ...
  inline CreateReplicationGroupRequest& WithTransitEncryptionMode(TransitEncryptionMode value) {
  ...
  inline CreateReplicationGroupRequest& WithClusterMode(ClusterMode value) {
