...
class IncreaseNodeGroupsInGlobalReplicationGroupResult {
 public:
  AWS_ELASTICACHE_API IncreaseNodeGroupsInGlobalReplicationGroupResult() = default;
  AWS_ELASTICACHE_API IncreaseNodeGroupsInGlobalReplicationGroupResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_ELASTICACHE_API IncreaseNodeGroupsInGlobalReplicationGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  IncreaseNodeGroupsInGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  IncreaseNodeGroupsInGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
