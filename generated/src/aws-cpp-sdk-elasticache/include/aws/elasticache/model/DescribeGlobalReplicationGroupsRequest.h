...
class DescribeGlobalReplicationGroupsRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline DescribeGlobalReplicationGroupsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShowMemberInfo(bool value) {
    m_showMemberInfoHasBeenSet = true;
    m_showMemberInfo = value;
  }
  inline DescribeGlobalReplicationGroupsRequest& WithShowMemberInfo(bool value) {
    SetShowMemberInfo(value);
    return *this;
  }
  ///@}
 private:
