...
class ModifyReplicationGroupRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  void SetSnapshottingClusterId(SnapshottingClusterIdT&& value) {
    ...
    m_snapshottingClusterId = std::forward<SnapshottingClusterIdT>(value);
  }
  template <typename SnapshottingClusterIdT = Aws::String>
  ModifyReplicationGroupRequest& WithSnapshottingClusterId(SnapshottingClusterIdT&& value) {
    SetSnapshottingClusterId(std::forward<SnapshottingClusterIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyReplicationGroupRequest& WithAutomaticFailoverEnabled(bool value) {
  ...
  inline void SetMultiAZEnabled(bool value) {
    m_multiAZEnabledHasBeenSet = true;
    m_multiAZEnabled = value;
  }
  inline ModifyReplicationGroupRequest& WithMultiAZEnabled(bool value) {
    SetMultiAZEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyReplicationGroupRequest& WithApplyImmediately(bool value) {
  ...
  inline ModifyReplicationGroupRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline ModifyReplicationGroupRequest& WithSnapshotRetentionLimit(int value) {
  ...
  inline ModifyReplicationGroupRequest& WithAuthTokenUpdateStrategy(AuthTokenUpdateStrategyType value) {
  ...
  inline void SetRemoveUserGroups(bool value) {
    m_removeUserGroupsHasBeenSet = true;
    m_removeUserGroups = value;
  }
  inline ModifyReplicationGroupRequest& WithRemoveUserGroups(bool value) {
    SetRemoveUserGroups(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyReplicationGroupRequest& WithIpDiscovery(IpDiscovery value) {
  ...
  inline ModifyReplicationGroupRequest& WithTransitEncryptionEnabled(bool value) {
  ...
  inline ModifyReplicationGroupRequest& WithTransitEncryptionMode(TransitEncryptionMode value) {
  ...
  inline ModifyReplicationGroupRequest& WithClusterMode(ClusterMode value) {
