...
class EngineDefaults {
 public:
   ...
   */
  inline const Aws::Vector<CacheNodeTypeSpecificParameter>& GetCacheNodeTypeSpecificParameters() const {
    return m_cacheNodeTypeSpecificParameters;
  }
  ...
  void SetCacheNodeTypeSpecificParameters(CacheNodeTypeSpecificParametersT&& value) {
    ...
    m_cacheNodeTypeSpecificParameters = std::forward<CacheNodeTypeSpecificParametersT>(value);
  }
  template <typename CacheNodeTypeSpecificParametersT = Aws::Vector<CacheNodeTypeSpecificParameter>>
  EngineDefaults& WithCacheNodeTypeSpecificParameters(CacheNodeTypeSpecificParametersT&& value) {
    SetCacheNodeTypeSpecificParameters(std::forward<CacheNodeTypeSpecificParametersT>(value));
    return *this;
  }
  ...
  EngineDefaults& AddCacheNodeTypeSpecificParameters(CacheNodeTypeSpecificParametersT&& value) {
    m_cacheNodeTypeSpecificParametersHasBeenSet = true;
    m_cacheNodeTypeSpecificParameters.emplace_back(std::forward<CacheNodeTypeSpecificParametersT>(value));
    return *this;
  }
  ///@}
 private:
