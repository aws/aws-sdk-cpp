...
class DeleteGlobalReplicationGroupResult {
 public:
  ...
  AWS_ELASTICACHE_API DeleteGlobalReplicationGroupResult& operator=(
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  DeleteGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
