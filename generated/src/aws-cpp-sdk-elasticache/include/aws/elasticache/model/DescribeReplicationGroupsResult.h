...
class DescribeReplicationGroupsResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeReplicationGroupsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ReplicationGroupsT = Aws::Vector<ReplicationGroup>>
  DescribeReplicationGroupsResult& WithReplicationGroups(ReplicationGroupsT&& value) {
    SetReplicationGroups(std::forward<ReplicationGroupsT>(value));
    return *this;
  }
  template <typename ReplicationGroupsT = ReplicationGroup>
  DescribeReplicationGroupsResult& AddReplicationGroups(ReplicationGroupsT&& value) {
    m_replicationGroupsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReplicationGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
