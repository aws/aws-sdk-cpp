...
class LogDeliveryConfigurationRequest {
 public:
  ...
  inline LogDeliveryConfigurationRequest& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  inline LogDeliveryConfigurationRequest& WithDestinationType(DestinationType value) {
  ...
  inline LogDeliveryConfigurationRequest& WithLogFormat(LogFormat value) {
    SetLogFormat(value);
    return *this;
  }
  ///@}
  ...
  inline LogDeliveryConfigurationRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
