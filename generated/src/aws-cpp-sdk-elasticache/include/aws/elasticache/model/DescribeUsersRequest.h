...
class DescribeUsersRequest : public ElastiCacheRequest {
 public:
  AWS_ELASTICACHE_API DescribeUsersRequest() = default;
 ...
 public:
  ...
  template <typename EngineT = Aws::String>
  DescribeUsersRequest& WithEngine(EngineT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  DescribeUsersRequest& WithUserId(UserIdT&& value) {
  ...
  inline DescribeUsersRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
