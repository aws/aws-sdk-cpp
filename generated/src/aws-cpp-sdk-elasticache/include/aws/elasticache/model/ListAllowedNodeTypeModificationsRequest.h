...
class ListAllowedNodeTypeModificationsRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  template <typename CacheClusterIdT = Aws::String>
  ListAllowedNodeTypeModificationsRequest& WithCacheClusterId(CacheClusterIdT&& value) {
  ...
  template <typename ReplicationGroupIdT = Aws::String>
  ListAllowedNodeTypeModificationsRequest& WithReplicationGroupId(ReplicationGroupIdT&& value) {
