...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API StartMigrationResult() = default;
    ...
    template<typename ReplicationGroupT = ReplicationGroup>
    StartMigrationResult& WithReplicationGroup(ReplicationGroupT&& value) { SetReplicationGroup(std::forward<ReplicationGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    StartMigrationResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
