...
class FailoverGlobalReplicationGroupResult {
 public:
  ...
  AWS_ELASTICACHE_API FailoverGlobalReplicationGroupResult& operator=(
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  FailoverGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  FailoverGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
