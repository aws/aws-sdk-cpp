...
class DeleteGlobalReplicationGroupRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline void SetRetainPrimaryReplicationGroup(bool value) {
    m_retainPrimaryReplicationGroupHasBeenSet = true;
    m_retainPrimaryReplicationGroup = value;
  }
  inline DeleteGlobalReplicationGroupRequest& WithRetainPrimaryReplicationGroup(bool value) {
    SetRetainPrimaryReplicationGroup(value);
    return *this;
  }
  ///@}
 private:
