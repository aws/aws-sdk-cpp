...
class DescribeCacheClustersResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeCacheClustersResult& WithMarker(MarkerT&& value) {
  ...
  void SetCacheClusters(CacheClustersT&& value) {
    m_cacheClustersHasBeenSet = true;
    m_cacheClusters = std::forward<CacheClustersT>(value);
  }
  template <typename CacheClustersT = Aws::Vector<CacheCluster>>
  DescribeCacheClustersResult& WithCacheClusters(CacheClustersT&& value) {
    SetCacheClusters(std::forward<CacheClustersT>(value));
    return *this;
  }
  template <typename CacheClustersT = CacheCluster>
  DescribeCacheClustersResult& AddCacheClusters(CacheClustersT&& value) {
    m_cacheClustersHasBeenSet = true;
    m_cacheClusters.emplace_back(std::forward<CacheClustersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCacheClustersResult& WithResponseMetadata(ResponseMetadataT&& value) {
