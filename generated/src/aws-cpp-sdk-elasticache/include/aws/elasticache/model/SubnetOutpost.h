...
class SubnetOutpost {
 public:
  ...
  void SetSubnetOutpostArn(SubnetOutpostArnT&& value) {
    m_subnetOutpostArnHasBeenSet = true;
    m_subnetOutpostArn = std::forward<SubnetOutpostArnT>(value);
  }
  template <typename SubnetOutpostArnT = Aws::String>
  SubnetOutpost& WithSubnetOutpostArn(SubnetOutpostArnT&& value) {
    SetSubnetOutpostArn(std::forward<SubnetOutpostArnT>(value));
    return *this;
  }
  ///@}
 private:
