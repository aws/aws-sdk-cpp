...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API AuthorizeCacheSecurityGroupIngressResult() = default;
    ...
    template<typename CacheSecurityGroupT = CacheSecurityGroup>
    AuthorizeCacheSecurityGroupIngressResult& WithCacheSecurityGroup(CacheSecurityGroupT&& value) { SetCacheSecurityGroup(std::forward<CacheSecurityGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    AuthorizeCacheSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
