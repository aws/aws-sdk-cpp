...
class AuthorizeCacheSecurityGroupIngressResult {
 public:
  ...
  AWS_ELASTICACHE_API AuthorizeCacheSecurityGroupIngressResult& operator=(
  ...
  template <typename CacheSecurityGroupT = CacheSecurityGroup>
  AuthorizeCacheSecurityGroupIngressResult& WithCacheSecurityGroup(CacheSecurityGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AuthorizeCacheSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadataT&& value) {
