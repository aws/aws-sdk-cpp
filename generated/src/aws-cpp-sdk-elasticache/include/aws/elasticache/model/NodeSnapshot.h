...
class NodeSnapshot {
 public:
  ...
  void SetNodeGroupConfiguration(NodeGroupConfigurationT&& value) {
    ...
    m_nodeGroupConfiguration = std::forward<NodeGroupConfigurationT>(value);
  }
  template <typename NodeGroupConfigurationT = NodeGroupConfiguration>
  NodeSnapshot& WithNodeGroupConfiguration(NodeGroupConfigurationT&& value) {
    SetNodeGroupConfiguration(std::forward<NodeGroupConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheSize(CacheSizeT&& value) {
    ...
    m_cacheSize = std::forward<CacheSizeT>(value);
  }
  template <typename CacheSizeT = Aws::String>
  NodeSnapshot& WithCacheSize(CacheSizeT&& value) {
    SetCacheSize(std::forward<CacheSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCacheNodeCreateTime(CacheNodeCreateTimeT&& value) {
    ...
    m_cacheNodeCreateTime = std::forward<CacheNodeCreateTimeT>(value);
  }
  template <typename CacheNodeCreateTimeT = Aws::Utils::DateTime>
  NodeSnapshot& WithCacheNodeCreateTime(CacheNodeCreateTimeT&& value) {
    SetCacheNodeCreateTime(std::forward<CacheNodeCreateTimeT>(value));
    return *this;
  }
  ///@}
