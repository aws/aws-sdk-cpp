...
class CacheNode {
 public:
  ...
  void SetCacheNodeStatus(CacheNodeStatusT&& value) {
    ...
    m_cacheNodeStatus = std::forward<CacheNodeStatusT>(value);
  }
  template <typename CacheNodeStatusT = Aws::String>
  CacheNode& WithCacheNodeStatus(CacheNodeStatusT&& value) {
    SetCacheNodeStatus(std::forward<CacheNodeStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceCacheNodeId(SourceCacheNodeIdT&& value) {
    ...
    m_sourceCacheNodeId = std::forward<SourceCacheNodeIdT>(value);
  }
  template <typename SourceCacheNodeIdT = Aws::String>
  CacheNode& WithSourceCacheNodeId(SourceCacheNodeIdT&& value) {
    SetSourceCacheNodeId(std::forward<SourceCacheNodeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerAvailabilityZone(CustomerAvailabilityZoneT&& value) {
    ...
    m_customerAvailabilityZone = std::forward<CustomerAvailabilityZoneT>(value);
  }
  template <typename CustomerAvailabilityZoneT = Aws::String>
  CacheNode& WithCustomerAvailabilityZone(CustomerAvailabilityZoneT&& value) {
    SetCustomerAvailabilityZone(std::forward<CustomerAvailabilityZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerOutpostArn(CustomerOutpostArnT&& value) {
    ...
    m_customerOutpostArn = std::forward<CustomerOutpostArnT>(value);
  }
  template <typename CustomerOutpostArnT = Aws::String>
  CacheNode& WithCustomerOutpostArn(CustomerOutpostArnT&& value) {
    SetCustomerOutpostArn(std::forward<CustomerOutpostArnT>(value));
    return *this;
  }
  ///@}
 private:
