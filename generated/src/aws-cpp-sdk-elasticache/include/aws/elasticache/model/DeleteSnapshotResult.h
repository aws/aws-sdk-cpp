...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICACHE_API DeleteSnapshotResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
