...
class TestMigrationResult {
 public:
  AWS_ELASTICACHE_API TestMigrationResult() = default;
  ...
  template <typename ReplicationGroupT = ReplicationGroup>
  TestMigrationResult& WithReplicationGroup(ReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  TestMigrationResult& WithResponseMetadata(ResponseMetadataT&& value) {
