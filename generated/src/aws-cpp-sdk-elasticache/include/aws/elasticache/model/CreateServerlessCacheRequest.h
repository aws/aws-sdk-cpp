...
class CreateServerlessCacheRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  void SetSnapshotArnsToRestore(SnapshotArnsToRestoreT&& value) {
    m_snapshotArnsToRestoreHasBeenSet = true;
    m_snapshotArnsToRestore = std::forward<SnapshotArnsToRestoreT>(value);
  }
  template <typename SnapshotArnsToRestoreT = Aws::Vector<Aws::String>>
  CreateServerlessCacheRequest& WithSnapshotArnsToRestore(SnapshotArnsToRestoreT&& value) {
    SetSnapshotArnsToRestore(std::forward<SnapshotArnsToRestoreT>(value));
    return *this;
  }
  ...
  CreateServerlessCacheRequest& AddSnapshotArnsToRestore(SnapshotArnsToRestoreT&& value) {
    m_snapshotArnsToRestoreHasBeenSet = true;
    m_snapshotArnsToRestore.emplace_back(std::forward<SnapshotArnsToRestoreT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateServerlessCacheRequest& WithSnapshotRetentionLimit(int value) {
