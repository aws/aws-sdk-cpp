...
class NodeGroupMemberUpdateStatus {
 public:
  ...
  inline void SetNodeUpdateStatus(NodeUpdateStatus value) {
    m_nodeUpdateStatusHasBeenSet = true;
    m_nodeUpdateStatus = value;
  }
  inline NodeGroupMemberUpdateStatus& WithNodeUpdateStatus(NodeUpdateStatus value) {
    SetNodeUpdateStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeDeletionDate(NodeDeletionDateT&& value) {
    ...
    m_nodeDeletionDate = std::forward<NodeDeletionDateT>(value);
  }
  template <typename NodeDeletionDateT = Aws::Utils::DateTime>
  NodeGroupMemberUpdateStatus& WithNodeDeletionDate(NodeDeletionDateT&& value) {
    SetNodeDeletionDate(std::forward<NodeDeletionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeUpdateStartDate(NodeUpdateStartDateT&& value) {
    ...
    m_nodeUpdateStartDate = std::forward<NodeUpdateStartDateT>(value);
  }
  template <typename NodeUpdateStartDateT = Aws::Utils::DateTime>
  NodeGroupMemberUpdateStatus& WithNodeUpdateStartDate(NodeUpdateStartDateT&& value) {
    SetNodeUpdateStartDate(std::forward<NodeUpdateStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeUpdateEndDate(NodeUpdateEndDateT&& value) {
    ...
    m_nodeUpdateEndDate = std::forward<NodeUpdateEndDateT>(value);
  }
  template <typename NodeUpdateEndDateT = Aws::Utils::DateTime>
  NodeGroupMemberUpdateStatus& WithNodeUpdateEndDate(NodeUpdateEndDateT&& value) {
    SetNodeUpdateEndDate(std::forward<NodeUpdateEndDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNodeUpdateInitiatedBy(NodeUpdateInitiatedBy value) {
    m_nodeUpdateInitiatedByHasBeenSet = true;
    m_nodeUpdateInitiatedBy = value;
  }
  inline NodeGroupMemberUpdateStatus& WithNodeUpdateInitiatedBy(NodeUpdateInitiatedBy value) {
    SetNodeUpdateInitiatedBy(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeUpdateInitiatedDate(NodeUpdateInitiatedDateT&& value) {
    ...
    m_nodeUpdateInitiatedDate = std::forward<NodeUpdateInitiatedDateT>(value);
  }
  template <typename NodeUpdateInitiatedDateT = Aws::Utils::DateTime>
  NodeGroupMemberUpdateStatus& WithNodeUpdateInitiatedDate(NodeUpdateInitiatedDateT&& value) {
    SetNodeUpdateInitiatedDate(std::forward<NodeUpdateInitiatedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeUpdateStatusModifiedDate(NodeUpdateStatusModifiedDateT&& value) {
    ...
    m_nodeUpdateStatusModifiedDate = std::forward<NodeUpdateStatusModifiedDateT>(value);
  }
  template <typename NodeUpdateStatusModifiedDateT = Aws::Utils::DateTime>
  NodeGroupMemberUpdateStatus& WithNodeUpdateStatusModifiedDate(NodeUpdateStatusModifiedDateT&& value) {
    SetNodeUpdateStatusModifiedDate(std::forward<NodeUpdateStatusModifiedDateT>(value));
    return *this;
  }
  ///@}
 private:
