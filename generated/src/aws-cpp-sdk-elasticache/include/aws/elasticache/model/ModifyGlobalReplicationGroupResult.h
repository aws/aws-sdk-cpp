...
namespace Model
{
  ...
  public:
    ...
    template<typename GlobalReplicationGroupT = GlobalReplicationGroup>
    ModifyGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) { SetGlobalReplicationGroup(std::forward<GlobalReplicationGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
