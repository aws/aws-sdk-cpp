...
class DestinationDetails {
 public:
  ...
  void SetCloudWatchLogsDetails(CloudWatchLogsDetailsT&& value) {
    m_cloudWatchLogsDetailsHasBeenSet = true;
    m_cloudWatchLogsDetails = std::forward<CloudWatchLogsDetailsT>(value);
  }
  template <typename CloudWatchLogsDetailsT = CloudWatchLogsDestinationDetails>
  DestinationDetails& WithCloudWatchLogsDetails(CloudWatchLogsDetailsT&& value) {
    SetCloudWatchLogsDetails(std::forward<CloudWatchLogsDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisFirehoseDetails(KinesisFirehoseDetailsT&& value) {
    m_kinesisFirehoseDetailsHasBeenSet = true;
    m_kinesisFirehoseDetails = std::forward<KinesisFirehoseDetailsT>(value);
  }
  template <typename KinesisFirehoseDetailsT = KinesisFirehoseDestinationDetails>
  DestinationDetails& WithKinesisFirehoseDetails(KinesisFirehoseDetailsT&& value) {
    SetKinesisFirehoseDetails(std::forward<KinesisFirehoseDetailsT>(value));
    return *this;
  }
  ///@}
 private:
