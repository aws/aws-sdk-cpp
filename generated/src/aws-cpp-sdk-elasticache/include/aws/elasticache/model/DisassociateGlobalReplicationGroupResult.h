...
class DisassociateGlobalReplicationGroupResult {
 public:
  ...
  AWS_ELASTICACHE_API DisassociateGlobalReplicationGroupResult& operator=(
  ...
  template <typename GlobalReplicationGroupT = GlobalReplicationGroup>
  DisassociateGlobalReplicationGroupResult& WithGlobalReplicationGroup(GlobalReplicationGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateGlobalReplicationGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
