...
class RevokeCacheSecurityGroupIngressRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  template <typename CacheSecurityGroupNameT = Aws::String>
  RevokeCacheSecurityGroupIngressRequest& WithCacheSecurityGroupName(CacheSecurityGroupNameT&& value) {
  ...
  template <typename EC2SecurityGroupNameT = Aws::String>
  RevokeCacheSecurityGroupIngressRequest& WithEC2SecurityGroupName(EC2SecurityGroupNameT&& value) {
  ...
  template <typename EC2SecurityGroupOwnerIdT = Aws::String>
  RevokeCacheSecurityGroupIngressRequest& WithEC2SecurityGroupOwnerId(EC2SecurityGroupOwnerIdT&& value) {
