...
class DescribeServerlessCachesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeServerlessCachesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ServerlessCachesT = Aws::Vector<ServerlessCache>>
  DescribeServerlessCachesResult& WithServerlessCaches(ServerlessCachesT&& value) {
    SetServerlessCaches(std::forward<ServerlessCachesT>(value));
    return *this;
  }
  template <typename ServerlessCachesT = ServerlessCache>
  DescribeServerlessCachesResult& AddServerlessCaches(ServerlessCachesT&& value) {
    m_serverlessCachesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeServerlessCachesResult& WithResponseMetadata(ResponseMetadataT&& value) {
