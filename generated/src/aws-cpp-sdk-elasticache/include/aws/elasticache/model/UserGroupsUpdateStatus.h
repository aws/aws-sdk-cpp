...
class UserGroupsUpdateStatus {
 public:
  ...
  void SetUserGroupIdsToRemove(UserGroupIdsToRemoveT&& value) {
    ...
    m_userGroupIdsToRemove = std::forward<UserGroupIdsToRemoveT>(value);
  }
  template <typename UserGroupIdsToRemoveT = Aws::Vector<Aws::String>>
  UserGroupsUpdateStatus& WithUserGroupIdsToRemove(UserGroupIdsToRemoveT&& value) {
    SetUserGroupIdsToRemove(std::forward<UserGroupIdsToRemoveT>(value));
    return *this;
  }
  ...
  UserGroupsUpdateStatus& AddUserGroupIdsToRemove(UserGroupIdsToRemoveT&& value) {
    m_userGroupIdsToRemoveHasBeenSet = true;
    m_userGroupIdsToRemove.emplace_back(std::forward<UserGroupIdsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
