...
class CopyServerlessCacheSnapshotRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  void SetSourceServerlessCacheSnapshotName(SourceServerlessCacheSnapshotNameT&& value) {
    m_sourceServerlessCacheSnapshotNameHasBeenSet = true;
    m_sourceServerlessCacheSnapshotName = std::forward<SourceServerlessCacheSnapshotNameT>(value);
  }
  template <typename SourceServerlessCacheSnapshotNameT = Aws::String>
  CopyServerlessCacheSnapshotRequest& WithSourceServerlessCacheSnapshotName(SourceServerlessCacheSnapshotNameT&& value) {
    SetSourceServerlessCacheSnapshotName(std::forward<SourceServerlessCacheSnapshotNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetServerlessCacheSnapshotName(TargetServerlessCacheSnapshotNameT&& value) {
    m_targetServerlessCacheSnapshotNameHasBeenSet = true;
    m_targetServerlessCacheSnapshotName = std::forward<TargetServerlessCacheSnapshotNameT>(value);
  }
  template <typename TargetServerlessCacheSnapshotNameT = Aws::String>
  CopyServerlessCacheSnapshotRequest& WithTargetServerlessCacheSnapshotName(TargetServerlessCacheSnapshotNameT&& value) {
    SetTargetServerlessCacheSnapshotName(std::forward<TargetServerlessCacheSnapshotNameT>(value));
    return *this;
  }
  ///@}
