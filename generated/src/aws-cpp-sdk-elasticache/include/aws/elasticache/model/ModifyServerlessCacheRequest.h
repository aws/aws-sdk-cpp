...
class ModifyServerlessCacheRequest : public ElastiCacheRequest {
 ...
 public:
  ...
  inline void SetRemoveUserGroup(bool value) {
    m_removeUserGroupHasBeenSet = true;
    m_removeUserGroup = value;
  }
  inline ModifyServerlessCacheRequest& WithRemoveUserGroup(bool value) {
    SetRemoveUserGroup(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyServerlessCacheRequest& WithSnapshotRetentionLimit(int value) {
