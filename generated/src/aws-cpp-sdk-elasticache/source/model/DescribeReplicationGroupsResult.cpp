...
DescribeReplicationGroupsResult::DescribeReplicationGroupsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeReplicationGroupsResult& DescribeReplicationGroupsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::DescribeReplicationGroupsResult",
