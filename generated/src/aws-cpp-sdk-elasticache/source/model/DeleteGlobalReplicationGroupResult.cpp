...
DeleteGlobalReplicationGroupResult& DeleteGlobalReplicationGroupResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DeleteGlobalReplicationGroupResult")) {
    resultNode = rootNode.FirstChild("DeleteGlobalReplicationGroupResult");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::DeleteGlobalReplicationGroupResult",
