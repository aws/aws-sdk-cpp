...
DescribeUserGroupsResult::DescribeUserGroupsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeUserGroupsResult& DescribeUserGroupsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!userGroupsNode.IsNull()) {
      ...
      m_userGroupsHasBeenSet = !userGroupsMember.IsNull();
