...
CacheNodeTypeSpecificParameter::CacheNodeTypeSpecificParameter(const XmlNode& xmlNode) { *this = xmlNode; }
...
CacheNodeTypeSpecificParameter& CacheNodeTypeSpecificParameter::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!changeTypeNode.IsNull()) {
      m_changeType = ChangeTypeMapper::GetChangeTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(changeTypeNode.GetText()).c_str()));
...
void CacheNodeTypeSpecificParameter::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_cacheNodeTypeSpecificValuesHasBeenSet) {
    ...
    for (auto& item : m_cacheNodeTypeSpecificValues) {
      ...
      cacheNodeTypeSpecificValuesSs << location << index << locationValue << ".CacheNodeTypeSpecificValues.CacheNodeTypeSpecificValue."
                                    << cacheNodeTypeSpecificValuesIdx++;
  ...
  if (m_changeTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".ChangeType=" << StringUtils::URLEncode(ChangeTypeMapper::GetNameForChangeType(m_changeType)) << "&";
  }
}
...
void CacheNodeTypeSpecificParameter::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_cacheNodeTypeSpecificValuesHasBeenSet) {
    ...
    for (auto& item : m_cacheNodeTypeSpecificValues) {
      Aws::StringStream cacheNodeTypeSpecificValuesSs;
      cacheNodeTypeSpecificValuesSs << location << ".CacheNodeTypeSpecificValues.CacheNodeTypeSpecificValue."
                                    << cacheNodeTypeSpecificValuesIdx++;
      item.OutputToStream(oStream, cacheNodeTypeSpecificValuesSs.str().c_str());
    }
  }
