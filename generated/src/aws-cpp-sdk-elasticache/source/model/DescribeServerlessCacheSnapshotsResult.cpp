...
DescribeServerlessCacheSnapshotsResult& DescribeServerlessCacheSnapshotsResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!serverlessCacheSnapshotsNode.IsNull()) {
      ...
      m_serverlessCacheSnapshotsHasBeenSet = !serverlessCacheSnapshotsMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::DescribeServerlessCacheSnapshotsResult",
