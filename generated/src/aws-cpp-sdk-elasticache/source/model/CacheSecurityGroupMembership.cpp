...
CacheSecurityGroupMembership::CacheSecurityGroupMembership(const XmlNode& xmlNode) { *this = xmlNode; }
...
void CacheSecurityGroupMembership::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
