...
UpdateAction::UpdateAction(const XmlNode& xmlNode) { *this = xmlNode; }
...
UpdateAction& UpdateAction::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!updateActionAvailableDateNode.IsNull()) {
      m_updateActionAvailableDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(updateActionAvailableDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!updateActionStatusModifiedDateNode.IsNull()) {
      m_updateActionStatusModifiedDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(updateActionStatusModifiedDateNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void UpdateAction::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_updateActionAvailableDateHasBeenSet) {
    oStream << location << index << locationValue << ".UpdateActionAvailableDate="
            << StringUtils::URLEncode(m_updateActionAvailableDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_updateActionStatusModifiedDateHasBeenSet) {
    oStream << location << index << locationValue << ".UpdateActionStatusModifiedDate="
            << StringUtils::URLEncode(m_updateActionStatusModifiedDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_nodeGroupUpdateStatusHasBeenSet) {
    ...
    for (auto& item : m_nodeGroupUpdateStatus) {
      ...
      nodeGroupUpdateStatusSs << location << index << locationValue << ".NodeGroupUpdateStatus.NodeGroupUpdateStatus."
                              << nodeGroupUpdateStatusIdx++;
  ...
  if (m_cacheNodeUpdateStatusHasBeenSet) {
    ...
    for (auto& item : m_cacheNodeUpdateStatus) {
      ...
      cacheNodeUpdateStatusSs << location << index << locationValue << ".CacheNodeUpdateStatus.CacheNodeUpdateStatus."
                              << cacheNodeUpdateStatusIdx++;
...
void UpdateAction::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_updateActionAvailableDateHasBeenSet) {
    oStream << location << ".UpdateActionAvailableDate="
            << StringUtils::URLEncode(m_updateActionAvailableDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_updateActionStatusHasBeenSet) {
  ...
  if (m_updateActionStatusModifiedDateHasBeenSet) {
    oStream << location << ".UpdateActionStatusModifiedDate="
            << StringUtils::URLEncode(m_updateActionStatusModifiedDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_slaMetHasBeenSet) {
