...
BatchApplyUpdateActionResult::BatchApplyUpdateActionResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
BatchApplyUpdateActionResult& BatchApplyUpdateActionResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::BatchApplyUpdateActionResult",
