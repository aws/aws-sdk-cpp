...
DecreaseReplicaCountResult::DecreaseReplicaCountResult(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  *this = result;
}
...
DecreaseReplicaCountResult& DecreaseReplicaCountResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "DecreaseReplicaCountResult"))
  {
    resultNode = rootNode.FirstChild("DecreaseReplicaCountResult");
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::DecreaseReplicaCountResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
