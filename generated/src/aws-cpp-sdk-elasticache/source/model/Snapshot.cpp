...
Snapshot& Snapshot::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!numCacheNodesNode.IsNull()) {
      m_numCacheNodes = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numCacheNodesNode.GetText()).c_str()).c_str());
    ...
    if (!cacheClusterCreateTimeNode.IsNull()) {
      m_cacheClusterCreateTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(cacheClusterCreateTimeNode.GetText()).c_str()).c_str(),
    ...
    if (!numNodeGroupsNode.IsNull()) {
      m_numNodeGroups = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(numNodeGroupsNode.GetText()).c_str()).c_str());
...
void Snapshot::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_replicationGroupDescriptionHasBeenSet) {
    oStream << location << index << locationValue
            << ".ReplicationGroupDescription=" << StringUtils::URLEncode(m_replicationGroupDescription.c_str()) << "&";
  }
  ...
  if (m_preferredAvailabilityZoneHasBeenSet) {
    oStream << location << index << locationValue
            << ".PreferredAvailabilityZone=" << StringUtils::URLEncode(m_preferredAvailabilityZone.c_str()) << "&";
  }
  ...
  if (m_cacheClusterCreateTimeHasBeenSet) {
    oStream << location << index << locationValue << ".CacheClusterCreateTime="
            << StringUtils::URLEncode(m_cacheClusterCreateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void Snapshot::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_cacheClusterCreateTimeHasBeenSet) {
    oStream << location << ".CacheClusterCreateTime="
            << StringUtils::URLEncode(m_cacheClusterCreateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_preferredMaintenanceWindowHasBeenSet) {
