...
GlobalReplicationGroupMember::GlobalReplicationGroupMember(const XmlNode& xmlNode) { *this = xmlNode; }
...
GlobalReplicationGroupMember& GlobalReplicationGroupMember::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!automaticFailoverNode.IsNull()) {
      m_automaticFailover = AutomaticFailoverStatusMapper::GetAutomaticFailoverStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(automaticFailoverNode.GetText()).c_str()));
...
void GlobalReplicationGroupMember::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_automaticFailoverHasBeenSet) {
    oStream << location << index << locationValue << ".AutomaticFailover="
            << StringUtils::URLEncode(AutomaticFailoverStatusMapper::GetNameForAutomaticFailoverStatus(m_automaticFailover)) << "&";
  }
...
void GlobalReplicationGroupMember::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_automaticFailoverHasBeenSet) {
    oStream << location << ".AutomaticFailover="
            << StringUtils::URLEncode(AutomaticFailoverStatusMapper::GetNameForAutomaticFailoverStatus(m_automaticFailover)) << "&";
  }
  if (m_statusHasBeenSet) {
