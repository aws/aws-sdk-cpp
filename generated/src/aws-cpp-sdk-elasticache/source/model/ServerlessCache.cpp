...
ServerlessCache::ServerlessCache(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ServerlessCache::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_securityGroupIdsHasBeenSet) {
    ...
    for (auto& item : m_securityGroupIds) {
      oStream << location << index << locationValue << ".SecurityGroupIds.SecurityGroupId." << securityGroupIdsIdx++ << "="
  ...
  if (m_subnetIdsHasBeenSet) {
    ...
    for (auto& item : m_subnetIds) {
      oStream << location << index << locationValue << ".SubnetIds.SubnetId." << subnetIdsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
