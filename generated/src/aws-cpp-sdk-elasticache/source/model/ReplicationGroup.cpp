...
ReplicationGroup::ReplicationGroup(const XmlNode& xmlNode) { *this = xmlNode; }
...
ReplicationGroup& ReplicationGroup::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!multiAZNode.IsNull()) {
      m_multiAZ = MultiAZStatusMapper::GetMultiAZStatusForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(multiAZNode.GetText()).c_str()));
    ...
    if (!snapshotRetentionLimitNode.IsNull()) {
      m_snapshotRetentionLimit = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(snapshotRetentionLimitNode.GetText()).c_str()).c_str());
    ...
    if (!clusterEnabledNode.IsNull()) {
      m_clusterEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(clusterEnabledNode.GetText()).c_str()).c_str());
    ...
    if (!authTokenEnabledNode.IsNull()) {
      m_authTokenEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(authTokenEnabledNode.GetText()).c_str()).c_str());
    ...
    if (!authTokenLastModifiedDateNode.IsNull()) {
      m_authTokenLastModifiedDate =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(authTokenLastModifiedDateNode.GetText()).c_str()).c_str(),
    ...
    if (!atRestEncryptionEnabledNode.IsNull()) {
      m_atRestEncryptionEnabled = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(atRestEncryptionEnabledNode.GetText()).c_str()).c_str());
    ...
    if (!replicationGroupCreateTimeNode.IsNull()) {
      m_replicationGroupCreateTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(replicationGroupCreateTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!dataTieringNode.IsNull()) {
      m_dataTiering = DataTieringStatusMapper::GetDataTieringStatusForName(
    ...
    if (!ipDiscoveryNode.IsNull()) {
      m_ipDiscovery = IpDiscoveryMapper::GetIpDiscoveryForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(ipDiscoveryNode.GetText()).c_str()));
...
void ReplicationGroup::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_memberClustersHasBeenSet) {
    ...
    for (auto& item : m_memberClusters) {
      oStream << location << index << locationValue << ".MemberClusters.ClusterId." << memberClustersIdx++ << "="
  ...
  if (m_multiAZHasBeenSet) {
    oStream << location << index << locationValue
            << ".MultiAZ=" << StringUtils::URLEncode(MultiAZStatusMapper::GetNameForMultiAZStatus(m_multiAZ)) << "&";
  }
  ...
  if (m_authTokenLastModifiedDateHasBeenSet) {
    oStream << location << index << locationValue << ".AuthTokenLastModifiedDate="
            << StringUtils::URLEncode(m_authTokenLastModifiedDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_memberClustersOutpostArnsHasBeenSet) {
    ...
    for (auto& item : m_memberClustersOutpostArns) {
      oStream << location << index << locationValue << ".MemberClustersOutpostArns.ReplicationGroupOutpostArn."
              << memberClustersOutpostArnsIdx++ << "=" << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  ...
  if (m_logDeliveryConfigurationsHasBeenSet) {
    ...
    for (auto& item : m_logDeliveryConfigurations) {
      ...
      logDeliveryConfigurationsSs << location << index << locationValue << ".LogDeliveryConfigurations.LogDeliveryConfiguration."
  ...
  if (m_replicationGroupCreateTimeHasBeenSet) {
    oStream << location << index << locationValue << ".ReplicationGroupCreateTime="
            << StringUtils::URLEncode(m_replicationGroupCreateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_ipDiscoveryHasBeenSet) {
    oStream << location << index << locationValue
            << ".IpDiscovery=" << StringUtils::URLEncode(IpDiscoveryMapper::GetNameForIpDiscovery(m_ipDiscovery)) << "&";
  }
...
void ReplicationGroup::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_authTokenLastModifiedDateHasBeenSet) {
    oStream << location << ".AuthTokenLastModifiedDate="
            << StringUtils::URLEncode(m_authTokenLastModifiedDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_transitEncryptionEnabledHasBeenSet) {
  ...
  if (m_memberClustersOutpostArnsHasBeenSet) {
    unsigned memberClustersOutpostArnsIdx = 1;
    for (auto& item : m_memberClustersOutpostArns) {
      oStream << location << ".MemberClustersOutpostArns.ReplicationGroupOutpostArn." << memberClustersOutpostArnsIdx++ << "="
              << StringUtils::URLEncode(item.c_str()) << "&";
    }
  }
  if (m_kmsKeyIdHasBeenSet) {
  ...
  if (m_replicationGroupCreateTimeHasBeenSet) {
    oStream << location << ".ReplicationGroupCreateTime="
            << StringUtils::URLEncode(m_replicationGroupCreateTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_dataTieringHasBeenSet) {
