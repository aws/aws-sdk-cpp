...
FailoverGlobalReplicationGroupResult& FailoverGlobalReplicationGroupResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::FailoverGlobalReplicationGroupResult",
