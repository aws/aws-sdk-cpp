...
ServerlessCacheConfiguration::ServerlessCacheConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ServerlessCacheConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
