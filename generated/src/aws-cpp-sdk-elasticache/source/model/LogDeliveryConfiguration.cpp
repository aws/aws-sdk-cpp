...
LogDeliveryConfiguration::LogDeliveryConfiguration(const XmlNode& xmlNode) { *this = xmlNode; }
...
LogDeliveryConfiguration& LogDeliveryConfiguration::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = LogDeliveryConfigurationStatusMapper::GetLogDeliveryConfigurationStatusForName(
...
void LogDeliveryConfiguration::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue << ".Status="
            << StringUtils::URLEncode(LogDeliveryConfigurationStatusMapper::GetNameForLogDeliveryConfigurationStatus(m_status)) << "&";
  }
