...
LogDeliveryConfigurationRequest::LogDeliveryConfigurationRequest(const XmlNode& xmlNode) { *this = xmlNode; }
...
void LogDeliveryConfigurationRequest::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
