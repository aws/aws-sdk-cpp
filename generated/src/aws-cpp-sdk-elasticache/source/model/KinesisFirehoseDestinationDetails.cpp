...
KinesisFirehoseDestinationDetails::KinesisFirehoseDestinationDetails(const XmlNode& xmlNode) { *this = xmlNode; }
...
void KinesisFirehoseDestinationDetails::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
