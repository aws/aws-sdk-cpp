...
DescribeGlobalReplicationGroupsResult& DescribeGlobalReplicationGroupsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::ElastiCache::Model::DescribeGlobalReplicationGroupsResult",
