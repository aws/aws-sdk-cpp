...
ReservedCacheNodesOffering::ReservedCacheNodesOffering(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ReservedCacheNodesOffering::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
