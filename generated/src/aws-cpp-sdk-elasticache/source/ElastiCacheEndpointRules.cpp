...
't','i','c','a','c','h','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
's','t','i','c','a','c','h','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* ElastiCacheEndpointRules::GetRulesBlob()
{
