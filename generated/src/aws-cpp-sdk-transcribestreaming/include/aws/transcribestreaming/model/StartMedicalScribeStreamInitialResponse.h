...
class StartMedicalScribeStreamInitialResponse {
 public:
  ...
  inline StartMedicalScribeStreamInitialResponse& WithLanguageCode(MedicalScribeLanguageCode value) {
  ...
  inline StartMedicalScribeStreamInitialResponse& WithMediaSampleRateHertz(int value) {
  ...
  inline StartMedicalScribeStreamInitialResponse& WithMediaEncoding(MedicalScribeMediaEncoding value) {
