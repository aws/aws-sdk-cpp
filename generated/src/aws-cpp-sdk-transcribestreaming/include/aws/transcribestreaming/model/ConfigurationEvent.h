...
class ConfigurationEvent {
 public:
  ...
  template <typename ChannelDefinitionsT = Aws::Vector<ChannelDefinition>>
  ConfigurationEvent& WithChannelDefinitions(ChannelDefinitionsT&& value) {
    SetChannelDefinitions(std::forward<ChannelDefinitionsT>(value));
    return *this;
  }
  template <typename ChannelDefinitionsT = ChannelDefinition>
  ConfigurationEvent& AddChannelDefinitions(ChannelDefinitionsT&& value) {
    m_channelDefinitionsHasBeenSet = true;
  ...
  template <typename PostCallAnalyticsSettingsT = PostCallAnalyticsSettings>
  ConfigurationEvent& WithPostCallAnalyticsSettings(PostCallAnalyticsSettingsT&& value) {
