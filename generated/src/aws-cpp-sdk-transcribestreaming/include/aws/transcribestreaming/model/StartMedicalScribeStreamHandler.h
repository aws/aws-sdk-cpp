...
namespace Model {
enum class StartMedicalScribeStreamEventType { INITIAL_RESPONSE, TRANSCRIPTEVENT, UNKNOWN };
...
class StartMedicalScribeStreamHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const StartMedicalScribeStreamInitialResponse&, const Utils::Event::InitialResponseType)>
 ...
 public:
   ...
   * @param callback
   */
  inline void SetInitialResponseCallbackEx(const StartMedicalScribeStreamInitialResponseCallbackEx& callback) {
  ...
  inline void SetInitialResponseCallback(const StartMedicalScribeStreamInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const StartMedicalScribeStreamInitialResponse& rs, const Utils::Event::InitialResponseType) {
