...
class PointsOfInterest {
 public:
  ...
  void SetTimestampRanges(TimestampRangesT&& value) {
    ...
    m_timestampRanges = std::forward<TimestampRangesT>(value);
  }
  template <typename TimestampRangesT = Aws::Vector<TimestampRange>>
  PointsOfInterest& WithTimestampRanges(TimestampRangesT&& value) {
    SetTimestampRanges(std::forward<TimestampRangesT>(value));
    return *this;
  }
  template <typename TimestampRangesT = TimestampRange>
  PointsOfInterest& AddTimestampRanges(TimestampRangesT&& value) {
    m_timestampRangesHasBeenSet = true;
    m_timestampRanges.emplace_back(std::forward<TimestampRangesT>(value));
    return *this;
  }
  ///@}
 private:
