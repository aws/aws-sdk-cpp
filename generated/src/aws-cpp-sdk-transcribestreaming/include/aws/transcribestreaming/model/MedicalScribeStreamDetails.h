...
class MedicalScribeStreamDetails {
 public:
  ...
  void SetStreamCreatedAt(StreamCreatedAtT&& value) {
    ...
    m_streamCreatedAt = std::forward<StreamCreatedAtT>(value);
  }
  template <typename StreamCreatedAtT = Aws::Utils::DateTime>
  MedicalScribeStreamDetails& WithStreamCreatedAt(StreamCreatedAtT&& value) {
    SetStreamCreatedAt(std::forward<StreamCreatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStreamEndedAt(StreamEndedAtT&& value) {
    ...
    m_streamEndedAt = std::forward<StreamEndedAtT>(value);
  }
  template <typename StreamEndedAtT = Aws::Utils::DateTime>
  MedicalScribeStreamDetails& WithStreamEndedAt(StreamEndedAtT&& value) {
    SetStreamEndedAt(std::forward<StreamEndedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline MedicalScribeStreamDetails& WithLanguageCode(MedicalScribeLanguageCode value) {
  ...
  inline MedicalScribeStreamDetails& WithMediaSampleRateHertz(int value) {
  ...
  inline MedicalScribeStreamDetails& WithMediaEncoding(MedicalScribeMediaEncoding value) {
  ...
  inline void SetVocabularyFilterMethod(MedicalScribeVocabularyFilterMethod value) {
    m_vocabularyFilterMethodHasBeenSet = true;
    m_vocabularyFilterMethod = value;
  }
  inline MedicalScribeStreamDetails& WithVocabularyFilterMethod(MedicalScribeVocabularyFilterMethod value) {
  ...
  inline MedicalScribeStreamDetails& WithStreamStatus(MedicalScribeStreamStatus value) {
  ...
  void SetPostStreamAnalyticsSettings(PostStreamAnalyticsSettingsT&& value) {
    ...
    m_postStreamAnalyticsSettings = std::forward<PostStreamAnalyticsSettingsT>(value);
  }
  template <typename PostStreamAnalyticsSettingsT = MedicalScribePostStreamAnalyticsSettings>
  MedicalScribeStreamDetails& WithPostStreamAnalyticsSettings(PostStreamAnalyticsSettingsT&& value) {
    SetPostStreamAnalyticsSettings(std::forward<PostStreamAnalyticsSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostStreamAnalyticsResult(PostStreamAnalyticsResultT&& value) {
    ...
    m_postStreamAnalyticsResult = std::forward<PostStreamAnalyticsResultT>(value);
  }
  template <typename PostStreamAnalyticsResultT = MedicalScribePostStreamAnalyticsResult>
  MedicalScribeStreamDetails& WithPostStreamAnalyticsResult(PostStreamAnalyticsResultT&& value) {
    SetPostStreamAnalyticsResult(std::forward<PostStreamAnalyticsResultT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMedicalScribeContextProvided(bool value) {
    m_medicalScribeContextProvidedHasBeenSet = true;
    m_medicalScribeContextProvided = value;
  }
  inline MedicalScribeStreamDetails& WithMedicalScribeContextProvided(bool value) {
    SetMedicalScribeContextProvided(value);
    return *this;
  }
  ///@}
 private:
