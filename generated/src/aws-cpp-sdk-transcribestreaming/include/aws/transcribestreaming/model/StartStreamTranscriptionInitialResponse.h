...
class StartStreamTranscriptionInitialResponse {
 public:
  ...
  inline StartStreamTranscriptionInitialResponse& WithLanguageCode(LanguageCode value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithMediaSampleRateHertz(int value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithMediaEncoding(MediaEncoding value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithShowSpeakerLabel(bool value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithEnableChannelIdentification(bool value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithNumberOfChannels(int value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithEnablePartialResultsStabilization(bool value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithPartialResultsStability(PartialResultsStability value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithContentIdentificationType(ContentIdentificationType value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithContentRedactionType(ContentRedactionType value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithIdentifyLanguage(bool value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithPreferredLanguage(LanguageCode value) {
  ...
  inline StartStreamTranscriptionInitialResponse& WithIdentifyMultipleLanguages(bool value) {
