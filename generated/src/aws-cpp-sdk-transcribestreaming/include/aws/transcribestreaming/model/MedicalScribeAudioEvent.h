...
class MedicalScribeAudioEvent {
 public:
  ...
  inline MedicalScribeAudioEvent& WithAudioChunk(const Aws::Vector<unsigned char>& value) {
    SetAudioChunk(value);
    return *this;
  }
  inline MedicalScribeAudioEvent& WithAudioChunk(Aws::Vector<unsigned char>&& value) {
