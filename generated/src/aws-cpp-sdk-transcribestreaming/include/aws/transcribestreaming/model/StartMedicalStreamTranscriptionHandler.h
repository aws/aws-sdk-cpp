...
namespace Model {
enum class StartMedicalStreamTranscriptionEventType { INITIAL_RESPONSE, TRANSCRIPTEVENT, UNKNOWN };
...
class StartMedicalStreamTranscriptionHandler : public Aws::Utils::Event::EventStreamHandler {
  ...
  typedef std::function<void(const StartMedicalStreamTranscriptionInitialResponse&, const Utils::Event::InitialResponseType)>
      StartMedicalStreamTranscriptionInitialResponseCallbackEx;
 ...
 public:
  ...
  AWS_TRANSCRIBESTREAMINGSERVICE_API StartMedicalStreamTranscriptionHandler& operator=(const StartMedicalStreamTranscriptionHandler&) =
      default;
   ...
   * @param callback
   */
  inline void SetInitialResponseCallbackEx(const StartMedicalStreamTranscriptionInitialResponseCallbackEx& callback) {
  ...
  inline void SetInitialResponseCallback(const StartMedicalStreamTranscriptionInitialResponseCallback& noArgCallback) {
    m_onInitialResponse = [noArgCallback](const StartMedicalStreamTranscriptionInitialResponse& rs,
...
AWS_TRANSCRIBESTREAMINGSERVICE_API StartMedicalStreamTranscriptionEventType
GetStartMedicalStreamTranscriptionEventTypeForName(const Aws::String& name);

AWS_TRANSCRIBESTREAMINGSERVICE_API Aws::String GetNameForStartMedicalStreamTranscriptionEventType(
    StartMedicalStreamTranscriptionEventType value);
}  // namespace StartMedicalStreamTranscriptionEventMapper
}  // namespace Model
}  // namespace TranscribeStreamingService
}  // namespace Aws
