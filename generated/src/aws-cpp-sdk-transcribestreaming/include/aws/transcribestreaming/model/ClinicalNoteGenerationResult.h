...
class ClinicalNoteGenerationResult {
 public:
  ...
  void SetClinicalNoteOutputLocation(ClinicalNoteOutputLocationT&& value) {
    ...
    m_clinicalNoteOutputLocation = std::forward<ClinicalNoteOutputLocationT>(value);
  }
  template <typename ClinicalNoteOutputLocationT = Aws::String>
  ClinicalNoteGenerationResult& WithClinicalNoteOutputLocation(ClinicalNoteOutputLocationT&& value) {
    SetClinicalNoteOutputLocation(std::forward<ClinicalNoteOutputLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTranscriptOutputLocation(TranscriptOutputLocationT&& value) {
    ...
    m_transcriptOutputLocation = std::forward<TranscriptOutputLocationT>(value);
  }
  template <typename TranscriptOutputLocationT = Aws::String>
  ClinicalNoteGenerationResult& WithTranscriptOutputLocation(TranscriptOutputLocationT&& value) {
    SetTranscriptOutputLocation(std::forward<TranscriptOutputLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ClinicalNoteGenerationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ClinicalNoteGenerationResult& WithStatus(ClinicalNoteGenerationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
