...
class MedicalScribeTranscriptItem {
 public:
  ...
  inline void SetBeginAudioTime(double value) {
    m_beginAudioTimeHasBeenSet = true;
    m_beginAudioTime = value;
  }
  inline MedicalScribeTranscriptItem& WithBeginAudioTime(double value) {
    SetBeginAudioTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndAudioTime(double value) {
    m_endAudioTimeHasBeenSet = true;
    m_endAudioTime = value;
  }
  inline MedicalScribeTranscriptItem& WithEndAudioTime(double value) {
    SetEndAudioTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(MedicalScribeTranscriptItemType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MedicalScribeTranscriptItem& WithType(MedicalScribeTranscriptItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalScribeTranscriptItem& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalScribeTranscriptItem& WithVocabularyFilterMatch(bool value) {
