...
class Item {
 public:
  ...
  inline Item& WithStartTime(double value) {
    SetStartTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndTime(double value) {
    m_endTimeHasBeenSet = true;
    m_endTime = value;
  }
  inline Item& WithEndTime(double value) {
    SetEndTime(value);
    return *this;
  }
  ///@}
  ...
  inline Item& WithVocabularyFilterMatch(bool value) {
  ...
  inline Item& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline Item& WithStable(bool value) {
    SetStable(value);
    return *this;
  }
  ///@}
