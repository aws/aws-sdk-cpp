...
class MedicalItem {
 public:
  ...
  inline MedicalItem& WithStartTime(double value) {
    SetStartTime(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalItem& WithEndTime(double value) {
    SetEndTime(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalItem& WithType(ItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalItem& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
