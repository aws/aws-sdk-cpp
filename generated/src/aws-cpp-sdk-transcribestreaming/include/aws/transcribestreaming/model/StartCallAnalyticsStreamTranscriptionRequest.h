...
class StartCallAnalyticsStreamTranscriptionRequest : public TranscribeStreamingServiceRequest {
 public:
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline void SetEventStreamHandler(const StartCallAnalyticsStreamTranscriptionHandler& value) {
    m_handler = value;
   ...
   * Underlying Event Stream Handler which is used to define callback functions.
   */
  inline StartCallAnalyticsStreamTranscriptionRequest& WithEventStreamHandler(const StartCallAnalyticsStreamTranscriptionHandler& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithLanguageCode(CallAnalyticsLanguageCode value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithMediaSampleRateHertz(int value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithMediaEncoding(MediaEncoding value) {
  ...
  AWS_TRANSCRIBESTREAMINGSERVICE_API StartCallAnalyticsStreamTranscriptionRequest& WithAudioStream(
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithIdentifyLanguage(bool value) {
  ...
  template <typename LanguageOptionsT = Aws::String>
  StartCallAnalyticsStreamTranscriptionRequest& WithLanguageOptions(LanguageOptionsT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithPreferredLanguage(CallAnalyticsLanguageCode value) {
  ...
  template <typename VocabularyNamesT = Aws::String>
  StartCallAnalyticsStreamTranscriptionRequest& WithVocabularyNames(VocabularyNamesT&& value) {
  ...
  template <typename VocabularyFilterNamesT = Aws::String>
  StartCallAnalyticsStreamTranscriptionRequest& WithVocabularyFilterNames(VocabularyFilterNamesT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithEnablePartialResultsStabilization(bool value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithPartialResultsStability(PartialResultsStability value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithContentIdentificationType(ContentIdentificationType value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionRequest& WithContentRedactionType(ContentRedactionType value) {
