...
class StartCallAnalyticsStreamTranscriptionInitialResponse {
 public:
  ...
  AWS_TRANSCRIBESTREAMINGSERVICE_API StartCallAnalyticsStreamTranscriptionInitialResponse(
      const Http::HeaderValueCollection& responseHeaders);
  ...
  template <typename RequestIdT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithRequestId(RequestIdT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithLanguageCode(CallAnalyticsLanguageCode value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithMediaSampleRateHertz(int value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithMediaEncoding(MediaEncoding value) {
  ...
  template <typename VocabularyNameT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithVocabularyName(VocabularyNameT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithSessionId(SessionIdT&& value) {
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
  ...
  template <typename LanguageModelNameT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithLanguageModelName(LanguageModelNameT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithIdentifyLanguage(bool value) {
  ...
  template <typename LanguageOptionsT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithLanguageOptions(LanguageOptionsT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithPreferredLanguage(CallAnalyticsLanguageCode value) {
  ...
  template <typename VocabularyNamesT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithVocabularyNames(VocabularyNamesT&& value) {
  ...
  template <typename VocabularyFilterNamesT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithVocabularyFilterNames(VocabularyFilterNamesT&& value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithEnablePartialResultsStabilization(bool value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithPartialResultsStability(PartialResultsStability value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithContentIdentificationType(ContentIdentificationType value) {
  ...
  inline StartCallAnalyticsStreamTranscriptionInitialResponse& WithContentRedactionType(ContentRedactionType value) {
  ...
  template <typename PiiEntityTypesT = Aws::String>
  StartCallAnalyticsStreamTranscriptionInitialResponse& WithPiiEntityTypes(PiiEntityTypesT&& value) {
