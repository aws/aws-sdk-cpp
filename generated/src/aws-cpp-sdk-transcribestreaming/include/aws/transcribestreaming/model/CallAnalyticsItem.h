...
class CallAnalyticsItem {
 public:
  ...
  inline CallAnalyticsItem& WithBeginOffsetMillis(long long value) {
  ...
  inline CallAnalyticsItem& WithEndOffsetMillis(long long value) {
  ...
  inline void SetType(ItemType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CallAnalyticsItem& WithType(ItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CallAnalyticsItem& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVocabularyFilterMatch(bool value) {
    ...
    m_vocabularyFilterMatch = value;
  }
  inline CallAnalyticsItem& WithVocabularyFilterMatch(bool value) {
  ...
  inline void SetStable(bool value) {
    m_stableHasBeenSet = true;
    m_stable = value;
  }
  inline CallAnalyticsItem& WithStable(bool value) {
    SetStable(value);
    return *this;
  }
  ///@}
