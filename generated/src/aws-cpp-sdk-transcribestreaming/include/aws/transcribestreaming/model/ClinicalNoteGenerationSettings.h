...
class ClinicalNoteGenerationSettings {
 public:
  ...
  void SetOutputBucketName(OutputBucketNameT&& value) {
    ...
    m_outputBucketName = std::forward<OutputBucketNameT>(value);
  }
  template <typename OutputBucketNameT = Aws::String>
  ClinicalNoteGenerationSettings& WithOutputBucketName(OutputBucketNameT&& value) {
    SetOutputBucketName(std::forward<OutputBucketNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNoteTemplate(MedicalScribeNoteTemplate value) {
    m_noteTemplateHasBeenSet = true;
    m_noteTemplate = value;
  }
  inline ClinicalNoteGenerationSettings& WithNoteTemplate(MedicalScribeNoteTemplate value) {
