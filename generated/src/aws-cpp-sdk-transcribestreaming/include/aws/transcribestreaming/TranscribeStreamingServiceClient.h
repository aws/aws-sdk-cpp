...
class AWS_TRANSCRIBESTREAMINGSERVICE_API TranscribeStreamingServiceClient
 ...
 public:
  ...
  TranscribeStreamingServiceClient(
      const Aws::TranscribeStreamingService::TranscribeStreamingServiceClientConfiguration& clientConfiguration =
  ...
  /**
   * A Callable wrapper for GetMedicalScribeStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMedicalScribeStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMedicalScribeStreamRequestT = Model::GetMedicalScribeStreamRequest>
  void GetMedicalScribeStreamAsync(const GetMedicalScribeStreamRequestT& request,
                                   const GetMedicalScribeStreamResponseReceivedHandler& handler,
   ...
   */
  virtual void StartCallAnalyticsStreamTranscriptionAsync(
   ...
   * The handler is triggered when the request is finished.
   */
  virtual void StartMedicalStreamTranscriptionAsync(
