...
using TranscribeStreamingServiceEndpointProviderBase =
    Aws::TranscribeStreamingService::Endpoint::TranscribeStreamingServiceEndpointProviderBase;
...
typedef std::function<void(const TranscribeStreamingServiceClient*, const Model::GetMedicalScribeStreamRequest&,
                           const Model::GetMedicalScribeStreamOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMedicalScribeStreamResponseReceivedHandler;
typedef std::function<void(Model::AudioStream&)> StartCallAnalyticsStreamTranscriptionStreamReadyHandler;
typedef std::function<void(const TranscribeStreamingServiceClient*, const Model::StartCallAnalyticsStreamTranscriptionRequest&,
                           const Model::StartCallAnalyticsStreamTranscriptionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartCallAnalyticsStreamTranscriptionResponseReceivedHandler;
typedef std::function<void(Model::MedicalScribeInputStream&)> StartMedicalScribeStreamStreamReadyHandler;
typedef std::function<void(const TranscribeStreamingServiceClient*, const Model::StartMedicalScribeStreamRequest&,
                           const Model::StartMedicalScribeStreamOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartMedicalScribeStreamResponseReceivedHandler;
typedef std::function<void(Model::AudioStream&)> StartMedicalStreamTranscriptionStreamReadyHandler;
typedef std::function<void(const TranscribeStreamingServiceClient*, const Model::StartMedicalStreamTranscriptionRequest&,
                           const Model::StartMedicalStreamTranscriptionOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartMedicalStreamTranscriptionResponseReceivedHandler;
typedef std::function<void(Model::AudioStream&)> StartStreamTranscriptionStreamReadyHandler;
typedef std::function<void(const TranscribeStreamingServiceClient*, const Model::StartStreamTranscriptionRequest&,
                           const Model::StartStreamTranscriptionOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartStreamTranscriptionResponseReceivedHandler;
