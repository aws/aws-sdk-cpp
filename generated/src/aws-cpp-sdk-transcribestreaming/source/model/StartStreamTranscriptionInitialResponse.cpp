...
StartStreamTranscriptionInitialResponse::StartStreamTranscriptionInitialResponse(JsonView jsonValue) { *this = jsonValue; }
...
StartStreamTranscriptionInitialResponse::StartStreamTranscriptionInitialResponse(const Http::HeaderValueCollection& headers)
  ...
  if (contentIdentificationTypeIter != headers.end()) {
    m_contentIdentificationType =
        ContentIdentificationTypeMapper::GetContentIdentificationTypeForName(contentIdentificationTypeIter->second);
