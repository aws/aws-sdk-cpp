...
class ListAllowedNodeTypeUpdatesResult {
 public:
  ...
  template <typename ScaleUpNodeTypesT = Aws::Vector<Aws::String>>
  ListAllowedNodeTypeUpdatesResult& WithScaleUpNodeTypes(ScaleUpNodeTypesT&& value) {
    SetScaleUpNodeTypes(std::forward<ScaleUpNodeTypesT>(value));
    return *this;
  }
  template <typename ScaleUpNodeTypesT = Aws::String>
  ListAllowedNodeTypeUpdatesResult& AddScaleUpNodeTypes(ScaleUpNodeTypesT&& value) {
    m_scaleUpNodeTypesHasBeenSet = true;
  ...
  template <typename ScaleDownNodeTypesT = Aws::Vector<Aws::String>>
  ListAllowedNodeTypeUpdatesResult& WithScaleDownNodeTypes(ScaleDownNodeTypesT&& value) {
    SetScaleDownNodeTypes(std::forward<ScaleDownNodeTypesT>(value));
    return *this;
  }
  template <typename ScaleDownNodeTypesT = Aws::String>
  ListAllowedNodeTypeUpdatesResult& AddScaleDownNodeTypes(ScaleDownNodeTypesT&& value) {
    m_scaleDownNodeTypesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListAllowedNodeTypeUpdatesResult& WithRequestId(RequestIdT&& value) {
