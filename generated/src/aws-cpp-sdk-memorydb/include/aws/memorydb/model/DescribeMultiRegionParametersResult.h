...
class DescribeMultiRegionParametersResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMultiRegionParametersResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetMultiRegionParameters(MultiRegionParametersT&& value) {
    m_multiRegionParametersHasBeenSet = true;
    m_multiRegionParameters = std::forward<MultiRegionParametersT>(value);
  }
  template <typename MultiRegionParametersT = Aws::Vector<MultiRegionParameter>>
  DescribeMultiRegionParametersResult& WithMultiRegionParameters(MultiRegionParametersT&& value) {
    SetMultiRegionParameters(std::forward<MultiRegionParametersT>(value));
    return *this;
  }
  template <typename MultiRegionParametersT = MultiRegionParameter>
  DescribeMultiRegionParametersResult& AddMultiRegionParameters(MultiRegionParametersT&& value) {
    m_multiRegionParametersHasBeenSet = true;
    m_multiRegionParameters.emplace_back(std::forward<MultiRegionParametersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMultiRegionParametersResult& WithRequestId(RequestIdT&& value) {
