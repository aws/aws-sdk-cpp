...
class BatchUpdateClusterResult {
 public:
  ...
  void SetProcessedClusters(ProcessedClustersT&& value) {
    m_processedClustersHasBeenSet = true;
    m_processedClusters = std::forward<ProcessedClustersT>(value);
  }
  template <typename ProcessedClustersT = Aws::Vector<Cluster>>
  BatchUpdateClusterResult& WithProcessedClusters(ProcessedClustersT&& value) {
    SetProcessedClusters(std::forward<ProcessedClustersT>(value));
    return *this;
  }
  template <typename ProcessedClustersT = Cluster>
  BatchUpdateClusterResult& AddProcessedClusters(ProcessedClustersT&& value) {
    m_processedClustersHasBeenSet = true;
    m_processedClusters.emplace_back(std::forward<ProcessedClustersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnprocessedClusters(UnprocessedClustersT&& value) {
    m_unprocessedClustersHasBeenSet = true;
    m_unprocessedClusters = std::forward<UnprocessedClustersT>(value);
  }
  template <typename UnprocessedClustersT = Aws::Vector<UnprocessedCluster>>
  BatchUpdateClusterResult& WithUnprocessedClusters(UnprocessedClustersT&& value) {
    SetUnprocessedClusters(std::forward<UnprocessedClustersT>(value));
    return *this;
  }
  template <typename UnprocessedClustersT = UnprocessedCluster>
  BatchUpdateClusterResult& AddUnprocessedClusters(UnprocessedClustersT&& value) {
    m_unprocessedClustersHasBeenSet = true;
    m_unprocessedClusters.emplace_back(std::forward<UnprocessedClustersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchUpdateClusterResult& WithRequestId(RequestIdT&& value) {
