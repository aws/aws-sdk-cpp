...
class DescribeClustersRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  DescribeClustersRequest& WithClusterName(ClusterNameT&& value) {
  ...
  inline DescribeClustersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShowShardDetails(bool value) {
    m_showShardDetailsHasBeenSet = true;
    m_showShardDetails = value;
  }
  inline DescribeClustersRequest& WithShowShardDetails(bool value) {
    SetShowShardDetails(value);
    return *this;
  }
  ///@}
 private:
