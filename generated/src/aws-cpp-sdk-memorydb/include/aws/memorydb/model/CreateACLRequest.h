...
class CreateACLRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ACLNameT = Aws::String>
  CreateACLRequest& WithACLName(ACLNameT&& value) {
  ...
  template <typename UserNamesT = Aws::Vector<Aws::String>>
  CreateACLRequest& WithUserNames(UserNamesT&& value) {
    SetUserNames(std::forward<UserNamesT>(value));
    return *this;
  }
  template <typename UserNamesT = Aws::String>
  CreateACLRequest& AddUserNames(UserNamesT&& value) {
    m_userNamesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateACLRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateACLRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
