...
class EngineVersionInfo {
 public:
  ...
  template <typename EngineT = Aws::String>
  EngineVersionInfo& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  EngineVersionInfo& WithEngineVersion(EngineVersionT&& value) {
  ...
  void SetEnginePatchVersion(EnginePatchVersionT&& value) {
    m_enginePatchVersionHasBeenSet = true;
    m_enginePatchVersion = std::forward<EnginePatchVersionT>(value);
  }
  template <typename EnginePatchVersionT = Aws::String>
  EngineVersionInfo& WithEnginePatchVersion(EnginePatchVersionT&& value) {
    SetEnginePatchVersion(std::forward<EnginePatchVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ParameterGroupFamilyT = Aws::String>
  EngineVersionInfo& WithParameterGroupFamily(ParameterGroupFamilyT&& value) {
