...
namespace Model
{
  ...
  {
  public:
    AWS_MEMORYDB_API ListAllowedMultiRegionClusterUpdatesRequest() = default;
    ...
    template<typename MultiRegionClusterNameT = Aws::String>
    ListAllowedMultiRegionClusterUpdatesRequest& WithMultiRegionClusterName(MultiRegionClusterNameT&& value) { SetMultiRegionClusterName(std::forward<MultiRegionClusterNameT>(value)); return *this;}
    ///@}
  private:
