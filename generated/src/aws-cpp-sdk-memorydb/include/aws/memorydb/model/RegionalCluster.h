...
class RegionalCluster {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  RegionalCluster& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename RegionT = Aws::String>
  RegionalCluster& WithRegion(RegionT&& value) {
  ...
  template <typename StatusT = Aws::String>
  RegionalCluster& WithStatus(StatusT&& value) {
  ...
  template <typename ARNT = Aws::String>
  RegionalCluster& WithARN(ARNT&& value) {
