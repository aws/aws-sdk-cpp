...
class CreateClusterRequest : public MemoryDBRequest {
 public:
  ...
  template <typename MultiRegionClusterNameT = Aws::String>
  CreateClusterRequest& WithMultiRegionClusterName(MultiRegionClusterNameT&& value) {
  ...
  inline void SetNumShards(int value) {
    m_numShardsHasBeenSet = true;
    m_numShards = value;
  }
  inline CreateClusterRequest& WithNumShards(int value) {
    SetNumShards(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumReplicasPerShard(int value) {
    m_numReplicasPerShardHasBeenSet = true;
    m_numReplicasPerShard = value;
  }
  inline CreateClusterRequest& WithNumReplicasPerShard(int value) {
    SetNumReplicasPerShard(value);
    return *this;
  }
  ///@}
  ...
  template <typename MaintenanceWindowT = Aws::String>
  CreateClusterRequest& WithMaintenanceWindow(MaintenanceWindowT&& value) {
  ...
  template <typename SnsTopicArnT = Aws::String>
  CreateClusterRequest& WithSnsTopicArn(SnsTopicArnT&& value) {
  ...
  inline CreateClusterRequest& WithTLSEnabled(bool value) {
    SetTLSEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename SnapshotArnsT = Aws::Vector<Aws::String>>
  CreateClusterRequest& WithSnapshotArns(SnapshotArnsT&& value) {
    SetSnapshotArns(std::forward<SnapshotArnsT>(value));
    return *this;
  }
  template <typename SnapshotArnsT = Aws::String>
  CreateClusterRequest& AddSnapshotArns(SnapshotArnsT&& value) {
    m_snapshotArnsHasBeenSet = true;
  ...
  template <typename SnapshotNameT = Aws::String>
  CreateClusterRequest& WithSnapshotName(SnapshotNameT&& value) {
  ...
  inline CreateClusterRequest& WithSnapshotRetentionLimit(int value) {
  ...
  template <typename SnapshotWindowT = Aws::String>
  CreateClusterRequest& WithSnapshotWindow(SnapshotWindowT&& value) {
  ...
  template <typename ACLNameT = Aws::String>
  CreateClusterRequest& WithACLName(ACLNameT&& value) {
  ...
  template <typename EngineT = Aws::String>
  CreateClusterRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  CreateClusterRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  inline CreateClusterRequest& WithAutoMinorVersionUpgrade(bool value) {
  ...
  inline void SetDataTiering(bool value) {
    m_dataTieringHasBeenSet = true;
    m_dataTiering = value;
  }
  inline CreateClusterRequest& WithDataTiering(bool value) {
  ...
  inline CreateClusterRequest& WithIpDiscovery(IpDiscovery value) {
