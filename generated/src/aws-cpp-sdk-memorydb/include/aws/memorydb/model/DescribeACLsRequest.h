...
class DescribeACLsRequest : public MemoryDBRequest {
 public:
  AWS_MEMORYDB_API DescribeACLsRequest() = default;
  ...
  template <typename ACLNameT = Aws::String>
  DescribeACLsRequest& WithACLName(ACLNameT&& value) {
  ...
  inline DescribeACLsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeACLsRequest& WithNextToken(NextTokenT&& value) {
