...
namespace Model
{
  ...
  public:
    ...
    inline DescribeServiceUpdatesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeServiceUpdatesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeServiceUpdatesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
