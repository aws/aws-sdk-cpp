...
class BatchUpdateClusterRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ClusterNamesT = Aws::Vector<Aws::String>>
  BatchUpdateClusterRequest& WithClusterNames(ClusterNamesT&& value) {
    SetClusterNames(std::forward<ClusterNamesT>(value));
    return *this;
  }
  template <typename ClusterNamesT = Aws::String>
  BatchUpdateClusterRequest& AddClusterNames(ClusterNamesT&& value) {
    m_clusterNamesHasBeenSet = true;
  ...
  void SetServiceUpdate(ServiceUpdateT&& value) {
    m_serviceUpdateHasBeenSet = true;
    m_serviceUpdate = std::forward<ServiceUpdateT>(value);
  }
  template <typename ServiceUpdateT = ServiceUpdateRequest>
  BatchUpdateClusterRequest& WithServiceUpdate(ServiceUpdateT&& value) {
    SetServiceUpdate(std::forward<ServiceUpdateT>(value));
    return *this;
  }
  ///@}
 private:
