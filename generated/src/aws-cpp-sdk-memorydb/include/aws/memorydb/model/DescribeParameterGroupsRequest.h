...
namespace Model
{
  ...
  {
  public:
    AWS_MEMORYDB_API DescribeParameterGroupsRequest() = default;
    ...
    template<typename ParameterGroupNameT = Aws::String>
    DescribeParameterGroupsRequest& WithParameterGroupName(ParameterGroupNameT&& value) { SetParameterGroupName(std::forward<ParameterGroupNameT>(value)); return *this;}
    ///@}
