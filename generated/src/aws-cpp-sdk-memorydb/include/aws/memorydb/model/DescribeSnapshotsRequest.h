...
class DescribeSnapshotsRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  DescribeSnapshotsRequest& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename SourceT = Aws::String>
  DescribeSnapshotsRequest& WithSource(SourceT&& value) {
  ...
  inline void SetShowDetail(bool value) {
    m_showDetailHasBeenSet = true;
    m_showDetail = value;
  }
  inline DescribeSnapshotsRequest& WithShowDetail(bool value) {
    SetShowDetail(value);
    return *this;
  }
  ///@}
