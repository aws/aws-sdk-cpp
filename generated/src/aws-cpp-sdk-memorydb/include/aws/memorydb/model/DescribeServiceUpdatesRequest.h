...
class DescribeServiceUpdatesRequest : public MemoryDBRequest {
 public:
  ...
  void SetClusterNames(ClusterNamesT&& value) {
    m_clusterNamesHasBeenSet = true;
    m_clusterNames = std::forward<ClusterNamesT>(value);
  }
  template <typename ClusterNamesT = Aws::Vector<Aws::String>>
  DescribeServiceUpdatesRequest& WithClusterNames(ClusterNamesT&& value) {
    SetClusterNames(std::forward<ClusterNamesT>(value));
    return *this;
  }
  template <typename ClusterNamesT = Aws::String>
  DescribeServiceUpdatesRequest& AddClusterNames(ClusterNamesT&& value) {
    m_clusterNamesHasBeenSet = true;
    m_clusterNames.emplace_back(std::forward<ClusterNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::Vector<ServiceUpdateStatus>>
  DescribeServiceUpdatesRequest& WithStatus(StatusT&& value) {
    SetStatus(std::forward<StatusT>(value));
    return *this;
  }
  inline DescribeServiceUpdatesRequest& AddStatus(ServiceUpdateStatus value) {
    m_statusHasBeenSet = true;
  ...
  inline DescribeServiceUpdatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeServiceUpdatesRequest& WithNextToken(NextTokenT&& value) {
