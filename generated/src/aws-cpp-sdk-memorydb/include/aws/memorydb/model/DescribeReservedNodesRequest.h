...
class DescribeReservedNodesRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ReservationIdT = Aws::String>
  DescribeReservedNodesRequest& WithReservationId(ReservationIdT&& value) {
  ...
  template <typename ReservedNodesOfferingIdT = Aws::String>
  DescribeReservedNodesRequest& WithReservedNodesOfferingId(ReservedNodesOfferingIdT&& value) {
  ...
  template <typename NodeTypeT = Aws::String>
  DescribeReservedNodesRequest& WithNodeType(NodeTypeT&& value) {
  ...
  template <typename DurationT = Aws::String>
  DescribeReservedNodesRequest& WithDuration(DurationT&& value) {
  ...
  template <typename OfferingTypeT = Aws::String>
  DescribeReservedNodesRequest& WithOfferingType(OfferingTypeT&& value) {
  ...
  inline DescribeReservedNodesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedNodesRequest& WithNextToken(NextTokenT&& value) {
