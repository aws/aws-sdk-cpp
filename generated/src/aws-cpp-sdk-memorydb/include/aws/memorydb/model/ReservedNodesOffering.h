...
class ReservedNodesOffering {
 public:
  ...
  template <typename ReservedNodesOfferingIdT = Aws::String>
  ReservedNodesOffering& WithReservedNodesOfferingId(ReservedNodesOfferingIdT&& value) {
  ...
  template <typename NodeTypeT = Aws::String>
  ReservedNodesOffering& WithNodeType(NodeTypeT&& value) {
  ...
  inline ReservedNodesOffering& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNodesOffering& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  template <typename OfferingTypeT = Aws::String>
  ReservedNodesOffering& WithOfferingType(OfferingTypeT&& value) {
  ...
  template <typename RecurringChargesT = Aws::Vector<RecurringCharge>>
  ReservedNodesOffering& WithRecurringCharges(RecurringChargesT&& value) {
    SetRecurringCharges(std::forward<RecurringChargesT>(value));
    return *this;
  }
  template <typename RecurringChargesT = RecurringCharge>
  ReservedNodesOffering& AddRecurringCharges(RecurringChargesT&& value) {
    m_recurringChargesHasBeenSet = true;
