...
/**
 */
class DescribeMultiRegionParametersRequest : public MemoryDBRequest {
 public:
  AWS_MEMORYDB_API DescribeMultiRegionParametersRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DescribeMultiRegionParameters"; }
  ...
  template <typename MultiRegionParameterGroupNameT = Aws::String>
  DescribeMultiRegionParametersRequest& WithMultiRegionParameterGroupName(MultiRegionParameterGroupNameT&& value) {
  ...
  ///@{
  /**
   * <p>The parameter types to return. Valid values: user | system |
   * engine-default</p>
   */
  ...
  template <typename SourceT = Aws::String>
  DescribeMultiRegionParametersRequest& WithSource(SourceT&& value) {
  ...
  inline DescribeMultiRegionParametersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMultiRegionParametersRequest& WithNextToken(NextTokenT&& value) {
