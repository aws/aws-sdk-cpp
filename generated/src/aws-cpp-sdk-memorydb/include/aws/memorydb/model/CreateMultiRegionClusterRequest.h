...
class CreateMultiRegionClusterRequest : public MemoryDBRequest {
 public:
  ...
  void SetMultiRegionClusterNameSuffix(MultiRegionClusterNameSuffixT&& value) {
    m_multiRegionClusterNameSuffixHasBeenSet = true;
    m_multiRegionClusterNameSuffix = std::forward<MultiRegionClusterNameSuffixT>(value);
  }
  template <typename MultiRegionClusterNameSuffixT = Aws::String>
  CreateMultiRegionClusterRequest& WithMultiRegionClusterNameSuffix(MultiRegionClusterNameSuffixT&& value) {
    SetMultiRegionClusterNameSuffix(std::forward<MultiRegionClusterNameSuffixT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CreateMultiRegionClusterRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EngineT = Aws::String>
  CreateMultiRegionClusterRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  CreateMultiRegionClusterRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename NodeTypeT = Aws::String>
  CreateMultiRegionClusterRequest& WithNodeType(NodeTypeT&& value) {
  ...
  template <typename MultiRegionParameterGroupNameT = Aws::String>
  CreateMultiRegionClusterRequest& WithMultiRegionParameterGroupName(MultiRegionParameterGroupNameT&& value) {
  ...
  inline CreateMultiRegionClusterRequest& WithNumShards(int value) {
    SetNumShards(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMultiRegionClusterRequest& WithTLSEnabled(bool value) {
    SetTLSEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMultiRegionClusterRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMultiRegionClusterRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
