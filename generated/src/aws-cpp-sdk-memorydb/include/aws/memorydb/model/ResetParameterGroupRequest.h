...
class ResetParameterGroupRequest : public MemoryDBRequest {
 public:
  ...
  template <typename ParameterGroupNameT = Aws::String>
  ResetParameterGroupRequest& WithParameterGroupName(ParameterGroupNameT&& value) {
  ...
  inline void SetAllParameters(bool value) {
    m_allParametersHasBeenSet = true;
    m_allParameters = value;
  }
  inline ResetParameterGroupRequest& WithAllParameters(bool value) {
    SetAllParameters(value);
    return *this;
  }
  ///@}
  ...
  void SetParameterNames(ParameterNamesT&& value) {
    m_parameterNamesHasBeenSet = true;
    m_parameterNames = std::forward<ParameterNamesT>(value);
  }
  template <typename ParameterNamesT = Aws::Vector<Aws::String>>
  ResetParameterGroupRequest& WithParameterNames(ParameterNamesT&& value) {
    SetParameterNames(std::forward<ParameterNamesT>(value));
    return *this;
  }
  template <typename ParameterNamesT = Aws::String>
  ResetParameterGroupRequest& AddParameterNames(ParameterNamesT&& value) {
    m_parameterNamesHasBeenSet = true;
    m_parameterNames.emplace_back(std::forward<ParameterNamesT>(value));
    return *this;
  }
  ///@}
 private:
