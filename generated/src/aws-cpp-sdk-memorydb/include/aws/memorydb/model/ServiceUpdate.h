...
class ServiceUpdate {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ServiceUpdate& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename ReleaseDateT = Aws::Utils::DateTime>
  ServiceUpdate& WithReleaseDate(ReleaseDateT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ServiceUpdate& WithDescription(DescriptionT&& value) {
  ...
  inline void SetStatus(ServiceUpdateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ServiceUpdate& WithStatus(ServiceUpdateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ServiceUpdateType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ServiceUpdate& WithType(ServiceUpdateType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetNodesUpdated(NodesUpdatedT&& value) {
    ...
    m_nodesUpdated = std::forward<NodesUpdatedT>(value);
  }
  template <typename NodesUpdatedT = Aws::String>
  ServiceUpdate& WithNodesUpdated(NodesUpdatedT&& value) {
    SetNodesUpdated(std::forward<NodesUpdatedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAutoUpdateStartDate(AutoUpdateStartDateT&& value) {
    m_autoUpdateStartDateHasBeenSet = true;
    m_autoUpdateStartDate = std::forward<AutoUpdateStartDateT>(value);
  }
  template <typename AutoUpdateStartDateT = Aws::Utils::DateTime>
  ServiceUpdate& WithAutoUpdateStartDate(AutoUpdateStartDateT&& value) {
    SetAutoUpdateStartDate(std::forward<AutoUpdateStartDateT>(value));
    return *this;
  }
  ///@}
 private:
