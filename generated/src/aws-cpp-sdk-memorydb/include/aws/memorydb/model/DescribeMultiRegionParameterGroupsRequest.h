...
namespace Model
{
  ...
  public:
    ...
    template<typename MultiRegionParameterGroupNameT = Aws::String>
    DescribeMultiRegionParameterGroupsRequest& WithMultiRegionParameterGroupName(MultiRegionParameterGroupNameT&& value) { SetMultiRegionParameterGroupName(std::forward<MultiRegionParameterGroupNameT>(value)); return *this;}
    ///@}
    ...
    inline DescribeMultiRegionParameterGroupsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeMultiRegionParameterGroupsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
