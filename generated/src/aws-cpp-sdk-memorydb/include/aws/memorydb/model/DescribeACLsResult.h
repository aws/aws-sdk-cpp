...
namespace Model
{
  ...
  public:
    ...
    inline DescribeACLsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeACLsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeACLsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
