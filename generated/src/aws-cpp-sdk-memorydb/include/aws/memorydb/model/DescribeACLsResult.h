...
class DescribeACLsResult {
 public:
  AWS_MEMORYDB_API DescribeACLsResult() = default;
  ...
  template <typename ACLsT = Aws::Vector<ACL>>
  void SetACLs(ACLsT&& value) {
    m_aCLsHasBeenSet = true;
    m_aCLs = std::forward<ACLsT>(value);
  }
  template <typename ACLsT = Aws::Vector<ACL>>
  DescribeACLsResult& WithACLs(ACLsT&& value) {
    SetACLs(std::forward<ACLsT>(value));
    return *this;
  }
  template <typename ACLsT = ACL>
  DescribeACLsResult& AddACLs(ACLsT&& value) {
    m_aCLsHasBeenSet = true;
    m_aCLs.emplace_back(std::forward<ACLsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeACLsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeACLsResult& WithRequestId(RequestIdT&& value) {
