...
class DeleteMultiRegionClusterResult {
 public:
  ...
  void SetMultiRegionCluster(MultiRegionClusterT&& value) {
    m_multiRegionClusterHasBeenSet = true;
    m_multiRegionCluster = std::forward<MultiRegionClusterT>(value);
  }
  template <typename MultiRegionClusterT = MultiRegionCluster>
  DeleteMultiRegionClusterResult& WithMultiRegionCluster(MultiRegionClusterT&& value) {
    SetMultiRegionCluster(std::forward<MultiRegionClusterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteMultiRegionClusterResult& WithRequestId(RequestIdT&& value) {
