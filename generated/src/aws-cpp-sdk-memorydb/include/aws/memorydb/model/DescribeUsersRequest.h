...
class DescribeUsersRequest : public MemoryDBRequest {
 public:
  AWS_MEMORYDB_API DescribeUsersRequest() = default;
  ...
  template <typename UserNameT = Aws::String>
  DescribeUsersRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeUsersRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeUsersRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
