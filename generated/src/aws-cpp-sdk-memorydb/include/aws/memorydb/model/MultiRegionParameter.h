...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    MultiRegionParameter& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    MultiRegionParameter& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    MultiRegionParameter& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceT = Aws::String>
    MultiRegionParameter& WithSource(SourceT&& value) { SetSource(std::forward<SourceT>(value)); return *this;}
    ///@}
    ...
    template<typename DataTypeT = Aws::String>
    MultiRegionParameter& WithDataType(DataTypeT&& value) { SetDataType(std::forward<DataTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename AllowedValuesT = Aws::String>
    MultiRegionParameter& WithAllowedValues(AllowedValuesT&& value) { SetAllowedValues(std::forward<AllowedValuesT>(value)); return *this;}
    ///@}
    ...
    template<typename MinimumEngineVersionT = Aws::String>
    MultiRegionParameter& WithMinimumEngineVersion(MinimumEngineVersionT&& value) { SetMinimumEngineVersion(std::forward<MinimumEngineVersionT>(value)); return *this;}
    ///@}
  private:
