...
class ACL {
 public:
  ...
  void SetUserNames(UserNamesT&& value) {
    m_userNamesHasBeenSet = true;
    m_userNames = std::forward<UserNamesT>(value);
  }
  template <typename UserNamesT = Aws::Vector<Aws::String>>
  ACL& WithUserNames(UserNamesT&& value) {
    SetUserNames(std::forward<UserNamesT>(value));
    return *this;
  }
  template <typename UserNamesT = Aws::String>
  ACL& AddUserNames(UserNamesT&& value) {
    m_userNamesHasBeenSet = true;
    m_userNames.emplace_back(std::forward<UserNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MinimumEngineVersionT = Aws::String>
  ACL& WithMinimumEngineVersion(MinimumEngineVersionT&& value) {
  ...
  template <typename PendingChangesT = ACLPendingChanges>
  ACL& WithPendingChanges(PendingChangesT&& value) {
