...
class DescribeMultiRegionClustersRequest : public MemoryDBRequest {
 public:
  ...
  template <typename MultiRegionClusterNameT = Aws::String>
  DescribeMultiRegionClustersRequest& WithMultiRegionClusterName(MultiRegionClusterNameT&& value) {
  ...
  inline DescribeMultiRegionClustersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMultiRegionClustersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetShowClusterDetails(bool value) {
    m_showClusterDetailsHasBeenSet = true;
    m_showClusterDetails = value;
  }
  inline DescribeMultiRegionClustersRequest& WithShowClusterDetails(bool value) {
