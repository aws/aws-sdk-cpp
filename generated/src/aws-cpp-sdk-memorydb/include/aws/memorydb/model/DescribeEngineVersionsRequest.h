...
class DescribeEngineVersionsRequest : public MemoryDBRequest {
 public:
  AWS_MEMORYDB_API DescribeEngineVersionsRequest() = default;
  ...
  template <typename EngineT = Aws::String>
  DescribeEngineVersionsRequest& WithEngine(EngineT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  DescribeEngineVersionsRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename ParameterGroupFamilyT = Aws::String>
  DescribeEngineVersionsRequest& WithParameterGroupFamily(ParameterGroupFamilyT&& value) {
  ...
  inline DescribeEngineVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEngineVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeEngineVersionsRequest& WithDefaultOnly(bool value) {
