...
namespace Model
{
  ...
  {
  public:
    AWS_MEMORYDB_API UpdateMultiRegionClusterResult() = default;
    ...
    template<typename MultiRegionClusterT = MultiRegionCluster>
    UpdateMultiRegionClusterResult& WithMultiRegionCluster(MultiRegionClusterT&& value) { SetMultiRegionCluster(std::forward<MultiRegionClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMultiRegionClusterResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
