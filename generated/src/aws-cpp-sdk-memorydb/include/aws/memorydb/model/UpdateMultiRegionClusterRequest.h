...
class UpdateMultiRegionClusterRequest : public MemoryDBRequest {
 public:
  ...
  template <typename MultiRegionClusterNameT = Aws::String>
  UpdateMultiRegionClusterRequest& WithMultiRegionClusterName(MultiRegionClusterNameT&& value) {
  ...
  template <typename NodeTypeT = Aws::String>
  UpdateMultiRegionClusterRequest& WithNodeType(NodeTypeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateMultiRegionClusterRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename EngineVersionT = Aws::String>
  UpdateMultiRegionClusterRequest& WithEngineVersion(EngineVersionT&& value) {
  ...
  template <typename ShardConfigurationT = ShardConfigurationRequest>
  UpdateMultiRegionClusterRequest& WithShardConfiguration(ShardConfigurationT&& value) {
  ...
  template <typename MultiRegionParameterGroupNameT = Aws::String>
  UpdateMultiRegionClusterRequest& WithMultiRegionParameterGroupName(MultiRegionParameterGroupNameT&& value) {
  ...
  inline void SetUpdateStrategy(UpdateStrategy value) {
    m_updateStrategyHasBeenSet = true;
    m_updateStrategy = value;
  }
  inline UpdateMultiRegionClusterRequest& WithUpdateStrategy(UpdateStrategy value) {
