...
namespace MemoryDB
{
const size_t MemoryDBEndpointRules::RulesBlobStrLen = 3633;
const size_t MemoryDBEndpointRules::RulesBlobSize = 3634;
...
't','t','p','s',':','/','/','m','e','m','o','r','y','-','d','b','-','f','i','p','s','.','{','R','e',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','m','o','r','y','-','d','b',
...
const char* MemoryDBEndpointRules::GetRulesBlob()
{
