...
'r','y','-','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'l','"',':','"','h','t','t','p','s',':','/','/','m','e','m','o','r','y','-','d','b','.','{','R','e',
