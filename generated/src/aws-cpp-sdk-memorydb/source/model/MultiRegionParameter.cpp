...
MultiRegionParameter::MultiRegionParameter(JsonView jsonValue)
{
  *this = jsonValue;
}

MultiRegionParameter& MultiRegionParameter::operator =(JsonView jsonValue)
{
...
JsonValue MultiRegionParameter::Jsonize() const
{
  JsonValue payload;
