...
DescribeReservedNodesOfferingsResult& DescribeReservedNodesOfferingsResult::operator=(
  ...
  if (jsonValue.ValueExists("ReservedNodesOfferings")) {
    ...
    for (unsigned reservedNodesOfferingsIndex = 0; reservedNodesOfferingsIndex < reservedNodesOfferingsJsonList.GetLength();
         ++reservedNodesOfferingsIndex) {
