...
DeleteMultiRegionClusterResult::DeleteMultiRegionClusterResult()
{
}

DeleteMultiRegionClusterResult::DeleteMultiRegionClusterResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
