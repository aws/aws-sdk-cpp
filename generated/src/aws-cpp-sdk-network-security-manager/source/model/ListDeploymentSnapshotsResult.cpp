...
ListDeploymentSnapshotsResult::ListDeploymentSnapshotsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListDeploymentSnapshotsResult& ListDeploymentSnapshotsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
