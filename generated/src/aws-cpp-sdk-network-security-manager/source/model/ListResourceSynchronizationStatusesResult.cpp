...
ListResourceSynchronizationStatusesResult::ListResourceSynchronizationStatusesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

ListResourceSynchronizationStatusesResult& ListResourceSynchronizationStatusesResult::operator=(
