...
CreateRuleSnapshotResult::CreateRuleSnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateRuleSnapshotResult& CreateRuleSnapshotResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
