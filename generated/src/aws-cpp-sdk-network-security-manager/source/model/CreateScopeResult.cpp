...
CreateScopeResult::CreateScopeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateScopeResult& CreateScopeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
