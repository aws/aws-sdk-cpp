...
ListScopeSnapshotsResult::ListScopeSnapshotsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListScopeSnapshotsResult& ListScopeSnapshotsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
