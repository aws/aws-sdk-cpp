...
ListPolicySnapshotsResult::ListPolicySnapshotsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListPolicySnapshotsResult& ListPolicySnapshotsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
