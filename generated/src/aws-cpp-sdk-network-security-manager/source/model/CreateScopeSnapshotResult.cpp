...
CreateScopeSnapshotResult::CreateScopeSnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateScopeSnapshotResult& CreateScopeSnapshotResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
