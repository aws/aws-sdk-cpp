...
CreatePolicySnapshotResult::CreatePolicySnapshotResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreatePolicySnapshotResult& CreatePolicySnapshotResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
