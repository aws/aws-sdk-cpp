...
/**
 * <p>The request would exceed a service quota.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/network-security-manager-2025-10-30/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_NETWORKSECURITYMANAGER_API ServiceQuotaExceededException() = default;
  AWS_NETWORKSECURITYMANAGER_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
  AWS_NETWORKSECURITYMANAGER_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
