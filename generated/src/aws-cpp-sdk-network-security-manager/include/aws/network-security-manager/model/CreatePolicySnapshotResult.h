...
namespace Model {
class CreatePolicySnapshotResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreatePolicySnapshotResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreatePolicySnapshotResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreatePolicySnapshotResult& operator=(
  ...
  template <typename PolicyIdT = Aws::String>
  CreatePolicySnapshotResult& WithPolicyId(PolicyIdT&& value) {
  ...
  template <typename PolicyArnT = Aws::String>
  CreatePolicySnapshotResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename PolicyNameT = Aws::String>
  CreatePolicySnapshotResult& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyDescriptionT = Aws::String>
  CreatePolicySnapshotResult& WithPolicyDescription(PolicyDescriptionT&& value) {
  ...
  inline CreatePolicySnapshotResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePolicySnapshotResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociatedTemplateAndRuleListT = Aws::Vector<AssociatedTemplateOrRule>>
  CreatePolicySnapshotResult& WithAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
  ...
  CreatePolicySnapshotResult& AddAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
    m_associatedTemplateAndRuleListHasBeenSet = true;
  ...
  template <typename VersionT = Aws::String>
  CreatePolicySnapshotResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreatePolicySnapshotResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreatePolicySnapshotResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePolicySnapshotResult& WithHasPublishedVersion(bool value) {
  ...
  inline CreatePolicySnapshotResult& WithFirewallType(PolicyFirewallType value) {
  ...
  template <typename PolicyConfigurationT = PolicyConfiguration>
  CreatePolicySnapshotResult& WithPolicyConfiguration(PolicyConfigurationT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreatePolicySnapshotResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePolicySnapshotResult& WithRequestId(RequestIdT&& value) {
