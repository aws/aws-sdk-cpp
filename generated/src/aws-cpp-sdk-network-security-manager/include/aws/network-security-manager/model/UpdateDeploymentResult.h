...
class UpdateDeploymentResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API UpdateDeploymentResult() = default;
  AWS_NETWORKSECURITYMANAGER_API UpdateDeploymentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API UpdateDeploymentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DeploymentIdT = Aws::String>
  UpdateDeploymentResult& WithDeploymentId(DeploymentIdT&& value) {
  ...
  template <typename DeploymentArnT = Aws::String>
  UpdateDeploymentResult& WithDeploymentArn(DeploymentArnT&& value) {
  ...
  template <typename DeploymentNameT = Aws::String>
  UpdateDeploymentResult& WithDeploymentName(DeploymentNameT&& value) {
  ...
  template <typename DeploymentDescriptionT = Aws::String>
  UpdateDeploymentResult& WithDeploymentDescription(DeploymentDescriptionT&& value) {
  ...
  inline UpdateDeploymentResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeploymentConfigurationT = DeploymentConfiguration>
  UpdateDeploymentResult& WithDeploymentConfiguration(DeploymentConfigurationT&& value) {
  ...
  template <typename AssociatedPolicyListT = Aws::Vector<AssociatedPolicy>>
  UpdateDeploymentResult& WithAssociatedPolicyList(AssociatedPolicyListT&& value) {
    SetAssociatedPolicyList(std::forward<AssociatedPolicyListT>(value));
    return *this;
  }
  template <typename AssociatedPolicyListT = AssociatedPolicy>
  UpdateDeploymentResult& AddAssociatedPolicyList(AssociatedPolicyListT&& value) {
    m_associatedPolicyListHasBeenSet = true;
  ...
  template <typename AssociatedScopeListT = Aws::Vector<AssociatedScope>>
  UpdateDeploymentResult& WithAssociatedScopeList(AssociatedScopeListT&& value) {
    SetAssociatedScopeList(std::forward<AssociatedScopeListT>(value));
    return *this;
  }
  template <typename AssociatedScopeListT = AssociatedScope>
  UpdateDeploymentResult& AddAssociatedScopeList(AssociatedScopeListT&& value) {
    m_associatedScopeListHasBeenSet = true;
  ...
  template <typename VersionT = Aws::String>
  UpdateDeploymentResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateDeploymentResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline UpdateDeploymentResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateDeploymentResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename DeploymentCoverageT = Aws::Vector<DeploymentCoverageEntry>>
  UpdateDeploymentResult& WithDeploymentCoverage(DeploymentCoverageT&& value) {
    SetDeploymentCoverage(std::forward<DeploymentCoverageT>(value));
    return *this;
  }
  template <typename DeploymentCoverageT = DeploymentCoverageEntry>
  UpdateDeploymentResult& AddDeploymentCoverage(DeploymentCoverageT&& value) {
    m_deploymentCoverageHasBeenSet = true;
  ...
  template <typename WarningsT = Aws::Vector<DeploymentWarningEntry>>
  UpdateDeploymentResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = DeploymentWarningEntry>
  UpdateDeploymentResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateDeploymentResult& WithUpdatedAt(UpdatedAtT&& value) {
