...
namespace Model {
class ListAggregateResourceSynchronizationStatusesResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListAggregateResourceSynchronizationStatusesResult() = default;
  AWS_NETWORKSECURITYMANAGER_API ListAggregateResourceSynchronizationStatusesResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API ListAggregateResourceSynchronizationStatusesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  ListAggregateResourceSynchronizationStatusesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResourceSynchronizationStatusesT = Aws::Vector<ResourceSynchronizationStatusSummary>>
  ListAggregateResourceSynchronizationStatusesResult& WithResourceSynchronizationStatuses(ResourceSynchronizationStatusesT&& value) {
  ...
  ListAggregateResourceSynchronizationStatusesResult& AddResourceSynchronizationStatuses(ResourceSynchronizationStatusesT&& value) {
    m_resourceSynchronizationStatusesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListAggregateResourceSynchronizationStatusesResult& WithRequestId(RequestIdT&& value) {
