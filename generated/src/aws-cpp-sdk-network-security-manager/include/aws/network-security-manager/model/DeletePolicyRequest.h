...
/**
 */
class DeletePolicyRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API DeletePolicyRequest() = default;
  ...
  template <typename PolicyIdentifierT = Aws::String>
  DeletePolicyRequest& WithPolicyIdentifier(PolicyIdentifierT&& value) {
