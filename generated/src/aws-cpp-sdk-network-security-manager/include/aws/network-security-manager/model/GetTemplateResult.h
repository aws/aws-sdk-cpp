...
class GetTemplateResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetTemplateResult() = default;
  AWS_NETWORKSECURITYMANAGER_API GetTemplateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API GetTemplateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TemplateNameT = Aws::String>
  GetTemplateResult& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateDescriptionT = Aws::String>
  GetTemplateResult& WithTemplateDescription(TemplateDescriptionT&& value) {
  ...
  inline GetTemplateResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  GetTemplateResult& WithVersion(VersionT&& value) {
  ...
  template <typename AssociatedRuleListT = Aws::Vector<AssociatedRule>>
  GetTemplateResult& WithAssociatedRuleList(AssociatedRuleListT&& value) {
    SetAssociatedRuleList(std::forward<AssociatedRuleListT>(value));
    return *this;
  }
  template <typename AssociatedRuleListT = AssociatedRule>
  GetTemplateResult& AddAssociatedRuleList(AssociatedRuleListT&& value) {
    m_associatedRuleListHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  GetTemplateResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline GetTemplateResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline GetTemplateResult& WithHasPublishedVersion(bool value) {
  ...
  inline GetTemplateResult& WithFirewallType(TemplateFirewallType value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetTemplateResult& WithUpdatedAt(UpdatedAtT&& value) {
