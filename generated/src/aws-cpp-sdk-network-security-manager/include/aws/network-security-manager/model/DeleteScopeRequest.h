...
/**
 */
class DeleteScopeRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API DeleteScopeRequest() = default;
  ...
  template <typename ScopeIdentifierT = Aws::String>
  DeleteScopeRequest& WithScopeIdentifier(ScopeIdentifierT&& value) {
