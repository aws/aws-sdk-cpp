...
class CreateScopeResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreateScopeResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreateScopeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreateScopeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ScopeNameT = Aws::String>
  CreateScopeResult& WithScopeName(ScopeNameT&& value) {
  ...
  template <typename ScopeDescriptionT = Aws::String>
  CreateScopeResult& WithScopeDescription(ScopeDescriptionT&& value) {
  ...
  template <typename ScopeConfigurationT = ScopeConfiguration>
  CreateScopeResult& WithScopeConfiguration(ScopeConfigurationT&& value) {
  ...
  inline CreateScopeResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  CreateScopeResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateScopeResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreateScopeResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreateScopeResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateScopeResult& WithUpdatedAt(UpdatedAtT&& value) {
