...
/**
 */
class TagResourceRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API TagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>The ARN of the resource to tag. The ARN must not include a
   * <code>:DRAFT</code> qualifier.</p>
   */
