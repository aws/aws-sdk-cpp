...
/**
 */
class GetTemplateRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetTemplateRequest() = default;
  ...
  template <typename TemplateIdentifierT = Aws::String>
  GetTemplateRequest& WithTemplateIdentifier(TemplateIdentifierT&& value) {
