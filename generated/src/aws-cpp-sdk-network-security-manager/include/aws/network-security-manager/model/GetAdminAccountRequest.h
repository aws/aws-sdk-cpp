...
/**
 */
class GetAdminAccountRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetAdminAccountRequest() = default;
  ...
  template <typename AccountIdT = Aws::String>
  GetAdminAccountRequest& WithAccountId(AccountIdT&& value) {
