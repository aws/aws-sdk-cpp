...
class UpdateTemplateResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API UpdateTemplateResult() = default;
  AWS_NETWORKSECURITYMANAGER_API UpdateTemplateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API UpdateTemplateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TemplateNameT = Aws::String>
  UpdateTemplateResult& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateDescriptionT = Aws::String>
  UpdateTemplateResult& WithTemplateDescription(TemplateDescriptionT&& value) {
  ...
  inline UpdateTemplateResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  UpdateTemplateResult& WithVersion(VersionT&& value) {
  ...
  template <typename AssociatedRuleListT = Aws::Vector<AssociatedRule>>
  UpdateTemplateResult& WithAssociatedRuleList(AssociatedRuleListT&& value) {
    SetAssociatedRuleList(std::forward<AssociatedRuleListT>(value));
    return *this;
  }
  template <typename AssociatedRuleListT = AssociatedRule>
  UpdateTemplateResult& AddAssociatedRuleList(AssociatedRuleListT&& value) {
    m_associatedRuleListHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateTemplateResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline UpdateTemplateResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateTemplateResult& WithHasPublishedVersion(bool value) {
  ...
  inline UpdateTemplateResult& WithFirewallType(TemplateFirewallType value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateTemplateResult& WithUpdatedAt(UpdatedAtT&& value) {
