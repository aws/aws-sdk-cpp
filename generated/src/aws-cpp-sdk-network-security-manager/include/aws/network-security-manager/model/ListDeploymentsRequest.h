...
/**
 */
class ListDeploymentsRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListDeploymentsRequest() = default;
  ...
  inline ListDeploymentsRequest& WithStatus(EntityStatusFilter value) {
    SetStatus(value);
    return *this;
  }
  ///@}
