...
namespace Model {
class CreateRuleSnapshotResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreateRuleSnapshotResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreateRuleSnapshotResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreateRuleSnapshotResult& operator=(
  ...
  template <typename RuleIdT = Aws::String>
  CreateRuleSnapshotResult& WithRuleId(RuleIdT&& value) {
  ...
  template <typename RuleArnT = Aws::String>
  CreateRuleSnapshotResult& WithRuleArn(RuleArnT&& value) {
  ...
  template <typename RuleNameT = Aws::String>
  CreateRuleSnapshotResult& WithRuleName(RuleNameT&& value) {
  ...
  inline CreateRuleSnapshotResult& WithFirewallType(RuleFirewallType value) {
  ...
  inline CreateRuleSnapshotResult& WithRuleType(RuleType value) {
    SetRuleType(value);
    return *this;
  }
  ///@}
  ...
  template <typename RuleDescriptionT = Aws::String>
  CreateRuleSnapshotResult& WithRuleDescription(RuleDescriptionT&& value) {
  ...
  template <typename ConfigurationT = Aws::Utils::Document>
  CreateRuleSnapshotResult& WithConfiguration(ConfigurationT&& value) {
  ...
  inline CreateRuleSnapshotResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  CreateRuleSnapshotResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateRuleSnapshotResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreateRuleSnapshotResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreateRuleSnapshotResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateRuleSnapshotResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRuleSnapshotResult& WithRequestId(RequestIdT&& value) {
