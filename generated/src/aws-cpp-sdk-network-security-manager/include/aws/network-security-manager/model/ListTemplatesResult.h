...
class ListTemplatesResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListTemplatesResult() = default;
  AWS_NETWORKSECURITYMANAGER_API ListTemplatesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API ListTemplatesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
