...
class CreatePolicyResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreatePolicyResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreatePolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreatePolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PolicyDescriptionT = Aws::String>
  CreatePolicyResult& WithPolicyDescription(PolicyDescriptionT&& value) {
  ...
  inline CreatePolicyResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePolicyResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociatedTemplateAndRuleListT = Aws::Vector<AssociatedTemplateOrRule>>
  CreatePolicyResult& WithAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
  ...
  CreatePolicyResult& AddAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
    m_associatedTemplateAndRuleListHasBeenSet = true;
  ...
  template <typename VersionT = Aws::String>
  CreatePolicyResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreatePolicyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreatePolicyResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePolicyResult& WithHasPublishedVersion(bool value) {
  ...
  inline CreatePolicyResult& WithFirewallType(PolicyFirewallType value) {
  ...
  template <typename PolicyConfigurationT = PolicyConfiguration>
  CreatePolicyResult& WithPolicyConfiguration(PolicyConfigurationT&& value) {
