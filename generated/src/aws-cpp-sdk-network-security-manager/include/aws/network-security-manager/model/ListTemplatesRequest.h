...
/**
 */
class ListTemplatesRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListTemplatesRequest() = default;
  ...
  inline ListTemplatesRequest& WithStatus(EntityStatusFilter value) {
    SetStatus(value);
    return *this;
  }
  ///@}
