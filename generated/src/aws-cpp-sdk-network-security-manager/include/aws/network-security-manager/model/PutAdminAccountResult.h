...
namespace Model {
class PutAdminAccountResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API PutAdminAccountResult() = default;
  AWS_NETWORKSECURITYMANAGER_API PutAdminAccountResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API PutAdminAccountResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AdminAccountDetailsT = AdminAccountDetails>
  PutAdminAccountResult& WithAdminAccountDetails(AdminAccountDetailsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutAdminAccountResult& WithRequestId(RequestIdT&& value) {
