...
class UpdateRuleResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API UpdateRuleResult() = default;
  AWS_NETWORKSECURITYMANAGER_API UpdateRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API UpdateRuleResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RuleIdT = Aws::String>
  UpdateRuleResult& WithRuleId(RuleIdT&& value) {
  ...
  template <typename RuleNameT = Aws::String>
  UpdateRuleResult& WithRuleName(RuleNameT&& value) {
  ...
  inline UpdateRuleResult& WithFirewallType(RuleFirewallType value) {
  ...
  inline UpdateRuleResult& WithRuleType(RuleType value) {
    SetRuleType(value);
    return *this;
  }
  ///@}
  ...
  template <typename RuleDescriptionT = Aws::String>
  UpdateRuleResult& WithRuleDescription(RuleDescriptionT&& value) {
  ...
  template <typename ConfigurationT = Aws::Utils::Document>
  UpdateRuleResult& WithConfiguration(ConfigurationT&& value) {
  ...
  inline UpdateRuleResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  UpdateRuleResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdateRuleResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline UpdateRuleResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRuleResult& WithHasPublishedVersion(bool value) {
