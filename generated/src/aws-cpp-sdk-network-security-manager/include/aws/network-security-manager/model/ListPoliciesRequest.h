...
/**
 */
class ListPoliciesRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListPoliciesRequest() = default;
  ...
  ///@{
  /**
   * <p>Filters the results by status, either <code>ACTIVE</code> or
   * <code>DRAFT</code>.</p>
   */
  inline EntityStatusFilter GetStatus() const { return m_status; }
  inline bool StatusHasBeenSet() const { return m_statusHasBeenSet; }
  inline void SetStatus(EntityStatusFilter value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListPoliciesRequest& WithStatus(EntityStatusFilter value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 private:
  ...
  EntityStatusFilter m_status{EntityStatusFilter::NOT_SET};
