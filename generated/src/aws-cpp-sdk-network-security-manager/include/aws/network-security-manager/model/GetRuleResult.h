...
class GetRuleResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetRuleResult() = default;
  AWS_NETWORKSECURITYMANAGER_API GetRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API GetRuleResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename RuleIdT = Aws::String>
  GetRuleResult& WithRuleId(RuleIdT&& value) {
  ...
  template <typename RuleNameT = Aws::String>
  GetRuleResult& WithRuleName(RuleNameT&& value) {
  ...
  inline GetRuleResult& WithFirewallType(RuleFirewallType value) {
  ...
  template <typename RuleDescriptionT = Aws::String>
  GetRuleResult& WithRuleDescription(RuleDescriptionT&& value) {
  ...
  template <typename ConfigurationT = Aws::Utils::Document>
  GetRuleResult& WithConfiguration(ConfigurationT&& value) {
  ...
  inline GetRuleResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  GetRuleResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  GetRuleResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline GetRuleResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline GetRuleResult& WithHasPublishedVersion(bool value) {
