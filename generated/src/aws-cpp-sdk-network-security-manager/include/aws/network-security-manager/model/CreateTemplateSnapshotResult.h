...
namespace Model {
class CreateTemplateSnapshotResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreateTemplateSnapshotResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreateTemplateSnapshotResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreateTemplateSnapshotResult& operator=(
  ...
  template <typename TemplateIdT = Aws::String>
  CreateTemplateSnapshotResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  CreateTemplateSnapshotResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  CreateTemplateSnapshotResult& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateDescriptionT = Aws::String>
  CreateTemplateSnapshotResult& WithTemplateDescription(TemplateDescriptionT&& value) {
  ...
  inline CreateTemplateSnapshotResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  CreateTemplateSnapshotResult& WithVersion(VersionT&& value) {
  ...
  template <typename AssociatedRuleListT = Aws::Vector<AssociatedRule>>
  CreateTemplateSnapshotResult& WithAssociatedRuleList(AssociatedRuleListT&& value) {
    SetAssociatedRuleList(std::forward<AssociatedRuleListT>(value));
    return *this;
  }
  template <typename AssociatedRuleListT = AssociatedRule>
  CreateTemplateSnapshotResult& AddAssociatedRuleList(AssociatedRuleListT&& value) {
    m_associatedRuleListHasBeenSet = true;
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateTemplateSnapshotResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreateTemplateSnapshotResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreateTemplateSnapshotResult& WithHasPublishedVersion(bool value) {
  ...
  inline CreateTemplateSnapshotResult& WithFirewallType(TemplateFirewallType value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateTemplateSnapshotResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTemplateSnapshotResult& WithRequestId(RequestIdT&& value) {
