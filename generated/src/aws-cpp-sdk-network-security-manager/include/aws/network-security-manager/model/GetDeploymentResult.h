...
class GetDeploymentResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetDeploymentResult() = default;
  AWS_NETWORKSECURITYMANAGER_API GetDeploymentResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API GetDeploymentResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DeploymentArnT = Aws::String>
  GetDeploymentResult& WithDeploymentArn(DeploymentArnT&& value) {
  ...
  template <typename DeploymentDescriptionT = Aws::String>
  GetDeploymentResult& WithDeploymentDescription(DeploymentDescriptionT&& value) {
  ...
  inline GetDeploymentResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeploymentConfigurationT = DeploymentConfiguration>
  GetDeploymentResult& WithDeploymentConfiguration(DeploymentConfigurationT&& value) {
  ...
  template <typename AssociatedPolicyListT = Aws::Vector<AssociatedPolicy>>
  GetDeploymentResult& WithAssociatedPolicyList(AssociatedPolicyListT&& value) {
    SetAssociatedPolicyList(std::forward<AssociatedPolicyListT>(value));
    return *this;
  }
  template <typename AssociatedPolicyListT = AssociatedPolicy>
  GetDeploymentResult& AddAssociatedPolicyList(AssociatedPolicyListT&& value) {
    m_associatedPolicyListHasBeenSet = true;
  ...
  template <typename AssociatedScopeListT = Aws::Vector<AssociatedScope>>
  GetDeploymentResult& WithAssociatedScopeList(AssociatedScopeListT&& value) {
    SetAssociatedScopeList(std::forward<AssociatedScopeListT>(value));
    return *this;
  }
  template <typename AssociatedScopeListT = AssociatedScope>
  GetDeploymentResult& AddAssociatedScopeList(AssociatedScopeListT&& value) {
    m_associatedScopeListHasBeenSet = true;
  ...
  template <typename VersionT = Aws::String>
  GetDeploymentResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  GetDeploymentResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline GetDeploymentResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline GetDeploymentResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetDeploymentResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename DeploymentCoverageT = Aws::Vector<DeploymentCoverageEntry>>
  GetDeploymentResult& WithDeploymentCoverage(DeploymentCoverageT&& value) {
    SetDeploymentCoverage(std::forward<DeploymentCoverageT>(value));
    return *this;
  }
  template <typename DeploymentCoverageT = DeploymentCoverageEntry>
  GetDeploymentResult& AddDeploymentCoverage(DeploymentCoverageT&& value) {
    m_deploymentCoverageHasBeenSet = true;
  ...
  template <typename WarningsT = Aws::Vector<DeploymentWarningEntry>>
  GetDeploymentResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = DeploymentWarningEntry>
  GetDeploymentResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
