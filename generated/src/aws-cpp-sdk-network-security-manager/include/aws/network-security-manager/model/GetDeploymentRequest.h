...
/**
 */
class GetDeploymentRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetDeploymentRequest() = default;
  ...
  template <typename DeploymentIdentifierT = Aws::String>
  GetDeploymentRequest& WithDeploymentIdentifier(DeploymentIdentifierT&& value) {
