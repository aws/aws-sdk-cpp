...
namespace Model {
class CreateScopeSnapshotResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API CreateScopeSnapshotResult() = default;
  AWS_NETWORKSECURITYMANAGER_API CreateScopeSnapshotResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API CreateScopeSnapshotResult& operator=(
  ...
  template <typename ScopeIdT = Aws::String>
  CreateScopeSnapshotResult& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename ScopeArnT = Aws::String>
  CreateScopeSnapshotResult& WithScopeArn(ScopeArnT&& value) {
  ...
  template <typename ScopeNameT = Aws::String>
  CreateScopeSnapshotResult& WithScopeName(ScopeNameT&& value) {
  ...
  template <typename ScopeDescriptionT = Aws::String>
  CreateScopeSnapshotResult& WithScopeDescription(ScopeDescriptionT&& value) {
  ...
  template <typename ScopeConfigurationT = ScopeConfiguration>
  CreateScopeSnapshotResult& WithScopeConfiguration(ScopeConfigurationT&& value) {
  ...
  inline CreateScopeSnapshotResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  CreateScopeSnapshotResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  CreateScopeSnapshotResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline CreateScopeSnapshotResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline CreateScopeSnapshotResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateScopeSnapshotResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateScopeSnapshotResult& WithRequestId(RequestIdT&& value) {
