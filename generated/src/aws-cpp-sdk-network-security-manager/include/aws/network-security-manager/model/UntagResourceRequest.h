...
/**
 */
class UntagResourceRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API UntagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>The ARN of the resource to remove tags from. The ARN must not include a
