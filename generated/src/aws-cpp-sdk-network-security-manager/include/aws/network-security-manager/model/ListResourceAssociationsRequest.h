...
/**
 */
class ListResourceAssociationsRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListResourceAssociationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListResourceAssociations"; }
  ...
  ///@{
  /**
   * <p>The identifier of the resource to list associations for. This is the
  ...
  template <typename ResourceIdentifierT = Aws::String>
  ListResourceAssociationsRequest& WithResourceIdentifier(ResourceIdentifierT&& value) {
  ...
  inline ListResourceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceAssociationsRequest& WithNextToken(NextTokenT&& value) {
