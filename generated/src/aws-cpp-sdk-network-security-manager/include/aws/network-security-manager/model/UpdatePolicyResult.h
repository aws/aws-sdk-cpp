...
class UpdatePolicyResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API UpdatePolicyResult() = default;
  AWS_NETWORKSECURITYMANAGER_API UpdatePolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API UpdatePolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PolicyNameT = Aws::String>
  UpdatePolicyResult& WithPolicyName(PolicyNameT&& value) {
  ...
  template <typename PolicyDescriptionT = Aws::String>
  UpdatePolicyResult& WithPolicyDescription(PolicyDescriptionT&& value) {
  ...
  inline UpdatePolicyResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePolicyResult& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssociatedTemplateAndRuleListT = Aws::Vector<AssociatedTemplateOrRule>>
  UpdatePolicyResult& WithAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
  ...
  UpdatePolicyResult& AddAssociatedTemplateAndRuleList(AssociatedTemplateAndRuleListT&& value) {
    m_associatedTemplateAndRuleListHasBeenSet = true;
  ...
  template <typename VersionT = Aws::String>
  UpdatePolicyResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  UpdatePolicyResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline UpdatePolicyResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePolicyResult& WithHasPublishedVersion(bool value) {
  ...
  inline UpdatePolicyResult& WithFirewallType(PolicyFirewallType value) {
  ...
  template <typename PolicyConfigurationT = PolicyConfiguration>
  UpdatePolicyResult& WithPolicyConfiguration(PolicyConfigurationT&& value) {
