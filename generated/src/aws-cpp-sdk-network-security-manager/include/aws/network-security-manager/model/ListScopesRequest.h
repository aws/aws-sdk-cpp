...
/**
 */
class ListScopesRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListScopesRequest() = default;
  ...
  inline ListScopesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListScopesRequest& WithNextToken(NextTokenT&& value) {
  ...
  ///@{
  /**
   * <p>Filters the results by status: <code>ACTIVE</code>, <code>DRAFT</code>, or
  ...
  inline ListScopesRequest& WithStatus(EntityStatusFilter value) {
    SetStatus(value);
    return *this;
  }
  ///@}
