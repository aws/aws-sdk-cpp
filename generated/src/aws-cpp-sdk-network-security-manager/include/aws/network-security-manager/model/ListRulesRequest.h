...
/**
 */
class ListRulesRequest : public NetworkSecurityManagerRequest {
 public:
  AWS_NETWORKSECURITYMANAGER_API ListRulesRequest() = default;
  ...
  inline ListRulesRequest& WithStatus(EntityStatusFilter value) {
    SetStatus(value);
    return *this;
  }
  ///@}
