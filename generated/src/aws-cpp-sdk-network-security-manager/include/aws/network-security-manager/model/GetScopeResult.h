...
class GetScopeResult {
 public:
  AWS_NETWORKSECURITYMANAGER_API GetScopeResult() = default;
  AWS_NETWORKSECURITYMANAGER_API GetScopeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_NETWORKSECURITYMANAGER_API GetScopeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ScopeIdT = Aws::String>
  GetScopeResult& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename ScopeArnT = Aws::String>
  GetScopeResult& WithScopeArn(ScopeArnT&& value) {
  ...
  template <typename ScopeNameT = Aws::String>
  GetScopeResult& WithScopeName(ScopeNameT&& value) {
  ...
  template <typename ScopeDescriptionT = Aws::String>
  GetScopeResult& WithScopeDescription(ScopeDescriptionT&& value) {
  ...
  template <typename ScopeConfigurationT = ScopeConfiguration>
  GetScopeResult& WithScopeConfiguration(ScopeConfigurationT&& value) {
  ...
  inline GetScopeResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename VersionT = Aws::String>
  GetScopeResult& WithVersion(VersionT&& value) {
  ...
  template <typename UpdateTokenT = Aws::String>
  GetScopeResult& WithUpdateToken(UpdateTokenT&& value) {
  ...
  inline GetScopeResult& WithIsSnapshot(bool value) {
    SetIsSnapshot(value);
    return *this;
  }
  ///@}
  ...
  inline GetScopeResult& WithHasPublishedVersion(bool value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetScopeResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetScopeResult& WithRequestId(RequestIdT&& value) {
