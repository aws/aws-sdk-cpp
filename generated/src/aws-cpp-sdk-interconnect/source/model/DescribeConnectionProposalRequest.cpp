...
Aws::String DescribeConnectionProposalRequest::SerializePayload() const {
...
Aws::Http::HeaderValueCollection DescribeConnectionProposalRequest::GetRequestSpecificHeaders() const {
