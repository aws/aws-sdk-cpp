...
/**
 */
class ListAttachPointsRequest : public InterconnectRequest {
 public:
  AWS_INTERCONNECT_API ListAttachPointsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAttachPoints"; }
  ...
  ///@{
  /**
   * <p>The identifier of the <a>Environment</a> for which to list valid Attach
   * Points.</p>
   */
  ...
  template <typename EnvironmentIdT = Aws::String>
  ListAttachPointsRequest& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  inline ListAttachPointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAttachPointsRequest& WithNextToken(NextTokenT&& value) {
