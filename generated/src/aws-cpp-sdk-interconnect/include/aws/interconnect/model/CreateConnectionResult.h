...
class CreateConnectionResult {
 public:
  AWS_INTERCONNECT_API CreateConnectionResult() = default;
  AWS_INTERCONNECT_API CreateConnectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_INTERCONNECT_API CreateConnectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
