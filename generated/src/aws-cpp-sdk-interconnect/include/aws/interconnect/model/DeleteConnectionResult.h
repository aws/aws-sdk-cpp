...
class DeleteConnectionResult {
 public:
  AWS_INTERCONNECT_API DeleteConnectionResult() = default;
  AWS_INTERCONNECT_API DeleteConnectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_INTERCONNECT_API DeleteConnectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
