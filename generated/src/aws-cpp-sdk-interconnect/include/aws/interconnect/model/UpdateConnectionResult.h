...
class UpdateConnectionResult {
 public:
  AWS_INTERCONNECT_API UpdateConnectionResult() = default;
  AWS_INTERCONNECT_API UpdateConnectionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_INTERCONNECT_API UpdateConnectionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
