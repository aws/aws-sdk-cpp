...
class AWS_AIOPS_API AIOpsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AIOpsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AIOpsEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateInvestigationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInvestigationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInvestigationGroupRequestT = Model::CreateInvestigationGroupRequest>
  void CreateInvestigationGroupAsync(const CreateInvestigationGroupRequestT& request,
                                     const CreateInvestigationGroupResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteInvestigationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInvestigationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInvestigationGroupRequestT = Model::DeleteInvestigationGroupRequest>
  void DeleteInvestigationGroupAsync(const DeleteInvestigationGroupRequestT& request,
                                     const DeleteInvestigationGroupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteInvestigationGroupPolicyOutcome DeleteInvestigationGroupPolicy(
      const Model::DeleteInvestigationGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteInvestigationGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteInvestigationGroupPolicyRequestT = Model::DeleteInvestigationGroupPolicyRequest>
  Model::DeleteInvestigationGroupPolicyOutcomeCallable DeleteInvestigationGroupPolicyCallable(
      const DeleteInvestigationGroupPolicyRequestT& request) const {
    return SubmitCallable(&AIOpsClient::DeleteInvestigationGroupPolicy, request);
  }

  /**
   * An Async wrapper for DeleteInvestigationGroupPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteInvestigationGroupPolicyRequestT = Model::DeleteInvestigationGroupPolicyRequest>
  void DeleteInvestigationGroupPolicyAsync(const DeleteInvestigationGroupPolicyRequestT& request,
                                           const DeleteInvestigationGroupPolicyResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetInvestigationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInvestigationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInvestigationGroupRequestT = Model::GetInvestigationGroupRequest>
  void GetInvestigationGroupAsync(const GetInvestigationGroupRequestT& request, const GetInvestigationGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetInvestigationGroupPolicyOutcome GetInvestigationGroupPolicy(
      const Model::GetInvestigationGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetInvestigationGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetInvestigationGroupPolicyRequestT = Model::GetInvestigationGroupPolicyRequest>
  Model::GetInvestigationGroupPolicyOutcomeCallable GetInvestigationGroupPolicyCallable(
      const GetInvestigationGroupPolicyRequestT& request) const {
    return SubmitCallable(&AIOpsClient::GetInvestigationGroupPolicy, request);
  }

  /**
   * An Async wrapper for GetInvestigationGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetInvestigationGroupPolicyRequestT = Model::GetInvestigationGroupPolicyRequest>
  void GetInvestigationGroupPolicyAsync(const GetInvestigationGroupPolicyRequestT& request,
                                        const GetInvestigationGroupPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListInvestigationGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInvestigationGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInvestigationGroupsRequestT = Model::ListInvestigationGroupsRequest>
  void ListInvestigationGroupsAsync(const ListInvestigationGroupsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListInvestigationGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutInvestigationGroupPolicyOutcome PutInvestigationGroupPolicy(
      const Model::PutInvestigationGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutInvestigationGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutInvestigationGroupPolicyRequestT = Model::PutInvestigationGroupPolicyRequest>
  Model::PutInvestigationGroupPolicyOutcomeCallable PutInvestigationGroupPolicyCallable(
      const PutInvestigationGroupPolicyRequestT& request) const {
    return SubmitCallable(&AIOpsClient::PutInvestigationGroupPolicy, request);
  }

  /**
   * An Async wrapper for PutInvestigationGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutInvestigationGroupPolicyRequestT = Model::PutInvestigationGroupPolicyRequest>
  void PutInvestigationGroupPolicyAsync(const PutInvestigationGroupPolicyRequestT& request,
                                        const PutInvestigationGroupPolicyResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInvestigationGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInvestigationGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInvestigationGroupRequestT = Model::UpdateInvestigationGroupRequest>
  void UpdateInvestigationGroupAsync(const UpdateInvestigationGroupRequestT& request,
                                     const UpdateInvestigationGroupResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
