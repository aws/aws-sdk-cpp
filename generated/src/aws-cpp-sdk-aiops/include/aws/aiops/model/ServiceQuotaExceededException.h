...
namespace Model
{
  ...
  /**
   * <p>This request exceeds a service quota.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/aiops-2018-05-10/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_AIOPS_API ServiceQuotaExceededException() = default;
    AWS_AIOPS_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
