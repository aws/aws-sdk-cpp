...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public AIOpsRequest
  {
  public:
    AWS_AIOPS_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource that you want to apply the
     * tags to. You can use the <code>ListInvestigationGroups</code> operation to find
