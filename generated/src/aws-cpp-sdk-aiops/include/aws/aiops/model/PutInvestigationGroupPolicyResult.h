...
class PutInvestigationGroupPolicyResult {
 public:
  ...
  template <typename InvestigationGroupArnT = Aws::String>
  PutInvestigationGroupPolicyResult& WithInvestigationGroupArn(InvestigationGroupArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutInvestigationGroupPolicyResult& WithRequestId(RequestIdT&& value) {
