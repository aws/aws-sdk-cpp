...
class GetInvestigationGroupResult {
 public:
  ...
  inline GetInvestigationGroupResult& WithCreatedAt(long long value) {
    SetCreatedAt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastModifiedAt(long long value) {
    m_lastModifiedAtHasBeenSet = true;
    m_lastModifiedAt = value;
  }
  inline GetInvestigationGroupResult& WithLastModifiedAt(long long value) {
  ...
  inline GetInvestigationGroupResult& WithRetentionInDays(long long value) {
  ...
  GetInvestigationGroupResult& AddChatbotNotificationChannel(ChatbotNotificationChannelKeyT&& key,
  ...
  inline GetInvestigationGroupResult& WithIsCloudTrailEventHistoryEnabled(bool value) {
