...
class UpdateInvestigationGroupRequest : public AIOpsRequest {
 public:
  ...
  UpdateInvestigationGroupRequest& AddChatbotNotificationChannel(ChatbotNotificationChannelKeyT&& key,
  ...
  inline UpdateInvestigationGroupRequest& WithIsCloudTrailEventHistoryEnabled(bool value) {
