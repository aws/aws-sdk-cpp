...
/**
 */
class CreateInvestigationGroupRequest : public AIOpsRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateInvestigationGroup"; }
  ...
  ///@{
  /**
   * <p>Specify how long that investigation data is kept. For more information, see
   * <a
   * href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Investigations-Retention.html">Operational
   * investigation data retention</a>. </p> <p>If you omit this parameter, the
   * default of 90 days is used.</p>
   */
  ...
  inline void SetRetentionInDays(long long value) {
    m_retentionInDaysHasBeenSet = true;
    m_retentionInDays = value;
  }
  inline CreateInvestigationGroupRequest& WithRetentionInDays(long long value) {
  ...
  ///@{
  /**
   * <p>A list of key-value pairs to associate with the investigation group. You can
   ...
   * <code>cloudwatch:TagResource</code> permission.</p> <p>Tags can help you
  ...
  void SetTagKeyBoundaries(TagKeyBoundariesT&& value) {
    ...
    m_tagKeyBoundaries = std::forward<TagKeyBoundariesT>(value);
  }
  template <typename TagKeyBoundariesT = Aws::Vector<Aws::String>>
  CreateInvestigationGroupRequest& WithTagKeyBoundaries(TagKeyBoundariesT&& value) {
    SetTagKeyBoundaries(std::forward<TagKeyBoundariesT>(value));
    return *this;
  }
  ...
  CreateInvestigationGroupRequest& AddTagKeyBoundaries(TagKeyBoundariesT&& value) {
    m_tagKeyBoundariesHasBeenSet = true;
    m_tagKeyBoundaries.emplace_back(std::forward<TagKeyBoundariesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<Aws::String, Aws::Vector<Aws::String>>& GetChatbotNotificationChannel() const {
    return m_chatbotNotificationChannel;
  }
  ...
  void SetChatbotNotificationChannel(ChatbotNotificationChannelT&& value) {
    ...
    m_chatbotNotificationChannel = std::forward<ChatbotNotificationChannelT>(value);
  }
  template <typename ChatbotNotificationChannelT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  CreateInvestigationGroupRequest& WithChatbotNotificationChannel(ChatbotNotificationChannelT&& value) {
    SetChatbotNotificationChannel(std::forward<ChatbotNotificationChannelT>(value));
    return *this;
  }
  ...
  CreateInvestigationGroupRequest& AddChatbotNotificationChannel(ChatbotNotificationChannelKeyT&& key,
                                                                 ChatbotNotificationChannelValueT&& value) {
    m_chatbotNotificationChannelHasBeenSet = true;
    m_chatbotNotificationChannel.emplace(std::forward<ChatbotNotificationChannelKeyT>(key),
                                         std::forward<ChatbotNotificationChannelValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsCloudTrailEventHistoryEnabled(bool value) {
    m_isCloudTrailEventHistoryEnabledHasBeenSet = true;
    m_isCloudTrailEventHistoryEnabled = value;
  }
  inline CreateInvestigationGroupRequest& WithIsCloudTrailEventHistoryEnabled(bool value) {
    SetIsCloudTrailEventHistoryEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCrossAccountConfigurations(CrossAccountConfigurationsT&& value) {
    ...
    m_crossAccountConfigurations = std::forward<CrossAccountConfigurationsT>(value);
  }
  template <typename CrossAccountConfigurationsT = Aws::Vector<CrossAccountConfiguration>>
  CreateInvestigationGroupRequest& WithCrossAccountConfigurations(CrossAccountConfigurationsT&& value) {
    SetCrossAccountConfigurations(std::forward<CrossAccountConfigurationsT>(value));
    return *this;
  }
  ...
  CreateInvestigationGroupRequest& AddCrossAccountConfigurations(CrossAccountConfigurationsT&& value) {
    m_crossAccountConfigurationsHasBeenSet = true;
    m_crossAccountConfigurations.emplace_back(std::forward<CrossAccountConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
