...
ExternalSystemsConfiguration::ExternalSystemsConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ExternalSystemsConfiguration& ExternalSystemsConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SessionBorderControllerTypes")) {
    ...
    for (unsigned sessionBorderControllerTypesIndex = 0;
         sessionBorderControllerTypesIndex < sessionBorderControllerTypesJsonList.GetLength(); ++sessionBorderControllerTypesIndex) {
      m_sessionBorderControllerTypes.push_back(SessionBorderControllerTypeMapper::GetSessionBorderControllerTypeForName(
          sessionBorderControllerTypesJsonList[sessionBorderControllerTypesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("ContactCenterSystemTypes")) {
    ...
    for (unsigned contactCenterSystemTypesIndex = 0; contactCenterSystemTypesIndex < contactCenterSystemTypesJsonList.GetLength();
         ++contactCenterSystemTypesIndex) {
      m_contactCenterSystemTypes.push_back(ContactCenterSystemTypeMapper::GetContactCenterSystemTypeForName(
          contactCenterSystemTypesJsonList[contactCenterSystemTypesIndex].AsString()));
    }
...
JsonValue ExternalSystemsConfiguration::Jsonize() const {
  ...
  if (m_sessionBorderControllerTypesHasBeenSet) {
    ...
    for (unsigned sessionBorderControllerTypesIndex = 0;
         sessionBorderControllerTypesIndex < sessionBorderControllerTypesJsonList.GetLength(); ++sessionBorderControllerTypesIndex) {
      sessionBorderControllerTypesJsonList[sessionBorderControllerTypesIndex].AsString(
          SessionBorderControllerTypeMapper::GetNameForSessionBorderControllerType(
              m_sessionBorderControllerTypes[sessionBorderControllerTypesIndex]));
    }
  ...
  if (m_contactCenterSystemTypesHasBeenSet) {
    ...
    for (unsigned contactCenterSystemTypesIndex = 0; contactCenterSystemTypesIndex < contactCenterSystemTypesJsonList.GetLength();
         ++contactCenterSystemTypesIndex) {
      contactCenterSystemTypesJsonList[contactCenterSystemTypesIndex].AsString(
          ContactCenterSystemTypeMapper::GetNameForContactCenterSystemType(m_contactCenterSystemTypes[contactCenterSystemTypesIndex]));
    }
