...
ProxySession::ProxySession(JsonView jsonValue) { *this = jsonValue; }
...
ProxySession& ProxySession::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("NumberSelectionBehavior")) {
    m_numberSelectionBehavior =
        NumberSelectionBehaviorMapper::GetNumberSelectionBehaviorForName(jsonValue.GetString("NumberSelectionBehavior"));
