...
ListAvailableVoiceConnectorRegionsResult& ListAvailableVoiceConnectorRegionsResult::operator=(
  ...
  if (jsonValue.ValueExists("VoiceConnectorRegions")) {
    ...
    for (unsigned voiceConnectorRegionsIndex = 0; voiceConnectorRegionsIndex < voiceConnectorRegionsJsonList.GetLength();
         ++voiceConnectorRegionsIndex) {
      m_voiceConnectorRegions.push_back(VoiceConnectorAwsRegionMapper::GetVoiceConnectorAwsRegionForName(
          voiceConnectorRegionsJsonList[voiceConnectorRegionsIndex].AsString()));
    }
