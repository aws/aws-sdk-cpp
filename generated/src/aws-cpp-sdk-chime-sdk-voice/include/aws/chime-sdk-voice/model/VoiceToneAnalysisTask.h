...
class VoiceToneAnalysisTask {
 public:
  ...
  void SetVoiceToneAnalysisTaskStatus(VoiceToneAnalysisTaskStatusT&& value) {
    m_voiceToneAnalysisTaskStatusHasBeenSet = true;
    m_voiceToneAnalysisTaskStatus = std::forward<VoiceToneAnalysisTaskStatusT>(value);
  }
  template <typename VoiceToneAnalysisTaskStatusT = Aws::String>
  VoiceToneAnalysisTask& WithVoiceToneAnalysisTaskStatus(VoiceToneAnalysisTaskStatusT&& value) {
    SetVoiceToneAnalysisTaskStatus(std::forward<VoiceToneAnalysisTaskStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CallDetailsT = CallDetails>
  VoiceToneAnalysisTask& WithCallDetails(CallDetailsT&& value) {
  ...
  template <typename StartedTimestampT = Aws::Utils::DateTime>
  VoiceToneAnalysisTask& WithStartedTimestamp(StartedTimestampT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  VoiceToneAnalysisTask& WithStatusMessage(StatusMessageT&& value) {
