...
class OriginationRoute {
 public:
  ...
  template <typename HostT = Aws::String>
  OriginationRoute& WithHost(HostT&& value) {
  ...
  inline OriginationRoute& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProtocol(OriginationRouteProtocol value) {
    m_protocolHasBeenSet = true;
    m_protocol = value;
  }
  inline OriginationRoute& WithProtocol(OriginationRouteProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline OriginationRoute& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline OriginationRoute& WithWeight(int value) {
    SetWeight(value);
    return *this;
  }
  ///@}
