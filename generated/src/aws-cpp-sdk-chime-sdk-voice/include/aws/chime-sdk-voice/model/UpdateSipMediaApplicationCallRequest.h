...
class UpdateSipMediaApplicationCallRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename SipMediaApplicationIdT = Aws::String>
  UpdateSipMediaApplicationCallRequest& WithSipMediaApplicationId(SipMediaApplicationIdT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  UpdateSipMediaApplicationCallRequest& WithTransactionId(TransactionIdT&& value) {
  ...
  template <typename ArgumentsT = Aws::Map<Aws::String, Aws::String>>
  UpdateSipMediaApplicationCallRequest& WithArguments(ArgumentsT&& value) {
