...
class PutVoiceConnectorStreamingConfigurationRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  PutVoiceConnectorStreamingConfigurationRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename StreamingConfigurationT = StreamingConfiguration>
  PutVoiceConnectorStreamingConfigurationRequest& WithStreamingConfiguration(StreamingConfigurationT&& value) {
