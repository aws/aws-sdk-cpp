...
class GeoMatchParams {
 public:
  ...
  template <typename CountryT = Aws::String>
  GeoMatchParams& WithCountry(CountryT&& value) {
  ...
  void SetAreaCode(AreaCodeT&& value) {
    ...
    m_areaCode = std::forward<AreaCodeT>(value);
  }
  template <typename AreaCodeT = Aws::String>
  GeoMatchParams& WithAreaCode(AreaCodeT&& value) {
    SetAreaCode(std::forward<AreaCodeT>(value));
    return *this;
  }
  ///@}
 private:
