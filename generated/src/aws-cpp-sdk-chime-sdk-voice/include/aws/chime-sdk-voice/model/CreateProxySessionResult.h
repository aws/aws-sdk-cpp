...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API CreateProxySessionResult() = default;
    ...
    template<typename ProxySessionT = ProxySession>
    CreateProxySessionResult& WithProxySession(ProxySessionT&& value) { SetProxySession(std::forward<ProxySessionT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateProxySessionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
