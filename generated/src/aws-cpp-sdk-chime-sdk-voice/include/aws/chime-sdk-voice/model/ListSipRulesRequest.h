...
class ListSipRulesRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename SipMediaApplicationIdT = Aws::String>
  ListSipRulesRequest& WithSipMediaApplicationId(SipMediaApplicationIdT&& value) {
  ...
  inline ListSipRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSipRulesRequest& WithNextToken(NextTokenT&& value) {
