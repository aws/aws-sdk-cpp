...
namespace Model
{
  ...
  /**
   */
  class DeleteVoiceConnectorProxyRequest : public ChimeSDKVoiceRequest
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteVoiceConnectorProxyRequest() = default;
    ...
    template<typename VoiceConnectorIdT = Aws::String>
    DeleteVoiceConnectorProxyRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) { SetVoiceConnectorId(std::forward<VoiceConnectorIdT>(value)); return *this;}
    ///@}
  private:
