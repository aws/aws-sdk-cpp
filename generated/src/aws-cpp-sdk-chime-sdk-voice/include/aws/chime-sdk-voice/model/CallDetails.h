...
class CallDetails {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  CallDetails& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  CallDetails& WithTransactionId(TransactionIdT&& value) {
  ...
  inline void SetIsCaller(bool value) {
    m_isCallerHasBeenSet = true;
    m_isCaller = value;
  }
  inline CallDetails& WithIsCaller(bool value) {
    SetIsCaller(value);
    return *this;
  }
  ///@}
