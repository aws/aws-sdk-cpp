...
class PutVoiceConnectorOriginationResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API PutVoiceConnectorOriginationResult& operator=(
  ...
  template <typename OriginationT = Origination>
  PutVoiceConnectorOriginationResult& WithOrigination(OriginationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutVoiceConnectorOriginationResult& WithRequestId(RequestIdT&& value) {
