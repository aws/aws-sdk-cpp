...
class CreateVoiceConnectorGroupRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateVoiceConnectorGroupRequest& WithName(NameT&& value) {
  ...
  template <typename VoiceConnectorItemsT = Aws::Vector<VoiceConnectorItem>>
  CreateVoiceConnectorGroupRequest& WithVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    SetVoiceConnectorItems(std::forward<VoiceConnectorItemsT>(value));
    return *this;
  }
  template <typename VoiceConnectorItemsT = VoiceConnectorItem>
  CreateVoiceConnectorGroupRequest& AddVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    m_voiceConnectorItemsHasBeenSet = true;
  ...
  inline CreateVoiceConnectorGroupRequest& WithCallDistributionType(CallDistributionType value) {
