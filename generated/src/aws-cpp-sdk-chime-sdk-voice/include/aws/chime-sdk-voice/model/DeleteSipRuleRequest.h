...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteSipRuleRequest() = default;
    ...
    template<typename SipRuleIdT = Aws::String>
    DeleteSipRuleRequest& WithSipRuleId(SipRuleIdT&& value) { SetSipRuleId(std::forward<SipRuleIdT>(value)); return *this;}
    ///@}
  private:
