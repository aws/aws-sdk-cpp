...
class ValidateE911AddressResult {
 public:
  ...
  inline void SetValidationResult(int value) {
    m_validationResultHasBeenSet = true;
    m_validationResult = value;
  }
  inline ValidateE911AddressResult& WithValidationResult(int value) {
  ...
  void SetAddressExternalId(AddressExternalIdT&& value) {
    m_addressExternalIdHasBeenSet = true;
    m_addressExternalId = std::forward<AddressExternalIdT>(value);
  }
  template <typename AddressExternalIdT = Aws::String>
  ValidateE911AddressResult& WithAddressExternalId(AddressExternalIdT&& value) {
    SetAddressExternalId(std::forward<AddressExternalIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AddressT = Address>
  ValidateE911AddressResult& WithAddress(AddressT&& value) {
  ...
  void SetCandidateAddressList(CandidateAddressListT&& value) {
    m_candidateAddressListHasBeenSet = true;
    m_candidateAddressList = std::forward<CandidateAddressListT>(value);
  }
  template <typename CandidateAddressListT = Aws::Vector<CandidateAddress>>
  ValidateE911AddressResult& WithCandidateAddressList(CandidateAddressListT&& value) {
    SetCandidateAddressList(std::forward<CandidateAddressListT>(value));
    return *this;
  }
  template <typename CandidateAddressListT = CandidateAddress>
  ValidateE911AddressResult& AddCandidateAddressList(CandidateAddressListT&& value) {
    m_candidateAddressListHasBeenSet = true;
    m_candidateAddressList.emplace_back(std::forward<CandidateAddressListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ValidateE911AddressResult& WithRequestId(RequestIdT&& value) {
