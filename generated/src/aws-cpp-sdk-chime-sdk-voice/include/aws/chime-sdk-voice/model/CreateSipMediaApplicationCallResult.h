...
class CreateSipMediaApplicationCallResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API CreateSipMediaApplicationCallResult& operator=(
  ...
  template <typename SipMediaApplicationCallT = SipMediaApplicationCall>
  CreateSipMediaApplicationCallResult& WithSipMediaApplicationCall(SipMediaApplicationCallT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSipMediaApplicationCallResult& WithRequestId(RequestIdT&& value) {
