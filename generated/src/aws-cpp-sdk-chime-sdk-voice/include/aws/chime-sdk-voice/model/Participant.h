...
class Participant {
 public:
  ...
  template <typename PhoneNumberT = Aws::String>
  Participant& WithPhoneNumber(PhoneNumberT&& value) {
  ...
  void SetProxyPhoneNumber(ProxyPhoneNumberT&& value) {
    m_proxyPhoneNumberHasBeenSet = true;
    m_proxyPhoneNumber = std::forward<ProxyPhoneNumberT>(value);
  }
  template <typename ProxyPhoneNumberT = Aws::String>
  Participant& WithProxyPhoneNumber(ProxyPhoneNumberT&& value) {
    SetProxyPhoneNumber(std::forward<ProxyPhoneNumberT>(value));
    return *this;
  }
  ///@}
 private:
