...
class ListSipMediaApplicationsResult {
 public:
  ...
  void SetSipMediaApplications(SipMediaApplicationsT&& value) {
    m_sipMediaApplicationsHasBeenSet = true;
    m_sipMediaApplications = std::forward<SipMediaApplicationsT>(value);
  }
  template <typename SipMediaApplicationsT = Aws::Vector<SipMediaApplication>>
  ListSipMediaApplicationsResult& WithSipMediaApplications(SipMediaApplicationsT&& value) {
    SetSipMediaApplications(std::forward<SipMediaApplicationsT>(value));
    return *this;
  }
  template <typename SipMediaApplicationsT = SipMediaApplication>
  ListSipMediaApplicationsResult& AddSipMediaApplications(SipMediaApplicationsT&& value) {
    m_sipMediaApplicationsHasBeenSet = true;
    m_sipMediaApplications.emplace_back(std::forward<SipMediaApplicationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSipMediaApplicationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSipMediaApplicationsResult& WithRequestId(RequestIdT&& value) {
