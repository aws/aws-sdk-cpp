...
class VoiceProfileSummary {
 public:
  ...
  template <typename VoiceProfileIdT = Aws::String>
  VoiceProfileSummary& WithVoiceProfileId(VoiceProfileIdT&& value) {
  ...
  void SetVoiceProfileArn(VoiceProfileArnT&& value) {
    m_voiceProfileArnHasBeenSet = true;
    m_voiceProfileArn = std::forward<VoiceProfileArnT>(value);
  }
  template <typename VoiceProfileArnT = Aws::String>
  VoiceProfileSummary& WithVoiceProfileArn(VoiceProfileArnT&& value) {
    SetVoiceProfileArn(std::forward<VoiceProfileArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VoiceProfileDomainIdT = Aws::String>
  VoiceProfileSummary& WithVoiceProfileDomainId(VoiceProfileDomainIdT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  VoiceProfileSummary& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  VoiceProfileSummary& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  template <typename ExpirationTimestampT = Aws::Utils::DateTime>
  VoiceProfileSummary& WithExpirationTimestamp(ExpirationTimestampT&& value) {
