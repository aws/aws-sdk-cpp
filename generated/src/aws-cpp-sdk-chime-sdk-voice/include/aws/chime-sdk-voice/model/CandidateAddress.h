...
class CandidateAddress {
 public:
  ...
  template <typename StreetInfoT = Aws::String>
  CandidateAddress& WithStreetInfo(StreetInfoT&& value) {
  ...
  template <typename StreetNumberT = Aws::String>
  CandidateAddress& WithStreetNumber(StreetNumberT&& value) {
  ...
  template <typename CityT = Aws::String>
  CandidateAddress& WithCity(CityT&& value) {
  ...
  template <typename StateT = Aws::String>
  CandidateAddress& WithState(StateT&& value) {
  ...
  template <typename PostalCodeT = Aws::String>
  CandidateAddress& WithPostalCode(PostalCodeT&& value) {
  ...
  void SetPostalCodePlus4(PostalCodePlus4T&& value) {
    m_postalCodePlus4HasBeenSet = true;
    m_postalCodePlus4 = std::forward<PostalCodePlus4T>(value);
  }
  template <typename PostalCodePlus4T = Aws::String>
  CandidateAddress& WithPostalCodePlus4(PostalCodePlus4T&& value) {
    SetPostalCodePlus4(std::forward<PostalCodePlus4T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CountryT = Aws::String>
  CandidateAddress& WithCountry(CountryT&& value) {
