...
class ExternalSystemsConfiguration {
 public:
  ...
  void SetSessionBorderControllerTypes(SessionBorderControllerTypesT&& value) {
    m_sessionBorderControllerTypesHasBeenSet = true;
    m_sessionBorderControllerTypes = std::forward<SessionBorderControllerTypesT>(value);
  }
  template <typename SessionBorderControllerTypesT = Aws::Vector<SessionBorderControllerType>>
  ExternalSystemsConfiguration& WithSessionBorderControllerTypes(SessionBorderControllerTypesT&& value) {
    SetSessionBorderControllerTypes(std::forward<SessionBorderControllerTypesT>(value));
    return *this;
  }
  inline ExternalSystemsConfiguration& AddSessionBorderControllerTypes(SessionBorderControllerType value) {
    m_sessionBorderControllerTypesHasBeenSet = true;
    m_sessionBorderControllerTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetContactCenterSystemTypes(ContactCenterSystemTypesT&& value) {
    m_contactCenterSystemTypesHasBeenSet = true;
    m_contactCenterSystemTypes = std::forward<ContactCenterSystemTypesT>(value);
  }
  template <typename ContactCenterSystemTypesT = Aws::Vector<ContactCenterSystemType>>
  ExternalSystemsConfiguration& WithContactCenterSystemTypes(ContactCenterSystemTypesT&& value) {
    SetContactCenterSystemTypes(std::forward<ContactCenterSystemTypesT>(value));
    return *this;
  }
  inline ExternalSystemsConfiguration& AddContactCenterSystemTypes(ContactCenterSystemType value) {
    m_contactCenterSystemTypesHasBeenSet = true;
    m_contactCenterSystemTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
