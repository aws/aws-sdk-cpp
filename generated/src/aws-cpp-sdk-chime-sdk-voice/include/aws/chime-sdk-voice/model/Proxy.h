...
class Proxy {
 public:
  ...
  inline void SetDefaultSessionExpiryMinutes(int value) {
    m_defaultSessionExpiryMinutesHasBeenSet = true;
    m_defaultSessionExpiryMinutes = value;
  }
  inline Proxy& WithDefaultSessionExpiryMinutes(int value) {
    SetDefaultSessionExpiryMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline Proxy& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetFallBackPhoneNumber(FallBackPhoneNumberT&& value) {
    m_fallBackPhoneNumberHasBeenSet = true;
    m_fallBackPhoneNumber = std::forward<FallBackPhoneNumberT>(value);
  }
  template <typename FallBackPhoneNumberT = Aws::String>
  Proxy& WithFallBackPhoneNumber(FallBackPhoneNumberT&& value) {
    SetFallBackPhoneNumber(std::forward<FallBackPhoneNumberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PhoneNumberCountriesT = Aws::Vector<Aws::String>>
  Proxy& WithPhoneNumberCountries(PhoneNumberCountriesT&& value) {
    SetPhoneNumberCountries(std::forward<PhoneNumberCountriesT>(value));
    return *this;
  }
  template <typename PhoneNumberCountriesT = Aws::String>
  Proxy& AddPhoneNumberCountries(PhoneNumberCountriesT&& value) {
    m_phoneNumberCountriesHasBeenSet = true;
