...
class PutVoiceConnectorStreamingConfigurationResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API PutVoiceConnectorStreamingConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename StreamingConfigurationT = StreamingConfiguration>
  PutVoiceConnectorStreamingConfigurationResult& WithStreamingConfiguration(StreamingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutVoiceConnectorStreamingConfigurationResult& WithRequestId(RequestIdT&& value) {
