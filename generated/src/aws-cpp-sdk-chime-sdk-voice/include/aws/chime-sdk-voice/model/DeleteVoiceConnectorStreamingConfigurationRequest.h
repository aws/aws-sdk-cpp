...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteVoiceConnectorStreamingConfigurationRequest() = default;
    ...
    template<typename VoiceConnectorIdT = Aws::String>
    DeleteVoiceConnectorStreamingConfigurationRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) { SetVoiceConnectorId(std::forward<VoiceConnectorIdT>(value)); return *this;}
    ///@}
  private:
