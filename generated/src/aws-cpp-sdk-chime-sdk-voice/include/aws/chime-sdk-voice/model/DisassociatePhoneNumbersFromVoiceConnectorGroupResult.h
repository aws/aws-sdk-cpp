...
class DisassociatePhoneNumbersFromVoiceConnectorGroupResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API DisassociatePhoneNumbersFromVoiceConnectorGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PhoneNumberErrorsT = Aws::Vector<PhoneNumberError>>
  DisassociatePhoneNumbersFromVoiceConnectorGroupResult& WithPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    SetPhoneNumberErrors(std::forward<PhoneNumberErrorsT>(value));
    return *this;
  }
  template <typename PhoneNumberErrorsT = PhoneNumberError>
  DisassociatePhoneNumbersFromVoiceConnectorGroupResult& AddPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    m_phoneNumberErrorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorGroupResult& WithRequestId(RequestIdT&& value) {
