...
class PutVoiceConnectorExternalSystemsConfigurationRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  PutVoiceConnectorExternalSystemsConfigurationRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename SessionBorderControllerTypesT = Aws::Vector<SessionBorderControllerType>>
  PutVoiceConnectorExternalSystemsConfigurationRequest& WithSessionBorderControllerTypes(SessionBorderControllerTypesT&& value) {
    SetSessionBorderControllerTypes(std::forward<SessionBorderControllerTypesT>(value));
    return *this;
  }
  inline PutVoiceConnectorExternalSystemsConfigurationRequest& AddSessionBorderControllerTypes(SessionBorderControllerType value) {
    m_sessionBorderControllerTypesHasBeenSet = true;
  ...
  template <typename ContactCenterSystemTypesT = Aws::Vector<ContactCenterSystemType>>
  PutVoiceConnectorExternalSystemsConfigurationRequest& WithContactCenterSystemTypes(ContactCenterSystemTypesT&& value) {
    SetContactCenterSystemTypes(std::forward<ContactCenterSystemTypesT>(value));
    return *this;
  }
  inline PutVoiceConnectorExternalSystemsConfigurationRequest& AddContactCenterSystemTypes(ContactCenterSystemType value) {
    m_contactCenterSystemTypesHasBeenSet = true;
