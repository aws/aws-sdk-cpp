...
class AssociatePhoneNumbersWithVoiceConnectorGroupResult {
 public:
  AWS_CHIMESDKVOICE_API AssociatePhoneNumbersWithVoiceConnectorGroupResult() = default;
  AWS_CHIMESDKVOICE_API AssociatePhoneNumbersWithVoiceConnectorGroupResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CHIMESDKVOICE_API AssociatePhoneNumbersWithVoiceConnectorGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    ...
    m_phoneNumberErrors = std::forward<PhoneNumberErrorsT>(value);
  }
  template <typename PhoneNumberErrorsT = Aws::Vector<PhoneNumberError>>
  AssociatePhoneNumbersWithVoiceConnectorGroupResult& WithPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    SetPhoneNumberErrors(std::forward<PhoneNumberErrorsT>(value));
    return *this;
  }
  template <typename PhoneNumberErrorsT = PhoneNumberError>
  AssociatePhoneNumbersWithVoiceConnectorGroupResult& AddPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    m_phoneNumberErrorsHasBeenSet = true;
    m_phoneNumberErrors.emplace_back(std::forward<PhoneNumberErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociatePhoneNumbersWithVoiceConnectorGroupResult& WithRequestId(RequestIdT&& value) {
