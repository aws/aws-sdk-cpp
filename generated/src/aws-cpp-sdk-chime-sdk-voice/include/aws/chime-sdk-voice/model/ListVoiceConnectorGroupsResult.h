...
class ListVoiceConnectorGroupsResult {
 public:
  ...
  void SetVoiceConnectorGroups(VoiceConnectorGroupsT&& value) {
    m_voiceConnectorGroupsHasBeenSet = true;
    m_voiceConnectorGroups = std::forward<VoiceConnectorGroupsT>(value);
  }
  template <typename VoiceConnectorGroupsT = Aws::Vector<VoiceConnectorGroup>>
  ListVoiceConnectorGroupsResult& WithVoiceConnectorGroups(VoiceConnectorGroupsT&& value) {
    SetVoiceConnectorGroups(std::forward<VoiceConnectorGroupsT>(value));
    return *this;
  }
  template <typename VoiceConnectorGroupsT = VoiceConnectorGroup>
  ListVoiceConnectorGroupsResult& AddVoiceConnectorGroups(VoiceConnectorGroupsT&& value) {
    m_voiceConnectorGroupsHasBeenSet = true;
    m_voiceConnectorGroups.emplace_back(std::forward<VoiceConnectorGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVoiceConnectorGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVoiceConnectorGroupsResult& WithRequestId(RequestIdT&& value) {
