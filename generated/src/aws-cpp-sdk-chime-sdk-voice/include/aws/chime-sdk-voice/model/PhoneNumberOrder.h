...
class PhoneNumberOrder {
 public:
  ...
  inline PhoneNumberOrder& WithProductType(PhoneNumberProductType value) {
  ...
  inline void SetStatus(PhoneNumberOrderStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PhoneNumberOrder& WithStatus(PhoneNumberOrderStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOrderType(PhoneNumberOrderType value) {
    m_orderTypeHasBeenSet = true;
    m_orderType = value;
  }
  inline PhoneNumberOrder& WithOrderType(PhoneNumberOrderType value) {
    SetOrderType(value);
    return *this;
  }
  ///@}
  ...
  void SetOrderedPhoneNumbers(OrderedPhoneNumbersT&& value) {
    ...
    m_orderedPhoneNumbers = std::forward<OrderedPhoneNumbersT>(value);
  }
  template <typename OrderedPhoneNumbersT = Aws::Vector<OrderedPhoneNumber>>
  PhoneNumberOrder& WithOrderedPhoneNumbers(OrderedPhoneNumbersT&& value) {
    SetOrderedPhoneNumbers(std::forward<OrderedPhoneNumbersT>(value));
    return *this;
  }
  ...
  PhoneNumberOrder& AddOrderedPhoneNumbers(OrderedPhoneNumbersT&& value) {
    m_orderedPhoneNumbersHasBeenSet = true;
    m_orderedPhoneNumbers.emplace_back(std::forward<OrderedPhoneNumbersT>(value));
    return *this;
  }
  ///@}
