...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API CreateVoiceConnectorGroupResult() = default;
    ...
    template<typename VoiceConnectorGroupT = VoiceConnectorGroup>
    CreateVoiceConnectorGroupResult& WithVoiceConnectorGroup(VoiceConnectorGroupT&& value) { SetVoiceConnectorGroup(std::forward<VoiceConnectorGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateVoiceConnectorGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
