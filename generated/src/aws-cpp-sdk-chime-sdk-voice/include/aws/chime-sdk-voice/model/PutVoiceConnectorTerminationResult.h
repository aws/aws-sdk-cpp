...
class PutVoiceConnectorTerminationResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API PutVoiceConnectorTerminationResult& operator=(
  ...
  template <typename TerminationT = Termination>
  PutVoiceConnectorTerminationResult& WithTermination(TerminationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutVoiceConnectorTerminationResult& WithRequestId(RequestIdT&& value) {
