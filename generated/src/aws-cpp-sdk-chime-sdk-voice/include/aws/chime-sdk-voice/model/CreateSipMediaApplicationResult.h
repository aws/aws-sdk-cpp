...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API CreateSipMediaApplicationResult() = default;
    ...
    template<typename SipMediaApplicationT = SipMediaApplication>
    CreateSipMediaApplicationResult& WithSipMediaApplication(SipMediaApplicationT&& value) { SetSipMediaApplication(std::forward<SipMediaApplicationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSipMediaApplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
