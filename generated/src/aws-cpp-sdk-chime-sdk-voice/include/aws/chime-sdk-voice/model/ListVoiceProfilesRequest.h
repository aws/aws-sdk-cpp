...
class ListVoiceProfilesRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceProfileDomainIdT = Aws::String>
  ListVoiceProfilesRequest& WithVoiceProfileDomainId(VoiceProfileDomainIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVoiceProfilesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListVoiceProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
