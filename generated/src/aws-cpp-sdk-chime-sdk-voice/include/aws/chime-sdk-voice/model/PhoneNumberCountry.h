...
/**
 * <p>The phone number's country.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-voice-2022-08-03/PhoneNumberCountry">AWS
 * API Reference</a></p>
 */
class PhoneNumberCountry {
 public:
  ...
  void SetSupportedPhoneNumberTypes(SupportedPhoneNumberTypesT&& value) {
    ...
    m_supportedPhoneNumberTypes = std::forward<SupportedPhoneNumberTypesT>(value);
  }
  template <typename SupportedPhoneNumberTypesT = Aws::Vector<PhoneNumberType>>
  PhoneNumberCountry& WithSupportedPhoneNumberTypes(SupportedPhoneNumberTypesT&& value) {
    SetSupportedPhoneNumberTypes(std::forward<SupportedPhoneNumberTypesT>(value));
    return *this;
  }
  inline PhoneNumberCountry& AddSupportedPhoneNumberTypes(PhoneNumberType value) {
    m_supportedPhoneNumberTypesHasBeenSet = true;
    m_supportedPhoneNumberTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
