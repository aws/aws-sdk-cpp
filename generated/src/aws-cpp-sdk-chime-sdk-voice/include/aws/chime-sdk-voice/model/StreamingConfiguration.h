...
class StreamingConfiguration {
 public:
  ...
  inline StreamingConfiguration& WithDataRetentionInHours(int value) {
  ...
  inline StreamingConfiguration& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetStreamingNotificationTargets(StreamingNotificationTargetsT&& value) {
    m_streamingNotificationTargetsHasBeenSet = true;
    m_streamingNotificationTargets = std::forward<StreamingNotificationTargetsT>(value);
  }
  template <typename StreamingNotificationTargetsT = Aws::Vector<StreamingNotificationTarget>>
  StreamingConfiguration& WithStreamingNotificationTargets(StreamingNotificationTargetsT&& value) {
    SetStreamingNotificationTargets(std::forward<StreamingNotificationTargetsT>(value));
    return *this;
  }
  template <typename StreamingNotificationTargetsT = StreamingNotificationTarget>
  StreamingConfiguration& AddStreamingNotificationTargets(StreamingNotificationTargetsT&& value) {
    m_streamingNotificationTargetsHasBeenSet = true;
    m_streamingNotificationTargets.emplace_back(std::forward<StreamingNotificationTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMediaInsightsConfiguration(MediaInsightsConfigurationT&& value) {
    m_mediaInsightsConfigurationHasBeenSet = true;
    m_mediaInsightsConfiguration = std::forward<MediaInsightsConfigurationT>(value);
  }
  template <typename MediaInsightsConfigurationT = MediaInsightsConfiguration>
  StreamingConfiguration& WithMediaInsightsConfiguration(MediaInsightsConfigurationT&& value) {
    SetMediaInsightsConfiguration(std::forward<MediaInsightsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
