...
class CreateVoiceProfileDomainRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateVoiceProfileDomainRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateVoiceProfileDomainRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename ServerSideEncryptionConfigurationT = ServerSideEncryptionConfiguration>
  CreateVoiceProfileDomainRequest& WithServerSideEncryptionConfiguration(ServerSideEncryptionConfigurationT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateVoiceProfileDomainRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVoiceProfileDomainRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVoiceProfileDomainRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
