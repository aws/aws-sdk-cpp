...
class AssociatePhoneNumbersWithVoiceConnectorGroupRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorGroupIdT = Aws::String>
  AssociatePhoneNumbersWithVoiceConnectorGroupRequest& WithVoiceConnectorGroupId(VoiceConnectorGroupIdT&& value) {
  ...
  template <typename E164PhoneNumbersT = Aws::Vector<Aws::String>>
  AssociatePhoneNumbersWithVoiceConnectorGroupRequest& WithE164PhoneNumbers(E164PhoneNumbersT&& value) {
    SetE164PhoneNumbers(std::forward<E164PhoneNumbersT>(value));
    return *this;
  }
  template <typename E164PhoneNumbersT = Aws::String>
  AssociatePhoneNumbersWithVoiceConnectorGroupRequest& AddE164PhoneNumbers(E164PhoneNumbersT&& value) {
    m_e164PhoneNumbersHasBeenSet = true;
  ...
  inline AssociatePhoneNumbersWithVoiceConnectorGroupRequest& WithForceAssociate(bool value) {
