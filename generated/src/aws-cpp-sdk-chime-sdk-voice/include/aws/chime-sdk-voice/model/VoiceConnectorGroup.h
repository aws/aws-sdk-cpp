...
class VoiceConnectorGroup {
 public:
  ...
  void SetVoiceConnectorGroupId(VoiceConnectorGroupIdT&& value) {
    m_voiceConnectorGroupIdHasBeenSet = true;
    m_voiceConnectorGroupId = std::forward<VoiceConnectorGroupIdT>(value);
  }
  template <typename VoiceConnectorGroupIdT = Aws::String>
  VoiceConnectorGroup& WithVoiceConnectorGroupId(VoiceConnectorGroupIdT&& value) {
    SetVoiceConnectorGroupId(std::forward<VoiceConnectorGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  VoiceConnectorGroup& WithName(NameT&& value) {
  ...
  void SetVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    m_voiceConnectorItemsHasBeenSet = true;
    m_voiceConnectorItems = std::forward<VoiceConnectorItemsT>(value);
  }
  template <typename VoiceConnectorItemsT = Aws::Vector<VoiceConnectorItem>>
  VoiceConnectorGroup& WithVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    SetVoiceConnectorItems(std::forward<VoiceConnectorItemsT>(value));
    return *this;
  }
  template <typename VoiceConnectorItemsT = VoiceConnectorItem>
  VoiceConnectorGroup& AddVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    m_voiceConnectorItemsHasBeenSet = true;
    m_voiceConnectorItems.emplace_back(std::forward<VoiceConnectorItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  VoiceConnectorGroup& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  VoiceConnectorGroup& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  void SetVoiceConnectorGroupArn(VoiceConnectorGroupArnT&& value) {
    m_voiceConnectorGroupArnHasBeenSet = true;
    m_voiceConnectorGroupArn = std::forward<VoiceConnectorGroupArnT>(value);
  }
  template <typename VoiceConnectorGroupArnT = Aws::String>
  VoiceConnectorGroup& WithVoiceConnectorGroupArn(VoiceConnectorGroupArnT&& value) {
    SetVoiceConnectorGroupArn(std::forward<VoiceConnectorGroupArnT>(value));
    return *this;
  }
  ///@}
 private:
