...
class UpdateVoiceConnectorRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  UpdateVoiceConnectorRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateVoiceConnectorRequest& WithName(NameT&& value) {
  ...
  inline UpdateVoiceConnectorRequest& WithRequireEncryption(bool value) {
