...
class PutVoiceConnectorLoggingConfigurationResult {
 public:
  AWS_CHIMESDKVOICE_API PutVoiceConnectorLoggingConfigurationResult() = default;
  ...
  AWS_CHIMESDKVOICE_API PutVoiceConnectorLoggingConfigurationResult& operator=(
  ...
  template <typename LoggingConfigurationT = LoggingConfiguration>
  PutVoiceConnectorLoggingConfigurationResult& WithLoggingConfiguration(LoggingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutVoiceConnectorLoggingConfigurationResult& WithRequestId(RequestIdT&& value) {
