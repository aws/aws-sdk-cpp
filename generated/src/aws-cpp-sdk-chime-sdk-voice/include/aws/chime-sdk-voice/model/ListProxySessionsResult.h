...
class ListProxySessionsResult {
 public:
  ...
  void SetProxySessions(ProxySessionsT&& value) {
    m_proxySessionsHasBeenSet = true;
    m_proxySessions = std::forward<ProxySessionsT>(value);
  }
  template <typename ProxySessionsT = Aws::Vector<ProxySession>>
  ListProxySessionsResult& WithProxySessions(ProxySessionsT&& value) {
    SetProxySessions(std::forward<ProxySessionsT>(value));
    return *this;
  }
  template <typename ProxySessionsT = ProxySession>
  ListProxySessionsResult& AddProxySessions(ProxySessionsT&& value) {
    m_proxySessionsHasBeenSet = true;
    m_proxySessions.emplace_back(std::forward<ProxySessionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProxySessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProxySessionsResult& WithRequestId(RequestIdT&& value) {
