...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteSipMediaApplicationRequest() = default;
    ...
    template<typename SipMediaApplicationIdT = Aws::String>
    DeleteSipMediaApplicationRequest& WithSipMediaApplicationId(SipMediaApplicationIdT&& value) { SetSipMediaApplicationId(std::forward<SipMediaApplicationIdT>(value)); return *this;}
    ///@}
  private:
