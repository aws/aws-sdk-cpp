...
class VoiceProfileDomain {
 public:
  ...
  template <typename VoiceProfileDomainIdT = Aws::String>
  VoiceProfileDomain& WithVoiceProfileDomainId(VoiceProfileDomainIdT&& value) {
  ...
  template <typename VoiceProfileDomainArnT = Aws::String>
  VoiceProfileDomain& WithVoiceProfileDomainArn(VoiceProfileDomainArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  VoiceProfileDomain& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  VoiceProfileDomain& WithDescription(DescriptionT&& value) {
  ...
  template <typename ServerSideEncryptionConfigurationT = ServerSideEncryptionConfiguration>
  VoiceProfileDomain& WithServerSideEncryptionConfiguration(ServerSideEncryptionConfigurationT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  VoiceProfileDomain& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  VoiceProfileDomain& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
