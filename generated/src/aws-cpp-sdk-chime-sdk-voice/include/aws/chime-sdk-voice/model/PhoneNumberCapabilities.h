...
class PhoneNumberCapabilities {
 public:
  ...
  inline void SetInboundCall(bool value) {
    m_inboundCallHasBeenSet = true;
    m_inboundCall = value;
  }
  inline PhoneNumberCapabilities& WithInboundCall(bool value) {
    SetInboundCall(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutboundCall(bool value) {
    m_outboundCallHasBeenSet = true;
    m_outboundCall = value;
  }
  inline PhoneNumberCapabilities& WithOutboundCall(bool value) {
    SetOutboundCall(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInboundSMS(bool value) {
    m_inboundSMSHasBeenSet = true;
    m_inboundSMS = value;
  }
  inline PhoneNumberCapabilities& WithInboundSMS(bool value) {
    SetInboundSMS(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutboundSMS(bool value) {
    m_outboundSMSHasBeenSet = true;
    m_outboundSMS = value;
  }
  inline PhoneNumberCapabilities& WithOutboundSMS(bool value) {
    SetOutboundSMS(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInboundMMS(bool value) {
    m_inboundMMSHasBeenSet = true;
    m_inboundMMS = value;
  }
  inline PhoneNumberCapabilities& WithInboundMMS(bool value) {
    SetInboundMMS(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOutboundMMS(bool value) {
    m_outboundMMSHasBeenSet = true;
    m_outboundMMS = value;
  }
  inline PhoneNumberCapabilities& WithOutboundMMS(bool value) {
    SetOutboundMMS(value);
    return *this;
  }
  ///@}
 private:
