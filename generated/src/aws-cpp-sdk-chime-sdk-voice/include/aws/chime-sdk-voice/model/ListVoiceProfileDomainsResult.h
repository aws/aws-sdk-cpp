...
class ListVoiceProfileDomainsResult {
 public:
  ...
  void SetVoiceProfileDomains(VoiceProfileDomainsT&& value) {
    m_voiceProfileDomainsHasBeenSet = true;
    m_voiceProfileDomains = std::forward<VoiceProfileDomainsT>(value);
  }
  template <typename VoiceProfileDomainsT = Aws::Vector<VoiceProfileDomainSummary>>
  ListVoiceProfileDomainsResult& WithVoiceProfileDomains(VoiceProfileDomainsT&& value) {
    SetVoiceProfileDomains(std::forward<VoiceProfileDomainsT>(value));
    return *this;
  }
  template <typename VoiceProfileDomainsT = VoiceProfileDomainSummary>
  ListVoiceProfileDomainsResult& AddVoiceProfileDomains(VoiceProfileDomainsT&& value) {
    m_voiceProfileDomainsHasBeenSet = true;
    m_voiceProfileDomains.emplace_back(std::forward<VoiceProfileDomainsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVoiceProfileDomainsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVoiceProfileDomainsResult& WithRequestId(RequestIdT&& value) {
