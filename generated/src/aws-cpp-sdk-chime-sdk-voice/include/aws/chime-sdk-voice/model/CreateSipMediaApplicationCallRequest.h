...
class CreateSipMediaApplicationCallRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  void SetFromPhoneNumber(FromPhoneNumberT&& value) {
    m_fromPhoneNumberHasBeenSet = true;
    m_fromPhoneNumber = std::forward<FromPhoneNumberT>(value);
  }
  template <typename FromPhoneNumberT = Aws::String>
  CreateSipMediaApplicationCallRequest& WithFromPhoneNumber(FromPhoneNumberT&& value) {
    SetFromPhoneNumber(std::forward<FromPhoneNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToPhoneNumber(ToPhoneNumberT&& value) {
    m_toPhoneNumberHasBeenSet = true;
    m_toPhoneNumber = std::forward<ToPhoneNumberT>(value);
  }
  template <typename ToPhoneNumberT = Aws::String>
  CreateSipMediaApplicationCallRequest& WithToPhoneNumber(ToPhoneNumberT&& value) {
    SetToPhoneNumber(std::forward<ToPhoneNumberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SipMediaApplicationIdT = Aws::String>
  CreateSipMediaApplicationCallRequest& WithSipMediaApplicationId(SipMediaApplicationIdT&& value) {
  ...
  void SetSipHeaders(SipHeadersT&& value) {
    m_sipHeadersHasBeenSet = true;
    m_sipHeaders = std::forward<SipHeadersT>(value);
  }
  template <typename SipHeadersT = Aws::Map<Aws::String, Aws::String>>
  CreateSipMediaApplicationCallRequest& WithSipHeaders(SipHeadersT&& value) {
    SetSipHeaders(std::forward<SipHeadersT>(value));
    return *this;
  }
  ...
  CreateSipMediaApplicationCallRequest& AddSipHeaders(SipHeadersKeyT&& key, SipHeadersValueT&& value) {
    m_sipHeadersHasBeenSet = true;
    m_sipHeaders.emplace(std::forward<SipHeadersKeyT>(key), std::forward<SipHeadersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArgumentsMap(ArgumentsMapT&& value) {
    m_argumentsMapHasBeenSet = true;
    m_argumentsMap = std::forward<ArgumentsMapT>(value);
  }
  template <typename ArgumentsMapT = Aws::Map<Aws::String, Aws::String>>
  CreateSipMediaApplicationCallRequest& WithArgumentsMap(ArgumentsMapT&& value) {
    SetArgumentsMap(std::forward<ArgumentsMapT>(value));
    return *this;
  }
  ...
  CreateSipMediaApplicationCallRequest& AddArgumentsMap(ArgumentsMapKeyT&& key, ArgumentsMapValueT&& value) {
    m_argumentsMapHasBeenSet = true;
    m_argumentsMap.emplace(std::forward<ArgumentsMapKeyT>(key), std::forward<ArgumentsMapValueT>(value));
    return *this;
  }
  ///@}
 private:
