...
class DisassociatePhoneNumbersFromVoiceConnectorRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename E164PhoneNumbersT = Aws::Vector<Aws::String>>
  DisassociatePhoneNumbersFromVoiceConnectorRequest& WithE164PhoneNumbers(E164PhoneNumbersT&& value) {
    SetE164PhoneNumbers(std::forward<E164PhoneNumbersT>(value));
    return *this;
  }
  template <typename E164PhoneNumbersT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorRequest& AddE164PhoneNumbers(E164PhoneNumbersT&& value) {
    m_e164PhoneNumbersHasBeenSet = true;
