 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-voice-2022-08-03/OrderedPhoneNumber">AWS
 * API Reference</a></p>
 */
class OrderedPhoneNumber {
 public:
  AWS_CHIMESDKVOICE_API OrderedPhoneNumber() = default;
  ...
  template <typename E164PhoneNumberT = Aws::String>
  OrderedPhoneNumber& WithE164PhoneNumber(E164PhoneNumberT&& value) {
  ...
  inline void SetStatus(OrderedPhoneNumberStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline OrderedPhoneNumber& WithStatus(OrderedPhoneNumberStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
