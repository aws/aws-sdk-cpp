...
class DisassociatePhoneNumbersFromVoiceConnectorGroupRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorGroupIdT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorGroupRequest& WithVoiceConnectorGroupId(VoiceConnectorGroupIdT&& value) {
  ...
  template <typename E164PhoneNumbersT = Aws::Vector<Aws::String>>
  DisassociatePhoneNumbersFromVoiceConnectorGroupRequest& WithE164PhoneNumbers(E164PhoneNumbersT&& value) {
    SetE164PhoneNumbers(std::forward<E164PhoneNumbersT>(value));
    return *this;
  }
  template <typename E164PhoneNumbersT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorGroupRequest& AddE164PhoneNumbers(E164PhoneNumbersT&& value) {
    m_e164PhoneNumbersHasBeenSet = true;
