...
class PutVoiceConnectorProxyRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  PutVoiceConnectorProxyRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  inline PutVoiceConnectorProxyRequest& WithDefaultSessionExpiryMinutes(int value) {
  ...
  void SetPhoneNumberPoolCountries(PhoneNumberPoolCountriesT&& value) {
    m_phoneNumberPoolCountriesHasBeenSet = true;
    m_phoneNumberPoolCountries = std::forward<PhoneNumberPoolCountriesT>(value);
  }
  template <typename PhoneNumberPoolCountriesT = Aws::Vector<Aws::String>>
  PutVoiceConnectorProxyRequest& WithPhoneNumberPoolCountries(PhoneNumberPoolCountriesT&& value) {
    SetPhoneNumberPoolCountries(std::forward<PhoneNumberPoolCountriesT>(value));
    return *this;
  }
  template <typename PhoneNumberPoolCountriesT = Aws::String>
  PutVoiceConnectorProxyRequest& AddPhoneNumberPoolCountries(PhoneNumberPoolCountriesT&& value) {
    m_phoneNumberPoolCountriesHasBeenSet = true;
    m_phoneNumberPoolCountries.emplace_back(std::forward<PhoneNumberPoolCountriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FallBackPhoneNumberT = Aws::String>
  PutVoiceConnectorProxyRequest& WithFallBackPhoneNumber(FallBackPhoneNumberT&& value) {
  ...
  inline PutVoiceConnectorProxyRequest& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
