...
class PutVoiceConnectorExternalSystemsConfigurationResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API PutVoiceConnectorExternalSystemsConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetExternalSystemsConfiguration(ExternalSystemsConfigurationT&& value) {
    m_externalSystemsConfigurationHasBeenSet = true;
    m_externalSystemsConfiguration = std::forward<ExternalSystemsConfigurationT>(value);
  }
  template <typename ExternalSystemsConfigurationT = ExternalSystemsConfiguration>
  PutVoiceConnectorExternalSystemsConfigurationResult& WithExternalSystemsConfiguration(ExternalSystemsConfigurationT&& value) {
    SetExternalSystemsConfiguration(std::forward<ExternalSystemsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutVoiceConnectorExternalSystemsConfigurationResult& WithRequestId(RequestIdT&& value) {
