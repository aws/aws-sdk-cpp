...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API GetVoiceConnectorLoggingConfigurationResult() = default;
    ...
    template<typename LoggingConfigurationT = LoggingConfiguration>
    GetVoiceConnectorLoggingConfigurationResult& WithLoggingConfiguration(LoggingConfigurationT&& value) { SetLoggingConfiguration(std::forward<LoggingConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetVoiceConnectorLoggingConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
