...
class SipMediaApplication {
 public:
  ...
  template <typename SipMediaApplicationIdT = Aws::String>
  SipMediaApplication& WithSipMediaApplicationId(SipMediaApplicationIdT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  SipMediaApplication& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename NameT = Aws::String>
  SipMediaApplication& WithName(NameT&& value) {
  ...
  template <typename EndpointsT = Aws::Vector<SipMediaApplicationEndpoint>>
  SipMediaApplication& WithEndpoints(EndpointsT&& value) {
    SetEndpoints(std::forward<EndpointsT>(value));
    return *this;
  }
  template <typename EndpointsT = SipMediaApplicationEndpoint>
  SipMediaApplication& AddEndpoints(EndpointsT&& value) {
    m_endpointsHasBeenSet = true;
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  SipMediaApplication& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  SipMediaApplication& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  void SetSipMediaApplicationArn(SipMediaApplicationArnT&& value) {
    m_sipMediaApplicationArnHasBeenSet = true;
    m_sipMediaApplicationArn = std::forward<SipMediaApplicationArnT>(value);
  }
  template <typename SipMediaApplicationArnT = Aws::String>
  SipMediaApplication& WithSipMediaApplicationArn(SipMediaApplicationArnT&& value) {
    SetSipMediaApplicationArn(std::forward<SipMediaApplicationArnT>(value));
    return *this;
  }
  ///@}
 private:
