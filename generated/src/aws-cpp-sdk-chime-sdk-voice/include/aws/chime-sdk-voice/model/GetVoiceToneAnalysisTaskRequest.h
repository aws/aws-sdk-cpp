...
class GetVoiceToneAnalysisTaskRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  GetVoiceToneAnalysisTaskRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename VoiceToneAnalysisTaskIdT = Aws::String>
  GetVoiceToneAnalysisTaskRequest& WithVoiceToneAnalysisTaskId(VoiceToneAnalysisTaskIdT&& value) {
  ...
  inline GetVoiceToneAnalysisTaskRequest& WithIsCaller(bool value) {
    SetIsCaller(value);
    return *this;
  }
  ///@}
