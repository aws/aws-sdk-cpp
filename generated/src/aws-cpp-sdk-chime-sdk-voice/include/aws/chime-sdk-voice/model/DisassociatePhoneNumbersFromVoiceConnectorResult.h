...
class DisassociatePhoneNumbersFromVoiceConnectorResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API DisassociatePhoneNumbersFromVoiceConnectorResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PhoneNumberErrorsT = Aws::Vector<PhoneNumberError>>
  DisassociatePhoneNumbersFromVoiceConnectorResult& WithPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    SetPhoneNumberErrors(std::forward<PhoneNumberErrorsT>(value));
    return *this;
  }
  template <typename PhoneNumberErrorsT = PhoneNumberError>
  DisassociatePhoneNumbersFromVoiceConnectorResult& AddPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    m_phoneNumberErrorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DisassociatePhoneNumbersFromVoiceConnectorResult& WithRequestId(RequestIdT&& value) {
