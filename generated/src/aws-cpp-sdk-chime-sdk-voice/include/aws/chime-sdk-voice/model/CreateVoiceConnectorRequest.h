...
class CreateVoiceConnectorRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateVoiceConnectorRequest& WithName(NameT&& value) {
  ...
  inline CreateVoiceConnectorRequest& WithAwsRegion(VoiceConnectorAwsRegion value) {
    SetAwsRegion(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVoiceConnectorRequest& WithRequireEncryption(bool value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVoiceConnectorRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVoiceConnectorRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The connectors for use with Connect Customer.</p> <p>The following options
   * are available:</p> <ul> <li> <p> <code>CONNECT_CALL_TRANSFER_CONNECTOR</code> -
   * Enables enterprises to integrate Connect Customer with other voice systems to
   * directly transfer voice calls and metadata without using the public telephone
   * network. They can use Connect Customer telephony and Interactive Voice Response
   ...
   * Connect Customer can start with Contact Lens analytics and performance insights
  ...
  inline CreateVoiceConnectorRequest& WithIntegrationType(VoiceConnectorIntegrationType value) {
  ...
  inline CreateVoiceConnectorRequest& WithNetworkType(NetworkType value) {
