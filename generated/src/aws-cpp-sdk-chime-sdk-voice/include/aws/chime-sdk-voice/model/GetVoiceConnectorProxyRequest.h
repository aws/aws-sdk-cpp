...
namespace Model
{
  ...
  /**
   */
  class GetVoiceConnectorProxyRequest : public ChimeSDKVoiceRequest
  {
  public:
    AWS_CHIMESDKVOICE_API GetVoiceConnectorProxyRequest() = default;
    ...
    template<typename VoiceConnectorIdT = Aws::String>
    GetVoiceConnectorProxyRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) { SetVoiceConnectorId(std::forward<VoiceConnectorIdT>(value)); return *this;}
    ///@}
  private:
