...
class StreamingNotificationTarget {
 public:
  ...
  inline void SetNotificationTarget(NotificationTarget value) {
    m_notificationTargetHasBeenSet = true;
    m_notificationTarget = value;
  }
  inline StreamingNotificationTarget& WithNotificationTarget(NotificationTarget value) {
