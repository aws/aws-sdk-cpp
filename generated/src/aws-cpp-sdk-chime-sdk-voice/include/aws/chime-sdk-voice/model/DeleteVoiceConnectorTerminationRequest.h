...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteVoiceConnectorTerminationRequest() = default;
    ...
    template<typename VoiceConnectorIdT = Aws::String>
    DeleteVoiceConnectorTerminationRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) { SetVoiceConnectorId(std::forward<VoiceConnectorIdT>(value)); return *this;}
    ///@}
  private:
