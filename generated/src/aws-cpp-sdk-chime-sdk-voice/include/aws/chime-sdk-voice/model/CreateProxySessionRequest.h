...
class CreateProxySessionRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  CreateProxySessionRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  void SetParticipantPhoneNumbers(ParticipantPhoneNumbersT&& value) {
    m_participantPhoneNumbersHasBeenSet = true;
    m_participantPhoneNumbers = std::forward<ParticipantPhoneNumbersT>(value);
  }
  template <typename ParticipantPhoneNumbersT = Aws::Vector<Aws::String>>
  CreateProxySessionRequest& WithParticipantPhoneNumbers(ParticipantPhoneNumbersT&& value) {
    SetParticipantPhoneNumbers(std::forward<ParticipantPhoneNumbersT>(value));
    return *this;
  }
  template <typename ParticipantPhoneNumbersT = Aws::String>
  CreateProxySessionRequest& AddParticipantPhoneNumbers(ParticipantPhoneNumbersT&& value) {
    m_participantPhoneNumbersHasBeenSet = true;
    m_participantPhoneNumbers.emplace_back(std::forward<ParticipantPhoneNumbersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  CreateProxySessionRequest& WithName(NameT&& value) {
  ...
  inline CreateProxySessionRequest& WithExpiryMinutes(int value) {
  ...
  template <typename CapabilitiesT = Aws::Vector<Capability>>
  CreateProxySessionRequest& WithCapabilities(CapabilitiesT&& value) {
    SetCapabilities(std::forward<CapabilitiesT>(value));
    return *this;
  }
  inline CreateProxySessionRequest& AddCapabilities(Capability value) {
    m_capabilitiesHasBeenSet = true;
  ...
  inline void SetNumberSelectionBehavior(NumberSelectionBehavior value) {
    m_numberSelectionBehaviorHasBeenSet = true;
    m_numberSelectionBehavior = value;
  }
  inline CreateProxySessionRequest& WithNumberSelectionBehavior(NumberSelectionBehavior value) {
    SetNumberSelectionBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGeoMatchLevel(GeoMatchLevel value) {
    m_geoMatchLevelHasBeenSet = true;
    m_geoMatchLevel = value;
  }
  inline CreateProxySessionRequest& WithGeoMatchLevel(GeoMatchLevel value) {
    SetGeoMatchLevel(value);
    return *this;
  }
  ///@}
  ...
  void SetGeoMatchParams(GeoMatchParamsT&& value) {
    m_geoMatchParamsHasBeenSet = true;
    m_geoMatchParams = std::forward<GeoMatchParamsT>(value);
  }
  template <typename GeoMatchParamsT = GeoMatchParams>
  CreateProxySessionRequest& WithGeoMatchParams(GeoMatchParamsT&& value) {
    SetGeoMatchParams(std::forward<GeoMatchParamsT>(value));
    return *this;
  }
  ///@}
 private:
