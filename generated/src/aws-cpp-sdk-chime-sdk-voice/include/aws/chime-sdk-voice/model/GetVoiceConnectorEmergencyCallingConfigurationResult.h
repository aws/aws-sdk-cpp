...
class GetVoiceConnectorEmergencyCallingConfigurationResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API GetVoiceConnectorEmergencyCallingConfigurationResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EmergencyCallingConfigurationT = EmergencyCallingConfiguration>
  GetVoiceConnectorEmergencyCallingConfigurationResult& WithEmergencyCallingConfiguration(EmergencyCallingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetVoiceConnectorEmergencyCallingConfigurationResult& WithRequestId(RequestIdT&& value) {
