...
class SpeakerSearchDetails {
 public:
  ...
  template <typename ResultsT = Aws::Vector<SpeakerSearchResult>>
  SpeakerSearchDetails& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = SpeakerSearchResult>
  SpeakerSearchDetails& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  void SetVoiceprintGenerationStatus(VoiceprintGenerationStatusT&& value) {
    m_voiceprintGenerationStatusHasBeenSet = true;
    m_voiceprintGenerationStatus = std::forward<VoiceprintGenerationStatusT>(value);
  }
  template <typename VoiceprintGenerationStatusT = Aws::String>
  SpeakerSearchDetails& WithVoiceprintGenerationStatus(VoiceprintGenerationStatusT&& value) {
    SetVoiceprintGenerationStatus(std::forward<VoiceprintGenerationStatusT>(value));
    return *this;
  }
  ///@}
 private:
