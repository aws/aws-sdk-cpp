...
class StartSpeakerSearchTaskRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  StartSpeakerSearchTaskRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  StartSpeakerSearchTaskRequest& WithTransactionId(TransactionIdT&& value) {
  ...
  template <typename VoiceProfileDomainIdT = Aws::String>
  StartSpeakerSearchTaskRequest& WithVoiceProfileDomainId(VoiceProfileDomainIdT&& value) {
  ...
  inline void SetCallLeg(CallLegType value) {
    m_callLegHasBeenSet = true;
    m_callLeg = value;
  }
  inline StartSpeakerSearchTaskRequest& WithCallLeg(CallLegType value) {
    SetCallLeg(value);
    return *this;
  }
  ///@}
