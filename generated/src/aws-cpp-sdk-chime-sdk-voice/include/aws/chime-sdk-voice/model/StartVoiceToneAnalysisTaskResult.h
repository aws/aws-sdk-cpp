...
class StartVoiceToneAnalysisTaskResult {
 public:
  ...
  void SetVoiceToneAnalysisTask(VoiceToneAnalysisTaskT&& value) {
    m_voiceToneAnalysisTaskHasBeenSet = true;
    m_voiceToneAnalysisTask = std::forward<VoiceToneAnalysisTaskT>(value);
  }
  template <typename VoiceToneAnalysisTaskT = VoiceToneAnalysisTask>
  StartVoiceToneAnalysisTaskResult& WithVoiceToneAnalysisTask(VoiceToneAnalysisTaskT&& value) {
    SetVoiceToneAnalysisTask(std::forward<VoiceToneAnalysisTaskT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartVoiceToneAnalysisTaskResult& WithRequestId(RequestIdT&& value) {
