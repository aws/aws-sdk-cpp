...
namespace Model
{
  ...
  /**
   */
  class DeleteVoiceConnectorRequest : public ChimeSDKVoiceRequest
  {
  public:
    AWS_CHIMESDKVOICE_API DeleteVoiceConnectorRequest() = default;
    ...
    template<typename VoiceConnectorIdT = Aws::String>
    DeleteVoiceConnectorRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) { SetVoiceConnectorId(std::forward<VoiceConnectorIdT>(value)); return *this;}
    ///@}
  private:
