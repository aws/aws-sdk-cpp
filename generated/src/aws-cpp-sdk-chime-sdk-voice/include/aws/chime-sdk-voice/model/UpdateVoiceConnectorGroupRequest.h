...
class UpdateVoiceConnectorGroupRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorGroupIdT = Aws::String>
  UpdateVoiceConnectorGroupRequest& WithVoiceConnectorGroupId(VoiceConnectorGroupIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateVoiceConnectorGroupRequest& WithName(NameT&& value) {
  ...
  template <typename VoiceConnectorItemsT = Aws::Vector<VoiceConnectorItem>>
  UpdateVoiceConnectorGroupRequest& WithVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    SetVoiceConnectorItems(std::forward<VoiceConnectorItemsT>(value));
    return *this;
  }
  template <typename VoiceConnectorItemsT = VoiceConnectorItem>
  UpdateVoiceConnectorGroupRequest& AddVoiceConnectorItems(VoiceConnectorItemsT&& value) {
    m_voiceConnectorItemsHasBeenSet = true;
