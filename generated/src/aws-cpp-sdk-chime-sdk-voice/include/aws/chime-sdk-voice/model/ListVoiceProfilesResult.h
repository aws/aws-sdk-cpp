...
class ListVoiceProfilesResult {
 public:
  ...
  void SetVoiceProfiles(VoiceProfilesT&& value) {
    m_voiceProfilesHasBeenSet = true;
    m_voiceProfiles = std::forward<VoiceProfilesT>(value);
  }
  template <typename VoiceProfilesT = Aws::Vector<VoiceProfileSummary>>
  ListVoiceProfilesResult& WithVoiceProfiles(VoiceProfilesT&& value) {
    SetVoiceProfiles(std::forward<VoiceProfilesT>(value));
    return *this;
  }
  template <typename VoiceProfilesT = VoiceProfileSummary>
  ListVoiceProfilesResult& AddVoiceProfiles(VoiceProfilesT&& value) {
    m_voiceProfilesHasBeenSet = true;
    m_voiceProfiles.emplace_back(std::forward<VoiceProfilesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVoiceProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVoiceProfilesResult& WithRequestId(RequestIdT&& value) {
