...
class AssociatePhoneNumbersWithVoiceConnectorResult {
 public:
  ...
  AWS_CHIMESDKVOICE_API AssociatePhoneNumbersWithVoiceConnectorResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename PhoneNumberErrorsT = Aws::Vector<PhoneNumberError>>
  AssociatePhoneNumbersWithVoiceConnectorResult& WithPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    SetPhoneNumberErrors(std::forward<PhoneNumberErrorsT>(value));
    return *this;
  }
  template <typename PhoneNumberErrorsT = PhoneNumberError>
  AssociatePhoneNumbersWithVoiceConnectorResult& AddPhoneNumberErrors(PhoneNumberErrorsT&& value) {
    m_phoneNumberErrorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AssociatePhoneNumbersWithVoiceConnectorResult& WithRequestId(RequestIdT&& value) {
