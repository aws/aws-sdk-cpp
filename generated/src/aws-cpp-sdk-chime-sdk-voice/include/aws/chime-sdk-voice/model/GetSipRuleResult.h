...
class GetSipRuleResult {
 public:
  ...
  void SetSipRule(SipRuleT&& value) {
    m_sipRuleHasBeenSet = true;
    m_sipRule = std::forward<SipRuleT>(value);
  }
  template <typename SipRuleT = SipRule>
  GetSipRuleResult& WithSipRule(SipRuleT&& value) {
    SetSipRule(std::forward<SipRuleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSipRuleResult& WithRequestId(RequestIdT&& value) {
