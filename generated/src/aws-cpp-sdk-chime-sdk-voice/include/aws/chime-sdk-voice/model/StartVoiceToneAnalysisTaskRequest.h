...
class StartVoiceToneAnalysisTaskRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  StartVoiceToneAnalysisTaskRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename TransactionIdT = Aws::String>
  StartVoiceToneAnalysisTaskRequest& WithTransactionId(TransactionIdT&& value) {
  ...
  inline StartVoiceToneAnalysisTaskRequest& WithLanguageCode(LanguageCode value) {
