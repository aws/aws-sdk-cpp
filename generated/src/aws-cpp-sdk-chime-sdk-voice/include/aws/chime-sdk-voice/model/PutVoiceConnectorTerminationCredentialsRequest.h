...
class PutVoiceConnectorTerminationCredentialsRequest : public ChimeSDKVoiceRequest {
 public:
  ...
  template <typename VoiceConnectorIdT = Aws::String>
  PutVoiceConnectorTerminationCredentialsRequest& WithVoiceConnectorId(VoiceConnectorIdT&& value) {
  ...
  template <typename CredentialsT = Aws::Vector<Credential>>
  PutVoiceConnectorTerminationCredentialsRequest& WithCredentials(CredentialsT&& value) {
    SetCredentials(std::forward<CredentialsT>(value));
    return *this;
  }
  template <typename CredentialsT = Credential>
  PutVoiceConnectorTerminationCredentialsRequest& AddCredentials(CredentialsT&& value) {
    m_credentialsHasBeenSet = true;
