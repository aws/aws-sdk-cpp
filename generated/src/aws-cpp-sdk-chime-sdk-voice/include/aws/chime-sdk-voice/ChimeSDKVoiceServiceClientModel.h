...
#include <aws/chime-sdk-voice/model/CreateVoiceProfileDomainResult.h>
#include <aws/chime-sdk-voice/model/CreateVoiceProfileResult.h>
...
#include <aws/chime-sdk-voice/model/GetVoiceProfileDomainResult.h>
...
#include <aws/chime-sdk-voice/model/ListTagsForResourceResult.h>
...
typedef Aws::Utils::Outcome<AssociatePhoneNumbersWithVoiceConnectorResult, ChimeSDKVoiceError>
    AssociatePhoneNumbersWithVoiceConnectorOutcome;
typedef Aws::Utils::Outcome<AssociatePhoneNumbersWithVoiceConnectorGroupResult, ChimeSDKVoiceError>
...
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> DeleteVoiceProfileOutcome;
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> DeleteVoiceProfileDomainOutcome;
typedef Aws::Utils::Outcome<DisassociatePhoneNumbersFromVoiceConnectorResult, ChimeSDKVoiceError>
    DisassociatePhoneNumbersFromVoiceConnectorOutcome;
typedef Aws::Utils::Outcome<DisassociatePhoneNumbersFromVoiceConnectorGroupResult, ChimeSDKVoiceError>
...
typedef Aws::Utils::Outcome<GetVoiceConnectorEmergencyCallingConfigurationResult, ChimeSDKVoiceError>
    GetVoiceConnectorEmergencyCallingConfigurationOutcome;
typedef Aws::Utils::Outcome<GetVoiceConnectorExternalSystemsConfigurationResult, ChimeSDKVoiceError>
...
typedef Aws::Utils::Outcome<GetVoiceProfileResult, ChimeSDKVoiceError> GetVoiceProfileOutcome;
typedef Aws::Utils::Outcome<GetVoiceProfileDomainResult, ChimeSDKVoiceError> GetVoiceProfileDomainOutcome;
typedef Aws::Utils::Outcome<GetVoiceToneAnalysisTaskResult, ChimeSDKVoiceError> GetVoiceToneAnalysisTaskOutcome;
...
typedef Aws::Utils::Outcome<ListTagsForResourceResult, ChimeSDKVoiceError> ListTagsForResourceOutcome;
typedef Aws::Utils::Outcome<ListVoiceConnectorGroupsResult, ChimeSDKVoiceError> ListVoiceConnectorGroupsOutcome;
typedef Aws::Utils::Outcome<ListVoiceConnectorTerminationCredentialsResult, ChimeSDKVoiceError>
...
typedef Aws::Utils::Outcome<PutSipMediaApplicationLoggingConfigurationResult, ChimeSDKVoiceError>
    PutSipMediaApplicationLoggingConfigurationOutcome;
typedef Aws::Utils::Outcome<PutVoiceConnectorEmergencyCallingConfigurationResult, ChimeSDKVoiceError>
    PutVoiceConnectorEmergencyCallingConfigurationOutcome;
typedef Aws::Utils::Outcome<PutVoiceConnectorExternalSystemsConfigurationResult, ChimeSDKVoiceError>
...
typedef Aws::Utils::Outcome<StartSpeakerSearchTaskResult, ChimeSDKVoiceError> StartSpeakerSearchTaskOutcome;
typedef Aws::Utils::Outcome<StartVoiceToneAnalysisTaskResult, ChimeSDKVoiceError> StartVoiceToneAnalysisTaskOutcome;
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> StopSpeakerSearchTaskOutcome;
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> StopVoiceToneAnalysisTaskOutcome;
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> TagResourceOutcome;
typedef Aws::Utils::Outcome<Aws::NoResult, ChimeSDKVoiceError> UntagResourceOutcome;
...
typedef Aws::Utils::Outcome<UpdateVoiceProfileResult, ChimeSDKVoiceError> UpdateVoiceProfileOutcome;
typedef Aws::Utils::Outcome<UpdateVoiceProfileDomainResult, ChimeSDKVoiceError> UpdateVoiceProfileDomainOutcome;
...
typedef std::future<DeleteVoiceConnectorEmergencyCallingConfigurationOutcome>
    DeleteVoiceConnectorEmergencyCallingConfigurationOutcomeCallable;
typedef std::future<DeleteVoiceConnectorExternalSystemsConfigurationOutcome>
...
typedef std::future<DeleteVoiceProfileOutcome> DeleteVoiceProfileOutcomeCallable;
typedef std::future<DeleteVoiceProfileDomainOutcome> DeleteVoiceProfileDomainOutcomeCallable;
...
typedef std::future<GetVoiceProfileOutcome> GetVoiceProfileOutcomeCallable;
typedef std::future<GetVoiceProfileDomainOutcome> GetVoiceProfileDomainOutcomeCallable;
...
typedef std::future<UpdateVoiceProfileOutcome> UpdateVoiceProfileOutcomeCallable;
typedef std::future<UpdateVoiceProfileDomainOutcome> UpdateVoiceProfileDomainOutcomeCallable;
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::AssociatePhoneNumbersWithVoiceConnectorRequest&,
                           const Model::AssociatePhoneNumbersWithVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    AssociatePhoneNumbersWithVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::AssociatePhoneNumbersWithVoiceConnectorGroupRequest&,
                           const Model::AssociatePhoneNumbersWithVoiceConnectorGroupOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    AssociatePhoneNumbersWithVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::BatchDeletePhoneNumberRequest&,
                           const Model::BatchDeletePhoneNumberOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    BatchDeletePhoneNumberResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::BatchUpdatePhoneNumberRequest&,
                           const Model::BatchUpdatePhoneNumberOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateSipMediaApplicationCallRequest&,
                           const Model::CreateSipMediaApplicationCallOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateSipMediaApplicationCallResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateSipRuleRequest&, const Model::CreateSipRuleOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateSipRuleResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateVoiceConnectorRequest&, const Model::CreateVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateVoiceConnectorGroupRequest&,
                           const Model::CreateVoiceConnectorGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateVoiceProfileRequest&, const Model::CreateVoiceProfileOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateVoiceProfileResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::CreateVoiceProfileDomainRequest&,
                           const Model::CreateVoiceProfileDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateVoiceProfileDomainResponseReceivedHandler;
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteSipRuleRequest&, const Model::DeleteSipRuleOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteSipRuleResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorRequest&, const Model::DeleteVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorEmergencyCallingConfigurationRequest&,
                           const Model::DeleteVoiceConnectorEmergencyCallingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorEmergencyCallingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorExternalSystemsConfigurationRequest&,
                           const Model::DeleteVoiceConnectorExternalSystemsConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorExternalSystemsConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorGroupRequest&,
                           const Model::DeleteVoiceConnectorGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorOriginationRequest&,
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorTerminationRequest&,
                           const Model::DeleteVoiceConnectorTerminationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorTerminationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceConnectorTerminationCredentialsRequest&,
                           const Model::DeleteVoiceConnectorTerminationCredentialsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceConnectorTerminationCredentialsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceProfileRequest&, const Model::DeleteVoiceProfileOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceProfileResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DeleteVoiceProfileDomainRequest&,
                           const Model::DeleteVoiceProfileDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteVoiceProfileDomainResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DisassociatePhoneNumbersFromVoiceConnectorRequest&,
                           const Model::DisassociatePhoneNumbersFromVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DisassociatePhoneNumbersFromVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::DisassociatePhoneNumbersFromVoiceConnectorGroupRequest&,
                           const Model::DisassociatePhoneNumbersFromVoiceConnectorGroupOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DisassociatePhoneNumbersFromVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetGlobalSettingsRequest&, const Model::GetGlobalSettingsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetGlobalSettingsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetPhoneNumberRequest&, const Model::GetPhoneNumberOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetPhoneNumberResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetPhoneNumberOrderRequest&, const Model::GetPhoneNumberOrderOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetSipMediaApplicationLoggingConfigurationRequest&,
                           const Model::GetSipMediaApplicationLoggingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetSipMediaApplicationLoggingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetSipRuleRequest&, const Model::GetSipRuleOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetSipRuleResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetSpeakerSearchTaskRequest&, const Model::GetSpeakerSearchTaskOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetSpeakerSearchTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorRequest&, const Model::GetVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorEmergencyCallingConfigurationRequest&,
                           const Model::GetVoiceConnectorEmergencyCallingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorEmergencyCallingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorExternalSystemsConfigurationRequest&,
                           const Model::GetVoiceConnectorExternalSystemsConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorExternalSystemsConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorGroupRequest&,
                           const Model::GetVoiceConnectorGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorLoggingConfigurationRequest&,
                           const Model::GetVoiceConnectorLoggingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorLoggingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorOriginationRequest&,
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorTerminationRequest&,
                           const Model::GetVoiceConnectorTerminationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorTerminationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceConnectorTerminationHealthRequest&,
                           const Model::GetVoiceConnectorTerminationHealthOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceConnectorTerminationHealthResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceProfileRequest&, const Model::GetVoiceProfileOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceProfileResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceProfileDomainRequest&,
                           const Model::GetVoiceProfileDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceProfileDomainResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::GetVoiceToneAnalysisTaskRequest&,
                           const Model::GetVoiceToneAnalysisTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetVoiceToneAnalysisTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListAvailableVoiceConnectorRegionsRequest&,
                           const Model::ListAvailableVoiceConnectorRegionsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListAvailableVoiceConnectorRegionsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListPhoneNumberOrdersRequest&,
                           const Model::ListPhoneNumberOrdersOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListSipRulesRequest&, const Model::ListSipRulesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListSipRulesResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListSupportedPhoneNumberCountriesRequest&,
                           const Model::ListSupportedPhoneNumberCountriesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListSupportedPhoneNumberCountriesResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListVoiceConnectorGroupsRequest&,
                           const Model::ListVoiceConnectorGroupsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListVoiceConnectorGroupsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListVoiceConnectorTerminationCredentialsRequest&,
                           const Model::ListVoiceConnectorTerminationCredentialsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListVoiceConnectorTerminationCredentialsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListVoiceConnectorsRequest&, const Model::ListVoiceConnectorsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListVoiceConnectorsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListVoiceProfileDomainsRequest&,
                           const Model::ListVoiceProfileDomainsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListVoiceProfileDomainsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ListVoiceProfilesRequest&, const Model::ListVoiceProfilesOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListVoiceProfilesResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutSipMediaApplicationLoggingConfigurationRequest&,
                           const Model::PutSipMediaApplicationLoggingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutSipMediaApplicationLoggingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorEmergencyCallingConfigurationRequest&,
                           const Model::PutVoiceConnectorEmergencyCallingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutVoiceConnectorEmergencyCallingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorExternalSystemsConfigurationRequest&,
                           const Model::PutVoiceConnectorExternalSystemsConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutVoiceConnectorExternalSystemsConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorLoggingConfigurationRequest&,
                           const Model::PutVoiceConnectorLoggingConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutVoiceConnectorLoggingConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorOriginationRequest&,
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorTerminationRequest&,
                           const Model::PutVoiceConnectorTerminationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutVoiceConnectorTerminationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::PutVoiceConnectorTerminationCredentialsRequest&,
                           const Model::PutVoiceConnectorTerminationCredentialsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutVoiceConnectorTerminationCredentialsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::RestorePhoneNumberRequest&, const Model::RestorePhoneNumberOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    RestorePhoneNumberResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::SearchAvailablePhoneNumbersRequest&,
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::StartSpeakerSearchTaskRequest&,
                           const Model::StartSpeakerSearchTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartSpeakerSearchTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::StartVoiceToneAnalysisTaskRequest&,
                           const Model::StartVoiceToneAnalysisTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartVoiceToneAnalysisTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::StopSpeakerSearchTaskRequest&,
                           const Model::StopSpeakerSearchTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StopSpeakerSearchTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::StopVoiceToneAnalysisTaskRequest&,
                           const Model::StopVoiceToneAnalysisTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StopVoiceToneAnalysisTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateGlobalSettingsRequest&, const Model::UpdateGlobalSettingsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateGlobalSettingsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdatePhoneNumberRequest&, const Model::UpdatePhoneNumberOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
...
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateSipMediaApplicationCallRequest&,
                           const Model::UpdateSipMediaApplicationCallOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateSipMediaApplicationCallResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateSipRuleRequest&, const Model::UpdateSipRuleOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateSipRuleResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateVoiceConnectorRequest&, const Model::UpdateVoiceConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateVoiceConnectorResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateVoiceConnectorGroupRequest&,
                           const Model::UpdateVoiceConnectorGroupOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateVoiceConnectorGroupResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateVoiceProfileRequest&, const Model::UpdateVoiceProfileOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateVoiceProfileResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::UpdateVoiceProfileDomainRequest&,
                           const Model::UpdateVoiceProfileDomainOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateVoiceProfileDomainResponseReceivedHandler;
typedef std::function<void(const ChimeSDKVoiceClient*, const Model::ValidateE911AddressRequest&, const Model::ValidateE911AddressOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ValidateE911AddressResponseReceivedHandler;
