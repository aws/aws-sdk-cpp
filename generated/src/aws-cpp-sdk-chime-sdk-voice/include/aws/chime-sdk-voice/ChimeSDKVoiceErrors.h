...
public:
  ...
  ChimeSDKVoiceError(const Aws::Client::AWSError<ChimeSDKVoiceErrors>& rhs) : Aws::Client::AWSError<ChimeSDKVoiceErrors>(rhs) {}
  ChimeSDKVoiceError(Aws::Client::AWSError<ChimeSDKVoiceErrors>&& rhs) : Aws::Client::AWSError<ChimeSDKVoiceErrors>(rhs) {}
