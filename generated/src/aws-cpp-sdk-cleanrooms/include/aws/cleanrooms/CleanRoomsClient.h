...
class AWS_CLEANROOMS_API CleanRoomsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CleanRoomsClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CleanRoomsEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CleanRooms::CleanRoomsClientConfiguration& clientConfiguration = Aws::CleanRooms::CleanRoomsClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetCollaborationAnalysisTemplateOutcome BatchGetCollaborationAnalysisTemplate(
      const Model::BatchGetCollaborationAnalysisTemplateRequest& request) const;

  /**
   * A Callable wrapper for BatchGetCollaborationAnalysisTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchGetCollaborationAnalysisTemplateRequestT = Model::BatchGetCollaborationAnalysisTemplateRequest>
  Model::BatchGetCollaborationAnalysisTemplateOutcomeCallable BatchGetCollaborationAnalysisTemplateCallable(
      const BatchGetCollaborationAnalysisTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::BatchGetCollaborationAnalysisTemplate, request);
  }

  /**
   * An Async wrapper for BatchGetCollaborationAnalysisTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetCollaborationAnalysisTemplateRequestT = Model::BatchGetCollaborationAnalysisTemplateRequest>
  void BatchGetCollaborationAnalysisTemplateAsync(const BatchGetCollaborationAnalysisTemplateRequestT& request,
                                                  const BatchGetCollaborationAnalysisTemplateResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for BatchGetSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetSchemaRequestT = Model::BatchGetSchemaRequest>
  void BatchGetSchemaAsync(const BatchGetSchemaRequestT& request, const BatchGetSchemaResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetSchemaAnalysisRuleOutcome BatchGetSchemaAnalysisRule(
      const Model::BatchGetSchemaAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for BatchGetSchemaAnalysisRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetSchemaAnalysisRuleRequestT = Model::BatchGetSchemaAnalysisRuleRequest>
  Model::BatchGetSchemaAnalysisRuleOutcomeCallable BatchGetSchemaAnalysisRuleCallable(
      const BatchGetSchemaAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::BatchGetSchemaAnalysisRule, request);
  }

  /**
   * An Async wrapper for BatchGetSchemaAnalysisRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetSchemaAnalysisRuleRequestT = Model::BatchGetSchemaAnalysisRuleRequest>
  void BatchGetSchemaAnalysisRuleAsync(const BatchGetSchemaAnalysisRuleRequestT& request,
                                       const BatchGetSchemaAnalysisRuleResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAnalysisTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAnalysisTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAnalysisTemplateRequestT = Model::CreateAnalysisTemplateRequest>
  void CreateAnalysisTemplateAsync(const CreateAnalysisTemplateRequestT& request,
                                   const CreateAnalysisTemplateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCollaboration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCollaboration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCollaborationRequestT = Model::CreateCollaborationRequest>
  void CreateCollaborationAsync(const CreateCollaborationRequestT& request, const CreateCollaborationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCollaborationChangeRequestOutcome CreateCollaborationChangeRequest(
      const Model::CreateCollaborationChangeRequestRequest& request) const;

  /**
   * A Callable wrapper for CreateCollaborationChangeRequest that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateCollaborationChangeRequestRequestT = Model::CreateCollaborationChangeRequestRequest>
  Model::CreateCollaborationChangeRequestOutcomeCallable CreateCollaborationChangeRequestCallable(
      const CreateCollaborationChangeRequestRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateCollaborationChangeRequest, request);
  }

  /**
   * An Async wrapper for CreateCollaborationChangeRequest that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateCollaborationChangeRequestRequestT = Model::CreateCollaborationChangeRequestRequest>
  void CreateCollaborationChangeRequestAsync(const CreateCollaborationChangeRequestRequestT& request,
                                             const CreateCollaborationChangeRequestResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredAudienceModelAssociationOutcome CreateConfiguredAudienceModelAssociation(
      const Model::CreateConfiguredAudienceModelAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredAudienceModelAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateConfiguredAudienceModelAssociationRequestT = Model::CreateConfiguredAudienceModelAssociationRequest>
  Model::CreateConfiguredAudienceModelAssociationOutcomeCallable CreateConfiguredAudienceModelAssociationCallable(
      const CreateConfiguredAudienceModelAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateConfiguredAudienceModelAssociation, request);
  }

  /**
   * An Async wrapper for CreateConfiguredAudienceModelAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateConfiguredAudienceModelAssociationRequestT = Model::CreateConfiguredAudienceModelAssociationRequest>
  void CreateConfiguredAudienceModelAssociationAsync(
      const CreateConfiguredAudienceModelAssociationRequestT& request,
      const CreateConfiguredAudienceModelAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConfiguredTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConfiguredTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConfiguredTableRequestT = Model::CreateConfiguredTableRequest>
  void CreateConfiguredTableAsync(const CreateConfiguredTableRequestT& request, const CreateConfiguredTableResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredTableAnalysisRuleOutcome CreateConfiguredTableAnalysisRule(
      const Model::CreateConfiguredTableAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredTableAnalysisRule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateConfiguredTableAnalysisRuleRequestT = Model::CreateConfiguredTableAnalysisRuleRequest>
  Model::CreateConfiguredTableAnalysisRuleOutcomeCallable CreateConfiguredTableAnalysisRuleCallable(
      const CreateConfiguredTableAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateConfiguredTableAnalysisRule, request);
  }

  /**
   * An Async wrapper for CreateConfiguredTableAnalysisRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateConfiguredTableAnalysisRuleRequestT = Model::CreateConfiguredTableAnalysisRuleRequest>
  void CreateConfiguredTableAnalysisRuleAsync(const CreateConfiguredTableAnalysisRuleRequestT& request,
                                              const CreateConfiguredTableAnalysisRuleResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredTableAssociationOutcome CreateConfiguredTableAssociation(
      const Model::CreateConfiguredTableAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredTableAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateConfiguredTableAssociationRequestT = Model::CreateConfiguredTableAssociationRequest>
  Model::CreateConfiguredTableAssociationOutcomeCallable CreateConfiguredTableAssociationCallable(
      const CreateConfiguredTableAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateConfiguredTableAssociation, request);
  }

  /**
   * An Async wrapper for CreateConfiguredTableAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateConfiguredTableAssociationRequestT = Model::CreateConfiguredTableAssociationRequest>
  void CreateConfiguredTableAssociationAsync(const CreateConfiguredTableAssociationRequestT& request,
                                             const CreateConfiguredTableAssociationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredTableAssociationAnalysisRuleOutcome CreateConfiguredTableAssociationAnalysisRule(
      const Model::CreateConfiguredTableAssociationAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredTableAssociationAnalysisRule that returns a future to the operation so that it can be executed
  ...
  Model::CreateConfiguredTableAssociationAnalysisRuleOutcomeCallable CreateConfiguredTableAssociationAnalysisRuleCallable(
      const CreateConfiguredTableAssociationAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateConfiguredTableAssociationAnalysisRule, request);
  }

  /**
   * An Async wrapper for CreateConfiguredTableAssociationAnalysisRule that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename CreateConfiguredTableAssociationAnalysisRuleRequestT = Model::CreateConfiguredTableAssociationAnalysisRuleRequest>
  void CreateConfiguredTableAssociationAnalysisRuleAsync(
      const CreateConfiguredTableAssociationAnalysisRuleRequestT& request,
      const CreateConfiguredTableAssociationAnalysisRuleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateIdMappingTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateIdMappingTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIdMappingTableRequestT = Model::CreateIdMappingTableRequest>
  void CreateIdMappingTableAsync(const CreateIdMappingTableRequestT& request, const CreateIdMappingTableResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIdNamespaceAssociationOutcome CreateIdNamespaceAssociation(
      const Model::CreateIdNamespaceAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateIdNamespaceAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateIdNamespaceAssociationRequestT = Model::CreateIdNamespaceAssociationRequest>
  Model::CreateIdNamespaceAssociationOutcomeCallable CreateIdNamespaceAssociationCallable(
      const CreateIdNamespaceAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreateIdNamespaceAssociation, request);
  }

  /**
   * An Async wrapper for CreateIdNamespaceAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIdNamespaceAssociationRequestT = Model::CreateIdNamespaceAssociationRequest>
  void CreateIdNamespaceAssociationAsync(const CreateIdNamespaceAssociationRequestT& request,
                                         const CreateIdNamespaceAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePrivacyBudgetTemplateOutcome CreatePrivacyBudgetTemplate(
      const Model::CreatePrivacyBudgetTemplateRequest& request) const;

  /**
   * A Callable wrapper for CreatePrivacyBudgetTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePrivacyBudgetTemplateRequestT = Model::CreatePrivacyBudgetTemplateRequest>
  Model::CreatePrivacyBudgetTemplateOutcomeCallable CreatePrivacyBudgetTemplateCallable(
      const CreatePrivacyBudgetTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::CreatePrivacyBudgetTemplate, request);
  }

  /**
   * An Async wrapper for CreatePrivacyBudgetTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePrivacyBudgetTemplateRequestT = Model::CreatePrivacyBudgetTemplateRequest>
  void CreatePrivacyBudgetTemplateAsync(const CreatePrivacyBudgetTemplateRequestT& request,
                                        const CreatePrivacyBudgetTemplateResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAnalysisTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAnalysisTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnalysisTemplateRequestT = Model::DeleteAnalysisTemplateRequest>
  void DeleteAnalysisTemplateAsync(const DeleteAnalysisTemplateRequestT& request,
                                   const DeleteAnalysisTemplateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCollaboration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCollaboration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCollaborationRequestT = Model::DeleteCollaborationRequest>
  void DeleteCollaborationAsync(const DeleteCollaborationRequestT& request, const DeleteCollaborationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredAudienceModelAssociationOutcome DeleteConfiguredAudienceModelAssociation(
      const Model::DeleteConfiguredAudienceModelAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredAudienceModelAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteConfiguredAudienceModelAssociationRequestT = Model::DeleteConfiguredAudienceModelAssociationRequest>
  Model::DeleteConfiguredAudienceModelAssociationOutcomeCallable DeleteConfiguredAudienceModelAssociationCallable(
      const DeleteConfiguredAudienceModelAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeleteConfiguredAudienceModelAssociation, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredAudienceModelAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteConfiguredAudienceModelAssociationRequestT = Model::DeleteConfiguredAudienceModelAssociationRequest>
  void DeleteConfiguredAudienceModelAssociationAsync(
      const DeleteConfiguredAudienceModelAssociationRequestT& request,
      const DeleteConfiguredAudienceModelAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConfiguredTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConfiguredTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfiguredTableRequestT = Model::DeleteConfiguredTableRequest>
  void DeleteConfiguredTableAsync(const DeleteConfiguredTableRequestT& request, const DeleteConfiguredTableResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredTableAnalysisRuleOutcome DeleteConfiguredTableAnalysisRule(
      const Model::DeleteConfiguredTableAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredTableAnalysisRule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteConfiguredTableAnalysisRuleRequestT = Model::DeleteConfiguredTableAnalysisRuleRequest>
  Model::DeleteConfiguredTableAnalysisRuleOutcomeCallable DeleteConfiguredTableAnalysisRuleCallable(
      const DeleteConfiguredTableAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeleteConfiguredTableAnalysisRule, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredTableAnalysisRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteConfiguredTableAnalysisRuleRequestT = Model::DeleteConfiguredTableAnalysisRuleRequest>
  void DeleteConfiguredTableAnalysisRuleAsync(const DeleteConfiguredTableAnalysisRuleRequestT& request,
                                              const DeleteConfiguredTableAnalysisRuleResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredTableAssociationOutcome DeleteConfiguredTableAssociation(
      const Model::DeleteConfiguredTableAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredTableAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteConfiguredTableAssociationRequestT = Model::DeleteConfiguredTableAssociationRequest>
  Model::DeleteConfiguredTableAssociationOutcomeCallable DeleteConfiguredTableAssociationCallable(
      const DeleteConfiguredTableAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeleteConfiguredTableAssociation, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredTableAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteConfiguredTableAssociationRequestT = Model::DeleteConfiguredTableAssociationRequest>
  void DeleteConfiguredTableAssociationAsync(const DeleteConfiguredTableAssociationRequestT& request,
                                             const DeleteConfiguredTableAssociationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredTableAssociationAnalysisRuleOutcome DeleteConfiguredTableAssociationAnalysisRule(
      const Model::DeleteConfiguredTableAssociationAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredTableAssociationAnalysisRule that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::DeleteConfiguredTableAssociationAnalysisRuleOutcomeCallable DeleteConfiguredTableAssociationAnalysisRuleCallable(
      const DeleteConfiguredTableAssociationAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeleteConfiguredTableAssociationAnalysisRule, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredTableAssociationAnalysisRule that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DeleteConfiguredTableAssociationAnalysisRuleRequestT = Model::DeleteConfiguredTableAssociationAnalysisRuleRequest>
  void DeleteConfiguredTableAssociationAnalysisRuleAsync(
      const DeleteConfiguredTableAssociationAnalysisRuleRequestT& request,
      const DeleteConfiguredTableAssociationAnalysisRuleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIdMappingTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIdMappingTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIdMappingTableRequestT = Model::DeleteIdMappingTableRequest>
  void DeleteIdMappingTableAsync(const DeleteIdMappingTableRequestT& request, const DeleteIdMappingTableResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteIdNamespaceAssociationOutcome DeleteIdNamespaceAssociation(
      const Model::DeleteIdNamespaceAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteIdNamespaceAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteIdNamespaceAssociationRequestT = Model::DeleteIdNamespaceAssociationRequest>
  Model::DeleteIdNamespaceAssociationOutcomeCallable DeleteIdNamespaceAssociationCallable(
      const DeleteIdNamespaceAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeleteIdNamespaceAssociation, request);
  }

  /**
   * An Async wrapper for DeleteIdNamespaceAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIdNamespaceAssociationRequestT = Model::DeleteIdNamespaceAssociationRequest>
  void DeleteIdNamespaceAssociationAsync(const DeleteIdNamespaceAssociationRequestT& request,
                                         const DeleteIdNamespaceAssociationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePrivacyBudgetTemplateOutcome DeletePrivacyBudgetTemplate(
      const Model::DeletePrivacyBudgetTemplateRequest& request) const;

  /**
   * A Callable wrapper for DeletePrivacyBudgetTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePrivacyBudgetTemplateRequestT = Model::DeletePrivacyBudgetTemplateRequest>
  Model::DeletePrivacyBudgetTemplateOutcomeCallable DeletePrivacyBudgetTemplateCallable(
      const DeletePrivacyBudgetTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::DeletePrivacyBudgetTemplate, request);
  }

  /**
   * An Async wrapper for DeletePrivacyBudgetTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePrivacyBudgetTemplateRequestT = Model::DeletePrivacyBudgetTemplateRequest>
  void DeletePrivacyBudgetTemplateAsync(const DeletePrivacyBudgetTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAnalysisTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAnalysisTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAnalysisTemplateRequestT = Model::GetAnalysisTemplateRequest>
  void GetAnalysisTemplateAsync(const GetAnalysisTemplateRequestT& request, const GetAnalysisTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCollaboration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCollaboration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCollaborationRequestT = Model::GetCollaborationRequest>
  void GetCollaborationAsync(const GetCollaborationRequestT& request, const GetCollaborationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationAnalysisTemplateOutcome GetCollaborationAnalysisTemplate(
      const Model::GetCollaborationAnalysisTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationAnalysisTemplate that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCollaborationAnalysisTemplateRequestT = Model::GetCollaborationAnalysisTemplateRequest>
  Model::GetCollaborationAnalysisTemplateOutcomeCallable GetCollaborationAnalysisTemplateCallable(
      const GetCollaborationAnalysisTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetCollaborationAnalysisTemplate, request);
  }

  /**
   * An Async wrapper for GetCollaborationAnalysisTemplate that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCollaborationAnalysisTemplateRequestT = Model::GetCollaborationAnalysisTemplateRequest>
  void GetCollaborationAnalysisTemplateAsync(const GetCollaborationAnalysisTemplateRequestT& request,
                                             const GetCollaborationAnalysisTemplateResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationChangeRequestOutcome GetCollaborationChangeRequest(
      const Model::GetCollaborationChangeRequestRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationChangeRequest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCollaborationChangeRequestRequestT = Model::GetCollaborationChangeRequestRequest>
  Model::GetCollaborationChangeRequestOutcomeCallable GetCollaborationChangeRequestCallable(
      const GetCollaborationChangeRequestRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetCollaborationChangeRequest, request);
  }

  /**
   * An Async wrapper for GetCollaborationChangeRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCollaborationChangeRequestRequestT = Model::GetCollaborationChangeRequestRequest>
  void GetCollaborationChangeRequestAsync(const GetCollaborationChangeRequestRequestT& request,
                                          const GetCollaborationChangeRequestResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationConfiguredAudienceModelAssociationOutcome GetCollaborationConfiguredAudienceModelAssociation(
      const Model::GetCollaborationConfiguredAudienceModelAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationConfiguredAudienceModelAssociation that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename GetCollaborationConfiguredAudienceModelAssociationRequestT =
                Model::GetCollaborationConfiguredAudienceModelAssociationRequest>
  Model::GetCollaborationConfiguredAudienceModelAssociationOutcomeCallable GetCollaborationConfiguredAudienceModelAssociationCallable(
      const GetCollaborationConfiguredAudienceModelAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetCollaborationConfiguredAudienceModelAssociation, request);
  }

  /**
   * An Async wrapper for GetCollaborationConfiguredAudienceModelAssociation that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetCollaborationConfiguredAudienceModelAssociationRequestT =
                Model::GetCollaborationConfiguredAudienceModelAssociationRequest>
  void GetCollaborationConfiguredAudienceModelAssociationAsync(
      const GetCollaborationConfiguredAudienceModelAssociationRequestT& request,
      const GetCollaborationConfiguredAudienceModelAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationIdNamespaceAssociationOutcome GetCollaborationIdNamespaceAssociation(
      const Model::GetCollaborationIdNamespaceAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationIdNamespaceAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetCollaborationIdNamespaceAssociationRequestT = Model::GetCollaborationIdNamespaceAssociationRequest>
  Model::GetCollaborationIdNamespaceAssociationOutcomeCallable GetCollaborationIdNamespaceAssociationCallable(
      const GetCollaborationIdNamespaceAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetCollaborationIdNamespaceAssociation, request);
  }

  /**
   * An Async wrapper for GetCollaborationIdNamespaceAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetCollaborationIdNamespaceAssociationRequestT = Model::GetCollaborationIdNamespaceAssociationRequest>
  void GetCollaborationIdNamespaceAssociationAsync(const GetCollaborationIdNamespaceAssociationRequestT& request,
                                                   const GetCollaborationIdNamespaceAssociationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationPrivacyBudgetTemplateOutcome GetCollaborationPrivacyBudgetTemplate(
      const Model::GetCollaborationPrivacyBudgetTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationPrivacyBudgetTemplate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetCollaborationPrivacyBudgetTemplateRequestT = Model::GetCollaborationPrivacyBudgetTemplateRequest>
  Model::GetCollaborationPrivacyBudgetTemplateOutcomeCallable GetCollaborationPrivacyBudgetTemplateCallable(
      const GetCollaborationPrivacyBudgetTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetCollaborationPrivacyBudgetTemplate, request);
  }

  /**
   * An Async wrapper for GetCollaborationPrivacyBudgetTemplate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetCollaborationPrivacyBudgetTemplateRequestT = Model::GetCollaborationPrivacyBudgetTemplateRequest>
  void GetCollaborationPrivacyBudgetTemplateAsync(const GetCollaborationPrivacyBudgetTemplateRequestT& request,
                                                  const GetCollaborationPrivacyBudgetTemplateResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredAudienceModelAssociationOutcome GetConfiguredAudienceModelAssociation(
      const Model::GetConfiguredAudienceModelAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredAudienceModelAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetConfiguredAudienceModelAssociationRequestT = Model::GetConfiguredAudienceModelAssociationRequest>
  Model::GetConfiguredAudienceModelAssociationOutcomeCallable GetConfiguredAudienceModelAssociationCallable(
      const GetConfiguredAudienceModelAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetConfiguredAudienceModelAssociation, request);
  }

  /**
   * An Async wrapper for GetConfiguredAudienceModelAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetConfiguredAudienceModelAssociationRequestT = Model::GetConfiguredAudienceModelAssociationRequest>
  void GetConfiguredAudienceModelAssociationAsync(const GetConfiguredAudienceModelAssociationRequestT& request,
                                                  const GetConfiguredAudienceModelAssociationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConfiguredTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConfiguredTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetConfiguredTableRequestT = Model::GetConfiguredTableRequest>
  void GetConfiguredTableAsync(const GetConfiguredTableRequestT& request, const GetConfiguredTableResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredTableAnalysisRuleOutcome GetConfiguredTableAnalysisRule(
      const Model::GetConfiguredTableAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredTableAnalysisRule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConfiguredTableAnalysisRuleRequestT = Model::GetConfiguredTableAnalysisRuleRequest>
  Model::GetConfiguredTableAnalysisRuleOutcomeCallable GetConfiguredTableAnalysisRuleCallable(
      const GetConfiguredTableAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetConfiguredTableAnalysisRule, request);
  }

  /**
   * An Async wrapper for GetConfiguredTableAnalysisRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetConfiguredTableAnalysisRuleRequestT = Model::GetConfiguredTableAnalysisRuleRequest>
  void GetConfiguredTableAnalysisRuleAsync(const GetConfiguredTableAnalysisRuleRequestT& request,
                                           const GetConfiguredTableAnalysisRuleResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredTableAssociationOutcome GetConfiguredTableAssociation(
      const Model::GetConfiguredTableAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredTableAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConfiguredTableAssociationRequestT = Model::GetConfiguredTableAssociationRequest>
  Model::GetConfiguredTableAssociationOutcomeCallable GetConfiguredTableAssociationCallable(
      const GetConfiguredTableAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetConfiguredTableAssociation, request);
  }

  /**
   * An Async wrapper for GetConfiguredTableAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConfiguredTableAssociationRequestT = Model::GetConfiguredTableAssociationRequest>
  void GetConfiguredTableAssociationAsync(const GetConfiguredTableAssociationRequestT& request,
                                          const GetConfiguredTableAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredTableAssociationAnalysisRuleOutcome GetConfiguredTableAssociationAnalysisRule(
      const Model::GetConfiguredTableAssociationAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredTableAssociationAnalysisRule that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetConfiguredTableAssociationAnalysisRuleOutcomeCallable GetConfiguredTableAssociationAnalysisRuleCallable(
      const GetConfiguredTableAssociationAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetConfiguredTableAssociationAnalysisRule, request);
  }

  /**
   * An Async wrapper for GetConfiguredTableAssociationAnalysisRule that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetConfiguredTableAssociationAnalysisRuleRequestT = Model::GetConfiguredTableAssociationAnalysisRuleRequest>
  void GetConfiguredTableAssociationAnalysisRuleAsync(
      const GetConfiguredTableAssociationAnalysisRuleRequestT& request,
      const GetConfiguredTableAssociationAnalysisRuleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIdMappingTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdMappingTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetIdMappingTableRequestT = Model::GetIdMappingTableRequest>
  void GetIdMappingTableAsync(const GetIdMappingTableRequestT& request, const GetIdMappingTableResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIdNamespaceAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetIdNamespaceAssociationRequestT = Model::GetIdNamespaceAssociationRequest>
  Model::GetIdNamespaceAssociationOutcomeCallable GetIdNamespaceAssociationCallable(
      const GetIdNamespaceAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::GetIdNamespaceAssociation, request);
  }

  /**
   * An Async wrapper for GetIdNamespaceAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdNamespaceAssociationRequestT = Model::GetIdNamespaceAssociationRequest>
  void GetIdNamespaceAssociationAsync(const GetIdNamespaceAssociationRequestT& request,
  ...
  /**
   * An Async wrapper for GetMembership that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMembershipRequestT = Model::GetMembershipRequest>
  void GetMembershipAsync(const GetMembershipRequestT& request, const GetMembershipResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPrivacyBudgetTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPrivacyBudgetTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPrivacyBudgetTemplateRequestT = Model::GetPrivacyBudgetTemplateRequest>
  void GetPrivacyBudgetTemplateAsync(const GetPrivacyBudgetTemplateRequestT& request,
                                     const GetPrivacyBudgetTemplateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetProtectedJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetProtectedJobRequestT = Model::GetProtectedJobRequest>
  void GetProtectedJobAsync(const GetProtectedJobRequestT& request, const GetProtectedJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProtectedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProtectedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetProtectedQueryRequestT = Model::GetProtectedQueryRequest>
  void GetProtectedQueryAsync(const GetProtectedQueryRequestT& request, const GetProtectedQueryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSchemaAnalysisRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSchemaAnalysisRule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSchemaAnalysisRuleRequestT = Model::GetSchemaAnalysisRuleRequest>
  ...
  /**
   * A Callable wrapper for ListAnalysisTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAnalysisTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAnalysisTemplatesRequestT = Model::ListAnalysisTemplatesRequest>
  void ListAnalysisTemplatesAsync(const ListAnalysisTemplatesRequestT& request, const ListAnalysisTemplatesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationAnalysisTemplatesOutcome ListCollaborationAnalysisTemplates(
      const Model::ListCollaborationAnalysisTemplatesRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationAnalysisTemplates that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCollaborationAnalysisTemplatesRequestT = Model::ListCollaborationAnalysisTemplatesRequest>
  Model::ListCollaborationAnalysisTemplatesOutcomeCallable ListCollaborationAnalysisTemplatesCallable(
      const ListCollaborationAnalysisTemplatesRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationAnalysisTemplates, request);
  }

  /**
   * An Async wrapper for ListCollaborationAnalysisTemplates that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCollaborationAnalysisTemplatesRequestT = Model::ListCollaborationAnalysisTemplatesRequest>
  void ListCollaborationAnalysisTemplatesAsync(const ListCollaborationAnalysisTemplatesRequestT& request,
                                               const ListCollaborationAnalysisTemplatesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationChangeRequestsOutcome ListCollaborationChangeRequests(
      const Model::ListCollaborationChangeRequestsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationChangeRequests that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCollaborationChangeRequestsRequestT = Model::ListCollaborationChangeRequestsRequest>
  Model::ListCollaborationChangeRequestsOutcomeCallable ListCollaborationChangeRequestsCallable(
      const ListCollaborationChangeRequestsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationChangeRequests, request);
  }

  /**
   * An Async wrapper for ListCollaborationChangeRequests that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCollaborationChangeRequestsRequestT = Model::ListCollaborationChangeRequestsRequest>
  void ListCollaborationChangeRequestsAsync(const ListCollaborationChangeRequestsRequestT& request,
                                            const ListCollaborationChangeRequestsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationConfiguredAudienceModelAssociationsOutcome ListCollaborationConfiguredAudienceModelAssociations(
      const Model::ListCollaborationConfiguredAudienceModelAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationConfiguredAudienceModelAssociations that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename ListCollaborationConfiguredAudienceModelAssociationsRequestT =
                Model::ListCollaborationConfiguredAudienceModelAssociationsRequest>
  Model::ListCollaborationConfiguredAudienceModelAssociationsOutcomeCallable ListCollaborationConfiguredAudienceModelAssociationsCallable(
      const ListCollaborationConfiguredAudienceModelAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationConfiguredAudienceModelAssociations, request);
  }

  /**
   * An Async wrapper for ListCollaborationConfiguredAudienceModelAssociations that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListCollaborationConfiguredAudienceModelAssociationsRequestT =
                Model::ListCollaborationConfiguredAudienceModelAssociationsRequest>
  void ListCollaborationConfiguredAudienceModelAssociationsAsync(
      const ListCollaborationConfiguredAudienceModelAssociationsRequestT& request,
      const ListCollaborationConfiguredAudienceModelAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationIdNamespaceAssociationsOutcome ListCollaborationIdNamespaceAssociations(
      const Model::ListCollaborationIdNamespaceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationIdNamespaceAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCollaborationIdNamespaceAssociationsRequestT = Model::ListCollaborationIdNamespaceAssociationsRequest>
  Model::ListCollaborationIdNamespaceAssociationsOutcomeCallable ListCollaborationIdNamespaceAssociationsCallable(
      const ListCollaborationIdNamespaceAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationIdNamespaceAssociations, request);
  }

  /**
   * An Async wrapper for ListCollaborationIdNamespaceAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCollaborationIdNamespaceAssociationsRequestT = Model::ListCollaborationIdNamespaceAssociationsRequest>
  void ListCollaborationIdNamespaceAssociationsAsync(
      const ListCollaborationIdNamespaceAssociationsRequestT& request,
      const ListCollaborationIdNamespaceAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationPrivacyBudgetTemplatesOutcome ListCollaborationPrivacyBudgetTemplates(
      const Model::ListCollaborationPrivacyBudgetTemplatesRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationPrivacyBudgetTemplates that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCollaborationPrivacyBudgetTemplatesRequestT = Model::ListCollaborationPrivacyBudgetTemplatesRequest>
  Model::ListCollaborationPrivacyBudgetTemplatesOutcomeCallable ListCollaborationPrivacyBudgetTemplatesCallable(
      const ListCollaborationPrivacyBudgetTemplatesRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationPrivacyBudgetTemplates, request);
  }

  /**
   * An Async wrapper for ListCollaborationPrivacyBudgetTemplates that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCollaborationPrivacyBudgetTemplatesRequestT = Model::ListCollaborationPrivacyBudgetTemplatesRequest>
  void ListCollaborationPrivacyBudgetTemplatesAsync(const ListCollaborationPrivacyBudgetTemplatesRequestT& request,
                                                    const ListCollaborationPrivacyBudgetTemplatesResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationPrivacyBudgetsOutcome ListCollaborationPrivacyBudgets(
      const Model::ListCollaborationPrivacyBudgetsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationPrivacyBudgets that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCollaborationPrivacyBudgetsRequestT = Model::ListCollaborationPrivacyBudgetsRequest>
  Model::ListCollaborationPrivacyBudgetsOutcomeCallable ListCollaborationPrivacyBudgetsCallable(
      const ListCollaborationPrivacyBudgetsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListCollaborationPrivacyBudgets, request);
  }

  /**
   * An Async wrapper for ListCollaborationPrivacyBudgets that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCollaborationPrivacyBudgetsRequestT = Model::ListCollaborationPrivacyBudgetsRequest>
  void ListCollaborationPrivacyBudgetsAsync(const ListCollaborationPrivacyBudgetsRequestT& request,
                                            const ListCollaborationPrivacyBudgetsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCollaborations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCollaborations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCollaborationsRequestT = Model::ListCollaborationsRequest>
  void ListCollaborationsAsync(const ListCollaborationsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListCollaborationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfiguredAudienceModelAssociationsOutcome ListConfiguredAudienceModelAssociations(
      const Model::ListConfiguredAudienceModelAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListConfiguredAudienceModelAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListConfiguredAudienceModelAssociationsRequestT = Model::ListConfiguredAudienceModelAssociationsRequest>
  Model::ListConfiguredAudienceModelAssociationsOutcomeCallable ListConfiguredAudienceModelAssociationsCallable(
      const ListConfiguredAudienceModelAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListConfiguredAudienceModelAssociations, request);
  }

  /**
   * An Async wrapper for ListConfiguredAudienceModelAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListConfiguredAudienceModelAssociationsRequestT = Model::ListConfiguredAudienceModelAssociationsRequest>
  void ListConfiguredAudienceModelAssociationsAsync(const ListConfiguredAudienceModelAssociationsRequestT& request,
                                                    const ListConfiguredAudienceModelAssociationsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfiguredTableAssociationsOutcome ListConfiguredTableAssociations(
      const Model::ListConfiguredTableAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListConfiguredTableAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConfiguredTableAssociationsRequestT = Model::ListConfiguredTableAssociationsRequest>
  Model::ListConfiguredTableAssociationsOutcomeCallable ListConfiguredTableAssociationsCallable(
      const ListConfiguredTableAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListConfiguredTableAssociations, request);
  }

  /**
   * An Async wrapper for ListConfiguredTableAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListConfiguredTableAssociationsRequestT = Model::ListConfiguredTableAssociationsRequest>
  void ListConfiguredTableAssociationsAsync(const ListConfiguredTableAssociationsRequestT& request,
                                            const ListConfiguredTableAssociationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListConfiguredTables that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConfiguredTables that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfiguredTablesRequestT = Model::ListConfiguredTablesRequest>
  void ListConfiguredTablesAsync(const ListConfiguredTablesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListConfiguredTablesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIdMappingTables that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIdMappingTables that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListIdMappingTablesRequestT = Model::ListIdMappingTablesRequest>
  void ListIdMappingTablesAsync(const ListIdMappingTablesRequestT& request, const ListIdMappingTablesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListIdNamespaceAssociationsOutcome ListIdNamespaceAssociations(
      const Model::ListIdNamespaceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListIdNamespaceAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListIdNamespaceAssociationsRequestT = Model::ListIdNamespaceAssociationsRequest>
  Model::ListIdNamespaceAssociationsOutcomeCallable ListIdNamespaceAssociationsCallable(
      const ListIdNamespaceAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListIdNamespaceAssociations, request);
  }

  /**
   * An Async wrapper for ListIdNamespaceAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIdNamespaceAssociationsRequestT = Model::ListIdNamespaceAssociationsRequest>
  void ListIdNamespaceAssociationsAsync(const ListIdNamespaceAssociationsRequestT& request,
                                        const ListIdNamespaceAssociationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListMembershipsRequestT = Model::ListMembershipsRequest>
  void ListMembershipsAsync(const ListMembershipsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListMembershipsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPrivacyBudgetTemplatesOutcome ListPrivacyBudgetTemplates(
      const Model::ListPrivacyBudgetTemplatesRequest& request) const;

  /**
   * A Callable wrapper for ListPrivacyBudgetTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPrivacyBudgetTemplatesRequestT = Model::ListPrivacyBudgetTemplatesRequest>
  Model::ListPrivacyBudgetTemplatesOutcomeCallable ListPrivacyBudgetTemplatesCallable(
      const ListPrivacyBudgetTemplatesRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::ListPrivacyBudgetTemplates, request);
  }

  /**
   * An Async wrapper for ListPrivacyBudgetTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPrivacyBudgetTemplatesRequestT = Model::ListPrivacyBudgetTemplatesRequest>
  void ListPrivacyBudgetTemplatesAsync(const ListPrivacyBudgetTemplatesRequestT& request,
                                       const ListPrivacyBudgetTemplatesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPrivacyBudgets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPrivacyBudgets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPrivacyBudgetsRequestT = Model::ListPrivacyBudgetsRequest>
  void ListPrivacyBudgetsAsync(const ListPrivacyBudgetsRequestT& request, const ListPrivacyBudgetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProtectedJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProtectedJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProtectedJobsRequestT = Model::ListProtectedJobsRequest>
  void ListProtectedJobsAsync(const ListProtectedJobsRequestT& request, const ListProtectedJobsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProtectedQueries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProtectedQueries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProtectedQueriesRequestT = Model::ListProtectedQueriesRequest>
  void ListProtectedQueriesAsync(const ListProtectedQueriesRequestT& request, const ListProtectedQueriesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PopulateIdMappingTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PopulateIdMappingTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PopulateIdMappingTableRequestT = Model::PopulateIdMappingTableRequest>
  void PopulateIdMappingTableAsync(const PopulateIdMappingTableRequestT& request,
  ...
  /**
   * A Callable wrapper for PreviewPrivacyImpact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PreviewPrivacyImpact that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PreviewPrivacyImpactRequestT = Model::PreviewPrivacyImpactRequest>
  ...
  /**
   * A Callable wrapper for StartProtectedJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartProtectedJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartProtectedJobRequestT = Model::StartProtectedJobRequest>
  void StartProtectedJobAsync(const StartProtectedJobRequestT& request, const StartProtectedJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartProtectedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartProtectedQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartProtectedQueryRequestT = Model::StartProtectedQueryRequest>
  void StartProtectedQueryAsync(const StartProtectedQueryRequestT& request, const StartProtectedQueryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAnalysisTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAnalysisTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAnalysisTemplateRequestT = Model::UpdateAnalysisTemplateRequest>
  void UpdateAnalysisTemplateAsync(const UpdateAnalysisTemplateRequestT& request,
                                   const UpdateAnalysisTemplateResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCollaboration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCollaboration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateCollaborationRequestT = Model::UpdateCollaborationRequest>
  void UpdateCollaborationAsync(const UpdateCollaborationRequestT& request, const UpdateCollaborationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfiguredAudienceModelAssociationOutcome UpdateConfiguredAudienceModelAssociation(
      const Model::UpdateConfiguredAudienceModelAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfiguredAudienceModelAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateConfiguredAudienceModelAssociationRequestT = Model::UpdateConfiguredAudienceModelAssociationRequest>
  Model::UpdateConfiguredAudienceModelAssociationOutcomeCallable UpdateConfiguredAudienceModelAssociationCallable(
      const UpdateConfiguredAudienceModelAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdateConfiguredAudienceModelAssociation, request);
  }

  /**
   * An Async wrapper for UpdateConfiguredAudienceModelAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateConfiguredAudienceModelAssociationRequestT = Model::UpdateConfiguredAudienceModelAssociationRequest>
  void UpdateConfiguredAudienceModelAssociationAsync(
      const UpdateConfiguredAudienceModelAssociationRequestT& request,
      const UpdateConfiguredAudienceModelAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateConfiguredTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConfiguredTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfiguredTableRequestT = Model::UpdateConfiguredTableRequest>
  void UpdateConfiguredTableAsync(const UpdateConfiguredTableRequestT& request, const UpdateConfiguredTableResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfiguredTableAnalysisRuleOutcome UpdateConfiguredTableAnalysisRule(
      const Model::UpdateConfiguredTableAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfiguredTableAnalysisRule that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateConfiguredTableAnalysisRuleRequestT = Model::UpdateConfiguredTableAnalysisRuleRequest>
  Model::UpdateConfiguredTableAnalysisRuleOutcomeCallable UpdateConfiguredTableAnalysisRuleCallable(
      const UpdateConfiguredTableAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdateConfiguredTableAnalysisRule, request);
  }

  /**
   * An Async wrapper for UpdateConfiguredTableAnalysisRule that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateConfiguredTableAnalysisRuleRequestT = Model::UpdateConfiguredTableAnalysisRuleRequest>
  void UpdateConfiguredTableAnalysisRuleAsync(const UpdateConfiguredTableAnalysisRuleRequestT& request,
                                              const UpdateConfiguredTableAnalysisRuleResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfiguredTableAssociationOutcome UpdateConfiguredTableAssociation(
      const Model::UpdateConfiguredTableAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfiguredTableAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateConfiguredTableAssociationRequestT = Model::UpdateConfiguredTableAssociationRequest>
  Model::UpdateConfiguredTableAssociationOutcomeCallable UpdateConfiguredTableAssociationCallable(
      const UpdateConfiguredTableAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdateConfiguredTableAssociation, request);
  }

  /**
   * An Async wrapper for UpdateConfiguredTableAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateConfiguredTableAssociationRequestT = Model::UpdateConfiguredTableAssociationRequest>
  void UpdateConfiguredTableAssociationAsync(const UpdateConfiguredTableAssociationRequestT& request,
                                             const UpdateConfiguredTableAssociationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfiguredTableAssociationAnalysisRuleOutcome UpdateConfiguredTableAssociationAnalysisRule(
      const Model::UpdateConfiguredTableAssociationAnalysisRuleRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfiguredTableAssociationAnalysisRule that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::UpdateConfiguredTableAssociationAnalysisRuleOutcomeCallable UpdateConfiguredTableAssociationAnalysisRuleCallable(
      const UpdateConfiguredTableAssociationAnalysisRuleRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdateConfiguredTableAssociationAnalysisRule, request);
  }

  /**
   * An Async wrapper for UpdateConfiguredTableAssociationAnalysisRule that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename UpdateConfiguredTableAssociationAnalysisRuleRequestT = Model::UpdateConfiguredTableAssociationAnalysisRuleRequest>
  void UpdateConfiguredTableAssociationAnalysisRuleAsync(
      const UpdateConfiguredTableAssociationAnalysisRuleRequestT& request,
      const UpdateConfiguredTableAssociationAnalysisRuleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateIdMappingTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateIdMappingTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIdMappingTableRequestT = Model::UpdateIdMappingTableRequest>
  void UpdateIdMappingTableAsync(const UpdateIdMappingTableRequestT& request, const UpdateIdMappingTableResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateIdNamespaceAssociationOutcome UpdateIdNamespaceAssociation(
      const Model::UpdateIdNamespaceAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateIdNamespaceAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateIdNamespaceAssociationRequestT = Model::UpdateIdNamespaceAssociationRequest>
  Model::UpdateIdNamespaceAssociationOutcomeCallable UpdateIdNamespaceAssociationCallable(
      const UpdateIdNamespaceAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdateIdNamespaceAssociation, request);
  }

  /**
   * An Async wrapper for UpdateIdNamespaceAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIdNamespaceAssociationRequestT = Model::UpdateIdNamespaceAssociationRequest>
  void UpdateIdNamespaceAssociationAsync(const UpdateIdNamespaceAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMembership that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMembershipRequestT = Model::UpdateMembershipRequest>
  void UpdateMembershipAsync(const UpdateMembershipRequestT& request, const UpdateMembershipResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePrivacyBudgetTemplateOutcome UpdatePrivacyBudgetTemplate(
      const Model::UpdatePrivacyBudgetTemplateRequest& request) const;

  /**
   * A Callable wrapper for UpdatePrivacyBudgetTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePrivacyBudgetTemplateRequestT = Model::UpdatePrivacyBudgetTemplateRequest>
  Model::UpdatePrivacyBudgetTemplateOutcomeCallable UpdatePrivacyBudgetTemplateCallable(
      const UpdatePrivacyBudgetTemplateRequestT& request) const {
    return SubmitCallable(&CleanRoomsClient::UpdatePrivacyBudgetTemplate, request);
  }

  /**
   * An Async wrapper for UpdatePrivacyBudgetTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePrivacyBudgetTemplateRequestT = Model::UpdatePrivacyBudgetTemplateRequest>
  void UpdatePrivacyBudgetTemplateAsync(const UpdatePrivacyBudgetTemplateRequestT& request,
                                        const UpdatePrivacyBudgetTemplateResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateProtectedJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProtectedJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateProtectedJobRequestT = Model::UpdateProtectedJobRequest>
  void UpdateProtectedJobAsync(const UpdateProtectedJobRequestT& request, const UpdateProtectedJobResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateProtectedQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProtectedQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProtectedQueryRequestT = Model::UpdateProtectedQueryRequest>
  void UpdateProtectedQueryAsync(const UpdateProtectedQueryRequestT& request, const UpdateProtectedQueryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
