...
namespace CleanRooms
{
   ...
   */
  class AWS_CLEANROOMS_API CleanRoomsClient : Aws::Client::ClientWithAsyncTemplateMethods<CleanRoomsClient>,
    smithy::client::AwsSmithyClientT<Aws::CleanRooms::SERVICE_NAME,
