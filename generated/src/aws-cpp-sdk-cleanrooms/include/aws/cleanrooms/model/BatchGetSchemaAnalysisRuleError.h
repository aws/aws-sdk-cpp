...
class BatchGetSchemaAnalysisRuleError {
 public:
  ...
  template <typename NameT = Aws::String>
  BatchGetSchemaAnalysisRuleError& WithName(NameT&& value) {
  ...
  inline BatchGetSchemaAnalysisRuleError& WithType(AnalysisRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CodeT = Aws::String>
  BatchGetSchemaAnalysisRuleError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchGetSchemaAnalysisRuleError& WithMessage(MessageT&& value) {
