...
class GetCollaborationChangeRequestRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  GetCollaborationChangeRequestRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename ChangeRequestIdentifierT = Aws::String>
  GetCollaborationChangeRequestRequest& WithChangeRequestIdentifier(ChangeRequestIdentifierT&& value) {
