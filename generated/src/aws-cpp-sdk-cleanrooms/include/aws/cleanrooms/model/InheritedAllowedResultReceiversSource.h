...
/**
 * <p>Contains information about a parent table that contributes an allowed result
 * receivers constraint.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/InheritedAllowedResultReceiversSource">AWS
 * API Reference</a></p>
 */
class InheritedAllowedResultReceiversSource {
 public:
  AWS_CLEANROOMS_API InheritedAllowedResultReceiversSource() = default;
  ...
  template <typename NameT = Aws::String>
  InheritedAllowedResultReceiversSource& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  InheritedAllowedResultReceiversSource& WithId(IdT&& value) {
  ...
  inline InheritedAllowedResultReceiversSource& WithType(BaseTableDependencyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::Vector<Aws::String>>
  InheritedAllowedResultReceiversSource& WithValue(ValueT&& value) {
    SetValue(std::forward<ValueT>(value));
    return *this;
  }
  template <typename ValueT = Aws::String>
  InheritedAllowedResultReceiversSource& AddValue(ValueT&& value) {
    m_valueHasBeenSet = true;
