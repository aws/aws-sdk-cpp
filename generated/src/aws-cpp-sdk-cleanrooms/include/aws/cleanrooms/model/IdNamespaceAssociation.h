...
namespace Model
{
  ...
  /**
   * <p>Provides information to create the ID namespace association.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/IdNamespaceAssociation">AWS
   * API Reference</a></p>
   */
  class IdNamespaceAssociation
  {
  public:
    AWS_CLEANROOMS_API IdNamespaceAssociation();
    ...
    inline IdNamespaceAssociation& WithId(const Aws::String& value) { SetId(value); return *this;}
    inline IdNamespaceAssociation& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithId(const char* value) { SetId(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithArn(const Aws::String& value) { SetArn(value); return *this;}
    inline IdNamespaceAssociation& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithArn(const char* value) { SetArn(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithMembershipId(const Aws::String& value) { SetMembershipId(value); return *this;}
    inline IdNamespaceAssociation& WithMembershipId(Aws::String&& value) { SetMembershipId(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithMembershipId(const char* value) { SetMembershipId(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithMembershipArn(const Aws::String& value) { SetMembershipArn(value); return *this;}
    inline IdNamespaceAssociation& WithMembershipArn(Aws::String&& value) { SetMembershipArn(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithMembershipArn(const char* value) { SetMembershipArn(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithCollaborationId(const Aws::String& value) { SetCollaborationId(value); return *this;}
    inline IdNamespaceAssociation& WithCollaborationId(Aws::String&& value) { SetCollaborationId(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithCollaborationId(const char* value) { SetCollaborationId(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithCollaborationArn(const Aws::String& value) { SetCollaborationArn(value); return *this;}
    inline IdNamespaceAssociation& WithCollaborationArn(Aws::String&& value) { SetCollaborationArn(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithCollaborationArn(const char* value) { SetCollaborationArn(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithName(const Aws::String& value) { SetName(value); return *this;}
    inline IdNamespaceAssociation& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithName(const char* value) { SetName(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithDescription(const Aws::String& value) { SetDescription(value); return *this;}
    inline IdNamespaceAssociation& WithDescription(Aws::String&& value) { SetDescription(std::move(value)); return *this;}
    inline IdNamespaceAssociation& WithDescription(const char* value) { SetDescription(value); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithCreateTime(const Aws::Utils::DateTime& value) { SetCreateTime(value); return *this;}
    inline IdNamespaceAssociation& WithCreateTime(Aws::Utils::DateTime&& value) { SetCreateTime(std::move(value)); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithUpdateTime(const Aws::Utils::DateTime& value) { SetUpdateTime(value); return *this;}
    inline IdNamespaceAssociation& WithUpdateTime(Aws::Utils::DateTime&& value) { SetUpdateTime(std::move(value)); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithInputReferenceConfig(const IdNamespaceAssociationInputReferenceConfig& value) { SetInputReferenceConfig(value); return *this;}
    inline IdNamespaceAssociation& WithInputReferenceConfig(IdNamespaceAssociationInputReferenceConfig&& value) { SetInputReferenceConfig(std::move(value)); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithInputReferenceProperties(const IdNamespaceAssociationInputReferenceProperties& value) { SetInputReferenceProperties(value); return *this;}
    inline IdNamespaceAssociation& WithInputReferenceProperties(IdNamespaceAssociationInputReferenceProperties&& value) { SetInputReferenceProperties(std::move(value)); return *this;}
    ///@}
    ...
    inline IdNamespaceAssociation& WithIdMappingConfig(const IdMappingConfig& value) { SetIdMappingConfig(value); return *this;}
    inline IdNamespaceAssociation& WithIdMappingConfig(IdMappingConfig&& value) { SetIdMappingConfig(std::move(value)); return *this;}
    ///@}
  private:
