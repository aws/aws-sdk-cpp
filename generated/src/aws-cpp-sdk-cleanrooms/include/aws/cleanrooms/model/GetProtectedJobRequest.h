...
class GetProtectedJobRequest : public CleanRoomsRequest {
 public:
  ...
  void SetProtectedJobIdentifier(ProtectedJobIdentifierT&& value) {
    m_protectedJobIdentifierHasBeenSet = true;
    m_protectedJobIdentifier = std::forward<ProtectedJobIdentifierT>(value);
  }
  template <typename ProtectedJobIdentifierT = Aws::String>
  GetProtectedJobRequest& WithProtectedJobIdentifier(ProtectedJobIdentifierT&& value) {
    SetProtectedJobIdentifier(std::forward<ProtectedJobIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
