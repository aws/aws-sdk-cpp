...
class CreateConfiguredTableAssociationAnalysisRuleResult {
 public:
  ...
  AWS_CLEANROOMS_API CreateConfiguredTableAssociationAnalysisRuleResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AnalysisRuleT = ConfiguredTableAssociationAnalysisRule>
  CreateConfiguredTableAssociationAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConfiguredTableAssociationAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
