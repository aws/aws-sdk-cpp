...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    CollaborationChangeRequestSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationIdT = Aws::String>
    CollaborationChangeRequestSummary& WithCollaborationId(CollaborationIdT&& value) { SetCollaborationId(std::forward<CollaborationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    CollaborationChangeRequestSummary& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimeT = Aws::Utils::DateTime>
    CollaborationChangeRequestSummary& WithUpdateTime(UpdateTimeT&& value) { SetUpdateTime(std::forward<UpdateTimeT>(value)); return *this;}
    ///@}
    ...
    inline CollaborationChangeRequestSummary& WithStatus(ChangeRequestStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline CollaborationChangeRequestSummary& WithIsAutoApproved(bool value) { SetIsAutoApproved(value); return *this;}
    ///@}
    ...
    template<typename ChangesT = Aws::Vector<Change>>
    CollaborationChangeRequestSummary& WithChanges(ChangesT&& value) { SetChanges(std::forward<ChangesT>(value)); return *this;}
    template<typename ChangesT = Change>
    CollaborationChangeRequestSummary& AddChanges(ChangesT&& value) { m_changesHasBeenSet = true; m_changes.emplace_back(std::forward<ChangesT>(value)); return *this; }
    ///@}
  private:
