...
class UpdatePrivacyBudgetTemplateResult {
 public:
  ...
  template <typename PrivacyBudgetTemplateT = PrivacyBudgetTemplate>
  UpdatePrivacyBudgetTemplateResult& WithPrivacyBudgetTemplate(PrivacyBudgetTemplateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePrivacyBudgetTemplateResult& WithRequestId(RequestIdT&& value) {
