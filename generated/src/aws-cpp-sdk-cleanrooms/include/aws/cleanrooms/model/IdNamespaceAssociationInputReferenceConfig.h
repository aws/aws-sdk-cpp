...
class IdNamespaceAssociationInputReferenceConfig {
 public:
  ...
  template <typename InputReferenceArnT = Aws::String>
  IdNamespaceAssociationInputReferenceConfig& WithInputReferenceArn(InputReferenceArnT&& value) {
  ...
  inline IdNamespaceAssociationInputReferenceConfig& WithManageResourcePolicies(bool value) {
