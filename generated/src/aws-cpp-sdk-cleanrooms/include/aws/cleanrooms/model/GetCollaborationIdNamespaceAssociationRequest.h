...
class GetCollaborationIdNamespaceAssociationRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  GetCollaborationIdNamespaceAssociationRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename IdNamespaceAssociationIdentifierT = Aws::String>
  GetCollaborationIdNamespaceAssociationRequest& WithIdNamespaceAssociationIdentifier(IdNamespaceAssociationIdentifierT&& value) {
