...
class ConfiguredTableAssociationAnalysisRuleList {
 public:
  ...
  template <typename AllowedResultReceiversT = Aws::Vector<Aws::String>>
  ConfiguredTableAssociationAnalysisRuleList& WithAllowedResultReceivers(AllowedResultReceiversT&& value) {
    SetAllowedResultReceivers(std::forward<AllowedResultReceiversT>(value));
    return *this;
  }
  template <typename AllowedResultReceiversT = Aws::String>
  ConfiguredTableAssociationAnalysisRuleList& AddAllowedResultReceivers(AllowedResultReceiversT&& value) {
    m_allowedResultReceiversHasBeenSet = true;
  ...
  template <typename AllowedAdditionalAnalysesT = Aws::Vector<Aws::String>>
  ConfiguredTableAssociationAnalysisRuleList& WithAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) {
  ...
  ConfiguredTableAssociationAnalysisRuleList& AddAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) {
    m_allowedAdditionalAnalysesHasBeenSet = true;
