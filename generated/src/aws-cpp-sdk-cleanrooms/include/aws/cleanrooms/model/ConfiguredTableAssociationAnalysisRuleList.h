...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API ConfiguredTableAssociationAnalysisRuleList() = default;
    ...
    template<typename AllowedResultReceiversT = Aws::Vector<Aws::String>>
    ConfiguredTableAssociationAnalysisRuleList& WithAllowedResultReceivers(AllowedResultReceiversT&& value) { SetAllowedResultReceivers(std::forward<AllowedResultReceiversT>(value)); return *this;}
    template<typename AllowedResultReceiversT = Aws::String>
    ConfiguredTableAssociationAnalysisRuleList& AddAllowedResultReceivers(AllowedResultReceiversT&& value) { m_allowedResultReceiversHasBeenSet = true; m_allowedResultReceivers.emplace_back(std::forward<AllowedResultReceiversT>(value)); return *this; }
    ///@}
    ...
    template<typename AllowedAdditionalAnalysesT = Aws::Vector<Aws::String>>
    ConfiguredTableAssociationAnalysisRuleList& WithAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) { SetAllowedAdditionalAnalyses(std::forward<AllowedAdditionalAnalysesT>(value)); return *this;}
    template<typename AllowedAdditionalAnalysesT = Aws::String>
    ConfiguredTableAssociationAnalysisRuleList& AddAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) { m_allowedAdditionalAnalysesHasBeenSet = true; m_allowedAdditionalAnalyses.emplace_back(std::forward<AllowedAdditionalAnalysesT>(value)); return *this; }
    ///@}
  private:
