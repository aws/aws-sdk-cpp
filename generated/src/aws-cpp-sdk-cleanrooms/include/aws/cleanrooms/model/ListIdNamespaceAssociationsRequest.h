...
class ListIdNamespaceAssociationsRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API ListIdNamespaceAssociationsRequest() = default;
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListIdNamespaceAssociationsRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListIdNamespaceAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIdNamespaceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
