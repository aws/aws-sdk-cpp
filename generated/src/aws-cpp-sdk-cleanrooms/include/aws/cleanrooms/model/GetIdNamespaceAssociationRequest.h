...
namespace Model
{
  ...
  /**
   */
  class GetIdNamespaceAssociationRequest : public CleanRoomsRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetIdNamespaceAssociation"; }
    ...
    template<typename IdNamespaceAssociationIdentifierT = Aws::String>
    GetIdNamespaceAssociationRequest& WithIdNamespaceAssociationIdentifier(IdNamespaceAssociationIdentifierT&& value) { SetIdNamespaceAssociationIdentifier(std::forward<IdNamespaceAssociationIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename MembershipIdentifierT = Aws::String>
    GetIdNamespaceAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
  private:
