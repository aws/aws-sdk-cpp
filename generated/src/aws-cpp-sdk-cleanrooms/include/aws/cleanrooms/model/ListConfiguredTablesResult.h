...
class ListConfiguredTablesResult {
 public:
  ...
  void SetConfiguredTableSummaries(ConfiguredTableSummariesT&& value) {
    m_configuredTableSummariesHasBeenSet = true;
    m_configuredTableSummaries = std::forward<ConfiguredTableSummariesT>(value);
  }
  template <typename ConfiguredTableSummariesT = Aws::Vector<ConfiguredTableSummary>>
  ListConfiguredTablesResult& WithConfiguredTableSummaries(ConfiguredTableSummariesT&& value) {
    SetConfiguredTableSummaries(std::forward<ConfiguredTableSummariesT>(value));
    return *this;
  }
  template <typename ConfiguredTableSummariesT = ConfiguredTableSummary>
  ListConfiguredTablesResult& AddConfiguredTableSummaries(ConfiguredTableSummariesT&& value) {
    m_configuredTableSummariesHasBeenSet = true;
    m_configuredTableSummaries.emplace_back(std::forward<ConfiguredTableSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredTablesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfiguredTablesResult& WithRequestId(RequestIdT&& value) {
