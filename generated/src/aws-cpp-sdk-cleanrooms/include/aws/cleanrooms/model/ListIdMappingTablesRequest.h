...
class ListIdMappingTablesRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListIdMappingTablesRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListIdMappingTablesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIdMappingTablesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
