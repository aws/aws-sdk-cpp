...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API ListIdMappingTablesRequest() = default;
    ...
    template<typename MembershipIdentifierT = Aws::String>
    ListIdMappingTablesRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListIdMappingTablesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
