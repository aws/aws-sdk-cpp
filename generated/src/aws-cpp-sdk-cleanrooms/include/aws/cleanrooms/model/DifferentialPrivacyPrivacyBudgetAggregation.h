...
class DifferentialPrivacyPrivacyBudgetAggregation {
 public:
  ...
  inline DifferentialPrivacyPrivacyBudgetAggregation& WithType(DifferentialPrivacyAggregationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DifferentialPrivacyPrivacyBudgetAggregation& WithMaxCount(int value) {
    SetMaxCount(value);
    return *this;
  }
  ///@}
  ...
  inline DifferentialPrivacyPrivacyBudgetAggregation& WithRemainingCount(int value) {
