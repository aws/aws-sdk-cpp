...
class SchemaStatusDetail {
 public:
  ...
  inline SchemaStatusDetail& WithStatus(SchemaStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAnalysisRuleType(AnalysisRuleType value) {
    m_analysisRuleTypeHasBeenSet = true;
    m_analysisRuleType = value;
  }
  inline SchemaStatusDetail& WithAnalysisRuleType(AnalysisRuleType value) {
  ...
  inline SchemaStatusDetail& AddConfigurations(SchemaConfiguration value) {
    m_configurationsHasBeenSet = true;
    m_configurations.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline SchemaStatusDetail& WithAnalysisType(AnalysisType value) {
