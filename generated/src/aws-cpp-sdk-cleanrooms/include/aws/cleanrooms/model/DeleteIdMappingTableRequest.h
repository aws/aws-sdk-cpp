...
class DeleteIdMappingTableRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename IdMappingTableIdentifierT = Aws::String>
  DeleteIdMappingTableRequest& WithIdMappingTableIdentifier(IdMappingTableIdentifierT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteIdMappingTableRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
