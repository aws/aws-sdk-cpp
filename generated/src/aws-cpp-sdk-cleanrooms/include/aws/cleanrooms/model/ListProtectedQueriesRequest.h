...
namespace Model
{
  ...
  public:
    ...
    template<typename MembershipIdentifierT = Aws::String>
    ListProtectedQueriesRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
    ...
    inline ListProtectedQueriesRequest& WithStatus(ProtectedQueryStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListProtectedQueriesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
