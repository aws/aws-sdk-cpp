...
class CreateConfiguredAudienceModelAssociationRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CreateConfiguredAudienceModelAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename ConfiguredAudienceModelArnT = Aws::String>
  CreateConfiguredAudienceModelAssociationRequest& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) {
  ...
  void SetConfiguredAudienceModelAssociationName(ConfiguredAudienceModelAssociationNameT&& value) {
    m_configuredAudienceModelAssociationNameHasBeenSet = true;
    m_configuredAudienceModelAssociationName = std::forward<ConfiguredAudienceModelAssociationNameT>(value);
  }
  template <typename ConfiguredAudienceModelAssociationNameT = Aws::String>
  CreateConfiguredAudienceModelAssociationRequest& WithConfiguredAudienceModelAssociationName(
      ConfiguredAudienceModelAssociationNameT&& value) {
    SetConfiguredAudienceModelAssociationName(std::forward<ConfiguredAudienceModelAssociationNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateConfiguredAudienceModelAssociationRequest& WithManageResourcePolicies(bool value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateConfiguredAudienceModelAssociationRequest& WithTags(TagsT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateConfiguredAudienceModelAssociationRequest& WithDescription(DescriptionT&& value) {
