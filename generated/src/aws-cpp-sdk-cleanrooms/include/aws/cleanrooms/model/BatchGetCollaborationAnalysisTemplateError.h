...
class BatchGetCollaborationAnalysisTemplateError {
 public:
  ...
  template <typename ArnT = Aws::String>
  BatchGetCollaborationAnalysisTemplateError& WithArn(ArnT&& value) {
  ...
  template <typename CodeT = Aws::String>
  BatchGetCollaborationAnalysisTemplateError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchGetCollaborationAnalysisTemplateError& WithMessage(MessageT&& value) {
