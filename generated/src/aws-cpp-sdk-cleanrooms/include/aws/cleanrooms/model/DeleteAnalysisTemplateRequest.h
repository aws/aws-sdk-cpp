...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API DeleteAnalysisTemplateRequest() = default;
    ...
    template<typename MembershipIdentifierT = Aws::String>
    DeleteAnalysisTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AnalysisTemplateIdentifierT = Aws::String>
    DeleteAnalysisTemplateRequest& WithAnalysisTemplateIdentifier(AnalysisTemplateIdentifierT&& value) { SetAnalysisTemplateIdentifier(std::forward<AnalysisTemplateIdentifierT>(value)); return *this;}
    ///@}
  private:
