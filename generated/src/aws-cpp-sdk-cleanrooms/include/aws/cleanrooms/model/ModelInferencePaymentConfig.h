...
class ModelInferencePaymentConfig {
 public:
   ...
   * candidates for model inference costs.</p> <p>If the collaboration creator hasn't
   * specified anyone as the member paying for model inference costs, then the member
  ...
  inline ModelInferencePaymentConfig& WithIsResponsible(bool value) {
