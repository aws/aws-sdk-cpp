...
namespace Model {
class GetIntermediateTableAnalysisRuleResult {
 public:
  AWS_CLEANROOMS_API GetIntermediateTableAnalysisRuleResult() = default;
  AWS_CLEANROOMS_API GetIntermediateTableAnalysisRuleResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CLEANROOMS_API GetIntermediateTableAnalysisRuleResult& operator=(
  ...
  template <typename AnalysisRuleT = IntermediateTableAnalysisRule>
  GetIntermediateTableAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetIntermediateTableAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
