...
namespace Model
{
  ...
  public:
    ...
    template<typename MembershipIdentifierT = Aws::String>
    DeleteMembershipRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
  private:
