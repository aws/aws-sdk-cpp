...
class CollaborationConfiguredAudienceModelAssociationSummary {
 public:
  AWS_CLEANROOMS_API CollaborationConfiguredAudienceModelAssociationSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithArn(ArnT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationConfiguredAudienceModelAssociationSummary& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename IdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithName(NameT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationConfiguredAudienceModelAssociationSummary& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename CollaborationArnT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithCollaborationArn(CollaborationArnT&& value) {
  ...
  template <typename CollaborationIdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithCollaborationId(CollaborationIdT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CollaborationConfiguredAudienceModelAssociationSummary& WithDescription(DescriptionT&& value) {
