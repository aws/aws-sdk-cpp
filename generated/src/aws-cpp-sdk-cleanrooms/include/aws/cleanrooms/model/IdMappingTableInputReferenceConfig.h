...
class IdMappingTableInputReferenceConfig {
 public:
  ...
  void SetInputReferenceArn(InputReferenceArnT&& value) {
    m_inputReferenceArnHasBeenSet = true;
    m_inputReferenceArn = std::forward<InputReferenceArnT>(value);
  }
  template <typename InputReferenceArnT = Aws::String>
  IdMappingTableInputReferenceConfig& WithInputReferenceArn(InputReferenceArnT&& value) {
    SetInputReferenceArn(std::forward<InputReferenceArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline IdMappingTableInputReferenceConfig& WithManageResourcePolicies(bool value) {
