...
class ListProtectedJobsRequest : public CleanRoomsRequest {
 public:
  ...
  inline void SetStatus(ProtectedJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListProtectedJobsRequest& WithStatus(ProtectedJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListProtectedJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
