...
class ProtectedJobReceiverConfiguration {
 public:
  ...
  inline void SetAnalysisType(ProtectedJobAnalysisType value) {
    m_analysisTypeHasBeenSet = true;
    m_analysisType = value;
  }
  inline ProtectedJobReceiverConfiguration& WithAnalysisType(ProtectedJobAnalysisType value) {
  ...
  void SetConfigurationDetails(ConfigurationDetailsT&& value) {
    ...
    m_configurationDetails = std::forward<ConfigurationDetailsT>(value);
  }
  template <typename ConfigurationDetailsT = ProtectedJobConfigurationDetails>
  ProtectedJobReceiverConfiguration& WithConfigurationDetails(ConfigurationDetailsT&& value) {
    SetConfigurationDetails(std::forward<ConfigurationDetailsT>(value));
    return *this;
  }
  ///@}
 private:
