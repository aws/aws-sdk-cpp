...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListProtectedJobsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    void SetProtectedJobs(ProtectedJobsT&& value) { m_protectedJobsHasBeenSet = true; m_protectedJobs = std::forward<ProtectedJobsT>(value); }
    template<typename ProtectedJobsT = Aws::Vector<ProtectedJobSummary>>
    ListProtectedJobsResult& WithProtectedJobs(ProtectedJobsT&& value) { SetProtectedJobs(std::forward<ProtectedJobsT>(value)); return *this;}
    template<typename ProtectedJobsT = ProtectedJobSummary>
    ListProtectedJobsResult& AddProtectedJobs(ProtectedJobsT&& value) { m_protectedJobsHasBeenSet = true; m_protectedJobs.emplace_back(std::forward<ProtectedJobsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListProtectedJobsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
