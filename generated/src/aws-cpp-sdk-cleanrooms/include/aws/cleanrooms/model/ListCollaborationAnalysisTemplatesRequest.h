...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API ListCollaborationAnalysisTemplatesRequest() = default;
    ...
    template<typename CollaborationIdentifierT = Aws::String>
    ListCollaborationAnalysisTemplatesRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) { SetCollaborationIdentifier(std::forward<CollaborationIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListCollaborationAnalysisTemplatesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
