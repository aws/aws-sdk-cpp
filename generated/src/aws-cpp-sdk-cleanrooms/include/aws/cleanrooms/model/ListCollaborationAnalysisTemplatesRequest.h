...
class ListCollaborationAnalysisTemplatesRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationAnalysisTemplatesRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationAnalysisTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationAnalysisTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
