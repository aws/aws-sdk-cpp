...
class ConfiguredTable {
 public:
  ...
  void SetTableReference(TableReferenceT&& value) {
    ...
    m_tableReference = std::forward<TableReferenceT>(value);
  }
  template <typename TableReferenceT = TableReference>
  ConfiguredTable& WithTableReference(TableReferenceT&& value) {
    SetTableReference(std::forward<TableReferenceT>(value));
    return *this;
  }
  ///@}
  ...
  inline ConfiguredTable& AddAnalysisRuleTypes(ConfiguredTableAnalysisRuleType value) {
    m_analysisRuleTypesHasBeenSet = true;
  ...
  inline void SetAnalysisMethod(AnalysisMethod value) {
    m_analysisMethodHasBeenSet = true;
    m_analysisMethod = value;
  }
  inline ConfiguredTable& WithAnalysisMethod(AnalysisMethod value) {
  ...
  void SetAllowedColumns(AllowedColumnsT&& value) {
    ...
    m_allowedColumns = std::forward<AllowedColumnsT>(value);
  }
  template <typename AllowedColumnsT = Aws::Vector<Aws::String>>
  ConfiguredTable& WithAllowedColumns(AllowedColumnsT&& value) {
    SetAllowedColumns(std::forward<AllowedColumnsT>(value));
    return *this;
  }
  template <typename AllowedColumnsT = Aws::String>
  ConfiguredTable& AddAllowedColumns(AllowedColumnsT&& value) {
    m_allowedColumnsHasBeenSet = true;
    m_allowedColumns.emplace_back(std::forward<AllowedColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectedAnalysisMethods(SelectedAnalysisMethodsT&& value) {
    ...
    m_selectedAnalysisMethods = std::forward<SelectedAnalysisMethodsT>(value);
  }
  template <typename SelectedAnalysisMethodsT = Aws::Vector<SelectedAnalysisMethod>>
  ConfiguredTable& WithSelectedAnalysisMethods(SelectedAnalysisMethodsT&& value) {
    SetSelectedAnalysisMethods(std::forward<SelectedAnalysisMethodsT>(value));
    return *this;
  }
  inline ConfiguredTable& AddSelectedAnalysisMethods(SelectedAnalysisMethod value) {
    m_selectedAnalysisMethodsHasBeenSet = true;
    m_selectedAnalysisMethods.push_back(value);
    return *this;
  }
  ///@}
 private:
