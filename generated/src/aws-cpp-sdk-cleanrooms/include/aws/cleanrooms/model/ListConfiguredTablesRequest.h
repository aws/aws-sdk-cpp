...
class ListConfiguredTablesRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API ListConfiguredTablesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredTablesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListConfiguredTablesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
