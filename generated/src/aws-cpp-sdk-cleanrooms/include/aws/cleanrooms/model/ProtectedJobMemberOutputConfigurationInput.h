...
/**
 * <p> The protected job member output configuration input.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/ProtectedJobMemberOutputConfigurationInput">AWS
 * API Reference</a></p>
 */
class ProtectedJobMemberOutputConfigurationInput {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  ProtectedJobMemberOutputConfigurationInput& WithAccountId(AccountIdT&& value) {
