...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API GetConfiguredTableAssociationAnalysisRuleResult();
    ...
    inline GetConfiguredTableAssociationAnalysisRuleResult& WithAnalysisRule(const ConfiguredTableAssociationAnalysisRule& value) { SetAnalysisRule(value); return *this;}
    inline GetConfiguredTableAssociationAnalysisRuleResult& WithAnalysisRule(ConfiguredTableAssociationAnalysisRule&& value) { SetAnalysisRule(std::move(value)); return *this;}
    ///@}
    ...
    inline GetConfiguredTableAssociationAnalysisRuleResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline GetConfiguredTableAssociationAnalysisRuleResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline GetConfiguredTableAssociationAnalysisRuleResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
