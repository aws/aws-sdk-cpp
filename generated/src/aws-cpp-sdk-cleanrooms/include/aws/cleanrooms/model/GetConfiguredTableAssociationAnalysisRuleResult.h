...
class GetConfiguredTableAssociationAnalysisRuleResult {
 public:
  ...
  AWS_CLEANROOMS_API GetConfiguredTableAssociationAnalysisRuleResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AnalysisRuleT = ConfiguredTableAssociationAnalysisRule>
  GetConfiguredTableAssociationAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetConfiguredTableAssociationAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
