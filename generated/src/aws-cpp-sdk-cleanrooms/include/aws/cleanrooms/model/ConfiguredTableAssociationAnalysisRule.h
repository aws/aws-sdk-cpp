...
class ConfiguredTableAssociationAnalysisRule {
 public:
  ...
  void SetConfiguredTableAssociationArn(ConfiguredTableAssociationArnT&& value) {
    m_configuredTableAssociationArnHasBeenSet = true;
    m_configuredTableAssociationArn = std::forward<ConfiguredTableAssociationArnT>(value);
  }
  template <typename ConfiguredTableAssociationArnT = Aws::String>
  ConfiguredTableAssociationAnalysisRule& WithConfiguredTableAssociationArn(ConfiguredTableAssociationArnT&& value) {
    SetConfiguredTableAssociationArn(std::forward<ConfiguredTableAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(ConfiguredTableAssociationAnalysisRuleType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ConfiguredTableAssociationAnalysisRule& WithType(ConfiguredTableAssociationAnalysisRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
