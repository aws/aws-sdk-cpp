...
namespace Model
{
  ...
  public:
    ...
    inline void SetType(AccessBudgetType value) { m_typeHasBeenSet = true; m_type = value; }
    inline BudgetParameter& WithType(AccessBudgetType value) { SetType(value); return *this;}
    ///@}
    ...
    inline void SetBudget(int value) { m_budgetHasBeenSet = true; m_budget = value; }
    inline BudgetParameter& WithBudget(int value) { SetBudget(value); return *this;}
    ///@}
    ...
    inline void SetAutoRefresh(AutoRefreshMode value) { m_autoRefreshHasBeenSet = true; m_autoRefresh = value; }
    inline BudgetParameter& WithAutoRefresh(AutoRefreshMode value) { SetAutoRefresh(value); return *this;}
    ///@}
  private:
