...
class UpdateAnalysisTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  UpdateAnalysisTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename AnalysisTemplateIdentifierT = Aws::String>
  UpdateAnalysisTemplateRequest& WithAnalysisTemplateIdentifier(AnalysisTemplateIdentifierT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateAnalysisTemplateRequest& WithDescription(DescriptionT&& value) {
