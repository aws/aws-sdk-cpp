...
class CollaborationConfiguredAudienceModelAssociation {
 public:
  ...
  template <typename IdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithArn(ArnT&& value) {
  ...
  template <typename CollaborationIdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithCollaborationId(CollaborationIdT&& value) {
  ...
  template <typename CollaborationArnT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithCollaborationArn(CollaborationArnT&& value) {
  ...
  template <typename ConfiguredAudienceModelArnT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationConfiguredAudienceModelAssociation& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationConfiguredAudienceModelAssociation& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationConfiguredAudienceModelAssociation& WithUpdateTime(UpdateTimeT&& value) {
