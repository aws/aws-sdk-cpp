...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API CollaborationConfiguredAudienceModelAssociation() = default;
    ...
    template<typename IdT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationIdT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithCollaborationId(CollaborationIdT&& value) { SetCollaborationId(std::forward<CollaborationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationArnT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithCollaborationArn(CollaborationArnT&& value) { SetCollaborationArn(std::forward<CollaborationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfiguredAudienceModelArnT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) { SetConfiguredAudienceModelArn(std::forward<ConfiguredAudienceModelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatorAccountIdT = Aws::String>
    CollaborationConfiguredAudienceModelAssociation& WithCreatorAccountId(CreatorAccountIdT&& value) { SetCreatorAccountId(std::forward<CreatorAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    CollaborationConfiguredAudienceModelAssociation& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimeT = Aws::Utils::DateTime>
    CollaborationConfiguredAudienceModelAssociation& WithUpdateTime(UpdateTimeT&& value) { SetUpdateTime(std::forward<UpdateTimeT>(value)); return *this;}
    ///@}
  private:
