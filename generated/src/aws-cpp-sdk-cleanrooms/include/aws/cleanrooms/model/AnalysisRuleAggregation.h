...
class AnalysisRuleAggregation {
 public:
  ...
  inline AnalysisRuleAggregation& WithJoinRequired(JoinRequiredOption value) {
  ...
  inline AnalysisRuleAggregation& AddAllowedJoinOperators(JoinOperator value) {
    m_allowedJoinOperatorsHasBeenSet = true;
  ...
  inline AnalysisRuleAggregation& AddScalarFunctions(ScalarFunctions value) {
    m_scalarFunctionsHasBeenSet = true;
  ...
  inline AnalysisRuleAggregation& WithAdditionalAnalyses(AdditionalAnalyses value) {
