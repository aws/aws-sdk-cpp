...
class DifferentialPrivacySensitivityParameters {
 public:
  ...
  inline void SetAggregationType(DifferentialPrivacyAggregationType value) {
    m_aggregationTypeHasBeenSet = true;
    m_aggregationType = value;
  }
  inline DifferentialPrivacySensitivityParameters& WithAggregationType(DifferentialPrivacyAggregationType value) {
  ...
  inline void SetUserContributionLimit(int value) {
    m_userContributionLimitHasBeenSet = true;
    m_userContributionLimit = value;
  }
  inline DifferentialPrivacySensitivityParameters& WithUserContributionLimit(int value) {
    SetUserContributionLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinColumnValue(double value) {
    m_minColumnValueHasBeenSet = true;
    m_minColumnValue = value;
  }
  inline DifferentialPrivacySensitivityParameters& WithMinColumnValue(double value) {
    SetMinColumnValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxColumnValue(double value) {
    m_maxColumnValueHasBeenSet = true;
    m_maxColumnValue = value;
  }
  inline DifferentialPrivacySensitivityParameters& WithMaxColumnValue(double value) {
    SetMaxColumnValue(value);
    return *this;
  }
  ///@}
 private:
