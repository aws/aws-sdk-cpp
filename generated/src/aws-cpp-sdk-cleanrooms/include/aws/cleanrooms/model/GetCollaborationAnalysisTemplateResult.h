...
class GetCollaborationAnalysisTemplateResult {
 public:
  ...
  AWS_CLEANROOMS_API GetCollaborationAnalysisTemplateResult& operator=(
  ...
  void SetCollaborationAnalysisTemplate(CollaborationAnalysisTemplateT&& value) {
    m_collaborationAnalysisTemplateHasBeenSet = true;
    m_collaborationAnalysisTemplate = std::forward<CollaborationAnalysisTemplateT>(value);
  }
  template <typename CollaborationAnalysisTemplateT = CollaborationAnalysisTemplate>
  GetCollaborationAnalysisTemplateResult& WithCollaborationAnalysisTemplate(CollaborationAnalysisTemplateT&& value) {
    SetCollaborationAnalysisTemplate(std::forward<CollaborationAnalysisTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCollaborationAnalysisTemplateResult& WithRequestId(RequestIdT&& value) {
