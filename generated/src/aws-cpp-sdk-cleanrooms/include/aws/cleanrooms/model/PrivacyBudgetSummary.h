...
class PrivacyBudgetSummary {
 public:
  ...
  void SetPrivacyBudgetTemplateId(PrivacyBudgetTemplateIdT&& value) {
    ...
    m_privacyBudgetTemplateId = std::forward<PrivacyBudgetTemplateIdT>(value);
  }
  template <typename PrivacyBudgetTemplateIdT = Aws::String>
  PrivacyBudgetSummary& WithPrivacyBudgetTemplateId(PrivacyBudgetTemplateIdT&& value) {
    SetPrivacyBudgetTemplateId(std::forward<PrivacyBudgetTemplateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrivacyBudgetTemplateArn(PrivacyBudgetTemplateArnT&& value) {
    ...
    m_privacyBudgetTemplateArn = std::forward<PrivacyBudgetTemplateArnT>(value);
  }
  template <typename PrivacyBudgetTemplateArnT = Aws::String>
  PrivacyBudgetSummary& WithPrivacyBudgetTemplateArn(PrivacyBudgetTemplateArnT&& value) {
    SetPrivacyBudgetTemplateArn(std::forward<PrivacyBudgetTemplateArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(PrivacyBudgetType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline PrivacyBudgetSummary& WithType(PrivacyBudgetType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetBudget(BudgetT&& value) {
    ...
    m_budget = std::forward<BudgetT>(value);
  }
  template <typename BudgetT = PrivacyBudget>
  PrivacyBudgetSummary& WithBudget(BudgetT&& value) {
    SetBudget(std::forward<BudgetT>(value));
    return *this;
  }
  ///@}
 private:
