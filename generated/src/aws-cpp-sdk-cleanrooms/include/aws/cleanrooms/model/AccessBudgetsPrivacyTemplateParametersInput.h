...
namespace Model
{
  ...
  public:
    ...
    template<typename BudgetParametersT = Aws::Vector<BudgetParameter>>
    AccessBudgetsPrivacyTemplateParametersInput& WithBudgetParameters(BudgetParametersT&& value) { SetBudgetParameters(std::forward<BudgetParametersT>(value)); return *this;}
    template<typename BudgetParametersT = BudgetParameter>
    AccessBudgetsPrivacyTemplateParametersInput& AddBudgetParameters(BudgetParametersT&& value) { m_budgetParametersHasBeenSet = true; m_budgetParameters.emplace_back(std::forward<BudgetParametersT>(value)); return *this; }
    ///@}
    ...
    template<typename ResourceArnT = Aws::String>
    AccessBudgetsPrivacyTemplateParametersInput& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
