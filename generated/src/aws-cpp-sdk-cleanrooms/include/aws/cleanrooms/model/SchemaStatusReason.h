...
class SchemaStatusReason {
 public:
  ...
  inline void SetCode(SchemaStatusReasonCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline SchemaStatusReason& WithCode(SchemaStatusReasonCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  SchemaStatusReason& WithMessage(MessageT&& value) {
