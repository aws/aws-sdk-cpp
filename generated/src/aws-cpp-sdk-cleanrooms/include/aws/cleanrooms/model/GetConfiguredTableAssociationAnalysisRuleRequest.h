...
class GetConfiguredTableAssociationAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API GetConfiguredTableAssociationAnalysisRuleRequest() = default;
  ...
  template <typename MembershipIdentifierT = Aws::String>
  GetConfiguredTableAssociationAnalysisRuleRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename ConfiguredTableAssociationIdentifierT = Aws::String>
  GetConfiguredTableAssociationAnalysisRuleRequest& WithConfiguredTableAssociationIdentifier(
      ConfiguredTableAssociationIdentifierT&& value) {
  ...
  inline void SetAnalysisRuleType(ConfiguredTableAssociationAnalysisRuleType value) {
    m_analysisRuleTypeHasBeenSet = true;
    m_analysisRuleType = value;
  }
  inline GetConfiguredTableAssociationAnalysisRuleRequest& WithAnalysisRuleType(ConfiguredTableAssociationAnalysisRuleType value) {
