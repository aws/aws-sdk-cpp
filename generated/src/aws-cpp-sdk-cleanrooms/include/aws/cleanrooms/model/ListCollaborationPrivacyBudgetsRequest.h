...
class ListCollaborationPrivacyBudgetsRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationPrivacyBudgetsRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  inline ListCollaborationPrivacyBudgetsRequest& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  inline ListCollaborationPrivacyBudgetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationPrivacyBudgetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename AccessBudgetResourceArnT = Aws::String>
  ListCollaborationPrivacyBudgetsRequest& WithAccessBudgetResourceArn(AccessBudgetResourceArnT&& value) {
