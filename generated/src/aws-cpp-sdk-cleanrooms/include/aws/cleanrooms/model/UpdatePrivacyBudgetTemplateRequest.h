...
class UpdatePrivacyBudgetTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  UpdatePrivacyBudgetTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename PrivacyBudgetTemplateIdentifierT = Aws::String>
  UpdatePrivacyBudgetTemplateRequest& WithPrivacyBudgetTemplateIdentifier(PrivacyBudgetTemplateIdentifierT&& value) {
  ...
  inline UpdatePrivacyBudgetTemplateRequest& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  template <typename ParametersT = PrivacyBudgetTemplateUpdateParameters>
  UpdatePrivacyBudgetTemplateRequest& WithParameters(ParametersT&& value) {
