...
class DeleteConfiguredTableAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename ConfiguredTableIdentifierT = Aws::String>
  DeleteConfiguredTableAnalysisRuleRequest& WithConfiguredTableIdentifier(ConfiguredTableIdentifierT&& value) {
  ...
  inline DeleteConfiguredTableAnalysisRuleRequest& WithAnalysisRuleType(ConfiguredTableAnalysisRuleType value) {
