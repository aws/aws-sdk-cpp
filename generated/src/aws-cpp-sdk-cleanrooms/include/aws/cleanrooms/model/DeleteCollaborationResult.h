...
namespace Model
{
  ...
  public:
    ...
    inline DeleteCollaborationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteCollaborationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteCollaborationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
