...
namespace Model
{
  ...
  public:
    ...
    template<typename CollaborationIdentifierT = Aws::String>
    ListMembersRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) { SetCollaborationIdentifier(std::forward<CollaborationIdentifierT>(value)); return *this;}
    ///@}
