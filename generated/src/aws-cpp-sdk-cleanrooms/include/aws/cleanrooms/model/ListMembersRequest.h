...
namespace Model
{
  ...
  /**
   */
  class ListMembersRequest : public CleanRoomsRequest
  {
  public:
    AWS_CLEANROOMS_API ListMembersRequest();
     ...
     * <p>The identifier of the collaboration in which the members are listed.</p>
     */
    inline ListMembersRequest& WithCollaborationIdentifier(const Aws::String& value) { SetCollaborationIdentifier(value); return *this;}

    /**
     * <p>The identifier of the collaboration in which the members are listed.</p>
     */
    inline ListMembersRequest& WithCollaborationIdentifier(Aws::String&& value) { SetCollaborationIdentifier(std::move(value)); return *this;}

    /**
     * <p>The identifier of the collaboration in which the members are listed.</p>
     */
    inline ListMembersRequest& WithCollaborationIdentifier(const char* value) { SetCollaborationIdentifier(value); return *this;}
