...
class DeleteConfiguredAudienceModelAssociationRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename ConfiguredAudienceModelAssociationIdentifierT = Aws::String>
  DeleteConfiguredAudienceModelAssociationRequest& WithConfiguredAudienceModelAssociationIdentifier(
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteConfiguredAudienceModelAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
