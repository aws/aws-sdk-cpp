...
class AnalysisTemplateValidationStatusDetail {
 public:
  ...
  inline void SetType(AnalysisTemplateValidationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AnalysisTemplateValidationStatusDetail& WithType(AnalysisTemplateValidationType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(AnalysisTemplateValidationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AnalysisTemplateValidationStatusDetail& WithStatus(AnalysisTemplateValidationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
