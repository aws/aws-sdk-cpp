...
class QueryComputePaymentConfig {
 public:
   ...
   * candidates for query compute costs.</p> <p>If the collaboration creator hasn't
   * specified anyone as the member paying for query compute costs, then the member
  ...
  inline QueryComputePaymentConfig& WithIsResponsible(bool value) {
