...
namespace Model
{
  ...
  public:
    ...
    template<typename CollaborationIdentifierT = Aws::String>
    ListSchemasRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) { SetCollaborationIdentifier(std::forward<CollaborationIdentifierT>(value)); return *this;}
    ///@}
     ...
     */
    inline SchemaType GetSchemaType() const { return m_schemaType; }
    inline bool SchemaTypeHasBeenSet() const { return m_schemaTypeHasBeenSet; }
    inline void SetSchemaType(SchemaType value) { m_schemaTypeHasBeenSet = true; m_schemaType = value; }
    inline ListSchemasRequest& WithSchemaType(SchemaType value) { SetSchemaType(value); return *this;}
    ///@}
  ...
  private:
    ...
    SchemaType m_schemaType{SchemaType::NOT_SET};
