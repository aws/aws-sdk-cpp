...
class UpdateIdNamespaceAssociationRequest : public CleanRoomsRequest {
 public:
  ...
  void SetIdNamespaceAssociationIdentifier(IdNamespaceAssociationIdentifierT&& value) {
    m_idNamespaceAssociationIdentifierHasBeenSet = true;
    m_idNamespaceAssociationIdentifier = std::forward<IdNamespaceAssociationIdentifierT>(value);
  }
  template <typename IdNamespaceAssociationIdentifierT = Aws::String>
  UpdateIdNamespaceAssociationRequest& WithIdNamespaceAssociationIdentifier(IdNamespaceAssociationIdentifierT&& value) {
    SetIdNamespaceAssociationIdentifier(std::forward<IdNamespaceAssociationIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdMappingConfig(IdMappingConfigT&& value) {
    ...
    m_idMappingConfig = std::forward<IdMappingConfigT>(value);
  }
  template <typename IdMappingConfigT = IdMappingConfig>
  UpdateIdNamespaceAssociationRequest& WithIdMappingConfig(IdMappingConfigT&& value) {
    SetIdMappingConfig(std::forward<IdMappingConfigT>(value));
    return *this;
  }
  ///@}
 private:
