...
namespace Model
{
  ...
  public:
    ...
    template<typename CollaborationIdentifierT = Aws::String>
    BatchGetSchemaRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) { SetCollaborationIdentifier(std::forward<CollaborationIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NamesT = Aws::Vector<Aws::String>>
    BatchGetSchemaRequest& WithNames(NamesT&& value) { SetNames(std::forward<NamesT>(value)); return *this;}
    template<typename NamesT = Aws::String>
    BatchGetSchemaRequest& AddNames(NamesT&& value) { m_namesHasBeenSet = true; m_names.emplace_back(std::forward<NamesT>(value)); return *this; }
    ///@}
  private:
