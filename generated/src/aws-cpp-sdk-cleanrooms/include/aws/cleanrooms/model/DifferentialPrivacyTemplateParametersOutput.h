...
class DifferentialPrivacyTemplateParametersOutput {
 public:
  AWS_CLEANROOMS_API DifferentialPrivacyTemplateParametersOutput() = default;
  ...
  inline void SetEpsilon(int value) {
    m_epsilonHasBeenSet = true;
    m_epsilon = value;
  }
  inline DifferentialPrivacyTemplateParametersOutput& WithEpsilon(int value) {
    SetEpsilon(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUsersNoisePerQuery(int value) {
    m_usersNoisePerQueryHasBeenSet = true;
    m_usersNoisePerQuery = value;
  }
  inline DifferentialPrivacyTemplateParametersOutput& WithUsersNoisePerQuery(int value) {
    SetUsersNoisePerQuery(value);
    return *this;
  }
  ///@}
 private:
