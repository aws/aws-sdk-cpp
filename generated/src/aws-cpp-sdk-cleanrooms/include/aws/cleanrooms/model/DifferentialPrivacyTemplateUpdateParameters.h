...
class DifferentialPrivacyTemplateUpdateParameters {
 public:
  ...
  inline DifferentialPrivacyTemplateUpdateParameters& WithEpsilon(int value) {
    SetEpsilon(value);
    return *this;
  }
  ///@}
  ...
  inline DifferentialPrivacyTemplateUpdateParameters& WithUsersNoisePerQuery(int value) {
