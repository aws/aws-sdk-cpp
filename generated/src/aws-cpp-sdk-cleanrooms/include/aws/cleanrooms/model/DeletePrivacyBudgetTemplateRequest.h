...
class DeletePrivacyBudgetTemplateRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API DeletePrivacyBudgetTemplateRequest() = default;
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeletePrivacyBudgetTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename PrivacyBudgetTemplateIdentifierT = Aws::String>
  DeletePrivacyBudgetTemplateRequest& WithPrivacyBudgetTemplateIdentifier(PrivacyBudgetTemplateIdentifierT&& value) {
