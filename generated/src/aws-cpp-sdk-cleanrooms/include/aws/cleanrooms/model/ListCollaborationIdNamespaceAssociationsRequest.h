...
class ListCollaborationIdNamespaceAssociationsRequest : public CleanRoomsRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListCollaborationIdNamespaceAssociations"; }
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationIdNamespaceAssociationsRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationIdNamespaceAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationIdNamespaceAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
