...
class DeleteConfiguredTableAssociationRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename ConfiguredTableAssociationIdentifierT = Aws::String>
  DeleteConfiguredTableAssociationRequest& WithConfiguredTableAssociationIdentifier(ConfiguredTableAssociationIdentifierT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteConfiguredTableAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
