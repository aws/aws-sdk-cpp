...
class UpdateConfiguredTableRequest : public CleanRoomsRequest {
 public:
  ...
  inline UpdateConfiguredTableRequest& WithAnalysisMethod(AnalysisMethod value) {
  ...
  inline UpdateConfiguredTableRequest& AddSelectedAnalysisMethods(SelectedAnalysisMethod value) {
    m_selectedAnalysisMethodsHasBeenSet = true;
