...
/**
 */
class UpdateIntermediateTableAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API UpdateIntermediateTableAnalysisRuleRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "UpdateIntermediateTableAnalysisRule"; }
  ...
  template <typename MembershipIdentifierT = Aws::String>
  UpdateIntermediateTableAnalysisRuleRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the intermediate table for which to update the
   * analysis rule.</p>
   */
  ...
  template <typename IntermediateTableIdentifierT = Aws::String>
  UpdateIntermediateTableAnalysisRuleRequest& WithIntermediateTableIdentifier(IntermediateTableIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The type of analysis rule to update. Currently, only <code>CUSTOM</code> is
   * supported.</p>
   */
  ...
  inline UpdateIntermediateTableAnalysisRuleRequest& WithAnalysisRuleType(IntermediateTableAnalysisRuleType value) {
  ...
  template <typename AnalysisRulePolicyT = IntermediateTableAnalysisRulePolicy>
  UpdateIntermediateTableAnalysisRuleRequest& WithAnalysisRulePolicy(AnalysisRulePolicyT&& value) {
