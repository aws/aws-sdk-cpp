...
class AggregateColumn {
 public:
  ...
  template <typename ColumnNamesT = Aws::Vector<Aws::String>>
  AggregateColumn& WithColumnNames(ColumnNamesT&& value) {
    SetColumnNames(std::forward<ColumnNamesT>(value));
    return *this;
  }
  template <typename ColumnNamesT = Aws::String>
  AggregateColumn& AddColumnNames(ColumnNamesT&& value) {
    m_columnNamesHasBeenSet = true;
  ...
  inline void SetFunction(AggregateFunctionName value) {
    m_functionHasBeenSet = true;
    m_function = value;
  }
  inline AggregateColumn& WithFunction(AggregateFunctionName value) {
    SetFunction(value);
    return *this;
  }
  ///@}
