...
class CollaborationPrivacyBudgetTemplateSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  CollaborationPrivacyBudgetTemplateSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CollaborationPrivacyBudgetTemplateSummary& WithArn(ArnT&& value) {
  ...
  template <typename CollaborationIdT = Aws::String>
  CollaborationPrivacyBudgetTemplateSummary& WithCollaborationId(CollaborationIdT&& value) {
  ...
  template <typename CollaborationArnT = Aws::String>
  CollaborationPrivacyBudgetTemplateSummary& WithCollaborationArn(CollaborationArnT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationPrivacyBudgetTemplateSummary& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  inline CollaborationPrivacyBudgetTemplateSummary& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationPrivacyBudgetTemplateSummary& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationPrivacyBudgetTemplateSummary& WithUpdateTime(UpdateTimeT&& value) {
