...
namespace Model {
class CreateIntermediateTableResult {
 public:
  AWS_CLEANROOMS_API CreateIntermediateTableResult() = default;
  AWS_CLEANROOMS_API CreateIntermediateTableResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CLEANROOMS_API CreateIntermediateTableResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IntermediateTableT = IntermediateTable>
  CreateIntermediateTableResult& WithIntermediateTable(IntermediateTableT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateIntermediateTableResult& WithRequestId(RequestIdT&& value) {
