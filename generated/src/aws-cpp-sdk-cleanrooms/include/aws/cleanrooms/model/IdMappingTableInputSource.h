...
class IdMappingTableInputSource {
 public:
  ...
  void SetIdNamespaceAssociationId(IdNamespaceAssociationIdT&& value) {
    m_idNamespaceAssociationIdHasBeenSet = true;
    m_idNamespaceAssociationId = std::forward<IdNamespaceAssociationIdT>(value);
  }
  template <typename IdNamespaceAssociationIdT = Aws::String>
  IdMappingTableInputSource& WithIdNamespaceAssociationId(IdNamespaceAssociationIdT&& value) {
    SetIdNamespaceAssociationId(std::forward<IdNamespaceAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline IdMappingTableInputSource& WithType(IdNamespaceType value) {
    SetType(value);
    return *this;
  }
  ///@}
