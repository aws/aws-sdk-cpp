...
class ListCollaborationsRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMemberStatus(FilterableMemberStatus value) {
    m_memberStatusHasBeenSet = true;
    m_memberStatus = value;
  }
  inline ListCollaborationsRequest& WithMemberStatus(FilterableMemberStatus value) {
