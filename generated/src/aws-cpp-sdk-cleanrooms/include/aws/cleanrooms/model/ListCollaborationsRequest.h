...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API ListCollaborationsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListCollaborationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
     ...
     */
    inline FilterableMemberStatus GetMemberStatus() const { return m_memberStatus; }
    inline bool MemberStatusHasBeenSet() const { return m_memberStatusHasBeenSet; }
    inline void SetMemberStatus(FilterableMemberStatus value) { m_memberStatusHasBeenSet = true; m_memberStatus = value; }
    inline ListCollaborationsRequest& WithMemberStatus(FilterableMemberStatus value) { SetMemberStatus(value); return *this;}
    ///@}
  private:
