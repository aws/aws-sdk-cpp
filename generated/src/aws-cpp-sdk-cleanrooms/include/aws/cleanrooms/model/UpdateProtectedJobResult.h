...
class UpdateProtectedJobResult {
 public:
  ...
  void SetProtectedJob(ProtectedJobT&& value) {
    ...
    m_protectedJob = std::forward<ProtectedJobT>(value);
  }
  template <typename ProtectedJobT = ProtectedJob>
  UpdateProtectedJobResult& WithProtectedJob(ProtectedJobT&& value) {
    SetProtectedJob(std::forward<ProtectedJobT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProtectedJobResult& WithRequestId(RequestIdT&& value) {
