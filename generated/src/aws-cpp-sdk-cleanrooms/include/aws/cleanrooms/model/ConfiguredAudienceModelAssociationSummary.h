...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API ConfiguredAudienceModelAssociationSummary() = default;
    ...
    template<typename MembershipIdT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithMembershipId(MembershipIdT&& value) { SetMembershipId(std::forward<MembershipIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MembershipArnT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithMembershipArn(MembershipArnT&& value) { SetMembershipArn(std::forward<MembershipArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationArnT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithCollaborationArn(CollaborationArnT&& value) { SetCollaborationArn(std::forward<CollaborationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationIdT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithCollaborationId(CollaborationIdT&& value) { SetCollaborationId(std::forward<CollaborationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    ConfiguredAudienceModelAssociationSummary& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimeT = Aws::Utils::DateTime>
    ConfiguredAudienceModelAssociationSummary& WithUpdateTime(UpdateTimeT&& value) { SetUpdateTime(std::forward<UpdateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfiguredAudienceModelArnT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) { SetConfiguredAudienceModelArn(std::forward<ConfiguredAudienceModelArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ConfiguredAudienceModelAssociationSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
