...
class ConfiguredAudienceModelAssociationSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  ConfiguredAudienceModelAssociationSummary& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ConfiguredAudienceModelAssociationSummary& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ConfiguredAudienceModelAssociationSummary& WithName(NameT&& value) {
