...
class CreatePrivacyBudgetTemplateResult {
 public:
  ...
  void SetPrivacyBudgetTemplate(PrivacyBudgetTemplateT&& value) {
    m_privacyBudgetTemplateHasBeenSet = true;
    m_privacyBudgetTemplate = std::forward<PrivacyBudgetTemplateT>(value);
  }
  template <typename PrivacyBudgetTemplateT = PrivacyBudgetTemplate>
  CreatePrivacyBudgetTemplateResult& WithPrivacyBudgetTemplate(PrivacyBudgetTemplateT&& value) {
    SetPrivacyBudgetTemplate(std::forward<PrivacyBudgetTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreatePrivacyBudgetTemplateResult& WithRequestId(RequestIdT&& value) {
