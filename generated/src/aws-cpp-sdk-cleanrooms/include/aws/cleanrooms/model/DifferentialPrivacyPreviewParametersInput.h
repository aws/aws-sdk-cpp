...
class DifferentialPrivacyPreviewParametersInput {
 public:
  AWS_CLEANROOMS_API DifferentialPrivacyPreviewParametersInput() = default;
  ...
  inline DifferentialPrivacyPreviewParametersInput& WithEpsilon(int value) {
    SetEpsilon(value);
    return *this;
  }
  ///@}
  ...
  inline DifferentialPrivacyPreviewParametersInput& WithUsersNoisePerQuery(int value) {
