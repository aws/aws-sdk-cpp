...
class CreatePrivacyBudgetTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CreatePrivacyBudgetTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  inline CreatePrivacyBudgetTemplateRequest& WithAutoRefresh(PrivacyBudgetTemplateAutoRefresh value) {
  ...
  inline CreatePrivacyBudgetTemplateRequest& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  template <typename ParametersT = PrivacyBudgetTemplateParametersInput>
  CreatePrivacyBudgetTemplateRequest& WithParameters(ParametersT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreatePrivacyBudgetTemplateRequest& WithTags(TagsT&& value) {
