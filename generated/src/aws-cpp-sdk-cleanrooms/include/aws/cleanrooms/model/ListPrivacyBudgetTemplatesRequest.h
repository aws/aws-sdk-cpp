...
class ListPrivacyBudgetTemplatesRequest : public CleanRoomsRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListPrivacyBudgetTemplates"; }
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListPrivacyBudgetTemplatesRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPrivacyBudgetTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPrivacyBudgetTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
