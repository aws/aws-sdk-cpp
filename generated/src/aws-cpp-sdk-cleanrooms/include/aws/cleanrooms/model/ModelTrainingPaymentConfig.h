...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/ModelTrainingPaymentConfig">AWS
   * API Reference</a></p>
   */
  class ModelTrainingPaymentConfig
  {
  public:
    AWS_CLEANROOMS_API ModelTrainingPaymentConfig() = default;
    AWS_CLEANROOMS_API ModelTrainingPaymentConfig(Aws::Utils::Json::JsonView jsonValue);
    AWS_CLEANROOMS_API ModelTrainingPaymentConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline ModelTrainingPaymentConfig& WithIsResponsible(bool value) { SetIsResponsible(value); return *this;}
    ///@}
  private:
