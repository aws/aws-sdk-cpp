...
class CreateConfiguredTableAssociationAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CreateConfiguredTableAssociationAnalysisRuleRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename ConfiguredTableAssociationIdentifierT = Aws::String>
  CreateConfiguredTableAssociationAnalysisRuleRequest& WithConfiguredTableAssociationIdentifier(
  ...
  inline CreateConfiguredTableAssociationAnalysisRuleRequest& WithAnalysisRuleType(ConfiguredTableAssociationAnalysisRuleType value) {
  ...
  template <typename AnalysisRulePolicyT = ConfiguredTableAssociationAnalysisRulePolicy>
  CreateConfiguredTableAssociationAnalysisRuleRequest& WithAnalysisRulePolicy(AnalysisRulePolicyT&& value) {
