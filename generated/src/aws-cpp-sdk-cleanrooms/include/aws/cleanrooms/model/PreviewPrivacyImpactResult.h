...
class PreviewPrivacyImpactResult {
 public:
  ...
  void SetPrivacyImpact(PrivacyImpactT&& value) {
    m_privacyImpactHasBeenSet = true;
    m_privacyImpact = std::forward<PrivacyImpactT>(value);
  }
  template <typename PrivacyImpactT = PrivacyImpact>
  PreviewPrivacyImpactResult& WithPrivacyImpact(PrivacyImpactT&& value) {
    SetPrivacyImpact(std::forward<PrivacyImpactT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PreviewPrivacyImpactResult& WithRequestId(RequestIdT&& value) {
