...
class ListPrivacyBudgetsResult {
 public:
  ...
  void SetPrivacyBudgetSummaries(PrivacyBudgetSummariesT&& value) {
    m_privacyBudgetSummariesHasBeenSet = true;
    m_privacyBudgetSummaries = std::forward<PrivacyBudgetSummariesT>(value);
  }
  template <typename PrivacyBudgetSummariesT = Aws::Vector<PrivacyBudgetSummary>>
  ListPrivacyBudgetsResult& WithPrivacyBudgetSummaries(PrivacyBudgetSummariesT&& value) {
    SetPrivacyBudgetSummaries(std::forward<PrivacyBudgetSummariesT>(value));
    return *this;
  }
  template <typename PrivacyBudgetSummariesT = PrivacyBudgetSummary>
  ListPrivacyBudgetsResult& AddPrivacyBudgetSummaries(PrivacyBudgetSummariesT&& value) {
    m_privacyBudgetSummariesHasBeenSet = true;
    m_privacyBudgetSummaries.emplace_back(std::forward<PrivacyBudgetSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPrivacyBudgetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPrivacyBudgetsResult& WithRequestId(RequestIdT&& value) {
