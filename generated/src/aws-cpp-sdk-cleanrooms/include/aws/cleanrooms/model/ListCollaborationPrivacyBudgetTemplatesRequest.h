...
class ListCollaborationPrivacyBudgetTemplatesRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationPrivacyBudgetTemplatesRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationPrivacyBudgetTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationPrivacyBudgetTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
