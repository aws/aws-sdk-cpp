...
class CreateConfiguredTableAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  ...
  void SetConfiguredTableIdentifier(ConfiguredTableIdentifierT&& value) {
    m_configuredTableIdentifierHasBeenSet = true;
    m_configuredTableIdentifier = std::forward<ConfiguredTableIdentifierT>(value);
  }
  template <typename ConfiguredTableIdentifierT = Aws::String>
  CreateConfiguredTableAnalysisRuleRequest& WithConfiguredTableIdentifier(ConfiguredTableIdentifierT&& value) {
    SetConfiguredTableIdentifier(std::forward<ConfiguredTableIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnalysisRuleType(ConfiguredTableAnalysisRuleType value) {
    m_analysisRuleTypeHasBeenSet = true;
    m_analysisRuleType = value;
  }
  inline CreateConfiguredTableAnalysisRuleRequest& WithAnalysisRuleType(ConfiguredTableAnalysisRuleType value) {
  ...
  template <typename AnalysisRulePolicyT = ConfiguredTableAnalysisRulePolicy>
  CreateConfiguredTableAnalysisRuleRequest& WithAnalysisRulePolicy(AnalysisRulePolicyT&& value) {
