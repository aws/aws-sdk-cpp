...
class ProtectedJobConfigurationDetails {
 public:
   ...
   */
  inline const ProtectedJobDirectAnalysisConfigurationDetails& GetDirectAnalysisConfigurationDetails() const {
  ...
  template <typename DirectAnalysisConfigurationDetailsT = ProtectedJobDirectAnalysisConfigurationDetails>
  ProtectedJobConfigurationDetails& WithDirectAnalysisConfigurationDetails(DirectAnalysisConfigurationDetailsT&& value) {
