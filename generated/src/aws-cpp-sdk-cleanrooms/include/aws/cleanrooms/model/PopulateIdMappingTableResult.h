...
class PopulateIdMappingTableResult {
 public:
  ...
  void SetIdMappingJobId(IdMappingJobIdT&& value) {
    m_idMappingJobIdHasBeenSet = true;
    m_idMappingJobId = std::forward<IdMappingJobIdT>(value);
  }
  template <typename IdMappingJobIdT = Aws::String>
  PopulateIdMappingTableResult& WithIdMappingJobId(IdMappingJobIdT&& value) {
    SetIdMappingJobId(std::forward<IdMappingJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PopulateIdMappingTableResult& WithRequestId(RequestIdT&& value) {
