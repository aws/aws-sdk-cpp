...
class GetCollaborationAnalysisTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  GetCollaborationAnalysisTemplateRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename AnalysisTemplateArnT = Aws::String>
  GetCollaborationAnalysisTemplateRequest& WithAnalysisTemplateArn(AnalysisTemplateArnT&& value) {
