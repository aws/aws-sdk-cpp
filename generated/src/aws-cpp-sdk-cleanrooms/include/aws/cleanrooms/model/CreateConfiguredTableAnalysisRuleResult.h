...
class CreateConfiguredTableAnalysisRuleResult {
 public:
  ...
  AWS_CLEANROOMS_API CreateConfiguredTableAnalysisRuleResult& operator=(
  ...
  template <typename AnalysisRuleT = ConfiguredTableAnalysisRule>
  CreateConfiguredTableAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConfiguredTableAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
