...
class AnalysisTemplateArtifactMetadata {
 public:
  ...
  void SetEntryPointHash(EntryPointHashT&& value) {
    m_entryPointHashHasBeenSet = true;
    m_entryPointHash = std::forward<EntryPointHashT>(value);
  }
  template <typename EntryPointHashT = Hash>
  AnalysisTemplateArtifactMetadata& WithEntryPointHash(EntryPointHashT&& value) {
    SetEntryPointHash(std::forward<EntryPointHashT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalArtifactHashes(AdditionalArtifactHashesT&& value) {
    m_additionalArtifactHashesHasBeenSet = true;
    m_additionalArtifactHashes = std::forward<AdditionalArtifactHashesT>(value);
  }
  template <typename AdditionalArtifactHashesT = Aws::Vector<Hash>>
  AnalysisTemplateArtifactMetadata& WithAdditionalArtifactHashes(AdditionalArtifactHashesT&& value) {
    SetAdditionalArtifactHashes(std::forward<AdditionalArtifactHashesT>(value));
    return *this;
  }
  template <typename AdditionalArtifactHashesT = Hash>
  AnalysisTemplateArtifactMetadata& AddAdditionalArtifactHashes(AdditionalArtifactHashesT&& value) {
    m_additionalArtifactHashesHasBeenSet = true;
    m_additionalArtifactHashes.emplace_back(std::forward<AdditionalArtifactHashesT>(value));
    return *this;
  }
  ///@}
 private:
