...
class CreateConfiguredTableRequest : public CleanRoomsRequest {
 public:
  ...
  inline CreateConfiguredTableRequest& WithAnalysisMethod(AnalysisMethod value) {
  ...
  inline CreateConfiguredTableRequest& AddSelectedAnalysisMethods(SelectedAnalysisMethod value) {
    m_selectedAnalysisMethodsHasBeenSet = true;
