...
class GetPrivacyBudgetTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  GetPrivacyBudgetTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename PrivacyBudgetTemplateIdentifierT = Aws::String>
  GetPrivacyBudgetTemplateRequest& WithPrivacyBudgetTemplateIdentifier(PrivacyBudgetTemplateIdentifierT&& value) {
