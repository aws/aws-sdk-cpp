...
class ListMembersResult {
 public:
  ...
  void SetMemberSummaries(MemberSummariesT&& value) {
    m_memberSummariesHasBeenSet = true;
    m_memberSummaries = std::forward<MemberSummariesT>(value);
  }
  template <typename MemberSummariesT = Aws::Vector<MemberSummary>>
  ListMembersResult& WithMemberSummaries(MemberSummariesT&& value) {
    SetMemberSummaries(std::forward<MemberSummariesT>(value));
    return *this;
  }
  template <typename MemberSummariesT = MemberSummary>
  ListMembersResult& AddMemberSummaries(MemberSummariesT&& value) {
    m_memberSummariesHasBeenSet = true;
    m_memberSummaries.emplace_back(std::forward<MemberSummariesT>(value));
    return *this;
  }
  ///@}
