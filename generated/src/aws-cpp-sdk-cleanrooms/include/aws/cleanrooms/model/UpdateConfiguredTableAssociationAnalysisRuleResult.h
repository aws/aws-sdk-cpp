...
class UpdateConfiguredTableAssociationAnalysisRuleResult {
 public:
  ...
  AWS_CLEANROOMS_API UpdateConfiguredTableAssociationAnalysisRuleResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AnalysisRuleT = ConfiguredTableAssociationAnalysisRule>
  UpdateConfiguredTableAssociationAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConfiguredTableAssociationAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
