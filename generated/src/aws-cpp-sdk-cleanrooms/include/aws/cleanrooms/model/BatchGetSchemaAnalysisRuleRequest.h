...
class BatchGetSchemaAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  ...
  void SetSchemaAnalysisRuleRequests(SchemaAnalysisRuleRequestsT&& value) {
    m_schemaAnalysisRuleRequestsHasBeenSet = true;
    m_schemaAnalysisRuleRequests = std::forward<SchemaAnalysisRuleRequestsT>(value);
  }
  template <typename SchemaAnalysisRuleRequestsT = Aws::Vector<SchemaAnalysisRuleRequest>>
  BatchGetSchemaAnalysisRuleRequest& WithSchemaAnalysisRuleRequests(SchemaAnalysisRuleRequestsT&& value) {
    SetSchemaAnalysisRuleRequests(std::forward<SchemaAnalysisRuleRequestsT>(value));
    return *this;
  }
  ...
  BatchGetSchemaAnalysisRuleRequest& AddSchemaAnalysisRuleRequests(SchemaAnalysisRuleRequestsT&& value) {
    m_schemaAnalysisRuleRequestsHasBeenSet = true;
    m_schemaAnalysisRuleRequests.emplace_back(std::forward<SchemaAnalysisRuleRequestsT>(value));
    return *this;
  }
  ///@}
 private:
