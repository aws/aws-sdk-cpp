...
class ListAnalysisTemplatesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAnalysisTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAnalysisTemplateSummaries(AnalysisTemplateSummariesT&& value) {
    m_analysisTemplateSummariesHasBeenSet = true;
    m_analysisTemplateSummaries = std::forward<AnalysisTemplateSummariesT>(value);
  }
  template <typename AnalysisTemplateSummariesT = Aws::Vector<AnalysisTemplateSummary>>
  ListAnalysisTemplatesResult& WithAnalysisTemplateSummaries(AnalysisTemplateSummariesT&& value) {
    SetAnalysisTemplateSummaries(std::forward<AnalysisTemplateSummariesT>(value));
    return *this;
  }
  template <typename AnalysisTemplateSummariesT = AnalysisTemplateSummary>
  ListAnalysisTemplatesResult& AddAnalysisTemplateSummaries(AnalysisTemplateSummariesT&& value) {
    m_analysisTemplateSummariesHasBeenSet = true;
    m_analysisTemplateSummaries.emplace_back(std::forward<AnalysisTemplateSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAnalysisTemplatesResult& WithRequestId(RequestIdT&& value) {
