...
class ListIdNamespaceAssociationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListIdNamespaceAssociationsResult& WithNextToken(NextTokenT&& value) {
   ...
   * requested.</p>
   */
  inline const Aws::Vector<IdNamespaceAssociationSummary>& GetIdNamespaceAssociationSummaries() const {
    return m_idNamespaceAssociationSummaries;
  }
  template <typename IdNamespaceAssociationSummariesT = Aws::Vector<IdNamespaceAssociationSummary>>
  void SetIdNamespaceAssociationSummaries(IdNamespaceAssociationSummariesT&& value) {
    m_idNamespaceAssociationSummariesHasBeenSet = true;
    m_idNamespaceAssociationSummaries = std::forward<IdNamespaceAssociationSummariesT>(value);
  }
  template <typename IdNamespaceAssociationSummariesT = Aws::Vector<IdNamespaceAssociationSummary>>
  ListIdNamespaceAssociationsResult& WithIdNamespaceAssociationSummaries(IdNamespaceAssociationSummariesT&& value) {
    SetIdNamespaceAssociationSummaries(std::forward<IdNamespaceAssociationSummariesT>(value));
    return *this;
  }
  template <typename IdNamespaceAssociationSummariesT = IdNamespaceAssociationSummary>
  ListIdNamespaceAssociationsResult& AddIdNamespaceAssociationSummaries(IdNamespaceAssociationSummariesT&& value) {
    m_idNamespaceAssociationSummariesHasBeenSet = true;
    m_idNamespaceAssociationSummaries.emplace_back(std::forward<IdNamespaceAssociationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListIdNamespaceAssociationsResult& WithRequestId(RequestIdT&& value) {
