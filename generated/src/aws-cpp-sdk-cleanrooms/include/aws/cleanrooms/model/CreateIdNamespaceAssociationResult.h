...
class CreateIdNamespaceAssociationResult {
 public:
  ...
  template <typename IdNamespaceAssociationT = IdNamespaceAssociation>
  CreateIdNamespaceAssociationResult& WithIdNamespaceAssociation(IdNamespaceAssociationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateIdNamespaceAssociationResult& WithRequestId(RequestIdT&& value) {
