...
class DifferentialPrivacyTemplateParametersInput {
 public:
  ...
  inline DifferentialPrivacyTemplateParametersInput& WithEpsilon(int value) {
    SetEpsilon(value);
    return *this;
  }
  ///@}
  ...
  inline DifferentialPrivacyTemplateParametersInput& WithUsersNoisePerQuery(int value) {
