...
class UpdateConfiguredTableAnalysisRuleResult {
 public:
  ...
  AWS_CLEANROOMS_API UpdateConfiguredTableAnalysisRuleResult& operator=(
  ...
  template <typename AnalysisRuleT = ConfiguredTableAnalysisRule>
  UpdateConfiguredTableAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConfiguredTableAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
