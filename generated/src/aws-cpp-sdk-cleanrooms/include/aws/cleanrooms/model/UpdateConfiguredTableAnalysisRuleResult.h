...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMS_API UpdateConfiguredTableAnalysisRuleResult() = default;
    ...
    template<typename AnalysisRuleT = ConfiguredTableAnalysisRule>
    UpdateConfiguredTableAnalysisRuleResult& WithAnalysisRule(AnalysisRuleT&& value) { SetAnalysisRule(std::forward<AnalysisRuleT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateConfiguredTableAnalysisRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
