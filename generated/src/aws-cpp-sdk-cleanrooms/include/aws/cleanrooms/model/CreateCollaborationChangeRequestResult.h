...
class CreateCollaborationChangeRequestResult {
 public:
  ...
  AWS_CLEANROOMS_API CreateCollaborationChangeRequestResult& operator=(
  ...
  void SetCollaborationChangeRequest(CollaborationChangeRequestT&& value) {
    m_collaborationChangeRequestHasBeenSet = true;
    m_collaborationChangeRequest = std::forward<CollaborationChangeRequestT>(value);
  }
  template <typename CollaborationChangeRequestT = CollaborationChangeRequest>
  CreateCollaborationChangeRequestResult& WithCollaborationChangeRequest(CollaborationChangeRequestT&& value) {
    SetCollaborationChangeRequest(std::forward<CollaborationChangeRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateCollaborationChangeRequestResult& WithRequestId(RequestIdT&& value) {
