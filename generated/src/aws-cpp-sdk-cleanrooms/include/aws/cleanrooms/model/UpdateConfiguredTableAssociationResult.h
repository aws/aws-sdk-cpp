...
class UpdateConfiguredTableAssociationResult {
 public:
  ...
  AWS_CLEANROOMS_API UpdateConfiguredTableAssociationResult& operator=(
  ...
  template <typename ConfiguredTableAssociationT = ConfiguredTableAssociation>
  UpdateConfiguredTableAssociationResult& WithConfiguredTableAssociation(ConfiguredTableAssociationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateConfiguredTableAssociationResult& WithRequestId(RequestIdT&& value) {
