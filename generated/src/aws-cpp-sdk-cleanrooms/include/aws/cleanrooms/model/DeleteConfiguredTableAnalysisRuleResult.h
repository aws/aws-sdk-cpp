...
class DeleteConfiguredTableAnalysisRuleResult {
 public:
  AWS_CLEANROOMS_API DeleteConfiguredTableAnalysisRuleResult() = default;
  ...
  AWS_CLEANROOMS_API DeleteConfiguredTableAnalysisRuleResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DeleteConfiguredTableAnalysisRuleResult& WithRequestId(RequestIdT&& value) {
