...
class GetAnalysisTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  GetAnalysisTemplateRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  void SetAnalysisTemplateIdentifier(AnalysisTemplateIdentifierT&& value) {
    m_analysisTemplateIdentifierHasBeenSet = true;
    m_analysisTemplateIdentifier = std::forward<AnalysisTemplateIdentifierT>(value);
  }
  template <typename AnalysisTemplateIdentifierT = Aws::String>
  GetAnalysisTemplateRequest& WithAnalysisTemplateIdentifier(AnalysisTemplateIdentifierT&& value) {
    SetAnalysisTemplateIdentifier(std::forward<AnalysisTemplateIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
