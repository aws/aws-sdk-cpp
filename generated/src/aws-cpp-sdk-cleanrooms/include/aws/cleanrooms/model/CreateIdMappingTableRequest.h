...
class CreateIdMappingTableRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API CreateIdMappingTableRequest() = default;
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CreateIdMappingTableRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateIdMappingTableRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateIdMappingTableRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename InputReferenceConfigT = IdMappingTableInputReferenceConfig>
  CreateIdMappingTableRequest& WithInputReferenceConfig(InputReferenceConfigT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateIdMappingTableRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateIdMappingTableRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateIdMappingTableRequest& WithKmsKeyArn(KmsKeyArnT&& value) {
