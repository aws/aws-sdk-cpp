...
/**
 * <p>Contains information about a parent table that contributes an additional
 * analyses constraint.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/InheritedAdditionalAnalysesSource">AWS
 * API Reference</a></p>
 */
class InheritedAdditionalAnalysesSource {
 public:
  ...
  template <typename IdT = Aws::String>
  InheritedAdditionalAnalysesSource& WithId(IdT&& value) {
  ...
  inline InheritedAdditionalAnalysesSource& WithType(BaseTableDependencyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline InheritedAdditionalAnalysesSource& WithValue(AdditionalAnalyses value) {
    SetValue(value);
    return *this;
  }
  ///@}
