...
class AggregationConstraint {
 public:
  ...
  inline AggregationConstraint& WithMinimum(int value) {
    SetMinimum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(AggregationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AggregationConstraint& WithType(AggregationType value) {
    SetType(value);
    return *this;
  }
  ///@}
