...
/**
 */
class DeleteIntermediateTableAnalysisRuleRequest : public CleanRoomsRequest {
 public:
  AWS_CLEANROOMS_API DeleteIntermediateTableAnalysisRuleRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteIntermediateTableAnalysisRule"; }
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteIntermediateTableAnalysisRuleRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the intermediate table from which to delete the
   * analysis rule.</p>
   */
  ...
  template <typename IntermediateTableIdentifierT = Aws::String>
  DeleteIntermediateTableAnalysisRuleRequest& WithIntermediateTableIdentifier(IntermediateTableIdentifierT&& value) {
  ...
  ///@{
  /**
   * <p>The type of analysis rule to delete. Currently, only <code>CUSTOM</code> is
   * supported.</p>
   */
  ...
  inline DeleteIntermediateTableAnalysisRuleRequest& WithAnalysisRuleType(IntermediateTableAnalysisRuleType value) {
