...
class AnalysisRuleIdMappingTable {
 public:
  ...
  void SetQueryConstraints(QueryConstraintsT&& value) {
    ...
    m_queryConstraints = std::forward<QueryConstraintsT>(value);
  }
  template <typename QueryConstraintsT = Aws::Vector<QueryConstraint>>
  AnalysisRuleIdMappingTable& WithQueryConstraints(QueryConstraintsT&& value) {
    SetQueryConstraints(std::forward<QueryConstraintsT>(value));
    return *this;
  }
  ...
  AnalysisRuleIdMappingTable& AddQueryConstraints(QueryConstraintsT&& value) {
    m_queryConstraintsHasBeenSet = true;
    m_queryConstraints.emplace_back(std::forward<QueryConstraintsT>(value));
    return *this;
  }
  ///@}
