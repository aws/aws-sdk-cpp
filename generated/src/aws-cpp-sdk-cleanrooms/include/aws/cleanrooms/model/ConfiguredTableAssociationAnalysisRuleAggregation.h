...
class ConfiguredTableAssociationAnalysisRuleAggregation {
 public:
  ...
  template <typename AllowedResultReceiversT = Aws::Vector<Aws::String>>
  ConfiguredTableAssociationAnalysisRuleAggregation& WithAllowedResultReceivers(AllowedResultReceiversT&& value) {
    SetAllowedResultReceivers(std::forward<AllowedResultReceiversT>(value));
    return *this;
  }
  template <typename AllowedResultReceiversT = Aws::String>
  ConfiguredTableAssociationAnalysisRuleAggregation& AddAllowedResultReceivers(AllowedResultReceiversT&& value) {
    m_allowedResultReceiversHasBeenSet = true;
  ...
  template <typename AllowedAdditionalAnalysesT = Aws::Vector<Aws::String>>
  ConfiguredTableAssociationAnalysisRuleAggregation& WithAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) {
  ...
  ConfiguredTableAssociationAnalysisRuleAggregation& AddAllowedAdditionalAnalyses(AllowedAdditionalAnalysesT&& value) {
    m_allowedAdditionalAnalysesHasBeenSet = true;
