...
class BatchGetCollaborationAnalysisTemplateRequest : public CleanRoomsRequest {
 public:
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  BatchGetCollaborationAnalysisTemplateRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  void SetAnalysisTemplateArns(AnalysisTemplateArnsT&& value) {
    m_analysisTemplateArnsHasBeenSet = true;
    m_analysisTemplateArns = std::forward<AnalysisTemplateArnsT>(value);
  }
  template <typename AnalysisTemplateArnsT = Aws::Vector<Aws::String>>
  BatchGetCollaborationAnalysisTemplateRequest& WithAnalysisTemplateArns(AnalysisTemplateArnsT&& value) {
    SetAnalysisTemplateArns(std::forward<AnalysisTemplateArnsT>(value));
    return *this;
  }
  template <typename AnalysisTemplateArnsT = Aws::String>
  BatchGetCollaborationAnalysisTemplateRequest& AddAnalysisTemplateArns(AnalysisTemplateArnsT&& value) {
    m_analysisTemplateArnsHasBeenSet = true;
    m_analysisTemplateArns.emplace_back(std::forward<AnalysisTemplateArnsT>(value));
    return *this;
  }
  ///@}
 private:
