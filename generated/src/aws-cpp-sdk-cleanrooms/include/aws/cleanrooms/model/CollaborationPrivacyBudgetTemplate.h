...
class CollaborationPrivacyBudgetTemplate {
 public:
  ...
  template <typename IdT = Aws::String>
  CollaborationPrivacyBudgetTemplate& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CollaborationPrivacyBudgetTemplate& WithArn(ArnT&& value) {
  ...
  inline CollaborationPrivacyBudgetTemplate& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  inline void SetAutoRefresh(PrivacyBudgetTemplateAutoRefresh value) {
    m_autoRefreshHasBeenSet = true;
    m_autoRefresh = value;
  }
  inline CollaborationPrivacyBudgetTemplate& WithAutoRefresh(PrivacyBudgetTemplateAutoRefresh value) {
