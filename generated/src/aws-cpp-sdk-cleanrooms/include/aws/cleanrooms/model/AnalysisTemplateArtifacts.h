...
class AnalysisTemplateArtifacts {
 public:
  ...
  void SetAdditionalArtifacts(AdditionalArtifactsT&& value) {
    m_additionalArtifactsHasBeenSet = true;
    m_additionalArtifacts = std::forward<AdditionalArtifactsT>(value);
  }
  template <typename AdditionalArtifactsT = Aws::Vector<AnalysisTemplateArtifact>>
  AnalysisTemplateArtifacts& WithAdditionalArtifacts(AdditionalArtifactsT&& value) {
    SetAdditionalArtifacts(std::forward<AdditionalArtifactsT>(value));
    return *this;
  }
  ...
  AnalysisTemplateArtifacts& AddAdditionalArtifacts(AdditionalArtifactsT&& value) {
    m_additionalArtifactsHasBeenSet = true;
    m_additionalArtifacts.emplace_back(std::forward<AdditionalArtifactsT>(value));
    return *this;
  }
  ///@}
