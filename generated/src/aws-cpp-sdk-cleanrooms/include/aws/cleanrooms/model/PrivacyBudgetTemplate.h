...
class PrivacyBudgetTemplate {
 public:
  ...
  template <typename IdT = Aws::String>
  PrivacyBudgetTemplate& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  PrivacyBudgetTemplate& WithArn(ArnT&& value) {
  ...
  template <typename MembershipIdT = Aws::String>
  PrivacyBudgetTemplate& WithMembershipId(MembershipIdT&& value) {
  ...
  template <typename MembershipArnT = Aws::String>
  PrivacyBudgetTemplate& WithMembershipArn(MembershipArnT&& value) {
  ...
  template <typename CollaborationIdT = Aws::String>
  PrivacyBudgetTemplate& WithCollaborationId(CollaborationIdT&& value) {
  ...
  template <typename CollaborationArnT = Aws::String>
  PrivacyBudgetTemplate& WithCollaborationArn(CollaborationArnT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  PrivacyBudgetTemplate& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  PrivacyBudgetTemplate& WithUpdateTime(UpdateTimeT&& value) {
  ...
  inline PrivacyBudgetTemplate& WithPrivacyBudgetType(PrivacyBudgetType value) {
  ...
  inline PrivacyBudgetTemplate& WithAutoRefresh(PrivacyBudgetTemplateAutoRefresh value) {
  ...
  template <typename ParametersT = PrivacyBudgetTemplateParametersOutput>
  PrivacyBudgetTemplate& WithParameters(ParametersT&& value) {
