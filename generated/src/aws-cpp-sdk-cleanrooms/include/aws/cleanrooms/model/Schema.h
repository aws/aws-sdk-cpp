...
class Schema {
 public:
  ...
  inline Schema& AddAnalysisRuleTypes(AnalysisRuleType value) {
    m_analysisRuleTypesHasBeenSet = true;
  ...
  inline Schema& WithAnalysisMethod(AnalysisMethod value) {
  ...
  inline Schema& AddSelectedAnalysisMethods(SelectedAnalysisMethod value) {
    m_selectedAnalysisMethodsHasBeenSet = true;
  ...
  inline Schema& WithType(SchemaType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSchemaStatusDetails(SchemaStatusDetailsT&& value) {
    ...
    m_schemaStatusDetails = std::forward<SchemaStatusDetailsT>(value);
  }
  template <typename SchemaStatusDetailsT = Aws::Vector<SchemaStatusDetail>>
  Schema& WithSchemaStatusDetails(SchemaStatusDetailsT&& value) {
    SetSchemaStatusDetails(std::forward<SchemaStatusDetailsT>(value));
    return *this;
  }
  template <typename SchemaStatusDetailsT = SchemaStatusDetail>
  Schema& AddSchemaStatusDetails(SchemaStatusDetailsT&& value) {
    m_schemaStatusDetailsHasBeenSet = true;
    m_schemaStatusDetails.emplace_back(std::forward<SchemaStatusDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchemaTypeProperties(SchemaTypePropertiesT&& value) {
    ...
    m_schemaTypeProperties = std::forward<SchemaTypePropertiesT>(value);
  }
  template <typename SchemaTypePropertiesT = SchemaTypeProperties>
  Schema& WithSchemaTypeProperties(SchemaTypePropertiesT&& value) {
    SetSchemaTypeProperties(std::forward<SchemaTypePropertiesT>(value));
    return *this;
  }
  ///@}
 private:
