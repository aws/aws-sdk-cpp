...
class ConfigurationDetails {
 public:
   ...
   */
  inline const DirectAnalysisConfigurationDetails& GetDirectAnalysisConfigurationDetails() const {
    return m_directAnalysisConfigurationDetails;
  }
  ...
  void SetDirectAnalysisConfigurationDetails(DirectAnalysisConfigurationDetailsT&& value) {
    m_directAnalysisConfigurationDetailsHasBeenSet = true;
    m_directAnalysisConfigurationDetails = std::forward<DirectAnalysisConfigurationDetailsT>(value);
  }
  template <typename DirectAnalysisConfigurationDetailsT = DirectAnalysisConfigurationDetails>
  ConfigurationDetails& WithDirectAnalysisConfigurationDetails(DirectAnalysisConfigurationDetailsT&& value) {
    SetDirectAnalysisConfigurationDetails(std::forward<DirectAnalysisConfigurationDetailsT>(value));
    return *this;
  }
  ///@}
 private:
