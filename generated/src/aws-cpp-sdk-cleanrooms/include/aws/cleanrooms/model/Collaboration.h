...
class Collaboration {
 public:
  ...
  inline Collaboration& WithMemberStatus(MemberStatus value) {
  ...
  inline Collaboration& WithQueryLogStatus(CollaborationQueryLogStatus value) {
  ...
  inline Collaboration& WithJobLogStatus(CollaborationJobLogStatus value) {
  ...
  inline Collaboration& WithAnalyticsEngine(AnalyticsEngine value) {
  ...
  inline Collaboration& AddAutoApprovedChangeTypes(AutoApprovedChangeType value) {
    m_autoApprovedChangeTypesHasBeenSet = true;
  ...
  inline Collaboration& AddAllowedResultRegions(SupportedS3Region value) {
    m_allowedResultRegionsHasBeenSet = true;
