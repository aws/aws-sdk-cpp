...
ConsolidatedPolicyCustom::ConsolidatedPolicyCustom(JsonView jsonValue) { *this = jsonValue; }
...
ConsolidatedPolicyCustom& ConsolidatedPolicyCustom::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("allowedAnalysisProviders")) {
    ...
    for (unsigned allowedAnalysisProvidersIndex = 0; allowedAnalysisProvidersIndex < allowedAnalysisProvidersJsonList.GetLength();
         ++allowedAnalysisProvidersIndex) {
  ...
  if (jsonValue.ValueExists("disallowedOutputColumns")) {
    ...
    for (unsigned disallowedOutputColumnsIndex = 0; disallowedOutputColumnsIndex < disallowedOutputColumnsJsonList.GetLength();
         ++disallowedOutputColumnsIndex) {
