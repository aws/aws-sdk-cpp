...
IntermediateTableSchema::IntermediateTableSchema(JsonView jsonValue) { *this = jsonValue; }

IntermediateTableSchema& IntermediateTableSchema::operator=(JsonView jsonValue) {
...
JsonValue IntermediateTableSchema::Jsonize() const {
  JsonValue payload;
