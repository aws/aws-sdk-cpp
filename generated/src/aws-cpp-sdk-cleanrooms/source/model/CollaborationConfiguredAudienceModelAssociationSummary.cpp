...
CollaborationConfiguredAudienceModelAssociationSummary::CollaborationConfiguredAudienceModelAssociationSummary() : 
...
CollaborationConfiguredAudienceModelAssociationSummary::CollaborationConfiguredAudienceModelAssociationSummary(JsonView jsonValue) : 
    m_arnHasBeenSet(false),
    m_createTimeHasBeenSet(false),
    m_idHasBeenSet(false),
    m_nameHasBeenSet(false),
...
CollaborationConfiguredAudienceModelAssociationSummary& CollaborationConfiguredAudienceModelAssociationSummary::operator =(JsonView jsonValue)
{
...
JsonValue CollaborationConfiguredAudienceModelAssociationSummary::Jsonize() const
{
  JsonValue payload;
