...
ListCollaborationChangeRequestsResult& ListCollaborationChangeRequestsResult::operator=(
  ...
  if (jsonValue.ValueExists("collaborationChangeRequestSummaries")) {
    ...
    for (unsigned collaborationChangeRequestSummariesIndex = 0;
         collaborationChangeRequestSummariesIndex < collaborationChangeRequestSummariesJsonList.GetLength();
         ++collaborationChangeRequestSummariesIndex) {
      m_collaborationChangeRequestSummaries.push_back(
          collaborationChangeRequestSummariesJsonList[collaborationChangeRequestSummariesIndex].AsObject());
    }
