...
IntermediateTableAnalysisRuleCustom::IntermediateTableAnalysisRuleCustom(JsonView jsonValue) { *this = jsonValue; }

IntermediateTableAnalysisRuleCustom& IntermediateTableAnalysisRuleCustom::operator=(JsonView jsonValue) {
...
JsonValue IntermediateTableAnalysisRuleCustom::Jsonize() const {
  JsonValue payload;
