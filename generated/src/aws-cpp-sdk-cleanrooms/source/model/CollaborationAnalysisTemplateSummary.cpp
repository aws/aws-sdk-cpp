...
CollaborationAnalysisTemplateSummary::CollaborationAnalysisTemplateSummary(JsonView jsonValue) { *this = jsonValue; }

CollaborationAnalysisTemplateSummary& CollaborationAnalysisTemplateSummary::operator=(JsonView jsonValue) {
...
JsonValue CollaborationAnalysisTemplateSummary::Jsonize() const {
  JsonValue payload;
