...
IntermediateTableStatus GetIntermediateTableStatusForName(const Aws::String& name) {
  int hashCode = HashingUtils::HashString(name.c_str());
  if (hashCode == CREATED_HASH) {
    return IntermediateTableStatus::CREATED;
  } else if (hashCode == POPULATE_STARTED_HASH) {
    return IntermediateTableStatus::POPULATE_STARTED;
  } else if (hashCode == POPULATE_SUCCESS_HASH) {
    return IntermediateTableStatus::POPULATE_SUCCESS;
  } else if (hashCode == POPULATE_FAILED_HASH) {
    return IntermediateTableStatus::POPULATE_FAILED;
  } else if (hashCode == DISALLOWED_BY_DATA_PROVIDER_HASH) {
    return IntermediateTableStatus::DISALLOWED_BY_DATA_PROVIDER;
  } else if (hashCode == BASE_TABLE_REMOVED_HASH) {
    return IntermediateTableStatus::BASE_TABLE_REMOVED;
  } else if (hashCode == RETENTION_PERIOD_EXPIRED_HASH) {
    return IntermediateTableStatus::RETENTION_PERIOD_EXPIRED;
  }
  EnumParseOverflowContainer* overflowContainer = Aws::GetEnumOverflowContainer();
  if (overflowContainer) {
    overflowContainer->StoreOverflow(hashCode, name);
    return static_cast<IntermediateTableStatus>(hashCode);
  }

  return IntermediateTableStatus::NOT_SET;
}

Aws::String GetNameForIntermediateTableStatus(IntermediateTableStatus enumValue) {
  switch (enumValue) {
    case IntermediateTableStatus::NOT_SET:
      return {};
    case IntermediateTableStatus::CREATED:
      return "CREATED";
    case IntermediateTableStatus::POPULATE_STARTED:
      return "POPULATE_STARTED";
    case IntermediateTableStatus::POPULATE_SUCCESS:
      return "POPULATE_SUCCESS";
    case IntermediateTableStatus::POPULATE_FAILED:
      return "POPULATE_FAILED";
    case IntermediateTableStatus::DISALLOWED_BY_DATA_PROVIDER:
      return "DISALLOWED_BY_DATA_PROVIDER";
    case IntermediateTableStatus::BASE_TABLE_REMOVED:
      return "BASE_TABLE_REMOVED";
    case IntermediateTableStatus::RETENTION_PERIOD_EXPIRED:
