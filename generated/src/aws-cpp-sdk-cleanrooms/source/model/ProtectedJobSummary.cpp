...
ProtectedJobSummary::ProtectedJobSummary() : 
...
ProtectedJobSummary::ProtectedJobSummary(JsonView jsonValue)
  : ProtectedJobSummary()
{
  *this = jsonValue;
}

ProtectedJobSummary& ProtectedJobSummary::operator =(JsonView jsonValue)
{
...
JsonValue ProtectedJobSummary::Jsonize() const
{
  JsonValue payload;
