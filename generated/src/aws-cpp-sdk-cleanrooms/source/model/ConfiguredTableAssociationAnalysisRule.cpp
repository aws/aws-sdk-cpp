...
ConfiguredTableAssociationAnalysisRule::ConfiguredTableAssociationAnalysisRule(JsonView jsonValue) { *this = jsonValue; }
...
ConfiguredTableAssociationAnalysisRule& ConfiguredTableAssociationAnalysisRule::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("type")) {
    m_type =
        ConfiguredTableAssociationAnalysisRuleTypeMapper::GetConfiguredTableAssociationAnalysisRuleTypeForName(jsonValue.GetString("type"));
...
JsonValue ConfiguredTableAssociationAnalysisRule::Jsonize() const {
  ...
  if (m_typeHasBeenSet) {
    payload.WithString("type",
                       ConfiguredTableAssociationAnalysisRuleTypeMapper::GetNameForConfiguredTableAssociationAnalysisRuleType(m_type));
  }
