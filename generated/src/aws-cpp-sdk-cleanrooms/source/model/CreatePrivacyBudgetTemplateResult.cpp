...
CreatePrivacyBudgetTemplateResult::CreatePrivacyBudgetTemplateResult()
{
}

CreatePrivacyBudgetTemplateResult::CreatePrivacyBudgetTemplateResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
