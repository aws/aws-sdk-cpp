...
GetIdNamespaceAssociationResult::GetIdNamespaceAssociationResult()
{
}

GetIdNamespaceAssociationResult::GetIdNamespaceAssociationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
