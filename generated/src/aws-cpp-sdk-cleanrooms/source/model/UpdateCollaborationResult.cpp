...
UpdateCollaborationResult::UpdateCollaborationResult()
{
}

UpdateCollaborationResult::UpdateCollaborationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
