...
DifferentialPrivacySensitivityParameters::DifferentialPrivacySensitivityParameters(JsonView jsonValue) { *this = jsonValue; }
...
DifferentialPrivacySensitivityParameters& DifferentialPrivacySensitivityParameters::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("aggregationType")) {
    m_aggregationType =
        DifferentialPrivacyAggregationTypeMapper::GetDifferentialPrivacyAggregationTypeForName(jsonValue.GetString("aggregationType"));
...
JsonValue DifferentialPrivacySensitivityParameters::Jsonize() const {
  ...
  if (m_aggregationTypeHasBeenSet) {
    payload.WithString("aggregationType",
                       DifferentialPrivacyAggregationTypeMapper::GetNameForDifferentialPrivacyAggregationType(m_aggregationType));
  }
