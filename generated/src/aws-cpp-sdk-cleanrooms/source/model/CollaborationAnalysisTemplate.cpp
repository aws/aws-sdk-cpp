...
CollaborationAnalysisTemplate::CollaborationAnalysisTemplate(JsonView jsonValue) { *this = jsonValue; }
...
CollaborationAnalysisTemplate& CollaborationAnalysisTemplate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("analysisParameters")) {
    ...
    for (unsigned analysisParametersIndex = 0; analysisParametersIndex < analysisParametersJsonList.GetLength();
         ++analysisParametersIndex) {
