...
UpdateMembershipPaymentConfiguration::UpdateMembershipPaymentConfiguration(JsonView jsonValue) { *this = jsonValue; }

UpdateMembershipPaymentConfiguration& UpdateMembershipPaymentConfiguration::operator=(JsonView jsonValue) {
...
JsonValue UpdateMembershipPaymentConfiguration::Jsonize() const {
  JsonValue payload;
