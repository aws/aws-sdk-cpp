...
IdMappingTable::IdMappingTable(JsonView jsonValue) { *this = jsonValue; }

IdMappingTable& IdMappingTable::operator=(JsonView jsonValue) {
...
JsonValue IdMappingTable::Jsonize() const {
  JsonValue payload;
