...
ListConfiguredTableAssociationsResult& ListConfiguredTableAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("configuredTableAssociationSummaries")) {
    ...
    for (unsigned configuredTableAssociationSummariesIndex = 0;
         configuredTableAssociationSummariesIndex < configuredTableAssociationSummariesJsonList.GetLength();
         ++configuredTableAssociationSummariesIndex) {
      m_configuredTableAssociationSummaries.push_back(
          configuredTableAssociationSummariesJsonList[configuredTableAssociationSummariesIndex].AsObject());
    }
