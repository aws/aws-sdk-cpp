...
BatchGetCollaborationAnalysisTemplateResult& BatchGetCollaborationAnalysisTemplateResult::operator=(
  ...
  if (jsonValue.ValueExists("collaborationAnalysisTemplates")) {
    ...
    for (unsigned collaborationAnalysisTemplatesIndex = 0;
         collaborationAnalysisTemplatesIndex < collaborationAnalysisTemplatesJsonList.GetLength(); ++collaborationAnalysisTemplatesIndex) {
