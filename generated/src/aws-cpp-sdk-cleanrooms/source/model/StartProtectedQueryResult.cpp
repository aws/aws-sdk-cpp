...
StartProtectedQueryResult::StartProtectedQueryResult()
{
}

StartProtectedQueryResult::StartProtectedQueryResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
