...
ListCollaborationPrivacyBudgetsResult& ListCollaborationPrivacyBudgetsResult::operator=(
  ...
  if (jsonValue.ValueExists("collaborationPrivacyBudgetSummaries")) {
    ...
    for (unsigned collaborationPrivacyBudgetSummariesIndex = 0;
         collaborationPrivacyBudgetSummariesIndex < collaborationPrivacyBudgetSummariesJsonList.GetLength();
         ++collaborationPrivacyBudgetSummariesIndex) {
      m_collaborationPrivacyBudgetSummaries.push_back(
          collaborationPrivacyBudgetSummariesJsonList[collaborationPrivacyBudgetSummariesIndex].AsObject());
    }
