...
InheritedAllowedAdditionalAnalysesSource::InheritedAllowedAdditionalAnalysesSource(JsonView jsonValue) { *this = jsonValue; }

InheritedAllowedAdditionalAnalysesSource& InheritedAllowedAdditionalAnalysesSource::operator=(JsonView jsonValue) {
...
JsonValue InheritedAllowedAdditionalAnalysesSource::Jsonize() const {
  JsonValue payload;
