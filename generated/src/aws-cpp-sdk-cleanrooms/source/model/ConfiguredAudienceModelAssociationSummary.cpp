...
ConfiguredAudienceModelAssociationSummary::ConfiguredAudienceModelAssociationSummary(JsonView jsonValue) { *this = jsonValue; }

ConfiguredAudienceModelAssociationSummary& ConfiguredAudienceModelAssociationSummary::operator=(JsonView jsonValue) {
...
JsonValue ConfiguredAudienceModelAssociationSummary::Jsonize() const {
  JsonValue payload;
