...
ListAnalysisTemplatesResult::ListAnalysisTemplatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAnalysisTemplatesResult& ListAnalysisTemplatesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("analysisTemplateSummaries")) {
    ...
    for (unsigned analysisTemplateSummariesIndex = 0; analysisTemplateSummariesIndex < analysisTemplateSummariesJsonList.GetLength();
         ++analysisTemplateSummariesIndex) {
