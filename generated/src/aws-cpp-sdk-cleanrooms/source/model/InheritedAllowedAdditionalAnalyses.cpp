...
InheritedAllowedAdditionalAnalyses::InheritedAllowedAdditionalAnalyses(JsonView jsonValue) { *this = jsonValue; }

InheritedAllowedAdditionalAnalyses& InheritedAllowedAdditionalAnalyses::operator=(JsonView jsonValue) {
...
JsonValue InheritedAllowedAdditionalAnalyses::Jsonize() const {
  JsonValue payload;
