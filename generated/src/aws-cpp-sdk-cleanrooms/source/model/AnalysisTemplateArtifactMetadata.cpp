...
AnalysisTemplateArtifactMetadata::AnalysisTemplateArtifactMetadata(JsonView jsonValue) { *this = jsonValue; }
...
AnalysisTemplateArtifactMetadata& AnalysisTemplateArtifactMetadata::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("additionalArtifactHashes")) {
    ...
    for (unsigned additionalArtifactHashesIndex = 0; additionalArtifactHashesIndex < additionalArtifactHashesJsonList.GetLength();
         ++additionalArtifactHashesIndex) {
...
JsonValue AnalysisTemplateArtifactMetadata::Jsonize() const {
  ...
  if (m_additionalArtifactHashesHasBeenSet) {
    ...
    for (unsigned additionalArtifactHashesIndex = 0; additionalArtifactHashesIndex < additionalArtifactHashesJsonList.GetLength();
         ++additionalArtifactHashesIndex) {
      additionalArtifactHashesJsonList[additionalArtifactHashesIndex].AsObject(
          m_additionalArtifactHashes[additionalArtifactHashesIndex].Jsonize());
    }
