...
ConfiguredTableAssociationAnalysisRuleCustom::ConfiguredTableAssociationAnalysisRuleCustom(JsonView jsonValue) { *this = jsonValue; }

ConfiguredTableAssociationAnalysisRuleCustom& ConfiguredTableAssociationAnalysisRuleCustom::operator=(JsonView jsonValue) {
...
JsonValue ConfiguredTableAssociationAnalysisRuleCustom::Jsonize() const {
  JsonValue payload;
