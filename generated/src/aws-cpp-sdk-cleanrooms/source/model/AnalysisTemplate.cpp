...
AnalysisTemplate::AnalysisTemplate(JsonView jsonValue) { *this = jsonValue; }

AnalysisTemplate& AnalysisTemplate::operator=(JsonView jsonValue) {
...
JsonValue AnalysisTemplate::Jsonize() const {
  JsonValue payload;
