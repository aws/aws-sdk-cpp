...
IdNamespaceAssociationSummary::IdNamespaceAssociationSummary() : 
...
IdNamespaceAssociationSummary::IdNamespaceAssociationSummary(JsonView jsonValue)
  : IdNamespaceAssociationSummary()
{
  *this = jsonValue;
}

IdNamespaceAssociationSummary& IdNamespaceAssociationSummary::operator =(JsonView jsonValue)
{
...
JsonValue IdNamespaceAssociationSummary::Jsonize() const
{
  JsonValue payload;
