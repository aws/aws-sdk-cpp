...
namespace LookoutforVision
{
   ...
   * circuit boards.</p>
   */
  class AWS_LOOKOUTFORVISION_API LookoutforVisionClient : Aws::Client::ClientWithAsyncTemplateMethods<LookoutforVisionClient>,
    smithy::client::AwsSmithyClientT<Aws::LookoutforVision::SERVICE_NAME,
