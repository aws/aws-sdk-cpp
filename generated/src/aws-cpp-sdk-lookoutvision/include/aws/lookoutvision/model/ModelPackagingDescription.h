...
class ModelPackagingDescription {
 public:
  ...
  void SetModelPackagingConfiguration(ModelPackagingConfigurationT&& value) {
    ...
    m_modelPackagingConfiguration = std::forward<ModelPackagingConfigurationT>(value);
  }
  template <typename ModelPackagingConfigurationT = ModelPackagingConfiguration>
  ModelPackagingDescription& WithModelPackagingConfiguration(ModelPackagingConfigurationT&& value) {
    SetModelPackagingConfiguration(std::forward<ModelPackagingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelPackagingJobDescription(ModelPackagingJobDescriptionT&& value) {
    ...
    m_modelPackagingJobDescription = std::forward<ModelPackagingJobDescriptionT>(value);
  }
  template <typename ModelPackagingJobDescriptionT = Aws::String>
  ModelPackagingDescription& WithModelPackagingJobDescription(ModelPackagingJobDescriptionT&& value) {
    SetModelPackagingJobDescription(std::forward<ModelPackagingJobDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelPackagingMethod(ModelPackagingMethodT&& value) {
    ...
    m_modelPackagingMethod = std::forward<ModelPackagingMethodT>(value);
  }
  template <typename ModelPackagingMethodT = Aws::String>
  ModelPackagingDescription& WithModelPackagingMethod(ModelPackagingMethodT&& value) {
    SetModelPackagingMethod(std::forward<ModelPackagingMethodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelPackagingOutputDetails(ModelPackagingOutputDetailsT&& value) {
    ...
    m_modelPackagingOutputDetails = std::forward<ModelPackagingOutputDetailsT>(value);
  }
  template <typename ModelPackagingOutputDetailsT = ModelPackagingOutputDetails>
  ModelPackagingDescription& WithModelPackagingOutputDetails(ModelPackagingOutputDetailsT&& value) {
    SetModelPackagingOutputDetails(std::forward<ModelPackagingOutputDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ModelPackagingJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ModelPackagingDescription& WithStatus(ModelPackagingJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
