...
class DescribeModelResult {
 public:
  ...
  void SetModelDescription(ModelDescriptionT&& value) {
    m_modelDescriptionHasBeenSet = true;
    m_modelDescription = std::forward<ModelDescriptionT>(value);
  }
  template <typename ModelDescriptionT = ModelDescription>
  DescribeModelResult& WithModelDescription(ModelDescriptionT&& value) {
    SetModelDescription(std::forward<ModelDescriptionT>(value));
    return *this;
  }
  ///@}
