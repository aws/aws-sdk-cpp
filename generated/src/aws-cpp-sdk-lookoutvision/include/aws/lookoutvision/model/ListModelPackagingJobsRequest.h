...
class ListModelPackagingJobsRequest : public LookoutforVisionRequest {
 public:
  ...
  template <typename ProjectNameT = Aws::String>
  ListModelPackagingJobsRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListModelPackagingJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelPackagingJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
