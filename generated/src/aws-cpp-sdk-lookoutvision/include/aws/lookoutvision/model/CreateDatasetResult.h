...
class CreateDatasetResult {
 public:
  ...
  void SetDatasetMetadata(DatasetMetadataT&& value) {
    m_datasetMetadataHasBeenSet = true;
    m_datasetMetadata = std::forward<DatasetMetadataT>(value);
  }
  template <typename DatasetMetadataT = DatasetMetadata>
  CreateDatasetResult& WithDatasetMetadata(DatasetMetadataT&& value) {
    SetDatasetMetadata(std::forward<DatasetMetadataT>(value));
    return *this;
  }
  ///@}
