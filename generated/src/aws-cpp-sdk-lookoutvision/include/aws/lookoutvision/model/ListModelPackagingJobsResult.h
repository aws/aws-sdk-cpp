...
class ListModelPackagingJobsResult {
 public:
  ...
  void SetModelPackagingJobs(ModelPackagingJobsT&& value) {
    m_modelPackagingJobsHasBeenSet = true;
    m_modelPackagingJobs = std::forward<ModelPackagingJobsT>(value);
  }
  template <typename ModelPackagingJobsT = Aws::Vector<ModelPackagingJobMetadata>>
  ListModelPackagingJobsResult& WithModelPackagingJobs(ModelPackagingJobsT&& value) {
    SetModelPackagingJobs(std::forward<ModelPackagingJobsT>(value));
    return *this;
  }
  template <typename ModelPackagingJobsT = ModelPackagingJobMetadata>
  ListModelPackagingJobsResult& AddModelPackagingJobs(ModelPackagingJobsT&& value) {
    m_modelPackagingJobsHasBeenSet = true;
    m_modelPackagingJobs.emplace_back(std::forward<ModelPackagingJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelPackagingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelPackagingJobsResult& WithRequestId(RequestIdT&& value) {
