...
class DetectAnomaliesResult {
 public:
  ...
  void SetDetectAnomalyResult(DetectAnomalyResultT&& value) {
    m_detectAnomalyResultHasBeenSet = true;
    m_detectAnomalyResult = std::forward<DetectAnomalyResultT>(value);
  }
  template <typename DetectAnomalyResultT = DetectAnomalyResult>
  DetectAnomaliesResult& WithDetectAnomalyResult(DetectAnomalyResultT&& value) {
    SetDetectAnomalyResult(std::forward<DetectAnomalyResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DetectAnomaliesResult& WithRequestId(RequestIdT&& value) {
