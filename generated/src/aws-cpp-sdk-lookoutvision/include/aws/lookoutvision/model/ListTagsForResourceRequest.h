...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public LookoutforVisionRequest
  {
  public:
    AWS_LOOKOUTFORVISION_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the model for which you want to list tags.
     * </p>
     */
