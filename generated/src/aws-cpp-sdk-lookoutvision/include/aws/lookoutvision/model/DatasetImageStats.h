...
class DatasetImageStats {
 public:
  ...
  inline DatasetImageStats& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLabeled(int value) {
    m_labeledHasBeenSet = true;
    m_labeled = value;
  }
  inline DatasetImageStats& WithLabeled(int value) {
    SetLabeled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNormal(int value) {
    m_normalHasBeenSet = true;
    m_normal = value;
  }
  inline DatasetImageStats& WithNormal(int value) {
    SetNormal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAnomaly(int value) {
    m_anomalyHasBeenSet = true;
    m_anomaly = value;
  }
  inline DatasetImageStats& WithAnomaly(int value) {
    SetAnomaly(value);
    return *this;
  }
  ///@}
