...
class StopModelRequest : public LookoutforVisionRequest {
 public:
  ...
  template <typename ProjectNameT = Aws::String>
  StopModelRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename ModelVersionT = Aws::String>
  StopModelRequest& WithModelVersion(ModelVersionT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StopModelRequest& WithClientToken(ClientTokenT&& value) {
