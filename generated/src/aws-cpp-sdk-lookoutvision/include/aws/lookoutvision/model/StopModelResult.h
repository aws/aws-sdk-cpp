...
class StopModelResult {
 public:
  ...
  inline void SetStatus(ModelHostingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StopModelResult& WithStatus(ModelHostingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopModelResult& WithRequestId(RequestIdT&& value) {
