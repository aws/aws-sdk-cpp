...
class DescribeModelPackagingJobResult {
 public:
  ...
  AWS_LOOKOUTFORVISION_API DescribeModelPackagingJobResult& operator=(
  ...
  void SetModelPackagingDescription(ModelPackagingDescriptionT&& value) {
    m_modelPackagingDescriptionHasBeenSet = true;
    m_modelPackagingDescription = std::forward<ModelPackagingDescriptionT>(value);
  }
  template <typename ModelPackagingDescriptionT = ModelPackagingDescription>
  DescribeModelPackagingJobResult& WithModelPackagingDescription(ModelPackagingDescriptionT&& value) {
    SetModelPackagingDescription(std::forward<ModelPackagingDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeModelPackagingJobResult& WithRequestId(RequestIdT&& value) {
