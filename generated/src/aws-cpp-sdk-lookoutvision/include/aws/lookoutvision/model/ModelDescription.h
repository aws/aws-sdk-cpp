...
class ModelDescription {
 public:
  ...
  inline ModelDescription& WithStatus(ModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetEvaluationManifest(EvaluationManifestT&& value) {
    ...
    m_evaluationManifest = std::forward<EvaluationManifestT>(value);
  }
  template <typename EvaluationManifestT = OutputS3Object>
  ModelDescription& WithEvaluationManifest(EvaluationManifestT&& value) {
    SetEvaluationManifest(std::forward<EvaluationManifestT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluationEndTimestamp(EvaluationEndTimestampT&& value) {
    ...
    m_evaluationEndTimestamp = std::forward<EvaluationEndTimestampT>(value);
  }
  template <typename EvaluationEndTimestampT = Aws::Utils::DateTime>
  ModelDescription& WithEvaluationEndTimestamp(EvaluationEndTimestampT&& value) {
    SetEvaluationEndTimestamp(std::forward<EvaluationEndTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMinInferenceUnits(int value) {
    m_minInferenceUnitsHasBeenSet = true;
    m_minInferenceUnits = value;
  }
  inline ModelDescription& WithMinInferenceUnits(int value) {
    SetMinInferenceUnits(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxInferenceUnits(int value) {
    m_maxInferenceUnitsHasBeenSet = true;
    m_maxInferenceUnits = value;
  }
  inline ModelDescription& WithMaxInferenceUnits(int value) {
    SetMaxInferenceUnits(value);
    return *this;
  }
  ///@}
 private:
