...
class GreengrassConfiguration {
 public:
  ...
  void SetCompilerOptions(CompilerOptionsT&& value) {
    ...
    m_compilerOptions = std::forward<CompilerOptionsT>(value);
  }
  template <typename CompilerOptionsT = Aws::String>
  GreengrassConfiguration& WithCompilerOptions(CompilerOptionsT&& value) {
    SetCompilerOptions(std::forward<CompilerOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTargetDevice(TargetDevice value) {
    m_targetDeviceHasBeenSet = true;
    m_targetDevice = value;
  }
  inline GreengrassConfiguration& WithTargetDevice(TargetDevice value) {
  ...
  void SetTargetPlatform(TargetPlatformT&& value) {
    ...
    m_targetPlatform = std::forward<TargetPlatformT>(value);
  }
  template <typename TargetPlatformT = TargetPlatform>
  GreengrassConfiguration& WithTargetPlatform(TargetPlatformT&& value) {
    SetTargetPlatform(std::forward<TargetPlatformT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComponentDescription(ComponentDescriptionT&& value) {
    ...
    m_componentDescription = std::forward<ComponentDescriptionT>(value);
  }
  template <typename ComponentDescriptionT = Aws::String>
  GreengrassConfiguration& WithComponentDescription(ComponentDescriptionT&& value) {
    SetComponentDescription(std::forward<ComponentDescriptionT>(value));
    return *this;
  }
  ///@}
