...
class DetectAnomalyResult {
 public:
  ...
  inline void SetIsAnomalous(bool value) {
    m_isAnomalousHasBeenSet = true;
    m_isAnomalous = value;
  }
  inline DetectAnomalyResult& WithIsAnomalous(bool value) {
    SetIsAnomalous(value);
    return *this;
  }
  ///@}
  ...
  inline DetectAnomalyResult& WithConfidence(double value) {
    SetConfidence(value);
    return *this;
  }
  ///@}
  ...
  void SetAnomalyMask(AnomalyMaskT&& value) {
    m_anomalyMaskHasBeenSet = true;
    m_anomalyMask = std::forward<AnomalyMaskT>(value);
  }
  template <typename AnomalyMaskT = Aws::Utils::ByteBuffer>
  DetectAnomalyResult& WithAnomalyMask(AnomalyMaskT&& value) {
    SetAnomalyMask(std::forward<AnomalyMaskT>(value));
    return *this;
  }
  ///@}
 private:
