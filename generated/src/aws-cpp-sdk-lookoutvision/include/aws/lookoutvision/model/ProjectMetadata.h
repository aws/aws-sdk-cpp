...
class ProjectMetadata {
 public:
  AWS_LOOKOUTFORVISION_API ProjectMetadata() = default;
  ...
  template <typename ProjectArnT = Aws::String>
  ProjectMetadata& WithProjectArn(ProjectArnT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  ProjectMetadata& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename CreationTimestampT = Aws::Utils::DateTime>
  ProjectMetadata& WithCreationTimestamp(CreationTimestampT&& value) {
