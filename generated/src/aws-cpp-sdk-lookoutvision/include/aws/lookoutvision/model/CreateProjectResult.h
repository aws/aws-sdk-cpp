...
class CreateProjectResult {
 public:
  ...
  void SetProjectMetadata(ProjectMetadataT&& value) {
    m_projectMetadataHasBeenSet = true;
    m_projectMetadata = std::forward<ProjectMetadataT>(value);
  }
  template <typename ProjectMetadataT = ProjectMetadata>
  CreateProjectResult& WithProjectMetadata(ProjectMetadataT&& value) {
    SetProjectMetadata(std::forward<ProjectMetadataT>(value));
    return *this;
  }
  ///@}
