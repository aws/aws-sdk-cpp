...
class ListDatasetEntriesRequest : public LookoutforVisionRequest {
 public:
  ...
  void SetAnomalyClass(AnomalyClassT&& value) {
    m_anomalyClassHasBeenSet = true;
    m_anomalyClass = std::forward<AnomalyClassT>(value);
  }
  template <typename AnomalyClassT = Aws::String>
  ListDatasetEntriesRequest& WithAnomalyClass(AnomalyClassT&& value) {
    SetAnomalyClass(std::forward<AnomalyClassT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBeforeCreationDate(BeforeCreationDateT&& value) {
    m_beforeCreationDateHasBeenSet = true;
    m_beforeCreationDate = std::forward<BeforeCreationDateT>(value);
  }
  template <typename BeforeCreationDateT = Aws::Utils::DateTime>
  ListDatasetEntriesRequest& WithBeforeCreationDate(BeforeCreationDateT&& value) {
    SetBeforeCreationDate(std::forward<BeforeCreationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAfterCreationDate(AfterCreationDateT&& value) {
    m_afterCreationDateHasBeenSet = true;
    m_afterCreationDate = std::forward<AfterCreationDateT>(value);
  }
  template <typename AfterCreationDateT = Aws::Utils::DateTime>
  ListDatasetEntriesRequest& WithAfterCreationDate(AfterCreationDateT&& value) {
    SetAfterCreationDate(std::forward<AfterCreationDateT>(value));
    return *this;
  }
  ///@}
