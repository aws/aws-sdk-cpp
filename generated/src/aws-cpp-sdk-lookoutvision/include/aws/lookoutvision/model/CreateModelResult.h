...
class CreateModelResult {
 public:
  ...
  void SetModelMetadata(ModelMetadataT&& value) {
    m_modelMetadataHasBeenSet = true;
    m_modelMetadata = std::forward<ModelMetadataT>(value);
  }
  template <typename ModelMetadataT = ModelMetadata>
  CreateModelResult& WithModelMetadata(ModelMetadataT&& value) {
    SetModelMetadata(std::forward<ModelMetadataT>(value));
    return *this;
  }
  ///@}
