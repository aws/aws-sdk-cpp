...
/**
 */
class ListModelsRequest : public LookoutforVisionRequest {
 public:
  AWS_LOOKOUTFORVISION_API ListModelsRequest() = default;
  ...
  template <typename ProjectNameT = Aws::String>
  ListModelsRequest& WithProjectName(ProjectNameT&& value) {
