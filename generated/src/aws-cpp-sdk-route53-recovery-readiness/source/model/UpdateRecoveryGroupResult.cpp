...
UpdateRecoveryGroupResult::UpdateRecoveryGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateRecoveryGroupResult& UpdateRecoveryGroupResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
