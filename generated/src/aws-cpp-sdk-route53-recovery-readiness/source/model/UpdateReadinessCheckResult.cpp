...
UpdateReadinessCheckResult::UpdateReadinessCheckResult()
{
}

UpdateReadinessCheckResult::UpdateReadinessCheckResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
