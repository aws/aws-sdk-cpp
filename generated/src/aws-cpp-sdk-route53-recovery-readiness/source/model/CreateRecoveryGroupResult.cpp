...
CreateRecoveryGroupResult::CreateRecoveryGroupResult()
{
}

CreateRecoveryGroupResult::CreateRecoveryGroupResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateRecoveryGroupResult& CreateRecoveryGroupResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
