...
class ReadinessCheckSummary {
 public:
  ...
  inline void SetReadiness(Readiness value) {
    m_readinessHasBeenSet = true;
    m_readiness = value;
  }
  inline ReadinessCheckSummary& WithReadiness(Readiness value) {
    SetReadiness(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReadinessCheckNameT = Aws::String>
  ReadinessCheckSummary& WithReadinessCheckName(ReadinessCheckNameT&& value) {
