...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYREADINESS_API GetResourceSetRequest() = default;
    ...
    template<typename ResourceSetNameT = Aws::String>
    GetResourceSetRequest& WithResourceSetName(ResourceSetNameT&& value) { SetResourceSetName(std::forward<ResourceSetNameT>(value)); return *this;}
    ///@}
  private:
