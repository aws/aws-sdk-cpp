...
class DNSTargetResource {
 public:
  ...
  void SetHostedZoneArn(HostedZoneArnT&& value) {
    ...
    m_hostedZoneArn = std::forward<HostedZoneArnT>(value);
  }
  template <typename HostedZoneArnT = Aws::String>
  DNSTargetResource& WithHostedZoneArn(HostedZoneArnT&& value) {
    SetHostedZoneArn(std::forward<HostedZoneArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordSetId(RecordSetIdT&& value) {
    ...
    m_recordSetId = std::forward<RecordSetIdT>(value);
  }
  template <typename RecordSetIdT = Aws::String>
  DNSTargetResource& WithRecordSetId(RecordSetIdT&& value) {
    SetRecordSetId(std::forward<RecordSetIdT>(value));
    return *this;
  }
  ///@}
