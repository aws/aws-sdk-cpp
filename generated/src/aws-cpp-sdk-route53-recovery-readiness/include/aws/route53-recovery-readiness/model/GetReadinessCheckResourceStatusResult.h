...
class GetReadinessCheckResourceStatusResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API GetReadinessCheckResourceStatusResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  GetReadinessCheckResourceStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  inline GetReadinessCheckResourceStatusResult& WithReadiness(Readiness value) {
    SetReadiness(value);
    return *this;
  }
  ///@}
  ...
  template <typename RulesT = Aws::Vector<RuleResult>>
  GetReadinessCheckResourceStatusResult& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = RuleResult>
  GetReadinessCheckResourceStatusResult& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReadinessCheckResourceStatusResult& WithRequestId(RequestIdT&& value) {
