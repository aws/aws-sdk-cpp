...
class GetReadinessCheckStatusResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API GetReadinessCheckStatusResult& operator=(
  ...
  template <typename MessagesT = Aws::Vector<Message>>
  GetReadinessCheckStatusResult& WithMessages(MessagesT&& value) {
    SetMessages(std::forward<MessagesT>(value));
    return *this;
  }
  template <typename MessagesT = Message>
  GetReadinessCheckStatusResult& AddMessages(MessagesT&& value) {
    m_messagesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetReadinessCheckStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  inline GetReadinessCheckStatusResult& WithReadiness(Readiness value) {
    SetReadiness(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourcesT = Aws::Vector<ResourceResult>>
  GetReadinessCheckStatusResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ResourceResult>
  GetReadinessCheckStatusResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetReadinessCheckStatusResult& WithRequestId(RequestIdT&& value) {
