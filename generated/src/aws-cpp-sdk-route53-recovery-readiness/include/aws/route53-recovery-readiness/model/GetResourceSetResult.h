...
class GetResourceSetResult {
 public:
  ...
  template <typename ResourceSetArnT = Aws::String>
  GetResourceSetResult& WithResourceSetArn(ResourceSetArnT&& value) {
  ...
  template <typename ResourceSetNameT = Aws::String>
  GetResourceSetResult& WithResourceSetName(ResourceSetNameT&& value) {
  ...
  template <typename ResourceSetTypeT = Aws::String>
  GetResourceSetResult& WithResourceSetType(ResourceSetTypeT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  GetResourceSetResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  GetResourceSetResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetResourceSetResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResourceSetResult& WithRequestId(RequestIdT&& value) {
