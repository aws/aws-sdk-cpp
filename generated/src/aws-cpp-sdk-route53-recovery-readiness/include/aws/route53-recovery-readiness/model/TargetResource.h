...
class TargetResource {
 public:
  ...
  void SetNLBResource(NLBResourceT&& value) {
    ...
    m_nLBResource = std::forward<NLBResourceT>(value);
  }
  template <typename NLBResourceT = NLBResource>
  TargetResource& WithNLBResource(NLBResourceT&& value) {
    SetNLBResource(std::forward<NLBResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetR53Resource(R53ResourceT&& value) {
    ...
    m_r53Resource = std::forward<R53ResourceT>(value);
  }
  template <typename R53ResourceT = R53ResourceRecord>
  TargetResource& WithR53Resource(R53ResourceT&& value) {
    SetR53Resource(std::forward<R53ResourceT>(value));
    return *this;
  }
  ///@}
 private:
