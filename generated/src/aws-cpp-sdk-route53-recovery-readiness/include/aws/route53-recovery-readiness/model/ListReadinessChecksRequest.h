...
class ListReadinessChecksRequest : public Route53RecoveryReadinessRequest {
 public:
  AWS_ROUTE53RECOVERYREADINESS_API ListReadinessChecksRequest() = default;
  ...
  inline ListReadinessChecksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReadinessChecksRequest& WithNextToken(NextTokenT&& value) {
