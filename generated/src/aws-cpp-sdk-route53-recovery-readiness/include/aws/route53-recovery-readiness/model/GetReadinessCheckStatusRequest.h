...
class GetReadinessCheckStatusRequest : public Route53RecoveryReadinessRequest {
 public:
  ...
  inline GetReadinessCheckStatusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetReadinessCheckStatusRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ReadinessCheckNameT = Aws::String>
  GetReadinessCheckStatusRequest& WithReadinessCheckName(ReadinessCheckNameT&& value) {
