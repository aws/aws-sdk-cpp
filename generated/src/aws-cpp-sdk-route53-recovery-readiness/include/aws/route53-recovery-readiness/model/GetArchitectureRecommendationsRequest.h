...
class GetArchitectureRecommendationsRequest : public Route53RecoveryReadinessRequest {
 public:
  ...
  inline GetArchitectureRecommendationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetArchitectureRecommendationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RecoveryGroupNameT = Aws::String>
  GetArchitectureRecommendationsRequest& WithRecoveryGroupName(RecoveryGroupNameT&& value) {
