...
class Resource {
 public:
  ...
  void SetDnsTargetResource(DnsTargetResourceT&& value) {
    ...
    m_dnsTargetResource = std::forward<DnsTargetResourceT>(value);
  }
  template <typename DnsTargetResourceT = DNSTargetResource>
  Resource& WithDnsTargetResource(DnsTargetResourceT&& value) {
    SetDnsTargetResource(std::forward<DnsTargetResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadinessScopes(ReadinessScopesT&& value) {
    ...
    m_readinessScopes = std::forward<ReadinessScopesT>(value);
  }
  template <typename ReadinessScopesT = Aws::Vector<Aws::String>>
  Resource& WithReadinessScopes(ReadinessScopesT&& value) {
    SetReadinessScopes(std::forward<ReadinessScopesT>(value));
    return *this;
  }
  template <typename ReadinessScopesT = Aws::String>
  Resource& AddReadinessScopes(ReadinessScopesT&& value) {
    m_readinessScopesHasBeenSet = true;
    m_readinessScopes.emplace_back(std::forward<ReadinessScopesT>(value));
    return *this;
  }
  ///@}
