...
class UpdateReadinessCheckResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API UpdateReadinessCheckResult& operator=(
  ...
  template <typename ReadinessCheckArnT = Aws::String>
  UpdateReadinessCheckResult& WithReadinessCheckArn(ReadinessCheckArnT&& value) {
  ...
  template <typename ReadinessCheckNameT = Aws::String>
  UpdateReadinessCheckResult& WithReadinessCheckName(ReadinessCheckNameT&& value) {
  ...
  template <typename ResourceSetT = Aws::String>
  UpdateReadinessCheckResult& WithResourceSet(ResourceSetT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateReadinessCheckResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateReadinessCheckResult& WithRequestId(RequestIdT&& value) {
