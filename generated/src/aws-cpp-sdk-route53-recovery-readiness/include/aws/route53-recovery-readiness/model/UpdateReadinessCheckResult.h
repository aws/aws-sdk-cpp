...
namespace Model
{
  ...
  public:
    ...
    inline UpdateReadinessCheckResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateReadinessCheckResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateReadinessCheckResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
