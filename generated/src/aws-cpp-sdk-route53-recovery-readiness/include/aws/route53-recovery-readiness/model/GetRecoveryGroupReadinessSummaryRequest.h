...
class GetRecoveryGroupReadinessSummaryRequest : public Route53RecoveryReadinessRequest {
 public:
  ...
  inline GetRecoveryGroupReadinessSummaryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetRecoveryGroupReadinessSummaryRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RecoveryGroupNameT = Aws::String>
  GetRecoveryGroupReadinessSummaryRequest& WithRecoveryGroupName(RecoveryGroupNameT&& value) {
