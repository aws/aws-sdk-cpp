...
class CreateCellResult {
 public:
  ...
  template <typename CellArnT = Aws::String>
  CreateCellResult& WithCellArn(CellArnT&& value) {
  ...
  template <typename CellNameT = Aws::String>
  CreateCellResult& WithCellName(CellNameT&& value) {
  ...
  template <typename CellsT = Aws::Vector<Aws::String>>
  CreateCellResult& WithCells(CellsT&& value) {
    SetCells(std::forward<CellsT>(value));
    return *this;
  }
  template <typename CellsT = Aws::String>
  CreateCellResult& AddCells(CellsT&& value) {
    m_cellsHasBeenSet = true;
  ...
  template <typename ParentReadinessScopesT = Aws::Vector<Aws::String>>
  CreateCellResult& WithParentReadinessScopes(ParentReadinessScopesT&& value) {
    SetParentReadinessScopes(std::forward<ParentReadinessScopesT>(value));
    return *this;
  }
  template <typename ParentReadinessScopesT = Aws::String>
  CreateCellResult& AddParentReadinessScopes(ParentReadinessScopesT&& value) {
    m_parentReadinessScopesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCellResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCellResult& WithRequestId(RequestIdT&& value) {
