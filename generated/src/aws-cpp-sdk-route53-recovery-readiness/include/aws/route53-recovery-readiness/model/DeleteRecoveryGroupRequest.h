...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYREADINESS_API DeleteRecoveryGroupRequest() = default;
    ...
    template<typename RecoveryGroupNameT = Aws::String>
    DeleteRecoveryGroupRequest& WithRecoveryGroupName(RecoveryGroupNameT&& value) { SetRecoveryGroupName(std::forward<RecoveryGroupNameT>(value)); return *this;}
    ///@}
  private:
