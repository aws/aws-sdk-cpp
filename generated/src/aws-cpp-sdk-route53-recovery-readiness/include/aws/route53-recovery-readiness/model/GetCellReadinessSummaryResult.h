...
class GetCellReadinessSummaryResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API GetCellReadinessSummaryResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  GetCellReadinessSummaryResult& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCellReadinessSummaryResult& WithReadiness(Readiness value) {
    SetReadiness(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetCellReadinessSummaryResult& WithRequestId(RequestIdT&& value) {
