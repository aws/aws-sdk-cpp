...
class ListResourceSetsResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API ListResourceSetsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetResourceSets(ResourceSetsT&& value) {
    m_resourceSetsHasBeenSet = true;
    m_resourceSets = std::forward<ResourceSetsT>(value);
  }
  template <typename ResourceSetsT = Aws::Vector<ResourceSetOutput>>
  ListResourceSetsResult& WithResourceSets(ResourceSetsT&& value) {
    SetResourceSets(std::forward<ResourceSetsT>(value));
    return *this;
  }
  template <typename ResourceSetsT = ResourceSetOutput>
  ListResourceSetsResult& AddResourceSets(ResourceSetsT&& value) {
    m_resourceSetsHasBeenSet = true;
    m_resourceSets.emplace_back(std::forward<ResourceSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceSetsResult& WithRequestId(RequestIdT&& value) {
