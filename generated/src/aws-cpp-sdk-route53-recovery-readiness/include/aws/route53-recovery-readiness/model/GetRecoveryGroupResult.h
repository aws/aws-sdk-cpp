...
class GetRecoveryGroupResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API GetRecoveryGroupResult& operator=(
  ...
  template <typename CellsT = Aws::Vector<Aws::String>>
  GetRecoveryGroupResult& WithCells(CellsT&& value) {
    SetCells(std::forward<CellsT>(value));
    return *this;
  }
  template <typename CellsT = Aws::String>
  GetRecoveryGroupResult& AddCells(CellsT&& value) {
    m_cellsHasBeenSet = true;
  ...
  void SetRecoveryGroupArn(RecoveryGroupArnT&& value) {
    ...
    m_recoveryGroupArn = std::forward<RecoveryGroupArnT>(value);
  }
  template <typename RecoveryGroupArnT = Aws::String>
  GetRecoveryGroupResult& WithRecoveryGroupArn(RecoveryGroupArnT&& value) {
    SetRecoveryGroupArn(std::forward<RecoveryGroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecoveryGroupNameT = Aws::String>
  GetRecoveryGroupResult& WithRecoveryGroupName(RecoveryGroupNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetRecoveryGroupResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRecoveryGroupResult& WithRequestId(RequestIdT&& value) {
