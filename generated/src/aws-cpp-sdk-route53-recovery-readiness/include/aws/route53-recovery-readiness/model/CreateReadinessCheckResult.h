...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYREADINESS_API CreateReadinessCheckResult() = default;
    ...
    template<typename ReadinessCheckArnT = Aws::String>
    CreateReadinessCheckResult& WithReadinessCheckArn(ReadinessCheckArnT&& value) { SetReadinessCheckArn(std::forward<ReadinessCheckArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ReadinessCheckNameT = Aws::String>
    CreateReadinessCheckResult& WithReadinessCheckName(ReadinessCheckNameT&& value) { SetReadinessCheckName(std::forward<ReadinessCheckNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceSetT = Aws::String>
    CreateReadinessCheckResult& WithResourceSet(ResourceSetT&& value) { SetResourceSet(std::forward<ResourceSetT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateReadinessCheckResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    CreateReadinessCheckResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreateReadinessCheckResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
