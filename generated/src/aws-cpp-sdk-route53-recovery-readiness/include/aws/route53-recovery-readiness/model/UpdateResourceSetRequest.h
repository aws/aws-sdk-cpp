...
class UpdateResourceSetRequest : public Route53RecoveryReadinessRequest {
 public:
  ...
  template <typename ResourceSetNameT = Aws::String>
  UpdateResourceSetRequest& WithResourceSetName(ResourceSetNameT&& value) {
  ...
  template <typename ResourceSetTypeT = Aws::String>
  UpdateResourceSetRequest& WithResourceSetType(ResourceSetTypeT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  UpdateResourceSetRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resource>
  UpdateResourceSetRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
