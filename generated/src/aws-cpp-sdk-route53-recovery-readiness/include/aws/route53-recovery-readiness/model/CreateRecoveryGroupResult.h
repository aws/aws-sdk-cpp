...
namespace Model
{
  ...
  public:
    ...
    inline CreateRecoveryGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateRecoveryGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateRecoveryGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
