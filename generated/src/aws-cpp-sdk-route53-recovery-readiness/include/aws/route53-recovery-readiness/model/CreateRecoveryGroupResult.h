...
class CreateRecoveryGroupResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API CreateRecoveryGroupResult& operator=(
  ...
  template <typename CellsT = Aws::Vector<Aws::String>>
  CreateRecoveryGroupResult& WithCells(CellsT&& value) {
    SetCells(std::forward<CellsT>(value));
    return *this;
  }
  template <typename CellsT = Aws::String>
  CreateRecoveryGroupResult& AddCells(CellsT&& value) {
    m_cellsHasBeenSet = true;
  ...
  template <typename RecoveryGroupArnT = Aws::String>
  CreateRecoveryGroupResult& WithRecoveryGroupArn(RecoveryGroupArnT&& value) {
  ...
  template <typename RecoveryGroupNameT = Aws::String>
  CreateRecoveryGroupResult& WithRecoveryGroupName(RecoveryGroupNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRecoveryGroupResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRecoveryGroupResult& WithRequestId(RequestIdT&& value) {
