...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYREADINESS_API CreateRecoveryGroupResult() = default;
    ...
    template<typename CellsT = Aws::Vector<Aws::String>>
    CreateRecoveryGroupResult& WithCells(CellsT&& value) { SetCells(std::forward<CellsT>(value)); return *this;}
    template<typename CellsT = Aws::String>
    CreateRecoveryGroupResult& AddCells(CellsT&& value) { m_cellsHasBeenSet = true; m_cells.emplace_back(std::forward<CellsT>(value)); return *this; }
    ///@}
    ...
    template<typename RecoveryGroupArnT = Aws::String>
    CreateRecoveryGroupResult& WithRecoveryGroupArn(RecoveryGroupArnT&& value) { SetRecoveryGroupArn(std::forward<RecoveryGroupArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RecoveryGroupNameT = Aws::String>
    CreateRecoveryGroupResult& WithRecoveryGroupName(RecoveryGroupNameT&& value) { SetRecoveryGroupName(std::forward<RecoveryGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateRecoveryGroupResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    CreateRecoveryGroupResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreateRecoveryGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
