...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53RECOVERYREADINESS_API UpdateCellResult();
    ...
    inline UpdateCellResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateCellResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateCellResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
