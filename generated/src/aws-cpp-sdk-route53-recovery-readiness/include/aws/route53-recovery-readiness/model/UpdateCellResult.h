...
namespace Model {
class UpdateCellResult {
 public:
  AWS_ROUTE53RECOVERYREADINESS_API UpdateCellResult() = default;
  AWS_ROUTE53RECOVERYREADINESS_API UpdateCellResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ROUTE53RECOVERYREADINESS_API UpdateCellResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetCellArn(CellArnT&& value) {
    ...
    m_cellArn = std::forward<CellArnT>(value);
  }
  template <typename CellArnT = Aws::String>
  UpdateCellResult& WithCellArn(CellArnT&& value) {
    SetCellArn(std::forward<CellArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CellNameT = Aws::String>
  UpdateCellResult& WithCellName(CellNameT&& value) {
  ...
  template <typename CellsT = Aws::Vector<Aws::String>>
  UpdateCellResult& WithCells(CellsT&& value) {
    SetCells(std::forward<CellsT>(value));
    return *this;
  }
  template <typename CellsT = Aws::String>
  UpdateCellResult& AddCells(CellsT&& value) {
    m_cellsHasBeenSet = true;
  ...
  void SetParentReadinessScopes(ParentReadinessScopesT&& value) {
    ...
    m_parentReadinessScopes = std::forward<ParentReadinessScopesT>(value);
  }
  template <typename ParentReadinessScopesT = Aws::Vector<Aws::String>>
  UpdateCellResult& WithParentReadinessScopes(ParentReadinessScopesT&& value) {
    SetParentReadinessScopes(std::forward<ParentReadinessScopesT>(value));
    return *this;
  }
  template <typename ParentReadinessScopesT = Aws::String>
  UpdateCellResult& AddParentReadinessScopes(ParentReadinessScopesT&& value) {
    m_parentReadinessScopesHasBeenSet = true;
    m_parentReadinessScopes.emplace_back(std::forward<ParentReadinessScopesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateCellResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  UpdateCellResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCellResult& WithRequestId(RequestIdT&& value) {
