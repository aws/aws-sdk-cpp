...
class UpdateResourceSetResult {
 public:
  ...
  AWS_ROUTE53RECOVERYREADINESS_API UpdateResourceSetResult& operator=(
  ...
  UpdateResourceSetResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateResourceSetResult& WithTags(TagsT&& value) {
