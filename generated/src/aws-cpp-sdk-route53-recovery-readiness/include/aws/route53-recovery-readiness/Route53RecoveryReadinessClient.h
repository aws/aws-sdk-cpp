...
namespace Route53RecoveryReadiness
{
   ...
   */
  class AWS_ROUTE53RECOVERYREADINESS_API Route53RecoveryReadinessClient : Aws::Client::ClientWithAsyncTemplateMethods<Route53RecoveryReadinessClient>,
    smithy::client::AwsSmithyClientT<Aws::Route53RecoveryReadiness::SERVICE_NAME,
