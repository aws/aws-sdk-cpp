...
namespace SecretsManager
{
   ...
   */
  class AWS_SECRETSMANAGER_API SecretsManagerClient : Aws::Client::ClientWithAsyncTemplateMethods<SecretsManagerClient>,
    smithy::client::AwsSmithyClientT<Aws::SecretsManager::SERVICE_NAME,
