...
class GetRandomPasswordResult {
 public:
  ...
  void SetRandomPassword(RandomPasswordT&& value) {
    m_randomPasswordHasBeenSet = true;
    m_randomPassword = std::forward<RandomPasswordT>(value);
  }
  template <typename RandomPasswordT = Aws::String>
  GetRandomPasswordResult& WithRandomPassword(RandomPasswordT&& value) {
    SetRandomPassword(std::forward<RandomPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRandomPasswordResult& WithRequestId(RequestIdT&& value) {
