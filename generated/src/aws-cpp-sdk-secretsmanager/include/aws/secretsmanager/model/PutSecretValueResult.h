...
class PutSecretValueResult {
 public:
  ...
  template <typename ARNT = Aws::String>
  PutSecretValueResult& WithARN(ARNT&& value) {
  ...
  template <typename NameT = Aws::String>
  PutSecretValueResult& WithName(NameT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  PutSecretValueResult& WithVersionId(VersionIdT&& value) {
  ...
  void SetVersionStages(VersionStagesT&& value) {
    ...
    m_versionStages = std::forward<VersionStagesT>(value);
  }
  template <typename VersionStagesT = Aws::Vector<Aws::String>>
  PutSecretValueResult& WithVersionStages(VersionStagesT&& value) {
    SetVersionStages(std::forward<VersionStagesT>(value));
    return *this;
  }
  template <typename VersionStagesT = Aws::String>
  PutSecretValueResult& AddVersionStages(VersionStagesT&& value) {
    m_versionStagesHasBeenSet = true;
    m_versionStages.emplace_back(std::forward<VersionStagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutSecretValueResult& WithRequestId(RequestIdT&& value) {
