...
class UpdateSecretVersionStageRequest : public SecretsManagerRequest {
 public:
  ...
  template <typename SecretIdT = Aws::String>
  UpdateSecretVersionStageRequest& WithSecretId(SecretIdT&& value) {
  ...
  void SetVersionStage(VersionStageT&& value) {
    m_versionStageHasBeenSet = true;
    m_versionStage = std::forward<VersionStageT>(value);
  }
  template <typename VersionStageT = Aws::String>
  UpdateSecretVersionStageRequest& WithVersionStage(VersionStageT&& value) {
    SetVersionStage(std::forward<VersionStageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveFromVersionId(RemoveFromVersionIdT&& value) {
    m_removeFromVersionIdHasBeenSet = true;
    m_removeFromVersionId = std::forward<RemoveFromVersionIdT>(value);
  }
  template <typename RemoveFromVersionIdT = Aws::String>
  UpdateSecretVersionStageRequest& WithRemoveFromVersionId(RemoveFromVersionIdT&& value) {
    SetRemoveFromVersionId(std::forward<RemoveFromVersionIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMoveToVersionId(MoveToVersionIdT&& value) {
    m_moveToVersionIdHasBeenSet = true;
    m_moveToVersionId = std::forward<MoveToVersionIdT>(value);
  }
  template <typename MoveToVersionIdT = Aws::String>
  UpdateSecretVersionStageRequest& WithMoveToVersionId(MoveToVersionIdT&& value) {
    SetMoveToVersionId(std::forward<MoveToVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
