...
class DescribeSecretResult {
 public:
  ...
  inline void SetRotationEnabled(bool value) {
    m_rotationEnabledHasBeenSet = true;
    m_rotationEnabled = value;
  }
  inline DescribeSecretResult& WithRotationEnabled(bool value) {
  ...
  void SetLastRotatedDate(LastRotatedDateT&& value) {
    ...
    m_lastRotatedDate = std::forward<LastRotatedDateT>(value);
  }
  template <typename LastRotatedDateT = Aws::Utils::DateTime>
  DescribeSecretResult& WithLastRotatedDate(LastRotatedDateT&& value) {
    SetLastRotatedDate(std::forward<LastRotatedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastChangedDate(LastChangedDateT&& value) {
    ...
    m_lastChangedDate = std::forward<LastChangedDateT>(value);
  }
  template <typename LastChangedDateT = Aws::Utils::DateTime>
  DescribeSecretResult& WithLastChangedDate(LastChangedDateT&& value) {
    SetLastChangedDate(std::forward<LastChangedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletedDate(DeletedDateT&& value) {
    ...
    m_deletedDate = std::forward<DeletedDateT>(value);
  }
  template <typename DeletedDateT = Aws::Utils::DateTime>
  DescribeSecretResult& WithDeletedDate(DeletedDateT&& value) {
    SetDeletedDate(std::forward<DeletedDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextRotationDate(NextRotationDateT&& value) {
    ...
    m_nextRotationDate = std::forward<NextRotationDateT>(value);
  }
  template <typename NextRotationDateT = Aws::Utils::DateTime>
  DescribeSecretResult& WithNextRotationDate(NextRotationDateT&& value) {
    SetNextRotationDate(std::forward<NextRotationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVersionIdsToStages(VersionIdsToStagesT&& value) {
    ...
    m_versionIdsToStages = std::forward<VersionIdsToStagesT>(value);
  }
  template <typename VersionIdsToStagesT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  DescribeSecretResult& WithVersionIdsToStages(VersionIdsToStagesT&& value) {
    SetVersionIdsToStages(std::forward<VersionIdsToStagesT>(value));
    return *this;
  }
  ...
  DescribeSecretResult& AddVersionIdsToStages(VersionIdsToStagesKeyT&& key, VersionIdsToStagesValueT&& value) {
    m_versionIdsToStagesHasBeenSet = true;
    m_versionIdsToStages.emplace(std::forward<VersionIdsToStagesKeyT>(key), std::forward<VersionIdsToStagesValueT>(value));
    return *this;
  }
  ///@}
