...
class UpdateSecretVersionStageResult {
 public:
  AWS_SECRETSMANAGER_API UpdateSecretVersionStageResult() = default;
  ...
  template <typename ARNT = Aws::String>
  UpdateSecretVersionStageResult& WithARN(ARNT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateSecretVersionStageResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSecretVersionStageResult& WithRequestId(RequestIdT&& value) {
