...
class ReplicationStatusType {
 public:
  ...
  template <typename RegionT = Aws::String>
  ReplicationStatusType& WithRegion(RegionT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  ReplicationStatusType& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline ReplicationStatusType& WithStatus(StatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  ReplicationStatusType& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename LastAccessedDateT = Aws::Utils::DateTime>
  ReplicationStatusType& WithLastAccessedDate(LastAccessedDateT&& value) {
