...
class RotationRulesType {
 public:
  ...
  inline void SetAutomaticallyAfterDays(long long value) {
    m_automaticallyAfterDaysHasBeenSet = true;
    m_automaticallyAfterDays = value;
  }
  inline RotationRulesType& WithAutomaticallyAfterDays(long long value) {
  ...
  template <typename DurationT = Aws::String>
  RotationRulesType& WithDuration(DurationT&& value) {
  ...
  template <typename ScheduleExpressionT = Aws::String>
  RotationRulesType& WithScheduleExpression(ScheduleExpressionT&& value) {
