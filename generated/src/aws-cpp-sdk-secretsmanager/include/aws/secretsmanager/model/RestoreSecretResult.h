...
namespace Model
{
  ...
  {
  public:
    AWS_SECRETSMANAGER_API RestoreSecretResult() = default;
    ...
    template<typename ARNT = Aws::String>
    RestoreSecretResult& WithARN(ARNT&& value) { SetARN(std::forward<ARNT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    RestoreSecretResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    RestoreSecretResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
