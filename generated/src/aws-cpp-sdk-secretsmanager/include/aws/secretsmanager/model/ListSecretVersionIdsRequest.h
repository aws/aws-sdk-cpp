...
class ListSecretVersionIdsRequest : public SecretsManagerRequest {
 public:
  ...
  template <typename SecretIdT = Aws::String>
  ListSecretVersionIdsRequest& WithSecretId(SecretIdT&& value) {
  ...
  inline ListSecretVersionIdsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSecretVersionIdsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSecretVersionIdsRequest& WithIncludeDeprecated(bool value) {
