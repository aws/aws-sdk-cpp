...
namespace Model
{
  ...
  public:
    ...
    template<typename ARNT = Aws::String>
    CancelRotateSecretResult& WithARN(ARNT&& value) { SetARN(std::forward<ARNT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CancelRotateSecretResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionIdT = Aws::String>
    CancelRotateSecretResult& WithVersionId(VersionIdT&& value) { SetVersionId(std::forward<VersionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelRotateSecretResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
