...
namespace Model
{
  ...
  {
  public:
    AWS_SECRETSMANAGER_API GetResourcePolicyRequest() = default;
    ...
    template<typename SecretIdT = Aws::String>
    GetResourcePolicyRequest& WithSecretId(SecretIdT&& value) { SetSecretId(std::forward<SecretIdT>(value)); return *this;}
    ///@}
  private:
