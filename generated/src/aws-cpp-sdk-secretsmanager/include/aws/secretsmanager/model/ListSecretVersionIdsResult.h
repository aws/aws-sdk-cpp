...
class ListSecretVersionIdsResult {
 public:
  ...
  template <typename VersionsT = Aws::Vector<SecretVersionsListEntry>>
  ListSecretVersionIdsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = SecretVersionsListEntry>
  ListSecretVersionIdsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSecretVersionIdsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ARNT = Aws::String>
  ListSecretVersionIdsResult& WithARN(ARNT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListSecretVersionIdsResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSecretVersionIdsResult& WithRequestId(RequestIdT&& value) {
