...
class ReplicateSecretToRegionsResult {
 public:
  ...
  template <typename ARNT = Aws::String>
  ReplicateSecretToRegionsResult& WithARN(ARNT&& value) {
  ...
  template <typename ReplicationStatusT = Aws::Vector<ReplicationStatusType>>
  ReplicateSecretToRegionsResult& WithReplicationStatus(ReplicationStatusT&& value) {
    SetReplicationStatus(std::forward<ReplicationStatusT>(value));
    return *this;
  }
  template <typename ReplicationStatusT = ReplicationStatusType>
  ReplicateSecretToRegionsResult& AddReplicationStatus(ReplicationStatusT&& value) {
    m_replicationStatusHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ReplicateSecretToRegionsResult& WithRequestId(RequestIdT&& value) {
