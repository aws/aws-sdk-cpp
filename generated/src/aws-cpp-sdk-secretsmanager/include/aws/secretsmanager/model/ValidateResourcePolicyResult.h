...
class ValidateResourcePolicyResult {
 public:
  ...
  inline void SetPolicyValidationPassed(bool value) {
    m_policyValidationPassedHasBeenSet = true;
    m_policyValidationPassed = value;
  }
  inline ValidateResourcePolicyResult& WithPolicyValidationPassed(bool value) {
    SetPolicyValidationPassed(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValidationErrorsT = Aws::Vector<ValidationErrorsEntry>>
  ValidateResourcePolicyResult& WithValidationErrors(ValidationErrorsT&& value) {
    SetValidationErrors(std::forward<ValidationErrorsT>(value));
    return *this;
  }
  template <typename ValidationErrorsT = ValidationErrorsEntry>
  ValidateResourcePolicyResult& AddValidationErrors(ValidationErrorsT&& value) {
    m_validationErrorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ValidateResourcePolicyResult& WithRequestId(RequestIdT&& value) {
