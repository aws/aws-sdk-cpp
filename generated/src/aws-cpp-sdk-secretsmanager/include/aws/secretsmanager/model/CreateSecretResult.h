...
class CreateSecretResult {
 public:
  ...
  template <typename ARNT = Aws::String>
  CreateSecretResult& WithARN(ARNT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateSecretResult& WithName(NameT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  CreateSecretResult& WithVersionId(VersionIdT&& value) {
  ...
  template <typename ReplicationStatusT = Aws::Vector<ReplicationStatusType>>
  CreateSecretResult& WithReplicationStatus(ReplicationStatusT&& value) {
    SetReplicationStatus(std::forward<ReplicationStatusT>(value));
    return *this;
  }
  template <typename ReplicationStatusT = ReplicationStatusType>
  CreateSecretResult& AddReplicationStatus(ReplicationStatusT&& value) {
    m_replicationStatusHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateSecretResult& WithRequestId(RequestIdT&& value) {
