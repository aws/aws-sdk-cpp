...
class GetSecretValueRequest : public SecretsManagerRequest {
 public:
  ...
  template <typename SecretIdT = Aws::String>
  GetSecretValueRequest& WithSecretId(SecretIdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  GetSecretValueRequest& WithVersionId(VersionIdT&& value) {
  ...
  template <typename VersionStageT = Aws::String>
  GetSecretValueRequest& WithVersionStage(VersionStageT&& value) {
