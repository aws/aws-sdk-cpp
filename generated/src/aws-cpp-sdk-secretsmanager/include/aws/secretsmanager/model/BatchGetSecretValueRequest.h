...
class BatchGetSecretValueRequest : public SecretsManagerRequest {
 public:
  ...
  inline BatchGetSecretValueRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
