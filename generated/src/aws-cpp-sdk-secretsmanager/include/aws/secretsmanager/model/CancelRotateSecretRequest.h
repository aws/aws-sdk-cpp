...
namespace Model
{
  ...
  {
  public:
    AWS_SECRETSMANAGER_API CancelRotateSecretRequest() = default;
    ...
    template<typename SecretIdT = Aws::String>
    CancelRotateSecretRequest& WithSecretId(SecretIdT&& value) { SetSecretId(std::forward<SecretIdT>(value)); return *this;}
    ///@}
  private:
