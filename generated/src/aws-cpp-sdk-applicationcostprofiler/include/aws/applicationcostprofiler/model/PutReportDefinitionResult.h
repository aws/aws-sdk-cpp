...
class PutReportDefinitionResult {
 public:
  ...
  AWS_APPLICATIONCOSTPROFILER_API PutReportDefinitionResult& operator=(
  ...
  template <typename ReportIdT = Aws::String>
  PutReportDefinitionResult& WithReportId(ReportIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutReportDefinitionResult& WithRequestId(RequestIdT&& value) {
