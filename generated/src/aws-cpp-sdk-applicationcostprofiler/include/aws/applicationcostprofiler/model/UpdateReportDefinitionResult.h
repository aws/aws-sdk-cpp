...
namespace Model
{
  ...
  public:
    ...
    inline UpdateReportDefinitionResult& WithReportId(const Aws::String& value) { SetReportId(value); return *this;}
    inline UpdateReportDefinitionResult& WithReportId(Aws::String&& value) { SetReportId(std::move(value)); return *this;}
    inline UpdateReportDefinitionResult& WithReportId(const char* value) { SetReportId(value); return *this;}
    ///@}
    ...
    inline UpdateReportDefinitionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline UpdateReportDefinitionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline UpdateReportDefinitionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
