...
namespace Model
{
  ...
  {
  public:
    AWS_APPLICATIONCOSTPROFILER_API UpdateReportDefinitionResult() = default;
    ...
    template<typename ReportIdT = Aws::String>
    UpdateReportDefinitionResult& WithReportId(ReportIdT&& value) { SetReportId(std::forward<ReportIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateReportDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
