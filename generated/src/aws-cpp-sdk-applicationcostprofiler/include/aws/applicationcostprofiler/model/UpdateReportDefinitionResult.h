...
class UpdateReportDefinitionResult {
 public:
  ...
  AWS_APPLICATIONCOSTPROFILER_API UpdateReportDefinitionResult& operator=(
  ...
  template <typename ReportIdT = Aws::String>
  UpdateReportDefinitionResult& WithReportId(ReportIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateReportDefinitionResult& WithRequestId(RequestIdT&& value) {
