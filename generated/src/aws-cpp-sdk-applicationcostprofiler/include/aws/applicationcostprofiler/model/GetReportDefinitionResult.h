...
class GetReportDefinitionResult {
 public:
  ...
  AWS_APPLICATIONCOSTPROFILER_API GetReportDefinitionResult& operator=(
  ...
  inline GetReportDefinitionResult& WithReportFrequency(ReportFrequency value) {
  ...
  inline GetReportDefinitionResult& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
