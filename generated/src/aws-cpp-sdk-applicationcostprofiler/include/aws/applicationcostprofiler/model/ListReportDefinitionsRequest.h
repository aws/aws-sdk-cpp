...
class ListReportDefinitionsRequest : public ApplicationCostProfilerRequest {
 public:
  AWS_APPLICATIONCOSTPROFILER_API ListReportDefinitionsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListReportDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReportDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
