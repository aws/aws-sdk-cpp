...
class ImportApplicationUsageResult {
 public:
  ...
  AWS_APPLICATIONCOSTPROFILER_API ImportApplicationUsageResult& operator=(
  ...
  template <typename ImportIdT = Aws::String>
  ImportApplicationUsageResult& WithImportId(ImportIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportApplicationUsageResult& WithRequestId(RequestIdT&& value) {
