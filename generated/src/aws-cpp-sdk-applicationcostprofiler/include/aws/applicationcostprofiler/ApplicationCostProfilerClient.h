...
namespace ApplicationCostProfiler
{
   ...
   */
  class AWS_APPLICATIONCOSTPROFILER_API ApplicationCostProfilerClient : Aws::Client::ClientWithAsyncTemplateMethods<ApplicationCostProfilerClient>,
    smithy::client::AwsSmithyClientT<Aws::ApplicationCostProfiler::SERVICE_NAME,
