...
class BatchGetStreamKeyResult {
 public:
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  BatchGetStreamKeyResult& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  BatchGetStreamKeyResult& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  BatchGetStreamKeyResult& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  BatchGetStreamKeyResult& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  BatchGetStreamKeyResult& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  BatchGetStreamKeyResult& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  BatchGetStreamKeyResult& WithXFrameOptions(XFrameOptionsT&& value) {
