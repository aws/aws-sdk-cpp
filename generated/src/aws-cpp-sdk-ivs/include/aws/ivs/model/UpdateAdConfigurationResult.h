...
namespace IVS {
namespace Model {
class UpdateAdConfigurationResult {
 public:
  AWS_IVS_API UpdateAdConfigurationResult() = default;
  AWS_IVS_API UpdateAdConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_IVS_API UpdateAdConfigurationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AdConfigurationT = AdConfiguration>
  UpdateAdConfigurationResult& WithAdConfiguration(AdConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAdConfigurationResult& WithRequestId(RequestIdT&& value) {
