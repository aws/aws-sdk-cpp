...
/**
 * <p>Your account is pending verification.</p><p><h3>See Also:</h3>   <a
...
class PendingVerification {
 public:
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  PendingVerification& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  PendingVerification& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  PendingVerification& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  PendingVerification& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  PendingVerification& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  PendingVerification& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  PendingVerification& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename XAmznErrorTypeT = Aws::String>
  PendingVerification& WithXAmznErrorType(XAmznErrorTypeT&& value) {
  ...
  template <typename ExceptionMessageT = Aws::String>
  PendingVerification& WithExceptionMessage(ExceptionMessageT&& value) {
