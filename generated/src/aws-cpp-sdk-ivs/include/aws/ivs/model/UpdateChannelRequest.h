...
class UpdateChannelRequest : public IVSRequest {
 public:
  ...
  inline UpdateChannelRequest& WithContainerFormat(ContainerFormat value) {
  ...
  inline UpdateChannelRequest& WithInsecureIngest(bool value) {
  ...
  inline UpdateChannelRequest& WithLatencyMode(ChannelLatencyMode value) {
  ...
  inline UpdateChannelRequest& WithPreset(TranscodePreset value) {
    SetPreset(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateChannelRequest& WithType(ChannelType value) {
    SetType(value);
    return *this;
  }
  ///@}
