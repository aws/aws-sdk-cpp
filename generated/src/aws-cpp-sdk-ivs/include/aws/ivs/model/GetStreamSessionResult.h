...
class GetStreamSessionResult {
 public:
  ...
  void SetStreamSession(StreamSessionT&& value) {
    m_streamSessionHasBeenSet = true;
    m_streamSession = std::forward<StreamSessionT>(value);
  }
  template <typename StreamSessionT = StreamSession>
  GetStreamSessionResult& WithStreamSession(StreamSessionT&& value) {
    SetStreamSession(std::forward<StreamSessionT>(value));
    return *this;
  }
  ///@}
