...
namespace Model
{
  ...
  {
  public:
    AWS_IVS_API GetPlaybackRestrictionPolicyRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    GetPlaybackRestrictionPolicyRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
