...
class ListPlaybackKeyPairsResult {
 public:
  ...
  template <typename KeyPairsT = Aws::Vector<PlaybackKeyPairSummary>>
  ListPlaybackKeyPairsResult& WithKeyPairs(KeyPairsT&& value) {
    SetKeyPairs(std::forward<KeyPairsT>(value));
    return *this;
  }
  template <typename KeyPairsT = PlaybackKeyPairSummary>
  ListPlaybackKeyPairsResult& AddKeyPairs(KeyPairsT&& value) {
    m_keyPairsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPlaybackKeyPairsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPlaybackKeyPairsResult& WithRequestId(RequestIdT&& value) {
