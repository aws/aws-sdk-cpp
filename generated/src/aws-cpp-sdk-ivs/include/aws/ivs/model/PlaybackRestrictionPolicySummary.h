...
namespace Model
{
  ...
  {
  public:
    AWS_IVS_API PlaybackRestrictionPolicySummary() = default;
    ...
    template<typename AllowedCountriesT = Aws::Vector<Aws::String>>
    PlaybackRestrictionPolicySummary& WithAllowedCountries(AllowedCountriesT&& value) { SetAllowedCountries(std::forward<AllowedCountriesT>(value)); return *this;}
    template<typename AllowedCountriesT = Aws::String>
    PlaybackRestrictionPolicySummary& AddAllowedCountries(AllowedCountriesT&& value) { m_allowedCountriesHasBeenSet = true; m_allowedCountries.emplace_back(std::forward<AllowedCountriesT>(value)); return *this; }
    ///@}
    ...
    template<typename AllowedOriginsT = Aws::Vector<Aws::String>>
    PlaybackRestrictionPolicySummary& WithAllowedOrigins(AllowedOriginsT&& value) { SetAllowedOrigins(std::forward<AllowedOriginsT>(value)); return *this;}
    template<typename AllowedOriginsT = Aws::String>
    PlaybackRestrictionPolicySummary& AddAllowedOrigins(AllowedOriginsT&& value) { m_allowedOriginsHasBeenSet = true; m_allowedOrigins.emplace_back(std::forward<AllowedOriginsT>(value)); return *this; }
    ///@}
    ...
    template<typename ArnT = Aws::String>
    PlaybackRestrictionPolicySummary& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    PlaybackRestrictionPolicySummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    PlaybackRestrictionPolicySummary& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
