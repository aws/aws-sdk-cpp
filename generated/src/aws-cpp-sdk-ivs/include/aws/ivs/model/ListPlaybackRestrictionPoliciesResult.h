...
class ListPlaybackRestrictionPoliciesResult {
 public:
  ...
  inline const Aws::Vector<PlaybackRestrictionPolicySummary>& GetPlaybackRestrictionPolicies() const {
    return m_playbackRestrictionPolicies;
  }
  template <typename PlaybackRestrictionPoliciesT = Aws::Vector<PlaybackRestrictionPolicySummary>>
  void SetPlaybackRestrictionPolicies(PlaybackRestrictionPoliciesT&& value) {
    m_playbackRestrictionPoliciesHasBeenSet = true;
    m_playbackRestrictionPolicies = std::forward<PlaybackRestrictionPoliciesT>(value);
  }
  template <typename PlaybackRestrictionPoliciesT = Aws::Vector<PlaybackRestrictionPolicySummary>>
  ListPlaybackRestrictionPoliciesResult& WithPlaybackRestrictionPolicies(PlaybackRestrictionPoliciesT&& value) {
    SetPlaybackRestrictionPolicies(std::forward<PlaybackRestrictionPoliciesT>(value));
    return *this;
  }
  template <typename PlaybackRestrictionPoliciesT = PlaybackRestrictionPolicySummary>
  ListPlaybackRestrictionPoliciesResult& AddPlaybackRestrictionPolicies(PlaybackRestrictionPoliciesT&& value) {
    m_playbackRestrictionPoliciesHasBeenSet = true;
    m_playbackRestrictionPolicies.emplace_back(std::forward<PlaybackRestrictionPoliciesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPlaybackRestrictionPoliciesResult& WithRequestId(RequestIdT&& value) {
