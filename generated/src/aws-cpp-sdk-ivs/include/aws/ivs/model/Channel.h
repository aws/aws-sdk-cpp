...
class Channel {
 public:
  ...
  inline Channel& WithAuthorized(bool value) {
    SetAuthorized(value);
    return *this;
  }
  ///@}
  ...
  inline Channel& WithContainerFormat(ContainerFormat value) {
  ...
  void SetIngestEndpoint(IngestEndpointT&& value) {
    ...
    m_ingestEndpoint = std::forward<IngestEndpointT>(value);
  }
  template <typename IngestEndpointT = Aws::String>
  Channel& WithIngestEndpoint(IngestEndpointT&& value) {
    SetIngestEndpoint(std::forward<IngestEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline Channel& WithInsecureIngest(bool value) {
  ...
  inline Channel& WithLatencyMode(ChannelLatencyMode value) {
  ...
  inline Channel& WithPreset(TranscodePreset value) {
    SetPreset(value);
    return *this;
  }
  ///@}
  ...
  void SetSrt(SrtT&& value) {
    ...
    m_srt = std::forward<SrtT>(value);
  }
  template <typename SrtT = Srt>
  Channel& WithSrt(SrtT&& value) {
    SetSrt(std::forward<SrtT>(value));
    return *this;
  }
  ///@}
  ...
  inline Channel& WithType(ChannelType value) {
    SetType(value);
    return *this;
  }
  ///@}
