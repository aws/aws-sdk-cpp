...
class StreamSessionSummary {
 public:
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StreamSessionSummary& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetHasErrorEvent(bool value) {
    m_hasErrorEventHasBeenSet = true;
    m_hasErrorEvent = value;
  }
  inline StreamSessionSummary& WithHasErrorEvent(bool value) {
    SetHasErrorEvent(value);
    return *this;
  }
  ///@}
