...
class IngestConfigurations {
 public:
  ...
  void SetVideoConfigurations(VideoConfigurationsT&& value) {
    m_videoConfigurationsHasBeenSet = true;
    m_videoConfigurations = std::forward<VideoConfigurationsT>(value);
  }
  template <typename VideoConfigurationsT = Aws::Vector<VideoConfiguration>>
  IngestConfigurations& WithVideoConfigurations(VideoConfigurationsT&& value) {
    SetVideoConfigurations(std::forward<VideoConfigurationsT>(value));
    return *this;
  }
  template <typename VideoConfigurationsT = VideoConfiguration>
  IngestConfigurations& AddVideoConfigurations(VideoConfigurationsT&& value) {
    m_videoConfigurationsHasBeenSet = true;
    m_videoConfigurations.emplace_back(std::forward<VideoConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
