...
class GetRecordingConfigurationResult {
 public:
  ...
  void SetRecordingConfiguration(RecordingConfigurationT&& value) {
    ...
    m_recordingConfiguration = std::forward<RecordingConfigurationT>(value);
  }
  template <typename RecordingConfigurationT = RecordingConfiguration>
  GetRecordingConfigurationResult& WithRecordingConfiguration(RecordingConfigurationT&& value) {
    SetRecordingConfiguration(std::forward<RecordingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRecordingConfigurationResult& WithRequestId(RequestIdT&& value) {
