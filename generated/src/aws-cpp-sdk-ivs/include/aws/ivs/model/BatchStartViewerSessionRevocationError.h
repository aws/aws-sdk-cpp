...
class BatchStartViewerSessionRevocationError {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  BatchStartViewerSessionRevocationError& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename CodeT = Aws::String>
  BatchStartViewerSessionRevocationError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchStartViewerSessionRevocationError& WithMessage(MessageT&& value) {
