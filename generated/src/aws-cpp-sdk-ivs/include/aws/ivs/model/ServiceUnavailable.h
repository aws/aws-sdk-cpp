...
/**
 * <p>The service is temporarily unavailable.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/ServiceUnavailable">AWS
 * API Reference</a></p>
 */
class ServiceUnavailable {
 public:
  AWS_IVS_API ServiceUnavailable() = default;
  AWS_IVS_API ServiceUnavailable(Aws::Utils::Json::JsonView jsonValue);
  AWS_IVS_API ServiceUnavailable& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  ServiceUnavailable& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  ServiceUnavailable& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  ServiceUnavailable& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  ServiceUnavailable& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  ServiceUnavailable& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  ServiceUnavailable& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  ServiceUnavailable& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename XAmznErrorTypeT = Aws::String>
  ServiceUnavailable& WithXAmznErrorType(XAmznErrorTypeT&& value) {
  ...
  template <typename ExceptionMessageT = Aws::String>
  ServiceUnavailable& WithExceptionMessage(ExceptionMessageT&& value) {
