...
class ListRecordingConfigurationsRequest : public IVSRequest {
 public:
  AWS_IVS_API ListRecordingConfigurationsRequest() = default;
  ...
  inline ListRecordingConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRecordingConfigurationsRequest& WithNextToken(NextTokenT&& value) {
