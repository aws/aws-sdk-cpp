...
class BatchStartViewerSessionRevocationRequest : public IVSRequest {
 public:
  ...
  void SetViewerSessions(ViewerSessionsT&& value) {
    m_viewerSessionsHasBeenSet = true;
    m_viewerSessions = std::forward<ViewerSessionsT>(value);
  }
  template <typename ViewerSessionsT = Aws::Vector<BatchStartViewerSessionRevocationViewerSession>>
  BatchStartViewerSessionRevocationRequest& WithViewerSessions(ViewerSessionsT&& value) {
    SetViewerSessions(std::forward<ViewerSessionsT>(value));
    return *this;
  }
  ...
  BatchStartViewerSessionRevocationRequest& AddViewerSessions(ViewerSessionsT&& value) {
    m_viewerSessionsHasBeenSet = true;
    m_viewerSessions.emplace_back(std::forward<ViewerSessionsT>(value));
    return *this;
  }
  ///@}
 private:
