...
namespace Model
{
  ...
  {
  public:
    AWS_IVS_API DeletePlaybackKeyPairResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePlaybackKeyPairResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
