...
class BatchStartViewerSessionRevocationViewerSession {
 public:
  ...
  template <typename ChannelArnT = Aws::String>
  BatchStartViewerSessionRevocationViewerSession& WithChannelArn(ChannelArnT&& value) {
  ...
  template <typename ViewerIdT = Aws::String>
  BatchStartViewerSessionRevocationViewerSession& WithViewerId(ViewerIdT&& value) {
  ...
  inline void SetViewerSessionVersionsLessThanOrEqualTo(int value) {
    m_viewerSessionVersionsLessThanOrEqualToHasBeenSet = true;
    m_viewerSessionVersionsLessThanOrEqualTo = value;
  }
  inline BatchStartViewerSessionRevocationViewerSession& WithViewerSessionVersionsLessThanOrEqualTo(int value) {
    SetViewerSessionVersionsLessThanOrEqualTo(value);
    return *this;
  }
  ///@}
 private:
