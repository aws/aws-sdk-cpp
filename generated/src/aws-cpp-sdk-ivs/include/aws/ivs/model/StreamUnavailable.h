...
class StreamUnavailable {
 public:
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  StreamUnavailable& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  StreamUnavailable& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  StreamUnavailable& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  StreamUnavailable& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  StreamUnavailable& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  StreamUnavailable& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  StreamUnavailable& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename XAmznErrorTypeT = Aws::String>
  StreamUnavailable& WithXAmznErrorType(XAmznErrorTypeT&& value) {
  ...
  template <typename ExceptionMessageT = Aws::String>
  StreamUnavailable& WithExceptionMessage(ExceptionMessageT&& value) {
