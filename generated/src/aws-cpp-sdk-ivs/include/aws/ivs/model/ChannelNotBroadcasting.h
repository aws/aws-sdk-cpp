...
/**
 * <p>The stream is offline for the given channel ARN.</p><p><h3>See Also:</h3>
 * <a
...
class ChannelNotBroadcasting {
 public:
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  ChannelNotBroadcasting& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  ChannelNotBroadcasting& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  ChannelNotBroadcasting& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  ChannelNotBroadcasting& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  ChannelNotBroadcasting& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  ChannelNotBroadcasting& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  ChannelNotBroadcasting& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename XAmznErrorTypeT = Aws::String>
  ChannelNotBroadcasting& WithXAmznErrorType(XAmznErrorTypeT&& value) {
  ...
  template <typename ExceptionMessageT = Aws::String>
  ChannelNotBroadcasting& WithExceptionMessage(ExceptionMessageT&& value) {
