...
class ConflictException {
 public:
  ...
  template <typename AccessControlAllowOriginT = Aws::String>
  ConflictException& WithAccessControlAllowOrigin(AccessControlAllowOriginT&& value) {
  ...
  template <typename AccessControlExposeHeadersT = Aws::String>
  ConflictException& WithAccessControlExposeHeaders(AccessControlExposeHeadersT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  ConflictException& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentSecurityPolicyT = Aws::String>
  ConflictException& WithContentSecurityPolicy(ContentSecurityPolicyT&& value) {
  ...
  template <typename StrictTransportSecurityT = Aws::String>
  ConflictException& WithStrictTransportSecurity(StrictTransportSecurityT&& value) {
  ...
  template <typename XContentTypeOptionsT = Aws::String>
  ConflictException& WithXContentTypeOptions(XContentTypeOptionsT&& value) {
  ...
  template <typename XFrameOptionsT = Aws::String>
  ConflictException& WithXFrameOptions(XFrameOptionsT&& value) {
  ...
  template <typename XAmznErrorTypeT = Aws::String>
  ConflictException& WithXAmznErrorType(XAmznErrorTypeT&& value) {
  ...
  template <typename ExceptionMessageT = Aws::String>
  ConflictException& WithExceptionMessage(ExceptionMessageT&& value) {
