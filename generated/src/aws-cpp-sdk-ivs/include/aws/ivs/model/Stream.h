...
class Stream {
 public:
  ...
  void SetPlaybackUrl(PlaybackUrlT&& value) {
    ...
    m_playbackUrl = std::forward<PlaybackUrlT>(value);
  }
  template <typename PlaybackUrlT = Aws::String>
  ...
  inline void SetState(StreamState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Stream& WithState(StreamState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetViewerCount(long long value) {
    m_viewerCountHasBeenSet = true;
    m_viewerCount = value;
  }
  inline Stream& WithViewerCount(long long value) {
