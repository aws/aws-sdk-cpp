...
class ListPlaybackKeyPairsRequest : public IVSRequest {
 public:
  AWS_IVS_API ListPlaybackKeyPairsRequest() = default;
  ...
  inline ListPlaybackKeyPairsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlaybackKeyPairsRequest& WithNextToken(NextTokenT&& value) {
