...
class ListChannelsRequest : public IVSRequest {
 public:
  ...
  void SetFilterByName(FilterByNameT&& value) {
    m_filterByNameHasBeenSet = true;
    m_filterByName = std::forward<FilterByNameT>(value);
  }
  template <typename FilterByNameT = Aws::String>
  ListChannelsRequest& WithFilterByName(FilterByNameT&& value) {
    SetFilterByName(std::forward<FilterByNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterByRecordingConfigurationArn(FilterByRecordingConfigurationArnT&& value) {
    m_filterByRecordingConfigurationArnHasBeenSet = true;
    m_filterByRecordingConfigurationArn = std::forward<FilterByRecordingConfigurationArnT>(value);
  }
  template <typename FilterByRecordingConfigurationArnT = Aws::String>
  ListChannelsRequest& WithFilterByRecordingConfigurationArn(FilterByRecordingConfigurationArnT&& value) {
    SetFilterByRecordingConfigurationArn(std::forward<FilterByRecordingConfigurationArnT>(value));
    return *this;
  }
  ///@}
