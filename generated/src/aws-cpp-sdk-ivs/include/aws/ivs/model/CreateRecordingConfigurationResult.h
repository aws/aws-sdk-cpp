...
class CreateRecordingConfigurationResult {
 public:
  ...
  template <typename RecordingConfigurationT = RecordingConfiguration>
  CreateRecordingConfigurationResult& WithRecordingConfiguration(RecordingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRecordingConfigurationResult& WithRequestId(RequestIdT&& value) {
