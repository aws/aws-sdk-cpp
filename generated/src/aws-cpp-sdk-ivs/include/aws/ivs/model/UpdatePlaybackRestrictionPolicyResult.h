...
class UpdatePlaybackRestrictionPolicyResult {
 public:
  ...
  template <typename PlaybackRestrictionPolicyT = PlaybackRestrictionPolicy>
  UpdatePlaybackRestrictionPolicyResult& WithPlaybackRestrictionPolicy(PlaybackRestrictionPolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePlaybackRestrictionPolicyResult& WithRequestId(RequestIdT&& value) {
