...
class CreateRecordingConfigurationRequest : public IVSRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateRecordingConfigurationRequest& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRecordingConfigurationRequest& WithTags(TagsT&& value) {
  ...
  template <typename ThumbnailConfigurationT = ThumbnailConfiguration>
  CreateRecordingConfigurationRequest& WithThumbnailConfiguration(ThumbnailConfigurationT&& value) {
