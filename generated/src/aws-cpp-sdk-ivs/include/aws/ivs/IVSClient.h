...
class AWS_IVS_API IVSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IVSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<IVSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for BatchGetChannel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetChannelRequestT = Model::BatchGetChannelRequest>
  void BatchGetChannelAsync(const BatchGetChannelRequestT& request, const BatchGetChannelResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for BatchGetStreamKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetStreamKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetStreamKeyRequestT = Model::BatchGetStreamKeyRequest>
  void BatchGetStreamKeyAsync(const BatchGetStreamKeyRequestT& request, const BatchGetStreamKeyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchStartViewerSessionRevocationOutcome BatchStartViewerSessionRevocation(
      const Model::BatchStartViewerSessionRevocationRequest& request) const;

  /**
   * A Callable wrapper for BatchStartViewerSessionRevocation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename BatchStartViewerSessionRevocationRequestT = Model::BatchStartViewerSessionRevocationRequest>
  Model::BatchStartViewerSessionRevocationOutcomeCallable BatchStartViewerSessionRevocationCallable(
      const BatchStartViewerSessionRevocationRequestT& request) const {
    return SubmitCallable(&IVSClient::BatchStartViewerSessionRevocation, request);
  }

  /**
   * An Async wrapper for BatchStartViewerSessionRevocation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchStartViewerSessionRevocationRequestT = Model::BatchStartViewerSessionRevocationRequest>
  void BatchStartViewerSessionRevocationAsync(const BatchStartViewerSessionRevocationRequestT& request,
                                              const BatchStartViewerSessionRevocationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePlaybackRestrictionPolicyOutcome CreatePlaybackRestrictionPolicy(
      const Model::CreatePlaybackRestrictionPolicyRequest& request = {}) const;

  /**
   * A Callable wrapper for CreatePlaybackRestrictionPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePlaybackRestrictionPolicyRequestT = Model::CreatePlaybackRestrictionPolicyRequest>
  Model::CreatePlaybackRestrictionPolicyOutcomeCallable CreatePlaybackRestrictionPolicyCallable(
      const CreatePlaybackRestrictionPolicyRequestT& request = {}) const {
    return SubmitCallable(&IVSClient::CreatePlaybackRestrictionPolicy, request);
  }

  /**
   * An Async wrapper for CreatePlaybackRestrictionPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePlaybackRestrictionPolicyRequestT = Model::CreatePlaybackRestrictionPolicyRequest>
  void CreatePlaybackRestrictionPolicyAsync(const CreatePlaybackRestrictionPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const CreatePlaybackRestrictionPolicyRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRecordingConfigurationOutcome CreateRecordingConfiguration(
      const Model::CreateRecordingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateRecordingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRecordingConfigurationRequestT = Model::CreateRecordingConfigurationRequest>
  Model::CreateRecordingConfigurationOutcomeCallable CreateRecordingConfigurationCallable(
      const CreateRecordingConfigurationRequestT& request) const {
    return SubmitCallable(&IVSClient::CreateRecordingConfiguration, request);
  }

  /**
   * An Async wrapper for CreateRecordingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRecordingConfigurationRequestT = Model::CreateRecordingConfigurationRequest>
  void CreateRecordingConfigurationAsync(const CreateRecordingConfigurationRequestT& request,
                                         const CreateRecordingConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateStreamKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateStreamKeyRequestT = Model::CreateStreamKeyRequest>
  ...
  /**
   * A Callable wrapper for DeletePlaybackKeyPair that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePlaybackKeyPair that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePlaybackKeyPairRequestT = Model::DeletePlaybackKeyPairRequest>
  void DeletePlaybackKeyPairAsync(const DeletePlaybackKeyPairRequestT& request, const DeletePlaybackKeyPairResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePlaybackRestrictionPolicyOutcome DeletePlaybackRestrictionPolicy(
      const Model::DeletePlaybackRestrictionPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeletePlaybackRestrictionPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePlaybackRestrictionPolicyRequestT = Model::DeletePlaybackRestrictionPolicyRequest>
  Model::DeletePlaybackRestrictionPolicyOutcomeCallable DeletePlaybackRestrictionPolicyCallable(
      const DeletePlaybackRestrictionPolicyRequestT& request) const {
    return SubmitCallable(&IVSClient::DeletePlaybackRestrictionPolicy, request);
  }

  /**
   * An Async wrapper for DeletePlaybackRestrictionPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePlaybackRestrictionPolicyRequestT = Model::DeletePlaybackRestrictionPolicyRequest>
  void DeletePlaybackRestrictionPolicyAsync(const DeletePlaybackRestrictionPolicyRequestT& request,
                                            const DeletePlaybackRestrictionPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRecordingConfigurationOutcome DeleteRecordingConfiguration(
      const Model::DeleteRecordingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteRecordingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRecordingConfigurationRequestT = Model::DeleteRecordingConfigurationRequest>
  Model::DeleteRecordingConfigurationOutcomeCallable DeleteRecordingConfigurationCallable(
      const DeleteRecordingConfigurationRequestT& request) const {
    return SubmitCallable(&IVSClient::DeleteRecordingConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteRecordingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRecordingConfigurationRequestT = Model::DeleteRecordingConfigurationRequest>
  void DeleteRecordingConfigurationAsync(const DeleteRecordingConfigurationRequestT& request,
                                         const DeleteRecordingConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteStreamKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteStreamKeyRequestT = Model::DeleteStreamKeyRequest>
  ...
  /**
   * A Callable wrapper for GetPlaybackKeyPair that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPlaybackKeyPair that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPlaybackKeyPairRequestT = Model::GetPlaybackKeyPairRequest>
  void GetPlaybackKeyPairAsync(const GetPlaybackKeyPairRequestT& request, const GetPlaybackKeyPairResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPlaybackRestrictionPolicyOutcome GetPlaybackRestrictionPolicy(
      const Model::GetPlaybackRestrictionPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetPlaybackRestrictionPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPlaybackRestrictionPolicyRequestT = Model::GetPlaybackRestrictionPolicyRequest>
  Model::GetPlaybackRestrictionPolicyOutcomeCallable GetPlaybackRestrictionPolicyCallable(
      const GetPlaybackRestrictionPolicyRequestT& request) const {
    return SubmitCallable(&IVSClient::GetPlaybackRestrictionPolicy, request);
  }

  /**
   * An Async wrapper for GetPlaybackRestrictionPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPlaybackRestrictionPolicyRequestT = Model::GetPlaybackRestrictionPolicyRequest>
  void GetPlaybackRestrictionPolicyAsync(const GetPlaybackRestrictionPolicyRequestT& request,
                                         const GetPlaybackRestrictionPolicyResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRecordingConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetRecordingConfigurationRequestT = Model::GetRecordingConfigurationRequest>
  Model::GetRecordingConfigurationOutcomeCallable GetRecordingConfigurationCallable(
      const GetRecordingConfigurationRequestT& request) const {
    return SubmitCallable(&IVSClient::GetRecordingConfiguration, request);
  }

  /**
   * An Async wrapper for GetRecordingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRecordingConfigurationRequestT = Model::GetRecordingConfigurationRequest>
  void GetRecordingConfigurationAsync(const GetRecordingConfigurationRequestT& request,
                                      const GetRecordingConfigurationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetStreamKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStreamKeyRequestT = Model::GetStreamKeyRequest>
  void GetStreamKeyAsync(const GetStreamKeyRequestT& request, const GetStreamKeyResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportPlaybackKeyPair that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportPlaybackKeyPair that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportPlaybackKeyPairRequestT = Model::ImportPlaybackKeyPairRequest>
  ...
  /**
   * A Callable wrapper for ListPlaybackKeyPairs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPlaybackKeyPairs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPlaybackKeyPairsRequestT = Model::ListPlaybackKeyPairsRequest>
  void ListPlaybackKeyPairsAsync(const ListPlaybackKeyPairsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListPlaybackKeyPairsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPlaybackRestrictionPoliciesOutcome ListPlaybackRestrictionPolicies(
      const Model::ListPlaybackRestrictionPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPlaybackRestrictionPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPlaybackRestrictionPoliciesRequestT = Model::ListPlaybackRestrictionPoliciesRequest>
  Model::ListPlaybackRestrictionPoliciesOutcomeCallable ListPlaybackRestrictionPoliciesCallable(
      const ListPlaybackRestrictionPoliciesRequestT& request = {}) const {
    return SubmitCallable(&IVSClient::ListPlaybackRestrictionPolicies, request);
  }

  /**
   * An Async wrapper for ListPlaybackRestrictionPolicies that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPlaybackRestrictionPoliciesRequestT = Model::ListPlaybackRestrictionPoliciesRequest>
  void ListPlaybackRestrictionPoliciesAsync(const ListPlaybackRestrictionPoliciesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListPlaybackRestrictionPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRecordingConfigurationsOutcome ListRecordingConfigurations(
      const Model::ListRecordingConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListRecordingConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRecordingConfigurationsRequestT = Model::ListRecordingConfigurationsRequest>
  Model::ListRecordingConfigurationsOutcomeCallable ListRecordingConfigurationsCallable(
      const ListRecordingConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&IVSClient::ListRecordingConfigurations, request);
  }

  /**
   * An Async wrapper for ListRecordingConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecordingConfigurationsRequestT = Model::ListRecordingConfigurationsRequest>
  void ListRecordingConfigurationsAsync(const ListRecordingConfigurationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListRecordingConfigurationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListStreamKeys that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListStreamKeysRequestT = Model::ListStreamKeysRequest>
  void ListStreamKeysAsync(const ListStreamKeysRequestT& request, const ListStreamKeysResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutMetadata that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutMetadataRequestT = Model::PutMetadataRequest>
  void PutMetadataAsync(const PutMetadataRequestT& request, const PutMetadataResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartViewerSessionRevocationOutcome StartViewerSessionRevocation(
      const Model::StartViewerSessionRevocationRequest& request) const;

  /**
   * A Callable wrapper for StartViewerSessionRevocation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartViewerSessionRevocationRequestT = Model::StartViewerSessionRevocationRequest>
  Model::StartViewerSessionRevocationOutcomeCallable StartViewerSessionRevocationCallable(
      const StartViewerSessionRevocationRequestT& request) const {
    return SubmitCallable(&IVSClient::StartViewerSessionRevocation, request);
  }

  /**
   * An Async wrapper for StartViewerSessionRevocation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartViewerSessionRevocationRequestT = Model::StartViewerSessionRevocationRequest>
  void StartViewerSessionRevocationAsync(const StartViewerSessionRevocationRequestT& request,
                                         const StartViewerSessionRevocationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopStreamRequestT = Model::StopStreamRequest>
  void StopStreamAsync(const StopStreamRequestT& request, const StopStreamResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePlaybackRestrictionPolicyOutcome UpdatePlaybackRestrictionPolicy(
      const Model::UpdatePlaybackRestrictionPolicyRequest& request) const;

  /**
   * A Callable wrapper for UpdatePlaybackRestrictionPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePlaybackRestrictionPolicyRequestT = Model::UpdatePlaybackRestrictionPolicyRequest>
  Model::UpdatePlaybackRestrictionPolicyOutcomeCallable UpdatePlaybackRestrictionPolicyCallable(
      const UpdatePlaybackRestrictionPolicyRequestT& request) const {
    return SubmitCallable(&IVSClient::UpdatePlaybackRestrictionPolicy, request);
  }

  /**
   * An Async wrapper for UpdatePlaybackRestrictionPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdatePlaybackRestrictionPolicyRequestT = Model::UpdatePlaybackRestrictionPolicyRequest>
  void UpdatePlaybackRestrictionPolicyAsync(const UpdatePlaybackRestrictionPolicyRequestT& request,
                                            const UpdatePlaybackRestrictionPolicyResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
