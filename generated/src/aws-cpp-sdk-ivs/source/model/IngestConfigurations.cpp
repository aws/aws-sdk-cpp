...
IngestConfigurations::IngestConfigurations(JsonView jsonValue) { *this = jsonValue; }
...
IngestConfigurations& IngestConfigurations::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("videoConfigurations")) {
    ...
    for (unsigned videoConfigurationsIndex = 0; videoConfigurationsIndex < videoConfigurationsJsonList.GetLength();
         ++videoConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("audioConfigurations")) {
    ...
    for (unsigned audioConfigurationsIndex = 0; audioConfigurationsIndex < audioConfigurationsJsonList.GetLength();
         ++audioConfigurationsIndex) {
