...
CreateRecordingConfigurationResult::CreateRecordingConfigurationResult()
{
}

CreateRecordingConfigurationResult::CreateRecordingConfigurationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
