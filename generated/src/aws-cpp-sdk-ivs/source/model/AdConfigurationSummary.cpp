...
AdConfigurationSummary::AdConfigurationSummary(JsonView jsonValue) { *this = jsonValue; }

AdConfigurationSummary& AdConfigurationSummary::operator=(JsonView jsonValue) {
...
JsonValue AdConfigurationSummary::Jsonize() const {
  JsonValue payload;
