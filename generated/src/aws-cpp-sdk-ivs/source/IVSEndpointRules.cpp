...
namespace IVS
{
const size_t IVSEndpointRules::RulesBlobStrLen = 3712;
const size_t IVSEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','i','v','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
