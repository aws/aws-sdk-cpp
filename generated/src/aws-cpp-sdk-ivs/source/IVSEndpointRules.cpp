...
namespace IVS
{
const size_t IVSEndpointRules::RulesBlobStrLen = 3506;
const size_t IVSEndpointRules::RulesBlobSize = 3507;
...
'/','/','i','v','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
