...
class AWS_HEALTH_API HealthClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  HealthClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<HealthEndpointProviderBase> endpointProvider = nullptr,
  ...
  virtual Model::DescribeAffectedAccountsForOrganizationOutcome DescribeAffectedAccountsForOrganization(
      const Model::DescribeAffectedAccountsForOrganizationRequest& request) const;

  /**
   * A Callable wrapper for DescribeAffectedAccountsForOrganization that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeAffectedAccountsForOrganizationOutcomeCallable DescribeAffectedAccountsForOrganizationCallable(
      const DescribeAffectedAccountsForOrganizationRequestT& request) const {
    return SubmitCallable(&HealthClient::DescribeAffectedAccountsForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeAffectedAccountsForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAffectedAccountsForOrganizationRequestT = Model::DescribeAffectedAccountsForOrganizationRequest>
  void DescribeAffectedAccountsForOrganizationAsync(const DescribeAffectedAccountsForOrganizationRequestT& request,
                                                    const DescribeAffectedAccountsForOrganizationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeAffectedEntities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAffectedEntities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAffectedEntitiesRequestT = Model::DescribeAffectedEntitiesRequest>
  void DescribeAffectedEntitiesAsync(const DescribeAffectedEntitiesRequestT& request,
                                     const DescribeAffectedEntitiesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAffectedEntitiesForOrganizationOutcome DescribeAffectedEntitiesForOrganization(
      const Model::DescribeAffectedEntitiesForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAffectedEntitiesForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeAffectedEntitiesForOrganizationRequestT = Model::DescribeAffectedEntitiesForOrganizationRequest>
  Model::DescribeAffectedEntitiesForOrganizationOutcomeCallable DescribeAffectedEntitiesForOrganizationCallable(
      const DescribeAffectedEntitiesForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::DescribeAffectedEntitiesForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeAffectedEntitiesForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeAffectedEntitiesForOrganizationRequestT = Model::DescribeAffectedEntitiesForOrganizationRequest>
  void DescribeAffectedEntitiesForOrganizationAsync(const DescribeAffectedEntitiesForOrganizationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeEntityAggregates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeEntityAggregatesRequestT = Model::DescribeEntityAggregatesRequest>
  Model::DescribeEntityAggregatesOutcomeCallable DescribeEntityAggregatesCallable(
      const DescribeEntityAggregatesRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::DescribeEntityAggregates, request);
  }

  /**
   * An Async wrapper for DescribeEntityAggregates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEntityAggregatesRequestT = Model::DescribeEntityAggregatesRequest>
  void DescribeEntityAggregatesAsync(const DescribeEntityAggregatesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeEntityAggregatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEntityAggregatesForOrganizationOutcome DescribeEntityAggregatesForOrganization(
      const Model::DescribeEntityAggregatesForOrganizationRequest& request) const;

  /**
   * A Callable wrapper for DescribeEntityAggregatesForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeEntityAggregatesForOrganizationRequestT = Model::DescribeEntityAggregatesForOrganizationRequest>
  Model::DescribeEntityAggregatesForOrganizationOutcomeCallable DescribeEntityAggregatesForOrganizationCallable(
      const DescribeEntityAggregatesForOrganizationRequestT& request) const {
    return SubmitCallable(&HealthClient::DescribeEntityAggregatesForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeEntityAggregatesForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEntityAggregatesForOrganizationRequestT = Model::DescribeEntityAggregatesForOrganizationRequest>
  void DescribeEntityAggregatesForOrganizationAsync(const DescribeEntityAggregatesForOrganizationRequestT& request,
                                                    const DescribeEntityAggregatesForOrganizationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEventAggregates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEventAggregates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventAggregatesRequestT = Model::DescribeEventAggregatesRequest>
  void DescribeEventAggregatesAsync(const DescribeEventAggregatesRequestT& request,
                                    const DescribeEventAggregatesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEventDetails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEventDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventDetailsRequestT = Model::DescribeEventDetailsRequest>
  void DescribeEventDetailsAsync(const DescribeEventDetailsRequestT& request, const DescribeEventDetailsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEventDetailsForOrganizationOutcome DescribeEventDetailsForOrganization(
      const Model::DescribeEventDetailsForOrganizationRequest& request) const;

  /**
   * A Callable wrapper for DescribeEventDetailsForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeEventDetailsForOrganizationRequestT = Model::DescribeEventDetailsForOrganizationRequest>
  Model::DescribeEventDetailsForOrganizationOutcomeCallable DescribeEventDetailsForOrganizationCallable(
      const DescribeEventDetailsForOrganizationRequestT& request) const {
    return SubmitCallable(&HealthClient::DescribeEventDetailsForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeEventDetailsForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeEventDetailsForOrganizationRequestT = Model::DescribeEventDetailsForOrganizationRequest>
  void DescribeEventDetailsForOrganizationAsync(const DescribeEventDetailsForOrganizationRequestT& request,
                                                const DescribeEventDetailsForOrganizationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEventTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEventTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEventTypesRequestT = Model::DescribeEventTypesRequest>
  void DescribeEventTypesAsync(const DescribeEventTypesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeEventTypesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEventsForOrganizationOutcome DescribeEventsForOrganization(
      const Model::DescribeEventsForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEventsForOrganization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEventsForOrganizationRequestT = Model::DescribeEventsForOrganizationRequest>
  Model::DescribeEventsForOrganizationOutcomeCallable DescribeEventsForOrganizationCallable(
      const DescribeEventsForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::DescribeEventsForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeEventsForOrganization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEventsForOrganizationRequestT = Model::DescribeEventsForOrganizationRequest>
  void DescribeEventsForOrganizationAsync(const DescribeEventsForOrganizationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeEventsForOrganizationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHealthServiceStatusForOrganizationOutcome DescribeHealthServiceStatusForOrganization(
      const Model::DescribeHealthServiceStatusForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeHealthServiceStatusForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DescribeHealthServiceStatusForOrganizationOutcomeCallable DescribeHealthServiceStatusForOrganizationCallable(
      const DescribeHealthServiceStatusForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::DescribeHealthServiceStatusForOrganization, request);
  }

  /**
   * An Async wrapper for DescribeHealthServiceStatusForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeHealthServiceStatusForOrganizationRequestT = Model::DescribeHealthServiceStatusForOrganizationRequest>
  void DescribeHealthServiceStatusForOrganizationAsync(const DescribeHealthServiceStatusForOrganizationResponseReceivedHandler& handler,
                                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                       const DescribeHealthServiceStatusForOrganizationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableHealthServiceAccessForOrganizationOutcome DisableHealthServiceAccessForOrganization(
      const Model::DisableHealthServiceAccessForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableHealthServiceAccessForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DisableHealthServiceAccessForOrganizationOutcomeCallable DisableHealthServiceAccessForOrganizationCallable(
      const DisableHealthServiceAccessForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::DisableHealthServiceAccessForOrganization, request);
  }

  /**
   * An Async wrapper for DisableHealthServiceAccessForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableHealthServiceAccessForOrganizationRequestT = Model::DisableHealthServiceAccessForOrganizationRequest>
  void DisableHealthServiceAccessForOrganizationAsync(const DisableHealthServiceAccessForOrganizationResponseReceivedHandler& handler,
                                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                      const DisableHealthServiceAccessForOrganizationRequestT& request = {}) const {
  ...
  virtual Model::EnableHealthServiceAccessForOrganizationOutcome EnableHealthServiceAccessForOrganization(
      const Model::EnableHealthServiceAccessForOrganizationRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableHealthServiceAccessForOrganization that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename EnableHealthServiceAccessForOrganizationRequestT = Model::EnableHealthServiceAccessForOrganizationRequest>
  Model::EnableHealthServiceAccessForOrganizationOutcomeCallable EnableHealthServiceAccessForOrganizationCallable(
      const EnableHealthServiceAccessForOrganizationRequestT& request = {}) const {
    return SubmitCallable(&HealthClient::EnableHealthServiceAccessForOrganization, request);
  }

  /**
   * An Async wrapper for EnableHealthServiceAccessForOrganization that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename EnableHealthServiceAccessForOrganizationRequestT = Model::EnableHealthServiceAccessForOrganizationRequest>
  void EnableHealthServiceAccessForOrganizationAsync(const EnableHealthServiceAccessForOrganizationResponseReceivedHandler& handler,
                                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                     const EnableHealthServiceAccessForOrganizationRequestT& request = {}) const {
