...
class DescribeAffectedEntitiesForOrganizationResult {
 public:
  ...
  AWS_HEALTH_API DescribeAffectedEntitiesForOrganizationResult& operator=(
  ...
  template <typename EntitiesT = Aws::Vector<AffectedEntity>>
  DescribeAffectedEntitiesForOrganizationResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = AffectedEntity>
  DescribeAffectedEntitiesForOrganizationResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename FailedSetT = Aws::Vector<OrganizationAffectedEntitiesErrorItem>>
  DescribeAffectedEntitiesForOrganizationResult& WithFailedSet(FailedSetT&& value) {
    SetFailedSet(std::forward<FailedSetT>(value));
    return *this;
  }
  template <typename FailedSetT = OrganizationAffectedEntitiesErrorItem>
  DescribeAffectedEntitiesForOrganizationResult& AddFailedSet(FailedSetT&& value) {
    m_failedSetHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAffectedEntitiesForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAffectedEntitiesForOrganizationResult& WithRequestId(RequestIdT&& value) {
