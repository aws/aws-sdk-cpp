...
class DescribeEntityAggregatesForOrganizationResult {
 public:
  ...
  AWS_HEALTH_API DescribeEntityAggregatesForOrganizationResult& operator=(
  ...
  void SetOrganizationEntityAggregates(OrganizationEntityAggregatesT&& value) {
    m_organizationEntityAggregatesHasBeenSet = true;
    m_organizationEntityAggregates = std::forward<OrganizationEntityAggregatesT>(value);
  }
  template <typename OrganizationEntityAggregatesT = Aws::Vector<OrganizationEntityAggregate>>
  DescribeEntityAggregatesForOrganizationResult& WithOrganizationEntityAggregates(OrganizationEntityAggregatesT&& value) {
    SetOrganizationEntityAggregates(std::forward<OrganizationEntityAggregatesT>(value));
    return *this;
  }
  template <typename OrganizationEntityAggregatesT = OrganizationEntityAggregate>
  DescribeEntityAggregatesForOrganizationResult& AddOrganizationEntityAggregates(OrganizationEntityAggregatesT&& value) {
    m_organizationEntityAggregatesHasBeenSet = true;
    m_organizationEntityAggregates.emplace_back(std::forward<OrganizationEntityAggregatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEntityAggregatesForOrganizationResult& WithRequestId(RequestIdT&& value) {
