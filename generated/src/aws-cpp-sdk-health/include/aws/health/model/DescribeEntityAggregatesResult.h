...
class DescribeEntityAggregatesResult {
 public:
  ...
  void SetEntityAggregates(EntityAggregatesT&& value) {
    m_entityAggregatesHasBeenSet = true;
    m_entityAggregates = std::forward<EntityAggregatesT>(value);
  }
  template <typename EntityAggregatesT = Aws::Vector<EntityAggregate>>
  DescribeEntityAggregatesResult& WithEntityAggregates(EntityAggregatesT&& value) {
    SetEntityAggregates(std::forward<EntityAggregatesT>(value));
    return *this;
  }
  template <typename EntityAggregatesT = EntityAggregate>
  DescribeEntityAggregatesResult& AddEntityAggregates(EntityAggregatesT&& value) {
    m_entityAggregatesHasBeenSet = true;
    m_entityAggregates.emplace_back(std::forward<EntityAggregatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEntityAggregatesResult& WithRequestId(RequestIdT&& value) {
