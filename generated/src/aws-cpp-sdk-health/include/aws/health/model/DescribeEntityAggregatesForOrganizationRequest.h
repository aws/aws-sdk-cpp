...
class DescribeEntityAggregatesForOrganizationRequest : public HealthRequest {
 public:
  ...
  template <typename EventArnsT = Aws::Vector<Aws::String>>
  DescribeEntityAggregatesForOrganizationRequest& WithEventArns(EventArnsT&& value) {
    SetEventArns(std::forward<EventArnsT>(value));
    return *this;
  }
  template <typename EventArnsT = Aws::String>
  DescribeEntityAggregatesForOrganizationRequest& AddEventArns(EventArnsT&& value) {
    m_eventArnsHasBeenSet = true;
  ...
  template <typename AwsAccountIdsT = Aws::Vector<Aws::String>>
  DescribeEntityAggregatesForOrganizationRequest& WithAwsAccountIds(AwsAccountIdsT&& value) {
    SetAwsAccountIds(std::forward<AwsAccountIdsT>(value));
    return *this;
  }
  template <typename AwsAccountIdsT = Aws::String>
  DescribeEntityAggregatesForOrganizationRequest& AddAwsAccountIds(AwsAccountIdsT&& value) {
    m_awsAccountIdsHasBeenSet = true;
