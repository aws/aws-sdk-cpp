...
class DescribeAffectedEntitiesResult {
 public:
  ...
  template <typename EntitiesT = Aws::Vector<AffectedEntity>>
  DescribeAffectedEntitiesResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = AffectedEntity>
  DescribeAffectedEntitiesResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAffectedEntitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAffectedEntitiesResult& WithRequestId(RequestIdT&& value) {
