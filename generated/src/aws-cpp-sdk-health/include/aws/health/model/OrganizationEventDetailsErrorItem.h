...
class OrganizationEventDetailsErrorItem {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  OrganizationEventDetailsErrorItem& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename EventArnT = Aws::String>
  OrganizationEventDetailsErrorItem& WithEventArn(EventArnT&& value) {
  ...
  template <typename ErrorNameT = Aws::String>
  OrganizationEventDetailsErrorItem& WithErrorName(ErrorNameT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  OrganizationEventDetailsErrorItem& WithErrorMessage(ErrorMessageT&& value) {
