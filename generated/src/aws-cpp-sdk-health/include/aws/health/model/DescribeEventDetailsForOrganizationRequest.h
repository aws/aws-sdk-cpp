...
class DescribeEventDetailsForOrganizationRequest : public HealthRequest {
 public:
  ...
  void SetOrganizationEventDetailFilters(OrganizationEventDetailFiltersT&& value) {
    m_organizationEventDetailFiltersHasBeenSet = true;
    m_organizationEventDetailFilters = std::forward<OrganizationEventDetailFiltersT>(value);
  }
  template <typename OrganizationEventDetailFiltersT = Aws::Vector<EventAccountFilter>>
  DescribeEventDetailsForOrganizationRequest& WithOrganizationEventDetailFilters(OrganizationEventDetailFiltersT&& value) {
    SetOrganizationEventDetailFilters(std::forward<OrganizationEventDetailFiltersT>(value));
    return *this;
  }
  template <typename OrganizationEventDetailFiltersT = EventAccountFilter>
  DescribeEventDetailsForOrganizationRequest& AddOrganizationEventDetailFilters(OrganizationEventDetailFiltersT&& value) {
    m_organizationEventDetailFiltersHasBeenSet = true;
    m_organizationEventDetailFilters.emplace_back(std::forward<OrganizationEventDetailFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocaleT = Aws::String>
  DescribeEventDetailsForOrganizationRequest& WithLocale(LocaleT&& value) {
