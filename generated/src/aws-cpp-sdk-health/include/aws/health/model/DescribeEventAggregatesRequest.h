...
class DescribeEventAggregatesRequest : public HealthRequest {
 public:
  ...
  inline void SetAggregateField(EventAggregateField value) {
    m_aggregateFieldHasBeenSet = true;
    m_aggregateField = value;
  }
  inline DescribeEventAggregatesRequest& WithAggregateField(EventAggregateField value) {
  ...
  inline DescribeEventAggregatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
