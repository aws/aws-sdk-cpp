...
class DescribeEventsForOrganizationRequest : public HealthRequest {
 public:
  ...
  template <typename FilterT = OrganizationEventFilter>
  DescribeEventsForOrganizationRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEventsForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeEventsForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename LocaleT = Aws::String>
  DescribeEventsForOrganizationRequest& WithLocale(LocaleT&& value) {
