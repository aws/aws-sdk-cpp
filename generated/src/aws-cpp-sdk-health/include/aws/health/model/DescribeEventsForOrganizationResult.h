...
class DescribeEventsForOrganizationResult {
 public:
  ...
  template <typename EventsT = Aws::Vector<OrganizationEvent>>
  DescribeEventsForOrganizationResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = OrganizationEvent>
  DescribeEventsForOrganizationResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEventsForOrganizationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEventsForOrganizationResult& WithRequestId(RequestIdT&& value) {
