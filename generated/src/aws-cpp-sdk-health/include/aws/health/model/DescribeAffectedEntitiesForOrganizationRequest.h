...
class DescribeAffectedEntitiesForOrganizationRequest : public HealthRequest {
 public:
  ...
  template <typename LocaleT = Aws::String>
  DescribeAffectedEntitiesForOrganizationRequest& WithLocale(LocaleT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAffectedEntitiesForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAffectedEntitiesForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetOrganizationEntityAccountFilters(OrganizationEntityAccountFiltersT&& value) {
    m_organizationEntityAccountFiltersHasBeenSet = true;
    m_organizationEntityAccountFilters = std::forward<OrganizationEntityAccountFiltersT>(value);
  }
  template <typename OrganizationEntityAccountFiltersT = Aws::Vector<EntityAccountFilter>>
  DescribeAffectedEntitiesForOrganizationRequest& WithOrganizationEntityAccountFilters(OrganizationEntityAccountFiltersT&& value) {
    SetOrganizationEntityAccountFilters(std::forward<OrganizationEntityAccountFiltersT>(value));
    return *this;
  }
  template <typename OrganizationEntityAccountFiltersT = EntityAccountFilter>
  DescribeAffectedEntitiesForOrganizationRequest& AddOrganizationEntityAccountFilters(OrganizationEntityAccountFiltersT&& value) {
    m_organizationEntityAccountFiltersHasBeenSet = true;
    m_organizationEntityAccountFilters.emplace_back(std::forward<OrganizationEntityAccountFiltersT>(value));
    return *this;
  }
  ///@}
 private:
