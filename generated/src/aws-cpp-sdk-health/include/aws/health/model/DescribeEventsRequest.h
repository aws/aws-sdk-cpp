...
namespace Model
{
  ...
  public:
    ...
    template<typename FilterT = EventFilter>
    DescribeEventsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename LocaleT = Aws::String>
    DescribeEventsRequest& WithLocale(LocaleT&& value) { SetLocale(std::forward<LocaleT>(value)); return *this;}
    ///@}
  private:
