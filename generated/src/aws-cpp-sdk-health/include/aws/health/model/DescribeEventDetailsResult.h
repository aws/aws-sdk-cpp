...
class DescribeEventDetailsResult {
 public:
  ...
  template <typename SuccessfulSetT = Aws::Vector<EventDetails>>
  DescribeEventDetailsResult& WithSuccessfulSet(SuccessfulSetT&& value) {
    SetSuccessfulSet(std::forward<SuccessfulSetT>(value));
    return *this;
  }
  template <typename SuccessfulSetT = EventDetails>
  DescribeEventDetailsResult& AddSuccessfulSet(SuccessfulSetT&& value) {
    m_successfulSetHasBeenSet = true;
  ...
  template <typename FailedSetT = Aws::Vector<EventDetailsErrorItem>>
  DescribeEventDetailsResult& WithFailedSet(FailedSetT&& value) {
    SetFailedSet(std::forward<FailedSetT>(value));
    return *this;
  }
  template <typename FailedSetT = EventDetailsErrorItem>
  DescribeEventDetailsResult& AddFailedSet(FailedSetT&& value) {
    m_failedSetHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEventDetailsResult& WithRequestId(RequestIdT&& value) {
