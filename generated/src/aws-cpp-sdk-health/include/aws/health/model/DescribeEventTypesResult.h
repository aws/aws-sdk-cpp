...
class DescribeEventTypesResult {
 public:
  ...
  template <typename EventTypesT = Aws::Vector<Aws::String>>
  DescribeEventTypesResult& WithEventTypes(EventTypesT&& value) {
    SetEventTypes(std::forward<EventTypesT>(value));
    return *this;
  }
  template <typename EventTypesT = Aws::String>
  DescribeEventTypesResult& AddEventTypes(EventTypesT&& value) {
    m_eventTypesHasBeenSet = true;
    m_eventTypes.emplace_back(std::forward<EventTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEventTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEventTypesResult& WithRequestId(RequestIdT&& value) {
