...
class DescribeAffectedAccountsForOrganizationRequest : public HealthRequest {
 public:
  ...
  template <typename EventArnT = Aws::String>
  DescribeAffectedAccountsForOrganizationRequest& WithEventArn(EventArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAffectedAccountsForOrganizationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAffectedAccountsForOrganizationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
