...
class DescribeEventTypesRequest : public HealthRequest {
 public:
  ...
  template <typename FilterT = EventTypeFilter>
  DescribeEventTypesRequest& WithFilter(FilterT&& value) {
  ...
  template <typename LocaleT = Aws::String>
  DescribeEventTypesRequest& WithLocale(LocaleT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEventTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeEventTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
