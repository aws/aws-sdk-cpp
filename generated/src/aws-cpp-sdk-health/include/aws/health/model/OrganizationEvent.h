...
class OrganizationEvent {
 public:
  ...
  inline OrganizationEvent& WithEventTypeCategory(EventTypeCategory value) {
  ...
  inline OrganizationEvent& WithEventScopeCode(EventScopeCode value) {
  ...
  inline OrganizationEvent& WithStatusCode(EventStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline OrganizationEvent& WithActionability(EventActionability value) {
  ...
  inline OrganizationEvent& AddPersonas(EventPersona value) {
    m_personasHasBeenSet = true;
