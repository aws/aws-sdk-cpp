...
class EventFilter {
 public:
  ...
  template <typename ActionabilitiesT = Aws::Vector<EventActionability>>
  EventFilter& WithActionabilities(ActionabilitiesT&& value) {
    SetActionabilities(std::forward<ActionabilitiesT>(value));
    return *this;
  }
  inline EventFilter& AddActionabilities(EventActionability value) {
    m_actionabilitiesHasBeenSet = true;
  ...
  template <typename EventArnsT = Aws::Vector<Aws::String>>
  EventFilter& WithEventArns(EventArnsT&& value) {
    SetEventArns(std::forward<EventArnsT>(value));
    return *this;
  }
  template <typename EventArnsT = Aws::String>
  EventFilter& AddEventArns(EventArnsT&& value) {
    m_eventArnsHasBeenSet = true;
  ...
  template <typename EventTypeCodesT = Aws::Vector<Aws::String>>
  EventFilter& WithEventTypeCodes(EventTypeCodesT&& value) {
    SetEventTypeCodes(std::forward<EventTypeCodesT>(value));
    return *this;
  }
  template <typename EventTypeCodesT = Aws::String>
  EventFilter& AddEventTypeCodes(EventTypeCodesT&& value) {
    m_eventTypeCodesHasBeenSet = true;
  ...
  template <typename ServicesT = Aws::Vector<Aws::String>>
  EventFilter& WithServices(ServicesT&& value) {
    SetServices(std::forward<ServicesT>(value));
    return *this;
  }
  template <typename ServicesT = Aws::String>
  EventFilter& AddServices(ServicesT&& value) {
    m_servicesHasBeenSet = true;
  ...
  template <typename RegionsT = Aws::Vector<Aws::String>>
  EventFilter& WithRegions(RegionsT&& value) {
    SetRegions(std::forward<RegionsT>(value));
    return *this;
  }
  template <typename RegionsT = Aws::String>
  EventFilter& AddRegions(RegionsT&& value) {
    m_regionsHasBeenSet = true;
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  EventFilter& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  EventFilter& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  void SetStartTimes(StartTimesT&& value) {
    m_startTimesHasBeenSet = true;
    m_startTimes = std::forward<StartTimesT>(value);
  }
  template <typename StartTimesT = Aws::Vector<DateTimeRange>>
  EventFilter& WithStartTimes(StartTimesT&& value) {
    SetStartTimes(std::forward<StartTimesT>(value));
    return *this;
  }
  template <typename StartTimesT = DateTimeRange>
  EventFilter& AddStartTimes(StartTimesT&& value) {
    m_startTimesHasBeenSet = true;
    m_startTimes.emplace_back(std::forward<StartTimesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedTimesT = Aws::Vector<DateTimeRange>>
  EventFilter& WithLastUpdatedTimes(LastUpdatedTimesT&& value) {
    SetLastUpdatedTimes(std::forward<LastUpdatedTimesT>(value));
    return *this;
  }
  template <typename LastUpdatedTimesT = DateTimeRange>
  EventFilter& AddLastUpdatedTimes(LastUpdatedTimesT&& value) {
    m_lastUpdatedTimesHasBeenSet = true;
  ...
  template <typename EntityArnsT = Aws::Vector<Aws::String>>
  EventFilter& WithEntityArns(EntityArnsT&& value) {
    SetEntityArns(std::forward<EntityArnsT>(value));
    return *this;
  }
  template <typename EntityArnsT = Aws::String>
  EventFilter& AddEntityArns(EntityArnsT&& value) {
    m_entityArnsHasBeenSet = true;
  ...
  template <typename EntityValuesT = Aws::Vector<Aws::String>>
  EventFilter& WithEntityValues(EntityValuesT&& value) {
    SetEntityValues(std::forward<EntityValuesT>(value));
    return *this;
  }
  template <typename EntityValuesT = Aws::String>
  EventFilter& AddEntityValues(EntityValuesT&& value) {
    m_entityValuesHasBeenSet = true;
  ...
  template <typename EventTypeCategoriesT = Aws::Vector<EventTypeCategory>>
  EventFilter& WithEventTypeCategories(EventTypeCategoriesT&& value) {
    SetEventTypeCategories(std::forward<EventTypeCategoriesT>(value));
    return *this;
  }
  inline EventFilter& AddEventTypeCategories(EventTypeCategory value) {
    m_eventTypeCategoriesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Aws::Map<Aws::String, Aws::String>>>
  EventFilter& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  EventFilter& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename EventStatusCodesT = Aws::Vector<EventStatusCode>>
  EventFilter& WithEventStatusCodes(EventStatusCodesT&& value) {
    SetEventStatusCodes(std::forward<EventStatusCodesT>(value));
    return *this;
  }
  inline EventFilter& AddEventStatusCodes(EventStatusCode value) {
    m_eventStatusCodesHasBeenSet = true;
  ...
  template <typename PersonasT = Aws::Vector<EventPersona>>
  EventFilter& WithPersonas(PersonasT&& value) {
    SetPersonas(std::forward<PersonasT>(value));
    return *this;
  }
  inline EventFilter& AddPersonas(EventPersona value) {
    m_personasHasBeenSet = true;
