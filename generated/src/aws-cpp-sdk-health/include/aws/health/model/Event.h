...
class Event {
 public:
  ...
  void SetEventTypeCode(EventTypeCodeT&& value) {
    ...
    m_eventTypeCode = std::forward<EventTypeCodeT>(value);
  }
  template <typename EventTypeCodeT = Aws::String>
  Event& WithEventTypeCode(EventTypeCodeT&& value) {
    SetEventTypeCode(std::forward<EventTypeCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEventTypeCategory(EventTypeCategory value) {
    m_eventTypeCategoryHasBeenSet = true;
    m_eventTypeCategory = value;
  }
  inline Event& WithEventTypeCategory(EventTypeCategory value) {
    SetEventTypeCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusCode(EventStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline Event& WithStatusCode(EventStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  inline Event& WithEventScopeCode(EventScopeCode value) {
