...
namespace Health
{
const size_t HealthEndpointRules::RulesBlobStrLen = 4265;
const size_t HealthEndpointRules::RulesBlobSize = 4266;
...
'/','h','e','a','l','t','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'g','l','o','b','a','l','.','h','e','a','l','t','h','.','a','m','a','z','o','n','a','w','s','.','c',
...
's','-','c','n','-','g','l','o','b','a','l','"',']','}',']',',','"','e','n','d','p','o','i','n','t',
'"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','g','l','o','b','a','l','.',
'h','e','a','l','t','h','.','a','m','a','z','o','n','a','w','s','.','c','o','m','.','c','n','"',',',
'"','p','r','o','p','e','r','t','i','e','s','"',':','{','"','a','u','t','h','S','c','h','e','m','e',
's','"',':','[','{','"','n','a','m','e','"',':','"','s','i','g','v','4','"',',','"','s','i','g','n',
'i','n','g','N','a','m','e','"',':','"','h','e','a','l','t','h','"',',','"','s','i','g','n','i','n',
'g','R','e','g','i','o','n','"',':','"','c','n','-','n','o','r','t','h','w','e','s','t','-','1','"',
'}',']','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':',
'"','e','n','d','p','o','i','n','t','"','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',
':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t',
't','p','s',':','/','/','h','e','a','l','t','h','.','{','R','e','g','i','o','n','}','.','{','P','a',
'r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',
',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s',
'"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']',
