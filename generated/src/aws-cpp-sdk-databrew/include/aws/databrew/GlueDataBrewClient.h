...
namespace GlueDataBrew
{
   ...
   * required.</p>
   */
  class AWS_GLUEDATABREW_API GlueDataBrewClient : Aws::Client::ClientWithAsyncTemplateMethods<GlueDataBrewClient>,
    smithy::client::AwsSmithyClientT<Aws::GlueDataBrew::SERVICE_NAME,
