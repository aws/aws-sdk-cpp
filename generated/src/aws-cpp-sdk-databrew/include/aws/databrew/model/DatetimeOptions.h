...
class DatetimeOptions {
 public:
  ...
  void SetTimezoneOffset(TimezoneOffsetT&& value) {
    ...
    m_timezoneOffset = std::forward<TimezoneOffsetT>(value);
  }
  template <typename TimezoneOffsetT = Aws::String>
  DatetimeOptions& WithTimezoneOffset(TimezoneOffsetT&& value) {
    SetTimezoneOffset(std::forward<TimezoneOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocaleCode(LocaleCodeT&& value) {
    ...
    m_localeCode = std::forward<LocaleCodeT>(value);
  }
  template <typename LocaleCodeT = Aws::String>
  DatetimeOptions& WithLocaleCode(LocaleCodeT&& value) {
    SetLocaleCode(std::forward<LocaleCodeT>(value));
    return *this;
  }
  ///@}
 private:
