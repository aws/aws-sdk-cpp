...
namespace Model
{
  ...
  {
  public:
    AWS_GLUEDATABREW_API CreateProfileJobResult() = default;
    ...
    template<typename NameT = Aws::String>
    CreateProfileJobResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateProfileJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
