...
class UpdateDatasetRequest : public GlueDataBrewRequest {
 public:
  ...
  inline void SetFormat(InputFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline UpdateDatasetRequest& WithFormat(InputFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetPathOptions(PathOptionsT&& value) {
    ...
    m_pathOptions = std::forward<PathOptionsT>(value);
  }
  template <typename PathOptionsT = PathOptions>
  UpdateDatasetRequest& WithPathOptions(PathOptionsT&& value) {
    SetPathOptions(std::forward<PathOptionsT>(value));
    return *this;
  }
  ///@}
 private:
