...
class FilterExpression {
 public:
  ...
  template <typename ExpressionT = Aws::String>
  FilterExpression& WithExpression(ExpressionT&& value) {
  ...
  void SetValuesMap(ValuesMapT&& value) {
    m_valuesMapHasBeenSet = true;
    m_valuesMap = std::forward<ValuesMapT>(value);
  }
  template <typename ValuesMapT = Aws::Map<Aws::String, Aws::String>>
  FilterExpression& WithValuesMap(ValuesMapT&& value) {
    SetValuesMap(std::forward<ValuesMapT>(value));
    return *this;
  }
  ...
  FilterExpression& AddValuesMap(ValuesMapKeyT&& key, ValuesMapValueT&& value) {
    m_valuesMapHasBeenSet = true;
    m_valuesMap.emplace(std::forward<ValuesMapKeyT>(key), std::forward<ValuesMapValueT>(value));
    return *this;
  }
  ///@}
 private:
