...
class UpdateProfileJobRequest : public GlueDataBrewRequest {
 public:
  ...
  inline UpdateProfileJobRequest& WithEncryptionMode(EncryptionMode value) {
  ...
  inline UpdateProfileJobRequest& WithLogSubscription(LogSubscription value) {
  ...
  inline UpdateProfileJobRequest& WithMaxCapacity(int value) {
  ...
  inline UpdateProfileJobRequest& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProfileJobRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
