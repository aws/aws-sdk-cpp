...
namespace Model
{
  class CreateRecipeJobResult
  {
  public:
    AWS_GLUEDATABREW_API CreateRecipeJobResult();
    ...
    inline CreateRecipeJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateRecipeJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateRecipeJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
