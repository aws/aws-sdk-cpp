...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    StopJobRunRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RunIdT = Aws::String>
    StopJobRunRequest& WithRunId(RunIdT&& value) { SetRunId(std::forward<RunIdT>(value)); return *this;}
    ///@}
  private:
