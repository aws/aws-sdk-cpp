...
class ProfileConfiguration {
 public:
  ...
  void SetDatasetStatisticsConfiguration(DatasetStatisticsConfigurationT&& value) {
    ...
    m_datasetStatisticsConfiguration = std::forward<DatasetStatisticsConfigurationT>(value);
  }
  template <typename DatasetStatisticsConfigurationT = StatisticsConfiguration>
  ProfileConfiguration& WithDatasetStatisticsConfiguration(DatasetStatisticsConfigurationT&& value) {
    SetDatasetStatisticsConfiguration(std::forward<DatasetStatisticsConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * evaluations. </p>
   */
  inline const Aws::Vector<ColumnStatisticsConfiguration>& GetColumnStatisticsConfigurations() const {
    return m_columnStatisticsConfigurations;
  }
  ...
  void SetColumnStatisticsConfigurations(ColumnStatisticsConfigurationsT&& value) {
    ...
    m_columnStatisticsConfigurations = std::forward<ColumnStatisticsConfigurationsT>(value);
  }
  template <typename ColumnStatisticsConfigurationsT = Aws::Vector<ColumnStatisticsConfiguration>>
  ProfileConfiguration& WithColumnStatisticsConfigurations(ColumnStatisticsConfigurationsT&& value) {
    SetColumnStatisticsConfigurations(std::forward<ColumnStatisticsConfigurationsT>(value));
    return *this;
  }
  ...
  ProfileConfiguration& AddColumnStatisticsConfigurations(ColumnStatisticsConfigurationsT&& value) {
    m_columnStatisticsConfigurationsHasBeenSet = true;
    m_columnStatisticsConfigurations.emplace_back(std::forward<ColumnStatisticsConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntityDetectorConfiguration(EntityDetectorConfigurationT&& value) {
    ...
    m_entityDetectorConfiguration = std::forward<EntityDetectorConfigurationT>(value);
  }
  template <typename EntityDetectorConfigurationT = EntityDetectorConfiguration>
  ProfileConfiguration& WithEntityDetectorConfiguration(EntityDetectorConfigurationT&& value) {
    SetEntityDetectorConfiguration(std::forward<EntityDetectorConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
