...
class Job {
 public:
  ...
  inline Job& WithEncryptionMode(EncryptionMode value) {
  ...
  inline Job& WithLogSubscription(LogSubscription value) {
  ...
  inline Job& WithMaxCapacity(int value) {
  ...
  inline Job& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
