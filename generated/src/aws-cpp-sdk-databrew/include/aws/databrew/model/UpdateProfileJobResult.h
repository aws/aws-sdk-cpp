...
namespace Model
{
  ...
  {
  public:
    AWS_GLUEDATABREW_API UpdateProfileJobResult() = default;
    ...
    template<typename NameT = Aws::String>
    UpdateProfileJobResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateProfileJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
