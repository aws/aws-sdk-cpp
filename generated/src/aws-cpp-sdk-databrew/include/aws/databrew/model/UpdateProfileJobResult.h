...
namespace Model
{
  ...
  public:
    ...
    inline UpdateProfileJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateProfileJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateProfileJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
