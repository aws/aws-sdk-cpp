...
class Rule {
 public:
  ...
  inline Rule& WithDisabled(bool value) {
    SetDisabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCheckExpression(CheckExpressionT&& value) {
    ...
    m_checkExpression = std::forward<CheckExpressionT>(value);
  }
  template <typename CheckExpressionT = Aws::String>
  Rule& WithCheckExpression(CheckExpressionT&& value) {
    SetCheckExpression(std::forward<CheckExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubstitutionMap(SubstitutionMapT&& value) {
    ...
    m_substitutionMap = std::forward<SubstitutionMapT>(value);
  }
  template <typename SubstitutionMapT = Aws::Map<Aws::String, Aws::String>>
  Rule& WithSubstitutionMap(SubstitutionMapT&& value) {
    SetSubstitutionMap(std::forward<SubstitutionMapT>(value));
    return *this;
  }
  ...
  Rule& AddSubstitutionMap(SubstitutionMapKeyT&& key, SubstitutionMapValueT&& value) {
    m_substitutionMapHasBeenSet = true;
    m_substitutionMap.emplace(std::forward<SubstitutionMapKeyT>(key), std::forward<SubstitutionMapValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColumnSelectors(ColumnSelectorsT&& value) {
    ...
    m_columnSelectors = std::forward<ColumnSelectorsT>(value);
  }
  template <typename ColumnSelectorsT = Aws::Vector<ColumnSelector>>
  Rule& WithColumnSelectors(ColumnSelectorsT&& value) {
    SetColumnSelectors(std::forward<ColumnSelectorsT>(value));
    return *this;
  }
  template <typename ColumnSelectorsT = ColumnSelector>
  Rule& AddColumnSelectors(ColumnSelectorsT&& value) {
    m_columnSelectorsHasBeenSet = true;
    m_columnSelectors.emplace_back(std::forward<ColumnSelectorsT>(value));
    return *this;
  }
  ///@}
 private:
