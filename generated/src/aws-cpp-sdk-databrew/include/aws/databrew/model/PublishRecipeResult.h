...
namespace Model
{
  ...
  {
  public:
    AWS_GLUEDATABREW_API PublishRecipeResult() = default;
    ...
    template<typename NameT = Aws::String>
    PublishRecipeResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PublishRecipeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
