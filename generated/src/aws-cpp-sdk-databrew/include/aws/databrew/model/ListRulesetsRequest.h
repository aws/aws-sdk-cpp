...
namespace Model
{
  ...
  {
  public:
    AWS_GLUEDATABREW_API ListRulesetsRequest() = default;
    ...
    template<typename TargetArnT = Aws::String>
    ListRulesetsRequest& WithTargetArn(TargetArnT&& value) { SetTargetArn(std::forward<TargetArnT>(value)); return *this;}
    ///@}
