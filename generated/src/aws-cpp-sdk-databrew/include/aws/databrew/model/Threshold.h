...
class Threshold {
 public:
  ...
  inline Threshold& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline Threshold& WithType(ThresholdType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(ThresholdUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline Threshold& WithUnit(ThresholdUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
