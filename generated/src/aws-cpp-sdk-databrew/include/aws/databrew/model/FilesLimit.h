...
class FilesLimit {
 public:
  ...
  inline void SetMaxFiles(int value) {
    m_maxFilesHasBeenSet = true;
    m_maxFiles = value;
  }
  inline FilesLimit& WithMaxFiles(int value) {
    SetMaxFiles(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOrderedBy(OrderedBy value) {
    m_orderedByHasBeenSet = true;
    m_orderedBy = value;
  }
  inline FilesLimit& WithOrderedBy(OrderedBy value) {
    SetOrderedBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOrder(Order value) {
    m_orderHasBeenSet = true;
    m_order = value;
  }
  inline FilesLimit& WithOrder(Order value) {
    SetOrder(value);
    return *this;
  }
  ///@}
