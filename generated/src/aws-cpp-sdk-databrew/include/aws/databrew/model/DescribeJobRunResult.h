...
class DescribeJobRunResult {
 public:
  ...
  inline DescribeJobRunResult& WithAttempt(int value) {
    SetAttempt(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeJobRunResult& WithExecutionTime(int value) {
  ...
  inline DescribeJobRunResult& WithState(JobRunState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeJobRunResult& WithLogSubscription(LogSubscription value) {
