...
class ExcelOptions {
 public:
  ...
  void SetSheetNames(SheetNamesT&& value) {
    ...
    m_sheetNames = std::forward<SheetNamesT>(value);
  }
  template <typename SheetNamesT = Aws::Vector<Aws::String>>
  ExcelOptions& WithSheetNames(SheetNamesT&& value) {
    SetSheetNames(std::forward<SheetNamesT>(value));
    return *this;
  }
  template <typename SheetNamesT = Aws::String>
  ExcelOptions& AddSheetNames(SheetNamesT&& value) {
    m_sheetNamesHasBeenSet = true;
    m_sheetNames.emplace_back(std::forward<SheetNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSheetIndexes(SheetIndexesT&& value) {
    ...
    m_sheetIndexes = std::forward<SheetIndexesT>(value);
  }
  template <typename SheetIndexesT = Aws::Vector<int>>
  ExcelOptions& WithSheetIndexes(SheetIndexesT&& value) {
    SetSheetIndexes(std::forward<SheetIndexesT>(value));
    return *this;
  }
  inline ExcelOptions& AddSheetIndexes(int value) {
    m_sheetIndexesHasBeenSet = true;
    m_sheetIndexes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ExcelOptions& WithHeaderRow(bool value) {
    SetHeaderRow(value);
    return *this;
  }
  ///@}
