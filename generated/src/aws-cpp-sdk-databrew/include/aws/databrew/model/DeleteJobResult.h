...
namespace Model
{
  ...
  {
  public:
    AWS_GLUEDATABREW_API DeleteJobResult() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteJobResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
