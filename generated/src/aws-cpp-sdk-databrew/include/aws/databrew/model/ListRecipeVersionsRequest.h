...
namespace Model
{
  ...
  /**
   */
  class ListRecipeVersionsRequest : public GlueDataBrewRequest
  {
  public:
    AWS_GLUEDATABREW_API ListRecipeVersionsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListRecipeVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ListRecipeVersionsRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
