...
class ListRecipeVersionsRequest : public GlueDataBrewRequest {
 public:
  ...
  inline ListRecipeVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRecipeVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListRecipeVersionsRequest& WithName(NameT&& value) {
