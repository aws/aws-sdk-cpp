...
class Output {
 public:
  ...
  inline Output& WithCompressionFormat(CompressionFormat value) {
  ...
  inline void SetFormat(OutputFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline Output& WithFormat(OutputFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverwrite(bool value) {
    m_overwriteHasBeenSet = true;
    m_overwrite = value;
  }
  inline Output& WithOverwrite(bool value) {
    SetOverwrite(value);
    return *this;
  }
  ///@}
  ...
  void SetFormatOptions(FormatOptionsT&& value) {
    ...
    m_formatOptions = std::forward<FormatOptionsT>(value);
  }
  template <typename FormatOptionsT = OutputFormatOptions>
  Output& WithFormatOptions(FormatOptionsT&& value) {
    SetFormatOptions(std::forward<FormatOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxOutputFiles(int value) {
    m_maxOutputFilesHasBeenSet = true;
    m_maxOutputFiles = value;
  }
  inline Output& WithMaxOutputFiles(int value) {
    SetMaxOutputFiles(value);
    return *this;
  }
  ///@}
 private:
