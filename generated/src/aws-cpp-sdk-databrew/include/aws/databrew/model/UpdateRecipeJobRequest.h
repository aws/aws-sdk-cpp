...
class UpdateRecipeJobRequest : public GlueDataBrewRequest {
 public:
  ...
  inline UpdateRecipeJobRequest& WithEncryptionMode(EncryptionMode value) {
  ...
  inline UpdateRecipeJobRequest& WithLogSubscription(LogSubscription value) {
  ...
  inline UpdateRecipeJobRequest& WithMaxCapacity(int value) {
  ...
  inline UpdateRecipeJobRequest& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateRecipeJobRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
