...
class DatasetParameter {
 public:
  ...
  inline DatasetParameter& WithType(ParameterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetDatetimeOptions(DatetimeOptionsT&& value) {
    ...
    m_datetimeOptions = std::forward<DatetimeOptionsT>(value);
  }
  template <typename DatetimeOptionsT = DatetimeOptions>
  DatasetParameter& WithDatetimeOptions(DatetimeOptionsT&& value) {
    SetDatetimeOptions(std::forward<DatetimeOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCreateColumn(bool value) {
    m_createColumnHasBeenSet = true;
    m_createColumn = value;
  }
  inline DatasetParameter& WithCreateColumn(bool value) {
    SetCreateColumn(value);
    return *this;
  }
  ///@}
