...
class ViewFrame {
 public:
  ...
  inline void SetStartColumnIndex(int value) {
    m_startColumnIndexHasBeenSet = true;
    m_startColumnIndex = value;
  }
  inline ViewFrame& WithStartColumnIndex(int value) {
    SetStartColumnIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetColumnRange(int value) {
    m_columnRangeHasBeenSet = true;
    m_columnRange = value;
  }
  inline ViewFrame& WithColumnRange(int value) {
    SetColumnRange(value);
    return *this;
  }
  ///@}
  ...
  void SetHiddenColumns(HiddenColumnsT&& value) {
    ...
    m_hiddenColumns = std::forward<HiddenColumnsT>(value);
  }
  template <typename HiddenColumnsT = Aws::Vector<Aws::String>>
  ViewFrame& WithHiddenColumns(HiddenColumnsT&& value) {
    SetHiddenColumns(std::forward<HiddenColumnsT>(value));
    return *this;
  }
  template <typename HiddenColumnsT = Aws::String>
  ViewFrame& AddHiddenColumns(HiddenColumnsT&& value) {
    m_hiddenColumnsHasBeenSet = true;
    m_hiddenColumns.emplace_back(std::forward<HiddenColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStartRowIndex(int value) {
    m_startRowIndexHasBeenSet = true;
    m_startRowIndex = value;
  }
  inline ViewFrame& WithStartRowIndex(int value) {
    SetStartRowIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRowRange(int value) {
    m_rowRangeHasBeenSet = true;
    m_rowRange = value;
  }
  inline ViewFrame& WithRowRange(int value) {
    SetRowRange(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAnalytics(AnalyticsMode value) {
    m_analyticsHasBeenSet = true;
    m_analytics = value;
  }
  inline ViewFrame& WithAnalytics(AnalyticsMode value) {
    SetAnalytics(value);
    return *this;
  }
  ///@}
