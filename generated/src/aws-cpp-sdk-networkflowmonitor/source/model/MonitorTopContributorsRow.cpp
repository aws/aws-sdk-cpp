...
MonitorTopContributorsRow::MonitorTopContributorsRow(JsonView jsonValue) { *this = jsonValue; }
...
MonitorTopContributorsRow& MonitorTopContributorsRow::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("traversedConstructs")) {
    ...
    for (unsigned traversedConstructsIndex = 0; traversedConstructsIndex < traversedConstructsJsonList.GetLength();
         ++traversedConstructsIndex) {
