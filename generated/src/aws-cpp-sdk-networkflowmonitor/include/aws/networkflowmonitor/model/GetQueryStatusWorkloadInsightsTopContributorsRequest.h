...
class GetQueryStatusWorkloadInsightsTopContributorsRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename ScopeIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsRequest& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsRequest& WithQueryId(QueryIdT&& value) {
