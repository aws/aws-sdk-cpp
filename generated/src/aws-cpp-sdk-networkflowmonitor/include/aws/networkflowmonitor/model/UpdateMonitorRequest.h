...
class UpdateMonitorRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  void SetLocalResourcesToAdd(LocalResourcesToAddT&& value) {
    m_localResourcesToAddHasBeenSet = true;
    m_localResourcesToAdd = std::forward<LocalResourcesToAddT>(value);
  }
  template <typename LocalResourcesToAddT = Aws::Vector<MonitorLocalResource>>
  UpdateMonitorRequest& WithLocalResourcesToAdd(LocalResourcesToAddT&& value) {
    SetLocalResourcesToAdd(std::forward<LocalResourcesToAddT>(value));
    return *this;
  }
  template <typename LocalResourcesToAddT = MonitorLocalResource>
  UpdateMonitorRequest& AddLocalResourcesToAdd(LocalResourcesToAddT&& value) {
    m_localResourcesToAddHasBeenSet = true;
    m_localResourcesToAdd.emplace_back(std::forward<LocalResourcesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalResourcesToRemove(LocalResourcesToRemoveT&& value) {
    m_localResourcesToRemoveHasBeenSet = true;
    m_localResourcesToRemove = std::forward<LocalResourcesToRemoveT>(value);
  }
  template <typename LocalResourcesToRemoveT = Aws::Vector<MonitorLocalResource>>
  UpdateMonitorRequest& WithLocalResourcesToRemove(LocalResourcesToRemoveT&& value) {
    SetLocalResourcesToRemove(std::forward<LocalResourcesToRemoveT>(value));
    return *this;
  }
  template <typename LocalResourcesToRemoveT = MonitorLocalResource>
  UpdateMonitorRequest& AddLocalResourcesToRemove(LocalResourcesToRemoveT&& value) {
    m_localResourcesToRemoveHasBeenSet = true;
    m_localResourcesToRemove.emplace_back(std::forward<LocalResourcesToRemoveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteResourcesToAdd(RemoteResourcesToAddT&& value) {
    m_remoteResourcesToAddHasBeenSet = true;
    m_remoteResourcesToAdd = std::forward<RemoteResourcesToAddT>(value);
  }
  template <typename RemoteResourcesToAddT = Aws::Vector<MonitorRemoteResource>>
  UpdateMonitorRequest& WithRemoteResourcesToAdd(RemoteResourcesToAddT&& value) {
    SetRemoteResourcesToAdd(std::forward<RemoteResourcesToAddT>(value));
    return *this;
  }
  template <typename RemoteResourcesToAddT = MonitorRemoteResource>
  UpdateMonitorRequest& AddRemoteResourcesToAdd(RemoteResourcesToAddT&& value) {
    m_remoteResourcesToAddHasBeenSet = true;
    m_remoteResourcesToAdd.emplace_back(std::forward<RemoteResourcesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteResourcesToRemove(RemoteResourcesToRemoveT&& value) {
    m_remoteResourcesToRemoveHasBeenSet = true;
    m_remoteResourcesToRemove = std::forward<RemoteResourcesToRemoveT>(value);
  }
  template <typename RemoteResourcesToRemoveT = Aws::Vector<MonitorRemoteResource>>
  UpdateMonitorRequest& WithRemoteResourcesToRemove(RemoteResourcesToRemoveT&& value) {
    SetRemoteResourcesToRemove(std::forward<RemoteResourcesToRemoveT>(value));
    return *this;
  }
  template <typename RemoteResourcesToRemoveT = MonitorRemoteResource>
  UpdateMonitorRequest& AddRemoteResourcesToRemove(RemoteResourcesToRemoveT&& value) {
    m_remoteResourcesToRemoveHasBeenSet = true;
    m_remoteResourcesToRemove.emplace_back(std::forward<RemoteResourcesToRemoveT>(value));
    return *this;
  }
  ///@}
