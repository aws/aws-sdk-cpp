...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFLOWMONITOR_API StopQueryWorkloadInsightsTopContributorsRequest() = default;
    ...
    template<typename ScopeIdT = Aws::String>
    StopQueryWorkloadInsightsTopContributorsRequest& WithScopeId(ScopeIdT&& value) { SetScopeId(std::forward<ScopeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryIdT = Aws::String>
    StopQueryWorkloadInsightsTopContributorsRequest& WithQueryId(QueryIdT&& value) { SetQueryId(std::forward<QueryIdT>(value)); return *this;}
    ///@}
  private:
