...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFLOWMONITOR_API GetQueryStatusWorkloadInsightsTopContributorsDataRequest();
    ...
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithScopeId(const Aws::String& value) { SetScopeId(value); return *this;}
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithScopeId(Aws::String&& value) { SetScopeId(std::move(value)); return *this;}
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithScopeId(const char* value) { SetScopeId(value); return *this;}
    ///@}
    ...
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithQueryId(const Aws::String& value) { SetQueryId(value); return *this;}
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithQueryId(Aws::String&& value) { SetQueryId(std::move(value)); return *this;}
    inline GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithQueryId(const char* value) { SetQueryId(value); return *this;}
    ///@}
  private:
