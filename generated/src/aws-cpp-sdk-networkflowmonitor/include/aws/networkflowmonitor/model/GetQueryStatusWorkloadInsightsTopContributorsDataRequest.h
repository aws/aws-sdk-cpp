...
class GetQueryStatusWorkloadInsightsTopContributorsDataRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename ScopeIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsDataRequest& WithQueryId(QueryIdT&& value) {
