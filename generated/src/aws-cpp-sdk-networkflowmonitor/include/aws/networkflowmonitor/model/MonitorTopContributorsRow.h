...
class MonitorTopContributorsRow {
 public:
  ...
  void SetLocalIp(LocalIpT&& value) {
    m_localIpHasBeenSet = true;
    m_localIp = std::forward<LocalIpT>(value);
  }
  template <typename LocalIpT = Aws::String>
  MonitorTopContributorsRow& WithLocalIp(LocalIpT&& value) {
    SetLocalIp(std::forward<LocalIpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnatIp(SnatIpT&& value) {
    m_snatIpHasBeenSet = true;
    m_snatIp = std::forward<SnatIpT>(value);
  }
  template <typename SnatIpT = Aws::String>
  MonitorTopContributorsRow& WithSnatIp(SnatIpT&& value) {
    SetSnatIp(std::forward<SnatIpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalInstanceId(LocalInstanceIdT&& value) {
    m_localInstanceIdHasBeenSet = true;
    m_localInstanceId = std::forward<LocalInstanceIdT>(value);
  }
  template <typename LocalInstanceIdT = Aws::String>
  MonitorTopContributorsRow& WithLocalInstanceId(LocalInstanceIdT&& value) {
    SetLocalInstanceId(std::forward<LocalInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocalVpcIdT = Aws::String>
  MonitorTopContributorsRow& WithLocalVpcId(LocalVpcIdT&& value) {
  ...
  template <typename LocalRegionT = Aws::String>
  MonitorTopContributorsRow& WithLocalRegion(LocalRegionT&& value) {
  ...
  template <typename LocalAzT = Aws::String>
  MonitorTopContributorsRow& WithLocalAz(LocalAzT&& value) {
  ...
  template <typename LocalSubnetIdT = Aws::String>
  MonitorTopContributorsRow& WithLocalSubnetId(LocalSubnetIdT&& value) {
  ...
  inline MonitorTopContributorsRow& WithTargetPort(int value) {
    SetTargetPort(value);
    return *this;
  }
  ///@}
  ...
  inline MonitorTopContributorsRow& WithDestinationCategory(DestinationCategory value) {
  ...
  void SetRemoteVpcId(RemoteVpcIdT&& value) {
    m_remoteVpcIdHasBeenSet = true;
    m_remoteVpcId = std::forward<RemoteVpcIdT>(value);
  }
  template <typename RemoteVpcIdT = Aws::String>
  MonitorTopContributorsRow& WithRemoteVpcId(RemoteVpcIdT&& value) {
    SetRemoteVpcId(std::forward<RemoteVpcIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteRegion(RemoteRegionT&& value) {
    m_remoteRegionHasBeenSet = true;
    m_remoteRegion = std::forward<RemoteRegionT>(value);
  }
  template <typename RemoteRegionT = Aws::String>
  MonitorTopContributorsRow& WithRemoteRegion(RemoteRegionT&& value) {
    SetRemoteRegion(std::forward<RemoteRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteAz(RemoteAzT&& value) {
    m_remoteAzHasBeenSet = true;
    m_remoteAz = std::forward<RemoteAzT>(value);
  }
  template <typename RemoteAzT = Aws::String>
  MonitorTopContributorsRow& WithRemoteAz(RemoteAzT&& value) {
    SetRemoteAz(std::forward<RemoteAzT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteSubnetId(RemoteSubnetIdT&& value) {
    m_remoteSubnetIdHasBeenSet = true;
    m_remoteSubnetId = std::forward<RemoteSubnetIdT>(value);
  }
  template <typename RemoteSubnetIdT = Aws::String>
  MonitorTopContributorsRow& WithRemoteSubnetId(RemoteSubnetIdT&& value) {
    SetRemoteSubnetId(std::forward<RemoteSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteInstanceId(RemoteInstanceIdT&& value) {
    m_remoteInstanceIdHasBeenSet = true;
    m_remoteInstanceId = std::forward<RemoteInstanceIdT>(value);
  }
  template <typename RemoteInstanceIdT = Aws::String>
  MonitorTopContributorsRow& WithRemoteInstanceId(RemoteInstanceIdT&& value) {
    SetRemoteInstanceId(std::forward<RemoteInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteIp(RemoteIpT&& value) {
    m_remoteIpHasBeenSet = true;
    m_remoteIp = std::forward<RemoteIpT>(value);
  }
  template <typename RemoteIpT = Aws::String>
  MonitorTopContributorsRow& WithRemoteIp(RemoteIpT&& value) {
    SetRemoteIp(std::forward<RemoteIpT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDnatIp(DnatIpT&& value) {
    m_dnatIpHasBeenSet = true;
    m_dnatIp = std::forward<DnatIpT>(value);
  }
  template <typename DnatIpT = Aws::String>
  MonitorTopContributorsRow& WithDnatIp(DnatIpT&& value) {
    SetDnatIp(std::forward<DnatIpT>(value));
    return *this;
  }
  ///@}
  ...
  inline MonitorTopContributorsRow& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  void SetTraversedConstructs(TraversedConstructsT&& value) {
    m_traversedConstructsHasBeenSet = true;
    m_traversedConstructs = std::forward<TraversedConstructsT>(value);
  }
  template <typename TraversedConstructsT = Aws::Vector<TraversedComponent>>
  MonitorTopContributorsRow& WithTraversedConstructs(TraversedConstructsT&& value) {
    SetTraversedConstructs(std::forward<TraversedConstructsT>(value));
    return *this;
  }
  template <typename TraversedConstructsT = TraversedComponent>
  MonitorTopContributorsRow& AddTraversedConstructs(TraversedConstructsT&& value) {
    m_traversedConstructsHasBeenSet = true;
    m_traversedConstructs.emplace_back(std::forward<TraversedConstructsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKubernetesMetadata(KubernetesMetadataT&& value) {
    m_kubernetesMetadataHasBeenSet = true;
    m_kubernetesMetadata = std::forward<KubernetesMetadataT>(value);
  }
  template <typename KubernetesMetadataT = KubernetesMetadata>
  MonitorTopContributorsRow& WithKubernetesMetadata(KubernetesMetadataT&& value) {
    SetKubernetesMetadata(std::forward<KubernetesMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalInstanceArn(LocalInstanceArnT&& value) {
    m_localInstanceArnHasBeenSet = true;
    m_localInstanceArn = std::forward<LocalInstanceArnT>(value);
  }
  template <typename LocalInstanceArnT = Aws::String>
  MonitorTopContributorsRow& WithLocalInstanceArn(LocalInstanceArnT&& value) {
    SetLocalInstanceArn(std::forward<LocalInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocalSubnetArnT = Aws::String>
  MonitorTopContributorsRow& WithLocalSubnetArn(LocalSubnetArnT&& value) {
  ...
  template <typename LocalVpcArnT = Aws::String>
  MonitorTopContributorsRow& WithLocalVpcArn(LocalVpcArnT&& value) {
  ...
  void SetRemoteInstanceArn(RemoteInstanceArnT&& value) {
    m_remoteInstanceArnHasBeenSet = true;
    m_remoteInstanceArn = std::forward<RemoteInstanceArnT>(value);
  }
  template <typename RemoteInstanceArnT = Aws::String>
  MonitorTopContributorsRow& WithRemoteInstanceArn(RemoteInstanceArnT&& value) {
    SetRemoteInstanceArn(std::forward<RemoteInstanceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteSubnetArn(RemoteSubnetArnT&& value) {
    m_remoteSubnetArnHasBeenSet = true;
    m_remoteSubnetArn = std::forward<RemoteSubnetArnT>(value);
  }
  template <typename RemoteSubnetArnT = Aws::String>
  MonitorTopContributorsRow& WithRemoteSubnetArn(RemoteSubnetArnT&& value) {
    SetRemoteSubnetArn(std::forward<RemoteSubnetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteVpcArn(RemoteVpcArnT&& value) {
    m_remoteVpcArnHasBeenSet = true;
    m_remoteVpcArn = std::forward<RemoteVpcArnT>(value);
  }
  template <typename RemoteVpcArnT = Aws::String>
  MonitorTopContributorsRow& WithRemoteVpcArn(RemoteVpcArnT&& value) {
    SetRemoteVpcArn(std::forward<RemoteVpcArnT>(value));
    return *this;
  }
  ///@}
 private:
