...
class GetQueryResultsMonitorTopContributorsRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  GetQueryResultsMonitorTopContributorsRequest& WithMonitorName(MonitorNameT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  GetQueryResultsMonitorTopContributorsRequest& WithQueryId(QueryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetQueryResultsMonitorTopContributorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetQueryResultsMonitorTopContributorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
