...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFLOWMONITOR_API StopQueryWorkloadInsightsTopContributorsDataRequest() = default;
    ...
    template<typename ScopeIdT = Aws::String>
    StopQueryWorkloadInsightsTopContributorsDataRequest& WithScopeId(ScopeIdT&& value) { SetScopeId(std::forward<ScopeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryIdT = Aws::String>
    StopQueryWorkloadInsightsTopContributorsDataRequest& WithQueryId(QueryIdT&& value) { SetQueryId(std::forward<QueryIdT>(value)); return *this;}
    ///@}
  private:
