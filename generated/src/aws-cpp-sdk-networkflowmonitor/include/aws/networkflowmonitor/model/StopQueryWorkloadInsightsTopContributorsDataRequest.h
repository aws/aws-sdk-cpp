...
class StopQueryWorkloadInsightsTopContributorsDataRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename ScopeIdT = Aws::String>
  StopQueryWorkloadInsightsTopContributorsDataRequest& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  StopQueryWorkloadInsightsTopContributorsDataRequest& WithQueryId(QueryIdT&& value) {
