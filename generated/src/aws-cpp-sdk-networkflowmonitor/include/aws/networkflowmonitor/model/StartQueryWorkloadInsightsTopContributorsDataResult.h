...
class StartQueryWorkloadInsightsTopContributorsDataResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API StartQueryWorkloadInsightsTopContributorsDataResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename QueryIdT = Aws::String>
  StartQueryWorkloadInsightsTopContributorsDataResult& WithQueryId(QueryIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartQueryWorkloadInsightsTopContributorsDataResult& WithRequestId(RequestIdT&& value) {
