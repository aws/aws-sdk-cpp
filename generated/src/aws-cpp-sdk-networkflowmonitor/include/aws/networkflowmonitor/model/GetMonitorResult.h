...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFLOWMONITOR_API GetMonitorResult();
    AWS_NETWORKFLOWMONITOR_API GetMonitorResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKFLOWMONITOR_API GetMonitorResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline GetMonitorResult& WithMonitorStatus(const MonitorStatus& value) { SetMonitorStatus(value); return *this;}
    inline GetMonitorResult& WithMonitorStatus(MonitorStatus&& value) { SetMonitorStatus(std::move(value)); return *this;}
    ///@}
    ...
    inline GetMonitorResult& WithLocalResources(const Aws::Vector<MonitorLocalResource>& value) { SetLocalResources(value); return *this;}
    inline GetMonitorResult& WithLocalResources(Aws::Vector<MonitorLocalResource>&& value) { SetLocalResources(std::move(value)); return *this;}
    inline GetMonitorResult& AddLocalResources(const MonitorLocalResource& value) { m_localResources.push_back(value); return *this; }
    inline GetMonitorResult& AddLocalResources(MonitorLocalResource&& value) { m_localResources.push_back(std::move(value)); return *this; }
    ///@}
    ...
    inline GetMonitorResult& WithRemoteResources(const Aws::Vector<MonitorRemoteResource>& value) { SetRemoteResources(value); return *this;}
    inline GetMonitorResult& WithRemoteResources(Aws::Vector<MonitorRemoteResource>&& value) { SetRemoteResources(std::move(value)); return *this;}
    inline GetMonitorResult& AddRemoteResources(const MonitorRemoteResource& value) { m_remoteResources.push_back(value); return *this; }
    inline GetMonitorResult& AddRemoteResources(MonitorRemoteResource&& value) { m_remoteResources.push_back(std::move(value)); return *this; }
    ///@}
