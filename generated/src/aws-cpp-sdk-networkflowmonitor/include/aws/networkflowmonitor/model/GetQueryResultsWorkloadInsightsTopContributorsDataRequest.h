...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKFLOWMONITOR_API GetQueryResultsWorkloadInsightsTopContributorsDataRequest() = default;
    ...
    template<typename ScopeIdT = Aws::String>
    GetQueryResultsWorkloadInsightsTopContributorsDataRequest& WithScopeId(ScopeIdT&& value) { SetScopeId(std::forward<ScopeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename QueryIdT = Aws::String>
    GetQueryResultsWorkloadInsightsTopContributorsDataRequest& WithQueryId(QueryIdT&& value) { SetQueryId(std::forward<QueryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetQueryResultsWorkloadInsightsTopContributorsDataRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
