...
class GetQueryResultsWorkloadInsightsTopContributorsResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API GetQueryResultsWorkloadInsightsTopContributorsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetTopContributors(TopContributorsT&& value) {
    ...
    m_topContributors = std::forward<TopContributorsT>(value);
  }
  template <typename TopContributorsT = Aws::Vector<WorkloadInsightsTopContributorsRow>>
  GetQueryResultsWorkloadInsightsTopContributorsResult& WithTopContributors(TopContributorsT&& value) {
    SetTopContributors(std::forward<TopContributorsT>(value));
    return *this;
  }
  template <typename TopContributorsT = WorkloadInsightsTopContributorsRow>
  GetQueryResultsWorkloadInsightsTopContributorsResult& AddTopContributors(TopContributorsT&& value) {
    m_topContributorsHasBeenSet = true;
    m_topContributors.emplace_back(std::forward<TopContributorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetQueryResultsWorkloadInsightsTopContributorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetQueryResultsWorkloadInsightsTopContributorsResult& WithRequestId(RequestIdT&& value) {
