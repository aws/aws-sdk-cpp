 ...
 * can be a a subnet, a VPC, an Availability Zone, an EKS cluster or an Amazon Web
...
class MonitorLocalResource {
 public:
   ...
   * <code>AWS::EKS::Cluster</code>, or <code>AWS::Region</code>.</p>
   */
  inline MonitorLocalResourceType GetType() const { return m_type; }
  inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
  inline void SetType(MonitorLocalResourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MonitorLocalResource& WithType(MonitorLocalResourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The identifier of the local resource. The values you can specify are the
   * following:</p> <ul> <li> <p>For a VPC, subnet or EKS cluster, this identifier is
   * the VPC Amazon Resource Name (ARN), subnet ARN or cluster ARN.</p> </li> <li>
   * <p>For an Availability Zone, this identifier is the AZ name, for example,
   * us-west-2b.</p> </li> <li> <p>For a Region, this identifier is the Region name,
   * for example, us-west-2.</p> </li> </ul>
   */
  ...
  template <typename IdentifierT = Aws::String>
  MonitorLocalResource& WithIdentifier(IdentifierT&& value) {
