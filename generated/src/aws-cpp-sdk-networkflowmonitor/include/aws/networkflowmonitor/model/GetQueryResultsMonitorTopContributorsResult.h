...
class GetQueryResultsMonitorTopContributorsResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API GetQueryResultsMonitorTopContributorsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetQueryResultsMonitorTopContributorsResult& WithUnit(MetricUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  template <typename TopContributorsT = Aws::Vector<MonitorTopContributorsRow>>
  GetQueryResultsMonitorTopContributorsResult& WithTopContributors(TopContributorsT&& value) {
    SetTopContributors(std::forward<TopContributorsT>(value));
    return *this;
  }
  template <typename TopContributorsT = MonitorTopContributorsRow>
  GetQueryResultsMonitorTopContributorsResult& AddTopContributors(TopContributorsT&& value) {
    m_topContributorsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetQueryResultsMonitorTopContributorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetQueryResultsMonitorTopContributorsResult& WithRequestId(RequestIdT&& value) {
