...
class KubernetesMetadata {
 public:
  ...
  void SetLocalServiceName(LocalServiceNameT&& value) {
    m_localServiceNameHasBeenSet = true;
    m_localServiceName = std::forward<LocalServiceNameT>(value);
  }
  template <typename LocalServiceNameT = Aws::String>
  KubernetesMetadata& WithLocalServiceName(LocalServiceNameT&& value) {
    SetLocalServiceName(std::forward<LocalServiceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalPodName(LocalPodNameT&& value) {
    m_localPodNameHasBeenSet = true;
    m_localPodName = std::forward<LocalPodNameT>(value);
  }
  template <typename LocalPodNameT = Aws::String>
  KubernetesMetadata& WithLocalPodName(LocalPodNameT&& value) {
    SetLocalPodName(std::forward<LocalPodNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalPodNamespace(LocalPodNamespaceT&& value) {
    m_localPodNamespaceHasBeenSet = true;
    m_localPodNamespace = std::forward<LocalPodNamespaceT>(value);
  }
  template <typename LocalPodNamespaceT = Aws::String>
  KubernetesMetadata& WithLocalPodNamespace(LocalPodNamespaceT&& value) {
    SetLocalPodNamespace(std::forward<LocalPodNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteServiceName(RemoteServiceNameT&& value) {
    m_remoteServiceNameHasBeenSet = true;
    m_remoteServiceName = std::forward<RemoteServiceNameT>(value);
  }
  template <typename RemoteServiceNameT = Aws::String>
  KubernetesMetadata& WithRemoteServiceName(RemoteServiceNameT&& value) {
    SetRemoteServiceName(std::forward<RemoteServiceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemotePodName(RemotePodNameT&& value) {
    m_remotePodNameHasBeenSet = true;
    m_remotePodName = std::forward<RemotePodNameT>(value);
  }
  template <typename RemotePodNameT = Aws::String>
  KubernetesMetadata& WithRemotePodName(RemotePodNameT&& value) {
    SetRemotePodName(std::forward<RemotePodNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemotePodNamespace(RemotePodNamespaceT&& value) {
    m_remotePodNamespaceHasBeenSet = true;
    m_remotePodNamespace = std::forward<RemotePodNamespaceT>(value);
  }
  template <typename RemotePodNamespaceT = Aws::String>
  KubernetesMetadata& WithRemotePodNamespace(RemotePodNamespaceT&& value) {
    SetRemotePodNamespace(std::forward<RemotePodNamespaceT>(value));
    return *this;
  }
  ///@}
 private:
