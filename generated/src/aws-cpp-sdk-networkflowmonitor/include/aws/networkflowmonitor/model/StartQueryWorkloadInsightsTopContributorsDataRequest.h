...
class StartQueryWorkloadInsightsTopContributorsDataRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename ScopeIdT = Aws::String>
  StartQueryWorkloadInsightsTopContributorsDataRequest& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StartQueryWorkloadInsightsTopContributorsDataRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StartQueryWorkloadInsightsTopContributorsDataRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetMetricName(WorkloadInsightsMetric value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline StartQueryWorkloadInsightsTopContributorsDataRequest& WithMetricName(WorkloadInsightsMetric value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDestinationCategory(DestinationCategory value) {
    m_destinationCategoryHasBeenSet = true;
    m_destinationCategory = value;
  }
  inline StartQueryWorkloadInsightsTopContributorsDataRequest& WithDestinationCategory(DestinationCategory value) {
