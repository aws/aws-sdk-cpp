...
class GetQueryStatusWorkloadInsightsTopContributorsDataResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API GetQueryStatusWorkloadInsightsTopContributorsDataResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetQueryStatusWorkloadInsightsTopContributorsDataResult& WithStatus(QueryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsDataResult& WithRequestId(RequestIdT&& value) {
