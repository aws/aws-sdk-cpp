...
class StartQueryMonitorTopContributorsRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  StartQueryMonitorTopContributorsRequest& WithMonitorName(MonitorNameT&& value) {
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StartQueryMonitorTopContributorsRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StartQueryMonitorTopContributorsRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetMetricName(MonitorMetric value) {
    m_metricNameHasBeenSet = true;
    m_metricName = value;
  }
  inline StartQueryMonitorTopContributorsRequest& WithMetricName(MonitorMetric value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline StartQueryMonitorTopContributorsRequest& WithDestinationCategory(DestinationCategory value) {
  ...
  inline StartQueryMonitorTopContributorsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
