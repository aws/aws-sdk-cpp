...
class WorkloadInsightsTopContributorsDataPoint {
 public:
  ...
  template <typename TimestampsT = Aws::Vector<Aws::Utils::DateTime>>
  WorkloadInsightsTopContributorsDataPoint& WithTimestamps(TimestampsT&& value) {
    SetTimestamps(std::forward<TimestampsT>(value));
    return *this;
  }
  template <typename TimestampsT = Aws::Utils::DateTime>
  WorkloadInsightsTopContributorsDataPoint& AddTimestamps(TimestampsT&& value) {
    m_timestampsHasBeenSet = true;
  ...
  template <typename ValuesT = Aws::Vector<double>>
  WorkloadInsightsTopContributorsDataPoint& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  inline WorkloadInsightsTopContributorsDataPoint& AddValues(double value) {
    m_valuesHasBeenSet = true;
  ...
  template <typename LabelT = Aws::String>
  WorkloadInsightsTopContributorsDataPoint& WithLabel(LabelT&& value) {
