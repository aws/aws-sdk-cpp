...
class CreateMonitorRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename LocalResourcesT = Aws::Vector<MonitorLocalResource>>
  CreateMonitorRequest& WithLocalResources(LocalResourcesT&& value) {
    SetLocalResources(std::forward<LocalResourcesT>(value));
    return *this;
  }
  template <typename LocalResourcesT = MonitorLocalResource>
  CreateMonitorRequest& AddLocalResources(LocalResourcesT&& value) {
    m_localResourcesHasBeenSet = true;
  ...
  template <typename RemoteResourcesT = Aws::Vector<MonitorRemoteResource>>
  CreateMonitorRequest& WithRemoteResources(RemoteResourcesT&& value) {
    SetRemoteResources(std::forward<RemoteResourcesT>(value));
    return *this;
  }
  template <typename RemoteResourcesT = MonitorRemoteResource>
  CreateMonitorRequest& AddRemoteResources(RemoteResourcesT&& value) {
    m_remoteResourcesHasBeenSet = true;
  ...
  template <typename ScopeArnT = Aws::String>
  CreateMonitorRequest& WithScopeArn(ScopeArnT&& value) {
