...
class GetQueryResultsWorkloadInsightsTopContributorsRequest : public NetworkFlowMonitorRequest {
 public:
  ...
  template <typename ScopeIdT = Aws::String>
  GetQueryResultsWorkloadInsightsTopContributorsRequest& WithScopeId(ScopeIdT&& value) {
  ...
  template <typename QueryIdT = Aws::String>
  GetQueryResultsWorkloadInsightsTopContributorsRequest& WithQueryId(QueryIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetQueryResultsWorkloadInsightsTopContributorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetQueryResultsWorkloadInsightsTopContributorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
