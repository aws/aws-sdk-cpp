...
class WorkloadInsightsTopContributorsRow {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithAccountId(AccountIdT&& value) {
  ...
  void SetLocalSubnetId(LocalSubnetIdT&& value) {
    m_localSubnetIdHasBeenSet = true;
    m_localSubnetId = std::forward<LocalSubnetIdT>(value);
  }
  template <typename LocalSubnetIdT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalSubnetId(LocalSubnetIdT&& value) {
    SetLocalSubnetId(std::forward<LocalSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalAz(LocalAzT&& value) {
    m_localAzHasBeenSet = true;
    m_localAz = std::forward<LocalAzT>(value);
  }
  template <typename LocalAzT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalAz(LocalAzT&& value) {
    SetLocalAz(std::forward<LocalAzT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalVpcId(LocalVpcIdT&& value) {
    m_localVpcIdHasBeenSet = true;
    m_localVpcId = std::forward<LocalVpcIdT>(value);
  }
  template <typename LocalVpcIdT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalVpcId(LocalVpcIdT&& value) {
    SetLocalVpcId(std::forward<LocalVpcIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalRegion(LocalRegionT&& value) {
    m_localRegionHasBeenSet = true;
    m_localRegion = std::forward<LocalRegionT>(value);
  }
  template <typename LocalRegionT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalRegion(LocalRegionT&& value) {
    SetLocalRegion(std::forward<LocalRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteIdentifier(RemoteIdentifierT&& value) {
    m_remoteIdentifierHasBeenSet = true;
    m_remoteIdentifier = std::forward<RemoteIdentifierT>(value);
  }
  template <typename RemoteIdentifierT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithRemoteIdentifier(RemoteIdentifierT&& value) {
    SetRemoteIdentifier(std::forward<RemoteIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline WorkloadInsightsTopContributorsRow& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  void SetLocalSubnetArn(LocalSubnetArnT&& value) {
    m_localSubnetArnHasBeenSet = true;
    m_localSubnetArn = std::forward<LocalSubnetArnT>(value);
  }
  template <typename LocalSubnetArnT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalSubnetArn(LocalSubnetArnT&& value) {
    SetLocalSubnetArn(std::forward<LocalSubnetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalVpcArn(LocalVpcArnT&& value) {
    m_localVpcArnHasBeenSet = true;
    m_localVpcArn = std::forward<LocalVpcArnT>(value);
  }
  template <typename LocalVpcArnT = Aws::String>
  WorkloadInsightsTopContributorsRow& WithLocalVpcArn(LocalVpcArnT&& value) {
    SetLocalVpcArn(std::forward<LocalVpcArnT>(value));
    return *this;
  }
  ///@}
 private:
