...
class StartQueryWorkloadInsightsTopContributorsResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API StartQueryWorkloadInsightsTopContributorsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename QueryIdT = Aws::String>
  StartQueryWorkloadInsightsTopContributorsResult& WithQueryId(QueryIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartQueryWorkloadInsightsTopContributorsResult& WithRequestId(RequestIdT&& value) {
