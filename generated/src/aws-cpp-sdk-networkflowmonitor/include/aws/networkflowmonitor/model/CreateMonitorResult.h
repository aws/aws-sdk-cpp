...
class CreateMonitorResult {
 public:
  ...
  inline CreateMonitorResult& WithMonitorStatus(MonitorStatus value) {
  ...
  template <typename LocalResourcesT = Aws::Vector<MonitorLocalResource>>
  CreateMonitorResult& WithLocalResources(LocalResourcesT&& value) {
    SetLocalResources(std::forward<LocalResourcesT>(value));
    return *this;
  }
  template <typename LocalResourcesT = MonitorLocalResource>
  CreateMonitorResult& AddLocalResources(LocalResourcesT&& value) {
    m_localResourcesHasBeenSet = true;
  ...
  template <typename RemoteResourcesT = Aws::Vector<MonitorRemoteResource>>
  CreateMonitorResult& WithRemoteResources(RemoteResourcesT&& value) {
    SetRemoteResources(std::forward<RemoteResourcesT>(value));
    return *this;
  }
  template <typename RemoteResourcesT = MonitorRemoteResource>
  CreateMonitorResult& AddRemoteResources(RemoteResourcesT&& value) {
    m_remoteResourcesHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateMonitorResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  CreateMonitorResult& WithModifiedAt(ModifiedAtT&& value) {
