...
class GetQueryStatusWorkloadInsightsTopContributorsResult {
 public:
  ...
  AWS_NETWORKFLOWMONITOR_API GetQueryStatusWorkloadInsightsTopContributorsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline GetQueryStatusWorkloadInsightsTopContributorsResult& WithStatus(QueryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetQueryStatusWorkloadInsightsTopContributorsResult& WithRequestId(RequestIdT&& value) {
