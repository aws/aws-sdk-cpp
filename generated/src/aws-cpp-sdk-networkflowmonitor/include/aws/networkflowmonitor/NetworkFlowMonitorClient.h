...
namespace NetworkFlowMonitor
{
   ...
   */
  class AWS_NETWORKFLOWMONITOR_API NetworkFlowMonitorClient : Aws::Client::ClientWithAsyncTemplateMethods<NetworkFlowMonitorClient>,
    smithy::client::AwsSmithyClientT<Aws::NetworkFlowMonitor::SERVICE_NAME,
