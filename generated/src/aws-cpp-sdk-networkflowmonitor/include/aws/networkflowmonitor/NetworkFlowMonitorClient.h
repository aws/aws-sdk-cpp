...
class AWS_NETWORKFLOWMONITOR_API NetworkFlowMonitorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NetworkFlowMonitorClient(const Aws::NetworkFlowMonitor::NetworkFlowMonitorClientConfiguration& clientConfiguration =
  ...
  NetworkFlowMonitorClient(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<NetworkFlowMonitorEndpointProviderBase> endpointProvider = nullptr,
                           const Aws::NetworkFlowMonitor::NetworkFlowMonitorClientConfiguration& clientConfiguration =
                               Aws::NetworkFlowMonitor::NetworkFlowMonitorClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  NetworkFlowMonitorClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for GetMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMonitorRequestT = Model::GetMonitorRequest>
  void GetMonitorAsync(const GetMonitorRequestT& request, const GetMonitorResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetQueryResultsMonitorTopContributorsOutcome GetQueryResultsMonitorTopContributors(
      const Model::GetQueryResultsMonitorTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for GetQueryResultsMonitorTopContributors that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetQueryResultsMonitorTopContributorsRequestT = Model::GetQueryResultsMonitorTopContributorsRequest>
  Model::GetQueryResultsMonitorTopContributorsOutcomeCallable GetQueryResultsMonitorTopContributorsCallable(
      const GetQueryResultsMonitorTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryResultsMonitorTopContributors, request);
  }

  /**
   * An Async wrapper for GetQueryResultsMonitorTopContributors that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetQueryResultsMonitorTopContributorsRequestT = Model::GetQueryResultsMonitorTopContributorsRequest>
  void GetQueryResultsMonitorTopContributorsAsync(const GetQueryResultsMonitorTopContributorsRequestT& request,
                                                  const GetQueryResultsMonitorTopContributorsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetQueryResultsWorkloadInsightsTopContributorsOutcome GetQueryResultsWorkloadInsightsTopContributors(
      const Model::GetQueryResultsWorkloadInsightsTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for GetQueryResultsWorkloadInsightsTopContributors that returns a future to the operation so that it can be executed
  ...
  Model::GetQueryResultsWorkloadInsightsTopContributorsOutcomeCallable GetQueryResultsWorkloadInsightsTopContributorsCallable(
      const GetQueryResultsWorkloadInsightsTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryResultsWorkloadInsightsTopContributors, request);
  }

  /**
   * An Async wrapper for GetQueryResultsWorkloadInsightsTopContributors that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetQueryResultsWorkloadInsightsTopContributorsRequestT = Model::GetQueryResultsWorkloadInsightsTopContributorsRequest>
  void GetQueryResultsWorkloadInsightsTopContributorsAsync(
      const GetQueryResultsWorkloadInsightsTopContributorsRequestT& request,
      const GetQueryResultsWorkloadInsightsTopContributorsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetQueryResultsWorkloadInsightsTopContributorsDataOutcome GetQueryResultsWorkloadInsightsTopContributorsData(
      const Model::GetQueryResultsWorkloadInsightsTopContributorsDataRequest& request) const;

  /**
   * A Callable wrapper for GetQueryResultsWorkloadInsightsTopContributorsData that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename GetQueryResultsWorkloadInsightsTopContributorsDataRequestT =
                Model::GetQueryResultsWorkloadInsightsTopContributorsDataRequest>
  Model::GetQueryResultsWorkloadInsightsTopContributorsDataOutcomeCallable GetQueryResultsWorkloadInsightsTopContributorsDataCallable(
      const GetQueryResultsWorkloadInsightsTopContributorsDataRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryResultsWorkloadInsightsTopContributorsData, request);
  }

  /**
   * An Async wrapper for GetQueryResultsWorkloadInsightsTopContributorsData that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetQueryResultsWorkloadInsightsTopContributorsDataRequestT =
                Model::GetQueryResultsWorkloadInsightsTopContributorsDataRequest>
  void GetQueryResultsWorkloadInsightsTopContributorsDataAsync(
      const GetQueryResultsWorkloadInsightsTopContributorsDataRequestT& request,
      const GetQueryResultsWorkloadInsightsTopContributorsDataResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetQueryStatusMonitorTopContributorsOutcome GetQueryStatusMonitorTopContributors(
      const Model::GetQueryStatusMonitorTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for GetQueryStatusMonitorTopContributors that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetQueryStatusMonitorTopContributorsRequestT = Model::GetQueryStatusMonitorTopContributorsRequest>
  Model::GetQueryStatusMonitorTopContributorsOutcomeCallable GetQueryStatusMonitorTopContributorsCallable(
      const GetQueryStatusMonitorTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryStatusMonitorTopContributors, request);
  }

  /**
   * An Async wrapper for GetQueryStatusMonitorTopContributors that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetQueryStatusMonitorTopContributorsRequestT = Model::GetQueryStatusMonitorTopContributorsRequest>
  void GetQueryStatusMonitorTopContributorsAsync(const GetQueryStatusMonitorTopContributorsRequestT& request,
                                                 const GetQueryStatusMonitorTopContributorsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetQueryStatusWorkloadInsightsTopContributorsOutcome GetQueryStatusWorkloadInsightsTopContributors(
      const Model::GetQueryStatusWorkloadInsightsTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for GetQueryStatusWorkloadInsightsTopContributors that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::GetQueryStatusWorkloadInsightsTopContributorsOutcomeCallable GetQueryStatusWorkloadInsightsTopContributorsCallable(
      const GetQueryStatusWorkloadInsightsTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryStatusWorkloadInsightsTopContributors, request);
  }

  /**
   * An Async wrapper for GetQueryStatusWorkloadInsightsTopContributors that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetQueryStatusWorkloadInsightsTopContributorsRequestT = Model::GetQueryStatusWorkloadInsightsTopContributorsRequest>
  void GetQueryStatusWorkloadInsightsTopContributorsAsync(
      const GetQueryStatusWorkloadInsightsTopContributorsRequestT& request,
      const GetQueryStatusWorkloadInsightsTopContributorsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetQueryStatusWorkloadInsightsTopContributorsDataOutcome GetQueryStatusWorkloadInsightsTopContributorsData(
      const Model::GetQueryStatusWorkloadInsightsTopContributorsDataRequest& request) const;

  /**
   * A Callable wrapper for GetQueryStatusWorkloadInsightsTopContributorsData that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <
      typename GetQueryStatusWorkloadInsightsTopContributorsDataRequestT = Model::GetQueryStatusWorkloadInsightsTopContributorsDataRequest>
  Model::GetQueryStatusWorkloadInsightsTopContributorsDataOutcomeCallable GetQueryStatusWorkloadInsightsTopContributorsDataCallable(
      const GetQueryStatusWorkloadInsightsTopContributorsDataRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::GetQueryStatusWorkloadInsightsTopContributorsData, request);
  }

  /**
   * An Async wrapper for GetQueryStatusWorkloadInsightsTopContributorsData that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <
      typename GetQueryStatusWorkloadInsightsTopContributorsDataRequestT = Model::GetQueryStatusWorkloadInsightsTopContributorsDataRequest>
  void GetQueryStatusWorkloadInsightsTopContributorsDataAsync(
      const GetQueryStatusWorkloadInsightsTopContributorsDataRequestT& request,
      const GetQueryStatusWorkloadInsightsTopContributorsDataResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartQueryMonitorTopContributorsOutcome StartQueryMonitorTopContributors(
      const Model::StartQueryMonitorTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for StartQueryMonitorTopContributors that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename StartQueryMonitorTopContributorsRequestT = Model::StartQueryMonitorTopContributorsRequest>
  Model::StartQueryMonitorTopContributorsOutcomeCallable StartQueryMonitorTopContributorsCallable(
      const StartQueryMonitorTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StartQueryMonitorTopContributors, request);
  }

  /**
   * An Async wrapper for StartQueryMonitorTopContributors that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StartQueryMonitorTopContributorsRequestT = Model::StartQueryMonitorTopContributorsRequest>
  void StartQueryMonitorTopContributorsAsync(const StartQueryMonitorTopContributorsRequestT& request,
                                             const StartQueryMonitorTopContributorsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartQueryWorkloadInsightsTopContributorsOutcome StartQueryWorkloadInsightsTopContributors(
      const Model::StartQueryWorkloadInsightsTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for StartQueryWorkloadInsightsTopContributors that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::StartQueryWorkloadInsightsTopContributorsOutcomeCallable StartQueryWorkloadInsightsTopContributorsCallable(
      const StartQueryWorkloadInsightsTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StartQueryWorkloadInsightsTopContributors, request);
  }

  /**
   * An Async wrapper for StartQueryWorkloadInsightsTopContributors that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartQueryWorkloadInsightsTopContributorsRequestT = Model::StartQueryWorkloadInsightsTopContributorsRequest>
  void StartQueryWorkloadInsightsTopContributorsAsync(
      const StartQueryWorkloadInsightsTopContributorsRequestT& request,
      const StartQueryWorkloadInsightsTopContributorsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartQueryWorkloadInsightsTopContributorsDataOutcome StartQueryWorkloadInsightsTopContributorsData(
      const Model::StartQueryWorkloadInsightsTopContributorsDataRequest& request) const;

  /**
   * A Callable wrapper for StartQueryWorkloadInsightsTopContributorsData that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::StartQueryWorkloadInsightsTopContributorsDataOutcomeCallable StartQueryWorkloadInsightsTopContributorsDataCallable(
      const StartQueryWorkloadInsightsTopContributorsDataRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StartQueryWorkloadInsightsTopContributorsData, request);
  }

  /**
   * An Async wrapper for StartQueryWorkloadInsightsTopContributorsData that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename StartQueryWorkloadInsightsTopContributorsDataRequestT = Model::StartQueryWorkloadInsightsTopContributorsDataRequest>
  void StartQueryWorkloadInsightsTopContributorsDataAsync(
      const StartQueryWorkloadInsightsTopContributorsDataRequestT& request,
      const StartQueryWorkloadInsightsTopContributorsDataResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopQueryMonitorTopContributorsOutcome StopQueryMonitorTopContributors(
      const Model::StopQueryMonitorTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for StopQueryMonitorTopContributors that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopQueryMonitorTopContributorsRequestT = Model::StopQueryMonitorTopContributorsRequest>
  Model::StopQueryMonitorTopContributorsOutcomeCallable StopQueryMonitorTopContributorsCallable(
      const StopQueryMonitorTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StopQueryMonitorTopContributors, request);
  }

  /**
   * An Async wrapper for StopQueryMonitorTopContributors that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StopQueryMonitorTopContributorsRequestT = Model::StopQueryMonitorTopContributorsRequest>
  void StopQueryMonitorTopContributorsAsync(const StopQueryMonitorTopContributorsRequestT& request,
                                            const StopQueryMonitorTopContributorsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StopQueryWorkloadInsightsTopContributorsOutcome StopQueryWorkloadInsightsTopContributors(
      const Model::StopQueryWorkloadInsightsTopContributorsRequest& request) const;

  /**
   * A Callable wrapper for StopQueryWorkloadInsightsTopContributors that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StopQueryWorkloadInsightsTopContributorsRequestT = Model::StopQueryWorkloadInsightsTopContributorsRequest>
  Model::StopQueryWorkloadInsightsTopContributorsOutcomeCallable StopQueryWorkloadInsightsTopContributorsCallable(
      const StopQueryWorkloadInsightsTopContributorsRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StopQueryWorkloadInsightsTopContributors, request);
  }

  /**
   * An Async wrapper for StopQueryWorkloadInsightsTopContributors that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StopQueryWorkloadInsightsTopContributorsRequestT = Model::StopQueryWorkloadInsightsTopContributorsRequest>
  void StopQueryWorkloadInsightsTopContributorsAsync(
      const StopQueryWorkloadInsightsTopContributorsRequestT& request,
      const StopQueryWorkloadInsightsTopContributorsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StopQueryWorkloadInsightsTopContributorsDataOutcome StopQueryWorkloadInsightsTopContributorsData(
      const Model::StopQueryWorkloadInsightsTopContributorsDataRequest& request) const;

  /**
   * A Callable wrapper for StopQueryWorkloadInsightsTopContributorsData that returns a future to the operation so that it can be executed
   * in parallel to other requests.
   */
  ...
  Model::StopQueryWorkloadInsightsTopContributorsDataOutcomeCallable StopQueryWorkloadInsightsTopContributorsDataCallable(
      const StopQueryWorkloadInsightsTopContributorsDataRequestT& request) const {
    return SubmitCallable(&NetworkFlowMonitorClient::StopQueryWorkloadInsightsTopContributorsData, request);
  }

  /**
   * An Async wrapper for StopQueryWorkloadInsightsTopContributorsData that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename StopQueryWorkloadInsightsTopContributorsDataRequestT = Model::StopQueryWorkloadInsightsTopContributorsDataRequest>
  void StopQueryWorkloadInsightsTopContributorsDataAsync(
      const StopQueryWorkloadInsightsTopContributorsDataRequestT& request,
      const StopQueryWorkloadInsightsTopContributorsDataResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMonitorRequestT = Model::UpdateMonitorRequest>
