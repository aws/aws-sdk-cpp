...
class AWS_DATAPIPELINE_API DataPipelineClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DataPipelineClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DataPipelineEndpointProviderBase> endpointProvider = nullptr,
      const Aws::DataPipeline::DataPipelineClientConfiguration& clientConfiguration = Aws::DataPipeline::DataPipelineClientConfiguration());
  ...
  /**
   * A Callable wrapper for ActivatePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivatePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ActivatePipelineRequestT = Model::ActivatePipelineRequest>
  void ActivatePipelineAsync(const ActivatePipelineRequestT& request, const ActivatePipelineResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeactivatePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeactivatePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeactivatePipelineRequestT = Model::DeactivatePipelineRequest>
  void DeactivatePipelineAsync(const DeactivatePipelineRequestT& request, const DeactivatePipelineResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeObjects that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeObjectsRequestT = Model::DescribeObjectsRequest>
  void DescribeObjectsAsync(const DescribeObjectsRequestT& request, const DescribeObjectsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePipelines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePipelines that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePipelinesRequestT = Model::DescribePipelinesRequest>
  void DescribePipelinesAsync(const DescribePipelinesRequestT& request, const DescribePipelinesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EvaluateExpression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EvaluateExpression that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EvaluateExpressionRequestT = Model::EvaluateExpressionRequest>
  void EvaluateExpressionAsync(const EvaluateExpressionRequestT& request, const EvaluateExpressionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPipelineDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPipelineDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPipelineDefinitionRequestT = Model::GetPipelineDefinitionRequest>
  void GetPipelineDefinitionAsync(const GetPipelineDefinitionRequestT& request, const GetPipelineDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PollForTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PollForTaskRequestT = Model::PollForTaskRequest>
  void PollForTaskAsync(const PollForTaskRequestT& request, const PollForTaskResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutPipelineDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutPipelineDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutPipelineDefinitionRequestT = Model::PutPipelineDefinitionRequest>
  void PutPipelineDefinitionAsync(const PutPipelineDefinitionRequestT& request, const PutPipelineDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for QueryObjects that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename QueryObjectsRequestT = Model::QueryObjectsRequest>
  void QueryObjectsAsync(const QueryObjectsRequestT& request, const QueryObjectsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReportTaskProgress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ReportTaskProgress that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ReportTaskProgressRequestT = Model::ReportTaskProgressRequest>
  void ReportTaskProgressAsync(const ReportTaskProgressRequestT& request, const ReportTaskProgressResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ReportTaskRunnerHeartbeat that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ReportTaskRunnerHeartbeatRequestT = Model::ReportTaskRunnerHeartbeatRequest>
  Model::ReportTaskRunnerHeartbeatOutcomeCallable ReportTaskRunnerHeartbeatCallable(
      const ReportTaskRunnerHeartbeatRequestT& request) const {
    return SubmitCallable(&DataPipelineClient::ReportTaskRunnerHeartbeat, request);
  }

  /**
   * An Async wrapper for ReportTaskRunnerHeartbeat that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ReportTaskRunnerHeartbeatRequestT = Model::ReportTaskRunnerHeartbeatRequest>
  void ReportTaskRunnerHeartbeatAsync(const ReportTaskRunnerHeartbeatRequestT& request,
  ...
  /**
   * An Async wrapper for SetStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SetStatusRequestT = Model::SetStatusRequest>
  void SetStatusAsync(const SetStatusRequestT& request, const SetStatusResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SetTaskStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SetTaskStatusRequestT = Model::SetTaskStatusRequest>
  void SetTaskStatusAsync(const SetTaskStatusRequestT& request, const SetTaskStatusResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ValidatePipelineDefinitionOutcome ValidatePipelineDefinition(
      const Model::ValidatePipelineDefinitionRequest& request) const;

  /**
   * A Callable wrapper for ValidatePipelineDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ValidatePipelineDefinitionRequestT = Model::ValidatePipelineDefinitionRequest>
  Model::ValidatePipelineDefinitionOutcomeCallable ValidatePipelineDefinitionCallable(
      const ValidatePipelineDefinitionRequestT& request) const {
    return SubmitCallable(&DataPipelineClient::ValidatePipelineDefinition, request);
  }

  /**
   * An Async wrapper for ValidatePipelineDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ValidatePipelineDefinitionRequestT = Model::ValidatePipelineDefinitionRequest>
  void ValidatePipelineDefinitionAsync(const ValidatePipelineDefinitionRequestT& request,
