...
namespace DataPipeline
{
   ...
   */
  class AWS_DATAPIPELINE_API DataPipelineClient : Aws::Client::ClientWithAsyncTemplateMethods<DataPipelineClient>,
    smithy::client::AwsSmithyClientT<Aws::DataPipeline::SERVICE_NAME,
