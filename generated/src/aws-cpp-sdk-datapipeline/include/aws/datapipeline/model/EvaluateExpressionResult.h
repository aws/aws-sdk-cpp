...
class EvaluateExpressionResult {
 public:
  ...
  void SetEvaluatedExpression(EvaluatedExpressionT&& value) {
    m_evaluatedExpressionHasBeenSet = true;
    m_evaluatedExpression = std::forward<EvaluatedExpressionT>(value);
  }
  template <typename EvaluatedExpressionT = Aws::String>
  EvaluateExpressionResult& WithEvaluatedExpression(EvaluatedExpressionT&& value) {
    SetEvaluatedExpression(std::forward<EvaluatedExpressionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  EvaluateExpressionResult& WithRequestId(RequestIdT&& value) {
