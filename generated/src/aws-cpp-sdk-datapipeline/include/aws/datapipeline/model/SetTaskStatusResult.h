...
namespace Model
{
  ...
  {
  public:
    AWS_DATAPIPELINE_API SetTaskStatusResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    SetTaskStatusResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
