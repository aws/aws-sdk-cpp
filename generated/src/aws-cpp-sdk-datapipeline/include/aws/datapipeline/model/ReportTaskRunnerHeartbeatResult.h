...
class ReportTaskRunnerHeartbeatResult {
 public:
  ...
  inline void SetTerminate(bool value) {
    m_terminateHasBeenSet = true;
    m_terminate = value;
  }
  inline ReportTaskRunnerHeartbeatResult& WithTerminate(bool value) {
    SetTerminate(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ReportTaskRunnerHeartbeatResult& WithRequestId(RequestIdT&& value) {
