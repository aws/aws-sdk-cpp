...
class ValidatePipelineDefinitionResult {
 public:
  ...
  template <typename ValidationErrorsT = Aws::Vector<ValidationError>>
  ValidatePipelineDefinitionResult& WithValidationErrors(ValidationErrorsT&& value) {
    SetValidationErrors(std::forward<ValidationErrorsT>(value));
    return *this;
  }
  template <typename ValidationErrorsT = ValidationError>
  ValidatePipelineDefinitionResult& AddValidationErrors(ValidationErrorsT&& value) {
    m_validationErrorsHasBeenSet = true;
  ...
  template <typename ValidationWarningsT = Aws::Vector<ValidationWarning>>
  ValidatePipelineDefinitionResult& WithValidationWarnings(ValidationWarningsT&& value) {
    SetValidationWarnings(std::forward<ValidationWarningsT>(value));
    return *this;
  }
  template <typename ValidationWarningsT = ValidationWarning>
  ValidatePipelineDefinitionResult& AddValidationWarnings(ValidationWarningsT&& value) {
    m_validationWarningsHasBeenSet = true;
  ...
  inline ValidatePipelineDefinitionResult& WithErrored(bool value) {
    SetErrored(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ValidatePipelineDefinitionResult& WithRequestId(RequestIdT&& value) {
