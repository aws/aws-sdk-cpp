...
class SetTaskStatusRequest : public DataPipelineRequest {
 public:
  ...
  inline SetTaskStatusRequest& WithTaskStatus(TaskStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetErrorId(ErrorIdT&& value) {
    ...
    m_errorId = std::forward<ErrorIdT>(value);
  }
  template <typename ErrorIdT = Aws::String>
  SetTaskStatusRequest& WithErrorId(ErrorIdT&& value) {
    SetErrorId(std::forward<ErrorIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetErrorStackTrace(ErrorStackTraceT&& value) {
    m_errorStackTraceHasBeenSet = true;
    m_errorStackTrace = std::forward<ErrorStackTraceT>(value);
  }
  template <typename ErrorStackTraceT = Aws::String>
  SetTaskStatusRequest& WithErrorStackTrace(ErrorStackTraceT&& value) {
    SetErrorStackTrace(std::forward<ErrorStackTraceT>(value));
    return *this;
  }
  ///@}
 private:
