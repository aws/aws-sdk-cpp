...
class DeactivatePipelineRequest : public DataPipelineRequest {
 public:
  ...
  template <typename PipelineIdT = Aws::String>
  DeactivatePipelineRequest& WithPipelineId(PipelineIdT&& value) {
  ...
  inline void SetCancelActive(bool value) {
    m_cancelActiveHasBeenSet = true;
    m_cancelActive = value;
  }
  inline DeactivatePipelineRequest& WithCancelActive(bool value) {
    SetCancelActive(value);
    return *this;
  }
  ///@}
 private:
