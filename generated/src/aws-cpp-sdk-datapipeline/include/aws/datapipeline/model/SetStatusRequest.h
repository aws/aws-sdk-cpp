...
class SetStatusRequest : public DataPipelineRequest {
 public:
  ...
  void SetObjectIds(ObjectIdsT&& value) {
    m_objectIdsHasBeenSet = true;
    m_objectIds = std::forward<ObjectIdsT>(value);
  }
  template <typename ObjectIdsT = Aws::Vector<Aws::String>>
  SetStatusRequest& WithObjectIds(ObjectIdsT&& value) {
    SetObjectIds(std::forward<ObjectIdsT>(value));
    return *this;
  }
  template <typename ObjectIdsT = Aws::String>
  SetStatusRequest& AddObjectIds(ObjectIdsT&& value) {
    m_objectIdsHasBeenSet = true;
    m_objectIds.emplace_back(std::forward<ObjectIdsT>(value));
    return *this;
  }
  ///@}
