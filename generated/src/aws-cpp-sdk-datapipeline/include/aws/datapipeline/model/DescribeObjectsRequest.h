...
class DescribeObjectsRequest : public DataPipelineRequest {
 public:
  ...
  template <typename PipelineIdT = Aws::String>
  DescribeObjectsRequest& WithPipelineId(PipelineIdT&& value) {
  ...
  template <typename ObjectIdsT = Aws::Vector<Aws::String>>
  DescribeObjectsRequest& WithObjectIds(ObjectIdsT&& value) {
    SetObjectIds(std::forward<ObjectIdsT>(value));
    return *this;
  }
  template <typename ObjectIdsT = Aws::String>
  DescribeObjectsRequest& AddObjectIds(ObjectIdsT&& value) {
    m_objectIdsHasBeenSet = true;
  ...
  inline void SetEvaluateExpressions(bool value) {
    m_evaluateExpressionsHasBeenSet = true;
    m_evaluateExpressions = value;
  }
  inline DescribeObjectsRequest& WithEvaluateExpressions(bool value) {
    SetEvaluateExpressions(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeObjectsRequest& WithMarker(MarkerT&& value) {
