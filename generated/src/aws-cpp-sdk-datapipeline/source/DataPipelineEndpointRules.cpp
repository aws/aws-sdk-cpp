...
{
const size_t DataPipelineEndpointRules::RulesBlobStrLen = 3478;
const size_t DataPipelineEndpointRules::RulesBlobSize = 3479;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','d','a','t','a','p','i',
'p','e','l','i','n','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
't','p','s',':','/','/','d','a','t','a','p','i','p','e','l','i','n','e','-','f','i','p','s','.','{',
...
'h','t','t','p','s',':','/','/','d','a','t','a','p','i','p','e','l','i','n','e','.','{','R','e','g',
...
'd','a','t','a','p','i','p','e','l','i','n','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* DataPipelineEndpointRules::GetRulesBlob()
{
