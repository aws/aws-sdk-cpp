...
DescribeWorkspaceAssociationsResult::DescribeWorkspaceAssociationsResult()
{
}

DescribeWorkspaceAssociationsResult::DescribeWorkspaceAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeWorkspaceAssociationsResult& DescribeWorkspaceAssociationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
