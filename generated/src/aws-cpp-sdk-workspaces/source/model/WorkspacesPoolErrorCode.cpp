...
static const int IAM_SERVICE_ROLE_MISSING_ENI_DESCRIBE_ACTION_HASH =
    HashingUtils::HashString("IAM_SERVICE_ROLE_MISSING_ENI_DESCRIBE_ACTION");
...
static const int IAM_SERVICE_ROLE_MISSING_DESCRIBE_SUBNET_ACTION_HASH =
    HashingUtils::HashString("IAM_SERVICE_ROLE_MISSING_DESCRIBE_SUBNET_ACTION");
...
static const int IAM_SERVICE_ROLE_MISSING_DESCRIBE_SECURITY_GROUPS_ACTION_HASH =
    HashingUtils::HashString("IAM_SERVICE_ROLE_MISSING_DESCRIBE_SECURITY_GROUPS_ACTION");
static const int WORKSPACES_POOL_STOPPED_HASH = HashingUtils::HashString("WORKSPACES_POOL_STOPPED");
static const int WORKSPACES_POOL_INSTANCE_PROVISIONING_FAILURE_HASH =
    HashingUtils::HashString("WORKSPACES_POOL_INSTANCE_PROVISIONING_FAILURE");
...
static const int DOMAIN_JOIN_ERROR_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED_HASH =
...
static const int DOMAIN_JOIN_ERROR_SECRET_ACTION_PERMISSION_IS_MISSING_HASH =
    HashingUtils::HashString("DOMAIN_JOIN_ERROR_SECRET_ACTION_PERMISSION_IS_MISSING");
...
static const int DOMAIN_JOIN_ERROR_SECRET_VALUE_KEY_NOT_FOUND_HASH =
    HashingUtils::HashString("DOMAIN_JOIN_ERROR_SECRET_VALUE_KEY_NOT_FOUND");
