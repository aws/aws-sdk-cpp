...
DisassociateConnectionAliasResult::DisassociateConnectionAliasResult()
{
}

DisassociateConnectionAliasResult::DisassociateConnectionAliasResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
