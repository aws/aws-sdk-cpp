...
DescribeConnectionAliasPermissionsResult& DescribeConnectionAliasPermissionsResult::operator=(
  ...
  if (jsonValue.ValueExists("ConnectionAliasPermissions")) {
    ...
    for (unsigned connectionAliasPermissionsIndex = 0; connectionAliasPermissionsIndex < connectionAliasPermissionsJsonList.GetLength();
         ++connectionAliasPermissionsIndex) {
