...
DescribeImageAssociationsResult::DescribeImageAssociationsResult()
{
}

DescribeImageAssociationsResult::DescribeImageAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
