...
DescribeBundleAssociationsResult::DescribeBundleAssociationsResult()
{
}

DescribeBundleAssociationsResult::DescribeBundleAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeBundleAssociationsResult& DescribeBundleAssociationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
