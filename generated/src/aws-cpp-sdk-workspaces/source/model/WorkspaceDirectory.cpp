...
WorkspaceDirectory::WorkspaceDirectory(JsonView jsonValue) { *this = jsonValue; }
...
WorkspaceDirectory& WorkspaceDirectory::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EndpointEncryptionMode")) {
    m_endpointEncryptionMode =
        EndpointEncryptionModeMapper::GetEndpointEncryptionModeForName(jsonValue.GetString("EndpointEncryptionMode"));
