...
AssociateWorkspaceApplicationResult::AssociateWorkspaceApplicationResult()
{
}

AssociateWorkspaceApplicationResult::AssociateWorkspaceApplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
