...
DescribeApplicationAssociationsResult::DescribeApplicationAssociationsResult()
{
}

DescribeApplicationAssociationsResult::DescribeApplicationAssociationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DescribeApplicationAssociationsResult& DescribeApplicationAssociationsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
