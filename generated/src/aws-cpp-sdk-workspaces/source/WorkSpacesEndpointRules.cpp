...
{
const size_t WorkSpacesEndpointRules::RulesBlobStrLen = 3534;
const size_t WorkSpacesEndpointRules::RulesBlobSize = 3535;
...
'k','s','p','a','c','e','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'"','h','t','t','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','-','f','i','p','s','.',
...
'o','r','k','s','p','a','c','e','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
't','p','s',':','/','/','w','o','r','k','s','p','a','c','e','s','.','{','R','e','g','i','o','n','}',
