...
class AWS_WORKSPACES_API WorkSpacesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WorkSpacesClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<WorkSpacesEndpointProviderBase> endpointProvider = nullptr,
      const Aws::WorkSpaces::WorkSpacesClientConfiguration& clientConfiguration = Aws::WorkSpaces::WorkSpacesClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptAccountLinkInvitationOutcome AcceptAccountLinkInvitation(
      const Model::AcceptAccountLinkInvitationRequest& request) const;

  /**
   * A Callable wrapper for AcceptAccountLinkInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AcceptAccountLinkInvitationRequestT = Model::AcceptAccountLinkInvitationRequest>
  Model::AcceptAccountLinkInvitationOutcomeCallable AcceptAccountLinkInvitationCallable(
      const AcceptAccountLinkInvitationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::AcceptAccountLinkInvitation, request);
  }

  /**
   * An Async wrapper for AcceptAccountLinkInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptAccountLinkInvitationRequestT = Model::AcceptAccountLinkInvitationRequest>
  void AcceptAccountLinkInvitationAsync(const AcceptAccountLinkInvitationRequestT& request,
                                        const AcceptAccountLinkInvitationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateConnectionAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateConnectionAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateConnectionAliasRequestT = Model::AssociateConnectionAliasRequest>
  void AssociateConnectionAliasAsync(const AssociateConnectionAliasRequestT& request,
                                     const AssociateConnectionAliasResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateIpGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateIpGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateIpGroupsRequestT = Model::AssociateIpGroupsRequest>
  void AssociateIpGroupsAsync(const AssociateIpGroupsRequestT& request, const AssociateIpGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateWorkspaceApplicationOutcome AssociateWorkspaceApplication(
      const Model::AssociateWorkspaceApplicationRequest& request) const;

  /**
   * A Callable wrapper for AssociateWorkspaceApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateWorkspaceApplicationRequestT = Model::AssociateWorkspaceApplicationRequest>
  Model::AssociateWorkspaceApplicationOutcomeCallable AssociateWorkspaceApplicationCallable(
      const AssociateWorkspaceApplicationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::AssociateWorkspaceApplication, request);
  }

  /**
   * An Async wrapper for AssociateWorkspaceApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateWorkspaceApplicationRequestT = Model::AssociateWorkspaceApplicationRequest>
  void AssociateWorkspaceApplicationAsync(const AssociateWorkspaceApplicationRequestT& request,
                                          const AssociateWorkspaceApplicationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AuthorizeIpRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AuthorizeIpRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AuthorizeIpRulesRequestT = Model::AuthorizeIpRulesRequest>
  void AuthorizeIpRulesAsync(const AuthorizeIpRulesRequestT& request, const AuthorizeIpRulesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CopyWorkspaceImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CopyWorkspaceImage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CopyWorkspaceImageRequestT = Model::CopyWorkspaceImageRequest>
  void CopyWorkspaceImageAsync(const CopyWorkspaceImageRequestT& request, const CopyWorkspaceImageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAccountLinkInvitationOutcome CreateAccountLinkInvitation(
      const Model::CreateAccountLinkInvitationRequest& request) const;

  /**
   * A Callable wrapper for CreateAccountLinkInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAccountLinkInvitationRequestT = Model::CreateAccountLinkInvitationRequest>
  Model::CreateAccountLinkInvitationOutcomeCallable CreateAccountLinkInvitationCallable(
      const CreateAccountLinkInvitationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::CreateAccountLinkInvitation, request);
  }

  /**
   * An Async wrapper for CreateAccountLinkInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAccountLinkInvitationRequestT = Model::CreateAccountLinkInvitationRequest>
  void CreateAccountLinkInvitationAsync(const CreateAccountLinkInvitationRequestT& request,
                                        const CreateAccountLinkInvitationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConnectClientAddIn that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectClientAddIn that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectClientAddInRequestT = Model::CreateConnectClientAddInRequest>
  void CreateConnectClientAddInAsync(const CreateConnectClientAddInRequestT& request,
                                     const CreateConnectClientAddInResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConnectionAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectionAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectionAliasRequestT = Model::CreateConnectionAliasRequest>
  void CreateConnectionAliasAsync(const CreateConnectionAliasRequestT& request, const CreateConnectionAliasResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateIpGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateIpGroupRequestT = Model::CreateIpGroupRequest>
  void CreateIpGroupAsync(const CreateIpGroupRequestT& request, const CreateIpGroupResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStandbyWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStandbyWorkspaces that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStandbyWorkspacesRequestT = Model::CreateStandbyWorkspacesRequest>
  void CreateStandbyWorkspacesAsync(const CreateStandbyWorkspacesRequestT& request,
                                    const CreateStandbyWorkspacesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateUpdatedWorkspaceImageOutcome CreateUpdatedWorkspaceImage(
      const Model::CreateUpdatedWorkspaceImageRequest& request) const;

  /**
   * A Callable wrapper for CreateUpdatedWorkspaceImage that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateUpdatedWorkspaceImageRequestT = Model::CreateUpdatedWorkspaceImageRequest>
  Model::CreateUpdatedWorkspaceImageOutcomeCallable CreateUpdatedWorkspaceImageCallable(
      const CreateUpdatedWorkspaceImageRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::CreateUpdatedWorkspaceImage, request);
  }

  /**
   * An Async wrapper for CreateUpdatedWorkspaceImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateUpdatedWorkspaceImageRequestT = Model::CreateUpdatedWorkspaceImageRequest>
  void CreateUpdatedWorkspaceImageAsync(const CreateUpdatedWorkspaceImageRequestT& request,
                                        const CreateUpdatedWorkspaceImageResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkspaceBundle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkspaceBundle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkspaceBundleRequestT = Model::CreateWorkspaceBundleRequest>
  void CreateWorkspaceBundleAsync(const CreateWorkspaceBundleRequestT& request, const CreateWorkspaceBundleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkspaceImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkspaceImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkspaceImageRequestT = Model::CreateWorkspaceImageRequest>
  void CreateWorkspaceImageAsync(const CreateWorkspaceImageRequestT& request, const CreateWorkspaceImageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <code>PCOIP</code> protocol for Linux bundles because <code>DCV</code> (formerly
   * WSP) is the default protocol for those bundles.</p> </li> <li> <p>User-decoupled
   * WorkSpaces are only supported by Amazon WorkSpaces Core.</p> </li> <li>
   * <p>Review your running mode to ensure you are using one that is optimal for your
  ...
  /**
   * A Callable wrapper for CreateWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkspaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateWorkspacesRequestT = Model::CreateWorkspacesRequest>
  void CreateWorkspacesAsync(const CreateWorkspacesRequestT& request, const CreateWorkspacesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorkspacesPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateWorkspacesPoolRequestT = Model::CreateWorkspacesPoolRequest>
  Model::CreateWorkspacesPoolOutcomeCallable CreateWorkspacesPoolCallable(const CreateWorkspacesPoolRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::CreateWorkspacesPool, request);
  }

  /**
   * An Async wrapper for CreateWorkspacesPool that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorkspacesPoolRequestT = Model::CreateWorkspacesPoolRequest>
  void CreateWorkspacesPoolAsync(const CreateWorkspacesPoolRequestT& request, const CreateWorkspacesPoolResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::CreateWorkspacesPool, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAccountLinkInvitationOutcome DeleteAccountLinkInvitation(
      const Model::DeleteAccountLinkInvitationRequest& request) const;

  /**
   * A Callable wrapper for DeleteAccountLinkInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAccountLinkInvitationRequestT = Model::DeleteAccountLinkInvitationRequest>
  Model::DeleteAccountLinkInvitationOutcomeCallable DeleteAccountLinkInvitationCallable(
      const DeleteAccountLinkInvitationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DeleteAccountLinkInvitation, request);
  }

  /**
   * An Async wrapper for DeleteAccountLinkInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAccountLinkInvitationRequestT = Model::DeleteAccountLinkInvitationRequest>
  void DeleteAccountLinkInvitationAsync(const DeleteAccountLinkInvitationRequestT& request,
                                        const DeleteAccountLinkInvitationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteClientBranding that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClientBranding that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClientBrandingRequestT = Model::DeleteClientBrandingRequest>
  void DeleteClientBrandingAsync(const DeleteClientBrandingRequestT& request, const DeleteClientBrandingResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConnectClientAddIn that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConnectClientAddIn that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConnectClientAddInRequestT = Model::DeleteConnectClientAddInRequest>
  void DeleteConnectClientAddInAsync(const DeleteConnectClientAddInRequestT& request,
                                     const DeleteConnectClientAddInResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConnectionAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConnectionAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConnectionAliasRequestT = Model::DeleteConnectionAliasRequest>
  void DeleteConnectionAliasAsync(const DeleteConnectionAliasRequestT& request, const DeleteConnectionAliasResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteIpGroup that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteIpGroupRequestT = Model::DeleteIpGroupRequest>
  void DeleteIpGroupAsync(const DeleteIpGroupRequestT& request, const DeleteIpGroupResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkspaceBundle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkspaceBundle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkspaceBundleRequestT = Model::DeleteWorkspaceBundleRequest>
  void DeleteWorkspaceBundleAsync(const DeleteWorkspaceBundleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DeleteWorkspaceBundleRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteWorkspaceImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkspaceImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWorkspaceImageRequestT = Model::DeleteWorkspaceImageRequest>
  void DeleteWorkspaceImageAsync(const DeleteWorkspaceImageRequestT& request, const DeleteWorkspaceImageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeployWorkspaceApplicationsOutcome DeployWorkspaceApplications(
      const Model::DeployWorkspaceApplicationsRequest& request) const;

  /**
   * A Callable wrapper for DeployWorkspaceApplications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeployWorkspaceApplicationsRequestT = Model::DeployWorkspaceApplicationsRequest>
  Model::DeployWorkspaceApplicationsOutcomeCallable DeployWorkspaceApplicationsCallable(
      const DeployWorkspaceApplicationsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DeployWorkspaceApplications, request);
  }

  /**
   * An Async wrapper for DeployWorkspaceApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeployWorkspaceApplicationsRequestT = Model::DeployWorkspaceApplicationsRequest>
  void DeployWorkspaceApplicationsAsync(const DeployWorkspaceApplicationsRequestT& request,
                                        const DeployWorkspaceApplicationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterWorkspaceDirectoryOutcome DeregisterWorkspaceDirectory(
      const Model::DeregisterWorkspaceDirectoryRequest& request) const;

  /**
   * A Callable wrapper for DeregisterWorkspaceDirectory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterWorkspaceDirectoryRequestT = Model::DeregisterWorkspaceDirectoryRequest>
  Model::DeregisterWorkspaceDirectoryOutcomeCallable DeregisterWorkspaceDirectoryCallable(
      const DeregisterWorkspaceDirectoryRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DeregisterWorkspaceDirectory, request);
  }

  /**
   * An Async wrapper for DeregisterWorkspaceDirectory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterWorkspaceDirectoryRequestT = Model::DeregisterWorkspaceDirectoryRequest>
  void DeregisterWorkspaceDirectoryAsync(const DeregisterWorkspaceDirectoryRequestT& request,
                                         const DeregisterWorkspaceDirectoryResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAccount that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAccountRequestT = Model::DescribeAccountRequest>
  void DescribeAccountAsync(const DescribeAccountResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccountModificationsOutcome DescribeAccountModifications(
      const Model::DescribeAccountModificationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAccountModifications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAccountModificationsRequestT = Model::DescribeAccountModificationsRequest>
  Model::DescribeAccountModificationsOutcomeCallable DescribeAccountModificationsCallable(
      const DescribeAccountModificationsRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeAccountModifications, request);
  }

  /**
   * An Async wrapper for DescribeAccountModifications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountModificationsRequestT = Model::DescribeAccountModificationsRequest>
  void DescribeAccountModificationsAsync(const DescribeAccountModificationsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeAccountModificationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicationAssociationsOutcome DescribeApplicationAssociations(
      const Model::DescribeApplicationAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeApplicationAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeApplicationAssociationsRequestT = Model::DescribeApplicationAssociationsRequest>
  Model::DescribeApplicationAssociationsOutcomeCallable DescribeApplicationAssociationsCallable(
      const DescribeApplicationAssociationsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeApplicationAssociations, request);
  }

  /**
   * An Async wrapper for DescribeApplicationAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeApplicationAssociationsRequestT = Model::DescribeApplicationAssociationsRequest>
  void DescribeApplicationAssociationsAsync(const DescribeApplicationAssociationsRequestT& request,
                                            const DescribeApplicationAssociationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeBundleAssociationsOutcome DescribeBundleAssociations(
      const Model::DescribeBundleAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeBundleAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeBundleAssociationsRequestT = Model::DescribeBundleAssociationsRequest>
  Model::DescribeBundleAssociationsOutcomeCallable DescribeBundleAssociationsCallable(
      const DescribeBundleAssociationsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeBundleAssociations, request);
  }

  /**
   * An Async wrapper for DescribeBundleAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBundleAssociationsRequestT = Model::DescribeBundleAssociationsRequest>
  void DescribeBundleAssociationsAsync(const DescribeBundleAssociationsRequestT& request,
                                       const DescribeBundleAssociationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeClientBranding that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClientBranding that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClientBrandingRequestT = Model::DescribeClientBrandingRequest>
  void DescribeClientBrandingAsync(const DescribeClientBrandingRequestT& request,
                                   const DescribeClientBrandingResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeClientProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClientProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClientPropertiesRequestT = Model::DescribeClientPropertiesRequest>
  void DescribeClientPropertiesAsync(const DescribeClientPropertiesRequestT& request,
                                     const DescribeClientPropertiesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConnectClientAddInsOutcome DescribeConnectClientAddIns(
      const Model::DescribeConnectClientAddInsRequest& request) const;

  /**
   * A Callable wrapper for DescribeConnectClientAddIns that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeConnectClientAddInsRequestT = Model::DescribeConnectClientAddInsRequest>
  Model::DescribeConnectClientAddInsOutcomeCallable DescribeConnectClientAddInsCallable(
      const DescribeConnectClientAddInsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeConnectClientAddIns, request);
  }

  /**
   * An Async wrapper for DescribeConnectClientAddIns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectClientAddInsRequestT = Model::DescribeConnectClientAddInsRequest>
  void DescribeConnectClientAddInsAsync(const DescribeConnectClientAddInsRequestT& request,
                                        const DescribeConnectClientAddInsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConnectionAliasPermissionsOutcome DescribeConnectionAliasPermissions(
      const Model::DescribeConnectionAliasPermissionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeConnectionAliasPermissions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeConnectionAliasPermissionsRequestT = Model::DescribeConnectionAliasPermissionsRequest>
  Model::DescribeConnectionAliasPermissionsOutcomeCallable DescribeConnectionAliasPermissionsCallable(
      const DescribeConnectionAliasPermissionsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeConnectionAliasPermissions, request);
  }

  /**
   * An Async wrapper for DescribeConnectionAliasPermissions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeConnectionAliasPermissionsRequestT = Model::DescribeConnectionAliasPermissionsRequest>
  void DescribeConnectionAliasPermissionsAsync(const DescribeConnectionAliasPermissionsRequestT& request,
                                               const DescribeConnectionAliasPermissionsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeConnectionAliasesOutcome DescribeConnectionAliases(
      const Model::DescribeConnectionAliasesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeConnectionAliases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeConnectionAliasesRequestT = Model::DescribeConnectionAliasesRequest>
  Model::DescribeConnectionAliasesOutcomeCallable DescribeConnectionAliasesCallable(
      const DescribeConnectionAliasesRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeConnectionAliases, request);
  }

  /**
   * An Async wrapper for DescribeConnectionAliases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectionAliasesRequestT = Model::DescribeConnectionAliasesRequest>
  void DescribeConnectionAliasesAsync(const DescribeConnectionAliasesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeConnectionAliasesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomWorkspaceImageImportOutcome DescribeCustomWorkspaceImageImport(
      const Model::DescribeCustomWorkspaceImageImportRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomWorkspaceImageImport that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeCustomWorkspaceImageImportRequestT = Model::DescribeCustomWorkspaceImageImportRequest>
  Model::DescribeCustomWorkspaceImageImportOutcomeCallable DescribeCustomWorkspaceImageImportCallable(
      const DescribeCustomWorkspaceImageImportRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeCustomWorkspaceImageImport, request);
  }

  /**
   * An Async wrapper for DescribeCustomWorkspaceImageImport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCustomWorkspaceImageImportRequestT = Model::DescribeCustomWorkspaceImageImportRequest>
  void DescribeCustomWorkspaceImageImportAsync(const DescribeCustomWorkspaceImageImportRequestT& request,
                                               const DescribeCustomWorkspaceImageImportResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeImageAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeImageAssociationsRequestT = Model::DescribeImageAssociationsRequest>
  Model::DescribeImageAssociationsOutcomeCallable DescribeImageAssociationsCallable(
      const DescribeImageAssociationsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeImageAssociations, request);
  }

  /**
   * An Async wrapper for DescribeImageAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeImageAssociationsRequestT = Model::DescribeImageAssociationsRequest>
  void DescribeImageAssociationsAsync(const DescribeImageAssociationsRequestT& request,
                                      const DescribeImageAssociationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeIpGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIpGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeIpGroupsRequestT = Model::DescribeIpGroupsRequest>
  void DescribeIpGroupsAsync(const DescribeIpGroupsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeIpGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspaceAssociationsOutcome DescribeWorkspaceAssociations(
      const Model::DescribeWorkspaceAssociationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorkspaceAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorkspaceAssociationsRequestT = Model::DescribeWorkspaceAssociationsRequest>
  Model::DescribeWorkspaceAssociationsOutcomeCallable DescribeWorkspaceAssociationsCallable(
      const DescribeWorkspaceAssociationsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspaceAssociations, request);
  }

  /**
   * An Async wrapper for DescribeWorkspaceAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspaceAssociationsRequestT = Model::DescribeWorkspaceAssociationsRequest>
  void DescribeWorkspaceAssociationsAsync(const DescribeWorkspaceAssociationsRequestT& request,
                                          const DescribeWorkspaceAssociationsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkspaceBundles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeWorkspaceBundlesRequestT = Model::DescribeWorkspaceBundlesRequest>
  Model::DescribeWorkspaceBundlesOutcomeCallable DescribeWorkspaceBundlesCallable(
      const DescribeWorkspaceBundlesRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspaceBundles, request);
  }

  /**
   * An Async wrapper for DescribeWorkspaceBundles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspaceBundlesRequestT = Model::DescribeWorkspaceBundlesRequest>
  void DescribeWorkspaceBundlesAsync(const DescribeWorkspaceBundlesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeWorkspaceBundlesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspaceDirectoriesOutcome DescribeWorkspaceDirectories(
      const Model::DescribeWorkspaceDirectoriesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeWorkspaceDirectories that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorkspaceDirectoriesRequestT = Model::DescribeWorkspaceDirectoriesRequest>
  Model::DescribeWorkspaceDirectoriesOutcomeCallable DescribeWorkspaceDirectoriesCallable(
      const DescribeWorkspaceDirectoriesRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspaceDirectories, request);
  }

  /**
   * An Async wrapper for DescribeWorkspaceDirectories that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspaceDirectoriesRequestT = Model::DescribeWorkspaceDirectoriesRequest>
  void DescribeWorkspaceDirectoriesAsync(const DescribeWorkspaceDirectoriesResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const DescribeWorkspaceDirectoriesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspaceImagePermissionsOutcome DescribeWorkspaceImagePermissions(
      const Model::DescribeWorkspaceImagePermissionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorkspaceImagePermissions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeWorkspaceImagePermissionsRequestT = Model::DescribeWorkspaceImagePermissionsRequest>
  Model::DescribeWorkspaceImagePermissionsOutcomeCallable DescribeWorkspaceImagePermissionsCallable(
      const DescribeWorkspaceImagePermissionsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspaceImagePermissions, request);
  }

  /**
   * An Async wrapper for DescribeWorkspaceImagePermissions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeWorkspaceImagePermissionsRequestT = Model::DescribeWorkspaceImagePermissionsRequest>
  void DescribeWorkspaceImagePermissionsAsync(const DescribeWorkspaceImagePermissionsRequestT& request,
                                              const DescribeWorkspaceImagePermissionsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkspaceImages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkspaceImages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspaceImagesRequestT = Model::DescribeWorkspaceImagesRequest>
  void DescribeWorkspaceImagesAsync(const DescribeWorkspaceImagesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeWorkspaceImagesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspaceSnapshotsOutcome DescribeWorkspaceSnapshots(
      const Model::DescribeWorkspaceSnapshotsRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorkspaceSnapshots that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorkspaceSnapshotsRequestT = Model::DescribeWorkspaceSnapshotsRequest>
  Model::DescribeWorkspaceSnapshotsOutcomeCallable DescribeWorkspaceSnapshotsCallable(
      const DescribeWorkspaceSnapshotsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspaceSnapshots, request);
  }

  /**
   * An Async wrapper for DescribeWorkspaceSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspaceSnapshotsRequestT = Model::DescribeWorkspaceSnapshotsRequest>
  void DescribeWorkspaceSnapshotsAsync(const DescribeWorkspaceSnapshotsRequestT& request,
                                       const DescribeWorkspaceSnapshotsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkspaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWorkspacesRequestT = Model::DescribeWorkspacesRequest>
  void DescribeWorkspacesAsync(const DescribeWorkspacesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeWorkspacesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspacesConnectionStatusOutcome DescribeWorkspacesConnectionStatus(
      const Model::DescribeWorkspacesConnectionStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeWorkspacesConnectionStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeWorkspacesConnectionStatusRequestT = Model::DescribeWorkspacesConnectionStatusRequest>
  Model::DescribeWorkspacesConnectionStatusOutcomeCallable DescribeWorkspacesConnectionStatusCallable(
      const DescribeWorkspacesConnectionStatusRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspacesConnectionStatus, request);
  }

  /**
   * An Async wrapper for DescribeWorkspacesConnectionStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeWorkspacesConnectionStatusRequestT = Model::DescribeWorkspacesConnectionStatusRequest>
  void DescribeWorkspacesConnectionStatusAsync(const DescribeWorkspacesConnectionStatusResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeWorkspacesConnectionStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorkspacesPoolSessionsOutcome DescribeWorkspacesPoolSessions(
      const Model::DescribeWorkspacesPoolSessionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorkspacesPoolSessions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorkspacesPoolSessionsRequestT = Model::DescribeWorkspacesPoolSessionsRequest>
  Model::DescribeWorkspacesPoolSessionsOutcomeCallable DescribeWorkspacesPoolSessionsCallable(
      const DescribeWorkspacesPoolSessionsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspacesPoolSessions, request);
  }

  /**
   * An Async wrapper for DescribeWorkspacesPoolSessions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeWorkspacesPoolSessionsRequestT = Model::DescribeWorkspacesPoolSessionsRequest>
  void DescribeWorkspacesPoolSessionsAsync(const DescribeWorkspacesPoolSessionsRequestT& request,
                                           const DescribeWorkspacesPoolSessionsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::DescribeWorkspacesPoolSessions, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for DescribeWorkspacesPools that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeWorkspacesPoolsRequestT = Model::DescribeWorkspacesPoolsRequest>
  Model::DescribeWorkspacesPoolsOutcomeCallable DescribeWorkspacesPoolsCallable(const DescribeWorkspacesPoolsRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::DescribeWorkspacesPools, request);
  }

  /**
   * An Async wrapper for DescribeWorkspacesPools that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorkspacesPoolsRequestT = Model::DescribeWorkspacesPoolsRequest>
  void DescribeWorkspacesPoolsAsync(const DescribeWorkspacesPoolsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeWorkspacesPoolsRequestT& request = {}) const {
    return SubmitAsync(&WorkSpacesClient::DescribeWorkspacesPools, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateConnectionAliasOutcome DisassociateConnectionAlias(
      const Model::DisassociateConnectionAliasRequest& request) const;

  /**
   * A Callable wrapper for DisassociateConnectionAlias that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateConnectionAliasRequestT = Model::DisassociateConnectionAliasRequest>
  Model::DisassociateConnectionAliasOutcomeCallable DisassociateConnectionAliasCallable(
      const DisassociateConnectionAliasRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DisassociateConnectionAlias, request);
  }

  /**
   * An Async wrapper for DisassociateConnectionAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateConnectionAliasRequestT = Model::DisassociateConnectionAliasRequest>
  void DisassociateConnectionAliasAsync(const DisassociateConnectionAliasRequestT& request,
                                        const DisassociateConnectionAliasResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateIpGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateIpGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateIpGroupsRequestT = Model::DisassociateIpGroupsRequest>
  void DisassociateIpGroupsAsync(const DisassociateIpGroupsRequestT& request, const DisassociateIpGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateWorkspaceApplicationOutcome DisassociateWorkspaceApplication(
      const Model::DisassociateWorkspaceApplicationRequest& request) const;

  /**
   * A Callable wrapper for DisassociateWorkspaceApplication that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DisassociateWorkspaceApplicationRequestT = Model::DisassociateWorkspaceApplicationRequest>
  Model::DisassociateWorkspaceApplicationOutcomeCallable DisassociateWorkspaceApplicationCallable(
      const DisassociateWorkspaceApplicationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::DisassociateWorkspaceApplication, request);
  }

  /**
   * An Async wrapper for DisassociateWorkspaceApplication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateWorkspaceApplicationRequestT = Model::DisassociateWorkspaceApplicationRequest>
  void DisassociateWorkspaceApplicationAsync(const DisassociateWorkspaceApplicationRequestT& request,
                                             const DisassociateWorkspaceApplicationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAccountLink that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAccountLinkRequestT = Model::GetAccountLinkRequest>
  void GetAccountLinkAsync(const GetAccountLinkResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetAccountLinkRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ImportClientBranding that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportClientBranding that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportClientBrandingRequestT = Model::ImportClientBrandingRequest>
  void ImportClientBrandingAsync(const ImportClientBrandingRequestT& request, const ImportClientBrandingResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ImportCustomWorkspaceImageOutcome ImportCustomWorkspaceImage(
      const Model::ImportCustomWorkspaceImageRequest& request) const;

  /**
   * A Callable wrapper for ImportCustomWorkspaceImage that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ImportCustomWorkspaceImageRequestT = Model::ImportCustomWorkspaceImageRequest>
  Model::ImportCustomWorkspaceImageOutcomeCallable ImportCustomWorkspaceImageCallable(
      const ImportCustomWorkspaceImageRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ImportCustomWorkspaceImage, request);
  }

  /**
   * An Async wrapper for ImportCustomWorkspaceImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportCustomWorkspaceImageRequestT = Model::ImportCustomWorkspaceImageRequest>
  void ImportCustomWorkspaceImageAsync(const ImportCustomWorkspaceImageRequestT& request,
                                       const ImportCustomWorkspaceImageResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportWorkspaceImage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportWorkspaceImage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ImportWorkspaceImageRequestT = Model::ImportWorkspaceImageRequest>
  void ImportWorkspaceImageAsync(const ImportWorkspaceImageRequestT& request, const ImportWorkspaceImageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountLinks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountLinks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccountLinksRequestT = Model::ListAccountLinksRequest>
  void ListAccountLinksAsync(const ListAccountLinksResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListAccountLinksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableManagementCidrRangesOutcome ListAvailableManagementCidrRanges(
      const Model::ListAvailableManagementCidrRangesRequest& request) const;

  /**
   * A Callable wrapper for ListAvailableManagementCidrRanges that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAvailableManagementCidrRangesRequestT = Model::ListAvailableManagementCidrRangesRequest>
  Model::ListAvailableManagementCidrRangesOutcomeCallable ListAvailableManagementCidrRangesCallable(
      const ListAvailableManagementCidrRangesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ListAvailableManagementCidrRanges, request);
  }

  /**
   * An Async wrapper for ListAvailableManagementCidrRanges that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAvailableManagementCidrRangesRequestT = Model::ListAvailableManagementCidrRangesRequest>
  void ListAvailableManagementCidrRangesAsync(const ListAvailableManagementCidrRangesRequestT& request,
                                              const ListAvailableManagementCidrRangesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for MigrateWorkspace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for MigrateWorkspace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename MigrateWorkspaceRequestT = Model::MigrateWorkspaceRequest>
  void MigrateWorkspaceAsync(const MigrateWorkspaceRequestT& request, const MigrateWorkspaceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyAccount that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyAccountRequestT = Model::ModifyAccountRequest>
  void ModifyAccountAsync(const ModifyAccountResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ModifyAccountRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyCertificateBasedAuthPropertiesOutcome ModifyCertificateBasedAuthProperties(
      const Model::ModifyCertificateBasedAuthPropertiesRequest& request) const;

  /**
   * A Callable wrapper for ModifyCertificateBasedAuthProperties that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ModifyCertificateBasedAuthPropertiesRequestT = Model::ModifyCertificateBasedAuthPropertiesRequest>
  Model::ModifyCertificateBasedAuthPropertiesOutcomeCallable ModifyCertificateBasedAuthPropertiesCallable(
      const ModifyCertificateBasedAuthPropertiesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyCertificateBasedAuthProperties, request);
  }

  /**
   * An Async wrapper for ModifyCertificateBasedAuthProperties that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ModifyCertificateBasedAuthPropertiesRequestT = Model::ModifyCertificateBasedAuthPropertiesRequest>
  void ModifyCertificateBasedAuthPropertiesAsync(const ModifyCertificateBasedAuthPropertiesRequestT& request,
                                                 const ModifyCertificateBasedAuthPropertiesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyClientProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClientProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClientPropertiesRequestT = Model::ModifyClientPropertiesRequest>
  void ModifyClientPropertiesAsync(const ModifyClientPropertiesRequestT& request,
                                   const ModifyClientPropertiesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyEndpointEncryptionModeOutcome ModifyEndpointEncryptionMode(
      const Model::ModifyEndpointEncryptionModeRequest& request) const;

  /**
   * A Callable wrapper for ModifyEndpointEncryptionMode that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyEndpointEncryptionModeRequestT = Model::ModifyEndpointEncryptionModeRequest>
  Model::ModifyEndpointEncryptionModeOutcomeCallable ModifyEndpointEncryptionModeCallable(
      const ModifyEndpointEncryptionModeRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyEndpointEncryptionMode, request);
  }

  /**
   * An Async wrapper for ModifyEndpointEncryptionMode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyEndpointEncryptionModeRequestT = Model::ModifyEndpointEncryptionModeRequest>
  void ModifyEndpointEncryptionModeAsync(const ModifyEndpointEncryptionModeRequestT& request,
                                         const ModifyEndpointEncryptionModeResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifySamlProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifySamlProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifySamlPropertiesRequestT = Model::ModifySamlPropertiesRequest>
  void ModifySamlPropertiesAsync(const ModifySamlPropertiesRequestT& request, const ModifySamlPropertiesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifySelfservicePermissionsOutcome ModifySelfservicePermissions(
      const Model::ModifySelfservicePermissionsRequest& request) const;

  /**
   * A Callable wrapper for ModifySelfservicePermissions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifySelfservicePermissionsRequestT = Model::ModifySelfservicePermissionsRequest>
  Model::ModifySelfservicePermissionsOutcomeCallable ModifySelfservicePermissionsCallable(
      const ModifySelfservicePermissionsRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifySelfservicePermissions, request);
  }

  /**
   * An Async wrapper for ModifySelfservicePermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifySelfservicePermissionsRequestT = Model::ModifySelfservicePermissionsRequest>
  void ModifySelfservicePermissionsAsync(const ModifySelfservicePermissionsRequestT& request,
                                         const ModifySelfservicePermissionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::ModifySelfservicePermissions, request, handler, context);
  }

  /**
   * <p>Modifies the specified streaming properties.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/ModifyStreamingProperties">AWS
   * API Reference</a></p>
   */
  ...
  /**
   * A Callable wrapper for ModifyStreamingProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyStreamingPropertiesRequestT = Model::ModifyStreamingPropertiesRequest>
  Model::ModifyStreamingPropertiesOutcomeCallable ModifyStreamingPropertiesCallable(
      const ModifyStreamingPropertiesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyStreamingProperties, request);
  }

  /**
   * An Async wrapper for ModifyStreamingProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyStreamingPropertiesRequestT = Model::ModifyStreamingPropertiesRequest>
  void ModifyStreamingPropertiesAsync(const ModifyStreamingPropertiesRequestT& request,
                                      const ModifyStreamingPropertiesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::ModifyStreamingProperties, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyWorkspaceAccessPropertiesOutcome ModifyWorkspaceAccessProperties(
      const Model::ModifyWorkspaceAccessPropertiesRequest& request) const;

  /**
   * A Callable wrapper for ModifyWorkspaceAccessProperties that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyWorkspaceAccessPropertiesRequestT = Model::ModifyWorkspaceAccessPropertiesRequest>
  Model::ModifyWorkspaceAccessPropertiesOutcomeCallable ModifyWorkspaceAccessPropertiesCallable(
      const ModifyWorkspaceAccessPropertiesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyWorkspaceAccessProperties, request);
  }

  /**
   * An Async wrapper for ModifyWorkspaceAccessProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ModifyWorkspaceAccessPropertiesRequestT = Model::ModifyWorkspaceAccessPropertiesRequest>
  void ModifyWorkspaceAccessPropertiesAsync(const ModifyWorkspaceAccessPropertiesRequestT& request,
                                            const ModifyWorkspaceAccessPropertiesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyWorkspaceCreationPropertiesOutcome ModifyWorkspaceCreationProperties(
      const Model::ModifyWorkspaceCreationPropertiesRequest& request) const;

  /**
   * A Callable wrapper for ModifyWorkspaceCreationProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ModifyWorkspaceCreationPropertiesRequestT = Model::ModifyWorkspaceCreationPropertiesRequest>
  Model::ModifyWorkspaceCreationPropertiesOutcomeCallable ModifyWorkspaceCreationPropertiesCallable(
      const ModifyWorkspaceCreationPropertiesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyWorkspaceCreationProperties, request);
  }

  /**
   * An Async wrapper for ModifyWorkspaceCreationProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ModifyWorkspaceCreationPropertiesRequestT = Model::ModifyWorkspaceCreationPropertiesRequest>
  void ModifyWorkspaceCreationPropertiesAsync(const ModifyWorkspaceCreationPropertiesRequestT& request,
                                              const ModifyWorkspaceCreationPropertiesResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyWorkspaceProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ModifyWorkspacePropertiesRequestT = Model::ModifyWorkspacePropertiesRequest>
  Model::ModifyWorkspacePropertiesOutcomeCallable ModifyWorkspacePropertiesCallable(
      const ModifyWorkspacePropertiesRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::ModifyWorkspaceProperties, request);
  }

  /**
   * An Async wrapper for ModifyWorkspaceProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyWorkspacePropertiesRequestT = Model::ModifyWorkspacePropertiesRequest>
  void ModifyWorkspacePropertiesAsync(const ModifyWorkspacePropertiesRequestT& request,
                                      const ModifyWorkspacePropertiesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyWorkspaceState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyWorkspaceState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyWorkspaceStateRequestT = Model::ModifyWorkspaceStateRequest>
  void ModifyWorkspaceStateAsync(const ModifyWorkspaceStateRequestT& request, const ModifyWorkspaceStateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RebootWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebootWorkspaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebootWorkspacesRequestT = Model::RebootWorkspacesRequest>
  void RebootWorkspacesAsync(const RebootWorkspacesRequestT& request, const RebootWorkspacesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RebuildWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RebuildWorkspaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RebuildWorkspacesRequestT = Model::RebuildWorkspacesRequest>
  void RebuildWorkspacesAsync(const RebuildWorkspacesRequestT& request, const RebuildWorkspacesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterWorkspaceDirectoryOutcome RegisterWorkspaceDirectory(
      const Model::RegisterWorkspaceDirectoryRequest& request = {}) const;

  /**
   * A Callable wrapper for RegisterWorkspaceDirectory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterWorkspaceDirectoryRequestT = Model::RegisterWorkspaceDirectoryRequest>
  Model::RegisterWorkspaceDirectoryOutcomeCallable RegisterWorkspaceDirectoryCallable(
      const RegisterWorkspaceDirectoryRequestT& request = {}) const {
    return SubmitCallable(&WorkSpacesClient::RegisterWorkspaceDirectory, request);
  }

  /**
   * An Async wrapper for RegisterWorkspaceDirectory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterWorkspaceDirectoryRequestT = Model::RegisterWorkspaceDirectoryRequest>
  void RegisterWorkspaceDirectoryAsync(const RegisterWorkspaceDirectoryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const RegisterWorkspaceDirectoryRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RejectAccountLinkInvitationOutcome RejectAccountLinkInvitation(
      const Model::RejectAccountLinkInvitationRequest& request) const;

  /**
   * A Callable wrapper for RejectAccountLinkInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RejectAccountLinkInvitationRequestT = Model::RejectAccountLinkInvitationRequest>
  Model::RejectAccountLinkInvitationOutcomeCallable RejectAccountLinkInvitationCallable(
      const RejectAccountLinkInvitationRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::RejectAccountLinkInvitation, request);
  }

  /**
   * An Async wrapper for RejectAccountLinkInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectAccountLinkInvitationRequestT = Model::RejectAccountLinkInvitationRequest>
  void RejectAccountLinkInvitationAsync(const RejectAccountLinkInvitationRequestT& request,
                                        const RejectAccountLinkInvitationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RestoreWorkspace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestoreWorkspace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RestoreWorkspaceRequestT = Model::RestoreWorkspaceRequest>
  void RestoreWorkspaceAsync(const RestoreWorkspaceRequestT& request, const RestoreWorkspaceResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RevokeIpRules that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RevokeIpRulesRequestT = Model::RevokeIpRulesRequest>
  void RevokeIpRulesAsync(const RevokeIpRulesRequestT& request, const RevokeIpRulesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartWorkspaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartWorkspacesRequestT = Model::StartWorkspacesRequest>
  void StartWorkspacesAsync(const StartWorkspacesRequestT& request, const StartWorkspacesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartWorkspacesPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartWorkspacesPoolRequestT = Model::StartWorkspacesPoolRequest>
  Model::StartWorkspacesPoolOutcomeCallable StartWorkspacesPoolCallable(const StartWorkspacesPoolRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::StartWorkspacesPool, request);
  }

  /**
   * An Async wrapper for StartWorkspacesPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartWorkspacesPoolRequestT = Model::StartWorkspacesPoolRequest>
  void StartWorkspacesPoolAsync(const StartWorkspacesPoolRequestT& request, const StartWorkspacesPoolResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::StartWorkspacesPool, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for StopWorkspaces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopWorkspacesRequestT = Model::StopWorkspacesRequest>
  void StopWorkspacesAsync(const StopWorkspacesRequestT& request, const StopWorkspacesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopWorkspacesPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StopWorkspacesPoolRequestT = Model::StopWorkspacesPoolRequest>
  Model::StopWorkspacesPoolOutcomeCallable StopWorkspacesPoolCallable(const StopWorkspacesPoolRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::StopWorkspacesPool, request);
  }

  /**
   * An Async wrapper for StopWorkspacesPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopWorkspacesPoolRequestT = Model::StopWorkspacesPoolRequest>
  void StopWorkspacesPoolAsync(const StopWorkspacesPoolRequestT& request, const StopWorkspacesPoolResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::StopWorkspacesPool, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for TerminateWorkspaces that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TerminateWorkspaces that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TerminateWorkspacesRequestT = Model::TerminateWorkspacesRequest>
  void TerminateWorkspacesAsync(const TerminateWorkspacesRequestT& request, const TerminateWorkspacesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for TerminateWorkspacesPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename TerminateWorkspacesPoolRequestT = Model::TerminateWorkspacesPoolRequest>
  Model::TerminateWorkspacesPoolOutcomeCallable TerminateWorkspacesPoolCallable(const TerminateWorkspacesPoolRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::TerminateWorkspacesPool, request);
  }

  /**
   * An Async wrapper for TerminateWorkspacesPool that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename TerminateWorkspacesPoolRequestT = Model::TerminateWorkspacesPoolRequest>
  void TerminateWorkspacesPoolAsync(const TerminateWorkspacesPoolRequestT& request,
                                    const TerminateWorkspacesPoolResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::TerminateWorkspacesPool, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::TerminateWorkspacesPoolSessionOutcome TerminateWorkspacesPoolSession(
      const Model::TerminateWorkspacesPoolSessionRequest& request) const;

  /**
   * A Callable wrapper for TerminateWorkspacesPoolSession that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename TerminateWorkspacesPoolSessionRequestT = Model::TerminateWorkspacesPoolSessionRequest>
  Model::TerminateWorkspacesPoolSessionOutcomeCallable TerminateWorkspacesPoolSessionCallable(
      const TerminateWorkspacesPoolSessionRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::TerminateWorkspacesPoolSession, request);
  }

  /**
   * An Async wrapper for TerminateWorkspacesPoolSession that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename TerminateWorkspacesPoolSessionRequestT = Model::TerminateWorkspacesPoolSessionRequest>
  void TerminateWorkspacesPoolSessionAsync(const TerminateWorkspacesPoolSessionRequestT& request,
                                           const TerminateWorkspacesPoolSessionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&WorkSpacesClient::TerminateWorkspacesPoolSession, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for UpdateConnectClientAddIn that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConnectClientAddIn that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConnectClientAddInRequestT = Model::UpdateConnectClientAddInRequest>
  void UpdateConnectClientAddInAsync(const UpdateConnectClientAddInRequestT& request,
                                     const UpdateConnectClientAddInResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConnectionAliasPermissionOutcome UpdateConnectionAliasPermission(
      const Model::UpdateConnectionAliasPermissionRequest& request) const;

  /**
   * A Callable wrapper for UpdateConnectionAliasPermission that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConnectionAliasPermissionRequestT = Model::UpdateConnectionAliasPermissionRequest>
  Model::UpdateConnectionAliasPermissionOutcomeCallable UpdateConnectionAliasPermissionCallable(
      const UpdateConnectionAliasPermissionRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::UpdateConnectionAliasPermission, request);
  }

  /**
   * An Async wrapper for UpdateConnectionAliasPermission that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateConnectionAliasPermissionRequestT = Model::UpdateConnectionAliasPermissionRequest>
  void UpdateConnectionAliasPermissionAsync(const UpdateConnectionAliasPermissionRequestT& request,
                                            const UpdateConnectionAliasPermissionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRulesOfIpGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRulesOfIpGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRulesOfIpGroupRequestT = Model::UpdateRulesOfIpGroupRequest>
  void UpdateRulesOfIpGroupAsync(const UpdateRulesOfIpGroupRequestT& request, const UpdateRulesOfIpGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkspaceBundle that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorkspaceBundle that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWorkspaceBundleRequestT = Model::UpdateWorkspaceBundleRequest>
  void UpdateWorkspaceBundleAsync(const UpdateWorkspaceBundleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const UpdateWorkspaceBundleRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateWorkspaceImagePermissionOutcome UpdateWorkspaceImagePermission(
      const Model::UpdateWorkspaceImagePermissionRequest& request) const;

  /**
   * A Callable wrapper for UpdateWorkspaceImagePermission that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateWorkspaceImagePermissionRequestT = Model::UpdateWorkspaceImagePermissionRequest>
  Model::UpdateWorkspaceImagePermissionOutcomeCallable UpdateWorkspaceImagePermissionCallable(
      const UpdateWorkspaceImagePermissionRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::UpdateWorkspaceImagePermission, request);
  }

  /**
   * An Async wrapper for UpdateWorkspaceImagePermission that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateWorkspaceImagePermissionRequestT = Model::UpdateWorkspaceImagePermissionRequest>
  void UpdateWorkspaceImagePermissionAsync(const UpdateWorkspaceImagePermissionRequestT& request,
                                           const UpdateWorkspaceImagePermissionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateWorkspacesPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateWorkspacesPoolRequestT = Model::UpdateWorkspacesPoolRequest>
  Model::UpdateWorkspacesPoolOutcomeCallable UpdateWorkspacesPoolCallable(const UpdateWorkspacesPoolRequestT& request) const {
    return SubmitCallable(&WorkSpacesClient::UpdateWorkspacesPool, request);
  }

  /**
   * An Async wrapper for UpdateWorkspacesPool that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateWorkspacesPoolRequestT = Model::UpdateWorkspacesPoolRequest>
  void UpdateWorkspacesPoolAsync(const UpdateWorkspacesPoolRequestT& request, const UpdateWorkspacesPoolResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
