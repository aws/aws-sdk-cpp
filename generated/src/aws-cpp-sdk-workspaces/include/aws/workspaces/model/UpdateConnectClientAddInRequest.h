...
class UpdateConnectClientAddInRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename AddInIdT = Aws::String>
  UpdateConnectClientAddInRequest& WithAddInId(AddInIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  UpdateConnectClientAddInRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateConnectClientAddInRequest& WithName(NameT&& value) {
  ...
  template <typename URLT = Aws::String>
  UpdateConnectClientAddInRequest& WithURL(URLT&& value) {
