...
class FailedCreateStandbyWorkspacesRequest {
 public:
  ...
  void SetStandbyWorkspaceRequest(StandbyWorkspaceRequestT&& value) {
    m_standbyWorkspaceRequestHasBeenSet = true;
    m_standbyWorkspaceRequest = std::forward<StandbyWorkspaceRequestT>(value);
  }
  template <typename StandbyWorkspaceRequestT = StandbyWorkspace>
  FailedCreateStandbyWorkspacesRequest& WithStandbyWorkspaceRequest(StandbyWorkspaceRequestT&& value) {
    SetStandbyWorkspaceRequest(std::forward<StandbyWorkspaceRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorCodeT = Aws::String>
  FailedCreateStandbyWorkspacesRequest& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedCreateStandbyWorkspacesRequest& WithErrorMessage(ErrorMessageT&& value) {
