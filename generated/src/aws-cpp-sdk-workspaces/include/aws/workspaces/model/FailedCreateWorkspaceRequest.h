...
class FailedCreateWorkspaceRequest {
 public:
  ...
  void SetWorkspaceRequest(WorkspaceRequestT&& value) {
    m_workspaceRequestHasBeenSet = true;
    m_workspaceRequest = std::forward<WorkspaceRequestT>(value);
  }
  template <typename WorkspaceRequestT = WorkspaceRequest>
  FailedCreateWorkspaceRequest& WithWorkspaceRequest(WorkspaceRequestT&& value) {
    SetWorkspaceRequest(std::forward<WorkspaceRequestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ErrorCodeT = Aws::String>
  FailedCreateWorkspaceRequest& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedCreateWorkspaceRequest& WithErrorMessage(ErrorMessageT&& value) {
