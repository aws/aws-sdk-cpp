...
class ModifyWorkspaceStateRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  ModifyWorkspaceStateRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  inline void SetWorkspaceState(TargetWorkspaceState value) {
    m_workspaceStateHasBeenSet = true;
    m_workspaceState = value;
  }
  inline ModifyWorkspaceStateRequest& WithWorkspaceState(TargetWorkspaceState value) {
