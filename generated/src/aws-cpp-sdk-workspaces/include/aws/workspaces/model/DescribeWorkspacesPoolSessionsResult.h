...
class DescribeWorkspacesPoolSessionsResult {
 public:
  ...
  AWS_WORKSPACES_API DescribeWorkspacesPoolSessionsResult& operator=(
  ...
  template <typename SessionsT = Aws::Vector<WorkspacesPoolSession>>
  DescribeWorkspacesPoolSessionsResult& WithSessions(SessionsT&& value) {
    SetSessions(std::forward<SessionsT>(value));
    return *this;
  }
  template <typename SessionsT = WorkspacesPoolSession>
  DescribeWorkspacesPoolSessionsResult& AddSessions(SessionsT&& value) {
    m_sessionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspacesPoolSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspacesPoolSessionsResult& WithRequestId(RequestIdT&& value) {
