...
class GlobalAcceleratorForDirectory {
 public:
  ...
  inline void SetMode(AGAModeForDirectoryEnum value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline GlobalAcceleratorForDirectory& WithMode(AGAModeForDirectoryEnum value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreferredProtocol(AGAPreferredProtocolForDirectory value) {
    m_preferredProtocolHasBeenSet = true;
    m_preferredProtocol = value;
  }
  inline GlobalAcceleratorForDirectory& WithPreferredProtocol(AGAPreferredProtocolForDirectory value) {
