...
class DescribeWorkspacesResult {
 public:
  ...
  template <typename WorkspacesT = Aws::Vector<Workspace>>
  DescribeWorkspacesResult& WithWorkspaces(WorkspacesT&& value) {
    SetWorkspaces(std::forward<WorkspacesT>(value));
    return *this;
  }
  template <typename WorkspacesT = Workspace>
  DescribeWorkspacesResult& AddWorkspaces(WorkspacesT&& value) {
    m_workspacesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspacesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspacesResult& WithRequestId(RequestIdT&& value) {
