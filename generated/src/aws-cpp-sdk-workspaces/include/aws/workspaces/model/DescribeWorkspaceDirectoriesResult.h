...
class DescribeWorkspaceDirectoriesResult {
 public:
  ...
  template <typename DirectoriesT = Aws::Vector<WorkspaceDirectory>>
  DescribeWorkspaceDirectoriesResult& WithDirectories(DirectoriesT&& value) {
    SetDirectories(std::forward<DirectoriesT>(value));
    return *this;
  }
  template <typename DirectoriesT = WorkspaceDirectory>
  DescribeWorkspaceDirectoriesResult& AddDirectories(DirectoriesT&& value) {
    m_directoriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspaceDirectoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspaceDirectoriesResult& WithRequestId(RequestIdT&& value) {
