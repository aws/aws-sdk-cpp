...
class ModifyCertificateBasedAuthPropertiesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  ModifyCertificateBasedAuthPropertiesRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename CertificateBasedAuthPropertiesT = CertificateBasedAuthProperties>
  ModifyCertificateBasedAuthPropertiesRequest& WithCertificateBasedAuthProperties(CertificateBasedAuthPropertiesT&& value) {
  ...
  template <typename PropertiesToDeleteT = Aws::Vector<DeletableCertificateBasedAuthProperty>>
  ModifyCertificateBasedAuthPropertiesRequest& WithPropertiesToDelete(PropertiesToDeleteT&& value) {
    SetPropertiesToDelete(std::forward<PropertiesToDeleteT>(value));
    return *this;
  }
  inline ModifyCertificateBasedAuthPropertiesRequest& AddPropertiesToDelete(DeletableCertificateBasedAuthProperty value) {
    m_propertiesToDeleteHasBeenSet = true;
