...
class CreateStandbyWorkspacesResult {
 public:
  ...
  void SetFailedStandbyRequests(FailedStandbyRequestsT&& value) {
    ...
    m_failedStandbyRequests = std::forward<FailedStandbyRequestsT>(value);
  }
  template <typename FailedStandbyRequestsT = Aws::Vector<FailedCreateStandbyWorkspacesRequest>>
  CreateStandbyWorkspacesResult& WithFailedStandbyRequests(FailedStandbyRequestsT&& value) {
    SetFailedStandbyRequests(std::forward<FailedStandbyRequestsT>(value));
    return *this;
  }
  ...
  CreateStandbyWorkspacesResult& AddFailedStandbyRequests(FailedStandbyRequestsT&& value) {
    m_failedStandbyRequestsHasBeenSet = true;
    m_failedStandbyRequests.emplace_back(std::forward<FailedStandbyRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingStandbyRequests(PendingStandbyRequestsT&& value) {
    ...
    m_pendingStandbyRequests = std::forward<PendingStandbyRequestsT>(value);
  }
  template <typename PendingStandbyRequestsT = Aws::Vector<PendingCreateStandbyWorkspacesRequest>>
  CreateStandbyWorkspacesResult& WithPendingStandbyRequests(PendingStandbyRequestsT&& value) {
    SetPendingStandbyRequests(std::forward<PendingStandbyRequestsT>(value));
    return *this;
  }
  ...
  CreateStandbyWorkspacesResult& AddPendingStandbyRequests(PendingStandbyRequestsT&& value) {
    m_pendingStandbyRequestsHasBeenSet = true;
    m_pendingStandbyRequests.emplace_back(std::forward<PendingStandbyRequestsT>(value));
    return *this;
  }
  ///@}
