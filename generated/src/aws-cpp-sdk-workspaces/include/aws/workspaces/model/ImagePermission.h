...
class ImagePermission {
 public:
  ...
  void SetSharedAccountId(SharedAccountIdT&& value) {
    ...
    m_sharedAccountId = std::forward<SharedAccountIdT>(value);
  }
  template <typename SharedAccountIdT = Aws::String>
  ImagePermission& WithSharedAccountId(SharedAccountIdT&& value) {
    SetSharedAccountId(std::forward<SharedAccountIdT>(value));
    return *this;
  }
  ///@}
 private:
