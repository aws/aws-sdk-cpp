...
class ModifyAccountRequest : public WorkSpacesRequest {
 public:
  ...
  inline void SetDedicatedTenancySupport(DedicatedTenancySupportEnum value) {
    m_dedicatedTenancySupportHasBeenSet = true;
    m_dedicatedTenancySupport = value;
  }
  inline ModifyAccountRequest& WithDedicatedTenancySupport(DedicatedTenancySupportEnum value) {
  ...
  template <typename DedicatedTenancyManagementCidrRangeT = Aws::String>
  ModifyAccountRequest& WithDedicatedTenancyManagementCidrRange(DedicatedTenancyManagementCidrRangeT&& value) {
