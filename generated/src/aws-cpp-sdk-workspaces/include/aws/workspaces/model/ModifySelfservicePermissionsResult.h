...
namespace Model
{
  ...
  public:
    ...
    inline ModifySelfservicePermissionsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ModifySelfservicePermissionsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ModifySelfservicePermissionsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
