...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API ModifySelfservicePermissionsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ModifySelfservicePermissionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
