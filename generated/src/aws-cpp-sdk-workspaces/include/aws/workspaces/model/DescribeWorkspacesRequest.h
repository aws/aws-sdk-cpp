...
class DescribeWorkspacesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename WorkspaceIdsT = Aws::Vector<Aws::String>>
  DescribeWorkspacesRequest& WithWorkspaceIds(WorkspaceIdsT&& value) {
    SetWorkspaceIds(std::forward<WorkspaceIdsT>(value));
    return *this;
  }
  template <typename WorkspaceIdsT = Aws::String>
  DescribeWorkspacesRequest& AddWorkspaceIds(WorkspaceIdsT&& value) {
    m_workspaceIdsHasBeenSet = true;
  ...
  template <typename DirectoryIdT = Aws::String>
  DescribeWorkspacesRequest& WithDirectoryId(DirectoryIdT&& value) {
  ...
  template <typename UserNameT = Aws::String>
  DescribeWorkspacesRequest& WithUserName(UserNameT&& value) {
  ...
  template <typename BundleIdT = Aws::String>
  DescribeWorkspacesRequest& WithBundleId(BundleIdT&& value) {
  ...
  inline DescribeWorkspacesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspacesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename WorkspaceNameT = Aws::String>
  DescribeWorkspacesRequest& WithWorkspaceName(WorkspaceNameT&& value) {
