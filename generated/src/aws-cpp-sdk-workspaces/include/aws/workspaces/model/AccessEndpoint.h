...
class AccessEndpoint {
 public:
  ...
  inline void SetAccessEndpointType(AccessEndpointType value) {
    m_accessEndpointTypeHasBeenSet = true;
    m_accessEndpointType = value;
  }
  inline AccessEndpoint& WithAccessEndpointType(AccessEndpointType value) {
    SetAccessEndpointType(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcEndpointIdT = Aws::String>
  AccessEndpoint& WithVpcEndpointId(VpcEndpointIdT&& value) {
