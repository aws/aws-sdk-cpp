...
class ClientProperties {
 public:
  ...
  inline void SetReconnectEnabled(ReconnectEnum value) {
    m_reconnectEnabledHasBeenSet = true;
    m_reconnectEnabled = value;
  }
  inline ClientProperties& WithReconnectEnabled(ReconnectEnum value) {
  ...
  inline void SetLogUploadEnabled(LogUploadEnum value) {
    m_logUploadEnabledHasBeenSet = true;
    m_logUploadEnabled = value;
  }
  inline ClientProperties& WithLogUploadEnabled(LogUploadEnum value) {
    SetLogUploadEnabled(value);
    return *this;
  }
  ///@}
 private:
