...
class ModifySelfservicePermissionsRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  ModifySelfservicePermissionsRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename SelfservicePermissionsT = SelfservicePermissions>
  ModifySelfservicePermissionsRequest& WithSelfservicePermissions(SelfservicePermissionsT&& value) {
