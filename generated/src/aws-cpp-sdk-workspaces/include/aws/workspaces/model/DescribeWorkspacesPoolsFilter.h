...
class DescribeWorkspacesPoolsFilter {
 public:
  ...
  inline void SetName(DescribeWorkspacesPoolsFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DescribeWorkspacesPoolsFilter& WithName(DescribeWorkspacesPoolsFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DescribeWorkspacesPoolsFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DescribeWorkspacesPoolsFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(DescribeWorkspacesPoolsFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline DescribeWorkspacesPoolsFilter& WithOperator(DescribeWorkspacesPoolsFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
