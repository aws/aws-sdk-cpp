...
class DescribeWorkspaceDirectoriesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename DirectoryIdsT = Aws::Vector<Aws::String>>
  DescribeWorkspaceDirectoriesRequest& WithDirectoryIds(DirectoryIdsT&& value) {
    SetDirectoryIds(std::forward<DirectoryIdsT>(value));
    return *this;
  }
  template <typename DirectoryIdsT = Aws::String>
  DescribeWorkspaceDirectoriesRequest& AddDirectoryIds(DirectoryIdsT&& value) {
    m_directoryIdsHasBeenSet = true;
  ...
  void SetWorkspaceDirectoryNames(WorkspaceDirectoryNamesT&& value) {
    m_workspaceDirectoryNamesHasBeenSet = true;
    m_workspaceDirectoryNames = std::forward<WorkspaceDirectoryNamesT>(value);
  }
  template <typename WorkspaceDirectoryNamesT = Aws::Vector<Aws::String>>
  DescribeWorkspaceDirectoriesRequest& WithWorkspaceDirectoryNames(WorkspaceDirectoryNamesT&& value) {
    SetWorkspaceDirectoryNames(std::forward<WorkspaceDirectoryNamesT>(value));
    return *this;
  }
  template <typename WorkspaceDirectoryNamesT = Aws::String>
  DescribeWorkspaceDirectoriesRequest& AddWorkspaceDirectoryNames(WorkspaceDirectoryNamesT&& value) {
    m_workspaceDirectoryNamesHasBeenSet = true;
    m_workspaceDirectoryNames.emplace_back(std::forward<WorkspaceDirectoryNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeWorkspaceDirectoriesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspaceDirectoriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<DescribeWorkspaceDirectoriesFilter>>
  DescribeWorkspaceDirectoriesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = DescribeWorkspaceDirectoriesFilter>
  DescribeWorkspaceDirectoriesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
