...
class UpdateConnectionAliasPermissionRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename AliasIdT = Aws::String>
  UpdateConnectionAliasPermissionRequest& WithAliasId(AliasIdT&& value) {
  ...
  void SetConnectionAliasPermission(ConnectionAliasPermissionT&& value) {
    m_connectionAliasPermissionHasBeenSet = true;
    m_connectionAliasPermission = std::forward<ConnectionAliasPermissionT>(value);
  }
  template <typename ConnectionAliasPermissionT = ConnectionAliasPermission>
  UpdateConnectionAliasPermissionRequest& WithConnectionAliasPermission(ConnectionAliasPermissionT&& value) {
    SetConnectionAliasPermission(std::forward<ConnectionAliasPermissionT>(value));
    return *this;
  }
  ///@}
 private:
