...
class DescribeAccountResult {
 public:
  ...
  inline void SetDedicatedTenancySupport(DedicatedTenancySupportResultEnum value) {
    m_dedicatedTenancySupportHasBeenSet = true;
    m_dedicatedTenancySupport = value;
  }
  inline DescribeAccountResult& WithDedicatedTenancySupport(DedicatedTenancySupportResultEnum value) {
    SetDedicatedTenancySupport(value);
    return *this;
  }
  ///@}
  ...
  void SetDedicatedTenancyManagementCidrRange(DedicatedTenancyManagementCidrRangeT&& value) {
    ...
    m_dedicatedTenancyManagementCidrRange = std::forward<DedicatedTenancyManagementCidrRangeT>(value);
  }
  template <typename DedicatedTenancyManagementCidrRangeT = Aws::String>
  DescribeAccountResult& WithDedicatedTenancyManagementCidrRange(DedicatedTenancyManagementCidrRangeT&& value) {
    SetDedicatedTenancyManagementCidrRange(std::forward<DedicatedTenancyManagementCidrRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDedicatedTenancyAccountType(DedicatedTenancyAccountType value) {
    m_dedicatedTenancyAccountTypeHasBeenSet = true;
    m_dedicatedTenancyAccountType = value;
  }
  inline DescribeAccountResult& WithDedicatedTenancyAccountType(DedicatedTenancyAccountType value) {
    SetDedicatedTenancyAccountType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  DescribeAccountResult& WithMessage(MessageT&& value) {
