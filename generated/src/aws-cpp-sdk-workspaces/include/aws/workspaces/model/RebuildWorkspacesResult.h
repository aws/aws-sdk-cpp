...
class RebuildWorkspacesResult {
 public:
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedWorkspaceChangeRequest>>
  RebuildWorkspacesResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedWorkspaceChangeRequest>
  RebuildWorkspacesResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RebuildWorkspacesResult& WithRequestId(RequestIdT&& value) {
