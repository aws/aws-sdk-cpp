...
class TerminateWorkspacesResult {
 public:
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedWorkspaceChangeRequest>>
  TerminateWorkspacesResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedWorkspaceChangeRequest>
  TerminateWorkspacesResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  TerminateWorkspacesResult& WithRequestId(RequestIdT&& value) {
