...
class WorkspaceCreationProperties {
 public:
  ...
  inline WorkspaceCreationProperties& WithEnableInternetAccess(bool value) {
  ...
  inline WorkspaceCreationProperties& WithUserEnabledAsLocalAdministrator(bool value) {
  ...
  inline WorkspaceCreationProperties& WithEnableMaintenanceMode(bool value) {
