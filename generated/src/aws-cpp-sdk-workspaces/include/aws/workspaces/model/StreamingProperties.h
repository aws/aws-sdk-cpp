...
class StreamingProperties {
 public:
   ...
   */
  inline StreamingExperiencePreferredProtocolEnum GetStreamingExperiencePreferredProtocol() const {
    return m_streamingExperiencePreferredProtocol;
  }
  inline bool StreamingExperiencePreferredProtocolHasBeenSet() const { return m_streamingExperiencePreferredProtocolHasBeenSet; }
  inline void SetStreamingExperiencePreferredProtocol(StreamingExperiencePreferredProtocolEnum value) {
    m_streamingExperiencePreferredProtocolHasBeenSet = true;
    m_streamingExperiencePreferredProtocol = value;
  }
  inline StreamingProperties& WithStreamingExperiencePreferredProtocol(StreamingExperiencePreferredProtocolEnum value) {
    SetStreamingExperiencePreferredProtocol(value);
    return *this;
  }
  ///@}
