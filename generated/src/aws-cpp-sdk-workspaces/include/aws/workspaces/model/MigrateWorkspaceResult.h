...
class MigrateWorkspaceResult {
 public:
  ...
  template <typename SourceWorkspaceIdT = Aws::String>
  MigrateWorkspaceResult& WithSourceWorkspaceId(SourceWorkspaceIdT&& value) {
  ...
  void SetTargetWorkspaceId(TargetWorkspaceIdT&& value) {
    m_targetWorkspaceIdHasBeenSet = true;
    m_targetWorkspaceId = std::forward<TargetWorkspaceIdT>(value);
  }
  template <typename TargetWorkspaceIdT = Aws::String>
  MigrateWorkspaceResult& WithTargetWorkspaceId(TargetWorkspaceIdT&& value) {
    SetTargetWorkspaceId(std::forward<TargetWorkspaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  MigrateWorkspaceResult& WithRequestId(RequestIdT&& value) {
