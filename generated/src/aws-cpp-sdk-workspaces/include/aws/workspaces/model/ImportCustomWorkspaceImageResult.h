...
class ImportCustomWorkspaceImageResult {
 public:
  ...
  template <typename ImageIdT = Aws::String>
  ImportCustomWorkspaceImageResult& WithImageId(ImageIdT&& value) {
  ...
  inline void SetState(CustomWorkspaceImageImportState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ImportCustomWorkspaceImageResult& WithState(CustomWorkspaceImageImportState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ImportCustomWorkspaceImageResult& WithRequestId(RequestIdT&& value) {
