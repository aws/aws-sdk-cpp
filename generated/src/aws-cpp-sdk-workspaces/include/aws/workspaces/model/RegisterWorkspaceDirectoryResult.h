...
class RegisterWorkspaceDirectoryResult {
 public:
  ...
  template <typename DirectoryIdT = Aws::String>
  RegisterWorkspaceDirectoryResult& WithDirectoryId(DirectoryIdT&& value) {
  ...
  inline void SetState(WorkspaceDirectoryState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline RegisterWorkspaceDirectoryResult& WithState(WorkspaceDirectoryState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RegisterWorkspaceDirectoryResult& WithRequestId(RequestIdT&& value) {
