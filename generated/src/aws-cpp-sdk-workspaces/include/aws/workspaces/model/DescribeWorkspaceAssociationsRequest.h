...
class DescribeWorkspaceAssociationsRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  DescribeWorkspaceAssociationsRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename AssociatedResourceTypesT = Aws::Vector<WorkSpaceAssociatedResourceType>>
  DescribeWorkspaceAssociationsRequest& WithAssociatedResourceTypes(AssociatedResourceTypesT&& value) {
    SetAssociatedResourceTypes(std::forward<AssociatedResourceTypesT>(value));
    return *this;
  }
  inline DescribeWorkspaceAssociationsRequest& AddAssociatedResourceTypes(WorkSpaceAssociatedResourceType value) {
    m_associatedResourceTypesHasBeenSet = true;
