...
class WorkspacesPoolError {
 public:
  ...
  inline void SetErrorCode(WorkspacesPoolErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline WorkspacesPoolError& WithErrorCode(WorkspacesPoolErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  WorkspacesPoolError& WithErrorMessage(ErrorMessageT&& value) {
