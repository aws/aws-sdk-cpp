...
class AccountLink {
 public:
  ...
  void SetAccountLinkId(AccountLinkIdT&& value) {
    ...
    m_accountLinkId = std::forward<AccountLinkIdT>(value);
  }
  template <typename AccountLinkIdT = Aws::String>
  AccountLink& WithAccountLinkId(AccountLinkIdT&& value) {
    SetAccountLinkId(std::forward<AccountLinkIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAccountLinkStatus(AccountLinkStatusEnum value) {
    m_accountLinkStatusHasBeenSet = true;
    m_accountLinkStatus = value;
  }
  inline AccountLink& WithAccountLinkStatus(AccountLinkStatusEnum value) {
    SetAccountLinkStatus(value);
    return *this;
  }
  ///@}
