...
class DescribeWorkspacesPoolSessionsRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename PoolIdT = Aws::String>
  DescribeWorkspacesPoolSessionsRequest& WithPoolId(PoolIdT&& value) {
  ...
  template <typename UserIdT = Aws::String>
  DescribeWorkspacesPoolSessionsRequest& WithUserId(UserIdT&& value) {
  ...
  inline DescribeWorkspacesPoolSessionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspacesPoolSessionsRequest& WithNextToken(NextTokenT&& value) {
