...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API DeleteWorkspaceImageResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteWorkspaceImageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
