...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API ModifyAccountResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ModifyAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
