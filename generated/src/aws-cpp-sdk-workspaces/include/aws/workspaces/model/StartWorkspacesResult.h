...
class StartWorkspacesResult {
 public:
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedWorkspaceChangeRequest>>
  StartWorkspacesResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedWorkspaceChangeRequest>
  StartWorkspacesResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StartWorkspacesResult& WithRequestId(RequestIdT&& value) {
