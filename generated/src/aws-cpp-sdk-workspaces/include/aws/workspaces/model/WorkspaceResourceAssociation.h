...
class WorkspaceResourceAssociation {
 public:
  ...
  template <typename AssociatedResourceIdT = Aws::String>
  WorkspaceResourceAssociation& WithAssociatedResourceId(AssociatedResourceIdT&& value) {
  ...
  inline void SetAssociatedResourceType(WorkSpaceAssociatedResourceType value) {
    m_associatedResourceTypeHasBeenSet = true;
    m_associatedResourceType = value;
  }
  inline WorkspaceResourceAssociation& WithAssociatedResourceType(WorkSpaceAssociatedResourceType value) {
    SetAssociatedResourceType(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedT = Aws::Utils::DateTime>
  WorkspaceResourceAssociation& WithCreated(CreatedT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  WorkspaceResourceAssociation& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  inline void SetState(AssociationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline WorkspaceResourceAssociation& WithState(AssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateReasonT = AssociationStateReason>
  WorkspaceResourceAssociation& WithStateReason(StateReasonT&& value) {
  ...
  template <typename WorkspaceIdT = Aws::String>
  WorkspaceResourceAssociation& WithWorkspaceId(WorkspaceIdT&& value) {
