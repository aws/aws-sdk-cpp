...
class StandbyWorkspacesProperties {
 public:
  ...
  void SetStandbyWorkspaceId(StandbyWorkspaceIdT&& value) {
    ...
    m_standbyWorkspaceId = std::forward<StandbyWorkspaceIdT>(value);
  }
  template <typename StandbyWorkspaceIdT = Aws::String>
  StandbyWorkspacesProperties& WithStandbyWorkspaceId(StandbyWorkspaceIdT&& value) {
    SetStandbyWorkspaceId(std::forward<StandbyWorkspaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline StandbyWorkspacesProperties& WithDataReplication(DataReplication value) {
  ...
  void SetRecoverySnapshotTime(RecoverySnapshotTimeT&& value) {
    ...
    m_recoverySnapshotTime = std::forward<RecoverySnapshotTimeT>(value);
  }
  template <typename RecoverySnapshotTimeT = Aws::Utils::DateTime>
  StandbyWorkspacesProperties& WithRecoverySnapshotTime(RecoverySnapshotTimeT&& value) {
    SetRecoverySnapshotTime(std::forward<RecoverySnapshotTimeT>(value));
    return *this;
  }
  ///@}
 private:
