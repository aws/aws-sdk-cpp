...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API DeleteAccountLinkInvitationResult() = default;
    ...
    template<typename AccountLinkT = AccountLink>
    DeleteAccountLinkInvitationResult& WithAccountLink(AccountLinkT&& value) { SetAccountLink(std::forward<AccountLinkT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAccountLinkInvitationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
