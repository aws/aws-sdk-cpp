...
class ImageSourceIdentifier {
 public:
  ...
  void SetEc2ImportTaskId(Ec2ImportTaskIdT&& value) {
    m_ec2ImportTaskIdHasBeenSet = true;
    m_ec2ImportTaskId = std::forward<Ec2ImportTaskIdT>(value);
  }
  template <typename Ec2ImportTaskIdT = Aws::String>
  ImageSourceIdentifier& WithEc2ImportTaskId(Ec2ImportTaskIdT&& value) {
    SetEc2ImportTaskId(std::forward<Ec2ImportTaskIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  ImageSourceIdentifier& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
  ...
  template <typename Ec2ImageIdT = Aws::String>
  ImageSourceIdentifier& WithEc2ImageId(Ec2ImageIdT&& value) {
