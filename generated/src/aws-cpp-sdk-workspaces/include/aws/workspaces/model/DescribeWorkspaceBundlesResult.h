...
class DescribeWorkspaceBundlesResult {
 public:
  ...
  template <typename BundlesT = Aws::Vector<WorkspaceBundle>>
  DescribeWorkspaceBundlesResult& WithBundles(BundlesT&& value) {
    SetBundles(std::forward<BundlesT>(value));
    return *this;
  }
  template <typename BundlesT = WorkspaceBundle>
  DescribeWorkspaceBundlesResult& AddBundles(BundlesT&& value) {
    m_bundlesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspaceBundlesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspaceBundlesResult& WithRequestId(RequestIdT&& value) {
