...
class CreateWorkspacesPoolResult {
 public:
  ...
  void SetWorkspacesPool(WorkspacesPoolT&& value) {
    m_workspacesPoolHasBeenSet = true;
    m_workspacesPool = std::forward<WorkspacesPoolT>(value);
  }
  template <typename WorkspacesPoolT = WorkspacesPool>
  CreateWorkspacesPoolResult& WithWorkspacesPool(WorkspacesPoolT&& value) {
    SetWorkspacesPool(std::forward<WorkspacesPoolT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkspacesPoolResult& WithRequestId(RequestIdT&& value) {
