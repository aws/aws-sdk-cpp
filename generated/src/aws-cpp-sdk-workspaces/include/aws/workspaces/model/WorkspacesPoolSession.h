...
class WorkspacesPoolSession {
 public:
  ...
  inline WorkspacesPoolSession& WithAuthenticationType(AuthenticationType value) {
  ...
  inline WorkspacesPoolSession& WithConnectionState(SessionConnectionState value) {
