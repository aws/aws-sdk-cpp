...
class Workspace {
 public:
  ...
  inline Workspace& WithState(WorkspaceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetComputerName(ComputerNameT&& value) {
    ...
    m_computerName = std::forward<ComputerNameT>(value);
  }
  template <typename ComputerNameT = Aws::String>
  Workspace& WithComputerName(ComputerNameT&& value) {
    SetComputerName(std::forward<ComputerNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVolumeEncryptionKey(VolumeEncryptionKeyT&& value) {
    ...
    m_volumeEncryptionKey = std::forward<VolumeEncryptionKeyT>(value);
  }
  template <typename VolumeEncryptionKeyT = Aws::String>
  Workspace& WithVolumeEncryptionKey(VolumeEncryptionKeyT&& value) {
    SetVolumeEncryptionKey(std::forward<VolumeEncryptionKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUserVolumeEncryptionEnabled(bool value) {
    m_userVolumeEncryptionEnabledHasBeenSet = true;
    m_userVolumeEncryptionEnabled = value;
  }
  inline Workspace& WithUserVolumeEncryptionEnabled(bool value) {
    SetUserVolumeEncryptionEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRootVolumeEncryptionEnabled(bool value) {
    m_rootVolumeEncryptionEnabledHasBeenSet = true;
    m_rootVolumeEncryptionEnabled = value;
  }
  inline Workspace& WithRootVolumeEncryptionEnabled(bool value) {
    SetRootVolumeEncryptionEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetWorkspaceProperties(WorkspacePropertiesT&& value) {
    ...
    m_workspaceProperties = std::forward<WorkspacePropertiesT>(value);
  }
  template <typename WorkspacePropertiesT = WorkspaceProperties>
  Workspace& WithWorkspaceProperties(WorkspacePropertiesT&& value) {
    SetWorkspaceProperties(std::forward<WorkspacePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModificationStates(ModificationStatesT&& value) {
    ...
    m_modificationStates = std::forward<ModificationStatesT>(value);
  }
  template <typename ModificationStatesT = Aws::Vector<ModificationState>>
  Workspace& WithModificationStates(ModificationStatesT&& value) {
    SetModificationStates(std::forward<ModificationStatesT>(value));
    return *this;
  }
  template <typename ModificationStatesT = ModificationState>
  Workspace& AddModificationStates(ModificationStatesT&& value) {
    m_modificationStatesHasBeenSet = true;
    m_modificationStates.emplace_back(std::forward<ModificationStatesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelatedWorkspaces(RelatedWorkspacesT&& value) {
    ...
    m_relatedWorkspaces = std::forward<RelatedWorkspacesT>(value);
  }
  template <typename RelatedWorkspacesT = Aws::Vector<RelatedWorkspaceProperties>>
  Workspace& WithRelatedWorkspaces(RelatedWorkspacesT&& value) {
    SetRelatedWorkspaces(std::forward<RelatedWorkspacesT>(value));
    return *this;
  }
  template <typename RelatedWorkspacesT = RelatedWorkspaceProperties>
  Workspace& AddRelatedWorkspaces(RelatedWorkspacesT&& value) {
    m_relatedWorkspacesHasBeenSet = true;
    m_relatedWorkspaces.emplace_back(std::forward<RelatedWorkspacesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataReplicationSettings(DataReplicationSettingsT&& value) {
    ...
    m_dataReplicationSettings = std::forward<DataReplicationSettingsT>(value);
  }
  template <typename DataReplicationSettingsT = DataReplicationSettings>
  Workspace& WithDataReplicationSettings(DataReplicationSettingsT&& value) {
    SetDataReplicationSettings(std::forward<DataReplicationSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStandbyWorkspacesProperties(StandbyWorkspacesPropertiesT&& value) {
    ...
    m_standbyWorkspacesProperties = std::forward<StandbyWorkspacesPropertiesT>(value);
  }
  template <typename StandbyWorkspacesPropertiesT = Aws::Vector<StandbyWorkspacesProperties>>
  Workspace& WithStandbyWorkspacesProperties(StandbyWorkspacesPropertiesT&& value) {
    SetStandbyWorkspacesProperties(std::forward<StandbyWorkspacesPropertiesT>(value));
    return *this;
  }
  ...
  Workspace& AddStandbyWorkspacesProperties(StandbyWorkspacesPropertiesT&& value) {
    m_standbyWorkspacesPropertiesHasBeenSet = true;
    m_standbyWorkspacesProperties.emplace_back(std::forward<StandbyWorkspacesPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
