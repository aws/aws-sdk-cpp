...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API ModifyWorkspacePropertiesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ModifyWorkspacePropertiesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
