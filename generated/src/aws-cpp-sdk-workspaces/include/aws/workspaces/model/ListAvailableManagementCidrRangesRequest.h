...
class ListAvailableManagementCidrRangesRequest : public WorkSpacesRequest {
 public:
  ...
  void SetManagementCidrRangeConstraint(ManagementCidrRangeConstraintT&& value) {
    m_managementCidrRangeConstraintHasBeenSet = true;
    m_managementCidrRangeConstraint = std::forward<ManagementCidrRangeConstraintT>(value);
  }
  template <typename ManagementCidrRangeConstraintT = Aws::String>
  ListAvailableManagementCidrRangesRequest& WithManagementCidrRangeConstraint(ManagementCidrRangeConstraintT&& value) {
    SetManagementCidrRangeConstraint(std::forward<ManagementCidrRangeConstraintT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAvailableManagementCidrRangesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAvailableManagementCidrRangesRequest& WithNextToken(NextTokenT&& value) {
