...
class IosImportClientBrandingAttributes {
 public:
  ...
  template <typename LogoT = Aws::Utils::ByteBuffer>
  IosImportClientBrandingAttributes& WithLogo(LogoT&& value) {
  ...
  void SetLogo2x(Logo2xT&& value) {
    m_logo2xHasBeenSet = true;
    m_logo2x = std::forward<Logo2xT>(value);
  }
  template <typename Logo2xT = Aws::Utils::ByteBuffer>
  IosImportClientBrandingAttributes& WithLogo2x(Logo2xT&& value) {
    SetLogo2x(std::forward<Logo2xT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogo3x(Logo3xT&& value) {
    m_logo3xHasBeenSet = true;
    m_logo3x = std::forward<Logo3xT>(value);
  }
  template <typename Logo3xT = Aws::Utils::ByteBuffer>
  IosImportClientBrandingAttributes& WithLogo3x(Logo3xT&& value) {
    SetLogo3x(std::forward<Logo3xT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SupportEmailT = Aws::String>
  IosImportClientBrandingAttributes& WithSupportEmail(SupportEmailT&& value) {
  ...
  template <typename SupportLinkT = Aws::String>
  IosImportClientBrandingAttributes& WithSupportLink(SupportLinkT&& value) {
  ...
  template <typename ForgotPasswordLinkT = Aws::String>
  IosImportClientBrandingAttributes& WithForgotPasswordLink(ForgotPasswordLinkT&& value) {
  ...
  template <typename LoginMessageT = Aws::Map<Aws::String, Aws::String>>
  IosImportClientBrandingAttributes& WithLoginMessage(LoginMessageT&& value) {
