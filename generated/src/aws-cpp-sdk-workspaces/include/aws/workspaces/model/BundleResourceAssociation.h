...
class BundleResourceAssociation {
 public:
  ...
  inline void SetAssociatedResourceType(BundleAssociatedResourceType value) {
    m_associatedResourceTypeHasBeenSet = true;
    m_associatedResourceType = value;
  }
  inline BundleResourceAssociation& WithAssociatedResourceType(BundleAssociatedResourceType value) {
  ...
  inline BundleResourceAssociation& WithState(AssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
