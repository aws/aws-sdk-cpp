...
class AccessEndpointConfig {
 public:
  ...
  void SetInternetFallbackProtocols(InternetFallbackProtocolsT&& value) {
    ...
    m_internetFallbackProtocols = std::forward<InternetFallbackProtocolsT>(value);
  }
  template <typename InternetFallbackProtocolsT = Aws::Vector<InternetFallbackProtocol>>
  AccessEndpointConfig& WithInternetFallbackProtocols(InternetFallbackProtocolsT&& value) {
    SetInternetFallbackProtocols(std::forward<InternetFallbackProtocolsT>(value));
    return *this;
  }
  inline AccessEndpointConfig& AddInternetFallbackProtocols(InternetFallbackProtocol value) {
    m_internetFallbackProtocolsHasBeenSet = true;
    m_internetFallbackProtocols.push_back(value);
    return *this;
  }
  ///@}
 private:
