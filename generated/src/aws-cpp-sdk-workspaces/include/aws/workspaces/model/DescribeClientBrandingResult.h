...
class DescribeClientBrandingResult {
 public:
  ...
  template <typename DeviceTypeWindowsT = DefaultClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeWindows(DeviceTypeWindowsT&& value) {
  ...
  template <typename DeviceTypeOsxT = DefaultClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeOsx(DeviceTypeOsxT&& value) {
  ...
  template <typename DeviceTypeAndroidT = DefaultClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeAndroid(DeviceTypeAndroidT&& value) {
  ...
  template <typename DeviceTypeIosT = IosClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeIos(DeviceTypeIosT&& value) {
  ...
  template <typename DeviceTypeLinuxT = DefaultClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeLinux(DeviceTypeLinuxT&& value) {
  ...
  template <typename DeviceTypeWebT = DefaultClientBrandingAttributes>
  DescribeClientBrandingResult& WithDeviceTypeWeb(DeviceTypeWebT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeClientBrandingResult& WithRequestId(RequestIdT&& value) {
