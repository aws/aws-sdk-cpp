...
class Tag {
 public:
  AWS_WORKSPACES_API Tag() = default;
  AWS_WORKSPACES_API Tag(Aws::Utils::Json::JsonView jsonValue);
  AWS_WORKSPACES_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
