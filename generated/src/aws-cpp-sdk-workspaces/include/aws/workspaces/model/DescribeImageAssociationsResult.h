...
class DescribeImageAssociationsResult {
 public:
  ...
  template <typename AssociationsT = Aws::Vector<ImageResourceAssociation>>
  DescribeImageAssociationsResult& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = ImageResourceAssociation>
  DescribeImageAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeImageAssociationsResult& WithRequestId(RequestIdT&& value) {
