...
class DescribeWorkspaceImagesResult {
 public:
  ...
  template <typename ImagesT = Aws::Vector<WorkspaceImage>>
  DescribeWorkspaceImagesResult& WithImages(ImagesT&& value) {
    SetImages(std::forward<ImagesT>(value));
    return *this;
  }
  template <typename ImagesT = WorkspaceImage>
  DescribeWorkspaceImagesResult& AddImages(ImagesT&& value) {
    m_imagesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspaceImagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspaceImagesResult& WithRequestId(RequestIdT&& value) {
