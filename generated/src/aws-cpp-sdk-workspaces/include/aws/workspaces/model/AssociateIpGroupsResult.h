...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API AssociateIpGroupsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateIpGroupsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
