...
class ListAccountLinksRequest : public WorkSpacesRequest {
 public:
  ...
  void SetLinkStatusFilter(LinkStatusFilterT&& value) {
    m_linkStatusFilterHasBeenSet = true;
    m_linkStatusFilter = std::forward<LinkStatusFilterT>(value);
  }
  template <typename LinkStatusFilterT = Aws::Vector<AccountLinkStatusEnum>>
  ListAccountLinksRequest& WithLinkStatusFilter(LinkStatusFilterT&& value) {
    SetLinkStatusFilter(std::forward<LinkStatusFilterT>(value));
    return *this;
  }
  inline ListAccountLinksRequest& AddLinkStatusFilter(AccountLinkStatusEnum value) {
    m_linkStatusFilterHasBeenSet = true;
    m_linkStatusFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountLinksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccountLinksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
