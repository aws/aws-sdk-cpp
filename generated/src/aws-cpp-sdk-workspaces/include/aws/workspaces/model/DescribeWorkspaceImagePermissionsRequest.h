...
class DescribeWorkspaceImagePermissionsRequest : public WorkSpacesRequest {
 public:
  AWS_WORKSPACES_API DescribeWorkspaceImagePermissionsRequest() = default;
  ...
  template <typename ImageIdT = Aws::String>
  DescribeWorkspaceImagePermissionsRequest& WithImageId(ImageIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspaceImagePermissionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeWorkspaceImagePermissionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
