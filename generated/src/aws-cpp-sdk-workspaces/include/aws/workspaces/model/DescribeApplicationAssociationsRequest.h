...
class DescribeApplicationAssociationsRequest : public WorkSpacesRequest {
 public:
  ...
  inline DescribeApplicationAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeApplicationAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ApplicationIdT = Aws::String>
  DescribeApplicationAssociationsRequest& WithApplicationId(ApplicationIdT&& value) {
  ...
  template <typename AssociatedResourceTypesT = Aws::Vector<ApplicationAssociatedResourceType>>
  DescribeApplicationAssociationsRequest& WithAssociatedResourceTypes(AssociatedResourceTypesT&& value) {
    SetAssociatedResourceTypes(std::forward<AssociatedResourceTypesT>(value));
    return *this;
  }
  inline DescribeApplicationAssociationsRequest& AddAssociatedResourceTypes(ApplicationAssociatedResourceType value) {
    m_associatedResourceTypesHasBeenSet = true;
