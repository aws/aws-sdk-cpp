...
class WorkSpaceApplication {
 public:
  ...
  inline WorkSpaceApplication& WithLicenseType(WorkSpaceApplicationLicenseType value) {
  ...
  inline void SetState(WorkSpaceApplicationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline WorkSpaceApplication& WithState(WorkSpaceApplicationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedComputeTypeNames(SupportedComputeTypeNamesT&& value) {
    ...
    m_supportedComputeTypeNames = std::forward<SupportedComputeTypeNamesT>(value);
  }
  template <typename SupportedComputeTypeNamesT = Aws::Vector<Compute>>
  WorkSpaceApplication& WithSupportedComputeTypeNames(SupportedComputeTypeNamesT&& value) {
    SetSupportedComputeTypeNames(std::forward<SupportedComputeTypeNamesT>(value));
    return *this;
  }
  inline WorkSpaceApplication& AddSupportedComputeTypeNames(Compute value) {
    m_supportedComputeTypeNamesHasBeenSet = true;
    m_supportedComputeTypeNames.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedOperatingSystemNames(SupportedOperatingSystemNamesT&& value) {
    ...
    m_supportedOperatingSystemNames = std::forward<SupportedOperatingSystemNamesT>(value);
  }
  template <typename SupportedOperatingSystemNamesT = Aws::Vector<OperatingSystemName>>
  WorkSpaceApplication& WithSupportedOperatingSystemNames(SupportedOperatingSystemNamesT&& value) {
    SetSupportedOperatingSystemNames(std::forward<SupportedOperatingSystemNamesT>(value));
    return *this;
  }
  inline WorkSpaceApplication& AddSupportedOperatingSystemNames(OperatingSystemName value) {
    m_supportedOperatingSystemNamesHasBeenSet = true;
    m_supportedOperatingSystemNames.push_back(value);
    return *this;
  }
  ///@}
 private:
