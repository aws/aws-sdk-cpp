...
class AccountModification {
 public:
  ...
  inline void SetModificationState(DedicatedTenancyModificationStateEnum value) {
    m_modificationStateHasBeenSet = true;
    m_modificationState = value;
  }
  inline AccountModification& WithModificationState(DedicatedTenancyModificationStateEnum value) {
  ...
  inline AccountModification& WithDedicatedTenancySupport(DedicatedTenancySupportResultEnum value) {
