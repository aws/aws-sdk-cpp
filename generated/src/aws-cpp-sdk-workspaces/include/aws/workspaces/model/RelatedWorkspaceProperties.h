...
class RelatedWorkspaceProperties {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  RelatedWorkspaceProperties& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename RegionT = Aws::String>
  RelatedWorkspaceProperties& WithRegion(RegionT&& value) {
  ...
  inline RelatedWorkspaceProperties& WithState(WorkspaceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(StandbyWorkspaceRelationshipType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RelatedWorkspaceProperties& WithType(StandbyWorkspaceRelationshipType value) {
    SetType(value);
    return *this;
  }
  ///@}
