...
class DeployWorkspaceApplicationsRequest : public WorkSpacesRequest {
 public:
  AWS_WORKSPACES_API DeployWorkspaceApplicationsRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeployWorkspaceApplicationsRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  inline DeployWorkspaceApplicationsRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
