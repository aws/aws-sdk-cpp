...
class DescribeIpGroupsResult {
 public:
  ...
  template <typename ResultT = Aws::Vector<WorkspacesIpGroup>>
  DescribeIpGroupsResult& WithResult(ResultT&& value) {
    SetResult(std::forward<ResultT>(value));
    return *this;
  }
  template <typename ResultT = WorkspacesIpGroup>
  DescribeIpGroupsResult& AddResult(ResultT&& value) {
    m_resultHasBeenSet = true;
    m_result.emplace_back(std::forward<ResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIpGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeIpGroupsResult& WithRequestId(RequestIdT&& value) {
