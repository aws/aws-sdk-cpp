...
class ConnectionAliasPermission {
 public:
  ...
  inline void SetAllowAssociation(bool value) {
    m_allowAssociationHasBeenSet = true;
    m_allowAssociation = value;
  }
  inline ConnectionAliasPermission& WithAllowAssociation(bool value) {
    SetAllowAssociation(value);
    return *this;
  }
  ///@}
 private:
