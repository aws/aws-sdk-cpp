...
class DefaultImportClientBrandingAttributes {
 public:
  ...
  template <typename LogoT = Aws::Utils::ByteBuffer>
  DefaultImportClientBrandingAttributes& WithLogo(LogoT&& value) {
  ...
  template <typename SupportEmailT = Aws::String>
  DefaultImportClientBrandingAttributes& WithSupportEmail(SupportEmailT&& value) {
  ...
  template <typename SupportLinkT = Aws::String>
  DefaultImportClientBrandingAttributes& WithSupportLink(SupportLinkT&& value) {
  ...
  template <typename ForgotPasswordLinkT = Aws::String>
  DefaultImportClientBrandingAttributes& WithForgotPasswordLink(ForgotPasswordLinkT&& value) {
  ...
  template <typename LoginMessageT = Aws::Map<Aws::String, Aws::String>>
  DefaultImportClientBrandingAttributes& WithLoginMessage(LoginMessageT&& value) {
