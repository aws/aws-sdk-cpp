...
namespace Model
{
  ...
  public:
    ...
    inline UpdateRulesOfIpGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateRulesOfIpGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateRulesOfIpGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
