...
class StandbyWorkspace {
 public:
  ...
  void SetPrimaryWorkspaceId(PrimaryWorkspaceIdT&& value) {
    ...
    m_primaryWorkspaceId = std::forward<PrimaryWorkspaceIdT>(value);
  }
  template <typename PrimaryWorkspaceIdT = Aws::String>
  StandbyWorkspace& WithPrimaryWorkspaceId(PrimaryWorkspaceIdT&& value) {
    SetPrimaryWorkspaceId(std::forward<PrimaryWorkspaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataReplication(DataReplication value) {
    m_dataReplicationHasBeenSet = true;
    m_dataReplication = value;
  }
  inline StandbyWorkspace& WithDataReplication(DataReplication value) {
    SetDataReplication(value);
    return *this;
  }
  ///@}
 private:
