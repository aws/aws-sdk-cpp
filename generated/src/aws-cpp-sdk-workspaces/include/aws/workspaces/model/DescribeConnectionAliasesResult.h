...
class DescribeConnectionAliasesResult {
 public:
  ...
  void SetConnectionAliases(ConnectionAliasesT&& value) {
    m_connectionAliasesHasBeenSet = true;
    m_connectionAliases = std::forward<ConnectionAliasesT>(value);
  }
  template <typename ConnectionAliasesT = Aws::Vector<ConnectionAlias>>
  DescribeConnectionAliasesResult& WithConnectionAliases(ConnectionAliasesT&& value) {
    SetConnectionAliases(std::forward<ConnectionAliasesT>(value));
    return *this;
  }
  template <typename ConnectionAliasesT = ConnectionAlias>
  DescribeConnectionAliasesResult& AddConnectionAliases(ConnectionAliasesT&& value) {
    m_connectionAliasesHasBeenSet = true;
    m_connectionAliases.emplace_back(std::forward<ConnectionAliasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConnectionAliasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeConnectionAliasesResult& WithRequestId(RequestIdT&& value) {
