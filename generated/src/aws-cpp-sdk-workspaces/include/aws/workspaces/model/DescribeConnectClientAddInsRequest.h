...
class DescribeConnectClientAddInsRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  DescribeConnectClientAddInsRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeConnectClientAddInsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeConnectClientAddInsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
