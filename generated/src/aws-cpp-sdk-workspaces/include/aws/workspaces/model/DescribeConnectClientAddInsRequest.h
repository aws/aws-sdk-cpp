...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API DescribeConnectClientAddInsRequest() = default;
    ...
    template<typename ResourceIdT = Aws::String>
    DescribeConnectClientAddInsRequest& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeConnectClientAddInsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
