...
class DescribeClientPropertiesResult {
 public:
  ...
  void SetClientPropertiesList(ClientPropertiesListT&& value) {
    m_clientPropertiesListHasBeenSet = true;
    m_clientPropertiesList = std::forward<ClientPropertiesListT>(value);
  }
  template <typename ClientPropertiesListT = Aws::Vector<ClientPropertiesResult>>
  DescribeClientPropertiesResult& WithClientPropertiesList(ClientPropertiesListT&& value) {
    SetClientPropertiesList(std::forward<ClientPropertiesListT>(value));
    return *this;
  }
  template <typename ClientPropertiesListT = ClientPropertiesResult>
  DescribeClientPropertiesResult& AddClientPropertiesList(ClientPropertiesListT&& value) {
    m_clientPropertiesListHasBeenSet = true;
    m_clientPropertiesList.emplace_back(std::forward<ClientPropertiesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeClientPropertiesResult& WithRequestId(RequestIdT&& value) {
