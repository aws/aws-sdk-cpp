...
class GlobalAcceleratorForWorkSpace {
 public:
  ...
  inline void SetMode(AGAModeForWorkSpaceEnum value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline GlobalAcceleratorForWorkSpace& WithMode(AGAModeForWorkSpaceEnum value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreferredProtocol(AGAPreferredProtocolForWorkSpace value) {
    m_preferredProtocolHasBeenSet = true;
    m_preferredProtocol = value;
  }
  inline GlobalAcceleratorForWorkSpace& WithPreferredProtocol(AGAPreferredProtocolForWorkSpace value) {
