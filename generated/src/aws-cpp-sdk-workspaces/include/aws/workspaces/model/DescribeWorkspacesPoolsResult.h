...
class DescribeWorkspacesPoolsResult {
 public:
  ...
  void SetWorkspacesPools(WorkspacesPoolsT&& value) {
    m_workspacesPoolsHasBeenSet = true;
    m_workspacesPools = std::forward<WorkspacesPoolsT>(value);
  }
  template <typename WorkspacesPoolsT = Aws::Vector<WorkspacesPool>>
  DescribeWorkspacesPoolsResult& WithWorkspacesPools(WorkspacesPoolsT&& value) {
    SetWorkspacesPools(std::forward<WorkspacesPoolsT>(value));
    return *this;
  }
  template <typename WorkspacesPoolsT = WorkspacesPool>
  DescribeWorkspacesPoolsResult& AddWorkspacesPools(WorkspacesPoolsT&& value) {
    m_workspacesPoolsHasBeenSet = true;
    m_workspacesPools.emplace_back(std::forward<WorkspacesPoolsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeWorkspacesPoolsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkspacesPoolsResult& WithRequestId(RequestIdT&& value) {
