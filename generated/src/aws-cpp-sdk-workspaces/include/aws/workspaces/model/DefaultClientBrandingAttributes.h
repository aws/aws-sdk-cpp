...
class DefaultClientBrandingAttributes {
 public:
  ...
  template <typename LogoUrlT = Aws::String>
  DefaultClientBrandingAttributes& WithLogoUrl(LogoUrlT&& value) {
  ...
  template <typename SupportEmailT = Aws::String>
  DefaultClientBrandingAttributes& WithSupportEmail(SupportEmailT&& value) {
  ...
  template <typename SupportLinkT = Aws::String>
  DefaultClientBrandingAttributes& WithSupportLink(SupportLinkT&& value) {
  ...
  template <typename ForgotPasswordLinkT = Aws::String>
  DefaultClientBrandingAttributes& WithForgotPasswordLink(ForgotPasswordLinkT&& value) {
  ...
  template <typename LoginMessageT = Aws::Map<Aws::String, Aws::String>>
  DefaultClientBrandingAttributes& WithLoginMessage(LoginMessageT&& value) {
