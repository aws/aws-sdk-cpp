...
class DescribeWorkspaceDirectoriesFilter {
 public:
  ...
  inline void SetName(DescribeWorkspaceDirectoriesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DescribeWorkspaceDirectoriesFilter& WithName(DescribeWorkspaceDirectoriesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DescribeWorkspaceDirectoriesFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DescribeWorkspaceDirectoriesFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
