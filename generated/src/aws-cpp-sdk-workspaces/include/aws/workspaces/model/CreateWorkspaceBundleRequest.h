...
class CreateWorkspaceBundleRequest : public WorkSpacesRequest {
 public:
  ...
  void SetBundleDescription(BundleDescriptionT&& value) {
    m_bundleDescriptionHasBeenSet = true;
    m_bundleDescription = std::forward<BundleDescriptionT>(value);
  }
  template <typename BundleDescriptionT = Aws::String>
  CreateWorkspaceBundleRequest& WithBundleDescription(BundleDescriptionT&& value) {
    SetBundleDescription(std::forward<BundleDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComputeType(ComputeTypeT&& value) {
    ...
    m_computeType = std::forward<ComputeTypeT>(value);
  }
  template <typename ComputeTypeT = ComputeType>
  CreateWorkspaceBundleRequest& WithComputeType(ComputeTypeT&& value) {
    SetComputeType(std::forward<ComputeTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserStorage(UserStorageT&& value) {
    ...
    m_userStorage = std::forward<UserStorageT>(value);
  }
  template <typename UserStorageT = UserStorage>
  CreateWorkspaceBundleRequest& WithUserStorage(UserStorageT&& value) {
    SetUserStorage(std::forward<UserStorageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRootStorage(RootStorageT&& value) {
    ...
    m_rootStorage = std::forward<RootStorageT>(value);
  }
  template <typename RootStorageT = RootStorage>
  CreateWorkspaceBundleRequest& WithRootStorage(RootStorageT&& value) {
    SetRootStorage(std::forward<RootStorageT>(value));
    return *this;
  }
  ///@}
