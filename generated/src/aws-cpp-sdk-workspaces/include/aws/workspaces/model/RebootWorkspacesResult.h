...
class RebootWorkspacesResult {
 public:
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedWorkspaceChangeRequest>>
  RebootWorkspacesResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedWorkspaceChangeRequest>
  RebootWorkspacesResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RebootWorkspacesResult& WithRequestId(RequestIdT&& value) {
