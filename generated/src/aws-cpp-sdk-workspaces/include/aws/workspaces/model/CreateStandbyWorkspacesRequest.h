...
class CreateStandbyWorkspacesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename PrimaryRegionT = Aws::String>
  CreateStandbyWorkspacesRequest& WithPrimaryRegion(PrimaryRegionT&& value) {
  ...
  void SetStandbyWorkspaces(StandbyWorkspacesT&& value) {
    m_standbyWorkspacesHasBeenSet = true;
    m_standbyWorkspaces = std::forward<StandbyWorkspacesT>(value);
  }
  template <typename StandbyWorkspacesT = Aws::Vector<StandbyWorkspace>>
  CreateStandbyWorkspacesRequest& WithStandbyWorkspaces(StandbyWorkspacesT&& value) {
    SetStandbyWorkspaces(std::forward<StandbyWorkspacesT>(value));
    return *this;
  }
  template <typename StandbyWorkspacesT = StandbyWorkspace>
  CreateStandbyWorkspacesRequest& AddStandbyWorkspaces(StandbyWorkspacesT&& value) {
    m_standbyWorkspacesHasBeenSet = true;
    m_standbyWorkspaces.emplace_back(std::forward<StandbyWorkspacesT>(value));
    return *this;
  }
  ///@}
 private:
