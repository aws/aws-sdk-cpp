...
namespace Model
{
  ...
  public:
    ...
    inline AuthorizeIpRulesResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AuthorizeIpRulesResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AuthorizeIpRulesResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
