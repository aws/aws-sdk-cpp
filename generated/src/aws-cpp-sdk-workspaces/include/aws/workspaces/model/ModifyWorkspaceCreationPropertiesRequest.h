...
class ModifyWorkspaceCreationPropertiesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  ModifyWorkspaceCreationPropertiesRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename WorkspaceCreationPropertiesT = WorkspaceCreationProperties>
  ModifyWorkspaceCreationPropertiesRequest& WithWorkspaceCreationProperties(WorkspaceCreationPropertiesT&& value) {
