...
namespace Model
{
  ...
  {
  public:
    AWS_WORKSPACES_API ModifyEndpointEncryptionModeResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ModifyEndpointEncryptionModeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
