...
class ModifyWorkspaceAccessPropertiesRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  ModifyWorkspaceAccessPropertiesRequest& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename WorkspaceAccessPropertiesT = WorkspaceAccessProperties>
  ModifyWorkspaceAccessPropertiesRequest& WithWorkspaceAccessProperties(WorkspaceAccessPropertiesT&& value) {
