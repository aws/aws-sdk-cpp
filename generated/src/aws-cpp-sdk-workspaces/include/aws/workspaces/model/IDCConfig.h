...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceArnT = Aws::String>
    IDCConfig& WithInstanceArn(InstanceArnT&& value) { SetInstanceArn(std::forward<InstanceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ApplicationArnT = Aws::String>
    IDCConfig& WithApplicationArn(ApplicationArnT&& value) { SetApplicationArn(std::forward<ApplicationArnT>(value)); return *this;}
    ///@}
  private:
