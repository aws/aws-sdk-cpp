...
class DescribeApplicationAssociationsResult {
 public:
  ...
  AWS_WORKSPACES_API DescribeApplicationAssociationsResult& operator=(
  ...
  template <typename AssociationsT = Aws::Vector<ApplicationResourceAssociation>>
  DescribeApplicationAssociationsResult& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = ApplicationResourceAssociation>
  DescribeApplicationAssociationsResult& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeApplicationAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeApplicationAssociationsResult& WithRequestId(RequestIdT&& value) {
