...
class MigrateWorkspaceRequest : public WorkSpacesRequest {
 public:
  ...
  void SetSourceWorkspaceId(SourceWorkspaceIdT&& value) {
    m_sourceWorkspaceIdHasBeenSet = true;
    m_sourceWorkspaceId = std::forward<SourceWorkspaceIdT>(value);
  }
  template <typename SourceWorkspaceIdT = Aws::String>
  MigrateWorkspaceRequest& WithSourceWorkspaceId(SourceWorkspaceIdT&& value) {
    SetSourceWorkspaceId(std::forward<SourceWorkspaceIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BundleIdT = Aws::String>
  MigrateWorkspaceRequest& WithBundleId(BundleIdT&& value) {
