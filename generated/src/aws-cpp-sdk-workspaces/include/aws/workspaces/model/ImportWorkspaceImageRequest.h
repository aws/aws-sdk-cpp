...
class ImportWorkspaceImageRequest : public WorkSpacesRequest {
 public:
  ...
  void SetEc2ImageId(Ec2ImageIdT&& value) {
    m_ec2ImageIdHasBeenSet = true;
    m_ec2ImageId = std::forward<Ec2ImageIdT>(value);
  }
  template <typename Ec2ImageIdT = Aws::String>
  ImportWorkspaceImageRequest& WithEc2ImageId(Ec2ImageIdT&& value) {
    SetEc2ImageId(std::forward<Ec2ImageIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIngestionProcess(WorkspaceImageIngestionProcess value) {
    m_ingestionProcessHasBeenSet = true;
    m_ingestionProcess = value;
  }
  inline ImportWorkspaceImageRequest& WithIngestionProcess(WorkspaceImageIngestionProcess value) {
    SetIngestionProcess(value);
    return *this;
  }
  ///@}
  ...
  template <typename ImageNameT = Aws::String>
  ImportWorkspaceImageRequest& WithImageName(ImageNameT&& value) {
  ...
  template <typename ImageDescriptionT = Aws::String>
  ImportWorkspaceImageRequest& WithImageDescription(ImageDescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ImportWorkspaceImageRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ImportWorkspaceImageRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ApplicationsT = Aws::Vector<Application>>
  ImportWorkspaceImageRequest& WithApplications(ApplicationsT&& value) {
    SetApplications(std::forward<ApplicationsT>(value));
    return *this;
  }
  inline ImportWorkspaceImageRequest& AddApplications(Application value) {
    m_applicationsHasBeenSet = true;
    m_applications.push_back(value);
    return *this;
  }
  ///@}
 private:
