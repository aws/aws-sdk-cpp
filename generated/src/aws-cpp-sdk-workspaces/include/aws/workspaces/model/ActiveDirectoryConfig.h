...
class ActiveDirectoryConfig {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  ActiveDirectoryConfig& WithDomainName(DomainNameT&& value) {
  ...
  void SetServiceAccountSecretArn(ServiceAccountSecretArnT&& value) {
    m_serviceAccountSecretArnHasBeenSet = true;
    m_serviceAccountSecretArn = std::forward<ServiceAccountSecretArnT>(value);
  }
  template <typename ServiceAccountSecretArnT = Aws::String>
  ActiveDirectoryConfig& WithServiceAccountSecretArn(ServiceAccountSecretArnT&& value) {
    SetServiceAccountSecretArn(std::forward<ServiceAccountSecretArnT>(value));
    return *this;
  }
  ///@}
 private:
