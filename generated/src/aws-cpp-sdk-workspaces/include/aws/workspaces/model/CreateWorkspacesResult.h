...
class CreateWorkspacesResult {
 public:
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedCreateWorkspaceRequest>>
  CreateWorkspacesResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedCreateWorkspaceRequest>
  CreateWorkspacesResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename PendingRequestsT = Aws::Vector<Workspace>>
  CreateWorkspacesResult& WithPendingRequests(PendingRequestsT&& value) {
    SetPendingRequests(std::forward<PendingRequestsT>(value));
    return *this;
  }
  template <typename PendingRequestsT = Workspace>
  CreateWorkspacesResult& AddPendingRequests(PendingRequestsT&& value) {
    m_pendingRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorkspacesResult& WithRequestId(RequestIdT&& value) {
