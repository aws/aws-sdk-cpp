...
class StartWorkspacesRequest : public WorkSpacesRequest {
 public:
  ...
  void SetStartWorkspaceRequests(StartWorkspaceRequestsT&& value) {
    m_startWorkspaceRequestsHasBeenSet = true;
    m_startWorkspaceRequests = std::forward<StartWorkspaceRequestsT>(value);
  }
  template <typename StartWorkspaceRequestsT = Aws::Vector<StartRequest>>
  StartWorkspacesRequest& WithStartWorkspaceRequests(StartWorkspaceRequestsT&& value) {
    SetStartWorkspaceRequests(std::forward<StartWorkspaceRequestsT>(value));
    return *this;
  }
  template <typename StartWorkspaceRequestsT = StartRequest>
  StartWorkspacesRequest& AddStartWorkspaceRequests(StartWorkspaceRequestsT&& value) {
    m_startWorkspaceRequestsHasBeenSet = true;
    m_startWorkspaceRequests.emplace_back(std::forward<StartWorkspaceRequestsT>(value));
    return *this;
  }
  ///@}
 private:
