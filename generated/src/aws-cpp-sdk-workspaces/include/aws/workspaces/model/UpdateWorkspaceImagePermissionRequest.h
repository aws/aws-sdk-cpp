...
class UpdateWorkspaceImagePermissionRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename ImageIdT = Aws::String>
  UpdateWorkspaceImagePermissionRequest& WithImageId(ImageIdT&& value) {
  ...
  inline void SetAllowCopyImage(bool value) {
    m_allowCopyImageHasBeenSet = true;
    m_allowCopyImage = value;
  }
  inline UpdateWorkspaceImagePermissionRequest& WithAllowCopyImage(bool value) {
    SetAllowCopyImage(value);
    return *this;
  }
  ///@}
  ...
  template <typename SharedAccountIdT = Aws::String>
  UpdateWorkspaceImagePermissionRequest& WithSharedAccountId(SharedAccountIdT&& value) {
