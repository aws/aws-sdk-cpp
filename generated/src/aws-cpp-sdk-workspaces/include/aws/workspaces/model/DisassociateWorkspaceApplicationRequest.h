...
class DisassociateWorkspaceApplicationRequest : public WorkSpacesRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  DisassociateWorkspaceApplicationRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename ApplicationIdT = Aws::String>
  DisassociateWorkspaceApplicationRequest& WithApplicationId(ApplicationIdT&& value) {
