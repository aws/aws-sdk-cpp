...
class ModificationState {
 public:
  ...
  inline void SetResource(ModificationResourceEnum value) {
    m_resourceHasBeenSet = true;
    m_resource = value;
  }
  inline ModificationState& WithResource(ModificationResourceEnum value) {
    SetResource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(ModificationStateEnum value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ModificationState& WithState(ModificationStateEnum value) {
    SetState(value);
    return *this;
  }
  ///@}
