...
class FailedWorkspaceChangeRequest {
 public:
  AWS_WORKSPACES_API FailedWorkspaceChangeRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  FailedWorkspaceChangeRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  FailedWorkspaceChangeRequest& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  FailedWorkspaceChangeRequest& WithErrorMessage(ErrorMessageT&& value) {
