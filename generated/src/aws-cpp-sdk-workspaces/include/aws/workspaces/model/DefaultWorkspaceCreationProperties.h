...
class DefaultWorkspaceCreationProperties {
 public:
  ...
  inline void SetEnableInternetAccess(bool value) {
    m_enableInternetAccessHasBeenSet = true;
    m_enableInternetAccess = value;
  }
  inline DefaultWorkspaceCreationProperties& WithEnableInternetAccess(bool value) {
    SetEnableInternetAccess(value);
    return *this;
  }
  ///@}
  ...
  void SetDefaultOu(DefaultOuT&& value) {
    m_defaultOuHasBeenSet = true;
    m_defaultOu = std::forward<DefaultOuT>(value);
  }
  template <typename DefaultOuT = Aws::String>
  DefaultWorkspaceCreationProperties& WithDefaultOu(DefaultOuT&& value) {
    SetDefaultOu(std::forward<DefaultOuT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomSecurityGroupId(CustomSecurityGroupIdT&& value) {
    m_customSecurityGroupIdHasBeenSet = true;
    m_customSecurityGroupId = std::forward<CustomSecurityGroupIdT>(value);
  }
  template <typename CustomSecurityGroupIdT = Aws::String>
  DefaultWorkspaceCreationProperties& WithCustomSecurityGroupId(CustomSecurityGroupIdT&& value) {
    SetCustomSecurityGroupId(std::forward<CustomSecurityGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUserEnabledAsLocalAdministrator(bool value) {
    m_userEnabledAsLocalAdministratorHasBeenSet = true;
    m_userEnabledAsLocalAdministrator = value;
  }
  inline DefaultWorkspaceCreationProperties& WithUserEnabledAsLocalAdministrator(bool value) {
    SetUserEnabledAsLocalAdministrator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableMaintenanceMode(bool value) {
    m_enableMaintenanceModeHasBeenSet = true;
    m_enableMaintenanceMode = value;
  }
  inline DefaultWorkspaceCreationProperties& WithEnableMaintenanceMode(bool value) {
    SetEnableMaintenanceMode(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceIamRoleArn(InstanceIamRoleArnT&& value) {
    m_instanceIamRoleArnHasBeenSet = true;
    m_instanceIamRoleArn = std::forward<InstanceIamRoleArnT>(value);
  }
  template <typename InstanceIamRoleArnT = Aws::String>
  DefaultWorkspaceCreationProperties& WithInstanceIamRoleArn(InstanceIamRoleArnT&& value) {
    SetInstanceIamRoleArn(std::forward<InstanceIamRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
