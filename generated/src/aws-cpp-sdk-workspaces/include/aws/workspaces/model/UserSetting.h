...
class UserSetting {
 public:
  ...
  inline void SetAction(UserSettingActionEnum value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline UserSetting& WithAction(UserSettingActionEnum value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPermission(UserSettingPermissionEnum value) {
    m_permissionHasBeenSet = true;
    m_permission = value;
  }
  inline UserSetting& WithPermission(UserSettingPermissionEnum value) {
    SetPermission(value);
    return *this;
  }
  ///@}
