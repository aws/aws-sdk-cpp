...
namespace Model
{
  ...
  /**
   */
  class DescribeCertificateRequest : public ACMRequest
  {
  public:
    AWS_ACM_API DescribeCertificateRequest() = default;
    ...
    template<typename CertificateArnT = Aws::String>
    DescribeCertificateRequest& WithCertificateArn(CertificateArnT&& value) { SetCertificateArn(std::forward<CertificateArnT>(value)); return *this;}
    ///@}
  private:
