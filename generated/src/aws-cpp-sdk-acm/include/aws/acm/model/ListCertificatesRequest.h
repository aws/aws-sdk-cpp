...
class ListCertificatesRequest : public ACMRequest {
 public:
  ...
  void SetCertificateStatuses(CertificateStatusesT&& value) {
    m_certificateStatusesHasBeenSet = true;
    m_certificateStatuses = std::forward<CertificateStatusesT>(value);
  }
  template <typename CertificateStatusesT = Aws::Vector<CertificateStatus>>
  ListCertificatesRequest& WithCertificateStatuses(CertificateStatusesT&& value) {
    SetCertificateStatuses(std::forward<CertificateStatusesT>(value));
    return *this;
  }
  ...
  template <typename IncludesT = Filters>
  ListCertificatesRequest& WithIncludes(IncludesT&& value) {
  ...
  inline ListCertificatesRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
  ...
  inline ListCertificatesRequest& WithSortBy(SortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCertificatesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
