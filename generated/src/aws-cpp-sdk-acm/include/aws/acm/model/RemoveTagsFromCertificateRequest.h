...
class RemoveTagsFromCertificateRequest : public ACMRequest {
 public:
  AWS_ACM_API RemoveTagsFromCertificateRequest() = default;
  ...
  template <typename CertificateArnT = Aws::String>
  RemoveTagsFromCertificateRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  RemoveTagsFromCertificateRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  RemoveTagsFromCertificateRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
