...
class CertificateSummary {
 public:
   ...
   * <a
   * href="https://docs.aws.amazon.com/acm/latest/APIReference/API_DescribeCertificate.html">DescribeCertificate</a>.</p>
   */
  ...
  void SetSubjectAlternativeNameSummaries(SubjectAlternativeNameSummariesT&& value) {
    ...
    m_subjectAlternativeNameSummaries = std::forward<SubjectAlternativeNameSummariesT>(value);
  }
  template <typename SubjectAlternativeNameSummariesT = Aws::Vector<Aws::String>>
  CertificateSummary& WithSubjectAlternativeNameSummaries(SubjectAlternativeNameSummariesT&& value) {
    SetSubjectAlternativeNameSummaries(std::forward<SubjectAlternativeNameSummariesT>(value));
    return *this;
  }
  ...
  CertificateSummary& AddSubjectAlternativeNameSummaries(SubjectAlternativeNameSummariesT&& value) {
    m_subjectAlternativeNameSummariesHasBeenSet = true;
    m_subjectAlternativeNameSummaries.emplace_back(std::forward<SubjectAlternativeNameSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHasAdditionalSubjectAlternativeNames(bool value) {
    m_hasAdditionalSubjectAlternativeNamesHasBeenSet = true;
    m_hasAdditionalSubjectAlternativeNames = value;
  }
  inline CertificateSummary& WithHasAdditionalSubjectAlternativeNames(bool value) {
    SetHasAdditionalSubjectAlternativeNames(value);
    return *this;
  }
  ///@}
  ...
  inline CertificateSummary& WithStatus(CertificateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CertificateSummary& WithType(CertificateType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CertificateSummary& WithKeyAlgorithm(KeyAlgorithm value) {
  ...
  inline CertificateSummary& AddKeyUsages(KeyUsageName value) {
    m_keyUsagesHasBeenSet = true;
  ...
  inline CertificateSummary& AddExtendedKeyUsages(ExtendedKeyUsageName value) {
    m_extendedKeyUsagesHasBeenSet = true;
  ...
  inline CertificateSummary& WithExportOption(CertificateExport value) {
  ...
  inline CertificateSummary& WithInUse(bool value) {
    SetInUse(value);
    return *this;
  }
  ///@}
  ...
  inline CertificateSummary& WithExported(bool value) {
    SetExported(value);
    return *this;
  }
  ///@}
  ...
  inline CertificateSummary& WithRenewalEligibility(RenewalEligibility value) {
  ...
  inline CertificateSummary& WithManagedBy(CertificateManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
