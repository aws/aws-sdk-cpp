...
class Filters {
 public:
  ...
  template <typename ExtendedKeyUsageT = Aws::Vector<ExtendedKeyUsageName>>
  Filters& WithExtendedKeyUsage(ExtendedKeyUsageT&& value) {
    SetExtendedKeyUsage(std::forward<ExtendedKeyUsageT>(value));
    return *this;
  }
  inline Filters& AddExtendedKeyUsage(ExtendedKeyUsageName value) {
    m_extendedKeyUsageHasBeenSet = true;
    m_extendedKeyUsage.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename KeyUsageT = Aws::Vector<KeyUsageName>>
  Filters& WithKeyUsage(KeyUsageT&& value) {
    SetKeyUsage(std::forward<KeyUsageT>(value));
    return *this;
  }
  inline Filters& AddKeyUsage(KeyUsageName value) {
    m_keyUsageHasBeenSet = true;
    m_keyUsage.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetKeyTypes(KeyTypesT&& value) {
    m_keyTypesHasBeenSet = true;
    m_keyTypes = std::forward<KeyTypesT>(value);
  }
  template <typename KeyTypesT = Aws::Vector<KeyAlgorithm>>
  Filters& WithKeyTypes(KeyTypesT&& value) {
    SetKeyTypes(std::forward<KeyTypesT>(value));
    return *this;
  }
  inline Filters& AddKeyTypes(KeyAlgorithm value) {
    m_keyTypesHasBeenSet = true;
    m_keyTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline Filters& WithExportOption(CertificateExport value) {
  ...
  inline Filters& WithManagedBy(CertificateManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
