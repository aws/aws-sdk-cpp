...
class RequestCertificateRequest : public ACMRequest {
 public:
  ...
  inline RequestCertificateRequest& WithValidationMethod(ValidationMethod value) {
  ...
  inline RequestCertificateRequest& WithKeyAlgorithm(KeyAlgorithm value) {
  ...
  inline RequestCertificateRequest& WithManagedBy(CertificateManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
