...
/**
 * <p>Contains detailed information about an ACME endpoint.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/acm-2015-12-08/AcmeEndpoint">AWS
 * API Reference</a></p>
 */
class AcmeEndpoint {
 public:
  ...
  inline AcmeEndpoint& WithStatus(AcmeEndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AcmeEndpoint& WithAuthorizationBehavior(AcmeAuthorizationBehavior value) {
  ...
  inline AcmeEndpoint& WithContact(AcmeContact value) {
    SetContact(value);
    return *this;
  }
  ///@}
