...
class AddTagsToCertificateRequest : public ACMRequest {
 public:
  ...
  template <typename CertificateArnT = Aws::String>
  AddTagsToCertificateRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AddTagsToCertificateRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AddTagsToCertificateRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
