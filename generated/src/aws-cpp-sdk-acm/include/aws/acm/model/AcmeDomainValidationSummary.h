...
/**
 * <p>Contains summary information about an ACME domain validation.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/acm-2015-12-08/AcmeDomainValidationSummary">AWS
 * API Reference</a></p>
 */
class AcmeDomainValidationSummary {
 public:
  AWS_ACM_API AcmeDomainValidationSummary() = default;
  AWS_ACM_API AcmeDomainValidationSummary(Aws::Utils::Json::JsonView jsonValue);
  AWS_ACM_API AcmeDomainValidationSummary& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AcmeDomainValidationArnT = Aws::String>
  AcmeDomainValidationSummary& WithAcmeDomainValidationArn(AcmeDomainValidationArnT&& value) {
  ...
  template <typename AcmeEndpointArnT = Aws::String>
  AcmeDomainValidationSummary& WithAcmeEndpointArn(AcmeEndpointArnT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  AcmeDomainValidationSummary& WithDomainName(DomainNameT&& value) {
  ...
  inline AcmeDomainValidationSummary& WithPrevalidationType(PrevalidationType value) {
  ...
  template <typename PrevalidationDetailsT = PrevalidationDetails>
  AcmeDomainValidationSummary& WithPrevalidationDetails(PrevalidationDetailsT&& value) {
  ...
  inline AcmeDomainValidationSummary& WithStatus(AcmeDomainValidationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureDetailsT = FailureDetails>
  AcmeDomainValidationSummary& WithFailureDetails(FailureDetailsT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AcmeDomainValidationSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AcmeDomainValidationSummary& WithUpdatedAt(UpdatedAtT&& value) {
