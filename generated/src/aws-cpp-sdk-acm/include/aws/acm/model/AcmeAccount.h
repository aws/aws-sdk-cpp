...
/**
 * <p>Contains detailed information about an ACME account.</p><p><h3>See Also:</h3>
 * <a href="http://docs.aws.amazon.com/goto/WebAPI/acm-2015-12-08/AcmeAccount">AWS
 * API Reference</a></p>
 */
class AcmeAccount {
 public:
  AWS_ACM_API AcmeAccount() = default;
  AWS_ACM_API AcmeAccount(Aws::Utils::Json::JsonView jsonValue);
  AWS_ACM_API AcmeAccount& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename AccountUrlT = Aws::String>
  AcmeAccount& WithAccountUrl(AccountUrlT&& value) {
  ...
  template <typename PublicKeyThumbprintT = Aws::String>
  AcmeAccount& WithPublicKeyThumbprint(PublicKeyThumbprintT&& value) {
  ...
  inline AcmeAccount& WithStatus(AcmeAccountStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AcmeAccount& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename AcmeExternalAccountBindingArnT = Aws::String>
  AcmeAccount& WithAcmeExternalAccountBindingArn(AcmeExternalAccountBindingArnT&& value) {
  ...
  template <typename ContactsT = Aws::Vector<Aws::String>>
  AcmeAccount& WithContacts(ContactsT&& value) {
    SetContacts(std::forward<ContactsT>(value));
    return *this;
  }
  template <typename ContactsT = Aws::String>
  AcmeAccount& AddContacts(ContactsT&& value) {
    m_contactsHasBeenSet = true;
