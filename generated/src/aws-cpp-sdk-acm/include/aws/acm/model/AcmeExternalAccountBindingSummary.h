...
/**
 * <p>Contains summary information about an ACME external account
 * binding.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/acm-2015-12-08/AcmeExternalAccountBindingSummary">AWS
 * API Reference</a></p>
 */
class AcmeExternalAccountBindingSummary {
 public:
