...
DnsNameFilter::DnsNameFilter(JsonView jsonValue) { *this = jsonValue; }

DnsNameFilter& DnsNameFilter::operator=(JsonView jsonValue) {
...
JsonValue DnsNameFilter::Jsonize() const {
  JsonValue payload;
