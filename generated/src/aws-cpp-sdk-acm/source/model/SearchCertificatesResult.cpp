...
SearchCertificatesResult::SearchCertificatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchCertificatesResult& SearchCertificatesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
