...
AcmeDomainValidationSummary::AcmeDomainValidationSummary(JsonView jsonValue) { *this = jsonValue; }

AcmeDomainValidationSummary& AcmeDomainValidationSummary::operator=(JsonView jsonValue) {
...
JsonValue AcmeDomainValidationSummary::Jsonize() const {
  JsonValue payload;
