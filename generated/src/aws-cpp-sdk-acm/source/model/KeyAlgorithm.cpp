  ...
  namespace ACM
  {
    namespace Model
    {
      namespace KeyAlgorithmMapper
      {
        ...
        static constexpr uint32_t RSA_1024_HASH = ConstExprHashingUtils::HashString("RSA_1024");
        ...
        static constexpr uint32_t EC_secp521r1_HASH = ConstExprHashingUtils::HashString("EC_secp521r1");
