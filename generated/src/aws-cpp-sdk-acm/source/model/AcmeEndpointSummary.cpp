...
AcmeEndpointSummary::AcmeEndpointSummary(JsonView jsonValue) { *this = jsonValue; }

AcmeEndpointSummary& AcmeEndpointSummary::operator=(JsonView jsonValue) {
...
JsonValue AcmeEndpointSummary::Jsonize() const {
  JsonValue payload;
