...
static const int DOMAIN_VALIDATION_METHOD_HASH = HashingUtils::HashString("DOMAIN_VALIDATION_METHOD");

UpdateType GetUpdateTypeForName(const Aws::String& name) {
  int hashCode = HashingUtils::HashString(name.c_str());
  if (hashCode == DOMAIN_VALIDATION_METHOD_HASH) {
    return UpdateType::DOMAIN_VALIDATION_METHOD;
  }
...
Aws::String GetNameForUpdateType(UpdateType enumValue) {
  switch (enumValue) {
    case UpdateType::NOT_SET:
      return {};
    case UpdateType::DOMAIN_VALIDATION_METHOD:
