...
AcmeExternalAccountBindingSummary::AcmeExternalAccountBindingSummary(JsonView jsonValue) { *this = jsonValue; }

AcmeExternalAccountBindingSummary& AcmeExternalAccountBindingSummary::operator=(JsonView jsonValue) {
...
JsonValue AcmeExternalAccountBindingSummary::Jsonize() const {
  JsonValue payload;
