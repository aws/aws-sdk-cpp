...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ACMErrors::INTERNAL_SERVER), RetryableType::RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ACMErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ACMErrors::SERVICE_QUOTA_EXCEEDED), RetryableType::NOT_RETRYABLE);
