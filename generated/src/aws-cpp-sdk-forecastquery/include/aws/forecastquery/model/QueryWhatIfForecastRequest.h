...
class QueryWhatIfForecastRequest : public ForecastQueryServiceRequest {
 public:
  ...
  template <typename WhatIfForecastArnT = Aws::String>
  QueryWhatIfForecastRequest& WithWhatIfForecastArn(WhatIfForecastArnT&& value) {
  ...
  template <typename StartDateT = Aws::String>
  QueryWhatIfForecastRequest& WithStartDate(StartDateT&& value) {
  ...
  template <typename EndDateT = Aws::String>
  QueryWhatIfForecastRequest& WithEndDate(EndDateT&& value) {
  ...
  template <typename FiltersT = Aws::Map<Aws::String, Aws::String>>
  QueryWhatIfForecastRequest& WithFilters(FiltersT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  QueryWhatIfForecastRequest& WithNextToken(NextTokenT&& value) {
