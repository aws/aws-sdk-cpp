...
class AWS_FORECASTQUERYSERVICE_API ForecastQueryServiceClient
 ...
 public:
   ...
   */
  ForecastQueryServiceClient(const Aws::ForecastQueryService::ForecastQueryServiceClientConfiguration& clientConfiguration =
  ...
  ForecastQueryServiceClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<ForecastQueryServiceEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::ForecastQueryService::ForecastQueryServiceClientConfiguration& clientConfiguration =
                                 Aws::ForecastQueryService::ForecastQueryServiceClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  ForecastQueryServiceClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for QueryForecast that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename QueryForecastRequestT = Model::QueryForecastRequest>
  void QueryForecastAsync(const QueryForecastRequestT& request, const QueryForecastResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for QueryWhatIfForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for QueryWhatIfForecast that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename QueryWhatIfForecastRequestT = Model::QueryWhatIfForecastRequest>
  void QueryWhatIfForecastAsync(const QueryWhatIfForecastRequestT& request, const QueryWhatIfForecastResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
