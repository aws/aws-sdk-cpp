...
namespace ForecastQueryService
{
   ...
   */
  class AWS_FORECASTQUERYSERVICE_API ForecastQueryServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<ForecastQueryServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::ForecastQueryService::SERVICE_NAME,
