...
ListBackendJobsResult::ListBackendJobsResult()
{
}

ListBackendJobsResult::ListBackendJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListBackendJobsResult& ListBackendJobsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
