...
DeleteBackendStorageResult::DeleteBackendStorageResult()
{
}

DeleteBackendStorageResult::DeleteBackendStorageResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
