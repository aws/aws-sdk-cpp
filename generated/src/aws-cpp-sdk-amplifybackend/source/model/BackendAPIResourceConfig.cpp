...
BackendAPIResourceConfig::BackendAPIResourceConfig(JsonView jsonValue) { *this = jsonValue; }
...
BackendAPIResourceConfig& BackendAPIResourceConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("additionalAuthTypes")) {
    ...
    for (unsigned additionalAuthTypesIndex = 0; additionalAuthTypesIndex < additionalAuthTypesJsonList.GetLength();
         ++additionalAuthTypesIndex) {
