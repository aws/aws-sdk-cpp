...
CreateBackendResult::CreateBackendResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateBackendResult& CreateBackendResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
