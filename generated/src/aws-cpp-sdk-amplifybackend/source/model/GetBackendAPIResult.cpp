...
GetBackendAPIResult::GetBackendAPIResult()
{
}

GetBackendAPIResult::GetBackendAPIResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

GetBackendAPIResult& GetBackendAPIResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
