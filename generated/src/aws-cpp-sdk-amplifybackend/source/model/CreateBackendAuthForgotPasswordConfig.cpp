...
CreateBackendAuthForgotPasswordConfig::CreateBackendAuthForgotPasswordConfig(JsonView jsonValue) { *this = jsonValue; }

CreateBackendAuthForgotPasswordConfig& CreateBackendAuthForgotPasswordConfig::operator=(JsonView jsonValue) {
...
JsonValue CreateBackendAuthForgotPasswordConfig::Jsonize() const {
  JsonValue payload;
