...
public:
  ...
  AmplifyBackendError(const Aws::Client::AWSError<AmplifyBackendErrors>& rhs) : Aws::Client::AWSError<AmplifyBackendErrors>(rhs) {}
  AmplifyBackendError(Aws::Client::AWSError<AmplifyBackendErrors>&& rhs) : Aws::Client::AWSError<AmplifyBackendErrors>(rhs) {}
