...
class UpdateBackendAuthForgotPasswordConfig {
 public:
  ...
  inline void SetDeliveryMethod(DeliveryMethod value) {
    m_deliveryMethodHasBeenSet = true;
    m_deliveryMethod = value;
  }
  inline UpdateBackendAuthForgotPasswordConfig& WithDeliveryMethod(DeliveryMethod value) {
  ...
  void SetEmailSettings(EmailSettingsT&& value) {
    ...
    m_emailSettings = std::forward<EmailSettingsT>(value);
  }
  template <typename EmailSettingsT = EmailSettings>
  UpdateBackendAuthForgotPasswordConfig& WithEmailSettings(EmailSettingsT&& value) {
    SetEmailSettings(std::forward<EmailSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSmsSettings(SmsSettingsT&& value) {
    ...
    m_smsSettings = std::forward<SmsSettingsT>(value);
  }
  template <typename SmsSettingsT = SmsSettings>
  UpdateBackendAuthForgotPasswordConfig& WithSmsSettings(SmsSettingsT&& value) {
    SetSmsSettings(std::forward<SmsSettingsT>(value));
    return *this;
  }
  ///@}
 private:
