...
class CreateBackendStorageResourceConfig {
 public:
  ...
  template <typename BucketNameT = Aws::String>
  CreateBackendStorageResourceConfig& WithBucketName(BucketNameT&& value) {
  ...
  template <typename PermissionsT = BackendStoragePermissions>
  CreateBackendStorageResourceConfig& WithPermissions(PermissionsT&& value) {
  ...
  inline CreateBackendStorageResourceConfig& WithServiceName(ServiceName value) {
