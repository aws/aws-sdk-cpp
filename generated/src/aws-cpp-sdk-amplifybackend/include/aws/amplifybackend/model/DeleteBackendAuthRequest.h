...
class DeleteBackendAuthRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  DeleteBackendAuthRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  DeleteBackendAuthRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  DeleteBackendAuthRequest& WithResourceName(ResourceNameT&& value) {
