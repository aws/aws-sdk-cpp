...
class ImportBackendAuthResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ImportBackendAuthResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  ImportBackendAuthResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  ImportBackendAuthResult& WithError(ErrorT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ImportBackendAuthResult& WithJobId(JobIdT&& value) {
  ...
  template <typename OperationT = Aws::String>
  ImportBackendAuthResult& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ImportBackendAuthResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportBackendAuthResult& WithRequestId(RequestIdT&& value) {
