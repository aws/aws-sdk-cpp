...
class UpdateBackendAuthPasswordPolicyConfig {
 public:
  ...
  template <typename AdditionalConstraintsT = Aws::Vector<AdditionalConstraintsElement>>
  UpdateBackendAuthPasswordPolicyConfig& WithAdditionalConstraints(AdditionalConstraintsT&& value) {
    SetAdditionalConstraints(std::forward<AdditionalConstraintsT>(value));
    return *this;
  }
  inline UpdateBackendAuthPasswordPolicyConfig& AddAdditionalConstraints(AdditionalConstraintsElement value) {
    m_additionalConstraintsHasBeenSet = true;
  ...
  inline UpdateBackendAuthPasswordPolicyConfig& WithMinimumLength(double value) {
