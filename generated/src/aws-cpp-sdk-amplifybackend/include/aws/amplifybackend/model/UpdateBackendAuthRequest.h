...
class UpdateBackendAuthRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  UpdateBackendAuthRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  UpdateBackendAuthRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = UpdateBackendAuthResourceConfig>
  UpdateBackendAuthRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  UpdateBackendAuthRequest& WithResourceName(ResourceNameT&& value) {
