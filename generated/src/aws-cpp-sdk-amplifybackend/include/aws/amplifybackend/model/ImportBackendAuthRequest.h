...
class ImportBackendAuthRequest : public AmplifyBackendRequest {
 public:
  ...
  void SetNativeClientId(NativeClientIdT&& value) {
    m_nativeClientIdHasBeenSet = true;
    m_nativeClientId = std::forward<NativeClientIdT>(value);
  }
  template <typename NativeClientIdT = Aws::String>
  ImportBackendAuthRequest& WithNativeClientId(NativeClientIdT&& value) {
    SetNativeClientId(std::forward<NativeClientIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebClientId(WebClientIdT&& value) {
    m_webClientIdHasBeenSet = true;
    m_webClientId = std::forward<WebClientIdT>(value);
  }
  template <typename WebClientIdT = Aws::String>
  ImportBackendAuthRequest& WithWebClientId(WebClientIdT&& value) {
    SetWebClientId(std::forward<WebClientIdT>(value));
    return *this;
  }
  ///@}
 private:
