...
class GetBackendAPIRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GetBackendAPIRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GetBackendAPIRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = BackendAPIResourceConfig>
  GetBackendAPIRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  GetBackendAPIRequest& WithResourceName(ResourceNameT&& value) {
