...
class CloneBackendResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  CloneBackendResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  CloneBackendResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  CloneBackendResult& WithError(ErrorT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  CloneBackendResult& WithJobId(JobIdT&& value) {
  ...
  template <typename OperationT = Aws::String>
  CloneBackendResult& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  CloneBackendResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CloneBackendResult& WithRequestId(RequestIdT&& value) {
