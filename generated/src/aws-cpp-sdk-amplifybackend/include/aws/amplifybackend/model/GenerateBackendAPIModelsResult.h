...
namespace Model
{
  ...
  public:
    ...
    inline GenerateBackendAPIModelsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GenerateBackendAPIModelsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GenerateBackendAPIModelsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
