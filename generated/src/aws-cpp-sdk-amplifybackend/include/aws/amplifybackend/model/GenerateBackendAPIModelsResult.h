...
class GenerateBackendAPIModelsResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GenerateBackendAPIModelsResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GenerateBackendAPIModelsResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  GenerateBackendAPIModelsResult& WithError(ErrorT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  GenerateBackendAPIModelsResult& WithJobId(JobIdT&& value) {
  ...
  template <typename OperationT = Aws::String>
  GenerateBackendAPIModelsResult& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  GenerateBackendAPIModelsResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GenerateBackendAPIModelsResult& WithRequestId(RequestIdT&& value) {
