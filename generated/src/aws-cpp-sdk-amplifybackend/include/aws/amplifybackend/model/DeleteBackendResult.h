...
class DeleteBackendResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  DeleteBackendResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  DeleteBackendResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  DeleteBackendResult& WithError(ErrorT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  DeleteBackendResult& WithJobId(JobIdT&& value) {
  ...
  template <typename OperationT = Aws::String>
  DeleteBackendResult& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DeleteBackendResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBackendResult& WithRequestId(RequestIdT&& value) {
