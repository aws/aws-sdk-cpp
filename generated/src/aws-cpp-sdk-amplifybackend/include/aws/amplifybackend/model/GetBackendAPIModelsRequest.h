...
class GetBackendAPIModelsRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GetBackendAPIModelsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GetBackendAPIModelsRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  GetBackendAPIModelsRequest& WithResourceName(ResourceNameT&& value) {
