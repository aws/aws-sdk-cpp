...
namespace Model
{
  ...
  {
  public:
    AWS_AMPLIFYBACKEND_API GetBackendAPIModelsRequest() = default;
    ...
    template<typename AppIdT = Aws::String>
    GetBackendAPIModelsRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BackendEnvironmentNameT = Aws::String>
    GetBackendAPIModelsRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) { SetBackendEnvironmentName(std::forward<BackendEnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceNameT = Aws::String>
    GetBackendAPIModelsRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
  private:
