...
class CreateBackendAuthPasswordPolicyConfig {
 public:
  ...
  void SetAdditionalConstraints(AdditionalConstraintsT&& value) {
    m_additionalConstraintsHasBeenSet = true;
    m_additionalConstraints = std::forward<AdditionalConstraintsT>(value);
  }
  template <typename AdditionalConstraintsT = Aws::Vector<AdditionalConstraintsElement>>
  CreateBackendAuthPasswordPolicyConfig& WithAdditionalConstraints(AdditionalConstraintsT&& value) {
    SetAdditionalConstraints(std::forward<AdditionalConstraintsT>(value));
    return *this;
  }
  inline CreateBackendAuthPasswordPolicyConfig& AddAdditionalConstraints(AdditionalConstraintsElement value) {
    m_additionalConstraintsHasBeenSet = true;
    m_additionalConstraints.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumLength(double value) {
    m_minimumLengthHasBeenSet = true;
    m_minimumLength = value;
  }
  inline CreateBackendAuthPasswordPolicyConfig& WithMinimumLength(double value) {
