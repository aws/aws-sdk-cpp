...
class UpdateBackendAPIRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  UpdateBackendAPIRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  UpdateBackendAPIRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = BackendAPIResourceConfig>
  UpdateBackendAPIRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  UpdateBackendAPIRequest& WithResourceName(ResourceNameT&& value) {
