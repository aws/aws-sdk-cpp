...
class GetBackendAPIModelsResult {
 public:
  ...
  template <typename ModelsT = Aws::String>
  GetBackendAPIModelsResult& WithModels(ModelsT&& value) {
  ...
  inline GetBackendAPIModelsResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetModelIntrospectionSchema(ModelIntrospectionSchemaT&& value) {
    m_modelIntrospectionSchemaHasBeenSet = true;
    m_modelIntrospectionSchema = std::forward<ModelIntrospectionSchemaT>(value);
  }
  template <typename ModelIntrospectionSchemaT = Aws::String>
  GetBackendAPIModelsResult& WithModelIntrospectionSchema(ModelIntrospectionSchemaT&& value) {
    SetModelIntrospectionSchema(std::forward<ModelIntrospectionSchemaT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBackendAPIModelsResult& WithRequestId(RequestIdT&& value) {
