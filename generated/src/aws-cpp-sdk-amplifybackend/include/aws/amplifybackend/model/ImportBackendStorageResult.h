...
class ImportBackendStorageResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ImportBackendStorageResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  ImportBackendStorageResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ImportBackendStorageResult& WithJobId(JobIdT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ImportBackendStorageResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportBackendStorageResult& WithRequestId(RequestIdT&& value) {
