...
class UpdateBackendAuthResourceConfig {
 public:
  ...
  inline void SetAuthResources(AuthResources value) {
    m_authResourcesHasBeenSet = true;
    m_authResources = value;
  }
  inline UpdateBackendAuthResourceConfig& WithAuthResources(AuthResources value) {
    SetAuthResources(value);
    return *this;
  }
  ///@}
  ...
  void SetIdentityPoolConfigs(IdentityPoolConfigsT&& value) {
    ...
    m_identityPoolConfigs = std::forward<IdentityPoolConfigsT>(value);
  }
  template <typename IdentityPoolConfigsT = UpdateBackendAuthIdentityPoolConfig>
  UpdateBackendAuthResourceConfig& WithIdentityPoolConfigs(IdentityPoolConfigsT&& value) {
    SetIdentityPoolConfigs(std::forward<IdentityPoolConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateBackendAuthResourceConfig& WithService(Service value) {
    SetService(value);
    return *this;
  }
  ///@}
  ...
  void SetUserPoolConfigs(UserPoolConfigsT&& value) {
    ...
    m_userPoolConfigs = std::forward<UserPoolConfigsT>(value);
  }
  template <typename UserPoolConfigsT = UpdateBackendAuthUserPoolConfig>
  UpdateBackendAuthResourceConfig& WithUserPoolConfigs(UserPoolConfigsT&& value) {
    SetUserPoolConfigs(std::forward<UserPoolConfigsT>(value));
    return *this;
  }
  ///@}
 private:
