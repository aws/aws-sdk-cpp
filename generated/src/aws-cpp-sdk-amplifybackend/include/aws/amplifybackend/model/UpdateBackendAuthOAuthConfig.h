...
class UpdateBackendAuthOAuthConfig {
 public:
  ...
  void SetDomainPrefix(DomainPrefixT&& value) {
    ...
    m_domainPrefix = std::forward<DomainPrefixT>(value);
  }
  template <typename DomainPrefixT = Aws::String>
  UpdateBackendAuthOAuthConfig& WithDomainPrefix(DomainPrefixT&& value) {
    SetDomainPrefix(std::forward<DomainPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOAuthGrantType(OAuthGrantType value) {
    m_oAuthGrantTypeHasBeenSet = true;
    m_oAuthGrantType = value;
  }
  inline UpdateBackendAuthOAuthConfig& WithOAuthGrantType(OAuthGrantType value) {
    SetOAuthGrantType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBackendAuthOAuthConfig& AddOAuthScopes(OAuthScopesElement value) {
    m_oAuthScopesHasBeenSet = true;
    m_oAuthScopes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetRedirectSignInURIs(RedirectSignInURIsT&& value) {
    ...
    m_redirectSignInURIs = std::forward<RedirectSignInURIsT>(value);
  }
  template <typename RedirectSignInURIsT = Aws::Vector<Aws::String>>
  UpdateBackendAuthOAuthConfig& WithRedirectSignInURIs(RedirectSignInURIsT&& value) {
    SetRedirectSignInURIs(std::forward<RedirectSignInURIsT>(value));
    return *this;
  }
  ...
  UpdateBackendAuthOAuthConfig& AddRedirectSignInURIs(RedirectSignInURIsT&& value) {
    m_redirectSignInURIsHasBeenSet = true;
    m_redirectSignInURIs.emplace_back(std::forward<RedirectSignInURIsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedirectSignOutURIs(RedirectSignOutURIsT&& value) {
    ...
    m_redirectSignOutURIs = std::forward<RedirectSignOutURIsT>(value);
  }
  template <typename RedirectSignOutURIsT = Aws::Vector<Aws::String>>
  UpdateBackendAuthOAuthConfig& WithRedirectSignOutURIs(RedirectSignOutURIsT&& value) {
    SetRedirectSignOutURIs(std::forward<RedirectSignOutURIsT>(value));
    return *this;
  }
  ...
  UpdateBackendAuthOAuthConfig& AddRedirectSignOutURIs(RedirectSignOutURIsT&& value) {
    m_redirectSignOutURIsHasBeenSet = true;
    m_redirectSignOutURIs.emplace_back(std::forward<RedirectSignOutURIsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSocialProviderSettings(SocialProviderSettingsT&& value) {
    ...
    m_socialProviderSettings = std::forward<SocialProviderSettingsT>(value);
  }
  template <typename SocialProviderSettingsT = SocialProviderSettings>
  UpdateBackendAuthOAuthConfig& WithSocialProviderSettings(SocialProviderSettingsT&& value) {
    SetSocialProviderSettings(std::forward<SocialProviderSettingsT>(value));
    return *this;
  }
  ///@}
 private:
