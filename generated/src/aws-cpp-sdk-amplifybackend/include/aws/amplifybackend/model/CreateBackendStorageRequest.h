...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class CreateBackendStorageRequest : public AmplifyBackendRequest
  {
  public:
    ...
    template<typename AppIdT = Aws::String>
    CreateBackendStorageRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BackendEnvironmentNameT = Aws::String>
    CreateBackendStorageRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) { SetBackendEnvironmentName(std::forward<BackendEnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceConfigT = CreateBackendStorageResourceConfig>
    ...
    template<typename ResourceConfigT = CreateBackendStorageResourceConfig>
    CreateBackendStorageRequest& WithResourceConfig(ResourceConfigT&& value) { SetResourceConfig(std::forward<ResourceConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceNameT = Aws::String>
    CreateBackendStorageRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
  private:
