...
class ListBackendJobsResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<BackendJobRespObj>>
  ListBackendJobsResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = BackendJobRespObj>
  ListBackendJobsResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListBackendJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBackendJobsResult& WithRequestId(RequestIdT&& value) {
