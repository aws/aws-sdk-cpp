...
class CreateBackendAuthOAuthConfig {
 public:
  ...
  inline CreateBackendAuthOAuthConfig& WithOAuthGrantType(OAuthGrantType value) {
  ...
  inline CreateBackendAuthOAuthConfig& AddOAuthScopes(OAuthScopesElement value) {
    m_oAuthScopesHasBeenSet = true;
