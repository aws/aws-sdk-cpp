...
class RemoveAllBackendsRequest : public AmplifyBackendRequest {
 public:
  ...
  inline void SetCleanAmplifyApp(bool value) {
    m_cleanAmplifyAppHasBeenSet = true;
    m_cleanAmplifyApp = value;
  }
  inline RemoveAllBackendsRequest& WithCleanAmplifyApp(bool value) {
    SetCleanAmplifyApp(value);
    return *this;
  }
  ///@}
 private:
