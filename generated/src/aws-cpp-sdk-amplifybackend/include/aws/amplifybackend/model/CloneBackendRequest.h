...
class CloneBackendRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  CloneBackendRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  CloneBackendRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  void SetTargetEnvironmentName(TargetEnvironmentNameT&& value) {
    m_targetEnvironmentNameHasBeenSet = true;
    m_targetEnvironmentName = std::forward<TargetEnvironmentNameT>(value);
  }
  template <typename TargetEnvironmentNameT = Aws::String>
  CloneBackendRequest& WithTargetEnvironmentName(TargetEnvironmentNameT&& value) {
    SetTargetEnvironmentName(std::forward<TargetEnvironmentNameT>(value));
    return *this;
  }
  ///@}
 private:
