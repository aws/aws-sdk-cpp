...
class DeleteBackendStorageResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  DeleteBackendStorageResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  DeleteBackendStorageResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  DeleteBackendStorageResult& WithJobId(JobIdT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DeleteBackendStorageResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBackendStorageResult& WithRequestId(RequestIdT&& value) {
