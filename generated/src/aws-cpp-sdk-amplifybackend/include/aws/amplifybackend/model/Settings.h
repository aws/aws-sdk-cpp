...
class Settings {
 public:
  ...
  void SetMfaTypes(MfaTypesT&& value) {
    m_mfaTypesHasBeenSet = true;
    m_mfaTypes = std::forward<MfaTypesT>(value);
  }
  template <typename MfaTypesT = Aws::Vector<MfaTypesElement>>
  Settings& WithMfaTypes(MfaTypesT&& value) {
    SetMfaTypes(std::forward<MfaTypesT>(value));
    return *this;
  }
  inline Settings& AddMfaTypes(MfaTypesElement value) {
    m_mfaTypesHasBeenSet = true;
    m_mfaTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSmsMessage(SmsMessageT&& value) {
    ...
    m_smsMessage = std::forward<SmsMessageT>(value);
  }
  template <typename SmsMessageT = Aws::String>
  Settings& WithSmsMessage(SmsMessageT&& value) {
    SetSmsMessage(std::forward<SmsMessageT>(value));
    return *this;
  }
  ///@}
 private:
