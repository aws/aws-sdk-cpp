...
class UpdateBackendAuthUserPoolConfig {
 public:
  ...
  void SetForgotPassword(ForgotPasswordT&& value) {
    ...
    m_forgotPassword = std::forward<ForgotPasswordT>(value);
  }
  template <typename ForgotPasswordT = UpdateBackendAuthForgotPasswordConfig>
  UpdateBackendAuthUserPoolConfig& WithForgotPassword(ForgotPasswordT&& value) {
    SetForgotPassword(std::forward<ForgotPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerificationMessage(VerificationMessageT&& value) {
    ...
    m_verificationMessage = std::forward<VerificationMessageT>(value);
  }
  template <typename VerificationMessageT = UpdateBackendAuthVerificationMessageConfig>
  UpdateBackendAuthUserPoolConfig& WithVerificationMessage(VerificationMessageT&& value) {
    SetVerificationMessage(std::forward<VerificationMessageT>(value));
    return *this;
  }
  ///@}
 private:
