...
class BackendAPIResourceConfig {
 public:
  ...
  void SetAdditionalAuthTypes(AdditionalAuthTypesT&& value) {
    ...
    m_additionalAuthTypes = std::forward<AdditionalAuthTypesT>(value);
  }
  template <typename AdditionalAuthTypesT = Aws::Vector<BackendAPIAuthType>>
  BackendAPIResourceConfig& WithAdditionalAuthTypes(AdditionalAuthTypesT&& value) {
    SetAdditionalAuthTypes(std::forward<AdditionalAuthTypesT>(value));
    return *this;
  }
  ...
  BackendAPIResourceConfig& AddAdditionalAuthTypes(AdditionalAuthTypesT&& value) {
    m_additionalAuthTypesHasBeenSet = true;
    m_additionalAuthTypes.emplace_back(std::forward<AdditionalAuthTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultAuthType(DefaultAuthTypeT&& value) {
    ...
    m_defaultAuthType = std::forward<DefaultAuthTypeT>(value);
  }
  template <typename DefaultAuthTypeT = BackendAPIAuthType>
  BackendAPIResourceConfig& WithDefaultAuthType(DefaultAuthTypeT&& value) {
    SetDefaultAuthType(std::forward<DefaultAuthTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformSchema(TransformSchemaT&& value) {
    ...
    m_transformSchema = std::forward<TransformSchemaT>(value);
  }
  template <typename TransformSchemaT = Aws::String>
  BackendAPIResourceConfig& WithTransformSchema(TransformSchemaT&& value) {
    SetTransformSchema(std::forward<TransformSchemaT>(value));
    return *this;
  }
  ///@}
 private:
