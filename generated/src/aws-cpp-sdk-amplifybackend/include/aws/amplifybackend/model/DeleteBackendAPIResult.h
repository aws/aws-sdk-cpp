...
class DeleteBackendAPIResult {
 public:
  ...
  template <typename AppIdT = Aws::String>
  DeleteBackendAPIResult& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  DeleteBackendAPIResult& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  DeleteBackendAPIResult& WithError(ErrorT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  DeleteBackendAPIResult& WithJobId(JobIdT&& value) {
  ...
  template <typename OperationT = Aws::String>
  DeleteBackendAPIResult& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DeleteBackendAPIResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBackendAPIResult& WithRequestId(RequestIdT&& value) {
