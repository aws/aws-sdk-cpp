...
class CreateBackendAuthMFAConfig {
 public:
  ...
  inline void SetMFAMode(MFAMode value) {
    m_mFAModeHasBeenSet = true;
    m_mFAMode = value;
  }
  inline CreateBackendAuthMFAConfig& WithMFAMode(MFAMode value) {
    SetMFAMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename SettingsT = Settings>
  CreateBackendAuthMFAConfig& WithSettings(SettingsT&& value) {
