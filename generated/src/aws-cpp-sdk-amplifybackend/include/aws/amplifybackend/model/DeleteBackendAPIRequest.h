...
class DeleteBackendAPIRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  DeleteBackendAPIRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  DeleteBackendAPIRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = BackendAPIResourceConfig>
  DeleteBackendAPIRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  DeleteBackendAPIRequest& WithResourceName(ResourceNameT&& value) {
