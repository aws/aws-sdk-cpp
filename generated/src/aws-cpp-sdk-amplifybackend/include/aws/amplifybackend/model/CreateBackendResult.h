...
namespace Model
{
  ...
  public:
     ...
     * <p>The current status of the request.</p>
     */
    inline CreateBackendResult& WithStatus(const char* value) { SetStatus(value); return *this;}
    ...
    inline CreateBackendResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateBackendResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateBackendResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
