...
class GetBackendStorageRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GetBackendStorageRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GetBackendStorageRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  GetBackendStorageRequest& WithResourceName(ResourceNameT&& value) {
