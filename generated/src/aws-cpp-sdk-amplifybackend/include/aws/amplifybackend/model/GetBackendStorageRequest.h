...
namespace Model
{
  ...
  {
  public:
    AWS_AMPLIFYBACKEND_API GetBackendStorageRequest() = default;
    ...
    template<typename AppIdT = Aws::String>
    GetBackendStorageRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BackendEnvironmentNameT = Aws::String>
    GetBackendStorageRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) { SetBackendEnvironmentName(std::forward<BackendEnvironmentNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceNameT = Aws::String>
    GetBackendStorageRequest& WithResourceName(ResourceNameT&& value) { SetResourceName(std::forward<ResourceNameT>(value)); return *this;}
    ///@}
  private:
