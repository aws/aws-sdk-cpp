...
class GetBackendAuthRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GetBackendAuthRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GetBackendAuthRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  GetBackendAuthRequest& WithResourceName(ResourceNameT&& value) {
