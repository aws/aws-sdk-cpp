...
class CreateBackendAuthForgotPasswordConfig {
 public:
  AWS_AMPLIFYBACKEND_API CreateBackendAuthForgotPasswordConfig() = default;
  ...
  inline CreateBackendAuthForgotPasswordConfig& WithDeliveryMethod(DeliveryMethod value) {
  ...
  template <typename EmailSettingsT = EmailSettings>
  CreateBackendAuthForgotPasswordConfig& WithEmailSettings(EmailSettingsT&& value) {
  ...
  template <typename SmsSettingsT = SmsSettings>
  CreateBackendAuthForgotPasswordConfig& WithSmsSettings(SmsSettingsT&& value) {
