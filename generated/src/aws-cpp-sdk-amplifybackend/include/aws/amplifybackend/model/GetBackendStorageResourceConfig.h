...
class GetBackendStorageResourceConfig {
 public:
  ...
  inline void SetImported(bool value) {
    m_importedHasBeenSet = true;
    m_imported = value;
  }
  inline GetBackendStorageResourceConfig& WithImported(bool value) {
    SetImported(value);
    return *this;
  }
  ///@}
  ...
  inline GetBackendStorageResourceConfig& WithServiceName(ServiceName value) {
