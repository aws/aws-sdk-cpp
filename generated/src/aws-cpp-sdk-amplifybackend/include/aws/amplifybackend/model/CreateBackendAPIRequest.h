...
class CreateBackendAPIRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  CreateBackendAPIRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  CreateBackendAPIRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = BackendAPIResourceConfig>
  CreateBackendAPIRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  CreateBackendAPIRequest& WithResourceName(ResourceNameT&& value) {
