...
class CreateBackendRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  CreateBackendRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename AppNameT = Aws::String>
  CreateBackendRequest& WithAppName(AppNameT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  CreateBackendRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceConfigT = ResourceConfig>
  CreateBackendRequest& WithResourceConfig(ResourceConfigT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  CreateBackendRequest& WithResourceName(ResourceNameT&& value) {
