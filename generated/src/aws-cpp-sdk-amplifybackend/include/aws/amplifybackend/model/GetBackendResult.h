...
class GetBackendResult {
 public:
  ...
  void SetAmplifyFeatureFlags(AmplifyFeatureFlagsT&& value) {
    ...
    m_amplifyFeatureFlags = std::forward<AmplifyFeatureFlagsT>(value);
  }
  template <typename AmplifyFeatureFlagsT = Aws::String>
  GetBackendResult& WithAmplifyFeatureFlags(AmplifyFeatureFlagsT&& value) {
    SetAmplifyFeatureFlags(std::forward<AmplifyFeatureFlagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmplifyMetaConfig(AmplifyMetaConfigT&& value) {
    ...
    m_amplifyMetaConfig = std::forward<AmplifyMetaConfigT>(value);
  }
  template <typename AmplifyMetaConfigT = Aws::String>
  GetBackendResult& WithAmplifyMetaConfig(AmplifyMetaConfigT&& value) {
    SetAmplifyMetaConfig(std::forward<AmplifyMetaConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBackendEnvironmentList(BackendEnvironmentListT&& value) {
    ...
    m_backendEnvironmentList = std::forward<BackendEnvironmentListT>(value);
  }
  template <typename BackendEnvironmentListT = Aws::Vector<Aws::String>>
  GetBackendResult& WithBackendEnvironmentList(BackendEnvironmentListT&& value) {
    SetBackendEnvironmentList(std::forward<BackendEnvironmentListT>(value));
    return *this;
  }
  ...
  GetBackendResult& AddBackendEnvironmentList(BackendEnvironmentListT&& value) {
    m_backendEnvironmentListHasBeenSet = true;
    m_backendEnvironmentList.emplace_back(std::forward<BackendEnvironmentListT>(value));
    return *this;
  }
  ///@}
