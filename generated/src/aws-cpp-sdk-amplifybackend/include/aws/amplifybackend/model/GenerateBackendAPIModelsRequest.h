...
class GenerateBackendAPIModelsRequest : public AmplifyBackendRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  GenerateBackendAPIModelsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  GenerateBackendAPIModelsRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename ResourceNameT = Aws::String>
  GenerateBackendAPIModelsRequest& WithResourceName(ResourceNameT&& value) {
