...
class ListBackendJobsRequest : public AmplifyBackendRequest {
 public:
  AWS_AMPLIFYBACKEND_API ListBackendJobsRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  ListBackendJobsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename BackendEnvironmentNameT = Aws::String>
  ListBackendJobsRequest& WithBackendEnvironmentName(BackendEnvironmentNameT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  ListBackendJobsRequest& WithJobId(JobIdT&& value) {
  ...
  inline ListBackendJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBackendJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename OperationT = Aws::String>
  ListBackendJobsRequest& WithOperation(OperationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ListBackendJobsRequest& WithStatus(StatusT&& value) {
