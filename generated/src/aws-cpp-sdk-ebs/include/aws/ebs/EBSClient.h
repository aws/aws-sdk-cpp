...
class AWS_EBS_API EBSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EBSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<EBSEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CompleteSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CompleteSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CompleteSnapshotRequestT = Model::CompleteSnapshotRequest>
  void CompleteSnapshotAsync(const CompleteSnapshotRequestT& request, const CompleteSnapshotResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for GetSnapshotBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSnapshotBlock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSnapshotBlockRequestT = Model::GetSnapshotBlockRequest>
  void GetSnapshotBlockAsync(const GetSnapshotBlockRequestT& request, const GetSnapshotBlockResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChangedBlocks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChangedBlocks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListChangedBlocksRequestT = Model::ListChangedBlocksRequest>
  void ListChangedBlocksAsync(const ListChangedBlocksRequestT& request, const ListChangedBlocksResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSnapshotBlocks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSnapshotBlocks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSnapshotBlocksRequestT = Model::ListSnapshotBlocksRequest>
  void ListSnapshotBlocksAsync(const ListSnapshotBlocksRequestT& request, const ListSnapshotBlocksResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutSnapshotBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutSnapshotBlock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutSnapshotBlockRequestT = Model::PutSnapshotBlockRequest>
  void PutSnapshotBlockAsync(const PutSnapshotBlockRequestT& request, const PutSnapshotBlockResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartSnapshot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartSnapshotRequestT = Model::StartSnapshotRequest>
  void StartSnapshotAsync(const StartSnapshotRequestT& request, const StartSnapshotResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
