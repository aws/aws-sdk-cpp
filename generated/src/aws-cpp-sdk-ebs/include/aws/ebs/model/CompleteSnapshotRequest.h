...
class CompleteSnapshotRequest : public EBSRequest {
 public:
  ...
  inline void SetChangedBlocksCount(int value) {
    m_changedBlocksCountHasBeenSet = true;
    m_changedBlocksCount = value;
  }
  inline CompleteSnapshotRequest& WithChangedBlocksCount(int value) {
    SetChangedBlocksCount(value);
    return *this;
  }
  ///@}
  ...
  inline CompleteSnapshotRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  inline void SetChecksumAggregationMethod(ChecksumAggregationMethod value) {
    m_checksumAggregationMethodHasBeenSet = true;
    m_checksumAggregationMethod = value;
  }
  inline CompleteSnapshotRequest& WithChecksumAggregationMethod(ChecksumAggregationMethod value) {
    SetChecksumAggregationMethod(value);
    return *this;
  }
  ///@}
 private:
