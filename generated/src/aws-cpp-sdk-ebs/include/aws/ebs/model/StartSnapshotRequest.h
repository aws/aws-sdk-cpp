...
class StartSnapshotRequest : public EBSRequest {
 public:
  ...
  inline StartSnapshotRequest& WithVolumeSize(long long value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline StartSnapshotRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline StartSnapshotRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
