...
class ChangedBlock {
 public:
  ...
  inline void SetBlockIndex(int value) {
    m_blockIndexHasBeenSet = true;
    m_blockIndex = value;
  }
  inline ChangedBlock& WithBlockIndex(int value) {
    SetBlockIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetFirstBlockToken(FirstBlockTokenT&& value) {
    ...
    m_firstBlockToken = std::forward<FirstBlockTokenT>(value);
  }
  template <typename FirstBlockTokenT = Aws::String>
  ChangedBlock& WithFirstBlockToken(FirstBlockTokenT&& value) {
    SetFirstBlockToken(std::forward<FirstBlockTokenT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondBlockToken(SecondBlockTokenT&& value) {
    ...
    m_secondBlockToken = std::forward<SecondBlockTokenT>(value);
  }
  template <typename SecondBlockTokenT = Aws::String>
  ChangedBlock& WithSecondBlockToken(SecondBlockTokenT&& value) {
    SetSecondBlockToken(std::forward<SecondBlockTokenT>(value));
    return *this;
  }
  ///@}
 private:
