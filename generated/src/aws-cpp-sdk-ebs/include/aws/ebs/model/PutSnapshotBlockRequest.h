...
class PutSnapshotBlockRequest : public StreamingEBSRequest {
 public:
  ...
  inline PutSnapshotBlockRequest& WithBlockIndex(int value) {
    SetBlockIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataLength(int value) {
    m_dataLengthHasBeenSet = true;
    m_dataLength = value;
  }
  inline PutSnapshotBlockRequest& WithDataLength(int value) {
    SetDataLength(value);
    return *this;
  }
  ///@}
  ...
  inline PutSnapshotBlockRequest& WithProgress(int value) {
    SetProgress(value);
    return *this;
  }
  ///@}
  ...
  inline PutSnapshotBlockRequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
