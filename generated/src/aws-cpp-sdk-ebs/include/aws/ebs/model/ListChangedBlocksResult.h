...
class ListChangedBlocksResult {
 public:
  ...
  void SetChangedBlocks(ChangedBlocksT&& value) {
    m_changedBlocksHasBeenSet = true;
    m_changedBlocks = std::forward<ChangedBlocksT>(value);
  }
  template <typename ChangedBlocksT = Aws::Vector<ChangedBlock>>
  ListChangedBlocksResult& WithChangedBlocks(ChangedBlocksT&& value) {
    SetChangedBlocks(std::forward<ChangedBlocksT>(value));
    return *this;
  }
  template <typename ChangedBlocksT = ChangedBlock>
  ListChangedBlocksResult& AddChangedBlocks(ChangedBlocksT&& value) {
    m_changedBlocksHasBeenSet = true;
    m_changedBlocks.emplace_back(std::forward<ChangedBlocksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpiryTimeT = Aws::Utils::DateTime>
  ListChangedBlocksResult& WithExpiryTime(ExpiryTimeT&& value) {
  ...
  inline ListChangedBlocksResult& WithVolumeSize(long long value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline ListChangedBlocksResult& WithBlockSize(int value) {
    SetBlockSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChangedBlocksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChangedBlocksResult& WithRequestId(RequestIdT&& value) {
