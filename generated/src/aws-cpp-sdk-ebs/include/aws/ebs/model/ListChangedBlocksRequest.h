...
class ListChangedBlocksRequest : public EBSRequest {
 public:
  ...
  void SetFirstSnapshotId(FirstSnapshotIdT&& value) {
    m_firstSnapshotIdHasBeenSet = true;
    m_firstSnapshotId = std::forward<FirstSnapshotIdT>(value);
  }
  template <typename FirstSnapshotIdT = Aws::String>
  ListChangedBlocksRequest& WithFirstSnapshotId(FirstSnapshotIdT&& value) {
    SetFirstSnapshotId(std::forward<FirstSnapshotIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondSnapshotId(SecondSnapshotIdT&& value) {
    m_secondSnapshotIdHasBeenSet = true;
    m_secondSnapshotId = std::forward<SecondSnapshotIdT>(value);
  }
  template <typename SecondSnapshotIdT = Aws::String>
  ListChangedBlocksRequest& WithSecondSnapshotId(SecondSnapshotIdT&& value) {
    SetSecondSnapshotId(std::forward<SecondSnapshotIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListChangedBlocksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListChangedBlocksRequest& WithStartingBlockIndex(int value) {
