...
Aws::String CompleteSnapshotRequest::SerializePayload() const { return {}; }
...
Aws::Http::HeaderValueCollection CompleteSnapshotRequest::GetRequestSpecificHeaders() const {
  ...
  if (m_checksumAggregationMethodHasBeenSet && m_checksumAggregationMethod != ChecksumAggregationMethod::NOT_SET) {
    headers.emplace("x-amz-checksum-aggregation-method",
                    ChecksumAggregationMethodMapper::GetNameForChecksumAggregationMethod(m_checksumAggregationMethod));
  }
