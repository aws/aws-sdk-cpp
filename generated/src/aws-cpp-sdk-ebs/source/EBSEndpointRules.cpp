...
':','/','/','e','b','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'p','s',':','/','/','e','b','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* EBSEndpointRules::GetRulesBlob()
{
