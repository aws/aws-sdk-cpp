...
MarketplaceReportingClient::MarketplaceReportingClient(
    const AWSCredentials& credentials, std::shared_ptr<MarketplaceReportingEndpointProviderBase> endpointProvider,
    const MarketplaceReporting::MarketplaceReportingClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
MarketplaceReportingClient::MarketplaceReportingClient(const Aws::Client::ClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
                Aws::MakeShared<AWSAuthV4Signer>(
                    ALLOCATION_TAG,
                    Aws::MakeShared<DefaultAWSCredentialsProviderChain>(ALLOCATION_TAG, clientConfiguration.credentialProviderConfig),
...
MarketplaceReportingClient::~MarketplaceReportingClient() { ShutdownSdkClient(this, -1); }
...
MarketplaceReportingClient::InvokeOperationOutcome MarketplaceReportingClient::InvokeServiceOperation(
  ...
  return TracingUtils::MakeCallWithTiming<InvokeOperationOutcome>(
      [&]() -> InvokeOperationOutcome {
        ...
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetBuyerDashboard, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        endpointResolutionOutcome.GetResult().AddPathSegments("/getBuyerDashboard");
        auto result =
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER);
        return result.IsSuccess() ? GetBuyerDashboardOutcome(GetBuyerDashboardResult(result.GetResultWithOwnership()))
                                  : GetBuyerDashboardOutcome(result.GetError());
      },
