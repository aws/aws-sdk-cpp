...
typedef std::function<void(const MarketplaceReportingClient*, const Model::GetBuyerDashboardRequest&,
                           const Model::GetBuyerDashboardOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetBuyerDashboardResponseReceivedHandler;
