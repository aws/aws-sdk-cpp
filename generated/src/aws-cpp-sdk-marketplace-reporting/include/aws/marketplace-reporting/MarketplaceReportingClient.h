...
{
  /**
   * <p>The AWS Marketplace <code>GetBuyerDashboard</code> API enables you to get a
   ...
   * in your Amazon Web Services organization. </p> <p>To use the API, you must
   * complete the following prerequisites:</p> <ul> <li> <p>Enable all features for
   * your organization. For more information, see <a
   * href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html">Enabling
   * all features for an organization with Amazon Web Services Organizations</a>, in
   * the <i>Amazon Web Services Organizations User Guide</i>.</p> </li> <li> <p>Call
   ...
   * the dashboard, but they only see data for their accounts.</p> <p>For more
   * information about management accounts, see <a
   ...
   * the management account with Amazon Web Services Organizations</a>, both in the
   * <i>Amazon Web Services Organizations User Guide</i>.</p> <p>For more information
   * about delegated administrators, see <a
   * href="https://docs.aws.amazon.com/marketplace/latest/buyerguide/management-delegates.html">Using
   * delegated administrators</a>, in the <i>AWS Marketplace Buyer Guide</i>.</p>
   * </li> <li> <p>Create an IAM policy that enables the
   ...
   * and permissions in Amazon Web Services Identity and Access Management</a>, in
   * the <i>IAM User Guide</i>.</p> </li> <li> <p>Use the Amazon Web Services
   * Marketplace console to create the
   * <code>AWSServiceRoleForProcurementInsightsPolicy</code> service-linked role. The
   ...
   * access to Amazon Web Services Organizations</a>, and <a
    ...
    public:
      ...
      typedef MarketplaceReportingEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * anonymous user.</p> <p>The following rules apply to a generated URL:</p> <ul>
         * <li> <p>It contains a temporary bearer token, valid for 5 minutes after it is
         * generated. Once redeemed within that period, it cannot be re-used again.</p>
         * </li> <li> <p>It has a session lifetime of one hour. The 5-minute validity
         * period runs separately from the session lifetime.</p> </li> </ul><p><h3>See
         * Also:</h3>   <a
