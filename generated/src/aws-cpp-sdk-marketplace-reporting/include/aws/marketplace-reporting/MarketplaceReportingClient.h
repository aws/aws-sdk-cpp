...
namespace MarketplaceReporting
{
   ...
   * Guide</i>.</p> </li> </ul>
   */
  class AWS_MARKETPLACEREPORTING_API MarketplaceReportingClient : Aws::Client::ClientWithAsyncTemplateMethods<MarketplaceReportingClient>,
    smithy::client::AwsSmithyClientT<Aws::MarketplaceReporting::SERVICE_NAME,
