...
class AWS_MARKETPLACEREPORTING_API MarketplaceReportingClient
 ...
 public:
   ...
   */
  MarketplaceReportingClient(const Aws::MarketplaceReporting::MarketplaceReportingClientConfiguration& clientConfiguration =
  ...
  MarketplaceReportingClient(const Aws::Auth::AWSCredentials& credentials,
                             std::shared_ptr<MarketplaceReportingEndpointProviderBase> endpointProvider = nullptr,
                             const Aws::MarketplaceReporting::MarketplaceReportingClientConfiguration& clientConfiguration =
                                 Aws::MarketplaceReporting::MarketplaceReportingClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  MarketplaceReportingClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for GetBuyerDashboard that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBuyerDashboard that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBuyerDashboardRequestT = Model::GetBuyerDashboardRequest>
  void GetBuyerDashboardAsync(const GetBuyerDashboardRequestT& request, const GetBuyerDashboardResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&MarketplaceReportingClient::GetBuyerDashboard, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<MarketplaceReportingEndpointProviderBase>& accessEndpointProvider();
