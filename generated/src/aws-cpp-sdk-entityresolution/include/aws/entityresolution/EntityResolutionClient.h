...
namespace EntityResolution
{
   ...
   */
  class AWS_ENTITYRESOLUTION_API EntityResolutionClient : smithy::client::AwsSmithyClientT<Aws::EntityResolution::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<EntityResolutionClient>
  {
    public:
