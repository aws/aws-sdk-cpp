...
class ProviderIdNameSpaceConfiguration {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  ProviderIdNameSpaceConfiguration& WithDescription(DescriptionT&& value) {
  ...
  void SetProviderTargetConfigurationDefinition(ProviderTargetConfigurationDefinitionT&& value) {
    m_providerTargetConfigurationDefinitionHasBeenSet = true;
    m_providerTargetConfigurationDefinition = std::forward<ProviderTargetConfigurationDefinitionT>(value);
  }
  template <typename ProviderTargetConfigurationDefinitionT = Aws::Utils::Document>
  ProviderIdNameSpaceConfiguration& WithProviderTargetConfigurationDefinition(ProviderTargetConfigurationDefinitionT&& value) {
    SetProviderTargetConfigurationDefinition(std::forward<ProviderTargetConfigurationDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderSourceConfigurationDefinition(ProviderSourceConfigurationDefinitionT&& value) {
    m_providerSourceConfigurationDefinitionHasBeenSet = true;
    m_providerSourceConfigurationDefinition = std::forward<ProviderSourceConfigurationDefinitionT>(value);
  }
  template <typename ProviderSourceConfigurationDefinitionT = Aws::Utils::Document>
  ProviderIdNameSpaceConfiguration& WithProviderSourceConfigurationDefinition(ProviderSourceConfigurationDefinitionT&& value) {
    SetProviderSourceConfigurationDefinition(std::forward<ProviderSourceConfigurationDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
