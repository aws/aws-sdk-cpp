...
class ListIdMappingJobsRequest : public EntityResolutionRequest {
 public:
  AWS_ENTITYRESOLUTION_API ListIdMappingJobsRequest() = default;
  ...
  template <typename WorkflowNameT = Aws::String>
  ListIdMappingJobsRequest& WithWorkflowName(WorkflowNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListIdMappingJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIdMappingJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
