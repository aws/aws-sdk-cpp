...
class GenerateMatchIdResult {
 public:
  ...
  void SetMatchGroups(MatchGroupsT&& value) {
    m_matchGroupsHasBeenSet = true;
    m_matchGroups = std::forward<MatchGroupsT>(value);
  }
  template <typename MatchGroupsT = Aws::Vector<MatchGroup>>
  GenerateMatchIdResult& WithMatchGroups(MatchGroupsT&& value) {
    SetMatchGroups(std::forward<MatchGroupsT>(value));
    return *this;
  }
  template <typename MatchGroupsT = MatchGroup>
  GenerateMatchIdResult& AddMatchGroups(MatchGroupsT&& value) {
    m_matchGroupsHasBeenSet = true;
    m_matchGroups.emplace_back(std::forward<MatchGroupsT>(value));
    return *this;
  }
  ///@}
