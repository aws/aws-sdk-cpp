...
class ListMatchingWorkflowsRequest : public EntityResolutionRequest {
 public:
  AWS_ENTITYRESOLUTION_API ListMatchingWorkflowsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListMatchingWorkflowsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMatchingWorkflowsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
