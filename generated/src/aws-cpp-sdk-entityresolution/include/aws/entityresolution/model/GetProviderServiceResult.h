...
class GetProviderServiceResult {
 public:
  ...
  void SetProviderServiceName(ProviderServiceNameT&& value) {
    ...
    m_providerServiceName = std::forward<ProviderServiceNameT>(value);
  }
  template <typename ProviderServiceNameT = Aws::String>
  GetProviderServiceResult& WithProviderServiceName(ProviderServiceNameT&& value) {
    SetProviderServiceName(std::forward<ProviderServiceNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderServiceDisplayName(ProviderServiceDisplayNameT&& value) {
    ...
    m_providerServiceDisplayName = std::forward<ProviderServiceDisplayNameT>(value);
  }
  template <typename ProviderServiceDisplayNameT = Aws::String>
  GetProviderServiceResult& WithProviderServiceDisplayName(ProviderServiceDisplayNameT&& value) {
    SetProviderServiceDisplayName(std::forward<ProviderServiceDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProviderServiceType(ServiceType value) {
    m_providerServiceTypeHasBeenSet = true;
    m_providerServiceType = value;
  }
  inline GetProviderServiceResult& WithProviderServiceType(ServiceType value) {
    SetProviderServiceType(value);
    return *this;
  }
  ///@}
  ...
  void SetProviderServiceArn(ProviderServiceArnT&& value) {
    ...
    m_providerServiceArn = std::forward<ProviderServiceArnT>(value);
  }
  template <typename ProviderServiceArnT = Aws::String>
  GetProviderServiceResult& WithProviderServiceArn(ProviderServiceArnT&& value) {
    SetProviderServiceArn(std::forward<ProviderServiceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderConfigurationDefinition(ProviderConfigurationDefinitionT&& value) {
    ...
    m_providerConfigurationDefinition = std::forward<ProviderConfigurationDefinitionT>(value);
  }
  template <typename ProviderConfigurationDefinitionT = Aws::Utils::Document>
  GetProviderServiceResult& WithProviderConfigurationDefinition(ProviderConfigurationDefinitionT&& value) {
    SetProviderConfigurationDefinition(std::forward<ProviderConfigurationDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderIdNameSpaceConfiguration(ProviderIdNameSpaceConfigurationT&& value) {
    ...
    m_providerIdNameSpaceConfiguration = std::forward<ProviderIdNameSpaceConfigurationT>(value);
  }
  template <typename ProviderIdNameSpaceConfigurationT = ProviderIdNameSpaceConfiguration>
  GetProviderServiceResult& WithProviderIdNameSpaceConfiguration(ProviderIdNameSpaceConfigurationT&& value) {
    SetProviderIdNameSpaceConfiguration(std::forward<ProviderIdNameSpaceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderJobConfiguration(ProviderJobConfigurationT&& value) {
    ...
    m_providerJobConfiguration = std::forward<ProviderJobConfigurationT>(value);
  }
  template <typename ProviderJobConfigurationT = Aws::Utils::Document>
  GetProviderServiceResult& WithProviderJobConfiguration(ProviderJobConfigurationT&& value) {
    SetProviderJobConfiguration(std::forward<ProviderJobConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderEndpointConfiguration(ProviderEndpointConfigurationT&& value) {
    ...
    m_providerEndpointConfiguration = std::forward<ProviderEndpointConfigurationT>(value);
  }
  template <typename ProviderEndpointConfigurationT = ProviderEndpointConfiguration>
  GetProviderServiceResult& WithProviderEndpointConfiguration(ProviderEndpointConfigurationT&& value) {
    SetProviderEndpointConfiguration(std::forward<ProviderEndpointConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnonymizedOutput(bool value) {
    m_anonymizedOutputHasBeenSet = true;
    m_anonymizedOutput = value;
  }
  inline GetProviderServiceResult& WithAnonymizedOutput(bool value) {
    SetAnonymizedOutput(value);
    return *this;
  }
  ///@}
  ...
  void SetProviderEntityOutputDefinition(ProviderEntityOutputDefinitionT&& value) {
    ...
    m_providerEntityOutputDefinition = std::forward<ProviderEntityOutputDefinitionT>(value);
  }
  template <typename ProviderEntityOutputDefinitionT = Aws::Utils::Document>
  GetProviderServiceResult& WithProviderEntityOutputDefinition(ProviderEntityOutputDefinitionT&& value) {
    SetProviderEntityOutputDefinition(std::forward<ProviderEntityOutputDefinitionT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ProviderIntermediateDataAccessConfiguration& GetProviderIntermediateDataAccessConfiguration() const {
    return m_providerIntermediateDataAccessConfiguration;
  }
  ...
  void SetProviderIntermediateDataAccessConfiguration(ProviderIntermediateDataAccessConfigurationT&& value) {
    ...
    m_providerIntermediateDataAccessConfiguration = std::forward<ProviderIntermediateDataAccessConfigurationT>(value);
  }
  template <typename ProviderIntermediateDataAccessConfigurationT = ProviderIntermediateDataAccessConfiguration>
  GetProviderServiceResult& WithProviderIntermediateDataAccessConfiguration(ProviderIntermediateDataAccessConfigurationT&& value) {
    SetProviderIntermediateDataAccessConfiguration(std::forward<ProviderIntermediateDataAccessConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProviderComponentSchema(ProviderComponentSchemaT&& value) {
    ...
    m_providerComponentSchema = std::forward<ProviderComponentSchemaT>(value);
  }
  template <typename ProviderComponentSchemaT = ProviderComponentSchema>
  GetProviderServiceResult& WithProviderComponentSchema(ProviderComponentSchemaT&& value) {
    SetProviderComponentSchema(std::forward<ProviderComponentSchemaT>(value));
    return *this;
  }
  ///@}
