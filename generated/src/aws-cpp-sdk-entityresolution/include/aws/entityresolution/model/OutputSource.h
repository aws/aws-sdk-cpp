...
class OutputSource {
 public:
  ...
  OutputSource& AddOutput(OutputT&& value) {
    m_outputHasBeenSet = true;
    m_output.emplace_back(std::forward<OutputT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetApplyNormalization(bool value) {
    m_applyNormalizationHasBeenSet = true;
    m_applyNormalization = value;
  }
  inline OutputSource& WithApplyNormalization(bool value) {
    SetApplyNormalization(value);
    return *this;
  }
  ///@}
 private:
