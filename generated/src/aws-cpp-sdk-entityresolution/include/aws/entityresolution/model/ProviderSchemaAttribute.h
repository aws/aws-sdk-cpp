...
class ProviderSchemaAttribute {
 public:
  ...
  inline void SetType(SchemaAttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ProviderSchemaAttribute& WithType(SchemaAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHashing(bool value) {
    m_hashingHasBeenSet = true;
    m_hashing = value;
  }
  inline ProviderSchemaAttribute& WithHashing(bool value) {
    SetHashing(value);
    return *this;
  }
  ///@}
