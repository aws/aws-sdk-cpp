...
namespace Model
{
  ...
  {
  public:
    AWS_ENTITYRESOLUTION_API PutPolicyResult() = default;
    ...
    template<typename ArnT = Aws::String>
    PutPolicyResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenT = Aws::String>
    PutPolicyResult& WithToken(TokenT&& value) { SetToken(std::forward<TokenT>(value)); return *this;}
    ///@}
