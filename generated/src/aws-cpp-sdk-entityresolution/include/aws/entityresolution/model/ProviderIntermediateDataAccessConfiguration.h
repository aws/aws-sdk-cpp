...
class ProviderIntermediateDataAccessConfiguration {
 public:
  ...
  void SetRequiredBucketActions(RequiredBucketActionsT&& value) {
    m_requiredBucketActionsHasBeenSet = true;
    m_requiredBucketActions = std::forward<RequiredBucketActionsT>(value);
  }
  template <typename RequiredBucketActionsT = Aws::Vector<Aws::String>>
  ProviderIntermediateDataAccessConfiguration& WithRequiredBucketActions(RequiredBucketActionsT&& value) {
    SetRequiredBucketActions(std::forward<RequiredBucketActionsT>(value));
    return *this;
  }
  ...
  ProviderIntermediateDataAccessConfiguration& AddRequiredBucketActions(RequiredBucketActionsT&& value) {
    m_requiredBucketActionsHasBeenSet = true;
    m_requiredBucketActions.emplace_back(std::forward<RequiredBucketActionsT>(value));
    return *this;
  }
  ///@}
 private:
