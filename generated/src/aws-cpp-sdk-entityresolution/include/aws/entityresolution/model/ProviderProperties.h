...
class ProviderProperties {
 public:
  ...
  void SetIntermediateSourceConfiguration(IntermediateSourceConfigurationT&& value) {
    ...
    m_intermediateSourceConfiguration = std::forward<IntermediateSourceConfigurationT>(value);
  }
  template <typename IntermediateSourceConfigurationT = IntermediateSourceConfiguration>
  ProviderProperties& WithIntermediateSourceConfiguration(IntermediateSourceConfigurationT&& value) {
    SetIntermediateSourceConfiguration(std::forward<IntermediateSourceConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
