...
class GetMatchIdResult {
 public:
  ...
  void SetMatchId(MatchIdT&& value) {
    ...
    m_matchId = std::forward<MatchIdT>(value);
  }
  template <typename MatchIdT = Aws::String>
  GetMatchIdResult& WithMatchId(MatchIdT&& value) {
    SetMatchId(std::forward<MatchIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchRule(MatchRuleT&& value) {
    ...
    m_matchRule = std::forward<MatchRuleT>(value);
  }
  template <typename MatchRuleT = Aws::String>
  GetMatchIdResult& WithMatchRule(MatchRuleT&& value) {
    SetMatchRule(std::forward<MatchRuleT>(value));
    return *this;
  }
  ///@}
