...
class DeletePolicyStatementResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeletePolicyStatementResult& WithArn(ArnT&& value) {
  ...
  template <typename TokenT = Aws::String>
  DeletePolicyStatementResult& WithToken(TokenT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  DeletePolicyStatementResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeletePolicyStatementResult& WithRequestId(RequestIdT&& value) {
