...
class IdMappingIncrementalRunConfig {
 public:
  ...
  inline void SetIncrementalRunType(IdMappingIncrementalRunType value) {
    m_incrementalRunTypeHasBeenSet = true;
    m_incrementalRunType = value;
  }
  inline IdMappingIncrementalRunConfig& WithIncrementalRunType(IdMappingIncrementalRunType value) {
