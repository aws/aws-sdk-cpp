...
class RuleBasedProperties {
 public:
  ...
  inline RuleBasedProperties& WithAttributeMatchingModel(AttributeMatchingModel value) {
  ...
  inline void SetMatchPurpose(MatchPurpose value) {
    m_matchPurposeHasBeenSet = true;
    m_matchPurpose = value;
  }
  inline RuleBasedProperties& WithMatchPurpose(MatchPurpose value) {
    SetMatchPurpose(value);
    return *this;
  }
  ///@}
 private:
