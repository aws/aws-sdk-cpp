...
class SchemaInputAttribute {
 public:
  ...
  inline SchemaInputAttribute& WithType(SchemaAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetMatchKey(MatchKeyT&& value) {
    m_matchKeyHasBeenSet = true;
    m_matchKey = std::forward<MatchKeyT>(value);
  }
  template <typename MatchKeyT = Aws::String>
  SchemaInputAttribute& WithMatchKey(MatchKeyT&& value) {
    SetMatchKey(std::forward<MatchKeyT>(value));
    return *this;
  }
  ///@}
  ...
  inline SchemaInputAttribute& WithHashed(bool value) {
    SetHashed(value);
    return *this;
  }
  ///@}
