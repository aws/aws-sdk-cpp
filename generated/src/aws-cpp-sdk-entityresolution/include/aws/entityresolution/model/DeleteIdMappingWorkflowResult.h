...
namespace Model
{
  ...
  {
  public:
    AWS_ENTITYRESOLUTION_API DeleteIdMappingWorkflowResult() = default;
    ...
    template<typename MessageT = Aws::String>
    DeleteIdMappingWorkflowResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteIdMappingWorkflowResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
