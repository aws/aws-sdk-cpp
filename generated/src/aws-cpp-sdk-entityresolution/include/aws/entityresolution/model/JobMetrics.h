...
class JobMetrics {
 public:
  ...
  inline JobMetrics& WithInputRecords(int value) {
  ...
  inline JobMetrics& WithTotalRecordsProcessed(int value) {
  ...
  inline JobMetrics& WithRecordsNotProcessed(int value) {
  ...
  inline JobMetrics& WithDeleteRecordsProcessed(int value) {
  ...
  inline void SetMatchIDs(int value) {
    m_matchIDsHasBeenSet = true;
    m_matchIDs = value;
  }
  inline JobMetrics& WithMatchIDs(int value) {
    SetMatchIDs(value);
    return *this;
  }
  ///@}
