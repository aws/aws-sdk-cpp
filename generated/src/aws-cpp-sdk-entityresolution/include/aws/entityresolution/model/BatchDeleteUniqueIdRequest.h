...
class BatchDeleteUniqueIdRequest : public EntityResolutionRequest {
 public:
  ...
  void SetUniqueIds(UniqueIdsT&& value) {
    m_uniqueIdsHasBeenSet = true;
    m_uniqueIds = std::forward<UniqueIdsT>(value);
  }
  template <typename UniqueIdsT = Aws::Vector<Aws::String>>
  BatchDeleteUniqueIdRequest& WithUniqueIds(UniqueIdsT&& value) {
    SetUniqueIds(std::forward<UniqueIdsT>(value));
    return *this;
  }
  template <typename UniqueIdsT = Aws::String>
  BatchDeleteUniqueIdRequest& AddUniqueIds(UniqueIdsT&& value) {
    m_uniqueIdsHasBeenSet = true;
    m_uniqueIds.emplace_back(std::forward<UniqueIdsT>(value));
    return *this;
  }
  ///@}
 private:
