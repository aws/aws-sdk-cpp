...
class ListSchemaMappingsRequest : public EntityResolutionRequest {
 public:
  AWS_ENTITYRESOLUTION_API ListSchemaMappingsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListSchemaMappingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSchemaMappingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
