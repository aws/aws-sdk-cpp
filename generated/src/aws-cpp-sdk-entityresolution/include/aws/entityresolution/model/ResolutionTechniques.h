...
class ResolutionTechniques {
 public:
  ...
  inline ResolutionTechniques& WithResolutionType(ResolutionType value) {
  ...
  void SetRuleConditionProperties(RuleConditionPropertiesT&& value) {
    ...
    m_ruleConditionProperties = std::forward<RuleConditionPropertiesT>(value);
  }
  template <typename RuleConditionPropertiesT = RuleConditionProperties>
  ResolutionTechniques& WithRuleConditionProperties(RuleConditionPropertiesT&& value) {
    SetRuleConditionProperties(std::forward<RuleConditionPropertiesT>(value));
    return *this;
  }
  ///@}
