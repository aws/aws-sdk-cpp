...
class AddPolicyStatementResult {
 public:
  AWS_ENTITYRESOLUTION_API AddPolicyStatementResult() = default;
  ...
  template <typename ArnT = Aws::String>
  AddPolicyStatementResult& WithArn(ArnT&& value) {
  ...
  template <typename TokenT = Aws::String>
  AddPolicyStatementResult& WithToken(TokenT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  AddPolicyStatementResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AddPolicyStatementResult& WithRequestId(RequestIdT&& value) {
