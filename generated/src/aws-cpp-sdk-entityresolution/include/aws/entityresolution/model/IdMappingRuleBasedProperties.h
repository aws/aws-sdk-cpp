...
class IdMappingRuleBasedProperties {
 public:
  ...
  inline void SetRuleDefinitionType(IdMappingWorkflowRuleDefinitionType value) {
    m_ruleDefinitionTypeHasBeenSet = true;
    m_ruleDefinitionType = value;
  }
  inline IdMappingRuleBasedProperties& WithRuleDefinitionType(IdMappingWorkflowRuleDefinitionType value) {
    SetRuleDefinitionType(value);
    return *this;
  }
  ///@}
   ...
   * of Profile A matches the value of the <code>BusinessEmail</code> field of
   * Profile B, the two profiles are matched on the <code>Email</code> attribute
   * type. </p>
   */
  ...
  inline IdMappingRuleBasedProperties& WithAttributeMatchingModel(AttributeMatchingModel value) {
  ...
  inline void SetRecordMatchingModel(RecordMatchingModel value) {
    m_recordMatchingModelHasBeenSet = true;
    m_recordMatchingModel = value;
  }
  inline IdMappingRuleBasedProperties& WithRecordMatchingModel(RecordMatchingModel value) {
    SetRecordMatchingModel(value);
    return *this;
  }
  ///@}
 private:
