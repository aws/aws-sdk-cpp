...
class Record {
 public:
  ...
  void SetRecordAttributeMap(RecordAttributeMapT&& value) {
    ...
    m_recordAttributeMap = std::forward<RecordAttributeMapT>(value);
  }
  template <typename RecordAttributeMapT = Aws::Map<Aws::String, Aws::String>>
  Record& WithRecordAttributeMap(RecordAttributeMapT&& value) {
    SetRecordAttributeMap(std::forward<RecordAttributeMapT>(value));
    return *this;
  }
  ...
  Record& AddRecordAttributeMap(RecordAttributeMapKeyT&& key, RecordAttributeMapValueT&& value) {
    m_recordAttributeMapHasBeenSet = true;
    m_recordAttributeMap.emplace(std::forward<RecordAttributeMapKeyT>(key), std::forward<RecordAttributeMapValueT>(value));
    return *this;
  }
  ///@}
 private:
