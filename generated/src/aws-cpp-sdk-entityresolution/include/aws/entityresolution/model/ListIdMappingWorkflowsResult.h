...
namespace Model
{
  ...
  public:
    ...
    template<typename WorkflowSummariesT = Aws::Vector<IdMappingWorkflowSummary>>
    ListIdMappingWorkflowsResult& WithWorkflowSummaries(WorkflowSummariesT&& value) { SetWorkflowSummaries(std::forward<WorkflowSummariesT>(value)); return *this;}
    template<typename WorkflowSummariesT = IdMappingWorkflowSummary>
    ListIdMappingWorkflowsResult& AddWorkflowSummaries(WorkflowSummariesT&& value) { m_workflowSummariesHasBeenSet = true; m_workflowSummaries.emplace_back(std::forward<WorkflowSummariesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListIdMappingWorkflowsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListIdMappingWorkflowsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
