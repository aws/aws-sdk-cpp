...
namespace Model
{
  ...
  {
  public:
    AWS_ENTITYRESOLUTION_API GetIdMappingWorkflowRequest() = default;
    ...
    template<typename WorkflowNameT = Aws::String>
    GetIdMappingWorkflowRequest& WithWorkflowName(WorkflowNameT&& value) { SetWorkflowName(std::forward<WorkflowNameT>(value)); return *this;}
    ///@}
  private:
