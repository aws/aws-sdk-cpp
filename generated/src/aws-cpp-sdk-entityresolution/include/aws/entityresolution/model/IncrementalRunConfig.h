...
class IncrementalRunConfig {
 public:
   ...
   * where <code>resolutionType</code> is <code>PROVIDER</code>, incremental
  ...
  inline void SetIncrementalRunType(IncrementalRunType value) {
    m_incrementalRunTypeHasBeenSet = true;
    m_incrementalRunType = value;
  }
  inline IncrementalRunConfig& WithIncrementalRunType(IncrementalRunType value) {
    SetIncrementalRunType(value);
    return *this;
  }
  ///@}
 private:
