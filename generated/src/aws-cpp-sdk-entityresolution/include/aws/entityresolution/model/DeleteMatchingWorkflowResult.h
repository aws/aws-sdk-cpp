...
namespace Model
{
  ...
  {
  public:
    AWS_ENTITYRESOLUTION_API DeleteMatchingWorkflowResult() = default;
    ...
    template<typename MessageT = Aws::String>
    DeleteMatchingWorkflowResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteMatchingWorkflowResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
