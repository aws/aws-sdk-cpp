...
class ListMatchingWorkflowsResult {
 public:
  ...
  template <typename WorkflowSummariesT = Aws::Vector<MatchingWorkflowSummary>>
  ListMatchingWorkflowsResult& WithWorkflowSummaries(WorkflowSummariesT&& value) {
    SetWorkflowSummaries(std::forward<WorkflowSummariesT>(value));
    return *this;
  }
  template <typename WorkflowSummariesT = MatchingWorkflowSummary>
  ListMatchingWorkflowsResult& AddWorkflowSummaries(WorkflowSummariesT&& value) {
    m_workflowSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMatchingWorkflowsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMatchingWorkflowsResult& WithRequestId(RequestIdT&& value) {
