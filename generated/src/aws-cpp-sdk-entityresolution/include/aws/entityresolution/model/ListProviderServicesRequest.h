...
namespace Model
{
  ...
  {
  public:
    AWS_ENTITYRESOLUTION_API ListProviderServicesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListProviderServicesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ProviderNameT = Aws::String>
    ListProviderServicesRequest& WithProviderName(ProviderNameT&& value) { SetProviderName(std::forward<ProviderNameT>(value)); return *this;}
    ///@}
  private:
