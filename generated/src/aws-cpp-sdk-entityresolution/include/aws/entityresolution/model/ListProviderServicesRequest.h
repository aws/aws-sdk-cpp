...
class ListProviderServicesRequest : public EntityResolutionRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListProviderServicesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProviderServicesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename ProviderNameT = Aws::String>
  ListProviderServicesRequest& WithProviderName(ProviderNameT&& value) {
