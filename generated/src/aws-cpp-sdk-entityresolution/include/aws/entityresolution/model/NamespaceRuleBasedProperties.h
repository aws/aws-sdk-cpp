...
class NamespaceRuleBasedProperties {
 public:
  ...
  void SetRuleDefinitionTypes(RuleDefinitionTypesT&& value) {
    ...
    m_ruleDefinitionTypes = std::forward<RuleDefinitionTypesT>(value);
  }
  template <typename RuleDefinitionTypesT = Aws::Vector<IdMappingWorkflowRuleDefinitionType>>
  NamespaceRuleBasedProperties& WithRuleDefinitionTypes(RuleDefinitionTypesT&& value) {
    SetRuleDefinitionTypes(std::forward<RuleDefinitionTypesT>(value));
    return *this;
  }
  inline NamespaceRuleBasedProperties& AddRuleDefinitionTypes(IdMappingWorkflowRuleDefinitionType value) {
    m_ruleDefinitionTypesHasBeenSet = true;
    m_ruleDefinitionTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline NamespaceRuleBasedProperties& WithAttributeMatchingModel(AttributeMatchingModel value) {
  ...
  void SetRecordMatchingModels(RecordMatchingModelsT&& value) {
    ...
    m_recordMatchingModels = std::forward<RecordMatchingModelsT>(value);
  }
  template <typename RecordMatchingModelsT = Aws::Vector<RecordMatchingModel>>
  NamespaceRuleBasedProperties& WithRecordMatchingModels(RecordMatchingModelsT&& value) {
    SetRecordMatchingModels(std::forward<RecordMatchingModelsT>(value));
    return *this;
  }
  inline NamespaceRuleBasedProperties& AddRecordMatchingModels(RecordMatchingModel value) {
    m_recordMatchingModelsHasBeenSet = true;
    m_recordMatchingModels.push_back(value);
    return *this;
  }
  ///@}
 private:
