...
class ListIdMappingJobsResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<JobSummary>>
  ListIdMappingJobsResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = JobSummary>
  ListIdMappingJobsResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIdMappingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIdMappingJobsResult& WithRequestId(RequestIdT&& value) {
