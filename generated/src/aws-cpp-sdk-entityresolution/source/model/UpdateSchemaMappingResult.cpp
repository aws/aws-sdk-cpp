...
UpdateSchemaMappingResult::UpdateSchemaMappingResult()
{
}

UpdateSchemaMappingResult::UpdateSchemaMappingResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
