...
Aws::String BatchDeleteUniqueIdRequest::SerializePayload() const { return {}; }
...
Aws::Http::HeaderValueCollection BatchDeleteUniqueIdRequest::GetRequestSpecificHeaders() const {
  ...
  if (m_uniqueIdsHasBeenSet) {
    headers.emplace("uniqueids", std::accumulate(std::begin(m_uniqueIds), std::end(m_uniqueIds), Aws::String{},
