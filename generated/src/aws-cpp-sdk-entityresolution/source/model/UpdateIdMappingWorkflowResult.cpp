...
UpdateIdMappingWorkflowResult::UpdateIdMappingWorkflowResult()
{
}

UpdateIdMappingWorkflowResult::UpdateIdMappingWorkflowResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateIdMappingWorkflowResult& UpdateIdMappingWorkflowResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
