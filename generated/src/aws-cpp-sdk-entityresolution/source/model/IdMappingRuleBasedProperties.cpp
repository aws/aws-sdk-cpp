...
IdMappingRuleBasedProperties::IdMappingRuleBasedProperties(JsonView jsonValue) { *this = jsonValue; }
...
IdMappingRuleBasedProperties& IdMappingRuleBasedProperties::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ruleDefinitionType")) {
    m_ruleDefinitionType =
        IdMappingWorkflowRuleDefinitionTypeMapper::GetIdMappingWorkflowRuleDefinitionTypeForName(jsonValue.GetString("ruleDefinitionType"));
...
JsonValue IdMappingRuleBasedProperties::Jsonize() const {
  ...
  if (m_ruleDefinitionTypeHasBeenSet) {
    payload.WithString("ruleDefinitionType",
                       IdMappingWorkflowRuleDefinitionTypeMapper::GetNameForIdMappingWorkflowRuleDefinitionType(m_ruleDefinitionType));
  }
