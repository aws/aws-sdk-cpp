...
namespace Translate
{
   ...
   * target language.</p>
   */
  class AWS_TRANSLATE_API TranslateClient : Aws::Client::ClientWithAsyncTemplateMethods<TranslateClient>,
    smithy::client::AwsSmithyClientT<Aws::Translate::SERVICE_NAME,
