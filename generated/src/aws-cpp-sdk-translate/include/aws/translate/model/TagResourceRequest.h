...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public TranslateRequest
  {
  public:
    AWS_TRANSLATE_API TagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the given Amazon Translate resource to
    ...
    ///@{
    /**
     * <p>Tags being associated with a specific Amazon Translate resource. There can be
