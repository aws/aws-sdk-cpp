...
class DeleteParallelDataResult {
 public:
  AWS_TRANSLATE_API DeleteParallelDataResult() = default;
  ...
  template <typename NameT = Aws::String>
  DeleteParallelDataResult& WithName(NameT&& value) {
  ...
  inline DeleteParallelDataResult& WithStatus(ParallelDataStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteParallelDataResult& WithRequestId(RequestIdT&& value) {
