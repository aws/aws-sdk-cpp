...
class StopTextTranslationJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StopTextTranslationJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StopTextTranslationJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopTextTranslationJobResult& WithRequestId(RequestIdT&& value) {
