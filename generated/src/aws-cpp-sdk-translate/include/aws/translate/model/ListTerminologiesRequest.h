...
/**
 */
class ListTerminologiesRequest : public TranslateRequest {
 public:
  AWS_TRANSLATE_API ListTerminologiesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListTerminologiesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTerminologiesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
