...
class TextTranslationJobFilter {
 public:
  ...
  template <typename JobNameT = Aws::String>
  TextTranslationJobFilter& WithJobName(JobNameT&& value) {
  ...
  inline TextTranslationJobFilter& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSubmittedBeforeTime(SubmittedBeforeTimeT&& value) {
    m_submittedBeforeTimeHasBeenSet = true;
    m_submittedBeforeTime = std::forward<SubmittedBeforeTimeT>(value);
  }
  template <typename SubmittedBeforeTimeT = Aws::Utils::DateTime>
  TextTranslationJobFilter& WithSubmittedBeforeTime(SubmittedBeforeTimeT&& value) {
    SetSubmittedBeforeTime(std::forward<SubmittedBeforeTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubmittedAfterTime(SubmittedAfterTimeT&& value) {
    m_submittedAfterTimeHasBeenSet = true;
    m_submittedAfterTime = std::forward<SubmittedAfterTimeT>(value);
  }
  template <typename SubmittedAfterTimeT = Aws::Utils::DateTime>
  TextTranslationJobFilter& WithSubmittedAfterTime(SubmittedAfterTimeT&& value) {
    SetSubmittedAfterTime(std::forward<SubmittedAfterTimeT>(value));
    return *this;
  }
  ///@}
 private:
