...
class ListLanguagesRequest : public TranslateRequest {
 public:
  ...
  inline ListLanguagesRequest& WithDisplayLanguageCode(DisplayLanguageCode value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListLanguagesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListLanguagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
