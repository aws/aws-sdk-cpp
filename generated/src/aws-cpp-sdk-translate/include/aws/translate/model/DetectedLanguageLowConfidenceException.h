...
class DetectedLanguageLowConfidenceException {
 public:
  ...
  template <typename MessageT = Aws::String>
  DetectedLanguageLowConfidenceException& WithMessage(MessageT&& value) {
  ...
  void SetDetectedLanguageCode(DetectedLanguageCodeT&& value) {
    m_detectedLanguageCodeHasBeenSet = true;
    m_detectedLanguageCode = std::forward<DetectedLanguageCodeT>(value);
  }
  template <typename DetectedLanguageCodeT = Aws::String>
  DetectedLanguageLowConfidenceException& WithDetectedLanguageCode(DetectedLanguageCodeT&& value) {
    SetDetectedLanguageCode(std::forward<DetectedLanguageCodeT>(value));
    return *this;
  }
  ///@}
 private:
