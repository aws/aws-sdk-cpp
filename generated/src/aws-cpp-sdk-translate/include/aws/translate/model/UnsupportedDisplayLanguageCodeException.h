...
class UnsupportedDisplayLanguageCodeException {
 public:
  ...
  template <typename MessageT = Aws::String>
  UnsupportedDisplayLanguageCodeException& WithMessage(MessageT&& value) {
  ...
  void SetDisplayLanguageCode(DisplayLanguageCodeT&& value) {
    m_displayLanguageCodeHasBeenSet = true;
    m_displayLanguageCode = std::forward<DisplayLanguageCodeT>(value);
  }
  template <typename DisplayLanguageCodeT = Aws::String>
  UnsupportedDisplayLanguageCodeException& WithDisplayLanguageCode(DisplayLanguageCodeT&& value) {
    SetDisplayLanguageCode(std::forward<DisplayLanguageCodeT>(value));
    return *this;
  }
  ///@}
 private:
