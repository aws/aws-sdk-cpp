...
class TranslateDocumentRequest : public TranslateRequest {
 public:
  ...
  template <typename DocumentT = Document>
  TranslateDocumentRequest& WithDocument(DocumentT&& value) {
  ...
  template <typename TerminologyNamesT = Aws::Vector<Aws::String>>
  TranslateDocumentRequest& WithTerminologyNames(TerminologyNamesT&& value) {
    SetTerminologyNames(std::forward<TerminologyNamesT>(value));
    return *this;
  }
  template <typename TerminologyNamesT = Aws::String>
  TranslateDocumentRequest& AddTerminologyNames(TerminologyNamesT&& value) {
    m_terminologyNamesHasBeenSet = true;
  ...
  template <typename SourceLanguageCodeT = Aws::String>
  TranslateDocumentRequest& WithSourceLanguageCode(SourceLanguageCodeT&& value) {
  ...
  template <typename TargetLanguageCodeT = Aws::String>
  TranslateDocumentRequest& WithTargetLanguageCode(TargetLanguageCodeT&& value) {
  ...
  template <typename SettingsT = TranslationSettings>
  TranslateDocumentRequest& WithSettings(SettingsT&& value) {
