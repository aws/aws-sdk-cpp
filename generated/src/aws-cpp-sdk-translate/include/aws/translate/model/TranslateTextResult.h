...
class TranslateTextResult {
 public:
  ...
  void SetTranslatedText(TranslatedTextT&& value) {
    ...
    m_translatedText = std::forward<TranslatedTextT>(value);
  }
  template <typename TranslatedTextT = Aws::String>
  TranslateTextResult& WithTranslatedText(TranslatedTextT&& value) {
    SetTranslatedText(std::forward<TranslatedTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetLanguageCode(TargetLanguageCodeT&& value) {
    ...
    m_targetLanguageCode = std::forward<TargetLanguageCodeT>(value);
  }
  template <typename TargetLanguageCodeT = Aws::String>
  TranslateTextResult& WithTargetLanguageCode(TargetLanguageCodeT&& value) {
    SetTargetLanguageCode(std::forward<TargetLanguageCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppliedTerminologies(AppliedTerminologiesT&& value) {
    ...
    m_appliedTerminologies = std::forward<AppliedTerminologiesT>(value);
  }
  template <typename AppliedTerminologiesT = Aws::Vector<AppliedTerminology>>
  TranslateTextResult& WithAppliedTerminologies(AppliedTerminologiesT&& value) {
    SetAppliedTerminologies(std::forward<AppliedTerminologiesT>(value));
    return *this;
  }
  ...
  TranslateTextResult& AddAppliedTerminologies(AppliedTerminologiesT&& value) {
    m_appliedTerminologiesHasBeenSet = true;
    m_appliedTerminologies.emplace_back(std::forward<AppliedTerminologiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppliedSettings(AppliedSettingsT&& value) {
    ...
    m_appliedSettings = std::forward<AppliedSettingsT>(value);
  }
  template <typename AppliedSettingsT = TranslationSettings>
  TranslateTextResult& WithAppliedSettings(AppliedSettingsT&& value) {
    SetAppliedSettings(std::forward<AppliedSettingsT>(value));
    return *this;
  }
  ///@}
