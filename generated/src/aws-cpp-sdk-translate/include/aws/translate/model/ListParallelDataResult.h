...
class ListParallelDataResult {
 public:
  ...
  void SetParallelDataPropertiesList(ParallelDataPropertiesListT&& value) {
    m_parallelDataPropertiesListHasBeenSet = true;
    m_parallelDataPropertiesList = std::forward<ParallelDataPropertiesListT>(value);
  }
  template <typename ParallelDataPropertiesListT = Aws::Vector<ParallelDataProperties>>
  ListParallelDataResult& WithParallelDataPropertiesList(ParallelDataPropertiesListT&& value) {
    SetParallelDataPropertiesList(std::forward<ParallelDataPropertiesListT>(value));
    return *this;
  }
  template <typename ParallelDataPropertiesListT = ParallelDataProperties>
  ListParallelDataResult& AddParallelDataPropertiesList(ParallelDataPropertiesListT&& value) {
    m_parallelDataPropertiesListHasBeenSet = true;
    m_parallelDataPropertiesList.emplace_back(std::forward<ParallelDataPropertiesListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListParallelDataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListParallelDataResult& WithRequestId(RequestIdT&& value) {
