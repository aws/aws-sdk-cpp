...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public TranslateRequest
  {
  public:
    AWS_TRANSLATE_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p> The Amazon Resource Name (ARN) of the given Amazon Translate resource from
