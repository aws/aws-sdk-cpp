...
class TranslationSettings {
 public:
  ...
  inline void SetFormality(Formality value) {
    m_formalityHasBeenSet = true;
    m_formality = value;
  }
  inline TranslationSettings& WithFormality(Formality value) {
    SetFormality(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProfanity(Profanity value) {
    m_profanityHasBeenSet = true;
    m_profanity = value;
  }
  inline TranslationSettings& WithProfanity(Profanity value) {
    SetProfanity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBrevity(Brevity value) {
    m_brevityHasBeenSet = true;
    m_brevity = value;
  }
  inline TranslationSettings& WithBrevity(Brevity value) {
    SetBrevity(value);
    return *this;
  }
  ///@}
