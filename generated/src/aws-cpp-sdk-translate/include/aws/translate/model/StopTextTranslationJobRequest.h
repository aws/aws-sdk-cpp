...
namespace Model
{
  ...
  /**
   */
  class StopTextTranslationJobRequest : public TranslateRequest
  {
  public:
    AWS_TRANSLATE_API StopTextTranslationJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    StopTextTranslationJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
