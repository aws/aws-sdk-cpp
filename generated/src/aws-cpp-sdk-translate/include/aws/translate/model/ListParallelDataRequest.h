...
/**
 */
class ListParallelDataRequest : public TranslateRequest {
 public:
  AWS_TRANSLATE_API ListParallelDataRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListParallelDataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListParallelDataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
