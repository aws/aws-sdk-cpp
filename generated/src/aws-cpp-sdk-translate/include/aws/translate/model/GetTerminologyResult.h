...
class GetTerminologyResult {
 public:
  ...
  void SetTerminologyProperties(TerminologyPropertiesT&& value) {
    ...
    m_terminologyProperties = std::forward<TerminologyPropertiesT>(value);
  }
  template <typename TerminologyPropertiesT = TerminologyProperties>
  GetTerminologyResult& WithTerminologyProperties(TerminologyPropertiesT&& value) {
    SetTerminologyProperties(std::forward<TerminologyPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTerminologyDataLocation(TerminologyDataLocationT&& value) {
    ...
    m_terminologyDataLocation = std::forward<TerminologyDataLocationT>(value);
  }
  template <typename TerminologyDataLocationT = TerminologyDataLocation>
  GetTerminologyResult& WithTerminologyDataLocation(TerminologyDataLocationT&& value) {
    SetTerminologyDataLocation(std::forward<TerminologyDataLocationT>(value));
    return *this;
  }
  ///@}
