...
class GetParallelDataResult {
 public:
  ...
  void SetParallelDataProperties(ParallelDataPropertiesT&& value) {
    ...
    m_parallelDataProperties = std::forward<ParallelDataPropertiesT>(value);
  }
  template <typename ParallelDataPropertiesT = ParallelDataProperties>
  GetParallelDataResult& WithParallelDataProperties(ParallelDataPropertiesT&& value) {
    SetParallelDataProperties(std::forward<ParallelDataPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuxiliaryDataLocation(AuxiliaryDataLocationT&& value) {
    ...
    m_auxiliaryDataLocation = std::forward<AuxiliaryDataLocationT>(value);
  }
  template <typename AuxiliaryDataLocationT = ParallelDataDataLocation>
  GetParallelDataResult& WithAuxiliaryDataLocation(AuxiliaryDataLocationT&& value) {
    SetAuxiliaryDataLocation(std::forward<AuxiliaryDataLocationT>(value));
    return *this;
  }
  ///@}
   ...
   * presigned URL to that has a 30-minute expiration.</p>
   */
  inline const ParallelDataDataLocation& GetLatestUpdateAttemptAuxiliaryDataLocation() const {
    return m_latestUpdateAttemptAuxiliaryDataLocation;
  }
  ...
  void SetLatestUpdateAttemptAuxiliaryDataLocation(LatestUpdateAttemptAuxiliaryDataLocationT&& value) {
    ...
    m_latestUpdateAttemptAuxiliaryDataLocation = std::forward<LatestUpdateAttemptAuxiliaryDataLocationT>(value);
  }
  template <typename LatestUpdateAttemptAuxiliaryDataLocationT = ParallelDataDataLocation>
  GetParallelDataResult& WithLatestUpdateAttemptAuxiliaryDataLocation(LatestUpdateAttemptAuxiliaryDataLocationT&& value) {
    SetLatestUpdateAttemptAuxiliaryDataLocation(std::forward<LatestUpdateAttemptAuxiliaryDataLocationT>(value));
    return *this;
  }
  ///@}
