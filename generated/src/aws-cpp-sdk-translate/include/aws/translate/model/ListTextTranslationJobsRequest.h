...
class ListTextTranslationJobsRequest : public TranslateRequest {
 public:
  ...
  template <typename FilterT = TextTranslationJobFilter>
  ListTextTranslationJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTextTranslationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTextTranslationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
