...
class StartTextTranslationJobResult {
 public:
  ...
  template <typename JobIdT = Aws::String>
  StartTextTranslationJobResult& WithJobId(JobIdT&& value) {
  ...
  inline StartTextTranslationJobResult& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartTextTranslationJobResult& WithRequestId(RequestIdT&& value) {
