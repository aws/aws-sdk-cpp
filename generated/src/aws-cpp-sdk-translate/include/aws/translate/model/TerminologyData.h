...
class TerminologyData {
 public:
  ...
  inline void SetFormat(TerminologyDataFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline TerminologyData& WithFormat(TerminologyDataFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDirectionality(Directionality value) {
    m_directionalityHasBeenSet = true;
    m_directionality = value;
  }
  inline TerminologyData& WithDirectionality(Directionality value) {
