...
namespace Model
{
  ...
  /**
   */
  class GetParallelDataRequest : public TranslateRequest
  {
  public:
    AWS_TRANSLATE_API GetParallelDataRequest() = default;
    ...
    template<typename NameT = Aws::String>
    GetParallelDataRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
