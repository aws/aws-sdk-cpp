...
class ImportTerminologyRequest : public TranslateRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  ImportTerminologyRequest& WithName(NameT&& value) {
  ...
  inline void SetMergeStrategy(MergeStrategy value) {
    m_mergeStrategyHasBeenSet = true;
    m_mergeStrategy = value;
  }
  inline ImportTerminologyRequest& WithMergeStrategy(MergeStrategy value) {
  ...
  template <typename DescriptionT = Aws::String>
  ImportTerminologyRequest& WithDescription(DescriptionT&& value) {
  ...
  void SetTerminologyData(TerminologyDataT&& value) {
    m_terminologyDataHasBeenSet = true;
    m_terminologyData = std::forward<TerminologyDataT>(value);
  }
  template <typename TerminologyDataT = TerminologyData>
  ImportTerminologyRequest& WithTerminologyData(TerminologyDataT&& value) {
    SetTerminologyData(std::forward<TerminologyDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EncryptionKeyT = EncryptionKey>
  ImportTerminologyRequest& WithEncryptionKey(EncryptionKeyT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ImportTerminologyRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ImportTerminologyRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
