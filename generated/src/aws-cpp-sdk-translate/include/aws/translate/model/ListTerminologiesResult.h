...
class ListTerminologiesResult {
 public:
  ...
  void SetTerminologyPropertiesList(TerminologyPropertiesListT&& value) {
    ...
    m_terminologyPropertiesList = std::forward<TerminologyPropertiesListT>(value);
  }
  template <typename TerminologyPropertiesListT = Aws::Vector<TerminologyProperties>>
  ListTerminologiesResult& WithTerminologyPropertiesList(TerminologyPropertiesListT&& value) {
    SetTerminologyPropertiesList(std::forward<TerminologyPropertiesListT>(value));
    return *this;
  }
  ...
  ListTerminologiesResult& AddTerminologyPropertiesList(TerminologyPropertiesListT&& value) {
    m_terminologyPropertiesListHasBeenSet = true;
    m_terminologyPropertiesList.emplace_back(std::forward<TerminologyPropertiesListT>(value));
    return *this;
  }
  ///@}
