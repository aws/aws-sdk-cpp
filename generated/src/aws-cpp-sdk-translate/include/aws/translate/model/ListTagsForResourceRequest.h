...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public TranslateRequest
  {
  public:
    AWS_TRANSLATE_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the given Amazon Translate resource you are
     * querying. </p>
     */
