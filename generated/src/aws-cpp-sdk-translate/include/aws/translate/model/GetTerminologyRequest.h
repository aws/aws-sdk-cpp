...
class GetTerminologyRequest : public TranslateRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  GetTerminologyRequest& WithName(NameT&& value) {
  ...
  inline void SetTerminologyDataFormat(TerminologyDataFormat value) {
    m_terminologyDataFormatHasBeenSet = true;
    m_terminologyDataFormat = value;
  }
  inline GetTerminologyRequest& WithTerminologyDataFormat(TerminologyDataFormat value) {
    SetTerminologyDataFormat(value);
    return *this;
  }
  ///@}
 private:
