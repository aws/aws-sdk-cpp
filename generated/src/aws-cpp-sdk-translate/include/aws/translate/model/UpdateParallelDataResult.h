...
class UpdateParallelDataResult {
 public:
  ...
  inline void SetStatus(ParallelDataStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateParallelDataResult& WithStatus(ParallelDataStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLatestUpdateAttemptStatus(ParallelDataStatus value) {
    m_latestUpdateAttemptStatusHasBeenSet = true;
    m_latestUpdateAttemptStatus = value;
  }
  inline UpdateParallelDataResult& WithLatestUpdateAttemptStatus(ParallelDataStatus value) {
    SetLatestUpdateAttemptStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLatestUpdateAttemptAt(LatestUpdateAttemptAtT&& value) {
    ...
    m_latestUpdateAttemptAt = std::forward<LatestUpdateAttemptAtT>(value);
  }
  template <typename LatestUpdateAttemptAtT = Aws::Utils::DateTime>
  UpdateParallelDataResult& WithLatestUpdateAttemptAt(LatestUpdateAttemptAtT&& value) {
    SetLatestUpdateAttemptAt(std::forward<LatestUpdateAttemptAtT>(value));
    return *this;
  }
  ///@}
