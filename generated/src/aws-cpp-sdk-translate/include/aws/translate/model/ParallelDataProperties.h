...
class ParallelDataProperties {
 public:
  ...
  inline ParallelDataProperties& WithStatus(ParallelDataStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImportedDataSize(long long value) {
    m_importedDataSizeHasBeenSet = true;
    m_importedDataSize = value;
  }
  inline ParallelDataProperties& WithImportedDataSize(long long value) {
    SetImportedDataSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImportedRecordCount(long long value) {
    m_importedRecordCountHasBeenSet = true;
    m_importedRecordCount = value;
  }
  inline ParallelDataProperties& WithImportedRecordCount(long long value) {
    SetImportedRecordCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedRecordCount(long long value) {
    m_failedRecordCountHasBeenSet = true;
    m_failedRecordCount = value;
  }
  inline ParallelDataProperties& WithFailedRecordCount(long long value) {
    SetFailedRecordCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkippedRecordCount(long long value) {
    m_skippedRecordCountHasBeenSet = true;
    m_skippedRecordCount = value;
  }
  inline ParallelDataProperties& WithSkippedRecordCount(long long value) {
    SetSkippedRecordCount(value);
    return *this;
  }
  ///@}
  ...
  inline ParallelDataProperties& WithLatestUpdateAttemptStatus(ParallelDataStatus value) {
