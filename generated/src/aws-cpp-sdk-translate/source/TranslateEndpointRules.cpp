...
namespace Translate
{
const size_t TranslateEndpointRules::RulesBlobStrLen = 3404;
const size_t TranslateEndpointRules::RulesBlobSize = 3405;
...
't','t','p','s',':','/','/','t','r','a','n','s','l','a','t','e','-','f','i','p','s','.','{','R','e',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','r','a','n','s','l','a','t','e',
...
's',':','/','/','t','r','a','n','s','l','a','t','e','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* TranslateEndpointRules::GetRulesBlob()
{
