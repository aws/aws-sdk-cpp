...
EmailChannelSubtypeConfig::EmailChannelSubtypeConfig() : 
    m_capacity(0.0),
...
EmailChannelSubtypeConfig::EmailChannelSubtypeConfig(JsonView jsonValue)
  : EmailChannelSubtypeConfig()
{
  *this = jsonValue;
}

EmailChannelSubtypeConfig& EmailChannelSubtypeConfig::operator =(JsonView jsonValue)
{
...
JsonValue EmailChannelSubtypeConfig::Jsonize() const
{
  JsonValue payload;
