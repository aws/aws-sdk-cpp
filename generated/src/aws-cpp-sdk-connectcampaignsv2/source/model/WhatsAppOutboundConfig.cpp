...
WhatsAppOutboundConfig::WhatsAppOutboundConfig(JsonView jsonValue) { *this = jsonValue; }

WhatsAppOutboundConfig& WhatsAppOutboundConfig::operator=(JsonView jsonValue) {
...
JsonValue WhatsAppOutboundConfig::Jsonize() const {
  JsonValue payload;
