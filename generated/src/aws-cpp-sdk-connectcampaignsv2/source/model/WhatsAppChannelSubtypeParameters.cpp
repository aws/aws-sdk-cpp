...
WhatsAppChannelSubtypeParameters::WhatsAppChannelSubtypeParameters(JsonView jsonValue) { *this = jsonValue; }

WhatsAppChannelSubtypeParameters& WhatsAppChannelSubtypeParameters::operator=(JsonView jsonValue) {
...
JsonValue WhatsAppChannelSubtypeParameters::Jsonize() const {
  JsonValue payload;
