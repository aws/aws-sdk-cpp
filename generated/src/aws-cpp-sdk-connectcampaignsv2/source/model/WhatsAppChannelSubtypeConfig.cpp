...
WhatsAppChannelSubtypeConfig::WhatsAppChannelSubtypeConfig(JsonView jsonValue) { *this = jsonValue; }

WhatsAppChannelSubtypeConfig& WhatsAppChannelSubtypeConfig::operator=(JsonView jsonValue) {
...
JsonValue WhatsAppChannelSubtypeConfig::Jsonize() const {
  JsonValue payload;
