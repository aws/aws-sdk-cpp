...
WhatsAppOutboundMode::WhatsAppOutboundMode(JsonView jsonValue) { *this = jsonValue; }

WhatsAppOutboundMode& WhatsAppOutboundMode::operator=(JsonView jsonValue) {
...
JsonValue WhatsAppOutboundMode::Jsonize() const {
  JsonValue payload;
