...
LocalTimeZoneConfig::LocalTimeZoneConfig(JsonView jsonValue) { *this = jsonValue; }
...
LocalTimeZoneConfig& LocalTimeZoneConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("localTimeZoneDetection")) {
    ...
    for (unsigned localTimeZoneDetectionIndex = 0; localTimeZoneDetectionIndex < localTimeZoneDetectionJsonList.GetLength();
         ++localTimeZoneDetectionIndex) {
      m_localTimeZoneDetection.push_back(LocalTimeZoneDetectionTypeMapper::GetLocalTimeZoneDetectionTypeForName(
          localTimeZoneDetectionJsonList[localTimeZoneDetectionIndex].AsString()));
    }
