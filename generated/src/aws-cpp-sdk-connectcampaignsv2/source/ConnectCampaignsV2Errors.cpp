...
template <>
AWS_CONNECTCAMPAIGNSV2_API ConflictException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API ServiceQuotaExceededException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API ThrottlingException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API InternalServerException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API ResourceNotFoundException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API ValidationException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API AccessDeniedException ConnectCampaignsV2Error::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsV2Errors::ACCESS_DENIED);
  return AccessDeniedException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNSV2_API InvalidCampaignStateException ConnectCampaignsV2Error::GetModeledError() {
...
template <>
AWS_CONNECTCAMPAIGNSV2_API InvalidStateException ConnectCampaignsV2Error::GetModeledError() {
