...
class UpdateCampaignCommunicationLimitsRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateCampaignCommunicationLimitsRequest& WithId(IdT&& value) {
  ...
  template <typename CommunicationLimitsOverrideT = CommunicationLimitsConfig>
  UpdateCampaignCommunicationLimitsRequest& WithCommunicationLimitsOverride(CommunicationLimitsOverrideT&& value) {
