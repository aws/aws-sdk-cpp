...
namespace Model
{
  ...
  /**
   * <p>The request for GetInstanceOnboardingJobStatus API.</p><p><h3>See Also:</h3> 
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/GetInstanceOnboardingJobStatusRequest">AWS
   * API Reference</a></p>
   */
  class GetInstanceOnboardingJobStatusRequest : public ConnectCampaignsV2Request
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API GetInstanceOnboardingJobStatusRequest() = default;
