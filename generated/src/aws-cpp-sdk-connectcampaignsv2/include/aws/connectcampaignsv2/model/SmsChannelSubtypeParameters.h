...
class SmsChannelSubtypeParameters {
 public:
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  SmsChannelSubtypeParameters& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename ConnectSourcePhoneNumberArnT = Aws::String>
  SmsChannelSubtypeParameters& WithConnectSourcePhoneNumberArn(ConnectSourcePhoneNumberArnT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  SmsChannelSubtypeParameters& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename TemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  SmsChannelSubtypeParameters& WithTemplateParameters(TemplateParametersT&& value) {
