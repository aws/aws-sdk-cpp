...
class TelephonyChannelSubtypeParameters {
 public:
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  TelephonyChannelSubtypeParameters& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  template <typename AttributesT = Aws::Map<Aws::String, Aws::String>>
  TelephonyChannelSubtypeParameters& WithAttributes(AttributesT&& value) {
  ...
  template <typename ConnectSourcePhoneNumberT = Aws::String>
  TelephonyChannelSubtypeParameters& WithConnectSourcePhoneNumber(ConnectSourcePhoneNumberT&& value) {
  ...
  template <typename AnswerMachineDetectionConfigT = AnswerMachineDetectionConfig>
  TelephonyChannelSubtypeParameters& WithAnswerMachineDetectionConfig(AnswerMachineDetectionConfigT&& value) {
