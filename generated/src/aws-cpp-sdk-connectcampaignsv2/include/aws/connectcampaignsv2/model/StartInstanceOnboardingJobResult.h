...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API StartInstanceOnboardingJobResult() = default;
    ...
    template<typename ConnectInstanceOnboardingJobStatusT = InstanceOnboardingJobStatus>
    StartInstanceOnboardingJobResult& WithConnectInstanceOnboardingJobStatus(ConnectInstanceOnboardingJobStatusT&& value) { SetConnectInstanceOnboardingJobStatus(std::forward<ConnectInstanceOnboardingJobStatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartInstanceOnboardingJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
