...
class ListConnectInstanceIntegrationsResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNSV2_API ListConnectInstanceIntegrationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectInstanceIntegrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetIntegrationSummaryList(IntegrationSummaryListT&& value) {
    m_integrationSummaryListHasBeenSet = true;
    m_integrationSummaryList = std::forward<IntegrationSummaryListT>(value);
  }
  template <typename IntegrationSummaryListT = Aws::Vector<IntegrationSummary>>
  ListConnectInstanceIntegrationsResult& WithIntegrationSummaryList(IntegrationSummaryListT&& value) {
    SetIntegrationSummaryList(std::forward<IntegrationSummaryListT>(value));
    return *this;
  }
  template <typename IntegrationSummaryListT = IntegrationSummary>
  ListConnectInstanceIntegrationsResult& AddIntegrationSummaryList(IntegrationSummaryListT&& value) {
    m_integrationSummaryListHasBeenSet = true;
    m_integrationSummaryList.emplace_back(std::forward<IntegrationSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectInstanceIntegrationsResult& WithRequestId(RequestIdT&& value) {
