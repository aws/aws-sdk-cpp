...
/**
 * <p>The request for UntagResource API.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/UntagResourceRequest">AWS
 * API Reference</a></p>
 */
class UntagResourceRequest : public ConnectCampaignsV2Request {
 public:
  AWS_CONNECTCAMPAIGNSV2_API UntagResourceRequest() = default;
