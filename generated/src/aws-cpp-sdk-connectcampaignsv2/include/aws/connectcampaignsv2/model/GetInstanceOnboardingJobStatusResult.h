...
class GetInstanceOnboardingJobStatusResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNSV2_API GetInstanceOnboardingJobStatusResult& operator=(
  ...
  template <typename ConnectInstanceOnboardingJobStatusT = InstanceOnboardingJobStatus>
  GetInstanceOnboardingJobStatusResult& WithConnectInstanceOnboardingJobStatus(ConnectInstanceOnboardingJobStatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetInstanceOnboardingJobStatusResult& WithRequestId(RequestIdT&& value) {
