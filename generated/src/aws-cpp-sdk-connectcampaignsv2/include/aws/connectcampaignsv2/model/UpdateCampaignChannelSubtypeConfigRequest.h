...
class UpdateCampaignChannelSubtypeConfigRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateCampaignChannelSubtypeConfigRequest& WithId(IdT&& value) {
  ...
  template <typename ChannelSubtypeConfigT = ChannelSubtypeConfig>
  UpdateCampaignChannelSubtypeConfigRequest& WithChannelSubtypeConfig(ChannelSubtypeConfigT&& value) {
