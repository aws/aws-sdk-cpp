...
class SmsChannelSubtypeConfig {
 public:
  ...
  inline SmsChannelSubtypeConfig& WithCapacity(double value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutboundModeT = SmsOutboundMode>
  SmsChannelSubtypeConfig& WithOutboundMode(OutboundModeT&& value) {
  ...
  template <typename DefaultOutboundConfigT = SmsOutboundConfig>
  SmsChannelSubtypeConfig& WithDefaultOutboundConfig(DefaultOutboundConfigT&& value) {
