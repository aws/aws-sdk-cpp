...
class CommunicationLimits {
 public:
  ...
  void SetCommunicationLimitsList(CommunicationLimitsListT&& value) {
    m_communicationLimitsListHasBeenSet = true;
    m_communicationLimitsList = std::forward<CommunicationLimitsListT>(value);
  }
  template <typename CommunicationLimitsListT = Aws::Vector<CommunicationLimit>>
  CommunicationLimits& WithCommunicationLimitsList(CommunicationLimitsListT&& value) {
    SetCommunicationLimitsList(std::forward<CommunicationLimitsListT>(value));
    return *this;
  }
  template <typename CommunicationLimitsListT = CommunicationLimit>
  CommunicationLimits& AddCommunicationLimitsList(CommunicationLimitsListT&& value) {
    m_communicationLimitsListHasBeenSet = true;
    m_communicationLimitsList.emplace_back(std::forward<CommunicationLimitsListT>(value));
    return *this;
  }
  ///@}
 private:
