...
class UpdateCampaignCommunicationTimeRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateCampaignCommunicationTimeRequest& WithId(IdT&& value) {
  ...
  template <typename CommunicationTimeConfigT = CommunicationTimeConfig>
  UpdateCampaignCommunicationTimeRequest& WithCommunicationTimeConfig(CommunicationTimeConfigT&& value) {
