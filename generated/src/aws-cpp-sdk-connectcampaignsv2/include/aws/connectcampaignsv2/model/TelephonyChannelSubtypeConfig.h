...
class TelephonyChannelSubtypeConfig {
 public:
  ...
  inline TelephonyChannelSubtypeConfig& WithCapacity(double value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectQueueId(ConnectQueueIdT&& value) {
    ...
    m_connectQueueId = std::forward<ConnectQueueIdT>(value);
  }
  template <typename ConnectQueueIdT = Aws::String>
  TelephonyChannelSubtypeConfig& WithConnectQueueId(ConnectQueueIdT&& value) {
    SetConnectQueueId(std::forward<ConnectQueueIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutboundModeT = TelephonyOutboundMode>
  TelephonyChannelSubtypeConfig& WithOutboundMode(OutboundModeT&& value) {
  ...
  template <typename DefaultOutboundConfigT = TelephonyOutboundConfig>
  TelephonyChannelSubtypeConfig& WithDefaultOutboundConfig(DefaultOutboundConfigT&& value) {
