...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/InternalServerException">AWS
   * API Reference</a></p>
   */
  class InternalServerException
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API InternalServerException() = default;
    AWS_CONNECTCAMPAIGNSV2_API InternalServerException(Aws::Utils::Json::JsonView jsonValue);
