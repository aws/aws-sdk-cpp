...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/AccessDeniedException">AWS
   * API Reference</a></p>
   */
  class AccessDeniedException
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API AccessDeniedException() = default;
    AWS_CONNECTCAMPAIGNSV2_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
