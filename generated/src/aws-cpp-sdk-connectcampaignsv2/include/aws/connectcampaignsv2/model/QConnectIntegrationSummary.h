...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API QConnectIntegrationSummary();
    ...
    inline QConnectIntegrationSummary& WithKnowledgeBaseArn(const Aws::String& value) { SetKnowledgeBaseArn(value); return *this;}
    inline QConnectIntegrationSummary& WithKnowledgeBaseArn(Aws::String&& value) { SetKnowledgeBaseArn(std::move(value)); return *this;}
    inline QConnectIntegrationSummary& WithKnowledgeBaseArn(const char* value) { SetKnowledgeBaseArn(value); return *this;}
    ///@}
  private:
