...
class LocalTimeZoneConfig {
 public:
  ...
  void SetDefaultTimeZone(DefaultTimeZoneT&& value) {
    m_defaultTimeZoneHasBeenSet = true;
    m_defaultTimeZone = std::forward<DefaultTimeZoneT>(value);
  }
  template <typename DefaultTimeZoneT = Aws::String>
  LocalTimeZoneConfig& WithDefaultTimeZone(DefaultTimeZoneT&& value) {
    SetDefaultTimeZone(std::forward<DefaultTimeZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalTimeZoneDetection(LocalTimeZoneDetectionT&& value) {
    ...
    m_localTimeZoneDetection = std::forward<LocalTimeZoneDetectionT>(value);
  }
  template <typename LocalTimeZoneDetectionT = Aws::Vector<LocalTimeZoneDetectionType>>
  LocalTimeZoneConfig& WithLocalTimeZoneDetection(LocalTimeZoneDetectionT&& value) {
    SetLocalTimeZoneDetection(std::forward<LocalTimeZoneDetectionT>(value));
    return *this;
  }
  inline LocalTimeZoneConfig& AddLocalTimeZoneDetection(LocalTimeZoneDetectionType value) {
    m_localTimeZoneDetectionHasBeenSet = true;
    m_localTimeZoneDetection.push_back(value);
    return *this;
  }
  ///@}
 private:
