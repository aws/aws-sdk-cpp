...
/**
 * <p>Parameters for the WhatsApp Channel Subtype</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/WhatsAppChannelSubtypeParameters">AWS
 * API Reference</a></p>
 */
class WhatsAppChannelSubtypeParameters {
 public:
  AWS_CONNECTCAMPAIGNSV2_API WhatsAppChannelSubtypeParameters() = default;
  AWS_CONNECTCAMPAIGNSV2_API WhatsAppChannelSubtypeParameters(Aws::Utils::Json::JsonView jsonValue);
  AWS_CONNECTCAMPAIGNSV2_API WhatsAppChannelSubtypeParameters& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename DestinationPhoneNumberT = Aws::String>
  WhatsAppChannelSubtypeParameters& WithDestinationPhoneNumber(DestinationPhoneNumberT&& value) {
  ...
  void SetConnectSourcePhoneNumberArn(ConnectSourcePhoneNumberArnT&& value) {
    ...
    m_connectSourcePhoneNumberArn = std::forward<ConnectSourcePhoneNumberArnT>(value);
  }
  template <typename ConnectSourcePhoneNumberArnT = Aws::String>
  WhatsAppChannelSubtypeParameters& WithConnectSourcePhoneNumberArn(ConnectSourcePhoneNumberArnT&& value) {
    SetConnectSourcePhoneNumberArn(std::forward<ConnectSourcePhoneNumberArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateArnT = Aws::String>
  WhatsAppChannelSubtypeParameters& WithTemplateArn(TemplateArnT&& value) {
  ...
  void SetTemplateParameters(TemplateParametersT&& value) {
    m_templateParametersHasBeenSet = true;
    m_templateParameters = std::forward<TemplateParametersT>(value);
  }
  template <typename TemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  WhatsAppChannelSubtypeParameters& WithTemplateParameters(TemplateParametersT&& value) {
    SetTemplateParameters(std::forward<TemplateParametersT>(value));
    return *this;
  }
  template <typename TemplateParametersKeyT = Aws::String, typename TemplateParametersValueT = Aws::String>
  WhatsAppChannelSubtypeParameters& AddTemplateParameters(TemplateParametersKeyT&& key, TemplateParametersValueT&& value) {
    m_templateParametersHasBeenSet = true;
    m_templateParameters.emplace(std::forward<TemplateParametersKeyT>(key), std::forward<TemplateParametersValueT>(value));
    return *this;
  }
  ///@}
 private:
