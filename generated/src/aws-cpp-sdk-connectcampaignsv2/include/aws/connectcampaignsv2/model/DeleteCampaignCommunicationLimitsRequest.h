...
class DeleteCampaignCommunicationLimitsRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename IdT = Aws::String>
  DeleteCampaignCommunicationLimitsRequest& WithId(IdT&& value) {
  ...
  inline void SetConfig(CommunicationLimitsConfigType value) {
    m_configHasBeenSet = true;
    m_config = value;
  }
  inline DeleteCampaignCommunicationLimitsRequest& WithConfig(CommunicationLimitsConfigType value) {
    SetConfig(value);
    return *this;
  }
  ///@}
