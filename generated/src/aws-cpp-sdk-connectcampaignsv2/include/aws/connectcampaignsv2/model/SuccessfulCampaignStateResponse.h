...
class SuccessfulCampaignStateResponse {
 public:
  ...
  template <typename CampaignIdT = Aws::String>
  SuccessfulCampaignStateResponse& WithCampaignId(CampaignIdT&& value) {
  ...
  inline void SetState(CampaignState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline SuccessfulCampaignStateResponse& WithState(CampaignState value) {
    SetState(value);
    return *this;
  }
  ///@}
