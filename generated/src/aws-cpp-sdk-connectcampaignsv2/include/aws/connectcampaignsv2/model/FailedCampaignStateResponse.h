...
class FailedCampaignStateResponse {
 public:
  ...
  inline void SetFailureCode(GetCampaignStateBatchFailureCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline FailedCampaignStateResponse& WithFailureCode(GetCampaignStateBatchFailureCode value) {
