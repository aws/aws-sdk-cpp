...
/**
 * <p>Progressive config</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/ProgressiveConfig">AWS
 * API Reference</a></p>
 */
class ProgressiveConfig {
 public:
  ...
  inline ProgressiveConfig& WithBandwidthAllocation(double value) {
