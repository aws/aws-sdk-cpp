...
class EmailChannelSubtypeConfig {
 public:
  ...
  inline EmailChannelSubtypeConfig& WithCapacity(double value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutboundModeT = EmailOutboundMode>
  EmailChannelSubtypeConfig& WithOutboundMode(OutboundModeT&& value) {
  ...
  template <typename DefaultOutboundConfigT = EmailOutboundConfig>
  EmailChannelSubtypeConfig& WithDefaultOutboundConfig(DefaultOutboundConfigT&& value) {
