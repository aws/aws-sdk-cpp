...
class PutOutboundRequestBatchResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNSV2_API PutOutboundRequestBatchResult& operator=(
  ...
  void SetSuccessfulRequests(SuccessfulRequestsT&& value) {
    m_successfulRequestsHasBeenSet = true;
    m_successfulRequests = std::forward<SuccessfulRequestsT>(value);
  }
  template <typename SuccessfulRequestsT = Aws::Vector<SuccessfulRequest>>
  PutOutboundRequestBatchResult& WithSuccessfulRequests(SuccessfulRequestsT&& value) {
    SetSuccessfulRequests(std::forward<SuccessfulRequestsT>(value));
    return *this;
  }
  template <typename SuccessfulRequestsT = SuccessfulRequest>
  PutOutboundRequestBatchResult& AddSuccessfulRequests(SuccessfulRequestsT&& value) {
    m_successfulRequestsHasBeenSet = true;
    m_successfulRequests.emplace_back(std::forward<SuccessfulRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedRequest>>
  PutOutboundRequestBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedRequest>
  PutOutboundRequestBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutOutboundRequestBatchResult& WithRequestId(RequestIdT&& value) {
