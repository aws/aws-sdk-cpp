...
/**
 * <p>The request for DeleteCampaignCommunicationTime API.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/DeleteCampaignCommunicationTimeRequest">AWS
 * API Reference</a></p>
 */
class DeleteCampaignCommunicationTimeRequest : public ConnectCampaignsV2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteCampaignCommunicationTime"; }
  ...
  template <typename IdT = Aws::String>
  DeleteCampaignCommunicationTimeRequest& WithId(IdT&& value) {
  ...
  inline void SetConfig(CommunicationTimeConfigType value) {
    m_configHasBeenSet = true;
    m_config = value;
  }
  inline DeleteCampaignCommunicationTimeRequest& WithConfig(CommunicationTimeConfigType value) {
    SetConfig(value);
    return *this;
  }
  ///@}
