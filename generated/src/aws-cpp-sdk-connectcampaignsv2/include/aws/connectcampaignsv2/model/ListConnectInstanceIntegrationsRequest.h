...
class ListConnectInstanceIntegrationsRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename ConnectInstanceIdT = Aws::String>
  ListConnectInstanceIntegrationsRequest& WithConnectInstanceId(ConnectInstanceIdT&& value) {
  ...
  inline ListConnectInstanceIntegrationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectInstanceIntegrationsRequest& WithNextToken(NextTokenT&& value) {
