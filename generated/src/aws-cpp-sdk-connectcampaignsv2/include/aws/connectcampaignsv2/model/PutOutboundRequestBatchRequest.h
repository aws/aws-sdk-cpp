...
class PutOutboundRequestBatchRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename IdT = Aws::String>
  PutOutboundRequestBatchRequest& WithId(IdT&& value) {
  ...
  void SetOutboundRequests(OutboundRequestsT&& value) {
    m_outboundRequestsHasBeenSet = true;
    m_outboundRequests = std::forward<OutboundRequestsT>(value);
  }
  template <typename OutboundRequestsT = Aws::Vector<OutboundRequest>>
  PutOutboundRequestBatchRequest& WithOutboundRequests(OutboundRequestsT&& value) {
    SetOutboundRequests(std::forward<OutboundRequestsT>(value));
    return *this;
  }
  template <typename OutboundRequestsT = OutboundRequest>
  PutOutboundRequestBatchRequest& AddOutboundRequests(OutboundRequestsT&& value) {
    m_outboundRequestsHasBeenSet = true;
    m_outboundRequests.emplace_back(std::forward<OutboundRequestsT>(value));
    return *this;
  }
  ///@}
 private:
