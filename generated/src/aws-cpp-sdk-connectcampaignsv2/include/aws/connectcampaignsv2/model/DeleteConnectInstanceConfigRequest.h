...
class DeleteConnectInstanceConfigRequest : public ConnectCampaignsV2Request {
 public:
  ...
  template <typename ConnectInstanceIdT = Aws::String>
  DeleteConnectInstanceConfigRequest& WithConnectInstanceId(ConnectInstanceIdT&& value) {
  ...
  inline void SetCampaignDeletionPolicy(CampaignDeletionPolicy value) {
    m_campaignDeletionPolicyHasBeenSet = true;
    m_campaignDeletionPolicy = value;
  }
  inline DeleteConnectInstanceConfigRequest& WithCampaignDeletionPolicy(CampaignDeletionPolicy value) {
    SetCampaignDeletionPolicy(value);
    return *this;
  }
  ///@}
 private:
