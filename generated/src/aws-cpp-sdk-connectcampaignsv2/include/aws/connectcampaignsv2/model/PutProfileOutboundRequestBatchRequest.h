...
class PutProfileOutboundRequestBatchRequest : public ConnectCampaignsV2Request {
 public:
  ...
  void SetProfileOutboundRequests(ProfileOutboundRequestsT&& value) {
    m_profileOutboundRequestsHasBeenSet = true;
    m_profileOutboundRequests = std::forward<ProfileOutboundRequestsT>(value);
  }
  template <typename ProfileOutboundRequestsT = Aws::Vector<ProfileOutboundRequest>>
  PutProfileOutboundRequestBatchRequest& WithProfileOutboundRequests(ProfileOutboundRequestsT&& value) {
    SetProfileOutboundRequests(std::forward<ProfileOutboundRequestsT>(value));
    return *this;
  }
  ...
  PutProfileOutboundRequestBatchRequest& AddProfileOutboundRequests(ProfileOutboundRequestsT&& value) {
    m_profileOutboundRequestsHasBeenSet = true;
    m_profileOutboundRequests.emplace_back(std::forward<ProfileOutboundRequestsT>(value));
    return *this;
  }
  ///@}
 private:
