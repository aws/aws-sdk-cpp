...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/connectcampaignsv2-2024-04-23/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_CONNECTCAMPAIGNSV2_API ServiceQuotaExceededException() = default;
    AWS_CONNECTCAMPAIGNSV2_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
