...
class TelephonyOutboundMode {
 public:
  ...
  void SetProgressive(ProgressiveT&& value) {
    ...
    m_progressive = std::forward<ProgressiveT>(value);
  }
  template <typename ProgressiveT = ProgressiveConfig>
  TelephonyOutboundMode& WithProgressive(ProgressiveT&& value) {
    SetProgressive(std::forward<ProgressiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredictive(PredictiveT&& value) {
    ...
    m_predictive = std::forward<PredictiveT>(value);
  }
  template <typename PredictiveT = PredictiveConfig>
  TelephonyOutboundMode& WithPredictive(PredictiveT&& value) {
    SetPredictive(std::forward<PredictiveT>(value));
    return *this;
  }
  ///@}
