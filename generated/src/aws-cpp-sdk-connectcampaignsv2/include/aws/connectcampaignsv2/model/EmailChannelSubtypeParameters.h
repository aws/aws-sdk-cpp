...
class EmailChannelSubtypeParameters {
 public:
  ...
  template <typename DestinationEmailAddressT = Aws::String>
  EmailChannelSubtypeParameters& WithDestinationEmailAddress(DestinationEmailAddressT&& value) {
  ...
  template <typename ConnectSourceEmailAddressT = Aws::String>
  EmailChannelSubtypeParameters& WithConnectSourceEmailAddress(ConnectSourceEmailAddressT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  EmailChannelSubtypeParameters& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename TemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  EmailChannelSubtypeParameters& WithTemplateParameters(TemplateParametersT&& value) {
