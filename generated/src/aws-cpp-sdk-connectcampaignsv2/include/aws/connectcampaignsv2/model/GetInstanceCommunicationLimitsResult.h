...
class GetInstanceCommunicationLimitsResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNSV2_API GetInstanceCommunicationLimitsResult& operator=(
  ...
  void SetCommunicationLimitsConfig(CommunicationLimitsConfigT&& value) {
    m_communicationLimitsConfigHasBeenSet = true;
    m_communicationLimitsConfig = std::forward<CommunicationLimitsConfigT>(value);
  }
  template <typename CommunicationLimitsConfigT = InstanceCommunicationLimitsConfig>
  GetInstanceCommunicationLimitsResult& WithCommunicationLimitsConfig(CommunicationLimitsConfigT&& value) {
    SetCommunicationLimitsConfig(std::forward<CommunicationLimitsConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetInstanceCommunicationLimitsResult& WithRequestId(RequestIdT&& value) {
