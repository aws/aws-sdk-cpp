...
class AnswerMachineDetectionConfig {
 public:
  ...
  inline void SetEnableAnswerMachineDetection(bool value) {
    m_enableAnswerMachineDetectionHasBeenSet = true;
    m_enableAnswerMachineDetection = value;
  }
  inline AnswerMachineDetectionConfig& WithEnableAnswerMachineDetection(bool value) {
    SetEnableAnswerMachineDetection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAwaitAnswerMachinePrompt(bool value) {
    ...
    m_awaitAnswerMachinePrompt = value;
  }
  inline AnswerMachineDetectionConfig& WithAwaitAnswerMachinePrompt(bool value) {
    SetAwaitAnswerMachinePrompt(value);
    return *this;
  }
  ///@}
 private:
