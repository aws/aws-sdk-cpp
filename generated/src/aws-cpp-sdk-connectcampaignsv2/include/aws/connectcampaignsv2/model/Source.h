...
class Source {
 public:
  ...
  void SetCustomerProfilesSegmentArn(CustomerProfilesSegmentArnT&& value) {
    ...
    m_customerProfilesSegmentArn = std::forward<CustomerProfilesSegmentArnT>(value);
  }
  template <typename CustomerProfilesSegmentArnT = Aws::String>
  Source& WithCustomerProfilesSegmentArn(CustomerProfilesSegmentArnT&& value) {
    SetCustomerProfilesSegmentArn(std::forward<CustomerProfilesSegmentArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventTrigger(EventTriggerT&& value) {
    ...
    m_eventTrigger = std::forward<EventTriggerT>(value);
  }
  template <typename EventTriggerT = EventTrigger>
  Source& WithEventTrigger(EventTriggerT&& value) {
    SetEventTrigger(std::forward<EventTriggerT>(value));
    return *this;
  }
  ///@}
 private:
