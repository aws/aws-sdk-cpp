...
class CommunicationLimitsConfig {
 public:
  ...
  void SetAllChannelSubtypes(AllChannelSubtypesT&& value) {
    ...
    m_allChannelSubtypes = std::forward<AllChannelSubtypesT>(value);
  }
  template <typename AllChannelSubtypesT = CommunicationLimits>
  CommunicationLimitsConfig& WithAllChannelSubtypes(AllChannelSubtypesT&& value) {
    SetAllChannelSubtypes(std::forward<AllChannelSubtypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceLimitsHandling(InstanceLimitsHandling value) {
    m_instanceLimitsHandlingHasBeenSet = true;
    m_instanceLimitsHandling = value;
  }
  inline CommunicationLimitsConfig& WithInstanceLimitsHandling(InstanceLimitsHandling value) {
    SetInstanceLimitsHandling(value);
    return *this;
  }
  ///@}
 private:
