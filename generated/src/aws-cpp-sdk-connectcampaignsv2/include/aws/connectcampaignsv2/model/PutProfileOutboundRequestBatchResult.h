...
class PutProfileOutboundRequestBatchResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNSV2_API PutProfileOutboundRequestBatchResult& operator=(
  ...
  template <typename SuccessfulRequestsT = Aws::Vector<SuccessfulProfileOutboundRequest>>
  PutProfileOutboundRequestBatchResult& WithSuccessfulRequests(SuccessfulRequestsT&& value) {
  ...
  PutProfileOutboundRequestBatchResult& AddSuccessfulRequests(SuccessfulRequestsT&& value) {
    m_successfulRequestsHasBeenSet = true;
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedProfileOutboundRequest>>
  PutProfileOutboundRequestBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedProfileOutboundRequest>
  PutProfileOutboundRequestBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutProfileOutboundRequestBatchResult& WithRequestId(RequestIdT&& value) {
