...
class FailedProfileOutboundRequest {
 public:
  ...
  inline void SetFailureCode(ProfileOutboundRequestFailureCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline FailedProfileOutboundRequest& WithFailureCode(ProfileOutboundRequestFailureCode value) {
