...
namespace ConnectCampaignsV2
{
   ...
   */
  class AWS_CONNECTCAMPAIGNSV2_API ConnectCampaignsV2Client : smithy::client::AwsSmithyClientT<Aws::ConnectCampaignsV2::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<ConnectCampaignsV2Client>
  {
    public:
