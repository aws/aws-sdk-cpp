...
class AWS_CONNECTCAMPAIGNSV2_API ConnectCampaignsV2Client : public Aws::Client::AWSJsonClient,
                                                            ...
                                                            public ConnectCampaignsV2Waiter<ConnectCampaignsV2Client> {
 public:
   ...
   */
  ConnectCampaignsV2Client(const Aws::ConnectCampaignsV2::ConnectCampaignsV2ClientConfiguration& clientConfiguration =
                               Aws::ConnectCampaignsV2::ConnectCampaignsV2ClientConfiguration(),
  ...
  ConnectCampaignsV2Client(const Aws::Auth::AWSCredentials& credentials,
                           std::shared_ptr<ConnectCampaignsV2EndpointProviderBase> endpointProvider = nullptr,
                           const Aws::ConnectCampaignsV2::ConnectCampaignsV2ClientConfiguration& clientConfiguration =
                               Aws::ConnectCampaignsV2::ConnectCampaignsV2ClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCampaignChannelSubtypeConfigOutcome DeleteCampaignChannelSubtypeConfig(
      const Model::DeleteCampaignChannelSubtypeConfigRequest& request) const;

  /**
   * A Callable wrapper for DeleteCampaignChannelSubtypeConfig that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteCampaignChannelSubtypeConfigRequestT = Model::DeleteCampaignChannelSubtypeConfigRequest>
  Model::DeleteCampaignChannelSubtypeConfigOutcomeCallable DeleteCampaignChannelSubtypeConfigCallable(
      const DeleteCampaignChannelSubtypeConfigRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::DeleteCampaignChannelSubtypeConfig, request);
  }

  /**
   * An Async wrapper for DeleteCampaignChannelSubtypeConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCampaignChannelSubtypeConfigRequestT = Model::DeleteCampaignChannelSubtypeConfigRequest>
  void DeleteCampaignChannelSubtypeConfigAsync(const DeleteCampaignChannelSubtypeConfigRequestT& request,
                                               const DeleteCampaignChannelSubtypeConfigResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCampaignCommunicationLimitsOutcome DeleteCampaignCommunicationLimits(
      const Model::DeleteCampaignCommunicationLimitsRequest& request) const;

  /**
   * A Callable wrapper for DeleteCampaignCommunicationLimits that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteCampaignCommunicationLimitsRequestT = Model::DeleteCampaignCommunicationLimitsRequest>
  Model::DeleteCampaignCommunicationLimitsOutcomeCallable DeleteCampaignCommunicationLimitsCallable(
      const DeleteCampaignCommunicationLimitsRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::DeleteCampaignCommunicationLimits, request);
  }

  /**
   * An Async wrapper for DeleteCampaignCommunicationLimits that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCampaignCommunicationLimitsRequestT = Model::DeleteCampaignCommunicationLimitsRequest>
  void DeleteCampaignCommunicationLimitsAsync(const DeleteCampaignCommunicationLimitsRequestT& request,
                                              const DeleteCampaignCommunicationLimitsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCampaignCommunicationTimeOutcome DeleteCampaignCommunicationTime(
      const Model::DeleteCampaignCommunicationTimeRequest& request) const;

  /**
   * A Callable wrapper for DeleteCampaignCommunicationTime that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCampaignCommunicationTimeRequestT = Model::DeleteCampaignCommunicationTimeRequest>
  Model::DeleteCampaignCommunicationTimeOutcomeCallable DeleteCampaignCommunicationTimeCallable(
      const DeleteCampaignCommunicationTimeRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::DeleteCampaignCommunicationTime, request);
  }

  /**
   * An Async wrapper for DeleteCampaignCommunicationTime that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCampaignCommunicationTimeRequestT = Model::DeleteCampaignCommunicationTimeRequest>
  void DeleteCampaignCommunicationTimeAsync(const DeleteCampaignCommunicationTimeRequestT& request,
                                            const DeleteCampaignCommunicationTimeResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConnectInstanceIntegrationOutcome DeleteConnectInstanceIntegration(
      const Model::DeleteConnectInstanceIntegrationRequest& request) const;

  /**
   * A Callable wrapper for DeleteConnectInstanceIntegration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteConnectInstanceIntegrationRequestT = Model::DeleteConnectInstanceIntegrationRequest>
  Model::DeleteConnectInstanceIntegrationOutcomeCallable DeleteConnectInstanceIntegrationCallable(
      const DeleteConnectInstanceIntegrationRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::DeleteConnectInstanceIntegration, request);
  }

  /**
   * An Async wrapper for DeleteConnectInstanceIntegration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteConnectInstanceIntegrationRequestT = Model::DeleteConnectInstanceIntegrationRequest>
  void DeleteConnectInstanceIntegrationAsync(const DeleteConnectInstanceIntegrationRequestT& request,
                                             const DeleteConnectInstanceIntegrationResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetInstanceCommunicationLimitsOutcome GetInstanceCommunicationLimits(
      const Model::GetInstanceCommunicationLimitsRequest& request) const;

  /**
   * A Callable wrapper for GetInstanceCommunicationLimits that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetInstanceCommunicationLimitsRequestT = Model::GetInstanceCommunicationLimitsRequest>
  Model::GetInstanceCommunicationLimitsOutcomeCallable GetInstanceCommunicationLimitsCallable(
      const GetInstanceCommunicationLimitsRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::GetInstanceCommunicationLimits, request);
  }

  /**
   * An Async wrapper for GetInstanceCommunicationLimits that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetInstanceCommunicationLimitsRequestT = Model::GetInstanceCommunicationLimitsRequest>
  void GetInstanceCommunicationLimitsAsync(const GetInstanceCommunicationLimitsRequestT& request,
                                           const GetInstanceCommunicationLimitsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListConnectInstanceIntegrationsOutcome ListConnectInstanceIntegrations(
      const Model::ListConnectInstanceIntegrationsRequest& request) const;

  /**
   * A Callable wrapper for ListConnectInstanceIntegrations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConnectInstanceIntegrationsRequestT = Model::ListConnectInstanceIntegrationsRequest>
  Model::ListConnectInstanceIntegrationsOutcomeCallable ListConnectInstanceIntegrationsCallable(
      const ListConnectInstanceIntegrationsRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::ListConnectInstanceIntegrations, request);
  }

  /**
   * An Async wrapper for ListConnectInstanceIntegrations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListConnectInstanceIntegrationsRequestT = Model::ListConnectInstanceIntegrationsRequest>
  void ListConnectInstanceIntegrationsAsync(const ListConnectInstanceIntegrationsRequestT& request,
                                            const ListConnectInstanceIntegrationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutConnectInstanceIntegrationOutcome PutConnectInstanceIntegration(
      const Model::PutConnectInstanceIntegrationRequest& request) const;

  /**
   * A Callable wrapper for PutConnectInstanceIntegration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutConnectInstanceIntegrationRequestT = Model::PutConnectInstanceIntegrationRequest>
  Model::PutConnectInstanceIntegrationOutcomeCallable PutConnectInstanceIntegrationCallable(
      const PutConnectInstanceIntegrationRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::PutConnectInstanceIntegration, request);
  }

  /**
   * An Async wrapper for PutConnectInstanceIntegration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutConnectInstanceIntegrationRequestT = Model::PutConnectInstanceIntegrationRequest>
  void PutConnectInstanceIntegrationAsync(const PutConnectInstanceIntegrationRequestT& request,
                                          const PutConnectInstanceIntegrationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutInstanceCommunicationLimitsOutcome PutInstanceCommunicationLimits(
      const Model::PutInstanceCommunicationLimitsRequest& request) const;

  /**
   * A Callable wrapper for PutInstanceCommunicationLimits that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutInstanceCommunicationLimitsRequestT = Model::PutInstanceCommunicationLimitsRequest>
  Model::PutInstanceCommunicationLimitsOutcomeCallable PutInstanceCommunicationLimitsCallable(
      const PutInstanceCommunicationLimitsRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::PutInstanceCommunicationLimits, request);
  }

  /**
   * An Async wrapper for PutInstanceCommunicationLimits that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutInstanceCommunicationLimitsRequestT = Model::PutInstanceCommunicationLimitsRequest>
  void PutInstanceCommunicationLimitsAsync(const PutInstanceCommunicationLimitsRequestT& request,
                                           const PutInstanceCommunicationLimitsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutOutboundRequestBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutOutboundRequestBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutOutboundRequestBatchRequestT = Model::PutOutboundRequestBatchRequest>
  void PutOutboundRequestBatchAsync(const PutOutboundRequestBatchRequestT& request,
                                    const PutOutboundRequestBatchResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PutProfileOutboundRequestBatchOutcome PutProfileOutboundRequestBatch(
      const Model::PutProfileOutboundRequestBatchRequest& request) const;

  /**
   * A Callable wrapper for PutProfileOutboundRequestBatch that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutProfileOutboundRequestBatchRequestT = Model::PutProfileOutboundRequestBatchRequest>
  Model::PutProfileOutboundRequestBatchOutcomeCallable PutProfileOutboundRequestBatchCallable(
      const PutProfileOutboundRequestBatchRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::PutProfileOutboundRequestBatch, request);
  }

  /**
   * An Async wrapper for PutProfileOutboundRequestBatch that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutProfileOutboundRequestBatchRequestT = Model::PutProfileOutboundRequestBatchRequest>
  void PutProfileOutboundRequestBatchAsync(const PutProfileOutboundRequestBatchRequestT& request,
                                           const PutProfileOutboundRequestBatchResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateCampaignChannelSubtypeConfigOutcome UpdateCampaignChannelSubtypeConfig(
      const Model::UpdateCampaignChannelSubtypeConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateCampaignChannelSubtypeConfig that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateCampaignChannelSubtypeConfigRequestT = Model::UpdateCampaignChannelSubtypeConfigRequest>
  Model::UpdateCampaignChannelSubtypeConfigOutcomeCallable UpdateCampaignChannelSubtypeConfigCallable(
      const UpdateCampaignChannelSubtypeConfigRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::UpdateCampaignChannelSubtypeConfig, request);
  }

  /**
   * An Async wrapper for UpdateCampaignChannelSubtypeConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCampaignChannelSubtypeConfigRequestT = Model::UpdateCampaignChannelSubtypeConfigRequest>
  void UpdateCampaignChannelSubtypeConfigAsync(const UpdateCampaignChannelSubtypeConfigRequestT& request,
                                               const UpdateCampaignChannelSubtypeConfigResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCampaignCommunicationLimitsOutcome UpdateCampaignCommunicationLimits(
      const Model::UpdateCampaignCommunicationLimitsRequest& request) const;

  /**
   * A Callable wrapper for UpdateCampaignCommunicationLimits that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateCampaignCommunicationLimitsRequestT = Model::UpdateCampaignCommunicationLimitsRequest>
  Model::UpdateCampaignCommunicationLimitsOutcomeCallable UpdateCampaignCommunicationLimitsCallable(
      const UpdateCampaignCommunicationLimitsRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::UpdateCampaignCommunicationLimits, request);
  }

  /**
   * An Async wrapper for UpdateCampaignCommunicationLimits that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCampaignCommunicationLimitsRequestT = Model::UpdateCampaignCommunicationLimitsRequest>
  void UpdateCampaignCommunicationLimitsAsync(const UpdateCampaignCommunicationLimitsRequestT& request,
                                              const UpdateCampaignCommunicationLimitsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCampaignCommunicationTimeOutcome UpdateCampaignCommunicationTime(
      const Model::UpdateCampaignCommunicationTimeRequest& request) const;

  /**
   * A Callable wrapper for UpdateCampaignCommunicationTime that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCampaignCommunicationTimeRequestT = Model::UpdateCampaignCommunicationTimeRequest>
  Model::UpdateCampaignCommunicationTimeOutcomeCallable UpdateCampaignCommunicationTimeCallable(
      const UpdateCampaignCommunicationTimeRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::UpdateCampaignCommunicationTime, request);
  }

  /**
   * An Async wrapper for UpdateCampaignCommunicationTime that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCampaignCommunicationTimeRequestT = Model::UpdateCampaignCommunicationTimeRequest>
  void UpdateCampaignCommunicationTimeAsync(const UpdateCampaignCommunicationTimeRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCampaignFlowAssociationOutcome UpdateCampaignFlowAssociation(
      const Model::UpdateCampaignFlowAssociationRequest& request) const;

  /**
   * A Callable wrapper for UpdateCampaignFlowAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCampaignFlowAssociationRequestT = Model::UpdateCampaignFlowAssociationRequest>
  Model::UpdateCampaignFlowAssociationOutcomeCallable UpdateCampaignFlowAssociationCallable(
      const UpdateCampaignFlowAssociationRequestT& request) const {
    return SubmitCallable(&ConnectCampaignsV2Client::UpdateCampaignFlowAssociation, request);
  }

  /**
   * An Async wrapper for UpdateCampaignFlowAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCampaignFlowAssociationRequestT = Model::UpdateCampaignFlowAssociationRequest>
  void UpdateCampaignFlowAssociationAsync(const UpdateCampaignFlowAssociationRequestT& request,
                                          const UpdateCampaignFlowAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCampaignSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCampaignSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCampaignScheduleRequestT = Model::UpdateCampaignScheduleRequest>
  void UpdateCampaignScheduleAsync(const UpdateCampaignScheduleRequestT& request,
                                   const UpdateCampaignScheduleResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCampaignSource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCampaignSource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCampaignSourceRequestT = Model::UpdateCampaignSourceRequest>
  void UpdateCampaignSourceAsync(const UpdateCampaignSourceRequestT& request, const UpdateCampaignSourceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, ConnectCampaignsV2Error> InvokeOperationOutcome;
