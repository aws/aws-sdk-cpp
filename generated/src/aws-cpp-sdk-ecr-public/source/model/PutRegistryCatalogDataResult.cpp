...
PutRegistryCatalogDataResult::PutRegistryCatalogDataResult()
{
}

PutRegistryCatalogDataResult::PutRegistryCatalogDataResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
