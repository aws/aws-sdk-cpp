...
namespace ECRPublic
{
const size_t ECRPublicEndpointRules::RulesBlobStrLen = 1662;
const size_t ECRPublicEndpointRules::RulesBlobSize = 1663;
...
'}',']',',','"','e','r','r','o','r','"',':','"','E','C','R',' ','P','u','b','l','i','c',' ','d','o',
...
'e','c','r','-','p','u','b','l','i','c','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'-','p','u','b','l','i','c','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
