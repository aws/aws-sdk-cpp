...
class AWS_ECRPUBLIC_API ECRPublicClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ECRPublicClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ECRPublicEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for DescribeImageTags that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeImageTags that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeImageTagsRequestT = Model::DescribeImageTagsRequest>
  void DescribeImageTagsAsync(const DescribeImageTagsRequestT& request, const DescribeImageTagsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRegistries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRegistries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRegistriesRequestT = Model::DescribeRegistriesRequest>
  void DescribeRegistriesAsync(const DescribeRegistriesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeRegistriesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRegistryCatalogData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRegistryCatalogData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRegistryCatalogDataRequestT = Model::GetRegistryCatalogDataRequest>
  void GetRegistryCatalogDataAsync(const GetRegistryCatalogDataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetRegistryCatalogDataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRepositoryCatalogData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRepositoryCatalogData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRepositoryCatalogDataRequestT = Model::GetRepositoryCatalogDataRequest>
  void GetRepositoryCatalogDataAsync(const GetRepositoryCatalogDataRequestT& request,
                                     const GetRepositoryCatalogDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRegistryCatalogData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRegistryCatalogData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRegistryCatalogDataRequestT = Model::PutRegistryCatalogDataRequest>
  void PutRegistryCatalogDataAsync(const PutRegistryCatalogDataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const PutRegistryCatalogDataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutRepositoryCatalogData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRepositoryCatalogData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRepositoryCatalogDataRequestT = Model::PutRepositoryCatalogDataRequest>
  void PutRepositoryCatalogDataAsync(const PutRepositoryCatalogDataRequestT& request,
                                     const PutRepositoryCatalogDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<ECRPublicEndpointProviderBase>& accessEndpointProvider();
