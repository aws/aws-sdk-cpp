...
class ImageTagDetail {
 public:
  ...
  template <typename ImageTagT = Aws::String>
  ImageTagDetail& WithImageTag(ImageTagT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ImageTagDetail& WithCreatedAt(CreatedAtT&& value) {
  ...
  void SetImageDetail(ImageDetailT&& value) {
    m_imageDetailHasBeenSet = true;
    m_imageDetail = std::forward<ImageDetailT>(value);
  }
  template <typename ImageDetailT = ReferencedImageDetail>
  ImageTagDetail& WithImageDetail(ImageDetailT&& value) {
    SetImageDetail(std::forward<ImageDetailT>(value));
    return *this;
  }
  ///@}
 private:
