...
class RepositoryCatalogData {
 public:
  ...
  void SetAboutText(AboutTextT&& value) {
    ...
    m_aboutText = std::forward<AboutTextT>(value);
  }
  template <typename AboutTextT = Aws::String>
  RepositoryCatalogData& WithAboutText(AboutTextT&& value) {
    SetAboutText(std::forward<AboutTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUsageText(UsageTextT&& value) {
    ...
    m_usageText = std::forward<UsageTextT>(value);
  }
  template <typename UsageTextT = Aws::String>
  RepositoryCatalogData& WithUsageText(UsageTextT&& value) {
    SetUsageText(std::forward<UsageTextT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMarketplaceCertified(bool value) {
    m_marketplaceCertifiedHasBeenSet = true;
    m_marketplaceCertified = value;
  }
  inline RepositoryCatalogData& WithMarketplaceCertified(bool value) {
    SetMarketplaceCertified(value);
    return *this;
  }
  ///@}
 private:
