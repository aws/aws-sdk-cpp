...
namespace Model
{
  ...
  {
  public:
    AWS_ECRPUBLIC_API DeleteRepositoryPolicyRequest() = default;
    ...
    template<typename RegistryIdT = Aws::String>
    DeleteRepositoryPolicyRequest& WithRegistryId(RegistryIdT&& value) { SetRegistryId(std::forward<RegistryIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryNameT = Aws::String>
    DeleteRepositoryPolicyRequest& WithRepositoryName(RepositoryNameT&& value) { SetRepositoryName(std::forward<RepositoryNameT>(value)); return *this;}
    ///@}
  private:
