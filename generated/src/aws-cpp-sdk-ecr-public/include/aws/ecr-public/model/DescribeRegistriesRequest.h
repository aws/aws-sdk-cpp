...
class DescribeRegistriesRequest : public ECRPublicRequest {
 public:
  AWS_ECRPUBLIC_API DescribeRegistriesRequest() = default;
   ...
   * If there are no more results to return, this value is <code>null</code>.</p>
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeRegistriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
