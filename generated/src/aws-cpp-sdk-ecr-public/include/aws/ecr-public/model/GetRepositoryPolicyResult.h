...
class GetRepositoryPolicyResult {
 public:
  AWS_ECRPUBLIC_API GetRepositoryPolicyResult() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  GetRepositoryPolicyResult& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  GetRepositoryPolicyResult& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename PolicyTextT = Aws::String>
  GetRepositoryPolicyResult& WithPolicyText(PolicyTextT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRepositoryPolicyResult& WithRequestId(RequestIdT&& value) {
