...
class DescribeRegistriesResult {
 public:
  ...
  template <typename RegistriesT = Aws::Vector<Registry>>
  DescribeRegistriesResult& WithRegistries(RegistriesT&& value) {
    SetRegistries(std::forward<RegistriesT>(value));
    return *this;
  }
  template <typename RegistriesT = Registry>
  DescribeRegistriesResult& AddRegistries(RegistriesT&& value) {
    m_registriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRegistriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRegistriesResult& WithRequestId(RequestIdT&& value) {
