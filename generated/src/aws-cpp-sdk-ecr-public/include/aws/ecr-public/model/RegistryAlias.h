...
class RegistryAlias {
 public:
  ...
  template <typename NameT = Aws::String>
  RegistryAlias& WithName(NameT&& value) {
  ...
  inline void SetStatus(RegistryAliasStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RegistryAlias& WithStatus(RegistryAliasStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrimaryRegistryAlias(bool value) {
    m_primaryRegistryAliasHasBeenSet = true;
    m_primaryRegistryAlias = value;
  }
  inline RegistryAlias& WithPrimaryRegistryAlias(bool value) {
    SetPrimaryRegistryAlias(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultRegistryAlias(bool value) {
    m_defaultRegistryAliasHasBeenSet = true;
    m_defaultRegistryAlias = value;
  }
  inline RegistryAlias& WithDefaultRegistryAlias(bool value) {
    SetDefaultRegistryAlias(value);
    return *this;
  }
  ///@}
 private:
