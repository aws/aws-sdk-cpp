...
class DescribeImageTagsResult {
 public:
  ...
  void SetImageTagDetails(ImageTagDetailsT&& value) {
    m_imageTagDetailsHasBeenSet = true;
    m_imageTagDetails = std::forward<ImageTagDetailsT>(value);
  }
  template <typename ImageTagDetailsT = Aws::Vector<ImageTagDetail>>
  DescribeImageTagsResult& WithImageTagDetails(ImageTagDetailsT&& value) {
    SetImageTagDetails(std::forward<ImageTagDetailsT>(value));
    return *this;
  }
  template <typename ImageTagDetailsT = ImageTagDetail>
  DescribeImageTagsResult& AddImageTagDetails(ImageTagDetailsT&& value) {
    m_imageTagDetailsHasBeenSet = true;
    m_imageTagDetails.emplace_back(std::forward<ImageTagDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageTagsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeImageTagsResult& WithRequestId(RequestIdT&& value) {
