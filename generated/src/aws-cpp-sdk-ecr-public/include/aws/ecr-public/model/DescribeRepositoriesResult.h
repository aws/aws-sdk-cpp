...
class DescribeRepositoriesResult {
 public:
  ...
  template <typename RepositoriesT = Aws::Vector<Repository>>
  DescribeRepositoriesResult& WithRepositories(RepositoriesT&& value) {
    SetRepositories(std::forward<RepositoriesT>(value));
    return *this;
  }
  template <typename RepositoriesT = Repository>
  DescribeRepositoriesResult& AddRepositories(RepositoriesT&& value) {
    m_repositoriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRepositoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeRepositoriesResult& WithRequestId(RequestIdT&& value) {
