...
/**
 */
class SetRepositoryPolicyRequest : public ECRPublicRequest {
 public:
  AWS_ECRPUBLIC_API SetRepositoryPolicyRequest() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  SetRepositoryPolicyRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  SetRepositoryPolicyRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  void SetPolicyText(PolicyTextT&& value) {
    ...
    m_policyText = std::forward<PolicyTextT>(value);
  }
  template <typename PolicyTextT = Aws::String>
  SetRepositoryPolicyRequest& WithPolicyText(PolicyTextT&& value) {
    SetPolicyText(std::forward<PolicyTextT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>If the policy that you want to set on a repository policy would prevent you
  ...
  inline SetRepositoryPolicyRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
