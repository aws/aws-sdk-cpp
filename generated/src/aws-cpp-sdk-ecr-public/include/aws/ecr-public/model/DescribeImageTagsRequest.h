...
class DescribeImageTagsRequest : public ECRPublicRequest {
 public:
  AWS_ECRPUBLIC_API DescribeImageTagsRequest() = default;
  ...
  template <typename RegistryIdT = Aws::String>
  DescribeImageTagsRequest& WithRegistryId(RegistryIdT&& value) {
  ...
  template <typename RepositoryNameT = Aws::String>
  DescribeImageTagsRequest& WithRepositoryName(RepositoryNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageTagsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeImageTagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
