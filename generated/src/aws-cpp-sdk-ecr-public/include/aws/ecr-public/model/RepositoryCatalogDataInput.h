...
class RepositoryCatalogDataInput {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  RepositoryCatalogDataInput& WithDescription(DescriptionT&& value) {
  ...
  template <typename ArchitecturesT = Aws::Vector<Aws::String>>
  RepositoryCatalogDataInput& WithArchitectures(ArchitecturesT&& value) {
    SetArchitectures(std::forward<ArchitecturesT>(value));
    return *this;
  }
  template <typename ArchitecturesT = Aws::String>
  RepositoryCatalogDataInput& AddArchitectures(ArchitecturesT&& value) {
    m_architecturesHasBeenSet = true;
  ...
  template <typename OperatingSystemsT = Aws::Vector<Aws::String>>
  RepositoryCatalogDataInput& WithOperatingSystems(OperatingSystemsT&& value) {
    SetOperatingSystems(std::forward<OperatingSystemsT>(value));
    return *this;
  }
  template <typename OperatingSystemsT = Aws::String>
  RepositoryCatalogDataInput& AddOperatingSystems(OperatingSystemsT&& value) {
    m_operatingSystemsHasBeenSet = true;
  ...
  void SetLogoImageBlob(LogoImageBlobT&& value) {
    m_logoImageBlobHasBeenSet = true;
    m_logoImageBlob = std::forward<LogoImageBlobT>(value);
  }
  template <typename LogoImageBlobT = Aws::Utils::ByteBuffer>
  RepositoryCatalogDataInput& WithLogoImageBlob(LogoImageBlobT&& value) {
    SetLogoImageBlob(std::forward<LogoImageBlobT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AboutTextT = Aws::String>
  RepositoryCatalogDataInput& WithAboutText(AboutTextT&& value) {
  ...
  template <typename UsageTextT = Aws::String>
  RepositoryCatalogDataInput& WithUsageText(UsageTextT&& value) {
