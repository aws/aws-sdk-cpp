...
class AWS_COMPREHENDMEDICAL_API ComprehendMedicalClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ComprehendMedicalClient(const Aws::ComprehendMedical::ComprehendMedicalClientConfiguration& clientConfiguration =
  ...
  ComprehendMedicalClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<ComprehendMedicalEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::ComprehendMedical::ComprehendMedicalClientConfiguration& clientConfiguration =
                              Aws::ComprehendMedical::ComprehendMedicalClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEntitiesDetectionV2JobOutcome DescribeEntitiesDetectionV2Job(
      const Model::DescribeEntitiesDetectionV2JobRequest& request) const;

  /**
   * A Callable wrapper for DescribeEntitiesDetectionV2Job that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEntitiesDetectionV2JobRequestT = Model::DescribeEntitiesDetectionV2JobRequest>
  Model::DescribeEntitiesDetectionV2JobOutcomeCallable DescribeEntitiesDetectionV2JobCallable(
      const DescribeEntitiesDetectionV2JobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::DescribeEntitiesDetectionV2Job, request);
  }

  /**
   * An Async wrapper for DescribeEntitiesDetectionV2Job that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEntitiesDetectionV2JobRequestT = Model::DescribeEntitiesDetectionV2JobRequest>
  void DescribeEntitiesDetectionV2JobAsync(const DescribeEntitiesDetectionV2JobRequestT& request,
                                           const DescribeEntitiesDetectionV2JobResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeICD10CMInferenceJobOutcome DescribeICD10CMInferenceJob(
      const Model::DescribeICD10CMInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeICD10CMInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeICD10CMInferenceJobRequestT = Model::DescribeICD10CMInferenceJobRequest>
  Model::DescribeICD10CMInferenceJobOutcomeCallable DescribeICD10CMInferenceJobCallable(
      const DescribeICD10CMInferenceJobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::DescribeICD10CMInferenceJob, request);
  }

  /**
   * An Async wrapper for DescribeICD10CMInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeICD10CMInferenceJobRequestT = Model::DescribeICD10CMInferenceJobRequest>
  void DescribeICD10CMInferenceJobAsync(const DescribeICD10CMInferenceJobRequestT& request,
                                        const DescribeICD10CMInferenceJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePHIDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePHIDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePHIDetectionJobRequestT = Model::DescribePHIDetectionJobRequest>
  void DescribePHIDetectionJobAsync(const DescribePHIDetectionJobRequestT& request,
                                    const DescribePHIDetectionJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRxNormInferenceJobOutcome DescribeRxNormInferenceJob(
      const Model::DescribeRxNormInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeRxNormInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRxNormInferenceJobRequestT = Model::DescribeRxNormInferenceJobRequest>
  Model::DescribeRxNormInferenceJobOutcomeCallable DescribeRxNormInferenceJobCallable(
      const DescribeRxNormInferenceJobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::DescribeRxNormInferenceJob, request);
  }

  /**
   * An Async wrapper for DescribeRxNormInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRxNormInferenceJobRequestT = Model::DescribeRxNormInferenceJobRequest>
  void DescribeRxNormInferenceJobAsync(const DescribeRxNormInferenceJobRequestT& request,
                                       const DescribeRxNormInferenceJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSNOMEDCTInferenceJobOutcome DescribeSNOMEDCTInferenceJob(
      const Model::DescribeSNOMEDCTInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeSNOMEDCTInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSNOMEDCTInferenceJobRequestT = Model::DescribeSNOMEDCTInferenceJobRequest>
  Model::DescribeSNOMEDCTInferenceJobOutcomeCallable DescribeSNOMEDCTInferenceJobCallable(
      const DescribeSNOMEDCTInferenceJobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::DescribeSNOMEDCTInferenceJob, request);
  }

  /**
   * An Async wrapper for DescribeSNOMEDCTInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSNOMEDCTInferenceJobRequestT = Model::DescribeSNOMEDCTInferenceJobRequest>
  void DescribeSNOMEDCTInferenceJobAsync(const DescribeSNOMEDCTInferenceJobRequestT& request,
                                         const DescribeSNOMEDCTInferenceJobResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectEntitiesV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectEntitiesV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DetectEntitiesV2RequestT = Model::DetectEntitiesV2Request>
  void DetectEntitiesV2Async(const DetectEntitiesV2RequestT& request, const DetectEntitiesV2ResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DetectPHI that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DetectPHIRequestT = Model::DetectPHIRequest>
  void DetectPHIAsync(const DetectPHIRequestT& request, const DetectPHIResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for InferICD10CM that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename InferICD10CMRequestT = Model::InferICD10CMRequest>
  void InferICD10CMAsync(const InferICD10CMRequestT& request, const InferICD10CMResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for InferRxNorm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename InferRxNormRequestT = Model::InferRxNormRequest>
  void InferRxNormAsync(const InferRxNormRequestT& request, const InferRxNormResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for InferSNOMEDCT that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename InferSNOMEDCTRequestT = Model::InferSNOMEDCTRequest>
  void InferSNOMEDCTAsync(const InferSNOMEDCTRequestT& request, const InferSNOMEDCTResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEntitiesDetectionV2JobsOutcome ListEntitiesDetectionV2Jobs(
      const Model::ListEntitiesDetectionV2JobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEntitiesDetectionV2Jobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEntitiesDetectionV2JobsRequestT = Model::ListEntitiesDetectionV2JobsRequest>
  Model::ListEntitiesDetectionV2JobsOutcomeCallable ListEntitiesDetectionV2JobsCallable(
      const ListEntitiesDetectionV2JobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendMedicalClient::ListEntitiesDetectionV2Jobs, request);
  }

  /**
   * An Async wrapper for ListEntitiesDetectionV2Jobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEntitiesDetectionV2JobsRequestT = Model::ListEntitiesDetectionV2JobsRequest>
  void ListEntitiesDetectionV2JobsAsync(const ListEntitiesDetectionV2JobsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for ListICD10CMInferenceJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListICD10CMInferenceJobsRequestT = Model::ListICD10CMInferenceJobsRequest>
  Model::ListICD10CMInferenceJobsOutcomeCallable ListICD10CMInferenceJobsCallable(
      const ListICD10CMInferenceJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendMedicalClient::ListICD10CMInferenceJobs, request);
  }

  /**
   * An Async wrapper for ListICD10CMInferenceJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListICD10CMInferenceJobsRequestT = Model::ListICD10CMInferenceJobsRequest>
  void ListICD10CMInferenceJobsAsync(const ListICD10CMInferenceJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListICD10CMInferenceJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPHIDetectionJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPHIDetectionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPHIDetectionJobsRequestT = Model::ListPHIDetectionJobsRequest>
  void ListPHIDetectionJobsAsync(const ListPHIDetectionJobsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListPHIDetectionJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRxNormInferenceJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRxNormInferenceJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRxNormInferenceJobsRequestT = Model::ListRxNormInferenceJobsRequest>
  void ListRxNormInferenceJobsAsync(const ListRxNormInferenceJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListRxNormInferenceJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSNOMEDCTInferenceJobsOutcome ListSNOMEDCTInferenceJobs(
      const Model::ListSNOMEDCTInferenceJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSNOMEDCTInferenceJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSNOMEDCTInferenceJobsRequestT = Model::ListSNOMEDCTInferenceJobsRequest>
  Model::ListSNOMEDCTInferenceJobsOutcomeCallable ListSNOMEDCTInferenceJobsCallable(
      const ListSNOMEDCTInferenceJobsRequestT& request = {}) const {
    return SubmitCallable(&ComprehendMedicalClient::ListSNOMEDCTInferenceJobs, request);
  }

  /**
   * An Async wrapper for ListSNOMEDCTInferenceJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSNOMEDCTInferenceJobsRequestT = Model::ListSNOMEDCTInferenceJobsRequest>
  void ListSNOMEDCTInferenceJobsAsync(const ListSNOMEDCTInferenceJobsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListSNOMEDCTInferenceJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartEntitiesDetectionV2JobOutcome StartEntitiesDetectionV2Job(
      const Model::StartEntitiesDetectionV2JobRequest& request) const;

  /**
   * A Callable wrapper for StartEntitiesDetectionV2Job that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartEntitiesDetectionV2JobRequestT = Model::StartEntitiesDetectionV2JobRequest>
  Model::StartEntitiesDetectionV2JobOutcomeCallable StartEntitiesDetectionV2JobCallable(
      const StartEntitiesDetectionV2JobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::StartEntitiesDetectionV2Job, request);
  }

  /**
   * An Async wrapper for StartEntitiesDetectionV2Job that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEntitiesDetectionV2JobRequestT = Model::StartEntitiesDetectionV2JobRequest>
  void StartEntitiesDetectionV2JobAsync(const StartEntitiesDetectionV2JobRequestT& request,
                                        const StartEntitiesDetectionV2JobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartICD10CMInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartICD10CMInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartICD10CMInferenceJobRequestT = Model::StartICD10CMInferenceJobRequest>
  void StartICD10CMInferenceJobAsync(const StartICD10CMInferenceJobRequestT& request,
                                     const StartICD10CMInferenceJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartPHIDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartPHIDetectionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartPHIDetectionJobRequestT = Model::StartPHIDetectionJobRequest>
  void StartPHIDetectionJobAsync(const StartPHIDetectionJobRequestT& request, const StartPHIDetectionJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartRxNormInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRxNormInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartRxNormInferenceJobRequestT = Model::StartRxNormInferenceJobRequest>
  void StartRxNormInferenceJobAsync(const StartRxNormInferenceJobRequestT& request,
                                    const StartRxNormInferenceJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartSNOMEDCTInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartSNOMEDCTInferenceJobRequestT = Model::StartSNOMEDCTInferenceJobRequest>
  Model::StartSNOMEDCTInferenceJobOutcomeCallable StartSNOMEDCTInferenceJobCallable(
      const StartSNOMEDCTInferenceJobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::StartSNOMEDCTInferenceJob, request);
  }

  /**
   * An Async wrapper for StartSNOMEDCTInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSNOMEDCTInferenceJobRequestT = Model::StartSNOMEDCTInferenceJobRequest>
  void StartSNOMEDCTInferenceJobAsync(const StartSNOMEDCTInferenceJobRequestT& request,
                                      const StartSNOMEDCTInferenceJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopEntitiesDetectionV2JobOutcome StopEntitiesDetectionV2Job(
      const Model::StopEntitiesDetectionV2JobRequest& request) const;

  /**
   * A Callable wrapper for StopEntitiesDetectionV2Job that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopEntitiesDetectionV2JobRequestT = Model::StopEntitiesDetectionV2JobRequest>
  Model::StopEntitiesDetectionV2JobOutcomeCallable StopEntitiesDetectionV2JobCallable(
      const StopEntitiesDetectionV2JobRequestT& request) const {
    return SubmitCallable(&ComprehendMedicalClient::StopEntitiesDetectionV2Job, request);
  }

  /**
   * An Async wrapper for StopEntitiesDetectionV2Job that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEntitiesDetectionV2JobRequestT = Model::StopEntitiesDetectionV2JobRequest>
  void StopEntitiesDetectionV2JobAsync(const StopEntitiesDetectionV2JobRequestT& request,
                                       const StopEntitiesDetectionV2JobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopICD10CMInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopICD10CMInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopICD10CMInferenceJobRequestT = Model::StopICD10CMInferenceJobRequest>
  void StopICD10CMInferenceJobAsync(const StopICD10CMInferenceJobRequestT& request,
                                    const StopICD10CMInferenceJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopPHIDetectionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopPHIDetectionJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopPHIDetectionJobRequestT = Model::StopPHIDetectionJobRequest>
  void StopPHIDetectionJobAsync(const StopPHIDetectionJobRequestT& request, const StopPHIDetectionJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopRxNormInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopRxNormInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopRxNormInferenceJobRequestT = Model::StopRxNormInferenceJobRequest>
  void StopRxNormInferenceJobAsync(const StopRxNormInferenceJobRequestT& request,
                                   const StopRxNormInferenceJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopSNOMEDCTInferenceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopSNOMEDCTInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopSNOMEDCTInferenceJobRequestT = Model::StopSNOMEDCTInferenceJobRequest>
  void StopSNOMEDCTInferenceJobAsync(const StopSNOMEDCTInferenceJobRequestT& request,
                                     const StopSNOMEDCTInferenceJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
