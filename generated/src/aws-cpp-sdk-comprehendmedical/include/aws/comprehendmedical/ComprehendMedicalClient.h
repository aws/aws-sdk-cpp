...
namespace ComprehendMedical
{
   ...
   */
  class AWS_COMPREHENDMEDICAL_API ComprehendMedicalClient : Aws::Client::ClientWithAsyncTemplateMethods<ComprehendMedicalClient>,
    smithy::client::AwsSmithyClientT<Aws::ComprehendMedical::SERVICE_NAME,
