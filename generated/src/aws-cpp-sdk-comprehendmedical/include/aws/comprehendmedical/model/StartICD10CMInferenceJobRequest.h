...
class StartICD10CMInferenceJobRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename InputDataConfigT = InputDataConfig>
  StartICD10CMInferenceJobRequest& WithInputDataConfig(InputDataConfigT&& value) {
  ...
  template <typename OutputDataConfigT = OutputDataConfig>
  StartICD10CMInferenceJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  StartICD10CMInferenceJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  StartICD10CMInferenceJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartICD10CMInferenceJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename KMSKeyT = Aws::String>
  StartICD10CMInferenceJobRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  inline StartICD10CMInferenceJobRequest& WithLanguageCode(LanguageCode value) {
