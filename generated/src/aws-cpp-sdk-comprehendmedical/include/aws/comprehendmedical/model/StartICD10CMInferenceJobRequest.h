...
namespace Model
{
  ...
  /**
   */
  class StartICD10CMInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API StartICD10CMInferenceJobRequest() = default;
    ...
    template<typename InputDataConfigT = InputDataConfig>
    StartICD10CMInferenceJobRequest& WithInputDataConfig(InputDataConfigT&& value) { SetInputDataConfig(std::forward<InputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputDataConfigT = OutputDataConfig>
    StartICD10CMInferenceJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) { SetOutputDataConfig(std::forward<OutputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DataAccessRoleArnT = Aws::String>
    StartICD10CMInferenceJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) { SetDataAccessRoleArn(std::forward<DataAccessRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename JobNameT = Aws::String>
    StartICD10CMInferenceJobRequest& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientRequestTokenT = Aws::String>
    StartICD10CMInferenceJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) { SetClientRequestToken(std::forward<ClientRequestTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyT = Aws::String>
    StartICD10CMInferenceJobRequest& WithKMSKey(KMSKeyT&& value) { SetKMSKey(std::forward<KMSKeyT>(value)); return *this;}
    ///@}
    ...
    inline StartICD10CMInferenceJobRequest& WithLanguageCode(LanguageCode value) { SetLanguageCode(value); return *this;}
    ///@}
  private:
