...
class ICD10CMEntity {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ICD10CMEntity(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API ICD10CMEntity& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline ICD10CMEntity& WithId(int64_t value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(ICD10CMEntityCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline ICD10CMEntity& WithCategory(ICD10CMEntityCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ICD10CMEntityType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ICD10CMEntity& WithType(ICD10CMEntityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMEntity& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMEntity& WithBeginOffset(int64_t value) {
  ...
  inline ICD10CMEntity& WithEndOffset(int64_t value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  void SetICD10CMConcepts(ICD10CMConceptsT&& value) {
    ...
    m_iCD10CMConcepts = std::forward<ICD10CMConceptsT>(value);
  }
  template <typename ICD10CMConceptsT = Aws::Vector<ICD10CMConcept>>
  ICD10CMEntity& WithICD10CMConcepts(ICD10CMConceptsT&& value) {
    SetICD10CMConcepts(std::forward<ICD10CMConceptsT>(value));
    return *this;
  }
  template <typename ICD10CMConceptsT = ICD10CMConcept>
  ICD10CMEntity& AddICD10CMConcepts(ICD10CMConceptsT&& value) {
    m_iCD10CMConceptsHasBeenSet = true;
    m_iCD10CMConcepts.emplace_back(std::forward<ICD10CMConceptsT>(value));
    return *this;
  }
  ///@}
 private:
