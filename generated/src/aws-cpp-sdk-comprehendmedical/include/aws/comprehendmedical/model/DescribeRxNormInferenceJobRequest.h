...
namespace Model
{
  ...
  /**
   */
  class DescribeRxNormInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API DescribeRxNormInferenceJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    DescribeRxNormInferenceJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
