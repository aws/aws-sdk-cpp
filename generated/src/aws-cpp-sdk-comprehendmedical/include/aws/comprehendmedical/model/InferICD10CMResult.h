...
class InferICD10CMResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API InferICD10CMResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API InferICD10CMResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename EntitiesT = Aws::Vector<ICD10CMEntity>>
  InferICD10CMResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = ICD10CMEntity>
  InferICD10CMResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename PaginationTokenT = Aws::String>
  InferICD10CMResult& WithPaginationToken(PaginationTokenT&& value) {
  ...
  template <typename ModelVersionT = Aws::String>
  InferICD10CMResult& WithModelVersion(ModelVersionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InferICD10CMResult& WithRequestId(RequestIdT&& value) {
