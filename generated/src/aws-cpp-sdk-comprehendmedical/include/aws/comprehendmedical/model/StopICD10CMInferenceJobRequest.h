...
namespace Model
{
  ...
  /**
   */
  class StopICD10CMInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API StopICD10CMInferenceJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    StopICD10CMInferenceJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
