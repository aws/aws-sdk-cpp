...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHENDMEDICAL_API StartRxNormInferenceJobRequest() = default;
    ...
    template<typename InputDataConfigT = InputDataConfig>
    StartRxNormInferenceJobRequest& WithInputDataConfig(InputDataConfigT&& value) { SetInputDataConfig(std::forward<InputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputDataConfigT = OutputDataConfig>
    StartRxNormInferenceJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) { SetOutputDataConfig(std::forward<OutputDataConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DataAccessRoleArnT = Aws::String>
    StartRxNormInferenceJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) { SetDataAccessRoleArn(std::forward<DataAccessRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename JobNameT = Aws::String>
    StartRxNormInferenceJobRequest& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientRequestTokenT = Aws::String>
    StartRxNormInferenceJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) { SetClientRequestToken(std::forward<ClientRequestTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename KMSKeyT = Aws::String>
    StartRxNormInferenceJobRequest& WithKMSKey(KMSKeyT&& value) { SetKMSKey(std::forward<KMSKeyT>(value)); return *this;}
    ///@}
    ...
    inline StartRxNormInferenceJobRequest& WithLanguageCode(LanguageCode value) { SetLanguageCode(value); return *this;}
    ///@}
  private:
