...
class StartRxNormInferenceJobRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename InputDataConfigT = InputDataConfig>
  StartRxNormInferenceJobRequest& WithInputDataConfig(InputDataConfigT&& value) {
  ...
  template <typename OutputDataConfigT = OutputDataConfig>
  StartRxNormInferenceJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  StartRxNormInferenceJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  StartRxNormInferenceJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartRxNormInferenceJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename KMSKeyT = Aws::String>
  StartRxNormInferenceJobRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  inline StartRxNormInferenceJobRequest& WithLanguageCode(LanguageCode value) {
