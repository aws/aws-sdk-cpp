...
class ListICD10CMInferenceJobsRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename FilterT = ComprehendMedicalAsyncJobFilter>
  ListICD10CMInferenceJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListICD10CMInferenceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListICD10CMInferenceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
