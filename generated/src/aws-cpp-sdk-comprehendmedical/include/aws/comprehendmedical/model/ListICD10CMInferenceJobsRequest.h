...
namespace Model
{
  ...
  /**
   */
  class ListICD10CMInferenceJobsRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API ListICD10CMInferenceJobsRequest() = default;
    ...
    template<typename FilterT = ComprehendMedicalAsyncJobFilter>
    ListICD10CMInferenceJobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListICD10CMInferenceJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
