...
class ICD10CMTrait {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ICD10CMTrait(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API ICD10CMTrait& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(ICD10CMTraitName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ICD10CMTrait& WithName(ICD10CMTraitName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMTrait& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
