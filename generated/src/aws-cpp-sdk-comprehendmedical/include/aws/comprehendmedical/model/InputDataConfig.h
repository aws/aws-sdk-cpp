...
class InputDataConfig {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API InputDataConfig(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API InputDataConfig& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
