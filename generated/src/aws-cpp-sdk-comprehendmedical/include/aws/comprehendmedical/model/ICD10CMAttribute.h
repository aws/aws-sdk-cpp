...
class ICD10CMAttribute {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ICD10CMAttribute(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API ICD10CMAttribute& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetType(ICD10CMAttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ICD10CMAttribute& WithType(ICD10CMAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMAttribute& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMAttribute& WithRelationshipScore(double value) {
  ...
  inline ICD10CMAttribute& WithId(int64_t value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline ICD10CMAttribute& WithBeginOffset(int64_t value) {
  ...
  inline ICD10CMAttribute& WithEndOffset(int64_t value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(ICD10CMEntityType value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline ICD10CMAttribute& WithCategory(ICD10CMEntityType value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRelationshipType(ICD10CMRelationshipType value) {
    m_relationshipTypeHasBeenSet = true;
    m_relationshipType = value;
  }
  inline ICD10CMAttribute& WithRelationshipType(ICD10CMRelationshipType value) {
