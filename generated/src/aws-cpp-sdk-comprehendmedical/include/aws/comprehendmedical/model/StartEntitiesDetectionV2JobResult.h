...
namespace Model
{
  ...
  public:
    ...
    template<typename JobIdT = Aws::String>
    StartEntitiesDetectionV2JobResult& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartEntitiesDetectionV2JobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
