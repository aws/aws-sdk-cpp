...
class ListSNOMEDCTInferenceJobsRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename FilterT = ComprehendMedicalAsyncJobFilter>
  ListSNOMEDCTInferenceJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSNOMEDCTInferenceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSNOMEDCTInferenceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
