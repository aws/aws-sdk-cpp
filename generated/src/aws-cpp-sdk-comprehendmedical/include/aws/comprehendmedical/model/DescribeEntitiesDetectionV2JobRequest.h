...
namespace Model
{
  ...
  {
  public:
    AWS_COMPREHENDMEDICAL_API DescribeEntitiesDetectionV2JobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    DescribeEntitiesDetectionV2JobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
