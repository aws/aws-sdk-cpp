...
class RxNormConcept {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API RxNormConcept(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API RxNormConcept& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline RxNormConcept& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
