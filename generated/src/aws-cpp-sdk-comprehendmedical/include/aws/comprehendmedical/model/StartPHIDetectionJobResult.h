...
namespace Model
{
  ...
  public:
    ...
    inline StartPHIDetectionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartPHIDetectionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartPHIDetectionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
