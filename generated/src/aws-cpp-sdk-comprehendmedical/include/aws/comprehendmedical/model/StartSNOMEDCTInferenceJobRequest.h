...
class StartSNOMEDCTInferenceJobRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename InputDataConfigT = InputDataConfig>
  StartSNOMEDCTInferenceJobRequest& WithInputDataConfig(InputDataConfigT&& value) {
  ...
  template <typename OutputDataConfigT = OutputDataConfig>
  StartSNOMEDCTInferenceJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  StartSNOMEDCTInferenceJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  StartSNOMEDCTInferenceJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartSNOMEDCTInferenceJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename KMSKeyT = Aws::String>
  StartSNOMEDCTInferenceJobRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  inline StartSNOMEDCTInferenceJobRequest& WithLanguageCode(LanguageCode value) {
