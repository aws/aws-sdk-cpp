...
namespace Model
{
  ...
  public:
    ...
    inline StopICD10CMInferenceJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StopICD10CMInferenceJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StopICD10CMInferenceJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
