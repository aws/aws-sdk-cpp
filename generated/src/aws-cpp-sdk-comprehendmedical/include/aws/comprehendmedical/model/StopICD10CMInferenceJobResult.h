...
class StopICD10CMInferenceJobResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API StopICD10CMInferenceJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API StopICD10CMInferenceJobResult& operator=(
  ...
  template <typename JobIdT = Aws::String>
  StopICD10CMInferenceJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopICD10CMInferenceJobResult& WithRequestId(RequestIdT&& value) {
