...
class ListPHIDetectionJobsRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename FilterT = ComprehendMedicalAsyncJobFilter>
  ListPHIDetectionJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPHIDetectionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPHIDetectionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
