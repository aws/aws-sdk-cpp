...
namespace Model
{
  ...
  /**
   */
  class ListPHIDetectionJobsRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API ListPHIDetectionJobsRequest() = default;
    ...
    template<typename FilterT = ComprehendMedicalAsyncJobFilter>
    ListPHIDetectionJobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListPHIDetectionJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
