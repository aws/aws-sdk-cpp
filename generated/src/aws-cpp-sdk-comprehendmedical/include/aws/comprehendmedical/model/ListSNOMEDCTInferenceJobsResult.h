...
class ListSNOMEDCTInferenceJobsResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ListSNOMEDCTInferenceJobsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API ListSNOMEDCTInferenceJobsResult& operator=(
  ...
  template <typename ComprehendMedicalAsyncJobPropertiesListT = Aws::Vector<ComprehendMedicalAsyncJobProperties>>
  ListSNOMEDCTInferenceJobsResult& WithComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
  ...
  ListSNOMEDCTInferenceJobsResult& AddComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
    m_comprehendMedicalAsyncJobPropertiesListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSNOMEDCTInferenceJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSNOMEDCTInferenceJobsResult& WithRequestId(RequestIdT&& value) {
