...
class ListRxNormInferenceJobsResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ListRxNormInferenceJobsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API ListRxNormInferenceJobsResult& operator=(
  ...
  template <typename ComprehendMedicalAsyncJobPropertiesListT = Aws::Vector<ComprehendMedicalAsyncJobProperties>>
  ListRxNormInferenceJobsResult& WithComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
  ...
  ListRxNormInferenceJobsResult& AddComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
    m_comprehendMedicalAsyncJobPropertiesListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRxNormInferenceJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRxNormInferenceJobsResult& WithRequestId(RequestIdT&& value) {
