...
class DescribePHIDetectionJobResult {
 public:
  AWS_COMPREHENDMEDICAL_API DescribePHIDetectionJobResult() = default;
  AWS_COMPREHENDMEDICAL_API DescribePHIDetectionJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API DescribePHIDetectionJobResult& operator=(
  ...
  template <typename ComprehendMedicalAsyncJobPropertiesT = ComprehendMedicalAsyncJobProperties>
  DescribePHIDetectionJobResult& WithComprehendMedicalAsyncJobProperties(ComprehendMedicalAsyncJobPropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribePHIDetectionJobResult& WithRequestId(RequestIdT&& value) {
