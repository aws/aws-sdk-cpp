...
namespace Model
{
  ...
  public:
    ...
    inline DescribePHIDetectionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribePHIDetectionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribePHIDetectionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
