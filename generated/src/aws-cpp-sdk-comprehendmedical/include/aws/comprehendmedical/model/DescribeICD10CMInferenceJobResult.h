...
class DescribeICD10CMInferenceJobResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API DescribeICD10CMInferenceJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API DescribeICD10CMInferenceJobResult& operator=(
  ...
  template <typename ComprehendMedicalAsyncJobPropertiesT = ComprehendMedicalAsyncJobProperties>
  DescribeICD10CMInferenceJobResult& WithComprehendMedicalAsyncJobProperties(ComprehendMedicalAsyncJobPropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeICD10CMInferenceJobResult& WithRequestId(RequestIdT&& value) {
