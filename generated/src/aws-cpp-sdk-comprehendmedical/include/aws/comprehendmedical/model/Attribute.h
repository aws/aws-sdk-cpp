...
class Attribute {
 public:
  ...
  inline Attribute& WithType(EntitySubType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Attribute& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline Attribute& WithRelationshipScore(double value) {
  ...
  inline void SetRelationshipType(RelationshipType value) {
    m_relationshipTypeHasBeenSet = true;
    m_relationshipType = value;
  }
  inline Attribute& WithRelationshipType(RelationshipType value) {
  ...
  inline Attribute& WithId(int64_t value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline Attribute& WithBeginOffset(int64_t value) {
  ...
  inline Attribute& WithEndOffset(int64_t value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
  ...
  inline Attribute& WithCategory(EntityType value) {
    SetCategory(value);
    return *this;
  }
  ///@}
