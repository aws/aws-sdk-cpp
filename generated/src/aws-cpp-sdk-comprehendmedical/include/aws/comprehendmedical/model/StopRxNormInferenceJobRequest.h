...
namespace Model
{
  ...
  /**
   */
  class StopRxNormInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API StopRxNormInferenceJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    StopRxNormInferenceJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
