...
class StartPHIDetectionJobRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename InputDataConfigT = InputDataConfig>
  StartPHIDetectionJobRequest& WithInputDataConfig(InputDataConfigT&& value) {
  ...
  template <typename OutputDataConfigT = OutputDataConfig>
  StartPHIDetectionJobRequest& WithOutputDataConfig(OutputDataConfigT&& value) {
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  StartPHIDetectionJobRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  StartPHIDetectionJobRequest& WithJobName(JobNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartPHIDetectionJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename KMSKeyT = Aws::String>
  StartPHIDetectionJobRequest& WithKMSKey(KMSKeyT&& value) {
  ...
  inline StartPHIDetectionJobRequest& WithLanguageCode(LanguageCode value) {
