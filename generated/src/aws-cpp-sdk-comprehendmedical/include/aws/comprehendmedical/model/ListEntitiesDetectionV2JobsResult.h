...
class ListEntitiesDetectionV2JobsResult {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API ListEntitiesDetectionV2JobsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_COMPREHENDMEDICAL_API ListEntitiesDetectionV2JobsResult& operator=(
  ...
  template <typename ComprehendMedicalAsyncJobPropertiesListT = Aws::Vector<ComprehendMedicalAsyncJobProperties>>
  ListEntitiesDetectionV2JobsResult& WithComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
  ...
  ListEntitiesDetectionV2JobsResult& AddComprehendMedicalAsyncJobPropertiesList(ComprehendMedicalAsyncJobPropertiesListT&& value) {
    m_comprehendMedicalAsyncJobPropertiesListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEntitiesDetectionV2JobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEntitiesDetectionV2JobsResult& WithRequestId(RequestIdT&& value) {
