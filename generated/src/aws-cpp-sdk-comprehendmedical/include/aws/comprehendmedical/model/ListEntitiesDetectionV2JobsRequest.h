...
class ListEntitiesDetectionV2JobsRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename FilterT = ComprehendMedicalAsyncJobFilter>
  ListEntitiesDetectionV2JobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEntitiesDetectionV2JobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEntitiesDetectionV2JobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
