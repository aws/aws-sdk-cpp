...
namespace Model
{
  ...
  /**
   */
  class ListEntitiesDetectionV2JobsRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API ListEntitiesDetectionV2JobsRequest() = default;
    ...
    template<typename FilterT = ComprehendMedicalAsyncJobFilter>
    ListEntitiesDetectionV2JobsRequest& WithFilter(FilterT&& value) { SetFilter(std::forward<FilterT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListEntitiesDetectionV2JobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
