...
namespace Model
{
  ...
  /**
   */
  class DescribeSNOMEDCTInferenceJobRequest : public ComprehendMedicalRequest
  {
  public:
    AWS_COMPREHENDMEDICAL_API DescribeSNOMEDCTInferenceJobRequest() = default;
    ...
    template<typename JobIdT = Aws::String>
    DescribeSNOMEDCTInferenceJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
