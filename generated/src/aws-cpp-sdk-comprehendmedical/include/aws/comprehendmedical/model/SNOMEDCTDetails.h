...
class SNOMEDCTDetails {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API SNOMEDCTDetails(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API SNOMEDCTDetails& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetEdition(EditionT&& value) {
    m_editionHasBeenSet = true;
    m_edition = std::forward<EditionT>(value);
  }
  template <typename EditionT = Aws::String>
  SNOMEDCTDetails& WithEdition(EditionT&& value) {
    SetEdition(std::forward<EditionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LanguageT = Aws::String>
  SNOMEDCTDetails& WithLanguage(LanguageT&& value) {
  ...
  void SetVersionDate(VersionDateT&& value) {
    m_versionDateHasBeenSet = true;
    m_versionDate = std::forward<VersionDateT>(value);
  }
  template <typename VersionDateT = Aws::String>
  SNOMEDCTDetails& WithVersionDate(VersionDateT&& value) {
    SetVersionDate(std::forward<VersionDateT>(value));
    return *this;
  }
  ///@}
 private:
