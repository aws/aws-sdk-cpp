...
class SNOMEDCTAttribute {
 public:
  ...
  inline SNOMEDCTAttribute& WithCategory(SNOMEDCTEntityCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(SNOMEDCTAttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SNOMEDCTAttribute& WithType(SNOMEDCTAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SNOMEDCTAttribute& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRelationshipScore(double value) {
    m_relationshipScoreHasBeenSet = true;
    m_relationshipScore = value;
  }
  inline SNOMEDCTAttribute& WithRelationshipScore(double value) {
  ...
  inline void SetRelationshipType(SNOMEDCTRelationshipType value) {
    m_relationshipTypeHasBeenSet = true;
    m_relationshipType = value;
  }
  inline SNOMEDCTAttribute& WithRelationshipType(SNOMEDCTRelationshipType value) {
  ...
  template <typename TextT = Aws::String>
  SNOMEDCTAttribute& WithText(TextT&& value) {
  ...
  template <typename TraitsT = Aws::Vector<SNOMEDCTTrait>>
  SNOMEDCTAttribute& WithTraits(TraitsT&& value) {
    SetTraits(std::forward<TraitsT>(value));
    return *this;
  }
  template <typename TraitsT = SNOMEDCTTrait>
  SNOMEDCTAttribute& AddTraits(TraitsT&& value) {
    m_traitsHasBeenSet = true;
  ...
  template <typename SNOMEDCTConceptsT = Aws::Vector<SNOMEDCTConcept>>
  SNOMEDCTAttribute& WithSNOMEDCTConcepts(SNOMEDCTConceptsT&& value) {
    SetSNOMEDCTConcepts(std::forward<SNOMEDCTConceptsT>(value));
    return *this;
  }
  template <typename SNOMEDCTConceptsT = SNOMEDCTConcept>
  SNOMEDCTAttribute& AddSNOMEDCTConcepts(SNOMEDCTConceptsT&& value) {
    m_sNOMEDCTConceptsHasBeenSet = true;
