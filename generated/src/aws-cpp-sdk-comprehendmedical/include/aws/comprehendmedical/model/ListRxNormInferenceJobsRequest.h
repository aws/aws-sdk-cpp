...
class ListRxNormInferenceJobsRequest : public ComprehendMedicalRequest {
 public:
  ...
  template <typename FilterT = ComprehendMedicalAsyncJobFilter>
  ListRxNormInferenceJobsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRxNormInferenceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRxNormInferenceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
