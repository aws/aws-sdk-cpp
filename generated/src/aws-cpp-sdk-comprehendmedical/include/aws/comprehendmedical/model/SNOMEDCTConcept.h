...
class SNOMEDCTConcept {
 public:
  AWS_COMPREHENDMEDICAL_API SNOMEDCTConcept() = default;
  AWS_COMPREHENDMEDICAL_API SNOMEDCTConcept(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API SNOMEDCTConcept& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DescriptionT = Aws::String>
  SNOMEDCTConcept& WithDescription(DescriptionT&& value) {
  ...
  template <typename CodeT = Aws::String>
  SNOMEDCTConcept& WithCode(CodeT&& value) {
  ...
  inline SNOMEDCTConcept& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
