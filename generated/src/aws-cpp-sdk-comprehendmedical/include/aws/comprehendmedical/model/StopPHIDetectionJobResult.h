...
namespace Model
{
  ...
  public:
    ...
    inline StopPHIDetectionJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StopPHIDetectionJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StopPHIDetectionJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
