...
class SNOMEDCTTrait {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API SNOMEDCTTrait(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API SNOMEDCTTrait& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetName(SNOMEDCTTraitName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SNOMEDCTTrait& WithName(SNOMEDCTTraitName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline SNOMEDCTTrait& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
