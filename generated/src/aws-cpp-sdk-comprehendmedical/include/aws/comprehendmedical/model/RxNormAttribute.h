...
class RxNormAttribute {
 public:
  ...
  AWS_COMPREHENDMEDICAL_API RxNormAttribute(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_COMPREHENDMEDICAL_API RxNormAttribute& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetType(RxNormAttributeType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RxNormAttribute& WithType(RxNormAttributeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RxNormAttribute& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  inline RxNormAttribute& WithRelationshipScore(double value) {
  ...
  inline RxNormAttribute& WithId(int64_t value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline RxNormAttribute& WithBeginOffset(int64_t value) {
  ...
  inline RxNormAttribute& WithEndOffset(int64_t value) {
    SetEndOffset(value);
    return *this;
  }
  ///@}
