...
DetectEntitiesV2Result::DetectEntitiesV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DetectEntitiesV2Result& DetectEntitiesV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("UnmappedAttributes")) {
    ...
    for (unsigned unmappedAttributesIndex = 0; unmappedAttributesIndex < unmappedAttributesJsonList.GetLength();
         ++unmappedAttributesIndex) {
