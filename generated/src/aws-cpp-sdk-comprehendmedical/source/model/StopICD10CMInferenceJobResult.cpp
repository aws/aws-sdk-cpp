...
StopICD10CMInferenceJobResult::StopICD10CMInferenceJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

StopICD10CMInferenceJobResult& StopICD10CMInferenceJobResult::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("StopICD10CMInferenceJobResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
