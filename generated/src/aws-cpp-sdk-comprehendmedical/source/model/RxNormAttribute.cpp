...
RxNormAttribute::RxNormAttribute(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) { *this = decoder; }

RxNormAttribute& RxNormAttribute::operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder) {
  if (decoder != nullptr) {
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "Type") {
                ...
                if (val.has_value()) {
                  m_type = RxNormAttributeTypeMapper::GetRxNormAttributeTypeForName(
                  ...
                  if (peekType_0.value() == CborType::ArrayStart) {
                    ...
                    if (listSize_0.has_value()) {
                      for (size_t j_0 = 0; j_0 < listSize_0.value(); j_0++) {
                        m_traits.push_back(RxNormTrait(decoder));
                      }
                    }
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("RxNormAttribute", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
...
void RxNormAttribute::CborEncode(Aws::Crt::Cbor::CborEncoder& encoder) const {
  // Calculate map size
  size_t mapSize = 0;
  if (m_typeHasBeenSet) {
    mapSize++;
  ...
  if (m_typeHasBeenSet) {
    ...
    encoder.WriteText(Aws::Crt::ByteCursorFromCString(RxNormAttributeTypeMapper::GetNameForRxNormAttributeType(m_type).c_str()));
  }
