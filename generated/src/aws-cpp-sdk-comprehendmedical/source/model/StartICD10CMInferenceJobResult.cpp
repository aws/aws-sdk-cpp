...
StartICD10CMInferenceJobResult::StartICD10CMInferenceJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
  *this = result;
}

StartICD10CMInferenceJobResult& StartICD10CMInferenceJobResult::operator=(
          ...
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("StartICD10CMInferenceJobResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
