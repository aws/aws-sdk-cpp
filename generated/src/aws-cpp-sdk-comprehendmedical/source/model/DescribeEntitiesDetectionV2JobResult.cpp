...
DescribeEntitiesDetectionV2JobResult& DescribeEntitiesDetectionV2JobResult::operator=(
    const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "ComprehendMedicalAsyncJobProperties") {
                m_comprehendMedicalAsyncJobProperties = ComprehendMedicalAsyncJobProperties(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeEntitiesDetectionV2JobResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
