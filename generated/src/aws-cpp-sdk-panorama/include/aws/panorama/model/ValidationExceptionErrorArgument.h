...
class ValidationExceptionErrorArgument {
 public:
  AWS_PANORAMA_API ValidationExceptionErrorArgument() = default;
  ...
  template <typename NameT = Aws::String>
  ValidationExceptionErrorArgument& WithName(NameT&& value) {
  ...
  template <typename ValueT = Aws::String>
  ValidationExceptionErrorArgument& WithValue(ValueT&& value) {
