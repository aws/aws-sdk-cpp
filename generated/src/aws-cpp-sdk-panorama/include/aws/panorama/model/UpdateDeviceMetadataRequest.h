...
class UpdateDeviceMetadataRequest : public PanoramaRequest {
 public:
  AWS_PANORAMA_API UpdateDeviceMetadataRequest() = default;
  ...
  template <typename DescriptionT = Aws::String>
  UpdateDeviceMetadataRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  UpdateDeviceMetadataRequest& WithDeviceId(DeviceIdT&& value) {
