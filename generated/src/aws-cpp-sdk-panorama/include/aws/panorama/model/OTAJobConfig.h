...
class OTAJobConfig {
 public:
  ...
  inline void SetAllowMajorVersionUpdate(bool value) {
    m_allowMajorVersionUpdateHasBeenSet = true;
    m_allowMajorVersionUpdate = value;
  }
  inline OTAJobConfig& WithAllowMajorVersionUpdate(bool value) {
    SetAllowMajorVersionUpdate(value);
    return *this;
  }
  ///@}
