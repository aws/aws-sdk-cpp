...
class EthernetPayload {
 public:
  ...
  inline EthernetPayload& WithConnectionType(ConnectionType value) {
  ...
  void SetStaticIpConnectionInfo(StaticIpConnectionInfoT&& value) {
    m_staticIpConnectionInfoHasBeenSet = true;
    m_staticIpConnectionInfo = std::forward<StaticIpConnectionInfoT>(value);
  }
  template <typename StaticIpConnectionInfoT = StaticIpConnectionInfo>
  EthernetPayload& WithStaticIpConnectionInfo(StaticIpConnectionInfoT&& value) {
    SetStaticIpConnectionInfo(std::forward<StaticIpConnectionInfoT>(value));
    return *this;
  }
  ///@}
 private:
