...
class DescribeApplicationInstanceResult {
 public:
  ...
  void SetApplicationInstanceIdToReplace(ApplicationInstanceIdToReplaceT&& value) {
    ...
    m_applicationInstanceIdToReplace = std::forward<ApplicationInstanceIdToReplaceT>(value);
  }
  template <typename ApplicationInstanceIdToReplaceT = Aws::String>
  DescribeApplicationInstanceResult& WithApplicationInstanceIdToReplace(ApplicationInstanceIdToReplaceT&& value) {
    SetApplicationInstanceIdToReplace(std::forward<ApplicationInstanceIdToReplaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultRuntimeContextDevice(DefaultRuntimeContextDeviceT&& value) {
    ...
    m_defaultRuntimeContextDevice = std::forward<DefaultRuntimeContextDeviceT>(value);
  }
  template <typename DefaultRuntimeContextDeviceT = Aws::String>
  DescribeApplicationInstanceResult& WithDefaultRuntimeContextDevice(DefaultRuntimeContextDeviceT&& value) {
    SetDefaultRuntimeContextDevice(std::forward<DefaultRuntimeContextDeviceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultRuntimeContextDeviceName(DefaultRuntimeContextDeviceNameT&& value) {
    ...
    m_defaultRuntimeContextDeviceName = std::forward<DefaultRuntimeContextDeviceNameT>(value);
  }
  template <typename DefaultRuntimeContextDeviceNameT = Aws::String>
  DescribeApplicationInstanceResult& WithDefaultRuntimeContextDeviceName(DefaultRuntimeContextDeviceNameT&& value) {
    SetDefaultRuntimeContextDeviceName(std::forward<DefaultRuntimeContextDeviceNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHealthStatus(ApplicationInstanceHealthStatus value) {
    m_healthStatusHasBeenSet = true;
    m_healthStatus = value;
  }
  inline DescribeApplicationInstanceResult& WithHealthStatus(ApplicationInstanceHealthStatus value) {
  ...
  void SetRuntimeContextStates(RuntimeContextStatesT&& value) {
    ...
    m_runtimeContextStates = std::forward<RuntimeContextStatesT>(value);
  }
  template <typename RuntimeContextStatesT = Aws::Vector<ReportedRuntimeContextState>>
  DescribeApplicationInstanceResult& WithRuntimeContextStates(RuntimeContextStatesT&& value) {
    SetRuntimeContextStates(std::forward<RuntimeContextStatesT>(value));
    return *this;
  }
  ...
  DescribeApplicationInstanceResult& AddRuntimeContextStates(RuntimeContextStatesT&& value) {
    m_runtimeContextStatesHasBeenSet = true;
    m_runtimeContextStates.emplace_back(std::forward<RuntimeContextStatesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ApplicationInstanceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeApplicationInstanceResult& WithStatus(ApplicationInstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
