...
class PackageImportJob {
 public:
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  PackageImportJob& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  PackageImportJob& WithJobId(JobIdT&& value) {
  ...
  inline PackageImportJob& WithJobType(PackageImportJobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  PackageImportJob& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  inline PackageImportJob& WithStatus(PackageImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  PackageImportJob& WithStatusMessage(StatusMessageT&& value) {
