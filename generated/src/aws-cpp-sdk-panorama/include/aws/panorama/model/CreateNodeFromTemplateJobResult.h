...
class CreateNodeFromTemplateJobResult {
 public:
  AWS_PANORAMA_API CreateNodeFromTemplateJobResult() = default;
  ...
  template <typename JobIdT = Aws::String>
  CreateNodeFromTemplateJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateNodeFromTemplateJobResult& WithRequestId(RequestIdT&& value) {
