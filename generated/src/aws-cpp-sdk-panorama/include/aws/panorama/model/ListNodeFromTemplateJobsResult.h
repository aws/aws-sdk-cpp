...
class ListNodeFromTemplateJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListNodeFromTemplateJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetNodeFromTemplateJobs(NodeFromTemplateJobsT&& value) {
    m_nodeFromTemplateJobsHasBeenSet = true;
    m_nodeFromTemplateJobs = std::forward<NodeFromTemplateJobsT>(value);
  }
  template <typename NodeFromTemplateJobsT = Aws::Vector<NodeFromTemplateJob>>
  ListNodeFromTemplateJobsResult& WithNodeFromTemplateJobs(NodeFromTemplateJobsT&& value) {
    SetNodeFromTemplateJobs(std::forward<NodeFromTemplateJobsT>(value));
    return *this;
  }
  template <typename NodeFromTemplateJobsT = NodeFromTemplateJob>
  ListNodeFromTemplateJobsResult& AddNodeFromTemplateJobs(NodeFromTemplateJobsT&& value) {
    m_nodeFromTemplateJobsHasBeenSet = true;
    m_nodeFromTemplateJobs.emplace_back(std::forward<NodeFromTemplateJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListNodeFromTemplateJobsResult& WithRequestId(RequestIdT&& value) {
