...
class CreatePackageImportJobRequest : public PanoramaRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreatePackageImportJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename InputConfigT = PackageImportJobInputConfig>
  CreatePackageImportJobRequest& WithInputConfig(InputConfigT&& value) {
  ...
  template <typename JobTagsT = Aws::Vector<JobResourceTags>>
  CreatePackageImportJobRequest& WithJobTags(JobTagsT&& value) {
    SetJobTags(std::forward<JobTagsT>(value));
    return *this;
  }
  template <typename JobTagsT = JobResourceTags>
  CreatePackageImportJobRequest& AddJobTags(JobTagsT&& value) {
    m_jobTagsHasBeenSet = true;
  ...
  inline CreatePackageImportJobRequest& WithJobType(PackageImportJobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutputConfigT = PackageImportJobOutputConfig>
  CreatePackageImportJobRequest& WithOutputConfig(OutputConfigT&& value) {
