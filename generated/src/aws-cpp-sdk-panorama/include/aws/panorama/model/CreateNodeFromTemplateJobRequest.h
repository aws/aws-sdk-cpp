...
class CreateNodeFromTemplateJobRequest : public PanoramaRequest {
 public:
  ...
  template <typename JobTagsT = Aws::Vector<JobResourceTags>>
  CreateNodeFromTemplateJobRequest& WithJobTags(JobTagsT&& value) {
    SetJobTags(std::forward<JobTagsT>(value));
    return *this;
  }
  template <typename JobTagsT = JobResourceTags>
  CreateNodeFromTemplateJobRequest& AddJobTags(JobTagsT&& value) {
    m_jobTagsHasBeenSet = true;
  ...
  void SetNodeDescription(NodeDescriptionT&& value) {
    m_nodeDescriptionHasBeenSet = true;
    m_nodeDescription = std::forward<NodeDescriptionT>(value);
  }
  template <typename NodeDescriptionT = Aws::String>
  CreateNodeFromTemplateJobRequest& WithNodeDescription(NodeDescriptionT&& value) {
    SetNodeDescription(std::forward<NodeDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NodeNameT = Aws::String>
  CreateNodeFromTemplateJobRequest& WithNodeName(NodeNameT&& value) {
  ...
  void SetOutputPackageName(OutputPackageNameT&& value) {
    m_outputPackageNameHasBeenSet = true;
    m_outputPackageName = std::forward<OutputPackageNameT>(value);
  }
  template <typename OutputPackageNameT = Aws::String>
  CreateNodeFromTemplateJobRequest& WithOutputPackageName(OutputPackageNameT&& value) {
    SetOutputPackageName(std::forward<OutputPackageNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputPackageVersion(OutputPackageVersionT&& value) {
    m_outputPackageVersionHasBeenSet = true;
    m_outputPackageVersion = std::forward<OutputPackageVersionT>(value);
  }
  template <typename OutputPackageVersionT = Aws::String>
  CreateNodeFromTemplateJobRequest& WithOutputPackageVersion(OutputPackageVersionT&& value) {
    SetOutputPackageVersion(std::forward<OutputPackageVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  CreateNodeFromTemplateJobRequest& WithTemplateParameters(TemplateParametersT&& value) {
  ...
  inline CreateNodeFromTemplateJobRequest& WithTemplateType(TemplateType value) {
