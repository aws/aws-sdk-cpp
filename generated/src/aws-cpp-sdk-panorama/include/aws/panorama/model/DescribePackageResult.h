...
class DescribePackageResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribePackageResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  DescribePackageResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename PackageIdT = Aws::String>
  DescribePackageResult& WithPackageId(PackageIdT&& value) {
  ...
  template <typename PackageNameT = Aws::String>
  DescribePackageResult& WithPackageName(PackageNameT&& value) {
  ...
  void SetReadAccessPrincipalArns(ReadAccessPrincipalArnsT&& value) {
    m_readAccessPrincipalArnsHasBeenSet = true;
    m_readAccessPrincipalArns = std::forward<ReadAccessPrincipalArnsT>(value);
  }
  template <typename ReadAccessPrincipalArnsT = Aws::Vector<Aws::String>>
  DescribePackageResult& WithReadAccessPrincipalArns(ReadAccessPrincipalArnsT&& value) {
    SetReadAccessPrincipalArns(std::forward<ReadAccessPrincipalArnsT>(value));
    return *this;
  }
  template <typename ReadAccessPrincipalArnsT = Aws::String>
  DescribePackageResult& AddReadAccessPrincipalArns(ReadAccessPrincipalArnsT&& value) {
    m_readAccessPrincipalArnsHasBeenSet = true;
    m_readAccessPrincipalArns.emplace_back(std::forward<ReadAccessPrincipalArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StorageLocationT = StorageLocation>
  DescribePackageResult& WithStorageLocation(StorageLocationT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribePackageResult& WithTags(TagsT&& value) {
  ...
  void SetWriteAccessPrincipalArns(WriteAccessPrincipalArnsT&& value) {
    m_writeAccessPrincipalArnsHasBeenSet = true;
    m_writeAccessPrincipalArns = std::forward<WriteAccessPrincipalArnsT>(value);
  }
  template <typename WriteAccessPrincipalArnsT = Aws::Vector<Aws::String>>
  DescribePackageResult& WithWriteAccessPrincipalArns(WriteAccessPrincipalArnsT&& value) {
    SetWriteAccessPrincipalArns(std::forward<WriteAccessPrincipalArnsT>(value));
    return *this;
  }
  template <typename WriteAccessPrincipalArnsT = Aws::String>
  DescribePackageResult& AddWriteAccessPrincipalArns(WriteAccessPrincipalArnsT&& value) {
    m_writeAccessPrincipalArnsHasBeenSet = true;
    m_writeAccessPrincipalArns.emplace_back(std::forward<WriteAccessPrincipalArnsT>(value));
    return *this;
  }
  ///@}
