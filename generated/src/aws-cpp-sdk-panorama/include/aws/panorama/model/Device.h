...
class Device {
 public:
  ...
  inline Device& WithBrand(DeviceBrand value) {
    SetBrand(value);
    return *this;
  }
  ///@}
  ...
  inline Device& WithDeviceAggregatedStatus(DeviceAggregatedStatus value) {
  ...
  inline Device& WithProvisioningStatus(DeviceStatus value) {
  ...
  inline Device& WithType(DeviceType value) {
    SetType(value);
    return *this;
  }
  ///@}
