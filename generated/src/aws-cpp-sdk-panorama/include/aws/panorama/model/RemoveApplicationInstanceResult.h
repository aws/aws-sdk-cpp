...
namespace Model
{
  ...
  {
  public:
    AWS_PANORAMA_API RemoveApplicationInstanceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveApplicationInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
