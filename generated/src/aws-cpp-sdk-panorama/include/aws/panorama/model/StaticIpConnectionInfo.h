...
class StaticIpConnectionInfo {
 public:
  ...
  void SetDefaultGateway(DefaultGatewayT&& value) {
    ...
    m_defaultGateway = std::forward<DefaultGatewayT>(value);
  }
  template <typename DefaultGatewayT = Aws::String>
  StaticIpConnectionInfo& WithDefaultGateway(DefaultGatewayT&& value) {
    SetDefaultGateway(std::forward<DefaultGatewayT>(value));
    return *this;
  }
  ///@}
  ...
  StaticIpConnectionInfo& AddDns(DnsT&& value) {
    m_dnsHasBeenSet = true;
    m_dns.emplace_back(std::forward<DnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMask(MaskT&& value) {
    ...
    m_mask = std::forward<MaskT>(value);
  }
  template <typename MaskT = Aws::String>
  StaticIpConnectionInfo& WithMask(MaskT&& value) {
    SetMask(std::forward<MaskT>(value));
    return *this;
  }
  ///@}
 private:
