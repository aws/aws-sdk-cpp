...
class DescribePackageVersionResult {
 public:
  ...
  inline void SetIsLatestPatch(bool value) {
    m_isLatestPatchHasBeenSet = true;
    m_isLatestPatch = value;
  }
  inline DescribePackageVersionResult& WithIsLatestPatch(bool value) {
    SetIsLatestPatch(value);
    return *this;
  }
  ///@}
  ...
  inline DescribePackageVersionResult& WithStatus(PackageVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
