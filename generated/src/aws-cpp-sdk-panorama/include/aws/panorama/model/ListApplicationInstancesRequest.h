...
class ListApplicationInstancesRequest : public PanoramaRequest {
 public:
  ...
  template <typename DeviceIdT = Aws::String>
  ListApplicationInstancesRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  inline ListApplicationInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationInstancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetStatusFilter(StatusFilter value) {
    m_statusFilterHasBeenSet = true;
    m_statusFilter = value;
  }
  inline ListApplicationInstancesRequest& WithStatusFilter(StatusFilter value) {
