...
class PackageImportJobInputConfig {
 public:
  ...
  void SetPackageVersionInputConfig(PackageVersionInputConfigT&& value) {
    m_packageVersionInputConfigHasBeenSet = true;
    m_packageVersionInputConfig = std::forward<PackageVersionInputConfigT>(value);
  }
  template <typename PackageVersionInputConfigT = PackageVersionInputConfig>
  PackageImportJobInputConfig& WithPackageVersionInputConfig(PackageVersionInputConfigT&& value) {
    SetPackageVersionInputConfig(std::forward<PackageVersionInputConfigT>(value));
    return *this;
  }
  ///@}
 private:
