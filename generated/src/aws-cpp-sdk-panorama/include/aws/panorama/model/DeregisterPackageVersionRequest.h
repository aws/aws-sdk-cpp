...
class DeregisterPackageVersionRequest : public PanoramaRequest {
 public:
  ...
  void SetUpdatedLatestPatchVersion(UpdatedLatestPatchVersionT&& value) {
    m_updatedLatestPatchVersionHasBeenSet = true;
    m_updatedLatestPatchVersion = std::forward<UpdatedLatestPatchVersionT>(value);
  }
  template <typename UpdatedLatestPatchVersionT = Aws::String>
  DeregisterPackageVersionRequest& WithUpdatedLatestPatchVersion(UpdatedLatestPatchVersionT&& value) {
    SetUpdatedLatestPatchVersion(std::forward<UpdatedLatestPatchVersionT>(value));
    return *this;
  }
  ///@}
 private:
