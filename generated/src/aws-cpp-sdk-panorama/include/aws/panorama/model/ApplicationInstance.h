...
class ApplicationInstance {
 public:
  ...
  inline ApplicationInstance& WithHealthStatus(ApplicationInstanceHealthStatus value) {
  ...
  inline ApplicationInstance& WithStatus(ApplicationInstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
