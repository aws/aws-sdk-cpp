...
class NetworkStatus {
 public:
  ...
  void SetEthernet0Status(Ethernet0StatusT&& value) {
    ...
    m_ethernet0Status = std::forward<Ethernet0StatusT>(value);
  }
  template <typename Ethernet0StatusT = EthernetStatus>
  NetworkStatus& WithEthernet0Status(Ethernet0StatusT&& value) {
    SetEthernet0Status(std::forward<Ethernet0StatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEthernet1Status(Ethernet1StatusT&& value) {
    ...
    m_ethernet1Status = std::forward<Ethernet1StatusT>(value);
  }
  template <typename Ethernet1StatusT = EthernetStatus>
  NetworkStatus& WithEthernet1Status(Ethernet1StatusT&& value) {
    SetEthernet1Status(std::forward<Ethernet1StatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNtpStatus(NtpStatusT&& value) {
    ...
    m_ntpStatus = std::forward<NtpStatusT>(value);
  }
  template <typename NtpStatusT = NtpStatus>
  NetworkStatus& WithNtpStatus(NtpStatusT&& value) {
    SetNtpStatus(std::forward<NtpStatusT>(value));
    return *this;
  }
  ///@}
 private:
