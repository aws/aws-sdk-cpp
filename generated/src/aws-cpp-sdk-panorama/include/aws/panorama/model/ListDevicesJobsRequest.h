...
class ListDevicesJobsRequest : public PanoramaRequest {
 public:
  ...
  template <typename DeviceIdT = Aws::String>
  ListDevicesJobsRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  inline ListDevicesJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDevicesJobsRequest& WithNextToken(NextTokenT&& value) {
