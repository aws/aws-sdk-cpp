...
class SignalApplicationInstanceNodeInstancesRequest : public PanoramaRequest {
 public:
  ...
  void SetApplicationInstanceId(ApplicationInstanceIdT&& value) {
    ...
    m_applicationInstanceId = std::forward<ApplicationInstanceIdT>(value);
  }
  template <typename ApplicationInstanceIdT = Aws::String>
  SignalApplicationInstanceNodeInstancesRequest& WithApplicationInstanceId(ApplicationInstanceIdT&& value) {
    SetApplicationInstanceId(std::forward<ApplicationInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNodeSignals(NodeSignalsT&& value) {
    m_nodeSignalsHasBeenSet = true;
    m_nodeSignals = std::forward<NodeSignalsT>(value);
  }
  template <typename NodeSignalsT = Aws::Vector<NodeSignal>>
  SignalApplicationInstanceNodeInstancesRequest& WithNodeSignals(NodeSignalsT&& value) {
    SetNodeSignals(std::forward<NodeSignalsT>(value));
    return *this;
  }
  template <typename NodeSignalsT = NodeSignal>
  SignalApplicationInstanceNodeInstancesRequest& AddNodeSignals(NodeSignalsT&& value) {
    m_nodeSignalsHasBeenSet = true;
    m_nodeSignals.emplace_back(std::forward<NodeSignalsT>(value));
    return *this;
  }
  ///@}
 private:
