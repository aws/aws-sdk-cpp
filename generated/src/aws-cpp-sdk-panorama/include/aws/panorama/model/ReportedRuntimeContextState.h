...
class ReportedRuntimeContextState {
 public:
  ...
  inline ReportedRuntimeContextState& WithDesiredState(DesiredState value) {
  ...
  inline void SetDeviceReportedStatus(DeviceReportedStatus value) {
    m_deviceReportedStatusHasBeenSet = true;
    m_deviceReportedStatus = value;
  }
  inline ReportedRuntimeContextState& WithDeviceReportedStatus(DeviceReportedStatus value) {
    SetDeviceReportedStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDeviceReportedTime(DeviceReportedTimeT&& value) {
    ...
    m_deviceReportedTime = std::forward<DeviceReportedTimeT>(value);
  }
  template <typename DeviceReportedTimeT = Aws::Utils::DateTime>
  ReportedRuntimeContextState& WithDeviceReportedTime(DeviceReportedTimeT&& value) {
    SetDeviceReportedTime(std::forward<DeviceReportedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeContextName(RuntimeContextNameT&& value) {
    ...
    m_runtimeContextName = std::forward<RuntimeContextNameT>(value);
  }
  template <typename RuntimeContextNameT = Aws::String>
  ReportedRuntimeContextState& WithRuntimeContextName(RuntimeContextNameT&& value) {
    SetRuntimeContextName(std::forward<RuntimeContextNameT>(value));
    return *this;
  }
  ///@}
 private:
