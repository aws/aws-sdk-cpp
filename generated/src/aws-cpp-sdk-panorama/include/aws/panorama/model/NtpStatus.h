...
class NtpStatus {
 public:
  ...
  inline void SetConnectionStatus(NetworkConnectionStatus value) {
    m_connectionStatusHasBeenSet = true;
    m_connectionStatus = value;
  }
  inline NtpStatus& WithConnectionStatus(NetworkConnectionStatus value) {
  ...
  void SetNtpServerName(NtpServerNameT&& value) {
    ...
    m_ntpServerName = std::forward<NtpServerNameT>(value);
  }
  template <typename NtpServerNameT = Aws::String>
  NtpStatus& WithNtpServerName(NtpServerNameT&& value) {
    SetNtpServerName(std::forward<NtpServerNameT>(value));
    return *this;
  }
  ///@}
 private:
