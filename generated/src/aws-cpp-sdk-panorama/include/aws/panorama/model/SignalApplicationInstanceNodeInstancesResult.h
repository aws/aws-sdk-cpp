...
class SignalApplicationInstanceNodeInstancesResult {
 public:
  ...
  AWS_PANORAMA_API SignalApplicationInstanceNodeInstancesResult& operator=(
  ...
  template <typename ApplicationInstanceIdT = Aws::String>
  SignalApplicationInstanceNodeInstancesResult& WithApplicationInstanceId(ApplicationInstanceIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SignalApplicationInstanceNodeInstancesResult& WithRequestId(RequestIdT&& value) {
