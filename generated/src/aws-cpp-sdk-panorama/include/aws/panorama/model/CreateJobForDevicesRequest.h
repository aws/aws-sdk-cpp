...
class CreateJobForDevicesRequest : public PanoramaRequest {
 public:
  ...
  void SetDeviceJobConfig(DeviceJobConfigT&& value) {
    m_deviceJobConfigHasBeenSet = true;
    m_deviceJobConfig = std::forward<DeviceJobConfigT>(value);
  }
  template <typename DeviceJobConfigT = DeviceJobConfig>
  CreateJobForDevicesRequest& WithDeviceJobConfig(DeviceJobConfigT&& value) {
    SetDeviceJobConfig(std::forward<DeviceJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateJobForDevicesRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
