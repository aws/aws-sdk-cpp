...
class ListPackageImportJobsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPackageImportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPackageImportJobs(PackageImportJobsT&& value) {
    m_packageImportJobsHasBeenSet = true;
    m_packageImportJobs = std::forward<PackageImportJobsT>(value);
  }
  template <typename PackageImportJobsT = Aws::Vector<PackageImportJob>>
  ListPackageImportJobsResult& WithPackageImportJobs(PackageImportJobsT&& value) {
    SetPackageImportJobs(std::forward<PackageImportJobsT>(value));
    return *this;
  }
  template <typename PackageImportJobsT = PackageImportJob>
  ListPackageImportJobsResult& AddPackageImportJobs(PackageImportJobsT&& value) {
    m_packageImportJobsHasBeenSet = true;
    m_packageImportJobs.emplace_back(std::forward<PackageImportJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPackageImportJobsResult& WithRequestId(RequestIdT&& value) {
