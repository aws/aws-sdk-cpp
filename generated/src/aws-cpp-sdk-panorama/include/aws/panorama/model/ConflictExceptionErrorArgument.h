...
namespace Model
{
  ...
  {
  public:
    AWS_PANORAMA_API ConflictExceptionErrorArgument() = default;
    ...
    template<typename NameT = Aws::String>
    ConflictExceptionErrorArgument& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    ConflictExceptionErrorArgument& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
