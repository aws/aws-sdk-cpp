...
class DescribeNodeFromTemplateJobResult {
 public:
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  DescribeNodeFromTemplateJobResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename JobTagsT = Aws::Vector<JobResourceTags>>
  DescribeNodeFromTemplateJobResult& WithJobTags(JobTagsT&& value) {
    SetJobTags(std::forward<JobTagsT>(value));
    return *this;
  }
  template <typename JobTagsT = JobResourceTags>
  DescribeNodeFromTemplateJobResult& AddJobTags(JobTagsT&& value) {
    m_jobTagsHasBeenSet = true;
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  DescribeNodeFromTemplateJobResult& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename NodeDescriptionT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithNodeDescription(NodeDescriptionT&& value) {
  ...
  template <typename NodeNameT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithNodeName(NodeNameT&& value) {
  ...
  template <typename OutputPackageNameT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithOutputPackageName(OutputPackageNameT&& value) {
  ...
  template <typename OutputPackageVersionT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithOutputPackageVersion(OutputPackageVersionT&& value) {
  ...
  inline DescribeNodeFromTemplateJobResult& WithStatus(NodeFromTemplateJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename TemplateParametersT = Aws::Map<Aws::String, Aws::String>>
  DescribeNodeFromTemplateJobResult& WithTemplateParameters(TemplateParametersT&& value) {
  ...
  inline DescribeNodeFromTemplateJobResult& WithTemplateType(TemplateType value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeNodeFromTemplateJobResult& WithRequestId(RequestIdT&& value) {
