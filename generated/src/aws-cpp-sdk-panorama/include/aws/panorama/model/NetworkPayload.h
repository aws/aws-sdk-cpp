...
class NetworkPayload {
 public:
  ...
  void SetEthernet0(Ethernet0T&& value) {
    ...
    m_ethernet0 = std::forward<Ethernet0T>(value);
  }
  template <typename Ethernet0T = EthernetPayload>
  NetworkPayload& WithEthernet0(Ethernet0T&& value) {
    SetEthernet0(std::forward<Ethernet0T>(value));
    return *this;
  }
  ///@}
  ...
  void SetEthernet1(Ethernet1T&& value) {
    ...
    m_ethernet1 = std::forward<Ethernet1T>(value);
  }
  template <typename Ethernet1T = EthernetPayload>
  NetworkPayload& WithEthernet1(Ethernet1T&& value) {
    SetEthernet1(std::forward<Ethernet1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetNtp(NtpT&& value) {
    ...
    m_ntp = std::forward<NtpT>(value);
  }
  template <typename NtpT = NtpPayload>
  NetworkPayload& WithNtp(NtpT&& value) {
    SetNtp(std::forward<NtpT>(value));
    return *this;
  }
  ///@}
 private:
