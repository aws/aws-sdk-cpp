...
class ListApplicationInstanceDependenciesRequest : public PanoramaRequest {
 public:
  ...
  template <typename ApplicationInstanceIdT = Aws::String>
  ListApplicationInstanceDependenciesRequest& WithApplicationInstanceId(ApplicationInstanceIdT&& value) {
  ...
  inline ListApplicationInstanceDependenciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationInstanceDependenciesRequest& WithNextToken(NextTokenT&& value) {
