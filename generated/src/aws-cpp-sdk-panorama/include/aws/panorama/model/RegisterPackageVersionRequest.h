...
class RegisterPackageVersionRequest : public PanoramaRequest {
 public:
  ...
  inline void SetMarkLatest(bool value) {
    m_markLatestHasBeenSet = true;
    m_markLatest = value;
  }
  inline RegisterPackageVersionRequest& WithMarkLatest(bool value) {
    SetMarkLatest(value);
    return *this;
  }
  ///@}
  ...
  template <typename OwnerAccountT = Aws::String>
  RegisterPackageVersionRequest& WithOwnerAccount(OwnerAccountT&& value) {
  ...
  template <typename PackageIdT = Aws::String>
  RegisterPackageVersionRequest& WithPackageId(PackageIdT&& value) {
  ...
  template <typename PackageVersionT = Aws::String>
  RegisterPackageVersionRequest& WithPackageVersion(PackageVersionT&& value) {
  ...
  template <typename PatchVersionT = Aws::String>
  RegisterPackageVersionRequest& WithPatchVersion(PatchVersionT&& value) {
