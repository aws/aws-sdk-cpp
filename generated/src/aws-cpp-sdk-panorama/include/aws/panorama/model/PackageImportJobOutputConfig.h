...
class PackageImportJobOutputConfig {
 public:
  ...
  void SetPackageVersionOutputConfig(PackageVersionOutputConfigT&& value) {
    m_packageVersionOutputConfigHasBeenSet = true;
    m_packageVersionOutputConfig = std::forward<PackageVersionOutputConfigT>(value);
  }
  template <typename PackageVersionOutputConfigT = PackageVersionOutputConfig>
  PackageImportJobOutputConfig& WithPackageVersionOutputConfig(PackageVersionOutputConfigT&& value) {
    SetPackageVersionOutputConfig(std::forward<PackageVersionOutputConfigT>(value));
    return *this;
  }
  ///@}
 private:
