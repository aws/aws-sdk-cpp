...
class DescribeNodeResult {
 public:
  ...
  inline DescribeNodeResult& WithCategory(NodeCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeInterface(NodeInterfaceT&& value) {
    ...
    m_nodeInterface = std::forward<NodeInterfaceT>(value);
  }
  template <typename NodeInterfaceT = NodeInterface>
  DescribeNodeResult& WithNodeInterface(NodeInterfaceT&& value) {
    SetNodeInterface(std::forward<NodeInterfaceT>(value));
    return *this;
  }
  ///@}
