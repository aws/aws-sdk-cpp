...
namespace Panorama
{
   ...
   */
  class AWS_PANORAMA_API PanoramaClient : Aws::Client::ClientWithAsyncTemplateMethods<PanoramaClient>,
    smithy::client::AwsSmithyClientT<Aws::Panorama::SERVICE_NAME,
