...
class AWS_PANORAMA_API PanoramaClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PanoramaClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<PanoramaEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateApplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateApplicationInstanceRequestT = Model::CreateApplicationInstanceRequest>
  Model::CreateApplicationInstanceOutcomeCallable CreateApplicationInstanceCallable(
      const CreateApplicationInstanceRequestT& request) const {
    return SubmitCallable(&PanoramaClient::CreateApplicationInstance, request);
  }

  /**
   * An Async wrapper for CreateApplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateApplicationInstanceRequestT = Model::CreateApplicationInstanceRequest>
  void CreateApplicationInstanceAsync(const CreateApplicationInstanceRequestT& request,
                                      const CreateApplicationInstanceResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateJobForDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateJobForDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateJobForDevicesRequestT = Model::CreateJobForDevicesRequest>
  void CreateJobForDevicesAsync(const CreateJobForDevicesRequestT& request, const CreateJobForDevicesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateNodeFromTemplateJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateNodeFromTemplateJobRequestT = Model::CreateNodeFromTemplateJobRequest>
  Model::CreateNodeFromTemplateJobOutcomeCallable CreateNodeFromTemplateJobCallable(
      const CreateNodeFromTemplateJobRequestT& request) const {
    return SubmitCallable(&PanoramaClient::CreateNodeFromTemplateJob, request);
  }

  /**
   * An Async wrapper for CreateNodeFromTemplateJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNodeFromTemplateJobRequestT = Model::CreateNodeFromTemplateJobRequest>
  void CreateNodeFromTemplateJobAsync(const CreateNodeFromTemplateJobRequestT& request,
                                      const CreateNodeFromTemplateJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePackageImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePackageImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePackageImportJobRequestT = Model::CreatePackageImportJobRequest>
  void CreatePackageImportJobAsync(const CreatePackageImportJobRequestT& request,
                                   const CreatePackageImportJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDeviceRequestT = Model::DeleteDeviceRequest>
  void DeleteDeviceAsync(const DeleteDeviceRequestT& request, const DeleteDeviceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterPackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterPackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterPackageVersionRequestT = Model::DeregisterPackageVersionRequest>
  void DeregisterPackageVersionAsync(const DeregisterPackageVersionRequestT& request,
                                     const DeregisterPackageVersionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicationInstanceOutcome DescribeApplicationInstance(
      const Model::DescribeApplicationInstanceRequest& request) const;

  /**
   * A Callable wrapper for DescribeApplicationInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeApplicationInstanceRequestT = Model::DescribeApplicationInstanceRequest>
  Model::DescribeApplicationInstanceOutcomeCallable DescribeApplicationInstanceCallable(
      const DescribeApplicationInstanceRequestT& request) const {
    return SubmitCallable(&PanoramaClient::DescribeApplicationInstance, request);
  }

  /**
   * An Async wrapper for DescribeApplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeApplicationInstanceRequestT = Model::DescribeApplicationInstanceRequest>
  void DescribeApplicationInstanceAsync(const DescribeApplicationInstanceRequestT& request,
                                        const DescribeApplicationInstanceResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeApplicationInstanceDetailsOutcome DescribeApplicationInstanceDetails(
      const Model::DescribeApplicationInstanceDetailsRequest& request) const;

  /**
   * A Callable wrapper for DescribeApplicationInstanceDetails that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeApplicationInstanceDetailsRequestT = Model::DescribeApplicationInstanceDetailsRequest>
  Model::DescribeApplicationInstanceDetailsOutcomeCallable DescribeApplicationInstanceDetailsCallable(
      const DescribeApplicationInstanceDetailsRequestT& request) const {
    return SubmitCallable(&PanoramaClient::DescribeApplicationInstanceDetails, request);
  }

  /**
   * An Async wrapper for DescribeApplicationInstanceDetails that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeApplicationInstanceDetailsRequestT = Model::DescribeApplicationInstanceDetailsRequest>
  void DescribeApplicationInstanceDetailsAsync(const DescribeApplicationInstanceDetailsRequestT& request,
                                               const DescribeApplicationInstanceDetailsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDeviceJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDeviceJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDeviceJobRequestT = Model::DescribeDeviceJobRequest>
  void DescribeDeviceJobAsync(const DescribeDeviceJobRequestT& request, const DescribeDeviceJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNodeFromTemplateJobOutcome DescribeNodeFromTemplateJob(
      const Model::DescribeNodeFromTemplateJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeNodeFromTemplateJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeNodeFromTemplateJobRequestT = Model::DescribeNodeFromTemplateJobRequest>
  Model::DescribeNodeFromTemplateJobOutcomeCallable DescribeNodeFromTemplateJobCallable(
      const DescribeNodeFromTemplateJobRequestT& request) const {
    return SubmitCallable(&PanoramaClient::DescribeNodeFromTemplateJob, request);
  }

  /**
   * An Async wrapper for DescribeNodeFromTemplateJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNodeFromTemplateJobRequestT = Model::DescribeNodeFromTemplateJobRequest>
  void DescribeNodeFromTemplateJobAsync(const DescribeNodeFromTemplateJobRequestT& request,
                                        const DescribeNodeFromTemplateJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePackageImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePackageImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePackageImportJobRequestT = Model::DescribePackageImportJobRequest>
  void DescribePackageImportJobAsync(const DescribePackageImportJobRequestT& request,
                                     const DescribePackageImportJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListApplicationInstanceDependenciesOutcome ListApplicationInstanceDependencies(
      const Model::ListApplicationInstanceDependenciesRequest& request) const;

  /**
   * A Callable wrapper for ListApplicationInstanceDependencies that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListApplicationInstanceDependenciesRequestT = Model::ListApplicationInstanceDependenciesRequest>
  Model::ListApplicationInstanceDependenciesOutcomeCallable ListApplicationInstanceDependenciesCallable(
      const ListApplicationInstanceDependenciesRequestT& request) const {
    return SubmitCallable(&PanoramaClient::ListApplicationInstanceDependencies, request);
  }

  /**
   * An Async wrapper for ListApplicationInstanceDependencies that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListApplicationInstanceDependenciesRequestT = Model::ListApplicationInstanceDependenciesRequest>
  void ListApplicationInstanceDependenciesAsync(const ListApplicationInstanceDependenciesRequestT& request,
                                                const ListApplicationInstanceDependenciesResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListApplicationInstanceNodeInstancesOutcome ListApplicationInstanceNodeInstances(
      const Model::ListApplicationInstanceNodeInstancesRequest& request) const;

  /**
   * A Callable wrapper for ListApplicationInstanceNodeInstances that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListApplicationInstanceNodeInstancesRequestT = Model::ListApplicationInstanceNodeInstancesRequest>
  Model::ListApplicationInstanceNodeInstancesOutcomeCallable ListApplicationInstanceNodeInstancesCallable(
      const ListApplicationInstanceNodeInstancesRequestT& request) const {
    return SubmitCallable(&PanoramaClient::ListApplicationInstanceNodeInstances, request);
  }

  /**
   * An Async wrapper for ListApplicationInstanceNodeInstances that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListApplicationInstanceNodeInstancesRequestT = Model::ListApplicationInstanceNodeInstancesRequest>
  void ListApplicationInstanceNodeInstancesAsync(const ListApplicationInstanceNodeInstancesRequestT& request,
                                                 const ListApplicationInstanceNodeInstancesResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApplicationInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListApplicationInstancesRequestT = Model::ListApplicationInstancesRequest>
  Model::ListApplicationInstancesOutcomeCallable ListApplicationInstancesCallable(
      const ListApplicationInstancesRequestT& request = {}) const {
    return SubmitCallable(&PanoramaClient::ListApplicationInstances, request);
  }

  /**
   * An Async wrapper for ListApplicationInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApplicationInstancesRequestT = Model::ListApplicationInstancesRequest>
  void ListApplicationInstancesAsync(const ListApplicationInstancesResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for ListDevicesJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDevicesJobsRequestT = Model::ListDevicesJobsRequest>
  void ListDevicesJobsAsync(const ListDevicesJobsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListDevicesJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNodeFromTemplateJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListNodeFromTemplateJobsRequestT = Model::ListNodeFromTemplateJobsRequest>
  Model::ListNodeFromTemplateJobsOutcomeCallable ListNodeFromTemplateJobsCallable(
      const ListNodeFromTemplateJobsRequestT& request = {}) const {
    return SubmitCallable(&PanoramaClient::ListNodeFromTemplateJobs, request);
  }

  /**
   * An Async wrapper for ListNodeFromTemplateJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNodeFromTemplateJobsRequestT = Model::ListNodeFromTemplateJobsRequest>
  void ListNodeFromTemplateJobsAsync(const ListNodeFromTemplateJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListNodeFromTemplateJobsRequestT& request = {}) const {
   ...
   */
  template <typename ListNodesRequestT = Model::ListNodesRequest>
  void ListNodesAsync(const ListNodesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListNodesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPackageImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackageImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPackageImportJobsRequestT = Model::ListPackageImportJobsRequest>
  void ListPackageImportJobsAsync(const ListPackageImportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListPackageImportJobsRequestT& request = {}) const {
   ...
   */
  template <typename ListPackagesRequestT = Model::ListPackagesRequest>
  void ListPackagesAsync(const ListPackagesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListPackagesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ProvisionDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ProvisionDeviceRequestT = Model::ProvisionDeviceRequest>
  void ProvisionDeviceAsync(const ProvisionDeviceRequestT& request, const ProvisionDeviceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterPackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterPackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterPackageVersionRequestT = Model::RegisterPackageVersionRequest>
  void RegisterPackageVersionAsync(const RegisterPackageVersionRequestT& request,
                                   const RegisterPackageVersionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveApplicationInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RemoveApplicationInstanceRequestT = Model::RemoveApplicationInstanceRequest>
  Model::RemoveApplicationInstanceOutcomeCallable RemoveApplicationInstanceCallable(
      const RemoveApplicationInstanceRequestT& request) const {
    return SubmitCallable(&PanoramaClient::RemoveApplicationInstance, request);
  }

  /**
   * An Async wrapper for RemoveApplicationInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveApplicationInstanceRequestT = Model::RemoveApplicationInstanceRequest>
  void RemoveApplicationInstanceAsync(const RemoveApplicationInstanceRequestT& request,
                                      const RemoveApplicationInstanceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SignalApplicationInstanceNodeInstancesOutcome SignalApplicationInstanceNodeInstances(
      const Model::SignalApplicationInstanceNodeInstancesRequest& request) const;

  /**
   * A Callable wrapper for SignalApplicationInstanceNodeInstances that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename SignalApplicationInstanceNodeInstancesRequestT = Model::SignalApplicationInstanceNodeInstancesRequest>
  Model::SignalApplicationInstanceNodeInstancesOutcomeCallable SignalApplicationInstanceNodeInstancesCallable(
      const SignalApplicationInstanceNodeInstancesRequestT& request) const {
    return SubmitCallable(&PanoramaClient::SignalApplicationInstanceNodeInstances, request);
  }

  /**
   * An Async wrapper for SignalApplicationInstanceNodeInstances that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename SignalApplicationInstanceNodeInstancesRequestT = Model::SignalApplicationInstanceNodeInstancesRequest>
  void SignalApplicationInstanceNodeInstancesAsync(const SignalApplicationInstanceNodeInstancesRequestT& request,
                                                   const SignalApplicationInstanceNodeInstancesResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDeviceMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDeviceMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDeviceMetadataRequestT = Model::UpdateDeviceMetadataRequest>
  void UpdateDeviceMetadataAsync(const UpdateDeviceMetadataRequestT& request, const UpdateDeviceMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
