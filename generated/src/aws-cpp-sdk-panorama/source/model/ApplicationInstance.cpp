...
ApplicationInstance::ApplicationInstance(JsonView jsonValue) { *this = jsonValue; }
...
ApplicationInstance& ApplicationInstance::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("RuntimeContextStates")) {
    ...
    for (unsigned runtimeContextStatesIndex = 0; runtimeContextStatesIndex < runtimeContextStatesJsonList.GetLength();
         ++runtimeContextStatesIndex) {
