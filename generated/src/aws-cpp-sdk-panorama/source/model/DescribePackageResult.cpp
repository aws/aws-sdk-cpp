...
DescribePackageResult& DescribePackageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ReadAccessPrincipalArns")) {
    ...
    for (unsigned readAccessPrincipalArnsIndex = 0; readAccessPrincipalArnsIndex < readAccessPrincipalArnsJsonList.GetLength();
         ++readAccessPrincipalArnsIndex) {
  ...
  if (jsonValue.ValueExists("WriteAccessPrincipalArns")) {
    ...
    for (unsigned writeAccessPrincipalArnsIndex = 0; writeAccessPrincipalArnsIndex < writeAccessPrincipalArnsJsonList.GetLength();
         ++writeAccessPrincipalArnsIndex) {
