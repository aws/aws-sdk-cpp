...
ListNodeFromTemplateJobsResult::ListNodeFromTemplateJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListNodeFromTemplateJobsResult& ListNodeFromTemplateJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("NodeFromTemplateJobs")) {
    ...
    for (unsigned nodeFromTemplateJobsIndex = 0; nodeFromTemplateJobsIndex < nodeFromTemplateJobsJsonList.GetLength();
         ++nodeFromTemplateJobsIndex) {
