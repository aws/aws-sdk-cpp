...
Aws::String AssociateResourcesToSubscriptionRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection AssociateResourcesToSubscriptionRequest::GetRequestSpecificHeaders() const {
