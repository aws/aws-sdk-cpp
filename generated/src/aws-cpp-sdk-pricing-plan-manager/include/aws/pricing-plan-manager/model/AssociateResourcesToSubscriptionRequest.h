...
/**
 */
class AssociateResourcesToSubscriptionRequest : public PricingPlanManagerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AssociateResourcesToSubscription"; }
