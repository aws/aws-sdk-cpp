...
/**
 * <p>The specified subscription was not found. Verify that the ARN is correct and
 * that the subscription belongs to your account.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_PRICINGPLANMANAGER_API ResourceNotFoundException() = default;
  AWS_PRICINGPLANMANAGER_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
