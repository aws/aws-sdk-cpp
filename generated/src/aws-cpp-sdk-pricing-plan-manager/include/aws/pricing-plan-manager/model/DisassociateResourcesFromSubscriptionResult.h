...
namespace Model {
class DisassociateResourcesFromSubscriptionResult {
 public:
  AWS_PRICINGPLANMANAGER_API DisassociateResourcesFromSubscriptionResult() = default;
  AWS_PRICINGPLANMANAGER_API DisassociateResourcesFromSubscriptionResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PRICINGPLANMANAGER_API DisassociateResourcesFromSubscriptionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
