...
namespace Model {
class AssociateResourcesToSubscriptionResult {
 public:
  AWS_PRICINGPLANMANAGER_API AssociateResourcesToSubscriptionResult() = default;
  AWS_PRICINGPLANMANAGER_API AssociateResourcesToSubscriptionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PRICINGPLANMANAGER_API AssociateResourcesToSubscriptionResult& operator=(
  ...
  template <typename SubscriptionT = Subscription>
  AssociateResourcesToSubscriptionResult& WithSubscription(SubscriptionT&& value) {
  ...
  template <typename ETagT = Aws::String>
  AssociateResourcesToSubscriptionResult& WithETag(ETagT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateResourcesToSubscriptionResult& WithRequestId(RequestIdT&& value) {
