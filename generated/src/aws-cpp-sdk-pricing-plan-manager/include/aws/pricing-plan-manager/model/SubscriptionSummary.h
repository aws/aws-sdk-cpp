...
/**
 * <p>Summary information for a flat-rate pricing subscription, as returned by list
 * operations.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/SubscriptionSummary">AWS
 * API Reference</a></p>
 */
class SubscriptionSummary {
 public:
  ...
  inline SubscriptionSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The entity tag for concurrency control. Pass this value in the
   * <code>If-Match</code> header when making changes to this subscription.</p>
   */
