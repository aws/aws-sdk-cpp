...
/**
 */
class GetSubscriptionRequest : public PricingPlanManagerRequest {
 public:
  AWS_PRICINGPLANMANAGER_API GetSubscriptionRequest() = default;
  ...
  template <typename ArnT = Aws::String>
  GetSubscriptionRequest& WithArn(ArnT&& value) {
