...
/**
 */
class CancelSubscriptionRequest : public PricingPlanManagerRequest {
 public:
  AWS_PRICINGPLANMANAGER_API CancelSubscriptionRequest() = default;
  ...
  template <typename ArnT = Aws::String>
  CancelSubscriptionRequest& WithArn(ArnT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  CancelSubscriptionRequest& WithIfMatch(IfMatchT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CancelSubscriptionRequest& WithClientToken(ClientTokenT&& value) {
