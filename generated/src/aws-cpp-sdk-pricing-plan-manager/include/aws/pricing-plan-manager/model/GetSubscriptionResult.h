...
class GetSubscriptionResult {
 public:
  AWS_PRICINGPLANMANAGER_API GetSubscriptionResult() = default;
  AWS_PRICINGPLANMANAGER_API GetSubscriptionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PRICINGPLANMANAGER_API GetSubscriptionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ETagT = Aws::String>
  GetSubscriptionResult& WithETag(ETagT&& value) {
