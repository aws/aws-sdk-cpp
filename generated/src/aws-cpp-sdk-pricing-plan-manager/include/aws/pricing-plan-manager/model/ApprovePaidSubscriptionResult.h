...
namespace Model {
class ApprovePaidSubscriptionResult {
 public:
  ...
  AWS_PRICINGPLANMANAGER_API ApprovePaidSubscriptionResult& operator=(
  ...
  template <typename ETagT = Aws::String>
  ApprovePaidSubscriptionResult& WithETag(ETagT&& value) {
