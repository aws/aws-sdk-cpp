...
/**
 * <p>The request conflicts with the current state of the resource. This typically
 * occurs when the <code>ETag</code> value in the <code>If-Match</code> header does
 * not match the current version of the subscription. Retrieve the latest version
 * and retry.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/pricing-plan-manager-2025-08-05/ConflictException">AWS
 * API Reference</a></p>
 */
