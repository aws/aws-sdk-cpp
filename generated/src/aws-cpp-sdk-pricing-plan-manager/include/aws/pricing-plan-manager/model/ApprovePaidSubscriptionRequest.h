...
/**
 */
class ApprovePaidSubscriptionRequest : public PricingPlanManagerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ApprovePaidSubscription"; }
  ...
  template <typename ArnT = Aws::String>
  ApprovePaidSubscriptionRequest& WithArn(ArnT&& value) {
   ...
   * <code>ListSubscriptions</code> response. This ensures you are approving the
  ...
  template <typename IfMatchT = Aws::String>
  ApprovePaidSubscriptionRequest& WithIfMatch(IfMatchT&& value) {
