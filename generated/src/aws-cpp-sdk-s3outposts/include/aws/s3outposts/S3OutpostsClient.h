...
namespace S3Outposts
{
   ...
   */
  class AWS_S3OUTPOSTS_API S3OutpostsClient : Aws::Client::ClientWithAsyncTemplateMethods<S3OutpostsClient>,
    smithy::client::AwsSmithyClientT<Aws::S3Outposts::SERVICE_NAME,
