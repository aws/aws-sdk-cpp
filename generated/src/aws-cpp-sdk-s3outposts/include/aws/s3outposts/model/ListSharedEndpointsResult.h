...
class ListSharedEndpointsResult {
 public:
  ...
  template <typename EndpointsT = Aws::Vector<Endpoint>>
  ListSharedEndpointsResult& WithEndpoints(EndpointsT&& value) {
    SetEndpoints(std::forward<EndpointsT>(value));
    return *this;
  }
  template <typename EndpointsT = Endpoint>
  ListSharedEndpointsResult& AddEndpoints(EndpointsT&& value) {
    m_endpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSharedEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSharedEndpointsResult& WithRequestId(RequestIdT&& value) {
