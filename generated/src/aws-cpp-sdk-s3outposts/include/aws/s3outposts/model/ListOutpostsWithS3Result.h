...
class ListOutpostsWithS3Result {
 public:
  ...
  void SetOutposts(OutpostsT&& value) {
    m_outpostsHasBeenSet = true;
    m_outposts = std::forward<OutpostsT>(value);
  }
  template <typename OutpostsT = Aws::Vector<Outpost>>
  ListOutpostsWithS3Result& WithOutposts(OutpostsT&& value) {
    SetOutposts(std::forward<OutpostsT>(value));
    return *this;
  }
  template <typename OutpostsT = Outpost>
  ListOutpostsWithS3Result& AddOutposts(OutpostsT&& value) {
    m_outpostsHasBeenSet = true;
    m_outposts.emplace_back(std::forward<OutpostsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOutpostsWithS3Result& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOutpostsWithS3Result& WithRequestId(RequestIdT&& value) {
