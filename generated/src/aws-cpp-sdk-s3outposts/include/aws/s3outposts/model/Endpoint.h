...
class Endpoint {
 public:
  ...
  void SetOutpostsId(OutpostsIdT&& value) {
    ...
    m_outpostsId = std::forward<OutpostsIdT>(value);
  }
  template <typename OutpostsIdT = Aws::String>
  Endpoint& WithOutpostsId(OutpostsIdT&& value) {
    SetOutpostsId(std::forward<OutpostsIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(EndpointStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Endpoint& WithStatus(EndpointStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccessType(EndpointAccessType value) {
    m_accessTypeHasBeenSet = true;
    m_accessType = value;
  }
  inline Endpoint& WithAccessType(EndpointAccessType value) {
    SetAccessType(value);
    return *this;
  }
  ///@}
  ...
  void SetFailedReason(FailedReasonT&& value) {
    ...
    m_failedReason = std::forward<FailedReasonT>(value);
  }
  template <typename FailedReasonT = FailedReason>
  Endpoint& WithFailedReason(FailedReasonT&& value) {
    SetFailedReason(std::forward<FailedReasonT>(value));
    return *this;
  }
  ///@}
 private:
