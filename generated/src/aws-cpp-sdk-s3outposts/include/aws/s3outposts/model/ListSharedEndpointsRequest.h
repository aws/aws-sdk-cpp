...
class ListSharedEndpointsRequest : public S3OutpostsRequest {
 public:
  AWS_S3OUTPOSTS_API ListSharedEndpointsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListSharedEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSharedEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutpostIdT = Aws::String>
  ListSharedEndpointsRequest& WithOutpostId(OutpostIdT&& value) {
