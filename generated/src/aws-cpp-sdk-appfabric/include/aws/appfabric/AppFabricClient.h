...
class AWS_APPFABRIC_API AppFabricClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AppFabricClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AppFabricEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchGetUserAccessTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetUserAccessTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetUserAccessTasksRequestT = Model::BatchGetUserAccessTasksRequest>
  void BatchGetUserAccessTasksAsync(const BatchGetUserAccessTasksRequestT& request,
                                    const BatchGetUserAccessTasksResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for ConnectAppAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ConnectAppAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ConnectAppAuthorizationRequestT = Model::ConnectAppAuthorizationRequest>
  void ConnectAppAuthorizationAsync(const ConnectAppAuthorizationRequestT& request,
                                    const ConnectAppAuthorizationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppAuthorizationRequestT = Model::CreateAppAuthorizationRequest>
  void CreateAppAuthorizationAsync(const CreateAppAuthorizationRequestT& request,
                                   const CreateAppAuthorizationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAppBundle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAppBundleRequestT = Model::CreateAppBundleRequest>
  void CreateAppBundleAsync(const CreateAppBundleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const CreateAppBundleRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIngestionDestinationOutcome CreateIngestionDestination(
      const Model::CreateIngestionDestinationRequest& request) const;

  /**
   * A Callable wrapper for CreateIngestionDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateIngestionDestinationRequestT = Model::CreateIngestionDestinationRequest>
  Model::CreateIngestionDestinationOutcomeCallable CreateIngestionDestinationCallable(
      const CreateIngestionDestinationRequestT& request) const {
    return SubmitCallable(&AppFabricClient::CreateIngestionDestination, request);
  }

  /**
   * An Async wrapper for CreateIngestionDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIngestionDestinationRequestT = Model::CreateIngestionDestinationRequest>
  void CreateIngestionDestinationAsync(const CreateIngestionDestinationRequestT& request,
                                       const CreateIngestionDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppAuthorizationRequestT = Model::DeleteAppAuthorizationRequest>
  void DeleteAppAuthorizationAsync(const DeleteAppAuthorizationRequestT& request,
                                   const DeleteAppAuthorizationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAppBundle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAppBundleRequestT = Model::DeleteAppBundleRequest>
  void DeleteAppBundleAsync(const DeleteAppBundleRequestT& request, const DeleteAppBundleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteIngestion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteIngestionRequestT = Model::DeleteIngestionRequest>
  void DeleteIngestionAsync(const DeleteIngestionRequestT& request, const DeleteIngestionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteIngestionDestinationOutcome DeleteIngestionDestination(
      const Model::DeleteIngestionDestinationRequest& request) const;

  /**
   * A Callable wrapper for DeleteIngestionDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteIngestionDestinationRequestT = Model::DeleteIngestionDestinationRequest>
  Model::DeleteIngestionDestinationOutcomeCallable DeleteIngestionDestinationCallable(
      const DeleteIngestionDestinationRequestT& request) const {
    return SubmitCallable(&AppFabricClient::DeleteIngestionDestination, request);
  }

  /**
   * An Async wrapper for DeleteIngestionDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteIngestionDestinationRequestT = Model::DeleteIngestionDestinationRequest>
  void DeleteIngestionDestinationAsync(const DeleteIngestionDestinationRequestT& request,
                                       const DeleteIngestionDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAppAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAppAuthorization that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAppAuthorizationRequestT = Model::GetAppAuthorizationRequest>
  void GetAppAuthorizationAsync(const GetAppAuthorizationRequestT& request, const GetAppAuthorizationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAppBundle that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAppBundleRequestT = Model::GetAppBundleRequest>
  void GetAppBundleAsync(const GetAppBundleRequestT& request, const GetAppBundleResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetIngestion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetIngestionRequestT = Model::GetIngestionRequest>
  void GetIngestionAsync(const GetIngestionRequestT& request, const GetIngestionResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIngestionDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIngestionDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIngestionDestinationRequestT = Model::GetIngestionDestinationRequest>
  void GetIngestionDestinationAsync(const GetIngestionDestinationRequestT& request,
                                    const GetIngestionDestinationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppAuthorizations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppAuthorizations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAppAuthorizationsRequestT = Model::ListAppAuthorizationsRequest>
  void ListAppAuthorizationsAsync(const ListAppAuthorizationsRequestT& request, const ListAppAuthorizationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAppBundles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAppBundlesRequestT = Model::ListAppBundlesRequest>
  void ListAppBundlesAsync(const ListAppBundlesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAppBundlesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListIngestionDestinations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListIngestionDestinationsRequestT = Model::ListIngestionDestinationsRequest>
  Model::ListIngestionDestinationsOutcomeCallable ListIngestionDestinationsCallable(
      const ListIngestionDestinationsRequestT& request) const {
    return SubmitCallable(&AppFabricClient::ListIngestionDestinations, request);
  }

  /**
   * An Async wrapper for ListIngestionDestinations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIngestionDestinationsRequestT = Model::ListIngestionDestinationsRequest>
  void ListIngestionDestinationsAsync(const ListIngestionDestinationsRequestT& request,
                                      const ListIngestionDestinationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartIngestion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartIngestionRequestT = Model::StartIngestionRequest>
  void StartIngestionAsync(const StartIngestionRequestT& request, const StartIngestionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartUserAccessTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartUserAccessTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartUserAccessTasksRequestT = Model::StartUserAccessTasksRequest>
  void StartUserAccessTasksAsync(const StartUserAccessTasksRequestT& request, const StartUserAccessTasksResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopIngestion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopIngestionRequestT = Model::StopIngestionRequest>
  void StopIngestionAsync(const StopIngestionRequestT& request, const StopIngestionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppAuthorization that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppAuthorizationRequestT = Model::UpdateAppAuthorizationRequest>
  void UpdateAppAuthorizationAsync(const UpdateAppAuthorizationRequestT& request,
                                   const UpdateAppAuthorizationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateIngestionDestinationOutcome UpdateIngestionDestination(
      const Model::UpdateIngestionDestinationRequest& request) const;

  /**
   * A Callable wrapper for UpdateIngestionDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateIngestionDestinationRequestT = Model::UpdateIngestionDestinationRequest>
  Model::UpdateIngestionDestinationOutcomeCallable UpdateIngestionDestinationCallable(
      const UpdateIngestionDestinationRequestT& request) const {
    return SubmitCallable(&AppFabricClient::UpdateIngestionDestination, request);
  }

  /**
   * An Async wrapper for UpdateIngestionDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateIngestionDestinationRequestT = Model::UpdateIngestionDestinationRequest>
  void UpdateIngestionDestinationAsync(const UpdateIngestionDestinationRequestT& request,
                                       const UpdateIngestionDestinationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
