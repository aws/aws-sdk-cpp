...
namespace Model
{
  ...
  {
  public:
    AWS_APPFABRIC_API DeleteIngestionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteIngestionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
