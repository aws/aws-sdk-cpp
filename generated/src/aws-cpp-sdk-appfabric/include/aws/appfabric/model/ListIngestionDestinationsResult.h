...
class ListIngestionDestinationsResult {
 public:
  ...
  void SetIngestionDestinations(IngestionDestinationsT&& value) {
    m_ingestionDestinationsHasBeenSet = true;
    m_ingestionDestinations = std::forward<IngestionDestinationsT>(value);
  }
  template <typename IngestionDestinationsT = Aws::Vector<IngestionDestinationSummary>>
  ListIngestionDestinationsResult& WithIngestionDestinations(IngestionDestinationsT&& value) {
    SetIngestionDestinations(std::forward<IngestionDestinationsT>(value));
    return *this;
  }
  template <typename IngestionDestinationsT = IngestionDestinationSummary>
  ListIngestionDestinationsResult& AddIngestionDestinations(IngestionDestinationsT&& value) {
    m_ingestionDestinationsHasBeenSet = true;
    m_ingestionDestinations.emplace_back(std::forward<IngestionDestinationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIngestionDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIngestionDestinationsResult& WithRequestId(RequestIdT&& value) {
