...
namespace Model
{
  ...
  /**
   * <p>The request exceeds a service quota.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_APPFABRIC_API ServiceQuotaExceededException() = default;
    AWS_APPFABRIC_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
    AWS_APPFABRIC_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
