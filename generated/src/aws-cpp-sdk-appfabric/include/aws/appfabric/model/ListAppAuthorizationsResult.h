...
class ListAppAuthorizationsResult {
 public:
  ...
  void SetAppAuthorizationSummaryList(AppAuthorizationSummaryListT&& value) {
    m_appAuthorizationSummaryListHasBeenSet = true;
    m_appAuthorizationSummaryList = std::forward<AppAuthorizationSummaryListT>(value);
  }
  template <typename AppAuthorizationSummaryListT = Aws::Vector<AppAuthorizationSummary>>
  ListAppAuthorizationsResult& WithAppAuthorizationSummaryList(AppAuthorizationSummaryListT&& value) {
    SetAppAuthorizationSummaryList(std::forward<AppAuthorizationSummaryListT>(value));
    return *this;
  }
  template <typename AppAuthorizationSummaryListT = AppAuthorizationSummary>
  ListAppAuthorizationsResult& AddAppAuthorizationSummaryList(AppAuthorizationSummaryListT&& value) {
    m_appAuthorizationSummaryListHasBeenSet = true;
    m_appAuthorizationSummaryList.emplace_back(std::forward<AppAuthorizationSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAuthorizationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppAuthorizationsResult& WithRequestId(RequestIdT&& value) {
