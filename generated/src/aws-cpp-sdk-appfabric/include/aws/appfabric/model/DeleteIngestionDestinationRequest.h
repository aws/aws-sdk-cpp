...
class DeleteIngestionDestinationRequest : public AppFabricRequest {
 public:
  ...
  template <typename AppBundleIdentifierT = Aws::String>
  DeleteIngestionDestinationRequest& WithAppBundleIdentifier(AppBundleIdentifierT&& value) {
  ...
  template <typename IngestionIdentifierT = Aws::String>
  DeleteIngestionDestinationRequest& WithIngestionIdentifier(IngestionIdentifierT&& value) {
  ...
  template <typename IngestionDestinationIdentifierT = Aws::String>
  DeleteIngestionDestinationRequest& WithIngestionDestinationIdentifier(IngestionDestinationIdentifierT&& value) {
