...
class StartUserAccessTasksResult {
 public:
  ...
  void SetUserAccessTasksList(UserAccessTasksListT&& value) {
    m_userAccessTasksListHasBeenSet = true;
    m_userAccessTasksList = std::forward<UserAccessTasksListT>(value);
  }
  template <typename UserAccessTasksListT = Aws::Vector<UserAccessTaskItem>>
  StartUserAccessTasksResult& WithUserAccessTasksList(UserAccessTasksListT&& value) {
    SetUserAccessTasksList(std::forward<UserAccessTasksListT>(value));
    return *this;
  }
  template <typename UserAccessTasksListT = UserAccessTaskItem>
  StartUserAccessTasksResult& AddUserAccessTasksList(UserAccessTasksListT&& value) {
    m_userAccessTasksListHasBeenSet = true;
    m_userAccessTasksList.emplace_back(std::forward<UserAccessTasksListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartUserAccessTasksResult& WithRequestId(RequestIdT&& value) {
