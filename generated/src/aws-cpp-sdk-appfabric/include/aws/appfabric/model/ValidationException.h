...
namespace Model
{
  ...
  /**
   * <p>The request has invalid or missing parameters.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ValidationException">AWS
   * API Reference</a></p>
   */
  class ValidationException
  {
  public:
    AWS_APPFABRIC_API ValidationException() = default;
    AWS_APPFABRIC_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_APPFABRIC_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
