...
namespace Model
{
  ...
  /**
   */
  class ListAppAuthorizationsRequest : public AppFabricRequest
  {
  public:
    AWS_APPFABRIC_API ListAppAuthorizationsRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ListAppAuthorizations"; }
     ...
     * app bundle to use for the request.</p>
     */
    inline ListAppAuthorizationsRequest& WithAppBundleIdentifier(const Aws::String& value) { SetAppBundleIdentifier(value); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the
     * app bundle to use for the request.</p>
     */
    inline ListAppAuthorizationsRequest& WithAppBundleIdentifier(Aws::String&& value) { SetAppBundleIdentifier(std::move(value)); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the
     * app bundle to use for the request.</p>
     */
    inline ListAppAuthorizationsRequest& WithAppBundleIdentifier(const char* value) { SetAppBundleIdentifier(value); return *this;}
     ...
     * than the specified maximum.</p>
     */
    inline ListAppAuthorizationsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
     ...
     * error</i>.</p>
     */
    inline ListAppAuthorizationsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * error</i>.</p>
     */
    inline ListAppAuthorizationsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * error</i>.</p>
     */
    inline ListAppAuthorizationsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
