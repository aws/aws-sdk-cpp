...
class ListAppAuthorizationsRequest : public AppFabricRequest {
 public:
  ...
  template <typename AppBundleIdentifierT = Aws::String>
  ListAppAuthorizationsRequest& WithAppBundleIdentifier(AppBundleIdentifierT&& value) {
  ...
  inline ListAppAuthorizationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppAuthorizationsRequest& WithNextToken(NextTokenT&& value) {
