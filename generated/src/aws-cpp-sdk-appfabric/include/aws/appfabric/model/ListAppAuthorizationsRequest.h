...
namespace Model
{
  ...
  {
  public:
    AWS_APPFABRIC_API ListAppAuthorizationsRequest() = default;
    ...
    template<typename AppBundleIdentifierT = Aws::String>
    ListAppAuthorizationsRequest& WithAppBundleIdentifier(AppBundleIdentifierT&& value) { SetAppBundleIdentifier(std::forward<AppBundleIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAppAuthorizationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
