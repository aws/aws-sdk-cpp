...
namespace Model
{
  ...
  /**
   * <p>The request rate exceeds the limit.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ThrottlingException">AWS
   * API Reference</a></p>
   */
  class ThrottlingException
  {
  public:
    AWS_APPFABRIC_API ThrottlingException() = default;
    AWS_APPFABRIC_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
    AWS_APPFABRIC_API ThrottlingException& operator=(Aws::Utils::Json::JsonView jsonValue);
