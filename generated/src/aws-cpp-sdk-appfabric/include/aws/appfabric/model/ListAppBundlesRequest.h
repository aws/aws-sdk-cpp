...
namespace Model
{
  ...
  {
  public:
    AWS_APPFABRIC_API ListAppBundlesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListAppBundlesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
