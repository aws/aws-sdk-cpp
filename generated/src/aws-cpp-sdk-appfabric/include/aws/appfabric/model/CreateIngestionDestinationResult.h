...
namespace Model
{
  ...
  public:
    ...
    template<typename IngestionDestinationT = IngestionDestination>
    CreateIngestionDestinationResult& WithIngestionDestination(IngestionDestinationT&& value) { SetIngestionDestination(std::forward<IngestionDestinationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateIngestionDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
