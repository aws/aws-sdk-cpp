...
class AuditLogProcessingConfiguration {
 public:
  ...
  inline void SetSchema(Schema value) {
    m_schemaHasBeenSet = true;
    m_schema = value;
  }
  inline AuditLogProcessingConfiguration& WithSchema(Schema value) {
    SetSchema(value);
    return *this;
  }
  ///@}
  ...
  inline AuditLogProcessingConfiguration& WithFormat(Format value) {
    SetFormat(value);
    return *this;
  }
  ///@}
