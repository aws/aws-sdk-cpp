...
class ConnectAppAuthorizationResult {
 public:
  ...
  void SetAppAuthorizationSummary(AppAuthorizationSummaryT&& value) {
    m_appAuthorizationSummaryHasBeenSet = true;
    m_appAuthorizationSummary = std::forward<AppAuthorizationSummaryT>(value);
  }
  template <typename AppAuthorizationSummaryT = AppAuthorizationSummary>
  ConnectAppAuthorizationResult& WithAppAuthorizationSummary(AppAuthorizationSummaryT&& value) {
    SetAppAuthorizationSummary(std::forward<AppAuthorizationSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ConnectAppAuthorizationResult& WithRequestId(RequestIdT&& value) {
