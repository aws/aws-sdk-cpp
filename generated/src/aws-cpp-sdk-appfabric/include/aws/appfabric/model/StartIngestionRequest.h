...
namespace Model
{
  ...
  public:
    ...
    template<typename IngestionIdentifierT = Aws::String>
    StartIngestionRequest& WithIngestionIdentifier(IngestionIdentifierT&& value) { SetIngestionIdentifier(std::forward<IngestionIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AppBundleIdentifierT = Aws::String>
    StartIngestionRequest& WithAppBundleIdentifier(AppBundleIdentifierT&& value) { SetAppBundleIdentifier(std::forward<AppBundleIdentifierT>(value)); return *this;}
    ///@}
  private:
