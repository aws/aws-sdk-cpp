...
namespace Model
{
  ...
  {
  public:
    AWS_APPFABRIC_API StopIngestionRequest() = default;
    ...
    template<typename IngestionIdentifierT = Aws::String>
    StopIngestionRequest& WithIngestionIdentifier(IngestionIdentifierT&& value) { SetIngestionIdentifier(std::forward<IngestionIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AppBundleIdentifierT = Aws::String>
    StopIngestionRequest& WithAppBundleIdentifier(AppBundleIdentifierT&& value) { SetAppBundleIdentifier(std::forward<AppBundleIdentifierT>(value)); return *this;}
    ///@}
  private:
