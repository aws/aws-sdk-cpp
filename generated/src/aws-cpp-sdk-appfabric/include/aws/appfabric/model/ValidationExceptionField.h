...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ValidationExceptionField">AWS
   * API Reference</a></p>
   */
  class ValidationExceptionField
  {
  public:
    AWS_APPFABRIC_API ValidationExceptionField() = default;
    AWS_APPFABRIC_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_APPFABRIC_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
