...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_APPFABRIC_API ResourceNotFoundException() = default;
    AWS_APPFABRIC_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_APPFABRIC_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
