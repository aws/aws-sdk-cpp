...
/**
 * <p>The request has created a conflict. Check the request parameters and try
 * again.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_APPFABRIC_API ConflictException() = default;
  AWS_APPFABRIC_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_APPFABRIC_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
