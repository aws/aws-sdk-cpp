...
namespace Model
{
  ...
  {
  public:
    AWS_APPFABRIC_API ListTagsForResourceResult() = default;
    AWS_APPFABRIC_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_APPFABRIC_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
