...
class ListAppBundlesResult {
 public:
  ...
  void SetAppBundleSummaryList(AppBundleSummaryListT&& value) {
    m_appBundleSummaryListHasBeenSet = true;
    m_appBundleSummaryList = std::forward<AppBundleSummaryListT>(value);
  }
  template <typename AppBundleSummaryListT = Aws::Vector<AppBundleSummary>>
  ListAppBundlesResult& WithAppBundleSummaryList(AppBundleSummaryListT&& value) {
    SetAppBundleSummaryList(std::forward<AppBundleSummaryListT>(value));
    return *this;
  }
  template <typename AppBundleSummaryListT = AppBundleSummary>
  ListAppBundlesResult& AddAppBundleSummaryList(AppBundleSummaryListT&& value) {
    m_appBundleSummaryListHasBeenSet = true;
    m_appBundleSummaryList.emplace_back(std::forward<AppBundleSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppBundlesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAppBundlesResult& WithRequestId(RequestIdT&& value) {
