...
namespace Model
{
  ...
  public:
    ...
    template<typename ErrorCodeT = Aws::String>
    TaskError& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = Aws::String>
    TaskError& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
  private:
