...
GetIngestionDestinationResult::GetIngestionDestinationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetIngestionDestinationResult& GetIngestionDestinationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
