...
ListAppAuthorizationsResult::ListAppAuthorizationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAppAuthorizationsResult& ListAppAuthorizationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("appAuthorizationSummaryList")) {
    ...
    for (unsigned appAuthorizationSummaryListIndex = 0; appAuthorizationSummaryListIndex < appAuthorizationSummaryListJsonList.GetLength();
         ++appAuthorizationSummaryListIndex) {
      m_appAuthorizationSummaryList.push_back(appAuthorizationSummaryListJsonList[appAuthorizationSummaryListIndex].AsObject());
    }
    m_appAuthorizationSummaryListHasBeenSet = true;
  }
