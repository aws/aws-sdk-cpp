...
DeleteAppAuthorizationResult::DeleteAppAuthorizationResult()
{
}

DeleteAppAuthorizationResult::DeleteAppAuthorizationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
