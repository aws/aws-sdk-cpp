...
class AssociateConfigurationItemsToApplicationRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  template <typename ApplicationConfigurationIdT = Aws::String>
  AssociateConfigurationItemsToApplicationRequest& WithApplicationConfigurationId(ApplicationConfigurationIdT&& value) {
  ...
  template <typename ConfigurationIdsT = Aws::Vector<Aws::String>>
  AssociateConfigurationItemsToApplicationRequest& WithConfigurationIds(ConfigurationIdsT&& value) {
    SetConfigurationIds(std::forward<ConfigurationIdsT>(value));
    return *this;
  }
  template <typename ConfigurationIdsT = Aws::String>
  AssociateConfigurationItemsToApplicationRequest& AddConfigurationIds(ConfigurationIdsT&& value) {
    m_configurationIdsHasBeenSet = true;
