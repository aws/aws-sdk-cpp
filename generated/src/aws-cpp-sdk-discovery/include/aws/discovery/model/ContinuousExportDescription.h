...
class ContinuousExportDescription {
 public:
  ...
  inline void SetStatus(ContinuousExportStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ContinuousExportDescription& WithStatus(ContinuousExportStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ContinuousExportDescription& WithDataSource(DataSource value) {
    SetDataSource(value);
    return *this;
  }
  ///@}
  ...
  void SetSchemaStorageConfig(SchemaStorageConfigT&& value) {
    ...
    m_schemaStorageConfig = std::forward<SchemaStorageConfigT>(value);
  }
  template <typename SchemaStorageConfigT = Aws::Map<Aws::String, Aws::String>>
  ContinuousExportDescription& WithSchemaStorageConfig(SchemaStorageConfigT&& value) {
    SetSchemaStorageConfig(std::forward<SchemaStorageConfigT>(value));
    return *this;
  }
  ...
  ContinuousExportDescription& AddSchemaStorageConfig(SchemaStorageConfigKeyT&& key, SchemaStorageConfigValueT&& value) {
    m_schemaStorageConfigHasBeenSet = true;
    m_schemaStorageConfig.emplace(std::forward<SchemaStorageConfigKeyT>(key), std::forward<SchemaStorageConfigValueT>(value));
    return *this;
  }
  ///@}
 private:
