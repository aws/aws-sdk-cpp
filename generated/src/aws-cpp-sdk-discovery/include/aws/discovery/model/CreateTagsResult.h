...
namespace Model
{
  ...
  {
  public:
    AWS_APPLICATIONDISCOVERYSERVICE_API CreateTagsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateTagsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
