...
class DescribeExportTasksResult {
 public:
  ...
  AWS_APPLICATIONDISCOVERYSERVICE_API DescribeExportTasksResult& operator=(
  ...
  void SetExportsInfo(ExportsInfoT&& value) {
    m_exportsInfoHasBeenSet = true;
    m_exportsInfo = std::forward<ExportsInfoT>(value);
  }
  template <typename ExportsInfoT = Aws::Vector<ExportInfo>>
  DescribeExportTasksResult& WithExportsInfo(ExportsInfoT&& value) {
    SetExportsInfo(std::forward<ExportsInfoT>(value));
    return *this;
  }
  template <typename ExportsInfoT = ExportInfo>
  DescribeExportTasksResult& AddExportsInfo(ExportsInfoT&& value) {
    m_exportsInfoHasBeenSet = true;
    m_exportsInfo.emplace_back(std::forward<ExportsInfoT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeExportTasksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeExportTasksResult& WithRequestId(RequestIdT&& value) {
