...
class BatchDeleteImportDataRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  void SetImportTaskIds(ImportTaskIdsT&& value) {
    m_importTaskIdsHasBeenSet = true;
    m_importTaskIds = std::forward<ImportTaskIdsT>(value);
  }
  template <typename ImportTaskIdsT = Aws::Vector<Aws::String>>
  BatchDeleteImportDataRequest& WithImportTaskIds(ImportTaskIdsT&& value) {
    SetImportTaskIds(std::forward<ImportTaskIdsT>(value));
    return *this;
  }
  template <typename ImportTaskIdsT = Aws::String>
  BatchDeleteImportDataRequest& AddImportTaskIds(ImportTaskIdsT&& value) {
    m_importTaskIdsHasBeenSet = true;
    m_importTaskIds.emplace_back(std::forward<ImportTaskIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteHistory(bool value) {
    m_deleteHistoryHasBeenSet = true;
    m_deleteHistory = value;
  }
  inline BatchDeleteImportDataRequest& WithDeleteHistory(bool value) {
    SetDeleteHistory(value);
    return *this;
  }
  ///@}
 private:
