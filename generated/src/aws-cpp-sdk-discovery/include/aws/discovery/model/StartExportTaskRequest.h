...
class StartExportTaskRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  void SetExportDataFormat(ExportDataFormatT&& value) {
    m_exportDataFormatHasBeenSet = true;
    m_exportDataFormat = std::forward<ExportDataFormatT>(value);
  }
  template <typename ExportDataFormatT = Aws::Vector<ExportDataFormat>>
  StartExportTaskRequest& WithExportDataFormat(ExportDataFormatT&& value) {
    SetExportDataFormat(std::forward<ExportDataFormatT>(value));
    return *this;
  }
  inline StartExportTaskRequest& AddExportDataFormat(ExportDataFormat value) {
    m_exportDataFormatHasBeenSet = true;
    m_exportDataFormat.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<ExportFilter>>
  StartExportTaskRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ExportFilter>
  StartExportTaskRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StartExportTaskRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  StartExportTaskRequest& WithEndTime(EndTimeT&& value) {
