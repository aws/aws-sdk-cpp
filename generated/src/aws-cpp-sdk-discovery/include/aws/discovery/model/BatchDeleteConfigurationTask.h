...
class BatchDeleteConfigurationTask {
 public:
  ...
  inline void SetStatus(BatchDeleteConfigurationTaskStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline BatchDeleteConfigurationTask& WithStatus(BatchDeleteConfigurationTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline BatchDeleteConfigurationTask& WithConfigurationType(DeletionConfigurationItemType value) {
  ...
  void SetRequestedConfigurations(RequestedConfigurationsT&& value) {
    ...
    m_requestedConfigurations = std::forward<RequestedConfigurationsT>(value);
  }
  template <typename RequestedConfigurationsT = Aws::Vector<Aws::String>>
  BatchDeleteConfigurationTask& WithRequestedConfigurations(RequestedConfigurationsT&& value) {
    SetRequestedConfigurations(std::forward<RequestedConfigurationsT>(value));
    return *this;
  }
  ...
  BatchDeleteConfigurationTask& AddRequestedConfigurations(RequestedConfigurationsT&& value) {
    m_requestedConfigurationsHasBeenSet = true;
    m_requestedConfigurations.emplace_back(std::forward<RequestedConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletedConfigurations(DeletedConfigurationsT&& value) {
    ...
    m_deletedConfigurations = std::forward<DeletedConfigurationsT>(value);
  }
  template <typename DeletedConfigurationsT = Aws::Vector<Aws::String>>
  BatchDeleteConfigurationTask& WithDeletedConfigurations(DeletedConfigurationsT&& value) {
    SetDeletedConfigurations(std::forward<DeletedConfigurationsT>(value));
    return *this;
  }
  ...
  BatchDeleteConfigurationTask& AddDeletedConfigurations(DeletedConfigurationsT&& value) {
    m_deletedConfigurationsHasBeenSet = true;
    m_deletedConfigurations.emplace_back(std::forward<DeletedConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailedConfigurations(FailedConfigurationsT&& value) {
    ...
    m_failedConfigurations = std::forward<FailedConfigurationsT>(value);
  }
  template <typename FailedConfigurationsT = Aws::Vector<FailedConfiguration>>
  BatchDeleteConfigurationTask& WithFailedConfigurations(FailedConfigurationsT&& value) {
    SetFailedConfigurations(std::forward<FailedConfigurationsT>(value));
    return *this;
  }
  ...
  BatchDeleteConfigurationTask& AddFailedConfigurations(FailedConfigurationsT&& value) {
    m_failedConfigurationsHasBeenSet = true;
    m_failedConfigurations.emplace_back(std::forward<FailedConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletionWarnings(DeletionWarningsT&& value) {
    ...
    m_deletionWarnings = std::forward<DeletionWarningsT>(value);
  }
  template <typename DeletionWarningsT = Aws::Vector<DeletionWarning>>
  BatchDeleteConfigurationTask& WithDeletionWarnings(DeletionWarningsT&& value) {
    SetDeletionWarnings(std::forward<DeletionWarningsT>(value));
    return *this;
  }
  ...
  BatchDeleteConfigurationTask& AddDeletionWarnings(DeletionWarningsT&& value) {
    m_deletionWarningsHasBeenSet = true;
    m_deletionWarnings.emplace_back(std::forward<DeletionWarningsT>(value));
    return *this;
  }
  ///@}
 private:
