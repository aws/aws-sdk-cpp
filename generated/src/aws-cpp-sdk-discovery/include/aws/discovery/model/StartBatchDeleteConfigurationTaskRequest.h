...
class StartBatchDeleteConfigurationTaskRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  inline void SetConfigurationType(DeletionConfigurationItemType value) {
    m_configurationTypeHasBeenSet = true;
    m_configurationType = value;
  }
  inline StartBatchDeleteConfigurationTaskRequest& WithConfigurationType(DeletionConfigurationItemType value) {
