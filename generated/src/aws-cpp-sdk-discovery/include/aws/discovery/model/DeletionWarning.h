...
class DeletionWarning {
 public:
  ...
  inline void SetWarningCode(int value) {
    m_warningCodeHasBeenSet = true;
    m_warningCode = value;
  }
  inline DeletionWarning& WithWarningCode(int value) {
    SetWarningCode(value);
    return *this;
  }
  ///@}
  ...
  void SetWarningText(WarningTextT&& value) {
    m_warningTextHasBeenSet = true;
    m_warningText = std::forward<WarningTextT>(value);
  }
  template <typename WarningTextT = Aws::String>
  DeletionWarning& WithWarningText(WarningTextT&& value) {
    SetWarningText(std::forward<WarningTextT>(value));
    return *this;
  }
  ///@}
 private:
