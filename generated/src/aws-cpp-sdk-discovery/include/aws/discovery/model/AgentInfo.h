...
class AgentInfo {
 public:
  ...
  void SetAgentNetworkInfoList(AgentNetworkInfoListT&& value) {
    ...
    m_agentNetworkInfoList = std::forward<AgentNetworkInfoListT>(value);
  }
  template <typename AgentNetworkInfoListT = Aws::Vector<AgentNetworkInfo>>
  AgentInfo& WithAgentNetworkInfoList(AgentNetworkInfoListT&& value) {
    SetAgentNetworkInfoList(std::forward<AgentNetworkInfoListT>(value));
    return *this;
  }
  template <typename AgentNetworkInfoListT = AgentNetworkInfo>
  AgentInfo& AddAgentNetworkInfoList(AgentNetworkInfoListT&& value) {
    m_agentNetworkInfoListHasBeenSet = true;
    m_agentNetworkInfoList.emplace_back(std::forward<AgentNetworkInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHealth(AgentStatus value) {
    m_healthHasBeenSet = true;
    m_health = value;
  }
  inline AgentInfo& WithHealth(AgentStatus value) {
    SetHealth(value);
    return *this;
  }
  ///@}
  ...
  void SetLastHealthPingTime(LastHealthPingTimeT&& value) {
    ...
    m_lastHealthPingTime = std::forward<LastHealthPingTimeT>(value);
  }
  template <typename LastHealthPingTimeT = Aws::String>
  AgentInfo& WithLastHealthPingTime(LastHealthPingTimeT&& value) {
    SetLastHealthPingTime(std::forward<LastHealthPingTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollectionStatus(CollectionStatusT&& value) {
    ...
    m_collectionStatus = std::forward<CollectionStatusT>(value);
  }
  template <typename CollectionStatusT = Aws::String>
  AgentInfo& WithCollectionStatus(CollectionStatusT&& value) {
    SetCollectionStatus(std::forward<CollectionStatusT>(value));
    return *this;
  }
  ///@}
