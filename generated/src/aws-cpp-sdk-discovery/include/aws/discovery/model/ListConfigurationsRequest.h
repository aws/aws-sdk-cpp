...
class ListConfigurationsRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  inline ListConfigurationsRequest& WithConfigurationType(ConfigurationItemType value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListConfigurationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListConfigurationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename OrderByT = Aws::Vector<OrderByElement>>
  ListConfigurationsRequest& WithOrderBy(OrderByT&& value) {
    SetOrderBy(std::forward<OrderByT>(value));
    return *this;
  }
  template <typename OrderByT = OrderByElement>
  ListConfigurationsRequest& AddOrderBy(OrderByT&& value) {
    m_orderByHasBeenSet = true;
