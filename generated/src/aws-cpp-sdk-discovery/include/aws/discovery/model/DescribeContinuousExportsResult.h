...
class DescribeContinuousExportsResult {
 public:
  ...
  AWS_APPLICATIONDISCOVERYSERVICE_API DescribeContinuousExportsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DescriptionsT = Aws::Vector<ContinuousExportDescription>>
  DescribeContinuousExportsResult& WithDescriptions(DescriptionsT&& value) {
    SetDescriptions(std::forward<DescriptionsT>(value));
    return *this;
  }
  template <typename DescriptionsT = ContinuousExportDescription>
  DescribeContinuousExportsResult& AddDescriptions(DescriptionsT&& value) {
    m_descriptionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeContinuousExportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeContinuousExportsResult& WithRequestId(RequestIdT&& value) {
