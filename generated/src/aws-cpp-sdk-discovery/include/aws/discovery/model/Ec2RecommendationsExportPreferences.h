...
class Ec2RecommendationsExportPreferences {
 public:
  ...
  inline Ec2RecommendationsExportPreferences& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCpuPerformanceMetricBasis(CpuPerformanceMetricBasisT&& value) {
    ...
    m_cpuPerformanceMetricBasis = std::forward<CpuPerformanceMetricBasisT>(value);
  }
  template <typename CpuPerformanceMetricBasisT = UsageMetricBasis>
  Ec2RecommendationsExportPreferences& WithCpuPerformanceMetricBasis(CpuPerformanceMetricBasisT&& value) {
    SetCpuPerformanceMetricBasis(std::forward<CpuPerformanceMetricBasisT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRamPerformanceMetricBasis(RamPerformanceMetricBasisT&& value) {
    ...
    m_ramPerformanceMetricBasis = std::forward<RamPerformanceMetricBasisT>(value);
  }
  template <typename RamPerformanceMetricBasisT = UsageMetricBasis>
  Ec2RecommendationsExportPreferences& WithRamPerformanceMetricBasis(RamPerformanceMetricBasisT&& value) {
    SetRamPerformanceMetricBasis(std::forward<RamPerformanceMetricBasisT>(value));
    return *this;
  }
  ///@}
  ...
  inline Ec2RecommendationsExportPreferences& WithTenancy(Tenancy value) {
    SetTenancy(value);
    return *this;
  }
  ///@}
  ...
  void SetPreferredRegion(PreferredRegionT&& value) {
    ...
    m_preferredRegion = std::forward<PreferredRegionT>(value);
  }
  template <typename PreferredRegionT = Aws::String>
  Ec2RecommendationsExportPreferences& WithPreferredRegion(PreferredRegionT&& value) {
    SetPreferredRegion(std::forward<PreferredRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedInstanceOptions(ReservedInstanceOptionsT&& value) {
    ...
    m_reservedInstanceOptions = std::forward<ReservedInstanceOptionsT>(value);
  }
  template <typename ReservedInstanceOptionsT = ReservedInstanceOptions>
  Ec2RecommendationsExportPreferences& WithReservedInstanceOptions(ReservedInstanceOptionsT&& value) {
    SetReservedInstanceOptions(std::forward<ReservedInstanceOptionsT>(value));
    return *this;
  }
  ///@}
 private:
