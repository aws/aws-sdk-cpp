...
class ListServerNeighborsRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  template <typename ConfigurationIdT = Aws::String>
  ListServerNeighborsRequest& WithConfigurationId(ConfigurationIdT&& value) {
  ...
  inline void SetPortInformationNeeded(bool value) {
    m_portInformationNeededHasBeenSet = true;
    m_portInformationNeeded = value;
  }
  inline ListServerNeighborsRequest& WithPortInformationNeeded(bool value) {
    SetPortInformationNeeded(value);
    return *this;
  }
  ///@}
  ...
  void SetNeighborConfigurationIds(NeighborConfigurationIdsT&& value) {
    m_neighborConfigurationIdsHasBeenSet = true;
    m_neighborConfigurationIds = std::forward<NeighborConfigurationIdsT>(value);
  }
  template <typename NeighborConfigurationIdsT = Aws::Vector<Aws::String>>
  ListServerNeighborsRequest& WithNeighborConfigurationIds(NeighborConfigurationIdsT&& value) {
    SetNeighborConfigurationIds(std::forward<NeighborConfigurationIdsT>(value));
    return *this;
  }
  template <typename NeighborConfigurationIdsT = Aws::String>
  ListServerNeighborsRequest& AddNeighborConfigurationIds(NeighborConfigurationIdsT&& value) {
    m_neighborConfigurationIdsHasBeenSet = true;
    m_neighborConfigurationIds.emplace_back(std::forward<NeighborConfigurationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListServerNeighborsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServerNeighborsRequest& WithNextToken(NextTokenT&& value) {
