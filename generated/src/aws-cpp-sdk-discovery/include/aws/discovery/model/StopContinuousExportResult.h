...
class StopContinuousExportResult {
 public:
  ...
  AWS_APPLICATIONDISCOVERYSERVICE_API StopContinuousExportResult& operator=(
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  StopContinuousExportResult& WithStartTime(StartTimeT&& value) {
  ...
  template <typename StopTimeT = Aws::Utils::DateTime>
  StopContinuousExportResult& WithStopTime(StopTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopContinuousExportResult& WithRequestId(RequestIdT&& value) {
