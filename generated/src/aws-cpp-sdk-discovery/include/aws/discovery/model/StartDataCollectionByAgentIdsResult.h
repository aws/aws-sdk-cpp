...
class StartDataCollectionByAgentIdsResult {
 public:
  ...
  AWS_APPLICATIONDISCOVERYSERVICE_API StartDataCollectionByAgentIdsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AgentsConfigurationStatusT = Aws::Vector<AgentConfigurationStatus>>
  StartDataCollectionByAgentIdsResult& WithAgentsConfigurationStatus(AgentsConfigurationStatusT&& value) {
  ...
  StartDataCollectionByAgentIdsResult& AddAgentsConfigurationStatus(AgentsConfigurationStatusT&& value) {
    m_agentsConfigurationStatusHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  StartDataCollectionByAgentIdsResult& WithRequestId(RequestIdT&& value) {
