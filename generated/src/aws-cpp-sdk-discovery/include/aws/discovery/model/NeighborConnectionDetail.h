...
class NeighborConnectionDetail {
 public:
  ...
  void SetDestinationServerId(DestinationServerIdT&& value) {
    ...
    m_destinationServerId = std::forward<DestinationServerIdT>(value);
  }
  template <typename DestinationServerIdT = Aws::String>
  NeighborConnectionDetail& WithDestinationServerId(DestinationServerIdT&& value) {
    SetDestinationServerId(std::forward<DestinationServerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline NeighborConnectionDetail& WithDestinationPort(int value) {
  ...
  inline void SetConnectionsCount(long long value) {
    m_connectionsCountHasBeenSet = true;
    m_connectionsCount = value;
  }
  inline NeighborConnectionDetail& WithConnectionsCount(long long value) {
    SetConnectionsCount(value);
    return *this;
  }
  ///@}
 private:
