...
class CustomerConnectorInfo {
 public:
  ...
  inline void SetActiveConnectors(int value) {
    m_activeConnectorsHasBeenSet = true;
    m_activeConnectors = value;
  }
  inline CustomerConnectorInfo& WithActiveConnectors(int value) {
    SetActiveConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthyConnectors(int value) {
    m_healthyConnectorsHasBeenSet = true;
    m_healthyConnectors = value;
  }
  inline CustomerConnectorInfo& WithHealthyConnectors(int value) {
    SetHealthyConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBlackListedConnectors(int value) {
    m_blackListedConnectorsHasBeenSet = true;
    m_blackListedConnectors = value;
  }
  inline CustomerConnectorInfo& WithBlackListedConnectors(int value) {
    SetBlackListedConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShutdownConnectors(int value) {
    m_shutdownConnectorsHasBeenSet = true;
    m_shutdownConnectors = value;
  }
  inline CustomerConnectorInfo& WithShutdownConnectors(int value) {
    SetShutdownConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnhealthyConnectors(int value) {
    m_unhealthyConnectorsHasBeenSet = true;
    m_unhealthyConnectors = value;
  }
  inline CustomerConnectorInfo& WithUnhealthyConnectors(int value) {
    SetUnhealthyConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalConnectors(int value) {
    m_totalConnectorsHasBeenSet = true;
    m_totalConnectors = value;
  }
  inline CustomerConnectorInfo& WithTotalConnectors(int value) {
    SetTotalConnectors(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnknownConnectors(int value) {
    m_unknownConnectorsHasBeenSet = true;
    m_unknownConnectors = value;
  }
  inline CustomerConnectorInfo& WithUnknownConnectors(int value) {
    SetUnknownConnectors(value);
    return *this;
  }
  ///@}
 private:
