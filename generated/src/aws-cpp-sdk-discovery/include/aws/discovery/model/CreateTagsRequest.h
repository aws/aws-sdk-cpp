...
class CreateTagsRequest : public ApplicationDiscoveryServiceRequest {
 public:
  ...
  template <typename ConfigurationIdsT = Aws::Vector<Aws::String>>
  CreateTagsRequest& WithConfigurationIds(ConfigurationIdsT&& value) {
    SetConfigurationIds(std::forward<ConfigurationIdsT>(value));
    return *this;
  }
  template <typename ConfigurationIdsT = Aws::String>
  CreateTagsRequest& AddConfigurationIds(ConfigurationIdsT&& value) {
    m_configurationIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateTagsRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateTagsRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
