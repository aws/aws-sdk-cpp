...
class ExportInfo {
 public:
  ...
  inline ExportInfo& WithExportStatus(ExportStatus value) {
  ...
  void SetConfigurationsDownloadUrl(ConfigurationsDownloadUrlT&& value) {
    ...
    m_configurationsDownloadUrl = std::forward<ConfigurationsDownloadUrlT>(value);
  }
  template <typename ConfigurationsDownloadUrlT = Aws::String>
  ExportInfo& WithConfigurationsDownloadUrl(ConfigurationsDownloadUrlT&& value) {
    SetConfigurationsDownloadUrl(std::forward<ConfigurationsDownloadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportRequestTime(ExportRequestTimeT&& value) {
    ...
    m_exportRequestTime = std::forward<ExportRequestTimeT>(value);
  }
  template <typename ExportRequestTimeT = Aws::Utils::DateTime>
  ExportInfo& WithExportRequestTime(ExportRequestTimeT&& value) {
    SetExportRequestTime(std::forward<ExportRequestTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ExportInfo& WithIsTruncated(bool value) {
  ...
  void SetRequestedStartTime(RequestedStartTimeT&& value) {
    ...
    m_requestedStartTime = std::forward<RequestedStartTimeT>(value);
  }
  template <typename RequestedStartTimeT = Aws::Utils::DateTime>
  ExportInfo& WithRequestedStartTime(RequestedStartTimeT&& value) {
    SetRequestedStartTime(std::forward<RequestedStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestedEndTime(RequestedEndTimeT&& value) {
    ...
    m_requestedEndTime = std::forward<RequestedEndTimeT>(value);
  }
  template <typename RequestedEndTimeT = Aws::Utils::DateTime>
  ExportInfo& WithRequestedEndTime(RequestedEndTimeT&& value) {
    SetRequestedEndTime(std::forward<RequestedEndTimeT>(value));
    return *this;
  }
  ///@}
 private:
