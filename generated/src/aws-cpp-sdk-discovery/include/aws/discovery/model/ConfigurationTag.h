...
class ConfigurationTag {
 public:
  ...
  inline void SetConfigurationType(ConfigurationItemType value) {
    m_configurationTypeHasBeenSet = true;
    m_configurationType = value;
  }
  inline ConfigurationTag& WithConfigurationType(ConfigurationItemType value) {
  ...
  template <typename ConfigurationIdT = Aws::String>
  ConfigurationTag& WithConfigurationId(ConfigurationIdT&& value) {
  ...
  template <typename KeyT = Aws::String>
  ConfigurationTag& WithKey(KeyT&& value) {
  ...
  template <typename ValueT = Aws::String>
  ConfigurationTag& WithValue(ValueT&& value) {
  ...
  void SetTimeOfCreation(TimeOfCreationT&& value) {
    m_timeOfCreationHasBeenSet = true;
    m_timeOfCreation = std::forward<TimeOfCreationT>(value);
  }
  template <typename TimeOfCreationT = Aws::Utils::DateTime>
  ConfigurationTag& WithTimeOfCreation(TimeOfCreationT&& value) {
    SetTimeOfCreation(std::forward<TimeOfCreationT>(value));
    return *this;
  }
  ///@}
 private:
