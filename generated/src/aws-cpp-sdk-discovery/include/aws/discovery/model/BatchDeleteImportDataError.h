...
class BatchDeleteImportDataError {
 public:
  ...
  template <typename ImportTaskIdT = Aws::String>
  BatchDeleteImportDataError& WithImportTaskId(ImportTaskIdT&& value) {
  ...
  inline void SetErrorCode(BatchDeleteImportDataErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline BatchDeleteImportDataError& WithErrorCode(BatchDeleteImportDataErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorDescriptionT = Aws::String>
  BatchDeleteImportDataError& WithErrorDescription(ErrorDescriptionT&& value) {
