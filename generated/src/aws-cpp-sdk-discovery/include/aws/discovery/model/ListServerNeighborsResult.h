...
class ListServerNeighborsResult {
 public:
  ...
  AWS_APPLICATIONDISCOVERYSERVICE_API ListServerNeighborsResult& operator=(
  ...
  void SetNeighbors(NeighborsT&& value) {
    m_neighborsHasBeenSet = true;
    m_neighbors = std::forward<NeighborsT>(value);
  }
  template <typename NeighborsT = Aws::Vector<NeighborConnectionDetail>>
  ListServerNeighborsResult& WithNeighbors(NeighborsT&& value) {
    SetNeighbors(std::forward<NeighborsT>(value));
    return *this;
  }
  template <typename NeighborsT = NeighborConnectionDetail>
  ListServerNeighborsResult& AddNeighbors(NeighborsT&& value) {
    m_neighborsHasBeenSet = true;
    m_neighbors.emplace_back(std::forward<NeighborsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServerNeighborsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetKnownDependencyCount(long long value) {
    m_knownDependencyCountHasBeenSet = true;
    m_knownDependencyCount = value;
  }
  inline ListServerNeighborsResult& WithKnownDependencyCount(long long value) {
    SetKnownDependencyCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListServerNeighborsResult& WithRequestId(RequestIdT&& value) {
