...
namespace ApplicationDiscoveryService
{
   ...
   */
  class AWS_APPLICATIONDISCOVERYSERVICE_API ApplicationDiscoveryServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<ApplicationDiscoveryServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::ApplicationDiscoveryService::SERVICE_NAME,
