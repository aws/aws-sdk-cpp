 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-microvms-2025-09-09/ResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class ResourceNotFoundException {
 public:
  AWS_LAMBDAMICROVMS_API ResourceNotFoundException() = default;
  AWS_LAMBDAMICROVMS_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAMBDAMICROVMS_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
