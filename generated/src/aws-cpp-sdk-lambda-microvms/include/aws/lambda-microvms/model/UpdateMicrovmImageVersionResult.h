...
namespace Model {
class UpdateMicrovmImageVersionResult {
 public:
  AWS_LAMBDAMICROVMS_API UpdateMicrovmImageVersionResult() = default;
  AWS_LAMBDAMICROVMS_API UpdateMicrovmImageVersionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LAMBDAMICROVMS_API UpdateMicrovmImageVersionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename BaseImageArnT = Aws::String>
  UpdateMicrovmImageVersionResult& WithBaseImageArn(BaseImageArnT&& value) {
  ...
  template <typename BaseImageVersionT = Aws::String>
  UpdateMicrovmImageVersionResult& WithBaseImageVersion(BaseImageVersionT&& value) {
  ...
  template <typename BuildRoleArnT = Aws::String>
  UpdateMicrovmImageVersionResult& WithBuildRoleArn(BuildRoleArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateMicrovmImageVersionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CodeArtifactT = CodeArtifact>
  UpdateMicrovmImageVersionResult& WithCodeArtifact(CodeArtifactT&& value) {
  ...
  template <typename LoggingT = Logging>
  UpdateMicrovmImageVersionResult& WithLogging(LoggingT&& value) {
  ...
  template <typename EgressNetworkConnectorsT = Aws::Vector<Aws::String>>
  UpdateMicrovmImageVersionResult& WithEgressNetworkConnectors(EgressNetworkConnectorsT&& value) {
  ...
  UpdateMicrovmImageVersionResult& AddEgressNetworkConnectors(EgressNetworkConnectorsT&& value) {
    m_egressNetworkConnectorsHasBeenSet = true;
  ...
  template <typename CpuConfigurationsT = Aws::Vector<CpuConfiguration>>
  UpdateMicrovmImageVersionResult& WithCpuConfigurations(CpuConfigurationsT&& value) {
    SetCpuConfigurations(std::forward<CpuConfigurationsT>(value));
    return *this;
  }
  template <typename CpuConfigurationsT = CpuConfiguration>
  UpdateMicrovmImageVersionResult& AddCpuConfigurations(CpuConfigurationsT&& value) {
    m_cpuConfigurationsHasBeenSet = true;
  ...
  template <typename ResourcesT = Aws::Vector<Resources>>
  UpdateMicrovmImageVersionResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Resources>
  UpdateMicrovmImageVersionResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename AdditionalOsCapabilitiesT = Aws::Vector<Capability>>
  UpdateMicrovmImageVersionResult& WithAdditionalOsCapabilities(AdditionalOsCapabilitiesT&& value) {
    SetAdditionalOsCapabilities(std::forward<AdditionalOsCapabilitiesT>(value));
    return *this;
  }
  inline UpdateMicrovmImageVersionResult& AddAdditionalOsCapabilities(Capability value) {
    m_additionalOsCapabilitiesHasBeenSet = true;
  ...
  template <typename HooksT = Hooks>
  UpdateMicrovmImageVersionResult& WithHooks(HooksT&& value) {
  ...
  template <typename EnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  UpdateMicrovmImageVersionResult& WithEnvironmentVariables(EnvironmentVariablesT&& value) {
  ...
  UpdateMicrovmImageVersionResult& AddEnvironmentVariables(EnvironmentVariablesKeyT&& key, EnvironmentVariablesValueT&& value) {
    m_environmentVariablesHasBeenSet = true;
  ...
  template <typename ImageArnT = Aws::String>
  UpdateMicrovmImageVersionResult& WithImageArn(ImageArnT&& value) {
  ...
  template <typename ImageVersionT = Aws::String>
  UpdateMicrovmImageVersionResult& WithImageVersion(ImageVersionT&& value) {
  ...
  inline UpdateMicrovmImageVersionResult& WithState(MicrovmImageVersionState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMicrovmImageVersionResult& WithStatus(MicrovmImageVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateMicrovmImageVersionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateMicrovmImageVersionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename StateReasonT = Aws::String>
  UpdateMicrovmImageVersionResult& WithStateReason(StateReasonT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateMicrovmImageVersionResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  UpdateMicrovmImageVersionResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateMicrovmImageVersionResult& WithRequestId(RequestIdT&& value) {
