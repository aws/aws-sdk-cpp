...
namespace Model {
class GetMicrovmImageVersionResult {
 public:
  ...
  inline GetMicrovmImageVersionResult& AddAdditionalOsCapabilities(Capability value) {
    m_additionalOsCapabilitiesHasBeenSet = true;
  ...
  template <typename HooksT = Hooks>
  GetMicrovmImageVersionResult& WithHooks(HooksT&& value) {
  ...
  inline GetMicrovmImageVersionResult& WithState(MicrovmImageVersionState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline GetMicrovmImageVersionResult& WithStatus(MicrovmImageVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetMicrovmImageVersionResult& WithTags(TagsT&& value) {
