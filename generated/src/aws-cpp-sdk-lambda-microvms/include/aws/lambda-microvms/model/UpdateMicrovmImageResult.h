...
namespace Model {
class UpdateMicrovmImageResult {
 public:
  ...
  inline UpdateMicrovmImageResult& WithState(MicrovmImageState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMicrovmImageResult& AddAdditionalOsCapabilities(Capability value) {
    m_additionalOsCapabilitiesHasBeenSet = true;
