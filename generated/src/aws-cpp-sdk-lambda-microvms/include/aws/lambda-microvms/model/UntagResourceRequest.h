...
/**
 */
class UntagResourceRequest : public LambdaMicrovmsRequest {
 public:
  AWS_LAMBDAMICROVMS_API UntagResourceRequest() = default;
  ...
  template <typename ResourceT = Aws::String>
  UntagResourceRequest& WithResource(ResourceT&& value) {
