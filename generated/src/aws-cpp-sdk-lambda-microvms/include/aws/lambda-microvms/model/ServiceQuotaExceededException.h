...
/**
 * <p>You have exceeded a service quota for Lambda MicroVMs.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-microvms-2025-09-09/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_LAMBDAMICROVMS_API ServiceQuotaExceededException() = default;
  AWS_LAMBDAMICROVMS_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAMBDAMICROVMS_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);
