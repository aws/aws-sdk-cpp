...
/**
 * <p>The request throughput limit was exceeded. Retry the request
 * later.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-microvms-2025-09-09/TooManyRequestsException">AWS
 * API Reference</a></p>
 */
