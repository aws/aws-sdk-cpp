 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/lambda-microvms-2025-09-09/ConflictException">AWS
 * API Reference</a></p>
 */
class ConflictException {
 public:
  AWS_LAMBDAMICROVMS_API ConflictException() = default;
  AWS_LAMBDAMICROVMS_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
  AWS_LAMBDAMICROVMS_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
