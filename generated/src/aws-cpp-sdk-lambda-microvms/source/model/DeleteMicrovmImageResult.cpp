...
DeleteMicrovmImageResult::DeleteMicrovmImageResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteMicrovmImageResult& DeleteMicrovmImageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
