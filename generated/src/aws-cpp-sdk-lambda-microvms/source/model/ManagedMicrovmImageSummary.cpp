...
ManagedMicrovmImageSummary::ManagedMicrovmImageSummary(JsonView jsonValue) { *this = jsonValue; }

ManagedMicrovmImageSummary& ManagedMicrovmImageSummary::operator=(JsonView jsonValue) {
...
JsonValue ManagedMicrovmImageSummary::Jsonize() const {
  JsonValue payload;
