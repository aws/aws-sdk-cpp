...
CreateMicrovmShellAuthTokenResult::CreateMicrovmShellAuthTokenResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateMicrovmShellAuthTokenResult& CreateMicrovmShellAuthTokenResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
