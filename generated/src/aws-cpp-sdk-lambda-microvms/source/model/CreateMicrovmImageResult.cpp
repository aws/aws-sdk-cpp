...
CreateMicrovmImageResult::CreateMicrovmImageResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateMicrovmImageResult& CreateMicrovmImageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
