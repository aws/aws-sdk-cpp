...
GetMicrovmResult::GetMicrovmResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetMicrovmResult& GetMicrovmResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
