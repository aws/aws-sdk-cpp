...
GetMicrovmImageVersionResult::GetMicrovmImageVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetMicrovmImageVersionResult& GetMicrovmImageVersionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
