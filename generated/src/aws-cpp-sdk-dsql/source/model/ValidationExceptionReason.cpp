  ...
  namespace DSQL
  {
    namespace Model
    {
      namespace ValidationExceptionReasonMapper
      {
        ...
        static const int deletionProtectionEnabled_HASH = HashingUtils::HashString("deletionProtectionEnabled");
        ...
        ValidationExceptionReason GetValidationExceptionReasonForName(const Aws::String& name)
        {
          ...
          else if (hashCode == deletionProtectionEnabled_HASH)
          {
            return ValidationExceptionReason::deletionProtectionEnabled;
          }
        ...
        Aws::String GetNameForValidationExceptionReason(ValidationExceptionReason enumValue)
        {
          ...
          case ValidationExceptionReason::deletionProtectionEnabled:
