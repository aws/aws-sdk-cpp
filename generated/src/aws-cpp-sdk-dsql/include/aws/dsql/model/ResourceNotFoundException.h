...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/dsql-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_DSQL_API ResourceNotFoundException() = default;
    AWS_DSQL_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DSQL_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
