...
namespace Model
{
  ...
  {
  public:
    AWS_DSQL_API PutClusterPolicyResult() = default;
    AWS_DSQL_API PutClusterPolicyResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DSQL_API PutClusterPolicyResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename PolicyVersionT = Aws::String>
    PutClusterPolicyResult& WithPolicyVersion(PolicyVersionT&& value) { SetPolicyVersion(std::forward<PolicyVersionT>(value)); return *this;}
    ///@}
