...
namespace Model
{
  ...
  {
  public:
    AWS_DSQL_API ValidationException() = default;
    AWS_DSQL_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DSQL_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
