...
class GetClusterResult {
 public:
  ...
  inline GetClusterResult& WithStatus(ClusterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetClusterResult& WithDeletionProtectionEnabled(bool value) {
  ...
  void SetEncryptionDetails(EncryptionDetailsT&& value) {
    ...
    m_encryptionDetails = std::forward<EncryptionDetailsT>(value);
  }
  template <typename EncryptionDetailsT = EncryptionDetails>
  GetClusterResult& WithEncryptionDetails(EncryptionDetailsT&& value) {
    SetEncryptionDetails(std::forward<EncryptionDetailsT>(value));
    return *this;
  }
  ///@}
