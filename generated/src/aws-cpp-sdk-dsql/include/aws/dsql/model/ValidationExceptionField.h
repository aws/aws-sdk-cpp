...
namespace Model
{
  ...
  {
  public:
    AWS_DSQL_API ValidationExceptionField() = default;
    AWS_DSQL_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_DSQL_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
