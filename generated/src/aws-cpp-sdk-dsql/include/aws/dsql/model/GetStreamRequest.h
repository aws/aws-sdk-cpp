...
/**
 */
class GetStreamRequest : public DSQLRequest {
 public:
  AWS_DSQL_API GetStreamRequest() = default;
  ...
  template <typename ClusterIdentifierT = Aws::String>
  GetStreamRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename StreamIdentifierT = Aws::String>
  GetStreamRequest& WithStreamIdentifier(StreamIdentifierT&& value) {
