...
class UpdateClusterRequest : public DSQLRequest {
 public:
  ...
  inline UpdateClusterRequest& WithDeletionProtectionEnabled(bool value) {
   ...
   * create a default key for you.</p> <p>To switch to the key owned by Amazon Web
   * Services, specify the reserved value <code>AWS_OWNED_KMS_KEY</code>.</p>
   */
