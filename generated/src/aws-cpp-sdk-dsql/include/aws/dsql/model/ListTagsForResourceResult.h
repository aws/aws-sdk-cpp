...
namespace Model
{
  ...
  {
  public:
    AWS_DSQL_API ListTagsForResourceResult() = default;
    AWS_DSQL_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DSQL_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
