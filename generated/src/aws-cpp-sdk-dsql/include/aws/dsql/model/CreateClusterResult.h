...
class CreateClusterResult {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  CreateClusterResult& WithIdentifier(IdentifierT&& value) {
  ...
  inline CreateClusterResult& WithStatus(ClusterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CreateClusterResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename MultiRegionPropertiesT = MultiRegionProperties>
  CreateClusterResult& WithMultiRegionProperties(MultiRegionPropertiesT&& value) {
  ...
  template <typename EncryptionDetailsT = EncryptionDetails>
  CreateClusterResult& WithEncryptionDetails(EncryptionDetailsT&& value) {
  ...
  inline CreateClusterResult& WithDeletionProtectionEnabled(bool value) {
