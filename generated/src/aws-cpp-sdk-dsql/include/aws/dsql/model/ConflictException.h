...
namespace Model
{
  ...
  {
  public:
    AWS_DSQL_API ConflictException() = default;
    AWS_DSQL_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_DSQL_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
