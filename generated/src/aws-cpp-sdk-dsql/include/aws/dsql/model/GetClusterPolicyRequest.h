...
namespace Model
{
  ...
  /**
   */
  class GetClusterPolicyRequest : public DSQLRequest
  {
  public:
    AWS_DSQL_API GetClusterPolicyRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    GetClusterPolicyRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
