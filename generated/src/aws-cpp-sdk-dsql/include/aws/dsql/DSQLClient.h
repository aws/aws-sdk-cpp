...
class AWS_DSQL_API DSQLClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DSQLClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DSQLEndpointProviderBase> endpointProvider = nullptr,
   ...
   */
  template <typename CreateClusterRequestT = Model::CreateClusterRequest>
  void CreateClusterAsync(const CreateClusterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const CreateClusterRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteClusterPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClusterPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteClusterPolicyRequestT = Model::DeleteClusterPolicyRequest>
  ...
  /**
   * An Async wrapper for GetCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetClusterRequestT = Model::GetClusterRequest>
  void GetClusterAsync(const GetClusterRequestT& request, const GetClusterResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetClusterPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClusterPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetClusterPolicyRequestT = Model::GetClusterPolicyRequest>
  void GetClusterPolicyAsync(const GetClusterPolicyRequestT& request, const GetClusterPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVpcEndpointServiceName that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetVpcEndpointServiceNameRequestT = Model::GetVpcEndpointServiceNameRequest>
  Model::GetVpcEndpointServiceNameOutcomeCallable GetVpcEndpointServiceNameCallable(
      const GetVpcEndpointServiceNameRequestT& request) const {
    return SubmitCallable(&DSQLClient::GetVpcEndpointServiceName, request);
  }

  /**
   * An Async wrapper for GetVpcEndpointServiceName that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetVpcEndpointServiceNameRequestT = Model::GetVpcEndpointServiceNameRequest>
  void GetVpcEndpointServiceNameAsync(const GetVpcEndpointServiceNameRequestT& request,
                                      const GetVpcEndpointServiceNameResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutClusterPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutClusterPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutClusterPolicyRequestT = Model::PutClusterPolicyRequest>
  void PutClusterPolicyAsync(const PutClusterPolicyRequestT& request, const PutClusterPolicyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  Aws::Utils::Outcome<String, DSQLError> GenerateDBConnectAuthToken(const Aws::String& hostname, const Aws::String& region,
  ...
  virtual std::shared_ptr<DSQLEndpointProviderBase>& accessEndpointProvider();
