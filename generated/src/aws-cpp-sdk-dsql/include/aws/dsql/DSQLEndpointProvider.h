 ...
 */
using DSQLEndpointProviderBase = EndpointProviderBase<DSQLClientConfiguration, DSQLBuiltInParameters, DSQLClientContextParameters>;

using DSQLDefaultEpProviderBase = DefaultEndpointProvider<DSQLClientConfiguration, DSQLBuiltInParameters, DSQLClientContextParameters>;
