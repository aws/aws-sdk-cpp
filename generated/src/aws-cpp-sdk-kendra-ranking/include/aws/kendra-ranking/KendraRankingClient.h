...
namespace KendraRanking
{
   ...
   */
  class AWS_KENDRARANKING_API KendraRankingClient : Aws::Client::ClientWithAsyncTemplateMethods<KendraRankingClient>,
    smithy::client::AwsSmithyClientT<Aws::KendraRanking::SERVICE_NAME,
