...
#ifdef AWS_KENDRARANKING_EXPORTS
#define AWS_KENDRARANKING_API __declspec(dllexport)
#else
...
#define AWS_KENDRARANKING_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_KENDRARANKING_API
#define AWS_KENDRARANKING_EXTERN extern
#if __GNUC__ >= 4
#define AWS_KENDRARANKING_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_KENDRARANKING_LOCAL
#endif
