...
class Document {
 public:
  ...
  void SetTokenizedTitle(TokenizedTitleT&& value) {
    ...
    m_tokenizedTitle = std::forward<TokenizedTitleT>(value);
  }
  template <typename TokenizedTitleT = Aws::Vector<Aws::String>>
  Document& WithTokenizedTitle(TokenizedTitleT&& value) {
    SetTokenizedTitle(std::forward<TokenizedTitleT>(value));
    return *this;
  }
  template <typename TokenizedTitleT = Aws::String>
  Document& AddTokenizedTitle(TokenizedTitleT&& value) {
    m_tokenizedTitleHasBeenSet = true;
    m_tokenizedTitle.emplace_back(std::forward<TokenizedTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenizedBody(TokenizedBodyT&& value) {
    ...
    m_tokenizedBody = std::forward<TokenizedBodyT>(value);
  }
  template <typename TokenizedBodyT = Aws::Vector<Aws::String>>
  Document& WithTokenizedBody(TokenizedBodyT&& value) {
    SetTokenizedBody(std::forward<TokenizedBodyT>(value));
    return *this;
  }
  template <typename TokenizedBodyT = Aws::String>
  Document& AddTokenizedBody(TokenizedBodyT&& value) {
    m_tokenizedBodyHasBeenSet = true;
    m_tokenizedBody.emplace_back(std::forward<TokenizedBodyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOriginalScore(double value) {
    m_originalScoreHasBeenSet = true;
    m_originalScore = value;
  }
  inline Document& WithOriginalScore(double value) {
    SetOriginalScore(value);
    return *this;
  }
  ///@}
 private:
