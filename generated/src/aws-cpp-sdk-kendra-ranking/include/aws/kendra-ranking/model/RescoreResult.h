...
class RescoreResult {
 public:
  ...
  AWS_KENDRARANKING_API RescoreResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_KENDRARANKING_API RescoreResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetRescoreId(RescoreIdT&& value) {
    m_rescoreIdHasBeenSet = true;
    m_rescoreId = std::forward<RescoreIdT>(value);
  }
  template <typename RescoreIdT = Aws::String>
  RescoreResult& WithRescoreId(RescoreIdT&& value) {
    SetRescoreId(std::forward<RescoreIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResultItemsT = Aws::Vector<RescoreResultItem>>
  RescoreResult& WithResultItems(ResultItemsT&& value) {
    SetResultItems(std::forward<ResultItemsT>(value));
    return *this;
  }
  template <typename ResultItemsT = RescoreResultItem>
  RescoreResult& AddResultItems(ResultItemsT&& value) {
    m_resultItemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RescoreResult& WithRequestId(RequestIdT&& value) {
