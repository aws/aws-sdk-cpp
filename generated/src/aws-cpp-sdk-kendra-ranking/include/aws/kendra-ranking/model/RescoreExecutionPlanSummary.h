...
class RescoreExecutionPlanSummary {
 public:
  ...
  AWS_KENDRARANKING_API RescoreExecutionPlanSummary(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_KENDRARANKING_API RescoreExecutionPlanSummary& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename NameT = Aws::String>
  RescoreExecutionPlanSummary& WithName(NameT&& value) {
  ...
  template <typename IdT = Aws::String>
  RescoreExecutionPlanSummary& WithId(IdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  RescoreExecutionPlanSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RescoreExecutionPlanSummary& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline void SetStatus(RescoreExecutionPlanStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RescoreExecutionPlanSummary& WithStatus(RescoreExecutionPlanStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
