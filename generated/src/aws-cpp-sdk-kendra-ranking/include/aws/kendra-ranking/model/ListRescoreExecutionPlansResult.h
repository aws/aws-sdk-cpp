...
class ListRescoreExecutionPlansResult {
 public:
  ...
  AWS_KENDRARANKING_API ListRescoreExecutionPlansResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_KENDRARANKING_API ListRescoreExecutionPlansResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename SummaryItemsT = Aws::Vector<RescoreExecutionPlanSummary>>
  ListRescoreExecutionPlansResult& WithSummaryItems(SummaryItemsT&& value) {
    SetSummaryItems(std::forward<SummaryItemsT>(value));
    return *this;
  }
  template <typename SummaryItemsT = RescoreExecutionPlanSummary>
  ListRescoreExecutionPlansResult& AddSummaryItems(SummaryItemsT&& value) {
    m_summaryItemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRescoreExecutionPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRescoreExecutionPlansResult& WithRequestId(RequestIdT&& value) {
