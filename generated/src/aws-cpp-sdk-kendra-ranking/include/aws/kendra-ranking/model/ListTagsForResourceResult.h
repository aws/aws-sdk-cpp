...
class ListTagsForResourceResult {
 public:
  AWS_KENDRARANKING_API ListTagsForResourceResult() = default;
  AWS_KENDRARANKING_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_KENDRARANKING_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
