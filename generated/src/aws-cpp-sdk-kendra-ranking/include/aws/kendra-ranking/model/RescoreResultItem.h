...
class RescoreResultItem {
 public:
  ...
  AWS_KENDRARANKING_API RescoreResultItem(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_KENDRARANKING_API RescoreResultItem& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename DocumentIdT = Aws::String>
  RescoreResultItem& WithDocumentId(DocumentIdT&& value) {
  ...
  inline RescoreResultItem& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
