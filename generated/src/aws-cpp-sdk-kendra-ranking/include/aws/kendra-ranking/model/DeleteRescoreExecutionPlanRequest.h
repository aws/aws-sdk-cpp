...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRARANKING_API DeleteRescoreExecutionPlanRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DeleteRescoreExecutionPlanRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
