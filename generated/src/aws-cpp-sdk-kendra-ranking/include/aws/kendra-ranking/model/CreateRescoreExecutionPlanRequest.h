...
class CreateRescoreExecutionPlanRequest : public KendraRankingRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateRescoreExecutionPlanRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateRescoreExecutionPlanRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename CapacityUnitsT = CapacityUnitsConfiguration>
  CreateRescoreExecutionPlanRequest& WithCapacityUnits(CapacityUnitsT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateRescoreExecutionPlanRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateRescoreExecutionPlanRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRescoreExecutionPlanRequest& WithClientToken(ClientTokenT&& value) {
