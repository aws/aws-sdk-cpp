...
namespace Model
{
  ...
  {
  public:
    AWS_KENDRARANKING_API DescribeRescoreExecutionPlanRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DescribeRescoreExecutionPlanRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
