...
class AWS_BCMRECOMMENDEDACTIONS_API BCMRecommendedActionsClient
 ...
 public:
   ...
   */
  BCMRecommendedActionsClient(const Aws::BCMRecommendedActions::BCMRecommendedActionsClientConfiguration& clientConfiguration =
                                  Aws::BCMRecommendedActions::BCMRecommendedActionsClientConfiguration(),
  ...
  BCMRecommendedActionsClient(const Aws::Auth::AWSCredentials& credentials,
                              std::shared_ptr<BCMRecommendedActionsEndpointProviderBase> endpointProvider = nullptr,
                              const Aws::BCMRecommendedActions::BCMRecommendedActionsClientConfiguration& clientConfiguration =
                                  Aws::BCMRecommendedActions::BCMRecommendedActionsClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  BCMRecommendedActionsClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
