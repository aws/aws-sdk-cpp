...
class ListRecommendedActionsResult {
 public:
  ...
  AWS_BCMRECOMMENDEDACTIONS_API ListRecommendedActionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_BCMRECOMMENDEDACTIONS_API ListRecommendedActionsResult& operator=(
