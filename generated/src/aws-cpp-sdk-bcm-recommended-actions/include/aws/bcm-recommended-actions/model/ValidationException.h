...
namespace Model
{
  ...
  public:
    ...
    AWS_BCMRECOMMENDEDACTIONS_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
    AWS_BCMRECOMMENDEDACTIONS_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
