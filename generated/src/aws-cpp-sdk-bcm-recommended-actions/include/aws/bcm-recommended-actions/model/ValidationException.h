 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/bcm-recommended-actions-2024-11-14/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_BCMRECOMMENDEDACTIONS_API ValidationException() = default;
  AWS_BCMRECOMMENDEDACTIONS_API ValidationException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMRECOMMENDEDACTIONS_API ValidationException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
