...
class ActionFilter {
 public:
  ...
  AWS_BCMRECOMMENDEDACTIONS_API ActionFilter(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_BCMRECOMMENDEDACTIONS_API ActionFilter& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetKey(FilterName value) {
    m_keyHasBeenSet = true;
    m_key = value;
  }
  inline ActionFilter& WithKey(FilterName value) {
    SetKey(value);
    return *this;
  }
  ///@}
  ...
  inline ActionFilter& WithMatchOption(MatchOption value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ActionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ActionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
