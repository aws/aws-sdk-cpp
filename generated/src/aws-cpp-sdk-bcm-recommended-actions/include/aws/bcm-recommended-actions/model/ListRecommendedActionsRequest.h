...
class ListRecommendedActionsRequest : public BCMRecommendedActionsRequest {
 public:
  ...
  template <typename FilterT = RequestFilter>
  ListRecommendedActionsRequest& WithFilter(FilterT&& value) {
  ...
  inline ListRecommendedActionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRecommendedActionsRequest& WithNextToken(NextTokenT&& value) {
