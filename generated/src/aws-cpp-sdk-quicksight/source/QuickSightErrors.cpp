...
template <>
AWS_QUICKSIGHT_API ConflictException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API ResourceExistsException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API LimitExceededException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::LIMIT_EXCEEDED);
  return LimitExceededException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API QuickSightUserNotFoundException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API IdentityTypeNotSupportedException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API InvalidParameterValueException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API InvalidNextTokenException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::INVALID_NEXT_TOKEN);
  return InvalidNextTokenException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API InternalFailureException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::INTERNAL_FAILURE);
  return InternalFailureException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API UnsupportedPricingPlanException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API DomainNotWhitelistedException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API ThrottlingException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API CustomerManagedKeyUnavailableException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API UnsupportedUserEditionException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API AccessDeniedException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::ACCESS_DENIED);
  return AccessDeniedException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API PreconditionNotMetException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API ResourceUnavailableException QuickSightError::GetModeledError() {
...
template <>
AWS_QUICKSIGHT_API InvalidRequestException QuickSightError::GetModeledError() {
  assert(this->GetErrorType() == QuickSightErrors::INVALID_REQUEST);
  return InvalidRequestException(this->GetJsonPayload().View());
}

template <>
AWS_QUICKSIGHT_API ConcurrentUpdatingException QuickSightError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QuickSightErrors::RESOURCE_UNAVAILABLE), RetryableType::RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(QuickSightErrors::CONCURRENT_UPDATING), RetryableType::RETRYABLE);
  }
