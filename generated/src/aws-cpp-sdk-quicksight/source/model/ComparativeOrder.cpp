...
ComparativeOrder::ComparativeOrder(JsonView jsonValue) { *this = jsonValue; }
...
ComparativeOrder& ComparativeOrder::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TreatUndefinedSpecifiedValues")) {
    m_treatUndefinedSpecifiedValues =
        UndefinedSpecifiedValueTypeMapper::GetUndefinedSpecifiedValueTypeForName(jsonValue.GetString("TreatUndefinedSpecifiedValues"));
...
JsonValue ComparativeOrder::Jsonize() const {
  ...
  if (m_treatUndefinedSpecifiedValuesHasBeenSet) {
    payload.WithString("TreatUndefinedSpecifiedValues",
                       UndefinedSpecifiedValueTypeMapper::GetNameForUndefinedSpecifiedValueType(m_treatUndefinedSpecifiedValues));
  }
