...
LineChartAggregatedFieldWells::LineChartAggregatedFieldWells(JsonView jsonValue) { *this = jsonValue; }

LineChartAggregatedFieldWells& LineChartAggregatedFieldWells::operator=(JsonView jsonValue) {
...
JsonValue LineChartAggregatedFieldWells::Jsonize() const {
  JsonValue payload;
