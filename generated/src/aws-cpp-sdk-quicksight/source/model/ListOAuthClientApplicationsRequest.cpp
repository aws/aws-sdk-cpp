...
Aws::String ListOAuthClientApplicationsRequest::SerializePayload() const { return {}; }

void ListOAuthClientApplicationsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
