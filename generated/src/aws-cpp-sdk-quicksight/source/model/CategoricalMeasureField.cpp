...
CategoricalMeasureField::CategoricalMeasureField(JsonView jsonValue) { *this = jsonValue; }
...
CategoricalMeasureField& CategoricalMeasureField::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AggregationFunction")) {
    m_aggregationFunction =
        CategoricalAggregationFunctionMapper::GetCategoricalAggregationFunctionForName(jsonValue.GetString("AggregationFunction"));
...
JsonValue CategoricalMeasureField::Jsonize() const {
  ...
  if (m_aggregationFunctionHasBeenSet) {
    payload.WithString("AggregationFunction",
                       CategoricalAggregationFunctionMapper::GetNameForCategoricalAggregationFunction(m_aggregationFunction));
  }
