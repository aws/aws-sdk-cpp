...
ReferenceLineLabelConfiguration::ReferenceLineLabelConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
ReferenceLineLabelConfiguration& ReferenceLineLabelConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("HorizontalPosition")) {
    m_horizontalPosition = ReferenceLineLabelHorizontalPositionMapper::GetReferenceLineLabelHorizontalPositionForName(
        jsonValue.GetString("HorizontalPosition"));
    m_horizontalPositionHasBeenSet = true;
  }
  if (jsonValue.ValueExists("VerticalPosition")) {
    m_verticalPosition =
        ReferenceLineLabelVerticalPositionMapper::GetReferenceLineLabelVerticalPositionForName(jsonValue.GetString("VerticalPosition"));
...
JsonValue ReferenceLineLabelConfiguration::Jsonize() const {
  ...
  if (m_horizontalPositionHasBeenSet) {
    payload.WithString("HorizontalPosition",
                       ReferenceLineLabelHorizontalPositionMapper::GetNameForReferenceLineLabelHorizontalPosition(m_horizontalPosition));
  }

  if (m_verticalPositionHasBeenSet) {
    payload.WithString("VerticalPosition",
                       ReferenceLineLabelVerticalPositionMapper::GetNameForReferenceLineLabelVerticalPosition(m_verticalPosition));
  }
