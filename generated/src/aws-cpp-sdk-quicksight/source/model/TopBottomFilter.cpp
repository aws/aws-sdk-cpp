...
TopBottomFilter::TopBottomFilter(JsonView jsonValue) { *this = jsonValue; }
...
TopBottomFilter& TopBottomFilter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AggregationSortConfigurations")) {
    ...
    for (unsigned aggregationSortConfigurationsIndex = 0;
         aggregationSortConfigurationsIndex < aggregationSortConfigurationsJsonList.GetLength(); ++aggregationSortConfigurationsIndex) {
...
JsonValue TopBottomFilter::Jsonize() const {
  ...
  if (m_aggregationSortConfigurationsHasBeenSet) {
    ...
    for (unsigned aggregationSortConfigurationsIndex = 0;
         aggregationSortConfigurationsIndex < aggregationSortConfigurationsJsonList.GetLength(); ++aggregationSortConfigurationsIndex) {
      aggregationSortConfigurationsJsonList[aggregationSortConfigurationsIndex].AsObject(
          m_aggregationSortConfigurations[aggregationSortConfigurationsIndex].Jsonize());
    }
