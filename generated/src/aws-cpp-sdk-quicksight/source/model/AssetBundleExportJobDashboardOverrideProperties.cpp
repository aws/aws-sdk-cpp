...
AssetBundleExportJobDashboardOverrideProperties& AssetBundleExportJobDashboardOverrideProperties::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("Properties"))
  {
    ...
    {
      m_properties.push_back(AssetBundleExportJobDashboardPropertyToOverrideMapper::GetAssetBundleExportJobDashboardPropertyToOverrideForName(propertiesJsonList[propertiesIndex].AsString()));
    }
...
JsonValue AssetBundleExportJobDashboardOverrideProperties::Jsonize() const
{
  JsonValue payload;
  ...
  if(m_propertiesHasBeenSet)
  {
   ...
   for(unsigned propertiesIndex = 0; propertiesIndex < propertiesJsonList.GetLength(); ++propertiesIndex)
   {
     propertiesJsonList[propertiesIndex].AsString(AssetBundleExportJobDashboardPropertyToOverrideMapper::GetNameForAssetBundleExportJobDashboardPropertyToOverride(m_properties[propertiesIndex]));
   }
