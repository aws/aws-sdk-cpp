...
GaugeChartVisual::GaugeChartVisual(JsonView jsonValue) { *this = jsonValue; }

GaugeChartVisual& GaugeChartVisual::operator=(JsonView jsonValue) {
...
JsonValue GaugeChartVisual::Jsonize() const {
  JsonValue payload;
