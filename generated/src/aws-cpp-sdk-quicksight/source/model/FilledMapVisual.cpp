...
FilledMapVisual::FilledMapVisual(JsonView jsonValue) { *this = jsonValue; }

FilledMapVisual& FilledMapVisual::operator=(JsonView jsonValue) {
...
JsonValue FilledMapVisual::Jsonize() const {
  JsonValue payload;
