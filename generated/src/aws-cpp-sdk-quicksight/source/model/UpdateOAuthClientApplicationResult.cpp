...
UpdateOAuthClientApplicationResult::UpdateOAuthClientApplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateOAuthClientApplicationResult& UpdateOAuthClientApplicationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
