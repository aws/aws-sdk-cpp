...
SnapshotAnonymousUserRedacted::SnapshotAnonymousUserRedacted(JsonView jsonValue) { *this = jsonValue; }
...
SnapshotAnonymousUserRedacted& SnapshotAnonymousUserRedacted::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("RowLevelPermissionTagKeys")) {
    ...
    for (unsigned rowLevelPermissionTagKeysIndex = 0; rowLevelPermissionTagKeysIndex < rowLevelPermissionTagKeysJsonList.GetLength();
         ++rowLevelPermissionTagKeysIndex) {
...
JsonValue SnapshotAnonymousUserRedacted::Jsonize() const {
  ...
  if (m_rowLevelPermissionTagKeysHasBeenSet) {
    ...
    for (unsigned rowLevelPermissionTagKeysIndex = 0; rowLevelPermissionTagKeysIndex < rowLevelPermissionTagKeysJsonList.GetLength();
         ++rowLevelPermissionTagKeysIndex) {
      rowLevelPermissionTagKeysJsonList[rowLevelPermissionTagKeysIndex].AsString(
          m_rowLevelPermissionTagKeys[rowLevelPermissionTagKeysIndex]);
    }
