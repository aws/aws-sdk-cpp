...
RadarChartVisual::RadarChartVisual(JsonView jsonValue) { *this = jsonValue; }

RadarChartVisual& RadarChartVisual::operator=(JsonView jsonValue) {
...
JsonValue RadarChartVisual::Jsonize() const {
  JsonValue payload;
