...
UpdateTopicPermissionsResult::UpdateTopicPermissionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateTopicPermissionsResult& UpdateTopicPermissionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
