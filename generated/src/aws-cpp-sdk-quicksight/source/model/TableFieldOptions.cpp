...
TableFieldOptions::TableFieldOptions(JsonView jsonValue) { *this = jsonValue; }
...
TableFieldOptions& TableFieldOptions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TransposedTableOptions")) {
    ...
    for (unsigned transposedTableOptionsIndex = 0; transposedTableOptionsIndex < transposedTableOptionsJsonList.GetLength();
         ++transposedTableOptionsIndex) {
