...
SankeyDiagramVisual::SankeyDiagramVisual(JsonView jsonValue) { *this = jsonValue; }

SankeyDiagramVisual& SankeyDiagramVisual::operator=(JsonView jsonValue) {
...
JsonValue SankeyDiagramVisual::Jsonize() const {
  JsonValue payload;
