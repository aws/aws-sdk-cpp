...
ExecutiveSummaryOption::ExecutiveSummaryOption(JsonView jsonValue) { *this = jsonValue; }

ExecutiveSummaryOption& ExecutiveSummaryOption::operator=(JsonView jsonValue) {
...
JsonValue ExecutiveSummaryOption::Jsonize() const {
  JsonValue payload;
