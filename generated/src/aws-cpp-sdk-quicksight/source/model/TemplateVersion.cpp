...
TemplateVersion::TemplateVersion(JsonView jsonValue) { *this = jsonValue; }
...
TemplateVersion& TemplateVersion::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DataSetConfigurations")) {
    ...
    for (unsigned dataSetConfigurationsIndex = 0; dataSetConfigurationsIndex < dataSetConfigurationsJsonList.GetLength();
         ++dataSetConfigurationsIndex) {
