...
ColumnGroupSchema::ColumnGroupSchema(JsonView jsonValue) { *this = jsonValue; }
...
ColumnGroupSchema& ColumnGroupSchema::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ColumnGroupColumnSchemaList")) {
    ...
    for (unsigned columnGroupColumnSchemaListIndex = 0; columnGroupColumnSchemaListIndex < columnGroupColumnSchemaListJsonList.GetLength();
         ++columnGroupColumnSchemaListIndex) {
...
JsonValue ColumnGroupSchema::Jsonize() const {
  ...
  if (m_columnGroupColumnSchemaListHasBeenSet) {
    ...
    for (unsigned columnGroupColumnSchemaListIndex = 0; columnGroupColumnSchemaListIndex < columnGroupColumnSchemaListJsonList.GetLength();
         ++columnGroupColumnSchemaListIndex) {
      columnGroupColumnSchemaListJsonList[columnGroupColumnSchemaListIndex].AsObject(
          m_columnGroupColumnSchemaList[columnGroupColumnSchemaListIndex].Jsonize());
    }
