...
ImageMenuOption::ImageMenuOption(JsonView jsonValue) { *this = jsonValue; }

ImageMenuOption& ImageMenuOption::operator=(JsonView jsonValue) {
...
JsonValue ImageMenuOption::Jsonize() const {
  JsonValue payload;
