...
NumericalAggregationFunction::NumericalAggregationFunction(JsonView jsonValue) { *this = jsonValue; }
...
NumericalAggregationFunction& NumericalAggregationFunction::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SimpleNumericalAggregation")) {
    m_simpleNumericalAggregation = SimpleNumericalAggregationFunctionMapper::GetSimpleNumericalAggregationFunctionForName(
        jsonValue.GetString("SimpleNumericalAggregation"));
...
JsonValue NumericalAggregationFunction::Jsonize() const {
  ...
  if (m_simpleNumericalAggregationHasBeenSet) {
    payload.WithString("SimpleNumericalAggregation", SimpleNumericalAggregationFunctionMapper::GetNameForSimpleNumericalAggregationFunction(
