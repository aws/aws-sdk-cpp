...
FilterListConfiguration::FilterListConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
FilterListConfiguration& FilterListConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SelectAllOptions")) {
    m_selectAllOptions =
        CategoryFilterSelectAllOptionsMapper::GetCategoryFilterSelectAllOptionsForName(jsonValue.GetString("SelectAllOptions"));
...
JsonValue FilterListConfiguration::Jsonize() const {
  ...
  if (m_selectAllOptionsHasBeenSet) {
    payload.WithString("SelectAllOptions",
                       CategoryFilterSelectAllOptionsMapper::GetNameForCategoryFilterSelectAllOptions(m_selectAllOptions));
  }
