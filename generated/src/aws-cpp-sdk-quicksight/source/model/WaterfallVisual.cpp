...
WaterfallVisual::WaterfallVisual(JsonView jsonValue) { *this = jsonValue; }

WaterfallVisual& WaterfallVisual::operator=(JsonView jsonValue) {
...
JsonValue WaterfallVisual::Jsonize() const {
  JsonValue payload;
