...
ComboChartDefaultSeriesSettings::ComboChartDefaultSeriesSettings(JsonView jsonValue) { *this = jsonValue; }

ComboChartDefaultSeriesSettings& ComboChartDefaultSeriesSettings::operator=(JsonView jsonValue) {
...
JsonValue ComboChartDefaultSeriesSettings::Jsonize() const {
  JsonValue payload;
