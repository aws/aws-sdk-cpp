...
CustomContentVisual::CustomContentVisual(JsonView jsonValue) { *this = jsonValue; }

CustomContentVisual& CustomContentVisual::operator=(JsonView jsonValue) {
...
JsonValue CustomContentVisual::Jsonize() const {
  JsonValue payload;
