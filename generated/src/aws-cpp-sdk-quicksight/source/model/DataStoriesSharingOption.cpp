...
DataStoriesSharingOption::DataStoriesSharingOption(JsonView jsonValue) { *this = jsonValue; }

DataStoriesSharingOption& DataStoriesSharingOption::operator=(JsonView jsonValue) {
...
JsonValue DataStoriesSharingOption::Jsonize() const {
  JsonValue payload;
