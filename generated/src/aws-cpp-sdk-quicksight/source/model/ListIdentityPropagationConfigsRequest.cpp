...
Aws::String ListIdentityPropagationConfigsRequest::SerializePayload() const { return {}; }

void ListIdentityPropagationConfigsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
