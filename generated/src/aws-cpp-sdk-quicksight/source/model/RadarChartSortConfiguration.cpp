...
RadarChartSortConfiguration::RadarChartSortConfiguration(JsonView jsonValue) { *this = jsonValue; }

RadarChartSortConfiguration& RadarChartSortConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RadarChartSortConfiguration::Jsonize() const {
  JsonValue payload;
