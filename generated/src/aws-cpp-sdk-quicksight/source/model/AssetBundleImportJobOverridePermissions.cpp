...
AssetBundleImportJobOverridePermissions::AssetBundleImportJobOverridePermissions(JsonView jsonValue) { *this = jsonValue; }

AssetBundleImportJobOverridePermissions& AssetBundleImportJobOverridePermissions::operator=(JsonView jsonValue) {
...
JsonValue AssetBundleImportJobOverridePermissions::Jsonize() const {
  JsonValue payload;
