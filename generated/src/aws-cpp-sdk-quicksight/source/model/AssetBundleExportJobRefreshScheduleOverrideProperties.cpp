...
AssetBundleExportJobRefreshScheduleOverrideProperties& AssetBundleExportJobRefreshScheduleOverrideProperties::operator=(
    JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Properties")) {
    ...
    for (unsigned propertiesIndex = 0; propertiesIndex < propertiesJsonList.GetLength(); ++propertiesIndex) {
      m_properties.push_back(
          AssetBundleExportJobRefreshSchedulePropertyToOverrideMapper::GetAssetBundleExportJobRefreshSchedulePropertyToOverrideForName(
              propertiesJsonList[propertiesIndex].AsString()));
    }
...
JsonValue AssetBundleExportJobRefreshScheduleOverrideProperties::Jsonize() const {
  JsonValue payload;
  ...
  if (m_propertiesHasBeenSet) {
    ...
    for (unsigned propertiesIndex = 0; propertiesIndex < propertiesJsonList.GetLength(); ++propertiesIndex) {
      propertiesJsonList[propertiesIndex].AsString(
          AssetBundleExportJobRefreshSchedulePropertyToOverrideMapper::GetNameForAssetBundleExportJobRefreshSchedulePropertyToOverride(
