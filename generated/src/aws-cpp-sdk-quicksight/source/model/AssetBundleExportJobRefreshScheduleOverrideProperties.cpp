...
AssetBundleExportJobRefreshScheduleOverrideProperties& AssetBundleExportJobRefreshScheduleOverrideProperties::operator =(JsonView jsonValue)
{
  ...
  if(jsonValue.ValueExists("Properties"))
  {
    ...
    {
      m_properties.push_back(AssetBundleExportJobRefreshSchedulePropertyToOverrideMapper::GetAssetBundleExportJobRefreshSchedulePropertyToOverrideForName(propertiesJsonList[propertiesIndex].AsString()));
    }
