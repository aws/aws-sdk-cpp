...
ComboChartVisual::ComboChartVisual(JsonView jsonValue) { *this = jsonValue; }

ComboChartVisual& ComboChartVisual::operator=(JsonView jsonValue) {
...
JsonValue ComboChartVisual::Jsonize() const {
  JsonValue payload;
