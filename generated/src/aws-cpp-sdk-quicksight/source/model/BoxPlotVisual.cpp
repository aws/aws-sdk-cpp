...
BoxPlotVisual::BoxPlotVisual(JsonView jsonValue) { *this = jsonValue; }

BoxPlotVisual& BoxPlotVisual::operator=(JsonView jsonValue) {
...
JsonValue BoxPlotVisual::Jsonize() const {
  JsonValue payload;
