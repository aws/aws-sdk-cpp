...
GridLayoutElementBorderStyle::GridLayoutElementBorderStyle(JsonView jsonValue) { *this = jsonValue; }

GridLayoutElementBorderStyle& GridLayoutElementBorderStyle::operator=(JsonView jsonValue) {
...
JsonValue GridLayoutElementBorderStyle::Jsonize() const {
  JsonValue payload;
