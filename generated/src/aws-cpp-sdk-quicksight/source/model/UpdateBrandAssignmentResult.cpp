...
UpdateBrandAssignmentResult::UpdateBrandAssignmentResult()
{
}

UpdateBrandAssignmentResult::UpdateBrandAssignmentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
