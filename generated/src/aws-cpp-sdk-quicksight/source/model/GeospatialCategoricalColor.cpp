...
GeospatialCategoricalColor::GeospatialCategoricalColor(JsonView jsonValue) { *this = jsonValue; }
...
GeospatialCategoricalColor& GeospatialCategoricalColor::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("CategoryDataColors")) {
    ...
    for (unsigned categoryDataColorsIndex = 0; categoryDataColorsIndex < categoryDataColorsJsonList.GetLength();
         ++categoryDataColorsIndex) {
