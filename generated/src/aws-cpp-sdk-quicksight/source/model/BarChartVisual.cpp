...
BarChartVisual::BarChartVisual(JsonView jsonValue) { *this = jsonValue; }

BarChartVisual& BarChartVisual::operator=(JsonView jsonValue) {
...
JsonValue BarChartVisual::Jsonize() const {
  JsonValue payload;
