...
DataFieldBarSeriesItem::DataFieldBarSeriesItem(JsonView jsonValue) { *this = jsonValue; }

DataFieldBarSeriesItem& DataFieldBarSeriesItem::operator=(JsonView jsonValue) {
...
JsonValue DataFieldBarSeriesItem::Jsonize() const {
  JsonValue payload;
