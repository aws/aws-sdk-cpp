...
VPCConnectionSummary::VPCConnectionSummary(JsonView jsonValue) { *this = jsonValue; }
...
VPCConnectionSummary& VPCConnectionSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AvailabilityStatus")) {
    m_availabilityStatus =
        VPCConnectionAvailabilityStatusMapper::GetVPCConnectionAvailabilityStatusForName(jsonValue.GetString("AvailabilityStatus"));
...
JsonValue VPCConnectionSummary::Jsonize() const {
  ...
  if (m_availabilityStatusHasBeenSet) {
    payload.WithString("AvailabilityStatus",
                       VPCConnectionAvailabilityStatusMapper::GetNameForVPCConnectionAvailabilityStatus(m_availabilityStatus));
  }
