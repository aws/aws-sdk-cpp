...
SemanticType::SemanticType(JsonView jsonValue) { *this = jsonValue; }
...
SemanticType& SemanticType::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TruthyCellValueSynonyms")) {
    ...
    for (unsigned truthyCellValueSynonymsIndex = 0; truthyCellValueSynonymsIndex < truthyCellValueSynonymsJsonList.GetLength();
         ++truthyCellValueSynonymsIndex) {
  ...
  if (jsonValue.ValueExists("FalseyCellValueSynonyms")) {
    ...
    for (unsigned falseyCellValueSynonymsIndex = 0; falseyCellValueSynonymsIndex < falseyCellValueSynonymsJsonList.GetLength();
         ++falseyCellValueSynonymsIndex) {
