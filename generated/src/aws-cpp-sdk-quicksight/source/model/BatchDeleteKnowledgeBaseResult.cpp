...
BatchDeleteKnowledgeBaseResult::BatchDeleteKnowledgeBaseResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchDeleteKnowledgeBaseResult& BatchDeleteKnowledgeBaseResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
