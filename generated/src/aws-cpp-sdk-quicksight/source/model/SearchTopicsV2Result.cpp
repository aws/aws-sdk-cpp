...
SearchTopicsV2Result::SearchTopicsV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchTopicsV2Result& SearchTopicsV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
