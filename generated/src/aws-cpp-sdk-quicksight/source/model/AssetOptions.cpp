...
AssetOptions::AssetOptions(JsonView jsonValue) { *this = jsonValue; }
...
AssetOptions& AssetOptions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("QBusinessInsightsStatus")) {
    m_qBusinessInsightsStatus =
        QBusinessInsightsStatusMapper::GetQBusinessInsightsStatusForName(jsonValue.GetString("QBusinessInsightsStatus"));
  ...
  if (jsonValue.ValueExists("ExcludedDataSetArns")) {
    ...
    for (unsigned excludedDataSetArnsIndex = 0; excludedDataSetArnsIndex < excludedDataSetArnsJsonList.GetLength();
         ++excludedDataSetArnsIndex) {
...
JsonValue AssetOptions::Jsonize() const {
  ...
  if (m_qBusinessInsightsStatusHasBeenSet) {
    payload.WithString("QBusinessInsightsStatus",
                       QBusinessInsightsStatusMapper::GetNameForQBusinessInsightsStatus(m_qBusinessInsightsStatus));
  }
