...
HeatMapVisual::HeatMapVisual(JsonView jsonValue) { *this = jsonValue; }

HeatMapVisual& HeatMapVisual::operator=(JsonView jsonValue) {
...
JsonValue HeatMapVisual::Jsonize() const {
  JsonValue payload;
