...
ListSelfUpgradesResult& ListSelfUpgradesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SelfUpgradeRequestDetails")) {
    ...
    for (unsigned selfUpgradeRequestDetailsIndex = 0; selfUpgradeRequestDetailsIndex < selfUpgradeRequestDetailsJsonList.GetLength();
         ++selfUpgradeRequestDetailsIndex) {
      m_selfUpgradeRequestDetails.push_back(selfUpgradeRequestDetailsJsonList[selfUpgradeRequestDetailsIndex].AsObject());
    }
