...
TreeMapVisual::TreeMapVisual(JsonView jsonValue) { *this = jsonValue; }

TreeMapVisual& TreeMapVisual::operator=(JsonView jsonValue) {
...
JsonValue TreeMapVisual::Jsonize() const {
  JsonValue payload;
