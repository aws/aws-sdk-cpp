...
AssetBundleExportJobFolderOverrideProperties::AssetBundleExportJobFolderOverrideProperties(JsonView jsonValue) { *this = jsonValue; }
...
AssetBundleExportJobFolderOverrideProperties& AssetBundleExportJobFolderOverrideProperties::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Properties")) {
    ...
    for (unsigned propertiesIndex = 0; propertiesIndex < propertiesJsonList.GetLength(); ++propertiesIndex) {
      m_properties.push_back(AssetBundleExportJobFolderPropertyToOverrideMapper::GetAssetBundleExportJobFolderPropertyToOverrideForName(
...
JsonValue AssetBundleExportJobFolderOverrideProperties::Jsonize() const {
  ...
  if (m_propertiesHasBeenSet) {
    ...
    for (unsigned propertiesIndex = 0; propertiesIndex < propertiesJsonList.GetLength(); ++propertiesIndex) {
      propertiesJsonList[propertiesIndex].AsString(
          AssetBundleExportJobFolderPropertyToOverrideMapper::GetNameForAssetBundleExportJobFolderPropertyToOverride(
