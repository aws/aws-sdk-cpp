...
LineChartSortConfiguration::LineChartSortConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
LineChartSortConfiguration& LineChartSortConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SmallMultiplesSort")) {
    ...
    for (unsigned smallMultiplesSortIndex = 0; smallMultiplesSortIndex < smallMultiplesSortJsonList.GetLength();
         ++smallMultiplesSortIndex) {
