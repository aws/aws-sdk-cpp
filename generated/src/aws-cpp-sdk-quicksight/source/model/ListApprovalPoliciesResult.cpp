...
ListApprovalPoliciesResult::ListApprovalPoliciesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListApprovalPoliciesResult& ListApprovalPoliciesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
