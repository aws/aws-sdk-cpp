...
SearchAgentsResult::SearchAgentsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

SearchAgentsResult& SearchAgentsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
