...
ReadAuthenticationMetadata::ReadAuthenticationMetadata(JsonView jsonValue) { *this = jsonValue; }

ReadAuthenticationMetadata& ReadAuthenticationMetadata::operator=(JsonView jsonValue) {
...
JsonValue ReadAuthenticationMetadata::Jsonize() const {
  JsonValue payload;
