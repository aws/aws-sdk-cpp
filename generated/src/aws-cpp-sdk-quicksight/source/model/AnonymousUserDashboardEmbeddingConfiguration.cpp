...
AnonymousUserDashboardEmbeddingConfiguration::AnonymousUserDashboardEmbeddingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AnonymousUserDashboardEmbeddingConfiguration& AnonymousUserDashboardEmbeddingConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EnabledFeatures")) {
    ...
    for (unsigned enabledFeaturesIndex = 0; enabledFeaturesIndex < enabledFeaturesJsonList.GetLength(); ++enabledFeaturesIndex) {
      m_enabledFeatures.push_back(AnonymousUserDashboardEmbeddingConfigurationEnabledFeatureMapper::
                                      GetAnonymousUserDashboardEmbeddingConfigurationEnabledFeatureForName(
                                          enabledFeaturesJsonList[enabledFeaturesIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("DisabledFeatures")) {
    ...
    for (unsigned disabledFeaturesIndex = 0; disabledFeaturesIndex < disabledFeaturesJsonList.GetLength(); ++disabledFeaturesIndex) {
      m_disabledFeatures.push_back(AnonymousUserDashboardEmbeddingConfigurationDisabledFeatureMapper::
                                       GetAnonymousUserDashboardEmbeddingConfigurationDisabledFeatureForName(
                                           disabledFeaturesJsonList[disabledFeaturesIndex].AsString()));
    }
...
JsonValue AnonymousUserDashboardEmbeddingConfiguration::Jsonize() const {
  ...
  if (m_enabledFeaturesHasBeenSet) {
    ...
    for (unsigned enabledFeaturesIndex = 0; enabledFeaturesIndex < enabledFeaturesJsonList.GetLength(); ++enabledFeaturesIndex) {
      enabledFeaturesJsonList[enabledFeaturesIndex].AsString(
          AnonymousUserDashboardEmbeddingConfigurationEnabledFeatureMapper::
              GetNameForAnonymousUserDashboardEmbeddingConfigurationEnabledFeature(m_enabledFeatures[enabledFeaturesIndex]));
    }
  ...
  if (m_disabledFeaturesHasBeenSet) {
    ...
    for (unsigned disabledFeaturesIndex = 0; disabledFeaturesIndex < disabledFeaturesJsonList.GetLength(); ++disabledFeaturesIndex) {
      disabledFeaturesJsonList[disabledFeaturesIndex].AsString(
          AnonymousUserDashboardEmbeddingConfigurationDisabledFeatureMapper::
              GetNameForAnonymousUserDashboardEmbeddingConfigurationDisabledFeature(m_disabledFeatures[disabledFeaturesIndex]));
    }
