...
RowLevelPermissionDataSet::RowLevelPermissionDataSet(JsonView jsonValue) { *this = jsonValue; }
...
RowLevelPermissionDataSet& RowLevelPermissionDataSet::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FormatVersion")) {
    m_formatVersion =
        RowLevelPermissionFormatVersionMapper::GetRowLevelPermissionFormatVersionForName(jsonValue.GetString("FormatVersion"));
