...
FunnelChartDataLabelOptions::FunnelChartDataLabelOptions(JsonView jsonValue) { *this = jsonValue; }
...
FunnelChartDataLabelOptions& FunnelChartDataLabelOptions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MeasureDataLabelStyle")) {
    m_measureDataLabelStyle =
        FunnelChartMeasureDataLabelStyleMapper::GetFunnelChartMeasureDataLabelStyleForName(jsonValue.GetString("MeasureDataLabelStyle"));
...
JsonValue FunnelChartDataLabelOptions::Jsonize() const {
  ...
  if (m_measureDataLabelStyleHasBeenSet) {
    payload.WithString("MeasureDataLabelStyle",
                       FunnelChartMeasureDataLabelStyleMapper::GetNameForFunnelChartMeasureDataLabelStyle(m_measureDataLabelStyle));
  }
