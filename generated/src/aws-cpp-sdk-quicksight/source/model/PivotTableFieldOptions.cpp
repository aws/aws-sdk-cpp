...
PivotTableFieldOptions::PivotTableFieldOptions(JsonView jsonValue) { *this = jsonValue; }
...
PivotTableFieldOptions& PivotTableFieldOptions::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SelectedFieldOptions")) {
    ...
    for (unsigned selectedFieldOptionsIndex = 0; selectedFieldOptionsIndex < selectedFieldOptionsJsonList.GetLength();
         ++selectedFieldOptionsIndex) {
  ...
  if (jsonValue.ValueExists("CollapseStateOptions")) {
    ...
    for (unsigned collapseStateOptionsIndex = 0; collapseStateOptionsIndex < collapseStateOptionsJsonList.GetLength();
         ++collapseStateOptionsIndex) {
