...
NumericRangeFilter::NumericRangeFilter(JsonView jsonValue) { *this = jsonValue; }
...
NumericRangeFilter& NumericRangeFilter::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SelectAllOptions")) {
    m_selectAllOptions =
        NumericFilterSelectAllOptionsMapper::GetNumericFilterSelectAllOptionsForName(jsonValue.GetString("SelectAllOptions"));
...
JsonValue NumericRangeFilter::Jsonize() const {
  ...
  if (m_selectAllOptionsHasBeenSet) {
    payload.WithString("SelectAllOptions",
                       NumericFilterSelectAllOptionsMapper::GetNameForNumericFilterSelectAllOptions(m_selectAllOptions));
  }
