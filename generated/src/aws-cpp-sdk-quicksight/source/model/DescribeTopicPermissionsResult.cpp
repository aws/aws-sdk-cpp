...
DescribeTopicPermissionsResult::DescribeTopicPermissionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DescribeTopicPermissionsResult& DescribeTopicPermissionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
