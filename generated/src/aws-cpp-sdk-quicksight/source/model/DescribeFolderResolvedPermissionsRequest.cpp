...
Aws::String DescribeFolderResolvedPermissionsRequest::SerializePayload() const { return {}; }

void DescribeFolderResolvedPermissionsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
