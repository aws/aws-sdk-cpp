...
SnapshotFileSheetSelection::SnapshotFileSheetSelection(JsonView jsonValue) { *this = jsonValue; }
...
SnapshotFileSheetSelection& SnapshotFileSheetSelection::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SelectionScope")) {
    m_selectionScope =
        SnapshotFileSheetSelectionScopeMapper::GetSnapshotFileSheetSelectionScopeForName(jsonValue.GetString("SelectionScope"));
...
JsonValue SnapshotFileSheetSelection::Jsonize() const {
  ...
  if (m_selectionScopeHasBeenSet) {
    payload.WithString("SelectionScope",
                       SnapshotFileSheetSelectionScopeMapper::GetNameForSnapshotFileSheetSelectionScope(m_selectionScope));
  }
