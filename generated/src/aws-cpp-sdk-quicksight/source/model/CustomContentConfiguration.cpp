...
CustomContentConfiguration::CustomContentConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
CustomContentConfiguration& CustomContentConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ImageScaling")) {
    m_imageScaling =
        CustomContentImageScalingConfigurationMapper::GetCustomContentImageScalingConfigurationForName(jsonValue.GetString("ImageScaling"));
...
JsonValue CustomContentConfiguration::Jsonize() const {
  ...
  if (m_imageScalingHasBeenSet) {
    payload.WithString("ImageScaling",
                       CustomContentImageScalingConfigurationMapper::GetNameForCustomContentImageScalingConfiguration(m_imageScaling));
  }
