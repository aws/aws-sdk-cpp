...
RestoreAnalysisResult::RestoreAnalysisResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
RestoreAnalysisResult& RestoreAnalysisResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RestorationFailedFolderArns")) {
    ...
    for (unsigned restorationFailedFolderArnsIndex = 0; restorationFailedFolderArnsIndex < restorationFailedFolderArnsJsonList.GetLength();
         ++restorationFailedFolderArnsIndex) {
