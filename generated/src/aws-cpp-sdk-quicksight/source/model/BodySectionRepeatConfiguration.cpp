...
BodySectionRepeatConfiguration::BodySectionRepeatConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
BodySectionRepeatConfiguration& BodySectionRepeatConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("NonRepeatingVisuals")) {
    ...
    for (unsigned nonRepeatingVisualsIndex = 0; nonRepeatingVisualsIndex < nonRepeatingVisualsJsonList.GetLength();
         ++nonRepeatingVisualsIndex) {
