...
DlpSettingDetails::DlpSettingDetails(JsonView jsonValue) { *this = jsonValue; }

DlpSettingDetails& DlpSettingDetails::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProviderConfig")) {
    m_providerConfig = jsonValue.GetObject("ProviderConfig");
    m_providerConfigHasBeenSet = true;
  }
  if (jsonValue.ValueExists("ProviderOutageAction")) {
    m_providerOutageAction = DlpActionMapper::GetDlpActionForName(jsonValue.GetString("ProviderOutageAction"));
...
JsonValue DlpSettingDetails::Jsonize() const {
  JsonValue payload;
