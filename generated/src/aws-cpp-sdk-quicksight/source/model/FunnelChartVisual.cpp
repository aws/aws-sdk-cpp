...
FunnelChartVisual::FunnelChartVisual(JsonView jsonValue) { *this = jsonValue; }

FunnelChartVisual& FunnelChartVisual::operator=(JsonView jsonValue) {
...
JsonValue FunnelChartVisual::Jsonize() const {
  JsonValue payload;
