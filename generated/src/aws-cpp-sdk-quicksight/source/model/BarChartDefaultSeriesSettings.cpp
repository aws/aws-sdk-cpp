...
BarChartDefaultSeriesSettings::BarChartDefaultSeriesSettings(JsonView jsonValue) { *this = jsonValue; }

BarChartDefaultSeriesSettings& BarChartDefaultSeriesSettings::operator=(JsonView jsonValue) {
...
JsonValue BarChartDefaultSeriesSettings::Jsonize() const {
  JsonValue payload;
