...
DataPointMenuLabelOption::DataPointMenuLabelOption(JsonView jsonValue) { *this = jsonValue; }

DataPointMenuLabelOption& DataPointMenuLabelOption::operator=(JsonView jsonValue) {
...
JsonValue DataPointMenuLabelOption::Jsonize() const {
  JsonValue payload;
