...
SnapshotAnonymousUser::SnapshotAnonymousUser(JsonView jsonValue) { *this = jsonValue; }
...
SnapshotAnonymousUser& SnapshotAnonymousUser::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("RowLevelPermissionTags")) {
    ...
    for (unsigned rowLevelPermissionTagsIndex = 0; rowLevelPermissionTagsIndex < rowLevelPermissionTagsJsonList.GetLength();
         ++rowLevelPermissionTagsIndex) {
