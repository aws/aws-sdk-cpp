...
TopicIRMetric::TopicIRMetric(JsonView jsonValue) { *this = jsonValue; }
...
TopicIRMetric& TopicIRMetric::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CalculatedFieldReferences")) {
    ...
    for (unsigned calculatedFieldReferencesIndex = 0; calculatedFieldReferencesIndex < calculatedFieldReferencesJsonList.GetLength();
         ++calculatedFieldReferencesIndex) {
...
JsonValue TopicIRMetric::Jsonize() const {
  ...
  if (m_calculatedFieldReferencesHasBeenSet) {
    ...
    for (unsigned calculatedFieldReferencesIndex = 0; calculatedFieldReferencesIndex < calculatedFieldReferencesJsonList.GetLength();
         ++calculatedFieldReferencesIndex) {
      calculatedFieldReferencesJsonList[calculatedFieldReferencesIndex].AsObject(
          m_calculatedFieldReferences[calculatedFieldReferencesIndex].Jsonize());
    }
