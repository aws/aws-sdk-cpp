...
GeospatialPointStyleOptions::GeospatialPointStyleOptions(JsonView jsonValue) { *this = jsonValue; }
...
GeospatialPointStyleOptions& GeospatialPointStyleOptions::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("SelectedPointStyle")) {
    m_selectedPointStyle =
        GeospatialSelectedPointStyleMapper::GetGeospatialSelectedPointStyleForName(jsonValue.GetString("SelectedPointStyle"));
...
JsonValue GeospatialPointStyleOptions::Jsonize() const {
  ...
  if (m_selectedPointStyleHasBeenSet) {
    payload.WithString("SelectedPointStyle",
                       GeospatialSelectedPointStyleMapper::GetNameForGeospatialSelectedPointStyle(m_selectedPointStyle));
  }
