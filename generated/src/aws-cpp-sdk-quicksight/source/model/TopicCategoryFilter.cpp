...
TopicCategoryFilter::TopicCategoryFilter(JsonView jsonValue) { *this = jsonValue; }

TopicCategoryFilter& TopicCategoryFilter::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("CategoryFilterFunction")) {
    m_categoryFilterFunction =
        CategoryFilterFunctionMapper::GetCategoryFilterFunctionForName(jsonValue.GetString("CategoryFilterFunction"));
