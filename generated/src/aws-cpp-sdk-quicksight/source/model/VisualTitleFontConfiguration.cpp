...
VisualTitleFontConfiguration::VisualTitleFontConfiguration(JsonView jsonValue) { *this = jsonValue; }

VisualTitleFontConfiguration& VisualTitleFontConfiguration::operator=(JsonView jsonValue) {
...
JsonValue VisualTitleFontConfiguration::Jsonize() const {
  JsonValue payload;
