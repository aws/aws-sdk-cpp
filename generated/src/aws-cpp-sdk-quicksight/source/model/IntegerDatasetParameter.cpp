...
IntegerDatasetParameter::IntegerDatasetParameter(JsonView jsonValue) { *this = jsonValue; }

IntegerDatasetParameter& IntegerDatasetParameter::operator=(JsonView jsonValue) {
...
JsonValue IntegerDatasetParameter::Jsonize() const {
  JsonValue payload;
