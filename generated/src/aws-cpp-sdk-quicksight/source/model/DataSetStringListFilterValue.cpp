...
DataSetStringListFilterValue::DataSetStringListFilterValue(JsonView jsonValue) { *this = jsonValue; }

DataSetStringListFilterValue& DataSetStringListFilterValue::operator=(JsonView jsonValue) {
...
JsonValue DataSetStringListFilterValue::Jsonize() const {
  JsonValue payload;
