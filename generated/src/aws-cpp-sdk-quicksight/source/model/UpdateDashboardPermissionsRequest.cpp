...
Aws::String UpdateDashboardPermissionsRequest::SerializePayload() const {
  ...
  if (m_grantLinkPermissionsHasBeenSet) {
    ...
    for (unsigned grantLinkPermissionsIndex = 0; grantLinkPermissionsIndex < grantLinkPermissionsJsonList.GetLength();
         ++grantLinkPermissionsIndex) {
  ...
  if (m_revokeLinkPermissionsHasBeenSet) {
    ...
    for (unsigned revokeLinkPermissionsIndex = 0; revokeLinkPermissionsIndex < revokeLinkPermissionsJsonList.GetLength();
         ++revokeLinkPermissionsIndex) {
