...
ScatterPlotVisual::ScatterPlotVisual(JsonView jsonValue) { *this = jsonValue; }

ScatterPlotVisual& ScatterPlotVisual::operator=(JsonView jsonValue) {
...
JsonValue ScatterPlotVisual::Jsonize() const {
  JsonValue payload;
