...
ParameterTextAreaControl::ParameterTextAreaControl(JsonView jsonValue) { *this = jsonValue; }

ParameterTextAreaControl& ParameterTextAreaControl::operator=(JsonView jsonValue) {
...
JsonValue ParameterTextAreaControl::Jsonize() const {
  JsonValue payload;
