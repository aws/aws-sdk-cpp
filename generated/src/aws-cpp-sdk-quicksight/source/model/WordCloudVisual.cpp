...
WordCloudVisual::WordCloudVisual(JsonView jsonValue) { *this = jsonValue; }

WordCloudVisual& WordCloudVisual::operator=(JsonView jsonValue) {
...
JsonValue WordCloudVisual::Jsonize() const {
  JsonValue payload;
