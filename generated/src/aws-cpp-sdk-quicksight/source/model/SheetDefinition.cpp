...
SheetDefinition::SheetDefinition(JsonView jsonValue) { *this = jsonValue; }
...
SheetDefinition& SheetDefinition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SheetControlLayouts")) {
    ...
    for (unsigned sheetControlLayoutsIndex = 0; sheetControlLayoutsIndex < sheetControlLayoutsJsonList.GetLength();
         ++sheetControlLayoutsIndex) {
