...
LineChartConfiguration::LineChartConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
LineChartConfiguration& LineChartConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ForecastConfigurations")) {
    ...
    for (unsigned forecastConfigurationsIndex = 0; forecastConfigurationsIndex < forecastConfigurationsJsonList.GetLength();
         ++forecastConfigurationsIndex) {
