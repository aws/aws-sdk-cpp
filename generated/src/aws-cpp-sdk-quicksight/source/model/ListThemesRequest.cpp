...
Aws::String ListThemesRequest::SerializePayload() const { return {}; }

void ListThemesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
  ...
  if (m_typeHasBeenSet) {
    ss << ThemeTypeMapper::GetNameForThemeType(m_type);
