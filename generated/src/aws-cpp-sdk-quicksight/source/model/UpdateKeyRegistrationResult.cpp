...
UpdateKeyRegistrationResult& UpdateKeyRegistrationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FailedKeyRegistration")) {
    ...
    for (unsigned failedKeyRegistrationIndex = 0; failedKeyRegistrationIndex < failedKeyRegistrationJsonList.GetLength();
         ++failedKeyRegistrationIndex) {
  ...
  if (jsonValue.ValueExists("SuccessfulKeyRegistration")) {
    ...
    for (unsigned successfulKeyRegistrationIndex = 0; successfulKeyRegistrationIndex < successfulKeyRegistrationJsonList.GetLength();
         ++successfulKeyRegistrationIndex) {
