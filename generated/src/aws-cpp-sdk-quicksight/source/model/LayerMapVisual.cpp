...
LayerMapVisual::LayerMapVisual(JsonView jsonValue) { *this = jsonValue; }

LayerMapVisual& LayerMapVisual::operator=(JsonView jsonValue) {
...
JsonValue LayerMapVisual::Jsonize() const {
  JsonValue payload;
