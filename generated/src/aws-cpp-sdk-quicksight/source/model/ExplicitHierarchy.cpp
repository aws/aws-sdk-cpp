...
ExplicitHierarchy::ExplicitHierarchy(JsonView jsonValue) { *this = jsonValue; }

ExplicitHierarchy& ExplicitHierarchy::operator=(JsonView jsonValue) {
...
JsonValue ExplicitHierarchy::Jsonize() const {
  JsonValue payload;
