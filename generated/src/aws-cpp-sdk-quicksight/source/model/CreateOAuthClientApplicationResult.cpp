...
CreateOAuthClientApplicationResult::CreateOAuthClientApplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

CreateOAuthClientApplicationResult& CreateOAuthClientApplicationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
