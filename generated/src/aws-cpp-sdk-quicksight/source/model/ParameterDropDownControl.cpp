...
ParameterDropDownControl::ParameterDropDownControl(JsonView jsonValue) { *this = jsonValue; }

ParameterDropDownControl& ParameterDropDownControl::operator=(JsonView jsonValue) {
...
JsonValue ParameterDropDownControl::Jsonize() const {
  JsonValue payload;
