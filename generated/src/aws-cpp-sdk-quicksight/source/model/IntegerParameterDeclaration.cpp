...
IntegerParameterDeclaration::IntegerParameterDeclaration(JsonView jsonValue) { *this = jsonValue; }

IntegerParameterDeclaration& IntegerParameterDeclaration::operator=(JsonView jsonValue) {
...
JsonValue IntegerParameterDeclaration::Jsonize() const {
  JsonValue payload;
