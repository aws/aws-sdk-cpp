...
DataQAEnabledOption::DataQAEnabledOption(JsonView jsonValue) { *this = jsonValue; }

DataQAEnabledOption& DataQAEnabledOption::operator=(JsonView jsonValue) {
...
JsonValue DataQAEnabledOption::Jsonize() const {
  JsonValue payload;
