...
TopicReviewedAnswer::TopicReviewedAnswer() : 
...
TopicReviewedAnswer::TopicReviewedAnswer(JsonView jsonValue)
  : TopicReviewedAnswer()
{
  *this = jsonValue;
}

TopicReviewedAnswer& TopicReviewedAnswer::operator =(JsonView jsonValue)
{
...
JsonValue TopicReviewedAnswer::Jsonize() const
{
  JsonValue payload;
