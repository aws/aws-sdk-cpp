...
PivotTableFieldCollapseStateTarget::PivotTableFieldCollapseStateTarget(JsonView jsonValue) { *this = jsonValue; }
...
PivotTableFieldCollapseStateTarget& PivotTableFieldCollapseStateTarget::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FieldDataPathValues")) {
    ...
    for (unsigned fieldDataPathValuesIndex = 0; fieldDataPathValuesIndex < fieldDataPathValuesJsonList.GetLength();
         ++fieldDataPathValuesIndex) {
