...
AssetBundleExportJobRefreshSchedulePropertyToOverride GetAssetBundleExportJobRefreshSchedulePropertyToOverrideForName(
...
Aws::String GetNameForAssetBundleExportJobRefreshSchedulePropertyToOverride(
    AssetBundleExportJobRefreshSchedulePropertyToOverride enumValue) {
  switch (enumValue) {
