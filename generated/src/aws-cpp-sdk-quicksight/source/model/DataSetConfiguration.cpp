...
DataSetConfiguration::DataSetConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
DataSetConfiguration& DataSetConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ColumnGroupSchemaList")) {
    ...
    for (unsigned columnGroupSchemaListIndex = 0; columnGroupSchemaListIndex < columnGroupSchemaListJsonList.GetLength();
         ++columnGroupSchemaListIndex) {
