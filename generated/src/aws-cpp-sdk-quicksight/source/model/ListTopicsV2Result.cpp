...
ListTopicsV2Result::ListTopicsV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListTopicsV2Result& ListTopicsV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
