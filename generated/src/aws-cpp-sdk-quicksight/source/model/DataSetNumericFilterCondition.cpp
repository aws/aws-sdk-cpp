...
DataSetNumericFilterCondition::DataSetNumericFilterCondition(JsonView jsonValue) { *this = jsonValue; }

DataSetNumericFilterCondition& DataSetNumericFilterCondition::operator=(JsonView jsonValue) {
...
JsonValue DataSetNumericFilterCondition::Jsonize() const {
  JsonValue payload;
