...
DescribeSpacePermissionsResult::DescribeSpacePermissionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DescribeSpacePermissionsResult& DescribeSpacePermissionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
