...
CreateBrandResult::CreateBrandResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateBrandResult& CreateBrandResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
