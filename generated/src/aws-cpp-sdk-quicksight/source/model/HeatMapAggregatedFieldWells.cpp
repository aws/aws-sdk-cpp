...
HeatMapAggregatedFieldWells::HeatMapAggregatedFieldWells(JsonView jsonValue) { *this = jsonValue; }

HeatMapAggregatedFieldWells& HeatMapAggregatedFieldWells::operator=(JsonView jsonValue) {
...
JsonValue HeatMapAggregatedFieldWells::Jsonize() const {
  JsonValue payload;
