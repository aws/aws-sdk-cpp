...
OAuthClientApplication::OAuthClientApplication(JsonView jsonValue) { *this = jsonValue; }

OAuthClientApplication& OAuthClientApplication::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OAuthTokenEndpointUrl")) {
    m_oAuthTokenEndpointUrl = jsonValue.GetString("OAuthTokenEndpointUrl");
    m_oAuthTokenEndpointUrlHasBeenSet = true;
  }
  if (jsonValue.ValueExists("OAuthAuthorizationEndpointUrl")) {
    m_oAuthAuthorizationEndpointUrl = jsonValue.GetString("OAuthAuthorizationEndpointUrl");
    m_oAuthAuthorizationEndpointUrlHasBeenSet = true;
  }
  if (jsonValue.ValueExists("OAuthScopes")) {
    m_oAuthScopes = jsonValue.GetString("OAuthScopes");
...
JsonValue OAuthClientApplication::Jsonize() const {
  JsonValue payload;
