...
KPIConditionalFormatting::KPIConditionalFormatting(JsonView jsonValue) { *this = jsonValue; }

KPIConditionalFormatting& KPIConditionalFormatting::operator=(JsonView jsonValue) {
...
JsonValue KPIConditionalFormatting::Jsonize() const {
  JsonValue payload;
