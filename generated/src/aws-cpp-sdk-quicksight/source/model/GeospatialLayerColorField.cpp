...
GeospatialLayerColorField::GeospatialLayerColorField(JsonView jsonValue) { *this = jsonValue; }
...
GeospatialLayerColorField& GeospatialLayerColorField::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ColorDimensionsFields")) {
    ...
    for (unsigned colorDimensionsFieldsIndex = 0; colorDimensionsFieldsIndex < colorDimensionsFieldsJsonList.GetLength();
         ++colorDimensionsFieldsIndex) {
