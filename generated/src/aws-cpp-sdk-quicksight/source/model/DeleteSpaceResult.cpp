...
DeleteSpaceResult::DeleteSpaceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteSpaceResult& DeleteSpaceResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
