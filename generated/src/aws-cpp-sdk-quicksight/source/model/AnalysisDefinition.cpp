...
AnalysisDefinition::AnalysisDefinition(JsonView jsonValue) { *this = jsonValue; }

AnalysisDefinition& AnalysisDefinition::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("DataSetIdentifierDeclarations")) {
    ...
    for (unsigned dataSetIdentifierDeclarationsIndex = 0;
         dataSetIdentifierDeclarationsIndex < dataSetIdentifierDeclarationsJsonList.GetLength(); ++dataSetIdentifierDeclarationsIndex) {
  ...
  if (jsonValue.ValueExists("ParameterDeclarations")) {
    ...
    for (unsigned parameterDeclarationsIndex = 0; parameterDeclarationsIndex < parameterDeclarationsJsonList.GetLength();
         ++parameterDeclarationsIndex) {
  ...
  if (jsonValue.ValueExists("ColumnConfigurations")) {
    ...
    for (unsigned columnConfigurationsIndex = 0; columnConfigurationsIndex < columnConfigurationsJsonList.GetLength();
         ++columnConfigurationsIndex) {
...
JsonValue AnalysisDefinition::Jsonize() const {
  JsonValue payload;
  ...
  if (m_dataSetIdentifierDeclarationsHasBeenSet) {
    ...
    for (unsigned dataSetIdentifierDeclarationsIndex = 0;
         dataSetIdentifierDeclarationsIndex < dataSetIdentifierDeclarationsJsonList.GetLength(); ++dataSetIdentifierDeclarationsIndex) {
      dataSetIdentifierDeclarationsJsonList[dataSetIdentifierDeclarationsIndex].AsObject(
