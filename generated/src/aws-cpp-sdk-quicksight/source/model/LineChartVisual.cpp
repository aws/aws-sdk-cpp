...
LineChartVisual::LineChartVisual(JsonView jsonValue) { *this = jsonValue; }

LineChartVisual& LineChartVisual::operator=(JsonView jsonValue) {
...
JsonValue LineChartVisual::Jsonize() const {
  JsonValue payload;
