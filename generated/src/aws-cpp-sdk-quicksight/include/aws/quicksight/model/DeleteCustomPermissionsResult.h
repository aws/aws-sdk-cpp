...
class DeleteCustomPermissionsResult {
 public:
  ...
  inline DeleteCustomPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  DeleteCustomPermissionsResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteCustomPermissionsResult& WithRequestId(RequestIdT&& value) {
