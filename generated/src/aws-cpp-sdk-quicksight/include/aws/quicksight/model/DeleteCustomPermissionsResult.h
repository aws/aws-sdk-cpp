...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DeleteCustomPermissionsResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteCustomPermissionsResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteCustomPermissionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
