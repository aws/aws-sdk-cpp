...
class NumericalAggregationFunction {
 public:
  ...
  inline void SetSimpleNumericalAggregation(SimpleNumericalAggregationFunction value) {
    m_simpleNumericalAggregationHasBeenSet = true;
    m_simpleNumericalAggregation = value;
  }
  inline NumericalAggregationFunction& WithSimpleNumericalAggregation(SimpleNumericalAggregationFunction value) {
    SetSimpleNumericalAggregation(value);
    return *this;
  }
  ///@}
  ...
  void SetPercentileAggregation(PercentileAggregationT&& value) {
    ...
    m_percentileAggregation = std::forward<PercentileAggregationT>(value);
  }
  template <typename PercentileAggregationT = PercentileAggregation>
  NumericalAggregationFunction& WithPercentileAggregation(PercentileAggregationT&& value) {
    SetPercentileAggregation(std::forward<PercentileAggregationT>(value));
    return *this;
  }
  ///@}
 private:
