...
class DescribeQPersonalizationConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeQPersonalizationConfigurationResult& operator=(
  ...
  inline void SetPersonalizationMode(PersonalizationMode value) {
    m_personalizationModeHasBeenSet = true;
    m_personalizationMode = value;
  }
  inline DescribeQPersonalizationConfigurationResult& WithPersonalizationMode(PersonalizationMode value) {
    SetPersonalizationMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeQPersonalizationConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeQPersonalizationConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
