...
class AssetBundleImportJobResourceIdOverrideConfiguration {
 public:
  ...
  void SetPrefixForAllResources(PrefixForAllResourcesT&& value) {
    m_prefixForAllResourcesHasBeenSet = true;
    m_prefixForAllResources = std::forward<PrefixForAllResourcesT>(value);
  }
  template <typename PrefixForAllResourcesT = Aws::String>
  AssetBundleImportJobResourceIdOverrideConfiguration& WithPrefixForAllResources(PrefixForAllResourcesT&& value) {
    SetPrefixForAllResources(std::forward<PrefixForAllResourcesT>(value));
    return *this;
  }
  ///@}
 private:
