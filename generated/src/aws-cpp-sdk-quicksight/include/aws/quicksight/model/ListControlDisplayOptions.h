...
class ListControlDisplayOptions {
 public:
  ...
  void SetSearchOptions(SearchOptionsT&& value) {
    m_searchOptionsHasBeenSet = true;
    m_searchOptions = std::forward<SearchOptionsT>(value);
  }
  template <typename SearchOptionsT = ListControlSearchOptions>
  ListControlDisplayOptions& WithSearchOptions(SearchOptionsT&& value) {
    SetSearchOptions(std::forward<SearchOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectAllOptions(SelectAllOptionsT&& value) {
    m_selectAllOptionsHasBeenSet = true;
    m_selectAllOptions = std::forward<SelectAllOptionsT>(value);
  }
  template <typename SelectAllOptionsT = ListControlSelectAllOptions>
  ListControlDisplayOptions& WithSelectAllOptions(SelectAllOptionsT&& value) {
    SetSelectAllOptions(std::forward<SelectAllOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTitleOptions(TitleOptionsT&& value) {
    ...
    m_titleOptions = std::forward<TitleOptionsT>(value);
  }
  template <typename TitleOptionsT = LabelOptions>
  ListControlDisplayOptions& WithTitleOptions(TitleOptionsT&& value) {
    SetTitleOptions(std::forward<TitleOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInfoIconLabelOptions(InfoIconLabelOptionsT&& value) {
    ...
    m_infoIconLabelOptions = std::forward<InfoIconLabelOptionsT>(value);
  }
  template <typename InfoIconLabelOptionsT = SheetControlInfoIconLabelOptions>
  ListControlDisplayOptions& WithInfoIconLabelOptions(InfoIconLabelOptionsT&& value) {
    SetInfoIconLabelOptions(std::forward<InfoIconLabelOptionsT>(value));
    return *this;
  }
  ///@}
 private:
