...
class GeospatialMapState {
 public:
  ...
  inline void SetMapNavigation(GeospatialMapNavigation value) {
    m_mapNavigationHasBeenSet = true;
    m_mapNavigation = value;
  }
  inline GeospatialMapState& WithMapNavigation(GeospatialMapNavigation value) {
    SetMapNavigation(value);
    return *this;
  }
  ///@}
 private:
