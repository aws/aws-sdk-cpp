...
class ReadAuthorizationCodeGrantMetadata {
 public:
  ...
  template <typename BaseEndpointT = Aws::String>
  ReadAuthorizationCodeGrantMetadata& WithBaseEndpoint(BaseEndpointT&& value) {
  ...
  template <typename RedirectUrlT = Aws::String>
  ReadAuthorizationCodeGrantMetadata& WithRedirectUrl(RedirectUrlT&& value) {
   ...
   */
  inline const ReadAuthorizationCodeGrantCredentialsDetails& GetReadAuthorizationCodeGrantCredentialsDetails() const {
    return m_readAuthorizationCodeGrantCredentialsDetails;
  }
  inline bool ReadAuthorizationCodeGrantCredentialsDetailsHasBeenSet() const {
    return m_readAuthorizationCodeGrantCredentialsDetailsHasBeenSet;
  }
  template <typename ReadAuthorizationCodeGrantCredentialsDetailsT = ReadAuthorizationCodeGrantCredentialsDetails>
  void SetReadAuthorizationCodeGrantCredentialsDetails(ReadAuthorizationCodeGrantCredentialsDetailsT&& value) {
    m_readAuthorizationCodeGrantCredentialsDetailsHasBeenSet = true;
    m_readAuthorizationCodeGrantCredentialsDetails = std::forward<ReadAuthorizationCodeGrantCredentialsDetailsT>(value);
  }
  template <typename ReadAuthorizationCodeGrantCredentialsDetailsT = ReadAuthorizationCodeGrantCredentialsDetails>
  ReadAuthorizationCodeGrantMetadata& WithReadAuthorizationCodeGrantCredentialsDetails(
      ReadAuthorizationCodeGrantCredentialsDetailsT&& value) {
    SetReadAuthorizationCodeGrantCredentialsDetails(std::forward<ReadAuthorizationCodeGrantCredentialsDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReadAuthorizationCodeGrantMetadata& WithAuthorizationCodeGrantCredentialsSource(AuthorizationCodeGrantCredentialsSource value) {
