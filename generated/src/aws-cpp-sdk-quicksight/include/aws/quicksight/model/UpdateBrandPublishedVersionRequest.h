...
class UpdateBrandPublishedVersionRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateBrandPublishedVersionRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename BrandIdT = Aws::String>
  UpdateBrandPublishedVersionRequest& WithBrandId(BrandIdT&& value) {
  ...
  template <typename VersionIdT = Aws::String>
  UpdateBrandPublishedVersionRequest& WithVersionId(VersionIdT&& value) {
