...
class ColumnTooltipItem {
 public:
  ...
  inline ColumnTooltipItem& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTooltipTarget(TooltipTarget value) {
    m_tooltipTargetHasBeenSet = true;
    m_tooltipTarget = value;
  }
  inline ColumnTooltipItem& WithTooltipTarget(TooltipTarget value) {
    SetTooltipTarget(value);
    return *this;
  }
  ///@}
 private:
