...
/**
 * <p>A folder in Quick Sight.</p><p><h3>See Also:</h3>   <a
...
class Folder {
 public:
  ...
  inline void SetFolderType(FolderType value) {
    m_folderTypeHasBeenSet = true;
    m_folderType = value;
  }
  inline Folder& WithFolderType(FolderType value) {
    SetFolderType(value);
    return *this;
  }
  ///@}
  ...
  Folder& AddFolderPath(FolderPathT&& value) {
    m_folderPathHasBeenSet = true;
    m_folderPath.emplace_back(std::forward<FolderPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSharingModel(SharingModel value) {
    m_sharingModelHasBeenSet = true;
    m_sharingModel = value;
  }
  inline Folder& WithSharingModel(SharingModel value) {
