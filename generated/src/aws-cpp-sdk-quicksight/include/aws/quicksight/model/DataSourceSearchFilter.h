...
class DataSourceSearchFilter {
 public:
  ...
  inline DataSourceSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(DataSourceFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DataSourceSearchFilter& WithName(DataSourceFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  DataSourceSearchFilter& WithValue(ValueT&& value) {
