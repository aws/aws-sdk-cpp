...
class RefreshFrequency {
 public:
  ...
  inline void SetInterval(RefreshInterval value) {
    m_intervalHasBeenSet = true;
    m_interval = value;
  }
  inline RefreshFrequency& WithInterval(RefreshInterval value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  void SetRefreshOnDay(RefreshOnDayT&& value) {
    ...
    m_refreshOnDay = std::forward<RefreshOnDayT>(value);
  }
  template <typename RefreshOnDayT = ScheduleRefreshOnEntity>
  RefreshFrequency& WithRefreshOnDay(RefreshOnDayT&& value) {
    SetRefreshOnDay(std::forward<RefreshOnDayT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeOfTheDay(TimeOfTheDayT&& value) {
    ...
    m_timeOfTheDay = std::forward<TimeOfTheDayT>(value);
  }
  template <typename TimeOfTheDayT = Aws::String>
  RefreshFrequency& WithTimeOfTheDay(TimeOfTheDayT&& value) {
    SetTimeOfTheDay(std::forward<TimeOfTheDayT>(value));
    return *this;
  }
  ///@}
 private:
