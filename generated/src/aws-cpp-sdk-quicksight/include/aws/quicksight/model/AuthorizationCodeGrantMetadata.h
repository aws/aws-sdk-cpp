...
namespace Model
{
  ...
  public:
    ...
    template<typename BaseEndpointT = Aws::String>
    AuthorizationCodeGrantMetadata& WithBaseEndpoint(BaseEndpointT&& value) { SetBaseEndpoint(std::forward<BaseEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename RedirectUrlT = Aws::String>
    AuthorizationCodeGrantMetadata& WithRedirectUrl(RedirectUrlT&& value) { SetRedirectUrl(std::forward<RedirectUrlT>(value)); return *this;}
    ///@}
    ...
    inline AuthorizationCodeGrantMetadata& WithAuthorizationCodeGrantCredentialsSource(AuthorizationCodeGrantCredentialsSource value) { SetAuthorizationCodeGrantCredentialsSource(value); return *this;}
    ///@}
     ...
     */
    inline const AuthorizationCodeGrantCredentialsDetails& GetAuthorizationCodeGrantCredentialsDetails() const { return m_authorizationCodeGrantCredentialsDetails; }
    ...
    void SetAuthorizationCodeGrantCredentialsDetails(AuthorizationCodeGrantCredentialsDetailsT&& value) { m_authorizationCodeGrantCredentialsDetailsHasBeenSet = true; m_authorizationCodeGrantCredentialsDetails = std::forward<AuthorizationCodeGrantCredentialsDetailsT>(value); }
    template<typename AuthorizationCodeGrantCredentialsDetailsT = AuthorizationCodeGrantCredentialsDetails>
    AuthorizationCodeGrantMetadata& WithAuthorizationCodeGrantCredentialsDetails(AuthorizationCodeGrantCredentialsDetailsT&& value) { SetAuthorizationCodeGrantCredentialsDetails(std::forward<AuthorizationCodeGrantCredentialsDetailsT>(value)); return *this;}
    ///@}
  private:
