...
class AssetBundleExportJobResourceIdOverrideConfiguration {
 public:
  ...
  inline void SetPrefixForAllResources(bool value) {
    m_prefixForAllResourcesHasBeenSet = true;
    m_prefixForAllResources = value;
  }
  inline AssetBundleExportJobResourceIdOverrideConfiguration& WithPrefixForAllResources(bool value) {
    SetPrefixForAllResources(value);
    return *this;
  }
  ///@}
 private:
