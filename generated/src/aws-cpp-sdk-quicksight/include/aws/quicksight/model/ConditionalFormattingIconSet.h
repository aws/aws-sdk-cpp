...
class ConditionalFormattingIconSet {
 public:
  ...
  inline void SetIconSetType(ConditionalFormattingIconSetType value) {
    m_iconSetTypeHasBeenSet = true;
    m_iconSetType = value;
  }
  inline ConditionalFormattingIconSet& WithIconSetType(ConditionalFormattingIconSetType value) {
