...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DescribeGroupMembershipRequest() = default;
    ...
    template<typename MemberNameT = Aws::String>
    DescribeGroupMembershipRequest& WithMemberName(MemberNameT&& value) { SetMemberName(std::forward<MemberNameT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupNameT = Aws::String>
    DescribeGroupMembershipRequest& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeGroupMembershipRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DescribeGroupMembershipRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
  private:
