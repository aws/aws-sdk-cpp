...
class DescribeGroupMembershipRequest : public QuickSightRequest {
 public:
  ...
  template <typename MemberNameT = Aws::String>
  DescribeGroupMembershipRequest& WithMemberName(MemberNameT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  DescribeGroupMembershipRequest& WithGroupName(GroupNameT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeGroupMembershipRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DescribeGroupMembershipRequest& WithNamespace(NamespaceT&& value) {
