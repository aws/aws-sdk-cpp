...
class DeleteVPCConnectionRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteVPCConnectionRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  void SetVPCConnectionId(VPCConnectionIdT&& value) {
    ...
    m_vPCConnectionId = std::forward<VPCConnectionIdT>(value);
  }
  template <typename VPCConnectionIdT = Aws::String>
  DeleteVPCConnectionRequest& WithVPCConnectionId(VPCConnectionIdT&& value) {
    SetVPCConnectionId(std::forward<VPCConnectionIdT>(value));
    return *this;
  }
  ///@}
 private:
