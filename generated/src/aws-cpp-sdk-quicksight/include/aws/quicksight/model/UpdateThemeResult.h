...
class UpdateThemeResult {
 public:
  ...
  template <typename ThemeIdT = Aws::String>
  UpdateThemeResult& WithThemeId(ThemeIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateThemeResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionArnT = Aws::String>
  UpdateThemeResult& WithVersionArn(VersionArnT&& value) {
  ...
  inline UpdateThemeResult& WithCreationStatus(ResourceStatus value) {
  ...
  inline UpdateThemeResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
