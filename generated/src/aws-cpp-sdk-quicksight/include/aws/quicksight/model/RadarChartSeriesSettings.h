...
class RadarChartSeriesSettings {
 public:
  ...
  void SetAreaStyleSettings(AreaStyleSettingsT&& value) {
    m_areaStyleSettingsHasBeenSet = true;
    m_areaStyleSettings = std::forward<AreaStyleSettingsT>(value);
  }
  template <typename AreaStyleSettingsT = RadarChartAreaStyleSettings>
  RadarChartSeriesSettings& WithAreaStyleSettings(AreaStyleSettingsT&& value) {
    SetAreaStyleSettings(std::forward<AreaStyleSettingsT>(value));
    return *this;
  }
  ///@}
 private:
