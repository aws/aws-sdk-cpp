...
class RestoreAnalysisRequest : public QuickSightRequest {
 public:
  ...
  inline void SetRestoreToFolders(bool value) {
    m_restoreToFoldersHasBeenSet = true;
    m_restoreToFolders = value;
  }
  inline RestoreAnalysisRequest& WithRestoreToFolders(bool value) {
    SetRestoreToFolders(value);
    return *this;
  }
  ///@}
 private:
