...
class ArcConfiguration {
 public:
  ...
  inline void SetArcAngle(double value) {
    m_arcAngleHasBeenSet = true;
    m_arcAngle = value;
  }
  inline ArcConfiguration& WithArcAngle(double value) {
    SetArcAngle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetArcThickness(ArcThicknessOptions value) {
    m_arcThicknessHasBeenSet = true;
    m_arcThickness = value;
  }
  inline ArcConfiguration& WithArcThickness(ArcThicknessOptions value) {
    SetArcThickness(value);
    return *this;
  }
  ///@}
 private:
