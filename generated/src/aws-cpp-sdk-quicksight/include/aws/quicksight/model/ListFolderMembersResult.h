...
class ListFolderMembersResult {
 public:
  ...
  inline ListFolderMembersResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetFolderMemberList(FolderMemberListT&& value) {
    m_folderMemberListHasBeenSet = true;
    m_folderMemberList = std::forward<FolderMemberListT>(value);
  }
  template <typename FolderMemberListT = Aws::Vector<MemberIdArnPair>>
  ListFolderMembersResult& WithFolderMemberList(FolderMemberListT&& value) {
    SetFolderMemberList(std::forward<FolderMemberListT>(value));
    return *this;
  }
  template <typename FolderMemberListT = MemberIdArnPair>
  ListFolderMembersResult& AddFolderMemberList(FolderMemberListT&& value) {
    m_folderMemberListHasBeenSet = true;
    m_folderMemberList.emplace_back(std::forward<FolderMemberListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFolderMembersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFolderMembersResult& WithRequestId(RequestIdT&& value) {
