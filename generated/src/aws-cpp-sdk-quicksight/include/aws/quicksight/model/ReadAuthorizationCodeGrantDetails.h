...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    ReadAuthorizationCodeGrantDetails& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenEndpointT = Aws::String>
    ReadAuthorizationCodeGrantDetails& WithTokenEndpoint(TokenEndpointT&& value) { SetTokenEndpoint(std::forward<TokenEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationEndpointT = Aws::String>
    ReadAuthorizationCodeGrantDetails& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) { SetAuthorizationEndpoint(std::forward<AuthorizationEndpointT>(value)); return *this;}
    ///@}
  private:
