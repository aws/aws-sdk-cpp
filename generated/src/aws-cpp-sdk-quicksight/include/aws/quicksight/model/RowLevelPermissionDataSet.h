...
class RowLevelPermissionDataSet {
 public:
  ...
  inline void SetPermissionPolicy(RowLevelPermissionPolicy value) {
    m_permissionPolicyHasBeenSet = true;
    m_permissionPolicy = value;
  }
  inline RowLevelPermissionDataSet& WithPermissionPolicy(RowLevelPermissionPolicy value) {
  ...
  inline void SetFormatVersion(RowLevelPermissionFormatVersion value) {
    m_formatVersionHasBeenSet = true;
    m_formatVersion = value;
  }
  inline RowLevelPermissionDataSet& WithFormatVersion(RowLevelPermissionFormatVersion value) {
  ...
  inline RowLevelPermissionDataSet& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
