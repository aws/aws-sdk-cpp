...
class ListTopicsResult {
 public:
  ...
  void SetTopicsSummaries(TopicsSummariesT&& value) {
    m_topicsSummariesHasBeenSet = true;
    m_topicsSummaries = std::forward<TopicsSummariesT>(value);
  }
  template <typename TopicsSummariesT = Aws::Vector<TopicSummary>>
  ListTopicsResult& WithTopicsSummaries(TopicsSummariesT&& value) {
    SetTopicsSummaries(std::forward<TopicsSummariesT>(value));
    return *this;
  }
  template <typename TopicsSummariesT = TopicSummary>
  ListTopicsResult& AddTopicsSummaries(TopicsSummariesT&& value) {
    m_topicsSummariesHasBeenSet = true;
    m_topicsSummaries.emplace_back(std::forward<TopicsSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTopicsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
