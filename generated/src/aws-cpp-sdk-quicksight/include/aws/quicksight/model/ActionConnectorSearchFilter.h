...
class ActionConnectorSearchFilter {
 public:
  ...
  inline void SetName(ActionConnectorSearchFilterNameEnum value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ActionConnectorSearchFilter& WithName(ActionConnectorSearchFilterNameEnum value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline ActionConnectorSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  ActionConnectorSearchFilter& WithValue(ValueT&& value) {
