...
class DescribeNamespaceResult {
 public:
  ...
  template <typename NamespaceT = NamespaceInfoV2>
  DescribeNamespaceResult& WithNamespace(NamespaceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeNamespaceResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeNamespaceResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
