...
namespace Model
{
  ...
  public:
    ...
    template<typename UserNameT = Aws::String>
    DeleteUserCustomPermissionRequest& WithUserName(UserNameT&& value) { SetUserName(std::forward<UserNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    DeleteUserCustomPermissionRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DeleteUserCustomPermissionRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
  private:
