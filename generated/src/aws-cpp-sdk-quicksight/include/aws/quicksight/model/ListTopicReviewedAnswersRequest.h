...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListTopicReviewedAnswersRequest();
    ...
    inline ListTopicReviewedAnswersRequest& WithAwsAccountId(const Aws::String& value) { SetAwsAccountId(value); return *this;}
    inline ListTopicReviewedAnswersRequest& WithAwsAccountId(Aws::String&& value) { SetAwsAccountId(std::move(value)); return *this;}
    inline ListTopicReviewedAnswersRequest& WithAwsAccountId(const char* value) { SetAwsAccountId(value); return *this;}
    ///@}
    ...
    inline ListTopicReviewedAnswersRequest& WithTopicId(const Aws::String& value) { SetTopicId(value); return *this;}
    inline ListTopicReviewedAnswersRequest& WithTopicId(Aws::String&& value) { SetTopicId(std::move(value)); return *this;}
    inline ListTopicReviewedAnswersRequest& WithTopicId(const char* value) { SetTopicId(value); return *this;}
    ///@}
  private:
