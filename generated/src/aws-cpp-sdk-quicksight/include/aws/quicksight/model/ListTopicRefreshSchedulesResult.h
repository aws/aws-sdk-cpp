...
class ListTopicRefreshSchedulesResult {
 public:
  ...
  template <typename TopicIdT = Aws::String>
  ListTopicRefreshSchedulesResult& WithTopicId(TopicIdT&& value) {
  ...
  template <typename TopicArnT = Aws::String>
  ListTopicRefreshSchedulesResult& WithTopicArn(TopicArnT&& value) {
  ...
  template <typename RefreshSchedulesT = Aws::Vector<TopicRefreshScheduleSummary>>
  ListTopicRefreshSchedulesResult& WithRefreshSchedules(RefreshSchedulesT&& value) {
    SetRefreshSchedules(std::forward<RefreshSchedulesT>(value));
    return *this;
  }
  template <typename RefreshSchedulesT = TopicRefreshScheduleSummary>
  ListTopicRefreshSchedulesResult& AddRefreshSchedules(RefreshSchedulesT&& value) {
    m_refreshSchedulesHasBeenSet = true;
  ...
  inline ListTopicRefreshSchedulesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTopicRefreshSchedulesResult& WithRequestId(RequestIdT&& value) {
