...
class DeleteTemplateResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  DeleteTemplateResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DeleteTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  DeleteTemplateResult& WithTemplateId(TemplateIdT&& value) {
  ...
  inline DeleteTemplateResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
