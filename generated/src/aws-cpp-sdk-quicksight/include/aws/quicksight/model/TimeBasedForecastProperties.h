...
class TimeBasedForecastProperties {
 public:
  ...
  inline TimeBasedForecastProperties& WithPeriodsForward(int value) {
  ...
  inline TimeBasedForecastProperties& WithPeriodsBackward(int value) {
  ...
  inline TimeBasedForecastProperties& WithUpperBoundary(double value) {
  ...
  inline TimeBasedForecastProperties& WithLowerBoundary(double value) {
  ...
  inline TimeBasedForecastProperties& WithPredictionInterval(int value) {
  ...
  inline void SetSeasonality(int value) {
    m_seasonalityHasBeenSet = true;
    m_seasonality = value;
  }
  inline TimeBasedForecastProperties& WithSeasonality(int value) {
