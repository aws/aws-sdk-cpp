...
class DescribeBrandPublishedVersionResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBrandPublishedVersionResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename BrandDetailT = BrandDetail>
  DescribeBrandPublishedVersionResult& WithBrandDetail(BrandDetailT&& value) {
  ...
  template <typename BrandDefinitionT = BrandDefinition>
  DescribeBrandPublishedVersionResult& WithBrandDefinition(BrandDefinitionT&& value) {
