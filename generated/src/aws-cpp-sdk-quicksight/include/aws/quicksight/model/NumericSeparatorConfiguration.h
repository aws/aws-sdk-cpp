...
class NumericSeparatorConfiguration {
 public:
  ...
  inline void SetDecimalSeparator(NumericSeparatorSymbol value) {
    m_decimalSeparatorHasBeenSet = true;
    m_decimalSeparator = value;
  }
  inline NumericSeparatorConfiguration& WithDecimalSeparator(NumericSeparatorSymbol value) {
  ...
  void SetThousandsSeparator(ThousandsSeparatorT&& value) {
    ...
    m_thousandsSeparator = std::forward<ThousandsSeparatorT>(value);
  }
  template <typename ThousandsSeparatorT = ThousandSeparatorOptions>
  NumericSeparatorConfiguration& WithThousandsSeparator(ThousandsSeparatorT&& value) {
    SetThousandsSeparator(std::forward<ThousandsSeparatorT>(value));
    return *this;
  }
  ///@}
 private:
