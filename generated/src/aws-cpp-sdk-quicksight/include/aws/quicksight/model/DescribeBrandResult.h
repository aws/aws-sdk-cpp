...
class DescribeBrandResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  DescribeBrandResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetBrandDetail(BrandDetailT&& value) {
    m_brandDetailHasBeenSet = true;
    m_brandDetail = std::forward<BrandDetailT>(value);
  }
  template <typename BrandDetailT = BrandDetail>
  DescribeBrandResult& WithBrandDetail(BrandDetailT&& value) {
    SetBrandDetail(std::forward<BrandDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBrandDefinition(BrandDefinitionT&& value) {
    ...
    m_brandDefinition = std::forward<BrandDefinitionT>(value);
  }
  template <typename BrandDefinitionT = BrandDefinition>
  DescribeBrandResult& WithBrandDefinition(BrandDefinitionT&& value) {
    SetBrandDefinition(std::forward<BrandDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
