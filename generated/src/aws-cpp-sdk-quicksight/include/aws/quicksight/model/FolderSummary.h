...
/**
 * <p>A summary of information about an existing Quick Sight folder. </p><p><h3>See
 * Also:</h3>   <a
...
class FolderSummary {
 public:
  ...
  inline FolderSummary& WithFolderType(FolderType value) {
    SetFolderType(value);
    return *this;
  }
  ///@}
  ...
  inline FolderSummary& WithSharingModel(SharingModel value) {
