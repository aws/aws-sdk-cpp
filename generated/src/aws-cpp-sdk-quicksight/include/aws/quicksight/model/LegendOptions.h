...
class LegendOptions {
 public:
  ...
  inline LegendOptions& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPosition(LegendPosition value) {
    m_positionHasBeenSet = true;
    m_position = value;
  }
  inline LegendOptions& WithPosition(LegendPosition value) {
    SetPosition(value);
    return *this;
  }
  ///@}
  ...
  void SetValueFontConfiguration(ValueFontConfigurationT&& value) {
    ...
    m_valueFontConfiguration = std::forward<ValueFontConfigurationT>(value);
  }
  template <typename ValueFontConfigurationT = FontConfiguration>
  LegendOptions& WithValueFontConfiguration(ValueFontConfigurationT&& value) {
    SetValueFontConfiguration(std::forward<ValueFontConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
