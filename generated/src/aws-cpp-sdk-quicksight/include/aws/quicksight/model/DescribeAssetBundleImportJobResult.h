...
class DescribeAssetBundleImportJobResult {
 public:
  ...
  inline void SetJobStatus(AssetBundleImportJobStatus value) {
    m_jobStatusHasBeenSet = true;
    m_jobStatus = value;
  }
  inline DescribeAssetBundleImportJobResult& WithJobStatus(AssetBundleImportJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorsT = Aws::Vector<AssetBundleImportJobError>>
  DescribeAssetBundleImportJobResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = AssetBundleImportJobError>
  DescribeAssetBundleImportJobResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  void SetRollbackErrors(RollbackErrorsT&& value) {
    m_rollbackErrorsHasBeenSet = true;
    m_rollbackErrors = std::forward<RollbackErrorsT>(value);
  }
  template <typename RollbackErrorsT = Aws::Vector<AssetBundleImportJobError>>
  DescribeAssetBundleImportJobResult& WithRollbackErrors(RollbackErrorsT&& value) {
    SetRollbackErrors(std::forward<RollbackErrorsT>(value));
    return *this;
  }
  template <typename RollbackErrorsT = AssetBundleImportJobError>
  DescribeAssetBundleImportJobResult& AddRollbackErrors(RollbackErrorsT&& value) {
    m_rollbackErrorsHasBeenSet = true;
    m_rollbackErrors.emplace_back(std::forward<RollbackErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  DescribeAssetBundleImportJobResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  DescribeAssetBundleImportJobResult& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename AssetBundleImportJobIdT = Aws::String>
  DescribeAssetBundleImportJobResult& WithAssetBundleImportJobId(AssetBundleImportJobIdT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeAssetBundleImportJobResult& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  void SetAssetBundleImportSource(AssetBundleImportSourceT&& value) {
    m_assetBundleImportSourceHasBeenSet = true;
    m_assetBundleImportSource = std::forward<AssetBundleImportSourceT>(value);
  }
  template <typename AssetBundleImportSourceT = AssetBundleImportSourceDescription>
  DescribeAssetBundleImportJobResult& WithAssetBundleImportSource(AssetBundleImportSourceT&& value) {
    SetAssetBundleImportSource(std::forward<AssetBundleImportSourceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OverrideParametersT = AssetBundleImportJobOverrideParameters>
  DescribeAssetBundleImportJobResult& WithOverrideParameters(OverrideParametersT&& value) {
  ...
  inline void SetFailureAction(AssetBundleImportFailureAction value) {
    m_failureActionHasBeenSet = true;
    m_failureAction = value;
  }
  inline DescribeAssetBundleImportJobResult& WithFailureAction(AssetBundleImportFailureAction value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAssetBundleImportJobResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeAssetBundleImportJobResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetOverridePermissions(OverridePermissionsT&& value) {
    m_overridePermissionsHasBeenSet = true;
    m_overridePermissions = std::forward<OverridePermissionsT>(value);
  }
  template <typename OverridePermissionsT = AssetBundleImportJobOverridePermissions>
  DescribeAssetBundleImportJobResult& WithOverridePermissions(OverridePermissionsT&& value) {
    SetOverridePermissions(std::forward<OverridePermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOverrideTags(OverrideTagsT&& value) {
    m_overrideTagsHasBeenSet = true;
    m_overrideTags = std::forward<OverrideTagsT>(value);
  }
  template <typename OverrideTagsT = AssetBundleImportJobOverrideTags>
  DescribeAssetBundleImportJobResult& WithOverrideTags(OverrideTagsT&& value) {
    SetOverrideTags(std::forward<OverrideTagsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AssetBundleImportJobOverrideValidationStrategy& GetOverrideValidationStrategy() const {
    return m_overrideValidationStrategy;
  }
  template <typename OverrideValidationStrategyT = AssetBundleImportJobOverrideValidationStrategy>
  void SetOverrideValidationStrategy(OverrideValidationStrategyT&& value) {
    m_overrideValidationStrategyHasBeenSet = true;
    m_overrideValidationStrategy = std::forward<OverrideValidationStrategyT>(value);
  }
  template <typename OverrideValidationStrategyT = AssetBundleImportJobOverrideValidationStrategy>
  DescribeAssetBundleImportJobResult& WithOverrideValidationStrategy(OverrideValidationStrategyT&& value) {
    SetOverrideValidationStrategy(std::forward<OverrideValidationStrategyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WarningsT = Aws::Vector<AssetBundleImportJobWarning>>
  DescribeAssetBundleImportJobResult& WithWarnings(WarningsT&& value) {
    SetWarnings(std::forward<WarningsT>(value));
    return *this;
  }
  template <typename WarningsT = AssetBundleImportJobWarning>
  DescribeAssetBundleImportJobResult& AddWarnings(WarningsT&& value) {
    m_warningsHasBeenSet = true;
