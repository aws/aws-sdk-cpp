...
class AnalysisSearchFilter {
 public:
  ...
  inline AnalysisSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(AnalysisFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalysisSearchFilter& WithName(AnalysisFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AnalysisSearchFilter& WithValue(ValueT&& value) {
