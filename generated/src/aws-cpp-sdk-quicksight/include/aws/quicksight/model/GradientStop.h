...
class GradientStop {
 public:
  ...
  inline void SetGradientOffset(double value) {
    m_gradientOffsetHasBeenSet = true;
    m_gradientOffset = value;
  }
  inline GradientStop& WithGradientOffset(double value) {
    SetGradientOffset(value);
    return *this;
  }
  ///@}
  ...
  inline GradientStop& WithDataValue(double value) {
    SetDataValue(value);
    return *this;
  }
  ///@}
