...
/**
 * <p>A filter condition that filters date values within a specified
 * range.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DataSetDateRangeFilterCondition">AWS
 * API Reference</a></p>
 */
class DataSetDateRangeFilterCondition {
 public:
  AWS_QUICKSIGHT_API DataSetDateRangeFilterCondition() = default;
  AWS_QUICKSIGHT_API DataSetDateRangeFilterCondition(Aws::Utils::Json::JsonView jsonValue);
  AWS_QUICKSIGHT_API DataSetDateRangeFilterCondition& operator=(Aws::Utils::Json::JsonView jsonValue);
   ...
   */
  inline const DataSetDateFilterValue& GetRangeMinimum() const { return m_rangeMinimum; }
  inline bool RangeMinimumHasBeenSet() const { return m_rangeMinimumHasBeenSet; }
  template <typename RangeMinimumT = DataSetDateFilterValue>
  void SetRangeMinimum(RangeMinimumT&& value) {
    m_rangeMinimumHasBeenSet = true;
    m_rangeMinimum = std::forward<RangeMinimumT>(value);
  }
  template <typename RangeMinimumT = DataSetDateFilterValue>
  DataSetDateRangeFilterCondition& WithRangeMinimum(RangeMinimumT&& value) {
   ...
   */
  inline const DataSetDateFilterValue& GetRangeMaximum() const { return m_rangeMaximum; }
  inline bool RangeMaximumHasBeenSet() const { return m_rangeMaximumHasBeenSet; }
  template <typename RangeMaximumT = DataSetDateFilterValue>
  void SetRangeMaximum(RangeMaximumT&& value) {
    m_rangeMaximumHasBeenSet = true;
    m_rangeMaximum = std::forward<RangeMaximumT>(value);
  }
  template <typename RangeMaximumT = DataSetDateFilterValue>
  DataSetDateRangeFilterCondition& WithRangeMaximum(RangeMaximumT&& value) {
  ...
  inline DataSetDateRangeFilterCondition& WithIncludeMinimum(bool value) {
  ...
  inline DataSetDateRangeFilterCondition& WithIncludeMaximum(bool value) {
