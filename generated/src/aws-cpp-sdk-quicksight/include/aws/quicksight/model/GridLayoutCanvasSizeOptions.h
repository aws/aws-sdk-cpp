...
class GridLayoutCanvasSizeOptions {
 public:
  ...
  void SetScreenCanvasSizeOptions(ScreenCanvasSizeOptionsT&& value) {
    m_screenCanvasSizeOptionsHasBeenSet = true;
    m_screenCanvasSizeOptions = std::forward<ScreenCanvasSizeOptionsT>(value);
  }
  template <typename ScreenCanvasSizeOptionsT = GridLayoutScreenCanvasSizeOptions>
  GridLayoutCanvasSizeOptions& WithScreenCanvasSizeOptions(ScreenCanvasSizeOptionsT&& value) {
    SetScreenCanvasSizeOptions(std::forward<ScreenCanvasSizeOptionsT>(value));
    return *this;
  }
  ///@}
 private:
