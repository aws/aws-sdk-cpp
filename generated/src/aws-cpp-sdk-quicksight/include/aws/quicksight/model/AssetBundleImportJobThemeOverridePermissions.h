...
class AssetBundleImportJobThemeOverridePermissions {
 public:
  ...
  void SetThemeIds(ThemeIdsT&& value) {
    m_themeIdsHasBeenSet = true;
    m_themeIds = std::forward<ThemeIdsT>(value);
  }
  template <typename ThemeIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobThemeOverridePermissions& WithThemeIds(ThemeIdsT&& value) {
    SetThemeIds(std::forward<ThemeIdsT>(value));
    return *this;
  }
  template <typename ThemeIdsT = Aws::String>
  AssetBundleImportJobThemeOverridePermissions& AddThemeIds(ThemeIdsT&& value) {
    m_themeIdsHasBeenSet = true;
    m_themeIds.emplace_back(std::forward<ThemeIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PermissionsT = AssetBundleResourcePermissions>
  AssetBundleImportJobThemeOverridePermissions& WithPermissions(PermissionsT&& value) {
