...
class TransformOperation {
 public:
  ...
  void SetProjectOperation(ProjectOperationT&& value) {
    ...
    m_projectOperation = std::forward<ProjectOperationT>(value);
  }
  template <typename ProjectOperationT = ProjectOperation>
  TransformOperation& WithProjectOperation(ProjectOperationT&& value) {
    SetProjectOperation(std::forward<ProjectOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterOperation(FilterOperationT&& value) {
    ...
    m_filterOperation = std::forward<FilterOperationT>(value);
  }
  template <typename FilterOperationT = FilterOperation>
  TransformOperation& WithFilterOperation(FilterOperationT&& value) {
    SetFilterOperation(std::forward<FilterOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateColumnsOperation(CreateColumnsOperationT&& value) {
    ...
    m_createColumnsOperation = std::forward<CreateColumnsOperationT>(value);
  }
  template <typename CreateColumnsOperationT = CreateColumnsOperation>
  TransformOperation& WithCreateColumnsOperation(CreateColumnsOperationT&& value) {
    SetCreateColumnsOperation(std::forward<CreateColumnsOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRenameColumnOperation(RenameColumnOperationT&& value) {
    ...
    m_renameColumnOperation = std::forward<RenameColumnOperationT>(value);
  }
  template <typename RenameColumnOperationT = RenameColumnOperation>
  TransformOperation& WithRenameColumnOperation(RenameColumnOperationT&& value) {
    SetRenameColumnOperation(std::forward<RenameColumnOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCastColumnTypeOperation(CastColumnTypeOperationT&& value) {
    ...
    m_castColumnTypeOperation = std::forward<CastColumnTypeOperationT>(value);
  }
  template <typename CastColumnTypeOperationT = CastColumnTypeOperation>
  TransformOperation& WithCastColumnTypeOperation(CastColumnTypeOperationT&& value) {
    SetCastColumnTypeOperation(std::forward<CastColumnTypeOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagColumnOperation(TagColumnOperationT&& value) {
    ...
    m_tagColumnOperation = std::forward<TagColumnOperationT>(value);
  }
  template <typename TagColumnOperationT = TagColumnOperation>
  TransformOperation& WithTagColumnOperation(TagColumnOperationT&& value) {
    SetTagColumnOperation(std::forward<TagColumnOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUntagColumnOperation(UntagColumnOperationT&& value) {
    ...
    m_untagColumnOperation = std::forward<UntagColumnOperationT>(value);
  }
  template <typename UntagColumnOperationT = UntagColumnOperation>
  TransformOperation& WithUntagColumnOperation(UntagColumnOperationT&& value) {
    SetUntagColumnOperation(std::forward<UntagColumnOperationT>(value));
    return *this;
  }
  ///@}
  ...
  inline const OverrideDatasetParameterOperation& GetOverrideDatasetParameterOperation() const {
    return m_overrideDatasetParameterOperation;
  }
  ...
  void SetOverrideDatasetParameterOperation(OverrideDatasetParameterOperationT&& value) {
    ...
    m_overrideDatasetParameterOperation = std::forward<OverrideDatasetParameterOperationT>(value);
  }
  template <typename OverrideDatasetParameterOperationT = OverrideDatasetParameterOperation>
  TransformOperation& WithOverrideDatasetParameterOperation(OverrideDatasetParameterOperationT&& value) {
    SetOverrideDatasetParameterOperation(std::forward<OverrideDatasetParameterOperationT>(value));
    return *this;
  }
  ///@}
 private:
