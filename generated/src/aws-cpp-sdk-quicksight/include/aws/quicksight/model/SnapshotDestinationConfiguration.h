...
class SnapshotDestinationConfiguration {
 public:
  ...
  void SetS3Destinations(S3DestinationsT&& value) {
    ...
    m_s3Destinations = std::forward<S3DestinationsT>(value);
  }
  template <typename S3DestinationsT = Aws::Vector<SnapshotS3DestinationConfiguration>>
  SnapshotDestinationConfiguration& WithS3Destinations(S3DestinationsT&& value) {
    SetS3Destinations(std::forward<S3DestinationsT>(value));
    return *this;
  }
  ...
  SnapshotDestinationConfiguration& AddS3Destinations(S3DestinationsT&& value) {
    m_s3DestinationsHasBeenSet = true;
    m_s3Destinations.emplace_back(std::forward<S3DestinationsT>(value));
    return *this;
  }
  ///@}
 private:
