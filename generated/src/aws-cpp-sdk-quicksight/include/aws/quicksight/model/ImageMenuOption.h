...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ImageMenuOption();
    ...
    inline ImageMenuOption& WithAvailabilityStatus(const DashboardBehavior& value) { SetAvailabilityStatus(value); return *this;}
    inline ImageMenuOption& WithAvailabilityStatus(DashboardBehavior&& value) { SetAvailabilityStatus(std::move(value)); return *this;}
    ///@}
  private:
