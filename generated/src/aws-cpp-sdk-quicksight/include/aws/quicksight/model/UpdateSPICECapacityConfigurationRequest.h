...
class UpdateSPICECapacityConfigurationRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateSPICECapacityConfigurationRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline void SetPurchaseMode(PurchaseMode value) {
    m_purchaseModeHasBeenSet = true;
    m_purchaseMode = value;
  }
  inline UpdateSPICECapacityConfigurationRequest& WithPurchaseMode(PurchaseMode value) {
