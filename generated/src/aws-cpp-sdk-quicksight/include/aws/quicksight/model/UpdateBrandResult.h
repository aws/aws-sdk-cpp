...
class UpdateBrandResult {
 public:
  AWS_QUICKSIGHT_API UpdateBrandResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBrandResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename BrandDetailT = BrandDetail>
  UpdateBrandResult& WithBrandDetail(BrandDetailT&& value) {
  ...
  template <typename BrandDefinitionT = BrandDefinition>
  UpdateBrandResult& WithBrandDefinition(BrandDefinitionT&& value) {
