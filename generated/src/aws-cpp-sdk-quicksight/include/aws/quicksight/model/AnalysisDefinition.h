...
class AnalysisDefinition {
 public:
  ...
  ///@{
  /**
   * <p>An array of topic identifier declarations. This mapping allows the usage of
   * topic identifiers instead of topic ARNs throughout analysis sub-structures.</p>
   */
  ...
  ///@{
  /**
   * <p>An array of tooltip sheet definitions for an analysis. Each
   * <code>TooltipSheetDefinition</code> provides detailed information about a
   * tooltip sheet within this analysis.</p>
   */
  ...
  void SetQueryExecutionOptions(QueryExecutionOptionsT&& value) {
    ...
    m_queryExecutionOptions = std::forward<QueryExecutionOptionsT>(value);
  }
  template <typename QueryExecutionOptionsT = QueryExecutionOptions>
  AnalysisDefinition& WithQueryExecutionOptions(QueryExecutionOptionsT&& value) {
    SetQueryExecutionOptions(std::forward<QueryExecutionOptionsT>(value));
    return *this;
  }
  ///@}
