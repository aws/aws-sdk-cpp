...
class NavbarStyle {
 public:
  ...
  void SetGlobalNavbar(GlobalNavbarT&& value) {
    ...
    m_globalNavbar = std::forward<GlobalNavbarT>(value);
  }
  template <typename GlobalNavbarT = Palette>
  NavbarStyle& WithGlobalNavbar(GlobalNavbarT&& value) {
    SetGlobalNavbar(std::forward<GlobalNavbarT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContextualNavbar(ContextualNavbarT&& value) {
    ...
    m_contextualNavbar = std::forward<ContextualNavbarT>(value);
  }
  template <typename ContextualNavbarT = Palette>
  NavbarStyle& WithContextualNavbar(ContextualNavbarT&& value) {
    SetContextualNavbar(std::forward<ContextualNavbarT>(value));
    return *this;
  }
  ///@}
 private:
