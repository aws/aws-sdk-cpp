...
class ConditionalFormattingIconDisplayConfiguration {
 public:
  ...
  inline void SetIconDisplayOption(ConditionalFormattingIconDisplayOption value) {
    m_iconDisplayOptionHasBeenSet = true;
    m_iconDisplayOption = value;
  }
  inline ConditionalFormattingIconDisplayConfiguration& WithIconDisplayOption(ConditionalFormattingIconDisplayOption value) {
    SetIconDisplayOption(value);
    return *this;
  }
  ///@}
 private:
