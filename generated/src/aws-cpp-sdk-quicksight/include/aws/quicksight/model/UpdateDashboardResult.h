...
class UpdateDashboardResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateDashboardResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionArnT = Aws::String>
  UpdateDashboardResult& WithVersionArn(VersionArnT&& value) {
  ...
  template <typename DashboardIdT = Aws::String>
  UpdateDashboardResult& WithDashboardId(DashboardIdT&& value) {
  ...
  inline UpdateDashboardResult& WithCreationStatus(ResourceStatus value) {
  ...
  inline UpdateDashboardResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
