...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API UpdateDashboardResult() = default;
    ...
    template<typename ArnT = Aws::String>
    UpdateDashboardResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionArnT = Aws::String>
    UpdateDashboardResult& WithVersionArn(VersionArnT&& value) { SetVersionArn(std::forward<VersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DashboardIdT = Aws::String>
    UpdateDashboardResult& WithDashboardId(DashboardIdT&& value) { SetDashboardId(std::forward<DashboardIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateDashboardResult& WithCreationStatus(ResourceStatus value) { SetCreationStatus(value); return *this;}
    ///@}
