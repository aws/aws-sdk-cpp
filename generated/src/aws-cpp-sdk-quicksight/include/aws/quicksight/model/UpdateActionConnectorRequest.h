...
namespace Model
{
  ...
  public:
    ...
    template<typename AwsAccountIdT = Aws::String>
    UpdateActionConnectorRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionConnectorIdT = Aws::String>
    UpdateActionConnectorRequest& WithActionConnectorId(ActionConnectorIdT&& value) { SetActionConnectorId(std::forward<ActionConnectorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    UpdateActionConnectorRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthenticationConfigT = AuthConfig>
    UpdateActionConnectorRequest& WithAuthenticationConfig(AuthenticationConfigT&& value) { SetAuthenticationConfig(std::forward<AuthenticationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateActionConnectorRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcConnectionArnT = Aws::String>
    UpdateActionConnectorRequest& WithVpcConnectionArn(VpcConnectionArnT&& value) { SetVpcConnectionArn(std::forward<VpcConnectionArnT>(value)); return *this;}
    ///@}
  private:
