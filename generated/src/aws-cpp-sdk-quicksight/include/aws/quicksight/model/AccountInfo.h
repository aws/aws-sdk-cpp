...
class AccountInfo {
 public:
  ...
  inline AccountInfo& WithEdition(Edition value) {
    SetEdition(value);
    return *this;
  }
  ///@}
  ...
  void SetAccountSubscriptionStatus(AccountSubscriptionStatusT&& value) {
    ...
    m_accountSubscriptionStatus = std::forward<AccountSubscriptionStatusT>(value);
  }
  template <typename AccountSubscriptionStatusT = Aws::String>
  AccountInfo& WithAccountSubscriptionStatus(AccountSubscriptionStatusT&& value) {
    SetAccountSubscriptionStatus(std::forward<AccountSubscriptionStatusT>(value));
    return *this;
  }
  ///@}
