...
class PercentageDisplayFormatConfiguration {
 public:
  ...
  template <typename PrefixT = Aws::String>
  PercentageDisplayFormatConfiguration& WithPrefix(PrefixT&& value) {
  ...
  template <typename SuffixT = Aws::String>
  PercentageDisplayFormatConfiguration& WithSuffix(SuffixT&& value) {
  ...
  template <typename SeparatorConfigurationT = NumericSeparatorConfiguration>
  PercentageDisplayFormatConfiguration& WithSeparatorConfiguration(SeparatorConfigurationT&& value) {
  ...
  template <typename DecimalPlacesConfigurationT = DecimalPlacesConfiguration>
  PercentageDisplayFormatConfiguration& WithDecimalPlacesConfiguration(DecimalPlacesConfigurationT&& value) {
  ...
  template <typename NegativeValueConfigurationT = NegativeValueConfiguration>
  PercentageDisplayFormatConfiguration& WithNegativeValueConfiguration(NegativeValueConfigurationT&& value) {
  ...
  template <typename NullValueFormatConfigurationT = NullValueFormatConfiguration>
  PercentageDisplayFormatConfiguration& WithNullValueFormatConfiguration(NullValueFormatConfigurationT&& value) {
