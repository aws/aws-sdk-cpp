...
/**
 * <p>Options that determine the presentation of a series in the
 * visual.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ComboChartSeriesSettings">AWS
 * API Reference</a></p>
 */
