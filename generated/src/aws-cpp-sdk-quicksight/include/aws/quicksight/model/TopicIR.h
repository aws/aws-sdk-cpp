...
class TopicIR {
 public:
  ...
  void SetGroupByList(GroupByListT&& value) {
    ...
    m_groupByList = std::forward<GroupByListT>(value);
  }
  template <typename GroupByListT = Aws::Vector<TopicIRGroupBy>>
  TopicIR& WithGroupByList(GroupByListT&& value) {
    SetGroupByList(std::forward<GroupByListT>(value));
    return *this;
  }
  template <typename GroupByListT = TopicIRGroupBy>
  TopicIR& AddGroupByList(GroupByListT&& value) {
    m_groupByListHasBeenSet = true;
    m_groupByList.emplace_back(std::forward<GroupByListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContributionAnalysis(ContributionAnalysisT&& value) {
    ...
    m_contributionAnalysis = std::forward<ContributionAnalysisT>(value);
  }
  template <typename ContributionAnalysisT = TopicIRContributionAnalysis>
  TopicIR& WithContributionAnalysis(ContributionAnalysisT&& value) {
    SetContributionAnalysis(std::forward<ContributionAnalysisT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisual(VisualT&& value) {
    ...
    m_visual = std::forward<VisualT>(value);
  }
  template <typename VisualT = VisualOptions>
  TopicIR& WithVisual(VisualT&& value) {
    SetVisual(std::forward<VisualT>(value));
    return *this;
  }
  ///@}
 private:
