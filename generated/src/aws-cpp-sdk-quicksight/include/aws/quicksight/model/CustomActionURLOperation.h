...
class CustomActionURLOperation {
 public:
  ...
  void SetURLTemplate(URLTemplateT&& value) {
    ...
    m_uRLTemplate = std::forward<URLTemplateT>(value);
  }
  template <typename URLTemplateT = Aws::String>
  CustomActionURLOperation& WithURLTemplate(URLTemplateT&& value) {
    SetURLTemplate(std::forward<URLTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetURLTarget(URLTargetConfiguration value) {
    m_uRLTargetHasBeenSet = true;
    m_uRLTarget = value;
  }
  inline CustomActionURLOperation& WithURLTarget(URLTargetConfiguration value) {
    SetURLTarget(value);
    return *this;
  }
  ///@}
