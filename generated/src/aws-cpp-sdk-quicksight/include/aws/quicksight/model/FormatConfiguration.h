...
class FormatConfiguration {
 public:
  ...
  void SetStringFormatConfiguration(StringFormatConfigurationT&& value) {
    ...
    m_stringFormatConfiguration = std::forward<StringFormatConfigurationT>(value);
  }
  template <typename StringFormatConfigurationT = StringFormatConfiguration>
  FormatConfiguration& WithStringFormatConfiguration(StringFormatConfigurationT&& value) {
    SetStringFormatConfiguration(std::forward<StringFormatConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNumberFormatConfiguration(NumberFormatConfigurationT&& value) {
    ...
    m_numberFormatConfiguration = std::forward<NumberFormatConfigurationT>(value);
  }
  template <typename NumberFormatConfigurationT = NumberFormatConfiguration>
  FormatConfiguration& WithNumberFormatConfiguration(NumberFormatConfigurationT&& value) {
    SetNumberFormatConfiguration(std::forward<NumberFormatConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateTimeFormatConfiguration(DateTimeFormatConfigurationT&& value) {
    ...
    m_dateTimeFormatConfiguration = std::forward<DateTimeFormatConfigurationT>(value);
  }
  template <typename DateTimeFormatConfigurationT = DateTimeFormatConfiguration>
  FormatConfiguration& WithDateTimeFormatConfiguration(DateTimeFormatConfigurationT&& value) {
    SetDateTimeFormatConfiguration(std::forward<DateTimeFormatConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
