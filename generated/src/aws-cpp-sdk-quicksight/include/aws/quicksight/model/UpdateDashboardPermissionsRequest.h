...
class UpdateDashboardPermissionsRequest : public QuickSightRequest {
 public:
  ...
  void SetGrantLinkPermissions(GrantLinkPermissionsT&& value) {
    m_grantLinkPermissionsHasBeenSet = true;
    m_grantLinkPermissions = std::forward<GrantLinkPermissionsT>(value);
  }
  template <typename GrantLinkPermissionsT = Aws::Vector<ResourcePermission>>
  UpdateDashboardPermissionsRequest& WithGrantLinkPermissions(GrantLinkPermissionsT&& value) {
    SetGrantLinkPermissions(std::forward<GrantLinkPermissionsT>(value));
    return *this;
  }
  ...
  UpdateDashboardPermissionsRequest& AddGrantLinkPermissions(GrantLinkPermissionsT&& value) {
    m_grantLinkPermissionsHasBeenSet = true;
    m_grantLinkPermissions.emplace_back(std::forward<GrantLinkPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRevokeLinkPermissions(RevokeLinkPermissionsT&& value) {
    m_revokeLinkPermissionsHasBeenSet = true;
    m_revokeLinkPermissions = std::forward<RevokeLinkPermissionsT>(value);
  }
  template <typename RevokeLinkPermissionsT = Aws::Vector<ResourcePermission>>
  UpdateDashboardPermissionsRequest& WithRevokeLinkPermissions(RevokeLinkPermissionsT&& value) {
    SetRevokeLinkPermissions(std::forward<RevokeLinkPermissionsT>(value));
    return *this;
  }
  ...
  UpdateDashboardPermissionsRequest& AddRevokeLinkPermissions(RevokeLinkPermissionsT&& value) {
    m_revokeLinkPermissionsHasBeenSet = true;
    m_revokeLinkPermissions.emplace_back(std::forward<RevokeLinkPermissionsT>(value));
    return *this;
  }
  ///@}
 private:
