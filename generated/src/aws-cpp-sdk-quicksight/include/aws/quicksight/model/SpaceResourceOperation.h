...
/**
 * <p>An operation to perform on a resource in a space.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SpaceResourceOperation">AWS
 * API Reference</a></p>
 */
class SpaceResourceOperation {
 public:
  ...
  inline SpaceResourceOperation& WithResourceType(SpaceQuickSightResourceType value) {
