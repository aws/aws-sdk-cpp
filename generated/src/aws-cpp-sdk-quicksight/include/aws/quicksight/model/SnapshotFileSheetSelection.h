...
class SnapshotFileSheetSelection {
 public:
  ...
  inline void SetSelectionScope(SnapshotFileSheetSelectionScope value) {
    m_selectionScopeHasBeenSet = true;
    m_selectionScope = value;
  }
  inline SnapshotFileSheetSelection& WithSelectionScope(SnapshotFileSheetSelectionScope value) {
