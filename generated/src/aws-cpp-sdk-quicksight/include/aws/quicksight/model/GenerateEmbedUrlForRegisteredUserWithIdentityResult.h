...
class GenerateEmbedUrlForRegisteredUserWithIdentityResult {
 public:
  ...
  AWS_QUICKSIGHT_API GenerateEmbedUrlForRegisteredUserWithIdentityResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EmbedUrlT = Aws::String>
  GenerateEmbedUrlForRegisteredUserWithIdentityResult& WithEmbedUrl(EmbedUrlT&& value) {
  ...
  inline GenerateEmbedUrlForRegisteredUserWithIdentityResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GenerateEmbedUrlForRegisteredUserWithIdentityResult& WithRequestId(RequestIdT&& value) {
