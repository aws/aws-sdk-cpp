...
class DatasetParameter {
 public:
  ...
  void SetStringDatasetParameter(StringDatasetParameterT&& value) {
    ...
    m_stringDatasetParameter = std::forward<StringDatasetParameterT>(value);
  }
  template <typename StringDatasetParameterT = StringDatasetParameter>
  DatasetParameter& WithStringDatasetParameter(StringDatasetParameterT&& value) {
    SetStringDatasetParameter(std::forward<StringDatasetParameterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalDatasetParameter(DecimalDatasetParameterT&& value) {
    ...
    m_decimalDatasetParameter = std::forward<DecimalDatasetParameterT>(value);
  }
  template <typename DecimalDatasetParameterT = DecimalDatasetParameter>
  DatasetParameter& WithDecimalDatasetParameter(DecimalDatasetParameterT&& value) {
    SetDecimalDatasetParameter(std::forward<DecimalDatasetParameterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegerDatasetParameter(IntegerDatasetParameterT&& value) {
    ...
    m_integerDatasetParameter = std::forward<IntegerDatasetParameterT>(value);
  }
  template <typename IntegerDatasetParameterT = IntegerDatasetParameter>
  DatasetParameter& WithIntegerDatasetParameter(IntegerDatasetParameterT&& value) {
    SetIntegerDatasetParameter(std::forward<IntegerDatasetParameterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateTimeDatasetParameter(DateTimeDatasetParameterT&& value) {
    ...
    m_dateTimeDatasetParameter = std::forward<DateTimeDatasetParameterT>(value);
  }
  template <typename DateTimeDatasetParameterT = DateTimeDatasetParameter>
  DatasetParameter& WithDateTimeDatasetParameter(DateTimeDatasetParameterT&& value) {
    SetDateTimeDatasetParameter(std::forward<DateTimeDatasetParameterT>(value));
    return *this;
  }
  ///@}
 private:
