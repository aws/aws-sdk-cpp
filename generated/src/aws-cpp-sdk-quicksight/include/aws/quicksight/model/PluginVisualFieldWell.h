...
class PluginVisualFieldWell {
 public:
  ...
  inline void SetAxisName(PluginVisualAxisName value) {
    m_axisNameHasBeenSet = true;
    m_axisName = value;
  }
  inline PluginVisualFieldWell& WithAxisName(PluginVisualAxisName value) {
    SetAxisName(value);
    return *this;
  }
  ///@}
