...
class FunnelChartConfiguration {
 public:
  ...
  void SetValueLabelOptions(ValueLabelOptionsT&& value) {
    ...
    m_valueLabelOptions = std::forward<ValueLabelOptionsT>(value);
  }
  template <typename ValueLabelOptionsT = ChartAxisLabelOptions>
  FunnelChartConfiguration& WithValueLabelOptions(ValueLabelOptionsT&& value) {
    SetValueLabelOptions(std::forward<ValueLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataLabelOptions(DataLabelOptionsT&& value) {
    ...
    m_dataLabelOptions = std::forward<DataLabelOptionsT>(value);
  }
  template <typename DataLabelOptionsT = FunnelChartDataLabelOptions>
  FunnelChartConfiguration& WithDataLabelOptions(DataLabelOptionsT&& value) {
    SetDataLabelOptions(std::forward<DataLabelOptionsT>(value));
    return *this;
  }
  ///@}
