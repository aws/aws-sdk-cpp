...
class TooltipItem {
 public:
  ...
  void SetFieldTooltipItem(FieldTooltipItemT&& value) {
    m_fieldTooltipItemHasBeenSet = true;
    m_fieldTooltipItem = std::forward<FieldTooltipItemT>(value);
  }
  template <typename FieldTooltipItemT = FieldTooltipItem>
  TooltipItem& WithFieldTooltipItem(FieldTooltipItemT&& value) {
    SetFieldTooltipItem(std::forward<FieldTooltipItemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColumnTooltipItem(ColumnTooltipItemT&& value) {
    m_columnTooltipItemHasBeenSet = true;
    m_columnTooltipItem = std::forward<ColumnTooltipItemT>(value);
  }
  template <typename ColumnTooltipItemT = ColumnTooltipItem>
  TooltipItem& WithColumnTooltipItem(ColumnTooltipItemT&& value) {
    SetColumnTooltipItem(std::forward<ColumnTooltipItemT>(value));
    return *this;
  }
  ///@}
 private:
