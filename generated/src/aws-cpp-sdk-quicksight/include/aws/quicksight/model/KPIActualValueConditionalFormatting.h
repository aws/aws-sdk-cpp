...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API KPIActualValueConditionalFormatting() = default;
    ...
    template<typename TextColorT = ConditionalFormattingColor>
    KPIActualValueConditionalFormatting& WithTextColor(TextColorT&& value) { SetTextColor(std::forward<TextColorT>(value)); return *this;}
    ///@}
    ...
    template<typename IconT = ConditionalFormattingIcon>
    KPIActualValueConditionalFormatting& WithIcon(IconT&& value) { SetIcon(std::forward<IconT>(value)); return *this;}
    ///@}
  private:
