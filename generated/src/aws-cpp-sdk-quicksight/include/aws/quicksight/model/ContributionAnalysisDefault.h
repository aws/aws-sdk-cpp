...
class ContributionAnalysisDefault {
 public:
  ...
  void SetMeasureFieldId(MeasureFieldIdT&& value) {
    m_measureFieldIdHasBeenSet = true;
    m_measureFieldId = std::forward<MeasureFieldIdT>(value);
  }
  template <typename MeasureFieldIdT = Aws::String>
  ContributionAnalysisDefault& WithMeasureFieldId(MeasureFieldIdT&& value) {
    SetMeasureFieldId(std::forward<MeasureFieldIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContributorDimensions(ContributorDimensionsT&& value) {
    m_contributorDimensionsHasBeenSet = true;
    m_contributorDimensions = std::forward<ContributorDimensionsT>(value);
  }
  template <typename ContributorDimensionsT = Aws::Vector<ColumnIdentifier>>
  ContributionAnalysisDefault& WithContributorDimensions(ContributorDimensionsT&& value) {
    SetContributorDimensions(std::forward<ContributorDimensionsT>(value));
    return *this;
  }
  ...
  ContributionAnalysisDefault& AddContributorDimensions(ContributorDimensionsT&& value) {
    m_contributorDimensionsHasBeenSet = true;
    m_contributorDimensions.emplace_back(std::forward<ContributorDimensionsT>(value));
    return *this;
  }
  ///@}
 private:
