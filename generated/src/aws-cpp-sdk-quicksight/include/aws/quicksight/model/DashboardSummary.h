...
class DashboardSummary {
 public:
  ...
  inline void SetPublishedVersionNumber(long long value) {
    m_publishedVersionNumberHasBeenSet = true;
    m_publishedVersionNumber = value;
  }
  inline DashboardSummary& WithPublishedVersionNumber(long long value) {
    SetPublishedVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetLastPublishedTime(LastPublishedTimeT&& value) {
    ...
    m_lastPublishedTime = std::forward<LastPublishedTimeT>(value);
  }
  template <typename LastPublishedTimeT = Aws::Utils::DateTime>
  DashboardSummary& WithLastPublishedTime(LastPublishedTimeT&& value) {
    SetLastPublishedTime(std::forward<LastPublishedTimeT>(value));
    return *this;
  }
  ///@}
 private:
