...
class AxisScale {
 public:
  ...
  void SetLinear(LinearT&& value) {
    ...
    m_linear = std::forward<LinearT>(value);
  }
  template <typename LinearT = AxisLinearScale>
  AxisScale& WithLinear(LinearT&& value) {
    SetLinear(std::forward<LinearT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogarithmic(LogarithmicT&& value) {
    ...
    m_logarithmic = std::forward<LogarithmicT>(value);
  }
  template <typename LogarithmicT = AxisLogarithmicScale>
  AxisScale& WithLogarithmic(LogarithmicT&& value) {
    SetLogarithmic(std::forward<LogarithmicT>(value));
    return *this;
  }
  ///@}
 private:
