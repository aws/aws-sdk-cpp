...
class ParameterSelectableValues {
 public:
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ParameterSelectableValues& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ParameterSelectableValues& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  void SetLinkToDataSetColumn(LinkToDataSetColumnT&& value) {
    m_linkToDataSetColumnHasBeenSet = true;
    m_linkToDataSetColumn = std::forward<LinkToDataSetColumnT>(value);
  }
  template <typename LinkToDataSetColumnT = ColumnIdentifier>
  ParameterSelectableValues& WithLinkToDataSetColumn(LinkToDataSetColumnT&& value) {
    SetLinkToDataSetColumn(std::forward<LinkToDataSetColumnT>(value));
    return *this;
  }
  ///@}
 private:
