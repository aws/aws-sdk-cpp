...
class LocalNavigationConfiguration {
 public:
  ...
  void SetTargetSheetId(TargetSheetIdT&& value) {
    m_targetSheetIdHasBeenSet = true;
    m_targetSheetId = std::forward<TargetSheetIdT>(value);
  }
  template <typename TargetSheetIdT = Aws::String>
  LocalNavigationConfiguration& WithTargetSheetId(TargetSheetIdT&& value) {
    SetTargetSheetId(std::forward<TargetSheetIdT>(value));
    return *this;
  }
  ///@}
 private:
