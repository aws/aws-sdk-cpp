...
class CreateTemplateAliasResult {
 public:
  ...
  template <typename TemplateAliasT = TemplateAlias>
  CreateTemplateAliasResult& WithTemplateAlias(TemplateAliasT&& value) {
  ...
  inline CreateTemplateAliasResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateTemplateAliasResult& WithRequestId(RequestIdT&& value) {
