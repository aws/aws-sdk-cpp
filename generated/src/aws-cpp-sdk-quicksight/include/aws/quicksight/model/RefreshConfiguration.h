...
class RefreshConfiguration {
 public:
  ...
  void SetIncrementalRefresh(IncrementalRefreshT&& value) {
    m_incrementalRefreshHasBeenSet = true;
    m_incrementalRefresh = std::forward<IncrementalRefreshT>(value);
  }
  template <typename IncrementalRefreshT = IncrementalRefresh>
  RefreshConfiguration& WithIncrementalRefresh(IncrementalRefreshT&& value) {
    SetIncrementalRefresh(std::forward<IncrementalRefreshT>(value));
    return *this;
  }
  ///@}
 private:
