...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API UpdateThemeAliasResult() = default;
    ...
    template<typename ThemeAliasT = ThemeAlias>
    UpdateThemeAliasResult& WithThemeAlias(ThemeAliasT&& value) { SetThemeAlias(std::forward<ThemeAliasT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateThemeAliasResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
