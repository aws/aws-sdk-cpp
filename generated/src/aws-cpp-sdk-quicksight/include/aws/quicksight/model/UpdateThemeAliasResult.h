...
class UpdateThemeAliasResult {
 public:
  ...
  template <typename ThemeAliasT = ThemeAlias>
  UpdateThemeAliasResult& WithThemeAlias(ThemeAliasT&& value) {
  ...
  inline UpdateThemeAliasResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateThemeAliasResult& WithRequestId(RequestIdT&& value) {
