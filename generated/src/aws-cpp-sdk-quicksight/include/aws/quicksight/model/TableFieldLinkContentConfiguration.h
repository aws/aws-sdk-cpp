...
class TableFieldLinkContentConfiguration {
 public:
  ...
  void SetCustomTextContent(CustomTextContentT&& value) {
    ...
    m_customTextContent = std::forward<CustomTextContentT>(value);
  }
  template <typename CustomTextContentT = TableFieldCustomTextContent>
  TableFieldLinkContentConfiguration& WithCustomTextContent(CustomTextContentT&& value) {
    SetCustomTextContent(std::forward<CustomTextContentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomIconContent(CustomIconContentT&& value) {
    ...
    m_customIconContent = std::forward<CustomIconContentT>(value);
  }
  template <typename CustomIconContentT = TableFieldCustomIconContent>
  TableFieldLinkContentConfiguration& WithCustomIconContent(CustomIconContentT&& value) {
    SetCustomIconContent(std::forward<CustomIconContentT>(value));
    return *this;
  }
  ///@}
 private:
