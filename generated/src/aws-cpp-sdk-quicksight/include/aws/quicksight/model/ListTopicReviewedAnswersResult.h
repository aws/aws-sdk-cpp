...
class ListTopicReviewedAnswersResult {
 public:
  ...
  template <typename TopicIdT = Aws::String>
  ListTopicReviewedAnswersResult& WithTopicId(TopicIdT&& value) {
  ...
  template <typename TopicArnT = Aws::String>
  ListTopicReviewedAnswersResult& WithTopicArn(TopicArnT&& value) {
  ...
  void SetAnswers(AnswersT&& value) {
    ...
    m_answers = std::forward<AnswersT>(value);
  }
  template <typename AnswersT = Aws::Vector<TopicReviewedAnswer>>
  ListTopicReviewedAnswersResult& WithAnswers(AnswersT&& value) {
    SetAnswers(std::forward<AnswersT>(value));
    return *this;
  }
  template <typename AnswersT = TopicReviewedAnswer>
  ListTopicReviewedAnswersResult& AddAnswers(AnswersT&& value) {
    m_answersHasBeenSet = true;
    m_answers.emplace_back(std::forward<AnswersT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTopicReviewedAnswersResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTopicReviewedAnswersResult& WithRequestId(RequestIdT&& value) {
