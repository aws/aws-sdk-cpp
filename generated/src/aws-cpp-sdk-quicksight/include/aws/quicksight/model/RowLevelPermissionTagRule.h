...
class RowLevelPermissionTagRule {
 public:
  ...
  template <typename TagKeyT = Aws::String>
  RowLevelPermissionTagRule& WithTagKey(TagKeyT&& value) {
  ...
  template <typename ColumnNameT = Aws::String>
  RowLevelPermissionTagRule& WithColumnName(ColumnNameT&& value) {
  ...
  void SetTagMultiValueDelimiter(TagMultiValueDelimiterT&& value) {
    m_tagMultiValueDelimiterHasBeenSet = true;
    m_tagMultiValueDelimiter = std::forward<TagMultiValueDelimiterT>(value);
  }
  template <typename TagMultiValueDelimiterT = Aws::String>
  RowLevelPermissionTagRule& WithTagMultiValueDelimiter(TagMultiValueDelimiterT&& value) {
    SetTagMultiValueDelimiter(std::forward<TagMultiValueDelimiterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchAllValue(MatchAllValueT&& value) {
    m_matchAllValueHasBeenSet = true;
    m_matchAllValue = std::forward<MatchAllValueT>(value);
  }
  template <typename MatchAllValueT = Aws::String>
  RowLevelPermissionTagRule& WithMatchAllValue(MatchAllValueT&& value) {
    SetMatchAllValue(std::forward<MatchAllValueT>(value));
    return *this;
  }
  ///@}
 private:
