...
class DataAggregation {
 public:
  ...
  inline void SetDatasetRowDateGranularity(TopicTimeGranularity value) {
    m_datasetRowDateGranularityHasBeenSet = true;
    m_datasetRowDateGranularity = value;
  }
  inline DataAggregation& WithDatasetRowDateGranularity(TopicTimeGranularity value) {
    SetDatasetRowDateGranularity(value);
    return *this;
  }
  ///@}
  ...
  void SetDefaultDateColumnName(DefaultDateColumnNameT&& value) {
    m_defaultDateColumnNameHasBeenSet = true;
    m_defaultDateColumnName = std::forward<DefaultDateColumnNameT>(value);
  }
  template <typename DefaultDateColumnNameT = Aws::String>
  DataAggregation& WithDefaultDateColumnName(DefaultDateColumnNameT&& value) {
    SetDefaultDateColumnName(std::forward<DefaultDateColumnNameT>(value));
    return *this;
  }
  ///@}
 private:
