...
class HistogramFieldWells {
 public:
  ...
  void SetHistogramAggregatedFieldWells(HistogramAggregatedFieldWellsT&& value) {
    m_histogramAggregatedFieldWellsHasBeenSet = true;
    m_histogramAggregatedFieldWells = std::forward<HistogramAggregatedFieldWellsT>(value);
  }
  template <typename HistogramAggregatedFieldWellsT = HistogramAggregatedFieldWells>
  HistogramFieldWells& WithHistogramAggregatedFieldWells(HistogramAggregatedFieldWellsT&& value) {
    SetHistogramAggregatedFieldWells(std::forward<HistogramAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
