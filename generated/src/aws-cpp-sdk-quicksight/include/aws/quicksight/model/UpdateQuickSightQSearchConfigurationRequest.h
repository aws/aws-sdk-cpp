...
class UpdateQuickSightQSearchConfigurationRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateQuickSightQSearchConfigurationRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline UpdateQuickSightQSearchConfigurationRequest& WithQSearchStatus(QSearchStatus value) {
