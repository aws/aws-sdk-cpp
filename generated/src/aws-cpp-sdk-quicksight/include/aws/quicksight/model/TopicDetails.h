...
class TopicDetails {
 public:
  ...
  inline void SetUserExperienceVersion(TopicUserExperienceVersion value) {
    m_userExperienceVersionHasBeenSet = true;
    m_userExperienceVersion = value;
  }
  inline TopicDetails& WithUserExperienceVersion(TopicUserExperienceVersion value) {
    SetUserExperienceVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetConfigOptions(ConfigOptionsT&& value) {
    ...
    m_configOptions = std::forward<ConfigOptionsT>(value);
  }
  template <typename ConfigOptionsT = TopicConfigOptions>
  TopicDetails& WithConfigOptions(ConfigOptionsT&& value) {
    SetConfigOptions(std::forward<ConfigOptionsT>(value));
    return *this;
  }
  ///@}
 private:
