...
class ConditionalFormattingIcon {
 public:
  ...
  void SetIconSet(IconSetT&& value) {
    m_iconSetHasBeenSet = true;
    m_iconSet = std::forward<IconSetT>(value);
  }
  template <typename IconSetT = ConditionalFormattingIconSet>
  ConditionalFormattingIcon& WithIconSet(IconSetT&& value) {
    SetIconSet(std::forward<IconSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomCondition(CustomConditionT&& value) {
    m_customConditionHasBeenSet = true;
    m_customCondition = std::forward<CustomConditionT>(value);
  }
  template <typename CustomConditionT = ConditionalFormattingCustomIconCondition>
  ConditionalFormattingIcon& WithCustomCondition(CustomConditionT&& value) {
    SetCustomCondition(std::forward<CustomConditionT>(value));
    return *this;
  }
  ///@}
 private:
