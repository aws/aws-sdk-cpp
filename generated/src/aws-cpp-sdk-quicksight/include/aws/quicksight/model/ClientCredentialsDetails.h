...
class ClientCredentialsDetails {
 public:
  ...
  void SetClientCredentialsGrantDetails(ClientCredentialsGrantDetailsT&& value) {
    ...
    m_clientCredentialsGrantDetails = std::forward<ClientCredentialsGrantDetailsT>(value);
  }
  template <typename ClientCredentialsGrantDetailsT = ClientCredentialsGrantDetails>
  ClientCredentialsDetails& WithClientCredentialsGrantDetails(ClientCredentialsGrantDetailsT&& value) {
    SetClientCredentialsGrantDetails(std::forward<ClientCredentialsGrantDetailsT>(value));
    return *this;
  }
  ///@}
 private:
