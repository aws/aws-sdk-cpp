...
/**
 */
class DeleteSpaceRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DeleteSpaceRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteSpaceRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename SpaceIdT = Aws::String>
  DeleteSpaceRequest& WithSpaceId(SpaceIdT&& value) {
