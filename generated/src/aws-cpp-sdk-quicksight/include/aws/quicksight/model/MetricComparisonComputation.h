...
class MetricComparisonComputation {
 public:
  ...
  void SetFromValue(FromValueT&& value) {
    m_fromValueHasBeenSet = true;
    m_fromValue = std::forward<FromValueT>(value);
  }
  template <typename FromValueT = MeasureField>
  MetricComparisonComputation& WithFromValue(FromValueT&& value) {
    SetFromValue(std::forward<FromValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetValue(TargetValueT&& value) {
    m_targetValueHasBeenSet = true;
    m_targetValue = std::forward<TargetValueT>(value);
  }
  template <typename TargetValueT = MeasureField>
  MetricComparisonComputation& WithTargetValue(TargetValueT&& value) {
    SetTargetValue(std::forward<TargetValueT>(value));
    return *this;
  }
  ///@}
 private:
