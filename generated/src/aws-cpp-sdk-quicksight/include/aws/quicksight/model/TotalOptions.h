...
class TotalOptions {
 public:
  ...
  inline TotalOptions& WithTotalsVisibility(Visibility value) {
  ...
  inline TotalOptions& WithPlacement(TableTotalsPlacement value) {
    SetPlacement(value);
    return *this;
  }
  ///@}
  ...
  inline TotalOptions& WithScrollStatus(TableTotalsScrollStatus value) {
