...
class PhysicalTable {
 public:
  ...
  void SetRelationalTable(RelationalTableT&& value) {
    ...
    m_relationalTable = std::forward<RelationalTableT>(value);
  }
  template <typename RelationalTableT = RelationalTable>
  PhysicalTable& WithRelationalTable(RelationalTableT&& value) {
    SetRelationalTable(std::forward<RelationalTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomSql(CustomSqlT&& value) {
    ...
    m_customSql = std::forward<CustomSqlT>(value);
  }
  template <typename CustomSqlT = CustomSql>
  PhysicalTable& WithCustomSql(CustomSqlT&& value) {
    SetCustomSql(std::forward<CustomSqlT>(value));
    return *this;
  }
  ///@}
