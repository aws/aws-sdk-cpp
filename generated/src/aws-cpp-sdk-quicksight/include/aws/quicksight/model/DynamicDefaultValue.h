...
class DynamicDefaultValue {
 public:
  ...
  void SetUserNameColumn(UserNameColumnT&& value) {
    m_userNameColumnHasBeenSet = true;
    m_userNameColumn = std::forward<UserNameColumnT>(value);
  }
  template <typename UserNameColumnT = ColumnIdentifier>
  DynamicDefaultValue& WithUserNameColumn(UserNameColumnT&& value) {
    SetUserNameColumn(std::forward<UserNameColumnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupNameColumn(GroupNameColumnT&& value) {
    m_groupNameColumnHasBeenSet = true;
    m_groupNameColumn = std::forward<GroupNameColumnT>(value);
  }
  template <typename GroupNameColumnT = ColumnIdentifier>
  DynamicDefaultValue& WithGroupNameColumn(GroupNameColumnT&& value) {
    SetGroupNameColumn(std::forward<GroupNameColumnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultValueColumn(DefaultValueColumnT&& value) {
    m_defaultValueColumnHasBeenSet = true;
    m_defaultValueColumn = std::forward<DefaultValueColumnT>(value);
  }
  template <typename DefaultValueColumnT = ColumnIdentifier>
  DynamicDefaultValue& WithDefaultValueColumn(DefaultValueColumnT&& value) {
    SetDefaultValueColumn(std::forward<DefaultValueColumnT>(value));
    return *this;
  }
  ///@}
 private:
