...
class DescribeAssetBundleExportJobRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeAssetBundleExportJobRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename AssetBundleExportJobIdT = Aws::String>
  DescribeAssetBundleExportJobRequest& WithAssetBundleExportJobId(AssetBundleExportJobIdT&& value) {
