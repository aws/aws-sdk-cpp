...
class AssetBundleImportJobDataSourceOverridePermissions {
 public:
  ...
  template <typename DataSourceIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobDataSourceOverridePermissions& WithDataSourceIds(DataSourceIdsT&& value) {
    SetDataSourceIds(std::forward<DataSourceIdsT>(value));
    return *this;
  }
  template <typename DataSourceIdsT = Aws::String>
  AssetBundleImportJobDataSourceOverridePermissions& AddDataSourceIds(DataSourceIdsT&& value) {
    m_dataSourceIdsHasBeenSet = true;
  ...
  template <typename PermissionsT = AssetBundleResourcePermissions>
  AssetBundleImportJobDataSourceOverridePermissions& WithPermissions(PermissionsT&& value) {
