...
class DataSet {
 public:
  ...
  void SetOutputColumns(OutputColumnsT&& value) {
    ...
    m_outputColumns = std::forward<OutputColumnsT>(value);
  }
  template <typename OutputColumnsT = Aws::Vector<OutputColumn>>
  DataSet& WithOutputColumns(OutputColumnsT&& value) {
    SetOutputColumns(std::forward<OutputColumnsT>(value));
    return *this;
  }
  template <typename OutputColumnsT = OutputColumn>
  DataSet& AddOutputColumns(OutputColumnsT&& value) {
    m_outputColumnsHasBeenSet = true;
    m_outputColumns.emplace_back(std::forward<OutputColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DataSet& WithImportMode(DataSetImportMode value) {
    SetImportMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConsumedSpiceCapacityInBytes(long long value) {
    m_consumedSpiceCapacityInBytesHasBeenSet = true;
    m_consumedSpiceCapacityInBytes = value;
  }
  inline DataSet& WithConsumedSpiceCapacityInBytes(long long value) {
    SetConsumedSpiceCapacityInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline DataSet& WithUseAs(DataSetUseAs value) {
    SetUseAs(value);
    return *this;
  }
  ///@}
