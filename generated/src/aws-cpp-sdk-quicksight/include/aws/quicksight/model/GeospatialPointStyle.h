...
class GeospatialPointStyle {
 public:
  ...
  void SetCircleSymbolStyle(CircleSymbolStyleT&& value) {
    m_circleSymbolStyleHasBeenSet = true;
    m_circleSymbolStyle = std::forward<CircleSymbolStyleT>(value);
  }
  template <typename CircleSymbolStyleT = GeospatialCircleSymbolStyle>
  GeospatialPointStyle& WithCircleSymbolStyle(CircleSymbolStyleT&& value) {
    SetCircleSymbolStyle(std::forward<CircleSymbolStyleT>(value));
    return *this;
  }
  ///@}
 private:
