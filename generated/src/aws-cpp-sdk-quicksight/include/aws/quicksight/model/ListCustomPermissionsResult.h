...
class ListCustomPermissionsResult {
 public:
  ...
  inline ListCustomPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomPermissionsList(CustomPermissionsListT&& value) {
    m_customPermissionsListHasBeenSet = true;
    m_customPermissionsList = std::forward<CustomPermissionsListT>(value);
  }
  template <typename CustomPermissionsListT = Aws::Vector<CustomPermissions>>
  ListCustomPermissionsResult& WithCustomPermissionsList(CustomPermissionsListT&& value) {
    SetCustomPermissionsList(std::forward<CustomPermissionsListT>(value));
    return *this;
  }
  template <typename CustomPermissionsListT = CustomPermissions>
  ListCustomPermissionsResult& AddCustomPermissionsList(CustomPermissionsListT&& value) {
    m_customPermissionsListHasBeenSet = true;
    m_customPermissionsList.emplace_back(std::forward<CustomPermissionsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomPermissionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomPermissionsResult& WithRequestId(RequestIdT&& value) {
