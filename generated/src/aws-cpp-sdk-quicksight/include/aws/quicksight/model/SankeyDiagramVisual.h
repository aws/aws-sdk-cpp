...
class SankeyDiagramVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  SankeyDiagramVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  SankeyDiagramVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  SankeyDiagramVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = SankeyDiagramChartConfiguration>
  SankeyDiagramVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  SankeyDiagramVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  SankeyDiagramVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  SankeyDiagramVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
