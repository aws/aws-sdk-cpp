...
class KPIOptions {
 public:
  ...
  void SetProgressBar(ProgressBarT&& value) {
    ...
    m_progressBar = std::forward<ProgressBarT>(value);
  }
  template <typename ProgressBarT = ProgressBarOptions>
  KPIOptions& WithProgressBar(ProgressBarT&& value) {
    SetProgressBar(std::forward<ProgressBarT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrendArrows(TrendArrowsT&& value) {
    ...
    m_trendArrows = std::forward<TrendArrowsT>(value);
  }
  template <typename TrendArrowsT = TrendArrowOptions>
  KPIOptions& WithTrendArrows(TrendArrowsT&& value) {
    SetTrendArrows(std::forward<TrendArrowsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryValue(SecondaryValueT&& value) {
    ...
    m_secondaryValue = std::forward<SecondaryValueT>(value);
  }
  template <typename SecondaryValueT = SecondaryValueOptions>
  KPIOptions& WithSecondaryValue(SecondaryValueT&& value) {
    SetSecondaryValue(std::forward<SecondaryValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComparison(ComparisonT&& value) {
    ...
    m_comparison = std::forward<ComparisonT>(value);
  }
  template <typename ComparisonT = ComparisonConfiguration>
  KPIOptions& WithComparison(ComparisonT&& value) {
    SetComparison(std::forward<ComparisonT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPrimaryValueDisplayType(PrimaryValueDisplayType value) {
    m_primaryValueDisplayTypeHasBeenSet = true;
    m_primaryValueDisplayType = value;
  }
  inline KPIOptions& WithPrimaryValueDisplayType(PrimaryValueDisplayType value) {
    SetPrimaryValueDisplayType(value);
    return *this;
  }
  ///@}
  ...
  void SetPrimaryValueFontConfiguration(PrimaryValueFontConfigurationT&& value) {
    ...
    m_primaryValueFontConfiguration = std::forward<PrimaryValueFontConfigurationT>(value);
  }
  template <typename PrimaryValueFontConfigurationT = FontConfiguration>
  KPIOptions& WithPrimaryValueFontConfiguration(PrimaryValueFontConfigurationT&& value) {
    SetPrimaryValueFontConfiguration(std::forward<PrimaryValueFontConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryValueFontConfiguration(SecondaryValueFontConfigurationT&& value) {
    ...
    m_secondaryValueFontConfiguration = std::forward<SecondaryValueFontConfigurationT>(value);
  }
  template <typename SecondaryValueFontConfigurationT = FontConfiguration>
  KPIOptions& WithSecondaryValueFontConfiguration(SecondaryValueFontConfigurationT&& value) {
    SetSecondaryValueFontConfiguration(std::forward<SecondaryValueFontConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkline(SparklineT&& value) {
    ...
    m_sparkline = std::forward<SparklineT>(value);
  }
  template <typename SparklineT = KPISparklineOptions>
  KPIOptions& WithSparkline(SparklineT&& value) {
    SetSparkline(std::forward<SparklineT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualLayoutOptions(VisualLayoutOptionsT&& value) {
    ...
    m_visualLayoutOptions = std::forward<VisualLayoutOptionsT>(value);
  }
  template <typename VisualLayoutOptionsT = KPIVisualLayoutOptions>
  KPIOptions& WithVisualLayoutOptions(VisualLayoutOptionsT&& value) {
    SetVisualLayoutOptions(std::forward<VisualLayoutOptionsT>(value));
    return *this;
  }
  ///@}
 private:
