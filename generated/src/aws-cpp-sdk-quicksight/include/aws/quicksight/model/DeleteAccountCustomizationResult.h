...
class DeleteAccountCustomizationResult {
 public:
  AWS_QUICKSIGHT_API DeleteAccountCustomizationResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAccountCustomizationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DeleteAccountCustomizationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
