...
class TopicNullFilter {
 public:
  ...
  inline void SetNullFilterType(NullFilterType value) {
    m_nullFilterTypeHasBeenSet = true;
    m_nullFilterType = value;
  }
  inline TopicNullFilter& WithNullFilterType(NullFilterType value) {
    SetNullFilterType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConstantT = TopicSingularFilterConstant>
  TopicNullFilter& WithConstant(ConstantT&& value) {
  ...
  inline TopicNullFilter& WithInverse(bool value) {
    SetInverse(value);
    return *this;
  }
  ///@}
