...
class ImageCustomAction {
 public:
  ...
  void SetCustomActionId(CustomActionIdT&& value) {
    ...
    m_customActionId = std::forward<CustomActionIdT>(value);
  }
  template <typename CustomActionIdT = Aws::String>
  ImageCustomAction& WithCustomActionId(CustomActionIdT&& value) {
    SetCustomActionId(std::forward<CustomActionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ImageCustomAction& WithStatus(WidgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrigger(ImageCustomActionTrigger value) {
    m_triggerHasBeenSet = true;
    m_trigger = value;
  }
  inline ImageCustomAction& WithTrigger(ImageCustomActionTrigger value) {
    SetTrigger(value);
    return *this;
  }
  ///@}
  ...
  void SetActionOperations(ActionOperationsT&& value) {
    ...
    m_actionOperations = std::forward<ActionOperationsT>(value);
  }
  template <typename ActionOperationsT = Aws::Vector<ImageCustomActionOperation>>
  ImageCustomAction& WithActionOperations(ActionOperationsT&& value) {
    SetActionOperations(std::forward<ActionOperationsT>(value));
    return *this;
  }
  ...
  ImageCustomAction& AddActionOperations(ActionOperationsT&& value) {
    m_actionOperationsHasBeenSet = true;
    m_actionOperations.emplace_back(std::forward<ActionOperationsT>(value));
    return *this;
  }
  ///@}
 private:
