...
class FreeFormLayoutScreenCanvasSizeOptions {
 public:
  ...
  void SetOptimizedViewPortWidth(OptimizedViewPortWidthT&& value) {
    m_optimizedViewPortWidthHasBeenSet = true;
    m_optimizedViewPortWidth = std::forward<OptimizedViewPortWidthT>(value);
  }
  template <typename OptimizedViewPortWidthT = Aws::String>
  FreeFormLayoutScreenCanvasSizeOptions& WithOptimizedViewPortWidth(OptimizedViewPortWidthT&& value) {
    SetOptimizedViewPortWidth(std::forward<OptimizedViewPortWidthT>(value));
    return *this;
  }
  ///@}
 private:
