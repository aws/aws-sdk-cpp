...
class RelativeDatesFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  RelativeDatesFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  RelativeDatesFilter& WithColumn(ColumnT&& value) {
  ...
  void SetAnchorDateConfiguration(AnchorDateConfigurationT&& value) {
    m_anchorDateConfigurationHasBeenSet = true;
    m_anchorDateConfiguration = std::forward<AnchorDateConfigurationT>(value);
  }
  template <typename AnchorDateConfigurationT = AnchorDateConfiguration>
  RelativeDatesFilter& WithAnchorDateConfiguration(AnchorDateConfigurationT&& value) {
    SetAnchorDateConfiguration(std::forward<AnchorDateConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMinimumGranularity(TimeGranularity value) {
    m_minimumGranularityHasBeenSet = true;
    m_minimumGranularity = value;
  }
  inline RelativeDatesFilter& WithMinimumGranularity(TimeGranularity value) {
    SetMinimumGranularity(value);
    return *this;
  }
  ///@}
  ...
  inline RelativeDatesFilter& WithTimeGranularity(TimeGranularity value) {
  ...
  inline void SetRelativeDateType(RelativeDateType value) {
    m_relativeDateTypeHasBeenSet = true;
    m_relativeDateType = value;
  }
  inline RelativeDatesFilter& WithRelativeDateType(RelativeDateType value) {
  ...
  inline void SetRelativeDateValue(int value) {
    m_relativeDateValueHasBeenSet = true;
    m_relativeDateValue = value;
  }
  inline RelativeDatesFilter& WithRelativeDateValue(int value) {
  ...
  template <typename ParameterNameT = Aws::String>
  RelativeDatesFilter& WithParameterName(ParameterNameT&& value) {
  ...
  inline RelativeDatesFilter& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludePeriodConfiguration(ExcludePeriodConfigurationT&& value) {
    m_excludePeriodConfigurationHasBeenSet = true;
    m_excludePeriodConfiguration = std::forward<ExcludePeriodConfigurationT>(value);
  }
  template <typename ExcludePeriodConfigurationT = ExcludePeriodConfiguration>
  RelativeDatesFilter& WithExcludePeriodConfiguration(ExcludePeriodConfigurationT&& value) {
    SetExcludePeriodConfiguration(std::forward<ExcludePeriodConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  RelativeDatesFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
