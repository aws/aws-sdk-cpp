...
namespace Model
{
  ...
  /**
   * <p>The definition for a <code>SucceededTopicReviewedAnswer</code>.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SucceededTopicReviewedAnswer">AWS
   * API Reference</a></p>
   */
