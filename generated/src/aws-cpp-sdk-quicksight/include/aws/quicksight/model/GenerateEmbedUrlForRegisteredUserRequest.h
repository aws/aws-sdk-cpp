...
class GenerateEmbedUrlForRegisteredUserRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  GenerateEmbedUrlForRegisteredUserRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline GenerateEmbedUrlForRegisteredUserRequest& WithSessionLifetimeInMinutes(long long value) {
  ...
  template <typename UserArnT = Aws::String>
  GenerateEmbedUrlForRegisteredUserRequest& WithUserArn(UserArnT&& value) {
  ...
  template <typename ExperienceConfigurationT = RegisteredUserEmbeddingExperienceConfiguration>
  GenerateEmbedUrlForRegisteredUserRequest& WithExperienceConfiguration(ExperienceConfigurationT&& value) {
  ...
  template <typename AllowedDomainsT = Aws::Vector<Aws::String>>
  GenerateEmbedUrlForRegisteredUserRequest& WithAllowedDomains(AllowedDomainsT&& value) {
    SetAllowedDomains(std::forward<AllowedDomainsT>(value));
    return *this;
  }
  template <typename AllowedDomainsT = Aws::String>
  GenerateEmbedUrlForRegisteredUserRequest& AddAllowedDomains(AllowedDomainsT&& value) {
    m_allowedDomainsHasBeenSet = true;
