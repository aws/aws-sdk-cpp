...
class AssetBundleExportJobDashboardOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobDashboardOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobDashboardPropertyToOverride>>
  AssetBundleExportJobDashboardOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobDashboardOverrideProperties& AddProperties(AssetBundleExportJobDashboardPropertyToOverride value) {
    m_propertiesHasBeenSet = true;
