...
class DeleteUserCustomPermissionResult {
 public:
  AWS_QUICKSIGHT_API DeleteUserCustomPermissionResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteUserCustomPermissionResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DeleteUserCustomPermissionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
