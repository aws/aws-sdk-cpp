...
class GeospatialHeatmapConfiguration {
 public:
  ...
  void SetHeatmapColor(HeatmapColorT&& value) {
    m_heatmapColorHasBeenSet = true;
    m_heatmapColor = std::forward<HeatmapColorT>(value);
  }
  template <typename HeatmapColorT = GeospatialHeatmapColorScale>
  GeospatialHeatmapConfiguration& WithHeatmapColor(HeatmapColorT&& value) {
    SetHeatmapColor(std::forward<HeatmapColorT>(value));
    return *this;
  }
  ///@}
 private:
