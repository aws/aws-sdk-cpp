...
class ConditionalFormattingCustomIconCondition {
 public:
  ...
  template <typename ExpressionT = Aws::String>
  ConditionalFormattingCustomIconCondition& WithExpression(ExpressionT&& value) {
  ...
  void SetIconOptions(IconOptionsT&& value) {
    m_iconOptionsHasBeenSet = true;
    m_iconOptions = std::forward<IconOptionsT>(value);
  }
  template <typename IconOptionsT = ConditionalFormattingCustomIconOptions>
  ConditionalFormattingCustomIconCondition& WithIconOptions(IconOptionsT&& value) {
    SetIconOptions(std::forward<IconOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ColorT = Aws::String>
  ConditionalFormattingCustomIconCondition& WithColor(ColorT&& value) {
  ...
  template <typename DisplayConfigurationT = ConditionalFormattingIconDisplayConfiguration>
  ConditionalFormattingCustomIconCondition& WithDisplayConfiguration(DisplayConfigurationT&& value) {
