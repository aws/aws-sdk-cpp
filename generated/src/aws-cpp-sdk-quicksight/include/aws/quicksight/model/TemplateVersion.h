...
class TemplateVersion {
 public:
  ...
  inline TemplateVersion& WithVersionNumber(long long value) {
  ...
  inline TemplateVersion& WithStatus(ResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDataSetConfigurations(DataSetConfigurationsT&& value) {
    ...
    m_dataSetConfigurations = std::forward<DataSetConfigurationsT>(value);
  }
  template <typename DataSetConfigurationsT = Aws::Vector<DataSetConfiguration>>
  TemplateVersion& WithDataSetConfigurations(DataSetConfigurationsT&& value) {
    SetDataSetConfigurations(std::forward<DataSetConfigurationsT>(value));
    return *this;
  }
  ...
  void SetSourceEntityArn(SourceEntityArnT&& value) {
    ...
    m_sourceEntityArn = std::forward<SourceEntityArnT>(value);
  }
  template <typename SourceEntityArnT = Aws::String>
  TemplateVersion& WithSourceEntityArn(SourceEntityArnT&& value) {
    SetSourceEntityArn(std::forward<SourceEntityArnT>(value));
    return *this;
  }
  ///@}
