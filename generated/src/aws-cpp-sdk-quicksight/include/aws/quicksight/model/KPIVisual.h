 ...
 * KPIs</a> in the <i>Amazon Quick Suite User Guide</i>.</p><p><h3>See Also:</h3>
 * <a
...
class KPIVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  KPIVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  KPIVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  KPIVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = KPIConfiguration>
  KPIVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ConditionalFormattingT = KPIConditionalFormatting>
  KPIVisual& WithConditionalFormatting(ConditionalFormattingT&& value) {
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  KPIVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  KPIVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  KPIVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
