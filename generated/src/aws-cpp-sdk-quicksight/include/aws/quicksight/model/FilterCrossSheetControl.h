...
class FilterCrossSheetControl {
 public:
  ...
  template <typename FilterControlIdT = Aws::String>
  FilterCrossSheetControl& WithFilterControlId(FilterControlIdT&& value) {
  ...
  template <typename SourceFilterIdT = Aws::String>
  FilterCrossSheetControl& WithSourceFilterId(SourceFilterIdT&& value) {
  ...
  template <typename CascadingControlConfigurationT = CascadingControlConfiguration>
  FilterCrossSheetControl& WithCascadingControlConfiguration(CascadingControlConfigurationT&& value) {
