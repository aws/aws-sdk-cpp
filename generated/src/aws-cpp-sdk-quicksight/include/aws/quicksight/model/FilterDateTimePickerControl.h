...
class FilterDateTimePickerControl {
 public:
  ...
  template <typename FilterControlIdT = Aws::String>
  FilterDateTimePickerControl& WithFilterControlId(FilterControlIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  FilterDateTimePickerControl& WithTitle(TitleT&& value) {
  ...
  template <typename SourceFilterIdT = Aws::String>
  FilterDateTimePickerControl& WithSourceFilterId(SourceFilterIdT&& value) {
  ...
  template <typename DisplayOptionsT = DateTimePickerControlDisplayOptions>
  FilterDateTimePickerControl& WithDisplayOptions(DisplayOptionsT&& value) {
  ...
  inline void SetType(SheetControlDateTimePickerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FilterDateTimePickerControl& WithType(SheetControlDateTimePickerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline FilterDateTimePickerControl& WithCommitMode(CommitMode value) {
    SetCommitMode(value);
    return *this;
  }
  ///@}
