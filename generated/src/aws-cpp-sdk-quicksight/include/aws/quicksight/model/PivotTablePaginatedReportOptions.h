...
class PivotTablePaginatedReportOptions {
 public:
  ...
  inline void SetVerticalOverflowVisibility(Visibility value) {
    m_verticalOverflowVisibilityHasBeenSet = true;
    m_verticalOverflowVisibility = value;
  }
  inline PivotTablePaginatedReportOptions& WithVerticalOverflowVisibility(Visibility value) {
    SetVerticalOverflowVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverflowColumnHeaderVisibility(Visibility value) {
    m_overflowColumnHeaderVisibilityHasBeenSet = true;
    m_overflowColumnHeaderVisibility = value;
  }
  inline PivotTablePaginatedReportOptions& WithOverflowColumnHeaderVisibility(Visibility value) {
    SetOverflowColumnHeaderVisibility(value);
    return *this;
  }
  ///@}
 private:
