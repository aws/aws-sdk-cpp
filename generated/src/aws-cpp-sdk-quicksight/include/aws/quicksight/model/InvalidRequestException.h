...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API InvalidRequestException() = default;
    ...
    template<typename RequestIdT = Aws::String>
    InvalidRequestException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
