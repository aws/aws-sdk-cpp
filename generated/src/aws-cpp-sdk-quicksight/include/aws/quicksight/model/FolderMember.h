...
/**
 * <p>An asset in a Quick Sight folder, such as a dashboard, analysis, or
...
class FolderMember {
 public:
  ...
  template <typename MemberIdT = Aws::String>
  FolderMember& WithMemberId(MemberIdT&& value) {
  ...
  inline FolderMember& WithMemberType(MemberType value) {
    SetMemberType(value);
    return *this;
  }
  ///@}
