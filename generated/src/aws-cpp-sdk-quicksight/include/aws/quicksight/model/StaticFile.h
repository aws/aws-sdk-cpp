...
class StaticFile {
 public:
  ...
  void SetImageStaticFile(ImageStaticFileT&& value) {
    ...
    m_imageStaticFile = std::forward<ImageStaticFileT>(value);
  }
  template <typename ImageStaticFileT = ImageStaticFile>
  StaticFile& WithImageStaticFile(ImageStaticFileT&& value) {
    SetImageStaticFile(std::forward<ImageStaticFileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpatialStaticFile(SpatialStaticFileT&& value) {
    ...
    m_spatialStaticFile = std::forward<SpatialStaticFileT>(value);
  }
  template <typename SpatialStaticFileT = SpatialStaticFile>
  StaticFile& WithSpatialStaticFile(SpatialStaticFileT&& value) {
    SetSpatialStaticFile(std::forward<SpatialStaticFileT>(value));
    return *this;
  }
  ///@}
 private:
