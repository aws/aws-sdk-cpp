...
class TopBottomMoversComputation {
 public:
  ...
  inline void SetMoverSize(int value) {
    m_moverSizeHasBeenSet = true;
    m_moverSize = value;
  }
  inline TopBottomMoversComputation& WithMoverSize(int value) {
    SetMoverSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(TopBottomSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline TopBottomMoversComputation& WithSortOrder(TopBottomSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(TopBottomComputationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TopBottomMoversComputation& WithType(TopBottomComputationType value) {
    SetType(value);
    return *this;
  }
  ///@}
