...
class LineChartConfiguration {
 public:
  ...
  void SetForecastConfigurations(ForecastConfigurationsT&& value) {
    ...
    m_forecastConfigurations = std::forward<ForecastConfigurationsT>(value);
  }
  template <typename ForecastConfigurationsT = Aws::Vector<ForecastConfiguration>>
  LineChartConfiguration& WithForecastConfigurations(ForecastConfigurationsT&& value) {
    SetForecastConfigurations(std::forward<ForecastConfigurationsT>(value));
    return *this;
  }
  ...
  LineChartConfiguration& AddForecastConfigurations(ForecastConfigurationsT&& value) {
    m_forecastConfigurationsHasBeenSet = true;
    m_forecastConfigurations.emplace_back(std::forward<ForecastConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(LineChartType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline LineChartConfiguration& WithType(LineChartType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetSmallMultiplesOptions(SmallMultiplesOptionsT&& value) {
    ...
    m_smallMultiplesOptions = std::forward<SmallMultiplesOptionsT>(value);
  }
  template <typename SmallMultiplesOptionsT = SmallMultiplesOptions>
  LineChartConfiguration& WithSmallMultiplesOptions(SmallMultiplesOptionsT&& value) {
    SetSmallMultiplesOptions(std::forward<SmallMultiplesOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXAxisDisplayOptions(XAxisDisplayOptionsT&& value) {
    ...
    m_xAxisDisplayOptions = std::forward<XAxisDisplayOptionsT>(value);
  }
  template <typename XAxisDisplayOptionsT = AxisDisplayOptions>
  LineChartConfiguration& WithXAxisDisplayOptions(XAxisDisplayOptionsT&& value) {
    SetXAxisDisplayOptions(std::forward<XAxisDisplayOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXAxisLabelOptions(XAxisLabelOptionsT&& value) {
    ...
    m_xAxisLabelOptions = std::forward<XAxisLabelOptionsT>(value);
  }
  template <typename XAxisLabelOptionsT = ChartAxisLabelOptions>
  LineChartConfiguration& WithXAxisLabelOptions(XAxisLabelOptionsT&& value) {
    SetXAxisLabelOptions(std::forward<XAxisLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContributionAnalysisDefaults(ContributionAnalysisDefaultsT&& value) {
    ...
    m_contributionAnalysisDefaults = std::forward<ContributionAnalysisDefaultsT>(value);
  }
  template <typename ContributionAnalysisDefaultsT = Aws::Vector<ContributionAnalysisDefault>>
  LineChartConfiguration& WithContributionAnalysisDefaults(ContributionAnalysisDefaultsT&& value) {
    SetContributionAnalysisDefaults(std::forward<ContributionAnalysisDefaultsT>(value));
    return *this;
  }
  ...
  LineChartConfiguration& AddContributionAnalysisDefaults(ContributionAnalysisDefaultsT&& value) {
    m_contributionAnalysisDefaultsHasBeenSet = true;
    m_contributionAnalysisDefaults.emplace_back(std::forward<ContributionAnalysisDefaultsT>(value));
    return *this;
  }
  ///@}
