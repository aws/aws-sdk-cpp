...
class DeleteThemeResult {
 public:
  AWS_QUICKSIGHT_API DeleteThemeResult() = default;
  ...
  template <typename ArnT = Aws::String>
  DeleteThemeResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteThemeResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DeleteThemeResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ThemeIdT = Aws::String>
  DeleteThemeResult& WithThemeId(ThemeIdT&& value) {
