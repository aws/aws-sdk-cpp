...
class DatasetMetadata {
 public:
  ...
  void SetDataAggregation(DataAggregationT&& value) {
    ...
    m_dataAggregation = std::forward<DataAggregationT>(value);
  }
  template <typename DataAggregationT = DataAggregation>
  DatasetMetadata& WithDataAggregation(DataAggregationT&& value) {
    SetDataAggregation(std::forward<DataAggregationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNamedEntities(NamedEntitiesT&& value) {
    ...
    m_namedEntities = std::forward<NamedEntitiesT>(value);
  }
  template <typename NamedEntitiesT = Aws::Vector<TopicNamedEntity>>
  DatasetMetadata& WithNamedEntities(NamedEntitiesT&& value) {
    SetNamedEntities(std::forward<NamedEntitiesT>(value));
    return *this;
  }
  template <typename NamedEntitiesT = TopicNamedEntity>
  DatasetMetadata& AddNamedEntities(NamedEntitiesT&& value) {
    m_namedEntitiesHasBeenSet = true;
    m_namedEntities.emplace_back(std::forward<NamedEntitiesT>(value));
    return *this;
  }
  ///@}
 private:
