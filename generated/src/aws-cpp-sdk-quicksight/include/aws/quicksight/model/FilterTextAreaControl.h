...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API FilterTextAreaControl() = default;
    ...
    template<typename FilterControlIdT = Aws::String>
    FilterTextAreaControl& WithFilterControlId(FilterControlIdT&& value) { SetFilterControlId(std::forward<FilterControlIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = Aws::String>
    FilterTextAreaControl& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceFilterIdT = Aws::String>
    FilterTextAreaControl& WithSourceFilterId(SourceFilterIdT&& value) { SetSourceFilterId(std::forward<SourceFilterIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DelimiterT = Aws::String>
    FilterTextAreaControl& WithDelimiter(DelimiterT&& value) { SetDelimiter(std::forward<DelimiterT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayOptionsT = TextAreaControlDisplayOptions>
    FilterTextAreaControl& WithDisplayOptions(DisplayOptionsT&& value) { SetDisplayOptions(std::forward<DisplayOptionsT>(value)); return *this;}
    ///@}
  private:
