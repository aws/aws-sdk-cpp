...
class PaginationConfiguration {
 public:
  ...
  inline void SetPageSize(long long value) {
    m_pageSizeHasBeenSet = true;
    m_pageSize = value;
  }
  inline PaginationConfiguration& WithPageSize(long long value) {
    SetPageSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPageNumber(long long value) {
    m_pageNumberHasBeenSet = true;
    m_pageNumber = value;
  }
  inline PaginationConfiguration& WithPageNumber(long long value) {
    SetPageNumber(value);
    return *this;
  }
  ///@}
