...
class AnalysisDefaults {
 public:
  ...
  void SetDefaultNewSheetConfiguration(DefaultNewSheetConfigurationT&& value) {
    m_defaultNewSheetConfigurationHasBeenSet = true;
    m_defaultNewSheetConfiguration = std::forward<DefaultNewSheetConfigurationT>(value);
  }
  template <typename DefaultNewSheetConfigurationT = DefaultNewSheetConfiguration>
  AnalysisDefaults& WithDefaultNewSheetConfiguration(DefaultNewSheetConfigurationT&& value) {
    SetDefaultNewSheetConfiguration(std::forward<DefaultNewSheetConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
