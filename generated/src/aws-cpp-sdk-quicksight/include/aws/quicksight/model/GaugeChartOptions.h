...
class GaugeChartOptions {
 public:
  ...
  inline GaugeChartOptions& WithPrimaryValueDisplayType(PrimaryValueDisplayType value) {
  ...
  void SetArcAxis(ArcAxisT&& value) {
    ...
    m_arcAxis = std::forward<ArcAxisT>(value);
  }
  template <typename ArcAxisT = ArcAxisConfiguration>
  GaugeChartOptions& WithArcAxis(ArcAxisT&& value) {
    SetArcAxis(std::forward<ArcAxisT>(value));
    return *this;
  }
  ///@}
