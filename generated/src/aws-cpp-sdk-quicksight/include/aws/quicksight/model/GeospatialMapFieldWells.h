...
class GeospatialMapFieldWells {
 public:
   ...
   */
  inline const GeospatialMapAggregatedFieldWells& GetGeospatialMapAggregatedFieldWells() const {
    return m_geospatialMapAggregatedFieldWells;
  }
  ...
  void SetGeospatialMapAggregatedFieldWells(GeospatialMapAggregatedFieldWellsT&& value) {
    m_geospatialMapAggregatedFieldWellsHasBeenSet = true;
    m_geospatialMapAggregatedFieldWells = std::forward<GeospatialMapAggregatedFieldWellsT>(value);
  }
  template <typename GeospatialMapAggregatedFieldWellsT = GeospatialMapAggregatedFieldWells>
  GeospatialMapFieldWells& WithGeospatialMapAggregatedFieldWells(GeospatialMapAggregatedFieldWellsT&& value) {
    SetGeospatialMapAggregatedFieldWells(std::forward<GeospatialMapAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
