...
class BoxPlotOptions {
 public:
  ...
  void SetStyleOptions(StyleOptionsT&& value) {
    ...
    m_styleOptions = std::forward<StyleOptionsT>(value);
  }
  template <typename StyleOptionsT = BoxPlotStyleOptions>
  BoxPlotOptions& WithStyleOptions(StyleOptionsT&& value) {
    SetStyleOptions(std::forward<StyleOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOutlierVisibility(Visibility value) {
    m_outlierVisibilityHasBeenSet = true;
    m_outlierVisibility = value;
  }
  inline BoxPlotOptions& WithOutlierVisibility(Visibility value) {
    SetOutlierVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllDataPointsVisibility(Visibility value) {
    m_allDataPointsVisibilityHasBeenSet = true;
    m_allDataPointsVisibility = value;
  }
  inline BoxPlotOptions& WithAllDataPointsVisibility(Visibility value) {
    SetAllDataPointsVisibility(value);
    return *this;
  }
  ///@}
 private:
