...
class UpdateAccountSettingsRequest : public QuickSightRequest {
 public:
  ...
  void SetDefaultNamespace(DefaultNamespaceT&& value) {
    ...
    m_defaultNamespace = std::forward<DefaultNamespaceT>(value);
  }
  template <typename DefaultNamespaceT = Aws::String>
  UpdateAccountSettingsRequest& WithDefaultNamespace(DefaultNamespaceT&& value) {
    SetDefaultNamespace(std::forward<DefaultNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNotificationEmail(NotificationEmailT&& value) {
    ...
    m_notificationEmail = std::forward<NotificationEmailT>(value);
  }
  template <typename NotificationEmailT = Aws::String>
  UpdateAccountSettingsRequest& WithNotificationEmail(NotificationEmailT&& value) {
    SetNotificationEmail(std::forward<NotificationEmailT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateAccountSettingsRequest& WithTerminationProtectionEnabled(bool value) {
