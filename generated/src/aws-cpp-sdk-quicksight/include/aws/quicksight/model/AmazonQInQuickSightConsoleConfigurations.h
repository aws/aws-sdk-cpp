...
class AmazonQInQuickSightConsoleConfigurations {
 public:
  ...
  void SetDataQnA(DataQnAT&& value) {
    m_dataQnAHasBeenSet = true;
    m_dataQnA = std::forward<DataQnAT>(value);
  }
  template <typename DataQnAT = DataQnAConfigurations>
  AmazonQInQuickSightConsoleConfigurations& WithDataQnA(DataQnAT&& value) {
    SetDataQnA(std::forward<DataQnAT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGenerativeAuthoring(GenerativeAuthoringT&& value) {
    m_generativeAuthoringHasBeenSet = true;
    m_generativeAuthoring = std::forward<GenerativeAuthoringT>(value);
  }
  template <typename GenerativeAuthoringT = GenerativeAuthoringConfigurations>
  AmazonQInQuickSightConsoleConfigurations& WithGenerativeAuthoring(GenerativeAuthoringT&& value) {
    SetGenerativeAuthoring(std::forward<GenerativeAuthoringT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExecutiveSummaryT = ExecutiveSummaryConfigurations>
  AmazonQInQuickSightConsoleConfigurations& WithExecutiveSummary(ExecutiveSummaryT&& value) {
  ...
  void SetDataStories(DataStoriesT&& value) {
    m_dataStoriesHasBeenSet = true;
    m_dataStories = std::forward<DataStoriesT>(value);
  }
  template <typename DataStoriesT = DataStoriesConfigurations>
  AmazonQInQuickSightConsoleConfigurations& WithDataStories(DataStoriesT&& value) {
    SetDataStories(std::forward<DataStoriesT>(value));
    return *this;
  }
  ///@}
 private:
