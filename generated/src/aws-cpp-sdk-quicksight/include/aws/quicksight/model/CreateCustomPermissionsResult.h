...
class CreateCustomPermissionsResult {
 public:
  AWS_QUICKSIGHT_API CreateCustomPermissionsResult() = default;
  ...
  inline CreateCustomPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  CreateCustomPermissionsResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCustomPermissionsResult& WithRequestId(RequestIdT&& value) {
