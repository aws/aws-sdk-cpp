...
class GeospatialMapVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  GeospatialMapVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  GeospatialMapVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  GeospatialMapVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = GeospatialMapConfiguration>
  GeospatialMapVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  GeospatialMapVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  GeospatialMapVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  GeospatialMapVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  GeospatialMapVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  GeospatialMapVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
