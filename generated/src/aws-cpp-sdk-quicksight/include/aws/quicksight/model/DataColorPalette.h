...
class DataColorPalette {
 public:
  ...
  template <typename ColorsT = Aws::Vector<Aws::String>>
  DataColorPalette& WithColors(ColorsT&& value) {
    SetColors(std::forward<ColorsT>(value));
    return *this;
  }
  template <typename ColorsT = Aws::String>
  DataColorPalette& AddColors(ColorsT&& value) {
    m_colorsHasBeenSet = true;
  ...
  void SetMinMaxGradient(MinMaxGradientT&& value) {
    m_minMaxGradientHasBeenSet = true;
    m_minMaxGradient = std::forward<MinMaxGradientT>(value);
  }
  template <typename MinMaxGradientT = Aws::Vector<Aws::String>>
  DataColorPalette& WithMinMaxGradient(MinMaxGradientT&& value) {
    SetMinMaxGradient(std::forward<MinMaxGradientT>(value));
    return *this;
  }
  template <typename MinMaxGradientT = Aws::String>
  DataColorPalette& AddMinMaxGradient(MinMaxGradientT&& value) {
    m_minMaxGradientHasBeenSet = true;
    m_minMaxGradient.emplace_back(std::forward<MinMaxGradientT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmptyFillColor(EmptyFillColorT&& value) {
    m_emptyFillColorHasBeenSet = true;
    m_emptyFillColor = std::forward<EmptyFillColorT>(value);
  }
  template <typename EmptyFillColorT = Aws::String>
  DataColorPalette& WithEmptyFillColor(EmptyFillColorT&& value) {
    SetEmptyFillColor(std::forward<EmptyFillColorT>(value));
    return *this;
  }
  ///@}
 private:
