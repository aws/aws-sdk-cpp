...
class DataSetSearchFilter {
 public:
  ...
  inline DataSetSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(DataSetFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DataSetSearchFilter& WithName(DataSetFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  DataSetSearchFilter& WithValue(ValueT&& value) {
