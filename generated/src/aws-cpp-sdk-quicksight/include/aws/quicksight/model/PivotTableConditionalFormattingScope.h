...
class PivotTableConditionalFormattingScope {
 public:
  ...
  inline void SetRole(PivotTableConditionalFormattingScopeRole value) {
    m_roleHasBeenSet = true;
    m_role = value;
  }
  inline PivotTableConditionalFormattingScope& WithRole(PivotTableConditionalFormattingScopeRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
