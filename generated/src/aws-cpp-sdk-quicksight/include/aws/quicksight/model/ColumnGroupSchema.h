...
class ColumnGroupSchema {
 public:
  ...
  template <typename NameT = Aws::String>
  ColumnGroupSchema& WithName(NameT&& value) {
  ...
  void SetColumnGroupColumnSchemaList(ColumnGroupColumnSchemaListT&& value) {
    m_columnGroupColumnSchemaListHasBeenSet = true;
    m_columnGroupColumnSchemaList = std::forward<ColumnGroupColumnSchemaListT>(value);
  }
  template <typename ColumnGroupColumnSchemaListT = Aws::Vector<ColumnGroupColumnSchema>>
  ColumnGroupSchema& WithColumnGroupColumnSchemaList(ColumnGroupColumnSchemaListT&& value) {
    SetColumnGroupColumnSchemaList(std::forward<ColumnGroupColumnSchemaListT>(value));
    return *this;
  }
  template <typename ColumnGroupColumnSchemaListT = ColumnGroupColumnSchema>
  ColumnGroupSchema& AddColumnGroupColumnSchemaList(ColumnGroupColumnSchemaListT&& value) {
    m_columnGroupColumnSchemaListHasBeenSet = true;
    m_columnGroupColumnSchemaList.emplace_back(std::forward<ColumnGroupColumnSchemaListT>(value));
    return *this;
  }
  ///@}
 private:
