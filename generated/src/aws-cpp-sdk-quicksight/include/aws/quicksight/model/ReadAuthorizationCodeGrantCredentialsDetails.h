...
namespace Model
{
  ...
  public:
     ...
     */
    inline const ReadAuthorizationCodeGrantDetails& GetReadAuthorizationCodeGrantDetails() const { return m_readAuthorizationCodeGrantDetails; }
    ...
    void SetReadAuthorizationCodeGrantDetails(ReadAuthorizationCodeGrantDetailsT&& value) { m_readAuthorizationCodeGrantDetailsHasBeenSet = true; m_readAuthorizationCodeGrantDetails = std::forward<ReadAuthorizationCodeGrantDetailsT>(value); }
    template<typename ReadAuthorizationCodeGrantDetailsT = ReadAuthorizationCodeGrantDetails>
    ReadAuthorizationCodeGrantCredentialsDetails& WithReadAuthorizationCodeGrantDetails(ReadAuthorizationCodeGrantDetailsT&& value) { SetReadAuthorizationCodeGrantDetails(std::forward<ReadAuthorizationCodeGrantDetailsT>(value)); return *this;}
    ///@}
  private:
