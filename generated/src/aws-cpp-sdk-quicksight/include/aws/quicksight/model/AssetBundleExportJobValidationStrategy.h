...
class AssetBundleExportJobValidationStrategy {
 public:
  AWS_QUICKSIGHT_API AssetBundleExportJobValidationStrategy() = default;
  ...
  inline AssetBundleExportJobValidationStrategy& WithStrictModeForAllResources(bool value) {
