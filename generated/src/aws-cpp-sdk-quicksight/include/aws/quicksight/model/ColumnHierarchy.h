...
class ColumnHierarchy {
 public:
  ...
  void SetExplicitHierarchy(ExplicitHierarchyT&& value) {
    ...
    m_explicitHierarchy = std::forward<ExplicitHierarchyT>(value);
  }
  template <typename ExplicitHierarchyT = ExplicitHierarchy>
  ColumnHierarchy& WithExplicitHierarchy(ExplicitHierarchyT&& value) {
    SetExplicitHierarchy(std::forward<ExplicitHierarchyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateTimeHierarchy(DateTimeHierarchyT&& value) {
    ...
    m_dateTimeHierarchy = std::forward<DateTimeHierarchyT>(value);
  }
  template <typename DateTimeHierarchyT = DateTimeHierarchy>
  ColumnHierarchy& WithDateTimeHierarchy(DateTimeHierarchyT&& value) {
    SetDateTimeHierarchy(std::forward<DateTimeHierarchyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredefinedHierarchy(PredefinedHierarchyT&& value) {
    ...
    m_predefinedHierarchy = std::forward<PredefinedHierarchyT>(value);
  }
  template <typename PredefinedHierarchyT = PredefinedHierarchy>
  ColumnHierarchy& WithPredefinedHierarchy(PredefinedHierarchyT&& value) {
    SetPredefinedHierarchy(std::forward<PredefinedHierarchyT>(value));
    return *this;
  }
  ///@}
 private:
