...
class GaugeChartVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  GaugeChartVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  GaugeChartVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  GaugeChartVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = GaugeChartConfiguration>
  GaugeChartVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ConditionalFormattingT = GaugeChartConditionalFormatting>
  GaugeChartVisual& WithConditionalFormatting(ConditionalFormattingT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  GaugeChartVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  GaugeChartVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  GaugeChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
