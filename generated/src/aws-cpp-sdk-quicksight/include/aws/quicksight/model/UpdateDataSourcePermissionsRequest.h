...
class UpdateDataSourcePermissionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateDataSourcePermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  UpdateDataSourcePermissionsRequest& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename GrantPermissionsT = Aws::Vector<ResourcePermission>>
  UpdateDataSourcePermissionsRequest& WithGrantPermissions(GrantPermissionsT&& value) {
    SetGrantPermissions(std::forward<GrantPermissionsT>(value));
    return *this;
  }
  template <typename GrantPermissionsT = ResourcePermission>
  UpdateDataSourcePermissionsRequest& AddGrantPermissions(GrantPermissionsT&& value) {
    m_grantPermissionsHasBeenSet = true;
  ...
  template <typename RevokePermissionsT = Aws::Vector<ResourcePermission>>
  UpdateDataSourcePermissionsRequest& WithRevokePermissions(RevokePermissionsT&& value) {
    SetRevokePermissions(std::forward<RevokePermissionsT>(value));
    return *this;
  }
  template <typename RevokePermissionsT = ResourcePermission>
  UpdateDataSourcePermissionsRequest& AddRevokePermissions(RevokePermissionsT&& value) {
    m_revokePermissionsHasBeenSet = true;
