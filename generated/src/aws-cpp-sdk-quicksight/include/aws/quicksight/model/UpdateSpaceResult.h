...
class UpdateSpaceResult {
 public:
  AWS_QUICKSIGHT_API UpdateSpaceResult() = default;
  AWS_QUICKSIGHT_API UpdateSpaceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API UpdateSpaceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SpaceIdT = Aws::String>
  UpdateSpaceResult& WithSpaceId(SpaceIdT&& value) {
  ...
  template <typename SpaceArnT = Aws::String>
  UpdateSpaceResult& WithSpaceArn(SpaceArnT&& value) {
