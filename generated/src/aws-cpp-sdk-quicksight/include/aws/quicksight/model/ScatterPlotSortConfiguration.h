...
class ScatterPlotSortConfiguration {
 public:
  ...
  void SetScatterPlotLimitConfiguration(ScatterPlotLimitConfigurationT&& value) {
    m_scatterPlotLimitConfigurationHasBeenSet = true;
    m_scatterPlotLimitConfiguration = std::forward<ScatterPlotLimitConfigurationT>(value);
  }
  template <typename ScatterPlotLimitConfigurationT = ItemsLimitConfiguration>
  ScatterPlotSortConfiguration& WithScatterPlotLimitConfiguration(ScatterPlotLimitConfigurationT&& value) {
    SetScatterPlotLimitConfiguration(std::forward<ScatterPlotLimitConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
