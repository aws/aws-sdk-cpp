...
class TopicConstantValue {
 public:
  ...
  inline TopicConstantValue& WithConstantType(ConstantType value) {
  ...
  void SetMinimum(MinimumT&& value) {
    m_minimumHasBeenSet = true;
    m_minimum = std::forward<MinimumT>(value);
  }
  template <typename MinimumT = Aws::String>
  TopicConstantValue& WithMinimum(MinimumT&& value) {
    SetMinimum(std::forward<MinimumT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaximum(MaximumT&& value) {
    m_maximumHasBeenSet = true;
    m_maximum = std::forward<MaximumT>(value);
  }
  template <typename MaximumT = Aws::String>
  TopicConstantValue& WithMaximum(MaximumT&& value) {
    SetMaximum(std::forward<MaximumT>(value));
    return *this;
  }
  ///@}
