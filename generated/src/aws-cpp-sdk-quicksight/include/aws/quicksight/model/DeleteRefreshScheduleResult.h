...
namespace Model
{
  ...
  public:
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRefreshScheduleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleIdT = Aws::String>
    DeleteRefreshScheduleResult& WithScheduleId(ScheduleIdT&& value) { SetScheduleId(std::forward<ScheduleIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    DeleteRefreshScheduleResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
