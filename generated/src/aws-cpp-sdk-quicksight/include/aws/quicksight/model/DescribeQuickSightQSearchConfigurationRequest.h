...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DescribeQuickSightQSearchConfigurationRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeQuickSightQSearchConfigurationRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
  private:
