...
class GeospatialColor {
 public:
  ...
  void SetSolid(SolidT&& value) {
    m_solidHasBeenSet = true;
    m_solid = std::forward<SolidT>(value);
  }
  template <typename SolidT = GeospatialSolidColor>
  GeospatialColor& WithSolid(SolidT&& value) {
    SetSolid(std::forward<SolidT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GradientT = GeospatialGradientColor>
  GeospatialColor& WithGradient(GradientT&& value) {
  ...
  template <typename CategoricalT = GeospatialCategoricalColor>
  GeospatialColor& WithCategorical(CategoricalT&& value) {
