...
class PivotTableFieldOptions {
 public:
  ...
  template <typename SelectedFieldOptionsT = Aws::Vector<PivotTableFieldOption>>
  PivotTableFieldOptions& WithSelectedFieldOptions(SelectedFieldOptionsT&& value) {
  ...
  PivotTableFieldOptions& AddSelectedFieldOptions(SelectedFieldOptionsT&& value) {
    m_selectedFieldOptionsHasBeenSet = true;
  ...
  void SetDataPathOptions(DataPathOptionsT&& value) {
    m_dataPathOptionsHasBeenSet = true;
    m_dataPathOptions = std::forward<DataPathOptionsT>(value);
  }
  template <typename DataPathOptionsT = Aws::Vector<PivotTableDataPathOption>>
  PivotTableFieldOptions& WithDataPathOptions(DataPathOptionsT&& value) {
    SetDataPathOptions(std::forward<DataPathOptionsT>(value));
    return *this;
  }
  template <typename DataPathOptionsT = PivotTableDataPathOption>
  PivotTableFieldOptions& AddDataPathOptions(DataPathOptionsT&& value) {
    m_dataPathOptionsHasBeenSet = true;
    m_dataPathOptions.emplace_back(std::forward<DataPathOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollapseStateOptions(CollapseStateOptionsT&& value) {
    m_collapseStateOptionsHasBeenSet = true;
    m_collapseStateOptions = std::forward<CollapseStateOptionsT>(value);
  }
  template <typename CollapseStateOptionsT = Aws::Vector<PivotTableFieldCollapseStateOption>>
  PivotTableFieldOptions& WithCollapseStateOptions(CollapseStateOptionsT&& value) {
    SetCollapseStateOptions(std::forward<CollapseStateOptionsT>(value));
    return *this;
  }
  template <typename CollapseStateOptionsT = PivotTableFieldCollapseStateOption>
  PivotTableFieldOptions& AddCollapseStateOptions(CollapseStateOptionsT&& value) {
    m_collapseStateOptionsHasBeenSet = true;
    m_collapseStateOptions.emplace_back(std::forward<CollapseStateOptionsT>(value));
    return *this;
  }
  ///@}
 private:
