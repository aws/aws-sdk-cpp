...
class RowInfo {
 public:
  ...
  inline void SetRowsIngested(long long value) {
    m_rowsIngestedHasBeenSet = true;
    m_rowsIngested = value;
  }
  inline RowInfo& WithRowsIngested(long long value) {
    SetRowsIngested(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRowsDropped(long long value) {
    m_rowsDroppedHasBeenSet = true;
    m_rowsDropped = value;
  }
  inline RowInfo& WithRowsDropped(long long value) {
    SetRowsDropped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRowsInDataset(long long value) {
    m_totalRowsInDatasetHasBeenSet = true;
    m_totalRowsInDataset = value;
  }
  inline RowInfo& WithTotalRowsInDataset(long long value) {
    SetTotalRowsInDataset(value);
    return *this;
  }
  ///@}
 private:
