...
class MissingDataConfiguration {
 public:
  ...
  inline void SetTreatmentOption(MissingDataTreatmentOption value) {
    m_treatmentOptionHasBeenSet = true;
    m_treatmentOption = value;
  }
  inline MissingDataConfiguration& WithTreatmentOption(MissingDataTreatmentOption value) {
