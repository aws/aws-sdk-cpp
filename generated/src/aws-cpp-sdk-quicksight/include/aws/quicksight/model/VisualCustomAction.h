...
class VisualCustomAction {
 public:
  ...
  inline VisualCustomAction& WithStatus(WidgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrigger(VisualCustomActionTrigger value) {
    m_triggerHasBeenSet = true;
    m_trigger = value;
  }
  inline VisualCustomAction& WithTrigger(VisualCustomActionTrigger value) {
    SetTrigger(value);
    return *this;
  }
  ///@}
