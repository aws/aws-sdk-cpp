...
class ColumnTag {
 public:
  ...
  inline void SetColumnGeographicRole(GeoSpatialDataRole value) {
    m_columnGeographicRoleHasBeenSet = true;
    m_columnGeographicRole = value;
  }
  inline ColumnTag& WithColumnGeographicRole(GeoSpatialDataRole value) {
    SetColumnGeographicRole(value);
    return *this;
  }
  ///@}
  ...
  void SetColumnDescription(ColumnDescriptionT&& value) {
    ...
    m_columnDescription = std::forward<ColumnDescriptionT>(value);
  }
  template <typename ColumnDescriptionT = ColumnDescription>
  ColumnTag& WithColumnDescription(ColumnDescriptionT&& value) {
    SetColumnDescription(std::forward<ColumnDescriptionT>(value));
    return *this;
  }
  ///@}
 private:
