...
class DeleteCustomPermissionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteCustomPermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename CustomPermissionsNameT = Aws::String>
  DeleteCustomPermissionsRequest& WithCustomPermissionsName(CustomPermissionsNameT&& value) {
