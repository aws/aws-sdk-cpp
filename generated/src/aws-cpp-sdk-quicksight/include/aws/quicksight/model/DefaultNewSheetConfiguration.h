...
class DefaultNewSheetConfiguration {
 public:
  ...
  void SetInteractiveLayoutConfiguration(InteractiveLayoutConfigurationT&& value) {
    ...
    m_interactiveLayoutConfiguration = std::forward<InteractiveLayoutConfigurationT>(value);
  }
  template <typename InteractiveLayoutConfigurationT = DefaultInteractiveLayoutConfiguration>
  DefaultNewSheetConfiguration& WithInteractiveLayoutConfiguration(InteractiveLayoutConfigurationT&& value) {
    SetInteractiveLayoutConfiguration(std::forward<InteractiveLayoutConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPaginatedLayoutConfiguration(PaginatedLayoutConfigurationT&& value) {
    ...
    m_paginatedLayoutConfiguration = std::forward<PaginatedLayoutConfigurationT>(value);
  }
  template <typename PaginatedLayoutConfigurationT = DefaultPaginatedLayoutConfiguration>
  DefaultNewSheetConfiguration& WithPaginatedLayoutConfiguration(PaginatedLayoutConfigurationT&& value) {
    SetPaginatedLayoutConfiguration(std::forward<PaginatedLayoutConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSheetContentType(SheetContentType value) {
    m_sheetContentTypeHasBeenSet = true;
    m_sheetContentType = value;
  }
  inline DefaultNewSheetConfiguration& WithSheetContentType(SheetContentType value) {
    SetSheetContentType(value);
    return *this;
  }
  ///@}
 private:
