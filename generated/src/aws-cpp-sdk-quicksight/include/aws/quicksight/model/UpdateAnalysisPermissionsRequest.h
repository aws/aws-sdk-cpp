...
class UpdateAnalysisPermissionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateAnalysisPermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename AnalysisIdT = Aws::String>
  UpdateAnalysisPermissionsRequest& WithAnalysisId(AnalysisIdT&& value) {
  ...
  template <typename GrantPermissionsT = Aws::Vector<ResourcePermission>>
  UpdateAnalysisPermissionsRequest& WithGrantPermissions(GrantPermissionsT&& value) {
    SetGrantPermissions(std::forward<GrantPermissionsT>(value));
    return *this;
  }
  template <typename GrantPermissionsT = ResourcePermission>
  UpdateAnalysisPermissionsRequest& AddGrantPermissions(GrantPermissionsT&& value) {
    m_grantPermissionsHasBeenSet = true;
  ...
  template <typename RevokePermissionsT = Aws::Vector<ResourcePermission>>
  UpdateAnalysisPermissionsRequest& WithRevokePermissions(RevokePermissionsT&& value) {
    SetRevokePermissions(std::forward<RevokePermissionsT>(value));
    return *this;
  }
  template <typename RevokePermissionsT = ResourcePermission>
  UpdateAnalysisPermissionsRequest& AddRevokePermissions(RevokePermissionsT&& value) {
    m_revokePermissionsHasBeenSet = true;
