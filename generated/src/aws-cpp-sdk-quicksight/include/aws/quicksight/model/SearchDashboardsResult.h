...
class SearchDashboardsResult {
 public:
  ...
  void SetDashboardSummaryList(DashboardSummaryListT&& value) {
    m_dashboardSummaryListHasBeenSet = true;
    m_dashboardSummaryList = std::forward<DashboardSummaryListT>(value);
  }
  template <typename DashboardSummaryListT = Aws::Vector<DashboardSummary>>
  SearchDashboardsResult& WithDashboardSummaryList(DashboardSummaryListT&& value) {
    SetDashboardSummaryList(std::forward<DashboardSummaryListT>(value));
    return *this;
  }
  ...
  SearchDashboardsResult& AddDashboardSummaryList(DashboardSummaryListT&& value) {
    m_dashboardSummaryListHasBeenSet = true;
    m_dashboardSummaryList.emplace_back(std::forward<DashboardSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchDashboardsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
