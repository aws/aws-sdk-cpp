...
class TimeRangeDrillDownFilter {
 public:
  ...
  template <typename ColumnT = ColumnIdentifier>
  TimeRangeDrillDownFilter& WithColumn(ColumnT&& value) {
  ...
  template <typename RangeMinimumT = Aws::Utils::DateTime>
  TimeRangeDrillDownFilter& WithRangeMinimum(RangeMinimumT&& value) {
  ...
  template <typename RangeMaximumT = Aws::Utils::DateTime>
  TimeRangeDrillDownFilter& WithRangeMaximum(RangeMaximumT&& value) {
  ...
  inline TimeRangeDrillDownFilter& WithTimeGranularity(TimeGranularity value) {
