...
class StartAssetBundleImportJobRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  StartAssetBundleImportJobRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename AssetBundleImportJobIdT = Aws::String>
  StartAssetBundleImportJobRequest& WithAssetBundleImportJobId(AssetBundleImportJobIdT&& value) {
  ...
  template <typename AssetBundleImportSourceT = AssetBundleImportSource>
  StartAssetBundleImportJobRequest& WithAssetBundleImportSource(AssetBundleImportSourceT&& value) {
  ...
  template <typename OverrideParametersT = AssetBundleImportJobOverrideParameters>
  StartAssetBundleImportJobRequest& WithOverrideParameters(OverrideParametersT&& value) {
   ...
   * job, possibly keeping the Amazon Quick Sight account in an inconsistent
   * state.</p>
   */
  ...
  inline StartAssetBundleImportJobRequest& WithFailureAction(AssetBundleImportFailureAction value) {
  ...
  template <typename OverridePermissionsT = AssetBundleImportJobOverridePermissions>
  StartAssetBundleImportJobRequest& WithOverridePermissions(OverridePermissionsT&& value) {
  ...
  template <typename OverrideTagsT = AssetBundleImportJobOverrideTags>
  StartAssetBundleImportJobRequest& WithOverrideTags(OverrideTagsT&& value) {
  ...
  template <typename OverrideValidationStrategyT = AssetBundleImportJobOverrideValidationStrategy>
  StartAssetBundleImportJobRequest& WithOverrideValidationStrategy(OverrideValidationStrategyT&& value) {
