...
class UpdateTemplateAliasRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateTemplateAliasRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  UpdateTemplateAliasRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename AliasNameT = Aws::String>
  UpdateTemplateAliasRequest& WithAliasName(AliasNameT&& value) {
  ...
  inline UpdateTemplateAliasRequest& WithTemplateVersionNumber(long long value) {
