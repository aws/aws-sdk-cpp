...
class UpdateDataSourceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateDataSourceResult& WithArn(ArnT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  UpdateDataSourceResult& WithDataSourceId(DataSourceIdT&& value) {
  ...
  inline UpdateDataSourceResult& WithUpdateStatus(ResourceStatus value) {
  ...
  inline UpdateDataSourceResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
