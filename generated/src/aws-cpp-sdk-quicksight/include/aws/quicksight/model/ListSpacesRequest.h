...
/**
 */
class ListSpacesRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API ListSpacesRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  ListSpacesRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline ListSpacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
