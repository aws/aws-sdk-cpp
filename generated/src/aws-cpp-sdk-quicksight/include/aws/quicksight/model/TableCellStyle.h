...
class TableCellStyle {
 public:
  ...
  inline TableCellStyle& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTextWrap(TextWrap value) {
    m_textWrapHasBeenSet = true;
    m_textWrap = value;
  }
  inline TableCellStyle& WithTextWrap(TextWrap value) {
    SetTextWrap(value);
    return *this;
  }
  ///@}
  ...
  inline TableCellStyle& WithHorizontalTextAlignment(HorizontalTextAlignment value) {
  ...
  inline void SetVerticalTextAlignment(VerticalTextAlignment value) {
    m_verticalTextAlignmentHasBeenSet = true;
    m_verticalTextAlignment = value;
  }
  inline TableCellStyle& WithVerticalTextAlignment(VerticalTextAlignment value) {
  ...
  inline TableCellStyle& WithHeight(int value) {
    SetHeight(value);
    return *this;
  }
  ///@}
