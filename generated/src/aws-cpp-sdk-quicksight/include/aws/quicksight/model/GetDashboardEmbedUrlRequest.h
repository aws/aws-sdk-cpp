...
class GetDashboardEmbedUrlRequest : public QuickSightRequest {
 public:
  ...
  inline void SetIdentityType(EmbeddingIdentityType value) {
    m_identityTypeHasBeenSet = true;
    m_identityType = value;
  }
  inline GetDashboardEmbedUrlRequest& WithIdentityType(EmbeddingIdentityType value) {
  ...
  inline void SetSessionLifetimeInMinutes(long long value) {
    m_sessionLifetimeInMinutesHasBeenSet = true;
    m_sessionLifetimeInMinutes = value;
  }
  inline GetDashboardEmbedUrlRequest& WithSessionLifetimeInMinutes(long long value) {
    SetSessionLifetimeInMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUndoRedoDisabled(bool value) {
    m_undoRedoDisabledHasBeenSet = true;
    m_undoRedoDisabled = value;
  }
  inline GetDashboardEmbedUrlRequest& WithUndoRedoDisabled(bool value) {
    SetUndoRedoDisabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResetDisabled(bool value) {
    m_resetDisabledHasBeenSet = true;
    m_resetDisabled = value;
  }
  inline GetDashboardEmbedUrlRequest& WithResetDisabled(bool value) {
    SetResetDisabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatePersistenceEnabled(bool value) {
    m_statePersistenceEnabledHasBeenSet = true;
    m_statePersistenceEnabled = value;
  }
  inline GetDashboardEmbedUrlRequest& WithStatePersistenceEnabled(bool value) {
    SetStatePersistenceEnabled(value);
    return *this;
  }
  ///@}
   ...
   * users in your account (readers, authors, or admins) authenticated as one of the
   * following:</p> <ul> <li> <p>Active Directory (AD) users or group members</p>
   * </li> <li> <p>Invited nonfederated users</p> </li> <li> <p>IAM users and IAM
   * role-based sessions authenticated through Federated Single Sign-On using SAML,
   * OpenID Connect, or IAM federation.</p> </li> </ul> <p>Omit this parameter for
   * users in the third group – IAM users and IAM role-based sessions.</p>
   */
   ...
   * or IAM users. For example, if you set "<code>--dashboard-id dash_id1
  ...
  void SetAdditionalDashboardIds(AdditionalDashboardIdsT&& value) {
    m_additionalDashboardIdsHasBeenSet = true;
    m_additionalDashboardIds = std::forward<AdditionalDashboardIdsT>(value);
  }
  template <typename AdditionalDashboardIdsT = Aws::Vector<Aws::String>>
  GetDashboardEmbedUrlRequest& WithAdditionalDashboardIds(AdditionalDashboardIdsT&& value) {
    SetAdditionalDashboardIds(std::forward<AdditionalDashboardIdsT>(value));
    return *this;
  }
  ...
  GetDashboardEmbedUrlRequest& AddAdditionalDashboardIds(AdditionalDashboardIdsT&& value) {
    m_additionalDashboardIdsHasBeenSet = true;
    m_additionalDashboardIds.emplace_back(std::forward<AdditionalDashboardIdsT>(value));
    return *this;
  }
  ///@}
 private:
