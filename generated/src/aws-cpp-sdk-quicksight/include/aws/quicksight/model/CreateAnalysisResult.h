...
class CreateAnalysisResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateAnalysisResult& WithArn(ArnT&& value) {
  ...
  template <typename AnalysisIdT = Aws::String>
  CreateAnalysisResult& WithAnalysisId(AnalysisIdT&& value) {
  ...
  inline CreateAnalysisResult& WithCreationStatus(ResourceStatus value) {
  ...
  inline CreateAnalysisResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateAnalysisResult& WithRequestId(RequestIdT&& value) {
