...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    UpdateActionConnectorResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionConnectorIdT = Aws::String>
    UpdateActionConnectorResult& WithActionConnectorId(ActionConnectorIdT&& value) { SetActionConnectorId(std::forward<ActionConnectorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateActionConnectorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateActionConnectorResult& WithUpdateStatus(ResourceStatus value) { SetUpdateStatus(value); return *this;}
    ///@}
    ...
    inline UpdateActionConnectorResult& WithStatus(int value) { SetStatus(value); return *this;}
    ///@}
  private:
