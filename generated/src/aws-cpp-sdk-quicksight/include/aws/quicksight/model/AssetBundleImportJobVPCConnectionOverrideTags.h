...
class AssetBundleImportJobVPCConnectionOverrideTags {
 public:
  ...
  void SetVPCConnectionIds(VPCConnectionIdsT&& value) {
    m_vPCConnectionIdsHasBeenSet = true;
    m_vPCConnectionIds = std::forward<VPCConnectionIdsT>(value);
  }
  template <typename VPCConnectionIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobVPCConnectionOverrideTags& WithVPCConnectionIds(VPCConnectionIdsT&& value) {
    SetVPCConnectionIds(std::forward<VPCConnectionIdsT>(value));
    return *this;
  }
  template <typename VPCConnectionIdsT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideTags& AddVPCConnectionIds(VPCConnectionIdsT&& value) {
    m_vPCConnectionIdsHasBeenSet = true;
    m_vPCConnectionIds.emplace_back(std::forward<VPCConnectionIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobVPCConnectionOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobVPCConnectionOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
