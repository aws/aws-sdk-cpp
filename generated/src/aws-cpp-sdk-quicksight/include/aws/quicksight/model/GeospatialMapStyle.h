...
class GeospatialMapStyle {
 public:
  ...
  inline GeospatialMapStyle& WithBaseMapStyle(BaseMapStyleType value) {
  ...
  inline void SetBaseMapVisibility(Visibility value) {
    m_baseMapVisibilityHasBeenSet = true;
    m_baseMapVisibility = value;
  }
  inline GeospatialMapStyle& WithBaseMapVisibility(Visibility value) {
    SetBaseMapVisibility(value);
    return *this;
  }
  ///@}
 private:
