...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DescribeTopicRefreshScheduleRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeTopicRefreshScheduleRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicIdT = Aws::String>
    DescribeTopicRefreshScheduleRequest& WithTopicId(TopicIdT&& value) { SetTopicId(std::forward<TopicIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DatasetIdT = Aws::String>
    DescribeTopicRefreshScheduleRequest& WithDatasetId(DatasetIdT&& value) { SetDatasetId(std::forward<DatasetIdT>(value)); return *this;}
    ///@}
  private:
