...
class DescribeTopicRefreshScheduleRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeTopicRefreshScheduleRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TopicIdT = Aws::String>
  DescribeTopicRefreshScheduleRequest& WithTopicId(TopicIdT&& value) {
  ...
  template <typename DatasetIdT = Aws::String>
  DescribeTopicRefreshScheduleRequest& WithDatasetId(DatasetIdT&& value) {
