...
class ListThemeVersionsResult {
 public:
  ...
  void SetThemeVersionSummaryList(ThemeVersionSummaryListT&& value) {
    m_themeVersionSummaryListHasBeenSet = true;
    m_themeVersionSummaryList = std::forward<ThemeVersionSummaryListT>(value);
  }
  template <typename ThemeVersionSummaryListT = Aws::Vector<ThemeVersionSummary>>
  ListThemeVersionsResult& WithThemeVersionSummaryList(ThemeVersionSummaryListT&& value) {
    SetThemeVersionSummaryList(std::forward<ThemeVersionSummaryListT>(value));
    return *this;
  }
  template <typename ThemeVersionSummaryListT = ThemeVersionSummary>
  ListThemeVersionsResult& AddThemeVersionSummaryList(ThemeVersionSummaryListT&& value) {
    m_themeVersionSummaryListHasBeenSet = true;
    m_themeVersionSummaryList.emplace_back(std::forward<ThemeVersionSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListThemeVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThemeVersionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListThemeVersionsResult& WithRequestId(RequestIdT&& value) {
