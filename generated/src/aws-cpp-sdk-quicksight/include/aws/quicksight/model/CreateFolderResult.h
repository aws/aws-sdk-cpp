...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CreateFolderResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename FolderIdT = Aws::String>
    CreateFolderResult& WithFolderId(FolderIdT&& value) { SetFolderId(std::forward<FolderIdT>(value)); return *this;}
    ///@}
