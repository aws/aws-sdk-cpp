...
class CreateNamespaceRequest : public QuickSightRequest {
 public:
  ...
  ///@{
  /**
   * <p>The ID for the Amazon Web Services account that you want to create the Quick
   * Sight namespace in.</p>
   */
  ...
  inline CreateNamespaceRequest& WithIdentityStore(IdentityStore value) {
