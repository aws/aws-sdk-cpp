...
class GeospatialCircleSymbolStyle {
 public:
  ...
  void SetStrokeWidth(StrokeWidthT&& value) {
    ...
    m_strokeWidth = std::forward<StrokeWidthT>(value);
  }
  template <typename StrokeWidthT = GeospatialLineWidth>
  GeospatialCircleSymbolStyle& WithStrokeWidth(StrokeWidthT&& value) {
    SetStrokeWidth(std::forward<StrokeWidthT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCircleRadius(CircleRadiusT&& value) {
    ...
    m_circleRadius = std::forward<CircleRadiusT>(value);
  }
  template <typename CircleRadiusT = GeospatialCircleRadius>
  GeospatialCircleSymbolStyle& WithCircleRadius(CircleRadiusT&& value) {
    SetCircleRadius(std::forward<CircleRadiusT>(value));
    return *this;
  }
  ///@}
 private:
