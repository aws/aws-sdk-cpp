...
class QDataKey {
 public:
  ...
  void SetQDataKeyArn(QDataKeyArnT&& value) {
    m_qDataKeyArnHasBeenSet = true;
    m_qDataKeyArn = std::forward<QDataKeyArnT>(value);
  }
  template <typename QDataKeyArnT = Aws::String>
  QDataKey& WithQDataKeyArn(QDataKeyArnT&& value) {
    SetQDataKeyArn(std::forward<QDataKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetQDataKeyType(QDataKeyType value) {
    m_qDataKeyTypeHasBeenSet = true;
    m_qDataKeyType = value;
  }
  inline QDataKey& WithQDataKeyType(QDataKeyType value) {
    SetQDataKeyType(value);
    return *this;
  }
  ///@}
 private:
