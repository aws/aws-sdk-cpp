...
class AssetBundleImportJobThemeOverrideTags {
 public:
  ...
  template <typename ThemeIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobThemeOverrideTags& WithThemeIds(ThemeIdsT&& value) {
    SetThemeIds(std::forward<ThemeIdsT>(value));
    return *this;
  }
  template <typename ThemeIdsT = Aws::String>
  AssetBundleImportJobThemeOverrideTags& AddThemeIds(ThemeIdsT&& value) {
    m_themeIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobThemeOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobThemeOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
