...
class SnapshotAnonymousUserRedacted {
 public:
  ...
  void SetRowLevelPermissionTagKeys(RowLevelPermissionTagKeysT&& value) {
    m_rowLevelPermissionTagKeysHasBeenSet = true;
    m_rowLevelPermissionTagKeys = std::forward<RowLevelPermissionTagKeysT>(value);
  }
  template <typename RowLevelPermissionTagKeysT = Aws::Vector<Aws::String>>
  SnapshotAnonymousUserRedacted& WithRowLevelPermissionTagKeys(RowLevelPermissionTagKeysT&& value) {
    SetRowLevelPermissionTagKeys(std::forward<RowLevelPermissionTagKeysT>(value));
    return *this;
  }
  template <typename RowLevelPermissionTagKeysT = Aws::String>
  SnapshotAnonymousUserRedacted& AddRowLevelPermissionTagKeys(RowLevelPermissionTagKeysT&& value) {
    m_rowLevelPermissionTagKeysHasBeenSet = true;
    m_rowLevelPermissionTagKeys.emplace_back(std::forward<RowLevelPermissionTagKeysT>(value));
    return *this;
  }
  ///@}
 private:
