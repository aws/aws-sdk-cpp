...
class DataSetConfiguration {
 public:
  ...
  template <typename PlaceholderT = Aws::String>
  DataSetConfiguration& WithPlaceholder(PlaceholderT&& value) {
  ...
  template <typename DataSetSchemaT = DataSetSchema>
  DataSetConfiguration& WithDataSetSchema(DataSetSchemaT&& value) {
  ...
  template <typename ColumnGroupSchemaListT = Aws::Vector<ColumnGroupSchema>>
  DataSetConfiguration& WithColumnGroupSchemaList(ColumnGroupSchemaListT&& value) {
  ...
  DataSetConfiguration& AddColumnGroupSchemaList(ColumnGroupSchemaListT&& value) {
    m_columnGroupSchemaListHasBeenSet = true;
