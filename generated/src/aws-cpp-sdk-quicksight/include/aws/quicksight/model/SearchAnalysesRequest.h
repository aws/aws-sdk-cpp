...
class SearchAnalysesRequest : public QuickSightRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<AnalysisSearchFilter>>
  ...
  template <typename FiltersT = AnalysisSearchFilter>
  ...
  inline SearchAnalysesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
