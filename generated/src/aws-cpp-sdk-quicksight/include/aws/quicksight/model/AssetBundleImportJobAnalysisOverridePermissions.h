...
class AssetBundleImportJobAnalysisOverridePermissions {
 public:
  ...
  template <typename AnalysisIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobAnalysisOverridePermissions& WithAnalysisIds(AnalysisIdsT&& value) {
    SetAnalysisIds(std::forward<AnalysisIdsT>(value));
    return *this;
  }
  template <typename AnalysisIdsT = Aws::String>
  AssetBundleImportJobAnalysisOverridePermissions& AddAnalysisIds(AnalysisIdsT&& value) {
    m_analysisIdsHasBeenSet = true;
  ...
  template <typename PermissionsT = AssetBundleResourcePermissions>
  AssetBundleImportJobAnalysisOverridePermissions& WithPermissions(PermissionsT&& value) {
