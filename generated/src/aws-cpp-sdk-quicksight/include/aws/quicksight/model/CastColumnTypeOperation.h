...
class CastColumnTypeOperation {
 public:
  ...
  template <typename ColumnNameT = Aws::String>
  CastColumnTypeOperation& WithColumnName(ColumnNameT&& value) {
  ...
  inline void SetNewColumnType(ColumnDataType value) {
    m_newColumnTypeHasBeenSet = true;
    m_newColumnType = value;
  }
  inline CastColumnTypeOperation& WithNewColumnType(ColumnDataType value) {
  ...
  inline CastColumnTypeOperation& WithSubType(ColumnDataSubType value) {
    SetSubType(value);
    return *this;
  }
  ///@}
  ...
  template <typename FormatT = Aws::String>
  CastColumnTypeOperation& WithFormat(FormatT&& value) {
