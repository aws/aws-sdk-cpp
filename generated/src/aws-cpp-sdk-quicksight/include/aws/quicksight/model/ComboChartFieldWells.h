...
class ComboChartFieldWells {
 public:
  ...
  void SetComboChartAggregatedFieldWells(ComboChartAggregatedFieldWellsT&& value) {
    ...
    m_comboChartAggregatedFieldWells = std::forward<ComboChartAggregatedFieldWellsT>(value);
  }
  template <typename ComboChartAggregatedFieldWellsT = ComboChartAggregatedFieldWells>
  ComboChartFieldWells& WithComboChartAggregatedFieldWells(ComboChartAggregatedFieldWellsT&& value) {
    SetComboChartAggregatedFieldWells(std::forward<ComboChartAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
