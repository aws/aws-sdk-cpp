...
class CreateIAMPolicyAssignmentRequest : public QuickSightRequest {
 public:
   ...
   * policy to Amazon Quick Sight users or groups.</p>
   */
  ...
  template <typename AwsAccountIdT = Aws::String>
  CreateIAMPolicyAssignmentRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename AssignmentNameT = Aws::String>
  CreateIAMPolicyAssignmentRequest& WithAssignmentName(AssignmentNameT&& value) {
  ...
  inline CreateIAMPolicyAssignmentRequest& WithAssignmentStatus(AssignmentStatus value) {
  ...
  template <typename PolicyArnT = Aws::String>
  CreateIAMPolicyAssignmentRequest& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename IdentitiesT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  CreateIAMPolicyAssignmentRequest& WithIdentities(IdentitiesT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  CreateIAMPolicyAssignmentRequest& WithNamespace(NamespaceT&& value) {
