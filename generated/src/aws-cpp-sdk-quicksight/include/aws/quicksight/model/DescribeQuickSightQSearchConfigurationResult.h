...
class DescribeQuickSightQSearchConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeQuickSightQSearchConfigurationResult& operator=(
  ...
  inline DescribeQuickSightQSearchConfigurationResult& WithQSearchStatus(QSearchStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeQuickSightQSearchConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeQuickSightQSearchConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
