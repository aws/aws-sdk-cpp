...
class AssetBundleImportJobDataSourceOverrideTags {
 public:
  ...
  template <typename DataSourceIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobDataSourceOverrideTags& WithDataSourceIds(DataSourceIdsT&& value) {
    SetDataSourceIds(std::forward<DataSourceIdsT>(value));
    return *this;
  }
  template <typename DataSourceIdsT = Aws::String>
  AssetBundleImportJobDataSourceOverrideTags& AddDataSourceIds(DataSourceIdsT&& value) {
    m_dataSourceIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobDataSourceOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobDataSourceOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
