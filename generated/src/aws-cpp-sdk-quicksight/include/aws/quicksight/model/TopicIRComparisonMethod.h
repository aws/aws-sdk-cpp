...
class TopicIRComparisonMethod {
 public:
  ...
  inline void SetType(ComparisonMethodType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TopicIRComparisonMethod& WithType(ComparisonMethodType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline TopicIRComparisonMethod& WithPeriod(TopicTimeGranularity value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline TopicIRComparisonMethod& WithWindowSize(int value) {
    SetWindowSize(value);
    return *this;
  }
  ///@}
