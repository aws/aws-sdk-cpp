...
namespace Model
{
  ...
  public:
     ...
     */
    inline const ComparisonMethodType& GetType() const{ return m_type; }
    inline bool TypeHasBeenSet() const { return m_typeHasBeenSet; }
    inline void SetType(const ComparisonMethodType& value) { m_typeHasBeenSet = true; m_type = value; }
    inline void SetType(ComparisonMethodType&& value) { m_typeHasBeenSet = true; m_type = std::move(value); }
    inline TopicIRComparisonMethod& WithType(const ComparisonMethodType& value) { SetType(value); return *this;}
    inline TopicIRComparisonMethod& WithType(ComparisonMethodType&& value) { SetType(std::move(value)); return *this;}
    ///@}
    ...
    inline TopicIRComparisonMethod& WithPeriod(const TopicTimeGranularity& value) { SetPeriod(value); return *this;}
    inline TopicIRComparisonMethod& WithPeriod(TopicTimeGranularity&& value) { SetPeriod(std::move(value)); return *this;}
    ///@}
