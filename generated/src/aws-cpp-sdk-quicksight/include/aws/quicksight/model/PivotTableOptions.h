...
class PivotTableOptions {
 public:
  ...
  inline void SetMetricPlacement(PivotTableMetricPlacement value) {
    m_metricPlacementHasBeenSet = true;
    m_metricPlacement = value;
  }
  inline PivotTableOptions& WithMetricPlacement(PivotTableMetricPlacement value) {
    SetMetricPlacement(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSingleMetricVisibility(Visibility value) {
    m_singleMetricVisibilityHasBeenSet = true;
    m_singleMetricVisibility = value;
  }
  inline PivotTableOptions& WithSingleMetricVisibility(Visibility value) {
    SetSingleMetricVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetColumnNamesVisibility(Visibility value) {
    m_columnNamesVisibilityHasBeenSet = true;
    m_columnNamesVisibility = value;
  }
  inline PivotTableOptions& WithColumnNamesVisibility(Visibility value) {
    SetColumnNamesVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetToggleButtonsVisibility(Visibility value) {
    m_toggleButtonsVisibilityHasBeenSet = true;
    m_toggleButtonsVisibility = value;
  }
  inline PivotTableOptions& WithToggleButtonsVisibility(Visibility value) {
    SetToggleButtonsVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetColumnHeaderStyle(ColumnHeaderStyleT&& value) {
    ...
    m_columnHeaderStyle = std::forward<ColumnHeaderStyleT>(value);
  }
  template <typename ColumnHeaderStyleT = TableCellStyle>
  PivotTableOptions& WithColumnHeaderStyle(ColumnHeaderStyleT&& value) {
    SetColumnHeaderStyle(std::forward<ColumnHeaderStyleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRowHeaderStyle(RowHeaderStyleT&& value) {
    ...
    m_rowHeaderStyle = std::forward<RowHeaderStyleT>(value);
  }
  template <typename RowHeaderStyleT = TableCellStyle>
  PivotTableOptions& WithRowHeaderStyle(RowHeaderStyleT&& value) {
    SetRowHeaderStyle(std::forward<RowHeaderStyleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRowFieldNamesStyle(RowFieldNamesStyleT&& value) {
    ...
    m_rowFieldNamesStyle = std::forward<RowFieldNamesStyleT>(value);
  }
  template <typename RowFieldNamesStyleT = TableCellStyle>
  PivotTableOptions& WithRowFieldNamesStyle(RowFieldNamesStyleT&& value) {
    SetRowFieldNamesStyle(std::forward<RowFieldNamesStyleT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCollapsedRowDimensionsVisibility(Visibility value) {
    m_collapsedRowDimensionsVisibilityHasBeenSet = true;
    m_collapsedRowDimensionsVisibility = value;
  }
  inline PivotTableOptions& WithCollapsedRowDimensionsVisibility(Visibility value) {
    SetCollapsedRowDimensionsVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRowsLayout(PivotTableRowsLayout value) {
    m_rowsLayoutHasBeenSet = true;
    m_rowsLayout = value;
  }
  inline PivotTableOptions& WithRowsLayout(PivotTableRowsLayout value) {
    SetRowsLayout(value);
    return *this;
  }
  ///@}
  ...
  void SetRowsLabelOptions(RowsLabelOptionsT&& value) {
    ...
    m_rowsLabelOptions = std::forward<RowsLabelOptionsT>(value);
  }
  template <typename RowsLabelOptionsT = PivotTableRowsLabelOptions>
  PivotTableOptions& WithRowsLabelOptions(RowsLabelOptionsT&& value) {
    SetRowsLabelOptions(std::forward<RowsLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultCellWidth(DefaultCellWidthT&& value) {
    ...
    m_defaultCellWidth = std::forward<DefaultCellWidthT>(value);
  }
  template <typename DefaultCellWidthT = Aws::String>
  PivotTableOptions& WithDefaultCellWidth(DefaultCellWidthT&& value) {
    SetDefaultCellWidth(std::forward<DefaultCellWidthT>(value));
    return *this;
  }
  ///@}
 private:
