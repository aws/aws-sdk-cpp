...
class DateAxisOptions {
 public:
  ...
  inline void SetMissingDateVisibility(Visibility value) {
    m_missingDateVisibilityHasBeenSet = true;
    m_missingDateVisibility = value;
  }
  inline DateAxisOptions& WithMissingDateVisibility(Visibility value) {
    SetMissingDateVisibility(value);
    return *this;
  }
  ///@}
 private:
