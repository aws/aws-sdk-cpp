...
class DataSourceParameters {
 public:
  ...
  void SetAmazonElasticsearchParameters(AmazonElasticsearchParametersT&& value) {
    ...
    m_amazonElasticsearchParameters = std::forward<AmazonElasticsearchParametersT>(value);
  }
  template <typename AmazonElasticsearchParametersT = AmazonElasticsearchParameters>
  DataSourceParameters& WithAmazonElasticsearchParameters(AmazonElasticsearchParametersT&& value) {
    SetAmazonElasticsearchParameters(std::forward<AmazonElasticsearchParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAthenaParameters(AthenaParametersT&& value) {
    ...
    m_athenaParameters = std::forward<AthenaParametersT>(value);
  }
  template <typename AthenaParametersT = AthenaParameters>
  DataSourceParameters& WithAthenaParameters(AthenaParametersT&& value) {
    SetAthenaParameters(std::forward<AthenaParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuroraParameters(AuroraParametersT&& value) {
    ...
    m_auroraParameters = std::forward<AuroraParametersT>(value);
  }
  template <typename AuroraParametersT = AuroraParameters>
  DataSourceParameters& WithAuroraParameters(AuroraParametersT&& value) {
    SetAuroraParameters(std::forward<AuroraParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuroraPostgreSqlParameters(AuroraPostgreSqlParametersT&& value) {
    ...
    m_auroraPostgreSqlParameters = std::forward<AuroraPostgreSqlParametersT>(value);
  }
  template <typename AuroraPostgreSqlParametersT = AuroraPostgreSqlParameters>
  DataSourceParameters& WithAuroraPostgreSqlParameters(AuroraPostgreSqlParametersT&& value) {
    SetAuroraPostgreSqlParameters(std::forward<AuroraPostgreSqlParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsIotAnalyticsParameters(AwsIotAnalyticsParametersT&& value) {
    ...
    m_awsIotAnalyticsParameters = std::forward<AwsIotAnalyticsParametersT>(value);
  }
  template <typename AwsIotAnalyticsParametersT = AwsIotAnalyticsParameters>
  DataSourceParameters& WithAwsIotAnalyticsParameters(AwsIotAnalyticsParametersT&& value) {
    SetAwsIotAnalyticsParameters(std::forward<AwsIotAnalyticsParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJiraParameters(JiraParametersT&& value) {
    ...
    m_jiraParameters = std::forward<JiraParametersT>(value);
  }
  template <typename JiraParametersT = JiraParameters>
  DataSourceParameters& WithJiraParameters(JiraParametersT&& value) {
    SetJiraParameters(std::forward<JiraParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMariaDbParameters(MariaDbParametersT&& value) {
    ...
    m_mariaDbParameters = std::forward<MariaDbParametersT>(value);
  }
  template <typename MariaDbParametersT = MariaDbParameters>
  DataSourceParameters& WithMariaDbParameters(MariaDbParametersT&& value) {
    SetMariaDbParameters(std::forward<MariaDbParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMySqlParameters(MySqlParametersT&& value) {
    ...
    m_mySqlParameters = std::forward<MySqlParametersT>(value);
  }
  template <typename MySqlParametersT = MySqlParameters>
  DataSourceParameters& WithMySqlParameters(MySqlParametersT&& value) {
    SetMySqlParameters(std::forward<MySqlParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOracleParameters(OracleParametersT&& value) {
    ...
    m_oracleParameters = std::forward<OracleParametersT>(value);
  }
  template <typename OracleParametersT = OracleParameters>
  DataSourceParameters& WithOracleParameters(OracleParametersT&& value) {
    SetOracleParameters(std::forward<OracleParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostgreSqlParameters(PostgreSqlParametersT&& value) {
    ...
    m_postgreSqlParameters = std::forward<PostgreSqlParametersT>(value);
  }
  template <typename PostgreSqlParametersT = PostgreSqlParameters>
  DataSourceParameters& WithPostgreSqlParameters(PostgreSqlParametersT&& value) {
    SetPostgreSqlParameters(std::forward<PostgreSqlParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrestoParameters(PrestoParametersT&& value) {
    ...
    m_prestoParameters = std::forward<PrestoParametersT>(value);
  }
  template <typename PrestoParametersT = PrestoParameters>
  DataSourceParameters& WithPrestoParameters(PrestoParametersT&& value) {
    SetPrestoParameters(std::forward<PrestoParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRdsParameters(RdsParametersT&& value) {
    ...
    m_rdsParameters = std::forward<RdsParametersT>(value);
  }
  template <typename RdsParametersT = RdsParameters>
  DataSourceParameters& WithRdsParameters(RdsParametersT&& value) {
    SetRdsParameters(std::forward<RdsParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftParameters(RedshiftParametersT&& value) {
    ...
    m_redshiftParameters = std::forward<RedshiftParametersT>(value);
  }
  template <typename RedshiftParametersT = RedshiftParameters>
  DataSourceParameters& WithRedshiftParameters(RedshiftParametersT&& value) {
    SetRedshiftParameters(std::forward<RedshiftParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3Parameters(S3ParametersT&& value) {
    ...
    m_s3Parameters = std::forward<S3ParametersT>(value);
  }
  template <typename S3ParametersT = S3Parameters>
  ...
  void SetS3KnowledgeBaseParameters(S3KnowledgeBaseParametersT&& value) {
    ...
    m_s3KnowledgeBaseParameters = std::forward<S3KnowledgeBaseParametersT>(value);
  }
  template <typename S3KnowledgeBaseParametersT = S3KnowledgeBaseParameters>
  DataSourceParameters& WithS3KnowledgeBaseParameters(S3KnowledgeBaseParametersT&& value) {
    SetS3KnowledgeBaseParameters(std::forward<S3KnowledgeBaseParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetServiceNowParameters(ServiceNowParametersT&& value) {
    ...
    m_serviceNowParameters = std::forward<ServiceNowParametersT>(value);
  }
  template <typename ServiceNowParametersT = ServiceNowParameters>
  DataSourceParameters& WithServiceNowParameters(ServiceNowParametersT&& value) {
    SetServiceNowParameters(std::forward<ServiceNowParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnowflakeParameters(SnowflakeParametersT&& value) {
    ...
    m_snowflakeParameters = std::forward<SnowflakeParametersT>(value);
  }
  template <typename SnowflakeParametersT = SnowflakeParameters>
  DataSourceParameters& WithSnowflakeParameters(SnowflakeParametersT&& value) {
    SetSnowflakeParameters(std::forward<SnowflakeParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkParameters(SparkParametersT&& value) {
    ...
    m_sparkParameters = std::forward<SparkParametersT>(value);
  }
  template <typename SparkParametersT = SparkParameters>
  DataSourceParameters& WithSparkParameters(SparkParametersT&& value) {
    SetSparkParameters(std::forward<SparkParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqlServerParameters(SqlServerParametersT&& value) {
    ...
    m_sqlServerParameters = std::forward<SqlServerParametersT>(value);
  }
  template <typename SqlServerParametersT = SqlServerParameters>
  DataSourceParameters& WithSqlServerParameters(SqlServerParametersT&& value) {
    SetSqlServerParameters(std::forward<SqlServerParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTeradataParameters(TeradataParametersT&& value) {
    ...
    m_teradataParameters = std::forward<TeradataParametersT>(value);
  }
  template <typename TeradataParametersT = TeradataParameters>
  DataSourceParameters& WithTeradataParameters(TeradataParametersT&& value) {
    SetTeradataParameters(std::forward<TeradataParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTwitterParameters(TwitterParametersT&& value) {
    ...
    m_twitterParameters = std::forward<TwitterParametersT>(value);
  }
  template <typename TwitterParametersT = TwitterParameters>
  DataSourceParameters& WithTwitterParameters(TwitterParametersT&& value) {
    SetTwitterParameters(std::forward<TwitterParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmazonOpenSearchParameters(AmazonOpenSearchParametersT&& value) {
    ...
    m_amazonOpenSearchParameters = std::forward<AmazonOpenSearchParametersT>(value);
  }
  template <typename AmazonOpenSearchParametersT = AmazonOpenSearchParameters>
  DataSourceParameters& WithAmazonOpenSearchParameters(AmazonOpenSearchParametersT&& value) {
    SetAmazonOpenSearchParameters(std::forward<AmazonOpenSearchParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExasolParameters(ExasolParametersT&& value) {
    ...
    m_exasolParameters = std::forward<ExasolParametersT>(value);
  }
  template <typename ExasolParametersT = ExasolParameters>
  DataSourceParameters& WithExasolParameters(ExasolParametersT&& value) {
    SetExasolParameters(std::forward<ExasolParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabricksParameters(DatabricksParametersT&& value) {
    ...
    m_databricksParameters = std::forward<DatabricksParametersT>(value);
  }
  template <typename DatabricksParametersT = DatabricksParameters>
  DataSourceParameters& WithDatabricksParameters(DatabricksParametersT&& value) {
    SetDatabricksParameters(std::forward<DatabricksParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStarburstParameters(StarburstParametersT&& value) {
    ...
    m_starburstParameters = std::forward<StarburstParametersT>(value);
  }
  template <typename StarburstParametersT = StarburstParameters>
  DataSourceParameters& WithStarburstParameters(StarburstParametersT&& value) {
    SetStarburstParameters(std::forward<StarburstParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrinoParameters(TrinoParametersT&& value) {
    ...
    m_trinoParameters = std::forward<TrinoParametersT>(value);
  }
  template <typename TrinoParametersT = TrinoParameters>
  DataSourceParameters& WithTrinoParameters(TrinoParametersT&& value) {
    SetTrinoParameters(std::forward<TrinoParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBigQueryParameters(BigQueryParametersT&& value) {
    ...
    m_bigQueryParameters = std::forward<BigQueryParametersT>(value);
  }
  template <typename BigQueryParametersT = BigQueryParameters>
  DataSourceParameters& WithBigQueryParameters(BigQueryParametersT&& value) {
    SetBigQueryParameters(std::forward<BigQueryParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImpalaParameters(ImpalaParametersT&& value) {
    ...
    m_impalaParameters = std::forward<ImpalaParametersT>(value);
  }
  template <typename ImpalaParametersT = ImpalaParameters>
  DataSourceParameters& WithImpalaParameters(ImpalaParametersT&& value) {
    SetImpalaParameters(std::forward<ImpalaParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomConnectionParameters(CustomConnectionParametersT&& value) {
    ...
    m_customConnectionParameters = std::forward<CustomConnectionParametersT>(value);
  }
  template <typename CustomConnectionParametersT = CustomConnectionParameters>
  DataSourceParameters& WithCustomConnectionParameters(CustomConnectionParametersT&& value) {
    SetCustomConnectionParameters(std::forward<CustomConnectionParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWebCrawlerParameters(WebCrawlerParametersT&& value) {
    ...
    m_webCrawlerParameters = std::forward<WebCrawlerParametersT>(value);
  }
  template <typename WebCrawlerParametersT = WebCrawlerParameters>
  DataSourceParameters& WithWebCrawlerParameters(WebCrawlerParametersT&& value) {
    SetWebCrawlerParameters(std::forward<WebCrawlerParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfluenceParameters(ConfluenceParametersT&& value) {
    ...
    m_confluenceParameters = std::forward<ConfluenceParametersT>(value);
  }
  template <typename ConfluenceParametersT = ConfluenceParameters>
  DataSourceParameters& WithConfluenceParameters(ConfluenceParametersT&& value) {
    SetConfluenceParameters(std::forward<ConfluenceParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQBusinessParameters(QBusinessParametersT&& value) {
    ...
    m_qBusinessParameters = std::forward<QBusinessParametersT>(value);
  }
  template <typename QBusinessParametersT = QBusinessParameters>
  DataSourceParameters& WithQBusinessParameters(QBusinessParametersT&& value) {
    SetQBusinessParameters(std::forward<QBusinessParametersT>(value));
    return *this;
  }
  ///@}
 private:
