...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API KPIComparisonValueConditionalFormatting() = default;
    ...
    template<typename TextColorT = ConditionalFormattingColor>
    KPIComparisonValueConditionalFormatting& WithTextColor(TextColorT&& value) { SetTextColor(std::forward<TextColorT>(value)); return *this;}
    ///@}
    ...
    template<typename IconT = ConditionalFormattingIcon>
    KPIComparisonValueConditionalFormatting& WithIcon(IconT&& value) { SetIcon(std::forward<IconT>(value)); return *this;}
    ///@}
  private:
