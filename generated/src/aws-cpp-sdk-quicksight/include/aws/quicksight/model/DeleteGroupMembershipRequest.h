...
namespace Model
{
  ...
  /**
   */
  class DeleteGroupMembershipRequest : public QuickSightRequest
  {
  public:
    ...
    template<typename MemberNameT = Aws::String>
    DeleteGroupMembershipRequest& WithMemberName(MemberNameT&& value) { SetMemberName(std::forward<MemberNameT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupNameT = Aws::String>
    DeleteGroupMembershipRequest& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AwsAccountIdT = Aws::String>
    DeleteGroupMembershipRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DeleteGroupMembershipRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
  private:
