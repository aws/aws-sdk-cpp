...
#include <aws/quicksight/model/TopicV2Summary.h>
...
class SearchTopicsV2Result {
 public:
   ...
   */
  inline const Aws::Vector<TopicV2Summary>& GetTopicSummaryList() const { return m_topicSummaryList; }
  template <typename TopicSummaryListT = Aws::Vector<TopicV2Summary>>
  void SetTopicSummaryList(TopicSummaryListT&& value) {
    m_topicSummaryListHasBeenSet = true;
    m_topicSummaryList = std::forward<TopicSummaryListT>(value);
  }
  template <typename TopicSummaryListT = Aws::Vector<TopicV2Summary>>
  SearchTopicsV2Result& WithTopicSummaryList(TopicSummaryListT&& value) {
    SetTopicSummaryList(std::forward<TopicSummaryListT>(value));
    return *this;
  }
  template <typename TopicSummaryListT = TopicV2Summary>
  SearchTopicsV2Result& AddTopicSummaryList(TopicSummaryListT&& value) {
    m_topicSummaryListHasBeenSet = true;
    m_topicSummaryList.emplace_back(std::forward<TopicSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchTopicsV2Result& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 ...
 private:
  Aws::Vector<TopicV2Summary> m_topicSummaryList;
