...
class FilterControl {
 public:
  ...
  template <typename DateTimePickerT = FilterDateTimePickerControl>
  FilterControl& WithDateTimePicker(DateTimePickerT&& value) {
  ...
  template <typename ListT = FilterListControl>
  FilterControl& WithList(ListT&& value) {
  ...
  template <typename DropdownT = FilterDropDownControl>
  FilterControl& WithDropdown(DropdownT&& value) {
  ...
  template <typename TextFieldT = FilterTextFieldControl>
  FilterControl& WithTextField(TextFieldT&& value) {
  ...
  template <typename TextAreaT = FilterTextAreaControl>
  FilterControl& WithTextArea(TextAreaT&& value) {
  ...
  template <typename SliderT = FilterSliderControl>
  FilterControl& WithSlider(SliderT&& value) {
  ...
  void SetRelativeDateTime(RelativeDateTimeT&& value) {
    m_relativeDateTimeHasBeenSet = true;
    m_relativeDateTime = std::forward<RelativeDateTimeT>(value);
  }
  template <typename RelativeDateTimeT = FilterRelativeDateTimeControl>
  FilterControl& WithRelativeDateTime(RelativeDateTimeT&& value) {
    SetRelativeDateTime(std::forward<RelativeDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrossSheet(CrossSheetT&& value) {
    m_crossSheetHasBeenSet = true;
    m_crossSheet = std::forward<CrossSheetT>(value);
  }
  template <typename CrossSheetT = FilterCrossSheetControl>
  FilterControl& WithCrossSheet(CrossSheetT&& value) {
    SetCrossSheet(std::forward<CrossSheetT>(value));
    return *this;
  }
  ///@}
 private:
