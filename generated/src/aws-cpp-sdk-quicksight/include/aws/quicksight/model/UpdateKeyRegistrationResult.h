...
class UpdateKeyRegistrationResult {
 public:
  ...
  void SetFailedKeyRegistration(FailedKeyRegistrationT&& value) {
    ...
    m_failedKeyRegistration = std::forward<FailedKeyRegistrationT>(value);
  }
  template <typename FailedKeyRegistrationT = Aws::Vector<FailedKeyRegistrationEntry>>
  UpdateKeyRegistrationResult& WithFailedKeyRegistration(FailedKeyRegistrationT&& value) {
    SetFailedKeyRegistration(std::forward<FailedKeyRegistrationT>(value));
    return *this;
  }
  ...
  UpdateKeyRegistrationResult& AddFailedKeyRegistration(FailedKeyRegistrationT&& value) {
    m_failedKeyRegistrationHasBeenSet = true;
    m_failedKeyRegistration.emplace_back(std::forward<FailedKeyRegistrationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSuccessfulKeyRegistration(SuccessfulKeyRegistrationT&& value) {
    ...
    m_successfulKeyRegistration = std::forward<SuccessfulKeyRegistrationT>(value);
  }
  template <typename SuccessfulKeyRegistrationT = Aws::Vector<SuccessfulKeyRegistrationEntry>>
  UpdateKeyRegistrationResult& WithSuccessfulKeyRegistration(SuccessfulKeyRegistrationT&& value) {
    SetSuccessfulKeyRegistration(std::forward<SuccessfulKeyRegistrationT>(value));
    return *this;
  }
  ...
  UpdateKeyRegistrationResult& AddSuccessfulKeyRegistration(SuccessfulKeyRegistrationT&& value) {
    m_successfulKeyRegistrationHasBeenSet = true;
    m_successfulKeyRegistration.emplace_back(std::forward<SuccessfulKeyRegistrationT>(value));
    return *this;
  }
  ///@}
