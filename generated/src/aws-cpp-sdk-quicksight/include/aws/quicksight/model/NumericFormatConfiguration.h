...
class NumericFormatConfiguration {
 public:
  ...
  void SetNumberDisplayFormatConfiguration(NumberDisplayFormatConfigurationT&& value) {
    ...
    m_numberDisplayFormatConfiguration = std::forward<NumberDisplayFormatConfigurationT>(value);
  }
  template <typename NumberDisplayFormatConfigurationT = NumberDisplayFormatConfiguration>
  NumericFormatConfiguration& WithNumberDisplayFormatConfiguration(NumberDisplayFormatConfigurationT&& value) {
    SetNumberDisplayFormatConfiguration(std::forward<NumberDisplayFormatConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const CurrencyDisplayFormatConfiguration& GetCurrencyDisplayFormatConfiguration() const {
    return m_currencyDisplayFormatConfiguration;
  }
  ...
  void SetCurrencyDisplayFormatConfiguration(CurrencyDisplayFormatConfigurationT&& value) {
    ...
    m_currencyDisplayFormatConfiguration = std::forward<CurrencyDisplayFormatConfigurationT>(value);
  }
  template <typename CurrencyDisplayFormatConfigurationT = CurrencyDisplayFormatConfiguration>
  NumericFormatConfiguration& WithCurrencyDisplayFormatConfiguration(CurrencyDisplayFormatConfigurationT&& value) {
    SetCurrencyDisplayFormatConfiguration(std::forward<CurrencyDisplayFormatConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const PercentageDisplayFormatConfiguration& GetPercentageDisplayFormatConfiguration() const {
    return m_percentageDisplayFormatConfiguration;
  }
  ...
  void SetPercentageDisplayFormatConfiguration(PercentageDisplayFormatConfigurationT&& value) {
    ...
    m_percentageDisplayFormatConfiguration = std::forward<PercentageDisplayFormatConfigurationT>(value);
  }
  template <typename PercentageDisplayFormatConfigurationT = PercentageDisplayFormatConfiguration>
  NumericFormatConfiguration& WithPercentageDisplayFormatConfiguration(PercentageDisplayFormatConfigurationT&& value) {
    SetPercentageDisplayFormatConfiguration(std::forward<PercentageDisplayFormatConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
