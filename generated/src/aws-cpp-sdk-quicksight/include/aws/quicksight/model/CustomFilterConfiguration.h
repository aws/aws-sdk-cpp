...
class CustomFilterConfiguration {
 public:
  ...
  inline CustomFilterConfiguration& WithMatchOperator(CategoryFilterMatchOperator value) {
  ...
  void SetCategoryValue(CategoryValueT&& value) {
    m_categoryValueHasBeenSet = true;
    m_categoryValue = std::forward<CategoryValueT>(value);
  }
  template <typename CategoryValueT = Aws::String>
  CustomFilterConfiguration& WithCategoryValue(CategoryValueT&& value) {
    SetCategoryValue(std::forward<CategoryValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline CustomFilterConfiguration& WithSelectAllOptions(CategoryFilterSelectAllOptions value) {
  ...
  template <typename ParameterNameT = Aws::String>
  CustomFilterConfiguration& WithParameterName(ParameterNameT&& value) {
  ...
  inline CustomFilterConfiguration& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
