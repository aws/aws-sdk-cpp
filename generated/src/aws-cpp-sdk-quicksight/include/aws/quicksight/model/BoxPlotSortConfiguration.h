...
class BoxPlotSortConfiguration {
 public:
  ...
  template <typename CategorySortT = Aws::Vector<FieldSortOptions>>
  BoxPlotSortConfiguration& WithCategorySort(CategorySortT&& value) {
    SetCategorySort(std::forward<CategorySortT>(value));
    return *this;
  }
  template <typename CategorySortT = FieldSortOptions>
  BoxPlotSortConfiguration& AddCategorySort(CategorySortT&& value) {
    m_categorySortHasBeenSet = true;
  ...
  template <typename PaginationConfigurationT = PaginationConfiguration>
  BoxPlotSortConfiguration& WithPaginationConfiguration(PaginationConfigurationT&& value) {
