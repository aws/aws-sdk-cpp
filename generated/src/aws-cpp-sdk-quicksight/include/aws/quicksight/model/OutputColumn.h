...
class OutputColumn {
 public:
  ...
  inline void SetType(ColumnDataType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OutputColumn& WithType(ColumnDataType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSubType(ColumnDataSubType value) {
    m_subTypeHasBeenSet = true;
    m_subType = value;
  }
  inline OutputColumn& WithSubType(ColumnDataSubType value) {
    SetSubType(value);
    return *this;
  }
  ///@}
