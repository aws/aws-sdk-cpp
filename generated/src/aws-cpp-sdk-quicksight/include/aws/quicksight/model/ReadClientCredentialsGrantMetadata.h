...
class ReadClientCredentialsGrantMetadata {
 public:
  ...
  void SetReadClientCredentialsDetails(ReadClientCredentialsDetailsT&& value) {
    m_readClientCredentialsDetailsHasBeenSet = true;
    m_readClientCredentialsDetails = std::forward<ReadClientCredentialsDetailsT>(value);
  }
  template <typename ReadClientCredentialsDetailsT = ReadClientCredentialsDetails>
  ReadClientCredentialsGrantMetadata& WithReadClientCredentialsDetails(ReadClientCredentialsDetailsT&& value) {
    SetReadClientCredentialsDetails(std::forward<ReadClientCredentialsDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReadClientCredentialsGrantMetadata& WithClientCredentialsSource(ClientCredentialsSource value) {
