...
class AssetBundleExportJobThemeOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobThemeOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobThemePropertyToOverride>>
  AssetBundleExportJobThemeOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobThemeOverrideProperties& AddProperties(AssetBundleExportJobThemePropertyToOverride value) {
    m_propertiesHasBeenSet = true;
