...
namespace Model
{
  ...
  public:
    ...
    template<typename ParameterControlIdT = Aws::String>
    ParameterDateTimePickerControl& WithParameterControlId(ParameterControlIdT&& value) { SetParameterControlId(std::forward<ParameterControlIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = Aws::String>
    ParameterDateTimePickerControl& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceParameterNameT = Aws::String>
    ParameterDateTimePickerControl& WithSourceParameterName(SourceParameterNameT&& value) { SetSourceParameterName(std::forward<SourceParameterNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayOptionsT = DateTimePickerControlDisplayOptions>
    ParameterDateTimePickerControl& WithDisplayOptions(DisplayOptionsT&& value) { SetDisplayOptions(std::forward<DisplayOptionsT>(value)); return *this;}
    ///@}
  private:
