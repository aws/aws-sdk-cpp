...
class HistogramVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  HistogramVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  HistogramVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  HistogramVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = HistogramConfiguration>
  HistogramVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  HistogramVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  HistogramVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  HistogramVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
