...
/**
 */
class UpdateKnowledgeBasePermissionsRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API UpdateKnowledgeBasePermissionsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "UpdateKnowledgeBasePermissions"; }
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateKnowledgeBasePermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  UpdateKnowledgeBasePermissionsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename GrantPermissionsT = Aws::Vector<ResourcePermission>>
  UpdateKnowledgeBasePermissionsRequest& WithGrantPermissions(GrantPermissionsT&& value) {
    SetGrantPermissions(std::forward<GrantPermissionsT>(value));
    return *this;
  }
  template <typename GrantPermissionsT = ResourcePermission>
  UpdateKnowledgeBasePermissionsRequest& AddGrantPermissions(GrantPermissionsT&& value) {
    m_grantPermissionsHasBeenSet = true;
  ...
  template <typename RevokePermissionsT = Aws::Vector<ResourcePermission>>
  UpdateKnowledgeBasePermissionsRequest& WithRevokePermissions(RevokePermissionsT&& value) {
    SetRevokePermissions(std::forward<RevokePermissionsT>(value));
    return *this;
  }
  template <typename RevokePermissionsT = ResourcePermission>
  UpdateKnowledgeBasePermissionsRequest& AddRevokePermissions(RevokePermissionsT&& value) {
    m_revokePermissionsHasBeenSet = true;
