...
class BodySectionRepeatDimensionConfiguration {
 public:
   ...
   */
  inline const BodySectionDynamicCategoryDimensionConfiguration& GetDynamicCategoryDimensionConfiguration() const {
    return m_dynamicCategoryDimensionConfiguration;
  }
  ...
  void SetDynamicCategoryDimensionConfiguration(DynamicCategoryDimensionConfigurationT&& value) {
    ...
    m_dynamicCategoryDimensionConfiguration = std::forward<DynamicCategoryDimensionConfigurationT>(value);
  }
  template <typename DynamicCategoryDimensionConfigurationT = BodySectionDynamicCategoryDimensionConfiguration>
  BodySectionRepeatDimensionConfiguration& WithDynamicCategoryDimensionConfiguration(DynamicCategoryDimensionConfigurationT&& value) {
    SetDynamicCategoryDimensionConfiguration(std::forward<DynamicCategoryDimensionConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const BodySectionDynamicNumericDimensionConfiguration& GetDynamicNumericDimensionConfiguration() const {
    return m_dynamicNumericDimensionConfiguration;
  }
  ...
  void SetDynamicNumericDimensionConfiguration(DynamicNumericDimensionConfigurationT&& value) {
    ...
    m_dynamicNumericDimensionConfiguration = std::forward<DynamicNumericDimensionConfigurationT>(value);
  }
  template <typename DynamicNumericDimensionConfigurationT = BodySectionDynamicNumericDimensionConfiguration>
  BodySectionRepeatDimensionConfiguration& WithDynamicNumericDimensionConfiguration(DynamicNumericDimensionConfigurationT&& value) {
    SetDynamicNumericDimensionConfiguration(std::forward<DynamicNumericDimensionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
