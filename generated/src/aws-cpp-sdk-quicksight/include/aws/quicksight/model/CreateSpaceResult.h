...
class CreateSpaceResult {
 public:
  AWS_QUICKSIGHT_API CreateSpaceResult() = default;
  AWS_QUICKSIGHT_API CreateSpaceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API CreateSpaceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
