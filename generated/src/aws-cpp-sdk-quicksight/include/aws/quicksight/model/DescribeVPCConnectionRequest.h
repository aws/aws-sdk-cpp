...
namespace Model
{
  ...
  public:
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeVPCConnectionRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VPCConnectionIdT = Aws::String>
    DescribeVPCConnectionRequest& WithVPCConnectionId(VPCConnectionIdT&& value) { SetVPCConnectionId(std::forward<VPCConnectionIdT>(value)); return *this;}
    ///@}
  private:
