...
class DefaultSliderControlOptions {
 public:
  ...
  inline DefaultSliderControlOptions& WithType(SheetControlSliderType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DefaultSliderControlOptions& WithMaximumValue(double value) {
  ...
  inline DefaultSliderControlOptions& WithMinimumValue(double value) {
  ...
  inline DefaultSliderControlOptions& WithStepSize(double value) {
    SetStepSize(value);
    return *this;
  }
  ///@}
