...
class AnonymousUserDashboardEmbeddingConfiguration {
 public:
  ...
  void SetInitialDashboardId(InitialDashboardIdT&& value) {
    m_initialDashboardIdHasBeenSet = true;
    m_initialDashboardId = std::forward<InitialDashboardIdT>(value);
  }
  template <typename InitialDashboardIdT = Aws::String>
  AnonymousUserDashboardEmbeddingConfiguration& WithInitialDashboardId(InitialDashboardIdT&& value) {
    SetInitialDashboardId(std::forward<InitialDashboardIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AnonymousUserDashboardEmbeddingConfigurationEnabledFeature>& GetEnabledFeatures() const {
  ...
  void SetEnabledFeatures(EnabledFeaturesT&& value) {
    m_enabledFeaturesHasBeenSet = true;
    m_enabledFeatures = std::forward<EnabledFeaturesT>(value);
  }
  template <typename EnabledFeaturesT = Aws::Vector<AnonymousUserDashboardEmbeddingConfigurationEnabledFeature>>
  AnonymousUserDashboardEmbeddingConfiguration& WithEnabledFeatures(EnabledFeaturesT&& value) {
    SetEnabledFeatures(std::forward<EnabledFeaturesT>(value));
    return *this;
  }
  inline AnonymousUserDashboardEmbeddingConfiguration& AddEnabledFeatures(
      AnonymousUserDashboardEmbeddingConfigurationEnabledFeature value) {
    m_enabledFeaturesHasBeenSet = true;
    m_enabledFeatures.push_back(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AnonymousUserDashboardEmbeddingConfigurationDisabledFeature>& GetDisabledFeatures() const {
  ...
  void SetDisabledFeatures(DisabledFeaturesT&& value) {
    m_disabledFeaturesHasBeenSet = true;
    m_disabledFeatures = std::forward<DisabledFeaturesT>(value);
  }
  template <typename DisabledFeaturesT = Aws::Vector<AnonymousUserDashboardEmbeddingConfigurationDisabledFeature>>
  AnonymousUserDashboardEmbeddingConfiguration& WithDisabledFeatures(DisabledFeaturesT&& value) {
    SetDisabledFeatures(std::forward<DisabledFeaturesT>(value));
    return *this;
  }
  inline AnonymousUserDashboardEmbeddingConfiguration& AddDisabledFeatures(
      AnonymousUserDashboardEmbeddingConfigurationDisabledFeature value) {
    m_disabledFeaturesHasBeenSet = true;
    m_disabledFeatures.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetFeatureConfigurations(FeatureConfigurationsT&& value) {
    m_featureConfigurationsHasBeenSet = true;
    m_featureConfigurations = std::forward<FeatureConfigurationsT>(value);
  }
  template <typename FeatureConfigurationsT = AnonymousUserDashboardFeatureConfigurations>
  AnonymousUserDashboardEmbeddingConfiguration& WithFeatureConfigurations(FeatureConfigurationsT&& value) {
    SetFeatureConfigurations(std::forward<FeatureConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
