...
class PeriodToDateComputation {
 public:
  ...
  inline void SetPeriodTimeGranularity(TimeGranularity value) {
    m_periodTimeGranularityHasBeenSet = true;
    m_periodTimeGranularity = value;
  }
  inline PeriodToDateComputation& WithPeriodTimeGranularity(TimeGranularity value) {
    SetPeriodTimeGranularity(value);
    return *this;
  }
  ///@}
 private:
