...
class SingleAxisOptions {
 public:
  ...
  void SetYAxisOptions(YAxisOptionsT&& value) {
    m_yAxisOptionsHasBeenSet = true;
    m_yAxisOptions = std::forward<YAxisOptionsT>(value);
  }
  template <typename YAxisOptionsT = YAxisOptions>
  SingleAxisOptions& WithYAxisOptions(YAxisOptionsT&& value) {
    SetYAxisOptions(std::forward<YAxisOptionsT>(value));
    return *this;
  }
  ///@}
 private:
