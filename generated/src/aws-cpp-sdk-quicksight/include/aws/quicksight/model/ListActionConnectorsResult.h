...
namespace Model
{
  ...
  public:
    ...
    template<typename ActionConnectorSummariesT = Aws::Vector<ActionConnectorSummary>>
    ListActionConnectorsResult& WithActionConnectorSummaries(ActionConnectorSummariesT&& value) { SetActionConnectorSummaries(std::forward<ActionConnectorSummariesT>(value)); return *this;}
    template<typename ActionConnectorSummariesT = ActionConnectorSummary>
    ListActionConnectorsResult& AddActionConnectorSummaries(ActionConnectorSummariesT&& value) { m_actionConnectorSummariesHasBeenSet = true; m_actionConnectorSummaries.emplace_back(std::forward<ActionConnectorSummariesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListActionConnectorsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListActionConnectorsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    inline ListActionConnectorsResult& WithStatus(int value) { SetStatus(value); return *this;}
    ///@}
  private:
