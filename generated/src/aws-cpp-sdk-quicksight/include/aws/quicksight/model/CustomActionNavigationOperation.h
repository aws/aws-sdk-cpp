...
class CustomActionNavigationOperation {
 public:
  ...
  void SetLocalNavigationConfiguration(LocalNavigationConfigurationT&& value) {
    m_localNavigationConfigurationHasBeenSet = true;
    m_localNavigationConfiguration = std::forward<LocalNavigationConfigurationT>(value);
  }
  template <typename LocalNavigationConfigurationT = LocalNavigationConfiguration>
  CustomActionNavigationOperation& WithLocalNavigationConfiguration(LocalNavigationConfigurationT&& value) {
    SetLocalNavigationConfiguration(std::forward<LocalNavigationConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
