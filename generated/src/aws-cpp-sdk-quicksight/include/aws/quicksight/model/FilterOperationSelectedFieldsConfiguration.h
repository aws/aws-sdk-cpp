...
class FilterOperationSelectedFieldsConfiguration {
 public:
  ...
  template <typename SelectedFieldsT = Aws::Vector<Aws::String>>
  FilterOperationSelectedFieldsConfiguration& WithSelectedFields(SelectedFieldsT&& value) {
    SetSelectedFields(std::forward<SelectedFieldsT>(value));
    return *this;
  }
  template <typename SelectedFieldsT = Aws::String>
  FilterOperationSelectedFieldsConfiguration& AddSelectedFields(SelectedFieldsT&& value) {
    m_selectedFieldsHasBeenSet = true;
    m_selectedFields.emplace_back(std::forward<SelectedFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSelectedFieldOptions(SelectedFieldOptions value) {
    m_selectedFieldOptionsHasBeenSet = true;
    m_selectedFieldOptions = value;
  }
  inline FilterOperationSelectedFieldsConfiguration& WithSelectedFieldOptions(SelectedFieldOptions value) {
    SetSelectedFieldOptions(value);
    return *this;
  }
  ///@}
  ...
  template <typename SelectedColumnsT = Aws::Vector<ColumnIdentifier>>
  FilterOperationSelectedFieldsConfiguration& WithSelectedColumns(SelectedColumnsT&& value) {
    SetSelectedColumns(std::forward<SelectedColumnsT>(value));
    return *this;
  }
  template <typename SelectedColumnsT = ColumnIdentifier>
  FilterOperationSelectedFieldsConfiguration& AddSelectedColumns(SelectedColumnsT&& value) {
    m_selectedColumnsHasBeenSet = true;
