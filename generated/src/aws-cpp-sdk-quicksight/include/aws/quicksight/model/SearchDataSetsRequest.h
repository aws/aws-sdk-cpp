...
class SearchDataSetsRequest : public QuickSightRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<DataSetSearchFilter>>
  ...
  template <typename FiltersT = DataSetSearchFilter>
  ...
  inline SearchDataSetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
