...
class TopicFilter {
 public:
  ...
  void SetFilterDescription(FilterDescriptionT&& value) {
    m_filterDescriptionHasBeenSet = true;
    m_filterDescription = std::forward<FilterDescriptionT>(value);
  }
  template <typename FilterDescriptionT = Aws::String>
  TopicFilter& WithFilterDescription(FilterDescriptionT&& value) {
    SetFilterDescription(std::forward<FilterDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFilterClass(FilterClass value) {
    m_filterClassHasBeenSet = true;
    m_filterClass = value;
  }
  inline TopicFilter& WithFilterClass(FilterClass value) {
  ...
  template <typename FilterNameT = Aws::String>
  TopicFilter& WithFilterName(FilterNameT&& value) {
  ...
  void SetFilterSynonyms(FilterSynonymsT&& value) {
    m_filterSynonymsHasBeenSet = true;
    m_filterSynonyms = std::forward<FilterSynonymsT>(value);
  }
  template <typename FilterSynonymsT = Aws::Vector<Aws::String>>
  TopicFilter& WithFilterSynonyms(FilterSynonymsT&& value) {
    SetFilterSynonyms(std::forward<FilterSynonymsT>(value));
    return *this;
  }
  template <typename FilterSynonymsT = Aws::String>
  TopicFilter& AddFilterSynonyms(FilterSynonymsT&& value) {
    m_filterSynonymsHasBeenSet = true;
    m_filterSynonyms.emplace_back(std::forward<FilterSynonymsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperandFieldName(OperandFieldNameT&& value) {
    m_operandFieldNameHasBeenSet = true;
    m_operandFieldName = std::forward<OperandFieldNameT>(value);
  }
  template <typename OperandFieldNameT = Aws::String>
  TopicFilter& WithOperandFieldName(OperandFieldNameT&& value) {
    SetOperandFieldName(std::forward<OperandFieldNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFilterType(NamedFilterType value) {
    m_filterTypeHasBeenSet = true;
    m_filterType = value;
  }
  inline TopicFilter& WithFilterType(NamedFilterType value) {
    SetFilterType(value);
    return *this;
  }
  ///@}
  ...
  void SetCategoryFilter(CategoryFilterT&& value) {
    m_categoryFilterHasBeenSet = true;
    m_categoryFilter = std::forward<CategoryFilterT>(value);
  }
  template <typename CategoryFilterT = TopicCategoryFilter>
  TopicFilter& WithCategoryFilter(CategoryFilterT&& value) {
    SetCategoryFilter(std::forward<CategoryFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNumericEqualityFilter(NumericEqualityFilterT&& value) {
    m_numericEqualityFilterHasBeenSet = true;
    m_numericEqualityFilter = std::forward<NumericEqualityFilterT>(value);
  }
  template <typename NumericEqualityFilterT = TopicNumericEqualityFilter>
  TopicFilter& WithNumericEqualityFilter(NumericEqualityFilterT&& value) {
    SetNumericEqualityFilter(std::forward<NumericEqualityFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNumericRangeFilter(NumericRangeFilterT&& value) {
    m_numericRangeFilterHasBeenSet = true;
    m_numericRangeFilter = std::forward<NumericRangeFilterT>(value);
  }
  template <typename NumericRangeFilterT = TopicNumericRangeFilter>
  TopicFilter& WithNumericRangeFilter(NumericRangeFilterT&& value) {
    SetNumericRangeFilter(std::forward<NumericRangeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateRangeFilter(DateRangeFilterT&& value) {
    m_dateRangeFilterHasBeenSet = true;
    m_dateRangeFilter = std::forward<DateRangeFilterT>(value);
  }
  template <typename DateRangeFilterT = TopicDateRangeFilter>
  TopicFilter& WithDateRangeFilter(DateRangeFilterT&& value) {
    SetDateRangeFilter(std::forward<DateRangeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelativeDateFilter(RelativeDateFilterT&& value) {
    m_relativeDateFilterHasBeenSet = true;
    m_relativeDateFilter = std::forward<RelativeDateFilterT>(value);
  }
  template <typename RelativeDateFilterT = TopicRelativeDateFilter>
  TopicFilter& WithRelativeDateFilter(RelativeDateFilterT&& value) {
    SetRelativeDateFilter(std::forward<RelativeDateFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNullFilter(NullFilterT&& value) {
    m_nullFilterHasBeenSet = true;
    m_nullFilter = std::forward<NullFilterT>(value);
  }
  template <typename NullFilterT = TopicNullFilter>
  TopicFilter& WithNullFilter(NullFilterT&& value) {
    SetNullFilter(std::forward<NullFilterT>(value));
    return *this;
  }
  ///@}
 private:
