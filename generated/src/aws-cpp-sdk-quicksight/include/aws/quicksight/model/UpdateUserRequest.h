...
class UpdateUserRequest : public QuickSightRequest {
 public:
   ...
   * Quick Sight settings.</p> </li> <li> <p> <code>READER_PRO</code>: Reader Pro
   * adds Generative BI capabilities to the Reader role. Reader Pros have access to
   * Amazon Q in Quick Sight, can build stories with Amazon Q, and can generate
   ...
   * Pros who can also manage Amazon Quick Sight administrative settings. Admin Pro
   * users are billed at Author Pro pricing.</p> </li> </ul> <p>The name of the Quick
   * Sight role is invisible to the user except for the console screens dealing with
   * permissions.</p>
   */
  ...
  inline UpdateUserRequest& WithRole(UserRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
   ...
   * the profile names for custom permission sets by using the Quick Sight console.
   * Then, you use the <code>RegisterUser</code> API operation to assign the named
   * set of permissions to a Quick Sight user. </p> <p>Quick Sight custom permissions
   * are applied through IAM policies. Therefore, they override the permissions
   * typically granted by assigning Quick Sight users to one of the default security
   * cohorts in Quick Sight (admin, author, reader).</p> <p>This feature is available
   * only to Quick Sight Enterprise edition subscriptions.</p>
   */
  ...
  inline void SetUnapplyCustomPermissions(bool value) {
    m_unapplyCustomPermissionsHasBeenSet = true;
    m_unapplyCustomPermissions = value;
  }
  inline UpdateUserRequest& WithUnapplyCustomPermissions(bool value) {
  ...
  void SetExternalLoginFederationProviderType(ExternalLoginFederationProviderTypeT&& value) {
    ...
    m_externalLoginFederationProviderType = std::forward<ExternalLoginFederationProviderTypeT>(value);
  }
  template <typename ExternalLoginFederationProviderTypeT = Aws::String>
  UpdateUserRequest& WithExternalLoginFederationProviderType(ExternalLoginFederationProviderTypeT&& value) {
    SetExternalLoginFederationProviderType(std::forward<ExternalLoginFederationProviderTypeT>(value));
    return *this;
  }
  ///@}
   ...
   * to let a user federate into Quick Sight with an associated Identity and Access
  ...
  void SetCustomFederationProviderUrl(CustomFederationProviderUrlT&& value) {
    m_customFederationProviderUrlHasBeenSet = true;
    m_customFederationProviderUrl = std::forward<CustomFederationProviderUrlT>(value);
  }
  template <typename CustomFederationProviderUrlT = Aws::String>
  UpdateUserRequest& WithCustomFederationProviderUrl(CustomFederationProviderUrlT&& value) {
    SetCustomFederationProviderUrl(std::forward<CustomFederationProviderUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExternalLoginId(ExternalLoginIdT&& value) {
    ...
    m_externalLoginId = std::forward<ExternalLoginIdT>(value);
  }
  template <typename ExternalLoginIdT = Aws::String>
  UpdateUserRequest& WithExternalLoginId(ExternalLoginIdT&& value) {
    SetExternalLoginId(std::forward<ExternalLoginIdT>(value));
    return *this;
  }
  ///@}
 private:
