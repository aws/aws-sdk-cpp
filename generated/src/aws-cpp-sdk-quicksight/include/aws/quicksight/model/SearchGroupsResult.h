...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupListT = Aws::Vector<Group>>
    SearchGroupsResult& WithGroupList(GroupListT&& value) { SetGroupList(std::forward<GroupListT>(value)); return *this;}
    template<typename GroupListT = Group>
    SearchGroupsResult& AddGroupList(GroupListT&& value) { m_groupListHasBeenSet = true; m_groupList.emplace_back(std::forward<GroupListT>(value)); return *this; }
    ///@}
