...
class QueryExecutionOptions {
 public:
  ...
  inline void SetQueryExecutionMode(QueryExecutionMode value) {
    m_queryExecutionModeHasBeenSet = true;
    m_queryExecutionMode = value;
  }
  inline QueryExecutionOptions& WithQueryExecutionMode(QueryExecutionMode value) {
    SetQueryExecutionMode(value);
    return *this;
  }
  ///@}
 private:
