...
class LineSeriesAxisDisplayOptions {
 public:
  ...
  void SetAxisOptions(AxisOptionsT&& value) {
    m_axisOptionsHasBeenSet = true;
    m_axisOptions = std::forward<AxisOptionsT>(value);
  }
  template <typename AxisOptionsT = AxisDisplayOptions>
  LineSeriesAxisDisplayOptions& WithAxisOptions(AxisOptionsT&& value) {
    SetAxisOptions(std::forward<AxisOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMissingDataConfigurations(MissingDataConfigurationsT&& value) {
    m_missingDataConfigurationsHasBeenSet = true;
    m_missingDataConfigurations = std::forward<MissingDataConfigurationsT>(value);
  }
  template <typename MissingDataConfigurationsT = Aws::Vector<MissingDataConfiguration>>
  LineSeriesAxisDisplayOptions& WithMissingDataConfigurations(MissingDataConfigurationsT&& value) {
    SetMissingDataConfigurations(std::forward<MissingDataConfigurationsT>(value));
    return *this;
  }
  template <typename MissingDataConfigurationsT = MissingDataConfiguration>
  LineSeriesAxisDisplayOptions& AddMissingDataConfigurations(MissingDataConfigurationsT&& value) {
    m_missingDataConfigurationsHasBeenSet = true;
    m_missingDataConfigurations.emplace_back(std::forward<MissingDataConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
