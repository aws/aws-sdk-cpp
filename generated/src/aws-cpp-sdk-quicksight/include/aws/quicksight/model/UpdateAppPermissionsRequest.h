...
/**
 */
class UpdateAppPermissionsRequest : public QuickSightRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "UpdateAppPermissions"; }
  ...
  ///@{
  /**
   * <p>The visibility to set for the app. Currently, only <code>PRIVATE</code> is
   * accepted, which removes public (anonymous) access from the app. If you don't
   * specify a value, the app's visibility is unchanged. Setting an app to
   * <code>PUBLIC</code> through this operation is not supported.</p>
   */
  ...
  inline UpdateAppPermissionsRequest& WithVisibility(AppVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
