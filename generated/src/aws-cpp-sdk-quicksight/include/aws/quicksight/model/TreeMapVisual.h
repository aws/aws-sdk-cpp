...
namespace Model
{
   ...
   * tree maps</a> in the <i>Amazon Quick Suite User Guide</i>.</p><p><h3>See
   * Also:</h3>   <a
  ...
  {
  public:
    AWS_QUICKSIGHT_API TreeMapVisual() = default;
    ...
    template<typename VisualIdT = Aws::String>
    TreeMapVisual& WithVisualId(VisualIdT&& value) { SetVisualId(std::forward<VisualIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = VisualTitleLabelOptions>
    TreeMapVisual& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SubtitleT = VisualSubtitleLabelOptions>
    TreeMapVisual& WithSubtitle(SubtitleT&& value) { SetSubtitle(std::forward<SubtitleT>(value)); return *this;}
    ///@}
    ...
    template<typename ChartConfigurationT = TreeMapConfiguration>
    ...
    template<typename ChartConfigurationT = TreeMapConfiguration>
    TreeMapVisual& WithChartConfiguration(ChartConfigurationT&& value) { SetChartConfiguration(std::forward<ChartConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Vector<VisualCustomAction>>
    TreeMapVisual& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    template<typename ActionsT = VisualCustomAction>
    TreeMapVisual& AddActions(ActionsT&& value) { m_actionsHasBeenSet = true; m_actions.emplace_back(std::forward<ActionsT>(value)); return *this; }
    ///@}
    ...
    template<typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
    TreeMapVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) { SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value)); return *this;}
    template<typename ColumnHierarchiesT = ColumnHierarchy>
    TreeMapVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.emplace_back(std::forward<ColumnHierarchiesT>(value)); return *this; }
    ///@}
    ...
    template<typename VisualContentAltTextT = Aws::String>
    TreeMapVisual& WithVisualContentAltText(VisualContentAltTextT&& value) { SetVisualContentAltText(std::forward<VisualContentAltTextT>(value)); return *this;}
    ///@}
  private:
