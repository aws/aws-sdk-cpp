...
class DateTimePickerControlDisplayOptions {
 public:
  ...
  template <typename TitleOptionsT = LabelOptions>
  DateTimePickerControlDisplayOptions& WithTitleOptions(TitleOptionsT&& value) {
  ...
  template <typename DateTimeFormatT = Aws::String>
  DateTimePickerControlDisplayOptions& WithDateTimeFormat(DateTimeFormatT&& value) {
  ...
  template <typename InfoIconLabelOptionsT = SheetControlInfoIconLabelOptions>
  DateTimePickerControlDisplayOptions& WithInfoIconLabelOptions(InfoIconLabelOptionsT&& value) {
  ...
  inline void SetHelperTextVisibility(Visibility value) {
    m_helperTextVisibilityHasBeenSet = true;
    m_helperTextVisibility = value;
  }
  inline DateTimePickerControlDisplayOptions& WithHelperTextVisibility(Visibility value) {
    SetHelperTextVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDateIconVisibility(Visibility value) {
    m_dateIconVisibilityHasBeenSet = true;
    m_dateIconVisibility = value;
  }
  inline DateTimePickerControlDisplayOptions& WithDateIconVisibility(Visibility value) {
    SetDateIconVisibility(value);
    return *this;
  }
  ///@}
 private:
