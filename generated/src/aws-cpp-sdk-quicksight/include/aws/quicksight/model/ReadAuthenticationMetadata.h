...
namespace Model
{
  ...
  public:
    ...
    template<typename AuthorizationCodeGrantMetadataT = ReadAuthorizationCodeGrantMetadata>
    ReadAuthenticationMetadata& WithAuthorizationCodeGrantMetadata(AuthorizationCodeGrantMetadataT&& value) { SetAuthorizationCodeGrantMetadata(std::forward<AuthorizationCodeGrantMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientCredentialsGrantMetadataT = ReadClientCredentialsGrantMetadata>
    ReadAuthenticationMetadata& WithClientCredentialsGrantMetadata(ClientCredentialsGrantMetadataT&& value) { SetClientCredentialsGrantMetadata(std::forward<ClientCredentialsGrantMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename BasicAuthConnectionMetadataT = ReadBasicAuthConnectionMetadata>
    ReadAuthenticationMetadata& WithBasicAuthConnectionMetadata(BasicAuthConnectionMetadataT&& value) { SetBasicAuthConnectionMetadata(std::forward<BasicAuthConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename ApiKeyConnectionMetadataT = ReadAPIKeyConnectionMetadata>
    ReadAuthenticationMetadata& WithApiKeyConnectionMetadata(ApiKeyConnectionMetadataT&& value) { SetApiKeyConnectionMetadata(std::forward<ApiKeyConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename NoneConnectionMetadataT = ReadNoneConnectionMetadata>
    ReadAuthenticationMetadata& WithNoneConnectionMetadata(NoneConnectionMetadataT&& value) { SetNoneConnectionMetadata(std::forward<NoneConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    template<typename IamConnectionMetadataT = ReadIamConnectionMetadata>
    ReadAuthenticationMetadata& WithIamConnectionMetadata(IamConnectionMetadataT&& value) { SetIamConnectionMetadata(std::forward<IamConnectionMetadataT>(value)); return *this;}
    ///@}
  private:
