...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    ClientCredentialsGrantDetails& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientSecretT = Aws::String>
    ClientCredentialsGrantDetails& WithClientSecret(ClientSecretT&& value) { SetClientSecret(std::forward<ClientSecretT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenEndpointT = Aws::String>
    ClientCredentialsGrantDetails& WithTokenEndpoint(TokenEndpointT&& value) { SetTokenEndpoint(std::forward<TokenEndpointT>(value)); return *this;}
    ///@}
  private:
