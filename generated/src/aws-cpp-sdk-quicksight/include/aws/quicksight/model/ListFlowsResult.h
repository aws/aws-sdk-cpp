...
namespace Model
{
  ...
  public:
    ...
    template<typename FlowSummaryListT = Aws::Vector<FlowSummary>>
    ListFlowsResult& WithFlowSummaryList(FlowSummaryListT&& value) { SetFlowSummaryList(std::forward<FlowSummaryListT>(value)); return *this;}
    template<typename FlowSummaryListT = FlowSummary>
    ListFlowsResult& AddFlowSummaryList(FlowSummaryListT&& value) { m_flowSummaryListHasBeenSet = true; m_flowSummaryList.emplace_back(std::forward<FlowSummaryListT>(value)); return *this; }
    ///@}
    ...
    inline ListFlowsResult& WithStatus(int value) { SetStatus(value); return *this;}
    ///@}
  private:
