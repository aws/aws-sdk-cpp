...
class DescribeIAMPolicyAssignmentRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeIAMPolicyAssignmentRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename AssignmentNameT = Aws::String>
  DescribeIAMPolicyAssignmentRequest& WithAssignmentName(AssignmentNameT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DescribeIAMPolicyAssignmentRequest& WithNamespace(NamespaceT&& value) {
