...
class UIColorPalette {
 public:
  ...
  void SetPrimaryForeground(PrimaryForegroundT&& value) {
    m_primaryForegroundHasBeenSet = true;
    m_primaryForeground = std::forward<PrimaryForegroundT>(value);
  }
  template <typename PrimaryForegroundT = Aws::String>
  UIColorPalette& WithPrimaryForeground(PrimaryForegroundT&& value) {
    SetPrimaryForeground(std::forward<PrimaryForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrimaryBackground(PrimaryBackgroundT&& value) {
    m_primaryBackgroundHasBeenSet = true;
    m_primaryBackground = std::forward<PrimaryBackgroundT>(value);
  }
  template <typename PrimaryBackgroundT = Aws::String>
  UIColorPalette& WithPrimaryBackground(PrimaryBackgroundT&& value) {
    SetPrimaryBackground(std::forward<PrimaryBackgroundT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryForeground(SecondaryForegroundT&& value) {
    m_secondaryForegroundHasBeenSet = true;
    m_secondaryForeground = std::forward<SecondaryForegroundT>(value);
  }
  template <typename SecondaryForegroundT = Aws::String>
  UIColorPalette& WithSecondaryForeground(SecondaryForegroundT&& value) {
    SetSecondaryForeground(std::forward<SecondaryForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryBackground(SecondaryBackgroundT&& value) {
    m_secondaryBackgroundHasBeenSet = true;
    m_secondaryBackground = std::forward<SecondaryBackgroundT>(value);
  }
  template <typename SecondaryBackgroundT = Aws::String>
  UIColorPalette& WithSecondaryBackground(SecondaryBackgroundT&& value) {
    SetSecondaryBackground(std::forward<SecondaryBackgroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AccentT = Aws::String>
  UIColorPalette& WithAccent(AccentT&& value) {
  ...
  void SetAccentForeground(AccentForegroundT&& value) {
    m_accentForegroundHasBeenSet = true;
    m_accentForeground = std::forward<AccentForegroundT>(value);
  }
  template <typename AccentForegroundT = Aws::String>
  UIColorPalette& WithAccentForeground(AccentForegroundT&& value) {
    SetAccentForeground(std::forward<AccentForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DangerT = Aws::String>
  UIColorPalette& WithDanger(DangerT&& value) {
  ...
  void SetDangerForeground(DangerForegroundT&& value) {
    m_dangerForegroundHasBeenSet = true;
    m_dangerForeground = std::forward<DangerForegroundT>(value);
  }
  template <typename DangerForegroundT = Aws::String>
  UIColorPalette& WithDangerForeground(DangerForegroundT&& value) {
    SetDangerForeground(std::forward<DangerForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WarningT = Aws::String>
  UIColorPalette& WithWarning(WarningT&& value) {
  ...
  void SetWarningForeground(WarningForegroundT&& value) {
    m_warningForegroundHasBeenSet = true;
    m_warningForeground = std::forward<WarningForegroundT>(value);
  }
  template <typename WarningForegroundT = Aws::String>
  UIColorPalette& WithWarningForeground(WarningForegroundT&& value) {
    SetWarningForeground(std::forward<WarningForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SuccessT = Aws::String>
  UIColorPalette& WithSuccess(SuccessT&& value) {
  ...
  void SetSuccessForeground(SuccessForegroundT&& value) {
    m_successForegroundHasBeenSet = true;
    m_successForeground = std::forward<SuccessForegroundT>(value);
  }
  template <typename SuccessForegroundT = Aws::String>
  UIColorPalette& WithSuccessForeground(SuccessForegroundT&& value) {
    SetSuccessForeground(std::forward<SuccessForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DimensionT = Aws::String>
  UIColorPalette& WithDimension(DimensionT&& value) {
  ...
  void SetDimensionForeground(DimensionForegroundT&& value) {
    m_dimensionForegroundHasBeenSet = true;
    m_dimensionForeground = std::forward<DimensionForegroundT>(value);
  }
  template <typename DimensionForegroundT = Aws::String>
  UIColorPalette& WithDimensionForeground(DimensionForegroundT&& value) {
    SetDimensionForeground(std::forward<DimensionForegroundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MeasureT = Aws::String>
  UIColorPalette& WithMeasure(MeasureT&& value) {
  ...
  void SetMeasureForeground(MeasureForegroundT&& value) {
    m_measureForegroundHasBeenSet = true;
    m_measureForeground = std::forward<MeasureForegroundT>(value);
  }
  template <typename MeasureForegroundT = Aws::String>
  UIColorPalette& WithMeasureForeground(MeasureForegroundT&& value) {
    SetMeasureForeground(std::forward<MeasureForegroundT>(value));
    return *this;
  }
  ///@}
 private:
