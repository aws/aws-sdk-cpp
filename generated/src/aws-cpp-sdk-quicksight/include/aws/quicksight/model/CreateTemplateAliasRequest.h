...
class CreateTemplateAliasRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API CreateTemplateAliasRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  CreateTemplateAliasRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  CreateTemplateAliasRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename AliasNameT = Aws::String>
  CreateTemplateAliasRequest& WithAliasName(AliasNameT&& value) {
  ...
  inline void SetTemplateVersionNumber(long long value) {
    m_templateVersionNumberHasBeenSet = true;
    m_templateVersionNumber = value;
  }
  inline CreateTemplateAliasRequest& WithTemplateVersionNumber(long long value) {
    SetTemplateVersionNumber(value);
    return *this;
  }
  ///@}
 private:
