...
class DescribeDashboardRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DescribeDashboardRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeDashboardRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename DashboardIdT = Aws::String>
  DescribeDashboardRequest& WithDashboardId(DashboardIdT&& value) {
  ...
  inline DescribeDashboardRequest& WithVersionNumber(long long value) {
  ...
  template <typename AliasNameT = Aws::String>
  DescribeDashboardRequest& WithAliasName(AliasNameT&& value) {
