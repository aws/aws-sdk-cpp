...
class LayerCustomActionOperation {
 public:
  ...
  void SetNavigationOperation(NavigationOperationT&& value) {
    ...
    m_navigationOperation = std::forward<NavigationOperationT>(value);
  }
  template <typename NavigationOperationT = CustomActionNavigationOperation>
  LayerCustomActionOperation& WithNavigationOperation(NavigationOperationT&& value) {
    SetNavigationOperation(std::forward<NavigationOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetURLOperation(URLOperationT&& value) {
    ...
    m_uRLOperation = std::forward<URLOperationT>(value);
  }
  template <typename URLOperationT = CustomActionURLOperation>
  LayerCustomActionOperation& WithURLOperation(URLOperationT&& value) {
    SetURLOperation(std::forward<URLOperationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSetParametersOperation(SetParametersOperationT&& value) {
    ...
    m_setParametersOperation = std::forward<SetParametersOperationT>(value);
  }
  template <typename SetParametersOperationT = CustomActionSetParametersOperation>
  LayerCustomActionOperation& WithSetParametersOperation(SetParametersOperationT&& value) {
    SetSetParametersOperation(std::forward<SetParametersOperationT>(value));
    return *this;
  }
  ///@}
 private:
