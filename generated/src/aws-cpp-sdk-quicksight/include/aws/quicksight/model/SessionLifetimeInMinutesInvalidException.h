...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API SessionLifetimeInMinutesInvalidException() = default;
    ...
    template<typename MessageT = Aws::String>
    SessionLifetimeInMinutesInvalidException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SessionLifetimeInMinutesInvalidException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
