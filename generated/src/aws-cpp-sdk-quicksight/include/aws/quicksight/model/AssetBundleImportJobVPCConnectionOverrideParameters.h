...
class AssetBundleImportJobVPCConnectionOverrideParameters {
 public:
  ...
  template <typename VPCConnectionIdT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithVPCConnectionId(VPCConnectionIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithName(NameT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  template <typename DnsResolversT = Aws::Vector<Aws::String>>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithDnsResolvers(DnsResolversT&& value) {
    SetDnsResolvers(std::forward<DnsResolversT>(value));
    return *this;
  }
  template <typename DnsResolversT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& AddDnsResolvers(DnsResolversT&& value) {
    m_dnsResolversHasBeenSet = true;
  ...
  template <typename RoleArnT = Aws::String>
  AssetBundleImportJobVPCConnectionOverrideParameters& WithRoleArn(RoleArnT&& value) {
