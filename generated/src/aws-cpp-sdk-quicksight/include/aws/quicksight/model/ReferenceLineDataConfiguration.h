...
class ReferenceLineDataConfiguration {
 public:
  ...
  void SetStaticConfiguration(StaticConfigurationT&& value) {
    ...
    m_staticConfiguration = std::forward<StaticConfigurationT>(value);
  }
  template <typename StaticConfigurationT = ReferenceLineStaticDataConfiguration>
  ReferenceLineDataConfiguration& WithStaticConfiguration(StaticConfigurationT&& value) {
    SetStaticConfiguration(std::forward<StaticConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamicConfiguration(DynamicConfigurationT&& value) {
    ...
    m_dynamicConfiguration = std::forward<DynamicConfigurationT>(value);
  }
  template <typename DynamicConfigurationT = ReferenceLineDynamicDataConfiguration>
  ReferenceLineDataConfiguration& WithDynamicConfiguration(DynamicConfigurationT&& value) {
    SetDynamicConfiguration(std::forward<DynamicConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAxisBinding(AxisBinding value) {
    m_axisBindingHasBeenSet = true;
    m_axisBinding = value;
  }
  inline ReferenceLineDataConfiguration& WithAxisBinding(AxisBinding value) {
    SetAxisBinding(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeriesType(ReferenceLineSeriesType value) {
    m_seriesTypeHasBeenSet = true;
    m_seriesType = value;
  }
  inline ReferenceLineDataConfiguration& WithSeriesType(ReferenceLineSeriesType value) {
    SetSeriesType(value);
    return *this;
  }
  ///@}
