...
class TemplateError {
 public:
  ...
  inline void SetType(TemplateErrorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TemplateError& WithType(TemplateErrorType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  TemplateError& WithMessage(MessageT&& value) {
  ...
  template <typename ViolatedEntitiesT = Aws::Vector<Entity>>
  TemplateError& WithViolatedEntities(ViolatedEntitiesT&& value) {
    SetViolatedEntities(std::forward<ViolatedEntitiesT>(value));
    return *this;
  }
  template <typename ViolatedEntitiesT = Entity>
  TemplateError& AddViolatedEntities(ViolatedEntitiesT&& value) {
    m_violatedEntitiesHasBeenSet = true;
