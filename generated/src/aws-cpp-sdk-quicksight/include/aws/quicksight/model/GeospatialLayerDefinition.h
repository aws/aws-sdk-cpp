...
class GeospatialLayerDefinition {
 public:
  ...
  void SetPointLayer(PointLayerT&& value) {
    ...
    m_pointLayer = std::forward<PointLayerT>(value);
  }
  template <typename PointLayerT = GeospatialPointLayer>
  GeospatialLayerDefinition& WithPointLayer(PointLayerT&& value) {
    SetPointLayer(std::forward<PointLayerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineLayer(LineLayerT&& value) {
    ...
    m_lineLayer = std::forward<LineLayerT>(value);
  }
  template <typename LineLayerT = GeospatialLineLayer>
  GeospatialLayerDefinition& WithLineLayer(LineLayerT&& value) {
    SetLineLayer(std::forward<LineLayerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPolygonLayer(PolygonLayerT&& value) {
    ...
    m_polygonLayer = std::forward<PolygonLayerT>(value);
  }
  template <typename PolygonLayerT = GeospatialPolygonLayer>
  GeospatialLayerDefinition& WithPolygonLayer(PolygonLayerT&& value) {
    SetPolygonLayer(std::forward<PolygonLayerT>(value));
    return *this;
  }
  ///@}
 private:
