...
class TopicConfigOptions {
 public:
  ...
  inline void SetQBusinessInsightsEnabled(bool value) {
    m_qBusinessInsightsEnabledHasBeenSet = true;
    m_qBusinessInsightsEnabled = value;
  }
  inline TopicConfigOptions& WithQBusinessInsightsEnabled(bool value) {
    SetQBusinessInsightsEnabled(value);
    return *this;
  }
  ///@}
 private:
