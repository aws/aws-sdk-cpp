...
class FilledMapVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  FilledMapVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  FilledMapVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  FilledMapVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = FilledMapConfiguration>
  FilledMapVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ConditionalFormattingT = FilledMapConditionalFormatting>
  FilledMapVisual& WithConditionalFormatting(ConditionalFormattingT&& value) {
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  FilledMapVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  FilledMapVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  FilledMapVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  FilledMapVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  FilledMapVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
