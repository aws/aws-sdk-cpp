...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListTopicRefreshSchedulesRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    ListTopicRefreshSchedulesRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicIdT = Aws::String>
    ListTopicRefreshSchedulesRequest& WithTopicId(TopicIdT&& value) { SetTopicId(std::forward<TopicIdT>(value)); return *this;}
    ///@}
  private:
