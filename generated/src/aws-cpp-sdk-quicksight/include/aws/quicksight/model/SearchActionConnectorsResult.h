...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    SearchActionConnectorsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SearchActionConnectorsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    inline SearchActionConnectorsResult& WithStatus(int value) { SetStatus(value); return *this;}
    ///@}
    ...
    void SetActionConnectorSummaries(ActionConnectorSummariesT&& value) { m_actionConnectorSummariesHasBeenSet = true; m_actionConnectorSummaries = std::forward<ActionConnectorSummariesT>(value); }
    template<typename ActionConnectorSummariesT = Aws::Vector<ActionConnectorSummary>>
    SearchActionConnectorsResult& WithActionConnectorSummaries(ActionConnectorSummariesT&& value) { SetActionConnectorSummaries(std::forward<ActionConnectorSummariesT>(value)); return *this;}
    template<typename ActionConnectorSummariesT = ActionConnectorSummary>
    SearchActionConnectorsResult& AddActionConnectorSummaries(ActionConnectorSummariesT&& value) { m_actionConnectorSummariesHasBeenSet = true; m_actionConnectorSummaries.emplace_back(std::forward<ActionConnectorSummariesT>(value)); return *this; }
    ///@}
  private:
