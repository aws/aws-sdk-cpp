...
class ListThemesResult {
 public:
  ...
  void SetThemeSummaryList(ThemeSummaryListT&& value) {
    m_themeSummaryListHasBeenSet = true;
    m_themeSummaryList = std::forward<ThemeSummaryListT>(value);
  }
  template <typename ThemeSummaryListT = Aws::Vector<ThemeSummary>>
  ListThemesResult& WithThemeSummaryList(ThemeSummaryListT&& value) {
    SetThemeSummaryList(std::forward<ThemeSummaryListT>(value));
    return *this;
  }
  template <typename ThemeSummaryListT = ThemeSummary>
  ListThemesResult& AddThemeSummaryList(ThemeSummaryListT&& value) {
    m_themeSummaryListHasBeenSet = true;
    m_themeSummaryList.emplace_back(std::forward<ThemeSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListThemesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
