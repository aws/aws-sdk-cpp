...
class SectionBasedLayoutPaperCanvasSizeOptions {
 public:
  ...
  inline void SetPaperSize(PaperSize value) {
    m_paperSizeHasBeenSet = true;
    m_paperSize = value;
  }
  inline SectionBasedLayoutPaperCanvasSizeOptions& WithPaperSize(PaperSize value) {
    SetPaperSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPaperOrientation(PaperOrientation value) {
    m_paperOrientationHasBeenSet = true;
    m_paperOrientation = value;
  }
  inline SectionBasedLayoutPaperCanvasSizeOptions& WithPaperOrientation(PaperOrientation value) {
  ...
  void SetPaperMargin(PaperMarginT&& value) {
    m_paperMarginHasBeenSet = true;
    m_paperMargin = std::forward<PaperMarginT>(value);
  }
  template <typename PaperMarginT = Spacing>
  SectionBasedLayoutPaperCanvasSizeOptions& WithPaperMargin(PaperMarginT&& value) {
    SetPaperMargin(std::forward<PaperMarginT>(value));
    return *this;
  }
  ///@}
 private:
