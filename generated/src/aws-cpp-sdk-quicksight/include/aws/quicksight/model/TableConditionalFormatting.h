...
class TableConditionalFormatting {
 public:
   ...
   */
  inline const Aws::Vector<TableConditionalFormattingOption>& GetConditionalFormattingOptions() const {
  ...
  template <typename ConditionalFormattingOptionsT = Aws::Vector<TableConditionalFormattingOption>>
  TableConditionalFormatting& WithConditionalFormattingOptions(ConditionalFormattingOptionsT&& value) {
  ...
  TableConditionalFormatting& AddConditionalFormattingOptions(ConditionalFormattingOptionsT&& value) {
    m_conditionalFormattingOptionsHasBeenSet = true;
