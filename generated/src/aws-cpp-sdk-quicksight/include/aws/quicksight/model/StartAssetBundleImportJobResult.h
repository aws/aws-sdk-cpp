...
class StartAssetBundleImportJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StartAssetBundleImportJobResult& WithArn(ArnT&& value) {
  ...
  template <typename AssetBundleImportJobIdT = Aws::String>
  StartAssetBundleImportJobResult& WithAssetBundleImportJobId(AssetBundleImportJobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartAssetBundleImportJobResult& WithRequestId(RequestIdT&& value) {
  ...
  inline StartAssetBundleImportJobResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
