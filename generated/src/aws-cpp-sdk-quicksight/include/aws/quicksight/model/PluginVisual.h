...
class PluginVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  PluginVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename PluginArnT = Aws::String>
  PluginVisual& WithPluginArn(PluginArnT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  PluginVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  PluginVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = PluginVisualConfiguration>
  PluginVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename VisualContentAltTextT = Aws::String>
  PluginVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
