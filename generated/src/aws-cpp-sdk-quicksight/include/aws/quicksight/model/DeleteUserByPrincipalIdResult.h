...
class DeleteUserByPrincipalIdResult {
 public:
  AWS_QUICKSIGHT_API DeleteUserByPrincipalIdResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  DeleteUserByPrincipalIdResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DeleteUserByPrincipalIdResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
