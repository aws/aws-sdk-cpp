...
namespace Model
{
  ...
  public:
     ...
     */
    inline const ReadClientCredentialsGrantDetails& GetReadClientCredentialsGrantDetails() const { return m_readClientCredentialsGrantDetails; }
    ...
    void SetReadClientCredentialsGrantDetails(ReadClientCredentialsGrantDetailsT&& value) { m_readClientCredentialsGrantDetailsHasBeenSet = true; m_readClientCredentialsGrantDetails = std::forward<ReadClientCredentialsGrantDetailsT>(value); }
    template<typename ReadClientCredentialsGrantDetailsT = ReadClientCredentialsGrantDetails>
    ReadClientCredentialsDetails& WithReadClientCredentialsGrantDetails(ReadClientCredentialsGrantDetailsT&& value) { SetReadClientCredentialsGrantDetails(std::forward<ReadClientCredentialsGrantDetailsT>(value)); return *this;}
    ///@}
  private:
