...
class PluginVisualTableQuerySort {
 public:
  ...
  template <typename RowSortT = Aws::Vector<FieldSortOptions>>
  PluginVisualTableQuerySort& WithRowSort(RowSortT&& value) {
    SetRowSort(std::forward<RowSortT>(value));
    return *this;
  }
  template <typename RowSortT = FieldSortOptions>
  PluginVisualTableQuerySort& AddRowSort(RowSortT&& value) {
    m_rowSortHasBeenSet = true;
  ...
  void SetItemsLimitConfiguration(ItemsLimitConfigurationT&& value) {
    m_itemsLimitConfigurationHasBeenSet = true;
    m_itemsLimitConfiguration = std::forward<ItemsLimitConfigurationT>(value);
  }
  template <typename ItemsLimitConfigurationT = PluginVisualItemsLimitConfiguration>
  PluginVisualTableQuerySort& WithItemsLimitConfiguration(ItemsLimitConfigurationT&& value) {
    SetItemsLimitConfiguration(std::forward<ItemsLimitConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
