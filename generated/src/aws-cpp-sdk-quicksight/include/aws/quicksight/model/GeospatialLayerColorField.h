...
class GeospatialLayerColorField {
 public:
  ...
  void SetColorDimensionsFields(ColorDimensionsFieldsT&& value) {
    m_colorDimensionsFieldsHasBeenSet = true;
    m_colorDimensionsFields = std::forward<ColorDimensionsFieldsT>(value);
  }
  template <typename ColorDimensionsFieldsT = Aws::Vector<DimensionField>>
  GeospatialLayerColorField& WithColorDimensionsFields(ColorDimensionsFieldsT&& value) {
    SetColorDimensionsFields(std::forward<ColorDimensionsFieldsT>(value));
    return *this;
  }
  template <typename ColorDimensionsFieldsT = DimensionField>
  GeospatialLayerColorField& AddColorDimensionsFields(ColorDimensionsFieldsT&& value) {
    m_colorDimensionsFieldsHasBeenSet = true;
    m_colorDimensionsFields.emplace_back(std::forward<ColorDimensionsFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColorValuesFields(ColorValuesFieldsT&& value) {
    m_colorValuesFieldsHasBeenSet = true;
    m_colorValuesFields = std::forward<ColorValuesFieldsT>(value);
  }
  template <typename ColorValuesFieldsT = Aws::Vector<MeasureField>>
  GeospatialLayerColorField& WithColorValuesFields(ColorValuesFieldsT&& value) {
    SetColorValuesFields(std::forward<ColorValuesFieldsT>(value));
    return *this;
  }
  template <typename ColorValuesFieldsT = MeasureField>
  GeospatialLayerColorField& AddColorValuesFields(ColorValuesFieldsT&& value) {
    m_colorValuesFieldsHasBeenSet = true;
    m_colorValuesFields.emplace_back(std::forward<ColorValuesFieldsT>(value));
    return *this;
  }
  ///@}
 private:
