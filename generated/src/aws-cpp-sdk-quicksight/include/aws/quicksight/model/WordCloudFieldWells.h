...
class WordCloudFieldWells {
 public:
  ...
  void SetWordCloudAggregatedFieldWells(WordCloudAggregatedFieldWellsT&& value) {
    ...
    m_wordCloudAggregatedFieldWells = std::forward<WordCloudAggregatedFieldWellsT>(value);
  }
  template <typename WordCloudAggregatedFieldWellsT = WordCloudAggregatedFieldWells>
  WordCloudFieldWells& WithWordCloudAggregatedFieldWells(WordCloudAggregatedFieldWellsT&& value) {
    SetWordCloudAggregatedFieldWells(std::forward<WordCloudAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
