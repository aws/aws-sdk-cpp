...
class UpdateUserCustomPermissionResult {
 public:
  AWS_QUICKSIGHT_API UpdateUserCustomPermissionResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateUserCustomPermissionResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateUserCustomPermissionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
