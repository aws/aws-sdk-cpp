...
class GeospatialLayerItem {
 public:
  ...
  void SetLayerId(LayerIdT&& value) {
    ...
    m_layerId = std::forward<LayerIdT>(value);
  }
  template <typename LayerIdT = Aws::String>
  GeospatialLayerItem& WithLayerId(LayerIdT&& value) {
    SetLayerId(std::forward<LayerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLayerType(GeospatialLayerType value) {
    m_layerTypeHasBeenSet = true;
    m_layerType = value;
  }
  inline GeospatialLayerItem& WithLayerType(GeospatialLayerType value) {
    SetLayerType(value);
    return *this;
  }
  ///@}
  ...
  inline GeospatialLayerItem& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetLayerDefinition(LayerDefinitionT&& value) {
    ...
    m_layerDefinition = std::forward<LayerDefinitionT>(value);
  }
  template <typename LayerDefinitionT = GeospatialLayerDefinition>
  GeospatialLayerItem& WithLayerDefinition(LayerDefinitionT&& value) {
    SetLayerDefinition(std::forward<LayerDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJoinDefinition(JoinDefinitionT&& value) {
    ...
    m_joinDefinition = std::forward<JoinDefinitionT>(value);
  }
  template <typename JoinDefinitionT = GeospatialLayerJoinDefinition>
  GeospatialLayerItem& WithJoinDefinition(JoinDefinitionT&& value) {
    SetJoinDefinition(std::forward<JoinDefinitionT>(value));
    return *this;
  }
  ///@}
