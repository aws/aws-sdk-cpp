...
class ForecastComputation {
 public:
  ...
  inline void SetPeriodsForward(int value) {
    m_periodsForwardHasBeenSet = true;
    m_periodsForward = value;
  }
  inline ForecastComputation& WithPeriodsForward(int value) {
    SetPeriodsForward(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPeriodsBackward(int value) {
    m_periodsBackwardHasBeenSet = true;
    m_periodsBackward = value;
  }
  inline ForecastComputation& WithPeriodsBackward(int value) {
    SetPeriodsBackward(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpperBoundary(double value) {
    m_upperBoundaryHasBeenSet = true;
    m_upperBoundary = value;
  }
  inline ForecastComputation& WithUpperBoundary(double value) {
  ...
  inline void SetLowerBoundary(double value) {
    m_lowerBoundaryHasBeenSet = true;
    m_lowerBoundary = value;
  }
  inline ForecastComputation& WithLowerBoundary(double value) {
  ...
  inline void SetPredictionInterval(int value) {
    m_predictionIntervalHasBeenSet = true;
    m_predictionInterval = value;
  }
  inline ForecastComputation& WithPredictionInterval(int value) {
    SetPredictionInterval(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeasonality(ForecastComputationSeasonality value) {
    m_seasonalityHasBeenSet = true;
    m_seasonality = value;
  }
  inline ForecastComputation& WithSeasonality(ForecastComputationSeasonality value) {
  ...
  inline void SetCustomSeasonalityValue(int value) {
    m_customSeasonalityValueHasBeenSet = true;
    m_customSeasonalityValue = value;
  }
  inline ForecastComputation& WithCustomSeasonalityValue(int value) {
    SetCustomSeasonalityValue(value);
    return *this;
  }
  ///@}
 private:
