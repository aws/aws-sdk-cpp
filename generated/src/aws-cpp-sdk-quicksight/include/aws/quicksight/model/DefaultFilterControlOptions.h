...
class DefaultFilterControlOptions {
 public:
  ...
  void SetDefaultDateTimePickerOptions(DefaultDateTimePickerOptionsT&& value) {
    m_defaultDateTimePickerOptionsHasBeenSet = true;
    m_defaultDateTimePickerOptions = std::forward<DefaultDateTimePickerOptionsT>(value);
  }
  template <typename DefaultDateTimePickerOptionsT = DefaultDateTimePickerControlOptions>
  DefaultFilterControlOptions& WithDefaultDateTimePickerOptions(DefaultDateTimePickerOptionsT&& value) {
    SetDefaultDateTimePickerOptions(std::forward<DefaultDateTimePickerOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultListOptions(DefaultListOptionsT&& value) {
    m_defaultListOptionsHasBeenSet = true;
    m_defaultListOptions = std::forward<DefaultListOptionsT>(value);
  }
  template <typename DefaultListOptionsT = DefaultFilterListControlOptions>
  DefaultFilterControlOptions& WithDefaultListOptions(DefaultListOptionsT&& value) {
    SetDefaultListOptions(std::forward<DefaultListOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultDropdownOptions(DefaultDropdownOptionsT&& value) {
    m_defaultDropdownOptionsHasBeenSet = true;
    m_defaultDropdownOptions = std::forward<DefaultDropdownOptionsT>(value);
  }
  template <typename DefaultDropdownOptionsT = DefaultFilterDropDownControlOptions>
  DefaultFilterControlOptions& WithDefaultDropdownOptions(DefaultDropdownOptionsT&& value) {
    SetDefaultDropdownOptions(std::forward<DefaultDropdownOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTextFieldOptions(DefaultTextFieldOptionsT&& value) {
    m_defaultTextFieldOptionsHasBeenSet = true;
    m_defaultTextFieldOptions = std::forward<DefaultTextFieldOptionsT>(value);
  }
  template <typename DefaultTextFieldOptionsT = DefaultTextFieldControlOptions>
  DefaultFilterControlOptions& WithDefaultTextFieldOptions(DefaultTextFieldOptionsT&& value) {
    SetDefaultTextFieldOptions(std::forward<DefaultTextFieldOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultTextAreaOptions(DefaultTextAreaOptionsT&& value) {
    m_defaultTextAreaOptionsHasBeenSet = true;
    m_defaultTextAreaOptions = std::forward<DefaultTextAreaOptionsT>(value);
  }
  template <typename DefaultTextAreaOptionsT = DefaultTextAreaControlOptions>
  DefaultFilterControlOptions& WithDefaultTextAreaOptions(DefaultTextAreaOptionsT&& value) {
    SetDefaultTextAreaOptions(std::forward<DefaultTextAreaOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultSliderOptions(DefaultSliderOptionsT&& value) {
    m_defaultSliderOptionsHasBeenSet = true;
    m_defaultSliderOptions = std::forward<DefaultSliderOptionsT>(value);
  }
  template <typename DefaultSliderOptionsT = DefaultSliderControlOptions>
  DefaultFilterControlOptions& WithDefaultSliderOptions(DefaultSliderOptionsT&& value) {
    SetDefaultSliderOptions(std::forward<DefaultSliderOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultRelativeDateTimeOptions(DefaultRelativeDateTimeOptionsT&& value) {
    m_defaultRelativeDateTimeOptionsHasBeenSet = true;
    m_defaultRelativeDateTimeOptions = std::forward<DefaultRelativeDateTimeOptionsT>(value);
  }
  template <typename DefaultRelativeDateTimeOptionsT = DefaultRelativeDateTimeControlOptions>
  DefaultFilterControlOptions& WithDefaultRelativeDateTimeOptions(DefaultRelativeDateTimeOptionsT&& value) {
    SetDefaultRelativeDateTimeOptions(std::forward<DefaultRelativeDateTimeOptionsT>(value));
    return *this;
  }
  ///@}
 private:
