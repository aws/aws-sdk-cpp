...
class BrandDetail {
 public:
  ...
  inline BrandDetail& WithBrandStatus(BrandStatus value) {
  ...
  inline void SetVersionStatus(BrandVersionStatus value) {
    m_versionStatusHasBeenSet = true;
    m_versionStatus = value;
  }
  inline BrandDetail& WithVersionStatus(BrandVersionStatus value) {
