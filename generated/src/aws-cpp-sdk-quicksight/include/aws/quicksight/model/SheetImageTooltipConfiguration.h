...
class SheetImageTooltipConfiguration {
 public:
  ...
  void SetTooltipText(TooltipTextT&& value) {
    m_tooltipTextHasBeenSet = true;
    m_tooltipText = std::forward<TooltipTextT>(value);
  }
  template <typename TooltipTextT = SheetImageTooltipText>
  SheetImageTooltipConfiguration& WithTooltipText(TooltipTextT&& value) {
    SetTooltipText(std::forward<TooltipTextT>(value));
    return *this;
  }
  ///@}
  ...
  inline SheetImageTooltipConfiguration& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
