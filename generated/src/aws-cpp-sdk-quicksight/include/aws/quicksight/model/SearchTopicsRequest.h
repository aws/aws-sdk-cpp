...
class SearchTopicsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  SearchTopicsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<TopicSearchFilter>>
  SearchTopicsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = TopicSearchFilter>
  SearchTopicsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchTopicsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchTopicsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
