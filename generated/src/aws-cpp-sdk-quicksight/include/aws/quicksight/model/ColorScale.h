...
class ColorScale {
 public:
  ...
  inline void SetColorFillType(ColorFillType value) {
    m_colorFillTypeHasBeenSet = true;
    m_colorFillType = value;
  }
  inline ColorScale& WithColorFillType(ColorFillType value) {
    SetColorFillType(value);
    return *this;
  }
  ///@}
  ...
  void SetNullValueColor(NullValueColorT&& value) {
    m_nullValueColorHasBeenSet = true;
    m_nullValueColor = std::forward<NullValueColorT>(value);
  }
  template <typename NullValueColorT = DataColor>
  ColorScale& WithNullValueColor(NullValueColorT&& value) {
    SetNullValueColor(std::forward<NullValueColorT>(value));
    return *this;
  }
  ///@}
 private:
