...
class ParameterControl {
 public:
  ...
  void SetDateTimePicker(DateTimePickerT&& value) {
    ...
    m_dateTimePicker = std::forward<DateTimePickerT>(value);
  }
  template <typename DateTimePickerT = ParameterDateTimePickerControl>
  ParameterControl& WithDateTimePicker(DateTimePickerT&& value) {
    SetDateTimePicker(std::forward<DateTimePickerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDropdown(DropdownT&& value) {
    ...
    m_dropdown = std::forward<DropdownT>(value);
  }
  template <typename DropdownT = ParameterDropDownControl>
  ParameterControl& WithDropdown(DropdownT&& value) {
    SetDropdown(std::forward<DropdownT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextArea(TextAreaT&& value) {
    ...
    m_textArea = std::forward<TextAreaT>(value);
  }
  template <typename TextAreaT = ParameterTextAreaControl>
  ParameterControl& WithTextArea(TextAreaT&& value) {
    SetTextArea(std::forward<TextAreaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlider(SliderT&& value) {
    ...
    m_slider = std::forward<SliderT>(value);
  }
  template <typename SliderT = ParameterSliderControl>
  ParameterControl& WithSlider(SliderT&& value) {
    SetSlider(std::forward<SliderT>(value));
    return *this;
  }
  ///@}
 private:
