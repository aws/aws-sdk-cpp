...
class SemanticType {
 public:
  ...
  template <typename TypeNameT = Aws::String>
  SemanticType& WithTypeName(TypeNameT&& value) {
  ...
  void SetSubTypeName(SubTypeNameT&& value) {
    m_subTypeNameHasBeenSet = true;
    m_subTypeName = std::forward<SubTypeNameT>(value);
  }
  template <typename SubTypeNameT = Aws::String>
  SemanticType& WithSubTypeName(SubTypeNameT&& value) {
    SetSubTypeName(std::forward<SubTypeNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTypeParameters(TypeParametersT&& value) {
    m_typeParametersHasBeenSet = true;
    m_typeParameters = std::forward<TypeParametersT>(value);
  }
  template <typename TypeParametersT = Aws::Map<Aws::String, Aws::String>>
  SemanticType& WithTypeParameters(TypeParametersT&& value) {
    SetTypeParameters(std::forward<TypeParametersT>(value));
    return *this;
  }
  ...
  SemanticType& AddTypeParameters(TypeParametersKeyT&& key, TypeParametersValueT&& value) {
    m_typeParametersHasBeenSet = true;
    m_typeParameters.emplace(std::forward<TypeParametersKeyT>(key), std::forward<TypeParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTruthyCellValue(TruthyCellValueT&& value) {
    m_truthyCellValueHasBeenSet = true;
    m_truthyCellValue = std::forward<TruthyCellValueT>(value);
  }
  template <typename TruthyCellValueT = Aws::String>
  SemanticType& WithTruthyCellValue(TruthyCellValueT&& value) {
    SetTruthyCellValue(std::forward<TruthyCellValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTruthyCellValueSynonyms(TruthyCellValueSynonymsT&& value) {
    m_truthyCellValueSynonymsHasBeenSet = true;
    m_truthyCellValueSynonyms = std::forward<TruthyCellValueSynonymsT>(value);
  }
  template <typename TruthyCellValueSynonymsT = Aws::Vector<Aws::String>>
  SemanticType& WithTruthyCellValueSynonyms(TruthyCellValueSynonymsT&& value) {
    SetTruthyCellValueSynonyms(std::forward<TruthyCellValueSynonymsT>(value));
    return *this;
  }
  template <typename TruthyCellValueSynonymsT = Aws::String>
  SemanticType& AddTruthyCellValueSynonyms(TruthyCellValueSynonymsT&& value) {
    m_truthyCellValueSynonymsHasBeenSet = true;
    m_truthyCellValueSynonyms.emplace_back(std::forward<TruthyCellValueSynonymsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFalseyCellValue(FalseyCellValueT&& value) {
    m_falseyCellValueHasBeenSet = true;
    m_falseyCellValue = std::forward<FalseyCellValueT>(value);
  }
  template <typename FalseyCellValueT = Aws::String>
  SemanticType& WithFalseyCellValue(FalseyCellValueT&& value) {
    SetFalseyCellValue(std::forward<FalseyCellValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFalseyCellValueSynonyms(FalseyCellValueSynonymsT&& value) {
    m_falseyCellValueSynonymsHasBeenSet = true;
    m_falseyCellValueSynonyms = std::forward<FalseyCellValueSynonymsT>(value);
  }
  template <typename FalseyCellValueSynonymsT = Aws::Vector<Aws::String>>
  SemanticType& WithFalseyCellValueSynonyms(FalseyCellValueSynonymsT&& value) {
    SetFalseyCellValueSynonyms(std::forward<FalseyCellValueSynonymsT>(value));
    return *this;
  }
  template <typename FalseyCellValueSynonymsT = Aws::String>
  SemanticType& AddFalseyCellValueSynonyms(FalseyCellValueSynonymsT&& value) {
    m_falseyCellValueSynonymsHasBeenSet = true;
    m_falseyCellValueSynonyms.emplace_back(std::forward<FalseyCellValueSynonymsT>(value));
    return *this;
  }
  ///@}
 private:
