...
class CustomActionFilterOperation {
 public:
  ...
  void SetSelectedFieldsConfiguration(SelectedFieldsConfigurationT&& value) {
    m_selectedFieldsConfigurationHasBeenSet = true;
    m_selectedFieldsConfiguration = std::forward<SelectedFieldsConfigurationT>(value);
  }
  template <typename SelectedFieldsConfigurationT = FilterOperationSelectedFieldsConfiguration>
  CustomActionFilterOperation& WithSelectedFieldsConfiguration(SelectedFieldsConfigurationT&& value) {
    SetSelectedFieldsConfiguration(std::forward<SelectedFieldsConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetVisualsConfiguration(TargetVisualsConfigurationT&& value) {
    m_targetVisualsConfigurationHasBeenSet = true;
    m_targetVisualsConfiguration = std::forward<TargetVisualsConfigurationT>(value);
  }
  template <typename TargetVisualsConfigurationT = FilterOperationTargetVisualsConfiguration>
  CustomActionFilterOperation& WithTargetVisualsConfiguration(TargetVisualsConfigurationT&& value) {
    SetTargetVisualsConfiguration(std::forward<TargetVisualsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
