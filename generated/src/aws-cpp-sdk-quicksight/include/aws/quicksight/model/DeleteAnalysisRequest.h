...
class DeleteAnalysisRequest : public QuickSightRequest {
 public:
  ...
  ///@{
  /**
   * <p>A value that specifies the number of days that Amazon Quick Sight waits
  ...
  inline DeleteAnalysisRequest& WithRecoveryWindowInDays(long long value) {
  ...
  inline DeleteAnalysisRequest& WithForceDeleteWithoutRecovery(bool value) {
