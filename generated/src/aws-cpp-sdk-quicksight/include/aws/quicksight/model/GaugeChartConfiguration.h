...
class GaugeChartConfiguration {
 public:
  ...
  void SetGaugeChartOptions(GaugeChartOptionsT&& value) {
    ...
    m_gaugeChartOptions = std::forward<GaugeChartOptionsT>(value);
  }
  template <typename GaugeChartOptionsT = GaugeChartOptions>
  GaugeChartConfiguration& WithGaugeChartOptions(GaugeChartOptionsT&& value) {
    SetGaugeChartOptions(std::forward<GaugeChartOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTooltipOptions(TooltipOptionsT&& value) {
    ...
    m_tooltipOptions = std::forward<TooltipOptionsT>(value);
  }
  template <typename TooltipOptionsT = TooltipOptions>
  GaugeChartConfiguration& WithTooltipOptions(TooltipOptionsT&& value) {
    SetTooltipOptions(std::forward<TooltipOptionsT>(value));
    return *this;
  }
  ///@}
