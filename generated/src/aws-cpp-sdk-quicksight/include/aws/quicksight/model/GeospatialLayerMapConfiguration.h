...
class GeospatialLayerMapConfiguration {
 public:
  ...
  void SetMapState(MapStateT&& value) {
    ...
    m_mapState = std::forward<MapStateT>(value);
  }
  template <typename MapStateT = GeospatialMapState>
  GeospatialLayerMapConfiguration& WithMapState(MapStateT&& value) {
    SetMapState(std::forward<MapStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMapStyle(MapStyleT&& value) {
    ...
    m_mapStyle = std::forward<MapStyleT>(value);
  }
  template <typename MapStyleT = GeospatialMapStyle>
  GeospatialLayerMapConfiguration& WithMapStyle(MapStyleT&& value) {
    SetMapStyle(std::forward<MapStyleT>(value));
    return *this;
  }
  ///@}
