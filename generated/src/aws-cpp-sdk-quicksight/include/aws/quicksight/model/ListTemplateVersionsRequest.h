...
class ListTemplateVersionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  ListTemplateVersionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  ListTemplateVersionsRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  inline ListTemplateVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
