...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListTemplateVersionsRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    ListTemplateVersionsRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateIdT = Aws::String>
    ListTemplateVersionsRequest& WithTemplateId(TemplateIdT&& value) { SetTemplateId(std::forward<TemplateIdT>(value)); return *this;}
    ///@}
