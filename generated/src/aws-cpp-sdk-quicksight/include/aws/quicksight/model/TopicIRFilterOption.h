...
class TopicIRFilterOption {
 public:
  ...
  inline void SetFilterType(TopicIRFilterType value) {
    m_filterTypeHasBeenSet = true;
    m_filterType = value;
  }
  inline TopicIRFilterOption& WithFilterType(TopicIRFilterType value) {
    SetFilterType(value);
    return *this;
  }
  ///@}
  ...
  inline TopicIRFilterOption& WithFilterClass(FilterClass value) {
  ...
  void SetOperandField(OperandFieldT&& value) {
    m_operandFieldHasBeenSet = true;
    m_operandField = std::forward<OperandFieldT>(value);
  }
  template <typename OperandFieldT = Identifier>
  TopicIRFilterOption& WithOperandField(OperandFieldT&& value) {
    SetOperandField(std::forward<OperandFieldT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFunction(TopicIRFilterFunction value) {
    m_functionHasBeenSet = true;
    m_function = value;
  }
  inline TopicIRFilterOption& WithFunction(TopicIRFilterFunction value) {
    SetFunction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConstantT = TopicConstantValue>
  TopicIRFilterOption& WithConstant(ConstantT&& value) {
  ...
  inline TopicIRFilterOption& WithInverse(bool value) {
    SetInverse(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNullFilter(NullFilterOption value) {
    m_nullFilterHasBeenSet = true;
    m_nullFilter = value;
  }
  inline TopicIRFilterOption& WithNullFilter(NullFilterOption value) {
    SetNullFilter(value);
    return *this;
  }
  ///@}
  ...
  inline TopicIRFilterOption& WithAggregation(AggType value) {
  ...
  template <typename AggregationFunctionParametersT = Aws::Map<Aws::String, Aws::String>>
  TopicIRFilterOption& WithAggregationFunctionParameters(AggregationFunctionParametersT&& value) {
  ...
  TopicIRFilterOption& AddAggregationFunctionParameters(AggregationFunctionParametersKeyT&& key,
  ...
  void SetAggregationPartitionBy(AggregationPartitionByT&& value) {
    m_aggregationPartitionByHasBeenSet = true;
    m_aggregationPartitionBy = std::forward<AggregationPartitionByT>(value);
  }
  template <typename AggregationPartitionByT = Aws::Vector<AggregationPartitionBy>>
  TopicIRFilterOption& WithAggregationPartitionBy(AggregationPartitionByT&& value) {
    SetAggregationPartitionBy(std::forward<AggregationPartitionByT>(value));
    return *this;
  }
  template <typename AggregationPartitionByT = AggregationPartitionBy>
  TopicIRFilterOption& AddAggregationPartitionBy(AggregationPartitionByT&& value) {
    m_aggregationPartitionByHasBeenSet = true;
    m_aggregationPartitionBy.emplace_back(std::forward<AggregationPartitionByT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RangeT = TopicConstantValue>
  TopicIRFilterOption& WithRange(RangeT&& value) {
  ...
  inline TopicIRFilterOption& WithInclusive(bool value) {
    SetInclusive(value);
    return *this;
  }
  ///@}
  ...
  inline TopicIRFilterOption& WithTimeGranularity(TimeGranularity value) {
  ...
  void SetLastNextOffset(LastNextOffsetT&& value) {
    m_lastNextOffsetHasBeenSet = true;
    m_lastNextOffset = std::forward<LastNextOffsetT>(value);
  }
  template <typename LastNextOffsetT = TopicConstantValue>
  TopicIRFilterOption& WithLastNextOffset(LastNextOffsetT&& value) {
    SetLastNextOffset(std::forward<LastNextOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggMetrics(AggMetricsT&& value) {
    m_aggMetricsHasBeenSet = true;
    m_aggMetrics = std::forward<AggMetricsT>(value);
  }
  template <typename AggMetricsT = Aws::Vector<FilterAggMetrics>>
  TopicIRFilterOption& WithAggMetrics(AggMetricsT&& value) {
    SetAggMetrics(std::forward<AggMetricsT>(value));
    return *this;
  }
  template <typename AggMetricsT = FilterAggMetrics>
  TopicIRFilterOption& AddAggMetrics(AggMetricsT&& value) {
    m_aggMetricsHasBeenSet = true;
    m_aggMetrics.emplace_back(std::forward<AggMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopBottomLimit(TopBottomLimitT&& value) {
    m_topBottomLimitHasBeenSet = true;
    m_topBottomLimit = std::forward<TopBottomLimitT>(value);
  }
  template <typename TopBottomLimitT = TopicConstantValue>
  TopicIRFilterOption& WithTopBottomLimit(TopBottomLimitT&& value) {
    SetTopBottomLimit(std::forward<TopBottomLimitT>(value));
    return *this;
  }
  ///@}
  ...
  inline TopicIRFilterOption& WithSortDirection(TopicSortDirection value) {
  ...
  template <typename AnchorT = Anchor>
  TopicIRFilterOption& WithAnchor(AnchorT&& value) {
