...
class PutDataSetRefreshPropertiesResult {
 public:
  AWS_QUICKSIGHT_API PutDataSetRefreshPropertiesResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  PutDataSetRefreshPropertiesResult& WithRequestId(RequestIdT&& value) {
  ...
  inline PutDataSetRefreshPropertiesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
