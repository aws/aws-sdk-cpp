...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListFoldersResult() = default;
    ...
    template<typename FolderSummaryListT = Aws::Vector<FolderSummary>>
    ListFoldersResult& WithFolderSummaryList(FolderSummaryListT&& value) { SetFolderSummaryList(std::forward<FolderSummaryListT>(value)); return *this;}
    template<typename FolderSummaryListT = FolderSummary>
    ListFoldersResult& AddFolderSummaryList(FolderSummaryListT&& value) { m_folderSummaryListHasBeenSet = true; m_folderSummaryList.emplace_back(std::forward<FolderSummaryListT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFoldersResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListFoldersResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
