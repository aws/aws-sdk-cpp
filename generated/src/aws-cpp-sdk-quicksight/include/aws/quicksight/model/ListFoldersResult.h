...
class ListFoldersResult {
 public:
  ...
  inline ListFoldersResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetFolderSummaryList(FolderSummaryListT&& value) {
    ...
    m_folderSummaryList = std::forward<FolderSummaryListT>(value);
  }
  template <typename FolderSummaryListT = Aws::Vector<FolderSummary>>
  ListFoldersResult& WithFolderSummaryList(FolderSummaryListT&& value) {
    SetFolderSummaryList(std::forward<FolderSummaryListT>(value));
    return *this;
  }
  template <typename FolderSummaryListT = FolderSummary>
  ListFoldersResult& AddFolderSummaryList(FolderSummaryListT&& value) {
    m_folderSummaryListHasBeenSet = true;
    m_folderSummaryList.emplace_back(std::forward<FolderSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFoldersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFoldersResult& WithRequestId(RequestIdT&& value) {
