...
class ParameterSliderControl {
 public:
  ...
  inline ParameterSliderControl& WithMaximumValue(double value) {
  ...
  inline ParameterSliderControl& WithMinimumValue(double value) {
  ...
  inline ParameterSliderControl& WithStepSize(double value) {
    SetStepSize(value);
    return *this;
  }
  ///@}
