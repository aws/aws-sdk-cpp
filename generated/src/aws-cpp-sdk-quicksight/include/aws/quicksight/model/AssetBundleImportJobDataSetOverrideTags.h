...
class AssetBundleImportJobDataSetOverrideTags {
 public:
  ...
  template <typename DataSetIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobDataSetOverrideTags& WithDataSetIds(DataSetIdsT&& value) {
    SetDataSetIds(std::forward<DataSetIdsT>(value));
    return *this;
  }
  template <typename DataSetIdsT = Aws::String>
  AssetBundleImportJobDataSetOverrideTags& AddDataSetIds(DataSetIdsT&& value) {
    m_dataSetIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobDataSetOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobDataSetOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
