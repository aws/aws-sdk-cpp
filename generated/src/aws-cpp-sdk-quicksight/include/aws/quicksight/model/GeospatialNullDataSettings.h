...
class GeospatialNullDataSettings {
 public:
  ...
  void SetSymbolStyle(SymbolStyleT&& value) {
    m_symbolStyleHasBeenSet = true;
    m_symbolStyle = std::forward<SymbolStyleT>(value);
  }
  template <typename SymbolStyleT = GeospatialNullSymbolStyle>
  GeospatialNullDataSettings& WithSymbolStyle(SymbolStyleT&& value) {
    SetSymbolStyle(std::forward<SymbolStyleT>(value));
    return *this;
  }
  ///@}
 private:
