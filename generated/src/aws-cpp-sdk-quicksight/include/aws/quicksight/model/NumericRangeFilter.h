...
class NumericRangeFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  NumericRangeFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  NumericRangeFilter& WithColumn(ColumnT&& value) {
  ...
  inline NumericRangeFilter& WithIncludeMinimum(bool value) {
  ...
  inline NumericRangeFilter& WithIncludeMaximum(bool value) {
  ...
  template <typename RangeMinimumT = NumericRangeFilterValue>
  NumericRangeFilter& WithRangeMinimum(RangeMinimumT&& value) {
  ...
  template <typename RangeMaximumT = NumericRangeFilterValue>
  NumericRangeFilter& WithRangeMaximum(RangeMaximumT&& value) {
  ...
  inline NumericRangeFilter& WithSelectAllOptions(NumericFilterSelectAllOptions value) {
  ...
  template <typename AggregationFunctionT = AggregationFunction>
  NumericRangeFilter& WithAggregationFunction(AggregationFunctionT&& value) {
  ...
  inline NumericRangeFilter& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  NumericRangeFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
