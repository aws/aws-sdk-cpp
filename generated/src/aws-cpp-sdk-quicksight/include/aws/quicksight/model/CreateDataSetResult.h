...
class CreateDataSetResult {
 public:
  ...
  void SetIngestionArn(IngestionArnT&& value) {
    ...
    m_ingestionArn = std::forward<IngestionArnT>(value);
  }
  template <typename IngestionArnT = Aws::String>
  CreateDataSetResult& WithIngestionArn(IngestionArnT&& value) {
    SetIngestionArn(std::forward<IngestionArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IngestionIdT = Aws::String>
  CreateDataSetResult& WithIngestionId(IngestionIdT&& value) {
  ...
  inline CreateDataSetResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
