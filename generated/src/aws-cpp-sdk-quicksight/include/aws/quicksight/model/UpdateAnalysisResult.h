...
class UpdateAnalysisResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateAnalysisResult& WithArn(ArnT&& value) {
  ...
  template <typename AnalysisIdT = Aws::String>
  UpdateAnalysisResult& WithAnalysisId(AnalysisIdT&& value) {
  ...
  inline UpdateAnalysisResult& WithUpdateStatus(ResourceStatus value) {
  ...
  inline UpdateAnalysisResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAnalysisResult& WithRequestId(RequestIdT&& value) {
