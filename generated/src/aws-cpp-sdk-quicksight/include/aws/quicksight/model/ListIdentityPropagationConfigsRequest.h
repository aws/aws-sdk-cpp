...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListIdentityPropagationConfigsRequest();
     ...
     * results.</p>
     */
    inline ListIdentityPropagationConfigsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
