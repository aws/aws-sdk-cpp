...
class CreateTopicReviewedAnswer {
 public:
  ...
  void SetMir(MirT&& value) {
    m_mirHasBeenSet = true;
    m_mir = std::forward<MirT>(value);
  }
  template <typename MirT = TopicIR>
  CreateTopicReviewedAnswer& WithMir(MirT&& value) {
    SetMir(std::forward<MirT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrimaryVisual(PrimaryVisualT&& value) {
    m_primaryVisualHasBeenSet = true;
    m_primaryVisual = std::forward<PrimaryVisualT>(value);
  }
  template <typename PrimaryVisualT = TopicVisual>
  CreateTopicReviewedAnswer& WithPrimaryVisual(PrimaryVisualT&& value) {
    SetPrimaryVisual(std::forward<PrimaryVisualT>(value));
    return *this;
  }
  ///@}
