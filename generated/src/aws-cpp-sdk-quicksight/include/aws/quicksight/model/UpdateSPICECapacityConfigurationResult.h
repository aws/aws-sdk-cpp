...
class UpdateSPICECapacityConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API UpdateSPICECapacityConfigurationResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSPICECapacityConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateSPICECapacityConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
