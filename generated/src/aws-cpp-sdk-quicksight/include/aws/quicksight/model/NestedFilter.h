...
class NestedFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  NestedFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  NestedFilter& WithColumn(ColumnT&& value) {
  ...
  inline void SetIncludeInnerSet(bool value) {
    m_includeInnerSetHasBeenSet = true;
    m_includeInnerSet = value;
  }
  inline NestedFilter& WithIncludeInnerSet(bool value) {
    SetIncludeInnerSet(value);
    return *this;
  }
  ///@}
  ...
  void SetInnerFilter(InnerFilterT&& value) {
    m_innerFilterHasBeenSet = true;
    m_innerFilter = std::forward<InnerFilterT>(value);
  }
  template <typename InnerFilterT = InnerFilter>
  NestedFilter& WithInnerFilter(InnerFilterT&& value) {
    SetInnerFilter(std::forward<InnerFilterT>(value));
    return *this;
  }
  ///@}
 private:
