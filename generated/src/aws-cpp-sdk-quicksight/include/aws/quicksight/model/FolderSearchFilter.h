...
class FolderSearchFilter {
 public:
  ...
  inline FolderSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(FolderFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline FolderSearchFilter& WithName(FolderFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  FolderSearchFilter& WithValue(ValueT&& value) {
