...
class AssetBundleImportJobDataSetOverrideParameters {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  AssetBundleImportJobDataSetOverrideParameters& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetBundleImportJobDataSetOverrideParameters& WithName(NameT&& value) {
  ...
  template <typename DataSetRefreshPropertiesT = DataSetRefreshProperties>
  AssetBundleImportJobDataSetOverrideParameters& WithDataSetRefreshProperties(DataSetRefreshPropertiesT&& value) {
