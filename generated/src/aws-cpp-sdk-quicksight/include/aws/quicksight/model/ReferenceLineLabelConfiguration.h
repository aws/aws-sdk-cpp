...
class ReferenceLineLabelConfiguration {
 public:
  ...
  void SetValueLabelConfiguration(ValueLabelConfigurationT&& value) {
    m_valueLabelConfigurationHasBeenSet = true;
    m_valueLabelConfiguration = std::forward<ValueLabelConfigurationT>(value);
  }
  template <typename ValueLabelConfigurationT = ReferenceLineValueLabelConfiguration>
  ReferenceLineLabelConfiguration& WithValueLabelConfiguration(ValueLabelConfigurationT&& value) {
    SetValueLabelConfiguration(std::forward<ValueLabelConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomLabelConfiguration(CustomLabelConfigurationT&& value) {
    m_customLabelConfigurationHasBeenSet = true;
    m_customLabelConfiguration = std::forward<CustomLabelConfigurationT>(value);
  }
  template <typename CustomLabelConfigurationT = ReferenceLineCustomLabelConfiguration>
  ReferenceLineLabelConfiguration& WithCustomLabelConfiguration(CustomLabelConfigurationT&& value) {
    SetCustomLabelConfiguration(std::forward<CustomLabelConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHorizontalPosition(ReferenceLineLabelHorizontalPosition value) {
    m_horizontalPositionHasBeenSet = true;
    m_horizontalPosition = value;
  }
  inline ReferenceLineLabelConfiguration& WithHorizontalPosition(ReferenceLineLabelHorizontalPosition value) {
  ...
  inline void SetVerticalPosition(ReferenceLineLabelVerticalPosition value) {
    m_verticalPositionHasBeenSet = true;
    m_verticalPosition = value;
  }
  inline ReferenceLineLabelConfiguration& WithVerticalPosition(ReferenceLineLabelVerticalPosition value) {
