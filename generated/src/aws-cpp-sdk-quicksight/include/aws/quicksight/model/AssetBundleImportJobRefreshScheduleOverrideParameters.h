...
class AssetBundleImportJobRefreshScheduleOverrideParameters {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  AssetBundleImportJobRefreshScheduleOverrideParameters& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename ScheduleIdT = Aws::String>
  AssetBundleImportJobRefreshScheduleOverrideParameters& WithScheduleId(ScheduleIdT&& value) {
  ...
  void SetStartAfterDateTime(StartAfterDateTimeT&& value) {
    ...
    m_startAfterDateTime = std::forward<StartAfterDateTimeT>(value);
  }
  template <typename StartAfterDateTimeT = Aws::Utils::DateTime>
  AssetBundleImportJobRefreshScheduleOverrideParameters& WithStartAfterDateTime(StartAfterDateTimeT&& value) {
    SetStartAfterDateTime(std::forward<StartAfterDateTimeT>(value));
    return *this;
  }
  ///@}
 private:
