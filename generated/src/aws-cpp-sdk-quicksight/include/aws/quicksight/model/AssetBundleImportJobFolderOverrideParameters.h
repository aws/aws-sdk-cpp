...
class AssetBundleImportJobFolderOverrideParameters {
 public:
  ...
  template <typename FolderIdT = Aws::String>
  AssetBundleImportJobFolderOverrideParameters& WithFolderId(FolderIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetBundleImportJobFolderOverrideParameters& WithName(NameT&& value) {
  ...
  void SetParentFolderArn(ParentFolderArnT&& value) {
    ...
    m_parentFolderArn = std::forward<ParentFolderArnT>(value);
  }
  template <typename ParentFolderArnT = Aws::String>
  AssetBundleImportJobFolderOverrideParameters& WithParentFolderArn(ParentFolderArnT&& value) {
    SetParentFolderArn(std::forward<ParentFolderArnT>(value));
    return *this;
  }
  ///@}
 private:
