...
class TableBorderOptions {
 public:
  ...
  inline TableBorderOptions& WithThickness(int value) {
    SetThickness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStyle(TableBorderStyle value) {
    m_styleHasBeenSet = true;
    m_style = value;
  }
  inline TableBorderOptions& WithStyle(TableBorderStyle value) {
    SetStyle(value);
    return *this;
  }
  ///@}
