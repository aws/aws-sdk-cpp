...
class AggregationFunction {
 public:
  ...
  void SetNumericalAggregationFunction(NumericalAggregationFunctionT&& value) {
    ...
    m_numericalAggregationFunction = std::forward<NumericalAggregationFunctionT>(value);
  }
  template <typename NumericalAggregationFunctionT = NumericalAggregationFunction>
  AggregationFunction& WithNumericalAggregationFunction(NumericalAggregationFunctionT&& value) {
    SetNumericalAggregationFunction(std::forward<NumericalAggregationFunctionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCategoricalAggregationFunction(CategoricalAggregationFunction value) {
    m_categoricalAggregationFunctionHasBeenSet = true;
    m_categoricalAggregationFunction = value;
  }
  inline AggregationFunction& WithCategoricalAggregationFunction(CategoricalAggregationFunction value) {
    SetCategoricalAggregationFunction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDateAggregationFunction(DateAggregationFunction value) {
    m_dateAggregationFunctionHasBeenSet = true;
    m_dateAggregationFunction = value;
  }
  inline AggregationFunction& WithDateAggregationFunction(DateAggregationFunction value) {
    SetDateAggregationFunction(value);
    return *this;
  }
  ///@}
  ...
  void SetAttributeAggregationFunction(AttributeAggregationFunctionT&& value) {
    ...
    m_attributeAggregationFunction = std::forward<AttributeAggregationFunctionT>(value);
  }
  template <typename AttributeAggregationFunctionT = AttributeAggregationFunction>
  AggregationFunction& WithAttributeAggregationFunction(AttributeAggregationFunctionT&& value) {
    SetAttributeAggregationFunction(std::forward<AttributeAggregationFunctionT>(value));
    return *this;
  }
  ///@}
 private:
