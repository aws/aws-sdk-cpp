...
class SemanticEntityType {
 public:
  ...
  template <typename TypeNameT = Aws::String>
  SemanticEntityType& WithTypeName(TypeNameT&& value) {
  ...
  template <typename SubTypeNameT = Aws::String>
  SemanticEntityType& WithSubTypeName(SubTypeNameT&& value) {
  ...
  template <typename TypeParametersT = Aws::Map<Aws::String, Aws::String>>
  SemanticEntityType& WithTypeParameters(TypeParametersT&& value) {
