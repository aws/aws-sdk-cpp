...
namespace Model
{
  ...
  public:
    ...
    template<typename TitleOptionsT = LabelOptions>
    TextAreaControlDisplayOptions& WithTitleOptions(TitleOptionsT&& value) { SetTitleOptions(std::forward<TitleOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename PlaceholderOptionsT = TextControlPlaceholderOptions>
    TextAreaControlDisplayOptions& WithPlaceholderOptions(PlaceholderOptionsT&& value) { SetPlaceholderOptions(std::forward<PlaceholderOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename InfoIconLabelOptionsT = SheetControlInfoIconLabelOptions>
    TextAreaControlDisplayOptions& WithInfoIconLabelOptions(InfoIconLabelOptionsT&& value) { SetInfoIconLabelOptions(std::forward<InfoIconLabelOptionsT>(value)); return *this;}
    ///@}
  private:
