...
namespace Model
{
  ...
  public:
     ...
     * <p>The configuration of info icon label options.</p>
     */
    inline TextAreaControlDisplayOptions& WithInfoIconLabelOptions(SheetControlInfoIconLabelOptions&& value) { SetInfoIconLabelOptions(std::move(value)); return *this;}
