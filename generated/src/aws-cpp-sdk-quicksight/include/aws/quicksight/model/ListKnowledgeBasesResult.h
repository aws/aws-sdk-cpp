...
class ListKnowledgeBasesResult {
 public:
  AWS_QUICKSIGHT_API ListKnowledgeBasesResult() = default;
  AWS_QUICKSIGHT_API ListKnowledgeBasesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API ListKnowledgeBasesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  inline ListKnowledgeBasesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
