...
class GaugeChartConditionalFormatting {
 public:
   ...
   */
  inline const Aws::Vector<GaugeChartConditionalFormattingOption>& GetConditionalFormattingOptions() const {
  ...
  template <typename ConditionalFormattingOptionsT = Aws::Vector<GaugeChartConditionalFormattingOption>>
  GaugeChartConditionalFormatting& WithConditionalFormattingOptions(ConditionalFormattingOptionsT&& value) {
  ...
  GaugeChartConditionalFormatting& AddConditionalFormattingOptions(ConditionalFormattingOptionsT&& value) {
    m_conditionalFormattingOptionsHasBeenSet = true;
