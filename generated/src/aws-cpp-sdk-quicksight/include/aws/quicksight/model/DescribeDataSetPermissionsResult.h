...
class DescribeDataSetPermissionsResult {
 public:
  ...
  template <typename DataSetArnT = Aws::String>
  DescribeDataSetPermissionsResult& WithDataSetArn(DataSetArnT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  DescribeDataSetPermissionsResult& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeDataSetPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeDataSetPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDataSetPermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeDataSetPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
