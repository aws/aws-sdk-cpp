...
namespace Model
{
  ...
  public:
    ...
    template<typename AwsAccountIdT = Aws::String>
    BatchCreateTopicReviewedAnswerRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicIdT = Aws::String>
    BatchCreateTopicReviewedAnswerRequest& WithTopicId(TopicIdT&& value) { SetTopicId(std::forward<TopicIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AnswersT = Aws::Vector<CreateTopicReviewedAnswer>>
    void SetAnswers(AnswersT&& value) { m_answersHasBeenSet = true; m_answers = std::forward<AnswersT>(value); }
    template<typename AnswersT = Aws::Vector<CreateTopicReviewedAnswer>>
    BatchCreateTopicReviewedAnswerRequest& WithAnswers(AnswersT&& value) { SetAnswers(std::forward<AnswersT>(value)); return *this;}
    template<typename AnswersT = CreateTopicReviewedAnswer>
    BatchCreateTopicReviewedAnswerRequest& AddAnswers(AnswersT&& value) { m_answersHasBeenSet = true; m_answers.emplace_back(std::forward<AnswersT>(value)); return *this; }
    ///@}
  private:
