...
class RadarChartFieldWells {
 public:
  ...
  void SetRadarChartAggregatedFieldWells(RadarChartAggregatedFieldWellsT&& value) {
    m_radarChartAggregatedFieldWellsHasBeenSet = true;
    m_radarChartAggregatedFieldWells = std::forward<RadarChartAggregatedFieldWellsT>(value);
  }
  template <typename RadarChartAggregatedFieldWellsT = RadarChartAggregatedFieldWells>
  RadarChartFieldWells& WithRadarChartAggregatedFieldWells(RadarChartAggregatedFieldWellsT&& value) {
    SetRadarChartAggregatedFieldWells(std::forward<RadarChartAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
