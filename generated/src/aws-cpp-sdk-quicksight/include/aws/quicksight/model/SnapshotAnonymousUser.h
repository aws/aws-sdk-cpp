...
class SnapshotAnonymousUser {
 public:
   ...
   * Row-Level Security (RLS) with Tags</a>in the <i>Amazon Quick User Guide</i>.</p>
   */
  ...
  void SetRowLevelPermissionTags(RowLevelPermissionTagsT&& value) {
    m_rowLevelPermissionTagsHasBeenSet = true;
    m_rowLevelPermissionTags = std::forward<RowLevelPermissionTagsT>(value);
  }
  template <typename RowLevelPermissionTagsT = Aws::Vector<SessionTag>>
  SnapshotAnonymousUser& WithRowLevelPermissionTags(RowLevelPermissionTagsT&& value) {
    SetRowLevelPermissionTags(std::forward<RowLevelPermissionTagsT>(value));
    return *this;
  }
  template <typename RowLevelPermissionTagsT = SessionTag>
  SnapshotAnonymousUser& AddRowLevelPermissionTags(RowLevelPermissionTagsT&& value) {
    m_rowLevelPermissionTagsHasBeenSet = true;
    m_rowLevelPermissionTags.emplace_back(std::forward<RowLevelPermissionTagsT>(value));
    return *this;
  }
  ///@}
 private:
