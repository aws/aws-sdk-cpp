...
class LayerCustomAction {
 public:
  ...
  inline LayerCustomAction& WithStatus(WidgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTrigger(LayerCustomActionTrigger value) {
    m_triggerHasBeenSet = true;
    m_trigger = value;
  }
  inline LayerCustomAction& WithTrigger(LayerCustomActionTrigger value) {
    SetTrigger(value);
    return *this;
  }
  ///@}
