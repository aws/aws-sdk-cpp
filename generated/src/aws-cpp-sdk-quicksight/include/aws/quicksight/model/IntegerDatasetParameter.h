...
class IntegerDatasetParameter {
 public:
  ...
  template <typename IdT = Aws::String>
  IntegerDatasetParameter& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  IntegerDatasetParameter& WithName(NameT&& value) {
  ...
  inline IntegerDatasetParameter& WithValueType(DatasetParameterValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultValuesT = IntegerDatasetParameterDefaultValues>
  IntegerDatasetParameter& WithDefaultValues(DefaultValuesT&& value) {
