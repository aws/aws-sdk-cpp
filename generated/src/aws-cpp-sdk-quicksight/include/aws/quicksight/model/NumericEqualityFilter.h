...
class NumericEqualityFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  NumericEqualityFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  NumericEqualityFilter& WithColumn(ColumnT&& value) {
  ...
  inline NumericEqualityFilter& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelectAllOptions(NumericFilterSelectAllOptions value) {
    m_selectAllOptionsHasBeenSet = true;
    m_selectAllOptions = value;
  }
  inline NumericEqualityFilter& WithSelectAllOptions(NumericFilterSelectAllOptions value) {
  ...
  inline void SetMatchOperator(NumericEqualityMatchOperator value) {
    m_matchOperatorHasBeenSet = true;
    m_matchOperator = value;
  }
  inline NumericEqualityFilter& WithMatchOperator(NumericEqualityMatchOperator value) {
  ...
  template <typename AggregationFunctionT = AggregationFunction>
  NumericEqualityFilter& WithAggregationFunction(AggregationFunctionT&& value) {
  ...
  template <typename ParameterNameT = Aws::String>
  NumericEqualityFilter& WithParameterName(ParameterNameT&& value) {
  ...
  inline NumericEqualityFilter& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  NumericEqualityFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
