...
class DeleteFolderMembershipResult {
 public:
  AWS_QUICKSIGHT_API DeleteFolderMembershipResult() = default;
  ...
  inline DeleteFolderMembershipResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteFolderMembershipResult& WithRequestId(RequestIdT&& value) {
