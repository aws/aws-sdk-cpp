...
class Filter {
 public:
  ...
  template <typename CategoryFilterT = CategoryFilter>
  Filter& WithCategoryFilter(CategoryFilterT&& value) {
  ...
  template <typename NumericRangeFilterT = NumericRangeFilter>
  Filter& WithNumericRangeFilter(NumericRangeFilterT&& value) {
  ...
  template <typename NumericEqualityFilterT = NumericEqualityFilter>
  Filter& WithNumericEqualityFilter(NumericEqualityFilterT&& value) {
  ...
  void SetTimeEqualityFilter(TimeEqualityFilterT&& value) {
    m_timeEqualityFilterHasBeenSet = true;
    m_timeEqualityFilter = std::forward<TimeEqualityFilterT>(value);
  }
  template <typename TimeEqualityFilterT = TimeEqualityFilter>
  Filter& WithTimeEqualityFilter(TimeEqualityFilterT&& value) {
    SetTimeEqualityFilter(std::forward<TimeEqualityFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TimeRangeFilterT = TimeRangeFilter>
  Filter& WithTimeRangeFilter(TimeRangeFilterT&& value) {
  ...
  void SetRelativeDatesFilter(RelativeDatesFilterT&& value) {
    m_relativeDatesFilterHasBeenSet = true;
    m_relativeDatesFilter = std::forward<RelativeDatesFilterT>(value);
  }
  template <typename RelativeDatesFilterT = RelativeDatesFilter>
  Filter& WithRelativeDatesFilter(RelativeDatesFilterT&& value) {
    SetRelativeDatesFilter(std::forward<RelativeDatesFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTopBottomFilter(TopBottomFilterT&& value) {
    m_topBottomFilterHasBeenSet = true;
    m_topBottomFilter = std::forward<TopBottomFilterT>(value);
  }
  template <typename TopBottomFilterT = TopBottomFilter>
  Filter& WithTopBottomFilter(TopBottomFilterT&& value) {
    SetTopBottomFilter(std::forward<TopBottomFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNestedFilter(NestedFilterT&& value) {
    m_nestedFilterHasBeenSet = true;
    m_nestedFilter = std::forward<NestedFilterT>(value);
  }
  template <typename NestedFilterT = NestedFilter>
  Filter& WithNestedFilter(NestedFilterT&& value) {
    SetNestedFilter(std::forward<NestedFilterT>(value));
    return *this;
  }
  ///@}
 private:
