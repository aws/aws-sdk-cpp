...
class ScatterPlotFieldWells {
 public:
   ...
   * both.</p>
   */
  inline const ScatterPlotCategoricallyAggregatedFieldWells& GetScatterPlotCategoricallyAggregatedFieldWells() const {
    return m_scatterPlotCategoricallyAggregatedFieldWells;
  }
  inline bool ScatterPlotCategoricallyAggregatedFieldWellsHasBeenSet() const {
    return m_scatterPlotCategoricallyAggregatedFieldWellsHasBeenSet;
  }
  ...
  void SetScatterPlotCategoricallyAggregatedFieldWells(ScatterPlotCategoricallyAggregatedFieldWellsT&& value) {
    ...
    m_scatterPlotCategoricallyAggregatedFieldWells = std::forward<ScatterPlotCategoricallyAggregatedFieldWellsT>(value);
  }
  template <typename ScatterPlotCategoricallyAggregatedFieldWellsT = ScatterPlotCategoricallyAggregatedFieldWells>
  ScatterPlotFieldWells& WithScatterPlotCategoricallyAggregatedFieldWells(ScatterPlotCategoricallyAggregatedFieldWellsT&& value) {
    SetScatterPlotCategoricallyAggregatedFieldWells(std::forward<ScatterPlotCategoricallyAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ScatterPlotUnaggregatedFieldWells& GetScatterPlotUnaggregatedFieldWells() const {
    return m_scatterPlotUnaggregatedFieldWells;
  }
  ...
  void SetScatterPlotUnaggregatedFieldWells(ScatterPlotUnaggregatedFieldWellsT&& value) {
    ...
    m_scatterPlotUnaggregatedFieldWells = std::forward<ScatterPlotUnaggregatedFieldWellsT>(value);
  }
  template <typename ScatterPlotUnaggregatedFieldWellsT = ScatterPlotUnaggregatedFieldWells>
  ScatterPlotFieldWells& WithScatterPlotUnaggregatedFieldWells(ScatterPlotUnaggregatedFieldWellsT&& value) {
    SetScatterPlotUnaggregatedFieldWells(std::forward<ScatterPlotUnaggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
