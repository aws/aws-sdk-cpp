...
class DeleteDashboardResult {
 public:
  ...
  inline DeleteDashboardResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  DeleteDashboardResult& WithArn(ArnT&& value) {
  ...
  template <typename DashboardIdT = Aws::String>
  DeleteDashboardResult& WithDashboardId(DashboardIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDashboardResult& WithRequestId(RequestIdT&& value) {
