...
class FilterTextFieldControl {
 public:
  ...
  template <typename FilterControlIdT = Aws::String>
  FilterTextFieldControl& WithFilterControlId(FilterControlIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  FilterTextFieldControl& WithTitle(TitleT&& value) {
  ...
  template <typename SourceFilterIdT = Aws::String>
  FilterTextFieldControl& WithSourceFilterId(SourceFilterIdT&& value) {
  ...
  template <typename DisplayOptionsT = TextFieldControlDisplayOptions>
  FilterTextFieldControl& WithDisplayOptions(DisplayOptionsT&& value) {
