...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ConcurrentUpdatingException() = default;
    ...
    template<typename MessageT = Aws::String>
    ConcurrentUpdatingException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ConcurrentUpdatingException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
