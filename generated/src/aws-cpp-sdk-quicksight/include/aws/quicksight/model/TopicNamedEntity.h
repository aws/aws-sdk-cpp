...
class TopicNamedEntity {
 public:
  ...
  void SetEntityDescription(EntityDescriptionT&& value) {
    ...
    m_entityDescription = std::forward<EntityDescriptionT>(value);
  }
  template <typename EntityDescriptionT = Aws::String>
  TopicNamedEntity& WithEntityDescription(EntityDescriptionT&& value) {
    SetEntityDescription(std::forward<EntityDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEntitySynonyms(EntitySynonymsT&& value) {
    ...
    m_entitySynonyms = std::forward<EntitySynonymsT>(value);
  }
  template <typename EntitySynonymsT = Aws::Vector<Aws::String>>
  TopicNamedEntity& WithEntitySynonyms(EntitySynonymsT&& value) {
    SetEntitySynonyms(std::forward<EntitySynonymsT>(value));
    return *this;
  }
  template <typename EntitySynonymsT = Aws::String>
  TopicNamedEntity& AddEntitySynonyms(EntitySynonymsT&& value) {
    m_entitySynonymsHasBeenSet = true;
    m_entitySynonyms.emplace_back(std::forward<EntitySynonymsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSemanticEntityType(SemanticEntityTypeT&& value) {
    ...
    m_semanticEntityType = std::forward<SemanticEntityTypeT>(value);
  }
  template <typename SemanticEntityTypeT = SemanticEntityType>
  TopicNamedEntity& WithSemanticEntityType(SemanticEntityTypeT&& value) {
    SetSemanticEntityType(std::forward<SemanticEntityTypeT>(value));
    return *this;
  }
  ///@}
