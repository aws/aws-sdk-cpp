...
class AssetBundleExportJobAnalysisOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobAnalysisOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobAnalysisPropertyToOverride>>
  AssetBundleExportJobAnalysisOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobAnalysisOverrideProperties& AddProperties(AssetBundleExportJobAnalysisPropertyToOverride value) {
    m_propertiesHasBeenSet = true;
