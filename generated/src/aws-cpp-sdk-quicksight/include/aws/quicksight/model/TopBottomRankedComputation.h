...
class TopBottomRankedComputation {
 public:
  ...
  inline void SetResultSize(int value) {
    m_resultSizeHasBeenSet = true;
    m_resultSize = value;
  }
  inline TopBottomRankedComputation& WithResultSize(int value) {
    SetResultSize(value);
    return *this;
  }
  ///@}
  ...
  inline TopBottomRankedComputation& WithType(TopBottomComputationType value) {
    SetType(value);
    return *this;
  }
  ///@}
