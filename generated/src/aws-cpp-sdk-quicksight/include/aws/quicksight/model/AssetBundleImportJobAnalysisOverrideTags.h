...
class AssetBundleImportJobAnalysisOverrideTags {
 public:
  ...
  void SetAnalysisIds(AnalysisIdsT&& value) {
    m_analysisIdsHasBeenSet = true;
    m_analysisIds = std::forward<AnalysisIdsT>(value);
  }
  template <typename AnalysisIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobAnalysisOverrideTags& WithAnalysisIds(AnalysisIdsT&& value) {
    SetAnalysisIds(std::forward<AnalysisIdsT>(value));
    return *this;
  }
  template <typename AnalysisIdsT = Aws::String>
  AssetBundleImportJobAnalysisOverrideTags& AddAnalysisIds(AnalysisIdsT&& value) {
    m_analysisIdsHasBeenSet = true;
    m_analysisIds.emplace_back(std::forward<AnalysisIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobAnalysisOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobAnalysisOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
