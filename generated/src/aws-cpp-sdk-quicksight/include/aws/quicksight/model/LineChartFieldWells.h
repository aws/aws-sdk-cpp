...
class LineChartFieldWells {
 public:
  ...
  void SetLineChartAggregatedFieldWells(LineChartAggregatedFieldWellsT&& value) {
    ...
    m_lineChartAggregatedFieldWells = std::forward<LineChartAggregatedFieldWellsT>(value);
  }
  template <typename LineChartAggregatedFieldWellsT = LineChartAggregatedFieldWells>
  LineChartFieldWells& WithLineChartAggregatedFieldWells(LineChartAggregatedFieldWellsT&& value) {
    SetLineChartAggregatedFieldWells(std::forward<LineChartAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
