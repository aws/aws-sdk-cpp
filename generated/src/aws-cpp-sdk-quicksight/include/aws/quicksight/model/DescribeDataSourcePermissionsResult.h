...
class DescribeDataSourcePermissionsResult {
 public:
  ...
  template <typename DataSourceArnT = Aws::String>
  DescribeDataSourcePermissionsResult& WithDataSourceArn(DataSourceArnT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  DescribeDataSourcePermissionsResult& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeDataSourcePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeDataSourcePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDataSourcePermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeDataSourcePermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
