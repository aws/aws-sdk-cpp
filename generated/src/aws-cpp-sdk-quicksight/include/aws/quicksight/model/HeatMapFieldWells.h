...
class HeatMapFieldWells {
 public:
  ...
  void SetHeatMapAggregatedFieldWells(HeatMapAggregatedFieldWellsT&& value) {
    m_heatMapAggregatedFieldWellsHasBeenSet = true;
    m_heatMapAggregatedFieldWells = std::forward<HeatMapAggregatedFieldWellsT>(value);
  }
  template <typename HeatMapAggregatedFieldWellsT = HeatMapAggregatedFieldWells>
  HeatMapFieldWells& WithHeatMapAggregatedFieldWells(HeatMapAggregatedFieldWellsT&& value) {
    SetHeatMapAggregatedFieldWells(std::forward<HeatMapAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
