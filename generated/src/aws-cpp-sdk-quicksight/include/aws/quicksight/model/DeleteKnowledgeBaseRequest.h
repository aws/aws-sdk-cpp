...
/**
 */
class DeleteKnowledgeBaseRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DeleteKnowledgeBaseRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteKnowledgeBaseRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  DeleteKnowledgeBaseRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
