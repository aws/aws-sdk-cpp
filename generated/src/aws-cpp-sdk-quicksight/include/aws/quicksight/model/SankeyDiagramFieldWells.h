...
class SankeyDiagramFieldWells {
 public:
   ...
   */
  inline const SankeyDiagramAggregatedFieldWells& GetSankeyDiagramAggregatedFieldWells() const {
    return m_sankeyDiagramAggregatedFieldWells;
  }
  ...
  void SetSankeyDiagramAggregatedFieldWells(SankeyDiagramAggregatedFieldWellsT&& value) {
    m_sankeyDiagramAggregatedFieldWellsHasBeenSet = true;
    m_sankeyDiagramAggregatedFieldWells = std::forward<SankeyDiagramAggregatedFieldWellsT>(value);
  }
  template <typename SankeyDiagramAggregatedFieldWellsT = SankeyDiagramAggregatedFieldWells>
  SankeyDiagramFieldWells& WithSankeyDiagramAggregatedFieldWells(SankeyDiagramAggregatedFieldWellsT&& value) {
    SetSankeyDiagramAggregatedFieldWells(std::forward<SankeyDiagramAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
