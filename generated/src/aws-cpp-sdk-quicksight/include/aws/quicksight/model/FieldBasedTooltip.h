...
class FieldBasedTooltip {
 public:
  ...
  inline void SetAggregationVisibility(Visibility value) {
    m_aggregationVisibilityHasBeenSet = true;
    m_aggregationVisibility = value;
  }
  inline FieldBasedTooltip& WithAggregationVisibility(Visibility value) {
    SetAggregationVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTooltipTitleType(TooltipTitleType value) {
    m_tooltipTitleTypeHasBeenSet = true;
    m_tooltipTitleType = value;
  }
  inline FieldBasedTooltip& WithTooltipTitleType(TooltipTitleType value) {
    SetTooltipTitleType(value);
    return *this;
  }
  ///@}
  ...
  void SetTooltipFields(TooltipFieldsT&& value) {
    m_tooltipFieldsHasBeenSet = true;
    m_tooltipFields = std::forward<TooltipFieldsT>(value);
  }
  template <typename TooltipFieldsT = Aws::Vector<TooltipItem>>
  FieldBasedTooltip& WithTooltipFields(TooltipFieldsT&& value) {
    SetTooltipFields(std::forward<TooltipFieldsT>(value));
    return *this;
  }
  template <typename TooltipFieldsT = TooltipItem>
  FieldBasedTooltip& AddTooltipFields(TooltipFieldsT&& value) {
    m_tooltipFieldsHasBeenSet = true;
    m_tooltipFields.emplace_back(std::forward<TooltipFieldsT>(value));
    return *this;
  }
  ///@}
 private:
