...
class GeospatialGradientColor {
 public:
  ...
  void SetStepColors(StepColorsT&& value) {
    m_stepColorsHasBeenSet = true;
    m_stepColors = std::forward<StepColorsT>(value);
  }
  template <typename StepColorsT = Aws::Vector<GeospatialGradientStepColor>>
  GeospatialGradientColor& WithStepColors(StepColorsT&& value) {
    SetStepColors(std::forward<StepColorsT>(value));
    return *this;
  }
  template <typename StepColorsT = GeospatialGradientStepColor>
  GeospatialGradientColor& AddStepColors(StepColorsT&& value) {
    m_stepColorsHasBeenSet = true;
    m_stepColors.emplace_back(std::forward<StepColorsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GeospatialGradientColor& WithNullDataVisibility(Visibility value) {
  ...
  template <typename NullDataSettingsT = GeospatialNullDataSettings>
  GeospatialGradientColor& WithNullDataSettings(NullDataSettingsT&& value) {
  ...
  inline GeospatialGradientColor& WithDefaultOpacity(double value) {
