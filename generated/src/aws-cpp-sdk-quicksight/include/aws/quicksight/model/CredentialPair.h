...
class CredentialPair {
 public:
  ...
  template <typename UsernameT = Aws::String>
  CredentialPair& WithUsername(UsernameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  CredentialPair& WithPassword(PasswordT&& value) {
  ...
  void SetAlternateDataSourceParameters(AlternateDataSourceParametersT&& value) {
    ...
    m_alternateDataSourceParameters = std::forward<AlternateDataSourceParametersT>(value);
  }
  template <typename AlternateDataSourceParametersT = Aws::Vector<DataSourceParameters>>
  CredentialPair& WithAlternateDataSourceParameters(AlternateDataSourceParametersT&& value) {
    SetAlternateDataSourceParameters(std::forward<AlternateDataSourceParametersT>(value));
    return *this;
  }
  template <typename AlternateDataSourceParametersT = DataSourceParameters>
  CredentialPair& AddAlternateDataSourceParameters(AlternateDataSourceParametersT&& value) {
    m_alternateDataSourceParametersHasBeenSet = true;
    m_alternateDataSourceParameters.emplace_back(std::forward<AlternateDataSourceParametersT>(value));
    return *this;
  }
  ///@}
 private:
