...
class DescribeDefaultQBusinessApplicationResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeDefaultQBusinessApplicationResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDefaultQBusinessApplicationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeDefaultQBusinessApplicationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationIdT = Aws::String>
  DescribeDefaultQBusinessApplicationResult& WithApplicationId(ApplicationIdT&& value) {
