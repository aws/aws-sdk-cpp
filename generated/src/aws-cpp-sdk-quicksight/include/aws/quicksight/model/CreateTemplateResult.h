...
class CreateTemplateResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename VersionArnT = Aws::String>
  CreateTemplateResult& WithVersionArn(VersionArnT&& value) {
  ...
  inline CreateTemplateResult& WithCreationStatus(ResourceStatus value) {
  ...
  inline CreateTemplateResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
