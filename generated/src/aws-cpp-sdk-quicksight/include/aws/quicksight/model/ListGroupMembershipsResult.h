...
class ListGroupMembershipsResult {
 public:
  ...
  void SetGroupMemberList(GroupMemberListT&& value) {
    m_groupMemberListHasBeenSet = true;
    m_groupMemberList = std::forward<GroupMemberListT>(value);
  }
  template <typename GroupMemberListT = Aws::Vector<GroupMember>>
  ListGroupMembershipsResult& WithGroupMemberList(GroupMemberListT&& value) {
    SetGroupMemberList(std::forward<GroupMemberListT>(value));
    return *this;
  }
  template <typename GroupMemberListT = GroupMember>
  ListGroupMembershipsResult& AddGroupMemberList(GroupMemberListT&& value) {
    m_groupMemberListHasBeenSet = true;
    m_groupMemberList.emplace_back(std::forward<GroupMemberListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupMembershipsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGroupMembershipsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline ListGroupMembershipsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
