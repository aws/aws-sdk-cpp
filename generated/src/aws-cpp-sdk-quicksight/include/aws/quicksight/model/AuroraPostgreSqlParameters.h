...
class AuroraPostgreSqlParameters {
 public:
  ...
  template <typename HostT = Aws::String>
  AuroraPostgreSqlParameters& WithHost(HostT&& value) {
  ...
  inline AuroraPostgreSqlParameters& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseT = Aws::String>
  AuroraPostgreSqlParameters& WithDatabase(DatabaseT&& value) {
