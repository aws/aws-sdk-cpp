...
class RestoreAnalysisResult {
 public:
  ...
  inline RestoreAnalysisResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRestorationFailedFolderArns(RestorationFailedFolderArnsT&& value) {
    ...
    m_restorationFailedFolderArns = std::forward<RestorationFailedFolderArnsT>(value);
  }
  template <typename RestorationFailedFolderArnsT = Aws::Vector<Aws::String>>
  RestoreAnalysisResult& WithRestorationFailedFolderArns(RestorationFailedFolderArnsT&& value) {
    SetRestorationFailedFolderArns(std::forward<RestorationFailedFolderArnsT>(value));
    return *this;
  }
  ...
  RestoreAnalysisResult& AddRestorationFailedFolderArns(RestorationFailedFolderArnsT&& value) {
    m_restorationFailedFolderArnsHasBeenSet = true;
    m_restorationFailedFolderArns.emplace_back(std::forward<RestorationFailedFolderArnsT>(value));
    return *this;
  }
  ///@}
 private:
