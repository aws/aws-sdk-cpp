...
class TopicCategoryFilter {
 public:
  ...
  inline void SetCategoryFilterFunction(CategoryFilterFunction value) {
    m_categoryFilterFunctionHasBeenSet = true;
    m_categoryFilterFunction = value;
  }
  inline TopicCategoryFilter& WithCategoryFilterFunction(CategoryFilterFunction value) {
    SetCategoryFilterFunction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategoryFilterType(CategoryFilterType value) {
    m_categoryFilterTypeHasBeenSet = true;
    m_categoryFilterType = value;
  }
  inline TopicCategoryFilter& WithCategoryFilterType(CategoryFilterType value) {
  ...
  template <typename ConstantT = TopicCategoryFilterConstant>
  TopicCategoryFilter& WithConstant(ConstantT&& value) {
  ...
  inline TopicCategoryFilter& WithInverse(bool value) {
    SetInverse(value);
    return *this;
  }
  ///@}
