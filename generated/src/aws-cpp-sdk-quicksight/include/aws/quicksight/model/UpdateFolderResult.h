...
class UpdateFolderResult {
 public:
  AWS_QUICKSIGHT_API UpdateFolderResult() = default;
  ...
  inline UpdateFolderResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  UpdateFolderResult& WithArn(ArnT&& value) {
  ...
  template <typename FolderIdT = Aws::String>
  UpdateFolderResult& WithFolderId(FolderIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFolderResult& WithRequestId(RequestIdT&& value) {
