...
namespace Model
{
  ...
  /**
   * <p>An internal failure occurred.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/InternalFailureException">AWS
   * API Reference</a></p>
   */
  ...
  public:
     ...
     * <p>The Amazon Web Services request ID for this request.</p>
     */
    inline InternalFailureException& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    /**
     * <p>The Amazon Web Services request ID for this request.</p>
     */
    inline InternalFailureException& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    /**
     * <p>The Amazon Web Services request ID for this request.</p>
     */
    inline InternalFailureException& WithRequestId(const char* value) { SetRequestId(value); return *this;}
