...
namespace Model
{
  ...
  public:
    ...
    template<typename BucketT = Aws::String>
    ManifestFileLocation& WithBucket(BucketT&& value) { SetBucket(std::forward<BucketT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyT = Aws::String>
    ManifestFileLocation& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
  private:
