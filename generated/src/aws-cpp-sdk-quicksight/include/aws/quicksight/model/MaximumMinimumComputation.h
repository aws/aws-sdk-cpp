...
class MaximumMinimumComputation {
 public:
  ...
  template <typename ComputationIdT = Aws::String>
  MaximumMinimumComputation& WithComputationId(ComputationIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  MaximumMinimumComputation& WithName(NameT&& value) {
  ...
  template <typename TimeT = DimensionField>
  MaximumMinimumComputation& WithTime(TimeT&& value) {
  ...
  template <typename ValueT = MeasureField>
  MaximumMinimumComputation& WithValue(ValueT&& value) {
  ...
  inline void SetType(MaximumMinimumComputationType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MaximumMinimumComputation& WithType(MaximumMinimumComputationType value) {
    SetType(value);
    return *this;
  }
  ///@}
