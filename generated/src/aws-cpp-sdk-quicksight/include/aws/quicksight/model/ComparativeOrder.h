...
class ComparativeOrder {
 public:
  ...
  inline void SetUseOrdering(ColumnOrderingType value) {
    m_useOrderingHasBeenSet = true;
    m_useOrdering = value;
  }
  inline ComparativeOrder& WithUseOrdering(ColumnOrderingType value) {
    SetUseOrdering(value);
    return *this;
  }
  ///@}
  ...
  void SetSpecifedOrder(SpecifedOrderT&& value) {
    m_specifedOrderHasBeenSet = true;
    m_specifedOrder = std::forward<SpecifedOrderT>(value);
  }
  template <typename SpecifedOrderT = Aws::Vector<Aws::String>>
  ComparativeOrder& WithSpecifedOrder(SpecifedOrderT&& value) {
    SetSpecifedOrder(std::forward<SpecifedOrderT>(value));
    return *this;
  }
  template <typename SpecifedOrderT = Aws::String>
  ComparativeOrder& AddSpecifedOrder(SpecifedOrderT&& value) {
    m_specifedOrderHasBeenSet = true;
    m_specifedOrder.emplace_back(std::forward<SpecifedOrderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTreatUndefinedSpecifiedValues(UndefinedSpecifiedValueType value) {
    m_treatUndefinedSpecifiedValuesHasBeenSet = true;
    m_treatUndefinedSpecifiedValues = value;
  }
  inline ComparativeOrder& WithTreatUndefinedSpecifiedValues(UndefinedSpecifiedValueType value) {
    SetTreatUndefinedSpecifiedValues(value);
    return *this;
  }
  ///@}
 private:
