...
class SheetDefinition {
 public:
  ...
  void SetParameterControls(ParameterControlsT&& value) {
    ...
    m_parameterControls = std::forward<ParameterControlsT>(value);
  }
  template <typename ParameterControlsT = Aws::Vector<ParameterControl>>
  SheetDefinition& WithParameterControls(ParameterControlsT&& value) {
    SetParameterControls(std::forward<ParameterControlsT>(value));
    return *this;
  }
  template <typename ParameterControlsT = ParameterControl>
  SheetDefinition& AddParameterControls(ParameterControlsT&& value) {
    m_parameterControlsHasBeenSet = true;
    m_parameterControls.emplace_back(std::forward<ParameterControlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilterControls(FilterControlsT&& value) {
    ...
    m_filterControls = std::forward<FilterControlsT>(value);
  }
  template <typename FilterControlsT = Aws::Vector<FilterControl>>
  SheetDefinition& WithFilterControls(FilterControlsT&& value) {
    SetFilterControls(std::forward<FilterControlsT>(value));
    return *this;
  }
  template <typename FilterControlsT = FilterControl>
  SheetDefinition& AddFilterControls(FilterControlsT&& value) {
    m_filterControlsHasBeenSet = true;
    m_filterControls.emplace_back(std::forward<FilterControlsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSheetControlLayouts(SheetControlLayoutsT&& value) {
    ...
    m_sheetControlLayouts = std::forward<SheetControlLayoutsT>(value);
  }
  template <typename SheetControlLayoutsT = Aws::Vector<SheetControlLayout>>
  SheetDefinition& WithSheetControlLayouts(SheetControlLayoutsT&& value) {
    SetSheetControlLayouts(std::forward<SheetControlLayoutsT>(value));
    return *this;
  }
  ...
  SheetDefinition& AddSheetControlLayouts(SheetControlLayoutsT&& value) {
    m_sheetControlLayoutsHasBeenSet = true;
    m_sheetControlLayouts.emplace_back(std::forward<SheetControlLayoutsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContentType(SheetContentType value) {
    m_contentTypeHasBeenSet = true;
    m_contentType = value;
  }
  inline SheetDefinition& WithContentType(SheetContentType value) {
