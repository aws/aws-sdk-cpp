...
class ListUsersResult {
 public:
  ...
  void SetUserList(UserListT&& value) {
    m_userListHasBeenSet = true;
    m_userList = std::forward<UserListT>(value);
  }
  template <typename UserListT = Aws::Vector<User>>
  ListUsersResult& WithUserList(UserListT&& value) {
    SetUserList(std::forward<UserListT>(value));
    return *this;
  }
  template <typename UserListT = User>
  ListUsersResult& AddUserList(UserListT&& value) {
    m_userListHasBeenSet = true;
    m_userList.emplace_back(std::forward<UserListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListUsersResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
