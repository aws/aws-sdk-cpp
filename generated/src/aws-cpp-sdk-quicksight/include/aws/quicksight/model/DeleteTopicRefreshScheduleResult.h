...
namespace Model
{
  ...
  public:
    ...
    template<typename TopicIdT = Aws::String>
    DeleteTopicRefreshScheduleResult& WithTopicId(TopicIdT&& value) { SetTopicId(std::forward<TopicIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TopicArnT = Aws::String>
    DeleteTopicRefreshScheduleResult& WithTopicArn(TopicArnT&& value) { SetTopicArn(std::forward<TopicArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DatasetArnT = Aws::String>
    DeleteTopicRefreshScheduleResult& WithDatasetArn(DatasetArnT&& value) { SetDatasetArn(std::forward<DatasetArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTopicRefreshScheduleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
