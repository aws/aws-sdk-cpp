...
class AssetBundleImportJobDataSourceCredentialPair {
 public:
  AWS_QUICKSIGHT_API AssetBundleImportJobDataSourceCredentialPair() = default;
  ...
  template <typename UsernameT = Aws::String>
  AssetBundleImportJobDataSourceCredentialPair& WithUsername(UsernameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  AssetBundleImportJobDataSourceCredentialPair& WithPassword(PasswordT&& value) {
