...
class UpdateRefreshScheduleRequest : public QuickSightRequest {
 public:
  ...
  template <typename DataSetIdT = Aws::String>
  UpdateRefreshScheduleRequest& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  UpdateRefreshScheduleRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename ScheduleT = RefreshSchedule>
  UpdateRefreshScheduleRequest& WithSchedule(ScheduleT&& value) {
