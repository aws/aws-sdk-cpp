...
class CreateActionConnectorResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateActionConnectorResult& WithArn(ArnT&& value) {
  ...
  inline CreateActionConnectorResult& WithCreationStatus(ResourceStatus value) {
  ...
  template <typename ActionConnectorIdT = Aws::String>
  CreateActionConnectorResult& WithActionConnectorId(ActionConnectorIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateActionConnectorResult& WithRequestId(RequestIdT&& value) {
  ...
  inline CreateActionConnectorResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
