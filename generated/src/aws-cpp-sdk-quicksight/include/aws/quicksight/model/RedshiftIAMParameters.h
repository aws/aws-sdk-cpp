...
/**
 * <p>A structure that grants Quick Sight access to your cluster and make a call to
...
class RedshiftIAMParameters {
 public:
  ...
  ///@{
  /**
   * <p>Use the <code>RoleArn</code> structure to allow Quick Sight to call
   * <code>redshift:GetClusterCredentials</code> on your cluster. The calling
   * principal must have <code>iam:PassRole</code> access to pass the role to Quick
   * Sight. The role's trust policy must allow the Quick Sight service principal to
   * assume the role.</p>
   */
  ...
  template <typename RoleArnT = Aws::String>
  RedshiftIAMParameters& WithRoleArn(RoleArnT&& value) {
  ...
  ///@{
  /**
   * <p>The user whose permissions and group memberships will be used by Quick Sight
  ...
  void SetDatabaseUser(DatabaseUserT&& value) {
    ...
    m_databaseUser = std::forward<DatabaseUserT>(value);
  }
  template <typename DatabaseUserT = Aws::String>
  RedshiftIAMParameters& WithDatabaseUser(DatabaseUserT&& value) {
    SetDatabaseUser(std::forward<DatabaseUserT>(value));
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>A list of groups whose permissions will be granted to Quick Sight to access
   * the cluster. These permissions are combined with the permissions granted to
   * Quick Sight by the <code>DatabaseUser</code>. If you choose to include this
  ...
  void SetDatabaseGroups(DatabaseGroupsT&& value) {
    m_databaseGroupsHasBeenSet = true;
    m_databaseGroups = std::forward<DatabaseGroupsT>(value);
  }
  template <typename DatabaseGroupsT = Aws::Vector<Aws::String>>
  RedshiftIAMParameters& WithDatabaseGroups(DatabaseGroupsT&& value) {
    SetDatabaseGroups(std::forward<DatabaseGroupsT>(value));
    return *this;
  }
  template <typename DatabaseGroupsT = Aws::String>
  RedshiftIAMParameters& AddDatabaseGroups(DatabaseGroupsT&& value) {
    m_databaseGroupsHasBeenSet = true;
    m_databaseGroups.emplace_back(std::forward<DatabaseGroupsT>(value));
    return *this;
  }
  ///@}
   ...
   * no <code>DatabaseUser</code>, Quick Sight can't connect to your cluster. The
  ...
  inline void SetAutoCreateDatabaseUser(bool value) {
    m_autoCreateDatabaseUserHasBeenSet = true;
    m_autoCreateDatabaseUser = value;
  }
  inline RedshiftIAMParameters& WithAutoCreateDatabaseUser(bool value) {
    SetAutoCreateDatabaseUser(value);
    return *this;
  }
  ///@}
 private:
