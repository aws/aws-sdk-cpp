...
class FilledMapFieldWells {
 public:
  ...
  void SetFilledMapAggregatedFieldWells(FilledMapAggregatedFieldWellsT&& value) {
    m_filledMapAggregatedFieldWellsHasBeenSet = true;
    m_filledMapAggregatedFieldWells = std::forward<FilledMapAggregatedFieldWellsT>(value);
  }
  template <typename FilledMapAggregatedFieldWellsT = FilledMapAggregatedFieldWells>
  FilledMapFieldWells& WithFilledMapAggregatedFieldWells(FilledMapAggregatedFieldWellsT&& value) {
    SetFilledMapAggregatedFieldWells(std::forward<FilledMapAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
