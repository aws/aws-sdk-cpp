...
class DescribeFolderResolvedPermissionsResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeFolderResolvedPermissionsResult& operator=(
  ...
  inline DescribeFolderResolvedPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FolderIdT = Aws::String>
  DescribeFolderResolvedPermissionsResult& WithFolderId(FolderIdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  DescribeFolderResolvedPermissionsResult& WithArn(ArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeFolderResolvedPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeFolderResolvedPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeFolderResolvedPermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFolderResolvedPermissionsResult& WithNextToken(NextTokenT&& value) {
