...
class OverrideDatasetParameterOperation {
 public:
  ...
  void SetNewParameterName(NewParameterNameT&& value) {
    ...
    m_newParameterName = std::forward<NewParameterNameT>(value);
  }
  template <typename NewParameterNameT = Aws::String>
  OverrideDatasetParameterOperation& WithNewParameterName(NewParameterNameT&& value) {
    SetNewParameterName(std::forward<NewParameterNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewDefaultValues(NewDefaultValuesT&& value) {
    ...
    m_newDefaultValues = std::forward<NewDefaultValuesT>(value);
  }
  template <typename NewDefaultValuesT = NewDefaultValues>
  OverrideDatasetParameterOperation& WithNewDefaultValues(NewDefaultValuesT&& value) {
    SetNewDefaultValues(std::forward<NewDefaultValuesT>(value));
    return *this;
  }
  ///@}
 private:
