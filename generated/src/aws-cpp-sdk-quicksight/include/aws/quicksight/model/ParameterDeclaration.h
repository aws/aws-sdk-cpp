...
class ParameterDeclaration {
 public:
  ...
  void SetStringParameterDeclaration(StringParameterDeclarationT&& value) {
    ...
    m_stringParameterDeclaration = std::forward<StringParameterDeclarationT>(value);
  }
  template <typename StringParameterDeclarationT = StringParameterDeclaration>
  ParameterDeclaration& WithStringParameterDeclaration(StringParameterDeclarationT&& value) {
    SetStringParameterDeclaration(std::forward<StringParameterDeclarationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalParameterDeclaration(DecimalParameterDeclarationT&& value) {
    ...
    m_decimalParameterDeclaration = std::forward<DecimalParameterDeclarationT>(value);
  }
  template <typename DecimalParameterDeclarationT = DecimalParameterDeclaration>
  ParameterDeclaration& WithDecimalParameterDeclaration(DecimalParameterDeclarationT&& value) {
    SetDecimalParameterDeclaration(std::forward<DecimalParameterDeclarationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegerParameterDeclaration(IntegerParameterDeclarationT&& value) {
    ...
    m_integerParameterDeclaration = std::forward<IntegerParameterDeclarationT>(value);
  }
  template <typename IntegerParameterDeclarationT = IntegerParameterDeclaration>
  ParameterDeclaration& WithIntegerParameterDeclaration(IntegerParameterDeclarationT&& value) {
    SetIntegerParameterDeclaration(std::forward<IntegerParameterDeclarationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateTimeParameterDeclaration(DateTimeParameterDeclarationT&& value) {
    ...
    m_dateTimeParameterDeclaration = std::forward<DateTimeParameterDeclarationT>(value);
  }
  template <typename DateTimeParameterDeclarationT = DateTimeParameterDeclaration>
  ParameterDeclaration& WithDateTimeParameterDeclaration(DateTimeParameterDeclarationT&& value) {
    SetDateTimeParameterDeclaration(std::forward<DateTimeParameterDeclarationT>(value));
    return *this;
  }
  ///@}
 private:
