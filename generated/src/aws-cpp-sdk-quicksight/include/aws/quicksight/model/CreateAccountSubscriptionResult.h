...
class CreateAccountSubscriptionResult {
 public:
  ...
  void SetSignupResponse(SignupResponseT&& value) {
    m_signupResponseHasBeenSet = true;
    m_signupResponse = std::forward<SignupResponseT>(value);
  }
  template <typename SignupResponseT = SignupResponse>
  CreateAccountSubscriptionResult& WithSignupResponse(SignupResponseT&& value) {
    SetSignupResponse(std::forward<SignupResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateAccountSubscriptionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateAccountSubscriptionResult& WithRequestId(RequestIdT&& value) {
