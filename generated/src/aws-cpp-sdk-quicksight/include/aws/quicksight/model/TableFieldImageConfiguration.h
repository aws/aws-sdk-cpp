...
class TableFieldImageConfiguration {
 public:
  ...
  void SetSizingOptions(SizingOptionsT&& value) {
    m_sizingOptionsHasBeenSet = true;
    m_sizingOptions = std::forward<SizingOptionsT>(value);
  }
  template <typename SizingOptionsT = TableCellImageSizingConfiguration>
  TableFieldImageConfiguration& WithSizingOptions(SizingOptionsT&& value) {
    SetSizingOptions(std::forward<SizingOptionsT>(value));
    return *this;
  }
  ///@}
 private:
