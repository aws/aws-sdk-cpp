...
class UpdateTemplateAliasResult {
 public:
  ...
  void SetTemplateAlias(TemplateAliasT&& value) {
    m_templateAliasHasBeenSet = true;
    m_templateAlias = std::forward<TemplateAliasT>(value);
  }
  template <typename TemplateAliasT = TemplateAlias>
  UpdateTemplateAliasResult& WithTemplateAlias(TemplateAliasT&& value) {
    SetTemplateAlias(std::forward<TemplateAliasT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateTemplateAliasResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTemplateAliasResult& WithRequestId(RequestIdT&& value) {
