...
namespace Model
{
  ...
  public:
    ...
    template<typename FieldIdT = Aws::String>
    NumericalMeasureField& WithFieldId(FieldIdT&& value) { SetFieldId(std::forward<FieldIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ColumnT = ColumnIdentifier>
    NumericalMeasureField& WithColumn(ColumnT&& value) { SetColumn(std::forward<ColumnT>(value)); return *this;}
    ///@}
    ...
    template<typename AggregationFunctionT = NumericalAggregationFunction>
    ...
    template<typename AggregationFunctionT = NumericalAggregationFunction>
    NumericalMeasureField& WithAggregationFunction(AggregationFunctionT&& value) { SetAggregationFunction(std::forward<AggregationFunctionT>(value)); return *this;}
    ///@}
    ...
    template<typename FormatConfigurationT = NumberFormatConfiguration>
    NumericalMeasureField& WithFormatConfiguration(FormatConfigurationT&& value) { SetFormatConfiguration(std::forward<FormatConfigurationT>(value)); return *this;}
    ///@}
  private:
