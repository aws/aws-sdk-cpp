...
class DescribeTemplateAliasResult {
 public:
  ...
  template <typename TemplateAliasT = TemplateAlias>
  DescribeTemplateAliasResult& WithTemplateAlias(TemplateAliasT&& value) {
  ...
  inline DescribeTemplateAliasResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTemplateAliasResult& WithRequestId(RequestIdT&& value) {
