...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API TeradataParameters() = default;
    ...
    template<typename HostT = Aws::String>
    TeradataParameters& WithHost(HostT&& value) { SetHost(std::forward<HostT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    TeradataParameters& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
  private:
