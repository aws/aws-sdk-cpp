...
class VisualSubtitleLabelOptions {
 public:
  ...
  inline VisualSubtitleLabelOptions& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetFormatText(FormatTextT&& value) {
    ...
    m_formatText = std::forward<FormatTextT>(value);
  }
  template <typename FormatTextT = LongFormatText>
  VisualSubtitleLabelOptions& WithFormatText(FormatTextT&& value) {
    SetFormatText(std::forward<FormatTextT>(value));
    return *this;
  }
  ///@}
 private:
