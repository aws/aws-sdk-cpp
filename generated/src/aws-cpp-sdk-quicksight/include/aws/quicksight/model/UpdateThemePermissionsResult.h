...
class UpdateThemePermissionsResult {
 public:
  ...
  template <typename ThemeIdT = Aws::String>
  UpdateThemePermissionsResult& WithThemeId(ThemeIdT&& value) {
  ...
  template <typename ThemeArnT = Aws::String>
  UpdateThemePermissionsResult& WithThemeArn(ThemeArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  UpdateThemePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  UpdateThemePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateThemePermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateThemePermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
