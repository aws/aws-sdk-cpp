...
class DropDownControlDisplayOptions {
 public:
  ...
  template <typename SelectAllOptionsT = ListControlSelectAllOptions>
  DropDownControlDisplayOptions& WithSelectAllOptions(SelectAllOptionsT&& value) {
  ...
  template <typename TitleOptionsT = LabelOptions>
  DropDownControlDisplayOptions& WithTitleOptions(TitleOptionsT&& value) {
  ...
  template <typename InfoIconLabelOptionsT = SheetControlInfoIconLabelOptions>
  DropDownControlDisplayOptions& WithInfoIconLabelOptions(InfoIconLabelOptionsT&& value) {
