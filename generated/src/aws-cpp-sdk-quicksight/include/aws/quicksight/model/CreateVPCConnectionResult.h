...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API CreateVPCConnectionResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreateVPCConnectionResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename VPCConnectionIdT = Aws::String>
    CreateVPCConnectionResult& WithVPCConnectionId(VPCConnectionIdT&& value) { SetVPCConnectionId(std::forward<VPCConnectionIdT>(value)); return *this;}
    ///@}
     ...
     */
    inline VPCConnectionResourceStatus GetCreationStatus() const { return m_creationStatus; }
    inline void SetCreationStatus(VPCConnectionResourceStatus value) { m_creationStatusHasBeenSet = true; m_creationStatus = value; }
    inline CreateVPCConnectionResult& WithCreationStatus(VPCConnectionResourceStatus value) { SetCreationStatus(value); return *this;}
    ///@}
    ...
    inline CreateVPCConnectionResult& WithAvailabilityStatus(VPCConnectionAvailabilityStatus value) { SetAvailabilityStatus(value); return *this;}
    ///@}
  ...
  private:
    ...
    VPCConnectionResourceStatus m_creationStatus{VPCConnectionResourceStatus::NOT_SET};
