...
class GaugeChartColorConfiguration {
 public:
  ...
  void SetForegroundColor(ForegroundColorT&& value) {
    m_foregroundColorHasBeenSet = true;
    m_foregroundColor = std::forward<ForegroundColorT>(value);
  }
  template <typename ForegroundColorT = Aws::String>
  GaugeChartColorConfiguration& WithForegroundColor(ForegroundColorT&& value) {
    SetForegroundColor(std::forward<ForegroundColorT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BackgroundColorT = Aws::String>
  GaugeChartColorConfiguration& WithBackgroundColor(BackgroundColorT&& value) {
