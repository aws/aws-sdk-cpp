...
class AssetOptions {
 public:
  ...
  inline void SetWeekStart(DayOfTheWeek value) {
    m_weekStartHasBeenSet = true;
    m_weekStart = value;
  }
  inline AssetOptions& WithWeekStart(DayOfTheWeek value) {
    SetWeekStart(value);
    return *this;
  }
  ///@}
  ...
  inline void SetQBusinessInsightsStatus(QBusinessInsightsStatus value) {
    m_qBusinessInsightsStatusHasBeenSet = true;
    m_qBusinessInsightsStatus = value;
  }
  inline AssetOptions& WithQBusinessInsightsStatus(QBusinessInsightsStatus value) {
    SetQBusinessInsightsStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludedDataSetArns(ExcludedDataSetArnsT&& value) {
    ...
    m_excludedDataSetArns = std::forward<ExcludedDataSetArnsT>(value);
  }
  template <typename ExcludedDataSetArnsT = Aws::Vector<Aws::String>>
  AssetOptions& WithExcludedDataSetArns(ExcludedDataSetArnsT&& value) {
    SetExcludedDataSetArns(std::forward<ExcludedDataSetArnsT>(value));
    return *this;
  }
  template <typename ExcludedDataSetArnsT = Aws::String>
  AssetOptions& AddExcludedDataSetArns(ExcludedDataSetArnsT&& value) {
    m_excludedDataSetArnsHasBeenSet = true;
    m_excludedDataSetArns.emplace_back(std::forward<ExcludedDataSetArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomActionDefaults(CustomActionDefaultsT&& value) {
    ...
    m_customActionDefaults = std::forward<CustomActionDefaultsT>(value);
  }
  template <typename CustomActionDefaultsT = VisualCustomActionDefaults>
  AssetOptions& WithCustomActionDefaults(CustomActionDefaultsT&& value) {
    SetCustomActionDefaults(std::forward<CustomActionDefaultsT>(value));
    return *this;
  }
  ///@}
 private:
