...
class SheetImage {
 public:
  ...
  void SetSheetImageId(SheetImageIdT&& value) {
    ...
    m_sheetImageId = std::forward<SheetImageIdT>(value);
  }
  template <typename SheetImageIdT = Aws::String>
  SheetImage& WithSheetImageId(SheetImageIdT&& value) {
    SetSheetImageId(std::forward<SheetImageIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScaling(ScalingT&& value) {
    ...
    m_scaling = std::forward<ScalingT>(value);
  }
  template <typename ScalingT = SheetImageScalingConfiguration>
  SheetImage& WithScaling(ScalingT&& value) {
    SetScaling(std::forward<ScalingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImageContentAltText(ImageContentAltTextT&& value) {
    ...
    m_imageContentAltText = std::forward<ImageContentAltTextT>(value);
  }
  template <typename ImageContentAltTextT = Aws::String>
  SheetImage& WithImageContentAltText(ImageContentAltTextT&& value) {
    SetImageContentAltText(std::forward<ImageContentAltTextT>(value));
    return *this;
  }
  ///@}
