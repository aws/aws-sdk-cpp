...
class FilterOperationTargetVisualsConfiguration {
 public:
   ...
   * filtered.</p>
   */
  inline const SameSheetTargetVisualConfiguration& GetSameSheetTargetVisualConfiguration() const {
    return m_sameSheetTargetVisualConfiguration;
  }
  ...
  void SetSameSheetTargetVisualConfiguration(SameSheetTargetVisualConfigurationT&& value) {
    m_sameSheetTargetVisualConfigurationHasBeenSet = true;
    m_sameSheetTargetVisualConfiguration = std::forward<SameSheetTargetVisualConfigurationT>(value);
  }
  template <typename SameSheetTargetVisualConfigurationT = SameSheetTargetVisualConfiguration>
  FilterOperationTargetVisualsConfiguration& WithSameSheetTargetVisualConfiguration(SameSheetTargetVisualConfigurationT&& value) {
    SetSameSheetTargetVisualConfiguration(std::forward<SameSheetTargetVisualConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
