...
class DeleteVPCConnectionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DeleteVPCConnectionResult& WithArn(ArnT&& value) {
  ...
  template <typename VPCConnectionIdT = Aws::String>
  DeleteVPCConnectionResult& WithVPCConnectionId(VPCConnectionIdT&& value) {
  ...
  inline void SetDeletionStatus(VPCConnectionResourceStatus value) {
    m_deletionStatusHasBeenSet = true;
    m_deletionStatus = value;
  }
  inline DeleteVPCConnectionResult& WithDeletionStatus(VPCConnectionResourceStatus value) {
  ...
  inline DeleteVPCConnectionResult& WithAvailabilityStatus(VPCConnectionAvailabilityStatus value) {
  ...
  inline DeleteVPCConnectionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
