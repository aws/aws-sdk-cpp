...
class PieChartFieldWells {
 public:
  ...
  void SetPieChartAggregatedFieldWells(PieChartAggregatedFieldWellsT&& value) {
    ...
    m_pieChartAggregatedFieldWells = std::forward<PieChartAggregatedFieldWellsT>(value);
  }
  template <typename PieChartAggregatedFieldWellsT = PieChartAggregatedFieldWells>
  PieChartFieldWells& WithPieChartAggregatedFieldWells(PieChartAggregatedFieldWellsT&& value) {
    SetPieChartAggregatedFieldWells(std::forward<PieChartAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
