...
namespace Model {
class SearchAgentsResult {
 public:
  AWS_QUICKSIGHT_API SearchAgentsResult() = default;
  AWS_QUICKSIGHT_API SearchAgentsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API SearchAgentsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AgentSummariesT = Aws::Vector<AgentSummary>>
  SearchAgentsResult& WithAgentSummaries(AgentSummariesT&& value) {
    SetAgentSummaries(std::forward<AgentSummariesT>(value));
    return *this;
  }
  template <typename AgentSummariesT = AgentSummary>
  SearchAgentsResult& AddAgentSummaries(AgentSummariesT&& value) {
    m_agentSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchAgentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchAgentsResult& WithRequestId(RequestIdT&& value) {
