...
class UpdateFolderPermissionsResult {
 public:
  ...
  inline UpdateFolderPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  UpdateFolderPermissionsResult& WithArn(ArnT&& value) {
  ...
  template <typename FolderIdT = Aws::String>
  UpdateFolderPermissionsResult& WithFolderId(FolderIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  UpdateFolderPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  UpdateFolderPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFolderPermissionsResult& WithRequestId(RequestIdT&& value) {
