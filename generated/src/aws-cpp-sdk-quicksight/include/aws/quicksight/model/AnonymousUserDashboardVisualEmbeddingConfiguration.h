...
class AnonymousUserDashboardVisualEmbeddingConfiguration {
 public:
  ...
  void SetInitialDashboardVisualId(InitialDashboardVisualIdT&& value) {
    m_initialDashboardVisualIdHasBeenSet = true;
    m_initialDashboardVisualId = std::forward<InitialDashboardVisualIdT>(value);
  }
  template <typename InitialDashboardVisualIdT = DashboardVisualId>
  AnonymousUserDashboardVisualEmbeddingConfiguration& WithInitialDashboardVisualId(InitialDashboardVisualIdT&& value) {
    SetInitialDashboardVisualId(std::forward<InitialDashboardVisualIdT>(value));
    return *this;
  }
  ///@}
 private:
