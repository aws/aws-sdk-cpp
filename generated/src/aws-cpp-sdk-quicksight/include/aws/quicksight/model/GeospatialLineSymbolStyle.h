...
class GeospatialLineSymbolStyle {
 public:
  ...
  void SetFillColor(FillColorT&& value) {
    ...
    m_fillColor = std::forward<FillColorT>(value);
  }
  template <typename FillColorT = GeospatialColor>
  GeospatialLineSymbolStyle& WithFillColor(FillColorT&& value) {
    SetFillColor(std::forward<FillColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineWidth(LineWidthT&& value) {
    ...
    m_lineWidth = std::forward<LineWidthT>(value);
  }
  template <typename LineWidthT = GeospatialLineWidth>
  GeospatialLineSymbolStyle& WithLineWidth(LineWidthT&& value) {
    SetLineWidth(std::forward<LineWidthT>(value));
    return *this;
  }
  ///@}
 private:
