...
class DescribeActionConnectorPermissionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeActionConnectorPermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename ActionConnectorIdT = Aws::String>
  DescribeActionConnectorPermissionsRequest& WithActionConnectorId(ActionConnectorIdT&& value) {
