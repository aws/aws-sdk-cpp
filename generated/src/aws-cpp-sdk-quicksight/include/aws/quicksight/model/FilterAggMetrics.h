...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API FilterAggMetrics();
    ...
    inline void SetMetricOperand(const Identifier& value) { m_metricOperandHasBeenSet = true; m_metricOperand = value; }
    inline void SetMetricOperand(Identifier&& value) { m_metricOperandHasBeenSet = true; m_metricOperand = std::move(value); }
    inline FilterAggMetrics& WithMetricOperand(const Identifier& value) { SetMetricOperand(value); return *this;}
    inline FilterAggMetrics& WithMetricOperand(Identifier&& value) { SetMetricOperand(std::move(value)); return *this;}
    ///@}
     ...
     */
    inline const AggType& GetFunction() const{ return m_function; }
    inline bool FunctionHasBeenSet() const { return m_functionHasBeenSet; }
    inline void SetFunction(const AggType& value) { m_functionHasBeenSet = true; m_function = value; }
    inline void SetFunction(AggType&& value) { m_functionHasBeenSet = true; m_function = std::move(value); }
    inline FilterAggMetrics& WithFunction(const AggType& value) { SetFunction(value); return *this;}
    inline FilterAggMetrics& WithFunction(AggType&& value) { SetFunction(std::move(value)); return *this;}
    ///@}
    ...
    inline FilterAggMetrics& WithSortDirection(const TopicSortDirection& value) { SetSortDirection(value); return *this;}
    inline FilterAggMetrics& WithSortDirection(TopicSortDirection&& value) { SetSortDirection(std::move(value)); return *this;}
    ///@}
  private:
