...
class FilterAggMetrics {
 public:
  ...
  void SetMetricOperand(MetricOperandT&& value) {
    m_metricOperandHasBeenSet = true;
    m_metricOperand = std::forward<MetricOperandT>(value);
  }
  template <typename MetricOperandT = Identifier>
  FilterAggMetrics& WithMetricOperand(MetricOperandT&& value) {
    SetMetricOperand(std::forward<MetricOperandT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFunction(AggType value) {
    m_functionHasBeenSet = true;
    m_function = value;
  }
  inline FilterAggMetrics& WithFunction(AggType value) {
    SetFunction(value);
    return *this;
  }
  ///@}
  ...
  inline FilterAggMetrics& WithSortDirection(TopicSortDirection value) {
