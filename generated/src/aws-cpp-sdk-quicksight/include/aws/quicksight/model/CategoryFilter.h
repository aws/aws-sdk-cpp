 ...
 * text filters</a> in the <i>Amazon Quick Suite User Guide</i>.</p><p><h3>See
 * Also:</h3>   <a
...
class CategoryFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  CategoryFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  CategoryFilter& WithColumn(ColumnT&& value) {
  ...
  template <typename ConfigurationT = CategoryFilterConfiguration>
  CategoryFilter& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  CategoryFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
