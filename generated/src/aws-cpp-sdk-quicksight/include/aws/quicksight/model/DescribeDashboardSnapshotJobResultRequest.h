...
class DescribeDashboardSnapshotJobResultRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeDashboardSnapshotJobResultRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename DashboardIdT = Aws::String>
  DescribeDashboardSnapshotJobResultRequest& WithDashboardId(DashboardIdT&& value) {
  ...
  template <typename SnapshotJobIdT = Aws::String>
  DescribeDashboardSnapshotJobResultRequest& WithSnapshotJobId(SnapshotJobIdT&& value) {
