...
class CustomActionSetParametersOperation {
 public:
   ...
   */
  inline const Aws::Vector<SetParameterValueConfiguration>& GetParameterValueConfigurations() const {
    return m_parameterValueConfigurations;
  }
  ...
  void SetParameterValueConfigurations(ParameterValueConfigurationsT&& value) {
    m_parameterValueConfigurationsHasBeenSet = true;
    m_parameterValueConfigurations = std::forward<ParameterValueConfigurationsT>(value);
  }
  template <typename ParameterValueConfigurationsT = Aws::Vector<SetParameterValueConfiguration>>
  CustomActionSetParametersOperation& WithParameterValueConfigurations(ParameterValueConfigurationsT&& value) {
    SetParameterValueConfigurations(std::forward<ParameterValueConfigurationsT>(value));
    return *this;
  }
  ...
  CustomActionSetParametersOperation& AddParameterValueConfigurations(ParameterValueConfigurationsT&& value) {
    m_parameterValueConfigurationsHasBeenSet = true;
    m_parameterValueConfigurations.emplace_back(std::forward<ParameterValueConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
