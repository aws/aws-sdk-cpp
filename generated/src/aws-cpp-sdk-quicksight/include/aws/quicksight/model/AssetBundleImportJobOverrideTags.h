...
class AssetBundleImportJobOverrideTags {
 public:
  ...
  template <typename VPCConnectionsT = Aws::Vector<AssetBundleImportJobVPCConnectionOverrideTags>>
  AssetBundleImportJobOverrideTags& WithVPCConnections(VPCConnectionsT&& value) {
  ...
  AssetBundleImportJobOverrideTags& AddVPCConnections(VPCConnectionsT&& value) {
    m_vPCConnectionsHasBeenSet = true;
  ...
  template <typename DataSourcesT = Aws::Vector<AssetBundleImportJobDataSourceOverrideTags>>
  AssetBundleImportJobOverrideTags& WithDataSources(DataSourcesT&& value) {
    SetDataSources(std::forward<DataSourcesT>(value));
    return *this;
  }
  template <typename DataSourcesT = AssetBundleImportJobDataSourceOverrideTags>
  AssetBundleImportJobOverrideTags& AddDataSources(DataSourcesT&& value) {
    m_dataSourcesHasBeenSet = true;
  ...
  template <typename DataSetsT = Aws::Vector<AssetBundleImportJobDataSetOverrideTags>>
  AssetBundleImportJobOverrideTags& WithDataSets(DataSetsT&& value) {
    SetDataSets(std::forward<DataSetsT>(value));
    return *this;
  }
  template <typename DataSetsT = AssetBundleImportJobDataSetOverrideTags>
  AssetBundleImportJobOverrideTags& AddDataSets(DataSetsT&& value) {
    m_dataSetsHasBeenSet = true;
  ...
  template <typename ThemesT = Aws::Vector<AssetBundleImportJobThemeOverrideTags>>
  AssetBundleImportJobOverrideTags& WithThemes(ThemesT&& value) {
    SetThemes(std::forward<ThemesT>(value));
    return *this;
  }
  template <typename ThemesT = AssetBundleImportJobThemeOverrideTags>
  AssetBundleImportJobOverrideTags& AddThemes(ThemesT&& value) {
    m_themesHasBeenSet = true;
  ...
  template <typename AnalysesT = Aws::Vector<AssetBundleImportJobAnalysisOverrideTags>>
  AssetBundleImportJobOverrideTags& WithAnalyses(AnalysesT&& value) {
    SetAnalyses(std::forward<AnalysesT>(value));
    return *this;
  }
  template <typename AnalysesT = AssetBundleImportJobAnalysisOverrideTags>
  AssetBundleImportJobOverrideTags& AddAnalyses(AnalysesT&& value) {
    m_analysesHasBeenSet = true;
  ...
  template <typename DashboardsT = Aws::Vector<AssetBundleImportJobDashboardOverrideTags>>
  AssetBundleImportJobOverrideTags& WithDashboards(DashboardsT&& value) {
    SetDashboards(std::forward<DashboardsT>(value));
    return *this;
  }
  template <typename DashboardsT = AssetBundleImportJobDashboardOverrideTags>
  AssetBundleImportJobOverrideTags& AddDashboards(DashboardsT&& value) {
    m_dashboardsHasBeenSet = true;
  ...
  template <typename FoldersT = Aws::Vector<AssetBundleImportJobFolderOverrideTags>>
  AssetBundleImportJobOverrideTags& WithFolders(FoldersT&& value) {
    SetFolders(std::forward<FoldersT>(value));
    return *this;
  }
  template <typename FoldersT = AssetBundleImportJobFolderOverrideTags>
  AssetBundleImportJobOverrideTags& AddFolders(FoldersT&& value) {
    m_foldersHasBeenSet = true;
