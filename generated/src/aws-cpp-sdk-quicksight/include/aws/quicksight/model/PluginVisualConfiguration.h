...
class PluginVisualConfiguration {
 public:
  ...
  PluginVisualConfiguration& AddFieldWells(FieldWellsT&& value) {
    m_fieldWellsHasBeenSet = true;
    m_fieldWells.emplace_back(std::forward<FieldWellsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualOptions(VisualOptionsT&& value) {
    ...
    m_visualOptions = std::forward<VisualOptionsT>(value);
  }
  template <typename VisualOptionsT = PluginVisualOptions>
  PluginVisualConfiguration& WithVisualOptions(VisualOptionsT&& value) {
    SetVisualOptions(std::forward<VisualOptionsT>(value));
    return *this;
  }
  ///@}
