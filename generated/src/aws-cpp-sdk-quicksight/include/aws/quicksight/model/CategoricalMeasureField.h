...
class CategoricalMeasureField {
 public:
  ...
  inline void SetAggregationFunction(CategoricalAggregationFunction value) {
    m_aggregationFunctionHasBeenSet = true;
    m_aggregationFunction = value;
  }
  inline CategoricalMeasureField& WithAggregationFunction(CategoricalAggregationFunction value) {
