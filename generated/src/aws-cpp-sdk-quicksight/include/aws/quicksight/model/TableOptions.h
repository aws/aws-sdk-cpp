...
class TableOptions {
 public:
  ...
  inline void SetOrientation(TableOrientation value) {
    m_orientationHasBeenSet = true;
    m_orientation = value;
  }
  inline TableOptions& WithOrientation(TableOrientation value) {
  ...
  void SetHeaderStyle(HeaderStyleT&& value) {
    ...
    m_headerStyle = std::forward<HeaderStyleT>(value);
  }
  template <typename HeaderStyleT = TableCellStyle>
  TableOptions& WithHeaderStyle(HeaderStyleT&& value) {
    SetHeaderStyle(std::forward<HeaderStyleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCellStyle(CellStyleT&& value) {
    ...
    m_cellStyle = std::forward<CellStyleT>(value);
  }
  template <typename CellStyleT = TableCellStyle>
  TableOptions& WithCellStyle(CellStyleT&& value) {
    SetCellStyle(std::forward<CellStyleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRowAlternateColorOptions(RowAlternateColorOptionsT&& value) {
    ...
    m_rowAlternateColorOptions = std::forward<RowAlternateColorOptionsT>(value);
  }
  template <typename RowAlternateColorOptionsT = RowAlternateColorOptions>
  TableOptions& WithRowAlternateColorOptions(RowAlternateColorOptionsT&& value) {
    SetRowAlternateColorOptions(std::forward<RowAlternateColorOptionsT>(value));
    return *this;
  }
  ///@}
 private:
