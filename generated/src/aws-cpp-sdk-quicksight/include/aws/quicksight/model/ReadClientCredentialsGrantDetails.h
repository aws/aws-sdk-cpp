...
namespace Model
{
  ...
  /**
   * <p>Read-only configuration details for OAuth2 client credentials grant flow,
   * including client ID and token endpoint.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ReadClientCredentialsGrantDetails">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename ClientIdT = Aws::String>
    ReadClientCredentialsGrantDetails& WithClientId(ClientIdT&& value) { SetClientId(std::forward<ClientIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TokenEndpointT = Aws::String>
    ReadClientCredentialsGrantDetails& WithTokenEndpoint(TokenEndpointT&& value) { SetTokenEndpoint(std::forward<TokenEndpointT>(value)); return *this;}
    ///@}
  private:
