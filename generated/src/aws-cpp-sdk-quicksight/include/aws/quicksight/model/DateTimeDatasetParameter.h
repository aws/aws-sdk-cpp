...
class DateTimeDatasetParameter {
 public:
  ...
  inline void SetValueType(DatasetParameterValueType value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = value;
  }
  inline DateTimeDatasetParameter& WithValueType(DatasetParameterValueType value) {
    SetValueType(value);
    return *this;
  }
  ///@}
  ...
  inline DateTimeDatasetParameter& WithTimeGranularity(TimeGranularity value) {
