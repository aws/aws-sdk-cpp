...
class ForecastScenario {
 public:
  ...
  void SetWhatIfPointScenario(WhatIfPointScenarioT&& value) {
    ...
    m_whatIfPointScenario = std::forward<WhatIfPointScenarioT>(value);
  }
  template <typename WhatIfPointScenarioT = WhatIfPointScenario>
  ForecastScenario& WithWhatIfPointScenario(WhatIfPointScenarioT&& value) {
    SetWhatIfPointScenario(std::forward<WhatIfPointScenarioT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWhatIfRangeScenario(WhatIfRangeScenarioT&& value) {
    ...
    m_whatIfRangeScenario = std::forward<WhatIfRangeScenarioT>(value);
  }
  template <typename WhatIfRangeScenarioT = WhatIfRangeScenario>
  ForecastScenario& WithWhatIfRangeScenario(WhatIfRangeScenarioT&& value) {
    SetWhatIfRangeScenario(std::forward<WhatIfRangeScenarioT>(value));
    return *this;
  }
  ///@}
 private:
