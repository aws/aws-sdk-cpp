...
class GenerateEmbedUrlForAnonymousUserRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  GenerateEmbedUrlForAnonymousUserRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline GenerateEmbedUrlForAnonymousUserRequest& WithSessionLifetimeInMinutes(long long value) {
  ...
  template <typename NamespaceT = Aws::String>
  GenerateEmbedUrlForAnonymousUserRequest& WithNamespace(NamespaceT&& value) {
  ...
  ///@{
  /**
   * <p>Session tags are user-specified strings that identify a session in your
   * application. You can use these tags to implement row-level security (RLS)
   * controls. Before you use the <code>SessionTags</code> parameter, make sure that
   * you have configured the relevant datasets using the
   * <code>DataSet$RowLevelPermissionTagConfiguration</code> parameter so that
   * session tags can be used to provide row-level security.</p> <p>When using
   * <code>SessionTags</code> in <code>GenerateEmbedUrlForAnonymousUser</code>,</p>
   * <ul> <li> <p>Treat <code>SessionTags</code> as security credentials. Do not
   * expose <code>SessionTags</code> to end users or client-side code.</p> </li> <li>
   * <p>Implement server-side controls. Ensure that <code>SessionTags</code> are set
   * exclusively by your trusted backend services, not by parameters that end users
   * can modify.</p> </li> <li> <p>Protect <code>SessionTags</code> from enumeration.
   * Ensure that users in one tenant cannot discover or guess sessionTag values
   * belonging to other tenants.</p> </li> <li> <p>Review your architecture. If
   * downstream customers or partners are allowed to call the
   * <code>GenerateEmbedUrlForAnonymousUser</code> API directly, evaluate whether
  ...
  void SetSessionTags(SessionTagsT&& value) {
    m_sessionTagsHasBeenSet = true;
    m_sessionTags = std::forward<SessionTagsT>(value);
  }
  template <typename SessionTagsT = Aws::Vector<SessionTag>>
  GenerateEmbedUrlForAnonymousUserRequest& WithSessionTags(SessionTagsT&& value) {
    SetSessionTags(std::forward<SessionTagsT>(value));
    return *this;
  }
  template <typename SessionTagsT = SessionTag>
  GenerateEmbedUrlForAnonymousUserRequest& AddSessionTags(SessionTagsT&& value) {
    m_sessionTagsHasBeenSet = true;
    m_sessionTags.emplace_back(std::forward<SessionTagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizedResourceArns(AuthorizedResourceArnsT&& value) {
    m_authorizedResourceArnsHasBeenSet = true;
    m_authorizedResourceArns = std::forward<AuthorizedResourceArnsT>(value);
  }
  template <typename AuthorizedResourceArnsT = Aws::Vector<Aws::String>>
  GenerateEmbedUrlForAnonymousUserRequest& WithAuthorizedResourceArns(AuthorizedResourceArnsT&& value) {
    SetAuthorizedResourceArns(std::forward<AuthorizedResourceArnsT>(value));
    return *this;
  }
  template <typename AuthorizedResourceArnsT = Aws::String>
  GenerateEmbedUrlForAnonymousUserRequest& AddAuthorizedResourceArns(AuthorizedResourceArnsT&& value) {
    m_authorizedResourceArnsHasBeenSet = true;
    m_authorizedResourceArns.emplace_back(std::forward<AuthorizedResourceArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExperienceConfigurationT = AnonymousUserEmbeddingExperienceConfiguration>
  GenerateEmbedUrlForAnonymousUserRequest& WithExperienceConfiguration(ExperienceConfigurationT&& value) {
  ...
  template <typename AllowedDomainsT = Aws::Vector<Aws::String>>
  GenerateEmbedUrlForAnonymousUserRequest& WithAllowedDomains(AllowedDomainsT&& value) {
    SetAllowedDomains(std::forward<AllowedDomainsT>(value));
    return *this;
  }
  template <typename AllowedDomainsT = Aws::String>
  GenerateEmbedUrlForAnonymousUserRequest& AddAllowedDomains(AllowedDomainsT&& value) {
    m_allowedDomainsHasBeenSet = true;
