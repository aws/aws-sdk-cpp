...
class Visual {
 public:
  ...
  void SetTableVisual(TableVisualT&& value) {
    ...
    m_tableVisual = std::forward<TableVisualT>(value);
  }
  template <typename TableVisualT = TableVisual>
  Visual& WithTableVisual(TableVisualT&& value) {
    SetTableVisual(std::forward<TableVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPivotTableVisual(PivotTableVisualT&& value) {
    ...
    m_pivotTableVisual = std::forward<PivotTableVisualT>(value);
  }
  template <typename PivotTableVisualT = PivotTableVisual>
  Visual& WithPivotTableVisual(PivotTableVisualT&& value) {
    SetPivotTableVisual(std::forward<PivotTableVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBarChartVisual(BarChartVisualT&& value) {
    ...
    m_barChartVisual = std::forward<BarChartVisualT>(value);
  }
  template <typename BarChartVisualT = BarChartVisual>
  Visual& WithBarChartVisual(BarChartVisualT&& value) {
    SetBarChartVisual(std::forward<BarChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKPIVisual(KPIVisualT&& value) {
    ...
    m_kPIVisual = std::forward<KPIVisualT>(value);
  }
  template <typename KPIVisualT = KPIVisual>
  Visual& WithKPIVisual(KPIVisualT&& value) {
    SetKPIVisual(std::forward<KPIVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPieChartVisual(PieChartVisualT&& value) {
    ...
    m_pieChartVisual = std::forward<PieChartVisualT>(value);
  }
  template <typename PieChartVisualT = PieChartVisual>
  Visual& WithPieChartVisual(PieChartVisualT&& value) {
    SetPieChartVisual(std::forward<PieChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGaugeChartVisual(GaugeChartVisualT&& value) {
    ...
    m_gaugeChartVisual = std::forward<GaugeChartVisualT>(value);
  }
  template <typename GaugeChartVisualT = GaugeChartVisual>
  Visual& WithGaugeChartVisual(GaugeChartVisualT&& value) {
    SetGaugeChartVisual(std::forward<GaugeChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineChartVisual(LineChartVisualT&& value) {
    ...
    m_lineChartVisual = std::forward<LineChartVisualT>(value);
  }
  template <typename LineChartVisualT = LineChartVisual>
  Visual& WithLineChartVisual(LineChartVisualT&& value) {
    SetLineChartVisual(std::forward<LineChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeatMapVisual(HeatMapVisualT&& value) {
    ...
    m_heatMapVisual = std::forward<HeatMapVisualT>(value);
  }
  template <typename HeatMapVisualT = HeatMapVisual>
  Visual& WithHeatMapVisual(HeatMapVisualT&& value) {
    SetHeatMapVisual(std::forward<HeatMapVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTreeMapVisual(TreeMapVisualT&& value) {
    ...
    m_treeMapVisual = std::forward<TreeMapVisualT>(value);
  }
  template <typename TreeMapVisualT = TreeMapVisual>
  Visual& WithTreeMapVisual(TreeMapVisualT&& value) {
    SetTreeMapVisual(std::forward<TreeMapVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeospatialMapVisual(GeospatialMapVisualT&& value) {
    ...
    m_geospatialMapVisual = std::forward<GeospatialMapVisualT>(value);
  }
  template <typename GeospatialMapVisualT = GeospatialMapVisual>
  Visual& WithGeospatialMapVisual(GeospatialMapVisualT&& value) {
    SetGeospatialMapVisual(std::forward<GeospatialMapVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilledMapVisual(FilledMapVisualT&& value) {
    ...
    m_filledMapVisual = std::forward<FilledMapVisualT>(value);
  }
  template <typename FilledMapVisualT = FilledMapVisual>
  Visual& WithFilledMapVisual(FilledMapVisualT&& value) {
    SetFilledMapVisual(std::forward<FilledMapVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLayerMapVisual(LayerMapVisualT&& value) {
    ...
    m_layerMapVisual = std::forward<LayerMapVisualT>(value);
  }
  template <typename LayerMapVisualT = LayerMapVisual>
  Visual& WithLayerMapVisual(LayerMapVisualT&& value) {
    SetLayerMapVisual(std::forward<LayerMapVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunnelChartVisual(FunnelChartVisualT&& value) {
    ...
    m_funnelChartVisual = std::forward<FunnelChartVisualT>(value);
  }
  template <typename FunnelChartVisualT = FunnelChartVisual>
  Visual& WithFunnelChartVisual(FunnelChartVisualT&& value) {
    SetFunnelChartVisual(std::forward<FunnelChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScatterPlotVisual(ScatterPlotVisualT&& value) {
    ...
    m_scatterPlotVisual = std::forward<ScatterPlotVisualT>(value);
  }
  template <typename ScatterPlotVisualT = ScatterPlotVisual>
  Visual& WithScatterPlotVisual(ScatterPlotVisualT&& value) {
    SetScatterPlotVisual(std::forward<ScatterPlotVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetComboChartVisual(ComboChartVisualT&& value) {
    ...
    m_comboChartVisual = std::forward<ComboChartVisualT>(value);
  }
  template <typename ComboChartVisualT = ComboChartVisual>
  Visual& WithComboChartVisual(ComboChartVisualT&& value) {
    SetComboChartVisual(std::forward<ComboChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBoxPlotVisual(BoxPlotVisualT&& value) {
    ...
    m_boxPlotVisual = std::forward<BoxPlotVisualT>(value);
  }
  template <typename BoxPlotVisualT = BoxPlotVisual>
  Visual& WithBoxPlotVisual(BoxPlotVisualT&& value) {
    SetBoxPlotVisual(std::forward<BoxPlotVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWaterfallVisual(WaterfallVisualT&& value) {
    ...
    m_waterfallVisual = std::forward<WaterfallVisualT>(value);
  }
  template <typename WaterfallVisualT = WaterfallVisual>
  Visual& WithWaterfallVisual(WaterfallVisualT&& value) {
    SetWaterfallVisual(std::forward<WaterfallVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHistogramVisual(HistogramVisualT&& value) {
    ...
    m_histogramVisual = std::forward<HistogramVisualT>(value);
  }
  template <typename HistogramVisualT = HistogramVisual>
  Visual& WithHistogramVisual(HistogramVisualT&& value) {
    SetHistogramVisual(std::forward<HistogramVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWordCloudVisual(WordCloudVisualT&& value) {
    ...
    m_wordCloudVisual = std::forward<WordCloudVisualT>(value);
  }
  template <typename WordCloudVisualT = WordCloudVisual>
  Visual& WithWordCloudVisual(WordCloudVisualT&& value) {
    SetWordCloudVisual(std::forward<WordCloudVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInsightVisual(InsightVisualT&& value) {
    ...
    m_insightVisual = std::forward<InsightVisualT>(value);
  }
  template <typename InsightVisualT = InsightVisual>
  Visual& WithInsightVisual(InsightVisualT&& value) {
    SetInsightVisual(std::forward<InsightVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSankeyDiagramVisual(SankeyDiagramVisualT&& value) {
    ...
    m_sankeyDiagramVisual = std::forward<SankeyDiagramVisualT>(value);
  }
  template <typename SankeyDiagramVisualT = SankeyDiagramVisual>
  Visual& WithSankeyDiagramVisual(SankeyDiagramVisualT&& value) {
    SetSankeyDiagramVisual(std::forward<SankeyDiagramVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomContentVisual(CustomContentVisualT&& value) {
    ...
    m_customContentVisual = std::forward<CustomContentVisualT>(value);
  }
  template <typename CustomContentVisualT = CustomContentVisual>
  Visual& WithCustomContentVisual(CustomContentVisualT&& value) {
    SetCustomContentVisual(std::forward<CustomContentVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmptyVisual(EmptyVisualT&& value) {
    ...
    m_emptyVisual = std::forward<EmptyVisualT>(value);
  }
  template <typename EmptyVisualT = EmptyVisual>
  Visual& WithEmptyVisual(EmptyVisualT&& value) {
    SetEmptyVisual(std::forward<EmptyVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRadarChartVisual(RadarChartVisualT&& value) {
    ...
    m_radarChartVisual = std::forward<RadarChartVisualT>(value);
  }
  template <typename RadarChartVisualT = RadarChartVisual>
  Visual& WithRadarChartVisual(RadarChartVisualT&& value) {
    SetRadarChartVisual(std::forward<RadarChartVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPluginVisual(PluginVisualT&& value) {
    ...
    m_pluginVisual = std::forward<PluginVisualT>(value);
  }
  template <typename PluginVisualT = PluginVisual>
  Visual& WithPluginVisual(PluginVisualT&& value) {
    SetPluginVisual(std::forward<PluginVisualT>(value));
    return *this;
  }
  ///@}
 private:
