...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API BarChartVisual() = default;
    ...
    template<typename VisualIdT = Aws::String>
    BarChartVisual& WithVisualId(VisualIdT&& value) { SetVisualId(std::forward<VisualIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = VisualTitleLabelOptions>
    BarChartVisual& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SubtitleT = VisualSubtitleLabelOptions>
    BarChartVisual& WithSubtitle(SubtitleT&& value) { SetSubtitle(std::forward<SubtitleT>(value)); return *this;}
    ///@}
    ...
    template<typename ChartConfigurationT = BarChartConfiguration>
    ...
    template<typename ChartConfigurationT = BarChartConfiguration>
    BarChartVisual& WithChartConfiguration(ChartConfigurationT&& value) { SetChartConfiguration(std::forward<ChartConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Vector<VisualCustomAction>>
    BarChartVisual& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    template<typename ActionsT = VisualCustomAction>
    BarChartVisual& AddActions(ActionsT&& value) { m_actionsHasBeenSet = true; m_actions.emplace_back(std::forward<ActionsT>(value)); return *this; }
    ///@}
    ...
    template<typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
    BarChartVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) { SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value)); return *this;}
    template<typename ColumnHierarchiesT = ColumnHierarchy>
    BarChartVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.emplace_back(std::forward<ColumnHierarchiesT>(value)); return *this; }
    ///@}
    ...
    template<typename VisualContentAltTextT = Aws::String>
    BarChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) { SetVisualContentAltText(std::forward<VisualContentAltTextT>(value)); return *this;}
    ///@}
  private:
