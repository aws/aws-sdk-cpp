...
class BarChartVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  BarChartVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  BarChartVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  BarChartVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = BarChartConfiguration>
  BarChartVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  BarChartVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  BarChartVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  BarChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
