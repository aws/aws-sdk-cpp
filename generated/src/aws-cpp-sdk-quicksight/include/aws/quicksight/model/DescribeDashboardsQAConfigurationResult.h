...
class DescribeDashboardsQAConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeDashboardsQAConfigurationResult& operator=(
  ...
  inline DescribeDashboardsQAConfigurationResult& WithDashboardsQAStatus(DashboardsQAStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDashboardsQAConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeDashboardsQAConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
