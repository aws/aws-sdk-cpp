...
class BrandColorPalette {
 public:
  ...
  template <typename PrimaryT = Palette>
  BrandColorPalette& WithPrimary(PrimaryT&& value) {
  ...
  void SetSecondary(SecondaryT&& value) {
    ...
    m_secondary = std::forward<SecondaryT>(value);
  }
  template <typename SecondaryT = Palette>
  BrandColorPalette& WithSecondary(SecondaryT&& value) {
    SetSecondary(std::forward<SecondaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccent(AccentT&& value) {
    m_accentHasBeenSet = true;
    m_accent = std::forward<AccentT>(value);
  }
  template <typename AccentT = Palette>
  BrandColorPalette& WithAccent(AccentT&& value) {
    SetAccent(std::forward<AccentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMeasure(MeasureT&& value) {
    m_measureHasBeenSet = true;
    m_measure = std::forward<MeasureT>(value);
  }
  template <typename MeasureT = Palette>
  BrandColorPalette& WithMeasure(MeasureT&& value) {
    SetMeasure(std::forward<MeasureT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DimensionT = Palette>
  BrandColorPalette& WithDimension(DimensionT&& value) {
  ...
  void SetSuccess(SuccessT&& value) {
    m_successHasBeenSet = true;
    m_success = std::forward<SuccessT>(value);
  }
  template <typename SuccessT = Palette>
  BrandColorPalette& WithSuccess(SuccessT&& value) {
    SetSuccess(std::forward<SuccessT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename InfoT = Palette>
  BrandColorPalette& WithInfo(InfoT&& value) {
  ...
  template <typename WarningT = Palette>
  BrandColorPalette& WithWarning(WarningT&& value) {
  ...
  void SetDanger(DangerT&& value) {
    m_dangerHasBeenSet = true;
    m_danger = std::forward<DangerT>(value);
  }
  template <typename DangerT = Palette>
  BrandColorPalette& WithDanger(DangerT&& value) {
    SetDanger(std::forward<DangerT>(value));
    return *this;
  }
  ///@}
 private:
