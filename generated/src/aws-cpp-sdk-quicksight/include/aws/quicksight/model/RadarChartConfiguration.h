...
class RadarChartConfiguration {
 public:
  ...
  inline void SetShape(RadarChartShape value) {
    m_shapeHasBeenSet = true;
    m_shape = value;
  }
  inline RadarChartConfiguration& WithShape(RadarChartShape value) {
    SetShape(value);
    return *this;
  }
  ///@}
  ...
  void SetBaseSeriesSettings(BaseSeriesSettingsT&& value) {
    ...
    m_baseSeriesSettings = std::forward<BaseSeriesSettingsT>(value);
  }
  template <typename BaseSeriesSettingsT = RadarChartSeriesSettings>
  RadarChartConfiguration& WithBaseSeriesSettings(BaseSeriesSettingsT&& value) {
    SetBaseSeriesSettings(std::forward<BaseSeriesSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline RadarChartConfiguration& WithStartAngle(double value) {
    SetStartAngle(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAlternateBandColorsVisibility(Visibility value) {
    m_alternateBandColorsVisibilityHasBeenSet = true;
    m_alternateBandColorsVisibility = value;
  }
  inline RadarChartConfiguration& WithAlternateBandColorsVisibility(Visibility value) {
    SetAlternateBandColorsVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetAlternateBandEvenColor(AlternateBandEvenColorT&& value) {
    ...
    m_alternateBandEvenColor = std::forward<AlternateBandEvenColorT>(value);
  }
  template <typename AlternateBandEvenColorT = Aws::String>
  RadarChartConfiguration& WithAlternateBandEvenColor(AlternateBandEvenColorT&& value) {
    SetAlternateBandEvenColor(std::forward<AlternateBandEvenColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlternateBandOddColor(AlternateBandOddColorT&& value) {
    ...
    m_alternateBandOddColor = std::forward<AlternateBandOddColorT>(value);
  }
  template <typename AlternateBandOddColorT = Aws::String>
  RadarChartConfiguration& WithAlternateBandOddColor(AlternateBandOddColorT&& value) {
    SetAlternateBandOddColor(std::forward<AlternateBandOddColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColorAxis(ColorAxisT&& value) {
    ...
    m_colorAxis = std::forward<ColorAxisT>(value);
  }
  template <typename ColorAxisT = AxisDisplayOptions>
  RadarChartConfiguration& WithColorAxis(ColorAxisT&& value) {
    SetColorAxis(std::forward<ColorAxisT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAxesRangeScale(RadarChartAxesRangeScale value) {
    m_axesRangeScaleHasBeenSet = true;
    m_axesRangeScale = value;
  }
  inline RadarChartConfiguration& WithAxesRangeScale(RadarChartAxesRangeScale value) {
    SetAxesRangeScale(value);
    return *this;
  }
  ///@}
