...
class DescribeCustomPermissionsResult {
 public:
  ...
  inline DescribeCustomPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomPermissions(CustomPermissionsT&& value) {
    m_customPermissionsHasBeenSet = true;
    m_customPermissions = std::forward<CustomPermissionsT>(value);
  }
  template <typename CustomPermissionsT = CustomPermissions>
  DescribeCustomPermissionsResult& WithCustomPermissions(CustomPermissionsT&& value) {
    SetCustomPermissions(std::forward<CustomPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCustomPermissionsResult& WithRequestId(RequestIdT&& value) {
