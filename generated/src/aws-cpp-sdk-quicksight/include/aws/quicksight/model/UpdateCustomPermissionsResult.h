...
class UpdateCustomPermissionsResult {
 public:
  ...
  inline UpdateCustomPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArnT = Aws::String>
  UpdateCustomPermissionsResult& WithArn(ArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCustomPermissionsResult& WithRequestId(RequestIdT&& value) {
