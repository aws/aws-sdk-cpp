...
class SectionBasedLayoutConfiguration {
 public:
  ...
  void SetHeaderSections(HeaderSectionsT&& value) {
    ...
    m_headerSections = std::forward<HeaderSectionsT>(value);
  }
  template <typename HeaderSectionsT = Aws::Vector<HeaderFooterSectionConfiguration>>
  SectionBasedLayoutConfiguration& WithHeaderSections(HeaderSectionsT&& value) {
    SetHeaderSections(std::forward<HeaderSectionsT>(value));
    return *this;
  }
  ...
  SectionBasedLayoutConfiguration& AddHeaderSections(HeaderSectionsT&& value) {
    m_headerSectionsHasBeenSet = true;
    m_headerSections.emplace_back(std::forward<HeaderSectionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBodySections(BodySectionsT&& value) {
    ...
    m_bodySections = std::forward<BodySectionsT>(value);
  }
  template <typename BodySectionsT = Aws::Vector<BodySectionConfiguration>>
  SectionBasedLayoutConfiguration& WithBodySections(BodySectionsT&& value) {
    SetBodySections(std::forward<BodySectionsT>(value));
    return *this;
  }
  ...
  SectionBasedLayoutConfiguration& AddBodySections(BodySectionsT&& value) {
    m_bodySectionsHasBeenSet = true;
    m_bodySections.emplace_back(std::forward<BodySectionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFooterSections(FooterSectionsT&& value) {
    ...
    m_footerSections = std::forward<FooterSectionsT>(value);
  }
  template <typename FooterSectionsT = Aws::Vector<HeaderFooterSectionConfiguration>>
  SectionBasedLayoutConfiguration& WithFooterSections(FooterSectionsT&& value) {
    SetFooterSections(std::forward<FooterSectionsT>(value));
    return *this;
  }
  ...
  SectionBasedLayoutConfiguration& AddFooterSections(FooterSectionsT&& value) {
    m_footerSectionsHasBeenSet = true;
    m_footerSections.emplace_back(std::forward<FooterSectionsT>(value));
    return *this;
  }
  ///@}
