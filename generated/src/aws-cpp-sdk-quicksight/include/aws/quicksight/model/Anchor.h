...
class Anchor {
 public:
  ...
  inline void SetAnchorType(AnchorType value) {
    m_anchorTypeHasBeenSet = true;
    m_anchorType = value;
  }
  inline Anchor& WithAnchorType(AnchorType value) {
    SetAnchorType(value);
    return *this;
  }
  ///@}
  ...
  inline Anchor& WithTimeGranularity(TimeGranularity value) {
  ...
  inline Anchor& WithOffset(int value) {
    SetOffset(value);
    return *this;
  }
  ///@}
