...
class WaterfallChartGroupColorConfiguration {
 public:
  ...
  void SetPositiveBarColor(PositiveBarColorT&& value) {
    m_positiveBarColorHasBeenSet = true;
    m_positiveBarColor = std::forward<PositiveBarColorT>(value);
  }
  template <typename PositiveBarColorT = Aws::String>
  WaterfallChartGroupColorConfiguration& WithPositiveBarColor(PositiveBarColorT&& value) {
    SetPositiveBarColor(std::forward<PositiveBarColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNegativeBarColor(NegativeBarColorT&& value) {
    m_negativeBarColorHasBeenSet = true;
    m_negativeBarColor = std::forward<NegativeBarColorT>(value);
  }
  template <typename NegativeBarColorT = Aws::String>
  WaterfallChartGroupColorConfiguration& WithNegativeBarColor(NegativeBarColorT&& value) {
    SetNegativeBarColor(std::forward<NegativeBarColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTotalBarColor(TotalBarColorT&& value) {
    m_totalBarColorHasBeenSet = true;
    m_totalBarColor = std::forward<TotalBarColorT>(value);
  }
  template <typename TotalBarColorT = Aws::String>
  WaterfallChartGroupColorConfiguration& WithTotalBarColor(TotalBarColorT&& value) {
    SetTotalBarColor(std::forward<TotalBarColorT>(value));
    return *this;
  }
  ///@}
 private:
