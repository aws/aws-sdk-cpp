...
class OAuthParameters {
 public:
  ...
  void SetTokenProviderUrl(TokenProviderUrlT&& value) {
    ...
    m_tokenProviderUrl = std::forward<TokenProviderUrlT>(value);
  }
  template <typename TokenProviderUrlT = Aws::String>
  OAuthParameters& WithTokenProviderUrl(TokenProviderUrlT&& value) {
    SetTokenProviderUrl(std::forward<TokenProviderUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOAuthScope(OAuthScopeT&& value) {
    ...
    m_oAuthScope = std::forward<OAuthScopeT>(value);
  }
  template <typename OAuthScopeT = Aws::String>
  OAuthParameters& WithOAuthScope(OAuthScopeT&& value) {
    SetOAuthScope(std::forward<OAuthScopeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentityProviderResourceUri(IdentityProviderResourceUriT&& value) {
    ...
    m_identityProviderResourceUri = std::forward<IdentityProviderResourceUriT>(value);
  }
  template <typename IdentityProviderResourceUriT = Aws::String>
  OAuthParameters& WithIdentityProviderResourceUri(IdentityProviderResourceUriT&& value) {
    SetIdentityProviderResourceUri(std::forward<IdentityProviderResourceUriT>(value));
    return *this;
  }
  ///@}
 private:
