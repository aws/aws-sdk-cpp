...
class ScatterPlotConfiguration {
 public:
  ...
  void SetYAxisLabelOptions(YAxisLabelOptionsT&& value) {
    ...
    m_yAxisLabelOptions = std::forward<YAxisLabelOptionsT>(value);
  }
  template <typename YAxisLabelOptionsT = ChartAxisLabelOptions>
  ScatterPlotConfiguration& WithYAxisLabelOptions(YAxisLabelOptionsT&& value) {
    SetYAxisLabelOptions(std::forward<YAxisLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetYAxisDisplayOptions(YAxisDisplayOptionsT&& value) {
    ...
    m_yAxisDisplayOptions = std::forward<YAxisDisplayOptionsT>(value);
  }
  template <typename YAxisDisplayOptionsT = AxisDisplayOptions>
  ScatterPlotConfiguration& WithYAxisDisplayOptions(YAxisDisplayOptionsT&& value) {
    SetYAxisDisplayOptions(std::forward<YAxisDisplayOptionsT>(value));
    return *this;
  }
  ///@}
