...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API Tag() = default;
    AWS_QUICKSIGHT_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_QUICKSIGHT_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
