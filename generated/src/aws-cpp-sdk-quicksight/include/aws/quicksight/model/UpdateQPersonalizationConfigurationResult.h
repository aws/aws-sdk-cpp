...
class UpdateQPersonalizationConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API UpdateQPersonalizationConfigurationResult& operator=(
  ...
  inline UpdateQPersonalizationConfigurationResult& WithPersonalizationMode(PersonalizationMode value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateQPersonalizationConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateQPersonalizationConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
