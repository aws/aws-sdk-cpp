...
class DescribeVPCConnectionResult {
 public:
  ...
  void SetVPCConnection(VPCConnectionT&& value) {
    ...
    m_vPCConnection = std::forward<VPCConnectionT>(value);
  }
  template <typename VPCConnectionT = VPCConnection>
  DescribeVPCConnectionResult& WithVPCConnection(VPCConnectionT&& value) {
    SetVPCConnection(std::forward<VPCConnectionT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeVPCConnectionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
