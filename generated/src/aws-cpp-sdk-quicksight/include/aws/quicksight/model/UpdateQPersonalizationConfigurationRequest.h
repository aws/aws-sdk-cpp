...
class UpdateQPersonalizationConfigurationRequest : public QuickSightRequest {
 public:
  ...
  ///@{
  /**
   * <p>An option to allow Amazon Quick Sight to customize data stories with user
  ...
  inline UpdateQPersonalizationConfigurationRequest& WithPersonalizationMode(PersonalizationMode value) {
