...
namespace Model {
class SearchAppsResult {
 public:
  AWS_QUICKSIGHT_API SearchAppsResult() = default;
  AWS_QUICKSIGHT_API SearchAppsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API SearchAppsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AppSummaryListT = Aws::Vector<AppSummary>>
  SearchAppsResult& WithAppSummaryList(AppSummaryListT&& value) {
    SetAppSummaryList(std::forward<AppSummaryListT>(value));
    return *this;
  }
  template <typename AppSummaryListT = AppSummary>
  SearchAppsResult& AddAppSummaryList(AppSummaryListT&& value) {
    m_appSummaryListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchAppsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchAppsResult& WithRequestId(RequestIdT&& value) {
