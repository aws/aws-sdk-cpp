...
class StaticFileSource {
 public:
  ...
  void SetUrlOptions(UrlOptionsT&& value) {
    ...
    m_urlOptions = std::forward<UrlOptionsT>(value);
  }
  template <typename UrlOptionsT = StaticFileUrlSourceOptions>
  StaticFileSource& WithUrlOptions(UrlOptionsT&& value) {
    SetUrlOptions(std::forward<UrlOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3Options(S3OptionsT&& value) {
    ...
    m_s3Options = std::forward<S3OptionsT>(value);
  }
  template <typename S3OptionsT = StaticFileS3SourceOptions>
  StaticFileSource& WithS3Options(S3OptionsT&& value) {
    SetS3Options(std::forward<S3OptionsT>(value));
    return *this;
  }
  ///@}
 private:
