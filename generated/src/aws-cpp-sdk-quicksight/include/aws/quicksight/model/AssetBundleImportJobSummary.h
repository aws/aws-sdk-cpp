...
class AssetBundleImportJobSummary {
 public:
  ...
  inline AssetBundleImportJobSummary& WithJobStatus(AssetBundleImportJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AssetBundleImportJobSummary& WithFailureAction(AssetBundleImportFailureAction value) {
