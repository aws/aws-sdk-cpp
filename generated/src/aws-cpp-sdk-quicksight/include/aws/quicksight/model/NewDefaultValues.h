...
class NewDefaultValues {
 public:
  ...
  void SetStringStaticValues(StringStaticValuesT&& value) {
    ...
    m_stringStaticValues = std::forward<StringStaticValuesT>(value);
  }
  template <typename StringStaticValuesT = Aws::Vector<Aws::String>>
  NewDefaultValues& WithStringStaticValues(StringStaticValuesT&& value) {
    SetStringStaticValues(std::forward<StringStaticValuesT>(value));
    return *this;
  }
  template <typename StringStaticValuesT = Aws::String>
  NewDefaultValues& AddStringStaticValues(StringStaticValuesT&& value) {
    m_stringStaticValuesHasBeenSet = true;
    m_stringStaticValues.emplace_back(std::forward<StringStaticValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalStaticValues(DecimalStaticValuesT&& value) {
    ...
    m_decimalStaticValues = std::forward<DecimalStaticValuesT>(value);
  }
  template <typename DecimalStaticValuesT = Aws::Vector<double>>
  NewDefaultValues& WithDecimalStaticValues(DecimalStaticValuesT&& value) {
    SetDecimalStaticValues(std::forward<DecimalStaticValuesT>(value));
    return *this;
  }
  inline NewDefaultValues& AddDecimalStaticValues(double value) {
    m_decimalStaticValuesHasBeenSet = true;
    m_decimalStaticValues.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetDateTimeStaticValues(DateTimeStaticValuesT&& value) {
    ...
    m_dateTimeStaticValues = std::forward<DateTimeStaticValuesT>(value);
  }
  template <typename DateTimeStaticValuesT = Aws::Vector<Aws::Utils::DateTime>>
  NewDefaultValues& WithDateTimeStaticValues(DateTimeStaticValuesT&& value) {
    SetDateTimeStaticValues(std::forward<DateTimeStaticValuesT>(value));
    return *this;
  }
  ...
  NewDefaultValues& AddDateTimeStaticValues(DateTimeStaticValuesT&& value) {
    m_dateTimeStaticValuesHasBeenSet = true;
    m_dateTimeStaticValues.emplace_back(std::forward<DateTimeStaticValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegerStaticValues(IntegerStaticValuesT&& value) {
    ...
    m_integerStaticValues = std::forward<IntegerStaticValuesT>(value);
  }
  template <typename IntegerStaticValuesT = Aws::Vector<long long>>
  NewDefaultValues& WithIntegerStaticValues(IntegerStaticValuesT&& value) {
    SetIntegerStaticValues(std::forward<IntegerStaticValuesT>(value));
    return *this;
  }
  inline NewDefaultValues& AddIntegerStaticValues(long long value) {
    m_integerStaticValuesHasBeenSet = true;
    m_integerStaticValues.push_back(value);
    return *this;
  }
  ///@}
 private:
