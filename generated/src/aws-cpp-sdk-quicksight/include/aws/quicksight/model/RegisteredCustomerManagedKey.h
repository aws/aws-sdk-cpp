 ...
 * to a Quick Sight account for encryption and decryption use.</p> </li> <li> <p>
...
class RegisteredCustomerManagedKey {
 public:
  ...
  inline void SetDefaultKey(bool value) {
    m_defaultKeyHasBeenSet = true;
    m_defaultKey = value;
  }
  inline RegisteredCustomerManagedKey& WithDefaultKey(bool value) {
    SetDefaultKey(value);
    return *this;
  }
  ///@}
