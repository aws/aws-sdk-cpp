...
class DescribeAnalysisPermissionsResult {
 public:
  ...
  template <typename AnalysisIdT = Aws::String>
  DescribeAnalysisPermissionsResult& WithAnalysisId(AnalysisIdT&& value) {
  ...
  void SetAnalysisArn(AnalysisArnT&& value) {
    m_analysisArnHasBeenSet = true;
    m_analysisArn = std::forward<AnalysisArnT>(value);
  }
  template <typename AnalysisArnT = Aws::String>
  DescribeAnalysisPermissionsResult& WithAnalysisArn(AnalysisArnT&& value) {
    SetAnalysisArn(std::forward<AnalysisArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeAnalysisPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeAnalysisPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  inline DescribeAnalysisPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAnalysisPermissionsResult& WithRequestId(RequestIdT&& value) {
