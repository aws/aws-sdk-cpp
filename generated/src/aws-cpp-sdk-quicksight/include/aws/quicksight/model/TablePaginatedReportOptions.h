...
class TablePaginatedReportOptions {
 public:
  ...
  inline TablePaginatedReportOptions& WithVerticalOverflowVisibility(Visibility value) {
  ...
  inline TablePaginatedReportOptions& WithOverflowColumnHeaderVisibility(Visibility value) {
