...
/**
 * <p>A list of Quick Sight parameters and the list's override
...
class Parameters {
 public:
  ...
  void SetStringParameters(StringParametersT&& value) {
    ...
    m_stringParameters = std::forward<StringParametersT>(value);
  }
  template <typename StringParametersT = Aws::Vector<StringParameter>>
  Parameters& WithStringParameters(StringParametersT&& value) {
    SetStringParameters(std::forward<StringParametersT>(value));
    return *this;
  }
  template <typename StringParametersT = StringParameter>
  Parameters& AddStringParameters(StringParametersT&& value) {
    m_stringParametersHasBeenSet = true;
    m_stringParameters.emplace_back(std::forward<StringParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntegerParameters(IntegerParametersT&& value) {
    ...
    m_integerParameters = std::forward<IntegerParametersT>(value);
  }
  template <typename IntegerParametersT = Aws::Vector<IntegerParameter>>
  Parameters& WithIntegerParameters(IntegerParametersT&& value) {
    SetIntegerParameters(std::forward<IntegerParametersT>(value));
    return *this;
  }
  template <typename IntegerParametersT = IntegerParameter>
  Parameters& AddIntegerParameters(IntegerParametersT&& value) {
    m_integerParametersHasBeenSet = true;
    m_integerParameters.emplace_back(std::forward<IntegerParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalParameters(DecimalParametersT&& value) {
    ...
    m_decimalParameters = std::forward<DecimalParametersT>(value);
  }
  template <typename DecimalParametersT = Aws::Vector<DecimalParameter>>
  Parameters& WithDecimalParameters(DecimalParametersT&& value) {
    SetDecimalParameters(std::forward<DecimalParametersT>(value));
    return *this;
  }
  template <typename DecimalParametersT = DecimalParameter>
  Parameters& AddDecimalParameters(DecimalParametersT&& value) {
    m_decimalParametersHasBeenSet = true;
    m_decimalParameters.emplace_back(std::forward<DecimalParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateTimeParameters(DateTimeParametersT&& value) {
    ...
    m_dateTimeParameters = std::forward<DateTimeParametersT>(value);
  }
  template <typename DateTimeParametersT = Aws::Vector<DateTimeParameter>>
  Parameters& WithDateTimeParameters(DateTimeParametersT&& value) {
    SetDateTimeParameters(std::forward<DateTimeParametersT>(value));
    return *this;
  }
  template <typename DateTimeParametersT = DateTimeParameter>
  Parameters& AddDateTimeParameters(DateTimeParametersT&& value) {
    m_dateTimeParametersHasBeenSet = true;
    m_dateTimeParameters.emplace_back(std::forward<DateTimeParametersT>(value));
    return *this;
  }
  ///@}
 private:
