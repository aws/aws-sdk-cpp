...
class TreeMapConfiguration {
 public:
  ...
  void SetGroupLabelOptions(GroupLabelOptionsT&& value) {
    ...
    m_groupLabelOptions = std::forward<GroupLabelOptionsT>(value);
  }
  template <typename GroupLabelOptionsT = ChartAxisLabelOptions>
  TreeMapConfiguration& WithGroupLabelOptions(GroupLabelOptionsT&& value) {
    SetGroupLabelOptions(std::forward<GroupLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSizeLabelOptions(SizeLabelOptionsT&& value) {
    ...
    m_sizeLabelOptions = std::forward<SizeLabelOptionsT>(value);
  }
  template <typename SizeLabelOptionsT = ChartAxisLabelOptions>
  TreeMapConfiguration& WithSizeLabelOptions(SizeLabelOptionsT&& value) {
    SetSizeLabelOptions(std::forward<SizeLabelOptionsT>(value));
    return *this;
  }
  ///@}
