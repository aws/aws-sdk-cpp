...
class SearchFlowsFilter {
 public:
  ...
  inline void SetName(FieldName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SearchFlowsFilter& WithName(FieldName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline SearchFlowsFilter& WithOperator(SearchFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  SearchFlowsFilter& WithValue(ValueT&& value) {
