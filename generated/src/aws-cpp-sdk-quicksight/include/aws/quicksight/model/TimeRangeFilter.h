...
class TimeRangeFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  TimeRangeFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  TimeRangeFilter& WithColumn(ColumnT&& value) {
  ...
  inline TimeRangeFilter& WithIncludeMinimum(bool value) {
  ...
  inline TimeRangeFilter& WithIncludeMaximum(bool value) {
  ...
  void SetRangeMinimumValue(RangeMinimumValueT&& value) {
    m_rangeMinimumValueHasBeenSet = true;
    m_rangeMinimumValue = std::forward<RangeMinimumValueT>(value);
  }
  template <typename RangeMinimumValueT = TimeRangeFilterValue>
  TimeRangeFilter& WithRangeMinimumValue(RangeMinimumValueT&& value) {
    SetRangeMinimumValue(std::forward<RangeMinimumValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRangeMaximumValue(RangeMaximumValueT&& value) {
    m_rangeMaximumValueHasBeenSet = true;
    m_rangeMaximumValue = std::forward<RangeMaximumValueT>(value);
  }
  template <typename RangeMaximumValueT = TimeRangeFilterValue>
  TimeRangeFilter& WithRangeMaximumValue(RangeMaximumValueT&& value) {
    SetRangeMaximumValue(std::forward<RangeMaximumValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline TimeRangeFilter& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExcludePeriodConfigurationT = ExcludePeriodConfiguration>
  TimeRangeFilter& WithExcludePeriodConfiguration(ExcludePeriodConfigurationT&& value) {
  ...
  inline TimeRangeFilter& WithTimeGranularity(TimeGranularity value) {
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  TimeRangeFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
