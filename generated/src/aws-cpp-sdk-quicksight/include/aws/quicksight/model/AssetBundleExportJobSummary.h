...
class AssetBundleExportJobSummary {
 public:
  ...
  inline void SetJobStatus(AssetBundleExportJobStatus value) {
    m_jobStatusHasBeenSet = true;
    m_jobStatus = value;
  }
  inline AssetBundleExportJobSummary& WithJobStatus(AssetBundleExportJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AssetBundleExportJobSummary& WithIncludeAllDependencies(bool value) {
  ...
  inline AssetBundleExportJobSummary& WithExportFormat(AssetBundleExportFormat value) {
  ...
  inline AssetBundleExportJobSummary& WithIncludePermissions(bool value) {
  ...
  inline AssetBundleExportJobSummary& WithIncludeTags(bool value) {
