...
class DimensionField {
 public:
  ...
  void SetNumericalDimensionField(NumericalDimensionFieldT&& value) {
    ...
    m_numericalDimensionField = std::forward<NumericalDimensionFieldT>(value);
  }
  template <typename NumericalDimensionFieldT = NumericalDimensionField>
  DimensionField& WithNumericalDimensionField(NumericalDimensionFieldT&& value) {
    SetNumericalDimensionField(std::forward<NumericalDimensionFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCategoricalDimensionField(CategoricalDimensionFieldT&& value) {
    ...
    m_categoricalDimensionField = std::forward<CategoricalDimensionFieldT>(value);
  }
  template <typename CategoricalDimensionFieldT = CategoricalDimensionField>
  DimensionField& WithCategoricalDimensionField(CategoricalDimensionFieldT&& value) {
    SetCategoricalDimensionField(std::forward<CategoricalDimensionFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateDimensionField(DateDimensionFieldT&& value) {
    ...
    m_dateDimensionField = std::forward<DateDimensionFieldT>(value);
  }
  template <typename DateDimensionFieldT = DateDimensionField>
  DimensionField& WithDateDimensionField(DateDimensionFieldT&& value) {
    SetDateDimensionField(std::forward<DateDimensionFieldT>(value));
    return *this;
  }
  ///@}
 private:
