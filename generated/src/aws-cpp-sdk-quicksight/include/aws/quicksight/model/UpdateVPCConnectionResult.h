...
class UpdateVPCConnectionResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateVPCConnectionResult& WithArn(ArnT&& value) {
  ...
  template <typename VPCConnectionIdT = Aws::String>
  UpdateVPCConnectionResult& WithVPCConnectionId(VPCConnectionIdT&& value) {
  ...
  inline void SetUpdateStatus(VPCConnectionResourceStatus value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus = value;
  }
  inline UpdateVPCConnectionResult& WithUpdateStatus(VPCConnectionResourceStatus value) {
  ...
  inline UpdateVPCConnectionResult& WithAvailabilityStatus(VPCConnectionAvailabilityStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateVPCConnectionResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateVPCConnectionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
