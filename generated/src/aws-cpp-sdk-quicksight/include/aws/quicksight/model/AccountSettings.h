...
class AccountSettings {
 public:
  ...
  inline AccountSettings& WithEdition(Edition value) {
    SetEdition(value);
    return *this;
  }
  ///@}
  ...
  inline AccountSettings& WithPublicSharingEnabled(bool value) {
  ...
  inline AccountSettings& WithTerminationProtectionEnabled(bool value) {
