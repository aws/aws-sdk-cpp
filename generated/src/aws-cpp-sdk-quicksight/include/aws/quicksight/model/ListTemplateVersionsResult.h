...
class ListTemplateVersionsResult {
 public:
  ...
  void SetTemplateVersionSummaryList(TemplateVersionSummaryListT&& value) {
    m_templateVersionSummaryListHasBeenSet = true;
    m_templateVersionSummaryList = std::forward<TemplateVersionSummaryListT>(value);
  }
  template <typename TemplateVersionSummaryListT = Aws::Vector<TemplateVersionSummary>>
  ListTemplateVersionsResult& WithTemplateVersionSummaryList(TemplateVersionSummaryListT&& value) {
    SetTemplateVersionSummaryList(std::forward<TemplateVersionSummaryListT>(value));
    return *this;
  }
  template <typename TemplateVersionSummaryListT = TemplateVersionSummary>
  ListTemplateVersionsResult& AddTemplateVersionSummaryList(TemplateVersionSummaryListT&& value) {
    m_templateVersionSummaryListHasBeenSet = true;
    m_templateVersionSummaryList.emplace_back(std::forward<TemplateVersionSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTemplateVersionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTemplateVersionsResult& WithRequestId(RequestIdT&& value) {
