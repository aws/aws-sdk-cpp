...
class LineChartLineStyleSettings {
 public:
  ...
  inline void SetLineVisibility(Visibility value) {
    m_lineVisibilityHasBeenSet = true;
    m_lineVisibility = value;
  }
  inline LineChartLineStyleSettings& WithLineVisibility(Visibility value) {
  ...
  inline LineChartLineStyleSettings& WithLineInterpolation(LineInterpolation value) {
  ...
  inline void SetLineStyle(LineChartLineStyle value) {
    m_lineStyleHasBeenSet = true;
    m_lineStyle = value;
  }
  inline LineChartLineStyleSettings& WithLineStyle(LineChartLineStyle value) {
    SetLineStyle(value);
    return *this;
  }
  ///@}
