...
class AssetBundleExportJobFolderOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobFolderOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobFolderPropertyToOverride>>
  AssetBundleExportJobFolderOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobFolderOverrideProperties& AddProperties(AssetBundleExportJobFolderPropertyToOverride value) {
    m_propertiesHasBeenSet = true;
