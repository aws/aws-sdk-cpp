...
class RowLevelPermissionTagConfiguration {
 public:
  ...
  inline RowLevelPermissionTagConfiguration& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTagRules(TagRulesT&& value) {
    m_tagRulesHasBeenSet = true;
    m_tagRules = std::forward<TagRulesT>(value);
  }
  template <typename TagRulesT = Aws::Vector<RowLevelPermissionTagRule>>
  RowLevelPermissionTagConfiguration& WithTagRules(TagRulesT&& value) {
    SetTagRules(std::forward<TagRulesT>(value));
    return *this;
  }
  template <typename TagRulesT = RowLevelPermissionTagRule>
  RowLevelPermissionTagConfiguration& AddTagRules(TagRulesT&& value) {
    m_tagRulesHasBeenSet = true;
    m_tagRules.emplace_back(std::forward<TagRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagRuleConfigurations(TagRuleConfigurationsT&& value) {
    m_tagRuleConfigurationsHasBeenSet = true;
    m_tagRuleConfigurations = std::forward<TagRuleConfigurationsT>(value);
  }
  template <typename TagRuleConfigurationsT = Aws::Vector<Aws::Vector<Aws::String>>>
  RowLevelPermissionTagConfiguration& WithTagRuleConfigurations(TagRuleConfigurationsT&& value) {
    SetTagRuleConfigurations(std::forward<TagRuleConfigurationsT>(value));
    return *this;
  }
  template <typename TagRuleConfigurationsT = Aws::Vector<Aws::String>>
  RowLevelPermissionTagConfiguration& AddTagRuleConfigurations(TagRuleConfigurationsT&& value) {
    m_tagRuleConfigurationsHasBeenSet = true;
    m_tagRuleConfigurations.emplace_back(std::forward<TagRuleConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
