...
class NamedEntityDefinition {
 public:
  ...
  inline void SetPropertyRole(PropertyRole value) {
    m_propertyRoleHasBeenSet = true;
    m_propertyRole = value;
  }
  inline NamedEntityDefinition& WithPropertyRole(PropertyRole value) {
    SetPropertyRole(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPropertyUsage(PropertyUsage value) {
    m_propertyUsageHasBeenSet = true;
    m_propertyUsage = value;
  }
  inline NamedEntityDefinition& WithPropertyUsage(PropertyUsage value) {
