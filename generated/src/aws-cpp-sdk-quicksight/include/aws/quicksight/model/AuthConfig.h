...
namespace Model
{
  ...
  public:
    ...
    inline AuthConfig& WithAuthenticationType(ConnectionAuthType value) { SetAuthenticationType(value); return *this;}
    ///@}
    ...
    template<typename AuthenticationMetadataT = AuthenticationMetadata>
    AuthConfig& WithAuthenticationMetadata(AuthenticationMetadataT&& value) { SetAuthenticationMetadata(std::forward<AuthenticationMetadataT>(value)); return *this;}
    ///@}
  private:
