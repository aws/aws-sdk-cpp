...
class DescribeKeyRegistrationRequest : public QuickSightRequest {
 public:
  ...
  inline void SetDefaultKeyOnly(bool value) {
    m_defaultKeyOnlyHasBeenSet = true;
    m_defaultKeyOnly = value;
  }
  inline DescribeKeyRegistrationRequest& WithDefaultKeyOnly(bool value) {
    SetDefaultKeyOnly(value);
    return *this;
  }
  ///@}
 private:
