...
class IntegerValueWhenUnsetConfiguration {
 public:
  ...
  inline IntegerValueWhenUnsetConfiguration& WithValueWhenUnsetOption(ValueWhenUnsetOption value) {
  ...
  inline void SetCustomValue(long long value) {
    m_customValueHasBeenSet = true;
    m_customValue = value;
  }
  inline IntegerValueWhenUnsetConfiguration& WithCustomValue(long long value) {
