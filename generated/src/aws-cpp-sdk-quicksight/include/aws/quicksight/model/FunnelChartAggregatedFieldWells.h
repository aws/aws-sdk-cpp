...
class FunnelChartAggregatedFieldWells {
 public:
  ...
  template <typename CategoryT = Aws::Vector<DimensionField>>
  FunnelChartAggregatedFieldWells& WithCategory(CategoryT&& value) {
    SetCategory(std::forward<CategoryT>(value));
    return *this;
  }
  template <typename CategoryT = DimensionField>
  FunnelChartAggregatedFieldWells& AddCategory(CategoryT&& value) {
    m_categoryHasBeenSet = true;
  ...
  template <typename ValuesT = Aws::Vector<MeasureField>>
  FunnelChartAggregatedFieldWells& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = MeasureField>
  FunnelChartAggregatedFieldWells& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
