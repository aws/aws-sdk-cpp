...
class UploadSettings {
 public:
  ...
  inline void SetFormat(FileFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline UploadSettings& WithFormat(FileFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartFromRow(int value) {
    m_startFromRowHasBeenSet = true;
    m_startFromRow = value;
  }
  inline UploadSettings& WithStartFromRow(int value) {
    SetStartFromRow(value);
    return *this;
  }
  ///@}
  ...
  inline UploadSettings& WithContainsHeader(bool value) {
  ...
  inline void SetTextQualifier(TextQualifier value) {
    m_textQualifierHasBeenSet = true;
    m_textQualifier = value;
  }
  inline UploadSettings& WithTextQualifier(TextQualifier value) {
