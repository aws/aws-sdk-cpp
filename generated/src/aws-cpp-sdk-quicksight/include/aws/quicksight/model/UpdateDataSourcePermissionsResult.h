...
class UpdateDataSourcePermissionsResult {
 public:
  ...
  template <typename DataSourceArnT = Aws::String>
  UpdateDataSourcePermissionsResult& WithDataSourceArn(DataSourceArnT&& value) {
  ...
  template <typename DataSourceIdT = Aws::String>
  UpdateDataSourcePermissionsResult& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDataSourcePermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateDataSourcePermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
