...
class NamespaceInfoV2 {
 public:
  ...
  inline NamespaceInfoV2& WithCreationStatus(NamespaceStatus value) {
  ...
  inline NamespaceInfoV2& WithIdentityStore(IdentityStore value) {
  ...
  void SetNamespaceError(NamespaceErrorT&& value) {
    ...
    m_namespaceError = std::forward<NamespaceErrorT>(value);
  }
  template <typename NamespaceErrorT = NamespaceError>
  NamespaceInfoV2& WithNamespaceError(NamespaceErrorT&& value) {
    SetNamespaceError(std::forward<NamespaceErrorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIamIdentityCenterApplicationArn(IamIdentityCenterApplicationArnT&& value) {
    ...
    m_iamIdentityCenterApplicationArn = std::forward<IamIdentityCenterApplicationArnT>(value);
  }
  template <typename IamIdentityCenterApplicationArnT = Aws::String>
  NamespaceInfoV2& WithIamIdentityCenterApplicationArn(IamIdentityCenterApplicationArnT&& value) {
    SetIamIdentityCenterApplicationArn(std::forward<IamIdentityCenterApplicationArnT>(value));
    return *this;
  }
  ///@}
