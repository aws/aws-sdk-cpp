...
class GetFlowMetadataResult {
 public:
  ...
  inline GetFlowMetadataResult& WithPublishState(FlowPublishState value) {
  ...
  inline GetFlowMetadataResult& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
  ...
  inline GetFlowMetadataResult& WithRunCount(int value) {
    SetRunCount(value);
    return *this;
  }
  ///@}
  ...
  inline GetFlowMetadataResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
