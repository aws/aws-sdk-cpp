...
class CreateFolderMembershipResult {
 public:
  ...
  inline CreateFolderMembershipResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetFolderMember(FolderMemberT&& value) {
    m_folderMemberHasBeenSet = true;
    m_folderMember = std::forward<FolderMemberT>(value);
  }
  template <typename FolderMemberT = FolderMember>
  CreateFolderMembershipResult& WithFolderMember(FolderMemberT&& value) {
    SetFolderMember(std::forward<FolderMemberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateFolderMembershipResult& WithRequestId(RequestIdT&& value) {
