...
class TableFieldOptions {
 public:
  ...
  void SetSelectedFieldOptions(SelectedFieldOptionsT&& value) {
    ...
    m_selectedFieldOptions = std::forward<SelectedFieldOptionsT>(value);
  }
  template <typename SelectedFieldOptionsT = Aws::Vector<TableFieldOption>>
  TableFieldOptions& WithSelectedFieldOptions(SelectedFieldOptionsT&& value) {
    SetSelectedFieldOptions(std::forward<SelectedFieldOptionsT>(value));
    return *this;
  }
  ...
  TableFieldOptions& AddSelectedFieldOptions(SelectedFieldOptionsT&& value) {
    m_selectedFieldOptionsHasBeenSet = true;
    m_selectedFieldOptions.emplace_back(std::forward<SelectedFieldOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  TableFieldOptions& AddOrder(OrderT&& value) {
    m_orderHasBeenSet = true;
    m_order.emplace_back(std::forward<OrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPinnedFieldOptions(PinnedFieldOptionsT&& value) {
    ...
    m_pinnedFieldOptions = std::forward<PinnedFieldOptionsT>(value);
  }
  template <typename PinnedFieldOptionsT = TablePinnedFieldOptions>
  TableFieldOptions& WithPinnedFieldOptions(PinnedFieldOptionsT&& value) {
    SetPinnedFieldOptions(std::forward<PinnedFieldOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransposedTableOptions(TransposedTableOptionsT&& value) {
    ...
    m_transposedTableOptions = std::forward<TransposedTableOptionsT>(value);
  }
  template <typename TransposedTableOptionsT = Aws::Vector<TransposedTableOption>>
  TableFieldOptions& WithTransposedTableOptions(TransposedTableOptionsT&& value) {
    SetTransposedTableOptions(std::forward<TransposedTableOptionsT>(value));
    return *this;
  }
  ...
  TableFieldOptions& AddTransposedTableOptions(TransposedTableOptionsT&& value) {
    m_transposedTableOptionsHasBeenSet = true;
    m_transposedTableOptions.emplace_back(std::forward<TransposedTableOptionsT>(value));
    return *this;
  }
  ///@}
 private:
