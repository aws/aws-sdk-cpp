...
class ContributionAnalysisTimeRanges {
 public:
  ...
  void SetStartRange(StartRangeT&& value) {
    ...
    m_startRange = std::forward<StartRangeT>(value);
  }
  template <typename StartRangeT = TopicIRFilterOption>
  ContributionAnalysisTimeRanges& WithStartRange(StartRangeT&& value) {
    SetStartRange(std::forward<StartRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndRange(EndRangeT&& value) {
    ...
    m_endRange = std::forward<EndRangeT>(value);
  }
  template <typename EndRangeT = TopicIRFilterOption>
  ContributionAnalysisTimeRanges& WithEndRange(EndRangeT&& value) {
    SetEndRange(std::forward<EndRangeT>(value));
    return *this;
  }
  ///@}
 private:
