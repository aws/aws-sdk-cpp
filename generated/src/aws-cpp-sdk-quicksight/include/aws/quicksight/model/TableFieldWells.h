...
class TableFieldWells {
 public:
  ...
  void SetTableAggregatedFieldWells(TableAggregatedFieldWellsT&& value) {
    ...
    m_tableAggregatedFieldWells = std::forward<TableAggregatedFieldWellsT>(value);
  }
  template <typename TableAggregatedFieldWellsT = TableAggregatedFieldWells>
  TableFieldWells& WithTableAggregatedFieldWells(TableAggregatedFieldWellsT&& value) {
    SetTableAggregatedFieldWells(std::forward<TableAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTableUnaggregatedFieldWells(TableUnaggregatedFieldWellsT&& value) {
    ...
    m_tableUnaggregatedFieldWells = std::forward<TableUnaggregatedFieldWellsT>(value);
  }
  template <typename TableUnaggregatedFieldWellsT = TableUnaggregatedFieldWells>
  TableFieldWells& WithTableUnaggregatedFieldWells(TableUnaggregatedFieldWellsT&& value) {
    SetTableUnaggregatedFieldWells(std::forward<TableUnaggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
