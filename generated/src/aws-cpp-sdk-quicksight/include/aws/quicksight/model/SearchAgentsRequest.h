...
/**
 */
class SearchAgentsRequest : public QuickSightRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "SearchAgents"; }
   ...
   */
  inline const Aws::Vector<AgentSearchFilter>& GetFilters() const { return m_filters; }
  inline bool FiltersHasBeenSet() const { return m_filtersHasBeenSet; }
  template <typename FiltersT = Aws::Vector<AgentSearchFilter>>
  ...
  template <typename FiltersT = AgentSearchFilter>
  ...
  inline SearchAgentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  Aws::Vector<AgentSearchFilter> m_filters;
