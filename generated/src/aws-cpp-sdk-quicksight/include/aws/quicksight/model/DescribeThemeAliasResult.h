...
class DescribeThemeAliasResult {
 public:
  ...
  template <typename ThemeAliasT = ThemeAlias>
  DescribeThemeAliasResult& WithThemeAlias(ThemeAliasT&& value) {
  ...
  inline DescribeThemeAliasResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeThemeAliasResult& WithRequestId(RequestIdT&& value) {
