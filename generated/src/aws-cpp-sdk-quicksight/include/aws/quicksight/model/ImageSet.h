...
class ImageSet {
 public:
  ...
  void SetHeight64(Height64T&& value) {
    ...
    m_height64 = std::forward<Height64T>(value);
  }
  template <typename Height64T = Image>
  ImageSet& WithHeight64(Height64T&& value) {
    SetHeight64(std::forward<Height64T>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeight32(Height32T&& value) {
    ...
    m_height32 = std::forward<Height32T>(value);
  }
  template <typename Height32T = Image>
  ImageSet& WithHeight32(Height32T&& value) {
    SetHeight32(std::forward<Height32T>(value));
    return *this;
  }
  ///@}
 private:
