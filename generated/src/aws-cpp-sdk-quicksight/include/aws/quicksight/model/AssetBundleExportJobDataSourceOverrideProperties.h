...
class AssetBundleExportJobDataSourceOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobDataSourceOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobDataSourcePropertyToOverride>>
  AssetBundleExportJobDataSourceOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobDataSourceOverrideProperties& AddProperties(AssetBundleExportJobDataSourcePropertyToOverride value) {
    m_propertiesHasBeenSet = true;
