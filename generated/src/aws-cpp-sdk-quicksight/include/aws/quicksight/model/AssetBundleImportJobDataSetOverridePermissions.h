...
class AssetBundleImportJobDataSetOverridePermissions {
 public:
  ...
  template <typename DataSetIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobDataSetOverridePermissions& WithDataSetIds(DataSetIdsT&& value) {
    SetDataSetIds(std::forward<DataSetIdsT>(value));
    return *this;
  }
  template <typename DataSetIdsT = Aws::String>
  AssetBundleImportJobDataSetOverridePermissions& AddDataSetIds(DataSetIdsT&& value) {
    m_dataSetIdsHasBeenSet = true;
  ...
  template <typename PermissionsT = AssetBundleResourcePermissions>
  AssetBundleImportJobDataSetOverridePermissions& WithPermissions(PermissionsT&& value) {
