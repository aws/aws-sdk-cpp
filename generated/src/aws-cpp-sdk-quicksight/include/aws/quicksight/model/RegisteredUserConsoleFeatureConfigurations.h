...
/**
 * <p>The feature configurations of an embedded Amazon Quick Sight
...
class RegisteredUserConsoleFeatureConfigurations {
 public:
  ...
  ///@{
  /**
   * <p>The state persistence configurations of an embedded Amazon Quick Sight
   * console.</p>
   */
  ...
  void SetStatePersistence(StatePersistenceT&& value) {
    ...
    m_statePersistence = std::forward<StatePersistenceT>(value);
  }
  template <typename StatePersistenceT = StatePersistenceConfigurations>
  RegisteredUserConsoleFeatureConfigurations& WithStatePersistence(StatePersistenceT&& value) {
    SetStatePersistence(std::forward<StatePersistenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmazonQInQuickSight(AmazonQInQuickSightT&& value) {
    ...
    m_amazonQInQuickSight = std::forward<AmazonQInQuickSightT>(value);
  }
  template <typename AmazonQInQuickSightT = AmazonQInQuickSightConsoleConfigurations>
  RegisteredUserConsoleFeatureConfigurations& WithAmazonQInQuickSight(AmazonQInQuickSightT&& value) {
    SetAmazonQInQuickSight(std::forward<AmazonQInQuickSightT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecentSnapshots(RecentSnapshotsT&& value) {
    ...
    m_recentSnapshots = std::forward<RecentSnapshotsT>(value);
  }
  template <typename RecentSnapshotsT = RecentSnapshotsConfigurations>
  RegisteredUserConsoleFeatureConfigurations& WithRecentSnapshots(RecentSnapshotsT&& value) {
    SetRecentSnapshots(std::forward<RecentSnapshotsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetThresholdAlerts(ThresholdAlertsT&& value) {
    ...
    m_thresholdAlerts = std::forward<ThresholdAlertsT>(value);
  }
  template <typename ThresholdAlertsT = ThresholdAlertsConfigurations>
  RegisteredUserConsoleFeatureConfigurations& WithThresholdAlerts(ThresholdAlertsT&& value) {
    SetThresholdAlerts(std::forward<ThresholdAlertsT>(value));
    return *this;
  }
  ///@}
 private:
