...
namespace Model
{
  ...
  /**
   */
  class ListDataSourcesRequest : public QuickSightRequest
  {
  public:
    AWS_QUICKSIGHT_API ListDataSourcesRequest();
    ...
    inline ListDataSourcesRequest& WithAwsAccountId(const Aws::String& value) { SetAwsAccountId(value); return *this;}
    inline ListDataSourcesRequest& WithAwsAccountId(Aws::String&& value) { SetAwsAccountId(std::move(value)); return *this;}
    inline ListDataSourcesRequest& WithAwsAccountId(const char* value) { SetAwsAccountId(value); return *this;}
    ///@}
