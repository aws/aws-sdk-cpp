...
class AssetBundleExportJobError {
 public:
  AWS_QUICKSIGHT_API AssetBundleExportJobError() = default;
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobError& WithArn(ArnT&& value) {
  ...
  template <typename TypeT = Aws::String>
  AssetBundleExportJobError& WithType(TypeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  AssetBundleExportJobError& WithMessage(MessageT&& value) {
