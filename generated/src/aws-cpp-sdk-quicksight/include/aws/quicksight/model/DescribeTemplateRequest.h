...
class DescribeTemplateRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeTemplateRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  DescribeTemplateRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  inline DescribeTemplateRequest& WithVersionNumber(long long value) {
  ...
  template <typename AliasNameT = Aws::String>
  DescribeTemplateRequest& WithAliasName(AliasNameT&& value) {
