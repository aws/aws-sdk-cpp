...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API WordCloudVisual() = default;
    ...
    template<typename VisualIdT = Aws::String>
    WordCloudVisual& WithVisualId(VisualIdT&& value) { SetVisualId(std::forward<VisualIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = VisualTitleLabelOptions>
    WordCloudVisual& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SubtitleT = VisualSubtitleLabelOptions>
    WordCloudVisual& WithSubtitle(SubtitleT&& value) { SetSubtitle(std::forward<SubtitleT>(value)); return *this;}
    ///@}
    ...
    template<typename ChartConfigurationT = WordCloudChartConfiguration>
    ...
    template<typename ChartConfigurationT = WordCloudChartConfiguration>
    WordCloudVisual& WithChartConfiguration(ChartConfigurationT&& value) { SetChartConfiguration(std::forward<ChartConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Vector<VisualCustomAction>>
    WordCloudVisual& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    template<typename ActionsT = VisualCustomAction>
    WordCloudVisual& AddActions(ActionsT&& value) { m_actionsHasBeenSet = true; m_actions.emplace_back(std::forward<ActionsT>(value)); return *this; }
    ///@}
    ...
    template<typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
    WordCloudVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) { SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value)); return *this;}
    template<typename ColumnHierarchiesT = ColumnHierarchy>
    WordCloudVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.emplace_back(std::forward<ColumnHierarchiesT>(value)); return *this; }
    ///@}
    ...
    template<typename VisualContentAltTextT = Aws::String>
    WordCloudVisual& WithVisualContentAltText(VisualContentAltTextT&& value) { SetVisualContentAltText(std::forward<VisualContentAltTextT>(value)); return *this;}
    ///@}
  private:
