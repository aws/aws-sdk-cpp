...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API LimitExceededException() = default;
    ...
    inline LimitExceededException& WithResourceType(ExceptionResourceType value) { SetResourceType(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    LimitExceededException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
