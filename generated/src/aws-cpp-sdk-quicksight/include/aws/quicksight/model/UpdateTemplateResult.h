...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API UpdateTemplateResult() = default;
    ...
    template<typename ArnT = Aws::String>
    UpdateTemplateResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionArnT = Aws::String>
    UpdateTemplateResult& WithVersionArn(VersionArnT&& value) { SetVersionArn(std::forward<VersionArnT>(value)); return *this;}
    ///@}
    ...
    inline UpdateTemplateResult& WithCreationStatus(ResourceStatus value) { SetCreationStatus(value); return *this;}
    ///@}
