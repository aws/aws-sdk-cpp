...
class AccountCustomization {
 public:
  ...
  void SetDefaultTheme(DefaultThemeT&& value) {
    m_defaultThemeHasBeenSet = true;
    m_defaultTheme = std::forward<DefaultThemeT>(value);
  }
  template <typename DefaultThemeT = Aws::String>
  AccountCustomization& WithDefaultTheme(DefaultThemeT&& value) {
    SetDefaultTheme(std::forward<DefaultThemeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultEmailCustomizationTemplate(DefaultEmailCustomizationTemplateT&& value) {
    m_defaultEmailCustomizationTemplateHasBeenSet = true;
    m_defaultEmailCustomizationTemplate = std::forward<DefaultEmailCustomizationTemplateT>(value);
  }
  template <typename DefaultEmailCustomizationTemplateT = Aws::String>
  AccountCustomization& WithDefaultEmailCustomizationTemplate(DefaultEmailCustomizationTemplateT&& value) {
    SetDefaultEmailCustomizationTemplate(std::forward<DefaultEmailCustomizationTemplateT>(value));
    return *this;
  }
  ///@}
 private:
