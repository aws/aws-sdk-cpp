...
namespace Model
{
  ...
  public:
    ...
    template<typename RoleArnT = Aws::String>
    S3KnowledgeBaseParameters& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    void SetBucketUrl(BucketUrlT&& value) { m_bucketUrlHasBeenSet = true; m_bucketUrl = std::forward<BucketUrlT>(value); }
    template<typename BucketUrlT = Aws::String>
    S3KnowledgeBaseParameters& WithBucketUrl(BucketUrlT&& value) { SetBucketUrl(std::forward<BucketUrlT>(value)); return *this;}
    ///@}
    ...
    void SetMetadataFilesLocation(MetadataFilesLocationT&& value) { m_metadataFilesLocationHasBeenSet = true; m_metadataFilesLocation = std::forward<MetadataFilesLocationT>(value); }
    template<typename MetadataFilesLocationT = Aws::String>
    S3KnowledgeBaseParameters& WithMetadataFilesLocation(MetadataFilesLocationT&& value) { SetMetadataFilesLocation(std::forward<MetadataFilesLocationT>(value)); return *this;}
    ///@}
  private:
