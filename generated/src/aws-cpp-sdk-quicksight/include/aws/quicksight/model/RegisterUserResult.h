...
class RegisterUserResult {
 public:
  ...
  void SetUserInvitationUrl(UserInvitationUrlT&& value) {
    ...
    m_userInvitationUrl = std::forward<UserInvitationUrlT>(value);
  }
  template <typename UserInvitationUrlT = Aws::String>
  RegisterUserResult& WithUserInvitationUrl(UserInvitationUrlT&& value) {
    SetUserInvitationUrl(std::forward<UserInvitationUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline RegisterUserResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
