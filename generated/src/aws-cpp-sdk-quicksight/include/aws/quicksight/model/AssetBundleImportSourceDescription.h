...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A HTTPS download URL for the provided asset bundle that you optionally
     * provided at the start of the import job. This URL is valid for 5 minutes after
     * issuance. Call <code>DescribeAssetBundleExportJob</code> again for a fresh URL
     * if needed. The downloaded asset bundle is a <code>.qs</code> zip file.</p>
     */
