...
class DefaultFilterDropDownControlOptions {
 public:
  ...
  template <typename DisplayOptionsT = DropDownControlDisplayOptions>
  DefaultFilterDropDownControlOptions& WithDisplayOptions(DisplayOptionsT&& value) {
  ...
  inline DefaultFilterDropDownControlOptions& WithType(SheetControlListType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SelectableValuesT = FilterSelectableValues>
  DefaultFilterDropDownControlOptions& WithSelectableValues(SelectableValuesT&& value) {
  ...
  inline DefaultFilterDropDownControlOptions& WithCommitMode(CommitMode value) {
    SetCommitMode(value);
    return *this;
  }
  ///@}
