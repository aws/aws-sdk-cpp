...
class CategoricalDimensionField {
 public:
  ...
  template <typename FieldIdT = Aws::String>
  CategoricalDimensionField& WithFieldId(FieldIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  CategoricalDimensionField& WithColumn(ColumnT&& value) {
  ...
  template <typename HierarchyIdT = Aws::String>
  CategoricalDimensionField& WithHierarchyId(HierarchyIdT&& value) {
  ...
  template <typename FormatConfigurationT = StringFormatConfiguration>
  CategoricalDimensionField& WithFormatConfiguration(FormatConfigurationT&& value) {
