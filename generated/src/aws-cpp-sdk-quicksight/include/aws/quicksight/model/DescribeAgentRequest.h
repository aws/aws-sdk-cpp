...
/**
 */
class DescribeAgentRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DescribeAgentRequest() = default;
  ...
  template <typename AgentIdT = Aws::String>
  DescribeAgentRequest& WithAgentId(AgentIdT&& value) {
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeAgentRequest& WithAwsAccountId(AwsAccountIdT&& value) {
