...
class FilterListConfiguration {
 public:
  ...
  inline FilterListConfiguration& WithMatchOperator(CategoryFilterMatchOperator value) {
  ...
  template <typename CategoryValuesT = Aws::Vector<Aws::String>>
  FilterListConfiguration& WithCategoryValues(CategoryValuesT&& value) {
    SetCategoryValues(std::forward<CategoryValuesT>(value));
    return *this;
  }
  template <typename CategoryValuesT = Aws::String>
  FilterListConfiguration& AddCategoryValues(CategoryValuesT&& value) {
    m_categoryValuesHasBeenSet = true;
  ...
  inline FilterListConfiguration& WithSelectAllOptions(CategoryFilterSelectAllOptions value) {
  ...
  inline FilterListConfiguration& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
