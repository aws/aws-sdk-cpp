...
class TopicIRMetric {
 public:
  ...
  void SetComparisonMethod(ComparisonMethodT&& value) {
    ...
    m_comparisonMethod = std::forward<ComparisonMethodT>(value);
  }
  template <typename ComparisonMethodT = TopicIRComparisonMethod>
  TopicIRMetric& WithComparisonMethod(ComparisonMethodT&& value) {
    SetComparisonMethod(std::forward<ComparisonMethodT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCalculatedFieldReferences(CalculatedFieldReferencesT&& value) {
    ...
    m_calculatedFieldReferences = std::forward<CalculatedFieldReferencesT>(value);
  }
  template <typename CalculatedFieldReferencesT = Aws::Vector<Identifier>>
  TopicIRMetric& WithCalculatedFieldReferences(CalculatedFieldReferencesT&& value) {
    SetCalculatedFieldReferences(std::forward<CalculatedFieldReferencesT>(value));
    return *this;
  }
  ...
  TopicIRMetric& AddCalculatedFieldReferences(CalculatedFieldReferencesT&& value) {
    m_calculatedFieldReferencesHasBeenSet = true;
    m_calculatedFieldReferences.emplace_back(std::forward<CalculatedFieldReferencesT>(value));
    return *this;
  }
  ///@}
  ...
  inline TopicIRMetric& WithDisplayFormat(DisplayFormat value) {
