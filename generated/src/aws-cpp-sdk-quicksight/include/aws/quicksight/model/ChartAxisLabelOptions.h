...
class ChartAxisLabelOptions {
 public:
  ...
  inline ChartAxisLabelOptions& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortIconVisibility(Visibility value) {
    m_sortIconVisibilityHasBeenSet = true;
    m_sortIconVisibility = value;
  }
  inline ChartAxisLabelOptions& WithSortIconVisibility(Visibility value) {
    SetSortIconVisibility(value);
    return *this;
  }
  ///@}
