...
namespace Model {
class SearchKnowledgeBasesResult {
 public:
  AWS_QUICKSIGHT_API SearchKnowledgeBasesResult() = default;
  AWS_QUICKSIGHT_API SearchKnowledgeBasesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API SearchKnowledgeBasesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename KnowledgeBaseSummariesT = Aws::Vector<KnowledgeBaseSummary>>
  SearchKnowledgeBasesResult& WithKnowledgeBaseSummaries(KnowledgeBaseSummariesT&& value) {
  ...
  SearchKnowledgeBasesResult& AddKnowledgeBaseSummaries(KnowledgeBaseSummariesT&& value) {
    m_knowledgeBaseSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchKnowledgeBasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchKnowledgeBasesResult& WithRequestId(RequestIdT&& value) {
  ...
  inline SearchKnowledgeBasesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
