...
class TopicVisual {
 public:
  ...
  inline void SetRole(VisualRole value) {
    m_roleHasBeenSet = true;
    m_role = value;
  }
  inline TopicVisual& WithRole(VisualRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  void SetIr(IrT&& value) {
    m_irHasBeenSet = true;
    m_ir = std::forward<IrT>(value);
  }
  template <typename IrT = TopicIR>
  TopicVisual& WithIr(IrT&& value) {
    SetIr(std::forward<IrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportingVisuals(SupportingVisualsT&& value) {
    ...
    m_supportingVisuals = std::forward<SupportingVisualsT>(value);
  }
  template <typename SupportingVisualsT = Aws::Vector<TopicVisual>>
  TopicVisual& WithSupportingVisuals(SupportingVisualsT&& value) {
    SetSupportingVisuals(std::forward<SupportingVisualsT>(value));
    return *this;
  }
  template <typename SupportingVisualsT = TopicVisual>
  TopicVisual& AddSupportingVisuals(SupportingVisualsT&& value) {
    m_supportingVisualsHasBeenSet = true;
    m_supportingVisuals.emplace_back(std::forward<SupportingVisualsT>(value));
    return *this;
  }
  ///@}
 private:
