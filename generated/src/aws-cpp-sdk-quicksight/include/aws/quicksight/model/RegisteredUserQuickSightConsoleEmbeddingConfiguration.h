...
/**
 * <p>Information about the Amazon Quick Sight console that you want to
...
class RegisteredUserQuickSightConsoleEmbeddingConfiguration {
 public:
  ...
  ///@{
  /**
   * <p>The initial URL path for the Amazon Quick Sight console.
   ...
   * the actual ID key from the Amazon Quick Sight console URL of the dashboard.</p>
   * </li> <li> <p> <code>/analyses/AnalysisId</code>. <i>AnalysisId</i> is the
   * actual ID key from the Amazon Quick Sight console URL of the analysis.</p> </li>
   * </ul>
   */
  ...
  void SetInitialPath(InitialPathT&& value) {
    m_initialPathHasBeenSet = true;
    m_initialPath = std::forward<InitialPathT>(value);
  }
  template <typename InitialPathT = Aws::String>
  RegisteredUserQuickSightConsoleEmbeddingConfiguration& WithInitialPath(InitialPathT&& value) {
    SetInitialPath(std::forward<InitialPathT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FeatureConfigurationsT = RegisteredUserConsoleFeatureConfigurations>
  RegisteredUserQuickSightConsoleEmbeddingConfiguration& WithFeatureConfigurations(FeatureConfigurationsT&& value) {
