...
namespace Model
{
  ...
  public:
    ...
    inline ResourceExistsException& WithResourceType(ExceptionResourceType value) { SetResourceType(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ResourceExistsException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
