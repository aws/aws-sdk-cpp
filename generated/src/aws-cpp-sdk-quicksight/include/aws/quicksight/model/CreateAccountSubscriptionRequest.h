...
class CreateAccountSubscriptionRequest : public QuickSightRequest {
 public:
  ...
  inline CreateAccountSubscriptionRequest& WithEdition(Edition value) {
    SetEdition(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAuthenticationMethod(AuthenticationMethodOption value) {
    m_authenticationMethodHasBeenSet = true;
    m_authenticationMethod = value;
  }
  inline CreateAccountSubscriptionRequest& WithAuthenticationMethod(AuthenticationMethodOption value) {
  ...
  void SetActiveDirectoryName(ActiveDirectoryNameT&& value) {
    m_activeDirectoryNameHasBeenSet = true;
    m_activeDirectoryName = std::forward<ActiveDirectoryNameT>(value);
  }
  template <typename ActiveDirectoryNameT = Aws::String>
  CreateAccountSubscriptionRequest& WithActiveDirectoryName(ActiveDirectoryNameT&& value) {
    SetActiveDirectoryName(std::forward<ActiveDirectoryNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorGroup(AuthorGroupT&& value) {
    m_authorGroupHasBeenSet = true;
    m_authorGroup = std::forward<AuthorGroupT>(value);
  }
  template <typename AuthorGroupT = Aws::Vector<Aws::String>>
  CreateAccountSubscriptionRequest& WithAuthorGroup(AuthorGroupT&& value) {
    SetAuthorGroup(std::forward<AuthorGroupT>(value));
    return *this;
  }
  template <typename AuthorGroupT = Aws::String>
  CreateAccountSubscriptionRequest& AddAuthorGroup(AuthorGroupT&& value) {
    m_authorGroupHasBeenSet = true;
    m_authorGroup.emplace_back(std::forward<AuthorGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReaderGroup(ReaderGroupT&& value) {
    m_readerGroupHasBeenSet = true;
    m_readerGroup = std::forward<ReaderGroupT>(value);
  }
  template <typename ReaderGroupT = Aws::Vector<Aws::String>>
  CreateAccountSubscriptionRequest& WithReaderGroup(ReaderGroupT&& value) {
    SetReaderGroup(std::forward<ReaderGroupT>(value));
    return *this;
  }
  template <typename ReaderGroupT = Aws::String>
  CreateAccountSubscriptionRequest& AddReaderGroup(ReaderGroupT&& value) {
    m_readerGroupHasBeenSet = true;
    m_readerGroup.emplace_back(std::forward<ReaderGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdminProGroup(AdminProGroupT&& value) {
    m_adminProGroupHasBeenSet = true;
    m_adminProGroup = std::forward<AdminProGroupT>(value);
  }
  template <typename AdminProGroupT = Aws::Vector<Aws::String>>
  CreateAccountSubscriptionRequest& WithAdminProGroup(AdminProGroupT&& value) {
    SetAdminProGroup(std::forward<AdminProGroupT>(value));
    return *this;
  }
  template <typename AdminProGroupT = Aws::String>
  CreateAccountSubscriptionRequest& AddAdminProGroup(AdminProGroupT&& value) {
    m_adminProGroupHasBeenSet = true;
    m_adminProGroup.emplace_back(std::forward<AdminProGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorProGroup(AuthorProGroupT&& value) {
    m_authorProGroupHasBeenSet = true;
    m_authorProGroup = std::forward<AuthorProGroupT>(value);
  }
  template <typename AuthorProGroupT = Aws::Vector<Aws::String>>
  CreateAccountSubscriptionRequest& WithAuthorProGroup(AuthorProGroupT&& value) {
    SetAuthorProGroup(std::forward<AuthorProGroupT>(value));
    return *this;
  }
  template <typename AuthorProGroupT = Aws::String>
  CreateAccountSubscriptionRequest& AddAuthorProGroup(AuthorProGroupT&& value) {
    m_authorProGroupHasBeenSet = true;
    m_authorProGroup.emplace_back(std::forward<AuthorProGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReaderProGroup(ReaderProGroupT&& value) {
    m_readerProGroupHasBeenSet = true;
    m_readerProGroup = std::forward<ReaderProGroupT>(value);
  }
  template <typename ReaderProGroupT = Aws::Vector<Aws::String>>
  CreateAccountSubscriptionRequest& WithReaderProGroup(ReaderProGroupT&& value) {
    SetReaderProGroup(std::forward<ReaderProGroupT>(value));
    return *this;
  }
  template <typename ReaderProGroupT = Aws::String>
  CreateAccountSubscriptionRequest& AddReaderProGroup(ReaderProGroupT&& value) {
    m_readerProGroupHasBeenSet = true;
    m_readerProGroup.emplace_back(std::forward<ReaderProGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactNumber(ContactNumberT&& value) {
    ...
    m_contactNumber = std::forward<ContactNumberT>(value);
  }
  template <typename ContactNumberT = Aws::String>
  CreateAccountSubscriptionRequest& WithContactNumber(ContactNumberT&& value) {
    SetContactNumber(std::forward<ContactNumberT>(value));
    return *this;
  }
  ///@}
