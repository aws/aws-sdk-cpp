...
class ColumnGroup {
 public:
  ...
  void SetGeoSpatialColumnGroup(GeoSpatialColumnGroupT&& value) {
    m_geoSpatialColumnGroupHasBeenSet = true;
    m_geoSpatialColumnGroup = std::forward<GeoSpatialColumnGroupT>(value);
  }
  template <typename GeoSpatialColumnGroupT = GeoSpatialColumnGroup>
  ColumnGroup& WithGeoSpatialColumnGroup(GeoSpatialColumnGroupT&& value) {
    SetGeoSpatialColumnGroup(std::forward<GeoSpatialColumnGroupT>(value));
    return *this;
  }
  ///@}
 private:
