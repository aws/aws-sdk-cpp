...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DescribeFolderResolvedPermissionsRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeFolderResolvedPermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FolderIdT = Aws::String>
    DescribeFolderResolvedPermissionsRequest& WithFolderId(FolderIdT&& value) { SetFolderId(std::forward<FolderIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DescribeFolderResolvedPermissionsRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeFolderResolvedPermissionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
