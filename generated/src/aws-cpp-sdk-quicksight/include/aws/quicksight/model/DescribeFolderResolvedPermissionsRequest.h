...
class DescribeFolderResolvedPermissionsRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeFolderResolvedPermissionsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename FolderIdT = Aws::String>
  DescribeFolderResolvedPermissionsRequest& WithFolderId(FolderIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DescribeFolderResolvedPermissionsRequest& WithNamespace(NamespaceT&& value) {
  ...
  inline DescribeFolderResolvedPermissionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFolderResolvedPermissionsRequest& WithNextToken(NextTokenT&& value) {
