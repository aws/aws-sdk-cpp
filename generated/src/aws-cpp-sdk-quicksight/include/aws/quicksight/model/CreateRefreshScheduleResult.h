...
namespace Model
{
  ...
  public:
    ...
    template<typename RequestIdT = Aws::String>
    CreateRefreshScheduleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleIdT = Aws::String>
    CreateRefreshScheduleResult& WithScheduleId(ScheduleIdT&& value) { SetScheduleId(std::forward<ScheduleIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    CreateRefreshScheduleResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
