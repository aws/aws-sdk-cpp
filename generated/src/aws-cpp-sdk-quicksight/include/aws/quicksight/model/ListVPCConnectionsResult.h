...
class ListVPCConnectionsResult {
 public:
  ...
  void SetVPCConnectionSummaries(VPCConnectionSummariesT&& value) {
    m_vPCConnectionSummariesHasBeenSet = true;
    m_vPCConnectionSummaries = std::forward<VPCConnectionSummariesT>(value);
  }
  template <typename VPCConnectionSummariesT = Aws::Vector<VPCConnectionSummary>>
  ListVPCConnectionsResult& WithVPCConnectionSummaries(VPCConnectionSummariesT&& value) {
    SetVPCConnectionSummaries(std::forward<VPCConnectionSummariesT>(value));
    return *this;
  }
  template <typename VPCConnectionSummariesT = VPCConnectionSummary>
  ListVPCConnectionsResult& AddVPCConnectionSummaries(VPCConnectionSummariesT&& value) {
    m_vPCConnectionSummariesHasBeenSet = true;
    m_vPCConnectionSummaries.emplace_back(std::forward<VPCConnectionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVPCConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVPCConnectionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline ListVPCConnectionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
