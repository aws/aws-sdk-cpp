...
class ApplicationTheme {
 public:
  ...
  void SetBrandColorPalette(BrandColorPaletteT&& value) {
    ...
    m_brandColorPalette = std::forward<BrandColorPaletteT>(value);
  }
  template <typename BrandColorPaletteT = BrandColorPalette>
  ApplicationTheme& WithBrandColorPalette(BrandColorPaletteT&& value) {
    SetBrandColorPalette(std::forward<BrandColorPaletteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContextualAccentPalette(ContextualAccentPaletteT&& value) {
    ...
    m_contextualAccentPalette = std::forward<ContextualAccentPaletteT>(value);
  }
  template <typename ContextualAccentPaletteT = ContextualAccentPalette>
  ApplicationTheme& WithContextualAccentPalette(ContextualAccentPaletteT&& value) {
    SetContextualAccentPalette(std::forward<ContextualAccentPaletteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBrandElementStyle(BrandElementStyleT&& value) {
    ...
    m_brandElementStyle = std::forward<BrandElementStyleT>(value);
  }
  template <typename BrandElementStyleT = BrandElementStyle>
  ApplicationTheme& WithBrandElementStyle(BrandElementStyleT&& value) {
    SetBrandElementStyle(std::forward<BrandElementStyleT>(value));
    return *this;
  }
  ///@}
 private:
