...
class RowAlternateColorOptions {
 public:
  ...
  inline RowAlternateColorOptions& WithStatus(WidgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRowAlternateColors(RowAlternateColorsT&& value) {
    m_rowAlternateColorsHasBeenSet = true;
    m_rowAlternateColors = std::forward<RowAlternateColorsT>(value);
  }
  template <typename RowAlternateColorsT = Aws::Vector<Aws::String>>
  RowAlternateColorOptions& WithRowAlternateColors(RowAlternateColorsT&& value) {
    SetRowAlternateColors(std::forward<RowAlternateColorsT>(value));
    return *this;
  }
  template <typename RowAlternateColorsT = Aws::String>
  RowAlternateColorOptions& AddRowAlternateColors(RowAlternateColorsT&& value) {
    m_rowAlternateColorsHasBeenSet = true;
    m_rowAlternateColors.emplace_back(std::forward<RowAlternateColorsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUsePrimaryBackgroundColor(WidgetStatus value) {
    m_usePrimaryBackgroundColorHasBeenSet = true;
    m_usePrimaryBackgroundColor = value;
  }
  inline RowAlternateColorOptions& WithUsePrimaryBackgroundColor(WidgetStatus value) {
    SetUsePrimaryBackgroundColor(value);
    return *this;
  }
  ///@}
 private:
