...
class WaterfallChartColorConfiguration {
 public:
  ...
  void SetGroupColorConfiguration(GroupColorConfigurationT&& value) {
    m_groupColorConfigurationHasBeenSet = true;
    m_groupColorConfiguration = std::forward<GroupColorConfigurationT>(value);
  }
  template <typename GroupColorConfigurationT = WaterfallChartGroupColorConfiguration>
  WaterfallChartColorConfiguration& WithGroupColorConfiguration(GroupColorConfigurationT&& value) {
    SetGroupColorConfiguration(std::forward<GroupColorConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
