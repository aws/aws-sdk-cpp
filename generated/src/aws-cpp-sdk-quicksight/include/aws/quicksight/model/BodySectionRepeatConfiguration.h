...
class BodySectionRepeatConfiguration {
 public:
   ...
   */
  inline const Aws::Vector<BodySectionRepeatDimensionConfiguration>& GetDimensionConfigurations() const {
    return m_dimensionConfigurations;
  }
  ...
  void SetPageBreakConfiguration(PageBreakConfigurationT&& value) {
    ...
    m_pageBreakConfiguration = std::forward<PageBreakConfigurationT>(value);
  }
  template <typename PageBreakConfigurationT = BodySectionRepeatPageBreakConfiguration>
  BodySectionRepeatConfiguration& WithPageBreakConfiguration(PageBreakConfigurationT&& value) {
    SetPageBreakConfiguration(std::forward<PageBreakConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonRepeatingVisuals(NonRepeatingVisualsT&& value) {
    ...
    m_nonRepeatingVisuals = std::forward<NonRepeatingVisualsT>(value);
  }
  template <typename NonRepeatingVisualsT = Aws::Vector<Aws::String>>
  BodySectionRepeatConfiguration& WithNonRepeatingVisuals(NonRepeatingVisualsT&& value) {
    SetNonRepeatingVisuals(std::forward<NonRepeatingVisualsT>(value));
    return *this;
  }
  ...
  BodySectionRepeatConfiguration& AddNonRepeatingVisuals(NonRepeatingVisualsT&& value) {
    m_nonRepeatingVisualsHasBeenSet = true;
    m_nonRepeatingVisuals.emplace_back(std::forward<NonRepeatingVisualsT>(value));
    return *this;
  }
  ///@}
 private:
