...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API SheetImageStaticFileSource() = default;
    ...
    template<typename StaticFileIdT = Aws::String>
    SheetImageStaticFileSource& WithStaticFileId(StaticFileIdT&& value) { SetStaticFileId(std::forward<StaticFileIdT>(value)); return *this;}
    ///@}
  private:
