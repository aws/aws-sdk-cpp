...
class StarburstParameters {
 public:
  ...
  inline StarburstParameters& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetProductType(StarburstProductType value) {
    m_productTypeHasBeenSet = true;
    m_productType = value;
  }
  inline StarburstParameters& WithProductType(StarburstProductType value) {
  ...
  void SetDatabaseAccessControlRole(DatabaseAccessControlRoleT&& value) {
    ...
    m_databaseAccessControlRole = std::forward<DatabaseAccessControlRoleT>(value);
  }
  template <typename DatabaseAccessControlRoleT = Aws::String>
  StarburstParameters& WithDatabaseAccessControlRole(DatabaseAccessControlRoleT&& value) {
    SetDatabaseAccessControlRole(std::forward<DatabaseAccessControlRoleT>(value));
    return *this;
  }
  ///@}
  ...
  inline StarburstParameters& WithAuthenticationType(AuthenticationType value) {
