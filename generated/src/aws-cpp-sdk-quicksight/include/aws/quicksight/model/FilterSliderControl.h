...
class FilterSliderControl {
 public:
  ...
  template <typename FilterControlIdT = Aws::String>
  FilterSliderControl& WithFilterControlId(FilterControlIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  FilterSliderControl& WithTitle(TitleT&& value) {
  ...
  template <typename SourceFilterIdT = Aws::String>
  FilterSliderControl& WithSourceFilterId(SourceFilterIdT&& value) {
  ...
  template <typename DisplayOptionsT = SliderControlDisplayOptions>
  FilterSliderControl& WithDisplayOptions(DisplayOptionsT&& value) {
  ...
  inline void SetType(SheetControlSliderType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FilterSliderControl& WithType(SheetControlSliderType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaximumValue(double value) {
    m_maximumValueHasBeenSet = true;
    m_maximumValue = value;
  }
  inline FilterSliderControl& WithMaximumValue(double value) {
  ...
  inline void SetMinimumValue(double value) {
    m_minimumValueHasBeenSet = true;
    m_minimumValue = value;
  }
  inline FilterSliderControl& WithMinimumValue(double value) {
  ...
  inline FilterSliderControl& WithStepSize(double value) {
    SetStepSize(value);
    return *this;
  }
  ///@}
