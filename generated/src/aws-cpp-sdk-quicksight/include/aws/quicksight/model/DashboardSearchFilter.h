...
class DashboardSearchFilter {
 public:
  ...
  inline DashboardSearchFilter& WithOperator(FilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetName(DashboardFilterAttribute value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DashboardSearchFilter& WithName(DashboardFilterAttribute value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  DashboardSearchFilter& WithValue(ValueT&& value) {
