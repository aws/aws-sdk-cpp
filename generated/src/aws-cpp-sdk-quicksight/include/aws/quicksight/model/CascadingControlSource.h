...
class CascadingControlSource {
 public:
  ...
  void SetSourceSheetControlId(SourceSheetControlIdT&& value) {
    m_sourceSheetControlIdHasBeenSet = true;
    m_sourceSheetControlId = std::forward<SourceSheetControlIdT>(value);
  }
  template <typename SourceSheetControlIdT = Aws::String>
  CascadingControlSource& WithSourceSheetControlId(SourceSheetControlIdT&& value) {
    SetSourceSheetControlId(std::forward<SourceSheetControlIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColumnToMatch(ColumnToMatchT&& value) {
    m_columnToMatchHasBeenSet = true;
    m_columnToMatch = std::forward<ColumnToMatchT>(value);
  }
  template <typename ColumnToMatchT = ColumnIdentifier>
  CascadingControlSource& WithColumnToMatch(ColumnToMatchT&& value) {
    SetColumnToMatch(std::forward<ColumnToMatchT>(value));
    return *this;
  }
  ///@}
 private:
