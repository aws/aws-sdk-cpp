...
class DataBarsOptions {
 public:
  ...
  void SetPositiveColor(PositiveColorT&& value) {
    ...
    m_positiveColor = std::forward<PositiveColorT>(value);
  }
  template <typename PositiveColorT = Aws::String>
  DataBarsOptions& WithPositiveColor(PositiveColorT&& value) {
    SetPositiveColor(std::forward<PositiveColorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNegativeColor(NegativeColorT&& value) {
    ...
    m_negativeColor = std::forward<NegativeColorT>(value);
  }
  template <typename NegativeColorT = Aws::String>
  DataBarsOptions& WithNegativeColor(NegativeColorT&& value) {
    SetNegativeColor(std::forward<NegativeColorT>(value));
    return *this;
  }
  ///@}
 private:
