...
class TopicCategoryFilterConstant {
 public:
  ...
  inline TopicCategoryFilterConstant& WithConstantType(ConstantType value) {
  ...
  void SetSingularConstant(SingularConstantT&& value) {
    m_singularConstantHasBeenSet = true;
    m_singularConstant = std::forward<SingularConstantT>(value);
  }
  template <typename SingularConstantT = Aws::String>
  TopicCategoryFilterConstant& WithSingularConstant(SingularConstantT&& value) {
    SetSingularConstant(std::forward<SingularConstantT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCollectiveConstant(CollectiveConstantT&& value) {
    m_collectiveConstantHasBeenSet = true;
    m_collectiveConstant = std::forward<CollectiveConstantT>(value);
  }
  template <typename CollectiveConstantT = CollectiveConstant>
  TopicCategoryFilterConstant& WithCollectiveConstant(CollectiveConstantT&& value) {
    SetCollectiveConstant(std::forward<CollectiveConstantT>(value));
    return *this;
  }
  ///@}
 private:
