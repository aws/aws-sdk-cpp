...
class FilterGroup {
 public:
  ...
  void SetFilterGroupId(FilterGroupIdT&& value) {
    m_filterGroupIdHasBeenSet = true;
    m_filterGroupId = std::forward<FilterGroupIdT>(value);
  }
  template <typename FilterGroupIdT = Aws::String>
  FilterGroup& WithFilterGroupId(FilterGroupIdT&& value) {
    SetFilterGroupId(std::forward<FilterGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  FilterGroup& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  FilterGroup& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename ScopeConfigurationT = FilterScopeConfiguration>
  FilterGroup& WithScopeConfiguration(ScopeConfigurationT&& value) {
  ...
  inline void SetStatus(WidgetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline FilterGroup& WithStatus(WidgetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrossDataset(CrossDatasetTypes value) {
    m_crossDatasetHasBeenSet = true;
    m_crossDataset = value;
  }
  inline FilterGroup& WithCrossDataset(CrossDatasetTypes value) {
    SetCrossDataset(value);
    return *this;
  }
  ///@}
 private:
