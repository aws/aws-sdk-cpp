...
class FilterScopeConfiguration {
 public:
  ...
  void SetSelectedSheets(SelectedSheetsT&& value) {
    m_selectedSheetsHasBeenSet = true;
    m_selectedSheets = std::forward<SelectedSheetsT>(value);
  }
  template <typename SelectedSheetsT = SelectedSheetsFilterScopeConfiguration>
  FilterScopeConfiguration& WithSelectedSheets(SelectedSheetsT&& value) {
    SetSelectedSheets(std::forward<SelectedSheetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllSheets(AllSheetsT&& value) {
    m_allSheetsHasBeenSet = true;
    m_allSheets = std::forward<AllSheetsT>(value);
  }
  template <typename AllSheetsT = AllSheetsFilterScopeConfiguration>
  FilterScopeConfiguration& WithAllSheets(AllSheetsT&& value) {
    SetAllSheets(std::forward<AllSheetsT>(value));
    return *this;
  }
  ///@}
 private:
