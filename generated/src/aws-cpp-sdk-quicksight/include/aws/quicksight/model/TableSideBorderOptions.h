...
class TableSideBorderOptions {
 public:
  ...
  void SetInnerVertical(InnerVerticalT&& value) {
    ...
    m_innerVertical = std::forward<InnerVerticalT>(value);
  }
  template <typename InnerVerticalT = TableBorderOptions>
  TableSideBorderOptions& WithInnerVertical(InnerVerticalT&& value) {
    SetInnerVertical(std::forward<InnerVerticalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInnerHorizontal(InnerHorizontalT&& value) {
    ...
    m_innerHorizontal = std::forward<InnerHorizontalT>(value);
  }
  template <typename InnerHorizontalT = TableBorderOptions>
  TableSideBorderOptions& WithInnerHorizontal(InnerHorizontalT&& value) {
    SetInnerHorizontal(std::forward<InnerHorizontalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTop(TopT&& value) {
    ...
    m_top = std::forward<TopT>(value);
  }
  template <typename TopT = TableBorderOptions>
  TableSideBorderOptions& WithTop(TopT&& value) {
    SetTop(std::forward<TopT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBottom(BottomT&& value) {
    ...
    m_bottom = std::forward<BottomT>(value);
  }
  template <typename BottomT = TableBorderOptions>
  TableSideBorderOptions& WithBottom(BottomT&& value) {
    SetBottom(std::forward<BottomT>(value));
    return *this;
  }
  ///@}
 private:
