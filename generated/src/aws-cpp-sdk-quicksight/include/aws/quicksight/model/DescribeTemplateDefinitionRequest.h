...
class DescribeTemplateDefinitionRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeTemplateDefinitionRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  DescribeTemplateDefinitionRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  inline DescribeTemplateDefinitionRequest& WithVersionNumber(long long value) {
  ...
  template <typename AliasNameT = Aws::String>
  DescribeTemplateDefinitionRequest& WithAliasName(AliasNameT&& value) {
