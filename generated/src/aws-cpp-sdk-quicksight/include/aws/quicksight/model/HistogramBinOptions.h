...
class HistogramBinOptions {
 public:
  ...
  inline void SetSelectedBinType(HistogramBinType value) {
    m_selectedBinTypeHasBeenSet = true;
    m_selectedBinType = value;
  }
  inline HistogramBinOptions& WithSelectedBinType(HistogramBinType value) {
    SetSelectedBinType(value);
    return *this;
  }
  ///@}
  ...
  void SetBinCount(BinCountT&& value) {
    ...
    m_binCount = std::forward<BinCountT>(value);
  }
  template <typename BinCountT = BinCountOptions>
  HistogramBinOptions& WithBinCount(BinCountT&& value) {
    SetBinCount(std::forward<BinCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBinWidth(BinWidthT&& value) {
    ...
    m_binWidth = std::forward<BinWidthT>(value);
  }
  template <typename BinWidthT = BinWidthOptions>
  HistogramBinOptions& WithBinWidth(BinWidthT&& value) {
    SetBinWidth(std::forward<BinWidthT>(value));
    return *this;
  }
  ///@}
  ...
  inline HistogramBinOptions& WithStartValue(double value) {
    SetStartValue(value);
    return *this;
  }
  ///@}
