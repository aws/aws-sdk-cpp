...
class SnapshotFile {
 public:
  ...
  void SetSheetSelections(SheetSelectionsT&& value) {
    ...
    m_sheetSelections = std::forward<SheetSelectionsT>(value);
  }
  template <typename SheetSelectionsT = Aws::Vector<SnapshotFileSheetSelection>>
  SnapshotFile& WithSheetSelections(SheetSelectionsT&& value) {
    SetSheetSelections(std::forward<SheetSelectionsT>(value));
    return *this;
  }
  template <typename SheetSelectionsT = SnapshotFileSheetSelection>
  SnapshotFile& AddSheetSelections(SheetSelectionsT&& value) {
    m_sheetSelectionsHasBeenSet = true;
    m_sheetSelections.emplace_back(std::forward<SheetSelectionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFormatType(SnapshotFileFormatType value) {
    m_formatTypeHasBeenSet = true;
    m_formatType = value;
  }
  inline SnapshotFile& WithFormatType(SnapshotFileFormatType value) {
    SetFormatType(value);
    return *this;
  }
  ///@}
