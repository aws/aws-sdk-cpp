...
class CustomColor {
 public:
  ...
  template <typename FieldValueT = Aws::String>
  CustomColor& WithFieldValue(FieldValueT&& value) {
  ...
  template <typename ColorT = Aws::String>
  CustomColor& WithColor(ColorT&& value) {
  ...
  inline void SetSpecialValue(SpecialValue value) {
    m_specialValueHasBeenSet = true;
    m_specialValue = value;
  }
  inline CustomColor& WithSpecialValue(SpecialValue value) {
