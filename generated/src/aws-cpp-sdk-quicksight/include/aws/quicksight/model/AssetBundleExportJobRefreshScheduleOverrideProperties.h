...
class AssetBundleExportJobRefreshScheduleOverrideProperties {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssetBundleExportJobRefreshScheduleOverrideProperties& WithArn(ArnT&& value) {
  ...
  template <typename PropertiesT = Aws::Vector<AssetBundleExportJobRefreshSchedulePropertyToOverride>>
  AssetBundleExportJobRefreshScheduleOverrideProperties& WithProperties(PropertiesT&& value) {
    SetProperties(std::forward<PropertiesT>(value));
    return *this;
  }
  inline AssetBundleExportJobRefreshScheduleOverrideProperties& AddProperties(AssetBundleExportJobRefreshSchedulePropertyToOverride value) {
    m_propertiesHasBeenSet = true;
