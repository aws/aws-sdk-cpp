...
class TreeMapSortConfiguration {
 public:
  ...
  void SetTreeMapSort(TreeMapSortT&& value) {
    m_treeMapSortHasBeenSet = true;
    m_treeMapSort = std::forward<TreeMapSortT>(value);
  }
  template <typename TreeMapSortT = Aws::Vector<FieldSortOptions>>
  TreeMapSortConfiguration& WithTreeMapSort(TreeMapSortT&& value) {
    SetTreeMapSort(std::forward<TreeMapSortT>(value));
    return *this;
  }
  template <typename TreeMapSortT = FieldSortOptions>
  TreeMapSortConfiguration& AddTreeMapSort(TreeMapSortT&& value) {
    m_treeMapSortHasBeenSet = true;
    m_treeMapSort.emplace_back(std::forward<TreeMapSortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTreeMapGroupItemsLimitConfiguration(TreeMapGroupItemsLimitConfigurationT&& value) {
    m_treeMapGroupItemsLimitConfigurationHasBeenSet = true;
    m_treeMapGroupItemsLimitConfiguration = std::forward<TreeMapGroupItemsLimitConfigurationT>(value);
  }
  template <typename TreeMapGroupItemsLimitConfigurationT = ItemsLimitConfiguration>
  TreeMapSortConfiguration& WithTreeMapGroupItemsLimitConfiguration(TreeMapGroupItemsLimitConfigurationT&& value) {
    SetTreeMapGroupItemsLimitConfiguration(std::forward<TreeMapGroupItemsLimitConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
