...
class GeospatialNullSymbolStyle {
 public:
  ...
  void SetStrokeColor(StrokeColorT&& value) {
    ...
    m_strokeColor = std::forward<StrokeColorT>(value);
  }
  template <typename StrokeColorT = Aws::String>
  GeospatialNullSymbolStyle& WithStrokeColor(StrokeColorT&& value) {
    SetStrokeColor(std::forward<StrokeColorT>(value));
    return *this;
  }
  ///@}
  ...
  inline GeospatialNullSymbolStyle& WithStrokeWidth(double value) {
