...
class ColumnConfiguration {
 public:
  ...
  inline void SetRole(ColumnRole value) {
    m_roleHasBeenSet = true;
    m_role = value;
  }
  inline ColumnConfiguration& WithRole(ColumnRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  void SetColorsConfiguration(ColorsConfigurationT&& value) {
    ...
    m_colorsConfiguration = std::forward<ColorsConfigurationT>(value);
  }
  template <typename ColorsConfigurationT = ColorsConfiguration>
  ColumnConfiguration& WithColorsConfiguration(ColorsConfigurationT&& value) {
    SetColorsConfiguration(std::forward<ColorsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
