...
namespace Model
{
  ...
  public:
    ...
    inline DashboardVersion& WithOptions(const AssetOptions& value) { SetOptions(value); return *this;}

    
    inline DashboardVersion& WithOptions(AssetOptions&& value) { SetOptions(std::move(value)); return *this;}
