...
class AttributeAggregationFunction {
 public:
  ...
  inline void SetSimpleAttributeAggregation(SimpleAttributeAggregationFunction value) {
    m_simpleAttributeAggregationHasBeenSet = true;
    m_simpleAttributeAggregation = value;
  }
  inline AttributeAggregationFunction& WithSimpleAttributeAggregation(SimpleAttributeAggregationFunction value) {
    SetSimpleAttributeAggregation(value);
    return *this;
  }
  ///@}
  ...
  void SetValueForMultipleValues(ValueForMultipleValuesT&& value) {
    ...
    m_valueForMultipleValues = std::forward<ValueForMultipleValuesT>(value);
  }
  template <typename ValueForMultipleValuesT = Aws::String>
  AttributeAggregationFunction& WithValueForMultipleValues(ValueForMultipleValuesT&& value) {
    SetValueForMultipleValues(std::forward<ValueForMultipleValuesT>(value));
    return *this;
  }
  ///@}
 private:
