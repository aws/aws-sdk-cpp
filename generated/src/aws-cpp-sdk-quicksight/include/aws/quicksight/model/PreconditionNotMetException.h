...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API PreconditionNotMetException() = default;
    ...
    template<typename MessageT = Aws::String>
    PreconditionNotMetException& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PreconditionNotMetException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
