...
/**
 * <p>The background style configuration of a grid layout element.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/GridLayoutElementBackgroundStyle">AWS
 * API Reference</a></p>
 */
class GridLayoutElementBackgroundStyle {
 public:
  ...
  inline GridLayoutElementBackgroundStyle& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
