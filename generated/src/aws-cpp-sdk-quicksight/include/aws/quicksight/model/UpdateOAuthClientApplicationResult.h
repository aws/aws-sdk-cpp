...
namespace Model {
class UpdateOAuthClientApplicationResult {
 public:
  AWS_QUICKSIGHT_API UpdateOAuthClientApplicationResult() = default;
  AWS_QUICKSIGHT_API UpdateOAuthClientApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API UpdateOAuthClientApplicationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  UpdateOAuthClientApplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename OAuthClientApplicationIdT = Aws::String>
  UpdateOAuthClientApplicationResult& WithOAuthClientApplicationId(OAuthClientApplicationIdT&& value) {
  ...
  inline UpdateOAuthClientApplicationResult& WithUpdateStatus(ResourceStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOAuthClientApplicationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateOAuthClientApplicationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
