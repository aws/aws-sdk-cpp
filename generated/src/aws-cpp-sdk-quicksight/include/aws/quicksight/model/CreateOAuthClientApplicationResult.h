...
namespace Model {
class CreateOAuthClientApplicationResult {
 public:
  AWS_QUICKSIGHT_API CreateOAuthClientApplicationResult() = default;
  AWS_QUICKSIGHT_API CreateOAuthClientApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API CreateOAuthClientApplicationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ArnT = Aws::String>
  CreateOAuthClientApplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename OAuthClientApplicationIdT = Aws::String>
  CreateOAuthClientApplicationResult& WithOAuthClientApplicationId(OAuthClientApplicationIdT&& value) {
  ...
  inline CreateOAuthClientApplicationResult& WithCreationStatus(ResourceStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateOAuthClientApplicationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline CreateOAuthClientApplicationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
