...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API AmazonOpenSearchParameters() = default;
    ...
    template<typename DomainT = Aws::String>
    AmazonOpenSearchParameters& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
  private:
