...
/**
 */
class ListAgentsRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API ListAgentsRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  ListAgentsRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  inline ListAgentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
