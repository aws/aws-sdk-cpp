...
/**
 */
class DescribeSpacePermissionsRequest : public QuickSightRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeSpacePermissions"; }
