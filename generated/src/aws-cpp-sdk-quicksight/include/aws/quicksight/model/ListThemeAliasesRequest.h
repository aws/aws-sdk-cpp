...
class ListThemeAliasesRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  ListThemeAliasesRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename ThemeIdT = Aws::String>
  ListThemeAliasesRequest& WithThemeId(ThemeIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListThemeAliasesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListThemeAliasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
