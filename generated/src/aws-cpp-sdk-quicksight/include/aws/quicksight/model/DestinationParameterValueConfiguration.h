...
class DestinationParameterValueConfiguration {
 public:
  ...
  void SetCustomValuesConfiguration(CustomValuesConfigurationT&& value) {
    ...
    m_customValuesConfiguration = std::forward<CustomValuesConfigurationT>(value);
  }
  template <typename CustomValuesConfigurationT = CustomValuesConfiguration>
  DestinationParameterValueConfiguration& WithCustomValuesConfiguration(CustomValuesConfigurationT&& value) {
    SetCustomValuesConfiguration(std::forward<CustomValuesConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSelectAllValueOptions(SelectAllValueOptions value) {
    m_selectAllValueOptionsHasBeenSet = true;
    m_selectAllValueOptions = value;
  }
  inline DestinationParameterValueConfiguration& WithSelectAllValueOptions(SelectAllValueOptions value) {
    SetSelectAllValueOptions(value);
    return *this;
  }
  ///@}
