...
class KPISparklineOptions {
 public:
  ...
  inline KPISparklineOptions& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(KPISparklineType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline KPISparklineOptions& WithType(KPISparklineType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ColorT = Aws::String>
  KPISparklineOptions& WithColor(ColorT&& value) {
  ...
  inline KPISparklineOptions& WithTooltipVisibility(Visibility value) {
