...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ListDataSetsRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    ListDataSetsRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
