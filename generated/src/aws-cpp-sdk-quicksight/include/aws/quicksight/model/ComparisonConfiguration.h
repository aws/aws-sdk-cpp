...
class ComparisonConfiguration {
 public:
  ...
  inline void SetComparisonMethod(ComparisonMethod value) {
    m_comparisonMethodHasBeenSet = true;
    m_comparisonMethod = value;
  }
  inline ComparisonConfiguration& WithComparisonMethod(ComparisonMethod value) {
    SetComparisonMethod(value);
    return *this;
  }
  ///@}
  ...
  void SetComparisonFormat(ComparisonFormatT&& value) {
    ...
    m_comparisonFormat = std::forward<ComparisonFormatT>(value);
  }
  template <typename ComparisonFormatT = ComparisonFormatConfiguration>
  ComparisonConfiguration& WithComparisonFormat(ComparisonFormatT&& value) {
    SetComparisonFormat(std::forward<ComparisonFormatT>(value));
    return *this;
  }
  ///@}
 private:
