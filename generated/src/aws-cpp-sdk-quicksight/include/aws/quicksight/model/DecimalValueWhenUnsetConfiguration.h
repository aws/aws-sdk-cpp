...
class DecimalValueWhenUnsetConfiguration {
 public:
  ...
  inline DecimalValueWhenUnsetConfiguration& WithValueWhenUnsetOption(ValueWhenUnsetOption value) {
  ...
  inline void SetCustomValue(double value) {
    m_customValueHasBeenSet = true;
    m_customValue = value;
  }
  inline DecimalValueWhenUnsetConfiguration& WithCustomValue(double value) {
