...
class WaterfallVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  WaterfallVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  WaterfallVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  WaterfallVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = WaterfallChartConfiguration>
  WaterfallVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  WaterfallVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  WaterfallVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  WaterfallVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  WaterfallVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  WaterfallVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
