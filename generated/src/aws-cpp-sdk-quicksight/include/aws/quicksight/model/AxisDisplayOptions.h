...
class AxisDisplayOptions {
 public:
  ...
  void SetTickLabelOptions(TickLabelOptionsT&& value) {
    ...
    m_tickLabelOptions = std::forward<TickLabelOptionsT>(value);
  }
  template <typename TickLabelOptionsT = AxisTickLabelOptions>
  AxisDisplayOptions& WithTickLabelOptions(TickLabelOptionsT&& value) {
    SetTickLabelOptions(std::forward<TickLabelOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAxisLineVisibility(Visibility value) {
    m_axisLineVisibilityHasBeenSet = true;
    m_axisLineVisibility = value;
  }
  inline AxisDisplayOptions& WithAxisLineVisibility(Visibility value) {
    SetAxisLineVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGridLineVisibility(Visibility value) {
    m_gridLineVisibilityHasBeenSet = true;
    m_gridLineVisibility = value;
  }
  inline AxisDisplayOptions& WithGridLineVisibility(Visibility value) {
    SetGridLineVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetDataOptions(DataOptionsT&& value) {
    ...
    m_dataOptions = std::forward<DataOptionsT>(value);
  }
  template <typename DataOptionsT = AxisDataOptions>
  AxisDisplayOptions& WithDataOptions(DataOptionsT&& value) {
    SetDataOptions(std::forward<DataOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetScrollbarOptions(ScrollbarOptionsT&& value) {
    ...
    m_scrollbarOptions = std::forward<ScrollbarOptionsT>(value);
  }
  template <typename ScrollbarOptionsT = ScrollBarOptions>
  AxisDisplayOptions& WithScrollbarOptions(ScrollbarOptionsT&& value) {
    SetScrollbarOptions(std::forward<ScrollbarOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAxisOffset(AxisOffsetT&& value) {
    ...
    m_axisOffset = std::forward<AxisOffsetT>(value);
  }
  template <typename AxisOffsetT = Aws::String>
  AxisDisplayOptions& WithAxisOffset(AxisOffsetT&& value) {
    SetAxisOffset(std::forward<AxisOffsetT>(value));
    return *this;
  }
  ///@}
 private:
