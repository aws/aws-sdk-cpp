...
class TopBottomFilter {
 public:
  ...
  template <typename FilterIdT = Aws::String>
  TopBottomFilter& WithFilterId(FilterIdT&& value) {
  ...
  template <typename ColumnT = ColumnIdentifier>
  TopBottomFilter& WithColumn(ColumnT&& value) {
  ...
  inline TopBottomFilter& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<AggregationSortConfiguration>& GetAggregationSortConfigurations() const {
    return m_aggregationSortConfigurations;
  }
  ...
  void SetAggregationSortConfigurations(AggregationSortConfigurationsT&& value) {
    m_aggregationSortConfigurationsHasBeenSet = true;
    m_aggregationSortConfigurations = std::forward<AggregationSortConfigurationsT>(value);
  }
  template <typename AggregationSortConfigurationsT = Aws::Vector<AggregationSortConfiguration>>
  TopBottomFilter& WithAggregationSortConfigurations(AggregationSortConfigurationsT&& value) {
    SetAggregationSortConfigurations(std::forward<AggregationSortConfigurationsT>(value));
    return *this;
  }
  template <typename AggregationSortConfigurationsT = AggregationSortConfiguration>
  TopBottomFilter& AddAggregationSortConfigurations(AggregationSortConfigurationsT&& value) {
    m_aggregationSortConfigurationsHasBeenSet = true;
    m_aggregationSortConfigurations.emplace_back(std::forward<AggregationSortConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline TopBottomFilter& WithTimeGranularity(TimeGranularity value) {
  ...
  template <typename ParameterNameT = Aws::String>
  TopBottomFilter& WithParameterName(ParameterNameT&& value) {
  ...
  template <typename DefaultFilterControlConfigurationT = DefaultFilterControlConfiguration>
  TopBottomFilter& WithDefaultFilterControlConfiguration(DefaultFilterControlConfigurationT&& value) {
