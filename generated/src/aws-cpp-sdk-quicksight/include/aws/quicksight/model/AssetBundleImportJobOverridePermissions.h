...
class AssetBundleImportJobOverridePermissions {
 public:
  ...
  template <typename DataSourcesT = Aws::Vector<AssetBundleImportJobDataSourceOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithDataSources(DataSourcesT&& value) {
  ...
  AssetBundleImportJobOverridePermissions& AddDataSources(DataSourcesT&& value) {
    m_dataSourcesHasBeenSet = true;
  ...
  template <typename DataSetsT = Aws::Vector<AssetBundleImportJobDataSetOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithDataSets(DataSetsT&& value) {
    SetDataSets(std::forward<DataSetsT>(value));
    return *this;
  }
  template <typename DataSetsT = AssetBundleImportJobDataSetOverridePermissions>
  AssetBundleImportJobOverridePermissions& AddDataSets(DataSetsT&& value) {
    m_dataSetsHasBeenSet = true;
  ...
  template <typename ThemesT = Aws::Vector<AssetBundleImportJobThemeOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithThemes(ThemesT&& value) {
    SetThemes(std::forward<ThemesT>(value));
    return *this;
  }
  template <typename ThemesT = AssetBundleImportJobThemeOverridePermissions>
  AssetBundleImportJobOverridePermissions& AddThemes(ThemesT&& value) {
    m_themesHasBeenSet = true;
  ...
  template <typename AnalysesT = Aws::Vector<AssetBundleImportJobAnalysisOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithAnalyses(AnalysesT&& value) {
    SetAnalyses(std::forward<AnalysesT>(value));
    return *this;
  }
  template <typename AnalysesT = AssetBundleImportJobAnalysisOverridePermissions>
  AssetBundleImportJobOverridePermissions& AddAnalyses(AnalysesT&& value) {
    m_analysesHasBeenSet = true;
  ...
  template <typename DashboardsT = Aws::Vector<AssetBundleImportJobDashboardOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithDashboards(DashboardsT&& value) {
  ...
  AssetBundleImportJobOverridePermissions& AddDashboards(DashboardsT&& value) {
    m_dashboardsHasBeenSet = true;
  ...
  template <typename FoldersT = Aws::Vector<AssetBundleImportJobFolderOverridePermissions>>
  AssetBundleImportJobOverridePermissions& WithFolders(FoldersT&& value) {
    SetFolders(std::forward<FoldersT>(value));
    return *this;
  }
  template <typename FoldersT = AssetBundleImportJobFolderOverridePermissions>
  AssetBundleImportJobOverridePermissions& AddFolders(FoldersT&& value) {
    m_foldersHasBeenSet = true;
