...
class CreateBrandResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  CreateBrandResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename BrandDetailT = BrandDetail>
  CreateBrandResult& WithBrandDetail(BrandDetailT&& value) {
  ...
  template <typename BrandDefinitionT = BrandDefinition>
  CreateBrandResult& WithBrandDefinition(BrandDefinitionT&& value) {
