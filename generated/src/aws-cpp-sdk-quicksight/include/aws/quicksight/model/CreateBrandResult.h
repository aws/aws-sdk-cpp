...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API CreateBrandResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateBrandResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BrandDetailT = BrandDetail>
    CreateBrandResult& WithBrandDetail(BrandDetailT&& value) { SetBrandDetail(std::forward<BrandDetailT>(value)); return *this;}
    ///@}
    ...
    template<typename BrandDefinitionT = BrandDefinition>
    CreateBrandResult& WithBrandDefinition(BrandDefinitionT&& value) { SetBrandDefinition(std::forward<BrandDefinitionT>(value)); return *this;}
    ///@}
  private:
