...
namespace Model
{
  class DeleteActionConnectorResult
  {
  public:
    ...
    template<typename ArnT = Aws::String>
    DeleteActionConnectorResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionConnectorIdT = Aws::String>
    DeleteActionConnectorResult& WithActionConnectorId(ActionConnectorIdT&& value) { SetActionConnectorId(std::forward<ActionConnectorIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteActionConnectorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteActionConnectorResult& WithStatus(int value) { SetStatus(value); return *this;}
    ///@}
  private:
