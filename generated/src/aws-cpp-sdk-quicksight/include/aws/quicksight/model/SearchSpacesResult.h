...
namespace Model {
class SearchSpacesResult {
 public:
  AWS_QUICKSIGHT_API SearchSpacesResult() = default;
  AWS_QUICKSIGHT_API SearchSpacesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API SearchSpacesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SpaceIdT = Aws::String>
  SearchSpacesResult& WithSpaceId(SpaceIdT&& value) {
  ...
  template <typename SpaceArnT = Aws::String>
  SearchSpacesResult& WithSpaceArn(SpaceArnT&& value) {
  ...
  template <typename SpaceSummariesT = Aws::Vector<SpaceSummary>>
  SearchSpacesResult& WithSpaceSummaries(SpaceSummariesT&& value) {
    SetSpaceSummaries(std::forward<SpaceSummariesT>(value));
    return *this;
  }
  template <typename SpaceSummariesT = SpaceSummary>
  SearchSpacesResult& AddSpaceSummaries(SpaceSummariesT&& value) {
    m_spaceSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchSpacesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchSpacesResult& WithRequestId(RequestIdT&& value) {
