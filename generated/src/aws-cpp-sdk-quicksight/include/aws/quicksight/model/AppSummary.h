...
/**
 * <p>A summary of an app, including its identifier, name, and
 * metadata.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/AppSummary">AWS
 * API Reference</a></p>
 */
class AppSummary {
 public:
  ...
  ///@{
  /**
   * <p>The sharing status of the app: <code>PUBLIC</code> if the app is shared
   * publicly, or <code>PRIVATE</code> if it is private.</p>
   */
  inline AppVisibility GetVisibility() const { return m_visibility; }
  inline bool VisibilityHasBeenSet() const { return m_visibilityHasBeenSet; }
  inline void SetVisibility(AppVisibility value) {
    m_visibilityHasBeenSet = true;
    m_visibility = value;
  }
  inline AppSummary& WithVisibility(AppVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
 private:
  ...
  AppVisibility m_visibility{AppVisibility::NOT_SET};
