...
class SetParameterValueConfiguration {
 public:
  ...
  void SetDestinationParameterName(DestinationParameterNameT&& value) {
    m_destinationParameterNameHasBeenSet = true;
    m_destinationParameterName = std::forward<DestinationParameterNameT>(value);
  }
  template <typename DestinationParameterNameT = Aws::String>
  SetParameterValueConfiguration& WithDestinationParameterName(DestinationParameterNameT&& value) {
    SetDestinationParameterName(std::forward<DestinationParameterNameT>(value));
    return *this;
  }
  ///@}
