...
class ListIAMPolicyAssignmentsResult {
 public:
  ...
  void SetIAMPolicyAssignments(IAMPolicyAssignmentsT&& value) {
    m_iAMPolicyAssignmentsHasBeenSet = true;
    m_iAMPolicyAssignments = std::forward<IAMPolicyAssignmentsT>(value);
  }
  template <typename IAMPolicyAssignmentsT = Aws::Vector<IAMPolicyAssignmentSummary>>
  ListIAMPolicyAssignmentsResult& WithIAMPolicyAssignments(IAMPolicyAssignmentsT&& value) {
    SetIAMPolicyAssignments(std::forward<IAMPolicyAssignmentsT>(value));
    return *this;
  }
  template <typename IAMPolicyAssignmentsT = IAMPolicyAssignmentSummary>
  ListIAMPolicyAssignmentsResult& AddIAMPolicyAssignments(IAMPolicyAssignmentsT&& value) {
    m_iAMPolicyAssignmentsHasBeenSet = true;
    m_iAMPolicyAssignments.emplace_back(std::forward<IAMPolicyAssignmentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIAMPolicyAssignmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIAMPolicyAssignmentsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline ListIAMPolicyAssignmentsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
