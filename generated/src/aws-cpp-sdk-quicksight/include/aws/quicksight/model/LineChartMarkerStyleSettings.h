...
class LineChartMarkerStyleSettings {
 public:
  ...
  inline void SetMarkerVisibility(Visibility value) {
    m_markerVisibilityHasBeenSet = true;
    m_markerVisibility = value;
  }
  inline LineChartMarkerStyleSettings& WithMarkerVisibility(Visibility value) {
  ...
  inline void SetMarkerShape(LineChartMarkerShape value) {
    m_markerShapeHasBeenSet = true;
    m_markerShape = value;
  }
  inline LineChartMarkerStyleSettings& WithMarkerShape(LineChartMarkerShape value) {
  ...
  void SetMarkerSize(MarkerSizeT&& value) {
    m_markerSizeHasBeenSet = true;
    m_markerSize = std::forward<MarkerSizeT>(value);
  }
  template <typename MarkerSizeT = Aws::String>
  LineChartMarkerStyleSettings& WithMarkerSize(MarkerSizeT&& value) {
    SetMarkerSize(std::forward<MarkerSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMarkerColor(MarkerColorT&& value) {
    m_markerColorHasBeenSet = true;
    m_markerColor = std::forward<MarkerColorT>(value);
  }
  template <typename MarkerColorT = Aws::String>
  LineChartMarkerStyleSettings& WithMarkerColor(MarkerColorT&& value) {
    SetMarkerColor(std::forward<MarkerColorT>(value));
    return *this;
  }
  ///@}
 private:
