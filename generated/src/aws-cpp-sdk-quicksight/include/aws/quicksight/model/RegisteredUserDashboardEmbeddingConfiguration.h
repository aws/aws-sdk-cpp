...
class RegisteredUserDashboardEmbeddingConfiguration {
 public:
   ...
   * Quick Sight renders this dashboard if the user has permissions to view it.</p>
  ...
  template <typename InitialDashboardIdT = Aws::String>
  RegisteredUserDashboardEmbeddingConfiguration& WithInitialDashboardId(InitialDashboardIdT&& value) {
  ...
  template <typename FeatureConfigurationsT = RegisteredUserDashboardFeatureConfigurations>
  RegisteredUserDashboardEmbeddingConfiguration& WithFeatureConfigurations(FeatureConfigurationsT&& value) {
