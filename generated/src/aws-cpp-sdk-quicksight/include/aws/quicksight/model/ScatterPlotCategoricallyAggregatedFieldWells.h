...
class ScatterPlotCategoricallyAggregatedFieldWells {
 public:
  ...
  template <typename XAxisT = Aws::Vector<MeasureField>>
  ScatterPlotCategoricallyAggregatedFieldWells& WithXAxis(XAxisT&& value) {
    SetXAxis(std::forward<XAxisT>(value));
    return *this;
  }
  template <typename XAxisT = MeasureField>
  ScatterPlotCategoricallyAggregatedFieldWells& AddXAxis(XAxisT&& value) {
    m_xAxisHasBeenSet = true;
  ...
  template <typename YAxisT = Aws::Vector<MeasureField>>
  ScatterPlotCategoricallyAggregatedFieldWells& WithYAxis(YAxisT&& value) {
    SetYAxis(std::forward<YAxisT>(value));
    return *this;
  }
  template <typename YAxisT = MeasureField>
  ScatterPlotCategoricallyAggregatedFieldWells& AddYAxis(YAxisT&& value) {
    m_yAxisHasBeenSet = true;
  ...
  template <typename CategoryT = Aws::Vector<DimensionField>>
  ScatterPlotCategoricallyAggregatedFieldWells& WithCategory(CategoryT&& value) {
    SetCategory(std::forward<CategoryT>(value));
    return *this;
  }
  template <typename CategoryT = DimensionField>
  ScatterPlotCategoricallyAggregatedFieldWells& AddCategory(CategoryT&& value) {
    m_categoryHasBeenSet = true;
  ...
  template <typename SizeT = Aws::Vector<MeasureField>>
  ScatterPlotCategoricallyAggregatedFieldWells& WithSize(SizeT&& value) {
    SetSize(std::forward<SizeT>(value));
    return *this;
  }
  template <typename SizeT = MeasureField>
  ScatterPlotCategoricallyAggregatedFieldWells& AddSize(SizeT&& value) {
    m_sizeHasBeenSet = true;
  ...
  template <typename LabelT = Aws::Vector<DimensionField>>
  ScatterPlotCategoricallyAggregatedFieldWells& WithLabel(LabelT&& value) {
    SetLabel(std::forward<LabelT>(value));
    return *this;
  }
  template <typename LabelT = DimensionField>
  ScatterPlotCategoricallyAggregatedFieldWells& AddLabel(LabelT&& value) {
    m_labelHasBeenSet = true;
