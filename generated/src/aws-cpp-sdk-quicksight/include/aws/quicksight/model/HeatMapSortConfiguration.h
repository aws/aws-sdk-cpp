...
class HeatMapSortConfiguration {
 public:
  ...
  void SetHeatMapRowSort(HeatMapRowSortT&& value) {
    m_heatMapRowSortHasBeenSet = true;
    m_heatMapRowSort = std::forward<HeatMapRowSortT>(value);
  }
  template <typename HeatMapRowSortT = Aws::Vector<FieldSortOptions>>
  HeatMapSortConfiguration& WithHeatMapRowSort(HeatMapRowSortT&& value) {
    SetHeatMapRowSort(std::forward<HeatMapRowSortT>(value));
    return *this;
  }
  template <typename HeatMapRowSortT = FieldSortOptions>
  HeatMapSortConfiguration& AddHeatMapRowSort(HeatMapRowSortT&& value) {
    m_heatMapRowSortHasBeenSet = true;
    m_heatMapRowSort.emplace_back(std::forward<HeatMapRowSortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeatMapColumnSort(HeatMapColumnSortT&& value) {
    m_heatMapColumnSortHasBeenSet = true;
    m_heatMapColumnSort = std::forward<HeatMapColumnSortT>(value);
  }
  template <typename HeatMapColumnSortT = Aws::Vector<FieldSortOptions>>
  HeatMapSortConfiguration& WithHeatMapColumnSort(HeatMapColumnSortT&& value) {
    SetHeatMapColumnSort(std::forward<HeatMapColumnSortT>(value));
    return *this;
  }
  template <typename HeatMapColumnSortT = FieldSortOptions>
  HeatMapSortConfiguration& AddHeatMapColumnSort(HeatMapColumnSortT&& value) {
    m_heatMapColumnSortHasBeenSet = true;
    m_heatMapColumnSort.emplace_back(std::forward<HeatMapColumnSortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeatMapRowItemsLimitConfiguration(HeatMapRowItemsLimitConfigurationT&& value) {
    m_heatMapRowItemsLimitConfigurationHasBeenSet = true;
    m_heatMapRowItemsLimitConfiguration = std::forward<HeatMapRowItemsLimitConfigurationT>(value);
  }
  template <typename HeatMapRowItemsLimitConfigurationT = ItemsLimitConfiguration>
  HeatMapSortConfiguration& WithHeatMapRowItemsLimitConfiguration(HeatMapRowItemsLimitConfigurationT&& value) {
    SetHeatMapRowItemsLimitConfiguration(std::forward<HeatMapRowItemsLimitConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeatMapColumnItemsLimitConfiguration(HeatMapColumnItemsLimitConfigurationT&& value) {
    m_heatMapColumnItemsLimitConfigurationHasBeenSet = true;
    m_heatMapColumnItemsLimitConfiguration = std::forward<HeatMapColumnItemsLimitConfigurationT>(value);
  }
  template <typename HeatMapColumnItemsLimitConfigurationT = ItemsLimitConfiguration>
  HeatMapSortConfiguration& WithHeatMapColumnItemsLimitConfiguration(HeatMapColumnItemsLimitConfigurationT&& value) {
    SetHeatMapColumnItemsLimitConfiguration(std::forward<HeatMapColumnItemsLimitConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
