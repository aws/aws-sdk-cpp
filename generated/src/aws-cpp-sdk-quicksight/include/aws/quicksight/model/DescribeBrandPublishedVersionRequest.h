...
class DescribeBrandPublishedVersionRequest : public QuickSightRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeBrandPublishedVersion"; }
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeBrandPublishedVersionRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename BrandIdT = Aws::String>
  DescribeBrandPublishedVersionRequest& WithBrandId(BrandIdT&& value) {
