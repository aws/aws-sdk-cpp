...
class PluginVisualOptions {
 public:
  ...
  void SetVisualProperties(VisualPropertiesT&& value) {
    m_visualPropertiesHasBeenSet = true;
    m_visualProperties = std::forward<VisualPropertiesT>(value);
  }
  template <typename VisualPropertiesT = Aws::Vector<PluginVisualProperty>>
  PluginVisualOptions& WithVisualProperties(VisualPropertiesT&& value) {
    SetVisualProperties(std::forward<VisualPropertiesT>(value));
    return *this;
  }
  template <typename VisualPropertiesT = PluginVisualProperty>
  PluginVisualOptions& AddVisualProperties(VisualPropertiesT&& value) {
    m_visualPropertiesHasBeenSet = true;
    m_visualProperties.emplace_back(std::forward<VisualPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
