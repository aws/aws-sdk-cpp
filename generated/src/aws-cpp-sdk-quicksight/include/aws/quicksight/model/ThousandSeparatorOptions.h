...
class ThousandSeparatorOptions {
 public:
  ...
  inline void SetSymbol(NumericSeparatorSymbol value) {
    m_symbolHasBeenSet = true;
    m_symbol = value;
  }
  inline ThousandSeparatorOptions& WithSymbol(NumericSeparatorSymbol value) {
    SetSymbol(value);
    return *this;
  }
  ///@}
  ...
  inline ThousandSeparatorOptions& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGroupingStyle(DigitGroupingStyle value) {
    m_groupingStyleHasBeenSet = true;
    m_groupingStyle = value;
  }
  inline ThousandSeparatorOptions& WithGroupingStyle(DigitGroupingStyle value) {
    SetGroupingStyle(value);
    return *this;
  }
  ///@}
 private:
