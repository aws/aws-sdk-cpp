...
class TableVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  TableVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  TableVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  TableVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = TableConfiguration>
  TableVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ConditionalFormattingT = TableConditionalFormatting>
  TableVisual& WithConditionalFormatting(ConditionalFormattingT&& value) {
  ...
  template <typename VisualContentAltTextT = Aws::String>
  TableVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
