...
class DescribeDefaultQBusinessApplicationRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeDefaultQBusinessApplicationRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename NamespaceT = Aws::String>
  DescribeDefaultQBusinessApplicationRequest& WithNamespace(NamespaceT&& value) {
