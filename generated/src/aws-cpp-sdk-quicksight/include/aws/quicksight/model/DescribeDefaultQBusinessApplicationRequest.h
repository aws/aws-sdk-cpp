...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DescribeDefaultQBusinessApplicationRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    DescribeDefaultQBusinessApplicationRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    DescribeDefaultQBusinessApplicationRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
  private:
