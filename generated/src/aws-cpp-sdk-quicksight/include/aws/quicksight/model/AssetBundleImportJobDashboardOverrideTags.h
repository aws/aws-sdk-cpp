...
class AssetBundleImportJobDashboardOverrideTags {
 public:
  ...
  template <typename DashboardIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobDashboardOverrideTags& WithDashboardIds(DashboardIdsT&& value) {
    SetDashboardIds(std::forward<DashboardIdsT>(value));
    return *this;
  }
  template <typename DashboardIdsT = Aws::String>
  AssetBundleImportJobDashboardOverrideTags& AddDashboardIds(DashboardIdsT&& value) {
    m_dashboardIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobDashboardOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobDashboardOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
