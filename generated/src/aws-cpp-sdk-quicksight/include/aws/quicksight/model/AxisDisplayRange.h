...
class AxisDisplayRange {
 public:
  ...
  void SetMinMax(MinMaxT&& value) {
    ...
    m_minMax = std::forward<MinMaxT>(value);
  }
  template <typename MinMaxT = AxisDisplayMinMaxRange>
  AxisDisplayRange& WithMinMax(MinMaxT&& value) {
    SetMinMax(std::forward<MinMaxT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataDriven(DataDrivenT&& value) {
    ...
    m_dataDriven = std::forward<DataDrivenT>(value);
  }
  template <typename DataDrivenT = AxisDisplayDataDrivenRange>
  AxisDisplayRange& WithDataDriven(DataDrivenT&& value) {
    SetDataDriven(std::forward<DataDrivenT>(value));
    return *this;
  }
  ///@}
 private:
