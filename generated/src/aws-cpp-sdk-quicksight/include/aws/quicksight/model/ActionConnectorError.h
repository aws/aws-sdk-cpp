...
class ActionConnectorError {
 public:
  ...
  template <typename MessageT = Aws::String>
  ActionConnectorError& WithMessage(MessageT&& value) {
  ...
  inline void SetType(ActionConnectorErrorType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ActionConnectorError& WithType(ActionConnectorErrorType value) {
    SetType(value);
    return *this;
  }
  ///@}
