...
class AssetBundleImportJobFolderOverrideTags {
 public:
  ...
  template <typename FolderIdsT = Aws::Vector<Aws::String>>
  AssetBundleImportJobFolderOverrideTags& WithFolderIds(FolderIdsT&& value) {
    SetFolderIds(std::forward<FolderIdsT>(value));
    return *this;
  }
  template <typename FolderIdsT = Aws::String>
  AssetBundleImportJobFolderOverrideTags& AddFolderIds(FolderIdsT&& value) {
    m_folderIdsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  AssetBundleImportJobFolderOverrideTags& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  AssetBundleImportJobFolderOverrideTags& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
