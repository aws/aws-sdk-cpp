...
class DescribeTemplatePermissionsResult {
 public:
  ...
  template <typename TemplateIdT = Aws::String>
  DescribeTemplatePermissionsResult& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename TemplateArnT = Aws::String>
  DescribeTemplatePermissionsResult& WithTemplateArn(TemplateArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeTemplatePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeTemplatePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTemplatePermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeTemplatePermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
