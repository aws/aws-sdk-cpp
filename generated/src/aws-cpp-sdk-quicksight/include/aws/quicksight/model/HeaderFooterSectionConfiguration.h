...
class HeaderFooterSectionConfiguration {
 public:
  ...
  void SetSectionId(SectionIdT&& value) {
    ...
    m_sectionId = std::forward<SectionIdT>(value);
  }
  template <typename SectionIdT = Aws::String>
  HeaderFooterSectionConfiguration& WithSectionId(SectionIdT&& value) {
    SetSectionId(std::forward<SectionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LayoutT = SectionLayoutConfiguration>
  HeaderFooterSectionConfiguration& WithLayout(LayoutT&& value) {
  ...
  template <typename StyleT = SectionStyle>
  HeaderFooterSectionConfiguration& WithStyle(StyleT&& value) {
