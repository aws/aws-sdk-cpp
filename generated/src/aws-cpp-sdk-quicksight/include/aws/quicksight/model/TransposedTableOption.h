...
class TransposedTableOption {
 public:
  ...
  inline TransposedTableOption& WithColumnIndex(int value) {
  ...
  void SetColumnWidth(ColumnWidthT&& value) {
    ...
    m_columnWidth = std::forward<ColumnWidthT>(value);
  }
  template <typename ColumnWidthT = Aws::String>
  TransposedTableOption& WithColumnWidth(ColumnWidthT&& value) {
    SetColumnWidth(std::forward<ColumnWidthT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetColumnType(TransposedColumnType value) {
    m_columnTypeHasBeenSet = true;
    m_columnType = value;
  }
  inline TransposedTableOption& WithColumnType(TransposedColumnType value) {
    SetColumnType(value);
    return *this;
  }
  ///@}
