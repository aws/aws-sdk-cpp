...
class ConditionalFormattingCustomIconOptions {
 public:
  ...
  inline void SetIcon(Icon value) {
    m_iconHasBeenSet = true;
    m_icon = value;
  }
  inline ConditionalFormattingCustomIconOptions& WithIcon(Icon value) {
    SetIcon(value);
    return *this;
  }
  ///@}
  ...
  void SetUnicodeIcon(UnicodeIconT&& value) {
    m_unicodeIconHasBeenSet = true;
    m_unicodeIcon = std::forward<UnicodeIconT>(value);
  }
  template <typename UnicodeIconT = Aws::String>
  ConditionalFormattingCustomIconOptions& WithUnicodeIcon(UnicodeIconT&& value) {
    SetUnicodeIcon(std::forward<UnicodeIconT>(value));
    return *this;
  }
  ///@}
 private:
