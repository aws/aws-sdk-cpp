...
class DeleteTemplateRequest : public QuickSightRequest {
 public:
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteTemplateRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  DeleteTemplateRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  inline DeleteTemplateRequest& WithVersionNumber(long long value) {
