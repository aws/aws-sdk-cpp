...
namespace Model {
class DescribeSpacePermissionsResult {
 public:
  AWS_QUICKSIGHT_API DescribeSpacePermissionsResult() = default;
  AWS_QUICKSIGHT_API DescribeSpacePermissionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_QUICKSIGHT_API DescribeSpacePermissionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename SpaceIdT = Aws::String>
  DescribeSpacePermissionsResult& WithSpaceId(SpaceIdT&& value) {
  ...
  template <typename SpaceArnT = Aws::String>
  DescribeSpacePermissionsResult& WithSpaceArn(SpaceArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeSpacePermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeSpacePermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSpacePermissionsResult& WithRequestId(RequestIdT&& value) {
