...
class DescribeDashboardPermissionsResult {
 public:
  ...
  template <typename DashboardIdT = Aws::String>
  DescribeDashboardPermissionsResult& WithDashboardId(DashboardIdT&& value) {
  ...
  template <typename DashboardArnT = Aws::String>
  DescribeDashboardPermissionsResult& WithDashboardArn(DashboardArnT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  DescribeDashboardPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  DescribeDashboardPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  inline DescribeDashboardPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeDashboardPermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename LinkSharingConfigurationT = LinkSharingConfiguration>
  DescribeDashboardPermissionsResult& WithLinkSharingConfiguration(LinkSharingConfigurationT&& value) {
