...
class ListThemesRequest : public QuickSightRequest {
 public:
  ...
  inline ListThemesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   * by people using Amazon Quick Sight.</p> </li> <li> <p> <code>QUICKSIGHT</code> -
   * Display only the starting themes defined by Quick Sight.</p> </li> </ul>
   */
  ...
  inline ListThemesRequest& WithType(ThemeType value) {
    SetType(value);
    return *this;
  }
  ///@}
