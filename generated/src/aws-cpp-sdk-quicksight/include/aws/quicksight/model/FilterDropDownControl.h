...
class FilterDropDownControl {
 public:
  ...
  template <typename FilterControlIdT = Aws::String>
  FilterDropDownControl& WithFilterControlId(FilterControlIdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  FilterDropDownControl& WithTitle(TitleT&& value) {
  ...
  template <typename SourceFilterIdT = Aws::String>
  FilterDropDownControl& WithSourceFilterId(SourceFilterIdT&& value) {
  ...
  template <typename DisplayOptionsT = DropDownControlDisplayOptions>
  FilterDropDownControl& WithDisplayOptions(DisplayOptionsT&& value) {
  ...
  inline FilterDropDownControl& WithType(SheetControlListType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SelectableValuesT = FilterSelectableValues>
  FilterDropDownControl& WithSelectableValues(SelectableValuesT&& value) {
  ...
  template <typename CascadingControlConfigurationT = CascadingControlConfiguration>
  FilterDropDownControl& WithCascadingControlConfiguration(CascadingControlConfigurationT&& value) {
  ...
  inline FilterDropDownControl& WithCommitMode(CommitMode value) {
    SetCommitMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ControlSortConfigurationsT = Aws::Vector<ControlSortConfiguration>>
  FilterDropDownControl& WithControlSortConfigurations(ControlSortConfigurationsT&& value) {
  ...
  FilterDropDownControl& AddControlSortConfigurations(ControlSortConfigurationsT&& value) {
    m_controlSortConfigurationsHasBeenSet = true;
