...
class SelectedSheetsFilterScopeConfiguration {
 public:
   ...
   * applied to.</p>
   */
  inline const Aws::Vector<SheetVisualScopingConfiguration>& GetSheetVisualScopingConfigurations() const {
    return m_sheetVisualScopingConfigurations;
  }
  ...
  void SetSheetVisualScopingConfigurations(SheetVisualScopingConfigurationsT&& value) {
    m_sheetVisualScopingConfigurationsHasBeenSet = true;
    m_sheetVisualScopingConfigurations = std::forward<SheetVisualScopingConfigurationsT>(value);
  }
  template <typename SheetVisualScopingConfigurationsT = Aws::Vector<SheetVisualScopingConfiguration>>
  SelectedSheetsFilterScopeConfiguration& WithSheetVisualScopingConfigurations(SheetVisualScopingConfigurationsT&& value) {
    SetSheetVisualScopingConfigurations(std::forward<SheetVisualScopingConfigurationsT>(value));
    return *this;
  }
  template <typename SheetVisualScopingConfigurationsT = SheetVisualScopingConfiguration>
  SelectedSheetsFilterScopeConfiguration& AddSheetVisualScopingConfigurations(SheetVisualScopingConfigurationsT&& value) {
    m_sheetVisualScopingConfigurationsHasBeenSet = true;
    m_sheetVisualScopingConfigurations.emplace_back(std::forward<SheetVisualScopingConfigurationsT>(value));
    return *this;
  }
  ///@}
 private:
