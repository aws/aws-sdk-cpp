...
class SameSheetTargetVisualConfiguration {
 public:
  ...
  inline void SetTargetVisualOptions(TargetVisualOptions value) {
    m_targetVisualOptionsHasBeenSet = true;
    m_targetVisualOptions = value;
  }
  inline SameSheetTargetVisualConfiguration& WithTargetVisualOptions(TargetVisualOptions value) {
    SetTargetVisualOptions(value);
    return *this;
  }
  ///@}
 private:
