...
class GetSessionEmbedUrlRequest : public QuickSightRequest {
 public:
  ...
  ///@{
  /**
   * <p>The ID for the Amazon Web Services account associated with your Amazon Quick
   * Sight subscription.</p>
   */
   ...
   * console URL of the dashboard</p> </li> <li> <p>
  ...
  inline GetSessionEmbedUrlRequest& WithSessionLifetimeInMinutes(long long value) {
   ...
   * Quick users in your account (readers, authors, or admins). They need to be
