...
class PivotTableFieldCollapseStateTarget {
 public:
  ...
  template <typename FieldIdT = Aws::String>
  PivotTableFieldCollapseStateTarget& WithFieldId(FieldIdT&& value) {
  ...
  void SetFieldDataPathValues(FieldDataPathValuesT&& value) {
    m_fieldDataPathValuesHasBeenSet = true;
    m_fieldDataPathValues = std::forward<FieldDataPathValuesT>(value);
  }
  template <typename FieldDataPathValuesT = Aws::Vector<DataPathValue>>
  PivotTableFieldCollapseStateTarget& WithFieldDataPathValues(FieldDataPathValuesT&& value) {
    SetFieldDataPathValues(std::forward<FieldDataPathValuesT>(value));
    return *this;
  }
  template <typename FieldDataPathValuesT = DataPathValue>
  PivotTableFieldCollapseStateTarget& AddFieldDataPathValues(FieldDataPathValuesT&& value) {
    m_fieldDataPathValuesHasBeenSet = true;
    m_fieldDataPathValues.emplace_back(std::forward<FieldDataPathValuesT>(value));
    return *this;
  }
  ///@}
 private:
