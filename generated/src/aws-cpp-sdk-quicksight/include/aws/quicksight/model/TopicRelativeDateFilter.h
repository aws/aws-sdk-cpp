...
class TopicRelativeDateFilter {
 public:
  ...
  inline TopicRelativeDateFilter& WithTimeGranularity(TopicTimeGranularity value) {
  ...
  inline void SetRelativeDateFilterFunction(TopicRelativeDateFilterFunction value) {
    m_relativeDateFilterFunctionHasBeenSet = true;
    m_relativeDateFilterFunction = value;
  }
  inline TopicRelativeDateFilter& WithRelativeDateFilterFunction(TopicRelativeDateFilterFunction value) {
    SetRelativeDateFilterFunction(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConstantT = TopicSingularFilterConstant>
  TopicRelativeDateFilter& WithConstant(ConstantT&& value) {
