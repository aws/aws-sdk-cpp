...
class QAResult {
 public:
  ...
  inline void SetResultType(QAResultType value) {
    m_resultTypeHasBeenSet = true;
    m_resultType = value;
  }
  inline QAResult& WithResultType(QAResultType value) {
    SetResultType(value);
    return *this;
  }
  ///@}
  ...
  void SetDashboardVisual(DashboardVisualT&& value) {
    ...
    m_dashboardVisual = std::forward<DashboardVisualT>(value);
  }
  template <typename DashboardVisualT = DashboardVisualResult>
  QAResult& WithDashboardVisual(DashboardVisualT&& value) {
    SetDashboardVisual(std::forward<DashboardVisualT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeneratedAnswer(GeneratedAnswerT&& value) {
    ...
    m_generatedAnswer = std::forward<GeneratedAnswerT>(value);
  }
  template <typename GeneratedAnswerT = GeneratedAnswerResult>
  QAResult& WithGeneratedAnswer(GeneratedAnswerT&& value) {
    SetGeneratedAnswer(std::forward<GeneratedAnswerT>(value));
    return *this;
  }
  ///@}
 private:
