...
class DescribeAccountCustomPermissionResult {
 public:
  ...
  AWS_QUICKSIGHT_API DescribeAccountCustomPermissionResult& operator=(
  ...
  template <typename CustomPermissionsNameT = Aws::String>
  DescribeAccountCustomPermissionResult& WithCustomPermissionsName(CustomPermissionsNameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAccountCustomPermissionResult& WithRequestId(RequestIdT&& value) {
  ...
  inline DescribeAccountCustomPermissionResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
