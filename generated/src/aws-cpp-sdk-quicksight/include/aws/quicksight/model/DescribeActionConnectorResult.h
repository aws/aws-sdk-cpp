...
class DescribeActionConnectorResult {
 public:
  ...
  void SetActionConnector(ActionConnectorT&& value) {
    ...
    m_actionConnector = std::forward<ActionConnectorT>(value);
  }
  template <typename ActionConnectorT = ActionConnector>
  DescribeActionConnectorResult& WithActionConnector(ActionConnectorT&& value) {
    SetActionConnector(std::forward<ActionConnectorT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeActionConnectorResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
