...
/**
 */
class DeleteFlowRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DeleteFlowRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DeleteFlowRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename FlowIdT = Aws::String>
  DeleteFlowRequest& WithFlowId(FlowIdT&& value) {
