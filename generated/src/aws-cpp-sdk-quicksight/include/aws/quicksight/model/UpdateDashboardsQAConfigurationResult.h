...
class UpdateDashboardsQAConfigurationResult {
 public:
  ...
  AWS_QUICKSIGHT_API UpdateDashboardsQAConfigurationResult& operator=(
  ...
  inline void SetDashboardsQAStatus(DashboardsQAStatus value) {
    m_dashboardsQAStatusHasBeenSet = true;
    m_dashboardsQAStatus = value;
  }
  inline UpdateDashboardsQAConfigurationResult& WithDashboardsQAStatus(DashboardsQAStatus value) {
    SetDashboardsQAStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDashboardsQAConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateDashboardsQAConfigurationResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
