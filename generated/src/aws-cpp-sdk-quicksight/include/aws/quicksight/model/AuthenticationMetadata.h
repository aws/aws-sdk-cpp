...
namespace Model
{
  ...
  public:
    ...
    void SetAuthorizationCodeGrantMetadata(AuthorizationCodeGrantMetadataT&& value) { m_authorizationCodeGrantMetadataHasBeenSet = true; m_authorizationCodeGrantMetadata = std::forward<AuthorizationCodeGrantMetadataT>(value); }
    template<typename AuthorizationCodeGrantMetadataT = AuthorizationCodeGrantMetadata>
    AuthenticationMetadata& WithAuthorizationCodeGrantMetadata(AuthorizationCodeGrantMetadataT&& value) { SetAuthorizationCodeGrantMetadata(std::forward<AuthorizationCodeGrantMetadataT>(value)); return *this;}
    ///@}
    ...
    void SetClientCredentialsGrantMetadata(ClientCredentialsGrantMetadataT&& value) { m_clientCredentialsGrantMetadataHasBeenSet = true; m_clientCredentialsGrantMetadata = std::forward<ClientCredentialsGrantMetadataT>(value); }
    template<typename ClientCredentialsGrantMetadataT = ClientCredentialsGrantMetadata>
    AuthenticationMetadata& WithClientCredentialsGrantMetadata(ClientCredentialsGrantMetadataT&& value) { SetClientCredentialsGrantMetadata(std::forward<ClientCredentialsGrantMetadataT>(value)); return *this;}
    ///@}
    ...
    void SetBasicAuthConnectionMetadata(BasicAuthConnectionMetadataT&& value) { m_basicAuthConnectionMetadataHasBeenSet = true; m_basicAuthConnectionMetadata = std::forward<BasicAuthConnectionMetadataT>(value); }
    template<typename BasicAuthConnectionMetadataT = BasicAuthConnectionMetadata>
    AuthenticationMetadata& WithBasicAuthConnectionMetadata(BasicAuthConnectionMetadataT&& value) { SetBasicAuthConnectionMetadata(std::forward<BasicAuthConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    void SetApiKeyConnectionMetadata(ApiKeyConnectionMetadataT&& value) { m_apiKeyConnectionMetadataHasBeenSet = true; m_apiKeyConnectionMetadata = std::forward<ApiKeyConnectionMetadataT>(value); }
    template<typename ApiKeyConnectionMetadataT = APIKeyConnectionMetadata>
    AuthenticationMetadata& WithApiKeyConnectionMetadata(ApiKeyConnectionMetadataT&& value) { SetApiKeyConnectionMetadata(std::forward<ApiKeyConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    void SetNoneConnectionMetadata(NoneConnectionMetadataT&& value) { m_noneConnectionMetadataHasBeenSet = true; m_noneConnectionMetadata = std::forward<NoneConnectionMetadataT>(value); }
    template<typename NoneConnectionMetadataT = NoneConnectionMetadata>
    AuthenticationMetadata& WithNoneConnectionMetadata(NoneConnectionMetadataT&& value) { SetNoneConnectionMetadata(std::forward<NoneConnectionMetadataT>(value)); return *this;}
    ///@}
    ...
    void SetIamConnectionMetadata(IamConnectionMetadataT&& value) { m_iamConnectionMetadataHasBeenSet = true; m_iamConnectionMetadata = std::forward<IamConnectionMetadataT>(value); }
    template<typename IamConnectionMetadataT = IAMConnectionMetadata>
    AuthenticationMetadata& WithIamConnectionMetadata(IamConnectionMetadataT&& value) { SetIamConnectionMetadata(std::forward<IamConnectionMetadataT>(value)); return *this;}
    ///@}
  private:
