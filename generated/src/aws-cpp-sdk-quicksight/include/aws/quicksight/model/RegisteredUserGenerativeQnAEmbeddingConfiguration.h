...
class RegisteredUserGenerativeQnAEmbeddingConfiguration {
 public:
   ...
   * navigating to the Topics pane in the Quick application and opening a topic. The
   * ID is in the URL for the topic that you open.</p> <p>If you don't specify an
