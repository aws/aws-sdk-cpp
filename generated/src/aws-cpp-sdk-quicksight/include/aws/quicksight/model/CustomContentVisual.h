...
class CustomContentVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  CustomContentVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  CustomContentVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  CustomContentVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = CustomContentConfiguration>
  CustomContentVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  CustomContentVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  CustomContentVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  CustomContentVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
