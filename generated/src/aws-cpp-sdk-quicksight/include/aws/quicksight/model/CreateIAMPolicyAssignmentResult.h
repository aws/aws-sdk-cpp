...
class CreateIAMPolicyAssignmentResult {
 public:
  ...
  template <typename AssignmentNameT = Aws::String>
  CreateIAMPolicyAssignmentResult& WithAssignmentName(AssignmentNameT&& value) {
  ...
  template <typename AssignmentIdT = Aws::String>
  CreateIAMPolicyAssignmentResult& WithAssignmentId(AssignmentIdT&& value) {
  ...
  inline CreateIAMPolicyAssignmentResult& WithAssignmentStatus(AssignmentStatus value) {
  ...
  template <typename PolicyArnT = Aws::String>
  CreateIAMPolicyAssignmentResult& WithPolicyArn(PolicyArnT&& value) {
  ...
  template <typename IdentitiesT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  CreateIAMPolicyAssignmentResult& WithIdentities(IdentitiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateIAMPolicyAssignmentResult& WithRequestId(RequestIdT&& value) {
  ...
  inline CreateIAMPolicyAssignmentResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
