...
class ListTemplateAliasesResult {
 public:
  ...
  void SetTemplateAliasList(TemplateAliasListT&& value) {
    m_templateAliasListHasBeenSet = true;
    m_templateAliasList = std::forward<TemplateAliasListT>(value);
  }
  template <typename TemplateAliasListT = Aws::Vector<TemplateAlias>>
  ListTemplateAliasesResult& WithTemplateAliasList(TemplateAliasListT&& value) {
    SetTemplateAliasList(std::forward<TemplateAliasListT>(value));
    return *this;
  }
  template <typename TemplateAliasListT = TemplateAlias>
  ListTemplateAliasesResult& AddTemplateAliasList(TemplateAliasListT&& value) {
    m_templateAliasListHasBeenSet = true;
    m_templateAliasList.emplace_back(std::forward<TemplateAliasListT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTemplateAliasesResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTemplateAliasesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTemplateAliasesResult& WithNextToken(NextTokenT&& value) {
