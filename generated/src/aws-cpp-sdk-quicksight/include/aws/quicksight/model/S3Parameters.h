...
class S3Parameters {
 public:
   ...
   * was uploaded into Quick Sight.</p>
   */
  ...
  void SetManifestFileLocation(ManifestFileLocationT&& value) {
    ...
    m_manifestFileLocation = std::forward<ManifestFileLocationT>(value);
  }
  template <typename ManifestFileLocationT = ManifestFileLocation>
  S3Parameters& WithManifestFileLocation(ManifestFileLocationT&& value) {
    SetManifestFileLocation(std::forward<ManifestFileLocationT>(value));
    return *this;
  }
  ///@}
