...
class GlobalTableBorderOptions {
 public:
  ...
  void SetUniformBorder(UniformBorderT&& value) {
    m_uniformBorderHasBeenSet = true;
    m_uniformBorder = std::forward<UniformBorderT>(value);
  }
  template <typename UniformBorderT = TableBorderOptions>
  GlobalTableBorderOptions& WithUniformBorder(UniformBorderT&& value) {
    SetUniformBorder(std::forward<UniformBorderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSideSpecificBorder(SideSpecificBorderT&& value) {
    m_sideSpecificBorderHasBeenSet = true;
    m_sideSpecificBorder = std::forward<SideSpecificBorderT>(value);
  }
  template <typename SideSpecificBorderT = TableSideBorderOptions>
  GlobalTableBorderOptions& WithSideSpecificBorder(SideSpecificBorderT&& value) {
    SetSideSpecificBorder(std::forward<SideSpecificBorderT>(value));
    return *this;
  }
  ///@}
 private:
