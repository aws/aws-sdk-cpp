...
class ClusterMarker {
 public:
  ...
  void SetSimpleClusterMarker(SimpleClusterMarkerT&& value) {
    m_simpleClusterMarkerHasBeenSet = true;
    m_simpleClusterMarker = std::forward<SimpleClusterMarkerT>(value);
  }
  template <typename SimpleClusterMarkerT = SimpleClusterMarker>
  ClusterMarker& WithSimpleClusterMarker(SimpleClusterMarkerT&& value) {
    SetSimpleClusterMarker(std::forward<SimpleClusterMarkerT>(value));
    return *this;
  }
  ///@}
 private:
