...
class LayoutConfiguration {
 public:
  ...
  void SetGridLayout(GridLayoutT&& value) {
    ...
    m_gridLayout = std::forward<GridLayoutT>(value);
  }
  template <typename GridLayoutT = GridLayoutConfiguration>
  LayoutConfiguration& WithGridLayout(GridLayoutT&& value) {
    SetGridLayout(std::forward<GridLayoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFreeFormLayout(FreeFormLayoutT&& value) {
    ...
    m_freeFormLayout = std::forward<FreeFormLayoutT>(value);
  }
  template <typename FreeFormLayoutT = FreeFormLayoutConfiguration>
  LayoutConfiguration& WithFreeFormLayout(FreeFormLayoutT&& value) {
    SetFreeFormLayout(std::forward<FreeFormLayoutT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSectionBasedLayout(SectionBasedLayoutT&& value) {
    ...
    m_sectionBasedLayout = std::forward<SectionBasedLayoutT>(value);
  }
  template <typename SectionBasedLayoutT = SectionBasedLayoutConfiguration>
  LayoutConfiguration& WithSectionBasedLayout(SectionBasedLayoutT&& value) {
    SetSectionBasedLayout(std::forward<SectionBasedLayoutT>(value));
    return *this;
  }
  ///@}
 private:
