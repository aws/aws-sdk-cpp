...
/**
 */
class UpdateApprovalPolicyRequest : public QuickSightRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "UpdateApprovalPolicy"; }
  ...
  inline UpdateApprovalPolicyRequest& AddActions(GovernedAction value) {
    m_actionsHasBeenSet = true;
  ...
  inline UpdateApprovalPolicyRequest& AddAssetTypes(AssetType value) {
    m_assetTypesHasBeenSet = true;
