...
class UpdateAnalysisPermissionsResult {
 public:
  ...
  template <typename AnalysisArnT = Aws::String>
  UpdateAnalysisPermissionsResult& WithAnalysisArn(AnalysisArnT&& value) {
  ...
  template <typename AnalysisIdT = Aws::String>
  UpdateAnalysisPermissionsResult& WithAnalysisId(AnalysisIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<ResourcePermission>>
  UpdateAnalysisPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = ResourcePermission>
  UpdateAnalysisPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAnalysisPermissionsResult& WithRequestId(RequestIdT&& value) {
  ...
  inline UpdateAnalysisPermissionsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
