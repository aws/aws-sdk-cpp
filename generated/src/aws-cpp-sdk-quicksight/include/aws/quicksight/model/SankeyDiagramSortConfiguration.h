...
class SankeyDiagramSortConfiguration {
 public:
  ...
  void SetWeightSort(WeightSortT&& value) {
    m_weightSortHasBeenSet = true;
    m_weightSort = std::forward<WeightSortT>(value);
  }
  template <typename WeightSortT = Aws::Vector<FieldSortOptions>>
  SankeyDiagramSortConfiguration& WithWeightSort(WeightSortT&& value) {
    SetWeightSort(std::forward<WeightSortT>(value));
    return *this;
  }
  template <typename WeightSortT = FieldSortOptions>
  SankeyDiagramSortConfiguration& AddWeightSort(WeightSortT&& value) {
    m_weightSortHasBeenSet = true;
    m_weightSort.emplace_back(std::forward<WeightSortT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceItemsLimit(SourceItemsLimitT&& value) {
    m_sourceItemsLimitHasBeenSet = true;
    m_sourceItemsLimit = std::forward<SourceItemsLimitT>(value);
  }
  template <typename SourceItemsLimitT = ItemsLimitConfiguration>
  SankeyDiagramSortConfiguration& WithSourceItemsLimit(SourceItemsLimitT&& value) {
    SetSourceItemsLimit(std::forward<SourceItemsLimitT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationItemsLimit(DestinationItemsLimitT&& value) {
    m_destinationItemsLimitHasBeenSet = true;
    m_destinationItemsLimit = std::forward<DestinationItemsLimitT>(value);
  }
  template <typename DestinationItemsLimitT = ItemsLimitConfiguration>
  SankeyDiagramSortConfiguration& WithDestinationItemsLimit(DestinationItemsLimitT&& value) {
    SetDestinationItemsLimit(std::forward<DestinationItemsLimitT>(value));
    return *this;
  }
  ///@}
 private:
