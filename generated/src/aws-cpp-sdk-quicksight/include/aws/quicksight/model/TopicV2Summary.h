...
/**
 * <p>A summary of the topic.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/TopicV2Summary">AWS
 * API Reference</a></p>
 */
class TopicV2Summary {
 public:
  ...
  ///@{
  /**
   * <p>The ID of the topic. This ID is unique per Amazon Web Services Region for
