...
class GeospatialSolidColor {
 public:
  ...
  template <typename ColorT = Aws::String>
  GeospatialSolidColor& WithColor(ColorT&& value) {
  ...
  inline void SetState(GeospatialColorState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline GeospatialSolidColor& WithState(GeospatialColorState value) {
    SetState(value);
    return *this;
  }
  ///@}
