...
class AssetBundleImportJobDashboardOverrideParameters {
 public:
  ...
  template <typename DashboardIdT = Aws::String>
  AssetBundleImportJobDashboardOverrideParameters& WithDashboardId(DashboardIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetBundleImportJobDashboardOverrideParameters& WithName(NameT&& value) {
