...
class VisualCustomActionDefaults {
 public:
  ...
  void SetHighlightOperation(HighlightOperationT&& value) {
    m_highlightOperationHasBeenSet = true;
    m_highlightOperation = std::forward<HighlightOperationT>(value);
  }
  template <typename HighlightOperationT = VisualHighlightOperation>
  VisualCustomActionDefaults& WithHighlightOperation(HighlightOperationT&& value) {
    SetHighlightOperation(std::forward<HighlightOperationT>(value));
    return *this;
  }
  ///@}
 private:
