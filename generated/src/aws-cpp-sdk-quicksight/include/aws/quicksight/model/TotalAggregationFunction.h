...
class TotalAggregationFunction {
 public:
  ...
  inline void SetSimpleTotalAggregationFunction(SimpleTotalAggregationFunction value) {
    m_simpleTotalAggregationFunctionHasBeenSet = true;
    m_simpleTotalAggregationFunction = value;
  }
  inline TotalAggregationFunction& WithSimpleTotalAggregationFunction(SimpleTotalAggregationFunction value) {
    SetSimpleTotalAggregationFunction(value);
    return *this;
  }
  ///@}
 private:
