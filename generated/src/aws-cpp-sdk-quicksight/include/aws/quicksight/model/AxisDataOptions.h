...
class AxisDataOptions {
 public:
  ...
  void SetNumericAxisOptions(NumericAxisOptionsT&& value) {
    ...
    m_numericAxisOptions = std::forward<NumericAxisOptionsT>(value);
  }
  template <typename NumericAxisOptionsT = NumericAxisOptions>
  AxisDataOptions& WithNumericAxisOptions(NumericAxisOptionsT&& value) {
    SetNumericAxisOptions(std::forward<NumericAxisOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateAxisOptions(DateAxisOptionsT&& value) {
    ...
    m_dateAxisOptions = std::forward<DateAxisOptionsT>(value);
  }
  template <typename DateAxisOptionsT = DateAxisOptions>
  AxisDataOptions& WithDateAxisOptions(DateAxisOptionsT&& value) {
    SetDateAxisOptions(std::forward<DateAxisOptionsT>(value));
    return *this;
  }
  ///@}
 private:
