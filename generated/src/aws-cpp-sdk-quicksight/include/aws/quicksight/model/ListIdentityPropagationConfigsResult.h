...
class ListIdentityPropagationConfigsResult {
 public:
  ...
  AWS_QUICKSIGHT_API ListIdentityPropagationConfigsResult& operator=(
  ...
  template <typename ServicesT = Aws::Vector<AuthorizedTargetsByService>>
  ListIdentityPropagationConfigsResult& WithServices(ServicesT&& value) {
    SetServices(std::forward<ServicesT>(value));
    return *this;
  }
  template <typename ServicesT = AuthorizedTargetsByService>
  ListIdentityPropagationConfigsResult& AddServices(ServicesT&& value) {
    m_servicesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIdentityPropagationConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListIdentityPropagationConfigsResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListIdentityPropagationConfigsResult& WithRequestId(RequestIdT&& value) {
