...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API RadarChartVisual() = default;
    ...
    template<typename VisualIdT = Aws::String>
    RadarChartVisual& WithVisualId(VisualIdT&& value) { SetVisualId(std::forward<VisualIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TitleT = VisualTitleLabelOptions>
    RadarChartVisual& WithTitle(TitleT&& value) { SetTitle(std::forward<TitleT>(value)); return *this;}
    ///@}
    ...
    template<typename SubtitleT = VisualSubtitleLabelOptions>
    RadarChartVisual& WithSubtitle(SubtitleT&& value) { SetSubtitle(std::forward<SubtitleT>(value)); return *this;}
    ///@}
    ...
    template<typename ChartConfigurationT = RadarChartConfiguration>
    ...
    template<typename ChartConfigurationT = RadarChartConfiguration>
    RadarChartVisual& WithChartConfiguration(ChartConfigurationT&& value) { SetChartConfiguration(std::forward<ChartConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ActionsT = Aws::Vector<VisualCustomAction>>
    RadarChartVisual& WithActions(ActionsT&& value) { SetActions(std::forward<ActionsT>(value)); return *this;}
    template<typename ActionsT = VisualCustomAction>
    RadarChartVisual& AddActions(ActionsT&& value) { m_actionsHasBeenSet = true; m_actions.emplace_back(std::forward<ActionsT>(value)); return *this; }
    ///@}
    ...
    template<typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
    RadarChartVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) { SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value)); return *this;}
    template<typename ColumnHierarchiesT = ColumnHierarchy>
    RadarChartVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.emplace_back(std::forward<ColumnHierarchiesT>(value)); return *this; }
    ///@}
    ...
    template<typename VisualContentAltTextT = Aws::String>
    RadarChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) { SetVisualContentAltText(std::forward<VisualContentAltTextT>(value)); return *this;}
    ///@}
  private:
