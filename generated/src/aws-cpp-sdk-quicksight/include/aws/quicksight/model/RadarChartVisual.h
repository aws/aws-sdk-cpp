...
class RadarChartVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  RadarChartVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  RadarChartVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  RadarChartVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = RadarChartConfiguration>
  RadarChartVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  RadarChartVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  RadarChartVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  RadarChartVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  RadarChartVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  RadarChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
