...
namespace Model
{
  ...
  /**
   * <p>A radar chart visual.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/RadarChartVisual">AWS
   * API Reference</a></p>
   */
  class RadarChartVisual
  {
  public:
    AWS_QUICKSIGHT_API RadarChartVisual();
    AWS_QUICKSIGHT_API RadarChartVisual(Aws::Utils::Json::JsonView jsonValue);
    AWS_QUICKSIGHT_API RadarChartVisual& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline RadarChartVisual& WithVisualId(const Aws::String& value) { SetVisualId(value); return *this;}
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline RadarChartVisual& WithVisualId(Aws::String&& value) { SetVisualId(std::move(value)); return *this;}
     ...
     * templates can have visuals with the same identifiers.</p>
     */
    inline RadarChartVisual& WithVisualId(const char* value) { SetVisualId(value); return *this;}
     ...
     * <p>The title that is displayed on the visual.</p>
     */
    inline RadarChartVisual& WithTitle(const VisualTitleLabelOptions& value) { SetTitle(value); return *this;}

    /**
     * <p>The title that is displayed on the visual.</p>
     */
    inline RadarChartVisual& WithTitle(VisualTitleLabelOptions&& value) { SetTitle(std::move(value)); return *this;}
     ...
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline RadarChartVisual& WithSubtitle(const VisualSubtitleLabelOptions& value) { SetSubtitle(value); return *this;}

    /**
     * <p>The subtitle that is displayed on the visual.</p>
     */
    inline RadarChartVisual& WithSubtitle(VisualSubtitleLabelOptions&& value) { SetSubtitle(std::move(value)); return *this;}


    /**
     * <p>The configuration settings of the visual.</p>
     */
    inline const RadarChartConfiguration& GetChartConfiguration() const{ return m_chartConfiguration; }
     ...
     * <p>The configuration settings of the visual.</p>
     */
    inline void SetChartConfiguration(const RadarChartConfiguration& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = value; }

    /**
     * <p>The configuration settings of the visual.</p>
     */
    inline void SetChartConfiguration(RadarChartConfiguration&& value) { m_chartConfigurationHasBeenSet = true; m_chartConfiguration = std::move(value); }

    /**
     * <p>The configuration settings of the visual.</p>
     */
    inline RadarChartVisual& WithChartConfiguration(const RadarChartConfiguration& value) { SetChartConfiguration(value); return *this;}

    /**
     * <p>The configuration settings of the visual.</p>
     */
    inline RadarChartVisual& WithChartConfiguration(RadarChartConfiguration&& value) { SetChartConfiguration(std::move(value)); return *this;}
     ...
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline RadarChartVisual& WithActions(const Aws::Vector<VisualCustomAction>& value) { SetActions(value); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline RadarChartVisual& WithActions(Aws::Vector<VisualCustomAction>&& value) { SetActions(std::move(value)); return *this;}

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline RadarChartVisual& AddActions(const VisualCustomAction& value) { m_actionsHasBeenSet = true; m_actions.push_back(value); return *this; }

    /**
     * <p>The list of custom actions that are configured for a visual.</p>
     */
    inline RadarChartVisual& AddActions(VisualCustomAction&& value) { m_actionsHasBeenSet = true; m_actions.push_back(std::move(value)); return *this; }
     ...
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline RadarChartVisual& WithColumnHierarchies(const Aws::Vector<ColumnHierarchy>& value) { SetColumnHierarchies(value); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline RadarChartVisual& WithColumnHierarchies(Aws::Vector<ColumnHierarchy>&& value) { SetColumnHierarchies(std::move(value)); return *this;}

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline RadarChartVisual& AddColumnHierarchies(const ColumnHierarchy& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(value); return *this; }

    /**
     * <p>The column hierarchy that is used during drill-downs and drill-ups.</p>
     */
    inline RadarChartVisual& AddColumnHierarchies(ColumnHierarchy&& value) { m_columnHierarchiesHasBeenSet = true; m_columnHierarchies.push_back(std::move(value)); return *this; }
