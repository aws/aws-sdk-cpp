...
class MeasureField {
 public:
  ...
  void SetNumericalMeasureField(NumericalMeasureFieldT&& value) {
    m_numericalMeasureFieldHasBeenSet = true;
    m_numericalMeasureField = std::forward<NumericalMeasureFieldT>(value);
  }
  template <typename NumericalMeasureFieldT = NumericalMeasureField>
  MeasureField& WithNumericalMeasureField(NumericalMeasureFieldT&& value) {
    SetNumericalMeasureField(std::forward<NumericalMeasureFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCategoricalMeasureField(CategoricalMeasureFieldT&& value) {
    m_categoricalMeasureFieldHasBeenSet = true;
    m_categoricalMeasureField = std::forward<CategoricalMeasureFieldT>(value);
  }
  template <typename CategoricalMeasureFieldT = CategoricalMeasureField>
  MeasureField& WithCategoricalMeasureField(CategoricalMeasureFieldT&& value) {
    SetCategoricalMeasureField(std::forward<CategoricalMeasureFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateMeasureField(DateMeasureFieldT&& value) {
    m_dateMeasureFieldHasBeenSet = true;
    m_dateMeasureField = std::forward<DateMeasureFieldT>(value);
  }
  template <typename DateMeasureFieldT = DateMeasureField>
  MeasureField& WithDateMeasureField(DateMeasureFieldT&& value) {
    SetDateMeasureField(std::forward<DateMeasureFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCalculatedMeasureField(CalculatedMeasureFieldT&& value) {
    m_calculatedMeasureFieldHasBeenSet = true;
    m_calculatedMeasureField = std::forward<CalculatedMeasureFieldT>(value);
  }
  template <typename CalculatedMeasureFieldT = CalculatedMeasureField>
  MeasureField& WithCalculatedMeasureField(CalculatedMeasureFieldT&& value) {
    SetCalculatedMeasureField(std::forward<CalculatedMeasureFieldT>(value));
    return *this;
  }
  ///@}
 private:
