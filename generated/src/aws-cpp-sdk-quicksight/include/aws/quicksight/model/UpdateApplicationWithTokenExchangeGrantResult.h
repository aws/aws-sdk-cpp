...
class UpdateApplicationWithTokenExchangeGrantResult {
 public:
  ...
  AWS_QUICKSIGHT_API UpdateApplicationWithTokenExchangeGrantResult& operator=(
  ...
  inline UpdateApplicationWithTokenExchangeGrantResult& WithStatus(int value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateApplicationWithTokenExchangeGrantResult& WithRequestId(RequestIdT&& value) {
