...
class CustomFilterListConfiguration {
 public:
  ...
  inline void SetMatchOperator(CategoryFilterMatchOperator value) {
    m_matchOperatorHasBeenSet = true;
    m_matchOperator = value;
  }
  inline CustomFilterListConfiguration& WithMatchOperator(CategoryFilterMatchOperator value) {
  ...
  void SetCategoryValues(CategoryValuesT&& value) {
    m_categoryValuesHasBeenSet = true;
    m_categoryValues = std::forward<CategoryValuesT>(value);
  }
  template <typename CategoryValuesT = Aws::Vector<Aws::String>>
  CustomFilterListConfiguration& WithCategoryValues(CategoryValuesT&& value) {
    SetCategoryValues(std::forward<CategoryValuesT>(value));
    return *this;
  }
  template <typename CategoryValuesT = Aws::String>
  CustomFilterListConfiguration& AddCategoryValues(CategoryValuesT&& value) {
    m_categoryValuesHasBeenSet = true;
    m_categoryValues.emplace_back(std::forward<CategoryValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSelectAllOptions(CategoryFilterSelectAllOptions value) {
    m_selectAllOptionsHasBeenSet = true;
    m_selectAllOptions = value;
  }
  inline CustomFilterListConfiguration& WithSelectAllOptions(CategoryFilterSelectAllOptions value) {
    SetSelectAllOptions(value);
    return *this;
  }
  ///@}
  ...
  inline CustomFilterListConfiguration& WithNullOption(FilterNullOption value) {
    SetNullOption(value);
    return *this;
  }
  ///@}
