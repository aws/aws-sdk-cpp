...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CreateDataSourceResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    inline CreateDataSourceResult& WithCreationStatus(ResourceStatus value) { SetCreationStatus(value); return *this;}
    ///@}
