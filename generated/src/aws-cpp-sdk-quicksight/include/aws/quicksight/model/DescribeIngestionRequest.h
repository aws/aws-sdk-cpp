...
class DescribeIngestionRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DescribeIngestionRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeIngestionRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename DataSetIdT = Aws::String>
  DescribeIngestionRequest& WithDataSetId(DataSetIdT&& value) {
  ...
  template <typename IngestionIdT = Aws::String>
  DescribeIngestionRequest& WithIngestionId(IngestionIdT&& value) {
