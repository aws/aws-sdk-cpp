...
class GeospatialCategoricalColor {
 public:
  ...
  void SetCategoryDataColors(CategoryDataColorsT&& value) {
    m_categoryDataColorsHasBeenSet = true;
    m_categoryDataColors = std::forward<CategoryDataColorsT>(value);
  }
  template <typename CategoryDataColorsT = Aws::Vector<GeospatialCategoricalDataColor>>
  GeospatialCategoricalColor& WithCategoryDataColors(CategoryDataColorsT&& value) {
    SetCategoryDataColors(std::forward<CategoryDataColorsT>(value));
    return *this;
  }
  template <typename CategoryDataColorsT = GeospatialCategoricalDataColor>
  GeospatialCategoricalColor& AddCategoryDataColors(CategoryDataColorsT&& value) {
    m_categoryDataColorsHasBeenSet = true;
    m_categoryDataColors.emplace_back(std::forward<CategoryDataColorsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNullDataVisibility(Visibility value) {
    m_nullDataVisibilityHasBeenSet = true;
    m_nullDataVisibility = value;
  }
  inline GeospatialCategoricalColor& WithNullDataVisibility(Visibility value) {
    SetNullDataVisibility(value);
    return *this;
  }
  ///@}
  ...
  void SetNullDataSettings(NullDataSettingsT&& value) {
    m_nullDataSettingsHasBeenSet = true;
    m_nullDataSettings = std::forward<NullDataSettingsT>(value);
  }
  template <typename NullDataSettingsT = GeospatialNullDataSettings>
  GeospatialCategoricalColor& WithNullDataSettings(NullDataSettingsT&& value) {
    SetNullDataSettings(std::forward<NullDataSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultOpacity(double value) {
    m_defaultOpacityHasBeenSet = true;
    m_defaultOpacity = value;
  }
  inline GeospatialCategoricalColor& WithDefaultOpacity(double value) {
