...
class GeneratedAnswerResult {
 public:
  ...
  void SetQuestionText(QuestionTextT&& value) {
    ...
    m_questionText = std::forward<QuestionTextT>(value);
  }
  template <typename QuestionTextT = Aws::String>
  GeneratedAnswerResult& WithQuestionText(QuestionTextT&& value) {
    SetQuestionText(std::forward<QuestionTextT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnswerStatus(GeneratedAnswerStatus value) {
    m_answerStatusHasBeenSet = true;
    m_answerStatus = value;
  }
  inline GeneratedAnswerResult& WithAnswerStatus(GeneratedAnswerStatus value) {
  ...
  void SetRestatement(RestatementT&& value) {
    ...
    m_restatement = std::forward<RestatementT>(value);
  }
  template <typename RestatementT = Aws::String>
  GeneratedAnswerResult& WithRestatement(RestatementT&& value) {
    SetRestatement(std::forward<RestatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnswerId(AnswerIdT&& value) {
    ...
    m_answerId = std::forward<AnswerIdT>(value);
  }
  template <typename AnswerIdT = Aws::String>
  GeneratedAnswerResult& WithAnswerId(AnswerIdT&& value) {
    SetAnswerId(std::forward<AnswerIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuestionUrl(QuestionUrlT&& value) {
    ...
    m_questionUrl = std::forward<QuestionUrlT>(value);
  }
  template <typename QuestionUrlT = Aws::String>
  GeneratedAnswerResult& WithQuestionUrl(QuestionUrlT&& value) {
    SetQuestionUrl(std::forward<QuestionUrlT>(value));
    return *this;
  }
  ///@}
 private:
