...
class SignupResponse {
 public:
  ...
  inline void SetIAMUser(bool value) {
    m_iAMUserHasBeenSet = true;
    m_iAMUser = value;
  }
  inline SignupResponse& WithIAMUser(bool value) {
    SetIAMUser(value);
    return *this;
  }
  ///@}
  ...
  void SetUserLoginName(UserLoginNameT&& value) {
    ...
    m_userLoginName = std::forward<UserLoginNameT>(value);
  }
  template <typename UserLoginNameT = Aws::String>
  SignupResponse& WithUserLoginName(UserLoginNameT&& value) {
    SetUserLoginName(std::forward<UserLoginNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectoryType(DirectoryTypeT&& value) {
    ...
    m_directoryType = std::forward<DirectoryTypeT>(value);
  }
  template <typename DirectoryTypeT = Aws::String>
  SignupResponse& WithDirectoryType(DirectoryTypeT&& value) {
    SetDirectoryType(std::forward<DirectoryTypeT>(value));
    return *this;
  }
  ///@}
 private:
