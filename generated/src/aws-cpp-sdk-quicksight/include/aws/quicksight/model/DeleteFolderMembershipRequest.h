...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API DeleteFolderMembershipRequest() = default;
    ...
    template<typename AwsAccountIdT = Aws::String>
    DeleteFolderMembershipRequest& WithAwsAccountId(AwsAccountIdT&& value) { SetAwsAccountId(std::forward<AwsAccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FolderIdT = Aws::String>
    DeleteFolderMembershipRequest& WithFolderId(FolderIdT&& value) { SetFolderId(std::forward<FolderIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MemberIdT = Aws::String>
    DeleteFolderMembershipRequest& WithMemberId(MemberIdT&& value) { SetMemberId(std::forward<MemberIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteFolderMembershipRequest& WithMemberType(MemberType value) { SetMemberType(value); return *this;}
    ///@}
  private:
