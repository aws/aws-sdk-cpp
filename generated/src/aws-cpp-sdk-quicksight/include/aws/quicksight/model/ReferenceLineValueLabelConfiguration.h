...
class ReferenceLineValueLabelConfiguration {
 public:
  ...
  inline void SetRelativePosition(ReferenceLineValueLabelRelativePosition value) {
    m_relativePositionHasBeenSet = true;
    m_relativePosition = value;
  }
  inline ReferenceLineValueLabelConfiguration& WithRelativePosition(ReferenceLineValueLabelRelativePosition value) {
