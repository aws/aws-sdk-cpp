...
class ItemsLimitConfiguration {
 public:
  ...
  inline void SetItemsLimit(long long value) {
    m_itemsLimitHasBeenSet = true;
    m_itemsLimit = value;
  }
  inline ItemsLimitConfiguration& WithItemsLimit(long long value) {
    SetItemsLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOtherCategories(OtherCategories value) {
    m_otherCategoriesHasBeenSet = true;
    m_otherCategories = value;
  }
  inline ItemsLimitConfiguration& WithOtherCategories(OtherCategories value) {
