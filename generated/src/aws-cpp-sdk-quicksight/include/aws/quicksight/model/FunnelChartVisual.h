...
class FunnelChartVisual {
 public:
  ...
  template <typename VisualIdT = Aws::String>
  FunnelChartVisual& WithVisualId(VisualIdT&& value) {
  ...
  template <typename TitleT = VisualTitleLabelOptions>
  FunnelChartVisual& WithTitle(TitleT&& value) {
  ...
  template <typename SubtitleT = VisualSubtitleLabelOptions>
  FunnelChartVisual& WithSubtitle(SubtitleT&& value) {
  ...
  template <typename ChartConfigurationT = FunnelChartConfiguration>
  FunnelChartVisual& WithChartConfiguration(ChartConfigurationT&& value) {
  ...
  template <typename ActionsT = Aws::Vector<VisualCustomAction>>
  FunnelChartVisual& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = VisualCustomAction>
  FunnelChartVisual& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename ColumnHierarchiesT = Aws::Vector<ColumnHierarchy>>
  FunnelChartVisual& WithColumnHierarchies(ColumnHierarchiesT&& value) {
    SetColumnHierarchies(std::forward<ColumnHierarchiesT>(value));
    return *this;
  }
  template <typename ColumnHierarchiesT = ColumnHierarchy>
  FunnelChartVisual& AddColumnHierarchies(ColumnHierarchiesT&& value) {
    m_columnHierarchiesHasBeenSet = true;
  ...
  template <typename VisualContentAltTextT = Aws::String>
  FunnelChartVisual& WithVisualContentAltText(VisualContentAltTextT&& value) {
