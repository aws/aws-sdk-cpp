...
namespace Model
{
  ...
  {
  public:
    AWS_QUICKSIGHT_API ThrottlingException() = default;
    AWS_QUICKSIGHT_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
    AWS_QUICKSIGHT_API ThrottlingException& operator=(Aws::Utils::Json::JsonView jsonValue);
