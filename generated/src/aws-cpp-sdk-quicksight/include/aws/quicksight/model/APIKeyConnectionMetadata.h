...
class APIKeyConnectionMetadata {
 public:
  ...
  template <typename BaseEndpointT = Aws::String>
  APIKeyConnectionMetadata& WithBaseEndpoint(BaseEndpointT&& value) {
  ...
  template <typename ApiKeyT = Aws::String>
  APIKeyConnectionMetadata& WithApiKey(ApiKeyT&& value) {
  ...
  template <typename EmailT = Aws::String>
  APIKeyConnectionMetadata& WithEmail(EmailT&& value) {
