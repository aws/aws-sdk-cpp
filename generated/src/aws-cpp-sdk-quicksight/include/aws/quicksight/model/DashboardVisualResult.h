...
class DashboardVisualResult {
 public:
  ...
  void SetSheetName(SheetNameT&& value) {
    ...
    m_sheetName = std::forward<SheetNameT>(value);
  }
  template <typename SheetNameT = Aws::String>
  DashboardVisualResult& WithSheetName(SheetNameT&& value) {
    SetSheetName(std::forward<SheetNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualTitle(VisualTitleT&& value) {
    ...
    m_visualTitle = std::forward<VisualTitleT>(value);
  }
  template <typename VisualTitleT = Aws::String>
  DashboardVisualResult& WithVisualTitle(VisualTitleT&& value) {
    SetVisualTitle(std::forward<VisualTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisualSubtitle(VisualSubtitleT&& value) {
    ...
    m_visualSubtitle = std::forward<VisualSubtitleT>(value);
  }
  template <typename VisualSubtitleT = Aws::String>
  DashboardVisualResult& WithVisualSubtitle(VisualSubtitleT&& value) {
    SetVisualSubtitle(std::forward<VisualSubtitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDashboardUrl(DashboardUrlT&& value) {
    ...
    m_dashboardUrl = std::forward<DashboardUrlT>(value);
  }
  template <typename DashboardUrlT = Aws::String>
  DashboardVisualResult& WithDashboardUrl(DashboardUrlT&& value) {
    SetDashboardUrl(std::forward<DashboardUrlT>(value));
    return *this;
  }
  ///@}
 private:
