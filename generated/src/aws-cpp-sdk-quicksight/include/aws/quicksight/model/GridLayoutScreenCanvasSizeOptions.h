...
class GridLayoutScreenCanvasSizeOptions {
 public:
  ...
  inline void SetResizeOption(ResizeOption value) {
    m_resizeOptionHasBeenSet = true;
    m_resizeOption = value;
  }
  inline GridLayoutScreenCanvasSizeOptions& WithResizeOption(ResizeOption value) {
  ...
  template <typename OptimizedViewPortWidthT = Aws::String>
  GridLayoutScreenCanvasSizeOptions& WithOptimizedViewPortWidth(OptimizedViewPortWidthT&& value) {
