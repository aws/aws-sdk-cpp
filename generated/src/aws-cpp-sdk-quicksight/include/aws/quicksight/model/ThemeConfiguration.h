...
class ThemeConfiguration {
 public:
  ...
  void SetDataColorPalette(DataColorPaletteT&& value) {
    ...
    m_dataColorPalette = std::forward<DataColorPaletteT>(value);
  }
  template <typename DataColorPaletteT = DataColorPalette>
  ThemeConfiguration& WithDataColorPalette(DataColorPaletteT&& value) {
    SetDataColorPalette(std::forward<DataColorPaletteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUIColorPalette(UIColorPaletteT&& value) {
    ...
    m_uIColorPalette = std::forward<UIColorPaletteT>(value);
  }
  template <typename UIColorPaletteT = UIColorPalette>
  ThemeConfiguration& WithUIColorPalette(UIColorPaletteT&& value) {
    SetUIColorPalette(std::forward<UIColorPaletteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSheet(SheetT&& value) {
    ...
    m_sheet = std::forward<SheetT>(value);
  }
  template <typename SheetT = SheetStyle>
  ThemeConfiguration& WithSheet(SheetT&& value) {
    SetSheet(std::forward<SheetT>(value));
    return *this;
  }
  ///@}
