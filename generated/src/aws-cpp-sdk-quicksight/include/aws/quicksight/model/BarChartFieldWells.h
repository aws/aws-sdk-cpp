...
class BarChartFieldWells {
 public:
  ...
  void SetBarChartAggregatedFieldWells(BarChartAggregatedFieldWellsT&& value) {
    m_barChartAggregatedFieldWellsHasBeenSet = true;
    m_barChartAggregatedFieldWells = std::forward<BarChartAggregatedFieldWellsT>(value);
  }
  template <typename BarChartAggregatedFieldWellsT = BarChartAggregatedFieldWells>
  BarChartFieldWells& WithBarChartAggregatedFieldWells(BarChartAggregatedFieldWellsT&& value) {
    SetBarChartAggregatedFieldWells(std::forward<BarChartAggregatedFieldWellsT>(value));
    return *this;
  }
  ///@}
 private:
