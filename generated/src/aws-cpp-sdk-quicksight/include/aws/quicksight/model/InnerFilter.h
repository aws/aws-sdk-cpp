...
class InnerFilter {
 public:
  ...
  void SetCategoryInnerFilter(CategoryInnerFilterT&& value) {
    m_categoryInnerFilterHasBeenSet = true;
    m_categoryInnerFilter = std::forward<CategoryInnerFilterT>(value);
  }
  template <typename CategoryInnerFilterT = CategoryInnerFilter>
  InnerFilter& WithCategoryInnerFilter(CategoryInnerFilterT&& value) {
    SetCategoryInnerFilter(std::forward<CategoryInnerFilterT>(value));
    return *this;
  }
  ///@}
 private:
