...
class DescribeTemplateAliasRequest : public QuickSightRequest {
 public:
  AWS_QUICKSIGHT_API DescribeTemplateAliasRequest() = default;
  ...
  template <typename AwsAccountIdT = Aws::String>
  DescribeTemplateAliasRequest& WithAwsAccountId(AwsAccountIdT&& value) {
  ...
  template <typename TemplateIdT = Aws::String>
  DescribeTemplateAliasRequest& WithTemplateId(TemplateIdT&& value) {
  ...
  template <typename AliasNameT = Aws::String>
  DescribeTemplateAliasRequest& WithAliasName(AliasNameT&& value) {
