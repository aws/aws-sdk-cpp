...
class BarChartConfiguration {
 public:
  ...
  inline void SetOrientation(BarChartOrientation value) {
    m_orientationHasBeenSet = true;
    m_orientation = value;
  }
  inline BarChartConfiguration& WithOrientation(BarChartOrientation value) {
  ...
  inline BarChartConfiguration& WithBarsArrangement(BarsArrangement value) {
  ...
  void SetValueAxis(ValueAxisT&& value) {
    ...
    m_valueAxis = std::forward<ValueAxisT>(value);
  }
  template <typename ValueAxisT = AxisDisplayOptions>
  BarChartConfiguration& WithValueAxis(ValueAxisT&& value) {
    SetValueAxis(std::forward<ValueAxisT>(value));
    return *this;
  }
  ///@}
