    ...
    public:
      ...
      typedef QuickSightEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * <p>1 paginated PDF</p> </li> <li> <p>5 CSVs</p> </li> </ul> <p>Poll job
         * descriptions with a <code>DescribeDashboardSnapshotJob</code> API call. Once the
         * job succeeds, use the <code>DescribeDashboardSnapshotJobResult</code> API to
