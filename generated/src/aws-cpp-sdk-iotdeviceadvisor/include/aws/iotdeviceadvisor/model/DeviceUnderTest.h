...
class DeviceUnderTest {
 public:
  ...
  template <typename ThingArnT = Aws::String>
  DeviceUnderTest& WithThingArn(ThingArnT&& value) {
  ...
  template <typename CertificateArnT = Aws::String>
  DeviceUnderTest& WithCertificateArn(CertificateArnT&& value) {
  ...
  void SetDeviceRoleArn(DeviceRoleArnT&& value) {
    m_deviceRoleArnHasBeenSet = true;
    m_deviceRoleArn = std::forward<DeviceRoleArnT>(value);
  }
  template <typename DeviceRoleArnT = Aws::String>
  DeviceUnderTest& WithDeviceRoleArn(DeviceRoleArnT&& value) {
    SetDeviceRoleArn(std::forward<DeviceRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
