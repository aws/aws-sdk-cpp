...
class GetSuiteDefinitionResult {
 public:
  ...
  template <typename SuiteDefinitionIdT = Aws::String>
  GetSuiteDefinitionResult& WithSuiteDefinitionId(SuiteDefinitionIdT&& value) {
  ...
  template <typename SuiteDefinitionArnT = Aws::String>
  GetSuiteDefinitionResult& WithSuiteDefinitionArn(SuiteDefinitionArnT&& value) {
  ...
  template <typename SuiteDefinitionVersionT = Aws::String>
  GetSuiteDefinitionResult& WithSuiteDefinitionVersion(SuiteDefinitionVersionT&& value) {
  ...
  template <typename LatestVersionT = Aws::String>
  GetSuiteDefinitionResult& WithLatestVersion(LatestVersionT&& value) {
  ...
  template <typename SuiteDefinitionConfigurationT = SuiteDefinitionConfiguration>
  GetSuiteDefinitionResult& WithSuiteDefinitionConfiguration(SuiteDefinitionConfigurationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetSuiteDefinitionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastModifiedAtT = Aws::Utils::DateTime>
  GetSuiteDefinitionResult& WithLastModifiedAt(LastModifiedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetSuiteDefinitionResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSuiteDefinitionResult& WithRequestId(RequestIdT&& value) {
