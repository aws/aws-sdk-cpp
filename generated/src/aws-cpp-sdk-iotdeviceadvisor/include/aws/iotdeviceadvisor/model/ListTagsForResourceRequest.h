...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public IoTDeviceAdvisorRequest
  {
  public:
    AWS_IOTDEVICEADVISOR_API ListTagsForResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The resource ARN of the IoT Device Advisor resource. This can be
