...
class TestCaseScenario {
 public:
  ...
  void SetTestCaseScenarioId(TestCaseScenarioIdT&& value) {
    m_testCaseScenarioIdHasBeenSet = true;
    m_testCaseScenarioId = std::forward<TestCaseScenarioIdT>(value);
  }
  template <typename TestCaseScenarioIdT = Aws::String>
  TestCaseScenario& WithTestCaseScenarioId(TestCaseScenarioIdT&& value) {
    SetTestCaseScenarioId(std::forward<TestCaseScenarioIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTestCaseScenarioType(TestCaseScenarioType value) {
    m_testCaseScenarioTypeHasBeenSet = true;
    m_testCaseScenarioType = value;
  }
  inline TestCaseScenario& WithTestCaseScenarioType(TestCaseScenarioType value) {
    SetTestCaseScenarioType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TestCaseScenarioStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TestCaseScenario& WithStatus(TestCaseScenarioStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureT = Aws::String>
  TestCaseScenario& WithFailure(FailureT&& value) {
  ...
  template <typename SystemMessageT = Aws::String>
  TestCaseScenario& WithSystemMessage(SystemMessageT&& value) {
