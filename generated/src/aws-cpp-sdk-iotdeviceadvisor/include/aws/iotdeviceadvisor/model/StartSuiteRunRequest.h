...
class StartSuiteRunRequest : public IoTDeviceAdvisorRequest {
 public:
  ...
  template <typename SuiteDefinitionIdT = Aws::String>
  StartSuiteRunRequest& WithSuiteDefinitionId(SuiteDefinitionIdT&& value) {
  ...
  template <typename SuiteDefinitionVersionT = Aws::String>
  StartSuiteRunRequest& WithSuiteDefinitionVersion(SuiteDefinitionVersionT&& value) {
  ...
  template <typename SuiteRunConfigurationT = SuiteRunConfiguration>
  StartSuiteRunRequest& WithSuiteRunConfiguration(SuiteRunConfigurationT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartSuiteRunRequest& WithTags(TagsT&& value) {
