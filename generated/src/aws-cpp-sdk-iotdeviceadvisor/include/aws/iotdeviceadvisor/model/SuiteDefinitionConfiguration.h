...
class SuiteDefinitionConfiguration {
 public:
  ...
  template <typename SuiteDefinitionNameT = Aws::String>
  SuiteDefinitionConfiguration& WithSuiteDefinitionName(SuiteDefinitionNameT&& value) {
  ...
  template <typename DevicesT = Aws::Vector<DeviceUnderTest>>
  SuiteDefinitionConfiguration& WithDevices(DevicesT&& value) {
    SetDevices(std::forward<DevicesT>(value));
    return *this;
  }
  template <typename DevicesT = DeviceUnderTest>
  SuiteDefinitionConfiguration& AddDevices(DevicesT&& value) {
    m_devicesHasBeenSet = true;
  ...
  inline void SetIntendedForQualification(bool value) {
    m_intendedForQualificationHasBeenSet = true;
    m_intendedForQualification = value;
  }
  inline SuiteDefinitionConfiguration& WithIntendedForQualification(bool value) {
    SetIntendedForQualification(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsLongDurationTest(bool value) {
    m_isLongDurationTestHasBeenSet = true;
    m_isLongDurationTest = value;
  }
  inline SuiteDefinitionConfiguration& WithIsLongDurationTest(bool value) {
    SetIsLongDurationTest(value);
    return *this;
  }
  ///@}
  ...
  void SetRootGroup(RootGroupT&& value) {
    m_rootGroupHasBeenSet = true;
    m_rootGroup = std::forward<RootGroupT>(value);
  }
  template <typename RootGroupT = Aws::String>
  SuiteDefinitionConfiguration& WithRootGroup(RootGroupT&& value) {
    SetRootGroup(std::forward<RootGroupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDevicePermissionRoleArn(DevicePermissionRoleArnT&& value) {
    m_devicePermissionRoleArnHasBeenSet = true;
    m_devicePermissionRoleArn = std::forward<DevicePermissionRoleArnT>(value);
  }
  template <typename DevicePermissionRoleArnT = Aws::String>
  SuiteDefinitionConfiguration& WithDevicePermissionRoleArn(DevicePermissionRoleArnT&& value) {
    SetDevicePermissionRoleArn(std::forward<DevicePermissionRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline SuiteDefinitionConfiguration& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
