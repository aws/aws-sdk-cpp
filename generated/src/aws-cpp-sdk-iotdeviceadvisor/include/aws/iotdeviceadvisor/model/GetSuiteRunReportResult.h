...
class GetSuiteRunReportResult {
 public:
  ...
  void SetQualificationReportDownloadUrl(QualificationReportDownloadUrlT&& value) {
    m_qualificationReportDownloadUrlHasBeenSet = true;
    m_qualificationReportDownloadUrl = std::forward<QualificationReportDownloadUrlT>(value);
  }
  template <typename QualificationReportDownloadUrlT = Aws::String>
  GetSuiteRunReportResult& WithQualificationReportDownloadUrl(QualificationReportDownloadUrlT&& value) {
    SetQualificationReportDownloadUrl(std::forward<QualificationReportDownloadUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSuiteRunReportResult& WithRequestId(RequestIdT&& value) {
