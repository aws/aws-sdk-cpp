...
class GetEndpointRequest : public IoTDeviceAdvisorRequest {
 public:
  ...
  template <typename ThingArnT = Aws::String>
  GetEndpointRequest& WithThingArn(ThingArnT&& value) {
  ...
  template <typename CertificateArnT = Aws::String>
  GetEndpointRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename DeviceRoleArnT = Aws::String>
  GetEndpointRequest& WithDeviceRoleArn(DeviceRoleArnT&& value) {
  ...
  inline void SetAuthenticationMethod(AuthenticationMethod value) {
    m_authenticationMethodHasBeenSet = true;
    m_authenticationMethod = value;
  }
  inline GetEndpointRequest& WithAuthenticationMethod(AuthenticationMethod value) {
