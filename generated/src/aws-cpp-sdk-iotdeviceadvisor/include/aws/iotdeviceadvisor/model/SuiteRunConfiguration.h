...
class SuiteRunConfiguration {
 public:
  ...
  void SetPrimaryDevice(PrimaryDeviceT&& value) {
    m_primaryDeviceHasBeenSet = true;
    m_primaryDevice = std::forward<PrimaryDeviceT>(value);
  }
  template <typename PrimaryDeviceT = DeviceUnderTest>
  SuiteRunConfiguration& WithPrimaryDevice(PrimaryDeviceT&& value) {
    SetPrimaryDevice(std::forward<PrimaryDeviceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectedTestList(SelectedTestListT&& value) {
    m_selectedTestListHasBeenSet = true;
    m_selectedTestList = std::forward<SelectedTestListT>(value);
  }
  template <typename SelectedTestListT = Aws::Vector<Aws::String>>
  SuiteRunConfiguration& WithSelectedTestList(SelectedTestListT&& value) {
    SetSelectedTestList(std::forward<SelectedTestListT>(value));
    return *this;
  }
  template <typename SelectedTestListT = Aws::String>
  SuiteRunConfiguration& AddSelectedTestList(SelectedTestListT&& value) {
    m_selectedTestListHasBeenSet = true;
    m_selectedTestList.emplace_back(std::forward<SelectedTestListT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetParallelRun(bool value) {
    m_parallelRunHasBeenSet = true;
    m_parallelRun = value;
  }
  inline SuiteRunConfiguration& WithParallelRun(bool value) {
    SetParallelRun(value);
    return *this;
  }
  ///@}
 private:
