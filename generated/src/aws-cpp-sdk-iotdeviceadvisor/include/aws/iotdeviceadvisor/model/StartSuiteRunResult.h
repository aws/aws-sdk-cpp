...
class StartSuiteRunResult {
 public:
  ...
  template <typename SuiteRunIdT = Aws::String>
  StartSuiteRunResult& WithSuiteRunId(SuiteRunIdT&& value) {
  ...
  void SetSuiteRunArn(SuiteRunArnT&& value) {
    m_suiteRunArnHasBeenSet = true;
    m_suiteRunArn = std::forward<SuiteRunArnT>(value);
  }
  template <typename SuiteRunArnT = Aws::String>
  StartSuiteRunResult& WithSuiteRunArn(SuiteRunArnT&& value) {
    SetSuiteRunArn(std::forward<SuiteRunArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  StartSuiteRunResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename EndpointT = Aws::String>
  StartSuiteRunResult& WithEndpoint(EndpointT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartSuiteRunResult& WithRequestId(RequestIdT&& value) {
