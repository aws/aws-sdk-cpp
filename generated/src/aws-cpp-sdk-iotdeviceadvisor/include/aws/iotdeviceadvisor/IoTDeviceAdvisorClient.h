...
namespace IoTDeviceAdvisor
{
   ...
   */
  class AWS_IOTDEVICEADVISOR_API IoTDeviceAdvisorClient : Aws::Client::ClientWithAsyncTemplateMethods<IoTDeviceAdvisorClient>,
    smithy::client::AwsSmithyClientT<Aws::IoTDeviceAdvisor::SERVICE_NAME,
