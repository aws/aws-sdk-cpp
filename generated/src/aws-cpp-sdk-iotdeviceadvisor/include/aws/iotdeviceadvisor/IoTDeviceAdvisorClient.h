...
class AWS_IOTDEVICEADVISOR_API IoTDeviceAdvisorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  IoTDeviceAdvisorClient(const Aws::IoTDeviceAdvisor::IoTDeviceAdvisorClientConfiguration& clientConfiguration =
  ...
  IoTDeviceAdvisorClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<IoTDeviceAdvisorEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::IoTDeviceAdvisor::IoTDeviceAdvisorClientConfiguration& clientConfiguration =
                             Aws::IoTDeviceAdvisor::IoTDeviceAdvisorClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  IoTDeviceAdvisorClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * A Callable wrapper for CreateSuiteDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSuiteDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSuiteDefinitionRequestT = Model::CreateSuiteDefinitionRequest>
  void CreateSuiteDefinitionAsync(const CreateSuiteDefinitionRequestT& request, const CreateSuiteDefinitionResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteSuiteDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSuiteDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSuiteDefinitionRequestT = Model::DeleteSuiteDefinitionRequest>
  void DeleteSuiteDefinitionAsync(const DeleteSuiteDefinitionRequestT& request, const DeleteSuiteDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetEndpointRequestT = Model::GetEndpointRequest>
  void GetEndpointAsync(const GetEndpointResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetEndpointRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSuiteDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSuiteDefinition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSuiteDefinitionRequestT = Model::GetSuiteDefinitionRequest>
  void GetSuiteDefinitionAsync(const GetSuiteDefinitionRequestT& request, const GetSuiteDefinitionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSuiteRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSuiteRunRequestT = Model::GetSuiteRunRequest>
  void GetSuiteRunAsync(const GetSuiteRunRequestT& request, const GetSuiteRunResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSuiteRunReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSuiteRunReport that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSuiteRunReportRequestT = Model::GetSuiteRunReportRequest>
  void GetSuiteRunReportAsync(const GetSuiteRunReportRequestT& request, const GetSuiteRunReportResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSuiteDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSuiteDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSuiteDefinitionsRequestT = Model::ListSuiteDefinitionsRequest>
  void ListSuiteDefinitionsAsync(const ListSuiteDefinitionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListSuiteDefinitionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListSuiteRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSuiteRunsRequestT = Model::ListSuiteRunsRequest>
  void ListSuiteRunsAsync(const ListSuiteRunsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListSuiteRunsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartSuiteRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartSuiteRunRequestT = Model::StartSuiteRunRequest>
  void StartSuiteRunAsync(const StartSuiteRunRequestT& request, const StartSuiteRunResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopSuiteRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopSuiteRunRequestT = Model::StopSuiteRunRequest>
  void StopSuiteRunAsync(const StopSuiteRunRequestT& request, const StopSuiteRunResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSuiteDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSuiteDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSuiteDefinitionRequestT = Model::UpdateSuiteDefinitionRequest>
  void UpdateSuiteDefinitionAsync(const UpdateSuiteDefinitionRequestT& request, const UpdateSuiteDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
