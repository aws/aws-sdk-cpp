...
namespace Model
{
  ...
  {
  public:
    AWS_OAM_API ConflictException() = default;
    ...
    template<typename AmznErrorTypeT = Aws::String>
    ConflictException& WithAmznErrorType(AmznErrorTypeT&& value) { SetAmznErrorType(std::forward<AmznErrorTypeT>(value)); return *this;}
    ///@}
  private:
