...
namespace Model
{
  ...
  /**
   */
  class TagResourceRequest : public OAMRequest
  {
  public:
    AWS_OAM_API TagResourceRequest() = default;
     ...
     * a sink is <code>arn:aws:oam:<i>Region</i>:<i>account-id</i>:sink/<i>sink-id</i>
     * </code> </p> <p>The ARN format of a link is
