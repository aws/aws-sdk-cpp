...
class GetLinkResult {
 public:
  AWS_OAM_API GetLinkResult() = default;
  ...
  template <typename ArnT = Aws::String>
  GetLinkResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetLinkResult& WithId(IdT&& value) {
  ...
  template <typename LabelT = Aws::String>
  GetLinkResult& WithLabel(LabelT&& value) {
  ...
  template <typename LabelTemplateT = Aws::String>
  GetLinkResult& WithLabelTemplate(LabelTemplateT&& value) {
  ...
  template <typename LinkConfigurationT = LinkConfiguration>
  GetLinkResult& WithLinkConfiguration(LinkConfigurationT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<Aws::String>>
  GetLinkResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = Aws::String>
  GetLinkResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename SinkArnT = Aws::String>
  GetLinkResult& WithSinkArn(SinkArnT&& value) {
