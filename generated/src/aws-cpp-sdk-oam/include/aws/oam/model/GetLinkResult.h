...
namespace Model
{
  ...
  public:
     ...
     * account.</p>
     */
    inline GetLinkResult& WithLinkConfiguration(const LinkConfiguration& value) { SetLinkConfiguration(value); return *this;}
     ...
     * account.</p>
     */
    inline GetLinkResult& WithLinkConfiguration(LinkConfiguration&& value) { SetLinkConfiguration(std::move(value)); return *this;}
    ...
    inline GetLinkResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetLinkResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetLinkResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
