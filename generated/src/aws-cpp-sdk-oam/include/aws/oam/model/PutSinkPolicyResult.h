...
class PutSinkPolicyResult {
 public:
  ...
  template <typename PolicyT = Aws::String>
  PutSinkPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename SinkArnT = Aws::String>
  PutSinkPolicyResult& WithSinkArn(SinkArnT&& value) {
  ...
  template <typename SinkIdT = Aws::String>
  PutSinkPolicyResult& WithSinkId(SinkIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutSinkPolicyResult& WithRequestId(RequestIdT&& value) {
