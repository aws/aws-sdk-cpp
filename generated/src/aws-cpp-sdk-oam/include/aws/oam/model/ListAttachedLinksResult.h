...
class ListAttachedLinksResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ListAttachedLinksItem>>
  ListAttachedLinksResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListAttachedLinksItem>
  ListAttachedLinksResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAttachedLinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAttachedLinksResult& WithRequestId(RequestIdT&& value) {
