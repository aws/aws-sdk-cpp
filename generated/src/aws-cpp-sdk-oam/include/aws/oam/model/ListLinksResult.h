...
namespace Model
{
  ...
  public:
    ...
    inline ListLinksResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListLinksResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListLinksResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
