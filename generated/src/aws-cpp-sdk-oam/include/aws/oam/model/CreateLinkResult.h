...
class CreateLinkResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateLinkResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateLinkResult& WithId(IdT&& value) {
  ...
  template <typename LabelT = Aws::String>
  CreateLinkResult& WithLabel(LabelT&& value) {
  ...
  void SetLabelTemplate(LabelTemplateT&& value) {
    ...
    m_labelTemplate = std::forward<LabelTemplateT>(value);
  }
  template <typename LabelTemplateT = Aws::String>
  CreateLinkResult& WithLabelTemplate(LabelTemplateT&& value) {
    SetLabelTemplate(std::forward<LabelTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LinkConfigurationT = LinkConfiguration>
  CreateLinkResult& WithLinkConfiguration(LinkConfigurationT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<Aws::String>>
  CreateLinkResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = Aws::String>
  CreateLinkResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename SinkArnT = Aws::String>
  CreateLinkResult& WithSinkArn(SinkArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateLinkResult& WithTags(TagsT&& value) {
