...
class UpdateLinkResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateLinkResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateLinkResult& WithId(IdT&& value) {
  ...
  template <typename LabelT = Aws::String>
  UpdateLinkResult& WithLabel(LabelT&& value) {
  ...
  template <typename LabelTemplateT = Aws::String>
  UpdateLinkResult& WithLabelTemplate(LabelTemplateT&& value) {
  ...
  template <typename LinkConfigurationT = LinkConfiguration>
  UpdateLinkResult& WithLinkConfiguration(LinkConfigurationT&& value) {
  ...
  template <typename ResourceTypesT = Aws::Vector<Aws::String>>
  UpdateLinkResult& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  template <typename ResourceTypesT = Aws::String>
  UpdateLinkResult& AddResourceTypes(ResourceTypesT&& value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename SinkArnT = Aws::String>
  UpdateLinkResult& WithSinkArn(SinkArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateLinkResult& WithTags(TagsT&& value) {
