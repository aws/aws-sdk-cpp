...
class GetSinkResult {
 public:
  AWS_OAM_API GetSinkResult() = default;
  ...
  template <typename ArnT = Aws::String>
  GetSinkResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetSinkResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetSinkResult& WithName(NameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetSinkResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetSinkResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetSinkResult& WithRequestId(RequestIdT&& value) {
