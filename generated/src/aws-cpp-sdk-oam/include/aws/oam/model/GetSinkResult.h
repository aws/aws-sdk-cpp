...
namespace Model
{
  ...
  public:
    ...
    inline GetSinkResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetSinkResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetSinkResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
