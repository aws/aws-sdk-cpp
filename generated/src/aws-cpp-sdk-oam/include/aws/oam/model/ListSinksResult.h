...
namespace Model
{
  ...
  public:
    ...
    inline ListSinksResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListSinksResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListSinksResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
