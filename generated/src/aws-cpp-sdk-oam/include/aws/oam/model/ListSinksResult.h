...
class ListSinksResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ListSinksItem>>
  ListSinksResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListSinksItem>
  ListSinksResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSinksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSinksResult& WithRequestId(RequestIdT&& value) {
