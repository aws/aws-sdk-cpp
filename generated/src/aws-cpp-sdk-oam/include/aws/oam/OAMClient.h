 ...
 * accounts</i>. A monitoring account is a central Amazon Web Services account that
 * can view and interact with observability data generated from source accounts. A
...
class AWS_OAM_API OAMClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  OAMClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<OAMEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CreateSink that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSinkRequestT = Model::CreateSinkRequest>
  void CreateSinkAsync(const CreateSinkRequestT& request, const CreateSinkResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSink that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSinkRequestT = Model::DeleteSinkRequest>
  void DeleteSinkAsync(const DeleteSinkRequestT& request, const DeleteSinkResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSink that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSinkRequestT = Model::GetSinkRequest>
  void GetSinkAsync(const GetSinkRequestT& request, const GetSinkResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSinkPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSinkPolicyRequestT = Model::GetSinkPolicyRequest>
  void GetSinkPolicyAsync(const GetSinkPolicyRequestT& request, const GetSinkPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAttachedLinks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAttachedLinks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAttachedLinksRequestT = Model::ListAttachedLinksRequest>
  void ListAttachedLinksAsync(const ListAttachedLinksRequestT& request, const ListAttachedLinksResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListLinksRequestT = Model::ListLinksRequest>
  void ListLinksAsync(const ListLinksResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListLinksRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListSinks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSinksRequestT = Model::ListSinksRequest>
  void ListSinksAsync(const ListSinksResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListSinksRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PutSinkPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutSinkPolicyRequestT = Model::PutSinkPolicyRequest>
  void PutSinkPolicyAsync(const PutSinkPolicyRequestT& request, const PutSinkPolicyResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
