...
namespace Model
{
  ...
  {
  public:
    AWS_PRIVATENETWORKS_API ListOrdersRequest() = default;
    ...
    template<typename FiltersT = Aws::Map<OrderFilterKeys, Aws::Vector<Aws::String>>>
    void SetFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters = std::forward<FiltersT>(value); }
    template<typename FiltersT = Aws::Map<OrderFilterKeys, Aws::Vector<Aws::String>>>
    ListOrdersRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    inline ListOrdersRequest& AddFilters(OrderFilterKeys key, Aws::Vector<Aws::String> value) {
    ...
    template<typename NetworkArnT = Aws::String>
    ListOrdersRequest& WithNetworkArn(NetworkArnT&& value) { SetNetworkArn(std::forward<NetworkArnT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTokenT = Aws::String>
    ListOrdersRequest& WithStartToken(StartTokenT&& value) { SetStartToken(std::forward<StartTokenT>(value)); return *this;}
    ///@}
  private:
