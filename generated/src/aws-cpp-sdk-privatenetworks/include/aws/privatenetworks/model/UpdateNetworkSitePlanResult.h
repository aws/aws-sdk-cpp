...
namespace Model
{
  ...
  {
  public:
    AWS_PRIVATENETWORKS_API UpdateNetworkSitePlanResult() = default;
    ...
    template<typename NetworkSiteT = NetworkSite>
    UpdateNetworkSitePlanResult& WithNetworkSite(NetworkSiteT&& value) { SetNetworkSite(std::forward<NetworkSiteT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateNetworkSitePlanResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    UpdateNetworkSitePlanResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNetworkSitePlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
