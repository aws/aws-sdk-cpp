...
{
const size_t PrivateNetworksEndpointRules::RulesBlobStrLen = 3512;
const size_t PrivateNetworksEndpointRules::RulesBlobSize = 3513;

using RulesBlobT = Aws::Array<const char, PrivateNetworksEndpointRules::RulesBlobSize>;
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r','i','v',
'a','t','e','-','n','e','t','w','o','r','k','s','-','f','i','p','s','.','{','R','e','g','i','o','n',
...
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r','i',
'v','a','t','e','-','n','e','t','w','o','r','k','s','-','f','i','p','s','.','{','R','e','g','i','o',
...
'/','p','r','i','v','a','t','e','-','n','e','t','w','o','r','k','s','.','{','R','e','g','i','o','n',
'}','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t','#','d','u','a','l','S','t',
'a','c','k','D','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t','i','e',
's','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e',
'"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',',','{','"','c','o','n','d','i','t','i',
...
']','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p',
'o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r','i',
'v','a','t','e','-','n','e','t','w','o','r','k','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* PrivateNetworksEndpointRules::GetRulesBlob()
{
