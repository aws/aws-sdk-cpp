...
DeleteNetworkResult::DeleteNetworkResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

DeleteNetworkResult& DeleteNetworkResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
