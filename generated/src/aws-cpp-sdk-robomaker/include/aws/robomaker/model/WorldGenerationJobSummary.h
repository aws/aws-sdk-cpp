...
class WorldGenerationJobSummary {
 public:
  ...
  inline WorldGenerationJobSummary& WithStatus(WorldGenerationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSucceededWorldCount(int value) {
    m_succeededWorldCountHasBeenSet = true;
    m_succeededWorldCount = value;
  }
  inline WorldGenerationJobSummary& WithSucceededWorldCount(int value) {
    SetSucceededWorldCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedWorldCount(int value) {
    m_failedWorldCountHasBeenSet = true;
    m_failedWorldCount = value;
  }
  inline WorldGenerationJobSummary& WithFailedWorldCount(int value) {
    SetFailedWorldCount(value);
    return *this;
  }
  ///@}
 private:
