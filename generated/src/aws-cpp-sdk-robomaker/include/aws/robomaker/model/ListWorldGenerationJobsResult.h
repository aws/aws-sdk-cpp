...
class ListWorldGenerationJobsResult {
 public:
  ...
  void SetWorldGenerationJobSummaries(WorldGenerationJobSummariesT&& value) {
    m_worldGenerationJobSummariesHasBeenSet = true;
    m_worldGenerationJobSummaries = std::forward<WorldGenerationJobSummariesT>(value);
  }
  template <typename WorldGenerationJobSummariesT = Aws::Vector<WorldGenerationJobSummary>>
  ListWorldGenerationJobsResult& WithWorldGenerationJobSummaries(WorldGenerationJobSummariesT&& value) {
    SetWorldGenerationJobSummaries(std::forward<WorldGenerationJobSummariesT>(value));
    return *this;
  }
  template <typename WorldGenerationJobSummariesT = WorldGenerationJobSummary>
  ListWorldGenerationJobsResult& AddWorldGenerationJobSummaries(WorldGenerationJobSummariesT&& value) {
    m_worldGenerationJobSummariesHasBeenSet = true;
    m_worldGenerationJobSummaries.emplace_back(std::forward<WorldGenerationJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldGenerationJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorldGenerationJobsResult& WithRequestId(RequestIdT&& value) {
