...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API CancelWorldGenerationJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelWorldGenerationJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
