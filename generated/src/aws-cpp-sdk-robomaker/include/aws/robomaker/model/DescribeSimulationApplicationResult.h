...
class DescribeSimulationApplicationResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeSimulationApplicationResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeSimulationApplicationResult& WithName(NameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  DescribeSimulationApplicationResult& WithVersion(VersionT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<Source>>
  DescribeSimulationApplicationResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = Source>
  DescribeSimulationApplicationResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename SimulationSoftwareSuiteT = SimulationSoftwareSuite>
  DescribeSimulationApplicationResult& WithSimulationSoftwareSuite(SimulationSoftwareSuiteT&& value) {
  ...
  template <typename RobotSoftwareSuiteT = RobotSoftwareSuite>
  DescribeSimulationApplicationResult& WithRobotSoftwareSuite(RobotSoftwareSuiteT&& value) {
  ...
  template <typename RenderingEngineT = RenderingEngine>
  DescribeSimulationApplicationResult& WithRenderingEngine(RenderingEngineT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  DescribeSimulationApplicationResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  DescribeSimulationApplicationResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeSimulationApplicationResult& WithTags(TagsT&& value) {
  ...
  template <typename EnvironmentT = Environment>
  DescribeSimulationApplicationResult& WithEnvironment(EnvironmentT&& value) {
  ...
  template <typename ImageDigestT = Aws::String>
  DescribeSimulationApplicationResult& WithImageDigest(ImageDigestT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSimulationApplicationResult& WithRequestId(RequestIdT&& value) {
