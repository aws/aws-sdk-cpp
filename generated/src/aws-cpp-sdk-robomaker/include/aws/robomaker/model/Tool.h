...
class Tool {
 public:
  ...
  inline Tool& WithStreamUI(bool value) {
    SetStreamUI(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStreamOutputToCloudWatch(bool value) {
    m_streamOutputToCloudWatchHasBeenSet = true;
    m_streamOutputToCloudWatch = value;
  }
  inline Tool& WithStreamOutputToCloudWatch(bool value) {
    SetStreamOutputToCloudWatch(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExitBehavior(ExitBehavior value) {
    m_exitBehaviorHasBeenSet = true;
    m_exitBehavior = value;
  }
  inline Tool& WithExitBehavior(ExitBehavior value) {
