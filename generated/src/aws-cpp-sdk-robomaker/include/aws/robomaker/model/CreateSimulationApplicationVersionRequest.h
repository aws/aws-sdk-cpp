...
class CreateSimulationApplicationVersionRequest : public RoboMakerRequest {
 public:
  ...
  template <typename ApplicationT = Aws::String>
  CreateSimulationApplicationVersionRequest& WithApplication(ApplicationT&& value) {
  ...
  template <typename CurrentRevisionIdT = Aws::String>
  CreateSimulationApplicationVersionRequest& WithCurrentRevisionId(CurrentRevisionIdT&& value) {
  ...
  template <typename S3EtagsT = Aws::Vector<Aws::String>>
  CreateSimulationApplicationVersionRequest& WithS3Etags(S3EtagsT&& value) {
    SetS3Etags(std::forward<S3EtagsT>(value));
    return *this;
  }
  template <typename S3EtagsT = Aws::String>
  CreateSimulationApplicationVersionRequest& AddS3Etags(S3EtagsT&& value) {
    m_s3EtagsHasBeenSet = true;
  ...
  template <typename ImageDigestT = Aws::String>
  CreateSimulationApplicationVersionRequest& WithImageDigest(ImageDigestT&& value) {
