...
class FailedCreateSimulationJobRequest {
 public:
  ...
  inline FailedCreateSimulationJobRequest& WithFailureCode(SimulationJobErrorCode value) {
  ...
  void SetFailedAt(FailedAtT&& value) {
    m_failedAtHasBeenSet = true;
    m_failedAt = std::forward<FailedAtT>(value);
  }
  template <typename FailedAtT = Aws::Utils::DateTime>
  FailedCreateSimulationJobRequest& WithFailedAt(FailedAtT&& value) {
    SetFailedAt(std::forward<FailedAtT>(value));
    return *this;
  }
  ///@}
 private:
