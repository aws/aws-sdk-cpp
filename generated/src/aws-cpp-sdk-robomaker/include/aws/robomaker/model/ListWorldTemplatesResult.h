...
class ListWorldTemplatesResult {
 public:
  ...
  void SetTemplateSummaries(TemplateSummariesT&& value) {
    m_templateSummariesHasBeenSet = true;
    m_templateSummaries = std::forward<TemplateSummariesT>(value);
  }
  template <typename TemplateSummariesT = Aws::Vector<TemplateSummary>>
  ListWorldTemplatesResult& WithTemplateSummaries(TemplateSummariesT&& value) {
    SetTemplateSummaries(std::forward<TemplateSummariesT>(value));
    return *this;
  }
  template <typename TemplateSummariesT = TemplateSummary>
  ListWorldTemplatesResult& AddTemplateSummaries(TemplateSummariesT&& value) {
    m_templateSummariesHasBeenSet = true;
    m_templateSummaries.emplace_back(std::forward<TemplateSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorldTemplatesResult& WithRequestId(RequestIdT&& value) {
