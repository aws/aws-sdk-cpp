...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API DeleteSimulationApplicationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSimulationApplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
