...
class CreateSimulationApplicationVersionResult {
 public:
  ...
  AWS_ROBOMAKER_API CreateSimulationApplicationVersionResult& operator=(
  ...
  template <typename ArnT = Aws::String>
  CreateSimulationApplicationVersionResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateSimulationApplicationVersionResult& WithName(NameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  CreateSimulationApplicationVersionResult& WithVersion(VersionT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<Source>>
  CreateSimulationApplicationVersionResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = Source>
  CreateSimulationApplicationVersionResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  void SetSimulationSoftwareSuite(SimulationSoftwareSuiteT&& value) {
    ...
    m_simulationSoftwareSuite = std::forward<SimulationSoftwareSuiteT>(value);
  }
  template <typename SimulationSoftwareSuiteT = SimulationSoftwareSuite>
  CreateSimulationApplicationVersionResult& WithSimulationSoftwareSuite(SimulationSoftwareSuiteT&& value) {
    SetSimulationSoftwareSuite(std::forward<SimulationSoftwareSuiteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRobotSoftwareSuite(RobotSoftwareSuiteT&& value) {
    ...
    m_robotSoftwareSuite = std::forward<RobotSoftwareSuiteT>(value);
  }
  template <typename RobotSoftwareSuiteT = RobotSoftwareSuite>
  CreateSimulationApplicationVersionResult& WithRobotSoftwareSuite(RobotSoftwareSuiteT&& value) {
    SetRobotSoftwareSuite(std::forward<RobotSoftwareSuiteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRenderingEngine(RenderingEngineT&& value) {
    ...
    m_renderingEngine = std::forward<RenderingEngineT>(value);
  }
  template <typename RenderingEngineT = RenderingEngine>
  CreateSimulationApplicationVersionResult& WithRenderingEngine(RenderingEngineT&& value) {
    SetRenderingEngine(std::forward<RenderingEngineT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  CreateSimulationApplicationVersionResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateSimulationApplicationVersionResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename EnvironmentT = Environment>
  CreateSimulationApplicationVersionResult& WithEnvironment(EnvironmentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateSimulationApplicationVersionResult& WithRequestId(RequestIdT&& value) {
