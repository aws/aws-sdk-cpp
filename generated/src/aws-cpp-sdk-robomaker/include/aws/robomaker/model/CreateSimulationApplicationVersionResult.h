...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API CreateSimulationApplicationVersionResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreateSimulationApplicationVersionResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateSimulationApplicationVersionResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    CreateSimulationApplicationVersionResult& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
    ...
    template<typename SourcesT = Aws::Vector<Source>>
    CreateSimulationApplicationVersionResult& WithSources(SourcesT&& value) { SetSources(std::forward<SourcesT>(value)); return *this;}
    template<typename SourcesT = Source>
    CreateSimulationApplicationVersionResult& AddSources(SourcesT&& value) { m_sourcesHasBeenSet = true; m_sources.emplace_back(std::forward<SourcesT>(value)); return *this; }
    ///@}
    ...
    template<typename SimulationSoftwareSuiteT = SimulationSoftwareSuite>
    CreateSimulationApplicationVersionResult& WithSimulationSoftwareSuite(SimulationSoftwareSuiteT&& value) { SetSimulationSoftwareSuite(std::forward<SimulationSoftwareSuiteT>(value)); return *this;}
    ///@}
    ...
    template<typename RobotSoftwareSuiteT = RobotSoftwareSuite>
    CreateSimulationApplicationVersionResult& WithRobotSoftwareSuite(RobotSoftwareSuiteT&& value) { SetRobotSoftwareSuite(std::forward<RobotSoftwareSuiteT>(value)); return *this;}
    ///@}
    ...
    template<typename RenderingEngineT = RenderingEngine>
    CreateSimulationApplicationVersionResult& WithRenderingEngine(RenderingEngineT&& value) { SetRenderingEngine(std::forward<RenderingEngineT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    CreateSimulationApplicationVersionResult& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    CreateSimulationApplicationVersionResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentT = Environment>
    CreateSimulationApplicationVersionResult& WithEnvironment(EnvironmentT&& value) { SetEnvironment(std::forward<EnvironmentT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSimulationApplicationVersionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
