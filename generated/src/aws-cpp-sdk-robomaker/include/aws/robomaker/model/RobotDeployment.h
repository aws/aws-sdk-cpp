...
class RobotDeployment {
 public:
  ...
  void SetDeploymentFinishTime(DeploymentFinishTimeT&& value) {
    ...
    m_deploymentFinishTime = std::forward<DeploymentFinishTimeT>(value);
  }
  template <typename DeploymentFinishTimeT = Aws::Utils::DateTime>
  RobotDeployment& WithDeploymentFinishTime(DeploymentFinishTimeT&& value) {
    SetDeploymentFinishTime(std::forward<DeploymentFinishTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(RobotStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RobotDeployment& WithStatus(RobotStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetProgressDetail(ProgressDetailT&& value) {
    ...
    m_progressDetail = std::forward<ProgressDetailT>(value);
  }
  template <typename ProgressDetailT = ProgressDetail>
  RobotDeployment& WithProgressDetail(ProgressDetailT&& value) {
    SetProgressDetail(std::forward<ProgressDetailT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFailureCode(DeploymentJobErrorCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline RobotDeployment& WithFailureCode(DeploymentJobErrorCode value) {
