...
class DeploymentJob {
 public:
  ...
  inline DeploymentJob& WithStatus(DeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDeploymentApplicationConfigs(DeploymentApplicationConfigsT&& value) {
    ...
    m_deploymentApplicationConfigs = std::forward<DeploymentApplicationConfigsT>(value);
  }
  template <typename DeploymentApplicationConfigsT = Aws::Vector<DeploymentApplicationConfig>>
  DeploymentJob& WithDeploymentApplicationConfigs(DeploymentApplicationConfigsT&& value) {
    SetDeploymentApplicationConfigs(std::forward<DeploymentApplicationConfigsT>(value));
    return *this;
  }
  ...
  DeploymentJob& AddDeploymentApplicationConfigs(DeploymentApplicationConfigsT&& value) {
    m_deploymentApplicationConfigsHasBeenSet = true;
    m_deploymentApplicationConfigs.emplace_back(std::forward<DeploymentApplicationConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeploymentJob& WithFailureCode(DeploymentJobErrorCode value) {
