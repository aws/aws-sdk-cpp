...
class ListSimulationApplicationsRequest : public RoboMakerRequest {
 public:
  ...
  void SetVersionQualifier(VersionQualifierT&& value) {
    m_versionQualifierHasBeenSet = true;
    m_versionQualifier = std::forward<VersionQualifierT>(value);
  }
  template <typename VersionQualifierT = Aws::String>
  ListSimulationApplicationsRequest& WithVersionQualifier(VersionQualifierT&& value) {
    SetVersionQualifier(std::forward<VersionQualifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationApplicationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSimulationApplicationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListSimulationApplicationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListSimulationApplicationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
