...
class PortMapping {
 public:
  AWS_ROBOMAKER_API PortMapping() = default;
  ...
  inline void SetJobPort(int value) {
    m_jobPortHasBeenSet = true;
    m_jobPort = value;
  }
  inline PortMapping& WithJobPort(int value) {
    SetJobPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApplicationPort(int value) {
    m_applicationPortHasBeenSet = true;
    m_applicationPort = value;
  }
  inline PortMapping& WithApplicationPort(int value) {
    SetApplicationPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableOnPublicIp(bool value) {
    m_enableOnPublicIpHasBeenSet = true;
    m_enableOnPublicIp = value;
  }
  inline PortMapping& WithEnableOnPublicIp(bool value) {
 ...
 private:
  ...
  int m_applicationPort{0};
  bool m_applicationPortHasBeenSet = false;

  bool m_enableOnPublicIp{false};
