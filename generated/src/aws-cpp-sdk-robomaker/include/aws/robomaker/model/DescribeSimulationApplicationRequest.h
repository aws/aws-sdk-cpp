...
class DescribeSimulationApplicationRequest : public RoboMakerRequest {
 public:
  ...
  template <typename ApplicationT = Aws::String>
  DescribeSimulationApplicationRequest& WithApplication(ApplicationT&& value) {
  ...
  template <typename ApplicationVersionT = Aws::String>
  DescribeSimulationApplicationRequest& WithApplicationVersion(ApplicationVersionT&& value) {
