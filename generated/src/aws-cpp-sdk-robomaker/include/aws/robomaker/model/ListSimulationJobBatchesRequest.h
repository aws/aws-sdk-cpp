...
class ListSimulationJobBatchesRequest : public RoboMakerRequest {
 public:
  AWS_ROBOMAKER_API ListSimulationJobBatchesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationJobBatchesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSimulationJobBatchesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListSimulationJobBatchesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListSimulationJobBatchesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
