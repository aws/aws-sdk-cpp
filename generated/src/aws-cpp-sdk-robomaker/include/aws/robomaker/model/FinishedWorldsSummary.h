...
class FinishedWorldsSummary {
 public:
  ...
  inline void SetFinishedCount(int value) {
    m_finishedCountHasBeenSet = true;
    m_finishedCount = value;
  }
  inline FinishedWorldsSummary& WithFinishedCount(int value) {
    SetFinishedCount(value);
    return *this;
  }
  ///@}
  ...
  void SetFailureSummary(FailureSummaryT&& value) {
    ...
    m_failureSummary = std::forward<FailureSummaryT>(value);
  }
  template <typename FailureSummaryT = FailureSummary>
  FinishedWorldsSummary& WithFailureSummary(FailureSummaryT&& value) {
    SetFailureSummary(std::forward<FailureSummaryT>(value));
    return *this;
  }
  ///@}
 private:
