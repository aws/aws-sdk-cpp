...
class ComputeResponse {
 public:
  ...
  inline void SetSimulationUnitLimit(int value) {
    m_simulationUnitLimitHasBeenSet = true;
    m_simulationUnitLimit = value;
  }
  inline ComputeResponse& WithSimulationUnitLimit(int value) {
    SetSimulationUnitLimit(value);
    return *this;
  }
  ///@}
  ...
  inline ComputeResponse& WithComputeType(ComputeType value) {
  ...
  inline void SetGpuUnitLimit(int value) {
    m_gpuUnitLimitHasBeenSet = true;
    m_gpuUnitLimit = value;
  }
  inline ComputeResponse& WithGpuUnitLimit(int value) {
    SetGpuUnitLimit(value);
    return *this;
  }
  ///@}
 private:
