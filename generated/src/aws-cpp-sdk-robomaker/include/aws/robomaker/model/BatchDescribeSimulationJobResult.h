...
class BatchDescribeSimulationJobResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<SimulationJob>>
  BatchDescribeSimulationJobResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = SimulationJob>
  BatchDescribeSimulationJobResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  void SetUnprocessedJobs(UnprocessedJobsT&& value) {
    m_unprocessedJobsHasBeenSet = true;
    m_unprocessedJobs = std::forward<UnprocessedJobsT>(value);
  }
  template <typename UnprocessedJobsT = Aws::Vector<Aws::String>>
  BatchDescribeSimulationJobResult& WithUnprocessedJobs(UnprocessedJobsT&& value) {
    SetUnprocessedJobs(std::forward<UnprocessedJobsT>(value));
    return *this;
  }
  template <typename UnprocessedJobsT = Aws::String>
  BatchDescribeSimulationJobResult& AddUnprocessedJobs(UnprocessedJobsT&& value) {
    m_unprocessedJobsHasBeenSet = true;
    m_unprocessedJobs.emplace_back(std::forward<UnprocessedJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDescribeSimulationJobResult& WithRequestId(RequestIdT&& value) {
