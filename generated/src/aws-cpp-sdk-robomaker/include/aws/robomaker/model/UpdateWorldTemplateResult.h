...
class UpdateWorldTemplateResult {
 public:
  AWS_ROBOMAKER_API UpdateWorldTemplateResult() = default;
  ...
  template <typename ArnT = Aws::String>
  UpdateWorldTemplateResult& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateWorldTemplateResult& WithName(NameT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateWorldTemplateResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  UpdateWorldTemplateResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateWorldTemplateResult& WithRequestId(RequestIdT&& value) {
