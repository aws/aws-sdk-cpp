...
class Fleet {
 public:
  ...
  inline void SetLastDeploymentStatus(DeploymentStatus value) {
    m_lastDeploymentStatusHasBeenSet = true;
    m_lastDeploymentStatus = value;
  }
  inline Fleet& WithLastDeploymentStatus(DeploymentStatus value) {
    SetLastDeploymentStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastDeploymentJob(LastDeploymentJobT&& value) {
    ...
    m_lastDeploymentJob = std::forward<LastDeploymentJobT>(value);
  }
  template <typename LastDeploymentJobT = Aws::String>
  Fleet& WithLastDeploymentJob(LastDeploymentJobT&& value) {
    SetLastDeploymentJob(std::forward<LastDeploymentJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastDeploymentTime(LastDeploymentTimeT&& value) {
    ...
    m_lastDeploymentTime = std::forward<LastDeploymentTimeT>(value);
  }
  template <typename LastDeploymentTimeT = Aws::Utils::DateTime>
  Fleet& WithLastDeploymentTime(LastDeploymentTimeT&& value) {
    SetLastDeploymentTime(std::forward<LastDeploymentTimeT>(value));
    return *this;
  }
  ///@}
 private:
