...
class UploadConfiguration {
 public:
  ...
  inline void SetUploadBehavior(UploadBehavior value) {
    m_uploadBehaviorHasBeenSet = true;
    m_uploadBehavior = value;
  }
  inline UploadConfiguration& WithUploadBehavior(UploadBehavior value) {
    SetUploadBehavior(value);
    return *this;
  }
  ///@}
 private:
