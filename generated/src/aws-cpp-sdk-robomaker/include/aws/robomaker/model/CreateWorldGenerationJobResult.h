...
class CreateWorldGenerationJobResult {
 public:
  ...
  inline void SetStatus(WorldGenerationJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateWorldGenerationJobResult& WithStatus(WorldGenerationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureCode(WorldGenerationJobErrorCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline CreateWorldGenerationJobResult& WithFailureCode(WorldGenerationJobErrorCode value) {
  ...
  void SetWorldCount(WorldCountT&& value) {
    ...
    m_worldCount = std::forward<WorldCountT>(value);
  }
  template <typename WorldCountT = WorldCount>
  CreateWorldGenerationJobResult& WithWorldCount(WorldCountT&& value) {
    SetWorldCount(std::forward<WorldCountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorldTags(WorldTagsT&& value) {
    ...
    m_worldTags = std::forward<WorldTagsT>(value);
  }
  template <typename WorldTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateWorldGenerationJobResult& WithWorldTags(WorldTagsT&& value) {
    SetWorldTags(std::forward<WorldTagsT>(value));
    return *this;
  }
  ...
  CreateWorldGenerationJobResult& AddWorldTags(WorldTagsKeyT&& key, WorldTagsValueT&& value) {
    m_worldTagsHasBeenSet = true;
    m_worldTags.emplace(std::forward<WorldTagsKeyT>(key), std::forward<WorldTagsValueT>(value));
    return *this;
  }
  ///@}
