...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public RoboMakerRequest
  {
  public:
    AWS_ROBOMAKER_API UntagResourceRequest() = default;
    ...
    AWS_ROBOMAKER_API void AddQueryStringParameters(Aws::Http::URI& uri) const override;
