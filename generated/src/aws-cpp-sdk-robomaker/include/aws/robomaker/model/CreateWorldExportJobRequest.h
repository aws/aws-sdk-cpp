...
class CreateWorldExportJobRequest : public RoboMakerRequest {
 public:
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateWorldExportJobRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  void SetWorlds(WorldsT&& value) {
    ...
    m_worlds = std::forward<WorldsT>(value);
  }
  template <typename WorldsT = Aws::Vector<Aws::String>>
  CreateWorldExportJobRequest& WithWorlds(WorldsT&& value) {
    SetWorlds(std::forward<WorldsT>(value));
    return *this;
  }
  template <typename WorldsT = Aws::String>
  CreateWorldExportJobRequest& AddWorlds(WorldsT&& value) {
    m_worldsHasBeenSet = true;
    m_worlds.emplace_back(std::forward<WorldsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutputLocationT = OutputLocation>
  CreateWorldExportJobRequest& WithOutputLocation(OutputLocationT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  CreateWorldExportJobRequest& WithIamRole(IamRoleT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateWorldExportJobRequest& WithTags(TagsT&& value) {
