...
class ListSimulationApplicationsResult {
 public:
   ...
   * request.</p>
   */
  inline const Aws::Vector<SimulationApplicationSummary>& GetSimulationApplicationSummaries() const {
    return m_simulationApplicationSummaries;
  }
  template <typename SimulationApplicationSummariesT = Aws::Vector<SimulationApplicationSummary>>
  void SetSimulationApplicationSummaries(SimulationApplicationSummariesT&& value) {
    m_simulationApplicationSummariesHasBeenSet = true;
    m_simulationApplicationSummaries = std::forward<SimulationApplicationSummariesT>(value);
  }
  template <typename SimulationApplicationSummariesT = Aws::Vector<SimulationApplicationSummary>>
  ListSimulationApplicationsResult& WithSimulationApplicationSummaries(SimulationApplicationSummariesT&& value) {
    SetSimulationApplicationSummaries(std::forward<SimulationApplicationSummariesT>(value));
    return *this;
  }
  template <typename SimulationApplicationSummariesT = SimulationApplicationSummary>
  ListSimulationApplicationsResult& AddSimulationApplicationSummaries(SimulationApplicationSummariesT&& value) {
    m_simulationApplicationSummariesHasBeenSet = true;
    m_simulationApplicationSummaries.emplace_back(std::forward<SimulationApplicationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationApplicationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSimulationApplicationsResult& WithRequestId(RequestIdT&& value) {
