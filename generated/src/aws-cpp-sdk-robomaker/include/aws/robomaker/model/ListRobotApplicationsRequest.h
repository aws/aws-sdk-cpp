...
class ListRobotApplicationsRequest : public RoboMakerRequest {
 public:
  ...
  template <typename VersionQualifierT = Aws::String>
  ListRobotApplicationsRequest& WithVersionQualifier(VersionQualifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRobotApplicationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRobotApplicationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListRobotApplicationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListRobotApplicationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
