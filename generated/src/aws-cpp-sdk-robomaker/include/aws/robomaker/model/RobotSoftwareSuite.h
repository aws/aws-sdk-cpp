...
class RobotSoftwareSuite {
 public:
  ...
  inline void SetName(RobotSoftwareSuiteType value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline RobotSoftwareSuite& WithName(RobotSoftwareSuiteType value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVersion(RobotSoftwareSuiteVersionType value) {
    m_versionHasBeenSet = true;
    m_version = value;
  }
  inline RobotSoftwareSuite& WithVersion(RobotSoftwareSuiteVersionType value) {
    SetVersion(value);
    return *this;
  }
  ///@}
