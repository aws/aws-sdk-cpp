...
namespace Model
{
  ...
  /**
   */
  class DescribeWorldGenerationJobRequest : public RoboMakerRequest
  {
  public:
    AWS_ROBOMAKER_API DescribeWorldGenerationJobRequest() = default;
    ...
    template<typename JobT = Aws::String>
    DescribeWorldGenerationJobRequest& WithJob(JobT&& value) { SetJob(std::forward<JobT>(value)); return *this;}
    ///@}
  private:
