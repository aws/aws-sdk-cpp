...
class CreateSimulationJobRequest : public RoboMakerRequest {
 public:
  ...
  inline CreateSimulationJobRequest& WithMaxJobDurationInSeconds(long long value) {
  ...
  inline CreateSimulationJobRequest& WithFailureBehavior(FailureBehavior value) {
