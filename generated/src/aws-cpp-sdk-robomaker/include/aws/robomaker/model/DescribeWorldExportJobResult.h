...
class DescribeWorldExportJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeWorldExportJobResult& WithArn(ArnT&& value) {
  ...
  inline DescribeWorldExportJobResult& WithStatus(WorldExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DescribeWorldExportJobResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline DescribeWorldExportJobResult& WithFailureCode(WorldExportJobErrorCode value) {
  ...
  template <typename FailureReasonT = Aws::String>
  DescribeWorldExportJobResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DescribeWorldExportJobResult& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename WorldsT = Aws::Vector<Aws::String>>
  DescribeWorldExportJobResult& WithWorlds(WorldsT&& value) {
    SetWorlds(std::forward<WorldsT>(value));
    return *this;
  }
  template <typename WorldsT = Aws::String>
  DescribeWorldExportJobResult& AddWorlds(WorldsT&& value) {
    m_worldsHasBeenSet = true;
  ...
  template <typename OutputLocationT = OutputLocation>
  DescribeWorldExportJobResult& WithOutputLocation(OutputLocationT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  DescribeWorldExportJobResult& WithIamRole(IamRoleT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeWorldExportJobResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorldExportJobResult& WithRequestId(RequestIdT&& value) {
