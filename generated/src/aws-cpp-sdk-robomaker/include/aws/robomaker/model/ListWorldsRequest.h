...
class ListWorldsRequest : public RoboMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorldsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListWorldsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListWorldsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
