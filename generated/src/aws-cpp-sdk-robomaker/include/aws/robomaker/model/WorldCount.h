...
class WorldCount {
 public:
  ...
  inline void SetFloorplanCount(int value) {
    m_floorplanCountHasBeenSet = true;
    m_floorplanCount = value;
  }
  inline WorldCount& WithFloorplanCount(int value) {
    SetFloorplanCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInteriorCountPerFloorplan(int value) {
    m_interiorCountPerFloorplanHasBeenSet = true;
    m_interiorCountPerFloorplan = value;
  }
  inline WorldCount& WithInteriorCountPerFloorplan(int value) {
    SetInteriorCountPerFloorplan(value);
    return *this;
  }
  ///@}
 private:
