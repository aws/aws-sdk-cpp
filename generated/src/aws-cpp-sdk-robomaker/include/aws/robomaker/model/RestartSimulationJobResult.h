...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API RestartSimulationJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RestartSimulationJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
