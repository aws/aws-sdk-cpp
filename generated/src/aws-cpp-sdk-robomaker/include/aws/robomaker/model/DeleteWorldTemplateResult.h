...
namespace Model
{
  ...
  public:
    ...
    inline DeleteWorldTemplateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline DeleteWorldTemplateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline DeleteWorldTemplateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
