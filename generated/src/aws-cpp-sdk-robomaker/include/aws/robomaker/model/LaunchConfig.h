...
class LaunchConfig {
 public:
  ...
  void SetPortForwardingConfig(PortForwardingConfigT&& value) {
    ...
    m_portForwardingConfig = std::forward<PortForwardingConfigT>(value);
  }
  template <typename PortForwardingConfigT = PortForwardingConfig>
  LaunchConfig& WithPortForwardingConfig(PortForwardingConfigT&& value) {
    SetPortForwardingConfig(std::forward<PortForwardingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStreamUI(bool value) {
    m_streamUIHasBeenSet = true;
    m_streamUI = value;
  }
  inline LaunchConfig& WithStreamUI(bool value) {
    SetStreamUI(value);
    return *this;
  }
  ///@}
