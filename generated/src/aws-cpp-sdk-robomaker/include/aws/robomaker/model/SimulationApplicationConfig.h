...
class SimulationApplicationConfig {
 public:
  ...
  void SetLaunchConfig(LaunchConfigT&& value) {
    ...
    m_launchConfig = std::forward<LaunchConfigT>(value);
  }
  template <typename LaunchConfigT = LaunchConfig>
  SimulationApplicationConfig& WithLaunchConfig(LaunchConfigT&& value) {
    SetLaunchConfig(std::forward<LaunchConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUploadConfigurations(UploadConfigurationsT&& value) {
    ...
    m_uploadConfigurations = std::forward<UploadConfigurationsT>(value);
  }
  template <typename UploadConfigurationsT = Aws::Vector<UploadConfiguration>>
  SimulationApplicationConfig& WithUploadConfigurations(UploadConfigurationsT&& value) {
    SetUploadConfigurations(std::forward<UploadConfigurationsT>(value));
    return *this;
  }
  ...
  SimulationApplicationConfig& AddUploadConfigurations(UploadConfigurationsT&& value) {
    m_uploadConfigurationsHasBeenSet = true;
    m_uploadConfigurations.emplace_back(std::forward<UploadConfigurationsT>(value));
    return *this;
  }
  ///@}
