...
class SimulationJobSummary {
 public:
  ...
  inline SimulationJobSummary& WithStatus(SimulationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSimulationApplicationNames(SimulationApplicationNamesT&& value) {
    ...
    m_simulationApplicationNames = std::forward<SimulationApplicationNamesT>(value);
  }
  template <typename SimulationApplicationNamesT = Aws::Vector<Aws::String>>
  SimulationJobSummary& WithSimulationApplicationNames(SimulationApplicationNamesT&& value) {
    SetSimulationApplicationNames(std::forward<SimulationApplicationNamesT>(value));
    return *this;
  }
  ...
  SimulationJobSummary& AddSimulationApplicationNames(SimulationApplicationNamesT&& value) {
    m_simulationApplicationNamesHasBeenSet = true;
    m_simulationApplicationNames.emplace_back(std::forward<SimulationApplicationNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRobotApplicationNames(RobotApplicationNamesT&& value) {
    ...
    m_robotApplicationNames = std::forward<RobotApplicationNamesT>(value);
  }
  template <typename RobotApplicationNamesT = Aws::Vector<Aws::String>>
  SimulationJobSummary& WithRobotApplicationNames(RobotApplicationNamesT&& value) {
    SetRobotApplicationNames(std::forward<RobotApplicationNamesT>(value));
    return *this;
  }
  ...
  SimulationJobSummary& AddRobotApplicationNames(RobotApplicationNamesT&& value) {
    m_robotApplicationNamesHasBeenSet = true;
    m_robotApplicationNames.emplace_back(std::forward<RobotApplicationNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataSourceNames(DataSourceNamesT&& value) {
    ...
    m_dataSourceNames = std::forward<DataSourceNamesT>(value);
  }
  template <typename DataSourceNamesT = Aws::Vector<Aws::String>>
  SimulationJobSummary& WithDataSourceNames(DataSourceNamesT&& value) {
    SetDataSourceNames(std::forward<DataSourceNamesT>(value));
    return *this;
  }
  template <typename DataSourceNamesT = Aws::String>
  SimulationJobSummary& AddDataSourceNames(DataSourceNamesT&& value) {
    m_dataSourceNamesHasBeenSet = true;
    m_dataSourceNames.emplace_back(std::forward<DataSourceNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline SimulationJobSummary& WithComputeType(ComputeType value) {
