...
class DescribeWorldResult {
 public:
  ...
  void SetGenerationJob(GenerationJobT&& value) {
    ...
    m_generationJob = std::forward<GenerationJobT>(value);
  }
  template <typename GenerationJobT = Aws::String>
  DescribeWorldResult& WithGenerationJob(GenerationJobT&& value) {
    SetGenerationJob(std::forward<GenerationJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorldDescriptionBody(WorldDescriptionBodyT&& value) {
    ...
    m_worldDescriptionBody = std::forward<WorldDescriptionBodyT>(value);
  }
  template <typename WorldDescriptionBodyT = Aws::String>
  DescribeWorldResult& WithWorldDescriptionBody(WorldDescriptionBodyT&& value) {
    SetWorldDescriptionBody(std::forward<WorldDescriptionBodyT>(value));
    return *this;
  }
  ///@}
