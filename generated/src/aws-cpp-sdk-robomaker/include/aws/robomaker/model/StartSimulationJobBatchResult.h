...
class StartSimulationJobBatchResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  StartSimulationJobBatchResult& WithArn(ArnT&& value) {
  ...
  inline void SetStatus(SimulationJobBatchStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartSimulationJobBatchResult& WithStatus(SimulationJobBatchStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  StartSimulationJobBatchResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StartSimulationJobBatchResult& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  void SetBatchPolicy(BatchPolicyT&& value) {
    m_batchPolicyHasBeenSet = true;
    m_batchPolicy = std::forward<BatchPolicyT>(value);
  }
  template <typename BatchPolicyT = BatchPolicy>
  StartSimulationJobBatchResult& WithBatchPolicy(BatchPolicyT&& value) {
    SetBatchPolicy(std::forward<BatchPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFailureCode(SimulationJobBatchErrorCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline StartSimulationJobBatchResult& WithFailureCode(SimulationJobBatchErrorCode value) {
  ...
  template <typename FailureReasonT = Aws::String>
  StartSimulationJobBatchResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedCreateSimulationJobRequest>>
  StartSimulationJobBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedCreateSimulationJobRequest>
  StartSimulationJobBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  void SetPendingRequests(PendingRequestsT&& value) {
    m_pendingRequestsHasBeenSet = true;
    m_pendingRequests = std::forward<PendingRequestsT>(value);
  }
  template <typename PendingRequestsT = Aws::Vector<SimulationJobRequest>>
  StartSimulationJobBatchResult& WithPendingRequests(PendingRequestsT&& value) {
    SetPendingRequests(std::forward<PendingRequestsT>(value));
    return *this;
  }
  template <typename PendingRequestsT = SimulationJobRequest>
  StartSimulationJobBatchResult& AddPendingRequests(PendingRequestsT&& value) {
    m_pendingRequestsHasBeenSet = true;
    m_pendingRequests.emplace_back(std::forward<PendingRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreatedRequests(CreatedRequestsT&& value) {
    m_createdRequestsHasBeenSet = true;
    m_createdRequests = std::forward<CreatedRequestsT>(value);
  }
  template <typename CreatedRequestsT = Aws::Vector<SimulationJobSummary>>
  StartSimulationJobBatchResult& WithCreatedRequests(CreatedRequestsT&& value) {
    SetCreatedRequests(std::forward<CreatedRequestsT>(value));
    return *this;
  }
  template <typename CreatedRequestsT = SimulationJobSummary>
  StartSimulationJobBatchResult& AddCreatedRequests(CreatedRequestsT&& value) {
    m_createdRequestsHasBeenSet = true;
    m_createdRequests.emplace_back(std::forward<CreatedRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  StartSimulationJobBatchResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartSimulationJobBatchResult& WithRequestId(RequestIdT&& value) {
