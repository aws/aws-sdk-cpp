...
class DeploymentConfig {
 public:
  ...
  inline void SetConcurrentDeploymentPercentage(int value) {
    m_concurrentDeploymentPercentageHasBeenSet = true;
    m_concurrentDeploymentPercentage = value;
  }
  inline DeploymentConfig& WithConcurrentDeploymentPercentage(int value) {
    SetConcurrentDeploymentPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailureThresholdPercentage(int value) {
    m_failureThresholdPercentageHasBeenSet = true;
    m_failureThresholdPercentage = value;
  }
  inline DeploymentConfig& WithFailureThresholdPercentage(int value) {
    SetFailureThresholdPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRobotDeploymentTimeoutInSeconds(long long value) {
    m_robotDeploymentTimeoutInSecondsHasBeenSet = true;
    m_robotDeploymentTimeoutInSeconds = value;
  }
  inline DeploymentConfig& WithRobotDeploymentTimeoutInSeconds(long long value) {
    SetRobotDeploymentTimeoutInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetDownloadConditionFile(DownloadConditionFileT&& value) {
    ...
    m_downloadConditionFile = std::forward<DownloadConditionFileT>(value);
  }
  template <typename DownloadConditionFileT = S3Object>
  DeploymentConfig& WithDownloadConditionFile(DownloadConditionFileT&& value) {
    SetDownloadConditionFile(std::forward<DownloadConditionFileT>(value));
    return *this;
  }
  ///@}
 private:
