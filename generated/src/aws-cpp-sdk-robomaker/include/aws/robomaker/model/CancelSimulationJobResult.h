...
namespace Model
{
  ...
  public:
    ...
    inline CancelSimulationJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelSimulationJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelSimulationJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
