...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API CancelSimulationJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelSimulationJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
