...
class BatchDeleteWorldsResult {
 public:
  ...
  void SetUnprocessedWorlds(UnprocessedWorldsT&& value) {
    m_unprocessedWorldsHasBeenSet = true;
    m_unprocessedWorlds = std::forward<UnprocessedWorldsT>(value);
  }
  template <typename UnprocessedWorldsT = Aws::Vector<Aws::String>>
  BatchDeleteWorldsResult& WithUnprocessedWorlds(UnprocessedWorldsT&& value) {
    SetUnprocessedWorlds(std::forward<UnprocessedWorldsT>(value));
    return *this;
  }
  template <typename UnprocessedWorldsT = Aws::String>
  BatchDeleteWorldsResult& AddUnprocessedWorlds(UnprocessedWorldsT&& value) {
    m_unprocessedWorldsHasBeenSet = true;
    m_unprocessedWorlds.emplace_back(std::forward<UnprocessedWorldsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteWorldsResult& WithRequestId(RequestIdT&& value) {
