...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API CancelSimulationJobBatchResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CancelSimulationJobBatchResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
