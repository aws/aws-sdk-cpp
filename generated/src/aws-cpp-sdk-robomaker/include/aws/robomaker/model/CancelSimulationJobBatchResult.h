...
namespace Model
{
  ...
  public:
    ...
    inline CancelSimulationJobBatchResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CancelSimulationJobBatchResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CancelSimulationJobBatchResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
