...
namespace Model
{
  ...
  {
  public:
    AWS_ROBOMAKER_API DeleteRobotApplicationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRobotApplicationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
