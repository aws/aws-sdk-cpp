...
class DescribeSimulationJobBatchResult {
 public:
  AWS_ROBOMAKER_API DescribeSimulationJobBatchResult() = default;
  ...
  template <typename ArnT = Aws::String>
  DescribeSimulationJobBatchResult& WithArn(ArnT&& value) {
  ...
  inline DescribeSimulationJobBatchResult& WithStatus(SimulationJobBatchStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  DescribeSimulationJobBatchResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  DescribeSimulationJobBatchResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  DescribeSimulationJobBatchResult& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename BatchPolicyT = BatchPolicy>
  DescribeSimulationJobBatchResult& WithBatchPolicy(BatchPolicyT&& value) {
  ...
  inline DescribeSimulationJobBatchResult& WithFailureCode(SimulationJobBatchErrorCode value) {
  ...
  template <typename FailureReasonT = Aws::String>
  DescribeSimulationJobBatchResult& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedCreateSimulationJobRequest>>
  DescribeSimulationJobBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedCreateSimulationJobRequest>
  DescribeSimulationJobBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename PendingRequestsT = Aws::Vector<SimulationJobRequest>>
  DescribeSimulationJobBatchResult& WithPendingRequests(PendingRequestsT&& value) {
    SetPendingRequests(std::forward<PendingRequestsT>(value));
    return *this;
  }
  template <typename PendingRequestsT = SimulationJobRequest>
  DescribeSimulationJobBatchResult& AddPendingRequests(PendingRequestsT&& value) {
    m_pendingRequestsHasBeenSet = true;
  ...
  template <typename CreatedRequestsT = Aws::Vector<SimulationJobSummary>>
  DescribeSimulationJobBatchResult& WithCreatedRequests(CreatedRequestsT&& value) {
    SetCreatedRequests(std::forward<CreatedRequestsT>(value));
    return *this;
  }
  template <typename CreatedRequestsT = SimulationJobSummary>
  DescribeSimulationJobBatchResult& AddCreatedRequests(CreatedRequestsT&& value) {
    m_createdRequestsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeSimulationJobBatchResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  DescribeSimulationJobBatchResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSimulationJobBatchResult& WithRequestId(RequestIdT&& value) {
