...
class ListSimulationJobsRequest : public RoboMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSimulationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListSimulationJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListSimulationJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
