...
class ListWorldGenerationJobsRequest : public RoboMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldGenerationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorldGenerationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListWorldGenerationJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListWorldGenerationJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
