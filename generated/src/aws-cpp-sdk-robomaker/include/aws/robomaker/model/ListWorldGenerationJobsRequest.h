...
namespace Model
{
  ...
  /**
   */
  class ListWorldGenerationJobsRequest : public RoboMakerRequest
  {
  public:
    AWS_ROBOMAKER_API ListWorldGenerationJobsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListWorldGenerationJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListWorldGenerationJobsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListWorldGenerationJobsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
