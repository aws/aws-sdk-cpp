...
class WorldSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  WorldSummary& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  WorldSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename GenerationJobT = Aws::String>
  WorldSummary& WithGenerationJob(GenerationJobT&& value) {
  ...
  template <typename TemplateT = Aws::String>
  WorldSummary& WithTemplate(TemplateT&& value) {
