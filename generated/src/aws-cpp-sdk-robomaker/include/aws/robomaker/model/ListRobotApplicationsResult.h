...
class ListRobotApplicationsResult {
 public:
  ...
  void SetRobotApplicationSummaries(RobotApplicationSummariesT&& value) {
    m_robotApplicationSummariesHasBeenSet = true;
    m_robotApplicationSummaries = std::forward<RobotApplicationSummariesT>(value);
  }
  template <typename RobotApplicationSummariesT = Aws::Vector<RobotApplicationSummary>>
  ListRobotApplicationsResult& WithRobotApplicationSummaries(RobotApplicationSummariesT&& value) {
    SetRobotApplicationSummaries(std::forward<RobotApplicationSummariesT>(value));
    return *this;
  }
  template <typename RobotApplicationSummariesT = RobotApplicationSummary>
  ListRobotApplicationsResult& AddRobotApplicationSummaries(RobotApplicationSummariesT&& value) {
    m_robotApplicationSummariesHasBeenSet = true;
    m_robotApplicationSummaries.emplace_back(std::forward<RobotApplicationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRobotApplicationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRobotApplicationsResult& WithRequestId(RequestIdT&& value) {
