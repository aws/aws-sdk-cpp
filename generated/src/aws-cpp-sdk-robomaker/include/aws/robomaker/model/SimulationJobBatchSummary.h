...
class SimulationJobBatchSummary {
 public:
  ...
  template <typename ArnT = Aws::String>
  SimulationJobBatchSummary& WithArn(ArnT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  SimulationJobBatchSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  SimulationJobBatchSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline SimulationJobBatchSummary& WithStatus(SimulationJobBatchStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedRequestCount(int value) {
    m_failedRequestCountHasBeenSet = true;
    m_failedRequestCount = value;
  }
  inline SimulationJobBatchSummary& WithFailedRequestCount(int value) {
    SetFailedRequestCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPendingRequestCount(int value) {
    m_pendingRequestCountHasBeenSet = true;
    m_pendingRequestCount = value;
  }
  inline SimulationJobBatchSummary& WithPendingRequestCount(int value) {
    SetPendingRequestCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCreatedRequestCount(int value) {
    m_createdRequestCountHasBeenSet = true;
    m_createdRequestCount = value;
  }
  inline SimulationJobBatchSummary& WithCreatedRequestCount(int value) {
    SetCreatedRequestCount(value);
    return *this;
  }
  ///@}
 private:
