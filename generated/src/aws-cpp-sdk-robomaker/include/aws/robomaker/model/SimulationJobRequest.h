...
class SimulationJobRequest {
 public:
  ...
  inline SimulationJobRequest& WithMaxJobDurationInSeconds(long long value) {
  ...
  inline SimulationJobRequest& WithFailureBehavior(FailureBehavior value) {
  ...
  inline void SetUseDefaultApplications(bool value) {
    m_useDefaultApplicationsHasBeenSet = true;
    m_useDefaultApplications = value;
  }
  inline SimulationJobRequest& WithUseDefaultApplications(bool value) {
    SetUseDefaultApplications(value);
    return *this;
  }
  ///@}
