...
class CreateSimulationJobResult {
 public:
  ...
  inline CreateSimulationJobResult& WithStatus(SimulationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSimulationJobResult& WithFailureBehavior(FailureBehavior value) {
  ...
  inline CreateSimulationJobResult& WithFailureCode(SimulationJobErrorCode value) {
  ...
  inline CreateSimulationJobResult& WithMaxJobDurationInSeconds(long long value) {
  ...
  inline CreateSimulationJobResult& WithSimulationTimeMillis(long long value) {
