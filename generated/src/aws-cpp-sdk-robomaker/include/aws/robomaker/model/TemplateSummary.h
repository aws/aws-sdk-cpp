...
namespace Model
{
  ...
  public:
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    TemplateSummary& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename VersionT = Aws::String>
    TemplateSummary& WithVersion(VersionT&& value) { SetVersion(std::forward<VersionT>(value)); return *this;}
    ///@}
  private:
