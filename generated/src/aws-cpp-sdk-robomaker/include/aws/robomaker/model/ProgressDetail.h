...
class ProgressDetail {
 public:
  ...
  inline void SetCurrentProgress(RobotDeploymentStep value) {
    m_currentProgressHasBeenSet = true;
    m_currentProgress = value;
  }
  inline ProgressDetail& WithCurrentProgress(RobotDeploymentStep value) {
  ...
  inline void SetPercentDone(double value) {
    m_percentDoneHasBeenSet = true;
    m_percentDone = value;
  }
  inline ProgressDetail& WithPercentDone(double value) {
  ...
  inline void SetEstimatedTimeRemainingSeconds(int value) {
    m_estimatedTimeRemainingSecondsHasBeenSet = true;
    m_estimatedTimeRemainingSeconds = value;
  }
  inline ProgressDetail& WithEstimatedTimeRemainingSeconds(int value) {
    SetEstimatedTimeRemainingSeconds(value);
    return *this;
  }
  ///@}
