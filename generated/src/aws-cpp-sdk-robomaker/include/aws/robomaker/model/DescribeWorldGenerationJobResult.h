...
class DescribeWorldGenerationJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeWorldGenerationJobResult& WithArn(ArnT&& value) {
  ...
  inline DescribeWorldGenerationJobResult& WithStatus(WorldGenerationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeWorldGenerationJobResult& WithFailureCode(WorldGenerationJobErrorCode value) {
  ...
  void SetFinishedWorldsSummary(FinishedWorldsSummaryT&& value) {
    m_finishedWorldsSummaryHasBeenSet = true;
    m_finishedWorldsSummary = std::forward<FinishedWorldsSummaryT>(value);
  }
  template <typename FinishedWorldsSummaryT = FinishedWorldsSummary>
  DescribeWorldGenerationJobResult& WithFinishedWorldsSummary(FinishedWorldsSummaryT&& value) {
    SetFinishedWorldsSummary(std::forward<FinishedWorldsSummaryT>(value));
    return *this;
  }
  ///@}
