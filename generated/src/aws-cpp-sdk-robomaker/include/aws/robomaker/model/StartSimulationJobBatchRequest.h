...
class StartSimulationJobBatchRequest : public RoboMakerRequest {
 public:
  ...
  void SetCreateSimulationJobRequests(CreateSimulationJobRequestsT&& value) {
    m_createSimulationJobRequestsHasBeenSet = true;
    m_createSimulationJobRequests = std::forward<CreateSimulationJobRequestsT>(value);
  }
  template <typename CreateSimulationJobRequestsT = Aws::Vector<SimulationJobRequest>>
  StartSimulationJobBatchRequest& WithCreateSimulationJobRequests(CreateSimulationJobRequestsT&& value) {
    SetCreateSimulationJobRequests(std::forward<CreateSimulationJobRequestsT>(value));
    return *this;
  }
  ...
  StartSimulationJobBatchRequest& AddCreateSimulationJobRequests(CreateSimulationJobRequestsT&& value) {
    m_createSimulationJobRequestsHasBeenSet = true;
    m_createSimulationJobRequests.emplace_back(std::forward<CreateSimulationJobRequestsT>(value));
    return *this;
  }
  ///@}
