...
class ListWorldsResult {
 public:
  ...
  void SetWorldSummaries(WorldSummariesT&& value) {
    m_worldSummariesHasBeenSet = true;
    m_worldSummaries = std::forward<WorldSummariesT>(value);
  }
  template <typename WorldSummariesT = Aws::Vector<WorldSummary>>
  ListWorldsResult& WithWorldSummaries(WorldSummariesT&& value) {
    SetWorldSummaries(std::forward<WorldSummariesT>(value));
    return *this;
  }
  template <typename WorldSummariesT = WorldSummary>
  ListWorldsResult& AddWorldSummaries(WorldSummariesT&& value) {
    m_worldSummariesHasBeenSet = true;
    m_worldSummaries.emplace_back(std::forward<WorldSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorldsResult& WithRequestId(RequestIdT&& value) {
