...
class SimulationJob {
 public:
  ...
  inline SimulationJob& WithStatus(SimulationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline SimulationJob& WithFailureBehavior(FailureBehavior value) {
  ...
  inline SimulationJob& WithFailureCode(SimulationJobErrorCode value) {
  ...
  inline SimulationJob& WithMaxJobDurationInSeconds(long long value) {
  ...
  inline SimulationJob& WithSimulationTimeMillis(long long value) {
