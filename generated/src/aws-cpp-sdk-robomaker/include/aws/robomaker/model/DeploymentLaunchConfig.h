...
class DeploymentLaunchConfig {
 public:
  ...
  void SetPreLaunchFile(PreLaunchFileT&& value) {
    ...
    m_preLaunchFile = std::forward<PreLaunchFileT>(value);
  }
  template <typename PreLaunchFileT = Aws::String>
  DeploymentLaunchConfig& WithPreLaunchFile(PreLaunchFileT&& value) {
    SetPreLaunchFile(std::forward<PreLaunchFileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLaunchFile(LaunchFileT&& value) {
    ...
    m_launchFile = std::forward<LaunchFileT>(value);
  }
  template <typename LaunchFileT = Aws::String>
  DeploymentLaunchConfig& WithLaunchFile(LaunchFileT&& value) {
    SetLaunchFile(std::forward<LaunchFileT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostLaunchFile(PostLaunchFileT&& value) {
    ...
    m_postLaunchFile = std::forward<PostLaunchFileT>(value);
  }
  template <typename PostLaunchFileT = Aws::String>
  DeploymentLaunchConfig& WithPostLaunchFile(PostLaunchFileT&& value) {
    SetPostLaunchFile(std::forward<PostLaunchFileT>(value));
    return *this;
  }
  ///@}
