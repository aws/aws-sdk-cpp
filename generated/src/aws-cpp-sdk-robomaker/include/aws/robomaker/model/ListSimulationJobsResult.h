...
class ListSimulationJobsResult {
 public:
  ...
  void SetSimulationJobSummaries(SimulationJobSummariesT&& value) {
    m_simulationJobSummariesHasBeenSet = true;
    m_simulationJobSummaries = std::forward<SimulationJobSummariesT>(value);
  }
  template <typename SimulationJobSummariesT = Aws::Vector<SimulationJobSummary>>
  ListSimulationJobsResult& WithSimulationJobSummaries(SimulationJobSummariesT&& value) {
    SetSimulationJobSummaries(std::forward<SimulationJobSummariesT>(value));
    return *this;
  }
  template <typename SimulationJobSummariesT = SimulationJobSummary>
  ListSimulationJobsResult& AddSimulationJobSummaries(SimulationJobSummariesT&& value) {
    m_simulationJobSummariesHasBeenSet = true;
    m_simulationJobSummaries.emplace_back(std::forward<SimulationJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSimulationJobsResult& WithRequestId(RequestIdT&& value) {
