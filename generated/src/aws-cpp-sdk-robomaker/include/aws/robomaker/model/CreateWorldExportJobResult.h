...
namespace Model
{
  ...
  public:
    ...
    inline CreateWorldExportJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateWorldExportJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateWorldExportJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
