...
class CreateWorldExportJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateWorldExportJobResult& WithArn(ArnT&& value) {
  ...
  inline void SetStatus(WorldExportJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CreateWorldExportJobResult& WithStatus(WorldExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateWorldExportJobResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline void SetFailureCode(WorldExportJobErrorCode value) {
    m_failureCodeHasBeenSet = true;
    m_failureCode = value;
  }
  inline CreateWorldExportJobResult& WithFailureCode(WorldExportJobErrorCode value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateWorldExportJobResult& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename OutputLocationT = OutputLocation>
  CreateWorldExportJobResult& WithOutputLocation(OutputLocationT&& value) {
  ...
  template <typename IamRoleT = Aws::String>
  CreateWorldExportJobResult& WithIamRole(IamRoleT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateWorldExportJobResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWorldExportJobResult& WithRequestId(RequestIdT&& value) {
