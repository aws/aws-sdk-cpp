...
class ListWorldTemplatesRequest : public RoboMakerRequest {
 public:
  AWS_ROBOMAKER_API ListWorldTemplatesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListWorldTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorldTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
