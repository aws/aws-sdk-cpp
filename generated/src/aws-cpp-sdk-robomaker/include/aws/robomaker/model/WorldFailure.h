...
class WorldFailure {
 public:
  ...
  inline WorldFailure& WithFailureCode(WorldGenerationJobErrorCode value) {
  ...
  void SetSampleFailureReason(SampleFailureReasonT&& value) {
    ...
    m_sampleFailureReason = std::forward<SampleFailureReasonT>(value);
  }
  template <typename SampleFailureReasonT = Aws::String>
  WorldFailure& WithSampleFailureReason(SampleFailureReasonT&& value) {
    SetSampleFailureReason(std::forward<SampleFailureReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline WorldFailure& WithFailureCount(int value) {
