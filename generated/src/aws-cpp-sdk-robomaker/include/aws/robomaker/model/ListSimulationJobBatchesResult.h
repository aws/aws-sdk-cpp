...
class ListSimulationJobBatchesResult {
 public:
  ...
  void SetSimulationJobBatchSummaries(SimulationJobBatchSummariesT&& value) {
    m_simulationJobBatchSummariesHasBeenSet = true;
    m_simulationJobBatchSummaries = std::forward<SimulationJobBatchSummariesT>(value);
  }
  template <typename SimulationJobBatchSummariesT = Aws::Vector<SimulationJobBatchSummary>>
  ListSimulationJobBatchesResult& WithSimulationJobBatchSummaries(SimulationJobBatchSummariesT&& value) {
    SetSimulationJobBatchSummaries(std::forward<SimulationJobBatchSummariesT>(value));
    return *this;
  }
  template <typename SimulationJobBatchSummariesT = SimulationJobBatchSummary>
  ListSimulationJobBatchesResult& AddSimulationJobBatchSummaries(SimulationJobBatchSummariesT&& value) {
    m_simulationJobBatchSummariesHasBeenSet = true;
    m_simulationJobBatchSummaries.emplace_back(std::forward<SimulationJobBatchSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSimulationJobBatchesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSimulationJobBatchesResult& WithRequestId(RequestIdT&& value) {
