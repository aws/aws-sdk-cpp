...
class AWS_ROBOMAKER_API RoboMakerClient : public Aws::Client::AWSJsonClient,
                                          public Aws::Client::ClientWithAsyncTemplateMethods<RoboMakerClient> {
 public:
   ...
   */
  RoboMakerClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<RoboMakerEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchDeleteWorlds that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteWorlds that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteWorldsRequestT = Model::BatchDeleteWorldsRequest>
  void BatchDeleteWorldsAsync(const BatchDeleteWorldsRequestT& request, const BatchDeleteWorldsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDescribeSimulationJobOutcome BatchDescribeSimulationJob(
      const Model::BatchDescribeSimulationJobRequest& request) const;

  /**
   * A Callable wrapper for BatchDescribeSimulationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDescribeSimulationJobRequestT = Model::BatchDescribeSimulationJobRequest>
  Model::BatchDescribeSimulationJobOutcomeCallable BatchDescribeSimulationJobCallable(
      const BatchDescribeSimulationJobRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::BatchDescribeSimulationJob, request);
  }

  /**
   * An Async wrapper for BatchDescribeSimulationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDescribeSimulationJobRequestT = Model::BatchDescribeSimulationJobRequest>
  void BatchDescribeSimulationJobAsync(const BatchDescribeSimulationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CancelSimulationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelSimulationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelSimulationJobRequestT = Model::CancelSimulationJobRequest>
  void CancelSimulationJobAsync(const CancelSimulationJobRequestT& request, const CancelSimulationJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelSimulationJobBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelSimulationJobBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelSimulationJobBatchRequestT = Model::CancelSimulationJobBatchRequest>
  void CancelSimulationJobBatchAsync(const CancelSimulationJobBatchRequestT& request,
  ...
  /**
   * A Callable wrapper for CancelWorldExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelWorldExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelWorldExportJobRequestT = Model::CancelWorldExportJobRequest>
  void CancelWorldExportJobAsync(const CancelWorldExportJobRequestT& request, const CancelWorldExportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelWorldGenerationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelWorldGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelWorldGenerationJobRequestT = Model::CancelWorldGenerationJobRequest>
  void CancelWorldGenerationJobAsync(const CancelWorldGenerationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateRobotApplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRobotApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRobotApplicationRequestT = Model::CreateRobotApplicationRequest>
  void CreateRobotApplicationAsync(const CreateRobotApplicationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRobotApplicationVersionOutcome CreateRobotApplicationVersion(
      const Model::CreateRobotApplicationVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateRobotApplicationVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRobotApplicationVersionRequestT = Model::CreateRobotApplicationVersionRequest>
  Model::CreateRobotApplicationVersionOutcomeCallable CreateRobotApplicationVersionCallable(
      const CreateRobotApplicationVersionRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::CreateRobotApplicationVersion, request);
  }

  /**
   * An Async wrapper for CreateRobotApplicationVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRobotApplicationVersionRequestT = Model::CreateRobotApplicationVersionRequest>
  void CreateRobotApplicationVersionAsync(const CreateRobotApplicationVersionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateSimulationApplicationOutcome CreateSimulationApplication(
      const Model::CreateSimulationApplicationRequest& request) const;

  /**
   * A Callable wrapper for CreateSimulationApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateSimulationApplicationRequestT = Model::CreateSimulationApplicationRequest>
  Model::CreateSimulationApplicationOutcomeCallable CreateSimulationApplicationCallable(
      const CreateSimulationApplicationRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::CreateSimulationApplication, request);
  }

  /**
   * An Async wrapper for CreateSimulationApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSimulationApplicationRequestT = Model::CreateSimulationApplicationRequest>
  void CreateSimulationApplicationAsync(const CreateSimulationApplicationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateSimulationApplicationVersionOutcome CreateSimulationApplicationVersion(
      const Model::CreateSimulationApplicationVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateSimulationApplicationVersion that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateSimulationApplicationVersionRequestT = Model::CreateSimulationApplicationVersionRequest>
  Model::CreateSimulationApplicationVersionOutcomeCallable CreateSimulationApplicationVersionCallable(
      const CreateSimulationApplicationVersionRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::CreateSimulationApplicationVersion, request);
  }

  /**
   * An Async wrapper for CreateSimulationApplicationVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateSimulationApplicationVersionRequestT = Model::CreateSimulationApplicationVersionRequest>
  void CreateSimulationApplicationVersionAsync(const CreateSimulationApplicationVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateSimulationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSimulationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateSimulationJobRequestT = Model::CreateSimulationJobRequest>
  void CreateSimulationJobAsync(const CreateSimulationJobRequestT& request, const CreateSimulationJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorldExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorldExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorldExportJobRequestT = Model::CreateWorldExportJobRequest>
  void CreateWorldExportJobAsync(const CreateWorldExportJobRequestT& request, const CreateWorldExportJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWorldGenerationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorldGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWorldGenerationJobRequestT = Model::CreateWorldGenerationJobRequest>
  void CreateWorldGenerationJobAsync(const CreateWorldGenerationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateWorldTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorldTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateWorldTemplateRequestT = Model::CreateWorldTemplateRequest>
  void CreateWorldTemplateAsync(const CreateWorldTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const CreateWorldTemplateRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteRobotApplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRobotApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRobotApplicationRequestT = Model::DeleteRobotApplicationRequest>
  void DeleteRobotApplicationAsync(const DeleteRobotApplicationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteSimulationApplicationOutcome DeleteSimulationApplication(
      const Model::DeleteSimulationApplicationRequest& request) const;

  /**
   * A Callable wrapper for DeleteSimulationApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteSimulationApplicationRequestT = Model::DeleteSimulationApplicationRequest>
  Model::DeleteSimulationApplicationOutcomeCallable DeleteSimulationApplicationCallable(
      const DeleteSimulationApplicationRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::DeleteSimulationApplication, request);
  }

  /**
   * An Async wrapper for DeleteSimulationApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSimulationApplicationRequestT = Model::DeleteSimulationApplicationRequest>
  void DeleteSimulationApplicationAsync(const DeleteSimulationApplicationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteWorldTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorldTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteWorldTemplateRequestT = Model::DeleteWorldTemplateRequest>
  void DeleteWorldTemplateAsync(const DeleteWorldTemplateRequestT& request, const DeleteWorldTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeRobotApplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRobotApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeRobotApplicationRequestT = Model::DescribeRobotApplicationRequest>
  void DescribeRobotApplicationAsync(const DescribeRobotApplicationRequestT& request,
  ...
  virtual Model::DescribeSimulationApplicationOutcome DescribeSimulationApplication(
      const Model::DescribeSimulationApplicationRequest& request) const;

  /**
   * A Callable wrapper for DescribeSimulationApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSimulationApplicationRequestT = Model::DescribeSimulationApplicationRequest>
  Model::DescribeSimulationApplicationOutcomeCallable DescribeSimulationApplicationCallable(
      const DescribeSimulationApplicationRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::DescribeSimulationApplication, request);
  }

  /**
   * An Async wrapper for DescribeSimulationApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSimulationApplicationRequestT = Model::DescribeSimulationApplicationRequest>
  void DescribeSimulationApplicationAsync(const DescribeSimulationApplicationRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeSimulationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSimulationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSimulationJobRequestT = Model::DescribeSimulationJobRequest>
  void DescribeSimulationJobAsync(const DescribeSimulationJobRequestT& request, const DescribeSimulationJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSimulationJobBatchOutcome DescribeSimulationJobBatch(
      const Model::DescribeSimulationJobBatchRequest& request) const;

  /**
   * A Callable wrapper for DescribeSimulationJobBatch that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSimulationJobBatchRequestT = Model::DescribeSimulationJobBatchRequest>
  Model::DescribeSimulationJobBatchOutcomeCallable DescribeSimulationJobBatchCallable(
      const DescribeSimulationJobBatchRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::DescribeSimulationJobBatch, request);
  }

  /**
   * An Async wrapper for DescribeSimulationJobBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSimulationJobBatchRequestT = Model::DescribeSimulationJobBatchRequest>
  void DescribeSimulationJobBatchAsync(const DescribeSimulationJobBatchRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeWorld that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeWorldRequestT = Model::DescribeWorldRequest>
  void DescribeWorldAsync(const DescribeWorldRequestT& request, const DescribeWorldResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorldExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorldExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorldExportJobRequestT = Model::DescribeWorldExportJobRequest>
  void DescribeWorldExportJobAsync(const DescribeWorldExportJobRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWorldGenerationJobOutcome DescribeWorldGenerationJob(
      const Model::DescribeWorldGenerationJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeWorldGenerationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWorldGenerationJobRequestT = Model::DescribeWorldGenerationJobRequest>
  Model::DescribeWorldGenerationJobOutcomeCallable DescribeWorldGenerationJobCallable(
      const DescribeWorldGenerationJobRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::DescribeWorldGenerationJob, request);
  }

  /**
   * An Async wrapper for DescribeWorldGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorldGenerationJobRequestT = Model::DescribeWorldGenerationJobRequest>
  void DescribeWorldGenerationJobAsync(const DescribeWorldGenerationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeWorldTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorldTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWorldTemplateRequestT = Model::DescribeWorldTemplateRequest>
  void DescribeWorldTemplateAsync(const DescribeWorldTemplateRequestT& request, const DescribeWorldTemplateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorldTemplateBody that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorldTemplateBody that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorldTemplateBodyRequestT = Model::GetWorldTemplateBodyRequest>
  void GetWorldTemplateBodyAsync(const GetWorldTemplateBodyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetWorldTemplateBodyRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRobotApplications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRobotApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRobotApplicationsRequestT = Model::ListRobotApplicationsRequest>
  void ListRobotApplicationsAsync(const ListRobotApplicationsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListRobotApplicationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSimulationApplicationsOutcome ListSimulationApplications(
      const Model::ListSimulationApplicationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSimulationApplications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSimulationApplicationsRequestT = Model::ListSimulationApplicationsRequest>
  Model::ListSimulationApplicationsOutcomeCallable ListSimulationApplicationsCallable(
      const ListSimulationApplicationsRequestT& request = {}) const {
    return SubmitCallable(&RoboMakerClient::ListSimulationApplications, request);
  }

  /**
   * An Async wrapper for ListSimulationApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSimulationApplicationsRequestT = Model::ListSimulationApplicationsRequest>
  void ListSimulationApplicationsAsync(const ListSimulationApplicationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListSimulationApplicationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSimulationJobBatches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListSimulationJobBatchesRequestT = Model::ListSimulationJobBatchesRequest>
  Model::ListSimulationJobBatchesOutcomeCallable ListSimulationJobBatchesCallable(
      const ListSimulationJobBatchesRequestT& request = {}) const {
    return SubmitCallable(&RoboMakerClient::ListSimulationJobBatches, request);
  }

  /**
   * An Async wrapper for ListSimulationJobBatches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSimulationJobBatchesRequestT = Model::ListSimulationJobBatchesRequest>
  void ListSimulationJobBatchesAsync(const ListSimulationJobBatchesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListSimulationJobBatchesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSimulationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSimulationJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSimulationJobsRequestT = Model::ListSimulationJobsRequest>
  void ListSimulationJobsAsync(const ListSimulationJobsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListSimulationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorldExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorldExportJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWorldExportJobsRequestT = Model::ListWorldExportJobsRequest>
  void ListWorldExportJobsAsync(const ListWorldExportJobsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListWorldExportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorldGenerationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorldGenerationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorldGenerationJobsRequestT = Model::ListWorldGenerationJobsRequest>
  void ListWorldGenerationJobsAsync(const ListWorldGenerationJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListWorldGenerationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorldTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorldTemplates that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWorldTemplatesRequestT = Model::ListWorldTemplatesRequest>
  void ListWorldTemplatesAsync(const ListWorldTemplatesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListWorldTemplatesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListWorlds that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWorldsRequestT = Model::ListWorldsRequest>
  void ListWorldsAsync(const ListWorldsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListWorldsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RestartSimulationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RestartSimulationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestartSimulationJobRequestT = Model::RestartSimulationJobRequest>
  void RestartSimulationJobAsync(const RestartSimulationJobRequestT& request, const RestartSimulationJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartSimulationJobBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartSimulationJobBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartSimulationJobBatchRequestT = Model::StartSimulationJobBatchRequest>
  void StartSimulationJobBatchAsync(const StartSimulationJobBatchRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateRobotApplication that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRobotApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRobotApplicationRequestT = Model::UpdateRobotApplicationRequest>
  void UpdateRobotApplicationAsync(const UpdateRobotApplicationRequestT& request,
  ...
  virtual Model::UpdateSimulationApplicationOutcome UpdateSimulationApplication(
      const Model::UpdateSimulationApplicationRequest& request) const;

  /**
   * A Callable wrapper for UpdateSimulationApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSimulationApplicationRequestT = Model::UpdateSimulationApplicationRequest>
  Model::UpdateSimulationApplicationOutcomeCallable UpdateSimulationApplicationCallable(
      const UpdateSimulationApplicationRequestT& request) const {
    return SubmitCallable(&RoboMakerClient::UpdateSimulationApplication, request);
  }

  /**
   * An Async wrapper for UpdateSimulationApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSimulationApplicationRequestT = Model::UpdateSimulationApplicationRequest>
  void UpdateSimulationApplicationAsync(const UpdateSimulationApplicationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateWorldTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateWorldTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateWorldTemplateRequestT = Model::UpdateWorldTemplateRequest>
  void UpdateWorldTemplateAsync(const UpdateWorldTemplateRequestT& request, const UpdateWorldTemplateResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
