...
ListRobotApplicationsResult::ListRobotApplicationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListRobotApplicationsResult& ListRobotApplicationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("robotApplicationSummaries")) {
    ...
    for (unsigned robotApplicationSummariesIndex = 0; robotApplicationSummariesIndex < robotApplicationSummariesJsonList.GetLength();
         ++robotApplicationSummariesIndex) {
