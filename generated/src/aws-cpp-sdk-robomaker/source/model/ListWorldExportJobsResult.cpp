...
ListWorldExportJobsResult::ListWorldExportJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListWorldExportJobsResult& ListWorldExportJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("worldExportJobSummaries")) {
    ...
    for (unsigned worldExportJobSummariesIndex = 0; worldExportJobSummariesIndex < worldExportJobSummariesJsonList.GetLength();
         ++worldExportJobSummariesIndex) {
