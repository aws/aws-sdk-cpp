...
UpdateSimulationApplicationResult::UpdateSimulationApplicationResult()
{
}

UpdateSimulationApplicationResult::UpdateSimulationApplicationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

UpdateSimulationApplicationResult& UpdateSimulationApplicationResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
