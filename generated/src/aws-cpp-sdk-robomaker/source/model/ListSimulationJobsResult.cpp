...
ListSimulationJobsResult::ListSimulationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListSimulationJobsResult& ListSimulationJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("simulationJobSummaries")) {
    ...
    for (unsigned simulationJobSummariesIndex = 0; simulationJobSummariesIndex < simulationJobSummariesJsonList.GetLength();
         ++simulationJobSummariesIndex) {
