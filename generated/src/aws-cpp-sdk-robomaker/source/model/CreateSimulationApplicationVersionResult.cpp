...
CreateSimulationApplicationVersionResult::CreateSimulationApplicationVersionResult()
{
}

CreateSimulationApplicationVersionResult::CreateSimulationApplicationVersionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateSimulationApplicationVersionResult& CreateSimulationApplicationVersionResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
