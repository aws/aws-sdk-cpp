...
Aws::String StartSimulationJobBatchRequest::SerializePayload() const {
  ...
  if (m_createSimulationJobRequestsHasBeenSet) {
    ...
    for (unsigned createSimulationJobRequestsIndex = 0; createSimulationJobRequestsIndex < createSimulationJobRequestsJsonList.GetLength();
         ++createSimulationJobRequestsIndex) {
      createSimulationJobRequestsJsonList[createSimulationJobRequestsIndex].AsObject(
          m_createSimulationJobRequests[createSimulationJobRequestsIndex].Jsonize());
    }
