...
namespace ConnectCampaigns
{
   ...
   */
  class AWS_CONNECTCAMPAIGNS_API ConnectCampaignsClient : Aws::Client::ClientWithAsyncTemplateMethods<ConnectCampaignsClient>,
    smithy::client::AwsSmithyClientT<Aws::ConnectCampaigns::SERVICE_NAME,
