...
class GetCampaignStateBatchResult {
 public:
  AWS_CONNECTCAMPAIGNS_API GetCampaignStateBatchResult() = default;
  ...
  template <typename SuccessfulRequestsT = Aws::Vector<SuccessfulCampaignStateResponse>>
  GetCampaignStateBatchResult& WithSuccessfulRequests(SuccessfulRequestsT&& value) {
  ...
  GetCampaignStateBatchResult& AddSuccessfulRequests(SuccessfulRequestsT&& value) {
    m_successfulRequestsHasBeenSet = true;
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedCampaignStateResponse>>
  GetCampaignStateBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedCampaignStateResponse>
  GetCampaignStateBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetCampaignStateBatchResult& WithRequestId(RequestIdT&& value) {
