...
class InstanceIdFilter {
 public:
  ...
  template <typename ValueT = Aws::String>
  InstanceIdFilter& WithValue(ValueT&& value) {
  ...
  inline void SetOperator(InstanceIdFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline InstanceIdFilter& WithOperator(InstanceIdFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
