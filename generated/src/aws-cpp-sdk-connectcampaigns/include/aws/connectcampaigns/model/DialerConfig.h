...
class DialerConfig {
 public:
  ...
  void SetProgressiveDialerConfig(ProgressiveDialerConfigT&& value) {
    ...
    m_progressiveDialerConfig = std::forward<ProgressiveDialerConfigT>(value);
  }
  template <typename ProgressiveDialerConfigT = ProgressiveDialerConfig>
  DialerConfig& WithProgressiveDialerConfig(ProgressiveDialerConfigT&& value) {
    SetProgressiveDialerConfig(std::forward<ProgressiveDialerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredictiveDialerConfig(PredictiveDialerConfigT&& value) {
    ...
    m_predictiveDialerConfig = std::forward<PredictiveDialerConfigT>(value);
  }
  template <typename PredictiveDialerConfigT = PredictiveDialerConfig>
  DialerConfig& WithPredictiveDialerConfig(PredictiveDialerConfigT&& value) {
    SetPredictiveDialerConfig(std::forward<PredictiveDialerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentlessDialerConfig(AgentlessDialerConfigT&& value) {
    ...
    m_agentlessDialerConfig = std::forward<AgentlessDialerConfigT>(value);
  }
  template <typename AgentlessDialerConfigT = AgentlessDialerConfig>
  DialerConfig& WithAgentlessDialerConfig(AgentlessDialerConfigT&& value) {
    SetAgentlessDialerConfig(std::forward<AgentlessDialerConfigT>(value));
    return *this;
  }
  ///@}
 private:
