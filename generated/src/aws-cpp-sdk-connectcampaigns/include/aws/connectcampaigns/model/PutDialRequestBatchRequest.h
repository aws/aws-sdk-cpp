...
class PutDialRequestBatchRequest : public ConnectCampaignsRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  PutDialRequestBatchRequest& WithId(IdT&& value) {
  ...
  void SetDialRequests(DialRequestsT&& value) {
    m_dialRequestsHasBeenSet = true;
    m_dialRequests = std::forward<DialRequestsT>(value);
  }
  template <typename DialRequestsT = Aws::Vector<DialRequest>>
  PutDialRequestBatchRequest& WithDialRequests(DialRequestsT&& value) {
    SetDialRequests(std::forward<DialRequestsT>(value));
    return *this;
  }
  template <typename DialRequestsT = DialRequest>
  PutDialRequestBatchRequest& AddDialRequests(DialRequestsT&& value) {
    m_dialRequestsHasBeenSet = true;
    m_dialRequests.emplace_back(std::forward<DialRequestsT>(value));
    return *this;
  }
  ///@}
 private:
