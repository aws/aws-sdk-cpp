...
class PutDialRequestBatchResult {
 public:
  ...
  template <typename SuccessfulRequestsT = Aws::Vector<SuccessfulRequest>>
  PutDialRequestBatchResult& WithSuccessfulRequests(SuccessfulRequestsT&& value) {
    SetSuccessfulRequests(std::forward<SuccessfulRequestsT>(value));
    return *this;
  }
  template <typename SuccessfulRequestsT = SuccessfulRequest>
  PutDialRequestBatchResult& AddSuccessfulRequests(SuccessfulRequestsT&& value) {
    m_successfulRequestsHasBeenSet = true;
  ...
  template <typename FailedRequestsT = Aws::Vector<FailedRequest>>
  PutDialRequestBatchResult& WithFailedRequests(FailedRequestsT&& value) {
    SetFailedRequests(std::forward<FailedRequestsT>(value));
    return *this;
  }
  template <typename FailedRequestsT = FailedRequest>
  PutDialRequestBatchResult& AddFailedRequests(FailedRequestsT&& value) {
    m_failedRequestsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  PutDialRequestBatchResult& WithRequestId(RequestIdT&& value) {
