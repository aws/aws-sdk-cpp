...
class GetConnectInstanceConfigResult {
 public:
  ...
  AWS_CONNECTCAMPAIGNS_API GetConnectInstanceConfigResult& operator=(
  ...
  void SetConnectInstanceConfig(ConnectInstanceConfigT&& value) {
    m_connectInstanceConfigHasBeenSet = true;
    m_connectInstanceConfig = std::forward<ConnectInstanceConfigT>(value);
  }
  template <typename ConnectInstanceConfigT = InstanceConfig>
  GetConnectInstanceConfigResult& WithConnectInstanceConfig(ConnectInstanceConfigT&& value) {
    SetConnectInstanceConfig(std::forward<ConnectInstanceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetConnectInstanceConfigResult& WithRequestId(RequestIdT&& value) {
