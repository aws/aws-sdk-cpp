...
class PredictiveDialerConfig {
 public:
  ...
  inline PredictiveDialerConfig& WithBandwidthAllocation(double value) {
  ...
  inline void SetDialingCapacity(double value) {
    m_dialingCapacityHasBeenSet = true;
    m_dialingCapacity = value;
  }
  inline PredictiveDialerConfig& WithDialingCapacity(double value) {
    SetDialingCapacity(value);
    return *this;
  }
  ///@}
 private:
