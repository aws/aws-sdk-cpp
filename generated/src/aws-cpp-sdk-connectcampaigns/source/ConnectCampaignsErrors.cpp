...
template <>
AWS_CONNECTCAMPAIGNS_API ConflictException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API ServiceQuotaExceededException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API ThrottlingException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API InternalServerException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API ResourceNotFoundException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API ValidationException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API AccessDeniedException ConnectCampaignsError::GetModeledError() {
  assert(this->GetErrorType() == ConnectCampaignsErrors::ACCESS_DENIED);
  return AccessDeniedException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTCAMPAIGNS_API InvalidCampaignStateException ConnectCampaignsError::GetModeledError() {
...
template <>
AWS_CONNECTCAMPAIGNS_API InvalidStateException ConnectCampaignsError::GetModeledError() {
