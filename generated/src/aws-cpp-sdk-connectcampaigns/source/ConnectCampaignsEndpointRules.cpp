...
{
const size_t ConnectCampaignsEndpointRules::RulesBlobStrLen = 3516;
const size_t ConnectCampaignsEndpointRules::RulesBlobSize = 3517;

using RulesBlobT = Aws::Array<const char, ConnectCampaignsEndpointRules::RulesBlobSize>;
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','n','n',
'e','c','t','-','c','a','m','p','a','i','g','n','s','-','f','i','p','s','.','{','R','e','g','i','o',
...
'n','n','e','c','t','-','c','a','m','p','a','i','g','n','s','-','f','i','p','s','.','{','R','e','g',
...
':','/','/','c','o','n','n','e','c','t','-','c','a','m','p','a','i','g','n','s','.','{','R','e','g',
...
const char* ConnectCampaignsEndpointRules::GetRulesBlob()
{
