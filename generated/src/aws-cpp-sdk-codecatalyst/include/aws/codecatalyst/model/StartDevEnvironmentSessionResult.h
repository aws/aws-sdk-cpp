...
class StartDevEnvironmentSessionResult {
 public:
  AWS_CODECATALYST_API StartDevEnvironmentSessionResult() = default;
  ...
  template <typename AccessDetailsT = DevEnvironmentAccessDetails>
  void SetAccessDetails(AccessDetailsT&& value) {
    m_accessDetailsHasBeenSet = true;
    m_accessDetails = std::forward<AccessDetailsT>(value);
  }
  template <typename AccessDetailsT = DevEnvironmentAccessDetails>
  StartDevEnvironmentSessionResult& WithAccessDetails(AccessDetailsT&& value) {
  ...
  template <typename SessionIdT = Aws::String>
  StartDevEnvironmentSessionResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename SpaceNameT = Aws::String>
  StartDevEnvironmentSessionResult& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  StartDevEnvironmentSessionResult& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename IdT = Aws::String>
  StartDevEnvironmentSessionResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartDevEnvironmentSessionResult& WithRequestId(RequestIdT&& value) {
