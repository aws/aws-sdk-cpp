...
class ListAccessTokensRequest : public CodeCatalystRequest {
 public:
  AWS_CODECATALYST_API ListAccessTokensRequest() = default;
  ...
  inline ListAccessTokensRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAccessTokensRequest& WithNextToken(NextTokenT&& value) {
