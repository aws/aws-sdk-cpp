...
class ListSourceRepositoryBranchesItem {
 public:
  ...
  void SetRef(RefT&& value) {
    ...
    m_ref = std::forward<RefT>(value);
  }
  template <typename RefT = Aws::String>
  ListSourceRepositoryBranchesItem& WithRef(RefT&& value) {
    SetRef(std::forward<RefT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameT = Aws::String>
  ListSourceRepositoryBranchesItem& WithName(NameT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  ListSourceRepositoryBranchesItem& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  void SetHeadCommitId(HeadCommitIdT&& value) {
    ...
    m_headCommitId = std::forward<HeadCommitIdT>(value);
  }
  template <typename HeadCommitIdT = Aws::String>
  ListSourceRepositoryBranchesItem& WithHeadCommitId(HeadCommitIdT&& value) {
    SetHeadCommitId(std::forward<HeadCommitIdT>(value));
    return *this;
  }
  ///@}
 private:
