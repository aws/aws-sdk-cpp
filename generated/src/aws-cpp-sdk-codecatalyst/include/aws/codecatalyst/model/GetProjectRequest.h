...
namespace Model
{
  ...
  public:
    ...
    template<typename SpaceNameT = Aws::String>
    GetProjectRequest& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetProjectRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
