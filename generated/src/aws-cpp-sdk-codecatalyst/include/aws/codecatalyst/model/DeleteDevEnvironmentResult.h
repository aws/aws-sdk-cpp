...
class DeleteDevEnvironmentResult {
 public:
  AWS_CODECATALYST_API DeleteDevEnvironmentResult() = default;
  ...
  template <typename SpaceNameT = Aws::String>
  DeleteDevEnvironmentResult& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  DeleteDevEnvironmentResult& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteDevEnvironmentResult& WithId(IdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDevEnvironmentResult& WithRequestId(RequestIdT&& value) {
