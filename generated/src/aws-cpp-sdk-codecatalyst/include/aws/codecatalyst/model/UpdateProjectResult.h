...
namespace Model
{
  ...
  public:
    ...
    template<typename SpaceNameT = Aws::String>
    UpdateProjectResult& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DisplayNameT = Aws::String>
    UpdateProjectResult& WithDisplayName(DisplayNameT&& value) { SetDisplayName(std::forward<DisplayNameT>(value)); return *this;}
    ///@}
