...
class EventLogEntry {
 public:
  ...
  void SetEventCategory(EventCategoryT&& value) {
    ...
    m_eventCategory = std::forward<EventCategoryT>(value);
  }
  template <typename EventCategoryT = Aws::String>
  EventLogEntry& WithEventCategory(EventCategoryT&& value) {
    SetEventCategory(std::forward<EventCategoryT>(value));
    return *this;
  }
  ///@}
  ...
  inline EventLogEntry& WithOperationType(OperationType value) {
  ...
  void SetProjectInformation(ProjectInformationT&& value) {
    ...
    m_projectInformation = std::forward<ProjectInformationT>(value);
  }
  template <typename ProjectInformationT = ProjectInformation>
  EventLogEntry& WithProjectInformation(ProjectInformationT&& value) {
    SetProjectInformation(std::forward<ProjectInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestPayload(RequestPayloadT&& value) {
    ...
    m_requestPayload = std::forward<RequestPayloadT>(value);
  }
  template <typename RequestPayloadT = EventPayload>
  EventLogEntry& WithRequestPayload(RequestPayloadT&& value) {
    SetRequestPayload(std::forward<RequestPayloadT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResponsePayload(ResponsePayloadT&& value) {
    ...
    m_responsePayload = std::forward<ResponsePayloadT>(value);
  }
  template <typename ResponsePayloadT = EventPayload>
  EventLogEntry& WithResponsePayload(ResponsePayloadT&& value) {
    SetResponsePayload(std::forward<ResponsePayloadT>(value));
    return *this;
  }
  ///@}
