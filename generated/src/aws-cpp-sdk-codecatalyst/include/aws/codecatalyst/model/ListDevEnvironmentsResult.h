...
class ListDevEnvironmentsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DevEnvironmentSummary>>
  ListDevEnvironmentsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DevEnvironmentSummary>
  ListDevEnvironmentsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDevEnvironmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDevEnvironmentsResult& WithRequestId(RequestIdT&& value) {
