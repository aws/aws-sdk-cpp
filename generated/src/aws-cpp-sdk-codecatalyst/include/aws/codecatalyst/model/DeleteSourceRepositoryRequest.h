...
class DeleteSourceRepositoryRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  DeleteSourceRepositoryRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  DeleteSourceRepositoryRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteSourceRepositoryRequest& WithName(NameT&& value) {
