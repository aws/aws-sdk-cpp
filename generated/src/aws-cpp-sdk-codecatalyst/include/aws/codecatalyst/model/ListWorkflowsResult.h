...
class ListWorkflowsResult {
 public:
  AWS_CODECATALYST_API ListWorkflowsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<WorkflowSummary>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<WorkflowSummary>>
  ListWorkflowsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = WorkflowSummary>
  ListWorkflowsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
