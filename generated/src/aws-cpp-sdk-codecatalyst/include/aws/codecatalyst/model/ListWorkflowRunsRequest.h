...
class ListWorkflowRunsRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  ListWorkflowRunsRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  ListWorkflowRunsRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  ListWorkflowRunsRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename SortByT = Aws::Vector<WorkflowRunSortCriteria>>
  ListWorkflowRunsRequest& WithSortBy(SortByT&& value) {
    SetSortBy(std::forward<SortByT>(value));
    return *this;
  }
  template <typename SortByT = WorkflowRunSortCriteria>
  ListWorkflowRunsRequest& AddSortBy(SortByT&& value) {
    m_sortByHasBeenSet = true;
