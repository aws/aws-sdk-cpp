...
class StopDevEnvironmentResult {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  StopDevEnvironmentResult& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  StopDevEnvironmentResult& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename IdT = Aws::String>
  StopDevEnvironmentResult& WithId(IdT&& value) {
  ...
  inline StopDevEnvironmentResult& WithStatus(DevEnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StopDevEnvironmentResult& WithRequestId(RequestIdT&& value) {
