...
namespace Model
{
  ...
  {
  public:
    AWS_CODECATALYST_API StopDevEnvironmentResult() = default;
    ...
    template<typename SpaceNameT = Aws::String>
    StopDevEnvironmentResult& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ProjectNameT = Aws::String>
    StopDevEnvironmentResult& WithProjectName(ProjectNameT&& value) { SetProjectName(std::forward<ProjectNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    StopDevEnvironmentResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline StopDevEnvironmentResult& WithStatus(DevEnvironmentStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopDevEnvironmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
