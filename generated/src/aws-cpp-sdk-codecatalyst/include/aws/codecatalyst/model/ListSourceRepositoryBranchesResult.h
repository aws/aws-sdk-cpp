...
class ListSourceRepositoryBranchesResult {
 public:
  ...
  AWS_CODECATALYST_API ListSourceRepositoryBranchesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceRepositoryBranchesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<ListSourceRepositoryBranchesItem>>
  ListSourceRepositoryBranchesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListSourceRepositoryBranchesItem>
  ListSourceRepositoryBranchesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceRepositoryBranchesResult& WithRequestId(RequestIdT&& value) {
