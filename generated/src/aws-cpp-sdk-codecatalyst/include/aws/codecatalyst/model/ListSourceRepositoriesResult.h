...
class ListSourceRepositoriesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ListSourceRepositoriesItem>>
  ListSourceRepositoriesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListSourceRepositoriesItem>
  ListSourceRepositoriesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceRepositoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSourceRepositoriesResult& WithRequestId(RequestIdT&& value) {
