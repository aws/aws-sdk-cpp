...
class ListSourceRepositoriesItem {
 public:
  AWS_CODECATALYST_API ListSourceRepositoriesItem() = default;
  ...
  template <typename IdT = Aws::String>
  ListSourceRepositoriesItem& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListSourceRepositoriesItem& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListSourceRepositoriesItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  ListSourceRepositoriesItem& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  ListSourceRepositoriesItem& WithCreatedTime(CreatedTimeT&& value) {
