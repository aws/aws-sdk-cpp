...
class CreateDevEnvironmentRequest : public CodeCatalystRequest {
 public:
  ...
  inline CreateDevEnvironmentRequest& WithInstanceType(InstanceType value) {
  ...
  inline CreateDevEnvironmentRequest& WithInactivityTimeoutMinutes(int value) {
  ...
  void SetPersistentStorage(PersistentStorageT&& value) {
    ...
    m_persistentStorage = std::forward<PersistentStorageT>(value);
  }
  template <typename PersistentStorageT = PersistentStorageConfiguration>
  CreateDevEnvironmentRequest& WithPersistentStorage(PersistentStorageT&& value) {
    SetPersistentStorage(std::forward<PersistentStorageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVpcConnectionName(VpcConnectionNameT&& value) {
    ...
    m_vpcConnectionName = std::forward<VpcConnectionNameT>(value);
  }
  template <typename VpcConnectionNameT = Aws::String>
  CreateDevEnvironmentRequest& WithVpcConnectionName(VpcConnectionNameT&& value) {
    SetVpcConnectionName(std::forward<VpcConnectionNameT>(value));
    return *this;
  }
  ///@}
 private:
