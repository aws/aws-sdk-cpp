...
class GetSourceRepositoryCloneUrlsRequest : public CodeCatalystRequest {
 public:
  AWS_CODECATALYST_API GetSourceRepositoryCloneUrlsRequest() = default;
  ...
  template <typename SpaceNameT = Aws::String>
  GetSourceRepositoryCloneUrlsRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  GetSourceRepositoryCloneUrlsRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename SourceRepositoryNameT = Aws::String>
  GetSourceRepositoryCloneUrlsRequest& WithSourceRepositoryName(SourceRepositoryNameT&& value) {
