...
namespace Model
{
  ...
  {
  public:
    AWS_CODECATALYST_API ListSpacesResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<SpaceSummary>>
    ListSpacesResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = SpaceSummary>
    ListSpacesResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
