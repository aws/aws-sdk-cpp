...
class GetSubscriptionResult {
 public:
  ...
  void SetSubscriptionType(SubscriptionTypeT&& value) {
    ...
    m_subscriptionType = std::forward<SubscriptionTypeT>(value);
  }
  template <typename SubscriptionTypeT = Aws::String>
  GetSubscriptionResult& WithSubscriptionType(SubscriptionTypeT&& value) {
    SetSubscriptionType(std::forward<SubscriptionTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingSubscriptionType(PendingSubscriptionTypeT&& value) {
    ...
    m_pendingSubscriptionType = std::forward<PendingSubscriptionTypeT>(value);
  }
  template <typename PendingSubscriptionTypeT = Aws::String>
  GetSubscriptionResult& WithPendingSubscriptionType(PendingSubscriptionTypeT&& value) {
    SetPendingSubscriptionType(std::forward<PendingSubscriptionTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPendingSubscriptionStartTime(PendingSubscriptionStartTimeT&& value) {
    ...
    m_pendingSubscriptionStartTime = std::forward<PendingSubscriptionStartTimeT>(value);
  }
  template <typename PendingSubscriptionStartTimeT = Aws::Utils::DateTime>
  GetSubscriptionResult& WithPendingSubscriptionStartTime(PendingSubscriptionStartTimeT&& value) {
    SetPendingSubscriptionStartTime(std::forward<PendingSubscriptionStartTimeT>(value));
    return *this;
  }
  ///@}
