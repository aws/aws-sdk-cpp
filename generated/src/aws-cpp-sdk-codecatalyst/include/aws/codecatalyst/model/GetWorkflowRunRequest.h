...
namespace Model
{
  ...
  public:
    ...
    template<typename SpaceNameT = Aws::String>
    GetWorkflowRunRequest& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetWorkflowRunRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProjectNameT = Aws::String>
    GetWorkflowRunRequest& WithProjectName(ProjectNameT&& value) { SetProjectName(std::forward<ProjectNameT>(value)); return *this;}
    ///@}
  private:
