...
class GetWorkflowRunRequest : public CodeCatalystRequest {
 public:
  AWS_CODECATALYST_API GetWorkflowRunRequest() = default;
  ...
  template <typename SpaceNameT = Aws::String>
  GetWorkflowRunRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetWorkflowRunRequest& WithId(IdT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  GetWorkflowRunRequest& WithProjectName(ProjectNameT&& value) {
