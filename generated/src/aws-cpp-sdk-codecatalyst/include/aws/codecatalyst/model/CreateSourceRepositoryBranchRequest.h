...
class CreateSourceRepositoryBranchRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  CreateSourceRepositoryBranchRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  CreateSourceRepositoryBranchRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename SourceRepositoryNameT = Aws::String>
  CreateSourceRepositoryBranchRequest& WithSourceRepositoryName(SourceRepositoryNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateSourceRepositoryBranchRequest& WithName(NameT&& value) {
  ...
  template <typename HeadCommitIdT = Aws::String>
  CreateSourceRepositoryBranchRequest& WithHeadCommitId(HeadCommitIdT&& value) {
