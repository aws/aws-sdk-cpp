...
/**
 */
class ListSourceRepositoryBranchesRequest : public CodeCatalystRequest {
 public:
  AWS_CODECATALYST_API ListSourceRepositoryBranchesRequest() = default;
  ...
  template <typename SpaceNameT = Aws::String>
  ListSourceRepositoryBranchesRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  ListSourceRepositoryBranchesRequest& WithProjectName(ProjectNameT&& value) {
  ...
  void SetSourceRepositoryName(SourceRepositoryNameT&& value) {
    ...
    m_sourceRepositoryName = std::forward<SourceRepositoryNameT>(value);
  }
  template <typename SourceRepositoryNameT = Aws::String>
  ListSourceRepositoryBranchesRequest& WithSourceRepositoryName(SourceRepositoryNameT&& value) {
    SetSourceRepositoryName(std::forward<SourceRepositoryNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceRepositoryBranchesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSourceRepositoryBranchesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
