...
namespace Model
{
  ...
  {
  public:
    AWS_CODECATALYST_API DeleteProjectRequest() = default;
    ...
    template<typename SpaceNameT = Aws::String>
    DeleteProjectRequest& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    DeleteProjectRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
