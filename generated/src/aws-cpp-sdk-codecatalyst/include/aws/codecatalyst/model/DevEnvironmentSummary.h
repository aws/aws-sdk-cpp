...
class DevEnvironmentSummary {
 public:
  ...
  inline DevEnvironmentSummary& WithStatus(DevEnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DevEnvironmentSummary& WithInstanceType(InstanceType value) {
  ...
  inline DevEnvironmentSummary& WithInactivityTimeoutMinutes(int value) {
