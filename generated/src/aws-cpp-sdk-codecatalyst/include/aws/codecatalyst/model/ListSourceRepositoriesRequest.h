...
class ListSourceRepositoriesRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  ListSourceRepositoriesRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  ListSourceRepositoriesRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceRepositoriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSourceRepositoriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
