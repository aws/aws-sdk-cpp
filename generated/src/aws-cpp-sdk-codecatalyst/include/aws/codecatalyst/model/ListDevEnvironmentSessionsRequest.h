...
class ListDevEnvironmentSessionsRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  ListDevEnvironmentSessionsRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  ListDevEnvironmentSessionsRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename DevEnvironmentIdT = Aws::String>
  ListDevEnvironmentSessionsRequest& WithDevEnvironmentId(DevEnvironmentIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDevEnvironmentSessionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDevEnvironmentSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
