...
class DeleteDevEnvironmentRequest : public CodeCatalystRequest {
 public:
  ...
  template <typename SpaceNameT = Aws::String>
  DeleteDevEnvironmentRequest& WithSpaceName(SpaceNameT&& value) {
  ...
  template <typename ProjectNameT = Aws::String>
  DeleteDevEnvironmentRequest& WithProjectName(ProjectNameT&& value) {
  ...
  template <typename IdT = Aws::String>
  DeleteDevEnvironmentRequest& WithId(IdT&& value) {
