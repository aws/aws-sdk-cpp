...
ListSourceRepositoryBranchesResult::ListSourceRepositoryBranchesResult()
{
}

ListSourceRepositoryBranchesResult::ListSourceRepositoryBranchesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
