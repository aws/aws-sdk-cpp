...
class AWS_GLUE_API GlueClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GlueClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<GlueEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for BatchCreatePartition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchCreatePartition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchCreatePartitionRequestT = Model::BatchCreatePartitionRequest>
  void BatchCreatePartitionAsync(const BatchCreatePartitionRequestT& request, const BatchCreatePartitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteConnection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteConnectionRequestT = Model::BatchDeleteConnectionRequest>
  void BatchDeleteConnectionAsync(const BatchDeleteConnectionRequestT& request, const BatchDeleteConnectionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeletePartition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeletePartition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeletePartitionRequestT = Model::BatchDeletePartitionRequest>
  void BatchDeletePartitionAsync(const BatchDeletePartitionRequestT& request, const BatchDeletePartitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteTable that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteTable that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteTableRequestT = Model::BatchDeleteTableRequest>
  void BatchDeleteTableAsync(const BatchDeleteTableRequestT& request, const BatchDeleteTableResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteTableVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteTableVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteTableVersionRequestT = Model::BatchDeleteTableVersionRequest>
  void BatchDeleteTableVersionAsync(const BatchDeleteTableVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchGetBlueprints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetBlueprints that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetBlueprintsRequestT = Model::BatchGetBlueprintsRequest>
  void BatchGetBlueprintsAsync(const BatchGetBlueprintsRequestT& request, const BatchGetBlueprintsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetCrawlers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetCrawlers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetCrawlersRequestT = Model::BatchGetCrawlersRequest>
  void BatchGetCrawlersAsync(const BatchGetCrawlersRequestT& request, const BatchGetCrawlersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetCustomEntityTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchGetCustomEntityTypesRequestT = Model::BatchGetCustomEntityTypesRequest>
  Model::BatchGetCustomEntityTypesOutcomeCallable BatchGetCustomEntityTypesCallable(
      const BatchGetCustomEntityTypesRequestT& request) const {
    return SubmitCallable(&GlueClient::BatchGetCustomEntityTypes, request);
  }

  /**
   * An Async wrapper for BatchGetCustomEntityTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetCustomEntityTypesRequestT = Model::BatchGetCustomEntityTypesRequest>
  void BatchGetCustomEntityTypesAsync(const BatchGetCustomEntityTypesRequestT& request,
                                      const BatchGetCustomEntityTypesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetDataQualityResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchGetDataQualityResultRequestT = Model::BatchGetDataQualityResultRequest>
  Model::BatchGetDataQualityResultOutcomeCallable BatchGetDataQualityResultCallable(
      const BatchGetDataQualityResultRequestT& request) const {
    return SubmitCallable(&GlueClient::BatchGetDataQualityResult, request);
  }

  /**
   * An Async wrapper for BatchGetDataQualityResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDataQualityResultRequestT = Model::BatchGetDataQualityResultRequest>
  void BatchGetDataQualityResultAsync(const BatchGetDataQualityResultRequestT& request,
                                      const BatchGetDataQualityResultResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&GlueClient::BatchGetDataQualityResult, request, handler, context);
  }

  /**
   * <p>Retrieves the details of multiple evaluation runs in a single
   * request.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/BatchGetDataQualityRulesetEvaluationRun">AWS
   * API Reference</a></p>
   */
  virtual Model::BatchGetDataQualityRulesetEvaluationRunOutcome BatchGetDataQualityRulesetEvaluationRun(
      const Model::BatchGetDataQualityRulesetEvaluationRunRequest& request) const;

  /**
   * A Callable wrapper for BatchGetDataQualityRulesetEvaluationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchGetDataQualityRulesetEvaluationRunRequestT = Model::BatchGetDataQualityRulesetEvaluationRunRequest>
  Model::BatchGetDataQualityRulesetEvaluationRunOutcomeCallable BatchGetDataQualityRulesetEvaluationRunCallable(
      const BatchGetDataQualityRulesetEvaluationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::BatchGetDataQualityRulesetEvaluationRun, request);
  }

  /**
   * An Async wrapper for BatchGetDataQualityRulesetEvaluationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetDataQualityRulesetEvaluationRunRequestT = Model::BatchGetDataQualityRulesetEvaluationRunRequest>
  void BatchGetDataQualityRulesetEvaluationRunAsync(const BatchGetDataQualityRulesetEvaluationRunRequestT& request,
                                                    const BatchGetDataQualityRulesetEvaluationRunResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&GlueClient::BatchGetDataQualityRulesetEvaluationRun, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for BatchGetDevEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetDevEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDevEndpointsRequestT = Model::BatchGetDevEndpointsRequest>
  ...
  /**
   * An Async wrapper for BatchGetJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetJobsRequestT = Model::BatchGetJobsRequest>
  void BatchGetJobsAsync(const BatchGetJobsRequestT& request, const BatchGetJobsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetPartition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetPartition that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetPartitionRequestT = Model::BatchGetPartitionRequest>
  void BatchGetPartitionAsync(const BatchGetPartitionRequestT& request, const BatchGetPartitionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetTableOptimizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetTableOptimizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetTableOptimizerRequestT = Model::BatchGetTableOptimizerRequest>
  void BatchGetTableOptimizerAsync(const BatchGetTableOptimizerRequestT& request,
                                   const BatchGetTableOptimizerResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetTriggers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetTriggers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetTriggersRequestT = Model::BatchGetTriggersRequest>
  void BatchGetTriggersAsync(const BatchGetTriggersRequestT& request, const BatchGetTriggersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetWorkflows that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetWorkflows that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetWorkflowsRequestT = Model::BatchGetWorkflowsRequest>
  void BatchGetWorkflowsAsync(const BatchGetWorkflowsRequestT& request, const BatchGetWorkflowsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchPutDataQualityStatisticAnnotationOutcome BatchPutDataQualityStatisticAnnotation(
      const Model::BatchPutDataQualityStatisticAnnotationRequest& request) const;

  /**
   * A Callable wrapper for BatchPutDataQualityStatisticAnnotation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchPutDataQualityStatisticAnnotationRequestT = Model::BatchPutDataQualityStatisticAnnotationRequest>
  Model::BatchPutDataQualityStatisticAnnotationOutcomeCallable BatchPutDataQualityStatisticAnnotationCallable(
      const BatchPutDataQualityStatisticAnnotationRequestT& request) const {
    return SubmitCallable(&GlueClient::BatchPutDataQualityStatisticAnnotation, request);
  }

  /**
   * An Async wrapper for BatchPutDataQualityStatisticAnnotation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchPutDataQualityStatisticAnnotationRequestT = Model::BatchPutDataQualityStatisticAnnotationRequest>
  void BatchPutDataQualityStatisticAnnotationAsync(const BatchPutDataQualityStatisticAnnotationRequestT& request,
                                                   const BatchPutDataQualityStatisticAnnotationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchStopJobRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchStopJobRunRequestT = Model::BatchStopJobRunRequest>
  void BatchStopJobRunAsync(const BatchStopJobRunRequestT& request, const BatchStopJobRunResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdatePartition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdatePartition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchUpdatePartitionRequestT = Model::BatchUpdatePartitionRequest>
  void BatchUpdatePartitionAsync(const BatchUpdatePartitionRequestT& request, const BatchUpdatePartitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelDataQualityRuleRecommendationRunOutcome CancelDataQualityRuleRecommendationRun(
      const Model::CancelDataQualityRuleRecommendationRunRequest& request) const;

  /**
   * A Callable wrapper for CancelDataQualityRuleRecommendationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CancelDataQualityRuleRecommendationRunRequestT = Model::CancelDataQualityRuleRecommendationRunRequest>
  Model::CancelDataQualityRuleRecommendationRunOutcomeCallable CancelDataQualityRuleRecommendationRunCallable(
      const CancelDataQualityRuleRecommendationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::CancelDataQualityRuleRecommendationRun, request);
  }

  /**
   * An Async wrapper for CancelDataQualityRuleRecommendationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CancelDataQualityRuleRecommendationRunRequestT = Model::CancelDataQualityRuleRecommendationRunRequest>
  void CancelDataQualityRuleRecommendationRunAsync(const CancelDataQualityRuleRecommendationRunRequestT& request,
                                                   const CancelDataQualityRuleRecommendationRunResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelDataQualityRulesetEvaluationRunOutcome CancelDataQualityRulesetEvaluationRun(
      const Model::CancelDataQualityRulesetEvaluationRunRequest& request) const;

  /**
   * A Callable wrapper for CancelDataQualityRulesetEvaluationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CancelDataQualityRulesetEvaluationRunRequestT = Model::CancelDataQualityRulesetEvaluationRunRequest>
  Model::CancelDataQualityRulesetEvaluationRunOutcomeCallable CancelDataQualityRulesetEvaluationRunCallable(
      const CancelDataQualityRulesetEvaluationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::CancelDataQualityRulesetEvaluationRun, request);
  }

  /**
   * An Async wrapper for CancelDataQualityRulesetEvaluationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CancelDataQualityRulesetEvaluationRunRequestT = Model::CancelDataQualityRulesetEvaluationRunRequest>
  void CancelDataQualityRulesetEvaluationRunAsync(const CancelDataQualityRulesetEvaluationRunRequestT& request,
                                                  const CancelDataQualityRulesetEvaluationRunResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CancelMLTaskRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelMLTaskRunRequestT = Model::CancelMLTaskRunRequest>
  void CancelMLTaskRunAsync(const CancelMLTaskRunRequestT& request, const CancelMLTaskRunResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CheckSchemaVersionValidityOutcome CheckSchemaVersionValidity(
      const Model::CheckSchemaVersionValidityRequest& request) const;

  /**
   * A Callable wrapper for CheckSchemaVersionValidity that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CheckSchemaVersionValidityRequestT = Model::CheckSchemaVersionValidityRequest>
  Model::CheckSchemaVersionValidityOutcomeCallable CheckSchemaVersionValidityCallable(
      const CheckSchemaVersionValidityRequestT& request) const {
    return SubmitCallable(&GlueClient::CheckSchemaVersionValidity, request);
  }

  /**
   * An Async wrapper for CheckSchemaVersionValidity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CheckSchemaVersionValidityRequestT = Model::CheckSchemaVersionValidityRequest>
  void CheckSchemaVersionValidityAsync(const CheckSchemaVersionValidityRequestT& request,
  ...
  /**
   * An Async wrapper for CreateCatalog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCatalogRequestT = Model::CreateCatalogRequest>
  void CreateCatalogAsync(const CreateCatalogRequestT& request, const CreateCatalogResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateClassifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateClassifier that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateClassifierRequestT = Model::CreateClassifierRequest>
  void CreateClassifierAsync(const CreateClassifierResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const CreateClassifierRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateColumnStatisticsTaskSettingsOutcome CreateColumnStatisticsTaskSettings(
      const Model::CreateColumnStatisticsTaskSettingsRequest& request) const;

  /**
   * A Callable wrapper for CreateColumnStatisticsTaskSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateColumnStatisticsTaskSettingsRequestT = Model::CreateColumnStatisticsTaskSettingsRequest>
  Model::CreateColumnStatisticsTaskSettingsOutcomeCallable CreateColumnStatisticsTaskSettingsCallable(
      const CreateColumnStatisticsTaskSettingsRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateColumnStatisticsTaskSettings, request);
  }

  /**
   * An Async wrapper for CreateColumnStatisticsTaskSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateColumnStatisticsTaskSettingsRequestT = Model::CreateColumnStatisticsTaskSettingsRequest>
  void CreateColumnStatisticsTaskSettingsAsync(const CreateColumnStatisticsTaskSettingsRequestT& request,
                                               const CreateColumnStatisticsTaskSettingsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateCrawlerRequestT = Model::CreateCrawlerRequest>
  void CreateCrawlerAsync(const CreateCrawlerRequestT& request, const CreateCrawlerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCustomEntityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomEntityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomEntityTypeRequestT = Model::CreateCustomEntityTypeRequest>
  void CreateCustomEntityTypeAsync(const CreateCustomEntityTypeRequestT& request,
                                   const CreateCustomEntityTypeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataQualityRuleset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataQualityRuleset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataQualityRulesetRequestT = Model::CreateDataQualityRulesetRequest>
  void CreateDataQualityRulesetAsync(const CreateDataQualityRulesetRequestT& request,
                                     const CreateDataQualityRulesetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateDatabase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDatabaseRequestT = Model::CreateDatabaseRequest>
  void CreateDatabaseAsync(const CreateDatabaseRequestT& request, const CreateDatabaseResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDevEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDevEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDevEndpointRequestT = Model::CreateDevEndpointRequest>
  void CreateDevEndpointAsync(const CreateDevEndpointRequestT& request, const CreateDevEndpointResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateGlueIdentityCenterConfigurationOutcome CreateGlueIdentityCenterConfiguration(
      const Model::CreateGlueIdentityCenterConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateGlueIdentityCenterConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateGlueIdentityCenterConfigurationRequestT = Model::CreateGlueIdentityCenterConfigurationRequest>
  Model::CreateGlueIdentityCenterConfigurationOutcomeCallable CreateGlueIdentityCenterConfigurationCallable(
      const CreateGlueIdentityCenterConfigurationRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateGlueIdentityCenterConfiguration, request);
  }

  /**
   * An Async wrapper for CreateGlueIdentityCenterConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateGlueIdentityCenterConfigurationRequestT = Model::CreateGlueIdentityCenterConfigurationRequest>
  void CreateGlueIdentityCenterConfigurationAsync(const CreateGlueIdentityCenterConfigurationRequestT& request,
                                                  const CreateGlueIdentityCenterConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIntegrationResourcePropertyOutcome CreateIntegrationResourceProperty(
      const Model::CreateIntegrationResourcePropertyRequest& request) const;

  /**
   * A Callable wrapper for CreateIntegrationResourceProperty that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateIntegrationResourcePropertyRequestT = Model::CreateIntegrationResourcePropertyRequest>
  Model::CreateIntegrationResourcePropertyOutcomeCallable CreateIntegrationResourcePropertyCallable(
      const CreateIntegrationResourcePropertyRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateIntegrationResourceProperty, request);
  }

  /**
   * An Async wrapper for CreateIntegrationResourceProperty that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateIntegrationResourcePropertyRequestT = Model::CreateIntegrationResourcePropertyRequest>
  void CreateIntegrationResourcePropertyAsync(const CreateIntegrationResourcePropertyRequestT& request,
                                              const CreateIntegrationResourcePropertyResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateIntegrationTablePropertiesOutcome CreateIntegrationTableProperties(
      const Model::CreateIntegrationTablePropertiesRequest& request) const;

  /**
   * A Callable wrapper for CreateIntegrationTableProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateIntegrationTablePropertiesRequestT = Model::CreateIntegrationTablePropertiesRequest>
  Model::CreateIntegrationTablePropertiesOutcomeCallable CreateIntegrationTablePropertiesCallable(
      const CreateIntegrationTablePropertiesRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateIntegrationTableProperties, request);
  }

  /**
   * An Async wrapper for CreateIntegrationTableProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateIntegrationTablePropertiesRequestT = Model::CreateIntegrationTablePropertiesRequest>
  void CreateIntegrationTablePropertiesAsync(const CreateIntegrationTablePropertiesRequestT& request,
                                             const CreateIntegrationTablePropertiesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMLTransform that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMLTransform that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateMLTransformRequestT = Model::CreateMLTransformRequest>
  void CreateMLTransformAsync(const CreateMLTransformRequestT& request, const CreateMLTransformResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePartition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePartitionRequestT = Model::CreatePartitionRequest>
  void CreatePartitionAsync(const CreatePartitionRequestT& request, const CreatePartitionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePartitionIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePartitionIndex that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePartitionIndexRequestT = Model::CreatePartitionIndexRequest>
  void CreatePartitionIndexAsync(const CreatePartitionIndexRequestT& request, const CreatePartitionIndexResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSchemaRequestT = Model::CreateSchemaRequest>
  void CreateSchemaAsync(const CreateSchemaRequestT& request, const CreateSchemaResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateScript that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateScriptRequestT = Model::CreateScriptRequest>
  void CreateScriptAsync(const CreateScriptResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const CreateScriptRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateSecurityConfigurationOutcome CreateSecurityConfiguration(
      const Model::CreateSecurityConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateSecurityConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateSecurityConfigurationRequestT = Model::CreateSecurityConfigurationRequest>
  Model::CreateSecurityConfigurationOutcomeCallable CreateSecurityConfigurationCallable(
      const CreateSecurityConfigurationRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateSecurityConfiguration, request);
  }

  /**
   * An Async wrapper for CreateSecurityConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSecurityConfigurationRequestT = Model::CreateSecurityConfigurationRequest>
  void CreateSecurityConfigurationAsync(const CreateSecurityConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateTableOptimizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTableOptimizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTableOptimizerRequestT = Model::CreateTableOptimizerRequest>
  void CreateTableOptimizerAsync(const CreateTableOptimizerRequestT& request, const CreateTableOptimizerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUsageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUsageProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateUsageProfileRequestT = Model::CreateUsageProfileRequest>
  void CreateUsageProfileAsync(const CreateUsageProfileRequestT& request, const CreateUsageProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUserDefinedFunction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateUserDefinedFunctionRequestT = Model::CreateUserDefinedFunctionRequest>
  Model::CreateUserDefinedFunctionOutcomeCallable CreateUserDefinedFunctionCallable(
      const CreateUserDefinedFunctionRequestT& request) const {
    return SubmitCallable(&GlueClient::CreateUserDefinedFunction, request);
  }

  /**
   * An Async wrapper for CreateUserDefinedFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateUserDefinedFunctionRequestT = Model::CreateUserDefinedFunctionRequest>
  void CreateUserDefinedFunctionAsync(const CreateUserDefinedFunctionRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteCatalog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCatalogRequestT = Model::DeleteCatalogRequest>
  void DeleteCatalogAsync(const DeleteCatalogRequestT& request, const DeleteCatalogResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteClassifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClassifier that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteClassifierRequestT = Model::DeleteClassifierRequest>
  void DeleteClassifierAsync(const DeleteClassifierRequestT& request, const DeleteClassifierResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteColumnStatisticsForPartitionOutcome DeleteColumnStatisticsForPartition(
      const Model::DeleteColumnStatisticsForPartitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteColumnStatisticsForPartition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteColumnStatisticsForPartitionRequestT = Model::DeleteColumnStatisticsForPartitionRequest>
  Model::DeleteColumnStatisticsForPartitionOutcomeCallable DeleteColumnStatisticsForPartitionCallable(
      const DeleteColumnStatisticsForPartitionRequestT& request) const {
    return SubmitCallable(&GlueClient::DeleteColumnStatisticsForPartition, request);
  }

  /**
   * An Async wrapper for DeleteColumnStatisticsForPartition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteColumnStatisticsForPartitionRequestT = Model::DeleteColumnStatisticsForPartitionRequest>
  void DeleteColumnStatisticsForPartitionAsync(const DeleteColumnStatisticsForPartitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteColumnStatisticsForTableOutcome DeleteColumnStatisticsForTable(
      const Model::DeleteColumnStatisticsForTableRequest& request) const;

  /**
   * A Callable wrapper for DeleteColumnStatisticsForTable that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteColumnStatisticsForTableRequestT = Model::DeleteColumnStatisticsForTableRequest>
  Model::DeleteColumnStatisticsForTableOutcomeCallable DeleteColumnStatisticsForTableCallable(
      const DeleteColumnStatisticsForTableRequestT& request) const {
    return SubmitCallable(&GlueClient::DeleteColumnStatisticsForTable, request);
  }

  /**
   * An Async wrapper for DeleteColumnStatisticsForTable that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteColumnStatisticsForTableRequestT = Model::DeleteColumnStatisticsForTableRequest>
  void DeleteColumnStatisticsForTableAsync(const DeleteColumnStatisticsForTableRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteColumnStatisticsTaskSettingsOutcome DeleteColumnStatisticsTaskSettings(
      const Model::DeleteColumnStatisticsTaskSettingsRequest& request) const;

  /**
   * A Callable wrapper for DeleteColumnStatisticsTaskSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteColumnStatisticsTaskSettingsRequestT = Model::DeleteColumnStatisticsTaskSettingsRequest>
  Model::DeleteColumnStatisticsTaskSettingsOutcomeCallable DeleteColumnStatisticsTaskSettingsCallable(
      const DeleteColumnStatisticsTaskSettingsRequestT& request) const {
    return SubmitCallable(&GlueClient::DeleteColumnStatisticsTaskSettings, request);
  }

  /**
   * An Async wrapper for DeleteColumnStatisticsTaskSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteColumnStatisticsTaskSettingsRequestT = Model::DeleteColumnStatisticsTaskSettingsRequest>
  void DeleteColumnStatisticsTaskSettingsAsync(const DeleteColumnStatisticsTaskSettingsRequestT& request,
                                               const DeleteColumnStatisticsTaskSettingsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteCrawlerRequestT = Model::DeleteCrawlerRequest>
  void DeleteCrawlerAsync(const DeleteCrawlerRequestT& request, const DeleteCrawlerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomEntityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomEntityType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomEntityTypeRequestT = Model::DeleteCustomEntityTypeRequest>
  void DeleteCustomEntityTypeAsync(const DeleteCustomEntityTypeRequestT& request,
                                   const DeleteCustomEntityTypeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataQualityRuleset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataQualityRuleset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDataQualityRulesetRequestT = Model::DeleteDataQualityRulesetRequest>
  void DeleteDataQualityRulesetAsync(const DeleteDataQualityRulesetRequestT& request,
                                     const DeleteDataQualityRulesetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteDatabase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteDatabaseRequestT = Model::DeleteDatabaseRequest>
  void DeleteDatabaseAsync(const DeleteDatabaseRequestT& request, const DeleteDatabaseResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDevEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDevEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDevEndpointRequestT = Model::DeleteDevEndpointRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteGlueIdentityCenterConfigurationOutcome DeleteGlueIdentityCenterConfiguration(
      const Model::DeleteGlueIdentityCenterConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteGlueIdentityCenterConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteGlueIdentityCenterConfigurationRequestT = Model::DeleteGlueIdentityCenterConfigurationRequest>
  Model::DeleteGlueIdentityCenterConfigurationOutcomeCallable DeleteGlueIdentityCenterConfigurationCallable(
      const DeleteGlueIdentityCenterConfigurationRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::DeleteGlueIdentityCenterConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteGlueIdentityCenterConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteGlueIdentityCenterConfigurationRequestT = Model::DeleteGlueIdentityCenterConfigurationRequest>
  void DeleteGlueIdentityCenterConfigurationAsync(const DeleteGlueIdentityCenterConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const DeleteGlueIdentityCenterConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteIntegrationTablePropertiesOutcome DeleteIntegrationTableProperties(
      const Model::DeleteIntegrationTablePropertiesRequest& request) const;

  /**
   * A Callable wrapper for DeleteIntegrationTableProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteIntegrationTablePropertiesRequestT = Model::DeleteIntegrationTablePropertiesRequest>
  Model::DeleteIntegrationTablePropertiesOutcomeCallable DeleteIntegrationTablePropertiesCallable(
      const DeleteIntegrationTablePropertiesRequestT& request) const {
    return SubmitCallable(&GlueClient::DeleteIntegrationTableProperties, request);
  }

  /**
   * An Async wrapper for DeleteIntegrationTableProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteIntegrationTablePropertiesRequestT = Model::DeleteIntegrationTablePropertiesRequest>
  void DeleteIntegrationTablePropertiesAsync(const DeleteIntegrationTablePropertiesRequestT& request,
                                             const DeleteIntegrationTablePropertiesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMLTransform that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMLTransform that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteMLTransformRequestT = Model::DeleteMLTransformRequest>
  void DeleteMLTransformAsync(const DeleteMLTransformRequestT& request, const DeleteMLTransformResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePartition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePartitionRequestT = Model::DeletePartitionRequest>
  void DeletePartitionAsync(const DeletePartitionRequestT& request, const DeletePartitionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePartitionIndex that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePartitionIndex that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePartitionIndexRequestT = Model::DeletePartitionIndexRequest>
  void DeletePartitionIndexAsync(const DeletePartitionIndexRequestT& request, const DeletePartitionIndexResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DeleteResourcePolicyRequestT = Model::DeleteResourcePolicyRequest>
  void DeleteResourcePolicyAsync(const DeleteResourcePolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DeleteResourcePolicyRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DeleteSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSchemaRequestT = Model::DeleteSchemaRequest>
  void DeleteSchemaAsync(const DeleteSchemaRequestT& request, const DeleteSchemaResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSchemaVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSchemaVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSchemaVersionsRequestT = Model::DeleteSchemaVersionsRequest>
  void DeleteSchemaVersionsAsync(const DeleteSchemaVersionsRequestT& request, const DeleteSchemaVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTableOptimizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTableOptimizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTableOptimizerRequestT = Model::DeleteTableOptimizerRequest>
  void DeleteTableOptimizerAsync(const DeleteTableOptimizerRequestT& request, const DeleteTableOptimizerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTableVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTableVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTableVersionRequestT = Model::DeleteTableVersionRequest>
  void DeleteTableVersionAsync(const DeleteTableVersionRequestT& request, const DeleteTableVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUsageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUsageProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUsageProfileRequestT = Model::DeleteUsageProfileRequest>
  void DeleteUsageProfileAsync(const DeleteUsageProfileRequestT& request, const DeleteUsageProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUserDefinedFunction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteUserDefinedFunctionRequestT = Model::DeleteUserDefinedFunctionRequest>
  Model::DeleteUserDefinedFunctionOutcomeCallable DeleteUserDefinedFunctionCallable(
      const DeleteUserDefinedFunctionRequestT& request) const {
    return SubmitCallable(&GlueClient::DeleteUserDefinedFunction, request);
  }

  /**
   * An Async wrapper for DeleteUserDefinedFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteUserDefinedFunctionRequestT = Model::DeleteUserDefinedFunctionRequest>
  void DeleteUserDefinedFunctionAsync(const DeleteUserDefinedFunctionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeConnectionType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeConnectionType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeConnectionTypeRequestT = Model::DescribeConnectionTypeRequest>
  void DescribeConnectionTypeAsync(const DescribeConnectionTypeRequestT& request,
                                   const DescribeConnectionTypeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeEntity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeEntityRequestT = Model::DescribeEntityRequest>
  void DescribeEntityAsync(const DescribeEntityRequestT& request, const DescribeEntityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInboundIntegrationsOutcome DescribeInboundIntegrations(
      const Model::DescribeInboundIntegrationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeInboundIntegrations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInboundIntegrationsRequestT = Model::DescribeInboundIntegrationsRequest>
  Model::DescribeInboundIntegrationsOutcomeCallable DescribeInboundIntegrationsCallable(
      const DescribeInboundIntegrationsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::DescribeInboundIntegrations, request);
  }

  /**
   * An Async wrapper for DescribeInboundIntegrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInboundIntegrationsRequestT = Model::DescribeInboundIntegrationsRequest>
  void DescribeInboundIntegrationsAsync(const DescribeInboundIntegrationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeInboundIntegrationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeIntegrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIntegrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeIntegrationsRequestT = Model::DescribeIntegrationsRequest>
  void DescribeIntegrationsAsync(const DescribeIntegrationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * An Async wrapper for GetBlueprintRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetBlueprintRunRequestT = Model::GetBlueprintRunRequest>
  void GetBlueprintRunAsync(const GetBlueprintRunRequestT& request, const GetBlueprintRunResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBlueprintRuns that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBlueprintRuns that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBlueprintRunsRequestT = Model::GetBlueprintRunsRequest>
  void GetBlueprintRunsAsync(const GetBlueprintRunsRequestT& request, const GetBlueprintRunsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCatalog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCatalogRequestT = Model::GetCatalogRequest>
  void GetCatalogAsync(const GetCatalogRequestT& request, const GetCatalogResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCatalogImportStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCatalogImportStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCatalogImportStatusRequestT = Model::GetCatalogImportStatusRequest>
  void GetCatalogImportStatusAsync(const GetCatalogImportStatusResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetCatalogImportStatusRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetCatalogs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCatalogsRequestT = Model::GetCatalogsRequest>
  void GetCatalogsAsync(const GetCatalogsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetCatalogsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetClassifier that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetClassifierRequestT = Model::GetClassifierRequest>
  void GetClassifierAsync(const GetClassifierRequestT& request, const GetClassifierResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetClassifiers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetClassifiersRequestT = Model::GetClassifiersRequest>
  void GetClassifiersAsync(const GetClassifiersResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetClassifiersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetColumnStatisticsForPartitionOutcome GetColumnStatisticsForPartition(
      const Model::GetColumnStatisticsForPartitionRequest& request) const;

  /**
   * A Callable wrapper for GetColumnStatisticsForPartition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetColumnStatisticsForPartitionRequestT = Model::GetColumnStatisticsForPartitionRequest>
  Model::GetColumnStatisticsForPartitionOutcomeCallable GetColumnStatisticsForPartitionCallable(
      const GetColumnStatisticsForPartitionRequestT& request) const {
    return SubmitCallable(&GlueClient::GetColumnStatisticsForPartition, request);
  }

  /**
   * An Async wrapper for GetColumnStatisticsForPartition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetColumnStatisticsForPartitionRequestT = Model::GetColumnStatisticsForPartitionRequest>
  void GetColumnStatisticsForPartitionAsync(const GetColumnStatisticsForPartitionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetColumnStatisticsForTableOutcome GetColumnStatisticsForTable(
      const Model::GetColumnStatisticsForTableRequest& request) const;

  /**
   * A Callable wrapper for GetColumnStatisticsForTable that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetColumnStatisticsForTableRequestT = Model::GetColumnStatisticsForTableRequest>
  Model::GetColumnStatisticsForTableOutcomeCallable GetColumnStatisticsForTableCallable(
      const GetColumnStatisticsForTableRequestT& request) const {
    return SubmitCallable(&GlueClient::GetColumnStatisticsForTable, request);
  }

  /**
   * An Async wrapper for GetColumnStatisticsForTable that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetColumnStatisticsForTableRequestT = Model::GetColumnStatisticsForTableRequest>
  void GetColumnStatisticsForTableAsync(const GetColumnStatisticsForTableRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetColumnStatisticsTaskRunOutcome GetColumnStatisticsTaskRun(
      const Model::GetColumnStatisticsTaskRunRequest& request) const;

  /**
   * A Callable wrapper for GetColumnStatisticsTaskRun that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetColumnStatisticsTaskRunRequestT = Model::GetColumnStatisticsTaskRunRequest>
  Model::GetColumnStatisticsTaskRunOutcomeCallable GetColumnStatisticsTaskRunCallable(
      const GetColumnStatisticsTaskRunRequestT& request) const {
    return SubmitCallable(&GlueClient::GetColumnStatisticsTaskRun, request);
  }

  /**
   * An Async wrapper for GetColumnStatisticsTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetColumnStatisticsTaskRunRequestT = Model::GetColumnStatisticsTaskRunRequest>
  void GetColumnStatisticsTaskRunAsync(const GetColumnStatisticsTaskRunRequestT& request,
                                       const GetColumnStatisticsTaskRunResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetColumnStatisticsTaskRunsOutcome GetColumnStatisticsTaskRuns(
      const Model::GetColumnStatisticsTaskRunsRequest& request) const;

  /**
   * A Callable wrapper for GetColumnStatisticsTaskRuns that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetColumnStatisticsTaskRunsRequestT = Model::GetColumnStatisticsTaskRunsRequest>
  Model::GetColumnStatisticsTaskRunsOutcomeCallable GetColumnStatisticsTaskRunsCallable(
      const GetColumnStatisticsTaskRunsRequestT& request) const {
    return SubmitCallable(&GlueClient::GetColumnStatisticsTaskRuns, request);
  }

  /**
   * An Async wrapper for GetColumnStatisticsTaskRuns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetColumnStatisticsTaskRunsRequestT = Model::GetColumnStatisticsTaskRunsRequest>
  void GetColumnStatisticsTaskRunsAsync(const GetColumnStatisticsTaskRunsRequestT& request,
                                        const GetColumnStatisticsTaskRunsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetColumnStatisticsTaskSettingsOutcome GetColumnStatisticsTaskSettings(
      const Model::GetColumnStatisticsTaskSettingsRequest& request) const;

  /**
   * A Callable wrapper for GetColumnStatisticsTaskSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetColumnStatisticsTaskSettingsRequestT = Model::GetColumnStatisticsTaskSettingsRequest>
  Model::GetColumnStatisticsTaskSettingsOutcomeCallable GetColumnStatisticsTaskSettingsCallable(
      const GetColumnStatisticsTaskSettingsRequestT& request) const {
    return SubmitCallable(&GlueClient::GetColumnStatisticsTaskSettings, request);
  }

  /**
   * An Async wrapper for GetColumnStatisticsTaskSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetColumnStatisticsTaskSettingsRequestT = Model::GetColumnStatisticsTaskSettingsRequest>
  void GetColumnStatisticsTaskSettingsAsync(const GetColumnStatisticsTaskSettingsRequestT& request,
                                            const GetColumnStatisticsTaskSettingsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetConnections that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetConnectionsRequestT = Model::GetConnectionsRequest>
  void GetConnectionsAsync(const GetConnectionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetConnectionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCrawlerRequestT = Model::GetCrawlerRequest>
  void GetCrawlerAsync(const GetCrawlerRequestT& request, const GetCrawlerResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCrawlerMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCrawlerMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCrawlerMetricsRequestT = Model::GetCrawlerMetricsRequest>
  void GetCrawlerMetricsAsync(const GetCrawlerMetricsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetCrawlerMetricsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetCrawlers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCrawlersRequestT = Model::GetCrawlersRequest>
  void GetCrawlersAsync(const GetCrawlersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetCrawlersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetCustomEntityType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCustomEntityType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetCustomEntityTypeRequestT = Model::GetCustomEntityTypeRequest>
  void GetCustomEntityTypeAsync(const GetCustomEntityTypeRequestT& request, const GetCustomEntityTypeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDataCatalogEncryptionSettingsOutcome GetDataCatalogEncryptionSettings(
      const Model::GetDataCatalogEncryptionSettingsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetDataCatalogEncryptionSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetDataCatalogEncryptionSettingsRequestT = Model::GetDataCatalogEncryptionSettingsRequest>
  Model::GetDataCatalogEncryptionSettingsOutcomeCallable GetDataCatalogEncryptionSettingsCallable(
      const GetDataCatalogEncryptionSettingsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::GetDataCatalogEncryptionSettings, request);
  }

  /**
   * An Async wrapper for GetDataCatalogEncryptionSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDataCatalogEncryptionSettingsRequestT = Model::GetDataCatalogEncryptionSettingsRequest>
  void GetDataCatalogEncryptionSettingsAsync(const GetDataCatalogEncryptionSettingsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const GetDataCatalogEncryptionSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDataQualityModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataQualityModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDataQualityModelRequestT = Model::GetDataQualityModelRequest>
  void GetDataQualityModelAsync(const GetDataQualityModelRequestT& request, const GetDataQualityModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataQualityModelResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetDataQualityModelResultRequestT = Model::GetDataQualityModelResultRequest>
  Model::GetDataQualityModelResultOutcomeCallable GetDataQualityModelResultCallable(
      const GetDataQualityModelResultRequestT& request) const {
    return SubmitCallable(&GlueClient::GetDataQualityModelResult, request);
  }

  /**
   * An Async wrapper for GetDataQualityModelResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataQualityModelResultRequestT = Model::GetDataQualityModelResultRequest>
  void GetDataQualityModelResultAsync(const GetDataQualityModelResultRequestT& request,
                                      const GetDataQualityModelResultResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataQualityResult that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataQualityResult that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataQualityResultRequestT = Model::GetDataQualityResultRequest>
  void GetDataQualityResultAsync(const GetDataQualityResultRequestT& request, const GetDataQualityResultResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDataQualityRuleRecommendationRunOutcome GetDataQualityRuleRecommendationRun(
      const Model::GetDataQualityRuleRecommendationRunRequest& request) const;

  /**
   * A Callable wrapper for GetDataQualityRuleRecommendationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetDataQualityRuleRecommendationRunRequestT = Model::GetDataQualityRuleRecommendationRunRequest>
  Model::GetDataQualityRuleRecommendationRunOutcomeCallable GetDataQualityRuleRecommendationRunCallable(
      const GetDataQualityRuleRecommendationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::GetDataQualityRuleRecommendationRun, request);
  }

  /**
   * An Async wrapper for GetDataQualityRuleRecommendationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetDataQualityRuleRecommendationRunRequestT = Model::GetDataQualityRuleRecommendationRunRequest>
  void GetDataQualityRuleRecommendationRunAsync(const GetDataQualityRuleRecommendationRunRequestT& request,
                                                const GetDataQualityRuleRecommendationRunResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataQualityRuleset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataQualityRuleset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDataQualityRulesetRequestT = Model::GetDataQualityRulesetRequest>
  void GetDataQualityRulesetAsync(const GetDataQualityRulesetRequestT& request, const GetDataQualityRulesetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDataQualityRulesetEvaluationRunOutcome GetDataQualityRulesetEvaluationRun(
      const Model::GetDataQualityRulesetEvaluationRunRequest& request) const;

  /**
   * A Callable wrapper for GetDataQualityRulesetEvaluationRun that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetDataQualityRulesetEvaluationRunRequestT = Model::GetDataQualityRulesetEvaluationRunRequest>
  Model::GetDataQualityRulesetEvaluationRunOutcomeCallable GetDataQualityRulesetEvaluationRunCallable(
      const GetDataQualityRulesetEvaluationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::GetDataQualityRulesetEvaluationRun, request);
  }

  /**
   * An Async wrapper for GetDataQualityRulesetEvaluationRun that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDataQualityRulesetEvaluationRunRequestT = Model::GetDataQualityRulesetEvaluationRunRequest>
  void GetDataQualityRulesetEvaluationRunAsync(const GetDataQualityRulesetEvaluationRunRequestT& request,
                                               const GetDataQualityRulesetEvaluationRunResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDatabase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDatabaseRequestT = Model::GetDatabaseRequest>
  void GetDatabaseAsync(const GetDatabaseRequestT& request, const GetDatabaseResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDatabases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDatabasesRequestT = Model::GetDatabasesRequest>
  void GetDatabasesAsync(const GetDatabasesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetDatabasesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDataflowGraph that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataflowGraph that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDataflowGraphRequestT = Model::GetDataflowGraphRequest>
  void GetDataflowGraphAsync(const GetDataflowGraphResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetDataflowGraphRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetDevEndpoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDevEndpointRequestT = Model::GetDevEndpointRequest>
  void GetDevEndpointAsync(const GetDevEndpointRequestT& request, const GetDevEndpointResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDevEndpoints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDevEndpointsRequestT = Model::GetDevEndpointsRequest>
  void GetDevEndpointsAsync(const GetDevEndpointsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetDevEndpointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetEntityRecords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEntityRecords that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEntityRecordsRequestT = Model::GetEntityRecordsRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::GetGlueIdentityCenterConfigurationOutcome GetGlueIdentityCenterConfiguration(
      const Model::GetGlueIdentityCenterConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for GetGlueIdentityCenterConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetGlueIdentityCenterConfigurationRequestT = Model::GetGlueIdentityCenterConfigurationRequest>
  Model::GetGlueIdentityCenterConfigurationOutcomeCallable GetGlueIdentityCenterConfigurationCallable(
      const GetGlueIdentityCenterConfigurationRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::GetGlueIdentityCenterConfiguration, request);
  }

  /**
   * An Async wrapper for GetGlueIdentityCenterConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetGlueIdentityCenterConfigurationRequestT = Model::GetGlueIdentityCenterConfigurationRequest>
  void GetGlueIdentityCenterConfigurationAsync(const GetGlueIdentityCenterConfigurationResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const GetGlueIdentityCenterConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIntegrationResourcePropertyOutcome GetIntegrationResourceProperty(
      const Model::GetIntegrationResourcePropertyRequest& request) const;

  /**
   * A Callable wrapper for GetIntegrationResourceProperty that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetIntegrationResourcePropertyRequestT = Model::GetIntegrationResourcePropertyRequest>
  Model::GetIntegrationResourcePropertyOutcomeCallable GetIntegrationResourcePropertyCallable(
      const GetIntegrationResourcePropertyRequestT& request) const {
    return SubmitCallable(&GlueClient::GetIntegrationResourceProperty, request);
  }

  /**
   * An Async wrapper for GetIntegrationResourceProperty that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetIntegrationResourcePropertyRequestT = Model::GetIntegrationResourcePropertyRequest>
  void GetIntegrationResourcePropertyAsync(const GetIntegrationResourcePropertyRequestT& request,
                                           const GetIntegrationResourcePropertyResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetIntegrationTablePropertiesOutcome GetIntegrationTableProperties(
      const Model::GetIntegrationTablePropertiesRequest& request) const;

  /**
   * A Callable wrapper for GetIntegrationTableProperties that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetIntegrationTablePropertiesRequestT = Model::GetIntegrationTablePropertiesRequest>
  Model::GetIntegrationTablePropertiesOutcomeCallable GetIntegrationTablePropertiesCallable(
      const GetIntegrationTablePropertiesRequestT& request) const {
    return SubmitCallable(&GlueClient::GetIntegrationTableProperties, request);
  }

  /**
   * An Async wrapper for GetIntegrationTableProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIntegrationTablePropertiesRequestT = Model::GetIntegrationTablePropertiesRequest>
  void GetIntegrationTablePropertiesAsync(const GetIntegrationTablePropertiesRequestT& request,
                                          const GetIntegrationTablePropertiesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobBookmark that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobBookmarkRequestT = Model::GetJobBookmarkRequest>
  void GetJobBookmarkAsync(const GetJobBookmarkRequestT& request, const GetJobBookmarkResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobRunRequestT = Model::GetJobRunRequest>
  void GetJobRunAsync(const GetJobRunRequestT& request, const GetJobRunResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobRunsRequestT = Model::GetJobRunsRequest>
  void GetJobRunsAsync(const GetJobRunsRequestT& request, const GetJobRunsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetJobsRequestT = Model::GetJobsRequest>
  void GetJobsAsync(const GetJobsResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                    const GetJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMLTaskRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLTaskRunRequestT = Model::GetMLTaskRunRequest>
  void GetMLTaskRunAsync(const GetMLTaskRunRequestT& request, const GetMLTaskRunResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMLTaskRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLTaskRunsRequestT = Model::GetMLTaskRunsRequest>
  void GetMLTaskRunsAsync(const GetMLTaskRunsRequestT& request, const GetMLTaskRunsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMLTransform that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLTransformRequestT = Model::GetMLTransformRequest>
  void GetMLTransformAsync(const GetMLTransformRequestT& request, const GetMLTransformResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMLTransforms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLTransformsRequestT = Model::GetMLTransformsRequest>
  void GetMLTransformsAsync(const GetMLTransformsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetMLTransformsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetMapping that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMappingRequestT = Model::GetMappingRequest>
  void GetMappingAsync(const GetMappingRequestT& request, const GetMappingResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPartition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPartitionRequestT = Model::GetPartitionRequest>
  void GetPartitionAsync(const GetPartitionRequestT& request, const GetPartitionResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetPartitionIndexes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPartitionIndexes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetPartitionIndexesRequestT = Model::GetPartitionIndexesRequest>
  void GetPartitionIndexesAsync(const GetPartitionIndexesRequestT& request, const GetPartitionIndexesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetPartitions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetPartitionsRequestT = Model::GetPartitionsRequest>
  void GetPartitionsAsync(const GetPartitionsRequestT& request, const GetPartitionsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetResourcePolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourcePolicies that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetResourcePoliciesRequestT = Model::GetResourcePoliciesRequest>
  void GetResourcePoliciesAsync(const GetResourcePoliciesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetResourcePoliciesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSchemaRequestT = Model::GetSchemaRequest>
  void GetSchemaAsync(const GetSchemaRequestT& request, const GetSchemaResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSchemaByDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSchemaByDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSchemaByDefinitionRequestT = Model::GetSchemaByDefinitionRequest>
  void GetSchemaByDefinitionAsync(const GetSchemaByDefinitionRequestT& request, const GetSchemaByDefinitionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSchemaVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSchemaVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSchemaVersionRequestT = Model::GetSchemaVersionRequest>
  void GetSchemaVersionAsync(const GetSchemaVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const GetSchemaVersionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSchemaVersionsDiff that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSchemaVersionsDiff that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSchemaVersionsDiffRequestT = Model::GetSchemaVersionsDiffRequest>
  void GetSchemaVersionsDiffAsync(const GetSchemaVersionsDiffRequestT& request, const GetSchemaVersionsDiffResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSecurityConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSecurityConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSecurityConfigurationRequestT = Model::GetSecurityConfigurationRequest>
  void GetSecurityConfigurationAsync(const GetSecurityConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSecurityConfigurationsOutcome GetSecurityConfigurations(
      const Model::GetSecurityConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetSecurityConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetSecurityConfigurationsRequestT = Model::GetSecurityConfigurationsRequest>
  Model::GetSecurityConfigurationsOutcomeCallable GetSecurityConfigurationsCallable(
      const GetSecurityConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::GetSecurityConfigurations, request);
  }

  /**
   * An Async wrapper for GetSecurityConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSecurityConfigurationsRequestT = Model::GetSecurityConfigurationsRequest>
  void GetSecurityConfigurationsAsync(const GetSecurityConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const GetSecurityConfigurationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetStatement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetStatementRequestT = Model::GetStatementRequest>
  void GetStatementAsync(const GetStatementRequestT& request, const GetStatementResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetTableRequestT = Model::GetTableRequest>
  void GetTableAsync(const GetTableRequestT& request, const GetTableResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTableOptimizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTableOptimizer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTableOptimizerRequestT = Model::GetTableOptimizerRequest>
  void GetTableOptimizerAsync(const GetTableOptimizerRequestT& request, const GetTableOptimizerResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTableVersion that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTableVersionRequestT = Model::GetTableVersionRequest>
  void GetTableVersionAsync(const GetTableVersionRequestT& request, const GetTableVersionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTableVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTableVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTableVersionsRequestT = Model::GetTableVersionsRequest>
  void GetTableVersionsAsync(const GetTableVersionsRequestT& request, const GetTableVersionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTables that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTablesRequestT = Model::GetTablesRequest>
  void GetTablesAsync(const GetTablesRequestT& request, const GetTablesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTagsRequestT = Model::GetTagsRequest>
  void GetTagsAsync(const GetTagsRequestT& request, const GetTagsResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTriggers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTriggersRequestT = Model::GetTriggersRequest>
  void GetTriggersAsync(const GetTriggersResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetTriggersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetUnfilteredPartitionMetadataOutcome GetUnfilteredPartitionMetadata(
      const Model::GetUnfilteredPartitionMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetUnfilteredPartitionMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetUnfilteredPartitionMetadataRequestT = Model::GetUnfilteredPartitionMetadataRequest>
  Model::GetUnfilteredPartitionMetadataOutcomeCallable GetUnfilteredPartitionMetadataCallable(
      const GetUnfilteredPartitionMetadataRequestT& request) const {
    return SubmitCallable(&GlueClient::GetUnfilteredPartitionMetadata, request);
  }

  /**
   * An Async wrapper for GetUnfilteredPartitionMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetUnfilteredPartitionMetadataRequestT = Model::GetUnfilteredPartitionMetadataRequest>
  void GetUnfilteredPartitionMetadataAsync(const GetUnfilteredPartitionMetadataRequestT& request,
                                           const GetUnfilteredPartitionMetadataResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetUnfilteredPartitionsMetadataOutcome GetUnfilteredPartitionsMetadata(
      const Model::GetUnfilteredPartitionsMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetUnfilteredPartitionsMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetUnfilteredPartitionsMetadataRequestT = Model::GetUnfilteredPartitionsMetadataRequest>
  Model::GetUnfilteredPartitionsMetadataOutcomeCallable GetUnfilteredPartitionsMetadataCallable(
      const GetUnfilteredPartitionsMetadataRequestT& request) const {
    return SubmitCallable(&GlueClient::GetUnfilteredPartitionsMetadata, request);
  }

  /**
   * An Async wrapper for GetUnfilteredPartitionsMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetUnfilteredPartitionsMetadataRequestT = Model::GetUnfilteredPartitionsMetadataRequest>
  void GetUnfilteredPartitionsMetadataAsync(const GetUnfilteredPartitionsMetadataRequestT& request,
                                            const GetUnfilteredPartitionsMetadataResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetUnfilteredTableMetadataOutcome GetUnfilteredTableMetadata(
      const Model::GetUnfilteredTableMetadataRequest& request) const;

  /**
   * A Callable wrapper for GetUnfilteredTableMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetUnfilteredTableMetadataRequestT = Model::GetUnfilteredTableMetadataRequest>
  Model::GetUnfilteredTableMetadataOutcomeCallable GetUnfilteredTableMetadataCallable(
      const GetUnfilteredTableMetadataRequestT& request) const {
    return SubmitCallable(&GlueClient::GetUnfilteredTableMetadata, request);
  }

  /**
   * An Async wrapper for GetUnfilteredTableMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetUnfilteredTableMetadataRequestT = Model::GetUnfilteredTableMetadataRequest>
  void GetUnfilteredTableMetadataAsync(const GetUnfilteredTableMetadataRequestT& request,
                                       const GetUnfilteredTableMetadataResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetUsageProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUsageProfileRequestT = Model::GetUsageProfileRequest>
  void GetUsageProfileAsync(const GetUsageProfileRequestT& request, const GetUsageProfileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUserDefinedFunction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUserDefinedFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetUserDefinedFunctionRequestT = Model::GetUserDefinedFunctionRequest>
  void GetUserDefinedFunctionAsync(const GetUserDefinedFunctionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetUserDefinedFunctions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUserDefinedFunctions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetUserDefinedFunctionsRequestT = Model::GetUserDefinedFunctionsRequest>
  void GetUserDefinedFunctionsAsync(const GetUserDefinedFunctionsRequestT& request,
  ...
  /**
   * A Callable wrapper for GetWorkflowRunProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkflowRunProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkflowRunPropertiesRequestT = Model::GetWorkflowRunPropertiesRequest>
  void GetWorkflowRunPropertiesAsync(const GetWorkflowRunPropertiesRequestT& request,
  ...
  /**
   * An Async wrapper for GetWorkflowRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWorkflowRunsRequestT = Model::GetWorkflowRunsRequest>
  void GetWorkflowRunsAsync(const GetWorkflowRunsRequestT& request, const GetWorkflowRunsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportCatalogToGlue that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportCatalogToGlue that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportCatalogToGlueRequestT = Model::ImportCatalogToGlueRequest>
  void ImportCatalogToGlueAsync(const ImportCatalogToGlueResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ImportCatalogToGlueRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListColumnStatisticsTaskRunsOutcome ListColumnStatisticsTaskRuns(
      const Model::ListColumnStatisticsTaskRunsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListColumnStatisticsTaskRuns that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListColumnStatisticsTaskRunsRequestT = Model::ListColumnStatisticsTaskRunsRequest>
  Model::ListColumnStatisticsTaskRunsOutcomeCallable ListColumnStatisticsTaskRunsCallable(
      const ListColumnStatisticsTaskRunsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListColumnStatisticsTaskRuns, request);
  }

  /**
   * An Async wrapper for ListColumnStatisticsTaskRuns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListColumnStatisticsTaskRunsRequestT = Model::ListColumnStatisticsTaskRunsRequest>
  void ListColumnStatisticsTaskRunsAsync(const ListColumnStatisticsTaskRunsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListColumnStatisticsTaskRunsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListConnectionTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConnectionTypes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListConnectionTypesRequestT = Model::ListConnectionTypesRequest>
  void ListConnectionTypesAsync(const ListConnectionTypesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListConnectionTypesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCrawlers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCrawlersRequestT = Model::ListCrawlersRequest>
  void ListCrawlersAsync(const ListCrawlersResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListCrawlersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListCrawls that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCrawlsRequestT = Model::ListCrawlsRequest>
  void ListCrawlsAsync(const ListCrawlsRequestT& request, const ListCrawlsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCustomEntityTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCustomEntityTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomEntityTypesRequestT = Model::ListCustomEntityTypesRequest>
  void ListCustomEntityTypesAsync(const ListCustomEntityTypesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListCustomEntityTypesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDataQualityResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataQualityResults that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataQualityResultsRequestT = Model::ListDataQualityResultsRequest>
  void ListDataQualityResultsAsync(const ListDataQualityResultsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListDataQualityResultsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataQualityRuleRecommendationRunsOutcome ListDataQualityRuleRecommendationRuns(
      const Model::ListDataQualityRuleRecommendationRunsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataQualityRuleRecommendationRuns that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDataQualityRuleRecommendationRunsRequestT = Model::ListDataQualityRuleRecommendationRunsRequest>
  Model::ListDataQualityRuleRecommendationRunsOutcomeCallable ListDataQualityRuleRecommendationRunsCallable(
      const ListDataQualityRuleRecommendationRunsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListDataQualityRuleRecommendationRuns, request);
  }

  /**
   * An Async wrapper for ListDataQualityRuleRecommendationRuns that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDataQualityRuleRecommendationRunsRequestT = Model::ListDataQualityRuleRecommendationRunsRequest>
  void ListDataQualityRuleRecommendationRunsAsync(const ListDataQualityRuleRecommendationRunsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const ListDataQualityRuleRecommendationRunsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataQualityRulesetEvaluationRunsOutcome ListDataQualityRulesetEvaluationRuns(
      const Model::ListDataQualityRulesetEvaluationRunsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataQualityRulesetEvaluationRuns that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDataQualityRulesetEvaluationRunsRequestT = Model::ListDataQualityRulesetEvaluationRunsRequest>
  Model::ListDataQualityRulesetEvaluationRunsOutcomeCallable ListDataQualityRulesetEvaluationRunsCallable(
      const ListDataQualityRulesetEvaluationRunsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListDataQualityRulesetEvaluationRuns, request);
  }

  /**
   * An Async wrapper for ListDataQualityRulesetEvaluationRuns that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDataQualityRulesetEvaluationRunsRequestT = Model::ListDataQualityRulesetEvaluationRunsRequest>
  void ListDataQualityRulesetEvaluationRunsAsync(const ListDataQualityRulesetEvaluationRunsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const ListDataQualityRulesetEvaluationRunsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDataQualityRulesets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataQualityRulesets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataQualityRulesetsRequestT = Model::ListDataQualityRulesetsRequest>
  void ListDataQualityRulesetsAsync(const ListDataQualityRulesetsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListDataQualityRulesetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataQualityStatisticAnnotationsOutcome ListDataQualityStatisticAnnotations(
      const Model::ListDataQualityStatisticAnnotationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataQualityStatisticAnnotations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListDataQualityStatisticAnnotationsRequestT = Model::ListDataQualityStatisticAnnotationsRequest>
  Model::ListDataQualityStatisticAnnotationsOutcomeCallable ListDataQualityStatisticAnnotationsCallable(
      const ListDataQualityStatisticAnnotationsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListDataQualityStatisticAnnotations, request);
  }

  /**
   * An Async wrapper for ListDataQualityStatisticAnnotations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListDataQualityStatisticAnnotationsRequestT = Model::ListDataQualityStatisticAnnotationsRequest>
  void ListDataQualityStatisticAnnotationsAsync(const ListDataQualityStatisticAnnotationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListDataQualityStatisticAnnotationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataQualityStatisticsOutcome ListDataQualityStatistics(
      const Model::ListDataQualityStatisticsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataQualityStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListDataQualityStatisticsRequestT = Model::ListDataQualityStatisticsRequest>
  Model::ListDataQualityStatisticsOutcomeCallable ListDataQualityStatisticsCallable(
      const ListDataQualityStatisticsRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListDataQualityStatistics, request);
  }

  /**
   * An Async wrapper for ListDataQualityStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataQualityStatisticsRequestT = Model::ListDataQualityStatisticsRequest>
  void ListDataQualityStatisticsAsync(const ListDataQualityStatisticsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListDataQualityStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDevEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDevEndpoints that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDevEndpointsRequestT = Model::ListDevEndpointsRequest>
  void ListDevEndpointsAsync(const ListDevEndpointsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListDevEndpointsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListEntities that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEntitiesRequestT = Model::ListEntitiesRequest>
  void ListEntitiesAsync(const ListEntitiesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * <p>Lists the integration table properties in your account. This operation
   * supports filtering and pagination.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/ListIntegrationTableProperties">AWS
   * API Reference</a></p>
   */
  virtual Model::ListIntegrationTablePropertiesOutcome ListIntegrationTableProperties(
      const Model::ListIntegrationTablePropertiesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListIntegrationTableProperties that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListIntegrationTablePropertiesRequestT = Model::ListIntegrationTablePropertiesRequest>
  Model::ListIntegrationTablePropertiesOutcomeCallable ListIntegrationTablePropertiesCallable(
      const ListIntegrationTablePropertiesRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::ListIntegrationTableProperties, request);
  }

  /**
   * An Async wrapper for ListIntegrationTableProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListIntegrationTablePropertiesRequestT = Model::ListIntegrationTablePropertiesRequest>
  void ListIntegrationTablePropertiesAsync(const ListIntegrationTablePropertiesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListIntegrationTablePropertiesRequestT& request = {}) const {
    return SubmitAsync(&GlueClient::ListIntegrationTableProperties, request, handler, context);
  }
  ...
  /**
   * A Callable wrapper for ListMLTransforms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMLTransforms that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMLTransformsRequestT = Model::ListMLTransformsRequest>
  void ListMLTransformsAsync(const ListMLTransformsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListMLTransformsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSchemaVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSchemaVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSchemaVersionsRequestT = Model::ListSchemaVersionsRequest>
  void ListSchemaVersionsAsync(const ListSchemaVersionsRequestT& request, const ListSchemaVersionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListSchemasRequestT = Model::ListSchemasRequest>
  void ListSchemasAsync(const ListSchemasResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListSchemasRequestT& request = {}) const {
   ...
   */
  template <typename ListStatementsRequestT = Model::ListStatementsRequest>
  void ListStatementsAsync(const ListStatementsRequestT& request, const ListStatementsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTableOptimizerRuns that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTableOptimizerRuns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTableOptimizerRunsRequestT = Model::ListTableOptimizerRunsRequest>
  void ListTableOptimizerRunsAsync(const ListTableOptimizerRunsRequestT& request,
                                   const ListTableOptimizerRunsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListTriggersRequestT = Model::ListTriggersRequest>
  void ListTriggersAsync(const ListTriggersResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListTriggersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListUsageProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUsageProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListUsageProfilesRequestT = Model::ListUsageProfilesRequest>
  void ListUsageProfilesAsync(const ListUsageProfilesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListUsageProfilesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ModifyIntegration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyIntegration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyIntegrationRequestT = Model::ModifyIntegrationRequest>
  void ModifyIntegrationAsync(const ModifyIntegrationRequestT& request, const ModifyIntegrationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutDataCatalogEncryptionSettingsOutcome PutDataCatalogEncryptionSettings(
      const Model::PutDataCatalogEncryptionSettingsRequest& request) const;

  /**
   * A Callable wrapper for PutDataCatalogEncryptionSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutDataCatalogEncryptionSettingsRequestT = Model::PutDataCatalogEncryptionSettingsRequest>
  Model::PutDataCatalogEncryptionSettingsOutcomeCallable PutDataCatalogEncryptionSettingsCallable(
      const PutDataCatalogEncryptionSettingsRequestT& request) const {
    return SubmitCallable(&GlueClient::PutDataCatalogEncryptionSettings, request);
  }

  /**
   * An Async wrapper for PutDataCatalogEncryptionSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutDataCatalogEncryptionSettingsRequestT = Model::PutDataCatalogEncryptionSettingsRequest>
  void PutDataCatalogEncryptionSettingsAsync(const PutDataCatalogEncryptionSettingsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutDataQualityProfileAnnotationOutcome PutDataQualityProfileAnnotation(
      const Model::PutDataQualityProfileAnnotationRequest& request) const;

  /**
   * A Callable wrapper for PutDataQualityProfileAnnotation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutDataQualityProfileAnnotationRequestT = Model::PutDataQualityProfileAnnotationRequest>
  Model::PutDataQualityProfileAnnotationOutcomeCallable PutDataQualityProfileAnnotationCallable(
      const PutDataQualityProfileAnnotationRequestT& request) const {
    return SubmitCallable(&GlueClient::PutDataQualityProfileAnnotation, request);
  }

  /**
   * An Async wrapper for PutDataQualityProfileAnnotation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutDataQualityProfileAnnotationRequestT = Model::PutDataQualityProfileAnnotationRequest>
  void PutDataQualityProfileAnnotationAsync(const PutDataQualityProfileAnnotationRequestT& request,
  ...
  /**
   * A Callable wrapper for PutSchemaVersionMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutSchemaVersionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutSchemaVersionMetadataRequestT = Model::PutSchemaVersionMetadataRequest>
  void PutSchemaVersionMetadataAsync(const PutSchemaVersionMetadataRequestT& request,
  ...
  /**
   * A Callable wrapper for PutWorkflowRunProperties that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutWorkflowRunProperties that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutWorkflowRunPropertiesRequestT = Model::PutWorkflowRunPropertiesRequest>
  void PutWorkflowRunPropertiesAsync(const PutWorkflowRunPropertiesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::QuerySchemaVersionMetadataOutcome QuerySchemaVersionMetadata(
      const Model::QuerySchemaVersionMetadataRequest& request = {}) const;

  /**
   * A Callable wrapper for QuerySchemaVersionMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename QuerySchemaVersionMetadataRequestT = Model::QuerySchemaVersionMetadataRequest>
  Model::QuerySchemaVersionMetadataOutcomeCallable QuerySchemaVersionMetadataCallable(
  ...
  /**
   * An Async wrapper for QuerySchemaVersionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename QuerySchemaVersionMetadataRequestT = Model::QuerySchemaVersionMetadataRequest>
  void QuerySchemaVersionMetadataAsync(const QuerySchemaVersionMetadataResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const QuerySchemaVersionMetadataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RegisterSchemaVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterSchemaVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterSchemaVersionRequestT = Model::RegisterSchemaVersionRequest>
  void RegisterSchemaVersionAsync(const RegisterSchemaVersionRequestT& request, const RegisterSchemaVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveSchemaVersionMetadataOutcome RemoveSchemaVersionMetadata(
      const Model::RemoveSchemaVersionMetadataRequest& request) const;

  /**
   * A Callable wrapper for RemoveSchemaVersionMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveSchemaVersionMetadataRequestT = Model::RemoveSchemaVersionMetadataRequest>
  Model::RemoveSchemaVersionMetadataOutcomeCallable RemoveSchemaVersionMetadataCallable(
      const RemoveSchemaVersionMetadataRequestT& request) const {
    return SubmitCallable(&GlueClient::RemoveSchemaVersionMetadata, request);
  }

  /**
   * An Async wrapper for RemoveSchemaVersionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveSchemaVersionMetadataRequestT = Model::RemoveSchemaVersionMetadataRequest>
  void RemoveSchemaVersionMetadataAsync(const RemoveSchemaVersionMetadataRequestT& request,
  ...
  /**
   * A Callable wrapper for ResetJobBookmark that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResetJobBookmark that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResetJobBookmarkRequestT = Model::ResetJobBookmarkRequest>
  void ResetJobBookmarkAsync(const ResetJobBookmarkRequestT& request, const ResetJobBookmarkResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ResumeWorkflowRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResumeWorkflowRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResumeWorkflowRunRequestT = Model::ResumeWorkflowRunRequest>
  void ResumeWorkflowRunAsync(const ResumeWorkflowRunRequestT& request, const ResumeWorkflowRunResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RunStatement that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RunStatementRequestT = Model::RunStatementRequest>
  ...
  /**
   * An Async wrapper for SearchTables that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchTablesRequestT = Model::SearchTablesRequest>
  void SearchTablesAsync(const SearchTablesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const SearchTablesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartBlueprintRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartBlueprintRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartBlueprintRunRequestT = Model::StartBlueprintRunRequest>
  void StartBlueprintRunAsync(const StartBlueprintRunRequestT& request, const StartBlueprintRunResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartColumnStatisticsTaskRunOutcome StartColumnStatisticsTaskRun(
      const Model::StartColumnStatisticsTaskRunRequest& request) const;

  /**
   * A Callable wrapper for StartColumnStatisticsTaskRun that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartColumnStatisticsTaskRunRequestT = Model::StartColumnStatisticsTaskRunRequest>
  Model::StartColumnStatisticsTaskRunOutcomeCallable StartColumnStatisticsTaskRunCallable(
      const StartColumnStatisticsTaskRunRequestT& request) const {
    return SubmitCallable(&GlueClient::StartColumnStatisticsTaskRun, request);
  }

  /**
   * An Async wrapper for StartColumnStatisticsTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartColumnStatisticsTaskRunRequestT = Model::StartColumnStatisticsTaskRunRequest>
  void StartColumnStatisticsTaskRunAsync(const StartColumnStatisticsTaskRunRequestT& request,
                                         const StartColumnStatisticsTaskRunResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartColumnStatisticsTaskRunScheduleOutcome StartColumnStatisticsTaskRunSchedule(
      const Model::StartColumnStatisticsTaskRunScheduleRequest& request) const;

  /**
   * A Callable wrapper for StartColumnStatisticsTaskRunSchedule that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartColumnStatisticsTaskRunScheduleRequestT = Model::StartColumnStatisticsTaskRunScheduleRequest>
  Model::StartColumnStatisticsTaskRunScheduleOutcomeCallable StartColumnStatisticsTaskRunScheduleCallable(
      const StartColumnStatisticsTaskRunScheduleRequestT& request) const {
    return SubmitCallable(&GlueClient::StartColumnStatisticsTaskRunSchedule, request);
  }

  /**
   * An Async wrapper for StartColumnStatisticsTaskRunSchedule that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartColumnStatisticsTaskRunScheduleRequestT = Model::StartColumnStatisticsTaskRunScheduleRequest>
  void StartColumnStatisticsTaskRunScheduleAsync(const StartColumnStatisticsTaskRunScheduleRequestT& request,
                                                 const StartColumnStatisticsTaskRunScheduleResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartCrawlerRequestT = Model::StartCrawlerRequest>
  void StartCrawlerAsync(const StartCrawlerRequestT& request, const StartCrawlerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartCrawlerSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartCrawlerSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartCrawlerScheduleRequestT = Model::StartCrawlerScheduleRequest>
  void StartCrawlerScheduleAsync(const StartCrawlerScheduleRequestT& request, const StartCrawlerScheduleResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDataQualityRuleRecommendationRunOutcome StartDataQualityRuleRecommendationRun(
      const Model::StartDataQualityRuleRecommendationRunRequest& request) const;

  /**
   * A Callable wrapper for StartDataQualityRuleRecommendationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartDataQualityRuleRecommendationRunRequestT = Model::StartDataQualityRuleRecommendationRunRequest>
  Model::StartDataQualityRuleRecommendationRunOutcomeCallable StartDataQualityRuleRecommendationRunCallable(
      const StartDataQualityRuleRecommendationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::StartDataQualityRuleRecommendationRun, request);
  }

  /**
   * An Async wrapper for StartDataQualityRuleRecommendationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartDataQualityRuleRecommendationRunRequestT = Model::StartDataQualityRuleRecommendationRunRequest>
  void StartDataQualityRuleRecommendationRunAsync(const StartDataQualityRuleRecommendationRunRequestT& request,
                                                  const StartDataQualityRuleRecommendationRunResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDataQualityRulesetEvaluationRunOutcome StartDataQualityRulesetEvaluationRun(
      const Model::StartDataQualityRulesetEvaluationRunRequest& request) const;

  /**
   * A Callable wrapper for StartDataQualityRulesetEvaluationRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartDataQualityRulesetEvaluationRunRequestT = Model::StartDataQualityRulesetEvaluationRunRequest>
  Model::StartDataQualityRulesetEvaluationRunOutcomeCallable StartDataQualityRulesetEvaluationRunCallable(
      const StartDataQualityRulesetEvaluationRunRequestT& request) const {
    return SubmitCallable(&GlueClient::StartDataQualityRulesetEvaluationRun, request);
  }

  /**
   * An Async wrapper for StartDataQualityRulesetEvaluationRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartDataQualityRulesetEvaluationRunRequestT = Model::StartDataQualityRulesetEvaluationRunRequest>
  void StartDataQualityRulesetEvaluationRunAsync(const StartDataQualityRulesetEvaluationRunRequestT& request,
                                                 const StartDataQualityRulesetEvaluationRunResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartExportLabelsTaskRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartExportLabelsTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartExportLabelsTaskRunRequestT = Model::StartExportLabelsTaskRunRequest>
  void StartExportLabelsTaskRunAsync(const StartExportLabelsTaskRunRequestT& request,
  ...
  /**
   * A Callable wrapper for StartImportLabelsTaskRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartImportLabelsTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartImportLabelsTaskRunRequestT = Model::StartImportLabelsTaskRunRequest>
  void StartImportLabelsTaskRunAsync(const StartImportLabelsTaskRunRequestT& request,
  ...
  /**
   * A Callable wrapper for StartMLEvaluationTaskRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMLEvaluationTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMLEvaluationTaskRunRequestT = Model::StartMLEvaluationTaskRunRequest>
  void StartMLEvaluationTaskRunAsync(const StartMLEvaluationTaskRunRequestT& request,
                                     const StartMLEvaluationTaskRunResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMLLabelingSetGenerationTaskRunOutcome StartMLLabelingSetGenerationTaskRun(
      const Model::StartMLLabelingSetGenerationTaskRunRequest& request) const;

  /**
   * A Callable wrapper for StartMLLabelingSetGenerationTaskRun that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartMLLabelingSetGenerationTaskRunRequestT = Model::StartMLLabelingSetGenerationTaskRunRequest>
  Model::StartMLLabelingSetGenerationTaskRunOutcomeCallable StartMLLabelingSetGenerationTaskRunCallable(
      const StartMLLabelingSetGenerationTaskRunRequestT& request) const {
    return SubmitCallable(&GlueClient::StartMLLabelingSetGenerationTaskRun, request);
  }

  /**
   * An Async wrapper for StartMLLabelingSetGenerationTaskRun that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartMLLabelingSetGenerationTaskRunRequestT = Model::StartMLLabelingSetGenerationTaskRunRequest>
  void StartMLLabelingSetGenerationTaskRunAsync(const StartMLLabelingSetGenerationTaskRunRequestT& request,
                                                const StartMLLabelingSetGenerationTaskRunResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartTrigger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartTriggerRequestT = Model::StartTriggerRequest>
  void StartTriggerAsync(const StartTriggerRequestT& request, const StartTriggerResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopColumnStatisticsTaskRunOutcome StopColumnStatisticsTaskRun(
      const Model::StopColumnStatisticsTaskRunRequest& request) const;

  /**
   * A Callable wrapper for StopColumnStatisticsTaskRun that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopColumnStatisticsTaskRunRequestT = Model::StopColumnStatisticsTaskRunRequest>
  Model::StopColumnStatisticsTaskRunOutcomeCallable StopColumnStatisticsTaskRunCallable(
      const StopColumnStatisticsTaskRunRequestT& request) const {
    return SubmitCallable(&GlueClient::StopColumnStatisticsTaskRun, request);
  }

  /**
   * An Async wrapper for StopColumnStatisticsTaskRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopColumnStatisticsTaskRunRequestT = Model::StopColumnStatisticsTaskRunRequest>
  void StopColumnStatisticsTaskRunAsync(const StopColumnStatisticsTaskRunRequestT& request,
                                        const StopColumnStatisticsTaskRunResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopColumnStatisticsTaskRunScheduleOutcome StopColumnStatisticsTaskRunSchedule(
      const Model::StopColumnStatisticsTaskRunScheduleRequest& request) const;

  /**
   * A Callable wrapper for StopColumnStatisticsTaskRunSchedule that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StopColumnStatisticsTaskRunScheduleRequestT = Model::StopColumnStatisticsTaskRunScheduleRequest>
  Model::StopColumnStatisticsTaskRunScheduleOutcomeCallable StopColumnStatisticsTaskRunScheduleCallable(
      const StopColumnStatisticsTaskRunScheduleRequestT& request) const {
    return SubmitCallable(&GlueClient::StopColumnStatisticsTaskRunSchedule, request);
  }

  /**
   * An Async wrapper for StopColumnStatisticsTaskRunSchedule that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StopColumnStatisticsTaskRunScheduleRequestT = Model::StopColumnStatisticsTaskRunScheduleRequest>
  void StopColumnStatisticsTaskRunScheduleAsync(const StopColumnStatisticsTaskRunScheduleRequestT& request,
                                                const StopColumnStatisticsTaskRunScheduleResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopCrawlerRequestT = Model::StopCrawlerRequest>
  void StopCrawlerAsync(const StopCrawlerRequestT& request, const StopCrawlerResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopCrawlerSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopCrawlerSchedule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopCrawlerScheduleRequestT = Model::StopCrawlerScheduleRequest>
  ...
  /**
   * An Async wrapper for StopSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopSessionRequestT = Model::StopSessionRequest>
  void StopSessionAsync(const StopSessionRequestT& request, const StopSessionResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopTrigger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopTriggerRequestT = Model::StopTriggerRequest>
  void StopTriggerAsync(const StopTriggerRequestT& request, const StopTriggerResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename TestConnectionRequestT = Model::TestConnectionRequest>
  void TestConnectionAsync(const TestConnectionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const TestConnectionRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateCatalog that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCatalogRequestT = Model::UpdateCatalogRequest>
  void UpdateCatalogAsync(const UpdateCatalogRequestT& request, const UpdateCatalogResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateClassifier that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClassifier that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateClassifierRequestT = Model::UpdateClassifierRequest>
  void UpdateClassifierAsync(const UpdateClassifierResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const UpdateClassifierRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateColumnStatisticsForPartitionOutcome UpdateColumnStatisticsForPartition(
      const Model::UpdateColumnStatisticsForPartitionRequest& request) const;

  /**
   * A Callable wrapper for UpdateColumnStatisticsForPartition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateColumnStatisticsForPartitionRequestT = Model::UpdateColumnStatisticsForPartitionRequest>
  Model::UpdateColumnStatisticsForPartitionOutcomeCallable UpdateColumnStatisticsForPartitionCallable(
      const UpdateColumnStatisticsForPartitionRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateColumnStatisticsForPartition, request);
  }

  /**
   * An Async wrapper for UpdateColumnStatisticsForPartition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateColumnStatisticsForPartitionRequestT = Model::UpdateColumnStatisticsForPartitionRequest>
  void UpdateColumnStatisticsForPartitionAsync(const UpdateColumnStatisticsForPartitionRequestT& request,
                                               const UpdateColumnStatisticsForPartitionResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateColumnStatisticsForTableOutcome UpdateColumnStatisticsForTable(
      const Model::UpdateColumnStatisticsForTableRequest& request) const;

  /**
   * A Callable wrapper for UpdateColumnStatisticsForTable that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateColumnStatisticsForTableRequestT = Model::UpdateColumnStatisticsForTableRequest>
  Model::UpdateColumnStatisticsForTableOutcomeCallable UpdateColumnStatisticsForTableCallable(
      const UpdateColumnStatisticsForTableRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateColumnStatisticsForTable, request);
  }

  /**
   * An Async wrapper for UpdateColumnStatisticsForTable that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateColumnStatisticsForTableRequestT = Model::UpdateColumnStatisticsForTableRequest>
  void UpdateColumnStatisticsForTableAsync(const UpdateColumnStatisticsForTableRequestT& request,
                                           const UpdateColumnStatisticsForTableResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateColumnStatisticsTaskSettingsOutcome UpdateColumnStatisticsTaskSettings(
      const Model::UpdateColumnStatisticsTaskSettingsRequest& request) const;

  /**
   * A Callable wrapper for UpdateColumnStatisticsTaskSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateColumnStatisticsTaskSettingsRequestT = Model::UpdateColumnStatisticsTaskSettingsRequest>
  Model::UpdateColumnStatisticsTaskSettingsOutcomeCallable UpdateColumnStatisticsTaskSettingsCallable(
      const UpdateColumnStatisticsTaskSettingsRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateColumnStatisticsTaskSettings, request);
  }

  /**
   * An Async wrapper for UpdateColumnStatisticsTaskSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateColumnStatisticsTaskSettingsRequestT = Model::UpdateColumnStatisticsTaskSettingsRequest>
  void UpdateColumnStatisticsTaskSettingsAsync(const UpdateColumnStatisticsTaskSettingsRequestT& request,
                                               const UpdateColumnStatisticsTaskSettingsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateCrawler that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateCrawlerRequestT = Model::UpdateCrawlerRequest>
  void UpdateCrawlerAsync(const UpdateCrawlerRequestT& request, const UpdateCrawlerResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCrawlerSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCrawlerSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCrawlerScheduleRequestT = Model::UpdateCrawlerScheduleRequest>
  void UpdateCrawlerScheduleAsync(const UpdateCrawlerScheduleRequestT& request, const UpdateCrawlerScheduleResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDataQualityRuleset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDataQualityRuleset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDataQualityRulesetRequestT = Model::UpdateDataQualityRulesetRequest>
  void UpdateDataQualityRulesetAsync(const UpdateDataQualityRulesetRequestT& request,
                                     const UpdateDataQualityRulesetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateDatabase that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDatabaseRequestT = Model::UpdateDatabaseRequest>
  void UpdateDatabaseAsync(const UpdateDatabaseRequestT& request, const UpdateDatabaseResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDevEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDevEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDevEndpointRequestT = Model::UpdateDevEndpointRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateGlueIdentityCenterConfigurationOutcome UpdateGlueIdentityCenterConfiguration(
      const Model::UpdateGlueIdentityCenterConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateGlueIdentityCenterConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateGlueIdentityCenterConfigurationRequestT = Model::UpdateGlueIdentityCenterConfigurationRequest>
  Model::UpdateGlueIdentityCenterConfigurationOutcomeCallable UpdateGlueIdentityCenterConfigurationCallable(
      const UpdateGlueIdentityCenterConfigurationRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::UpdateGlueIdentityCenterConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateGlueIdentityCenterConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateGlueIdentityCenterConfigurationRequestT = Model::UpdateGlueIdentityCenterConfigurationRequest>
  void UpdateGlueIdentityCenterConfigurationAsync(const UpdateGlueIdentityCenterConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const UpdateGlueIdentityCenterConfigurationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateIntegrationResourcePropertyOutcome UpdateIntegrationResourceProperty(
      const Model::UpdateIntegrationResourcePropertyRequest& request) const;

  /**
   * A Callable wrapper for UpdateIntegrationResourceProperty that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateIntegrationResourcePropertyRequestT = Model::UpdateIntegrationResourcePropertyRequest>
  Model::UpdateIntegrationResourcePropertyOutcomeCallable UpdateIntegrationResourcePropertyCallable(
      const UpdateIntegrationResourcePropertyRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateIntegrationResourceProperty, request);
  }

  /**
   * An Async wrapper for UpdateIntegrationResourceProperty that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateIntegrationResourcePropertyRequestT = Model::UpdateIntegrationResourcePropertyRequest>
  void UpdateIntegrationResourcePropertyAsync(const UpdateIntegrationResourcePropertyRequestT& request,
                                              const UpdateIntegrationResourcePropertyResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateIntegrationTablePropertiesOutcome UpdateIntegrationTableProperties(
      const Model::UpdateIntegrationTablePropertiesRequest& request) const;

  /**
   * A Callable wrapper for UpdateIntegrationTableProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateIntegrationTablePropertiesRequestT = Model::UpdateIntegrationTablePropertiesRequest>
  Model::UpdateIntegrationTablePropertiesOutcomeCallable UpdateIntegrationTablePropertiesCallable(
      const UpdateIntegrationTablePropertiesRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateIntegrationTableProperties, request);
  }

  /**
   * An Async wrapper for UpdateIntegrationTableProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateIntegrationTablePropertiesRequestT = Model::UpdateIntegrationTablePropertiesRequest>
  void UpdateIntegrationTablePropertiesAsync(const UpdateIntegrationTablePropertiesRequestT& request,
                                             const UpdateIntegrationTablePropertiesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateJobFromSourceControlOutcome UpdateJobFromSourceControl(
      const Model::UpdateJobFromSourceControlRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateJobFromSourceControl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateJobFromSourceControlRequestT = Model::UpdateJobFromSourceControlRequest>
  Model::UpdateJobFromSourceControlOutcomeCallable UpdateJobFromSourceControlCallable(
      const UpdateJobFromSourceControlRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::UpdateJobFromSourceControl, request);
  }

  /**
   * An Async wrapper for UpdateJobFromSourceControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateJobFromSourceControlRequestT = Model::UpdateJobFromSourceControlRequest>
  void UpdateJobFromSourceControlAsync(const UpdateJobFromSourceControlResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const UpdateJobFromSourceControlRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateMLTransform that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMLTransform that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateMLTransformRequestT = Model::UpdateMLTransformRequest>
  void UpdateMLTransformAsync(const UpdateMLTransformRequestT& request, const UpdateMLTransformResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdatePartition that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdatePartitionRequestT = Model::UpdatePartitionRequest>
  void UpdatePartitionAsync(const UpdatePartitionRequestT& request, const UpdatePartitionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSchema that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSchemaRequestT = Model::UpdateSchemaRequest>
  void UpdateSchemaAsync(const UpdateSchemaRequestT& request, const UpdateSchemaResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSourceControlFromJobOutcome UpdateSourceControlFromJob(
      const Model::UpdateSourceControlFromJobRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateSourceControlFromJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSourceControlFromJobRequestT = Model::UpdateSourceControlFromJobRequest>
  Model::UpdateSourceControlFromJobOutcomeCallable UpdateSourceControlFromJobCallable(
      const UpdateSourceControlFromJobRequestT& request = {}) const {
    return SubmitCallable(&GlueClient::UpdateSourceControlFromJob, request);
  }

  /**
   * An Async wrapper for UpdateSourceControlFromJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSourceControlFromJobRequestT = Model::UpdateSourceControlFromJobRequest>
  void UpdateSourceControlFromJobAsync(const UpdateSourceControlFromJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const UpdateSourceControlFromJobRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for UpdateTable that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTableRequestT = Model::UpdateTableRequest>
  void UpdateTableAsync(const UpdateTableRequestT& request, const UpdateTableResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTableOptimizer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTableOptimizer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTableOptimizerRequestT = Model::UpdateTableOptimizerRequest>
  void UpdateTableOptimizerAsync(const UpdateTableOptimizerRequestT& request, const UpdateTableOptimizerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUsageProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUsageProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateUsageProfileRequestT = Model::UpdateUsageProfileRequest>
  void UpdateUsageProfileAsync(const UpdateUsageProfileRequestT& request, const UpdateUsageProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUserDefinedFunction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateUserDefinedFunctionRequestT = Model::UpdateUserDefinedFunctionRequest>
  Model::UpdateUserDefinedFunctionOutcomeCallable UpdateUserDefinedFunctionCallable(
      const UpdateUserDefinedFunctionRequestT& request) const {
    return SubmitCallable(&GlueClient::UpdateUserDefinedFunction, request);
  }

  /**
   * An Async wrapper for UpdateUserDefinedFunction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateUserDefinedFunctionRequestT = Model::UpdateUserDefinedFunctionRequest>
  void UpdateUserDefinedFunctionAsync(const UpdateUserDefinedFunctionRequestT& request,
                                      const UpdateUserDefinedFunctionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
