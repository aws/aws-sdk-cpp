...
class S3DeltaCatalogTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  S3DeltaCatalogTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  S3DeltaCatalogTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  S3DeltaCatalogTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  void SetPartitionKeys(PartitionKeysT&& value) {
    ...
    m_partitionKeys = std::forward<PartitionKeysT>(value);
  }
  template <typename PartitionKeysT = Aws::Vector<Aws::Vector<Aws::String>>>
  S3DeltaCatalogTarget& WithPartitionKeys(PartitionKeysT&& value) {
    SetPartitionKeys(std::forward<PartitionKeysT>(value));
    return *this;
  }
  template <typename PartitionKeysT = Aws::Vector<Aws::String>>
  S3DeltaCatalogTarget& AddPartitionKeys(PartitionKeysT&& value) {
    m_partitionKeysHasBeenSet = true;
    m_partitionKeys.emplace_back(std::forward<PartitionKeysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TableT = Aws::String>
  S3DeltaCatalogTarget& WithTable(TableT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  S3DeltaCatalogTarget& WithDatabase(DatabaseT&& value) {
  ...
  template <typename AdditionalOptionsT = Aws::Map<Aws::String, Aws::String>>
  S3DeltaCatalogTarget& WithAdditionalOptions(AdditionalOptionsT&& value) {
  ...
  S3DeltaCatalogTarget& AddAdditionalOptions(AdditionalOptionsKeyT&& key, AdditionalOptionsValueT&& value) {
    m_additionalOptionsHasBeenSet = true;
    m_additionalOptions.emplace(std::forward<AdditionalOptionsKeyT>(key), std::forward<AdditionalOptionsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchemaChangePolicy(SchemaChangePolicyT&& value) {
    ...
    m_schemaChangePolicy = std::forward<SchemaChangePolicyT>(value);
  }
  template <typename SchemaChangePolicyT = CatalogSchemaChangePolicy>
  S3DeltaCatalogTarget& WithSchemaChangePolicy(SchemaChangePolicyT&& value) {
    SetSchemaChangePolicy(std::forward<SchemaChangePolicyT>(value));
    return *this;
  }
  ///@}
   ...
   * Delta catalog target. When set to <code>true</code>, data quality checks are
  ...
  void SetAutoDataQuality(AutoDataQualityT&& value) {
    ...
    m_autoDataQuality = std::forward<AutoDataQualityT>(value);
  }
  template <typename AutoDataQualityT = AutoDataQuality>
  S3DeltaCatalogTarget& WithAutoDataQuality(AutoDataQualityT&& value) {
    SetAutoDataQuality(std::forward<AutoDataQualityT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutputSchemasT = Aws::Vector<GlueSchema>>
  S3DeltaCatalogTarget& WithOutputSchemas(OutputSchemasT&& value) {
    SetOutputSchemas(std::forward<OutputSchemasT>(value));
    return *this;
  }
  template <typename OutputSchemasT = GlueSchema>
  S3DeltaCatalogTarget& AddOutputSchemas(OutputSchemasT&& value) {
    m_outputSchemasHasBeenSet = true;
