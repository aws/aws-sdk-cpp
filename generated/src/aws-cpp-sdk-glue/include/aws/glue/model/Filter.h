...
class Filter {
 public:
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  Filter& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  Filter& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  inline Filter& WithLogicalOperator(FilterLogicalOperator value) {
  ...
  template <typename FiltersT = Aws::Vector<FilterExpression>>
  Filter& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = FilterExpression>
  Filter& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
