...
class TargetTableConfig {
 public:
  ...
  inline void SetUnnestSpec(UnnestSpec value) {
    m_unnestSpecHasBeenSet = true;
    m_unnestSpec = value;
  }
  inline TargetTableConfig& WithUnnestSpec(UnnestSpec value) {
    SetUnnestSpec(value);
    return *this;
  }
  ///@}
  ...
  TargetTableConfig& AddPartitionSpec(PartitionSpecT&& value) {
    m_partitionSpecHasBeenSet = true;
    m_partitionSpec.emplace_back(std::forward<PartitionSpecT>(value));
    return *this;
  }
  ///@}
