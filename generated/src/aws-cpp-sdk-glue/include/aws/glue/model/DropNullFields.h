...
class DropNullFields {
 public:
  ...
  void SetNullCheckBoxList(NullCheckBoxListT&& value) {
    ...
    m_nullCheckBoxList = std::forward<NullCheckBoxListT>(value);
  }
  template <typename NullCheckBoxListT = NullCheckBoxList>
  DropNullFields& WithNullCheckBoxList(NullCheckBoxListT&& value) {
    SetNullCheckBoxList(std::forward<NullCheckBoxListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNullTextList(NullTextListT&& value) {
    ...
    m_nullTextList = std::forward<NullTextListT>(value);
  }
  template <typename NullTextListT = Aws::Vector<NullValueField>>
  DropNullFields& WithNullTextList(NullTextListT&& value) {
    SetNullTextList(std::forward<NullTextListT>(value));
    return *this;
  }
  template <typename NullTextListT = NullValueField>
  DropNullFields& AddNullTextList(NullTextListT&& value) {
    m_nullTextListHasBeenSet = true;
    m_nullTextList.emplace_back(std::forward<NullTextListT>(value));
    return *this;
  }
  ///@}
 private:
