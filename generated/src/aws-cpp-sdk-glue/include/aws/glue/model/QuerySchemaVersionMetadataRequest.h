...
class QuerySchemaVersionMetadataRequest : public GlueRequest {
 public:
  ...
  template <typename SchemaIdT = SchemaId>
  QuerySchemaVersionMetadataRequest& WithSchemaId(SchemaIdT&& value) {
  ...
  template <typename SchemaVersionNumberT = SchemaVersionNumber>
  QuerySchemaVersionMetadataRequest& WithSchemaVersionNumber(SchemaVersionNumberT&& value) {
  ...
  template <typename SchemaVersionIdT = Aws::String>
  QuerySchemaVersionMetadataRequest& WithSchemaVersionId(SchemaVersionIdT&& value) {
  ...
  template <typename MetadataListT = Aws::Vector<MetadataKeyValuePair>>
  QuerySchemaVersionMetadataRequest& WithMetadataList(MetadataListT&& value) {
    SetMetadataList(std::forward<MetadataListT>(value));
    return *this;
  }
  template <typename MetadataListT = MetadataKeyValuePair>
  QuerySchemaVersionMetadataRequest& AddMetadataList(MetadataListT&& value) {
    m_metadataListHasBeenSet = true;
  ...
  inline QuerySchemaVersionMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  QuerySchemaVersionMetadataRequest& WithNextToken(NextTokenT&& value) {
