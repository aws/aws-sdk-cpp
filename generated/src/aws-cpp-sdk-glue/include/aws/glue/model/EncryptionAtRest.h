...
class EncryptionAtRest {
 public:
  ...
  inline void SetCatalogEncryptionMode(CatalogEncryptionMode value) {
    m_catalogEncryptionModeHasBeenSet = true;
    m_catalogEncryptionMode = value;
  }
  inline EncryptionAtRest& WithCatalogEncryptionMode(CatalogEncryptionMode value) {
    SetCatalogEncryptionMode(value);
    return *this;
  }
  ///@}
  ...
  void SetCatalogEncryptionServiceRole(CatalogEncryptionServiceRoleT&& value) {
    ...
    m_catalogEncryptionServiceRole = std::forward<CatalogEncryptionServiceRoleT>(value);
  }
  template <typename CatalogEncryptionServiceRoleT = Aws::String>
  EncryptionAtRest& WithCatalogEncryptionServiceRole(CatalogEncryptionServiceRoleT&& value) {
    SetCatalogEncryptionServiceRole(std::forward<CatalogEncryptionServiceRoleT>(value));
    return *this;
  }
  ///@}
 private:
