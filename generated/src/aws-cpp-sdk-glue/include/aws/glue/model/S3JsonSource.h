...
class S3JsonSource {
 public:
  ...
  inline S3JsonSource& WithCompressionType(CompressionType value) {
  ...
  inline S3JsonSource& WithRecurse(bool value) {
    SetRecurse(value);
    return *this;
  }
  ///@}
  ...
  inline S3JsonSource& WithMaxBand(int value) {
    SetMaxBand(value);
    return *this;
  }
  ///@}
  ...
  inline S3JsonSource& WithMaxFilesInBand(int value) {
  ...
  inline S3JsonSource& WithMultiline(bool value) {
    SetMultiline(value);
    return *this;
  }
  ///@}
