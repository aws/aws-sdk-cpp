...
class S3DeltaDirectTarget {
 public:
  ...
  inline void SetCompression(DeltaTargetCompressionType value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline S3DeltaDirectTarget& WithCompression(DeltaTargetCompressionType value) {
  ...
  inline S3DeltaDirectTarget& WithFormat(TargetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
   ...
   * Delta direct target. When set to <code>true</code>, data quality checks are
