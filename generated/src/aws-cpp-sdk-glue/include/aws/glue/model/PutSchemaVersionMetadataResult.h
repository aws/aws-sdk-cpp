...
namespace Model
{
  ...
  public:
    ...
    template<typename SchemaArnT = Aws::String>
    PutSchemaVersionMetadataResult& WithSchemaArn(SchemaArnT&& value) { SetSchemaArn(std::forward<SchemaArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaNameT = Aws::String>
    PutSchemaVersionMetadataResult& WithSchemaName(SchemaNameT&& value) { SetSchemaName(std::forward<SchemaNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegistryNameT = Aws::String>
    PutSchemaVersionMetadataResult& WithRegistryName(RegistryNameT&& value) { SetRegistryName(std::forward<RegistryNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaVersionIdT = Aws::String>
    PutSchemaVersionMetadataResult& WithSchemaVersionId(SchemaVersionIdT&& value) { SetSchemaVersionId(std::forward<SchemaVersionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataKeyT = Aws::String>
    PutSchemaVersionMetadataResult& WithMetadataKey(MetadataKeyT&& value) { SetMetadataKey(std::forward<MetadataKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataValueT = Aws::String>
    PutSchemaVersionMetadataResult& WithMetadataValue(MetadataValueT&& value) { SetMetadataValue(std::forward<MetadataValueT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutSchemaVersionMetadataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
