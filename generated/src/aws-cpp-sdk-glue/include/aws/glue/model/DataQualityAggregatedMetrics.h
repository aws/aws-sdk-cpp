...
class DataQualityAggregatedMetrics {
 public:
  ...
  inline void SetTotalRowsProcessed(double value) {
    m_totalRowsProcessedHasBeenSet = true;
    m_totalRowsProcessed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRowsProcessed(double value) {
    SetTotalRowsProcessed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRowsPassed(double value) {
    m_totalRowsPassedHasBeenSet = true;
    m_totalRowsPassed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRowsPassed(double value) {
    SetTotalRowsPassed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRowsFailed(double value) {
    m_totalRowsFailedHasBeenSet = true;
    m_totalRowsFailed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRowsFailed(double value) {
    SetTotalRowsFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRulesProcessed(double value) {
    m_totalRulesProcessedHasBeenSet = true;
    m_totalRulesProcessed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRulesProcessed(double value) {
    SetTotalRulesProcessed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRulesPassed(double value) {
    m_totalRulesPassedHasBeenSet = true;
    m_totalRulesPassed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRulesPassed(double value) {
    SetTotalRulesPassed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalRulesFailed(double value) {
    m_totalRulesFailedHasBeenSet = true;
    m_totalRulesFailed = value;
  }
  inline DataQualityAggregatedMetrics& WithTotalRulesFailed(double value) {
    SetTotalRulesFailed(value);
    return *this;
  }
  ///@}
 private:
