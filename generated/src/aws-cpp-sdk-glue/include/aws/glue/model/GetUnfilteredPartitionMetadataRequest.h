...
class GetUnfilteredPartitionMetadataRequest : public GlueRequest {
 public:
  ...
  template <typename RegionT = Aws::String>
  GetUnfilteredPartitionMetadataRequest& WithRegion(RegionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetUnfilteredPartitionMetadataRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetUnfilteredPartitionMetadataRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  GetUnfilteredPartitionMetadataRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename PartitionValuesT = Aws::Vector<Aws::String>>
  GetUnfilteredPartitionMetadataRequest& WithPartitionValues(PartitionValuesT&& value) {
    SetPartitionValues(std::forward<PartitionValuesT>(value));
    return *this;
  }
  template <typename PartitionValuesT = Aws::String>
  GetUnfilteredPartitionMetadataRequest& AddPartitionValues(PartitionValuesT&& value) {
    m_partitionValuesHasBeenSet = true;
  ...
  template <typename AuditContextT = AuditContext>
  GetUnfilteredPartitionMetadataRequest& WithAuditContext(AuditContextT&& value) {
  ...
  template <typename SupportedPermissionTypesT = Aws::Vector<PermissionType>>
  GetUnfilteredPartitionMetadataRequest& WithSupportedPermissionTypes(SupportedPermissionTypesT&& value) {
    SetSupportedPermissionTypes(std::forward<SupportedPermissionTypesT>(value));
    return *this;
  }
  inline GetUnfilteredPartitionMetadataRequest& AddSupportedPermissionTypes(PermissionType value) {
    m_supportedPermissionTypesHasBeenSet = true;
  ...
  template <typename QuerySessionContextT = QuerySessionContext>
  GetUnfilteredPartitionMetadataRequest& WithQuerySessionContext(QuerySessionContextT&& value) {
