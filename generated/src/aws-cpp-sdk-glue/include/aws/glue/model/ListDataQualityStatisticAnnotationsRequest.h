...
class ListDataQualityStatisticAnnotationsRequest : public GlueRequest {
 public:
  ...
  template <typename StatisticIdT = Aws::String>
  ListDataQualityStatisticAnnotationsRequest& WithStatisticId(StatisticIdT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  ListDataQualityStatisticAnnotationsRequest& WithProfileId(ProfileIdT&& value) {
  ...
  template <typename TimestampFilterT = TimestampFilter>
  ListDataQualityStatisticAnnotationsRequest& WithTimestampFilter(TimestampFilterT&& value) {
  ...
  inline ListDataQualityStatisticAnnotationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityStatisticAnnotationsRequest& WithNextToken(NextTokenT&& value) {
