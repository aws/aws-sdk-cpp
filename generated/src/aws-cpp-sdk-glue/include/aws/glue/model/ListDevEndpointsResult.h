...
class ListDevEndpointsResult {
 public:
  ...
  void SetDevEndpointNames(DevEndpointNamesT&& value) {
    ...
    m_devEndpointNames = std::forward<DevEndpointNamesT>(value);
  }
  template <typename DevEndpointNamesT = Aws::Vector<Aws::String>>
  ListDevEndpointsResult& WithDevEndpointNames(DevEndpointNamesT&& value) {
    SetDevEndpointNames(std::forward<DevEndpointNamesT>(value));
    return *this;
  }
  template <typename DevEndpointNamesT = Aws::String>
  ListDevEndpointsResult& AddDevEndpointNames(DevEndpointNamesT&& value) {
    m_devEndpointNamesHasBeenSet = true;
    m_devEndpointNames.emplace_back(std::forward<DevEndpointNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDevEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDevEndpointsResult& WithRequestId(RequestIdT&& value) {
