...
class GetUserDefinedFunctionRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  GetUserDefinedFunctionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetUserDefinedFunctionRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename FunctionNameT = Aws::String>
  GetUserDefinedFunctionRequest& WithFunctionName(FunctionNameT&& value) {
