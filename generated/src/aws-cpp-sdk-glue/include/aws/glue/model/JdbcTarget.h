...
class JdbcTarget {
 public:
  ...
  void SetEnableAdditionalMetadata(EnableAdditionalMetadataT&& value) {
    ...
    m_enableAdditionalMetadata = std::forward<EnableAdditionalMetadataT>(value);
  }
  template <typename EnableAdditionalMetadataT = Aws::Vector<JdbcMetadataEntry>>
  JdbcTarget& WithEnableAdditionalMetadata(EnableAdditionalMetadataT&& value) {
    SetEnableAdditionalMetadata(std::forward<EnableAdditionalMetadataT>(value));
    return *this;
  }
  inline JdbcTarget& AddEnableAdditionalMetadata(JdbcMetadataEntry value) {
    m_enableAdditionalMetadataHasBeenSet = true;
    m_enableAdditionalMetadata.push_back(value);
    return *this;
  }
  ///@}
 private:
