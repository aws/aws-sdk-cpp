...
class S3ExcelSource {
 public:
  ...
  inline S3ExcelSource& WithCompressionType(ParquetCompressionType value) {
  ...
  inline S3ExcelSource& WithRecurse(bool value) {
    SetRecurse(value);
    return *this;
  }
  ///@}
  ...
  inline S3ExcelSource& WithMaxBand(int value) {
    SetMaxBand(value);
    return *this;
  }
  ///@}
  ...
  inline S3ExcelSource& WithMaxFilesInBand(int value) {
  ...
  inline void SetNumberRows(long long value) {
    m_numberRowsHasBeenSet = true;
    m_numberRows = value;
  }
  inline S3ExcelSource& WithNumberRows(long long value) {
    SetNumberRows(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkipFooter(int value) {
    m_skipFooterHasBeenSet = true;
    m_skipFooter = value;
  }
  inline S3ExcelSource& WithSkipFooter(int value) {
    SetSkipFooter(value);
    return *this;
  }
  ///@}
