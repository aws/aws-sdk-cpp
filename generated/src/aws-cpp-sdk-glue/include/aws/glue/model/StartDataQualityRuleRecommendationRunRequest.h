...
class StartDataQualityRuleRecommendationRunRequest : public GlueRequest {
 public:
  ...
  template <typename DataSourceT = DataSource>
  StartDataQualityRuleRecommendationRunRequest& WithDataSource(DataSourceT&& value) {
  ...
  template <typename RoleT = Aws::String>
  StartDataQualityRuleRecommendationRunRequest& WithRole(RoleT&& value) {
  ...
  inline StartDataQualityRuleRecommendationRunRequest& WithNumberOfWorkers(int value) {
  ...
  inline StartDataQualityRuleRecommendationRunRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedRulesetNameT = Aws::String>
  StartDataQualityRuleRecommendationRunRequest& WithCreatedRulesetName(CreatedRulesetNameT&& value) {
  ...
  void SetDataQualitySecurityConfiguration(DataQualitySecurityConfigurationT&& value) {
    ...
    m_dataQualitySecurityConfiguration = std::forward<DataQualitySecurityConfigurationT>(value);
  }
  template <typename DataQualitySecurityConfigurationT = Aws::String>
  StartDataQualityRuleRecommendationRunRequest& WithDataQualitySecurityConfiguration(DataQualitySecurityConfigurationT&& value) {
    SetDataQualitySecurityConfiguration(std::forward<DataQualitySecurityConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  StartDataQualityRuleRecommendationRunRequest& WithClientToken(ClientTokenT&& value) {
