...
class Crawler {
 public:
  ...
  inline void SetState(CrawlerState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Crawler& WithState(CrawlerState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlElapsedTime(long long value) {
    m_crawlElapsedTimeHasBeenSet = true;
    m_crawlElapsedTime = value;
  }
  inline Crawler& WithCrawlElapsedTime(long long value) {
    SetCrawlElapsedTime(value);
    return *this;
  }
  ///@}
  ...
  void SetLastCrawl(LastCrawlT&& value) {
    ...
    m_lastCrawl = std::forward<LastCrawlT>(value);
  }
  template <typename LastCrawlT = LastCrawlInfo>
  Crawler& WithLastCrawl(LastCrawlT&& value) {
    SetLastCrawl(std::forward<LastCrawlT>(value));
    return *this;
  }
  ///@}
  ...
  inline Crawler& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
