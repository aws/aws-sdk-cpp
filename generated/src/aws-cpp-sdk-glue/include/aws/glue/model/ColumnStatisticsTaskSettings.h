...
class ColumnStatisticsTaskSettings {
 public:
  ...
  inline ColumnStatisticsTaskSettings& WithSampleSize(double value) {
    SetSampleSize(value);
    return *this;
  }
  ///@}
  ...
  inline ColumnStatisticsTaskSettings& WithScheduleType(ScheduleType value) {
  ...
  inline void SetSettingSource(SettingSource value) {
    m_settingSourceHasBeenSet = true;
    m_settingSource = value;
  }
  inline ColumnStatisticsTaskSettings& WithSettingSource(SettingSource value) {
    SetSettingSource(value);
    return *this;
  }
  ///@}
  ...
  void SetLastExecutionAttempt(LastExecutionAttemptT&& value) {
    ...
    m_lastExecutionAttempt = std::forward<LastExecutionAttemptT>(value);
  }
  template <typename LastExecutionAttemptT = ExecutionAttempt>
  ColumnStatisticsTaskSettings& WithLastExecutionAttempt(LastExecutionAttemptT&& value) {
    SetLastExecutionAttempt(std::forward<LastExecutionAttemptT>(value));
    return *this;
  }
  ///@}
 private:
