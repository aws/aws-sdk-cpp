...
class DescribeInboundIntegrationsResult {
 public:
  ...
  void SetInboundIntegrations(InboundIntegrationsT&& value) {
    ...
    m_inboundIntegrations = std::forward<InboundIntegrationsT>(value);
  }
  template <typename InboundIntegrationsT = Aws::Vector<InboundIntegration>>
  DescribeInboundIntegrationsResult& WithInboundIntegrations(InboundIntegrationsT&& value) {
    SetInboundIntegrations(std::forward<InboundIntegrationsT>(value));
    return *this;
  }
  ...
  DescribeInboundIntegrationsResult& AddInboundIntegrations(InboundIntegrationsT&& value) {
    m_inboundIntegrationsHasBeenSet = true;
    m_inboundIntegrations.emplace_back(std::forward<InboundIntegrationsT>(value));
    return *this;
  }
  ///@}
