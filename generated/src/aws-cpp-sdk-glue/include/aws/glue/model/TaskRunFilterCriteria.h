...
class TaskRunFilterCriteria {
 public:
  ...
  inline void SetTaskRunType(TaskType value) {
    m_taskRunTypeHasBeenSet = true;
    m_taskRunType = value;
  }
  inline TaskRunFilterCriteria& WithTaskRunType(TaskType value) {
    SetTaskRunType(value);
    return *this;
  }
  ///@}
  ...
  inline TaskRunFilterCriteria& WithStatus(TaskStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartedBeforeT = Aws::Utils::DateTime>
  TaskRunFilterCriteria& WithStartedBefore(StartedBeforeT&& value) {
  ...
  template <typename StartedAfterT = Aws::Utils::DateTime>
  TaskRunFilterCriteria& WithStartedAfter(StartedAfterT&& value) {
