...
class Condition {
 public:
  ...
  inline void SetLogicalOperator(LogicalOperator value) {
    m_logicalOperatorHasBeenSet = true;
    m_logicalOperator = value;
  }
  inline Condition& WithLogicalOperator(LogicalOperator value) {
  ...
  inline Condition& WithState(JobRunState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrawlState(CrawlState value) {
    m_crawlStateHasBeenSet = true;
    m_crawlState = value;
  }
  inline Condition& WithCrawlState(CrawlState value) {
    SetCrawlState(value);
    return *this;
  }
  ///@}
