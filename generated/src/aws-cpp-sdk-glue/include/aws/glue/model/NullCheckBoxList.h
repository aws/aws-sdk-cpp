...
class NullCheckBoxList {
 public:
  ...
  inline NullCheckBoxList& WithIsEmpty(bool value) {
    SetIsEmpty(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsNullString(bool value) {
    m_isNullStringHasBeenSet = true;
    m_isNullString = value;
  }
  inline NullCheckBoxList& WithIsNullString(bool value) {
    SetIsNullString(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsNegOne(bool value) {
    m_isNegOneHasBeenSet = true;
    m_isNegOne = value;
  }
  inline NullCheckBoxList& WithIsNegOne(bool value) {
    SetIsNegOne(value);
    return *this;
  }
  ///@}
