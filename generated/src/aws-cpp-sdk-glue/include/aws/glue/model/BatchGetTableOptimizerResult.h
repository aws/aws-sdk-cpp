...
class BatchGetTableOptimizerResult {
 public:
  ...
  void SetTableOptimizers(TableOptimizersT&& value) {
    m_tableOptimizersHasBeenSet = true;
    m_tableOptimizers = std::forward<TableOptimizersT>(value);
  }
  template <typename TableOptimizersT = Aws::Vector<BatchTableOptimizer>>
  BatchGetTableOptimizerResult& WithTableOptimizers(TableOptimizersT&& value) {
    SetTableOptimizers(std::forward<TableOptimizersT>(value));
    return *this;
  }
  ...
  BatchGetTableOptimizerResult& AddTableOptimizers(TableOptimizersT&& value) {
    m_tableOptimizersHasBeenSet = true;
    m_tableOptimizers.emplace_back(std::forward<TableOptimizersT>(value));
    return *this;
  }
  ///@}
