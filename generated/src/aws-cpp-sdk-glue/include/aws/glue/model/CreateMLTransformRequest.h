...
class CreateMLTransformRequest : public GlueRequest {
 public:
  ...
  inline CreateMLTransformRequest& WithMaxCapacity(double value) {
  ...
  inline CreateMLTransformRequest& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMLTransformRequest& WithNumberOfWorkers(int value) {
  ...
  inline CreateMLTransformRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMLTransformRequest& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
