...
class DataLakePrincipal {
 public:
  ...
  void SetDataLakePrincipalIdentifier(DataLakePrincipalIdentifierT&& value) {
    m_dataLakePrincipalIdentifierHasBeenSet = true;
    m_dataLakePrincipalIdentifier = std::forward<DataLakePrincipalIdentifierT>(value);
  }
  template <typename DataLakePrincipalIdentifierT = Aws::String>
  DataLakePrincipal& WithDataLakePrincipalIdentifier(DataLakePrincipalIdentifierT&& value) {
    SetDataLakePrincipalIdentifier(std::forward<DataLakePrincipalIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
