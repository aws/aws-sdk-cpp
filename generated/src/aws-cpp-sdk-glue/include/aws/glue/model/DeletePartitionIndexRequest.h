...
class DeletePartitionIndexRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  DeletePartitionIndexRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeletePartitionIndexRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DeletePartitionIndexRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename IndexNameT = Aws::String>
  DeletePartitionIndexRequest& WithIndexName(IndexNameT&& value) {
