...
class CatalogIcebergSource {
 public:
  ...
  void SetAdditionalIcebergOptions(AdditionalIcebergOptionsT&& value) {
    ...
    m_additionalIcebergOptions = std::forward<AdditionalIcebergOptionsT>(value);
  }
  template <typename AdditionalIcebergOptionsT = Aws::Map<Aws::String, Aws::String>>
  CatalogIcebergSource& WithAdditionalIcebergOptions(AdditionalIcebergOptionsT&& value) {
    SetAdditionalIcebergOptions(std::forward<AdditionalIcebergOptionsT>(value));
    return *this;
  }
  ...
  CatalogIcebergSource& AddAdditionalIcebergOptions(AdditionalIcebergOptionsKeyT&& key, AdditionalIcebergOptionsValueT&& value) {
    m_additionalIcebergOptionsHasBeenSet = true;
    m_additionalIcebergOptions.emplace(std::forward<AdditionalIcebergOptionsKeyT>(key),
                                       std::forward<AdditionalIcebergOptionsValueT>(value));
    return *this;
  }
  ///@}
