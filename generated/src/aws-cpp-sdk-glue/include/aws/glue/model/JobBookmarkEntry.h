...
class JobBookmarkEntry {
 public:
  ...
  inline JobBookmarkEntry& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline JobBookmarkEntry& WithRun(int value) {
    SetRun(value);
    return *this;
  }
  ///@}
  ...
  inline JobBookmarkEntry& WithAttempt(int value) {
    SetAttempt(value);
    return *this;
  }
  ///@}
  ...
  void SetJobBookmark(JobBookmarkT&& value) {
    ...
    m_jobBookmark = std::forward<JobBookmarkT>(value);
  }
  template <typename JobBookmarkT = Aws::String>
  JobBookmarkEntry& WithJobBookmark(JobBookmarkT&& value) {
    SetJobBookmark(std::forward<JobBookmarkT>(value));
    return *this;
  }
  ///@}
 private:
