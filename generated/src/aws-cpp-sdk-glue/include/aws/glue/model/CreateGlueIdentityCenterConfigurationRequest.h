...
class CreateGlueIdentityCenterConfigurationRequest : public GlueRequest {
 public:
  ...
  template <typename InstanceArnT = Aws::String>
  CreateGlueIdentityCenterConfigurationRequest& WithInstanceArn(InstanceArnT&& value) {
  ...
  template <typename ScopesT = Aws::Vector<Aws::String>>
  CreateGlueIdentityCenterConfigurationRequest& WithScopes(ScopesT&& value) {
    SetScopes(std::forward<ScopesT>(value));
    return *this;
  }
  template <typename ScopesT = Aws::String>
  CreateGlueIdentityCenterConfigurationRequest& AddScopes(ScopesT&& value) {
    m_scopesHasBeenSet = true;
  ...
  inline CreateGlueIdentityCenterConfigurationRequest& WithUserBackgroundSessionsEnabled(bool value) {
