...
class TableOptimizerConfiguration {
 public:
  ...
  inline TableOptimizerConfiguration& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCompactionConfiguration(CompactionConfigurationT&& value) {
    ...
    m_compactionConfiguration = std::forward<CompactionConfigurationT>(value);
  }
  template <typename CompactionConfigurationT = CompactionConfiguration>
  TableOptimizerConfiguration& WithCompactionConfiguration(CompactionConfigurationT&& value) {
    SetCompactionConfiguration(std::forward<CompactionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetentionConfiguration(RetentionConfigurationT&& value) {
    ...
    m_retentionConfiguration = std::forward<RetentionConfigurationT>(value);
  }
  template <typename RetentionConfigurationT = RetentionConfiguration>
  TableOptimizerConfiguration& WithRetentionConfiguration(RetentionConfigurationT&& value) {
    SetRetentionConfiguration(std::forward<RetentionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrphanFileDeletionConfiguration(OrphanFileDeletionConfigurationT&& value) {
    ...
    m_orphanFileDeletionConfiguration = std::forward<OrphanFileDeletionConfigurationT>(value);
  }
  template <typename OrphanFileDeletionConfigurationT = OrphanFileDeletionConfiguration>
  TableOptimizerConfiguration& WithOrphanFileDeletionConfiguration(OrphanFileDeletionConfigurationT&& value) {
    SetOrphanFileDeletionConfiguration(std::forward<OrphanFileDeletionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
