...
class FilterExpression {
 public:
  ...
  inline void SetOperation(FilterOperation value) {
    m_operationHasBeenSet = true;
    m_operation = value;
  }
  inline FilterExpression& WithOperation(FilterOperation value) {
    SetOperation(value);
    return *this;
  }
  ///@}
  ...
  inline FilterExpression& WithNegated(bool value) {
    SetNegated(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<FilterValue>>
  FilterExpression& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = FilterValue>
  FilterExpression& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
