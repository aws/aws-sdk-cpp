...
class MySQLCatalogTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  MySQLCatalogTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  MySQLCatalogTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  MySQLCatalogTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename DatabaseT = Aws::String>
  MySQLCatalogTarget& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  MySQLCatalogTarget& WithTable(TableT&& value) {
