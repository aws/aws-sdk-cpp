...
class ExecutionAttempt {
 public:
  ...
  inline ExecutionAttempt& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetColumnStatisticsTaskRunId(ColumnStatisticsTaskRunIdT&& value) {
    ...
    m_columnStatisticsTaskRunId = std::forward<ColumnStatisticsTaskRunIdT>(value);
  }
  template <typename ColumnStatisticsTaskRunIdT = Aws::String>
  ExecutionAttempt& WithColumnStatisticsTaskRunId(ColumnStatisticsTaskRunIdT&& value) {
    SetColumnStatisticsTaskRunId(std::forward<ColumnStatisticsTaskRunIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecutionTimestamp(ExecutionTimestampT&& value) {
    ...
    m_executionTimestamp = std::forward<ExecutionTimestampT>(value);
  }
  template <typename ExecutionTimestampT = Aws::Utils::DateTime>
  ExecutionAttempt& WithExecutionTimestamp(ExecutionTimestampT&& value) {
    SetExecutionTimestamp(std::forward<ExecutionTimestampT>(value));
    return *this;
  }
  ///@}
