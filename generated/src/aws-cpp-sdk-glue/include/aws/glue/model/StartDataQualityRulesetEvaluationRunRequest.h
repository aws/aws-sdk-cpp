...
class StartDataQualityRulesetEvaluationRunRequest : public GlueRequest {
 public:
  ...
  template <typename DataSourceT = DataSource>
  StartDataQualityRulesetEvaluationRunRequest& WithDataSource(DataSourceT&& value) {
  ...
  template <typename RoleT = Aws::String>
  StartDataQualityRulesetEvaluationRunRequest& WithRole(RoleT&& value) {
  ...
  inline StartDataQualityRulesetEvaluationRunRequest& WithNumberOfWorkers(int value) {
  ...
  inline StartDataQualityRulesetEvaluationRunRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  StartDataQualityRulesetEvaluationRunRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename AdditionalRunOptionsT = DataQualityEvaluationRunAdditionalRunOptions>
  StartDataQualityRulesetEvaluationRunRequest& WithAdditionalRunOptions(AdditionalRunOptionsT&& value) {
  ...
  template <typename RulesetNamesT = Aws::Vector<Aws::String>>
  StartDataQualityRulesetEvaluationRunRequest& WithRulesetNames(RulesetNamesT&& value) {
    SetRulesetNames(std::forward<RulesetNamesT>(value));
    return *this;
  }
  template <typename RulesetNamesT = Aws::String>
  StartDataQualityRulesetEvaluationRunRequest& AddRulesetNames(RulesetNamesT&& value) {
    m_rulesetNamesHasBeenSet = true;
  ...
  template <typename AdditionalDataSourcesT = Aws::Map<Aws::String, DataSource>>
  StartDataQualityRulesetEvaluationRunRequest& WithAdditionalDataSources(AdditionalDataSourcesT&& value) {
  ...
  StartDataQualityRulesetEvaluationRunRequest& AddAdditionalDataSources(AdditionalDataSourcesKeyT&& key,
                                                                        AdditionalDataSourcesValueT&& value) {
    m_additionalDataSourcesHasBeenSet = true;
