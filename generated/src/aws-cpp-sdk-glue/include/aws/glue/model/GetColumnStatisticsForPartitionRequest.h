...
class GetColumnStatisticsForPartitionRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  GetColumnStatisticsForPartitionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetColumnStatisticsForPartitionRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  GetColumnStatisticsForPartitionRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename PartitionValuesT = Aws::Vector<Aws::String>>
  GetColumnStatisticsForPartitionRequest& WithPartitionValues(PartitionValuesT&& value) {
    SetPartitionValues(std::forward<PartitionValuesT>(value));
    return *this;
  }
  template <typename PartitionValuesT = Aws::String>
  GetColumnStatisticsForPartitionRequest& AddPartitionValues(PartitionValuesT&& value) {
    m_partitionValuesHasBeenSet = true;
  ...
  template <typename ColumnNamesT = Aws::Vector<Aws::String>>
  GetColumnStatisticsForPartitionRequest& WithColumnNames(ColumnNamesT&& value) {
    SetColumnNames(std::forward<ColumnNamesT>(value));
    return *this;
  }
  template <typename ColumnNamesT = Aws::String>
  GetColumnStatisticsForPartitionRequest& AddColumnNames(ColumnNamesT&& value) {
    m_columnNamesHasBeenSet = true;
