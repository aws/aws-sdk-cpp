...
class PartitionIndexDescriptor {
 public:
  ...
  inline void SetIndexStatus(PartitionIndexStatus value) {
    m_indexStatusHasBeenSet = true;
    m_indexStatus = value;
  }
  inline PartitionIndexDescriptor& WithIndexStatus(PartitionIndexStatus value) {
