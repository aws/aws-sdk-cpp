...
class Capabilities {
 public:
  ...
  inline Capabilities& AddSupportedAuthenticationTypes(AuthenticationType value) {
    m_supportedAuthenticationTypesHasBeenSet = true;
  ...
  void SetSupportedDataOperations(SupportedDataOperationsT&& value) {
    ...
    m_supportedDataOperations = std::forward<SupportedDataOperationsT>(value);
  }
  template <typename SupportedDataOperationsT = Aws::Vector<DataOperation>>
  Capabilities& WithSupportedDataOperations(SupportedDataOperationsT&& value) {
    SetSupportedDataOperations(std::forward<SupportedDataOperationsT>(value));
    return *this;
  }
  inline Capabilities& AddSupportedDataOperations(DataOperation value) {
    m_supportedDataOperationsHasBeenSet = true;
    m_supportedDataOperations.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedComputeEnvironments(SupportedComputeEnvironmentsT&& value) {
    ...
    m_supportedComputeEnvironments = std::forward<SupportedComputeEnvironmentsT>(value);
  }
  template <typename SupportedComputeEnvironmentsT = Aws::Vector<ComputeEnvironment>>
  Capabilities& WithSupportedComputeEnvironments(SupportedComputeEnvironmentsT&& value) {
    SetSupportedComputeEnvironments(std::forward<SupportedComputeEnvironmentsT>(value));
    return *this;
  }
  inline Capabilities& AddSupportedComputeEnvironments(ComputeEnvironment value) {
    m_supportedComputeEnvironmentsHasBeenSet = true;
    m_supportedComputeEnvironments.push_back(value);
    return *this;
  }
  ///@}
 private:
