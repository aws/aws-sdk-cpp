...
class StartingEventBatchCondition {
 public:
  ...
  inline StartingEventBatchCondition& WithBatchSize(int value) {
    SetBatchSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBatchWindow(int value) {
    m_batchWindowHasBeenSet = true;
    m_batchWindow = value;
  }
  inline StartingEventBatchCondition& WithBatchWindow(int value) {
    SetBatchWindow(value);
    return *this;
  }
  ///@}
 private:
