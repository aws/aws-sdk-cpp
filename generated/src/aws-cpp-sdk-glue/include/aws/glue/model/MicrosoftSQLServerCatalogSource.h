...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API MicrosoftSQLServerCatalogSource() = default;
    ...
    template<typename NameT = Aws::String>
    MicrosoftSQLServerCatalogSource& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    MicrosoftSQLServerCatalogSource& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
    ...
    template<typename TableT = Aws::String>
    MicrosoftSQLServerCatalogSource& WithTable(TableT&& value) { SetTable(std::forward<TableT>(value)); return *this;}
    ///@}
  private:
