...
class MicrosoftSQLServerCatalogSource {
 public:
  ...
  template <typename NameT = Aws::String>
  MicrosoftSQLServerCatalogSource& WithName(NameT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  MicrosoftSQLServerCatalogSource& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  MicrosoftSQLServerCatalogSource& WithTable(TableT&& value) {
