...
class TransformSortCriteria {
 public:
  ...
  inline void SetColumn(TransformSortColumnType value) {
    m_columnHasBeenSet = true;
    m_column = value;
  }
  inline TransformSortCriteria& WithColumn(TransformSortColumnType value) {
    SetColumn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortDirection(SortDirectionType value) {
    m_sortDirectionHasBeenSet = true;
    m_sortDirection = value;
  }
  inline TransformSortCriteria& WithSortDirection(SortDirectionType value) {
