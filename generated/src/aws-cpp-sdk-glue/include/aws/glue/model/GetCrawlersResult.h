...
class GetCrawlersResult {
 public:
  ...
  template <typename CrawlersT = Aws::Vector<Crawler>>
  GetCrawlersResult& WithCrawlers(CrawlersT&& value) {
    SetCrawlers(std::forward<CrawlersT>(value));
    return *this;
  }
  template <typename CrawlersT = Crawler>
  GetCrawlersResult& AddCrawlers(CrawlersT&& value) {
    m_crawlersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetCrawlersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCrawlersResult& WithRequestId(RequestIdT&& value) {
