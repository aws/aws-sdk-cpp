...
namespace Model
{
  ...
  public:
    ...
    inline ListDataQualityRulesetEvaluationRunsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListDataQualityRulesetEvaluationRunsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListDataQualityRulesetEvaluationRunsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
