...
class UpdateJobFromSourceControlRequest : public GlueRequest {
 public:
  ...
  inline void SetProvider(SourceControlProvider value) {
    m_providerHasBeenSet = true;
    m_provider = value;
  }
  inline UpdateJobFromSourceControlRequest& WithProvider(SourceControlProvider value) {
    SetProvider(value);
    return *this;
  }
  ///@}
  ...
  void SetRepositoryOwner(RepositoryOwnerT&& value) {
    m_repositoryOwnerHasBeenSet = true;
    m_repositoryOwner = std::forward<RepositoryOwnerT>(value);
  }
  template <typename RepositoryOwnerT = Aws::String>
  UpdateJobFromSourceControlRequest& WithRepositoryOwner(RepositoryOwnerT&& value) {
    SetRepositoryOwner(std::forward<RepositoryOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAuthStrategy(SourceControlAuthStrategy value) {
    m_authStrategyHasBeenSet = true;
    m_authStrategy = value;
  }
  inline UpdateJobFromSourceControlRequest& WithAuthStrategy(SourceControlAuthStrategy value) {
