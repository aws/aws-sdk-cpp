...
class Blueprint {
 public:
  ...
  void SetParameterSpec(ParameterSpecT&& value) {
    ...
    m_parameterSpec = std::forward<ParameterSpecT>(value);
  }
  template <typename ParameterSpecT = Aws::String>
  Blueprint& WithParameterSpec(ParameterSpecT&& value) {
    SetParameterSpec(std::forward<ParameterSpecT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBlueprintServiceLocation(BlueprintServiceLocationT&& value) {
    ...
    m_blueprintServiceLocation = std::forward<BlueprintServiceLocationT>(value);
  }
  template <typename BlueprintServiceLocationT = Aws::String>
  Blueprint& WithBlueprintServiceLocation(BlueprintServiceLocationT&& value) {
    SetBlueprintServiceLocation(std::forward<BlueprintServiceLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(BlueprintStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Blueprint& WithStatus(BlueprintStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastActiveDefinition(LastActiveDefinitionT&& value) {
    ...
    m_lastActiveDefinition = std::forward<LastActiveDefinitionT>(value);
  }
  template <typename LastActiveDefinitionT = LastActiveDefinition>
  Blueprint& WithLastActiveDefinition(LastActiveDefinitionT&& value) {
    SetLastActiveDefinition(std::forward<LastActiveDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
