...
class AmazonRedshiftNodeData {
 public:
  ...
  void SetAccessType(AccessTypeT&& value) {
    ...
    m_accessType = std::forward<AccessTypeT>(value);
  }
  template <typename AccessTypeT = Aws::String>
  AmazonRedshiftNodeData& WithAccessType(AccessTypeT&& value) {
    SetAccessType(std::forward<AccessTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogDatabase(CatalogDatabaseT&& value) {
    ...
    m_catalogDatabase = std::forward<CatalogDatabaseT>(value);
  }
  template <typename CatalogDatabaseT = Option>
  AmazonRedshiftNodeData& WithCatalogDatabase(CatalogDatabaseT&& value) {
    SetCatalogDatabase(std::forward<CatalogDatabaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogTable(CatalogTableT&& value) {
    ...
    m_catalogTable = std::forward<CatalogTableT>(value);
  }
  template <typename CatalogTableT = Option>
  AmazonRedshiftNodeData& WithCatalogTable(CatalogTableT&& value) {
    SetCatalogTable(std::forward<CatalogTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogRedshiftSchema(CatalogRedshiftSchemaT&& value) {
    ...
    m_catalogRedshiftSchema = std::forward<CatalogRedshiftSchemaT>(value);
  }
  template <typename CatalogRedshiftSchemaT = Aws::String>
  AmazonRedshiftNodeData& WithCatalogRedshiftSchema(CatalogRedshiftSchemaT&& value) {
    SetCatalogRedshiftSchema(std::forward<CatalogRedshiftSchemaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogRedshiftTable(CatalogRedshiftTableT&& value) {
    ...
    m_catalogRedshiftTable = std::forward<CatalogRedshiftTableT>(value);
  }
  template <typename CatalogRedshiftTableT = Aws::String>
  AmazonRedshiftNodeData& WithCatalogRedshiftTable(CatalogRedshiftTableT&& value) {
    SetCatalogRedshiftTable(std::forward<CatalogRedshiftTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTempDir(TempDirT&& value) {
    ...
    m_tempDir = std::forward<TempDirT>(value);
  }
  template <typename TempDirT = Aws::String>
  AmazonRedshiftNodeData& WithTempDir(TempDirT&& value) {
    SetTempDir(std::forward<TempDirT>(value));
    return *this;
  }
  ///@}
  ...
  AmazonRedshiftNodeData& AddAdvancedOptions(AdvancedOptionsT&& value) {
    m_advancedOptionsHasBeenSet = true;
    m_advancedOptions.emplace_back(std::forward<AdvancedOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSampleQuery(SampleQueryT&& value) {
    ...
    m_sampleQuery = std::forward<SampleQueryT>(value);
  }
  template <typename SampleQueryT = Aws::String>
  AmazonRedshiftNodeData& WithSampleQuery(SampleQueryT&& value) {
    SetSampleQuery(std::forward<SampleQueryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreAction(PreActionT&& value) {
    ...
    m_preAction = std::forward<PreActionT>(value);
  }
  template <typename PreActionT = Aws::String>
  AmazonRedshiftNodeData& WithPreAction(PreActionT&& value) {
    SetPreAction(std::forward<PreActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostAction(PostActionT&& value) {
    ...
    m_postAction = std::forward<PostActionT>(value);
  }
  template <typename PostActionT = Aws::String>
  AmazonRedshiftNodeData& WithPostAction(PostActionT&& value) {
    SetPostAction(std::forward<PostActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTablePrefix(TablePrefixT&& value) {
    ...
    m_tablePrefix = std::forward<TablePrefixT>(value);
  }
  template <typename TablePrefixT = Aws::String>
  AmazonRedshiftNodeData& WithTablePrefix(TablePrefixT&& value) {
    SetTablePrefix(std::forward<TablePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline AmazonRedshiftNodeData& WithUpsert(bool value) {
    SetUpsert(value);
    return *this;
  }
  ///@}
  ...
  void SetMergeAction(MergeActionT&& value) {
    ...
    m_mergeAction = std::forward<MergeActionT>(value);
  }
  template <typename MergeActionT = Aws::String>
  AmazonRedshiftNodeData& WithMergeAction(MergeActionT&& value) {
    SetMergeAction(std::forward<MergeActionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMergeWhenMatched(MergeWhenMatchedT&& value) {
    ...
    m_mergeWhenMatched = std::forward<MergeWhenMatchedT>(value);
  }
  template <typename MergeWhenMatchedT = Aws::String>
  AmazonRedshiftNodeData& WithMergeWhenMatched(MergeWhenMatchedT&& value) {
    SetMergeWhenMatched(std::forward<MergeWhenMatchedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMergeWhenNotMatched(MergeWhenNotMatchedT&& value) {
    ...
    m_mergeWhenNotMatched = std::forward<MergeWhenNotMatchedT>(value);
  }
  template <typename MergeWhenNotMatchedT = Aws::String>
  AmazonRedshiftNodeData& WithMergeWhenNotMatched(MergeWhenNotMatchedT&& value) {
    SetMergeWhenNotMatched(std::forward<MergeWhenNotMatchedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMergeClause(MergeClauseT&& value) {
    ...
    m_mergeClause = std::forward<MergeClauseT>(value);
  }
  template <typename MergeClauseT = Aws::String>
  AmazonRedshiftNodeData& WithMergeClause(MergeClauseT&& value) {
    SetMergeClause(std::forward<MergeClauseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrawlerConnection(CrawlerConnectionT&& value) {
    ...
    m_crawlerConnection = std::forward<CrawlerConnectionT>(value);
  }
  template <typename CrawlerConnectionT = Aws::String>
  AmazonRedshiftNodeData& WithCrawlerConnection(CrawlerConnectionT&& value) {
    SetCrawlerConnection(std::forward<CrawlerConnectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStagingTable(StagingTableT&& value) {
    ...
    m_stagingTable = std::forward<StagingTableT>(value);
  }
  template <typename StagingTableT = Aws::String>
  AmazonRedshiftNodeData& WithStagingTable(StagingTableT&& value) {
    SetStagingTable(std::forward<StagingTableT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectedColumns(SelectedColumnsT&& value) {
    ...
    m_selectedColumns = std::forward<SelectedColumnsT>(value);
  }
  template <typename SelectedColumnsT = Aws::Vector<Option>>
  AmazonRedshiftNodeData& WithSelectedColumns(SelectedColumnsT&& value) {
    SetSelectedColumns(std::forward<SelectedColumnsT>(value));
    return *this;
  }
  template <typename SelectedColumnsT = Option>
  AmazonRedshiftNodeData& AddSelectedColumns(SelectedColumnsT&& value) {
    m_selectedColumnsHasBeenSet = true;
    m_selectedColumns.emplace_back(std::forward<SelectedColumnsT>(value));
    return *this;
  }
  ///@}
 private:
