...
class TimestampFilter {
 public:
  ...
  void SetRecordedBefore(RecordedBeforeT&& value) {
    m_recordedBeforeHasBeenSet = true;
    m_recordedBefore = std::forward<RecordedBeforeT>(value);
  }
  template <typename RecordedBeforeT = Aws::Utils::DateTime>
  TimestampFilter& WithRecordedBefore(RecordedBeforeT&& value) {
    SetRecordedBefore(std::forward<RecordedBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordedAfter(RecordedAfterT&& value) {
    m_recordedAfterHasBeenSet = true;
    m_recordedAfter = std::forward<RecordedAfterT>(value);
  }
  template <typename RecordedAfterT = Aws::Utils::DateTime>
  TimestampFilter& WithRecordedAfter(RecordedAfterT&& value) {
    SetRecordedAfter(std::forward<RecordedAfterT>(value));
    return *this;
  }
  ///@}
 private:
