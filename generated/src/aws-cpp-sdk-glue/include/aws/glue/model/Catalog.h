...
class Catalog {
 public:
  ...
  void SetTargetRedshiftCatalog(TargetRedshiftCatalogT&& value) {
    ...
    m_targetRedshiftCatalog = std::forward<TargetRedshiftCatalogT>(value);
  }
  template <typename TargetRedshiftCatalogT = TargetRedshiftCatalog>
  Catalog& WithTargetRedshiftCatalog(TargetRedshiftCatalogT&& value) {
    SetTargetRedshiftCatalog(std::forward<TargetRedshiftCatalogT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFederatedCatalog(FederatedCatalogT&& value) {
    ...
    m_federatedCatalog = std::forward<FederatedCatalogT>(value);
  }
  template <typename FederatedCatalogT = FederatedCatalog>
  Catalog& WithFederatedCatalog(FederatedCatalogT&& value) {
    SetFederatedCatalog(std::forward<FederatedCatalogT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogProperties(CatalogPropertiesT&& value) {
    ...
    m_catalogProperties = std::forward<CatalogPropertiesT>(value);
  }
  template <typename CatalogPropertiesT = CatalogPropertiesOutput>
  Catalog& WithCatalogProperties(CatalogPropertiesT&& value) {
    SetCatalogProperties(std::forward<CatalogPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateTableDefaultPermissions(CreateTableDefaultPermissionsT&& value) {
    ...
    m_createTableDefaultPermissions = std::forward<CreateTableDefaultPermissionsT>(value);
  }
  template <typename CreateTableDefaultPermissionsT = Aws::Vector<PrincipalPermissions>>
  Catalog& WithCreateTableDefaultPermissions(CreateTableDefaultPermissionsT&& value) {
    SetCreateTableDefaultPermissions(std::forward<CreateTableDefaultPermissionsT>(value));
    return *this;
  }
  ...
  Catalog& AddCreateTableDefaultPermissions(CreateTableDefaultPermissionsT&& value) {
    m_createTableDefaultPermissionsHasBeenSet = true;
    m_createTableDefaultPermissions.emplace_back(std::forward<CreateTableDefaultPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateDatabaseDefaultPermissions(CreateDatabaseDefaultPermissionsT&& value) {
    ...
    m_createDatabaseDefaultPermissions = std::forward<CreateDatabaseDefaultPermissionsT>(value);
  }
  template <typename CreateDatabaseDefaultPermissionsT = Aws::Vector<PrincipalPermissions>>
  Catalog& WithCreateDatabaseDefaultPermissions(CreateDatabaseDefaultPermissionsT&& value) {
    SetCreateDatabaseDefaultPermissions(std::forward<CreateDatabaseDefaultPermissionsT>(value));
    return *this;
  }
  ...
  Catalog& AddCreateDatabaseDefaultPermissions(CreateDatabaseDefaultPermissionsT&& value) {
    m_createDatabaseDefaultPermissionsHasBeenSet = true;
    m_createDatabaseDefaultPermissions.emplace_back(std::forward<CreateDatabaseDefaultPermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllowFullTableExternalDataAccess(AllowFullTableExternalDataAccessEnum value) {
    m_allowFullTableExternalDataAccessHasBeenSet = true;
    m_allowFullTableExternalDataAccess = value;
  }
  inline Catalog& WithAllowFullTableExternalDataAccess(AllowFullTableExternalDataAccessEnum value) {
    SetAllowFullTableExternalDataAccess(value);
    return *this;
  }
  ///@}
 private:
