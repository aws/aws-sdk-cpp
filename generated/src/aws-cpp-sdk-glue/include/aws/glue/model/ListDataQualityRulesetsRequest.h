...
class ListDataQualityRulesetsRequest : public GlueRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityRulesetsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataQualityRulesetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = DataQualityRulesetFilterCriteria>
  ListDataQualityRulesetsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ListDataQualityRulesetsRequest& WithTags(TagsT&& value) {
