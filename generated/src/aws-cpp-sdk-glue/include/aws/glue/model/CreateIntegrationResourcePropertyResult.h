...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceArnT = Aws::String>
    CreateIntegrationResourcePropertyResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceProcessingPropertiesT = SourceProcessingProperties>
    CreateIntegrationResourcePropertyResult& WithSourceProcessingProperties(SourceProcessingPropertiesT&& value) { SetSourceProcessingProperties(std::forward<SourceProcessingPropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetProcessingPropertiesT = TargetProcessingProperties>
    CreateIntegrationResourcePropertyResult& WithTargetProcessingProperties(TargetProcessingPropertiesT&& value) { SetTargetProcessingProperties(std::forward<TargetProcessingPropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateIntegrationResourcePropertyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
