...
class BinaryColumnStatisticsData {
 public:
  ...
  inline BinaryColumnStatisticsData& WithMaximumLength(long long value) {
  ...
  inline BinaryColumnStatisticsData& WithAverageLength(double value) {
  ...
  inline BinaryColumnStatisticsData& WithNumberOfNulls(long long value) {
