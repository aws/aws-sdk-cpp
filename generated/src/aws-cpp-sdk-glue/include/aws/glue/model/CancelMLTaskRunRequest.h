...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API CancelMLTaskRunRequest() = default;
    ...
    template<typename TransformIdT = Aws::String>
    CancelMLTaskRunRequest& WithTransformId(TransformIdT&& value) { SetTransformId(std::forward<TransformIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TaskRunIdT = Aws::String>
    CancelMLTaskRunRequest& WithTaskRunId(TaskRunIdT&& value) { SetTaskRunId(std::forward<TaskRunIdT>(value)); return *this;}
    ///@}
  private:
