...
class CodeGenConfigurationNode {
 public:
  ...
  void SetAthenaConnectorSource(AthenaConnectorSourceT&& value) {
    ...
    m_athenaConnectorSource = std::forward<AthenaConnectorSourceT>(value);
  }
  template <typename AthenaConnectorSourceT = AthenaConnectorSource>
  CodeGenConfigurationNode& WithAthenaConnectorSource(AthenaConnectorSourceT&& value) {
    SetAthenaConnectorSource(std::forward<AthenaConnectorSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJDBCConnectorSource(JDBCConnectorSourceT&& value) {
    ...
    m_jDBCConnectorSource = std::forward<JDBCConnectorSourceT>(value);
  }
  template <typename JDBCConnectorSourceT = JDBCConnectorSource>
  CodeGenConfigurationNode& WithJDBCConnectorSource(JDBCConnectorSourceT&& value) {
    SetJDBCConnectorSource(std::forward<JDBCConnectorSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkConnectorSource(SparkConnectorSourceT&& value) {
    ...
    m_sparkConnectorSource = std::forward<SparkConnectorSourceT>(value);
  }
  template <typename SparkConnectorSourceT = SparkConnectorSource>
  CodeGenConfigurationNode& WithSparkConnectorSource(SparkConnectorSourceT&& value) {
    SetSparkConnectorSource(std::forward<SparkConnectorSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogSource(CatalogSourceT&& value) {
    ...
    m_catalogSource = std::forward<CatalogSourceT>(value);
  }
  template <typename CatalogSourceT = CatalogSource>
  CodeGenConfigurationNode& WithCatalogSource(CatalogSourceT&& value) {
    SetCatalogSource(std::forward<CatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftSource(RedshiftSourceT&& value) {
    ...
    m_redshiftSource = std::forward<RedshiftSourceT>(value);
  }
  template <typename RedshiftSourceT = RedshiftSource>
  CodeGenConfigurationNode& WithRedshiftSource(RedshiftSourceT&& value) {
    SetRedshiftSource(std::forward<RedshiftSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CatalogSource(S3CatalogSourceT&& value) {
    ...
    m_s3CatalogSource = std::forward<S3CatalogSourceT>(value);
  }
  template <typename S3CatalogSourceT = S3CatalogSource>
  CodeGenConfigurationNode& WithS3CatalogSource(S3CatalogSourceT&& value) {
    SetS3CatalogSource(std::forward<S3CatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CsvSource(S3CsvSourceT&& value) {
    ...
    m_s3CsvSource = std::forward<S3CsvSourceT>(value);
  }
  template <typename S3CsvSourceT = S3CsvSource>
  CodeGenConfigurationNode& WithS3CsvSource(S3CsvSourceT&& value) {
    SetS3CsvSource(std::forward<S3CsvSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3JsonSource(S3JsonSourceT&& value) {
    ...
    m_s3JsonSource = std::forward<S3JsonSourceT>(value);
  }
  template <typename S3JsonSourceT = S3JsonSource>
  CodeGenConfigurationNode& WithS3JsonSource(S3JsonSourceT&& value) {
    SetS3JsonSource(std::forward<S3JsonSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3ParquetSource(S3ParquetSourceT&& value) {
    ...
    m_s3ParquetSource = std::forward<S3ParquetSourceT>(value);
  }
  template <typename S3ParquetSourceT = S3ParquetSource>
  CodeGenConfigurationNode& WithS3ParquetSource(S3ParquetSourceT&& value) {
    SetS3ParquetSource(std::forward<S3ParquetSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelationalCatalogSource(RelationalCatalogSourceT&& value) {
    ...
    m_relationalCatalogSource = std::forward<RelationalCatalogSourceT>(value);
  }
  template <typename RelationalCatalogSourceT = RelationalCatalogSource>
  CodeGenConfigurationNode& WithRelationalCatalogSource(RelationalCatalogSourceT&& value) {
    SetRelationalCatalogSource(std::forward<RelationalCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamoDBCatalogSource(DynamoDBCatalogSourceT&& value) {
    ...
    m_dynamoDBCatalogSource = std::forward<DynamoDBCatalogSourceT>(value);
  }
  template <typename DynamoDBCatalogSourceT = DynamoDBCatalogSource>
  CodeGenConfigurationNode& WithDynamoDBCatalogSource(DynamoDBCatalogSourceT&& value) {
    SetDynamoDBCatalogSource(std::forward<DynamoDBCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJDBCConnectorTarget(JDBCConnectorTargetT&& value) {
    ...
    m_jDBCConnectorTarget = std::forward<JDBCConnectorTargetT>(value);
  }
  template <typename JDBCConnectorTargetT = JDBCConnectorTarget>
  CodeGenConfigurationNode& WithJDBCConnectorTarget(JDBCConnectorTargetT&& value) {
    SetJDBCConnectorTarget(std::forward<JDBCConnectorTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkConnectorTarget(SparkConnectorTargetT&& value) {
    ...
    m_sparkConnectorTarget = std::forward<SparkConnectorTargetT>(value);
  }
  template <typename SparkConnectorTargetT = SparkConnectorTarget>
  CodeGenConfigurationNode& WithSparkConnectorTarget(SparkConnectorTargetT&& value) {
    SetSparkConnectorTarget(std::forward<SparkConnectorTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogTarget(CatalogTargetT&& value) {
    ...
    m_catalogTarget = std::forward<CatalogTargetT>(value);
  }
  template <typename CatalogTargetT = BasicCatalogTarget>
  CodeGenConfigurationNode& WithCatalogTarget(CatalogTargetT&& value) {
    SetCatalogTarget(std::forward<CatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftTarget(RedshiftTargetT&& value) {
    ...
    m_redshiftTarget = std::forward<RedshiftTargetT>(value);
  }
  template <typename RedshiftTargetT = RedshiftTarget>
  CodeGenConfigurationNode& WithRedshiftTarget(RedshiftTargetT&& value) {
    SetRedshiftTarget(std::forward<RedshiftTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CatalogTarget(S3CatalogTargetT&& value) {
    ...
    m_s3CatalogTarget = std::forward<S3CatalogTargetT>(value);
  }
  template <typename S3CatalogTargetT = S3CatalogTarget>
  CodeGenConfigurationNode& WithS3CatalogTarget(S3CatalogTargetT&& value) {
    SetS3CatalogTarget(std::forward<S3CatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3GlueParquetTarget(S3GlueParquetTargetT&& value) {
    ...
    m_s3GlueParquetTarget = std::forward<S3GlueParquetTargetT>(value);
  }
  template <typename S3GlueParquetTargetT = S3GlueParquetTarget>
  CodeGenConfigurationNode& WithS3GlueParquetTarget(S3GlueParquetTargetT&& value) {
    SetS3GlueParquetTarget(std::forward<S3GlueParquetTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DirectTarget(S3DirectTargetT&& value) {
    ...
    m_s3DirectTarget = std::forward<S3DirectTargetT>(value);
  }
  template <typename S3DirectTargetT = S3DirectTarget>
  CodeGenConfigurationNode& WithS3DirectTarget(S3DirectTargetT&& value) {
    SetS3DirectTarget(std::forward<S3DirectTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplyMapping(ApplyMappingT&& value) {
    ...
    m_applyMapping = std::forward<ApplyMappingT>(value);
  }
  template <typename ApplyMappingT = ApplyMapping>
  CodeGenConfigurationNode& WithApplyMapping(ApplyMappingT&& value) {
    SetApplyMapping(std::forward<ApplyMappingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectFields(SelectFieldsT&& value) {
    ...
    m_selectFields = std::forward<SelectFieldsT>(value);
  }
  template <typename SelectFieldsT = SelectFields>
  CodeGenConfigurationNode& WithSelectFields(SelectFieldsT&& value) {
    SetSelectFields(std::forward<SelectFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDropFields(DropFieldsT&& value) {
    ...
    m_dropFields = std::forward<DropFieldsT>(value);
  }
  template <typename DropFieldsT = DropFields>
  CodeGenConfigurationNode& WithDropFields(DropFieldsT&& value) {
    SetDropFields(std::forward<DropFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRenameField(RenameFieldT&& value) {
    ...
    m_renameField = std::forward<RenameFieldT>(value);
  }
  template <typename RenameFieldT = RenameField>
  CodeGenConfigurationNode& WithRenameField(RenameFieldT&& value) {
    SetRenameField(std::forward<RenameFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpigot(SpigotT&& value) {
    ...
    m_spigot = std::forward<SpigotT>(value);
  }
  template <typename SpigotT = Spigot>
  CodeGenConfigurationNode& WithSpigot(SpigotT&& value) {
    SetSpigot(std::forward<SpigotT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJoin(JoinT&& value) {
    ...
    m_join = std::forward<JoinT>(value);
  }
  template <typename JoinT = Join>
  CodeGenConfigurationNode& WithJoin(JoinT&& value) {
    SetJoin(std::forward<JoinT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSplitFields(SplitFieldsT&& value) {
    ...
    m_splitFields = std::forward<SplitFieldsT>(value);
  }
  template <typename SplitFieldsT = SplitFields>
  CodeGenConfigurationNode& WithSplitFields(SplitFieldsT&& value) {
    SetSplitFields(std::forward<SplitFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelectFromCollection(SelectFromCollectionT&& value) {
    ...
    m_selectFromCollection = std::forward<SelectFromCollectionT>(value);
  }
  template <typename SelectFromCollectionT = SelectFromCollection>
  CodeGenConfigurationNode& WithSelectFromCollection(SelectFromCollectionT&& value) {
    SetSelectFromCollection(std::forward<SelectFromCollectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFillMissingValues(FillMissingValuesT&& value) {
    ...
    m_fillMissingValues = std::forward<FillMissingValuesT>(value);
  }
  template <typename FillMissingValuesT = FillMissingValues>
  CodeGenConfigurationNode& WithFillMissingValues(FillMissingValuesT&& value) {
    SetFillMissingValues(std::forward<FillMissingValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomCode(CustomCodeT&& value) {
    ...
    m_customCode = std::forward<CustomCodeT>(value);
  }
  template <typename CustomCodeT = CustomCode>
  CodeGenConfigurationNode& WithCustomCode(CustomCodeT&& value) {
    SetCustomCode(std::forward<CustomCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSparkSQL(SparkSQLT&& value) {
    ...
    m_sparkSQL = std::forward<SparkSQLT>(value);
  }
  template <typename SparkSQLT = SparkSQL>
  CodeGenConfigurationNode& WithSparkSQL(SparkSQLT&& value) {
    SetSparkSQL(std::forward<SparkSQLT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectKinesisSource(DirectKinesisSourceT&& value) {
    ...
    m_directKinesisSource = std::forward<DirectKinesisSourceT>(value);
  }
  template <typename DirectKinesisSourceT = DirectKinesisSource>
  CodeGenConfigurationNode& WithDirectKinesisSource(DirectKinesisSourceT&& value) {
    SetDirectKinesisSource(std::forward<DirectKinesisSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectKafkaSource(DirectKafkaSourceT&& value) {
    ...
    m_directKafkaSource = std::forward<DirectKafkaSourceT>(value);
  }
  template <typename DirectKafkaSourceT = DirectKafkaSource>
  CodeGenConfigurationNode& WithDirectKafkaSource(DirectKafkaSourceT&& value) {
    SetDirectKafkaSource(std::forward<DirectKafkaSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogKinesisSource(CatalogKinesisSourceT&& value) {
    ...
    m_catalogKinesisSource = std::forward<CatalogKinesisSourceT>(value);
  }
  template <typename CatalogKinesisSourceT = CatalogKinesisSource>
  CodeGenConfigurationNode& WithCatalogKinesisSource(CatalogKinesisSourceT&& value) {
    SetCatalogKinesisSource(std::forward<CatalogKinesisSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogKafkaSource(CatalogKafkaSourceT&& value) {
    ...
    m_catalogKafkaSource = std::forward<CatalogKafkaSourceT>(value);
  }
  template <typename CatalogKafkaSourceT = CatalogKafkaSource>
  CodeGenConfigurationNode& WithCatalogKafkaSource(CatalogKafkaSourceT&& value) {
    SetCatalogKafkaSource(std::forward<CatalogKafkaSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDropNullFields(DropNullFieldsT&& value) {
    ...
    m_dropNullFields = std::forward<DropNullFieldsT>(value);
  }
  template <typename DropNullFieldsT = DropNullFields>
  CodeGenConfigurationNode& WithDropNullFields(DropNullFieldsT&& value) {
    SetDropNullFields(std::forward<DropNullFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnion(UnionT&& value) {
    ...
    m_union = std::forward<UnionT>(value);
  }
  template <typename UnionT = Union>
  CodeGenConfigurationNode& WithUnion(UnionT&& value) {
    SetUnion(std::forward<UnionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPIIDetection(PIIDetectionT&& value) {
    ...
    m_pIIDetection = std::forward<PIIDetectionT>(value);
  }
  template <typename PIIDetectionT = PIIDetection>
  CodeGenConfigurationNode& WithPIIDetection(PIIDetectionT&& value) {
    SetPIIDetection(std::forward<PIIDetectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggregate(AggregateT&& value) {
    ...
    m_aggregate = std::forward<AggregateT>(value);
  }
  template <typename AggregateT = Aggregate>
  CodeGenConfigurationNode& WithAggregate(AggregateT&& value) {
    SetAggregate(std::forward<AggregateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDropDuplicates(DropDuplicatesT&& value) {
    ...
    m_dropDuplicates = std::forward<DropDuplicatesT>(value);
  }
  template <typename DropDuplicatesT = DropDuplicates>
  CodeGenConfigurationNode& WithDropDuplicates(DropDuplicatesT&& value) {
    SetDropDuplicates(std::forward<DropDuplicatesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGovernedCatalogTarget(GovernedCatalogTargetT&& value) {
    ...
    m_governedCatalogTarget = std::forward<GovernedCatalogTargetT>(value);
  }
  template <typename GovernedCatalogTargetT = GovernedCatalogTarget>
  CodeGenConfigurationNode& WithGovernedCatalogTarget(GovernedCatalogTargetT&& value) {
    SetGovernedCatalogTarget(std::forward<GovernedCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGovernedCatalogSource(GovernedCatalogSourceT&& value) {
    ...
    m_governedCatalogSource = std::forward<GovernedCatalogSourceT>(value);
  }
  template <typename GovernedCatalogSourceT = GovernedCatalogSource>
  CodeGenConfigurationNode& WithGovernedCatalogSource(GovernedCatalogSourceT&& value) {
    SetGovernedCatalogSource(std::forward<GovernedCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMicrosoftSQLServerCatalogSource(MicrosoftSQLServerCatalogSourceT&& value) {
    ...
    m_microsoftSQLServerCatalogSource = std::forward<MicrosoftSQLServerCatalogSourceT>(value);
  }
  template <typename MicrosoftSQLServerCatalogSourceT = MicrosoftSQLServerCatalogSource>
  CodeGenConfigurationNode& WithMicrosoftSQLServerCatalogSource(MicrosoftSQLServerCatalogSourceT&& value) {
    SetMicrosoftSQLServerCatalogSource(std::forward<MicrosoftSQLServerCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMySQLCatalogSource(MySQLCatalogSourceT&& value) {
    ...
    m_mySQLCatalogSource = std::forward<MySQLCatalogSourceT>(value);
  }
  template <typename MySQLCatalogSourceT = MySQLCatalogSource>
  CodeGenConfigurationNode& WithMySQLCatalogSource(MySQLCatalogSourceT&& value) {
    SetMySQLCatalogSource(std::forward<MySQLCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOracleSQLCatalogSource(OracleSQLCatalogSourceT&& value) {
    ...
    m_oracleSQLCatalogSource = std::forward<OracleSQLCatalogSourceT>(value);
  }
  template <typename OracleSQLCatalogSourceT = OracleSQLCatalogSource>
  CodeGenConfigurationNode& WithOracleSQLCatalogSource(OracleSQLCatalogSourceT&& value) {
    SetOracleSQLCatalogSource(std::forward<OracleSQLCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostgreSQLCatalogSource(PostgreSQLCatalogSourceT&& value) {
    ...
    m_postgreSQLCatalogSource = std::forward<PostgreSQLCatalogSourceT>(value);
  }
  template <typename PostgreSQLCatalogSourceT = PostgreSQLCatalogSource>
  CodeGenConfigurationNode& WithPostgreSQLCatalogSource(PostgreSQLCatalogSourceT&& value) {
    SetPostgreSQLCatalogSource(std::forward<PostgreSQLCatalogSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMicrosoftSQLServerCatalogTarget(MicrosoftSQLServerCatalogTargetT&& value) {
    ...
    m_microsoftSQLServerCatalogTarget = std::forward<MicrosoftSQLServerCatalogTargetT>(value);
  }
  template <typename MicrosoftSQLServerCatalogTargetT = MicrosoftSQLServerCatalogTarget>
  CodeGenConfigurationNode& WithMicrosoftSQLServerCatalogTarget(MicrosoftSQLServerCatalogTargetT&& value) {
    SetMicrosoftSQLServerCatalogTarget(std::forward<MicrosoftSQLServerCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMySQLCatalogTarget(MySQLCatalogTargetT&& value) {
    ...
    m_mySQLCatalogTarget = std::forward<MySQLCatalogTargetT>(value);
  }
  template <typename MySQLCatalogTargetT = MySQLCatalogTarget>
  CodeGenConfigurationNode& WithMySQLCatalogTarget(MySQLCatalogTargetT&& value) {
    SetMySQLCatalogTarget(std::forward<MySQLCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOracleSQLCatalogTarget(OracleSQLCatalogTargetT&& value) {
    ...
    m_oracleSQLCatalogTarget = std::forward<OracleSQLCatalogTargetT>(value);
  }
  template <typename OracleSQLCatalogTargetT = OracleSQLCatalogTarget>
  CodeGenConfigurationNode& WithOracleSQLCatalogTarget(OracleSQLCatalogTargetT&& value) {
    SetOracleSQLCatalogTarget(std::forward<OracleSQLCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostgreSQLCatalogTarget(PostgreSQLCatalogTargetT&& value) {
    ...
    m_postgreSQLCatalogTarget = std::forward<PostgreSQLCatalogTargetT>(value);
  }
  template <typename PostgreSQLCatalogTargetT = PostgreSQLCatalogTarget>
  CodeGenConfigurationNode& WithPostgreSQLCatalogTarget(PostgreSQLCatalogTargetT&& value) {
    SetPostgreSQLCatalogTarget(std::forward<PostgreSQLCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamicTransform(DynamicTransformT&& value) {
    ...
    m_dynamicTransform = std::forward<DynamicTransformT>(value);
  }
  template <typename DynamicTransformT = DynamicTransform>
  CodeGenConfigurationNode& WithDynamicTransform(DynamicTransformT&& value) {
    SetDynamicTransform(std::forward<DynamicTransformT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluateDataQuality(EvaluateDataQualityT&& value) {
    ...
    m_evaluateDataQuality = std::forward<EvaluateDataQualityT>(value);
  }
  template <typename EvaluateDataQualityT = EvaluateDataQuality>
  CodeGenConfigurationNode& WithEvaluateDataQuality(EvaluateDataQualityT&& value) {
    SetEvaluateDataQuality(std::forward<EvaluateDataQualityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CatalogHudiSource(S3CatalogHudiSourceT&& value) {
    ...
    m_s3CatalogHudiSource = std::forward<S3CatalogHudiSourceT>(value);
  }
  template <typename S3CatalogHudiSourceT = S3CatalogHudiSource>
  CodeGenConfigurationNode& WithS3CatalogHudiSource(S3CatalogHudiSourceT&& value) {
    SetS3CatalogHudiSource(std::forward<S3CatalogHudiSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogHudiSource(CatalogHudiSourceT&& value) {
    ...
    m_catalogHudiSource = std::forward<CatalogHudiSourceT>(value);
  }
  template <typename CatalogHudiSourceT = CatalogHudiSource>
  CodeGenConfigurationNode& WithCatalogHudiSource(CatalogHudiSourceT&& value) {
    SetCatalogHudiSource(std::forward<CatalogHudiSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3HudiSource(S3HudiSourceT&& value) {
    ...
    m_s3HudiSource = std::forward<S3HudiSourceT>(value);
  }
  template <typename S3HudiSourceT = S3HudiSource>
  CodeGenConfigurationNode& WithS3HudiSource(S3HudiSourceT&& value) {
    SetS3HudiSource(std::forward<S3HudiSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3HudiCatalogTarget(S3HudiCatalogTargetT&& value) {
    ...
    m_s3HudiCatalogTarget = std::forward<S3HudiCatalogTargetT>(value);
  }
  template <typename S3HudiCatalogTargetT = S3HudiCatalogTarget>
  CodeGenConfigurationNode& WithS3HudiCatalogTarget(S3HudiCatalogTargetT&& value) {
    SetS3HudiCatalogTarget(std::forward<S3HudiCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3HudiDirectTarget(S3HudiDirectTargetT&& value) {
    ...
    m_s3HudiDirectTarget = std::forward<S3HudiDirectTargetT>(value);
  }
  template <typename S3HudiDirectTargetT = S3HudiDirectTarget>
  CodeGenConfigurationNode& WithS3HudiDirectTarget(S3HudiDirectTargetT&& value) {
    SetS3HudiDirectTarget(std::forward<S3HudiDirectTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectJDBCSource(DirectJDBCSourceT&& value) {
    ...
    m_directJDBCSource = std::forward<DirectJDBCSourceT>(value);
  }
  template <typename DirectJDBCSourceT = DirectJDBCSource>
  CodeGenConfigurationNode& WithDirectJDBCSource(DirectJDBCSourceT&& value) {
    SetDirectJDBCSource(std::forward<DirectJDBCSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CatalogDeltaSource(S3CatalogDeltaSourceT&& value) {
    ...
    m_s3CatalogDeltaSource = std::forward<S3CatalogDeltaSourceT>(value);
  }
  template <typename S3CatalogDeltaSourceT = S3CatalogDeltaSource>
  CodeGenConfigurationNode& WithS3CatalogDeltaSource(S3CatalogDeltaSourceT&& value) {
    SetS3CatalogDeltaSource(std::forward<S3CatalogDeltaSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogDeltaSource(CatalogDeltaSourceT&& value) {
    ...
    m_catalogDeltaSource = std::forward<CatalogDeltaSourceT>(value);
  }
  template <typename CatalogDeltaSourceT = CatalogDeltaSource>
  CodeGenConfigurationNode& WithCatalogDeltaSource(CatalogDeltaSourceT&& value) {
    SetCatalogDeltaSource(std::forward<CatalogDeltaSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DeltaSource(S3DeltaSourceT&& value) {
    ...
    m_s3DeltaSource = std::forward<S3DeltaSourceT>(value);
  }
  template <typename S3DeltaSourceT = S3DeltaSource>
  CodeGenConfigurationNode& WithS3DeltaSource(S3DeltaSourceT&& value) {
    SetS3DeltaSource(std::forward<S3DeltaSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DeltaCatalogTarget(S3DeltaCatalogTargetT&& value) {
    ...
    m_s3DeltaCatalogTarget = std::forward<S3DeltaCatalogTargetT>(value);
  }
  template <typename S3DeltaCatalogTargetT = S3DeltaCatalogTarget>
  CodeGenConfigurationNode& WithS3DeltaCatalogTarget(S3DeltaCatalogTargetT&& value) {
    SetS3DeltaCatalogTarget(std::forward<S3DeltaCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3DeltaDirectTarget(S3DeltaDirectTargetT&& value) {
    ...
    m_s3DeltaDirectTarget = std::forward<S3DeltaDirectTargetT>(value);
  }
  template <typename S3DeltaDirectTargetT = S3DeltaDirectTarget>
  CodeGenConfigurationNode& WithS3DeltaDirectTarget(S3DeltaDirectTargetT&& value) {
    SetS3DeltaDirectTarget(std::forward<S3DeltaDirectTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmazonRedshiftSource(AmazonRedshiftSourceT&& value) {
    ...
    m_amazonRedshiftSource = std::forward<AmazonRedshiftSourceT>(value);
  }
  template <typename AmazonRedshiftSourceT = AmazonRedshiftSource>
  CodeGenConfigurationNode& WithAmazonRedshiftSource(AmazonRedshiftSourceT&& value) {
    SetAmazonRedshiftSource(std::forward<AmazonRedshiftSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmazonRedshiftTarget(AmazonRedshiftTargetT&& value) {
    ...
    m_amazonRedshiftTarget = std::forward<AmazonRedshiftTargetT>(value);
  }
  template <typename AmazonRedshiftTargetT = AmazonRedshiftTarget>
  CodeGenConfigurationNode& WithAmazonRedshiftTarget(AmazonRedshiftTargetT&& value) {
    SetAmazonRedshiftTarget(std::forward<AmazonRedshiftTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluateDataQualityMultiFrame(EvaluateDataQualityMultiFrameT&& value) {
    ...
    m_evaluateDataQualityMultiFrame = std::forward<EvaluateDataQualityMultiFrameT>(value);
  }
  template <typename EvaluateDataQualityMultiFrameT = EvaluateDataQualityMultiFrame>
  CodeGenConfigurationNode& WithEvaluateDataQualityMultiFrame(EvaluateDataQualityMultiFrameT&& value) {
    SetEvaluateDataQualityMultiFrame(std::forward<EvaluateDataQualityMultiFrameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecipe(RecipeT&& value) {
    ...
    m_recipe = std::forward<RecipeT>(value);
  }
  template <typename RecipeT = Recipe>
  CodeGenConfigurationNode& WithRecipe(RecipeT&& value) {
    SetRecipe(std::forward<RecipeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnowflakeSource(SnowflakeSourceT&& value) {
    ...
    m_snowflakeSource = std::forward<SnowflakeSourceT>(value);
  }
  template <typename SnowflakeSourceT = SnowflakeSource>
  CodeGenConfigurationNode& WithSnowflakeSource(SnowflakeSourceT&& value) {
    SetSnowflakeSource(std::forward<SnowflakeSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnowflakeTarget(SnowflakeTargetT&& value) {
    ...
    m_snowflakeTarget = std::forward<SnowflakeTargetT>(value);
  }
  template <typename SnowflakeTargetT = SnowflakeTarget>
  CodeGenConfigurationNode& WithSnowflakeTarget(SnowflakeTargetT&& value) {
    SetSnowflakeTarget(std::forward<SnowflakeTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectorDataSource(ConnectorDataSourceT&& value) {
    ...
    m_connectorDataSource = std::forward<ConnectorDataSourceT>(value);
  }
  template <typename ConnectorDataSourceT = ConnectorDataSource>
  CodeGenConfigurationNode& WithConnectorDataSource(ConnectorDataSourceT&& value) {
    SetConnectorDataSource(std::forward<ConnectorDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectorDataTarget(ConnectorDataTargetT&& value) {
    ...
    m_connectorDataTarget = std::forward<ConnectorDataTargetT>(value);
  }
  template <typename ConnectorDataTargetT = ConnectorDataTarget>
  CodeGenConfigurationNode& WithConnectorDataTarget(ConnectorDataTargetT&& value) {
    SetConnectorDataTarget(std::forward<ConnectorDataTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3CatalogIcebergSource(S3CatalogIcebergSourceT&& value) {
    ...
    m_s3CatalogIcebergSource = std::forward<S3CatalogIcebergSourceT>(value);
  }
  template <typename S3CatalogIcebergSourceT = S3CatalogIcebergSource>
  CodeGenConfigurationNode& WithS3CatalogIcebergSource(S3CatalogIcebergSourceT&& value) {
    SetS3CatalogIcebergSource(std::forward<S3CatalogIcebergSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCatalogIcebergSource(CatalogIcebergSourceT&& value) {
    ...
    m_catalogIcebergSource = std::forward<CatalogIcebergSourceT>(value);
  }
  template <typename CatalogIcebergSourceT = CatalogIcebergSource>
  CodeGenConfigurationNode& WithCatalogIcebergSource(CatalogIcebergSourceT&& value) {
    SetCatalogIcebergSource(std::forward<CatalogIcebergSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3IcebergCatalogTarget(S3IcebergCatalogTargetT&& value) {
    ...
    m_s3IcebergCatalogTarget = std::forward<S3IcebergCatalogTargetT>(value);
  }
  template <typename S3IcebergCatalogTargetT = S3IcebergCatalogTarget>
  CodeGenConfigurationNode& WithS3IcebergCatalogTarget(S3IcebergCatalogTargetT&& value) {
    SetS3IcebergCatalogTarget(std::forward<S3IcebergCatalogTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3IcebergDirectTarget(S3IcebergDirectTargetT&& value) {
    ...
    m_s3IcebergDirectTarget = std::forward<S3IcebergDirectTargetT>(value);
  }
  template <typename S3IcebergDirectTargetT = S3IcebergDirectTarget>
  CodeGenConfigurationNode& WithS3IcebergDirectTarget(S3IcebergDirectTargetT&& value) {
    SetS3IcebergDirectTarget(std::forward<S3IcebergDirectTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3ExcelSource(S3ExcelSourceT&& value) {
    ...
    m_s3ExcelSource = std::forward<S3ExcelSourceT>(value);
  }
  template <typename S3ExcelSourceT = S3ExcelSource>
  CodeGenConfigurationNode& WithS3ExcelSource(S3ExcelSourceT&& value) {
    SetS3ExcelSource(std::forward<S3ExcelSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3HyperDirectTarget(S3HyperDirectTargetT&& value) {
    ...
    m_s3HyperDirectTarget = std::forward<S3HyperDirectTargetT>(value);
  }
  template <typename S3HyperDirectTargetT = S3HyperDirectTarget>
  CodeGenConfigurationNode& WithS3HyperDirectTarget(S3HyperDirectTargetT&& value) {
    SetS3HyperDirectTarget(std::forward<S3HyperDirectTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamoDBELTConnectorSource(DynamoDBELTConnectorSourceT&& value) {
    ...
    m_dynamoDBELTConnectorSource = std::forward<DynamoDBELTConnectorSourceT>(value);
  }
  template <typename DynamoDBELTConnectorSourceT = DynamoDBELTConnectorSource>
  CodeGenConfigurationNode& WithDynamoDBELTConnectorSource(DynamoDBELTConnectorSourceT&& value) {
    SetDynamoDBELTConnectorSource(std::forward<DynamoDBELTConnectorSourceT>(value));
    return *this;
  }
  ///@}
 private:
