...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API CreateIntegrationResult() = default;
    ...
    inline CreateIntegrationResult& WithStatus(IntegrationStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename DataFilterT = Aws::String>
    CreateIntegrationResult& WithDataFilter(DataFilterT&& value) { SetDataFilter(std::forward<DataFilterT>(value)); return *this;}
    ///@}
