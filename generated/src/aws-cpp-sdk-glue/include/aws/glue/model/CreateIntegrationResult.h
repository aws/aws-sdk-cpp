...
class CreateIntegrationResult {
 public:
  ...
  inline CreateIntegrationResult& WithStatus(IntegrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DataFilterT = Aws::String>
  CreateIntegrationResult& WithDataFilter(DataFilterT&& value) {
  ...
  template <typename IntegrationConfigT = IntegrationConfig>
  CreateIntegrationResult& WithIntegrationConfig(IntegrationConfigT&& value) {
