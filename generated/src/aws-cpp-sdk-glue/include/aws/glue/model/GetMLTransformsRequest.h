...
class GetMLTransformsRequest : public GlueRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetMLTransformsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetMLTransformsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FilterT = TransformFilterCriteria>
  GetMLTransformsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename SortT = TransformSortCriteria>
  GetMLTransformsRequest& WithSort(SortT&& value) {
