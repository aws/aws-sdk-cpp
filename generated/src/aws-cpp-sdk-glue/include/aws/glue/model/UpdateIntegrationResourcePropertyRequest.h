...
class UpdateIntegrationResourcePropertyRequest : public GlueRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateIntegrationResourcePropertyRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SourceProcessingPropertiesT = SourceProcessingProperties>
  UpdateIntegrationResourcePropertyRequest& WithSourceProcessingProperties(SourceProcessingPropertiesT&& value) {
  ...
  template <typename TargetProcessingPropertiesT = TargetProcessingProperties>
  UpdateIntegrationResourcePropertyRequest& WithTargetProcessingProperties(TargetProcessingPropertiesT&& value) {
