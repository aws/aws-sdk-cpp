...
class DataQualityRuleRecommendationRunFilter {
 public:
  ...
  template <typename DataSourceT = DataSource>
  DataQualityRuleRecommendationRunFilter& WithDataSource(DataSourceT&& value) {
  ...
  template <typename StartedBeforeT = Aws::Utils::DateTime>
  DataQualityRuleRecommendationRunFilter& WithStartedBefore(StartedBeforeT&& value) {
  ...
  template <typename StartedAfterT = Aws::Utils::DateTime>
  DataQualityRuleRecommendationRunFilter& WithStartedAfter(StartedAfterT&& value) {
