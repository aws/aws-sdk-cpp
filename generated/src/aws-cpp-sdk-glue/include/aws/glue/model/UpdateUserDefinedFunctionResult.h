...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API UpdateUserDefinedFunctionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateUserDefinedFunctionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
