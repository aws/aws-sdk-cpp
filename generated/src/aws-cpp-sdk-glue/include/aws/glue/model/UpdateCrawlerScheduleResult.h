...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API UpdateCrawlerScheduleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateCrawlerScheduleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
