...
class IcebergOptimizationProperties {
 public:
  ...
  void SetCompaction(CompactionT&& value) {
    ...
    m_compaction = std::forward<CompactionT>(value);
  }
  template <typename CompactionT = Aws::Map<Aws::String, Aws::String>>
  IcebergOptimizationProperties& WithCompaction(CompactionT&& value) {
    SetCompaction(std::forward<CompactionT>(value));
    return *this;
  }
  ...
  IcebergOptimizationProperties& AddCompaction(CompactionKeyT&& key, CompactionValueT&& value) {
    m_compactionHasBeenSet = true;
    m_compaction.emplace(std::forward<CompactionKeyT>(key), std::forward<CompactionValueT>(value));
    return *this;
  }
  ///@}
  ...
  IcebergOptimizationProperties& AddRetention(RetentionKeyT&& key, RetentionValueT&& value) {
    m_retentionHasBeenSet = true;
    m_retention.emplace(std::forward<RetentionKeyT>(key), std::forward<RetentionValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrphanFileDeletion(OrphanFileDeletionT&& value) {
    ...
    m_orphanFileDeletion = std::forward<OrphanFileDeletionT>(value);
  }
  template <typename OrphanFileDeletionT = Aws::Map<Aws::String, Aws::String>>
  IcebergOptimizationProperties& WithOrphanFileDeletion(OrphanFileDeletionT&& value) {
    SetOrphanFileDeletion(std::forward<OrphanFileDeletionT>(value));
    return *this;
  }
  ...
  IcebergOptimizationProperties& AddOrphanFileDeletion(OrphanFileDeletionKeyT&& key, OrphanFileDeletionValueT&& value) {
    m_orphanFileDeletionHasBeenSet = true;
    m_orphanFileDeletion.emplace(std::forward<OrphanFileDeletionKeyT>(key), std::forward<OrphanFileDeletionValueT>(value));
    return *this;
  }
  ///@}
 private:
