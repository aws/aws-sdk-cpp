...
class QuerySchemaVersionMetadataResult {
 public:
  ...
  void SetMetadataInfoMap(MetadataInfoMapT&& value) {
    m_metadataInfoMapHasBeenSet = true;
    m_metadataInfoMap = std::forward<MetadataInfoMapT>(value);
  }
  template <typename MetadataInfoMapT = Aws::Map<Aws::String, MetadataInfo>>
  QuerySchemaVersionMetadataResult& WithMetadataInfoMap(MetadataInfoMapT&& value) {
    SetMetadataInfoMap(std::forward<MetadataInfoMapT>(value));
    return *this;
  }
  ...
  QuerySchemaVersionMetadataResult& AddMetadataInfoMap(MetadataInfoMapKeyT&& key, MetadataInfoMapValueT&& value) {
    m_metadataInfoMapHasBeenSet = true;
    m_metadataInfoMap.emplace(std::forward<MetadataInfoMapKeyT>(key), std::forward<MetadataInfoMapValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SchemaVersionIdT = Aws::String>
  QuerySchemaVersionMetadataResult& WithSchemaVersionId(SchemaVersionIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  QuerySchemaVersionMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  QuerySchemaVersionMetadataResult& WithRequestId(RequestIdT&& value) {
