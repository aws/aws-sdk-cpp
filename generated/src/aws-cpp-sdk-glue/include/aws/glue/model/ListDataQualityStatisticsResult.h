...
class ListDataQualityStatisticsResult {
 public:
  ...
  template <typename StatisticsT = Aws::Vector<StatisticSummary>>
  ListDataQualityStatisticsResult& WithStatistics(StatisticsT&& value) {
    SetStatistics(std::forward<StatisticsT>(value));
    return *this;
  }
  template <typename StatisticsT = StatisticSummary>
  ListDataQualityStatisticsResult& AddStatistics(StatisticsT&& value) {
    m_statisticsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityStatisticsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityStatisticsResult& WithRequestId(RequestIdT&& value) {
