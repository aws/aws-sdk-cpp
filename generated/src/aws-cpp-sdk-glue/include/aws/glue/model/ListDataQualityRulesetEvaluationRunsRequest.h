...
class ListDataQualityRulesetEvaluationRunsRequest : public GlueRequest {
 public:
  ...
  template <typename FilterT = DataQualityRulesetEvaluationRunFilter>
  ListDataQualityRulesetEvaluationRunsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityRulesetEvaluationRunsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataQualityRulesetEvaluationRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
