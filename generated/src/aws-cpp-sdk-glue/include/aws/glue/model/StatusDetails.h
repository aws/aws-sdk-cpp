...
class StatusDetails {
 public:
   ...
   */
  inline const Table& GetRequestedChange() const { return *m_requestedChange; }
  ...
  StatusDetails& WithRequestedChange(RequestedChangeT&& value) {
    SetRequestedChange(std::forward<RequestedChangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetViewValidations(ViewValidationsT&& value) {
    ...
    m_viewValidations = std::forward<ViewValidationsT>(value);
  }
  template <typename ViewValidationsT = Aws::Vector<ViewValidation>>
  StatusDetails& WithViewValidations(ViewValidationsT&& value) {
    SetViewValidations(std::forward<ViewValidationsT>(value));
    return *this;
  }
  template <typename ViewValidationsT = ViewValidation>
  StatusDetails& AddViewValidations(ViewValidationsT&& value) {
    m_viewValidationsHasBeenSet = true;
    m_viewValidations.emplace_back(std::forward<ViewValidationsT>(value));
    return *this;
  }
  ///@}
 private:
