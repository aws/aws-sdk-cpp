...
namespace Model
{
  ...
  public:
    ...
    template<typename SchemaNameT = Aws::String>
    UpdateSchemaResult& WithSchemaName(SchemaNameT&& value) { SetSchemaName(std::forward<SchemaNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegistryNameT = Aws::String>
    UpdateSchemaResult& WithRegistryName(RegistryNameT&& value) { SetRegistryName(std::forward<RegistryNameT>(value)); return *this;}
    ///@}
