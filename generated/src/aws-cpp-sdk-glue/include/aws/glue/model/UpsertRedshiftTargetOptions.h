...
class UpsertRedshiftTargetOptions {
 public:
  ...
  void SetTableLocation(TableLocationT&& value) {
    ...
    m_tableLocation = std::forward<TableLocationT>(value);
  }
  template <typename TableLocationT = Aws::String>
  UpsertRedshiftTargetOptions& WithTableLocation(TableLocationT&& value) {
    SetTableLocation(std::forward<TableLocationT>(value));
    return *this;
  }
  ///@}
