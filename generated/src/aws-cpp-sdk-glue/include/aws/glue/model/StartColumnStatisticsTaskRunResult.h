...
class StartColumnStatisticsTaskRunResult {
 public:
  ...
  template <typename ColumnStatisticsTaskRunIdT = Aws::String>
  StartColumnStatisticsTaskRunResult& WithColumnStatisticsTaskRunId(ColumnStatisticsTaskRunIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartColumnStatisticsTaskRunResult& WithRequestId(RequestIdT&& value) {
