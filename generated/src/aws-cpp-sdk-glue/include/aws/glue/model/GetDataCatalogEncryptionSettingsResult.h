...
class GetDataCatalogEncryptionSettingsResult {
 public:
  ...
  template <typename DataCatalogEncryptionSettingsT = DataCatalogEncryptionSettings>
  GetDataCatalogEncryptionSettingsResult& WithDataCatalogEncryptionSettings(DataCatalogEncryptionSettingsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDataCatalogEncryptionSettingsResult& WithRequestId(RequestIdT&& value) {
