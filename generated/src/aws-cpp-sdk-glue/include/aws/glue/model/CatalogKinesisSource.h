...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    CatalogKinesisSource& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TableT = Aws::String>
    CatalogKinesisSource& WithTable(TableT&& value) { SetTable(std::forward<TableT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    CatalogKinesisSource& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
    ...
    template<typename StreamingOptionsT = KinesisStreamingSourceOptions>
    CatalogKinesisSource& WithStreamingOptions(StreamingOptionsT&& value) { SetStreamingOptions(std::forward<StreamingOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename DataPreviewOptionsT = StreamingDataPreviewOptions>
    CatalogKinesisSource& WithDataPreviewOptions(DataPreviewOptionsT&& value) { SetDataPreviewOptions(std::forward<DataPreviewOptionsT>(value)); return *this;}
    ///@}
  private:
