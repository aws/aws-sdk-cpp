...
class CatalogKinesisSource {
 public:
  ...
  inline void SetWindowSize(int value) {
    m_windowSizeHasBeenSet = true;
    m_windowSize = value;
  }
  inline CatalogKinesisSource& WithWindowSize(int value) {
    SetWindowSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDetectSchema(bool value) {
    m_detectSchemaHasBeenSet = true;
    m_detectSchema = value;
  }
  inline CatalogKinesisSource& WithDetectSchema(bool value) {
    SetDetectSchema(value);
    return *this;
  }
  ///@}
  ...
  void SetStreamingOptions(StreamingOptionsT&& value) {
    ...
    m_streamingOptions = std::forward<StreamingOptionsT>(value);
  }
  template <typename StreamingOptionsT = KinesisStreamingSourceOptions>
  CatalogKinesisSource& WithStreamingOptions(StreamingOptionsT&& value) {
    SetStreamingOptions(std::forward<StreamingOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataPreviewOptions(DataPreviewOptionsT&& value) {
    ...
    m_dataPreviewOptions = std::forward<DataPreviewOptionsT>(value);
  }
  template <typename DataPreviewOptionsT = StreamingDataPreviewOptions>
  CatalogKinesisSource& WithDataPreviewOptions(DataPreviewOptionsT&& value) {
    SetDataPreviewOptions(std::forward<DataPreviewOptionsT>(value));
    return *this;
  }
  ///@}
 private:
