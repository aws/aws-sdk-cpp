...
class CatalogDeltaSource {
 public:
  ...
  template <typename NameT = Aws::String>
  CatalogDeltaSource& WithName(NameT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  CatalogDeltaSource& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  CatalogDeltaSource& WithTable(TableT&& value) {
  ...
  template <typename AdditionalDeltaOptionsT = Aws::Map<Aws::String, Aws::String>>
  CatalogDeltaSource& WithAdditionalDeltaOptions(AdditionalDeltaOptionsT&& value) {
  ...
  template <typename OutputSchemasT = Aws::Vector<GlueSchema>>
  CatalogDeltaSource& WithOutputSchemas(OutputSchemasT&& value) {
    SetOutputSchemas(std::forward<OutputSchemasT>(value));
    return *this;
  }
  template <typename OutputSchemasT = GlueSchema>
  CatalogDeltaSource& AddOutputSchemas(OutputSchemasT&& value) {
    m_outputSchemasHasBeenSet = true;
