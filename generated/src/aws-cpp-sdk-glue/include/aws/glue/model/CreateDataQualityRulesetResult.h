...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API CreateDataQualityRulesetResult() = default;
    ...
    template<typename NameT = Aws::String>
    CreateDataQualityRulesetResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateDataQualityRulesetResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
