...
class TaskRunProperties {
 public:
  ...
  inline TaskRunProperties& WithTaskType(TaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
  ...
  void SetImportLabelsTaskRunProperties(ImportLabelsTaskRunPropertiesT&& value) {
    ...
    m_importLabelsTaskRunProperties = std::forward<ImportLabelsTaskRunPropertiesT>(value);
  }
  template <typename ImportLabelsTaskRunPropertiesT = ImportLabelsTaskRunProperties>
  TaskRunProperties& WithImportLabelsTaskRunProperties(ImportLabelsTaskRunPropertiesT&& value) {
    SetImportLabelsTaskRunProperties(std::forward<ImportLabelsTaskRunPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportLabelsTaskRunProperties(ExportLabelsTaskRunPropertiesT&& value) {
    ...
    m_exportLabelsTaskRunProperties = std::forward<ExportLabelsTaskRunPropertiesT>(value);
  }
  template <typename ExportLabelsTaskRunPropertiesT = ExportLabelsTaskRunProperties>
  TaskRunProperties& WithExportLabelsTaskRunProperties(ExportLabelsTaskRunPropertiesT&& value) {
    SetExportLabelsTaskRunProperties(std::forward<ExportLabelsTaskRunPropertiesT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const LabelingSetGenerationTaskRunProperties& GetLabelingSetGenerationTaskRunProperties() const {
    return m_labelingSetGenerationTaskRunProperties;
  }
  ...
  void SetLabelingSetGenerationTaskRunProperties(LabelingSetGenerationTaskRunPropertiesT&& value) {
    ...
    m_labelingSetGenerationTaskRunProperties = std::forward<LabelingSetGenerationTaskRunPropertiesT>(value);
  }
  template <typename LabelingSetGenerationTaskRunPropertiesT = LabelingSetGenerationTaskRunProperties>
  TaskRunProperties& WithLabelingSetGenerationTaskRunProperties(LabelingSetGenerationTaskRunPropertiesT&& value) {
    SetLabelingSetGenerationTaskRunProperties(std::forward<LabelingSetGenerationTaskRunPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFindMatchesTaskRunProperties(FindMatchesTaskRunPropertiesT&& value) {
    ...
    m_findMatchesTaskRunProperties = std::forward<FindMatchesTaskRunPropertiesT>(value);
  }
  template <typename FindMatchesTaskRunPropertiesT = FindMatchesTaskRunProperties>
  TaskRunProperties& WithFindMatchesTaskRunProperties(FindMatchesTaskRunPropertiesT&& value) {
    SetFindMatchesTaskRunProperties(std::forward<FindMatchesTaskRunPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
