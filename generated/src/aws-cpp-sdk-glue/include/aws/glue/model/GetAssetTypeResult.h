...
class GetAssetTypeResult {
 public:
  AWS_GLUE_API GetAssetTypeResult() = default;
  AWS_GLUE_API GetAssetTypeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_GLUE_API GetAssetTypeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdT = Aws::String>
  GetAssetTypeResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAssetTypeResult& WithName(NameT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAssetTypeResult& WithRequestId(RequestIdT&& value) {
