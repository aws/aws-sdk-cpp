...
class UpdateTriggerRequest : public GlueRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateTriggerRequest& WithName(NameT&& value) {
  ...
  void SetTriggerUpdate(TriggerUpdateT&& value) {
    m_triggerUpdateHasBeenSet = true;
    m_triggerUpdate = std::forward<TriggerUpdateT>(value);
  }
  template <typename TriggerUpdateT = TriggerUpdate>
  UpdateTriggerRequest& WithTriggerUpdate(TriggerUpdateT&& value) {
    SetTriggerUpdate(std::forward<TriggerUpdateT>(value));
    return *this;
  }
  ///@}
 private:
