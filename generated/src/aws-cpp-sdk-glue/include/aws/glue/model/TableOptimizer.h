...
class TableOptimizer {
 public:
  ...
  inline TableOptimizer& WithType(TableOptimizerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConfigurationSource(ConfigurationSource value) {
    m_configurationSourceHasBeenSet = true;
    m_configurationSource = value;
  }
  inline TableOptimizer& WithConfigurationSource(ConfigurationSource value) {
