...
class BatchDeleteConnectionRequest : public GlueRequest {
 public:
  ...
  void SetConnectionNameList(ConnectionNameListT&& value) {
    m_connectionNameListHasBeenSet = true;
    m_connectionNameList = std::forward<ConnectionNameListT>(value);
  }
  template <typename ConnectionNameListT = Aws::Vector<Aws::String>>
  BatchDeleteConnectionRequest& WithConnectionNameList(ConnectionNameListT&& value) {
    SetConnectionNameList(std::forward<ConnectionNameListT>(value));
    return *this;
  }
  ...
  BatchDeleteConnectionRequest& AddConnectionNameList(ConnectionNameListT&& value) {
    m_connectionNameListHasBeenSet = true;
    m_connectionNameList.emplace_back(std::forward<ConnectionNameListT>(value));
    return *this;
  }
  ///@}
 private:
