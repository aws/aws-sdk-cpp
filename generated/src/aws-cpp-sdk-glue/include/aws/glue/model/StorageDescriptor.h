...
class StorageDescriptor {
 public:
  ...
  void SetAdditionalLocations(AdditionalLocationsT&& value) {
    ...
    m_additionalLocations = std::forward<AdditionalLocationsT>(value);
  }
  template <typename AdditionalLocationsT = Aws::Vector<Aws::String>>
  StorageDescriptor& WithAdditionalLocations(AdditionalLocationsT&& value) {
    SetAdditionalLocations(std::forward<AdditionalLocationsT>(value));
    return *this;
  }
  template <typename AdditionalLocationsT = Aws::String>
  StorageDescriptor& AddAdditionalLocations(AdditionalLocationsT&& value) {
    m_additionalLocationsHasBeenSet = true;
    m_additionalLocations.emplace_back(std::forward<AdditionalLocationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline StorageDescriptor& WithCompressed(bool value) {
    SetCompressed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfBuckets(int value) {
    m_numberOfBucketsHasBeenSet = true;
    m_numberOfBuckets = value;
  }
  inline StorageDescriptor& WithNumberOfBuckets(int value) {
  ...
  void SetSerdeInfo(SerdeInfoT&& value) {
    ...
    m_serdeInfo = std::forward<SerdeInfoT>(value);
  }
  template <typename SerdeInfoT = SerDeInfo>
  StorageDescriptor& WithSerdeInfo(SerdeInfoT&& value) {
    SetSerdeInfo(std::forward<SerdeInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBucketColumns(BucketColumnsT&& value) {
    ...
    m_bucketColumns = std::forward<BucketColumnsT>(value);
  }
  template <typename BucketColumnsT = Aws::Vector<Aws::String>>
  StorageDescriptor& WithBucketColumns(BucketColumnsT&& value) {
    SetBucketColumns(std::forward<BucketColumnsT>(value));
    return *this;
  }
  template <typename BucketColumnsT = Aws::String>
  StorageDescriptor& AddBucketColumns(BucketColumnsT&& value) {
    m_bucketColumnsHasBeenSet = true;
    m_bucketColumns.emplace_back(std::forward<BucketColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkewedInfo(SkewedInfoT&& value) {
    ...
    m_skewedInfo = std::forward<SkewedInfoT>(value);
  }
  template <typename SkewedInfoT = SkewedInfo>
  StorageDescriptor& WithSkewedInfo(SkewedInfoT&& value) {
    SetSkewedInfo(std::forward<SkewedInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStoredAsSubDirectories(bool value) {
    m_storedAsSubDirectoriesHasBeenSet = true;
    m_storedAsSubDirectories = value;
  }
  inline StorageDescriptor& WithStoredAsSubDirectories(bool value) {
    SetStoredAsSubDirectories(value);
    return *this;
  }
  ///@}
  ...
  void SetSchemaReference(SchemaReferenceT&& value) {
    ...
    m_schemaReference = std::forward<SchemaReferenceT>(value);
  }
  template <typename SchemaReferenceT = SchemaReference>
  StorageDescriptor& WithSchemaReference(SchemaReferenceT&& value) {
    SetSchemaReference(std::forward<SchemaReferenceT>(value));
    return *this;
  }
  ///@}
 private:
