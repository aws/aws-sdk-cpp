...
class FillMissingValues {
 public:
  ...
  template <typename NameT = Aws::String>
  FillMissingValues& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  FillMissingValues& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  FillMissingValues& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  void SetImputedPath(ImputedPathT&& value) {
    m_imputedPathHasBeenSet = true;
    m_imputedPath = std::forward<ImputedPathT>(value);
  }
  template <typename ImputedPathT = Aws::String>
  FillMissingValues& WithImputedPath(ImputedPathT&& value) {
    SetImputedPath(std::forward<ImputedPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilledPath(FilledPathT&& value) {
    m_filledPathHasBeenSet = true;
    m_filledPath = std::forward<FilledPathT>(value);
  }
  template <typename FilledPathT = Aws::String>
  FillMissingValues& WithFilledPath(FilledPathT&& value) {
    SetFilledPath(std::forward<FilledPathT>(value));
    return *this;
  }
  ///@}
 private:
