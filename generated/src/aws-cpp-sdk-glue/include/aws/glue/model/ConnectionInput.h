...
class ConnectionInput {
 public:
   ...
   * not natively supported by Glue.</p> </li> </ul> <p>For more information on the
   * connection parameters needed for a particular connector, see the documentation
  ...
  inline ConnectionInput& WithConnectionType(ConnectionType value) {
  ...
  inline ConnectionInput& WithValidateCredentials(bool value) {
  ...
  inline ConnectionInput& AddValidateForComputeEnvironments(ComputeEnvironment value) {
    m_validateForComputeEnvironmentsHasBeenSet = true;
