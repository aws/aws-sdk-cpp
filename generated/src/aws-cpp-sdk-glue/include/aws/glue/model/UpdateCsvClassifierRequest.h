...
class UpdateCsvClassifierRequest {
 public:
  ...
  inline UpdateCsvClassifierRequest& WithContainsHeader(CsvHeaderOption value) {
  ...
  inline UpdateCsvClassifierRequest& WithDisableValueTrimming(bool value) {
  ...
  inline UpdateCsvClassifierRequest& WithAllowSingleColumn(bool value) {
  ...
  inline UpdateCsvClassifierRequest& WithCustomDatatypeConfigured(bool value) {
  ...
  inline UpdateCsvClassifierRequest& WithSerde(CsvSerdeOption value) {
    SetSerde(value);
    return *this;
  }
  ///@}
