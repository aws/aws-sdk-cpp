...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    UpdateCrawlerRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    UpdateCrawlerRequest& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    UpdateCrawlerRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateCrawlerRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetsT = CrawlerTargets>
    UpdateCrawlerRequest& WithTargets(TargetsT&& value) { SetTargets(std::forward<TargetsT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleT = Aws::String>
    UpdateCrawlerRequest& WithSchedule(ScheduleT&& value) { SetSchedule(std::forward<ScheduleT>(value)); return *this;}
    ///@}
    ...
    template<typename ClassifiersT = Aws::Vector<Aws::String>>
    UpdateCrawlerRequest& WithClassifiers(ClassifiersT&& value) { SetClassifiers(std::forward<ClassifiersT>(value)); return *this;}
    template<typename ClassifiersT = Aws::String>
    UpdateCrawlerRequest& AddClassifiers(ClassifiersT&& value) { m_classifiersHasBeenSet = true; m_classifiers.emplace_back(std::forward<ClassifiersT>(value)); return *this; }
    ///@}
    ...
    template<typename TablePrefixT = Aws::String>
    UpdateCrawlerRequest& WithTablePrefix(TablePrefixT&& value) { SetTablePrefix(std::forward<TablePrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaChangePolicyT = SchemaChangePolicy>
    UpdateCrawlerRequest& WithSchemaChangePolicy(SchemaChangePolicyT&& value) { SetSchemaChangePolicy(std::forward<SchemaChangePolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename RecrawlPolicyT = RecrawlPolicy>
    UpdateCrawlerRequest& WithRecrawlPolicy(RecrawlPolicyT&& value) { SetRecrawlPolicy(std::forward<RecrawlPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename LineageConfigurationT = LineageConfiguration>
    UpdateCrawlerRequest& WithLineageConfiguration(LineageConfigurationT&& value) { SetLineageConfiguration(std::forward<LineageConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename LakeFormationConfigurationT = LakeFormationConfiguration>
    UpdateCrawlerRequest& WithLakeFormationConfiguration(LakeFormationConfigurationT&& value) { SetLakeFormationConfiguration(std::forward<LakeFormationConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfigurationT = Aws::String>
    UpdateCrawlerRequest& WithConfiguration(ConfigurationT&& value) { SetConfiguration(std::forward<ConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CrawlerSecurityConfigurationT = Aws::String>
    UpdateCrawlerRequest& WithCrawlerSecurityConfiguration(CrawlerSecurityConfigurationT&& value) { SetCrawlerSecurityConfiguration(std::forward<CrawlerSecurityConfigurationT>(value)); return *this;}
    ///@}
  private:
