...
class GetUnfilteredPartitionsMetadataRequest : public GlueRequest {
 public:
  ...
  template <typename RegionT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithRegion(RegionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename ExpressionT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithExpression(ExpressionT&& value) {
  ...
  template <typename AuditContextT = AuditContext>
  GetUnfilteredPartitionsMetadataRequest& WithAuditContext(AuditContextT&& value) {
  ...
  template <typename SupportedPermissionTypesT = Aws::Vector<PermissionType>>
  GetUnfilteredPartitionsMetadataRequest& WithSupportedPermissionTypes(SupportedPermissionTypesT&& value) {
    SetSupportedPermissionTypes(std::forward<SupportedPermissionTypesT>(value));
    return *this;
  }
  inline GetUnfilteredPartitionsMetadataRequest& AddSupportedPermissionTypes(PermissionType value) {
    m_supportedPermissionTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetUnfilteredPartitionsMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SegmentT = Segment>
  GetUnfilteredPartitionsMetadataRequest& WithSegment(SegmentT&& value) {
  ...
  inline GetUnfilteredPartitionsMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename QuerySessionContextT = QuerySessionContext>
  GetUnfilteredPartitionsMetadataRequest& WithQuerySessionContext(QuerySessionContextT&& value) {
