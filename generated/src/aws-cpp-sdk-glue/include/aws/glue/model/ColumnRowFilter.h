...
class ColumnRowFilter {
 public:
  ...
  template <typename ColumnNameT = Aws::String>
  ColumnRowFilter& WithColumnName(ColumnNameT&& value) {
  ...
  void SetRowFilterExpression(RowFilterExpressionT&& value) {
    m_rowFilterExpressionHasBeenSet = true;
    m_rowFilterExpression = std::forward<RowFilterExpressionT>(value);
  }
  template <typename RowFilterExpressionT = Aws::String>
  ColumnRowFilter& WithRowFilterExpression(RowFilterExpressionT&& value) {
    SetRowFilterExpression(std::forward<RowFilterExpressionT>(value));
    return *this;
  }
  ///@}
 private:
