...
class UpdateOpenTableFormatInput {
 public:
  ...
  void SetUpdateIcebergInput(UpdateIcebergInputT&& value) {
    m_updateIcebergInputHasBeenSet = true;
    m_updateIcebergInput = std::forward<UpdateIcebergInputT>(value);
  }
  template <typename UpdateIcebergInputT = UpdateIcebergInput>
  UpdateOpenTableFormatInput& WithUpdateIcebergInput(UpdateIcebergInputT&& value) {
    SetUpdateIcebergInput(std::forward<UpdateIcebergInputT>(value));
    return *this;
  }
  ///@}
 private:
