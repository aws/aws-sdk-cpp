...
class UpdateSourceControlFromJobRequest : public GlueRequest {
 public:
  ...
  inline UpdateSourceControlFromJobRequest& WithProvider(SourceControlProvider value) {
    SetProvider(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateSourceControlFromJobRequest& WithAuthStrategy(SourceControlAuthStrategy value) {
