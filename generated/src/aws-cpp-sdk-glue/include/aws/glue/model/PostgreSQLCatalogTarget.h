...
class PostgreSQLCatalogTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  PostgreSQLCatalogTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  PostgreSQLCatalogTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  PostgreSQLCatalogTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename DatabaseT = Aws::String>
  PostgreSQLCatalogTarget& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  PostgreSQLCatalogTarget& WithTable(TableT&& value) {
