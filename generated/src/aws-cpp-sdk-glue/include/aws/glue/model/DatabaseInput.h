...
class DatabaseInput {
 public:
  ...
  void SetTargetDatabase(TargetDatabaseT&& value) {
    ...
    m_targetDatabase = std::forward<TargetDatabaseT>(value);
  }
  template <typename TargetDatabaseT = DatabaseIdentifier>
  DatabaseInput& WithTargetDatabase(TargetDatabaseT&& value) {
    SetTargetDatabase(std::forward<TargetDatabaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFederatedDatabase(FederatedDatabaseT&& value) {
    ...
    m_federatedDatabase = std::forward<FederatedDatabaseT>(value);
  }
  template <typename FederatedDatabaseT = FederatedDatabase>
  DatabaseInput& WithFederatedDatabase(FederatedDatabaseT&& value) {
    SetFederatedDatabase(std::forward<FederatedDatabaseT>(value));
    return *this;
  }
  ///@}
 private:
