...
namespace Model
{
  ...
  public:
    ...
    template<typename DatabaseNameT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TableNameT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithSchedule(ScheduleT&& value) { SetSchedule(std::forward<ScheduleT>(value)); return *this;}
    ///@}
    ...
    template<typename ColumnNameListT = Aws::Vector<Aws::String>>
    UpdateColumnStatisticsTaskSettingsRequest& WithColumnNameList(ColumnNameListT&& value) { SetColumnNameList(std::forward<ColumnNameListT>(value)); return *this;}
    template<typename ColumnNameListT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& AddColumnNameList(ColumnNameListT&& value) { m_columnNameListHasBeenSet = true; m_columnNameList.emplace_back(std::forward<ColumnNameListT>(value)); return *this; }
    ///@}
    ...
    template<typename CatalogIDT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithCatalogID(CatalogIDT&& value) { SetCatalogID(std::forward<CatalogIDT>(value)); return *this;}
    ///@}
    ...
    template<typename SecurityConfigurationT = Aws::String>
    UpdateColumnStatisticsTaskSettingsRequest& WithSecurityConfiguration(SecurityConfigurationT&& value) { SetSecurityConfiguration(std::forward<SecurityConfigurationT>(value)); return *this;}
    ///@}
  private:
