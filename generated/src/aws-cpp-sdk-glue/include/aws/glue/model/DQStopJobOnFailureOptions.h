...
class DQStopJobOnFailureOptions {
 public:
  ...
  inline void SetStopJobOnFailureTiming(DQStopJobOnFailureTiming value) {
    m_stopJobOnFailureTimingHasBeenSet = true;
    m_stopJobOnFailureTiming = value;
  }
  inline DQStopJobOnFailureOptions& WithStopJobOnFailureTiming(DQStopJobOnFailureTiming value) {
    SetStopJobOnFailureTiming(value);
    return *this;
  }
  ///@}
 private:
