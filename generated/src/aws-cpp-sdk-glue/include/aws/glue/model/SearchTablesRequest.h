...
class SearchTablesRequest : public GlueRequest {
 public:
  ...
  inline SearchTablesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline SearchTablesRequest& WithResourceShareType(ResourceShareType value) {
  ...
  inline SearchTablesRequest& WithIncludeStatusDetails(bool value) {
