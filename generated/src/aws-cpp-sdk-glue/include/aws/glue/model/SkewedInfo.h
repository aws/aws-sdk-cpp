...
class SkewedInfo {
 public:
  ...
  void SetSkewedColumnNames(SkewedColumnNamesT&& value) {
    ...
    m_skewedColumnNames = std::forward<SkewedColumnNamesT>(value);
  }
  template <typename SkewedColumnNamesT = Aws::Vector<Aws::String>>
  SkewedInfo& WithSkewedColumnNames(SkewedColumnNamesT&& value) {
    SetSkewedColumnNames(std::forward<SkewedColumnNamesT>(value));
    return *this;
  }
  template <typename SkewedColumnNamesT = Aws::String>
  SkewedInfo& AddSkewedColumnNames(SkewedColumnNamesT&& value) {
    m_skewedColumnNamesHasBeenSet = true;
    m_skewedColumnNames.emplace_back(std::forward<SkewedColumnNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkewedColumnValues(SkewedColumnValuesT&& value) {
    ...
    m_skewedColumnValues = std::forward<SkewedColumnValuesT>(value);
  }
  template <typename SkewedColumnValuesT = Aws::Vector<Aws::String>>
  SkewedInfo& WithSkewedColumnValues(SkewedColumnValuesT&& value) {
    SetSkewedColumnValues(std::forward<SkewedColumnValuesT>(value));
    return *this;
  }
  template <typename SkewedColumnValuesT = Aws::String>
  SkewedInfo& AddSkewedColumnValues(SkewedColumnValuesT&& value) {
    m_skewedColumnValuesHasBeenSet = true;
    m_skewedColumnValues.emplace_back(std::forward<SkewedColumnValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkewedColumnValueLocationMaps(SkewedColumnValueLocationMapsT&& value) {
    ...
    m_skewedColumnValueLocationMaps = std::forward<SkewedColumnValueLocationMapsT>(value);
  }
  template <typename SkewedColumnValueLocationMapsT = Aws::Map<Aws::String, Aws::String>>
  SkewedInfo& WithSkewedColumnValueLocationMaps(SkewedColumnValueLocationMapsT&& value) {
    SetSkewedColumnValueLocationMaps(std::forward<SkewedColumnValueLocationMapsT>(value));
    return *this;
  }
  ...
  SkewedInfo& AddSkewedColumnValueLocationMaps(SkewedColumnValueLocationMapsKeyT&& key, SkewedColumnValueLocationMapsValueT&& value) {
    m_skewedColumnValueLocationMapsHasBeenSet = true;
    m_skewedColumnValueLocationMaps.emplace(std::forward<SkewedColumnValueLocationMapsKeyT>(key),
                                            std::forward<SkewedColumnValueLocationMapsValueT>(value));
    return *this;
  }
  ///@}
 private:
