...
class MLUserDataEncryption {
 public:
  ...
  inline void SetMlUserDataEncryptionMode(MLUserDataEncryptionModeString value) {
    m_mlUserDataEncryptionModeHasBeenSet = true;
    m_mlUserDataEncryptionMode = value;
  }
  inline MLUserDataEncryption& WithMlUserDataEncryptionMode(MLUserDataEncryptionModeString value) {
    SetMlUserDataEncryptionMode(value);
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  MLUserDataEncryption& WithKmsKeyId(KmsKeyIdT&& value) {
