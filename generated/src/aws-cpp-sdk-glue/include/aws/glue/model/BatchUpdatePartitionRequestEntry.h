...
class BatchUpdatePartitionRequestEntry {
 public:
  ...
  template <typename PartitionValueListT = Aws::Vector<Aws::String>>
  BatchUpdatePartitionRequestEntry& WithPartitionValueList(PartitionValueListT&& value) {
    SetPartitionValueList(std::forward<PartitionValueListT>(value));
    return *this;
  }
  template <typename PartitionValueListT = Aws::String>
  BatchUpdatePartitionRequestEntry& AddPartitionValueList(PartitionValueListT&& value) {
    m_partitionValueListHasBeenSet = true;
  ...
  void SetPartitionInput(PartitionInputT&& value) {
    ...
    m_partitionInput = std::forward<PartitionInputT>(value);
  }
  template <typename PartitionInputT = PartitionInput>
  BatchUpdatePartitionRequestEntry& WithPartitionInput(PartitionInputT&& value) {
    SetPartitionInput(std::forward<PartitionInputT>(value));
    return *this;
  }
  ///@}
 private:
