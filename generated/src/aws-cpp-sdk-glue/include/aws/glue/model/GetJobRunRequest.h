...
class GetJobRunRequest : public GlueRequest {
 public:
  ...
  inline void SetPredecessorsIncluded(bool value) {
    m_predecessorsIncludedHasBeenSet = true;
    m_predecessorsIncluded = value;
  }
  inline GetJobRunRequest& WithPredecessorsIncluded(bool value) {
    SetPredecessorsIncluded(value);
    return *this;
  }
  ///@}
 private:
