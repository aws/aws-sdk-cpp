...
namespace Model
{
  ...
  public:
    ...
    template<typename DescriptionT = Aws::String>
    AllowedValue& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    AllowedValue& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
