...
class S3HyperDirectTarget {
 public:
  ...
  inline S3HyperDirectTarget& WithFormat(TargetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompression(HyperTargetCompressionType value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline S3HyperDirectTarget& WithCompression(HyperTargetCompressionType value) {
