...
class FindMatchesMetrics {
 public:
  ...
  inline void SetAreaUnderPRCurve(double value) {
    m_areaUnderPRCurveHasBeenSet = true;
    m_areaUnderPRCurve = value;
  }
  inline FindMatchesMetrics& WithAreaUnderPRCurve(double value) {
    SetAreaUnderPRCurve(value);
    return *this;
  }
  ///@}
  ...
  inline FindMatchesMetrics& WithPrecision(double value) {
    SetPrecision(value);
    return *this;
  }
  ///@}
  ...
  inline FindMatchesMetrics& WithRecall(double value) {
    SetRecall(value);
    return *this;
  }
  ///@}
  ...
  inline void SetF1(double value) {
    m_f1HasBeenSet = true;
    m_f1 = value;
  }
  inline FindMatchesMetrics& WithF1(double value) {
    SetF1(value);
    return *this;
  }
  ///@}
  ...
  void SetConfusionMatrix(ConfusionMatrixT&& value) {
    ...
    m_confusionMatrix = std::forward<ConfusionMatrixT>(value);
  }
  template <typename ConfusionMatrixT = ConfusionMatrix>
  FindMatchesMetrics& WithConfusionMatrix(ConfusionMatrixT&& value) {
    SetConfusionMatrix(std::forward<ConfusionMatrixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetColumnImportances(ColumnImportancesT&& value) {
    ...
    m_columnImportances = std::forward<ColumnImportancesT>(value);
  }
  template <typename ColumnImportancesT = Aws::Vector<ColumnImportance>>
  FindMatchesMetrics& WithColumnImportances(ColumnImportancesT&& value) {
    SetColumnImportances(std::forward<ColumnImportancesT>(value));
    return *this;
  }
  template <typename ColumnImportancesT = ColumnImportance>
  FindMatchesMetrics& AddColumnImportances(ColumnImportancesT&& value) {
    m_columnImportancesHasBeenSet = true;
    m_columnImportances.emplace_back(std::forward<ColumnImportancesT>(value));
    return *this;
  }
  ///@}
 private:
