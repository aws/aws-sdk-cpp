...
class BooleanColumnStatisticsData {
 public:
  ...
  inline void SetNumberOfTrues(long long value) {
    m_numberOfTruesHasBeenSet = true;
    m_numberOfTrues = value;
  }
  inline BooleanColumnStatisticsData& WithNumberOfTrues(long long value) {
    SetNumberOfTrues(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfFalses(long long value) {
    m_numberOfFalsesHasBeenSet = true;
    m_numberOfFalses = value;
  }
  inline BooleanColumnStatisticsData& WithNumberOfFalses(long long value) {
    SetNumberOfFalses(value);
    return *this;
  }
  ///@}
  ...
  inline BooleanColumnStatisticsData& WithNumberOfNulls(long long value) {
