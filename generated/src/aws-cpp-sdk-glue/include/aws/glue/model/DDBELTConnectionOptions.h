...
class DDBELTConnectionOptions {
 public:
  ...
  inline void SetDynamodbExport(DdbExportType value) {
    m_dynamodbExportHasBeenSet = true;
    m_dynamodbExport = value;
  }
  inline DDBELTConnectionOptions& WithDynamodbExport(DdbExportType value) {
    SetDynamodbExport(value);
    return *this;
  }
  ///@}
  ...
  inline DDBELTConnectionOptions& WithDynamodbUnnestDDBJson(bool value) {
  ...
  void SetDynamodbTableArn(DynamodbTableArnT&& value) {
    m_dynamodbTableArnHasBeenSet = true;
    m_dynamodbTableArn = std::forward<DynamodbTableArnT>(value);
  }
  template <typename DynamodbTableArnT = Aws::String>
  DDBELTConnectionOptions& WithDynamodbTableArn(DynamodbTableArnT&& value) {
    SetDynamodbTableArn(std::forward<DynamodbTableArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamodbS3Bucket(DynamodbS3BucketT&& value) {
    m_dynamodbS3BucketHasBeenSet = true;
    m_dynamodbS3Bucket = std::forward<DynamodbS3BucketT>(value);
  }
  template <typename DynamodbS3BucketT = Aws::String>
  DDBELTConnectionOptions& WithDynamodbS3Bucket(DynamodbS3BucketT&& value) {
    SetDynamodbS3Bucket(std::forward<DynamodbS3BucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamodbS3Prefix(DynamodbS3PrefixT&& value) {
    m_dynamodbS3PrefixHasBeenSet = true;
    m_dynamodbS3Prefix = std::forward<DynamodbS3PrefixT>(value);
  }
  template <typename DynamodbS3PrefixT = Aws::String>
  DDBELTConnectionOptions& WithDynamodbS3Prefix(DynamodbS3PrefixT&& value) {
    SetDynamodbS3Prefix(std::forward<DynamodbS3PrefixT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamodbS3BucketOwner(DynamodbS3BucketOwnerT&& value) {
    m_dynamodbS3BucketOwnerHasBeenSet = true;
    m_dynamodbS3BucketOwner = std::forward<DynamodbS3BucketOwnerT>(value);
  }
  template <typename DynamodbS3BucketOwnerT = Aws::String>
  DDBELTConnectionOptions& WithDynamodbS3BucketOwner(DynamodbS3BucketOwnerT&& value) {
    SetDynamodbS3BucketOwner(std::forward<DynamodbS3BucketOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamodbStsRoleArn(DynamodbStsRoleArnT&& value) {
    m_dynamodbStsRoleArnHasBeenSet = true;
    m_dynamodbStsRoleArn = std::forward<DynamodbStsRoleArnT>(value);
  }
  template <typename DynamodbStsRoleArnT = Aws::String>
  DDBELTConnectionOptions& WithDynamodbStsRoleArn(DynamodbStsRoleArnT&& value) {
    SetDynamodbStsRoleArn(std::forward<DynamodbStsRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
