...
class Recipe {
 public:
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  Recipe& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  Recipe& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename RecipeReferenceT = RecipeReference>
  Recipe& WithRecipeReference(RecipeReferenceT&& value) {
  ...
  void SetRecipeSteps(RecipeStepsT&& value) {
    m_recipeStepsHasBeenSet = true;
    m_recipeSteps = std::forward<RecipeStepsT>(value);
  }
  template <typename RecipeStepsT = Aws::Vector<RecipeStep>>
  Recipe& WithRecipeSteps(RecipeStepsT&& value) {
    SetRecipeSteps(std::forward<RecipeStepsT>(value));
    return *this;
  }
  template <typename RecipeStepsT = RecipeStep>
  Recipe& AddRecipeSteps(RecipeStepsT&& value) {
    m_recipeStepsHasBeenSet = true;
    m_recipeSteps.emplace_back(std::forward<RecipeStepsT>(value));
    return *this;
  }
  ///@}
 private:
