...
class Workflow {
 public:
  ...
  void SetDefaultRunProperties(DefaultRunPropertiesT&& value) {
    ...
    m_defaultRunProperties = std::forward<DefaultRunPropertiesT>(value);
  }
  template <typename DefaultRunPropertiesT = Aws::Map<Aws::String, Aws::String>>
  Workflow& WithDefaultRunProperties(DefaultRunPropertiesT&& value) {
    SetDefaultRunProperties(std::forward<DefaultRunPropertiesT>(value));
    return *this;
  }
  ...
  Workflow& AddDefaultRunProperties(DefaultRunPropertiesKeyT&& key, DefaultRunPropertiesValueT&& value) {
    m_defaultRunPropertiesHasBeenSet = true;
    m_defaultRunProperties.emplace(std::forward<DefaultRunPropertiesKeyT>(key), std::forward<DefaultRunPropertiesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastRun(LastRunT&& value) {
    ...
    m_lastRun = std::forward<LastRunT>(value);
  }
  template <typename LastRunT = WorkflowRun>
  Workflow& WithLastRun(LastRunT&& value) {
    SetLastRun(std::forward<LastRunT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGraph(GraphT&& value) {
    ...
    m_graph = std::forward<GraphT>(value);
  }
  template <typename GraphT = WorkflowGraph>
  Workflow& WithGraph(GraphT&& value) {
    SetGraph(std::forward<GraphT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentRuns(int value) {
    m_maxConcurrentRunsHasBeenSet = true;
    m_maxConcurrentRuns = value;
  }
  inline Workflow& WithMaxConcurrentRuns(int value) {
  ...
  void SetBlueprintDetails(BlueprintDetailsT&& value) {
    ...
    m_blueprintDetails = std::forward<BlueprintDetailsT>(value);
  }
  template <typename BlueprintDetailsT = BlueprintDetails>
  Workflow& WithBlueprintDetails(BlueprintDetailsT&& value) {
    SetBlueprintDetails(std::forward<BlueprintDetailsT>(value));
    return *this;
  }
  ///@}
 private:
