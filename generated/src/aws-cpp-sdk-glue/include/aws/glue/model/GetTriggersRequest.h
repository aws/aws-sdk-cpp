...
class GetTriggersRequest : public GlueRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetTriggersRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename DependentJobNameT = Aws::String>
  GetTriggersRequest& WithDependentJobName(DependentJobNameT&& value) {
  ...
  inline GetTriggersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
