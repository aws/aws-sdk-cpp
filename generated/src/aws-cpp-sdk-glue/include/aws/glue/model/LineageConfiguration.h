...
class LineageConfiguration {
 public:
  ...
  inline void SetCrawlerLineageSettings(CrawlerLineageSettings value) {
    m_crawlerLineageSettingsHasBeenSet = true;
    m_crawlerLineageSettings = value;
  }
  inline LineageConfiguration& WithCrawlerLineageSettings(CrawlerLineageSettings value) {
    SetCrawlerLineageSettings(value);
    return *this;
  }
  ///@}
 private:
