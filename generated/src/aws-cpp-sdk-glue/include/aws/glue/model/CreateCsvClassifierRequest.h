...
class CreateCsvClassifierRequest {
 public:
  ...
  inline CreateCsvClassifierRequest& WithContainsHeader(CsvHeaderOption value) {
  ...
  inline CreateCsvClassifierRequest& WithDisableValueTrimming(bool value) {
  ...
  inline CreateCsvClassifierRequest& WithAllowSingleColumn(bool value) {
  ...
  inline CreateCsvClassifierRequest& WithCustomDatatypeConfigured(bool value) {
  ...
  inline CreateCsvClassifierRequest& WithSerde(CsvSerdeOption value) {
    SetSerde(value);
    return *this;
  }
  ///@}
