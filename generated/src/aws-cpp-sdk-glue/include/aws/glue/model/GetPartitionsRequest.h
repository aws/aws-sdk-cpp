...
class GetPartitionsRequest : public GlueRequest {
 public:
  ...
  inline GetPartitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetExcludeColumnSchema(bool value) {
    m_excludeColumnSchemaHasBeenSet = true;
    m_excludeColumnSchema = value;
  }
  inline GetPartitionsRequest& WithExcludeColumnSchema(bool value) {
    SetExcludeColumnSchema(value);
    return *this;
  }
  ///@}
