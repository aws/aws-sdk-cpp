...
class IcebergCompactionMetrics {
 public:
  ...
  inline void SetNumberOfBytesCompacted(long long value) {
    m_numberOfBytesCompactedHasBeenSet = true;
    m_numberOfBytesCompacted = value;
  }
  inline IcebergCompactionMetrics& WithNumberOfBytesCompacted(long long value) {
    SetNumberOfBytesCompacted(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfFilesCompacted(long long value) {
    m_numberOfFilesCompactedHasBeenSet = true;
    m_numberOfFilesCompacted = value;
  }
  inline IcebergCompactionMetrics& WithNumberOfFilesCompacted(long long value) {
    SetNumberOfFilesCompacted(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergCompactionMetrics& WithDpuHours(double value) {
    SetDpuHours(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergCompactionMetrics& WithNumberOfDpus(int value) {
  ...
  inline IcebergCompactionMetrics& WithJobDurationInHour(double value) {
