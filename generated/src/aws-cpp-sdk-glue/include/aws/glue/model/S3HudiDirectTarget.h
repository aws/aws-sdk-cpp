...
class S3HudiDirectTarget {
 public:
  ...
  inline void SetCompression(HudiTargetCompressionType value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline S3HudiDirectTarget& WithCompression(HudiTargetCompressionType value) {
  ...
  inline S3HudiDirectTarget& WithFormat(TargetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename AutoDataQualityT = AutoDataQuality>
  S3HudiDirectTarget& WithAutoDataQuality(AutoDataQualityT&& value) {
