...
class IcebergRetentionConfiguration {
 public:
  ...
  inline void SetSnapshotRetentionPeriodInDays(int value) {
    m_snapshotRetentionPeriodInDaysHasBeenSet = true;
    m_snapshotRetentionPeriodInDays = value;
  }
  inline IcebergRetentionConfiguration& WithSnapshotRetentionPeriodInDays(int value) {
    SetSnapshotRetentionPeriodInDays(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfSnapshotsToRetain(int value) {
    m_numberOfSnapshotsToRetainHasBeenSet = true;
    m_numberOfSnapshotsToRetain = value;
  }
  inline IcebergRetentionConfiguration& WithNumberOfSnapshotsToRetain(int value) {
    SetNumberOfSnapshotsToRetain(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCleanExpiredFiles(bool value) {
    m_cleanExpiredFilesHasBeenSet = true;
    m_cleanExpiredFiles = value;
  }
  inline IcebergRetentionConfiguration& WithCleanExpiredFiles(bool value) {
    SetCleanExpiredFiles(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRunRateInHours(int value) {
    m_runRateInHoursHasBeenSet = true;
    m_runRateInHours = value;
  }
  inline IcebergRetentionConfiguration& WithRunRateInHours(int value) {
    SetRunRateInHours(value);
    return *this;
  }
  ///@}
 private:
