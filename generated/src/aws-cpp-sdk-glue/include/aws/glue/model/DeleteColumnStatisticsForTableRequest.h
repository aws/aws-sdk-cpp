...
/**
 */
class DeleteColumnStatisticsForTableRequest : public GlueRequest {
 public:
  AWS_GLUE_API DeleteColumnStatisticsForTableRequest() = default;
  ...
  template <typename CatalogIdT = Aws::String>
  DeleteColumnStatisticsForTableRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteColumnStatisticsForTableRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  DeleteColumnStatisticsForTableRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename ColumnNameT = Aws::String>
  DeleteColumnStatisticsForTableRequest& WithColumnName(ColumnNameT&& value) {
