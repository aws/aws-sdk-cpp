...
class GetCrawlerMetricsRequest : public GlueRequest {
 public:
  ...
  void SetCrawlerNameList(CrawlerNameListT&& value) {
    m_crawlerNameListHasBeenSet = true;
    m_crawlerNameList = std::forward<CrawlerNameListT>(value);
  }
  template <typename CrawlerNameListT = Aws::Vector<Aws::String>>
  GetCrawlerMetricsRequest& WithCrawlerNameList(CrawlerNameListT&& value) {
    SetCrawlerNameList(std::forward<CrawlerNameListT>(value));
    return *this;
  }
  template <typename CrawlerNameListT = Aws::String>
  GetCrawlerMetricsRequest& AddCrawlerNameList(CrawlerNameListT&& value) {
    m_crawlerNameListHasBeenSet = true;
    m_crawlerNameList.emplace_back(std::forward<CrawlerNameListT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCrawlerMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
