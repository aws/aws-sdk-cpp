...
class KafkaStreamingSourceOptions {
 public:
  ...
  void SetBootstrapServers(BootstrapServersT&& value) {
    ...
    m_bootstrapServers = std::forward<BootstrapServersT>(value);
  }
  template <typename BootstrapServersT = Aws::String>
  KafkaStreamingSourceOptions& WithBootstrapServers(BootstrapServersT&& value) {
    SetBootstrapServers(std::forward<BootstrapServersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityProtocol(SecurityProtocolT&& value) {
    ...
    m_securityProtocol = std::forward<SecurityProtocolT>(value);
  }
  template <typename SecurityProtocolT = Aws::String>
  KafkaStreamingSourceOptions& WithSecurityProtocol(SecurityProtocolT&& value) {
    SetSecurityProtocol(std::forward<SecurityProtocolT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssign(AssignT&& value) {
    ...
    m_assign = std::forward<AssignT>(value);
  }
  template <typename AssignT = Aws::String>
  KafkaStreamingSourceOptions& WithAssign(AssignT&& value) {
    SetAssign(std::forward<AssignT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubscribePattern(SubscribePatternT&& value) {
    ...
    m_subscribePattern = std::forward<SubscribePatternT>(value);
  }
  template <typename SubscribePatternT = Aws::String>
  KafkaStreamingSourceOptions& WithSubscribePattern(SubscribePatternT&& value) {
    SetSubscribePattern(std::forward<SubscribePatternT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStartingOffsets(StartingOffsetsT&& value) {
    ...
    m_startingOffsets = std::forward<StartingOffsetsT>(value);
  }
  template <typename StartingOffsetsT = Aws::String>
  KafkaStreamingSourceOptions& WithStartingOffsets(StartingOffsetsT&& value) {
    SetStartingOffsets(std::forward<StartingOffsetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndingOffsets(EndingOffsetsT&& value) {
    ...
    m_endingOffsets = std::forward<EndingOffsetsT>(value);
  }
  template <typename EndingOffsetsT = Aws::String>
  KafkaStreamingSourceOptions& WithEndingOffsets(EndingOffsetsT&& value) {
    SetEndingOffsets(std::forward<EndingOffsetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPollTimeoutMs(long long value) {
    m_pollTimeoutMsHasBeenSet = true;
    m_pollTimeoutMs = value;
  }
  inline KafkaStreamingSourceOptions& WithPollTimeoutMs(long long value) {
  ...
  inline KafkaStreamingSourceOptions& WithNumRetries(int value) {
    SetNumRetries(value);
    return *this;
  }
  ///@}
  ...
  inline KafkaStreamingSourceOptions& WithRetryIntervalMs(long long value) {
  ...
  inline void SetMaxOffsetsPerTrigger(long long value) {
    m_maxOffsetsPerTriggerHasBeenSet = true;
    m_maxOffsetsPerTrigger = value;
  }
  inline KafkaStreamingSourceOptions& WithMaxOffsetsPerTrigger(long long value) {
    SetMaxOffsetsPerTrigger(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinPartitions(int value) {
    m_minPartitionsHasBeenSet = true;
    m_minPartitions = value;
  }
  inline KafkaStreamingSourceOptions& WithMinPartitions(int value) {
    SetMinPartitions(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeHeaders(bool value) {
    m_includeHeadersHasBeenSet = true;
    m_includeHeaders = value;
  }
  inline KafkaStreamingSourceOptions& WithIncludeHeaders(bool value) {
