...
class CreateDevEndpointRequest : public GlueRequest {
 public:
  ...
  inline CreateDevEndpointRequest& WithNumberOfNodes(int value) {
  ...
  inline CreateDevEndpointRequest& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDevEndpointRequest& WithNumberOfWorkers(int value) {
