...
class Statement {
 public:
  ...
  inline Statement& WithId(int value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(StatementState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Statement& WithState(StatementState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline Statement& WithProgress(double value) {
    SetProgress(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartedOn(long long value) {
    m_startedOnHasBeenSet = true;
    m_startedOn = value;
  }
  inline Statement& WithStartedOn(long long value) {
    SetStartedOn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompletedOn(long long value) {
    m_completedOnHasBeenSet = true;
    m_completedOn = value;
  }
  inline Statement& WithCompletedOn(long long value) {
