...
namespace Model
{
  ...
  /**
   */
  class DeletePartitionRequest : public GlueRequest
  {
  public:
    ...
    template<typename CatalogIdT = Aws::String>
    DeletePartitionRequest& WithCatalogId(CatalogIdT&& value) { SetCatalogId(std::forward<CatalogIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    DeletePartitionRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TableNameT = Aws::String>
    DeletePartitionRequest& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PartitionValuesT = Aws::Vector<Aws::String>>
    DeletePartitionRequest& WithPartitionValues(PartitionValuesT&& value) { SetPartitionValues(std::forward<PartitionValuesT>(value)); return *this;}
    template<typename PartitionValuesT = Aws::String>
    DeletePartitionRequest& AddPartitionValues(PartitionValuesT&& value) { m_partitionValuesHasBeenSet = true; m_partitionValues.emplace_back(std::forward<PartitionValuesT>(value)); return *this; }
    ///@}
  private:
