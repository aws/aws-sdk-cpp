...
class TestConnectionRequest : public GlueRequest {
 public:
  ...
  void SetTestConnectionInput(TestConnectionInputT&& value) {
    m_testConnectionInputHasBeenSet = true;
    m_testConnectionInput = std::forward<TestConnectionInputT>(value);
  }
  template <typename TestConnectionInputT = TestConnectionInput>
  TestConnectionRequest& WithTestConnectionInput(TestConnectionInputT&& value) {
    SetTestConnectionInput(std::forward<TestConnectionInputT>(value));
    return *this;
  }
  ///@}
 private:
