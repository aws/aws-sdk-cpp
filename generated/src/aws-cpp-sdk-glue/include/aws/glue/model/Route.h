...
class Route {
 public:
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  Route& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  Route& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  void SetGroupFiltersList(GroupFiltersListT&& value) {
    m_groupFiltersListHasBeenSet = true;
    m_groupFiltersList = std::forward<GroupFiltersListT>(value);
  }
  template <typename GroupFiltersListT = Aws::Vector<GroupFilters>>
  Route& WithGroupFiltersList(GroupFiltersListT&& value) {
    SetGroupFiltersList(std::forward<GroupFiltersListT>(value));
    return *this;
  }
  template <typename GroupFiltersListT = GroupFilters>
  Route& AddGroupFiltersList(GroupFiltersListT&& value) {
    m_groupFiltersListHasBeenSet = true;
    m_groupFiltersList.emplace_back(std::forward<GroupFiltersListT>(value));
    return *this;
  }
  ///@}
 private:
