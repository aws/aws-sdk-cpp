...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API PutDataCatalogEncryptionSettingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutDataCatalogEncryptionSettingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
