...
class JDBCConnectorOptions {
 public:
  ...
  template <typename FilterPredicateT = Aws::String>
  JDBCConnectorOptions& WithFilterPredicate(FilterPredicateT&& value) {
  ...
  void SetPartitionColumn(PartitionColumnT&& value) {
    m_partitionColumnHasBeenSet = true;
    m_partitionColumn = std::forward<PartitionColumnT>(value);
  }
  template <typename PartitionColumnT = Aws::String>
  JDBCConnectorOptions& WithPartitionColumn(PartitionColumnT&& value) {
    SetPartitionColumn(std::forward<PartitionColumnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLowerBound(long long value) {
    m_lowerBoundHasBeenSet = true;
    m_lowerBound = value;
  }
  inline JDBCConnectorOptions& WithLowerBound(long long value) {
    SetLowerBound(value);
    return *this;
  }
  ///@}
  ...
  inline JDBCConnectorOptions& WithUpperBound(long long value) {
    SetUpperBound(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumPartitions(long long value) {
    m_numPartitionsHasBeenSet = true;
    m_numPartitions = value;
  }
  inline JDBCConnectorOptions& WithNumPartitions(long long value) {
  ...
  void SetJobBookmarkKeys(JobBookmarkKeysT&& value) {
    m_jobBookmarkKeysHasBeenSet = true;
    m_jobBookmarkKeys = std::forward<JobBookmarkKeysT>(value);
  }
  template <typename JobBookmarkKeysT = Aws::Vector<Aws::String>>
  JDBCConnectorOptions& WithJobBookmarkKeys(JobBookmarkKeysT&& value) {
    SetJobBookmarkKeys(std::forward<JobBookmarkKeysT>(value));
    return *this;
  }
  template <typename JobBookmarkKeysT = Aws::String>
  JDBCConnectorOptions& AddJobBookmarkKeys(JobBookmarkKeysT&& value) {
    m_jobBookmarkKeysHasBeenSet = true;
    m_jobBookmarkKeys.emplace_back(std::forward<JobBookmarkKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobBookmarkKeysSortOrder(JobBookmarkKeysSortOrderT&& value) {
    m_jobBookmarkKeysSortOrderHasBeenSet = true;
    m_jobBookmarkKeysSortOrder = std::forward<JobBookmarkKeysSortOrderT>(value);
  }
  template <typename JobBookmarkKeysSortOrderT = Aws::String>
  JDBCConnectorOptions& WithJobBookmarkKeysSortOrder(JobBookmarkKeysSortOrderT&& value) {
    SetJobBookmarkKeysSortOrder(std::forward<JobBookmarkKeysSortOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataTypeMapping(DataTypeMappingT&& value) {
    m_dataTypeMappingHasBeenSet = true;
    m_dataTypeMapping = std::forward<DataTypeMappingT>(value);
  }
  template <typename DataTypeMappingT = Aws::Map<JDBCDataType, GlueRecordType>>
  JDBCConnectorOptions& WithDataTypeMapping(DataTypeMappingT&& value) {
    SetDataTypeMapping(std::forward<DataTypeMappingT>(value));
    return *this;
  }
  inline JDBCConnectorOptions& AddDataTypeMapping(JDBCDataType key, GlueRecordType value) {
    m_dataTypeMappingHasBeenSet = true;
    m_dataTypeMapping.emplace(key, value);
    return *this;
  }
  ///@}
 private:
