...
class Join {
 public:
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  Join& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  Join& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  inline void SetJoinType(JoinType value) {
    m_joinTypeHasBeenSet = true;
    m_joinType = value;
  }
  inline Join& WithJoinType(JoinType value) {
    SetJoinType(value);
    return *this;
  }
  ///@}
