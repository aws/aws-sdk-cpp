...
class UpdateTableOptimizerRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateTableOptimizerRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  UpdateTableOptimizerRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  UpdateTableOptimizerRequest& WithTableName(TableNameT&& value) {
  ...
  inline void SetType(TableOptimizerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline UpdateTableOptimizerRequest& WithType(TableOptimizerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetTableOptimizerConfiguration(TableOptimizerConfigurationT&& value) {
    m_tableOptimizerConfigurationHasBeenSet = true;
    m_tableOptimizerConfiguration = std::forward<TableOptimizerConfigurationT>(value);
  }
  template <typename TableOptimizerConfigurationT = TableOptimizerConfiguration>
  UpdateTableOptimizerRequest& WithTableOptimizerConfiguration(TableOptimizerConfigurationT&& value) {
    SetTableOptimizerConfiguration(std::forward<TableOptimizerConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
