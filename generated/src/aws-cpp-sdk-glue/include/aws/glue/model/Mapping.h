...
class Mapping {
 public:
  ...
  void SetToKey(ToKeyT&& value) {
    ...
    m_toKey = std::forward<ToKeyT>(value);
  }
  template <typename ToKeyT = Aws::String>
  Mapping& WithToKey(ToKeyT&& value) {
    SetToKey(std::forward<ToKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromPath(FromPathT&& value) {
    ...
    m_fromPath = std::forward<FromPathT>(value);
  }
  template <typename FromPathT = Aws::Vector<Aws::String>>
  Mapping& WithFromPath(FromPathT&& value) {
    SetFromPath(std::forward<FromPathT>(value));
    return *this;
  }
  template <typename FromPathT = Aws::String>
  Mapping& AddFromPath(FromPathT&& value) {
    m_fromPathHasBeenSet = true;
    m_fromPath.emplace_back(std::forward<FromPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFromType(FromTypeT&& value) {
    ...
    m_fromType = std::forward<FromTypeT>(value);
  }
  template <typename FromTypeT = Aws::String>
  Mapping& WithFromType(FromTypeT&& value) {
    SetFromType(std::forward<FromTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetToType(ToTypeT&& value) {
    ...
    m_toType = std::forward<ToTypeT>(value);
  }
  template <typename ToTypeT = Aws::String>
  Mapping& WithToType(ToTypeT&& value) {
    SetToType(std::forward<ToTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDropped(bool value) {
    m_droppedHasBeenSet = true;
    m_dropped = value;
  }
  inline Mapping& WithDropped(bool value) {
    SetDropped(value);
    return *this;
  }
  ///@}
