...
class CreateSessionRequest : public GlueRequest {
 public:
  ...
  inline CreateSessionRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSessionRequest& WithIdleTimeout(int value) {
  ...
  inline CreateSessionRequest& WithMaxCapacity(double value) {
  ...
  inline CreateSessionRequest& WithNumberOfWorkers(int value) {
  ...
  inline CreateSessionRequest& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
