...
class DataQualityRulesetFilterCriteria {
 public:
  ...
  template <typename NameT = Aws::String>
  DataQualityRulesetFilterCriteria& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DataQualityRulesetFilterCriteria& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  DataQualityRulesetFilterCriteria& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  DataQualityRulesetFilterCriteria& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  void SetLastModifiedBefore(LastModifiedBeforeT&& value) {
    m_lastModifiedBeforeHasBeenSet = true;
    m_lastModifiedBefore = std::forward<LastModifiedBeforeT>(value);
  }
  template <typename LastModifiedBeforeT = Aws::Utils::DateTime>
  DataQualityRulesetFilterCriteria& WithLastModifiedBefore(LastModifiedBeforeT&& value) {
    SetLastModifiedBefore(std::forward<LastModifiedBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastModifiedAfter(LastModifiedAfterT&& value) {
    m_lastModifiedAfterHasBeenSet = true;
    m_lastModifiedAfter = std::forward<LastModifiedAfterT>(value);
  }
  template <typename LastModifiedAfterT = Aws::Utils::DateTime>
  DataQualityRulesetFilterCriteria& WithLastModifiedAfter(LastModifiedAfterT&& value) {
    SetLastModifiedAfter(std::forward<LastModifiedAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetTable(TargetTableT&& value) {
    ...
    m_targetTable = std::forward<TargetTableT>(value);
  }
  template <typename TargetTableT = DataQualityTargetTable>
  DataQualityRulesetFilterCriteria& WithTargetTable(TargetTableT&& value) {
    SetTargetTable(std::forward<TargetTableT>(value));
    return *this;
  }
  ///@}
 private:
