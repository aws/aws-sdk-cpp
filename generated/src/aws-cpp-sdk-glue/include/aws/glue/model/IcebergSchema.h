...
class IcebergSchema {
 public:
  ...
  inline IcebergSchema& WithSchemaId(int value) {
    SetSchemaId(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergSchema& AddIdentifierFieldIds(int value) {
    m_identifierFieldIdsHasBeenSet = true;
  ...
  inline void SetType(IcebergStructTypeEnum value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline IcebergSchema& WithType(IcebergStructTypeEnum value) {
    SetType(value);
    return *this;
  }
  ///@}
