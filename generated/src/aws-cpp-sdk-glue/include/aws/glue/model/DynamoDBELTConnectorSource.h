...
class DynamoDBELTConnectorSource {
 public:
  ...
  template <typename NameT = Aws::String>
  DynamoDBELTConnectorSource& WithName(NameT&& value) {
  ...
  template <typename ConnectionOptionsT = DDBELTConnectionOptions>
  DynamoDBELTConnectorSource& WithConnectionOptions(ConnectionOptionsT&& value) {
  ...
  template <typename OutputSchemasT = Aws::Vector<GlueSchema>>
  DynamoDBELTConnectorSource& WithOutputSchemas(OutputSchemasT&& value) {
    SetOutputSchemas(std::forward<OutputSchemasT>(value));
    return *this;
  }
  template <typename OutputSchemasT = GlueSchema>
  DynamoDBELTConnectorSource& AddOutputSchemas(OutputSchemasT&& value) {
    m_outputSchemasHasBeenSet = true;
