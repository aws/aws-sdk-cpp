...
class DeleteUserDefinedFunctionRequest : public GlueRequest {
 public:
  AWS_GLUE_API DeleteUserDefinedFunctionRequest() = default;
  ...
  template <typename CatalogIdT = Aws::String>
  DeleteUserDefinedFunctionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  DeleteUserDefinedFunctionRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename FunctionNameT = Aws::String>
  DeleteUserDefinedFunctionRequest& WithFunctionName(FunctionNameT&& value) {
