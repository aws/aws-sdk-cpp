...
class PIIDetection {
 public:
  ...
  inline void SetPiiType(PiiType value) {
    m_piiTypeHasBeenSet = true;
    m_piiType = value;
  }
  inline PIIDetection& WithPiiType(PiiType value) {
    SetPiiType(value);
    return *this;
  }
  ///@}
  ...
  void SetEntityTypesToDetect(EntityTypesToDetectT&& value) {
    ...
    m_entityTypesToDetect = std::forward<EntityTypesToDetectT>(value);
  }
  template <typename EntityTypesToDetectT = Aws::Vector<Aws::String>>
  PIIDetection& WithEntityTypesToDetect(EntityTypesToDetectT&& value) {
    SetEntityTypesToDetect(std::forward<EntityTypesToDetectT>(value));
    return *this;
  }
  template <typename EntityTypesToDetectT = Aws::String>
  PIIDetection& AddEntityTypesToDetect(EntityTypesToDetectT&& value) {
    m_entityTypesToDetectHasBeenSet = true;
    m_entityTypesToDetect.emplace_back(std::forward<EntityTypesToDetectT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSampleFraction(double value) {
    m_sampleFractionHasBeenSet = true;
    m_sampleFraction = value;
  }
  inline PIIDetection& WithSampleFraction(double value) {
  ...
  inline void SetThresholdFraction(double value) {
    m_thresholdFractionHasBeenSet = true;
    m_thresholdFraction = value;
  }
  inline PIIDetection& WithThresholdFraction(double value) {
    SetThresholdFraction(value);
    return *this;
  }
  ///@}
  ...
  void SetMaskValue(MaskValueT&& value) {
    ...
    m_maskValue = std::forward<MaskValueT>(value);
  }
  template <typename MaskValueT = Aws::String>
  PIIDetection& WithMaskValue(MaskValueT&& value) {
    SetMaskValue(std::forward<MaskValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedactText(RedactTextT&& value) {
    ...
    m_redactText = std::forward<RedactTextT>(value);
  }
  template <typename RedactTextT = Aws::String>
  PIIDetection& WithRedactText(RedactTextT&& value) {
    SetRedactText(std::forward<RedactTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedactChar(RedactCharT&& value) {
    ...
    m_redactChar = std::forward<RedactCharT>(value);
  }
  template <typename RedactCharT = Aws::String>
  PIIDetection& WithRedactChar(RedactCharT&& value) {
    SetRedactChar(std::forward<RedactCharT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMatchPattern(MatchPatternT&& value) {
    ...
    m_matchPattern = std::forward<MatchPatternT>(value);
  }
  template <typename MatchPatternT = Aws::String>
  PIIDetection& WithMatchPattern(MatchPatternT&& value) {
    SetMatchPattern(std::forward<MatchPatternT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumLeftCharsToExclude(int value) {
    m_numLeftCharsToExcludeHasBeenSet = true;
    m_numLeftCharsToExclude = value;
  }
  inline PIIDetection& WithNumLeftCharsToExclude(int value) {
    SetNumLeftCharsToExclude(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumRightCharsToExclude(int value) {
    m_numRightCharsToExcludeHasBeenSet = true;
    m_numRightCharsToExclude = value;
  }
  inline PIIDetection& WithNumRightCharsToExclude(int value) {
    SetNumRightCharsToExclude(value);
    return *this;
  }
  ///@}
  ...
  void SetDetectionParameters(DetectionParametersT&& value) {
    ...
    m_detectionParameters = std::forward<DetectionParametersT>(value);
  }
  template <typename DetectionParametersT = Aws::String>
  PIIDetection& WithDetectionParameters(DetectionParametersT&& value) {
    SetDetectionParameters(std::forward<DetectionParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDetectionSensitivity(DetectionSensitivityT&& value) {
    ...
    m_detectionSensitivity = std::forward<DetectionSensitivityT>(value);
  }
  template <typename DetectionSensitivityT = Aws::String>
  PIIDetection& WithDetectionSensitivity(DetectionSensitivityT&& value) {
    SetDetectionSensitivity(std::forward<DetectionSensitivityT>(value));
    return *this;
  }
  ///@}
 private:
