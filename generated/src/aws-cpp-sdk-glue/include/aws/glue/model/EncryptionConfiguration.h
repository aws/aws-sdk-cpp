...
class EncryptionConfiguration {
 public:
  ...
  void SetCloudWatchEncryption(CloudWatchEncryptionT&& value) {
    ...
    m_cloudWatchEncryption = std::forward<CloudWatchEncryptionT>(value);
  }
  template <typename CloudWatchEncryptionT = CloudWatchEncryption>
  EncryptionConfiguration& WithCloudWatchEncryption(CloudWatchEncryptionT&& value) {
    SetCloudWatchEncryption(std::forward<CloudWatchEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobBookmarksEncryption(JobBookmarksEncryptionT&& value) {
    ...
    m_jobBookmarksEncryption = std::forward<JobBookmarksEncryptionT>(value);
  }
  template <typename JobBookmarksEncryptionT = JobBookmarksEncryption>
  EncryptionConfiguration& WithJobBookmarksEncryption(JobBookmarksEncryptionT&& value) {
    SetJobBookmarksEncryption(std::forward<JobBookmarksEncryptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataQualityEncryption(DataQualityEncryptionT&& value) {
    ...
    m_dataQualityEncryption = std::forward<DataQualityEncryptionT>(value);
  }
  template <typename DataQualityEncryptionT = DataQualityEncryption>
  EncryptionConfiguration& WithDataQualityEncryption(DataQualityEncryptionT&& value) {
    SetDataQualityEncryption(std::forward<DataQualityEncryptionT>(value));
    return *this;
  }
  ///@}
 private:
