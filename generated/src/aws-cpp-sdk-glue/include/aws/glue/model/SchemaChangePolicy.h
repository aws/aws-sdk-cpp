...
class SchemaChangePolicy {
 public:
  ...
  inline void SetUpdateBehavior(UpdateBehavior value) {
    m_updateBehaviorHasBeenSet = true;
    m_updateBehavior = value;
  }
  inline SchemaChangePolicy& WithUpdateBehavior(UpdateBehavior value) {
  ...
  inline void SetDeleteBehavior(DeleteBehavior value) {
    m_deleteBehaviorHasBeenSet = true;
    m_deleteBehavior = value;
  }
  inline SchemaChangePolicy& WithDeleteBehavior(DeleteBehavior value) {
    SetDeleteBehavior(value);
    return *this;
  }
  ///@}
 private:
