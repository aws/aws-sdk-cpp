...
class GetWorkflowRunsResult {
 public:
  ...
  template <typename RunsT = Aws::Vector<WorkflowRun>>
  GetWorkflowRunsResult& WithRuns(RunsT&& value) {
    SetRuns(std::forward<RunsT>(value));
    return *this;
  }
  template <typename RunsT = WorkflowRun>
  GetWorkflowRunsResult& AddRuns(RunsT&& value) {
    m_runsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetWorkflowRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWorkflowRunsResult& WithRequestId(RequestIdT&& value) {
