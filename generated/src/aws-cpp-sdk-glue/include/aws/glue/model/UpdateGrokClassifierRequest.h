...
class UpdateGrokClassifierRequest {
 public:
  ...
  void SetGrokPattern(GrokPatternT&& value) {
    ...
    m_grokPattern = std::forward<GrokPatternT>(value);
  }
  template <typename GrokPatternT = Aws::String>
  UpdateGrokClassifierRequest& WithGrokPattern(GrokPatternT&& value) {
    SetGrokPattern(std::forward<GrokPatternT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomPatterns(CustomPatternsT&& value) {
    ...
    m_customPatterns = std::forward<CustomPatternsT>(value);
  }
  template <typename CustomPatternsT = Aws::String>
  UpdateGrokClassifierRequest& WithCustomPatterns(CustomPatternsT&& value) {
    SetCustomPatterns(std::forward<CustomPatternsT>(value));
    return *this;
  }
  ///@}
 private:
