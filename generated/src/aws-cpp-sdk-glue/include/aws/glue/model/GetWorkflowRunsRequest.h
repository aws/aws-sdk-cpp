...
/**
 */
class GetWorkflowRunsRequest : public GlueRequest {
 public:
  ...
  inline GetWorkflowRunsRequest& WithIncludeGraph(bool value) {
  ...
  inline GetWorkflowRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
