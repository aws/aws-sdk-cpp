...
class JobRun {
 public:
  ...
  void SetPreviousRunId(PreviousRunIdT&& value) {
    ...
    m_previousRunId = std::forward<PreviousRunIdT>(value);
  }
  template <typename PreviousRunIdT = Aws::String>
  JobRun& WithPreviousRunId(PreviousRunIdT&& value) {
    SetPreviousRunId(std::forward<PreviousRunIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTriggerName(TriggerNameT&& value) {
    ...
    m_triggerName = std::forward<TriggerNameT>(value);
  }
  template <typename TriggerNameT = Aws::String>
  JobRun& WithTriggerName(TriggerNameT&& value) {
    SetTriggerName(std::forward<TriggerNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithJobMode(JobMode value) {
    SetJobMode(value);
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithJobRunQueuingEnabled(bool value) {
  ...
  inline void SetJobRunState(JobRunState value) {
    m_jobRunStateHasBeenSet = true;
    m_jobRunState = value;
  }
  inline JobRun& WithJobRunState(JobRunState value) {
    SetJobRunState(value);
    return *this;
  }
  ///@}
  ...
  void SetPredecessorRuns(PredecessorRunsT&& value) {
    ...
    m_predecessorRuns = std::forward<PredecessorRunsT>(value);
  }
  template <typename PredecessorRunsT = Aws::Vector<Predecessor>>
  JobRun& WithPredecessorRuns(PredecessorRunsT&& value) {
    SetPredecessorRuns(std::forward<PredecessorRunsT>(value));
    return *this;
  }
  template <typename PredecessorRunsT = Predecessor>
  JobRun& AddPredecessorRuns(PredecessorRunsT&& value) {
    m_predecessorRunsHasBeenSet = true;
    m_predecessorRuns.emplace_back(std::forward<PredecessorRunsT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithMaxCapacity(double value) {
  ...
  inline JobRun& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithNumberOfWorkers(int value) {
  ...
  inline JobRun& WithDPUSeconds(double value) {
    SetDPUSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline JobRun& WithExecutionClass(ExecutionClass value) {
  ...
  void SetStateDetail(StateDetailT&& value) {
    ...
    m_stateDetail = std::forward<StateDetailT>(value);
  }
  template <typename StateDetailT = Aws::String>
  JobRun& WithStateDetail(StateDetailT&& value) {
    SetStateDetail(std::forward<StateDetailT>(value));
    return *this;
  }
  ///@}
