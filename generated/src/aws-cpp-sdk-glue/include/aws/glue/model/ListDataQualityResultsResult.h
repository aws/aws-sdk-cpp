...
class ListDataQualityResultsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<DataQualityResultDescription>>
  ListDataQualityResultsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = DataQualityResultDescription>
  ListDataQualityResultsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityResultsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityResultsResult& WithRequestId(RequestIdT&& value) {
