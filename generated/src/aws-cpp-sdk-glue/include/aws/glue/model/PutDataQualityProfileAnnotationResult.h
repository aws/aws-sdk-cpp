...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API PutDataQualityProfileAnnotationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutDataQualityProfileAnnotationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
