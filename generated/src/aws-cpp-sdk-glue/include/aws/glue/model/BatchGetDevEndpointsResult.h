...
class BatchGetDevEndpointsResult {
 public:
  ...
  void SetDevEndpointsNotFound(DevEndpointsNotFoundT&& value) {
    ...
    m_devEndpointsNotFound = std::forward<DevEndpointsNotFoundT>(value);
  }
  template <typename DevEndpointsNotFoundT = Aws::Vector<Aws::String>>
  BatchGetDevEndpointsResult& WithDevEndpointsNotFound(DevEndpointsNotFoundT&& value) {
    SetDevEndpointsNotFound(std::forward<DevEndpointsNotFoundT>(value));
    return *this;
  }
  ...
  BatchGetDevEndpointsResult& AddDevEndpointsNotFound(DevEndpointsNotFoundT&& value) {
    m_devEndpointsNotFoundHasBeenSet = true;
    m_devEndpointsNotFound.emplace_back(std::forward<DevEndpointsNotFoundT>(value));
    return *this;
  }
  ///@}
