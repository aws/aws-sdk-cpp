...
namespace Model
{
  ...
  public:
    ...
    ///@{
    /**
     * <p>The status of the integration being modified.</p> <p>The possible statuses
    ...
    template<typename IntegrationConfigT = IntegrationConfig>
    ModifyIntegrationResult& WithIntegrationConfig(IntegrationConfigT&& value) { SetIntegrationConfig(std::forward<IntegrationConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ModifyIntegrationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
