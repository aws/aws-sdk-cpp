...
class ModifyIntegrationResult {
 public:
  ...
  ModifyIntegrationResult& AddAdditionalEncryptionContext(AdditionalEncryptionContextKeyT&& key,
  ...
  inline ModifyIntegrationResult& WithStatus(IntegrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
