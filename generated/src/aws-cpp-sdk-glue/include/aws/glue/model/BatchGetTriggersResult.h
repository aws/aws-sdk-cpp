...
class BatchGetTriggersResult {
 public:
  ...
  template <typename TriggersT = Aws::Vector<Trigger>>
  BatchGetTriggersResult& WithTriggers(TriggersT&& value) {
    SetTriggers(std::forward<TriggersT>(value));
    return *this;
  }
  template <typename TriggersT = Trigger>
  BatchGetTriggersResult& AddTriggers(TriggersT&& value) {
    m_triggersHasBeenSet = true;
  ...
  void SetTriggersNotFound(TriggersNotFoundT&& value) {
    m_triggersNotFoundHasBeenSet = true;
    m_triggersNotFound = std::forward<TriggersNotFoundT>(value);
  }
  template <typename TriggersNotFoundT = Aws::Vector<Aws::String>>
  BatchGetTriggersResult& WithTriggersNotFound(TriggersNotFoundT&& value) {
    SetTriggersNotFound(std::forward<TriggersNotFoundT>(value));
    return *this;
  }
  template <typename TriggersNotFoundT = Aws::String>
  BatchGetTriggersResult& AddTriggersNotFound(TriggersNotFoundT&& value) {
    m_triggersNotFoundHasBeenSet = true;
    m_triggersNotFound.emplace_back(std::forward<TriggersNotFoundT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetTriggersResult& WithRequestId(RequestIdT&& value) {
