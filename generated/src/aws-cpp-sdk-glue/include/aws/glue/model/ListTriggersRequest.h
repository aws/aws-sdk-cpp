...
class ListTriggersRequest : public GlueRequest {
 public:
  ...
  void SetDependentJobName(DependentJobNameT&& value) {
    m_dependentJobNameHasBeenSet = true;
    m_dependentJobName = std::forward<DependentJobNameT>(value);
  }
  template <typename DependentJobNameT = Aws::String>
  ListTriggersRequest& WithDependentJobName(DependentJobNameT&& value) {
    SetDependentJobName(std::forward<DependentJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTriggersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
