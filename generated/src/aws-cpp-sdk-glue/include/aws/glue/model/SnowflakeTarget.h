...
class SnowflakeTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  SnowflakeTarget& WithName(NameT&& value) {
  ...
  template <typename DataT = SnowflakeNodeData>
  SnowflakeTarget& WithData(DataT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  SnowflakeTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  SnowflakeTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
