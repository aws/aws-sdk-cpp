...
class DQResultsPublishingOptions {
 public:
  ...
  inline DQResultsPublishingOptions& WithCloudWatchMetricsEnabled(bool value) {
  ...
  inline void SetResultsPublishingEnabled(bool value) {
    m_resultsPublishingEnabledHasBeenSet = true;
    m_resultsPublishingEnabled = value;
  }
  inline DQResultsPublishingOptions& WithResultsPublishingEnabled(bool value) {
    SetResultsPublishingEnabled(value);
    return *this;
  }
  ///@}
 private:
