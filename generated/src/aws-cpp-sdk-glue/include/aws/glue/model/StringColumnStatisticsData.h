...
class StringColumnStatisticsData {
 public:
  ...
  inline void SetMaximumLength(long long value) {
    m_maximumLengthHasBeenSet = true;
    m_maximumLength = value;
  }
  inline StringColumnStatisticsData& WithMaximumLength(long long value) {
  ...
  inline void SetAverageLength(double value) {
    m_averageLengthHasBeenSet = true;
    m_averageLength = value;
  }
  inline StringColumnStatisticsData& WithAverageLength(double value) {
    SetAverageLength(value);
    return *this;
  }
  ///@}
  ...
  inline StringColumnStatisticsData& WithNumberOfNulls(long long value) {
  ...
  inline StringColumnStatisticsData& WithNumberOfDistinctValues(long long value) {
