...
class DDBELTCatalogAdditionalOptions {
 public:
  ...
  void SetDynamodbExport(DynamodbExportT&& value) {
    m_dynamodbExportHasBeenSet = true;
    m_dynamodbExport = std::forward<DynamodbExportT>(value);
  }
  template <typename DynamodbExportT = Aws::String>
  DDBELTCatalogAdditionalOptions& WithDynamodbExport(DynamodbExportT&& value) {
    SetDynamodbExport(std::forward<DynamodbExportT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDynamodbUnnestDDBJson(bool value) {
    m_dynamodbUnnestDDBJsonHasBeenSet = true;
    m_dynamodbUnnestDDBJson = value;
  }
  inline DDBELTCatalogAdditionalOptions& WithDynamodbUnnestDDBJson(bool value) {
    SetDynamodbUnnestDDBJson(value);
    return *this;
  }
  ///@}
 private:
