...
class GetCatalogsRequest : public GlueRequest {
 public:
  ...
  void SetParentCatalogId(ParentCatalogIdT&& value) {
    ...
    m_parentCatalogId = std::forward<ParentCatalogIdT>(value);
  }
  template <typename ParentCatalogIdT = Aws::String>
  GetCatalogsRequest& WithParentCatalogId(ParentCatalogIdT&& value) {
    SetParentCatalogId(std::forward<ParentCatalogIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCatalogsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetCatalogsRequest& WithRecursive(bool value) {
    SetRecursive(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeRoot(bool value) {
    m_includeRootHasBeenSet = true;
    m_includeRoot = value;
  }
  inline GetCatalogsRequest& WithIncludeRoot(bool value) {
    SetIncludeRoot(value);
    return *this;
  }
  ///@}
 private:
