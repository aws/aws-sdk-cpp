...
class FindMatchesParameters {
 public:
  ...
  void SetPrimaryKeyColumnName(PrimaryKeyColumnNameT&& value) {
    ...
    m_primaryKeyColumnName = std::forward<PrimaryKeyColumnNameT>(value);
  }
  template <typename PrimaryKeyColumnNameT = Aws::String>
  FindMatchesParameters& WithPrimaryKeyColumnName(PrimaryKeyColumnNameT&& value) {
    SetPrimaryKeyColumnName(std::forward<PrimaryKeyColumnNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPrecisionRecallTradeoff(double value) {
    m_precisionRecallTradeoffHasBeenSet = true;
    m_precisionRecallTradeoff = value;
  }
  inline FindMatchesParameters& WithPrecisionRecallTradeoff(double value) {
    SetPrecisionRecallTradeoff(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccuracyCostTradeoff(double value) {
    m_accuracyCostTradeoffHasBeenSet = true;
    m_accuracyCostTradeoff = value;
  }
  inline FindMatchesParameters& WithAccuracyCostTradeoff(double value) {
    SetAccuracyCostTradeoff(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnforceProvidedLabels(bool value) {
    m_enforceProvidedLabelsHasBeenSet = true;
    m_enforceProvidedLabels = value;
  }
  inline FindMatchesParameters& WithEnforceProvidedLabels(bool value) {
    SetEnforceProvidedLabels(value);
    return *this;
  }
  ///@}
 private:
