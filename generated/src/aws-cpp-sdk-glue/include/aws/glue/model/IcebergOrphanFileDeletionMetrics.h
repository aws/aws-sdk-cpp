...
class IcebergOrphanFileDeletionMetrics {
 public:
  ...
  inline void SetNumberOfOrphanFilesDeleted(long long value) {
    m_numberOfOrphanFilesDeletedHasBeenSet = true;
    m_numberOfOrphanFilesDeleted = value;
  }
  inline IcebergOrphanFileDeletionMetrics& WithNumberOfOrphanFilesDeleted(long long value) {
    SetNumberOfOrphanFilesDeleted(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergOrphanFileDeletionMetrics& WithDpuHours(double value) {
    SetDpuHours(value);
    return *this;
  }
  ///@}
  ...
  inline IcebergOrphanFileDeletionMetrics& WithNumberOfDpus(int value) {
  ...
  inline IcebergOrphanFileDeletionMetrics& WithJobDurationInHour(double value) {
