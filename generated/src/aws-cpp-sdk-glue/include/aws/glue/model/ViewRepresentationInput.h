...
class ViewRepresentationInput {
 public:
  ...
  inline ViewRepresentationInput& WithDialect(ViewDialect value) {
    SetDialect(value);
    return *this;
  }
  ///@}
  ...
  template <typename DialectVersionT = Aws::String>
  ViewRepresentationInput& WithDialectVersion(DialectVersionT&& value) {
  ...
  template <typename ViewOriginalTextT = Aws::String>
  ViewRepresentationInput& WithViewOriginalText(ViewOriginalTextT&& value) {
  ...
  void SetValidationConnection(ValidationConnectionT&& value) {
    ...
    m_validationConnection = std::forward<ValidationConnectionT>(value);
  }
  template <typename ValidationConnectionT = Aws::String>
  ViewRepresentationInput& WithValidationConnection(ValidationConnectionT&& value) {
    SetValidationConnection(std::forward<ValidationConnectionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ViewExpandedTextT = Aws::String>
  ViewRepresentationInput& WithViewExpandedText(ViewExpandedTextT&& value) {
