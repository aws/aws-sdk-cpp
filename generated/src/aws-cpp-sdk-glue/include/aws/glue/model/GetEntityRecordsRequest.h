...
class GetEntityRecordsRequest : public GlueRequest {
 public:
  ...
  template <typename ConnectionNameT = Aws::String>
  GetEntityRecordsRequest& WithConnectionName(ConnectionNameT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetEntityRecordsRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename EntityNameT = Aws::String>
  GetEntityRecordsRequest& WithEntityName(EntityNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetEntityRecordsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename DataStoreApiVersionT = Aws::String>
  GetEntityRecordsRequest& WithDataStoreApiVersion(DataStoreApiVersionT&& value) {
  ...
  template <typename ConnectionOptionsT = Aws::Map<Aws::String, Aws::String>>
  GetEntityRecordsRequest& WithConnectionOptions(ConnectionOptionsT&& value) {
  ...
  template <typename FilterPredicateT = Aws::String>
  GetEntityRecordsRequest& WithFilterPredicate(FilterPredicateT&& value) {
  ...
  inline GetEntityRecordsRequest& WithLimit(long long value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  template <typename OrderByT = Aws::String>
  GetEntityRecordsRequest& WithOrderBy(OrderByT&& value) {
  ...
  template <typename SelectedFieldsT = Aws::Vector<Aws::String>>
  GetEntityRecordsRequest& WithSelectedFields(SelectedFieldsT&& value) {
    SetSelectedFields(std::forward<SelectedFieldsT>(value));
    return *this;
  }
  template <typename SelectedFieldsT = Aws::String>
  GetEntityRecordsRequest& AddSelectedFields(SelectedFieldsT&& value) {
    m_selectedFieldsHasBeenSet = true;
