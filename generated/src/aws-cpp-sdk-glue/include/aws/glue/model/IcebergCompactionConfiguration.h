...
class IcebergCompactionConfiguration {
 public:
  ...
  inline void SetStrategy(CompactionStrategy value) {
    m_strategyHasBeenSet = true;
    m_strategy = value;
  }
  inline IcebergCompactionConfiguration& WithStrategy(CompactionStrategy value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinInputFiles(int value) {
    m_minInputFilesHasBeenSet = true;
    m_minInputFiles = value;
  }
  inline IcebergCompactionConfiguration& WithMinInputFiles(int value) {
    SetMinInputFiles(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeleteFileThreshold(int value) {
    m_deleteFileThresholdHasBeenSet = true;
    m_deleteFileThreshold = value;
  }
  inline IcebergCompactionConfiguration& WithDeleteFileThreshold(int value) {
    SetDeleteFileThreshold(value);
    return *this;
  }
  ///@}
 private:
