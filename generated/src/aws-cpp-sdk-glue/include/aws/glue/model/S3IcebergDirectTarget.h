...
class S3IcebergDirectTarget {
 public:
  ...
  inline void SetFormat(TargetFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline S3IcebergDirectTarget& WithFormat(TargetFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompression(IcebergTargetCompressionType value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline S3IcebergDirectTarget& WithCompression(IcebergTargetCompressionType value) {
  ...
  void SetNumberTargetPartitions(NumberTargetPartitionsT&& value) {
    ...
    m_numberTargetPartitions = std::forward<NumberTargetPartitionsT>(value);
  }
  template <typename NumberTargetPartitionsT = Aws::String>
  S3IcebergDirectTarget& WithNumberTargetPartitions(NumberTargetPartitionsT&& value) {
    SetNumberTargetPartitions(std::forward<NumberTargetPartitionsT>(value));
    return *this;
  }
  ///@}
