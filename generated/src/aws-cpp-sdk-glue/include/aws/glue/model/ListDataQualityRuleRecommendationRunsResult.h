...
class ListDataQualityRuleRecommendationRunsResult {
 public:
  ...
  AWS_GLUE_API ListDataQualityRuleRecommendationRunsResult& operator=(
  ...
  template <typename RunsT = Aws::Vector<DataQualityRuleRecommendationRunDescription>>
  ListDataQualityRuleRecommendationRunsResult& WithRuns(RunsT&& value) {
    SetRuns(std::forward<RunsT>(value));
    return *this;
  }
  template <typename RunsT = DataQualityRuleRecommendationRunDescription>
  ListDataQualityRuleRecommendationRunsResult& AddRuns(RunsT&& value) {
    m_runsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityRuleRecommendationRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityRuleRecommendationRunsResult& WithRequestId(RequestIdT&& value) {
