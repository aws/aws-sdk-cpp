...
namespace Model
{
  ...
  public:
    ...
    inline JobUpdate& WithJobMode(JobMode value) { SetJobMode(value); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    JobUpdate& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename LogUriT = Aws::String>
    JobUpdate& WithLogUri(LogUriT&& value) { SetLogUri(std::forward<LogUriT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleT = Aws::String>
    JobUpdate& WithRole(RoleT&& value) { SetRole(std::forward<RoleT>(value)); return *this;}
    ///@}
    ...
    template<typename ExecutionPropertyT = ExecutionProperty>
    JobUpdate& WithExecutionProperty(ExecutionPropertyT&& value) { SetExecutionProperty(std::forward<ExecutionPropertyT>(value)); return *this;}
    ///@}
    ...
    template<typename CommandT = JobCommand>
    JobUpdate& WithCommand(CommandT&& value) { SetCommand(std::forward<CommandT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultArgumentsT = Aws::Map<Aws::String, Aws::String>>
    JobUpdate& WithDefaultArguments(DefaultArgumentsT&& value) { SetDefaultArguments(std::forward<DefaultArgumentsT>(value)); return *this;}
    ...
    template<typename NonOverridableArgumentsT = Aws::Map<Aws::String, Aws::String>>
    JobUpdate& WithNonOverridableArguments(NonOverridableArgumentsT&& value) { SetNonOverridableArguments(std::forward<NonOverridableArgumentsT>(value)); return *this;}
    ...
    template<typename ConnectionsT = ConnectionsList>
    JobUpdate& WithConnections(ConnectionsT&& value) { SetConnections(std::forward<ConnectionsT>(value)); return *this;}
    ///@}
     ...
     * for Ray jobs. For more information, see <a
     * href="https://docs.aws.amazon.com/glue/latest/dg/add-job.html#create-job">Defining
     * job properties for Spark jobs </a> </p>
     */
    ...
    inline JobUpdate& WithWorkerType(WorkerType value) { SetWorkerType(value); return *this;}
    ///@}
    ...
    template<typename SecurityConfigurationT = Aws::String>
    JobUpdate& WithSecurityConfiguration(SecurityConfigurationT&& value) { SetSecurityConfiguration(std::forward<SecurityConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename NotificationPropertyT = NotificationProperty>
    JobUpdate& WithNotificationProperty(NotificationPropertyT&& value) { SetNotificationProperty(std::forward<NotificationPropertyT>(value)); return *this;}
    ///@}
    ...
    template<typename GlueVersionT = Aws::String>
    JobUpdate& WithGlueVersion(GlueVersionT&& value) { SetGlueVersion(std::forward<GlueVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeGenConfigurationNodesT = Aws::Map<Aws::String, CodeGenConfigurationNode>>
    JobUpdate& WithCodeGenConfigurationNodes(CodeGenConfigurationNodesT&& value) { SetCodeGenConfigurationNodes(std::forward<CodeGenConfigurationNodesT>(value)); return *this;}
    ...
    inline JobUpdate& WithExecutionClass(ExecutionClass value) { SetExecutionClass(value); return *this;}
    ///@}
    ...
    template<typename SourceControlDetailsT = SourceControlDetails>
    JobUpdate& WithSourceControlDetails(SourceControlDetailsT&& value) { SetSourceControlDetails(std::forward<SourceControlDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename MaintenanceWindowT = Aws::String>
    JobUpdate& WithMaintenanceWindow(MaintenanceWindowT&& value) { SetMaintenanceWindow(std::forward<MaintenanceWindowT>(value)); return *this;}
    ///@}
  private:
