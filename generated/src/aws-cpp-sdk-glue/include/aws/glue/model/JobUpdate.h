...
class JobUpdate {
 public:
  ...
  inline JobUpdate& WithJobMode(JobMode value) {
    SetJobMode(value);
    return *this;
  }
  ///@}
  ...
  inline JobUpdate& WithJobRunQueuingEnabled(bool value) {
  ...
  inline JobUpdate& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  inline JobUpdate& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline JobUpdate& WithMaxCapacity(double value) {
  ...
  inline JobUpdate& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline JobUpdate& WithNumberOfWorkers(int value) {
   ...
   * in the developer guide.</p> <p>If not provided in the update request, the Glue
   * version retains the value from the existing job definition.</p>
   */
  ...
  inline JobUpdate& WithExecutionClass(ExecutionClass value) {
