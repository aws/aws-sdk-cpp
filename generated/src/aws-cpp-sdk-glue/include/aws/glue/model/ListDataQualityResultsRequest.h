...
class ListDataQualityResultsRequest : public GlueRequest {
 public:
  ...
  template <typename FilterT = DataQualityResultFilterCriteria>
  ListDataQualityResultsRequest& WithFilter(FilterT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityResultsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataQualityResultsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
