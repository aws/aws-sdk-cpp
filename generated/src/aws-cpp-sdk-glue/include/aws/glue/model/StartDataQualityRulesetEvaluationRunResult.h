...
class StartDataQualityRulesetEvaluationRunResult {
 public:
  ...
  AWS_GLUE_API StartDataQualityRulesetEvaluationRunResult& operator=(
  ...
  template <typename RunIdT = Aws::String>
  StartDataQualityRulesetEvaluationRunResult& WithRunId(RunIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartDataQualityRulesetEvaluationRunResult& WithRequestId(RequestIdT&& value) {
