...
class CreateCustomEntityTypeRequest : public GlueRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateCustomEntityTypeRequest& WithName(NameT&& value) {
  ...
  template <typename RegexStringT = Aws::String>
  CreateCustomEntityTypeRequest& WithRegexString(RegexStringT&& value) {
  ...
  template <typename ContextWordsT = Aws::Vector<Aws::String>>
  CreateCustomEntityTypeRequest& WithContextWords(ContextWordsT&& value) {
    SetContextWords(std::forward<ContextWordsT>(value));
    return *this;
  }
  template <typename ContextWordsT = Aws::String>
  CreateCustomEntityTypeRequest& AddContextWords(ContextWordsT&& value) {
    m_contextWordsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateCustomEntityTypeRequest& WithTags(TagsT&& value) {
