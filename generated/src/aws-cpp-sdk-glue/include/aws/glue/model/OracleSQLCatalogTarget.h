...
class OracleSQLCatalogTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  OracleSQLCatalogTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  OracleSQLCatalogTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  OracleSQLCatalogTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename DatabaseT = Aws::String>
  OracleSQLCatalogTarget& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  OracleSQLCatalogTarget& WithTable(TableT&& value) {
