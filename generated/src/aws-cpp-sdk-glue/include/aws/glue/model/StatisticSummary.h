...
class StatisticSummary {
 public:
  ...
  void SetRunIdentifier(RunIdentifierT&& value) {
    ...
    m_runIdentifier = std::forward<RunIdentifierT>(value);
  }
  template <typename RunIdentifierT = RunIdentifier>
  StatisticSummary& WithRunIdentifier(RunIdentifierT&& value) {
    SetRunIdentifier(std::forward<RunIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatisticName(StatisticNameT&& value) {
    ...
    m_statisticName = std::forward<StatisticNameT>(value);
  }
  template <typename StatisticNameT = Aws::String>
  StatisticSummary& WithStatisticName(StatisticNameT&& value) {
    SetStatisticName(std::forward<StatisticNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEvaluationLevel(StatisticEvaluationLevel value) {
    m_evaluationLevelHasBeenSet = true;
    m_evaluationLevel = value;
  }
  inline StatisticSummary& WithEvaluationLevel(StatisticEvaluationLevel value) {
  ...
  void SetColumnsReferenced(ColumnsReferencedT&& value) {
    ...
    m_columnsReferenced = std::forward<ColumnsReferencedT>(value);
  }
  template <typename ColumnsReferencedT = Aws::Vector<Aws::String>>
  StatisticSummary& WithColumnsReferenced(ColumnsReferencedT&& value) {
    SetColumnsReferenced(std::forward<ColumnsReferencedT>(value));
    return *this;
  }
  template <typename ColumnsReferencedT = Aws::String>
  StatisticSummary& AddColumnsReferenced(ColumnsReferencedT&& value) {
    m_columnsReferencedHasBeenSet = true;
    m_columnsReferenced.emplace_back(std::forward<ColumnsReferencedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReferencedDatasets(ReferencedDatasetsT&& value) {
    ...
    m_referencedDatasets = std::forward<ReferencedDatasetsT>(value);
  }
  template <typename ReferencedDatasetsT = Aws::Vector<Aws::String>>
  StatisticSummary& WithReferencedDatasets(ReferencedDatasetsT&& value) {
    SetReferencedDatasets(std::forward<ReferencedDatasetsT>(value));
    return *this;
  }
  template <typename ReferencedDatasetsT = Aws::String>
  StatisticSummary& AddReferencedDatasets(ReferencedDatasetsT&& value) {
    m_referencedDatasetsHasBeenSet = true;
    m_referencedDatasets.emplace_back(std::forward<ReferencedDatasetsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStatisticProperties(StatisticPropertiesT&& value) {
    ...
    m_statisticProperties = std::forward<StatisticPropertiesT>(value);
  }
  template <typename StatisticPropertiesT = Aws::Map<Aws::String, Aws::String>>
  StatisticSummary& WithStatisticProperties(StatisticPropertiesT&& value) {
    SetStatisticProperties(std::forward<StatisticPropertiesT>(value));
    return *this;
  }
  ...
  StatisticSummary& AddStatisticProperties(StatisticPropertiesKeyT&& key, StatisticPropertiesValueT&& value) {
    m_statisticPropertiesHasBeenSet = true;
    m_statisticProperties.emplace(std::forward<StatisticPropertiesKeyT>(key), std::forward<StatisticPropertiesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordedOn(RecordedOnT&& value) {
    ...
    m_recordedOn = std::forward<RecordedOnT>(value);
  }
  template <typename RecordedOnT = Aws::Utils::DateTime>
  StatisticSummary& WithRecordedOn(RecordedOnT&& value) {
    SetRecordedOn(std::forward<RecordedOnT>(value));
    return *this;
  }
  ///@}
