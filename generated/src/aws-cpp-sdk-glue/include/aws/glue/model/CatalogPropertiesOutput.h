...
class CatalogPropertiesOutput {
 public:
  ...
  void SetDataLakeAccessProperties(DataLakeAccessPropertiesT&& value) {
    ...
    m_dataLakeAccessProperties = std::forward<DataLakeAccessPropertiesT>(value);
  }
  template <typename DataLakeAccessPropertiesT = DataLakeAccessPropertiesOutput>
  CatalogPropertiesOutput& WithDataLakeAccessProperties(DataLakeAccessPropertiesT&& value) {
    SetDataLakeAccessProperties(std::forward<DataLakeAccessPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIcebergOptimizationProperties(IcebergOptimizationPropertiesT&& value) {
    ...
    m_icebergOptimizationProperties = std::forward<IcebergOptimizationPropertiesT>(value);
  }
  template <typename IcebergOptimizationPropertiesT = IcebergOptimizationPropertiesOutput>
  CatalogPropertiesOutput& WithIcebergOptimizationProperties(IcebergOptimizationPropertiesT&& value) {
    SetIcebergOptimizationProperties(std::forward<IcebergOptimizationPropertiesT>(value));
    return *this;
  }
  ///@}
