...
class DataQualityRulesetEvaluationRunFilter {
 public:
  ...
  template <typename DataSourceT = DataSource>
  DataQualityRulesetEvaluationRunFilter& WithDataSource(DataSourceT&& value) {
  ...
  template <typename StartedBeforeT = Aws::Utils::DateTime>
  DataQualityRulesetEvaluationRunFilter& WithStartedBefore(StartedBeforeT&& value) {
  ...
  template <typename StartedAfterT = Aws::Utils::DateTime>
  DataQualityRulesetEvaluationRunFilter& WithStartedAfter(StartedAfterT&& value) {
