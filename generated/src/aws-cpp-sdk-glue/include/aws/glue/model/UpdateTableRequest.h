...
class UpdateTableRequest : public GlueRequest {
 public:
  ...
  void SetTableInput(TableInputT&& value) {
    m_tableInputHasBeenSet = true;
    m_tableInput = std::forward<TableInputT>(value);
  }
  template <typename TableInputT = TableInput>
  UpdateTableRequest& WithTableInput(TableInputT&& value) {
    SetTableInput(std::forward<TableInputT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSkipArchive(bool value) {
    m_skipArchiveHasBeenSet = true;
    m_skipArchive = value;
  }
  inline UpdateTableRequest& WithSkipArchive(bool value) {
    SetSkipArchive(value);
    return *this;
  }
  ///@}
  ...
  inline void SetViewUpdateAction(ViewUpdateAction value) {
    m_viewUpdateActionHasBeenSet = true;
    m_viewUpdateAction = value;
  }
  inline UpdateTableRequest& WithViewUpdateAction(ViewUpdateAction value) {
    SetViewUpdateAction(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateTableRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdateOpenTableFormatInput(UpdateOpenTableFormatInputT&& value) {
    m_updateOpenTableFormatInputHasBeenSet = true;
    m_updateOpenTableFormatInput = std::forward<UpdateOpenTableFormatInputT>(value);
  }
  template <typename UpdateOpenTableFormatInputT = UpdateOpenTableFormatInput>
  UpdateTableRequest& WithUpdateOpenTableFormatInput(UpdateOpenTableFormatInputT&& value) {
    SetUpdateOpenTableFormatInput(std::forward<UpdateOpenTableFormatInputT>(value));
    return *this;
  }
  ///@}
 private:
