...
class DataQualityRuleRecommendationRunDescription {
 public:
  ...
  template <typename RunIdT = Aws::String>
  DataQualityRuleRecommendationRunDescription& WithRunId(RunIdT&& value) {
  ...
  inline DataQualityRuleRecommendationRunDescription& WithStatus(TaskStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartedOnT = Aws::Utils::DateTime>
  DataQualityRuleRecommendationRunDescription& WithStartedOn(StartedOnT&& value) {
  ...
  template <typename DataSourceT = DataSource>
  DataQualityRuleRecommendationRunDescription& WithDataSource(DataSourceT&& value) {
