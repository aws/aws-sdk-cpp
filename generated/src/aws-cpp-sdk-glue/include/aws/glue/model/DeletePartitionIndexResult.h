...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API DeletePartitionIndexResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeletePartitionIndexResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
