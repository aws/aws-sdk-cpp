...
class SourceTableConfig {
 public:
  ...
  void SetFilterPredicate(FilterPredicateT&& value) {
    ...
    m_filterPredicate = std::forward<FilterPredicateT>(value);
  }
  template <typename FilterPredicateT = Aws::String>
  SourceTableConfig& WithFilterPredicate(FilterPredicateT&& value) {
    SetFilterPredicate(std::forward<FilterPredicateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrimaryKey(PrimaryKeyT&& value) {
    ...
    m_primaryKey = std::forward<PrimaryKeyT>(value);
  }
  template <typename PrimaryKeyT = Aws::Vector<Aws::String>>
  SourceTableConfig& WithPrimaryKey(PrimaryKeyT&& value) {
    SetPrimaryKey(std::forward<PrimaryKeyT>(value));
    return *this;
  }
  template <typename PrimaryKeyT = Aws::String>
  SourceTableConfig& AddPrimaryKey(PrimaryKeyT&& value) {
    m_primaryKeyHasBeenSet = true;
    m_primaryKey.emplace_back(std::forward<PrimaryKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecordUpdateField(RecordUpdateFieldT&& value) {
    ...
    m_recordUpdateField = std::forward<RecordUpdateFieldT>(value);
  }
  template <typename RecordUpdateFieldT = Aws::String>
  SourceTableConfig& WithRecordUpdateField(RecordUpdateFieldT&& value) {
    SetRecordUpdateField(std::forward<RecordUpdateFieldT>(value));
    return *this;
  }
  ///@}
 private:
