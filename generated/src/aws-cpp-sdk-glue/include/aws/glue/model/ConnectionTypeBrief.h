...
class ConnectionTypeBrief {
 public:
  ...
  inline ConnectionTypeBrief& WithConnectionType(ConnectionType value) {
  ...
  template <typename DisplayNameT = Aws::String>
  ConnectionTypeBrief& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename VendorT = Aws::String>
  ConnectionTypeBrief& WithVendor(VendorT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ConnectionTypeBrief& WithDescription(DescriptionT&& value) {
  ...
  template <typename CategoriesT = Aws::Vector<Aws::String>>
  ConnectionTypeBrief& WithCategories(CategoriesT&& value) {
    SetCategories(std::forward<CategoriesT>(value));
    return *this;
  }
  template <typename CategoriesT = Aws::String>
  ConnectionTypeBrief& AddCategories(CategoriesT&& value) {
    m_categoriesHasBeenSet = true;
  ...
  template <typename CapabilitiesT = Capabilities>
  ConnectionTypeBrief& WithCapabilities(CapabilitiesT&& value) {
  ...
  template <typename LogoUrlT = Aws::String>
  ConnectionTypeBrief& WithLogoUrl(LogoUrlT&& value) {
  ...
  void SetConnectionTypeVariants(ConnectionTypeVariantsT&& value) {
    m_connectionTypeVariantsHasBeenSet = true;
    m_connectionTypeVariants = std::forward<ConnectionTypeVariantsT>(value);
  }
  template <typename ConnectionTypeVariantsT = Aws::Vector<ConnectionTypeVariant>>
  ConnectionTypeBrief& WithConnectionTypeVariants(ConnectionTypeVariantsT&& value) {
    SetConnectionTypeVariants(std::forward<ConnectionTypeVariantsT>(value));
    return *this;
  }
  template <typename ConnectionTypeVariantsT = ConnectionTypeVariant>
  ConnectionTypeBrief& AddConnectionTypeVariants(ConnectionTypeVariantsT&& value) {
    m_connectionTypeVariantsHasBeenSet = true;
    m_connectionTypeVariants.emplace_back(std::forward<ConnectionTypeVariantsT>(value));
    return *this;
  }
  ///@}
 private:
