...
class UpdateColumnStatisticsForTableRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateColumnStatisticsForTableRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  UpdateColumnStatisticsForTableRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  UpdateColumnStatisticsForTableRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename ColumnStatisticsListT = Aws::Vector<ColumnStatistics>>
  UpdateColumnStatisticsForTableRequest& WithColumnStatisticsList(ColumnStatisticsListT&& value) {
    SetColumnStatisticsList(std::forward<ColumnStatisticsListT>(value));
    return *this;
  }
  template <typename ColumnStatisticsListT = ColumnStatistics>
  UpdateColumnStatisticsForTableRequest& AddColumnStatisticsList(ColumnStatisticsListT&& value) {
    m_columnStatisticsListHasBeenSet = true;
