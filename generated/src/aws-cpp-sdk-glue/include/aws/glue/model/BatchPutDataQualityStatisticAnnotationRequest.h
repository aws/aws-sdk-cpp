...
class BatchPutDataQualityStatisticAnnotationRequest : public GlueRequest {
 public:
  ...
  void SetInclusionAnnotations(InclusionAnnotationsT&& value) {
    m_inclusionAnnotationsHasBeenSet = true;
    m_inclusionAnnotations = std::forward<InclusionAnnotationsT>(value);
  }
  template <typename InclusionAnnotationsT = Aws::Vector<DatapointInclusionAnnotation>>
  BatchPutDataQualityStatisticAnnotationRequest& WithInclusionAnnotations(InclusionAnnotationsT&& value) {
    SetInclusionAnnotations(std::forward<InclusionAnnotationsT>(value));
    return *this;
  }
  template <typename InclusionAnnotationsT = DatapointInclusionAnnotation>
  BatchPutDataQualityStatisticAnnotationRequest& AddInclusionAnnotations(InclusionAnnotationsT&& value) {
    m_inclusionAnnotationsHasBeenSet = true;
    m_inclusionAnnotations.emplace_back(std::forward<InclusionAnnotationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  BatchPutDataQualityStatisticAnnotationRequest& WithClientToken(ClientTokenT&& value) {
