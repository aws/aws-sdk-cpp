...
class StartMLLabelingSetGenerationTaskRunRequest : public GlueRequest {
 public:
  ...
  template <typename TransformIdT = Aws::String>
  StartMLLabelingSetGenerationTaskRunRequest& WithTransformId(TransformIdT&& value) {
  ...
  template <typename OutputS3PathT = Aws::String>
  StartMLLabelingSetGenerationTaskRunRequest& WithOutputS3Path(OutputS3PathT&& value) {
