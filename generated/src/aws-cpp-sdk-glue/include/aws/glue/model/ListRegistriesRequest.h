...
namespace Model
{
  ...
  /**
   */
  class ListRegistriesRequest : public GlueRequest
  {
  public:
    AWS_GLUE_API ListRegistriesRequest() = default;
    ...
    inline ListRegistriesRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
