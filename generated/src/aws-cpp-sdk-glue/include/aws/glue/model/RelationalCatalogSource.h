...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    RelationalCatalogSource& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    RelationalCatalogSource& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
    ...
    template<typename TableT = Aws::String>
    RelationalCatalogSource& WithTable(TableT&& value) { SetTable(std::forward<TableT>(value)); return *this;}
    ///@}
  private:
