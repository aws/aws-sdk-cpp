...
class DataCatalogEncryptionSettings {
 public:
  ...
  template <typename EncryptionAtRestT = EncryptionAtRest>
  DataCatalogEncryptionSettings& WithEncryptionAtRest(EncryptionAtRestT&& value) {
  ...
  void SetConnectionPasswordEncryption(ConnectionPasswordEncryptionT&& value) {
    m_connectionPasswordEncryptionHasBeenSet = true;
    m_connectionPasswordEncryption = std::forward<ConnectionPasswordEncryptionT>(value);
  }
  template <typename ConnectionPasswordEncryptionT = ConnectionPasswordEncryption>
  DataCatalogEncryptionSettings& WithConnectionPasswordEncryption(ConnectionPasswordEncryptionT&& value) {
    SetConnectionPasswordEncryption(std::forward<ConnectionPasswordEncryptionT>(value));
    return *this;
  }
  ///@}
 private:
