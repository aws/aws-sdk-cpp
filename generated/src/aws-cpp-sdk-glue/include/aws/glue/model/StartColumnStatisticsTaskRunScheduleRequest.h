...
class StartColumnStatisticsTaskRunScheduleRequest : public GlueRequest {
 public:
  AWS_GLUE_API StartColumnStatisticsTaskRunScheduleRequest() = default;
  ...
  template <typename DatabaseNameT = Aws::String>
  StartColumnStatisticsTaskRunScheduleRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  StartColumnStatisticsTaskRunScheduleRequest& WithTableName(TableNameT&& value) {
