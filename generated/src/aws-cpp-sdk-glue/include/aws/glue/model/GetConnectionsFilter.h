...
class GetConnectionsFilter {
 public:
  ...
  template <typename MatchCriteriaT = Aws::Vector<Aws::String>>
  GetConnectionsFilter& WithMatchCriteria(MatchCriteriaT&& value) {
    SetMatchCriteria(std::forward<MatchCriteriaT>(value));
    return *this;
  }
  template <typename MatchCriteriaT = Aws::String>
  GetConnectionsFilter& AddMatchCriteria(MatchCriteriaT&& value) {
    m_matchCriteriaHasBeenSet = true;
  ...
  inline GetConnectionsFilter& WithConnectionType(ConnectionType value) {
  ...
  inline GetConnectionsFilter& WithConnectionSchemaVersion(int value) {
