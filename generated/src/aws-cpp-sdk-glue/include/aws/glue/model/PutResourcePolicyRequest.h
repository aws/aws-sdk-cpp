...
class PutResourcePolicyRequest : public GlueRequest {
 public:
  ...
  void SetPolicyHashCondition(PolicyHashConditionT&& value) {
    m_policyHashConditionHasBeenSet = true;
    m_policyHashCondition = std::forward<PolicyHashConditionT>(value);
  }
  template <typename PolicyHashConditionT = Aws::String>
  PutResourcePolicyRequest& WithPolicyHashCondition(PolicyHashConditionT&& value) {
    SetPolicyHashCondition(std::forward<PolicyHashConditionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPolicyExistsCondition(ExistCondition value) {
    m_policyExistsConditionHasBeenSet = true;
    m_policyExistsCondition = value;
  }
  inline PutResourcePolicyRequest& WithPolicyExistsCondition(ExistCondition value) {
    SetPolicyExistsCondition(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableHybrid(EnableHybridValues value) {
    m_enableHybridHasBeenSet = true;
    m_enableHybrid = value;
  }
  inline PutResourcePolicyRequest& WithEnableHybrid(EnableHybridValues value) {
    SetEnableHybrid(value);
    return *this;
  }
  ///@}
 private:
