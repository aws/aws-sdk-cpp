...
class DoubleColumnStatisticsData {
 public:
  ...
  inline DoubleColumnStatisticsData& WithMinimumValue(double value) {
  ...
  inline DoubleColumnStatisticsData& WithMaximumValue(double value) {
  ...
  inline DoubleColumnStatisticsData& WithNumberOfNulls(long long value) {
  ...
  inline DoubleColumnStatisticsData& WithNumberOfDistinctValues(long long value) {
