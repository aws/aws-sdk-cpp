...
class BatchDeletePartitionRequest : public GlueRequest {
 public:
  ...
  void SetPartitionsToDelete(PartitionsToDeleteT&& value) {
    m_partitionsToDeleteHasBeenSet = true;
    m_partitionsToDelete = std::forward<PartitionsToDeleteT>(value);
  }
  template <typename PartitionsToDeleteT = Aws::Vector<PartitionValueList>>
  BatchDeletePartitionRequest& WithPartitionsToDelete(PartitionsToDeleteT&& value) {
    SetPartitionsToDelete(std::forward<PartitionsToDeleteT>(value));
    return *this;
  }
  ...
  BatchDeletePartitionRequest& AddPartitionsToDelete(PartitionsToDeleteT&& value) {
    m_partitionsToDeleteHasBeenSet = true;
    m_partitionsToDelete.emplace_back(std::forward<PartitionsToDeleteT>(value));
    return *this;
  }
  ///@}
 private:
