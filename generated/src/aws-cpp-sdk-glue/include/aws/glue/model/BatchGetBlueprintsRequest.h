...
class BatchGetBlueprintsRequest : public GlueRequest {
 public:
  ...
  inline void SetIncludeBlueprint(bool value) {
    m_includeBlueprintHasBeenSet = true;
    m_includeBlueprint = value;
  }
  inline BatchGetBlueprintsRequest& WithIncludeBlueprint(bool value) {
    SetIncludeBlueprint(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeParameterSpec(bool value) {
    m_includeParameterSpecHasBeenSet = true;
    m_includeParameterSpec = value;
  }
  inline BatchGetBlueprintsRequest& WithIncludeParameterSpec(bool value) {
    SetIncludeParameterSpec(value);
    return *this;
  }
  ///@}
 private:
