...
class GetResourcePoliciesResult {
 public:
  ...
  void SetGetResourcePoliciesResponseList(GetResourcePoliciesResponseListT&& value) {
    m_getResourcePoliciesResponseListHasBeenSet = true;
    m_getResourcePoliciesResponseList = std::forward<GetResourcePoliciesResponseListT>(value);
  }
  template <typename GetResourcePoliciesResponseListT = Aws::Vector<GluePolicy>>
  GetResourcePoliciesResult& WithGetResourcePoliciesResponseList(GetResourcePoliciesResponseListT&& value) {
    SetGetResourcePoliciesResponseList(std::forward<GetResourcePoliciesResponseListT>(value));
    return *this;
  }
  template <typename GetResourcePoliciesResponseListT = GluePolicy>
  GetResourcePoliciesResult& AddGetResourcePoliciesResponseList(GetResourcePoliciesResponseListT&& value) {
    m_getResourcePoliciesResponseListHasBeenSet = true;
    m_getResourcePoliciesResponseList.emplace_back(std::forward<GetResourcePoliciesResponseListT>(value));
    return *this;
  }
  ///@}
