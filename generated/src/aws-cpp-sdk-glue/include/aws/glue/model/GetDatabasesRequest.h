...
class GetDatabasesRequest : public GlueRequest {
 public:
  ...
  inline GetDatabasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetDatabasesRequest& WithResourceShareType(ResourceShareType value) {
  ...
  inline GetDatabasesRequest& AddAttributesToGet(DatabaseAttributes value) {
    m_attributesToGetHasBeenSet = true;
