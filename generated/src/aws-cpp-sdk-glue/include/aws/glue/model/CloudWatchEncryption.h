...
class CloudWatchEncryption {
 public:
  ...
  inline void SetCloudWatchEncryptionMode(CloudWatchEncryptionMode value) {
    m_cloudWatchEncryptionModeHasBeenSet = true;
    m_cloudWatchEncryptionMode = value;
  }
  inline CloudWatchEncryption& WithCloudWatchEncryptionMode(CloudWatchEncryptionMode value) {
    SetCloudWatchEncryptionMode(value);
    return *this;
  }
  ///@}
