...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API DeleteBlueprintResult() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteBlueprintResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteBlueprintResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
