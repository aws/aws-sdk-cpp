...
namespace Model
{
  ...
  public:
    ...
    template<typename CatalogIdT = Aws::String>
    DatabaseIdentifier& WithCatalogId(CatalogIdT&& value) { SetCatalogId(std::forward<CatalogIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    DatabaseIdentifier& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    DatabaseIdentifier& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
  private:
