...
class CreateJobRequest : public GlueRequest {
 public:
  ...
  inline void SetJobMode(JobMode value) {
    m_jobModeHasBeenSet = true;
    m_jobMode = value;
  }
  inline CreateJobRequest& WithJobMode(JobMode value) {
    SetJobMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithJobRunQueuingEnabled(bool value) {
  ...
  void SetExecutionProperty(ExecutionPropertyT&& value) {
    ...
    m_executionProperty = std::forward<ExecutionPropertyT>(value);
  }
  template <typename ExecutionPropertyT = ExecutionProperty>
  CreateJobRequest& WithExecutionProperty(ExecutionPropertyT&& value) {
    SetExecutionProperty(std::forward<ExecutionPropertyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonOverridableArguments(NonOverridableArgumentsT&& value) {
    ...
    m_nonOverridableArguments = std::forward<NonOverridableArgumentsT>(value);
  }
  template <typename NonOverridableArgumentsT = Aws::Map<Aws::String, Aws::String>>
  CreateJobRequest& WithNonOverridableArguments(NonOverridableArgumentsT&& value) {
    SetNonOverridableArguments(std::forward<NonOverridableArgumentsT>(value));
    return *this;
  }
  ...
  CreateJobRequest& AddNonOverridableArguments(NonOverridableArgumentsKeyT&& key, NonOverridableArgumentsValueT&& value) {
    m_nonOverridableArgumentsHasBeenSet = true;
    m_nonOverridableArguments.emplace(std::forward<NonOverridableArgumentsKeyT>(key), std::forward<NonOverridableArgumentsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
   ...
   * blank, the timeout is defaulted to 2,880 minutes for Glue version 4.0 and
  ...
  inline CreateJobRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithMaxCapacity(double value) {
  ...
  inline CreateJobRequest& WithNumberOfWorkers(int value) {
  ...
  inline CreateJobRequest& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  void SetCodeGenConfigurationNodes(CodeGenConfigurationNodesT&& value) {
    ...
    m_codeGenConfigurationNodes = std::forward<CodeGenConfigurationNodesT>(value);
  }
  template <typename CodeGenConfigurationNodesT = Aws::Map<Aws::String, CodeGenConfigurationNode>>
  CreateJobRequest& WithCodeGenConfigurationNodes(CodeGenConfigurationNodesT&& value) {
    SetCodeGenConfigurationNodes(std::forward<CodeGenConfigurationNodesT>(value));
    return *this;
  }
  ...
  CreateJobRequest& AddCodeGenConfigurationNodes(CodeGenConfigurationNodesKeyT&& key, CodeGenConfigurationNodesValueT&& value) {
    m_codeGenConfigurationNodesHasBeenSet = true;
    m_codeGenConfigurationNodes.emplace(std::forward<CodeGenConfigurationNodesKeyT>(key),
                                        std::forward<CodeGenConfigurationNodesValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateJobRequest& WithExecutionClass(ExecutionClass value) {
  ...
  void SetSourceControlDetails(SourceControlDetailsT&& value) {
    ...
    m_sourceControlDetails = std::forward<SourceControlDetailsT>(value);
  }
  template <typename SourceControlDetailsT = SourceControlDetails>
  CreateJobRequest& WithSourceControlDetails(SourceControlDetailsT&& value) {
    SetSourceControlDetails(std::forward<SourceControlDetailsT>(value));
    return *this;
  }
  ///@}
