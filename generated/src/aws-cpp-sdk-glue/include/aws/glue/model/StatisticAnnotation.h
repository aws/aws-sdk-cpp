...
class StatisticAnnotation {
 public:
  ...
  void SetStatisticRecordedOn(StatisticRecordedOnT&& value) {
    ...
    m_statisticRecordedOn = std::forward<StatisticRecordedOnT>(value);
  }
  template <typename StatisticRecordedOnT = Aws::Utils::DateTime>
  StatisticAnnotation& WithStatisticRecordedOn(StatisticRecordedOnT&& value) {
    SetStatisticRecordedOn(std::forward<StatisticRecordedOnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInclusionAnnotation(InclusionAnnotationT&& value) {
    ...
    m_inclusionAnnotation = std::forward<InclusionAnnotationT>(value);
  }
  template <typename InclusionAnnotationT = TimestampedInclusionAnnotation>
  StatisticAnnotation& WithInclusionAnnotation(InclusionAnnotationT&& value) {
    SetInclusionAnnotation(std::forward<InclusionAnnotationT>(value));
    return *this;
  }
  ///@}
 private:
