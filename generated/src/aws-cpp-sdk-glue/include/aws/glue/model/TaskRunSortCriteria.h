...
class TaskRunSortCriteria {
 public:
  ...
  inline void SetColumn(TaskRunSortColumnType value) {
    m_columnHasBeenSet = true;
    m_column = value;
  }
  inline TaskRunSortCriteria& WithColumn(TaskRunSortColumnType value) {
    SetColumn(value);
    return *this;
  }
  ///@}
  ...
  inline TaskRunSortCriteria& WithSortDirection(SortDirectionType value) {
