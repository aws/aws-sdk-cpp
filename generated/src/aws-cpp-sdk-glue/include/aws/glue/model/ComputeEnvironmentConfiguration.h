...
class ComputeEnvironmentConfiguration {
 public:
  ...
  inline void SetComputeEnvironment(ComputeEnvironment value) {
    m_computeEnvironmentHasBeenSet = true;
    m_computeEnvironment = value;
  }
  inline ComputeEnvironmentConfiguration& WithComputeEnvironment(ComputeEnvironment value) {
    SetComputeEnvironment(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedAuthenticationTypes(SupportedAuthenticationTypesT&& value) {
    ...
    m_supportedAuthenticationTypes = std::forward<SupportedAuthenticationTypesT>(value);
  }
  template <typename SupportedAuthenticationTypesT = Aws::Vector<AuthenticationType>>
  ComputeEnvironmentConfiguration& WithSupportedAuthenticationTypes(SupportedAuthenticationTypesT&& value) {
    SetSupportedAuthenticationTypes(std::forward<SupportedAuthenticationTypesT>(value));
    return *this;
  }
  inline ComputeEnvironmentConfiguration& AddSupportedAuthenticationTypes(AuthenticationType value) {
    m_supportedAuthenticationTypesHasBeenSet = true;
    m_supportedAuthenticationTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectionPropertyNameOverrides(ConnectionPropertyNameOverridesT&& value) {
    ...
    m_connectionPropertyNameOverrides = std::forward<ConnectionPropertyNameOverridesT>(value);
  }
  template <typename ConnectionPropertyNameOverridesT = Aws::Map<Aws::String, Aws::String>>
  ComputeEnvironmentConfiguration& WithConnectionPropertyNameOverrides(ConnectionPropertyNameOverridesT&& value) {
    SetConnectionPropertyNameOverrides(std::forward<ConnectionPropertyNameOverridesT>(value));
    return *this;
  }
  ...
  ComputeEnvironmentConfiguration& AddConnectionPropertyNameOverrides(ConnectionPropertyNameOverridesKeyT&& key,
                                                                      ConnectionPropertyNameOverridesValueT&& value) {
    m_connectionPropertyNameOverridesHasBeenSet = true;
    m_connectionPropertyNameOverrides.emplace(std::forward<ConnectionPropertyNameOverridesKeyT>(key),
                                              std::forward<ConnectionPropertyNameOverridesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectionOptionNameOverrides(ConnectionOptionNameOverridesT&& value) {
    ...
    m_connectionOptionNameOverrides = std::forward<ConnectionOptionNameOverridesT>(value);
  }
  template <typename ConnectionOptionNameOverridesT = Aws::Map<Aws::String, Aws::String>>
  ComputeEnvironmentConfiguration& WithConnectionOptionNameOverrides(ConnectionOptionNameOverridesT&& value) {
    SetConnectionOptionNameOverrides(std::forward<ConnectionOptionNameOverridesT>(value));
    return *this;
  }
  template <typename ConnectionOptionNameOverridesKeyT = Aws::String, typename ConnectionOptionNameOverridesValueT = Aws::String>
  ComputeEnvironmentConfiguration& AddConnectionOptionNameOverrides(ConnectionOptionNameOverridesKeyT&& key,
                                                                    ConnectionOptionNameOverridesValueT&& value) {
    m_connectionOptionNameOverridesHasBeenSet = true;
    m_connectionOptionNameOverrides.emplace(std::forward<ConnectionOptionNameOverridesKeyT>(key),
                                            std::forward<ConnectionOptionNameOverridesValueT>(value));
    return *this;
  }
  ///@}
   ...
   * environment.</p>
   */
  inline const Aws::Vector<Aws::String>& GetConnectionPropertiesRequiredOverrides() const {
    return m_connectionPropertiesRequiredOverrides;
  }
  ...
  void SetConnectionPropertiesRequiredOverrides(ConnectionPropertiesRequiredOverridesT&& value) {
    ...
    m_connectionPropertiesRequiredOverrides = std::forward<ConnectionPropertiesRequiredOverridesT>(value);
  }
  template <typename ConnectionPropertiesRequiredOverridesT = Aws::Vector<Aws::String>>
  ComputeEnvironmentConfiguration& WithConnectionPropertiesRequiredOverrides(ConnectionPropertiesRequiredOverridesT&& value) {
    SetConnectionPropertiesRequiredOverrides(std::forward<ConnectionPropertiesRequiredOverridesT>(value));
    return *this;
  }
  ...
  ComputeEnvironmentConfiguration& AddConnectionPropertiesRequiredOverrides(ConnectionPropertiesRequiredOverridesT&& value) {
    m_connectionPropertiesRequiredOverridesHasBeenSet = true;
    m_connectionPropertiesRequiredOverrides.emplace_back(std::forward<ConnectionPropertiesRequiredOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPhysicalConnectionPropertiesRequired(bool value) {
    ...
    m_physicalConnectionPropertiesRequired = value;
  }
  inline ComputeEnvironmentConfiguration& WithPhysicalConnectionPropertiesRequired(bool value) {
    SetPhysicalConnectionPropertiesRequired(value);
    return *this;
  }
  ///@}
 private:
