...
class GetConnectionsResult {
 public:
  ...
  void SetConnectionList(ConnectionListT&& value) {
    m_connectionListHasBeenSet = true;
    m_connectionList = std::forward<ConnectionListT>(value);
  }
  template <typename ConnectionListT = Aws::Vector<Connection>>
  GetConnectionsResult& WithConnectionList(ConnectionListT&& value) {
    SetConnectionList(std::forward<ConnectionListT>(value));
    return *this;
  }
  template <typename ConnectionListT = Connection>
  GetConnectionsResult& AddConnectionList(ConnectionListT&& value) {
    m_connectionListHasBeenSet = true;
    m_connectionList.emplace_back(std::forward<ConnectionListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetConnectionsResult& WithRequestId(RequestIdT&& value) {
