...
class MicrosoftSQLServerCatalogTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  MicrosoftSQLServerCatalogTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  MicrosoftSQLServerCatalogTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  MicrosoftSQLServerCatalogTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename DatabaseT = Aws::String>
  MicrosoftSQLServerCatalogTarget& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  MicrosoftSQLServerCatalogTarget& WithTable(TableT&& value) {
