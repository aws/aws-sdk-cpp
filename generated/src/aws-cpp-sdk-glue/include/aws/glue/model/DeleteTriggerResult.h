...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API DeleteTriggerResult() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteTriggerResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTriggerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
