...
namespace Model
{
  ...
  public:
    ...
    inline DeleteTriggerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteTriggerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteTriggerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
