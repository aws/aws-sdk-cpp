...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API S3CatalogSource() = default;
    ...
    template<typename NameT = Aws::String>
    S3CatalogSource& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    S3CatalogSource& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
    ...
    template<typename TableT = Aws::String>
    S3CatalogSource& WithTable(TableT&& value) { SetTable(std::forward<TableT>(value)); return *this;}
    ///@}
    ...
    template<typename PartitionPredicateT = Aws::String>
    S3CatalogSource& WithPartitionPredicate(PartitionPredicateT&& value) { SetPartitionPredicate(std::forward<PartitionPredicateT>(value)); return *this;}
    ///@}
    ...
    template<typename AdditionalOptionsT = S3SourceAdditionalOptions>
    S3CatalogSource& WithAdditionalOptions(AdditionalOptionsT&& value) { SetAdditionalOptions(std::forward<AdditionalOptionsT>(value)); return *this;}
    ///@}
  private:
