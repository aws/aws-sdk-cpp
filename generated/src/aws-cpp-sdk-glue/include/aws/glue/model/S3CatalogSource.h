...
class S3CatalogSource {
 public:
  ...
  template <typename NameT = Aws::String>
  S3CatalogSource& WithName(NameT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  S3CatalogSource& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  S3CatalogSource& WithTable(TableT&& value) {
  ...
  template <typename PartitionPredicateT = Aws::String>
  S3CatalogSource& WithPartitionPredicate(PartitionPredicateT&& value) {
  ...
  template <typename AdditionalOptionsT = S3SourceAdditionalOptions>
  S3CatalogSource& WithAdditionalOptions(AdditionalOptionsT&& value) {
