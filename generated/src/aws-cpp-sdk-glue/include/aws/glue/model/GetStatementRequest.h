...
/**
 */
class GetStatementRequest : public GlueRequest {
 public:
  AWS_GLUE_API GetStatementRequest() = default;
  ...
  template <typename SessionIdT = Aws::String>
  GetStatementRequest& WithSessionId(SessionIdT&& value) {
  ...
  inline GetStatementRequest& WithId(int value) {
    SetId(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestOriginT = Aws::String>
  GetStatementRequest& WithRequestOrigin(RequestOriginT&& value) {
