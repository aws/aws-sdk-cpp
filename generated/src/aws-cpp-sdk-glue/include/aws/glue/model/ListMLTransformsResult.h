...
class ListMLTransformsResult {
 public:
  ...
  void SetTransformIds(TransformIdsT&& value) {
    m_transformIdsHasBeenSet = true;
    m_transformIds = std::forward<TransformIdsT>(value);
  }
  template <typename TransformIdsT = Aws::Vector<Aws::String>>
  ListMLTransformsResult& WithTransformIds(TransformIdsT&& value) {
    SetTransformIds(std::forward<TransformIdsT>(value));
    return *this;
  }
  template <typename TransformIdsT = Aws::String>
  ListMLTransformsResult& AddTransformIds(TransformIdsT&& value) {
    m_transformIdsHasBeenSet = true;
    m_transformIds.emplace_back(std::forward<TransformIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMLTransformsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMLTransformsResult& WithRequestId(RequestIdT&& value) {
