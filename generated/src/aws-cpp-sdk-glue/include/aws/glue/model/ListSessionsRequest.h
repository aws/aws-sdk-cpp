...
namespace Model
{
  ...
  public:
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ListSessionsRequest& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename RequestOriginT = Aws::String>
    ListSessionsRequest& WithRequestOrigin(RequestOriginT&& value) { SetRequestOrigin(std::forward<RequestOriginT>(value)); return *this;}
    ///@}
  private:
