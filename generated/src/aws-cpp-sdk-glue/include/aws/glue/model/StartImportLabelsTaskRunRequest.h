...
class StartImportLabelsTaskRunRequest : public GlueRequest {
 public:
  ...
  template <typename TransformIdT = Aws::String>
  StartImportLabelsTaskRunRequest& WithTransformId(TransformIdT&& value) {
  ...
  void SetInputS3Path(InputS3PathT&& value) {
    ...
    m_inputS3Path = std::forward<InputS3PathT>(value);
  }
  template <typename InputS3PathT = Aws::String>
  StartImportLabelsTaskRunRequest& WithInputS3Path(InputS3PathT&& value) {
    SetInputS3Path(std::forward<InputS3PathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReplaceAllLabels(bool value) {
    m_replaceAllLabelsHasBeenSet = true;
    m_replaceAllLabels = value;
  }
  inline StartImportLabelsTaskRunRequest& WithReplaceAllLabels(bool value) {
    SetReplaceAllLabels(value);
    return *this;
  }
  ///@}
 private:
