...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API RemoveSchemaVersionMetadataRequest() = default;
    ...
    template<typename SchemaIdT = SchemaId>
    RemoveSchemaVersionMetadataRequest& WithSchemaId(SchemaIdT&& value) { SetSchemaId(std::forward<SchemaIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaVersionNumberT = SchemaVersionNumber>
    RemoveSchemaVersionMetadataRequest& WithSchemaVersionNumber(SchemaVersionNumberT&& value) { SetSchemaVersionNumber(std::forward<SchemaVersionNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename SchemaVersionIdT = Aws::String>
    RemoveSchemaVersionMetadataRequest& WithSchemaVersionId(SchemaVersionIdT&& value) { SetSchemaVersionId(std::forward<SchemaVersionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataKeyValueT = MetadataKeyValuePair>
    RemoveSchemaVersionMetadataRequest& WithMetadataKeyValue(MetadataKeyValueT&& value) { SetMetadataKeyValue(std::forward<MetadataKeyValueT>(value)); return *this;}
    ///@}
  private:
