...
class DataQualityResult {
 public:
  ...
  inline DataQualityResult& WithScore(double value) {
    SetScore(value);
    return *this;
  }
  ///@}
  ...
  void SetJobRunId(JobRunIdT&& value) {
    ...
    m_jobRunId = std::forward<JobRunIdT>(value);
  }
  template <typename JobRunIdT = Aws::String>
  DataQualityResult& WithJobRunId(JobRunIdT&& value) {
    SetJobRunId(std::forward<JobRunIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRulesetEvaluationRunId(RulesetEvaluationRunIdT&& value) {
    ...
    m_rulesetEvaluationRunId = std::forward<RulesetEvaluationRunIdT>(value);
  }
  template <typename RulesetEvaluationRunIdT = Aws::String>
  DataQualityResult& WithRulesetEvaluationRunId(RulesetEvaluationRunIdT&& value) {
    SetRulesetEvaluationRunId(std::forward<RulesetEvaluationRunIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAggregatedMetrics(AggregatedMetricsT&& value) {
    ...
    m_aggregatedMetrics = std::forward<AggregatedMetricsT>(value);
  }
  template <typename AggregatedMetricsT = DataQualityAggregatedMetrics>
  DataQualityResult& WithAggregatedMetrics(AggregatedMetricsT&& value) {
    SetAggregatedMetrics(std::forward<AggregatedMetricsT>(value));
    return *this;
  }
  ///@}
 private:
