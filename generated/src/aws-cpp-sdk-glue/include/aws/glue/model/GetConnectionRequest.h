...
class GetConnectionRequest : public GlueRequest {
 public:
  ...
  inline void SetHidePassword(bool value) {
    m_hidePasswordHasBeenSet = true;
    m_hidePassword = value;
  }
  inline GetConnectionRequest& WithHidePassword(bool value) {
  ...
  inline void SetApplyOverrideForComputeEnvironment(ComputeEnvironment value) {
    m_applyOverrideForComputeEnvironmentHasBeenSet = true;
    m_applyOverrideForComputeEnvironment = value;
  }
  inline GetConnectionRequest& WithApplyOverrideForComputeEnvironment(ComputeEnvironment value) {
    SetApplyOverrideForComputeEnvironment(value);
    return *this;
  }
  ///@}
 private:
