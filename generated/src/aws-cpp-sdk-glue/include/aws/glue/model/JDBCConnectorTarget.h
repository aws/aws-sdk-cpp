...
class JDBCConnectorTarget {
 public:
  ...
  template <typename NameT = Aws::String>
  JDBCConnectorTarget& WithName(NameT&& value) {
  ...
  template <typename InputsT = Aws::Vector<Aws::String>>
  JDBCConnectorTarget& WithInputs(InputsT&& value) {
    SetInputs(std::forward<InputsT>(value));
    return *this;
  }
  template <typename InputsT = Aws::String>
  JDBCConnectorTarget& AddInputs(InputsT&& value) {
    m_inputsHasBeenSet = true;
  ...
  template <typename ConnectionNameT = Aws::String>
  JDBCConnectorTarget& WithConnectionName(ConnectionNameT&& value) {
  ...
  template <typename ConnectionTableT = Aws::String>
  JDBCConnectorTarget& WithConnectionTable(ConnectionTableT&& value) {
  ...
  template <typename ConnectorNameT = Aws::String>
  JDBCConnectorTarget& WithConnectorName(ConnectorNameT&& value) {
  ...
  template <typename ConnectionTypeT = Aws::String>
  JDBCConnectorTarget& WithConnectionType(ConnectionTypeT&& value) {
  ...
  template <typename AdditionalOptionsT = Aws::Map<Aws::String, Aws::String>>
  JDBCConnectorTarget& WithAdditionalOptions(AdditionalOptionsT&& value) {
  ...
  template <typename OutputSchemasT = Aws::Vector<GlueSchema>>
  JDBCConnectorTarget& WithOutputSchemas(OutputSchemasT&& value) {
    SetOutputSchemas(std::forward<OutputSchemasT>(value));
    return *this;
  }
  template <typename OutputSchemasT = GlueSchema>
  JDBCConnectorTarget& AddOutputSchemas(OutputSchemasT&& value) {
    m_outputSchemasHasBeenSet = true;
