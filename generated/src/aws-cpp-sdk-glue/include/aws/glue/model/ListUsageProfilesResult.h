...
class ListUsageProfilesResult {
 public:
  ...
  template <typename ProfilesT = Aws::Vector<UsageProfileDefinition>>
  ListUsageProfilesResult& WithProfiles(ProfilesT&& value) {
    SetProfiles(std::forward<ProfilesT>(value));
    return *this;
  }
  template <typename ProfilesT = UsageProfileDefinition>
  ListUsageProfilesResult& AddProfiles(ProfilesT&& value) {
    m_profilesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListUsageProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUsageProfilesResult& WithRequestId(RequestIdT&& value) {
