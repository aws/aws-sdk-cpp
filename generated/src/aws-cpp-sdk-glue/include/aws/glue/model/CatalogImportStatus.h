...
class CatalogImportStatus {
 public:
  ...
  inline void SetImportCompleted(bool value) {
    m_importCompletedHasBeenSet = true;
    m_importCompleted = value;
  }
  inline CatalogImportStatus& WithImportCompleted(bool value) {
    SetImportCompleted(value);
    return *this;
  }
  ///@}
  ...
  void SetImportTime(ImportTimeT&& value) {
    ...
    m_importTime = std::forward<ImportTimeT>(value);
  }
  template <typename ImportTimeT = Aws::Utils::DateTime>
  CatalogImportStatus& WithImportTime(ImportTimeT&& value) {
    SetImportTime(std::forward<ImportTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetImportedBy(ImportedByT&& value) {
    ...
    m_importedBy = std::forward<ImportedByT>(value);
  }
  template <typename ImportedByT = Aws::String>
  CatalogImportStatus& WithImportedBy(ImportedByT&& value) {
    SetImportedBy(std::forward<ImportedByT>(value));
    return *this;
  }
  ///@}
 private:
