...
class UpdateColumnStatisticsForPartitionRequest : public GlueRequest {
 public:
  ...
  template <typename CatalogIdT = Aws::String>
  UpdateColumnStatisticsForPartitionRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  UpdateColumnStatisticsForPartitionRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  UpdateColumnStatisticsForPartitionRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename PartitionValuesT = Aws::Vector<Aws::String>>
  UpdateColumnStatisticsForPartitionRequest& WithPartitionValues(PartitionValuesT&& value) {
    SetPartitionValues(std::forward<PartitionValuesT>(value));
    return *this;
  }
  template <typename PartitionValuesT = Aws::String>
  UpdateColumnStatisticsForPartitionRequest& AddPartitionValues(PartitionValuesT&& value) {
    m_partitionValuesHasBeenSet = true;
  ...
  template <typename ColumnStatisticsListT = Aws::Vector<ColumnStatistics>>
  UpdateColumnStatisticsForPartitionRequest& WithColumnStatisticsList(ColumnStatisticsListT&& value) {
    SetColumnStatisticsList(std::forward<ColumnStatisticsListT>(value));
    return *this;
  }
  template <typename ColumnStatisticsListT = ColumnStatistics>
  UpdateColumnStatisticsForPartitionRequest& AddColumnStatisticsList(ColumnStatisticsListT&& value) {
    m_columnStatisticsListHasBeenSet = true;
