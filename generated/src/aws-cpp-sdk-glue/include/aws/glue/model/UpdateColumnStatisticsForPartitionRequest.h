...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API UpdateColumnStatisticsForPartitionRequest() = default;
    ...
    template<typename CatalogIdT = Aws::String>
    UpdateColumnStatisticsForPartitionRequest& WithCatalogId(CatalogIdT&& value) { SetCatalogId(std::forward<CatalogIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    UpdateColumnStatisticsForPartitionRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TableNameT = Aws::String>
    UpdateColumnStatisticsForPartitionRequest& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PartitionValuesT = Aws::Vector<Aws::String>>
    UpdateColumnStatisticsForPartitionRequest& WithPartitionValues(PartitionValuesT&& value) { SetPartitionValues(std::forward<PartitionValuesT>(value)); return *this;}
    template<typename PartitionValuesT = Aws::String>
    UpdateColumnStatisticsForPartitionRequest& AddPartitionValues(PartitionValuesT&& value) { m_partitionValuesHasBeenSet = true; m_partitionValues.emplace_back(std::forward<PartitionValuesT>(value)); return *this; }
    ///@}
    ...
    template<typename ColumnStatisticsListT = Aws::Vector<ColumnStatistics>>
    UpdateColumnStatisticsForPartitionRequest& WithColumnStatisticsList(ColumnStatisticsListT&& value) { SetColumnStatisticsList(std::forward<ColumnStatisticsListT>(value)); return *this;}
    template<typename ColumnStatisticsListT = ColumnStatistics>
    UpdateColumnStatisticsForPartitionRequest& AddColumnStatisticsList(ColumnStatisticsListT&& value) { m_columnStatisticsListHasBeenSet = true; m_columnStatisticsList.emplace_back(std::forward<ColumnStatisticsListT>(value)); return *this; }
    ///@}
  private:
