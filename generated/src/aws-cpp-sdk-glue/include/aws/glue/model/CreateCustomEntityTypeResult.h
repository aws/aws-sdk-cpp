...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API CreateCustomEntityTypeResult() = default;
    ...
    template<typename NameT = Aws::String>
    CreateCustomEntityTypeResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateCustomEntityTypeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
