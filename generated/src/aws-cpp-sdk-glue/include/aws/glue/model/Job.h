...
class Job {
 public:
  ...
  inline Job& WithJobMode(JobMode value) {
    SetJobMode(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithJobRunQueuingEnabled(bool value) {
  ...
  inline Job& WithMaxCapacity(double value) {
  ...
  inline Job& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithNumberOfWorkers(int value) {
  ...
  inline Job& WithExecutionClass(ExecutionClass value) {
