...
class BatchCreatePartitionRequest : public GlueRequest {
 public:
  ...
  void SetPartitionInputList(PartitionInputListT&& value) {
    m_partitionInputListHasBeenSet = true;
    m_partitionInputList = std::forward<PartitionInputListT>(value);
  }
  template <typename PartitionInputListT = Aws::Vector<PartitionInput>>
  BatchCreatePartitionRequest& WithPartitionInputList(PartitionInputListT&& value) {
    SetPartitionInputList(std::forward<PartitionInputListT>(value));
    return *this;
  }
  ...
  BatchCreatePartitionRequest& AddPartitionInputList(PartitionInputListT&& value) {
    m_partitionInputListHasBeenSet = true;
    m_partitionInputList.emplace_back(std::forward<PartitionInputListT>(value));
    return *this;
  }
  ///@}
 private:
