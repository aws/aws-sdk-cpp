...
class S3DirectSourceAdditionalOptions {
 public:
  ...
  inline void SetBoundedSize(long long value) {
    m_boundedSizeHasBeenSet = true;
    m_boundedSize = value;
  }
  inline S3DirectSourceAdditionalOptions& WithBoundedSize(long long value) {
    SetBoundedSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBoundedFiles(long long value) {
    m_boundedFilesHasBeenSet = true;
    m_boundedFiles = value;
  }
  inline S3DirectSourceAdditionalOptions& WithBoundedFiles(long long value) {
    SetBoundedFiles(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableSamplePath(bool value) {
    m_enableSamplePathHasBeenSet = true;
    m_enableSamplePath = value;
  }
  inline S3DirectSourceAdditionalOptions& WithEnableSamplePath(bool value) {
    SetEnableSamplePath(value);
    return *this;
  }
  ///@}
  ...
  void SetSamplePath(SamplePathT&& value) {
    ...
    m_samplePath = std::forward<SamplePathT>(value);
  }
  template <typename SamplePathT = Aws::String>
  S3DirectSourceAdditionalOptions& WithSamplePath(SamplePathT&& value) {
    SetSamplePath(std::forward<SamplePathT>(value));
    return *this;
  }
  ///@}
 private:
