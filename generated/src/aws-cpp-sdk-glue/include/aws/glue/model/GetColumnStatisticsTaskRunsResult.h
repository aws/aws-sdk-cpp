...
class GetColumnStatisticsTaskRunsResult {
 public:
  ...
  void SetColumnStatisticsTaskRuns(ColumnStatisticsTaskRunsT&& value) {
    m_columnStatisticsTaskRunsHasBeenSet = true;
    m_columnStatisticsTaskRuns = std::forward<ColumnStatisticsTaskRunsT>(value);
  }
  template <typename ColumnStatisticsTaskRunsT = Aws::Vector<ColumnStatisticsTaskRun>>
  GetColumnStatisticsTaskRunsResult& WithColumnStatisticsTaskRuns(ColumnStatisticsTaskRunsT&& value) {
    SetColumnStatisticsTaskRuns(std::forward<ColumnStatisticsTaskRunsT>(value));
    return *this;
  }
  template <typename ColumnStatisticsTaskRunsT = ColumnStatisticsTaskRun>
  GetColumnStatisticsTaskRunsResult& AddColumnStatisticsTaskRuns(ColumnStatisticsTaskRunsT&& value) {
    m_columnStatisticsTaskRunsHasBeenSet = true;
    m_columnStatisticsTaskRuns.emplace_back(std::forward<ColumnStatisticsTaskRunsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetColumnStatisticsTaskRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetColumnStatisticsTaskRunsResult& WithRequestId(RequestIdT&& value) {
