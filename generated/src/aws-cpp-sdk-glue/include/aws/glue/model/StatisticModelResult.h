...
class StatisticModelResult {
 public:
  ...
  inline void SetLowerBound(double value) {
    m_lowerBoundHasBeenSet = true;
    m_lowerBound = value;
  }
  inline StatisticModelResult& WithLowerBound(double value) {
    SetLowerBound(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUpperBound(double value) {
    m_upperBoundHasBeenSet = true;
    m_upperBound = value;
  }
  inline StatisticModelResult& WithUpperBound(double value) {
    SetUpperBound(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPredictedValue(double value) {
    m_predictedValueHasBeenSet = true;
    m_predictedValue = value;
  }
  inline StatisticModelResult& WithPredictedValue(double value) {
  ...
  inline void SetActualValue(double value) {
    m_actualValueHasBeenSet = true;
    m_actualValue = value;
  }
  inline StatisticModelResult& WithActualValue(double value) {
  ...
  inline StatisticModelResult& WithInclusionAnnotation(InclusionAnnotationValue value) {
