...
class TransformFilterCriteria {
 public:
  ...
  template <typename NameT = Aws::String>
  TransformFilterCriteria& WithName(NameT&& value) {
  ...
  inline TransformFilterCriteria& WithTransformType(TransformType value) {
  ...
  inline TransformFilterCriteria& WithStatus(TransformStatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename GlueVersionT = Aws::String>
  TransformFilterCriteria& WithGlueVersion(GlueVersionT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  TransformFilterCriteria& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  TransformFilterCriteria& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename LastModifiedBeforeT = Aws::Utils::DateTime>
  TransformFilterCriteria& WithLastModifiedBefore(LastModifiedBeforeT&& value) {
  ...
  template <typename LastModifiedAfterT = Aws::Utils::DateTime>
  TransformFilterCriteria& WithLastModifiedAfter(LastModifiedAfterT&& value) {
  ...
  template <typename SchemaT = Aws::Vector<SchemaColumn>>
  TransformFilterCriteria& WithSchema(SchemaT&& value) {
    SetSchema(std::forward<SchemaT>(value));
    return *this;
  }
  template <typename SchemaT = SchemaColumn>
  TransformFilterCriteria& AddSchema(SchemaT&& value) {
    m_schemaHasBeenSet = true;
