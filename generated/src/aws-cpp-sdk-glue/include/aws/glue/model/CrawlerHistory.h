...
class CrawlerHistory {
 public:
  ...
  void SetCrawlId(CrawlIdT&& value) {
    ...
    m_crawlId = std::forward<CrawlIdT>(value);
  }
  template <typename CrawlIdT = Aws::String>
  CrawlerHistory& WithCrawlId(CrawlIdT&& value) {
    SetCrawlId(std::forward<CrawlIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(CrawlerHistoryState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CrawlerHistory& WithState(CrawlerHistoryState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetMessagePrefix(MessagePrefixT&& value) {
    ...
    m_messagePrefix = std::forward<MessagePrefixT>(value);
  }
  template <typename MessagePrefixT = Aws::String>
  CrawlerHistory& WithMessagePrefix(MessagePrefixT&& value) {
    SetMessagePrefix(std::forward<MessagePrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDPUHour(double value) {
    m_dPUHourHasBeenSet = true;
    m_dPUHour = value;
  }
  inline CrawlerHistory& WithDPUHour(double value) {
    SetDPUHour(value);
    return *this;
  }
  ///@}
