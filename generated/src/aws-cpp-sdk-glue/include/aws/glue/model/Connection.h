...
class Connection {
 public:
  ...
  inline Connection& WithConnectionType(ConnectionType value) {
  ...
  Connection& AddMatchCriteria(MatchCriteriaT&& value) {
    m_matchCriteriaHasBeenSet = true;
    m_matchCriteria.emplace_back(std::forward<MatchCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  inline Connection& AddConnectionProperties(ConnectionPropertyKey key, Aws::String value) {
    m_connectionPropertiesHasBeenSet = true;
    m_connectionProperties.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline Connection& WithStatus(ConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastConnectionValidationTime(LastConnectionValidationTimeT&& value) {
    ...
    m_lastConnectionValidationTime = std::forward<LastConnectionValidationTimeT>(value);
  }
  template <typename LastConnectionValidationTimeT = Aws::Utils::DateTime>
  Connection& WithLastConnectionValidationTime(LastConnectionValidationTimeT&& value) {
    SetLastConnectionValidationTime(std::forward<LastConnectionValidationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConnectionSchemaVersion(int value) {
    m_connectionSchemaVersionHasBeenSet = true;
    m_connectionSchemaVersion = value;
  }
  inline Connection& WithConnectionSchemaVersion(int value) {
    SetConnectionSchemaVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetCompatibleComputeEnvironments(CompatibleComputeEnvironmentsT&& value) {
    ...
    m_compatibleComputeEnvironments = std::forward<CompatibleComputeEnvironmentsT>(value);
  }
  template <typename CompatibleComputeEnvironmentsT = Aws::Vector<ComputeEnvironment>>
  Connection& WithCompatibleComputeEnvironments(CompatibleComputeEnvironmentsT&& value) {
    SetCompatibleComputeEnvironments(std::forward<CompatibleComputeEnvironmentsT>(value));
    return *this;
  }
  inline Connection& AddCompatibleComputeEnvironments(ComputeEnvironment value) {
    m_compatibleComputeEnvironmentsHasBeenSet = true;
    m_compatibleComputeEnvironments.push_back(value);
    return *this;
  }
  ///@}
 private:
