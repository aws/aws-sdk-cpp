...
class Node {
 public:
  ...
  inline Node& WithType(NodeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename UniqueIdT = Aws::String>
  Node& WithUniqueId(UniqueIdT&& value) {
  ...
  template <typename TriggerDetailsT = TriggerNodeDetails>
  Node& WithTriggerDetails(TriggerDetailsT&& value) {
  ...
  template <typename JobDetailsT = JobNodeDetails>
  Node& WithJobDetails(JobDetailsT&& value) {
  ...
  void SetCrawlerDetails(CrawlerDetailsT&& value) {
    m_crawlerDetailsHasBeenSet = true;
    m_crawlerDetails = std::forward<CrawlerDetailsT>(value);
  }
  template <typename CrawlerDetailsT = CrawlerNodeDetails>
  Node& WithCrawlerDetails(CrawlerDetailsT&& value) {
    SetCrawlerDetails(std::forward<CrawlerDetailsT>(value));
    return *this;
  }
  ///@}
 private:
