...
class CreateSchemaResult {
 public:
  ...
  inline CreateSchemaResult& WithDataFormat(DataFormat value) {
    SetDataFormat(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSchemaResult& WithCompatibility(Compatibility value) {
  ...
  inline CreateSchemaResult& WithSchemaCheckpoint(long long value) {
  ...
  inline CreateSchemaResult& WithLatestSchemaVersion(long long value) {
  ...
  inline CreateSchemaResult& WithNextSchemaVersion(long long value) {
  ...
  inline CreateSchemaResult& WithSchemaStatus(SchemaStatus value) {
  ...
  inline void SetSchemaVersionStatus(SchemaVersionStatus value) {
    m_schemaVersionStatusHasBeenSet = true;
    m_schemaVersionStatus = value;
  }
  inline CreateSchemaResult& WithSchemaVersionStatus(SchemaVersionStatus value) {
    SetSchemaVersionStatus(value);
    return *this;
  }
  ///@}
