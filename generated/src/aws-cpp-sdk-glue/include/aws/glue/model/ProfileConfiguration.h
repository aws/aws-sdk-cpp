...
class ProfileConfiguration {
 public:
  ...
  ProfileConfiguration& AddSessionConfiguration(SessionConfigurationKeyT&& key, SessionConfigurationValueT&& value) {
    m_sessionConfigurationHasBeenSet = true;
    m_sessionConfiguration.emplace(std::forward<SessionConfigurationKeyT>(key), std::forward<SessionConfigurationValueT>(value));
    return *this;
  }
  ///@}
  ...
  ProfileConfiguration& AddJobConfiguration(JobConfigurationKeyT&& key, JobConfigurationValueT&& value) {
    m_jobConfigurationHasBeenSet = true;
    m_jobConfiguration.emplace(std::forward<JobConfigurationKeyT>(key), std::forward<JobConfigurationValueT>(value));
    return *this;
  }
  ///@}
 private:
