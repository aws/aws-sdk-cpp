...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API DeleteDevEndpointResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDevEndpointResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
