...
class S3CatalogIcebergSource {
 public:
  ...
  template <typename NameT = Aws::String>
  S3CatalogIcebergSource& WithName(NameT&& value) {
  ...
  template <typename DatabaseT = Aws::String>
  S3CatalogIcebergSource& WithDatabase(DatabaseT&& value) {
  ...
  template <typename TableT = Aws::String>
  S3CatalogIcebergSource& WithTable(TableT&& value) {
  ...
  template <typename AdditionalIcebergOptionsT = Aws::Map<Aws::String, Aws::String>>
  S3CatalogIcebergSource& WithAdditionalIcebergOptions(AdditionalIcebergOptionsT&& value) {
  ...
  template <typename OutputSchemasT = Aws::Vector<GlueSchema>>
  S3CatalogIcebergSource& WithOutputSchemas(OutputSchemasT&& value) {
    SetOutputSchemas(std::forward<OutputSchemasT>(value));
    return *this;
  }
  template <typename OutputSchemasT = GlueSchema>
  S3CatalogIcebergSource& AddOutputSchemas(OutputSchemasT&& value) {
    m_outputSchemasHasBeenSet = true;
