...
namespace Model
{
   ...
   * Catalog. The Iceberg data source must be stored in Amazon S3.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3CatalogIcebergSource">AWS
   * API Reference</a></p>
   */
  class S3CatalogIcebergSource
  {
  public:
    AWS_GLUE_API S3CatalogIcebergSource() = default;
    AWS_GLUE_API S3CatalogIcebergSource(Aws::Utils::Json::JsonView jsonValue);
    AWS_GLUE_API S3CatalogIcebergSource& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename NameT = Aws::String>
    S3CatalogIcebergSource& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseT = Aws::String>
    S3CatalogIcebergSource& WithDatabase(DatabaseT&& value) { SetDatabase(std::forward<DatabaseT>(value)); return *this;}
    ///@}
    ...
    template<typename TableT = Aws::String>
    S3CatalogIcebergSource& WithTable(TableT&& value) { SetTable(std::forward<TableT>(value)); return *this;}
    ///@}
    ...
    template<typename AdditionalIcebergOptionsT = Aws::Map<Aws::String, Aws::String>>
    S3CatalogIcebergSource& WithAdditionalIcebergOptions(AdditionalIcebergOptionsT&& value) { SetAdditionalIcebergOptions(std::forward<AdditionalIcebergOptionsT>(value)); return *this;}
    template<typename AdditionalIcebergOptionsKeyT = Aws::String, typename AdditionalIcebergOptionsValueT = Aws::String>
    S3CatalogIcebergSource& AddAdditionalIcebergOptions(AdditionalIcebergOptionsKeyT&& key, AdditionalIcebergOptionsValueT&& value) {
    ...
    template<typename OutputSchemasT = Aws::Vector<GlueSchema>>
    S3CatalogIcebergSource& WithOutputSchemas(OutputSchemasT&& value) { SetOutputSchemas(std::forward<OutputSchemasT>(value)); return *this;}
    template<typename OutputSchemasT = GlueSchema>
    S3CatalogIcebergSource& AddOutputSchemas(OutputSchemasT&& value) { m_outputSchemasHasBeenSet = true; m_outputSchemas.emplace_back(std::forward<OutputSchemasT>(value)); return *this; }
    ///@}
  private:
