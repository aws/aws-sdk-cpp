...
class Property {
 public:
  ...
  inline Property& WithRequired(bool value) {
    SetRequired(value);
    return *this;
  }
  ///@}
  ...
  void SetPropertyTypes(PropertyTypesT&& value) {
    ...
    m_propertyTypes = std::forward<PropertyTypesT>(value);
  }
  template <typename PropertyTypesT = Aws::Vector<PropertyType>>
  Property& WithPropertyTypes(PropertyTypesT&& value) {
    SetPropertyTypes(std::forward<PropertyTypesT>(value));
    return *this;
  }
  inline Property& AddPropertyTypes(PropertyType value) {
    m_propertyTypesHasBeenSet = true;
    m_propertyTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetDataOperationScopes(DataOperationScopesT&& value) {
    ...
    m_dataOperationScopes = std::forward<DataOperationScopesT>(value);
  }
  template <typename DataOperationScopesT = Aws::Vector<DataOperation>>
  Property& WithDataOperationScopes(DataOperationScopesT&& value) {
    SetDataOperationScopes(std::forward<DataOperationScopesT>(value));
    return *this;
  }
  inline Property& AddDataOperationScopes(DataOperation value) {
    m_dataOperationScopesHasBeenSet = true;
    m_dataOperationScopes.push_back(value);
    return *this;
  }
  ///@}
 private:
