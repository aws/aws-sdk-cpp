...
class S3ParquetSource {
 public:
  ...
  inline void SetCompressionType(ParquetCompressionType value) {
    m_compressionTypeHasBeenSet = true;
    m_compressionType = value;
  }
  inline S3ParquetSource& WithCompressionType(ParquetCompressionType value) {
  ...
  void SetGroupSize(GroupSizeT&& value) {
    ...
    m_groupSize = std::forward<GroupSizeT>(value);
  }
  template <typename GroupSizeT = Aws::String>
  S3ParquetSource& WithGroupSize(GroupSizeT&& value) {
    SetGroupSize(std::forward<GroupSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupFiles(GroupFilesT&& value) {
    ...
    m_groupFiles = std::forward<GroupFilesT>(value);
  }
  template <typename GroupFilesT = Aws::String>
  S3ParquetSource& WithGroupFiles(GroupFilesT&& value) {
    SetGroupFiles(std::forward<GroupFilesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRecurse(bool value) {
    m_recurseHasBeenSet = true;
    m_recurse = value;
  }
  inline S3ParquetSource& WithRecurse(bool value) {
    SetRecurse(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxBand(int value) {
    m_maxBandHasBeenSet = true;
    m_maxBand = value;
  }
  inline S3ParquetSource& WithMaxBand(int value) {
    SetMaxBand(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxFilesInBand(int value) {
    m_maxFilesInBandHasBeenSet = true;
    m_maxFilesInBand = value;
  }
  inline S3ParquetSource& WithMaxFilesInBand(int value) {
    SetMaxFilesInBand(value);
    return *this;
  }
  ///@}
