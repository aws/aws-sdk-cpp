...
class UpdateMLTransformRequest : public GlueRequest {
 public:
  ...
  inline UpdateMLTransformRequest& WithMaxCapacity(double value) {
  ...
  inline UpdateMLTransformRequest& WithWorkerType(WorkerType value) {
    SetWorkerType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMLTransformRequest& WithNumberOfWorkers(int value) {
  ...
  inline UpdateMLTransformRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMLTransformRequest& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
