...
class AuditContext {
 public:
  ...
  void SetAdditionalAuditContext(AdditionalAuditContextT&& value) {
    m_additionalAuditContextHasBeenSet = true;
    m_additionalAuditContext = std::forward<AdditionalAuditContextT>(value);
  }
  template <typename AdditionalAuditContextT = Aws::String>
  AuditContext& WithAdditionalAuditContext(AdditionalAuditContextT&& value) {
    SetAdditionalAuditContext(std::forward<AdditionalAuditContextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestedColumns(RequestedColumnsT&& value) {
    m_requestedColumnsHasBeenSet = true;
    m_requestedColumns = std::forward<RequestedColumnsT>(value);
  }
  template <typename RequestedColumnsT = Aws::Vector<Aws::String>>
  AuditContext& WithRequestedColumns(RequestedColumnsT&& value) {
    SetRequestedColumns(std::forward<RequestedColumnsT>(value));
    return *this;
  }
  template <typename RequestedColumnsT = Aws::String>
  AuditContext& AddRequestedColumns(RequestedColumnsT&& value) {
    m_requestedColumnsHasBeenSet = true;
    m_requestedColumns.emplace_back(std::forward<RequestedColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllColumnsRequested(bool value) {
    m_allColumnsRequestedHasBeenSet = true;
    m_allColumnsRequested = value;
  }
  inline AuditContext& WithAllColumnsRequested(bool value) {
    SetAllColumnsRequested(value);
    return *this;
  }
  ///@}
 private:
