...
class MetadataInfo {
 public:
  ...
  template <typename MetadataValueT = Aws::String>
  MetadataInfo& WithMetadataValue(MetadataValueT&& value) {
  ...
  template <typename CreatedTimeT = Aws::String>
  MetadataInfo& WithCreatedTime(CreatedTimeT&& value) {
  ...
  void SetOtherMetadataValueList(OtherMetadataValueListT&& value) {
    m_otherMetadataValueListHasBeenSet = true;
    m_otherMetadataValueList = std::forward<OtherMetadataValueListT>(value);
  }
  template <typename OtherMetadataValueListT = Aws::Vector<OtherMetadataValueListItem>>
  MetadataInfo& WithOtherMetadataValueList(OtherMetadataValueListT&& value) {
    SetOtherMetadataValueList(std::forward<OtherMetadataValueListT>(value));
    return *this;
  }
  template <typename OtherMetadataValueListT = OtherMetadataValueListItem>
  MetadataInfo& AddOtherMetadataValueList(OtherMetadataValueListT&& value) {
    m_otherMetadataValueListHasBeenSet = true;
    m_otherMetadataValueList.emplace_back(std::forward<OtherMetadataValueListT>(value));
    return *this;
  }
  ///@}
 private:
