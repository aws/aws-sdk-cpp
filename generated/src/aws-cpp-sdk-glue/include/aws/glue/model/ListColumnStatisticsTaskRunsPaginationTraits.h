...
struct ListColumnStatisticsTaskRunsPaginationTraits {
  using RequestType = Model::ListColumnStatisticsTaskRunsRequest;
  using ResultType = Model::ListColumnStatisticsTaskRunsResult;
  using OutcomeType = Model::ListColumnStatisticsTaskRunsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListColumnStatisticsTaskRuns(request); }
