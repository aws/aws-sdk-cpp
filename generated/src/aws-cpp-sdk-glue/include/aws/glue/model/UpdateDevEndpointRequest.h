...
class UpdateDevEndpointRequest : public GlueRequest {
 public:
  ...
  void SetAddPublicKeys(AddPublicKeysT&& value) {
    m_addPublicKeysHasBeenSet = true;
    m_addPublicKeys = std::forward<AddPublicKeysT>(value);
  }
  template <typename AddPublicKeysT = Aws::Vector<Aws::String>>
  UpdateDevEndpointRequest& WithAddPublicKeys(AddPublicKeysT&& value) {
    SetAddPublicKeys(std::forward<AddPublicKeysT>(value));
    return *this;
  }
  template <typename AddPublicKeysT = Aws::String>
  UpdateDevEndpointRequest& AddAddPublicKeys(AddPublicKeysT&& value) {
    m_addPublicKeysHasBeenSet = true;
    m_addPublicKeys.emplace_back(std::forward<AddPublicKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeletePublicKeys(DeletePublicKeysT&& value) {
    m_deletePublicKeysHasBeenSet = true;
    m_deletePublicKeys = std::forward<DeletePublicKeysT>(value);
  }
  template <typename DeletePublicKeysT = Aws::Vector<Aws::String>>
  UpdateDevEndpointRequest& WithDeletePublicKeys(DeletePublicKeysT&& value) {
    SetDeletePublicKeys(std::forward<DeletePublicKeysT>(value));
    return *this;
  }
  template <typename DeletePublicKeysT = Aws::String>
  UpdateDevEndpointRequest& AddDeletePublicKeys(DeletePublicKeysT&& value) {
    m_deletePublicKeysHasBeenSet = true;
    m_deletePublicKeys.emplace_back(std::forward<DeletePublicKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomLibraries(CustomLibrariesT&& value) {
    m_customLibrariesHasBeenSet = true;
    m_customLibraries = std::forward<CustomLibrariesT>(value);
  }
  template <typename CustomLibrariesT = DevEndpointCustomLibraries>
  UpdateDevEndpointRequest& WithCustomLibraries(CustomLibrariesT&& value) {
    SetCustomLibraries(std::forward<CustomLibrariesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateEtlLibraries(bool value) {
    m_updateEtlLibrariesHasBeenSet = true;
    m_updateEtlLibraries = value;
  }
  inline UpdateDevEndpointRequest& WithUpdateEtlLibraries(bool value) {
    SetUpdateEtlLibraries(value);
    return *this;
  }
  ///@}
  ...
  void SetDeleteArguments(DeleteArgumentsT&& value) {
    m_deleteArgumentsHasBeenSet = true;
    m_deleteArguments = std::forward<DeleteArgumentsT>(value);
  }
  template <typename DeleteArgumentsT = Aws::Vector<Aws::String>>
  UpdateDevEndpointRequest& WithDeleteArguments(DeleteArgumentsT&& value) {
    SetDeleteArguments(std::forward<DeleteArgumentsT>(value));
    return *this;
  }
  template <typename DeleteArgumentsT = Aws::String>
  UpdateDevEndpointRequest& AddDeleteArguments(DeleteArgumentsT&& value) {
    m_deleteArgumentsHasBeenSet = true;
    m_deleteArguments.emplace_back(std::forward<DeleteArgumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAddArguments(AddArgumentsT&& value) {
    m_addArgumentsHasBeenSet = true;
    m_addArguments = std::forward<AddArgumentsT>(value);
  }
  template <typename AddArgumentsT = Aws::Map<Aws::String, Aws::String>>
  UpdateDevEndpointRequest& WithAddArguments(AddArgumentsT&& value) {
    SetAddArguments(std::forward<AddArgumentsT>(value));
    return *this;
  }
  ...
  UpdateDevEndpointRequest& AddAddArguments(AddArgumentsKeyT&& key, AddArgumentsValueT&& value) {
    m_addArgumentsHasBeenSet = true;
    m_addArguments.emplace(std::forward<AddArgumentsKeyT>(key), std::forward<AddArgumentsValueT>(value));
    return *this;
  }
  ///@}
 private:
