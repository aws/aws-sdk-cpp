...
class CreateTriggerRequest : public GlueRequest {
 public:
  ...
  inline CreateTriggerRequest& WithType(TriggerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartOnCreation(bool value) {
    m_startOnCreationHasBeenSet = true;
    m_startOnCreation = value;
  }
  inline CreateTriggerRequest& WithStartOnCreation(bool value) {
    SetStartOnCreation(value);
    return *this;
  }
  ///@}
