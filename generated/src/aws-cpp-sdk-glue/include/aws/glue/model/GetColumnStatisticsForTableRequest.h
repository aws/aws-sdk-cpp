...
class GetColumnStatisticsForTableRequest : public GlueRequest {
 public:
  AWS_GLUE_API GetColumnStatisticsForTableRequest() = default;
  ...
  template <typename CatalogIdT = Aws::String>
  GetColumnStatisticsForTableRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetColumnStatisticsForTableRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  GetColumnStatisticsForTableRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename ColumnNamesT = Aws::Vector<Aws::String>>
  GetColumnStatisticsForTableRequest& WithColumnNames(ColumnNamesT&& value) {
    SetColumnNames(std::forward<ColumnNamesT>(value));
    return *this;
  }
  template <typename ColumnNamesT = Aws::String>
  GetColumnStatisticsForTableRequest& AddColumnNames(ColumnNamesT&& value) {
    m_columnNamesHasBeenSet = true;
