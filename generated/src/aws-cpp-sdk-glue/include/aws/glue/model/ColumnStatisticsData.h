...
class ColumnStatisticsData {
 public:
  ...
  inline void SetType(ColumnStatisticsType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ColumnStatisticsData& WithType(ColumnStatisticsType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetBooleanColumnStatisticsData(BooleanColumnStatisticsDataT&& value) {
    ...
    m_booleanColumnStatisticsData = std::forward<BooleanColumnStatisticsDataT>(value);
  }
  template <typename BooleanColumnStatisticsDataT = BooleanColumnStatisticsData>
  ColumnStatisticsData& WithBooleanColumnStatisticsData(BooleanColumnStatisticsDataT&& value) {
    SetBooleanColumnStatisticsData(std::forward<BooleanColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateColumnStatisticsData(DateColumnStatisticsDataT&& value) {
    ...
    m_dateColumnStatisticsData = std::forward<DateColumnStatisticsDataT>(value);
  }
  template <typename DateColumnStatisticsDataT = DateColumnStatisticsData>
  ColumnStatisticsData& WithDateColumnStatisticsData(DateColumnStatisticsDataT&& value) {
    SetDateColumnStatisticsData(std::forward<DateColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDecimalColumnStatisticsData(DecimalColumnStatisticsDataT&& value) {
    ...
    m_decimalColumnStatisticsData = std::forward<DecimalColumnStatisticsDataT>(value);
  }
  template <typename DecimalColumnStatisticsDataT = DecimalColumnStatisticsData>
  ColumnStatisticsData& WithDecimalColumnStatisticsData(DecimalColumnStatisticsDataT&& value) {
    SetDecimalColumnStatisticsData(std::forward<DecimalColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDoubleColumnStatisticsData(DoubleColumnStatisticsDataT&& value) {
    ...
    m_doubleColumnStatisticsData = std::forward<DoubleColumnStatisticsDataT>(value);
  }
  template <typename DoubleColumnStatisticsDataT = DoubleColumnStatisticsData>
  ColumnStatisticsData& WithDoubleColumnStatisticsData(DoubleColumnStatisticsDataT&& value) {
    SetDoubleColumnStatisticsData(std::forward<DoubleColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLongColumnStatisticsData(LongColumnStatisticsDataT&& value) {
    ...
    m_longColumnStatisticsData = std::forward<LongColumnStatisticsDataT>(value);
  }
  template <typename LongColumnStatisticsDataT = LongColumnStatisticsData>
  ColumnStatisticsData& WithLongColumnStatisticsData(LongColumnStatisticsDataT&& value) {
    SetLongColumnStatisticsData(std::forward<LongColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStringColumnStatisticsData(StringColumnStatisticsDataT&& value) {
    ...
    m_stringColumnStatisticsData = std::forward<StringColumnStatisticsDataT>(value);
  }
  template <typename StringColumnStatisticsDataT = StringColumnStatisticsData>
  ColumnStatisticsData& WithStringColumnStatisticsData(StringColumnStatisticsDataT&& value) {
    SetStringColumnStatisticsData(std::forward<StringColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBinaryColumnStatisticsData(BinaryColumnStatisticsDataT&& value) {
    ...
    m_binaryColumnStatisticsData = std::forward<BinaryColumnStatisticsDataT>(value);
  }
  template <typename BinaryColumnStatisticsDataT = BinaryColumnStatisticsData>
  ColumnStatisticsData& WithBinaryColumnStatisticsData(BinaryColumnStatisticsDataT&& value) {
    SetBinaryColumnStatisticsData(std::forward<BinaryColumnStatisticsDataT>(value));
    return *this;
  }
  ///@}
 private:
