...
class DeltaTarget {
 public:
  ...
  void SetDeltaTables(DeltaTablesT&& value) {
    ...
    m_deltaTables = std::forward<DeltaTablesT>(value);
  }
  template <typename DeltaTablesT = Aws::Vector<Aws::String>>
  DeltaTarget& WithDeltaTables(DeltaTablesT&& value) {
    SetDeltaTables(std::forward<DeltaTablesT>(value));
    return *this;
  }
  template <typename DeltaTablesT = Aws::String>
  DeltaTarget& AddDeltaTables(DeltaTablesT&& value) {
    m_deltaTablesHasBeenSet = true;
    m_deltaTables.emplace_back(std::forward<DeltaTablesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWriteManifest(bool value) {
    m_writeManifestHasBeenSet = true;
    m_writeManifest = value;
  }
  inline DeltaTarget& WithWriteManifest(bool value) {
    SetWriteManifest(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCreateNativeDeltaTable(bool value) {
    m_createNativeDeltaTableHasBeenSet = true;
    m_createNativeDeltaTable = value;
  }
  inline DeltaTarget& WithCreateNativeDeltaTable(bool value) {
    SetCreateNativeDeltaTable(value);
    return *this;
  }
  ///@}
 private:
