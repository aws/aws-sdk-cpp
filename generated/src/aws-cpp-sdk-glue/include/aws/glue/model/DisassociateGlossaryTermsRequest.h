...
/**
 */
class DisassociateGlossaryTermsRequest : public GlueRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DisassociateGlossaryTerms"; }
