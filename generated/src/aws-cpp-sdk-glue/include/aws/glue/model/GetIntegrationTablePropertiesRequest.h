...
namespace Model
{
  ...
  /**
   */
  class GetIntegrationTablePropertiesRequest : public GlueRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "GetIntegrationTableProperties"; }
    ...
    template<typename ResourceArnT = Aws::String>
    GetIntegrationTablePropertiesRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TableNameT = Aws::String>
    GetIntegrationTablePropertiesRequest& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
  private:
