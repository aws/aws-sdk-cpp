...
class S3Encryption {
 public:
  ...
  inline void SetS3EncryptionMode(S3EncryptionMode value) {
    m_s3EncryptionModeHasBeenSet = true;
    m_s3EncryptionMode = value;
  }
  inline S3Encryption& WithS3EncryptionMode(S3EncryptionMode value) {
    SetS3EncryptionMode(value);
    return *this;
  }
  ///@}
