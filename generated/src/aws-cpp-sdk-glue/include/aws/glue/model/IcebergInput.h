...
class IcebergInput {
 public:
  ...
  inline void SetMetadataOperation(MetadataOperation value) {
    m_metadataOperationHasBeenSet = true;
    m_metadataOperation = value;
  }
  inline IcebergInput& WithMetadataOperation(MetadataOperation value) {
    SetMetadataOperation(value);
    return *this;
  }
  ///@}
  ...
  void SetCreateIcebergTableInput(CreateIcebergTableInputT&& value) {
    ...
    m_createIcebergTableInput = std::forward<CreateIcebergTableInputT>(value);
  }
  template <typename CreateIcebergTableInputT = CreateIcebergTableInput>
  IcebergInput& WithCreateIcebergTableInput(CreateIcebergTableInputT&& value) {
    SetCreateIcebergTableInput(std::forward<CreateIcebergTableInputT>(value));
    return *this;
  }
  ///@}
 private:
