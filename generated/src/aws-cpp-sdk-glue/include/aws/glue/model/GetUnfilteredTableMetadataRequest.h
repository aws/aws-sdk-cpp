...
class GetUnfilteredTableMetadataRequest : public GlueRequest {
 public:
  ...
  template <typename RegionT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithRegion(RegionT&& value) {
  ...
  template <typename CatalogIdT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithCatalogId(CatalogIdT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithName(NameT&& value) {
  ...
  template <typename AuditContextT = AuditContext>
  GetUnfilteredTableMetadataRequest& WithAuditContext(AuditContextT&& value) {
  ...
  template <typename SupportedPermissionTypesT = Aws::Vector<PermissionType>>
  GetUnfilteredTableMetadataRequest& WithSupportedPermissionTypes(SupportedPermissionTypesT&& value) {
    SetSupportedPermissionTypes(std::forward<SupportedPermissionTypesT>(value));
    return *this;
  }
  inline GetUnfilteredTableMetadataRequest& AddSupportedPermissionTypes(PermissionType value) {
    m_supportedPermissionTypesHasBeenSet = true;
  ...
  void SetParentResourceArn(ParentResourceArnT&& value) {
    m_parentResourceArnHasBeenSet = true;
    m_parentResourceArn = std::forward<ParentResourceArnT>(value);
  }
  template <typename ParentResourceArnT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithParentResourceArn(ParentResourceArnT&& value) {
    SetParentResourceArn(std::forward<ParentResourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRootResourceArn(RootResourceArnT&& value) {
    m_rootResourceArnHasBeenSet = true;
    m_rootResourceArn = std::forward<RootResourceArnT>(value);
  }
  template <typename RootResourceArnT = Aws::String>
  GetUnfilteredTableMetadataRequest& WithRootResourceArn(RootResourceArnT&& value) {
    SetRootResourceArn(std::forward<RootResourceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupportedDialect(SupportedDialectT&& value) {
    m_supportedDialectHasBeenSet = true;
    m_supportedDialect = std::forward<SupportedDialectT>(value);
  }
  template <typename SupportedDialectT = SupportedDialect>
  GetUnfilteredTableMetadataRequest& WithSupportedDialect(SupportedDialectT&& value) {
    SetSupportedDialect(std::forward<SupportedDialectT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PermissionsT = Aws::Vector<Permission>>
  GetUnfilteredTableMetadataRequest& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  inline GetUnfilteredTableMetadataRequest& AddPermissions(Permission value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename QuerySessionContextT = QuerySessionContext>
  GetUnfilteredTableMetadataRequest& WithQuerySessionContext(QuerySessionContextT&& value) {
