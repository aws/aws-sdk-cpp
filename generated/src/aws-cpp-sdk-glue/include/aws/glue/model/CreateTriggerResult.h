...
namespace Model
{
  ...
  {
  public:
    AWS_GLUE_API CreateTriggerResult() = default;
    ...
    template<typename NameT = Aws::String>
    CreateTriggerResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTriggerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
