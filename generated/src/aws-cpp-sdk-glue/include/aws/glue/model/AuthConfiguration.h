...
class AuthConfiguration {
 public:
  ...
  void SetAuthenticationType(AuthenticationTypeT&& value) {
    ...
    m_authenticationType = std::forward<AuthenticationTypeT>(value);
  }
  template <typename AuthenticationTypeT = Property>
  AuthConfiguration& WithAuthenticationType(AuthenticationTypeT&& value) {
    SetAuthenticationType(std::forward<AuthenticationTypeT>(value));
    return *this;
  }
  ///@}
  ...
  AuthConfiguration& AddOAuth2Properties(OAuth2PropertiesKeyT&& key, OAuth2PropertiesValueT&& value) {
    m_oAuth2PropertiesHasBeenSet = true;
    m_oAuth2Properties.emplace(std::forward<OAuth2PropertiesKeyT>(key), std::forward<OAuth2PropertiesValueT>(value));
    return *this;
  }
  ///@}
  ...
  AuthConfiguration& AddBasicAuthenticationProperties(BasicAuthenticationPropertiesKeyT&& key,
                                                      BasicAuthenticationPropertiesValueT&& value) {
    m_basicAuthenticationPropertiesHasBeenSet = true;
    m_basicAuthenticationProperties.emplace(std::forward<BasicAuthenticationPropertiesKeyT>(key),
                                            std::forward<BasicAuthenticationPropertiesValueT>(value));
    return *this;
  }
  ///@}
  ...
  AuthConfiguration& AddCustomAuthenticationProperties(CustomAuthenticationPropertiesKeyT&& key,
                                                       CustomAuthenticationPropertiesValueT&& value) {
    m_customAuthenticationPropertiesHasBeenSet = true;
    m_customAuthenticationProperties.emplace(std::forward<CustomAuthenticationPropertiesKeyT>(key),
                                             std::forward<CustomAuthenticationPropertiesValueT>(value));
    return *this;
  }
  ///@}
 private:
