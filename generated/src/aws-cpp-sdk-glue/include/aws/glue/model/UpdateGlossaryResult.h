...
class UpdateGlossaryResult {
 public:
  AWS_GLUE_API UpdateGlossaryResult() = default;
  AWS_GLUE_API UpdateGlossaryResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_GLUE_API UpdateGlossaryResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
