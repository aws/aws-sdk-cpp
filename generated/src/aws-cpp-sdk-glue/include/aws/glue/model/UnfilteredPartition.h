...
class UnfilteredPartition {
 public:
  ...
  template <typename PartitionT = Partition>
  UnfilteredPartition& WithPartition(PartitionT&& value) {
  ...
  template <typename AuthorizedColumnsT = Aws::Vector<Aws::String>>
  UnfilteredPartition& WithAuthorizedColumns(AuthorizedColumnsT&& value) {
    SetAuthorizedColumns(std::forward<AuthorizedColumnsT>(value));
    return *this;
  }
  template <typename AuthorizedColumnsT = Aws::String>
  UnfilteredPartition& AddAuthorizedColumns(AuthorizedColumnsT&& value) {
    m_authorizedColumnsHasBeenSet = true;
  ...
  inline UnfilteredPartition& WithIsRegisteredWithLakeFormation(bool value) {
