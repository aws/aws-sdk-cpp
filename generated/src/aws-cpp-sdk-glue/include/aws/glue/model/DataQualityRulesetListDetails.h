...
class DataQualityRulesetListDetails {
 public:
  ...
  template <typename NameT = Aws::String>
  DataQualityRulesetListDetails& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DataQualityRulesetListDetails& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedOnT = Aws::Utils::DateTime>
  DataQualityRulesetListDetails& WithCreatedOn(CreatedOnT&& value) {
  ...
  template <typename LastModifiedOnT = Aws::Utils::DateTime>
  DataQualityRulesetListDetails& WithLastModifiedOn(LastModifiedOnT&& value) {
  ...
  template <typename TargetTableT = DataQualityTargetTable>
  DataQualityRulesetListDetails& WithTargetTable(TargetTableT&& value) {
  ...
  template <typename RecommendationRunIdT = Aws::String>
  DataQualityRulesetListDetails& WithRecommendationRunId(RecommendationRunIdT&& value) {
  ...
  inline DataQualityRulesetListDetails& WithRuleCount(int value) {
    SetRuleCount(value);
    return *this;
  }
  ///@}
