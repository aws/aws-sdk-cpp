...
namespace Model
{
  ...
  public:
    ...
    template<typename PolicyHashConditionT = Aws::String>
    DeleteResourcePolicyRequest& WithPolicyHashCondition(PolicyHashConditionT&& value) { SetPolicyHashCondition(std::forward<PolicyHashConditionT>(value)); return *this;}
    ///@}
