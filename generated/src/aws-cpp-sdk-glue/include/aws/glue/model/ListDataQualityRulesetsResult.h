...
class ListDataQualityRulesetsResult {
 public:
  ...
  template <typename RulesetsT = Aws::Vector<DataQualityRulesetListDetails>>
  ListDataQualityRulesetsResult& WithRulesets(RulesetsT&& value) {
    SetRulesets(std::forward<RulesetsT>(value));
    return *this;
  }
  template <typename RulesetsT = DataQualityRulesetListDetails>
  ListDataQualityRulesetsResult& AddRulesets(RulesetsT&& value) {
    m_rulesetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityRulesetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityRulesetsResult& WithRequestId(RequestIdT&& value) {
