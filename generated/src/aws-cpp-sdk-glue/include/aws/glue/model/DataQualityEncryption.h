...
class DataQualityEncryption {
 public:
  ...
  inline void SetDataQualityEncryptionMode(DataQualityEncryptionMode value) {
    m_dataQualityEncryptionModeHasBeenSet = true;
    m_dataQualityEncryptionMode = value;
  }
  inline DataQualityEncryption& WithDataQualityEncryptionMode(DataQualityEncryptionMode value) {
    SetDataQualityEncryptionMode(value);
    return *this;
  }
  ///@}
