...
class StartColumnStatisticsTaskRunRequest : public GlueRequest {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  StartColumnStatisticsTaskRunRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  StartColumnStatisticsTaskRunRequest& WithTableName(TableNameT&& value) {
  ...
  template <typename ColumnNameListT = Aws::Vector<Aws::String>>
  StartColumnStatisticsTaskRunRequest& WithColumnNameList(ColumnNameListT&& value) {
    SetColumnNameList(std::forward<ColumnNameListT>(value));
    return *this;
  }
  template <typename ColumnNameListT = Aws::String>
  StartColumnStatisticsTaskRunRequest& AddColumnNameList(ColumnNameListT&& value) {
    m_columnNameListHasBeenSet = true;
  ...
  template <typename RoleT = Aws::String>
  StartColumnStatisticsTaskRunRequest& WithRole(RoleT&& value) {
  ...
  inline StartColumnStatisticsTaskRunRequest& WithSampleSize(double value) {
    SetSampleSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename CatalogIDT = Aws::String>
  StartColumnStatisticsTaskRunRequest& WithCatalogID(CatalogIDT&& value) {
  ...
  template <typename SecurityConfigurationT = Aws::String>
  StartColumnStatisticsTaskRunRequest& WithSecurityConfiguration(SecurityConfigurationT&& value) {
