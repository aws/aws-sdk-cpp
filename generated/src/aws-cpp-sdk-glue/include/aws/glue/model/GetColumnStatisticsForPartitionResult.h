...
namespace Model
{
  ...
  public:
    ...
    template<typename ColumnStatisticsListT = Aws::Vector<ColumnStatistics>>
    GetColumnStatisticsForPartitionResult& WithColumnStatisticsList(ColumnStatisticsListT&& value) { SetColumnStatisticsList(std::forward<ColumnStatisticsListT>(value)); return *this;}
    template<typename ColumnStatisticsListT = ColumnStatistics>
    GetColumnStatisticsForPartitionResult& AddColumnStatisticsList(ColumnStatisticsListT&& value) { m_columnStatisticsListHasBeenSet = true; m_columnStatisticsList.emplace_back(std::forward<ColumnStatisticsListT>(value)); return *this; }
    ///@}
    ...
    template<typename ErrorsT = Aws::Vector<ColumnError>>
    GetColumnStatisticsForPartitionResult& WithErrors(ErrorsT&& value) { SetErrors(std::forward<ErrorsT>(value)); return *this;}
    template<typename ErrorsT = ColumnError>
    GetColumnStatisticsForPartitionResult& AddErrors(ErrorsT&& value) { m_errorsHasBeenSet = true; m_errors.emplace_back(std::forward<ErrorsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetColumnStatisticsForPartitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
