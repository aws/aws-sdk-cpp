...
class GetWorkflowRunPropertiesRequest : public GlueRequest {
 public:
  AWS_GLUE_API GetWorkflowRunPropertiesRequest() = default;
  ...
  template <typename NameT = Aws::String>
  GetWorkflowRunPropertiesRequest& WithName(NameT&& value) {
  ...
  template <typename RunIdT = Aws::String>
  GetWorkflowRunPropertiesRequest& WithRunId(RunIdT&& value) {
