...
namespace Glue
{
const size_t GlueEndpointRules::RulesBlobStrLen = 3716;
const size_t GlueEndpointRules::RulesBlobSize = 3717;
...
'l','u','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'h','t','t','p','s',':','/','/','g','l','u','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
'"','h','t','t','p','s',':','/','/','g','l','u','e','.','{','R','e','g','i','o','n','}','.','{','P',
