...
S3HudiCatalogTarget::S3HudiCatalogTarget(JsonView jsonValue) { *this = jsonValue; }

S3HudiCatalogTarget& S3HudiCatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue S3HudiCatalogTarget::Jsonize() const {
  JsonValue payload;
