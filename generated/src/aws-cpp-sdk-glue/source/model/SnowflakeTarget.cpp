...
SnowflakeTarget::SnowflakeTarget(JsonView jsonValue) { *this = jsonValue; }

SnowflakeTarget& SnowflakeTarget::operator=(JsonView jsonValue) {
...
JsonValue SnowflakeTarget::Jsonize() const {
  JsonValue payload;
