...
StorageDescriptor::StorageDescriptor(JsonView jsonValue) { *this = jsonValue; }
...
StorageDescriptor& StorageDescriptor::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AdditionalLocations")) {
    ...
    for (unsigned additionalLocationsIndex = 0; additionalLocationsIndex < additionalLocationsJsonList.GetLength();
         ++additionalLocationsIndex) {
