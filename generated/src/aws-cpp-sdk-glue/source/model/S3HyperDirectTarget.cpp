...
S3HyperDirectTarget::S3HyperDirectTarget(JsonView jsonValue) { *this = jsonValue; }

S3HyperDirectTarget& S3HyperDirectTarget::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("Compression")) {
    m_compression = HyperTargetCompressionTypeMapper::GetHyperTargetCompressionTypeForName(jsonValue.GetString("Compression"));
...
JsonValue S3HyperDirectTarget::Jsonize() const {
  JsonValue payload;
  ...
  if (m_compressionHasBeenSet) {
    payload.WithString("Compression", HyperTargetCompressionTypeMapper::GetNameForHyperTargetCompressionType(m_compression));
  }
