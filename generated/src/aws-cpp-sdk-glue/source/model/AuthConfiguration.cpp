...
AuthConfiguration::AuthConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AuthConfiguration& AuthConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("BasicAuthenticationProperties")) {
    Aws::Map<Aws::String, JsonView> basicAuthenticationPropertiesJsonMap =
        jsonValue.GetObject("BasicAuthenticationProperties").GetAllObjects();
  ...
  if (jsonValue.ValueExists("CustomAuthenticationProperties")) {
    Aws::Map<Aws::String, JsonView> customAuthenticationPropertiesJsonMap =
        jsonValue.GetObject("CustomAuthenticationProperties").GetAllObjects();
...
JsonValue AuthConfiguration::Jsonize() const {
  ...
  if (m_basicAuthenticationPropertiesHasBeenSet) {
    ...
    for (auto& basicAuthenticationPropertiesItem : m_basicAuthenticationProperties) {
      basicAuthenticationPropertiesJsonMap.WithObject(basicAuthenticationPropertiesItem.first,
                                                      basicAuthenticationPropertiesItem.second.Jsonize());
    }
  ...
  if (m_customAuthenticationPropertiesHasBeenSet) {
    ...
    for (auto& customAuthenticationPropertiesItem : m_customAuthenticationProperties) {
      customAuthenticationPropertiesJsonMap.WithObject(customAuthenticationPropertiesItem.first,
                                                       customAuthenticationPropertiesItem.second.Jsonize());
    }
