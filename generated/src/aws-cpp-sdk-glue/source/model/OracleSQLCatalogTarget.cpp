...
OracleSQLCatalogTarget::OracleSQLCatalogTarget(JsonView jsonValue) { *this = jsonValue; }

OracleSQLCatalogTarget& OracleSQLCatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue OracleSQLCatalogTarget::Jsonize() const {
  JsonValue payload;
