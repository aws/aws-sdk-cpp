...
Aws::Http::HeaderValueCollection DisassociateGlossaryTermsRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "AWSGlue.DisassociateGlossaryTerms"));
  return headers;
}
