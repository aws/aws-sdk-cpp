...
BatchPutDataQualityStatisticAnnotationResult& BatchPutDataQualityStatisticAnnotationResult::operator=(
  ...
  if (jsonValue.ValueExists("FailedInclusionAnnotations")) {
    ...
    for (unsigned failedInclusionAnnotationsIndex = 0; failedInclusionAnnotationsIndex < failedInclusionAnnotationsJsonList.GetLength();
         ++failedInclusionAnnotationsIndex) {
