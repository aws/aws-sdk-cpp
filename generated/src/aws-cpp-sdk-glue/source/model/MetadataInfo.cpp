...
MetadataInfo::MetadataInfo(JsonView jsonValue) { *this = jsonValue; }
...
MetadataInfo& MetadataInfo::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OtherMetadataValueList")) {
    ...
    for (unsigned otherMetadataValueListIndex = 0; otherMetadataValueListIndex < otherMetadataValueListJsonList.GetLength();
         ++otherMetadataValueListIndex) {
