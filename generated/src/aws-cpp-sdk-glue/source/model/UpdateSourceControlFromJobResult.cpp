...
UpdateSourceControlFromJobResult::UpdateSourceControlFromJobResult()
{
}

UpdateSourceControlFromJobResult::UpdateSourceControlFromJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
