...
DescribeConnectionTypeResult::DescribeConnectionTypeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeConnectionTypeResult& DescribeConnectionTypeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ComputeEnvironmentConfigurations")) {
    Aws::Map<Aws::String, JsonView> computeEnvironmentConfigurationsJsonMap =
        jsonValue.GetObject("ComputeEnvironmentConfigurations").GetAllObjects();
    for (auto& computeEnvironmentConfigurationsItem : computeEnvironmentConfigurationsJsonMap) {
      m_computeEnvironmentConfigurations[computeEnvironmentConfigurationsItem.first] =
          computeEnvironmentConfigurationsItem.second.AsObject();
    }
    m_computeEnvironmentConfigurationsHasBeenSet = true;
  }
  if (jsonValue.ValueExists("PhysicalConnectionRequirements")) {
    Aws::Map<Aws::String, JsonView> physicalConnectionRequirementsJsonMap =
        jsonValue.GetObject("PhysicalConnectionRequirements").GetAllObjects();
