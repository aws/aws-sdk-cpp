...
ClientCredentialsProperties::ClientCredentialsProperties(JsonView jsonValue) { *this = jsonValue; }

ClientCredentialsProperties& ClientCredentialsProperties::operator=(JsonView jsonValue) {
...
JsonValue ClientCredentialsProperties::Jsonize() const {
  JsonValue payload;
