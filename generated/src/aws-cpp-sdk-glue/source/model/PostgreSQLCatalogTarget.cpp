...
PostgreSQLCatalogTarget::PostgreSQLCatalogTarget(JsonView jsonValue) { *this = jsonValue; }

PostgreSQLCatalogTarget& PostgreSQLCatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue PostgreSQLCatalogTarget::Jsonize() const {
  JsonValue payload;
