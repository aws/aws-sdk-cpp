...
Property::Property(JsonView jsonValue) { *this = jsonValue; }
...
Property& Property::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DataOperationScopes")) {
    ...
    for (unsigned dataOperationScopesIndex = 0; dataOperationScopesIndex < dataOperationScopesJsonList.GetLength();
         ++dataOperationScopesIndex) {
      m_dataOperationScopes.push_back(
          DataOperationMapper::GetDataOperationForName(dataOperationScopesJsonList[dataOperationScopesIndex].AsString()));
    }
...
JsonValue Property::Jsonize() const {
  ...
  if (m_dataOperationScopesHasBeenSet) {
    ...
    for (unsigned dataOperationScopesIndex = 0; dataOperationScopesIndex < dataOperationScopesJsonList.GetLength();
         ++dataOperationScopesIndex) {
      dataOperationScopesJsonList[dataOperationScopesIndex].AsString(
