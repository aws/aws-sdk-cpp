...
MySQLCatalogTarget::MySQLCatalogTarget(JsonView jsonValue) { *this = jsonValue; }

MySQLCatalogTarget& MySQLCatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue MySQLCatalogTarget::Jsonize() const {
  JsonValue payload;
