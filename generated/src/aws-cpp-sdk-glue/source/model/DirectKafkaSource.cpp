...
DirectKafkaSource::DirectKafkaSource(JsonView jsonValue) { *this = jsonValue; }

DirectKafkaSource& DirectKafkaSource::operator=(JsonView jsonValue) {
...
JsonValue DirectKafkaSource::Jsonize() const {
  JsonValue payload;
