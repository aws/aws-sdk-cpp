...
GetColumnStatisticsTaskRunResult::GetColumnStatisticsTaskRunResult()
{
}

GetColumnStatisticsTaskRunResult::GetColumnStatisticsTaskRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
