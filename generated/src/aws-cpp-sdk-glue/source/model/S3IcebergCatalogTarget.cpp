...
S3IcebergCatalogTarget::S3IcebergCatalogTarget(JsonView jsonValue) { *this = jsonValue; }

S3IcebergCatalogTarget& S3IcebergCatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue S3IcebergCatalogTarget::Jsonize() const {
  JsonValue payload;
