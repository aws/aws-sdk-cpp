...
PutAssetTypeResult::PutAssetTypeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

PutAssetTypeResult& PutAssetTypeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
