...
S3CatalogTarget::S3CatalogTarget(JsonView jsonValue) { *this = jsonValue; }

S3CatalogTarget& S3CatalogTarget::operator=(JsonView jsonValue) {
...
JsonValue S3CatalogTarget::Jsonize() const {
  JsonValue payload;
