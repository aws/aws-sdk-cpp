...
S3CatalogIcebergSource::S3CatalogIcebergSource(JsonView jsonValue)
{
  *this = jsonValue;
}

S3CatalogIcebergSource& S3CatalogIcebergSource::operator =(JsonView jsonValue)
{
...
JsonValue S3CatalogIcebergSource::Jsonize() const
{
  JsonValue payload;
