...
GetResourcePoliciesResult& GetResourcePoliciesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("GetResourcePoliciesResponseList")) {
    ...
    for (unsigned getResourcePoliciesResponseListIndex = 0;
         getResourcePoliciesResponseListIndex < getResourcePoliciesResponseListJsonList.GetLength();
         ++getResourcePoliciesResponseListIndex) {
