...
ListUsageProfilesResult::ListUsageProfilesResult()
{
}

ListUsageProfilesResult::ListUsageProfilesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListUsageProfilesResult& ListUsageProfilesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
