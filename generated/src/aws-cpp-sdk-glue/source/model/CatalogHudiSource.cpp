...
CatalogHudiSource::CatalogHudiSource(JsonView jsonValue) { *this = jsonValue; }

CatalogHudiSource& CatalogHudiSource::operator=(JsonView jsonValue) {
...
JsonValue CatalogHudiSource::Jsonize() const {
  JsonValue payload;
