...
namespace Glue {
template <>
AWS_GLUE_API FederatedResourceAlreadyExistsException GlueError::GetModeledError() {
...
static const int SESSION_BUSY_HASH = HashingUtils::HashString("SessionBusyException");
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  } else if (hashCode == SESSION_BUSY_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(GlueErrors::SESSION_BUSY), RetryableType::NOT_RETRYABLE);
