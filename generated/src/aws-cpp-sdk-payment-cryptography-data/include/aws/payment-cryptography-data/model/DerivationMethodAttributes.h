...
class DerivationMethodAttributes {
 public:
  ...
  void SetEmvCommon(EmvCommonT&& value) {
    ...
    m_emvCommon = std::forward<EmvCommonT>(value);
  }
  template <typename EmvCommonT = EmvCommonAttributes>
  DerivationMethodAttributes& WithEmvCommon(EmvCommonT&& value) {
    SetEmvCommon(std::forward<EmvCommonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmex(AmexT&& value) {
    ...
    m_amex = std::forward<AmexT>(value);
  }
  template <typename AmexT = AmexAttributes>
  DerivationMethodAttributes& WithAmex(AmexT&& value) {
    SetAmex(std::forward<AmexT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisa(VisaT&& value) {
    ...
    m_visa = std::forward<VisaT>(value);
  }
  template <typename VisaT = VisaAttributes>
  DerivationMethodAttributes& WithVisa(VisaT&& value) {
    SetVisa(std::forward<VisaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmv2000(Emv2000T&& value) {
    ...
    m_emv2000 = std::forward<Emv2000T>(value);
  }
  template <typename Emv2000T = Emv2000Attributes>
  DerivationMethodAttributes& WithEmv2000(Emv2000T&& value) {
    SetEmv2000(std::forward<Emv2000T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMastercard(MastercardT&& value) {
    ...
    m_mastercard = std::forward<MastercardT>(value);
  }
  template <typename MastercardT = MasterCardAttributes>
  DerivationMethodAttributes& WithMastercard(MastercardT&& value) {
    SetMastercard(std::forward<MastercardT>(value));
    return *this;
  }
  ///@}
 private:
