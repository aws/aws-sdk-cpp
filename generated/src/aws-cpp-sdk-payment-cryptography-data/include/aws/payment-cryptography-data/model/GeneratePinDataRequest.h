...
class GeneratePinDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  void SetGenerationKeyIdentifier(GenerationKeyIdentifierT&& value) {
    m_generationKeyIdentifierHasBeenSet = true;
    m_generationKeyIdentifier = std::forward<GenerationKeyIdentifierT>(value);
  }
  template <typename GenerationKeyIdentifierT = Aws::String>
  GeneratePinDataRequest& WithGenerationKeyIdentifier(GenerationKeyIdentifierT&& value) {
    SetGenerationKeyIdentifier(std::forward<GenerationKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncryptionKeyIdentifier(EncryptionKeyIdentifierT&& value) {
    m_encryptionKeyIdentifierHasBeenSet = true;
    m_encryptionKeyIdentifier = std::forward<EncryptionKeyIdentifierT>(value);
  }
  template <typename EncryptionKeyIdentifierT = Aws::String>
  GeneratePinDataRequest& WithEncryptionKeyIdentifier(EncryptionKeyIdentifierT&& value) {
    SetEncryptionKeyIdentifier(std::forward<EncryptionKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGenerationAttributes(GenerationAttributesT&& value) {
    m_generationAttributesHasBeenSet = true;
    m_generationAttributes = std::forward<GenerationAttributesT>(value);
  }
  template <typename GenerationAttributesT = PinGenerationAttributes>
  GeneratePinDataRequest& WithGenerationAttributes(GenerationAttributesT&& value) {
    SetGenerationAttributes(std::forward<GenerationAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPinDataLength(int value) {
    m_pinDataLengthHasBeenSet = true;
    m_pinDataLength = value;
  }
  inline GeneratePinDataRequest& WithPinDataLength(int value) {
    SetPinDataLength(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPinBlockFormat(PinBlockFormatForPinData value) {
    m_pinBlockFormatHasBeenSet = true;
    m_pinBlockFormat = value;
  }
  inline GeneratePinDataRequest& WithPinBlockFormat(PinBlockFormatForPinData value) {
  ...
  void SetEncryptionWrappedKey(EncryptionWrappedKeyT&& value) {
    m_encryptionWrappedKeyHasBeenSet = true;
    m_encryptionWrappedKey = std::forward<EncryptionWrappedKeyT>(value);
  }
  template <typename EncryptionWrappedKeyT = WrappedKey>
  GeneratePinDataRequest& WithEncryptionWrappedKey(EncryptionWrappedKeyT&& value) {
    SetEncryptionWrappedKey(std::forward<EncryptionWrappedKeyT>(value));
    return *this;
  }
  ///@}
 private:
