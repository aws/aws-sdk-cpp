...
class Emv2000Attributes {
 public:
  ...
  inline Emv2000Attributes& WithMajorKeyDerivationMode(MajorKeyDerivationMode value) {
  ...
  template <typename PrimaryAccountNumberT = Aws::String>
  Emv2000Attributes& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) {
  ...
  template <typename PanSequenceNumberT = Aws::String>
  Emv2000Attributes& WithPanSequenceNumber(PanSequenceNumberT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  Emv2000Attributes& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
