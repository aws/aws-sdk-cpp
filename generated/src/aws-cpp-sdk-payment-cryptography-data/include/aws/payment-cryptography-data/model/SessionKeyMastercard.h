...
class SessionKeyMastercard {
 public:
  ...
  template <typename PrimaryAccountNumberT = Aws::String>
  SessionKeyMastercard& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) {
  ...
  template <typename PanSequenceNumberT = Aws::String>
  SessionKeyMastercard& WithPanSequenceNumber(PanSequenceNumberT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  SessionKeyMastercard& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
  ...
  template <typename UnpredictableNumberT = Aws::String>
  SessionKeyMastercard& WithUnpredictableNumber(UnpredictableNumberT&& value) {
