...
class EmvCommonAttributes {
 public:
  ...
  inline EmvCommonAttributes& WithMajorKeyDerivationMode(MajorKeyDerivationMode value) {
  ...
  void SetApplicationCryptogram(ApplicationCryptogramT&& value) {
    ...
    m_applicationCryptogram = std::forward<ApplicationCryptogramT>(value);
  }
  template <typename ApplicationCryptogramT = Aws::String>
  EmvCommonAttributes& WithApplicationCryptogram(ApplicationCryptogramT&& value) {
    SetApplicationCryptogram(std::forward<ApplicationCryptogramT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMode(EmvEncryptionMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline EmvCommonAttributes& WithMode(EmvEncryptionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPinBlockPaddingType(PinBlockPaddingType value) {
    m_pinBlockPaddingTypeHasBeenSet = true;
    m_pinBlockPaddingType = value;
  }
  inline EmvCommonAttributes& WithPinBlockPaddingType(PinBlockPaddingType value) {
    SetPinBlockPaddingType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPinBlockLengthPosition(PinBlockLengthPosition value) {
    m_pinBlockLengthPositionHasBeenSet = true;
    m_pinBlockLengthPosition = value;
  }
  inline EmvCommonAttributes& WithPinBlockLengthPosition(PinBlockLengthPosition value) {
    SetPinBlockLengthPosition(value);
    return *this;
  }
  ///@}
 private:
