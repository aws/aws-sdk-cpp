...
class TranslatePinDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  void SetIncomingTranslationAttributes(IncomingTranslationAttributesT&& value) {
    m_incomingTranslationAttributesHasBeenSet = true;
    m_incomingTranslationAttributes = std::forward<IncomingTranslationAttributesT>(value);
  }
  template <typename IncomingTranslationAttributesT = TranslationIsoFormats>
  TranslatePinDataRequest& WithIncomingTranslationAttributes(IncomingTranslationAttributesT&& value) {
    SetIncomingTranslationAttributes(std::forward<IncomingTranslationAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutgoingTranslationAttributes(OutgoingTranslationAttributesT&& value) {
    m_outgoingTranslationAttributesHasBeenSet = true;
    m_outgoingTranslationAttributes = std::forward<OutgoingTranslationAttributesT>(value);
  }
  template <typename OutgoingTranslationAttributesT = TranslationIsoFormats>
  TranslatePinDataRequest& WithOutgoingTranslationAttributes(OutgoingTranslationAttributesT&& value) {
    SetOutgoingTranslationAttributes(std::forward<OutgoingTranslationAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncomingDukptAttributes(IncomingDukptAttributesT&& value) {
    m_incomingDukptAttributesHasBeenSet = true;
    m_incomingDukptAttributes = std::forward<IncomingDukptAttributesT>(value);
  }
  template <typename IncomingDukptAttributesT = DukptDerivationAttributes>
  TranslatePinDataRequest& WithIncomingDukptAttributes(IncomingDukptAttributesT&& value) {
    SetIncomingDukptAttributes(std::forward<IncomingDukptAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutgoingDukptAttributes(OutgoingDukptAttributesT&& value) {
    m_outgoingDukptAttributesHasBeenSet = true;
    m_outgoingDukptAttributes = std::forward<OutgoingDukptAttributesT>(value);
  }
  template <typename OutgoingDukptAttributesT = DukptDerivationAttributes>
  TranslatePinDataRequest& WithOutgoingDukptAttributes(OutgoingDukptAttributesT&& value) {
    SetOutgoingDukptAttributes(std::forward<OutgoingDukptAttributesT>(value));
    return *this;
  }
  ///@}
