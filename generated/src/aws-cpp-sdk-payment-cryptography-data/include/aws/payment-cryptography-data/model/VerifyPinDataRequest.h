...
class VerifyPinDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  void SetVerificationKeyIdentifier(VerificationKeyIdentifierT&& value) {
    m_verificationKeyIdentifierHasBeenSet = true;
    m_verificationKeyIdentifier = std::forward<VerificationKeyIdentifierT>(value);
  }
  template <typename VerificationKeyIdentifierT = Aws::String>
  VerifyPinDataRequest& WithVerificationKeyIdentifier(VerificationKeyIdentifierT&& value) {
    SetVerificationKeyIdentifier(std::forward<VerificationKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline VerifyPinDataRequest& WithPinBlockFormat(PinBlockFormatForPinData value) {
  ...
  inline VerifyPinDataRequest& WithPinDataLength(int value) {
  ...
  void SetDukptAttributes(DukptAttributesT&& value) {
    m_dukptAttributesHasBeenSet = true;
    m_dukptAttributes = std::forward<DukptAttributesT>(value);
  }
  template <typename DukptAttributesT = DukptAttributes>
  VerifyPinDataRequest& WithDukptAttributes(DukptAttributesT&& value) {
    SetDukptAttributes(std::forward<DukptAttributesT>(value));
    return *this;
  }
  ///@}
