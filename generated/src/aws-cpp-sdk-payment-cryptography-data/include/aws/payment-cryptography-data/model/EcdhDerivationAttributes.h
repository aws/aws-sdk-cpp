...
class EcdhDerivationAttributes {
 public:
  ...
  inline void SetKeyAlgorithm(SymmetricKeyAlgorithm value) {
    m_keyAlgorithmHasBeenSet = true;
    m_keyAlgorithm = value;
  }
  inline EcdhDerivationAttributes& WithKeyAlgorithm(SymmetricKeyAlgorithm value) {
  ...
  inline EcdhDerivationAttributes& WithKeyDerivationFunction(KeyDerivationFunction value) {
  ...
  inline EcdhDerivationAttributes& WithKeyDerivationHashAlgorithm(KeyDerivationHashAlgorithm value) {
