...
namespace Model
{
  ...
  public:
    ...
    template<typename DiffieHellmanTr31KeyBlockT = IncomingDiffieHellmanTr31KeyBlock>
    IncomingKeyMaterial& WithDiffieHellmanTr31KeyBlock(DiffieHellmanTr31KeyBlockT&& value) { SetDiffieHellmanTr31KeyBlock(std::forward<DiffieHellmanTr31KeyBlockT>(value)); return *this;}
    ///@}
  private:
