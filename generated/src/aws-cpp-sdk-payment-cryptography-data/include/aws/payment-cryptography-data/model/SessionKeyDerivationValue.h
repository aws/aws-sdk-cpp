...
class SessionKeyDerivationValue {
 public:
  ...
  template <typename ApplicationCryptogramT = Aws::String>
  SessionKeyDerivationValue& WithApplicationCryptogram(ApplicationCryptogramT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  SessionKeyDerivationValue& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
