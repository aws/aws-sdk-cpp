...
class GeneratePinDataResult {
 public:
  ...
  void SetGenerationKeyArn(GenerationKeyArnT&& value) {
    ...
    m_generationKeyArn = std::forward<GenerationKeyArnT>(value);
  }
  template <typename GenerationKeyArnT = Aws::String>
  GeneratePinDataResult& WithGenerationKeyArn(GenerationKeyArnT&& value) {
    SetGenerationKeyArn(std::forward<GenerationKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGenerationKeyCheckValue(GenerationKeyCheckValueT&& value) {
    ...
    m_generationKeyCheckValue = std::forward<GenerationKeyCheckValueT>(value);
  }
  template <typename GenerationKeyCheckValueT = Aws::String>
  GeneratePinDataResult& WithGenerationKeyCheckValue(GenerationKeyCheckValueT&& value) {
    SetGenerationKeyCheckValue(std::forward<GenerationKeyCheckValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncryptionKeyCheckValue(EncryptionKeyCheckValueT&& value) {
    ...
    m_encryptionKeyCheckValue = std::forward<EncryptionKeyCheckValueT>(value);
  }
  template <typename EncryptionKeyCheckValueT = Aws::String>
  GeneratePinDataResult& WithEncryptionKeyCheckValue(EncryptionKeyCheckValueT&& value) {
    SetEncryptionKeyCheckValue(std::forward<EncryptionKeyCheckValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPinData(PinDataT&& value) {
    ...
    m_pinData = std::forward<PinDataT>(value);
  }
  template <typename PinDataT = PinData>
  GeneratePinDataResult& WithPinData(PinDataT&& value) {
    SetPinData(std::forward<PinDataT>(value));
    return *this;
  }
  ///@}
