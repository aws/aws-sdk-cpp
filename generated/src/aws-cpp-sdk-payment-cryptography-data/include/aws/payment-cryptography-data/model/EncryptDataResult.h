...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyArnT = Aws::String>
    EncryptDataResult& WithKeyArn(KeyArnT&& value) { SetKeyArn(std::forward<KeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyCheckValueT = Aws::String>
    EncryptDataResult& WithKeyCheckValue(KeyCheckValueT&& value) { SetKeyCheckValue(std::forward<KeyCheckValueT>(value)); return *this;}
    ///@}
    ...
    template<typename CipherTextT = Aws::String>
    EncryptDataResult& WithCipherText(CipherTextT&& value) { SetCipherText(std::forward<CipherTextT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    EncryptDataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
