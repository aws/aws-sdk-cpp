...
class GenerateCardValidationDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  inline void SetValidationDataLength(int value) {
    m_validationDataLengthHasBeenSet = true;
    m_validationDataLength = value;
  }
  inline GenerateCardValidationDataRequest& WithValidationDataLength(int value) {
    SetValidationDataLength(value);
    return *this;
  }
  ///@}
 private:
