...
class VerificationFailedException {
 public:
  ...
  inline void SetReason(VerificationFailedReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline VerificationFailedException& WithReason(VerificationFailedReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  VerificationFailedException& WithMessage(MessageT&& value) {
