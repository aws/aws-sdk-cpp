...
namespace Model
{
  ...
  public:
    ...
    template<typename WrappedKeyMaterialT = Aws::String>
    WrappedWorkingKey& WithWrappedKeyMaterial(WrappedKeyMaterialT&& value) { SetWrappedKeyMaterial(std::forward<WrappedKeyMaterialT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyCheckValueT = Aws::String>
    WrappedWorkingKey& WithKeyCheckValue(KeyCheckValueT&& value) { SetKeyCheckValue(std::forward<KeyCheckValueT>(value)); return *this;}
    ///@}
    ...
    inline WrappedWorkingKey& WithWrappedKeyMaterialFormat(WrappedKeyMaterialFormat value) { SetWrappedKeyMaterialFormat(value); return *this;}
    ///@}
  private:
