...
class ReEncryptDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  void SetIncomingKeyIdentifier(IncomingKeyIdentifierT&& value) {
    m_incomingKeyIdentifierHasBeenSet = true;
    m_incomingKeyIdentifier = std::forward<IncomingKeyIdentifierT>(value);
  }
  template <typename IncomingKeyIdentifierT = Aws::String>
  ReEncryptDataRequest& WithIncomingKeyIdentifier(IncomingKeyIdentifierT&& value) {
    SetIncomingKeyIdentifier(std::forward<IncomingKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutgoingKeyIdentifier(OutgoingKeyIdentifierT&& value) {
    m_outgoingKeyIdentifierHasBeenSet = true;
    m_outgoingKeyIdentifier = std::forward<OutgoingKeyIdentifierT>(value);
  }
  template <typename OutgoingKeyIdentifierT = Aws::String>
  ReEncryptDataRequest& WithOutgoingKeyIdentifier(OutgoingKeyIdentifierT&& value) {
    SetOutgoingKeyIdentifier(std::forward<OutgoingKeyIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCipherText(CipherTextT&& value) {
    ...
    m_cipherText = std::forward<CipherTextT>(value);
  }
  template <typename CipherTextT = Aws::String>
  ReEncryptDataRequest& WithCipherText(CipherTextT&& value) {
    SetCipherText(std::forward<CipherTextT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncomingEncryptionAttributes(IncomingEncryptionAttributesT&& value) {
    m_incomingEncryptionAttributesHasBeenSet = true;
    m_incomingEncryptionAttributes = std::forward<IncomingEncryptionAttributesT>(value);
  }
  template <typename IncomingEncryptionAttributesT = ReEncryptionAttributes>
  ReEncryptDataRequest& WithIncomingEncryptionAttributes(IncomingEncryptionAttributesT&& value) {
    SetIncomingEncryptionAttributes(std::forward<IncomingEncryptionAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutgoingEncryptionAttributes(OutgoingEncryptionAttributesT&& value) {
    m_outgoingEncryptionAttributesHasBeenSet = true;
    m_outgoingEncryptionAttributes = std::forward<OutgoingEncryptionAttributesT>(value);
  }
  template <typename OutgoingEncryptionAttributesT = ReEncryptionAttributes>
  ReEncryptDataRequest& WithOutgoingEncryptionAttributes(OutgoingEncryptionAttributesT&& value) {
    SetOutgoingEncryptionAttributes(std::forward<OutgoingEncryptionAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncomingWrappedKey(IncomingWrappedKeyT&& value) {
    m_incomingWrappedKeyHasBeenSet = true;
    m_incomingWrappedKey = std::forward<IncomingWrappedKeyT>(value);
  }
  template <typename IncomingWrappedKeyT = WrappedKey>
  ReEncryptDataRequest& WithIncomingWrappedKey(IncomingWrappedKeyT&& value) {
    SetIncomingWrappedKey(std::forward<IncomingWrappedKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutgoingWrappedKey(OutgoingWrappedKeyT&& value) {
    m_outgoingWrappedKeyHasBeenSet = true;
    m_outgoingWrappedKey = std::forward<OutgoingWrappedKeyT>(value);
  }
  template <typename OutgoingWrappedKeyT = WrappedKey>
  ReEncryptDataRequest& WithOutgoingWrappedKey(OutgoingWrappedKeyT&& value) {
    SetOutgoingWrappedKey(std::forward<OutgoingWrappedKeyT>(value));
    return *this;
  }
  ///@}
 private:
