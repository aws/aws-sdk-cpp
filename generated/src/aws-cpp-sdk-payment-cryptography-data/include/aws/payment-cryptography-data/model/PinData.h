...
class PinData {
 public:
  ...
  void SetPinOffset(PinOffsetT&& value) {
    ...
    m_pinOffset = std::forward<PinOffsetT>(value);
  }
  template <typename PinOffsetT = Aws::String>
  PinData& WithPinOffset(PinOffsetT&& value) {
    SetPinOffset(std::forward<PinOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerificationValue(VerificationValueT&& value) {
    m_verificationValueHasBeenSet = true;
    m_verificationValue = std::forward<VerificationValueT>(value);
  }
  template <typename VerificationValueT = Aws::String>
  PinData& WithVerificationValue(VerificationValueT&& value) {
    SetVerificationValue(std::forward<VerificationValueT>(value));
    return *this;
  }
  ///@}
 private:
