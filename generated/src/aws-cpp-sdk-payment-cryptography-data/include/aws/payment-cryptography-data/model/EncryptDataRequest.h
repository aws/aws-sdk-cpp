...
class EncryptDataRequest : public PaymentCryptographyDataRequest {
 public:
  ...
  void SetEncryptionAttributes(EncryptionAttributesT&& value) {
    m_encryptionAttributesHasBeenSet = true;
    m_encryptionAttributes = std::forward<EncryptionAttributesT>(value);
  }
  template <typename EncryptionAttributesT = EncryptionDecryptionAttributes>
  EncryptDataRequest& WithEncryptionAttributes(EncryptionAttributesT&& value) {
    SetEncryptionAttributes(std::forward<EncryptionAttributesT>(value));
    return *this;
  }
  ///@}
