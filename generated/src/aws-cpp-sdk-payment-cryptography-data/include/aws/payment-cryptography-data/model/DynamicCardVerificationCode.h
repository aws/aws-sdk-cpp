...
class DynamicCardVerificationCode {
 public:
  ...
  template <typename UnpredictableNumberT = Aws::String>
  DynamicCardVerificationCode& WithUnpredictableNumber(UnpredictableNumberT&& value) {
  ...
  template <typename PanSequenceNumberT = Aws::String>
  DynamicCardVerificationCode& WithPanSequenceNumber(PanSequenceNumberT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  DynamicCardVerificationCode& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
  ...
  void SetTrackData(TrackDataT&& value) {
    m_trackDataHasBeenSet = true;
    m_trackData = std::forward<TrackDataT>(value);
  }
  template <typename TrackDataT = Aws::String>
  DynamicCardVerificationCode& WithTrackData(TrackDataT&& value) {
    SetTrackData(std::forward<TrackDataT>(value));
    return *this;
  }
  ///@}
 private:
