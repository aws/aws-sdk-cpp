...
class EncryptionDecryptionAttributes {
 public:
  ...
  void SetSymmetric(SymmetricT&& value) {
    ...
    m_symmetric = std::forward<SymmetricT>(value);
  }
  template <typename SymmetricT = SymmetricEncryptionAttributes>
  EncryptionDecryptionAttributes& WithSymmetric(SymmetricT&& value) {
    SetSymmetric(std::forward<SymmetricT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDukpt(DukptT&& value) {
    ...
    m_dukpt = std::forward<DukptT>(value);
  }
  template <typename DukptT = DukptEncryptionAttributes>
  EncryptionDecryptionAttributes& WithDukpt(DukptT&& value) {
    SetDukpt(std::forward<DukptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmv(EmvT&& value) {
    ...
    m_emv = std::forward<EmvT>(value);
  }
  template <typename EmvT = EmvEncryptionAttributes>
  EncryptionDecryptionAttributes& WithEmv(EmvT&& value) {
    SetEmv(std::forward<EmvT>(value));
    return *this;
  }
  ///@}
 private:
