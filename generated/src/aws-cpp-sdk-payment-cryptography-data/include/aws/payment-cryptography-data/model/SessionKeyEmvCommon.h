...
namespace Model
{
  ...
  {
  public:
    AWS_PAYMENTCRYPTOGRAPHYDATA_API SessionKeyEmvCommon() = default;
    ...
    template<typename PrimaryAccountNumberT = Aws::String>
    SessionKeyEmvCommon& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) { SetPrimaryAccountNumber(std::forward<PrimaryAccountNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename PanSequenceNumberT = Aws::String>
    SessionKeyEmvCommon& WithPanSequenceNumber(PanSequenceNumberT&& value) { SetPanSequenceNumber(std::forward<PanSequenceNumberT>(value)); return *this;}
    ///@}
    ...
    template<typename ApplicationTransactionCounterT = Aws::String>
    SessionKeyEmvCommon& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) { SetApplicationTransactionCounter(std::forward<ApplicationTransactionCounterT>(value)); return *this;}
    ///@}
  private:
