...
class SessionKeyEmvCommon {
 public:
  ...
  template <typename PrimaryAccountNumberT = Aws::String>
  SessionKeyEmvCommon& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) {
  ...
  template <typename PanSequenceNumberT = Aws::String>
  SessionKeyEmvCommon& WithPanSequenceNumber(PanSequenceNumberT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  SessionKeyEmvCommon& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
