...
class TranslationIsoFormats {
 public:
  ...
  void SetIsoFormat0(IsoFormat0T&& value) {
    m_isoFormat0HasBeenSet = true;
    m_isoFormat0 = std::forward<IsoFormat0T>(value);
  }
  template <typename IsoFormat0T = TranslationPinDataIsoFormat034>
  TranslationIsoFormats& WithIsoFormat0(IsoFormat0T&& value) {
    SetIsoFormat0(std::forward<IsoFormat0T>(value));
    return *this;
  }
  ///@}
  ...
  void SetIsoFormat1(IsoFormat1T&& value) {
    m_isoFormat1HasBeenSet = true;
    m_isoFormat1 = std::forward<IsoFormat1T>(value);
  }
  template <typename IsoFormat1T = TranslationPinDataIsoFormat1>
  TranslationIsoFormats& WithIsoFormat1(IsoFormat1T&& value) {
    SetIsoFormat1(std::forward<IsoFormat1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetIsoFormat3(IsoFormat3T&& value) {
    m_isoFormat3HasBeenSet = true;
    m_isoFormat3 = std::forward<IsoFormat3T>(value);
  }
  template <typename IsoFormat3T = TranslationPinDataIsoFormat034>
  TranslationIsoFormats& WithIsoFormat3(IsoFormat3T&& value) {
    SetIsoFormat3(std::forward<IsoFormat3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetIsoFormat4(IsoFormat4T&& value) {
    m_isoFormat4HasBeenSet = true;
    m_isoFormat4 = std::forward<IsoFormat4T>(value);
  }
  template <typename IsoFormat4T = TranslationPinDataIsoFormat034>
  TranslationIsoFormats& WithIsoFormat4(IsoFormat4T&& value) {
    SetIsoFormat4(std::forward<IsoFormat4T>(value));
    return *this;
  }
  ///@}
 private:
