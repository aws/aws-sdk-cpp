...
class SessionKeyEmv2000 {
 public:
  ...
  template <typename PrimaryAccountNumberT = Aws::String>
  SessionKeyEmv2000& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) {
  ...
  template <typename PanSequenceNumberT = Aws::String>
  SessionKeyEmv2000& WithPanSequenceNumber(PanSequenceNumberT&& value) {
  ...
  template <typename ApplicationTransactionCounterT = Aws::String>
  SessionKeyEmv2000& WithApplicationTransactionCounter(ApplicationTransactionCounterT&& value) {
