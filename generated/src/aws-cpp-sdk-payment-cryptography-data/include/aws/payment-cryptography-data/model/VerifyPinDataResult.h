...
class VerifyPinDataResult {
 public:
  ...
  void SetVerificationKeyArn(VerificationKeyArnT&& value) {
    ...
    m_verificationKeyArn = std::forward<VerificationKeyArnT>(value);
  }
  template <typename VerificationKeyArnT = Aws::String>
  VerifyPinDataResult& WithVerificationKeyArn(VerificationKeyArnT&& value) {
    SetVerificationKeyArn(std::forward<VerificationKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerificationKeyCheckValue(VerificationKeyCheckValueT&& value) {
    ...
    m_verificationKeyCheckValue = std::forward<VerificationKeyCheckValueT>(value);
  }
  template <typename VerificationKeyCheckValueT = Aws::String>
  VerifyPinDataResult& WithVerificationKeyCheckValue(VerificationKeyCheckValueT&& value) {
    SetVerificationKeyCheckValue(std::forward<VerificationKeyCheckValueT>(value));
    return *this;
  }
  ///@}
