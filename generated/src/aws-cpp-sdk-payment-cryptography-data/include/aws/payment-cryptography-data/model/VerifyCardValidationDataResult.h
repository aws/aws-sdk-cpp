...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyArnT = Aws::String>
    VerifyCardValidationDataResult& WithKeyArn(KeyArnT&& value) { SetKeyArn(std::forward<KeyArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyCheckValueT = Aws::String>
    VerifyCardValidationDataResult& WithKeyCheckValue(KeyCheckValueT&& value) { SetKeyCheckValue(std::forward<KeyCheckValueT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    VerifyCardValidationDataResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
