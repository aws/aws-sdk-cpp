...
class CardVerificationAttributes {
 public:
  ...
  void SetAmexCardSecurityCodeVersion1(AmexCardSecurityCodeVersion1T&& value) {
    ...
    m_amexCardSecurityCodeVersion1 = std::forward<AmexCardSecurityCodeVersion1T>(value);
  }
  template <typename AmexCardSecurityCodeVersion1T = AmexCardSecurityCodeVersion1>
  CardVerificationAttributes& WithAmexCardSecurityCodeVersion1(AmexCardSecurityCodeVersion1T&& value) {
    SetAmexCardSecurityCodeVersion1(std::forward<AmexCardSecurityCodeVersion1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetAmexCardSecurityCodeVersion2(AmexCardSecurityCodeVersion2T&& value) {
    ...
    m_amexCardSecurityCodeVersion2 = std::forward<AmexCardSecurityCodeVersion2T>(value);
  }
  template <typename AmexCardSecurityCodeVersion2T = AmexCardSecurityCodeVersion2>
  CardVerificationAttributes& WithAmexCardSecurityCodeVersion2(AmexCardSecurityCodeVersion2T&& value) {
    SetAmexCardSecurityCodeVersion2(std::forward<AmexCardSecurityCodeVersion2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCardVerificationValue1(CardVerificationValue1T&& value) {
    ...
    m_cardVerificationValue1 = std::forward<CardVerificationValue1T>(value);
  }
  template <typename CardVerificationValue1T = CardVerificationValue1>
  CardVerificationAttributes& WithCardVerificationValue1(CardVerificationValue1T&& value) {
    SetCardVerificationValue1(std::forward<CardVerificationValue1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCardVerificationValue2(CardVerificationValue2T&& value) {
    ...
    m_cardVerificationValue2 = std::forward<CardVerificationValue2T>(value);
  }
  template <typename CardVerificationValue2T = CardVerificationValue2>
  CardVerificationAttributes& WithCardVerificationValue2(CardVerificationValue2T&& value) {
    SetCardVerificationValue2(std::forward<CardVerificationValue2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetCardHolderVerificationValue(CardHolderVerificationValueT&& value) {
    ...
    m_cardHolderVerificationValue = std::forward<CardHolderVerificationValueT>(value);
  }
  template <typename CardHolderVerificationValueT = CardHolderVerificationValue>
  CardVerificationAttributes& WithCardHolderVerificationValue(CardHolderVerificationValueT&& value) {
    SetCardHolderVerificationValue(std::forward<CardHolderVerificationValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamicCardVerificationCode(DynamicCardVerificationCodeT&& value) {
    ...
    m_dynamicCardVerificationCode = std::forward<DynamicCardVerificationCodeT>(value);
  }
  template <typename DynamicCardVerificationCodeT = DynamicCardVerificationCode>
  CardVerificationAttributes& WithDynamicCardVerificationCode(DynamicCardVerificationCodeT&& value) {
    SetDynamicCardVerificationCode(std::forward<DynamicCardVerificationCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDynamicCardVerificationValue(DynamicCardVerificationValueT&& value) {
    ...
    m_dynamicCardVerificationValue = std::forward<DynamicCardVerificationValueT>(value);
  }
  template <typename DynamicCardVerificationValueT = DynamicCardVerificationValue>
  CardVerificationAttributes& WithDynamicCardVerificationValue(DynamicCardVerificationValueT&& value) {
    SetDynamicCardVerificationValue(std::forward<DynamicCardVerificationValueT>(value));
    return *this;
  }
  ///@}
   ...
   * Code (dCVC) for the payment card.</p>
   */
  inline const DiscoverDynamicCardVerificationCode& GetDiscoverDynamicCardVerificationCode() const {
    return m_discoverDynamicCardVerificationCode;
  }
  ...
  void SetDiscoverDynamicCardVerificationCode(DiscoverDynamicCardVerificationCodeT&& value) {
    ...
    m_discoverDynamicCardVerificationCode = std::forward<DiscoverDynamicCardVerificationCodeT>(value);
  }
  template <typename DiscoverDynamicCardVerificationCodeT = DiscoverDynamicCardVerificationCode>
  CardVerificationAttributes& WithDiscoverDynamicCardVerificationCode(DiscoverDynamicCardVerificationCodeT&& value) {
    SetDiscoverDynamicCardVerificationCode(std::forward<DiscoverDynamicCardVerificationCodeT>(value));
    return *this;
  }
  ///@}
 private:
