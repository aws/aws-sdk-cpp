...
/**
 * <p>Parameters that are required for translation between AS2805 PIN format 0
 * translation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/TranslationPinDataAs2805Format0">AWS
 * API Reference</a></p>
 */
class TranslationPinDataAs2805Format0 {
 public:
  AWS_PAYMENTCRYPTOGRAPHYDATA_API TranslationPinDataAs2805Format0() = default;
  AWS_PAYMENTCRYPTOGRAPHYDATA_API TranslationPinDataAs2805Format0(Aws::Utils::Json::JsonView jsonValue);
  AWS_PAYMENTCRYPTOGRAPHYDATA_API TranslationPinDataAs2805Format0& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename PrimaryAccountNumberT = Aws::String>
  TranslationPinDataAs2805Format0& WithPrimaryAccountNumber(PrimaryAccountNumberT&& value) {
