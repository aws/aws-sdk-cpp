...
class Ibm3624NaturalPin {
 public:
  ...
  template <typename DecimalizationTableT = Aws::String>
  Ibm3624NaturalPin& WithDecimalizationTable(DecimalizationTableT&& value) {
  ...
  template <typename PinValidationDataPadCharacterT = Aws::String>
  Ibm3624NaturalPin& WithPinValidationDataPadCharacter(PinValidationDataPadCharacterT&& value) {
  ...
  template <typename PinValidationDataT = Aws::String>
  Ibm3624NaturalPin& WithPinValidationData(PinValidationDataT&& value) {
