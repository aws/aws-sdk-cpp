...
class MacAlgorithmEmv {
 public:
  ...
  inline MacAlgorithmEmv& WithMajorKeyDerivationMode(MajorKeyDerivationMode value) {
  ...
  inline void SetSessionKeyDerivationMode(SessionKeyDerivationMode value) {
    m_sessionKeyDerivationModeHasBeenSet = true;
    m_sessionKeyDerivationMode = value;
  }
  inline MacAlgorithmEmv& WithSessionKeyDerivationMode(SessionKeyDerivationMode value) {
    SetSessionKeyDerivationMode(value);
    return *this;
  }
  ///@}
  ...
  void SetSessionKeyDerivationValue(SessionKeyDerivationValueT&& value) {
    ...
    m_sessionKeyDerivationValue = std::forward<SessionKeyDerivationValueT>(value);
  }
  template <typename SessionKeyDerivationValueT = SessionKeyDerivationValue>
  MacAlgorithmEmv& WithSessionKeyDerivationValue(SessionKeyDerivationValueT&& value) {
    SetSessionKeyDerivationValue(std::forward<SessionKeyDerivationValueT>(value));
    return *this;
  }
  ///@}
 private:
