 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/DiffieHellmanDerivationData">AWS
 * API Reference</a></p>
 */
class DiffieHellmanDerivationData {
 public:
  ...
  void SetSharedInformation(SharedInformationT&& value) {
    ...
    m_sharedInformation = std::forward<SharedInformationT>(value);
  }
  template <typename SharedInformationT = Aws::String>
  DiffieHellmanDerivationData& WithSharedInformation(SharedInformationT&& value) {
    SetSharedInformation(std::forward<SharedInformationT>(value));
    return *this;
  }
  ///@}
 private:
