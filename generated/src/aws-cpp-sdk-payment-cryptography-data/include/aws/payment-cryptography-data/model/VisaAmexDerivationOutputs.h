...
class VisaAmexDerivationOutputs {
 public:
  ...
  void SetAuthorizationRequestKeyArn(AuthorizationRequestKeyArnT&& value) {
    ...
    m_authorizationRequestKeyArn = std::forward<AuthorizationRequestKeyArnT>(value);
  }
  template <typename AuthorizationRequestKeyArnT = Aws::String>
  VisaAmexDerivationOutputs& WithAuthorizationRequestKeyArn(AuthorizationRequestKeyArnT&& value) {
    SetAuthorizationRequestKeyArn(std::forward<AuthorizationRequestKeyArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAuthorizationRequestKeyCheckValue(AuthorizationRequestKeyCheckValueT&& value) {
    ...
    m_authorizationRequestKeyCheckValue = std::forward<AuthorizationRequestKeyCheckValueT>(value);
  }
  template <typename AuthorizationRequestKeyCheckValueT = Aws::String>
  VisaAmexDerivationOutputs& WithAuthorizationRequestKeyCheckValue(AuthorizationRequestKeyCheckValueT&& value) {
    SetAuthorizationRequestKeyCheckValue(std::forward<AuthorizationRequestKeyCheckValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentPinPekArn(CurrentPinPekArnT&& value) {
    ...
    m_currentPinPekArn = std::forward<CurrentPinPekArnT>(value);
  }
  template <typename CurrentPinPekArnT = Aws::String>
  VisaAmexDerivationOutputs& WithCurrentPinPekArn(CurrentPinPekArnT&& value) {
    SetCurrentPinPekArn(std::forward<CurrentPinPekArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCurrentPinPekKeyCheckValue(CurrentPinPekKeyCheckValueT&& value) {
    ...
    m_currentPinPekKeyCheckValue = std::forward<CurrentPinPekKeyCheckValueT>(value);
  }
  template <typename CurrentPinPekKeyCheckValueT = Aws::String>
  VisaAmexDerivationOutputs& WithCurrentPinPekKeyCheckValue(CurrentPinPekKeyCheckValueT&& value) {
    SetCurrentPinPekKeyCheckValue(std::forward<CurrentPinPekKeyCheckValueT>(value));
    return *this;
  }
  ///@}
 private:
