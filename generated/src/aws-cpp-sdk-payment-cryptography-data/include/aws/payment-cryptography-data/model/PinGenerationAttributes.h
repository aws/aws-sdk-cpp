...
class PinGenerationAttributes {
 public:
  ...
  void SetVisaPin(VisaPinT&& value) {
    ...
    m_visaPin = std::forward<VisaPinT>(value);
  }
  template <typename VisaPinT = VisaPin>
  PinGenerationAttributes& WithVisaPin(VisaPinT&& value) {
    SetVisaPin(std::forward<VisaPinT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVisaPinVerificationValue(VisaPinVerificationValueT&& value) {
    ...
    m_visaPinVerificationValue = std::forward<VisaPinVerificationValueT>(value);
  }
  template <typename VisaPinVerificationValueT = VisaPinVerificationValue>
  PinGenerationAttributes& WithVisaPinVerificationValue(VisaPinVerificationValueT&& value) {
    SetVisaPinVerificationValue(std::forward<VisaPinVerificationValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIbm3624PinOffset(Ibm3624PinOffsetT&& value) {
    ...
    m_ibm3624PinOffset = std::forward<Ibm3624PinOffsetT>(value);
  }
  template <typename Ibm3624PinOffsetT = Ibm3624PinOffset>
  PinGenerationAttributes& WithIbm3624PinOffset(Ibm3624PinOffsetT&& value) {
    SetIbm3624PinOffset(std::forward<Ibm3624PinOffsetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIbm3624NaturalPin(Ibm3624NaturalPinT&& value) {
    ...
    m_ibm3624NaturalPin = std::forward<Ibm3624NaturalPinT>(value);
  }
  template <typename Ibm3624NaturalPinT = Ibm3624NaturalPin>
  PinGenerationAttributes& WithIbm3624NaturalPin(Ibm3624NaturalPinT&& value) {
    SetIbm3624NaturalPin(std::forward<Ibm3624NaturalPinT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIbm3624RandomPin(Ibm3624RandomPinT&& value) {
    ...
    m_ibm3624RandomPin = std::forward<Ibm3624RandomPinT>(value);
  }
  template <typename Ibm3624RandomPinT = Ibm3624RandomPin>
  PinGenerationAttributes& WithIbm3624RandomPin(Ibm3624RandomPinT&& value) {
    SetIbm3624RandomPin(std::forward<Ibm3624RandomPinT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIbm3624PinFromOffset(Ibm3624PinFromOffsetT&& value) {
    ...
    m_ibm3624PinFromOffset = std::forward<Ibm3624PinFromOffsetT>(value);
  }
  template <typename Ibm3624PinFromOffsetT = Ibm3624PinFromOffset>
  PinGenerationAttributes& WithIbm3624PinFromOffset(Ibm3624PinFromOffsetT&& value) {
    SetIbm3624PinFromOffset(std::forward<Ibm3624PinFromOffsetT>(value));
    return *this;
  }
  ///@}
 private:
