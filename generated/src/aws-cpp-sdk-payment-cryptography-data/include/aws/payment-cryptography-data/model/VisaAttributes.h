...
/**
 * <p>Parameters to derive the confidentiality and integrity keys for a Visa
 * payment card.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/VisaAttributes">AWS
 * API Reference</a></p>
 */
class VisaAttributes {
 public:
  ...
  inline VisaAttributes& WithMajorKeyDerivationMode(MajorKeyDerivationMode value) {
