...
class DukptDerivationAttributes {
 public:
  ...
  inline DukptDerivationAttributes& WithDukptKeyDerivationType(DukptDerivationType value) {
  ...
  inline DukptDerivationAttributes& WithDukptKeyVariant(DukptKeyVariant value) {
