...
class Ibm3624RandomPin {
 public:
  ...
  template <typename DecimalizationTableT = Aws::String>
  Ibm3624RandomPin& WithDecimalizationTable(DecimalizationTableT&& value) {
  ...
  template <typename PinValidationDataPadCharacterT = Aws::String>
  Ibm3624RandomPin& WithPinValidationDataPadCharacter(PinValidationDataPadCharacterT&& value) {
  ...
  template <typename PinValidationDataT = Aws::String>
  Ibm3624RandomPin& WithPinValidationData(PinValidationDataT&& value) {
