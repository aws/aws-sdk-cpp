...
IncomingDiffieHellmanTr31KeyBlock::IncomingDiffieHellmanTr31KeyBlock(JsonView jsonValue) { *this = jsonValue; }

IncomingDiffieHellmanTr31KeyBlock& IncomingDiffieHellmanTr31KeyBlock::operator=(JsonView jsonValue) {
...
JsonValue IncomingDiffieHellmanTr31KeyBlock::Jsonize() const {
  JsonValue payload;
