...
AmexAttributes::AmexAttributes(JsonView jsonValue)
  : AmexAttributes()
{
  *this = jsonValue;
}

AmexAttributes& AmexAttributes::operator =(JsonView jsonValue)
{
...
JsonValue AmexAttributes::Jsonize() const
{
  JsonValue payload;
