...
SessionKeyUnionPay::SessionKeyUnionPay(JsonView jsonValue) { *this = jsonValue; }

SessionKeyUnionPay& SessionKeyUnionPay::operator=(JsonView jsonValue) {
...
JsonValue SessionKeyUnionPay::Jsonize() const {
  JsonValue payload;
