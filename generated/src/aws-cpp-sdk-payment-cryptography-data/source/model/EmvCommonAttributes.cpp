...
EmvCommonAttributes::EmvCommonAttributes() : 
    ...
    m_pinBlockPaddingType(PinBlockPaddingType::NOT_SET),
    m_pinBlockPaddingTypeHasBeenSet(false),
    m_pinBlockLengthPosition(PinBlockLengthPosition::NOT_SET),
    m_pinBlockLengthPositionHasBeenSet(false)
{
}
