...
GenerateAs2805KekValidationResult::GenerateAs2805KekValidationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}
...
GenerateAs2805KekValidationResult& GenerateAs2805KekValidationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RandomKeyReceive")) {
    m_randomKeyReceive = jsonValue.GetString("RandomKeyReceive");
