...
MacAlgorithmEmv::MacAlgorithmEmv(JsonView jsonValue) { *this = jsonValue; }
...
MacAlgorithmEmv& MacAlgorithmEmv::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SessionKeyDerivationMode")) {
    m_sessionKeyDerivationMode =
        SessionKeyDerivationModeMapper::GetSessionKeyDerivationModeForName(jsonValue.GetString("SessionKeyDerivationMode"));
...
JsonValue MacAlgorithmEmv::Jsonize() const {
  ...
  if (m_sessionKeyDerivationModeHasBeenSet) {
    payload.WithString("SessionKeyDerivationMode",
                       SessionKeyDerivationModeMapper::GetNameForSessionKeyDerivationMode(m_sessionKeyDerivationMode));
  }
