...
class AWS_AMPLIFY_API AmplifyClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AmplifyClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AmplifyEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateBackendEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBackendEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBackendEnvironmentRequestT = Model::CreateBackendEnvironmentRequest>
  void CreateBackendEnvironmentAsync(const CreateBackendEnvironmentRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDomainAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDomainAssociationRequestT = Model::CreateDomainAssociationRequest>
  void CreateDomainAssociationAsync(const CreateDomainAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBackendEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBackendEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBackendEnvironmentRequestT = Model::DeleteBackendEnvironmentRequest>
  void DeleteBackendEnvironmentAsync(const DeleteBackendEnvironmentRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDomainAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDomainAssociationRequestT = Model::DeleteDomainAssociationRequest>
  void DeleteDomainAssociationAsync(const DeleteDomainAssociationRequestT& request,
  ...
  /**
   * A Callable wrapper for GenerateAccessLogs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GenerateAccessLogs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GenerateAccessLogsRequestT = Model::GenerateAccessLogsRequest>
  void GenerateAccessLogsAsync(const GenerateAccessLogsRequestT& request, const GenerateAccessLogsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetArtifactUrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetArtifactUrlRequestT = Model::GetArtifactUrlRequest>
  void GetArtifactUrlAsync(const GetArtifactUrlRequestT& request, const GetArtifactUrlResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetBackendEnvironment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBackendEnvironment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBackendEnvironmentRequestT = Model::GetBackendEnvironmentRequest>
  void GetBackendEnvironmentAsync(const GetBackendEnvironmentRequestT& request, const GetBackendEnvironmentResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetBranchRequestT = Model::GetBranchRequest>
  void GetBranchAsync(const GetBranchRequestT& request, const GetBranchResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDomainAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDomainAssociationRequestT = Model::GetDomainAssociationRequest>
  void GetDomainAssociationAsync(const GetDomainAssociationRequestT& request, const GetDomainAssociationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetWebhook that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetWebhookRequestT = Model::GetWebhookRequest>
  void GetWebhookAsync(const GetWebhookRequestT& request, const GetWebhookResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBackendEnvironments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBackendEnvironments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBackendEnvironmentsRequestT = Model::ListBackendEnvironmentsRequest>
  void ListBackendEnvironmentsAsync(const ListBackendEnvironmentsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDomainAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDomainAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDomainAssociationsRequestT = Model::ListDomainAssociationsRequest>
  void ListDomainAssociationsAsync(const ListDomainAssociationsRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateBranch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateBranchRequestT = Model::UpdateBranchRequest>
  void UpdateBranchAsync(const UpdateBranchRequestT& request, const UpdateBranchResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDomainAssociationRequestT = Model::UpdateDomainAssociationRequest>
  void UpdateDomainAssociationAsync(const UpdateDomainAssociationRequestT& request,
