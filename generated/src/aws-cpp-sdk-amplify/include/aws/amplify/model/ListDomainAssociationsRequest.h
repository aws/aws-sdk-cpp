 ...
 * API Reference</a></p>
 */
class ListDomainAssociationsRequest : public AmplifyRequest {
 public:
  AWS_AMPLIFY_API ListDomainAssociationsRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  ListDomainAssociationsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDomainAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
