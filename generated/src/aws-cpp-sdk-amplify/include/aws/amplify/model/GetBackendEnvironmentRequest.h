...
class GetBackendEnvironmentRequest : public AmplifyRequest {
 public:
  AWS_AMPLIFY_API GetBackendEnvironmentRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  GetBackendEnvironmentRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  GetBackendEnvironmentRequest& WithEnvironmentName(EnvironmentNameT&& value) {
