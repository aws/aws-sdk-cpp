...
class ListDomainAssociationsResult {
 public:
  ...
  void SetDomainAssociations(DomainAssociationsT&& value) {
    ...
    m_domainAssociations = std::forward<DomainAssociationsT>(value);
  }
  template <typename DomainAssociationsT = Aws::Vector<DomainAssociation>>
  ListDomainAssociationsResult& WithDomainAssociations(DomainAssociationsT&& value) {
    SetDomainAssociations(std::forward<DomainAssociationsT>(value));
    return *this;
  }
  ...
  ListDomainAssociationsResult& AddDomainAssociations(DomainAssociationsT&& value) {
    m_domainAssociationsHasBeenSet = true;
    m_domainAssociations.emplace_back(std::forward<DomainAssociationsT>(value));
    return *this;
  }
  ///@}
