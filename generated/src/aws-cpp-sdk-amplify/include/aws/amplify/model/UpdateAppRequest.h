...
class UpdateAppRequest : public AmplifyRequest {
 public:
  ...
  inline UpdateAppRequest& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateAppRequest& WithEnableBranchAutoBuild(bool value) {
  ...
  inline UpdateAppRequest& WithEnableBranchAutoDeletion(bool value) {
  ...
  inline UpdateAppRequest& WithEnableBasicAuth(bool value) {
  ...
  inline UpdateAppRequest& WithEnableAutoBranchCreation(bool value) {
