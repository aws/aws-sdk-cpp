...
class CreateBranchRequest : public AmplifyRequest {
 public:
  ...
  inline CreateBranchRequest& WithStage(Stage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  inline CreateBranchRequest& WithEnableNotification(bool value) {
  ...
  inline CreateBranchRequest& WithEnableAutoBuild(bool value) {
  ...
  inline CreateBranchRequest& WithEnableSkewProtection(bool value) {
  ...
  inline CreateBranchRequest& WithEnableBasicAuth(bool value) {
  ...
  inline CreateBranchRequest& WithEnablePerformanceMode(bool value) {
  ...
  inline CreateBranchRequest& WithEnablePullRequestPreview(bool value) {
