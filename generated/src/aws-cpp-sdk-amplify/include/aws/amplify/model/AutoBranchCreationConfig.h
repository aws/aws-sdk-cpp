...
class AutoBranchCreationConfig {
 public:
  ...
  inline AutoBranchCreationConfig& WithStage(Stage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  inline AutoBranchCreationConfig& WithEnableAutoBuild(bool value) {
  ...
  inline AutoBranchCreationConfig& WithEnableBasicAuth(bool value) {
  ...
  inline AutoBranchCreationConfig& WithEnablePerformanceMode(bool value) {
  ...
  inline AutoBranchCreationConfig& WithEnablePullRequestPreview(bool value) {
