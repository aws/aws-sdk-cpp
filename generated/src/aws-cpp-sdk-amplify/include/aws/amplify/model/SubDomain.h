...
class SubDomain {
 public:
  ...
  void SetSubDomainSetting(SubDomainSettingT&& value) {
    ...
    m_subDomainSetting = std::forward<SubDomainSettingT>(value);
  }
  template <typename SubDomainSettingT = SubDomainSetting>
  SubDomain& WithSubDomainSetting(SubDomainSettingT&& value) {
    SetSubDomainSetting(std::forward<SubDomainSettingT>(value));
    return *this;
  }
  ///@}
  ...
  inline SubDomain& WithVerified(bool value) {
    SetVerified(value);
    return *this;
  }
  ///@}
  ...
  void SetDnsRecord(DnsRecordT&& value) {
    ...
    m_dnsRecord = std::forward<DnsRecordT>(value);
  }
  template <typename DnsRecordT = Aws::String>
  SubDomain& WithDnsRecord(DnsRecordT&& value) {
    SetDnsRecord(std::forward<DnsRecordT>(value));
    return *this;
  }
  ///@}
 private:
