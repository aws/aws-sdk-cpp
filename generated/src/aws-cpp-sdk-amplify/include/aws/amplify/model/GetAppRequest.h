...
namespace Model
{
  ...
  /**
   * <p>The request structure for the get app request. </p><p><h3>See Also:</h3>   <a
  ...
  {
  public:
    AWS_AMPLIFY_API GetAppRequest() = default;
    ...
    template<typename AppIdT = Aws::String>
    GetAppRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
  private:
