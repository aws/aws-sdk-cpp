...
class UpdateBranchRequest : public AmplifyRequest {
 public:
  ...
  inline UpdateBranchRequest& WithStage(Stage value) {
    SetStage(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBranchRequest& WithEnableNotification(bool value) {
  ...
  inline UpdateBranchRequest& WithEnableAutoBuild(bool value) {
  ...
  inline UpdateBranchRequest& WithEnableSkewProtection(bool value) {
  ...
  inline UpdateBranchRequest& WithEnableBasicAuth(bool value) {
  ...
  inline UpdateBranchRequest& WithEnablePerformanceMode(bool value) {
  ...
  inline UpdateBranchRequest& WithEnablePullRequestPreview(bool value) {
