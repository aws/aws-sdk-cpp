 ...
 * API Reference</a></p>
 */
class ListWebhooksRequest : public AmplifyRequest {
 public:
  AWS_AMPLIFY_API ListWebhooksRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  ListWebhooksRequest& WithAppId(AppIdT&& value) {
  ...
  inline ListWebhooksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
