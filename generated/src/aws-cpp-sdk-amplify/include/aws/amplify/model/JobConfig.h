...
class JobConfig {
 public:
  ...
  inline void SetBuildComputeType(BuildComputeType value) {
    m_buildComputeTypeHasBeenSet = true;
    m_buildComputeType = value;
  }
  inline JobConfig& WithBuildComputeType(BuildComputeType value) {
    SetBuildComputeType(value);
    return *this;
  }
  ///@}
 private:
