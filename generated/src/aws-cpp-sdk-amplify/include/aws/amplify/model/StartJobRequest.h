...
class StartJobRequest : public AmplifyRequest {
 public:
  ...
  inline StartJobRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetJobReason(JobReasonT&& value) {
    m_jobReasonHasBeenSet = true;
    m_jobReason = std::forward<JobReasonT>(value);
  }
  template <typename JobReasonT = Aws::String>
  StartJobRequest& WithJobReason(JobReasonT&& value) {
    SetJobReason(std::forward<JobReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCommitTime(CommitTimeT&& value) {
    ...
    m_commitTime = std::forward<CommitTimeT>(value);
  }
  template <typename CommitTimeT = Aws::Utils::DateTime>
  StartJobRequest& WithCommitTime(CommitTimeT&& value) {
    SetCommitTime(std::forward<CommitTimeT>(value));
    return *this;
  }
  ///@}
 private:
