...
namespace Model
{
  ...
  public:
    ...
    template<typename AppIdT = Aws::String>
    StopJobRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BranchNameT = Aws::String>
    StopJobRequest& WithBranchName(BranchNameT&& value) { SetBranchName(std::forward<BranchNameT>(value)); return *this;}
    ///@}
    ...
    template<typename JobIdT = Aws::String>
    StopJobRequest& WithJobId(JobIdT&& value) { SetJobId(std::forward<JobIdT>(value)); return *this;}
    ///@}
  private:
