...
class ListBackendEnvironmentsRequest : public AmplifyRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ListBackendEnvironmentsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  ListBackendEnvironmentsRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListBackendEnvironmentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBackendEnvironmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
