...
class DeleteDomainAssociationRequest : public AmplifyRequest {
 public:
  AWS_AMPLIFY_API DeleteDomainAssociationRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  DeleteDomainAssociationRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  DeleteDomainAssociationRequest& WithDomainName(DomainNameT&& value) {
