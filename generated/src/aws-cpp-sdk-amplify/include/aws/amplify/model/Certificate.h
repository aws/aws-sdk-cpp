...
class Certificate {
 public:
  ...
  void SetCustomCertificateArn(CustomCertificateArnT&& value) {
    ...
    m_customCertificateArn = std::forward<CustomCertificateArnT>(value);
  }
  template <typename CustomCertificateArnT = Aws::String>
  Certificate& WithCustomCertificateArn(CustomCertificateArnT&& value) {
    SetCustomCertificateArn(std::forward<CustomCertificateArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCertificateVerificationDNSRecord(CertificateVerificationDNSRecordT&& value) {
    ...
    m_certificateVerificationDNSRecord = std::forward<CertificateVerificationDNSRecordT>(value);
  }
  template <typename CertificateVerificationDNSRecordT = Aws::String>
  Certificate& WithCertificateVerificationDNSRecord(CertificateVerificationDNSRecordT&& value) {
    SetCertificateVerificationDNSRecord(std::forward<CertificateVerificationDNSRecordT>(value));
    return *this;
  }
  ///@}
 private:
