...
class ListBackendEnvironmentsResult {
 public:
  ...
  void SetBackendEnvironments(BackendEnvironmentsT&& value) {
    m_backendEnvironmentsHasBeenSet = true;
    m_backendEnvironments = std::forward<BackendEnvironmentsT>(value);
  }
  template <typename BackendEnvironmentsT = Aws::Vector<BackendEnvironment>>
  ListBackendEnvironmentsResult& WithBackendEnvironments(BackendEnvironmentsT&& value) {
    SetBackendEnvironments(std::forward<BackendEnvironmentsT>(value));
    return *this;
  }
  template <typename BackendEnvironmentsT = BackendEnvironment>
  ListBackendEnvironmentsResult& AddBackendEnvironments(BackendEnvironmentsT&& value) {
    m_backendEnvironmentsHasBeenSet = true;
    m_backendEnvironments.emplace_back(std::forward<BackendEnvironmentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBackendEnvironmentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBackendEnvironmentsResult& WithRequestId(RequestIdT&& value) {
