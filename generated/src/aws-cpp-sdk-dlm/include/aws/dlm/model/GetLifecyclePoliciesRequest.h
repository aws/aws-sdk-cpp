...
class GetLifecyclePoliciesRequest : public DLMRequest {
 public:
  ...
  inline GetLifecyclePoliciesRequest& WithState(GettablePolicyStateValues value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline GetLifecyclePoliciesRequest& AddResourceTypes(ResourceTypeValues value) {
    m_resourceTypesHasBeenSet = true;
  ...
  inline void SetDefaultPolicyType(DefaultPoliciesTypeValues value) {
    m_defaultPolicyTypeHasBeenSet = true;
    m_defaultPolicyType = value;
  }
  inline GetLifecyclePoliciesRequest& WithDefaultPolicyType(DefaultPoliciesTypeValues value) {
    SetDefaultPolicyType(value);
    return *this;
  }
  ///@}
 private:
