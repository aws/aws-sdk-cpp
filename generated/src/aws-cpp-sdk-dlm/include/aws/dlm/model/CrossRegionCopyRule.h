...
class CrossRegionCopyRule {
 public:
  ...
  inline CrossRegionCopyRule& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  void SetCmkArn(CmkArnT&& value) {
    ...
    m_cmkArn = std::forward<CmkArnT>(value);
  }
  template <typename CmkArnT = Aws::String>
  CrossRegionCopyRule& WithCmkArn(CmkArnT&& value) {
    SetCmkArn(std::forward<CmkArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CrossRegionCopyRule& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
