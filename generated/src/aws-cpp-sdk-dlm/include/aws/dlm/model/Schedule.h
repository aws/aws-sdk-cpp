...
class Schedule {
 public:
  ...
  inline Schedule& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  void SetTagsToAdd(TagsToAddT&& value) {
    ...
    m_tagsToAdd = std::forward<TagsToAddT>(value);
  }
  template <typename TagsToAddT = Aws::Vector<Tag>>
  Schedule& WithTagsToAdd(TagsToAddT&& value) {
    SetTagsToAdd(std::forward<TagsToAddT>(value));
    return *this;
  }
  template <typename TagsToAddT = Tag>
  Schedule& AddTagsToAdd(TagsToAddT&& value) {
    m_tagsToAddHasBeenSet = true;
    m_tagsToAdd.emplace_back(std::forward<TagsToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVariableTags(VariableTagsT&& value) {
    ...
    m_variableTags = std::forward<VariableTagsT>(value);
  }
  template <typename VariableTagsT = Aws::Vector<Tag>>
  Schedule& WithVariableTags(VariableTagsT&& value) {
    SetVariableTags(std::forward<VariableTagsT>(value));
    return *this;
  }
  template <typename VariableTagsT = Tag>
  Schedule& AddVariableTags(VariableTagsT&& value) {
    m_variableTagsHasBeenSet = true;
    m_variableTags.emplace_back(std::forward<VariableTagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateRule(CreateRuleT&& value) {
    ...
    m_createRule = std::forward<CreateRuleT>(value);
  }
  template <typename CreateRuleT = CreateRule>
  Schedule& WithCreateRule(CreateRuleT&& value) {
    SetCreateRule(std::forward<CreateRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRetainRule(RetainRuleT&& value) {
    ...
    m_retainRule = std::forward<RetainRuleT>(value);
  }
  template <typename RetainRuleT = RetainRule>
  Schedule& WithRetainRule(RetainRuleT&& value) {
    SetRetainRule(std::forward<RetainRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFastRestoreRule(FastRestoreRuleT&& value) {
    ...
    m_fastRestoreRule = std::forward<FastRestoreRuleT>(value);
  }
  template <typename FastRestoreRuleT = FastRestoreRule>
  Schedule& WithFastRestoreRule(FastRestoreRuleT&& value) {
    SetFastRestoreRule(std::forward<FastRestoreRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrossRegionCopyRules(CrossRegionCopyRulesT&& value) {
    ...
    m_crossRegionCopyRules = std::forward<CrossRegionCopyRulesT>(value);
  }
  template <typename CrossRegionCopyRulesT = Aws::Vector<CrossRegionCopyRule>>
  Schedule& WithCrossRegionCopyRules(CrossRegionCopyRulesT&& value) {
    SetCrossRegionCopyRules(std::forward<CrossRegionCopyRulesT>(value));
    return *this;
  }
  template <typename CrossRegionCopyRulesT = CrossRegionCopyRule>
  Schedule& AddCrossRegionCopyRules(CrossRegionCopyRulesT&& value) {
    m_crossRegionCopyRulesHasBeenSet = true;
    m_crossRegionCopyRules.emplace_back(std::forward<CrossRegionCopyRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShareRules(ShareRulesT&& value) {
    ...
    m_shareRules = std::forward<ShareRulesT>(value);
  }
  template <typename ShareRulesT = Aws::Vector<ShareRule>>
  Schedule& WithShareRules(ShareRulesT&& value) {
    SetShareRules(std::forward<ShareRulesT>(value));
    return *this;
  }
  template <typename ShareRulesT = ShareRule>
  Schedule& AddShareRules(ShareRulesT&& value) {
    m_shareRulesHasBeenSet = true;
    m_shareRules.emplace_back(std::forward<ShareRulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeprecateRule(DeprecateRuleT&& value) {
    ...
    m_deprecateRule = std::forward<DeprecateRuleT>(value);
  }
  template <typename DeprecateRuleT = DeprecateRule>
  Schedule& WithDeprecateRule(DeprecateRuleT&& value) {
    SetDeprecateRule(std::forward<DeprecateRuleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetArchiveRule(ArchiveRuleT&& value) {
    ...
    m_archiveRule = std::forward<ArchiveRuleT>(value);
  }
  template <typename ArchiveRuleT = ArchiveRule>
  Schedule& WithArchiveRule(ArchiveRuleT&& value) {
    SetArchiveRule(std::forward<ArchiveRuleT>(value));
    return *this;
  }
  ///@}
 private:
