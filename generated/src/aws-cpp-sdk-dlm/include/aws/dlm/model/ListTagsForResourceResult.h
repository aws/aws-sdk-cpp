...
namespace Model
{
  ...
  {
  public:
    AWS_DLM_API ListTagsForResourceResult() = default;
    AWS_DLM_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DLM_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
