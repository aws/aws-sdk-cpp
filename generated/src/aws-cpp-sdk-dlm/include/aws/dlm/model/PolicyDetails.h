...
class PolicyDetails {
 public:
  ...
  inline void SetPolicyType(PolicyTypeValues value) {
    m_policyTypeHasBeenSet = true;
    m_policyType = value;
  }
  inline PolicyDetails& WithPolicyType(PolicyTypeValues value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyDetails& AddResourceTypes(ResourceTypeValues value) {
    m_resourceTypesHasBeenSet = true;
  ...
  void SetResourceLocations(ResourceLocationsT&& value) {
    ...
    m_resourceLocations = std::forward<ResourceLocationsT>(value);
  }
  template <typename ResourceLocationsT = Aws::Vector<ResourceLocationValues>>
  PolicyDetails& WithResourceLocations(ResourceLocationsT&& value) {
    SetResourceLocations(std::forward<ResourceLocationsT>(value));
    return *this;
  }
  inline PolicyDetails& AddResourceLocations(ResourceLocationValues value) {
    m_resourceLocationsHasBeenSet = true;
    m_resourceLocations.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetTags(TargetTagsT&& value) {
    ...
    m_targetTags = std::forward<TargetTagsT>(value);
  }
  template <typename TargetTagsT = Aws::Vector<Tag>>
  PolicyDetails& WithTargetTags(TargetTagsT&& value) {
    SetTargetTags(std::forward<TargetTagsT>(value));
    return *this;
  }
  template <typename TargetTagsT = Tag>
  PolicyDetails& AddTargetTags(TargetTagsT&& value) {
    m_targetTagsHasBeenSet = true;
    m_targetTags.emplace_back(std::forward<TargetTagsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchedules(SchedulesT&& value) {
    ...
    m_schedules = std::forward<SchedulesT>(value);
  }
  template <typename SchedulesT = Aws::Vector<Schedule>>
  PolicyDetails& WithSchedules(SchedulesT&& value) {
    SetSchedules(std::forward<SchedulesT>(value));
    return *this;
  }
  template <typename SchedulesT = Schedule>
  PolicyDetails& AddSchedules(SchedulesT&& value) {
    m_schedulesHasBeenSet = true;
    m_schedules.emplace_back(std::forward<SchedulesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventSource(EventSourceT&& value) {
    ...
    m_eventSource = std::forward<EventSourceT>(value);
  }
  template <typename EventSourceT = EventSource>
  PolicyDetails& WithEventSource(EventSourceT&& value) {
    SetEventSource(std::forward<EventSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPolicyLanguage(PolicyLanguageValues value) {
    m_policyLanguageHasBeenSet = true;
    m_policyLanguage = value;
  }
  inline PolicyDetails& WithPolicyLanguage(PolicyLanguageValues value) {
    SetPolicyLanguage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceType(ResourceTypeValues value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline PolicyDetails& WithResourceType(ResourceTypeValues value) {
  ...
  inline void SetCreateInterval(int value) {
    m_createIntervalHasBeenSet = true;
    m_createInterval = value;
  }
  inline PolicyDetails& WithCreateInterval(int value) {
    SetCreateInterval(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetainInterval(int value) {
    m_retainIntervalHasBeenSet = true;
    m_retainInterval = value;
  }
  inline PolicyDetails& WithRetainInterval(int value) {
    SetRetainInterval(value);
    return *this;
  }
  ///@}
  ...
  inline PolicyDetails& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  void SetCrossRegionCopyTargets(CrossRegionCopyTargetsT&& value) {
    ...
    m_crossRegionCopyTargets = std::forward<CrossRegionCopyTargetsT>(value);
  }
  template <typename CrossRegionCopyTargetsT = Aws::Vector<CrossRegionCopyTarget>>
  PolicyDetails& WithCrossRegionCopyTargets(CrossRegionCopyTargetsT&& value) {
    SetCrossRegionCopyTargets(std::forward<CrossRegionCopyTargetsT>(value));
    return *this;
  }
  ...
  PolicyDetails& AddCrossRegionCopyTargets(CrossRegionCopyTargetsT&& value) {
    m_crossRegionCopyTargetsHasBeenSet = true;
    m_crossRegionCopyTargets.emplace_back(std::forward<CrossRegionCopyTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExtendDeletion(bool value) {
    m_extendDeletionHasBeenSet = true;
    m_extendDeletion = value;
  }
  inline PolicyDetails& WithExtendDeletion(bool value) {
    SetExtendDeletion(value);
    return *this;
  }
  ///@}
