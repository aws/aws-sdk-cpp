...
class Parameters {
 public:
  ...
  inline Parameters& WithExcludeBootVolume(bool value) {
  ...
  inline void SetNoReboot(bool value) {
    m_noRebootHasBeenSet = true;
    m_noReboot = value;
  }
  inline Parameters& WithNoReboot(bool value) {
    SetNoReboot(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludeDataVolumeTags(ExcludeDataVolumeTagsT&& value) {
    ...
    m_excludeDataVolumeTags = std::forward<ExcludeDataVolumeTagsT>(value);
  }
  template <typename ExcludeDataVolumeTagsT = Aws::Vector<Tag>>
  Parameters& WithExcludeDataVolumeTags(ExcludeDataVolumeTagsT&& value) {
    SetExcludeDataVolumeTags(std::forward<ExcludeDataVolumeTagsT>(value));
    return *this;
  }
  template <typename ExcludeDataVolumeTagsT = Tag>
  Parameters& AddExcludeDataVolumeTags(ExcludeDataVolumeTagsT&& value) {
    m_excludeDataVolumeTagsHasBeenSet = true;
    m_excludeDataVolumeTags.emplace_back(std::forward<ExcludeDataVolumeTagsT>(value));
    return *this;
  }
  ///@}
 private:
