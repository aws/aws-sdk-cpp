...
class LifecyclePolicySummary {
 public:
  ...
  inline LifecyclePolicySummary& WithState(GettablePolicyStateValues value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicySummary& WithPolicyType(PolicyTypeValues value) {
    SetPolicyType(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicySummary& WithDefaultPolicy(bool value) {
