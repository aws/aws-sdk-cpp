...
class Exclusions {
 public:
  ...
  inline void SetExcludeBootVolumes(bool value) {
    m_excludeBootVolumesHasBeenSet = true;
    m_excludeBootVolumes = value;
  }
  inline Exclusions& WithExcludeBootVolumes(bool value) {
    SetExcludeBootVolumes(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludeVolumeTypes(ExcludeVolumeTypesT&& value) {
    ...
    m_excludeVolumeTypes = std::forward<ExcludeVolumeTypesT>(value);
  }
  template <typename ExcludeVolumeTypesT = Aws::Vector<Aws::String>>
  Exclusions& WithExcludeVolumeTypes(ExcludeVolumeTypesT&& value) {
    SetExcludeVolumeTypes(std::forward<ExcludeVolumeTypesT>(value));
    return *this;
  }
  template <typename ExcludeVolumeTypesT = Aws::String>
  Exclusions& AddExcludeVolumeTypes(ExcludeVolumeTypesT&& value) {
    m_excludeVolumeTypesHasBeenSet = true;
    m_excludeVolumeTypes.emplace_back(std::forward<ExcludeVolumeTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludeTags(ExcludeTagsT&& value) {
    ...
    m_excludeTags = std::forward<ExcludeTagsT>(value);
  }
  template <typename ExcludeTagsT = Aws::Vector<Tag>>
  Exclusions& WithExcludeTags(ExcludeTagsT&& value) {
    SetExcludeTags(std::forward<ExcludeTagsT>(value));
    return *this;
  }
  template <typename ExcludeTagsT = Tag>
  Exclusions& AddExcludeTags(ExcludeTagsT&& value) {
    m_excludeTagsHasBeenSet = true;
    m_excludeTags.emplace_back(std::forward<ExcludeTagsT>(value));
    return *this;
  }
  ///@}
 private:
