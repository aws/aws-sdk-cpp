...
class CreateLifecyclePolicyRequest : public DLMRequest {
 public:
  ...
  inline void SetState(SettablePolicyStateValues value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CreateLifecyclePolicyRequest& WithState(SettablePolicyStateValues value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultPolicy(DefaultPolicyTypeValues value) {
    m_defaultPolicyHasBeenSet = true;
    m_defaultPolicy = value;
  }
  inline CreateLifecyclePolicyRequest& WithDefaultPolicy(DefaultPolicyTypeValues value) {
  ...
  inline CreateLifecyclePolicyRequest& WithCreateInterval(int value) {
  ...
  inline CreateLifecyclePolicyRequest& WithRetainInterval(int value) {
  ...
  inline CreateLifecyclePolicyRequest& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLifecyclePolicyRequest& WithExtendDeletion(bool value) {
