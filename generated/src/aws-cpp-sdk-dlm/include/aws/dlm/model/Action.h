...
class Action {
 public:
  ...
  void SetCrossRegionCopy(CrossRegionCopyT&& value) {
    ...
    m_crossRegionCopy = std::forward<CrossRegionCopyT>(value);
  }
  template <typename CrossRegionCopyT = Aws::Vector<CrossRegionCopyAction>>
  Action& WithCrossRegionCopy(CrossRegionCopyT&& value) {
    SetCrossRegionCopy(std::forward<CrossRegionCopyT>(value));
    return *this;
  }
  template <typename CrossRegionCopyT = CrossRegionCopyAction>
  Action& AddCrossRegionCopy(CrossRegionCopyT&& value) {
    m_crossRegionCopyHasBeenSet = true;
    m_crossRegionCopy.emplace_back(std::forward<CrossRegionCopyT>(value));
    return *this;
  }
  ///@}
 private:
