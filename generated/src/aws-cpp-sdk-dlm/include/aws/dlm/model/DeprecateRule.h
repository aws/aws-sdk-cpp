...
class DeprecateRule {
 public:
  ...
  inline DeprecateRule& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline DeprecateRule& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline DeprecateRule& WithIntervalUnit(RetentionIntervalUnitValues value) {
