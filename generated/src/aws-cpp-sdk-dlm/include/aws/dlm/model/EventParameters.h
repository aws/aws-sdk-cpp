...
class EventParameters {
 public:
  ...
  inline void SetEventType(EventTypeValues value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline EventParameters& WithEventType(EventTypeValues value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetSnapshotOwner(SnapshotOwnerT&& value) {
    ...
    m_snapshotOwner = std::forward<SnapshotOwnerT>(value);
  }
  template <typename SnapshotOwnerT = Aws::Vector<Aws::String>>
  EventParameters& WithSnapshotOwner(SnapshotOwnerT&& value) {
    SetSnapshotOwner(std::forward<SnapshotOwnerT>(value));
    return *this;
  }
  template <typename SnapshotOwnerT = Aws::String>
  EventParameters& AddSnapshotOwner(SnapshotOwnerT&& value) {
    m_snapshotOwnerHasBeenSet = true;
    m_snapshotOwner.emplace_back(std::forward<SnapshotOwnerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDescriptionRegex(DescriptionRegexT&& value) {
    ...
    m_descriptionRegex = std::forward<DescriptionRegexT>(value);
  }
  template <typename DescriptionRegexT = Aws::String>
  EventParameters& WithDescriptionRegex(DescriptionRegexT&& value) {
    SetDescriptionRegex(std::forward<DescriptionRegexT>(value));
    return *this;
  }
  ///@}
 private:
