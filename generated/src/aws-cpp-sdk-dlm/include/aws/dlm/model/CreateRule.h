...
class CreateRule {
 public:
  ...
  inline void SetLocation(LocationValues value) {
    m_locationHasBeenSet = true;
    m_location = value;
  }
  inline CreateRule& WithLocation(LocationValues value) {
    SetLocation(value);
    return *this;
  }
  ///@}
  ...
  inline CreateRule& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIntervalUnit(IntervalUnitValues value) {
    m_intervalUnitHasBeenSet = true;
    m_intervalUnit = value;
  }
  inline CreateRule& WithIntervalUnit(IntervalUnitValues value) {
  ...
  void SetTimes(TimesT&& value) {
    ...
    m_times = std::forward<TimesT>(value);
  }
  template <typename TimesT = Aws::Vector<Aws::String>>
  CreateRule& WithTimes(TimesT&& value) {
    SetTimes(std::forward<TimesT>(value));
    return *this;
  }
  template <typename TimesT = Aws::String>
  CreateRule& AddTimes(TimesT&& value) {
    m_timesHasBeenSet = true;
    m_times.emplace_back(std::forward<TimesT>(value));
    return *this;
  }
  ///@}
