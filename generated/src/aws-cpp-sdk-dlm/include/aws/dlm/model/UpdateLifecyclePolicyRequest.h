...
class UpdateLifecyclePolicyRequest : public DLMRequest {
 public:
  ...
  inline UpdateLifecyclePolicyRequest& WithState(SettablePolicyStateValues value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLifecyclePolicyRequest& WithCreateInterval(int value) {
  ...
  inline UpdateLifecyclePolicyRequest& WithRetainInterval(int value) {
  ...
  inline UpdateLifecyclePolicyRequest& WithCopyTags(bool value) {
    SetCopyTags(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLifecyclePolicyRequest& WithExtendDeletion(bool value) {
