...
namespace DLM
{
const size_t DLMEndpointRules::RulesBlobStrLen = 3729;
const size_t DLMEndpointRules::RulesBlobSize = 3730;
...
'h','t','t','p','s',':','/','/','d','l','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* DLMEndpointRules::GetRulesBlob()
{
