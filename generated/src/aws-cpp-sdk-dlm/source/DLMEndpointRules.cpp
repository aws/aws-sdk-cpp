...
namespace DLM
{
const size_t DLMEndpointRules::RulesBlobStrLen = 3935;
const size_t DLMEndpointRules::RulesBlobSize = 3936;
...
'd','l','m','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','d','l','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
