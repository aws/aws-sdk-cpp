...
ShareRule::ShareRule(JsonView jsonValue) { *this = jsonValue; }
...
ShareRule& ShareRule::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("UnshareIntervalUnit")) {
    m_unshareIntervalUnit =
        RetentionIntervalUnitValuesMapper::GetRetentionIntervalUnitValuesForName(jsonValue.GetString("UnshareIntervalUnit"));
...
JsonValue ShareRule::Jsonize() const {
  ...
  if (m_unshareIntervalUnitHasBeenSet) {
    payload.WithString("UnshareIntervalUnit",
                       RetentionIntervalUnitValuesMapper::GetNameForRetentionIntervalUnitValues(m_unshareIntervalUnit));
  }
