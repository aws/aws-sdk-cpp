...
Exclusions::Exclusions(JsonView jsonValue) { *this = jsonValue; }
...
Exclusions& Exclusions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExcludeVolumeTypes")) {
    ...
    for (unsigned excludeVolumeTypesIndex = 0; excludeVolumeTypesIndex < excludeVolumeTypesJsonList.GetLength();
         ++excludeVolumeTypesIndex) {
