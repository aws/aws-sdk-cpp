...
DeprecateRule::DeprecateRule(JsonView jsonValue) { *this = jsonValue; }

DeprecateRule& DeprecateRule::operator=(JsonView jsonValue) {
...
JsonValue DeprecateRule::Jsonize() const {
  JsonValue payload;
