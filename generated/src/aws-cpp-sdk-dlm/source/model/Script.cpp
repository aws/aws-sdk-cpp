...
Script& Script::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExecutionHandlerService")) {
    m_executionHandlerService =
        ExecutionHandlerServiceValuesMapper::GetExecutionHandlerServiceValuesForName(jsonValue.GetString("ExecutionHandlerService"));
...
JsonValue Script::Jsonize() const {
  ...
  if (m_executionHandlerServiceHasBeenSet) {
    payload.WithString("ExecutionHandlerService",
                       ExecutionHandlerServiceValuesMapper::GetNameForExecutionHandlerServiceValues(m_executionHandlerService));
  }
