...
namespace SSO
{
const size_t SSOEndpointRules::RulesBlobStrLen = 3488;
const size_t SSOEndpointRules::RulesBlobSize = 3489;
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','o','r','t','a','l','.','s','s',
...
's',':','/','/','p','o','r','t','a','l','.','s','s','o','.','{','R','e','g','i','o','n','}','.','{',
