...
namespace Model
{
  ...
  /**
   */
  class LogoutRequest : public SSORequest
  {
  public:
    AWS_SSO_API LogoutRequest() = default;
    ...
    template<typename AccessTokenT = Aws::String>
    LogoutRequest& WithAccessToken(AccessTokenT&& value) { SetAccessToken(std::forward<AccessTokenT>(value)); return *this;}
    ///@}
  private:
