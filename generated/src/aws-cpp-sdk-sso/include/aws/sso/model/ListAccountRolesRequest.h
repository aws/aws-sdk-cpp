...
class ListAccountRolesRequest : public SSORequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountRolesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAccountRolesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AccessTokenT = Aws::String>
  ListAccountRolesRequest& WithAccessToken(AccessTokenT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  ListAccountRolesRequest& WithAccountId(AccountIdT&& value) {
