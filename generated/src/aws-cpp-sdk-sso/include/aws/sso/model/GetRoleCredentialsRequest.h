...
class GetRoleCredentialsRequest : public SSORequest {
 public:
  ...
  template <typename RoleNameT = Aws::String>
  GetRoleCredentialsRequest& WithRoleName(RoleNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetRoleCredentialsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename AccessTokenT = Aws::String>
  GetRoleCredentialsRequest& WithAccessToken(AccessTokenT&& value) {
