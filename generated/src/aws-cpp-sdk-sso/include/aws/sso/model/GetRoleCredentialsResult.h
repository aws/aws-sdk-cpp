...
class GetRoleCredentialsResult {
 public:
  ...
  void SetRoleCredentials(RoleCredentialsT&& value) {
    m_roleCredentialsHasBeenSet = true;
    m_roleCredentials = std::forward<RoleCredentialsT>(value);
  }
  template <typename RoleCredentialsT = RoleCredentials>
  GetRoleCredentialsResult& WithRoleCredentials(RoleCredentialsT&& value) {
    SetRoleCredentials(std::forward<RoleCredentialsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRoleCredentialsResult& WithRequestId(RequestIdT&& value) {
