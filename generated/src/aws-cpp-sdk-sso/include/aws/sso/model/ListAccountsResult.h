...
class ListAccountsResult {
 public:
  ...
  void SetAccountList(AccountListT&& value) {
    m_accountListHasBeenSet = true;
    m_accountList = std::forward<AccountListT>(value);
  }
  template <typename AccountListT = Aws::Vector<AccountInfo>>
  ListAccountsResult& WithAccountList(AccountListT&& value) {
    SetAccountList(std::forward<AccountListT>(value));
    return *this;
  }
  template <typename AccountListT = AccountInfo>
  ListAccountsResult& AddAccountList(AccountListT&& value) {
    m_accountListHasBeenSet = true;
    m_accountList.emplace_back(std::forward<AccountListT>(value));
    return *this;
  }
  ///@}
