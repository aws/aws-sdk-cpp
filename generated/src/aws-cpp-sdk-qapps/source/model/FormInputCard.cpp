...
FormInputCard::FormInputCard(JsonView jsonValue)
  : FormInputCard()
{
  *this = jsonValue;
}

FormInputCard& FormInputCard::operator =(JsonView jsonValue)
{
...
JsonValue FormInputCard::Jsonize() const
{
  JsonValue payload;
