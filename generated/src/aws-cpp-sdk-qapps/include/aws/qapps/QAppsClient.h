...
class AWS_QAPPS_API QAppsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  QAppsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<QAppsEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateLibraryItemReviewOutcome AssociateLibraryItemReview(
      const Model::AssociateLibraryItemReviewRequest& request) const;

  /**
   * A Callable wrapper for AssociateLibraryItemReview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateLibraryItemReviewRequestT = Model::AssociateLibraryItemReviewRequest>
  Model::AssociateLibraryItemReviewOutcomeCallable AssociateLibraryItemReviewCallable(
      const AssociateLibraryItemReviewRequestT& request) const {
    return SubmitCallable(&QAppsClient::AssociateLibraryItemReview, request);
  }

  /**
   * An Async wrapper for AssociateLibraryItemReview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateLibraryItemReviewRequestT = Model::AssociateLibraryItemReviewRequest>
  void AssociateLibraryItemReviewAsync(const AssociateLibraryItemReviewRequestT& request,
                                       const AssociateLibraryItemReviewResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateQAppWithUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateQAppWithUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateQAppWithUserRequestT = Model::AssociateQAppWithUserRequest>
  void AssociateQAppWithUserAsync(const AssociateQAppWithUserRequestT& request, const AssociateQAppWithUserResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchCreateCategory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchCreateCategory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchCreateCategoryRequestT = Model::BatchCreateCategoryRequest>
  void BatchCreateCategoryAsync(const BatchCreateCategoryRequestT& request, const BatchCreateCategoryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteCategory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteCategory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchDeleteCategoryRequestT = Model::BatchDeleteCategoryRequest>
  void BatchDeleteCategoryAsync(const BatchDeleteCategoryRequestT& request, const BatchDeleteCategoryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateCategory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateCategory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchUpdateCategoryRequestT = Model::BatchUpdateCategoryRequest>
  void BatchUpdateCategoryAsync(const BatchUpdateCategoryRequestT& request, const BatchUpdateCategoryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLibraryItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLibraryItem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLibraryItemRequestT = Model::CreateLibraryItemRequest>
  void CreateLibraryItemAsync(const CreateLibraryItemRequestT& request, const CreateLibraryItemResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePresignedUrl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePresignedUrl that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePresignedUrlRequestT = Model::CreatePresignedUrlRequest>
  void CreatePresignedUrlAsync(const CreatePresignedUrlRequestT& request, const CreatePresignedUrlResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateQApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateQAppRequestT = Model::CreateQAppRequest>
  void CreateQAppAsync(const CreateQAppRequestT& request, const CreateQAppResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteLibraryItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLibraryItem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLibraryItemRequestT = Model::DeleteLibraryItemRequest>
  void DeleteLibraryItemAsync(const DeleteLibraryItemRequestT& request, const DeleteLibraryItemResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteQApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteQAppRequestT = Model::DeleteQAppRequest>
  void DeleteQAppAsync(const DeleteQAppRequestT& request, const DeleteQAppResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeQAppPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeQAppPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeQAppPermissionsRequestT = Model::DescribeQAppPermissionsRequest>
  void DescribeQAppPermissionsAsync(const DescribeQAppPermissionsRequestT& request,
                                    const DescribeQAppPermissionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateLibraryItemReviewOutcome DisassociateLibraryItemReview(
      const Model::DisassociateLibraryItemReviewRequest& request) const;

  /**
   * A Callable wrapper for DisassociateLibraryItemReview that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateLibraryItemReviewRequestT = Model::DisassociateLibraryItemReviewRequest>
  Model::DisassociateLibraryItemReviewOutcomeCallable DisassociateLibraryItemReviewCallable(
      const DisassociateLibraryItemReviewRequestT& request) const {
    return SubmitCallable(&QAppsClient::DisassociateLibraryItemReview, request);
  }

  /**
   * An Async wrapper for DisassociateLibraryItemReview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateLibraryItemReviewRequestT = Model::DisassociateLibraryItemReviewRequest>
  void DisassociateLibraryItemReviewAsync(const DisassociateLibraryItemReviewRequestT& request,
                                          const DisassociateLibraryItemReviewResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateQAppFromUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateQAppFromUser that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateQAppFromUserRequestT = Model::DisassociateQAppFromUserRequest>
  void DisassociateQAppFromUserAsync(const DisassociateQAppFromUserRequestT& request,
                                     const DisassociateQAppFromUserResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExportQAppSessionData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExportQAppSessionData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExportQAppSessionDataRequestT = Model::ExportQAppSessionDataRequest>
  void ExportQAppSessionDataAsync(const ExportQAppSessionDataRequestT& request, const ExportQAppSessionDataResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLibraryItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLibraryItemRequestT = Model::GetLibraryItemRequest>
  void GetLibraryItemAsync(const GetLibraryItemRequestT& request, const GetLibraryItemResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQAppRequestT = Model::GetQAppRequest>
  void GetQAppAsync(const GetQAppRequestT& request, const GetQAppResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQAppSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQAppSessionRequestT = Model::GetQAppSessionRequest>
  void GetQAppSessionAsync(const GetQAppSessionRequestT& request, const GetQAppSessionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQAppSessionMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQAppSessionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQAppSessionMetadataRequestT = Model::GetQAppSessionMetadataRequest>
  void GetQAppSessionMetadataAsync(const GetQAppSessionMetadataRequestT& request,
                                   const GetQAppSessionMetadataResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportDocument that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportDocumentRequestT = Model::ImportDocumentRequest>
  void ImportDocumentAsync(const ImportDocumentRequestT& request, const ImportDocumentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListCategories that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListCategoriesRequestT = Model::ListCategoriesRequest>
  void ListCategoriesAsync(const ListCategoriesRequestT& request, const ListCategoriesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLibraryItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLibraryItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLibraryItemsRequestT = Model::ListLibraryItemsRequest>
  void ListLibraryItemsAsync(const ListLibraryItemsRequestT& request, const ListLibraryItemsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListQAppSessionData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQAppSessionData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListQAppSessionDataRequestT = Model::ListQAppSessionDataRequest>
  void ListQAppSessionDataAsync(const ListQAppSessionDataRequestT& request, const ListQAppSessionDataResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListQApps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListQAppsRequestT = Model::ListQAppsRequest>
  void ListQAppsAsync(const ListQAppsRequestT& request, const ListQAppsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PredictQApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PredictQAppRequestT = Model::PredictQAppRequest>
  void PredictQAppAsync(const PredictQAppRequestT& request, const PredictQAppResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartQAppSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartQAppSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartQAppSessionRequestT = Model::StartQAppSessionRequest>
  void StartQAppSessionAsync(const StartQAppSessionRequestT& request, const StartQAppSessionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopQAppSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopQAppSessionRequestT = Model::StopQAppSessionRequest>
  void StopQAppSessionAsync(const StopQAppSessionRequestT& request, const StopQAppSessionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateLibraryItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLibraryItem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLibraryItemRequestT = Model::UpdateLibraryItemRequest>
  void UpdateLibraryItemAsync(const UpdateLibraryItemRequestT& request, const UpdateLibraryItemResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateLibraryItemMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateLibraryItemMetadataRequestT = Model::UpdateLibraryItemMetadataRequest>
  Model::UpdateLibraryItemMetadataOutcomeCallable UpdateLibraryItemMetadataCallable(
      const UpdateLibraryItemMetadataRequestT& request) const {
    return SubmitCallable(&QAppsClient::UpdateLibraryItemMetadata, request);
  }

  /**
   * An Async wrapper for UpdateLibraryItemMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateLibraryItemMetadataRequestT = Model::UpdateLibraryItemMetadataRequest>
  void UpdateLibraryItemMetadataAsync(const UpdateLibraryItemMetadataRequestT& request,
                                      const UpdateLibraryItemMetadataResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateQApp that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateQAppRequestT = Model::UpdateQAppRequest>
  void UpdateQAppAsync(const UpdateQAppRequestT& request, const UpdateQAppResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateQAppPermissions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQAppPermissions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQAppPermissionsRequestT = Model::UpdateQAppPermissionsRequest>
  void UpdateQAppPermissionsAsync(const UpdateQAppPermissionsRequestT& request, const UpdateQAppPermissionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateQAppSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQAppSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateQAppSessionRequestT = Model::UpdateQAppSessionRequest>
  void UpdateQAppSessionAsync(const UpdateQAppSessionRequestT& request, const UpdateQAppSessionResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateQAppSessionMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateQAppSessionMetadataRequestT = Model::UpdateQAppSessionMetadataRequest>
  Model::UpdateQAppSessionMetadataOutcomeCallable UpdateQAppSessionMetadataCallable(
      const UpdateQAppSessionMetadataRequestT& request) const {
    return SubmitCallable(&QAppsClient::UpdateQAppSessionMetadata, request);
  }

  /**
   * An Async wrapper for UpdateQAppSessionMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQAppSessionMetadataRequestT = Model::UpdateQAppSessionMetadataRequest>
  void UpdateQAppSessionMetadataAsync(const UpdateQAppSessionMetadataRequestT& request,
                                      const UpdateQAppSessionMetadataResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
