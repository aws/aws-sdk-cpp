...
class DescribeQAppPermissionsResult {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  DescribeQAppPermissionsResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename AppIdT = Aws::String>
  DescribeQAppPermissionsResult& WithAppId(AppIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<PermissionOutput>>
  DescribeQAppPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = PermissionOutput>
  DescribeQAppPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeQAppPermissionsResult& WithRequestId(RequestIdT&& value) {
