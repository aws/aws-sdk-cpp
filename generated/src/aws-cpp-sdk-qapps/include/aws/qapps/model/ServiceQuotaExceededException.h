...
namespace Model
{
  ...
  /**
   * <p>The requested operation could not be completed because it would exceed the
   * service's quota or limit.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/qapps-2023-11-27/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
