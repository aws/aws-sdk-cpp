...
class ImportDocumentRequest : public QAppsRequest {
 public:
  ...
  void SetFileContentsBase64(FileContentsBase64T&& value) {
    m_fileContentsBase64HasBeenSet = true;
    m_fileContentsBase64 = std::forward<FileContentsBase64T>(value);
  }
  template <typename FileContentsBase64T = Aws::String>
  ImportDocumentRequest& WithFileContentsBase64(FileContentsBase64T&& value) {
    SetFileContentsBase64(std::forward<FileContentsBase64T>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScope(DocumentScope value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline ImportDocumentRequest& WithScope(DocumentScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
