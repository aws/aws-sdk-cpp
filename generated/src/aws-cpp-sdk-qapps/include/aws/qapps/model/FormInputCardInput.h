...
class FormInputCardInput {
 public:
  ...
  inline FormInputCardInput& WithType(CardType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComputeMode(InputCardComputeMode value) {
    m_computeModeHasBeenSet = true;
    m_computeMode = value;
  }
  inline FormInputCardInput& WithComputeMode(InputCardComputeMode value) {
