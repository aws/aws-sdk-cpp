...
class AppDefinition {
 public:
  ...
  void SetAppDefinitionVersion(AppDefinitionVersionT&& value) {
    ...
    m_appDefinitionVersion = std::forward<AppDefinitionVersionT>(value);
  }
  template <typename AppDefinitionVersionT = Aws::String>
  AppDefinition& WithAppDefinitionVersion(AppDefinitionVersionT&& value) {
    SetAppDefinitionVersion(std::forward<AppDefinitionVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCards(CardsT&& value) {
    ...
    m_cards = std::forward<CardsT>(value);
  }
  template <typename CardsT = Aws::Vector<Card>>
  AppDefinition& WithCards(CardsT&& value) {
    SetCards(std::forward<CardsT>(value));
    return *this;
  }
  template <typename CardsT = Card>
  AppDefinition& AddCards(CardsT&& value) {
    m_cardsHasBeenSet = true;
    m_cards.emplace_back(std::forward<CardsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCanEdit(bool value) {
    m_canEditHasBeenSet = true;
    m_canEdit = value;
  }
  inline AppDefinition& WithCanEdit(bool value) {
    SetCanEdit(value);
    return *this;
  }
  ///@}
