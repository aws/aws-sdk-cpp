...
class Submission {
 public:
  ...
  template <typename ValueT = Aws::Utils::Document>
  Submission& WithValue(ValueT&& value) {
  ...
  void SetSubmissionId(SubmissionIdT&& value) {
    ...
    m_submissionId = std::forward<SubmissionIdT>(value);
  }
  template <typename SubmissionIdT = Aws::String>
  Submission& WithSubmissionId(SubmissionIdT&& value) {
    SetSubmissionId(std::forward<SubmissionIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  Submission& WithTimestamp(TimestampT&& value) {
