...
class UpdateQAppPermissionsResult {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateQAppPermissionsResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename AppIdT = Aws::String>
  UpdateQAppPermissionsResult& WithAppId(AppIdT&& value) {
  ...
  template <typename PermissionsT = Aws::Vector<PermissionOutput>>
  UpdateQAppPermissionsResult& WithPermissions(PermissionsT&& value) {
    SetPermissions(std::forward<PermissionsT>(value));
    return *this;
  }
  template <typename PermissionsT = PermissionOutput>
  UpdateQAppPermissionsResult& AddPermissions(PermissionsT&& value) {
    m_permissionsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateQAppPermissionsResult& WithRequestId(RequestIdT&& value) {
