...
class UpdateQAppSessionMetadataResult {
 public:
  ...
  template <typename SessionIdT = Aws::String>
  UpdateQAppSessionMetadataResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename SessionArnT = Aws::String>
  UpdateQAppSessionMetadataResult& WithSessionArn(SessionArnT&& value) {
  ...
  template <typename SessionNameT = Aws::String>
  UpdateQAppSessionMetadataResult& WithSessionName(SessionNameT&& value) {
  ...
  template <typename SharingConfigurationT = SessionSharingConfiguration>
  UpdateQAppSessionMetadataResult& WithSharingConfiguration(SharingConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateQAppSessionMetadataResult& WithRequestId(RequestIdT&& value) {
