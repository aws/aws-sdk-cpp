...
class UpdateLibraryItemResult {
 public:
  ...
  inline UpdateLibraryItemResult& WithAppVersion(int value) {
    SetAppVersion(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLibraryItemResult& WithRatingCount(int value) {
  ...
  inline UpdateLibraryItemResult& WithIsRatedByUser(bool value) {
  ...
  inline UpdateLibraryItemResult& WithUserCount(int value) {
    SetUserCount(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLibraryItemResult& WithIsVerified(bool value) {
    SetIsVerified(value);
    return *this;
  }
  ///@}
