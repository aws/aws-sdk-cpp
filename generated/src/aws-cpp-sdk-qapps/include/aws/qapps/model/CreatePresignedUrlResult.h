...
class CreatePresignedUrlResult {
 public:
  ...
  template <typename FileIdT = Aws::String>
  CreatePresignedUrlResult& WithFileId(FileIdT&& value) {
  ...
  template <typename PresignedUrlT = Aws::String>
  CreatePresignedUrlResult& WithPresignedUrl(PresignedUrlT&& value) {
  ...
  void SetPresignedUrlFields(PresignedUrlFieldsT&& value) {
    m_presignedUrlFieldsHasBeenSet = true;
    m_presignedUrlFields = std::forward<PresignedUrlFieldsT>(value);
  }
  template <typename PresignedUrlFieldsT = Aws::Map<Aws::String, Aws::String>>
  CreatePresignedUrlResult& WithPresignedUrlFields(PresignedUrlFieldsT&& value) {
    SetPresignedUrlFields(std::forward<PresignedUrlFieldsT>(value));
    return *this;
  }
  ...
  CreatePresignedUrlResult& AddPresignedUrlFields(PresignedUrlFieldsKeyT&& key, PresignedUrlFieldsValueT&& value) {
    m_presignedUrlFieldsHasBeenSet = true;
    m_presignedUrlFields.emplace(std::forward<PresignedUrlFieldsKeyT>(key), std::forward<PresignedUrlFieldsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPresignedUrlExpiration(PresignedUrlExpirationT&& value) {
    m_presignedUrlExpirationHasBeenSet = true;
    m_presignedUrlExpiration = std::forward<PresignedUrlExpirationT>(value);
  }
  template <typename PresignedUrlExpirationT = Aws::Utils::DateTime>
  CreatePresignedUrlResult& WithPresignedUrlExpiration(PresignedUrlExpirationT&& value) {
    SetPresignedUrlExpiration(std::forward<PresignedUrlExpirationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreatePresignedUrlResult& WithRequestId(RequestIdT&& value) {
