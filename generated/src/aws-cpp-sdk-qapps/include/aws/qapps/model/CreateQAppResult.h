...
class CreateQAppResult {
 public:
  ...
  inline CreateQAppResult& WithAppVersion(int value) {
    SetAppVersion(value);
    return *this;
  }
  ///@}
  ...
  inline CreateQAppResult& WithStatus(AppStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateQAppResult& AddRequiredCapabilities(AppRequiredCapability value) {
    m_requiredCapabilitiesHasBeenSet = true;
