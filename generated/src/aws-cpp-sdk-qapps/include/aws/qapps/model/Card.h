...
class Card {
 public:
  ...
  void SetQQuery(QQueryT&& value) {
    ...
    m_qQuery = std::forward<QQueryT>(value);
  }
  template <typename QQueryT = QQueryCard>
  Card& WithQQuery(QQueryT&& value) {
    SetQQuery(std::forward<QQueryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQPlugin(QPluginT&& value) {
    ...
    m_qPlugin = std::forward<QPluginT>(value);
  }
  template <typename QPluginT = QPluginCard>
  Card& WithQPlugin(QPluginT&& value) {
    SetQPlugin(std::forward<QPluginT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFileUpload(FileUploadT&& value) {
    ...
    m_fileUpload = std::forward<FileUploadT>(value);
  }
  template <typename FileUploadT = FileUploadCard>
  Card& WithFileUpload(FileUploadT&& value) {
    SetFileUpload(std::forward<FileUploadT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFormInput(FormInputT&& value) {
    ...
    m_formInput = std::forward<FormInputT>(value);
  }
  template <typename FormInputT = FormInputCard>
  Card& WithFormInput(FormInputT&& value) {
    SetFormInput(std::forward<FormInputT>(value));
    return *this;
  }
  ///@}
 private:
