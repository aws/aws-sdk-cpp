...
namespace Model
{
  ...
  /**
   */
  class UntagResourceRequest : public QAppsRequest
  {
  public:
    AWS_QAPPS_API UntagResourceRequest() = default;
    ...
    ///@{
    /**
     * <p>The Amazon Resource Name (ARN) of the resource to disassociate the tag
     * from.</p>
     */
