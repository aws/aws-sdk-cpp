...
class AttributeFilter {
 public:
  AWS_QAPPS_API AttributeFilter() = default;
  ...
  template <typename AndAllFiltersT = Aws::Vector<AttributeFilter>>
  AttributeFilter& WithAndAllFilters(AndAllFiltersT&& value) {
    SetAndAllFilters(std::forward<AndAllFiltersT>(value));
    return *this;
  }
  template <typename AndAllFiltersT = AttributeFilter>
  AttributeFilter& AddAndAllFilters(AndAllFiltersT&& value) {
    m_andAllFiltersHasBeenSet = true;
  ...
  void SetOrAllFilters(OrAllFiltersT&& value) {
    m_orAllFiltersHasBeenSet = true;
    m_orAllFilters = std::forward<OrAllFiltersT>(value);
  }
  template <typename OrAllFiltersT = Aws::Vector<AttributeFilter>>
  AttributeFilter& WithOrAllFilters(OrAllFiltersT&& value) {
    SetOrAllFilters(std::forward<OrAllFiltersT>(value));
    return *this;
  }
  template <typename OrAllFiltersT = AttributeFilter>
  AttributeFilter& AddOrAllFilters(OrAllFiltersT&& value) {
    m_orAllFiltersHasBeenSet = true;
    m_orAllFilters.emplace_back(std::forward<OrAllFiltersT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AttributeFilter& GetNotFilter() const { return *m_notFilter; }
  ...
  template <typename NotFilterT = AttributeFilter>
  AttributeFilter& WithNotFilter(NotFilterT&& value) {
    SetNotFilter(std::forward<NotFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEqualsTo(EqualsToT&& value) {
    m_equalsToHasBeenSet = true;
    m_equalsTo = std::forward<EqualsToT>(value);
  }
  template <typename EqualsToT = DocumentAttribute>
  AttributeFilter& WithEqualsTo(EqualsToT&& value) {
    SetEqualsTo(std::forward<EqualsToT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainsAll(ContainsAllT&& value) {
    m_containsAllHasBeenSet = true;
    m_containsAll = std::forward<ContainsAllT>(value);
  }
  template <typename ContainsAllT = DocumentAttribute>
  AttributeFilter& WithContainsAll(ContainsAllT&& value) {
    SetContainsAll(std::forward<ContainsAllT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContainsAny(ContainsAnyT&& value) {
    m_containsAnyHasBeenSet = true;
    m_containsAny = std::forward<ContainsAnyT>(value);
  }
  template <typename ContainsAnyT = DocumentAttribute>
  AttributeFilter& WithContainsAny(ContainsAnyT&& value) {
    SetContainsAny(std::forward<ContainsAnyT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GreaterThanT = DocumentAttribute>
  AttributeFilter& WithGreaterThan(GreaterThanT&& value) {
  ...
  template <typename GreaterThanOrEqualsT = DocumentAttribute>
  AttributeFilter& WithGreaterThanOrEquals(GreaterThanOrEqualsT&& value) {
  ...
  template <typename LessThanT = DocumentAttribute>
  AttributeFilter& WithLessThan(LessThanT&& value) {
  ...
  template <typename LessThanOrEqualsT = DocumentAttribute>
  AttributeFilter& WithLessThanOrEquals(LessThanOrEqualsT&& value) {
