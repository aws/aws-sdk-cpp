...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    AssociateQAppWithUserRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AppIdT = Aws::String>
    AssociateQAppWithUserRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
  private:
