...
class AssociateQAppWithUserRequest : public QAppsRequest {
 public:
  AWS_QAPPS_API AssociateQAppWithUserRequest() = default;
  ...
  template <typename InstanceIdT = Aws::String>
  AssociateQAppWithUserRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AppIdT = Aws::String>
  AssociateQAppWithUserRequest& WithAppId(AppIdT&& value) {
