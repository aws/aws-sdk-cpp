...
class SessionSharingConfiguration {
 public:
  ...
  inline SessionSharingConfiguration& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAcceptResponses(bool value) {
    ...
    m_acceptResponses = value;
  }
  inline SessionSharingConfiguration& WithAcceptResponses(bool value) {
    SetAcceptResponses(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRevealCards(bool value) {
    m_revealCardsHasBeenSet = true;
    m_revealCards = value;
  }
  inline SessionSharingConfiguration& WithRevealCards(bool value) {
    SetRevealCards(value);
    return *this;
  }
  ///@}
 private:
