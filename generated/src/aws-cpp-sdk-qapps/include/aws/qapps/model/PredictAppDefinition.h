...
class PredictAppDefinition {
 public:
  ...
  template <typename TitleT = Aws::String>
  PredictAppDefinition& WithTitle(TitleT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PredictAppDefinition& WithDescription(DescriptionT&& value) {
  ...
  template <typename AppDefinitionT = AppDefinitionInput>
  PredictAppDefinition& WithAppDefinition(AppDefinitionT&& value) {
