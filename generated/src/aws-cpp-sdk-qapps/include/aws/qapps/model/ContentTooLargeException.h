...
class ContentTooLargeException {
 public:
  ...
  template <typename MessageT = Aws::String>
  ContentTooLargeException& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  ContentTooLargeException& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ContentTooLargeException& WithResourceType(ResourceTypeT&& value) {
