...
class BatchCreateCategoryInputCategory {
 public:
  ...
  template <typename IdT = Aws::String>
  BatchCreateCategoryInputCategory& WithId(IdT&& value) {
  ...
  template <typename TitleT = Aws::String>
  BatchCreateCategoryInputCategory& WithTitle(TitleT&& value) {
  ...
  template <typename ColorT = Aws::String>
  BatchCreateCategoryInputCategory& WithColor(ColorT&& value) {
