...
namespace Model
{
  ...
  {
  public:
    AWS_QAPPS_API StopQAppSessionRequest() = default;
    ...
    template<typename InstanceIdT = Aws::String>
    StopQAppSessionRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionIdT = Aws::String>
    StopQAppSessionRequest& WithSessionId(SessionIdT&& value) { SetSessionId(std::forward<SessionIdT>(value)); return *this;}
    ///@}
  private:
