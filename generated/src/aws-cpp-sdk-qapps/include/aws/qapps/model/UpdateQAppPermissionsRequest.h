...
class UpdateQAppPermissionsRequest : public QAppsRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  UpdateQAppPermissionsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename AppIdT = Aws::String>
  UpdateQAppPermissionsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename GrantPermissionsT = Aws::Vector<PermissionInput>>
  UpdateQAppPermissionsRequest& WithGrantPermissions(GrantPermissionsT&& value) {
    SetGrantPermissions(std::forward<GrantPermissionsT>(value));
    return *this;
  }
  template <typename GrantPermissionsT = PermissionInput>
  UpdateQAppPermissionsRequest& AddGrantPermissions(GrantPermissionsT&& value) {
    m_grantPermissionsHasBeenSet = true;
  ...
  template <typename RevokePermissionsT = Aws::Vector<PermissionInput>>
  UpdateQAppPermissionsRequest& WithRevokePermissions(RevokePermissionsT&& value) {
    SetRevokePermissions(std::forward<RevokePermissionsT>(value));
    return *this;
  }
  template <typename RevokePermissionsT = PermissionInput>
  UpdateQAppPermissionsRequest& AddRevokePermissions(RevokePermissionsT&& value) {
    m_revokePermissionsHasBeenSet = true;
