...
class QPluginCard {
 public:
  ...
  inline QPluginCard& WithType(CardType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline QPluginCard& WithPluginType(PluginType value) {
    SetPluginType(value);
    return *this;
  }
  ///@}
  ...
  void SetActionIdentifier(ActionIdentifierT&& value) {
    ...
    m_actionIdentifier = std::forward<ActionIdentifierT>(value);
  }
  template <typename ActionIdentifierT = Aws::String>
  QPluginCard& WithActionIdentifier(ActionIdentifierT&& value) {
    SetActionIdentifier(std::forward<ActionIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
