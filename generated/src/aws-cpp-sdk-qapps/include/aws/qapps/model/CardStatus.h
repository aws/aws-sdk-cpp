...
class CardStatus {
 public:
  ...
  inline void SetCurrentState(ExecutionStatus value) {
    m_currentStateHasBeenSet = true;
    m_currentState = value;
  }
  inline CardStatus& WithCurrentState(ExecutionStatus value) {
  ...
  void SetCurrentValue(CurrentValueT&& value) {
    ...
    m_currentValue = std::forward<CurrentValueT>(value);
  }
  template <typename CurrentValueT = Aws::String>
  CardStatus& WithCurrentValue(CurrentValueT&& value) {
    SetCurrentValue(std::forward<CurrentValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubmissions(SubmissionsT&& value) {
    ...
    m_submissions = std::forward<SubmissionsT>(value);
  }
  template <typename SubmissionsT = Aws::Vector<Submission>>
  CardStatus& WithSubmissions(SubmissionsT&& value) {
    SetSubmissions(std::forward<SubmissionsT>(value));
    return *this;
  }
  template <typename SubmissionsT = Submission>
  CardStatus& AddSubmissions(SubmissionsT&& value) {
    m_submissionsHasBeenSet = true;
    m_submissions.emplace_back(std::forward<SubmissionsT>(value));
    return *this;
  }
  ///@}
 private:
