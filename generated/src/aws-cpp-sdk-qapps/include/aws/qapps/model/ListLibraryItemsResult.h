...
class ListLibraryItemsResult {
 public:
  ...
  void SetLibraryItems(LibraryItemsT&& value) {
    m_libraryItemsHasBeenSet = true;
    m_libraryItems = std::forward<LibraryItemsT>(value);
  }
  template <typename LibraryItemsT = Aws::Vector<LibraryItemMember>>
  ListLibraryItemsResult& WithLibraryItems(LibraryItemsT&& value) {
    SetLibraryItems(std::forward<LibraryItemsT>(value));
    return *this;
  }
  template <typename LibraryItemsT = LibraryItemMember>
  ListLibraryItemsResult& AddLibraryItems(LibraryItemsT&& value) {
    m_libraryItemsHasBeenSet = true;
    m_libraryItems.emplace_back(std::forward<LibraryItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLibraryItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLibraryItemsResult& WithRequestId(RequestIdT&& value) {
