...
class UpdateQAppResult {
 public:
  ...
  inline UpdateQAppResult& WithAppVersion(int value) {
    SetAppVersion(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateQAppResult& WithStatus(AppStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateQAppResult& AddRequiredCapabilities(AppRequiredCapability value) {
    m_requiredCapabilitiesHasBeenSet = true;
