...
class SubmissionMutation {
 public:
  ...
  template <typename SubmissionIdT = Aws::String>
  SubmissionMutation& WithSubmissionId(SubmissionIdT&& value) {
  ...
  inline void SetMutationType(SubmissionMutationKind value) {
    m_mutationTypeHasBeenSet = true;
    m_mutationType = value;
  }
  inline SubmissionMutation& WithMutationType(SubmissionMutationKind value) {
