...
namespace Model
{
  ...
  /**
   * <p>The requested operation could not be completed because too many requests were
   * sent at once. Wait a bit and try again later.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/qapps-2023-11-27/ThrottlingException">AWS
   * API Reference</a></p>
   */
  class ThrottlingException
  {
  public:
    AWS_QAPPS_API ThrottlingException() = default;
    AWS_QAPPS_API ThrottlingException(Aws::Utils::Json::JsonView jsonValue);
    AWS_QAPPS_API ThrottlingException& operator=(Aws::Utils::Json::JsonView jsonValue);
