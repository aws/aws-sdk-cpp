...
class PermissionOutput {
 public:
  ...
  inline void SetAction(PermissionOutputActionEnum value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline PermissionOutput& WithAction(PermissionOutputActionEnum value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrincipalT = PrincipalOutput>
  PermissionOutput& WithPrincipal(PrincipalT&& value) {
