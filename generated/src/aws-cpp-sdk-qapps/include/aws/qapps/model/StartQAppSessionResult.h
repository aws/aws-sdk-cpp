...
class StartQAppSessionResult {
 public:
  ...
  template <typename SessionIdT = Aws::String>
  StartQAppSessionResult& WithSessionId(SessionIdT&& value) {
  ...
  template <typename SessionArnT = Aws::String>
  StartQAppSessionResult& WithSessionArn(SessionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartQAppSessionResult& WithRequestId(RequestIdT&& value) {
