...
namespace DataZone
{
  class AWS_DATAZONE_API DataZoneRequest : public Aws::AmazonSerializableWebServiceRequest
  {
  public:
    using EndpointParameter = Aws::Endpoint::EndpointParameter;
    using EndpointParameters = Aws::Endpoint::EndpointParameters;

    virtual ~DataZoneRequest () {}
  ...
  typedef Aws::AmazonStreamingWebServiceRequest StreamingDataZoneRequest;
