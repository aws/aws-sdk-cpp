...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListPolicyGrantsRequest();
    ...
    inline ListPolicyGrantsRequest& WithDomainIdentifier(const Aws::String& value) { SetDomainIdentifier(value); return *this;}
    inline ListPolicyGrantsRequest& WithDomainIdentifier(Aws::String&& value) { SetDomainIdentifier(std::move(value)); return *this;}
    inline ListPolicyGrantsRequest& WithDomainIdentifier(const char* value) { SetDomainIdentifier(value); return *this;}
    ///@}
    ...
    inline ListPolicyGrantsRequest& WithEntityIdentifier(const Aws::String& value) { SetEntityIdentifier(value); return *this;}
    inline ListPolicyGrantsRequest& WithEntityIdentifier(Aws::String&& value) { SetEntityIdentifier(std::move(value)); return *this;}
    inline ListPolicyGrantsRequest& WithEntityIdentifier(const char* value) { SetEntityIdentifier(value); return *this;}
    ///@}
    ...
    inline ListPolicyGrantsRequest& WithEntityType(const TargetEntityType& value) { SetEntityType(value); return *this;}
    inline ListPolicyGrantsRequest& WithEntityType(TargetEntityType&& value) { SetEntityType(std::move(value)); return *this;}
    ///@}
    ...
    inline ListPolicyGrantsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListPolicyGrantsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListPolicyGrantsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
    ...
    inline ListPolicyGrantsRequest& WithPolicyType(const ManagedPolicyType& value) { SetPolicyType(value); return *this;}
    inline ListPolicyGrantsRequest& WithPolicyType(ManagedPolicyType&& value) { SetPolicyType(std::move(value)); return *this;}
    ///@}
  private:
