...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientTokenT = Aws::String>
    CreateDomainUnitRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateDomainUnitRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdentifierT = Aws::String>
    CreateDomainUnitRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateDomainUnitRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ParentDomainUnitIdentifierT = Aws::String>
    CreateDomainUnitRequest& WithParentDomainUnitIdentifier(ParentDomainUnitIdentifierT&& value) { SetParentDomainUnitIdentifier(std::forward<ParentDomainUnitIdentifierT>(value)); return *this;}
    ///@}
  private:
