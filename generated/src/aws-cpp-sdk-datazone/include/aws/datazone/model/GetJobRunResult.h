...
class GetJobRunResult {
 public:
  ...
  inline GetJobRunResult& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRunMode(JobRunMode value) {
    m_runModeHasBeenSet = true;
    m_runMode = value;
  }
  inline GetJobRunResult& WithRunMode(JobRunMode value) {
    SetRunMode(value);
    return *this;
  }
  ///@}
  ...
  inline GetJobRunResult& WithStatus(JobRunStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
