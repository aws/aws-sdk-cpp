...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListConnectionsResult();
    ...
    inline void SetItems(const Aws::Vector<ConnectionSummary>& value) { m_items = value; }
    inline void SetItems(Aws::Vector<ConnectionSummary>&& value) { m_items = std::move(value); }
    inline ListConnectionsResult& WithItems(const Aws::Vector<ConnectionSummary>& value) { SetItems(value); return *this;}
    inline ListConnectionsResult& WithItems(Aws::Vector<ConnectionSummary>&& value) { SetItems(std::move(value)); return *this;}
    inline ListConnectionsResult& AddItems(const ConnectionSummary& value) { m_items.push_back(value); return *this; }
    inline ListConnectionsResult& AddItems(ConnectionSummary&& value) { m_items.push_back(std::move(value)); return *this; }
    ///@}
