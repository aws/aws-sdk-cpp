...
class RejectSubscriptionRequestResult {
 public:
  ...
  template <typename IdT = Aws::String>
  RejectSubscriptionRequestResult& WithId(IdT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  RejectSubscriptionRequestResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  RejectSubscriptionRequestResult& WithUpdatedBy(UpdatedByT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  RejectSubscriptionRequestResult& WithDomainId(DomainIdT&& value) {
  ...
  inline RejectSubscriptionRequestResult& WithStatus(SubscriptionRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  RejectSubscriptionRequestResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RejectSubscriptionRequestResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestReasonT = Aws::String>
  RejectSubscriptionRequestResult& WithRequestReason(RequestReasonT&& value) {
  ...
  template <typename SubscribedPrincipalsT = Aws::Vector<SubscribedPrincipal>>
  RejectSubscriptionRequestResult& WithSubscribedPrincipals(SubscribedPrincipalsT&& value) {
  ...
  RejectSubscriptionRequestResult& AddSubscribedPrincipals(SubscribedPrincipalsT&& value) {
    m_subscribedPrincipalsHasBeenSet = true;
  ...
  template <typename SubscribedListingsT = Aws::Vector<SubscribedListing>>
  RejectSubscriptionRequestResult& WithSubscribedListings(SubscribedListingsT&& value) {
    SetSubscribedListings(std::forward<SubscribedListingsT>(value));
    return *this;
  }
  template <typename SubscribedListingsT = SubscribedListing>
  RejectSubscriptionRequestResult& AddSubscribedListings(SubscribedListingsT&& value) {
    m_subscribedListingsHasBeenSet = true;
  ...
  template <typename ReviewerIdT = Aws::String>
  RejectSubscriptionRequestResult& WithReviewerId(ReviewerIdT&& value) {
  ...
  template <typename DecisionCommentT = Aws::String>
  RejectSubscriptionRequestResult& WithDecisionComment(DecisionCommentT&& value) {
  ...
  template <typename ExistingSubscriptionIdT = Aws::String>
  RejectSubscriptionRequestResult& WithExistingSubscriptionId(ExistingSubscriptionIdT&& value) {
  ...
  template <typename MetadataFormsT = Aws::Vector<FormOutput>>
  RejectSubscriptionRequestResult& WithMetadataForms(MetadataFormsT&& value) {
    SetMetadataForms(std::forward<MetadataFormsT>(value));
    return *this;
  }
  template <typename MetadataFormsT = FormOutput>
  RejectSubscriptionRequestResult& AddMetadataForms(MetadataFormsT&& value) {
    m_metadataFormsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  RejectSubscriptionRequestResult& WithRequestId(RequestIdT&& value) {
