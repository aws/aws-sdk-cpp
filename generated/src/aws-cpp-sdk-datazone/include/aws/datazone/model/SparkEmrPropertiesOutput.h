...
class SparkEmrPropertiesOutput {
 public:
  ...
  void SetCredentialsExpiration(CredentialsExpirationT&& value) {
    ...
    m_credentialsExpiration = std::forward<CredentialsExpirationT>(value);
  }
  template <typename CredentialsExpirationT = Aws::Utils::DateTime>
  SparkEmrPropertiesOutput& WithCredentialsExpiration(CredentialsExpirationT&& value) {
    SetCredentialsExpiration(std::forward<CredentialsExpirationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetGovernanceType(GovernanceType value) {
    m_governanceTypeHasBeenSet = true;
    m_governanceType = value;
  }
  inline SparkEmrPropertiesOutput& WithGovernanceType(GovernanceType value) {
  ...
  void SetLivyEndpoint(LivyEndpointT&& value) {
    ...
    m_livyEndpoint = std::forward<LivyEndpointT>(value);
  }
  template <typename LivyEndpointT = Aws::String>
  SparkEmrPropertiesOutput& WithLivyEndpoint(LivyEndpointT&& value) {
    SetLivyEndpoint(std::forward<LivyEndpointT>(value));
    return *this;
  }
  ///@}
