...
class ListDataProductRevisionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DataProductRevision>>
  ListDataProductRevisionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DataProductRevision>
  ListDataProductRevisionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataProductRevisionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataProductRevisionsResult& WithRequestId(RequestIdT&& value) {
