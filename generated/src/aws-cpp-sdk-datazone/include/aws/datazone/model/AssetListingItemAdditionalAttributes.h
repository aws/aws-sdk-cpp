...
class AssetListingItemAdditionalAttributes {
 public:
  ...
  template <typename FormsT = Aws::String>
  AssetListingItemAdditionalAttributes& WithForms(FormsT&& value) {
  ...
  template <typename LatestTimeSeriesDataPointFormsT = Aws::Vector<TimeSeriesDataPointSummaryFormOutput>>
  AssetListingItemAdditionalAttributes& WithLatestTimeSeriesDataPointForms(LatestTimeSeriesDataPointFormsT&& value) {
  ...
  AssetListingItemAdditionalAttributes& AddLatestTimeSeriesDataPointForms(LatestTimeSeriesDataPointFormsT&& value) {
    m_latestTimeSeriesDataPointFormsHasBeenSet = true;
