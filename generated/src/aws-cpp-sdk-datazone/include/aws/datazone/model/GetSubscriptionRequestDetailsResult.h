...
class GetSubscriptionRequestDetailsResult {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetSubscriptionRequestDetailsResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename DecisionCommentT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithDecisionComment(DecisionCommentT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename ExistingSubscriptionIdT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithExistingSubscriptionId(ExistingSubscriptionIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithId(IdT&& value) {
  ...
  template <typename MetadataFormsT = Aws::Vector<FormOutput>>
  GetSubscriptionRequestDetailsResult& WithMetadataForms(MetadataFormsT&& value) {
    SetMetadataForms(std::forward<MetadataFormsT>(value));
    return *this;
  }
  template <typename MetadataFormsT = FormOutput>
  GetSubscriptionRequestDetailsResult& AddMetadataForms(MetadataFormsT&& value) {
    m_metadataFormsHasBeenSet = true;
  ...
  template <typename RequestReasonT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithRequestReason(RequestReasonT&& value) {
  ...
  template <typename ReviewerIdT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithReviewerId(ReviewerIdT&& value) {
  ...
  inline GetSubscriptionRequestDetailsResult& WithStatus(SubscriptionRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubscribedListingsT = Aws::Vector<SubscribedListing>>
  GetSubscriptionRequestDetailsResult& WithSubscribedListings(SubscribedListingsT&& value) {
    SetSubscribedListings(std::forward<SubscribedListingsT>(value));
    return *this;
  }
  template <typename SubscribedListingsT = SubscribedListing>
  GetSubscriptionRequestDetailsResult& AddSubscribedListings(SubscribedListingsT&& value) {
    m_subscribedListingsHasBeenSet = true;
  ...
  template <typename SubscribedPrincipalsT = Aws::Vector<SubscribedPrincipal>>
  GetSubscriptionRequestDetailsResult& WithSubscribedPrincipals(SubscribedPrincipalsT&& value) {
  ...
  GetSubscriptionRequestDetailsResult& AddSubscribedPrincipals(SubscribedPrincipalsT&& value) {
    m_subscribedPrincipalsHasBeenSet = true;
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetSubscriptionRequestDetailsResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithUpdatedBy(UpdatedByT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetSubscriptionRequestDetailsResult& WithRequestId(RequestIdT&& value) {
