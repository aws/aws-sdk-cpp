...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API GetSubscriptionRequestDetailsResult() = default;
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetSubscriptionRequestDetailsResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedByT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithCreatedBy(CreatedByT&& value) { SetCreatedBy(std::forward<CreatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename DecisionCommentT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithDecisionComment(DecisionCommentT&& value) { SetDecisionComment(std::forward<DecisionCommentT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ExistingSubscriptionIdT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithExistingSubscriptionId(ExistingSubscriptionIdT&& value) { SetExistingSubscriptionId(std::forward<ExistingSubscriptionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename MetadataFormsT = Aws::Vector<FormOutput>>
    GetSubscriptionRequestDetailsResult& WithMetadataForms(MetadataFormsT&& value) { SetMetadataForms(std::forward<MetadataFormsT>(value)); return *this;}
    template<typename MetadataFormsT = FormOutput>
    GetSubscriptionRequestDetailsResult& AddMetadataForms(MetadataFormsT&& value) { m_metadataFormsHasBeenSet = true; m_metadataForms.emplace_back(std::forward<MetadataFormsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestReasonT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithRequestReason(RequestReasonT&& value) { SetRequestReason(std::forward<RequestReasonT>(value)); return *this;}
    ///@}
    ...
    template<typename ReviewerIdT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithReviewerId(ReviewerIdT&& value) { SetReviewerId(std::forward<ReviewerIdT>(value)); return *this;}
    ///@}
    ...
    inline GetSubscriptionRequestDetailsResult& WithStatus(SubscriptionRequestStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename SubscribedListingsT = Aws::Vector<SubscribedListing>>
    GetSubscriptionRequestDetailsResult& WithSubscribedListings(SubscribedListingsT&& value) { SetSubscribedListings(std::forward<SubscribedListingsT>(value)); return *this;}
    template<typename SubscribedListingsT = SubscribedListing>
    GetSubscriptionRequestDetailsResult& AddSubscribedListings(SubscribedListingsT&& value) { m_subscribedListingsHasBeenSet = true; m_subscribedListings.emplace_back(std::forward<SubscribedListingsT>(value)); return *this; }
    ///@}
    ...
    template<typename SubscribedPrincipalsT = Aws::Vector<SubscribedPrincipal>>
    GetSubscriptionRequestDetailsResult& WithSubscribedPrincipals(SubscribedPrincipalsT&& value) { SetSubscribedPrincipals(std::forward<SubscribedPrincipalsT>(value)); return *this;}
    template<typename SubscribedPrincipalsT = SubscribedPrincipal>
    GetSubscriptionRequestDetailsResult& AddSubscribedPrincipals(SubscribedPrincipalsT&& value) { m_subscribedPrincipalsHasBeenSet = true; m_subscribedPrincipals.emplace_back(std::forward<SubscribedPrincipalsT>(value)); return *this; }
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    GetSubscriptionRequestDetailsResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedByT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithUpdatedBy(UpdatedByT&& value) { SetUpdatedBy(std::forward<UpdatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetSubscriptionRequestDetailsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
