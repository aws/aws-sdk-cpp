...
class CreateProjectFromProjectProfilePolicyGrantDetail {
 public:
  ...
  inline CreateProjectFromProjectProfilePolicyGrantDetail& WithIncludeChildDomainUnits(bool value) {
  ...
  void SetProjectProfiles(ProjectProfilesT&& value) {
    m_projectProfilesHasBeenSet = true;
    m_projectProfiles = std::forward<ProjectProfilesT>(value);
  }
  template <typename ProjectProfilesT = Aws::Vector<Aws::String>>
  CreateProjectFromProjectProfilePolicyGrantDetail& WithProjectProfiles(ProjectProfilesT&& value) {
    SetProjectProfiles(std::forward<ProjectProfilesT>(value));
    return *this;
  }
  template <typename ProjectProfilesT = Aws::String>
  CreateProjectFromProjectProfilePolicyGrantDetail& AddProjectProfiles(ProjectProfilesT&& value) {
    m_projectProfilesHasBeenSet = true;
    m_projectProfiles.emplace_back(std::forward<ProjectProfilesT>(value));
    return *this;
  }
  ///@}
 private:
