...
class CreateDataProductRevisionResult {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateDataProductRevisionResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename FirstRevisionCreatedAtT = Aws::Utils::DateTime>
  CreateDataProductRevisionResult& WithFirstRevisionCreatedAt(FirstRevisionCreatedAtT&& value) {
  ...
  template <typename FirstRevisionCreatedByT = Aws::String>
  CreateDataProductRevisionResult& WithFirstRevisionCreatedBy(FirstRevisionCreatedByT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataProductRevisionResult& WithRequestId(RequestIdT&& value) {
