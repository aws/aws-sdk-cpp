...
namespace Model
{
  ...
  public:
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    PutEnvironmentBlueprintConfigurationResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnabledRegionsT = Aws::Vector<Aws::String>>
    PutEnvironmentBlueprintConfigurationResult& WithEnabledRegions(EnabledRegionsT&& value) { SetEnabledRegions(std::forward<EnabledRegionsT>(value)); return *this;}
    template<typename EnabledRegionsT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& AddEnabledRegions(EnabledRegionsT&& value) { m_enabledRegionsHasBeenSet = true; m_enabledRegions.emplace_back(std::forward<EnabledRegionsT>(value)); return *this; }
    ///@}
    ...
    template<typename EnvironmentBlueprintIdT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithEnvironmentBlueprintId(EnvironmentBlueprintIdT&& value) { SetEnvironmentBlueprintId(std::forward<EnvironmentBlueprintIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentRolePermissionBoundaryT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithEnvironmentRolePermissionBoundary(EnvironmentRolePermissionBoundaryT&& value) { SetEnvironmentRolePermissionBoundary(std::forward<EnvironmentRolePermissionBoundaryT>(value)); return *this;}
    ///@}
    ...
    template<typename ManageAccessRoleArnT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithManageAccessRoleArn(ManageAccessRoleArnT&& value) { SetManageAccessRoleArn(std::forward<ManageAccessRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvisioningConfigurationsT = Aws::Vector<ProvisioningConfiguration>>
    PutEnvironmentBlueprintConfigurationResult& WithProvisioningConfigurations(ProvisioningConfigurationsT&& value) { SetProvisioningConfigurations(std::forward<ProvisioningConfigurationsT>(value)); return *this;}
    template<typename ProvisioningConfigurationsT = ProvisioningConfiguration>
    PutEnvironmentBlueprintConfigurationResult& AddProvisioningConfigurations(ProvisioningConfigurationsT&& value) { m_provisioningConfigurationsHasBeenSet = true; m_provisioningConfigurations.emplace_back(std::forward<ProvisioningConfigurationsT>(value)); return *this; }
    ///@}
    ...
    template<typename ProvisioningRoleArnT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithProvisioningRoleArn(ProvisioningRoleArnT&& value) { SetProvisioningRoleArn(std::forward<ProvisioningRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RegionalParametersT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
    PutEnvironmentBlueprintConfigurationResult& WithRegionalParameters(RegionalParametersT&& value) { SetRegionalParameters(std::forward<RegionalParametersT>(value)); return *this;}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    PutEnvironmentBlueprintConfigurationResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutEnvironmentBlueprintConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
