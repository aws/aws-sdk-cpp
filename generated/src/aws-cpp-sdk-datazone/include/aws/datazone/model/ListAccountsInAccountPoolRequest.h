...
/**
 */
class ListAccountsInAccountPoolRequest : public DataZoneRequest {
 public:
  AWS_DATAZONE_API ListAccountsInAccountPoolRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListAccountsInAccountPool"; }
  ...
  ///@{
  /**
   * <p>The ID of the domain in which the accounts in the specified account pool are
   * to be listed.</p>
   */
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListAccountsInAccountPoolRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListAccountsInAccountPoolRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountsInAccountPoolRequest& WithNextToken(NextTokenT&& value) {
