...
class RevokeSubscriptionResult {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  RevokeSubscriptionResult& WithDomainId(DomainIdT&& value) {
  ...
  inline RevokeSubscriptionResult& WithStatus(SubscriptionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RevokeSubscriptionResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RevokeSubscriptionResult& WithRequestId(RequestIdT&& value) {
