...
class RecommendationConfiguration {
 public:
  ...
  inline void SetEnableBusinessNameGeneration(bool value) {
    m_enableBusinessNameGenerationHasBeenSet = true;
    m_enableBusinessNameGeneration = value;
  }
  inline RecommendationConfiguration& WithEnableBusinessNameGeneration(bool value) {
    SetEnableBusinessNameGeneration(value);
    return *this;
  }
  ///@}
 private:
