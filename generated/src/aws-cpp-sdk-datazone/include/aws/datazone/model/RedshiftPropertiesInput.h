...
class RedshiftPropertiesInput {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  RedshiftPropertiesInput& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename HostT = Aws::String>
  RedshiftPropertiesInput& WithHost(HostT&& value) {
  ...
  inline RedshiftPropertiesInput& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
