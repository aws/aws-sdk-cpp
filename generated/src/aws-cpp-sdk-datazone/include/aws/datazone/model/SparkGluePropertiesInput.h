...
class SparkGluePropertiesInput {
 public:
  ...
  void SetAdditionalArgs(AdditionalArgsT&& value) {
    ...
    m_additionalArgs = std::forward<AdditionalArgsT>(value);
  }
  template <typename AdditionalArgsT = SparkGlueArgs>
  SparkGluePropertiesInput& WithAdditionalArgs(AdditionalArgsT&& value) {
    SetAdditionalArgs(std::forward<AdditionalArgsT>(value));
    return *this;
  }
  ///@}
  ...
  inline SparkGluePropertiesInput& WithIdleTimeout(int value) {
  ...
  inline SparkGluePropertiesInput& WithNumberOfWorkers(int value) {
