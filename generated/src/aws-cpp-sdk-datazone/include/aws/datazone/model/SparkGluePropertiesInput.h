...
namespace Model
{
  ...
  public:
    ...
    template<typename AdditionalArgsT = SparkGlueArgs>
    SparkGluePropertiesInput& WithAdditionalArgs(AdditionalArgsT&& value) { SetAdditionalArgs(std::forward<AdditionalArgsT>(value)); return *this;}
    ///@}
    ...
    template<typename GlueConnectionNameT = Aws::String>
    SparkGluePropertiesInput& WithGlueConnectionName(GlueConnectionNameT&& value) { SetGlueConnectionName(std::forward<GlueConnectionNameT>(value)); return *this;}
    ///@}
    ...
    template<typename GlueVersionT = Aws::String>
    SparkGluePropertiesInput& WithGlueVersion(GlueVersionT&& value) { SetGlueVersion(std::forward<GlueVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename JavaVirtualEnvT = Aws::String>
    SparkGluePropertiesInput& WithJavaVirtualEnv(JavaVirtualEnvT&& value) { SetJavaVirtualEnv(std::forward<JavaVirtualEnvT>(value)); return *this;}
    ///@}
    ...
    template<typename PythonVirtualEnvT = Aws::String>
    SparkGluePropertiesInput& WithPythonVirtualEnv(PythonVirtualEnvT&& value) { SetPythonVirtualEnv(std::forward<PythonVirtualEnvT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkerTypeT = Aws::String>
    SparkGluePropertiesInput& WithWorkerType(WorkerTypeT&& value) { SetWorkerType(std::forward<WorkerTypeT>(value)); return *this;}
    ///@}
  private:
