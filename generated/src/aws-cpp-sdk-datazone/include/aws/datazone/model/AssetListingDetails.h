...
class AssetListingDetails {
 public:
  ...
  template <typename ListingIdT = Aws::String>
  AssetListingDetails& WithListingId(ListingIdT&& value) {
  ...
  inline void SetListingStatus(ListingStatus value) {
    m_listingStatusHasBeenSet = true;
    m_listingStatus = value;
  }
  inline AssetListingDetails& WithListingStatus(ListingStatus value) {
