...
namespace Model
{
  ...
  /**
   */
  class DeleteRuleRequest : public DataZoneRequest
  {
  public:
    AWS_DATAZONE_API DeleteRuleRequest();
    ...
    inline DeleteRuleRequest& WithDomainIdentifier(const Aws::String& value) { SetDomainIdentifier(value); return *this;}
    inline DeleteRuleRequest& WithDomainIdentifier(Aws::String&& value) { SetDomainIdentifier(std::move(value)); return *this;}
    inline DeleteRuleRequest& WithDomainIdentifier(const char* value) { SetDomainIdentifier(value); return *this;}
    ///@}
