...
class GlueRunConfigurationOutput {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  GlueRunConfigurationOutput& WithAccountId(AccountIdT&& value) {
  ...
  template <typename RegionT = Aws::String>
  GlueRunConfigurationOutput& WithRegion(RegionT&& value) {
  ...
  template <typename DataAccessRoleT = Aws::String>
  GlueRunConfigurationOutput& WithDataAccessRole(DataAccessRoleT&& value) {
  ...
  template <typename RelationalFilterConfigurationsT = Aws::Vector<RelationalFilterConfiguration>>
  GlueRunConfigurationOutput& WithRelationalFilterConfigurations(RelationalFilterConfigurationsT&& value) {
  ...
  GlueRunConfigurationOutput& AddRelationalFilterConfigurations(RelationalFilterConfigurationsT&& value) {
    m_relationalFilterConfigurationsHasBeenSet = true;
  ...
  inline GlueRunConfigurationOutput& WithAutoImportDataQualityResult(bool value) {
  ...
  template <typename CatalogNameT = Aws::String>
  GlueRunConfigurationOutput& WithCatalogName(CatalogNameT&& value) {
