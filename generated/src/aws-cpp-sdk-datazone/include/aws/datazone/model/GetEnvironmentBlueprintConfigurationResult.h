...
class GetEnvironmentBlueprintConfigurationResult {
 public:
  ...
  AWS_DATAZONE_API GetEnvironmentBlueprintConfigurationResult& operator=(
  ...
  template <typename DomainIdT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename EnvironmentBlueprintIdT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithEnvironmentBlueprintId(EnvironmentBlueprintIdT&& value) {
  ...
  template <typename ProvisioningRoleArnT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithProvisioningRoleArn(ProvisioningRoleArnT&& value) {
  ...
  template <typename EnvironmentRolePermissionBoundaryT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithEnvironmentRolePermissionBoundary(EnvironmentRolePermissionBoundaryT&& value) {
  ...
  template <typename ManageAccessRoleArnT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithManageAccessRoleArn(ManageAccessRoleArnT&& value) {
  ...
  template <typename EnabledRegionsT = Aws::Vector<Aws::String>>
  GetEnvironmentBlueprintConfigurationResult& WithEnabledRegions(EnabledRegionsT&& value) {
    SetEnabledRegions(std::forward<EnabledRegionsT>(value));
    return *this;
  }
  template <typename EnabledRegionsT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& AddEnabledRegions(EnabledRegionsT&& value) {
    m_enabledRegionsHasBeenSet = true;
  ...
  template <typename RegionalParametersT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::String>>>
  GetEnvironmentBlueprintConfigurationResult& WithRegionalParameters(RegionalParametersT&& value) {
  ...
  inline GetEnvironmentBlueprintConfigurationResult& WithAllowUserProvidedConfigurations(bool value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetEnvironmentBlueprintConfigurationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetEnvironmentBlueprintConfigurationResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename ResourceConfigurationsT = Aws::Vector<ResourceConfiguration>>
  GetEnvironmentBlueprintConfigurationResult& WithResourceConfigurations(ResourceConfigurationsT&& value) {
  ...
  GetEnvironmentBlueprintConfigurationResult& AddResourceConfigurations(ResourceConfigurationsT&& value) {
    m_resourceConfigurationsHasBeenSet = true;
  ...
  template <typename ProvisioningConfigurationsT = Aws::Vector<ProvisioningConfiguration>>
  GetEnvironmentBlueprintConfigurationResult& WithProvisioningConfigurations(ProvisioningConfigurationsT&& value) {
  ...
  GetEnvironmentBlueprintConfigurationResult& AddProvisioningConfigurations(ProvisioningConfigurationsT&& value) {
    m_provisioningConfigurationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetEnvironmentBlueprintConfigurationResult& WithRequestId(RequestIdT&& value) {
