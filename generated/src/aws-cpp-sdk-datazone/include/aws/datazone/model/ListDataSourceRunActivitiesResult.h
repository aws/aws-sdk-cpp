...
class ListDataSourceRunActivitiesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DataSourceRunActivity>>
  ListDataSourceRunActivitiesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DataSourceRunActivity>
  ListDataSourceRunActivitiesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSourceRunActivitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataSourceRunActivitiesResult& WithRequestId(RequestIdT&& value) {
