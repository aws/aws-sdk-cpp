...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListJobRunsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<JobRunSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<JobRunSummary>>
    ListJobRunsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = JobRunSummary>
    ListJobRunsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
