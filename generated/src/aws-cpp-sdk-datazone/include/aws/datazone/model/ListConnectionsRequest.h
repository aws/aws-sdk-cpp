...
class ListConnectionsRequest : public DataZoneRequest {
 public:
  ...
  inline void SetSortBy(SortFieldConnection value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListConnectionsRequest& WithSortBy(SortFieldConnection value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListConnectionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListConnectionsRequest& WithType(ConnectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
