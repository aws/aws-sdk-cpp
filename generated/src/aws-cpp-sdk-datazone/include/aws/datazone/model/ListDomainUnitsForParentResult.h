...
class ListDomainUnitsForParentResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DomainUnitSummary>>
  ListDomainUnitsForParentResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DomainUnitSummary>
  ListDomainUnitsForParentResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainUnitsForParentResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDomainUnitsForParentResult& WithRequestId(RequestIdT&& value) {
