...
class JobRunDetails {
 public:
  ...
  void SetLineageRunDetails(LineageRunDetailsT&& value) {
    m_lineageRunDetailsHasBeenSet = true;
    m_lineageRunDetails = std::forward<LineageRunDetailsT>(value);
  }
  template <typename LineageRunDetailsT = LineageRunDetails>
  JobRunDetails& WithLineageRunDetails(LineageRunDetailsT&& value) {
    SetLineageRunDetails(std::forward<LineageRunDetailsT>(value));
    return *this;
  }
  ///@}
 private:
