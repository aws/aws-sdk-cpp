...
class GetSubscriptionRequestDetailsRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  GetSubscriptionRequestDetailsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  GetSubscriptionRequestDetailsRequest& WithIdentifier(IdentifierT&& value) {
