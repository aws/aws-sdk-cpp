...
class CustomParameter {
 public:
  ...
  void SetFieldType(FieldTypeT&& value) {
    ...
    m_fieldType = std::forward<FieldTypeT>(value);
  }
  template <typename FieldTypeT = Aws::String>
  ...
  inline CustomParameter& WithIsEditable(bool value) {
    SetIsEditable(value);
    return *this;
  }
  ///@}
  ...
  inline CustomParameter& WithIsOptional(bool value) {
    SetIsOptional(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsUpdateSupported(bool value) {
    m_isUpdateSupportedHasBeenSet = true;
    m_isUpdateSupported = value;
  }
  inline CustomParameter& WithIsUpdateSupported(bool value) {
    SetIsUpdateSupported(value);
    return *this;
  }
  ///@}
 private:
