...
/**
 */
class DeleteNotebookRequest : public DataZoneRequest {
 public:
  AWS_DATAZONE_API DeleteNotebookRequest() = default;
  ...
  template <typename DomainIdentifierT = Aws::String>
  DeleteNotebookRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  DeleteNotebookRequest& WithIdentifier(IdentifierT&& value) {
