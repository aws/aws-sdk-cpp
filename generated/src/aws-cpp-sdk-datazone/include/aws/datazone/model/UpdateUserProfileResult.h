...
namespace Model
{
  ...
  public:
    ...
    template<typename DetailsT = UserProfileDetails>
    UpdateUserProfileResult& WithDetails(DetailsT&& value) { SetDetails(std::forward<DetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    UpdateUserProfileResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    UpdateUserProfileResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateUserProfileResult& WithStatus(UserProfileStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    inline UpdateUserProfileResult& WithType(UserProfileType value) { SetType(value); return *this;}
    ///@}
