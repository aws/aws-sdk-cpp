...
class GetUserProfileResult {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  GetUserProfileResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetUserProfileResult& WithId(IdT&& value) {
  ...
  inline GetUserProfileResult& WithStatus(UserProfileStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetUserProfileResult& WithRequestId(RequestIdT&& value) {
