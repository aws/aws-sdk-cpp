...
class SparkEmrPropertiesInput {
 public:
  ...
  template <typename ComputeArnT = Aws::String>
  SparkEmrPropertiesInput& WithComputeArn(ComputeArnT&& value) {
  ...
  template <typename InstanceProfileArnT = Aws::String>
  SparkEmrPropertiesInput& WithInstanceProfileArn(InstanceProfileArnT&& value) {
  ...
  void SetJavaVirtualEnv(JavaVirtualEnvT&& value) {
    ...
    m_javaVirtualEnv = std::forward<JavaVirtualEnvT>(value);
  }
  template <typename JavaVirtualEnvT = Aws::String>
  SparkEmrPropertiesInput& WithJavaVirtualEnv(JavaVirtualEnvT&& value) {
    SetJavaVirtualEnv(std::forward<JavaVirtualEnvT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LogUriT = Aws::String>
  SparkEmrPropertiesInput& WithLogUri(LogUriT&& value) {
  ...
  template <typename ManagedEndpointArnT = Aws::String>
  SparkEmrPropertiesInput& WithManagedEndpointArn(ManagedEndpointArnT&& value) {
  ...
  void SetPythonVirtualEnv(PythonVirtualEnvT&& value) {
    ...
    m_pythonVirtualEnv = std::forward<PythonVirtualEnvT>(value);
  }
  template <typename PythonVirtualEnvT = Aws::String>
  SparkEmrPropertiesInput& WithPythonVirtualEnv(PythonVirtualEnvT&& value) {
    SetPythonVirtualEnv(std::forward<PythonVirtualEnvT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuntimeRole(RuntimeRoleT&& value) {
    ...
    m_runtimeRole = std::forward<RuntimeRoleT>(value);
  }
  template <typename RuntimeRoleT = Aws::String>
  SparkEmrPropertiesInput& WithRuntimeRole(RuntimeRoleT&& value) {
    SetRuntimeRole(std::forward<RuntimeRoleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrustedCertificatesS3Uri(TrustedCertificatesS3UriT&& value) {
    ...
    m_trustedCertificatesS3Uri = std::forward<TrustedCertificatesS3UriT>(value);
  }
  template <typename TrustedCertificatesS3UriT = Aws::String>
  SparkEmrPropertiesInput& WithTrustedCertificatesS3Uri(TrustedCertificatesS3UriT&& value) {
    SetTrustedCertificatesS3Uri(std::forward<TrustedCertificatesS3UriT>(value));
    return *this;
  }
  ///@}
 private:
