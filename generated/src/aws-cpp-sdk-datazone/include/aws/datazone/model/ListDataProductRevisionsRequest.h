...
class ListDataProductRevisionsRequest : public DataZoneRequest {
 public:
  AWS_DATAZONE_API ListDataProductRevisionsRequest() = default;
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListDataProductRevisionsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListDataProductRevisionsRequest& WithIdentifier(IdentifierT&& value) {
  ...
  inline ListDataProductRevisionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataProductRevisionsRequest& WithNextToken(NextTokenT&& value) {
