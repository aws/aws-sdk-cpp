...
class CreateFormTypeRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  CreateFormTypeRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename OwningProjectIdentifierT = Aws::String>
  CreateFormTypeRequest& WithOwningProjectIdentifier(OwningProjectIdentifierT&& value) {
  ...
  inline CreateFormTypeRequest& WithStatus(FormTypeStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
