...
class PhysicalConnectionRequirements {
 public:
  ...
  void SetSubnetIdList(SubnetIdListT&& value) {
    m_subnetIdListHasBeenSet = true;
    m_subnetIdList = std::forward<SubnetIdListT>(value);
  }
  template <typename SubnetIdListT = Aws::Vector<Aws::String>>
  PhysicalConnectionRequirements& WithSubnetIdList(SubnetIdListT&& value) {
    SetSubnetIdList(std::forward<SubnetIdListT>(value));
    return *this;
  }
  template <typename SubnetIdListT = Aws::String>
  PhysicalConnectionRequirements& AddSubnetIdList(SubnetIdListT&& value) {
    m_subnetIdListHasBeenSet = true;
    m_subnetIdList.emplace_back(std::forward<SubnetIdListT>(value));
    return *this;
  }
  ///@}
