...
class ListProjectProfilesRequest : public DataZoneRequest {
 public:
  ...
  inline ListProjectProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListProjectProfilesRequest& WithSortBy(SortFieldProject value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListProjectProfilesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
