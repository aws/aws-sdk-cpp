...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainIdentifierT = Aws::String>
    ListProjectProfilesRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ListProjectProfilesRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListProjectProfilesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListProjectProfilesRequest& WithSortBy(SortFieldProject value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline ListProjectProfilesRequest& WithSortOrder(SortOrder value) { SetSortOrder(value); return *this;}
    ///@}
  private:
