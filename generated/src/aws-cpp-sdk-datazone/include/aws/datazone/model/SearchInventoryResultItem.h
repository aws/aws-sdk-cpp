...
class SearchInventoryResultItem {
 public:
  ...
  void SetGlossaryItem(GlossaryItemT&& value) {
    m_glossaryItemHasBeenSet = true;
    m_glossaryItem = std::forward<GlossaryItemT>(value);
  }
  template <typename GlossaryItemT = GlossaryItem>
  SearchInventoryResultItem& WithGlossaryItem(GlossaryItemT&& value) {
    SetGlossaryItem(std::forward<GlossaryItemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGlossaryTermItem(GlossaryTermItemT&& value) {
    m_glossaryTermItemHasBeenSet = true;
    m_glossaryTermItem = std::forward<GlossaryTermItemT>(value);
  }
  template <typename GlossaryTermItemT = GlossaryTermItem>
  SearchInventoryResultItem& WithGlossaryTermItem(GlossaryTermItemT&& value) {
    SetGlossaryTermItem(std::forward<GlossaryTermItemT>(value));
    return *this;
  }
  ///@}
