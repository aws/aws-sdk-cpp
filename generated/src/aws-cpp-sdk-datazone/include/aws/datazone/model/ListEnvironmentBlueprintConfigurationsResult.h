...
class ListEnvironmentBlueprintConfigurationsResult {
 public:
  ...
  AWS_DATAZONE_API ListEnvironmentBlueprintConfigurationsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<EnvironmentBlueprintConfigurationItem>>
  ListEnvironmentBlueprintConfigurationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EnvironmentBlueprintConfigurationItem>
  ListEnvironmentBlueprintConfigurationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentBlueprintConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentBlueprintConfigurationsResult& WithRequestId(RequestIdT&& value) {
