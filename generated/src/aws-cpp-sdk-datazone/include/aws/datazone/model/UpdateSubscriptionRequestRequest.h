...
class UpdateSubscriptionRequestRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  UpdateSubscriptionRequestRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  UpdateSubscriptionRequestRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename RequestReasonT = Aws::String>
  UpdateSubscriptionRequestRequest& WithRequestReason(RequestReasonT&& value) {
