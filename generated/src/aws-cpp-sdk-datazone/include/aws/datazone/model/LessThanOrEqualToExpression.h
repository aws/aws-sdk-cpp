...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API LessThanOrEqualToExpression() = default;
    ...
    template<typename ColumnNameT = Aws::String>
    LessThanOrEqualToExpression& WithColumnName(ColumnNameT&& value) { SetColumnName(std::forward<ColumnNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    LessThanOrEqualToExpression& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
