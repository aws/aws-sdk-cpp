...
class ListPolicyGrantsResult {
 public:
  ...
  void SetGrantList(GrantListT&& value) {
    m_grantListHasBeenSet = true;
    m_grantList = std::forward<GrantListT>(value);
  }
  template <typename GrantListT = Aws::Vector<PolicyGrantMember>>
  ListPolicyGrantsResult& WithGrantList(GrantListT&& value) {
    SetGrantList(std::forward<GrantListT>(value));
    return *this;
  }
  template <typename GrantListT = PolicyGrantMember>
  ListPolicyGrantsResult& AddGrantList(GrantListT&& value) {
    m_grantListHasBeenSet = true;
    m_grantList.emplace_back(std::forward<GrantListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPolicyGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPolicyGrantsResult& WithRequestId(RequestIdT&& value) {
