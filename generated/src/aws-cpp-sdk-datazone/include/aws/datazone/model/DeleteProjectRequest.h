...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainIdentifierT = Aws::String>
    DeleteProjectRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentifierT = Aws::String>
    DeleteProjectRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
