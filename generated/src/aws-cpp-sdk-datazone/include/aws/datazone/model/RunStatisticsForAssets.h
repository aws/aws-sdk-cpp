...
class RunStatisticsForAssets {
 public:
  ...
  inline void SetAdded(int value) {
    m_addedHasBeenSet = true;
    m_added = value;
  }
  inline RunStatisticsForAssets& WithAdded(int value) {
    SetAdded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnchanged(int value) {
    m_unchangedHasBeenSet = true;
    m_unchanged = value;
  }
  inline RunStatisticsForAssets& WithUnchanged(int value) {
    SetUnchanged(value);
    return *this;
  }
  ///@}
