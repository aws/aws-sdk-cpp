...
class CreateEnvironmentActionResult {
 public:
  ...
  template <typename DomainIdT = Aws::String>
  CreateEnvironmentActionResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename EnvironmentIdT = Aws::String>
  CreateEnvironmentActionResult& WithEnvironmentId(EnvironmentIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateEnvironmentActionResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateEnvironmentActionResult& WithName(NameT&& value) {
  ...
  template <typename ParametersT = ActionParameters>
  CreateEnvironmentActionResult& WithParameters(ParametersT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateEnvironmentActionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEnvironmentActionResult& WithRequestId(RequestIdT&& value) {
