...
class CreateAssetFilterResult {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateAssetFilterResult& WithId(IdT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  CreateAssetFilterResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  CreateAssetFilterResult& WithAssetId(AssetIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateAssetFilterResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateAssetFilterResult& WithDescription(DescriptionT&& value) {
  ...
  inline CreateAssetFilterResult& WithStatus(FilterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConfigurationT = AssetFilterConfiguration>
  CreateAssetFilterResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateAssetFilterResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  CreateAssetFilterResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename EffectiveColumnNamesT = Aws::Vector<Aws::String>>
  CreateAssetFilterResult& WithEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    SetEffectiveColumnNames(std::forward<EffectiveColumnNamesT>(value));
    return *this;
  }
  template <typename EffectiveColumnNamesT = Aws::String>
  CreateAssetFilterResult& AddEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    m_effectiveColumnNamesHasBeenSet = true;
  ...
  template <typename EffectiveRowFilterT = Aws::String>
  CreateAssetFilterResult& WithEffectiveRowFilter(EffectiveRowFilterT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAssetFilterResult& WithRequestId(RequestIdT&& value) {
