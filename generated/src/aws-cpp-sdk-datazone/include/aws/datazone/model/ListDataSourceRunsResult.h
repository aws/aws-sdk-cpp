...
class ListDataSourceRunsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<DataSourceRunSummary>>
  ListDataSourceRunsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = DataSourceRunSummary>
  ListDataSourceRunsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSourceRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataSourceRunsResult& WithRequestId(RequestIdT&& value) {
