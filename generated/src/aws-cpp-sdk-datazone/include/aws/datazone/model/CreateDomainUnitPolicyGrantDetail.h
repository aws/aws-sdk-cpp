...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/CreateDomainUnitPolicyGrantDetail">AWS
   * API Reference</a></p>
   */
  class CreateDomainUnitPolicyGrantDetail
  {
  public:
    AWS_DATAZONE_API CreateDomainUnitPolicyGrantDetail() = default;
    AWS_DATAZONE_API CreateDomainUnitPolicyGrantDetail(Aws::Utils::Json::JsonView jsonValue);
    AWS_DATAZONE_API CreateDomainUnitPolicyGrantDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    inline CreateDomainUnitPolicyGrantDetail& WithIncludeChildDomainUnits(bool value) { SetIncludeChildDomainUnits(value); return *this;}
    ///@}
  private:
