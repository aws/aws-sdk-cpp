...
class CreateGroupProfileResult {
 public:
  ...
  inline CreateGroupProfileResult& WithStatus(GroupProfileStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RolePrincipalArnT = Aws::String>
  CreateGroupProfileResult& WithRolePrincipalArn(RolePrincipalArnT&& value) {
  ...
  template <typename RolePrincipalIdT = Aws::String>
  CreateGroupProfileResult& WithRolePrincipalId(RolePrincipalIdT&& value) {
