...
class RelationalFilterConfiguration {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  RelationalFilterConfiguration& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename FilterExpressionsT = Aws::Vector<FilterExpression>>
  RelationalFilterConfiguration& WithFilterExpressions(FilterExpressionsT&& value) {
    SetFilterExpressions(std::forward<FilterExpressionsT>(value));
    return *this;
  }
  template <typename FilterExpressionsT = FilterExpression>
  RelationalFilterConfiguration& AddFilterExpressions(FilterExpressionsT&& value) {
    m_filterExpressionsHasBeenSet = true;
    m_filterExpressions.emplace_back(std::forward<FilterExpressionsT>(value));
    return *this;
  }
  ///@}
