...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API CancelMetadataGenerationRunRequest();
     ...
     * <p>The ID of the metadata generation run.</p>
     */
    inline CancelMetadataGenerationRunRequest& WithIdentifier(const char* value) { SetIdentifier(value); return *this;}
