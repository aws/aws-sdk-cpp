...
class SingleSignOn {
 public:
  ...
  inline void SetType(AuthType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SingleSignOn& WithType(AuthType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUserAssignment(UserAssignment value) {
    m_userAssignmentHasBeenSet = true;
    m_userAssignment = value;
  }
  inline SingleSignOn& WithUserAssignment(UserAssignment value) {
