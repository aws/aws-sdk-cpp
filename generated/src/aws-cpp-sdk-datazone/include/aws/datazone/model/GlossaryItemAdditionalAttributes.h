...
namespace Model
{
  ...
  /**
   * <p>The additional attributes of an Amazon DataZone glossary.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GlossaryItemAdditionalAttributes">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename MatchRationaleT = Aws::Vector<MatchRationaleItem>>
    GlossaryItemAdditionalAttributes& WithMatchRationale(MatchRationaleT&& value) { SetMatchRationale(std::forward<MatchRationaleT>(value)); return *this;}
    template<typename MatchRationaleT = MatchRationaleItem>
    GlossaryItemAdditionalAttributes& AddMatchRationale(MatchRationaleT&& value) { m_matchRationaleHasBeenSet = true; m_matchRationale.emplace_back(std::forward<MatchRationaleT>(value)); return *this; }
    ///@}
  private:
