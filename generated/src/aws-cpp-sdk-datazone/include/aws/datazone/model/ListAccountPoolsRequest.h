...
class ListAccountPoolsRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListAccountPoolsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  inline void SetSortBy(SortFieldAccountPool value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListAccountPoolsRequest& WithSortBy(SortFieldAccountPool value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListAccountPoolsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
