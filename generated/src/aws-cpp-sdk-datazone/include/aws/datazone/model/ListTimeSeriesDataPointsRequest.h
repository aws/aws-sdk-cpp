...
class ListTimeSeriesDataPointsRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListTimeSeriesDataPointsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename EntityIdentifierT = Aws::String>
  ListTimeSeriesDataPointsRequest& WithEntityIdentifier(EntityIdentifierT&& value) {
  ...
  inline ListTimeSeriesDataPointsRequest& WithEntityType(TimeSeriesEntityType value) {
    SetEntityType(value);
    return *this;
  }
  ///@}
  ...
  template <typename FormNameT = Aws::String>
  ListTimeSeriesDataPointsRequest& WithFormName(FormNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTimeSeriesDataPointsRequest& WithNextToken(NextTokenT&& value) {
