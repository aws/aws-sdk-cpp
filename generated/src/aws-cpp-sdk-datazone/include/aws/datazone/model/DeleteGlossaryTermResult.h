...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API DeleteGlossaryTermResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteGlossaryTermResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
