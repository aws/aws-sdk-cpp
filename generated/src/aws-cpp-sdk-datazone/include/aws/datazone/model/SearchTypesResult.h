...
class SearchTypesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SearchTypesResultItem>>
  SearchTypesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SearchTypesResultItem>
  SearchTypesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchTypesResult& WithTotalMatchCount(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchTypesResult& WithRequestId(RequestIdT&& value) {
