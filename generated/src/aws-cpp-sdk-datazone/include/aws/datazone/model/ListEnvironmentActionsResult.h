...
class ListEnvironmentActionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<EnvironmentActionSummary>>
  ListEnvironmentActionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EnvironmentActionSummary>
  ListEnvironmentActionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentActionsResult& WithRequestId(RequestIdT&& value) {
