...
class DeleteDataSourceRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  DeleteDataSourceRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  DeleteDataSourceRequest& WithIdentifier(IdentifierT&& value) {
  ...
  inline DeleteDataSourceRequest& WithRetainPermissionsOnRevokeFailure(bool value) {
