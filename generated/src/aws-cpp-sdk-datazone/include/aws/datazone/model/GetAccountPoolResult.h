...
namespace Model
{
  ...
  public:
    ...
    template<typename AccountSourceT = AccountSource>
    GetAccountPoolResult& WithAccountSource(AccountSourceT&& value) { SetAccountSource(std::forward<AccountSourceT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetAccountPoolResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedByT = Aws::String>
    GetAccountPoolResult& WithCreatedBy(CreatedByT&& value) { SetCreatedBy(std::forward<CreatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    GetAccountPoolResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    GetAccountPoolResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainUnitIdT = Aws::String>
    GetAccountPoolResult& WithDomainUnitId(DomainUnitIdT&& value) { SetDomainUnitId(std::forward<DomainUnitIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetAccountPoolResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    GetAccountPoolResult& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetAccountPoolResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline GetAccountPoolResult& WithResolutionStrategy(ResolutionStrategy value) { SetResolutionStrategy(value); return *this;}
    ///@}
    ...
    template<typename UpdatedByT = Aws::String>
    GetAccountPoolResult& WithUpdatedBy(UpdatedByT&& value) { SetUpdatedBy(std::forward<UpdatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetAccountPoolResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
