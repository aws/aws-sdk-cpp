...
class CreateDomainUnitResult {
 public:
  ...
  void SetAncestorDomainUnitIds(AncestorDomainUnitIdsT&& value) {
    ...
    m_ancestorDomainUnitIds = std::forward<AncestorDomainUnitIdsT>(value);
  }
  template <typename AncestorDomainUnitIdsT = Aws::Vector<Aws::String>>
  CreateDomainUnitResult& WithAncestorDomainUnitIds(AncestorDomainUnitIdsT&& value) {
    SetAncestorDomainUnitIds(std::forward<AncestorDomainUnitIdsT>(value));
    return *this;
  }
  ...
  CreateDomainUnitResult& AddAncestorDomainUnitIds(AncestorDomainUnitIdsT&& value) {
    m_ancestorDomainUnitIdsHasBeenSet = true;
    m_ancestorDomainUnitIds.emplace_back(std::forward<AncestorDomainUnitIdsT>(value));
    return *this;
  }
  ///@}
