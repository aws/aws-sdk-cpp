...
class UpdateSubscriptionRequestResult {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateSubscriptionRequestResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  UpdateSubscriptionRequestResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename DecisionCommentT = Aws::String>
  UpdateSubscriptionRequestResult& WithDecisionComment(DecisionCommentT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  UpdateSubscriptionRequestResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename ExistingSubscriptionIdT = Aws::String>
  UpdateSubscriptionRequestResult& WithExistingSubscriptionId(ExistingSubscriptionIdT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateSubscriptionRequestResult& WithId(IdT&& value) {
  ...
  template <typename MetadataFormsT = Aws::Vector<FormOutput>>
  UpdateSubscriptionRequestResult& WithMetadataForms(MetadataFormsT&& value) {
    SetMetadataForms(std::forward<MetadataFormsT>(value));
    return *this;
  }
  template <typename MetadataFormsT = FormOutput>
  UpdateSubscriptionRequestResult& AddMetadataForms(MetadataFormsT&& value) {
    m_metadataFormsHasBeenSet = true;
  ...
  template <typename RequestReasonT = Aws::String>
  UpdateSubscriptionRequestResult& WithRequestReason(RequestReasonT&& value) {
  ...
  template <typename ReviewerIdT = Aws::String>
  UpdateSubscriptionRequestResult& WithReviewerId(ReviewerIdT&& value) {
  ...
  inline UpdateSubscriptionRequestResult& WithStatus(SubscriptionRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubscribedListingsT = Aws::Vector<SubscribedListing>>
  UpdateSubscriptionRequestResult& WithSubscribedListings(SubscribedListingsT&& value) {
    SetSubscribedListings(std::forward<SubscribedListingsT>(value));
    return *this;
  }
  template <typename SubscribedListingsT = SubscribedListing>
  UpdateSubscriptionRequestResult& AddSubscribedListings(SubscribedListingsT&& value) {
    m_subscribedListingsHasBeenSet = true;
  ...
  template <typename SubscribedPrincipalsT = Aws::Vector<SubscribedPrincipal>>
  UpdateSubscriptionRequestResult& WithSubscribedPrincipals(SubscribedPrincipalsT&& value) {
  ...
  UpdateSubscriptionRequestResult& AddSubscribedPrincipals(SubscribedPrincipalsT&& value) {
    m_subscribedPrincipalsHasBeenSet = true;
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  UpdateSubscriptionRequestResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  UpdateSubscriptionRequestResult& WithUpdatedBy(UpdatedByT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSubscriptionRequestResult& WithRequestId(RequestIdT&& value) {
