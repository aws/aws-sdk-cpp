...
class RedshiftStorage {
 public:
  ...
  void SetRedshiftClusterSource(RedshiftClusterSourceT&& value) {
    ...
    m_redshiftClusterSource = std::forward<RedshiftClusterSourceT>(value);
  }
  template <typename RedshiftClusterSourceT = RedshiftClusterStorage>
  RedshiftStorage& WithRedshiftClusterSource(RedshiftClusterSourceT&& value) {
    SetRedshiftClusterSource(std::forward<RedshiftClusterSourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftServerlessSource(RedshiftServerlessSourceT&& value) {
    ...
    m_redshiftServerlessSource = std::forward<RedshiftServerlessSourceT>(value);
  }
  template <typename RedshiftServerlessSourceT = RedshiftServerlessStorage>
  RedshiftStorage& WithRedshiftServerlessSource(RedshiftServerlessSourceT&& value) {
    SetRedshiftServerlessSource(std::forward<RedshiftServerlessSourceT>(value));
    return *this;
  }
  ///@}
 private:
