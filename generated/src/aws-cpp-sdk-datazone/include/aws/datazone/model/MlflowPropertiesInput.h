...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/MlflowPropertiesInput">AWS
   * API Reference</a></p>
   */
  class MlflowPropertiesInput
  {
  public:
    AWS_DATAZONE_API MlflowPropertiesInput() = default;
    AWS_DATAZONE_API MlflowPropertiesInput(Aws::Utils::Json::JsonView jsonValue);
    AWS_DATAZONE_API MlflowPropertiesInput& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename TrackingServerArnT = Aws::String>
    MlflowPropertiesInput& WithTrackingServerArn(TrackingServerArnT&& value) { SetTrackingServerArn(std::forward<TrackingServerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename TrackingServerNameT = Aws::String>
    MlflowPropertiesInput& WithTrackingServerName(TrackingServerNameT&& value) { SetTrackingServerName(std::forward<TrackingServerNameT>(value)); return *this;}
    ///@}
  private:
