...
class DomainUnitPolicyGrantPrincipal {
 public:
  ...
  inline void SetDomainUnitDesignation(DomainUnitDesignation value) {
    m_domainUnitDesignationHasBeenSet = true;
    m_domainUnitDesignation = value;
  }
  inline DomainUnitPolicyGrantPrincipal& WithDomainUnitDesignation(DomainUnitDesignation value) {
    SetDomainUnitDesignation(value);
    return *this;
  }
  ///@}
