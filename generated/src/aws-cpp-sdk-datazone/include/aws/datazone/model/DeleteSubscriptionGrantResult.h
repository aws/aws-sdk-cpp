...
namespace Model
{
  ...
  public:
    ...
    template<typename AssetsT = Aws::Vector<SubscribedAsset>>
    DeleteSubscriptionGrantResult& WithAssets(AssetsT&& value) { SetAssets(std::forward<AssetsT>(value)); return *this;}
    template<typename AssetsT = SubscribedAsset>
    DeleteSubscriptionGrantResult& AddAssets(AssetsT&& value) { m_assetsHasBeenSet = true; m_assets.emplace_back(std::forward<AssetsT>(value)); return *this; }
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    DeleteSubscriptionGrantResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedByT = Aws::String>
    DeleteSubscriptionGrantResult& WithCreatedBy(CreatedByT&& value) { SetCreatedBy(std::forward<CreatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    DeleteSubscriptionGrantResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GrantedEntityT = GrantedEntity>
    DeleteSubscriptionGrantResult& WithGrantedEntity(GrantedEntityT&& value) { SetGrantedEntity(std::forward<GrantedEntityT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DeleteSubscriptionGrantResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteSubscriptionGrantResult& WithStatus(SubscriptionGrantOverallStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename SubscriptionTargetIdT = Aws::String>
    DeleteSubscriptionGrantResult& WithSubscriptionTargetId(SubscriptionTargetIdT&& value) { SetSubscriptionTargetId(std::forward<SubscriptionTargetIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    DeleteSubscriptionGrantResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedByT = Aws::String>
    DeleteSubscriptionGrantResult& WithUpdatedBy(UpdatedByT&& value) { SetUpdatedBy(std::forward<UpdatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteSubscriptionGrantResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
