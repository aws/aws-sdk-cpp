...
class ListAssetRevisionsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<AssetRevision>>
  ListAssetRevisionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AssetRevision>
  ListAssetRevisionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetRevisionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetRevisionsResult& WithRequestId(RequestIdT&& value) {
