...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListTimeSeriesDataPointsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<TimeSeriesDataPointSummaryFormOutput>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<TimeSeriesDataPointSummaryFormOutput>>
    ListTimeSeriesDataPointsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = TimeSeriesDataPointSummaryFormOutput>
    ListTimeSeriesDataPointsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTimeSeriesDataPointsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListTimeSeriesDataPointsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
