...
class ListTimeSeriesDataPointsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<TimeSeriesDataPointSummaryFormOutput>>
  ListTimeSeriesDataPointsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = TimeSeriesDataPointSummaryFormOutput>
  ListTimeSeriesDataPointsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTimeSeriesDataPointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTimeSeriesDataPointsResult& WithRequestId(RequestIdT&& value) {
