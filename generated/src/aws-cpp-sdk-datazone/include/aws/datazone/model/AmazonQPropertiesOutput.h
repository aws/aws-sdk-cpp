...
namespace Model
{
  ...
  public:
    ...
    template<typename AuthModeT = Aws::String>
    AmazonQPropertiesOutput& WithAuthMode(AuthModeT&& value) { SetAuthMode(std::forward<AuthModeT>(value)); return *this;}
    ///@}
    ...
    inline AmazonQPropertiesOutput& WithIsEnabled(bool value) { SetIsEnabled(value); return *this;}
    ///@}
    ...
    template<typename ProfileArnT = Aws::String>
    AmazonQPropertiesOutput& WithProfileArn(ProfileArnT&& value) { SetProfileArn(std::forward<ProfileArnT>(value)); return *this;}
    ///@}
  private:
