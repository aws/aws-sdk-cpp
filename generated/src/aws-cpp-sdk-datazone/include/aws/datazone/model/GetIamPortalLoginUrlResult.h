...
class GetIamPortalLoginUrlResult {
 public:
  ...
  void SetAuthCodeUrl(AuthCodeUrlT&& value) {
    ...
    m_authCodeUrl = std::forward<AuthCodeUrlT>(value);
  }
  template <typename AuthCodeUrlT = Aws::String>
  GetIamPortalLoginUrlResult& WithAuthCodeUrl(AuthCodeUrlT&& value) {
    SetAuthCodeUrl(std::forward<AuthCodeUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserProfileId(UserProfileIdT&& value) {
    m_userProfileIdHasBeenSet = true;
    m_userProfileId = std::forward<UserProfileIdT>(value);
  }
  template <typename UserProfileIdT = Aws::String>
  GetIamPortalLoginUrlResult& WithUserProfileId(UserProfileIdT&& value) {
    SetUserProfileId(std::forward<UserProfileIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetIamPortalLoginUrlResult& WithRequestId(RequestIdT&& value) {
