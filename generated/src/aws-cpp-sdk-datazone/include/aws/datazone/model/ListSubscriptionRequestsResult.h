...
class ListSubscriptionRequestsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SubscriptionRequestSummary>>
  ListSubscriptionRequestsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SubscriptionRequestSummary>
  ListSubscriptionRequestsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionRequestsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscriptionRequestsResult& WithRequestId(RequestIdT&& value) {
