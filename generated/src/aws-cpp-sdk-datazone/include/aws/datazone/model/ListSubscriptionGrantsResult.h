...
class ListSubscriptionGrantsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SubscriptionGrantSummary>>
  ListSubscriptionGrantsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SubscriptionGrantSummary>
  ListSubscriptionGrantsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionGrantsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscriptionGrantsResult& WithRequestId(RequestIdT&& value) {
