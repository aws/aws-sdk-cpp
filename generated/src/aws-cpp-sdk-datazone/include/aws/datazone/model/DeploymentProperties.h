...
class DeploymentProperties {
 public:
  ...
  inline void SetEndTimeoutMinutes(int value) {
    m_endTimeoutMinutesHasBeenSet = true;
    m_endTimeoutMinutes = value;
  }
  inline DeploymentProperties& WithEndTimeoutMinutes(int value) {
    SetEndTimeoutMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStartTimeoutMinutes(int value) {
    m_startTimeoutMinutesHasBeenSet = true;
    m_startTimeoutMinutes = value;
  }
  inline DeploymentProperties& WithStartTimeoutMinutes(int value) {
    SetStartTimeoutMinutes(value);
    return *this;
  }
  ///@}
 private:
