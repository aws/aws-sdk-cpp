...
class SearchGroupProfilesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<GroupProfileSummary>>
  SearchGroupProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = GroupProfileSummary>
  SearchGroupProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchGroupProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchGroupProfilesResult& WithRequestId(RequestIdT&& value) {
