...
class MetadataFormEnforcementDetail {
 public:
  ...
  void SetRequiredMetadataForms(RequiredMetadataFormsT&& value) {
    m_requiredMetadataFormsHasBeenSet = true;
    m_requiredMetadataForms = std::forward<RequiredMetadataFormsT>(value);
  }
  template <typename RequiredMetadataFormsT = Aws::Vector<MetadataFormReference>>
  MetadataFormEnforcementDetail& WithRequiredMetadataForms(RequiredMetadataFormsT&& value) {
    SetRequiredMetadataForms(std::forward<RequiredMetadataFormsT>(value));
    return *this;
  }
  template <typename RequiredMetadataFormsT = MetadataFormReference>
  MetadataFormEnforcementDetail& AddRequiredMetadataForms(RequiredMetadataFormsT&& value) {
    m_requiredMetadataFormsHasBeenSet = true;
    m_requiredMetadataForms.emplace_back(std::forward<RequiredMetadataFormsT>(value));
    return *this;
  }
  ///@}
 private:
