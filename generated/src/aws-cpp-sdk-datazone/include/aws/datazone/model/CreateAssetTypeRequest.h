...
namespace Model
{
  ...
  public:
    ...
    template<typename DescriptionT = Aws::String>
    CreateAssetTypeRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdentifierT = Aws::String>
    CreateAssetTypeRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename FormsInputT = Aws::Map<Aws::String, FormEntryInput>>
    CreateAssetTypeRequest& WithFormsInput(FormsInputT&& value) { SetFormsInput(std::forward<FormsInputT>(value)); return *this;}
    ...
    CreateAssetTypeRequest& AddFormsInput(FormsInputKeyT&& key, FormsInputValueT&& value) {
      m_formsInputHasBeenSet = true; m_formsInput.emplace(std::forward<FormsInputKeyT>(key), std::forward<FormsInputValueT>(value)); return *this;
    }
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateAssetTypeRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename OwningProjectIdentifierT = Aws::String>
    CreateAssetTypeRequest& WithOwningProjectIdentifier(OwningProjectIdentifierT&& value) { SetOwningProjectIdentifier(std::forward<OwningProjectIdentifierT>(value)); return *this;}
    ///@}
  private:
