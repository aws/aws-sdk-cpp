...
class SubscribedListingItem {
 public:
  ...
  void SetAssetListing(AssetListingT&& value) {
    ...
    m_assetListing = std::forward<AssetListingT>(value);
  }
  template <typename AssetListingT = SubscribedAssetListing>
  SubscribedListingItem& WithAssetListing(AssetListingT&& value) {
    SetAssetListing(std::forward<AssetListingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProductListing(ProductListingT&& value) {
    m_productListingHasBeenSet = true;
    m_productListing = std::forward<ProductListingT>(value);
  }
  template <typename ProductListingT = SubscribedProductListing>
  SubscribedListingItem& WithProductListing(ProductListingT&& value) {
    SetProductListing(std::forward<ProductListingT>(value));
    return *this;
  }
  ///@}
 private:
