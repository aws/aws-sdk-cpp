...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API RemoveEntityOwnerResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RemoveEntityOwnerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
