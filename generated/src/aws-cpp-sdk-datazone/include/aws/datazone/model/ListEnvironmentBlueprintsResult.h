...
class ListEnvironmentBlueprintsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<EnvironmentBlueprintSummary>>
  ListEnvironmentBlueprintsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EnvironmentBlueprintSummary>
  ListEnvironmentBlueprintsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentBlueprintsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentBlueprintsResult& WithRequestId(RequestIdT&& value) {
