...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API DeleteProjectProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProjectProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
