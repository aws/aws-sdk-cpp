...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API DeleteGlossaryResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteGlossaryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
