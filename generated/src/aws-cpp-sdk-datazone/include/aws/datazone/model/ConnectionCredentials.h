...
class ConnectionCredentials {
 public:
  AWS_DATAZONE_API ConnectionCredentials() = default;
  ...
  template <typename AccessKeyIdT = Aws::String>
  ConnectionCredentials& WithAccessKeyId(AccessKeyIdT&& value) {
  ...
  template <typename SecretAccessKeyT = Aws::String>
  ConnectionCredentials& WithSecretAccessKey(SecretAccessKeyT&& value) {
  ...
  template <typename SessionTokenT = Aws::String>
  ConnectionCredentials& WithSessionToken(SessionTokenT&& value) {
