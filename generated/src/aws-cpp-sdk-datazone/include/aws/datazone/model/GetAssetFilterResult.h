...
class GetAssetFilterResult {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  GetAssetFilterResult& WithAssetId(AssetIdT&& value) {
  ...
  template <typename ConfigurationT = AssetFilterConfiguration>
  GetAssetFilterResult& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAssetFilterResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAssetFilterResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  GetAssetFilterResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename EffectiveColumnNamesT = Aws::Vector<Aws::String>>
  GetAssetFilterResult& WithEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    SetEffectiveColumnNames(std::forward<EffectiveColumnNamesT>(value));
    return *this;
  }
  template <typename EffectiveColumnNamesT = Aws::String>
  GetAssetFilterResult& AddEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    m_effectiveColumnNamesHasBeenSet = true;
  ...
  template <typename EffectiveRowFilterT = Aws::String>
  GetAssetFilterResult& WithEffectiveRowFilter(EffectiveRowFilterT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  GetAssetFilterResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename IdT = Aws::String>
  GetAssetFilterResult& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAssetFilterResult& WithName(NameT&& value) {
  ...
  inline GetAssetFilterResult& WithStatus(FilterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAssetFilterResult& WithRequestId(RequestIdT&& value) {
