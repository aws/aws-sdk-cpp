...
class AssetFilterConfiguration {
 public:
  ...
  void SetColumnConfiguration(ColumnConfigurationT&& value) {
    ...
    m_columnConfiguration = std::forward<ColumnConfigurationT>(value);
  }
  template <typename ColumnConfigurationT = ColumnFilterConfiguration>
  AssetFilterConfiguration& WithColumnConfiguration(ColumnConfigurationT&& value) {
    SetColumnConfiguration(std::forward<ColumnConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRowConfiguration(RowConfigurationT&& value) {
    m_rowConfigurationHasBeenSet = true;
    m_rowConfiguration = std::forward<RowConfigurationT>(value);
  }
  template <typename RowConfigurationT = RowFilterConfiguration>
  AssetFilterConfiguration& WithRowConfiguration(RowConfigurationT&& value) {
    SetRowConfiguration(std::forward<RowConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
