...
class RedshiftSelfGrantStatusOutput {
 public:
  ...
  void SetSelfGrantStatusDetails(SelfGrantStatusDetailsT&& value) {
    ...
    m_selfGrantStatusDetails = std::forward<SelfGrantStatusDetailsT>(value);
  }
  template <typename SelfGrantStatusDetailsT = Aws::Vector<SelfGrantStatusDetail>>
  RedshiftSelfGrantStatusOutput& WithSelfGrantStatusDetails(SelfGrantStatusDetailsT&& value) {
    SetSelfGrantStatusDetails(std::forward<SelfGrantStatusDetailsT>(value));
    return *this;
  }
  ...
  RedshiftSelfGrantStatusOutput& AddSelfGrantStatusDetails(SelfGrantStatusDetailsT&& value) {
    m_selfGrantStatusDetailsHasBeenSet = true;
    m_selfGrantStatusDetails.emplace_back(std::forward<SelfGrantStatusDetailsT>(value));
    return *this;
  }
  ///@}
 private:
