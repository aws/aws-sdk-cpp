...
class GetConnectionResult {
 public:
  ...
  void SetEnvironmentUserRole(EnvironmentUserRoleT&& value) {
    ...
    m_environmentUserRole = std::forward<EnvironmentUserRoleT>(value);
  }
  template <typename EnvironmentUserRoleT = Aws::String>
  GetConnectionResult& WithEnvironmentUserRole(EnvironmentUserRoleT&& value) {
    SetEnvironmentUserRole(std::forward<EnvironmentUserRoleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProps(PropsT&& value) {
    ...
    m_props = std::forward<PropsT>(value);
  }
  template <typename PropsT = ConnectionPropertiesOutput>
  GetConnectionResult& WithProps(PropsT&& value) {
    SetProps(std::forward<PropsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(ConnectionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline GetConnectionResult& WithType(ConnectionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetConnectionResult& WithScope(ConnectionScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
