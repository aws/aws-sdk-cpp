...
class ListLineageEventsRequest : public DataZoneRequest {
 public:
  ...
  inline ListLineageEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListLineageEventsRequest& WithProcessingStatus(LineageEventProcessingStatus value) {
  ...
  inline ListLineageEventsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
