...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListDomainsResult();
     ...
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline void SetItems(const Aws::Vector<DomainSummary>& value) { m_items = value; }

    /**
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline void SetItems(Aws::Vector<DomainSummary>&& value) { m_items = std::move(value); }

    /**
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline ListDomainsResult& WithItems(const Aws::Vector<DomainSummary>& value) { SetItems(value); return *this;}

    /**
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline ListDomainsResult& WithItems(Aws::Vector<DomainSummary>&& value) { SetItems(std::move(value)); return *this;}

    /**
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline ListDomainsResult& AddItems(const DomainSummary& value) { m_items.push_back(value); return *this; }

    /**
     * <p>The results of the <code>ListDomains</code> action.</p>
     */
    inline ListDomainsResult& AddItems(DomainSummary&& value) { m_items.push_back(std::move(value)); return *this; }
