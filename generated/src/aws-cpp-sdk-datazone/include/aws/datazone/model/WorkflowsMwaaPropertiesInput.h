 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/WorkflowsMwaaPropertiesInput">AWS
 * API Reference</a></p>
 */
class WorkflowsMwaaPropertiesInput {
 public:
  AWS_DATAZONE_API WorkflowsMwaaPropertiesInput() = default;
  AWS_DATAZONE_API WorkflowsMwaaPropertiesInput(Aws::Utils::Json::JsonView jsonValue);
  AWS_DATAZONE_API WorkflowsMwaaPropertiesInput& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename MwaaEnvironmentNameT = Aws::String>
  WorkflowsMwaaPropertiesInput& WithMwaaEnvironmentName(MwaaEnvironmentNameT&& value) {
