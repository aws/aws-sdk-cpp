...
class SelfGrantStatusOutput {
 public:
  ...
  void SetGlueSelfGrantStatus(GlueSelfGrantStatusT&& value) {
    ...
    m_glueSelfGrantStatus = std::forward<GlueSelfGrantStatusT>(value);
  }
  template <typename GlueSelfGrantStatusT = GlueSelfGrantStatusOutput>
  SelfGrantStatusOutput& WithGlueSelfGrantStatus(GlueSelfGrantStatusT&& value) {
    SetGlueSelfGrantStatus(std::forward<GlueSelfGrantStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftSelfGrantStatus(RedshiftSelfGrantStatusT&& value) {
    ...
    m_redshiftSelfGrantStatus = std::forward<RedshiftSelfGrantStatusT>(value);
  }
  template <typename RedshiftSelfGrantStatusT = RedshiftSelfGrantStatusOutput>
  SelfGrantStatusOutput& WithRedshiftSelfGrantStatus(RedshiftSelfGrantStatusT&& value) {
    SetRedshiftSelfGrantStatus(std::forward<RedshiftSelfGrantStatusT>(value));
    return *this;
  }
  ///@}
 private:
