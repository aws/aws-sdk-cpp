...
class ListProjectProfilesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ProjectProfileSummary>>
  ListProjectProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ProjectProfileSummary>
  ListProjectProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProjectProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProjectProfilesResult& WithRequestId(RequestIdT&& value) {
