...
class FormTypeData {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  FormTypeData& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  FormTypeData& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  FormTypeData& WithDescription(DescriptionT&& value) {
  ...
  template <typename ImportsT = Aws::Vector<Import>>
  FormTypeData& WithImports(ImportsT&& value) {
    SetImports(std::forward<ImportsT>(value));
    return *this;
  }
  template <typename ImportsT = Import>
  FormTypeData& AddImports(ImportsT&& value) {
    m_importsHasBeenSet = true;
