...
class GlueConnection {
 public:
  ...
  inline GlueConnection& WithConnectionType(ConnectionType value) {
  ...
  inline GlueConnection& WithStatus(ConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GlueConnection& WithConnectionSchemaVersion(int value) {
  ...
  inline GlueConnection& AddCompatibleComputeEnvironments(ComputeEnvironments value) {
    m_compatibleComputeEnvironmentsHasBeenSet = true;
