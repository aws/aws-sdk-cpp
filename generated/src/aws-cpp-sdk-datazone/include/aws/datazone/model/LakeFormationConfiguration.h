...
class LakeFormationConfiguration {
 public:
   ...
   */
  inline const Aws::Vector<Aws::String>& GetLocationRegistrationExcludeS3Locations() const {
    return m_locationRegistrationExcludeS3Locations;
  }
  ...
  void SetLocationRegistrationExcludeS3Locations(LocationRegistrationExcludeS3LocationsT&& value) {
    m_locationRegistrationExcludeS3LocationsHasBeenSet = true;
    m_locationRegistrationExcludeS3Locations = std::forward<LocationRegistrationExcludeS3LocationsT>(value);
  }
  template <typename LocationRegistrationExcludeS3LocationsT = Aws::Vector<Aws::String>>
  LakeFormationConfiguration& WithLocationRegistrationExcludeS3Locations(LocationRegistrationExcludeS3LocationsT&& value) {
    SetLocationRegistrationExcludeS3Locations(std::forward<LocationRegistrationExcludeS3LocationsT>(value));
    return *this;
  }
  template <typename LocationRegistrationExcludeS3LocationsT = Aws::String>
  LakeFormationConfiguration& AddLocationRegistrationExcludeS3Locations(LocationRegistrationExcludeS3LocationsT&& value) {
    m_locationRegistrationExcludeS3LocationsHasBeenSet = true;
    m_locationRegistrationExcludeS3Locations.emplace_back(std::forward<LocationRegistrationExcludeS3LocationsT>(value));
    return *this;
  }
  ///@}
 private:
