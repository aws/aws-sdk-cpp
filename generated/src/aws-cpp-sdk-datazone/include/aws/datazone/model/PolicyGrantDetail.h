...
class PolicyGrantDetail {
 public:
  ...
  void SetAddToProjectMemberPool(AddToProjectMemberPoolT&& value) {
    ...
    m_addToProjectMemberPool = std::forward<AddToProjectMemberPoolT>(value);
  }
  template <typename AddToProjectMemberPoolT = AddToProjectMemberPoolPolicyGrantDetail>
  ...
  void SetCreateAssetType(CreateAssetTypeT&& value) {
    ...
    m_createAssetType = std::forward<CreateAssetTypeT>(value);
  }
  template <typename CreateAssetTypeT = CreateAssetTypePolicyGrantDetail>
  PolicyGrantDetail& WithCreateAssetType(CreateAssetTypeT&& value) {
    SetCreateAssetType(std::forward<CreateAssetTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateEnvironment(CreateEnvironmentT&& value) {
    ...
    m_createEnvironment = std::forward<CreateEnvironmentT>(value);
  }
  template <typename CreateEnvironmentT = Unit>
  PolicyGrantDetail& WithCreateEnvironment(CreateEnvironmentT&& value) {
    SetCreateEnvironment(std::forward<CreateEnvironmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCreateEnvironmentFromBlueprint(CreateEnvironmentFromBlueprintT&& value) {
    ...
    m_createEnvironmentFromBlueprint = std::forward<CreateEnvironmentFromBlueprintT>(value);
  }
  template <typename CreateEnvironmentFromBlueprintT = Unit>
  PolicyGrantDetail& WithCreateEnvironmentFromBlueprint(CreateEnvironmentFromBlueprintT&& value) {
    SetCreateEnvironmentFromBlueprint(std::forward<CreateEnvironmentFromBlueprintT>(value));
    return *this;
  }
  ///@}
  ...
  inline const CreateProjectFromProjectProfilePolicyGrantDetail& GetCreateProjectFromProjectProfile() const {
    return m_createProjectFromProjectProfile;
  }
  ...
  void SetCreateProjectFromProjectProfile(CreateProjectFromProjectProfileT&& value) {
    ...
    m_createProjectFromProjectProfile = std::forward<CreateProjectFromProjectProfileT>(value);
  }
  template <typename CreateProjectFromProjectProfileT = CreateProjectFromProjectProfilePolicyGrantDetail>
  ...
  void SetUseAssetType(UseAssetTypeT&& value) {
    ...
    m_useAssetType = std::forward<UseAssetTypeT>(value);
  }
  template <typename UseAssetTypeT = UseAssetTypePolicyGrantDetail>
  PolicyGrantDetail& WithUseAssetType(UseAssetTypeT&& value) {
    SetUseAssetType(std::forward<UseAssetTypeT>(value));
    return *this;
  }
  ///@}
 private:
