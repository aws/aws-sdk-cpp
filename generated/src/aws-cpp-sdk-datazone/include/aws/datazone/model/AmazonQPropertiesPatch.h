...
namespace Model
{
  ...
  public:
    ...
    void SetAuthMode(AuthModeT&& value) { m_authModeHasBeenSet = true; m_authMode = std::forward<AuthModeT>(value); }
    template<typename AuthModeT = Aws::String>
    AmazonQPropertiesPatch& WithAuthMode(AuthModeT&& value) { SetAuthMode(std::forward<AuthModeT>(value)); return *this;}
    ///@}
    ...
    inline AmazonQPropertiesPatch& WithIsEnabled(bool value) { SetIsEnabled(value); return *this;}
    ///@}
    ...
    template<typename ProfileArnT = Aws::String>
    AmazonQPropertiesPatch& WithProfileArn(ProfileArnT&& value) { SetProfileArn(std::forward<ProfileArnT>(value)); return *this;}
    ///@}
  private:
