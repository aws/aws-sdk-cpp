...
class ListDataSourceRunActivitiesRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListDataSourceRunActivitiesRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  ListDataSourceRunActivitiesRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDataSourceRunActivitiesRequest& WithNextToken(NextTokenT&& value) {
