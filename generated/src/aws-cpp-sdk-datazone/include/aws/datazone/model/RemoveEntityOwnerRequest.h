...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientTokenT = Aws::String>
    RemoveEntityOwnerRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdentifierT = Aws::String>
    RemoveEntityOwnerRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename EntityIdentifierT = Aws::String>
    RemoveEntityOwnerRequest& WithEntityIdentifier(EntityIdentifierT&& value) { SetEntityIdentifier(std::forward<EntityIdentifierT>(value)); return *this;}
    ///@}
    ...
    inline RemoveEntityOwnerRequest& WithEntityType(DataZoneEntityType value) { SetEntityType(value); return *this;}
    ///@}
    ...
    template<typename OwnerT = OwnerProperties>
    RemoveEntityOwnerRequest& WithOwner(OwnerT&& value) { SetOwner(std::forward<OwnerT>(value)); return *this;}
    ///@}
  private:
