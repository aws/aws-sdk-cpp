...
class SearchTypesResultItem {
 public:
  ...
  void SetAssetTypeItem(AssetTypeItemT&& value) {
    m_assetTypeItemHasBeenSet = true;
    m_assetTypeItem = std::forward<AssetTypeItemT>(value);
  }
  template <typename AssetTypeItemT = AssetTypeItem>
  SearchTypesResultItem& WithAssetTypeItem(AssetTypeItemT&& value) {
    SetAssetTypeItem(std::forward<AssetTypeItemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFormTypeItem(FormTypeItemT&& value) {
    m_formTypeItemHasBeenSet = true;
    m_formTypeItem = std::forward<FormTypeItemT>(value);
  }
  template <typename FormTypeItemT = FormTypeData>
  SearchTypesResultItem& WithFormTypeItem(FormTypeItemT&& value) {
    SetFormTypeItem(std::forward<FormTypeItemT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineageNodeTypeItem(LineageNodeTypeItemT&& value) {
    m_lineageNodeTypeItemHasBeenSet = true;
    m_lineageNodeTypeItem = std::forward<LineageNodeTypeItemT>(value);
  }
  template <typename LineageNodeTypeItemT = LineageNodeTypeItem>
  SearchTypesResultItem& WithLineageNodeTypeItem(LineageNodeTypeItemT&& value) {
    SetLineageNodeTypeItem(std::forward<LineageNodeTypeItemT>(value));
    return *this;
  }
  ///@}
 private:
