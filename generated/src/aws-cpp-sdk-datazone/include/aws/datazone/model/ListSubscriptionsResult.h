...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListSubscriptionsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<SubscriptionSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<SubscriptionSummary>>
    ListSubscriptionsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = SubscriptionSummary>
    ListSubscriptionsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
