...
class RevokeSubscriptionRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  RevokeSubscriptionRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  RevokeSubscriptionRequest& WithIdentifier(IdentifierT&& value) {
  ...
  inline RevokeSubscriptionRequest& WithRetainPermissions(bool value) {
