...
class SearchGroupProfilesRequest : public DataZoneRequest {
 public:
  ...
  inline void SetGroupType(GroupSearchType value) {
    m_groupTypeHasBeenSet = true;
    m_groupType = value;
  }
  inline SearchGroupProfilesRequest& WithGroupType(GroupSearchType value) {
    SetGroupType(value);
    return *this;
  }
  ///@}
  ...
  inline SearchGroupProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
