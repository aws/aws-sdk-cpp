...
class DomainSummary {
 public:
  ...
  void SetManagedAccountId(ManagedAccountIdT&& value) {
    ...
    m_managedAccountId = std::forward<ManagedAccountIdT>(value);
  }
  template <typename ManagedAccountIdT = Aws::String>
  DomainSummary& WithManagedAccountId(ManagedAccountIdT&& value) {
    SetManagedAccountId(std::forward<ManagedAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainSummary& WithDomainVersion(DomainVersion value) {
