...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API DomainUnitUserProperties();
    ...
    inline DomainUnitUserProperties& WithUserId(const Aws::String& value) { SetUserId(value); return *this;}
    inline DomainUnitUserProperties& WithUserId(Aws::String&& value) { SetUserId(std::move(value)); return *this;}
    inline DomainUnitUserProperties& WithUserId(const char* value) { SetUserId(value); return *this;}
    ///@}
  private:
