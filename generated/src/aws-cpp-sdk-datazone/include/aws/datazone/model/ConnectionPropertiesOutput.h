...
namespace Model
{
  ...
  public:
    ...
    template<typename AmazonQPropertiesT = AmazonQPropertiesOutput>
    ConnectionPropertiesOutput& WithAmazonQProperties(AmazonQPropertiesT&& value) { SetAmazonQProperties(std::forward<AmazonQPropertiesT>(value)); return *this;}
    ///@}
    ...
    template<typename MlflowPropertiesT = MlflowPropertiesOutput>
    ConnectionPropertiesOutput& WithMlflowProperties(MlflowPropertiesT&& value) { SetMlflowProperties(std::forward<MlflowPropertiesT>(value)); return *this;}
    ///@}
