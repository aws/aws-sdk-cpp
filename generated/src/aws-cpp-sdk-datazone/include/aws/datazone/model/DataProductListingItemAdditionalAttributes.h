...
class DataProductListingItemAdditionalAttributes {
 public:
  ...
  template <typename FormsT = Aws::String>
  DataProductListingItemAdditionalAttributes& WithForms(FormsT&& value) {
  ...
  template <typename MatchRationaleT = Aws::Vector<MatchRationaleItem>>
  DataProductListingItemAdditionalAttributes& WithMatchRationale(MatchRationaleT&& value) {
    SetMatchRationale(std::forward<MatchRationaleT>(value));
    return *this;
  }
  template <typename MatchRationaleT = MatchRationaleItem>
  DataProductListingItemAdditionalAttributes& AddMatchRationale(MatchRationaleT&& value) {
    m_matchRationaleHasBeenSet = true;
