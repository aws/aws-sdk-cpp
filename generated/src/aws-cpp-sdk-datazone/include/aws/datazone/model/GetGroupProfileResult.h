...
class GetGroupProfileResult {
 public:
  ...
  inline GetGroupProfileResult& WithStatus(GroupProfileStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RolePrincipalArnT = Aws::String>
  GetGroupProfileResult& WithRolePrincipalArn(RolePrincipalArnT&& value) {
  ...
  template <typename RolePrincipalIdT = Aws::String>
  GetGroupProfileResult& WithRolePrincipalId(RolePrincipalIdT&& value) {
