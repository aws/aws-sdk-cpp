...
namespace Model
{
  ...
  public:
    ...
    template<typename DescriptionT = Aws::String>
    GetEnvironmentActionResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    GetEnvironmentActionResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    GetEnvironmentActionResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetEnvironmentActionResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    GetEnvironmentActionResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = ActionParameters>
    GetEnvironmentActionResult& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetEnvironmentActionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
