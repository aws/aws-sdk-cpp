...
class ActionParameters {
 public:
  ...
  void SetAwsConsoleLink(AwsConsoleLinkT&& value) {
    m_awsConsoleLinkHasBeenSet = true;
    m_awsConsoleLink = std::forward<AwsConsoleLinkT>(value);
  }
  template <typename AwsConsoleLinkT = AwsConsoleLinkParameters>
  ActionParameters& WithAwsConsoleLink(AwsConsoleLinkT&& value) {
    SetAwsConsoleLink(std::forward<AwsConsoleLinkT>(value));
    return *this;
  }
  ///@}
 private:
