...
class ListLineageEventsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<LineageEventSummary>>
  ListLineageEventsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = LineageEventSummary>
  ListLineageEventsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLineageEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLineageEventsResult& WithRequestId(RequestIdT&& value) {
