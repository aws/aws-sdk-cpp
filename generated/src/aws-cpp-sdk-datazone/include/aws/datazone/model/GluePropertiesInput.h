...
class GluePropertiesInput {
 public:
  ...
  void SetGlueConnectionInput(GlueConnectionInputT&& value) {
    ...
    m_glueConnectionInput = std::forward<GlueConnectionInputT>(value);
  }
  template <typename GlueConnectionInputT = GlueConnectionInput>
  GluePropertiesInput& WithGlueConnectionInput(GlueConnectionInputT&& value) {
    SetGlueConnectionInput(std::forward<GlueConnectionInputT>(value));
    return *this;
  }
  ///@}
 private:
