...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainIdentifierT = Aws::String>
    GetConnectionRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentifierT = Aws::String>
    GetConnectionRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
