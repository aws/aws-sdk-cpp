...
class SearchUserProfilesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<UserProfileSummary>>
  SearchUserProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = UserProfileSummary>
  SearchUserProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchUserProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchUserProfilesResult& WithRequestId(RequestIdT&& value) {
