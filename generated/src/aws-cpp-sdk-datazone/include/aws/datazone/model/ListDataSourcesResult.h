...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListDataSourcesResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<DataSourceSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<DataSourceSummary>>
    ListDataSourcesResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = DataSourceSummary>
    ListDataSourcesResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
