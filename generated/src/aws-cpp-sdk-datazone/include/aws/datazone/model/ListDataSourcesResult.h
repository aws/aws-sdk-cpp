...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListDataSourcesResult();
    AWS_DATAZONE_API ListDataSourcesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_DATAZONE_API ListDataSourcesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);


    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline const Aws::Vector<DataSourceSummary>& GetItems() const{ return m_items; }

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline void SetItems(const Aws::Vector<DataSourceSummary>& value) { m_items = value; }

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline void SetItems(Aws::Vector<DataSourceSummary>&& value) { m_items = std::move(value); }

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline ListDataSourcesResult& WithItems(const Aws::Vector<DataSourceSummary>& value) { SetItems(value); return *this;}

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline ListDataSourcesResult& WithItems(Aws::Vector<DataSourceSummary>&& value) { SetItems(std::move(value)); return *this;}

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline ListDataSourcesResult& AddItems(const DataSourceSummary& value) { m_items.push_back(value); return *this; }

    /**
     * <p>The results of the <code>ListDataSources</code> action.</p>
     */
    inline ListDataSourcesResult& AddItems(DataSourceSummary&& value) { m_items.push_back(std::move(value)); return *this; }
  ...
  private:
    ...
    Aws::Vector<DataSourceSummary> m_items;
