...
class GetSubscriptionTargetRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  GetSubscriptionTargetRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  GetSubscriptionTargetRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  GetSubscriptionTargetRequest& WithIdentifier(IdentifierT&& value) {
