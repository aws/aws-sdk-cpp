...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API GetSubscriptionTargetRequest() = default;
    ...
    template<typename DomainIdentifierT = Aws::String>
    GetSubscriptionTargetRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdentifierT = Aws::String>
    GetSubscriptionTargetRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) { SetEnvironmentIdentifier(std::forward<EnvironmentIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentifierT = Aws::String>
    GetSubscriptionTargetRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
