...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/AmazonQPropertiesInput">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    template<typename AuthModeT = Aws::String>
    AmazonQPropertiesInput& WithAuthMode(AuthModeT&& value) { SetAuthMode(std::forward<AuthModeT>(value)); return *this;}
    ///@}
    ...
    inline AmazonQPropertiesInput& WithIsEnabled(bool value) { SetIsEnabled(value); return *this;}
    ///@}
    ...
    template<typename ProfileArnT = Aws::String>
    AmazonQPropertiesInput& WithProfileArn(ProfileArnT&& value) { SetProfileArn(std::forward<ProfileArnT>(value)); return *this;}
    ///@}
  private:
