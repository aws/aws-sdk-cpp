...
class LineageSqlQueryRunDetails {
 public:
  ...
  void SetQueryEndTime(QueryEndTimeT&& value) {
    ...
    m_queryEndTime = std::forward<QueryEndTimeT>(value);
  }
  template <typename QueryEndTimeT = Aws::Utils::DateTime>
  LineageSqlQueryRunDetails& WithQueryEndTime(QueryEndTimeT&& value) {
    SetQueryEndTime(std::forward<QueryEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalQueriesProcessed(int value) {
    m_totalQueriesProcessedHasBeenSet = true;
    m_totalQueriesProcessed = value;
  }
  inline LineageSqlQueryRunDetails& WithTotalQueriesProcessed(int value) {
    SetTotalQueriesProcessed(value);
    return *this;
  }
  ///@}
 private:
