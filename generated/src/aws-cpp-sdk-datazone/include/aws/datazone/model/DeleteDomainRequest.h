...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientTokenT = Aws::String>
    DeleteDomainRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename IdentifierT = Aws::String>
    DeleteDomainRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
