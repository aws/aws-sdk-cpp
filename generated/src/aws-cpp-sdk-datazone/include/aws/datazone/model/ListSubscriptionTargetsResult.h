...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListSubscriptionTargetsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<SubscriptionTargetSummary>>
    void SetItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items = std::forward<ItemsT>(value); }
    template<typename ItemsT = Aws::Vector<SubscriptionTargetSummary>>
    ListSubscriptionTargetsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = SubscriptionTargetSummary>
    ListSubscriptionTargetsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSubscriptionTargetsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListSubscriptionTargetsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
