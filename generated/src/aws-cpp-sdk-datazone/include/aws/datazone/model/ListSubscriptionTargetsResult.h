...
class ListSubscriptionTargetsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<SubscriptionTargetSummary>>
  ListSubscriptionTargetsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SubscriptionTargetSummary>
  ListSubscriptionTargetsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscriptionTargetsResult& WithRequestId(RequestIdT&& value) {
