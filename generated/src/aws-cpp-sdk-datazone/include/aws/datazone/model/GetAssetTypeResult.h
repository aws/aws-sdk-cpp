...
class GetAssetTypeResult {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetAssetTypeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  GetAssetTypeResult& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAssetTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  GetAssetTypeResult& WithDomainId(DomainIdT&& value) {
  ...
  template <typename FormsOutputT = Aws::Map<Aws::String, FormEntryOutput>>
  GetAssetTypeResult& WithFormsOutput(FormsOutputT&& value) {
  ...
  template <typename OriginDomainIdT = Aws::String>
  GetAssetTypeResult& WithOriginDomainId(OriginDomainIdT&& value) {
  ...
  template <typename OriginProjectIdT = Aws::String>
  GetAssetTypeResult& WithOriginProjectId(OriginProjectIdT&& value) {
  ...
  template <typename OwningProjectIdT = Aws::String>
  GetAssetTypeResult& WithOwningProjectId(OwningProjectIdT&& value) {
  ...
  template <typename RevisionT = Aws::String>
  GetAssetTypeResult& WithRevision(RevisionT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetAssetTypeResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  GetAssetTypeResult& WithUpdatedBy(UpdatedByT&& value) {
