...
class ListEnvironmentProfilesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<EnvironmentProfileSummary>>
  ListEnvironmentProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EnvironmentProfileSummary>
  ListEnvironmentProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEnvironmentProfilesResult& WithRequestId(RequestIdT&& value) {
