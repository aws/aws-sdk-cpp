...
class TimeSeriesDataPointFormInput {
 public:
  ...
  template <typename ContentT = Aws::String>
  TimeSeriesDataPointFormInput& WithContent(ContentT&& value) {
  ...
  template <typename FormNameT = Aws::String>
  TimeSeriesDataPointFormInput& WithFormName(FormNameT&& value) {
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  TimeSeriesDataPointFormInput& WithTimestamp(TimestampT&& value) {
  ...
  template <typename TypeIdentifierT = Aws::String>
  TimeSeriesDataPointFormInput& WithTypeIdentifier(TypeIdentifierT&& value) {
  ...
  template <typename TypeRevisionT = Aws::String>
  TimeSeriesDataPointFormInput& WithTypeRevision(TypeRevisionT&& value) {
