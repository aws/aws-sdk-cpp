...
class AssetTypeItem {
 public:
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AssetTypeItem& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  AssetTypeItem& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AssetTypeItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  AssetTypeItem& WithDomainId(DomainIdT&& value) {
  ...
  template <typename FormsOutputT = Aws::Map<Aws::String, FormEntryOutput>>
  AssetTypeItem& WithFormsOutput(FormsOutputT&& value) {
  ...
  template <typename OriginDomainIdT = Aws::String>
  AssetTypeItem& WithOriginDomainId(OriginDomainIdT&& value) {
  ...
  template <typename OriginProjectIdT = Aws::String>
  AssetTypeItem& WithOriginProjectId(OriginProjectIdT&& value) {
  ...
  template <typename OwningProjectIdT = Aws::String>
  AssetTypeItem& WithOwningProjectId(OwningProjectIdT&& value) {
  ...
  template <typename RevisionT = Aws::String>
  AssetTypeItem& WithRevision(RevisionT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  AssetTypeItem& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  AssetTypeItem& WithUpdatedBy(UpdatedByT&& value) {
