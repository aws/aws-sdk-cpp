...
class SearchTypesRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  SearchTypesRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  inline SearchTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetSearchScope(TypesSearchScope value) {
    m_searchScopeHasBeenSet = true;
    m_searchScope = value;
  }
  inline SearchTypesRequest& WithSearchScope(TypesSearchScope value) {
  ...
  template <typename SearchTextT = Aws::String>
  SearchTypesRequest& WithSearchText(SearchTextT&& value) {
  ...
  template <typename SortT = SearchSort>
  SearchTypesRequest& WithSort(SortT&& value) {
