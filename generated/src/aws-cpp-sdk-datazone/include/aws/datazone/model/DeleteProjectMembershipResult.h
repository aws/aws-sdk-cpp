...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API DeleteProjectMembershipResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProjectMembershipResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
