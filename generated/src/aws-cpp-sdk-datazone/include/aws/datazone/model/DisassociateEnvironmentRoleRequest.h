...
class DisassociateEnvironmentRoleRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  DisassociateEnvironmentRoleRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  DisassociateEnvironmentRoleRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
  ...
  template <typename EnvironmentRoleArnT = Aws::String>
  DisassociateEnvironmentRoleRequest& WithEnvironmentRoleArn(EnvironmentRoleArnT&& value) {
