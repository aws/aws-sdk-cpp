...
class AssetFilterSummary {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  AssetFilterSummary& WithAssetId(AssetIdT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  AssetFilterSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  AssetFilterSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  AssetFilterSummary& WithDomainId(DomainIdT&& value) {
  ...
  template <typename EffectiveColumnNamesT = Aws::Vector<Aws::String>>
  AssetFilterSummary& WithEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    SetEffectiveColumnNames(std::forward<EffectiveColumnNamesT>(value));
    return *this;
  }
  template <typename EffectiveColumnNamesT = Aws::String>
  AssetFilterSummary& AddEffectiveColumnNames(EffectiveColumnNamesT&& value) {
    m_effectiveColumnNamesHasBeenSet = true;
  ...
  template <typename EffectiveRowFilterT = Aws::String>
  AssetFilterSummary& WithEffectiveRowFilter(EffectiveRowFilterT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  AssetFilterSummary& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename IdT = Aws::String>
  AssetFilterSummary& WithId(IdT&& value) {
  ...
  template <typename NameT = Aws::String>
  AssetFilterSummary& WithName(NameT&& value) {
  ...
  inline AssetFilterSummary& WithStatus(FilterStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
