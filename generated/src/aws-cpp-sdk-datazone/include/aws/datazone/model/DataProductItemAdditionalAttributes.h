...
class DataProductItemAdditionalAttributes {
 public:
  ...
  template <typename MatchRationaleT = Aws::Vector<MatchRationaleItem>>
  DataProductItemAdditionalAttributes& WithMatchRationale(MatchRationaleT&& value) {
    SetMatchRationale(std::forward<MatchRationaleT>(value));
    return *this;
  }
  template <typename MatchRationaleT = MatchRationaleItem>
  DataProductItemAdditionalAttributes& AddMatchRationale(MatchRationaleT&& value) {
    m_matchRationaleHasBeenSet = true;
