...
class GetListingRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  GetListingRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  GetListingRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename ListingRevisionT = Aws::String>
  GetListingRequest& WithListingRevision(ListingRevisionT&& value) {
