...
class ColumnFilterConfiguration {
 public:
  ...
  void SetIncludedColumnNames(IncludedColumnNamesT&& value) {
    m_includedColumnNamesHasBeenSet = true;
    m_includedColumnNames = std::forward<IncludedColumnNamesT>(value);
  }
  template <typename IncludedColumnNamesT = Aws::Vector<Aws::String>>
  ColumnFilterConfiguration& WithIncludedColumnNames(IncludedColumnNamesT&& value) {
    SetIncludedColumnNames(std::forward<IncludedColumnNamesT>(value));
    return *this;
  }
  template <typename IncludedColumnNamesT = Aws::String>
  ColumnFilterConfiguration& AddIncludedColumnNames(IncludedColumnNamesT&& value) {
    m_includedColumnNamesHasBeenSet = true;
    m_includedColumnNames.emplace_back(std::forward<IncludedColumnNamesT>(value));
    return *this;
  }
  ///@}
 private:
