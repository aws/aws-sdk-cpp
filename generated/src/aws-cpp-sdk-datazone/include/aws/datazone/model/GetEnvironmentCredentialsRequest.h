...
class GetEnvironmentCredentialsRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  GetEnvironmentCredentialsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename EnvironmentIdentifierT = Aws::String>
  GetEnvironmentCredentialsRequest& WithEnvironmentIdentifier(EnvironmentIdentifierT&& value) {
