...
namespace Model
{
  ...
  public:
    ...
    template<typename AssetFormsOutputT = Aws::Vector<FormOutput>>
    GetDataSourceResult& WithAssetFormsOutput(AssetFormsOutputT&& value) { SetAssetFormsOutput(std::forward<AssetFormsOutputT>(value)); return *this;}
    template<typename AssetFormsOutputT = FormOutput>
    GetDataSourceResult& AddAssetFormsOutput(AssetFormsOutputT&& value) { m_assetFormsOutputHasBeenSet = true; m_assetFormsOutput.emplace_back(std::forward<AssetFormsOutputT>(value)); return *this; }
    ///@}
    ...
    template<typename ConnectionIdT = Aws::String>
    GetDataSourceResult& WithConnectionId(ConnectionIdT&& value) { SetConnectionId(std::forward<ConnectionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    GetDataSourceResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    inline GetDataSourceResult& WithEnableSetting(EnableSetting value) { SetEnableSetting(value); return *this;}
    ///@}
    ...
    template<typename EnvironmentIdT = Aws::String>
    GetDataSourceResult& WithEnvironmentId(EnvironmentIdT&& value) { SetEnvironmentId(std::forward<EnvironmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorMessageT = DataSourceErrorMessage>
    GetDataSourceResult& WithErrorMessage(ErrorMessageT&& value) { SetErrorMessage(std::forward<ErrorMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetDataSourceResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LastRunAtT = Aws::Utils::DateTime>
    GetDataSourceResult& WithLastRunAt(LastRunAtT&& value) { SetLastRunAt(std::forward<LastRunAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastRunErrorMessageT = DataSourceErrorMessage>
    GetDataSourceResult& WithLastRunErrorMessage(LastRunErrorMessageT&& value) { SetLastRunErrorMessage(std::forward<LastRunErrorMessageT>(value)); return *this;}
    ///@}
    ...
    inline GetDataSourceResult& WithLastRunStatus(DataSourceRunStatus value) { SetLastRunStatus(value); return *this;}
    ///@}
    ...
    template<typename ProjectIdT = Aws::String>
    GetDataSourceResult& WithProjectId(ProjectIdT&& value) { SetProjectId(std::forward<ProjectIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RecommendationT = RecommendationConfiguration>
    GetDataSourceResult& WithRecommendation(RecommendationT&& value) { SetRecommendation(std::forward<RecommendationT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleT = ScheduleConfiguration>
    GetDataSourceResult& WithSchedule(ScheduleT&& value) { SetSchedule(std::forward<ScheduleT>(value)); return *this;}
    ///@}
    ...
    template<typename SelfGrantStatusT = SelfGrantStatusOutput>
    GetDataSourceResult& WithSelfGrantStatus(SelfGrantStatusT&& value) { SetSelfGrantStatus(std::forward<SelfGrantStatusT>(value)); return *this;}
    ///@}
