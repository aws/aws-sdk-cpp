...
class ListAssetFiltersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<AssetFilterSummary>>
  ListAssetFiltersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = AssetFilterSummary>
  ListAssetFiltersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetFiltersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetFiltersResult& WithRequestId(RequestIdT&& value) {
