...
namespace Model
{
  ...
  public:
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetMetadataGenerationRunResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedByT = Aws::String>
    GetMetadataGenerationRunResult& WithCreatedBy(CreatedByT&& value) { SetCreatedBy(std::forward<CreatedByT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainIdT = Aws::String>
    GetMetadataGenerationRunResult& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetMetadataGenerationRunResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename OwningProjectIdT = Aws::String>
    GetMetadataGenerationRunResult& WithOwningProjectId(OwningProjectIdT&& value) { SetOwningProjectId(std::forward<OwningProjectIdT>(value)); return *this;}
    ///@}
    ...
    inline GetMetadataGenerationRunResult& WithStatus(MetadataGenerationRunStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename TargetT = MetadataGenerationRunTarget>
    GetMetadataGenerationRunResult& WithTarget(TargetT&& value) { SetTarget(std::forward<TargetT>(value)); return *this;}
    ///@}
    ...
    inline GetMetadataGenerationRunResult& WithType(MetadataGenerationRunType value) { SetType(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetMetadataGenerationRunResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
