...
class DeleteAssetFilterRequest : public DataZoneRequest {
 public:
  ...
  template <typename AssetIdentifierT = Aws::String>
  DeleteAssetFilterRequest& WithAssetIdentifier(AssetIdentifierT&& value) {
  ...
  template <typename DomainIdentifierT = Aws::String>
  DeleteAssetFilterRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  DeleteAssetFilterRequest& WithIdentifier(IdentifierT&& value) {
