...
class ListMetadataGenerationRunsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<MetadataGenerationRunItem>>
  ListMetadataGenerationRunsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = MetadataGenerationRunItem>
  ListMetadataGenerationRunsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMetadataGenerationRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMetadataGenerationRunsResult& WithRequestId(RequestIdT&& value) {
