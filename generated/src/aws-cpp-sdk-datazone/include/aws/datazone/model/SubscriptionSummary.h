...
class SubscriptionSummary {
 public:
  ...
  template <typename IdT = Aws::String>
  SubscriptionSummary& WithId(IdT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  SubscriptionSummary& WithCreatedBy(CreatedByT&& value) {
  ...
  template <typename UpdatedByT = Aws::String>
  SubscriptionSummary& WithUpdatedBy(UpdatedByT&& value) {
  ...
  template <typename DomainIdT = Aws::String>
  SubscriptionSummary& WithDomainId(DomainIdT&& value) {
  ...
  inline SubscriptionSummary& WithStatus(SubscriptionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubscribedPrincipalT = SubscribedPrincipal>
  SubscriptionSummary& WithSubscribedPrincipal(SubscribedPrincipalT&& value) {
  ...
  template <typename SubscribedListingT = SubscribedListing>
  SubscriptionSummary& WithSubscribedListing(SubscribedListingT&& value) {
  ...
  template <typename SubscriptionRequestIdT = Aws::String>
  SubscriptionSummary& WithSubscriptionRequestId(SubscriptionRequestIdT&& value) {
  ...
  inline SubscriptionSummary& WithRetainPermissions(bool value) {
