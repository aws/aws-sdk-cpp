...
class DeleteEnvironmentRequest : public DataZoneRequest {
 public:
  AWS_DATAZONE_API DeleteEnvironmentRequest() = default;
  ...
  template <typename DomainIdentifierT = Aws::String>
  DeleteEnvironmentRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  template <typename IdentifierT = Aws::String>
  DeleteEnvironmentRequest& WithIdentifier(IdentifierT&& value) {
