...
namespace Model
{
  ...
  public:
    ...
    template<typename ColumnNameT = Aws::String>
    GreaterThanExpression& WithColumnName(ColumnNameT&& value) { SetColumnName(std::forward<ColumnNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    GreaterThanExpression& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
