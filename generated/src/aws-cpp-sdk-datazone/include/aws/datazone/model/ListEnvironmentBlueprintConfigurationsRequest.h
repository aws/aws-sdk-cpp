...
namespace Model
{
  ...
  {
  public:
    AWS_DATAZONE_API ListEnvironmentBlueprintConfigurationsRequest() = default;
    ...
    template<typename DomainIdentifierT = Aws::String>
    ListEnvironmentBlueprintConfigurationsRequest& WithDomainIdentifier(DomainIdentifierT&& value) { SetDomainIdentifier(std::forward<DomainIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListEnvironmentBlueprintConfigurationsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
