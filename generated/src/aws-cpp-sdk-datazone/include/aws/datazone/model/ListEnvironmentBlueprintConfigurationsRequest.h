...
class ListEnvironmentBlueprintConfigurationsRequest : public DataZoneRequest {
 public:
  ...
  template <typename DomainIdentifierT = Aws::String>
  ListEnvironmentBlueprintConfigurationsRequest& WithDomainIdentifier(DomainIdentifierT&& value) {
  ...
  inline ListEnvironmentBlueprintConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEnvironmentBlueprintConfigurationsRequest& WithNextToken(NextTokenT&& value) {
