...
namespace DataZone
{
   ...
   */
  class AWS_DATAZONE_API DataZoneClient : Aws::Client::ClientWithAsyncTemplateMethods<DataZoneClient>,
    smithy::client::AwsSmithyClientT<Aws::DataZone::SERVICE_NAME,
