...
class AWS_DATAZONE_API DataZoneClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DataZoneClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DataZoneEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AcceptPredictions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptPredictions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AcceptPredictionsRequestT = Model::AcceptPredictionsRequest>
  void AcceptPredictionsAsync(const AcceptPredictionsRequestT& request, const AcceptPredictionsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AcceptSubscriptionRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AcceptSubscriptionRequestRequestT = Model::AcceptSubscriptionRequestRequest>
  Model::AcceptSubscriptionRequestOutcomeCallable AcceptSubscriptionRequestCallable(
      const AcceptSubscriptionRequestRequestT& request) const {
    return SubmitCallable(&DataZoneClient::AcceptSubscriptionRequest, request);
  }

  /**
   * An Async wrapper for AcceptSubscriptionRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptSubscriptionRequestRequestT = Model::AcceptSubscriptionRequestRequest>
  void AcceptSubscriptionRequestAsync(const AcceptSubscriptionRequestRequestT& request,
                                      const AcceptSubscriptionRequestResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AddEntityOwner that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddEntityOwnerRequestT = Model::AddEntityOwnerRequest>
  void AddEntityOwnerAsync(const AddEntityOwnerRequestT& request, const AddEntityOwnerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AddPolicyGrant that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddPolicyGrantRequestT = Model::AddPolicyGrantRequest>
  void AddPolicyGrantAsync(const AddPolicyGrantRequestT& request, const AddPolicyGrantResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateEnvironmentRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateEnvironmentRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateEnvironmentRoleRequestT = Model::AssociateEnvironmentRoleRequest>
  void AssociateEnvironmentRoleAsync(const AssociateEnvironmentRoleRequestT& request,
                                     const AssociateEnvironmentRoleResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateGovernedTerms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateGovernedTerms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateGovernedTermsRequestT = Model::AssociateGovernedTermsRequest>
  void AssociateGovernedTermsAsync(const AssociateGovernedTermsRequestT& request,
                                   const AssociateGovernedTermsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelMetadataGenerationRunOutcome CancelMetadataGenerationRun(
      const Model::CancelMetadataGenerationRunRequest& request) const;

  /**
   * A Callable wrapper for CancelMetadataGenerationRun that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelMetadataGenerationRunRequestT = Model::CancelMetadataGenerationRunRequest>
  Model::CancelMetadataGenerationRunOutcomeCallable CancelMetadataGenerationRunCallable(
      const CancelMetadataGenerationRunRequestT& request) const {
    return SubmitCallable(&DataZoneClient::CancelMetadataGenerationRun, request);
  }

  /**
   * An Async wrapper for CancelMetadataGenerationRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMetadataGenerationRunRequestT = Model::CancelMetadataGenerationRunRequest>
  void CancelMetadataGenerationRunAsync(const CancelMetadataGenerationRunRequestT& request,
                                        const CancelMetadataGenerationRunResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAccountPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccountPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAccountPoolRequestT = Model::CreateAccountPoolRequest>
  void CreateAccountPoolAsync(const CreateAccountPoolRequestT& request, const CreateAccountPoolResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAssetFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssetFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAssetFilterRequestT = Model::CreateAssetFilterRequest>
  void CreateAssetFilterAsync(const CreateAssetFilterRequestT& request, const CreateAssetFilterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAssetRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAssetRevision that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAssetRevisionRequestT = Model::CreateAssetRevisionRequest>
  void CreateAssetRevisionAsync(const CreateAssetRevisionRequestT& request, const CreateAssetRevisionResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAssetType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAssetTypeRequestT = Model::CreateAssetTypeRequest>
  void CreateAssetTypeAsync(const CreateAssetTypeRequestT& request, const CreateAssetTypeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataProduct that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDataProductRequestT = Model::CreateDataProductRequest>
  void CreateDataProductAsync(const CreateDataProductRequestT& request, const CreateDataProductResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataProductRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateDataProductRevisionRequestT = Model::CreateDataProductRevisionRequest>
  Model::CreateDataProductRevisionOutcomeCallable CreateDataProductRevisionCallable(
      const CreateDataProductRevisionRequestT& request) const {
    return SubmitCallable(&DataZoneClient::CreateDataProductRevision, request);
  }

  /**
   * An Async wrapper for CreateDataProductRevision that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataProductRevisionRequestT = Model::CreateDataProductRevisionRequest>
  void CreateDataProductRevisionAsync(const CreateDataProductRevisionRequestT& request,
                                      const CreateDataProductRevisionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDomainUnit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDomainUnit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDomainUnitRequestT = Model::CreateDomainUnitRequest>
  void CreateDomainUnitAsync(const CreateDomainUnitRequestT& request, const CreateDomainUnitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEnvironmentAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEnvironmentAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEnvironmentActionRequestT = Model::CreateEnvironmentActionRequest>
  void CreateEnvironmentActionAsync(const CreateEnvironmentActionRequestT& request,
                                    const CreateEnvironmentActionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateEnvironmentBlueprintOutcome CreateEnvironmentBlueprint(
      const Model::CreateEnvironmentBlueprintRequest& request) const;

  /**
   * A Callable wrapper for CreateEnvironmentBlueprint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateEnvironmentBlueprintRequestT = Model::CreateEnvironmentBlueprintRequest>
  Model::CreateEnvironmentBlueprintOutcomeCallable CreateEnvironmentBlueprintCallable(
      const CreateEnvironmentBlueprintRequestT& request) const {
    return SubmitCallable(&DataZoneClient::CreateEnvironmentBlueprint, request);
  }

  /**
   * An Async wrapper for CreateEnvironmentBlueprint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEnvironmentBlueprintRequestT = Model::CreateEnvironmentBlueprintRequest>
  void CreateEnvironmentBlueprintAsync(const CreateEnvironmentBlueprintRequestT& request,
                                       const CreateEnvironmentBlueprintResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEnvironmentProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEnvironmentProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEnvironmentProfileRequestT = Model::CreateEnvironmentProfileRequest>
  void CreateEnvironmentProfileAsync(const CreateEnvironmentProfileRequestT& request,
                                     const CreateEnvironmentProfileResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateFormType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateFormTypeRequestT = Model::CreateFormTypeRequest>
  void CreateFormTypeAsync(const CreateFormTypeRequestT& request, const CreateFormTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGroupProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGroupProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGroupProfileRequestT = Model::CreateGroupProfileRequest>
  void CreateGroupProfileAsync(const CreateGroupProfileRequestT& request, const CreateGroupProfileResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateListingChangeSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateListingChangeSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateListingChangeSetRequestT = Model::CreateListingChangeSetRequest>
  void CreateListingChangeSetAsync(const CreateListingChangeSetRequestT& request,
                                   const CreateListingChangeSetResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProjectMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProjectMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProjectMembershipRequestT = Model::CreateProjectMembershipRequest>
  void CreateProjectMembershipAsync(const CreateProjectMembershipRequestT& request,
                                    const CreateProjectMembershipResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProjectProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProjectProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProjectProfileRequestT = Model::CreateProjectProfileRequest>
  void CreateProjectProfileAsync(const CreateProjectProfileRequestT& request, const CreateProjectProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSubscriptionGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSubscriptionGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSubscriptionGrantRequestT = Model::CreateSubscriptionGrantRequest>
  void CreateSubscriptionGrantAsync(const CreateSubscriptionGrantRequestT& request,
                                    const CreateSubscriptionGrantResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSubscriptionRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateSubscriptionRequestRequestT = Model::CreateSubscriptionRequestRequest>
  Model::CreateSubscriptionRequestOutcomeCallable CreateSubscriptionRequestCallable(
      const CreateSubscriptionRequestRequestT& request) const {
    return SubmitCallable(&DataZoneClient::CreateSubscriptionRequest, request);
  }

  /**
   * An Async wrapper for CreateSubscriptionRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSubscriptionRequestRequestT = Model::CreateSubscriptionRequestRequest>
  void CreateSubscriptionRequestAsync(const CreateSubscriptionRequestRequestT& request,
                                      const CreateSubscriptionRequestResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSubscriptionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSubscriptionTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSubscriptionTargetRequestT = Model::CreateSubscriptionTargetRequest>
  void CreateSubscriptionTargetAsync(const CreateSubscriptionTargetRequestT& request,
                                     const CreateSubscriptionTargetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccountPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccountPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAccountPoolRequestT = Model::DeleteAccountPoolRequest>
  void DeleteAccountPoolAsync(const DeleteAccountPoolRequestT& request, const DeleteAccountPoolResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAssetFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAssetFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAssetFilterRequestT = Model::DeleteAssetFilterRequest>
  void DeleteAssetFilterAsync(const DeleteAssetFilterRequestT& request, const DeleteAssetFilterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDataProduct that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDataProduct that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDataProductRequestT = Model::DeleteDataProductRequest>
  void DeleteDataProductAsync(const DeleteDataProductRequestT& request, const DeleteDataProductResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDomainUnit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDomainUnit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDomainUnitRequestT = Model::DeleteDomainUnitRequest>
  void DeleteDomainUnitAsync(const DeleteDomainUnitRequestT& request, const DeleteDomainUnitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEnvironmentAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEnvironmentAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEnvironmentActionRequestT = Model::DeleteEnvironmentActionRequest>
  void DeleteEnvironmentActionAsync(const DeleteEnvironmentActionRequestT& request,
                                    const DeleteEnvironmentActionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEnvironmentBlueprintOutcome DeleteEnvironmentBlueprint(
      const Model::DeleteEnvironmentBlueprintRequest& request) const;

  /**
   * A Callable wrapper for DeleteEnvironmentBlueprint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteEnvironmentBlueprintRequestT = Model::DeleteEnvironmentBlueprintRequest>
  Model::DeleteEnvironmentBlueprintOutcomeCallable DeleteEnvironmentBlueprintCallable(
      const DeleteEnvironmentBlueprintRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DeleteEnvironmentBlueprint, request);
  }

  /**
   * An Async wrapper for DeleteEnvironmentBlueprint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEnvironmentBlueprintRequestT = Model::DeleteEnvironmentBlueprintRequest>
  void DeleteEnvironmentBlueprintAsync(const DeleteEnvironmentBlueprintRequestT& request,
                                       const DeleteEnvironmentBlueprintResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteEnvironmentBlueprintConfigurationOutcome DeleteEnvironmentBlueprintConfiguration(
      const Model::DeleteEnvironmentBlueprintConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteEnvironmentBlueprintConfiguration that returns a future to the operation so that it can be executed in
  ...
  Model::DeleteEnvironmentBlueprintConfigurationOutcomeCallable DeleteEnvironmentBlueprintConfigurationCallable(
      const DeleteEnvironmentBlueprintConfigurationRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DeleteEnvironmentBlueprintConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteEnvironmentBlueprintConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteEnvironmentBlueprintConfigurationRequestT = Model::DeleteEnvironmentBlueprintConfigurationRequest>
  void DeleteEnvironmentBlueprintConfigurationAsync(const DeleteEnvironmentBlueprintConfigurationRequestT& request,
                                                    const DeleteEnvironmentBlueprintConfigurationResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEnvironmentProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEnvironmentProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEnvironmentProfileRequestT = Model::DeleteEnvironmentProfileRequest>
  void DeleteEnvironmentProfileAsync(const DeleteEnvironmentProfileRequestT& request,
                                     const DeleteEnvironmentProfileResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteListing that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteListingRequestT = Model::DeleteListingRequest>
  ...
  /**
   * A Callable wrapper for DeleteProjectMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProjectMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProjectMembershipRequestT = Model::DeleteProjectMembershipRequest>
  void DeleteProjectMembershipAsync(const DeleteProjectMembershipRequestT& request,
                                    const DeleteProjectMembershipResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProjectProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProjectProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProjectProfileRequestT = Model::DeleteProjectProfileRequest>
  void DeleteProjectProfileAsync(const DeleteProjectProfileRequestT& request, const DeleteProjectProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSubscriptionGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSubscriptionGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSubscriptionGrantRequestT = Model::DeleteSubscriptionGrantRequest>
  void DeleteSubscriptionGrantAsync(const DeleteSubscriptionGrantRequestT& request,
                                    const DeleteSubscriptionGrantResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSubscriptionRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteSubscriptionRequestRequestT = Model::DeleteSubscriptionRequestRequest>
  Model::DeleteSubscriptionRequestOutcomeCallable DeleteSubscriptionRequestCallable(
      const DeleteSubscriptionRequestRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DeleteSubscriptionRequest, request);
  }

  /**
   * An Async wrapper for DeleteSubscriptionRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSubscriptionRequestRequestT = Model::DeleteSubscriptionRequestRequest>
  void DeleteSubscriptionRequestAsync(const DeleteSubscriptionRequestRequestT& request,
                                      const DeleteSubscriptionRequestResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSubscriptionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSubscriptionTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSubscriptionTargetRequestT = Model::DeleteSubscriptionTargetRequest>
  void DeleteSubscriptionTargetAsync(const DeleteSubscriptionTargetRequestT& request,
                                     const DeleteSubscriptionTargetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteTimeSeriesDataPointsOutcome DeleteTimeSeriesDataPoints(
      const Model::DeleteTimeSeriesDataPointsRequest& request) const;

  /**
   * A Callable wrapper for DeleteTimeSeriesDataPoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteTimeSeriesDataPointsRequestT = Model::DeleteTimeSeriesDataPointsRequest>
  Model::DeleteTimeSeriesDataPointsOutcomeCallable DeleteTimeSeriesDataPointsCallable(
      const DeleteTimeSeriesDataPointsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DeleteTimeSeriesDataPoints, request);
  }

  /**
   * An Async wrapper for DeleteTimeSeriesDataPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTimeSeriesDataPointsRequestT = Model::DeleteTimeSeriesDataPointsRequest>
  void DeleteTimeSeriesDataPointsAsync(const DeleteTimeSeriesDataPointsRequestT& request,
                                       const DeleteTimeSeriesDataPointsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateEnvironmentRoleOutcome DisassociateEnvironmentRole(
      const Model::DisassociateEnvironmentRoleRequest& request) const;

  /**
   * A Callable wrapper for DisassociateEnvironmentRole that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateEnvironmentRoleRequestT = Model::DisassociateEnvironmentRoleRequest>
  Model::DisassociateEnvironmentRoleOutcomeCallable DisassociateEnvironmentRoleCallable(
      const DisassociateEnvironmentRoleRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DisassociateEnvironmentRole, request);
  }

  /**
   * An Async wrapper for DisassociateEnvironmentRole that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateEnvironmentRoleRequestT = Model::DisassociateEnvironmentRoleRequest>
  void DisassociateEnvironmentRoleAsync(const DisassociateEnvironmentRoleRequestT& request,
                                        const DisassociateEnvironmentRoleResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateGovernedTerms that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisassociateGovernedTermsRequestT = Model::DisassociateGovernedTermsRequest>
  Model::DisassociateGovernedTermsOutcomeCallable DisassociateGovernedTermsCallable(
      const DisassociateGovernedTermsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::DisassociateGovernedTerms, request);
  }

  /**
   * An Async wrapper for DisassociateGovernedTerms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateGovernedTermsRequestT = Model::DisassociateGovernedTermsRequest>
  void DisassociateGovernedTermsAsync(const DisassociateGovernedTermsRequestT& request,
                                      const DisassociateGovernedTermsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAccountPool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAccountPoolRequestT = Model::GetAccountPoolRequest>
  void GetAccountPoolAsync(const GetAccountPoolRequestT& request, const GetAccountPoolResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAssetFilter that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAssetFilterRequestT = Model::GetAssetFilterRequest>
  void GetAssetFilterAsync(const GetAssetFilterRequestT& request, const GetAssetFilterResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDataProduct that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDataProductRequestT = Model::GetDataProductRequest>
  void GetDataProductAsync(const GetDataProductRequestT& request, const GetDataProductResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDataSourceRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDataSourceRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDataSourceRunRequestT = Model::GetDataSourceRunRequest>
  void GetDataSourceRunAsync(const GetDataSourceRunRequestT& request, const GetDataSourceRunResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDomainUnit that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDomainUnitRequestT = Model::GetDomainUnitRequest>
  void GetDomainUnitAsync(const GetDomainUnitRequestT& request, const GetDomainUnitResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnvironmentAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnvironmentAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEnvironmentActionRequestT = Model::GetEnvironmentActionRequest>
  void GetEnvironmentActionAsync(const GetEnvironmentActionRequestT& request, const GetEnvironmentActionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnvironmentBlueprint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnvironmentBlueprint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEnvironmentBlueprintRequestT = Model::GetEnvironmentBlueprintRequest>
  void GetEnvironmentBlueprintAsync(const GetEnvironmentBlueprintRequestT& request,
                                    const GetEnvironmentBlueprintResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetEnvironmentBlueprintConfigurationOutcome GetEnvironmentBlueprintConfiguration(
      const Model::GetEnvironmentBlueprintConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetEnvironmentBlueprintConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetEnvironmentBlueprintConfigurationRequestT = Model::GetEnvironmentBlueprintConfigurationRequest>
  Model::GetEnvironmentBlueprintConfigurationOutcomeCallable GetEnvironmentBlueprintConfigurationCallable(
      const GetEnvironmentBlueprintConfigurationRequestT& request) const {
    return SubmitCallable(&DataZoneClient::GetEnvironmentBlueprintConfiguration, request);
  }

  /**
   * An Async wrapper for GetEnvironmentBlueprintConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetEnvironmentBlueprintConfigurationRequestT = Model::GetEnvironmentBlueprintConfigurationRequest>
  void GetEnvironmentBlueprintConfigurationAsync(const GetEnvironmentBlueprintConfigurationRequestT& request,
                                                 const GetEnvironmentBlueprintConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnvironmentCredentials that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetEnvironmentCredentialsRequestT = Model::GetEnvironmentCredentialsRequest>
  Model::GetEnvironmentCredentialsOutcomeCallable GetEnvironmentCredentialsCallable(
      const GetEnvironmentCredentialsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::GetEnvironmentCredentials, request);
  }

  /**
   * An Async wrapper for GetEnvironmentCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEnvironmentCredentialsRequestT = Model::GetEnvironmentCredentialsRequest>
  void GetEnvironmentCredentialsAsync(const GetEnvironmentCredentialsRequestT& request,
                                      const GetEnvironmentCredentialsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnvironmentProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnvironmentProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetEnvironmentProfileRequestT = Model::GetEnvironmentProfileRequest>
  void GetEnvironmentProfileAsync(const GetEnvironmentProfileRequestT& request, const GetEnvironmentProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetGroupProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetGroupProfileRequestT = Model::GetGroupProfileRequest>
  void GetGroupProfileAsync(const GetGroupProfileRequestT& request, const GetGroupProfileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIamPortalLoginUrl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIamPortalLoginUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIamPortalLoginUrlRequestT = Model::GetIamPortalLoginUrlRequest>
  void GetIamPortalLoginUrlAsync(const GetIamPortalLoginUrlRequestT& request, const GetIamPortalLoginUrlResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLineageEvent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLineageEventRequestT = Model::GetLineageEventRequest>
  void GetLineageEventAsync(const GetLineageEventRequestT& request, const GetLineageEventResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLineageNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLineageNodeRequestT = Model::GetLineageNodeRequest>
  void GetLineageNodeAsync(const GetLineageNodeRequestT& request, const GetLineageNodeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMetadataGenerationRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMetadataGenerationRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMetadataGenerationRunRequestT = Model::GetMetadataGenerationRunRequest>
  void GetMetadataGenerationRunAsync(const GetMetadataGenerationRunRequestT& request,
                                     const GetMetadataGenerationRunResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProjectProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProjectProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetProjectProfileRequestT = Model::GetProjectProfileRequest>
  void GetProjectProfileAsync(const GetProjectProfileRequestT& request, const GetProjectProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSubscriptionGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSubscriptionGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSubscriptionGrantRequestT = Model::GetSubscriptionGrantRequest>
  void GetSubscriptionGrantAsync(const GetSubscriptionGrantRequestT& request, const GetSubscriptionGrantResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSubscriptionRequestDetailsOutcome GetSubscriptionRequestDetails(
      const Model::GetSubscriptionRequestDetailsRequest& request) const;

  /**
   * A Callable wrapper for GetSubscriptionRequestDetails that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSubscriptionRequestDetailsRequestT = Model::GetSubscriptionRequestDetailsRequest>
  Model::GetSubscriptionRequestDetailsOutcomeCallable GetSubscriptionRequestDetailsCallable(
      const GetSubscriptionRequestDetailsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::GetSubscriptionRequestDetails, request);
  }

  /**
   * An Async wrapper for GetSubscriptionRequestDetails that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSubscriptionRequestDetailsRequestT = Model::GetSubscriptionRequestDetailsRequest>
  void GetSubscriptionRequestDetailsAsync(const GetSubscriptionRequestDetailsRequestT& request,
                                          const GetSubscriptionRequestDetailsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSubscriptionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSubscriptionTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSubscriptionTargetRequestT = Model::GetSubscriptionTargetRequest>
  void GetSubscriptionTargetAsync(const GetSubscriptionTargetRequestT& request, const GetSubscriptionTargetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTimeSeriesDataPoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTimeSeriesDataPoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTimeSeriesDataPointRequestT = Model::GetTimeSeriesDataPointRequest>
  void GetTimeSeriesDataPointAsync(const GetTimeSeriesDataPointRequestT& request,
                                   const GetTimeSeriesDataPointResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetUserProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUserProfileRequestT = Model::GetUserProfileRequest>
  void GetUserProfileAsync(const GetUserProfileRequestT& request, const GetUserProfileResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountPools that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountPools that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAccountPoolsRequestT = Model::ListAccountPoolsRequest>
  void ListAccountPoolsAsync(const ListAccountPoolsRequestT& request, const ListAccountPoolsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountsInAccountPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListAccountsInAccountPoolRequestT = Model::ListAccountsInAccountPoolRequest>
  Model::ListAccountsInAccountPoolOutcomeCallable ListAccountsInAccountPoolCallable(
      const ListAccountsInAccountPoolRequestT& request) const {
    return SubmitCallable(&DataZoneClient::ListAccountsInAccountPool, request);
  }

  /**
   * An Async wrapper for ListAccountsInAccountPool that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccountsInAccountPoolRequestT = Model::ListAccountsInAccountPoolRequest>
  void ListAccountsInAccountPoolAsync(const ListAccountsInAccountPoolRequestT& request,
                                      const ListAccountsInAccountPoolResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssetFilters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssetFilters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAssetFiltersRequestT = Model::ListAssetFiltersRequest>
  void ListAssetFiltersAsync(const ListAssetFiltersRequestT& request, const ListAssetFiltersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssetRevisions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssetRevisions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAssetRevisionsRequestT = Model::ListAssetRevisionsRequest>
  void ListAssetRevisionsAsync(const ListAssetRevisionsRequestT& request, const ListAssetRevisionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataProductRevisions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataProductRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataProductRevisionsRequestT = Model::ListDataProductRevisionsRequest>
  void ListDataProductRevisionsAsync(const ListDataProductRevisionsRequestT& request,
                                     const ListDataProductRevisionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataSourceRunActivitiesOutcome ListDataSourceRunActivities(
      const Model::ListDataSourceRunActivitiesRequest& request) const;

  /**
   * A Callable wrapper for ListDataSourceRunActivities that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDataSourceRunActivitiesRequestT = Model::ListDataSourceRunActivitiesRequest>
  Model::ListDataSourceRunActivitiesOutcomeCallable ListDataSourceRunActivitiesCallable(
      const ListDataSourceRunActivitiesRequestT& request) const {
    return SubmitCallable(&DataZoneClient::ListDataSourceRunActivities, request);
  }

  /**
   * An Async wrapper for ListDataSourceRunActivities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataSourceRunActivitiesRequestT = Model::ListDataSourceRunActivitiesRequest>
  void ListDataSourceRunActivitiesAsync(const ListDataSourceRunActivitiesRequestT& request,
                                        const ListDataSourceRunActivitiesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDataSourceRuns that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDataSourceRuns that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDataSourceRunsRequestT = Model::ListDataSourceRunsRequest>
  void ListDataSourceRunsAsync(const ListDataSourceRunsRequestT& request, const ListDataSourceRunsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDomainUnitsForParent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDomainUnitsForParent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDomainUnitsForParentRequestT = Model::ListDomainUnitsForParentRequest>
  void ListDomainUnitsForParentAsync(const ListDomainUnitsForParentRequestT& request,
                                     const ListDomainUnitsForParentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEntityOwners that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEntityOwners that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEntityOwnersRequestT = Model::ListEntityOwnersRequest>
  void ListEntityOwnersAsync(const ListEntityOwnersRequestT& request, const ListEntityOwnersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEnvironmentActions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEnvironmentActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEnvironmentActionsRequestT = Model::ListEnvironmentActionsRequest>
  void ListEnvironmentActionsAsync(const ListEnvironmentActionsRequestT& request,
                                   const ListEnvironmentActionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEnvironmentBlueprintConfigurationsOutcome ListEnvironmentBlueprintConfigurations(
      const Model::ListEnvironmentBlueprintConfigurationsRequest& request) const;

  /**
   * A Callable wrapper for ListEnvironmentBlueprintConfigurations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListEnvironmentBlueprintConfigurationsRequestT = Model::ListEnvironmentBlueprintConfigurationsRequest>
  Model::ListEnvironmentBlueprintConfigurationsOutcomeCallable ListEnvironmentBlueprintConfigurationsCallable(
      const ListEnvironmentBlueprintConfigurationsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::ListEnvironmentBlueprintConfigurations, request);
  }

  /**
   * An Async wrapper for ListEnvironmentBlueprintConfigurations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListEnvironmentBlueprintConfigurationsRequestT = Model::ListEnvironmentBlueprintConfigurationsRequest>
  void ListEnvironmentBlueprintConfigurationsAsync(const ListEnvironmentBlueprintConfigurationsRequestT& request,
                                                   const ListEnvironmentBlueprintConfigurationsResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEnvironmentBlueprints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListEnvironmentBlueprintsRequestT = Model::ListEnvironmentBlueprintsRequest>
  Model::ListEnvironmentBlueprintsOutcomeCallable ListEnvironmentBlueprintsCallable(
      const ListEnvironmentBlueprintsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::ListEnvironmentBlueprints, request);
  }

  /**
   * An Async wrapper for ListEnvironmentBlueprints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEnvironmentBlueprintsRequestT = Model::ListEnvironmentBlueprintsRequest>
  void ListEnvironmentBlueprintsAsync(const ListEnvironmentBlueprintsRequestT& request,
                                      const ListEnvironmentBlueprintsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEnvironmentProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEnvironmentProfiles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEnvironmentProfilesRequestT = Model::ListEnvironmentProfilesRequest>
  void ListEnvironmentProfilesAsync(const ListEnvironmentProfilesRequestT& request,
                                    const ListEnvironmentProfilesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLineageEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLineageEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLineageEventsRequestT = Model::ListLineageEventsRequest>
  void ListLineageEventsAsync(const ListLineageEventsRequestT& request, const ListLineageEventsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLineageNodeHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLineageNodeHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLineageNodeHistoryRequestT = Model::ListLineageNodeHistoryRequest>
  void ListLineageNodeHistoryAsync(const ListLineageNodeHistoryRequestT& request,
                                   const ListLineageNodeHistoryResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMetadataGenerationRunsOutcome ListMetadataGenerationRuns(
      const Model::ListMetadataGenerationRunsRequest& request) const;

  /**
   * A Callable wrapper for ListMetadataGenerationRuns that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMetadataGenerationRunsRequestT = Model::ListMetadataGenerationRunsRequest>
  Model::ListMetadataGenerationRunsOutcomeCallable ListMetadataGenerationRunsCallable(
      const ListMetadataGenerationRunsRequestT& request) const {
    return SubmitCallable(&DataZoneClient::ListMetadataGenerationRuns, request);
  }

  /**
   * An Async wrapper for ListMetadataGenerationRuns that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMetadataGenerationRunsRequestT = Model::ListMetadataGenerationRunsRequest>
  void ListMetadataGenerationRunsAsync(const ListMetadataGenerationRunsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListPolicyGrants that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPolicyGrants that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPolicyGrantsRequestT = Model::ListPolicyGrantsRequest>
  void ListPolicyGrantsAsync(const ListPolicyGrantsRequestT& request, const ListPolicyGrantsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProjectMemberships that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProjectMemberships that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProjectMembershipsRequestT = Model::ListProjectMembershipsRequest>
  void ListProjectMembershipsAsync(const ListProjectMembershipsRequestT& request,
                                   const ListProjectMembershipsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProjectProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProjectProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProjectProfilesRequestT = Model::ListProjectProfilesRequest>
  void ListProjectProfilesAsync(const ListProjectProfilesRequestT& request, const ListProjectProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSubscriptionGrants that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSubscriptionGrants that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscriptionGrantsRequestT = Model::ListSubscriptionGrantsRequest>
  void ListSubscriptionGrantsAsync(const ListSubscriptionGrantsRequestT& request,
                                   const ListSubscriptionGrantsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSubscriptionRequests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSubscriptionRequests that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscriptionRequestsRequestT = Model::ListSubscriptionRequestsRequest>
  void ListSubscriptionRequestsAsync(const ListSubscriptionRequestsRequestT& request,
                                     const ListSubscriptionRequestsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSubscriptionTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSubscriptionTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscriptionTargetsRequestT = Model::ListSubscriptionTargetsRequest>
  void ListSubscriptionTargetsAsync(const ListSubscriptionTargetsRequestT& request,
                                    const ListSubscriptionTargetsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTimeSeriesDataPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTimeSeriesDataPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTimeSeriesDataPointsRequestT = Model::ListTimeSeriesDataPointsRequest>
  void ListTimeSeriesDataPointsAsync(const ListTimeSeriesDataPointsRequestT& request,
                                     const ListTimeSeriesDataPointsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PostLineageEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PostLineageEvent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PostLineageEventRequestT = Model::PostLineageEventRequest>
  void PostLineageEventAsync(const PostLineageEventRequestT& request, const PostLineageEventResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PostTimeSeriesDataPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PostTimeSeriesDataPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PostTimeSeriesDataPointsRequestT = Model::PostTimeSeriesDataPointsRequest>
  void PostTimeSeriesDataPointsAsync(const PostTimeSeriesDataPointsRequestT& request,
                                     const PostTimeSeriesDataPointsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutEnvironmentBlueprintConfigurationOutcome PutEnvironmentBlueprintConfiguration(
      const Model::PutEnvironmentBlueprintConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutEnvironmentBlueprintConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutEnvironmentBlueprintConfigurationRequestT = Model::PutEnvironmentBlueprintConfigurationRequest>
  Model::PutEnvironmentBlueprintConfigurationOutcomeCallable PutEnvironmentBlueprintConfigurationCallable(
      const PutEnvironmentBlueprintConfigurationRequestT& request) const {
    return SubmitCallable(&DataZoneClient::PutEnvironmentBlueprintConfiguration, request);
  }

  /**
   * An Async wrapper for PutEnvironmentBlueprintConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutEnvironmentBlueprintConfigurationRequestT = Model::PutEnvironmentBlueprintConfigurationRequest>
  void PutEnvironmentBlueprintConfigurationAsync(const PutEnvironmentBlueprintConfigurationRequestT& request,
                                                 const PutEnvironmentBlueprintConfigurationResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectPredictions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectPredictions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RejectPredictionsRequestT = Model::RejectPredictionsRequest>
  void RejectPredictionsAsync(const RejectPredictionsRequestT& request, const RejectPredictionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectSubscriptionRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename RejectSubscriptionRequestRequestT = Model::RejectSubscriptionRequestRequest>
  Model::RejectSubscriptionRequestOutcomeCallable RejectSubscriptionRequestCallable(
      const RejectSubscriptionRequestRequestT& request) const {
    return SubmitCallable(&DataZoneClient::RejectSubscriptionRequest, request);
  }

  /**
   * An Async wrapper for RejectSubscriptionRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectSubscriptionRequestRequestT = Model::RejectSubscriptionRequestRequest>
  void RejectSubscriptionRequestAsync(const RejectSubscriptionRequestRequestT& request,
                                      const RejectSubscriptionRequestResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveEntityOwner that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveEntityOwner that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RemoveEntityOwnerRequestT = Model::RemoveEntityOwnerRequest>
  void RemoveEntityOwnerAsync(const RemoveEntityOwnerRequestT& request, const RemoveEntityOwnerResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemovePolicyGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemovePolicyGrant that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RemovePolicyGrantRequestT = Model::RemovePolicyGrantRequest>
  void RemovePolicyGrantAsync(const RemovePolicyGrantRequestT& request, const RemovePolicyGrantResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RevokeSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RevokeSubscription that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RevokeSubscriptionRequestT = Model::RevokeSubscriptionRequest>
  void RevokeSubscriptionAsync(const RevokeSubscriptionRequestT& request, const RevokeSubscriptionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchGroupProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchGroupProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchGroupProfilesRequestT = Model::SearchGroupProfilesRequest>
  void SearchGroupProfilesAsync(const SearchGroupProfilesRequestT& request, const SearchGroupProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename SearchListingsRequestT = Model::SearchListingsRequest>
  void SearchListingsAsync(const SearchListingsRequestT& request, const SearchListingsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchTypesRequestT = Model::SearchTypesRequest>
  void SearchTypesAsync(const SearchTypesRequestT& request, const SearchTypesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SearchUserProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchUserProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SearchUserProfilesRequestT = Model::SearchUserProfilesRequest>
  void SearchUserProfilesAsync(const SearchUserProfilesRequestT& request, const SearchUserProfilesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartDataSourceRun that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartDataSourceRun that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartDataSourceRunRequestT = Model::StartDataSourceRunRequest>
  void StartDataSourceRunAsync(const StartDataSourceRunRequestT& request, const StartDataSourceRunResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartMetadataGenerationRunOutcome StartMetadataGenerationRun(
      const Model::StartMetadataGenerationRunRequest& request) const;

  /**
   * A Callable wrapper for StartMetadataGenerationRun that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartMetadataGenerationRunRequestT = Model::StartMetadataGenerationRunRequest>
  Model::StartMetadataGenerationRunOutcomeCallable StartMetadataGenerationRunCallable(
      const StartMetadataGenerationRunRequestT& request) const {
    return SubmitCallable(&DataZoneClient::StartMetadataGenerationRun, request);
  }

  /**
   * An Async wrapper for StartMetadataGenerationRun that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMetadataGenerationRunRequestT = Model::StartMetadataGenerationRunRequest>
  void StartMetadataGenerationRunAsync(const StartMetadataGenerationRunRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateAccountPool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAccountPool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAccountPoolRequestT = Model::UpdateAccountPoolRequest>
  void UpdateAccountPoolAsync(const UpdateAccountPoolRequestT& request, const UpdateAccountPoolResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAssetFilter that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAssetFilter that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAssetFilterRequestT = Model::UpdateAssetFilterRequest>
  void UpdateAssetFilterAsync(const UpdateAssetFilterRequestT& request, const UpdateAssetFilterResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainUnit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainUnit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDomainUnitRequestT = Model::UpdateDomainUnitRequest>
  void UpdateDomainUnitAsync(const UpdateDomainUnitRequestT& request, const UpdateDomainUnitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEnvironmentAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEnvironmentAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnvironmentActionRequestT = Model::UpdateEnvironmentActionRequest>
  void UpdateEnvironmentActionAsync(const UpdateEnvironmentActionRequestT& request,
                                    const UpdateEnvironmentActionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEnvironmentBlueprintOutcome UpdateEnvironmentBlueprint(
      const Model::UpdateEnvironmentBlueprintRequest& request) const;

  /**
   * A Callable wrapper for UpdateEnvironmentBlueprint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEnvironmentBlueprintRequestT = Model::UpdateEnvironmentBlueprintRequest>
  Model::UpdateEnvironmentBlueprintOutcomeCallable UpdateEnvironmentBlueprintCallable(
      const UpdateEnvironmentBlueprintRequestT& request) const {
    return SubmitCallable(&DataZoneClient::UpdateEnvironmentBlueprint, request);
  }

  /**
   * An Async wrapper for UpdateEnvironmentBlueprint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnvironmentBlueprintRequestT = Model::UpdateEnvironmentBlueprintRequest>
  void UpdateEnvironmentBlueprintAsync(const UpdateEnvironmentBlueprintRequestT& request,
                                       const UpdateEnvironmentBlueprintResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEnvironmentProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEnvironmentProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateEnvironmentProfileRequestT = Model::UpdateEnvironmentProfileRequest>
  void UpdateEnvironmentProfileAsync(const UpdateEnvironmentProfileRequestT& request,
                                     const UpdateEnvironmentProfileResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateGroupProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGroupProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateGroupProfileRequestT = Model::UpdateGroupProfileRequest>
  ...
  /**
   * A Callable wrapper for UpdateProjectProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProjectProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProjectProfileRequestT = Model::UpdateProjectProfileRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSubscriptionGrantStatusOutcome UpdateSubscriptionGrantStatus(
      const Model::UpdateSubscriptionGrantStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdateSubscriptionGrantStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSubscriptionGrantStatusRequestT = Model::UpdateSubscriptionGrantStatusRequest>
  Model::UpdateSubscriptionGrantStatusOutcomeCallable UpdateSubscriptionGrantStatusCallable(
      const UpdateSubscriptionGrantStatusRequestT& request) const {
    return SubmitCallable(&DataZoneClient::UpdateSubscriptionGrantStatus, request);
  }

  /**
   * An Async wrapper for UpdateSubscriptionGrantStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSubscriptionGrantStatusRequestT = Model::UpdateSubscriptionGrantStatusRequest>
  void UpdateSubscriptionGrantStatusAsync(const UpdateSubscriptionGrantStatusRequestT& request,
                                          const UpdateSubscriptionGrantStatusResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSubscriptionRequest that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateSubscriptionRequestRequestT = Model::UpdateSubscriptionRequestRequest>
  Model::UpdateSubscriptionRequestOutcomeCallable UpdateSubscriptionRequestCallable(
      const UpdateSubscriptionRequestRequestT& request) const {
    return SubmitCallable(&DataZoneClient::UpdateSubscriptionRequest, request);
  }

  /**
   * An Async wrapper for UpdateSubscriptionRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSubscriptionRequestRequestT = Model::UpdateSubscriptionRequestRequest>
  void UpdateSubscriptionRequestAsync(const UpdateSubscriptionRequestRequestT& request,
                                      const UpdateSubscriptionRequestResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSubscriptionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSubscriptionTarget that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSubscriptionTargetRequestT = Model::UpdateSubscriptionTargetRequest>
  void UpdateSubscriptionTargetAsync(const UpdateSubscriptionTargetRequestT& request,
                                     const UpdateSubscriptionTargetResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
