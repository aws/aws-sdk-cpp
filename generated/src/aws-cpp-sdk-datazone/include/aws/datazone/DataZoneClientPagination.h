...
using ListNotebooksPaginator = Aws::Utils::Pagination::Paginator<DataZoneClient, Model::ListNotebooksRequest,
                                                                 Pagination::ListNotebooksPaginationTraits<DataZoneClient>>;
