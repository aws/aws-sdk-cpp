...
GetEnvironmentBlueprintResult::GetEnvironmentBlueprintResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetEnvironmentBlueprintResult& GetEnvironmentBlueprintResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
