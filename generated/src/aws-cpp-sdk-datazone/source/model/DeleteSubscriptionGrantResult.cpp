...
DeleteSubscriptionGrantResult::DeleteSubscriptionGrantResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteSubscriptionGrantResult& DeleteSubscriptionGrantResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
