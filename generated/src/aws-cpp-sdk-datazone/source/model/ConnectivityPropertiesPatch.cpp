...
ConnectivityPropertiesPatch::ConnectivityPropertiesPatch(JsonView jsonValue) { *this = jsonValue; }

ConnectivityPropertiesPatch& ConnectivityPropertiesPatch::operator=(JsonView jsonValue) {
...
JsonValue ConnectivityPropertiesPatch::Jsonize() const {
  JsonValue payload;
