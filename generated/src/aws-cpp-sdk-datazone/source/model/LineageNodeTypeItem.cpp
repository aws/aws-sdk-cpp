...
LineageNodeTypeItem::LineageNodeTypeItem(JsonView jsonValue) { *this = jsonValue; }

LineageNodeTypeItem& LineageNodeTypeItem::operator=(JsonView jsonValue) {
...
JsonValue LineageNodeTypeItem::Jsonize() const {
  JsonValue payload;
