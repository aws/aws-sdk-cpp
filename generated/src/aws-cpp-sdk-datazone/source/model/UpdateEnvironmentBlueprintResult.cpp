...
UpdateEnvironmentBlueprintResult::UpdateEnvironmentBlueprintResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateEnvironmentBlueprintResult& UpdateEnvironmentBlueprintResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
