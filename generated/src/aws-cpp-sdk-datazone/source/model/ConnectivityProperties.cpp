...
ConnectivityProperties::ConnectivityProperties(JsonView jsonValue) { *this = jsonValue; }

ConnectivityProperties& ConnectivityProperties::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("validateForComputeEnvironments")) {
    ...
    for (unsigned validateForComputeEnvironmentsIndex = 0;
      ...
      m_validateForComputeEnvironments.push_back(ComputeEnvironmentsMapper::GetComputeEnvironmentsForName(
...
JsonValue ConnectivityProperties::Jsonize() const {
  JsonValue payload;
