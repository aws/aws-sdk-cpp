...
GetAssetFilterResult::GetAssetFilterResult() : 
    m_status(FilterStatus::NOT_SET)
{
}

GetAssetFilterResult::GetAssetFilterResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
  : GetAssetFilterResult()
{
  *this = result;
}

GetAssetFilterResult& GetAssetFilterResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
