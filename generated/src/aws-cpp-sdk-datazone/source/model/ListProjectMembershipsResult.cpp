...
ListProjectMembershipsResult::ListProjectMembershipsResult()
{
}

ListProjectMembershipsResult::ListProjectMembershipsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListProjectMembershipsResult& ListProjectMembershipsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
