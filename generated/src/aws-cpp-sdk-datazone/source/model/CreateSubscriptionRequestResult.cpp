...
CreateSubscriptionRequestResult::CreateSubscriptionRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateSubscriptionRequestResult& CreateSubscriptionRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
