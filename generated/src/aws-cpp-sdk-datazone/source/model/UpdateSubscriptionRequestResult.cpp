...
UpdateSubscriptionRequestResult::UpdateSubscriptionRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateSubscriptionRequestResult& UpdateSubscriptionRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
