...
AttributeInput::AttributeInput(JsonView jsonValue) { *this = jsonValue; }

AttributeInput& AttributeInput::operator=(JsonView jsonValue) {
...
JsonValue AttributeInput::Jsonize() const {
  JsonValue payload;
