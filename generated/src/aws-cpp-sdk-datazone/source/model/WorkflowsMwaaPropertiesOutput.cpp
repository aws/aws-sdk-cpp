...
WorkflowsMwaaPropertiesOutput::WorkflowsMwaaPropertiesOutput(JsonView jsonValue) { *this = jsonValue; }

WorkflowsMwaaPropertiesOutput& WorkflowsMwaaPropertiesOutput::operator=(JsonView jsonValue) {
...
JsonValue WorkflowsMwaaPropertiesOutput::Jsonize() const {
  JsonValue payload;
