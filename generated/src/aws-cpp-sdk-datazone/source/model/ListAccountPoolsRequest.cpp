...
Aws::String ListAccountPoolsRequest::SerializePayload() const { return {}; }

void ListAccountPoolsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
  if (m_nameHasBeenSet) {
    ss << m_name;
  ...
  if (m_sortByHasBeenSet) {
    ss << SortFieldAccountPoolMapper::GetNameForSortFieldAccountPool(m_sortBy);
