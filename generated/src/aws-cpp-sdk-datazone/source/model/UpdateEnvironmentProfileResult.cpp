...
UpdateEnvironmentProfileResult::UpdateEnvironmentProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateEnvironmentProfileResult& UpdateEnvironmentProfileResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
