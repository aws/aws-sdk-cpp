...
UpdateEnvironmentResult& UpdateEnvironmentResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("provisionedResources")) {
    ...
    for (unsigned provisionedResourcesIndex = 0; provisionedResourcesIndex < provisionedResourcesJsonList.GetLength();
         ++provisionedResourcesIndex) {
  ...
  if (jsonValue.ValueExists("environmentActions")) {
    ...
    for (unsigned environmentActionsIndex = 0; environmentActionsIndex < environmentActionsJsonList.GetLength();
         ++environmentActionsIndex) {
