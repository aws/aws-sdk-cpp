...
CreateGlossaryPolicyGrantDetail::CreateGlossaryPolicyGrantDetail(JsonView jsonValue) { *this = jsonValue; }

CreateGlossaryPolicyGrantDetail& CreateGlossaryPolicyGrantDetail::operator=(JsonView jsonValue) {
...
JsonValue CreateGlossaryPolicyGrantDetail::Jsonize() const {
  JsonValue payload;
