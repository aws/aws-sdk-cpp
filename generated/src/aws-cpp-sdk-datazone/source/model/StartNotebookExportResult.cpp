...
StartNotebookExportResult::StartNotebookExportResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartNotebookExportResult& StartNotebookExportResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
