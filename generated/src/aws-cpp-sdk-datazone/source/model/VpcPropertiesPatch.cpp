...
VpcPropertiesPatch::VpcPropertiesPatch(JsonView jsonValue) { *this = jsonValue; }

VpcPropertiesPatch& VpcPropertiesPatch::operator=(JsonView jsonValue) {
...
JsonValue VpcPropertiesPatch::Jsonize() const {
  JsonValue payload;
