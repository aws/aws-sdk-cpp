...
LakeFormationConfiguration& LakeFormationConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("locationRegistrationExcludeS3Locations")) {
    ...
    for (unsigned locationRegistrationExcludeS3LocationsIndex = 0;
         locationRegistrationExcludeS3LocationsIndex < locationRegistrationExcludeS3LocationsJsonList.GetLength();
         ++locationRegistrationExcludeS3LocationsIndex) {
      m_locationRegistrationExcludeS3Locations.push_back(
          locationRegistrationExcludeS3LocationsJsonList[locationRegistrationExcludeS3LocationsIndex].AsString());
    }
