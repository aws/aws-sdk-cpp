...
SubscriptionRequestSummary::SubscriptionRequestSummary(JsonView jsonValue) { *this = jsonValue; }
...
SubscriptionRequestSummary& SubscriptionRequestSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("metadataFormsSummary")) {
    ...
    for (unsigned metadataFormsSummaryIndex = 0; metadataFormsSummaryIndex < metadataFormsSummaryJsonList.GetLength();
         ++metadataFormsSummaryIndex) {
