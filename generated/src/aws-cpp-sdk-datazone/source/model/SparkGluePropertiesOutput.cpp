...
SparkGluePropertiesOutput::SparkGluePropertiesOutput(JsonView jsonValue) { *this = jsonValue; }

SparkGluePropertiesOutput& SparkGluePropertiesOutput::operator=(JsonView jsonValue) {
...
JsonValue SparkGluePropertiesOutput::Jsonize() const {
  JsonValue payload;
