...
GetNotebookResult::GetNotebookResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetNotebookResult& GetNotebookResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
