...
LakehousePropertiesInput::LakehousePropertiesInput(JsonView jsonValue) { *this = jsonValue; }

LakehousePropertiesInput& LakehousePropertiesInput::operator=(JsonView jsonValue) {
...
JsonValue LakehousePropertiesInput::Jsonize() const {
  JsonValue payload;
