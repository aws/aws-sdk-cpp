...
LakehousePropertiesOutput::LakehousePropertiesOutput(JsonView jsonValue) { *this = jsonValue; }

LakehousePropertiesOutput& LakehousePropertiesOutput::operator=(JsonView jsonValue) {
...
JsonValue LakehousePropertiesOutput::Jsonize() const {
  JsonValue payload;
