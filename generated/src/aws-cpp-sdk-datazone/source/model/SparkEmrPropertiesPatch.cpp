...
SparkEmrPropertiesPatch::SparkEmrPropertiesPatch(JsonView jsonValue) { *this = jsonValue; }

SparkEmrPropertiesPatch& SparkEmrPropertiesPatch::operator=(JsonView jsonValue) {
...
JsonValue SparkEmrPropertiesPatch::Jsonize() const {
  JsonValue payload;
