...
UpdateEnvironmentActionResult::UpdateEnvironmentActionResult()
{
}

UpdateEnvironmentActionResult::UpdateEnvironmentActionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
