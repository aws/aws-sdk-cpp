...
CreateFormTypePolicyGrantDetail::CreateFormTypePolicyGrantDetail(JsonView jsonValue) { *this = jsonValue; }

CreateFormTypePolicyGrantDetail& CreateFormTypePolicyGrantDetail::operator=(JsonView jsonValue) {
...
JsonValue CreateFormTypePolicyGrantDetail::Jsonize() const {
  JsonValue payload;
