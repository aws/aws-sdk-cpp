...
RedshiftRunConfigurationOutput::RedshiftRunConfigurationOutput(JsonView jsonValue) { *this = jsonValue; }
...
RedshiftRunConfigurationOutput& RedshiftRunConfigurationOutput::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("relationalFilterConfigurations")) {
    ...
    for (unsigned relationalFilterConfigurationsIndex = 0;
         relationalFilterConfigurationsIndex < relationalFilterConfigurationsJsonList.GetLength(); ++relationalFilterConfigurationsIndex) {
...
JsonValue RedshiftRunConfigurationOutput::Jsonize() const {
  ...
  if (m_relationalFilterConfigurationsHasBeenSet) {
    ...
    for (unsigned relationalFilterConfigurationsIndex = 0;
         relationalFilterConfigurationsIndex < relationalFilterConfigurationsJsonList.GetLength(); ++relationalFilterConfigurationsIndex) {
      relationalFilterConfigurationsJsonList[relationalFilterConfigurationsIndex].AsObject(
