...
GetUserProfileResult::GetUserProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetUserProfileResult& GetUserProfileResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
