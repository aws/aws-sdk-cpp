...
GetSubscriptionGrantResult::GetSubscriptionGrantResult() : 
    m_status(SubscriptionGrantOverallStatus::NOT_SET)
{
}

GetSubscriptionGrantResult::GetSubscriptionGrantResult(const Aws::AmazonWebServiceResult<JsonValue>& result) : 
    m_status(SubscriptionGrantOverallStatus::NOT_SET)
{
  *this = result;
}

GetSubscriptionGrantResult& GetSubscriptionGrantResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
