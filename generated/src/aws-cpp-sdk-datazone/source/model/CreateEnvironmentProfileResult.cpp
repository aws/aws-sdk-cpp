...
CreateEnvironmentProfileResult::CreateEnvironmentProfileResult()
{
}

CreateEnvironmentProfileResult::CreateEnvironmentProfileResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateEnvironmentProfileResult& CreateEnvironmentProfileResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
