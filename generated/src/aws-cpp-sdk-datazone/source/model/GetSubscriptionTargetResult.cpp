...
GetSubscriptionTargetResult::GetSubscriptionTargetResult()
{
}

GetSubscriptionTargetResult::GetSubscriptionTargetResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
