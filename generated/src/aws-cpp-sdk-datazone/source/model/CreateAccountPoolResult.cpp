...
CreateAccountPoolResult::CreateAccountPoolResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateAccountPoolResult& CreateAccountPoolResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  JsonView jsonValue = result.GetPayload().View();
  if (jsonValue.ValueExists("accountSource")) {
    m_accountSource = jsonValue.GetObject("accountSource");
