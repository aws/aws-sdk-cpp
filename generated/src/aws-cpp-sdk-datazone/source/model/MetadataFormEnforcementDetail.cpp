...
MetadataFormEnforcementDetail::MetadataFormEnforcementDetail(JsonView jsonValue) { *this = jsonValue; }
...
MetadataFormEnforcementDetail& MetadataFormEnforcementDetail::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("requiredMetadataForms")) {
    ...
    for (unsigned requiredMetadataFormsIndex = 0; requiredMetadataFormsIndex < requiredMetadataFormsJsonList.GetLength();
         ++requiredMetadataFormsIndex) {
