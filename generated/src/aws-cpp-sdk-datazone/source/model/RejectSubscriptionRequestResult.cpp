...
RejectSubscriptionRequestResult::RejectSubscriptionRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RejectSubscriptionRequestResult& RejectSubscriptionRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
