...
AssetTypesForRule::AssetTypesForRule(JsonView jsonValue) { *this = jsonValue; }
...
AssetTypesForRule& AssetTypesForRule::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("specificAssetTypes")) {
    ...
    for (unsigned specificAssetTypesIndex = 0; specificAssetTypesIndex < specificAssetTypesJsonList.GetLength();
         ++specificAssetTypesIndex) {
