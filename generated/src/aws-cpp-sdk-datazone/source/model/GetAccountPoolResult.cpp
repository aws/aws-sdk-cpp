...
GetAccountPoolResult::GetAccountPoolResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAccountPoolResult& GetAccountPoolResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
