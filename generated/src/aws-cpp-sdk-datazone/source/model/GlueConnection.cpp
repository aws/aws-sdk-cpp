...
GlueConnection::GlueConnection(JsonView jsonValue) { *this = jsonValue; }
...
GlueConnection& GlueConnection::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("compatibleComputeEnvironments")) {
    ...
    for (unsigned compatibleComputeEnvironmentsIndex = 0;
         compatibleComputeEnvironmentsIndex < compatibleComputeEnvironmentsJsonList.GetLength(); ++compatibleComputeEnvironmentsIndex) {
      m_compatibleComputeEnvironments.push_back(ComputeEnvironmentsMapper::GetComputeEnvironmentsForName(
          compatibleComputeEnvironmentsJsonList[compatibleComputeEnvironmentsIndex].AsString()));
    }
...
JsonValue GlueConnection::Jsonize() const {
  ...
  if (m_compatibleComputeEnvironmentsHasBeenSet) {
    ...
    for (unsigned compatibleComputeEnvironmentsIndex = 0;
         compatibleComputeEnvironmentsIndex < compatibleComputeEnvironmentsJsonList.GetLength(); ++compatibleComputeEnvironmentsIndex) {
      compatibleComputeEnvironmentsJsonList[compatibleComputeEnvironmentsIndex].AsString(
          ComputeEnvironmentsMapper::GetNameForComputeEnvironments(m_compatibleComputeEnvironments[compatibleComputeEnvironmentsIndex]));
    }
