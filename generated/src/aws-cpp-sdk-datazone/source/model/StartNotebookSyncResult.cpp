...
StartNotebookSyncResult::StartNotebookSyncResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartNotebookSyncResult& StartNotebookSyncResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
