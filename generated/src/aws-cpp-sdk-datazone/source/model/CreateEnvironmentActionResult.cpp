...
CreateEnvironmentActionResult::CreateEnvironmentActionResult()
{
}

CreateEnvironmentActionResult::CreateEnvironmentActionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
