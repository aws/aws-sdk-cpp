...
LakehousePropertiesPatch::LakehousePropertiesPatch(JsonView jsonValue) { *this = jsonValue; }

LakehousePropertiesPatch& LakehousePropertiesPatch::operator=(JsonView jsonValue) {
...
JsonValue LakehousePropertiesPatch::Jsonize() const {
  JsonValue payload;
