...
RedshiftSelfGrantStatusOutput::RedshiftSelfGrantStatusOutput(JsonView jsonValue) { *this = jsonValue; }
...
RedshiftSelfGrantStatusOutput& RedshiftSelfGrantStatusOutput::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("selfGrantStatusDetails")) {
    ...
    for (unsigned selfGrantStatusDetailsIndex = 0; selfGrantStatusDetailsIndex < selfGrantStatusDetailsJsonList.GetLength();
         ++selfGrantStatusDetailsIndex) {
