...
class DescribeAvailabilityOptionsResult {
 public:
  ...
  void SetAvailabilityOptions(AvailabilityOptionsT&& value) {
    m_availabilityOptionsHasBeenSet = true;
    m_availabilityOptions = std::forward<AvailabilityOptionsT>(value);
  }
  template <typename AvailabilityOptionsT = AvailabilityOptionsStatus>
  DescribeAvailabilityOptionsResult& WithAvailabilityOptions(AvailabilityOptionsT&& value) {
    SetAvailabilityOptions(std::forward<AvailabilityOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAvailabilityOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
