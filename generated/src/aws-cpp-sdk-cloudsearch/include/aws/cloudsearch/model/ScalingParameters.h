...
class ScalingParameters {
 public:
  ...
  inline void SetDesiredInstanceType(PartitionInstanceType value) {
    m_desiredInstanceTypeHasBeenSet = true;
    m_desiredInstanceType = value;
  }
  inline ScalingParameters& WithDesiredInstanceType(PartitionInstanceType value) {
    SetDesiredInstanceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredReplicationCount(int value) {
    m_desiredReplicationCountHasBeenSet = true;
    m_desiredReplicationCount = value;
  }
  inline ScalingParameters& WithDesiredReplicationCount(int value) {
    SetDesiredReplicationCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredPartitionCount(int value) {
    m_desiredPartitionCountHasBeenSet = true;
    m_desiredPartitionCount = value;
  }
  inline ScalingParameters& WithDesiredPartitionCount(int value) {
    SetDesiredPartitionCount(value);
    return *this;
  }
  ///@}
 private:
