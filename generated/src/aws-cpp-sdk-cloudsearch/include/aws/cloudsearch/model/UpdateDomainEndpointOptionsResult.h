...
class UpdateDomainEndpointOptionsResult {
 public:
  ...
  template <typename DomainEndpointOptionsT = DomainEndpointOptionsStatus>
  UpdateDomainEndpointOptionsResult& WithDomainEndpointOptions(DomainEndpointOptionsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UpdateDomainEndpointOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
