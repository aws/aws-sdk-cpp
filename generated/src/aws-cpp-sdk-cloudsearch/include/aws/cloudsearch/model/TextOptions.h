...
class TextOptions {
 public:
  ...
  void SetSourceField(SourceFieldT&& value) {
    ...
    m_sourceField = std::forward<SourceFieldT>(value);
  }
  template <typename SourceFieldT = Aws::String>
  TextOptions& WithSourceField(SourceFieldT&& value) {
    SetSourceField(std::forward<SourceFieldT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReturnEnabled(bool value) {
    m_returnEnabledHasBeenSet = true;
    m_returnEnabled = value;
  }
  inline TextOptions& WithReturnEnabled(bool value) {
    SetReturnEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortEnabled(bool value) {
    m_sortEnabledHasBeenSet = true;
    m_sortEnabled = value;
  }
  inline TextOptions& WithSortEnabled(bool value) {
  ...
  inline void SetHighlightEnabled(bool value) {
    m_highlightEnabledHasBeenSet = true;
    m_highlightEnabled = value;
  }
  inline TextOptions& WithHighlightEnabled(bool value) {
  ...
  void SetAnalysisScheme(AnalysisSchemeT&& value) {
    ...
    m_analysisScheme = std::forward<AnalysisSchemeT>(value);
  }
  template <typename AnalysisSchemeT = Aws::String>
  TextOptions& WithAnalysisScheme(AnalysisSchemeT&& value) {
    SetAnalysisScheme(std::forward<AnalysisSchemeT>(value));
    return *this;
  }
  ///@}
 private:
