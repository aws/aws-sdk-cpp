...
class DocumentSuggesterOptions {
 public:
  ...
  inline void SetFuzzyMatching(SuggesterFuzzyMatching value) {
    m_fuzzyMatchingHasBeenSet = true;
    m_fuzzyMatching = value;
  }
  inline DocumentSuggesterOptions& WithFuzzyMatching(SuggesterFuzzyMatching value) {
    SetFuzzyMatching(value);
    return *this;
  }
  ///@}
  ...
  void SetSortExpression(SortExpressionT&& value) {
    ...
    m_sortExpression = std::forward<SortExpressionT>(value);
  }
  template <typename SortExpressionT = Aws::String>
  DocumentSuggesterOptions& WithSortExpression(SortExpressionT&& value) {
    SetSortExpression(std::forward<SortExpressionT>(value));
    return *this;
  }
  ///@}
 private:
