...
class DoubleOptions {
 public:
  ...
  inline DoubleOptions& WithDefaultValue(double value) {
  ...
  inline DoubleOptions& WithFacetEnabled(bool value) {
  ...
  inline DoubleOptions& WithSearchEnabled(bool value) {
  ...
  inline DoubleOptions& WithReturnEnabled(bool value) {
  ...
  inline DoubleOptions& WithSortEnabled(bool value) {
