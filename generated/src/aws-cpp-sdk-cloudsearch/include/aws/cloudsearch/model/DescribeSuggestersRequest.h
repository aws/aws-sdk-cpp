...
class DescribeSuggestersRequest : public CloudSearchRequest {
 ...
 public:
  ...
  void SetSuggesterNames(SuggesterNamesT&& value) {
    m_suggesterNamesHasBeenSet = true;
    m_suggesterNames = std::forward<SuggesterNamesT>(value);
  }
  template <typename SuggesterNamesT = Aws::Vector<Aws::String>>
  DescribeSuggestersRequest& WithSuggesterNames(SuggesterNamesT&& value) {
    SetSuggesterNames(std::forward<SuggesterNamesT>(value));
    return *this;
  }
  template <typename SuggesterNamesT = Aws::String>
  DescribeSuggestersRequest& AddSuggesterNames(SuggesterNamesT&& value) {
    m_suggesterNamesHasBeenSet = true;
    m_suggesterNames.emplace_back(std::forward<SuggesterNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSuggestersRequest& WithDeployed(bool value) {
    SetDeployed(value);
    return *this;
  }
  ///@}
