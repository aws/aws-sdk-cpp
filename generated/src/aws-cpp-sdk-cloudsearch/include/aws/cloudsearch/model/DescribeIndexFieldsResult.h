...
class DescribeIndexFieldsResult {
 public:
  ...
  void SetIndexFields(IndexFieldsT&& value) {
    m_indexFieldsHasBeenSet = true;
    m_indexFields = std::forward<IndexFieldsT>(value);
  }
  template <typename IndexFieldsT = Aws::Vector<IndexFieldStatus>>
  DescribeIndexFieldsResult& WithIndexFields(IndexFieldsT&& value) {
    SetIndexFields(std::forward<IndexFieldsT>(value));
    return *this;
  }
  template <typename IndexFieldsT = IndexFieldStatus>
  DescribeIndexFieldsResult& AddIndexFields(IndexFieldsT&& value) {
    m_indexFieldsHasBeenSet = true;
    m_indexFields.emplace_back(std::forward<IndexFieldsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeIndexFieldsResult& WithResponseMetadata(ResponseMetadataT&& value) {
