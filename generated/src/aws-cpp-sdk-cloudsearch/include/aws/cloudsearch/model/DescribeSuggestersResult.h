...
class DescribeSuggestersResult {
 public:
  ...
  void SetSuggesters(SuggestersT&& value) {
    m_suggestersHasBeenSet = true;
    m_suggesters = std::forward<SuggestersT>(value);
  }
  template <typename SuggestersT = Aws::Vector<SuggesterStatus>>
  DescribeSuggestersResult& WithSuggesters(SuggestersT&& value) {
    SetSuggesters(std::forward<SuggestersT>(value));
    return *this;
  }
  template <typename SuggestersT = SuggesterStatus>
  DescribeSuggestersResult& AddSuggesters(SuggestersT&& value) {
    m_suggestersHasBeenSet = true;
    m_suggesters.emplace_back(std::forward<SuggestersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSuggestersResult& WithResponseMetadata(ResponseMetadataT&& value) {
