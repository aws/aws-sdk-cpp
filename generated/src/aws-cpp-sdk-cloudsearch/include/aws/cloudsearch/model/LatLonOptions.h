...
namespace Model
{
  ...
  public:
    ...
    template<typename DefaultValueT = Aws::String>
    LatLonOptions& WithDefaultValue(DefaultValueT&& value) { SetDefaultValue(std::forward<DefaultValueT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceFieldT = Aws::String>
    LatLonOptions& WithSourceField(SourceFieldT&& value) { SetSourceField(std::forward<SourceFieldT>(value)); return *this;}
    ///@}
