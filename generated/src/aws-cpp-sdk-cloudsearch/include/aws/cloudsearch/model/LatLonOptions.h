...
class LatLonOptions {
 public:
  ...
  inline LatLonOptions& WithFacetEnabled(bool value) {
  ...
  inline LatLonOptions& WithSearchEnabled(bool value) {
  ...
  inline LatLonOptions& WithReturnEnabled(bool value) {
  ...
  inline LatLonOptions& WithSortEnabled(bool value) {
