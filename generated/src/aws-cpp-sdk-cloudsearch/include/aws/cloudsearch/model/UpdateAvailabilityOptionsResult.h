...
class UpdateAvailabilityOptionsResult {
 public:
  ...
  template <typename AvailabilityOptionsT = AvailabilityOptionsStatus>
  UpdateAvailabilityOptionsResult& WithAvailabilityOptions(AvailabilityOptionsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UpdateAvailabilityOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
