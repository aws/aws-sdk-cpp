...
class IntArrayOptions {
 public:
  ...
  inline IntArrayOptions& WithDefaultValue(long long value) {
  ...
  inline IntArrayOptions& WithFacetEnabled(bool value) {
  ...
  inline IntArrayOptions& WithSearchEnabled(bool value) {
  ...
  inline IntArrayOptions& WithReturnEnabled(bool value) {
