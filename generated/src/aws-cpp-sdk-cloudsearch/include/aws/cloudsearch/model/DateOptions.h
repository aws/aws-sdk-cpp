...
class DateOptions {
 public:
  ...
  inline DateOptions& WithFacetEnabled(bool value) {
  ...
  inline DateOptions& WithSearchEnabled(bool value) {
  ...
  inline DateOptions& WithReturnEnabled(bool value) {
  ...
  inline DateOptions& WithSortEnabled(bool value) {
