...
class LiteralArrayOptions {
 public:
  ...
  inline LiteralArrayOptions& WithFacetEnabled(bool value) {
  ...
  inline LiteralArrayOptions& WithSearchEnabled(bool value) {
  ...
  inline LiteralArrayOptions& WithReturnEnabled(bool value) {
