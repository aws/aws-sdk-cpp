...
class BuildSuggestersResult {
 public:
  ...
  template <typename FieldNamesT = Aws::Vector<Aws::String>>
  BuildSuggestersResult& WithFieldNames(FieldNamesT&& value) {
    SetFieldNames(std::forward<FieldNamesT>(value));
    return *this;
  }
  template <typename FieldNamesT = Aws::String>
  BuildSuggestersResult& AddFieldNames(FieldNamesT&& value) {
    m_fieldNamesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  BuildSuggestersResult& WithResponseMetadata(ResponseMetadataT&& value) {
