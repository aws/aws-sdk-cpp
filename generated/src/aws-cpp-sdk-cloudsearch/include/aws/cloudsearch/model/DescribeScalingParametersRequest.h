...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDSEARCH_API DescribeScalingParametersRequest() = default;
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    DescribeScalingParametersRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
