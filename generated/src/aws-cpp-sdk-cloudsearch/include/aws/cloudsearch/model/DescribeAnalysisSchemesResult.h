...
class DescribeAnalysisSchemesResult {
 public:
  ...
  void SetAnalysisSchemes(AnalysisSchemesT&& value) {
    m_analysisSchemesHasBeenSet = true;
    m_analysisSchemes = std::forward<AnalysisSchemesT>(value);
  }
  template <typename AnalysisSchemesT = Aws::Vector<AnalysisSchemeStatus>>
  DescribeAnalysisSchemesResult& WithAnalysisSchemes(AnalysisSchemesT&& value) {
    SetAnalysisSchemes(std::forward<AnalysisSchemesT>(value));
    return *this;
  }
  template <typename AnalysisSchemesT = AnalysisSchemeStatus>
  DescribeAnalysisSchemesResult& AddAnalysisSchemes(AnalysisSchemesT&& value) {
    m_analysisSchemesHasBeenSet = true;
    m_analysisSchemes.emplace_back(std::forward<AnalysisSchemesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAnalysisSchemesResult& WithResponseMetadata(ResponseMetadataT&& value) {
