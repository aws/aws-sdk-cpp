...
class DomainStatus {
 public:
  ...
  void SetDocService(DocServiceT&& value) {
    ...
    m_docService = std::forward<DocServiceT>(value);
  }
  template <typename DocServiceT = ServiceEndpoint>
  DomainStatus& WithDocService(DocServiceT&& value) {
    SetDocService(std::forward<DocServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSearchService(SearchServiceT&& value) {
    ...
    m_searchService = std::forward<SearchServiceT>(value);
  }
  template <typename SearchServiceT = ServiceEndpoint>
  DomainStatus& WithSearchService(SearchServiceT&& value) {
    SetSearchService(std::forward<SearchServiceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRequiresIndexDocuments(bool value) {
    m_requiresIndexDocumentsHasBeenSet = true;
    m_requiresIndexDocuments = value;
  }
  inline DomainStatus& WithRequiresIndexDocuments(bool value) {
    SetRequiresIndexDocuments(value);
    return *this;
  }
  ///@}
  ...
  void SetSearchInstanceType(SearchInstanceTypeT&& value) {
    ...
    m_searchInstanceType = std::forward<SearchInstanceTypeT>(value);
  }
  template <typename SearchInstanceTypeT = Aws::String>
  DomainStatus& WithSearchInstanceType(SearchInstanceTypeT&& value) {
    SetSearchInstanceType(std::forward<SearchInstanceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSearchPartitionCount(int value) {
    m_searchPartitionCountHasBeenSet = true;
    m_searchPartitionCount = value;
  }
  inline DomainStatus& WithSearchPartitionCount(int value) {
    SetSearchPartitionCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSearchInstanceCount(int value) {
    m_searchInstanceCountHasBeenSet = true;
    m_searchInstanceCount = value;
  }
  inline DomainStatus& WithSearchInstanceCount(int value) {
    SetSearchInstanceCount(value);
    return *this;
  }
  ///@}
