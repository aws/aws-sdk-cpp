...
class DeleteAnalysisSchemeRequest : public CloudSearchRequest {
 ...
 public:
  ...
  template <typename DomainNameT = Aws::String>
  DeleteAnalysisSchemeRequest& WithDomainName(DomainNameT&& value) {
  ...
  void SetAnalysisSchemeName(AnalysisSchemeNameT&& value) {
    ...
    m_analysisSchemeName = std::forward<AnalysisSchemeNameT>(value);
  }
  template <typename AnalysisSchemeNameT = Aws::String>
  DeleteAnalysisSchemeRequest& WithAnalysisSchemeName(AnalysisSchemeNameT&& value) {
    SetAnalysisSchemeName(std::forward<AnalysisSchemeNameT>(value));
    return *this;
  }
  ///@}
 private:
