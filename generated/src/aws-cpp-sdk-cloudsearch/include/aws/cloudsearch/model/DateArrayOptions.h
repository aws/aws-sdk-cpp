...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDSEARCH_API DateArrayOptions();
    ...
    inline DateArrayOptions& WithDefaultValue(const Aws::String& value) { SetDefaultValue(value); return *this;}
    inline DateArrayOptions& WithDefaultValue(Aws::String&& value) { SetDefaultValue(std::move(value)); return *this;}
    ...
    inline DateArrayOptions& WithSourceFields(const Aws::String& value) { SetSourceFields(value); return *this;}
    inline DateArrayOptions& WithSourceFields(Aws::String&& value) { SetSourceFields(std::move(value)); return *this;}
