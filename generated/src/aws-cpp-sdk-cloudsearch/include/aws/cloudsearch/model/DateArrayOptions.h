...
class DateArrayOptions {
 public:
  ...
  inline DateArrayOptions& WithFacetEnabled(bool value) {
  ...
  inline DateArrayOptions& WithSearchEnabled(bool value) {
  ...
  inline DateArrayOptions& WithReturnEnabled(bool value) {
