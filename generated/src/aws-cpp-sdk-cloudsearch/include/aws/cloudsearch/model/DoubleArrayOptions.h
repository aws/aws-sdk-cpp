...
class DoubleArrayOptions {
 public:
  ...
  inline DoubleArrayOptions& WithDefaultValue(double value) {
  ...
  inline void SetFacetEnabled(bool value) {
    m_facetEnabledHasBeenSet = true;
    m_facetEnabled = value;
  }
  inline DoubleArrayOptions& WithFacetEnabled(bool value) {
    SetFacetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSearchEnabled(bool value) {
    m_searchEnabledHasBeenSet = true;
    m_searchEnabled = value;
  }
  inline DoubleArrayOptions& WithSearchEnabled(bool value) {
  ...
  inline DoubleArrayOptions& WithReturnEnabled(bool value) {
