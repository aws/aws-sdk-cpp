...
class IndexField {
 public:
  ...
  inline void SetIndexFieldType(IndexFieldType value) {
    m_indexFieldTypeHasBeenSet = true;
    m_indexFieldType = value;
  }
  inline IndexField& WithIndexFieldType(IndexFieldType value) {
    SetIndexFieldType(value);
    return *this;
  }
  ///@}
  ...
  void SetIntOptions(IntOptionsT&& value) {
    ...
    m_intOptions = std::forward<IntOptionsT>(value);
  }
  template <typename IntOptionsT = IntOptions>
  IndexField& WithIntOptions(IntOptionsT&& value) {
    SetIntOptions(std::forward<IntOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDoubleOptions(DoubleOptionsT&& value) {
    ...
    m_doubleOptions = std::forward<DoubleOptionsT>(value);
  }
  template <typename DoubleOptionsT = DoubleOptions>
  IndexField& WithDoubleOptions(DoubleOptionsT&& value) {
    SetDoubleOptions(std::forward<DoubleOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLiteralOptions(LiteralOptionsT&& value) {
    ...
    m_literalOptions = std::forward<LiteralOptionsT>(value);
  }
  template <typename LiteralOptionsT = LiteralOptions>
  IndexField& WithLiteralOptions(LiteralOptionsT&& value) {
    SetLiteralOptions(std::forward<LiteralOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextOptions(TextOptionsT&& value) {
    ...
    m_textOptions = std::forward<TextOptionsT>(value);
  }
  template <typename TextOptionsT = TextOptions>
  IndexField& WithTextOptions(TextOptionsT&& value) {
    SetTextOptions(std::forward<TextOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateOptions(DateOptionsT&& value) {
    ...
    m_dateOptions = std::forward<DateOptionsT>(value);
  }
  template <typename DateOptionsT = DateOptions>
  IndexField& WithDateOptions(DateOptionsT&& value) {
    SetDateOptions(std::forward<DateOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLatLonOptions(LatLonOptionsT&& value) {
    ...
    m_latLonOptions = std::forward<LatLonOptionsT>(value);
  }
  template <typename LatLonOptionsT = LatLonOptions>
  IndexField& WithLatLonOptions(LatLonOptionsT&& value) {
    SetLatLonOptions(std::forward<LatLonOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntArrayOptions(IntArrayOptionsT&& value) {
    ...
    m_intArrayOptions = std::forward<IntArrayOptionsT>(value);
  }
  template <typename IntArrayOptionsT = IntArrayOptions>
  IndexField& WithIntArrayOptions(IntArrayOptionsT&& value) {
    SetIntArrayOptions(std::forward<IntArrayOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDoubleArrayOptions(DoubleArrayOptionsT&& value) {
    ...
    m_doubleArrayOptions = std::forward<DoubleArrayOptionsT>(value);
  }
  template <typename DoubleArrayOptionsT = DoubleArrayOptions>
  IndexField& WithDoubleArrayOptions(DoubleArrayOptionsT&& value) {
    SetDoubleArrayOptions(std::forward<DoubleArrayOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLiteralArrayOptions(LiteralArrayOptionsT&& value) {
    ...
    m_literalArrayOptions = std::forward<LiteralArrayOptionsT>(value);
  }
  template <typename LiteralArrayOptionsT = LiteralArrayOptions>
  IndexField& WithLiteralArrayOptions(LiteralArrayOptionsT&& value) {
    SetLiteralArrayOptions(std::forward<LiteralArrayOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextArrayOptions(TextArrayOptionsT&& value) {
    ...
    m_textArrayOptions = std::forward<TextArrayOptionsT>(value);
  }
  template <typename TextArrayOptionsT = TextArrayOptions>
  IndexField& WithTextArrayOptions(TextArrayOptionsT&& value) {
    SetTextArrayOptions(std::forward<TextArrayOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDateArrayOptions(DateArrayOptionsT&& value) {
    ...
    m_dateArrayOptions = std::forward<DateArrayOptionsT>(value);
  }
  template <typename DateArrayOptionsT = DateArrayOptions>
  IndexField& WithDateArrayOptions(DateArrayOptionsT&& value) {
    SetDateArrayOptions(std::forward<DateArrayOptionsT>(value));
    return *this;
  }
  ///@}
 private:
