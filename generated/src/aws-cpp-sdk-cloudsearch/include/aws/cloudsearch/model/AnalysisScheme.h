...
class AnalysisScheme {
 public:
  ...
  inline void SetAnalysisSchemeLanguage(AnalysisSchemeLanguage value) {
    m_analysisSchemeLanguageHasBeenSet = true;
    m_analysisSchemeLanguage = value;
  }
  inline AnalysisScheme& WithAnalysisSchemeLanguage(AnalysisSchemeLanguage value) {
    SetAnalysisSchemeLanguage(value);
    return *this;
  }
  ///@}
  ...
  void SetAnalysisOptions(AnalysisOptionsT&& value) {
    ...
    m_analysisOptions = std::forward<AnalysisOptionsT>(value);
  }
  template <typename AnalysisOptionsT = AnalysisOptions>
  AnalysisScheme& WithAnalysisOptions(AnalysisOptionsT&& value) {
    SetAnalysisOptions(std::forward<AnalysisOptionsT>(value));
    return *this;
  }
  ///@}
 private:
