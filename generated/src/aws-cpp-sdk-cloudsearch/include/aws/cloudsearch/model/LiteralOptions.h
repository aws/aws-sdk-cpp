...
class LiteralOptions {
 public:
  ...
  inline LiteralOptions& WithFacetEnabled(bool value) {
  ...
  inline LiteralOptions& WithSearchEnabled(bool value) {
  ...
  inline LiteralOptions& WithReturnEnabled(bool value) {
  ...
  inline LiteralOptions& WithSortEnabled(bool value) {
