...
class DescribeExpressionsRequest : public CloudSearchRequest {
 ...
 public:
  ...
  void SetExpressionNames(ExpressionNamesT&& value) {
    m_expressionNamesHasBeenSet = true;
    m_expressionNames = std::forward<ExpressionNamesT>(value);
  }
  template <typename ExpressionNamesT = Aws::Vector<Aws::String>>
  DescribeExpressionsRequest& WithExpressionNames(ExpressionNamesT&& value) {
    SetExpressionNames(std::forward<ExpressionNamesT>(value));
    return *this;
  }
  template <typename ExpressionNamesT = Aws::String>
  DescribeExpressionsRequest& AddExpressionNames(ExpressionNamesT&& value) {
    m_expressionNamesHasBeenSet = true;
    m_expressionNames.emplace_back(std::forward<ExpressionNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeExpressionsRequest& WithDeployed(bool value) {
    SetDeployed(value);
    return *this;
  }
  ///@}
