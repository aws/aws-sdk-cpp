...
class DescribeAnalysisSchemesRequest : public CloudSearchRequest {
 ...
 public:
  ...
  void SetAnalysisSchemeNames(AnalysisSchemeNamesT&& value) {
    m_analysisSchemeNamesHasBeenSet = true;
    m_analysisSchemeNames = std::forward<AnalysisSchemeNamesT>(value);
  }
  template <typename AnalysisSchemeNamesT = Aws::Vector<Aws::String>>
  DescribeAnalysisSchemesRequest& WithAnalysisSchemeNames(AnalysisSchemeNamesT&& value) {
    SetAnalysisSchemeNames(std::forward<AnalysisSchemeNamesT>(value));
    return *this;
  }
  ...
  DescribeAnalysisSchemesRequest& AddAnalysisSchemeNames(AnalysisSchemeNamesT&& value) {
    m_analysisSchemeNamesHasBeenSet = true;
    m_analysisSchemeNames.emplace_back(std::forward<AnalysisSchemeNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAnalysisSchemesRequest& WithDeployed(bool value) {
    SetDeployed(value);
    return *this;
  }
  ///@}
