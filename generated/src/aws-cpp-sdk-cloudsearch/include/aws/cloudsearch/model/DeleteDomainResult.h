...
class DeleteDomainResult {
 public:
  AWS_CLOUDSEARCH_API DeleteDomainResult() = default;
  ...
  template <typename DomainStatusT = DomainStatus>
  DeleteDomainResult& WithDomainStatus(DomainStatusT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteDomainResult& WithResponseMetadata(ResponseMetadataT&& value) {
