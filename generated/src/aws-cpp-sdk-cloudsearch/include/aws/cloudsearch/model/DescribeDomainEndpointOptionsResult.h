...
class DescribeDomainEndpointOptionsResult {
 public:
  ...
  AWS_CLOUDSEARCH_API DescribeDomainEndpointOptionsResult& operator=(
  ...
  template <typename DomainEndpointOptionsT = DomainEndpointOptionsStatus>
  DescribeDomainEndpointOptionsResult& WithDomainEndpointOptions(DomainEndpointOptionsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDomainEndpointOptionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
