...
class DescribeExpressionsResult {
 public:
  ...
  void SetExpressions(ExpressionsT&& value) {
    m_expressionsHasBeenSet = true;
    m_expressions = std::forward<ExpressionsT>(value);
  }
  template <typename ExpressionsT = Aws::Vector<ExpressionStatus>>
  DescribeExpressionsResult& WithExpressions(ExpressionsT&& value) {
    SetExpressions(std::forward<ExpressionsT>(value));
    return *this;
  }
  template <typename ExpressionsT = ExpressionStatus>
  DescribeExpressionsResult& AddExpressions(ExpressionsT&& value) {
    m_expressionsHasBeenSet = true;
    m_expressions.emplace_back(std::forward<ExpressionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeExpressionsResult& WithResponseMetadata(ResponseMetadataT&& value) {
