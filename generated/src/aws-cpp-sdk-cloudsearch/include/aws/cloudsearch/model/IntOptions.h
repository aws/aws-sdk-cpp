...
class IntOptions {
 public:
  ...
  inline void SetDefaultValue(long long value) {
    m_defaultValueHasBeenSet = true;
    m_defaultValue = value;
  }
  inline IntOptions& WithDefaultValue(long long value) {
  ...
  inline IntOptions& WithFacetEnabled(bool value) {
  ...
  inline IntOptions& WithSearchEnabled(bool value) {
  ...
  inline IntOptions& WithReturnEnabled(bool value) {
  ...
  inline IntOptions& WithSortEnabled(bool value) {
