...
class AWS_CLOUDSEARCH_API CloudSearchClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  CloudSearchClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CloudSearchEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CloudSearch::CloudSearchClientConfiguration& clientConfiguration = Aws::CloudSearch::CloudSearchClientConfiguration());
  ...
  /**
   * An Async wrapper for BuildSuggesters that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BuildSuggestersRequestT = Model::BuildSuggestersRequest>
  void BuildSuggestersAsync(const BuildSuggestersRequestT& request, const BuildSuggestersResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DefineAnalysisScheme that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DefineAnalysisScheme that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DefineAnalysisSchemeRequestT = Model::DefineAnalysisSchemeRequest>
  void DefineAnalysisSchemeAsync(const DefineAnalysisSchemeRequestT& request, const DefineAnalysisSchemeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DefineExpression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DefineExpression that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DefineExpressionRequestT = Model::DefineExpressionRequest>
  void DefineExpressionAsync(const DefineExpressionRequestT& request, const DefineExpressionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DefineIndexField that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DefineIndexField that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DefineIndexFieldRequestT = Model::DefineIndexFieldRequest>
  void DefineIndexFieldAsync(const DefineIndexFieldRequestT& request, const DefineIndexFieldResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DefineSuggester that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DefineSuggesterRequestT = Model::DefineSuggesterRequest>
  void DefineSuggesterAsync(const DefineSuggesterRequestT& request, const DefineSuggesterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAnalysisScheme that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAnalysisScheme that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAnalysisSchemeRequestT = Model::DeleteAnalysisSchemeRequest>
  void DeleteAnalysisSchemeAsync(const DeleteAnalysisSchemeRequestT& request, const DeleteAnalysisSchemeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteExpression that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExpression that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteExpressionRequestT = Model::DeleteExpressionRequest>
  void DeleteExpressionAsync(const DeleteExpressionRequestT& request, const DeleteExpressionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteIndexField that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteIndexField that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteIndexFieldRequestT = Model::DeleteIndexFieldRequest>
  void DeleteIndexFieldAsync(const DeleteIndexFieldRequestT& request, const DeleteIndexFieldResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSuggester that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSuggesterRequestT = Model::DeleteSuggesterRequest>
  void DeleteSuggesterAsync(const DeleteSuggesterRequestT& request, const DeleteSuggesterResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAnalysisSchemes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAnalysisSchemes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAnalysisSchemesRequestT = Model::DescribeAnalysisSchemesRequest>
  void DescribeAnalysisSchemesAsync(const DescribeAnalysisSchemesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAvailabilityOptionsOutcome DescribeAvailabilityOptions(
      const Model::DescribeAvailabilityOptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAvailabilityOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAvailabilityOptionsRequestT = Model::DescribeAvailabilityOptionsRequest>
  Model::DescribeAvailabilityOptionsOutcomeCallable DescribeAvailabilityOptionsCallable(
      const DescribeAvailabilityOptionsRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::DescribeAvailabilityOptions, request);
  }

  /**
   * An Async wrapper for DescribeAvailabilityOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAvailabilityOptionsRequestT = Model::DescribeAvailabilityOptionsRequest>
  void DescribeAvailabilityOptionsAsync(const DescribeAvailabilityOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDomainEndpointOptionsOutcome DescribeDomainEndpointOptions(
      const Model::DescribeDomainEndpointOptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeDomainEndpointOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDomainEndpointOptionsRequestT = Model::DescribeDomainEndpointOptionsRequest>
  Model::DescribeDomainEndpointOptionsOutcomeCallable DescribeDomainEndpointOptionsCallable(
      const DescribeDomainEndpointOptionsRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::DescribeDomainEndpointOptions, request);
  }

  /**
   * An Async wrapper for DescribeDomainEndpointOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDomainEndpointOptionsRequestT = Model::DescribeDomainEndpointOptionsRequest>
  void DescribeDomainEndpointOptionsAsync(const DescribeDomainEndpointOptionsRequestT& request,
   ...
   */
  template <typename DescribeDomainsRequestT = Model::DescribeDomainsRequest>
  void DescribeDomainsAsync(const DescribeDomainsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeDomainsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeExpressions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeExpressions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeExpressionsRequestT = Model::DescribeExpressionsRequest>
  void DescribeExpressionsAsync(const DescribeExpressionsRequestT& request, const DescribeExpressionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeIndexFields that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeIndexFields that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeIndexFieldsRequestT = Model::DescribeIndexFieldsRequest>
  void DescribeIndexFieldsAsync(const DescribeIndexFieldsRequestT& request, const DescribeIndexFieldsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeScalingParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeScalingParametersRequestT = Model::DescribeScalingParametersRequest>
  Model::DescribeScalingParametersOutcomeCallable DescribeScalingParametersCallable(
      const DescribeScalingParametersRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::DescribeScalingParameters, request);
  }

  /**
   * An Async wrapper for DescribeScalingParameters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeScalingParametersRequestT = Model::DescribeScalingParametersRequest>
  void DescribeScalingParametersAsync(const DescribeScalingParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeServiceAccessPoliciesOutcome DescribeServiceAccessPolicies(
      const Model::DescribeServiceAccessPoliciesRequest& request) const;

  /**
   * A Callable wrapper for DescribeServiceAccessPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeServiceAccessPoliciesRequestT = Model::DescribeServiceAccessPoliciesRequest>
  Model::DescribeServiceAccessPoliciesOutcomeCallable DescribeServiceAccessPoliciesCallable(
      const DescribeServiceAccessPoliciesRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::DescribeServiceAccessPolicies, request);
  }

  /**
   * An Async wrapper for DescribeServiceAccessPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeServiceAccessPoliciesRequestT = Model::DescribeServiceAccessPoliciesRequest>
  void DescribeServiceAccessPoliciesAsync(const DescribeServiceAccessPoliciesRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeSuggesters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSuggesters that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSuggestersRequestT = Model::DescribeSuggestersRequest>
  void DescribeSuggestersAsync(const DescribeSuggestersRequestT& request, const DescribeSuggestersResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for IndexDocuments that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename IndexDocumentsRequestT = Model::IndexDocumentsRequest>
  void IndexDocumentsAsync(const IndexDocumentsRequestT& request, const IndexDocumentsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAvailabilityOptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateAvailabilityOptionsRequestT = Model::UpdateAvailabilityOptionsRequest>
  Model::UpdateAvailabilityOptionsOutcomeCallable UpdateAvailabilityOptionsCallable(
      const UpdateAvailabilityOptionsRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::UpdateAvailabilityOptions, request);
  }

  /**
   * An Async wrapper for UpdateAvailabilityOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAvailabilityOptionsRequestT = Model::UpdateAvailabilityOptionsRequest>
  void UpdateAvailabilityOptionsAsync(const UpdateAvailabilityOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDomainEndpointOptionsOutcome UpdateDomainEndpointOptions(
      const Model::UpdateDomainEndpointOptionsRequest& request) const;

  /**
   * A Callable wrapper for UpdateDomainEndpointOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDomainEndpointOptionsRequestT = Model::UpdateDomainEndpointOptionsRequest>
  Model::UpdateDomainEndpointOptionsOutcomeCallable UpdateDomainEndpointOptionsCallable(
      const UpdateDomainEndpointOptionsRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::UpdateDomainEndpointOptions, request);
  }

  /**
   * An Async wrapper for UpdateDomainEndpointOptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDomainEndpointOptionsRequestT = Model::UpdateDomainEndpointOptionsRequest>
  void UpdateDomainEndpointOptionsAsync(const UpdateDomainEndpointOptionsRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateScalingParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateScalingParameters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateScalingParametersRequestT = Model::UpdateScalingParametersRequest>
  void UpdateScalingParametersAsync(const UpdateScalingParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateServiceAccessPoliciesOutcome UpdateServiceAccessPolicies(
      const Model::UpdateServiceAccessPoliciesRequest& request) const;

  /**
   * A Callable wrapper for UpdateServiceAccessPolicies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateServiceAccessPoliciesRequestT = Model::UpdateServiceAccessPoliciesRequest>
  Model::UpdateServiceAccessPoliciesOutcomeCallable UpdateServiceAccessPoliciesCallable(
      const UpdateServiceAccessPoliciesRequestT& request) const {
    return SubmitCallable(&CloudSearchClient::UpdateServiceAccessPolicies, request);
  }

  /**
   * An Async wrapper for UpdateServiceAccessPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateServiceAccessPoliciesRequestT = Model::UpdateServiceAccessPoliciesRequest>
  void UpdateServiceAccessPoliciesAsync(const UpdateServiceAccessPoliciesRequestT& request,
