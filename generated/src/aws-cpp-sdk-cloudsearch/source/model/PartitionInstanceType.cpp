  ...
  namespace CloudSearch
  {
    namespace Model
    {
      namespace PartitionInstanceTypeMapper
      {
        ...
        static constexpr uint32_t search_m1_small_HASH = ConstExprHashingUtils::HashString("search.m1.small");
        static constexpr uint32_t search_m1_large_HASH = ConstExprHashingUtils::HashString("search.m1.large");
        static constexpr uint32_t search_m2_xlarge_HASH = ConstExprHashingUtils::HashString("search.m2.xlarge");
        static constexpr uint32_t search_m2_2xlarge_HASH = ConstExprHashingUtils::HashString("search.m2.2xlarge");
        static constexpr uint32_t search_m3_medium_HASH = ConstExprHashingUtils::HashString("search.m3.medium");
        static constexpr uint32_t search_m3_large_HASH = ConstExprHashingUtils::HashString("search.m3.large");
        static constexpr uint32_t search_m3_xlarge_HASH = ConstExprHashingUtils::HashString("search.m3.xlarge");
        static constexpr uint32_t search_m3_2xlarge_HASH = ConstExprHashingUtils::HashString("search.m3.2xlarge");
        static constexpr uint32_t search_small_HASH = ConstExprHashingUtils::HashString("search.small");
        static constexpr uint32_t search_medium_HASH = ConstExprHashingUtils::HashString("search.medium");
        static constexpr uint32_t search_large_HASH = ConstExprHashingUtils::HashString("search.large");
        static constexpr uint32_t search_xlarge_HASH = ConstExprHashingUtils::HashString("search.xlarge");
        static constexpr uint32_t search_2xlarge_HASH = ConstExprHashingUtils::HashString("search.2xlarge");
        static constexpr uint32_t search_previousgeneration_small_HASH = ConstExprHashingUtils::HashString("search.previousgeneration.small");
        static constexpr uint32_t search_previousgeneration_large_HASH = ConstExprHashingUtils::HashString("search.previousgeneration.large");
        static constexpr uint32_t search_previousgeneration_xlarge_HASH = ConstExprHashingUtils::HashString("search.previousgeneration.xlarge");
        static constexpr uint32_t search_previousgeneration_2xlarge_HASH = ConstExprHashingUtils::HashString("search.previousgeneration.2xlarge");
