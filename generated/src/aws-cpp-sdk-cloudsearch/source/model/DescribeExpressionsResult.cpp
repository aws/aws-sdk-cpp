...
DescribeExpressionsResult::DescribeExpressionsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeExpressionsResult& DescribeExpressionsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!expressionsNode.IsNull()) {
      ...
      m_expressionsHasBeenSet = !expressionsMember.IsNull();
