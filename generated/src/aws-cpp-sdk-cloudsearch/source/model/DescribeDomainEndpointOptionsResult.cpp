...
DescribeDomainEndpointOptionsResult& DescribeDomainEndpointOptionsResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudSearch::Model::DescribeDomainEndpointOptionsResult",
