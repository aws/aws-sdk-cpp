...
UpdateScalingParametersResult::UpdateScalingParametersResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
UpdateScalingParametersResult& UpdateScalingParametersResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudSearch::Model::UpdateScalingParametersResult",
