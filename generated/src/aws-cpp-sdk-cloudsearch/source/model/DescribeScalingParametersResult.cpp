...
DescribeScalingParametersResult::DescribeScalingParametersResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeScalingParametersResult& DescribeScalingParametersResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::CloudSearch::Model::DescribeScalingParametersResult",
