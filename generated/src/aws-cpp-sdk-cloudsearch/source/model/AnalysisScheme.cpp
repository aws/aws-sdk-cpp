...
AnalysisScheme::AnalysisScheme(const XmlNode& xmlNode) { *this = xmlNode; }
...
AnalysisScheme& AnalysisScheme::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!analysisSchemeLanguageNode.IsNull()) {
      m_analysisSchemeLanguage = AnalysisSchemeLanguageMapper::GetAnalysisSchemeLanguageForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(analysisSchemeLanguageNode.GetText()).c_str()));
...
void AnalysisScheme::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_analysisSchemeLanguageHasBeenSet) {
    oStream << location << index << locationValue << ".AnalysisSchemeLanguage="
            << StringUtils::URLEncode(AnalysisSchemeLanguageMapper::GetNameForAnalysisSchemeLanguage(m_analysisSchemeLanguage)) << "&";
  }
...
void AnalysisScheme::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_analysisSchemeLanguageHasBeenSet) {
    oStream << location << ".AnalysisSchemeLanguage="
            << StringUtils::URLEncode(AnalysisSchemeLanguageMapper::GetNameForAnalysisSchemeLanguage(m_analysisSchemeLanguage)) << "&";
  }
  if (m_analysisOptionsHasBeenSet) {
