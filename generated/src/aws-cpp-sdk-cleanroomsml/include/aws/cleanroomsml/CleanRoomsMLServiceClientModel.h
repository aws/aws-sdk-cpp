...
typedef Aws::Utils::Outcome<CreateConfiguredModelAlgorithmAssociationResult, CleanRoomsMLError>
...
typedef Aws::Utils::Outcome<GetCollaborationConfiguredModelAlgorithmAssociationResult, CleanRoomsMLError>
...
typedef Aws::Utils::Outcome<ListCollaborationConfiguredModelAlgorithmAssociationsResult, CleanRoomsMLError>
...
typedef Aws::Utils::Outcome<ListCollaborationTrainedModelExportJobsResult, CleanRoomsMLError>
    ListCollaborationTrainedModelExportJobsOutcome;
typedef Aws::Utils::Outcome<ListCollaborationTrainedModelInferenceJobsResult, CleanRoomsMLError>
...
typedef Aws::Utils::Outcome<ListConfiguredModelAlgorithmAssociationsResult, CleanRoomsMLError>
...
typedef std::future<GetCollaborationConfiguredModelAlgorithmAssociationOutcome>
    GetCollaborationConfiguredModelAlgorithmAssociationOutcomeCallable;
...
typedef std::future<ListCollaborationConfiguredModelAlgorithmAssociationsOutcome>
    ListCollaborationConfiguredModelAlgorithmAssociationsOutcomeCallable;
...
typedef std::function<void(const CleanRoomsMLClient*, const Model::CancelTrainedModelRequest&, const Model::CancelTrainedModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CancelTrainedModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CancelTrainedModelInferenceJobRequest&,
                           const Model::CancelTrainedModelInferenceJobOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CancelTrainedModelInferenceJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateAudienceModelRequest&, const Model::CreateAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateConfiguredAudienceModelRequest&,
                           const Model::CreateConfiguredAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConfiguredAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateConfiguredModelAlgorithmRequest&,
                           const Model::CreateConfiguredModelAlgorithmOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConfiguredModelAlgorithmResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateConfiguredModelAlgorithmAssociationRequest&,
                           const Model::CreateConfiguredModelAlgorithmAssociationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConfiguredModelAlgorithmAssociationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateMLInputChannelRequest&, const Model::CreateMLInputChannelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMLInputChannelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateTrainedModelRequest&, const Model::CreateTrainedModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTrainedModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::CreateTrainingDatasetRequest&,
                           const Model::CreateTrainingDatasetOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateTrainingDatasetResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteAudienceGenerationJobRequest&,
                           const Model::DeleteAudienceGenerationJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteAudienceGenerationJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteAudienceModelRequest&, const Model::DeleteAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteConfiguredAudienceModelRequest&,
                           const Model::DeleteConfiguredAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConfiguredAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteConfiguredAudienceModelPolicyRequest&,
                           const Model::DeleteConfiguredAudienceModelPolicyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConfiguredAudienceModelPolicyResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteConfiguredModelAlgorithmRequest&,
                           const Model::DeleteConfiguredModelAlgorithmOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConfiguredModelAlgorithmResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteConfiguredModelAlgorithmAssociationRequest&,
                           const Model::DeleteConfiguredModelAlgorithmAssociationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConfiguredModelAlgorithmAssociationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteMLConfigurationRequest&,
                           const Model::DeleteMLConfigurationOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMLConfigurationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteMLInputChannelDataRequest&,
                           const Model::DeleteMLInputChannelDataOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMLInputChannelDataResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteTrainedModelOutputRequest&,
                           const Model::DeleteTrainedModelOutputOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTrainedModelOutputResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::DeleteTrainingDatasetRequest&,
                           const Model::DeleteTrainingDatasetOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteTrainingDatasetResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetAudienceGenerationJobRequest&,
                           const Model::GetAudienceGenerationJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetAudienceGenerationJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetAudienceModelRequest&, const Model::GetAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetCollaborationConfiguredModelAlgorithmAssociationRequest&,
                           const Model::GetCollaborationConfiguredModelAlgorithmAssociationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCollaborationConfiguredModelAlgorithmAssociationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetCollaborationMLInputChannelRequest&,
                           const Model::GetCollaborationMLInputChannelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCollaborationMLInputChannelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetCollaborationTrainedModelRequest&,
                           const Model::GetCollaborationTrainedModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetCollaborationTrainedModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetConfiguredAudienceModelRequest&,
                           const Model::GetConfiguredAudienceModelOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConfiguredAudienceModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetConfiguredAudienceModelPolicyRequest&,
                           const Model::GetConfiguredAudienceModelPolicyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConfiguredAudienceModelPolicyResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetConfiguredModelAlgorithmRequest&,
                           const Model::GetConfiguredModelAlgorithmOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConfiguredModelAlgorithmResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetConfiguredModelAlgorithmAssociationRequest&,
                           const Model::GetConfiguredModelAlgorithmAssociationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConfiguredModelAlgorithmAssociationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetMLConfigurationRequest&, const Model::GetMLConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMLConfigurationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetMLInputChannelRequest&, const Model::GetMLInputChannelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMLInputChannelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetTrainedModelRequest&, const Model::GetTrainedModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTrainedModelResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetTrainedModelInferenceJobRequest&,
                           const Model::GetTrainedModelInferenceJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTrainedModelInferenceJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::GetTrainingDatasetRequest&, const Model::GetTrainingDatasetOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetTrainingDatasetResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListAudienceExportJobsRequest&,
                           const Model::ListAudienceExportJobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListAudienceExportJobsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListAudienceGenerationJobsRequest&,
                           const Model::ListAudienceGenerationJobsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListAudienceGenerationJobsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListAudienceModelsRequest&, const Model::ListAudienceModelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListAudienceModelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListCollaborationConfiguredModelAlgorithmAssociationsRequest&,
                           const Model::ListCollaborationConfiguredModelAlgorithmAssociationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCollaborationConfiguredModelAlgorithmAssociationsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListCollaborationMLInputChannelsRequest&,
                           const Model::ListCollaborationMLInputChannelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCollaborationMLInputChannelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListCollaborationTrainedModelExportJobsRequest&,
                           const Model::ListCollaborationTrainedModelExportJobsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCollaborationTrainedModelExportJobsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListCollaborationTrainedModelInferenceJobsRequest&,
                           const Model::ListCollaborationTrainedModelInferenceJobsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCollaborationTrainedModelInferenceJobsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListCollaborationTrainedModelsRequest&,
                           const Model::ListCollaborationTrainedModelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListCollaborationTrainedModelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListConfiguredAudienceModelsRequest&,
                           const Model::ListConfiguredAudienceModelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConfiguredAudienceModelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListConfiguredModelAlgorithmAssociationsRequest&,
                           const Model::ListConfiguredModelAlgorithmAssociationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConfiguredModelAlgorithmAssociationsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListConfiguredModelAlgorithmsRequest&,
                           const Model::ListConfiguredModelAlgorithmsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConfiguredModelAlgorithmsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListMLInputChannelsRequest&, const Model::ListMLInputChannelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListMLInputChannelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListTagsForResourceRequest&, const Model::ListTagsForResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListTrainedModelInferenceJobsRequest&,
                           const Model::ListTrainedModelInferenceJobsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTrainedModelInferenceJobsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListTrainedModelVersionsRequest&,
                           const Model::ListTrainedModelVersionsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTrainedModelVersionsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListTrainedModelsRequest&, const Model::ListTrainedModelsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTrainedModelsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::ListTrainingDatasetsRequest&, const Model::ListTrainingDatasetsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTrainingDatasetsResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::PutConfiguredAudienceModelPolicyRequest&,
                           const Model::PutConfiguredAudienceModelPolicyOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutConfiguredAudienceModelPolicyResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::PutMLConfigurationRequest&, const Model::PutMLConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    PutMLConfigurationResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::StartAudienceExportJobRequest&,
                           const Model::StartAudienceExportJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartAudienceExportJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::StartAudienceGenerationJobRequest&,
                           const Model::StartAudienceGenerationJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartAudienceGenerationJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::StartTrainedModelExportJobRequest&,
                           const Model::StartTrainedModelExportJobOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartTrainedModelExportJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::StartTrainedModelInferenceJobRequest&,
                           const Model::StartTrainedModelInferenceJobOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    StartTrainedModelInferenceJobResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const CleanRoomsMLClient*, const Model::UpdateConfiguredAudienceModelRequest&,
                           const Model::UpdateConfiguredAudienceModelOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateConfiguredAudienceModelResponseReceivedHandler;
