...
class LogsConfigurationPolicy {
 public:
  ...
  inline LogsConfigurationPolicy& WithLogType(LogType value) {
    SetLogType(value);
    return *this;
  }
  ///@}
  ...
  void SetLogRedactionConfiguration(LogRedactionConfigurationT&& value) {
    m_logRedactionConfigurationHasBeenSet = true;
    m_logRedactionConfiguration = std::forward<LogRedactionConfigurationT>(value);
  }
  template <typename LogRedactionConfigurationT = LogRedactionConfiguration>
  LogsConfigurationPolicy& WithLogRedactionConfiguration(LogRedactionConfigurationT&& value) {
    SetLogRedactionConfiguration(std::forward<LogRedactionConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
