...
class GetTrainedModelInferenceJobResult {
 public:
  ...
  inline GetTrainedModelInferenceJobResult& WithStatus(TrainedModelInferenceJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetContainerExecutionParameters(ContainerExecutionParametersT&& value) {
    ...
    m_containerExecutionParameters = std::forward<ContainerExecutionParametersT>(value);
  }
  template <typename ContainerExecutionParametersT = InferenceContainerExecutionParameters>
  GetTrainedModelInferenceJobResult& WithContainerExecutionParameters(ContainerExecutionParametersT&& value) {
    SetContainerExecutionParameters(std::forward<ContainerExecutionParametersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInferenceContainerImageDigest(InferenceContainerImageDigestT&& value) {
    ...
    m_inferenceContainerImageDigest = std::forward<InferenceContainerImageDigestT>(value);
  }
  template <typename InferenceContainerImageDigestT = Aws::String>
  GetTrainedModelInferenceJobResult& WithInferenceContainerImageDigest(InferenceContainerImageDigestT&& value) {
    SetInferenceContainerImageDigest(std::forward<InferenceContainerImageDigestT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetTrainedModelInferenceJobResult& WithMetricsStatus(MetricsStatus value) {
  ...
  inline GetTrainedModelInferenceJobResult& WithLogsStatus(LogsStatus value) {
    SetLogsStatus(value);
    return *this;
  }
  ///@}
