...
namespace Model
{
  ...
  public:
    ...
    template<typename TableNameT = Aws::String>
    GlueDataSource& WithTableName(TableNameT&& value) { SetTableName(std::forward<TableNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    GlueDataSource& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CatalogIdT = Aws::String>
    GlueDataSource& WithCatalogId(CatalogIdT&& value) { SetCatalogId(std::forward<CatalogIdT>(value)); return *this;}
    ///@}
  private:
