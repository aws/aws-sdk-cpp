...
class StartTrainedModelInferenceJobResult {
 public:
  ...
  AWS_CLEANROOMSML_API StartTrainedModelInferenceJobResult& operator=(
  ...
  template <typename TrainedModelInferenceJobArnT = Aws::String>
  StartTrainedModelInferenceJobResult& WithTrainedModelInferenceJobArn(TrainedModelInferenceJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartTrainedModelInferenceJobResult& WithRequestId(RequestIdT&& value) {
