...
class GetCollaborationConfiguredModelAlgorithmAssociationRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename ConfiguredModelAlgorithmAssociationArnT = Aws::String>
  GetCollaborationConfiguredModelAlgorithmAssociationRequest& WithConfiguredModelAlgorithmAssociationArn(
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  GetCollaborationConfiguredModelAlgorithmAssociationRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
