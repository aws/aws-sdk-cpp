...
class AudienceSizeConfig {
 public:
  ...
  inline void SetAudienceSizeType(AudienceSizeType value) {
    m_audienceSizeTypeHasBeenSet = true;
    m_audienceSizeType = value;
  }
  inline AudienceSizeConfig& WithAudienceSizeType(AudienceSizeType value) {
    SetAudienceSizeType(value);
    return *this;
  }
  ///@}
  ...
  void SetAudienceSizeBins(AudienceSizeBinsT&& value) {
    m_audienceSizeBinsHasBeenSet = true;
    m_audienceSizeBins = std::forward<AudienceSizeBinsT>(value);
  }
  template <typename AudienceSizeBinsT = Aws::Vector<int>>
  AudienceSizeConfig& WithAudienceSizeBins(AudienceSizeBinsT&& value) {
    SetAudienceSizeBins(std::forward<AudienceSizeBinsT>(value));
    return *this;
  }
  inline AudienceSizeConfig& AddAudienceSizeBins(int value) {
    m_audienceSizeBinsHasBeenSet = true;
    m_audienceSizeBins.push_back(value);
    return *this;
  }
  ///@}
 private:
