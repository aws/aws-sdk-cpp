...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMSML_API TrainedModelExportsMaxSize();
     ...
     */
    inline const TrainedModelExportsMaxSizeUnitType& GetUnit() const{ return m_unit; }
    inline bool UnitHasBeenSet() const { return m_unitHasBeenSet; }
    inline void SetUnit(const TrainedModelExportsMaxSizeUnitType& value) { m_unitHasBeenSet = true; m_unit = value; }
    inline void SetUnit(TrainedModelExportsMaxSizeUnitType&& value) { m_unitHasBeenSet = true; m_unit = std::move(value); }
    inline TrainedModelExportsMaxSize& WithUnit(const TrainedModelExportsMaxSizeUnitType& value) { SetUnit(value); return *this;}
    inline TrainedModelExportsMaxSize& WithUnit(TrainedModelExportsMaxSizeUnitType&& value) { SetUnit(std::move(value)); return *this;}
    ///@}
  ...
  private:
    ...
    TrainedModelExportsMaxSizeUnitType m_unit;
