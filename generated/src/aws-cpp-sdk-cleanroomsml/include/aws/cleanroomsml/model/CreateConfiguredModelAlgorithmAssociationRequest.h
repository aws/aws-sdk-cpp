...
class CreateConfiguredModelAlgorithmAssociationRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CreateConfiguredModelAlgorithmAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename ConfiguredModelAlgorithmArnT = Aws::String>
  CreateConfiguredModelAlgorithmAssociationRequest& WithConfiguredModelAlgorithmArn(ConfiguredModelAlgorithmArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateConfiguredModelAlgorithmAssociationRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateConfiguredModelAlgorithmAssociationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename PrivacyConfigurationT = PrivacyConfiguration>
  CreateConfiguredModelAlgorithmAssociationRequest& WithPrivacyConfiguration(PrivacyConfigurationT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateConfiguredModelAlgorithmAssociationRequest& WithTags(TagsT&& value) {
