...
class ColumnSchema {
 public:
  ...
  template <typename ColumnNameT = Aws::String>
  ColumnSchema& WithColumnName(ColumnNameT&& value) {
  ...
  void SetColumnTypes(ColumnTypesT&& value) {
    m_columnTypesHasBeenSet = true;
    m_columnTypes = std::forward<ColumnTypesT>(value);
  }
  template <typename ColumnTypesT = Aws::Vector<ColumnType>>
  ColumnSchema& WithColumnTypes(ColumnTypesT&& value) {
    SetColumnTypes(std::forward<ColumnTypesT>(value));
    return *this;
  }
  inline ColumnSchema& AddColumnTypes(ColumnType value) {
    m_columnTypesHasBeenSet = true;
    m_columnTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
