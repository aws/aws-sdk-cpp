...
class CreateTrainedModelResult {
 public:
  ...
  template <typename TrainedModelArnT = Aws::String>
  CreateTrainedModelResult& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename VersionIdentifierT = Aws::String>
  CreateTrainedModelResult& WithVersionIdentifier(VersionIdentifierT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateTrainedModelResult& WithRequestId(RequestIdT&& value) {
