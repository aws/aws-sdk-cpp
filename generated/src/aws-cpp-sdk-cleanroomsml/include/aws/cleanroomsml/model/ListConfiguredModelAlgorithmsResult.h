...
class ListConfiguredModelAlgorithmsResult {
 public:
  ...
  AWS_CLEANROOMSML_API ListConfiguredModelAlgorithmsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredModelAlgorithmsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetConfiguredModelAlgorithms(ConfiguredModelAlgorithmsT&& value) {
    m_configuredModelAlgorithmsHasBeenSet = true;
    m_configuredModelAlgorithms = std::forward<ConfiguredModelAlgorithmsT>(value);
  }
  template <typename ConfiguredModelAlgorithmsT = Aws::Vector<ConfiguredModelAlgorithmSummary>>
  ListConfiguredModelAlgorithmsResult& WithConfiguredModelAlgorithms(ConfiguredModelAlgorithmsT&& value) {
    SetConfiguredModelAlgorithms(std::forward<ConfiguredModelAlgorithmsT>(value));
    return *this;
  }
  template <typename ConfiguredModelAlgorithmsT = ConfiguredModelAlgorithmSummary>
  ListConfiguredModelAlgorithmsResult& AddConfiguredModelAlgorithms(ConfiguredModelAlgorithmsT&& value) {
    m_configuredModelAlgorithmsHasBeenSet = true;
    m_configuredModelAlgorithms.emplace_back(std::forward<ConfiguredModelAlgorithmsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListConfiguredModelAlgorithmsResult& WithRequestId(RequestIdT&& value) {
