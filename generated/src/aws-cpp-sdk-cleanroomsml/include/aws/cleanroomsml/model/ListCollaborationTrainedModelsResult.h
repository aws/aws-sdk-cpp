...
class ListCollaborationTrainedModelsResult {
 public:
  ...
  AWS_CLEANROOMSML_API ListCollaborationTrainedModelsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationTrainedModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCollaborationTrainedModels(CollaborationTrainedModelsT&& value) {
    m_collaborationTrainedModelsHasBeenSet = true;
    m_collaborationTrainedModels = std::forward<CollaborationTrainedModelsT>(value);
  }
  template <typename CollaborationTrainedModelsT = Aws::Vector<CollaborationTrainedModelSummary>>
  ListCollaborationTrainedModelsResult& WithCollaborationTrainedModels(CollaborationTrainedModelsT&& value) {
    SetCollaborationTrainedModels(std::forward<CollaborationTrainedModelsT>(value));
    return *this;
  }
  template <typename CollaborationTrainedModelsT = CollaborationTrainedModelSummary>
  ListCollaborationTrainedModelsResult& AddCollaborationTrainedModels(CollaborationTrainedModelsT&& value) {
    m_collaborationTrainedModelsHasBeenSet = true;
    m_collaborationTrainedModels.emplace_back(std::forward<CollaborationTrainedModelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCollaborationTrainedModelsResult& WithRequestId(RequestIdT&& value) {
