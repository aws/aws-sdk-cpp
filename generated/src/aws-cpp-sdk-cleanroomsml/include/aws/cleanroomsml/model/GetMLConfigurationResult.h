...
class GetMLConfigurationResult {
 public:
  ...
  void SetDefaultOutputLocation(DefaultOutputLocationT&& value) {
    m_defaultOutputLocationHasBeenSet = true;
    m_defaultOutputLocation = std::forward<DefaultOutputLocationT>(value);
  }
  template <typename DefaultOutputLocationT = MLOutputConfiguration>
  GetMLConfigurationResult& WithDefaultOutputLocation(DefaultOutputLocationT&& value) {
    SetDefaultOutputLocation(std::forward<DefaultOutputLocationT>(value));
    return *this;
  }
  ///@}
