...
class GetCollaborationTrainedModelResult {
 public:
  ...
  AWS_CLEANROOMSML_API GetCollaborationTrainedModelResult& operator=(
  ...
  inline GetCollaborationTrainedModelResult& WithStatus(TrainedModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetCollaborationTrainedModelResult& WithTrainingInputMode(TrainingInputMode value) {
  ...
  inline GetCollaborationTrainedModelResult& WithMetricsStatus(MetricsStatus value) {
  ...
  inline GetCollaborationTrainedModelResult& WithLogsStatus(LogsStatus value) {
    SetLogsStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingContainerImageDigest(TrainingContainerImageDigestT&& value) {
    ...
    m_trainingContainerImageDigest = std::forward<TrainingContainerImageDigestT>(value);
  }
  template <typename TrainingContainerImageDigestT = Aws::String>
  GetCollaborationTrainedModelResult& WithTrainingContainerImageDigest(TrainingContainerImageDigestT&& value) {
    SetTrainingContainerImageDigest(std::forward<TrainingContainerImageDigestT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MlModelTrainingPayerAccountIdT = Aws::String>
  GetCollaborationTrainedModelResult& WithMlModelTrainingPayerAccountId(MlModelTrainingPayerAccountIdT&& value) {
