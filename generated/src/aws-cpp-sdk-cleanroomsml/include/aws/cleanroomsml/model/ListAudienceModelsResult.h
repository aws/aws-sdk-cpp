...
class ListAudienceModelsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAudienceModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetAudienceModels(AudienceModelsT&& value) {
    m_audienceModelsHasBeenSet = true;
    m_audienceModels = std::forward<AudienceModelsT>(value);
  }
  template <typename AudienceModelsT = Aws::Vector<AudienceModelSummary>>
  ListAudienceModelsResult& WithAudienceModels(AudienceModelsT&& value) {
    SetAudienceModels(std::forward<AudienceModelsT>(value));
    return *this;
  }
  template <typename AudienceModelsT = AudienceModelSummary>
  ListAudienceModelsResult& AddAudienceModels(AudienceModelsT&& value) {
    m_audienceModelsHasBeenSet = true;
    m_audienceModels.emplace_back(std::forward<AudienceModelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAudienceModelsResult& WithRequestId(RequestIdT&& value) {
