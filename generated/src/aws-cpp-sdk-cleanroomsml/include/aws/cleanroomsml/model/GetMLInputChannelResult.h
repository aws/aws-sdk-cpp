...
class GetMLInputChannelResult {
 public:
  ...
  inline GetMLInputChannelResult& WithStatus(MLInputChannelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetMLInputChannelResult& WithRetentionInDays(int value) {
  ...
  inline GetMLInputChannelResult& WithNumberOfRecords(long long value) {
  ...
  template <typename PrivacyBudgetsT = PrivacyBudgets>
  GetMLInputChannelResult& WithPrivacyBudgets(PrivacyBudgetsT&& value) {
  ...
  template <typename SyntheticDataConfigurationT = SyntheticDataConfiguration>
  GetMLInputChannelResult& WithSyntheticDataConfiguration(SyntheticDataConfigurationT&& value) {
  ...
  template <typename PayerConfigurationT = PayerConfiguration>
  GetMLInputChannelResult& WithPayerConfiguration(PayerConfigurationT&& value) {
  ...
  inline void SetNumberOfFiles(double value) {
    m_numberOfFilesHasBeenSet = true;
    m_numberOfFiles = value;
  }
  inline GetMLInputChannelResult& WithNumberOfFiles(double value) {
  ...
  inline GetMLInputChannelResult& WithSizeInGb(double value) {
    SetSizeInGb(value);
    return *this;
  }
  ///@}
