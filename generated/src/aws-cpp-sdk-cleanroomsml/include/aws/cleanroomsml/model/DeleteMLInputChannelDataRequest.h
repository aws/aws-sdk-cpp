...
class DeleteMLInputChannelDataRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename MlInputChannelArnT = Aws::String>
  DeleteMLInputChannelDataRequest& WithMlInputChannelArn(MlInputChannelArnT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteMLInputChannelDataRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
