...
class CreateTrainingDatasetRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateTrainingDatasetRequest& WithName(NameT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateTrainingDatasetRequest& WithRoleArn(RoleArnT&& value) {
  ...
  void SetTrainingData(TrainingDataT&& value) {
    ...
    m_trainingData = std::forward<TrainingDataT>(value);
  }
  template <typename TrainingDataT = Aws::Vector<Dataset>>
  CreateTrainingDatasetRequest& WithTrainingData(TrainingDataT&& value) {
    SetTrainingData(std::forward<TrainingDataT>(value));
    return *this;
  }
  template <typename TrainingDataT = Dataset>
  CreateTrainingDatasetRequest& AddTrainingData(TrainingDataT&& value) {
    m_trainingDataHasBeenSet = true;
    m_trainingData.emplace_back(std::forward<TrainingDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateTrainingDatasetRequest& WithTags(TagsT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateTrainingDatasetRequest& WithDescription(DescriptionT&& value) {
