...
class CancelTrainedModelInferenceJobRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CancelTrainedModelInferenceJobRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  void SetTrainedModelInferenceJobArn(TrainedModelInferenceJobArnT&& value) {
    ...
    m_trainedModelInferenceJobArn = std::forward<TrainedModelInferenceJobArnT>(value);
  }
  template <typename TrainedModelInferenceJobArnT = Aws::String>
  CancelTrainedModelInferenceJobRequest& WithTrainedModelInferenceJobArn(TrainedModelInferenceJobArnT&& value) {
    SetTrainedModelInferenceJobArn(std::forward<TrainedModelInferenceJobArnT>(value));
    return *this;
  }
  ///@}
 private:
