...
class GetAudienceModelResult {
 public:
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  GetAudienceModelResult& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  GetAudienceModelResult& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename TrainingDataStartTimeT = Aws::Utils::DateTime>
  GetAudienceModelResult& WithTrainingDataStartTime(TrainingDataStartTimeT&& value) {
  ...
  template <typename TrainingDataEndTimeT = Aws::Utils::DateTime>
  GetAudienceModelResult& WithTrainingDataEndTime(TrainingDataEndTimeT&& value) {
  ...
  template <typename AudienceModelArnT = Aws::String>
  GetAudienceModelResult& WithAudienceModelArn(AudienceModelArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetAudienceModelResult& WithName(NameT&& value) {
  ...
  template <typename TrainingDatasetArnT = Aws::String>
  GetAudienceModelResult& WithTrainingDatasetArn(TrainingDatasetArnT&& value) {
  ...
  inline GetAudienceModelResult& WithStatus(AudienceModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = StatusDetails>
  GetAudienceModelResult& WithStatusDetails(StatusDetailsT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  GetAudienceModelResult& WithKmsKeyArn(KmsKeyArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetAudienceModelResult& WithTags(TagsT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetAudienceModelResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAudienceModelResult& WithRequestId(RequestIdT&& value) {
