...
class ListConfiguredModelAlgorithmAssociationsRequest : public CleanRoomsMLRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListConfiguredModelAlgorithmAssociations"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredModelAlgorithmAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListConfiguredModelAlgorithmAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListConfiguredModelAlgorithmAssociationsRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
