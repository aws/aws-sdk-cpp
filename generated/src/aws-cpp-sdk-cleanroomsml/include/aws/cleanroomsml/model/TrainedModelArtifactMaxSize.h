...
class TrainedModelArtifactMaxSize {
 public:
  ...
  inline void SetUnit(TrainedModelArtifactMaxSizeUnitType value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline TrainedModelArtifactMaxSize& WithUnit(TrainedModelArtifactMaxSizeUnitType value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline TrainedModelArtifactMaxSize& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
