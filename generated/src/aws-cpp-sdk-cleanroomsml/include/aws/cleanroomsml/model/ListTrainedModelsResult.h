...
class ListTrainedModelsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainedModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TrainedModelsT = Aws::Vector<TrainedModelSummary>>
  ListTrainedModelsResult& WithTrainedModels(TrainedModelsT&& value) {
    SetTrainedModels(std::forward<TrainedModelsT>(value));
    return *this;
  }
  template <typename TrainedModelsT = TrainedModelSummary>
  ListTrainedModelsResult& AddTrainedModels(TrainedModelsT&& value) {
    m_trainedModelsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListTrainedModelsResult& WithRequestId(RequestIdT&& value) {
