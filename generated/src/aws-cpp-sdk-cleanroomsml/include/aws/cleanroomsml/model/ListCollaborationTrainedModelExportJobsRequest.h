...
class ListCollaborationTrainedModelExportJobsRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationTrainedModelExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationTrainedModelExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationTrainedModelExportJobsRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  ListCollaborationTrainedModelExportJobsRequest& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  ///@{
  /**
   * <p>The version identifier of the trained model to filter export jobs by. When
  ...
  template <typename TrainedModelVersionIdentifierT = Aws::String>
  ListCollaborationTrainedModelExportJobsRequest& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) {
