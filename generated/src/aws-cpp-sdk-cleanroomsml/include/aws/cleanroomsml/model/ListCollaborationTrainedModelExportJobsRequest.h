...
namespace Model
{
  ...
  public:
    ...
    template<typename TrainedModelVersionIdentifierT = Aws::String>
    ListCollaborationTrainedModelExportJobsRequest& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) { SetTrainedModelVersionIdentifier(std::forward<TrainedModelVersionIdentifierT>(value)); return *this;}
    ///@}
  private:
