...
class TrainedModelExportsConfigurationPolicy {
 public:
  ...
  void SetMaxSize(MaxSizeT&& value) {
    ...
    m_maxSize = std::forward<MaxSizeT>(value);
  }
  template <typename MaxSizeT = TrainedModelExportsMaxSize>
  TrainedModelExportsConfigurationPolicy& WithMaxSize(MaxSizeT&& value) {
    SetMaxSize(std::forward<MaxSizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFilesToExport(FilesToExportT&& value) {
    m_filesToExportHasBeenSet = true;
    m_filesToExport = std::forward<FilesToExportT>(value);
  }
  template <typename FilesToExportT = Aws::Vector<TrainedModelExportFileType>>
  TrainedModelExportsConfigurationPolicy& WithFilesToExport(FilesToExportT&& value) {
    SetFilesToExport(std::forward<FilesToExportT>(value));
    return *this;
  }
  inline TrainedModelExportsConfigurationPolicy& AddFilesToExport(TrainedModelExportFileType value) {
    m_filesToExportHasBeenSet = true;
    m_filesToExport.push_back(value);
    return *this;
  }
  ///@}
 private:
