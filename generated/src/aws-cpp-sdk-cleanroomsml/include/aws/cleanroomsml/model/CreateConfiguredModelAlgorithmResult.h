...
class CreateConfiguredModelAlgorithmResult {
 public:
  ...
  AWS_CLEANROOMSML_API CreateConfiguredModelAlgorithmResult& operator=(
  ...
  template <typename ConfiguredModelAlgorithmArnT = Aws::String>
  CreateConfiguredModelAlgorithmResult& WithConfiguredModelAlgorithmArn(ConfiguredModelAlgorithmArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConfiguredModelAlgorithmResult& WithRequestId(RequestIdT&& value) {
