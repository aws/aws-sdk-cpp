...
class ListConfiguredAudienceModelsResult {
 public:
  ...
  AWS_CLEANROOMSML_API ListConfiguredAudienceModelsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredAudienceModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetConfiguredAudienceModels(ConfiguredAudienceModelsT&& value) {
    m_configuredAudienceModelsHasBeenSet = true;
    m_configuredAudienceModels = std::forward<ConfiguredAudienceModelsT>(value);
  }
  template <typename ConfiguredAudienceModelsT = Aws::Vector<ConfiguredAudienceModelSummary>>
  ListConfiguredAudienceModelsResult& WithConfiguredAudienceModels(ConfiguredAudienceModelsT&& value) {
    SetConfiguredAudienceModels(std::forward<ConfiguredAudienceModelsT>(value));
    return *this;
  }
  template <typename ConfiguredAudienceModelsT = ConfiguredAudienceModelSummary>
  ListConfiguredAudienceModelsResult& AddConfiguredAudienceModels(ConfiguredAudienceModelsT&& value) {
    m_configuredAudienceModelsHasBeenSet = true;
    m_configuredAudienceModels.emplace_back(std::forward<ConfiguredAudienceModelsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListConfiguredAudienceModelsResult& WithRequestId(RequestIdT&& value) {
