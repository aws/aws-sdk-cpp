...
class PutConfiguredAudienceModelPolicyRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename ConfiguredAudienceModelArnT = Aws::String>
  PutConfiguredAudienceModelPolicyRequest& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) {
  ...
  void SetConfiguredAudienceModelPolicy(ConfiguredAudienceModelPolicyT&& value) {
    m_configuredAudienceModelPolicyHasBeenSet = true;
    m_configuredAudienceModelPolicy = std::forward<ConfiguredAudienceModelPolicyT>(value);
  }
  template <typename ConfiguredAudienceModelPolicyT = Aws::String>
  PutConfiguredAudienceModelPolicyRequest& WithConfiguredAudienceModelPolicy(ConfiguredAudienceModelPolicyT&& value) {
    SetConfiguredAudienceModelPolicy(std::forward<ConfiguredAudienceModelPolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousPolicyHash(PreviousPolicyHashT&& value) {
    m_previousPolicyHashHasBeenSet = true;
    m_previousPolicyHash = std::forward<PreviousPolicyHashT>(value);
  }
  template <typename PreviousPolicyHashT = Aws::String>
  PutConfiguredAudienceModelPolicyRequest& WithPreviousPolicyHash(PreviousPolicyHashT&& value) {
    SetPreviousPolicyHash(std::forward<PreviousPolicyHashT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPolicyExistenceCondition(PolicyExistenceCondition value) {
    m_policyExistenceConditionHasBeenSet = true;
    m_policyExistenceCondition = value;
  }
  inline PutConfiguredAudienceModelPolicyRequest& WithPolicyExistenceCondition(PolicyExistenceCondition value) {
    SetPolicyExistenceCondition(value);
    return *this;
  }
  ///@}
 private:
