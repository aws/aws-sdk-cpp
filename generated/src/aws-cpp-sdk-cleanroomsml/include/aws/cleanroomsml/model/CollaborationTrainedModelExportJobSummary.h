...
class CollaborationTrainedModelExportJobSummary {
 public:
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationTrainedModelExportJobSummary& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationTrainedModelExportJobSummary& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename NameT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithName(NameT&& value) {
  ...
  template <typename OutputConfigurationT = TrainedModelExportOutputConfiguration>
  CollaborationTrainedModelExportJobSummary& WithOutputConfiguration(OutputConfigurationT&& value) {
  ...
  inline void SetStatus(TrainedModelExportJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline CollaborationTrainedModelExportJobSummary& WithStatus(TrainedModelExportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = StatusDetails>
  CollaborationTrainedModelExportJobSummary& WithStatusDetails(StatusDetailsT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename TrainedModelVersionIdentifierT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  CollaborationTrainedModelExportJobSummary& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
