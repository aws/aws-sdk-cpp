...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMSML_API DeleteConfiguredAudienceModelPolicyRequest() = default;
    ...
    template<typename ConfiguredAudienceModelArnT = Aws::String>
    DeleteConfiguredAudienceModelPolicyRequest& WithConfiguredAudienceModelArn(ConfiguredAudienceModelArnT&& value) { SetConfiguredAudienceModelArn(std::forward<ConfiguredAudienceModelArnT>(value)); return *this;}
    ///@}
  private:
