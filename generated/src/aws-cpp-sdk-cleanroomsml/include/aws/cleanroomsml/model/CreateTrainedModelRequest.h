...
class CreateTrainedModelRequest : public CleanRoomsMLRequest {
 public:
   ...
   */
  inline const Aws::Vector<IncrementalTrainingDataChannel>& GetIncrementalTrainingDataChannels() const {
  ...
  inline CreateTrainedModelRequest& WithTrainingInputMode(TrainingInputMode value) {
