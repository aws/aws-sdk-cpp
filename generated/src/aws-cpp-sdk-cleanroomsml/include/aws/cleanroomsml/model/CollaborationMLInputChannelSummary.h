...
class CollaborationMLInputChannelSummary {
 public:
  AWS_CLEANROOMSML_API CollaborationMLInputChannelSummary() = default;
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationMLInputChannelSummary& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationMLInputChannelSummary& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CollaborationMLInputChannelSummary& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  CollaborationMLInputChannelSummary& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename NameT = Aws::String>
  CollaborationMLInputChannelSummary& WithName(NameT&& value) {
  ...
  template <typename ConfiguredModelAlgorithmAssociationsT = Aws::Vector<Aws::String>>
  CollaborationMLInputChannelSummary& WithConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
  ...
  CollaborationMLInputChannelSummary& AddConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
    m_configuredModelAlgorithmAssociationsHasBeenSet = true;
  ...
  template <typename MlInputChannelArnT = Aws::String>
  CollaborationMLInputChannelSummary& WithMlInputChannelArn(MlInputChannelArnT&& value) {
  ...
  inline CollaborationMLInputChannelSummary& WithStatus(MLInputChannelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationMLInputChannelSummary& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CollaborationMLInputChannelSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename PayerConfigurationT = PayerConfiguration>
  CollaborationMLInputChannelSummary& WithPayerConfiguration(PayerConfigurationT&& value) {
