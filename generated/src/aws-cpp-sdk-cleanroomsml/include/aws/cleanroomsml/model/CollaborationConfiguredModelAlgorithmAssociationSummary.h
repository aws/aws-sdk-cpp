...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMSML_API CollaborationConfiguredModelAlgorithmAssociationSummary() = default;
    ...
    template<typename CreateTimeT = Aws::Utils::DateTime>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithCreateTime(CreateTimeT&& value) { SetCreateTime(std::forward<CreateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdateTimeT = Aws::Utils::DateTime>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithUpdateTime(UpdateTimeT&& value) { SetUpdateTime(std::forward<UpdateTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfiguredModelAlgorithmAssociationArnT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithConfiguredModelAlgorithmAssociationArn(ConfiguredModelAlgorithmAssociationArnT&& value) { SetConfiguredModelAlgorithmAssociationArn(std::forward<ConfiguredModelAlgorithmAssociationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename MembershipIdentifierT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename CollaborationIdentifierT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithCollaborationIdentifier(CollaborationIdentifierT&& value) { SetCollaborationIdentifier(std::forward<CollaborationIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename ConfiguredModelAlgorithmArnT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithConfiguredModelAlgorithmArn(ConfiguredModelAlgorithmArnT&& value) { SetConfiguredModelAlgorithmArn(std::forward<ConfiguredModelAlgorithmArnT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatorAccountIdT = Aws::String>
    CollaborationConfiguredModelAlgorithmAssociationSummary& WithCreatorAccountId(CreatorAccountIdT&& value) { SetCreatorAccountId(std::forward<CreatorAccountIdT>(value)); return *this;}
    ///@}
  private:
