...
class ListAudienceModelsRequest : public CleanRoomsMLRequest {
 public:
  AWS_CLEANROOMSML_API ListAudienceModelsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListAudienceModelsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAudienceModelsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
