...
class CreateConfiguredModelAlgorithmRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateConfiguredModelAlgorithmRequest& WithName(NameT&& value) {
  ...
  void SetTrainingContainerConfig(TrainingContainerConfigT&& value) {
    m_trainingContainerConfigHasBeenSet = true;
    m_trainingContainerConfig = std::forward<TrainingContainerConfigT>(value);
  }
  template <typename TrainingContainerConfigT = ContainerConfig>
  CreateConfiguredModelAlgorithmRequest& WithTrainingContainerConfig(TrainingContainerConfigT&& value) {
    SetTrainingContainerConfig(std::forward<TrainingContainerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInferenceContainerConfig(InferenceContainerConfigT&& value) {
    m_inferenceContainerConfigHasBeenSet = true;
    m_inferenceContainerConfig = std::forward<InferenceContainerConfigT>(value);
  }
  template <typename InferenceContainerConfigT = InferenceContainerConfig>
  CreateConfiguredModelAlgorithmRequest& WithInferenceContainerConfig(InferenceContainerConfigT&& value) {
    SetInferenceContainerConfig(std::forward<InferenceContainerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateConfiguredModelAlgorithmRequest& WithTags(TagsT&& value) {
