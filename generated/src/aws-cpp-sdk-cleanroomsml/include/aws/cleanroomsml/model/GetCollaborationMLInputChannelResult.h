...
class GetCollaborationMLInputChannelResult {
 public:
  ...
  AWS_CLEANROOMSML_API GetCollaborationMLInputChannelResult& operator=(
  ...
  template <typename MembershipIdentifierT = Aws::String>
  GetCollaborationMLInputChannelResult& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  GetCollaborationMLInputChannelResult& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename MlInputChannelArnT = Aws::String>
  GetCollaborationMLInputChannelResult& WithMlInputChannelArn(MlInputChannelArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  GetCollaborationMLInputChannelResult& WithName(NameT&& value) {
  ...
  template <typename ConfiguredModelAlgorithmAssociationsT = Aws::Vector<Aws::String>>
  GetCollaborationMLInputChannelResult& WithConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
  ...
  GetCollaborationMLInputChannelResult& AddConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
    m_configuredModelAlgorithmAssociationsHasBeenSet = true;
  ...
  inline void SetStatus(MLInputChannelStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetCollaborationMLInputChannelResult& WithStatus(MLInputChannelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusDetailsT = StatusDetails>
  GetCollaborationMLInputChannelResult& WithStatusDetails(StatusDetailsT&& value) {
  ...
  inline GetCollaborationMLInputChannelResult& WithRetentionInDays(int value) {
  ...
  inline void SetNumberOfRecords(long long value) {
    m_numberOfRecordsHasBeenSet = true;
    m_numberOfRecords = value;
  }
  inline GetCollaborationMLInputChannelResult& WithNumberOfRecords(long long value) {
  ...
  void SetPrivacyBudgets(PrivacyBudgetsT&& value) {
    m_privacyBudgetsHasBeenSet = true;
    m_privacyBudgets = std::forward<PrivacyBudgetsT>(value);
  }
  template <typename PrivacyBudgetsT = PrivacyBudgets>
  GetCollaborationMLInputChannelResult& WithPrivacyBudgets(PrivacyBudgetsT&& value) {
    SetPrivacyBudgets(std::forward<PrivacyBudgetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  GetCollaborationMLInputChannelResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename PayerConfigurationT = PayerConfiguration>
  GetCollaborationMLInputChannelResult& WithPayerConfiguration(PayerConfigurationT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  GetCollaborationMLInputChannelResult& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  GetCollaborationMLInputChannelResult& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  GetCollaborationMLInputChannelResult& WithCreatorAccountId(CreatorAccountIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCollaborationMLInputChannelResult& WithRequestId(RequestIdT&& value) {
