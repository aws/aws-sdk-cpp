...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceArnT = Aws::String>
    AccessBudget& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DetailsT = Aws::Vector<AccessBudgetDetails>>
    AccessBudget& WithDetails(DetailsT&& value) { SetDetails(std::forward<DetailsT>(value)); return *this;}
    template<typename DetailsT = AccessBudgetDetails>
    AccessBudget& AddDetails(DetailsT&& value) { m_detailsHasBeenSet = true; m_details.emplace_back(std::forward<DetailsT>(value)); return *this; }
    ///@}
    ...
    inline void SetAggregateRemainingBudget(int value) { m_aggregateRemainingBudgetHasBeenSet = true; m_aggregateRemainingBudget = value; }
    inline AccessBudget& WithAggregateRemainingBudget(int value) { SetAggregateRemainingBudget(value); return *this;}
    ///@}
  private:
