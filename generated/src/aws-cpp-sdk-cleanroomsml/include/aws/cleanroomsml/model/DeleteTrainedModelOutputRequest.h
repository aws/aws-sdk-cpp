...
class DeleteTrainedModelOutputRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename TrainedModelArnT = Aws::String>
  DeleteTrainedModelOutputRequest& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteTrainedModelOutputRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename VersionIdentifierT = Aws::String>
  DeleteTrainedModelOutputRequest& WithVersionIdentifier(VersionIdentifierT&& value) {
