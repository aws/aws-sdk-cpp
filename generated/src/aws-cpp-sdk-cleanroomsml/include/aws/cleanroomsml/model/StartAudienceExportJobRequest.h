...
class StartAudienceExportJobRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  StartAudienceExportJobRequest& WithName(NameT&& value) {
  ...
  template <typename AudienceGenerationJobArnT = Aws::String>
  StartAudienceExportJobRequest& WithAudienceGenerationJobArn(AudienceGenerationJobArnT&& value) {
  ...
  template <typename AudienceSizeT = AudienceSize>
  StartAudienceExportJobRequest& WithAudienceSize(AudienceSizeT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  StartAudienceExportJobRequest& WithDescription(DescriptionT&& value) {
