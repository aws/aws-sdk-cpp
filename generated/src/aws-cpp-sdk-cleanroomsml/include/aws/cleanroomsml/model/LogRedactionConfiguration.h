...
class LogRedactionConfiguration {
 public:
  ...
  void SetEntitiesToRedact(EntitiesToRedactT&& value) {
    m_entitiesToRedactHasBeenSet = true;
    m_entitiesToRedact = std::forward<EntitiesToRedactT>(value);
  }
  template <typename EntitiesToRedactT = Aws::Vector<EntityType>>
  LogRedactionConfiguration& WithEntitiesToRedact(EntitiesToRedactT&& value) {
    SetEntitiesToRedact(std::forward<EntitiesToRedactT>(value));
    return *this;
  }
  inline LogRedactionConfiguration& AddEntitiesToRedact(EntityType value) {
    m_entitiesToRedactHasBeenSet = true;
    m_entitiesToRedact.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomEntityConfig(CustomEntityConfigT&& value) {
    m_customEntityConfigHasBeenSet = true;
    m_customEntityConfig = std::forward<CustomEntityConfigT>(value);
  }
  template <typename CustomEntityConfigT = CustomEntityConfig>
  LogRedactionConfiguration& WithCustomEntityConfig(CustomEntityConfigT&& value) {
    SetCustomEntityConfig(std::forward<CustomEntityConfigT>(value));
    return *this;
  }
  ///@}
 private:
