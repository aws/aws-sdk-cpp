...
class ListAudienceExportJobsRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAudienceExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAudienceExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AudienceGenerationJobArnT = Aws::String>
  ListAudienceExportJobsRequest& WithAudienceGenerationJobArn(AudienceGenerationJobArnT&& value) {
