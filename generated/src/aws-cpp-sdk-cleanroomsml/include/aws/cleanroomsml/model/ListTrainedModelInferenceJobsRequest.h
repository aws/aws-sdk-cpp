...
class ListTrainedModelInferenceJobsRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainedModelInferenceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTrainedModelInferenceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListTrainedModelInferenceJobsRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  ListTrainedModelInferenceJobsRequest& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename TrainedModelVersionIdentifierT = Aws::String>
  ListTrainedModelInferenceJobsRequest& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) {
