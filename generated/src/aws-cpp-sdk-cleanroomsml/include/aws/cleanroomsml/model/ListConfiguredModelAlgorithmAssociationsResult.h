...
class ListConfiguredModelAlgorithmAssociationsResult {
 public:
  ...
  AWS_CLEANROOMSML_API ListConfiguredModelAlgorithmAssociationsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NextTokenT = Aws::String>
  ListConfiguredModelAlgorithmAssociationsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<ConfiguredModelAlgorithmAssociationSummary>& GetConfiguredModelAlgorithmAssociations() const {
    return m_configuredModelAlgorithmAssociations;
  }
  ...
  template <typename ConfiguredModelAlgorithmAssociationsT = Aws::Vector<ConfiguredModelAlgorithmAssociationSummary>>
  ListConfiguredModelAlgorithmAssociationsResult& WithConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
  ...
  ListConfiguredModelAlgorithmAssociationsResult& AddConfiguredModelAlgorithmAssociations(ConfiguredModelAlgorithmAssociationsT&& value) {
    m_configuredModelAlgorithmAssociationsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListConfiguredModelAlgorithmAssociationsResult& WithRequestId(RequestIdT&& value) {
