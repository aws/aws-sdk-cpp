...
class ListCollaborationTrainedModelInferenceJobsRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCollaborationTrainedModelInferenceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCollaborationTrainedModelInferenceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  ListCollaborationTrainedModelInferenceJobsRequest& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  ListCollaborationTrainedModelInferenceJobsRequest& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename TrainedModelVersionIdentifierT = Aws::String>
  ListCollaborationTrainedModelInferenceJobsRequest& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) {
