...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMSML_API ListCollaborationTrainedModelInferenceJobsRequest();
    ...
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
    ...
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithCollaborationIdentifier(const Aws::String& value) { SetCollaborationIdentifier(value); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithCollaborationIdentifier(Aws::String&& value) { SetCollaborationIdentifier(std::move(value)); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithCollaborationIdentifier(const char* value) { SetCollaborationIdentifier(value); return *this;}
    ///@}
    ...
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithTrainedModelArn(const Aws::String& value) { SetTrainedModelArn(value); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithTrainedModelArn(Aws::String&& value) { SetTrainedModelArn(std::move(value)); return *this;}
    inline ListCollaborationTrainedModelInferenceJobsRequest& WithTrainedModelArn(const char* value) { SetTrainedModelArn(value); return *this;}
    ///@}
  private:
