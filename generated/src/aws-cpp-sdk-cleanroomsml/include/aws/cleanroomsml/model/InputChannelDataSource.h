...
class InputChannelDataSource {
 public:
  ...
  void SetProtectedQueryInputParameters(ProtectedQueryInputParametersT&& value) {
    ...
    m_protectedQueryInputParameters = std::forward<ProtectedQueryInputParametersT>(value);
  }
  template <typename ProtectedQueryInputParametersT = ProtectedQueryInputParameters>
  InputChannelDataSource& WithProtectedQueryInputParameters(ProtectedQueryInputParametersT&& value) {
    SetProtectedQueryInputParameters(std::forward<ProtectedQueryInputParametersT>(value));
    return *this;
  }
  ///@}
 private:
