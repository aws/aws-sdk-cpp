...
class ListTrainedModelVersionsRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainedModelVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTrainedModelVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MembershipIdentifierT = Aws::String>
  ListTrainedModelVersionsRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  ListTrainedModelVersionsRequest& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  inline ListTrainedModelVersionsRequest& WithStatus(TrainedModelStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
