...
class TrainedModelInferenceMaxOutputSize {
 public:
  ...
  inline void SetUnit(TrainedModelInferenceMaxOutputSizeUnitType value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline TrainedModelInferenceMaxOutputSize& WithUnit(TrainedModelInferenceMaxOutputSizeUnitType value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline TrainedModelInferenceMaxOutputSize& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
