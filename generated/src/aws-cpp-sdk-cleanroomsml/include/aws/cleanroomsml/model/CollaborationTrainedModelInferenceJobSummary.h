...
class CollaborationTrainedModelInferenceJobSummary {
 public:
  ...
  template <typename TrainedModelInferenceJobArnT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithTrainedModelInferenceJobArn(TrainedModelInferenceJobArnT&& value) {
  ...
  template <typename ConfiguredModelAlgorithmAssociationArnT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithConfiguredModelAlgorithmAssociationArn(
  ...
  template <typename MembershipIdentifierT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename TrainedModelArnT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithTrainedModelArn(TrainedModelArnT&& value) {
  ...
  template <typename TrainedModelVersionIdentifierT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithTrainedModelVersionIdentifier(TrainedModelVersionIdentifierT&& value) {
  ...
  template <typename CollaborationIdentifierT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithCollaborationIdentifier(CollaborationIdentifierT&& value) {
  ...
  inline CollaborationTrainedModelInferenceJobSummary& WithStatus(TrainedModelInferenceJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename OutputConfigurationT = InferenceOutputConfiguration>
  CollaborationTrainedModelInferenceJobSummary& WithOutputConfiguration(OutputConfigurationT&& value) {
  ...
  template <typename NameT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithDescription(DescriptionT&& value) {
  ...
  inline CollaborationTrainedModelInferenceJobSummary& WithMetricsStatus(MetricsStatus value) {
  ...
  template <typename MetricsStatusDetailsT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithMetricsStatusDetails(MetricsStatusDetailsT&& value) {
  ...
  inline CollaborationTrainedModelInferenceJobSummary& WithLogsStatus(LogsStatus value) {
    SetLogsStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LogsStatusDetailsT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithLogsStatusDetails(LogsStatusDetailsT&& value) {
  ...
  template <typename MlModelInferencePayerAccountIdT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithMlModelInferencePayerAccountId(MlModelInferencePayerAccountIdT&& value) {
  ...
  template <typename CreateTimeT = Aws::Utils::DateTime>
  CollaborationTrainedModelInferenceJobSummary& WithCreateTime(CreateTimeT&& value) {
  ...
  template <typename UpdateTimeT = Aws::Utils::DateTime>
  CollaborationTrainedModelInferenceJobSummary& WithUpdateTime(UpdateTimeT&& value) {
  ...
  template <typename CreatorAccountIdT = Aws::String>
  CollaborationTrainedModelInferenceJobSummary& WithCreatorAccountId(CreatorAccountIdT&& value) {
