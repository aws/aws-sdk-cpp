...
class GetTrainedModelInferenceJobRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename MembershipIdentifierT = Aws::String>
  GetTrainedModelInferenceJobRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
  ...
  template <typename TrainedModelInferenceJobArnT = Aws::String>
  GetTrainedModelInferenceJobRequest& WithTrainedModelInferenceJobArn(TrainedModelInferenceJobArnT&& value) {
