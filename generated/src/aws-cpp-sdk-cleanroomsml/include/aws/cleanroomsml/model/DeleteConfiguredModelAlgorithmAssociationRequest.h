...
class DeleteConfiguredModelAlgorithmAssociationRequest : public CleanRoomsMLRequest {
 public:
  ...
  template <typename ConfiguredModelAlgorithmAssociationArnT = Aws::String>
  DeleteConfiguredModelAlgorithmAssociationRequest& WithConfiguredModelAlgorithmAssociationArn(
  ...
  template <typename MembershipIdentifierT = Aws::String>
  DeleteConfiguredModelAlgorithmAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) {
