...
namespace Model
{
  ...
  {
  public:
    AWS_CLEANROOMSML_API DeleteConfiguredModelAlgorithmAssociationRequest() = default;
    ...
    template<typename ConfiguredModelAlgorithmAssociationArnT = Aws::String>
    DeleteConfiguredModelAlgorithmAssociationRequest& WithConfiguredModelAlgorithmAssociationArn(ConfiguredModelAlgorithmAssociationArnT&& value) { SetConfiguredModelAlgorithmAssociationArn(std::forward<ConfiguredModelAlgorithmAssociationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MembershipIdentifierT = Aws::String>
    DeleteConfiguredModelAlgorithmAssociationRequest& WithMembershipIdentifier(MembershipIdentifierT&& value) { SetMembershipIdentifier(std::forward<MembershipIdentifierT>(value)); return *this;}
    ///@}
  private:
