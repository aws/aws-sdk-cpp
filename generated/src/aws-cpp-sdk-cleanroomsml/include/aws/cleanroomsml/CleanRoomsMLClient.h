...
class AWS_CLEANROOMSML_API CleanRoomsMLClient : public Aws::Client::AWSJsonClient,
                                                ...
                                                public CleanRoomsMLWaiter<CleanRoomsMLClient> {
 public:
   ...
   */
  CleanRoomsMLClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CleanRoomsMLEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CleanRoomsML::CleanRoomsMLClientConfiguration& clientConfiguration = Aws::CleanRoomsML::CleanRoomsMLClientConfiguration());
  ...
  /**
   * A Callable wrapper for CancelTrainedModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelTrainedModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelTrainedModelRequestT = Model::CancelTrainedModelRequest>
  void CancelTrainedModelAsync(const CancelTrainedModelRequestT& request, const CancelTrainedModelResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelTrainedModelInferenceJobOutcome CancelTrainedModelInferenceJob(
      const Model::CancelTrainedModelInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for CancelTrainedModelInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CancelTrainedModelInferenceJobRequestT = Model::CancelTrainedModelInferenceJobRequest>
  Model::CancelTrainedModelInferenceJobOutcomeCallable CancelTrainedModelInferenceJobCallable(
      const CancelTrainedModelInferenceJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::CancelTrainedModelInferenceJob, request);
  }

  /**
   * An Async wrapper for CancelTrainedModelInferenceJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CancelTrainedModelInferenceJobRequestT = Model::CancelTrainedModelInferenceJobRequest>
  void CancelTrainedModelInferenceJobAsync(const CancelTrainedModelInferenceJobRequestT& request,
                                           const CancelTrainedModelInferenceJobResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAudienceModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAudienceModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAudienceModelRequestT = Model::CreateAudienceModelRequest>
  void CreateAudienceModelAsync(const CreateAudienceModelRequestT& request, const CreateAudienceModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredAudienceModelOutcome CreateConfiguredAudienceModel(
      const Model::CreateConfiguredAudienceModelRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredAudienceModel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConfiguredAudienceModelRequestT = Model::CreateConfiguredAudienceModelRequest>
  Model::CreateConfiguredAudienceModelOutcomeCallable CreateConfiguredAudienceModelCallable(
      const CreateConfiguredAudienceModelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::CreateConfiguredAudienceModel, request);
  }

  /**
   * An Async wrapper for CreateConfiguredAudienceModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConfiguredAudienceModelRequestT = Model::CreateConfiguredAudienceModelRequest>
  void CreateConfiguredAudienceModelAsync(const CreateConfiguredAudienceModelRequestT& request,
                                          const CreateConfiguredAudienceModelResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredModelAlgorithmOutcome CreateConfiguredModelAlgorithm(
      const Model::CreateConfiguredModelAlgorithmRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredModelAlgorithm that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateConfiguredModelAlgorithmRequestT = Model::CreateConfiguredModelAlgorithmRequest>
  Model::CreateConfiguredModelAlgorithmOutcomeCallable CreateConfiguredModelAlgorithmCallable(
      const CreateConfiguredModelAlgorithmRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::CreateConfiguredModelAlgorithm, request);
  }

  /**
   * An Async wrapper for CreateConfiguredModelAlgorithm that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateConfiguredModelAlgorithmRequestT = Model::CreateConfiguredModelAlgorithmRequest>
  void CreateConfiguredModelAlgorithmAsync(const CreateConfiguredModelAlgorithmRequestT& request,
                                           const CreateConfiguredModelAlgorithmResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateConfiguredModelAlgorithmAssociationOutcome CreateConfiguredModelAlgorithmAssociation(
      const Model::CreateConfiguredModelAlgorithmAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateConfiguredModelAlgorithmAssociation that returns a future to the operation so that it can be executed in
  ...
  Model::CreateConfiguredModelAlgorithmAssociationOutcomeCallable CreateConfiguredModelAlgorithmAssociationCallable(
      const CreateConfiguredModelAlgorithmAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::CreateConfiguredModelAlgorithmAssociation, request);
  }

  /**
   * An Async wrapper for CreateConfiguredModelAlgorithmAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateConfiguredModelAlgorithmAssociationRequestT = Model::CreateConfiguredModelAlgorithmAssociationRequest>
  void CreateConfiguredModelAlgorithmAssociationAsync(
      const CreateConfiguredModelAlgorithmAssociationRequestT& request,
      const CreateConfiguredModelAlgorithmAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMLInputChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMLInputChannel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMLInputChannelRequestT = Model::CreateMLInputChannelRequest>
  void CreateMLInputChannelAsync(const CreateMLInputChannelRequestT& request, const CreateMLInputChannelResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTrainedModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrainedModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTrainedModelRequestT = Model::CreateTrainedModelRequest>
  void CreateTrainedModelAsync(const CreateTrainedModelRequestT& request, const CreateTrainedModelResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTrainingDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrainingDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTrainingDatasetRequestT = Model::CreateTrainingDatasetRequest>
  void CreateTrainingDatasetAsync(const CreateTrainingDatasetRequestT& request, const CreateTrainingDatasetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAudienceGenerationJobOutcome DeleteAudienceGenerationJob(
      const Model::DeleteAudienceGenerationJobRequest& request) const;

  /**
   * A Callable wrapper for DeleteAudienceGenerationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAudienceGenerationJobRequestT = Model::DeleteAudienceGenerationJobRequest>
  Model::DeleteAudienceGenerationJobOutcomeCallable DeleteAudienceGenerationJobCallable(
      const DeleteAudienceGenerationJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::DeleteAudienceGenerationJob, request);
  }

  /**
   * An Async wrapper for DeleteAudienceGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAudienceGenerationJobRequestT = Model::DeleteAudienceGenerationJobRequest>
  void DeleteAudienceGenerationJobAsync(const DeleteAudienceGenerationJobRequestT& request,
                                        const DeleteAudienceGenerationJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAudienceModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAudienceModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAudienceModelRequestT = Model::DeleteAudienceModelRequest>
  void DeleteAudienceModelAsync(const DeleteAudienceModelRequestT& request, const DeleteAudienceModelResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredAudienceModelOutcome DeleteConfiguredAudienceModel(
      const Model::DeleteConfiguredAudienceModelRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredAudienceModel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfiguredAudienceModelRequestT = Model::DeleteConfiguredAudienceModelRequest>
  Model::DeleteConfiguredAudienceModelOutcomeCallable DeleteConfiguredAudienceModelCallable(
      const DeleteConfiguredAudienceModelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::DeleteConfiguredAudienceModel, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredAudienceModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfiguredAudienceModelRequestT = Model::DeleteConfiguredAudienceModelRequest>
  void DeleteConfiguredAudienceModelAsync(const DeleteConfiguredAudienceModelRequestT& request,
                                          const DeleteConfiguredAudienceModelResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredAudienceModelPolicyOutcome DeleteConfiguredAudienceModelPolicy(
      const Model::DeleteConfiguredAudienceModelPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredAudienceModelPolicy that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteConfiguredAudienceModelPolicyRequestT = Model::DeleteConfiguredAudienceModelPolicyRequest>
  Model::DeleteConfiguredAudienceModelPolicyOutcomeCallable DeleteConfiguredAudienceModelPolicyCallable(
      const DeleteConfiguredAudienceModelPolicyRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::DeleteConfiguredAudienceModelPolicy, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredAudienceModelPolicy that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteConfiguredAudienceModelPolicyRequestT = Model::DeleteConfiguredAudienceModelPolicyRequest>
  void DeleteConfiguredAudienceModelPolicyAsync(const DeleteConfiguredAudienceModelPolicyRequestT& request,
                                                const DeleteConfiguredAudienceModelPolicyResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredModelAlgorithmOutcome DeleteConfiguredModelAlgorithm(
      const Model::DeleteConfiguredModelAlgorithmRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredModelAlgorithm that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteConfiguredModelAlgorithmRequestT = Model::DeleteConfiguredModelAlgorithmRequest>
  Model::DeleteConfiguredModelAlgorithmOutcomeCallable DeleteConfiguredModelAlgorithmCallable(
      const DeleteConfiguredModelAlgorithmRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::DeleteConfiguredModelAlgorithm, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredModelAlgorithm that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteConfiguredModelAlgorithmRequestT = Model::DeleteConfiguredModelAlgorithmRequest>
  void DeleteConfiguredModelAlgorithmAsync(const DeleteConfiguredModelAlgorithmRequestT& request,
                                           const DeleteConfiguredModelAlgorithmResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteConfiguredModelAlgorithmAssociationOutcome DeleteConfiguredModelAlgorithmAssociation(
      const Model::DeleteConfiguredModelAlgorithmAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteConfiguredModelAlgorithmAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::DeleteConfiguredModelAlgorithmAssociationOutcomeCallable DeleteConfiguredModelAlgorithmAssociationCallable(
      const DeleteConfiguredModelAlgorithmAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::DeleteConfiguredModelAlgorithmAssociation, request);
  }

  /**
   * An Async wrapper for DeleteConfiguredModelAlgorithmAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteConfiguredModelAlgorithmAssociationRequestT = Model::DeleteConfiguredModelAlgorithmAssociationRequest>
  void DeleteConfiguredModelAlgorithmAssociationAsync(
      const DeleteConfiguredModelAlgorithmAssociationRequestT& request,
      const DeleteConfiguredModelAlgorithmAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMLConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMLConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMLConfigurationRequestT = Model::DeleteMLConfigurationRequest>
  void DeleteMLConfigurationAsync(const DeleteMLConfigurationRequestT& request, const DeleteMLConfigurationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMLInputChannelData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMLInputChannelData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMLInputChannelDataRequestT = Model::DeleteMLInputChannelDataRequest>
  void DeleteMLInputChannelDataAsync(const DeleteMLInputChannelDataRequestT& request,
                                     const DeleteMLInputChannelDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTrainedModelOutput that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrainedModelOutput that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTrainedModelOutputRequestT = Model::DeleteTrainedModelOutputRequest>
  void DeleteTrainedModelOutputAsync(const DeleteTrainedModelOutputRequestT& request,
                                     const DeleteTrainedModelOutputResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTrainingDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrainingDataset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTrainingDatasetRequestT = Model::DeleteTrainingDatasetRequest>
  void DeleteTrainingDatasetAsync(const DeleteTrainingDatasetRequestT& request, const DeleteTrainingDatasetResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAudienceGenerationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAudienceGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAudienceGenerationJobRequestT = Model::GetAudienceGenerationJobRequest>
  void GetAudienceGenerationJobAsync(const GetAudienceGenerationJobRequestT& request,
                                     const GetAudienceGenerationJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAudienceModel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAudienceModel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAudienceModelRequestT = Model::GetAudienceModelRequest>
  void GetAudienceModelAsync(const GetAudienceModelRequestT& request, const GetAudienceModelResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationConfiguredModelAlgorithmAssociationOutcome GetCollaborationConfiguredModelAlgorithmAssociation(
      const Model::GetCollaborationConfiguredModelAlgorithmAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationConfiguredModelAlgorithmAssociation that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename GetCollaborationConfiguredModelAlgorithmAssociationRequestT =
                Model::GetCollaborationConfiguredModelAlgorithmAssociationRequest>
  Model::GetCollaborationConfiguredModelAlgorithmAssociationOutcomeCallable GetCollaborationConfiguredModelAlgorithmAssociationCallable(
      const GetCollaborationConfiguredModelAlgorithmAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetCollaborationConfiguredModelAlgorithmAssociation, request);
  }

  /**
   * An Async wrapper for GetCollaborationConfiguredModelAlgorithmAssociation that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename GetCollaborationConfiguredModelAlgorithmAssociationRequestT =
                Model::GetCollaborationConfiguredModelAlgorithmAssociationRequest>
  void GetCollaborationConfiguredModelAlgorithmAssociationAsync(
      const GetCollaborationConfiguredModelAlgorithmAssociationRequestT& request,
      const GetCollaborationConfiguredModelAlgorithmAssociationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationMLInputChannelOutcome GetCollaborationMLInputChannel(
      const Model::GetCollaborationMLInputChannelRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationMLInputChannel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCollaborationMLInputChannelRequestT = Model::GetCollaborationMLInputChannelRequest>
  Model::GetCollaborationMLInputChannelOutcomeCallable GetCollaborationMLInputChannelCallable(
      const GetCollaborationMLInputChannelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetCollaborationMLInputChannel, request);
  }

  /**
   * An Async wrapper for GetCollaborationMLInputChannel that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCollaborationMLInputChannelRequestT = Model::GetCollaborationMLInputChannelRequest>
  void GetCollaborationMLInputChannelAsync(const GetCollaborationMLInputChannelRequestT& request,
                                           const GetCollaborationMLInputChannelResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCollaborationTrainedModelOutcome GetCollaborationTrainedModel(
      const Model::GetCollaborationTrainedModelRequest& request) const;

  /**
   * A Callable wrapper for GetCollaborationTrainedModel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCollaborationTrainedModelRequestT = Model::GetCollaborationTrainedModelRequest>
  Model::GetCollaborationTrainedModelOutcomeCallable GetCollaborationTrainedModelCallable(
      const GetCollaborationTrainedModelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetCollaborationTrainedModel, request);
  }

  /**
   * An Async wrapper for GetCollaborationTrainedModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCollaborationTrainedModelRequestT = Model::GetCollaborationTrainedModelRequest>
  void GetCollaborationTrainedModelAsync(const GetCollaborationTrainedModelRequestT& request,
                                         const GetCollaborationTrainedModelResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredAudienceModelOutcome GetConfiguredAudienceModel(
      const Model::GetConfiguredAudienceModelRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredAudienceModel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConfiguredAudienceModelRequestT = Model::GetConfiguredAudienceModelRequest>
  Model::GetConfiguredAudienceModelOutcomeCallable GetConfiguredAudienceModelCallable(
      const GetConfiguredAudienceModelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetConfiguredAudienceModel, request);
  }

  /**
   * An Async wrapper for GetConfiguredAudienceModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConfiguredAudienceModelRequestT = Model::GetConfiguredAudienceModelRequest>
  void GetConfiguredAudienceModelAsync(const GetConfiguredAudienceModelRequestT& request,
                                       const GetConfiguredAudienceModelResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredAudienceModelPolicyOutcome GetConfiguredAudienceModelPolicy(
      const Model::GetConfiguredAudienceModelPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredAudienceModelPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetConfiguredAudienceModelPolicyRequestT = Model::GetConfiguredAudienceModelPolicyRequest>
  Model::GetConfiguredAudienceModelPolicyOutcomeCallable GetConfiguredAudienceModelPolicyCallable(
      const GetConfiguredAudienceModelPolicyRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetConfiguredAudienceModelPolicy, request);
  }

  /**
   * An Async wrapper for GetConfiguredAudienceModelPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetConfiguredAudienceModelPolicyRequestT = Model::GetConfiguredAudienceModelPolicyRequest>
  void GetConfiguredAudienceModelPolicyAsync(const GetConfiguredAudienceModelPolicyRequestT& request,
                                             const GetConfiguredAudienceModelPolicyResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredModelAlgorithmOutcome GetConfiguredModelAlgorithm(
      const Model::GetConfiguredModelAlgorithmRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredModelAlgorithm that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConfiguredModelAlgorithmRequestT = Model::GetConfiguredModelAlgorithmRequest>
  Model::GetConfiguredModelAlgorithmOutcomeCallable GetConfiguredModelAlgorithmCallable(
      const GetConfiguredModelAlgorithmRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetConfiguredModelAlgorithm, request);
  }

  /**
   * An Async wrapper for GetConfiguredModelAlgorithm that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConfiguredModelAlgorithmRequestT = Model::GetConfiguredModelAlgorithmRequest>
  void GetConfiguredModelAlgorithmAsync(const GetConfiguredModelAlgorithmRequestT& request,
                                        const GetConfiguredModelAlgorithmResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfiguredModelAlgorithmAssociationOutcome GetConfiguredModelAlgorithmAssociation(
      const Model::GetConfiguredModelAlgorithmAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetConfiguredModelAlgorithmAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetConfiguredModelAlgorithmAssociationRequestT = Model::GetConfiguredModelAlgorithmAssociationRequest>
  Model::GetConfiguredModelAlgorithmAssociationOutcomeCallable GetConfiguredModelAlgorithmAssociationCallable(
      const GetConfiguredModelAlgorithmAssociationRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetConfiguredModelAlgorithmAssociation, request);
  }

  /**
   * An Async wrapper for GetConfiguredModelAlgorithmAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetConfiguredModelAlgorithmAssociationRequestT = Model::GetConfiguredModelAlgorithmAssociationRequest>
  void GetConfiguredModelAlgorithmAssociationAsync(const GetConfiguredModelAlgorithmAssociationRequestT& request,
                                                   const GetConfiguredModelAlgorithmAssociationResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMLConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMLConfiguration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMLConfigurationRequestT = Model::GetMLConfigurationRequest>
  void GetMLConfigurationAsync(const GetMLConfigurationRequestT& request, const GetMLConfigurationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMLInputChannel that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMLInputChannel that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMLInputChannelRequestT = Model::GetMLInputChannelRequest>
  void GetMLInputChannelAsync(const GetMLInputChannelRequestT& request, const GetMLInputChannelResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTrainedModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTrainedModelRequestT = Model::GetTrainedModelRequest>
  void GetTrainedModelAsync(const GetTrainedModelRequestT& request, const GetTrainedModelResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTrainedModelInferenceJobOutcome GetTrainedModelInferenceJob(
      const Model::GetTrainedModelInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for GetTrainedModelInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTrainedModelInferenceJobRequestT = Model::GetTrainedModelInferenceJobRequest>
  Model::GetTrainedModelInferenceJobOutcomeCallable GetTrainedModelInferenceJobCallable(
      const GetTrainedModelInferenceJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::GetTrainedModelInferenceJob, request);
  }

  /**
   * An Async wrapper for GetTrainedModelInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTrainedModelInferenceJobRequestT = Model::GetTrainedModelInferenceJobRequest>
  void GetTrainedModelInferenceJobAsync(const GetTrainedModelInferenceJobRequestT& request,
                                        const GetTrainedModelInferenceJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTrainingDataset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTrainingDataset that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTrainingDatasetRequestT = Model::GetTrainingDatasetRequest>
  void GetTrainingDatasetAsync(const GetTrainingDatasetRequestT& request, const GetTrainingDatasetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAudienceExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAudienceExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAudienceExportJobsRequestT = Model::ListAudienceExportJobsRequest>
  void ListAudienceExportJobsAsync(const ListAudienceExportJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListAudienceExportJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAudienceGenerationJobsOutcome ListAudienceGenerationJobs(
      const Model::ListAudienceGenerationJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListAudienceGenerationJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAudienceGenerationJobsRequestT = Model::ListAudienceGenerationJobsRequest>
  Model::ListAudienceGenerationJobsOutcomeCallable ListAudienceGenerationJobsCallable(
      const ListAudienceGenerationJobsRequestT& request = {}) const {
    return SubmitCallable(&CleanRoomsMLClient::ListAudienceGenerationJobs, request);
  }

  /**
   * An Async wrapper for ListAudienceGenerationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAudienceGenerationJobsRequestT = Model::ListAudienceGenerationJobsRequest>
  void ListAudienceGenerationJobsAsync(const ListAudienceGenerationJobsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListAudienceGenerationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAudienceModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAudienceModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAudienceModelsRequestT = Model::ListAudienceModelsRequest>
  void ListAudienceModelsAsync(const ListAudienceModelsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListAudienceModelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationConfiguredModelAlgorithmAssociationsOutcome ListCollaborationConfiguredModelAlgorithmAssociations(
      const Model::ListCollaborationConfiguredModelAlgorithmAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationConfiguredModelAlgorithmAssociations that returns a future to the operation so that it can be
   * executed in parallel to other requests.
   */
  template <typename ListCollaborationConfiguredModelAlgorithmAssociationsRequestT =
                Model::ListCollaborationConfiguredModelAlgorithmAssociationsRequest>
  Model::ListCollaborationConfiguredModelAlgorithmAssociationsOutcomeCallable ListCollaborationConfiguredModelAlgorithmAssociationsCallable(
      const ListCollaborationConfiguredModelAlgorithmAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListCollaborationConfiguredModelAlgorithmAssociations, request);
  }

  /**
   * An Async wrapper for ListCollaborationConfiguredModelAlgorithmAssociations that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename ListCollaborationConfiguredModelAlgorithmAssociationsRequestT =
                Model::ListCollaborationConfiguredModelAlgorithmAssociationsRequest>
  void ListCollaborationConfiguredModelAlgorithmAssociationsAsync(
      const ListCollaborationConfiguredModelAlgorithmAssociationsRequestT& request,
      const ListCollaborationConfiguredModelAlgorithmAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationMLInputChannelsOutcome ListCollaborationMLInputChannels(
      const Model::ListCollaborationMLInputChannelsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationMLInputChannels that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCollaborationMLInputChannelsRequestT = Model::ListCollaborationMLInputChannelsRequest>
  Model::ListCollaborationMLInputChannelsOutcomeCallable ListCollaborationMLInputChannelsCallable(
      const ListCollaborationMLInputChannelsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListCollaborationMLInputChannels, request);
  }

  /**
   * An Async wrapper for ListCollaborationMLInputChannels that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCollaborationMLInputChannelsRequestT = Model::ListCollaborationMLInputChannelsRequest>
  void ListCollaborationMLInputChannelsAsync(const ListCollaborationMLInputChannelsRequestT& request,
                                             const ListCollaborationMLInputChannelsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationTrainedModelExportJobsOutcome ListCollaborationTrainedModelExportJobs(
      const Model::ListCollaborationTrainedModelExportJobsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationTrainedModelExportJobs that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListCollaborationTrainedModelExportJobsRequestT = Model::ListCollaborationTrainedModelExportJobsRequest>
  Model::ListCollaborationTrainedModelExportJobsOutcomeCallable ListCollaborationTrainedModelExportJobsCallable(
      const ListCollaborationTrainedModelExportJobsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListCollaborationTrainedModelExportJobs, request);
  }

  /**
   * An Async wrapper for ListCollaborationTrainedModelExportJobs that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCollaborationTrainedModelExportJobsRequestT = Model::ListCollaborationTrainedModelExportJobsRequest>
  void ListCollaborationTrainedModelExportJobsAsync(const ListCollaborationTrainedModelExportJobsRequestT& request,
                                                    const ListCollaborationTrainedModelExportJobsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationTrainedModelInferenceJobsOutcome ListCollaborationTrainedModelInferenceJobs(
      const Model::ListCollaborationTrainedModelInferenceJobsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationTrainedModelInferenceJobs that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListCollaborationTrainedModelInferenceJobsOutcomeCallable ListCollaborationTrainedModelInferenceJobsCallable(
      const ListCollaborationTrainedModelInferenceJobsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListCollaborationTrainedModelInferenceJobs, request);
  }

  /**
   * An Async wrapper for ListCollaborationTrainedModelInferenceJobs that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCollaborationTrainedModelInferenceJobsRequestT = Model::ListCollaborationTrainedModelInferenceJobsRequest>
  void ListCollaborationTrainedModelInferenceJobsAsync(
      const ListCollaborationTrainedModelInferenceJobsRequestT& request,
      const ListCollaborationTrainedModelInferenceJobsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCollaborationTrainedModelsOutcome ListCollaborationTrainedModels(
      const Model::ListCollaborationTrainedModelsRequest& request) const;

  /**
   * A Callable wrapper for ListCollaborationTrainedModels that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCollaborationTrainedModelsRequestT = Model::ListCollaborationTrainedModelsRequest>
  Model::ListCollaborationTrainedModelsOutcomeCallable ListCollaborationTrainedModelsCallable(
      const ListCollaborationTrainedModelsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListCollaborationTrainedModels, request);
  }

  /**
   * An Async wrapper for ListCollaborationTrainedModels that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCollaborationTrainedModelsRequestT = Model::ListCollaborationTrainedModelsRequest>
  void ListCollaborationTrainedModelsAsync(const ListCollaborationTrainedModelsRequestT& request,
                                           const ListCollaborationTrainedModelsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfiguredAudienceModelsOutcome ListConfiguredAudienceModels(
      const Model::ListConfiguredAudienceModelsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfiguredAudienceModels that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConfiguredAudienceModelsRequestT = Model::ListConfiguredAudienceModelsRequest>
  Model::ListConfiguredAudienceModelsOutcomeCallable ListConfiguredAudienceModelsCallable(
      const ListConfiguredAudienceModelsRequestT& request = {}) const {
    return SubmitCallable(&CleanRoomsMLClient::ListConfiguredAudienceModels, request);
  }

  /**
   * An Async wrapper for ListConfiguredAudienceModels that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfiguredAudienceModelsRequestT = Model::ListConfiguredAudienceModelsRequest>
  void ListConfiguredAudienceModelsAsync(const ListConfiguredAudienceModelsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListConfiguredAudienceModelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfiguredModelAlgorithmAssociationsOutcome ListConfiguredModelAlgorithmAssociations(
      const Model::ListConfiguredModelAlgorithmAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListConfiguredModelAlgorithmAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListConfiguredModelAlgorithmAssociationsRequestT = Model::ListConfiguredModelAlgorithmAssociationsRequest>
  Model::ListConfiguredModelAlgorithmAssociationsOutcomeCallable ListConfiguredModelAlgorithmAssociationsCallable(
      const ListConfiguredModelAlgorithmAssociationsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListConfiguredModelAlgorithmAssociations, request);
  }

  /**
   * An Async wrapper for ListConfiguredModelAlgorithmAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListConfiguredModelAlgorithmAssociationsRequestT = Model::ListConfiguredModelAlgorithmAssociationsRequest>
  void ListConfiguredModelAlgorithmAssociationsAsync(
      const ListConfiguredModelAlgorithmAssociationsRequestT& request,
      const ListConfiguredModelAlgorithmAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfiguredModelAlgorithmsOutcome ListConfiguredModelAlgorithms(
      const Model::ListConfiguredModelAlgorithmsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfiguredModelAlgorithms that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListConfiguredModelAlgorithmsRequestT = Model::ListConfiguredModelAlgorithmsRequest>
  Model::ListConfiguredModelAlgorithmsOutcomeCallable ListConfiguredModelAlgorithmsCallable(
      const ListConfiguredModelAlgorithmsRequestT& request = {}) const {
    return SubmitCallable(&CleanRoomsMLClient::ListConfiguredModelAlgorithms, request);
  }

  /**
   * An Async wrapper for ListConfiguredModelAlgorithms that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfiguredModelAlgorithmsRequestT = Model::ListConfiguredModelAlgorithmsRequest>
  void ListConfiguredModelAlgorithmsAsync(const ListConfiguredModelAlgorithmsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListConfiguredModelAlgorithmsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMLInputChannels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMLInputChannels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListMLInputChannelsRequestT = Model::ListMLInputChannelsRequest>
  void ListMLInputChannelsAsync(const ListMLInputChannelsRequestT& request, const ListMLInputChannelsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrainedModelInferenceJobsOutcome ListTrainedModelInferenceJobs(
      const Model::ListTrainedModelInferenceJobsRequest& request) const;

  /**
   * A Callable wrapper for ListTrainedModelInferenceJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTrainedModelInferenceJobsRequestT = Model::ListTrainedModelInferenceJobsRequest>
  Model::ListTrainedModelInferenceJobsOutcomeCallable ListTrainedModelInferenceJobsCallable(
      const ListTrainedModelInferenceJobsRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::ListTrainedModelInferenceJobs, request);
  }

  /**
   * An Async wrapper for ListTrainedModelInferenceJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrainedModelInferenceJobsRequestT = Model::ListTrainedModelInferenceJobsRequest>
  void ListTrainedModelInferenceJobsAsync(const ListTrainedModelInferenceJobsRequestT& request,
                                          const ListTrainedModelInferenceJobsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrainedModelVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrainedModelVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrainedModelVersionsRequestT = Model::ListTrainedModelVersionsRequest>
  void ListTrainedModelVersionsAsync(const ListTrainedModelVersionsRequestT& request,
                                     const ListTrainedModelVersionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrainedModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrainedModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrainedModelsRequestT = Model::ListTrainedModelsRequest>
  void ListTrainedModelsAsync(const ListTrainedModelsRequestT& request, const ListTrainedModelsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrainingDatasets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrainingDatasets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTrainingDatasetsRequestT = Model::ListTrainingDatasetsRequest>
  void ListTrainingDatasetsAsync(const ListTrainingDatasetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListTrainingDatasetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutConfiguredAudienceModelPolicyOutcome PutConfiguredAudienceModelPolicy(
      const Model::PutConfiguredAudienceModelPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutConfiguredAudienceModelPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename PutConfiguredAudienceModelPolicyRequestT = Model::PutConfiguredAudienceModelPolicyRequest>
  Model::PutConfiguredAudienceModelPolicyOutcomeCallable PutConfiguredAudienceModelPolicyCallable(
      const PutConfiguredAudienceModelPolicyRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::PutConfiguredAudienceModelPolicy, request);
  }

  /**
   * An Async wrapper for PutConfiguredAudienceModelPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutConfiguredAudienceModelPolicyRequestT = Model::PutConfiguredAudienceModelPolicyRequest>
  void PutConfiguredAudienceModelPolicyAsync(const PutConfiguredAudienceModelPolicyRequestT& request,
                                             const PutConfiguredAudienceModelPolicyResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutMLConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutMLConfiguration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutMLConfigurationRequestT = Model::PutMLConfigurationRequest>
  void PutMLConfigurationAsync(const PutMLConfigurationRequestT& request, const PutMLConfigurationResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartAudienceExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartAudienceExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAudienceExportJobRequestT = Model::StartAudienceExportJobRequest>
  void StartAudienceExportJobAsync(const StartAudienceExportJobRequestT& request,
                                   const StartAudienceExportJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartAudienceGenerationJobOutcome StartAudienceGenerationJob(
      const Model::StartAudienceGenerationJobRequest& request) const;

  /**
   * A Callable wrapper for StartAudienceGenerationJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartAudienceGenerationJobRequestT = Model::StartAudienceGenerationJobRequest>
  Model::StartAudienceGenerationJobOutcomeCallable StartAudienceGenerationJobCallable(
      const StartAudienceGenerationJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::StartAudienceGenerationJob, request);
  }

  /**
   * An Async wrapper for StartAudienceGenerationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartAudienceGenerationJobRequestT = Model::StartAudienceGenerationJobRequest>
  void StartAudienceGenerationJobAsync(const StartAudienceGenerationJobRequestT& request,
                                       const StartAudienceGenerationJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartTrainedModelExportJobOutcome StartTrainedModelExportJob(
      const Model::StartTrainedModelExportJobRequest& request) const;

  /**
   * A Callable wrapper for StartTrainedModelExportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartTrainedModelExportJobRequestT = Model::StartTrainedModelExportJobRequest>
  Model::StartTrainedModelExportJobOutcomeCallable StartTrainedModelExportJobCallable(
      const StartTrainedModelExportJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::StartTrainedModelExportJob, request);
  }

  /**
   * An Async wrapper for StartTrainedModelExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartTrainedModelExportJobRequestT = Model::StartTrainedModelExportJobRequest>
  void StartTrainedModelExportJobAsync(const StartTrainedModelExportJobRequestT& request,
                                       const StartTrainedModelExportJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartTrainedModelInferenceJobOutcome StartTrainedModelInferenceJob(
      const Model::StartTrainedModelInferenceJobRequest& request) const;

  /**
   * A Callable wrapper for StartTrainedModelInferenceJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartTrainedModelInferenceJobRequestT = Model::StartTrainedModelInferenceJobRequest>
  Model::StartTrainedModelInferenceJobOutcomeCallable StartTrainedModelInferenceJobCallable(
      const StartTrainedModelInferenceJobRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::StartTrainedModelInferenceJob, request);
  }

  /**
   * An Async wrapper for StartTrainedModelInferenceJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartTrainedModelInferenceJobRequestT = Model::StartTrainedModelInferenceJobRequest>
  void StartTrainedModelInferenceJobAsync(const StartTrainedModelInferenceJobRequestT& request,
                                          const StartTrainedModelInferenceJobResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateConfiguredAudienceModelOutcome UpdateConfiguredAudienceModel(
      const Model::UpdateConfiguredAudienceModelRequest& request) const;

  /**
   * A Callable wrapper for UpdateConfiguredAudienceModel that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateConfiguredAudienceModelRequestT = Model::UpdateConfiguredAudienceModelRequest>
  Model::UpdateConfiguredAudienceModelOutcomeCallable UpdateConfiguredAudienceModelCallable(
      const UpdateConfiguredAudienceModelRequestT& request) const {
    return SubmitCallable(&CleanRoomsMLClient::UpdateConfiguredAudienceModel, request);
  }

  /**
   * An Async wrapper for UpdateConfiguredAudienceModel that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfiguredAudienceModelRequestT = Model::UpdateConfiguredAudienceModelRequest>
  void UpdateConfiguredAudienceModelAsync(const UpdateConfiguredAudienceModelRequestT& request,
                                          const UpdateConfiguredAudienceModelResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CleanRoomsMLClient::UpdateConfiguredAudienceModel, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<CleanRoomsMLEndpointProviderBase>& accessEndpointProvider();
