...
namespace CleanRoomsML
{
   ...
   */
  class AWS_CLEANROOMSML_API CleanRoomsMLClient : Aws::Client::ClientWithAsyncTemplateMethods<CleanRoomsMLClient>,
    smithy::client::AwsSmithyClientT<Aws::CleanRoomsML::SERVICE_NAME,
