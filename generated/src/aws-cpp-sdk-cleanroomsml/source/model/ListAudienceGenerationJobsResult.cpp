...
ListAudienceGenerationJobsResult::ListAudienceGenerationJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAudienceGenerationJobsResult& ListAudienceGenerationJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("audienceGenerationJobs")) {
    ...
    for (unsigned audienceGenerationJobsIndex = 0; audienceGenerationJobsIndex < audienceGenerationJobsJsonList.GetLength();
         ++audienceGenerationJobsIndex) {
