...
UpdateConfiguredAudienceModelResult::UpdateConfiguredAudienceModelResult()
{
}

UpdateConfiguredAudienceModelResult::UpdateConfiguredAudienceModelResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
