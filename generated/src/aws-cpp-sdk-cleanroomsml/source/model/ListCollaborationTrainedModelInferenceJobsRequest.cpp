...
Aws::String ListCollaborationTrainedModelInferenceJobsRequest::SerializePayload() const { return {}; }

void ListCollaborationTrainedModelInferenceJobsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
