...
StartAudienceGenerationJobResult::StartAudienceGenerationJobResult()
{
}

StartAudienceGenerationJobResult::StartAudienceGenerationJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
