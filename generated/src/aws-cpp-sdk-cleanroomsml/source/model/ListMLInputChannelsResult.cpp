...
ListMLInputChannelsResult::ListMLInputChannelsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMLInputChannelsResult& ListMLInputChannelsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("mlInputChannelsList")) {
    ...
    for (unsigned mlInputChannelsListIndex = 0; mlInputChannelsListIndex < mlInputChannelsListJsonList.GetLength();
         ++mlInputChannelsListIndex) {
