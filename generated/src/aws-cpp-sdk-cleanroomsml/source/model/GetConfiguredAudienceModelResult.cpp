...
GetConfiguredAudienceModelResult::GetConfiguredAudienceModelResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetConfiguredAudienceModelResult& GetConfiguredAudienceModelResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("sharedAudienceMetrics")) {
    ...
    for (unsigned sharedAudienceMetricsIndex = 0; sharedAudienceMetricsIndex < sharedAudienceMetricsJsonList.GetLength();
      ...
      m_sharedAudienceMetrics.push_back(SharedAudienceMetricsMapper::GetSharedAudienceMetricsForName(
  ...
  if (jsonValue.ValueExists("childResourceTagOnCreatePolicy")) {
    m_childResourceTagOnCreatePolicy =
        TagOnCreatePolicyMapper::GetTagOnCreatePolicyForName(jsonValue.GetString("childResourceTagOnCreatePolicy"));
