...
CollaborationTrainedModelSummary::CollaborationTrainedModelSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue CollaborationTrainedModelSummary::Jsonize() const {
  ...
  if (m_incrementalTrainingDataChannelsHasBeenSet) {
    ...
    for (unsigned incrementalTrainingDataChannelsIndex = 0;
         incrementalTrainingDataChannelsIndex < incrementalTrainingDataChannelsJsonList.GetLength();
         ++incrementalTrainingDataChannelsIndex) {
      incrementalTrainingDataChannelsJsonList[incrementalTrainingDataChannelsIndex].AsObject(
          m_incrementalTrainingDataChannels[incrementalTrainingDataChannelsIndex].Jsonize());
    }
