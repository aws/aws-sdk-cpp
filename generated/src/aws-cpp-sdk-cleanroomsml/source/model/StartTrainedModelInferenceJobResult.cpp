...
StartTrainedModelInferenceJobResult::StartTrainedModelInferenceJobResult()
{
}

StartTrainedModelInferenceJobResult::StartTrainedModelInferenceJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
