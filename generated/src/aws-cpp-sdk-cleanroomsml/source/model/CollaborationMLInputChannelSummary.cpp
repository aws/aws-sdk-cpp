...
CollaborationMLInputChannelSummary::CollaborationMLInputChannelSummary(JsonView jsonValue) { *this = jsonValue; }

CollaborationMLInputChannelSummary& CollaborationMLInputChannelSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("configuredModelAlgorithmAssociations")) {
    ...
    for (unsigned configuredModelAlgorithmAssociationsIndex = 0;
      ...
      m_configuredModelAlgorithmAssociations.push_back(
          configuredModelAlgorithmAssociationsJsonList[configuredModelAlgorithmAssociationsIndex].AsString());
    }
...
JsonValue CollaborationMLInputChannelSummary::Jsonize() const {
  JsonValue payload;
  ...
  if (m_configuredModelAlgorithmAssociationsHasBeenSet) {
    ...
    for (unsigned configuredModelAlgorithmAssociationsIndex = 0;
         ...
         ++configuredModelAlgorithmAssociationsIndex) {
      configuredModelAlgorithmAssociationsJsonList[configuredModelAlgorithmAssociationsIndex].AsString(
          m_configuredModelAlgorithmAssociations[configuredModelAlgorithmAssociationsIndex]);
    }
