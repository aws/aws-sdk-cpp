...
GetTrainedModelResult::GetTrainedModelResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetTrainedModelResult& GetTrainedModelResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("incrementalTrainingDataChannels")) {
    ...
    for (unsigned incrementalTrainingDataChannelsIndex = 0;
         incrementalTrainingDataChannelsIndex < incrementalTrainingDataChannelsJsonList.GetLength();
         ++incrementalTrainingDataChannelsIndex) {
