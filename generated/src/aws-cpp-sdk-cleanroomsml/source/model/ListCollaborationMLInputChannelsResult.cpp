...
ListCollaborationMLInputChannelsResult& ListCollaborationMLInputChannelsResult::operator=(
  ...
  if (jsonValue.ValueExists("collaborationMLInputChannelsList")) {
    ...
    for (unsigned collaborationMLInputChannelsListIndex = 0;
         collaborationMLInputChannelsListIndex < collaborationMLInputChannelsListJsonList.GetLength();
         ++collaborationMLInputChannelsListIndex) {
      m_collaborationMLInputChannelsList.push_back(
          collaborationMLInputChannelsListJsonList[collaborationMLInputChannelsListIndex].AsObject());
    }
