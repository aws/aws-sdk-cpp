...
CreateRemoteAccessSessionConfiguration::CreateRemoteAccessSessionConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
CreateRemoteAccessSessionConfiguration& CreateRemoteAccessSessionConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("vpceConfigurationArns")) {
    ...
    for (unsigned vpceConfigurationArnsIndex = 0; vpceConfigurationArnsIndex < vpceConfigurationArnsJsonList.GetLength();
         ++vpceConfigurationArnsIndex) {
