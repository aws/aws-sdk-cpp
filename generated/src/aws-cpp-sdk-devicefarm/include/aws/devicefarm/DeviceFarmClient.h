...
#include <aws/devicefarm/DeviceFarmWaiter.h>
...
class AWS_DEVICEFARM_API DeviceFarmClient : public Aws::Client::AWSJsonClient,
                                            ...
                                            public DeviceFarmWaiter<DeviceFarmClient> {
 public:
   ...
   */
  DeviceFarmClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DeviceFarmEndpointProviderBase> endpointProvider = nullptr,
      const Aws::DeviceFarm::DeviceFarmClientConfiguration& clientConfiguration = Aws::DeviceFarm::DeviceFarmClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateDevicePool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDevicePool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDevicePoolRequestT = Model::CreateDevicePoolRequest>
  void CreateDevicePoolAsync(const CreateDevicePoolRequestT& request, const CreateDevicePoolResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateNetworkProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateNetworkProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNetworkProfileRequestT = Model::CreateNetworkProfileRequest>
  void CreateNetworkProfileAsync(const CreateNetworkProfileRequestT& request, const CreateNetworkProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRemoteAccessSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateRemoteAccessSessionRequestT = Model::CreateRemoteAccessSessionRequest>
  Model::CreateRemoteAccessSessionOutcomeCallable CreateRemoteAccessSessionCallable(
      const CreateRemoteAccessSessionRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::CreateRemoteAccessSession, request);
  }

  /**
   * An Async wrapper for CreateRemoteAccessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRemoteAccessSessionRequestT = Model::CreateRemoteAccessSessionRequest>
  void CreateRemoteAccessSessionAsync(const CreateRemoteAccessSessionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateTestGridProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTestGridProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTestGridProjectRequestT = Model::CreateTestGridProjectRequest>
  void CreateTestGridProjectAsync(const CreateTestGridProjectRequestT& request, const CreateTestGridProjectResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTestGridUrl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTestGridUrl that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTestGridUrlRequestT = Model::CreateTestGridUrlRequest>
  void CreateTestGridUrlAsync(const CreateTestGridUrlRequestT& request, const CreateTestGridUrlResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUpload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUploadRequestT = Model::CreateUploadRequest>
  void CreateUploadAsync(const CreateUploadRequestT& request, const CreateUploadResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVPCEConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVPCEConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateVPCEConfigurationRequestT = Model::CreateVPCEConfigurationRequest>
  void CreateVPCEConfigurationAsync(const CreateVPCEConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDevicePool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDevicePool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDevicePoolRequestT = Model::DeleteDevicePoolRequest>
  void DeleteDevicePoolAsync(const DeleteDevicePoolRequestT& request, const DeleteDevicePoolResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteNetworkProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteNetworkProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteNetworkProfileRequestT = Model::DeleteNetworkProfileRequest>
  void DeleteNetworkProfileAsync(const DeleteNetworkProfileRequestT& request, const DeleteNetworkProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRemoteAccessSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteRemoteAccessSessionRequestT = Model::DeleteRemoteAccessSessionRequest>
  Model::DeleteRemoteAccessSessionOutcomeCallable DeleteRemoteAccessSessionCallable(
      const DeleteRemoteAccessSessionRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::DeleteRemoteAccessSession, request);
  }

  /**
   * An Async wrapper for DeleteRemoteAccessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRemoteAccessSessionRequestT = Model::DeleteRemoteAccessSessionRequest>
  void DeleteRemoteAccessSessionAsync(const DeleteRemoteAccessSessionRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteRunRequestT = Model::DeleteRunRequest>
  ...
  /**
   * A Callable wrapper for DeleteTestGridProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTestGridProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTestGridProjectRequestT = Model::DeleteTestGridProjectRequest>
  void DeleteTestGridProjectAsync(const DeleteTestGridProjectRequestT& request, const DeleteTestGridProjectResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteUpload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteUploadRequestT = Model::DeleteUploadRequest>
  void DeleteUploadAsync(const DeleteUploadRequestT& request, const DeleteUploadResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteVPCEConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteVPCEConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteVPCEConfigurationRequestT = Model::DeleteVPCEConfigurationRequest>
  void DeleteVPCEConfigurationAsync(const DeleteVPCEConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDeviceInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceInstance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeviceInstanceRequestT = Model::GetDeviceInstanceRequest>
  void GetDeviceInstanceAsync(const GetDeviceInstanceRequestT& request, const GetDeviceInstanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDevicePool that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDevicePoolRequestT = Model::GetDevicePoolRequest>
  void GetDevicePoolAsync(const GetDevicePoolRequestT& request, const GetDevicePoolResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDevicePoolCompatibilityOutcome GetDevicePoolCompatibility(
      const Model::GetDevicePoolCompatibilityRequest& request) const;

  /**
   * A Callable wrapper for GetDevicePoolCompatibility that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDevicePoolCompatibilityRequestT = Model::GetDevicePoolCompatibilityRequest>
  Model::GetDevicePoolCompatibilityOutcomeCallable GetDevicePoolCompatibilityCallable(
      const GetDevicePoolCompatibilityRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::GetDevicePoolCompatibility, request);
  }

  /**
   * An Async wrapper for GetDevicePoolCompatibility that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDevicePoolCompatibilityRequestT = Model::GetDevicePoolCompatibilityRequest>
  void GetDevicePoolCompatibilityAsync(const GetDevicePoolCompatibilityRequestT& request,
  ...
  /**
   * A Callable wrapper for GetNetworkProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNetworkProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetNetworkProfileRequestT = Model::GetNetworkProfileRequest>
  void GetNetworkProfileAsync(const GetNetworkProfileRequestT& request, const GetNetworkProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOfferingStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOfferingStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetOfferingStatusRequestT = Model::GetOfferingStatusRequest>
  void GetOfferingStatusAsync(const GetOfferingStatusResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetOfferingStatusRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetProject that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetProjectRequestT = Model::GetProjectRequest>
  void GetProjectAsync(const GetProjectRequestT& request, const GetProjectResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRemoteAccessSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRemoteAccessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRemoteAccessSessionRequestT = Model::GetRemoteAccessSessionRequest>
  void GetRemoteAccessSessionAsync(const GetRemoteAccessSessionRequestT& request,
  ...
  /**
   * An Async wrapper for GetRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetRunRequestT = Model::GetRunRequest>
  void GetRunAsync(const GetRunRequestT& request, const GetRunResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSuite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSuiteRequestT = Model::GetSuiteRequest>
  void GetSuiteAsync(const GetSuiteRequestT& request, const GetSuiteResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTestGridProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTestGridProject that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTestGridProjectRequestT = Model::GetTestGridProjectRequest>
  void GetTestGridProjectAsync(const GetTestGridProjectRequestT& request, const GetTestGridProjectResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTestGridSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTestGridSession that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetTestGridSessionRequestT = Model::GetTestGridSessionRequest>
  void GetTestGridSessionAsync(const GetTestGridSessionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetTestGridSessionRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetUpload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUploadRequestT = Model::GetUploadRequest>
  void GetUploadAsync(const GetUploadRequestT& request, const GetUploadResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVPCEConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVPCEConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetVPCEConfigurationRequestT = Model::GetVPCEConfigurationRequest>
  void GetVPCEConfigurationAsync(const GetVPCEConfigurationRequestT& request, const GetVPCEConfigurationResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::InstallToRemoteAccessSessionOutcome InstallToRemoteAccessSession(
      const Model::InstallToRemoteAccessSessionRequest& request) const;

  /**
   * A Callable wrapper for InstallToRemoteAccessSession that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename InstallToRemoteAccessSessionRequestT = Model::InstallToRemoteAccessSessionRequest>
  Model::InstallToRemoteAccessSessionOutcomeCallable InstallToRemoteAccessSessionCallable(
      const InstallToRemoteAccessSessionRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::InstallToRemoteAccessSession, request);
  }

  /**
   * An Async wrapper for InstallToRemoteAccessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename InstallToRemoteAccessSessionRequestT = Model::InstallToRemoteAccessSessionRequest>
  void InstallToRemoteAccessSessionAsync(const InstallToRemoteAccessSessionRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDeviceInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeviceInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDeviceInstancesRequestT = Model::ListDeviceInstancesRequest>
  void ListDeviceInstancesAsync(const ListDeviceInstancesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListDeviceInstancesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListDevicePools that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDevicePoolsRequestT = Model::ListDevicePoolsRequest>
  void ListDevicePoolsAsync(const ListDevicePoolsRequestT& request, const ListDevicePoolsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListNetworkProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNetworkProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListNetworkProfilesRequestT = Model::ListNetworkProfilesRequest>
  void ListNetworkProfilesAsync(const ListNetworkProfilesRequestT& request, const ListNetworkProfilesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListOfferingPromotions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOfferingPromotions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOfferingPromotionsRequestT = Model::ListOfferingPromotionsRequest>
  void ListOfferingPromotionsAsync(const ListOfferingPromotionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListOfferingPromotionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOfferingTransactions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListOfferingTransactionsRequestT = Model::ListOfferingTransactionsRequest>
  Model::ListOfferingTransactionsOutcomeCallable ListOfferingTransactionsCallable(
      const ListOfferingTransactionsRequestT& request = {}) const {
    return SubmitCallable(&DeviceFarmClient::ListOfferingTransactions, request);
  }

  /**
   * An Async wrapper for ListOfferingTransactions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOfferingTransactionsRequestT = Model::ListOfferingTransactionsRequest>
  void ListOfferingTransactionsAsync(const ListOfferingTransactionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListOfferingTransactionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListRemoteAccessSessions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRemoteAccessSessions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRemoteAccessSessionsRequestT = Model::ListRemoteAccessSessionsRequest>
  void ListRemoteAccessSessionsAsync(const ListRemoteAccessSessionsRequestT& request,
  ...
  /**
   * An Async wrapper for ListRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListRunsRequestT = Model::ListRunsRequest>
  void ListRunsAsync(const ListRunsRequestT& request, const ListRunsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSamples that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSamplesRequestT = Model::ListSamplesRequest>
  void ListSamplesAsync(const ListSamplesRequestT& request, const ListSamplesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSuites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSuitesRequestT = Model::ListSuitesRequest>
  void ListSuitesAsync(const ListSuitesRequestT& request, const ListSuitesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTestGridProjects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTestGridProjects that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestGridProjectsRequestT = Model::ListTestGridProjectsRequest>
  void ListTestGridProjectsAsync(const ListTestGridProjectsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListTestGridProjectsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTestGridSessionActionsOutcome ListTestGridSessionActions(
      const Model::ListTestGridSessionActionsRequest& request) const;

  /**
   * A Callable wrapper for ListTestGridSessionActions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTestGridSessionActionsRequestT = Model::ListTestGridSessionActionsRequest>
  Model::ListTestGridSessionActionsOutcomeCallable ListTestGridSessionActionsCallable(
      const ListTestGridSessionActionsRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::ListTestGridSessionActions, request);
  }

  /**
   * An Async wrapper for ListTestGridSessionActions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestGridSessionActionsRequestT = Model::ListTestGridSessionActionsRequest>
  void ListTestGridSessionActionsAsync(const ListTestGridSessionActionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTestGridSessionArtifactsOutcome ListTestGridSessionArtifacts(
      const Model::ListTestGridSessionArtifactsRequest& request) const;

  /**
   * A Callable wrapper for ListTestGridSessionArtifacts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTestGridSessionArtifactsRequestT = Model::ListTestGridSessionArtifactsRequest>
  Model::ListTestGridSessionArtifactsOutcomeCallable ListTestGridSessionArtifactsCallable(
      const ListTestGridSessionArtifactsRequestT& request) const {
    return SubmitCallable(&DeviceFarmClient::ListTestGridSessionArtifacts, request);
  }

  /**
   * An Async wrapper for ListTestGridSessionArtifacts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestGridSessionArtifactsRequestT = Model::ListTestGridSessionArtifactsRequest>
  void ListTestGridSessionArtifactsAsync(const ListTestGridSessionArtifactsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListTestGridSessions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTestGridSessions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestGridSessionsRequestT = Model::ListTestGridSessionsRequest>
  void ListTestGridSessionsAsync(const ListTestGridSessionsRequestT& request, const ListTestGridSessionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListUniqueProblems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUniqueProblems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListUniqueProblemsRequestT = Model::ListUniqueProblemsRequest>
  void ListUniqueProblemsAsync(const ListUniqueProblemsRequestT& request, const ListUniqueProblemsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListUploads that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUploadsRequestT = Model::ListUploadsRequest>
  void ListUploadsAsync(const ListUploadsRequestT& request, const ListUploadsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListVPCEConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListVPCEConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListVPCEConfigurationsRequestT = Model::ListVPCEConfigurationsRequest>
  void ListVPCEConfigurationsAsync(const ListVPCEConfigurationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListVPCEConfigurationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for RenewOffering that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RenewOfferingRequestT = Model::RenewOfferingRequest>
  void RenewOfferingAsync(const RenewOfferingRequestT& request, const RenewOfferingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ScheduleRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ScheduleRunRequestT = Model::ScheduleRunRequest>
  void ScheduleRunAsync(const ScheduleRunRequestT& request, const ScheduleRunResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopRemoteAccessSession that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopRemoteAccessSession that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopRemoteAccessSessionRequestT = Model::StopRemoteAccessSessionRequest>
  void StopRemoteAccessSessionAsync(const StopRemoteAccessSessionRequestT& request,
  ...
  /**
   * An Async wrapper for StopRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopRunRequestT = Model::StopRunRequest>
  void StopRunAsync(const StopRunRequestT& request, const StopRunResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDeviceInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDeviceInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDeviceInstanceRequestT = Model::UpdateDeviceInstanceRequest>
  void UpdateDeviceInstanceAsync(const UpdateDeviceInstanceRequestT& request, const UpdateDeviceInstanceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDevicePool that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDevicePool that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDevicePoolRequestT = Model::UpdateDevicePoolRequest>
  void UpdateDevicePoolAsync(const UpdateDevicePoolRequestT& request, const UpdateDevicePoolResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInstanceProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInstanceProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInstanceProfileRequestT = Model::UpdateInstanceProfileRequest>
  void UpdateInstanceProfileAsync(const UpdateInstanceProfileRequestT& request, const UpdateInstanceProfileResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateNetworkProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNetworkProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNetworkProfileRequestT = Model::UpdateNetworkProfileRequest>
  void UpdateNetworkProfileAsync(const UpdateNetworkProfileRequestT& request, const UpdateNetworkProfileResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTestGridProject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTestGridProject that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTestGridProjectRequestT = Model::UpdateTestGridProjectRequest>
  void UpdateTestGridProjectAsync(const UpdateTestGridProjectRequestT& request, const UpdateTestGridProjectResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateUpload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateUploadRequestT = Model::UpdateUploadRequest>
  void UpdateUploadAsync(const UpdateUploadRequestT& request, const UpdateUploadResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateVPCEConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateVPCEConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateVPCEConfigurationRequestT = Model::UpdateVPCEConfigurationRequest>
  void UpdateVPCEConfigurationAsync(const UpdateVPCEConfigurationRequestT& request,
