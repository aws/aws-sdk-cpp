...
namespace Model
{
  ...
  {
  public:
    AWS_DEVICEFARM_API ListTestsRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    ListTestsRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTestsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
