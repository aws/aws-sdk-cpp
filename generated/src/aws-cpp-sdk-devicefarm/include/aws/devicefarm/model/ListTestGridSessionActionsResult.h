...
class ListTestGridSessionActionsResult {
 public:
  ...
  template <typename ActionsT = Aws::Vector<TestGridSessionAction>>
  ListTestGridSessionActionsResult& WithActions(ActionsT&& value) {
    SetActions(std::forward<ActionsT>(value));
    return *this;
  }
  template <typename ActionsT = TestGridSessionAction>
  ListTestGridSessionActionsResult& AddActions(ActionsT&& value) {
    m_actionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridSessionActionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestGridSessionActionsResult& WithRequestId(RequestIdT&& value) {
