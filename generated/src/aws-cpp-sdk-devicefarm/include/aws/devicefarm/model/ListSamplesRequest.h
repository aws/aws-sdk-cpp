...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ListSamplesRequest : public DeviceFarmRequest
  {
  public:
    ...
    template<typename ArnT = Aws::String>
    ListSamplesRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListSamplesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
