...
class ListDeviceInstancesResult {
 public:
  ...
  void SetDeviceInstances(DeviceInstancesT&& value) {
    m_deviceInstancesHasBeenSet = true;
    m_deviceInstances = std::forward<DeviceInstancesT>(value);
  }
  template <typename DeviceInstancesT = Aws::Vector<DeviceInstance>>
  ListDeviceInstancesResult& WithDeviceInstances(DeviceInstancesT&& value) {
    SetDeviceInstances(std::forward<DeviceInstancesT>(value));
    return *this;
  }
  template <typename DeviceInstancesT = DeviceInstance>
  ListDeviceInstancesResult& AddDeviceInstances(DeviceInstancesT&& value) {
    m_deviceInstancesHasBeenSet = true;
    m_deviceInstances.emplace_back(std::forward<DeviceInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceInstancesResult& WithRequestId(RequestIdT&& value) {
