...
class ListTestGridSessionArtifactsRequest : public DeviceFarmRequest {
 public:
  ...
  template <typename SessionArnT = Aws::String>
  ListTestGridSessionArtifactsRequest& WithSessionArn(SessionArnT&& value) {
  ...
  inline void SetType(TestGridSessionArtifactCategory value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ListTestGridSessionArtifactsRequest& WithType(TestGridSessionArtifactCategory value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ListTestGridSessionArtifactsRequest& WithMaxResult(int value) {
    SetMaxResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridSessionArtifactsRequest& WithNextToken(NextTokenT&& value) {
