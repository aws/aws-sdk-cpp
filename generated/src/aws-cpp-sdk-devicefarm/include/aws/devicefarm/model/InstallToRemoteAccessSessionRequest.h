...
class InstallToRemoteAccessSessionRequest : public DeviceFarmRequest {
 public:
  ...
  void SetRemoteAccessSessionArn(RemoteAccessSessionArnT&& value) {
    m_remoteAccessSessionArnHasBeenSet = true;
    m_remoteAccessSessionArn = std::forward<RemoteAccessSessionArnT>(value);
  }
  template <typename RemoteAccessSessionArnT = Aws::String>
  InstallToRemoteAccessSessionRequest& WithRemoteAccessSessionArn(RemoteAccessSessionArnT&& value) {
    SetRemoteAccessSessionArn(std::forward<RemoteAccessSessionArnT>(value));
    return *this;
  }
  ///@}
