...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetOfferingStatusRequest : public DeviceFarmRequest
  {
  public:
    AWS_DEVICEFARM_API GetOfferingStatusRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    GetOfferingStatusRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
