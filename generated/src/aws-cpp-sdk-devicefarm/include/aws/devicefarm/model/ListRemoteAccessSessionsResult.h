...
class ListRemoteAccessSessionsResult {
 public:
  ...
  void SetRemoteAccessSessions(RemoteAccessSessionsT&& value) {
    m_remoteAccessSessionsHasBeenSet = true;
    m_remoteAccessSessions = std::forward<RemoteAccessSessionsT>(value);
  }
  template <typename RemoteAccessSessionsT = Aws::Vector<RemoteAccessSession>>
  ListRemoteAccessSessionsResult& WithRemoteAccessSessions(RemoteAccessSessionsT&& value) {
    SetRemoteAccessSessions(std::forward<RemoteAccessSessionsT>(value));
    return *this;
  }
  template <typename RemoteAccessSessionsT = RemoteAccessSession>
  ListRemoteAccessSessionsResult& AddRemoteAccessSessions(RemoteAccessSessionsT&& value) {
    m_remoteAccessSessionsHasBeenSet = true;
    m_remoteAccessSessions.emplace_back(std::forward<RemoteAccessSessionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRemoteAccessSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRemoteAccessSessionsResult& WithRequestId(RequestIdT&& value) {
