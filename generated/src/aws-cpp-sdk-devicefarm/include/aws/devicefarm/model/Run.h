...
class Run {
 public:
  ...
  inline Run& WithType(TestType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPlatform(DevicePlatform value) {
    m_platformHasBeenSet = true;
    m_platform = value;
  }
  inline Run& WithPlatform(DevicePlatform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline Run& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Run& WithResult(ExecutionResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalJobs(int value) {
    m_totalJobsHasBeenSet = true;
    m_totalJobs = value;
  }
  inline Run& WithTotalJobs(int value) {
    SetTotalJobs(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompletedJobs(int value) {
    m_completedJobsHasBeenSet = true;
    m_completedJobs = value;
  }
  inline Run& WithCompletedJobs(int value) {
  ...
  inline Run& WithBillingMethod(BillingMethod value) {
  ...
  void SetParsingResultUrl(ParsingResultUrlT&& value) {
    ...
    m_parsingResultUrl = std::forward<ParsingResultUrlT>(value);
  }
  template <typename ParsingResultUrlT = Aws::String>
  Run& WithParsingResultUrl(ParsingResultUrlT&& value) {
    SetParsingResultUrl(std::forward<ParsingResultUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResultCode(ExecutionResultCode value) {
    m_resultCodeHasBeenSet = true;
    m_resultCode = value;
  }
  inline Run& WithResultCode(ExecutionResultCode value) {
    SetResultCode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeed(int value) {
    m_seedHasBeenSet = true;
    m_seed = value;
  }
  inline Run& WithSeed(int value) {
    SetSeed(value);
    return *this;
  }
  ///@}
  ...
  inline Run& WithEventCount(int value) {
    SetEventCount(value);
    return *this;
  }
  ///@}
  ...
  inline Run& WithJobTimeoutMinutes(int value) {
  ...
  void SetDevicePoolArn(DevicePoolArnT&& value) {
    ...
    m_devicePoolArn = std::forward<DevicePoolArnT>(value);
  }
  template <typename DevicePoolArnT = Aws::String>
  Run& WithDevicePoolArn(DevicePoolArnT&& value) {
    SetDevicePoolArn(std::forward<DevicePoolArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline Run& WithSkipAppResign(bool value) {
  ...
  void SetDeviceSelectionResult(DeviceSelectionResultT&& value) {
    ...
    m_deviceSelectionResult = std::forward<DeviceSelectionResultT>(value);
  }
  template <typename DeviceSelectionResultT = DeviceSelectionResult>
  Run& WithDeviceSelectionResult(DeviceSelectionResultT&& value) {
    SetDeviceSelectionResult(std::forward<DeviceSelectionResultT>(value));
    return *this;
  }
  ///@}
