...
class RenewOfferingResult {
 public:
  ...
  void SetOfferingTransaction(OfferingTransactionT&& value) {
    m_offeringTransactionHasBeenSet = true;
    m_offeringTransaction = std::forward<OfferingTransactionT>(value);
  }
  template <typename OfferingTransactionT = OfferingTransaction>
  RenewOfferingResult& WithOfferingTransaction(OfferingTransactionT&& value) {
    SetOfferingTransaction(std::forward<OfferingTransactionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RenewOfferingResult& WithRequestId(RequestIdT&& value) {
