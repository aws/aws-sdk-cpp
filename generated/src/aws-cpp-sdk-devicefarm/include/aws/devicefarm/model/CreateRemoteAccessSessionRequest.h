...
class CreateRemoteAccessSessionRequest : public DeviceFarmRequest {
 public:
  ...
  inline CreateRemoteAccessSessionRequest& WithRemoteDebugEnabled(bool value) {
  ...
  inline CreateRemoteAccessSessionRequest& WithRemoteRecordEnabled(bool value) {
  ...
  inline CreateRemoteAccessSessionRequest& WithInteractionMode(InteractionMode value) {
