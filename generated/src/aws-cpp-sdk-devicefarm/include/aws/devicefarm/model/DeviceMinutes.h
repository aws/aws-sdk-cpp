...
class DeviceMinutes {
 public:
  ...
  inline DeviceMinutes& WithTotal(double value) {
    SetTotal(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMetered(double value) {
    m_meteredHasBeenSet = true;
    m_metered = value;
  }
  inline DeviceMinutes& WithMetered(double value) {
    SetMetered(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnmetered(double value) {
    m_unmeteredHasBeenSet = true;
    m_unmetered = value;
  }
  inline DeviceMinutes& WithUnmetered(double value) {
    SetUnmetered(value);
    return *this;
  }
  ///@}
