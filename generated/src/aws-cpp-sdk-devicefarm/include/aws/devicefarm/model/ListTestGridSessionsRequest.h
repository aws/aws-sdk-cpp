...
class ListTestGridSessionsRequest : public DeviceFarmRequest {
 public:
  ...
  template <typename ProjectArnT = Aws::String>
  ListTestGridSessionsRequest& WithProjectArn(ProjectArnT&& value) {
  ...
  inline ListTestGridSessionsRequest& WithStatus(TestGridSessionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListTestGridSessionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListTestGridSessionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename EndTimeAfterT = Aws::Utils::DateTime>
  ListTestGridSessionsRequest& WithEndTimeAfter(EndTimeAfterT&& value) {
  ...
  template <typename EndTimeBeforeT = Aws::Utils::DateTime>
  ListTestGridSessionsRequest& WithEndTimeBefore(EndTimeBeforeT&& value) {
  ...
  inline ListTestGridSessionsRequest& WithMaxResult(int value) {
    SetMaxResult(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridSessionsRequest& WithNextToken(NextTokenT&& value) {
