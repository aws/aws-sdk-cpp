...
class ListUniqueProblemsResult {
 public:
  ...
  void SetUniqueProblems(UniqueProblemsT&& value) {
    m_uniqueProblemsHasBeenSet = true;
    m_uniqueProblems = std::forward<UniqueProblemsT>(value);
  }
  template <typename UniqueProblemsT = Aws::Map<ExecutionResult, Aws::Vector<UniqueProblem>>>
  ListUniqueProblemsResult& WithUniqueProblems(UniqueProblemsT&& value) {
    SetUniqueProblems(std::forward<UniqueProblemsT>(value));
    return *this;
  }
  inline ListUniqueProblemsResult& AddUniqueProblems(ExecutionResult key, Aws::Vector<UniqueProblem> value) {
    m_uniqueProblemsHasBeenSet = true;
    m_uniqueProblems.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUniqueProblemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUniqueProblemsResult& WithRequestId(RequestIdT&& value) {
