...
class ListTestGridProjectsResult {
 public:
  ...
  void SetTestGridProjects(TestGridProjectsT&& value) {
    m_testGridProjectsHasBeenSet = true;
    m_testGridProjects = std::forward<TestGridProjectsT>(value);
  }
  template <typename TestGridProjectsT = Aws::Vector<TestGridProject>>
  ListTestGridProjectsResult& WithTestGridProjects(TestGridProjectsT&& value) {
    SetTestGridProjects(std::forward<TestGridProjectsT>(value));
    return *this;
  }
  template <typename TestGridProjectsT = TestGridProject>
  ListTestGridProjectsResult& AddTestGridProjects(TestGridProjectsT&& value) {
    m_testGridProjectsHasBeenSet = true;
    m_testGridProjects.emplace_back(std::forward<TestGridProjectsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridProjectsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestGridProjectsResult& WithRequestId(RequestIdT&& value) {
