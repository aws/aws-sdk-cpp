...
class ListTestGridSessionArtifactsResult {
 public:
  ...
  template <typename ArtifactsT = Aws::Vector<TestGridSessionArtifact>>
  ListTestGridSessionArtifactsResult& WithArtifacts(ArtifactsT&& value) {
    SetArtifacts(std::forward<ArtifactsT>(value));
    return *this;
  }
  template <typename ArtifactsT = TestGridSessionArtifact>
  ListTestGridSessionArtifactsResult& AddArtifacts(ArtifactsT&& value) {
    m_artifactsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridSessionArtifactsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestGridSessionArtifactsResult& WithRequestId(RequestIdT&& value) {
