...
class OfferingTransaction {
 public:
  ...
  void SetOfferingStatus(OfferingStatusT&& value) {
    ...
    m_offeringStatus = std::forward<OfferingStatusT>(value);
  }
  template <typename OfferingStatusT = OfferingStatus>
  OfferingTransaction& WithOfferingStatus(OfferingStatusT&& value) {
    SetOfferingStatus(std::forward<OfferingStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOfferingPromotionId(OfferingPromotionIdT&& value) {
    ...
    m_offeringPromotionId = std::forward<OfferingPromotionIdT>(value);
  }
  template <typename OfferingPromotionIdT = Aws::String>
  OfferingTransaction& WithOfferingPromotionId(OfferingPromotionIdT&& value) {
    SetOfferingPromotionId(std::forward<OfferingPromotionIdT>(value));
    return *this;
  }
  ///@}
