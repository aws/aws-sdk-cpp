...
class ListVPCEConfigurationsResult {
 public:
  ...
  void SetVpceConfigurations(VpceConfigurationsT&& value) {
    m_vpceConfigurationsHasBeenSet = true;
    m_vpceConfigurations = std::forward<VpceConfigurationsT>(value);
  }
  template <typename VpceConfigurationsT = Aws::Vector<VPCEConfiguration>>
  ListVPCEConfigurationsResult& WithVpceConfigurations(VpceConfigurationsT&& value) {
    SetVpceConfigurations(std::forward<VpceConfigurationsT>(value));
    return *this;
  }
  template <typename VpceConfigurationsT = VPCEConfiguration>
  ListVPCEConfigurationsResult& AddVpceConfigurations(VpceConfigurationsT&& value) {
    m_vpceConfigurationsHasBeenSet = true;
    m_vpceConfigurations.emplace_back(std::forward<VpceConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVPCEConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVPCEConfigurationsResult& WithRequestId(RequestIdT&& value) {
