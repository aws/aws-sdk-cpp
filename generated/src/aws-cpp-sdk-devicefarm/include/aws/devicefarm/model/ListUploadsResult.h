...
class ListUploadsResult {
 public:
  ...
  template <typename UploadsT = Aws::Vector<Upload>>
  ListUploadsResult& WithUploads(UploadsT&& value) {
    SetUploads(std::forward<UploadsT>(value));
    return *this;
  }
  template <typename UploadsT = Upload>
  ListUploadsResult& AddUploads(UploadsT&& value) {
    m_uploadsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListUploadsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUploadsResult& WithRequestId(RequestIdT&& value) {
