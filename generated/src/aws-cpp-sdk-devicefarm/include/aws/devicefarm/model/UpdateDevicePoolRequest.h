...
class UpdateDevicePoolRequest : public DeviceFarmRequest {
 public:
  ...
  inline UpdateDevicePoolRequest& WithMaxDevices(int value) {
    SetMaxDevices(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClearMaxDevices(bool value) {
    m_clearMaxDevicesHasBeenSet = true;
    m_clearMaxDevices = value;
  }
  inline UpdateDevicePoolRequest& WithClearMaxDevices(bool value) {
    SetClearMaxDevices(value);
    return *this;
  }
  ///@}
 private:
