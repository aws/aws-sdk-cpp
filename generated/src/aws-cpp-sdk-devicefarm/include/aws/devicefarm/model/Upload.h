...
class Upload {
 public:
  ...
  inline Upload& WithType(UploadType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(UploadStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Upload& WithStatus(UploadStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCategory(UploadCategory value) {
    m_categoryHasBeenSet = true;
    m_category = value;
  }
  inline Upload& WithCategory(UploadCategory value) {
    SetCategory(value);
    return *this;
  }
  ///@}
