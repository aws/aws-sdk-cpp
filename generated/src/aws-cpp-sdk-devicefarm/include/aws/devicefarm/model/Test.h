...
class Test {
 public:
  ...
  inline Test& WithType(TestType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Test& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Test& WithResult(ExecutionResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  void SetCounters(CountersT&& value) {
    ...
    m_counters = std::forward<CountersT>(value);
  }
  template <typename CountersT = Counters>
  Test& WithCounters(CountersT&& value) {
    SetCounters(std::forward<CountersT>(value));
    return *this;
  }
  ///@}
