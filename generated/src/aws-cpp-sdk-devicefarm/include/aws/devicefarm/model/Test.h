...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    Test& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    Test& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedT = Aws::Utils::DateTime>
    Test& WithCreated(CreatedT&& value) { SetCreated(std::forward<CreatedT>(value)); return *this;}
    ///@}
    ...
    template<typename StartedT = Aws::Utils::DateTime>
    Test& WithStarted(StartedT&& value) { SetStarted(std::forward<StartedT>(value)); return *this;}
    ///@}
    ...
    template<typename StoppedT = Aws::Utils::DateTime>
    Test& WithStopped(StoppedT&& value) { SetStopped(std::forward<StoppedT>(value)); return *this;}
    ///@}
    ...
    template<typename CountersT = Counters>
    Test& WithCounters(CountersT&& value) { SetCounters(std::forward<CountersT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    Test& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename DeviceMinutesT = DeviceMinutes>
    Test& WithDeviceMinutes(DeviceMinutesT&& value) { SetDeviceMinutes(std::forward<DeviceMinutesT>(value)); return *this;}
    ///@}
  private:
