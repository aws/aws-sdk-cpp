...
namespace Model
{
  ...
  {
  public:
    AWS_DEVICEFARM_API DeleteDevicePoolResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDevicePoolResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
