...
class AccountSettings {
 public:
  ...
  void SetAwsAccountNumber(AwsAccountNumberT&& value) {
    ...
    m_awsAccountNumber = std::forward<AwsAccountNumberT>(value);
  }
  template <typename AwsAccountNumberT = Aws::String>
  AccountSettings& WithAwsAccountNumber(AwsAccountNumberT&& value) {
    SetAwsAccountNumber(std::forward<AwsAccountNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnmeteredDevices(UnmeteredDevicesT&& value) {
    ...
    m_unmeteredDevices = std::forward<UnmeteredDevicesT>(value);
  }
  template <typename UnmeteredDevicesT = Aws::Map<DevicePlatform, int>>
  AccountSettings& WithUnmeteredDevices(UnmeteredDevicesT&& value) {
    SetUnmeteredDevices(std::forward<UnmeteredDevicesT>(value));
    return *this;
  }
  inline AccountSettings& AddUnmeteredDevices(DevicePlatform key, int value) {
    m_unmeteredDevicesHasBeenSet = true;
    m_unmeteredDevices.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetUnmeteredRemoteAccessDevices(UnmeteredRemoteAccessDevicesT&& value) {
    ...
    m_unmeteredRemoteAccessDevices = std::forward<UnmeteredRemoteAccessDevicesT>(value);
  }
  template <typename UnmeteredRemoteAccessDevicesT = Aws::Map<DevicePlatform, int>>
  AccountSettings& WithUnmeteredRemoteAccessDevices(UnmeteredRemoteAccessDevicesT&& value) {
    SetUnmeteredRemoteAccessDevices(std::forward<UnmeteredRemoteAccessDevicesT>(value));
    return *this;
  }
  inline AccountSettings& AddUnmeteredRemoteAccessDevices(DevicePlatform key, int value) {
    m_unmeteredRemoteAccessDevicesHasBeenSet = true;
    m_unmeteredRemoteAccessDevices.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxJobTimeoutMinutes(int value) {
    m_maxJobTimeoutMinutesHasBeenSet = true;
    m_maxJobTimeoutMinutes = value;
  }
  inline AccountSettings& WithMaxJobTimeoutMinutes(int value) {
    SetMaxJobTimeoutMinutes(value);
    return *this;
  }
  ///@}
  ...
  void SetTrialMinutes(TrialMinutesT&& value) {
    ...
    m_trialMinutes = std::forward<TrialMinutesT>(value);
  }
  template <typename TrialMinutesT = TrialMinutes>
  AccountSettings& WithTrialMinutes(TrialMinutesT&& value) {
    SetTrialMinutes(std::forward<TrialMinutesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMaxSlots(MaxSlotsT&& value) {
    ...
    m_maxSlots = std::forward<MaxSlotsT>(value);
  }
  template <typename MaxSlotsT = Aws::Map<Aws::String, int>>
  AccountSettings& WithMaxSlots(MaxSlotsT&& value) {
    SetMaxSlots(std::forward<MaxSlotsT>(value));
    return *this;
  }
  inline AccountSettings& AddMaxSlots(Aws::String key, int value) {
    m_maxSlotsHasBeenSet = true;
    m_maxSlots.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  inline AccountSettings& WithDefaultJobTimeoutMinutes(int value) {
  ...
  inline AccountSettings& WithSkipAppResign(bool value) {
