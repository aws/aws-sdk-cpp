...
class Radios {
 public:
  ...
  inline void SetWifi(bool value) {
    m_wifiHasBeenSet = true;
    m_wifi = value;
  }
  inline Radios& WithWifi(bool value) {
    SetWifi(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBluetooth(bool value) {
    m_bluetoothHasBeenSet = true;
    m_bluetooth = value;
  }
  inline Radios& WithBluetooth(bool value) {
    SetBluetooth(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNfc(bool value) {
    m_nfcHasBeenSet = true;
    m_nfc = value;
  }
  inline Radios& WithNfc(bool value) {
    SetNfc(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGps(bool value) {
    m_gpsHasBeenSet = true;
    m_gps = value;
  }
  inline Radios& WithGps(bool value) {
    SetGps(value);
    return *this;
  }
  ///@}
