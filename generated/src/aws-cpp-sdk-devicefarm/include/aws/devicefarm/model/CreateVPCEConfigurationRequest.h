...
class CreateVPCEConfigurationRequest : public DeviceFarmRequest {
 public:
  ...
  template <typename VpceConfigurationNameT = Aws::String>
  CreateVPCEConfigurationRequest& WithVpceConfigurationName(VpceConfigurationNameT&& value) {
  ...
  template <typename VpceServiceNameT = Aws::String>
  CreateVPCEConfigurationRequest& WithVpceServiceName(VpceServiceNameT&& value) {
  ...
  template <typename ServiceDnsNameT = Aws::String>
  CreateVPCEConfigurationRequest& WithServiceDnsName(ServiceDnsNameT&& value) {
  ...
  template <typename VpceConfigurationDescriptionT = Aws::String>
  CreateVPCEConfigurationRequest& WithVpceConfigurationDescription(VpceConfigurationDescriptionT&& value) {
