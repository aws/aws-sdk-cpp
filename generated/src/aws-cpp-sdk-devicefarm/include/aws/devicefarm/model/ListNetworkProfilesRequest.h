...
class ListNetworkProfilesRequest : public DeviceFarmRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListNetworkProfilesRequest& WithArn(ArnT&& value) {
  ...
  inline ListNetworkProfilesRequest& WithType(NetworkProfileType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkProfilesRequest& WithNextToken(NextTokenT&& value) {
