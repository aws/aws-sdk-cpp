...
class ExecutionConfiguration {
 public:
  ...
  inline void SetJobTimeoutMinutes(int value) {
    m_jobTimeoutMinutesHasBeenSet = true;
    m_jobTimeoutMinutes = value;
  }
  inline ExecutionConfiguration& WithJobTimeoutMinutes(int value) {
    SetJobTimeoutMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAccountsCleanup(bool value) {
    m_accountsCleanupHasBeenSet = true;
    m_accountsCleanup = value;
  }
  inline ExecutionConfiguration& WithAccountsCleanup(bool value) {
    SetAccountsCleanup(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAppPackagesCleanup(bool value) {
    m_appPackagesCleanupHasBeenSet = true;
    m_appPackagesCleanup = value;
  }
  inline ExecutionConfiguration& WithAppPackagesCleanup(bool value) {
    SetAppPackagesCleanup(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVideoCapture(bool value) {
    m_videoCaptureHasBeenSet = true;
    m_videoCapture = value;
  }
  inline ExecutionConfiguration& WithVideoCapture(bool value) {
    SetVideoCapture(value);
    return *this;
  }
  ///@}
  ...
  inline ExecutionConfiguration& WithSkipAppResign(bool value) {
