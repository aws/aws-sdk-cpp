...
class Job {
 public:
  ...
  inline Job& WithType(TestType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Job& WithResult(ExecutionResult value) {
    SetResult(value);
    return *this;
  }
  ///@}
  ...
  void SetVideoEndpoint(VideoEndpointT&& value) {
    ...
    m_videoEndpoint = std::forward<VideoEndpointT>(value);
  }
  template <typename VideoEndpointT = Aws::String>
  Job& WithVideoEndpoint(VideoEndpointT&& value) {
    SetVideoEndpoint(std::forward<VideoEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline Job& WithVideoCapture(bool value) {
