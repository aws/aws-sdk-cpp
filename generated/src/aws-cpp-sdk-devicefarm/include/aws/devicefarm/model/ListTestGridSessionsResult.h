...
class ListTestGridSessionsResult {
 public:
  ...
  void SetTestGridSessions(TestGridSessionsT&& value) {
    m_testGridSessionsHasBeenSet = true;
    m_testGridSessions = std::forward<TestGridSessionsT>(value);
  }
  template <typename TestGridSessionsT = Aws::Vector<TestGridSession>>
  ListTestGridSessionsResult& WithTestGridSessions(TestGridSessionsT&& value) {
    SetTestGridSessions(std::forward<TestGridSessionsT>(value));
    return *this;
  }
  template <typename TestGridSessionsT = TestGridSession>
  ListTestGridSessionsResult& AddTestGridSessions(TestGridSessionsT&& value) {
    m_testGridSessionsHasBeenSet = true;
    m_testGridSessions.emplace_back(std::forward<TestGridSessionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestGridSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestGridSessionsResult& WithRequestId(RequestIdT&& value) {
