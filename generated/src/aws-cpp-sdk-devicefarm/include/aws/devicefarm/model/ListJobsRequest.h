...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class ListJobsRequest : public DeviceFarmRequest
  {
  public:
    AWS_DEVICEFARM_API ListJobsRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    ListJobsRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
