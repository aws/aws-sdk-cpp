...
namespace Model
{
  ...
  {
  public:
    AWS_DEVICEFARM_API DeleteTestGridProjectResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTestGridProjectResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
