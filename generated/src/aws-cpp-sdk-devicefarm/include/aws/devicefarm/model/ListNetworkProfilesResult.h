...
class ListNetworkProfilesResult {
 public:
  ...
  void SetNetworkProfiles(NetworkProfilesT&& value) {
    m_networkProfilesHasBeenSet = true;
    m_networkProfiles = std::forward<NetworkProfilesT>(value);
  }
  template <typename NetworkProfilesT = Aws::Vector<NetworkProfile>>
  ListNetworkProfilesResult& WithNetworkProfiles(NetworkProfilesT&& value) {
    SetNetworkProfiles(std::forward<NetworkProfilesT>(value));
    return *this;
  }
  template <typename NetworkProfilesT = NetworkProfile>
  ListNetworkProfilesResult& AddNetworkProfiles(NetworkProfilesT&& value) {
    m_networkProfilesHasBeenSet = true;
    m_networkProfiles.emplace_back(std::forward<NetworkProfilesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListNetworkProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListNetworkProfilesResult& WithRequestId(RequestIdT&& value) {
