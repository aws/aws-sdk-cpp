...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetRunRequest : public DeviceFarmRequest
  {
  public:
    AWS_DEVICEFARM_API GetRunRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    GetRunRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
