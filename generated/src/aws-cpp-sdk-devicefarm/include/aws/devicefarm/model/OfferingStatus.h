...
class OfferingStatus {
 public:
  ...
  inline void SetType(OfferingTransactionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline OfferingStatus& WithType(OfferingTransactionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetOffering(OfferingT&& value) {
    ...
    m_offering = std::forward<OfferingT>(value);
  }
  template <typename OfferingT = Offering>
  OfferingStatus& WithOffering(OfferingT&& value) {
    SetOffering(std::forward<OfferingT>(value));
    return *this;
  }
  ///@}
  ...
  inline OfferingStatus& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
