...
class UpdateNetworkProfileRequest : public DeviceFarmRequest {
 public:
  ...
  inline UpdateNetworkProfileRequest& WithType(NetworkProfileType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateNetworkProfileRequest& WithUplinkBandwidthBits(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithDownlinkBandwidthBits(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithUplinkDelayMs(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithDownlinkDelayMs(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithUplinkJitterMs(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithDownlinkJitterMs(long long value) {
  ...
  inline UpdateNetworkProfileRequest& WithUplinkLossPercent(int value) {
  ...
  inline UpdateNetworkProfileRequest& WithDownlinkLossPercent(int value) {
