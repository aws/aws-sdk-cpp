...
class DeviceFilter {
 public:
  ...
  inline void SetAttribute(DeviceFilterAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline DeviceFilter& WithAttribute(DeviceFilterAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOperator(RuleOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline DeviceFilter& WithOperator(RuleOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DeviceFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DeviceFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
