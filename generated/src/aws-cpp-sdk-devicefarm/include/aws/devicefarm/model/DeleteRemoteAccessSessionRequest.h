...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteRemoteAccessSessionRequest : public DeviceFarmRequest
  {
  public:
    AWS_DEVICEFARM_API DeleteRemoteAccessSessionRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteRemoteAccessSessionRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
