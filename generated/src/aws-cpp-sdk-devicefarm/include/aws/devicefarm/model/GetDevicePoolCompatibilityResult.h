...
class GetDevicePoolCompatibilityResult {
 public:
  ...
  void SetCompatibleDevices(CompatibleDevicesT&& value) {
    m_compatibleDevicesHasBeenSet = true;
    m_compatibleDevices = std::forward<CompatibleDevicesT>(value);
  }
  template <typename CompatibleDevicesT = Aws::Vector<DevicePoolCompatibilityResult>>
  GetDevicePoolCompatibilityResult& WithCompatibleDevices(CompatibleDevicesT&& value) {
    SetCompatibleDevices(std::forward<CompatibleDevicesT>(value));
    return *this;
  }
  template <typename CompatibleDevicesT = DevicePoolCompatibilityResult>
  GetDevicePoolCompatibilityResult& AddCompatibleDevices(CompatibleDevicesT&& value) {
    m_compatibleDevicesHasBeenSet = true;
    m_compatibleDevices.emplace_back(std::forward<CompatibleDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncompatibleDevices(IncompatibleDevicesT&& value) {
    m_incompatibleDevicesHasBeenSet = true;
    m_incompatibleDevices = std::forward<IncompatibleDevicesT>(value);
  }
  template <typename IncompatibleDevicesT = Aws::Vector<DevicePoolCompatibilityResult>>
  GetDevicePoolCompatibilityResult& WithIncompatibleDevices(IncompatibleDevicesT&& value) {
    SetIncompatibleDevices(std::forward<IncompatibleDevicesT>(value));
    return *this;
  }
  template <typename IncompatibleDevicesT = DevicePoolCompatibilityResult>
  GetDevicePoolCompatibilityResult& AddIncompatibleDevices(IncompatibleDevicesT&& value) {
    m_incompatibleDevicesHasBeenSet = true;
    m_incompatibleDevices.emplace_back(std::forward<IncompatibleDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDevicePoolCompatibilityResult& WithRequestId(RequestIdT&& value) {
