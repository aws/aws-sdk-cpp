...
namespace Model
{
  ...
  {
  public:
    AWS_DEVICEFARM_API DeleteNetworkProfileResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteNetworkProfileResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
