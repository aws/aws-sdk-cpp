...
class UpdateVPCEConfigurationRequest : public DeviceFarmRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  UpdateVPCEConfigurationRequest& WithArn(ArnT&& value) {
  ...
  template <typename VpceConfigurationNameT = Aws::String>
  UpdateVPCEConfigurationRequest& WithVpceConfigurationName(VpceConfigurationNameT&& value) {
  ...
  template <typename VpceServiceNameT = Aws::String>
  UpdateVPCEConfigurationRequest& WithVpceServiceName(VpceServiceNameT&& value) {
  ...
  template <typename ServiceDnsNameT = Aws::String>
  UpdateVPCEConfigurationRequest& WithServiceDnsName(ServiceDnsNameT&& value) {
  ...
  template <typename VpceConfigurationDescriptionT = Aws::String>
  UpdateVPCEConfigurationRequest& WithVpceConfigurationDescription(VpceConfigurationDescriptionT&& value) {
