...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DeleteDevicePoolRequest : public DeviceFarmRequest
  {
  public:
    AWS_DEVICEFARM_API DeleteDevicePoolRequest() = default;
    ...
    template<typename ArnT = Aws::String>
    DeleteDevicePoolRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
  private:
