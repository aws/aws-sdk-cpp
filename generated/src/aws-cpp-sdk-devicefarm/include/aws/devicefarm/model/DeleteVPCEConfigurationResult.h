...
namespace Model
{
  ...
  {
  public:
    AWS_DEVICEFARM_API DeleteVPCEConfigurationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteVPCEConfigurationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
