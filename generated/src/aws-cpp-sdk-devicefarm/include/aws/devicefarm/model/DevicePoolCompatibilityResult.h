...
class DevicePoolCompatibilityResult {
 public:
  ...
  template <typename DeviceT = Device>
  DevicePoolCompatibilityResult& WithDevice(DeviceT&& value) {
  ...
  inline void SetCompatible(bool value) {
    m_compatibleHasBeenSet = true;
    m_compatible = value;
  }
  inline DevicePoolCompatibilityResult& WithCompatible(bool value) {
    SetCompatible(value);
    return *this;
  }
  ///@}
  ...
  void SetIncompatibilityMessages(IncompatibilityMessagesT&& value) {
    m_incompatibilityMessagesHasBeenSet = true;
    m_incompatibilityMessages = std::forward<IncompatibilityMessagesT>(value);
  }
  template <typename IncompatibilityMessagesT = Aws::Vector<IncompatibilityMessage>>
  DevicePoolCompatibilityResult& WithIncompatibilityMessages(IncompatibilityMessagesT&& value) {
    SetIncompatibilityMessages(std::forward<IncompatibilityMessagesT>(value));
    return *this;
  }
  template <typename IncompatibilityMessagesT = IncompatibilityMessage>
  DevicePoolCompatibilityResult& AddIncompatibilityMessages(IncompatibilityMessagesT&& value) {
    m_incompatibilityMessagesHasBeenSet = true;
    m_incompatibilityMessages.emplace_back(std::forward<IncompatibilityMessagesT>(value));
    return *this;
  }
  ///@}
 private:
