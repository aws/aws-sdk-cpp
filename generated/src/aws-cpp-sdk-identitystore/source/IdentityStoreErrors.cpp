...
template <>
AWS_IDENTITYSTORE_API ConflictException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API ThrottlingException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API ServiceQuotaExceededException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::SERVICE_QUOTA_EXCEEDED);
  return ServiceQuotaExceededException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API ResourceNotFoundException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API InternalServerException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API ValidationException IdentityStoreError::GetModeledError() {
  assert(this->GetErrorType() == IdentityStoreErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_IDENTITYSTORE_API AccessDeniedException IdentityStoreError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(IdentityStoreErrors::CONFLICT), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == SERVICE_QUOTA_EXCEEDED_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(IdentityStoreErrors::SERVICE_QUOTA_EXCEEDED), RetryableType::NOT_RETRYABLE);
  } else if (hashCode == INTERNAL_SERVER_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(IdentityStoreErrors::INTERNAL_SERVER), RetryableType::RETRYABLE);
  }
