...
namespace IdentityStore
{
   ...
   * namespaces.</p> 
   */
  class AWS_IDENTITYSTORE_API IdentityStoreClient : Aws::Client::ClientWithAsyncTemplateMethods<IdentityStoreClient>,
    smithy::client::AwsSmithyClientT<Aws::IdentityStore::SERVICE_NAME,
