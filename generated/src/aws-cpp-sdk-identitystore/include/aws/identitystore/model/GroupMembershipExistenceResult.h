...
class GroupMembershipExistenceResult {
 public:
  ...
  inline void SetMembershipExists(bool value) {
    m_membershipExistsHasBeenSet = true;
    m_membershipExists = value;
  }
  inline GroupMembershipExistenceResult& WithMembershipExists(bool value) {
    SetMembershipExists(value);
    return *this;
  }
  ///@}
 private:
