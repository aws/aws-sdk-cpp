...
class DescribeGroupMembershipRequest : public IdentityStoreRequest {
 public:
  AWS_IDENTITYSTORE_API DescribeGroupMembershipRequest() = default;
  ...
  template <typename IdentityStoreIdT = Aws::String>
  DescribeGroupMembershipRequest& WithIdentityStoreId(IdentityStoreIdT&& value) {
  ...
  template <typename MembershipIdT = Aws::String>
  DescribeGroupMembershipRequest& WithMembershipId(MembershipIdT&& value) {
