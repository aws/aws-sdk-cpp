...
class ListGroupMembershipsForMemberRequest : public IdentityStoreRequest {
 public:
  ...
  template <typename IdentityStoreIdT = Aws::String>
  ListGroupMembershipsForMemberRequest& WithIdentityStoreId(IdentityStoreIdT&& value) {
  ...
  template <typename MemberIdT = MemberId>
  ListGroupMembershipsForMemberRequest& WithMemberId(MemberIdT&& value) {
  ...
  inline ListGroupMembershipsForMemberRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGroupMembershipsForMemberRequest& WithNextToken(NextTokenT&& value) {
