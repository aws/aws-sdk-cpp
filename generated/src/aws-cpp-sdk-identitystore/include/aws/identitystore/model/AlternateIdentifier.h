...
class AlternateIdentifier {
 public:
  ...
  template <typename ExternalIdT = ExternalId>
  AlternateIdentifier& WithExternalId(ExternalIdT&& value) {
  ...
  void SetUniqueAttribute(UniqueAttributeT&& value) {
    m_uniqueAttributeHasBeenSet = true;
    m_uniqueAttribute = std::forward<UniqueAttributeT>(value);
  }
  template <typename UniqueAttributeT = UniqueAttribute>
  AlternateIdentifier& WithUniqueAttribute(UniqueAttributeT&& value) {
    SetUniqueAttribute(std::forward<UniqueAttributeT>(value));
    return *this;
  }
  ///@}
 private:
