...
class ListOriginationNumbersRequest : public SNSRequest {
 public:
  AWS_SNS_API ListOriginationNumbersRequest() = default;
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOriginationNumbersRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOriginationNumbersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
