...
class SubscribeRequest : public SNSRequest {
 ...
 public:
  ...
  inline void SetReturnSubscriptionArn(bool value) {
    m_returnSubscriptionArnHasBeenSet = true;
    m_returnSubscriptionArn = value;
  }
  inline SubscribeRequest& WithReturnSubscriptionArn(bool value) {
    SetReturnSubscriptionArn(value);
    return *this;
  }
  ///@}
 private:
