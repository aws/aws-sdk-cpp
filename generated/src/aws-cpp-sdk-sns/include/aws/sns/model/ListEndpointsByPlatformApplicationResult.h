...
class ListEndpointsByPlatformApplicationResult {
 public:
  ...
  template <typename EndpointsT = Aws::Vector<Aws::String>>
  ListEndpointsByPlatformApplicationResult& WithEndpoints(EndpointsT&& value) {
    SetEndpoints(std::forward<EndpointsT>(value));
    return *this;
  }
  template <typename EndpointsT = Aws::String>
  ListEndpointsByPlatformApplicationResult& AddEndpoints(EndpointsT&& value) {
    m_endpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointsByPlatformApplicationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListEndpointsByPlatformApplicationResult& WithResponseMetadata(ResponseMetadataT&& value) {
