...
class PhoneNumberInformation {
 public:
  ...
  void SetIso2CountryCode(Iso2CountryCodeT&& value) {
    ...
    m_iso2CountryCode = std::forward<Iso2CountryCodeT>(value);
  }
  template <typename Iso2CountryCodeT = Aws::String>
  PhoneNumberInformation& WithIso2CountryCode(Iso2CountryCodeT&& value) {
    SetIso2CountryCode(std::forward<Iso2CountryCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline PhoneNumberInformation& WithRouteType(RouteType value) {
    SetRouteType(value);
    return *this;
  }
  ///@}
  ...
  inline PhoneNumberInformation& AddNumberCapabilities(NumberCapability value) {
    m_numberCapabilitiesHasBeenSet = true;
