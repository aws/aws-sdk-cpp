...
class GetDataProtectionPolicyResult {
 public:
  ...
  template <typename DataProtectionPolicyT = Aws::String>
  GetDataProtectionPolicyResult& WithDataProtectionPolicy(DataProtectionPolicyT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetDataProtectionPolicyResult& WithResponseMetadata(ResponseMetadataT&& value) {
