...
class ListSubscriptionsByTopicResult {
 public:
  AWS_SNS_API ListSubscriptionsByTopicResult() = default;
  ...
  template <typename SubscriptionsT = Aws::Vector<Subscription>>
  ListSubscriptionsByTopicResult& WithSubscriptions(SubscriptionsT&& value) {
    SetSubscriptions(std::forward<SubscriptionsT>(value));
    return *this;
  }
  template <typename SubscriptionsT = Subscription>
  ListSubscriptionsByTopicResult& AddSubscriptions(SubscriptionsT&& value) {
    m_subscriptionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscriptionsByTopicResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSubscriptionsByTopicResult& WithResponseMetadata(ResponseMetadataT&& value) {
