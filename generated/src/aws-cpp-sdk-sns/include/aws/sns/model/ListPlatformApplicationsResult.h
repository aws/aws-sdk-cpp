...
class ListPlatformApplicationsResult {
 public:
  ...
  void SetPlatformApplications(PlatformApplicationsT&& value) {
    m_platformApplicationsHasBeenSet = true;
    m_platformApplications = std::forward<PlatformApplicationsT>(value);
  }
  template <typename PlatformApplicationsT = Aws::Vector<PlatformApplication>>
  ListPlatformApplicationsResult& WithPlatformApplications(PlatformApplicationsT&& value) {
    SetPlatformApplications(std::forward<PlatformApplicationsT>(value));
    return *this;
  }
  template <typename PlatformApplicationsT = PlatformApplication>
  ListPlatformApplicationsResult& AddPlatformApplications(PlatformApplicationsT&& value) {
    m_platformApplicationsHasBeenSet = true;
    m_platformApplications.emplace_back(std::forward<PlatformApplicationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPlatformApplicationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListPlatformApplicationsResult& WithResponseMetadata(ResponseMetadataT&& value) {
