...
/**
 * <p>Input for <code>GetPlatformApplicationAttributes</code> action.</p><p><h3>See
 * Also:</h3>   <a
...
class GetPlatformApplicationAttributesRequest : public SNSRequest {
 ...
 public:
  ...
  template <typename PlatformApplicationArnT = Aws::String>
  GetPlatformApplicationAttributesRequest& WithPlatformApplicationArn(PlatformApplicationArnT&& value) {
