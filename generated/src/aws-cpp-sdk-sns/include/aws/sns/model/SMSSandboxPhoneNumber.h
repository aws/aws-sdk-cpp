...
class SMSSandboxPhoneNumber {
 public:
  ...
  inline void SetStatus(SMSSandboxPhoneNumberVerificationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline SMSSandboxPhoneNumber& WithStatus(SMSSandboxPhoneNumberVerificationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
