...
class PublishBatchRequest : public SNSRequest {
 ...
 public:
  ...
  template <typename TopicArnT = Aws::String>
  PublishBatchRequest& WithTopicArn(TopicArnT&& value) {
  ...
  void SetPublishBatchRequestEntries(PublishBatchRequestEntriesT&& value) {
    m_publishBatchRequestEntriesHasBeenSet = true;
    m_publishBatchRequestEntries = std::forward<PublishBatchRequestEntriesT>(value);
  }
  template <typename PublishBatchRequestEntriesT = Aws::Vector<PublishBatchRequestEntry>>
  PublishBatchRequest& WithPublishBatchRequestEntries(PublishBatchRequestEntriesT&& value) {
    SetPublishBatchRequestEntries(std::forward<PublishBatchRequestEntriesT>(value));
    return *this;
  }
  template <typename PublishBatchRequestEntriesT = PublishBatchRequestEntry>
  PublishBatchRequest& AddPublishBatchRequestEntries(PublishBatchRequestEntriesT&& value) {
    m_publishBatchRequestEntriesHasBeenSet = true;
    m_publishBatchRequestEntries.emplace_back(std::forward<PublishBatchRequestEntriesT>(value));
    return *this;
  }
  ///@}
 private:
