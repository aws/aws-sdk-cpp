...
class ListEndpointsByPlatformApplicationRequest : public SNSRequest {
 ...
 public:
  ...
  template <typename PlatformApplicationArnT = Aws::String>
  ListEndpointsByPlatformApplicationRequest& WithPlatformApplicationArn(PlatformApplicationArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointsByPlatformApplicationRequest& WithNextToken(NextTokenT&& value) {
