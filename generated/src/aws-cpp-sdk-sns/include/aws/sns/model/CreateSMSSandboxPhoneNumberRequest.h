...
class CreateSMSSandboxPhoneNumberRequest : public SNSRequest {
 ...
 public:
  ...
  template <typename PhoneNumberT = Aws::String>
  CreateSMSSandboxPhoneNumberRequest& WithPhoneNumber(PhoneNumberT&& value) {
  ...
  inline void SetLanguageCode(LanguageCodeString value) {
    m_languageCodeHasBeenSet = true;
    m_languageCode = value;
  }
  inline CreateSMSSandboxPhoneNumberRequest& WithLanguageCode(LanguageCodeString value) {
