...
namespace Model
{
  ...
  {
  public:
    AWS_SNS_API UntagResourceResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    UntagResourceResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
