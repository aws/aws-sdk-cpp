...
class ConfirmSubscriptionRequest : public SNSRequest {
 ...
 public:
  ...
  void SetAuthenticateOnUnsubscribe(AuthenticateOnUnsubscribeT&& value) {
    m_authenticateOnUnsubscribeHasBeenSet = true;
    m_authenticateOnUnsubscribe = std::forward<AuthenticateOnUnsubscribeT>(value);
  }
  template <typename AuthenticateOnUnsubscribeT = Aws::String>
  ConfirmSubscriptionRequest& WithAuthenticateOnUnsubscribe(AuthenticateOnUnsubscribeT&& value) {
    SetAuthenticateOnUnsubscribe(std::forward<AuthenticateOnUnsubscribeT>(value));
    return *this;
  }
  ///@}
 private:
