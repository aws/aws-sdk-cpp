...
ListEndpointsByPlatformApplicationResult& ListEndpointsByPlatformApplicationResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SNS::Model::ListEndpointsByPlatformApplicationResult",
