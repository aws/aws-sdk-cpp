...
CreateTopicResult::CreateTopicResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

CreateTopicResult& CreateTopicResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
