...
GetPlatformApplicationAttributesResult& GetPlatformApplicationAttributesResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!attributesNode.IsNull()) {
      ...
      while (!attributesEntry.IsNull()) {
        ...
        m_attributes[keyNode.GetText()] = valueNode.GetText();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::SNS::Model::GetPlatformApplicationAttributesResult",
