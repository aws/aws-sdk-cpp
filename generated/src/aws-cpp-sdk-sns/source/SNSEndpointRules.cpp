...
namespace SNS
{
const size_t SNSEndpointRules::RulesBlobStrLen = 4090;
const size_t SNSEndpointRules::RulesBlobSize = 4091;
...
'r','e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','u','s','-','g','o','v','-','e','a',
's','t','-','1','"',']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l',
'"',':','"','h','t','t','p','s',':','/','/','s','n','s','.','u','s','-','g','o','v','-','e','a','s',
...
'"','h','t','t','p','s',':','/','/','s','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a',
