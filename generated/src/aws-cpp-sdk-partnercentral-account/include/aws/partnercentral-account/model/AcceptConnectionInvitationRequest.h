...
/**
 */
class AcceptConnectionInvitationRequest : public PartnerCentralAccountRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AcceptConnectionInvitation"; }
