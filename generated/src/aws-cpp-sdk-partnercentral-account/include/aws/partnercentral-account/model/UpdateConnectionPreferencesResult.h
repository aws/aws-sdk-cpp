...
namespace Model {
class UpdateConnectionPreferencesResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API UpdateConnectionPreferencesResult& operator=(
  ...
  inline UpdateConnectionPreferencesResult& WithAccessType(AccessType value) {
    SetAccessType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateConnectionPreferencesResult& WithRevision(long long value) {
    SetRevision(value);
    return *this;
  }
  ///@}
