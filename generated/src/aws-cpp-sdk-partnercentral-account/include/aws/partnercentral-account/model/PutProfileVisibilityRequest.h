...
/**
 */
class PutProfileVisibilityRequest : public PartnerCentralAccountRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "PutProfileVisibility"; }
  ...
  inline PutProfileVisibilityRequest& WithVisibility(ProfileVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
