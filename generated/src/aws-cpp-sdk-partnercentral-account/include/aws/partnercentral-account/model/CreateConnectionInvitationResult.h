...
namespace Model {
class CreateConnectionInvitationResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API CreateConnectionInvitationResult& operator=(
  ...
  inline CreateConnectionInvitationResult& WithConnectionType(ConnectionType value) {
  ...
  ///@{
  /**
   * <p>The timestamp when the connection invitation will expire if not responded
   * to.</p>
   */
  ...
  inline CreateConnectionInvitationResult& WithParticipantType(ParticipantType value) {
  ...
  ///@{
  /**
   * <p>The current status of the connection invitation (pending, accepted, rejected,
   * etc.).</p>
   */
  ...
  inline CreateConnectionInvitationResult& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
