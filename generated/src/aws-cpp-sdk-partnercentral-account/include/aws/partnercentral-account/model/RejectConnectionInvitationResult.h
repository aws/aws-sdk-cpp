...
namespace Model {
class RejectConnectionInvitationResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API RejectConnectionInvitationResult& operator=(
  ...
  template <typename CatalogT = Aws::String>
  RejectConnectionInvitationResult& WithCatalog(CatalogT&& value) {
  ...
  template <typename IdT = Aws::String>
  RejectConnectionInvitationResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  RejectConnectionInvitationResult& WithArn(ArnT&& value) {
  ...
  inline RejectConnectionInvitationResult& WithConnectionType(ConnectionType value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  RejectConnectionInvitationResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RejectConnectionInvitationResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename ExpiresAtT = Aws::Utils::DateTime>
  RejectConnectionInvitationResult& WithExpiresAt(ExpiresAtT&& value) {
  ...
  inline RejectConnectionInvitationResult& WithParticipantType(ParticipantType value) {
  ...
  inline RejectConnectionInvitationResult& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  RejectConnectionInvitationResult& WithRequestId(RequestIdT&& value) {
