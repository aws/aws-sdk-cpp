...
namespace Model {
class GetProfileUpdateTaskResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API GetProfileUpdateTaskResult& operator=(
  ...
  ///@{
  /**
   * <p>The details of the profile update task including what changes are being
   * made.</p>
   */
  ...
  ///@{
  /**
   * <p>The current status of the profile update task (in progress, completed,
   * failed, etc.).</p>
   */
  ...
  inline GetProfileUpdateTaskResult& WithStatus(ProfileTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
