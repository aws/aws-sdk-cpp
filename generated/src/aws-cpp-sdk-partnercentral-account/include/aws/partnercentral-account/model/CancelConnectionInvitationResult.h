...
namespace Model {
class CancelConnectionInvitationResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API CancelConnectionInvitationResult& operator=(
  ...
  inline CancelConnectionInvitationResult& WithConnectionType(ConnectionType value) {
  ...
  ///@{
  /**
   * <p>The timestamp when the connection invitation would have expired if not
   * canceled.</p>
   */
  ...
  inline CancelConnectionInvitationResult& WithParticipantType(ParticipantType value) {
  ...
  inline CancelConnectionInvitationResult& WithStatus(InvitationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
