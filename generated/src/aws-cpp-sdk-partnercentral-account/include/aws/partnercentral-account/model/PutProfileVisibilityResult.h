...
namespace Model {
class PutProfileVisibilityResult {
 public:
  ...
  AWS_PARTNERCENTRALACCOUNT_API PutProfileVisibilityResult& operator=(
  ...
  inline PutProfileVisibilityResult& WithVisibility(ProfileVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
