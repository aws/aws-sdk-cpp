...
/**
 */
class CancelConnectionRequest : public PartnerCentralAccountRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CancelConnection"; }
  ...
  ///@{
  /**
   * <p>The type of connection to cancel (e.g., reseller, distributor, technology
   * partner).</p>
   */
  ...
  inline CancelConnectionRequest& WithConnectionType(ConnectionType value) {
  ...
  ///@{
  /**
   * <p>The reason for canceling the connection, providing context for the
   * termination.</p>
   */
