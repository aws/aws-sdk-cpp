...
namespace Model {
class StartQualificationsDisassociationTaskResult {
 public:
  AWS_PARTNERCENTRALACCOUNT_API StartQualificationsDisassociationTaskResult() = default;
  AWS_PARTNERCENTRALACCOUNT_API StartQualificationsDisassociationTaskResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_PARTNERCENTRALACCOUNT_API StartQualificationsDisassociationTaskResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CatalogT = Aws::String>
  StartQualificationsDisassociationTaskResult& WithCatalog(CatalogT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartQualificationsDisassociationTaskResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  StartQualificationsDisassociationTaskResult& WithId(IdT&& value) {
  ...
  ///@{
  /**
   * <p>The unique identifier of the started qualifications disassociation task, in
   * the format <code>pqdtask-[a-z2-7]{13}</code>.</p>
   */
  ...
  template <typename TaskIdT = Aws::String>
  StartQualificationsDisassociationTaskResult& WithTaskId(TaskIdT&& value) {
  ...
  ///@{
  /**
   * <p>The current status of the qualifications disassociation task. The initial
   * value is <code>IN_PROGRESS</code>.</p>
   */
  ...
  inline StartQualificationsDisassociationTaskResult& WithStatus(QualificationsDisassociationTaskStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The resolved primary partner's profile and account identifiers that the task
   * is disassociating qualifications from.</p>
   */
  ...
  template <typename StartedAtT = Aws::Utils::DateTime>
  StartQualificationsDisassociationTaskResult& WithStartedAt(StartedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartQualificationsDisassociationTaskResult& WithRequestId(RequestIdT&& value) {
