...
/**
 */
class GetConnectionPreferencesRequest : public PartnerCentralAccountRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetConnectionPreferences"; }
