...
GetAllianceLeadContactResult::GetAllianceLeadContactResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetAllianceLeadContactResult& GetAllianceLeadContactResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
