...
CancelConnectionResult::CancelConnectionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CancelConnectionResult& CancelConnectionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
