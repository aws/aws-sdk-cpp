...
StartProfileUpdateTaskResult::StartProfileUpdateTaskResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartProfileUpdateTaskResult& StartProfileUpdateTaskResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
