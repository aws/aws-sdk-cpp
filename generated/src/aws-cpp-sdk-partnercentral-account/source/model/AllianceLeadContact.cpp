...
AllianceLeadContact::AllianceLeadContact(JsonView jsonValue) { *this = jsonValue; }

AllianceLeadContact& AllianceLeadContact::operator=(JsonView jsonValue) {
...
JsonValue AllianceLeadContact::Jsonize() const {
  JsonValue payload;
