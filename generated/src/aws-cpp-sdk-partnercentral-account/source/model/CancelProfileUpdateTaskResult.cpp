...
CancelProfileUpdateTaskResult::CancelProfileUpdateTaskResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CancelProfileUpdateTaskResult& CancelProfileUpdateTaskResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
