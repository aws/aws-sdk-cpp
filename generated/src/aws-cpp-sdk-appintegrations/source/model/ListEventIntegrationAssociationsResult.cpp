...
ListEventIntegrationAssociationsResult& ListEventIntegrationAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("EventIntegrationAssociations")) {
    ...
    for (unsigned eventIntegrationAssociationsIndex = 0;
         eventIntegrationAssociationsIndex < eventIntegrationAssociationsJsonList.GetLength(); ++eventIntegrationAssociationsIndex) {
