...
ListDataIntegrationAssociationsResult& ListDataIntegrationAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("DataIntegrationAssociations")) {
    ...
    for (unsigned dataIntegrationAssociationsIndex = 0; dataIntegrationAssociationsIndex < dataIntegrationAssociationsJsonList.GetLength();
         ++dataIntegrationAssociationsIndex) {
