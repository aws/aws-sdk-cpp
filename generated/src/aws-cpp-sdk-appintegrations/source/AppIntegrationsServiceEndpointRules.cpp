...
{
const size_t AppIntegrationsServiceEndpointRules::RulesBlobStrLen = 3494;
const size_t AppIntegrationsServiceEndpointRules::RulesBlobSize = 3495;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','-','i','n',
't','e','g','r','a','t','i','o','n','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
':','"','h','t','t','p','s',':','/','/','a','p','p','-','i','n','t','e','g','r','a','t','i','o','n',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','-','i','n','t','e','g',
'r','a','t','i','o','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','-','i','n','t','e','g','r','a','t','i',
'o','n','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
's','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t',
'i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
'p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* AppIntegrationsServiceEndpointRules::GetRulesBlob()
{
