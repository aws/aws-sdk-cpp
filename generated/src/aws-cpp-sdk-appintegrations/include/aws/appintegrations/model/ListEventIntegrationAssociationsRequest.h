...
class ListEventIntegrationAssociationsRequest : public AppIntegrationsServiceRequest {
 public:
  ...
  template <typename EventIntegrationNameT = Aws::String>
  ListEventIntegrationAssociationsRequest& WithEventIntegrationName(EventIntegrationNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListEventIntegrationAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEventIntegrationAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
