...
class EventIntegrationAssociation {
 public:
  ...
  void SetEventIntegrationAssociationArn(EventIntegrationAssociationArnT&& value) {
    ...
    m_eventIntegrationAssociationArn = std::forward<EventIntegrationAssociationArnT>(value);
  }
  template <typename EventIntegrationAssociationArnT = Aws::String>
  EventIntegrationAssociation& WithEventIntegrationAssociationArn(EventIntegrationAssociationArnT&& value) {
    SetEventIntegrationAssociationArn(std::forward<EventIntegrationAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventIntegrationAssociationId(EventIntegrationAssociationIdT&& value) {
    ...
    m_eventIntegrationAssociationId = std::forward<EventIntegrationAssociationIdT>(value);
  }
  template <typename EventIntegrationAssociationIdT = Aws::String>
  EventIntegrationAssociation& WithEventIntegrationAssociationId(EventIntegrationAssociationIdT&& value) {
    SetEventIntegrationAssociationId(std::forward<EventIntegrationAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventIntegrationName(EventIntegrationNameT&& value) {
    ...
    m_eventIntegrationName = std::forward<EventIntegrationNameT>(value);
  }
  template <typename EventIntegrationNameT = Aws::String>
  EventIntegrationAssociation& WithEventIntegrationName(EventIntegrationNameT&& value) {
    SetEventIntegrationName(std::forward<EventIntegrationNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventBridgeRuleName(EventBridgeRuleNameT&& value) {
    ...
    m_eventBridgeRuleName = std::forward<EventBridgeRuleNameT>(value);
  }
  template <typename EventBridgeRuleNameT = Aws::String>
  EventIntegrationAssociation& WithEventBridgeRuleName(EventBridgeRuleNameT&& value) {
    SetEventBridgeRuleName(std::forward<EventBridgeRuleNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClientAssociationMetadata(ClientAssociationMetadataT&& value) {
    ...
    m_clientAssociationMetadata = std::forward<ClientAssociationMetadataT>(value);
  }
  template <typename ClientAssociationMetadataT = Aws::Map<Aws::String, Aws::String>>
  EventIntegrationAssociation& WithClientAssociationMetadata(ClientAssociationMetadataT&& value) {
    SetClientAssociationMetadata(std::forward<ClientAssociationMetadataT>(value));
    return *this;
  }
  ...
  EventIntegrationAssociation& AddClientAssociationMetadata(ClientAssociationMetadataKeyT&& key, ClientAssociationMetadataValueT&& value) {
    m_clientAssociationMetadataHasBeenSet = true;
    m_clientAssociationMetadata.emplace(std::forward<ClientAssociationMetadataKeyT>(key),
                                        std::forward<ClientAssociationMetadataValueT>(value));
    return *this;
  }
  ///@}
 private:
