...
class GetEventIntegrationResult {
 public:
  ...
  AWS_APPINTEGRATIONSSERVICE_API GetEventIntegrationResult& operator=(
  ...
  void SetEventIntegrationArn(EventIntegrationArnT&& value) {
    ...
    m_eventIntegrationArn = std::forward<EventIntegrationArnT>(value);
  }
  template <typename EventIntegrationArnT = Aws::String>
  GetEventIntegrationResult& WithEventIntegrationArn(EventIntegrationArnT&& value) {
    SetEventIntegrationArn(std::forward<EventIntegrationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventBridgeBus(EventBridgeBusT&& value) {
    ...
    m_eventBridgeBus = std::forward<EventBridgeBusT>(value);
  }
  template <typename EventBridgeBusT = Aws::String>
  GetEventIntegrationResult& WithEventBridgeBus(EventBridgeBusT&& value) {
    SetEventBridgeBus(std::forward<EventBridgeBusT>(value));
    return *this;
  }
  ///@}
