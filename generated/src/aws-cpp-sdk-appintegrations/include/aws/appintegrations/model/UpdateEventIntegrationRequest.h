...
namespace Model
{
  ...
  {
  public:
    AWS_APPINTEGRATIONSSERVICE_API UpdateEventIntegrationRequest() = default;
    ...
    template<typename NameT = Aws::String>
    UpdateEventIntegrationRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateEventIntegrationRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
