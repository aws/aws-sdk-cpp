...
class CreateEventIntegrationResult {
 public:
  ...
  AWS_APPINTEGRATIONSSERVICE_API CreateEventIntegrationResult& operator=(
  ...
  template <typename EventIntegrationArnT = Aws::String>
  CreateEventIntegrationResult& WithEventIntegrationArn(EventIntegrationArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventIntegrationResult& WithRequestId(RequestIdT&& value) {
