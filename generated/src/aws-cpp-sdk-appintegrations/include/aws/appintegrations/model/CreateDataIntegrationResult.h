...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    CreateDataIntegrationResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreateDataIntegrationResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    CreateDataIntegrationResult& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateDataIntegrationResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename KmsKeyT = Aws::String>
    CreateDataIntegrationResult& WithKmsKey(KmsKeyT&& value) { SetKmsKey(std::forward<KmsKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceURIT = Aws::String>
    CreateDataIntegrationResult& WithSourceURI(SourceURIT&& value) { SetSourceURI(std::forward<SourceURIT>(value)); return *this;}
    ///@}
    ...
    template<typename ScheduleConfigurationT = ScheduleConfiguration>
    CreateDataIntegrationResult& WithScheduleConfiguration(ScheduleConfigurationT&& value) { SetScheduleConfiguration(std::forward<ScheduleConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreateDataIntegrationResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename ClientTokenT = Aws::String>
    CreateDataIntegrationResult& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FileConfigurationT = FileConfiguration>
    CreateDataIntegrationResult& WithFileConfiguration(FileConfigurationT&& value) { SetFileConfiguration(std::forward<FileConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectConfigurationT = Aws::Map<Aws::String, Aws::Map<Aws::String, Aws::Vector<Aws::String>>>>
    CreateDataIntegrationResult& WithObjectConfiguration(ObjectConfigurationT&& value) { SetObjectConfiguration(std::forward<ObjectConfigurationT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    CreateDataIntegrationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
