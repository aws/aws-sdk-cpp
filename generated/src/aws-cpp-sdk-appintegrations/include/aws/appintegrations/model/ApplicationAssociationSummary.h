...
class ApplicationAssociationSummary {
 public:
  ...
  void SetApplicationAssociationArn(ApplicationAssociationArnT&& value) {
    m_applicationAssociationArnHasBeenSet = true;
    m_applicationAssociationArn = std::forward<ApplicationAssociationArnT>(value);
  }
  template <typename ApplicationAssociationArnT = Aws::String>
  ApplicationAssociationSummary& WithApplicationAssociationArn(ApplicationAssociationArnT&& value) {
    SetApplicationAssociationArn(std::forward<ApplicationAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ApplicationArnT = Aws::String>
  ApplicationAssociationSummary& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  ApplicationAssociationSummary& WithClientId(ClientIdT&& value) {
