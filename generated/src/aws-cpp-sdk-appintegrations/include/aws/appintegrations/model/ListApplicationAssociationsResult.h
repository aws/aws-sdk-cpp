...
class ListApplicationAssociationsResult {
 public:
  ...
  AWS_APPINTEGRATIONSSERVICE_API ListApplicationAssociationsResult& operator=(
  ...
  void SetApplicationAssociations(ApplicationAssociationsT&& value) {
    m_applicationAssociationsHasBeenSet = true;
    m_applicationAssociations = std::forward<ApplicationAssociationsT>(value);
  }
  template <typename ApplicationAssociationsT = Aws::Vector<ApplicationAssociationSummary>>
  ListApplicationAssociationsResult& WithApplicationAssociations(ApplicationAssociationsT&& value) {
    SetApplicationAssociations(std::forward<ApplicationAssociationsT>(value));
    return *this;
  }
  template <typename ApplicationAssociationsT = ApplicationAssociationSummary>
  ListApplicationAssociationsResult& AddApplicationAssociations(ApplicationAssociationsT&& value) {
    m_applicationAssociationsHasBeenSet = true;
    m_applicationAssociations.emplace_back(std::forward<ApplicationAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationAssociationsResult& WithRequestId(RequestIdT&& value) {
