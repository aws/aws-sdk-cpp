...
class CreateApplicationRequest : public AppIntegrationsServiceRequest {
 public:
  ...
  void SetApplicationSourceConfig(ApplicationSourceConfigT&& value) {
    ...
    m_applicationSourceConfig = std::forward<ApplicationSourceConfigT>(value);
  }
  template <typename ApplicationSourceConfigT = ApplicationSourceConfig>
  CreateApplicationRequest& WithApplicationSourceConfig(ApplicationSourceConfigT&& value) {
    SetApplicationSourceConfig(std::forward<ApplicationSourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInitializationTimeout(int value) {
    m_initializationTimeoutHasBeenSet = true;
    m_initializationTimeout = value;
  }
  inline CreateApplicationRequest& WithInitializationTimeout(int value) {
    SetInitializationTimeout(value);
    return *this;
  }
  ///@}
  ...
  void SetIframeConfig(IframeConfigT&& value) {
    ...
    m_iframeConfig = std::forward<IframeConfigT>(value);
  }
  template <typename IframeConfigT = IframeConfig>
  CreateApplicationRequest& WithIframeConfig(IframeConfigT&& value) {
    SetIframeConfig(std::forward<IframeConfigT>(value));
    return *this;
  }
  ///@}
