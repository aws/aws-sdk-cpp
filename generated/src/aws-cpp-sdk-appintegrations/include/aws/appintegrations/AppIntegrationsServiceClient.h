...
namespace AppIntegrationsService
{
   ...
   * </p> </li> </ul>
   */
  class AWS_APPINTEGRATIONSSERVICE_API AppIntegrationsServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<AppIntegrationsServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::AppIntegrationsService::SERVICE_NAME,
