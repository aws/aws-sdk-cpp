...
Aws::String GetInfrastructureConfigurationRequest::SerializePayload() const { return {}; }

void GetInfrastructureConfigurationRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
