...
WorkflowStepMetadata::WorkflowStepMetadata(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue WorkflowStepMetadata::Jsonize() const {
  ...
  if (m_rollbackStatusHasBeenSet) {
    payload.WithString("rollbackStatus",
                       WorkflowStepExecutionRollbackStatusMapper::GetNameForWorkflowStepExecutionRollbackStatus(m_rollbackStatus));
  }
