...
Distribution& Distribution::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("launchTemplateConfigurations")) {
    ...
    for (unsigned launchTemplateConfigurationsIndex = 0;
         launchTemplateConfigurationsIndex < launchTemplateConfigurationsJsonList.GetLength(); ++launchTemplateConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("fastLaunchConfigurations")) {
    ...
    for (unsigned fastLaunchConfigurationsIndex = 0; fastLaunchConfigurationsIndex < fastLaunchConfigurationsJsonList.GetLength();
  ...
  if (jsonValue.ValueExists("ssmParameterConfigurations")) {
    ...
    for (unsigned ssmParameterConfigurationsIndex = 0; ssmParameterConfigurationsIndex < ssmParameterConfigurationsJsonList.GetLength();
         ++ssmParameterConfigurationsIndex) {
...
JsonValue Distribution::Jsonize() const {
  ...
  if (m_launchTemplateConfigurationsHasBeenSet) {
    ...
    for (unsigned launchTemplateConfigurationsIndex = 0;
         launchTemplateConfigurationsIndex < launchTemplateConfigurationsJsonList.GetLength(); ++launchTemplateConfigurationsIndex) {
      launchTemplateConfigurationsJsonList[launchTemplateConfigurationsIndex].AsObject(
          m_launchTemplateConfigurations[launchTemplateConfigurationsIndex].Jsonize());
    }
  ...
  if (m_fastLaunchConfigurationsHasBeenSet) {
    ...
    for (unsigned fastLaunchConfigurationsIndex = 0; fastLaunchConfigurationsIndex < fastLaunchConfigurationsJsonList.GetLength();
         ++fastLaunchConfigurationsIndex) {
      fastLaunchConfigurationsJsonList[fastLaunchConfigurationsIndex].AsObject(
          m_fastLaunchConfigurations[fastLaunchConfigurationsIndex].Jsonize());
    }
  ...
  if (m_ssmParameterConfigurationsHasBeenSet) {
    ...
    for (unsigned ssmParameterConfigurationsIndex = 0; ssmParameterConfigurationsIndex < ssmParameterConfigurationsJsonList.GetLength();
         ++ssmParameterConfigurationsIndex) {
      ssmParameterConfigurationsJsonList[ssmParameterConfigurationsIndex].AsObject(
          m_ssmParameterConfigurations[ssmParameterConfigurationsIndex].Jsonize());
    }
