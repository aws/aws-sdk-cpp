...
WorkflowParameterDetail::WorkflowParameterDetail(JsonView jsonValue) { *this = jsonValue; }

WorkflowParameterDetail& WorkflowParameterDetail::operator=(JsonView jsonValue) {
...
JsonValue WorkflowParameterDetail::Jsonize() const {
  JsonValue payload;
