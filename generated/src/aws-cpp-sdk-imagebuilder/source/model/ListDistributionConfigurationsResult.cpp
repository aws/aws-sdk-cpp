...
ListDistributionConfigurationsResult& ListDistributionConfigurationsResult::operator=(
  ...
  if (jsonValue.ValueExists("distributionConfigurationSummaryList")) {
    ...
    for (unsigned distributionConfigurationSummaryListIndex = 0;
         distributionConfigurationSummaryListIndex < distributionConfigurationSummaryListJsonList.GetLength();
         ++distributionConfigurationSummaryListIndex) {
      m_distributionConfigurationSummaryList.push_back(
          distributionConfigurationSummaryListJsonList[distributionConfigurationSummaryListIndex].AsObject());
    }
