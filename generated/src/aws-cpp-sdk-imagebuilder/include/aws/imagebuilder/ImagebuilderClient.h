...
class AWS_IMAGEBUILDER_API ImagebuilderClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ImagebuilderClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ImagebuilderEndpointProviderBase> endpointProvider = nullptr,
      const Aws::imagebuilder::ImagebuilderClientConfiguration& clientConfiguration = Aws::imagebuilder::ImagebuilderClientConfiguration());
  ...
  /**
   * A Callable wrapper for CancelImageCreation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelImageCreation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelImageCreationRequestT = Model::CancelImageCreationRequest>
  void CancelImageCreationAsync(const CancelImageCreationRequestT& request, const CancelImageCreationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CancelLifecycleExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelLifecycleExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelLifecycleExecutionRequestT = Model::CancelLifecycleExecutionRequest>
  void CancelLifecycleExecutionAsync(const CancelLifecycleExecutionRequestT& request,
                                     const CancelLifecycleExecutionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateContainerRecipe that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContainerRecipe that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateContainerRecipeRequestT = Model::CreateContainerRecipeRequest>
  void CreateContainerRecipeAsync(const CreateContainerRecipeRequestT& request, const CreateContainerRecipeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDistributionConfigurationOutcome CreateDistributionConfiguration(
      const Model::CreateDistributionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateDistributionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDistributionConfigurationRequestT = Model::CreateDistributionConfigurationRequest>
  Model::CreateDistributionConfigurationOutcomeCallable CreateDistributionConfigurationCallable(
      const CreateDistributionConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::CreateDistributionConfiguration, request);
  }

  /**
   * An Async wrapper for CreateDistributionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateDistributionConfigurationRequestT = Model::CreateDistributionConfigurationRequest>
  void CreateDistributionConfigurationAsync(const CreateDistributionConfigurationRequestT& request,
                                            const CreateDistributionConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateImagePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateImagePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateImagePipelineRequestT = Model::CreateImagePipelineRequest>
  void CreateImagePipelineAsync(const CreateImagePipelineRequestT& request, const CreateImagePipelineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateImageRecipe that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateImageRecipe that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateImageRecipeRequestT = Model::CreateImageRecipeRequest>
  void CreateImageRecipeAsync(const CreateImageRecipeRequestT& request, const CreateImageRecipeResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateInfrastructureConfigurationOutcome CreateInfrastructureConfiguration(
      const Model::CreateInfrastructureConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateInfrastructureConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateInfrastructureConfigurationRequestT = Model::CreateInfrastructureConfigurationRequest>
  Model::CreateInfrastructureConfigurationOutcomeCallable CreateInfrastructureConfigurationCallable(
      const CreateInfrastructureConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::CreateInfrastructureConfiguration, request);
  }

  /**
   * An Async wrapper for CreateInfrastructureConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateInfrastructureConfigurationRequestT = Model::CreateInfrastructureConfigurationRequest>
  void CreateInfrastructureConfigurationAsync(const CreateInfrastructureConfigurationRequestT& request,
                                              const CreateInfrastructureConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContainerRecipe that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContainerRecipe that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContainerRecipeRequestT = Model::DeleteContainerRecipeRequest>
  void DeleteContainerRecipeAsync(const DeleteContainerRecipeRequestT& request, const DeleteContainerRecipeResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDistributionConfigurationOutcome DeleteDistributionConfiguration(
      const Model::DeleteDistributionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteDistributionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDistributionConfigurationRequestT = Model::DeleteDistributionConfigurationRequest>
  Model::DeleteDistributionConfigurationOutcomeCallable DeleteDistributionConfigurationCallable(
      const DeleteDistributionConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::DeleteDistributionConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteDistributionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDistributionConfigurationRequestT = Model::DeleteDistributionConfigurationRequest>
  void DeleteDistributionConfigurationAsync(const DeleteDistributionConfigurationRequestT& request,
                                            const DeleteDistributionConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImagePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImagePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteImagePipelineRequestT = Model::DeleteImagePipelineRequest>
  void DeleteImagePipelineAsync(const DeleteImagePipelineRequestT& request, const DeleteImagePipelineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImageRecipe that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImageRecipe that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteImageRecipeRequestT = Model::DeleteImageRecipeRequest>
  void DeleteImageRecipeAsync(const DeleteImageRecipeRequestT& request, const DeleteImageRecipeResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteInfrastructureConfigurationOutcome DeleteInfrastructureConfiguration(
      const Model::DeleteInfrastructureConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteInfrastructureConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteInfrastructureConfigurationRequestT = Model::DeleteInfrastructureConfigurationRequest>
  Model::DeleteInfrastructureConfigurationOutcomeCallable DeleteInfrastructureConfigurationCallable(
      const DeleteInfrastructureConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::DeleteInfrastructureConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteInfrastructureConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteInfrastructureConfigurationRequestT = Model::DeleteInfrastructureConfigurationRequest>
  void DeleteInfrastructureConfigurationAsync(const DeleteInfrastructureConfigurationRequestT& request,
                                              const DeleteInfrastructureConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetComponentPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetComponentPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetComponentPolicyRequestT = Model::GetComponentPolicyRequest>
  void GetComponentPolicyAsync(const GetComponentPolicyRequestT& request, const GetComponentPolicyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContainerRecipe that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContainerRecipe that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetContainerRecipeRequestT = Model::GetContainerRecipeRequest>
  void GetContainerRecipeAsync(const GetContainerRecipeRequestT& request, const GetContainerRecipeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContainerRecipePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContainerRecipePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContainerRecipePolicyRequestT = Model::GetContainerRecipePolicyRequest>
  void GetContainerRecipePolicyAsync(const GetContainerRecipePolicyRequestT& request,
                                     const GetContainerRecipePolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::GetDistributionConfigurationOutcome GetDistributionConfiguration(
      const Model::GetDistributionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetDistributionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDistributionConfigurationRequestT = Model::GetDistributionConfigurationRequest>
  Model::GetDistributionConfigurationOutcomeCallable GetDistributionConfigurationCallable(
      const GetDistributionConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::GetDistributionConfiguration, request);
  }

  /**
   * An Async wrapper for GetDistributionConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDistributionConfigurationRequestT = Model::GetDistributionConfigurationRequest>
  void GetDistributionConfigurationAsync(const GetDistributionConfigurationRequestT& request,
                                         const GetDistributionConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImageRequestT = Model::GetImageRequest>
  void GetImageAsync(const GetImageRequestT& request, const GetImageResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetImagePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetImagePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetImagePipelineRequestT = Model::GetImagePipelineRequest>
  void GetImagePipelineAsync(const GetImagePipelineRequestT& request, const GetImagePipelineResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImagePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImagePolicyRequestT = Model::GetImagePolicyRequest>
  void GetImagePolicyAsync(const GetImagePolicyRequestT& request, const GetImagePolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetImageRecipe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetImageRecipeRequestT = Model::GetImageRecipeRequest>
  void GetImageRecipeAsync(const GetImageRecipeRequestT& request, const GetImageRecipeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetImageRecipePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetImageRecipePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetImageRecipePolicyRequestT = Model::GetImageRecipePolicyRequest>
  void GetImageRecipePolicyAsync(const GetImageRecipePolicyRequestT& request, const GetImageRecipePolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetInfrastructureConfigurationOutcome GetInfrastructureConfiguration(
      const Model::GetInfrastructureConfigurationRequest& request) const;

  /**
   * A Callable wrapper for GetInfrastructureConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetInfrastructureConfigurationRequestT = Model::GetInfrastructureConfigurationRequest>
  Model::GetInfrastructureConfigurationOutcomeCallable GetInfrastructureConfigurationCallable(
      const GetInfrastructureConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::GetInfrastructureConfiguration, request);
  }

  /**
   * An Async wrapper for GetInfrastructureConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetInfrastructureConfigurationRequestT = Model::GetInfrastructureConfigurationRequest>
  void GetInfrastructureConfigurationAsync(const GetInfrastructureConfigurationRequestT& request,
                                           const GetInfrastructureConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLifecycleExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLifecycleExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLifecycleExecutionRequestT = Model::GetLifecycleExecutionRequest>
  void GetLifecycleExecutionAsync(const GetLifecycleExecutionRequestT& request, const GetLifecycleExecutionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMarketplaceResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMarketplaceResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMarketplaceResourceRequestT = Model::GetMarketplaceResourceRequest>
  void GetMarketplaceResourceAsync(const GetMarketplaceResourceRequestT& request,
                                   const GetMarketplaceResourceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkflowExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkflowExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkflowExecutionRequestT = Model::GetWorkflowExecutionRequest>
  void GetWorkflowExecutionAsync(const GetWorkflowExecutionRequestT& request, const GetWorkflowExecutionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkflowStepExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkflowStepExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetWorkflowStepExecutionRequestT = Model::GetWorkflowStepExecutionRequest>
  void GetWorkflowStepExecutionAsync(const GetWorkflowStepExecutionRequestT& request,
                                     const GetWorkflowStepExecutionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportComponent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportComponentRequestT = Model::ImportComponentRequest>
  void ImportComponentAsync(const ImportComponentRequestT& request, const ImportComponentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportDiskImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportDiskImageRequestT = Model::ImportDiskImageRequest>
  void ImportDiskImageAsync(const ImportDiskImageRequestT& request, const ImportDiskImageResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ImportVmImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ImportVmImageRequestT = Model::ImportVmImageRequest>
  void ImportVmImageAsync(const ImportVmImageRequestT& request, const ImportVmImageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListComponentBuildVersionsOutcome ListComponentBuildVersions(
      const Model::ListComponentBuildVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListComponentBuildVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListComponentBuildVersionsRequestT = Model::ListComponentBuildVersionsRequest>
  Model::ListComponentBuildVersionsOutcomeCallable ListComponentBuildVersionsCallable(
      const ListComponentBuildVersionsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListComponentBuildVersions, request);
  }

  /**
   * An Async wrapper for ListComponentBuildVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListComponentBuildVersionsRequestT = Model::ListComponentBuildVersionsRequest>
  void ListComponentBuildVersionsAsync(const ListComponentBuildVersionsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for ListContainerRecipes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContainerRecipes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContainerRecipesRequestT = Model::ListContainerRecipesRequest>
  void ListContainerRecipesAsync(const ListContainerRecipesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListContainerRecipesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDistributionConfigurationsOutcome ListDistributionConfigurations(
      const Model::ListDistributionConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDistributionConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDistributionConfigurationsRequestT = Model::ListDistributionConfigurationsRequest>
  Model::ListDistributionConfigurationsOutcomeCallable ListDistributionConfigurationsCallable(
      const ListDistributionConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListDistributionConfigurations, request);
  }

  /**
   * An Async wrapper for ListDistributionConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListDistributionConfigurationsRequestT = Model::ListDistributionConfigurationsRequest>
  void ListDistributionConfigurationsAsync(const ListDistributionConfigurationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListDistributionConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImageBuildVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImageBuildVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListImageBuildVersionsRequestT = Model::ListImageBuildVersionsRequest>
  void ListImageBuildVersionsAsync(const ListImageBuildVersionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListImageBuildVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImagePackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImagePackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListImagePackagesRequestT = Model::ListImagePackagesRequest>
  void ListImagePackagesAsync(const ListImagePackagesRequestT& request, const ListImagePackagesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListImagePipelineImages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImagePipelineImages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListImagePipelineImagesRequestT = Model::ListImagePipelineImagesRequest>
  void ListImagePipelineImagesAsync(const ListImagePipelineImagesRequestT& request,
                                    const ListImagePipelineImagesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListImagePipelines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImagePipelines that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListImagePipelinesRequestT = Model::ListImagePipelinesRequest>
  void ListImagePipelinesAsync(const ListImagePipelinesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListImagePipelinesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImageRecipes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImageRecipes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListImageRecipesRequestT = Model::ListImageRecipesRequest>
  void ListImageRecipesAsync(const ListImageRecipesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListImageRecipesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListImageScanFindingAggregationsOutcome ListImageScanFindingAggregations(
      const Model::ListImageScanFindingAggregationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListImageScanFindingAggregations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListImageScanFindingAggregationsRequestT = Model::ListImageScanFindingAggregationsRequest>
  Model::ListImageScanFindingAggregationsOutcomeCallable ListImageScanFindingAggregationsCallable(
      const ListImageScanFindingAggregationsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListImageScanFindingAggregations, request);
  }

  /**
   * An Async wrapper for ListImageScanFindingAggregations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListImageScanFindingAggregationsRequestT = Model::ListImageScanFindingAggregationsRequest>
  void ListImageScanFindingAggregationsAsync(const ListImageScanFindingAggregationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListImageScanFindingAggregationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImageScanFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImageScanFindings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListImageScanFindingsRequestT = Model::ListImageScanFindingsRequest>
  void ListImageScanFindingsAsync(const ListImageScanFindingsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListImageScanFindingsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListInfrastructureConfigurationsOutcome ListInfrastructureConfigurations(
      const Model::ListInfrastructureConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListInfrastructureConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListInfrastructureConfigurationsRequestT = Model::ListInfrastructureConfigurationsRequest>
  Model::ListInfrastructureConfigurationsOutcomeCallable ListInfrastructureConfigurationsCallable(
      const ListInfrastructureConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListInfrastructureConfigurations, request);
  }

  /**
   * An Async wrapper for ListInfrastructureConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListInfrastructureConfigurationsRequestT = Model::ListInfrastructureConfigurationsRequest>
  void ListInfrastructureConfigurationsAsync(const ListInfrastructureConfigurationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListInfrastructureConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLifecycleExecutionResourcesOutcome ListLifecycleExecutionResources(
      const Model::ListLifecycleExecutionResourcesRequest& request) const;

  /**
   * A Callable wrapper for ListLifecycleExecutionResources that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLifecycleExecutionResourcesRequestT = Model::ListLifecycleExecutionResourcesRequest>
  Model::ListLifecycleExecutionResourcesOutcomeCallable ListLifecycleExecutionResourcesCallable(
      const ListLifecycleExecutionResourcesRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::ListLifecycleExecutionResources, request);
  }

  /**
   * An Async wrapper for ListLifecycleExecutionResources that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListLifecycleExecutionResourcesRequestT = Model::ListLifecycleExecutionResourcesRequest>
  void ListLifecycleExecutionResourcesAsync(const ListLifecycleExecutionResourcesRequestT& request,
                                            const ListLifecycleExecutionResourcesResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListLifecycleExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLifecycleExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLifecycleExecutionsRequestT = Model::ListLifecycleExecutionsRequest>
  void ListLifecycleExecutionsAsync(const ListLifecycleExecutionsRequestT& request,
                                    const ListLifecycleExecutionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListLifecyclePoliciesRequestT = Model::ListLifecyclePoliciesRequest>
  void ListLifecyclePoliciesAsync(const ListLifecyclePoliciesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListLifecyclePoliciesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWaitingWorkflowSteps that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListWaitingWorkflowStepsRequestT = Model::ListWaitingWorkflowStepsRequest>
  Model::ListWaitingWorkflowStepsOutcomeCallable ListWaitingWorkflowStepsCallable(
      const ListWaitingWorkflowStepsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListWaitingWorkflowSteps, request);
  }

  /**
   * An Async wrapper for ListWaitingWorkflowSteps that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWaitingWorkflowStepsRequestT = Model::ListWaitingWorkflowStepsRequest>
  void ListWaitingWorkflowStepsAsync(const ListWaitingWorkflowStepsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListWaitingWorkflowStepsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWorkflowBuildVersionsOutcome ListWorkflowBuildVersions(
      const Model::ListWorkflowBuildVersionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListWorkflowBuildVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListWorkflowBuildVersionsRequestT = Model::ListWorkflowBuildVersionsRequest>
  Model::ListWorkflowBuildVersionsOutcomeCallable ListWorkflowBuildVersionsCallable(
      const ListWorkflowBuildVersionsRequestT& request = {}) const {
    return SubmitCallable(&ImagebuilderClient::ListWorkflowBuildVersions, request);
  }

  /**
   * An Async wrapper for ListWorkflowBuildVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkflowBuildVersionsRequestT = Model::ListWorkflowBuildVersionsRequest>
  void ListWorkflowBuildVersionsAsync(const ListWorkflowBuildVersionsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListWorkflowBuildVersionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorkflowExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkflowExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkflowExecutionsRequestT = Model::ListWorkflowExecutionsRequest>
  void ListWorkflowExecutionsAsync(const ListWorkflowExecutionsRequestT& request,
                                   const ListWorkflowExecutionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWorkflowStepExecutionsOutcome ListWorkflowStepExecutions(
      const Model::ListWorkflowStepExecutionsRequest& request) const;

  /**
   * A Callable wrapper for ListWorkflowStepExecutions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListWorkflowStepExecutionsRequestT = Model::ListWorkflowStepExecutionsRequest>
  Model::ListWorkflowStepExecutionsOutcomeCallable ListWorkflowStepExecutionsCallable(
      const ListWorkflowStepExecutionsRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::ListWorkflowStepExecutions, request);
  }

  /**
   * An Async wrapper for ListWorkflowStepExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWorkflowStepExecutionsRequestT = Model::ListWorkflowStepExecutionsRequest>
  void ListWorkflowStepExecutionsAsync(const ListWorkflowStepExecutionsRequestT& request,
                                       const ListWorkflowStepExecutionsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutComponentPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutComponentPolicy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutComponentPolicyRequestT = Model::PutComponentPolicyRequest>
  void PutComponentPolicyAsync(const PutComponentPolicyRequestT& request, const PutComponentPolicyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutContainerRecipePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutContainerRecipePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutContainerRecipePolicyRequestT = Model::PutContainerRecipePolicyRequest>
  void PutContainerRecipePolicyAsync(const PutContainerRecipePolicyRequestT& request,
                                     const PutContainerRecipePolicyResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutImagePolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutImagePolicyRequestT = Model::PutImagePolicyRequest>
  void PutImagePolicyAsync(const PutImagePolicyRequestT& request, const PutImagePolicyResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutImageRecipePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutImageRecipePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutImageRecipePolicyRequestT = Model::PutImageRecipePolicyRequest>
  ...
  /**
   * A Callable wrapper for SendWorkflowStepAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendWorkflowStepAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendWorkflowStepActionRequestT = Model::SendWorkflowStepActionRequest>
  void SendWorkflowStepActionAsync(const SendWorkflowStepActionRequestT& request,
                                   const SendWorkflowStepActionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StartImagePipelineExecutionOutcome StartImagePipelineExecution(
      const Model::StartImagePipelineExecutionRequest& request) const;

  /**
   * A Callable wrapper for StartImagePipelineExecution that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartImagePipelineExecutionRequestT = Model::StartImagePipelineExecutionRequest>
  Model::StartImagePipelineExecutionOutcomeCallable StartImagePipelineExecutionCallable(
      const StartImagePipelineExecutionRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::StartImagePipelineExecution, request);
  }

  /**
   * An Async wrapper for StartImagePipelineExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartImagePipelineExecutionRequestT = Model::StartImagePipelineExecutionRequest>
  void StartImagePipelineExecutionAsync(const StartImagePipelineExecutionRequestT& request,
                                        const StartImagePipelineExecutionResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartResourceStateUpdate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartResourceStateUpdate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartResourceStateUpdateRequestT = Model::StartResourceStateUpdateRequest>
  void StartResourceStateUpdateAsync(const StartResourceStateUpdateRequestT& request,
                                     const StartResourceStateUpdateResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDistributionConfigurationOutcome UpdateDistributionConfiguration(
      const Model::UpdateDistributionConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateDistributionConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDistributionConfigurationRequestT = Model::UpdateDistributionConfigurationRequest>
  Model::UpdateDistributionConfigurationOutcomeCallable UpdateDistributionConfigurationCallable(
      const UpdateDistributionConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::UpdateDistributionConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateDistributionConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateDistributionConfigurationRequestT = Model::UpdateDistributionConfigurationRequest>
  void UpdateDistributionConfigurationAsync(const UpdateDistributionConfigurationRequestT& request,
                                            const UpdateDistributionConfigurationResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateImagePipeline that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateImagePipeline that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateImagePipelineRequestT = Model::UpdateImagePipelineRequest>
  void UpdateImagePipelineAsync(const UpdateImagePipelineRequestT& request, const UpdateImagePipelineResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateInfrastructureConfigurationOutcome UpdateInfrastructureConfiguration(
      const Model::UpdateInfrastructureConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateInfrastructureConfiguration that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateInfrastructureConfigurationRequestT = Model::UpdateInfrastructureConfigurationRequest>
  Model::UpdateInfrastructureConfigurationOutcomeCallable UpdateInfrastructureConfigurationCallable(
      const UpdateInfrastructureConfigurationRequestT& request) const {
    return SubmitCallable(&ImagebuilderClient::UpdateInfrastructureConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateInfrastructureConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateInfrastructureConfigurationRequestT = Model::UpdateInfrastructureConfigurationRequest>
  void UpdateInfrastructureConfigurationAsync(const UpdateInfrastructureConfigurationRequestT& request,
                                              const UpdateInfrastructureConfigurationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
