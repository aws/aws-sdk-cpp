...
namespace imagebuilder
{
   ...
   */
  class AWS_IMAGEBUILDER_API ImagebuilderClient : Aws::Client::ClientWithAsyncTemplateMethods<ImagebuilderClient>,
    smithy::client::AwsSmithyClientT<Aws::imagebuilder::SERVICE_NAME,
