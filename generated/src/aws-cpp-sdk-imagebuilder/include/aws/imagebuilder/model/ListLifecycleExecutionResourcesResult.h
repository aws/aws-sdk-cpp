...
class ListLifecycleExecutionResourcesResult {
 public:
  ...
  AWS_IMAGEBUILDER_API ListLifecycleExecutionResourcesResult& operator=(
  ...
  template <typename LifecycleExecutionIdT = Aws::String>
  ListLifecycleExecutionResourcesResult& WithLifecycleExecutionId(LifecycleExecutionIdT&& value) {
  ...
  void SetLifecycleExecutionState(LifecycleExecutionStateT&& value) {
    m_lifecycleExecutionStateHasBeenSet = true;
    m_lifecycleExecutionState = std::forward<LifecycleExecutionStateT>(value);
  }
  template <typename LifecycleExecutionStateT = LifecycleExecutionState>
  ListLifecycleExecutionResourcesResult& WithLifecycleExecutionState(LifecycleExecutionStateT&& value) {
    SetLifecycleExecutionState(std::forward<LifecycleExecutionStateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourcesT = Aws::Vector<LifecycleExecutionResource>>
  ListLifecycleExecutionResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = LifecycleExecutionResource>
  ListLifecycleExecutionResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLifecycleExecutionResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLifecycleExecutionResourcesResult& WithRequestId(RequestIdT&& value) {
