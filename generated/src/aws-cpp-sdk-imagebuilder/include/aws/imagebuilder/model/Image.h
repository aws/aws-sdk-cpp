...
class Image {
 public:
  ...
  inline Image& WithType(ImageType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   * integer value, including zero. The upper limit is 2^30-1, or 1073741823, for
   ...
   * 2021.01.01.</p> <p> <b>Filtering:</b> You can use wildcards (x) to specify the
   * most recent versions or nodes when selecting the base image or components for
   * your recipe. When you use a wildcard in any node, all nodes to the right of the
   * first wildcard must also be wildcards.</p>
   */
  ...
  inline Image& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline Image& WithEnhancedImageMetadataEnabled(bool value) {
  ...
  void SetSourcePipelineName(SourcePipelineNameT&& value) {
    ...
    m_sourcePipelineName = std::forward<SourcePipelineNameT>(value);
  }
  template <typename SourcePipelineNameT = Aws::String>
  Image& WithSourcePipelineName(SourcePipelineNameT&& value) {
    SetSourcePipelineName(std::forward<SourcePipelineNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourcePipelineArn(SourcePipelineArnT&& value) {
    ...
    m_sourcePipelineArn = std::forward<SourcePipelineArnT>(value);
  }
  template <typename SourcePipelineArnT = Aws::String>
  Image& WithSourcePipelineArn(SourcePipelineArnT&& value) {
    SetSourcePipelineArn(std::forward<SourcePipelineArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInfrastructureConfiguration(InfrastructureConfigurationT&& value) {
    ...
    m_infrastructureConfiguration = std::forward<InfrastructureConfigurationT>(value);
  }
  template <typename InfrastructureConfigurationT = InfrastructureConfiguration>
  Image& WithInfrastructureConfiguration(InfrastructureConfigurationT&& value) {
    SetInfrastructureConfiguration(std::forward<InfrastructureConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDistributionConfiguration(DistributionConfigurationT&& value) {
    ...
    m_distributionConfiguration = std::forward<DistributionConfigurationT>(value);
  }
  template <typename DistributionConfigurationT = DistributionConfiguration>
  Image& WithDistributionConfiguration(DistributionConfigurationT&& value) {
    SetDistributionConfiguration(std::forward<DistributionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputResources(OutputResourcesT&& value) {
    ...
    m_outputResources = std::forward<OutputResourcesT>(value);
  }
  template <typename OutputResourcesT = OutputResources>
  Image& WithOutputResources(OutputResourcesT&& value) {
    SetOutputResources(std::forward<OutputResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBuildType(BuildType value) {
    m_buildTypeHasBeenSet = true;
    m_buildType = value;
  }
  inline Image& WithBuildType(BuildType value) {
    SetBuildType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetImageSource(ImageSource value) {
    m_imageSourceHasBeenSet = true;
    m_imageSource = value;
  }
  inline Image& WithImageSource(ImageSource value) {
  ...
  void SetScanState(ScanStateT&& value) {
    ...
    m_scanState = std::forward<ScanStateT>(value);
  }
  template <typename ScanStateT = ImageScanState>
  Image& WithScanState(ScanStateT&& value) {
    SetScanState(std::forward<ScanStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeprecationTime(DeprecationTimeT&& value) {
    ...
    m_deprecationTime = std::forward<DeprecationTimeT>(value);
  }
  template <typename DeprecationTimeT = Aws::Utils::DateTime>
  Image& WithDeprecationTime(DeprecationTimeT&& value) {
    SetDeprecationTime(std::forward<DeprecationTimeT>(value));
    return *this;
  }
  ///@}
