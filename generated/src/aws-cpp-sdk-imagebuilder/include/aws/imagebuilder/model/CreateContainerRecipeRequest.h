...
class CreateContainerRecipeRequest : public ImagebuilderRequest {
 public:
  ...
  inline CreateContainerRecipeRequest& WithContainerType(ContainerType value) {
  ...
  void SetInstanceConfiguration(InstanceConfigurationT&& value) {
    ...
    m_instanceConfiguration = std::forward<InstanceConfigurationT>(value);
  }
  template <typename InstanceConfigurationT = InstanceConfiguration>
  CreateContainerRecipeRequest& WithInstanceConfiguration(InstanceConfigurationT&& value) {
    SetInstanceConfiguration(std::forward<InstanceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDockerfileTemplateData(DockerfileTemplateDataT&& value) {
    ...
    m_dockerfileTemplateData = std::forward<DockerfileTemplateDataT>(value);
  }
  template <typename DockerfileTemplateDataT = Aws::String>
  CreateContainerRecipeRequest& WithDockerfileTemplateData(DockerfileTemplateDataT&& value) {
    SetDockerfileTemplateData(std::forward<DockerfileTemplateDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDockerfileTemplateUri(DockerfileTemplateUriT&& value) {
    m_dockerfileTemplateUriHasBeenSet = true;
    m_dockerfileTemplateUri = std::forward<DockerfileTemplateUriT>(value);
  }
  template <typename DockerfileTemplateUriT = Aws::String>
  CreateContainerRecipeRequest& WithDockerfileTemplateUri(DockerfileTemplateUriT&& value) {
    SetDockerfileTemplateUri(std::forward<DockerfileTemplateUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPlatformOverride(Platform value) {
    m_platformOverrideHasBeenSet = true;
    m_platformOverride = value;
  }
  inline CreateContainerRecipeRequest& WithPlatformOverride(Platform value) {
  ...
  void SetImageOsVersionOverride(ImageOsVersionOverrideT&& value) {
    m_imageOsVersionOverrideHasBeenSet = true;
    m_imageOsVersionOverride = std::forward<ImageOsVersionOverrideT>(value);
  }
  template <typename ImageOsVersionOverrideT = Aws::String>
  CreateContainerRecipeRequest& WithImageOsVersionOverride(ImageOsVersionOverrideT&& value) {
    SetImageOsVersionOverride(std::forward<ImageOsVersionOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateContainerRecipeRequest& WithTags(TagsT&& value) {
  ...
  void SetTargetRepository(TargetRepositoryT&& value) {
    ...
    m_targetRepository = std::forward<TargetRepositoryT>(value);
  }
  template <typename TargetRepositoryT = TargetContainerRepository>
  CreateContainerRecipeRequest& WithTargetRepository(TargetRepositoryT&& value) {
    SetTargetRepository(std::forward<TargetRepositoryT>(value));
    return *this;
  }
  ///@}
