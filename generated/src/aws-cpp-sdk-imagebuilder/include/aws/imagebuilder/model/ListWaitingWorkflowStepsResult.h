...
class ListWaitingWorkflowStepsResult {
 public:
  ...
  template <typename StepsT = Aws::Vector<WorkflowStepExecution>>
  ListWaitingWorkflowStepsResult& WithSteps(StepsT&& value) {
    SetSteps(std::forward<StepsT>(value));
    return *this;
  }
  template <typename StepsT = WorkflowStepExecution>
  ListWaitingWorkflowStepsResult& AddSteps(StepsT&& value) {
    m_stepsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWaitingWorkflowStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWaitingWorkflowStepsResult& WithRequestId(RequestIdT&& value) {
