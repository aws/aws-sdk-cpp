...
class LifecyclePolicyDetailActionIncludeResources {
 public:
  ...
  inline void SetAmis(bool value) {
    m_amisHasBeenSet = true;
    m_amis = value;
  }
  inline LifecyclePolicyDetailActionIncludeResources& WithAmis(bool value) {
    SetAmis(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshots(bool value) {
    m_snapshotsHasBeenSet = true;
    m_snapshots = value;
  }
  inline LifecyclePolicyDetailActionIncludeResources& WithSnapshots(bool value) {
    SetSnapshots(value);
    return *this;
  }
  ///@}
  ...
  inline void SetContainers(bool value) {
    m_containersHasBeenSet = true;
    m_containers = value;
  }
  inline LifecyclePolicyDetailActionIncludeResources& WithContainers(bool value) {
    SetContainers(value);
    return *this;
  }
  ///@}
