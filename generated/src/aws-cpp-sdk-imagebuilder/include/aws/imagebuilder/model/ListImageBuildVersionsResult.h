...
class ListImageBuildVersionsResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListImageBuildVersionsResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetImageSummaryList(ImageSummaryListT&& value) {
    m_imageSummaryListHasBeenSet = true;
    m_imageSummaryList = std::forward<ImageSummaryListT>(value);
  }
  template <typename ImageSummaryListT = Aws::Vector<ImageSummary>>
  ListImageBuildVersionsResult& WithImageSummaryList(ImageSummaryListT&& value) {
    SetImageSummaryList(std::forward<ImageSummaryListT>(value));
    return *this;
  }
  template <typename ImageSummaryListT = ImageSummary>
  ListImageBuildVersionsResult& AddImageSummaryList(ImageSummaryListT&& value) {
    m_imageSummaryListHasBeenSet = true;
    m_imageSummaryList.emplace_back(std::forward<ImageSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImageBuildVersionsResult& WithNextToken(NextTokenT&& value) {
