...
namespace Model
{
  ...
  {
  public:
    AWS_IMAGEBUILDER_API ListImageRecipesRequest() = default;
    ...
    inline ListImageRecipesRequest& WithOwner(Ownership value) { SetOwner(value); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListImageRecipesRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListImageRecipesRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListImageRecipesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
