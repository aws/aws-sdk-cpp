...
class PipelineLoggingConfiguration {
 public:
  ...
  void SetImageLogGroupName(ImageLogGroupNameT&& value) {
    m_imageLogGroupNameHasBeenSet = true;
    m_imageLogGroupName = std::forward<ImageLogGroupNameT>(value);
  }
  template <typename ImageLogGroupNameT = Aws::String>
  PipelineLoggingConfiguration& WithImageLogGroupName(ImageLogGroupNameT&& value) {
    SetImageLogGroupName(std::forward<ImageLogGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineLogGroupName(PipelineLogGroupNameT&& value) {
    m_pipelineLogGroupNameHasBeenSet = true;
    m_pipelineLogGroupName = std::forward<PipelineLogGroupNameT>(value);
  }
  template <typename PipelineLogGroupNameT = Aws::String>
  PipelineLoggingConfiguration& WithPipelineLogGroupName(PipelineLogGroupNameT&& value) {
    SetPipelineLogGroupName(std::forward<PipelineLogGroupNameT>(value));
    return *this;
  }
  ///@}
 private:
