...
namespace Model
{
  ...
  {
  public:
    AWS_IMAGEBUILDER_API StartImagePipelineExecutionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartImagePipelineExecutionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    StartImagePipelineExecutionResult& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ImageBuildVersionArnT = Aws::String>
    StartImagePipelineExecutionResult& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) { SetImageBuildVersionArn(std::forward<ImageBuildVersionArnT>(value)); return *this;}
    ///@}
  private:
