...
class LifecycleExecutionState {
 public:
  ...
  inline void SetStatus(LifecycleExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LifecycleExecutionState& WithStatus(LifecycleExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  LifecycleExecutionState& WithReason(ReasonT&& value) {
