...
class ListImageScanFindingsRequest : public ImagebuilderRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<ImageScanFindingsFilter>>
  ListImageScanFindingsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = ImageScanFindingsFilter>
  ListImageScanFindingsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListImageScanFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImageScanFindingsRequest& WithNextToken(NextTokenT&& value) {
