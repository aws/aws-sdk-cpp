...
class LifecyclePolicyDetailExclusionRulesAmisLastLaunched {
 public:
  ...
  inline LifecyclePolicyDetailExclusionRulesAmisLastLaunched& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicyDetailExclusionRulesAmisLastLaunched& WithUnit(LifecyclePolicyTimeUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
