...
class ListWorkflowsResult {
 public:
  ...
  void SetWorkflowVersionList(WorkflowVersionListT&& value) {
    m_workflowVersionListHasBeenSet = true;
    m_workflowVersionList = std::forward<WorkflowVersionListT>(value);
  }
  template <typename WorkflowVersionListT = Aws::Vector<WorkflowVersion>>
  ListWorkflowsResult& WithWorkflowVersionList(WorkflowVersionListT&& value) {
    SetWorkflowVersionList(std::forward<WorkflowVersionListT>(value));
    return *this;
  }
  template <typename WorkflowVersionListT = WorkflowVersion>
  ListWorkflowsResult& AddWorkflowVersionList(WorkflowVersionListT&& value) {
    m_workflowVersionListHasBeenSet = true;
    m_workflowVersionList.emplace_back(std::forward<WorkflowVersionListT>(value));
    return *this;
  }
  ///@}
