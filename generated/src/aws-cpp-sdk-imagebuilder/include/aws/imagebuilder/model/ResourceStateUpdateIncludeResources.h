...
class ResourceStateUpdateIncludeResources {
 public:
  ...
  inline ResourceStateUpdateIncludeResources& WithAmis(bool value) {
    SetAmis(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceStateUpdateIncludeResources& WithSnapshots(bool value) {
    SetSnapshots(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceStateUpdateIncludeResources& WithContainers(bool value) {
    SetContainers(value);
    return *this;
  }
  ///@}
