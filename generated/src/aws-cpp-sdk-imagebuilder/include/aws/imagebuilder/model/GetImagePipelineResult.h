...
class GetImagePipelineResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  GetImagePipelineResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetImagePipeline(ImagePipelineT&& value) {
    m_imagePipelineHasBeenSet = true;
    m_imagePipeline = std::forward<ImagePipelineT>(value);
  }
  template <typename ImagePipelineT = ImagePipeline>
  GetImagePipelineResult& WithImagePipeline(ImagePipelineT&& value) {
    SetImagePipeline(std::forward<ImagePipelineT>(value));
    return *this;
  }
  ///@}
 private:
