...
class ListInfrastructureConfigurationsResult {
 public:
  ...
  AWS_IMAGEBUILDER_API ListInfrastructureConfigurationsResult& operator=(
   ...
   */
  inline const Aws::Vector<InfrastructureConfigurationSummary>& GetInfrastructureConfigurationSummaryList() const {
    return m_infrastructureConfigurationSummaryList;
  }
  ...
  void SetInfrastructureConfigurationSummaryList(InfrastructureConfigurationSummaryListT&& value) {
    ...
    m_infrastructureConfigurationSummaryList = std::forward<InfrastructureConfigurationSummaryListT>(value);
  }
  template <typename InfrastructureConfigurationSummaryListT = Aws::Vector<InfrastructureConfigurationSummary>>
  ListInfrastructureConfigurationsResult& WithInfrastructureConfigurationSummaryList(InfrastructureConfigurationSummaryListT&& value) {
    SetInfrastructureConfigurationSummaryList(std::forward<InfrastructureConfigurationSummaryListT>(value));
    return *this;
  }
  ...
  ListInfrastructureConfigurationsResult& AddInfrastructureConfigurationSummaryList(InfrastructureConfigurationSummaryListT&& value) {
    m_infrastructureConfigurationSummaryListHasBeenSet = true;
    m_infrastructureConfigurationSummaryList.emplace_back(std::forward<InfrastructureConfigurationSummaryListT>(value));
    return *this;
  }
  ///@}
