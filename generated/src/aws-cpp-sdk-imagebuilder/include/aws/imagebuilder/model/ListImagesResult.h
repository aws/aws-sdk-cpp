...
class ListImagesResult {
 public:
  ...
  void SetImageVersionList(ImageVersionListT&& value) {
    m_imageVersionListHasBeenSet = true;
    m_imageVersionList = std::forward<ImageVersionListT>(value);
  }
  template <typename ImageVersionListT = Aws::Vector<ImageVersion>>
  ListImagesResult& WithImageVersionList(ImageVersionListT&& value) {
    SetImageVersionList(std::forward<ImageVersionListT>(value));
    return *this;
  }
  template <typename ImageVersionListT = ImageVersion>
  ListImagesResult& AddImageVersionList(ImageVersionListT&& value) {
    m_imageVersionListHasBeenSet = true;
    m_imageVersionList.emplace_back(std::forward<ImageVersionListT>(value));
    return *this;
  }
  ///@}
