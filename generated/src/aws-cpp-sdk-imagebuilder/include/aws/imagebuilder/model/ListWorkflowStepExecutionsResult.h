...
class ListWorkflowStepExecutionsResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkflowStepExecutionsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename StepsT = Aws::Vector<WorkflowStepMetadata>>
  ListWorkflowStepExecutionsResult& WithSteps(StepsT&& value) {
    SetSteps(std::forward<StepsT>(value));
    return *this;
  }
  template <typename StepsT = WorkflowStepMetadata>
  ListWorkflowStepExecutionsResult& AddSteps(StepsT&& value) {
    m_stepsHasBeenSet = true;
  ...
  template <typename WorkflowBuildVersionArnT = Aws::String>
  ListWorkflowStepExecutionsResult& WithWorkflowBuildVersionArn(WorkflowBuildVersionArnT&& value) {
  ...
  template <typename WorkflowExecutionIdT = Aws::String>
  ListWorkflowStepExecutionsResult& WithWorkflowExecutionId(WorkflowExecutionIdT&& value) {
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  ListWorkflowStepExecutionsResult& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
  ...
  template <typename MessageT = Aws::String>
  ListWorkflowStepExecutionsResult& WithMessage(MessageT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowStepExecutionsResult& WithNextToken(NextTokenT&& value) {
