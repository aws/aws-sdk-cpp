...
class UpdateImagePipelineResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  UpdateImagePipelineResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateImagePipelineResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ImagePipelineArnT = Aws::String>
  UpdateImagePipelineResult& WithImagePipelineArn(ImagePipelineArnT&& value) {
