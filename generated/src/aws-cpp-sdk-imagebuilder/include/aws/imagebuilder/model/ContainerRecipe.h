...
class ContainerRecipe {
 public:
  ...
  inline ContainerRecipe& WithContainerType(ContainerType value) {
  ...
  inline ContainerRecipe& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerRecipe& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
