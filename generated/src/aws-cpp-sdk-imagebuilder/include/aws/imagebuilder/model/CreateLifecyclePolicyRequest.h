...
class CreateLifecyclePolicyRequest : public ImagebuilderRequest {
 public:
  ...
  inline CreateLifecyclePolicyRequest& WithStatus(LifecyclePolicyStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLifecyclePolicyRequest& WithResourceType(LifecyclePolicyResourceType value) {
