...
class Schedule {
 public:
  ...
  inline void SetPipelineExecutionStartCondition(PipelineExecutionStartCondition value) {
    m_pipelineExecutionStartConditionHasBeenSet = true;
    m_pipelineExecutionStartCondition = value;
  }
  inline Schedule& WithPipelineExecutionStartCondition(PipelineExecutionStartCondition value) {
    SetPipelineExecutionStartCondition(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoDisablePolicy(AutoDisablePolicyT&& value) {
    ...
    m_autoDisablePolicy = std::forward<AutoDisablePolicyT>(value);
  }
  template <typename AutoDisablePolicyT = AutoDisablePolicy>
  Schedule& WithAutoDisablePolicy(AutoDisablePolicyT&& value) {
    SetAutoDisablePolicy(std::forward<AutoDisablePolicyT>(value));
    return *this;
  }
  ///@}
 private:
