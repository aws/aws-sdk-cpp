...
class GetWorkflowExecutionResult {
 public:
  ...
  inline GetWorkflowExecutionResult& WithType(WorkflowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowExecutionResult& WithStatus(WorkflowExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetWorkflowExecutionResult& WithTotalStepCount(int value) {
    SetTotalStepCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalStepsSucceeded(int value) {
    m_totalStepsSucceededHasBeenSet = true;
    m_totalStepsSucceeded = value;
  }
  inline GetWorkflowExecutionResult& WithTotalStepsSucceeded(int value) {
    SetTotalStepsSucceeded(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalStepsFailed(int value) {
    m_totalStepsFailedHasBeenSet = true;
    m_totalStepsFailed = value;
  }
  inline GetWorkflowExecutionResult& WithTotalStepsFailed(int value) {
    SetTotalStepsFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalStepsSkipped(int value) {
    m_totalStepsSkippedHasBeenSet = true;
    m_totalStepsSkipped = value;
  }
  inline GetWorkflowExecutionResult& WithTotalStepsSkipped(int value) {
    SetTotalStepsSkipped(value);
    return *this;
  }
  ///@}
  ...
  void SetParallelGroup(ParallelGroupT&& value) {
    ...
    m_parallelGroup = std::forward<ParallelGroupT>(value);
  }
  template <typename ParallelGroupT = Aws::String>
  GetWorkflowExecutionResult& WithParallelGroup(ParallelGroupT&& value) {
    SetParallelGroup(std::forward<ParallelGroupT>(value));
    return *this;
  }
  ///@}
 private:
