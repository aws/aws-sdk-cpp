...
namespace Model
{
  ...
  public:
    ...
    template<typename ComponentVersionArnT = Aws::String>
    ListComponentBuildVersionsRequest& WithComponentVersionArn(ComponentVersionArnT&& value) { SetComponentVersionArn(std::forward<ComponentVersionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListComponentBuildVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
