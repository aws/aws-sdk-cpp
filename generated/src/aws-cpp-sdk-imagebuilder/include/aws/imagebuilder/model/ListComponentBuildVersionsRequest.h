...
class ListComponentBuildVersionsRequest : public ImagebuilderRequest {
 public:
  AWS_IMAGEBUILDER_API ListComponentBuildVersionsRequest() = default;
  ...
  void SetComponentVersionArn(ComponentVersionArnT&& value) {
    m_componentVersionArnHasBeenSet = true;
    m_componentVersionArn = std::forward<ComponentVersionArnT>(value);
  }
  template <typename ComponentVersionArnT = Aws::String>
  ListComponentBuildVersionsRequest& WithComponentVersionArn(ComponentVersionArnT&& value) {
    SetComponentVersionArn(std::forward<ComponentVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListComponentBuildVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComponentBuildVersionsRequest& WithNextToken(NextTokenT&& value) {
