...
class UpdateDistributionConfigurationResult {
 public:
  ...
  AWS_IMAGEBUILDER_API UpdateDistributionConfigurationResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDistributionConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateDistributionConfigurationResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DistributionConfigurationArnT = Aws::String>
  UpdateDistributionConfigurationResult& WithDistributionConfigurationArn(DistributionConfigurationArnT&& value) {
