...
class ImportDiskImageResult {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  ImportDiskImageResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  ImportDiskImageResult& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ImportDiskImageResult& WithRequestId(RequestIdT&& value) {
