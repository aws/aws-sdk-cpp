...
class LifecyclePolicyDetailExclusionRulesAmis {
 public:
  ...
  inline LifecyclePolicyDetailExclusionRulesAmis& WithIsPublic(bool value) {
    SetIsPublic(value);
    return *this;
  }
  ///@}
  ...
  void SetSharedAccounts(SharedAccountsT&& value) {
    ...
    m_sharedAccounts = std::forward<SharedAccountsT>(value);
  }
  template <typename SharedAccountsT = Aws::Vector<Aws::String>>
  LifecyclePolicyDetailExclusionRulesAmis& WithSharedAccounts(SharedAccountsT&& value) {
    SetSharedAccounts(std::forward<SharedAccountsT>(value));
    return *this;
  }
  ...
  LifecyclePolicyDetailExclusionRulesAmis& AddSharedAccounts(SharedAccountsT&& value) {
    m_sharedAccountsHasBeenSet = true;
    m_sharedAccounts.emplace_back(std::forward<SharedAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastLaunched(LastLaunchedT&& value) {
    ...
    m_lastLaunched = std::forward<LastLaunchedT>(value);
  }
  template <typename LastLaunchedT = LifecyclePolicyDetailExclusionRulesAmisLastLaunched>
  LifecyclePolicyDetailExclusionRulesAmis& WithLastLaunched(LastLaunchedT&& value) {
    SetLastLaunched(std::forward<LastLaunchedT>(value));
    return *this;
  }
  ///@}
