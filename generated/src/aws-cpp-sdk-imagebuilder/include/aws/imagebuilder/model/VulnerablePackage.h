...
class VulnerablePackage {
 public:
  ...
  void SetSourceLayerHash(SourceLayerHashT&& value) {
    ...
    m_sourceLayerHash = std::forward<SourceLayerHashT>(value);
  }
  template <typename SourceLayerHashT = Aws::String>
  VulnerablePackage& WithSourceLayerHash(SourceLayerHashT&& value) {
    SetSourceLayerHash(std::forward<SourceLayerHashT>(value));
    return *this;
  }
  ///@}
  ...
  inline VulnerablePackage& WithEpoch(int value) {
    SetEpoch(value);
    return *this;
  }
  ///@}
  ...
  void SetPackageManager(PackageManagerT&& value) {
    ...
    m_packageManager = std::forward<PackageManagerT>(value);
  }
  template <typename PackageManagerT = Aws::String>
  VulnerablePackage& WithPackageManager(PackageManagerT&& value) {
    SetPackageManager(std::forward<PackageManagerT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFixedInVersion(FixedInVersionT&& value) {
    ...
    m_fixedInVersion = std::forward<FixedInVersionT>(value);
  }
  template <typename FixedInVersionT = Aws::String>
  VulnerablePackage& WithFixedInVersion(FixedInVersionT&& value) {
    SetFixedInVersion(std::forward<FixedInVersionT>(value));
    return *this;
  }
  ///@}
