...
class ListComponentBuildVersionsResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListComponentBuildVersionsResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetComponentSummaryList(ComponentSummaryListT&& value) {
    m_componentSummaryListHasBeenSet = true;
    m_componentSummaryList = std::forward<ComponentSummaryListT>(value);
  }
  template <typename ComponentSummaryListT = Aws::Vector<ComponentSummary>>
  ListComponentBuildVersionsResult& WithComponentSummaryList(ComponentSummaryListT&& value) {
    SetComponentSummaryList(std::forward<ComponentSummaryListT>(value));
    return *this;
  }
  template <typename ComponentSummaryListT = ComponentSummary>
  ListComponentBuildVersionsResult& AddComponentSummaryList(ComponentSummaryListT&& value) {
    m_componentSummaryListHasBeenSet = true;
    m_componentSummaryList.emplace_back(std::forward<ComponentSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComponentBuildVersionsResult& WithNextToken(NextTokenT&& value) {
