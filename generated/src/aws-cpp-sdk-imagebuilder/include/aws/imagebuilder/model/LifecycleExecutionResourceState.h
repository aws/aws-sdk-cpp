...
class LifecycleExecutionResourceState {
 public:
  ...
  inline void SetStatus(LifecycleExecutionResourceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LifecycleExecutionResourceState& WithStatus(LifecycleExecutionResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReasonT = Aws::String>
  LifecycleExecutionResourceState& WithReason(ReasonT&& value) {
