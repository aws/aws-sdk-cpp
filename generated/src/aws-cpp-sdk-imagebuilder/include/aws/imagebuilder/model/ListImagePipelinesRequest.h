...
class ListImagePipelinesRequest : public ImagebuilderRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListImagePipelinesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListImagePipelinesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListImagePipelinesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImagePipelinesRequest& WithNextToken(NextTokenT&& value) {
