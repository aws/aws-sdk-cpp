...
namespace Model
{
  ...
  {
  public:
    AWS_IMAGEBUILDER_API DeleteWorkflowRequest();
     ...
     * <p>The Amazon Resource Name (ARN) of the workflow resource to delete.</p>
     */
    inline DeleteWorkflowRequest& WithWorkflowBuildVersionArn(const Aws::String& value) { SetWorkflowBuildVersionArn(value); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the workflow resource to delete.</p>
     */
    inline DeleteWorkflowRequest& WithWorkflowBuildVersionArn(Aws::String&& value) { SetWorkflowBuildVersionArn(std::move(value)); return *this;}

    /**
     * <p>The Amazon Resource Name (ARN) of the workflow resource to delete.</p>
     */
    inline DeleteWorkflowRequest& WithWorkflowBuildVersionArn(const char* value) { SetWorkflowBuildVersionArn(value); return *this;}
