...
class SsmParameterConfiguration {
 public:
  ...
  void SetAmiAccountId(AmiAccountIdT&& value) {
    ...
    m_amiAccountId = std::forward<AmiAccountIdT>(value);
  }
  template <typename AmiAccountIdT = Aws::String>
  SsmParameterConfiguration& WithAmiAccountId(AmiAccountIdT&& value) {
    SetAmiAccountId(std::forward<AmiAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataType(SsmParameterDataType value) {
    m_dataTypeHasBeenSet = true;
    m_dataType = value;
  }
  inline SsmParameterConfiguration& WithDataType(SsmParameterDataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
