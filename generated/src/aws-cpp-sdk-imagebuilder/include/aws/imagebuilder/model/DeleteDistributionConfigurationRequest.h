...
namespace Model
{
  ...
  {
  public:
    AWS_IMAGEBUILDER_API DeleteDistributionConfigurationRequest() = default;
    ...
    template<typename DistributionConfigurationArnT = Aws::String>
    DeleteDistributionConfigurationRequest& WithDistributionConfigurationArn(DistributionConfigurationArnT&& value) { SetDistributionConfigurationArn(std::forward<DistributionConfigurationArnT>(value)); return *this;}
    ///@}
  private:
