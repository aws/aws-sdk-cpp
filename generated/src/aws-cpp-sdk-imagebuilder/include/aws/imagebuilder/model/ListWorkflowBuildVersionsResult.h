...
class ListWorkflowBuildVersionsResult {
 public:
  ...
  void SetWorkflowSummaryList(WorkflowSummaryListT&& value) {
    m_workflowSummaryListHasBeenSet = true;
    m_workflowSummaryList = std::forward<WorkflowSummaryListT>(value);
  }
  template <typename WorkflowSummaryListT = Aws::Vector<WorkflowSummary>>
  ListWorkflowBuildVersionsResult& WithWorkflowSummaryList(WorkflowSummaryListT&& value) {
    SetWorkflowSummaryList(std::forward<WorkflowSummaryListT>(value));
    return *this;
  }
  template <typename WorkflowSummaryListT = WorkflowSummary>
  ListWorkflowBuildVersionsResult& AddWorkflowSummaryList(WorkflowSummaryListT&& value) {
    m_workflowSummaryListHasBeenSet = true;
    m_workflowSummaryList.emplace_back(std::forward<WorkflowSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowBuildVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkflowBuildVersionsResult& WithRequestId(RequestIdT&& value) {
