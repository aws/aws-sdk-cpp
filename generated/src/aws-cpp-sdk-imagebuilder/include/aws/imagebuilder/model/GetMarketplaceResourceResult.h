...
class GetMarketplaceResourceResult {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  GetMarketplaceResourceResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename UrlT = Aws::String>
  GetMarketplaceResourceResult& WithUrl(UrlT&& value) {
  ...
  template <typename DataT = Aws::String>
  GetMarketplaceResourceResult& WithData(DataT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetMarketplaceResourceResult& WithRequestId(RequestIdT&& value) {
