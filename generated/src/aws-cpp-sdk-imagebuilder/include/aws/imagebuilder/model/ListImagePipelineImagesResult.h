...
class ListImagePipelineImagesResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListImagePipelineImagesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ImageSummaryListT = Aws::Vector<ImageSummary>>
  ListImagePipelineImagesResult& WithImageSummaryList(ImageSummaryListT&& value) {
    SetImageSummaryList(std::forward<ImageSummaryListT>(value));
    return *this;
  }
  template <typename ImageSummaryListT = ImageSummary>
  ListImagePipelineImagesResult& AddImageSummaryList(ImageSummaryListT&& value) {
    m_imageSummaryListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImagePipelineImagesResult& WithNextToken(NextTokenT&& value) {
