...
class WorkflowExecutionMetadata {
 public:
  ...
  inline WorkflowExecutionMetadata& WithType(WorkflowType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowExecutionMetadata& WithStatus(WorkflowExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline WorkflowExecutionMetadata& WithTotalStepCount(int value) {
  ...
  inline WorkflowExecutionMetadata& WithTotalStepsSucceeded(int value) {
  ...
  inline WorkflowExecutionMetadata& WithTotalStepsFailed(int value) {
  ...
  inline WorkflowExecutionMetadata& WithTotalStepsSkipped(int value) {
