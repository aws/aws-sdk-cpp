...
class ListContainerRecipesResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListContainerRecipesResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetContainerRecipeSummaryList(ContainerRecipeSummaryListT&& value) {
    m_containerRecipeSummaryListHasBeenSet = true;
    m_containerRecipeSummaryList = std::forward<ContainerRecipeSummaryListT>(value);
  }
  template <typename ContainerRecipeSummaryListT = Aws::Vector<ContainerRecipeSummary>>
  ListContainerRecipesResult& WithContainerRecipeSummaryList(ContainerRecipeSummaryListT&& value) {
    SetContainerRecipeSummaryList(std::forward<ContainerRecipeSummaryListT>(value));
    return *this;
  }
  template <typename ContainerRecipeSummaryListT = ContainerRecipeSummary>
  ListContainerRecipesResult& AddContainerRecipeSummaryList(ContainerRecipeSummaryListT&& value) {
    m_containerRecipeSummaryListHasBeenSet = true;
    m_containerRecipeSummaryList.emplace_back(std::forward<ContainerRecipeSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContainerRecipesResult& WithNextToken(NextTokenT&& value) {
