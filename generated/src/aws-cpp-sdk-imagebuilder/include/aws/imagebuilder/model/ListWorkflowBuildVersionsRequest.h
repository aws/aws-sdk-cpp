...
class ListWorkflowBuildVersionsRequest : public ImagebuilderRequest {
 public:
  ...
  void SetWorkflowVersionArn(WorkflowVersionArnT&& value) {
    m_workflowVersionArnHasBeenSet = true;
    m_workflowVersionArn = std::forward<WorkflowVersionArnT>(value);
  }
  template <typename WorkflowVersionArnT = Aws::String>
  ListWorkflowBuildVersionsRequest& WithWorkflowVersionArn(WorkflowVersionArnT&& value) {
    SetWorkflowVersionArn(std::forward<WorkflowVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListWorkflowBuildVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowBuildVersionsRequest& WithNextToken(NextTokenT&& value) {
