...
class ListImagesRequest : public ImagebuilderRequest {
 public:
  ...
  inline ListImagesRequest& WithOwner(Ownership value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  inline ListImagesRequest& WithByName(bool value) {
    SetByName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeDeprecated(bool value) {
    m_includeDeprecatedHasBeenSet = true;
    m_includeDeprecated = value;
  }
  inline ListImagesRequest& WithIncludeDeprecated(bool value) {
