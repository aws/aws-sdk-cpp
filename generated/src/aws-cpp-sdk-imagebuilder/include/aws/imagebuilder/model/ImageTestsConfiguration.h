...
class ImageTestsConfiguration {
 public:
  ...
  inline void SetImageTestsEnabled(bool value) {
    m_imageTestsEnabledHasBeenSet = true;
    m_imageTestsEnabled = value;
  }
  inline ImageTestsConfiguration& WithImageTestsEnabled(bool value) {
    SetImageTestsEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ImageTestsConfiguration& WithTimeoutMinutes(int value) {
