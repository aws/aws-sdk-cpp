...
class ListImageScanFindingAggregationsResult {
 public:
  ...
  AWS_IMAGEBUILDER_API ListImageScanFindingAggregationsResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  ListImageScanFindingAggregationsResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename AggregationTypeT = Aws::String>
  ListImageScanFindingAggregationsResult& WithAggregationType(AggregationTypeT&& value) {
  ...
  template <typename ResponsesT = Aws::Vector<ImageScanFindingAggregation>>
  ListImageScanFindingAggregationsResult& WithResponses(ResponsesT&& value) {
    SetResponses(std::forward<ResponsesT>(value));
    return *this;
  }
  template <typename ResponsesT = ImageScanFindingAggregation>
  ListImageScanFindingAggregationsResult& AddResponses(ResponsesT&& value) {
    m_responsesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImageScanFindingAggregationsResult& WithNextToken(NextTokenT&& value) {
