...
class ProductCodeListItem {
 public:
  ...
  template <typename ProductCodeIdT = Aws::String>
  ProductCodeListItem& WithProductCodeId(ProductCodeIdT&& value) {
  ...
  inline void SetProductCodeType(ProductCodeType value) {
    m_productCodeTypeHasBeenSet = true;
    m_productCodeType = value;
  }
  inline ProductCodeListItem& WithProductCodeType(ProductCodeType value) {
