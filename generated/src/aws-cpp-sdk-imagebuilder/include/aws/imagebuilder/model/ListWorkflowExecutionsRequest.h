...
class ListWorkflowExecutionsRequest : public ImagebuilderRequest {
 public:
  ...
  inline ListWorkflowExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkflowExecutionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  ListWorkflowExecutionsRequest& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
