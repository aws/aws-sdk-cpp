...
class AdditionalInstanceConfiguration {
 public:
  ...
  void SetSystemsManagerAgent(SystemsManagerAgentT&& value) {
    m_systemsManagerAgentHasBeenSet = true;
    m_systemsManagerAgent = std::forward<SystemsManagerAgentT>(value);
  }
  template <typename SystemsManagerAgentT = SystemsManagerAgent>
  AdditionalInstanceConfiguration& WithSystemsManagerAgent(SystemsManagerAgentT&& value) {
    SetSystemsManagerAgent(std::forward<SystemsManagerAgentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserDataOverride(UserDataOverrideT&& value) {
    m_userDataOverrideHasBeenSet = true;
    m_userDataOverride = std::forward<UserDataOverrideT>(value);
  }
  template <typename UserDataOverrideT = Aws::String>
  AdditionalInstanceConfiguration& WithUserDataOverride(UserDataOverrideT&& value) {
    SetUserDataOverride(std::forward<UserDataOverrideT>(value));
    return *this;
  }
  ///@}
 private:
