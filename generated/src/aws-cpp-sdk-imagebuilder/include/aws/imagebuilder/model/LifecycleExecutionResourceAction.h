...
class LifecycleExecutionResourceAction {
 public:
  ...
  inline void SetName(LifecycleExecutionResourceActionName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LifecycleExecutionResourceAction& WithName(LifecycleExecutionResourceActionName value) {
    SetName(value);
    return *this;
  }
  ///@}
