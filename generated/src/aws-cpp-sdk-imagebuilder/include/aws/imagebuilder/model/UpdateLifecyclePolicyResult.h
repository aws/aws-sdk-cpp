...
class UpdateLifecyclePolicyResult {
 public:
  AWS_IMAGEBUILDER_API UpdateLifecyclePolicyResult() = default;
  ...
  template <typename LifecyclePolicyArnT = Aws::String>
  UpdateLifecyclePolicyResult& WithLifecyclePolicyArn(LifecyclePolicyArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateLifecyclePolicyResult& WithRequestId(RequestIdT&& value) {
