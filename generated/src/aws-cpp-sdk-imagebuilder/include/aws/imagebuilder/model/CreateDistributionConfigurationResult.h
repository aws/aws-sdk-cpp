...
class CreateDistributionConfigurationResult {
 public:
  ...
  AWS_IMAGEBUILDER_API CreateDistributionConfigurationResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  CreateDistributionConfigurationResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateDistributionConfigurationResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename DistributionConfigurationArnT = Aws::String>
  CreateDistributionConfigurationResult& WithDistributionConfigurationArn(DistributionConfigurationArnT&& value) {
