...
class ListContainerRecipesRequest : public ImagebuilderRequest {
 public:
  ...
  inline ListContainerRecipesRequest& WithOwner(Ownership value) {
    SetOwner(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListContainerRecipesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListContainerRecipesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListContainerRecipesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContainerRecipesRequest& WithNextToken(NextTokenT&& value) {
