...
class ComponentVersion {
 public:
  ...
  inline ComponentVersion& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The operating system (OS) version supported by the component. If OS
  ...
  inline ComponentVersion& WithType(ComponentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ComponentVersion& WithStatus(ComponentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
