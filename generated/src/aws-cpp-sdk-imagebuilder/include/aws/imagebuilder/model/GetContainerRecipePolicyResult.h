...
class GetContainerRecipePolicyResult {
 public:
  AWS_IMAGEBUILDER_API GetContainerRecipePolicyResult() = default;
  ...
  template <typename RequestIdT = Aws::String>
  GetContainerRecipePolicyResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename PolicyT = Aws::String>
  GetContainerRecipePolicyResult& WithPolicy(PolicyT&& value) {
