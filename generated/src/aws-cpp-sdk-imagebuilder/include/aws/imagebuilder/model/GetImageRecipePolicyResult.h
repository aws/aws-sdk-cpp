...
namespace Model
{
  ...
  public:
    ...
    template<typename RequestIdT = Aws::String>
    GetImageRecipePolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PolicyT = Aws::String>
    GetImageRecipePolicyResult& WithPolicy(PolicyT&& value) { SetPolicy(std::forward<PolicyT>(value)); return *this;}
    ///@}
  private:
