...
class ListImageRecipesResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListImageRecipesResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetImageRecipeSummaryList(ImageRecipeSummaryListT&& value) {
    m_imageRecipeSummaryListHasBeenSet = true;
    m_imageRecipeSummaryList = std::forward<ImageRecipeSummaryListT>(value);
  }
  template <typename ImageRecipeSummaryListT = Aws::Vector<ImageRecipeSummary>>
  ListImageRecipesResult& WithImageRecipeSummaryList(ImageRecipeSummaryListT&& value) {
    SetImageRecipeSummaryList(std::forward<ImageRecipeSummaryListT>(value));
    return *this;
  }
  template <typename ImageRecipeSummaryListT = ImageRecipeSummary>
  ListImageRecipesResult& AddImageRecipeSummaryList(ImageRecipeSummaryListT&& value) {
    m_imageRecipeSummaryListHasBeenSet = true;
    m_imageRecipeSummaryList.emplace_back(std::forward<ImageRecipeSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImageRecipesResult& WithNextToken(NextTokenT&& value) {
