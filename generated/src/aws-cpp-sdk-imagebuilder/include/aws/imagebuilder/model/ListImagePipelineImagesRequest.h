...
class ListImagePipelineImagesRequest : public ImagebuilderRequest {
 public:
  ...
  template <typename ImagePipelineArnT = Aws::String>
  ListImagePipelineImagesRequest& WithImagePipelineArn(ImagePipelineArnT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListImagePipelineImagesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListImagePipelineImagesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListImagePipelineImagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImagePipelineImagesRequest& WithNextToken(NextTokenT&& value) {
