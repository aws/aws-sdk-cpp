...
class ListImagePackagesRequest : public ImagebuilderRequest {
 public:
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  ListImagePackagesRequest& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
  ...
  inline ListImagePackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImagePackagesRequest& WithNextToken(NextTokenT&& value) {
