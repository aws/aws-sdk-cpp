...
class CancelImageCreationResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  CancelImageCreationResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CancelImageCreationResult& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ImageBuildVersionArnT = Aws::String>
  CancelImageCreationResult& WithImageBuildVersionArn(ImageBuildVersionArnT&& value) {
