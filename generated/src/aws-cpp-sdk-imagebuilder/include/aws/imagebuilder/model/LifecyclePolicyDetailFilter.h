...
class LifecyclePolicyDetailFilter {
 public:
  ...
  inline void SetType(LifecyclePolicyDetailFilterType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline LifecyclePolicyDetailFilter& WithType(LifecyclePolicyDetailFilterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline LifecyclePolicyDetailFilter& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(LifecyclePolicyTimeUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline LifecyclePolicyDetailFilter& WithUnit(LifecyclePolicyTimeUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRetainAtLeast(int value) {
    m_retainAtLeastHasBeenSet = true;
    m_retainAtLeast = value;
  }
  inline LifecyclePolicyDetailFilter& WithRetainAtLeast(int value) {
    SetRetainAtLeast(value);
    return *this;
  }
  ///@}
 private:
