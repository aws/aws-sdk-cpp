...
class ListLifecyclePoliciesResult {
 public:
  ...
  void SetLifecyclePolicySummaryList(LifecyclePolicySummaryListT&& value) {
    m_lifecyclePolicySummaryListHasBeenSet = true;
    m_lifecyclePolicySummaryList = std::forward<LifecyclePolicySummaryListT>(value);
  }
  template <typename LifecyclePolicySummaryListT = Aws::Vector<LifecyclePolicySummary>>
  ListLifecyclePoliciesResult& WithLifecyclePolicySummaryList(LifecyclePolicySummaryListT&& value) {
    SetLifecyclePolicySummaryList(std::forward<LifecyclePolicySummaryListT>(value));
    return *this;
  }
  template <typename LifecyclePolicySummaryListT = LifecyclePolicySummary>
  ListLifecyclePoliciesResult& AddLifecyclePolicySummaryList(LifecyclePolicySummaryListT&& value) {
    m_lifecyclePolicySummaryListHasBeenSet = true;
    m_lifecyclePolicySummaryList.emplace_back(std::forward<LifecyclePolicySummaryListT>(value));
    return *this;
  }
  ///@}
