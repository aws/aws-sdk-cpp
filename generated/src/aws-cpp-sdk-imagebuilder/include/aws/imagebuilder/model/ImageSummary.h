...
class ImageSummary {
 public:
  ...
  inline ImageSummary& WithType(ImageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline ImageSummary& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  inline ImageSummary& WithBuildType(BuildType value) {
    SetBuildType(value);
    return *this;
  }
  ///@}
  ...
  inline ImageSummary& WithImageSource(ImageSource value) {
