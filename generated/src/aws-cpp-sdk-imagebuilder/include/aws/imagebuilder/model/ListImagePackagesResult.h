...
class ListImagePackagesResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ListImagePackagesResult& WithRequestId(RequestIdT&& value) {
  ...
  void SetImagePackageList(ImagePackageListT&& value) {
    m_imagePackageListHasBeenSet = true;
    m_imagePackageList = std::forward<ImagePackageListT>(value);
  }
  template <typename ImagePackageListT = Aws::Vector<ImagePackage>>
  ListImagePackagesResult& WithImagePackageList(ImagePackageListT&& value) {
    SetImagePackageList(std::forward<ImagePackageListT>(value));
    return *this;
  }
  template <typename ImagePackageListT = ImagePackage>
  ListImagePackagesResult& AddImagePackageList(ImagePackageListT&& value) {
    m_imagePackageListHasBeenSet = true;
    m_imagePackageList.emplace_back(std::forward<ImagePackageListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImagePackagesResult& WithNextToken(NextTokenT&& value) {
