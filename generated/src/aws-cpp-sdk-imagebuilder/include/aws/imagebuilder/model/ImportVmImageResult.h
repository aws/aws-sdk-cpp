...
class ImportVmImageResult {
 public:
  ...
  template <typename RequestIdT = Aws::String>
  ImportVmImageResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ImageArnT = Aws::String>
  ImportVmImageResult& WithImageArn(ImageArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ImportVmImageResult& WithClientToken(ClientTokenT&& value) {
