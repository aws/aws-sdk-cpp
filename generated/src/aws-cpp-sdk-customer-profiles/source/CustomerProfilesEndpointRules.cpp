...
{
const size_t CustomerProfilesEndpointRules::RulesBlobStrLen = 3396;
const size_t CustomerProfilesEndpointRules::RulesBlobSize = 3397;
...
't','t','p','s',':','/','/','p','r','o','f','i','l','e','-','f','i','p','s','.','{','R','e','g','i',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r','o','f','i','l','e','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','p','r','o','f','i','l','e','.','{','R','e','g','i','o',
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r',
'o','f','i','l','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n',
'R','e','s','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e',
'r','t','i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"',
't','y','p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* CustomerProfilesEndpointRules::GetRulesBlob()
{
