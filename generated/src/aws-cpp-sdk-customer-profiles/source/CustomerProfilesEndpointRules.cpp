...
{
const size_t CustomerProfilesEndpointRules::RulesBlobStrLen = 3728;
const size_t CustomerProfilesEndpointRules::RulesBlobSize = 3729;
...
'/','/','p','r','o','f','i','l','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','p','r','o','f','i','l','e','.','{','R','e',
