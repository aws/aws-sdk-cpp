...
Aws::String ListCalculatedAttributesForProfileRequest::SerializePayload() const { return {}; }

void ListCalculatedAttributesForProfileRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
