...
Aws::String ListSegmentSubscriptionEventsRequest::SerializePayload() const { return {}; }

void ListSegmentSubscriptionEventsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
