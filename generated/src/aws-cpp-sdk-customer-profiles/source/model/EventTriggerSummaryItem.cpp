...
EventTriggerSummaryItem& EventTriggerSummaryItem::operator =(JsonView jsonValue)
{
...
JsonValue EventTriggerSummaryItem::Jsonize() const
{
  JsonValue payload;
  ...
  if(m_eventTriggerNameHasBeenSet)
  {
   payload.WithString("EventTriggerName", m_eventTriggerName);
