...
Aws::String ListProfileObjectTypeTemplatesRequest::SerializePayload() const { return {}; }

void ListProfileObjectTypeTemplatesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
