...
Aws::String ListIdentityResolutionJobsRequest::SerializePayload() const { return {}; }

void ListIdentityResolutionJobsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
