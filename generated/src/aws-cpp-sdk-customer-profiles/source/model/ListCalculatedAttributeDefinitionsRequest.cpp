...
Aws::String ListCalculatedAttributeDefinitionsRequest::SerializePayload() const { return {}; }

void ListCalculatedAttributeDefinitionsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
