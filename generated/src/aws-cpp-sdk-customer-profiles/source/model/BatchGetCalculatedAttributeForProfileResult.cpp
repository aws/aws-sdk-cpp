...
BatchGetCalculatedAttributeForProfileResult& BatchGetCalculatedAttributeForProfileResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("CalculatedAttributeValues")) {
    ...
    for (unsigned calculatedAttributeValuesIndex = 0; calculatedAttributeValuesIndex < calculatedAttributeValuesJsonList.GetLength();
         ++calculatedAttributeValuesIndex) {
