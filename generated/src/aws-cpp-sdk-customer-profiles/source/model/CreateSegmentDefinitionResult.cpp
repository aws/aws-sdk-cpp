...
CreateSegmentDefinitionResult::CreateSegmentDefinitionResult()
{
}

CreateSegmentDefinitionResult::CreateSegmentDefinitionResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
