...
DomainObjectTypesListItem::DomainObjectTypesListItem(JsonView jsonValue) { *this = jsonValue; }

DomainObjectTypesListItem& DomainObjectTypesListItem::operator=(JsonView jsonValue) {
...
JsonValue DomainObjectTypesListItem::Jsonize() const {
  JsonValue payload;
