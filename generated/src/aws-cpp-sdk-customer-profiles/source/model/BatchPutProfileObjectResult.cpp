...
BatchPutProfileObjectResult::BatchPutProfileObjectResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchPutProfileObjectResult& BatchPutProfileObjectResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
