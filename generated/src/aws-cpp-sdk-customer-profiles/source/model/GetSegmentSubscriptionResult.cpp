...
GetSegmentSubscriptionResult::GetSegmentSubscriptionResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetSegmentSubscriptionResult& GetSegmentSubscriptionResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ScheduledExecutions")) {
    m_scheduledExecutions = jsonValue.GetObject("ScheduledExecutions");
