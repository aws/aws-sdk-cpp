...
Aws::String ListObjectTypeAttributeValuesRequest::SerializePayload() const { return {}; }

void ListObjectTypeAttributeValuesRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
