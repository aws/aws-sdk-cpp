...
namespace Model {
class CreateRecommenderSchemaResult {
 public:
  AWS_CUSTOMERPROFILES_API CreateRecommenderSchemaResult() = default;
  AWS_CUSTOMERPROFILES_API CreateRecommenderSchemaResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CUSTOMERPROFILES_API CreateRecommenderSchemaResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);

  ///@{
  /**
   * <p>The Amazon Resource Name (ARN) of the recommender schema.</p>
   */
  inline const Aws::String& GetRecommenderSchemaArn() const { return m_recommenderSchemaArn; }
  template <typename RecommenderSchemaArnT = Aws::String>
  void SetRecommenderSchemaArn(RecommenderSchemaArnT&& value) {
    m_recommenderSchemaArnHasBeenSet = true;
    m_recommenderSchemaArn = std::forward<RecommenderSchemaArnT>(value);
  }
  template <typename RecommenderSchemaArnT = Aws::String>
  CreateRecommenderSchemaResult& WithRecommenderSchemaArn(RecommenderSchemaArnT&& value) {
    SetRecommenderSchemaArn(std::forward<RecommenderSchemaArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecommenderSchemaNameT = Aws::String>
  CreateRecommenderSchemaResult& WithRecommenderSchemaName(RecommenderSchemaNameT&& value) {
  ...
  template <typename FieldsT = Aws::Map<Aws::String, Aws::Vector<RecommenderSchemaField>>>
  CreateRecommenderSchemaResult& WithFields(FieldsT&& value) {
  ...
  CreateRecommenderSchemaResult& AddFields(FieldsKeyT&& key, FieldsValueT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateRecommenderSchemaResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline CreateRecommenderSchemaResult& WithStatus(RecommenderSchemaStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRecommenderSchemaResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateRecommenderSchemaResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  CreateRecommenderSchemaResult& WithRequestId(RequestIdT&& value) {
 ...
 private:
  Aws::String m_recommenderSchemaArn;
  ...
  bool m_recommenderSchemaArnHasBeenSet = false;
