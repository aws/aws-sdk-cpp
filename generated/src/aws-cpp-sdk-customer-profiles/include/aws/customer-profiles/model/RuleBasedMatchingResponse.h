...
class RuleBasedMatchingResponse {
 public:
  ...
  inline RuleBasedMatchingResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(RuleBasedMatchingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RuleBasedMatchingResponse& WithStatus(RuleBasedMatchingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline RuleBasedMatchingResponse& WithMaxAllowedRuleLevelForMerging(int value) {
  ...
  inline RuleBasedMatchingResponse& WithMaxAllowedRuleLevelForMatching(int value) {
