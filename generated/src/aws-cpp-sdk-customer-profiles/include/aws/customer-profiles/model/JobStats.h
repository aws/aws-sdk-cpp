...
class JobStats {
 public:
  ...
  inline void SetNumberOfProfilesReviewed(long long value) {
    m_numberOfProfilesReviewedHasBeenSet = true;
    m_numberOfProfilesReviewed = value;
  }
  inline JobStats& WithNumberOfProfilesReviewed(long long value) {
    SetNumberOfProfilesReviewed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfMatchesFound(long long value) {
    m_numberOfMatchesFoundHasBeenSet = true;
    m_numberOfMatchesFound = value;
  }
  inline JobStats& WithNumberOfMatchesFound(long long value) {
    SetNumberOfMatchesFound(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfMergesDone(long long value) {
    m_numberOfMergesDoneHasBeenSet = true;
    m_numberOfMergesDone = value;
  }
  inline JobStats& WithNumberOfMergesDone(long long value) {
    SetNumberOfMergesDone(value);
    return *this;
  }
  ///@}
 private:
