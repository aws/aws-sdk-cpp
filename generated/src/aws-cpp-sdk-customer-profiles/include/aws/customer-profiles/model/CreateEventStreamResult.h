...
class CreateEventStreamResult {
 public:
  ...
  template <typename EventStreamArnT = Aws::String>
  CreateEventStreamResult& WithEventStreamArn(EventStreamArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateEventStreamResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateEventStreamResult& WithRequestId(RequestIdT&& value) {
