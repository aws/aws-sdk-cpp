...
class ProfileDimension {
 public:
  ...
  inline void SetDimensionType(StringDimensionType value) {
    m_dimensionTypeHasBeenSet = true;
    m_dimensionType = value;
  }
  inline ProfileDimension& WithDimensionType(StringDimensionType value) {
  ...
  ///@{
  /**
   * <p>The values to apply the DimensionType on. To reference a calculated attribute
