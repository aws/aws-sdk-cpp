...
class ListAccountIntegrationsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ListIntegrationItem>>
  ListAccountIntegrationsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListIntegrationItem>
  ListAccountIntegrationsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountIntegrationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountIntegrationsResult& WithRequestId(RequestIdT&& value) {
