...
class ListWorkflowsRequest : public CustomerProfilesRequest {
 public:
  ...
  inline ListWorkflowsRequest& WithWorkflowType(WorkflowType value) {
  ...
  inline ListWorkflowsRequest& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetQueryStartDate(QueryStartDateT&& value) {
    ...
    m_queryStartDate = std::forward<QueryStartDateT>(value);
  }
  template <typename QueryStartDateT = Aws::Utils::DateTime>
  ListWorkflowsRequest& WithQueryStartDate(QueryStartDateT&& value) {
    SetQueryStartDate(std::forward<QueryStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryEndDate(QueryEndDateT&& value) {
    ...
    m_queryEndDate = std::forward<QueryEndDateT>(value);
  }
  template <typename QueryEndDateT = Aws::Utils::DateTime>
  ListWorkflowsRequest& WithQueryEndDate(QueryEndDateT&& value) {
    SetQueryEndDate(std::forward<QueryEndDateT>(value));
    return *this;
  }
  ///@}
