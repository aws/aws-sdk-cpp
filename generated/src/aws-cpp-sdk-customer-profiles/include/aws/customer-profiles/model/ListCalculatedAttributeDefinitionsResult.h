...
class ListCalculatedAttributeDefinitionsResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API ListCalculatedAttributeDefinitionsResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ListCalculatedAttributeDefinitionItem>>
  ListCalculatedAttributeDefinitionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListCalculatedAttributeDefinitionItem>
  ListCalculatedAttributeDefinitionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCalculatedAttributeDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCalculatedAttributeDefinitionsResult& WithRequestId(RequestIdT&& value) {
