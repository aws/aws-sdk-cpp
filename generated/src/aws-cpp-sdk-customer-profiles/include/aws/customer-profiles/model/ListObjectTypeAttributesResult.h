...
class ListObjectTypeAttributesResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API ListObjectTypeAttributesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ListObjectTypeAttributeItem>>
  ListObjectTypeAttributesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListObjectTypeAttributeItem>
  ListObjectTypeAttributesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListObjectTypeAttributesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListObjectTypeAttributesResult& WithRequestId(RequestIdT&& value) {
