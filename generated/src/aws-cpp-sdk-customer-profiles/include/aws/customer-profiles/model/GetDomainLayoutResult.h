...
class GetDomainLayoutResult {
 public:
  ...
  inline GetDomainLayoutResult& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline GetDomainLayoutResult& WithLayoutType(LayoutType value) {
    SetLayoutType(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetDomainLayoutResult& WithTags(TagsT&& value) {
