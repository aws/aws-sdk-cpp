...
class ListProfileObjectTypesResult {
 public:
  AWS_CUSTOMERPROFILES_API ListProfileObjectTypesResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<ListProfileObjectTypeItem>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<ListProfileObjectTypeItem>>
  ListProfileObjectTypesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListProfileObjectTypeItem>
  ListProfileObjectTypesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileObjectTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileObjectTypesResult& WithRequestId(RequestIdT&& value) {
