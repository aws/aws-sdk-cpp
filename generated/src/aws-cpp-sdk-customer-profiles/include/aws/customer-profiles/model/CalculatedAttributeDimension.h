...
class CalculatedAttributeDimension {
 public:
  ...
  inline void SetDimensionType(AttributeDimensionType value) {
    m_dimensionTypeHasBeenSet = true;
    m_dimensionType = value;
  }
  inline CalculatedAttributeDimension& WithDimensionType(AttributeDimensionType value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  CalculatedAttributeDimension& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  CalculatedAttributeDimension& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  template <typename ConditionOverridesT = ConditionOverrides>
  CalculatedAttributeDimension& WithConditionOverrides(ConditionOverridesT&& value) {
