...
class ListProfileObjectsItem {
 public:
  ...
  template <typename ObjectTypeNameT = Aws::String>
  ListProfileObjectsItem& WithObjectTypeName(ObjectTypeNameT&& value) {
  ...
  template <typename ProfileObjectUniqueKeyT = Aws::String>
  ListProfileObjectsItem& WithProfileObjectUniqueKey(ProfileObjectUniqueKeyT&& value) {
  ...
  template <typename ObjectT = Aws::String>
  ListProfileObjectsItem& WithObject(ObjectT&& value) {
