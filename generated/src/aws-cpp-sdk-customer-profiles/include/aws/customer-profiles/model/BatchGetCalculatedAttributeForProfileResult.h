...
class BatchGetCalculatedAttributeForProfileResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API BatchGetCalculatedAttributeForProfileResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ErrorsT = Aws::Vector<BatchGetCalculatedAttributeForProfileError>>
  BatchGetCalculatedAttributeForProfileResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchGetCalculatedAttributeForProfileError>
  BatchGetCalculatedAttributeForProfileResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  void SetCalculatedAttributeValues(CalculatedAttributeValuesT&& value) {
    m_calculatedAttributeValuesHasBeenSet = true;
    m_calculatedAttributeValues = std::forward<CalculatedAttributeValuesT>(value);
  }
  template <typename CalculatedAttributeValuesT = Aws::Vector<CalculatedAttributeValue>>
  BatchGetCalculatedAttributeForProfileResult& WithCalculatedAttributeValues(CalculatedAttributeValuesT&& value) {
    SetCalculatedAttributeValues(std::forward<CalculatedAttributeValuesT>(value));
    return *this;
  }
  template <typename CalculatedAttributeValuesT = CalculatedAttributeValue>
  BatchGetCalculatedAttributeForProfileResult& AddCalculatedAttributeValues(CalculatedAttributeValuesT&& value) {
    m_calculatedAttributeValuesHasBeenSet = true;
    m_calculatedAttributeValues.emplace_back(std::forward<CalculatedAttributeValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConditionOverrides(ConditionOverridesT&& value) {
    m_conditionOverridesHasBeenSet = true;
    m_conditionOverrides = std::forward<ConditionOverridesT>(value);
  }
  template <typename ConditionOverridesT = ConditionOverrides>
  BatchGetCalculatedAttributeForProfileResult& WithConditionOverrides(ConditionOverridesT&& value) {
    SetConditionOverrides(std::forward<ConditionOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetCalculatedAttributeForProfileResult& WithRequestId(RequestIdT&& value) {
