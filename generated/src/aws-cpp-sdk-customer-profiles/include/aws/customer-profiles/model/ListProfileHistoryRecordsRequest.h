...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    ListProfileHistoryRecordsRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ProfileIdT = Aws::String>
    ListProfileHistoryRecordsRequest& WithProfileId(ProfileIdT&& value) { SetProfileId(std::forward<ProfileIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectTypeNameT = Aws::String>
    ListProfileHistoryRecordsRequest& WithObjectTypeName(ObjectTypeNameT&& value) { SetObjectTypeName(std::forward<ObjectTypeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListProfileHistoryRecordsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListProfileHistoryRecordsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    inline ListProfileHistoryRecordsRequest& WithActionType(ActionType value) { SetActionType(value); return *this;}
    ///@}
    ...
    template<typename PerformedByT = Aws::String>
    ListProfileHistoryRecordsRequest& WithPerformedBy(PerformedByT&& value) { SetPerformedBy(std::forward<PerformedByT>(value)); return *this;}
    ///@}
  private:
