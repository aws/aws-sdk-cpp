...
class SearchProfilesRequest : public CustomerProfilesRequest {
 public:
  ...
  inline SearchProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetAdditionalSearchKeys(AdditionalSearchKeysT&& value) {
    m_additionalSearchKeysHasBeenSet = true;
    m_additionalSearchKeys = std::forward<AdditionalSearchKeysT>(value);
  }
  template <typename AdditionalSearchKeysT = Aws::Vector<AdditionalSearchKey>>
  SearchProfilesRequest& WithAdditionalSearchKeys(AdditionalSearchKeysT&& value) {
    SetAdditionalSearchKeys(std::forward<AdditionalSearchKeysT>(value));
    return *this;
  }
  ...
  SearchProfilesRequest& AddAdditionalSearchKeys(AdditionalSearchKeysT&& value) {
    m_additionalSearchKeysHasBeenSet = true;
    m_additionalSearchKeys.emplace_back(std::forward<AdditionalSearchKeysT>(value));
    return *this;
  }
  ///@}
  ...
  inline SearchProfilesRequest& WithLogicalOperator(LogicalOperator value) {
