...
class ListCalculatedAttributesForProfileRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCalculatedAttributesForProfileRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCalculatedAttributesForProfileRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename DomainNameT = Aws::String>
  ListCalculatedAttributesForProfileRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  ListCalculatedAttributesForProfileRequest& WithProfileId(ProfileIdT&& value) {
