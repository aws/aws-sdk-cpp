...
class GetSimilarProfilesResult {
 public:
  ...
  inline GetSimilarProfilesResult& WithMatchType(MatchType value) {
    SetMatchType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRuleLevel(int value) {
    m_ruleLevelHasBeenSet = true;
    m_ruleLevel = value;
  }
  inline GetSimilarProfilesResult& WithRuleLevel(int value) {
    SetRuleLevel(value);
    return *this;
  }
  ///@}
  ...
  inline GetSimilarProfilesResult& WithConfidenceScore(double value) {
