...
class ListRuleBasedMatchesResult {
 public:
  ...
  void SetMatchIds(MatchIdsT&& value) {
    m_matchIdsHasBeenSet = true;
    m_matchIds = std::forward<MatchIdsT>(value);
  }
  template <typename MatchIdsT = Aws::Vector<Aws::String>>
  ListRuleBasedMatchesResult& WithMatchIds(MatchIdsT&& value) {
    SetMatchIds(std::forward<MatchIdsT>(value));
    return *this;
  }
  template <typename MatchIdsT = Aws::String>
  ListRuleBasedMatchesResult& AddMatchIds(MatchIdsT&& value) {
    m_matchIdsHasBeenSet = true;
    m_matchIds.emplace_back(std::forward<MatchIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRuleBasedMatchesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRuleBasedMatchesResult& WithRequestId(RequestIdT&& value) {
