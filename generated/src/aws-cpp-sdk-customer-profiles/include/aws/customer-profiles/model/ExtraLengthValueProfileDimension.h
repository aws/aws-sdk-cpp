...
class ExtraLengthValueProfileDimension {
 public:
  ...
  inline ExtraLengthValueProfileDimension& WithDimensionType(StringDimensionType value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExtraLengthValueProfileDimension& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExtraLengthValueProfileDimension& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
