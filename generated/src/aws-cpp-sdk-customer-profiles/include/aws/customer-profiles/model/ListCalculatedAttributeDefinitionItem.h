...
class ListCalculatedAttributeDefinitionItem {
 public:
  ...
  template <typename CalculatedAttributeNameT = Aws::String>
  ListCalculatedAttributeDefinitionItem& WithCalculatedAttributeName(CalculatedAttributeNameT&& value) {
  ...
  template <typename DisplayNameT = Aws::String>
  ListCalculatedAttributeDefinitionItem& WithDisplayName(DisplayNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListCalculatedAttributeDefinitionItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ListCalculatedAttributeDefinitionItem& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  ListCalculatedAttributeDefinitionItem& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline ListCalculatedAttributeDefinitionItem& WithUseHistoricalData(bool value) {
  ...
  inline ListCalculatedAttributeDefinitionItem& WithStatus(ReadinessStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ListCalculatedAttributeDefinitionItem& WithTags(TagsT&& value) {
