...
namespace Model
{
  ...
  public:
    ...
    template<typename Address1T = Aws::String>
    Address& WithAddress1(Address1T&& value) { SetAddress1(std::forward<Address1T>(value)); return *this;}
    ///@}
    ...
    template<typename Address2T = Aws::String>
    Address& WithAddress2(Address2T&& value) { SetAddress2(std::forward<Address2T>(value)); return *this;}
    ///@}
    ...
    template<typename Address3T = Aws::String>
    Address& WithAddress3(Address3T&& value) { SetAddress3(std::forward<Address3T>(value)); return *this;}
    ///@}
    ...
    template<typename Address4T = Aws::String>
    Address& WithAddress4(Address4T&& value) { SetAddress4(std::forward<Address4T>(value)); return *this;}
    ///@}
    ...
    template<typename CountyT = Aws::String>
    Address& WithCounty(CountyT&& value) { SetCounty(std::forward<CountyT>(value)); return *this;}
    ///@}
    ...
    template<typename ProvinceT = Aws::String>
    Address& WithProvince(ProvinceT&& value) { SetProvince(std::forward<ProvinceT>(value)); return *this;}
    ///@}
