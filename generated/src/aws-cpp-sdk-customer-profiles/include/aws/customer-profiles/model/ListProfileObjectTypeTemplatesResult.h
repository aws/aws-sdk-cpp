...
class ListProfileObjectTypeTemplatesResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API ListProfileObjectTypeTemplatesResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ListProfileObjectTypeTemplateItem>>
  ListProfileObjectTypeTemplatesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListProfileObjectTypeTemplateItem>
  ListProfileObjectTypeTemplatesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileObjectTypeTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileObjectTypeTemplatesResult& WithRequestId(RequestIdT&& value) {
