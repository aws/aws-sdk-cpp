...
class GetDomainObjectTypeResult {
 public:
  AWS_CUSTOMERPROFILES_API GetDomainObjectTypeResult() = default;
  AWS_CUSTOMERPROFILES_API GetDomainObjectTypeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_CUSTOMERPROFILES_API GetDomainObjectTypeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ObjectTypeNameT = Aws::String>
  GetDomainObjectTypeResult& WithObjectTypeName(ObjectTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetDomainObjectTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EncryptionKeyT = Aws::String>
  GetDomainObjectTypeResult& WithEncryptionKey(EncryptionKeyT&& value) {
  ...
  template <typename FieldsT = Aws::Map<Aws::String, DomainObjectTypeField>>
  GetDomainObjectTypeResult& WithFields(FieldsT&& value) {
    SetFields(std::forward<FieldsT>(value));
    return *this;
  }
  template <typename FieldsKeyT = Aws::String, typename FieldsValueT = DomainObjectTypeField>
  GetDomainObjectTypeResult& AddFields(FieldsKeyT&& key, FieldsValueT&& value) {
    m_fieldsHasBeenSet = true;
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetDomainObjectTypeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  GetDomainObjectTypeResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetDomainObjectTypeResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  GetDomainObjectTypeResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetDomainObjectTypeResult& WithRequestId(RequestIdT&& value) {
