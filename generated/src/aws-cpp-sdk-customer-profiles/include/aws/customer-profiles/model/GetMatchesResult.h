...
class GetMatchesResult {
 public:
  ...
  void SetMatchGenerationDate(MatchGenerationDateT&& value) {
    ...
    m_matchGenerationDate = std::forward<MatchGenerationDateT>(value);
  }
  template <typename MatchGenerationDateT = Aws::Utils::DateTime>
  GetMatchesResult& WithMatchGenerationDate(MatchGenerationDateT&& value) {
    SetMatchGenerationDate(std::forward<MatchGenerationDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPotentialMatches(int value) {
    m_potentialMatchesHasBeenSet = true;
    m_potentialMatches = value;
  }
  inline GetMatchesResult& WithPotentialMatches(int value) {
    SetPotentialMatches(value);
    return *this;
  }
  ///@}
