...
class ObjectTypeKey {
 public:
  ...
  void SetStandardIdentifiers(StandardIdentifiersT&& value) {
    m_standardIdentifiersHasBeenSet = true;
    m_standardIdentifiers = std::forward<StandardIdentifiersT>(value);
  }
  template <typename StandardIdentifiersT = Aws::Vector<StandardIdentifier>>
  ObjectTypeKey& WithStandardIdentifiers(StandardIdentifiersT&& value) {
    SetStandardIdentifiers(std::forward<StandardIdentifiersT>(value));
    return *this;
  }
  inline ObjectTypeKey& AddStandardIdentifiers(StandardIdentifier value) {
    m_standardIdentifiersHasBeenSet = true;
    m_standardIdentifiers.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetFieldNames(FieldNamesT&& value) {
    ...
    m_fieldNames = std::forward<FieldNamesT>(value);
  }
  template <typename FieldNamesT = Aws::Vector<Aws::String>>
  ObjectTypeKey& WithFieldNames(FieldNamesT&& value) {
    SetFieldNames(std::forward<FieldNamesT>(value));
    return *this;
  }
  template <typename FieldNamesT = Aws::String>
  ObjectTypeKey& AddFieldNames(FieldNamesT&& value) {
    m_fieldNamesHasBeenSet = true;
    m_fieldNames.emplace_back(std::forward<FieldNamesT>(value));
    return *this;
  }
  ///@}
 private:
