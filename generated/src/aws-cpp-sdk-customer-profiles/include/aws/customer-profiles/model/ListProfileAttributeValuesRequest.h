...
class ListProfileAttributeValuesRequest : public CustomerProfilesRequest {
 public:
  AWS_CUSTOMERPROFILES_API ListProfileAttributeValuesRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  ListProfileAttributeValuesRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename AttributeNameT = Aws::String>
  ListProfileAttributeValuesRequest& WithAttributeName(AttributeNameT&& value) {
