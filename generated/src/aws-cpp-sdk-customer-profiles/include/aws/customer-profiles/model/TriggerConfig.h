...
class TriggerConfig {
 public:
  ...
  inline TriggerConfig& WithTriggerType(TriggerType value) {
  ...
  void SetTriggerProperties(TriggerPropertiesT&& value) {
    ...
    m_triggerProperties = std::forward<TriggerPropertiesT>(value);
  }
  template <typename TriggerPropertiesT = TriggerProperties>
  TriggerConfig& WithTriggerProperties(TriggerPropertiesT&& value) {
    SetTriggerProperties(std::forward<TriggerPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
