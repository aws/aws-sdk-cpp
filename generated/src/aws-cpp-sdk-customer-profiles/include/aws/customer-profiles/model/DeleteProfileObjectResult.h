...
namespace Model
{
  ...
  {
  public:
    AWS_CUSTOMERPROFILES_API DeleteProfileObjectResult() = default;
    ...
    template<typename MessageT = Aws::String>
    DeleteProfileObjectResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProfileObjectResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
