...
/**
 */
class ListSegmentSubscriptionEventsRequest : public CustomerProfilesRequest {
 public:
  AWS_CUSTOMERPROFILES_API ListSegmentSubscriptionEventsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListSegmentSubscriptionEvents"; }
  ...
  template <typename DomainNameT = Aws::String>
  ListSegmentSubscriptionEventsRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename SegmentDefinitionNameT = Aws::String>
  ListSegmentSubscriptionEventsRequest& WithSegmentDefinitionName(SegmentDefinitionNameT&& value) {
  ...
  inline ListSegmentSubscriptionEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The pagination token from the previous call to retrieve the next page of
   * results. </p>
   */
  ...
  template <typename NextTokenT = Aws::String>
  ListSegmentSubscriptionEventsRequest& WithNextToken(NextTokenT&& value) {
