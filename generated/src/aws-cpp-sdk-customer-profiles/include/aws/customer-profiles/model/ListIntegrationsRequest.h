...
class ListIntegrationsRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  ListIntegrationsRequest& WithDomainName(DomainNameT&& value) {
  ...
  inline void SetIncludeHidden(bool value) {
    m_includeHiddenHasBeenSet = true;
    m_includeHidden = value;
  }
  inline ListIntegrationsRequest& WithIncludeHidden(bool value) {
