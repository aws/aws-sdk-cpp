...
class ListCalculatedAttributesForProfileResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API ListCalculatedAttributesForProfileResult& operator=(
  ...
  template <typename ItemsT = Aws::Vector<ListCalculatedAttributeForProfileItem>>
  ListCalculatedAttributesForProfileResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListCalculatedAttributeForProfileItem>
  ListCalculatedAttributesForProfileResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCalculatedAttributesForProfileResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCalculatedAttributesForProfileResult& WithRequestId(RequestIdT&& value) {
