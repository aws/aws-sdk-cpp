...
class EventTriggerCondition {
 public:
  ...
  void SetEventTriggerDimensions(EventTriggerDimensionsT&& value) {
    ...
    m_eventTriggerDimensions = std::forward<EventTriggerDimensionsT>(value);
  }
  template <typename EventTriggerDimensionsT = Aws::Vector<EventTriggerDimension>>
  EventTriggerCondition& WithEventTriggerDimensions(EventTriggerDimensionsT&& value) {
    SetEventTriggerDimensions(std::forward<EventTriggerDimensionsT>(value));
    return *this;
  }
  ...
  EventTriggerCondition& AddEventTriggerDimensions(EventTriggerDimensionsT&& value) {
    m_eventTriggerDimensionsHasBeenSet = true;
    m_eventTriggerDimensions.emplace_back(std::forward<EventTriggerDimensionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLogicalOperator(EventTriggerLogicalOperator value) {
    m_logicalOperatorHasBeenSet = true;
    m_logicalOperator = value;
  }
  inline EventTriggerCondition& WithLogicalOperator(EventTriggerLogicalOperator value) {
