...
namespace Model
{
  ...
  {
  public:
    AWS_CUSTOMERPROFILES_API ListIntegrationsResult() = default;
    ...
    template<typename ItemsT = Aws::Vector<ListIntegrationItem>>
    ListIntegrationsResult& WithItems(ItemsT&& value) { SetItems(std::forward<ItemsT>(value)); return *this;}
    template<typename ItemsT = ListIntegrationItem>
    ListIntegrationsResult& AddItems(ItemsT&& value) { m_itemsHasBeenSet = true; m_items.emplace_back(std::forward<ItemsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListIntegrationsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
