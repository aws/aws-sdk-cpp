...
class EventStreamDestinationDetails {
 public:
  ...
  inline void SetStatus(EventStreamDestinationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EventStreamDestinationDetails& WithStatus(EventStreamDestinationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetUnhealthySince(UnhealthySinceT&& value) {
    ...
    m_unhealthySince = std::forward<UnhealthySinceT>(value);
  }
  template <typename UnhealthySinceT = Aws::Utils::DateTime>
  EventStreamDestinationDetails& WithUnhealthySince(UnhealthySinceT&& value) {
    SetUnhealthySince(std::forward<UnhealthySinceT>(value));
    return *this;
  }
  ///@}
