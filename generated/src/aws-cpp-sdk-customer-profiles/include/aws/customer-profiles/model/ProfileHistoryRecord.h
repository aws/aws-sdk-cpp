...
namespace Model
{
  ...
  public:
    ...
    template<typename IdT = Aws::String>
    ProfileHistoryRecord& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ObjectTypeNameT = Aws::String>
    ProfileHistoryRecord& WithObjectTypeName(ObjectTypeNameT&& value) { SetObjectTypeName(std::forward<ObjectTypeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ProfileHistoryRecord& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename LastUpdatedAtT = Aws::Utils::DateTime>
    ProfileHistoryRecord& WithLastUpdatedAt(LastUpdatedAtT&& value) { SetLastUpdatedAt(std::forward<LastUpdatedAtT>(value)); return *this;}
    ///@}
    ...
    inline ProfileHistoryRecord& WithActionType(ActionType value) { SetActionType(value); return *this;}
    ///@}
    ...
    template<typename ProfileObjectUniqueKeyT = Aws::String>
    ProfileHistoryRecord& WithProfileObjectUniqueKey(ProfileObjectUniqueKeyT&& value) { SetProfileObjectUniqueKey(std::forward<ProfileObjectUniqueKeyT>(value)); return *this;}
    ///@}
    ...
    template<typename PerformedByT = Aws::String>
    ProfileHistoryRecord& WithPerformedBy(PerformedByT&& value) { SetPerformedBy(std::forward<PerformedByT>(value)); return *this;}
    ///@}
  private:
