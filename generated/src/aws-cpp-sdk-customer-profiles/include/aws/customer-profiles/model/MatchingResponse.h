...
class MatchingResponse {
 public:
  ...
  inline MatchingResponse& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobScheduleT = JobSchedule>
  MatchingResponse& WithJobSchedule(JobScheduleT&& value) {
  ...
  template <typename AutoMergingT = AutoMerging>
  MatchingResponse& WithAutoMerging(AutoMergingT&& value) {
  ...
  template <typename ExportingConfigT = ExportingConfig>
  MatchingResponse& WithExportingConfig(ExportingConfigT&& value) {
