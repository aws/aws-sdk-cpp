...
class ListEventTriggersResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<EventTriggerSummaryItem>>
  ListEventTriggersResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EventTriggerSummaryItem>
  ListEventTriggersResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventTriggersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEventTriggersResult& WithRequestId(RequestIdT&& value) {
