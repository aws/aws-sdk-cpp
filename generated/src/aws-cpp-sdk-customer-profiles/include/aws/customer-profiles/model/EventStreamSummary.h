...
class EventStreamSummary {
 public:
  ...
  void SetEventStreamArn(EventStreamArnT&& value) {
    ...
    m_eventStreamArn = std::forward<EventStreamArnT>(value);
  }
  template <typename EventStreamArnT = Aws::String>
  EventStreamSummary& WithEventStreamArn(EventStreamArnT&& value) {
    SetEventStreamArn(std::forward<EventStreamArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(EventStreamState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline EventStreamSummary& WithState(EventStreamState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetStoppedSince(StoppedSinceT&& value) {
    ...
    m_stoppedSince = std::forward<StoppedSinceT>(value);
  }
  template <typename StoppedSinceT = Aws::Utils::DateTime>
  EventStreamSummary& WithStoppedSince(StoppedSinceT&& value) {
    SetStoppedSince(std::forward<StoppedSinceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationSummary(DestinationSummaryT&& value) {
    ...
    m_destinationSummary = std::forward<DestinationSummaryT>(value);
  }
  template <typename DestinationSummaryT = DestinationSummary>
  EventStreamSummary& WithDestinationSummary(DestinationSummaryT&& value) {
    SetDestinationSummary(std::forward<DestinationSummaryT>(value));
    return *this;
  }
  ///@}
