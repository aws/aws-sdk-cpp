...
class S3ExportingConfig {
 public:
  ...
  template <typename S3BucketNameT = Aws::String>
  S3ExportingConfig& WithS3BucketName(S3BucketNameT&& value) {
  ...
  void SetS3KeyName(S3KeyNameT&& value) {
    m_s3KeyNameHasBeenSet = true;
    m_s3KeyName = std::forward<S3KeyNameT>(value);
  }
  template <typename S3KeyNameT = Aws::String>
  S3ExportingConfig& WithS3KeyName(S3KeyNameT&& value) {
    SetS3KeyName(std::forward<S3KeyNameT>(value));
    return *this;
  }
  ///@}
 private:
