...
class Consolidation {
 public:
  ...
  void SetMatchingAttributesList(MatchingAttributesListT&& value) {
    ...
    m_matchingAttributesList = std::forward<MatchingAttributesListT>(value);
  }
  template <typename MatchingAttributesListT = Aws::Vector<Aws::Vector<Aws::String>>>
  Consolidation& WithMatchingAttributesList(MatchingAttributesListT&& value) {
    SetMatchingAttributesList(std::forward<MatchingAttributesListT>(value));
    return *this;
  }
  ...
  Consolidation& AddMatchingAttributesList(MatchingAttributesListT&& value) {
    m_matchingAttributesListHasBeenSet = true;
    m_matchingAttributesList.emplace_back(std::forward<MatchingAttributesListT>(value));
    return *this;
  }
  ///@}
 private:
