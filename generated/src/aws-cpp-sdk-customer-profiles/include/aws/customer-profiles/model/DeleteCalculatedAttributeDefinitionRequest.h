...
class DeleteCalculatedAttributeDefinitionRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  DeleteCalculatedAttributeDefinitionRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename CalculatedAttributeNameT = Aws::String>
  DeleteCalculatedAttributeDefinitionRequest& WithCalculatedAttributeName(CalculatedAttributeNameT&& value) {
