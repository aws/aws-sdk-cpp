...
class BatchGetCalculatedAttributeForProfileError {
 public:
  ...
  template <typename CodeT = Aws::String>
  BatchGetCalculatedAttributeForProfileError& WithCode(CodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  BatchGetCalculatedAttributeForProfileError& WithMessage(MessageT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  BatchGetCalculatedAttributeForProfileError& WithProfileId(ProfileIdT&& value) {
