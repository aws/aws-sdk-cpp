...
namespace Model
{
  ...
  public:
    ...
    inline GetWorkflowStepsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}
    inline GetWorkflowStepsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}
    inline GetWorkflowStepsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
    ///@}
  private:
