...
class AttributeTypesSelector {
 public:
  ...
  inline void SetAttributeMatchingModel(AttributeMatchingModel value) {
    m_attributeMatchingModelHasBeenSet = true;
    m_attributeMatchingModel = value;
  }
  inline AttributeTypesSelector& WithAttributeMatchingModel(AttributeMatchingModel value) {
    SetAttributeMatchingModel(value);
    return *this;
  }
  ///@}
  ...
  template <typename AddressT = Aws::Vector<Aws::String>>
  AttributeTypesSelector& WithAddress(AddressT&& value) {
    SetAddress(std::forward<AddressT>(value));
    return *this;
  }
  template <typename AddressT = Aws::String>
  AttributeTypesSelector& AddAddress(AddressT&& value) {
    m_addressHasBeenSet = true;
    m_address.emplace_back(std::forward<AddressT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PhoneNumberT = Aws::Vector<Aws::String>>
  AttributeTypesSelector& WithPhoneNumber(PhoneNumberT&& value) {
    SetPhoneNumber(std::forward<PhoneNumberT>(value));
    return *this;
  }
  template <typename PhoneNumberT = Aws::String>
  AttributeTypesSelector& AddPhoneNumber(PhoneNumberT&& value) {
    m_phoneNumberHasBeenSet = true;
    m_phoneNumber.emplace_back(std::forward<PhoneNumberT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename EmailAddressT = Aws::Vector<Aws::String>>
  AttributeTypesSelector& WithEmailAddress(EmailAddressT&& value) {
    SetEmailAddress(std::forward<EmailAddressT>(value));
    return *this;
  }
  template <typename EmailAddressT = Aws::String>
  AttributeTypesSelector& AddEmailAddress(EmailAddressT&& value) {
    m_emailAddressHasBeenSet = true;
    m_emailAddress.emplace_back(std::forward<EmailAddressT>(value));
    return *this;
  }
  ///@}
 private:
