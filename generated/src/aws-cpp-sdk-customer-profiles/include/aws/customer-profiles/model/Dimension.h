...
class Dimension {
 public:
  ...
  void SetProfileAttributes(ProfileAttributesT&& value) {
    ...
    m_profileAttributes = std::forward<ProfileAttributesT>(value);
  }
  template <typename ProfileAttributesT = ProfileAttributes>
  Dimension& WithProfileAttributes(ProfileAttributesT&& value) {
    SetProfileAttributes(std::forward<ProfileAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCalculatedAttributes(CalculatedAttributesT&& value) {
    ...
    m_calculatedAttributes = std::forward<CalculatedAttributesT>(value);
  }
  template <typename CalculatedAttributesT = Aws::Map<Aws::String, CalculatedAttributeDimension>>
  Dimension& WithCalculatedAttributes(CalculatedAttributesT&& value) {
    SetCalculatedAttributes(std::forward<CalculatedAttributesT>(value));
    return *this;
  }
  ...
  Dimension& AddCalculatedAttributes(CalculatedAttributesKeyT&& key, CalculatedAttributesValueT&& value) {
    m_calculatedAttributesHasBeenSet = true;
    m_calculatedAttributes.emplace(std::forward<CalculatedAttributesKeyT>(key), std::forward<CalculatedAttributesValueT>(value));
    return *this;
  }
  ///@}
 private:
