...
class GetSimilarProfilesRequest : public CustomerProfilesRequest {
 public:
  ...
  inline GetSimilarProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetSimilarProfilesRequest& WithMatchType(MatchType value) {
    SetMatchType(value);
    return *this;
  }
  ///@}
  ...
  void SetSearchKey(SearchKeyT&& value) {
    ...
    m_searchKey = std::forward<SearchKeyT>(value);
  }
  template <typename SearchKeyT = Aws::String>
  GetSimilarProfilesRequest& WithSearchKey(SearchKeyT&& value) {
    SetSearchKey(std::forward<SearchKeyT>(value));
    return *this;
  }
  ///@}
