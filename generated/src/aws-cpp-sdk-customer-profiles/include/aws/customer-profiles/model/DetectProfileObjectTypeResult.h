...
class DetectProfileObjectTypeResult {
 public:
  ...
  void SetDetectedProfileObjectTypes(DetectedProfileObjectTypesT&& value) {
    m_detectedProfileObjectTypesHasBeenSet = true;
    m_detectedProfileObjectTypes = std::forward<DetectedProfileObjectTypesT>(value);
  }
  template <typename DetectedProfileObjectTypesT = Aws::Vector<DetectedProfileObjectType>>
  DetectProfileObjectTypeResult& WithDetectedProfileObjectTypes(DetectedProfileObjectTypesT&& value) {
    SetDetectedProfileObjectTypes(std::forward<DetectedProfileObjectTypesT>(value));
    return *this;
  }
  template <typename DetectedProfileObjectTypesT = DetectedProfileObjectType>
  DetectProfileObjectTypeResult& AddDetectedProfileObjectTypes(DetectedProfileObjectTypesT&& value) {
    m_detectedProfileObjectTypesHasBeenSet = true;
    m_detectedProfileObjectTypes.emplace_back(std::forward<DetectedProfileObjectTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DetectProfileObjectTypeResult& WithRequestId(RequestIdT&& value) {
