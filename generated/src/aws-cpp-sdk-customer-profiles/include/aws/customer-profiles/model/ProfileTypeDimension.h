...
class ProfileTypeDimension {
 public:
  ...
  inline void SetDimensionType(ProfileTypeDimensionType value) {
    m_dimensionTypeHasBeenSet = true;
    m_dimensionType = value;
  }
  inline ProfileTypeDimension& WithDimensionType(ProfileTypeDimensionType value) {
  ...
  template <typename ValuesT = Aws::Vector<ProfileType>>
  ProfileTypeDimension& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  inline ProfileTypeDimension& AddValues(ProfileType value) {
    m_valuesHasBeenSet = true;
