...
class IncrementalPullConfig {
 public:
  ...
  void SetDatetimeTypeFieldName(DatetimeTypeFieldNameT&& value) {
    m_datetimeTypeFieldNameHasBeenSet = true;
    m_datetimeTypeFieldName = std::forward<DatetimeTypeFieldNameT>(value);
  }
  template <typename DatetimeTypeFieldNameT = Aws::String>
  IncrementalPullConfig& WithDatetimeTypeFieldName(DatetimeTypeFieldNameT&& value) {
    SetDatetimeTypeFieldName(std::forward<DatetimeTypeFieldNameT>(value));
    return *this;
  }
  ///@}
 private:
