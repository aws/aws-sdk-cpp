...
class AppflowIntegrationWorkflowMetrics {
 public:
  ...
  inline AppflowIntegrationWorkflowMetrics& WithRecordsProcessed(long long value) {
  ...
  inline void SetStepsCompleted(long long value) {
    m_stepsCompletedHasBeenSet = true;
    m_stepsCompleted = value;
  }
  inline AppflowIntegrationWorkflowMetrics& WithStepsCompleted(long long value) {
  ...
  inline void SetTotalSteps(long long value) {
    m_totalStepsHasBeenSet = true;
    m_totalSteps = value;
  }
  inline AppflowIntegrationWorkflowMetrics& WithTotalSteps(long long value) {
    SetTotalSteps(value);
    return *this;
  }
  ///@}
