...
class GetCalculatedAttributeDefinitionResult {
 public:
  ...
  AWS_CUSTOMERPROFILES_API GetCalculatedAttributeDefinitionResult& operator=(
  ...
  inline GetCalculatedAttributeDefinitionResult& WithStatistic(Statistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline GetCalculatedAttributeDefinitionResult& WithUseHistoricalData(bool value) {
  ...
  inline GetCalculatedAttributeDefinitionResult& WithStatus(ReadinessStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
