...
class BatchGetCalculatedAttributeForProfileRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename CalculatedAttributeNameT = Aws::String>
  BatchGetCalculatedAttributeForProfileRequest& WithCalculatedAttributeName(CalculatedAttributeNameT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  BatchGetCalculatedAttributeForProfileRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename ProfileIdsT = Aws::Vector<Aws::String>>
  BatchGetCalculatedAttributeForProfileRequest& WithProfileIds(ProfileIdsT&& value) {
    SetProfileIds(std::forward<ProfileIdsT>(value));
    return *this;
  }
  template <typename ProfileIdsT = Aws::String>
  BatchGetCalculatedAttributeForProfileRequest& AddProfileIds(ProfileIdsT&& value) {
    m_profileIdsHasBeenSet = true;
  ...
  template <typename ConditionOverridesT = ConditionOverrides>
  BatchGetCalculatedAttributeForProfileRequest& WithConditionOverrides(ConditionOverridesT&& value) {
