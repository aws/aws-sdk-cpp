...
class Profile {
 public:
  ...
  inline Profile& WithPartyType(PartyType value) {
    SetPartyType(value);
    return *this;
  }
  ///@}
  ...
  inline Profile& WithGender(Gender value) {
    SetGender(value);
    return *this;
  }
  ///@}
  ...
  void SetFoundByItems(FoundByItemsT&& value) {
    ...
    m_foundByItems = std::forward<FoundByItemsT>(value);
  }
  template <typename FoundByItemsT = Aws::Vector<FoundByKeyValue>>
  Profile& WithFoundByItems(FoundByItemsT&& value) {
    SetFoundByItems(std::forward<FoundByItemsT>(value));
    return *this;
  }
  template <typename FoundByItemsT = FoundByKeyValue>
  Profile& AddFoundByItems(FoundByItemsT&& value) {
    m_foundByItemsHasBeenSet = true;
    m_foundByItems.emplace_back(std::forward<FoundByItemsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Profile& WithProfileType(ProfileType value) {
