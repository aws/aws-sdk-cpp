...
class GetSegmentEstimateResult {
 public:
  ...
  void SetEstimateId(EstimateIdT&& value) {
    ...
    m_estimateId = std::forward<EstimateIdT>(value);
  }
  template <typename EstimateIdT = Aws::String>
  GetSegmentEstimateResult& WithEstimateId(EstimateIdT&& value) {
    SetEstimateId(std::forward<EstimateIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(EstimateStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline GetSegmentEstimateResult& WithStatus(EstimateStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetSegmentEstimateResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
