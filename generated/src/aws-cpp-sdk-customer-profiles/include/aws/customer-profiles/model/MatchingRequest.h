...
class MatchingRequest {
 public:
  ...
  inline MatchingRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetJobSchedule(JobScheduleT&& value) {
    ...
    m_jobSchedule = std::forward<JobScheduleT>(value);
  }
  template <typename JobScheduleT = JobSchedule>
  MatchingRequest& WithJobSchedule(JobScheduleT&& value) {
    SetJobSchedule(std::forward<JobScheduleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExportingConfig(ExportingConfigT&& value) {
    ...
    m_exportingConfig = std::forward<ExportingConfigT>(value);
  }
  template <typename ExportingConfigT = ExportingConfig>
  MatchingRequest& WithExportingConfig(ExportingConfigT&& value) {
    SetExportingConfig(std::forward<ExportingConfigT>(value));
    return *this;
  }
  ///@}
 private:
