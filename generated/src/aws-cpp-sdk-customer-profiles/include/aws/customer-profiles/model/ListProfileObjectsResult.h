...
class ListProfileObjectsResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<ListProfileObjectsItem>>
  ListProfileObjectsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = ListProfileObjectsItem>
  ListProfileObjectsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProfileObjectsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProfileObjectsResult& WithRequestId(RequestIdT&& value) {
