...
class FilterAttributeDimension {
 public:
  ...
  inline void SetDimensionType(FilterDimensionType value) {
    m_dimensionTypeHasBeenSet = true;
    m_dimensionType = value;
  }
  inline FilterAttributeDimension& WithDimensionType(FilterDimensionType value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  FilterAttributeDimension& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  FilterAttributeDimension& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
