...
class GetWorkflowStepsRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  GetWorkflowStepsRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename WorkflowIdT = Aws::String>
  GetWorkflowStepsRequest& WithWorkflowId(WorkflowIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetWorkflowStepsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetWorkflowStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
