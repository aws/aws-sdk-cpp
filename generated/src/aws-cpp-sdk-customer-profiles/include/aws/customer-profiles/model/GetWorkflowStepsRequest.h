...
namespace Model
{
  ...
  {
  public:
    AWS_CUSTOMERPROFILES_API GetWorkflowStepsRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    GetWorkflowStepsRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename WorkflowIdT = Aws::String>
    GetWorkflowStepsRequest& WithWorkflowId(WorkflowIdT&& value) { SetWorkflowId(std::forward<WorkflowIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetWorkflowStepsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
