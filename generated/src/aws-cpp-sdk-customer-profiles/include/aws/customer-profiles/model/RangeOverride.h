...
class RangeOverride {
 public:
  ...
  inline RangeOverride& WithStart(int value) {
    SetStart(value);
    return *this;
  }
  ///@}
  ...
  inline RangeOverride& WithEnd(int value) {
    SetEnd(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnit(RangeUnit value) {
    m_unitHasBeenSet = true;
    m_unit = value;
  }
  inline RangeOverride& WithUnit(RangeUnit value) {
    SetUnit(value);
    return *this;
  }
  ///@}
