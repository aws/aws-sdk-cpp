...
class RuleBasedMatchingRequest {
 public:
  ...
  inline RuleBasedMatchingRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAllowedRuleLevelForMerging(int value) {
    m_maxAllowedRuleLevelForMergingHasBeenSet = true;
    m_maxAllowedRuleLevelForMerging = value;
  }
  inline RuleBasedMatchingRequest& WithMaxAllowedRuleLevelForMerging(int value) {
    SetMaxAllowedRuleLevelForMerging(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAllowedRuleLevelForMatching(int value) {
    m_maxAllowedRuleLevelForMatchingHasBeenSet = true;
    m_maxAllowedRuleLevelForMatching = value;
  }
  inline RuleBasedMatchingRequest& WithMaxAllowedRuleLevelForMatching(int value) {
    SetMaxAllowedRuleLevelForMatching(value);
    return *this;
  }
  ///@}
  ...
  void SetAttributeTypesSelector(AttributeTypesSelectorT&& value) {
    ...
    m_attributeTypesSelector = std::forward<AttributeTypesSelectorT>(value);
  }
  template <typename AttributeTypesSelectorT = AttributeTypesSelector>
  RuleBasedMatchingRequest& WithAttributeTypesSelector(AttributeTypesSelectorT&& value) {
    SetAttributeTypesSelector(std::forward<AttributeTypesSelectorT>(value));
    return *this;
  }
  ///@}
