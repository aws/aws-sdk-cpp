...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    GetProfileHistoryRecordRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ProfileIdT = Aws::String>
    GetProfileHistoryRecordRequest& WithProfileId(ProfileIdT&& value) { SetProfileId(std::forward<ProfileIdT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetProfileHistoryRecordRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
