...
class GetAutoMergingPreviewResult {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  GetAutoMergingPreviewResult& WithDomainName(DomainNameT&& value) {
  ...
  inline void SetNumberOfMatchesInSample(long long value) {
    m_numberOfMatchesInSampleHasBeenSet = true;
    m_numberOfMatchesInSample = value;
  }
  inline GetAutoMergingPreviewResult& WithNumberOfMatchesInSample(long long value) {
    SetNumberOfMatchesInSample(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfProfilesInSample(long long value) {
    m_numberOfProfilesInSampleHasBeenSet = true;
    m_numberOfProfilesInSample = value;
  }
  inline GetAutoMergingPreviewResult& WithNumberOfProfilesInSample(long long value) {
    SetNumberOfProfilesInSample(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfProfilesWillBeMerged(long long value) {
    m_numberOfProfilesWillBeMergedHasBeenSet = true;
    m_numberOfProfilesWillBeMerged = value;
  }
  inline GetAutoMergingPreviewResult& WithNumberOfProfilesWillBeMerged(long long value) {
    SetNumberOfProfilesWillBeMerged(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAutoMergingPreviewResult& WithRequestId(RequestIdT&& value) {
