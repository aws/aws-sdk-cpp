...
class GetCalculatedAttributeForProfileRequest : public CustomerProfilesRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  GetCalculatedAttributeForProfileRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename ProfileIdT = Aws::String>
  GetCalculatedAttributeForProfileRequest& WithProfileId(ProfileIdT&& value) {
  ...
  template <typename CalculatedAttributeNameT = Aws::String>
  GetCalculatedAttributeForProfileRequest& WithCalculatedAttributeName(CalculatedAttributeNameT&& value) {
