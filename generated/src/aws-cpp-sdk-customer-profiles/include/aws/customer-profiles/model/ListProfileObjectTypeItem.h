...
class ListProfileObjectTypeItem {
 public:
  ...
  template <typename ObjectTypeNameT = Aws::String>
  ListProfileObjectTypeItem& WithObjectTypeName(ObjectTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListProfileObjectTypeItem& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ListProfileObjectTypeItem& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  ListProfileObjectTypeItem& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  inline ListProfileObjectTypeItem& WithMaxProfileObjectCount(int value) {
  ...
  inline ListProfileObjectTypeItem& WithMaxAvailableProfileObjectCount(int value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  ListProfileObjectTypeItem& WithTags(TagsT&& value) {
