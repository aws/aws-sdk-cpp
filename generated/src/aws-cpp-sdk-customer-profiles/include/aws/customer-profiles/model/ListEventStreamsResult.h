...
class ListEventStreamsResult {
 public:
  AWS_CUSTOMERPROFILES_API ListEventStreamsResult() = default;
  ...
  template <typename ItemsT = Aws::Vector<EventStreamSummary>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<EventStreamSummary>>
  ListEventStreamsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = EventStreamSummary>
  ListEventStreamsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListEventStreamsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEventStreamsResult& WithRequestId(RequestIdT&& value) {
