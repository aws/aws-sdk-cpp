...
class SearchProfilesResult {
 public:
  ...
  template <typename ItemsT = Aws::Vector<Profile>>
  SearchProfilesResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = Profile>
  SearchProfilesResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchProfilesResult& WithRequestId(RequestIdT&& value) {
