...
class ListSegmentDefinitionsResult {
 public:
  AWS_CUSTOMERPROFILES_API ListSegmentDefinitionsResult() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListSegmentDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ItemsT = Aws::Vector<SegmentDefinitionItem>>
  void SetItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
    m_items = std::forward<ItemsT>(value);
  }
  template <typename ItemsT = Aws::Vector<SegmentDefinitionItem>>
  ListSegmentDefinitionsResult& WithItems(ItemsT&& value) {
    SetItems(std::forward<ItemsT>(value));
    return *this;
  }
  template <typename ItemsT = SegmentDefinitionItem>
  ListSegmentDefinitionsResult& AddItems(ItemsT&& value) {
    m_itemsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListSegmentDefinitionsResult& WithRequestId(RequestIdT&& value) {
