...
/**
 */
class StopRecommenderRequest : public CustomerProfilesRequest {
 public:
  AWS_CUSTOMERPROFILES_API StopRecommenderRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  StopRecommenderRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename RecommenderNameT = Aws::String>
  StopRecommenderRequest& WithRecommenderName(RecommenderNameT&& value) {
