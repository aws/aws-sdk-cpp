...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupsT = Aws::Vector<Group>>
    SegmentGroupStructure& WithGroups(GroupsT&& value) { SetGroups(std::forward<GroupsT>(value)); return *this;}
    template<typename GroupsT = Group>
    SegmentGroupStructure& AddGroups(GroupsT&& value) { m_groupsHasBeenSet = true; m_groups.emplace_back(std::forward<GroupsT>(value)); return *this; }
    ///@}
    ...
    inline SegmentGroupStructure& WithInclude(IncludeOptions value) { SetInclude(value); return *this;}
    ///@}
  private:
