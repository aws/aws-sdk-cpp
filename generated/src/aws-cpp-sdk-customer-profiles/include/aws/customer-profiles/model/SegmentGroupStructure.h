...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/SegmentGroupStructure">AWS
   * API Reference</a></p>
   */
  class SegmentGroupStructure
  {
  public:
    AWS_CUSTOMERPROFILES_API SegmentGroupStructure();
    ...
    inline SegmentGroupStructure& WithGroups(const Aws::Vector<Group>& value) { SetGroups(value); return *this;}
    inline SegmentGroupStructure& WithGroups(Aws::Vector<Group>&& value) { SetGroups(std::move(value)); return *this;}
    inline SegmentGroupStructure& AddGroups(const Group& value) { m_groupsHasBeenSet = true; m_groups.push_back(value); return *this; }
    inline SegmentGroupStructure& AddGroups(Group&& value) { m_groupsHasBeenSet = true; m_groups.push_back(std::move(value)); return *this; }
    ///@}

    ///@{
    /**
     * <p>Define whether to include or exclude the profiles that fit the segment
     * criteria.</p>
     */
    ...
    inline SegmentGroupStructure& WithInclude(const IncludeOptions& value) { SetInclude(value); return *this;}
    inline SegmentGroupStructure& WithInclude(IncludeOptions&& value) { SetInclude(std::move(value)); return *this;}
    ///@}
  private:
