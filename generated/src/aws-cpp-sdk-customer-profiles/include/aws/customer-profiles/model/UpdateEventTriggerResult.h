...
class UpdateEventTriggerResult {
 public:
  ...
  template <typename EventTriggerNameT = Aws::String>
  UpdateEventTriggerResult& WithEventTriggerName(EventTriggerNameT&& value) {
  ...
  template <typename ObjectTypeNameT = Aws::String>
  UpdateEventTriggerResult& WithObjectTypeName(ObjectTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateEventTriggerResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EventTriggerConditionsT = Aws::Vector<EventTriggerCondition>>
  UpdateEventTriggerResult& WithEventTriggerConditions(EventTriggerConditionsT&& value) {
  ...
  UpdateEventTriggerResult& AddEventTriggerConditions(EventTriggerConditionsT&& value) {
    m_eventTriggerConditionsHasBeenSet = true;
  ...
  template <typename SegmentFilterT = Aws::String>
  UpdateEventTriggerResult& WithSegmentFilter(SegmentFilterT&& value) {
  ...
  template <typename EventTriggerLimitsT = EventTriggerLimits>
  UpdateEventTriggerResult& WithEventTriggerLimits(EventTriggerLimitsT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateEventTriggerResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename LastUpdatedAtT = Aws::Utils::DateTime>
  UpdateEventTriggerResult& WithLastUpdatedAt(LastUpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateEventTriggerResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEventTriggerResult& WithRequestId(RequestIdT&& value) {
