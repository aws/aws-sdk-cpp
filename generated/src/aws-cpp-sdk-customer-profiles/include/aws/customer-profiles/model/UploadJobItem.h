...
class UploadJobItem {
 public:
  ...
  inline UploadJobItem& WithStatus(UploadJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UploadJobItem& WithStatusReason(StatusReason value) {
  ...
  inline UploadJobItem& WithDataExpiry(int value) {
    SetDataExpiry(value);
    return *this;
  }
  ///@}
