...
namespace CustomerProfiles
{
   ...
   */
  class AWS_CUSTOMERPROFILES_API CustomerProfilesClient : Aws::Client::ClientWithAsyncTemplateMethods<CustomerProfilesClient>,
    smithy::client::AwsSmithyClientT<Aws::CustomerProfiles::SERVICE_NAME,
