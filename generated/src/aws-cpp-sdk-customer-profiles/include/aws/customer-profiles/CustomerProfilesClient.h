...
class AWS_CUSTOMERPROFILES_API CustomerProfilesClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CustomerProfilesClient(const Aws::CustomerProfiles::CustomerProfilesClientConfiguration& clientConfiguration =
  ...
  CustomerProfilesClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<CustomerProfilesEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::CustomerProfiles::CustomerProfilesClientConfiguration& clientConfiguration =
                             Aws::CustomerProfiles::CustomerProfilesClientConfiguration());
  ...
  /**
   * An Async wrapper for AddProfileKey that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddProfileKeyRequestT = Model::AddProfileKeyRequest>
  void AddProfileKeyAsync(const AddProfileKeyRequestT& request, const AddProfileKeyResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetCalculatedAttributeForProfileOutcome BatchGetCalculatedAttributeForProfile(
      const Model::BatchGetCalculatedAttributeForProfileRequest& request) const;

  /**
   * A Callable wrapper for BatchGetCalculatedAttributeForProfile that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchGetCalculatedAttributeForProfileRequestT = Model::BatchGetCalculatedAttributeForProfileRequest>
  Model::BatchGetCalculatedAttributeForProfileOutcomeCallable BatchGetCalculatedAttributeForProfileCallable(
      const BatchGetCalculatedAttributeForProfileRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::BatchGetCalculatedAttributeForProfile, request);
  }

  /**
   * An Async wrapper for BatchGetCalculatedAttributeForProfile that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetCalculatedAttributeForProfileRequestT = Model::BatchGetCalculatedAttributeForProfileRequest>
  void BatchGetCalculatedAttributeForProfileAsync(const BatchGetCalculatedAttributeForProfileRequestT& request,
                                                  const BatchGetCalculatedAttributeForProfileResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BatchGetProfile that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BatchGetProfileRequestT = Model::BatchGetProfileRequest>
  void BatchGetProfileAsync(const BatchGetProfileRequestT& request, const BatchGetProfileResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCalculatedAttributeDefinitionOutcome CreateCalculatedAttributeDefinition(
      const Model::CreateCalculatedAttributeDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateCalculatedAttributeDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateCalculatedAttributeDefinitionRequestT = Model::CreateCalculatedAttributeDefinitionRequest>
  Model::CreateCalculatedAttributeDefinitionOutcomeCallable CreateCalculatedAttributeDefinitionCallable(
      const CreateCalculatedAttributeDefinitionRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::CreateCalculatedAttributeDefinition, request);
  }

  /**
   * An Async wrapper for CreateCalculatedAttributeDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateCalculatedAttributeDefinitionRequestT = Model::CreateCalculatedAttributeDefinitionRequest>
  void CreateCalculatedAttributeDefinitionAsync(const CreateCalculatedAttributeDefinitionRequestT& request,
                                                const CreateCalculatedAttributeDefinitionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDomainLayout that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDomainLayout that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDomainLayoutRequestT = Model::CreateDomainLayoutRequest>
  void CreateDomainLayoutAsync(const CreateDomainLayoutRequestT& request, const CreateDomainLayoutResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEventStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEventStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEventStreamRequestT = Model::CreateEventStreamRequest>
  void CreateEventStreamAsync(const CreateEventStreamRequestT& request, const CreateEventStreamResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEventTrigger that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEventTrigger that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEventTriggerRequestT = Model::CreateEventTriggerRequest>
  void CreateEventTriggerAsync(const CreateEventTriggerRequestT& request, const CreateEventTriggerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateIntegrationWorkflow that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateIntegrationWorkflowRequestT = Model::CreateIntegrationWorkflowRequest>
  Model::CreateIntegrationWorkflowOutcomeCallable CreateIntegrationWorkflowCallable(
      const CreateIntegrationWorkflowRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::CreateIntegrationWorkflow, request);
  }

  /**
   * An Async wrapper for CreateIntegrationWorkflow that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateIntegrationWorkflowRequestT = Model::CreateIntegrationWorkflowRequest>
  void CreateIntegrationWorkflowAsync(const CreateIntegrationWorkflowRequestT& request,
                                      const CreateIntegrationWorkflowResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSegmentDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSegmentDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSegmentDefinitionRequestT = Model::CreateSegmentDefinitionRequest>
  void CreateSegmentDefinitionAsync(const CreateSegmentDefinitionRequestT& request,
                                    const CreateSegmentDefinitionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSegmentEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSegmentEstimate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSegmentEstimateRequestT = Model::CreateSegmentEstimateRequest>
  void CreateSegmentEstimateAsync(const CreateSegmentEstimateRequestT& request, const CreateSegmentEstimateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSegmentSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSegmentSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSegmentSnapshotRequestT = Model::CreateSegmentSnapshotRequest>
  void CreateSegmentSnapshotAsync(const CreateSegmentSnapshotRequestT& request, const CreateSegmentSnapshotResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUploadJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUploadJobRequestT = Model::CreateUploadJobRequest>
  void CreateUploadJobAsync(const CreateUploadJobRequestT& request, const CreateUploadJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCalculatedAttributeDefinitionOutcome DeleteCalculatedAttributeDefinition(
      const Model::DeleteCalculatedAttributeDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteCalculatedAttributeDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteCalculatedAttributeDefinitionRequestT = Model::DeleteCalculatedAttributeDefinitionRequest>
  Model::DeleteCalculatedAttributeDefinitionOutcomeCallable DeleteCalculatedAttributeDefinitionCallable(
      const DeleteCalculatedAttributeDefinitionRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::DeleteCalculatedAttributeDefinition, request);
  }

  /**
   * An Async wrapper for DeleteCalculatedAttributeDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteCalculatedAttributeDefinitionRequestT = Model::DeleteCalculatedAttributeDefinitionRequest>
  void DeleteCalculatedAttributeDefinitionAsync(const DeleteCalculatedAttributeDefinitionRequestT& request,
                                                const DeleteCalculatedAttributeDefinitionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDomainLayout that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDomainLayout that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDomainLayoutRequestT = Model::DeleteDomainLayoutRequest>
  void DeleteDomainLayoutAsync(const DeleteDomainLayoutRequestT& request, const DeleteDomainLayoutResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEventTrigger that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEventTrigger that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEventTriggerRequestT = Model::DeleteEventTriggerRequest>
  void DeleteEventTriggerAsync(const DeleteEventTriggerRequestT& request, const DeleteEventTriggerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProfileKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProfileKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProfileKeyRequestT = Model::DeleteProfileKeyRequest>
  void DeleteProfileKeyAsync(const DeleteProfileKeyRequestT& request, const DeleteProfileKeyResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProfileObject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProfileObject that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProfileObjectRequestT = Model::DeleteProfileObjectRequest>
  void DeleteProfileObjectAsync(const DeleteProfileObjectRequestT& request, const DeleteProfileObjectResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProfileObjectType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProfileObjectType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProfileObjectTypeRequestT = Model::DeleteProfileObjectTypeRequest>
  void DeleteProfileObjectTypeAsync(const DeleteProfileObjectTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteSegmentDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSegmentDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSegmentDefinitionRequestT = Model::DeleteSegmentDefinitionRequest>
  void DeleteSegmentDefinitionAsync(const DeleteSegmentDefinitionRequestT& request,
                                    const DeleteSegmentDefinitionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetectProfileObjectType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetectProfileObjectType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetectProfileObjectTypeRequestT = Model::DetectProfileObjectTypeRequest>
  void DetectProfileObjectTypeAsync(const DetectProfileObjectTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAutoMergingPreview that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAutoMergingPreview that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAutoMergingPreviewRequestT = Model::GetAutoMergingPreviewRequest>
  void GetAutoMergingPreviewAsync(const GetAutoMergingPreviewRequestT& request, const GetAutoMergingPreviewResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCalculatedAttributeDefinitionOutcome GetCalculatedAttributeDefinition(
      const Model::GetCalculatedAttributeDefinitionRequest& request) const;

  /**
   * A Callable wrapper for GetCalculatedAttributeDefinition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCalculatedAttributeDefinitionRequestT = Model::GetCalculatedAttributeDefinitionRequest>
  Model::GetCalculatedAttributeDefinitionOutcomeCallable GetCalculatedAttributeDefinitionCallable(
      const GetCalculatedAttributeDefinitionRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::GetCalculatedAttributeDefinition, request);
  }

  /**
   * An Async wrapper for GetCalculatedAttributeDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCalculatedAttributeDefinitionRequestT = Model::GetCalculatedAttributeDefinitionRequest>
  void GetCalculatedAttributeDefinitionAsync(const GetCalculatedAttributeDefinitionRequestT& request,
                                             const GetCalculatedAttributeDefinitionResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCalculatedAttributeForProfileOutcome GetCalculatedAttributeForProfile(
      const Model::GetCalculatedAttributeForProfileRequest& request) const;

  /**
   * A Callable wrapper for GetCalculatedAttributeForProfile that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetCalculatedAttributeForProfileRequestT = Model::GetCalculatedAttributeForProfileRequest>
  Model::GetCalculatedAttributeForProfileOutcomeCallable GetCalculatedAttributeForProfileCallable(
      const GetCalculatedAttributeForProfileRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::GetCalculatedAttributeForProfile, request);
  }

  /**
   * An Async wrapper for GetCalculatedAttributeForProfile that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCalculatedAttributeForProfileRequestT = Model::GetCalculatedAttributeForProfileRequest>
  void GetCalculatedAttributeForProfileAsync(const GetCalculatedAttributeForProfileRequestT& request,
                                             const GetCalculatedAttributeForProfileResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDomainLayout that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDomainLayoutRequestT = Model::GetDomainLayoutRequest>
  void GetDomainLayoutAsync(const GetDomainLayoutRequestT& request, const GetDomainLayoutResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEventTrigger that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEventTriggerRequestT = Model::GetEventTriggerRequest>
  void GetEventTriggerAsync(const GetEventTriggerRequestT& request, const GetEventTriggerResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetIdentityResolutionJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetIdentityResolutionJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetIdentityResolutionJobRequestT = Model::GetIdentityResolutionJobRequest>
  void GetIdentityResolutionJobAsync(const GetIdentityResolutionJobRequestT& request,
                                     const GetIdentityResolutionJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMatches that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMatchesRequestT = Model::GetMatchesRequest>
  void GetMatchesAsync(const GetMatchesRequestT& request, const GetMatchesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProfileHistoryRecord that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProfileHistoryRecord that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProfileHistoryRecordRequestT = Model::GetProfileHistoryRecordRequest>
  void GetProfileHistoryRecordAsync(const GetProfileHistoryRecordRequestT& request,
                                    const GetProfileHistoryRecordResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetProfileObjectType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetProfileObjectType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProfileObjectTypeRequestT = Model::GetProfileObjectTypeRequest>
  void GetProfileObjectTypeAsync(const GetProfileObjectTypeRequestT& request, const GetProfileObjectTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetProfileObjectTypeTemplateOutcome GetProfileObjectTypeTemplate(
      const Model::GetProfileObjectTypeTemplateRequest& request) const;

  /**
   * A Callable wrapper for GetProfileObjectTypeTemplate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetProfileObjectTypeTemplateRequestT = Model::GetProfileObjectTypeTemplateRequest>
  Model::GetProfileObjectTypeTemplateOutcomeCallable GetProfileObjectTypeTemplateCallable(
      const GetProfileObjectTypeTemplateRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::GetProfileObjectTypeTemplate, request);
  }

  /**
   * An Async wrapper for GetProfileObjectTypeTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetProfileObjectTypeTemplateRequestT = Model::GetProfileObjectTypeTemplateRequest>
  void GetProfileObjectTypeTemplateAsync(const GetProfileObjectTypeTemplateRequestT& request,
  ...
  /**
   * A Callable wrapper for GetSegmentDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSegmentDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSegmentDefinitionRequestT = Model::GetSegmentDefinitionRequest>
  void GetSegmentDefinitionAsync(const GetSegmentDefinitionRequestT& request, const GetSegmentDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSegmentEstimate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSegmentEstimate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSegmentEstimateRequestT = Model::GetSegmentEstimateRequest>
  void GetSegmentEstimateAsync(const GetSegmentEstimateRequestT& request, const GetSegmentEstimateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSegmentMembership that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSegmentMembership that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSegmentMembershipRequestT = Model::GetSegmentMembershipRequest>
  void GetSegmentMembershipAsync(const GetSegmentMembershipRequestT& request, const GetSegmentMembershipResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSegmentSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSegmentSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSegmentSnapshotRequestT = Model::GetSegmentSnapshotRequest>
  void GetSegmentSnapshotAsync(const GetSegmentSnapshotRequestT& request, const GetSegmentSnapshotResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSimilarProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSimilarProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSimilarProfilesRequestT = Model::GetSimilarProfilesRequest>
  ...
  /**
   * An Async wrapper for GetUploadJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetUploadJobRequestT = Model::GetUploadJobRequest>
  void GetUploadJobAsync(const GetUploadJobRequestT& request, const GetUploadJobResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetUploadJobPath that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetUploadJobPath that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetUploadJobPathRequestT = Model::GetUploadJobPathRequest>
  void GetUploadJobPathAsync(const GetUploadJobPathRequestT& request, const GetUploadJobPathResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetWorkflowSteps that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetWorkflowSteps that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetWorkflowStepsRequestT = Model::GetWorkflowStepsRequest>
  void GetWorkflowStepsAsync(const GetWorkflowStepsRequestT& request, const GetWorkflowStepsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccountIntegrations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccountIntegrations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAccountIntegrationsRequestT = Model::ListAccountIntegrationsRequest>
  void ListAccountIntegrationsAsync(const ListAccountIntegrationsRequestT& request,
                                    const ListAccountIntegrationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCalculatedAttributeDefinitionsOutcome ListCalculatedAttributeDefinitions(
      const Model::ListCalculatedAttributeDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for ListCalculatedAttributeDefinitions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCalculatedAttributeDefinitionsRequestT = Model::ListCalculatedAttributeDefinitionsRequest>
  Model::ListCalculatedAttributeDefinitionsOutcomeCallable ListCalculatedAttributeDefinitionsCallable(
      const ListCalculatedAttributeDefinitionsRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::ListCalculatedAttributeDefinitions, request);
  }

  /**
   * An Async wrapper for ListCalculatedAttributeDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCalculatedAttributeDefinitionsRequestT = Model::ListCalculatedAttributeDefinitionsRequest>
  void ListCalculatedAttributeDefinitionsAsync(const ListCalculatedAttributeDefinitionsRequestT& request,
                                               const ListCalculatedAttributeDefinitionsResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCalculatedAttributesForProfileOutcome ListCalculatedAttributesForProfile(
      const Model::ListCalculatedAttributesForProfileRequest& request) const;

  /**
   * A Callable wrapper for ListCalculatedAttributesForProfile that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCalculatedAttributesForProfileRequestT = Model::ListCalculatedAttributesForProfileRequest>
  Model::ListCalculatedAttributesForProfileOutcomeCallable ListCalculatedAttributesForProfileCallable(
      const ListCalculatedAttributesForProfileRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::ListCalculatedAttributesForProfile, request);
  }

  /**
   * An Async wrapper for ListCalculatedAttributesForProfile that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCalculatedAttributesForProfileRequestT = Model::ListCalculatedAttributesForProfileRequest>
  void ListCalculatedAttributesForProfileAsync(const ListCalculatedAttributesForProfileRequestT& request,
                                               const ListCalculatedAttributesForProfileResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDomainLayouts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDomainLayouts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDomainLayoutsRequestT = Model::ListDomainLayoutsRequest>
  void ListDomainLayoutsAsync(const ListDomainLayoutsRequestT& request, const ListDomainLayoutsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEventStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventStreams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEventStreamsRequestT = Model::ListEventStreamsRequest>
  void ListEventStreamsAsync(const ListEventStreamsRequestT& request, const ListEventStreamsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEventTriggers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEventTriggers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEventTriggersRequestT = Model::ListEventTriggersRequest>
  void ListEventTriggersAsync(const ListEventTriggersRequestT& request, const ListEventTriggersResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListIdentityResolutionJobsOutcome ListIdentityResolutionJobs(
      const Model::ListIdentityResolutionJobsRequest& request) const;

  /**
   * A Callable wrapper for ListIdentityResolutionJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListIdentityResolutionJobsRequestT = Model::ListIdentityResolutionJobsRequest>
  Model::ListIdentityResolutionJobsOutcomeCallable ListIdentityResolutionJobsCallable(
      const ListIdentityResolutionJobsRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::ListIdentityResolutionJobs, request);
  }

  /**
   * An Async wrapper for ListIdentityResolutionJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIdentityResolutionJobsRequestT = Model::ListIdentityResolutionJobsRequest>
  void ListIdentityResolutionJobsAsync(const ListIdentityResolutionJobsRequestT& request,
                                       const ListIdentityResolutionJobsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListObjectTypeAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListObjectTypeAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListObjectTypeAttributesRequestT = Model::ListObjectTypeAttributesRequest>
  void ListObjectTypeAttributesAsync(const ListObjectTypeAttributesRequestT& request,
                                     const ListObjectTypeAttributesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProfileAttributeValuesOutcome ListProfileAttributeValues(
      const Model::ListProfileAttributeValuesRequest& request) const;

  /**
   * A Callable wrapper for ListProfileAttributeValues that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListProfileAttributeValuesRequestT = Model::ListProfileAttributeValuesRequest>
  Model::ListProfileAttributeValuesOutcomeCallable ListProfileAttributeValuesCallable(
      const ListProfileAttributeValuesRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::ListProfileAttributeValues, request);
  }

  /**
   * An Async wrapper for ListProfileAttributeValues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfileAttributeValuesRequestT = Model::ListProfileAttributeValuesRequest>
  void ListProfileAttributeValuesAsync(const ListProfileAttributeValuesRequestT& request,
                                       const ListProfileAttributeValuesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfileHistoryRecords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListProfileHistoryRecordsRequestT = Model::ListProfileHistoryRecordsRequest>
  Model::ListProfileHistoryRecordsOutcomeCallable ListProfileHistoryRecordsCallable(
      const ListProfileHistoryRecordsRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::ListProfileHistoryRecords, request);
  }

  /**
   * An Async wrapper for ListProfileHistoryRecords that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfileHistoryRecordsRequestT = Model::ListProfileHistoryRecordsRequest>
  void ListProfileHistoryRecordsAsync(const ListProfileHistoryRecordsRequestT& request,
                                      const ListProfileHistoryRecordsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListProfileObjectTypeTemplatesOutcome ListProfileObjectTypeTemplates(
      const Model::ListProfileObjectTypeTemplatesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListProfileObjectTypeTemplates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListProfileObjectTypeTemplatesRequestT = Model::ListProfileObjectTypeTemplatesRequest>
  Model::ListProfileObjectTypeTemplatesOutcomeCallable ListProfileObjectTypeTemplatesCallable(
      const ListProfileObjectTypeTemplatesRequestT& request = {}) const {
    return SubmitCallable(&CustomerProfilesClient::ListProfileObjectTypeTemplates, request);
  }

  /**
   * An Async wrapper for ListProfileObjectTypeTemplates that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListProfileObjectTypeTemplatesRequestT = Model::ListProfileObjectTypeTemplatesRequest>
  void ListProfileObjectTypeTemplatesAsync(const ListProfileObjectTypeTemplatesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListProfileObjectTypeTemplatesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProfileObjectTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfileObjectTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProfileObjectTypesRequestT = Model::ListProfileObjectTypesRequest>
  void ListProfileObjectTypesAsync(const ListProfileObjectTypesRequestT& request,
                                   const ListProfileObjectTypesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProfileObjects that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProfileObjects that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProfileObjectsRequestT = Model::ListProfileObjectsRequest>
  ...
  /**
   * A Callable wrapper for ListRuleBasedMatches that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRuleBasedMatches that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRuleBasedMatchesRequestT = Model::ListRuleBasedMatchesRequest>
  void ListRuleBasedMatchesAsync(const ListRuleBasedMatchesRequestT& request, const ListRuleBasedMatchesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSegmentDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSegmentDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSegmentDefinitionsRequestT = Model::ListSegmentDefinitionsRequest>
  void ListSegmentDefinitionsAsync(const ListSegmentDefinitionsRequestT& request,
                                   const ListSegmentDefinitionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListUploadJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListUploadJobsRequestT = Model::ListUploadJobsRequest>
  void ListUploadJobsAsync(const ListUploadJobsRequestT& request, const ListUploadJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for MergeProfiles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename MergeProfilesRequestT = Model::MergeProfilesRequest>
  void MergeProfilesAsync(const MergeProfilesRequestT& request, const MergeProfilesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutProfileObject that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutProfileObject that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutProfileObjectRequestT = Model::PutProfileObjectRequest>
  void PutProfileObjectAsync(const PutProfileObjectRequestT& request, const PutProfileObjectResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutProfileObjectType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutProfileObjectType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutProfileObjectTypeRequestT = Model::PutProfileObjectTypeRequest>
  ...
  /**
   * An Async wrapper for SearchProfiles that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SearchProfilesRequestT = Model::SearchProfilesRequest>
  void SearchProfilesAsync(const SearchProfilesRequestT& request, const SearchProfilesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartUploadJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartUploadJobRequestT = Model::StartUploadJobRequest>
  ...
  /**
   * An Async wrapper for StopUploadJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopUploadJobRequestT = Model::StopUploadJobRequest>
  void StopUploadJobAsync(const StopUploadJobRequestT& request, const StopUploadJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCalculatedAttributeDefinitionOutcome UpdateCalculatedAttributeDefinition(
      const Model::UpdateCalculatedAttributeDefinitionRequest& request) const;

  /**
   * A Callable wrapper for UpdateCalculatedAttributeDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateCalculatedAttributeDefinitionRequestT = Model::UpdateCalculatedAttributeDefinitionRequest>
  Model::UpdateCalculatedAttributeDefinitionOutcomeCallable UpdateCalculatedAttributeDefinitionCallable(
      const UpdateCalculatedAttributeDefinitionRequestT& request) const {
    return SubmitCallable(&CustomerProfilesClient::UpdateCalculatedAttributeDefinition, request);
  }

  /**
   * An Async wrapper for UpdateCalculatedAttributeDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateCalculatedAttributeDefinitionRequestT = Model::UpdateCalculatedAttributeDefinitionRequest>
  void UpdateCalculatedAttributeDefinitionAsync(const UpdateCalculatedAttributeDefinitionRequestT& request,
                                                const UpdateCalculatedAttributeDefinitionResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainLayout that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainLayout that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDomainLayoutRequestT = Model::UpdateDomainLayoutRequest>
  void UpdateDomainLayoutAsync(const UpdateDomainLayoutRequestT& request, const UpdateDomainLayoutResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEventTrigger that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEventTrigger that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEventTriggerRequestT = Model::UpdateEventTriggerRequest>
  void UpdateEventTriggerAsync(const UpdateEventTriggerRequestT& request, const UpdateEventTriggerResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
