...
namespace Model
{
  ...
  {
  public:
    AWS_FIREHOSE_API UntagDeliveryStreamResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UntagDeliveryStreamResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
