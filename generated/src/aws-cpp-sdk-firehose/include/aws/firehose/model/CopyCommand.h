...
class CopyCommand {
 public:
  ...
  void SetDataTableName(DataTableNameT&& value) {
    ...
    m_dataTableName = std::forward<DataTableNameT>(value);
  }
  template <typename DataTableNameT = Aws::String>
  CopyCommand& WithDataTableName(DataTableNameT&& value) {
    SetDataTableName(std::forward<DataTableNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataTableColumns(DataTableColumnsT&& value) {
    ...
    m_dataTableColumns = std::forward<DataTableColumnsT>(value);
  }
  template <typename DataTableColumnsT = Aws::String>
  CopyCommand& WithDataTableColumns(DataTableColumnsT&& value) {
    SetDataTableColumns(std::forward<DataTableColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCopyOptions(CopyOptionsT&& value) {
    ...
    m_copyOptions = std::forward<CopyOptionsT>(value);
  }
  template <typename CopyOptionsT = Aws::String>
  CopyCommand& WithCopyOptions(CopyOptionsT&& value) {
    SetCopyOptions(std::forward<CopyOptionsT>(value));
    return *this;
  }
  ///@}
 private:
