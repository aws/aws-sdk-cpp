...
class AmazonOpenSearchServerlessBufferingHints {
 public:
  ...
  inline void SetIntervalInSeconds(int value) {
    m_intervalInSecondsHasBeenSet = true;
    m_intervalInSeconds = value;
  }
  inline AmazonOpenSearchServerlessBufferingHints& WithIntervalInSeconds(int value) {
  ...
  inline void SetSizeInMBs(int value) {
    m_sizeInMBsHasBeenSet = true;
    m_sizeInMBs = value;
  }
  inline AmazonOpenSearchServerlessBufferingHints& WithSizeInMBs(int value) {
    SetSizeInMBs(value);
    return *this;
  }
  ///@}
