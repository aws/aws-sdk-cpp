...
class Serializer {
 public:
  ...
  void SetParquetSerDe(ParquetSerDeT&& value) {
    ...
    m_parquetSerDe = std::forward<ParquetSerDeT>(value);
  }
  template <typename ParquetSerDeT = ParquetSerDe>
  Serializer& WithParquetSerDe(ParquetSerDeT&& value) {
    SetParquetSerDe(std::forward<ParquetSerDeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrcSerDe(OrcSerDeT&& value) {
    ...
    m_orcSerDe = std::forward<OrcSerDeT>(value);
  }
  template <typename OrcSerDeT = OrcSerDe>
  Serializer& WithOrcSerDe(OrcSerDeT&& value) {
    SetOrcSerDe(std::forward<OrcSerDeT>(value));
    return *this;
  }
  ///@}
 private:
