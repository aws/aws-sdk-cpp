...
class SplunkDestinationConfiguration {
 public:
  ...
  inline SplunkDestinationConfiguration& WithHECEndpointType(HECEndpointType value) {
  ...
  inline SplunkDestinationConfiguration& WithHECAcknowledgmentTimeoutInSeconds(int value) {
  ...
  inline SplunkDestinationConfiguration& WithS3BackupMode(SplunkS3BackupMode value) {
