...
namespace Model
{
  ...
  public:
    ...
    ///@{
    /**
     * <p> Specifies the name of the Apache Iceberg Table. </p> <p>Amazon Data Firehose
    ...
    ///@{
    /**
     * <p> The name of the Apache Iceberg database. </p> <p>Amazon Data Firehose is in
     ...
     * destination. </p> <p>Amazon Data Firehose is in preview release and is subject
     * to change.</p>
     */
