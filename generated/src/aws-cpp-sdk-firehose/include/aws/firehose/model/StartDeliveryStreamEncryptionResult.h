...
namespace Model
{
  ...
  {
  public:
    AWS_FIREHOSE_API StartDeliveryStreamEncryptionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StartDeliveryStreamEncryptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
