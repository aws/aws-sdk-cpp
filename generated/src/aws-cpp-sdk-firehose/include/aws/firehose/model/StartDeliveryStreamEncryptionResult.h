...
namespace Model
{
  ...
  public:
    ...
    inline StartDeliveryStreamEncryptionResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline StartDeliveryStreamEncryptionResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline StartDeliveryStreamEncryptionResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
