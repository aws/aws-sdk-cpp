...
class DatabaseSourceConfiguration {
 public:
  ...
  inline void SetType(DatabaseType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DatabaseSourceConfiguration& WithType(DatabaseType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline DatabaseSourceConfiguration& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSSLMode(SSLMode value) {
    m_sSLModeHasBeenSet = true;
    m_sSLMode = value;
  }
  inline DatabaseSourceConfiguration& WithSSLMode(SSLMode value) {
    SetSSLMode(value);
    return *this;
  }
  ///@}
  ...
  void SetSnapshotWatermarkTable(SnapshotWatermarkTableT&& value) {
    ...
    m_snapshotWatermarkTable = std::forward<SnapshotWatermarkTableT>(value);
  }
  template <typename SnapshotWatermarkTableT = Aws::String>
  DatabaseSourceConfiguration& WithSnapshotWatermarkTable(SnapshotWatermarkTableT&& value) {
    SetSnapshotWatermarkTable(std::forward<SnapshotWatermarkTableT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const DatabaseSourceAuthenticationConfiguration& GetDatabaseSourceAuthenticationConfiguration() const {
    return m_databaseSourceAuthenticationConfiguration;
  }
  ...
  void SetDatabaseSourceAuthenticationConfiguration(DatabaseSourceAuthenticationConfigurationT&& value) {
    ...
    m_databaseSourceAuthenticationConfiguration = std::forward<DatabaseSourceAuthenticationConfigurationT>(value);
  }
  template <typename DatabaseSourceAuthenticationConfigurationT = DatabaseSourceAuthenticationConfiguration>
  DatabaseSourceConfiguration& WithDatabaseSourceAuthenticationConfiguration(DatabaseSourceAuthenticationConfigurationT&& value) {
    SetDatabaseSourceAuthenticationConfiguration(std::forward<DatabaseSourceAuthenticationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabaseSourceVPCConfiguration(DatabaseSourceVPCConfigurationT&& value) {
    ...
    m_databaseSourceVPCConfiguration = std::forward<DatabaseSourceVPCConfigurationT>(value);
  }
  template <typename DatabaseSourceVPCConfigurationT = DatabaseSourceVPCConfiguration>
  DatabaseSourceConfiguration& WithDatabaseSourceVPCConfiguration(DatabaseSourceVPCConfigurationT&& value) {
    SetDatabaseSourceVPCConfiguration(std::forward<DatabaseSourceVPCConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
