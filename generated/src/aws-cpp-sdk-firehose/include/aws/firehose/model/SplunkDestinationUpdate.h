...
class SplunkDestinationUpdate {
 public:
  ...
  void SetHECEndpoint(HECEndpointT&& value) {
    ...
    m_hECEndpoint = std::forward<HECEndpointT>(value);
  }
  template <typename HECEndpointT = Aws::String>
  SplunkDestinationUpdate& WithHECEndpoint(HECEndpointT&& value) {
    SetHECEndpoint(std::forward<HECEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHECEndpointType(HECEndpointType value) {
    m_hECEndpointTypeHasBeenSet = true;
    m_hECEndpointType = value;
  }
  inline SplunkDestinationUpdate& WithHECEndpointType(HECEndpointType value) {
    SetHECEndpointType(value);
    return *this;
  }
  ///@}
  ...
  void SetHECToken(HECTokenT&& value) {
    ...
    m_hECToken = std::forward<HECTokenT>(value);
  }
  template <typename HECTokenT = Aws::String>
  SplunkDestinationUpdate& WithHECToken(HECTokenT&& value) {
    SetHECToken(std::forward<HECTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHECAcknowledgmentTimeoutInSeconds(int value) {
    m_hECAcknowledgmentTimeoutInSecondsHasBeenSet = true;
    m_hECAcknowledgmentTimeoutInSeconds = value;
  }
  inline SplunkDestinationUpdate& WithHECAcknowledgmentTimeoutInSeconds(int value) {
    SetHECAcknowledgmentTimeoutInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetS3BackupMode(SplunkS3BackupMode value) {
    m_s3BackupModeHasBeenSet = true;
    m_s3BackupMode = value;
  }
  inline SplunkDestinationUpdate& WithS3BackupMode(SplunkS3BackupMode value) {
