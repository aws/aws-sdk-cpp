...
class ListTagsForDeliveryStreamRequest : public FirehoseRequest {
 public:
  ...
  template <typename DeliveryStreamNameT = Aws::String>
  ListTagsForDeliveryStreamRequest& WithDeliveryStreamName(DeliveryStreamNameT&& value) {
  ...
  template <typename ExclusiveStartTagKeyT = Aws::String>
  ListTagsForDeliveryStreamRequest& WithExclusiveStartTagKey(ExclusiveStartTagKeyT&& value) {
  ...
  inline ListTagsForDeliveryStreamRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
