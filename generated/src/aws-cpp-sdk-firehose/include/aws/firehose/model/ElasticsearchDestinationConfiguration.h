...
class ElasticsearchDestinationConfiguration {
 public:
  ...
  inline ElasticsearchDestinationConfiguration& WithIndexRotationPeriod(ElasticsearchIndexRotationPeriod value) {
  ...
  inline void SetS3BackupMode(ElasticsearchS3BackupMode value) {
    m_s3BackupModeHasBeenSet = true;
    m_s3BackupMode = value;
  }
  inline ElasticsearchDestinationConfiguration& WithS3BackupMode(ElasticsearchS3BackupMode value) {
