...
class AmazonopensearchserviceBufferingHints {
 public:
  AWS_FIREHOSE_API AmazonopensearchserviceBufferingHints() = default;
  ...
  inline AmazonopensearchserviceBufferingHints& WithIntervalInSeconds(int value) {
  ...
  inline AmazonopensearchserviceBufferingHints& WithSizeInMBs(int value) {
    SetSizeInMBs(value);
    return *this;
  }
  ///@}
