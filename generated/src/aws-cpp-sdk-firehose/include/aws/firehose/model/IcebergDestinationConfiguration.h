...
class IcebergDestinationConfiguration {
 public:
   ...
   */
  inline const Aws::Vector<DestinationTableConfiguration>& GetDestinationTableConfigurationList() const {
    return m_destinationTableConfigurationList;
  }
  ...
  void SetDestinationTableConfigurationList(DestinationTableConfigurationListT&& value) {
    ...
    m_destinationTableConfigurationList = std::forward<DestinationTableConfigurationListT>(value);
  }
  template <typename DestinationTableConfigurationListT = Aws::Vector<DestinationTableConfiguration>>
  IcebergDestinationConfiguration& WithDestinationTableConfigurationList(DestinationTableConfigurationListT&& value) {
    SetDestinationTableConfigurationList(std::forward<DestinationTableConfigurationListT>(value));
    return *this;
  }
  template <typename DestinationTableConfigurationListT = DestinationTableConfiguration>
  IcebergDestinationConfiguration& AddDestinationTableConfigurationList(DestinationTableConfigurationListT&& value) {
    m_destinationTableConfigurationListHasBeenSet = true;
    m_destinationTableConfigurationList.emplace_back(std::forward<DestinationTableConfigurationListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSchemaEvolutionConfiguration(SchemaEvolutionConfigurationT&& value) {
    ...
    m_schemaEvolutionConfiguration = std::forward<SchemaEvolutionConfigurationT>(value);
  }
  template <typename SchemaEvolutionConfigurationT = SchemaEvolutionConfiguration>
  IcebergDestinationConfiguration& WithSchemaEvolutionConfiguration(SchemaEvolutionConfigurationT&& value) {
    SetSchemaEvolutionConfiguration(std::forward<SchemaEvolutionConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTableCreationConfiguration(TableCreationConfigurationT&& value) {
    ...
    m_tableCreationConfiguration = std::forward<TableCreationConfigurationT>(value);
  }
  template <typename TableCreationConfigurationT = TableCreationConfiguration>
  IcebergDestinationConfiguration& WithTableCreationConfiguration(TableCreationConfigurationT&& value) {
    SetTableCreationConfiguration(std::forward<TableCreationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BufferingHintsT = BufferingHints>
  IcebergDestinationConfiguration& WithBufferingHints(BufferingHintsT&& value) {
  ...
  template <typename CloudWatchLoggingOptionsT = CloudWatchLoggingOptions>
  IcebergDestinationConfiguration& WithCloudWatchLoggingOptions(CloudWatchLoggingOptionsT&& value) {
  ...
  template <typename ProcessingConfigurationT = ProcessingConfiguration>
  IcebergDestinationConfiguration& WithProcessingConfiguration(ProcessingConfigurationT&& value) {
  ...
  inline void SetS3BackupMode(IcebergS3BackupMode value) {
    m_s3BackupModeHasBeenSet = true;
    m_s3BackupMode = value;
  }
  inline IcebergDestinationConfiguration& WithS3BackupMode(IcebergS3BackupMode value) {
  ...
  template <typename RetryOptionsT = RetryOptions>
  IcebergDestinationConfiguration& WithRetryOptions(RetryOptionsT&& value) {
  ...
  template <typename RoleARNT = Aws::String>
  IcebergDestinationConfiguration& WithRoleARN(RoleARNT&& value) {
  ...
  void SetCatalogConfiguration(CatalogConfigurationT&& value) {
    ...
    m_catalogConfiguration = std::forward<CatalogConfigurationT>(value);
  }
  template <typename CatalogConfigurationT = CatalogConfiguration>
  IcebergDestinationConfiguration& WithCatalogConfiguration(CatalogConfigurationT&& value) {
    SetCatalogConfiguration(std::forward<CatalogConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename S3ConfigurationT = S3DestinationConfiguration>
  IcebergDestinationConfiguration& WithS3Configuration(S3ConfigurationT&& value) {
