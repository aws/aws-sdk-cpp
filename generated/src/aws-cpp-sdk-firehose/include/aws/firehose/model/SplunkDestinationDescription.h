...
class SplunkDestinationDescription {
 public:
  ...
  inline SplunkDestinationDescription& WithHECEndpointType(HECEndpointType value) {
  ...
  inline SplunkDestinationDescription& WithHECAcknowledgmentTimeoutInSeconds(int value) {
  ...
  inline SplunkDestinationDescription& WithS3BackupMode(SplunkS3BackupMode value) {
