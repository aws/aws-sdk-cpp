...
class ListTagsForDeliveryStreamResult {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ListTagsForDeliveryStreamResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ListTagsForDeliveryStreamResult& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline void SetHasMoreTags(bool value) {
    m_hasMoreTagsHasBeenSet = true;
    m_hasMoreTags = value;
  }
  inline ListTagsForDeliveryStreamResult& WithHasMoreTags(bool value) {
    SetHasMoreTags(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTagsForDeliveryStreamResult& WithRequestId(RequestIdT&& value) {
