...
namespace Model
{
  ...
  {
  public:
    AWS_FIREHOSE_API StopDeliveryStreamEncryptionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopDeliveryStreamEncryptionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
