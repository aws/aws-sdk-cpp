...
class MSKSourceDescription {
 public:
  ...
  void SetMSKClusterARN(MSKClusterARNT&& value) {
    ...
    m_mSKClusterARN = std::forward<MSKClusterARNT>(value);
  }
  template <typename MSKClusterARNT = Aws::String>
  MSKSourceDescription& WithMSKClusterARN(MSKClusterARNT&& value) {
    SetMSKClusterARN(std::forward<MSKClusterARNT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeliveryStartTimestamp(DeliveryStartTimestampT&& value) {
    ...
    m_deliveryStartTimestamp = std::forward<DeliveryStartTimestampT>(value);
  }
  template <typename DeliveryStartTimestampT = Aws::Utils::DateTime>
  MSKSourceDescription& WithDeliveryStartTimestamp(DeliveryStartTimestampT&& value) {
    SetDeliveryStartTimestamp(std::forward<DeliveryStartTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReadFromTimestamp(ReadFromTimestampT&& value) {
    ...
    m_readFromTimestamp = std::forward<ReadFromTimestampT>(value);
  }
  template <typename ReadFromTimestampT = Aws::Utils::DateTime>
  MSKSourceDescription& WithReadFromTimestamp(ReadFromTimestampT&& value) {
    SetReadFromTimestamp(std::forward<ReadFromTimestampT>(value));
    return *this;
  }
  ///@}
 private:
