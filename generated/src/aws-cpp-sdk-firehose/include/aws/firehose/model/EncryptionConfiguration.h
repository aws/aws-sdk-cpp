...
class EncryptionConfiguration {
 public:
  ...
  inline void SetNoEncryptionConfig(NoEncryptionConfig value) {
    m_noEncryptionConfigHasBeenSet = true;
    m_noEncryptionConfig = value;
  }
  inline EncryptionConfiguration& WithNoEncryptionConfig(NoEncryptionConfig value) {
    SetNoEncryptionConfig(value);
    return *this;
  }
  ///@}
  ...
  void SetKMSEncryptionConfig(KMSEncryptionConfigT&& value) {
    ...
    m_kMSEncryptionConfig = std::forward<KMSEncryptionConfigT>(value);
  }
  template <typename KMSEncryptionConfigT = KMSEncryptionConfig>
  EncryptionConfiguration& WithKMSEncryptionConfig(KMSEncryptionConfigT&& value) {
    SetKMSEncryptionConfig(std::forward<KMSEncryptionConfigT>(value));
    return *this;
  }
  ///@}
 private:
