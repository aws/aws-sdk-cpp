...
namespace Model
{
  ...
  {
  public:
    AWS_FIREHOSE_API DeleteDeliveryStreamResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDeliveryStreamResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
