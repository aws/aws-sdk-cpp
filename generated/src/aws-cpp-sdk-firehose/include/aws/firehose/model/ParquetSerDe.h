...
class ParquetSerDe {
 public:
  ...
  inline ParquetSerDe& WithBlockSizeBytes(int value) {
  ...
  inline void SetPageSizeBytes(int value) {
    m_pageSizeBytesHasBeenSet = true;
    m_pageSizeBytes = value;
  }
  inline ParquetSerDe& WithPageSizeBytes(int value) {
    SetPageSizeBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCompression(ParquetCompression value) {
    m_compressionHasBeenSet = true;
    m_compression = value;
  }
  inline ParquetSerDe& WithCompression(ParquetCompression value) {
  ...
  inline void SetEnableDictionaryCompression(bool value) {
    m_enableDictionaryCompressionHasBeenSet = true;
    m_enableDictionaryCompression = value;
  }
  inline ParquetSerDe& WithEnableDictionaryCompression(bool value) {
    SetEnableDictionaryCompression(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxPaddingBytes(int value) {
    m_maxPaddingBytesHasBeenSet = true;
    m_maxPaddingBytes = value;
  }
  inline ParquetSerDe& WithMaxPaddingBytes(int value) {
    SetMaxPaddingBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWriterVersion(ParquetWriterVersion value) {
    m_writerVersionHasBeenSet = true;
    m_writerVersion = value;
  }
  inline ParquetSerDe& WithWriterVersion(ParquetWriterVersion value) {
