...
class CreateDeliveryStreamRequest : public FirehoseRequest {
 public:
  ...
  inline CreateDeliveryStreamRequest& WithDeliveryStreamType(DeliveryStreamType value) {
  ...
  void SetDirectPutSourceConfiguration(DirectPutSourceConfigurationT&& value) {
    m_directPutSourceConfigurationHasBeenSet = true;
    m_directPutSourceConfiguration = std::forward<DirectPutSourceConfigurationT>(value);
  }
  template <typename DirectPutSourceConfigurationT = DirectPutSourceConfiguration>
  CreateDeliveryStreamRequest& WithDirectPutSourceConfiguration(DirectPutSourceConfigurationT&& value) {
    SetDirectPutSourceConfiguration(std::forward<DirectPutSourceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKinesisStreamSourceConfiguration(KinesisStreamSourceConfigurationT&& value) {
    m_kinesisStreamSourceConfigurationHasBeenSet = true;
    m_kinesisStreamSourceConfiguration = std::forward<KinesisStreamSourceConfigurationT>(value);
  }
  template <typename KinesisStreamSourceConfigurationT = KinesisStreamSourceConfiguration>
  CreateDeliveryStreamRequest& WithKinesisStreamSourceConfiguration(KinesisStreamSourceConfigurationT&& value) {
    SetKinesisStreamSourceConfiguration(std::forward<KinesisStreamSourceConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ExtendedS3DestinationConfiguration& GetExtendedS3DestinationConfiguration() const {
    return m_extendedS3DestinationConfiguration;
  }
  ...
  void SetExtendedS3DestinationConfiguration(ExtendedS3DestinationConfigurationT&& value) {
    m_extendedS3DestinationConfigurationHasBeenSet = true;
    m_extendedS3DestinationConfiguration = std::forward<ExtendedS3DestinationConfigurationT>(value);
  }
  template <typename ExtendedS3DestinationConfigurationT = ExtendedS3DestinationConfiguration>
  CreateDeliveryStreamRequest& WithExtendedS3DestinationConfiguration(ExtendedS3DestinationConfigurationT&& value) {
    SetExtendedS3DestinationConfiguration(std::forward<ExtendedS3DestinationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedshiftDestinationConfiguration(RedshiftDestinationConfigurationT&& value) {
    m_redshiftDestinationConfigurationHasBeenSet = true;
    m_redshiftDestinationConfiguration = std::forward<RedshiftDestinationConfigurationT>(value);
  }
  template <typename RedshiftDestinationConfigurationT = RedshiftDestinationConfiguration>
  CreateDeliveryStreamRequest& WithRedshiftDestinationConfiguration(RedshiftDestinationConfigurationT&& value) {
    SetRedshiftDestinationConfiguration(std::forward<RedshiftDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * destination.</p>
   */
  inline const ElasticsearchDestinationConfiguration& GetElasticsearchDestinationConfiguration() const {
    return m_elasticsearchDestinationConfiguration;
  }
  ...
  void SetElasticsearchDestinationConfiguration(ElasticsearchDestinationConfigurationT&& value) {
    m_elasticsearchDestinationConfigurationHasBeenSet = true;
    m_elasticsearchDestinationConfiguration = std::forward<ElasticsearchDestinationConfigurationT>(value);
  }
  template <typename ElasticsearchDestinationConfigurationT = ElasticsearchDestinationConfiguration>
  CreateDeliveryStreamRequest& WithElasticsearchDestinationConfiguration(ElasticsearchDestinationConfigurationT&& value) {
    SetElasticsearchDestinationConfiguration(std::forward<ElasticsearchDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * destination.</p>
   */
  inline const AmazonopensearchserviceDestinationConfiguration& GetAmazonopensearchserviceDestinationConfiguration() const {
    return m_amazonopensearchserviceDestinationConfiguration;
  }
  inline bool AmazonopensearchserviceDestinationConfigurationHasBeenSet() const {
    return m_amazonopensearchserviceDestinationConfigurationHasBeenSet;
  }
  ...
  void SetAmazonopensearchserviceDestinationConfiguration(AmazonopensearchserviceDestinationConfigurationT&& value) {
    m_amazonopensearchserviceDestinationConfigurationHasBeenSet = true;
    m_amazonopensearchserviceDestinationConfiguration = std::forward<AmazonopensearchserviceDestinationConfigurationT>(value);
  }
  template <typename AmazonopensearchserviceDestinationConfigurationT = AmazonopensearchserviceDestinationConfiguration>
  CreateDeliveryStreamRequest& WithAmazonopensearchserviceDestinationConfiguration(
      AmazonopensearchserviceDestinationConfigurationT&& value) {
    SetAmazonopensearchserviceDestinationConfiguration(std::forward<AmazonopensearchserviceDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSplunkDestinationConfiguration(SplunkDestinationConfigurationT&& value) {
    m_splunkDestinationConfigurationHasBeenSet = true;
    m_splunkDestinationConfiguration = std::forward<SplunkDestinationConfigurationT>(value);
  }
  template <typename SplunkDestinationConfigurationT = SplunkDestinationConfiguration>
  CreateDeliveryStreamRequest& WithSplunkDestinationConfiguration(SplunkDestinationConfigurationT&& value) {
    SetSplunkDestinationConfiguration(std::forward<SplunkDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const HttpEndpointDestinationConfiguration& GetHttpEndpointDestinationConfiguration() const {
    return m_httpEndpointDestinationConfiguration;
  }
  ...
  void SetHttpEndpointDestinationConfiguration(HttpEndpointDestinationConfigurationT&& value) {
    m_httpEndpointDestinationConfigurationHasBeenSet = true;
    m_httpEndpointDestinationConfiguration = std::forward<HttpEndpointDestinationConfigurationT>(value);
  }
  template <typename HttpEndpointDestinationConfigurationT = HttpEndpointDestinationConfiguration>
  CreateDeliveryStreamRequest& WithHttpEndpointDestinationConfiguration(HttpEndpointDestinationConfigurationT&& value) {
    SetHttpEndpointDestinationConfiguration(std::forward<HttpEndpointDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AmazonOpenSearchServerlessDestinationConfiguration& GetAmazonOpenSearchServerlessDestinationConfiguration() const {
    return m_amazonOpenSearchServerlessDestinationConfiguration;
  }
  inline bool AmazonOpenSearchServerlessDestinationConfigurationHasBeenSet() const {
    return m_amazonOpenSearchServerlessDestinationConfigurationHasBeenSet;
  }
  ...
  void SetAmazonOpenSearchServerlessDestinationConfiguration(AmazonOpenSearchServerlessDestinationConfigurationT&& value) {
    m_amazonOpenSearchServerlessDestinationConfigurationHasBeenSet = true;
    m_amazonOpenSearchServerlessDestinationConfiguration = std::forward<AmazonOpenSearchServerlessDestinationConfigurationT>(value);
  }
  template <typename AmazonOpenSearchServerlessDestinationConfigurationT = AmazonOpenSearchServerlessDestinationConfiguration>
  CreateDeliveryStreamRequest& WithAmazonOpenSearchServerlessDestinationConfiguration(
      AmazonOpenSearchServerlessDestinationConfigurationT&& value) {
    SetAmazonOpenSearchServerlessDestinationConfiguration(std::forward<AmazonOpenSearchServerlessDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMSKSourceConfiguration(MSKSourceConfigurationT&& value) {
    m_mSKSourceConfigurationHasBeenSet = true;
    m_mSKSourceConfiguration = std::forward<MSKSourceConfigurationT>(value);
  }
  template <typename MSKSourceConfigurationT = MSKSourceConfiguration>
  CreateDeliveryStreamRequest& WithMSKSourceConfiguration(MSKSourceConfigurationT&& value) {
    SetMSKSourceConfiguration(std::forward<MSKSourceConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const SnowflakeDestinationConfiguration& GetSnowflakeDestinationConfiguration() const {
    return m_snowflakeDestinationConfiguration;
  }
  ...
  void SetSnowflakeDestinationConfiguration(SnowflakeDestinationConfigurationT&& value) {
    m_snowflakeDestinationConfigurationHasBeenSet = true;
    m_snowflakeDestinationConfiguration = std::forward<SnowflakeDestinationConfigurationT>(value);
  }
  template <typename SnowflakeDestinationConfigurationT = SnowflakeDestinationConfiguration>
  CreateDeliveryStreamRequest& WithSnowflakeDestinationConfiguration(SnowflakeDestinationConfigurationT&& value) {
    SetSnowflakeDestinationConfiguration(std::forward<SnowflakeDestinationConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDatabaseSourceConfiguration(DatabaseSourceConfigurationT&& value) {
    m_databaseSourceConfigurationHasBeenSet = true;
    m_databaseSourceConfiguration = std::forward<DatabaseSourceConfigurationT>(value);
  }
  template <typename DatabaseSourceConfigurationT = DatabaseSourceConfiguration>
  CreateDeliveryStreamRequest& WithDatabaseSourceConfiguration(DatabaseSourceConfigurationT&& value) {
    SetDatabaseSourceConfiguration(std::forward<DatabaseSourceConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
