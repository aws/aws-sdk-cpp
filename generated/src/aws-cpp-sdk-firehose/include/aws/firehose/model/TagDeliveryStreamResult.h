...
namespace Model
{
  ...
  {
  public:
    AWS_FIREHOSE_API TagDeliveryStreamResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    TagDeliveryStreamResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
