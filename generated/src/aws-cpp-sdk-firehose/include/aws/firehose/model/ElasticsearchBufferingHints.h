...
class ElasticsearchBufferingHints {
 public:
  AWS_FIREHOSE_API ElasticsearchBufferingHints() = default;
  ...
  inline ElasticsearchBufferingHints& WithIntervalInSeconds(int value) {
  ...
  inline ElasticsearchBufferingHints& WithSizeInMBs(int value) {
    SetSizeInMBs(value);
    return *this;
  }
  ///@}
