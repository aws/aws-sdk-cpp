...
class TagDeliveryStreamRequest : public FirehoseRequest {
 public:
  ...
  template <typename DeliveryStreamNameT = Aws::String>
  TagDeliveryStreamRequest& WithDeliveryStreamName(DeliveryStreamNameT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  TagDeliveryStreamRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  TagDeliveryStreamRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
