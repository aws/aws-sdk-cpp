...
class ExtendedS3DestinationDescription {
 public:
  ...
  inline ExtendedS3DestinationDescription& WithCompressionFormat(CompressionFormat value) {
  ...
  inline ExtendedS3DestinationDescription& WithS3BackupMode(S3BackupMode value) {
