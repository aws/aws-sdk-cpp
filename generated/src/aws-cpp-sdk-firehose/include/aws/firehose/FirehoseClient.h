...
class AWS_FIREHOSE_API FirehoseClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  FirehoseClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<FirehoseEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for CreateDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeliveryStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDeliveryStreamRequestT = Model::CreateDeliveryStreamRequest>
  void CreateDeliveryStreamAsync(const CreateDeliveryStreamRequestT& request, const CreateDeliveryStreamResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DeleteDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeliveryStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDeliveryStreamRequestT = Model::DeleteDeliveryStreamRequest>
  void DeleteDeliveryStreamAsync(const DeleteDeliveryStreamRequestT& request, const DeleteDeliveryStreamResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDeliveryStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDeliveryStreamRequestT = Model::DescribeDeliveryStreamRequest>
  void DescribeDeliveryStreamAsync(const DescribeDeliveryStreamRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDeliveryStreams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeliveryStreams that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDeliveryStreamsRequestT = Model::ListDeliveryStreamsRequest>
  void ListDeliveryStreamsAsync(const ListDeliveryStreamsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListDeliveryStreamsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTagsForDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListTagsForDeliveryStreamRequestT = Model::ListTagsForDeliveryStreamRequest>
  Model::ListTagsForDeliveryStreamOutcomeCallable ListTagsForDeliveryStreamCallable(
      const ListTagsForDeliveryStreamRequestT& request) const {
    return SubmitCallable(&FirehoseClient::ListTagsForDeliveryStream, request);
  }

  /**
   * An Async wrapper for ListTagsForDeliveryStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTagsForDeliveryStreamRequestT = Model::ListTagsForDeliveryStreamRequest>
  void ListTagsForDeliveryStreamAsync(const ListTagsForDeliveryStreamRequestT& request,
  ...
  /**
   * An Async wrapper for PutRecord that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRecordRequestT = Model::PutRecordRequest>
  void PutRecordAsync(const PutRecordRequestT& request, const PutRecordResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutRecordBatch that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRecordBatchRequestT = Model::PutRecordBatchRequest>
  void PutRecordBatchAsync(const PutRecordBatchRequestT& request, const PutRecordBatchResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartDeliveryStreamEncryptionOutcome StartDeliveryStreamEncryption(
      const Model::StartDeliveryStreamEncryptionRequest& request) const;

  /**
   * A Callable wrapper for StartDeliveryStreamEncryption that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartDeliveryStreamEncryptionRequestT = Model::StartDeliveryStreamEncryptionRequest>
  Model::StartDeliveryStreamEncryptionOutcomeCallable StartDeliveryStreamEncryptionCallable(
      const StartDeliveryStreamEncryptionRequestT& request) const {
    return SubmitCallable(&FirehoseClient::StartDeliveryStreamEncryption, request);
  }

  /**
   * An Async wrapper for StartDeliveryStreamEncryption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartDeliveryStreamEncryptionRequestT = Model::StartDeliveryStreamEncryptionRequest>
  void StartDeliveryStreamEncryptionAsync(const StartDeliveryStreamEncryptionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::StopDeliveryStreamEncryptionOutcome StopDeliveryStreamEncryption(
      const Model::StopDeliveryStreamEncryptionRequest& request) const;

  /**
   * A Callable wrapper for StopDeliveryStreamEncryption that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopDeliveryStreamEncryptionRequestT = Model::StopDeliveryStreamEncryptionRequest>
  Model::StopDeliveryStreamEncryptionOutcomeCallable StopDeliveryStreamEncryptionCallable(
      const StopDeliveryStreamEncryptionRequestT& request) const {
    return SubmitCallable(&FirehoseClient::StopDeliveryStreamEncryption, request);
  }

  /**
   * An Async wrapper for StopDeliveryStreamEncryption that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopDeliveryStreamEncryptionRequestT = Model::StopDeliveryStreamEncryptionRequest>
  void StopDeliveryStreamEncryptionAsync(const StopDeliveryStreamEncryptionRequestT& request,
  ...
  /**
   * A Callable wrapper for TagDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for TagDeliveryStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename TagDeliveryStreamRequestT = Model::TagDeliveryStreamRequest>
  void TagDeliveryStreamAsync(const TagDeliveryStreamRequestT& request, const TagDeliveryStreamResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UntagDeliveryStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UntagDeliveryStream that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UntagDeliveryStreamRequestT = Model::UntagDeliveryStreamRequest>
  void UntagDeliveryStreamAsync(const UntagDeliveryStreamRequestT& request, const UntagDeliveryStreamResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
