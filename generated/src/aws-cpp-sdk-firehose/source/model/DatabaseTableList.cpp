...
DatabaseTableList::DatabaseTableList(JsonView jsonValue) { *this = jsonValue; }

DatabaseTableList& DatabaseTableList::operator=(JsonView jsonValue) {
...
JsonValue DatabaseTableList::Jsonize() const {
  JsonValue payload;
