...
AmazonopensearchserviceDestinationUpdate::AmazonopensearchserviceDestinationUpdate(JsonView jsonValue) { *this = jsonValue; }

AmazonopensearchserviceDestinationUpdate& AmazonopensearchserviceDestinationUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IndexRotationPeriod")) {
    m_indexRotationPeriod = AmazonopensearchserviceIndexRotationPeriodMapper::GetAmazonopensearchserviceIndexRotationPeriodForName(
        jsonValue.GetString("IndexRotationPeriod"));
...
JsonValue AmazonopensearchserviceDestinationUpdate::Jsonize() const {
  JsonValue payload;
  ...
  if (m_indexRotationPeriodHasBeenSet) {
    payload.WithString(
        "IndexRotationPeriod",
        AmazonopensearchserviceIndexRotationPeriodMapper::GetNameForAmazonopensearchserviceIndexRotationPeriod(m_indexRotationPeriod));
  }
