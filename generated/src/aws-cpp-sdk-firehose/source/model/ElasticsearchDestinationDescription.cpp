...
ElasticsearchDestinationDescription::ElasticsearchDestinationDescription(JsonView jsonValue) { *this = jsonValue; }
...
ElasticsearchDestinationDescription& ElasticsearchDestinationDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("IndexRotationPeriod")) {
    m_indexRotationPeriod =
        ElasticsearchIndexRotationPeriodMapper::GetElasticsearchIndexRotationPeriodForName(jsonValue.GetString("IndexRotationPeriod"));
...
JsonValue ElasticsearchDestinationDescription::Jsonize() const {
  ...
  if (m_indexRotationPeriodHasBeenSet) {
    payload.WithString("IndexRotationPeriod",
                       ElasticsearchIndexRotationPeriodMapper::GetNameForElasticsearchIndexRotationPeriod(m_indexRotationPeriod));
  }
