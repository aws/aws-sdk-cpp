...
AmazonOpenSearchServerlessDestinationConfiguration& AmazonOpenSearchServerlessDestinationConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("S3BackupMode")) {
    m_s3BackupMode =
        AmazonOpenSearchServerlessS3BackupModeMapper::GetAmazonOpenSearchServerlessS3BackupModeForName(jsonValue.GetString("S3BackupMode"));
...
JsonValue AmazonOpenSearchServerlessDestinationConfiguration::Jsonize() const {
  ...
  if (m_s3BackupModeHasBeenSet) {
    payload.WithString("S3BackupMode",
                       AmazonOpenSearchServerlessS3BackupModeMapper::GetNameForAmazonOpenSearchServerlessS3BackupMode(m_s3BackupMode));
  }
