...
ExtendedS3DestinationConfiguration::ExtendedS3DestinationConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue ExtendedS3DestinationConfiguration::Jsonize() const {
  JsonValue payload;
