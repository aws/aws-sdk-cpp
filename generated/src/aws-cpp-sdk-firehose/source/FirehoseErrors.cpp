...
namespace Firehose {
template <>
AWS_FIREHOSE_API InvalidKMSResourceException FirehoseError::GetModeledError() {
...
template <>
AWS_FIREHOSE_API InvalidSourceException FirehoseError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == INVALID_K_M_S_RESOURCE_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(FirehoseErrors::LIMIT_EXCEEDED), RetryableType::RETRYABLE_THROTTLING);
