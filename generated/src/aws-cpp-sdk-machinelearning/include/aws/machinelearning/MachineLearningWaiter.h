 ...
 public:
  Aws::Utils::WaiterOutcome<Model::DescribeBatchPredictionsOutcome> WaitUntilBatchPredictionAvailable(
    ...
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeBatchPredictionsOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::all_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::BatchPrediction& item) {
    ...
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeBatchPredictionsOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::any_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::BatchPrediction& item) {
            return Model::EntityStatusMapper::GetNameForEntityStatus(item.GetStatus()) == expected.get<Aws::String>();
          });
        }));
  ...
  Aws::Utils::WaiterOutcome<Model::DescribeDataSourcesOutcome> WaitUntilDataSourceAvailable(
    ...
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeDataSourcesOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::all_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::DataSource& item) {
            return Model::EntityStatusMapper::GetNameForEntityStatus(item.GetStatus()) == expected.get<Aws::String>();
          });
        }));
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeDataSourcesOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::any_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::DataSource& item) {
            return Model::EntityStatusMapper::GetNameForEntityStatus(item.GetStatus()) == expected.get<Aws::String>();
          });
        }));
  ...
  Aws::Utils::WaiterOutcome<Model::DescribeEvaluationsOutcome> WaitUntilEvaluationAvailable(
    ...
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeEvaluationsOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::all_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::Evaluation& item) {
            return Model::EntityStatusMapper::GetNameForEntityStatus(item.GetStatus()) == expected.get<Aws::String>();
          });
        }));
    acceptors.emplace_back(Aws::MakeUnique<Aws::Utils::PathAcceptor<OutcomeT>>(
        ...
        [](const Model::DescribeEvaluationsOutcome& outcome, const Aws::Utils::ExpectedValue& expected) -> bool {
          if (!outcome.IsSuccess()) return false;
          const auto& result = outcome.GetResult();
          return std::any_of(result.GetResults().begin(), result.GetResults().end(), [&](const Model::Evaluation& item) {
            return Model::EntityStatusMapper::GetNameForEntityStatus(item.GetStatus()) == expected.get<Aws::String>();
          });
        }));
