...
class AWS_MACHINELEARNING_API MachineLearningClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MachineLearningClient(const Aws::MachineLearning::MachineLearningClientConfiguration& clientConfiguration =
  ...
  MachineLearningClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<MachineLearningEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::MachineLearning::MachineLearningClientConfiguration& clientConfiguration =
                            Aws::MachineLearning::MachineLearningClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateBatchPrediction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchPrediction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateBatchPredictionRequestT = Model::CreateBatchPredictionRequest>
  void CreateBatchPredictionAsync(const CreateBatchPredictionRequestT& request, const CreateBatchPredictionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDataSourceFromRDS that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataSourceFromRDS that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataSourceFromRDSRequestT = Model::CreateDataSourceFromRDSRequest>
  void CreateDataSourceFromRDSAsync(const CreateDataSourceFromRDSRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDataSourceFromRedshiftOutcome CreateDataSourceFromRedshift(
      const Model::CreateDataSourceFromRedshiftRequest& request) const;

  /**
   * A Callable wrapper for CreateDataSourceFromRedshift that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDataSourceFromRedshiftRequestT = Model::CreateDataSourceFromRedshiftRequest>
  Model::CreateDataSourceFromRedshiftOutcomeCallable CreateDataSourceFromRedshiftCallable(
      const CreateDataSourceFromRedshiftRequestT& request) const {
    return SubmitCallable(&MachineLearningClient::CreateDataSourceFromRedshift, request);
  }

  /**
   * An Async wrapper for CreateDataSourceFromRedshift that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataSourceFromRedshiftRequestT = Model::CreateDataSourceFromRedshiftRequest>
  void CreateDataSourceFromRedshiftAsync(const CreateDataSourceFromRedshiftRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDataSourceFromS3 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDataSourceFromS3 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDataSourceFromS3RequestT = Model::CreateDataSourceFromS3Request>
  void CreateDataSourceFromS3Async(const CreateDataSourceFromS3RequestT& request,
  ...
  /**
   * A Callable wrapper for CreateEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEvaluation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEvaluationRequestT = Model::CreateEvaluationRequest>
  void CreateEvaluationAsync(const CreateEvaluationRequestT& request, const CreateEvaluationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateMLModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMLModelRequestT = Model::CreateMLModelRequest>
  void CreateMLModelAsync(const CreateMLModelRequestT& request, const CreateMLModelResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateRealtimeEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateRealtimeEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRealtimeEndpointRequestT = Model::CreateRealtimeEndpointRequest>
  void CreateRealtimeEndpointAsync(const CreateRealtimeEndpointRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteBatchPrediction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBatchPrediction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteBatchPredictionRequestT = Model::DeleteBatchPredictionRequest>
  void DeleteBatchPredictionAsync(const DeleteBatchPredictionRequestT& request, const DeleteBatchPredictionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEvaluation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEvaluationRequestT = Model::DeleteEvaluationRequest>
  void DeleteEvaluationAsync(const DeleteEvaluationRequestT& request, const DeleteEvaluationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteMLModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMLModelRequestT = Model::DeleteMLModelRequest>
  void DeleteMLModelAsync(const DeleteMLModelRequestT& request, const DeleteMLModelResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteRealtimeEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteRealtimeEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRealtimeEndpointRequestT = Model::DeleteRealtimeEndpointRequest>
  void DeleteRealtimeEndpointAsync(const DeleteRealtimeEndpointRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeBatchPredictions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeBatchPredictionsRequestT = Model::DescribeBatchPredictionsRequest>
  Model::DescribeBatchPredictionsOutcomeCallable DescribeBatchPredictionsCallable(
      const DescribeBatchPredictionsRequestT& request = {}) const {
    return SubmitCallable(&MachineLearningClient::DescribeBatchPredictions, request);
  }

  /**
   * An Async wrapper for DescribeBatchPredictions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBatchPredictionsRequestT = Model::DescribeBatchPredictionsRequest>
  void DescribeBatchPredictionsAsync(const DescribeBatchPredictionsResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeDataSources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataSources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDataSourcesRequestT = Model::DescribeDataSourcesRequest>
  void DescribeDataSourcesAsync(const DescribeDataSourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeDataSourcesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeEvaluations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEvaluations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEvaluationsRequestT = Model::DescribeEvaluationsRequest>
  void DescribeEvaluationsAsync(const DescribeEvaluationsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeEvaluationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeMLModels that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMLModels that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeMLModelsRequestT = Model::DescribeMLModelsRequest>
  void DescribeMLModelsAsync(const DescribeMLModelsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeMLModelsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetBatchPrediction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetBatchPrediction that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetBatchPredictionRequestT = Model::GetBatchPredictionRequest>
  void GetBatchPredictionAsync(const GetBatchPredictionRequestT& request, const GetBatchPredictionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEvaluation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEvaluationRequestT = Model::GetEvaluationRequest>
  void GetEvaluationAsync(const GetEvaluationRequestT& request, const GetEvaluationResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMLModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLModelRequestT = Model::GetMLModelRequest>
  void GetMLModelAsync(const GetMLModelRequestT& request, const GetMLModelResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for Predict that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PredictRequestT = Model::PredictRequest>
  void PredictAsync(const PredictRequestT& request, const PredictResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBatchPrediction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBatchPrediction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateBatchPredictionRequestT = Model::UpdateBatchPredictionRequest>
  void UpdateBatchPredictionAsync(const UpdateBatchPredictionRequestT& request, const UpdateBatchPredictionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEvaluation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEvaluation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEvaluationRequestT = Model::UpdateEvaluationRequest>
  void UpdateEvaluationAsync(const UpdateEvaluationRequestT& request, const UpdateEvaluationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMLModel that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMLModelRequestT = Model::UpdateMLModelRequest>
  void UpdateMLModelAsync(const UpdateMLModelRequestT& request, const UpdateMLModelResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
