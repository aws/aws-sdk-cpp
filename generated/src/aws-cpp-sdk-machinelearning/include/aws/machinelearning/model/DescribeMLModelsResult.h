...
class DescribeMLModelsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<MLModel>>
  DescribeMLModelsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = MLModel>
  DescribeMLModelsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMLModelsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMLModelsResult& WithRequestId(RequestIdT&& value) {
