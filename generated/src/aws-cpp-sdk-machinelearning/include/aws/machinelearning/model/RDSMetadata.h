...
class RDSMetadata {
 public:
  ...
  void SetDatabaseUserName(DatabaseUserNameT&& value) {
    ...
    m_databaseUserName = std::forward<DatabaseUserNameT>(value);
  }
  template <typename DatabaseUserNameT = Aws::String>
  RDSMetadata& WithDatabaseUserName(DatabaseUserNameT&& value) {
    SetDatabaseUserName(std::forward<DatabaseUserNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataPipelineId(DataPipelineIdT&& value) {
    ...
    m_dataPipelineId = std::forward<DataPipelineIdT>(value);
  }
  template <typename DataPipelineIdT = Aws::String>
  RDSMetadata& WithDataPipelineId(DataPipelineIdT&& value) {
    SetDataPipelineId(std::forward<DataPipelineIdT>(value));
    return *this;
  }
  ///@}
 private:
