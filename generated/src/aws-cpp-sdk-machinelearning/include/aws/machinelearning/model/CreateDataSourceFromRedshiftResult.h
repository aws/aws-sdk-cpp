...
class CreateDataSourceFromRedshiftResult {
 public:
  ...
  AWS_MACHINELEARNING_API CreateDataSourceFromRedshiftResult& operator=(
  ...
  template <typename DataSourceIdT = Aws::String>
  CreateDataSourceFromRedshiftResult& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataSourceFromRedshiftResult& WithRequestId(RequestIdT&& value) {
