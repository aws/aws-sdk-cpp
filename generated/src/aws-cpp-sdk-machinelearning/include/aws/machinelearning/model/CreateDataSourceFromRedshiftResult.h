...
namespace Model
{
  ...
  public:
    ...
    inline CreateDataSourceFromRedshiftResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateDataSourceFromRedshiftResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateDataSourceFromRedshiftResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
