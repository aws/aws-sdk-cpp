...
namespace Model
{
  ...
  {
  public:
    AWS_MACHINELEARNING_API CreateDataSourceFromS3Result() = default;
    ...
    template<typename DataSourceIdT = Aws::String>
    CreateDataSourceFromS3Result& WithDataSourceId(DataSourceIdT&& value) { SetDataSourceId(std::forward<DataSourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateDataSourceFromS3Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
