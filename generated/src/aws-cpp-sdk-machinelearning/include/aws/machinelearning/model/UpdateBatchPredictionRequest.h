...
class UpdateBatchPredictionRequest : public MachineLearningRequest {
 public:
  ...
  void SetBatchPredictionName(BatchPredictionNameT&& value) {
    m_batchPredictionNameHasBeenSet = true;
    m_batchPredictionName = std::forward<BatchPredictionNameT>(value);
  }
  template <typename BatchPredictionNameT = Aws::String>
  UpdateBatchPredictionRequest& WithBatchPredictionName(BatchPredictionNameT&& value) {
    SetBatchPredictionName(std::forward<BatchPredictionNameT>(value));
    return *this;
  }
  ///@}
 private:
