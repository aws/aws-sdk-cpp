...
class MLModel {
 public:
  ...
  inline MLModel& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline MLModel& WithSizeInBytes(long long value) {
  ...
  inline MLModel& WithAlgorithm(Algorithm value) {
    SetAlgorithm(value);
    return *this;
  }
  ///@}
  ...
  inline MLModel& WithMLModelType(MLModelType value) {
  ...
  inline MLModel& WithScoreThreshold(double value) {
  ...
  inline MLModel& WithComputeTime(long long value) {
