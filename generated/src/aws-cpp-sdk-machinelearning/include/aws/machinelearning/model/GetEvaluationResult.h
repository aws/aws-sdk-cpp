...
class GetEvaluationResult {
 public:
  ...
  inline GetEvaluationResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPerformanceMetrics(PerformanceMetricsT&& value) {
    ...
    m_performanceMetrics = std::forward<PerformanceMetricsT>(value);
  }
  template <typename PerformanceMetricsT = PerformanceMetrics>
  GetEvaluationResult& WithPerformanceMetrics(PerformanceMetricsT&& value) {
    SetPerformanceMetrics(std::forward<PerformanceMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetEvaluationResult& WithComputeTime(long long value) {
