...
class RealtimeEndpointInfo {
 public:
  ...
  inline void SetPeakRequestsPerSecond(int value) {
    m_peakRequestsPerSecondHasBeenSet = true;
    m_peakRequestsPerSecond = value;
  }
  inline RealtimeEndpointInfo& WithPeakRequestsPerSecond(int value) {
    SetPeakRequestsPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEndpointStatus(RealtimeEndpointStatus value) {
    m_endpointStatusHasBeenSet = true;
    m_endpointStatus = value;
  }
  inline RealtimeEndpointInfo& WithEndpointStatus(RealtimeEndpointStatus value) {
