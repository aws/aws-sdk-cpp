...
class DataSource {
 public:
  ...
  inline DataSource& WithDataSizeInBytes(long long value) {
  ...
  inline DataSource& WithNumberOfFiles(long long value) {
  ...
  inline DataSource& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DataSource& WithComputeStatistics(bool value) {
  ...
  inline DataSource& WithComputeTime(long long value) {
