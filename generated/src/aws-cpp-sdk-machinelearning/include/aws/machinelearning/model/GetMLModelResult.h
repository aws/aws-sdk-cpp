...
class GetMLModelResult {
 public:
  ...
  inline GetMLModelResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline GetMLModelResult& WithSizeInBytes(long long value) {
  ...
  inline GetMLModelResult& WithMLModelType(MLModelType value) {
  ...
  inline void SetScoreThreshold(double value) {
    m_scoreThresholdHasBeenSet = true;
    m_scoreThreshold = value;
  }
  inline GetMLModelResult& WithScoreThreshold(double value) {
  ...
  void SetScoreThresholdLastUpdatedAt(ScoreThresholdLastUpdatedAtT&& value) {
    ...
    m_scoreThresholdLastUpdatedAt = std::forward<ScoreThresholdLastUpdatedAtT>(value);
  }
  template <typename ScoreThresholdLastUpdatedAtT = Aws::Utils::DateTime>
  GetMLModelResult& WithScoreThresholdLastUpdatedAt(ScoreThresholdLastUpdatedAtT&& value) {
    SetScoreThresholdLastUpdatedAt(std::forward<ScoreThresholdLastUpdatedAtT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetMLModelResult& WithComputeTime(long long value) {
