...
class CreateDataSourceFromRDSRequest : public MachineLearningRequest {
 public:
  ...
  template <typename DataSourceIdT = Aws::String>
  CreateDataSourceFromRDSRequest& WithDataSourceId(DataSourceIdT&& value) {
  ...
  template <typename DataSourceNameT = Aws::String>
  CreateDataSourceFromRDSRequest& WithDataSourceName(DataSourceNameT&& value) {
  ...
  void SetRDSData(RDSDataT&& value) {
    m_rDSDataHasBeenSet = true;
    m_rDSData = std::forward<RDSDataT>(value);
  }
  template <typename RDSDataT = RDSDataSpec>
  CreateDataSourceFromRDSRequest& WithRDSData(RDSDataT&& value) {
    SetRDSData(std::forward<RDSDataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RoleARNT = Aws::String>
  CreateDataSourceFromRDSRequest& WithRoleARN(RoleARNT&& value) {
  ...
  inline CreateDataSourceFromRDSRequest& WithComputeStatistics(bool value) {
