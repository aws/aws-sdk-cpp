...
class DescribeBatchPredictionsRequest : public MachineLearningRequest {
 public:
  ...
  inline void SetFilterVariable(BatchPredictionFilterVariable value) {
    m_filterVariableHasBeenSet = true;
    m_filterVariable = value;
  }
  inline DescribeBatchPredictionsRequest& WithFilterVariable(BatchPredictionFilterVariable value) {
  ...
  void SetGT(GTT&& value) {
    m_gTHasBeenSet = true;
    m_gT = std::forward<GTT>(value);
  }
  template <typename GTT = Aws::String>
  DescribeBatchPredictionsRequest& WithGT(GTT&& value) {
    SetGT(std::forward<GTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLT(LTT&& value) {
    m_lTHasBeenSet = true;
    m_lT = std::forward<LTT>(value);
  }
  template <typename LTT = Aws::String>
  DescribeBatchPredictionsRequest& WithLT(LTT&& value) {
    SetLT(std::forward<LTT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGE(GET&& value) {
    m_gEHasBeenSet = true;
    m_gE = std::forward<GET>(value);
  }
  template <typename GET = Aws::String>
  DescribeBatchPredictionsRequest& WithGE(GET&& value) {
    SetGE(std::forward<GET>(value));
    return *this;
  }
  ///@}
  ...
  void SetLE(LET&& value) {
    m_lEHasBeenSet = true;
    m_lE = std::forward<LET>(value);
  }
  template <typename LET = Aws::String>
  DescribeBatchPredictionsRequest& WithLE(LET&& value) {
    SetLE(std::forward<LET>(value));
    return *this;
  }
  ///@}
  ...
  void SetNE(NET&& value) {
    m_nEHasBeenSet = true;
    m_nE = std::forward<NET>(value);
  }
  template <typename NET = Aws::String>
  DescribeBatchPredictionsRequest& WithNE(NET&& value) {
    SetNE(std::forward<NET>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBatchPredictionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeBatchPredictionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
