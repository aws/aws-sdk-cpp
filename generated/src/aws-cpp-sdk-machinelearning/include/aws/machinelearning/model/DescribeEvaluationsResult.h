...
class DescribeEvaluationsResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<Evaluation>>
  DescribeEvaluationsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = Evaluation>
  DescribeEvaluationsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEvaluationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEvaluationsResult& WithRequestId(RequestIdT&& value) {
