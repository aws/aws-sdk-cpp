...
class DescribeDataSourcesRequest : public MachineLearningRequest {
 public:
  ...
  inline void SetFilterVariable(DataSourceFilterVariable value) {
    m_filterVariableHasBeenSet = true;
    m_filterVariable = value;
  }
  inline DescribeDataSourcesRequest& WithFilterVariable(DataSourceFilterVariable value) {
  ...
  inline DescribeDataSourcesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDataSourcesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
