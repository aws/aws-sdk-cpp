...
class GetDataSourceResult {
 public:
  ...
  void SetDataLocationS3(DataLocationS3T&& value) {
    ...
    m_dataLocationS3 = std::forward<DataLocationS3T>(value);
  }
  template <typename DataLocationS3T = Aws::String>
  GetDataSourceResult& WithDataLocationS3(DataLocationS3T&& value) {
    SetDataLocationS3(std::forward<DataLocationS3T>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataSizeInBytes(long long value) {
    m_dataSizeInBytesHasBeenSet = true;
    m_dataSizeInBytes = value;
  }
  inline GetDataSourceResult& WithDataSizeInBytes(long long value) {
    SetDataSizeInBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfFiles(long long value) {
    m_numberOfFilesHasBeenSet = true;
    m_numberOfFiles = value;
  }
  inline GetDataSourceResult& WithNumberOfFiles(long long value) {
  ...
  inline GetDataSourceResult& WithStatus(EntityStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRedshiftMetadata(RedshiftMetadataT&& value) {
    ...
    m_redshiftMetadata = std::forward<RedshiftMetadataT>(value);
  }
  template <typename RedshiftMetadataT = RedshiftMetadata>
  GetDataSourceResult& WithRedshiftMetadata(RedshiftMetadataT&& value) {
    SetRedshiftMetadata(std::forward<RedshiftMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRDSMetadata(RDSMetadataT&& value) {
    ...
    m_rDSMetadata = std::forward<RDSMetadataT>(value);
  }
  template <typename RDSMetadataT = RDSMetadata>
  GetDataSourceResult& WithRDSMetadata(RDSMetadataT&& value) {
    SetRDSMetadata(std::forward<RDSMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetDataSourceResult& WithComputeStatistics(bool value) {
    SetComputeStatistics(value);
    return *this;
  }
  ///@}
  ...
  inline GetDataSourceResult& WithComputeTime(long long value) {
  ...
  void SetDataSourceSchema(DataSourceSchemaT&& value) {
    ...
    m_dataSourceSchema = std::forward<DataSourceSchemaT>(value);
  }
  template <typename DataSourceSchemaT = Aws::String>
  GetDataSourceResult& WithDataSourceSchema(DataSourceSchemaT&& value) {
    SetDataSourceSchema(std::forward<DataSourceSchemaT>(value));
    return *this;
  }
  ///@}
