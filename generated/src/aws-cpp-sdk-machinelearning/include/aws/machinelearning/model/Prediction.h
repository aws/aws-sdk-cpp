...
class Prediction {
 public:
  ...
  void SetPredictedLabel(PredictedLabelT&& value) {
    ...
    m_predictedLabel = std::forward<PredictedLabelT>(value);
  }
  template <typename PredictedLabelT = Aws::String>
  Prediction& WithPredictedLabel(PredictedLabelT&& value) {
    SetPredictedLabel(std::forward<PredictedLabelT>(value));
    return *this;
  }
  ///@}
  ...
  inline Prediction& WithPredictedValue(double value) {
  ...
  void SetPredictedScores(PredictedScoresT&& value) {
    ...
    m_predictedScores = std::forward<PredictedScoresT>(value);
  }
  template <typename PredictedScoresT = Aws::Map<Aws::String, double>>
  Prediction& WithPredictedScores(PredictedScoresT&& value) {
    SetPredictedScores(std::forward<PredictedScoresT>(value));
    return *this;
  }
  inline Prediction& AddPredictedScores(Aws::String key, double value) {
    m_predictedScoresHasBeenSet = true;
    m_predictedScores.emplace(key, value);
    return *this;
  }
  ///@}
