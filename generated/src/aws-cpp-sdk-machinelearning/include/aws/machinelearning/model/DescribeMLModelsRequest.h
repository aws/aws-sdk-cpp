...
class DescribeMLModelsRequest : public MachineLearningRequest {
 public:
  ...
  inline void SetFilterVariable(MLModelFilterVariable value) {
    m_filterVariableHasBeenSet = true;
    m_filterVariable = value;
  }
  inline DescribeMLModelsRequest& WithFilterVariable(MLModelFilterVariable value) {
  ...
  inline DescribeMLModelsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeMLModelsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
