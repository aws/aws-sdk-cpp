...
class CreateMLModelRequest : public MachineLearningRequest {
 public:
  ...
  void SetMLModelName(MLModelNameT&& value) {
    m_mLModelNameHasBeenSet = true;
    m_mLModelName = std::forward<MLModelNameT>(value);
  }
  template <typename MLModelNameT = Aws::String>
  CreateMLModelRequest& WithMLModelName(MLModelNameT&& value) {
    SetMLModelName(std::forward<MLModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMLModelType(MLModelType value) {
    m_mLModelTypeHasBeenSet = true;
    m_mLModelType = value;
  }
  inline CreateMLModelRequest& WithMLModelType(MLModelType value) {
    SetMLModelType(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingDataSourceId(TrainingDataSourceIdT&& value) {
    ...
    m_trainingDataSourceId = std::forward<TrainingDataSourceIdT>(value);
  }
  template <typename TrainingDataSourceIdT = Aws::String>
  CreateMLModelRequest& WithTrainingDataSourceId(TrainingDataSourceIdT&& value) {
    SetTrainingDataSourceId(std::forward<TrainingDataSourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRecipeUri(RecipeUriT&& value) {
    m_recipeUriHasBeenSet = true;
    m_recipeUri = std::forward<RecipeUriT>(value);
  }
  template <typename RecipeUriT = Aws::String>
  CreateMLModelRequest& WithRecipeUri(RecipeUriT&& value) {
    SetRecipeUri(std::forward<RecipeUriT>(value));
    return *this;
  }
  ///@}
 private:
