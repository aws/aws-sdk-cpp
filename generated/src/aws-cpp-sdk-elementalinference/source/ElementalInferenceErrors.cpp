...
static const int GATEWAY_TIMED_OUT_HASH = HashingUtils::HashString("GatewayTimedOutException");
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  } else if (hashCode == GATEWAY_TIMED_OUT_HASH) {
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ElementalInferenceErrors::GATEWAY_TIMED_OUT), RetryableType::RETRYABLE);
