...
Aws::String SearchFixturesRequest::SerializePayload() const {
  JsonValue payload;

  if (m_sportHasBeenSet) {
    payload.WithString("sport", DataSourceSportMapper::GetNameForDataSourceSport(m_sport));
  }
