...
CreateDictionaryResult::CreateDictionaryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateDictionaryResult& CreateDictionaryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
