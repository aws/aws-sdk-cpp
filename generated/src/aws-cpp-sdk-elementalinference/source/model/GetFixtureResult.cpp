...
GetFixtureResult::GetFixtureResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetFixtureResult& GetFixtureResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
