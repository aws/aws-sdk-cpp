...
GetDictionaryResult::GetDictionaryResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetDictionaryResult& GetDictionaryResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
