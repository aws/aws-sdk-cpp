...
GetFeedResult::GetFeedResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetFeedResult& GetFeedResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
