...
UpdateFeedResult::UpdateFeedResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateFeedResult& UpdateFeedResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
