...
namespace Model {
class UpdateDictionaryResult {
 public:
  AWS_ELEMENTALINFERENCE_API UpdateDictionaryResult() = default;
  AWS_ELEMENTALINFERENCE_API UpdateDictionaryResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_ELEMENTALINFERENCE_API UpdateDictionaryResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename NameT = Aws::String>
  UpdateDictionaryResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  UpdateDictionaryResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateDictionaryResult& WithId(IdT&& value) {
  ...
  inline UpdateDictionaryResult& WithLanguage(DictionaryLanguage value) {
    SetLanguage(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateDictionaryResult& WithStatus(DictionaryStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReferencesT = Aws::Vector<Aws::String>>
  UpdateDictionaryResult& WithReferences(ReferencesT&& value) {
    SetReferences(std::forward<ReferencesT>(value));
    return *this;
  }
  template <typename ReferencesT = Aws::String>
  UpdateDictionaryResult& AddReferences(ReferencesT&& value) {
    m_referencesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateDictionaryResult& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  UpdateDictionaryResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDictionaryResult& WithRequestId(RequestIdT&& value) {
