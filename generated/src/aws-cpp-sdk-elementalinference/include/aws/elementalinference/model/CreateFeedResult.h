...
class CreateFeedResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateFeedResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateFeedResult& WithId(IdT&& value) {
  ...
  inline CreateFeedResult& WithStatus(FeedStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateFeedResult& WithTags(TagsT&& value) {
