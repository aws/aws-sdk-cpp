...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class GetDomainDetailRequest : public Route53DomainsRequest
  {
  public:
    AWS_ROUTE53DOMAINS_API GetDomainDetailRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    GetDomainDetailRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
