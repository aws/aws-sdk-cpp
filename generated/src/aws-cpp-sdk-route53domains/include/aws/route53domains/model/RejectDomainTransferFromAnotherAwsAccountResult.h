...
class RejectDomainTransferFromAnotherAwsAccountResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API RejectDomainTransferFromAnotherAwsAccountResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename OperationIdT = Aws::String>
  RejectDomainTransferFromAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RejectDomainTransferFromAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) {
