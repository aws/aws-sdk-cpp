...
namespace Model
{
  ...
  public:
    ...
    inline EnableDomainAutoRenewResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline EnableDomainAutoRenewResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline EnableDomainAutoRenewResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
