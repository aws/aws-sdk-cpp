...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API EnableDomainAutoRenewResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableDomainAutoRenewResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
