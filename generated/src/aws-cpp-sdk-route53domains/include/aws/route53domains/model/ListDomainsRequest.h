...
class ListDomainsRequest : public Route53DomainsRequest {
 public:
  ...
  void SetFilterConditions(FilterConditionsT&& value) {
    m_filterConditionsHasBeenSet = true;
    m_filterConditions = std::forward<FilterConditionsT>(value);
  }
  template <typename FilterConditionsT = Aws::Vector<FilterCondition>>
  ListDomainsRequest& WithFilterConditions(FilterConditionsT&& value) {
    SetFilterConditions(std::forward<FilterConditionsT>(value));
    return *this;
  }
  template <typename FilterConditionsT = FilterCondition>
  ListDomainsRequest& AddFilterConditions(FilterConditionsT&& value) {
    m_filterConditionsHasBeenSet = true;
    m_filterConditions.emplace_back(std::forward<FilterConditionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSortCondition(SortConditionT&& value) {
    m_sortConditionHasBeenSet = true;
    m_sortCondition = std::forward<SortConditionT>(value);
  }
  template <typename SortConditionT = SortCondition>
  ListDomainsRequest& WithSortCondition(SortConditionT&& value) {
    SetSortCondition(std::forward<SortConditionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  ListDomainsRequest& WithMarker(MarkerT&& value) {
  ...
  inline ListDomainsRequest& WithMaxItems(int value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
