...
class DomainPrice {
 public:
  ...
  void SetRegistrationPrice(RegistrationPriceT&& value) {
    ...
    m_registrationPrice = std::forward<RegistrationPriceT>(value);
  }
  template <typename RegistrationPriceT = PriceWithCurrency>
  DomainPrice& WithRegistrationPrice(RegistrationPriceT&& value) {
    SetRegistrationPrice(std::forward<RegistrationPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransferPrice(TransferPriceT&& value) {
    ...
    m_transferPrice = std::forward<TransferPriceT>(value);
  }
  template <typename TransferPriceT = PriceWithCurrency>
  DomainPrice& WithTransferPrice(TransferPriceT&& value) {
    SetTransferPrice(std::forward<TransferPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRenewalPrice(RenewalPriceT&& value) {
    ...
    m_renewalPrice = std::forward<RenewalPriceT>(value);
  }
  template <typename RenewalPriceT = PriceWithCurrency>
  DomainPrice& WithRenewalPrice(RenewalPriceT&& value) {
    SetRenewalPrice(std::forward<RenewalPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChangeOwnershipPrice(ChangeOwnershipPriceT&& value) {
    ...
    m_changeOwnershipPrice = std::forward<ChangeOwnershipPriceT>(value);
  }
  template <typename ChangeOwnershipPriceT = PriceWithCurrency>
  DomainPrice& WithChangeOwnershipPrice(ChangeOwnershipPriceT&& value) {
    SetChangeOwnershipPrice(std::forward<ChangeOwnershipPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRestorationPrice(RestorationPriceT&& value) {
    ...
    m_restorationPrice = std::forward<RestorationPriceT>(value);
  }
  template <typename RestorationPriceT = PriceWithCurrency>
  DomainPrice& WithRestorationPrice(RestorationPriceT&& value) {
    SetRestorationPrice(std::forward<RestorationPriceT>(value));
    return *this;
  }
  ///@}
 private:
