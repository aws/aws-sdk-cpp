...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class EnableDomainTransferLockRequest : public Route53DomainsRequest
  {
  public:
    AWS_ROUTE53DOMAINS_API EnableDomainTransferLockRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    EnableDomainTransferLockRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
