...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API DisableDomainAutoRenewResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisableDomainAutoRenewResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
