...
class ListTagsForDomainResult {
 public:
  ...
  template <typename TagListT = Aws::Vector<Tag>>
  ListTagsForDomainResult& WithTagList(TagListT&& value) {
    SetTagList(std::forward<TagListT>(value));
    return *this;
  }
  template <typename TagListT = Tag>
  ListTagsForDomainResult& AddTagList(TagListT&& value) {
    m_tagListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListTagsForDomainResult& WithRequestId(RequestIdT&& value) {
