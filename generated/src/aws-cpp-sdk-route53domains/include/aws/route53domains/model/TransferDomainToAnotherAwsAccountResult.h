...
class TransferDomainToAnotherAwsAccountResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API TransferDomainToAnotherAwsAccountResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  TransferDomainToAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  TransferDomainToAnotherAwsAccountResult& WithPassword(PasswordT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TransferDomainToAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) {
