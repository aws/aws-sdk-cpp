...
class AcceptDomainTransferFromAnotherAwsAccountRequest : public Route53DomainsRequest {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  AcceptDomainTransferFromAnotherAwsAccountRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  AcceptDomainTransferFromAnotherAwsAccountRequest& WithPassword(PasswordT&& value) {
