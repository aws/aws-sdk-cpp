...
class AssociateDelegationSignerToDomainResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API AssociateDelegationSignerToDomainResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  AssociateDelegationSignerToDomainResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateDelegationSignerToDomainResult& WithRequestId(RequestIdT&& value) {
