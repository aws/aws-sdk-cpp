...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API AssociateDelegationSignerToDomainResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    AssociateDelegationSignerToDomainResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateDelegationSignerToDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
