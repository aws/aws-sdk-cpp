...
namespace Model
{
  ...
  public:
    ...
    inline AcceptDomainTransferFromAnotherAwsAccountResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AcceptDomainTransferFromAnotherAwsAccountResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AcceptDomainTransferFromAnotherAwsAccountResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
