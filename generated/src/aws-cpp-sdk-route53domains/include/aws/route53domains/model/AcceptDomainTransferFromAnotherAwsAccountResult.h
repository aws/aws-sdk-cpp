...
class AcceptDomainTransferFromAnotherAwsAccountResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API AcceptDomainTransferFromAnotherAwsAccountResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename OperationIdT = Aws::String>
  AcceptDomainTransferFromAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AcceptDomainTransferFromAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) {
