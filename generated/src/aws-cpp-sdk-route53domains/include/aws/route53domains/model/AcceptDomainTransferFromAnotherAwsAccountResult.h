...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API AcceptDomainTransferFromAnotherAwsAccountResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    AcceptDomainTransferFromAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AcceptDomainTransferFromAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
