...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API UpdateTagsForDomainResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTagsForDomainResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
