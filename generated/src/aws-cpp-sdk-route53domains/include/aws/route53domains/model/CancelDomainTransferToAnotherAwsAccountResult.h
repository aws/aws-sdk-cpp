...
class CancelDomainTransferToAnotherAwsAccountResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API CancelDomainTransferToAnotherAwsAccountResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename OperationIdT = Aws::String>
  CancelDomainTransferToAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelDomainTransferToAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) {
