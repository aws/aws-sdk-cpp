...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API CancelDomainTransferToAnotherAwsAccountResult() = default;
    ...
    template<typename OperationIdT = Aws::String>
    CancelDomainTransferToAnotherAwsAccountResult& WithOperationId(OperationIdT&& value) { SetOperationId(std::forward<OperationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelDomainTransferToAnotherAwsAccountResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
