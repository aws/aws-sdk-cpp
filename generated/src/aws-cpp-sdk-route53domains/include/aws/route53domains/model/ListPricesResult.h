...
class ListPricesResult {
 public:
  ...
  template <typename PricesT = Aws::Vector<DomainPrice>>
  ListPricesResult& WithPrices(PricesT&& value) {
    SetPrices(std::forward<PricesT>(value));
    return *this;
  }
  template <typename PricesT = DomainPrice>
  ListPricesResult& AddPrices(PricesT&& value) {
    m_pricesHasBeenSet = true;
  ...
  template <typename NextPageMarkerT = Aws::String>
  ListPricesResult& WithNextPageMarker(NextPageMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPricesResult& WithRequestId(RequestIdT&& value) {
