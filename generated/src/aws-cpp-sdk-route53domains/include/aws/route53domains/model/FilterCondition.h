...
class FilterCondition {
 public:
  ...
  inline void SetName(ListDomainsAttributeName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline FilterCondition& WithName(ListDomainsAttributeName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline FilterCondition& WithOperator(Operator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  FilterCondition& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  FilterCondition& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
