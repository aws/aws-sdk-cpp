...
class UpdateDomainContactPrivacyResult {
 public:
  ...
  AWS_ROUTE53DOMAINS_API UpdateDomainContactPrivacyResult& operator=(
  ...
  template <typename OperationIdT = Aws::String>
  UpdateDomainContactPrivacyResult& WithOperationId(OperationIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDomainContactPrivacyResult& WithRequestId(RequestIdT&& value) {
