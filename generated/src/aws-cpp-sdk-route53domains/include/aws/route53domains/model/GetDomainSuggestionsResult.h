...
class GetDomainSuggestionsResult {
 public:
  ...
  void SetSuggestionsList(SuggestionsListT&& value) {
    m_suggestionsListHasBeenSet = true;
    m_suggestionsList = std::forward<SuggestionsListT>(value);
  }
  template <typename SuggestionsListT = Aws::Vector<DomainSuggestion>>
  GetDomainSuggestionsResult& WithSuggestionsList(SuggestionsListT&& value) {
    SetSuggestionsList(std::forward<SuggestionsListT>(value));
    return *this;
  }
  template <typename SuggestionsListT = DomainSuggestion>
  GetDomainSuggestionsResult& AddSuggestionsList(SuggestionsListT&& value) {
    m_suggestionsListHasBeenSet = true;
    m_suggestionsList.emplace_back(std::forward<SuggestionsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetDomainSuggestionsResult& WithRequestId(RequestIdT&& value) {
