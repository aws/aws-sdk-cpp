...
class DomainSummary {
 public:
  ...
  inline DomainSummary& WithAutoRenew(bool value) {
    SetAutoRenew(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransferLock(bool value) {
    m_transferLockHasBeenSet = true;
    m_transferLock = value;
  }
  inline DomainSummary& WithTransferLock(bool value) {
