...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    TransferDomainToAnotherAwsAccountRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountIdT = Aws::String>
    TransferDomainToAnotherAwsAccountRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
