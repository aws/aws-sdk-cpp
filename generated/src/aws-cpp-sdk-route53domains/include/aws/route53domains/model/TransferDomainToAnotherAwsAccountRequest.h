...
class TransferDomainToAnotherAwsAccountRequest : public Route53DomainsRequest {
 public:
  AWS_ROUTE53DOMAINS_API TransferDomainToAnotherAwsAccountRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  TransferDomainToAnotherAwsAccountRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  TransferDomainToAnotherAwsAccountRequest& WithAccountId(AccountIdT&& value) {
