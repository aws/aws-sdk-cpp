...
class RegisterDomainRequest : public Route53DomainsRequest {
 public:
  ...
  inline RegisterDomainRequest& WithDurationInYears(int value) {
  ...
  inline RegisterDomainRequest& WithAutoRenew(bool value) {
    SetAutoRenew(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterDomainRequest& WithPrivacyProtectAdminContact(bool value) {
  ...
  inline RegisterDomainRequest& WithPrivacyProtectRegistrantContact(bool value) {
  ...
  inline RegisterDomainRequest& WithPrivacyProtectTechContact(bool value) {
  ...
  inline RegisterDomainRequest& WithPrivacyProtectBillingContact(bool value) {
