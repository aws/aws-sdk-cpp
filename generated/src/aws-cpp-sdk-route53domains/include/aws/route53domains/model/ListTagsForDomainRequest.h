...
namespace Model
{
  ...
  {
  public:
    AWS_ROUTE53DOMAINS_API ListTagsForDomainRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    ListTagsForDomainRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
