...
class CheckDomainAvailabilityResult {
 public:
  ...
  inline void SetAvailability(DomainAvailability value) {
    m_availabilityHasBeenSet = true;
    m_availability = value;
  }
  inline CheckDomainAvailabilityResult& WithAvailability(DomainAvailability value) {
  ...
  template <typename RequestIdT = Aws::String>
  CheckDomainAvailabilityResult& WithRequestId(RequestIdT&& value) {
