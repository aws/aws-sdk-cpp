...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DisableDomainTransferLockRequest : public Route53DomainsRequest
  {
  public:
    AWS_ROUTE53DOMAINS_API DisableDomainTransferLockRequest() = default;
    ...
    template<typename DomainNameT = Aws::String>
    DisableDomainTransferLockRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
  private:
