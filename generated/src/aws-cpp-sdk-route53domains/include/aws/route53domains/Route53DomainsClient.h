...
class AWS_ROUTE53DOMAINS_API Route53DomainsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  Route53DomainsClient(const Aws::Route53Domains::Route53DomainsClientConfiguration& clientConfiguration =
  ...
  Route53DomainsClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<Route53DomainsEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::Route53Domains::Route53DomainsClientConfiguration& clientConfiguration =
                           Aws::Route53Domains::Route53DomainsClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptDomainTransferFromAnotherAwsAccountOutcome AcceptDomainTransferFromAnotherAwsAccount(
      const Model::AcceptDomainTransferFromAnotherAwsAccountRequest& request) const;

  /**
   * A Callable wrapper for AcceptDomainTransferFromAnotherAwsAccount that returns a future to the operation so that it can be executed in
  ...
  Model::AcceptDomainTransferFromAnotherAwsAccountOutcomeCallable AcceptDomainTransferFromAnotherAwsAccountCallable(
      const AcceptDomainTransferFromAnotherAwsAccountRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::AcceptDomainTransferFromAnotherAwsAccount, request);
  }

  /**
   * An Async wrapper for AcceptDomainTransferFromAnotherAwsAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AcceptDomainTransferFromAnotherAwsAccountRequestT = Model::AcceptDomainTransferFromAnotherAwsAccountRequest>
  void AcceptDomainTransferFromAnotherAwsAccountAsync(
      const AcceptDomainTransferFromAnotherAwsAccountRequestT& request,
      const AcceptDomainTransferFromAnotherAwsAccountResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateDelegationSignerToDomainOutcome AssociateDelegationSignerToDomain(
      const Model::AssociateDelegationSignerToDomainRequest& request) const;

  /**
   * A Callable wrapper for AssociateDelegationSignerToDomain that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateDelegationSignerToDomainRequestT = Model::AssociateDelegationSignerToDomainRequest>
  Model::AssociateDelegationSignerToDomainOutcomeCallable AssociateDelegationSignerToDomainCallable(
      const AssociateDelegationSignerToDomainRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::AssociateDelegationSignerToDomain, request);
  }

  /**
   * An Async wrapper for AssociateDelegationSignerToDomain that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateDelegationSignerToDomainRequestT = Model::AssociateDelegationSignerToDomainRequest>
  void AssociateDelegationSignerToDomainAsync(const AssociateDelegationSignerToDomainRequestT& request,
                                              const AssociateDelegationSignerToDomainResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CancelDomainTransferToAnotherAwsAccountOutcome CancelDomainTransferToAnotherAwsAccount(
      const Model::CancelDomainTransferToAnotherAwsAccountRequest& request) const;

  /**
   * A Callable wrapper for CancelDomainTransferToAnotherAwsAccount that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CancelDomainTransferToAnotherAwsAccountRequestT = Model::CancelDomainTransferToAnotherAwsAccountRequest>
  Model::CancelDomainTransferToAnotherAwsAccountOutcomeCallable CancelDomainTransferToAnotherAwsAccountCallable(
      const CancelDomainTransferToAnotherAwsAccountRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::CancelDomainTransferToAnotherAwsAccount, request);
  }

  /**
   * An Async wrapper for CancelDomainTransferToAnotherAwsAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CancelDomainTransferToAnotherAwsAccountRequestT = Model::CancelDomainTransferToAnotherAwsAccountRequest>
  void CancelDomainTransferToAnotherAwsAccountAsync(const CancelDomainTransferToAnotherAwsAccountRequestT& request,
                                                    const CancelDomainTransferToAnotherAwsAccountResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CheckDomainAvailability that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CheckDomainAvailability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CheckDomainAvailabilityRequestT = Model::CheckDomainAvailabilityRequest>
  void CheckDomainAvailabilityAsync(const CheckDomainAvailabilityRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CheckDomainTransferabilityOutcome CheckDomainTransferability(
      const Model::CheckDomainTransferabilityRequest& request) const;

  /**
   * A Callable wrapper for CheckDomainTransferability that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CheckDomainTransferabilityRequestT = Model::CheckDomainTransferabilityRequest>
  Model::CheckDomainTransferabilityOutcomeCallable CheckDomainTransferabilityCallable(
      const CheckDomainTransferabilityRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::CheckDomainTransferability, request);
  }

  /**
   * An Async wrapper for CheckDomainTransferability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CheckDomainTransferabilityRequestT = Model::CheckDomainTransferabilityRequest>
  void CheckDomainTransferabilityAsync(const CheckDomainTransferabilityRequestT& request,
                                       const CheckDomainTransferabilityResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTagsForDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTagsForDomain that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteTagsForDomainRequestT = Model::DeleteTagsForDomainRequest>
  void DeleteTagsForDomainAsync(const DeleteTagsForDomainRequestT& request, const DeleteTagsForDomainResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableDomainAutoRenew that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableDomainAutoRenew that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableDomainAutoRenewRequestT = Model::DisableDomainAutoRenewRequest>
  void DisableDomainAutoRenewAsync(const DisableDomainAutoRenewRequestT& request,
  ...
  /**
   * A Callable wrapper for DisableDomainTransferLock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DisableDomainTransferLockRequestT = Model::DisableDomainTransferLockRequest>
  Model::DisableDomainTransferLockOutcomeCallable DisableDomainTransferLockCallable(
      const DisableDomainTransferLockRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::DisableDomainTransferLock, request);
  }

  /**
   * An Async wrapper for DisableDomainTransferLock that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableDomainTransferLockRequestT = Model::DisableDomainTransferLockRequest>
  void DisableDomainTransferLockAsync(const DisableDomainTransferLockRequestT& request,
  ...
  virtual Model::DisassociateDelegationSignerFromDomainOutcome DisassociateDelegationSignerFromDomain(
      const Model::DisassociateDelegationSignerFromDomainRequest& request) const;

  /**
   * A Callable wrapper for DisassociateDelegationSignerFromDomain that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateDelegationSignerFromDomainRequestT = Model::DisassociateDelegationSignerFromDomainRequest>
  Model::DisassociateDelegationSignerFromDomainOutcomeCallable DisassociateDelegationSignerFromDomainCallable(
      const DisassociateDelegationSignerFromDomainRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::DisassociateDelegationSignerFromDomain, request);
  }

  /**
   * An Async wrapper for DisassociateDelegationSignerFromDomain that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateDelegationSignerFromDomainRequestT = Model::DisassociateDelegationSignerFromDomainRequest>
  void DisassociateDelegationSignerFromDomainAsync(const DisassociateDelegationSignerFromDomainRequestT& request,
                                                   const DisassociateDelegationSignerFromDomainResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableDomainAutoRenew that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableDomainAutoRenew that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableDomainAutoRenewRequestT = Model::EnableDomainAutoRenewRequest>
  void EnableDomainAutoRenewAsync(const EnableDomainAutoRenewRequestT& request, const EnableDomainAutoRenewResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableDomainTransferLock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableDomainTransferLock that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableDomainTransferLockRequestT = Model::EnableDomainTransferLockRequest>
  void EnableDomainTransferLockAsync(const EnableDomainTransferLockRequestT& request,
  ...
  virtual Model::GetContactReachabilityStatusOutcome GetContactReachabilityStatus(
      const Model::GetContactReachabilityStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for GetContactReachabilityStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetContactReachabilityStatusRequestT = Model::GetContactReachabilityStatusRequest>
  Model::GetContactReachabilityStatusOutcomeCallable GetContactReachabilityStatusCallable(
      const GetContactReachabilityStatusRequestT& request = {}) const {
    return SubmitCallable(&Route53DomainsClient::GetContactReachabilityStatus, request);
  }

  /**
   * An Async wrapper for GetContactReachabilityStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContactReachabilityStatusRequestT = Model::GetContactReachabilityStatusRequest>
  void GetContactReachabilityStatusAsync(const GetContactReachabilityStatusResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for GetDomainDetail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDomainDetailRequestT = Model::GetDomainDetailRequest>
  void GetDomainDetailAsync(const GetDomainDetailRequestT& request, const GetDomainDetailResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDomainSuggestions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDomainSuggestions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDomainSuggestionsRequestT = Model::GetDomainSuggestionsRequest>
  void GetDomainSuggestionsAsync(const GetDomainSuggestionsRequestT& request, const GetDomainSuggestionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOperationDetail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOperationDetail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetOperationDetailRequestT = Model::GetOperationDetailRequest>
  void GetOperationDetailAsync(const GetOperationDetailRequestT& request, const GetOperationDetailResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListOperations that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOperationsRequestT = Model::ListOperationsRequest>
  void ListOperationsAsync(const ListOperationsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListOperationsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListPrices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPricesRequestT = Model::ListPricesRequest>
  void ListPricesAsync(const ListPricesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListPricesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTagsForDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTagsForDomain that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTagsForDomainRequestT = Model::ListTagsForDomainRequest>
  void ListTagsForDomainAsync(const ListTagsForDomainRequestT& request, const ListTagsForDomainResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PushDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PushDomainRequestT = Model::PushDomainRequest>
  void PushDomainAsync(const PushDomainRequestT& request, const PushDomainResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RegisterDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterDomainRequestT = Model::RegisterDomainRequest>
  void RegisterDomainAsync(const RegisterDomainRequestT& request, const RegisterDomainResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::RejectDomainTransferFromAnotherAwsAccountOutcome RejectDomainTransferFromAnotherAwsAccount(
      const Model::RejectDomainTransferFromAnotherAwsAccountRequest& request) const;

  /**
   * A Callable wrapper for RejectDomainTransferFromAnotherAwsAccount that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::RejectDomainTransferFromAnotherAwsAccountOutcomeCallable RejectDomainTransferFromAnotherAwsAccountCallable(
      const RejectDomainTransferFromAnotherAwsAccountRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::RejectDomainTransferFromAnotherAwsAccount, request);
  }

  /**
   * An Async wrapper for RejectDomainTransferFromAnotherAwsAccount that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename RejectDomainTransferFromAnotherAwsAccountRequestT = Model::RejectDomainTransferFromAnotherAwsAccountRequest>
  void RejectDomainTransferFromAnotherAwsAccountAsync(
      const RejectDomainTransferFromAnotherAwsAccountRequestT& request,
      const RejectDomainTransferFromAnotherAwsAccountResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RenewDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RenewDomainRequestT = Model::RenewDomainRequest>
  void RenewDomainAsync(const RenewDomainRequestT& request, const RenewDomainResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResendContactReachabilityEmailOutcome ResendContactReachabilityEmail(
      const Model::ResendContactReachabilityEmailRequest& request = {}) const;

  /**
   * A Callable wrapper for ResendContactReachabilityEmail that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResendContactReachabilityEmailRequestT = Model::ResendContactReachabilityEmailRequest>
  Model::ResendContactReachabilityEmailOutcomeCallable ResendContactReachabilityEmailCallable(
      const ResendContactReachabilityEmailRequestT& request = {}) const {
    return SubmitCallable(&Route53DomainsClient::ResendContactReachabilityEmail, request);
  }

  /**
   * An Async wrapper for ResendContactReachabilityEmail that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ResendContactReachabilityEmailRequestT = Model::ResendContactReachabilityEmailRequest>
  void ResendContactReachabilityEmailAsync(const ResendContactReachabilityEmailResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ResendContactReachabilityEmailRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResendOperationAuthorizationOutcome ResendOperationAuthorization(
      const Model::ResendOperationAuthorizationRequest& request) const;

  /**
   * A Callable wrapper for ResendOperationAuthorization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResendOperationAuthorizationRequestT = Model::ResendOperationAuthorizationRequest>
  Model::ResendOperationAuthorizationOutcomeCallable ResendOperationAuthorizationCallable(
      const ResendOperationAuthorizationRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::ResendOperationAuthorization, request);
  }

  /**
   * An Async wrapper for ResendOperationAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResendOperationAuthorizationRequestT = Model::ResendOperationAuthorizationRequest>
  void ResendOperationAuthorizationAsync(const ResendOperationAuthorizationRequestT& request,
                                         const ResendOperationAuthorizationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RetrieveDomainAuthCode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RetrieveDomainAuthCode that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RetrieveDomainAuthCodeRequestT = Model::RetrieveDomainAuthCodeRequest>
  void RetrieveDomainAuthCodeAsync(const RetrieveDomainAuthCodeRequestT& request,
  ...
  /**
   * An Async wrapper for TransferDomain that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TransferDomainRequestT = Model::TransferDomainRequest>
  void TransferDomainAsync(const TransferDomainRequestT& request, const TransferDomainResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::TransferDomainToAnotherAwsAccountOutcome TransferDomainToAnotherAwsAccount(
      const Model::TransferDomainToAnotherAwsAccountRequest& request) const;

  /**
   * A Callable wrapper for TransferDomainToAnotherAwsAccount that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename TransferDomainToAnotherAwsAccountRequestT = Model::TransferDomainToAnotherAwsAccountRequest>
  Model::TransferDomainToAnotherAwsAccountOutcomeCallable TransferDomainToAnotherAwsAccountCallable(
      const TransferDomainToAnotherAwsAccountRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::TransferDomainToAnotherAwsAccount, request);
  }

  /**
   * An Async wrapper for TransferDomainToAnotherAwsAccount that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename TransferDomainToAnotherAwsAccountRequestT = Model::TransferDomainToAnotherAwsAccountRequest>
  void TransferDomainToAnotherAwsAccountAsync(const TransferDomainToAnotherAwsAccountRequestT& request,
                                              const TransferDomainToAnotherAwsAccountResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDomainContact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainContact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDomainContactRequestT = Model::UpdateDomainContactRequest>
  void UpdateDomainContactAsync(const UpdateDomainContactRequestT& request, const UpdateDomainContactResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDomainContactPrivacyOutcome UpdateDomainContactPrivacy(
      const Model::UpdateDomainContactPrivacyRequest& request) const;

  /**
   * A Callable wrapper for UpdateDomainContactPrivacy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateDomainContactPrivacyRequestT = Model::UpdateDomainContactPrivacyRequest>
  Model::UpdateDomainContactPrivacyOutcomeCallable UpdateDomainContactPrivacyCallable(
      const UpdateDomainContactPrivacyRequestT& request) const {
    return SubmitCallable(&Route53DomainsClient::UpdateDomainContactPrivacy, request);
  }

  /**
   * An Async wrapper for UpdateDomainContactPrivacy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDomainContactPrivacyRequestT = Model::UpdateDomainContactPrivacyRequest>
  void UpdateDomainContactPrivacyAsync(const UpdateDomainContactPrivacyRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateDomainNameservers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDomainNameservers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDomainNameserversRequestT = Model::UpdateDomainNameserversRequest>
  void UpdateDomainNameserversAsync(const UpdateDomainNameserversRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateTagsForDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTagsForDomain that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTagsForDomainRequestT = Model::UpdateTagsForDomainRequest>
  void UpdateTagsForDomainAsync(const UpdateTagsForDomainRequestT& request, const UpdateTagsForDomainResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ViewBilling that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ViewBillingRequestT = Model::ViewBillingRequest>
  void ViewBillingAsync(const ViewBillingResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ViewBillingRequestT& request = {}) const {
