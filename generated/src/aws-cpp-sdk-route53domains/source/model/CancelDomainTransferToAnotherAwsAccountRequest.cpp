...
Aws::Http::HeaderValueCollection CancelDomainTransferToAnotherAwsAccountRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount"));
  return headers;
