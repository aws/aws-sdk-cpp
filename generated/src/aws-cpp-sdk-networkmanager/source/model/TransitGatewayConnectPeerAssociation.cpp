...
TransitGatewayConnectPeerAssociation::TransitGatewayConnectPeerAssociation(JsonView jsonValue) { *this = jsonValue; }
...
TransitGatewayConnectPeerAssociation& TransitGatewayConnectPeerAssociation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("State")) {
    m_state =
        TransitGatewayConnectPeerAssociationStateMapper::GetTransitGatewayConnectPeerAssociationStateForName(jsonValue.GetString("State"));
...
JsonValue TransitGatewayConnectPeerAssociation::Jsonize() const {
  ...
  if (m_stateHasBeenSet) {
    payload.WithString("State",
                       TransitGatewayConnectPeerAssociationStateMapper::GetNameForTransitGatewayConnectPeerAssociationState(m_state));
  }
