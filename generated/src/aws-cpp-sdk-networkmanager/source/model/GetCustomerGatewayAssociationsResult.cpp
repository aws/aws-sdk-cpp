...
GetCustomerGatewayAssociationsResult& GetCustomerGatewayAssociationsResult::operator=(
  ...
  if (jsonValue.ValueExists("CustomerGatewayAssociations")) {
    ...
    for (unsigned customerGatewayAssociationsIndex = 0; customerGatewayAssociationsIndex < customerGatewayAssociationsJsonList.GetLength();
         ++customerGatewayAssociationsIndex) {
