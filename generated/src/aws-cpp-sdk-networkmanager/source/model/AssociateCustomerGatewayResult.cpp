...
AssociateCustomerGatewayResult::AssociateCustomerGatewayResult()
{
}

AssociateCustomerGatewayResult::AssociateCustomerGatewayResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
