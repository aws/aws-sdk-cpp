...
GetTransitGatewayRegistrationsResult& GetTransitGatewayRegistrationsResult::operator=(
  ...
  if (jsonValue.ValueExists("TransitGatewayRegistrations")) {
    ...
    for (unsigned transitGatewayRegistrationsIndex = 0; transitGatewayRegistrationsIndex < transitGatewayRegistrationsJsonList.GetLength();
         ++transitGatewayRegistrationsIndex) {
