...
Aws::String GetNetworkResourceRelationshipsRequest::SerializePayload() const { return {}; }

void GetNetworkResourceRelationshipsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
