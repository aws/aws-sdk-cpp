...
Via::Via(JsonView jsonValue) { *this = jsonValue; }
...
Via& Via::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("NetworkFunctionGroups")) {
    ...
    for (unsigned networkFunctionGroupsIndex = 0; networkFunctionGroupsIndex < networkFunctionGroupsJsonList.GetLength();
         ++networkFunctionGroupsIndex) {
