...
GetCoreNetworkChangeEventsResult::GetCoreNetworkChangeEventsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetCoreNetworkChangeEventsResult& GetCoreNetworkChangeEventsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("CoreNetworkChangeEvents")) {
    ...
    for (unsigned coreNetworkChangeEventsIndex = 0; coreNetworkChangeEventsIndex < coreNetworkChangeEventsJsonList.GetLength();
         ++coreNetworkChangeEventsIndex) {
