...
DeleteGlobalNetworkResult::DeleteGlobalNetworkResult()
{
}

DeleteGlobalNetworkResult::DeleteGlobalNetworkResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
