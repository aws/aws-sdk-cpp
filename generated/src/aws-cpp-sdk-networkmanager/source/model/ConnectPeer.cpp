...
ConnectPeer::ConnectPeer(JsonView jsonValue) { *this = jsonValue; }
...
ConnectPeer& ConnectPeer::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LastModificationErrors")) {
    ...
    for (unsigned lastModificationErrorsIndex = 0; lastModificationErrorsIndex < lastModificationErrorsJsonList.GetLength();
         ++lastModificationErrorsIndex) {
