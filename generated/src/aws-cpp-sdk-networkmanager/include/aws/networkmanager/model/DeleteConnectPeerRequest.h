...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API DeleteConnectPeerRequest() = default;
    ...
    template<typename ConnectPeerIdT = Aws::String>
    DeleteConnectPeerRequest& WithConnectPeerId(ConnectPeerIdT&& value) { SetConnectPeerId(std::forward<ConnectPeerIdT>(value)); return *this;}
    ///@}
  private:
