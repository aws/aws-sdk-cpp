...
class DisassociateCustomerGatewayRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  DisassociateCustomerGatewayRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  void SetCustomerGatewayArn(CustomerGatewayArnT&& value) {
    ...
    m_customerGatewayArn = std::forward<CustomerGatewayArnT>(value);
  }
  template <typename CustomerGatewayArnT = Aws::String>
  DisassociateCustomerGatewayRequest& WithCustomerGatewayArn(CustomerGatewayArnT&& value) {
    SetCustomerGatewayArn(std::forward<CustomerGatewayArnT>(value));
    return *this;
  }
  ///@}
 private:
