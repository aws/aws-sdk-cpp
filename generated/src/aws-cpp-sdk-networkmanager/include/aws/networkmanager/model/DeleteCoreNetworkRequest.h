...
class DeleteCoreNetworkRequest : public NetworkManagerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteCoreNetwork"; }
  ...
  template <typename CoreNetworkIdT = Aws::String>
  DeleteCoreNetworkRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
