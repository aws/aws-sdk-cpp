...
class GetLinkAssociationsResult {
 public:
  ...
  void SetLinkAssociations(LinkAssociationsT&& value) {
    m_linkAssociationsHasBeenSet = true;
    m_linkAssociations = std::forward<LinkAssociationsT>(value);
  }
  template <typename LinkAssociationsT = Aws::Vector<LinkAssociation>>
  GetLinkAssociationsResult& WithLinkAssociations(LinkAssociationsT&& value) {
    SetLinkAssociations(std::forward<LinkAssociationsT>(value));
    return *this;
  }
  template <typename LinkAssociationsT = LinkAssociation>
  GetLinkAssociationsResult& AddLinkAssociations(LinkAssociationsT&& value) {
    m_linkAssociationsHasBeenSet = true;
    m_linkAssociations.emplace_back(std::forward<LinkAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetLinkAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLinkAssociationsResult& WithRequestId(RequestIdT&& value) {
