...
class RouteAnalysisEndpointOptionsSpecification {
 public:
  ...
  void SetTransitGatewayAttachmentArn(TransitGatewayAttachmentArnT&& value) {
    ...
    m_transitGatewayAttachmentArn = std::forward<TransitGatewayAttachmentArnT>(value);
  }
  template <typename TransitGatewayAttachmentArnT = Aws::String>
  RouteAnalysisEndpointOptionsSpecification& WithTransitGatewayAttachmentArn(TransitGatewayAttachmentArnT&& value) {
    SetTransitGatewayAttachmentArn(std::forward<TransitGatewayAttachmentArnT>(value));
    return *this;
  }
  ///@}
