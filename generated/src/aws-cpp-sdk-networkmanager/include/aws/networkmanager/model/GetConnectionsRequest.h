...
namespace Model
{
  ...
  public:
    ...
    template<typename GlobalNetworkIdT = Aws::String>
    GetConnectionsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) { SetGlobalNetworkId(std::forward<GlobalNetworkIdT>(value)); return *this;}
    ///@}
    ...
    void SetConnectionIds(ConnectionIdsT&& value) { m_connectionIdsHasBeenSet = true; m_connectionIds = std::forward<ConnectionIdsT>(value); }
    template<typename ConnectionIdsT = Aws::Vector<Aws::String>>
    GetConnectionsRequest& WithConnectionIds(ConnectionIdsT&& value) { SetConnectionIds(std::forward<ConnectionIdsT>(value)); return *this;}
    template<typename ConnectionIdsT = Aws::String>
    GetConnectionsRequest& AddConnectionIds(ConnectionIdsT&& value) { m_connectionIdsHasBeenSet = true; m_connectionIds.emplace_back(std::forward<ConnectionIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename DeviceIdT = Aws::String>
    GetConnectionsRequest& WithDeviceId(DeviceIdT&& value) { SetDeviceId(std::forward<DeviceIdT>(value)); return *this;}
    ///@}
