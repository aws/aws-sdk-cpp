...
class NetworkResourceSummary {
 public:
  ...
  void SetNameTag(NameTagT&& value) {
    ...
    m_nameTag = std::forward<NameTagT>(value);
  }
  template <typename NameTagT = Aws::String>
  NetworkResourceSummary& WithNameTag(NameTagT&& value) {
    SetNameTag(std::forward<NameTagT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsMiddlebox(bool value) {
    m_isMiddleboxHasBeenSet = true;
    m_isMiddlebox = value;
  }
  inline NetworkResourceSummary& WithIsMiddlebox(bool value) {
    SetIsMiddlebox(value);
    return *this;
  }
  ///@}
 private:
