...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API PutCoreNetworkPolicyResult() = default;
    ...
    template<typename CoreNetworkPolicyT = CoreNetworkPolicy>
    PutCoreNetworkPolicyResult& WithCoreNetworkPolicy(CoreNetworkPolicyT&& value) { SetCoreNetworkPolicy(std::forward<CoreNetworkPolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutCoreNetworkPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
