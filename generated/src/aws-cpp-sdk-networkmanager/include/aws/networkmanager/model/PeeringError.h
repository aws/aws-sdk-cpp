...
class PeeringError {
 public:
  ...
  inline void SetCode(PeeringErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline PeeringError& WithCode(PeeringErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  PeeringError& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  PeeringError& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PeeringError& WithRequestId(RequestIdT&& value) {
  ...
  void SetMissingPermissionsContext(MissingPermissionsContextT&& value) {
    m_missingPermissionsContextHasBeenSet = true;
    m_missingPermissionsContext = std::forward<MissingPermissionsContextT>(value);
  }
  template <typename MissingPermissionsContextT = PermissionsErrorContext>
  PeeringError& WithMissingPermissionsContext(MissingPermissionsContextT&& value) {
    SetMissingPermissionsContext(std::forward<MissingPermissionsContextT>(value));
    return *this;
  }
  ///@}
 private:
