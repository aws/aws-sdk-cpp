...
class GetNetworkResourcesRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetNetworkResourcesRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename CoreNetworkIdT = Aws::String>
  GetNetworkResourcesRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename RegisteredGatewayArnT = Aws::String>
  GetNetworkResourcesRequest& WithRegisteredGatewayArn(RegisteredGatewayArnT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  GetNetworkResourcesRequest& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetNetworkResourcesRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  GetNetworkResourcesRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  GetNetworkResourcesRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline GetNetworkResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkResourcesRequest& WithNextToken(NextTokenT&& value) {
