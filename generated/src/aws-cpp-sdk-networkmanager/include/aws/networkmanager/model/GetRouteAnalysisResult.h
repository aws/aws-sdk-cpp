...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API GetRouteAnalysisResult() = default;
    ...
    template<typename RouteAnalysisT = RouteAnalysis>
    GetRouteAnalysisResult& WithRouteAnalysis(RouteAnalysisT&& value) { SetRouteAnalysis(std::forward<RouteAnalysisT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetRouteAnalysisResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
