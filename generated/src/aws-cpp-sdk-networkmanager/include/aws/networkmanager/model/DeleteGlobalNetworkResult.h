...
class DeleteGlobalNetworkResult {
 public:
  ...
  void SetGlobalNetwork(GlobalNetworkT&& value) {
    ...
    m_globalNetwork = std::forward<GlobalNetworkT>(value);
  }
  template <typename GlobalNetworkT = GlobalNetwork>
  DeleteGlobalNetworkResult& WithGlobalNetwork(GlobalNetworkT&& value) {
    SetGlobalNetwork(std::forward<GlobalNetworkT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteGlobalNetworkResult& WithRequestId(RequestIdT&& value) {
