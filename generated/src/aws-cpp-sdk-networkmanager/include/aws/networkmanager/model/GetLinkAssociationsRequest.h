...
/**
 */
class GetLinkAssociationsRequest : public NetworkManagerRequest {
 public:
  AWS_NETWORKMANAGER_API GetLinkAssociationsRequest() = default;
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetLinkAssociationsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  GetLinkAssociationsRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  GetLinkAssociationsRequest& WithLinkId(LinkIdT&& value) {
  ...
  inline GetLinkAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetLinkAssociationsRequest& WithNextToken(NextTokenT&& value) {
