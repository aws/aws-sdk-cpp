...
class AssociateCustomerGatewayRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename CustomerGatewayArnT = Aws::String>
  AssociateCustomerGatewayRequest& WithCustomerGatewayArn(CustomerGatewayArnT&& value) {
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  AssociateCustomerGatewayRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  AssociateCustomerGatewayRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  AssociateCustomerGatewayRequest& WithLinkId(LinkIdT&& value) {
