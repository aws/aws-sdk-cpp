...
class TransitGatewayPeering {
 public:
  ...
  template <typename PeeringT = Peering>
  TransitGatewayPeering& WithPeering(PeeringT&& value) {
  ...
  template <typename TransitGatewayArnT = Aws::String>
  TransitGatewayPeering& WithTransitGatewayArn(TransitGatewayArnT&& value) {
  ...
  void SetTransitGatewayPeeringAttachmentId(TransitGatewayPeeringAttachmentIdT&& value) {
    m_transitGatewayPeeringAttachmentIdHasBeenSet = true;
    m_transitGatewayPeeringAttachmentId = std::forward<TransitGatewayPeeringAttachmentIdT>(value);
  }
  template <typename TransitGatewayPeeringAttachmentIdT = Aws::String>
  TransitGatewayPeering& WithTransitGatewayPeeringAttachmentId(TransitGatewayPeeringAttachmentIdT&& value) {
    SetTransitGatewayPeeringAttachmentId(std::forward<TransitGatewayPeeringAttachmentIdT>(value));
    return *this;
  }
  ///@}
 private:
