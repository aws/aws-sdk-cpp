...
class LinkAssociation {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  LinkAssociation& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  LinkAssociation& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  LinkAssociation& WithLinkId(LinkIdT&& value) {
  ...
  inline void SetLinkAssociationState(LinkAssociationState value) {
    m_linkAssociationStateHasBeenSet = true;
    m_linkAssociationState = value;
  }
  inline LinkAssociation& WithLinkAssociationState(LinkAssociationState value) {
    SetLinkAssociationState(value);
    return *this;
  }
  ///@}
 private:
