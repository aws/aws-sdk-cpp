...
class GetNetworkTelemetryRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetNetworkTelemetryRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename CoreNetworkIdT = Aws::String>
  GetNetworkTelemetryRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename RegisteredGatewayArnT = Aws::String>
  GetNetworkTelemetryRequest& WithRegisteredGatewayArn(RegisteredGatewayArnT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  GetNetworkTelemetryRequest& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetNetworkTelemetryRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  GetNetworkTelemetryRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  GetNetworkTelemetryRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline GetNetworkTelemetryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkTelemetryRequest& WithNextToken(NextTokenT&& value) {
