...
class GetCoreNetworkChangeEventsRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  GetCoreNetworkChangeEventsRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline GetCoreNetworkChangeEventsRequest& WithPolicyVersionId(int value) {
  ...
  inline GetCoreNetworkChangeEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCoreNetworkChangeEventsRequest& WithNextToken(NextTokenT&& value) {
