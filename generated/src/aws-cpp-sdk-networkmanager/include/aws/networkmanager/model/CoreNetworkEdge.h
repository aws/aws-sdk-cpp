...
class CoreNetworkEdge {
 public:
  ...
  template <typename EdgeLocationT = Aws::String>
  CoreNetworkEdge& WithEdgeLocation(EdgeLocationT&& value) {
  ...
  inline CoreNetworkEdge& WithAsn(long long value) {
    SetAsn(value);
    return *this;
  }
  ///@}
  ...
  template <typename InsideCidrBlocksT = Aws::Vector<Aws::String>>
  CoreNetworkEdge& WithInsideCidrBlocks(InsideCidrBlocksT&& value) {
    SetInsideCidrBlocks(std::forward<InsideCidrBlocksT>(value));
    return *this;
  }
  template <typename InsideCidrBlocksT = Aws::String>
  CoreNetworkEdge& AddInsideCidrBlocks(InsideCidrBlocksT&& value) {
    m_insideCidrBlocksHasBeenSet = true;
