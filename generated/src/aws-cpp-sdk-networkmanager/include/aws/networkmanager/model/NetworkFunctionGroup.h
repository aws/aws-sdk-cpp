...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API NetworkFunctionGroup();
     ...
     * <p>The name of the network function group.</p>
     */
    inline NetworkFunctionGroup& WithName(const Aws::String& value) { SetName(value); return *this;}

    /**
     * <p>The name of the network function group.</p>
     */
    inline NetworkFunctionGroup& WithName(Aws::String&& value) { SetName(std::move(value)); return *this;}

    /**
     * <p>The name of the network function group.</p>
     */
    inline NetworkFunctionGroup& WithName(const char* value) { SetName(value); return *this;}
