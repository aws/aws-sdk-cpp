...
class ListPeeringsResult {
 public:
  ...
  void SetPeerings(PeeringsT&& value) {
    m_peeringsHasBeenSet = true;
    m_peerings = std::forward<PeeringsT>(value);
  }
  template <typename PeeringsT = Aws::Vector<Peering>>
  ListPeeringsResult& WithPeerings(PeeringsT&& value) {
    SetPeerings(std::forward<PeeringsT>(value));
    return *this;
  }
  template <typename PeeringsT = Peering>
  ListPeeringsResult& AddPeerings(PeeringsT&& value) {
    m_peeringsHasBeenSet = true;
    m_peerings.emplace_back(std::forward<PeeringsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPeeringsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPeeringsResult& WithRequestId(RequestIdT&& value) {
