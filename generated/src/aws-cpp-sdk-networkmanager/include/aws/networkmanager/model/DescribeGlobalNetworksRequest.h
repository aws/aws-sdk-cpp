...
class DescribeGlobalNetworksRequest : public NetworkManagerRequest {
 public:
  ...
  void SetGlobalNetworkIds(GlobalNetworkIdsT&& value) {
    m_globalNetworkIdsHasBeenSet = true;
    m_globalNetworkIds = std::forward<GlobalNetworkIdsT>(value);
  }
  template <typename GlobalNetworkIdsT = Aws::Vector<Aws::String>>
  DescribeGlobalNetworksRequest& WithGlobalNetworkIds(GlobalNetworkIdsT&& value) {
    SetGlobalNetworkIds(std::forward<GlobalNetworkIdsT>(value));
    return *this;
  }
  template <typename GlobalNetworkIdsT = Aws::String>
  DescribeGlobalNetworksRequest& AddGlobalNetworkIds(GlobalNetworkIdsT&& value) {
    m_globalNetworkIdsHasBeenSet = true;
    m_globalNetworkIds.emplace_back(std::forward<GlobalNetworkIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeGlobalNetworksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeGlobalNetworksRequest& WithNextToken(NextTokenT&& value) {
