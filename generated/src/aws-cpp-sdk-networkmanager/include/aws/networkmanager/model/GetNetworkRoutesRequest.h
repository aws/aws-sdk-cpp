...
class GetNetworkRoutesRequest : public NetworkManagerRequest {
 public:
  ...
  void SetRouteTableIdentifier(RouteTableIdentifierT&& value) {
    m_routeTableIdentifierHasBeenSet = true;
    m_routeTableIdentifier = std::forward<RouteTableIdentifierT>(value);
  }
  template <typename RouteTableIdentifierT = RouteTableIdentifier>
  GetNetworkRoutesRequest& WithRouteTableIdentifier(RouteTableIdentifierT&& value) {
    SetRouteTableIdentifier(std::forward<RouteTableIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExactCidrMatches(ExactCidrMatchesT&& value) {
    m_exactCidrMatchesHasBeenSet = true;
    m_exactCidrMatches = std::forward<ExactCidrMatchesT>(value);
  }
  template <typename ExactCidrMatchesT = Aws::Vector<Aws::String>>
  GetNetworkRoutesRequest& WithExactCidrMatches(ExactCidrMatchesT&& value) {
    SetExactCidrMatches(std::forward<ExactCidrMatchesT>(value));
    return *this;
  }
  template <typename ExactCidrMatchesT = Aws::String>
  GetNetworkRoutesRequest& AddExactCidrMatches(ExactCidrMatchesT&& value) {
    m_exactCidrMatchesHasBeenSet = true;
    m_exactCidrMatches.emplace_back(std::forward<ExactCidrMatchesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLongestPrefixMatches(LongestPrefixMatchesT&& value) {
    m_longestPrefixMatchesHasBeenSet = true;
    m_longestPrefixMatches = std::forward<LongestPrefixMatchesT>(value);
  }
  template <typename LongestPrefixMatchesT = Aws::Vector<Aws::String>>
  GetNetworkRoutesRequest& WithLongestPrefixMatches(LongestPrefixMatchesT&& value) {
    SetLongestPrefixMatches(std::forward<LongestPrefixMatchesT>(value));
    return *this;
  }
  ...
  GetNetworkRoutesRequest& AddLongestPrefixMatches(LongestPrefixMatchesT&& value) {
    m_longestPrefixMatchesHasBeenSet = true;
    m_longestPrefixMatches.emplace_back(std::forward<LongestPrefixMatchesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubnetOfMatches(SubnetOfMatchesT&& value) {
    m_subnetOfMatchesHasBeenSet = true;
    m_subnetOfMatches = std::forward<SubnetOfMatchesT>(value);
  }
  template <typename SubnetOfMatchesT = Aws::Vector<Aws::String>>
  GetNetworkRoutesRequest& WithSubnetOfMatches(SubnetOfMatchesT&& value) {
    SetSubnetOfMatches(std::forward<SubnetOfMatchesT>(value));
    return *this;
  }
  template <typename SubnetOfMatchesT = Aws::String>
  GetNetworkRoutesRequest& AddSubnetOfMatches(SubnetOfMatchesT&& value) {
    m_subnetOfMatchesHasBeenSet = true;
    m_subnetOfMatches.emplace_back(std::forward<SubnetOfMatchesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSupernetOfMatches(SupernetOfMatchesT&& value) {
    m_supernetOfMatchesHasBeenSet = true;
    m_supernetOfMatches = std::forward<SupernetOfMatchesT>(value);
  }
  template <typename SupernetOfMatchesT = Aws::Vector<Aws::String>>
  GetNetworkRoutesRequest& WithSupernetOfMatches(SupernetOfMatchesT&& value) {
    SetSupernetOfMatches(std::forward<SupernetOfMatchesT>(value));
    return *this;
  }
  template <typename SupernetOfMatchesT = Aws::String>
  GetNetworkRoutesRequest& AddSupernetOfMatches(SupernetOfMatchesT&& value) {
    m_supernetOfMatchesHasBeenSet = true;
    m_supernetOfMatches.emplace_back(std::forward<SupernetOfMatchesT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetNetworkRoutesRequest& AddStates(RouteState value) {
    m_statesHasBeenSet = true;
  ...
  inline GetNetworkRoutesRequest& AddTypes(RouteType value) {
    m_typesHasBeenSet = true;
  ...
  void SetDestinationFilters(DestinationFiltersT&& value) {
    m_destinationFiltersHasBeenSet = true;
    m_destinationFilters = std::forward<DestinationFiltersT>(value);
  }
  template <typename DestinationFiltersT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  GetNetworkRoutesRequest& WithDestinationFilters(DestinationFiltersT&& value) {
    SetDestinationFilters(std::forward<DestinationFiltersT>(value));
    return *this;
  }
  ...
  GetNetworkRoutesRequest& AddDestinationFilters(DestinationFiltersKeyT&& key, DestinationFiltersValueT&& value) {
    m_destinationFiltersHasBeenSet = true;
    m_destinationFilters.emplace(std::forward<DestinationFiltersKeyT>(key), std::forward<DestinationFiltersValueT>(value));
    return *this;
  }
  ///@}
 private:
