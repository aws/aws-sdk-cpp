...
class GetNetworkResourceRelationshipsRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename CoreNetworkIdT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename RegisteredGatewayArnT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithRegisteredGatewayArn(RegisteredGatewayArnT&& value) {
  ...
  template <typename AwsRegionT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithAwsRegion(AwsRegionT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  inline GetNetworkResourceRelationshipsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkResourceRelationshipsRequest& WithNextToken(NextTokenT&& value) {
