...
class AssociateConnectPeerRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  AssociateConnectPeerRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  void SetConnectPeerId(ConnectPeerIdT&& value) {
    ...
    m_connectPeerId = std::forward<ConnectPeerIdT>(value);
  }
  template <typename ConnectPeerIdT = Aws::String>
  AssociateConnectPeerRequest& WithConnectPeerId(ConnectPeerIdT&& value) {
    SetConnectPeerId(std::forward<ConnectPeerIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DeviceIdT = Aws::String>
  AssociateConnectPeerRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  AssociateConnectPeerRequest& WithLinkId(LinkIdT&& value) {
