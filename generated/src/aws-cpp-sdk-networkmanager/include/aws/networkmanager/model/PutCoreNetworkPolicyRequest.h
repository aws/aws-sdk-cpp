...
class PutCoreNetworkPolicyRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  PutCoreNetworkPolicyRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  PutCoreNetworkPolicyRequest& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PutCoreNetworkPolicyRequest& WithDescription(DescriptionT&& value) {
  ...
  inline void SetLatestVersionId(int value) {
    m_latestVersionIdHasBeenSet = true;
    m_latestVersionId = value;
  }
  inline PutCoreNetworkPolicyRequest& WithLatestVersionId(int value) {
    SetLatestVersionId(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  PutCoreNetworkPolicyRequest& WithClientToken(ClientTokenT&& value) {
