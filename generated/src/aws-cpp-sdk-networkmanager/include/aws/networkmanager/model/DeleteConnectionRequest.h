...
class DeleteConnectionRequest : public NetworkManagerRequest {
 public:
  AWS_NETWORKMANAGER_API DeleteConnectionRequest() = default;
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  DeleteConnectionRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename ConnectionIdT = Aws::String>
  DeleteConnectionRequest& WithConnectionId(ConnectionIdT&& value) {
