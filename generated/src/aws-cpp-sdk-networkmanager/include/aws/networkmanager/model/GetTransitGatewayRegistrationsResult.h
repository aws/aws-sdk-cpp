...
class GetTransitGatewayRegistrationsResult {
 public:
  ...
  AWS_NETWORKMANAGER_API GetTransitGatewayRegistrationsResult& operator=(
  ...
  void SetTransitGatewayRegistrations(TransitGatewayRegistrationsT&& value) {
    ...
    m_transitGatewayRegistrations = std::forward<TransitGatewayRegistrationsT>(value);
  }
  template <typename TransitGatewayRegistrationsT = Aws::Vector<TransitGatewayRegistration>>
  GetTransitGatewayRegistrationsResult& WithTransitGatewayRegistrations(TransitGatewayRegistrationsT&& value) {
    SetTransitGatewayRegistrations(std::forward<TransitGatewayRegistrationsT>(value));
    return *this;
  }
  ...
  GetTransitGatewayRegistrationsResult& AddTransitGatewayRegistrations(TransitGatewayRegistrationsT&& value) {
    m_transitGatewayRegistrationsHasBeenSet = true;
    m_transitGatewayRegistrations.emplace_back(std::forward<TransitGatewayRegistrationsT>(value));
    return *this;
  }
  ///@}
