...
class GetCoreNetworkChangeSetResult {
 public:
  ...
  void SetCoreNetworkChanges(CoreNetworkChangesT&& value) {
    m_coreNetworkChangesHasBeenSet = true;
    m_coreNetworkChanges = std::forward<CoreNetworkChangesT>(value);
  }
  template <typename CoreNetworkChangesT = Aws::Vector<CoreNetworkChange>>
  GetCoreNetworkChangeSetResult& WithCoreNetworkChanges(CoreNetworkChangesT&& value) {
    SetCoreNetworkChanges(std::forward<CoreNetworkChangesT>(value));
    return *this;
  }
  template <typename CoreNetworkChangesT = CoreNetworkChange>
  GetCoreNetworkChangeSetResult& AddCoreNetworkChanges(CoreNetworkChangesT&& value) {
    m_coreNetworkChangesHasBeenSet = true;
    m_coreNetworkChanges.emplace_back(std::forward<CoreNetworkChangesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCoreNetworkChangeSetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCoreNetworkChangeSetResult& WithRequestId(RequestIdT&& value) {
