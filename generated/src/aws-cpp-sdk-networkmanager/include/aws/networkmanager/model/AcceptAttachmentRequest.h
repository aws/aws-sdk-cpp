...
namespace Model
{
  ...
  /**
   */
  class AcceptAttachmentRequest : public NetworkManagerRequest
  {
  public:
    AWS_NETWORKMANAGER_API AcceptAttachmentRequest() = default;
    ...
    template<typename AttachmentIdT = Aws::String>
    AcceptAttachmentRequest& WithAttachmentId(AttachmentIdT&& value) { SetAttachmentId(std::forward<AttachmentIdT>(value)); return *this;}
    ///@}
  private:
