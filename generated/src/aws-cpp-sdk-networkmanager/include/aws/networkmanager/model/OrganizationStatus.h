...
class OrganizationStatus {
 public:
  ...
  template <typename OrganizationIdT = Aws::String>
  OrganizationStatus& WithOrganizationId(OrganizationIdT&& value) {
  ...
  void SetOrganizationAwsServiceAccessStatus(OrganizationAwsServiceAccessStatusT&& value) {
    m_organizationAwsServiceAccessStatusHasBeenSet = true;
    m_organizationAwsServiceAccessStatus = std::forward<OrganizationAwsServiceAccessStatusT>(value);
  }
  template <typename OrganizationAwsServiceAccessStatusT = Aws::String>
  OrganizationStatus& WithOrganizationAwsServiceAccessStatus(OrganizationAwsServiceAccessStatusT&& value) {
    SetOrganizationAwsServiceAccessStatus(std::forward<OrganizationAwsServiceAccessStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SLRDeploymentStatusT = Aws::String>
  OrganizationStatus& WithSLRDeploymentStatus(SLRDeploymentStatusT&& value) {
  ...
  void SetAccountStatusList(AccountStatusListT&& value) {
    m_accountStatusListHasBeenSet = true;
    m_accountStatusList = std::forward<AccountStatusListT>(value);
  }
  template <typename AccountStatusListT = Aws::Vector<AccountStatus>>
  OrganizationStatus& WithAccountStatusList(AccountStatusListT&& value) {
    SetAccountStatusList(std::forward<AccountStatusListT>(value));
    return *this;
  }
  template <typename AccountStatusListT = AccountStatus>
  OrganizationStatus& AddAccountStatusList(AccountStatusListT&& value) {
    m_accountStatusListHasBeenSet = true;
    m_accountStatusList.emplace_back(std::forward<AccountStatusListT>(value));
    return *this;
  }
  ///@}
 private:
