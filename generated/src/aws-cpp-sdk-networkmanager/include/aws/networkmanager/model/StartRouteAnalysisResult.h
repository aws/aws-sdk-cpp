...
class StartRouteAnalysisResult {
 public:
  ...
  void SetRouteAnalysis(RouteAnalysisT&& value) {
    m_routeAnalysisHasBeenSet = true;
    m_routeAnalysis = std::forward<RouteAnalysisT>(value);
  }
  template <typename RouteAnalysisT = RouteAnalysis>
  StartRouteAnalysisResult& WithRouteAnalysis(RouteAnalysisT&& value) {
    SetRouteAnalysis(std::forward<RouteAnalysisT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartRouteAnalysisResult& WithRequestId(RequestIdT&& value) {
