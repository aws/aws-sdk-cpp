...
class ListPeeringsRequest : public NetworkManagerRequest {
 public:
  ...
  inline ListPeeringsRequest& WithPeeringType(PeeringType value) {
  ...
  inline ListPeeringsRequest& WithState(PeeringState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ListPeeringsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
