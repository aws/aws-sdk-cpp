...
class CoreNetworkPolicy {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  CoreNetworkPolicy& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline CoreNetworkPolicy& WithPolicyVersionId(int value) {
  ...
  inline CoreNetworkPolicy& WithAlias(CoreNetworkPolicyAlias value) {
    SetAlias(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CoreNetworkPolicy& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CoreNetworkPolicy& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline CoreNetworkPolicy& WithChangeSetState(ChangeSetState value) {
  ...
  void SetPolicyErrors(PolicyErrorsT&& value) {
    m_policyErrorsHasBeenSet = true;
    m_policyErrors = std::forward<PolicyErrorsT>(value);
  }
  template <typename PolicyErrorsT = Aws::Vector<CoreNetworkPolicyError>>
  CoreNetworkPolicy& WithPolicyErrors(PolicyErrorsT&& value) {
    SetPolicyErrors(std::forward<PolicyErrorsT>(value));
    return *this;
  }
  template <typename PolicyErrorsT = CoreNetworkPolicyError>
  CoreNetworkPolicy& AddPolicyErrors(PolicyErrorsT&& value) {
    m_policyErrorsHasBeenSet = true;
    m_policyErrors.emplace_back(std::forward<PolicyErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PolicyDocumentT = Aws::String>
  CoreNetworkPolicy& WithPolicyDocument(PolicyDocumentT&& value) {
