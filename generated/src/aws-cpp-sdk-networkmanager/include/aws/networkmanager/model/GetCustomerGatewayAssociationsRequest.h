...
class GetCustomerGatewayAssociationsRequest : public NetworkManagerRequest {
 public:
  ...
  void SetCustomerGatewayArns(CustomerGatewayArnsT&& value) {
    m_customerGatewayArnsHasBeenSet = true;
    m_customerGatewayArns = std::forward<CustomerGatewayArnsT>(value);
  }
  template <typename CustomerGatewayArnsT = Aws::Vector<Aws::String>>
  GetCustomerGatewayAssociationsRequest& WithCustomerGatewayArns(CustomerGatewayArnsT&& value) {
    SetCustomerGatewayArns(std::forward<CustomerGatewayArnsT>(value));
    return *this;
  }
  ...
  GetCustomerGatewayAssociationsRequest& AddCustomerGatewayArns(CustomerGatewayArnsT&& value) {
    m_customerGatewayArnsHasBeenSet = true;
    m_customerGatewayArns.emplace_back(std::forward<CustomerGatewayArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetCustomerGatewayAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
