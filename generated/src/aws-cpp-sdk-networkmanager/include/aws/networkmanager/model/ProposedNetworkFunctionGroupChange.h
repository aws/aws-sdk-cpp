...
class ProposedNetworkFunctionGroupChange {
 public:
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ProposedNetworkFunctionGroupChange& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ProposedNetworkFunctionGroupChange& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline ProposedNetworkFunctionGroupChange& WithAttachmentPolicyRuleNumber(int value) {
  ...
  template <typename NetworkFunctionGroupNameT = Aws::String>
  ProposedNetworkFunctionGroupChange& WithNetworkFunctionGroupName(NetworkFunctionGroupNameT&& value) {
