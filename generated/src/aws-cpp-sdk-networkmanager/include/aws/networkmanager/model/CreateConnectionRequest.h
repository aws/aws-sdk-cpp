...
class CreateConnectionRequest : public NetworkManagerRequest {
 public:
  ...
  void SetConnectedDeviceId(ConnectedDeviceIdT&& value) {
    ...
    m_connectedDeviceId = std::forward<ConnectedDeviceIdT>(value);
  }
  template <typename ConnectedDeviceIdT = Aws::String>
  CreateConnectionRequest& WithConnectedDeviceId(ConnectedDeviceIdT&& value) {
    SetConnectedDeviceId(std::forward<ConnectedDeviceIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConnectedLinkId(ConnectedLinkIdT&& value) {
    ...
    m_connectedLinkId = std::forward<ConnectedLinkIdT>(value);
  }
  template <typename ConnectedLinkIdT = Aws::String>
  CreateConnectionRequest& WithConnectedLinkId(ConnectedLinkIdT&& value) {
    SetConnectedLinkId(std::forward<ConnectedLinkIdT>(value));
    return *this;
  }
  ///@}
