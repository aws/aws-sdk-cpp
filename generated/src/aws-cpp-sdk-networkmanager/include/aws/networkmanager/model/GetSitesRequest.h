...
class GetSitesRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetSitesRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  void SetSiteIds(SiteIdsT&& value) {
    m_siteIdsHasBeenSet = true;
    m_siteIds = std::forward<SiteIdsT>(value);
  }
  template <typename SiteIdsT = Aws::Vector<Aws::String>>
  GetSitesRequest& WithSiteIds(SiteIdsT&& value) {
    SetSiteIds(std::forward<SiteIdsT>(value));
    return *this;
  }
  template <typename SiteIdsT = Aws::String>
  GetSitesRequest& AddSiteIds(SiteIdsT&& value) {
    m_siteIdsHasBeenSet = true;
    m_siteIds.emplace_back(std::forward<SiteIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetSitesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSitesRequest& WithNextToken(NextTokenT&& value) {
