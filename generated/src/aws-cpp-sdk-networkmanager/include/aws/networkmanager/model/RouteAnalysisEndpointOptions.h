...
class RouteAnalysisEndpointOptions {
 public:
  ...
  template <typename TransitGatewayAttachmentArnT = Aws::String>
  RouteAnalysisEndpointOptions& WithTransitGatewayAttachmentArn(TransitGatewayAttachmentArnT&& value) {
  ...
  template <typename TransitGatewayArnT = Aws::String>
  RouteAnalysisEndpointOptions& WithTransitGatewayArn(TransitGatewayArnT&& value) {
  ...
  template <typename IpAddressT = Aws::String>
  RouteAnalysisEndpointOptions& WithIpAddress(IpAddressT&& value) {
