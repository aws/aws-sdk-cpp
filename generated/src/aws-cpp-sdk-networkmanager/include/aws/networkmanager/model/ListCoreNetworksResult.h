...
class ListCoreNetworksResult {
 public:
  ...
  void SetCoreNetworks(CoreNetworksT&& value) {
    m_coreNetworksHasBeenSet = true;
    m_coreNetworks = std::forward<CoreNetworksT>(value);
  }
  template <typename CoreNetworksT = Aws::Vector<CoreNetworkSummary>>
  ListCoreNetworksResult& WithCoreNetworks(CoreNetworksT&& value) {
    SetCoreNetworks(std::forward<CoreNetworksT>(value));
    return *this;
  }
  template <typename CoreNetworksT = CoreNetworkSummary>
  ListCoreNetworksResult& AddCoreNetworks(CoreNetworksT&& value) {
    m_coreNetworksHasBeenSet = true;
    m_coreNetworks.emplace_back(std::forward<CoreNetworksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCoreNetworksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCoreNetworksResult& WithRequestId(RequestIdT&& value) {
