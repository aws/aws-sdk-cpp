...
class ListConnectPeersResult {
 public:
  ...
  void SetConnectPeers(ConnectPeersT&& value) {
    m_connectPeersHasBeenSet = true;
    m_connectPeers = std::forward<ConnectPeersT>(value);
  }
  template <typename ConnectPeersT = Aws::Vector<ConnectPeerSummary>>
  ListConnectPeersResult& WithConnectPeers(ConnectPeersT&& value) {
    SetConnectPeers(std::forward<ConnectPeersT>(value));
    return *this;
  }
  template <typename ConnectPeersT = ConnectPeerSummary>
  ListConnectPeersResult& AddConnectPeers(ConnectPeersT&& value) {
    m_connectPeersHasBeenSet = true;
    m_connectPeers.emplace_back(std::forward<ConnectPeersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectPeersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConnectPeersResult& WithRequestId(RequestIdT&& value) {
