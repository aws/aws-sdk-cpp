...
class CoreNetworkSummary {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  CoreNetworkSummary& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename CoreNetworkArnT = Aws::String>
  CoreNetworkSummary& WithCoreNetworkArn(CoreNetworkArnT&& value) {
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  CoreNetworkSummary& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename OwnerAccountIdT = Aws::String>
  CoreNetworkSummary& WithOwnerAccountId(OwnerAccountIdT&& value) {
  ...
  inline void SetState(CoreNetworkState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CoreNetworkSummary& WithState(CoreNetworkState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CoreNetworkSummary& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CoreNetworkSummary& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CoreNetworkSummary& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
