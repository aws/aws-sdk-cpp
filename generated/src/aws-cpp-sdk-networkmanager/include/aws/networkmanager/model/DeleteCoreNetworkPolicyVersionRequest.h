...
class DeleteCoreNetworkPolicyVersionRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  DeleteCoreNetworkPolicyVersionRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline DeleteCoreNetworkPolicyVersionRequest& WithPolicyVersionId(int value) {
