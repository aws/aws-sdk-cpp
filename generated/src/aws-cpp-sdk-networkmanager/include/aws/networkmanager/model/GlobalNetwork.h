...
class GlobalNetwork {
 public:
  ...
  void SetGlobalNetworkArn(GlobalNetworkArnT&& value) {
    ...
    m_globalNetworkArn = std::forward<GlobalNetworkArnT>(value);
  }
  template <typename GlobalNetworkArnT = Aws::String>
  GlobalNetwork& WithGlobalNetworkArn(GlobalNetworkArnT&& value) {
    SetGlobalNetworkArn(std::forward<GlobalNetworkArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(GlobalNetworkState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline GlobalNetwork& WithState(GlobalNetworkState value) {
    SetState(value);
    return *this;
  }
  ///@}
