...
class GetTransitGatewayConnectPeerAssociationsRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetTransitGatewayConnectPeerAssociationsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  void SetTransitGatewayConnectPeerArns(TransitGatewayConnectPeerArnsT&& value) {
    m_transitGatewayConnectPeerArnsHasBeenSet = true;
    m_transitGatewayConnectPeerArns = std::forward<TransitGatewayConnectPeerArnsT>(value);
  }
  template <typename TransitGatewayConnectPeerArnsT = Aws::Vector<Aws::String>>
  GetTransitGatewayConnectPeerAssociationsRequest& WithTransitGatewayConnectPeerArns(TransitGatewayConnectPeerArnsT&& value) {
    SetTransitGatewayConnectPeerArns(std::forward<TransitGatewayConnectPeerArnsT>(value));
    return *this;
  }
  template <typename TransitGatewayConnectPeerArnsT = Aws::String>
  GetTransitGatewayConnectPeerAssociationsRequest& AddTransitGatewayConnectPeerArns(TransitGatewayConnectPeerArnsT&& value) {
    m_transitGatewayConnectPeerArnsHasBeenSet = true;
    m_transitGatewayConnectPeerArns.emplace_back(std::forward<TransitGatewayConnectPeerArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetTransitGatewayConnectPeerAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayConnectPeerAssociationsRequest& WithNextToken(NextTokenT&& value) {
