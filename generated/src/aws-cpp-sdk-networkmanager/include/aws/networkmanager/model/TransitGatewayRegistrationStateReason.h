...
class TransitGatewayRegistrationStateReason {
 public:
  ...
  inline void SetCode(TransitGatewayRegistrationState value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline TransitGatewayRegistrationStateReason& WithCode(TransitGatewayRegistrationState value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  TransitGatewayRegistrationStateReason& WithMessage(MessageT&& value) {
