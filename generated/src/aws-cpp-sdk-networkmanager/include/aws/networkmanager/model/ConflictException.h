...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API ConflictException() = default;
    AWS_NETWORKMANAGER_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NETWORKMANAGER_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
