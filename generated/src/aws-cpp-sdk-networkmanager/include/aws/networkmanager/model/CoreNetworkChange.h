...
class CoreNetworkChange {
 public:
  ...
  inline CoreNetworkChange& WithType(ChangeType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CoreNetworkChange& WithAction(ChangeAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdentifierT = Aws::String>
  CoreNetworkChange& WithIdentifier(IdentifierT&& value) {
  ...
  void SetPreviousValues(PreviousValuesT&& value) {
    m_previousValuesHasBeenSet = true;
    m_previousValues = std::forward<PreviousValuesT>(value);
  }
  template <typename PreviousValuesT = CoreNetworkChangeValues>
  CoreNetworkChange& WithPreviousValues(PreviousValuesT&& value) {
    SetPreviousValues(std::forward<PreviousValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNewValues(NewValuesT&& value) {
    m_newValuesHasBeenSet = true;
    m_newValues = std::forward<NewValuesT>(value);
  }
  template <typename NewValuesT = CoreNetworkChangeValues>
  CoreNetworkChange& WithNewValues(NewValuesT&& value) {
    SetNewValues(std::forward<NewValuesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdentifierPathT = Aws::String>
  CoreNetworkChange& WithIdentifierPath(IdentifierPathT&& value) {
