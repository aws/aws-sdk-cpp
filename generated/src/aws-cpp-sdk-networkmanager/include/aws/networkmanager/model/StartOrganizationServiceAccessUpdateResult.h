...
class StartOrganizationServiceAccessUpdateResult {
 public:
  ...
  AWS_NETWORKMANAGER_API StartOrganizationServiceAccessUpdateResult& operator=(
  ...
  void SetOrganizationStatus(OrganizationStatusT&& value) {
    m_organizationStatusHasBeenSet = true;
    m_organizationStatus = std::forward<OrganizationStatusT>(value);
  }
  template <typename OrganizationStatusT = OrganizationStatus>
  StartOrganizationServiceAccessUpdateResult& WithOrganizationStatus(OrganizationStatusT&& value) {
    SetOrganizationStatus(std::forward<OrganizationStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartOrganizationServiceAccessUpdateResult& WithRequestId(RequestIdT&& value) {
