...
class CreateCoreNetworkRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  CreateCoreNetworkRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateCoreNetworkRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateCoreNetworkRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateCoreNetworkRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename PolicyDocumentT = Aws::String>
  CreateCoreNetworkRequest& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateCoreNetworkRequest& WithClientToken(ClientTokenT&& value) {
