...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API GetDirectConnectGatewayAttachmentRequest() = default;
    ...
    template<typename AttachmentIdT = Aws::String>
    GetDirectConnectGatewayAttachmentRequest& WithAttachmentId(AttachmentIdT&& value) { SetAttachmentId(std::forward<AttachmentIdT>(value)); return *this;}
    ///@}
  private:
