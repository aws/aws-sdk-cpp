...
class RestoreCoreNetworkPolicyVersionResult {
 public:
  ...
  AWS_NETWORKMANAGER_API RestoreCoreNetworkPolicyVersionResult& operator=(
  ...
  template <typename CoreNetworkPolicyT = CoreNetworkPolicy>
  RestoreCoreNetworkPolicyVersionResult& WithCoreNetworkPolicy(CoreNetworkPolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RestoreCoreNetworkPolicyVersionResult& WithRequestId(RequestIdT&& value) {
