...
class ListConnectPeersRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  ListConnectPeersRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename ConnectAttachmentIdT = Aws::String>
  ListConnectPeersRequest& WithConnectAttachmentId(ConnectAttachmentIdT&& value) {
  ...
  inline ListConnectPeersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConnectPeersRequest& WithNextToken(NextTokenT&& value) {
