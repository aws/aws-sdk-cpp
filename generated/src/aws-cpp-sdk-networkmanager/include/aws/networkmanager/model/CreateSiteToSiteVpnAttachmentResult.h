...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API CreateSiteToSiteVpnAttachmentResult() = default;
    ...
    template<typename SiteToSiteVpnAttachmentT = SiteToSiteVpnAttachment>
    CreateSiteToSiteVpnAttachmentResult& WithSiteToSiteVpnAttachment(SiteToSiteVpnAttachmentT&& value) { SetSiteToSiteVpnAttachment(std::forward<SiteToSiteVpnAttachmentT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateSiteToSiteVpnAttachmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
