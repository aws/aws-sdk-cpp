...
class UpdateDirectConnectGatewayAttachmentRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename AttachmentIdT = Aws::String>
  UpdateDirectConnectGatewayAttachmentRequest& WithAttachmentId(AttachmentIdT&& value) {
  ...
  template <typename EdgeLocationsT = Aws::Vector<Aws::String>>
  UpdateDirectConnectGatewayAttachmentRequest& WithEdgeLocations(EdgeLocationsT&& value) {
    SetEdgeLocations(std::forward<EdgeLocationsT>(value));
    return *this;
  }
  template <typename EdgeLocationsT = Aws::String>
  UpdateDirectConnectGatewayAttachmentRequest& AddEdgeLocations(EdgeLocationsT&& value) {
    m_edgeLocationsHasBeenSet = true;
