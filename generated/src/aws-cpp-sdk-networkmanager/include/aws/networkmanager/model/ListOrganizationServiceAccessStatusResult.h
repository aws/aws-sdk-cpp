...
class ListOrganizationServiceAccessStatusResult {
 public:
  ...
  AWS_NETWORKMANAGER_API ListOrganizationServiceAccessStatusResult& operator=(
  ...
  template <typename OrganizationStatusT = OrganizationStatus>
  ListOrganizationServiceAccessStatusResult& WithOrganizationStatus(OrganizationStatusT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListOrganizationServiceAccessStatusResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOrganizationServiceAccessStatusResult& WithRequestId(RequestIdT&& value) {
