...
class GetTransitGatewayRegistrationsRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetTransitGatewayRegistrationsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  void SetTransitGatewayArns(TransitGatewayArnsT&& value) {
    m_transitGatewayArnsHasBeenSet = true;
    m_transitGatewayArns = std::forward<TransitGatewayArnsT>(value);
  }
  template <typename TransitGatewayArnsT = Aws::Vector<Aws::String>>
  GetTransitGatewayRegistrationsRequest& WithTransitGatewayArns(TransitGatewayArnsT&& value) {
    SetTransitGatewayArns(std::forward<TransitGatewayArnsT>(value));
    return *this;
  }
  template <typename TransitGatewayArnsT = Aws::String>
  GetTransitGatewayRegistrationsRequest& AddTransitGatewayArns(TransitGatewayArnsT&& value) {
    m_transitGatewayArnsHasBeenSet = true;
    m_transitGatewayArns.emplace_back(std::forward<TransitGatewayArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetTransitGatewayRegistrationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayRegistrationsRequest& WithNextToken(NextTokenT&& value) {
