...
class GetNetworkResourceCountsRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  GetNetworkResourceCountsRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  GetNetworkResourceCountsRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  inline GetNetworkResourceCountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkResourceCountsRequest& WithNextToken(NextTokenT&& value) {
