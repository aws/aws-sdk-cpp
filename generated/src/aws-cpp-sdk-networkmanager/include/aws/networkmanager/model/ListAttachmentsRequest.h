...
class ListAttachmentsRequest : public NetworkManagerRequest {
 public:
  ...
  inline ListAttachmentsRequest& WithAttachmentType(AttachmentType value) {
  ...
  inline ListAttachmentsRequest& WithState(AttachmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline ListAttachmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
