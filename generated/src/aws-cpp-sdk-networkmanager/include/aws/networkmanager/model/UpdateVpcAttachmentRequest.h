...
class UpdateVpcAttachmentRequest : public NetworkManagerRequest {
 public:
  ...
  void SetAddSubnetArns(AddSubnetArnsT&& value) {
    m_addSubnetArnsHasBeenSet = true;
    m_addSubnetArns = std::forward<AddSubnetArnsT>(value);
  }
  template <typename AddSubnetArnsT = Aws::Vector<Aws::String>>
  UpdateVpcAttachmentRequest& WithAddSubnetArns(AddSubnetArnsT&& value) {
    SetAddSubnetArns(std::forward<AddSubnetArnsT>(value));
    return *this;
  }
  template <typename AddSubnetArnsT = Aws::String>
  UpdateVpcAttachmentRequest& AddAddSubnetArns(AddSubnetArnsT&& value) {
    m_addSubnetArnsHasBeenSet = true;
    m_addSubnetArns.emplace_back(std::forward<AddSubnetArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveSubnetArns(RemoveSubnetArnsT&& value) {
    m_removeSubnetArnsHasBeenSet = true;
    m_removeSubnetArns = std::forward<RemoveSubnetArnsT>(value);
  }
  template <typename RemoveSubnetArnsT = Aws::Vector<Aws::String>>
  UpdateVpcAttachmentRequest& WithRemoveSubnetArns(RemoveSubnetArnsT&& value) {
    SetRemoveSubnetArns(std::forward<RemoveSubnetArnsT>(value));
    return *this;
  }
  template <typename RemoveSubnetArnsT = Aws::String>
  UpdateVpcAttachmentRequest& AddRemoveSubnetArns(RemoveSubnetArnsT&& value) {
    m_removeSubnetArnsHasBeenSet = true;
    m_removeSubnetArns.emplace_back(std::forward<RemoveSubnetArnsT>(value));
    return *this;
  }
  ///@}
