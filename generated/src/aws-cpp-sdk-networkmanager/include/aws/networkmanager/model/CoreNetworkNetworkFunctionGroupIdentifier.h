...
class CoreNetworkNetworkFunctionGroupIdentifier {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  CoreNetworkNetworkFunctionGroupIdentifier& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename NetworkFunctionGroupNameT = Aws::String>
  CoreNetworkNetworkFunctionGroupIdentifier& WithNetworkFunctionGroupName(NetworkFunctionGroupNameT&& value) {
  ...
  template <typename EdgeLocationT = Aws::String>
  CoreNetworkNetworkFunctionGroupIdentifier& WithEdgeLocation(EdgeLocationT&& value) {
