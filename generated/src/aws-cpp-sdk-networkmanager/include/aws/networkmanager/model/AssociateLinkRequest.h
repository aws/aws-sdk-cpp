...
class AssociateLinkRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  AssociateLinkRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  AssociateLinkRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  AssociateLinkRequest& WithLinkId(LinkIdT&& value) {
