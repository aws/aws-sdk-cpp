...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMANAGER_API AssociateLinkRequest() = default;
    ...
    template<typename GlobalNetworkIdT = Aws::String>
    AssociateLinkRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) { SetGlobalNetworkId(std::forward<GlobalNetworkIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DeviceIdT = Aws::String>
    AssociateLinkRequest& WithDeviceId(DeviceIdT&& value) { SetDeviceId(std::forward<DeviceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    AssociateLinkRequest& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
  private:
