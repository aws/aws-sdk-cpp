...
class DisassociateLinkRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  DisassociateLinkRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename DeviceIdT = Aws::String>
  DisassociateLinkRequest& WithDeviceId(DeviceIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  DisassociateLinkRequest& WithLinkId(LinkIdT&& value) {
