...
class ServiceInsertionAction {
 public:
  ...
  inline void SetAction(SegmentActionServiceInsertion value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline ServiceInsertionAction& WithAction(SegmentActionServiceInsertion value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMode(SendViaMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ServiceInsertionAction& WithMode(SendViaMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  void SetWhenSentTo(WhenSentToT&& value) {
    ...
    m_whenSentTo = std::forward<WhenSentToT>(value);
  }
  template <typename WhenSentToT = WhenSentTo>
  ServiceInsertionAction& WithWhenSentTo(WhenSentToT&& value) {
    SetWhenSentTo(std::forward<WhenSentToT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVia(ViaT&& value) {
    ...
    m_via = std::forward<ViaT>(value);
  }
  template <typename ViaT = Via>
  ServiceInsertionAction& WithVia(ViaT&& value) {
    SetVia(std::forward<ViaT>(value));
    return *this;
  }
  ///@}
 private:
