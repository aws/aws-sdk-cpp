...
class CoreNetworkSegmentEdgeIdentifier {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  CoreNetworkSegmentEdgeIdentifier& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename SegmentNameT = Aws::String>
  CoreNetworkSegmentEdgeIdentifier& WithSegmentName(SegmentNameT&& value) {
  ...
  template <typename EdgeLocationT = Aws::String>
  CoreNetworkSegmentEdgeIdentifier& WithEdgeLocation(EdgeLocationT&& value) {
