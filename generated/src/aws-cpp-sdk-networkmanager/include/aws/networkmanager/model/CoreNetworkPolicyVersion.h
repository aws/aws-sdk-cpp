...
class CoreNetworkPolicyVersion {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  CoreNetworkPolicyVersion& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline CoreNetworkPolicyVersion& WithPolicyVersionId(int value) {
  ...
  inline CoreNetworkPolicyVersion& WithAlias(CoreNetworkPolicyAlias value) {
    SetAlias(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CoreNetworkPolicyVersion& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CoreNetworkPolicyVersion& WithCreatedAt(CreatedAtT&& value) {
  ...
  inline void SetChangeSetState(ChangeSetState value) {
    m_changeSetStateHasBeenSet = true;
    m_changeSetState = value;
  }
  inline CoreNetworkPolicyVersion& WithChangeSetState(ChangeSetState value) {
    SetChangeSetState(value);
    return *this;
  }
  ///@}
 private:
