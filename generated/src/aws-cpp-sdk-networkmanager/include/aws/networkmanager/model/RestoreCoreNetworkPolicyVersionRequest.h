...
/**
 */
class RestoreCoreNetworkPolicyVersionRequest : public NetworkManagerRequest {
 public:
  AWS_NETWORKMANAGER_API RestoreCoreNetworkPolicyVersionRequest() = default;
  ...
  template <typename CoreNetworkIdT = Aws::String>
  RestoreCoreNetworkPolicyVersionRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline RestoreCoreNetworkPolicyVersionRequest& WithPolicyVersionId(int value) {
