...
class ConnectPeerError {
 public:
  ...
  inline void SetCode(ConnectPeerErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ConnectPeerError& WithCode(ConnectPeerErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ConnectPeerError& WithMessage(MessageT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  ConnectPeerError& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConnectPeerError& WithRequestId(RequestIdT&& value) {
