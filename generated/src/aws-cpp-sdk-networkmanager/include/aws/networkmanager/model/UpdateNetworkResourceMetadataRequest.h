...
class UpdateNetworkResourceMetadataRequest : public NetworkManagerRequest {
 public:
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  UpdateNetworkResourceMetadataRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateNetworkResourceMetadataRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename MetadataT = Aws::Map<Aws::String, Aws::String>>
  UpdateNetworkResourceMetadataRequest& WithMetadata(MetadataT&& value) {
