...
class EdgeOverride {
 public:
  ...
  void SetUseEdge(UseEdgeT&& value) {
    ...
    m_useEdge = std::forward<UseEdgeT>(value);
  }
  template <typename UseEdgeT = Aws::String>
  EdgeOverride& WithUseEdge(UseEdgeT&& value) {
    SetUseEdge(std::forward<UseEdgeT>(value));
    return *this;
  }
  ///@}
 private:
