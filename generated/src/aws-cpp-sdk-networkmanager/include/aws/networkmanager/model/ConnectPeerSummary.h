...
class ConnectPeerSummary {
 public:
  ...
  template <typename CoreNetworkIdT = Aws::String>
  ConnectPeerSummary& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  template <typename ConnectAttachmentIdT = Aws::String>
  ConnectPeerSummary& WithConnectAttachmentId(ConnectAttachmentIdT&& value) {
  ...
  template <typename ConnectPeerIdT = Aws::String>
  ConnectPeerSummary& WithConnectPeerId(ConnectPeerIdT&& value) {
  ...
  template <typename EdgeLocationT = Aws::String>
  ConnectPeerSummary& WithEdgeLocation(EdgeLocationT&& value) {
  ...
  inline void SetConnectPeerState(ConnectPeerState value) {
    m_connectPeerStateHasBeenSet = true;
    m_connectPeerState = value;
  }
  inline ConnectPeerSummary& WithConnectPeerState(ConnectPeerState value) {
    SetConnectPeerState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ConnectPeerSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ConnectPeerSummary& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ConnectPeerSummary& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename SubnetArnT = Aws::String>
  ConnectPeerSummary& WithSubnetArn(SubnetArnT&& value) {
