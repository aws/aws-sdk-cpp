...
class Peering {
 public:
  ...
  inline void SetPeeringType(PeeringType value) {
    m_peeringTypeHasBeenSet = true;
    m_peeringType = value;
  }
  inline Peering& WithPeeringType(PeeringType value) {
    SetPeeringType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(PeeringState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Peering& WithState(PeeringState value) {
    SetState(value);
    return *this;
  }
  ///@}
