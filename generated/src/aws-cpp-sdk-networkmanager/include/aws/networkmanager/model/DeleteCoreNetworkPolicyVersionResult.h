...
class DeleteCoreNetworkPolicyVersionResult {
 public:
  ...
  AWS_NETWORKMANAGER_API DeleteCoreNetworkPolicyVersionResult& operator=(
  ...
  template <typename CoreNetworkPolicyT = CoreNetworkPolicy>
  DeleteCoreNetworkPolicyVersionResult& WithCoreNetworkPolicy(CoreNetworkPolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteCoreNetworkPolicyVersionResult& WithRequestId(RequestIdT&& value) {
