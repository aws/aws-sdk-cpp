...
class CreateDirectConnectGatewayAttachmentResult {
 public:
  ...
  AWS_NETWORKMANAGER_API CreateDirectConnectGatewayAttachmentResult& operator=(
  ...
  template <typename DirectConnectGatewayAttachmentT = DirectConnectGatewayAttachment>
  CreateDirectConnectGatewayAttachmentResult& WithDirectConnectGatewayAttachment(DirectConnectGatewayAttachmentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDirectConnectGatewayAttachmentResult& WithRequestId(RequestIdT&& value) {
