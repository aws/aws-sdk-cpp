...
class Via {
 public:
  ...
  void SetWithEdgeOverrides(WithEdgeOverridesT&& value) {
    ...
    m_withEdgeOverrides = std::forward<WithEdgeOverridesT>(value);
  }
  template <typename WithEdgeOverridesT = Aws::Vector<EdgeOverride>>
  Via& WithWithEdgeOverrides(WithEdgeOverridesT&& value) {
    SetWithEdgeOverrides(std::forward<WithEdgeOverridesT>(value));
    return *this;
  }
  template <typename WithEdgeOverridesT = EdgeOverride>
  Via& AddWithEdgeOverrides(WithEdgeOverridesT&& value) {
    m_withEdgeOverridesHasBeenSet = true;
    m_withEdgeOverrides.emplace_back(std::forward<WithEdgeOverridesT>(value));
    return *this;
  }
  ///@}
 private:
