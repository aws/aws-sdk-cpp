...
class GetCustomerGatewayAssociationsResult {
 public:
  ...
  AWS_NETWORKMANAGER_API GetCustomerGatewayAssociationsResult& operator=(
  ...
  void SetCustomerGatewayAssociations(CustomerGatewayAssociationsT&& value) {
    m_customerGatewayAssociationsHasBeenSet = true;
    m_customerGatewayAssociations = std::forward<CustomerGatewayAssociationsT>(value);
  }
  template <typename CustomerGatewayAssociationsT = Aws::Vector<CustomerGatewayAssociation>>
  GetCustomerGatewayAssociationsResult& WithCustomerGatewayAssociations(CustomerGatewayAssociationsT&& value) {
    SetCustomerGatewayAssociations(std::forward<CustomerGatewayAssociationsT>(value));
    return *this;
  }
  template <typename CustomerGatewayAssociationsT = CustomerGatewayAssociation>
  GetCustomerGatewayAssociationsResult& AddCustomerGatewayAssociations(CustomerGatewayAssociationsT&& value) {
    m_customerGatewayAssociationsHasBeenSet = true;
    m_customerGatewayAssociations.emplace_back(std::forward<CustomerGatewayAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCustomerGatewayAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetCustomerGatewayAssociationsResult& WithRequestId(RequestIdT&& value) {
