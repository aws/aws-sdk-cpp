...
class GetCoreNetworkChangeSetRequest : public NetworkManagerRequest {
 public:
  AWS_NETWORKMANAGER_API GetCoreNetworkChangeSetRequest() = default;
  ...
  template <typename CoreNetworkIdT = Aws::String>
  GetCoreNetworkChangeSetRequest& WithCoreNetworkId(CoreNetworkIdT&& value) {
  ...
  inline void SetPolicyVersionId(int value) {
    m_policyVersionIdHasBeenSet = true;
    m_policyVersionId = value;
  }
  inline GetCoreNetworkChangeSetRequest& WithPolicyVersionId(int value) {
  ...
  inline GetCoreNetworkChangeSetRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCoreNetworkChangeSetRequest& WithNextToken(NextTokenT&& value) {
