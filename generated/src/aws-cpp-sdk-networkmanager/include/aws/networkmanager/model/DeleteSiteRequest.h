...
class DeleteSiteRequest : public NetworkManagerRequest {
 public:
  AWS_NETWORKMANAGER_API DeleteSiteRequest() = default;
  ...
  template <typename GlobalNetworkIdT = Aws::String>
  DeleteSiteRequest& WithGlobalNetworkId(GlobalNetworkIdT&& value) {
  ...
  template <typename SiteIdT = Aws::String>
  DeleteSiteRequest& WithSiteId(SiteIdT&& value) {
