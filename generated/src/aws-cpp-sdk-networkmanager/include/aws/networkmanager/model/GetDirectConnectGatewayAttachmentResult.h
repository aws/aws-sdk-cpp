...
class GetDirectConnectGatewayAttachmentResult {
 public:
  ...
  AWS_NETWORKMANAGER_API GetDirectConnectGatewayAttachmentResult& operator=(
  ...
  template <typename DirectConnectGatewayAttachmentT = DirectConnectGatewayAttachment>
  GetDirectConnectGatewayAttachmentResult& WithDirectConnectGatewayAttachment(DirectConnectGatewayAttachmentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetDirectConnectGatewayAttachmentResult& WithRequestId(RequestIdT&& value) {
