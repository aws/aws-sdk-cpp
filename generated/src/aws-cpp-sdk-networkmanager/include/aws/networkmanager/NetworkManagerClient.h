...
class AWS_NETWORKMANAGER_API NetworkManagerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NetworkManagerClient(const Aws::NetworkManager::NetworkManagerClientConfiguration& clientConfiguration =
  ...
  NetworkManagerClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<NetworkManagerEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::NetworkManager::NetworkManagerClientConfiguration& clientConfiguration =
                           Aws::NetworkManager::NetworkManagerClientConfiguration());
  ...
  /**
   * A Callable wrapper for AcceptAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AcceptAttachment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AcceptAttachmentRequestT = Model::AcceptAttachmentRequest>
  void AcceptAttachmentAsync(const AcceptAttachmentRequestT& request, const AcceptAttachmentResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateConnectPeer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateConnectPeer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateConnectPeerRequestT = Model::AssociateConnectPeerRequest>
  void AssociateConnectPeerAsync(const AssociateConnectPeerRequestT& request, const AssociateConnectPeerResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateCustomerGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateCustomerGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateCustomerGatewayRequestT = Model::AssociateCustomerGatewayRequest>
  void AssociateCustomerGatewayAsync(const AssociateCustomerGatewayRequestT& request,
                                     const AssociateCustomerGatewayResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for AssociateLink that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateLinkRequestT = Model::AssociateLinkRequest>
  void AssociateLinkAsync(const AssociateLinkRequestT& request, const AssociateLinkResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateTransitGatewayConnectPeerOutcome AssociateTransitGatewayConnectPeer(
      const Model::AssociateTransitGatewayConnectPeerRequest& request) const;

  /**
   * A Callable wrapper for AssociateTransitGatewayConnectPeer that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateTransitGatewayConnectPeerRequestT = Model::AssociateTransitGatewayConnectPeerRequest>
  Model::AssociateTransitGatewayConnectPeerOutcomeCallable AssociateTransitGatewayConnectPeerCallable(
      const AssociateTransitGatewayConnectPeerRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::AssociateTransitGatewayConnectPeer, request);
  }

  /**
   * An Async wrapper for AssociateTransitGatewayConnectPeer that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateTransitGatewayConnectPeerRequestT = Model::AssociateTransitGatewayConnectPeerRequest>
  void AssociateTransitGatewayConnectPeerAsync(const AssociateTransitGatewayConnectPeerRequestT& request,
                                               const AssociateTransitGatewayConnectPeerResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConnectAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConnectAttachmentRequestT = Model::CreateConnectAttachmentRequest>
  void CreateConnectAttachmentAsync(const CreateConnectAttachmentRequestT& request,
                                    const CreateConnectAttachmentResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConnectPeer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectPeer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateConnectPeerRequestT = Model::CreateConnectPeerRequest>
  void CreateConnectPeerAsync(const CreateConnectPeerRequestT& request, const CreateConnectPeerResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCoreNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCoreNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateCoreNetworkRequestT = Model::CreateCoreNetworkRequest>
  void CreateCoreNetworkAsync(const CreateCoreNetworkRequestT& request, const CreateCoreNetworkResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateDeviceRequestT = Model::CreateDeviceRequest>
  void CreateDeviceAsync(const CreateDeviceRequestT& request, const CreateDeviceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDirectConnectGatewayAttachmentOutcome CreateDirectConnectGatewayAttachment(
      const Model::CreateDirectConnectGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for CreateDirectConnectGatewayAttachment that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateDirectConnectGatewayAttachmentRequestT = Model::CreateDirectConnectGatewayAttachmentRequest>
  Model::CreateDirectConnectGatewayAttachmentOutcomeCallable CreateDirectConnectGatewayAttachmentCallable(
      const CreateDirectConnectGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::CreateDirectConnectGatewayAttachment, request);
  }

  /**
   * An Async wrapper for CreateDirectConnectGatewayAttachment that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateDirectConnectGatewayAttachmentRequestT = Model::CreateDirectConnectGatewayAttachmentRequest>
  void CreateDirectConnectGatewayAttachmentAsync(const CreateDirectConnectGatewayAttachmentRequestT& request,
                                                 const CreateDirectConnectGatewayAttachmentResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateGlobalNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateGlobalNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateGlobalNetworkRequestT = Model::CreateGlobalNetworkRequest>
  void CreateGlobalNetworkAsync(const CreateGlobalNetworkResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const CreateGlobalNetworkRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateSiteToSiteVpnAttachmentOutcome CreateSiteToSiteVpnAttachment(
      const Model::CreateSiteToSiteVpnAttachmentRequest& request) const;

  /**
   * A Callable wrapper for CreateSiteToSiteVpnAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateSiteToSiteVpnAttachmentRequestT = Model::CreateSiteToSiteVpnAttachmentRequest>
  Model::CreateSiteToSiteVpnAttachmentOutcomeCallable CreateSiteToSiteVpnAttachmentCallable(
      const CreateSiteToSiteVpnAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::CreateSiteToSiteVpnAttachment, request);
  }

  /**
   * An Async wrapper for CreateSiteToSiteVpnAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSiteToSiteVpnAttachmentRequestT = Model::CreateSiteToSiteVpnAttachmentRequest>
  void CreateSiteToSiteVpnAttachmentAsync(const CreateSiteToSiteVpnAttachmentRequestT& request,
                                          const CreateSiteToSiteVpnAttachmentResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTransitGatewayPeeringOutcome CreateTransitGatewayPeering(
      const Model::CreateTransitGatewayPeeringRequest& request) const;

  /**
   * A Callable wrapper for CreateTransitGatewayPeering that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTransitGatewayPeeringRequestT = Model::CreateTransitGatewayPeeringRequest>
  Model::CreateTransitGatewayPeeringOutcomeCallable CreateTransitGatewayPeeringCallable(
      const CreateTransitGatewayPeeringRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::CreateTransitGatewayPeering, request);
  }

  /**
   * An Async wrapper for CreateTransitGatewayPeering that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTransitGatewayPeeringRequestT = Model::CreateTransitGatewayPeeringRequest>
  void CreateTransitGatewayPeeringAsync(const CreateTransitGatewayPeeringRequestT& request,
                                        const CreateTransitGatewayPeeringResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTransitGatewayRouteTableAttachmentOutcome CreateTransitGatewayRouteTableAttachment(
      const Model::CreateTransitGatewayRouteTableAttachmentRequest& request) const;

  /**
   * A Callable wrapper for CreateTransitGatewayRouteTableAttachment that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateTransitGatewayRouteTableAttachmentRequestT = Model::CreateTransitGatewayRouteTableAttachmentRequest>
  Model::CreateTransitGatewayRouteTableAttachmentOutcomeCallable CreateTransitGatewayRouteTableAttachmentCallable(
      const CreateTransitGatewayRouteTableAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::CreateTransitGatewayRouteTableAttachment, request);
  }

  /**
   * An Async wrapper for CreateTransitGatewayRouteTableAttachment that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateTransitGatewayRouteTableAttachmentRequestT = Model::CreateTransitGatewayRouteTableAttachmentRequest>
  void CreateTransitGatewayRouteTableAttachmentAsync(
      const CreateTransitGatewayRouteTableAttachmentRequestT& request,
      const CreateTransitGatewayRouteTableAttachmentResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateVpcAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateVpcAttachment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateVpcAttachmentRequestT = Model::CreateVpcAttachmentRequest>
  void CreateVpcAttachmentAsync(const CreateVpcAttachmentRequestT& request, const CreateVpcAttachmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConnectPeer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConnectPeer that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteConnectPeerRequestT = Model::DeleteConnectPeerRequest>
  void DeleteConnectPeerAsync(const DeleteConnectPeerRequestT& request, const DeleteConnectPeerResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCoreNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCoreNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteCoreNetworkRequestT = Model::DeleteCoreNetworkRequest>
  void DeleteCoreNetworkAsync(const DeleteCoreNetworkRequestT& request, const DeleteCoreNetworkResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCoreNetworkPolicyVersionOutcome DeleteCoreNetworkPolicyVersion(
      const Model::DeleteCoreNetworkPolicyVersionRequest& request) const;

  /**
   * A Callable wrapper for DeleteCoreNetworkPolicyVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCoreNetworkPolicyVersionRequestT = Model::DeleteCoreNetworkPolicyVersionRequest>
  Model::DeleteCoreNetworkPolicyVersionOutcomeCallable DeleteCoreNetworkPolicyVersionCallable(
      const DeleteCoreNetworkPolicyVersionRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::DeleteCoreNetworkPolicyVersion, request);
  }

  /**
   * An Async wrapper for DeleteCoreNetworkPolicyVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCoreNetworkPolicyVersionRequestT = Model::DeleteCoreNetworkPolicyVersionRequest>
  void DeleteCoreNetworkPolicyVersionAsync(const DeleteCoreNetworkPolicyVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteGlobalNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteGlobalNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteGlobalNetworkRequestT = Model::DeleteGlobalNetworkRequest>
  void DeleteGlobalNetworkAsync(const DeleteGlobalNetworkRequestT& request, const DeleteGlobalNetworkResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePeering that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePeeringRequestT = Model::DeletePeeringRequest>
  void DeletePeeringAsync(const DeletePeeringRequestT& request, const DeletePeeringResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterTransitGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterTransitGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterTransitGatewayRequestT = Model::DeregisterTransitGatewayRequest>
  void DeregisterTransitGatewayAsync(const DeregisterTransitGatewayRequestT& request,
                                     const DeregisterTransitGatewayResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeGlobalNetworks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeGlobalNetworks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeGlobalNetworksRequestT = Model::DescribeGlobalNetworksRequest>
  void DescribeGlobalNetworksAsync(const DescribeGlobalNetworksResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeGlobalNetworksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateConnectPeer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateConnectPeer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateConnectPeerRequestT = Model::DisassociateConnectPeerRequest>
  void DisassociateConnectPeerAsync(const DisassociateConnectPeerRequestT& request,
                                    const DisassociateConnectPeerResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateCustomerGatewayOutcome DisassociateCustomerGateway(
      const Model::DisassociateCustomerGatewayRequest& request) const;

  /**
   * A Callable wrapper for DisassociateCustomerGateway that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateCustomerGatewayRequestT = Model::DisassociateCustomerGatewayRequest>
  Model::DisassociateCustomerGatewayOutcomeCallable DisassociateCustomerGatewayCallable(
      const DisassociateCustomerGatewayRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::DisassociateCustomerGateway, request);
  }

  /**
   * An Async wrapper for DisassociateCustomerGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateCustomerGatewayRequestT = Model::DisassociateCustomerGatewayRequest>
  void DisassociateCustomerGatewayAsync(const DisassociateCustomerGatewayRequestT& request,
                                        const DisassociateCustomerGatewayResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociateLink that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateLink that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateLinkRequestT = Model::DisassociateLinkRequest>
  void DisassociateLinkAsync(const DisassociateLinkRequestT& request, const DisassociateLinkResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateTransitGatewayConnectPeerOutcome DisassociateTransitGatewayConnectPeer(
      const Model::DisassociateTransitGatewayConnectPeerRequest& request) const;

  /**
   * A Callable wrapper for DisassociateTransitGatewayConnectPeer that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateTransitGatewayConnectPeerRequestT = Model::DisassociateTransitGatewayConnectPeerRequest>
  Model::DisassociateTransitGatewayConnectPeerOutcomeCallable DisassociateTransitGatewayConnectPeerCallable(
      const DisassociateTransitGatewayConnectPeerRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::DisassociateTransitGatewayConnectPeer, request);
  }

  /**
   * An Async wrapper for DisassociateTransitGatewayConnectPeer that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateTransitGatewayConnectPeerRequestT = Model::DisassociateTransitGatewayConnectPeerRequest>
  void DisassociateTransitGatewayConnectPeerAsync(const DisassociateTransitGatewayConnectPeerRequestT& request,
                                                  const DisassociateTransitGatewayConnectPeerResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExecuteCoreNetworkChangeSetOutcome ExecuteCoreNetworkChangeSet(
      const Model::ExecuteCoreNetworkChangeSetRequest& request) const;

  /**
   * A Callable wrapper for ExecuteCoreNetworkChangeSet that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExecuteCoreNetworkChangeSetRequestT = Model::ExecuteCoreNetworkChangeSetRequest>
  Model::ExecuteCoreNetworkChangeSetOutcomeCallable ExecuteCoreNetworkChangeSetCallable(
      const ExecuteCoreNetworkChangeSetRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::ExecuteCoreNetworkChangeSet, request);
  }

  /**
   * An Async wrapper for ExecuteCoreNetworkChangeSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteCoreNetworkChangeSetRequestT = Model::ExecuteCoreNetworkChangeSetRequest>
  void ExecuteCoreNetworkChangeSetAsync(const ExecuteCoreNetworkChangeSetRequestT& request,
                                        const ExecuteCoreNetworkChangeSetResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConnectAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConnectAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConnectAttachmentRequestT = Model::GetConnectAttachmentRequest>
  void GetConnectAttachmentAsync(const GetConnectAttachmentRequestT& request, const GetConnectAttachmentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetConnectPeer that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetConnectPeerRequestT = Model::GetConnectPeerRequest>
  void GetConnectPeerAsync(const GetConnectPeerRequestT& request, const GetConnectPeerResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConnectPeerAssociationsOutcome GetConnectPeerAssociations(
      const Model::GetConnectPeerAssociationsRequest& request) const;

  /**
   * A Callable wrapper for GetConnectPeerAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetConnectPeerAssociationsRequestT = Model::GetConnectPeerAssociationsRequest>
  Model::GetConnectPeerAssociationsOutcomeCallable GetConnectPeerAssociationsCallable(
      const GetConnectPeerAssociationsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetConnectPeerAssociations, request);
  }

  /**
   * An Async wrapper for GetConnectPeerAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConnectPeerAssociationsRequestT = Model::GetConnectPeerAssociationsRequest>
  void GetConnectPeerAssociationsAsync(const GetConnectPeerAssociationsRequestT& request,
                                       const GetConnectPeerAssociationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetConnectionsRequestT = Model::GetConnectionsRequest>
  void GetConnectionsAsync(const GetConnectionsRequestT& request, const GetConnectionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetCoreNetwork that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCoreNetworkRequestT = Model::GetCoreNetworkRequest>
  void GetCoreNetworkAsync(const GetCoreNetworkRequestT& request, const GetCoreNetworkResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCoreNetworkChangeEventsOutcome GetCoreNetworkChangeEvents(
      const Model::GetCoreNetworkChangeEventsRequest& request) const;

  /**
   * A Callable wrapper for GetCoreNetworkChangeEvents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCoreNetworkChangeEventsRequestT = Model::GetCoreNetworkChangeEventsRequest>
  Model::GetCoreNetworkChangeEventsOutcomeCallable GetCoreNetworkChangeEventsCallable(
      const GetCoreNetworkChangeEventsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetCoreNetworkChangeEvents, request);
  }

  /**
   * An Async wrapper for GetCoreNetworkChangeEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCoreNetworkChangeEventsRequestT = Model::GetCoreNetworkChangeEventsRequest>
  void GetCoreNetworkChangeEventsAsync(const GetCoreNetworkChangeEventsRequestT& request,
                                       const GetCoreNetworkChangeEventsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCoreNetworkChangeSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCoreNetworkChangeSet that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCoreNetworkChangeSetRequestT = Model::GetCoreNetworkChangeSetRequest>
  void GetCoreNetworkChangeSetAsync(const GetCoreNetworkChangeSetRequestT& request,
                                    const GetCoreNetworkChangeSetResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetCoreNetworkPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetCoreNetworkPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetCoreNetworkPolicyRequestT = Model::GetCoreNetworkPolicyRequest>
  void GetCoreNetworkPolicyAsync(const GetCoreNetworkPolicyRequestT& request, const GetCoreNetworkPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetCustomerGatewayAssociationsOutcome GetCustomerGatewayAssociations(
      const Model::GetCustomerGatewayAssociationsRequest& request) const;

  /**
   * A Callable wrapper for GetCustomerGatewayAssociations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetCustomerGatewayAssociationsRequestT = Model::GetCustomerGatewayAssociationsRequest>
  Model::GetCustomerGatewayAssociationsOutcomeCallable GetCustomerGatewayAssociationsCallable(
      const GetCustomerGatewayAssociationsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetCustomerGatewayAssociations, request);
  }

  /**
   * An Async wrapper for GetCustomerGatewayAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetCustomerGatewayAssociationsRequestT = Model::GetCustomerGatewayAssociationsRequest>
  void GetCustomerGatewayAssociationsAsync(const GetCustomerGatewayAssociationsRequestT& request,
                                           const GetCustomerGatewayAssociationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetDevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetDevicesRequestT = Model::GetDevicesRequest>
  void GetDevicesAsync(const GetDevicesRequestT& request, const GetDevicesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDirectConnectGatewayAttachmentOutcome GetDirectConnectGatewayAttachment(
      const Model::GetDirectConnectGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for GetDirectConnectGatewayAttachment that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetDirectConnectGatewayAttachmentRequestT = Model::GetDirectConnectGatewayAttachmentRequest>
  Model::GetDirectConnectGatewayAttachmentOutcomeCallable GetDirectConnectGatewayAttachmentCallable(
      const GetDirectConnectGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetDirectConnectGatewayAttachment, request);
  }

  /**
   * An Async wrapper for GetDirectConnectGatewayAttachment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetDirectConnectGatewayAttachmentRequestT = Model::GetDirectConnectGatewayAttachmentRequest>
  void GetDirectConnectGatewayAttachmentAsync(const GetDirectConnectGatewayAttachmentRequestT& request,
                                              const GetDirectConnectGatewayAttachmentResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLinkAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLinkAssociations that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLinkAssociationsRequestT = Model::GetLinkAssociationsRequest>
  void GetLinkAssociationsAsync(const GetLinkAssociationsRequestT& request, const GetLinkAssociationsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetLinks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetLinksRequestT = Model::GetLinksRequest>
  void GetLinksAsync(const GetLinksRequestT& request, const GetLinksResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNetworkResourceCounts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNetworkResourceCounts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetNetworkResourceCountsRequestT = Model::GetNetworkResourceCountsRequest>
  void GetNetworkResourceCountsAsync(const GetNetworkResourceCountsRequestT& request,
                                     const GetNetworkResourceCountsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetNetworkResourceRelationshipsOutcome GetNetworkResourceRelationships(
      const Model::GetNetworkResourceRelationshipsRequest& request) const;

  /**
   * A Callable wrapper for GetNetworkResourceRelationships that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetNetworkResourceRelationshipsRequestT = Model::GetNetworkResourceRelationshipsRequest>
  Model::GetNetworkResourceRelationshipsOutcomeCallable GetNetworkResourceRelationshipsCallable(
      const GetNetworkResourceRelationshipsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetNetworkResourceRelationships, request);
  }

  /**
   * An Async wrapper for GetNetworkResourceRelationships that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetNetworkResourceRelationshipsRequestT = Model::GetNetworkResourceRelationshipsRequest>
  void GetNetworkResourceRelationshipsAsync(const GetNetworkResourceRelationshipsRequestT& request,
                                            const GetNetworkResourceRelationshipsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNetworkResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNetworkResources that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetNetworkResourcesRequestT = Model::GetNetworkResourcesRequest>
  void GetNetworkResourcesAsync(const GetNetworkResourcesRequestT& request, const GetNetworkResourcesResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNetworkRoutes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNetworkRoutes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetNetworkRoutesRequestT = Model::GetNetworkRoutesRequest>
  void GetNetworkRoutesAsync(const GetNetworkRoutesRequestT& request, const GetNetworkRoutesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetNetworkTelemetry that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetNetworkTelemetry that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetNetworkTelemetryRequestT = Model::GetNetworkTelemetryRequest>
  void GetNetworkTelemetryAsync(const GetNetworkTelemetryRequestT& request, const GetNetworkTelemetryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetRouteAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRouteAnalysis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRouteAnalysisRequestT = Model::GetRouteAnalysisRequest>
  void GetRouteAnalysisAsync(const GetRouteAnalysisRequestT& request, const GetRouteAnalysisResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSiteToSiteVpnAttachmentOutcome GetSiteToSiteVpnAttachment(
      const Model::GetSiteToSiteVpnAttachmentRequest& request) const;

  /**
   * A Callable wrapper for GetSiteToSiteVpnAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSiteToSiteVpnAttachmentRequestT = Model::GetSiteToSiteVpnAttachmentRequest>
  Model::GetSiteToSiteVpnAttachmentOutcomeCallable GetSiteToSiteVpnAttachmentCallable(
      const GetSiteToSiteVpnAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetSiteToSiteVpnAttachment, request);
  }

  /**
   * An Async wrapper for GetSiteToSiteVpnAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSiteToSiteVpnAttachmentRequestT = Model::GetSiteToSiteVpnAttachmentRequest>
  void GetSiteToSiteVpnAttachmentAsync(const GetSiteToSiteVpnAttachmentRequestT& request,
                                       const GetSiteToSiteVpnAttachmentResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSitesRequestT = Model::GetSitesRequest>
  void GetSitesAsync(const GetSitesRequestT& request, const GetSitesResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTransitGatewayConnectPeerAssociationsOutcome GetTransitGatewayConnectPeerAssociations(
      const Model::GetTransitGatewayConnectPeerAssociationsRequest& request) const;

  /**
   * A Callable wrapper for GetTransitGatewayConnectPeerAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetTransitGatewayConnectPeerAssociationsRequestT = Model::GetTransitGatewayConnectPeerAssociationsRequest>
  Model::GetTransitGatewayConnectPeerAssociationsOutcomeCallable GetTransitGatewayConnectPeerAssociationsCallable(
      const GetTransitGatewayConnectPeerAssociationsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetTransitGatewayConnectPeerAssociations, request);
  }

  /**
   * An Async wrapper for GetTransitGatewayConnectPeerAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetTransitGatewayConnectPeerAssociationsRequestT = Model::GetTransitGatewayConnectPeerAssociationsRequest>
  void GetTransitGatewayConnectPeerAssociationsAsync(
      const GetTransitGatewayConnectPeerAssociationsRequestT& request,
      const GetTransitGatewayConnectPeerAssociationsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetTransitGatewayPeering that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetTransitGatewayPeering that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTransitGatewayPeeringRequestT = Model::GetTransitGatewayPeeringRequest>
  void GetTransitGatewayPeeringAsync(const GetTransitGatewayPeeringRequestT& request,
                                     const GetTransitGatewayPeeringResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTransitGatewayRegistrationsOutcome GetTransitGatewayRegistrations(
      const Model::GetTransitGatewayRegistrationsRequest& request) const;

  /**
   * A Callable wrapper for GetTransitGatewayRegistrations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTransitGatewayRegistrationsRequestT = Model::GetTransitGatewayRegistrationsRequest>
  Model::GetTransitGatewayRegistrationsOutcomeCallable GetTransitGatewayRegistrationsCallable(
      const GetTransitGatewayRegistrationsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetTransitGatewayRegistrations, request);
  }

  /**
   * An Async wrapper for GetTransitGatewayRegistrations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetTransitGatewayRegistrationsRequestT = Model::GetTransitGatewayRegistrationsRequest>
  void GetTransitGatewayRegistrationsAsync(const GetTransitGatewayRegistrationsRequestT& request,
                                           const GetTransitGatewayRegistrationsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTransitGatewayRouteTableAttachmentOutcome GetTransitGatewayRouteTableAttachment(
      const Model::GetTransitGatewayRouteTableAttachmentRequest& request) const;

  /**
   * A Callable wrapper for GetTransitGatewayRouteTableAttachment that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetTransitGatewayRouteTableAttachmentRequestT = Model::GetTransitGatewayRouteTableAttachmentRequest>
  Model::GetTransitGatewayRouteTableAttachmentOutcomeCallable GetTransitGatewayRouteTableAttachmentCallable(
      const GetTransitGatewayRouteTableAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::GetTransitGatewayRouteTableAttachment, request);
  }

  /**
   * An Async wrapper for GetTransitGatewayRouteTableAttachment that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetTransitGatewayRouteTableAttachmentRequestT = Model::GetTransitGatewayRouteTableAttachmentRequest>
  void GetTransitGatewayRouteTableAttachmentAsync(const GetTransitGatewayRouteTableAttachmentRequestT& request,
                                                  const GetTransitGatewayRouteTableAttachmentResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetVpcAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetVpcAttachment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetVpcAttachmentRequestT = Model::GetVpcAttachmentRequest>
  void GetVpcAttachmentAsync(const GetVpcAttachmentRequestT& request, const GetVpcAttachmentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListAttachmentsRequestT = Model::ListAttachmentsRequest>
  void ListAttachmentsAsync(const ListAttachmentsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListAttachmentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListConnectPeers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConnectPeers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListConnectPeersRequestT = Model::ListConnectPeersRequest>
  void ListConnectPeersAsync(const ListConnectPeersResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListConnectPeersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCoreNetworkPolicyVersionsOutcome ListCoreNetworkPolicyVersions(
      const Model::ListCoreNetworkPolicyVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListCoreNetworkPolicyVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCoreNetworkPolicyVersionsRequestT = Model::ListCoreNetworkPolicyVersionsRequest>
  Model::ListCoreNetworkPolicyVersionsOutcomeCallable ListCoreNetworkPolicyVersionsCallable(
      const ListCoreNetworkPolicyVersionsRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::ListCoreNetworkPolicyVersions, request);
  }

  /**
   * An Async wrapper for ListCoreNetworkPolicyVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCoreNetworkPolicyVersionsRequestT = Model::ListCoreNetworkPolicyVersionsRequest>
  void ListCoreNetworkPolicyVersionsAsync(const ListCoreNetworkPolicyVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListCoreNetworks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCoreNetworks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCoreNetworksRequestT = Model::ListCoreNetworksRequest>
  void ListCoreNetworksAsync(const ListCoreNetworksResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListCoreNetworksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListOrganizationServiceAccessStatusOutcome ListOrganizationServiceAccessStatus(
      const Model::ListOrganizationServiceAccessStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for ListOrganizationServiceAccessStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListOrganizationServiceAccessStatusRequestT = Model::ListOrganizationServiceAccessStatusRequest>
  Model::ListOrganizationServiceAccessStatusOutcomeCallable ListOrganizationServiceAccessStatusCallable(
      const ListOrganizationServiceAccessStatusRequestT& request = {}) const {
    return SubmitCallable(&NetworkManagerClient::ListOrganizationServiceAccessStatus, request);
  }

  /**
   * An Async wrapper for ListOrganizationServiceAccessStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListOrganizationServiceAccessStatusRequestT = Model::ListOrganizationServiceAccessStatusRequest>
  void ListOrganizationServiceAccessStatusAsync(const ListOrganizationServiceAccessStatusResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListOrganizationServiceAccessStatusRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListPeerings that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPeeringsRequestT = Model::ListPeeringsRequest>
  void ListPeeringsAsync(const ListPeeringsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListPeeringsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for PutCoreNetworkPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutCoreNetworkPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutCoreNetworkPolicyRequestT = Model::PutCoreNetworkPolicyRequest>
  void PutCoreNetworkPolicyAsync(const PutCoreNetworkPolicyRequestT& request, const PutCoreNetworkPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterTransitGateway that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterTransitGateway that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterTransitGatewayRequestT = Model::RegisterTransitGatewayRequest>
  void RegisterTransitGatewayAsync(const RegisterTransitGatewayRequestT& request,
                                   const RegisterTransitGatewayResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectAttachment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RejectAttachmentRequestT = Model::RejectAttachmentRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreCoreNetworkPolicyVersionOutcome RestoreCoreNetworkPolicyVersion(
      const Model::RestoreCoreNetworkPolicyVersionRequest& request) const;

  /**
   * A Callable wrapper for RestoreCoreNetworkPolicyVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreCoreNetworkPolicyVersionRequestT = Model::RestoreCoreNetworkPolicyVersionRequest>
  Model::RestoreCoreNetworkPolicyVersionOutcomeCallable RestoreCoreNetworkPolicyVersionCallable(
      const RestoreCoreNetworkPolicyVersionRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::RestoreCoreNetworkPolicyVersion, request);
  }

  /**
   * An Async wrapper for RestoreCoreNetworkPolicyVersion that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RestoreCoreNetworkPolicyVersionRequestT = Model::RestoreCoreNetworkPolicyVersionRequest>
  void RestoreCoreNetworkPolicyVersionAsync(const RestoreCoreNetworkPolicyVersionRequestT& request,
                                            const RestoreCoreNetworkPolicyVersionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartOrganizationServiceAccessUpdateOutcome StartOrganizationServiceAccessUpdate(
      const Model::StartOrganizationServiceAccessUpdateRequest& request) const;

  /**
   * A Callable wrapper for StartOrganizationServiceAccessUpdate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartOrganizationServiceAccessUpdateRequestT = Model::StartOrganizationServiceAccessUpdateRequest>
  Model::StartOrganizationServiceAccessUpdateOutcomeCallable StartOrganizationServiceAccessUpdateCallable(
      const StartOrganizationServiceAccessUpdateRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::StartOrganizationServiceAccessUpdate, request);
  }

  /**
   * An Async wrapper for StartOrganizationServiceAccessUpdate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartOrganizationServiceAccessUpdateRequestT = Model::StartOrganizationServiceAccessUpdateRequest>
  void StartOrganizationServiceAccessUpdateAsync(const StartOrganizationServiceAccessUpdateRequestT& request,
                                                 const StartOrganizationServiceAccessUpdateResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartRouteAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartRouteAnalysis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartRouteAnalysisRequestT = Model::StartRouteAnalysisRequest>
  void StartRouteAnalysisAsync(const StartRouteAnalysisRequestT& request, const StartRouteAnalysisResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCoreNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCoreNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateCoreNetworkRequestT = Model::UpdateCoreNetworkRequest>
  void UpdateCoreNetworkAsync(const UpdateCoreNetworkRequestT& request, const UpdateCoreNetworkResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDeviceRequestT = Model::UpdateDeviceRequest>
  void UpdateDeviceAsync(const UpdateDeviceRequestT& request, const UpdateDeviceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateDirectConnectGatewayAttachmentOutcome UpdateDirectConnectGatewayAttachment(
      const Model::UpdateDirectConnectGatewayAttachmentRequest& request) const;

  /**
   * A Callable wrapper for UpdateDirectConnectGatewayAttachment that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateDirectConnectGatewayAttachmentRequestT = Model::UpdateDirectConnectGatewayAttachmentRequest>
  Model::UpdateDirectConnectGatewayAttachmentOutcomeCallable UpdateDirectConnectGatewayAttachmentCallable(
      const UpdateDirectConnectGatewayAttachmentRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::UpdateDirectConnectGatewayAttachment, request);
  }

  /**
   * An Async wrapper for UpdateDirectConnectGatewayAttachment that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateDirectConnectGatewayAttachmentRequestT = Model::UpdateDirectConnectGatewayAttachmentRequest>
  void UpdateDirectConnectGatewayAttachmentAsync(const UpdateDirectConnectGatewayAttachmentRequestT& request,
                                                 const UpdateDirectConnectGatewayAttachmentResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateGlobalNetwork that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateGlobalNetwork that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateGlobalNetworkRequestT = Model::UpdateGlobalNetworkRequest>
  void UpdateGlobalNetworkAsync(const UpdateGlobalNetworkRequestT& request, const UpdateGlobalNetworkResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateNetworkResourceMetadataOutcome UpdateNetworkResourceMetadata(
      const Model::UpdateNetworkResourceMetadataRequest& request) const;

  /**
   * A Callable wrapper for UpdateNetworkResourceMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateNetworkResourceMetadataRequestT = Model::UpdateNetworkResourceMetadataRequest>
  Model::UpdateNetworkResourceMetadataOutcomeCallable UpdateNetworkResourceMetadataCallable(
      const UpdateNetworkResourceMetadataRequestT& request) const {
    return SubmitCallable(&NetworkManagerClient::UpdateNetworkResourceMetadata, request);
  }

  /**
   * An Async wrapper for UpdateNetworkResourceMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNetworkResourceMetadataRequestT = Model::UpdateNetworkResourceMetadataRequest>
  void UpdateNetworkResourceMetadataAsync(const UpdateNetworkResourceMetadataRequestT& request,
                                          const UpdateNetworkResourceMetadataResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateVpcAttachment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateVpcAttachment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateVpcAttachmentRequestT = Model::UpdateVpcAttachmentRequest>
  void UpdateVpcAttachmentAsync(const UpdateVpcAttachmentRequestT& request, const UpdateVpcAttachmentResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
