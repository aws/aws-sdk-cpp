...
namespace NetworkManager
{
   ...
   */
  class AWS_NETWORKMANAGER_API NetworkManagerClient : Aws::Client::ClientWithAsyncTemplateMethods<NetworkManagerClient>,
    smithy::client::AwsSmithyClientT<Aws::NetworkManager::SERVICE_NAME,
