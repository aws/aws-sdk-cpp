...
class PermissionGroup {
 public:
  ...
  template <typename PermissionGroupIdT = Aws::String>
  PermissionGroup& WithPermissionGroupId(PermissionGroupIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  PermissionGroup& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PermissionGroup& WithDescription(DescriptionT&& value) {
  ...
  template <typename ApplicationPermissionsT = Aws::Vector<ApplicationPermission>>
  PermissionGroup& WithApplicationPermissions(ApplicationPermissionsT&& value) {
    SetApplicationPermissions(std::forward<ApplicationPermissionsT>(value));
    return *this;
  }
  inline PermissionGroup& AddApplicationPermissions(ApplicationPermission value) {
    m_applicationPermissionsHasBeenSet = true;
    m_applicationPermissions.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline PermissionGroup& WithCreateTime(long long value) {
    SetCreateTime(value);
    return *this;
  }
  ///@}
  ...
  inline PermissionGroup& WithLastModifiedTime(long long value) {
  ...
  inline PermissionGroup& WithMembershipStatus(PermissionGroupMembershipStatus value) {
