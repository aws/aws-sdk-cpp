...
class ChangesetSummary {
 public:
  ...
  inline ChangesetSummary& WithChangeType(ChangeType value) {
    SetChangeType(value);
    return *this;
  }
  ///@}
  ...
  void SetSourceParams(SourceParamsT&& value) {
    ...
    m_sourceParams = std::forward<SourceParamsT>(value);
  }
  template <typename SourceParamsT = Aws::Map<Aws::String, Aws::String>>
  ChangesetSummary& WithSourceParams(SourceParamsT&& value) {
    SetSourceParams(std::forward<SourceParamsT>(value));
    return *this;
  }
  ...
  ChangesetSummary& AddSourceParams(SourceParamsKeyT&& key, SourceParamsValueT&& value) {
    m_sourceParamsHasBeenSet = true;
    m_sourceParams.emplace(std::forward<SourceParamsKeyT>(key), std::forward<SourceParamsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFormatParams(FormatParamsT&& value) {
    ...
    m_formatParams = std::forward<FormatParamsT>(value);
  }
  template <typename FormatParamsT = Aws::Map<Aws::String, Aws::String>>
  ChangesetSummary& WithFormatParams(FormatParamsT&& value) {
    SetFormatParams(std::forward<FormatParamsT>(value));
    return *this;
  }
  ...
  ChangesetSummary& AddFormatParams(FormatParamsKeyT&& key, FormatParamsValueT&& value) {
    m_formatParamsHasBeenSet = true;
    m_formatParams.emplace(std::forward<FormatParamsKeyT>(key), std::forward<FormatParamsValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline ChangesetSummary& WithCreateTime(long long value) {
    SetCreateTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(IngestionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ChangesetSummary& WithStatus(IngestionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActiveUntilTimestamp(long long value) {
    m_activeUntilTimestampHasBeenSet = true;
    m_activeUntilTimestamp = value;
  }
  inline ChangesetSummary& WithActiveUntilTimestamp(long long value) {
    SetActiveUntilTimestamp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActiveFromTimestamp(long long value) {
    m_activeFromTimestampHasBeenSet = true;
    m_activeFromTimestamp = value;
  }
  inline ChangesetSummary& WithActiveFromTimestamp(long long value) {
    SetActiveFromTimestamp(value);
    return *this;
  }
  ///@}
  ...
  void SetUpdatesChangesetId(UpdatesChangesetIdT&& value) {
    ...
    m_updatesChangesetId = std::forward<UpdatesChangesetIdT>(value);
  }
  template <typename UpdatesChangesetIdT = Aws::String>
  ChangesetSummary& WithUpdatesChangesetId(UpdatesChangesetIdT&& value) {
    SetUpdatesChangesetId(std::forward<UpdatesChangesetIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdatedByChangesetId(UpdatedByChangesetIdT&& value) {
    ...
    m_updatedByChangesetId = std::forward<UpdatedByChangesetIdT>(value);
  }
  template <typename UpdatedByChangesetIdT = Aws::String>
  ChangesetSummary& WithUpdatedByChangesetId(UpdatedByChangesetIdT&& value) {
    SetUpdatedByChangesetId(std::forward<UpdatedByChangesetIdT>(value));
    return *this;
  }
  ///@}
 private:
