...
class ColumnDefinition {
 public:
  ...
  inline void SetDataType(ColumnDataType value) {
    m_dataTypeHasBeenSet = true;
    m_dataType = value;
  }
  inline ColumnDefinition& WithDataType(ColumnDataType value) {
    SetDataType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ColumnNameT = Aws::String>
  ColumnDefinition& WithColumnName(ColumnNameT&& value) {
  ...
  template <typename ColumnDescriptionT = Aws::String>
  ColumnDefinition& WithColumnDescription(ColumnDescriptionT&& value) {
