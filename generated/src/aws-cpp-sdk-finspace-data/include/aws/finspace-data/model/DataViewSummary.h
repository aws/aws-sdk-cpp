...
class DataViewSummary {
 public:
  ...
  void SetDataViewId(DataViewIdT&& value) {
    m_dataViewIdHasBeenSet = true;
    m_dataViewId = std::forward<DataViewIdT>(value);
  }
  template <typename DataViewIdT = Aws::String>
  DataViewSummary& WithDataViewId(DataViewIdT&& value) {
    SetDataViewId(std::forward<DataViewIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataViewArn(DataViewArnT&& value) {
    m_dataViewArnHasBeenSet = true;
    m_dataViewArn = std::forward<DataViewArnT>(value);
  }
  template <typename DataViewArnT = Aws::String>
  DataViewSummary& WithDataViewArn(DataViewArnT&& value) {
    SetDataViewArn(std::forward<DataViewArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DatasetIdT = Aws::String>
  DataViewSummary& WithDatasetId(DatasetIdT&& value) {
  ...
  inline void SetAsOfTimestamp(long long value) {
    m_asOfTimestampHasBeenSet = true;
    m_asOfTimestamp = value;
  }
  inline DataViewSummary& WithAsOfTimestamp(long long value) {
    SetAsOfTimestamp(value);
    return *this;
  }
  ///@}
  ...
  void SetPartitionColumns(PartitionColumnsT&& value) {
    ...
    m_partitionColumns = std::forward<PartitionColumnsT>(value);
  }
  template <typename PartitionColumnsT = Aws::Vector<Aws::String>>
  DataViewSummary& WithPartitionColumns(PartitionColumnsT&& value) {
    SetPartitionColumns(std::forward<PartitionColumnsT>(value));
    return *this;
  }
  template <typename PartitionColumnsT = Aws::String>
  DataViewSummary& AddPartitionColumns(PartitionColumnsT&& value) {
    m_partitionColumnsHasBeenSet = true;
    m_partitionColumns.emplace_back(std::forward<PartitionColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSortColumns(SortColumnsT&& value) {
    ...
    m_sortColumns = std::forward<SortColumnsT>(value);
  }
  template <typename SortColumnsT = Aws::Vector<Aws::String>>
  DataViewSummary& WithSortColumns(SortColumnsT&& value) {
    SetSortColumns(std::forward<SortColumnsT>(value));
    return *this;
  }
  template <typename SortColumnsT = Aws::String>
  DataViewSummary& AddSortColumns(SortColumnsT&& value) {
    m_sortColumnsHasBeenSet = true;
    m_sortColumns.emplace_back(std::forward<SortColumnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(DataViewStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DataViewSummary& WithStatus(DataViewStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorInfoT = DataViewErrorInfo>
  DataViewSummary& WithErrorInfo(ErrorInfoT&& value) {
  ...
  void SetDestinationTypeProperties(DestinationTypePropertiesT&& value) {
    m_destinationTypePropertiesHasBeenSet = true;
    m_destinationTypeProperties = std::forward<DestinationTypePropertiesT>(value);
  }
  template <typename DestinationTypePropertiesT = DataViewDestinationTypeParams>
  DataViewSummary& WithDestinationTypeProperties(DestinationTypePropertiesT&& value) {
    SetDestinationTypeProperties(std::forward<DestinationTypePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DataViewSummary& WithAutoUpdate(bool value) {
    SetAutoUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCreateTime(long long value) {
    m_createTimeHasBeenSet = true;
    m_createTime = value;
  }
  inline DataViewSummary& WithCreateTime(long long value) {
    SetCreateTime(value);
    return *this;
  }
  ///@}
  ...
  inline DataViewSummary& WithLastModifiedTime(long long value) {
