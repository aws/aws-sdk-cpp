...
namespace Model
{
  ...
  public:
    ...
    inline UpdateChangesetResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateChangesetResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateChangesetResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
