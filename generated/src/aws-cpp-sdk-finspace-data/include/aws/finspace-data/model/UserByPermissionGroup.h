...
class UserByPermissionGroup {
 public:
  ...
  inline void SetStatus(UserStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UserByPermissionGroup& WithStatus(UserStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(UserType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline UserByPermissionGroup& WithType(UserType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApiAccess(ApiAccess value) {
    m_apiAccessHasBeenSet = true;
    m_apiAccess = value;
  }
  inline UserByPermissionGroup& WithApiAccess(ApiAccess value) {
    SetApiAccess(value);
    return *this;
  }
  ///@}
  ...
  void SetApiAccessPrincipalArn(ApiAccessPrincipalArnT&& value) {
    ...
    m_apiAccessPrincipalArn = std::forward<ApiAccessPrincipalArnT>(value);
  }
  template <typename ApiAccessPrincipalArnT = Aws::String>
  UserByPermissionGroup& WithApiAccessPrincipalArn(ApiAccessPrincipalArnT&& value) {
    SetApiAccessPrincipalArn(std::forward<ApiAccessPrincipalArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMembershipStatus(PermissionGroupMembershipStatus value) {
    m_membershipStatusHasBeenSet = true;
    m_membershipStatus = value;
  }
  inline UserByPermissionGroup& WithMembershipStatus(PermissionGroupMembershipStatus value) {
