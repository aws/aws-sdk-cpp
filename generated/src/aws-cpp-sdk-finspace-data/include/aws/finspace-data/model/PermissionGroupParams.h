...
class PermissionGroupParams {
 public:
  ...
  void SetDatasetPermissions(DatasetPermissionsT&& value) {
    ...
    m_datasetPermissions = std::forward<DatasetPermissionsT>(value);
  }
  template <typename DatasetPermissionsT = Aws::Vector<ResourcePermission>>
  PermissionGroupParams& WithDatasetPermissions(DatasetPermissionsT&& value) {
    SetDatasetPermissions(std::forward<DatasetPermissionsT>(value));
    return *this;
  }
  ...
  PermissionGroupParams& AddDatasetPermissions(DatasetPermissionsT&& value) {
    m_datasetPermissionsHasBeenSet = true;
    m_datasetPermissions.emplace_back(std::forward<DatasetPermissionsT>(value));
    return *this;
  }
  ///@}
 private:
