...
class SchemaDefinition {
 public:
  ...
  void SetPrimaryKeyColumns(PrimaryKeyColumnsT&& value) {
    ...
    m_primaryKeyColumns = std::forward<PrimaryKeyColumnsT>(value);
  }
  template <typename PrimaryKeyColumnsT = Aws::Vector<Aws::String>>
  SchemaDefinition& WithPrimaryKeyColumns(PrimaryKeyColumnsT&& value) {
    SetPrimaryKeyColumns(std::forward<PrimaryKeyColumnsT>(value));
    return *this;
  }
  template <typename PrimaryKeyColumnsT = Aws::String>
  SchemaDefinition& AddPrimaryKeyColumns(PrimaryKeyColumnsT&& value) {
    m_primaryKeyColumnsHasBeenSet = true;
    m_primaryKeyColumns.emplace_back(std::forward<PrimaryKeyColumnsT>(value));
    return *this;
  }
  ///@}
 private:
