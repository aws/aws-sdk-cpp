...
class DataViewDestinationTypeParams {
 public:
  ...
  template <typename DestinationTypeT = Aws::String>
  DataViewDestinationTypeParams& WithDestinationType(DestinationTypeT&& value) {
  ...
  inline void SetS3DestinationExportFileFormat(ExportFileFormat value) {
    m_s3DestinationExportFileFormatHasBeenSet = true;
    m_s3DestinationExportFileFormat = value;
  }
  inline DataViewDestinationTypeParams& WithS3DestinationExportFileFormat(ExportFileFormat value) {
    SetS3DestinationExportFileFormat(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<Aws::String, Aws::String>& GetS3DestinationExportFileFormatOptions() const {
    return m_s3DestinationExportFileFormatOptions;
  }
  ...
  void SetS3DestinationExportFileFormatOptions(S3DestinationExportFileFormatOptionsT&& value) {
    m_s3DestinationExportFileFormatOptionsHasBeenSet = true;
    m_s3DestinationExportFileFormatOptions = std::forward<S3DestinationExportFileFormatOptionsT>(value);
  }
  template <typename S3DestinationExportFileFormatOptionsT = Aws::Map<Aws::String, Aws::String>>
  DataViewDestinationTypeParams& WithS3DestinationExportFileFormatOptions(S3DestinationExportFileFormatOptionsT&& value) {
    SetS3DestinationExportFileFormatOptions(std::forward<S3DestinationExportFileFormatOptionsT>(value));
    return *this;
  }
  template <typename S3DestinationExportFileFormatOptionsKeyT = Aws::String,
            typename S3DestinationExportFileFormatOptionsValueT = Aws::String>
  DataViewDestinationTypeParams& AddS3DestinationExportFileFormatOptions(S3DestinationExportFileFormatOptionsKeyT&& key,
                                                                         S3DestinationExportFileFormatOptionsValueT&& value) {
    m_s3DestinationExportFileFormatOptionsHasBeenSet = true;
    m_s3DestinationExportFileFormatOptions.emplace(std::forward<S3DestinationExportFileFormatOptionsKeyT>(key),
                                                   std::forward<S3DestinationExportFileFormatOptionsValueT>(value));
    return *this;
  }
  ///@}
 private:
