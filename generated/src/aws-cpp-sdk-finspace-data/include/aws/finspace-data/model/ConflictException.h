...
namespace Model
{
  ...
  {
  public:
    AWS_FINSPACEDATA_API ConflictException();
    AWS_FINSPACEDATA_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_FINSPACEDATA_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
