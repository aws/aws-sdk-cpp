...
class User {
 public:
  ...
  inline User& WithStatus(UserStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline User& WithApiAccess(ApiAccess value) {
    SetApiAccess(value);
    return *this;
  }
  ///@}
  ...
  inline User& WithCreateTime(long long value) {
    SetCreateTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastEnabledTime(long long value) {
    m_lastEnabledTimeHasBeenSet = true;
    m_lastEnabledTime = value;
  }
  inline User& WithLastEnabledTime(long long value) {
    SetLastEnabledTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLastDisabledTime(long long value) {
    m_lastDisabledTimeHasBeenSet = true;
    m_lastDisabledTime = value;
  }
  inline User& WithLastDisabledTime(long long value) {
    SetLastDisabledTime(value);
    return *this;
  }
  ///@}
  ...
  inline User& WithLastModifiedTime(long long value) {
  ...
  inline void SetLastLoginTime(long long value) {
    m_lastLoginTimeHasBeenSet = true;
    m_lastLoginTime = value;
  }
  inline User& WithLastLoginTime(long long value) {
