...
namespace FinSpaceData
{
   ...
   */
  class AWS_FINSPACEDATA_API FinSpaceDataClient : Aws::Client::ClientWithAsyncTemplateMethods<FinSpaceDataClient>,
    smithy::client::AwsSmithyClientT<Aws::FinSpaceData::SERVICE_NAME,
