...
DataViewDestinationTypeParams::DataViewDestinationTypeParams(JsonView jsonValue) { *this = jsonValue; }
...
DataViewDestinationTypeParams& DataViewDestinationTypeParams::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("s3DestinationExportFileFormat")) {
    m_s3DestinationExportFileFormat =
        ExportFileFormatMapper::GetExportFileFormatForName(jsonValue.GetString("s3DestinationExportFileFormat"));
    m_s3DestinationExportFileFormatHasBeenSet = true;
  }
  if (jsonValue.ValueExists("s3DestinationExportFileFormatOptions")) {
    Aws::Map<Aws::String, JsonView> s3DestinationExportFileFormatOptionsJsonMap =
        jsonValue.GetObject("s3DestinationExportFileFormatOptions").GetAllObjects();
    for (auto& s3DestinationExportFileFormatOptionsItem : s3DestinationExportFileFormatOptionsJsonMap) {
      m_s3DestinationExportFileFormatOptions[s3DestinationExportFileFormatOptionsItem.first] =
          s3DestinationExportFileFormatOptionsItem.second.AsString();
    }
...
JsonValue DataViewDestinationTypeParams::Jsonize() const {
  ...
  if (m_s3DestinationExportFileFormatHasBeenSet) {
    payload.WithString("s3DestinationExportFileFormat",
                       ExportFileFormatMapper::GetNameForExportFileFormat(m_s3DestinationExportFileFormat));
  }
  ...
  if (m_s3DestinationExportFileFormatOptionsHasBeenSet) {
    ...
    for (auto& s3DestinationExportFileFormatOptionsItem : m_s3DestinationExportFileFormatOptions) {
      s3DestinationExportFileFormatOptionsJsonMap.WithString(s3DestinationExportFileFormatOptionsItem.first,
                                                             s3DestinationExportFileFormatOptionsItem.second);
    }
