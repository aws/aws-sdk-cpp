...
class ListChallengeMetadataRequest : public PcaConnectorScepRequest {
 public:
  ...
  inline ListChallengeMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChallengeMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ConnectorArnT = Aws::String>
  ListChallengeMetadataRequest& WithConnectorArn(ConnectorArnT&& value) {
