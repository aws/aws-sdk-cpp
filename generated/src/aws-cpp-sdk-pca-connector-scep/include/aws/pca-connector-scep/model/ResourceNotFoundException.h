...
namespace Model
{
  ...
  /**
   * <p>The operation tried to access a nonexistent resource. The resource might be
   * incorrectly specified, or it might have a status other than
   * <code>ACTIVE</code>.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/ResourceNotFoundException">AWS
   * API Reference</a></p>
   */
  class ResourceNotFoundException
  {
  public:
    AWS_PCACONNECTORSCEP_API ResourceNotFoundException() = default;
    AWS_PCACONNECTORSCEP_API ResourceNotFoundException(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCACONNECTORSCEP_API ResourceNotFoundException& operator=(Aws::Utils::Json::JsonView jsonValue);
