...
class IntuneConfiguration {
 public:
  ...
  void SetAzureApplicationId(AzureApplicationIdT&& value) {
    m_azureApplicationIdHasBeenSet = true;
    m_azureApplicationId = std::forward<AzureApplicationIdT>(value);
  }
  template <typename AzureApplicationIdT = Aws::String>
  IntuneConfiguration& WithAzureApplicationId(AzureApplicationIdT&& value) {
    SetAzureApplicationId(std::forward<AzureApplicationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DomainT = Aws::String>
  IntuneConfiguration& WithDomain(DomainT&& value) {
