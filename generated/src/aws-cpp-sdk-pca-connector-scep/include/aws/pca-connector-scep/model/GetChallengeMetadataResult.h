...
class GetChallengeMetadataResult {
 public:
  ...
  void SetChallengeMetadata(ChallengeMetadataT&& value) {
    m_challengeMetadataHasBeenSet = true;
    m_challengeMetadata = std::forward<ChallengeMetadataT>(value);
  }
  template <typename ChallengeMetadataT = ChallengeMetadata>
  GetChallengeMetadataResult& WithChallengeMetadata(ChallengeMetadataT&& value) {
    SetChallengeMetadata(std::forward<ChallengeMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetChallengeMetadataResult& WithRequestId(RequestIdT&& value) {
