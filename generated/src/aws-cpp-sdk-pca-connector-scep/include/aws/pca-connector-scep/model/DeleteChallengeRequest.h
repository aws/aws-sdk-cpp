...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORSCEP_API DeleteChallengeRequest();
    ...
    inline DeleteChallengeRequest& WithChallengeArn(const Aws::String& value) { SetChallengeArn(value); return *this;}
    inline DeleteChallengeRequest& WithChallengeArn(Aws::String&& value) { SetChallengeArn(std::move(value)); return *this;}
    inline DeleteChallengeRequest& WithChallengeArn(const char* value) { SetChallengeArn(value); return *this;}
    ///@}
  private:
