...
class ChallengeMetadataSummary {
 public:
  AWS_PCACONNECTORSCEP_API ChallengeMetadataSummary() = default;
  ...
  template <typename ArnT = Aws::String>
  ChallengeMetadataSummary& WithArn(ArnT&& value) {
  ...
  template <typename ConnectorArnT = Aws::String>
  ChallengeMetadataSummary& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ChallengeMetadataSummary& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  ChallengeMetadataSummary& WithUpdatedAt(UpdatedAtT&& value) {
