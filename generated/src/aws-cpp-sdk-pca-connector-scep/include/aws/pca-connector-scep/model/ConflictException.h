...
namespace Model
{
  ...
  /**
   * <p>This request can't be completed for one of the following reasons because the
   * requested resource was being concurrently modified by another
   * request.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_PCACONNECTORSCEP_API ConflictException() = default;
    AWS_PCACONNECTORSCEP_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_PCACONNECTORSCEP_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    ///@{
    /**
     * <p>The resource type, which can be either <code>Connector</code> or
