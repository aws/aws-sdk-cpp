...
namespace Model
{
  ...
  {
  public:
    AWS_PCACONNECTORSCEP_API ListTagsForResourceResult() = default;
    AWS_PCACONNECTORSCEP_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_PCACONNECTORSCEP_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
