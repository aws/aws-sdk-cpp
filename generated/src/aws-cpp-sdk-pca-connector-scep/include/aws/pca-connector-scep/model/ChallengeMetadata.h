...
class ChallengeMetadata {
 public:
  AWS_PCACONNECTORSCEP_API ChallengeMetadata() = default;
  ...
  template <typename ArnT = Aws::String>
  ChallengeMetadata& WithArn(ArnT&& value) {
  ...
  template <typename ConnectorArnT = Aws::String>
  ChallengeMetadata& WithConnectorArn(ConnectorArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  ChallengeMetadata& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  ChallengeMetadata& WithUpdatedAt(UpdatedAtT&& value) {
