...
class ListChallengeMetadataResult {
 public:
  ...
  void SetChallenges(ChallengesT&& value) {
    m_challengesHasBeenSet = true;
    m_challenges = std::forward<ChallengesT>(value);
  }
  template <typename ChallengesT = Aws::Vector<ChallengeMetadataSummary>>
  ListChallengeMetadataResult& WithChallenges(ChallengesT&& value) {
    SetChallenges(std::forward<ChallengesT>(value));
    return *this;
  }
  template <typename ChallengesT = ChallengeMetadataSummary>
  ListChallengeMetadataResult& AddChallenges(ChallengesT&& value) {
    m_challengesHasBeenSet = true;
    m_challenges.emplace_back(std::forward<ChallengesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListChallengeMetadataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListChallengeMetadataResult& WithRequestId(RequestIdT&& value) {
