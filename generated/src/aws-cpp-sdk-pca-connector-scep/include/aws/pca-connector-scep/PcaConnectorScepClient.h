...
class AWS_PCACONNECTORSCEP_API PcaConnectorScepClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  PcaConnectorScepClient(const Aws::PcaConnectorScep::PcaConnectorScepClientConfiguration& clientConfiguration =
  ...
  PcaConnectorScepClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<PcaConnectorScepEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::PcaConnectorScep::PcaConnectorScepClientConfiguration& clientConfiguration =
                             Aws::PcaConnectorScep::PcaConnectorScepClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  PcaConnectorScepClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for CreateChallenge that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateChallengeRequestT = Model::CreateChallengeRequest>
  void CreateChallengeAsync(const CreateChallengeRequestT& request, const CreateChallengeResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for DeleteChallenge that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteChallengeRequestT = Model::DeleteChallengeRequest>
  void DeleteChallengeAsync(const DeleteChallengeRequestT& request, const DeleteChallengeResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetChallengeMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetChallengeMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChallengeMetadataRequestT = Model::GetChallengeMetadataRequest>
  void GetChallengeMetadataAsync(const GetChallengeMetadataRequestT& request, const GetChallengeMetadataResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetChallengePassword that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetChallengePassword that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetChallengePasswordRequestT = Model::GetChallengePasswordRequest>
  void GetChallengePasswordAsync(const GetChallengePasswordRequestT& request, const GetChallengePasswordResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListChallengeMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListChallengeMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListChallengeMetadataRequestT = Model::ListChallengeMetadataRequest>
  void ListChallengeMetadataAsync(const ListChallengeMetadataRequestT& request, const ListChallengeMetadataResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
