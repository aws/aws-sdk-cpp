...
namespace PcaConnectorScep
{
   ...
   */
  class AWS_PCACONNECTORSCEP_API PcaConnectorScepClient : Aws::Client::ClientWithAsyncTemplateMethods<PcaConnectorScepClient>,
    smithy::client::AwsSmithyClientT<Aws::PcaConnectorScep::SERVICE_NAME,
