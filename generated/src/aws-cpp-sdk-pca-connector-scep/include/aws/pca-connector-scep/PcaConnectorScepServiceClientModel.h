...
typedef std::function<void(const PcaConnectorScepClient*, const Model::CreateChallengeRequest&, const Model::CreateChallengeOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateChallengeResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::CreateConnectorRequest&, const Model::CreateConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::DeleteChallengeRequest&, const Model::DeleteChallengeOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteChallengeResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::DeleteConnectorRequest&, const Model::DeleteConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::GetChallengeMetadataRequest&,
                           const Model::GetChallengeMetadataOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetChallengeMetadataResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::GetChallengePasswordRequest&,
                           const Model::GetChallengePasswordOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetChallengePasswordResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::GetConnectorRequest&, const Model::GetConnectorOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetConnectorResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::ListChallengeMetadataRequest&,
                           const Model::ListChallengeMetadataOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListChallengeMetadataResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::ListConnectorsRequest&, const Model::ListConnectorsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListConnectorsResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const PcaConnectorScepClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
