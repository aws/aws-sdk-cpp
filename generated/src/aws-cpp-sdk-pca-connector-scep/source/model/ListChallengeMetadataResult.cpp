...
ListChallengeMetadataResult::ListChallengeMetadataResult()
{
}

ListChallengeMetadataResult::ListChallengeMetadataResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
...
ListChallengeMetadataResult& ListChallengeMetadataResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  ...
  if(jsonValue.ValueExists("Challenges"))
  {
    ...
    for(unsigned challengesIndex = 0; challengesIndex < challengesJsonList.GetLength(); ++challengesIndex)
    {
      m_challenges.push_back(challengesJsonList[challengesIndex].AsObject());
    }
  }
