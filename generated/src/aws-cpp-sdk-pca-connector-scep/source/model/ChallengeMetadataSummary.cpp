...
ChallengeMetadataSummary::ChallengeMetadataSummary(JsonView jsonValue) { *this = jsonValue; }

ChallengeMetadataSummary& ChallengeMetadataSummary::operator=(JsonView jsonValue) {
...
JsonValue ChallengeMetadataSummary::Jsonize() const {
  JsonValue payload;
