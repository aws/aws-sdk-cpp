...
class Database {
 public:
  AWS_TIMESTREAMWRITE_API Database() = default;
  ...
  inline void SetTableCount(long long value) {
    m_tableCountHasBeenSet = true;
    m_tableCount = value;
  }
  inline Database& WithTableCount(long long value) {
    SetTableCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  Database& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  Database& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::Utils::DateTime>
  Database& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
