...
class Record {
 public:
  ...
  void SetMeasureValue(MeasureValueT&& value) {
    ...
    m_measureValue = std::forward<MeasureValueT>(value);
  }
  template <typename MeasureValueT = Aws::String>
  Record& WithMeasureValue(MeasureValueT&& value) {
    SetMeasureValue(std::forward<MeasureValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline Record& WithMeasureValueType(MeasureValueType value) {
  ...
  inline Record& WithTimeUnit(TimeUnit value) {
    SetTimeUnit(value);
    return *this;
  }
  ///@}
  ...
  inline Record& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetMeasureValues(MeasureValuesT&& value) {
    ...
    m_measureValues = std::forward<MeasureValuesT>(value);
  }
  template <typename MeasureValuesT = Aws::Vector<MeasureValue>>
  Record& WithMeasureValues(MeasureValuesT&& value) {
    SetMeasureValues(std::forward<MeasureValuesT>(value));
    return *this;
  }
  template <typename MeasureValuesT = MeasureValue>
  Record& AddMeasureValues(MeasureValuesT&& value) {
    m_measureValuesHasBeenSet = true;
    m_measureValues.emplace_back(std::forward<MeasureValuesT>(value));
    return *this;
  }
  ///@}
 private:
