...
class ListBatchLoadTasksRequest : public TimestreamWriteRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListBatchLoadTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListBatchLoadTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTaskStatus(BatchLoadStatus value) {
    m_taskStatusHasBeenSet = true;
    m_taskStatus = value;
  }
  inline ListBatchLoadTasksRequest& WithTaskStatus(BatchLoadStatus value) {
    SetTaskStatus(value);
    return *this;
  }
  ///@}
