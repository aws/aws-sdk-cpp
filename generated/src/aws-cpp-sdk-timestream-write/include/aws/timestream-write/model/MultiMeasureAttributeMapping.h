...
class MultiMeasureAttributeMapping {
 public:
  ...
  void SetTargetMultiMeasureAttributeName(TargetMultiMeasureAttributeNameT&& value) {
    ...
    m_targetMultiMeasureAttributeName = std::forward<TargetMultiMeasureAttributeNameT>(value);
  }
  template <typename TargetMultiMeasureAttributeNameT = Aws::String>
  MultiMeasureAttributeMapping& WithTargetMultiMeasureAttributeName(TargetMultiMeasureAttributeNameT&& value) {
    SetTargetMultiMeasureAttributeName(std::forward<TargetMultiMeasureAttributeNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMeasureValueType(ScalarMeasureValueType value) {
    m_measureValueTypeHasBeenSet = true;
    m_measureValueType = value;
  }
  inline MultiMeasureAttributeMapping& WithMeasureValueType(ScalarMeasureValueType value) {
