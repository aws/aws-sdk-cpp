...
class MagneticStoreWriteProperties {
 public:
  ...
  inline void SetEnableMagneticStoreWrites(bool value) {
    m_enableMagneticStoreWritesHasBeenSet = true;
    m_enableMagneticStoreWrites = value;
  }
  inline MagneticStoreWriteProperties& WithEnableMagneticStoreWrites(bool value) {
    SetEnableMagneticStoreWrites(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const MagneticStoreRejectedDataLocation& GetMagneticStoreRejectedDataLocation() const {
    return m_magneticStoreRejectedDataLocation;
  }
  ...
  void SetMagneticStoreRejectedDataLocation(MagneticStoreRejectedDataLocationT&& value) {
    ...
    m_magneticStoreRejectedDataLocation = std::forward<MagneticStoreRejectedDataLocationT>(value);
  }
  template <typename MagneticStoreRejectedDataLocationT = MagneticStoreRejectedDataLocation>
  MagneticStoreWriteProperties& WithMagneticStoreRejectedDataLocation(MagneticStoreRejectedDataLocationT&& value) {
    SetMagneticStoreRejectedDataLocation(std::forward<MagneticStoreRejectedDataLocationT>(value));
    return *this;
  }
  ///@}
 private:
