...
class DataSourceConfiguration {
 public:
  ...
  void SetDataSourceS3Configuration(DataSourceS3ConfigurationT&& value) {
    ...
    m_dataSourceS3Configuration = std::forward<DataSourceS3ConfigurationT>(value);
  }
  template <typename DataSourceS3ConfigurationT = DataSourceS3Configuration>
  DataSourceConfiguration& WithDataSourceS3Configuration(DataSourceS3ConfigurationT&& value) {
    SetDataSourceS3Configuration(std::forward<DataSourceS3ConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCsvConfiguration(CsvConfigurationT&& value) {
    ...
    m_csvConfiguration = std::forward<CsvConfigurationT>(value);
  }
  template <typename CsvConfigurationT = CsvConfiguration>
  DataSourceConfiguration& WithCsvConfiguration(CsvConfigurationT&& value) {
    SetCsvConfiguration(std::forward<CsvConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDataFormat(BatchLoadDataFormat value) {
    m_dataFormatHasBeenSet = true;
    m_dataFormat = value;
  }
  inline DataSourceConfiguration& WithDataFormat(BatchLoadDataFormat value) {
    SetDataFormat(value);
    return *this;
  }
  ///@}
