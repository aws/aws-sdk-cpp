...
class UpdateTableRequest : public TimestreamWriteRequest {
 public:
  ...
  void SetRetentionProperties(RetentionPropertiesT&& value) {
    ...
    m_retentionProperties = std::forward<RetentionPropertiesT>(value);
  }
  template <typename RetentionPropertiesT = RetentionProperties>
  UpdateTableRequest& WithRetentionProperties(RetentionPropertiesT&& value) {
    SetRetentionProperties(std::forward<RetentionPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMagneticStoreWriteProperties(MagneticStoreWritePropertiesT&& value) {
    ...
    m_magneticStoreWriteProperties = std::forward<MagneticStoreWritePropertiesT>(value);
  }
  template <typename MagneticStoreWritePropertiesT = MagneticStoreWriteProperties>
  UpdateTableRequest& WithMagneticStoreWriteProperties(MagneticStoreWritePropertiesT&& value) {
    SetMagneticStoreWriteProperties(std::forward<MagneticStoreWritePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SchemaT = Schema>
  UpdateTableRequest& WithSchema(SchemaT&& value) {
