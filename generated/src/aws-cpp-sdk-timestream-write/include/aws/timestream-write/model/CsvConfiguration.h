...
class CsvConfiguration {
 public:
  ...
  void SetColumnSeparator(ColumnSeparatorT&& value) {
    ...
    m_columnSeparator = std::forward<ColumnSeparatorT>(value);
  }
  template <typename ColumnSeparatorT = Aws::String>
  CsvConfiguration& WithColumnSeparator(ColumnSeparatorT&& value) {
    SetColumnSeparator(std::forward<ColumnSeparatorT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEscapeChar(EscapeCharT&& value) {
    ...
    m_escapeChar = std::forward<EscapeCharT>(value);
  }
  template <typename EscapeCharT = Aws::String>
  CsvConfiguration& WithEscapeChar(EscapeCharT&& value) {
    SetEscapeChar(std::forward<EscapeCharT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuoteChar(QuoteCharT&& value) {
    ...
    m_quoteChar = std::forward<QuoteCharT>(value);
  }
  template <typename QuoteCharT = Aws::String>
  CsvConfiguration& WithQuoteChar(QuoteCharT&& value) {
    SetQuoteChar(std::forward<QuoteCharT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrimWhiteSpace(bool value) {
    m_trimWhiteSpaceHasBeenSet = true;
    m_trimWhiteSpace = value;
  }
  inline CsvConfiguration& WithTrimWhiteSpace(bool value) {
