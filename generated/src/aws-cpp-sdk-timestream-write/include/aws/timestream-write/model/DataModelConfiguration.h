...
class DataModelConfiguration {
 public:
  ...
  void SetDataModel(DataModelT&& value) {
    m_dataModelHasBeenSet = true;
    m_dataModel = std::forward<DataModelT>(value);
  }
  template <typename DataModelT = DataModel>
  DataModelConfiguration& WithDataModel(DataModelT&& value) {
    SetDataModel(std::forward<DataModelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataModelS3Configuration(DataModelS3ConfigurationT&& value) {
    m_dataModelS3ConfigurationHasBeenSet = true;
    m_dataModelS3Configuration = std::forward<DataModelS3ConfigurationT>(value);
  }
  template <typename DataModelS3ConfigurationT = DataModelS3Configuration>
  DataModelConfiguration& WithDataModelS3Configuration(DataModelS3ConfigurationT&& value) {
    SetDataModelS3Configuration(std::forward<DataModelS3ConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
