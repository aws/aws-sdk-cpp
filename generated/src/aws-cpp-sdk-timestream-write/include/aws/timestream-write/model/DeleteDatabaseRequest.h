...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMWRITE_API DeleteDatabaseRequest() = default;
    ...
    template<typename DatabaseNameT = Aws::String>
    DeleteDatabaseRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
  private:
