...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMWRITE_API ResumeBatchLoadTaskResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    ResumeBatchLoadTaskResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
