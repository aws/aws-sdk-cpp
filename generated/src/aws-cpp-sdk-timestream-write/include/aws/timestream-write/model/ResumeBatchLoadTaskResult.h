...
namespace Model
{
  ...
  public:
    ...
    inline ResumeBatchLoadTaskResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ResumeBatchLoadTaskResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ResumeBatchLoadTaskResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
