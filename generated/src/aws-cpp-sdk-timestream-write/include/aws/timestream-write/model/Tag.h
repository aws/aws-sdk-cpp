...
namespace Model
{
  ...
  {
  public:
    AWS_TIMESTREAMWRITE_API Tag() = default;
    AWS_TIMESTREAMWRITE_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_TIMESTREAMWRITE_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
