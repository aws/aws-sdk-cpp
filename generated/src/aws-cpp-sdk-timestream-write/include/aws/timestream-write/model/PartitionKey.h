...
class PartitionKey {
 public:
  ...
  inline void SetType(PartitionKeyType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline PartitionKey& WithType(PartitionKeyType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnforcementInRecord(PartitionKeyEnforcementLevel value) {
    m_enforcementInRecordHasBeenSet = true;
    m_enforcementInRecord = value;
  }
  inline PartitionKey& WithEnforcementInRecord(PartitionKeyEnforcementLevel value) {
    SetEnforcementInRecord(value);
    return *this;
  }
  ///@}
 private:
