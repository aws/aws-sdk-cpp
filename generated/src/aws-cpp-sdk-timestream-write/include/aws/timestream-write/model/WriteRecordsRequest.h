...
class WriteRecordsRequest : public TimestreamWriteRequest {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  WriteRecordsRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename TableNameT = Aws::String>
  WriteRecordsRequest& WithTableName(TableNameT&& value) {
  ...
  void SetCommonAttributes(CommonAttributesT&& value) {
    ...
    m_commonAttributes = std::forward<CommonAttributesT>(value);
  }
  template <typename CommonAttributesT = Record>
  WriteRecordsRequest& WithCommonAttributes(CommonAttributesT&& value) {
    SetCommonAttributes(std::forward<CommonAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RecordsT = Aws::Vector<Record>>
  WriteRecordsRequest& WithRecords(RecordsT&& value) {
    SetRecords(std::forward<RecordsT>(value));
    return *this;
  }
  template <typename RecordsT = Record>
  WriteRecordsRequest& AddRecords(RecordsT&& value) {
    m_recordsHasBeenSet = true;
