...
class AWS_TIMESTREAMWRITE_API TimestreamWriteClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  TimestreamWriteClient(const Aws::TimestreamWrite::TimestreamWriteClientConfiguration& clientConfiguration =
  ...
  TimestreamWriteClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<TimestreamWriteEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::TimestreamWrite::TimestreamWriteClientConfiguration& clientConfiguration =
                            Aws::TimestreamWrite::TimestreamWriteClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateBatchLoadTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBatchLoadTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBatchLoadTaskRequestT = Model::CreateBatchLoadTaskRequest>
  void CreateBatchLoadTaskAsync(const CreateBatchLoadTaskRequestT& request, const CreateBatchLoadTaskResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DescribeBatchLoadTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBatchLoadTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBatchLoadTaskRequestT = Model::DescribeBatchLoadTaskRequest>
  void DescribeBatchLoadTaskAsync(const DescribeBatchLoadTaskRequestT& request, const DescribeBatchLoadTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDatabase that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDatabase that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDatabaseRequestT = Model::DescribeDatabaseRequest>
  void DescribeDatabaseAsync(const DescribeDatabaseRequestT& request, const DescribeDatabaseResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBatchLoadTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBatchLoadTasks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBatchLoadTasksRequestT = Model::ListBatchLoadTasksRequest>
  void ListBatchLoadTasksAsync(const ListBatchLoadTasksResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListBatchLoadTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ResumeBatchLoadTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ResumeBatchLoadTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ResumeBatchLoadTaskRequestT = Model::ResumeBatchLoadTaskRequest>
  void ResumeBatchLoadTaskAsync(const ResumeBatchLoadTaskRequestT& request, const ResumeBatchLoadTaskResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for WriteRecords that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename WriteRecordsRequestT = Model::WriteRecordsRequest>
  void WriteRecordsAsync(const WriteRecordsRequestT& request, const WriteRecordsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
