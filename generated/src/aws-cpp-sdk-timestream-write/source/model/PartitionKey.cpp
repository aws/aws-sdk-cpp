...
PartitionKey& PartitionKey::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EnforcementInRecord")) {
    m_enforcementInRecord =
        PartitionKeyEnforcementLevelMapper::GetPartitionKeyEnforcementLevelForName(jsonValue.GetString("EnforcementInRecord"));
...
JsonValue PartitionKey::Jsonize() const {
  ...
  if (m_enforcementInRecordHasBeenSet) {
    payload.WithString("EnforcementInRecord",
                       PartitionKeyEnforcementLevelMapper::GetNameForPartitionKeyEnforcementLevel(m_enforcementInRecord));
  }
