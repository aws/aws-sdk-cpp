...
{
const size_t TimestreamWriteEndpointRules::RulesBlobStrLen = 3768;
const size_t TimestreamWriteEndpointRules::RulesBlobSize = 3769;
...
'r','e','a','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'"','h','t','t','p','s',':','/','/','i','n','g','e','s','t','.','t','i','m','e','s','t','r','e','a',
