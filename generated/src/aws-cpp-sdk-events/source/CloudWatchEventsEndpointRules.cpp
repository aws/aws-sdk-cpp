...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','e','v','e','n','t','s','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','e','v','e','n','t','s','.','u','s','-','g','o','v','-',
...
'e','n','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
const char* CloudWatchEventsEndpointRules::GetRulesBlob()
{
