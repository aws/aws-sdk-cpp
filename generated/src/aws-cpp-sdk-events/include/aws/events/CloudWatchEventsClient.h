...
namespace CloudWatchEvents
{
   ...
   */
  class AWS_CLOUDWATCHEVENTS_API CloudWatchEventsClient : Aws::Client::ClientWithAsyncTemplateMethods<CloudWatchEventsClient>,
    smithy::client::AwsSmithyClientT<Aws::CloudWatchEvents::SERVICE_NAME,
