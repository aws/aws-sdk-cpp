...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVENTS_API RemoveTargetsResultEntry() = default;
    AWS_CLOUDWATCHEVENTS_API RemoveTargetsResultEntry(Aws::Utils::Json::JsonView jsonValue);
    AWS_CLOUDWATCHEVENTS_API RemoveTargetsResultEntry& operator=(Aws::Utils::Json::JsonView jsonValue);
