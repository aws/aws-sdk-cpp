...
class ListPartnerEventSourcesResult {
 public:
  ...
  void SetPartnerEventSources(PartnerEventSourcesT&& value) {
    m_partnerEventSourcesHasBeenSet = true;
    m_partnerEventSources = std::forward<PartnerEventSourcesT>(value);
  }
  template <typename PartnerEventSourcesT = Aws::Vector<PartnerEventSource>>
  ListPartnerEventSourcesResult& WithPartnerEventSources(PartnerEventSourcesT&& value) {
    SetPartnerEventSources(std::forward<PartnerEventSourcesT>(value));
    return *this;
  }
  template <typename PartnerEventSourcesT = PartnerEventSource>
  ListPartnerEventSourcesResult& AddPartnerEventSources(PartnerEventSourcesT&& value) {
    m_partnerEventSourcesHasBeenSet = true;
    m_partnerEventSources.emplace_back(std::forward<PartnerEventSourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPartnerEventSourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPartnerEventSourcesResult& WithRequestId(RequestIdT&& value) {
