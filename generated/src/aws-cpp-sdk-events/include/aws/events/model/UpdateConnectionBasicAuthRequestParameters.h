 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/events-2015-10-07/UpdateConnectionBasicAuthRequestParameters">AWS
 * API Reference</a></p>
 */
class UpdateConnectionBasicAuthRequestParameters {
 public:
  AWS_CLOUDWATCHEVENTS_API UpdateConnectionBasicAuthRequestParameters() = default;
  ...
  template <typename UsernameT = Aws::String>
  UpdateConnectionBasicAuthRequestParameters& WithUsername(UsernameT&& value) {
  ...
  template <typename PasswordT = Aws::String>
  UpdateConnectionBasicAuthRequestParameters& WithPassword(PasswordT&& value) {
