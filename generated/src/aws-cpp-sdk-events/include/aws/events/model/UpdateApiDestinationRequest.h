...
class UpdateApiDestinationRequest : public CloudWatchEventsRequest {
 public:
  ...
  inline UpdateApiDestinationRequest& WithHttpMethod(ApiDestinationHttpMethod value) {
    SetHttpMethod(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateApiDestinationRequest& WithInvocationRateLimitPerSecond(int value) {
