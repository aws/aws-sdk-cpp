...
class ListTargetsByRuleRequest : public CloudWatchEventsRequest {
 public:
  AWS_CLOUDWATCHEVENTS_API ListTargetsByRuleRequest() = default;
  ...
  template <typename RuleT = Aws::String>
  ListTargetsByRuleRequest& WithRule(RuleT&& value) {
  ...
  template <typename EventBusNameT = Aws::String>
  ListTargetsByRuleRequest& WithEventBusName(EventBusNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsByRuleRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTargetsByRuleRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
