...
class CreatePartnerEventSourceResult {
 public:
  ...
  AWS_CLOUDWATCHEVENTS_API CreatePartnerEventSourceResult& operator=(
  ...
  template <typename EventSourceArnT = Aws::String>
  CreatePartnerEventSourceResult& WithEventSourceArn(EventSourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePartnerEventSourceResult& WithRequestId(RequestIdT&& value) {
