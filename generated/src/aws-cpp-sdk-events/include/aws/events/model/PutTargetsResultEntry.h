...
class PutTargetsResultEntry {
 public:
  ...
  template <typename TargetIdT = Aws::String>
  PutTargetsResultEntry& WithTargetId(TargetIdT&& value) {
  ...
  template <typename ErrorCodeT = Aws::String>
  PutTargetsResultEntry& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  PutTargetsResultEntry& WithErrorMessage(ErrorMessageT&& value) {
