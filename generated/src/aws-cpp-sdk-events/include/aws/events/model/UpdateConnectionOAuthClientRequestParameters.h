...
class UpdateConnectionOAuthClientRequestParameters {
 public:
  ...
  template <typename ClientIDT = Aws::String>
  UpdateConnectionOAuthClientRequestParameters& WithClientID(ClientIDT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  UpdateConnectionOAuthClientRequestParameters& WithClientSecret(ClientSecretT&& value) {
