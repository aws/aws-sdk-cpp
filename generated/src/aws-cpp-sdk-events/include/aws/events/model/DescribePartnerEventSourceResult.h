...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVENTS_API DescribePartnerEventSourceResult();
    ...
    inline DescribePartnerEventSourceResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribePartnerEventSourceResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribePartnerEventSourceResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
