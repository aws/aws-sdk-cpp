...
namespace Model
{
  ...
  /**
   */
  class EnableRuleRequest : public CloudWatchEventsRequest
  {
  public:
    AWS_CLOUDWATCHEVENTS_API EnableRuleRequest() = default;
    ...
    template<typename NameT = Aws::String>
    EnableRuleRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename EventBusNameT = Aws::String>
    EnableRuleRequest& WithEventBusName(EventBusNameT&& value) { SetEventBusName(std::forward<EventBusNameT>(value)); return *this;}
    ///@}
  private:
