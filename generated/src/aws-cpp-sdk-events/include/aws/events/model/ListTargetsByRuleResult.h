...
class ListTargetsByRuleResult {
 public:
  ...
  template <typename TargetsT = Aws::Vector<Target>>
  ListTargetsByRuleResult& WithTargets(TargetsT&& value) {
    SetTargets(std::forward<TargetsT>(value));
    return *this;
  }
  template <typename TargetsT = Target>
  ListTargetsByRuleResult& AddTargets(TargetsT&& value) {
    m_targetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTargetsByRuleResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTargetsByRuleResult& WithRequestId(RequestIdT&& value) {
