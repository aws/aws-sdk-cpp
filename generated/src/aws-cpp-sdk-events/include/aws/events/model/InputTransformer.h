...
class InputTransformer {
 public:
  ...
  void SetInputPathsMap(InputPathsMapT&& value) {
    ...
    m_inputPathsMap = std::forward<InputPathsMapT>(value);
  }
  template <typename InputPathsMapT = Aws::Map<Aws::String, Aws::String>>
  InputTransformer& WithInputPathsMap(InputPathsMapT&& value) {
    SetInputPathsMap(std::forward<InputPathsMapT>(value));
    return *this;
  }
  ...
  InputTransformer& AddInputPathsMap(InputPathsMapKeyT&& key, InputPathsMapValueT&& value) {
    m_inputPathsMapHasBeenSet = true;
    m_inputPathsMap.emplace(std::forward<InputPathsMapKeyT>(key), std::forward<InputPathsMapValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInputTemplate(InputTemplateT&& value) {
    ...
    m_inputTemplate = std::forward<InputTemplateT>(value);
  }
  template <typename InputTemplateT = Aws::String>
  InputTransformer& WithInputTemplate(InputTemplateT&& value) {
    SetInputTemplate(std::forward<InputTemplateT>(value));
    return *this;
  }
  ///@}
 private:
