...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHEVENTS_API CreateConnectionResult() = default;
    ...
    template<typename CreationTimeT = Aws::Utils::DateTime>
    CreateConnectionResult& WithCreationTime(CreationTimeT&& value) { SetCreationTime(std::forward<CreationTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeT = Aws::Utils::DateTime>
    CreateConnectionResult& WithLastModifiedTime(LastModifiedTimeT&& value) { SetLastModifiedTime(std::forward<LastModifiedTimeT>(value)); return *this;}
    ///@}
