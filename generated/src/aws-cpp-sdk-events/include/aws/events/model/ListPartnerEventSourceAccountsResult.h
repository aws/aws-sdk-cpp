...
class ListPartnerEventSourceAccountsResult {
 public:
  ...
  AWS_CLOUDWATCHEVENTS_API ListPartnerEventSourceAccountsResult& operator=(
  ...
  void SetPartnerEventSourceAccounts(PartnerEventSourceAccountsT&& value) {
    m_partnerEventSourceAccountsHasBeenSet = true;
    m_partnerEventSourceAccounts = std::forward<PartnerEventSourceAccountsT>(value);
  }
  template <typename PartnerEventSourceAccountsT = Aws::Vector<PartnerEventSourceAccount>>
  ListPartnerEventSourceAccountsResult& WithPartnerEventSourceAccounts(PartnerEventSourceAccountsT&& value) {
    SetPartnerEventSourceAccounts(std::forward<PartnerEventSourceAccountsT>(value));
    return *this;
  }
  template <typename PartnerEventSourceAccountsT = PartnerEventSourceAccount>
  ListPartnerEventSourceAccountsResult& AddPartnerEventSourceAccounts(PartnerEventSourceAccountsT&& value) {
    m_partnerEventSourceAccountsHasBeenSet = true;
    m_partnerEventSourceAccounts.emplace_back(std::forward<PartnerEventSourceAccountsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPartnerEventSourceAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPartnerEventSourceAccountsResult& WithRequestId(RequestIdT&& value) {
