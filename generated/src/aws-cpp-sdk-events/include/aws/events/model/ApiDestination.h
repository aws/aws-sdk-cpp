...
class ApiDestination {
 public:
  AWS_CLOUDWATCHEVENTS_API ApiDestination() = default;
  ...
  void SetApiDestinationArn(ApiDestinationArnT&& value) {
    ...
    m_apiDestinationArn = std::forward<ApiDestinationArnT>(value);
  }
  template <typename ApiDestinationArnT = Aws::String>
  ApiDestination& WithApiDestinationArn(ApiDestinationArnT&& value) {
    SetApiDestinationArn(std::forward<ApiDestinationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetApiDestinationState(ApiDestinationState value) {
    m_apiDestinationStateHasBeenSet = true;
    m_apiDestinationState = value;
  }
  inline ApiDestination& WithApiDestinationState(ApiDestinationState value) {
    SetApiDestinationState(value);
    return *this;
  }
  ///@}
  ...
  inline ApiDestination& WithHttpMethod(ApiDestinationHttpMethod value) {
    SetHttpMethod(value);
    return *this;
  }
  ///@}
  ...
  inline ApiDestination& WithInvocationRateLimitPerSecond(int value) {
