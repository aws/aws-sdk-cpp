...
class ListRuleNamesByTargetResult {
 public:
  AWS_CLOUDWATCHEVENTS_API ListRuleNamesByTargetResult() = default;
  ...
  void SetRuleNames(RuleNamesT&& value) {
    ...
    m_ruleNames = std::forward<RuleNamesT>(value);
  }
  template <typename RuleNamesT = Aws::Vector<Aws::String>>
  ListRuleNamesByTargetResult& WithRuleNames(RuleNamesT&& value) {
    SetRuleNames(std::forward<RuleNamesT>(value));
    return *this;
  }
  template <typename RuleNamesT = Aws::String>
  ListRuleNamesByTargetResult& AddRuleNames(RuleNamesT&& value) {
    m_ruleNamesHasBeenSet = true;
    m_ruleNames.emplace_back(std::forward<RuleNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRuleNamesByTargetResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRuleNamesByTargetResult& WithRequestId(RequestIdT&& value) {
