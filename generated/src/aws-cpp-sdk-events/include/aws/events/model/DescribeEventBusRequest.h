...
/**
 */
class DescribeEventBusRequest : public CloudWatchEventsRequest {
 public:
  AWS_CLOUDWATCHEVENTS_API DescribeEventBusRequest() = default;
  ...
  template <typename NameT = Aws::String>
  DescribeEventBusRequest& WithName(NameT&& value) {
