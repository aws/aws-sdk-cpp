        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              if (initialKeyStr == "ComponentConfiguration") {
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeComponentConfigurationRecommendationResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
