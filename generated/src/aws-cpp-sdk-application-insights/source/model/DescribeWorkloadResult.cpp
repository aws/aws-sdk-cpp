...
DescribeWorkloadResult::DescribeWorkloadResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) { *this = result; }

DescribeWorkloadResult& DescribeWorkloadResult::operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result) {
        ...
        if (mapSize.has_value()) {
          for (size_t i = 0; i < mapSize.value(); ++i) {
            ...
            if (initialKey.has_value()) {
              ...
              else if (initialKeyStr == "WorkloadConfiguration") {
                m_workloadConfiguration = WorkloadConfiguration(decoder);
              ...
              if ((decoder->LastError() != AWS_ERROR_UNKNOWN)) {
                AWS_LOG_ERROR("DescribeWorkloadResult", "Invalid data received for %s", initialKeyStr.c_str());
                break;
              }
            }
          }
