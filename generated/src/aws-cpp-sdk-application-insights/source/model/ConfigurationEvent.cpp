...
ConfigurationEvent& ConfigurationEvent::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("EventResourceType")) {
    m_eventResourceType =
        ConfigurationEventResourceTypeMapper::GetConfigurationEventResourceTypeForName(jsonValue.GetString("EventResourceType"));
...
JsonValue ConfigurationEvent::Jsonize() const {
  ...
  if (m_eventResourceTypeHasBeenSet) {
    payload.WithString("EventResourceType",
                       ConfigurationEventResourceTypeMapper::GetNameForConfigurationEventResourceType(m_eventResourceType));
  }
