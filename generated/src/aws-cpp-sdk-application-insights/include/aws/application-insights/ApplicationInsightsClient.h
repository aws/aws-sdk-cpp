...
class AWS_APPLICATIONINSIGHTS_API ApplicationInsightsClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ApplicationInsightsClient(const Aws::ApplicationInsights::ApplicationInsightsClientConfiguration& clientConfiguration =
  ...
  ApplicationInsightsClient(const Aws::Auth::AWSCredentials& credentials,
                            std::shared_ptr<ApplicationInsightsEndpointProviderBase> endpointProvider = nullptr,
                            const Aws::ApplicationInsights::ApplicationInsightsClientConfiguration& clientConfiguration =
                                Aws::ApplicationInsights::ApplicationInsightsClientConfiguration());
  ...
  /**
   * An Async wrapper for AddWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddWorkloadRequestT = Model::AddWorkloadRequest>
  void AddWorkloadAsync(const AddWorkloadRequestT& request, const AddWorkloadResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateComponent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateComponentRequestT = Model::CreateComponentRequest>
  void CreateComponentAsync(const CreateComponentRequestT& request, const CreateComponentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLogPattern that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLogPattern that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLogPatternRequestT = Model::CreateLogPatternRequest>
  void CreateLogPatternAsync(const CreateLogPatternRequestT& request, const CreateLogPatternResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteComponent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteComponentRequestT = Model::DeleteComponentRequest>
  void DeleteComponentAsync(const DeleteComponentRequestT& request, const DeleteComponentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteLogPattern that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteLogPattern that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteLogPatternRequestT = Model::DeleteLogPatternRequest>
  void DeleteLogPatternAsync(const DeleteLogPatternRequestT& request, const DeleteLogPatternResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeComponent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeComponentRequestT = Model::DescribeComponentRequest>
  void DescribeComponentAsync(const DescribeComponentRequestT& request, const DescribeComponentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeComponentConfigurationOutcome DescribeComponentConfiguration(
      const Model::DescribeComponentConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeComponentConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeComponentConfigurationRequestT = Model::DescribeComponentConfigurationRequest>
  Model::DescribeComponentConfigurationOutcomeCallable DescribeComponentConfigurationCallable(
      const DescribeComponentConfigurationRequestT& request) const {
    return SubmitCallable(&ApplicationInsightsClient::DescribeComponentConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeComponentConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeComponentConfigurationRequestT = Model::DescribeComponentConfigurationRequest>
  void DescribeComponentConfigurationAsync(const DescribeComponentConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeComponentConfigurationRecommendationOutcome DescribeComponentConfigurationRecommendation(
      const Model::DescribeComponentConfigurationRecommendationRequest& request) const;

  /**
   * A Callable wrapper for DescribeComponentConfigurationRecommendation that returns a future to the operation so that it can be executed
  ...
  Model::DescribeComponentConfigurationRecommendationOutcomeCallable DescribeComponentConfigurationRecommendationCallable(
      const DescribeComponentConfigurationRecommendationRequestT& request) const {
    return SubmitCallable(&ApplicationInsightsClient::DescribeComponentConfigurationRecommendation, request);
  }

  /**
   * An Async wrapper for DescribeComponentConfigurationRecommendation that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename DescribeComponentConfigurationRecommendationRequestT = Model::DescribeComponentConfigurationRecommendationRequest>
  void DescribeComponentConfigurationRecommendationAsync(
      const DescribeComponentConfigurationRecommendationRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeLogPattern that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLogPattern that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeLogPatternRequestT = Model::DescribeLogPatternRequest>
  void DescribeLogPatternAsync(const DescribeLogPatternRequestT& request, const DescribeLogPatternResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeObservation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeObservation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeObservationRequestT = Model::DescribeObservationRequest>
  void DescribeObservationAsync(const DescribeObservationRequestT& request, const DescribeObservationResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeProblem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeProblemRequestT = Model::DescribeProblemRequest>
  void DescribeProblemAsync(const DescribeProblemRequestT& request, const DescribeProblemResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeProblemObservationsOutcome DescribeProblemObservations(
      const Model::DescribeProblemObservationsRequest& request) const;

  /**
   * A Callable wrapper for DescribeProblemObservations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeProblemObservationsRequestT = Model::DescribeProblemObservationsRequest>
  Model::DescribeProblemObservationsOutcomeCallable DescribeProblemObservationsCallable(
      const DescribeProblemObservationsRequestT& request) const {
    return SubmitCallable(&ApplicationInsightsClient::DescribeProblemObservations, request);
  }

  /**
   * An Async wrapper for DescribeProblemObservations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProblemObservationsRequestT = Model::DescribeProblemObservationsRequest>
  void DescribeProblemObservationsAsync(const DescribeProblemObservationsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeWorkload that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkload that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWorkloadRequestT = Model::DescribeWorkloadRequest>
  void DescribeWorkloadAsync(const DescribeWorkloadRequestT& request, const DescribeWorkloadResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListComponents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListComponentsRequestT = Model::ListComponentsRequest>
  void ListComponentsAsync(const ListComponentsRequestT& request, const ListComponentsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListConfigurationHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListConfigurationHistoryRequestT = Model::ListConfigurationHistoryRequest>
  Model::ListConfigurationHistoryOutcomeCallable ListConfigurationHistoryCallable(
      const ListConfigurationHistoryRequestT& request = {}) const {
    return SubmitCallable(&ApplicationInsightsClient::ListConfigurationHistory, request);
  }

  /**
   * An Async wrapper for ListConfigurationHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfigurationHistoryRequestT = Model::ListConfigurationHistoryRequest>
  void ListConfigurationHistoryAsync(const ListConfigurationHistoryResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListConfigurationHistoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListLogPatternSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLogPatternSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLogPatternSetsRequestT = Model::ListLogPatternSetsRequest>
  void ListLogPatternSetsAsync(const ListLogPatternSetsRequestT& request, const ListLogPatternSetsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListLogPatterns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLogPatternsRequestT = Model::ListLogPatternsRequest>
  void ListLogPatternsAsync(const ListLogPatternsRequestT& request, const ListLogPatternsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListProblems that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListProblemsRequestT = Model::ListProblemsRequest>
  void ListProblemsAsync(const ListProblemsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListProblemsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListWorkloads that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWorkloadsRequestT = Model::ListWorkloadsRequest>
  void ListWorkloadsAsync(const ListWorkloadsRequestT& request, const ListWorkloadsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RemoveWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RemoveWorkloadRequestT = Model::RemoveWorkloadRequest>
  void RemoveWorkloadAsync(const RemoveWorkloadRequestT& request, const RemoveWorkloadResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateComponent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateComponentRequestT = Model::UpdateComponentRequest>
  void UpdateComponentAsync(const UpdateComponentRequestT& request, const UpdateComponentResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateComponentConfigurationOutcome UpdateComponentConfiguration(
      const Model::UpdateComponentConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdateComponentConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateComponentConfigurationRequestT = Model::UpdateComponentConfigurationRequest>
  Model::UpdateComponentConfigurationOutcomeCallable UpdateComponentConfigurationCallable(
      const UpdateComponentConfigurationRequestT& request) const {
    return SubmitCallable(&ApplicationInsightsClient::UpdateComponentConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateComponentConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateComponentConfigurationRequestT = Model::UpdateComponentConfigurationRequest>
  void UpdateComponentConfigurationAsync(const UpdateComponentConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateLogPattern that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateLogPattern that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateLogPatternRequestT = Model::UpdateLogPatternRequest>
  void UpdateLogPatternAsync(const UpdateLogPatternRequestT& request, const UpdateLogPatternResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateProblem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateProblemRequestT = Model::UpdateProblemRequest>
  void UpdateProblemAsync(const UpdateProblemRequestT& request, const UpdateProblemResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWorkload that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWorkloadRequestT = Model::UpdateWorkloadRequest>
  void UpdateWorkloadAsync(const UpdateWorkloadRequestT& request, const UpdateWorkloadResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
