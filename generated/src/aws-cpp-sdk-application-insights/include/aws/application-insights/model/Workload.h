...
class Workload {
 public:
  ...
  inline Workload& WithTier(Tier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMissingWorkloadConfig(bool value) {
    m_missingWorkloadConfigHasBeenSet = true;
    m_missingWorkloadConfig = value;
  }
  inline Workload& WithMissingWorkloadConfig(bool value) {
    SetMissingWorkloadConfig(value);
    return *this;
  }
  ///@}
 private:
