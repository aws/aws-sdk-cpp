...
class ListConfigurationHistoryResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API ListConfigurationHistoryResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API ListConfigurationHistoryResult& operator=(
  ...
  template <typename EventListT = Aws::Vector<ConfigurationEvent>>
  ListConfigurationHistoryResult& WithEventList(EventListT&& value) {
    SetEventList(std::forward<EventListT>(value));
    return *this;
  }
  template <typename EventListT = ConfigurationEvent>
  ListConfigurationHistoryResult& AddEventList(EventListT&& value) {
    m_eventListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListConfigurationHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConfigurationHistoryResult& WithRequestId(RequestIdT&& value) {
