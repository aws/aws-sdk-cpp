...
class Tag {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API Tag(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPLICATIONINSIGHTS_API Tag& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
