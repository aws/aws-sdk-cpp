...
class ListTagsForResourceResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
