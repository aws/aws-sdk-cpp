...
class Problem {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API Problem(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_APPLICATIONINSIGHTS_API Problem& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline Problem& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAffectedResource(AffectedResourceT&& value) {
    ...
    m_affectedResource = std::forward<AffectedResourceT>(value);
  }
  template <typename AffectedResourceT = Aws::String>
  Problem& WithAffectedResource(AffectedResourceT&& value) {
    SetAffectedResource(std::forward<AffectedResourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSeverityLevel(SeverityLevel value) {
    m_severityLevelHasBeenSet = true;
    m_severityLevel = value;
  }
  inline Problem& WithSeverityLevel(SeverityLevel value) {
  ...
  inline void SetRecurringCount(long long value) {
    m_recurringCountHasBeenSet = true;
    m_recurringCount = value;
  }
  inline Problem& WithRecurringCount(long long value) {
  ...
  void SetLastRecurrenceTime(LastRecurrenceTimeT&& value) {
    ...
    m_lastRecurrenceTime = std::forward<LastRecurrenceTimeT>(value);
  }
  template <typename LastRecurrenceTimeT = Aws::Utils::DateTime>
  Problem& WithLastRecurrenceTime(LastRecurrenceTimeT&& value) {
    SetLastRecurrenceTime(std::forward<LastRecurrenceTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline Problem& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResolutionMethod(ResolutionMethod value) {
    m_resolutionMethodHasBeenSet = true;
    m_resolutionMethod = value;
  }
  inline Problem& WithResolutionMethod(ResolutionMethod value) {
