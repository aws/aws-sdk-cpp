...
class DescribeComponentConfigurationResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API DescribeComponentConfigurationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API DescribeComponentConfigurationResult& operator=(
  ...
  inline DescribeComponentConfigurationResult& WithMonitor(bool value) {
    SetMonitor(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeComponentConfigurationResult& WithTier(Tier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  void SetComponentConfiguration(ComponentConfigurationT&& value) {
    ...
    m_componentConfiguration = std::forward<ComponentConfigurationT>(value);
  }
  template <typename ComponentConfigurationT = Aws::String>
  DescribeComponentConfigurationResult& WithComponentConfiguration(ComponentConfigurationT&& value) {
    SetComponentConfiguration(std::forward<ComponentConfigurationT>(value));
    return *this;
  }
  ///@}
