...
class CreateLogPatternRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  CreateLogPatternRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename PatternSetNameT = Aws::String>
  CreateLogPatternRequest& WithPatternSetName(PatternSetNameT&& value) {
  ...
  template <typename PatternNameT = Aws::String>
  CreateLogPatternRequest& WithPatternName(PatternNameT&& value) {
  ...
  template <typename PatternT = Aws::String>
  CreateLogPatternRequest& WithPattern(PatternT&& value) {
  ...
  inline CreateLogPatternRequest& WithRank(int value) {
    SetRank(value);
    return *this;
  }
  ///@}
