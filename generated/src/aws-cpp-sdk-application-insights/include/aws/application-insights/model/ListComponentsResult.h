...
namespace Model
{
  ...
  public:
    ...
    void SetApplicationComponentList(ApplicationComponentListT&& value) { m_applicationComponentListHasBeenSet = true; m_applicationComponentList = std::forward<ApplicationComponentListT>(value); }
    template<typename ApplicationComponentListT = Aws::Vector<ApplicationComponent>>
    ListComponentsResult& WithApplicationComponentList(ApplicationComponentListT&& value) { SetApplicationComponentList(std::forward<ApplicationComponentListT>(value)); return *this;}
    template<typename ApplicationComponentListT = ApplicationComponent>
    ListComponentsResult& AddApplicationComponentList(ApplicationComponentListT&& value) { m_applicationComponentListHasBeenSet = true; m_applicationComponentList.emplace_back(std::forward<ApplicationComponentListT>(value)); return *this; }
    ///@}
