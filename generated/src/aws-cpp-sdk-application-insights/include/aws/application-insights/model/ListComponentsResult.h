...
class ListComponentsResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API ListComponentsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API ListComponentsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
