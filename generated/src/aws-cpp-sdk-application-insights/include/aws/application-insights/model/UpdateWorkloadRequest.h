...
class UpdateWorkloadRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  UpdateWorkloadRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename ComponentNameT = Aws::String>
  UpdateWorkloadRequest& WithComponentName(ComponentNameT&& value) {
  ...
  void SetWorkloadConfiguration(WorkloadConfigurationT&& value) {
    m_workloadConfigurationHasBeenSet = true;
    m_workloadConfiguration = std::forward<WorkloadConfigurationT>(value);
  }
  template <typename WorkloadConfigurationT = WorkloadConfiguration>
  UpdateWorkloadRequest& WithWorkloadConfiguration(WorkloadConfigurationT&& value) {
    SetWorkloadConfiguration(std::forward<WorkloadConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
