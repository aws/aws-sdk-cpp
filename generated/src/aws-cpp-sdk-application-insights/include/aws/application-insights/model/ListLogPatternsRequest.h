...
class ListLogPatternsRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  ListLogPatternsRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename PatternSetNameT = Aws::String>
  ListLogPatternsRequest& WithPatternSetName(PatternSetNameT&& value) {
  ...
  inline ListLogPatternsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLogPatternsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  ListLogPatternsRequest& WithAccountId(AccountIdT&& value) {
