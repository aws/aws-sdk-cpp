...
class ApplicationInfo {
 public:
  ...
  void SetOpsItemSNSTopicArn(OpsItemSNSTopicArnT&& value) {
    ...
    m_opsItemSNSTopicArn = std::forward<OpsItemSNSTopicArnT>(value);
  }
  template <typename OpsItemSNSTopicArnT = Aws::String>
  ApplicationInfo& WithOpsItemSNSTopicArn(OpsItemSNSTopicArnT&& value) {
    SetOpsItemSNSTopicArn(std::forward<OpsItemSNSTopicArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOpsCenterEnabled(bool value) {
    m_opsCenterEnabledHasBeenSet = true;
    m_opsCenterEnabled = value;
  }
  inline ApplicationInfo& WithOpsCenterEnabled(bool value) {
    SetOpsCenterEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCWEMonitorEnabled(bool value) {
    m_cWEMonitorEnabledHasBeenSet = true;
    m_cWEMonitorEnabled = value;
  }
  inline ApplicationInfo& WithCWEMonitorEnabled(bool value) {
    SetCWEMonitorEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetRemarks(RemarksT&& value) {
    ...
    m_remarks = std::forward<RemarksT>(value);
  }
  template <typename RemarksT = Aws::String>
  ApplicationInfo& WithRemarks(RemarksT&& value) {
    SetRemarks(std::forward<RemarksT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoConfigEnabled(bool value) {
    m_autoConfigEnabledHasBeenSet = true;
    m_autoConfigEnabled = value;
  }
  inline ApplicationInfo& WithAutoConfigEnabled(bool value) {
    SetAutoConfigEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ApplicationInfo& WithDiscoveryType(DiscoveryType value) {
  ...
  inline void SetAttachMissingPermission(bool value) {
    m_attachMissingPermissionHasBeenSet = true;
    m_attachMissingPermission = value;
  }
  inline ApplicationInfo& WithAttachMissingPermission(bool value) {
    SetAttachMissingPermission(value);
    return *this;
  }
  ///@}
 private:
