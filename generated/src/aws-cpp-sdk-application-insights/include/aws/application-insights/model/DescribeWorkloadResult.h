...
class DescribeWorkloadResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API DescribeWorkloadResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API DescribeWorkloadResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename WorkloadIdT = Aws::String>
  DescribeWorkloadResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  void SetWorkloadRemarks(WorkloadRemarksT&& value) {
    ...
    m_workloadRemarks = std::forward<WorkloadRemarksT>(value);
  }
  template <typename WorkloadRemarksT = Aws::String>
  DescribeWorkloadResult& WithWorkloadRemarks(WorkloadRemarksT&& value) {
    SetWorkloadRemarks(std::forward<WorkloadRemarksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WorkloadConfigurationT = WorkloadConfiguration>
  DescribeWorkloadResult& WithWorkloadConfiguration(WorkloadConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWorkloadResult& WithRequestId(RequestIdT&& value) {
