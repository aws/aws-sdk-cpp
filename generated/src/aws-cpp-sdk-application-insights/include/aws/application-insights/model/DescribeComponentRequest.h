...
class DescribeComponentRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  DescribeComponentRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename ComponentNameT = Aws::String>
  DescribeComponentRequest& WithComponentName(ComponentNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  DescribeComponentRequest& WithAccountId(AccountIdT&& value) {
