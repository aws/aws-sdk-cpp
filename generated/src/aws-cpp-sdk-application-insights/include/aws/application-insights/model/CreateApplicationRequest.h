...
class CreateApplicationRequest : public ApplicationInsightsRequest {
 public:
  ...
  inline CreateApplicationRequest& WithOpsCenterEnabled(bool value) {
  ...
  inline CreateApplicationRequest& WithCWEMonitorEnabled(bool value) {
  ...
  inline CreateApplicationRequest& WithAutoConfigEnabled(bool value) {
  ...
  inline void SetAutoCreate(bool value) {
    m_autoCreateHasBeenSet = true;
    m_autoCreate = value;
  }
  inline CreateApplicationRequest& WithAutoCreate(bool value) {
    SetAutoCreate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetGroupingType(GroupingType value) {
    m_groupingTypeHasBeenSet = true;
    m_groupingType = value;
  }
  inline CreateApplicationRequest& WithGroupingType(GroupingType value) {
  ...
  inline CreateApplicationRequest& WithAttachMissingPermission(bool value) {
