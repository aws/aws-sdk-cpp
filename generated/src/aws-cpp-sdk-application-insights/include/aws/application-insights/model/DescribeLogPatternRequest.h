...
class DescribeLogPatternRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  DescribeLogPatternRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename PatternSetNameT = Aws::String>
  DescribeLogPatternRequest& WithPatternSetName(PatternSetNameT&& value) {
  ...
  template <typename PatternNameT = Aws::String>
  DescribeLogPatternRequest& WithPatternName(PatternNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  DescribeLogPatternRequest& WithAccountId(AccountIdT&& value) {
