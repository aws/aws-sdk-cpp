...
class UpdateProblemRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ProblemIdT = Aws::String>
  UpdateProblemRequest& WithProblemId(ProblemIdT&& value) {
  ...
  inline UpdateProblemRequest& WithUpdateStatus(UpdateStatus value) {
  ...
  inline UpdateProblemRequest& WithVisibility(Visibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
