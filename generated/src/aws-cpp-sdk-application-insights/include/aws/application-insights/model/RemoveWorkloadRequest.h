...
class RemoveWorkloadRequest : public ApplicationInsightsRequest {
 public:
  AWS_APPLICATIONINSIGHTS_API RemoveWorkloadRequest() = default;
  ...
  template <typename ResourceGroupNameT = Aws::String>
  RemoveWorkloadRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename ComponentNameT = Aws::String>
  RemoveWorkloadRequest& WithComponentName(ComponentNameT&& value) {
  ...
  template <typename WorkloadIdT = Aws::String>
  RemoveWorkloadRequest& WithWorkloadId(WorkloadIdT&& value) {
