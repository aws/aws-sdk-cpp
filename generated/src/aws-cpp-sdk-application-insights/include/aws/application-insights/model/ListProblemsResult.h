...
class ListProblemsResult {
 public:
  ...
  AWS_APPLICATIONINSIGHTS_API ListProblemsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_APPLICATIONINSIGHTS_API ListProblemsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetProblemList(ProblemListT&& value) {
    ...
    m_problemList = std::forward<ProblemListT>(value);
  }
  template <typename ProblemListT = Aws::Vector<Problem>>
  ListProblemsResult& WithProblemList(ProblemListT&& value) {
    SetProblemList(std::forward<ProblemListT>(value));
    return *this;
  }
  template <typename ProblemListT = Problem>
  ListProblemsResult& AddProblemList(ProblemListT&& value) {
    m_problemListHasBeenSet = true;
    m_problemList.emplace_back(std::forward<ProblemListT>(value));
    return *this;
  }
  ///@}
