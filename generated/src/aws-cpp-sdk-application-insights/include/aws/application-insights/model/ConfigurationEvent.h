...
class ConfigurationEvent {
 public:
  ...
  void SetMonitoredResourceARN(MonitoredResourceARNT&& value) {
    ...
    m_monitoredResourceARN = std::forward<MonitoredResourceARNT>(value);
  }
  template <typename MonitoredResourceARNT = Aws::String>
  ConfigurationEvent& WithMonitoredResourceARN(MonitoredResourceARNT&& value) {
    SetMonitoredResourceARN(std::forward<MonitoredResourceARNT>(value));
    return *this;
  }
  ///@}
  ...
  inline ConfigurationEvent& WithEventStatus(ConfigurationEventStatus value) {
  ...
  inline void SetEventResourceType(ConfigurationEventResourceType value) {
    m_eventResourceTypeHasBeenSet = true;
    m_eventResourceType = value;
  }
  inline ConfigurationEvent& WithEventResourceType(ConfigurationEventResourceType value) {
    SetEventResourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetEventDetail(EventDetailT&& value) {
    ...
    m_eventDetail = std::forward<EventDetailT>(value);
  }
  template <typename EventDetailT = Aws::String>
  ConfigurationEvent& WithEventDetail(EventDetailT&& value) {
    SetEventDetail(std::forward<EventDetailT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventResourceName(EventResourceNameT&& value) {
    ...
    m_eventResourceName = std::forward<EventResourceNameT>(value);
  }
  template <typename EventResourceNameT = Aws::String>
  ConfigurationEvent& WithEventResourceName(EventResourceNameT&& value) {
    SetEventResourceName(std::forward<EventResourceNameT>(value));
    return *this;
  }
  ///@}
 private:
