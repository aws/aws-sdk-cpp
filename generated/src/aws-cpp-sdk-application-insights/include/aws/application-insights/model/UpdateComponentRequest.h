...
class UpdateComponentRequest : public ApplicationInsightsRequest {
 public:
  ...
  void SetNewComponentName(NewComponentNameT&& value) {
    m_newComponentNameHasBeenSet = true;
    m_newComponentName = std::forward<NewComponentNameT>(value);
  }
  template <typename NewComponentNameT = Aws::String>
  UpdateComponentRequest& WithNewComponentName(NewComponentNameT&& value) {
    SetNewComponentName(std::forward<NewComponentNameT>(value));
    return *this;
  }
  ///@}
