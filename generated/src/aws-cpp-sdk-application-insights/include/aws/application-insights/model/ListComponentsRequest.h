...
namespace Model
{
  ...
  public:
    ...
    template<typename ResourceGroupNameT = Aws::String>
    ListComponentsRequest& WithResourceGroupName(ResourceGroupNameT&& value) { SetResourceGroupName(std::forward<ResourceGroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AccountIdT = Aws::String>
    ListComponentsRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
  private:
