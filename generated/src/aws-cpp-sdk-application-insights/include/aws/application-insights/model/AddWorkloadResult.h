...
class AddWorkloadResult {
 public:
  ...
  template <typename WorkloadIdT = Aws::String>
  AddWorkloadResult& WithWorkloadId(WorkloadIdT&& value) {
  ...
  template <typename WorkloadConfigurationT = WorkloadConfiguration>
  AddWorkloadResult& WithWorkloadConfiguration(WorkloadConfigurationT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AddWorkloadResult& WithRequestId(RequestIdT&& value) {
