...
class DescribeComponentConfigurationRequest : public ApplicationInsightsRequest {
 public:
  ...
  template <typename ResourceGroupNameT = Aws::String>
  DescribeComponentConfigurationRequest& WithResourceGroupName(ResourceGroupNameT&& value) {
  ...
  template <typename ComponentNameT = Aws::String>
  DescribeComponentConfigurationRequest& WithComponentName(ComponentNameT&& value) {
  ...
  template <typename AccountIdT = Aws::String>
  DescribeComponentConfigurationRequest& WithAccountId(AccountIdT&& value) {
