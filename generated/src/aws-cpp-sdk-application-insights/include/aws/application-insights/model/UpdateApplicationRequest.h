...
class UpdateApplicationRequest : public ApplicationInsightsRequest {
 public:
  ...
  inline UpdateApplicationRequest& WithOpsCenterEnabled(bool value) {
  ...
  inline UpdateApplicationRequest& WithCWEMonitorEnabled(bool value) {
  ...
  inline void SetRemoveSNSTopic(bool value) {
    m_removeSNSTopicHasBeenSet = true;
    m_removeSNSTopic = value;
  }
  inline UpdateApplicationRequest& WithRemoveSNSTopic(bool value) {
    SetRemoveSNSTopic(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateApplicationRequest& WithAutoConfigEnabled(bool value) {
  ...
  inline UpdateApplicationRequest& WithAttachMissingPermission(bool value) {
