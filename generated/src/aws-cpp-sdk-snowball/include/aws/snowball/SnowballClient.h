...
namespace Snowball
{
   ...
   * Guide</a>.</p>
   */
  class AWS_SNOWBALL_API SnowballClient : Aws::Client::ClientWithAsyncTemplateMethods<SnowballClient>,
    smithy::client::AwsSmithyClientT<Aws::Snowball::SERVICE_NAME,
