...
class ListClusterJobsRequest : public SnowballRequest {
 public:
  ...
  template <typename ClusterIdT = Aws::String>
  ListClusterJobsRequest& WithClusterId(ClusterIdT&& value) {
  ...
  inline ListClusterJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterJobsRequest& WithNextToken(NextTokenT&& value) {
