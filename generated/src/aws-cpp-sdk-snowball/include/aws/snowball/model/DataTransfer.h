...
class DataTransfer {
 public:
  ...
  AWS_SNOWBALL_API DataTransfer(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API DataTransfer& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline DataTransfer& WithBytesTransferred(long long value) {
  ...
  inline void SetObjectsTransferred(long long value) {
    m_objectsTransferredHasBeenSet = true;
    m_objectsTransferred = value;
  }
  inline DataTransfer& WithObjectsTransferred(long long value) {
    SetObjectsTransferred(value);
    return *this;
  }
  ///@}
  ...
  inline DataTransfer& WithTotalBytes(long long value) {
    SetTotalBytes(value);
    return *this;
  }
  ///@}
  ...
  inline DataTransfer& WithTotalObjects(long long value) {
