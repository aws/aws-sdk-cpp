...
class ShippingDetails {
 public:
  ...
  inline ShippingDetails& WithShippingOption(ShippingOption value) {
  ...
  void SetInboundShipment(InboundShipmentT&& value) {
    ...
    m_inboundShipment = std::forward<InboundShipmentT>(value);
  }
  template <typename InboundShipmentT = Shipment>
  ShippingDetails& WithInboundShipment(InboundShipmentT&& value) {
    SetInboundShipment(std::forward<InboundShipmentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutboundShipment(OutboundShipmentT&& value) {
    ...
    m_outboundShipment = std::forward<OutboundShipmentT>(value);
  }
  template <typename OutboundShipmentT = Shipment>
  ShippingDetails& WithOutboundShipment(OutboundShipmentT&& value) {
    SetOutboundShipment(std::forward<OutboundShipmentT>(value));
    return *this;
  }
  ///@}
 private:
