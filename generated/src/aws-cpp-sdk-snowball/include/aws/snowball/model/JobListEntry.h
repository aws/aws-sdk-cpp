...
class JobListEntry {
 public:
  ...
  AWS_SNOWBALL_API JobListEntry(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API JobListEntry& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline JobListEntry& WithJobState(JobState value) {
    SetJobState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsMaster(bool value) {
    m_isMasterHasBeenSet = true;
    m_isMaster = value;
  }
  inline JobListEntry& WithIsMaster(bool value) {
    SetIsMaster(value);
    return *this;
  }
  ///@}
  ...
  inline JobListEntry& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline JobListEntry& WithSnowballType(SnowballType value) {
