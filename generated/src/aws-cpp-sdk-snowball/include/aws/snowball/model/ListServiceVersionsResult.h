...
class ListServiceVersionsResult {
 public:
  ...
  AWS_SNOWBALL_API ListServiceVersionsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_SNOWBALL_API ListServiceVersionsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetServiceVersions(ServiceVersionsT&& value) {
    m_serviceVersionsHasBeenSet = true;
    m_serviceVersions = std::forward<ServiceVersionsT>(value);
  }
  template <typename ServiceVersionsT = Aws::Vector<ServiceVersion>>
  ListServiceVersionsResult& WithServiceVersions(ServiceVersionsT&& value) {
    SetServiceVersions(std::forward<ServiceVersionsT>(value));
    return *this;
  }
  template <typename ServiceVersionsT = ServiceVersion>
  ListServiceVersionsResult& AddServiceVersions(ServiceVersionsT&& value) {
    m_serviceVersionsHasBeenSet = true;
    m_serviceVersions.emplace_back(std::forward<ServiceVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetServiceName(ServiceName value) {
    m_serviceNameHasBeenSet = true;
    m_serviceName = value;
  }
  inline ListServiceVersionsResult& WithServiceName(ServiceName value) {
  ...
  void SetDependentServices(DependentServicesT&& value) {
    ...
    m_dependentServices = std::forward<DependentServicesT>(value);
  }
  template <typename DependentServicesT = Aws::Vector<DependentService>>
  ListServiceVersionsResult& WithDependentServices(DependentServicesT&& value) {
    SetDependentServices(std::forward<DependentServicesT>(value));
    return *this;
  }
  template <typename DependentServicesT = DependentService>
  ListServiceVersionsResult& AddDependentServices(DependentServicesT&& value) {
    m_dependentServicesHasBeenSet = true;
    m_dependentServices.emplace_back(std::forward<DependentServicesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceVersionsResult& WithRequestId(RequestIdT&& value) {
