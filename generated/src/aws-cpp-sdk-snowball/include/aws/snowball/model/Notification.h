...
class Notification {
 public:
  ...
  AWS_SNOWBALL_API Notification(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API Notification& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetJobStatesToNotify(JobStatesToNotifyT&& value) {
    ...
    m_jobStatesToNotify = std::forward<JobStatesToNotifyT>(value);
  }
  template <typename JobStatesToNotifyT = Aws::Vector<JobState>>
  Notification& WithJobStatesToNotify(JobStatesToNotifyT&& value) {
    SetJobStatesToNotify(std::forward<JobStatesToNotifyT>(value));
    return *this;
  }
  inline Notification& AddJobStatesToNotify(JobState value) {
    m_jobStatesToNotifyHasBeenSet = true;
    m_jobStatesToNotify.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNotifyAll(bool value) {
    m_notifyAllHasBeenSet = true;
    m_notifyAll = value;
  }
  inline Notification& WithNotifyAll(bool value) {
    SetNotifyAll(value);
    return *this;
  }
  ///@}
  ...
  void SetDevicePickupSnsTopicARN(DevicePickupSnsTopicARNT&& value) {
    ...
    m_devicePickupSnsTopicARN = std::forward<DevicePickupSnsTopicARNT>(value);
  }
  template <typename DevicePickupSnsTopicARNT = Aws::String>
  Notification& WithDevicePickupSnsTopicARN(DevicePickupSnsTopicARNT&& value) {
    SetDevicePickupSnsTopicARN(std::forward<DevicePickupSnsTopicARNT>(value));
    return *this;
  }
  ///@}
 private:
