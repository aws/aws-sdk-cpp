...
class ListLongTermPricingRequest : public SnowballRequest {
 public:
  AWS_SNOWBALL_API ListLongTermPricingRequest() = default;
  ...
  inline ListLongTermPricingRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLongTermPricingRequest& WithNextToken(NextTokenT&& value) {
