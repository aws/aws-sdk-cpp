...
class Ec2AmiResource {
 public:
  ...
  AWS_SNOWBALL_API Ec2AmiResource(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API Ec2AmiResource& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename AmiIdT = Aws::String>
  Ec2AmiResource& WithAmiId(AmiIdT&& value) {
  ...
  void SetSnowballAmiId(SnowballAmiIdT&& value) {
    m_snowballAmiIdHasBeenSet = true;
    m_snowballAmiId = std::forward<SnowballAmiIdT>(value);
  }
  template <typename SnowballAmiIdT = Aws::String>
  Ec2AmiResource& WithSnowballAmiId(SnowballAmiIdT&& value) {
    SetSnowballAmiId(std::forward<SnowballAmiIdT>(value));
    return *this;
  }
  ///@}
 private:
