...
class PickupDetails {
 public:
  ...
  AWS_SNOWBALL_API PickupDetails(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API PickupDetails& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetIdentificationNumber(IdentificationNumberT&& value) {
    ...
    m_identificationNumber = std::forward<IdentificationNumberT>(value);
  }
  template <typename IdentificationNumberT = Aws::String>
  PickupDetails& WithIdentificationNumber(IdentificationNumberT&& value) {
    SetIdentificationNumber(std::forward<IdentificationNumberT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentificationExpirationDate(IdentificationExpirationDateT&& value) {
    ...
    m_identificationExpirationDate = std::forward<IdentificationExpirationDateT>(value);
  }
  template <typename IdentificationExpirationDateT = Aws::Utils::DateTime>
  PickupDetails& WithIdentificationExpirationDate(IdentificationExpirationDateT&& value) {
    SetIdentificationExpirationDate(std::forward<IdentificationExpirationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIdentificationIssuingOrg(IdentificationIssuingOrgT&& value) {
    ...
    m_identificationIssuingOrg = std::forward<IdentificationIssuingOrgT>(value);
  }
  template <typename IdentificationIssuingOrgT = Aws::String>
  PickupDetails& WithIdentificationIssuingOrg(IdentificationIssuingOrgT&& value) {
    SetIdentificationIssuingOrg(std::forward<IdentificationIssuingOrgT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDevicePickupId(DevicePickupIdT&& value) {
    ...
    m_devicePickupId = std::forward<DevicePickupIdT>(value);
  }
  template <typename DevicePickupIdT = Aws::String>
  PickupDetails& WithDevicePickupId(DevicePickupIdT&& value) {
    SetDevicePickupId(std::forward<DevicePickupIdT>(value));
    return *this;
  }
  ///@}
 private:
