...
class OnDeviceServiceConfiguration {
 public:
  ...
  AWS_SNOWBALL_API OnDeviceServiceConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API OnDeviceServiceConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetNFSOnDeviceService(NFSOnDeviceServiceT&& value) {
    ...
    m_nFSOnDeviceService = std::forward<NFSOnDeviceServiceT>(value);
  }
  template <typename NFSOnDeviceServiceT = NFSOnDeviceServiceConfiguration>
  OnDeviceServiceConfiguration& WithNFSOnDeviceService(NFSOnDeviceServiceT&& value) {
    SetNFSOnDeviceService(std::forward<NFSOnDeviceServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTGWOnDeviceService(TGWOnDeviceServiceT&& value) {
    ...
    m_tGWOnDeviceService = std::forward<TGWOnDeviceServiceT>(value);
  }
  template <typename TGWOnDeviceServiceT = TGWOnDeviceServiceConfiguration>
  OnDeviceServiceConfiguration& WithTGWOnDeviceService(TGWOnDeviceServiceT&& value) {
    SetTGWOnDeviceService(std::forward<TGWOnDeviceServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEKSOnDeviceService(EKSOnDeviceServiceT&& value) {
    ...
    m_eKSOnDeviceService = std::forward<EKSOnDeviceServiceT>(value);
  }
  template <typename EKSOnDeviceServiceT = EKSOnDeviceServiceConfiguration>
  OnDeviceServiceConfiguration& WithEKSOnDeviceService(EKSOnDeviceServiceT&& value) {
    SetEKSOnDeviceService(std::forward<EKSOnDeviceServiceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3OnDeviceService(S3OnDeviceServiceT&& value) {
    ...
    m_s3OnDeviceService = std::forward<S3OnDeviceServiceT>(value);
  }
  template <typename S3OnDeviceServiceT = S3OnDeviceServiceConfiguration>
  OnDeviceServiceConfiguration& WithS3OnDeviceService(S3OnDeviceServiceT&& value) {
    SetS3OnDeviceService(std::forward<S3OnDeviceServiceT>(value));
    return *this;
  }
  ///@}
 private:
