...
class Address {
 public:
  ...
  AWS_SNOWBALL_API Address(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API Address& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetPrefectureOrDistrict(PrefectureOrDistrictT&& value) {
    ...
    m_prefectureOrDistrict = std::forward<PrefectureOrDistrictT>(value);
  }
  template <typename PrefectureOrDistrictT = Aws::String>
  Address& WithPrefectureOrDistrict(PrefectureOrDistrictT&& value) {
    SetPrefectureOrDistrict(std::forward<PrefectureOrDistrictT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLandmark(LandmarkT&& value) {
    ...
    m_landmark = std::forward<LandmarkT>(value);
  }
  template <typename LandmarkT = Aws::String>
  Address& WithLandmark(LandmarkT&& value) {
    SetLandmark(std::forward<LandmarkT>(value));
    return *this;
  }
  ///@}
  ...
  inline Address& WithIsRestricted(bool value) {
  ...
  inline void SetType(AddressType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline Address& WithType(AddressType value) {
    SetType(value);
    return *this;
  }
  ///@}
