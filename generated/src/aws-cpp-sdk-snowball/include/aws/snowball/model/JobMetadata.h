...
class JobMetadata {
 public:
  ...
  AWS_SNOWBALL_API JobMetadata(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API JobMetadata& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetJobState(JobState value) {
    m_jobStateHasBeenSet = true;
    m_jobState = value;
  }
  inline JobMetadata& WithJobState(JobState value) {
    SetJobState(value);
    return *this;
  }
  ///@}
  ...
  inline JobMetadata& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSnowballType(SnowballType value) {
    m_snowballTypeHasBeenSet = true;
    m_snowballType = value;
  }
  inline JobMetadata& WithSnowballType(SnowballType value) {
    SetSnowballType(value);
    return *this;
  }
  ///@}
  ...
  void SetShippingDetails(ShippingDetailsT&& value) {
    ...
    m_shippingDetails = std::forward<ShippingDetailsT>(value);
  }
  template <typename ShippingDetailsT = ShippingDetails>
  JobMetadata& WithShippingDetails(ShippingDetailsT&& value) {
    SetShippingDetails(std::forward<ShippingDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobMetadata& WithSnowballCapacityPreference(SnowballCapacity value) {
  ...
  void SetJobLogInfo(JobLogInfoT&& value) {
    ...
    m_jobLogInfo = std::forward<JobLogInfoT>(value);
  }
  template <typename JobLogInfoT = JobLogs>
  JobMetadata& WithJobLogInfo(JobLogInfoT&& value) {
    SetJobLogInfo(std::forward<JobLogInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaxDocuments(TaxDocumentsT&& value) {
    ...
    m_taxDocuments = std::forward<TaxDocumentsT>(value);
  }
  template <typename TaxDocumentsT = TaxDocuments>
  JobMetadata& WithTaxDocuments(TaxDocumentsT&& value) {
    SetTaxDocuments(std::forward<TaxDocumentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRemoteManagement(RemoteManagement value) {
    m_remoteManagementHasBeenSet = true;
    m_remoteManagement = value;
  }
  inline JobMetadata& WithRemoteManagement(RemoteManagement value) {
    SetRemoteManagement(value);
    return *this;
  }
  ///@}
  ...
  void SetLongTermPricingId(LongTermPricingIdT&& value) {
    ...
    m_longTermPricingId = std::forward<LongTermPricingIdT>(value);
  }
  template <typename LongTermPricingIdT = Aws::String>
  JobMetadata& WithLongTermPricingId(LongTermPricingIdT&& value) {
    SetLongTermPricingId(std::forward<LongTermPricingIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetImpactLevel(ImpactLevel value) {
    m_impactLevelHasBeenSet = true;
    m_impactLevel = value;
  }
  inline JobMetadata& WithImpactLevel(ImpactLevel value) {
  ...
  void SetSnowballId(SnowballIdT&& value) {
    ...
    m_snowballId = std::forward<SnowballIdT>(value);
  }
  template <typename SnowballIdT = Aws::String>
  JobMetadata& WithSnowballId(SnowballIdT&& value) {
    SetSnowballId(std::forward<SnowballIdT>(value));
    return *this;
  }
  ///@}
 private:
