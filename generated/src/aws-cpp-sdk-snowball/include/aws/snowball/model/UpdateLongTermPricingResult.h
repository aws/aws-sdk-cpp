...
namespace Model
{
  ...
  public:
    ...
    inline UpdateLongTermPricingResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateLongTermPricingResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateLongTermPricingResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
