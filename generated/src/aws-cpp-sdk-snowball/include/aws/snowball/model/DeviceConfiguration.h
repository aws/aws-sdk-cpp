...
class DeviceConfiguration {
 public:
  ...
  void SetSnowconeDeviceConfiguration(SnowconeDeviceConfigurationT&& value) {
    ...
    m_snowconeDeviceConfiguration = std::forward<SnowconeDeviceConfigurationT>(value);
  }
  template <typename SnowconeDeviceConfigurationT = SnowconeDeviceConfiguration>
  DeviceConfiguration& WithSnowconeDeviceConfiguration(SnowconeDeviceConfigurationT&& value) {
    SetSnowconeDeviceConfiguration(std::forward<SnowconeDeviceConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
