...
class ConflictException {
 public:
  ...
  AWS_SNOWBALL_API ConflictException(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API ConflictException& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetConflictResource(ConflictResourceT&& value) {
    ...
    m_conflictResource = std::forward<ConflictResourceT>(value);
  }
  template <typename ConflictResourceT = Aws::String>
  ConflictException& WithConflictResource(ConflictResourceT&& value) {
    SetConflictResource(std::forward<ConflictResourceT>(value));
    return *this;
  }
  ///@}
