...
class EKSOnDeviceServiceConfiguration {
 public:
  ...
  AWS_SNOWBALL_API EKSOnDeviceServiceConfiguration(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API EKSOnDeviceServiceConfiguration& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  void SetKubernetesVersion(KubernetesVersionT&& value) {
    ...
    m_kubernetesVersion = std::forward<KubernetesVersionT>(value);
  }
  template <typename KubernetesVersionT = Aws::String>
  EKSOnDeviceServiceConfiguration& WithKubernetesVersion(KubernetesVersionT&& value) {
    SetKubernetesVersion(std::forward<KubernetesVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEKSAnywhereVersion(EKSAnywhereVersionT&& value) {
    m_eKSAnywhereVersionHasBeenSet = true;
    m_eKSAnywhereVersion = std::forward<EKSAnywhereVersionT>(value);
  }
  template <typename EKSAnywhereVersionT = Aws::String>
  EKSOnDeviceServiceConfiguration& WithEKSAnywhereVersion(EKSAnywhereVersionT&& value) {
    SetEKSAnywhereVersion(std::forward<EKSAnywhereVersionT>(value));
    return *this;
  }
  ///@}
 private:
