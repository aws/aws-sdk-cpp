...
/**
 */
class DescribeAddressesRequest : public SnowballRequest {
 public:
  AWS_SNOWBALL_API DescribeAddressesRequest() = default;
  ...
  inline DescribeAddressesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAddressesRequest& WithNextToken(NextTokenT&& value) {
