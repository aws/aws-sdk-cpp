...
class TargetOnDeviceService {
 public:
  ...
  inline void SetServiceName(DeviceServiceName value) {
    m_serviceNameHasBeenSet = true;
    m_serviceName = value;
  }
  inline TargetOnDeviceService& WithServiceName(DeviceServiceName value) {
  ...
  inline void SetTransferOption(TransferOption value) {
    m_transferOptionHasBeenSet = true;
    m_transferOption = value;
  }
  inline TargetOnDeviceService& WithTransferOption(TransferOption value) {
    SetTransferOption(value);
    return *this;
  }
  ///@}
 private:
