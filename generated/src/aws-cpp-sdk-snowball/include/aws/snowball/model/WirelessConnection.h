...
/**
 * <p>Configures the wireless connection on an Snowball Edge device.</p><p><h3>See
 * Also:</h3>   <a
...
class WirelessConnection {
 public:
  ...
  inline void SetIsWifiEnabled(bool value) {
    m_isWifiEnabledHasBeenSet = true;
    m_isWifiEnabled = value;
  }
  inline WirelessConnection& WithIsWifiEnabled(bool value) {
    SetIsWifiEnabled(value);
    return *this;
  }
  ///@}
 private:
