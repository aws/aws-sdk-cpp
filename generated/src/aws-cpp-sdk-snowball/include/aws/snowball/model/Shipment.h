...
class Shipment {
 public:
  ...
  AWS_SNOWBALL_API Shipment(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API Shipment& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename StatusT = Aws::String>
  Shipment& WithStatus(StatusT&& value) {
  ...
  template <typename TrackingNumberT = Aws::String>
  Shipment& WithTrackingNumber(TrackingNumberT&& value) {
