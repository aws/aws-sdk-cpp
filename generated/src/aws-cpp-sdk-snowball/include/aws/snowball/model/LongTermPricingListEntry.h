...
class LongTermPricingListEntry {
 public:
  ...
  AWS_SNOWBALL_API LongTermPricingListEntry(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API LongTermPricingListEntry& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename LongTermPricingIdT = Aws::String>
  LongTermPricingListEntry& WithLongTermPricingId(LongTermPricingIdT&& value) {
  ...
  void SetLongTermPricingEndDate(LongTermPricingEndDateT&& value) {
    m_longTermPricingEndDateHasBeenSet = true;
    m_longTermPricingEndDate = std::forward<LongTermPricingEndDateT>(value);
  }
  template <typename LongTermPricingEndDateT = Aws::Utils::DateTime>
  LongTermPricingListEntry& WithLongTermPricingEndDate(LongTermPricingEndDateT&& value) {
    SetLongTermPricingEndDate(std::forward<LongTermPricingEndDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLongTermPricingStartDate(LongTermPricingStartDateT&& value) {
    m_longTermPricingStartDateHasBeenSet = true;
    m_longTermPricingStartDate = std::forward<LongTermPricingStartDateT>(value);
  }
  template <typename LongTermPricingStartDateT = Aws::Utils::DateTime>
  LongTermPricingListEntry& WithLongTermPricingStartDate(LongTermPricingStartDateT&& value) {
    SetLongTermPricingStartDate(std::forward<LongTermPricingStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline LongTermPricingListEntry& WithLongTermPricingType(LongTermPricingType value) {
  ...
  void SetCurrentActiveJob(CurrentActiveJobT&& value) {
    m_currentActiveJobHasBeenSet = true;
    m_currentActiveJob = std::forward<CurrentActiveJobT>(value);
  }
  template <typename CurrentActiveJobT = Aws::String>
  LongTermPricingListEntry& WithCurrentActiveJob(CurrentActiveJobT&& value) {
    SetCurrentActiveJob(std::forward<CurrentActiveJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReplacementJob(ReplacementJobT&& value) {
    m_replacementJobHasBeenSet = true;
    m_replacementJob = std::forward<ReplacementJobT>(value);
  }
  template <typename ReplacementJobT = Aws::String>
  LongTermPricingListEntry& WithReplacementJob(ReplacementJobT&& value) {
    SetReplacementJob(std::forward<ReplacementJobT>(value));
    return *this;
  }
  ///@}
  ...
  inline LongTermPricingListEntry& WithIsLongTermPricingAutoRenew(bool value) {
  ...
  void SetLongTermPricingStatus(LongTermPricingStatusT&& value) {
    m_longTermPricingStatusHasBeenSet = true;
    m_longTermPricingStatus = std::forward<LongTermPricingStatusT>(value);
  }
  template <typename LongTermPricingStatusT = Aws::String>
  LongTermPricingListEntry& WithLongTermPricingStatus(LongTermPricingStatusT&& value) {
    SetLongTermPricingStatus(std::forward<LongTermPricingStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline LongTermPricingListEntry& WithSnowballType(SnowballType value) {
  ...
  template <typename JobIdsT = Aws::Vector<Aws::String>>
  LongTermPricingListEntry& WithJobIds(JobIdsT&& value) {
    SetJobIds(std::forward<JobIdsT>(value));
    return *this;
  }
  template <typename JobIdsT = Aws::String>
  LongTermPricingListEntry& AddJobIds(JobIdsT&& value) {
    m_jobIdsHasBeenSet = true;
