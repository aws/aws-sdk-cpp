...
namespace Model
{
  ...
  {
  public:
    AWS_SNOWBALL_API ListClusterJobsResult() = default;
    ...
    template<typename JobListEntriesT = Aws::Vector<JobListEntry>>
    ListClusterJobsResult& WithJobListEntries(JobListEntriesT&& value) { SetJobListEntries(std::forward<JobListEntriesT>(value)); return *this;}
    template<typename JobListEntriesT = JobListEntry>
    ListClusterJobsResult& AddJobListEntries(JobListEntriesT&& value) { m_jobListEntriesHasBeenSet = true; m_jobListEntries.emplace_back(std::forward<JobListEntriesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListClusterJobsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListClusterJobsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
