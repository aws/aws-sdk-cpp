...
class ListClusterJobsResult {
 public:
  ...
  AWS_SNOWBALL_API ListClusterJobsResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_SNOWBALL_API ListClusterJobsResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename JobListEntriesT = Aws::Vector<JobListEntry>>
  ListClusterJobsResult& WithJobListEntries(JobListEntriesT&& value) {
    SetJobListEntries(std::forward<JobListEntriesT>(value));
    return *this;
  }
  template <typename JobListEntriesT = JobListEntry>
  ListClusterJobsResult& AddJobListEntries(JobListEntriesT&& value) {
    m_jobListEntriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClusterJobsResult& WithRequestId(RequestIdT&& value) {
