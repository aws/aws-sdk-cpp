...
class ClusterMetadata {
 public:
  ...
  AWS_SNOWBALL_API ClusterMetadata(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_SNOWBALL_API ClusterMetadata& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  inline void SetClusterState(ClusterState value) {
    m_clusterStateHasBeenSet = true;
    m_clusterState = value;
  }
  inline ClusterMetadata& WithClusterState(ClusterState value) {
  ...
  inline ClusterMetadata& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline ClusterMetadata& WithSnowballType(SnowballType value) {
  ...
  inline ClusterMetadata& WithShippingOption(ShippingOption value) {
