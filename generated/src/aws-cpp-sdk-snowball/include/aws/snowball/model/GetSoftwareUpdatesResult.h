...
class GetSoftwareUpdatesResult {
 public:
  ...
  AWS_SNOWBALL_API GetSoftwareUpdatesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_SNOWBALL_API GetSoftwareUpdatesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  void SetUpdatesURI(UpdatesURIT&& value) {
    m_updatesURIHasBeenSet = true;
    m_updatesURI = std::forward<UpdatesURIT>(value);
  }
  template <typename UpdatesURIT = Aws::String>
  GetSoftwareUpdatesResult& WithUpdatesURI(UpdatesURIT&& value) {
    SetUpdatesURI(std::forward<UpdatesURIT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetSoftwareUpdatesResult& WithRequestId(RequestIdT&& value) {
