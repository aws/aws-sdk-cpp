...
class LambdaResource {
 public:
  ...
  template <typename LambdaArnT = Aws::String>
  LambdaResource& WithLambdaArn(LambdaArnT&& value) {
  ...
  void SetEventTriggers(EventTriggersT&& value) {
    m_eventTriggersHasBeenSet = true;
    m_eventTriggers = std::forward<EventTriggersT>(value);
  }
  template <typename EventTriggersT = Aws::Vector<EventTriggerDefinition>>
  LambdaResource& WithEventTriggers(EventTriggersT&& value) {
    SetEventTriggers(std::forward<EventTriggersT>(value));
    return *this;
  }
  template <typename EventTriggersT = EventTriggerDefinition>
  LambdaResource& AddEventTriggers(EventTriggersT&& value) {
    m_eventTriggersHasBeenSet = true;
    m_eventTriggers.emplace_back(std::forward<EventTriggersT>(value));
    return *this;
  }
  ///@}
 private:
