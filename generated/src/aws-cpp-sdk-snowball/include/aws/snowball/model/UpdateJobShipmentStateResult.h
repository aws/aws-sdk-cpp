...
namespace Model
{
  ...
  public:
    ...
    inline UpdateJobShipmentStateResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateJobShipmentStateResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateJobShipmentStateResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
