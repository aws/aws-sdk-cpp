...
class UpdateJobShipmentStateRequest : public SnowballRequest {
 public:
  ...
  inline void SetShipmentState(ShipmentState value) {
    m_shipmentStateHasBeenSet = true;
    m_shipmentState = value;
  }
  inline UpdateJobShipmentStateRequest& WithShipmentState(ShipmentState value) {
