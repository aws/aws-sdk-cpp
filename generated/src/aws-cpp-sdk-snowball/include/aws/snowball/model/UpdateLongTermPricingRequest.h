...
class UpdateLongTermPricingRequest : public SnowballRequest {
 public:
  ...
  template <typename LongTermPricingIdT = Aws::String>
  UpdateLongTermPricingRequest& WithLongTermPricingId(LongTermPricingIdT&& value) {
  ...
  template <typename ReplacementJobT = Aws::String>
  UpdateLongTermPricingRequest& WithReplacementJob(ReplacementJobT&& value) {
  ...
  inline UpdateLongTermPricingRequest& WithIsLongTermPricingAutoRenew(bool value) {
