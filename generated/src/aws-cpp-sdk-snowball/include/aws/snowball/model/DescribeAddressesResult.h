...
class DescribeAddressesResult {
 public:
  ...
  AWS_SNOWBALL_API DescribeAddressesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_SNOWBALL_API DescribeAddressesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename AddressesT = Aws::Vector<Address>>
  DescribeAddressesResult& WithAddresses(AddressesT&& value) {
    SetAddresses(std::forward<AddressesT>(value));
    return *this;
  }
  template <typename AddressesT = Address>
  DescribeAddressesResult& AddAddresses(AddressesT&& value) {
    m_addressesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAddressesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAddressesResult& WithRequestId(RequestIdT&& value) {
