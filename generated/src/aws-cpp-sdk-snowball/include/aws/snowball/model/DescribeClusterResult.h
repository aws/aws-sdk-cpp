...
class DescribeClusterResult {
 public:
  ...
  AWS_SNOWBALL_API DescribeClusterResult(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  AWS_SNOWBALL_API DescribeClusterResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Cbor::CborValue>& result);
  ...
  template <typename ClusterMetadataT = ClusterMetadata>
  DescribeClusterResult& WithClusterMetadata(ClusterMetadataT&& value) {
