...
class CreateJobRequest : public SnowballRequest {
 public:
  ...
  inline CreateJobRequest& WithSnowballCapacityPreference(SnowballCapacity value) {
  ...
  inline CreateJobRequest& WithShippingOption(ShippingOption value) {
  ...
  inline CreateJobRequest& WithSnowballType(SnowballType value) {
  ...
  inline CreateJobRequest& WithRemoteManagement(RemoteManagement value) {
  ...
  inline CreateJobRequest& WithImpactLevel(ImpactLevel value) {
