...
class ListCompatibleImagesRequest : public SnowballRequest {
 public:
  AWS_SNOWBALL_API ListCompatibleImagesRequest() = default;
  ...
  inline ListCompatibleImagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCompatibleImagesRequest& WithNextToken(NextTokenT&& value) {
