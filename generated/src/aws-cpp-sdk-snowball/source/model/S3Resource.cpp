...
S3Resource::S3Resource(JsonView jsonValue) { *this = jsonValue; }
...
S3Resource& S3Resource::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TargetOnDeviceServices")) {
    ...
    for (unsigned targetOnDeviceServicesIndex = 0; targetOnDeviceServicesIndex < targetOnDeviceServicesJsonList.GetLength();
         ++targetOnDeviceServicesIndex) {
