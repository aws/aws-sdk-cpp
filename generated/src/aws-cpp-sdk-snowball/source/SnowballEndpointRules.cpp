...
namespace Snowball
{
const size_t SnowballEndpointRules::RulesBlobStrLen = 3732;
const size_t SnowballEndpointRules::RulesBlobSize = 3733;
...
':','/','/','s','n','o','w','b','a','l','l','-','f','i','p','s','.','{','R','e','g','i','o','n','}',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','n','o','w','b','a','l','l','.',
...
'b','a','l','l','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
