...
namespace ChimeSDKMediaPipelines
{
   ...
   */
  class AWS_CHIMESDKMEDIAPIPELINES_API ChimeSDKMediaPipelinesClient : Aws::Client::ClientWithAsyncTemplateMethods<ChimeSDKMediaPipelinesClient>,
    smithy::client::AwsSmithyClientT<Aws::ChimeSDKMediaPipelines::SERVICE_NAME,
