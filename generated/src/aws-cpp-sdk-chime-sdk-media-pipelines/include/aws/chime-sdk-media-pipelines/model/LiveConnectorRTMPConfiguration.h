...
class LiveConnectorRTMPConfiguration {
 public:
  ...
  template <typename UrlT = Aws::String>
  LiveConnectorRTMPConfiguration& WithUrl(UrlT&& value) {
  ...
  inline void SetAudioChannels(AudioChannelsOption value) {
    m_audioChannelsHasBeenSet = true;
    m_audioChannels = value;
  }
  inline LiveConnectorRTMPConfiguration& WithAudioChannels(AudioChannelsOption value) {
  ...
  void SetAudioSampleRate(AudioSampleRateT&& value) {
    m_audioSampleRateHasBeenSet = true;
    m_audioSampleRate = std::forward<AudioSampleRateT>(value);
  }
  template <typename AudioSampleRateT = Aws::String>
  LiveConnectorRTMPConfiguration& WithAudioSampleRate(AudioSampleRateT&& value) {
    SetAudioSampleRate(std::forward<AudioSampleRateT>(value));
    return *this;
  }
  ///@}
 private:
