...
class LiveConnectorSinkConfiguration {
 public:
  ...
  inline void SetSinkType(LiveConnectorSinkType value) {
    m_sinkTypeHasBeenSet = true;
    m_sinkType = value;
  }
  inline LiveConnectorSinkConfiguration& WithSinkType(LiveConnectorSinkType value) {
    SetSinkType(value);
    return *this;
  }
  ///@}
  ...
  void SetRTMPConfiguration(RTMPConfigurationT&& value) {
    m_rTMPConfigurationHasBeenSet = true;
    m_rTMPConfiguration = std::forward<RTMPConfigurationT>(value);
  }
  template <typename RTMPConfigurationT = LiveConnectorRTMPConfiguration>
  LiveConnectorSinkConfiguration& WithRTMPConfiguration(RTMPConfigurationT&& value) {
    SetRTMPConfiguration(std::forward<RTMPConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
