...
/**
 */
class ListMediaCapturePipelinesRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  AWS_CHIMESDKMEDIAPIPELINES_API ListMediaCapturePipelinesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaCapturePipelinesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMediaCapturePipelinesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
