...
class ListMediaCapturePipelinesResult {
 public:
  ...
  AWS_CHIMESDKMEDIAPIPELINES_API ListMediaCapturePipelinesResult& operator=(
  ...
  void SetMediaCapturePipelines(MediaCapturePipelinesT&& value) {
    m_mediaCapturePipelinesHasBeenSet = true;
    m_mediaCapturePipelines = std::forward<MediaCapturePipelinesT>(value);
  }
  template <typename MediaCapturePipelinesT = Aws::Vector<MediaCapturePipelineSummary>>
  ListMediaCapturePipelinesResult& WithMediaCapturePipelines(MediaCapturePipelinesT&& value) {
    SetMediaCapturePipelines(std::forward<MediaCapturePipelinesT>(value));
    return *this;
  }
  template <typename MediaCapturePipelinesT = MediaCapturePipelineSummary>
  ListMediaCapturePipelinesResult& AddMediaCapturePipelines(MediaCapturePipelinesT&& value) {
    m_mediaCapturePipelinesHasBeenSet = true;
    m_mediaCapturePipelines.emplace_back(std::forward<MediaCapturePipelinesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaCapturePipelinesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMediaCapturePipelinesResult& WithRequestId(RequestIdT&& value) {
