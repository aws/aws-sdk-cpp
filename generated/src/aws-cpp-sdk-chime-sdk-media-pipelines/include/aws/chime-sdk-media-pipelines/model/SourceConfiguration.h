...
class SourceConfiguration {
 public:
  ...
  void SetSelectedVideoStreams(SelectedVideoStreamsT&& value) {
    m_selectedVideoStreamsHasBeenSet = true;
    m_selectedVideoStreams = std::forward<SelectedVideoStreamsT>(value);
  }
  template <typename SelectedVideoStreamsT = SelectedVideoStreams>
  SourceConfiguration& WithSelectedVideoStreams(SelectedVideoStreamsT&& value) {
    SetSelectedVideoStreams(std::forward<SelectedVideoStreamsT>(value));
    return *this;
  }
  ///@}
 private:
