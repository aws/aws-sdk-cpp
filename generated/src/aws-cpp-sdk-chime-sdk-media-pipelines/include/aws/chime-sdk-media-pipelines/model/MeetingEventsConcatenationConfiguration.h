...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API MeetingEventsConcatenationConfiguration() = default;
    ...
    inline MeetingEventsConcatenationConfiguration& WithState(ArtifactsConcatenationState value) { SetState(value); return *this;}
    ///@}
  private:
