...
class KinesisVideoStreamPoolConfiguration {
 public:
  ...
  template <typename PoolArnT = Aws::String>
  KinesisVideoStreamPoolConfiguration& WithPoolArn(PoolArnT&& value) {
  ...
  template <typename PoolNameT = Aws::String>
  KinesisVideoStreamPoolConfiguration& WithPoolName(PoolNameT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  KinesisVideoStreamPoolConfiguration& WithPoolId(PoolIdT&& value) {
  ...
  inline void SetPoolStatus(KinesisVideoStreamPoolStatus value) {
    m_poolStatusHasBeenSet = true;
    m_poolStatus = value;
  }
  inline KinesisVideoStreamPoolConfiguration& WithPoolStatus(KinesisVideoStreamPoolStatus value) {
    SetPoolStatus(value);
    return *this;
  }
  ///@}
  ...
  inline KinesisVideoStreamPoolConfiguration& WithPoolSize(int value) {
    SetPoolSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename StreamConfigurationT = KinesisVideoStreamConfiguration>
  KinesisVideoStreamPoolConfiguration& WithStreamConfiguration(StreamConfigurationT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  KinesisVideoStreamPoolConfiguration& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  KinesisVideoStreamPoolConfiguration& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
