...
class ListMediaPipelineKinesisVideoStreamPoolsRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  AWS_CHIMESDKMEDIAPIPELINES_API ListMediaPipelineKinesisVideoStreamPoolsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaPipelineKinesisVideoStreamPoolsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMediaPipelineKinesisVideoStreamPoolsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
