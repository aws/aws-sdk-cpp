...
namespace Model
{
   ...
   * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/ConflictException">AWS
   * API Reference</a></p>
   */
  class ConflictException
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API ConflictException() = default;
    AWS_CHIMESDKMEDIAPIPELINES_API ConflictException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIMESDKMEDIAPIPELINES_API ConflictException& operator=(Aws::Utils::Json::JsonView jsonValue);
