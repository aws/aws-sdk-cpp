...
class GridViewConfiguration {
 public:
  ...
  inline void SetContentShareLayout(ContentShareLayoutOption value) {
    m_contentShareLayoutHasBeenSet = true;
    m_contentShareLayout = value;
  }
  inline GridViewConfiguration& WithContentShareLayout(ContentShareLayoutOption value) {
    SetContentShareLayout(value);
    return *this;
  }
  ///@}
  ...
  void SetPresenterOnlyConfiguration(PresenterOnlyConfigurationT&& value) {
    m_presenterOnlyConfigurationHasBeenSet = true;
    m_presenterOnlyConfiguration = std::forward<PresenterOnlyConfigurationT>(value);
  }
  template <typename PresenterOnlyConfigurationT = PresenterOnlyConfiguration>
  GridViewConfiguration& WithPresenterOnlyConfiguration(PresenterOnlyConfigurationT&& value) {
    SetPresenterOnlyConfiguration(std::forward<PresenterOnlyConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActiveSpeakerOnlyConfiguration(ActiveSpeakerOnlyConfigurationT&& value) {
    m_activeSpeakerOnlyConfigurationHasBeenSet = true;
    m_activeSpeakerOnlyConfiguration = std::forward<ActiveSpeakerOnlyConfigurationT>(value);
  }
  template <typename ActiveSpeakerOnlyConfigurationT = ActiveSpeakerOnlyConfiguration>
  GridViewConfiguration& WithActiveSpeakerOnlyConfiguration(ActiveSpeakerOnlyConfigurationT&& value) {
    SetActiveSpeakerOnlyConfiguration(std::forward<ActiveSpeakerOnlyConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHorizontalLayoutConfiguration(HorizontalLayoutConfigurationT&& value) {
    m_horizontalLayoutConfigurationHasBeenSet = true;
    m_horizontalLayoutConfiguration = std::forward<HorizontalLayoutConfigurationT>(value);
  }
  template <typename HorizontalLayoutConfigurationT = HorizontalLayoutConfiguration>
  GridViewConfiguration& WithHorizontalLayoutConfiguration(HorizontalLayoutConfigurationT&& value) {
    SetHorizontalLayoutConfiguration(std::forward<HorizontalLayoutConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerticalLayoutConfiguration(VerticalLayoutConfigurationT&& value) {
    m_verticalLayoutConfigurationHasBeenSet = true;
    m_verticalLayoutConfiguration = std::forward<VerticalLayoutConfigurationT>(value);
  }
  template <typename VerticalLayoutConfigurationT = VerticalLayoutConfiguration>
  GridViewConfiguration& WithVerticalLayoutConfiguration(VerticalLayoutConfigurationT&& value) {
    SetVerticalLayoutConfiguration(std::forward<VerticalLayoutConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVideoAttribute(VideoAttributeT&& value) {
    m_videoAttributeHasBeenSet = true;
    m_videoAttribute = std::forward<VideoAttributeT>(value);
  }
  template <typename VideoAttributeT = VideoAttribute>
  GridViewConfiguration& WithVideoAttribute(VideoAttributeT&& value) {
    SetVideoAttribute(std::forward<VideoAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCanvasOrientation(CanvasOrientation value) {
    m_canvasOrientationHasBeenSet = true;
    m_canvasOrientation = value;
  }
  inline GridViewConfiguration& WithCanvasOrientation(CanvasOrientation value) {
    SetCanvasOrientation(value);
    return *this;
  }
  ///@}
 private:
