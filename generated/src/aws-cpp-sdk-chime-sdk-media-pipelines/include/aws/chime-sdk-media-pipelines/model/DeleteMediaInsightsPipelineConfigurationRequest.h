...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API DeleteMediaInsightsPipelineConfigurationRequest() = default;
    ...
    template<typename IdentifierT = Aws::String>
    DeleteMediaInsightsPipelineConfigurationRequest& WithIdentifier(IdentifierT&& value) { SetIdentifier(std::forward<IdentifierT>(value)); return *this;}
    ///@}
  private:
