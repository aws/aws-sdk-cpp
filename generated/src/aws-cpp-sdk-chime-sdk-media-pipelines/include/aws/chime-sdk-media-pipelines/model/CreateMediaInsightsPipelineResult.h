...
class CreateMediaInsightsPipelineResult {
 public:
  ...
  AWS_CHIMESDKMEDIAPIPELINES_API CreateMediaInsightsPipelineResult& operator=(
  ...
  void SetMediaInsightsPipeline(MediaInsightsPipelineT&& value) {
    m_mediaInsightsPipelineHasBeenSet = true;
    m_mediaInsightsPipeline = std::forward<MediaInsightsPipelineT>(value);
  }
  template <typename MediaInsightsPipelineT = MediaInsightsPipeline>
  CreateMediaInsightsPipelineResult& WithMediaInsightsPipeline(MediaInsightsPipelineT&& value) {
    SetMediaInsightsPipeline(std::forward<MediaInsightsPipelineT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateMediaInsightsPipelineResult& WithRequestId(RequestIdT&& value) {
