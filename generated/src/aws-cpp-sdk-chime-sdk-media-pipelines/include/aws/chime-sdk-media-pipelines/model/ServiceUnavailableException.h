...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API ServiceUnavailableException() = default;
    ...
    inline ServiceUnavailableException& WithCode(ErrorCode value) { SetCode(value); return *this;}
    ///@}
