...
class SseAwsKeyManagementParams {
 public:
  ...
  void SetAwsKmsKeyId(AwsKmsKeyIdT&& value) {
    ...
    m_awsKmsKeyId = std::forward<AwsKmsKeyIdT>(value);
  }
  template <typename AwsKmsKeyIdT = Aws::String>
  SseAwsKeyManagementParams& WithAwsKmsKeyId(AwsKmsKeyIdT&& value) {
    SetAwsKmsKeyId(std::forward<AwsKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsKmsEncryptionContext(AwsKmsEncryptionContextT&& value) {
    m_awsKmsEncryptionContextHasBeenSet = true;
    m_awsKmsEncryptionContext = std::forward<AwsKmsEncryptionContextT>(value);
  }
  template <typename AwsKmsEncryptionContextT = Aws::String>
  SseAwsKeyManagementParams& WithAwsKmsEncryptionContext(AwsKmsEncryptionContextT&& value) {
    SetAwsKmsEncryptionContext(std::forward<AwsKmsEncryptionContextT>(value));
    return *this;
  }
  ///@}
 private:
