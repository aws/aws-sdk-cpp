...
class StopVoiceToneAnalysisTaskRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  StopVoiceToneAnalysisTaskRequest& WithIdentifier(IdentifierT&& value) {
  ...
  void SetVoiceToneAnalysisTaskId(VoiceToneAnalysisTaskIdT&& value) {
    m_voiceToneAnalysisTaskIdHasBeenSet = true;
    m_voiceToneAnalysisTaskId = std::forward<VoiceToneAnalysisTaskIdT>(value);
  }
  template <typename VoiceToneAnalysisTaskIdT = Aws::String>
  StopVoiceToneAnalysisTaskRequest& WithVoiceToneAnalysisTaskId(VoiceToneAnalysisTaskIdT&& value) {
    SetVoiceToneAnalysisTaskId(std::forward<VoiceToneAnalysisTaskIdT>(value));
    return *this;
  }
  ///@}
 private:
