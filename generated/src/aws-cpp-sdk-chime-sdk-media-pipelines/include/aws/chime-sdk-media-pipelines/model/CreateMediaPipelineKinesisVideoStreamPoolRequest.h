...
class CreateMediaPipelineKinesisVideoStreamPoolRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  void SetStreamConfiguration(StreamConfigurationT&& value) {
    m_streamConfigurationHasBeenSet = true;
    m_streamConfiguration = std::forward<StreamConfigurationT>(value);
  }
  template <typename StreamConfigurationT = KinesisVideoStreamConfiguration>
  CreateMediaPipelineKinesisVideoStreamPoolRequest& WithStreamConfiguration(StreamConfigurationT&& value) {
    SetStreamConfiguration(std::forward<StreamConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PoolNameT = Aws::String>
  CreateMediaPipelineKinesisVideoStreamPoolRequest& WithPoolName(PoolNameT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaPipelineKinesisVideoStreamPoolRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaPipelineKinesisVideoStreamPoolRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaPipelineKinesisVideoStreamPoolRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
