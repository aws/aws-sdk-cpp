...
class CreateMediaCapturePipelineRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  inline CreateMediaCapturePipelineRequest& WithSourceType(MediaPipelineSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceArnT = Aws::String>
  CreateMediaCapturePipelineRequest& WithSourceArn(SourceArnT&& value) {
  ...
  inline CreateMediaCapturePipelineRequest& WithSinkType(MediaPipelineSinkType value) {
    SetSinkType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SinkArnT = Aws::String>
  CreateMediaCapturePipelineRequest& WithSinkArn(SinkArnT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaCapturePipelineRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename ChimeSdkMeetingConfigurationT = ChimeSdkMeetingConfiguration>
  CreateMediaCapturePipelineRequest& WithChimeSdkMeetingConfiguration(ChimeSdkMeetingConfigurationT&& value) {
  ...
  template <typename SseAwsKeyManagementParamsT = SseAwsKeyManagementParams>
  CreateMediaCapturePipelineRequest& WithSseAwsKeyManagementParams(SseAwsKeyManagementParamsT&& value) {
  ...
  template <typename SinkIamRoleArnT = Aws::String>
  CreateMediaCapturePipelineRequest& WithSinkIamRoleArn(SinkIamRoleArnT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaCapturePipelineRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaCapturePipelineRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
