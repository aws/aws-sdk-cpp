...
namespace Model
{
  ...
  public:
    ...
    template<typename KinesisVideoStreamPoolConfigurationT = KinesisVideoStreamPoolConfiguration>
    UpdateMediaPipelineKinesisVideoStreamPoolResult& WithKinesisVideoStreamPoolConfiguration(KinesisVideoStreamPoolConfigurationT&& value) { SetKinesisVideoStreamPoolConfiguration(std::forward<KinesisVideoStreamPoolConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateMediaPipelineKinesisVideoStreamPoolResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
