...
class MediaInsightsPipelineConfigurationElement {
 public:
  ...
  inline void SetType(MediaInsightsPipelineConfigurationElementType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MediaInsightsPipelineConfigurationElement& WithType(MediaInsightsPipelineConfigurationElementType value) {
    SetType(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const AmazonTranscribeCallAnalyticsProcessorConfiguration& GetAmazonTranscribeCallAnalyticsProcessorConfiguration() const {
    return m_amazonTranscribeCallAnalyticsProcessorConfiguration;
  }
  inline bool AmazonTranscribeCallAnalyticsProcessorConfigurationHasBeenSet() const {
    return m_amazonTranscribeCallAnalyticsProcessorConfigurationHasBeenSet;
  }
  ...
  void SetAmazonTranscribeCallAnalyticsProcessorConfiguration(AmazonTranscribeCallAnalyticsProcessorConfigurationT&& value) {
    m_amazonTranscribeCallAnalyticsProcessorConfigurationHasBeenSet = true;
    m_amazonTranscribeCallAnalyticsProcessorConfiguration = std::forward<AmazonTranscribeCallAnalyticsProcessorConfigurationT>(value);
  }
  template <typename AmazonTranscribeCallAnalyticsProcessorConfigurationT = AmazonTranscribeCallAnalyticsProcessorConfiguration>
  MediaInsightsPipelineConfigurationElement& WithAmazonTranscribeCallAnalyticsProcessorConfiguration(
      AmazonTranscribeCallAnalyticsProcessorConfigurationT&& value) {
    SetAmazonTranscribeCallAnalyticsProcessorConfiguration(std::forward<AmazonTranscribeCallAnalyticsProcessorConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const AmazonTranscribeProcessorConfiguration& GetAmazonTranscribeProcessorConfiguration() const {
    return m_amazonTranscribeProcessorConfiguration;
  }
  ...
  void SetAmazonTranscribeProcessorConfiguration(AmazonTranscribeProcessorConfigurationT&& value) {
    m_amazonTranscribeProcessorConfigurationHasBeenSet = true;
    m_amazonTranscribeProcessorConfiguration = std::forward<AmazonTranscribeProcessorConfigurationT>(value);
  }
  template <typename AmazonTranscribeProcessorConfigurationT = AmazonTranscribeProcessorConfiguration>
  MediaInsightsPipelineConfigurationElement& WithAmazonTranscribeProcessorConfiguration(AmazonTranscribeProcessorConfigurationT&& value) {
    SetAmazonTranscribeProcessorConfiguration(std::forward<AmazonTranscribeProcessorConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * insights pipeline configuration element.</p>
   */
  inline const KinesisDataStreamSinkConfiguration& GetKinesisDataStreamSinkConfiguration() const {
    return m_kinesisDataStreamSinkConfiguration;
  }
  ...
  void SetKinesisDataStreamSinkConfiguration(KinesisDataStreamSinkConfigurationT&& value) {
    m_kinesisDataStreamSinkConfigurationHasBeenSet = true;
    m_kinesisDataStreamSinkConfiguration = std::forward<KinesisDataStreamSinkConfigurationT>(value);
  }
  template <typename KinesisDataStreamSinkConfigurationT = KinesisDataStreamSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithKinesisDataStreamSinkConfiguration(KinesisDataStreamSinkConfigurationT&& value) {
    SetKinesisDataStreamSinkConfiguration(std::forward<KinesisDataStreamSinkConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3RecordingSinkConfiguration(S3RecordingSinkConfigurationT&& value) {
    m_s3RecordingSinkConfigurationHasBeenSet = true;
    m_s3RecordingSinkConfiguration = std::forward<S3RecordingSinkConfigurationT>(value);
  }
  template <typename S3RecordingSinkConfigurationT = S3RecordingSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithS3RecordingSinkConfiguration(S3RecordingSinkConfigurationT&& value) {
    SetS3RecordingSinkConfiguration(std::forward<S3RecordingSinkConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const VoiceAnalyticsProcessorConfiguration& GetVoiceAnalyticsProcessorConfiguration() const {
    return m_voiceAnalyticsProcessorConfiguration;
  }
  ...
  void SetVoiceAnalyticsProcessorConfiguration(VoiceAnalyticsProcessorConfigurationT&& value) {
    m_voiceAnalyticsProcessorConfigurationHasBeenSet = true;
    m_voiceAnalyticsProcessorConfiguration = std::forward<VoiceAnalyticsProcessorConfigurationT>(value);
  }
  template <typename VoiceAnalyticsProcessorConfigurationT = VoiceAnalyticsProcessorConfiguration>
  MediaInsightsPipelineConfigurationElement& WithVoiceAnalyticsProcessorConfiguration(VoiceAnalyticsProcessorConfigurationT&& value) {
    SetVoiceAnalyticsProcessorConfiguration(std::forward<VoiceAnalyticsProcessorConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaFunctionSinkConfiguration(LambdaFunctionSinkConfigurationT&& value) {
    m_lambdaFunctionSinkConfigurationHasBeenSet = true;
    m_lambdaFunctionSinkConfiguration = std::forward<LambdaFunctionSinkConfigurationT>(value);
  }
  template <typename LambdaFunctionSinkConfigurationT = LambdaFunctionSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithLambdaFunctionSinkConfiguration(LambdaFunctionSinkConfigurationT&& value) {
    SetLambdaFunctionSinkConfiguration(std::forward<LambdaFunctionSinkConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqsQueueSinkConfiguration(SqsQueueSinkConfigurationT&& value) {
    m_sqsQueueSinkConfigurationHasBeenSet = true;
    m_sqsQueueSinkConfiguration = std::forward<SqsQueueSinkConfigurationT>(value);
  }
  template <typename SqsQueueSinkConfigurationT = SqsQueueSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithSqsQueueSinkConfiguration(SqsQueueSinkConfigurationT&& value) {
    SetSqsQueueSinkConfiguration(std::forward<SqsQueueSinkConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSnsTopicSinkConfiguration(SnsTopicSinkConfigurationT&& value) {
    m_snsTopicSinkConfigurationHasBeenSet = true;
    m_snsTopicSinkConfiguration = std::forward<SnsTopicSinkConfigurationT>(value);
  }
  template <typename SnsTopicSinkConfigurationT = SnsTopicSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithSnsTopicSinkConfiguration(SnsTopicSinkConfigurationT&& value) {
    SetSnsTopicSinkConfiguration(std::forward<SnsTopicSinkConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * pipeline configuration element.</p>
   */
  inline const VoiceEnhancementSinkConfiguration& GetVoiceEnhancementSinkConfiguration() const {
    return m_voiceEnhancementSinkConfiguration;
  }
  ...
  void SetVoiceEnhancementSinkConfiguration(VoiceEnhancementSinkConfigurationT&& value) {
    m_voiceEnhancementSinkConfigurationHasBeenSet = true;
    m_voiceEnhancementSinkConfiguration = std::forward<VoiceEnhancementSinkConfigurationT>(value);
  }
  template <typename VoiceEnhancementSinkConfigurationT = VoiceEnhancementSinkConfiguration>
  MediaInsightsPipelineConfigurationElement& WithVoiceEnhancementSinkConfiguration(VoiceEnhancementSinkConfigurationT&& value) {
    SetVoiceEnhancementSinkConfiguration(std::forward<VoiceEnhancementSinkConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
