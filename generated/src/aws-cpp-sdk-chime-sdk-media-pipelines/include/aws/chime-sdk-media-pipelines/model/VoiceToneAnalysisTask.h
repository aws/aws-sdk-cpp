...
class VoiceToneAnalysisTask {
 public:
  ...
  template <typename VoiceToneAnalysisTaskIdT = Aws::String>
  VoiceToneAnalysisTask& WithVoiceToneAnalysisTaskId(VoiceToneAnalysisTaskIdT&& value) {
  ...
  inline void SetVoiceToneAnalysisTaskStatus(MediaPipelineTaskStatus value) {
    m_voiceToneAnalysisTaskStatusHasBeenSet = true;
    m_voiceToneAnalysisTaskStatus = value;
  }
  inline VoiceToneAnalysisTask& WithVoiceToneAnalysisTaskStatus(MediaPipelineTaskStatus value) {
    SetVoiceToneAnalysisTaskStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  VoiceToneAnalysisTask& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  VoiceToneAnalysisTask& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
