...
class MediaCapturePipelineSourceConfiguration {
 public:
  ...
  template <typename MediaPipelineArnT = Aws::String>
  MediaCapturePipelineSourceConfiguration& WithMediaPipelineArn(MediaPipelineArnT&& value) {
  ...
  template <typename ChimeSdkMeetingConfigurationT = ChimeSdkMeetingConcatenationConfiguration>
  MediaCapturePipelineSourceConfiguration& WithChimeSdkMeetingConfiguration(ChimeSdkMeetingConfigurationT&& value) {
