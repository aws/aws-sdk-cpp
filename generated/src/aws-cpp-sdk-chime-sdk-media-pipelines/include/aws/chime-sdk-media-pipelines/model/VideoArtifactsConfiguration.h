...
class VideoArtifactsConfiguration {
 public:
  ...
  inline void SetState(ArtifactsState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline VideoArtifactsConfiguration& WithState(ArtifactsState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMuxType(VideoMuxType value) {
    m_muxTypeHasBeenSet = true;
    m_muxType = value;
  }
  inline VideoArtifactsConfiguration& WithMuxType(VideoMuxType value) {
    SetMuxType(value);
    return *this;
  }
  ///@}
