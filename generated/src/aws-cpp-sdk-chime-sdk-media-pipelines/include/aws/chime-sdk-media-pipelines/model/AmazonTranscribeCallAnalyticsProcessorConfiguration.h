...
class AmazonTranscribeCallAnalyticsProcessorConfiguration {
 public:
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithLanguageCode(CallAnalyticsLanguageCode value) {
  ...
  template <typename VocabularyNameT = Aws::String>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithVocabularyName(VocabularyNameT&& value) {
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
  ...
  template <typename LanguageModelNameT = Aws::String>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithLanguageModelName(LanguageModelNameT&& value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithEnablePartialResultsStabilization(bool value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithPartialResultsStability(PartialResultsStability value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithContentIdentificationType(ContentType value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithContentRedactionType(ContentType value) {
  ...
  template <typename PiiEntityTypesT = Aws::String>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithPiiEntityTypes(PiiEntityTypesT&& value) {
  ...
  inline AmazonTranscribeCallAnalyticsProcessorConfiguration& WithFilterPartialResults(bool value) {
  ...
  void SetPostCallAnalyticsSettings(PostCallAnalyticsSettingsT&& value) {
    m_postCallAnalyticsSettingsHasBeenSet = true;
    m_postCallAnalyticsSettings = std::forward<PostCallAnalyticsSettingsT>(value);
  }
  template <typename PostCallAnalyticsSettingsT = PostCallAnalyticsSettings>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithPostCallAnalyticsSettings(PostCallAnalyticsSettingsT&& value) {
    SetPostCallAnalyticsSettings(std::forward<PostCallAnalyticsSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCallAnalyticsStreamCategories(CallAnalyticsStreamCategoriesT&& value) {
    m_callAnalyticsStreamCategoriesHasBeenSet = true;
    m_callAnalyticsStreamCategories = std::forward<CallAnalyticsStreamCategoriesT>(value);
  }
  template <typename CallAnalyticsStreamCategoriesT = Aws::Vector<Aws::String>>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& WithCallAnalyticsStreamCategories(CallAnalyticsStreamCategoriesT&& value) {
    SetCallAnalyticsStreamCategories(std::forward<CallAnalyticsStreamCategoriesT>(value));
    return *this;
  }
  template <typename CallAnalyticsStreamCategoriesT = Aws::String>
  AmazonTranscribeCallAnalyticsProcessorConfiguration& AddCallAnalyticsStreamCategories(CallAnalyticsStreamCategoriesT&& value) {
    m_callAnalyticsStreamCategoriesHasBeenSet = true;
    m_callAnalyticsStreamCategories.emplace_back(std::forward<CallAnalyticsStreamCategoriesT>(value));
    return *this;
  }
  ///@}
 private:
