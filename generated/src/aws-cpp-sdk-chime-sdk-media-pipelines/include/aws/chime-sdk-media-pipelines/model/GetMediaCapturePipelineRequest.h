...
namespace Model
{
  ...
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API GetMediaCapturePipelineRequest() = default;
    ...
    template<typename MediaPipelineIdT = Aws::String>
    GetMediaCapturePipelineRequest& WithMediaPipelineId(MediaPipelineIdT&& value) { SetMediaPipelineId(std::forward<MediaPipelineIdT>(value)); return *this;}
    ///@}
  private:
