...
class CreateMediaLiveConnectorPipelineRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename SourcesT = Aws::Vector<LiveConnectorSourceConfiguration>>
  CreateMediaLiveConnectorPipelineRequest& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = LiveConnectorSourceConfiguration>
  CreateMediaLiveConnectorPipelineRequest& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename SinksT = Aws::Vector<LiveConnectorSinkConfiguration>>
  CreateMediaLiveConnectorPipelineRequest& WithSinks(SinksT&& value) {
    SetSinks(std::forward<SinksT>(value));
    return *this;
  }
  template <typename SinksT = LiveConnectorSinkConfiguration>
  CreateMediaLiveConnectorPipelineRequest& AddSinks(SinksT&& value) {
    m_sinksHasBeenSet = true;
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaLiveConnectorPipelineRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaLiveConnectorPipelineRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaLiveConnectorPipelineRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
