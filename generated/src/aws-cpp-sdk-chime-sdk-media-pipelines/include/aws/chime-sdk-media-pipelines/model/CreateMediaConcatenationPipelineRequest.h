...
class CreateMediaConcatenationPipelineRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename SourcesT = Aws::Vector<ConcatenationSource>>
  CreateMediaConcatenationPipelineRequest& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = ConcatenationSource>
  CreateMediaConcatenationPipelineRequest& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename SinksT = Aws::Vector<ConcatenationSink>>
  CreateMediaConcatenationPipelineRequest& WithSinks(SinksT&& value) {
    SetSinks(std::forward<SinksT>(value));
    return *this;
  }
  template <typename SinksT = ConcatenationSink>
  CreateMediaConcatenationPipelineRequest& AddSinks(SinksT&& value) {
    m_sinksHasBeenSet = true;
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaConcatenationPipelineRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaConcatenationPipelineRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaConcatenationPipelineRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
