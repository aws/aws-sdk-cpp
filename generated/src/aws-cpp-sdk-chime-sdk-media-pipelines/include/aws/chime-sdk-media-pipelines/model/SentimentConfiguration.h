...
class SentimentConfiguration {
 public:
  ...
  template <typename RuleNameT = Aws::String>
  SentimentConfiguration& WithRuleName(RuleNameT&& value) {
  ...
  inline void SetSentimentType(SentimentType value) {
    m_sentimentTypeHasBeenSet = true;
    m_sentimentType = value;
  }
  inline SentimentConfiguration& WithSentimentType(SentimentType value) {
  ...
  inline void SetTimePeriod(int value) {
    m_timePeriodHasBeenSet = true;
    m_timePeriod = value;
  }
  inline SentimentConfiguration& WithTimePeriod(int value) {
    SetTimePeriod(value);
    return *this;
  }
  ///@}
