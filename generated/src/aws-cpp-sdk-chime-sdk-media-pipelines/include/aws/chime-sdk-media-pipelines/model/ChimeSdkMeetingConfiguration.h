...
class ChimeSdkMeetingConfiguration {
 public:
  ...
  template <typename SourceConfigurationT = SourceConfiguration>
  ChimeSdkMeetingConfiguration& WithSourceConfiguration(SourceConfigurationT&& value) {
  ...
  void SetArtifactsConfiguration(ArtifactsConfigurationT&& value) {
    m_artifactsConfigurationHasBeenSet = true;
    m_artifactsConfiguration = std::forward<ArtifactsConfigurationT>(value);
  }
  template <typename ArtifactsConfigurationT = ArtifactsConfiguration>
  ChimeSdkMeetingConfiguration& WithArtifactsConfiguration(ArtifactsConfigurationT&& value) {
    SetArtifactsConfiguration(std::forward<ArtifactsConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
