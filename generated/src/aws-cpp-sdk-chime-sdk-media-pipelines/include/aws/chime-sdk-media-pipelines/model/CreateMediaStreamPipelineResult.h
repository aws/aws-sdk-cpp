...
class CreateMediaStreamPipelineResult {
 public:
  ...
  AWS_CHIMESDKMEDIAPIPELINES_API CreateMediaStreamPipelineResult& operator=(
  ...
  template <typename MediaStreamPipelineT = MediaStreamPipeline>
  CreateMediaStreamPipelineResult& WithMediaStreamPipeline(MediaStreamPipelineT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateMediaStreamPipelineResult& WithRequestId(RequestIdT&& value) {
