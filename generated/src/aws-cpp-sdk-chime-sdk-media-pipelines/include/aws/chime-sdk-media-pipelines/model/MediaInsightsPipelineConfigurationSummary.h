...
class MediaInsightsPipelineConfigurationSummary {
 public:
  ...
  template <typename MediaInsightsPipelineConfigurationNameT = Aws::String>
  MediaInsightsPipelineConfigurationSummary& WithMediaInsightsPipelineConfigurationName(MediaInsightsPipelineConfigurationNameT&& value) {
  ...
  template <typename MediaInsightsPipelineConfigurationIdT = Aws::String>
  MediaInsightsPipelineConfigurationSummary& WithMediaInsightsPipelineConfigurationId(MediaInsightsPipelineConfigurationIdT&& value) {
  ...
  template <typename MediaInsightsPipelineConfigurationArnT = Aws::String>
  MediaInsightsPipelineConfigurationSummary& WithMediaInsightsPipelineConfigurationArn(MediaInsightsPipelineConfigurationArnT&& value) {
