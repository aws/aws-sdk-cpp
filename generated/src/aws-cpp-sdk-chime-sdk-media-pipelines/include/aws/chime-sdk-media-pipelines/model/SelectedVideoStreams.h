...
class SelectedVideoStreams {
 public:
  ...
  void SetAttendeeIds(AttendeeIdsT&& value) {
    m_attendeeIdsHasBeenSet = true;
    m_attendeeIds = std::forward<AttendeeIdsT>(value);
  }
  template <typename AttendeeIdsT = Aws::Vector<Aws::String>>
  SelectedVideoStreams& WithAttendeeIds(AttendeeIdsT&& value) {
    SetAttendeeIds(std::forward<AttendeeIdsT>(value));
    return *this;
  }
  template <typename AttendeeIdsT = Aws::String>
  SelectedVideoStreams& AddAttendeeIds(AttendeeIdsT&& value) {
    m_attendeeIdsHasBeenSet = true;
    m_attendeeIds.emplace_back(std::forward<AttendeeIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExternalUserIds(ExternalUserIdsT&& value) {
    m_externalUserIdsHasBeenSet = true;
    m_externalUserIds = std::forward<ExternalUserIdsT>(value);
  }
  template <typename ExternalUserIdsT = Aws::Vector<Aws::String>>
  SelectedVideoStreams& WithExternalUserIds(ExternalUserIdsT&& value) {
    SetExternalUserIds(std::forward<ExternalUserIdsT>(value));
    return *this;
  }
  template <typename ExternalUserIdsT = Aws::String>
  SelectedVideoStreams& AddExternalUserIds(ExternalUserIdsT&& value) {
    m_externalUserIdsHasBeenSet = true;
    m_externalUserIds.emplace_back(std::forward<ExternalUserIdsT>(value));
    return *this;
  }
  ///@}
 private:
