...
namespace Model
{
   ...
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/ForbiddenException">AWS
   * API Reference</a></p>
   */
  class ForbiddenException
  {
  public:
    AWS_CHIMESDKMEDIAPIPELINES_API ForbiddenException() = default;
    AWS_CHIMESDKMEDIAPIPELINES_API ForbiddenException(Aws::Utils::Json::JsonView jsonValue);
    AWS_CHIMESDKMEDIAPIPELINES_API ForbiddenException& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename RequestIdT = Aws::String>
    ForbiddenException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
