...
class VideoAttribute {
 public:
  ...
  inline void SetCornerRadius(int value) {
    m_cornerRadiusHasBeenSet = true;
    m_cornerRadius = value;
  }
  inline VideoAttribute& WithCornerRadius(int value) {
  ...
  inline void SetBorderColor(BorderColor value) {
    m_borderColorHasBeenSet = true;
    m_borderColor = value;
  }
  inline VideoAttribute& WithBorderColor(BorderColor value) {
  ...
  inline void SetHighlightColor(HighlightColor value) {
    m_highlightColorHasBeenSet = true;
    m_highlightColor = value;
  }
  inline VideoAttribute& WithHighlightColor(HighlightColor value) {
  ...
  inline void SetBorderThickness(int value) {
    m_borderThicknessHasBeenSet = true;
    m_borderThickness = value;
  }
  inline VideoAttribute& WithBorderThickness(int value) {
