...
class GetMediaPipelineResult {
 public:
  ...
  void SetMediaPipeline(MediaPipelineT&& value) {
    m_mediaPipelineHasBeenSet = true;
    m_mediaPipeline = std::forward<MediaPipelineT>(value);
  }
  template <typename MediaPipelineT = MediaPipeline>
  GetMediaPipelineResult& WithMediaPipeline(MediaPipelineT&& value) {
    SetMediaPipeline(std::forward<MediaPipelineT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetMediaPipelineResult& WithRequestId(RequestIdT&& value) {
