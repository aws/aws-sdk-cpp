...
class UpdateMediaPipelineKinesisVideoStreamPoolRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  UpdateMediaPipelineKinesisVideoStreamPoolRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename StreamConfigurationT = KinesisVideoStreamConfigurationUpdate>
  UpdateMediaPipelineKinesisVideoStreamPoolRequest& WithStreamConfiguration(StreamConfigurationT&& value) {
