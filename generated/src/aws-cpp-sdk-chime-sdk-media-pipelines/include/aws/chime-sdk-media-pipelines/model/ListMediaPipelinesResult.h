...
class ListMediaPipelinesResult {
 public:
  ...
  AWS_CHIMESDKMEDIAPIPELINES_API ListMediaPipelinesResult& operator=(
  ...
  void SetMediaPipelines(MediaPipelinesT&& value) {
    m_mediaPipelinesHasBeenSet = true;
    m_mediaPipelines = std::forward<MediaPipelinesT>(value);
  }
  template <typename MediaPipelinesT = Aws::Vector<MediaPipelineSummary>>
  ListMediaPipelinesResult& WithMediaPipelines(MediaPipelinesT&& value) {
    SetMediaPipelines(std::forward<MediaPipelinesT>(value));
    return *this;
  }
  template <typename MediaPipelinesT = MediaPipelineSummary>
  ListMediaPipelinesResult& AddMediaPipelines(MediaPipelinesT&& value) {
    m_mediaPipelinesHasBeenSet = true;
    m_mediaPipelines.emplace_back(std::forward<MediaPipelinesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaPipelinesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMediaPipelinesResult& WithRequestId(RequestIdT&& value) {
