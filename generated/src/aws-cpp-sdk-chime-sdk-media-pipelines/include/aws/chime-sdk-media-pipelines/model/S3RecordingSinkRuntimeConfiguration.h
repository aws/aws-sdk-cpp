...
class S3RecordingSinkRuntimeConfiguration {
 public:
  ...
  template <typename DestinationT = Aws::String>
  S3RecordingSinkRuntimeConfiguration& WithDestination(DestinationT&& value) {
  ...
  inline void SetRecordingFileFormat(RecordingFileFormat value) {
    m_recordingFileFormatHasBeenSet = true;
    m_recordingFileFormat = value;
  }
  inline S3RecordingSinkRuntimeConfiguration& WithRecordingFileFormat(RecordingFileFormat value) {
    SetRecordingFileFormat(value);
    return *this;
  }
  ///@}
 private:
