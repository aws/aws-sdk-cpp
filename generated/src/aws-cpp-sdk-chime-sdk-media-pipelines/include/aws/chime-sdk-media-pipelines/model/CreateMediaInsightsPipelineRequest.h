...
class CreateMediaInsightsPipelineRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename MediaInsightsPipelineConfigurationArnT = Aws::String>
  CreateMediaInsightsPipelineRequest& WithMediaInsightsPipelineConfigurationArn(MediaInsightsPipelineConfigurationArnT&& value) {
  ...
  template <typename KinesisVideoStreamSourceRuntimeConfigurationT = KinesisVideoStreamSourceRuntimeConfiguration>
  CreateMediaInsightsPipelineRequest& WithKinesisVideoStreamSourceRuntimeConfiguration(
      KinesisVideoStreamSourceRuntimeConfigurationT&& value) {
  ...
  template <typename MediaInsightsRuntimeMetadataT = Aws::Map<Aws::String, Aws::String>>
  CreateMediaInsightsPipelineRequest& WithMediaInsightsRuntimeMetadata(MediaInsightsRuntimeMetadataT&& value) {
  ...
  CreateMediaInsightsPipelineRequest& AddMediaInsightsRuntimeMetadata(MediaInsightsRuntimeMetadataKeyT&& key,
  ...
  template <typename KinesisVideoStreamRecordingSourceRuntimeConfigurationT = KinesisVideoStreamRecordingSourceRuntimeConfiguration>
  CreateMediaInsightsPipelineRequest& WithKinesisVideoStreamRecordingSourceRuntimeConfiguration(
  ...
  template <typename S3RecordingSinkRuntimeConfigurationT = S3RecordingSinkRuntimeConfiguration>
  CreateMediaInsightsPipelineRequest& WithS3RecordingSinkRuntimeConfiguration(S3RecordingSinkRuntimeConfigurationT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaInsightsPipelineRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaInsightsPipelineRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaInsightsPipelineRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
