...
class DeleteMediaPipelineKinesisVideoStreamPoolRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  AWS_CHIMESDKMEDIAPIPELINES_API DeleteMediaPipelineKinesisVideoStreamPoolRequest() = default;
  ...
  template <typename IdentifierT = Aws::String>
  DeleteMediaPipelineKinesisVideoStreamPoolRequest& WithIdentifier(IdentifierT&& value) {
