...
class ContentArtifactsConfiguration {
 public:
  ...
  inline ContentArtifactsConfiguration& WithState(ArtifactsState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMuxType(ContentMuxType value) {
    m_muxTypeHasBeenSet = true;
    m_muxType = value;
  }
  inline ContentArtifactsConfiguration& WithMuxType(ContentMuxType value) {
    SetMuxType(value);
    return *this;
  }
  ///@}
