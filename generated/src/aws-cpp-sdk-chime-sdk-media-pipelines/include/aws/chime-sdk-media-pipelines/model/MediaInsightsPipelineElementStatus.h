...
class MediaInsightsPipelineElementStatus {
 public:
  ...
  inline MediaInsightsPipelineElementStatus& WithType(MediaInsightsPipelineConfigurationElementType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(MediaPipelineElementStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MediaInsightsPipelineElementStatus& WithStatus(MediaPipelineElementStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
