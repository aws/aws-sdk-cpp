...
class MediaPipeline {
 public:
  ...
  template <typename MediaCapturePipelineT = MediaCapturePipeline>
  MediaPipeline& WithMediaCapturePipeline(MediaCapturePipelineT&& value) {
  ...
  void SetMediaLiveConnectorPipeline(MediaLiveConnectorPipelineT&& value) {
    m_mediaLiveConnectorPipelineHasBeenSet = true;
    m_mediaLiveConnectorPipeline = std::forward<MediaLiveConnectorPipelineT>(value);
  }
  template <typename MediaLiveConnectorPipelineT = MediaLiveConnectorPipeline>
  MediaPipeline& WithMediaLiveConnectorPipeline(MediaLiveConnectorPipelineT&& value) {
    SetMediaLiveConnectorPipeline(std::forward<MediaLiveConnectorPipelineT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MediaConcatenationPipelineT = MediaConcatenationPipeline>
  MediaPipeline& WithMediaConcatenationPipeline(MediaConcatenationPipelineT&& value) {
  ...
  template <typename MediaInsightsPipelineT = MediaInsightsPipeline>
  MediaPipeline& WithMediaInsightsPipeline(MediaInsightsPipelineT&& value) {
  ...
  void SetMediaStreamPipeline(MediaStreamPipelineT&& value) {
    m_mediaStreamPipelineHasBeenSet = true;
    m_mediaStreamPipeline = std::forward<MediaStreamPipelineT>(value);
  }
  template <typename MediaStreamPipelineT = MediaStreamPipeline>
  MediaPipeline& WithMediaStreamPipeline(MediaStreamPipelineT&& value) {
    SetMediaStreamPipeline(std::forward<MediaStreamPipelineT>(value));
    return *this;
  }
  ///@}
 private:
