...
class ActiveSpeakerOnlyConfiguration {
 public:
  ...
  inline void SetActiveSpeakerPosition(ActiveSpeakerPosition value) {
    m_activeSpeakerPositionHasBeenSet = true;
    m_activeSpeakerPosition = value;
  }
  inline ActiveSpeakerOnlyConfiguration& WithActiveSpeakerPosition(ActiveSpeakerPosition value) {
    SetActiveSpeakerPosition(value);
    return *this;
  }
  ///@}
 private:
