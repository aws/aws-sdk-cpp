...
class ListMediaPipelinesRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  AWS_CHIMESDKMEDIAPIPELINES_API ListMediaPipelinesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListMediaPipelinesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMediaPipelinesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
