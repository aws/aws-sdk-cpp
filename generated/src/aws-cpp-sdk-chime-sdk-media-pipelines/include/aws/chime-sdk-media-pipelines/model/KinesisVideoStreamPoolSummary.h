...
class KinesisVideoStreamPoolSummary {
 public:
  ...
  template <typename PoolNameT = Aws::String>
  KinesisVideoStreamPoolSummary& WithPoolName(PoolNameT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  KinesisVideoStreamPoolSummary& WithPoolId(PoolIdT&& value) {
  ...
  template <typename PoolArnT = Aws::String>
  KinesisVideoStreamPoolSummary& WithPoolArn(PoolArnT&& value) {
