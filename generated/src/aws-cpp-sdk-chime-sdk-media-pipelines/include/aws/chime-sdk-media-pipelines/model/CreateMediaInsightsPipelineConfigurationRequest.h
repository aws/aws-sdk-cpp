...
class CreateMediaInsightsPipelineConfigurationRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename MediaInsightsPipelineConfigurationNameT = Aws::String>
  CreateMediaInsightsPipelineConfigurationRequest& WithMediaInsightsPipelineConfigurationName(
      MediaInsightsPipelineConfigurationNameT&& value) {
  ...
  template <typename ResourceAccessRoleArnT = Aws::String>
  CreateMediaInsightsPipelineConfigurationRequest& WithResourceAccessRoleArn(ResourceAccessRoleArnT&& value) {
  ...
  template <typename RealTimeAlertConfigurationT = RealTimeAlertConfiguration>
  CreateMediaInsightsPipelineConfigurationRequest& WithRealTimeAlertConfiguration(RealTimeAlertConfigurationT&& value) {
  ...
  template <typename ElementsT = Aws::Vector<MediaInsightsPipelineConfigurationElement>>
  CreateMediaInsightsPipelineConfigurationRequest& WithElements(ElementsT&& value) {
    SetElements(std::forward<ElementsT>(value));
    return *this;
  }
  template <typename ElementsT = MediaInsightsPipelineConfigurationElement>
  CreateMediaInsightsPipelineConfigurationRequest& AddElements(ElementsT&& value) {
    m_elementsHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMediaInsightsPipelineConfigurationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMediaInsightsPipelineConfigurationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientRequestTokenT = Aws::String>
  CreateMediaInsightsPipelineConfigurationRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
