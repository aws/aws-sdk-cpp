...
class KinesisVideoStreamRecordingSourceRuntimeConfiguration {
 public:
  ...
  template <typename StreamsT = Aws::Vector<RecordingStreamConfiguration>>
  KinesisVideoStreamRecordingSourceRuntimeConfiguration& WithStreams(StreamsT&& value) {
    SetStreams(std::forward<StreamsT>(value));
    return *this;
  }
  template <typename StreamsT = RecordingStreamConfiguration>
  KinesisVideoStreamRecordingSourceRuntimeConfiguration& AddStreams(StreamsT&& value) {
    m_streamsHasBeenSet = true;
  ...
  void SetFragmentSelector(FragmentSelectorT&& value) {
    m_fragmentSelectorHasBeenSet = true;
    m_fragmentSelector = std::forward<FragmentSelectorT>(value);
  }
  template <typename FragmentSelectorT = FragmentSelector>
  KinesisVideoStreamRecordingSourceRuntimeConfiguration& WithFragmentSelector(FragmentSelectorT&& value) {
    SetFragmentSelector(std::forward<FragmentSelectorT>(value));
    return *this;
  }
  ///@}
 private:
