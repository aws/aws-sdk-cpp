...
class KinesisVideoStreamConfiguration {
 public:
  ...
  template <typename RegionT = Aws::String>
  KinesisVideoStreamConfiguration& WithRegion(RegionT&& value) {
  ...
  inline void SetDataRetentionInHours(int value) {
    m_dataRetentionInHoursHasBeenSet = true;
    m_dataRetentionInHours = value;
  }
  inline KinesisVideoStreamConfiguration& WithDataRetentionInHours(int value) {
    SetDataRetentionInHours(value);
    return *this;
  }
  ///@}
 private:
