...
class MediaStreamPipeline {
 public:
  ...
  template <typename MediaPipelineIdT = Aws::String>
  MediaStreamPipeline& WithMediaPipelineId(MediaPipelineIdT&& value) {
  ...
  template <typename MediaPipelineArnT = Aws::String>
  MediaStreamPipeline& WithMediaPipelineArn(MediaPipelineArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  MediaStreamPipeline& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  MediaStreamPipeline& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  inline MediaStreamPipeline& WithStatus(MediaPipelineStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourcesT = Aws::Vector<MediaStreamSource>>
  MediaStreamPipeline& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = MediaStreamSource>
  MediaStreamPipeline& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename SinksT = Aws::Vector<MediaStreamSink>>
  MediaStreamPipeline& WithSinks(SinksT&& value) {
    SetSinks(std::forward<SinksT>(value));
    return *this;
  }
  template <typename SinksT = MediaStreamSink>
  MediaStreamPipeline& AddSinks(SinksT&& value) {
    m_sinksHasBeenSet = true;
