...
class SpeakerSearchTask {
 public:
  ...
  inline void SetSpeakerSearchTaskStatus(MediaPipelineTaskStatus value) {
    m_speakerSearchTaskStatusHasBeenSet = true;
    m_speakerSearchTaskStatus = value;
  }
  inline SpeakerSearchTask& WithSpeakerSearchTaskStatus(MediaPipelineTaskStatus value) {
    SetSpeakerSearchTaskStatus(value);
    return *this;
  }
  ///@}
