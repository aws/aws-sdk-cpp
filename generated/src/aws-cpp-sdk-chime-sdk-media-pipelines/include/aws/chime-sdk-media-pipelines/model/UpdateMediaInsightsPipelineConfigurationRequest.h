...
class UpdateMediaInsightsPipelineConfigurationRequest : public ChimeSDKMediaPipelinesRequest {
 public:
  ...
  template <typename IdentifierT = Aws::String>
  UpdateMediaInsightsPipelineConfigurationRequest& WithIdentifier(IdentifierT&& value) {
  ...
  template <typename ResourceAccessRoleArnT = Aws::String>
  UpdateMediaInsightsPipelineConfigurationRequest& WithResourceAccessRoleArn(ResourceAccessRoleArnT&& value) {
  ...
  template <typename RealTimeAlertConfigurationT = RealTimeAlertConfiguration>
  UpdateMediaInsightsPipelineConfigurationRequest& WithRealTimeAlertConfiguration(RealTimeAlertConfigurationT&& value) {
  ...
  template <typename ElementsT = Aws::Vector<MediaInsightsPipelineConfigurationElement>>
  UpdateMediaInsightsPipelineConfigurationRequest& WithElements(ElementsT&& value) {
    SetElements(std::forward<ElementsT>(value));
    return *this;
  }
  template <typename ElementsT = MediaInsightsPipelineConfigurationElement>
  UpdateMediaInsightsPipelineConfigurationRequest& AddElements(ElementsT&& value) {
    m_elementsHasBeenSet = true;
