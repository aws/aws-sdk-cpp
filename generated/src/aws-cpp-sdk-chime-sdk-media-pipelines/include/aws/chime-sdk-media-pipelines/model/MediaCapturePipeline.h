...
class MediaCapturePipeline {
 public:
  ...
  void SetMediaPipelineId(MediaPipelineIdT&& value) {
    m_mediaPipelineIdHasBeenSet = true;
    m_mediaPipelineId = std::forward<MediaPipelineIdT>(value);
  }
  template <typename MediaPipelineIdT = Aws::String>
  MediaCapturePipeline& WithMediaPipelineId(MediaPipelineIdT&& value) {
    SetMediaPipelineId(std::forward<MediaPipelineIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMediaPipelineArn(MediaPipelineArnT&& value) {
    m_mediaPipelineArnHasBeenSet = true;
    m_mediaPipelineArn = std::forward<MediaPipelineArnT>(value);
  }
  template <typename MediaPipelineArnT = Aws::String>
  MediaCapturePipeline& WithMediaPipelineArn(MediaPipelineArnT&& value) {
    SetMediaPipelineArn(std::forward<MediaPipelineArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSourceType(MediaPipelineSourceType value) {
    m_sourceTypeHasBeenSet = true;
    m_sourceType = value;
  }
  inline MediaCapturePipeline& WithSourceType(MediaPipelineSourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceArnT = Aws::String>
  MediaCapturePipeline& WithSourceArn(SourceArnT&& value) {
  ...
  inline void SetStatus(MediaPipelineStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline MediaCapturePipeline& WithStatus(MediaPipelineStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSinkType(MediaPipelineSinkType value) {
    m_sinkTypeHasBeenSet = true;
    m_sinkType = value;
  }
  inline MediaCapturePipeline& WithSinkType(MediaPipelineSinkType value) {
    SetSinkType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SinkArnT = Aws::String>
  MediaCapturePipeline& WithSinkArn(SinkArnT&& value) {
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  MediaCapturePipeline& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  MediaCapturePipeline& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
  ...
  void SetChimeSdkMeetingConfiguration(ChimeSdkMeetingConfigurationT&& value) {
    m_chimeSdkMeetingConfigurationHasBeenSet = true;
    m_chimeSdkMeetingConfiguration = std::forward<ChimeSdkMeetingConfigurationT>(value);
  }
  template <typename ChimeSdkMeetingConfigurationT = ChimeSdkMeetingConfiguration>
  MediaCapturePipeline& WithChimeSdkMeetingConfiguration(ChimeSdkMeetingConfigurationT&& value) {
    SetChimeSdkMeetingConfiguration(std::forward<ChimeSdkMeetingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSseAwsKeyManagementParams(SseAwsKeyManagementParamsT&& value) {
    m_sseAwsKeyManagementParamsHasBeenSet = true;
    m_sseAwsKeyManagementParams = std::forward<SseAwsKeyManagementParamsT>(value);
  }
  template <typename SseAwsKeyManagementParamsT = SseAwsKeyManagementParams>
  MediaCapturePipeline& WithSseAwsKeyManagementParams(SseAwsKeyManagementParamsT&& value) {
    SetSseAwsKeyManagementParams(std::forward<SseAwsKeyManagementParamsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSinkIamRoleArn(SinkIamRoleArnT&& value) {
    m_sinkIamRoleArnHasBeenSet = true;
    m_sinkIamRoleArn = std::forward<SinkIamRoleArnT>(value);
  }
  template <typename SinkIamRoleArnT = Aws::String>
  MediaCapturePipeline& WithSinkIamRoleArn(SinkIamRoleArnT&& value) {
    SetSinkIamRoleArn(std::forward<SinkIamRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
