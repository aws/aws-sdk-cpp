...
class ConcatenationSink {
 public:
  ...
  inline void SetType(ConcatenationSinkType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ConcatenationSink& WithType(ConcatenationSinkType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetS3BucketSinkConfiguration(S3BucketSinkConfigurationT&& value) {
    m_s3BucketSinkConfigurationHasBeenSet = true;
    m_s3BucketSinkConfiguration = std::forward<S3BucketSinkConfigurationT>(value);
  }
  template <typename S3BucketSinkConfigurationT = S3BucketSinkConfiguration>
  ConcatenationSink& WithS3BucketSinkConfiguration(S3BucketSinkConfigurationT&& value) {
    SetS3BucketSinkConfiguration(std::forward<S3BucketSinkConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
