...
class VideoConcatenationConfiguration {
 public:
  AWS_CHIMESDKMEDIAPIPELINES_API VideoConcatenationConfiguration() = default;
  ...
  inline void SetState(ArtifactsConcatenationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline VideoConcatenationConfiguration& WithState(ArtifactsConcatenationState value) {
    SetState(value);
    return *this;
  }
  ///@}
