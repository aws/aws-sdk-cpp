...
class MediaLiveConnectorPipeline {
 public:
  ...
  template <typename SourcesT = Aws::Vector<LiveConnectorSourceConfiguration>>
  MediaLiveConnectorPipeline& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = LiveConnectorSourceConfiguration>
  MediaLiveConnectorPipeline& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename SinksT = Aws::Vector<LiveConnectorSinkConfiguration>>
  MediaLiveConnectorPipeline& WithSinks(SinksT&& value) {
    SetSinks(std::forward<SinksT>(value));
    return *this;
  }
  template <typename SinksT = LiveConnectorSinkConfiguration>
  MediaLiveConnectorPipeline& AddSinks(SinksT&& value) {
    m_sinksHasBeenSet = true;
  ...
  template <typename MediaPipelineIdT = Aws::String>
  MediaLiveConnectorPipeline& WithMediaPipelineId(MediaPipelineIdT&& value) {
  ...
  template <typename MediaPipelineArnT = Aws::String>
  MediaLiveConnectorPipeline& WithMediaPipelineArn(MediaPipelineArnT&& value) {
  ...
  inline MediaLiveConnectorPipeline& WithStatus(MediaPipelineStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedTimestampT = Aws::Utils::DateTime>
  MediaLiveConnectorPipeline& WithCreatedTimestamp(CreatedTimestampT&& value) {
  ...
  template <typename UpdatedTimestampT = Aws::Utils::DateTime>
  MediaLiveConnectorPipeline& WithUpdatedTimestamp(UpdatedTimestampT&& value) {
