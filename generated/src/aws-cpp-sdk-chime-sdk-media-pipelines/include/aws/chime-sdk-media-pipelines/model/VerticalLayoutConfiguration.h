...
class VerticalLayoutConfiguration {
 public:
  ...
  inline VerticalLayoutConfiguration& WithTileOrder(TileOrder value) {
    SetTileOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTilePosition(VerticalTilePosition value) {
    m_tilePositionHasBeenSet = true;
    m_tilePosition = value;
  }
  inline VerticalLayoutConfiguration& WithTilePosition(VerticalTilePosition value) {
  ...
  inline VerticalLayoutConfiguration& WithTileCount(int value) {
    SetTileCount(value);
    return *this;
  }
  ///@}
  ...
  template <typename TileAspectRatioT = Aws::String>
  VerticalLayoutConfiguration& WithTileAspectRatio(TileAspectRatioT&& value) {
