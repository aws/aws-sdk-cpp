...
typedef Aws::Utils::Outcome<CreateMediaInsightsPipelineConfigurationResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<CreateMediaPipelineKinesisVideoStreamPoolResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<GetMediaInsightsPipelineConfigurationResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<GetMediaPipelineKinesisVideoStreamPoolResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<ListMediaInsightsPipelineConfigurationsResult, ChimeSDKMediaPipelinesError>
    ListMediaInsightsPipelineConfigurationsOutcome;
typedef Aws::Utils::Outcome<ListMediaPipelineKinesisVideoStreamPoolsResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<UpdateMediaInsightsPipelineConfigurationResult, ChimeSDKMediaPipelinesError>
...
typedef Aws::Utils::Outcome<UpdateMediaPipelineKinesisVideoStreamPoolResult, ChimeSDKMediaPipelinesError>
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaCapturePipelineRequest&,
                           const Model::CreateMediaCapturePipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaCapturePipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaConcatenationPipelineRequest&,
                           const Model::CreateMediaConcatenationPipelineOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaConcatenationPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaInsightsPipelineRequest&,
                           const Model::CreateMediaInsightsPipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaInsightsPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaInsightsPipelineConfigurationRequest&,
                           const Model::CreateMediaInsightsPipelineConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaInsightsPipelineConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaLiveConnectorPipelineRequest&,
                           const Model::CreateMediaLiveConnectorPipelineOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaLiveConnectorPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaPipelineKinesisVideoStreamPoolRequest&,
                           const Model::CreateMediaPipelineKinesisVideoStreamPoolOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaPipelineKinesisVideoStreamPoolResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::CreateMediaStreamPipelineRequest&,
                           const Model::CreateMediaStreamPipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    CreateMediaStreamPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::DeleteMediaCapturePipelineRequest&,
                           const Model::DeleteMediaCapturePipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMediaCapturePipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::DeleteMediaInsightsPipelineConfigurationRequest&,
                           const Model::DeleteMediaInsightsPipelineConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMediaInsightsPipelineConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::DeleteMediaPipelineRequest&,
                           const Model::DeleteMediaPipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMediaPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::DeleteMediaPipelineKinesisVideoStreamPoolRequest&,
                           const Model::DeleteMediaPipelineKinesisVideoStreamPoolOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    DeleteMediaPipelineKinesisVideoStreamPoolResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetMediaCapturePipelineRequest&,
                           const Model::GetMediaCapturePipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMediaCapturePipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetMediaInsightsPipelineConfigurationRequest&,
                           const Model::GetMediaInsightsPipelineConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMediaInsightsPipelineConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetMediaPipelineRequest&,
                           const Model::GetMediaPipelineOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMediaPipelineResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetMediaPipelineKinesisVideoStreamPoolRequest&,
                           const Model::GetMediaPipelineKinesisVideoStreamPoolOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetMediaPipelineKinesisVideoStreamPoolResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetSpeakerSearchTaskRequest&,
                           const Model::GetSpeakerSearchTaskOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetSpeakerSearchTaskResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::GetVoiceToneAnalysisTaskRequest&,
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::ListMediaCapturePipelinesRequest&,
                           const Model::ListMediaCapturePipelinesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListMediaCapturePipelinesResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::ListMediaInsightsPipelineConfigurationsRequest&,
                           const Model::ListMediaInsightsPipelineConfigurationsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListMediaInsightsPipelineConfigurationsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::ListMediaPipelineKinesisVideoStreamPoolsRequest&,
                           const Model::ListMediaPipelineKinesisVideoStreamPoolsOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListMediaPipelineKinesisVideoStreamPoolsResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::ListMediaPipelinesRequest&,
                           const Model::ListMediaPipelinesOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListMediaPipelinesResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::ListTagsForResourceRequest&,
                           const Model::ListTagsForResourceOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    ListTagsForResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::StartSpeakerSearchTaskRequest&,
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::StartVoiceToneAnalysisTaskRequest&,
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::StopSpeakerSearchTaskRequest&,
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::StopVoiceToneAnalysisTaskRequest&,
...
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::TagResourceRequest&, const Model::TagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    TagResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::UntagResourceRequest&, const Model::UntagResourceOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UntagResourceResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::UpdateMediaInsightsPipelineConfigurationRequest&,
                           const Model::UpdateMediaInsightsPipelineConfigurationOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateMediaInsightsPipelineConfigurationResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::UpdateMediaInsightsPipelineStatusRequest&,
                           const Model::UpdateMediaInsightsPipelineStatusOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateMediaInsightsPipelineStatusResponseReceivedHandler;
typedef std::function<void(const ChimeSDKMediaPipelinesClient*, const Model::UpdateMediaPipelineKinesisVideoStreamPoolRequest&,
                           const Model::UpdateMediaPipelineKinesisVideoStreamPoolOutcome&,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    UpdateMediaPipelineKinesisVideoStreamPoolResponseReceivedHandler;
