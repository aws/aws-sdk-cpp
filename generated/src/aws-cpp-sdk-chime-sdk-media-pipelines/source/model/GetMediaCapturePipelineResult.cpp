...
GetMediaCapturePipelineResult::GetMediaCapturePipelineResult()
{
}

GetMediaCapturePipelineResult::GetMediaCapturePipelineResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
