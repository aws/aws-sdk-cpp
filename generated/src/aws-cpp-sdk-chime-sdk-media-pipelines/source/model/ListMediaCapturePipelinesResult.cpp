...
ListMediaCapturePipelinesResult::ListMediaCapturePipelinesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListMediaCapturePipelinesResult& ListMediaCapturePipelinesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("MediaCapturePipelines")) {
    ...
    for (unsigned mediaCapturePipelinesIndex = 0; mediaCapturePipelinesIndex < mediaCapturePipelinesJsonList.GetLength();
         ++mediaCapturePipelinesIndex) {
