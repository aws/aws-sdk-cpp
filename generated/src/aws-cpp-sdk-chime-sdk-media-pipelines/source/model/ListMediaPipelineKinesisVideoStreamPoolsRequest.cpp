...
Aws::String ListMediaPipelineKinesisVideoStreamPoolsRequest::SerializePayload() const { return {}; }

void ListMediaPipelineKinesisVideoStreamPoolsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
