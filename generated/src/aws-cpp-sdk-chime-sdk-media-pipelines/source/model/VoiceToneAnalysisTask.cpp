...
VoiceToneAnalysisTask& VoiceToneAnalysisTask::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("VoiceToneAnalysisTaskStatus")) {
    m_voiceToneAnalysisTaskStatus =
        MediaPipelineTaskStatusMapper::GetMediaPipelineTaskStatusForName(jsonValue.GetString("VoiceToneAnalysisTaskStatus"));
...
JsonValue VoiceToneAnalysisTask::Jsonize() const {
  ...
  if (m_voiceToneAnalysisTaskStatusHasBeenSet) {
    payload.WithString("VoiceToneAnalysisTaskStatus",
                       MediaPipelineTaskStatusMapper::GetNameForMediaPipelineTaskStatus(m_voiceToneAnalysisTaskStatus));
  }
