...
SpeakerSearchTask& SpeakerSearchTask::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SpeakerSearchTaskStatus")) {
    m_speakerSearchTaskStatus =
        MediaPipelineTaskStatusMapper::GetMediaPipelineTaskStatusForName(jsonValue.GetString("SpeakerSearchTaskStatus"));
...
JsonValue SpeakerSearchTask::Jsonize() const {
  ...
  if (m_speakerSearchTaskStatusHasBeenSet) {
    payload.WithString("SpeakerSearchTaskStatus",
                       MediaPipelineTaskStatusMapper::GetNameForMediaPipelineTaskStatus(m_speakerSearchTaskStatus));
  }
