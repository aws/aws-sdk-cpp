...
MediaInsightsPipeline::MediaInsightsPipeline(JsonView jsonValue) { *this = jsonValue; }
...
MediaInsightsPipeline& MediaInsightsPipeline::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MediaInsightsRuntimeMetadata")) {
    Aws::Map<Aws::String, JsonView> mediaInsightsRuntimeMetadataJsonMap =
        jsonValue.GetObject("MediaInsightsRuntimeMetadata").GetAllObjects();
