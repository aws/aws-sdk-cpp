...
Aws::String ListMediaInsightsPipelineConfigurationsRequest::SerializePayload() const { return {}; }

void ListMediaInsightsPipelineConfigurationsRequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
