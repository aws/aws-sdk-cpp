...
template <>
AWS_CHIMESDKMEDIAPIPELINES_API ServiceUnavailableException ChimeSDKMediaPipelinesError::GetModeledError() {
...
template <>
AWS_CHIMESDKMEDIAPIPELINES_API ConflictException ChimeSDKMediaPipelinesError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKMediaPipelinesErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKMEDIAPIPELINES_API NotFoundException ChimeSDKMediaPipelinesError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKMediaPipelinesErrors::NOT_FOUND);
  return NotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKMEDIAPIPELINES_API ServiceFailureException ChimeSDKMediaPipelinesError::GetModeledError() {
...
template <>
AWS_CHIMESDKMEDIAPIPELINES_API ForbiddenException ChimeSDKMediaPipelinesError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKMediaPipelinesErrors::FORBIDDEN);
  return ForbiddenException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKMEDIAPIPELINES_API ResourceLimitExceededException ChimeSDKMediaPipelinesError::GetModeledError() {
...
template <>
AWS_CHIMESDKMEDIAPIPELINES_API ThrottledClientException ChimeSDKMediaPipelinesError::GetModeledError() {
...
template <>
AWS_CHIMESDKMEDIAPIPELINES_API BadRequestException ChimeSDKMediaPipelinesError::GetModeledError() {
  assert(this->GetErrorType() == ChimeSDKMediaPipelinesErrors::BAD_REQUEST);
  return BadRequestException(this->GetJsonPayload().View());
}

template <>
AWS_CHIMESDKMEDIAPIPELINES_API UnauthorizedClientException ChimeSDKMediaPipelinesError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == CONFLICT_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ChimeSDKMediaPipelinesErrors::RESOURCE_LIMIT_EXCEEDED),
