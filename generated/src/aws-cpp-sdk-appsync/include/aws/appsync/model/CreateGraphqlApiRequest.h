...
class CreateGraphqlApiRequest : public AppSyncRequest {
 public:
  ...
  inline CreateGraphqlApiRequest& WithAuthenticationType(AuthenticationType value) {
  ...
  inline CreateGraphqlApiRequest& WithXrayEnabled(bool value) {
  ...
  inline CreateGraphqlApiRequest& WithApiType(GraphQLApiType value) {
    SetApiType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGraphqlApiRequest& WithVisibility(GraphQLApiVisibility value) {
    SetVisibility(value);
    return *this;
  }
  ///@}
  ...
  inline CreateGraphqlApiRequest& WithIntrospectionConfig(GraphQLApiIntrospectionConfig value) {
  ...
  inline CreateGraphqlApiRequest& WithQueryDepthLimit(int value) {
  ...
  inline CreateGraphqlApiRequest& WithResolverCountLimit(int value) {
