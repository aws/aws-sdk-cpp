...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API DisassociateApiResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateApiResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
