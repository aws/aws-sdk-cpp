...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API ListResolversByFunctionResult() = default;
    ...
    template<typename ResolversT = Aws::Vector<Resolver>>
    ListResolversByFunctionResult& WithResolvers(ResolversT&& value) { SetResolvers(std::forward<ResolversT>(value)); return *this;}
    template<typename ResolversT = Resolver>
    ListResolversByFunctionResult& AddResolvers(ResolversT&& value) { m_resolversHasBeenSet = true; m_resolvers.emplace_back(std::forward<ResolversT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListResolversByFunctionResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListResolversByFunctionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
