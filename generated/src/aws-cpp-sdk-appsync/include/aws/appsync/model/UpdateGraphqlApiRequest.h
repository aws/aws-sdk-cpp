...
class UpdateGraphqlApiRequest : public AppSyncRequest {
 public:
  ...
  inline UpdateGraphqlApiRequest& WithAuthenticationType(AuthenticationType value) {
  ...
  inline UpdateGraphqlApiRequest& WithXrayEnabled(bool value) {
  ...
  inline UpdateGraphqlApiRequest& WithIntrospectionConfig(GraphQLApiIntrospectionConfig value) {
  ...
  inline UpdateGraphqlApiRequest& WithQueryDepthLimit(int value) {
  ...
  inline UpdateGraphqlApiRequest& WithResolverCountLimit(int value) {
