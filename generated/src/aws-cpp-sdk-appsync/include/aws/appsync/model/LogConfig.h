...
class LogConfig {
 public:
  ...
  inline void SetFieldLogLevel(FieldLogLevel value) {
    m_fieldLogLevelHasBeenSet = true;
    m_fieldLogLevel = value;
  }
  inline LogConfig& WithFieldLogLevel(FieldLogLevel value) {
    SetFieldLogLevel(value);
    return *this;
  }
  ///@}
  ...
  inline LogConfig& WithExcludeVerboseContent(bool value) {
