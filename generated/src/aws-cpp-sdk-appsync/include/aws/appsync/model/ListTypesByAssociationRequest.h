...
class ListTypesByAssociationRequest : public AppSyncRequest {
 public:
  ...
  void SetMergedApiIdentifier(MergedApiIdentifierT&& value) {
    m_mergedApiIdentifierHasBeenSet = true;
    m_mergedApiIdentifier = std::forward<MergedApiIdentifierT>(value);
  }
  template <typename MergedApiIdentifierT = Aws::String>
  ListTypesByAssociationRequest& WithMergedApiIdentifier(MergedApiIdentifierT&& value) {
    SetMergedApiIdentifier(std::forward<MergedApiIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssociationIdT = Aws::String>
  ListTypesByAssociationRequest& WithAssociationId(AssociationIdT&& value) {
  ...
  inline ListTypesByAssociationRequest& WithFormat(TypeDefinitionFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTypesByAssociationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTypesByAssociationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
