...
class UpdateApiCacheRequest : public AppSyncRequest {
 public:
  ...
  inline UpdateApiCacheRequest& WithTtl(long long value) {
    SetTtl(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateApiCacheRequest& WithApiCachingBehavior(ApiCachingBehavior value) {
  ...
  inline UpdateApiCacheRequest& WithType(ApiCacheType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateApiCacheRequest& WithHealthMetricsConfig(CacheHealthMetricsConfig value) {
