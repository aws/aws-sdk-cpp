...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API UpdateResolverRequest() = default;
    ...
    template<typename ApiIdT = Aws::String>
    UpdateResolverRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TypeNameT = Aws::String>
    UpdateResolverRequest& WithTypeName(TypeNameT&& value) { SetTypeName(std::forward<TypeNameT>(value)); return *this;}
    ///@}
    ...
    template<typename FieldNameT = Aws::String>
    UpdateResolverRequest& WithFieldName(FieldNameT&& value) { SetFieldName(std::forward<FieldNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DataSourceNameT = Aws::String>
    UpdateResolverRequest& WithDataSourceName(DataSourceNameT&& value) { SetDataSourceName(std::forward<DataSourceNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestMappingTemplateT = Aws::String>
    UpdateResolverRequest& WithRequestMappingTemplate(RequestMappingTemplateT&& value) { SetRequestMappingTemplate(std::forward<RequestMappingTemplateT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMappingTemplateT = Aws::String>
    UpdateResolverRequest& WithResponseMappingTemplate(ResponseMappingTemplateT&& value) { SetResponseMappingTemplate(std::forward<ResponseMappingTemplateT>(value)); return *this;}
    ///@}
    ...
    inline UpdateResolverRequest& WithKind(ResolverKind value) { SetKind(value); return *this;}
    ///@}
    ...
    template<typename PipelineConfigT = PipelineConfig>
    UpdateResolverRequest& WithPipelineConfig(PipelineConfigT&& value) { SetPipelineConfig(std::forward<PipelineConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename SyncConfigT = SyncConfig>
    UpdateResolverRequest& WithSyncConfig(SyncConfigT&& value) { SetSyncConfig(std::forward<SyncConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename CachingConfigT = CachingConfig>
    UpdateResolverRequest& WithCachingConfig(CachingConfigT&& value) { SetCachingConfig(std::forward<CachingConfigT>(value)); return *this;}
    ///@}
    ...
    template<typename RuntimeT = AppSyncRuntime>
    UpdateResolverRequest& WithRuntime(RuntimeT&& value) { SetRuntime(std::forward<RuntimeT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    UpdateResolverRequest& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    inline UpdateResolverRequest& WithMetricsConfig(ResolverLevelMetricsConfig value) { SetMetricsConfig(value); return *this;}
    ///@}
  private:
