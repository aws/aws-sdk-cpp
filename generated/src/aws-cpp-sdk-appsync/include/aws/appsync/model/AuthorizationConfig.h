...
class AuthorizationConfig {
 public:
  ...
  inline AuthorizationConfig& WithAuthorizationType(AuthorizationType value) {
  ...
  void SetAwsIamConfig(AwsIamConfigT&& value) {
    ...
    m_awsIamConfig = std::forward<AwsIamConfigT>(value);
  }
  template <typename AwsIamConfigT = AwsIamConfig>
  AuthorizationConfig& WithAwsIamConfig(AwsIamConfigT&& value) {
    SetAwsIamConfig(std::forward<AwsIamConfigT>(value));
    return *this;
  }
  ///@}
 private:
