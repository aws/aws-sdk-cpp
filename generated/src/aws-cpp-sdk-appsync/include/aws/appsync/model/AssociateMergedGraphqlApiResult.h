...
class AssociateMergedGraphqlApiResult {
 public:
  AWS_APPSYNC_API AssociateMergedGraphqlApiResult() = default;
  ...
  void SetSourceApiAssociation(SourceApiAssociationT&& value) {
    ...
    m_sourceApiAssociation = std::forward<SourceApiAssociationT>(value);
  }
  template <typename SourceApiAssociationT = SourceApiAssociation>
  AssociateMergedGraphqlApiResult& WithSourceApiAssociation(SourceApiAssociationT&& value) {
    SetSourceApiAssociation(std::forward<SourceApiAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  AssociateMergedGraphqlApiResult& WithRequestId(RequestIdT&& value) {
