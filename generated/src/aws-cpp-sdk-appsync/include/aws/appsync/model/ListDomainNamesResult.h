...
class ListDomainNamesResult {
 public:
  ...
  void SetDomainNameConfigs(DomainNameConfigsT&& value) {
    m_domainNameConfigsHasBeenSet = true;
    m_domainNameConfigs = std::forward<DomainNameConfigsT>(value);
  }
  template <typename DomainNameConfigsT = Aws::Vector<DomainNameConfig>>
  ListDomainNamesResult& WithDomainNameConfigs(DomainNameConfigsT&& value) {
    SetDomainNameConfigs(std::forward<DomainNameConfigsT>(value));
    return *this;
  }
  template <typename DomainNameConfigsT = DomainNameConfig>
  ListDomainNamesResult& AddDomainNameConfigs(DomainNameConfigsT&& value) {
    m_domainNameConfigsHasBeenSet = true;
    m_domainNameConfigs.emplace_back(std::forward<DomainNameConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDomainNamesResult& WithNextToken(NextTokenT&& value) {
