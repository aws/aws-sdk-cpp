...
class GetGraphqlApiResult {
 public:
  ...
  void SetGraphqlApi(GraphqlApiT&& value) {
    m_graphqlApiHasBeenSet = true;
    m_graphqlApi = std::forward<GraphqlApiT>(value);
  }
  template <typename GraphqlApiT = GraphqlApi>
  GetGraphqlApiResult& WithGraphqlApi(GraphqlApiT&& value) {
    SetGraphqlApi(std::forward<GraphqlApiT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetGraphqlApiResult& WithRequestId(RequestIdT&& value) {
