...
class CodeErrorLocation {
 public:
  ...
  inline CodeErrorLocation& WithLine(int value) {
    SetLine(value);
    return *this;
  }
  ///@}
  ...
  inline CodeErrorLocation& WithColumn(int value) {
    SetColumn(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpan(int value) {
    m_spanHasBeenSet = true;
    m_span = value;
  }
  inline CodeErrorLocation& WithSpan(int value) {
    SetSpan(value);
    return *this;
  }
  ///@}
