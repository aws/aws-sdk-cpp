...
class GetDataSourceIntrospectionRequest : public AppSyncRequest {
 public:
  ...
  inline void SetIncludeModelsSDL(bool value) {
    m_includeModelsSDLHasBeenSet = true;
    m_includeModelsSDL = value;
  }
  inline GetDataSourceIntrospectionRequest& WithIncludeModelsSDL(bool value) {
    SetIncludeModelsSDL(value);
    return *this;
  }
  ///@}
  ...
  inline GetDataSourceIntrospectionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
