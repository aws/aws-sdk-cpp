...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API CreateApiCacheResult() = default;
    ...
    template<typename ApiCacheT = ApiCache>
    CreateApiCacheResult& WithApiCache(ApiCacheT&& value) { SetApiCache(std::forward<ApiCacheT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateApiCacheResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
