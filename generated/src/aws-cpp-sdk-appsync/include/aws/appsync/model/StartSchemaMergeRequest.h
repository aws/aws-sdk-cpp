...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API StartSchemaMergeRequest();
     ...
     * merged API.</p>
     */
    inline StartSchemaMergeRequest& WithMergedApiIdentifier(const char* value) { SetMergedApiIdentifier(value); return *this;}
