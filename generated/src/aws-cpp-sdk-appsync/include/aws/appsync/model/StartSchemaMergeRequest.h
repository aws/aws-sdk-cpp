...
namespace Model
{
  ...
  /**
   */
  class StartSchemaMergeRequest : public AppSyncRequest
  {
  public:
    ...
    inline virtual const char* GetServiceRequestName() const override { return "StartSchemaMerge"; }
    ...
    template<typename AssociationIdT = Aws::String>
    StartSchemaMergeRequest& WithAssociationId(AssociationIdT&& value) { SetAssociationId(std::forward<AssociationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MergedApiIdentifierT = Aws::String>
    StartSchemaMergeRequest& WithMergedApiIdentifier(MergedApiIdentifierT&& value) { SetMergedApiIdentifier(std::forward<MergedApiIdentifierT>(value)); return *this;}
    ///@}
  private:
