...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API GetSourceApiAssociationResult();
     ...
     * <p>The <code>SourceApiAssociation</code> object data.</p>
     */
    inline GetSourceApiAssociationResult& WithSourceApiAssociation(const SourceApiAssociation& value) { SetSourceApiAssociation(value); return *this;}

    /**
     * <p>The <code>SourceApiAssociation</code> object data.</p>
     */
    inline GetSourceApiAssociationResult& WithSourceApiAssociation(SourceApiAssociation&& value) { SetSourceApiAssociation(std::move(value)); return *this;}
    ...
    inline GetSourceApiAssociationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetSourceApiAssociationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetSourceApiAssociationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
