...
class ListTypesByAssociationResult {
 public:
  ...
  template <typename TypesT = Aws::Vector<Type>>
  ListTypesByAssociationResult& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  template <typename TypesT = Type>
  ListTypesByAssociationResult& AddTypes(TypesT&& value) {
    m_typesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTypesByAssociationResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTypesByAssociationResult& WithRequestId(RequestIdT&& value) {
