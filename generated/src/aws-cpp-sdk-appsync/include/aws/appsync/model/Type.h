...
class Type {
 public:
  ...
  template <typename DescriptionT = Aws::String>
  Type& WithDescription(DescriptionT&& value) {
  ...
  template <typename DefinitionT = Aws::String>
  Type& WithDefinition(DefinitionT&& value) {
  ...
  inline Type& WithFormat(TypeDefinitionFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
