...
class ChannelNamespace {
 public:
  ...
  void SetSubscribeAuthModes(SubscribeAuthModesT&& value) {
    ...
    m_subscribeAuthModes = std::forward<SubscribeAuthModesT>(value);
  }
  template <typename SubscribeAuthModesT = Aws::Vector<AuthMode>>
  ChannelNamespace& WithSubscribeAuthModes(SubscribeAuthModesT&& value) {
    SetSubscribeAuthModes(std::forward<SubscribeAuthModesT>(value));
    return *this;
  }
  template <typename SubscribeAuthModesT = AuthMode>
  ChannelNamespace& AddSubscribeAuthModes(SubscribeAuthModesT&& value) {
    m_subscribeAuthModesHasBeenSet = true;
    m_subscribeAuthModes.emplace_back(std::forward<SubscribeAuthModesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublishAuthModes(PublishAuthModesT&& value) {
    ...
    m_publishAuthModes = std::forward<PublishAuthModesT>(value);
  }
  template <typename PublishAuthModesT = Aws::Vector<AuthMode>>
  ChannelNamespace& WithPublishAuthModes(PublishAuthModesT&& value) {
    SetPublishAuthModes(std::forward<PublishAuthModesT>(value));
    return *this;
  }
  template <typename PublishAuthModesT = AuthMode>
  ChannelNamespace& AddPublishAuthModes(PublishAuthModesT&& value) {
    m_publishAuthModesHasBeenSet = true;
    m_publishAuthModes.emplace_back(std::forward<PublishAuthModesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeHandlers(CodeHandlersT&& value) {
    ...
    m_codeHandlers = std::forward<CodeHandlersT>(value);
  }
  template <typename CodeHandlersT = Aws::String>
  ChannelNamespace& WithCodeHandlers(CodeHandlersT&& value) {
    SetCodeHandlers(std::forward<CodeHandlersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChannelNamespaceArn(ChannelNamespaceArnT&& value) {
    ...
    m_channelNamespaceArn = std::forward<ChannelNamespaceArnT>(value);
  }
  template <typename ChannelNamespaceArnT = Aws::String>
  ChannelNamespace& WithChannelNamespaceArn(ChannelNamespaceArnT&& value) {
    SetChannelNamespaceArn(std::forward<ChannelNamespaceArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHandlerConfigs(HandlerConfigsT&& value) {
    ...
    m_handlerConfigs = std::forward<HandlerConfigsT>(value);
  }
  template <typename HandlerConfigsT = HandlerConfigs>
  ChannelNamespace& WithHandlerConfigs(HandlerConfigsT&& value) {
    SetHandlerConfigs(std::forward<HandlerConfigsT>(value));
    return *this;
  }
  ///@}
 private:
