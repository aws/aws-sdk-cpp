...
class AwsIamConfig {
 public:
  ...
  void SetSigningRegion(SigningRegionT&& value) {
    ...
    m_signingRegion = std::forward<SigningRegionT>(value);
  }
  template <typename SigningRegionT = Aws::String>
  AwsIamConfig& WithSigningRegion(SigningRegionT&& value) {
    SetSigningRegion(std::forward<SigningRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSigningServiceName(SigningServiceNameT&& value) {
    m_signingServiceNameHasBeenSet = true;
    m_signingServiceName = std::forward<SigningServiceNameT>(value);
  }
  template <typename SigningServiceNameT = Aws::String>
  AwsIamConfig& WithSigningServiceName(SigningServiceNameT&& value) {
    SetSigningServiceName(std::forward<SigningServiceNameT>(value));
    return *this;
  }
  ///@}
 private:
