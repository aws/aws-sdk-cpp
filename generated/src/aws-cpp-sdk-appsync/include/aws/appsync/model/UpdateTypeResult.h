...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API UpdateTypeResult() = default;
    ...
    template<typename TypeT = Type>
    UpdateTypeResult& WithType(TypeT&& value) { SetType(std::forward<TypeT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateTypeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
