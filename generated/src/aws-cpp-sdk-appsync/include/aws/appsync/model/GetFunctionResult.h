...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API GetFunctionResult() = default;
    ...
    template<typename FunctionConfigurationT = FunctionConfiguration>
    GetFunctionResult& WithFunctionConfiguration(FunctionConfigurationT&& value) { SetFunctionConfiguration(std::forward<FunctionConfigurationT>(value)); return *this;}
    ///@}
