...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API DeleteDomainNameResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteDomainNameResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
