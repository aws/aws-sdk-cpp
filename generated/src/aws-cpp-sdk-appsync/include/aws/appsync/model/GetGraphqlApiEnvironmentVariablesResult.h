...
class GetGraphqlApiEnvironmentVariablesResult {
 public:
  ...
  AWS_APPSYNC_API GetGraphqlApiEnvironmentVariablesResult& operator=(
  ...
  template <typename EnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  GetGraphqlApiEnvironmentVariablesResult& WithEnvironmentVariables(EnvironmentVariablesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetGraphqlApiEnvironmentVariablesResult& WithRequestId(RequestIdT&& value) {
