...
class RelationalDatabaseDataSourceConfig {
 public:
  ...
  inline void SetRelationalDatabaseSourceType(RelationalDatabaseSourceType value) {
    m_relationalDatabaseSourceTypeHasBeenSet = true;
    m_relationalDatabaseSourceType = value;
  }
  inline RelationalDatabaseDataSourceConfig& WithRelationalDatabaseSourceType(RelationalDatabaseSourceType value) {
    SetRelationalDatabaseSourceType(value);
    return *this;
  }
  ///@}
  ...
  void SetRdsHttpEndpointConfig(RdsHttpEndpointConfigT&& value) {
    ...
    m_rdsHttpEndpointConfig = std::forward<RdsHttpEndpointConfigT>(value);
  }
  template <typename RdsHttpEndpointConfigT = RdsHttpEndpointConfig>
  RelationalDatabaseDataSourceConfig& WithRdsHttpEndpointConfig(RdsHttpEndpointConfigT&& value) {
    SetRdsHttpEndpointConfig(std::forward<RdsHttpEndpointConfigT>(value));
    return *this;
  }
  ///@}
 private:
