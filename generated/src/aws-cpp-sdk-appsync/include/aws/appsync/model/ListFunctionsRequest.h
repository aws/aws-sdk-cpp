...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API ListFunctionsRequest() = default;
    ...
    template<typename ApiIdT = Aws::String>
    ListFunctionsRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListFunctionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
