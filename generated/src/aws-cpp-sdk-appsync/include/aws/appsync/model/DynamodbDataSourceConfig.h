...
class DynamodbDataSourceConfig {
 public:
  ...
  inline void SetUseCallerCredentials(bool value) {
    m_useCallerCredentialsHasBeenSet = true;
    m_useCallerCredentials = value;
  }
  inline DynamodbDataSourceConfig& WithUseCallerCredentials(bool value) {
    SetUseCallerCredentials(value);
    return *this;
  }
  ///@}
  ...
  void SetDeltaSyncConfig(DeltaSyncConfigT&& value) {
    ...
    m_deltaSyncConfig = std::forward<DeltaSyncConfigT>(value);
  }
  template <typename DeltaSyncConfigT = DeltaSyncConfig>
  DynamodbDataSourceConfig& WithDeltaSyncConfig(DeltaSyncConfigT&& value) {
    SetDeltaSyncConfig(std::forward<DeltaSyncConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVersioned(bool value) {
    m_versionedHasBeenSet = true;
    m_versioned = value;
  }
  inline DynamodbDataSourceConfig& WithVersioned(bool value) {
    SetVersioned(value);
    return *this;
  }
  ///@}
