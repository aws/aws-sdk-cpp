...
class Resolver {
 public:
  ...
  void SetResolverArn(ResolverArnT&& value) {
    ...
    m_resolverArn = std::forward<ResolverArnT>(value);
  }
  template <typename ResolverArnT = Aws::String>
  Resolver& WithResolverArn(ResolverArnT&& value) {
    SetResolverArn(std::forward<ResolverArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline Resolver& WithKind(ResolverKind value) {
    SetKind(value);
    return *this;
  }
  ///@}
  ...
  inline Resolver& WithMaxBatchSize(int value) {
  ...
  inline Resolver& WithMetricsConfig(ResolverLevelMetricsConfig value) {
