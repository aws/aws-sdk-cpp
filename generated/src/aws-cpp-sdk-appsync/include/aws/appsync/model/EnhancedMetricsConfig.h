...
class EnhancedMetricsConfig {
 public:
  ...
  inline void SetResolverLevelMetricsBehavior(ResolverLevelMetricsBehavior value) {
    m_resolverLevelMetricsBehaviorHasBeenSet = true;
    m_resolverLevelMetricsBehavior = value;
  }
  inline EnhancedMetricsConfig& WithResolverLevelMetricsBehavior(ResolverLevelMetricsBehavior value) {
    SetResolverLevelMetricsBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDataSourceLevelMetricsBehavior(DataSourceLevelMetricsBehavior value) {
    m_dataSourceLevelMetricsBehaviorHasBeenSet = true;
    m_dataSourceLevelMetricsBehavior = value;
  }
  inline EnhancedMetricsConfig& WithDataSourceLevelMetricsBehavior(DataSourceLevelMetricsBehavior value) {
    SetDataSourceLevelMetricsBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOperationLevelMetricsConfig(OperationLevelMetricsConfig value) {
    m_operationLevelMetricsConfigHasBeenSet = true;
    m_operationLevelMetricsConfig = value;
  }
  inline EnhancedMetricsConfig& WithOperationLevelMetricsConfig(OperationLevelMetricsConfig value) {
    SetOperationLevelMetricsConfig(value);
    return *this;
  }
  ///@}
 private:
