...
class StartDataSourceIntrospectionRequest : public AppSyncRequest {
 public:
  ...
  void SetRdsDataApiConfig(RdsDataApiConfigT&& value) {
    m_rdsDataApiConfigHasBeenSet = true;
    m_rdsDataApiConfig = std::forward<RdsDataApiConfigT>(value);
  }
  template <typename RdsDataApiConfigT = RdsDataApiConfig>
  StartDataSourceIntrospectionRequest& WithRdsDataApiConfig(RdsDataApiConfigT&& value) {
    SetRdsDataApiConfig(std::forward<RdsDataApiConfigT>(value));
    return *this;
  }
  ///@}
 private:
