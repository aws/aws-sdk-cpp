...
class CreateResolverRequest : public AppSyncRequest {
 public:
  ...
  inline CreateResolverRequest& WithKind(ResolverKind value) {
    SetKind(value);
    return *this;
  }
  ///@}
  ...
  inline CreateResolverRequest& WithMaxBatchSize(int value) {
  ...
  inline CreateResolverRequest& WithMetricsConfig(ResolverLevelMetricsConfig value) {
