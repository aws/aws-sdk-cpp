...
class ApiCache {
 public:
  ...
  inline ApiCache& WithTtl(long long value) {
    SetTtl(value);
    return *this;
  }
  ///@}
  ...
  inline ApiCache& WithApiCachingBehavior(ApiCachingBehavior value) {
  ...
  inline ApiCache& WithTransitEncryptionEnabled(bool value) {
  ...
  inline void SetAtRestEncryptionEnabled(bool value) {
    m_atRestEncryptionEnabledHasBeenSet = true;
    m_atRestEncryptionEnabled = value;
  }
  inline ApiCache& WithAtRestEncryptionEnabled(bool value) {
    SetAtRestEncryptionEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline ApiCache& WithType(ApiCacheType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ApiCacheStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ApiCache& WithStatus(ApiCacheStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ApiCache& WithHealthMetricsConfig(CacheHealthMetricsConfig value) {
