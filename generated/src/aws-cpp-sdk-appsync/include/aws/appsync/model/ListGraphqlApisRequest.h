...
class ListGraphqlApisRequest : public AppSyncRequest {
 public:
  ...
  inline ListGraphqlApisRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListGraphqlApisRequest& WithApiType(GraphQLApiType value) {
    SetApiType(value);
    return *this;
  }
  ///@}
  ...
  inline ListGraphqlApisRequest& WithOwner(Ownership value) {
    SetOwner(value);
    return *this;
  }
  ///@}
