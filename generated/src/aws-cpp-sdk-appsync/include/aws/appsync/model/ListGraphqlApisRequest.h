...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListGraphqlApisRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListGraphqlApisRequest& WithApiType(GraphQLApiType value) { SetApiType(value); return *this;}
    ///@}
    ...
    inline ListGraphqlApisRequest& WithOwner(Ownership value) { SetOwner(value); return *this;}
    ///@}
  private:
