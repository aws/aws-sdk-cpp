...
namespace Model
{
  ...
  /**
   */
  class ListDataSourcesRequest : public AppSyncRequest
  {
  public:
    AWS_APPSYNC_API ListDataSourcesRequest() = default;
    ...
    template<typename ApiIdT = Aws::String>
    ListDataSourcesRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
