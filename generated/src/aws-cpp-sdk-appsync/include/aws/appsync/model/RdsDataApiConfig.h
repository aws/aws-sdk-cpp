...
class RdsDataApiConfig {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  RdsDataApiConfig& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename SecretArnT = Aws::String>
  RdsDataApiConfig& WithSecretArn(SecretArnT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  RdsDataApiConfig& WithDatabaseName(DatabaseNameT&& value) {
