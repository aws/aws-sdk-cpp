...
class SyncConfig {
 public:
  ...
  inline void SetConflictHandler(ConflictHandlerType value) {
    m_conflictHandlerHasBeenSet = true;
    m_conflictHandler = value;
  }
  inline SyncConfig& WithConflictHandler(ConflictHandlerType value) {
    SetConflictHandler(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConflictDetection(ConflictDetectionType value) {
    m_conflictDetectionHasBeenSet = true;
    m_conflictDetection = value;
  }
  inline SyncConfig& WithConflictDetection(ConflictDetectionType value) {
    SetConflictDetection(value);
    return *this;
  }
  ///@}
  ...
  void SetLambdaConflictHandlerConfig(LambdaConflictHandlerConfigT&& value) {
    ...
    m_lambdaConflictHandlerConfig = std::forward<LambdaConflictHandlerConfigT>(value);
  }
  template <typename LambdaConflictHandlerConfigT = LambdaConflictHandlerConfig>
  SyncConfig& WithLambdaConflictHandlerConfig(LambdaConflictHandlerConfigT&& value) {
    SetLambdaConflictHandlerConfig(std::forward<LambdaConflictHandlerConfigT>(value));
    return *this;
  }
  ///@}
 private:
