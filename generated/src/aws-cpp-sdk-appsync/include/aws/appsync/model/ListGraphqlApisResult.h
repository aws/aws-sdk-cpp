...
class ListGraphqlApisResult {
 public:
  ...
  void SetGraphqlApis(GraphqlApisT&& value) {
    m_graphqlApisHasBeenSet = true;
    m_graphqlApis = std::forward<GraphqlApisT>(value);
  }
  template <typename GraphqlApisT = Aws::Vector<GraphqlApi>>
  ListGraphqlApisResult& WithGraphqlApis(GraphqlApisT&& value) {
    SetGraphqlApis(std::forward<GraphqlApisT>(value));
    return *this;
  }
  template <typename GraphqlApisT = GraphqlApi>
  ListGraphqlApisResult& AddGraphqlApis(GraphqlApisT&& value) {
    m_graphqlApisHasBeenSet = true;
    m_graphqlApis.emplace_back(std::forward<GraphqlApisT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGraphqlApisResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGraphqlApisResult& WithRequestId(RequestIdT&& value) {
