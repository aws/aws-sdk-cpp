...
class ApiAssociation {
 public:
  ...
  inline ApiAssociation& WithAssociationStatus(AssociationStatus value) {
  ...
  void SetDeploymentDetail(DeploymentDetailT&& value) {
    ...
    m_deploymentDetail = std::forward<DeploymentDetailT>(value);
  }
  template <typename DeploymentDetailT = Aws::String>
  ApiAssociation& WithDeploymentDetail(DeploymentDetailT&& value) {
    SetDeploymentDetail(std::forward<DeploymentDetailT>(value));
    return *this;
  }
  ///@}
 private:
