...
class CreateApiCacheRequest : public AppSyncRequest {
 public:
  ...
  inline CreateApiCacheRequest& WithTtl(long long value) {
    SetTtl(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApiCachingBehavior(ApiCachingBehavior value) {
    m_apiCachingBehaviorHasBeenSet = true;
    m_apiCachingBehavior = value;
  }
  inline CreateApiCacheRequest& WithApiCachingBehavior(ApiCachingBehavior value) {
    SetApiCachingBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(ApiCacheType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreateApiCacheRequest& WithType(ApiCacheType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthMetricsConfig(CacheHealthMetricsConfig value) {
    m_healthMetricsConfigHasBeenSet = true;
    m_healthMetricsConfig = value;
  }
  inline CreateApiCacheRequest& WithHealthMetricsConfig(CacheHealthMetricsConfig value) {
    SetHealthMetricsConfig(value);
    return *this;
  }
  ///@}
 private:
