...
namespace Model
{
  ...
  public:
    ...
    template<typename ApiIdT = Aws::String>
    CreateApiCacheRequest& WithApiId(ApiIdT&& value) { SetApiId(std::forward<ApiIdT>(value)); return *this;}
    ///@}
    ...
    inline CreateApiCacheRequest& WithApiCachingBehavior(ApiCachingBehavior value) { SetApiCachingBehavior(value); return *this;}
    ///@}
    ...
    inline CreateApiCacheRequest& WithType(ApiCacheType value) { SetType(value); return *this;}
    ///@}
    ...
    inline CreateApiCacheRequest& WithHealthMetricsConfig(CacheHealthMetricsConfig value) { SetHealthMetricsConfig(value); return *this;}
    ///@}
  private:
