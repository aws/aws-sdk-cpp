...
namespace Model
{
  ...
  {
  public:
    AWS_APPSYNC_API GetSourceApiAssociationRequest();
     ...
     * merged API.</p>
     */
    inline GetSourceApiAssociationRequest& WithMergedApiIdentifier(const Aws::String& value) { SetMergedApiIdentifier(value); return *this;}
     ...
     * merged API.</p>
     */
    inline GetSourceApiAssociationRequest& WithMergedApiIdentifier(Aws::String&& value) { SetMergedApiIdentifier(std::move(value)); return *this;}
     ...
     * merged API.</p>
     */
    inline GetSourceApiAssociationRequest& WithMergedApiIdentifier(const char* value) { SetMergedApiIdentifier(value); return *this;}
     ...
     * <p>The ID generated by the AppSync service for the source API association.</p>
     */
    inline GetSourceApiAssociationRequest& WithAssociationId(const Aws::String& value) { SetAssociationId(value); return *this;}

    /**
     * <p>The ID generated by the AppSync service for the source API association.</p>
     */
    inline GetSourceApiAssociationRequest& WithAssociationId(Aws::String&& value) { SetAssociationId(std::move(value)); return *this;}

    /**
     * <p>The ID generated by the AppSync service for the source API association.</p>
     */
    inline GetSourceApiAssociationRequest& WithAssociationId(const char* value) { SetAssociationId(value); return *this;}
