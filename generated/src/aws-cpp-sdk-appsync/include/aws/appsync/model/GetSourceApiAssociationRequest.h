...
class GetSourceApiAssociationRequest : public AppSyncRequest {
 public:
  ...
  template <typename MergedApiIdentifierT = Aws::String>
  GetSourceApiAssociationRequest& WithMergedApiIdentifier(MergedApiIdentifierT&& value) {
  ...
  template <typename AssociationIdT = Aws::String>
  GetSourceApiAssociationRequest& WithAssociationId(AssociationIdT&& value) {
