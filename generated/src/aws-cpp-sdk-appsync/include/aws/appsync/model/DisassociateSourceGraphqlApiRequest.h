...
namespace Model
{
  ...
  public:
    ...
    template<typename MergedApiIdentifierT = Aws::String>
    DisassociateSourceGraphqlApiRequest& WithMergedApiIdentifier(MergedApiIdentifierT&& value) { SetMergedApiIdentifier(std::forward<MergedApiIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationIdT = Aws::String>
    DisassociateSourceGraphqlApiRequest& WithAssociationId(AssociationIdT&& value) { SetAssociationId(std::forward<AssociationIdT>(value)); return *this;}
    ///@}
  private:
