...
EventConfig::EventConfig(JsonView jsonValue) { *this = jsonValue; }
...
EventConfig& EventConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("connectionAuthModes")) {
    ...
    for (unsigned connectionAuthModesIndex = 0; connectionAuthModesIndex < connectionAuthModesJsonList.GetLength();
         ++connectionAuthModesIndex) {
  ...
  if (jsonValue.ValueExists("defaultPublishAuthModes")) {
    ...
    for (unsigned defaultPublishAuthModesIndex = 0; defaultPublishAuthModesIndex < defaultPublishAuthModesJsonList.GetLength();
         ++defaultPublishAuthModesIndex) {
  ...
  if (jsonValue.ValueExists("defaultSubscribeAuthModes")) {
    ...
    for (unsigned defaultSubscribeAuthModesIndex = 0; defaultSubscribeAuthModesIndex < defaultSubscribeAuthModesJsonList.GetLength();
...
JsonValue EventConfig::Jsonize() const {
  ...
  if (m_defaultPublishAuthModesHasBeenSet) {
    ...
    for (unsigned defaultPublishAuthModesIndex = 0; defaultPublishAuthModesIndex < defaultPublishAuthModesJsonList.GetLength();
         ++defaultPublishAuthModesIndex) {
      defaultPublishAuthModesJsonList[defaultPublishAuthModesIndex].AsObject(
          m_defaultPublishAuthModes[defaultPublishAuthModesIndex].Jsonize());
    }
  ...
  if (m_defaultSubscribeAuthModesHasBeenSet) {
    ...
    for (unsigned defaultSubscribeAuthModesIndex = 0; defaultSubscribeAuthModesIndex < defaultSubscribeAuthModesJsonList.GetLength();
         ++defaultSubscribeAuthModesIndex) {
      defaultSubscribeAuthModesJsonList[defaultSubscribeAuthModesIndex].AsObject(
          m_defaultSubscribeAuthModes[defaultSubscribeAuthModesIndex].Jsonize());
    }
