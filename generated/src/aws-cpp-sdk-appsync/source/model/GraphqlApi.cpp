...
GraphqlApi::GraphqlApi(JsonView jsonValue) { *this = jsonValue; }
...
GraphqlApi& GraphqlApi::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("introspectionConfig")) {
    m_introspectionConfig =
        GraphQLApiIntrospectionConfigMapper::GetGraphQLApiIntrospectionConfigForName(jsonValue.GetString("introspectionConfig"));
