...
ChannelNamespace::ChannelNamespace(JsonView jsonValue) { *this = jsonValue; }
...
ChannelNamespace& ChannelNamespace::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("subscribeAuthModes")) {
    ...
    for (unsigned subscribeAuthModesIndex = 0; subscribeAuthModesIndex < subscribeAuthModesJsonList.GetLength();
         ++subscribeAuthModesIndex) {
