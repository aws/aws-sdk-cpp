...
UpdateChannelNamespaceResult::UpdateChannelNamespaceResult()
{
}

UpdateChannelNamespaceResult::UpdateChannelNamespaceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
