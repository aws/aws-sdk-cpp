...
SourceApiAssociation::SourceApiAssociation(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue SourceApiAssociation::Jsonize() const {
  ...
  if (m_sourceApiAssociationStatusHasBeenSet) {
    payload.WithString("sourceApiAssociationStatus",
                       SourceApiAssociationStatusMapper::GetNameForSourceApiAssociationStatus(m_sourceApiAssociationStatus));
  }
