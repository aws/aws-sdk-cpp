...
namespace AppSync
{
const size_t AppSyncEndpointRules::RulesBlobStrLen = 3728;
const size_t AppSyncEndpointRules::RulesBlobSize = 3729;
...
'/','/','a','p','p','s','y','n','c','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','p','s','y','n','c','.','{','R','e',
