...
ListQuickResponsesResult::ListQuickResponsesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListQuickResponsesResult& ListQuickResponsesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("quickResponseSummaries")) {
    ...
    for (unsigned quickResponseSummariesIndex = 0; quickResponseSummariesIndex < quickResponseSummariesJsonList.GetLength();
         ++quickResponseSummariesIndex) {
