...
template <>
AWS_CONNECTWISDOMSERVICE_API ResourceNotFoundException ConnectWisdomServiceError::GetModeledError() {
  assert(this->GetErrorType() == ConnectWisdomServiceErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_CONNECTWISDOMSERVICE_API TooManyTagsException ConnectWisdomServiceError::GetModeledError() {
