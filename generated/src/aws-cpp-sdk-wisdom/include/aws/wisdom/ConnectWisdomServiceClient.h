...
namespace ConnectWisdomService
{
   ...
   */
  class AWS_CONNECTWISDOMSERVICE_API ConnectWisdomServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<ConnectWisdomServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::ConnectWisdomService::SERVICE_NAME,
