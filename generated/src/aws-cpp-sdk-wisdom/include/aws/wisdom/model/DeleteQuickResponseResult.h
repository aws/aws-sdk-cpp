...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTWISDOMSERVICE_API DeleteQuickResponseResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteQuickResponseResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
