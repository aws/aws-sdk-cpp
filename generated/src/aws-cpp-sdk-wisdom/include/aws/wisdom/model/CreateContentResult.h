...
class CreateContentResult {
 public:
  AWS_CONNECTWISDOMSERVICE_API CreateContentResult() = default;
  ...
  template <typename ContentT = ContentData>
  CreateContentResult& WithContent(ContentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateContentResult& WithRequestId(RequestIdT&& value) {
