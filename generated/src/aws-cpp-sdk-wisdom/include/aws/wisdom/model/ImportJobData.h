...
class ImportJobData {
 public:
  ...
  void SetExternalSourceConfiguration(ExternalSourceConfigurationT&& value) {
    ...
    m_externalSourceConfiguration = std::forward<ExternalSourceConfigurationT>(value);
  }
  template <typename ExternalSourceConfigurationT = ExternalSourceConfiguration>
  ImportJobData& WithExternalSourceConfiguration(ExternalSourceConfigurationT&& value) {
    SetExternalSourceConfiguration(std::forward<ExternalSourceConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailedRecordReport(FailedRecordReportT&& value) {
    ...
    m_failedRecordReport = std::forward<FailedRecordReportT>(value);
  }
  template <typename FailedRecordReportT = Aws::String>
  ImportJobData& WithFailedRecordReport(FailedRecordReportT&& value) {
    SetFailedRecordReport(std::forward<FailedRecordReportT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetImportJobType(ImportJobType value) {
    m_importJobTypeHasBeenSet = true;
    m_importJobType = value;
  }
  inline ImportJobData& WithImportJobType(ImportJobType value) {
    SetImportJobType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ImportJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ImportJobData& WithStatus(ImportJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
