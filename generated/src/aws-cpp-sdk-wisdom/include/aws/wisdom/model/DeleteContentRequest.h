...
class DeleteContentRequest : public ConnectWisdomServiceRequest {
 public:
  AWS_CONNECTWISDOMSERVICE_API DeleteContentRequest() = default;
  ...
  template <typename ContentIdT = Aws::String>
  DeleteContentRequest& WithContentId(ContentIdT&& value) {
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  DeleteContentRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
