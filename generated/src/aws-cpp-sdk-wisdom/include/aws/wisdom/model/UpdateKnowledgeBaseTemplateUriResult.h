...
class UpdateKnowledgeBaseTemplateUriResult {
 public:
  AWS_CONNECTWISDOMSERVICE_API UpdateKnowledgeBaseTemplateUriResult() = default;
  ...
  AWS_CONNECTWISDOMSERVICE_API UpdateKnowledgeBaseTemplateUriResult& operator=(
  ...
  template <typename KnowledgeBaseT = KnowledgeBaseData>
  UpdateKnowledgeBaseTemplateUriResult& WithKnowledgeBase(KnowledgeBaseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateKnowledgeBaseTemplateUriResult& WithRequestId(RequestIdT&& value) {
