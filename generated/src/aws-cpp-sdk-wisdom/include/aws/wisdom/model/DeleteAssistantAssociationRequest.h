...
class DeleteAssistantAssociationRequest : public ConnectWisdomServiceRequest {
 public:
  ...
  template <typename AssistantAssociationIdT = Aws::String>
  DeleteAssistantAssociationRequest& WithAssistantAssociationId(AssistantAssociationIdT&& value) {
  ...
  template <typename AssistantIdT = Aws::String>
  DeleteAssistantAssociationRequest& WithAssistantId(AssistantIdT&& value) {
