...
class QuickResponseSearchResultData {
 public:
  ...
  void SetAttributesInterpolated(AttributesInterpolatedT&& value) {
    ...
    m_attributesInterpolated = std::forward<AttributesInterpolatedT>(value);
  }
  template <typename AttributesInterpolatedT = Aws::Vector<Aws::String>>
  QuickResponseSearchResultData& WithAttributesInterpolated(AttributesInterpolatedT&& value) {
    SetAttributesInterpolated(std::forward<AttributesInterpolatedT>(value));
    return *this;
  }
  ...
  QuickResponseSearchResultData& AddAttributesInterpolated(AttributesInterpolatedT&& value) {
    m_attributesInterpolatedHasBeenSet = true;
    m_attributesInterpolated.emplace_back(std::forward<AttributesInterpolatedT>(value));
    return *this;
  }
  ///@}
  ...
  inline QuickResponseSearchResultData& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
  ...
  inline QuickResponseSearchResultData& WithStatus(QuickResponseStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
