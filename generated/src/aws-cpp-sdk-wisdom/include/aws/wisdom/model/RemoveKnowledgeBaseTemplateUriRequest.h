...
namespace Model
{
  ...
  /**
   */
  class RemoveKnowledgeBaseTemplateUriRequest : public ConnectWisdomServiceRequest
  {
  public:
    AWS_CONNECTWISDOMSERVICE_API RemoveKnowledgeBaseTemplateUriRequest() = default;
    ...
    template<typename KnowledgeBaseIdT = Aws::String>
    RemoveKnowledgeBaseTemplateUriRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) { SetKnowledgeBaseId(std::forward<KnowledgeBaseIdT>(value)); return *this;}
    ///@}
  private:
