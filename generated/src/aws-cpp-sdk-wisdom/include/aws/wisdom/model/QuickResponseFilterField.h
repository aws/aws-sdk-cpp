...
class QuickResponseFilterField {
 public:
  AWS_CONNECTWISDOMSERVICE_API QuickResponseFilterField() = default;
  ...
  inline QuickResponseFilterField& WithIncludeNoExistence(bool value) {
  ...
  template <typename NameT = Aws::String>
  QuickResponseFilterField& WithName(NameT&& value) {
  ...
  inline void SetOperator(QuickResponseFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline QuickResponseFilterField& WithOperator(QuickResponseFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  QuickResponseFilterField& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  QuickResponseFilterField& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
