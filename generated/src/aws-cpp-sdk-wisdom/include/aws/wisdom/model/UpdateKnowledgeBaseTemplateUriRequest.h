...
class UpdateKnowledgeBaseTemplateUriRequest : public ConnectWisdomServiceRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  UpdateKnowledgeBaseTemplateUriRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  void SetTemplateUri(TemplateUriT&& value) {
    m_templateUriHasBeenSet = true;
    m_templateUri = std::forward<TemplateUriT>(value);
  }
  template <typename TemplateUriT = Aws::String>
  UpdateKnowledgeBaseTemplateUriRequest& WithTemplateUri(TemplateUriT&& value) {
    SetTemplateUri(std::forward<TemplateUriT>(value));
    return *this;
  }
  ///@}
 private:
