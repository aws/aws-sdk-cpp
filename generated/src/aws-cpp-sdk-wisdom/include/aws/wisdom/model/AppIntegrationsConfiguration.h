...
class AppIntegrationsConfiguration {
 public:
  ...
  void SetAppIntegrationArn(AppIntegrationArnT&& value) {
    m_appIntegrationArnHasBeenSet = true;
    m_appIntegrationArn = std::forward<AppIntegrationArnT>(value);
  }
  template <typename AppIntegrationArnT = Aws::String>
  AppIntegrationsConfiguration& WithAppIntegrationArn(AppIntegrationArnT&& value) {
    SetAppIntegrationArn(std::forward<AppIntegrationArnT>(value));
    return *this;
  }
  ///@}
