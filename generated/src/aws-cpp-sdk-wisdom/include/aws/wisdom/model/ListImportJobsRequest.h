...
class ListImportJobsRequest : public ConnectWisdomServiceRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListImportJobsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  inline ListImportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImportJobsRequest& WithNextToken(NextTokenT&& value) {
