...
namespace Model
{
  ...
  {
  public:
    AWS_CONNECTWISDOMSERVICE_API ListImportJobsRequest();
     ...
     * either the ID or the ARN. URLs cannot contain the ARN.</p>
     */
    inline ListImportJobsRequest& WithKnowledgeBaseId(const char* value) { SetKnowledgeBaseId(value); return *this;}
