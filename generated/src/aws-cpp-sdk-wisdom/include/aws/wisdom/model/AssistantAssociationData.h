...
class AssistantAssociationData {
 public:
  ...
  void SetAssistantAssociationArn(AssistantAssociationArnT&& value) {
    ...
    m_assistantAssociationArn = std::forward<AssistantAssociationArnT>(value);
  }
  template <typename AssistantAssociationArnT = Aws::String>
  AssistantAssociationData& WithAssistantAssociationArn(AssistantAssociationArnT&& value) {
    SetAssistantAssociationArn(std::forward<AssistantAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociationData(AssociationDataT&& value) {
    ...
    m_associationData = std::forward<AssociationDataT>(value);
  }
  template <typename AssociationDataT = AssistantAssociationOutputData>
  AssistantAssociationData& WithAssociationData(AssociationDataT&& value) {
    SetAssociationData(std::forward<AssociationDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline AssistantAssociationData& WithAssociationType(AssociationType value) {
