...
class QuickResponseQueryField {
 public:
  ...
  inline void SetAllowFuzziness(bool value) {
    m_allowFuzzinessHasBeenSet = true;
    m_allowFuzziness = value;
  }
  inline QuickResponseQueryField& WithAllowFuzziness(bool value) {
    SetAllowFuzziness(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOperator(QuickResponseQueryOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline QuickResponseQueryField& WithOperator(QuickResponseQueryOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline QuickResponseQueryField& WithPriority(Priority value) {
    SetPriority(value);
    return *this;
  }
  ///@}
