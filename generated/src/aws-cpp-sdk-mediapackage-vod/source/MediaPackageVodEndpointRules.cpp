...
{
const size_t MediaPackageVodEndpointRules::RulesBlobStrLen = 3494;
const size_t MediaPackageVodEndpointRules::RulesBlobSize = 3495;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','d','i','a','p',
'a','c','k','a','g','e','-','v','o','d','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.',
...
':','"','h','t','t','p','s',':','/','/','m','e','d','i','a','p','a','c','k','a','g','e','-','v','o',
'd','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','e','d','i','a','p','a','c','k',
'a','g','e','-','v','o','d','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','m','e','d','i','a','p','a','c','k','a','g','e','-',
'v','o','d','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R','e',
's','u','l','t','#','d','n','s','S','u','f','f','i','x','}','"',',','"','p','r','o','p','e','r','t',
'i','e','s','"',':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y',
'p','e','"',':','"','e','n','d','p','o','i','n','t','"','}',']','}',']','}','\0'
}};

const char* MediaPackageVodEndpointRules::GetRulesBlob()
{
