...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == NOT_FOUND_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(MediaPackageVodErrors::TOO_MANY_REQUESTS), RetryableType::RETRYABLE_THROTTLING);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(MediaPackageVodErrors::INTERNAL_SERVER_ERROR), RetryableType::RETRYABLE);
  }
