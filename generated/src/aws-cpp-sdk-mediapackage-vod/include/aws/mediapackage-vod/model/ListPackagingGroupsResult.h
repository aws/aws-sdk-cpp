...
class ListPackagingGroupsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPackagingGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPackagingGroups(PackagingGroupsT&& value) {
    m_packagingGroupsHasBeenSet = true;
    m_packagingGroups = std::forward<PackagingGroupsT>(value);
  }
  template <typename PackagingGroupsT = Aws::Vector<PackagingGroup>>
  ListPackagingGroupsResult& WithPackagingGroups(PackagingGroupsT&& value) {
    SetPackagingGroups(std::forward<PackagingGroupsT>(value));
    return *this;
  }
  template <typename PackagingGroupsT = PackagingGroup>
  ListPackagingGroupsResult& AddPackagingGroups(PackagingGroupsT&& value) {
    m_packagingGroupsHasBeenSet = true;
    m_packagingGroups.emplace_back(std::forward<PackagingGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPackagingGroupsResult& WithRequestId(RequestIdT&& value) {
