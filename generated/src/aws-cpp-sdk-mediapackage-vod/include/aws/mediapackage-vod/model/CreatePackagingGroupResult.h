...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEVOD_API CreatePackagingGroupResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreatePackagingGroupResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationT = Authorization>
    CreatePackagingGroupResult& WithAuthorization(AuthorizationT&& value) { SetAuthorization(std::forward<AuthorizationT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::String>
    CreatePackagingGroupResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainNameT = Aws::String>
    CreatePackagingGroupResult& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    template<typename EgressAccessLogsT = EgressAccessLogs>
    CreatePackagingGroupResult& WithEgressAccessLogs(EgressAccessLogsT&& value) { SetEgressAccessLogs(std::forward<EgressAccessLogsT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    CreatePackagingGroupResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    CreatePackagingGroupResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    CreatePackagingGroupResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    CreatePackagingGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
