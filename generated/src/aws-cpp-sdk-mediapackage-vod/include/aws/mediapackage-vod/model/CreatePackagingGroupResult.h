...
class CreatePackagingGroupResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreatePackagingGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename AuthorizationT = Authorization>
  CreatePackagingGroupResult& WithAuthorization(AuthorizationT&& value) {
  ...
  template <typename CreatedAtT = Aws::String>
  CreatePackagingGroupResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  CreatePackagingGroupResult& WithDomainName(DomainNameT&& value) {
  ...
  template <typename EgressAccessLogsT = EgressAccessLogs>
  CreatePackagingGroupResult& WithEgressAccessLogs(EgressAccessLogsT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreatePackagingGroupResult& WithId(IdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreatePackagingGroupResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePackagingGroupResult& WithRequestId(RequestIdT&& value) {
