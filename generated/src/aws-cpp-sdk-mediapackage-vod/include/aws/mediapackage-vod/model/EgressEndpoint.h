...
class EgressEndpoint {
 public:
  ...
  void SetPackagingConfigurationId(PackagingConfigurationIdT&& value) {
    m_packagingConfigurationIdHasBeenSet = true;
    m_packagingConfigurationId = std::forward<PackagingConfigurationIdT>(value);
  }
  template <typename PackagingConfigurationIdT = Aws::String>
  EgressEndpoint& WithPackagingConfigurationId(PackagingConfigurationIdT&& value) {
    SetPackagingConfigurationId(std::forward<PackagingConfigurationIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  EgressEndpoint& WithStatus(StatusT&& value) {
  ...
  template <typename UrlT = Aws::String>
  EgressEndpoint& WithUrl(UrlT&& value) {
