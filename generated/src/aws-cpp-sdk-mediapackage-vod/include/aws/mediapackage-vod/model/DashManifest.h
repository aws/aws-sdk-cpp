...
class DashManifest {
 public:
  ...
  inline void SetManifestLayout(ManifestLayout value) {
    m_manifestLayoutHasBeenSet = true;
    m_manifestLayout = value;
  }
  inline DashManifest& WithManifestLayout(ManifestLayout value) {
    SetManifestLayout(value);
    return *this;
  }
  ///@}
  ...
  inline DashManifest& WithMinBufferTimeSeconds(int value) {
  ...
  inline void SetProfile(Profile value) {
    m_profileHasBeenSet = true;
    m_profile = value;
  }
  inline DashManifest& WithProfile(Profile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScteMarkersSource(ScteMarkersSource value) {
    m_scteMarkersSourceHasBeenSet = true;
    m_scteMarkersSource = value;
  }
  inline DashManifest& WithScteMarkersSource(ScteMarkersSource value) {
    SetScteMarkersSource(value);
    return *this;
  }
  ///@}
