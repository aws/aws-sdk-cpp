...
class ListPackagingConfigurationsResult {
 public:
  ...
  AWS_MEDIAPACKAGEVOD_API ListPackagingConfigurationsResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListPackagingConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPackagingConfigurations(PackagingConfigurationsT&& value) {
    m_packagingConfigurationsHasBeenSet = true;
    m_packagingConfigurations = std::forward<PackagingConfigurationsT>(value);
  }
  template <typename PackagingConfigurationsT = Aws::Vector<PackagingConfiguration>>
  ListPackagingConfigurationsResult& WithPackagingConfigurations(PackagingConfigurationsT&& value) {
    SetPackagingConfigurations(std::forward<PackagingConfigurationsT>(value));
    return *this;
  }
  template <typename PackagingConfigurationsT = PackagingConfiguration>
  ListPackagingConfigurationsResult& AddPackagingConfigurations(PackagingConfigurationsT&& value) {
    m_packagingConfigurationsHasBeenSet = true;
    m_packagingConfigurations.emplace_back(std::forward<PackagingConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListPackagingConfigurationsResult& WithRequestId(RequestIdT&& value) {
