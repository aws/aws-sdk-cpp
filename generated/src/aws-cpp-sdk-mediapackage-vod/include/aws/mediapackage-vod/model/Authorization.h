...
class Authorization {
 public:
  ...
  void SetCdnIdentifierSecret(CdnIdentifierSecretT&& value) {
    ...
    m_cdnIdentifierSecret = std::forward<CdnIdentifierSecretT>(value);
  }
  template <typename CdnIdentifierSecretT = Aws::String>
  Authorization& WithCdnIdentifierSecret(CdnIdentifierSecretT&& value) {
    SetCdnIdentifierSecret(std::forward<CdnIdentifierSecretT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecretsRoleArn(SecretsRoleArnT&& value) {
    ...
    m_secretsRoleArn = std::forward<SecretsRoleArnT>(value);
  }
  template <typename SecretsRoleArnT = Aws::String>
  Authorization& WithSecretsRoleArn(SecretsRoleArnT&& value) {
    SetSecretsRoleArn(std::forward<SecretsRoleArnT>(value));
    return *this;
  }
  ///@}
 private:
