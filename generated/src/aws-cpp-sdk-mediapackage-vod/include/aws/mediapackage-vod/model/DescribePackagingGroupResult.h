...
class DescribePackagingGroupResult {
 public:
  ...
  inline DescribePackagingGroupResult& WithApproximateAssetCount(int value) {
  ...
  template <typename ArnT = Aws::String>
  DescribePackagingGroupResult& WithArn(ArnT&& value) {
  ...
  template <typename AuthorizationT = Authorization>
  DescribePackagingGroupResult& WithAuthorization(AuthorizationT&& value) {
  ...
  template <typename CreatedAtT = Aws::String>
  DescribePackagingGroupResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  DescribePackagingGroupResult& WithDomainName(DomainNameT&& value) {
  ...
  template <typename EgressAccessLogsT = EgressAccessLogs>
  DescribePackagingGroupResult& WithEgressAccessLogs(EgressAccessLogsT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribePackagingGroupResult& WithId(IdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribePackagingGroupResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribePackagingGroupResult& WithRequestId(RequestIdT&& value) {
