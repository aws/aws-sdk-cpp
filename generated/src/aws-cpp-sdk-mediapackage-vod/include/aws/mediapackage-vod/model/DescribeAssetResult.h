...
class DescribeAssetResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeAssetResult& WithArn(ArnT&& value) {
  ...
  template <typename CreatedAtT = Aws::String>
  DescribeAssetResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename EgressEndpointsT = Aws::Vector<EgressEndpoint>>
  DescribeAssetResult& WithEgressEndpoints(EgressEndpointsT&& value) {
    SetEgressEndpoints(std::forward<EgressEndpointsT>(value));
    return *this;
  }
  template <typename EgressEndpointsT = EgressEndpoint>
  DescribeAssetResult& AddEgressEndpoints(EgressEndpointsT&& value) {
    m_egressEndpointsHasBeenSet = true;
  ...
  template <typename IdT = Aws::String>
  DescribeAssetResult& WithId(IdT&& value) {
  ...
  template <typename PackagingGroupIdT = Aws::String>
  DescribeAssetResult& WithPackagingGroupId(PackagingGroupIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  DescribeAssetResult& WithResourceId(ResourceIdT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  DescribeAssetResult& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename SourceRoleArnT = Aws::String>
  DescribeAssetResult& WithSourceRoleArn(SourceRoleArnT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeAssetResult& WithTags(TagsT&& value) {
