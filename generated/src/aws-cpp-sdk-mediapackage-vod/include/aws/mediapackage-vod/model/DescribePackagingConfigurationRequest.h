...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGEVOD_API DescribePackagingConfigurationRequest() = default;
    ...
    template<typename IdT = Aws::String>
    DescribePackagingConfigurationRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
