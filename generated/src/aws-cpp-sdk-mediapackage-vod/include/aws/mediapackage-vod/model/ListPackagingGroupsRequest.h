...
/**
 */
class ListPackagingGroupsRequest : public MediaPackageVodRequest {
 public:
  AWS_MEDIAPACKAGEVOD_API ListPackagingGroupsRequest() = default;
  ...
  inline ListPackagingGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPackagingGroupsRequest& WithNextToken(NextTokenT&& value) {
