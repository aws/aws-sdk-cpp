...
class AWS_MEDIAPACKAGEVOD_API MediaPackageVodClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MediaPackageVodClient(const Aws::MediaPackageVod::MediaPackageVodClientConfiguration& clientConfiguration =
  ...
  MediaPackageVodClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<MediaPackageVodEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::MediaPackageVod::MediaPackageVodClientConfiguration& clientConfiguration =
                            Aws::MediaPackageVod::MediaPackageVodClientConfiguration());
  ...
  /**
   * An Async wrapper for ConfigureLogs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ConfigureLogsRequestT = Model::ConfigureLogsRequest>
  void ConfigureLogsAsync(const ConfigureLogsRequestT& request, const ConfigureLogsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePackagingConfigurationOutcome CreatePackagingConfiguration(
      const Model::CreatePackagingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreatePackagingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePackagingConfigurationRequestT = Model::CreatePackagingConfigurationRequest>
  Model::CreatePackagingConfigurationOutcomeCallable CreatePackagingConfigurationCallable(
      const CreatePackagingConfigurationRequestT& request) const {
    return SubmitCallable(&MediaPackageVodClient::CreatePackagingConfiguration, request);
  }

  /**
   * An Async wrapper for CreatePackagingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePackagingConfigurationRequestT = Model::CreatePackagingConfigurationRequest>
  void CreatePackagingConfigurationAsync(const CreatePackagingConfigurationRequestT& request,
                                         const CreatePackagingConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePackagingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePackagingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePackagingGroupRequestT = Model::CreatePackagingGroupRequest>
  void CreatePackagingGroupAsync(const CreatePackagingGroupRequestT& request, const CreatePackagingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePackagingConfigurationOutcome DeletePackagingConfiguration(
      const Model::DeletePackagingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeletePackagingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePackagingConfigurationRequestT = Model::DeletePackagingConfigurationRequest>
  Model::DeletePackagingConfigurationOutcomeCallable DeletePackagingConfigurationCallable(
      const DeletePackagingConfigurationRequestT& request) const {
    return SubmitCallable(&MediaPackageVodClient::DeletePackagingConfiguration, request);
  }

  /**
   * An Async wrapper for DeletePackagingConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePackagingConfigurationRequestT = Model::DeletePackagingConfigurationRequest>
  void DeletePackagingConfigurationAsync(const DeletePackagingConfigurationRequestT& request,
                                         const DeletePackagingConfigurationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePackagingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePackagingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePackagingGroupRequestT = Model::DeletePackagingGroupRequest>
  void DeletePackagingGroupAsync(const DeletePackagingGroupRequestT& request, const DeletePackagingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePackagingConfigurationOutcome DescribePackagingConfiguration(
      const Model::DescribePackagingConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribePackagingConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribePackagingConfigurationRequestT = Model::DescribePackagingConfigurationRequest>
  Model::DescribePackagingConfigurationOutcomeCallable DescribePackagingConfigurationCallable(
      const DescribePackagingConfigurationRequestT& request) const {
    return SubmitCallable(&MediaPackageVodClient::DescribePackagingConfiguration, request);
  }

  /**
   * An Async wrapper for DescribePackagingConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribePackagingConfigurationRequestT = Model::DescribePackagingConfigurationRequest>
  void DescribePackagingConfigurationAsync(const DescribePackagingConfigurationRequestT& request,
                                           const DescribePackagingConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePackagingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePackagingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePackagingGroupRequestT = Model::DescribePackagingGroupRequest>
  void DescribePackagingGroupAsync(const DescribePackagingGroupRequestT& request,
                                   const DescribePackagingGroupResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPackagingConfigurationsOutcome ListPackagingConfigurations(
      const Model::ListPackagingConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPackagingConfigurations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPackagingConfigurationsRequestT = Model::ListPackagingConfigurationsRequest>
  Model::ListPackagingConfigurationsOutcomeCallable ListPackagingConfigurationsCallable(
      const ListPackagingConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&MediaPackageVodClient::ListPackagingConfigurations, request);
  }

  /**
   * An Async wrapper for ListPackagingConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPackagingConfigurationsRequestT = Model::ListPackagingConfigurationsRequest>
  void ListPackagingConfigurationsAsync(const ListPackagingConfigurationsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListPackagingConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPackagingGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackagingGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPackagingGroupsRequestT = Model::ListPackagingGroupsRequest>
  void ListPackagingGroupsAsync(const ListPackagingGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListPackagingGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdatePackagingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePackagingGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePackagingGroupRequestT = Model::UpdatePackagingGroupRequest>
  void UpdatePackagingGroupAsync(const UpdatePackagingGroupRequestT& request, const UpdatePackagingGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
