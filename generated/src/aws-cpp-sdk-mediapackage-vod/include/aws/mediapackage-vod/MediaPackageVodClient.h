...
namespace MediaPackageVod
{
   ...
   */
  class AWS_MEDIAPACKAGEVOD_API MediaPackageVodClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaPackageVodClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaPackageVod::SERVICE_NAME,
