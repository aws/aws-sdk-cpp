...
namespace SFN {
/**
 * <fullname>Step Functions</fullname> <p>With Step Functions, you can create
 * workflows, also called <i>state machines</i>, to build distributed applications,
 * automate processes, orchestrate microservices, and create data and machine
 * learning pipelines.</p> <p>Through the Step Functions API, you can create, list,
 * update, and delete state machines, activities, and other data types. You can
 * start, stop, and redrive your state machines. Your activity workers can send
 * task success, heartbeat, and failure responses.</p> <p>With API calls, you can
 * also manage other aspects of your workflow, such as tags, versions, and
 * aliases.</p> <p>For more information about developing solutions with Step
...
class AWS_SFN_API SFNClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SFNClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SFNEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CreateActivity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateActivityRequestT = Model::CreateActivityRequest>
  void CreateActivityAsync(const CreateActivityRequestT& request, const CreateActivityResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateStateMachine that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStateMachine that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateStateMachineRequestT = Model::CreateStateMachineRequest>
  void CreateStateMachineAsync(const CreateStateMachineRequestT& request, const CreateStateMachineResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateStateMachineAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateStateMachineAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStateMachineAliasRequestT = Model::CreateStateMachineAliasRequest>
  void CreateStateMachineAliasAsync(const CreateStateMachineAliasRequestT& request,
                                    const CreateStateMachineAliasResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteActivity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteActivityRequestT = Model::DeleteActivityRequest>
  void DeleteActivityAsync(const DeleteActivityRequestT& request, const DeleteActivityResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStateMachine that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStateMachine that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteStateMachineRequestT = Model::DeleteStateMachineRequest>
  void DeleteStateMachineAsync(const DeleteStateMachineRequestT& request, const DeleteStateMachineResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStateMachineAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteStateMachineAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStateMachineAliasRequestT = Model::DeleteStateMachineAliasRequest>
  void DeleteStateMachineAliasAsync(const DeleteStateMachineAliasRequestT& request,
                                    const DeleteStateMachineAliasResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteStateMachineVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteStateMachineVersionRequestT = Model::DeleteStateMachineVersionRequest>
  Model::DeleteStateMachineVersionOutcomeCallable DeleteStateMachineVersionCallable(
      const DeleteStateMachineVersionRequestT& request) const {
    return SubmitCallable(&SFNClient::DeleteStateMachineVersion, request);
  }

  /**
   * An Async wrapper for DeleteStateMachineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStateMachineVersionRequestT = Model::DeleteStateMachineVersionRequest>
  void DeleteStateMachineVersionAsync(const DeleteStateMachineVersionRequestT& request,
                                      const DeleteStateMachineVersionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeActivity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeActivity that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeActivityRequestT = Model::DescribeActivityRequest>
  void DescribeActivityAsync(const DescribeActivityRequestT& request, const DescribeActivityResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeMapRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeMapRunRequestT = Model::DescribeMapRunRequest>
  void DescribeMapRunAsync(const DescribeMapRunRequestT& request, const DescribeMapRunResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeStateMachine that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStateMachine that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStateMachineRequestT = Model::DescribeStateMachineRequest>
  void DescribeStateMachineAsync(const DescribeStateMachineRequestT& request, const DescribeStateMachineResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeStateMachineAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeStateMachineAliasRequestT = Model::DescribeStateMachineAliasRequest>
  Model::DescribeStateMachineAliasOutcomeCallable DescribeStateMachineAliasCallable(
      const DescribeStateMachineAliasRequestT& request) const {
    return SubmitCallable(&SFNClient::DescribeStateMachineAlias, request);
  }

  /**
   * An Async wrapper for DescribeStateMachineAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStateMachineAliasRequestT = Model::DescribeStateMachineAliasRequest>
  void DescribeStateMachineAliasAsync(const DescribeStateMachineAliasRequestT& request,
                                      const DescribeStateMachineAliasResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeStateMachineForExecutionOutcome DescribeStateMachineForExecution(
      const Model::DescribeStateMachineForExecutionRequest& request) const;

  /**
   * A Callable wrapper for DescribeStateMachineForExecution that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeStateMachineForExecutionRequestT = Model::DescribeStateMachineForExecutionRequest>
  Model::DescribeStateMachineForExecutionOutcomeCallable DescribeStateMachineForExecutionCallable(
      const DescribeStateMachineForExecutionRequestT& request) const {
    return SubmitCallable(&SFNClient::DescribeStateMachineForExecution, request);
  }

  /**
   * An Async wrapper for DescribeStateMachineForExecution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeStateMachineForExecutionRequestT = Model::DescribeStateMachineForExecutionRequest>
  void DescribeStateMachineForExecutionAsync(const DescribeStateMachineForExecutionRequestT& request,
  ...
  /**
   * An Async wrapper for GetActivityTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetActivityTaskRequestT = Model::GetActivityTaskRequest>
  void GetActivityTaskAsync(const GetActivityTaskRequestT& request, const GetActivityTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetExecutionHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetExecutionHistory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetExecutionHistoryRequestT = Model::GetExecutionHistoryRequest>
  void GetExecutionHistoryAsync(const GetExecutionHistoryRequestT& request, const GetExecutionHistoryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListActivities that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListActivitiesRequestT = Model::ListActivitiesRequest>
  void ListActivitiesAsync(const ListActivitiesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListActivitiesRequestT& request = {}) const {
   ...
   */
  template <typename ListExecutionsRequestT = Model::ListExecutionsRequest>
  void ListExecutionsAsync(const ListExecutionsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListExecutionsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListMapRuns that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMapRunsRequestT = Model::ListMapRunsRequest>
  void ListMapRunsAsync(const ListMapRunsRequestT& request, const ListMapRunsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStateMachineAliases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStateMachineAliases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStateMachineAliasesRequestT = Model::ListStateMachineAliasesRequest>
  void ListStateMachineAliasesAsync(const ListStateMachineAliasesRequestT& request,
                                    const ListStateMachineAliasesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStateMachineVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStateMachineVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStateMachineVersionsRequestT = Model::ListStateMachineVersionsRequest>
  void ListStateMachineVersionsAsync(const ListStateMachineVersionsRequestT& request,
                                     const ListStateMachineVersionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListStateMachines that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStateMachines that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStateMachinesRequestT = Model::ListStateMachinesRequest>
  void ListStateMachinesAsync(const ListStateMachinesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListStateMachinesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PublishStateMachineVersionOutcome PublishStateMachineVersion(
      const Model::PublishStateMachineVersionRequest& request) const;

  /**
   * A Callable wrapper for PublishStateMachineVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PublishStateMachineVersionRequestT = Model::PublishStateMachineVersionRequest>
  Model::PublishStateMachineVersionOutcomeCallable PublishStateMachineVersionCallable(
      const PublishStateMachineVersionRequestT& request) const {
    return SubmitCallable(&SFNClient::PublishStateMachineVersion, request);
  }

  /**
   * An Async wrapper for PublishStateMachineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PublishStateMachineVersionRequestT = Model::PublishStateMachineVersionRequest>
  void PublishStateMachineVersionAsync(const PublishStateMachineVersionRequestT& request,
                                       const PublishStateMachineVersionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RedriveExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RedriveExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RedriveExecutionRequestT = Model::RedriveExecutionRequest>
  void RedriveExecutionAsync(const RedriveExecutionRequestT& request, const RedriveExecutionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendTaskFailure that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendTaskFailureRequestT = Model::SendTaskFailureRequest>
  void SendTaskFailureAsync(const SendTaskFailureRequestT& request, const SendTaskFailureResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendTaskHeartbeat that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendTaskHeartbeat that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendTaskHeartbeatRequestT = Model::SendTaskHeartbeatRequest>
  void SendTaskHeartbeatAsync(const SendTaskHeartbeatRequestT& request, const SendTaskHeartbeatResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SendTaskSuccess that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendTaskSuccessRequestT = Model::SendTaskSuccessRequest>
  void SendTaskSuccessAsync(const SendTaskSuccessRequestT& request, const SendTaskSuccessResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StartExecution that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartExecutionRequestT = Model::StartExecutionRequest>
  void StartExecutionAsync(const StartExecutionRequestT& request, const StartExecutionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartSyncExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartSyncExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartSyncExecutionRequestT = Model::StartSyncExecutionRequest>
  void StartSyncExecutionAsync(const StartSyncExecutionRequestT& request, const StartSyncExecutionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopExecution that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopExecutionRequestT = Model::StopExecutionRequest>
  void StopExecutionAsync(const StopExecutionRequestT& request, const StopExecutionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for TestState that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TestStateRequestT = Model::TestStateRequest>
  void TestStateAsync(const TestStateRequestT& request, const TestStateResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateMapRun that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateMapRunRequestT = Model::UpdateMapRunRequest>
  void UpdateMapRunAsync(const UpdateMapRunRequestT& request, const UpdateMapRunResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStateMachine that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStateMachine that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateStateMachineRequestT = Model::UpdateStateMachineRequest>
  void UpdateStateMachineAsync(const UpdateStateMachineRequestT& request, const UpdateStateMachineResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateStateMachineAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStateMachineAlias that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStateMachineAliasRequestT = Model::UpdateStateMachineAliasRequest>
  void UpdateStateMachineAliasAsync(const UpdateStateMachineAliasRequestT& request,
                                    const UpdateStateMachineAliasResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SFNClient::UpdateStateMachineAlias, request, handler, context);
  }

  /**
   * <p>Validates the syntax of a state machine definition specified in <a
   * href="https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html">Amazon
   * States Language</a> (ASL), a JSON-based, structured language.</p> <p>You can
   * validate that a state machine definition is correct without creating a state
   * machine resource.</p> <p>Suggested uses for
   ...
   * check state machine definitions before starting deployments.</p> </li> <li>
   * <p>Run validation from a Git pre-commit hook to verify the definition before
   * committing to your source repository.</p> </li> </ul> <p>Validation will look
   * for problems in your state machine definition and return a <b>result</b> and a
   * list of <b>diagnostic elements</b>.</p> <p>The <b>result</b> value will be
   * <code>OK</code> when your workflow definition can be successfully created or
   * updated. Note the result can be <code>OK</code> even when diagnostic warnings
   * are present in the response. The <b>result</b> value will be <code>FAIL</code>
   * when the workflow definition contains errors that would prevent you from
   * creating or updating your state machine. </p> <p>The list of <a
   ...
   * elements.</p>  <p>The <b>ValidateStateMachineDefinition API</b> might add
   ...
   * count, or wording of diagnostic messages.</p> <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/states-2016-11-23/ValidateStateMachineDefinition">AWS
   * API Reference</a></p>
   */
  virtual Model::ValidateStateMachineDefinitionOutcome ValidateStateMachineDefinition(
      const Model::ValidateStateMachineDefinitionRequest& request) const;

  /**
   * A Callable wrapper for ValidateStateMachineDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ValidateStateMachineDefinitionRequestT = Model::ValidateStateMachineDefinitionRequest>
  Model::ValidateStateMachineDefinitionOutcomeCallable ValidateStateMachineDefinitionCallable(
      const ValidateStateMachineDefinitionRequestT& request) const {
    return SubmitCallable(&SFNClient::ValidateStateMachineDefinition, request);
  }

  /**
   * An Async wrapper for ValidateStateMachineDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ValidateStateMachineDefinitionRequestT = Model::ValidateStateMachineDefinitionRequest>
  void ValidateStateMachineDefinitionAsync(const ValidateStateMachineDefinitionRequestT& request,
                                           const ValidateStateMachineDefinitionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
