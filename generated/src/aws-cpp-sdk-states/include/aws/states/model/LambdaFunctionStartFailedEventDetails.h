...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API LambdaFunctionStartFailedEventDetails() = default;
    ...
    template<typename ErrorT = Aws::String>
    LambdaFunctionStartFailedEventDetails& WithError(ErrorT&& value) { SetError(std::forward<ErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename CauseT = Aws::String>
    LambdaFunctionStartFailedEventDetails& WithCause(CauseT&& value) { SetCause(std::forward<CauseT>(value)); return *this;}
    ///@}
  private:
