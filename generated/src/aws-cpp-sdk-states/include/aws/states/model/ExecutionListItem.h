...
class ExecutionListItem {
 public:
  ...
  inline ExecutionListItem& WithStatus(ExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ExecutionListItem& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline ExecutionListItem& WithRedriveCount(int value) {
  ...
  void SetRedriveDate(RedriveDateT&& value) {
    ...
    m_redriveDate = std::forward<RedriveDateT>(value);
  }
  template <typename RedriveDateT = Aws::Utils::DateTime>
  ExecutionListItem& WithRedriveDate(RedriveDateT&& value) {
    SetRedriveDate(std::forward<RedriveDateT>(value));
    return *this;
  }
  ///@}
 private:
