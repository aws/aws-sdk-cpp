...
class ListStateMachineAliasesRequest : public SFNRequest {
 public:
  ...
  template <typename StateMachineArnT = Aws::String>
  ListStateMachineAliasesRequest& WithStateMachineArn(StateMachineArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStateMachineAliasesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStateMachineAliasesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
