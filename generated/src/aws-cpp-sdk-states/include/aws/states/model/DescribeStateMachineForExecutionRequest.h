...
namespace Model
{
  ...
  public:
    ...
    inline DescribeStateMachineForExecutionRequest& WithIncludedData(const IncludedData& value) { SetIncludedData(value); return *this;}
    inline DescribeStateMachineForExecutionRequest& WithIncludedData(IncludedData&& value) { SetIncludedData(std::move(value)); return *this;}
    ///@}
  private:
