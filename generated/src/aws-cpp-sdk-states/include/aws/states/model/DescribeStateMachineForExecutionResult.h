...
class DescribeStateMachineForExecutionResult {
 public:
  ...
  template <typename StateMachineArnT = Aws::String>
  DescribeStateMachineForExecutionResult& WithStateMachineArn(StateMachineArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  DescribeStateMachineForExecutionResult& WithName(NameT&& value) {
  ...
  template <typename DefinitionT = Aws::String>
  DescribeStateMachineForExecutionResult& WithDefinition(DefinitionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  DescribeStateMachineForExecutionResult& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename UpdateDateT = Aws::Utils::DateTime>
  DescribeStateMachineForExecutionResult& WithUpdateDate(UpdateDateT&& value) {
  ...
  template <typename LoggingConfigurationT = LoggingConfiguration>
  DescribeStateMachineForExecutionResult& WithLoggingConfiguration(LoggingConfigurationT&& value) {
  ...
  template <typename TracingConfigurationT = TracingConfiguration>
  DescribeStateMachineForExecutionResult& WithTracingConfiguration(TracingConfigurationT&& value) {
  ...
  template <typename MapRunArnT = Aws::String>
  DescribeStateMachineForExecutionResult& WithMapRunArn(MapRunArnT&& value) {
  ...
  template <typename LabelT = Aws::String>
  DescribeStateMachineForExecutionResult& WithLabel(LabelT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  DescribeStateMachineForExecutionResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  DescribeStateMachineForExecutionResult& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
  ...
  void SetVariableReferences(VariableReferencesT&& value) {
    ...
    m_variableReferences = std::forward<VariableReferencesT>(value);
  }
  template <typename VariableReferencesT = Aws::Map<Aws::String, Aws::Vector<Aws::String>>>
  DescribeStateMachineForExecutionResult& WithVariableReferences(VariableReferencesT&& value) {
    SetVariableReferences(std::forward<VariableReferencesT>(value));
    return *this;
  }
  ...
  DescribeStateMachineForExecutionResult& AddVariableReferences(VariableReferencesKeyT&& key, VariableReferencesValueT&& value) {
    m_variableReferencesHasBeenSet = true;
    m_variableReferences.emplace(std::forward<VariableReferencesKeyT>(key), std::forward<VariableReferencesValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeStateMachineForExecutionResult& WithRequestId(RequestIdT&& value) {
