...
class ListStateMachineVersionsRequest : public SFNRequest {
 public:
  ...
  template <typename StateMachineArnT = Aws::String>
  ListStateMachineVersionsRequest& WithStateMachineArn(StateMachineArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListStateMachineVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStateMachineVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
