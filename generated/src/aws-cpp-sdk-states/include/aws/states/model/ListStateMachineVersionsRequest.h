...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API ListStateMachineVersionsRequest() = default;
    ...
    template<typename StateMachineArnT = Aws::String>
    ListStateMachineVersionsRequest& WithStateMachineArn(StateMachineArnT&& value) { SetStateMachineArn(std::forward<StateMachineArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListStateMachineVersionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
