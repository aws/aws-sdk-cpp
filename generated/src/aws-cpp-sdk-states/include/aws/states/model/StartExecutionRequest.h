...
class StartExecutionRequest : public SFNRequest {
 public:
  ...
  template <typename StateMachineArnT = Aws::String>
  StartExecutionRequest& WithStateMachineArn(StateMachineArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StartExecutionRequest& WithName(NameT&& value) {
  ...
  template <typename InputT = Aws::String>
  StartExecutionRequest& WithInput(InputT&& value) {
  ...
  template <typename TraceHeaderT = Aws::String>
  StartExecutionRequest& WithTraceHeader(TraceHeaderT&& value) {
