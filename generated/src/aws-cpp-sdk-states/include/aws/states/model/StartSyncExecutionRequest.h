...
class StartSyncExecutionRequest : public SFNRequest {
 public:
  ...
  template <typename StateMachineArnT = Aws::String>
  StartSyncExecutionRequest& WithStateMachineArn(StateMachineArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  StartSyncExecutionRequest& WithName(NameT&& value) {
  ...
  template <typename InputT = Aws::String>
  StartSyncExecutionRequest& WithInput(InputT&& value) {
  ...
  template <typename TraceHeaderT = Aws::String>
  StartSyncExecutionRequest& WithTraceHeader(TraceHeaderT&& value) {
  ...
  inline StartSyncExecutionRequest& WithIncludedData(IncludedData value) {
