...
class DescribeStateMachineResult {
 public:
  ...
  inline void SetStatus(StateMachineStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeStateMachineResult& WithStatus(StateMachineStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeStateMachineResult& WithType(StateMachineType value) {
    SetType(value);
    return *this;
  }
  ///@}
