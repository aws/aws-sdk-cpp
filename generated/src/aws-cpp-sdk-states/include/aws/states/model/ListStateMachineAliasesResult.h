...
class ListStateMachineAliasesResult {
 public:
  ...
  void SetStateMachineAliases(StateMachineAliasesT&& value) {
    m_stateMachineAliasesHasBeenSet = true;
    m_stateMachineAliases = std::forward<StateMachineAliasesT>(value);
  }
  template <typename StateMachineAliasesT = Aws::Vector<StateMachineAliasListItem>>
  ListStateMachineAliasesResult& WithStateMachineAliases(StateMachineAliasesT&& value) {
    SetStateMachineAliases(std::forward<StateMachineAliasesT>(value));
    return *this;
  }
  template <typename StateMachineAliasesT = StateMachineAliasListItem>
  ListStateMachineAliasesResult& AddStateMachineAliases(StateMachineAliasesT&& value) {
    m_stateMachineAliasesHasBeenSet = true;
    m_stateMachineAliases.emplace_back(std::forward<StateMachineAliasesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStateMachineAliasesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStateMachineAliasesResult& WithRequestId(RequestIdT&& value) {
