...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API ExecutionSucceededEventDetails() = default;
    ...
    template<typename OutputT = Aws::String>
    ExecutionSucceededEventDetails& WithOutput(OutputT&& value) { SetOutput(std::forward<OutputT>(value)); return *this;}
    ///@}
    ...
    template<typename OutputDetailsT = HistoryEventExecutionDataDetails>
    ExecutionSucceededEventDetails& WithOutputDetails(OutputDetailsT&& value) { SetOutputDetails(std::forward<OutputDetailsT>(value)); return *this;}
    ///@}
  private:
