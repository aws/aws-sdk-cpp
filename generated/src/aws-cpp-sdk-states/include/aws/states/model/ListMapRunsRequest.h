...
class ListMapRunsRequest : public SFNRequest {
 public:
  ...
  template <typename ExecutionArnT = Aws::String>
  ListMapRunsRequest& WithExecutionArn(ExecutionArnT&& value) {
  ...
  inline ListMapRunsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMapRunsRequest& WithNextToken(NextTokenT&& value) {
