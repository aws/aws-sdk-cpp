...
class GetExecutionHistoryRequest : public SFNRequest {
 public:
  ...
  inline GetExecutionHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetExecutionHistoryRequest& WithReverseOrder(bool value) {
  ...
  inline GetExecutionHistoryRequest& WithIncludeExecutionData(bool value) {
