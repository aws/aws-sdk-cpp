...
class ListStateMachineVersionsResult {
 public:
  ...
  void SetStateMachineVersions(StateMachineVersionsT&& value) {
    m_stateMachineVersionsHasBeenSet = true;
    m_stateMachineVersions = std::forward<StateMachineVersionsT>(value);
  }
  template <typename StateMachineVersionsT = Aws::Vector<StateMachineVersionListItem>>
  ListStateMachineVersionsResult& WithStateMachineVersions(StateMachineVersionsT&& value) {
    SetStateMachineVersions(std::forward<StateMachineVersionsT>(value));
    return *this;
  }
  template <typename StateMachineVersionsT = StateMachineVersionListItem>
  ListStateMachineVersionsResult& AddStateMachineVersions(StateMachineVersionsT&& value) {
    m_stateMachineVersionsHasBeenSet = true;
    m_stateMachineVersions.emplace_back(std::forward<StateMachineVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStateMachineVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStateMachineVersionsResult& WithRequestId(RequestIdT&& value) {
