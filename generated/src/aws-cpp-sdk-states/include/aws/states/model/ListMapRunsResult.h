...
class ListMapRunsResult {
 public:
  ...
  void SetMapRuns(MapRunsT&& value) {
    m_mapRunsHasBeenSet = true;
    m_mapRuns = std::forward<MapRunsT>(value);
  }
  template <typename MapRunsT = Aws::Vector<MapRunListItem>>
  ListMapRunsResult& WithMapRuns(MapRunsT&& value) {
    SetMapRuns(std::forward<MapRunsT>(value));
    return *this;
  }
  template <typename MapRunsT = MapRunListItem>
  ListMapRunsResult& AddMapRuns(MapRunsT&& value) {
    m_mapRunsHasBeenSet = true;
    m_mapRuns.emplace_back(std::forward<MapRunsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMapRunsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMapRunsResult& WithRequestId(RequestIdT&& value) {
