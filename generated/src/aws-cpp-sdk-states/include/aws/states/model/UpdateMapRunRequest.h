...
class UpdateMapRunRequest : public SFNRequest {
 public:
  ...
  inline UpdateMapRunRequest& WithMaxConcurrency(int value) {
  ...
  inline UpdateMapRunRequest& WithToleratedFailurePercentage(double value) {
  ...
  inline void SetToleratedFailureCount(long long value) {
    m_toleratedFailureCountHasBeenSet = true;
    m_toleratedFailureCount = value;
  }
  inline UpdateMapRunRequest& WithToleratedFailureCount(long long value) {
