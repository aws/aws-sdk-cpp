...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API ActivityScheduleFailedEventDetails() = default;
    ...
    template<typename ErrorT = Aws::String>
    ActivityScheduleFailedEventDetails& WithError(ErrorT&& value) { SetError(std::forward<ErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename CauseT = Aws::String>
    ActivityScheduleFailedEventDetails& WithCause(CauseT&& value) { SetCause(std::forward<CauseT>(value)); return *this;}
    ///@}
  private:
