...
class ActivityScheduledEventDetails {
 public:
  ...
  inline ActivityScheduledEventDetails& WithTimeoutInSeconds(long long value) {
  ...
  inline void SetHeartbeatInSeconds(long long value) {
    m_heartbeatInSecondsHasBeenSet = true;
    m_heartbeatInSeconds = value;
  }
  inline ActivityScheduledEventDetails& WithHeartbeatInSeconds(long long value) {
    SetHeartbeatInSeconds(value);
    return *this;
  }
  ///@}
 private:
