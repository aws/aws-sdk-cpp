...
class TaskSubmitFailedEventDetails {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  TaskSubmitFailedEventDetails& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceT = Aws::String>
  TaskSubmitFailedEventDetails& WithResource(ResourceT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  TaskSubmitFailedEventDetails& WithError(ErrorT&& value) {
  ...
  template <typename CauseT = Aws::String>
  TaskSubmitFailedEventDetails& WithCause(CauseT&& value) {
