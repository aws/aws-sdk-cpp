...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API DeleteStateMachineResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteStateMachineResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
