...
class StateExitedEventDetails {
 public:
  ...
  void SetAssignedVariables(AssignedVariablesT&& value) {
    ...
    m_assignedVariables = std::forward<AssignedVariablesT>(value);
  }
  template <typename AssignedVariablesT = Aws::Map<Aws::String, Aws::String>>
  StateExitedEventDetails& WithAssignedVariables(AssignedVariablesT&& value) {
    SetAssignedVariables(std::forward<AssignedVariablesT>(value));
    return *this;
  }
  ...
  StateExitedEventDetails& AddAssignedVariables(AssignedVariablesKeyT&& key, AssignedVariablesValueT&& value) {
    m_assignedVariablesHasBeenSet = true;
    m_assignedVariables.emplace(std::forward<AssignedVariablesKeyT>(key), std::forward<AssignedVariablesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssignedVariablesDetails(AssignedVariablesDetailsT&& value) {
    ...
    m_assignedVariablesDetails = std::forward<AssignedVariablesDetailsT>(value);
  }
  template <typename AssignedVariablesDetailsT = AssignedVariablesDetails>
  StateExitedEventDetails& WithAssignedVariablesDetails(AssignedVariablesDetailsT&& value) {
    SetAssignedVariablesDetails(std::forward<AssignedVariablesDetailsT>(value));
    return *this;
  }
  ///@}
 private:
