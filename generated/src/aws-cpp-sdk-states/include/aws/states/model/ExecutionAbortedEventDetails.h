...
namespace Model
{
  ...
  {
  public:
    AWS_SFN_API ExecutionAbortedEventDetails() = default;
    ...
    template<typename ErrorT = Aws::String>
    ExecutionAbortedEventDetails& WithError(ErrorT&& value) { SetError(std::forward<ErrorT>(value)); return *this;}
    ///@}
    ...
    template<typename CauseT = Aws::String>
    ExecutionAbortedEventDetails& WithCause(CauseT&& value) { SetCause(std::forward<CauseT>(value)); return *this;}
    ///@}
  private:
