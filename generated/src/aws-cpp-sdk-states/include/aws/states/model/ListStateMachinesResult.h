...
class ListStateMachinesResult {
 public:
  ...
  void SetStateMachines(StateMachinesT&& value) {
    m_stateMachinesHasBeenSet = true;
    m_stateMachines = std::forward<StateMachinesT>(value);
  }
  template <typename StateMachinesT = Aws::Vector<StateMachineListItem>>
  ListStateMachinesResult& WithStateMachines(StateMachinesT&& value) {
    SetStateMachines(std::forward<StateMachinesT>(value));
    return *this;
  }
  template <typename StateMachinesT = StateMachineListItem>
  ListStateMachinesResult& AddStateMachines(StateMachinesT&& value) {
    m_stateMachinesHasBeenSet = true;
    m_stateMachines.emplace_back(std::forward<StateMachinesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListStateMachinesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListStateMachinesResult& WithRequestId(RequestIdT&& value) {
