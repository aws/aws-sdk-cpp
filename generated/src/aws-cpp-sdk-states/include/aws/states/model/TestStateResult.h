...
class TestStateResult {
 public:
  ...
  template <typename OutputT = Aws::String>
  TestStateResult& WithOutput(OutputT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  TestStateResult& WithError(ErrorT&& value) {
  ...
  template <typename CauseT = Aws::String>
  TestStateResult& WithCause(CauseT&& value) {
  ...
  void SetInspectionData(InspectionDataT&& value) {
    m_inspectionDataHasBeenSet = true;
    m_inspectionData = std::forward<InspectionDataT>(value);
  }
  template <typename InspectionDataT = InspectionData>
  TestStateResult& WithInspectionData(InspectionDataT&& value) {
    SetInspectionData(std::forward<InspectionDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextState(NextStateT&& value) {
    ...
    m_nextState = std::forward<NextStateT>(value);
  }
  template <typename NextStateT = Aws::String>
  TestStateResult& WithNextState(NextStateT&& value) {
    SetNextState(std::forward<NextStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TestExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline TestStateResult& WithStatus(TestExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  TestStateResult& WithRequestId(RequestIdT&& value) {
