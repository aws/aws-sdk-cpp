...
class StartSyncExecutionResult {
 public:
  ...
  inline void SetStatus(SyncExecutionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline StartSyncExecutionResult& WithStatus(SyncExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputDetails(OutputDetailsT&& value) {
    ...
    m_outputDetails = std::forward<OutputDetailsT>(value);
  }
  template <typename OutputDetailsT = CloudWatchEventsExecutionDataDetails>
  StartSyncExecutionResult& WithOutputDetails(OutputDetailsT&& value) {
    SetOutputDetails(std::forward<OutputDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingDetails(BillingDetailsT&& value) {
    ...
    m_billingDetails = std::forward<BillingDetailsT>(value);
  }
  template <typename BillingDetailsT = BillingDetails>
  StartSyncExecutionResult& WithBillingDetails(BillingDetailsT&& value) {
    SetBillingDetails(std::forward<BillingDetailsT>(value));
    return *this;
  }
  ///@}
