...
class TaskTimedOutEventDetails {
 public:
  ...
  template <typename ResourceTypeT = Aws::String>
  TaskTimedOutEventDetails& WithResourceType(ResourceTypeT&& value) {
  ...
  template <typename ResourceT = Aws::String>
  TaskTimedOutEventDetails& WithResource(ResourceT&& value) {
  ...
  template <typename ErrorT = Aws::String>
  TaskTimedOutEventDetails& WithError(ErrorT&& value) {
  ...
  template <typename CauseT = Aws::String>
  TaskTimedOutEventDetails& WithCause(CauseT&& value) {
