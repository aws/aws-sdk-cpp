...
namespace SFN
{
const size_t SFNEndpointRules::RulesBlobStrLen = 3645;
const size_t SFNEndpointRules::RulesBlobSize = 3646;
...
'l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','.','u','s','-','g','o','v',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','-','f','i',
...
'l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','.','{','R','e','g','i','o',
