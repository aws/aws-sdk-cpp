...
namespace SFN
{
const size_t SFNEndpointRules::RulesBlobStrLen = 3916;
const size_t SFNEndpointRules::RulesBlobSize = 3917;
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','s','t','a','t','e','s','.','u','s','-','g',
...
's',':','/','/','s','t','a','t','e','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
't','t','p','s',':','/','/','s','t','a','t','e','s','.','{','R','e','g','i','o','n','}','.','{','P',
