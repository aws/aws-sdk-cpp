...
LambdaFunctionFailedEventDetails::LambdaFunctionFailedEventDetails(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue LambdaFunctionFailedEventDetails::Jsonize() const {
  JsonValue payload;
