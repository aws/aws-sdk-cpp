...
class VpcEndpointError {
 public:
  AWS_ELASTICSEARCHSERVICE_API VpcEndpointError() = default;
  ...
  template <typename VpcEndpointIdT = Aws::String>
  VpcEndpointError& WithVpcEndpointId(VpcEndpointIdT&& value) {
  ...
  inline void SetErrorCode(VpcEndpointErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline VpcEndpointError& WithErrorCode(VpcEndpointErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  VpcEndpointError& WithErrorMessage(ErrorMessageT&& value) {
