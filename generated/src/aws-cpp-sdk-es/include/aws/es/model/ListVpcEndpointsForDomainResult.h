...
class ListVpcEndpointsForDomainResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API ListVpcEndpointsForDomainResult& operator=(
  ...
  void SetVpcEndpointSummaryList(VpcEndpointSummaryListT&& value) {
    ...
    m_vpcEndpointSummaryList = std::forward<VpcEndpointSummaryListT>(value);
  }
  template <typename VpcEndpointSummaryListT = Aws::Vector<VpcEndpointSummary>>
  ListVpcEndpointsForDomainResult& WithVpcEndpointSummaryList(VpcEndpointSummaryListT&& value) {
    SetVpcEndpointSummaryList(std::forward<VpcEndpointSummaryListT>(value));
    return *this;
  }
  template <typename VpcEndpointSummaryListT = VpcEndpointSummary>
  ListVpcEndpointsForDomainResult& AddVpcEndpointSummaryList(VpcEndpointSummaryListT&& value) {
    m_vpcEndpointSummaryListHasBeenSet = true;
    m_vpcEndpointSummaryList.emplace_back(std::forward<VpcEndpointSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcEndpointsForDomainResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVpcEndpointsForDomainResult& WithRequestId(RequestIdT&& value) {
