...
class GetCompatibleElasticsearchVersionsResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API GetCompatibleElasticsearchVersionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetCompatibleElasticsearchVersions(CompatibleElasticsearchVersionsT&& value) {
    ...
    m_compatibleElasticsearchVersions = std::forward<CompatibleElasticsearchVersionsT>(value);
  }
  template <typename CompatibleElasticsearchVersionsT = Aws::Vector<CompatibleVersionsMap>>
  GetCompatibleElasticsearchVersionsResult& WithCompatibleElasticsearchVersions(CompatibleElasticsearchVersionsT&& value) {
    SetCompatibleElasticsearchVersions(std::forward<CompatibleElasticsearchVersionsT>(value));
    return *this;
  }
  ...
  GetCompatibleElasticsearchVersionsResult& AddCompatibleElasticsearchVersions(CompatibleElasticsearchVersionsT&& value) {
    m_compatibleElasticsearchVersionsHasBeenSet = true;
    m_compatibleElasticsearchVersions.emplace_back(std::forward<CompatibleElasticsearchVersionsT>(value));
    return *this;
  }
  ///@}
