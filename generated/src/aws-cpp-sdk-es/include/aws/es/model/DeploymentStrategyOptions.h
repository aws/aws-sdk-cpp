 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/es-2015-01-01/DeploymentStrategyOptions">AWS
 * API Reference</a></p>
 */
class DeploymentStrategyOptions {
 public:
  AWS_ELASTICSEARCHSERVICE_API DeploymentStrategyOptions() = default;
  AWS_ELASTICSEARCHSERVICE_API DeploymentStrategyOptions(Aws::Utils::Json::JsonView jsonValue);
  AWS_ELASTICSEARCHSERVICE_API DeploymentStrategyOptions& operator=(Aws::Utils::Json::JsonView jsonValue);
