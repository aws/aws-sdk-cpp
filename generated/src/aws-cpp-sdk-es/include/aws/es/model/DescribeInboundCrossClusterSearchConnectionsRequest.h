...
class DescribeInboundCrossClusterSearchConnectionsRequest : public ElasticsearchServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeInboundCrossClusterSearchConnectionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeInboundCrossClusterSearchConnectionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeInboundCrossClusterSearchConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInboundCrossClusterSearchConnectionsRequest& WithNextToken(NextTokenT&& value) {
