...
class OutboundCrossClusterSearchConnectionStatus {
 public:
  ...
  inline void SetStatusCode(OutboundCrossClusterSearchConnectionStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline OutboundCrossClusterSearchConnectionStatus& WithStatusCode(OutboundCrossClusterSearchConnectionStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  OutboundCrossClusterSearchConnectionStatus& WithMessage(MessageT&& value) {
