...
class InboundCrossClusterSearchConnectionStatus {
 public:
  ...
  inline void SetStatusCode(InboundCrossClusterSearchConnectionStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline InboundCrossClusterSearchConnectionStatus& WithStatusCode(InboundCrossClusterSearchConnectionStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  InboundCrossClusterSearchConnectionStatus& WithMessage(MessageT&& value) {
