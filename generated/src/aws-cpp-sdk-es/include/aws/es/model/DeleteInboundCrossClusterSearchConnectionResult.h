...
class DeleteInboundCrossClusterSearchConnectionResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API DeleteInboundCrossClusterSearchConnectionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CrossClusterSearchConnectionT = InboundCrossClusterSearchConnection>
  DeleteInboundCrossClusterSearchConnectionResult& WithCrossClusterSearchConnection(CrossClusterSearchConnectionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteInboundCrossClusterSearchConnectionResult& WithRequestId(RequestIdT&& value) {
