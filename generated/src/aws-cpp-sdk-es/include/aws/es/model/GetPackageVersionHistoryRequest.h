...
class GetPackageVersionHistoryRequest : public ElasticsearchServiceRequest {
 public:
  ...
  template <typename PackageIDT = Aws::String>
  GetPackageVersionHistoryRequest& WithPackageID(PackageIDT&& value) {
  ...
  inline GetPackageVersionHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetPackageVersionHistoryRequest& WithNextToken(NextTokenT&& value) {
