...
class DescribePackagesResult {
 public:
  ...
  void SetPackageDetailsList(PackageDetailsListT&& value) {
    m_packageDetailsListHasBeenSet = true;
    m_packageDetailsList = std::forward<PackageDetailsListT>(value);
  }
  template <typename PackageDetailsListT = Aws::Vector<PackageDetails>>
  DescribePackagesResult& WithPackageDetailsList(PackageDetailsListT&& value) {
    SetPackageDetailsList(std::forward<PackageDetailsListT>(value));
    return *this;
  }
  template <typename PackageDetailsListT = PackageDetails>
  DescribePackagesResult& AddPackageDetailsList(PackageDetailsListT&& value) {
    m_packageDetailsListHasBeenSet = true;
    m_packageDetailsList.emplace_back(std::forward<PackageDetailsListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribePackagesResult& WithRequestId(RequestIdT&& value) {
