...
class ListVpcEndpointAccessResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API ListVpcEndpointAccessResult& operator=(
  ...
  void SetAuthorizedPrincipalList(AuthorizedPrincipalListT&& value) {
    m_authorizedPrincipalListHasBeenSet = true;
    m_authorizedPrincipalList = std::forward<AuthorizedPrincipalListT>(value);
  }
  template <typename AuthorizedPrincipalListT = Aws::Vector<AuthorizedPrincipal>>
  ListVpcEndpointAccessResult& WithAuthorizedPrincipalList(AuthorizedPrincipalListT&& value) {
    SetAuthorizedPrincipalList(std::forward<AuthorizedPrincipalListT>(value));
    return *this;
  }
  template <typename AuthorizedPrincipalListT = AuthorizedPrincipal>
  ListVpcEndpointAccessResult& AddAuthorizedPrincipalList(AuthorizedPrincipalListT&& value) {
    m_authorizedPrincipalListHasBeenSet = true;
    m_authorizedPrincipalList.emplace_back(std::forward<AuthorizedPrincipalListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcEndpointAccessResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListVpcEndpointAccessResult& WithRequestId(RequestIdT&& value) {
