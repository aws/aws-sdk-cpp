...
class InstanceLimits {
 public:
  ...
  void SetInstanceCountLimits(InstanceCountLimitsT&& value) {
    m_instanceCountLimitsHasBeenSet = true;
    m_instanceCountLimits = std::forward<InstanceCountLimitsT>(value);
  }
  template <typename InstanceCountLimitsT = InstanceCountLimits>
  InstanceLimits& WithInstanceCountLimits(InstanceCountLimitsT&& value) {
    SetInstanceCountLimits(std::forward<InstanceCountLimitsT>(value));
    return *this;
  }
  ///@}
 private:
