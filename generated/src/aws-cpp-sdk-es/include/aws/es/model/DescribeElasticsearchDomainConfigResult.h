...
class DescribeElasticsearchDomainConfigResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API DescribeElasticsearchDomainConfigResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename DomainConfigT = ElasticsearchDomainConfig>
  DescribeElasticsearchDomainConfigResult& WithDomainConfig(DomainConfigT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeElasticsearchDomainConfigResult& WithRequestId(RequestIdT&& value) {
