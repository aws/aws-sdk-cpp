...
namespace Model
{
  ...
  {
  public:
    AWS_ELASTICSEARCHSERVICE_API StartElasticsearchServiceSoftwareUpdateResult() = default;
    ...
    template<typename ServiceSoftwareOptionsT = ServiceSoftwareOptions>
    StartElasticsearchServiceSoftwareUpdateResult& WithServiceSoftwareOptions(ServiceSoftwareOptionsT&& value) { SetServiceSoftwareOptions(std::forward<ServiceSoftwareOptionsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartElasticsearchServiceSoftwareUpdateResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
