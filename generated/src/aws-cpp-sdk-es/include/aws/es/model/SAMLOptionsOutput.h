...
class SAMLOptionsOutput {
 public:
  AWS_ELASTICSEARCHSERVICE_API SAMLOptionsOutput() = default;
  ...
  inline SAMLOptionsOutput& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline SAMLOptionsOutput& WithSessionTimeoutMinutes(int value) {
