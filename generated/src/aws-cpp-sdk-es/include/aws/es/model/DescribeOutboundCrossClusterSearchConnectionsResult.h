...
class DescribeOutboundCrossClusterSearchConnectionsResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API DescribeOutboundCrossClusterSearchConnectionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
   ...
   */
  inline const Aws::Vector<OutboundCrossClusterSearchConnection>& GetCrossClusterSearchConnections() const {
    return m_crossClusterSearchConnections;
  }
  template <typename CrossClusterSearchConnectionsT = Aws::Vector<OutboundCrossClusterSearchConnection>>
  void SetCrossClusterSearchConnections(CrossClusterSearchConnectionsT&& value) {
    m_crossClusterSearchConnectionsHasBeenSet = true;
    m_crossClusterSearchConnections = std::forward<CrossClusterSearchConnectionsT>(value);
  }
  template <typename CrossClusterSearchConnectionsT = Aws::Vector<OutboundCrossClusterSearchConnection>>
  DescribeOutboundCrossClusterSearchConnectionsResult& WithCrossClusterSearchConnections(CrossClusterSearchConnectionsT&& value) {
    SetCrossClusterSearchConnections(std::forward<CrossClusterSearchConnectionsT>(value));
    return *this;
  }
  template <typename CrossClusterSearchConnectionsT = OutboundCrossClusterSearchConnection>
  DescribeOutboundCrossClusterSearchConnectionsResult& AddCrossClusterSearchConnections(CrossClusterSearchConnectionsT&& value) {
    m_crossClusterSearchConnectionsHasBeenSet = true;
    m_crossClusterSearchConnections.emplace_back(std::forward<CrossClusterSearchConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOutboundCrossClusterSearchConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeOutboundCrossClusterSearchConnectionsResult& WithRequestId(RequestIdT&& value) {
