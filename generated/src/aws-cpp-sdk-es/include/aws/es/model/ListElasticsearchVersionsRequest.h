...
class ListElasticsearchVersionsRequest : public ElasticsearchServiceRequest {
 public:
  AWS_ELASTICSEARCHSERVICE_API ListElasticsearchVersionsRequest() = default;
  ...
  inline ListElasticsearchVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListElasticsearchVersionsRequest& WithNextToken(NextTokenT&& value) {
