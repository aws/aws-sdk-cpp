...
class ElasticsearchClusterConfig {
 public:
  ...
  inline ElasticsearchClusterConfig& WithInstanceType(ESPartitionInstanceType value) {
  ...
  inline ElasticsearchClusterConfig& WithInstanceCount(int value) {
  ...
  inline ElasticsearchClusterConfig& WithDedicatedMasterEnabled(bool value) {
  ...
  inline ElasticsearchClusterConfig& WithZoneAwarenessEnabled(bool value) {
  ...
  inline void SetDedicatedMasterType(ESPartitionInstanceType value) {
    m_dedicatedMasterTypeHasBeenSet = true;
    m_dedicatedMasterType = value;
  }
  inline ElasticsearchClusterConfig& WithDedicatedMasterType(ESPartitionInstanceType value) {
  ...
  inline ElasticsearchClusterConfig& WithDedicatedMasterCount(int value) {
  ...
  inline ElasticsearchClusterConfig& WithWarmEnabled(bool value) {
  ...
  inline void SetWarmType(ESWarmPartitionInstanceType value) {
    m_warmTypeHasBeenSet = true;
    m_warmType = value;
  }
  inline ElasticsearchClusterConfig& WithWarmType(ESWarmPartitionInstanceType value) {
    SetWarmType(value);
    return *this;
  }
  ///@}
  ...
  inline ElasticsearchClusterConfig& WithWarmCount(int value) {
    SetWarmCount(value);
    return *this;
  }
  ///@}
