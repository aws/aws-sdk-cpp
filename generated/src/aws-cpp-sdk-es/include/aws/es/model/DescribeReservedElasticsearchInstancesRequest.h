...
class DescribeReservedElasticsearchInstancesRequest : public ElasticsearchServiceRequest {
 public:
  ...
  template <typename ReservedElasticsearchInstanceIdT = Aws::String>
  DescribeReservedElasticsearchInstancesRequest& WithReservedElasticsearchInstanceId(ReservedElasticsearchInstanceIdT&& value) {
  ...
  inline DescribeReservedElasticsearchInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReservedElasticsearchInstancesRequest& WithNextToken(NextTokenT&& value) {
