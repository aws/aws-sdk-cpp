...
class DescribeInboundCrossClusterSearchConnectionsResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API DescribeInboundCrossClusterSearchConnectionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
   ...
   */
  inline const Aws::Vector<InboundCrossClusterSearchConnection>& GetCrossClusterSearchConnections() const {
  ...
  template <typename CrossClusterSearchConnectionsT = Aws::Vector<InboundCrossClusterSearchConnection>>
  DescribeInboundCrossClusterSearchConnectionsResult& WithCrossClusterSearchConnections(CrossClusterSearchConnectionsT&& value) {
  ...
  DescribeInboundCrossClusterSearchConnectionsResult& AddCrossClusterSearchConnections(CrossClusterSearchConnectionsT&& value) {
    m_crossClusterSearchConnectionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInboundCrossClusterSearchConnectionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeInboundCrossClusterSearchConnectionsResult& WithRequestId(RequestIdT&& value) {
