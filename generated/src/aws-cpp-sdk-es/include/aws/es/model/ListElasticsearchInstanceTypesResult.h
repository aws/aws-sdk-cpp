...
class ListElasticsearchInstanceTypesResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API ListElasticsearchInstanceTypesResult& operator=(
  ...
  void SetElasticsearchInstanceTypes(ElasticsearchInstanceTypesT&& value) {
    m_elasticsearchInstanceTypesHasBeenSet = true;
    m_elasticsearchInstanceTypes = std::forward<ElasticsearchInstanceTypesT>(value);
  }
  template <typename ElasticsearchInstanceTypesT = Aws::Vector<ESPartitionInstanceType>>
  ListElasticsearchInstanceTypesResult& WithElasticsearchInstanceTypes(ElasticsearchInstanceTypesT&& value) {
    SetElasticsearchInstanceTypes(std::forward<ElasticsearchInstanceTypesT>(value));
    return *this;
  }
  inline ListElasticsearchInstanceTypesResult& AddElasticsearchInstanceTypes(ESPartitionInstanceType value) {
    m_elasticsearchInstanceTypesHasBeenSet = true;
    m_elasticsearchInstanceTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListElasticsearchInstanceTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListElasticsearchInstanceTypesResult& WithRequestId(RequestIdT&& value) {
