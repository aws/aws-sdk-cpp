...
class ReservedElasticsearchInstance {
 public:
  ...
  void SetReservedElasticsearchInstanceId(ReservedElasticsearchInstanceIdT&& value) {
    ...
    m_reservedElasticsearchInstanceId = std::forward<ReservedElasticsearchInstanceIdT>(value);
  }
  template <typename ReservedElasticsearchInstanceIdT = Aws::String>
  ReservedElasticsearchInstance& WithReservedElasticsearchInstanceId(ReservedElasticsearchInstanceIdT&& value) {
    SetReservedElasticsearchInstanceId(std::forward<ReservedElasticsearchInstanceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReservedElasticsearchInstance& WithElasticsearchInstanceType(ESPartitionInstanceType value) {
  ...
  inline ReservedElasticsearchInstance& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedElasticsearchInstance& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedElasticsearchInstance& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline void SetElasticsearchInstanceCount(int value) {
    m_elasticsearchInstanceCountHasBeenSet = true;
    m_elasticsearchInstanceCount = value;
  }
  inline ReservedElasticsearchInstance& WithElasticsearchInstanceCount(int value) {
    SetElasticsearchInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedElasticsearchInstance& WithPaymentOption(ReservedElasticsearchInstancePaymentOption value) {
