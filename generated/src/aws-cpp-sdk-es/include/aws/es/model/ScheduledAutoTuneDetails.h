...
class ScheduledAutoTuneDetails {
 public:
  ...
  inline void SetActionType(ScheduledAutoTuneActionType value) {
    m_actionTypeHasBeenSet = true;
    m_actionType = value;
  }
  inline ScheduledAutoTuneDetails& WithActionType(ScheduledAutoTuneActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSeverity(ScheduledAutoTuneSeverityType value) {
    m_severityHasBeenSet = true;
    m_severity = value;
  }
  inline ScheduledAutoTuneDetails& WithSeverity(ScheduledAutoTuneSeverityType value) {
    SetSeverity(value);
    return *this;
  }
  ///@}
