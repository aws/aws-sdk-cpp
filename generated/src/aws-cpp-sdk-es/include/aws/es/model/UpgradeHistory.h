...
class UpgradeHistory {
 public:
  ...
  inline void SetUpgradeStatus(UpgradeStatus value) {
    m_upgradeStatusHasBeenSet = true;
    m_upgradeStatus = value;
  }
  inline UpgradeHistory& WithUpgradeStatus(UpgradeStatus value) {
  ...
  void SetStepsList(StepsListT&& value) {
    ...
    m_stepsList = std::forward<StepsListT>(value);
  }
  template <typename StepsListT = Aws::Vector<UpgradeStepItem>>
  UpgradeHistory& WithStepsList(StepsListT&& value) {
    SetStepsList(std::forward<StepsListT>(value));
    return *this;
  }
  template <typename StepsListT = UpgradeStepItem>
  UpgradeHistory& AddStepsList(StepsListT&& value) {
    m_stepsListHasBeenSet = true;
    m_stepsList.emplace_back(std::forward<StepsListT>(value));
    return *this;
  }
  ///@}
 private:
