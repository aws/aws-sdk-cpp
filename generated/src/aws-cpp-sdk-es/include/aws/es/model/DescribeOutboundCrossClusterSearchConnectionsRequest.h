...
class DescribeOutboundCrossClusterSearchConnectionsRequest : public ElasticsearchServiceRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeOutboundCrossClusterSearchConnectionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeOutboundCrossClusterSearchConnectionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeOutboundCrossClusterSearchConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeOutboundCrossClusterSearchConnectionsRequest& WithNextToken(NextTokenT&& value) {
