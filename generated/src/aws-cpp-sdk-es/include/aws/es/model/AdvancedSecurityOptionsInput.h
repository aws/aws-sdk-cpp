...
class AdvancedSecurityOptionsInput {
 public:
  ...
  inline AdvancedSecurityOptionsInput& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline AdvancedSecurityOptionsInput& WithInternalUserDatabaseEnabled(bool value) {
  ...
  inline AdvancedSecurityOptionsInput& WithAnonymousAuthEnabled(bool value) {
