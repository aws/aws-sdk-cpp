...
class ListVpcEndpointAccessRequest : public ElasticsearchServiceRequest {
 public:
  AWS_ELASTICSEARCHSERVICE_API ListVpcEndpointAccessRequest() = default;
  ...
  template <typename DomainNameT = Aws::String>
  ListVpcEndpointAccessRequest& WithDomainName(DomainNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListVpcEndpointAccessRequest& WithNextToken(NextTokenT&& value) {
