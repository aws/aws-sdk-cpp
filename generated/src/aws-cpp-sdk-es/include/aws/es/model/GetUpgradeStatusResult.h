...
class GetUpgradeStatusResult {
 public:
  ...
  inline void SetUpgradeStep(UpgradeStep value) {
    m_upgradeStepHasBeenSet = true;
    m_upgradeStep = value;
  }
  inline GetUpgradeStatusResult& WithUpgradeStep(UpgradeStep value) {
    SetUpgradeStep(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStepStatus(UpgradeStatus value) {
    m_stepStatusHasBeenSet = true;
    m_stepStatus = value;
  }
  inline GetUpgradeStatusResult& WithStepStatus(UpgradeStatus value) {
    SetStepStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetUpgradeName(UpgradeNameT&& value) {
    ...
    m_upgradeName = std::forward<UpgradeNameT>(value);
  }
  template <typename UpgradeNameT = Aws::String>
  GetUpgradeStatusResult& WithUpgradeName(UpgradeNameT&& value) {
    SetUpgradeName(std::forward<UpgradeNameT>(value));
    return *this;
  }
  ///@}
