...
class ServiceSoftwareOptions {
 public:
  ...
  inline ServiceSoftwareOptions& WithUpdateAvailable(bool value) {
  ...
  inline ServiceSoftwareOptions& WithCancellable(bool value) {
  ...
  inline void SetUpdateStatus(DeploymentStatus value) {
    m_updateStatusHasBeenSet = true;
    m_updateStatus = value;
  }
  inline ServiceSoftwareOptions& WithUpdateStatus(DeploymentStatus value) {
  ...
  inline ServiceSoftwareOptions& WithOptionalDeployment(bool value) {
