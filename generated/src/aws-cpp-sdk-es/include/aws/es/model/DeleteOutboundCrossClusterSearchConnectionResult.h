...
class DeleteOutboundCrossClusterSearchConnectionResult {
 public:
  ...
  AWS_ELASTICSEARCHSERVICE_API DeleteOutboundCrossClusterSearchConnectionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename CrossClusterSearchConnectionT = OutboundCrossClusterSearchConnection>
  DeleteOutboundCrossClusterSearchConnectionResult& WithCrossClusterSearchConnection(CrossClusterSearchConnectionT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteOutboundCrossClusterSearchConnectionResult& WithRequestId(RequestIdT&& value) {
