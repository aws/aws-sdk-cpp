...
class AdvancedSecurityOptions {
 public:
  ...
  inline AdvancedSecurityOptions& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInternalUserDatabaseEnabled(bool value) {
    m_internalUserDatabaseEnabledHasBeenSet = true;
    m_internalUserDatabaseEnabled = value;
  }
  inline AdvancedSecurityOptions& WithInternalUserDatabaseEnabled(bool value) {
    SetInternalUserDatabaseEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetSAMLOptions(SAMLOptionsT&& value) {
    ...
    m_sAMLOptions = std::forward<SAMLOptionsT>(value);
  }
  template <typename SAMLOptionsT = SAMLOptionsOutput>
  AdvancedSecurityOptions& WithSAMLOptions(SAMLOptionsT&& value) {
    SetSAMLOptions(std::forward<SAMLOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnonymousAuthDisableDate(AnonymousAuthDisableDateT&& value) {
    ...
    m_anonymousAuthDisableDate = std::forward<AnonymousAuthDisableDateT>(value);
  }
  template <typename AnonymousAuthDisableDateT = Aws::Utils::DateTime>
  AdvancedSecurityOptions& WithAnonymousAuthDisableDate(AnonymousAuthDisableDateT&& value) {
    SetAnonymousAuthDisableDate(std::forward<AnonymousAuthDisableDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnonymousAuthEnabled(bool value) {
    m_anonymousAuthEnabledHasBeenSet = true;
    m_anonymousAuthEnabled = value;
  }
  inline AdvancedSecurityOptions& WithAnonymousAuthEnabled(bool value) {
    SetAnonymousAuthEnabled(value);
    return *this;
  }
  ///@}
 private:
