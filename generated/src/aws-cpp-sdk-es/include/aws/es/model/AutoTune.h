...
class AutoTune {
 public:
  ...
  inline void SetAutoTuneType(AutoTuneType value) {
    m_autoTuneTypeHasBeenSet = true;
    m_autoTuneType = value;
  }
  inline AutoTune& WithAutoTuneType(AutoTuneType value) {
    SetAutoTuneType(value);
    return *this;
  }
  ///@}
  ...
  void SetAutoTuneDetails(AutoTuneDetailsT&& value) {
    ...
    m_autoTuneDetails = std::forward<AutoTuneDetailsT>(value);
  }
  template <typename AutoTuneDetailsT = AutoTuneDetails>
  AutoTune& WithAutoTuneDetails(AutoTuneDetailsT&& value) {
    SetAutoTuneDetails(std::forward<AutoTuneDetailsT>(value));
    return *this;
  }
  ///@}
 private:
