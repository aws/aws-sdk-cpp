...
class PurchaseReservedElasticsearchInstanceOfferingRequest : public ElasticsearchServiceRequest {
 public:
  ...
  template <typename ReservedElasticsearchInstanceOfferingIdT = Aws::String>
  PurchaseReservedElasticsearchInstanceOfferingRequest& WithReservedElasticsearchInstanceOfferingId(
  ...
  template <typename ReservationNameT = Aws::String>
  PurchaseReservedElasticsearchInstanceOfferingRequest& WithReservationName(ReservationNameT&& value) {
  ...
  inline PurchaseReservedElasticsearchInstanceOfferingRequest& WithInstanceCount(int value) {
