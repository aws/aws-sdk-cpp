...
class ElasticsearchDomainStatus {
 public:
  ...
  inline ElasticsearchDomainStatus& WithCreated(bool value) {
    SetCreated(value);
    return *this;
  }
  ///@}
  ...
  inline ElasticsearchDomainStatus& WithDeleted(bool value) {
    SetDeleted(value);
    return *this;
  }
  ///@}
  ...
  inline ElasticsearchDomainStatus& WithProcessing(bool value) {
    SetProcessing(value);
    return *this;
  }
  ///@}
  ...
  inline ElasticsearchDomainStatus& WithUpgradeProcessing(bool value) {
  ...
  inline ElasticsearchDomainStatus& WithDomainProcessingStatus(DomainProcessingStatusType value) {
