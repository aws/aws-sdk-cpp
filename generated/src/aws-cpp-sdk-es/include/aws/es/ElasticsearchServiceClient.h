...
namespace ElasticsearchService
{
   ...
   */
  class AWS_ELASTICSEARCHSERVICE_API ElasticsearchServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<ElasticsearchServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::ElasticsearchService::SERVICE_NAME,
