...
class AWS_ELASTICSEARCHSERVICE_API ElasticsearchServiceError : public Aws::Client::AWSError<ElasticsearchServiceErrors> {
 public:
  ...
  ElasticsearchServiceError(const Aws::Client::AWSError<Aws::Client::CoreErrors>& rhs)
      : Aws::Client::AWSError<ElasticsearchServiceErrors>(rhs) {}
  ElasticsearchServiceError(Aws::Client::AWSError<Aws::Client::CoreErrors>&& rhs)
      : Aws::Client::AWSError<ElasticsearchServiceErrors>(rhs) {}
  ElasticsearchServiceError(const Aws::Client::AWSError<ElasticsearchServiceErrors>& rhs)
      : Aws::Client::AWSError<ElasticsearchServiceErrors>(rhs) {}
  ElasticsearchServiceError(Aws::Client::AWSError<ElasticsearchServiceErrors>&& rhs)
      : Aws::Client::AWSError<ElasticsearchServiceErrors>(rhs) {}
