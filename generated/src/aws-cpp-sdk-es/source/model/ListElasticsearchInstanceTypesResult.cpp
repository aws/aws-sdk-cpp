...
ListElasticsearchInstanceTypesResult& ListElasticsearchInstanceTypesResult::operator=(
  ...
  if (jsonValue.ValueExists("ElasticsearchInstanceTypes")) {
    ...
    for (unsigned elasticsearchInstanceTypesIndex = 0; elasticsearchInstanceTypesIndex < elasticsearchInstanceTypesJsonList.GetLength();
         ++elasticsearchInstanceTypesIndex) {
      m_elasticsearchInstanceTypes.push_back(ESPartitionInstanceTypeMapper::GetESPartitionInstanceTypeForName(
          elasticsearchInstanceTypesJsonList[elasticsearchInstanceTypesIndex].AsString()));
    }
