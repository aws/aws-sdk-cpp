...
DescribeReservedElasticsearchInstancesResult& DescribeReservedElasticsearchInstancesResult::operator=(
  ...
  if (jsonValue.ValueExists("ReservedElasticsearchInstances")) {
    ...
    for (unsigned reservedElasticsearchInstancesIndex = 0;
         reservedElasticsearchInstancesIndex < reservedElasticsearchInstancesJsonList.GetLength(); ++reservedElasticsearchInstancesIndex) {
