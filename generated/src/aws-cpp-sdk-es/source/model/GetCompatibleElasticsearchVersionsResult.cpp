...
GetCompatibleElasticsearchVersionsResult& GetCompatibleElasticsearchVersionsResult::operator=(
  ...
  if (jsonValue.ValueExists("CompatibleElasticsearchVersions")) {
    ...
    for (unsigned compatibleElasticsearchVersionsIndex = 0;
         compatibleElasticsearchVersionsIndex < compatibleElasticsearchVersionsJsonList.GetLength();
         ++compatibleElasticsearchVersionsIndex) {
