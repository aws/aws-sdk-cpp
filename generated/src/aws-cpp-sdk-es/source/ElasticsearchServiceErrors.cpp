...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == DISABLED_OPERATION_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ElasticsearchServiceErrors::INTERNAL), RetryableType::RETRYABLE);
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(ElasticsearchServiceErrors::INVALID_PAGINATION_TOKEN),
