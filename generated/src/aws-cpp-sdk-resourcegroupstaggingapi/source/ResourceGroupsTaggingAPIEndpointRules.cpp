...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','t','a','g','g','i','n','g','-','f','i',
...
't','t','p','s',':','/','/','t','a','g','g','i','n','g','-','f','i','p','s','.','{','R','e','g','i',
...
'/','/','t','a','g','g','i','n','g','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
const char* ResourceGroupsTaggingAPIEndpointRules::GetRulesBlob()
{
