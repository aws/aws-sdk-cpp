...
namespace ResourceGroupsTaggingAPI
{
   ...
   */
  class AWS_RESOURCEGROUPSTAGGINGAPI_API ResourceGroupsTaggingAPIClient : Aws::Client::ClientWithAsyncTemplateMethods<ResourceGroupsTaggingAPIClient>,
    smithy::client::AwsSmithyClientT<Aws::ResourceGroupsTaggingAPI::SERVICE_NAME,
