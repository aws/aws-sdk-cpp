...
class GetComplianceSummaryRequest : public ResourceGroupsTaggingAPIRequest {
 public:
  ...
  void SetTargetIdFilters(TargetIdFiltersT&& value) {
    m_targetIdFiltersHasBeenSet = true;
    m_targetIdFilters = std::forward<TargetIdFiltersT>(value);
  }
  template <typename TargetIdFiltersT = Aws::Vector<Aws::String>>
  GetComplianceSummaryRequest& WithTargetIdFilters(TargetIdFiltersT&& value) {
    SetTargetIdFilters(std::forward<TargetIdFiltersT>(value));
    return *this;
  }
  template <typename TargetIdFiltersT = Aws::String>
  GetComplianceSummaryRequest& AddTargetIdFilters(TargetIdFiltersT&& value) {
    m_targetIdFiltersHasBeenSet = true;
    m_targetIdFilters.emplace_back(std::forward<TargetIdFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegionFilters(RegionFiltersT&& value) {
    m_regionFiltersHasBeenSet = true;
    m_regionFilters = std::forward<RegionFiltersT>(value);
  }
  template <typename RegionFiltersT = Aws::Vector<Aws::String>>
  GetComplianceSummaryRequest& WithRegionFilters(RegionFiltersT&& value) {
    SetRegionFilters(std::forward<RegionFiltersT>(value));
    return *this;
  }
  template <typename RegionFiltersT = Aws::String>
  GetComplianceSummaryRequest& AddRegionFilters(RegionFiltersT&& value) {
    m_regionFiltersHasBeenSet = true;
    m_regionFilters.emplace_back(std::forward<RegionFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceTypeFilters(ResourceTypeFiltersT&& value) {
    m_resourceTypeFiltersHasBeenSet = true;
    m_resourceTypeFilters = std::forward<ResourceTypeFiltersT>(value);
  }
  template <typename ResourceTypeFiltersT = Aws::Vector<Aws::String>>
  GetComplianceSummaryRequest& WithResourceTypeFilters(ResourceTypeFiltersT&& value) {
    SetResourceTypeFilters(std::forward<ResourceTypeFiltersT>(value));
    return *this;
  }
  template <typename ResourceTypeFiltersT = Aws::String>
  GetComplianceSummaryRequest& AddResourceTypeFilters(ResourceTypeFiltersT&& value) {
    m_resourceTypeFiltersHasBeenSet = true;
    m_resourceTypeFilters.emplace_back(std::forward<ResourceTypeFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTagKeyFilters(TagKeyFiltersT&& value) {
    m_tagKeyFiltersHasBeenSet = true;
    m_tagKeyFilters = std::forward<TagKeyFiltersT>(value);
  }
  template <typename TagKeyFiltersT = Aws::Vector<Aws::String>>
  GetComplianceSummaryRequest& WithTagKeyFilters(TagKeyFiltersT&& value) {
    SetTagKeyFilters(std::forward<TagKeyFiltersT>(value));
    return *this;
  }
  template <typename TagKeyFiltersT = Aws::String>
  GetComplianceSummaryRequest& AddTagKeyFilters(TagKeyFiltersT&& value) {
    m_tagKeyFiltersHasBeenSet = true;
    m_tagKeyFilters.emplace_back(std::forward<TagKeyFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename GroupByT = Aws::Vector<GroupByAttribute>>
  GetComplianceSummaryRequest& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  inline GetComplianceSummaryRequest& AddGroupBy(GroupByAttribute value) {
    m_groupByHasBeenSet = true;
  ...
  inline GetComplianceSummaryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename PaginationTokenT = Aws::String>
  GetComplianceSummaryRequest& WithPaginationToken(PaginationTokenT&& value) {
