...
class TagResourcesRequest : public ResourceGroupsTaggingAPIRequest {
 public:
  ...
  template <typename ResourceARNListT = Aws::Vector<Aws::String>>
  TagResourcesRequest& WithResourceARNList(ResourceARNListT&& value) {
    SetResourceARNList(std::forward<ResourceARNListT>(value));
    return *this;
  }
  template <typename ResourceARNListT = Aws::String>
  TagResourcesRequest& AddResourceARNList(ResourceARNListT&& value) {
    m_resourceARNListHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  TagResourcesRequest& WithTags(TagsT&& value) {
