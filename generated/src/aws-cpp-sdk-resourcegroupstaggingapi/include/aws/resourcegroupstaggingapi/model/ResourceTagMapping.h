...
class ResourceTagMapping {
 public:
  ...
  template <typename ResourceARNT = Aws::String>
  ResourceTagMapping& WithResourceARN(ResourceARNT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  ResourceTagMapping& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  ResourceTagMapping& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  void SetComplianceDetails(ComplianceDetailsT&& value) {
    m_complianceDetailsHasBeenSet = true;
    m_complianceDetails = std::forward<ComplianceDetailsT>(value);
  }
  template <typename ComplianceDetailsT = ComplianceDetails>
  ResourceTagMapping& WithComplianceDetails(ComplianceDetailsT&& value) {
    SetComplianceDetails(std::forward<ComplianceDetailsT>(value));
    return *this;
  }
  ///@}
 private:
