...
namespace Model
{
  ...
  public:
    ...
    template<typename FailedResourcesMapT = Aws::Map<Aws::String, FailureInfo>>
    TagResourcesResult& WithFailedResourcesMap(FailedResourcesMapT&& value) { SetFailedResourcesMap(std::forward<FailedResourcesMapT>(value)); return *this;}
    ...
    template<typename RequestIdT = Aws::String>
    TagResourcesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
