...
class ComplianceDetails {
 public:
  ...
  void SetNoncompliantKeys(NoncompliantKeysT&& value) {
    m_noncompliantKeysHasBeenSet = true;
    m_noncompliantKeys = std::forward<NoncompliantKeysT>(value);
  }
  template <typename NoncompliantKeysT = Aws::Vector<Aws::String>>
  ComplianceDetails& WithNoncompliantKeys(NoncompliantKeysT&& value) {
    SetNoncompliantKeys(std::forward<NoncompliantKeysT>(value));
    return *this;
  }
  template <typename NoncompliantKeysT = Aws::String>
  ComplianceDetails& AddNoncompliantKeys(NoncompliantKeysT&& value) {
    m_noncompliantKeysHasBeenSet = true;
    m_noncompliantKeys.emplace_back(std::forward<NoncompliantKeysT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKeysWithNoncompliantValues(KeysWithNoncompliantValuesT&& value) {
    m_keysWithNoncompliantValuesHasBeenSet = true;
    m_keysWithNoncompliantValues = std::forward<KeysWithNoncompliantValuesT>(value);
  }
  template <typename KeysWithNoncompliantValuesT = Aws::Vector<Aws::String>>
  ComplianceDetails& WithKeysWithNoncompliantValues(KeysWithNoncompliantValuesT&& value) {
    SetKeysWithNoncompliantValues(std::forward<KeysWithNoncompliantValuesT>(value));
    return *this;
  }
  template <typename KeysWithNoncompliantValuesT = Aws::String>
  ComplianceDetails& AddKeysWithNoncompliantValues(KeysWithNoncompliantValuesT&& value) {
    m_keysWithNoncompliantValuesHasBeenSet = true;
    m_keysWithNoncompliantValues.emplace_back(std::forward<KeysWithNoncompliantValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetComplianceStatus(bool value) {
    m_complianceStatusHasBeenSet = true;
    m_complianceStatus = value;
  }
  inline ComplianceDetails& WithComplianceStatus(bool value) {
