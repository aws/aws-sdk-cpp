...
class GetResourcesResult {
 public:
  ...
  template <typename PaginationTokenT = Aws::String>
  GetResourcesResult& WithPaginationToken(PaginationTokenT&& value) {
  ...
  void SetResourceTagMappingList(ResourceTagMappingListT&& value) {
    m_resourceTagMappingListHasBeenSet = true;
    m_resourceTagMappingList = std::forward<ResourceTagMappingListT>(value);
  }
  template <typename ResourceTagMappingListT = Aws::Vector<ResourceTagMapping>>
  GetResourcesResult& WithResourceTagMappingList(ResourceTagMappingListT&& value) {
    SetResourceTagMappingList(std::forward<ResourceTagMappingListT>(value));
    return *this;
  }
  template <typename ResourceTagMappingListT = ResourceTagMapping>
  GetResourcesResult& AddResourceTagMappingList(ResourceTagMappingListT&& value) {
    m_resourceTagMappingListHasBeenSet = true;
    m_resourceTagMappingList.emplace_back(std::forward<ResourceTagMappingListT>(value));
    return *this;
  }
  ///@}
