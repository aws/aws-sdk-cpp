...
class GetTagKeysResult {
 public:
  ...
  template <typename PaginationTokenT = Aws::String>
  GetTagKeysResult& WithPaginationToken(PaginationTokenT&& value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  GetTagKeysResult& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  GetTagKeysResult& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GetTagKeysResult& WithRequestId(RequestIdT&& value) {
