...
class DescribeReportCreationResult {
 public:
  ...
  AWS_RESOURCEGROUPSTAGGINGAPI_API DescribeReportCreationResult& operator=(
  ...
  template <typename StatusT = Aws::String>
  DescribeReportCreationResult& WithStatus(StatusT&& value) {
  ...
  template <typename S3LocationT = Aws::String>
  DescribeReportCreationResult& WithS3Location(S3LocationT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  DescribeReportCreationResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReportCreationResult& WithRequestId(RequestIdT&& value) {
