...
class UntagResourcesRequest : public ResourceGroupsTaggingAPIRequest {
 public:
  ...
  template <typename ResourceARNListT = Aws::Vector<Aws::String>>
  UntagResourcesRequest& WithResourceARNList(ResourceARNListT&& value) {
    SetResourceARNList(std::forward<ResourceARNListT>(value));
    return *this;
  }
  template <typename ResourceARNListT = Aws::String>
  UntagResourcesRequest& AddResourceARNList(ResourceARNListT&& value) {
    m_resourceARNListHasBeenSet = true;
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  UntagResourcesRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  UntagResourcesRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
