...
SearchDiscoverableRegistryRecordsResult::SearchDiscoverableRegistryRecordsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

SearchDiscoverableRegistryRecordsResult& SearchDiscoverableRegistryRecordsResult::operator=(
