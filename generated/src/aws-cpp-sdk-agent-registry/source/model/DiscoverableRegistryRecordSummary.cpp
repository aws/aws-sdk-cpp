...
DiscoverableRegistryRecordSummary::DiscoverableRegistryRecordSummary(JsonView jsonValue) { *this = jsonValue; }

DiscoverableRegistryRecordSummary& DiscoverableRegistryRecordSummary::operator=(JsonView jsonValue) {
...
JsonValue DiscoverableRegistryRecordSummary::Jsonize() const {
  JsonValue payload;
