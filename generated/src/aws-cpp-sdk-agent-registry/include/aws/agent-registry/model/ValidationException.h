 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/ValidationException">AWS
 * API Reference</a></p>
 */
class ValidationException {
 public:
  AWS_AGENTREGISTRY_API ValidationException() = default;
  AWS_AGENTREGISTRY_API ValidationException(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API ValidationException& operator=(Aws::Utils::Json::JsonView jsonValue);
