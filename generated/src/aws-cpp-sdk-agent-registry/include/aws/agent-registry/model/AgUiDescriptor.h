...
/**
 * <p> A descriptor for a registry record that exposes an AG-UI protocol endpoint.
 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/AgUiDescriptor">AWS
 * API Reference</a></p>
 */
class AgUiDescriptor {
 public:
  AWS_AGENTREGISTRY_API AgUiDescriptor() = default;
  AWS_AGENTREGISTRY_API AgUiDescriptor(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API AgUiDescriptor& operator=(Aws::Utils::Json::JsonView jsonValue);
