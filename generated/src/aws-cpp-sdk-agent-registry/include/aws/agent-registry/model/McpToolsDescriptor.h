 ...
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/McpToolsDescriptor">AWS
 * API Reference</a></p>
 */
class McpToolsDescriptor {
 public:
  AWS_AGENTREGISTRY_API McpToolsDescriptor() = default;
  AWS_AGENTREGISTRY_API McpToolsDescriptor(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API McpToolsDescriptor& operator=(Aws::Utils::Json::JsonView jsonValue);
