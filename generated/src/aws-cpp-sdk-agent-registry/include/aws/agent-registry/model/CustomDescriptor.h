 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/CustomDescriptor">AWS
 * API Reference</a></p>
 */
class CustomDescriptor {
 public:
  AWS_AGENTREGISTRY_API CustomDescriptor() = default;
  AWS_AGENTREGISTRY_API CustomDescriptor(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API CustomDescriptor& operator=(Aws::Utils::Json::JsonView jsonValue);
