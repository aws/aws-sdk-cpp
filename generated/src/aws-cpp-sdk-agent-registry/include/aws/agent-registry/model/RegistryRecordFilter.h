...
/**
 * <p> A single filter applied to a <code>ListDiscoverableRegistryRecords</code>
 * request.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/RegistryRecordFilter">AWS
 * API Reference</a></p>
 */
class RegistryRecordFilter {
 public:
  AWS_AGENTREGISTRY_API RegistryRecordFilter() = default;
  AWS_AGENTREGISTRY_API RegistryRecordFilter(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API RegistryRecordFilter& operator=(Aws::Utils::Json::JsonView jsonValue);
