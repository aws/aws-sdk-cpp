 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/agent-registry-2025-12-01/McpServerAdditionalData">AWS
 * API Reference</a></p>
 */
class McpServerAdditionalData {
 public:
  AWS_AGENTREGISTRY_API McpServerAdditionalData() = default;
  AWS_AGENTREGISTRY_API McpServerAdditionalData(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGENTREGISTRY_API McpServerAdditionalData& operator=(Aws::Utils::Json::JsonView jsonValue);
