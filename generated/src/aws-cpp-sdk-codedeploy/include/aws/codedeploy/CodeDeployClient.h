...
class AWS_CODEDEPLOY_API CodeDeployClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeDeployClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CodeDeployEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CodeDeploy::CodeDeployClientConfiguration& clientConfiguration = Aws::CodeDeploy::CodeDeployClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AddTagsToOnPremisesInstancesOutcome AddTagsToOnPremisesInstances(
      const Model::AddTagsToOnPremisesInstancesRequest& request) const;

  /**
   * A Callable wrapper for AddTagsToOnPremisesInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AddTagsToOnPremisesInstancesRequestT = Model::AddTagsToOnPremisesInstancesRequest>
  Model::AddTagsToOnPremisesInstancesOutcomeCallable AddTagsToOnPremisesInstancesCallable(
      const AddTagsToOnPremisesInstancesRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::AddTagsToOnPremisesInstances, request);
  }

  /**
   * An Async wrapper for AddTagsToOnPremisesInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddTagsToOnPremisesInstancesRequestT = Model::AddTagsToOnPremisesInstancesRequest>
  void AddTagsToOnPremisesInstancesAsync(const AddTagsToOnPremisesInstancesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetApplicationRevisionsOutcome BatchGetApplicationRevisions(
      const Model::BatchGetApplicationRevisionsRequest& request) const;

  /**
   * A Callable wrapper for BatchGetApplicationRevisions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetApplicationRevisionsRequestT = Model::BatchGetApplicationRevisionsRequest>
  Model::BatchGetApplicationRevisionsOutcomeCallable BatchGetApplicationRevisionsCallable(
      const BatchGetApplicationRevisionsRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::BatchGetApplicationRevisions, request);
  }

  /**
   * An Async wrapper for BatchGetApplicationRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetApplicationRevisionsRequestT = Model::BatchGetApplicationRevisionsRequest>
  void BatchGetApplicationRevisionsAsync(const BatchGetApplicationRevisionsRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchGetApplications that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetApplications that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetApplicationsRequestT = Model::BatchGetApplicationsRequest>
  void BatchGetApplicationsAsync(const BatchGetApplicationsRequestT& request, const BatchGetApplicationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetDeploymentGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetDeploymentGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDeploymentGroupsRequestT = Model::BatchGetDeploymentGroupsRequest>
  void BatchGetDeploymentGroupsAsync(const BatchGetDeploymentGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for BatchGetDeploymentTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchGetDeploymentTargetsRequestT = Model::BatchGetDeploymentTargetsRequest>
  Model::BatchGetDeploymentTargetsOutcomeCallable BatchGetDeploymentTargetsCallable(
      const BatchGetDeploymentTargetsRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::BatchGetDeploymentTargets, request);
  }

  /**
   * An Async wrapper for BatchGetDeploymentTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetDeploymentTargetsRequestT = Model::BatchGetDeploymentTargetsRequest>
  void BatchGetDeploymentTargetsAsync(const BatchGetDeploymentTargetsRequestT& request,
                                      const BatchGetDeploymentTargetsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetDeployments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetDeployments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchGetDeploymentsRequestT = Model::BatchGetDeploymentsRequest>
  void BatchGetDeploymentsAsync(const BatchGetDeploymentsRequestT& request, const BatchGetDeploymentsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetOnPremisesInstancesOutcome BatchGetOnPremisesInstances(
      const Model::BatchGetOnPremisesInstancesRequest& request) const;

  /**
   * A Callable wrapper for BatchGetOnPremisesInstances that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetOnPremisesInstancesRequestT = Model::BatchGetOnPremisesInstancesRequest>
  Model::BatchGetOnPremisesInstancesOutcomeCallable BatchGetOnPremisesInstancesCallable(
      const BatchGetOnPremisesInstancesRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::BatchGetOnPremisesInstances, request);
  }

  /**
   * An Async wrapper for BatchGetOnPremisesInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetOnPremisesInstancesRequestT = Model::BatchGetOnPremisesInstancesRequest>
  void BatchGetOnPremisesInstancesAsync(const BatchGetOnPremisesInstancesRequestT& request,
  ...
  /**
   * A Callable wrapper for ContinueDeployment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ContinueDeployment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ContinueDeploymentRequestT = Model::ContinueDeploymentRequest>
  void ContinueDeploymentAsync(const ContinueDeploymentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ContinueDeploymentRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateDeploymentConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeploymentConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDeploymentConfigRequestT = Model::CreateDeploymentConfigRequest>
  void CreateDeploymentConfigAsync(const CreateDeploymentConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDeploymentGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeploymentGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDeploymentGroupRequestT = Model::CreateDeploymentGroupRequest>
  void CreateDeploymentGroupAsync(const CreateDeploymentGroupRequestT& request, const CreateDeploymentGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDeploymentConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeploymentConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDeploymentConfigRequestT = Model::DeleteDeploymentConfigRequest>
  void DeleteDeploymentConfigAsync(const DeleteDeploymentConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDeploymentGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeploymentGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDeploymentGroupRequestT = Model::DeleteDeploymentGroupRequest>
  void DeleteDeploymentGroupAsync(const DeleteDeploymentGroupRequestT& request, const DeleteDeploymentGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteGitHubAccountToken that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteGitHubAccountTokenRequestT = Model::DeleteGitHubAccountTokenRequest>
  Model::DeleteGitHubAccountTokenOutcomeCallable DeleteGitHubAccountTokenCallable(
      const DeleteGitHubAccountTokenRequestT& request = {}) const {
    return SubmitCallable(&CodeDeployClient::DeleteGitHubAccountToken, request);
  }

  /**
   * An Async wrapper for DeleteGitHubAccountToken that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteGitHubAccountTokenRequestT = Model::DeleteGitHubAccountTokenRequest>
  void DeleteGitHubAccountTokenAsync(const DeleteGitHubAccountTokenResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DeleteGitHubAccountTokenRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteResourcesByExternalIdOutcome DeleteResourcesByExternalId(
      const Model::DeleteResourcesByExternalIdRequest& request = {}) const;

  /**
   * A Callable wrapper for DeleteResourcesByExternalId that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteResourcesByExternalIdRequestT = Model::DeleteResourcesByExternalIdRequest>
  Model::DeleteResourcesByExternalIdOutcomeCallable DeleteResourcesByExternalIdCallable(
      const DeleteResourcesByExternalIdRequestT& request = {}) const {
    return SubmitCallable(&CodeDeployClient::DeleteResourcesByExternalId, request);
  }

  /**
   * An Async wrapper for DeleteResourcesByExternalId that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourcesByExternalIdRequestT = Model::DeleteResourcesByExternalIdRequest>
  void DeleteResourcesByExternalIdAsync(const DeleteResourcesByExternalIdResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DeleteResourcesByExternalIdRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterOnPremisesInstanceOutcome DeregisterOnPremisesInstance(
      const Model::DeregisterOnPremisesInstanceRequest& request) const;

  /**
   * A Callable wrapper for DeregisterOnPremisesInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterOnPremisesInstanceRequestT = Model::DeregisterOnPremisesInstanceRequest>
  Model::DeregisterOnPremisesInstanceOutcomeCallable DeregisterOnPremisesInstanceCallable(
      const DeregisterOnPremisesInstanceRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::DeregisterOnPremisesInstance, request);
  }

  /**
   * An Async wrapper for DeregisterOnPremisesInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterOnPremisesInstanceRequestT = Model::DeregisterOnPremisesInstanceRequest>
  void DeregisterOnPremisesInstanceAsync(const DeregisterOnPremisesInstanceRequestT& request,
  ...
  /**
   * A Callable wrapper for GetApplicationRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetApplicationRevision that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetApplicationRevisionRequestT = Model::GetApplicationRevisionRequest>
  void GetApplicationRevisionAsync(const GetApplicationRevisionRequestT& request,
  ...
  /**
   * A Callable wrapper for GetDeploymentConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeploymentConfig that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeploymentConfigRequestT = Model::GetDeploymentConfigRequest>
  void GetDeploymentConfigAsync(const GetDeploymentConfigRequestT& request, const GetDeploymentConfigResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDeploymentGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeploymentGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeploymentGroupRequestT = Model::GetDeploymentGroupRequest>
  void GetDeploymentGroupAsync(const GetDeploymentGroupRequestT& request, const GetDeploymentGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDeploymentTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeploymentTarget that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDeploymentTargetRequestT = Model::GetDeploymentTargetRequest>
  void GetDeploymentTargetAsync(const GetDeploymentTargetRequestT& request, const GetDeploymentTargetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOnPremisesInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOnPremisesInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOnPremisesInstanceRequestT = Model::GetOnPremisesInstanceRequest>
  void GetOnPremisesInstanceAsync(const GetOnPremisesInstanceRequestT& request, const GetOnPremisesInstanceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListApplicationRevisions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListApplicationRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListApplicationRevisionsRequestT = Model::ListApplicationRevisionsRequest>
  void ListApplicationRevisionsAsync(const ListApplicationRevisionsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListDeploymentConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeploymentConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeploymentConfigsRequestT = Model::ListDeploymentConfigsRequest>
  void ListDeploymentConfigsAsync(const ListDeploymentConfigsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDeploymentConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDeploymentGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeploymentGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeploymentGroupsRequestT = Model::ListDeploymentGroupsRequest>
  void ListDeploymentGroupsAsync(const ListDeploymentGroupsRequestT& request, const ListDeploymentGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDeploymentTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeploymentTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeploymentTargetsRequestT = Model::ListDeploymentTargetsRequest>
  void ListDeploymentTargetsAsync(const ListDeploymentTargetsRequestT& request, const ListDeploymentTargetsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListGitHubAccountTokenNamesOutcome ListGitHubAccountTokenNames(
      const Model::ListGitHubAccountTokenNamesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListGitHubAccountTokenNames that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListGitHubAccountTokenNamesRequestT = Model::ListGitHubAccountTokenNamesRequest>
  Model::ListGitHubAccountTokenNamesOutcomeCallable ListGitHubAccountTokenNamesCallable(
      const ListGitHubAccountTokenNamesRequestT& request = {}) const {
    return SubmitCallable(&CodeDeployClient::ListGitHubAccountTokenNames, request);
  }

  /**
   * An Async wrapper for ListGitHubAccountTokenNames that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListGitHubAccountTokenNamesRequestT = Model::ListGitHubAccountTokenNamesRequest>
  void ListGitHubAccountTokenNamesAsync(const ListGitHubAccountTokenNamesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListGitHubAccountTokenNamesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOnPremisesInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOnPremisesInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOnPremisesInstancesRequestT = Model::ListOnPremisesInstancesRequest>
  void ListOnPremisesInstancesAsync(const ListOnPremisesInstancesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListOnPremisesInstancesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutLifecycleEventHookExecutionStatusOutcome PutLifecycleEventHookExecutionStatus(
      const Model::PutLifecycleEventHookExecutionStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for PutLifecycleEventHookExecutionStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename PutLifecycleEventHookExecutionStatusRequestT = Model::PutLifecycleEventHookExecutionStatusRequest>
  Model::PutLifecycleEventHookExecutionStatusOutcomeCallable PutLifecycleEventHookExecutionStatusCallable(
      const PutLifecycleEventHookExecutionStatusRequestT& request = {}) const {
    return SubmitCallable(&CodeDeployClient::PutLifecycleEventHookExecutionStatus, request);
  }

  /**
   * An Async wrapper for PutLifecycleEventHookExecutionStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename PutLifecycleEventHookExecutionStatusRequestT = Model::PutLifecycleEventHookExecutionStatusRequest>
  void PutLifecycleEventHookExecutionStatusAsync(const PutLifecycleEventHookExecutionStatusResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const PutLifecycleEventHookExecutionStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterApplicationRevisionOutcome RegisterApplicationRevision(
      const Model::RegisterApplicationRevisionRequest& request) const;

  /**
   * A Callable wrapper for RegisterApplicationRevision that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterApplicationRevisionRequestT = Model::RegisterApplicationRevisionRequest>
  Model::RegisterApplicationRevisionOutcomeCallable RegisterApplicationRevisionCallable(
      const RegisterApplicationRevisionRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::RegisterApplicationRevision, request);
  }

  /**
   * An Async wrapper for RegisterApplicationRevision that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterApplicationRevisionRequestT = Model::RegisterApplicationRevisionRequest>
  void RegisterApplicationRevisionAsync(const RegisterApplicationRevisionRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RegisterOnPremisesInstanceOutcome RegisterOnPremisesInstance(
      const Model::RegisterOnPremisesInstanceRequest& request) const;

  /**
   * A Callable wrapper for RegisterOnPremisesInstance that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RegisterOnPremisesInstanceRequestT = Model::RegisterOnPremisesInstanceRequest>
  Model::RegisterOnPremisesInstanceOutcomeCallable RegisterOnPremisesInstanceCallable(
      const RegisterOnPremisesInstanceRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::RegisterOnPremisesInstance, request);
  }

  /**
   * An Async wrapper for RegisterOnPremisesInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterOnPremisesInstanceRequestT = Model::RegisterOnPremisesInstanceRequest>
  void RegisterOnPremisesInstanceAsync(const RegisterOnPremisesInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveTagsFromOnPremisesInstancesOutcome RemoveTagsFromOnPremisesInstances(
      const Model::RemoveTagsFromOnPremisesInstancesRequest& request) const;

  /**
   * A Callable wrapper for RemoveTagsFromOnPremisesInstances that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RemoveTagsFromOnPremisesInstancesRequestT = Model::RemoveTagsFromOnPremisesInstancesRequest>
  Model::RemoveTagsFromOnPremisesInstancesOutcomeCallable RemoveTagsFromOnPremisesInstancesCallable(
      const RemoveTagsFromOnPremisesInstancesRequestT& request) const {
    return SubmitCallable(&CodeDeployClient::RemoveTagsFromOnPremisesInstances, request);
  }

  /**
   * An Async wrapper for RemoveTagsFromOnPremisesInstances that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RemoveTagsFromOnPremisesInstancesRequestT = Model::RemoveTagsFromOnPremisesInstancesRequest>
  void RemoveTagsFromOnPremisesInstancesAsync(const RemoveTagsFromOnPremisesInstancesRequestT& request,
   ...
   */
  template <typename UpdateApplicationRequestT = Model::UpdateApplicationRequest>
  void UpdateApplicationAsync(const UpdateApplicationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const UpdateApplicationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateDeploymentGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDeploymentGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateDeploymentGroupRequestT = Model::UpdateDeploymentGroupRequest>
  void UpdateDeploymentGroupAsync(const UpdateDeploymentGroupRequestT& request, const UpdateDeploymentGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
