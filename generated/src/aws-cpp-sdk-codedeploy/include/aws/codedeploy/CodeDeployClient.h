...
namespace CodeDeploy
{
   ...
   * Forum</a> </p> </li> </ul>
   */
  class AWS_CODEDEPLOY_API CodeDeployClient : Aws::Client::ClientWithAsyncTemplateMethods<CodeDeployClient>,
    smithy::client::AwsSmithyClientT<Aws::CodeDeploy::SERVICE_NAME,
