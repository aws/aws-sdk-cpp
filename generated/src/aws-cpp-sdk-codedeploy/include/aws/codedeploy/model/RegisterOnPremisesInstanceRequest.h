...
class RegisterOnPremisesInstanceRequest : public CodeDeployRequest {
 public:
  ...
  template <typename InstanceNameT = Aws::String>
  RegisterOnPremisesInstanceRequest& WithInstanceName(InstanceNameT&& value) {
  ...
  template <typename IamSessionArnT = Aws::String>
  RegisterOnPremisesInstanceRequest& WithIamSessionArn(IamSessionArnT&& value) {
  ...
  template <typename IamUserArnT = Aws::String>
  RegisterOnPremisesInstanceRequest& WithIamUserArn(IamUserArnT&& value) {
