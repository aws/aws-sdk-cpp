...
namespace Model
{
  ...
  {
  public:
    AWS_CODEDEPLOY_API GetDeploymentGroupRequest() = default;
    ...
    template<typename ApplicationNameT = Aws::String>
    GetDeploymentGroupRequest& WithApplicationName(ApplicationNameT&& value) { SetApplicationName(std::forward<ApplicationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DeploymentGroupNameT = Aws::String>
    GetDeploymentGroupRequest& WithDeploymentGroupName(DeploymentGroupNameT&& value) { SetDeploymentGroupName(std::forward<DeploymentGroupNameT>(value)); return *this;}
    ///@}
  private:
