...
namespace Model
{
  ...
  {
  public:
    AWS_CODEDEPLOY_API GetApplicationRequest() = default;
    ...
    template<typename ApplicationNameT = Aws::String>
    GetApplicationRequest& WithApplicationName(ApplicationNameT&& value) { SetApplicationName(std::forward<ApplicationNameT>(value)); return *this;}
    ///@}
  private:
