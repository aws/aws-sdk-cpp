...
class ListDeploymentConfigsResult {
 public:
  ...
  void SetDeploymentConfigsList(DeploymentConfigsListT&& value) {
    ...
    m_deploymentConfigsList = std::forward<DeploymentConfigsListT>(value);
  }
  template <typename DeploymentConfigsListT = Aws::Vector<Aws::String>>
  ListDeploymentConfigsResult& WithDeploymentConfigsList(DeploymentConfigsListT&& value) {
    SetDeploymentConfigsList(std::forward<DeploymentConfigsListT>(value));
    return *this;
  }
  ...
  ListDeploymentConfigsResult& AddDeploymentConfigsList(DeploymentConfigsListT&& value) {
    m_deploymentConfigsListHasBeenSet = true;
    m_deploymentConfigsList.emplace_back(std::forward<DeploymentConfigsListT>(value));
    return *this;
  }
  ///@}
