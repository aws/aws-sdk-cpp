...
class ApplicationInfo {
 public:
  ...
  inline void SetLinkedToGitHub(bool value) {
    m_linkedToGitHubHasBeenSet = true;
    m_linkedToGitHub = value;
  }
  inline ApplicationInfo& WithLinkedToGitHub(bool value) {
    SetLinkedToGitHub(value);
    return *this;
  }
  ///@}
  ...
  void SetGitHubAccountName(GitHubAccountNameT&& value) {
    ...
    m_gitHubAccountName = std::forward<GitHubAccountNameT>(value);
  }
  template <typename GitHubAccountNameT = Aws::String>
  ApplicationInfo& WithGitHubAccountName(GitHubAccountNameT&& value) {
    SetGitHubAccountName(std::forward<GitHubAccountNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ApplicationInfo& WithComputePlatform(ComputePlatform value) {
