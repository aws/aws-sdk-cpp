...
class DeploymentStyle {
 public:
  ...
  inline DeploymentStyle& WithDeploymentType(DeploymentType value) {
  ...
  inline void SetDeploymentOption(DeploymentOption value) {
    m_deploymentOptionHasBeenSet = true;
    m_deploymentOption = value;
  }
  inline DeploymentStyle& WithDeploymentOption(DeploymentOption value) {
