...
class PutLifecycleEventHookExecutionStatusResult {
 public:
  ...
  AWS_CODEDEPLOY_API PutLifecycleEventHookExecutionStatusResult& operator=(
  ...
  template <typename LifecycleEventHookExecutionIdT = Aws::String>
  PutLifecycleEventHookExecutionStatusResult& WithLifecycleEventHookExecutionId(LifecycleEventHookExecutionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutLifecycleEventHookExecutionStatusResult& WithRequestId(RequestIdT&& value) {
