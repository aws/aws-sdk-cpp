...
class BatchGetApplicationRevisionsRequest : public CodeDeployRequest {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  BatchGetApplicationRevisionsRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename RevisionsT = Aws::Vector<RevisionLocation>>
  BatchGetApplicationRevisionsRequest& WithRevisions(RevisionsT&& value) {
    SetRevisions(std::forward<RevisionsT>(value));
    return *this;
  }
  template <typename RevisionsT = RevisionLocation>
  BatchGetApplicationRevisionsRequest& AddRevisions(RevisionsT&& value) {
    m_revisionsHasBeenSet = true;
