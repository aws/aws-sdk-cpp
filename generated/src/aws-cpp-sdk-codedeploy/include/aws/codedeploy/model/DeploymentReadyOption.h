...
class DeploymentReadyOption {
 public:
  ...
  inline void SetActionOnTimeout(DeploymentReadyAction value) {
    m_actionOnTimeoutHasBeenSet = true;
    m_actionOnTimeout = value;
  }
  inline DeploymentReadyOption& WithActionOnTimeout(DeploymentReadyAction value) {
    SetActionOnTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWaitTimeInMinutes(int value) {
    m_waitTimeInMinutesHasBeenSet = true;
    m_waitTimeInMinutes = value;
  }
  inline DeploymentReadyOption& WithWaitTimeInMinutes(int value) {
