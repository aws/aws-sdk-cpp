...
class PutLifecycleEventHookExecutionStatusRequest : public CodeDeployRequest {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  PutLifecycleEventHookExecutionStatusRequest& WithDeploymentId(DeploymentIdT&& value) {
  ...
  void SetLifecycleEventHookExecutionId(LifecycleEventHookExecutionIdT&& value) {
    m_lifecycleEventHookExecutionIdHasBeenSet = true;
    m_lifecycleEventHookExecutionId = std::forward<LifecycleEventHookExecutionIdT>(value);
  }
  template <typename LifecycleEventHookExecutionIdT = Aws::String>
  PutLifecycleEventHookExecutionStatusRequest& WithLifecycleEventHookExecutionId(LifecycleEventHookExecutionIdT&& value) {
    SetLifecycleEventHookExecutionId(std::forward<LifecycleEventHookExecutionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(LifecycleEventStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PutLifecycleEventHookExecutionStatusRequest& WithStatus(LifecycleEventStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
