...
class RollbackInfo {
 public:
  ...
  void SetRollbackDeploymentId(RollbackDeploymentIdT&& value) {
    ...
    m_rollbackDeploymentId = std::forward<RollbackDeploymentIdT>(value);
  }
  template <typename RollbackDeploymentIdT = Aws::String>
  RollbackInfo& WithRollbackDeploymentId(RollbackDeploymentIdT&& value) {
    SetRollbackDeploymentId(std::forward<RollbackDeploymentIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollbackTriggeringDeploymentId(RollbackTriggeringDeploymentIdT&& value) {
    ...
    m_rollbackTriggeringDeploymentId = std::forward<RollbackTriggeringDeploymentIdT>(value);
  }
  template <typename RollbackTriggeringDeploymentIdT = Aws::String>
  RollbackInfo& WithRollbackTriggeringDeploymentId(RollbackTriggeringDeploymentIdT&& value) {
    SetRollbackTriggeringDeploymentId(std::forward<RollbackTriggeringDeploymentIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollbackMessage(RollbackMessageT&& value) {
    ...
    m_rollbackMessage = std::forward<RollbackMessageT>(value);
  }
  template <typename RollbackMessageT = Aws::String>
  RollbackInfo& WithRollbackMessage(RollbackMessageT&& value) {
    SetRollbackMessage(std::forward<RollbackMessageT>(value));
    return *this;
  }
  ///@}
 private:
