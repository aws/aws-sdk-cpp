...
class InstanceTarget {
 public:
  ...
  inline InstanceTarget& WithStatus(TargetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceLabel(TargetLabel value) {
    m_instanceLabelHasBeenSet = true;
    m_instanceLabel = value;
  }
  inline InstanceTarget& WithInstanceLabel(TargetLabel value) {
