...
class BatchGetDeploymentGroupsRequest : public CodeDeployRequest {
 public:
  ...
  void SetDeploymentGroupNames(DeploymentGroupNamesT&& value) {
    m_deploymentGroupNamesHasBeenSet = true;
    m_deploymentGroupNames = std::forward<DeploymentGroupNamesT>(value);
  }
  template <typename DeploymentGroupNamesT = Aws::Vector<Aws::String>>
  BatchGetDeploymentGroupsRequest& WithDeploymentGroupNames(DeploymentGroupNamesT&& value) {
    SetDeploymentGroupNames(std::forward<DeploymentGroupNamesT>(value));
    return *this;
  }
  ...
  BatchGetDeploymentGroupsRequest& AddDeploymentGroupNames(DeploymentGroupNamesT&& value) {
    m_deploymentGroupNamesHasBeenSet = true;
    m_deploymentGroupNames.emplace_back(std::forward<DeploymentGroupNamesT>(value));
    return *this;
  }
  ///@}
 private:
