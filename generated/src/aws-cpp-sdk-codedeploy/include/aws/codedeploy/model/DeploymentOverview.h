...
class DeploymentOverview {
 public:
  ...
  inline DeploymentOverview& WithPending(long long value) {
    SetPending(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInProgress(long long value) {
    m_inProgressHasBeenSet = true;
    m_inProgress = value;
  }
  inline DeploymentOverview& WithInProgress(long long value) {
    SetInProgress(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentOverview& WithSucceeded(long long value) {
    SetSucceeded(value);
    return *this;
  }
  ///@}
  ...
  inline DeploymentOverview& WithFailed(long long value) {
    SetFailed(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSkipped(long long value) {
    m_skippedHasBeenSet = true;
    m_skipped = value;
  }
  inline DeploymentOverview& WithSkipped(long long value) {
    SetSkipped(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReady(long long value) {
    m_readyHasBeenSet = true;
    m_ready = value;
  }
  inline DeploymentOverview& WithReady(long long value) {
    SetReady(value);
    return *this;
  }
  ///@}
