...
class UpdateDeploymentGroupResult {
 public:
  ...
  template <typename HooksNotCleanedUpT = Aws::Vector<AutoScalingGroup>>
  UpdateDeploymentGroupResult& WithHooksNotCleanedUp(HooksNotCleanedUpT&& value) {
    SetHooksNotCleanedUp(std::forward<HooksNotCleanedUpT>(value));
    return *this;
  }
  template <typename HooksNotCleanedUpT = AutoScalingGroup>
  UpdateDeploymentGroupResult& AddHooksNotCleanedUp(HooksNotCleanedUpT&& value) {
    m_hooksNotCleanedUpHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  UpdateDeploymentGroupResult& WithRequestId(RequestIdT&& value) {
