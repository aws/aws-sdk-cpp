...
class LifecycleEvent {
 public:
  ...
  void SetLifecycleEventName(LifecycleEventNameT&& value) {
    ...
    m_lifecycleEventName = std::forward<LifecycleEventNameT>(value);
  }
  template <typename LifecycleEventNameT = Aws::String>
  LifecycleEvent& WithLifecycleEventName(LifecycleEventNameT&& value) {
    SetLifecycleEventName(std::forward<LifecycleEventNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDiagnostics(DiagnosticsT&& value) {
    ...
    m_diagnostics = std::forward<DiagnosticsT>(value);
  }
  template <typename DiagnosticsT = Diagnostics>
  LifecycleEvent& WithDiagnostics(DiagnosticsT&& value) {
    SetDiagnostics(std::forward<DiagnosticsT>(value));
    return *this;
  }
  ///@}
  ...
  inline LifecycleEvent& WithStatus(LifecycleEventStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
