...
class BatchGetApplicationsRequest : public CodeDeployRequest {
 public:
  ...
  void SetApplicationNames(ApplicationNamesT&& value) {
    m_applicationNamesHasBeenSet = true;
    m_applicationNames = std::forward<ApplicationNamesT>(value);
  }
  template <typename ApplicationNamesT = Aws::Vector<Aws::String>>
  BatchGetApplicationsRequest& WithApplicationNames(ApplicationNamesT&& value) {
    SetApplicationNames(std::forward<ApplicationNamesT>(value));
    return *this;
  }
  template <typename ApplicationNamesT = Aws::String>
  BatchGetApplicationsRequest& AddApplicationNames(ApplicationNamesT&& value) {
    m_applicationNamesHasBeenSet = true;
    m_applicationNames.emplace_back(std::forward<ApplicationNamesT>(value));
    return *this;
  }
  ///@}
 private:
