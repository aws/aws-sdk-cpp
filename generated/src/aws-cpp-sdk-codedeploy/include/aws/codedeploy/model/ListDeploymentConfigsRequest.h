...
namespace Model
{
  ...
  {
  public:
    AWS_CODEDEPLOY_API ListDeploymentConfigsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListDeploymentConfigsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
