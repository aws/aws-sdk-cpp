...
class ListApplicationRevisionsRequest : public CodeDeployRequest {
 public:
  ...
  inline void SetSortBy(ApplicationRevisionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListApplicationRevisionsRequest& WithSortBy(ApplicationRevisionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListApplicationRevisionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDeployed(ListStateFilterAction value) {
    m_deployedHasBeenSet = true;
    m_deployed = value;
  }
  inline ListApplicationRevisionsRequest& WithDeployed(ListStateFilterAction value) {
    SetDeployed(value);
    return *this;
  }
  ///@}
