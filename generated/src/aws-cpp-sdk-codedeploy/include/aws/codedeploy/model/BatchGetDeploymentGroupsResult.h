...
class BatchGetDeploymentGroupsResult {
 public:
  ...
  void SetDeploymentGroupsInfo(DeploymentGroupsInfoT&& value) {
    ...
    m_deploymentGroupsInfo = std::forward<DeploymentGroupsInfoT>(value);
  }
  template <typename DeploymentGroupsInfoT = Aws::Vector<DeploymentGroupInfo>>
  BatchGetDeploymentGroupsResult& WithDeploymentGroupsInfo(DeploymentGroupsInfoT&& value) {
    SetDeploymentGroupsInfo(std::forward<DeploymentGroupsInfoT>(value));
    return *this;
  }
  ...
  BatchGetDeploymentGroupsResult& AddDeploymentGroupsInfo(DeploymentGroupsInfoT&& value) {
    m_deploymentGroupsInfoHasBeenSet = true;
    m_deploymentGroupsInfo.emplace_back(std::forward<DeploymentGroupsInfoT>(value));
    return *this;
  }
  ///@}
