...
class BatchGetApplicationsResult {
 public:
  ...
  void SetApplicationsInfo(ApplicationsInfoT&& value) {
    m_applicationsInfoHasBeenSet = true;
    m_applicationsInfo = std::forward<ApplicationsInfoT>(value);
  }
  template <typename ApplicationsInfoT = Aws::Vector<ApplicationInfo>>
  BatchGetApplicationsResult& WithApplicationsInfo(ApplicationsInfoT&& value) {
    SetApplicationsInfo(std::forward<ApplicationsInfoT>(value));
    return *this;
  }
  ...
  BatchGetApplicationsResult& AddApplicationsInfo(ApplicationsInfoT&& value) {
    m_applicationsInfoHasBeenSet = true;
    m_applicationsInfo.emplace_back(std::forward<ApplicationsInfoT>(value));
    return *this;
  }
  ///@}
