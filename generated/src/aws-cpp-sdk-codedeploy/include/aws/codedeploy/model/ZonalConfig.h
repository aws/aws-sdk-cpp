...
class ZonalConfig {
 public:
  ...
  inline void SetFirstZoneMonitorDurationInSeconds(long long value) {
    m_firstZoneMonitorDurationInSecondsHasBeenSet = true;
    m_firstZoneMonitorDurationInSeconds = value;
  }
  inline ZonalConfig& WithFirstZoneMonitorDurationInSeconds(long long value) {
    SetFirstZoneMonitorDurationInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMonitorDurationInSeconds(long long value) {
    m_monitorDurationInSecondsHasBeenSet = true;
    m_monitorDurationInSeconds = value;
  }
  inline ZonalConfig& WithMonitorDurationInSeconds(long long value) {
    SetMonitorDurationInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetMinimumHealthyHostsPerZone(MinimumHealthyHostsPerZoneT&& value) {
    ...
    m_minimumHealthyHostsPerZone = std::forward<MinimumHealthyHostsPerZoneT>(value);
  }
  template <typename MinimumHealthyHostsPerZoneT = MinimumHealthyHostsPerZone>
  ZonalConfig& WithMinimumHealthyHostsPerZone(MinimumHealthyHostsPerZoneT&& value) {
    SetMinimumHealthyHostsPerZone(std::forward<MinimumHealthyHostsPerZoneT>(value));
    return *this;
  }
  ///@}
 private:
