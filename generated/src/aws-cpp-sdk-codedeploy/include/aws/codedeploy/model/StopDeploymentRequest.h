...
class StopDeploymentRequest : public CodeDeployRequest {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  StopDeploymentRequest& WithDeploymentId(DeploymentIdT&& value) {
  ...
  inline void SetAutoRollbackEnabled(bool value) {
    m_autoRollbackEnabledHasBeenSet = true;
    m_autoRollbackEnabled = value;
  }
  inline StopDeploymentRequest& WithAutoRollbackEnabled(bool value) {
    SetAutoRollbackEnabled(value);
    return *this;
  }
  ///@}
 private:
