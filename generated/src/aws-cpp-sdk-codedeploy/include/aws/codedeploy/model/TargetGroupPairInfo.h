...
class TargetGroupPairInfo {
 public:
  ...
  void SetProdTrafficRoute(ProdTrafficRouteT&& value) {
    ...
    m_prodTrafficRoute = std::forward<ProdTrafficRouteT>(value);
  }
  template <typename ProdTrafficRouteT = TrafficRoute>
  TargetGroupPairInfo& WithProdTrafficRoute(ProdTrafficRouteT&& value) {
    SetProdTrafficRoute(std::forward<ProdTrafficRouteT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestTrafficRoute(TestTrafficRouteT&& value) {
    ...
    m_testTrafficRoute = std::forward<TestTrafficRouteT>(value);
  }
  template <typename TestTrafficRouteT = TrafficRoute>
  TargetGroupPairInfo& WithTestTrafficRoute(TestTrafficRouteT&& value) {
    SetTestTrafficRoute(std::forward<TestTrafficRouteT>(value));
    return *this;
  }
  ///@}
 private:
