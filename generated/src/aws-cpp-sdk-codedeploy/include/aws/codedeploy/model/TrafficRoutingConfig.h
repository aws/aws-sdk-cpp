...
class TrafficRoutingConfig {
 public:
  ...
  inline void SetType(TrafficRoutingType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TrafficRoutingConfig& WithType(TrafficRoutingType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetTimeBasedCanary(TimeBasedCanaryT&& value) {
    ...
    m_timeBasedCanary = std::forward<TimeBasedCanaryT>(value);
  }
  template <typename TimeBasedCanaryT = TimeBasedCanary>
  TrafficRoutingConfig& WithTimeBasedCanary(TimeBasedCanaryT&& value) {
    SetTimeBasedCanary(std::forward<TimeBasedCanaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeBasedLinear(TimeBasedLinearT&& value) {
    ...
    m_timeBasedLinear = std::forward<TimeBasedLinearT>(value);
  }
  template <typename TimeBasedLinearT = TimeBasedLinear>
  TrafficRoutingConfig& WithTimeBasedLinear(TimeBasedLinearT&& value) {
    SetTimeBasedLinear(std::forward<TimeBasedLinearT>(value));
    return *this;
  }
  ///@}
 private:
