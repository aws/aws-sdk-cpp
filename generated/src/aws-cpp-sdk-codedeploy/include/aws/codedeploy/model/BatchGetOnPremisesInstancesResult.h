...
class BatchGetOnPremisesInstancesResult {
 public:
  ...
  void SetInstanceInfos(InstanceInfosT&& value) {
    m_instanceInfosHasBeenSet = true;
    m_instanceInfos = std::forward<InstanceInfosT>(value);
  }
  template <typename InstanceInfosT = Aws::Vector<InstanceInfo>>
  BatchGetOnPremisesInstancesResult& WithInstanceInfos(InstanceInfosT&& value) {
    SetInstanceInfos(std::forward<InstanceInfosT>(value));
    return *this;
  }
  template <typename InstanceInfosT = InstanceInfo>
  BatchGetOnPremisesInstancesResult& AddInstanceInfos(InstanceInfosT&& value) {
    m_instanceInfosHasBeenSet = true;
    m_instanceInfos.emplace_back(std::forward<InstanceInfosT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetOnPremisesInstancesResult& WithRequestId(RequestIdT&& value) {
