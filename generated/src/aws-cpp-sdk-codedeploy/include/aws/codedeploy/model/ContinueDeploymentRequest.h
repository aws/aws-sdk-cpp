...
class ContinueDeploymentRequest : public CodeDeployRequest {
 public:
  ...
  inline void SetDeploymentWaitType(DeploymentWaitType value) {
    m_deploymentWaitTypeHasBeenSet = true;
    m_deploymentWaitType = value;
  }
  inline ContinueDeploymentRequest& WithDeploymentWaitType(DeploymentWaitType value) {
    SetDeploymentWaitType(value);
    return *this;
  }
  ///@}
 private:
