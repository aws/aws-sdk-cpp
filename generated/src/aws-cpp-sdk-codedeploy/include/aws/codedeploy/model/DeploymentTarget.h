...
class DeploymentTarget {
 public:
  ...
  inline void SetDeploymentTargetType(DeploymentTargetType value) {
    m_deploymentTargetTypeHasBeenSet = true;
    m_deploymentTargetType = value;
  }
  inline DeploymentTarget& WithDeploymentTargetType(DeploymentTargetType value) {
    SetDeploymentTargetType(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceTarget(InstanceTargetT&& value) {
    ...
    m_instanceTarget = std::forward<InstanceTargetT>(value);
  }
  template <typename InstanceTargetT = InstanceTarget>
  DeploymentTarget& WithInstanceTarget(InstanceTargetT&& value) {
    SetInstanceTarget(std::forward<InstanceTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLambdaTarget(LambdaTargetT&& value) {
    ...
    m_lambdaTarget = std::forward<LambdaTargetT>(value);
  }
  template <typename LambdaTargetT = LambdaTarget>
  DeploymentTarget& WithLambdaTarget(LambdaTargetT&& value) {
    SetLambdaTarget(std::forward<LambdaTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEcsTarget(EcsTargetT&& value) {
    ...
    m_ecsTarget = std::forward<EcsTargetT>(value);
  }
  template <typename EcsTargetT = ECSTarget>
  DeploymentTarget& WithEcsTarget(EcsTargetT&& value) {
    SetEcsTarget(std::forward<EcsTargetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCloudFormationTarget(CloudFormationTargetT&& value) {
    ...
    m_cloudFormationTarget = std::forward<CloudFormationTargetT>(value);
  }
  template <typename CloudFormationTargetT = CloudFormationTarget>
  DeploymentTarget& WithCloudFormationTarget(CloudFormationTargetT&& value) {
    SetCloudFormationTarget(std::forward<CloudFormationTargetT>(value));
    return *this;
  }
  ///@}
 private:
