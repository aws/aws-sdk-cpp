...
class DeploymentConfigInfo {
 public:
  ...
  void SetMinimumHealthyHosts(MinimumHealthyHostsT&& value) {
    ...
    m_minimumHealthyHosts = std::forward<MinimumHealthyHostsT>(value);
  }
  template <typename MinimumHealthyHostsT = MinimumHealthyHosts>
  DeploymentConfigInfo& WithMinimumHealthyHosts(MinimumHealthyHostsT&& value) {
    SetMinimumHealthyHosts(std::forward<MinimumHealthyHostsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeploymentConfigInfo& WithComputePlatform(ComputePlatform value) {
  ...
  void SetTrafficRoutingConfig(TrafficRoutingConfigT&& value) {
    ...
    m_trafficRoutingConfig = std::forward<TrafficRoutingConfigT>(value);
  }
  template <typename TrafficRoutingConfigT = TrafficRoutingConfig>
  DeploymentConfigInfo& WithTrafficRoutingConfig(TrafficRoutingConfigT&& value) {
    SetTrafficRoutingConfig(std::forward<TrafficRoutingConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetZonalConfig(ZonalConfigT&& value) {
    ...
    m_zonalConfig = std::forward<ZonalConfigT>(value);
  }
  template <typename ZonalConfigT = ZonalConfig>
  DeploymentConfigInfo& WithZonalConfig(ZonalConfigT&& value) {
    SetZonalConfig(std::forward<ZonalConfigT>(value));
    return *this;
  }
  ///@}
 private:
