...
class ListDeploymentsRequest : public CodeDeployRequest {
 public:
  ...
  void SetIncludeOnlyStatuses(IncludeOnlyStatusesT&& value) {
    m_includeOnlyStatusesHasBeenSet = true;
    m_includeOnlyStatuses = std::forward<IncludeOnlyStatusesT>(value);
  }
  template <typename IncludeOnlyStatusesT = Aws::Vector<DeploymentStatus>>
  ListDeploymentsRequest& WithIncludeOnlyStatuses(IncludeOnlyStatusesT&& value) {
    SetIncludeOnlyStatuses(std::forward<IncludeOnlyStatusesT>(value));
    return *this;
  }
  inline ListDeploymentsRequest& AddIncludeOnlyStatuses(DeploymentStatus value) {
    m_includeOnlyStatusesHasBeenSet = true;
    m_includeOnlyStatuses.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetCreateTimeRange(CreateTimeRangeT&& value) {
    ...
    m_createTimeRange = std::forward<CreateTimeRangeT>(value);
  }
  template <typename CreateTimeRangeT = TimeRange>
  ListDeploymentsRequest& WithCreateTimeRange(CreateTimeRangeT&& value) {
    SetCreateTimeRange(std::forward<CreateTimeRangeT>(value));
    return *this;
  }
  ///@}
