...
class LoadBalancerInfo {
 public:
  ...
  void SetElbInfoList(ElbInfoListT&& value) {
    ...
    m_elbInfoList = std::forward<ElbInfoListT>(value);
  }
  template <typename ElbInfoListT = Aws::Vector<ELBInfo>>
  LoadBalancerInfo& WithElbInfoList(ElbInfoListT&& value) {
    SetElbInfoList(std::forward<ElbInfoListT>(value));
    return *this;
  }
  template <typename ElbInfoListT = ELBInfo>
  LoadBalancerInfo& AddElbInfoList(ElbInfoListT&& value) {
    m_elbInfoListHasBeenSet = true;
    m_elbInfoList.emplace_back(std::forward<ElbInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetGroupInfoList(TargetGroupInfoListT&& value) {
    ...
    m_targetGroupInfoList = std::forward<TargetGroupInfoListT>(value);
  }
  template <typename TargetGroupInfoListT = Aws::Vector<TargetGroupInfo>>
  LoadBalancerInfo& WithTargetGroupInfoList(TargetGroupInfoListT&& value) {
    SetTargetGroupInfoList(std::forward<TargetGroupInfoListT>(value));
    return *this;
  }
  template <typename TargetGroupInfoListT = TargetGroupInfo>
  LoadBalancerInfo& AddTargetGroupInfoList(TargetGroupInfoListT&& value) {
    m_targetGroupInfoListHasBeenSet = true;
    m_targetGroupInfoList.emplace_back(std::forward<TargetGroupInfoListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetGroupPairInfoList(TargetGroupPairInfoListT&& value) {
    ...
    m_targetGroupPairInfoList = std::forward<TargetGroupPairInfoListT>(value);
  }
  template <typename TargetGroupPairInfoListT = Aws::Vector<TargetGroupPairInfo>>
  LoadBalancerInfo& WithTargetGroupPairInfoList(TargetGroupPairInfoListT&& value) {
    SetTargetGroupPairInfoList(std::forward<TargetGroupPairInfoListT>(value));
    return *this;
  }
  ...
  LoadBalancerInfo& AddTargetGroupPairInfoList(TargetGroupPairInfoListT&& value) {
    m_targetGroupPairInfoListHasBeenSet = true;
    m_targetGroupPairInfoList.emplace_back(std::forward<TargetGroupPairInfoListT>(value));
    return *this;
  }
  ///@}
 private:
