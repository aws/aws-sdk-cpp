...
namespace Model
{
  ...
  {
  public:
    AWS_CODEDEPLOY_API ListGitHubAccountTokenNamesRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListGitHubAccountTokenNamesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
