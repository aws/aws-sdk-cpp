...
class ListApplicationRevisionsResult {
 public:
  ...
  template <typename RevisionsT = Aws::Vector<RevisionLocation>>
  ListApplicationRevisionsResult& WithRevisions(RevisionsT&& value) {
    SetRevisions(std::forward<RevisionsT>(value));
    return *this;
  }
  template <typename RevisionsT = RevisionLocation>
  ListApplicationRevisionsResult& AddRevisions(RevisionsT&& value) {
    m_revisionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListApplicationRevisionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListApplicationRevisionsResult& WithRequestId(RequestIdT&& value) {
