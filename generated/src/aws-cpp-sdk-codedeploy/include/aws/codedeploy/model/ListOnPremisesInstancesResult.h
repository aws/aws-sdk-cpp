...
class ListOnPremisesInstancesResult {
 public:
  ...
  template <typename InstanceNamesT = Aws::Vector<Aws::String>>
  ListOnPremisesInstancesResult& WithInstanceNames(InstanceNamesT&& value) {
    SetInstanceNames(std::forward<InstanceNamesT>(value));
    return *this;
  }
  template <typename InstanceNamesT = Aws::String>
  ListOnPremisesInstancesResult& AddInstanceNames(InstanceNamesT&& value) {
    m_instanceNamesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListOnPremisesInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOnPremisesInstancesResult& WithRequestId(RequestIdT&& value) {
