...
class DeleteDeploymentGroupRequest : public CodeDeployRequest {
 public:
  ...
  template <typename ApplicationNameT = Aws::String>
  DeleteDeploymentGroupRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename DeploymentGroupNameT = Aws::String>
  DeleteDeploymentGroupRequest& WithDeploymentGroupName(DeploymentGroupNameT&& value) {
