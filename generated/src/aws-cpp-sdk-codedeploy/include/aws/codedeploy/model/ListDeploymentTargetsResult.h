...
class ListDeploymentTargetsResult {
 public:
  ...
  template <typename TargetIdsT = Aws::Vector<Aws::String>>
  ListDeploymentTargetsResult& WithTargetIds(TargetIdsT&& value) {
    SetTargetIds(std::forward<TargetIdsT>(value));
    return *this;
  }
  template <typename TargetIdsT = Aws::String>
  ListDeploymentTargetsResult& AddTargetIds(TargetIdsT&& value) {
    m_targetIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDeploymentTargetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeploymentTargetsResult& WithRequestId(RequestIdT&& value) {
