...
class MinimumHealthyHosts {
 public:
  ...
  inline void SetType(MinimumHealthyHostsType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline MinimumHealthyHosts& WithType(MinimumHealthyHostsType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline MinimumHealthyHosts& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
