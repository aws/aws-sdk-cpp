...
class RegisterApplicationRevisionRequest : public CodeDeployRequest {
 public:
  AWS_CODEDEPLOY_API RegisterApplicationRevisionRequest() = default;
  ...
  template <typename ApplicationNameT = Aws::String>
  RegisterApplicationRevisionRequest& WithApplicationName(ApplicationNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  RegisterApplicationRevisionRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename RevisionT = RevisionLocation>
  RegisterApplicationRevisionRequest& WithRevision(RevisionT&& value) {
