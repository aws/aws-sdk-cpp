...
class CreateDeploymentRequest : public CodeDeployRequest {
 public:
  ...
  inline void SetIgnoreApplicationStopFailures(bool value) {
    m_ignoreApplicationStopFailuresHasBeenSet = true;
    m_ignoreApplicationStopFailures = value;
  }
  inline CreateDeploymentRequest& WithIgnoreApplicationStopFailures(bool value) {
    SetIgnoreApplicationStopFailures(value);
    return *this;
  }
  ///@}
  ...
  void SetTargetInstances(TargetInstancesT&& value) {
    ...
    m_targetInstances = std::forward<TargetInstancesT>(value);
  }
  template <typename TargetInstancesT = TargetInstances>
  CreateDeploymentRequest& WithTargetInstances(TargetInstancesT&& value) {
    SetTargetInstances(std::forward<TargetInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUpdateOutdatedInstancesOnly(bool value) {
    m_updateOutdatedInstancesOnlyHasBeenSet = true;
    m_updateOutdatedInstancesOnly = value;
  }
  inline CreateDeploymentRequest& WithUpdateOutdatedInstancesOnly(bool value) {
    SetUpdateOutdatedInstancesOnly(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFileExistsBehavior(FileExistsBehavior value) {
    m_fileExistsBehaviorHasBeenSet = true;
    m_fileExistsBehavior = value;
  }
  inline CreateDeploymentRequest& WithFileExistsBehavior(FileExistsBehavior value) {
    SetFileExistsBehavior(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The type of deployment to create. Valid values are:</p> <ul> <li> <p>
   * <code>STANDARD</code>: Deploys the specified revision. This is the default
   * behavior if <code>deploymentMode</code> is not specified.</p> </li> <li> <p>
   * <code>RESTART</code>: Restarts the application on the target instances using the
   ...
   * EC2/On-premises in-place deployments.</p> <p>When <code>deploymentMode</code> is
   * <code>RESTART</code>, the following apply:</p> <ul> <li> <p>The call is rejected
   * for Amazon ECS and Lambda deployments.</p> </li> <li> <p>The
   * <code>revision</code> parameter (including its <code>s3Location</code> and
   * <code>gitHubLocation</code>) must not be specified, and is rejected if provided.
   * The revision is resolved by the service from the deployment group's last
   * successful deployment.</p> </li> <li> <p>The
   * <code>updateOutdatedInstancesOnly</code> parameter must not be set to
   * <code>true</code>, and is rejected if provided.</p> </li> </ul> </li> </ul>
   */
  ...
  void SetOverrideAlarmConfiguration(OverrideAlarmConfigurationT&& value) {
    ...
    m_overrideAlarmConfiguration = std::forward<OverrideAlarmConfigurationT>(value);
  }
  template <typename OverrideAlarmConfigurationT = AlarmConfiguration>
  CreateDeploymentRequest& WithOverrideAlarmConfiguration(OverrideAlarmConfigurationT&& value) {
    SetOverrideAlarmConfiguration(std::forward<OverrideAlarmConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
