...
class CreateDeploymentConfigResult {
 public:
  ...
  void SetDeploymentConfigId(DeploymentConfigIdT&& value) {
    ...
    m_deploymentConfigId = std::forward<DeploymentConfigIdT>(value);
  }
  template <typename DeploymentConfigIdT = Aws::String>
  CreateDeploymentConfigResult& WithDeploymentConfigId(DeploymentConfigIdT&& value) {
    SetDeploymentConfigId(std::forward<DeploymentConfigIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateDeploymentConfigResult& WithRequestId(RequestIdT&& value) {
