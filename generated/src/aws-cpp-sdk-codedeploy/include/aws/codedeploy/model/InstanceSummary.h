...
class InstanceSummary {
 public:
  ...
  template <typename DeploymentIdT = Aws::String>
  InstanceSummary& WithDeploymentId(DeploymentIdT&& value) {
  ...
  inline void SetStatus(InstanceStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline InstanceSummary& WithStatus(InstanceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename LifecycleEventsT = Aws::Vector<LifecycleEvent>>
  InstanceSummary& WithLifecycleEvents(LifecycleEventsT&& value) {
    SetLifecycleEvents(std::forward<LifecycleEventsT>(value));
    return *this;
  }
  template <typename LifecycleEventsT = LifecycleEvent>
  InstanceSummary& AddLifecycleEvents(LifecycleEventsT&& value) {
    m_lifecycleEventsHasBeenSet = true;
  ...
  inline InstanceSummary& WithInstanceType(InstanceType value) {
