...
BatchGetDeploymentGroupsResult::BatchGetDeploymentGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
BatchGetDeploymentGroupsResult& BatchGetDeploymentGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("deploymentGroupsInfo")) {
    ...
    for (unsigned deploymentGroupsInfoIndex = 0; deploymentGroupsInfoIndex < deploymentGroupsInfoJsonList.GetLength();
         ++deploymentGroupsInfoIndex) {
