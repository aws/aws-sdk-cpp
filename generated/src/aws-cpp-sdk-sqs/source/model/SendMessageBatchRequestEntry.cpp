...
SendMessageBatchRequestEntry::SendMessageBatchRequestEntry(JsonView jsonValue) { *this = jsonValue; }
...
SendMessageBatchRequestEntry& SendMessageBatchRequestEntry::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MessageSystemAttributes")) {
    ...
    for (auto& messageSystemAttributesItem : messageSystemAttributesJsonMap) {
      m_messageSystemAttributes[MessageSystemAttributeNameForSendsMapper::GetMessageSystemAttributeNameForSendsForName(
          messageSystemAttributesItem.first)] = messageSystemAttributesItem.second.AsObject();
    }
...
JsonValue SendMessageBatchRequestEntry::Jsonize() const {
  ...
  if (m_messageSystemAttributesHasBeenSet) {
    ...
    for (auto& messageSystemAttributesItem : m_messageSystemAttributes) {
      messageSystemAttributesJsonMap.WithObject(
          MessageSystemAttributeNameForSendsMapper::GetNameForMessageSystemAttributeNameForSends(messageSystemAttributesItem.first),
          messageSystemAttributesItem.second.Jsonize());
    }
