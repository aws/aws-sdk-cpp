...
namespace SQS
{
const size_t SQSEndpointRules::RulesBlobStrLen = 3935;
const size_t SQSEndpointRules::RulesBlobSize = 3936;
...
's','q','s','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.','c','o',
...
's',':','/','/','s','q','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i',
