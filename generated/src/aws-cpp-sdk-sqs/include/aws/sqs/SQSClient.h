...
class AWS_SQS_API SQSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SQSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SQSEndpointProviderBase> endpointProvider = nullptr,
   ...
   * maximum of seven actions per statement.</p> </li> <li> <p>To remove the ability
   * to change queue permissions, you must deny permission to the
   * <code>AddPermission</code>, <code>RemovePermission</code>, and
   * <code>SetQueueAttributes</code> actions in your IAM policy.</p> </li> <li>
   * <p>Amazon SQS <code>AddPermission</code> does not support adding a non-account
   * principal.</p> </li> </ul>   <p>Cross-account permissions don't
  ...
  /**
   * A Callable wrapper for CancelMessageMoveTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelMessageMoveTaskRequestT = Model::CancelMessageMoveTaskRequest>
  Model::CancelMessageMoveTaskOutcomeCallable CancelMessageMoveTaskCallable(const CancelMessageMoveTaskRequestT& request) const {
    return SubmitCallable(&SQSClient::CancelMessageMoveTask, request);
  }

  /**
   * An Async wrapper for CancelMessageMoveTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMessageMoveTaskRequestT = Model::CancelMessageMoveTaskRequest>
  void CancelMessageMoveTaskAsync(const CancelMessageMoveTaskRequestT& request, const CancelMessageMoveTaskResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SQSClient::CancelMessageMoveTask, request, handler, context);
  }
   ...
   * Timeout</a> in the <i>Amazon SQS Developer Guide</i>.</p> <p>For example, if the
   * default timeout for a queue is 60 seconds, 15 seconds have elapsed since you
   * received the message, and you send a ChangeMessageVisibility call with
   * <code>VisibilityTimeout</code> set to 10 seconds, the 10 seconds begin to count
   * from the time that you make the <code>ChangeMessageVisibility</code> call. Thus,
   * any attempt to change the visibility timeout or to delete that message 10
   * seconds after you initially change the visibility timeout (a total of 25
   * seconds) might result in an error.</p> <p>An Amazon SQS message has three basic
   * states:</p> <ol> <li> <p>Sent to a queue by a producer.</p> </li> <li>
   * <p>Received from the queue by a consumer.</p> </li> <li> <p>Deleted from the
   * queue.</p> </li> </ol> <p>A message is considered to be <i>stored</i> after it
   * is sent to a queue by a producer, but not yet received from the queue by a
   ...
   * is, between states 2 and 3). There is a limit to the number of in flight
   * messages.</p> <p>Limits that apply to in flight messages are unrelated to the
  ...
  /**
   * A Callable wrapper for ChangeMessageVisibility that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ChangeMessageVisibility that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ChangeMessageVisibilityRequestT = Model::ChangeMessageVisibilityRequest>
  void ChangeMessageVisibilityAsync(const ChangeMessageVisibilityRequestT& request,
   ...
   * status code of <code>200</code>.</p> <p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ChangeMessageVisibilityBatch">AWS
   * API Reference</a></p>
   */
  virtual Model::ChangeMessageVisibilityBatchOutcome ChangeMessageVisibilityBatch(
      const Model::ChangeMessageVisibilityBatchRequest& request) const;

  /**
   * A Callable wrapper for ChangeMessageVisibilityBatch that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ChangeMessageVisibilityBatchRequestT = Model::ChangeMessageVisibilityBatchRequest>
  Model::ChangeMessageVisibilityBatchOutcomeCallable ChangeMessageVisibilityBatchCallable(
      const ChangeMessageVisibilityBatchRequestT& request) const {
    return SubmitCallable(&SQSClient::ChangeMessageVisibilityBatch, request);
  }

  /**
   * An Async wrapper for ChangeMessageVisibilityBatch that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ChangeMessageVisibilityBatchRequestT = Model::ChangeMessageVisibilityBatchRequest>
  void ChangeMessageVisibilityBatchAsync(const ChangeMessageVisibilityBatchRequestT& request,
   ...
   * <code>200</code>.</p> <p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for DeleteMessageBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMessageBatch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteMessageBatchRequestT = Model::DeleteMessageBatchRequest>
  void DeleteMessageBatchAsync(const DeleteMessageBatchRequestT& request, const DeleteMessageBatchResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name">Grant
   * cross-account permissions to a role and a username</a> in the <i>Amazon SQS
   * Developer Guide</i>.</p> <p>The delete operation uses the HTTP <code>GET</code>
   * verb.</p> <p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for GetQueueAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQueueAttributes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetQueueAttributesRequestT = Model::GetQueueAttributesRequest>
  void GetQueueAttributesAsync(const GetQueueAttributesRequestT& request, const GetQueueAttributesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetQueueUrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetQueueUrlRequestT = Model::GetQueueUrlRequest>
  void GetQueueUrlAsync(const GetQueueUrlRequestT& request, const GetQueueUrlResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDeadLetterSourceQueuesOutcome ListDeadLetterSourceQueues(
      const Model::ListDeadLetterSourceQueuesRequest& request) const;

  /**
   * A Callable wrapper for ListDeadLetterSourceQueues that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDeadLetterSourceQueuesRequestT = Model::ListDeadLetterSourceQueuesRequest>
  Model::ListDeadLetterSourceQueuesOutcomeCallable ListDeadLetterSourceQueuesCallable(
      const ListDeadLetterSourceQueuesRequestT& request) const {
    return SubmitCallable(&SQSClient::ListDeadLetterSourceQueues, request);
  }

  /**
   * An Async wrapper for ListDeadLetterSourceQueues that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDeadLetterSourceQueuesRequestT = Model::ListDeadLetterSourceQueuesRequest>
  void ListDeadLetterSourceQueuesAsync(const ListDeadLetterSourceQueuesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListMessageMoveTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListMessageMoveTasksRequestT = Model::ListMessageMoveTasksRequest>
  Model::ListMessageMoveTasksOutcomeCallable ListMessageMoveTasksCallable(const ListMessageMoveTasksRequestT& request) const {
    return SubmitCallable(&SQSClient::ListMessageMoveTasks, request);
  }

  /**
   * An Async wrapper for ListMessageMoveTasks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMessageMoveTasksRequestT = Model::ListMessageMoveTasksRequest>
  void ListMessageMoveTasksAsync(const ListMessageMoveTasksRequestT& request, const ListMessageMoveTasksResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SQSClient::ListMessageMoveTasks, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for ListQueueTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListQueueTagsRequestT = Model::ListQueueTagsRequest>
  void ListQueueTagsAsync(const ListQueueTagsRequestT& request, const ListQueueTagsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListQueuesRequestT = Model::ListQueuesRequest>
  void ListQueuesAsync(const ListQueuesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListQueuesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for PurgeQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PurgeQueueRequestT = Model::PurgeQueueRequest>
  void PurgeQueueAsync(const PurgeQueueRequestT& request, const PurgeQueueResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ReceiveMessage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ReceiveMessageRequestT = Model::ReceiveMessageRequest>
  void ReceiveMessageAsync(const ReceiveMessageRequestT& request, const ReceiveMessageResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * <code>#xFFFD</code> | <code>#x10000</code> to <code>#x10FFFF</code> </p> <p>If a
   * message contains characters outside the allowed set, Amazon SQS rejects the
   * message and returns an InvalidMessageContents error. Ensure that your message
   * body includes only valid characters to avoid this exception.</p>
   * <p><h3>See Also:</h3>   <a
   ...
   */
  template <typename SendMessageRequestT = Model::SendMessageRequest>
  void SendMessageAsync(const SendMessageRequestT& request, const SendMessageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SQSClient::SendMessage, request, handler, context);
  }

  /**
   * <p>You can use <code>SendMessageBatch</code> to send up to 10 messages to the
   * specified queue by assigning either identical or different values to each
   * message (or by not assigning values at all). This is a batch version of <code>
   * <a>SendMessage</a>.</code> For a FIFO queue, multiple messages within a single
   * batch are enqueued in the order they are sent.</p> <p>The result of sending each
   * message is reported individually in the response. Because the batch request can
   ...
   * batched messages) are both 1 MiB 1,048,576 bytes.</p>  <p>A message
   ...
   * message and returns an InvalidMessageContents error. Ensure that your message
   * body includes only valid characters to avoid this exception.</p>
   * <p>If you don't specify the <code>DelaySeconds</code> parameter for an entry,
   * Amazon SQS uses the default value for the queue.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for SendMessageBatch that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SendMessageBatch that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SendMessageBatchRequestT = Model::SendMessageBatchRequest>
  void SendMessageBatchAsync(const SendMessageBatchRequestT& request, const SendMessageBatchResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SetQueueAttributes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SetQueueAttributes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename SetQueueAttributesRequestT = Model::SetQueueAttributesRequest>
  void SetQueueAttributesAsync(const SetQueueAttributesRequestT& request, const SetQueueAttributesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMessageMoveTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartMessageMoveTaskRequestT = Model::StartMessageMoveTaskRequest>
  Model::StartMessageMoveTaskOutcomeCallable StartMessageMoveTaskCallable(const StartMessageMoveTaskRequestT& request) const {
    return SubmitCallable(&SQSClient::StartMessageMoveTask, request);
  }

  /**
   * An Async wrapper for StartMessageMoveTask that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMessageMoveTaskRequestT = Model::StartMessageMoveTaskRequest>
  void StartMessageMoveTaskAsync(const StartMessageMoveTaskRequestT& request, const StartMessageMoveTaskResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&SQSClient::StartMessageMoveTask, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for TagQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename TagQueueRequestT = Model::TagQueueRequest>
  void TagQueueAsync(const TagQueueRequestT& request, const TagQueueResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UntagQueue that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UntagQueueRequestT = Model::UntagQueueRequest>
  void UntagQueueAsync(const UntagQueueRequestT& request, const UntagQueueResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
