...
class ListQueuesResult {
 public:
  ...
  template <typename QueueUrlsT = Aws::Vector<Aws::String>>
  ListQueuesResult& WithQueueUrls(QueueUrlsT&& value) {
    SetQueueUrls(std::forward<QueueUrlsT>(value));
    return *this;
  }
  template <typename QueueUrlsT = Aws::String>
  ListQueuesResult& AddQueueUrls(QueueUrlsT&& value) {
    m_queueUrlsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListQueuesResult& WithResponseMetadata(ResponseMetadataT&& value) {
