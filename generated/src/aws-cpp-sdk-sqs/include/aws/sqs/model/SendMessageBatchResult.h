...
class SendMessageBatchResult {
 public:
  ...
  template <typename SuccessfulT = Aws::Vector<SendMessageBatchResultEntry>>
  SendMessageBatchResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = SendMessageBatchResultEntry>
  SendMessageBatchResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename FailedT = Aws::Vector<BatchResultErrorEntry>>
  SendMessageBatchResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = BatchResultErrorEntry>
  SendMessageBatchResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  SendMessageBatchResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SendMessageBatchResult& WithResponseMetadata(ResponseMetadataT&& value) {
