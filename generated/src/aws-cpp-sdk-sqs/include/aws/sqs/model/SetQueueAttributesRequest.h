...
namespace Model
{
  ...
  public:
     ...
     * ��� The length of time, in seconds, for which a <code> <a>ReceiveMessage</a>
     * </code> action waits for a message to arrive. Valid values: An integer from 0 to
     * 20 (seconds). Default: 0. </p> </li> <li> <p> <code>VisibilityTimeout</code> –
