...
class GetQueueUrlResult {
 public:
  ...
  template <typename QueueUrlT = Aws::String>
  GetQueueUrlResult& WithQueueUrl(QueueUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetQueueUrlResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetQueueUrlResult& WithResponseMetadata(ResponseMetadataT&& value) {
