...
class ListDeadLetterSourceQueuesResult {
 public:
  ...
  void SetQueueUrls(QueueUrlsT&& value) {
    m_queueUrlsHasBeenSet = true;
    m_queueUrls = std::forward<QueueUrlsT>(value);
  }
  template <typename QueueUrlsT = Aws::Vector<Aws::String>>
  ListDeadLetterSourceQueuesResult& WithQueueUrls(QueueUrlsT&& value) {
    SetQueueUrls(std::forward<QueueUrlsT>(value));
    return *this;
  }
  template <typename QueueUrlsT = Aws::String>
  ListDeadLetterSourceQueuesResult& AddQueueUrls(QueueUrlsT&& value) {
    m_queueUrlsHasBeenSet = true;
    m_queueUrls.emplace_back(std::forward<QueueUrlsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeadLetterSourceQueuesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeadLetterSourceQueuesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListDeadLetterSourceQueuesResult& WithResponseMetadata(ResponseMetadataT&& value) {
