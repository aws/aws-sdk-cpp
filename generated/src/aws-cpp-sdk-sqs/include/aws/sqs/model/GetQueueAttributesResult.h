...
class GetQueueAttributesResult {
 public:
  ...
  template <typename AttributesT = Aws::Map<QueueAttributeName, Aws::String>>
  GetQueueAttributesResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetQueueAttributesResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetQueueAttributesResult& WithResponseMetadata(ResponseMetadataT&& value) {
