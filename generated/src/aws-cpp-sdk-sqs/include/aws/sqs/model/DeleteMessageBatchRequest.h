...
class DeleteMessageBatchRequest : public SQSRequest {
 public:
  ...
  template <typename QueueUrlT = Aws::String>
  DeleteMessageBatchRequest& WithQueueUrl(QueueUrlT&& value) {
  ...
  template <typename EntriesT = Aws::Vector<DeleteMessageBatchRequestEntry>>
  DeleteMessageBatchRequest& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = DeleteMessageBatchRequestEntry>
  DeleteMessageBatchRequest& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
