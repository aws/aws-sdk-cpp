...
namespace Model
{
  ...
  {
  public:
    AWS_SQS_API DeleteMessageBatchRequest() = default;
    ...
    template<typename QueueUrlT = Aws::String>
    DeleteMessageBatchRequest& WithQueueUrl(QueueUrlT&& value) { SetQueueUrl(std::forward<QueueUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename EntriesT = Aws::Vector<DeleteMessageBatchRequestEntry>>
    void SetEntries(EntriesT&& value) { m_entriesHasBeenSet = true; m_entries = std::forward<EntriesT>(value); }
    template<typename EntriesT = Aws::Vector<DeleteMessageBatchRequestEntry>>
    DeleteMessageBatchRequest& WithEntries(EntriesT&& value) { SetEntries(std::forward<EntriesT>(value)); return *this;}
    template<typename EntriesT = DeleteMessageBatchRequestEntry>
    DeleteMessageBatchRequest& AddEntries(EntriesT&& value) { m_entriesHasBeenSet = true; m_entries.emplace_back(std::forward<EntriesT>(value)); return *this; }
    ///@}
  private:
