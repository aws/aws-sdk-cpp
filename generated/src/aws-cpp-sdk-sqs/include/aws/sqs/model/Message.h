...
class Message {
 public:
  ...
  void SetReceiptHandle(ReceiptHandleT&& value) {
    ...
    m_receiptHandle = std::forward<ReceiptHandleT>(value);
  }
  template <typename ReceiptHandleT = Aws::String>
  Message& WithReceiptHandle(ReceiptHandleT&& value) {
    SetReceiptHandle(std::forward<ReceiptHandleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMD5OfBody(MD5OfBodyT&& value) {
    ...
    m_mD5OfBody = std::forward<MD5OfBodyT>(value);
  }
  template <typename MD5OfBodyT = Aws::String>
  Message& WithMD5OfBody(MD5OfBodyT&& value) {
    SetMD5OfBody(std::forward<MD5OfBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMD5OfMessageAttributes(MD5OfMessageAttributesT&& value) {
    ...
    m_mD5OfMessageAttributes = std::forward<MD5OfMessageAttributesT>(value);
  }
  template <typename MD5OfMessageAttributesT = Aws::String>
  Message& WithMD5OfMessageAttributes(MD5OfMessageAttributesT&& value) {
    SetMD5OfMessageAttributes(std::forward<MD5OfMessageAttributesT>(value));
    return *this;
  }
  ///@}
