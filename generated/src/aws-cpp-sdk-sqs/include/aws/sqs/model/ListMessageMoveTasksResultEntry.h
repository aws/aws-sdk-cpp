...
class ListMessageMoveTasksResultEntry {
 public:
  ...
  template <typename TaskHandleT = Aws::String>
  ListMessageMoveTasksResultEntry& WithTaskHandle(TaskHandleT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ListMessageMoveTasksResultEntry& WithStatus(StatusT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  ListMessageMoveTasksResultEntry& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename DestinationArnT = Aws::String>
  ListMessageMoveTasksResultEntry& WithDestinationArn(DestinationArnT&& value) {
  ...
  inline void SetMaxNumberOfMessagesPerSecond(int value) {
    m_maxNumberOfMessagesPerSecondHasBeenSet = true;
    m_maxNumberOfMessagesPerSecond = value;
  }
  inline ListMessageMoveTasksResultEntry& WithMaxNumberOfMessagesPerSecond(int value) {
    SetMaxNumberOfMessagesPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline ListMessageMoveTasksResultEntry& WithApproximateNumberOfMessagesMoved(long long value) {
  ...
  inline void SetApproximateNumberOfMessagesToMove(long long value) {
    m_approximateNumberOfMessagesToMoveHasBeenSet = true;
    m_approximateNumberOfMessagesToMove = value;
  }
  inline ListMessageMoveTasksResultEntry& WithApproximateNumberOfMessagesToMove(long long value) {
    SetApproximateNumberOfMessagesToMove(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  ListMessageMoveTasksResultEntry& WithFailureReason(FailureReasonT&& value) {
  ...
  inline void SetStartedTimestamp(long long value) {
    m_startedTimestampHasBeenSet = true;
    m_startedTimestamp = value;
  }
  inline ListMessageMoveTasksResultEntry& WithStartedTimestamp(long long value) {
