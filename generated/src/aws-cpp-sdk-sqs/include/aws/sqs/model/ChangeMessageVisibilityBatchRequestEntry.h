...
class ChangeMessageVisibilityBatchRequestEntry {
 public:
  ...
  template <typename IdT = Aws::String>
  ChangeMessageVisibilityBatchRequestEntry& WithId(IdT&& value) {
  ...
  template <typename ReceiptHandleT = Aws::String>
  ChangeMessageVisibilityBatchRequestEntry& WithReceiptHandle(ReceiptHandleT&& value) {
  ...
  inline ChangeMessageVisibilityBatchRequestEntry& WithVisibilityTimeout(int value) {
