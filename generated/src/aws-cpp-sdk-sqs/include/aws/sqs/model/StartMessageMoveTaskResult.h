...
class StartMessageMoveTaskResult {
 public:
  ...
  void SetTaskHandle(TaskHandleT&& value) {
    m_taskHandleHasBeenSet = true;
    m_taskHandle = std::forward<TaskHandleT>(value);
  }
  template <typename TaskHandleT = Aws::String>
  StartMessageMoveTaskResult& WithTaskHandle(TaskHandleT&& value) {
    SetTaskHandle(std::forward<TaskHandleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartMessageMoveTaskResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartMessageMoveTaskResult& WithResponseMetadata(ResponseMetadataT&& value) {
