...
class ListDeadLetterSourceQueuesRequest : public SQSRequest {
 public:
  ...
  template <typename QueueUrlT = Aws::String>
  ListDeadLetterSourceQueuesRequest& WithQueueUrl(QueueUrlT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListDeadLetterSourceQueuesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDeadLetterSourceQueuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
