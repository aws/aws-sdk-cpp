...
class GetQueueUrlRequest : public SQSRequest {
 public:
  ...
  void SetQueueOwnerAWSAccountId(QueueOwnerAWSAccountIdT&& value) {
    m_queueOwnerAWSAccountIdHasBeenSet = true;
    m_queueOwnerAWSAccountId = std::forward<QueueOwnerAWSAccountIdT>(value);
  }
  template <typename QueueOwnerAWSAccountIdT = Aws::String>
  GetQueueUrlRequest& WithQueueOwnerAWSAccountId(QueueOwnerAWSAccountIdT&& value) {
    SetQueueOwnerAWSAccountId(std::forward<QueueOwnerAWSAccountIdT>(value));
    return *this;
  }
  ///@}
 private:
