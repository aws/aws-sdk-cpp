...
class ListMessageMoveTasksResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<ListMessageMoveTasksResultEntry>>
  ListMessageMoveTasksResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = ListMessageMoveTasksResultEntry>
  ListMessageMoveTasksResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListMessageMoveTasksResult& WithRequestId(RequestIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListMessageMoveTasksResult& WithResponseMetadata(ResponseMetadataT&& value) {
