...
class MessageAttributeValue {
 public:
  ...
  void SetBinaryListValues(BinaryListValuesT&& value) {
    ...
    m_binaryListValues = std::forward<BinaryListValuesT>(value);
  }
  template <typename BinaryListValuesT = Aws::Vector<Aws::Utils::ByteBuffer>>
  MessageAttributeValue& WithBinaryListValues(BinaryListValuesT&& value) {
    SetBinaryListValues(std::forward<BinaryListValuesT>(value));
    return *this;
  }
  ...
  MessageAttributeValue& AddBinaryListValues(BinaryListValuesT&& value) {
    m_binaryListValuesHasBeenSet = true;
    m_binaryListValues.emplace_back(std::forward<BinaryListValuesT>(value));
    return *this;
  }
  ///@}
