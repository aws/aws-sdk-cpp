...
class TransactionEvent {
 public:
  ...
  inline TransactionEvent& WithNetwork(QueryNetwork value) {
    SetNetwork(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventType(QueryTransactionEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline TransactionEvent& WithEventType(QueryTransactionEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  void SetContractAddress(ContractAddressT&& value) {
    ...
    m_contractAddress = std::forward<ContractAddressT>(value);
  }
  template <typename ContractAddressT = Aws::String>
  TransactionEvent& WithContractAddress(ContractAddressT&& value) {
    SetContractAddress(std::forward<ContractAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVoutIndex(int value) {
    m_voutIndexHasBeenSet = true;
    m_voutIndex = value;
  }
  inline TransactionEvent& WithVoutIndex(int value) {
    SetVoutIndex(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVoutSpent(bool value) {
    m_voutSpentHasBeenSet = true;
    m_voutSpent = value;
  }
  inline TransactionEvent& WithVoutSpent(bool value) {
    SetVoutSpent(value);
    return *this;
  }
  ///@}
  ...
  void SetSpentVoutTransactionId(SpentVoutTransactionIdT&& value) {
    ...
    m_spentVoutTransactionId = std::forward<SpentVoutTransactionIdT>(value);
  }
  template <typename SpentVoutTransactionIdT = Aws::String>
  TransactionEvent& WithSpentVoutTransactionId(SpentVoutTransactionIdT&& value) {
    SetSpentVoutTransactionId(std::forward<SpentVoutTransactionIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpentVoutTransactionHash(SpentVoutTransactionHashT&& value) {
    ...
    m_spentVoutTransactionHash = std::forward<SpentVoutTransactionHashT>(value);
  }
  template <typename SpentVoutTransactionHashT = Aws::String>
  TransactionEvent& WithSpentVoutTransactionHash(SpentVoutTransactionHashT&& value) {
    SetSpentVoutTransactionHash(std::forward<SpentVoutTransactionHashT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSpentVoutIndex(int value) {
    m_spentVoutIndexHasBeenSet = true;
    m_spentVoutIndex = value;
  }
  inline TransactionEvent& WithSpentVoutIndex(int value) {
    SetSpentVoutIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetBlockchainInstant(BlockchainInstantT&& value) {
    ...
    m_blockchainInstant = std::forward<BlockchainInstantT>(value);
  }
  template <typename BlockchainInstantT = BlockchainInstant>
  TransactionEvent& WithBlockchainInstant(BlockchainInstantT&& value) {
    SetBlockchainInstant(std::forward<BlockchainInstantT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConfirmationStatus(ConfirmationStatus value) {
    m_confirmationStatusHasBeenSet = true;
    m_confirmationStatus = value;
  }
  inline TransactionEvent& WithConfirmationStatus(ConfirmationStatus value) {
