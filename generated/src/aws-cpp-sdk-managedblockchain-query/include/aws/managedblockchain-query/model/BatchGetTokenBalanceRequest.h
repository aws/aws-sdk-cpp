...
class BatchGetTokenBalanceRequest : public ManagedBlockchainQueryRequest {
 public:
  ...
  void SetGetTokenBalanceInputs(GetTokenBalanceInputsT&& value) {
    m_getTokenBalanceInputsHasBeenSet = true;
    m_getTokenBalanceInputs = std::forward<GetTokenBalanceInputsT>(value);
  }
  template <typename GetTokenBalanceInputsT = Aws::Vector<BatchGetTokenBalanceInputItem>>
  BatchGetTokenBalanceRequest& WithGetTokenBalanceInputs(GetTokenBalanceInputsT&& value) {
    SetGetTokenBalanceInputs(std::forward<GetTokenBalanceInputsT>(value));
    return *this;
  }
  template <typename GetTokenBalanceInputsT = BatchGetTokenBalanceInputItem>
  BatchGetTokenBalanceRequest& AddGetTokenBalanceInputs(GetTokenBalanceInputsT&& value) {
    m_getTokenBalanceInputsHasBeenSet = true;
    m_getTokenBalanceInputs.emplace_back(std::forward<GetTokenBalanceInputsT>(value));
    return *this;
  }
  ///@}
 private:
