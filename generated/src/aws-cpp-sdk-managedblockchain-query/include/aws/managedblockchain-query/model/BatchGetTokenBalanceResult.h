...
class BatchGetTokenBalanceResult {
 public:
  ...
  AWS_MANAGEDBLOCKCHAINQUERY_API BatchGetTokenBalanceResult& operator=(
  ...
  template <typename TokenBalancesT = Aws::Vector<BatchGetTokenBalanceOutputItem>>
  BatchGetTokenBalanceResult& WithTokenBalances(TokenBalancesT&& value) {
    SetTokenBalances(std::forward<TokenBalancesT>(value));
    return *this;
  }
  template <typename TokenBalancesT = BatchGetTokenBalanceOutputItem>
  BatchGetTokenBalanceResult& AddTokenBalances(TokenBalancesT&& value) {
    m_tokenBalancesHasBeenSet = true;
  ...
  template <typename ErrorsT = Aws::Vector<BatchGetTokenBalanceErrorItem>>
  BatchGetTokenBalanceResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchGetTokenBalanceErrorItem>
  BatchGetTokenBalanceResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetTokenBalanceResult& WithRequestId(RequestIdT&& value) {
