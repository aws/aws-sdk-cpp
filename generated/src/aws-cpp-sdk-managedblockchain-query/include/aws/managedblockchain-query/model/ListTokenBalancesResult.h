...
class ListTokenBalancesResult {
 public:
  ...
  void SetTokenBalances(TokenBalancesT&& value) {
    m_tokenBalancesHasBeenSet = true;
    m_tokenBalances = std::forward<TokenBalancesT>(value);
  }
  template <typename TokenBalancesT = Aws::Vector<TokenBalance>>
  ListTokenBalancesResult& WithTokenBalances(TokenBalancesT&& value) {
    SetTokenBalances(std::forward<TokenBalancesT>(value));
    return *this;
  }
  template <typename TokenBalancesT = TokenBalance>
  ListTokenBalancesResult& AddTokenBalances(TokenBalancesT&& value) {
    m_tokenBalancesHasBeenSet = true;
    m_tokenBalances.emplace_back(std::forward<TokenBalancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTokenBalancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTokenBalancesResult& WithRequestId(RequestIdT&& value) {
