...
class BatchGetTokenBalanceInputItem {
 public:
  ...
  template <typename TokenIdentifierT = TokenIdentifier>
  BatchGetTokenBalanceInputItem& WithTokenIdentifier(TokenIdentifierT&& value) {
  ...
  template <typename OwnerIdentifierT = OwnerIdentifier>
  BatchGetTokenBalanceInputItem& WithOwnerIdentifier(OwnerIdentifierT&& value) {
  ...
  template <typename AtBlockchainInstantT = BlockchainInstant>
  BatchGetTokenBalanceInputItem& WithAtBlockchainInstant(AtBlockchainInstantT&& value) {
