...
class ListFilteredTransactionEventsResult {
 public:
  ...
  AWS_MANAGEDBLOCKCHAINQUERY_API ListFilteredTransactionEventsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EventsT = Aws::Vector<TransactionEvent>>
  ListFilteredTransactionEventsResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = TransactionEvent>
  ListFilteredTransactionEventsResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListFilteredTransactionEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListFilteredTransactionEventsResult& WithRequestId(RequestIdT&& value) {
