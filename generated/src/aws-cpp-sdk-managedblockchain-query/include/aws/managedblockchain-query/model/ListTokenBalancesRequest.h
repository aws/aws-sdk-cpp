...
class ListTokenBalancesRequest : public ManagedBlockchainQueryRequest {
 public:
  ...
  void SetOwnerFilter(OwnerFilterT&& value) {
    m_ownerFilterHasBeenSet = true;
    m_ownerFilter = std::forward<OwnerFilterT>(value);
  }
  template <typename OwnerFilterT = OwnerFilter>
  ListTokenBalancesRequest& WithOwnerFilter(OwnerFilterT&& value) {
    SetOwnerFilter(std::forward<OwnerFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenFilter(TokenFilterT&& value) {
    m_tokenFilterHasBeenSet = true;
    m_tokenFilter = std::forward<TokenFilterT>(value);
  }
  template <typename TokenFilterT = TokenFilter>
  ListTokenBalancesRequest& WithTokenFilter(TokenFilterT&& value) {
    SetTokenFilter(std::forward<TokenFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTokenBalancesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTokenBalancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
