...
namespace Model
{
  ...
  /**
   * <p>The service quota has been exceeded for this resource.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/managedblockchain-query-2023-05-04/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
