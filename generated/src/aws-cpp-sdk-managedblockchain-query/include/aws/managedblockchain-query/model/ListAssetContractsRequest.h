...
class ListAssetContractsRequest : public ManagedBlockchainQueryRequest {
 public:
  ...
  void SetContractFilter(ContractFilterT&& value) {
    m_contractFilterHasBeenSet = true;
    m_contractFilter = std::forward<ContractFilterT>(value);
  }
  template <typename ContractFilterT = ContractFilter>
  ListAssetContractsRequest& WithContractFilter(ContractFilterT&& value) {
    SetContractFilter(std::forward<ContractFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetContractsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssetContractsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
