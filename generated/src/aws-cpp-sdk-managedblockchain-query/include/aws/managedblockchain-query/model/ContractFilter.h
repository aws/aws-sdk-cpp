...
class ContractFilter {
 public:
  ...
  inline ContractFilter& WithNetwork(QueryNetwork value) {
    SetNetwork(value);
    return *this;
  }
  ///@}
  ...
  inline ContractFilter& WithTokenStandard(QueryTokenStandard value) {
  ...
  template <typename DeployerAddressT = Aws::String>
  ContractFilter& WithDeployerAddress(DeployerAddressT&& value) {
