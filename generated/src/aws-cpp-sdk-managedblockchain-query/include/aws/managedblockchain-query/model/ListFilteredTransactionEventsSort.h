...
class ListFilteredTransactionEventsSort {
 public:
  ...
  inline void SetSortBy(ListFilteredTransactionEventsSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListFilteredTransactionEventsSort& WithSortBy(ListFilteredTransactionEventsSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListFilteredTransactionEventsSort& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
