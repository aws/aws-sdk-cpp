...
class AWS_MANAGEDBLOCKCHAINQUERY_API ManagedBlockchainQueryClient
 ...
 public:
   ...
   */
  ManagedBlockchainQueryClient(const Aws::ManagedBlockchainQuery::ManagedBlockchainQueryClientConfiguration& clientConfiguration =
  ...
  ManagedBlockchainQueryClient(const Aws::Auth::AWSCredentials& credentials,
                               std::shared_ptr<ManagedBlockchainQueryEndpointProviderBase> endpointProvider = nullptr,
                               const Aws::ManagedBlockchainQuery::ManagedBlockchainQueryClientConfiguration& clientConfiguration =
                                   Aws::ManagedBlockchainQuery::ManagedBlockchainQueryClientConfiguration());
  ...
  /**
   * A Callable wrapper for BatchGetTokenBalance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetTokenBalance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetTokenBalanceRequestT = Model::BatchGetTokenBalanceRequest>
  void BatchGetTokenBalanceAsync(const BatchGetTokenBalanceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const BatchGetTokenBalanceRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetAssetContract that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAssetContract that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAssetContractRequestT = Model::GetAssetContractRequest>
  void GetAssetContractAsync(const GetAssetContractRequestT& request, const GetAssetContractResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for GetTokenBalance that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTokenBalanceRequestT = Model::GetTokenBalanceRequest>
  void GetTokenBalanceAsync(const GetTokenBalanceRequestT& request, const GetTokenBalanceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetTransaction that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetTransactionRequestT = Model::GetTransactionRequest>
  void GetTransactionAsync(const GetTransactionRequestT& request, const GetTransactionResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssetContracts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssetContracts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAssetContractsRequestT = Model::ListAssetContractsRequest>
  void ListAssetContractsAsync(const ListAssetContractsRequestT& request, const ListAssetContractsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::ListFilteredTransactionEventsOutcome ListFilteredTransactionEvents(
      const Model::ListFilteredTransactionEventsRequest& request) const;

  /**
   * A Callable wrapper for ListFilteredTransactionEvents that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListFilteredTransactionEventsRequestT = Model::ListFilteredTransactionEventsRequest>
  Model::ListFilteredTransactionEventsOutcomeCallable ListFilteredTransactionEventsCallable(
      const ListFilteredTransactionEventsRequestT& request) const {
    return SubmitCallable(&ManagedBlockchainQueryClient::ListFilteredTransactionEvents, request);
  }

  /**
   * An Async wrapper for ListFilteredTransactionEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFilteredTransactionEventsRequestT = Model::ListFilteredTransactionEventsRequest>
  void ListFilteredTransactionEventsAsync(const ListFilteredTransactionEventsRequestT& request,
                                          const ListFilteredTransactionEventsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTokenBalances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTokenBalances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTokenBalancesRequestT = Model::ListTokenBalancesRequest>
  void ListTokenBalancesAsync(const ListTokenBalancesRequestT& request, const ListTokenBalancesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTransactionEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTransactionEvents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTransactionEventsRequestT = Model::ListTransactionEventsRequest>
  void ListTransactionEventsAsync(const ListTransactionEventsRequestT& request, const ListTransactionEventsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListTransactionsRequestT = Model::ListTransactionsRequest>
  void ListTransactionsAsync(const ListTransactionsRequestT& request, const ListTransactionsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
