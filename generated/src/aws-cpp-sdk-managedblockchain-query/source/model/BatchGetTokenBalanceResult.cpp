...
BatchGetTokenBalanceResult::BatchGetTokenBalanceResult()
{
}

BatchGetTokenBalanceResult::BatchGetTokenBalanceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

BatchGetTokenBalanceResult& BatchGetTokenBalanceResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
