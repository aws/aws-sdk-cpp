...
const char* ManagedBlockchainQueryClient::SERVICE_NAME = "managedblockchain-query";
const char* ManagedBlockchainQueryClient::ALLOCATION_TAG = "ManagedBlockchainQueryClient";
