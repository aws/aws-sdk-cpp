...
namespace MediaPackage
{
   ...
   */
  class AWS_MEDIAPACKAGE_API MediaPackageClient : Aws::Client::ClientWithAsyncTemplateMethods<MediaPackageClient>,
    smithy::client::AwsSmithyClientT<Aws::MediaPackage::SERVICE_NAME,
