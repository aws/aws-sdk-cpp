...
rounded to the
  ...
  inline CmafPackage& WithSegmentDurationSeconds(int value) {
  ...
  void SetSegmentPrefix(SegmentPrefixT&& value) {
    ...
    m_segmentPrefix = std::forward<SegmentPrefixT>(value);
  }
  template <typename SegmentPrefixT = Aws::String>
  CmafPackage& WithSegmentPrefix(SegmentPrefixT&& value) {
    SetSegmentPrefix(std::forward<SegmentPrefixT>(value));
    return *this;
  }
  ///@}
