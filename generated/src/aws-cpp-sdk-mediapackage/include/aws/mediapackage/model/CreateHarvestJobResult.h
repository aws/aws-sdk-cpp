...
class CreateHarvestJobResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateHarvestJobResult& WithArn(ArnT&& value) {
  ...
  template <typename ChannelIdT = Aws::String>
  CreateHarvestJobResult& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename EndTimeT = Aws::String>
  CreateHarvestJobResult& WithEndTime(EndTimeT&& value) {
...
and it cannot
  ...
  template <typename IdT = Aws::String>
  CreateHarvestJobResult& WithId(IdT&& value) {
...
This cannot
  ...
  template <typename OriginEndpointIdT = Aws::String>
  CreateHarvestJobResult& WithOriginEndpointId(OriginEndpointIdT&& value) {
  ...
  template <typename S3DestinationT = S3Destination>
  CreateHarvestJobResult& WithS3Destination(S3DestinationT&& value) {
  ...
  template <typename StartTimeT = Aws::String>
  CreateHarvestJobResult& WithStartTime(StartTimeT&& value) {
...
include an explanation of why the HarvestJob failed.
  ...
  inline CreateHarvestJobResult& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
