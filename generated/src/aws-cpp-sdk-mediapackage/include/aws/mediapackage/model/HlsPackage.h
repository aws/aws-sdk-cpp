...
that is greater
  ...
  inline void SetAdMarkers(AdMarkers value) {
    m_adMarkersHasBeenSet = true;
    m_adMarkers = value;
  }
  inline HlsPackage& WithAdMarkers(AdMarkers value) {
    SetAdMarkers(value);
    return *this;
  }
  ///@}
  ...
  void SetAdTriggers(AdTriggersT&& value) {
    ...
    m_adTriggers = std::forward<AdTriggersT>(value);
  }
  template <typename AdTriggersT = Aws::Vector<__AdTriggersElement>>
  HlsPackage& WithAdTriggers(AdTriggersT&& value) {
    SetAdTriggers(std::forward<AdTriggersT>(value));
    return *this;
  }
  inline HlsPackage& AddAdTriggers(__AdTriggersElement value) {
    m_adTriggersHasBeenSet = true;
    m_adTriggers.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAdsOnDeliveryRestrictions(AdsOnDeliveryRestrictions value) {
    m_adsOnDeliveryRestrictionsHasBeenSet = true;
    m_adsOnDeliveryRestrictions = value;
  }
  inline HlsPackage& WithAdsOnDeliveryRestrictions(AdsOnDeliveryRestrictions value) {
    SetAdsOnDeliveryRestrictions(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeDvbSubtitles(bool value) {
    m_includeDvbSubtitlesHasBeenSet = true;
    m_includeDvbSubtitles = value;
  }
  inline HlsPackage& WithIncludeDvbSubtitles(bool value) {
    SetIncludeDvbSubtitles(value);
    return *this;
  }
  ///@}
  ...
  inline HlsPackage& WithIncludeIframeOnlyStream(bool value) {
...
entry will be included in the
  ...
  inline void SetPlaylistType(PlaylistType value) {
    m_playlistTypeHasBeenSet = true;
    m_playlistType = value;
  }
  inline HlsPackage& WithPlaylistType(PlaylistType value) {
  ...
  inline void SetPlaylistWindowSeconds(int value) {
    m_playlistWindowSecondsHasBeenSet = true;
    m_playlistWindowSeconds = value;
  }
  inline HlsPackage& WithPlaylistWindowSeconds(int value) {
    SetPlaylistWindowSeconds(value);
    return *this;
  }
  ///@}
...
it will
  ...
  inline HlsPackage& WithProgramDateTimeIntervalSeconds(int value) {
...
rounded to the
  ...
  inline HlsPackage& WithSegmentDurationSeconds(int value) {
  ...
  void SetStreamSelection(StreamSelectionT&& value) {
    ...
    m_streamSelection = std::forward<StreamSelectionT>(value);
  }
  template <typename StreamSelectionT = StreamSelection>
  HlsPackage& WithStreamSelection(StreamSelectionT&& value) {
    SetStreamSelection(std::forward<StreamSelectionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUseAudioRenditionGroup(bool value) {
    m_useAudioRenditionGroupHasBeenSet = true;
    m_useAudioRenditionGroup = value;
  }
  inline HlsPackage& WithUseAudioRenditionGroup(bool value) {
    SetUseAudioRenditionGroup(value);
    return *this;
  }
  ///@}
 private:
