...
class ListOriginEndpointsResult {
 public:
  ...
  void SetOriginEndpoints(OriginEndpointsT&& value) {
    m_originEndpointsHasBeenSet = true;
    m_originEndpoints = std::forward<OriginEndpointsT>(value);
  }
  template <typename OriginEndpointsT = Aws::Vector<OriginEndpoint>>
  ListOriginEndpointsResult& WithOriginEndpoints(OriginEndpointsT&& value) {
    SetOriginEndpoints(std::forward<OriginEndpointsT>(value));
    return *this;
  }
  template <typename OriginEndpointsT = OriginEndpoint>
  ListOriginEndpointsResult& AddOriginEndpoints(OriginEndpointsT&& value) {
    m_originEndpointsHasBeenSet = true;
    m_originEndpoints.emplace_back(std::forward<OriginEndpointsT>(value));
    return *this;
  }
  ///@}
