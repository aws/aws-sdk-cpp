...
class StreamSelection {
 public:
  ...
  inline void SetMaxVideoBitsPerSecond(int value) {
    m_maxVideoBitsPerSecondHasBeenSet = true;
    m_maxVideoBitsPerSecond = value;
  }
  inline StreamSelection& WithMaxVideoBitsPerSecond(int value) {
    SetMaxVideoBitsPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinVideoBitsPerSecond(int value) {
    m_minVideoBitsPerSecondHasBeenSet = true;
    m_minVideoBitsPerSecond = value;
  }
  inline StreamSelection& WithMinVideoBitsPerSecond(int value) {
    SetMinVideoBitsPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStreamOrder(StreamOrder value) {
    m_streamOrderHasBeenSet = true;
    m_streamOrder = value;
  }
  inline StreamSelection& WithStreamOrder(StreamOrder value) {
    SetStreamOrder(value);
    return *this;
  }
  ///@}
 private:
