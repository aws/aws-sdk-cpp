...
class OriginEndpoint {
 public:
  ...
  template <typename ArnT = Aws::String>
  OriginEndpoint& WithArn(ArnT&& value) {
  ...
  template <typename AuthorizationT = Authorization>
  OriginEndpoint& WithAuthorization(AuthorizationT&& value) {
  ...
  template <typename ChannelIdT = Aws::String>
  OriginEndpoint& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename CmafPackageT = CmafPackage>
  OriginEndpoint& WithCmafPackage(CmafPackageT&& value) {
  ...
  template <typename CreatedAtT = Aws::String>
  OriginEndpoint& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DashPackageT = DashPackage>
  OriginEndpoint& WithDashPackage(DashPackageT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  OriginEndpoint& WithDescription(DescriptionT&& value) {
  ...
  template <typename HlsPackageT = HlsPackage>
  OriginEndpoint& WithHlsPackage(HlsPackageT&& value) {
  ...
  template <typename IdT = Aws::String>
  OriginEndpoint& WithId(IdT&& value) {
  ...
  template <typename ManifestNameT = Aws::String>
  OriginEndpoint& WithManifestName(ManifestNameT&& value) {
  ...
  template <typename MssPackageT = MssPackage>
  OriginEndpoint& WithMssPackage(MssPackageT&& value) {
...
requested. This
  ...
  inline OriginEndpoint& WithOrigination(Origination value) {
...
If not
  ...
  inline OriginEndpoint& WithStartoverWindowSeconds(int value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  OriginEndpoint& WithTags(TagsT&& value) {
...
If not
  ...
  inline OriginEndpoint& WithTimeDelaySeconds(int value) {
  ...
  template <typename UrlT = Aws::String>
  OriginEndpoint& WithUrl(UrlT&& value) {
  ...
  template <typename WhitelistT = Aws::Vector<Aws::String>>
  OriginEndpoint& WithWhitelist(WhitelistT&& value) {
    SetWhitelist(std::forward<WhitelistT>(value));
    return *this;
  }
  template <typename WhitelistT = Aws::String>
  OriginEndpoint& AddWhitelist(WhitelistT&& value) {
    m_whitelistHasBeenSet = true;
