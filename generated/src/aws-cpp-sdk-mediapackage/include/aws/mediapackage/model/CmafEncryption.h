...
class CmafEncryption {
 public:
  ...
  inline void SetEncryptionMethod(CmafEncryptionMethod value) {
    m_encryptionMethodHasBeenSet = true;
    m_encryptionMethod = value;
  }
  inline CmafEncryption& WithEncryptionMethod(CmafEncryptionMethod value) {
  ...
  inline CmafEncryption& WithKeyRotationIntervalSeconds(int value) {
