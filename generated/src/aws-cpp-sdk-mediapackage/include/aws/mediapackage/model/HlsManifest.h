...
that is greater
  ...
  inline HlsManifest& WithAdMarkers(AdMarkers value) {
    SetAdMarkers(value);
    return *this;
  }
  ///@}
  ...
  inline HlsManifest& WithIncludeIframeOnlyStream(bool value) {
...
entry will be included in the
  ...
  inline HlsManifest& WithPlaylistType(PlaylistType value) {
  ...
  inline HlsManifest& WithPlaylistWindowSeconds(int value) {
...
it will
  ...
  inline HlsManifest& WithProgramDateTimeIntervalSeconds(int value) {
  ...
  inline HlsManifest& AddAdTriggers(__AdTriggersElement value) {
    m_adTriggersHasBeenSet = true;
  ...
  inline HlsManifest& WithAdsOnDeliveryRestrictions(AdsOnDeliveryRestrictions value) {
