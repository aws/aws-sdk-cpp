...
class ListHarvestJobsRequest : public MediaPackageRequest {
 public:
  ...
  void SetIncludeChannelId(IncludeChannelIdT&& value) {
    m_includeChannelIdHasBeenSet = true;
    m_includeChannelId = std::forward<IncludeChannelIdT>(value);
  }
  template <typename IncludeChannelIdT = Aws::String>
  ListHarvestJobsRequest& WithIncludeChannelId(IncludeChannelIdT&& value) {
    SetIncludeChannelId(std::forward<IncludeChannelIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IncludeStatusT = Aws::String>
  ListHarvestJobsRequest& WithIncludeStatus(IncludeStatusT&& value) {
