...
class ListOriginEndpointsRequest : public MediaPackageRequest {
 public:
  AWS_MEDIAPACKAGE_API ListOriginEndpointsRequest() = default;
  ...
  template <typename ChannelIdT = Aws::String>
  ListOriginEndpointsRequest& WithChannelId(ChannelIdT&& value) {
  ...
  inline ListOriginEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOriginEndpointsRequest& WithNextToken(NextTokenT&& value) {
