...
class DashPackage {
 public:
  ...
  inline DashPackage& AddAdTriggers(__AdTriggersElement value) {
    m_adTriggersHasBeenSet = true;
  ...
  inline DashPackage& WithAdsOnDeliveryRestrictions(AdsOnDeliveryRestrictions value) {
  ...
  inline DashPackage& WithManifestLayout(ManifestLayout value) {
  ...
  inline DashPackage& WithManifestWindowSeconds(int value) {
  ...
  inline DashPackage& WithMinBufferTimeSeconds(int value) {
  ...
  inline DashPackage& WithMinUpdatePeriodSeconds(int value) {
...
the
  ...
  inline DashPackage& WithProfile(Profile value) {
    SetProfile(value);
    return *this;
  }
  ///@}
...
rounded to the
  ...
  inline DashPackage& WithSuggestedPresentationDelaySeconds(int value) {
  ...
  inline void SetUtcTiming(UtcTiming value) {
    m_utcTimingHasBeenSet = true;
    m_utcTiming = value;
  }
  inline DashPackage& WithUtcTiming(UtcTiming value) {
    SetUtcTiming(value);
    return *this;
  }
  ///@}
  ...
  void SetUtcTimingUri(UtcTimingUriT&& value) {
    ...
    m_utcTimingUri = std::forward<UtcTimingUriT>(value);
  }
  template <typename UtcTimingUriT = Aws::String>
  DashPackage& WithUtcTimingUri(UtcTimingUriT&& value) {
    SetUtcTimingUri(std::forward<UtcTimingUriT>(value));
    return *this;
  }
  ///@}
 private:
