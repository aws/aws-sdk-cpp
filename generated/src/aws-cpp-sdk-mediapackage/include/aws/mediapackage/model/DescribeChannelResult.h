...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIAPACKAGE_API DescribeChannelResult() = default;
    ...
    template<typename CreatedAtT = Aws::String>
    DescribeChannelResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    DescribeChannelResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename EgressAccessLogsT = EgressAccessLogs>
    DescribeChannelResult& WithEgressAccessLogs(EgressAccessLogsT&& value) { SetEgressAccessLogs(std::forward<EgressAccessLogsT>(value)); return *this;}
    ///@}
    ...
    template<typename HlsIngestT = HlsIngest>
    DescribeChannelResult& WithHlsIngest(HlsIngestT&& value) { SetHlsIngest(std::forward<HlsIngestT>(value)); return *this;}
    ///@}
    ...
    template<typename IngressAccessLogsT = IngressAccessLogs>
    DescribeChannelResult& WithIngressAccessLogs(IngressAccessLogsT&& value) { SetIngressAccessLogs(std::forward<IngressAccessLogsT>(value)); return *this;}
    ///@}
