...
class DescribeChannelResult {
 public:
  ...
  template <typename CreatedAtT = Aws::String>
  DescribeChannelResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeChannelResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename EgressAccessLogsT = EgressAccessLogs>
  DescribeChannelResult& WithEgressAccessLogs(EgressAccessLogsT&& value) {
  ...
  template <typename HlsIngestT = HlsIngest>
  DescribeChannelResult& WithHlsIngest(HlsIngestT&& value) {
  ...
  template <typename IngressAccessLogsT = IngressAccessLogs>
  DescribeChannelResult& WithIngressAccessLogs(IngressAccessLogsT&& value) {
