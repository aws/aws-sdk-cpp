...
that is greater
  ...
  inline HlsManifestCreateOrUpdateParameters& WithAdMarkers(AdMarkers value) {
    SetAdMarkers(value);
    return *this;
  }
  ///@}
  ...
  template <typename AdTriggersT = Aws::Vector<__AdTriggersElement>>
  HlsManifestCreateOrUpdateParameters& WithAdTriggers(AdTriggersT&& value) {
    SetAdTriggers(std::forward<AdTriggersT>(value));
    return *this;
  }
  inline HlsManifestCreateOrUpdateParameters& AddAdTriggers(__AdTriggersElement value) {
    m_adTriggersHasBeenSet = true;
  ...
  inline HlsManifestCreateOrUpdateParameters& WithAdsOnDeliveryRestrictions(AdsOnDeliveryRestrictions value) {
  ...
  template <typename IdT = Aws::String>
  HlsManifestCreateOrUpdateParameters& WithId(IdT&& value) {
  ...
  inline HlsManifestCreateOrUpdateParameters& WithIncludeIframeOnlyStream(bool value) {
  ...
  template <typename ManifestNameT = Aws::String>
  HlsManifestCreateOrUpdateParameters& WithManifestName(ManifestNameT&& value) {
...
entry will be included in the
  ...
  inline HlsManifestCreateOrUpdateParameters& WithPlaylistType(PlaylistType value) {
  ...
  inline HlsManifestCreateOrUpdateParameters& WithPlaylistWindowSeconds(int value) {
...
it will
  ...
  inline HlsManifestCreateOrUpdateParameters& WithProgramDateTimeIntervalSeconds(int value) {
