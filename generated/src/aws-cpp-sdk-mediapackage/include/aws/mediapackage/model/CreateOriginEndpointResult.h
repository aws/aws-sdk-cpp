...
class CreateOriginEndpointResult {
 public:
  ...
  template <typename AuthorizationT = Authorization>
  CreateOriginEndpointResult& WithAuthorization(AuthorizationT&& value) {
  ...
  template <typename ChannelIdT = Aws::String>
  CreateOriginEndpointResult& WithChannelId(ChannelIdT&& value) {
  ...
  template <typename CmafPackageT = CmafPackage>
  CreateOriginEndpointResult& WithCmafPackage(CmafPackageT&& value) {
  ...
  template <typename DashPackageT = DashPackage>
  CreateOriginEndpointResult& WithDashPackage(DashPackageT&& value) {
  ...
  template <typename HlsPackageT = HlsPackage>
  CreateOriginEndpointResult& WithHlsPackage(HlsPackageT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateOriginEndpointResult& WithId(IdT&& value) {
  ...
  template <typename ManifestNameT = Aws::String>
  CreateOriginEndpointResult& WithManifestName(ManifestNameT&& value) {
  ...
  template <typename MssPackageT = MssPackage>
  CreateOriginEndpointResult& WithMssPackage(MssPackageT&& value) {
...
requested. This
  ...
  inline CreateOriginEndpointResult& WithOrigination(Origination value) {
...
If not
  ...
  inline CreateOriginEndpointResult& WithTimeDelaySeconds(int value) {
  ...
  template <typename UrlT = Aws::String>
  CreateOriginEndpointResult& WithUrl(UrlT&& value) {
  ...
  template <typename WhitelistT = Aws::Vector<Aws::String>>
  CreateOriginEndpointResult& WithWhitelist(WhitelistT&& value) {
    SetWhitelist(std::forward<WhitelistT>(value));
    return *this;
  }
  template <typename WhitelistT = Aws::String>
  CreateOriginEndpointResult& AddWhitelist(WhitelistT&& value) {
    m_whitelistHasBeenSet = true;
