...
class CreateChannelResult {
 public:
  ...
  template <typename EgressAccessLogsT = EgressAccessLogs>
  CreateChannelResult& WithEgressAccessLogs(EgressAccessLogsT&& value) {
  ...
  template <typename HlsIngestT = HlsIngest>
  CreateChannelResult& WithHlsIngest(HlsIngestT&& value) {
  ...
  template <typename IdT = Aws::String>
  CreateChannelResult& WithId(IdT&& value) {
  ...
  template <typename IngressAccessLogsT = IngressAccessLogs>
  CreateChannelResult& WithIngressAccessLogs(IngressAccessLogsT&& value) {
