...
class CmafPackageCreateOrUpdateParameters {
 public:
  AWS_MEDIAPACKAGE_API CmafPackageCreateOrUpdateParameters() = default;
  ...
  template <typename EncryptionT = CmafEncryption>
  CmafPackageCreateOrUpdateParameters& WithEncryption(EncryptionT&& value) {
  ...
  template <typename HlsManifestsT = Aws::Vector<HlsManifestCreateOrUpdateParameters>>
  void SetHlsManifests(HlsManifestsT&& value) {
    m_hlsManifestsHasBeenSet = true;
    m_hlsManifests = std::forward<HlsManifestsT>(value);
  }
  template <typename HlsManifestsT = Aws::Vector<HlsManifestCreateOrUpdateParameters>>
  CmafPackageCreateOrUpdateParameters& WithHlsManifests(HlsManifestsT&& value) {
    SetHlsManifests(std::forward<HlsManifestsT>(value));
    return *this;
  }
  template <typename HlsManifestsT = HlsManifestCreateOrUpdateParameters>
  CmafPackageCreateOrUpdateParameters& AddHlsManifests(HlsManifestsT&& value) {
    m_hlsManifestsHasBeenSet = true;
...
rounded to the
  ...
  inline CmafPackageCreateOrUpdateParameters& WithSegmentDurationSeconds(int value) {
  ...
  template <typename SegmentPrefixT = Aws::String>
  CmafPackageCreateOrUpdateParameters& WithSegmentPrefix(SegmentPrefixT&& value) {
  ...
  template <typename StreamSelectionT = StreamSelection>
  CmafPackageCreateOrUpdateParameters& WithStreamSelection(StreamSelectionT&& value) {
