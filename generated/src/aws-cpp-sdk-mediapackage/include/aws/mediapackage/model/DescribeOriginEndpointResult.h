...
namespace Model
{
  ...
  public:
    ...
    template<typename ArnT = Aws::String>
    DescribeOriginEndpointResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizationT = Authorization>
    DescribeOriginEndpointResult& WithAuthorization(AuthorizationT&& value) { SetAuthorization(std::forward<AuthorizationT>(value)); return *this;}
    ///@}
    ...
    template<typename ChannelIdT = Aws::String>
    DescribeOriginEndpointResult& WithChannelId(ChannelIdT&& value) { SetChannelId(std::forward<ChannelIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CmafPackageT = CmafPackage>
    DescribeOriginEndpointResult& WithCmafPackage(CmafPackageT&& value) { SetCmafPackage(std::forward<CmafPackageT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::String>
    DescribeOriginEndpointResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename DashPackageT = DashPackage>
    DescribeOriginEndpointResult& WithDashPackage(DashPackageT&& value) { SetDashPackage(std::forward<DashPackageT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    DescribeOriginEndpointResult& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename HlsPackageT = HlsPackage>
    DescribeOriginEndpointResult& WithHlsPackage(HlsPackageT&& value) { SetHlsPackage(std::forward<HlsPackageT>(value)); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DescribeOriginEndpointResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ManifestNameT = Aws::String>
    DescribeOriginEndpointResult& WithManifestName(ManifestNameT&& value) { SetManifestName(std::forward<ManifestNameT>(value)); return *this;}
    ///@}
    ...
    template<typename MssPackageT = MssPackage>
    DescribeOriginEndpointResult& WithMssPackage(MssPackageT&& value) { SetMssPackage(std::forward<MssPackageT>(value)); return *this;}
    ///@}
...
requested. This
    ...
    inline DescribeOriginEndpointResult& WithOrigination(Origination value) { SetOrigination(value); return *this;}
    ///@}
...
If not
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    DescribeOriginEndpointResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
...
If not
    ...
    template<typename UrlT = Aws::String>
    DescribeOriginEndpointResult& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
    ...
    template<typename WhitelistT = Aws::Vector<Aws::String>>
    DescribeOriginEndpointResult& WithWhitelist(WhitelistT&& value) { SetWhitelist(std::forward<WhitelistT>(value)); return *this;}
    template<typename WhitelistT = Aws::String>
    DescribeOriginEndpointResult& AddWhitelist(WhitelistT&& value) { m_whitelistHasBeenSet = true; m_whitelist.emplace_back(std::forward<WhitelistT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DescribeOriginEndpointResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
