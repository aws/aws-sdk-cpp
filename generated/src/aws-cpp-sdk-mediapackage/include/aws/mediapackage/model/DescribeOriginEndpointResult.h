...
class DescribeOriginEndpointResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  DescribeOriginEndpointResult& WithArn(ArnT&& value) {
  ...
  template <typename IdT = Aws::String>
  DescribeOriginEndpointResult& WithId(IdT&& value) {
...
requested. This
  ...
  inline DescribeOriginEndpointResult& WithOrigination(Origination value) {
...
If not
  ...
  inline DescribeOriginEndpointResult& WithStartoverWindowSeconds(int value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  DescribeOriginEndpointResult& WithTags(TagsT&& value) {
...
If not
  ...
  inline DescribeOriginEndpointResult& WithTimeDelaySeconds(int value) {
  ...
  template <typename UrlT = Aws::String>
  DescribeOriginEndpointResult& WithUrl(UrlT&& value) {
