...
class RotateIngestEndpointCredentialsRequest : public MediaPackageRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  RotateIngestEndpointCredentialsRequest& WithId(IdT&& value) {
  ...
  void SetIngestEndpointId(IngestEndpointIdT&& value) {
    m_ingestEndpointIdHasBeenSet = true;
    m_ingestEndpointId = std::forward<IngestEndpointIdT>(value);
  }
  template <typename IngestEndpointIdT = Aws::String>
  RotateIngestEndpointCredentialsRequest& WithIngestEndpointId(IngestEndpointIdT&& value) {
    SetIngestEndpointId(std::forward<IngestEndpointIdT>(value));
    return *this;
  }
  ///@}
 private:
