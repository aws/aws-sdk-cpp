...
class UpdateChannelResult {
 public:
  ...
  template <typename EgressAccessLogsT = EgressAccessLogs>
  UpdateChannelResult& WithEgressAccessLogs(EgressAccessLogsT&& value) {
  ...
  template <typename HlsIngestT = HlsIngest>
  UpdateChannelResult& WithHlsIngest(HlsIngestT&& value) {
  ...
  template <typename IdT = Aws::String>
  UpdateChannelResult& WithId(IdT&& value) {
  ...
  template <typename IngressAccessLogsT = IngressAccessLogs>
  UpdateChannelResult& WithIngressAccessLogs(IngressAccessLogsT&& value) {
