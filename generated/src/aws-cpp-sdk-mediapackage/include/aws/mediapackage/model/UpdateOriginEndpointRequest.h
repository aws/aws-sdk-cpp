...
class UpdateOriginEndpointRequest : public MediaPackageRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateOriginEndpointRequest& WithId(IdT&& value) {
...
requested. This
  ...
  inline UpdateOriginEndpointRequest& WithOrigination(Origination value) {
...
If not
  ...
  inline UpdateOriginEndpointRequest& WithTimeDelaySeconds(int value) {
