...
include an explanation of why the HarvestJob failed.
    ...
    inline DescribeHarvestJobResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DescribeHarvestJobResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DescribeHarvestJobResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
