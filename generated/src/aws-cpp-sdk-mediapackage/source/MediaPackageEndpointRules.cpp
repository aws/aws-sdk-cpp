...
{
const size_t MediaPackageEndpointRules::RulesBlobStrLen = 3478;
const size_t MediaPackageEndpointRules::RulesBlobSize = 3479;
...
'a','c','k','a','g','e','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
't','p','s',':','/','/','m','e','d','i','a','p','a','c','k','a','g','e','-','f','i','p','s','.','{',
...
'm','e','d','i','a','p','a','c','k','a','g','e','.','{','R','e','g','i','o','n','}','.','{','P','a',
