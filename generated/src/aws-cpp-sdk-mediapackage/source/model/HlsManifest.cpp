...
HlsManifest::HlsManifest(JsonView jsonValue) { *this = jsonValue; }
...
HlsManifest& HlsManifest::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("adsOnDeliveryRestrictions")) {
    m_adsOnDeliveryRestrictions =
        AdsOnDeliveryRestrictionsMapper::GetAdsOnDeliveryRestrictionsForName(jsonValue.GetString("adsOnDeliveryRestrictions"));
...
JsonValue HlsManifest::Jsonize() const {
  ...
  if (m_adsOnDeliveryRestrictionsHasBeenSet) {
    payload.WithString("adsOnDeliveryRestrictions",
                       AdsOnDeliveryRestrictionsMapper::GetNameForAdsOnDeliveryRestrictions(m_adsOnDeliveryRestrictions));
  }
