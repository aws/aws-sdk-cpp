...
class AWS_NEPTUNEDATA_API NeptunedataClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NeptunedataClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<NeptunedataEndpointProviderBase> endpointProvider = nullptr,
      const Aws::neptunedata::NeptunedataClientConfiguration& clientConfiguration = Aws::neptunedata::NeptunedataClientConfiguration());
  ...
  /**
   * A Callable wrapper for CancelGremlinQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelGremlinQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelGremlinQueryRequestT = Model::CancelGremlinQueryRequest>
  void CancelGremlinQueryAsync(const CancelGremlinQueryRequestT& request, const CancelGremlinQueryResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CancelLoaderJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelLoaderJobRequestT = Model::CancelLoaderJobRequest>
  void CancelLoaderJobAsync(const CancelLoaderJobRequestT& request, const CancelLoaderJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelMLDataProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelMLDataProcessingJobRequestT = Model::CancelMLDataProcessingJobRequest>
  Model::CancelMLDataProcessingJobOutcomeCallable CancelMLDataProcessingJobCallable(
      const CancelMLDataProcessingJobRequestT& request) const {
    return SubmitCallable(&NeptunedataClient::CancelMLDataProcessingJob, request);
  }

  /**
   * An Async wrapper for CancelMLDataProcessingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMLDataProcessingJobRequestT = Model::CancelMLDataProcessingJobRequest>
  void CancelMLDataProcessingJobAsync(const CancelMLDataProcessingJobRequestT& request,
                                      const CancelMLDataProcessingJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelMLModelTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelMLModelTrainingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMLModelTrainingJobRequestT = Model::CancelMLModelTrainingJobRequest>
  void CancelMLModelTrainingJobAsync(const CancelMLModelTrainingJobRequestT& request,
                                     const CancelMLModelTrainingJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelMLModelTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CancelMLModelTransformJobRequestT = Model::CancelMLModelTransformJobRequest>
  Model::CancelMLModelTransformJobOutcomeCallable CancelMLModelTransformJobCallable(
      const CancelMLModelTransformJobRequestT& request) const {
    return SubmitCallable(&NeptunedataClient::CancelMLModelTransformJob, request);
  }

  /**
   * An Async wrapper for CancelMLModelTransformJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelMLModelTransformJobRequestT = Model::CancelMLModelTransformJobRequest>
  void CancelMLModelTransformJobAsync(const CancelMLModelTransformJobRequestT& request,
                                      const CancelMLModelTransformJobResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CancelOpenCypherQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CancelOpenCypherQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CancelOpenCypherQueryRequestT = Model::CancelOpenCypherQueryRequest>
  void CancelOpenCypherQueryAsync(const CancelOpenCypherQueryRequestT& request, const CancelOpenCypherQueryResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMLEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMLEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateMLEndpointRequestT = Model::CreateMLEndpointRequest>
  void CreateMLEndpointAsync(const CreateMLEndpointResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const CreateMLEndpointRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteMLEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMLEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteMLEndpointRequestT = Model::DeleteMLEndpointRequest>
  void DeleteMLEndpointAsync(const DeleteMLEndpointRequestT& request, const DeleteMLEndpointResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePropertygraphStatisticsOutcome DeletePropertygraphStatistics(
      const Model::DeletePropertygraphStatisticsRequest& request = {}) const;

  /**
   * A Callable wrapper for DeletePropertygraphStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeletePropertygraphStatisticsRequestT = Model::DeletePropertygraphStatisticsRequest>
  Model::DeletePropertygraphStatisticsOutcomeCallable DeletePropertygraphStatisticsCallable(
      const DeletePropertygraphStatisticsRequestT& request = {}) const {
    return SubmitCallable(&NeptunedataClient::DeletePropertygraphStatistics, request);
  }

  /**
   * An Async wrapper for DeletePropertygraphStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePropertygraphStatisticsRequestT = Model::DeletePropertygraphStatisticsRequest>
  void DeletePropertygraphStatisticsAsync(const DeletePropertygraphStatisticsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DeletePropertygraphStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteSparqlStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSparqlStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSparqlStatisticsRequestT = Model::DeleteSparqlStatisticsRequest>
  void DeleteSparqlStatisticsAsync(const DeleteSparqlStatisticsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DeleteSparqlStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ExecuteFastReset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteFastReset that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ExecuteFastResetRequestT = Model::ExecuteFastResetRequest>
  void ExecuteFastResetAsync(const ExecuteFastResetRequestT& request, const ExecuteFastResetResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExecuteGremlinExplainQueryOutcome ExecuteGremlinExplainQuery(
      const Model::ExecuteGremlinExplainQueryRequest& request) const;

  /**
   * A Callable wrapper for ExecuteGremlinExplainQuery that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExecuteGremlinExplainQueryRequestT = Model::ExecuteGremlinExplainQueryRequest>
  Model::ExecuteGremlinExplainQueryOutcomeCallable ExecuteGremlinExplainQueryCallable(
      const ExecuteGremlinExplainQueryRequestT& request) const {
    return SubmitCallable(&NeptunedataClient::ExecuteGremlinExplainQuery, request);
  }

  /**
   * An Async wrapper for ExecuteGremlinExplainQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteGremlinExplainQueryRequestT = Model::ExecuteGremlinExplainQueryRequest>
  void ExecuteGremlinExplainQueryAsync(const ExecuteGremlinExplainQueryRequestT& request,
                                       const ExecuteGremlinExplainQueryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExecuteGremlinProfileQueryOutcome ExecuteGremlinProfileQuery(
      const Model::ExecuteGremlinProfileQueryRequest& request) const;

  /**
   * A Callable wrapper for ExecuteGremlinProfileQuery that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExecuteGremlinProfileQueryRequestT = Model::ExecuteGremlinProfileQueryRequest>
  Model::ExecuteGremlinProfileQueryOutcomeCallable ExecuteGremlinProfileQueryCallable(
      const ExecuteGremlinProfileQueryRequestT& request) const {
    return SubmitCallable(&NeptunedataClient::ExecuteGremlinProfileQuery, request);
  }

  /**
   * An Async wrapper for ExecuteGremlinProfileQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteGremlinProfileQueryRequestT = Model::ExecuteGremlinProfileQueryRequest>
  void ExecuteGremlinProfileQueryAsync(const ExecuteGremlinProfileQueryRequestT& request,
                                       const ExecuteGremlinProfileQueryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExecuteGremlinQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteGremlinQuery that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ExecuteGremlinQueryRequestT = Model::ExecuteGremlinQueryRequest>
  void ExecuteGremlinQueryAsync(const ExecuteGremlinQueryRequestT& request, const ExecuteGremlinQueryResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ExecuteOpenCypherExplainQueryOutcome ExecuteOpenCypherExplainQuery(
      const Model::ExecuteOpenCypherExplainQueryRequest& request) const;

  /**
   * A Callable wrapper for ExecuteOpenCypherExplainQuery that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ExecuteOpenCypherExplainQueryRequestT = Model::ExecuteOpenCypherExplainQueryRequest>
  Model::ExecuteOpenCypherExplainQueryOutcomeCallable ExecuteOpenCypherExplainQueryCallable(
      const ExecuteOpenCypherExplainQueryRequestT& request) const {
    return SubmitCallable(&NeptunedataClient::ExecuteOpenCypherExplainQuery, request);
  }

  /**
   * An Async wrapper for ExecuteOpenCypherExplainQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteOpenCypherExplainQueryRequestT = Model::ExecuteOpenCypherExplainQueryRequest>
  void ExecuteOpenCypherExplainQueryAsync(const ExecuteOpenCypherExplainQueryRequestT& request,
                                          const ExecuteOpenCypherExplainQueryResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ExecuteOpenCypherQuery that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ExecuteOpenCypherQuery that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ExecuteOpenCypherQueryRequestT = Model::ExecuteOpenCypherQueryRequest>
  void ExecuteOpenCypherQueryAsync(const ExecuteOpenCypherQueryRequestT& request,
                                   const ExecuteOpenCypherQueryResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetEngineStatus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetEngineStatusRequestT = Model::GetEngineStatusRequest>
  void GetEngineStatusAsync(const GetEngineStatusResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetEngineStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetGremlinQueryStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetGremlinQueryStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetGremlinQueryStatusRequestT = Model::GetGremlinQueryStatusRequest>
  void GetGremlinQueryStatusAsync(const GetGremlinQueryStatusRequestT& request, const GetGremlinQueryStatusResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLoaderJobStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLoaderJobStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetLoaderJobStatusRequestT = Model::GetLoaderJobStatusRequest>
  void GetLoaderJobStatusAsync(const GetLoaderJobStatusRequestT& request, const GetLoaderJobStatusResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMLDataProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMLDataProcessingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMLDataProcessingJobRequestT = Model::GetMLDataProcessingJobRequest>
  void GetMLDataProcessingJobAsync(const GetMLDataProcessingJobRequestT& request,
                                   const GetMLDataProcessingJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetMLEndpoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetMLEndpointRequestT = Model::GetMLEndpointRequest>
  void GetMLEndpointAsync(const GetMLEndpointRequestT& request, const GetMLEndpointResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMLModelTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMLModelTrainingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMLModelTrainingJobRequestT = Model::GetMLModelTrainingJobRequest>
  void GetMLModelTrainingJobAsync(const GetMLModelTrainingJobRequestT& request, const GetMLModelTrainingJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMLModelTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMLModelTransformJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetMLModelTransformJobRequestT = Model::GetMLModelTransformJobRequest>
  void GetMLModelTransformJobAsync(const GetMLModelTransformJobRequestT& request,
                                   const GetMLModelTransformJobResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOpenCypherQueryStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOpenCypherQueryStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOpenCypherQueryStatusRequestT = Model::GetOpenCypherQueryStatusRequest>
  void GetOpenCypherQueryStatusAsync(const GetOpenCypherQueryStatusRequestT& request,
                                     const GetOpenCypherQueryStatusResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetPropertygraphStatisticsOutcome GetPropertygraphStatistics(
      const Model::GetPropertygraphStatisticsRequest& request = {}) const;

  /**
   * A Callable wrapper for GetPropertygraphStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetPropertygraphStatisticsRequestT = Model::GetPropertygraphStatisticsRequest>
  Model::GetPropertygraphStatisticsOutcomeCallable GetPropertygraphStatisticsCallable(
      const GetPropertygraphStatisticsRequestT& request = {}) const {
    return SubmitCallable(&NeptunedataClient::GetPropertygraphStatistics, request);
  }

  /**
   * An Async wrapper for GetPropertygraphStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPropertygraphStatisticsRequestT = Model::GetPropertygraphStatisticsRequest>
  void GetPropertygraphStatisticsAsync(const GetPropertygraphStatisticsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const GetPropertygraphStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetPropertygraphStream that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPropertygraphStream that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPropertygraphStreamRequestT = Model::GetPropertygraphStreamRequest>
  void GetPropertygraphStreamAsync(const GetPropertygraphStreamResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const GetPropertygraphStreamRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetPropertygraphSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPropertygraphSummary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPropertygraphSummaryRequestT = Model::GetPropertygraphSummaryRequest>
  void GetPropertygraphSummaryAsync(const GetPropertygraphSummaryResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const GetPropertygraphSummaryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetRDFGraphSummary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRDFGraphSummary that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetRDFGraphSummaryRequestT = Model::GetRDFGraphSummaryRequest>
  void GetRDFGraphSummaryAsync(const GetRDFGraphSummaryResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const GetRDFGraphSummaryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSparqlStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSparqlStatistics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetSparqlStatisticsRequestT = Model::GetSparqlStatisticsRequest>
  void GetSparqlStatisticsAsync(const GetSparqlStatisticsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetSparqlStatisticsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetSparqlStream that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSparqlStreamRequestT = Model::GetSparqlStreamRequest>
  void GetSparqlStreamAsync(const GetSparqlStreamResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const GetSparqlStreamRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListGremlinQueries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListGremlinQueries that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListGremlinQueriesRequestT = Model::ListGremlinQueriesRequest>
  void ListGremlinQueriesAsync(const ListGremlinQueriesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListGremlinQueriesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListLoaderJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListLoaderJobsRequestT = Model::ListLoaderJobsRequest>
  void ListLoaderJobsAsync(const ListLoaderJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListLoaderJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMLDataProcessingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListMLDataProcessingJobsRequestT = Model::ListMLDataProcessingJobsRequest>
  Model::ListMLDataProcessingJobsOutcomeCallable ListMLDataProcessingJobsCallable(
      const ListMLDataProcessingJobsRequestT& request = {}) const {
    return SubmitCallable(&NeptunedataClient::ListMLDataProcessingJobs, request);
  }

  /**
   * An Async wrapper for ListMLDataProcessingJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMLDataProcessingJobsRequestT = Model::ListMLDataProcessingJobsRequest>
  void ListMLDataProcessingJobsAsync(const ListMLDataProcessingJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListMLDataProcessingJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListMLEndpoints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMLEndpointsRequestT = Model::ListMLEndpointsRequest>
  void ListMLEndpointsAsync(const ListMLEndpointsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListMLEndpointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMLModelTrainingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMLModelTrainingJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMLModelTrainingJobsRequestT = Model::ListMLModelTrainingJobsRequest>
  void ListMLModelTrainingJobsAsync(const ListMLModelTrainingJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListMLModelTrainingJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMLModelTransformJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListMLModelTransformJobsRequestT = Model::ListMLModelTransformJobsRequest>
  Model::ListMLModelTransformJobsOutcomeCallable ListMLModelTransformJobsCallable(
      const ListMLModelTransformJobsRequestT& request = {}) const {
    return SubmitCallable(&NeptunedataClient::ListMLModelTransformJobs, request);
  }

  /**
   * An Async wrapper for ListMLModelTransformJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMLModelTransformJobsRequestT = Model::ListMLModelTransformJobsRequest>
  void ListMLModelTransformJobsAsync(const ListMLModelTransformJobsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListMLModelTransformJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOpenCypherQueries that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOpenCypherQueries that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOpenCypherQueriesRequestT = Model::ListOpenCypherQueriesRequest>
  void ListOpenCypherQueriesAsync(const ListOpenCypherQueriesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListOpenCypherQueriesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ManagePropertygraphStatisticsOutcome ManagePropertygraphStatistics(
      const Model::ManagePropertygraphStatisticsRequest& request = {}) const;

  /**
   * A Callable wrapper for ManagePropertygraphStatistics that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ManagePropertygraphStatisticsRequestT = Model::ManagePropertygraphStatisticsRequest>
  Model::ManagePropertygraphStatisticsOutcomeCallable ManagePropertygraphStatisticsCallable(
      const ManagePropertygraphStatisticsRequestT& request = {}) const {
    return SubmitCallable(&NeptunedataClient::ManagePropertygraphStatistics, request);
  }

  /**
   * An Async wrapper for ManagePropertygraphStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ManagePropertygraphStatisticsRequestT = Model::ManagePropertygraphStatisticsRequest>
  void ManagePropertygraphStatisticsAsync(const ManagePropertygraphStatisticsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ManagePropertygraphStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ManageSparqlStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ManageSparqlStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ManageSparqlStatisticsRequestT = Model::ManageSparqlStatisticsRequest>
  void ManageSparqlStatisticsAsync(const ManageSparqlStatisticsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ManageSparqlStatisticsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for StartLoaderJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartLoaderJobRequestT = Model::StartLoaderJobRequest>
  void StartLoaderJobAsync(const StartLoaderJobRequestT& request, const StartLoaderJobResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMLDataProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMLDataProcessingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMLDataProcessingJobRequestT = Model::StartMLDataProcessingJobRequest>
  void StartMLDataProcessingJobAsync(const StartMLDataProcessingJobRequestT& request,
                                     const StartMLDataProcessingJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMLModelTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMLModelTrainingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMLModelTrainingJobRequestT = Model::StartMLModelTrainingJobRequest>
  void StartMLModelTrainingJobAsync(const StartMLModelTrainingJobRequestT& request,
                                    const StartMLModelTrainingJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMLModelTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMLModelTransformJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMLModelTransformJobRequestT = Model::StartMLModelTransformJobRequest>
  void StartMLModelTransformJobAsync(const StartMLModelTransformJobRequestT& request,
                                     const StartMLModelTransformJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
