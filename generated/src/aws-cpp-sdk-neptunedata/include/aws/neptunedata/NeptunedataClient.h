...
namespace neptunedata
{
   ...
   */
  class AWS_NEPTUNEDATA_API NeptunedataClient : Aws::Client::ClientWithAsyncTemplateMethods<NeptunedataClient>,
    smithy::client::AwsSmithyClientT<Aws::neptunedata::SERVICE_NAME,
