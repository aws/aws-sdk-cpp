...
class GetPropertygraphSummaryResult {
 public:
  ...
  inline GetPropertygraphSummaryResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename PayloadT = PropertygraphSummaryValueMap>
  GetPropertygraphSummaryResult& WithPayload(PayloadT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetPropertygraphSummaryResult& WithRequestId(RequestIdT&& value) {
