...
class CreateMLEndpointRequest : public NeptunedataRequest {
 public:
  ...
  void SetMlModelTransformJobId(MlModelTransformJobIdT&& value) {
    m_mlModelTransformJobIdHasBeenSet = true;
    m_mlModelTransformJobId = std::forward<MlModelTransformJobIdT>(value);
  }
  template <typename MlModelTransformJobIdT = Aws::String>
  CreateMLEndpointRequest& WithMlModelTransformJobId(MlModelTransformJobIdT&& value) {
    SetMlModelTransformJobId(std::forward<MlModelTransformJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetUpdate(bool value) {
    m_updateHasBeenSet = true;
    m_update = value;
  }
  inline CreateMLEndpointRequest& WithUpdate(bool value) {
    SetUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMLEndpointRequest& WithInstanceCount(int value) {
