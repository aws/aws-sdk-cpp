...
class DeletePropertygraphStatisticsResult {
 public:
  ...
  AWS_NEPTUNEDATA_API DeletePropertygraphStatisticsResult& operator=(
  ...
  inline DeletePropertygraphStatisticsResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusT = Aws::String>
  DeletePropertygraphStatisticsResult& WithStatus(StatusT&& value) {
  ...
  template <typename PayloadT = DeleteStatisticsValueMap>
  DeletePropertygraphStatisticsResult& WithPayload(PayloadT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeletePropertygraphStatisticsResult& WithRequestId(RequestIdT&& value) {
