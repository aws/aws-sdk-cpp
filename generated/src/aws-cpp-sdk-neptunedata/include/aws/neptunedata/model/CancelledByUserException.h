...
class CancelledByUserException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  CancelledByUserException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CancelledByUserException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  CancelledByUserException& WithCode(CodeT&& value) {
