...
namespace Model
{
  ...
  /**
   * <p>Raised when a user cancelled a request.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/neptunedata-2023-08-01/CancelledByUserException">AWS
   * API Reference</a></p>
   */
  class CancelledByUserException
  {
  public:
    AWS_NEPTUNEDATA_API CancelledByUserException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    CancelledByUserException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelledByUserException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    CancelledByUserException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
