...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API CancelMLModelTrainingJobResult() = default;
    ...
    template<typename StatusT = Aws::String>
    CancelMLModelTrainingJobResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelMLModelTrainingJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
