...
class NodeStructure {
 public:
  ...
  inline NodeStructure& WithCount(long long value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  NodeStructure& AddNodeProperties(NodePropertiesT&& value) {
    m_nodePropertiesHasBeenSet = true;
    m_nodeProperties.emplace_back(std::forward<NodePropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDistinctOutgoingEdgeLabels(DistinctOutgoingEdgeLabelsT&& value) {
    ...
    m_distinctOutgoingEdgeLabels = std::forward<DistinctOutgoingEdgeLabelsT>(value);
  }
  template <typename DistinctOutgoingEdgeLabelsT = Aws::Vector<Aws::String>>
  NodeStructure& WithDistinctOutgoingEdgeLabels(DistinctOutgoingEdgeLabelsT&& value) {
    SetDistinctOutgoingEdgeLabels(std::forward<DistinctOutgoingEdgeLabelsT>(value));
    return *this;
  }
  ...
  NodeStructure& AddDistinctOutgoingEdgeLabels(DistinctOutgoingEdgeLabelsT&& value) {
    m_distinctOutgoingEdgeLabelsHasBeenSet = true;
    m_distinctOutgoingEdgeLabels.emplace_back(std::forward<DistinctOutgoingEdgeLabelsT>(value));
    return *this;
  }
  ///@}
 private:
