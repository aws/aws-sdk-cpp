...
class ExecuteGremlinProfileQueryRequest : public NeptunedataRequest {
 public:
  ...
  void SetGremlinQuery(GremlinQueryT&& value) {
    m_gremlinQueryHasBeenSet = true;
    m_gremlinQuery = std::forward<GremlinQueryT>(value);
  }
  template <typename GremlinQueryT = Aws::String>
  ExecuteGremlinProfileQueryRequest& WithGremlinQuery(GremlinQueryT&& value) {
    SetGremlinQuery(std::forward<GremlinQueryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetResults(bool value) {
    m_resultsHasBeenSet = true;
    m_results = value;
  }
  inline ExecuteGremlinProfileQueryRequest& WithResults(bool value) {
    SetResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChop(int value) {
    m_chopHasBeenSet = true;
    m_chop = value;
  }
  inline ExecuteGremlinProfileQueryRequest& WithChop(int value) {
    SetChop(value);
    return *this;
  }
  ///@}
  ...
  void SetSerializer(SerializerT&& value) {
    ...
    m_serializer = std::forward<SerializerT>(value);
  }
  template <typename SerializerT = Aws::String>
  ExecuteGremlinProfileQueryRequest& WithSerializer(SerializerT&& value) {
    SetSerializer(std::forward<SerializerT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIndexOps(bool value) {
    m_indexOpsHasBeenSet = true;
    m_indexOps = value;
  }
  inline ExecuteGremlinProfileQueryRequest& WithIndexOps(bool value) {
    SetIndexOps(value);
    return *this;
  }
  ///@}
