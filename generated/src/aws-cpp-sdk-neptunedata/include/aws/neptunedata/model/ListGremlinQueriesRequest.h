...
class ListGremlinQueriesRequest : public NeptunedataRequest {
 public:
  ...
  inline void SetIncludeWaiting(bool value) {
    m_includeWaitingHasBeenSet = true;
    m_includeWaiting = value;
  }
  inline ListGremlinQueriesRequest& WithIncludeWaiting(bool value) {
    SetIncludeWaiting(value);
    return *this;
  }
  ///@}
 private:
