...
class StartMLModelTransformJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartMLModelTransformJobResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartMLModelTransformJobResult& WithArn(ArnT&& value) {
  ...
  inline void SetCreationTimeInMillis(long long value) {
    m_creationTimeInMillisHasBeenSet = true;
    m_creationTimeInMillis = value;
  }
  inline StartMLModelTransformJobResult& WithCreationTimeInMillis(long long value) {
    SetCreationTimeInMillis(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  StartMLModelTransformJobResult& WithRequestId(RequestIdT&& value) {
