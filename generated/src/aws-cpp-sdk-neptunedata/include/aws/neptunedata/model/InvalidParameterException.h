...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API InvalidParameterException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    InvalidParameterException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    InvalidParameterException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
