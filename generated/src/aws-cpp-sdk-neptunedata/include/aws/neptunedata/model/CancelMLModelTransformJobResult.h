...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API CancelMLModelTransformJobResult() = default;
    ...
    template<typename StatusT = Aws::String>
    CancelMLModelTransformJobResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CancelMLModelTransformJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
