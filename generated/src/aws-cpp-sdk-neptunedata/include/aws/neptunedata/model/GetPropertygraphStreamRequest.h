...
class GetPropertygraphStreamRequest : public NeptunedataRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "GetPropertygraphStream"; }
  ...
  inline GetPropertygraphStreamRequest& WithLimit(long long value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIteratorType(IteratorType value) {
    m_iteratorTypeHasBeenSet = true;
    m_iteratorType = value;
  }
  inline GetPropertygraphStreamRequest& WithIteratorType(IteratorType value) {
    SetIteratorType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCommitNum(long long value) {
    m_commitNumHasBeenSet = true;
    m_commitNum = value;
  }
  inline GetPropertygraphStreamRequest& WithCommitNum(long long value) {
    SetCommitNum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOpNum(long long value) {
    m_opNumHasBeenSet = true;
    m_opNum = value;
  }
  inline GetPropertygraphStreamRequest& WithOpNum(long long value) {
    SetOpNum(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEncoding(Encoding value) {
    m_encodingHasBeenSet = true;
    m_encoding = value;
  }
  inline GetPropertygraphStreamRequest& WithEncoding(Encoding value) {
    SetEncoding(value);
    return *this;
  }
  ///@}
