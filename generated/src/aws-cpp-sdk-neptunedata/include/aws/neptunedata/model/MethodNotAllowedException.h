...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API MethodNotAllowedException();
     ...
     * <p>A detailed message describing the problem.</p>
     */
    inline MethodNotAllowedException& WithDetailedMessage(const Aws::String& value) { SetDetailedMessage(value); return *this;}

    /**
     * <p>A detailed message describing the problem.</p>
     */
    inline MethodNotAllowedException& WithDetailedMessage(Aws::String&& value) { SetDetailedMessage(std::move(value)); return *this;}

    /**
     * <p>A detailed message describing the problem.</p>
     */
    inline MethodNotAllowedException& WithDetailedMessage(const char* value) { SetDetailedMessage(value); return *this;}
     ...
     * <p>The HTTP status code returned with the exception.</p>
     */
    inline MethodNotAllowedException& WithCode(const Aws::String& value) { SetCode(value); return *this;}

    /**
     * <p>The HTTP status code returned with the exception.</p>
     */
    inline MethodNotAllowedException& WithCode(Aws::String&& value) { SetCode(std::move(value)); return *this;}

    /**
     * <p>The HTTP status code returned with the exception.</p>
     */
    inline MethodNotAllowedException& WithCode(const char* value) { SetCode(value); return *this;}
