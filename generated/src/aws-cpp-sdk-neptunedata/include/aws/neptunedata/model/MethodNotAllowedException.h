...
class MethodNotAllowedException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  MethodNotAllowedException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MethodNotAllowedException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MethodNotAllowedException& WithCode(CodeT&& value) {
