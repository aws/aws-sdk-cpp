...
class LoadUrlAccessDeniedException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  LoadUrlAccessDeniedException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  LoadUrlAccessDeniedException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  LoadUrlAccessDeniedException& WithCode(CodeT&& value) {
