...
/**
 * <p>Raised when a specified machine-learning resource could not be
 * found.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/neptunedata-2023-08-01/MLResourceNotFoundException">AWS
 * API Reference</a></p>
 */
class MLResourceNotFoundException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  MLResourceNotFoundException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MLResourceNotFoundException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MLResourceNotFoundException& WithCode(CodeT&& value) {
