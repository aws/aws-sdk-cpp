...
class CustomModelTrainingParameters {
 public:
  ...
  void SetSourceS3DirectoryPath(SourceS3DirectoryPathT&& value) {
    ...
    m_sourceS3DirectoryPath = std::forward<SourceS3DirectoryPathT>(value);
  }
  template <typename SourceS3DirectoryPathT = Aws::String>
  CustomModelTrainingParameters& WithSourceS3DirectoryPath(SourceS3DirectoryPathT&& value) {
    SetSourceS3DirectoryPath(std::forward<SourceS3DirectoryPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingEntryPointScript(TrainingEntryPointScriptT&& value) {
    ...
    m_trainingEntryPointScript = std::forward<TrainingEntryPointScriptT>(value);
  }
  template <typename TrainingEntryPointScriptT = Aws::String>
  CustomModelTrainingParameters& WithTrainingEntryPointScript(TrainingEntryPointScriptT&& value) {
    SetTrainingEntryPointScript(std::forward<TrainingEntryPointScriptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformEntryPointScript(TransformEntryPointScriptT&& value) {
    ...
    m_transformEntryPointScript = std::forward<TransformEntryPointScriptT>(value);
  }
  template <typename TransformEntryPointScriptT = Aws::String>
  CustomModelTrainingParameters& WithTransformEntryPointScript(TransformEntryPointScriptT&& value) {
    SetTransformEntryPointScript(std::forward<TransformEntryPointScriptT>(value));
    return *this;
  }
  ///@}
 private:
