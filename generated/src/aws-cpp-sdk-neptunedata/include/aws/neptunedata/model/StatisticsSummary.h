...
class StatisticsSummary {
 public:
  ...
  inline void SetSignatureCount(int value) {
    m_signatureCountHasBeenSet = true;
    m_signatureCount = value;
  }
  inline StatisticsSummary& WithSignatureCount(int value) {
  ...
  inline StatisticsSummary& WithInstanceCount(int value) {
  ...
  inline void SetPredicateCount(int value) {
    m_predicateCountHasBeenSet = true;
    m_predicateCount = value;
  }
  inline StatisticsSummary& WithPredicateCount(int value) {
    SetPredicateCount(value);
    return *this;
  }
  ///@}
 private:
