...
class ConstraintViolationException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  ConstraintViolationException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConstraintViolationException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  ConstraintViolationException& WithCode(CodeT&& value) {
