...
class TimeLimitExceededException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  TimeLimitExceededException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  TimeLimitExceededException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  TimeLimitExceededException& WithCode(CodeT&& value) {
