...
class GetRDFGraphSummaryResult {
 public:
  ...
  inline GetRDFGraphSummaryResult& WithStatusCode(int value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename PayloadT = RDFGraphSummaryValueMap>
  GetRDFGraphSummaryResult& WithPayload(PayloadT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRDFGraphSummaryResult& WithRequestId(RequestIdT&& value) {
