...
class GetLoaderJobStatusResult {
 public:
  ...
  template <typename StatusT = Aws::String>
  GetLoaderJobStatusResult& WithStatus(StatusT&& value) {
  ...
  template <typename PayloadT = Aws::Utils::Document>
  GetLoaderJobStatusResult& WithPayload(PayloadT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLoaderJobStatusResult& WithRequestId(RequestIdT&& value) {
