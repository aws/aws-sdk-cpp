...
class ExpiredStreamException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  ExpiredStreamException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExpiredStreamException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  ExpiredStreamException& WithCode(CodeT&& value) {
