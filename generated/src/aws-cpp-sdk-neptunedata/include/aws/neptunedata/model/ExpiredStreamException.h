...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API ExpiredStreamException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    ExpiredStreamException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ExpiredStreamException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    ExpiredStreamException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
