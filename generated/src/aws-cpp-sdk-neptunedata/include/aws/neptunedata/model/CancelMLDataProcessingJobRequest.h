...
class CancelMLDataProcessingJobRequest : public NeptunedataRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CancelMLDataProcessingJob"; }
  ...
  template <typename IdT = Aws::String>
  CancelMLDataProcessingJobRequest& WithId(IdT&& value) {
  ...
  template <typename NeptuneIamRoleArnT = Aws::String>
  CancelMLDataProcessingJobRequest& WithNeptuneIamRoleArn(NeptuneIamRoleArnT&& value) {
  ...
  ///@{
  /**
   * <p>If set to <code>TRUE</code>, this flag specifies that all Neptune ML S3
  ...
  inline CancelMLDataProcessingJobRequest& WithClean(bool value) {
    SetClean(value);
    return *this;
  }
  ///@}
