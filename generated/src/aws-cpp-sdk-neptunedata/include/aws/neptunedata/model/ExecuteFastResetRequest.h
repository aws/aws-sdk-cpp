...
class ExecuteFastResetRequest : public NeptunedataRequest {
 public:
   ...
   * <code>initiateDatabaseReset</code> </b> - This action generates a unique token
   * needed to actually perform the fast reset.</p> </li> <li> <p> <b>
   * <code>performDatabaseReset</code> </b> - This action uses the token generated by
   * the <code>initiateDatabaseReset</code> action to actually perform the fast
   * reset.</p> <p/> </li> </ul>
   */
  ...
  inline ExecuteFastResetRequest& WithAction(Action value) {
    SetAction(value);
    return *this;
  }
  ///@}
