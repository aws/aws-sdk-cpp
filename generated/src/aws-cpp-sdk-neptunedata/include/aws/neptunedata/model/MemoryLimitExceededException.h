...
class MemoryLimitExceededException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  MemoryLimitExceededException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MemoryLimitExceededException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MemoryLimitExceededException& WithCode(CodeT&& value) {
