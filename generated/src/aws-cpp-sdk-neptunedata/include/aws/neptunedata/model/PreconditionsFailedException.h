...
/**
 * <p>Raised when a precondition for processing a request is not
 * satisfied.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/neptunedata-2023-08-01/PreconditionsFailedException">AWS
 * API Reference</a></p>
 */
class PreconditionsFailedException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  PreconditionsFailedException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PreconditionsFailedException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  PreconditionsFailedException& WithCode(CodeT&& value) {
