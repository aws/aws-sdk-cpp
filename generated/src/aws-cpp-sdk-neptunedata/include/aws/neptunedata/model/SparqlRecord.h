...
class SparqlRecord {
 public:
  ...
  inline void SetCommitTimestampInMillis(long long value) {
    m_commitTimestampInMillisHasBeenSet = true;
    m_commitTimestampInMillis = value;
  }
  inline SparqlRecord& WithCommitTimestampInMillis(long long value) {
    SetCommitTimestampInMillis(value);
    return *this;
  }
  ///@}
  ...
  SparqlRecord& AddEventId(EventIdKeyT&& key, EventIdValueT&& value) {
    m_eventIdHasBeenSet = true;
    m_eventId.emplace(std::forward<EventIdKeyT>(key), std::forward<EventIdValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOp(OpT&& value) {
    m_opHasBeenSet = true;
    m_op = std::forward<OpT>(value);
  }
  template <typename OpT = Aws::String>
  SparqlRecord& WithOp(OpT&& value) {
    SetOp(std::forward<OpT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsLastOp(bool value) {
    m_isLastOpHasBeenSet = true;
    m_isLastOp = value;
  }
  inline SparqlRecord& WithIsLastOp(bool value) {
    SetIsLastOp(value);
    return *this;
  }
  ///@}
