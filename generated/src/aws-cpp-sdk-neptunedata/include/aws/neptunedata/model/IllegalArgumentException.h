...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API IllegalArgumentException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    IllegalArgumentException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    IllegalArgumentException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    IllegalArgumentException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
