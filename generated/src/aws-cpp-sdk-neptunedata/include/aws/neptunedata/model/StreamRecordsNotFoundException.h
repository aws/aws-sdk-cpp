...
class StreamRecordsNotFoundException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  StreamRecordsNotFoundException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StreamRecordsNotFoundException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  StreamRecordsNotFoundException& WithCode(CodeT&& value) {
