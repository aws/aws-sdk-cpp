...
class MalformedQueryException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  MalformedQueryException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MalformedQueryException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MalformedQueryException& WithCode(CodeT&& value) {
