...
class ExecuteOpenCypherExplainQueryRequest : public NeptunedataRequest {
 public:
  ...
  void SetOpenCypherQuery(OpenCypherQueryT&& value) {
    m_openCypherQueryHasBeenSet = true;
    m_openCypherQuery = std::forward<OpenCypherQueryT>(value);
  }
  template <typename OpenCypherQueryT = Aws::String>
  ExecuteOpenCypherExplainQueryRequest& WithOpenCypherQuery(OpenCypherQueryT&& value) {
    SetOpenCypherQuery(std::forward<OpenCypherQueryT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExplainMode(OpenCypherExplainMode value) {
    m_explainModeHasBeenSet = true;
    m_explainMode = value;
  }
  inline ExecuteOpenCypherExplainQueryRequest& WithExplainMode(OpenCypherExplainMode value) {
