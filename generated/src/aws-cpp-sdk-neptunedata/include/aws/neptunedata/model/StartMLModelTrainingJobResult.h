...
class StartMLModelTrainingJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartMLModelTrainingJobResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartMLModelTrainingJobResult& WithArn(ArnT&& value) {
  ...
  inline StartMLModelTrainingJobResult& WithCreationTimeInMillis(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartMLModelTrainingJobResult& WithRequestId(RequestIdT&& value) {
