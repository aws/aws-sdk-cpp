...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API StartMLModelTrainingJobResult() = default;
    ...
    template<typename IdT = Aws::String>
    StartMLModelTrainingJobResult& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    StartMLModelTrainingJobResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartMLModelTrainingJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
