...
class RDFGraphSummaryValueMap {
 public:
  ...
  template <typename VersionT = Aws::String>
  RDFGraphSummaryValueMap& WithVersion(VersionT&& value) {
  ...
  template <typename LastStatisticsComputationTimeT = Aws::Utils::DateTime>
  RDFGraphSummaryValueMap& WithLastStatisticsComputationTime(LastStatisticsComputationTimeT&& value) {
  ...
  template <typename GraphSummaryT = RDFGraphSummary>
  RDFGraphSummaryValueMap& WithGraphSummary(GraphSummaryT&& value) {
