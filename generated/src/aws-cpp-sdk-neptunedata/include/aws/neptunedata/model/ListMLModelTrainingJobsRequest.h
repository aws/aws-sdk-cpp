...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API ListMLModelTrainingJobsRequest();
     ...
     * will occur.</p>
     */
    inline ListMLModelTrainingJobsRequest& WithNeptuneIamRoleArn(const Aws::String& value) { SetNeptuneIamRoleArn(value); return *this;}
     ...
     * will occur.</p>
     */
    inline ListMLModelTrainingJobsRequest& WithNeptuneIamRoleArn(Aws::String&& value) { SetNeptuneIamRoleArn(std::move(value)); return *this;}
     ...
     * will occur.</p>
     */
    inline ListMLModelTrainingJobsRequest& WithNeptuneIamRoleArn(const char* value) { SetNeptuneIamRoleArn(value); return *this;}
