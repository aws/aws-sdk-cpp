...
class ReadOnlyViolationException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  ReadOnlyViolationException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ReadOnlyViolationException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  ReadOnlyViolationException& WithCode(CodeT&& value) {
