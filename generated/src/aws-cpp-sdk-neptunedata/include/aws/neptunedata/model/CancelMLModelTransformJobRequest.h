...
class CancelMLModelTransformJobRequest : public NeptunedataRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  CancelMLModelTransformJobRequest& WithId(IdT&& value) {
  ...
  template <typename NeptuneIamRoleArnT = Aws::String>
  CancelMLModelTransformJobRequest& WithNeptuneIamRoleArn(NeptuneIamRoleArnT&& value) {
  ...
  inline CancelMLModelTransformJobRequest& WithClean(bool value) {
    SetClean(value);
    return *this;
  }
  ///@}
