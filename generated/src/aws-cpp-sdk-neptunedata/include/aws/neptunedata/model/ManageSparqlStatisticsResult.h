...
class ManageSparqlStatisticsResult {
 public:
  ...
  template <typename StatusT = Aws::String>
  ManageSparqlStatisticsResult& WithStatus(StatusT&& value) {
  ...
  template <typename PayloadT = RefreshStatisticsIdMap>
  ManageSparqlStatisticsResult& WithPayload(PayloadT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ManageSparqlStatisticsResult& WithRequestId(RequestIdT&& value) {
