...
class Statistics {
 public:
  ...
  inline void SetAutoCompute(bool value) {
    m_autoComputeHasBeenSet = true;
    m_autoCompute = value;
  }
  inline Statistics& WithAutoCompute(bool value) {
    SetAutoCompute(value);
    return *this;
  }
  ///@}
  ...
  inline Statistics& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  void SetSignatureInfo(SignatureInfoT&& value) {
    ...
    m_signatureInfo = std::forward<SignatureInfoT>(value);
  }
  template <typename SignatureInfoT = StatisticsSummary>
  Statistics& WithSignatureInfo(SignatureInfoT&& value) {
    SetSignatureInfo(std::forward<SignatureInfoT>(value));
    return *this;
  }
  ///@}
 private:
