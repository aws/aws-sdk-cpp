...
class StartMLDataProcessingJobResult {
 public:
  ...
  template <typename IdT = Aws::String>
  StartMLDataProcessingJobResult& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  StartMLDataProcessingJobResult& WithArn(ArnT&& value) {
  ...
  inline StartMLDataProcessingJobResult& WithCreationTimeInMillis(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartMLDataProcessingJobResult& WithRequestId(RequestIdT&& value) {
