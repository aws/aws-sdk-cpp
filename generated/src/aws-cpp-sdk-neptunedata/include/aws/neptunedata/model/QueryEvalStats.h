...
class QueryEvalStats {
 public:
  ...
  inline void SetWaited(int value) {
    m_waitedHasBeenSet = true;
    m_waited = value;
  }
  inline QueryEvalStats& WithWaited(int value) {
    SetWaited(value);
    return *this;
  }
  ///@}
  ...
  inline void SetElapsed(int value) {
    m_elapsedHasBeenSet = true;
    m_elapsed = value;
  }
  inline QueryEvalStats& WithElapsed(int value) {
    SetElapsed(value);
    return *this;
  }
  ///@}
  ...
  inline QueryEvalStats& WithCancelled(bool value) {
    SetCancelled(value);
    return *this;
  }
  ///@}
  ...
  void SetSubqueries(SubqueriesT&& value) {
    ...
    m_subqueries = std::forward<SubqueriesT>(value);
  }
  template <typename SubqueriesT = Aws::Utils::Document>
  QueryEvalStats& WithSubqueries(SubqueriesT&& value) {
    SetSubqueries(std::forward<SubqueriesT>(value));
    return *this;
  }
  ///@}
 private:
