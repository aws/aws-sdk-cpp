...
class ListOpenCypherQueriesResult {
 public:
  ...
  inline ListOpenCypherQueriesResult& WithAcceptedQueryCount(int value) {
  ...
  inline ListOpenCypherQueriesResult& WithRunningQueryCount(int value) {
  ...
  template <typename QueriesT = Aws::Vector<GremlinQueryStatus>>
  ListOpenCypherQueriesResult& WithQueries(QueriesT&& value) {
    SetQueries(std::forward<QueriesT>(value));
    return *this;
  }
  template <typename QueriesT = GremlinQueryStatus>
  ListOpenCypherQueriesResult& AddQueries(QueriesT&& value) {
    m_queriesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListOpenCypherQueriesResult& WithRequestId(RequestIdT&& value) {
