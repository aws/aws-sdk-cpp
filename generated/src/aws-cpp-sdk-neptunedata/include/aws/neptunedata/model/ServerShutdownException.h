...
class ServerShutdownException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  ServerShutdownException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ServerShutdownException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  ServerShutdownException& WithCode(CodeT&& value) {
