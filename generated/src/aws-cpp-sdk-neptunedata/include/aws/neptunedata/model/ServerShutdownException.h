...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API ServerShutdownException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    ServerShutdownException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ServerShutdownException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    ServerShutdownException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
