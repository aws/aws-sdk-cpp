...
class QueryTooLargeException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  QueryTooLargeException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  QueryTooLargeException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  QueryTooLargeException& WithCode(CodeT&& value) {
