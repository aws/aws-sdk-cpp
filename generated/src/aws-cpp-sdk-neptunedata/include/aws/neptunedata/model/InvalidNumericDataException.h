...
class InvalidNumericDataException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  InvalidNumericDataException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InvalidNumericDataException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  InvalidNumericDataException& WithCode(CodeT&& value) {
