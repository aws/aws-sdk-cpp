...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API InvalidNumericDataException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    InvalidNumericDataException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidNumericDataException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    InvalidNumericDataException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
