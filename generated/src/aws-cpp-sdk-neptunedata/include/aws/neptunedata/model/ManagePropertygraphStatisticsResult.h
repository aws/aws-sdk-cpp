...
namespace Model
{
  ...
  public:
    ...
    template<typename StatusT = Aws::String>
    ManagePropertygraphStatisticsResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename PayloadT = RefreshStatisticsIdMap>
    void SetPayload(PayloadT&& value) { m_payloadHasBeenSet = true; m_payload = std::forward<PayloadT>(value); }
    template<typename PayloadT = RefreshStatisticsIdMap>
    ManagePropertygraphStatisticsResult& WithPayload(PayloadT&& value) { SetPayload(std::forward<PayloadT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ManagePropertygraphStatisticsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
