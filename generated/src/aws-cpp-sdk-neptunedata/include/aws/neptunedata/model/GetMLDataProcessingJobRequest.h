...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API GetMLDataProcessingJobRequest();
     ...
     * <p>The unique identifier of the data-processing job to be retrieved.</p>
     */
    inline GetMLDataProcessingJobRequest& WithId(const Aws::String& value) { SetId(value); return *this;}

    /**
     * <p>The unique identifier of the data-processing job to be retrieved.</p>
     */
    inline GetMLDataProcessingJobRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}

    /**
     * <p>The unique identifier of the data-processing job to be retrieved.</p>
     */
    inline GetMLDataProcessingJobRequest& WithId(const char* value) { SetId(value); return *this;}
     ...
     * will occur.</p>
     */
    inline GetMLDataProcessingJobRequest& WithNeptuneIamRoleArn(const Aws::String& value) { SetNeptuneIamRoleArn(value); return *this;}
     ...
     * will occur.</p>
     */
    inline GetMLDataProcessingJobRequest& WithNeptuneIamRoleArn(Aws::String&& value) { SetNeptuneIamRoleArn(std::move(value)); return *this;}
     ...
     * will occur.</p>
     */
    inline GetMLDataProcessingJobRequest& WithNeptuneIamRoleArn(const char* value) { SetNeptuneIamRoleArn(value); return *this;}
