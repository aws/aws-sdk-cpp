...
class FailureByQueryException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  FailureByQueryException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  FailureByQueryException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  FailureByQueryException& WithCode(CodeT&& value) {
