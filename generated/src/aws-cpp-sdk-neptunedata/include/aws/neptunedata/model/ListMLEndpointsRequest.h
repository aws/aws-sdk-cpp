...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API ListMLEndpointsRequest() = default;
    ...
    template<typename NeptuneIamRoleArnT = Aws::String>
    ListMLEndpointsRequest& WithNeptuneIamRoleArn(NeptuneIamRoleArnT&& value) { SetNeptuneIamRoleArn(std::forward<NeptuneIamRoleArnT>(value)); return *this;}
    ///@}
  private:
