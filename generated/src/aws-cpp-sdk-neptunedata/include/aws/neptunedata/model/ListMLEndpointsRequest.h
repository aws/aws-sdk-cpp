...
namespace Model
{
  ...
  /**
   */
  class ListMLEndpointsRequest : public NeptunedataRequest
  {
  public:
    AWS_NEPTUNEDATA_API ListMLEndpointsRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ListMLEndpoints"; }
     ...
     * <p>The maximum number of items to return (from 1 to 1024; the default is 10.</p>
     */
    inline ListMLEndpointsRequest& WithMaxItems(int value) { SetMaxItems(value); return *this;}
     ...
     * will occur.</p>
     */
    inline ListMLEndpointsRequest& WithNeptuneIamRoleArn(const Aws::String& value) { SetNeptuneIamRoleArn(value); return *this;}
     ...
     * will occur.</p>
     */
    inline ListMLEndpointsRequest& WithNeptuneIamRoleArn(Aws::String&& value) { SetNeptuneIamRoleArn(std::move(value)); return *this;}
     ...
     * will occur.</p>
     */
    inline ListMLEndpointsRequest& WithNeptuneIamRoleArn(const char* value) { SetNeptuneIamRoleArn(value); return *this;}
