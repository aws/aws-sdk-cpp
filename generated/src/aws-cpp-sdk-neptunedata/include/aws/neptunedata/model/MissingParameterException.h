...
class MissingParameterException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  MissingParameterException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  MissingParameterException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  MissingParameterException& WithCode(CodeT&& value) {
