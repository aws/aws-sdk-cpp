...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API InvalidArgumentException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    InvalidArgumentException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    InvalidArgumentException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    InvalidArgumentException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
