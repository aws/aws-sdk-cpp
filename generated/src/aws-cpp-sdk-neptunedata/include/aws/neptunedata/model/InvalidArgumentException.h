...
class InvalidArgumentException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  InvalidArgumentException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  InvalidArgumentException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  InvalidArgumentException& WithCode(CodeT&& value) {
