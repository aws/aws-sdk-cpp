...
namespace Model
{
  ...
  /**
   */
  class CancelMLModelTrainingJobRequest : public NeptunedataRequest
  {
  public:
    AWS_NEPTUNEDATA_API CancelMLModelTrainingJobRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "CancelMLModelTrainingJob"; }
     ...
     * <p>The unique identifier of the model-training job to be canceled.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithId(const Aws::String& value) { SetId(value); return *this;}

    /**
     * <p>The unique identifier of the model-training job to be canceled.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}

    /**
     * <p>The unique identifier of the model-training job to be canceled.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithId(const char* value) { SetId(value); return *this;}
     ...
     * will occur.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithNeptuneIamRoleArn(const Aws::String& value) { SetNeptuneIamRoleArn(value); return *this;}
     ...
     * will occur.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithNeptuneIamRoleArn(Aws::String&& value) { SetNeptuneIamRoleArn(std::move(value)); return *this;}
     ...
     * will occur.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithNeptuneIamRoleArn(const char* value) { SetNeptuneIamRoleArn(value); return *this;}


    /**
     * <p>If set to <code>TRUE</code>, this flag specifies that all Amazon S3 artifacts
     ...
     * <code>FALSE</code>.</p>
     */
    inline CancelMLModelTrainingJobRequest& WithClean(bool value) { SetClean(value); return *this;}
