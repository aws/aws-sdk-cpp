...
class CancelMLModelTrainingJobRequest : public NeptunedataRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  CancelMLModelTrainingJobRequest& WithId(IdT&& value) {
  ...
  template <typename NeptuneIamRoleArnT = Aws::String>
  CancelMLModelTrainingJobRequest& WithNeptuneIamRoleArn(NeptuneIamRoleArnT&& value) {
  ...
  inline CancelMLModelTrainingJobRequest& WithClean(bool value) {
    SetClean(value);
    return *this;
  }
  ///@}
