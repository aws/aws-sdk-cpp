...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API CancelMLModelTrainingJobRequest() = default;
    ...
    template<typename IdT = Aws::String>
    CancelMLModelTrainingJobRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename NeptuneIamRoleArnT = Aws::String>
    CancelMLModelTrainingJobRequest& WithNeptuneIamRoleArn(NeptuneIamRoleArnT&& value) { SetNeptuneIamRoleArn(std::forward<NeptuneIamRoleArnT>(value)); return *this;}
    ///@}
