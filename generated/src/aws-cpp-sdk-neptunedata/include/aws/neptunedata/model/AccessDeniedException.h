...
namespace Model
{
  ...
  /**
   * <p>Raised in case of an authentication or authorization failure.</p><p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/neptunedata-2023-08-01/AccessDeniedException">AWS
   * API Reference</a></p>
   */
  class AccessDeniedException
  {
  public:
    AWS_NEPTUNEDATA_API AccessDeniedException();
    AWS_NEPTUNEDATA_API AccessDeniedException(Aws::Utils::Json::JsonView jsonValue);
    AWS_NEPTUNEDATA_API AccessDeniedException& operator=(Aws::Utils::Json::JsonView jsonValue);
     ...
     * <p>A detailed message describing the problem.</p>
     */
    inline AccessDeniedException& WithDetailedMessage(const Aws::String& value) { SetDetailedMessage(value); return *this;}

    /**
     * <p>A detailed message describing the problem.</p>
     */
    inline AccessDeniedException& WithDetailedMessage(Aws::String&& value) { SetDetailedMessage(std::move(value)); return *this;}

    /**
     * <p>A detailed message describing the problem.</p>
     */
    inline AccessDeniedException& WithDetailedMessage(const char* value) { SetDetailedMessage(value); return *this;}
