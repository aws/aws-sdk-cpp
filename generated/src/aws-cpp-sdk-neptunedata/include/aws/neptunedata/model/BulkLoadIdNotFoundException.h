...
class BulkLoadIdNotFoundException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  BulkLoadIdNotFoundException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  BulkLoadIdNotFoundException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  BulkLoadIdNotFoundException& WithCode(CodeT&& value) {
