...
class QueryLimitExceededException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  QueryLimitExceededException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  QueryLimitExceededException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  QueryLimitExceededException& WithCode(CodeT&& value) {
