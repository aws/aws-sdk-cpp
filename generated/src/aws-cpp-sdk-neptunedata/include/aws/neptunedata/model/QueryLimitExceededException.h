...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API QueryLimitExceededException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    QueryLimitExceededException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    QueryLimitExceededException& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    QueryLimitExceededException& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
