...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API BadRequestException() = default;
    ...
    template<typename DetailedMessageT = Aws::String>
    BadRequestException& WithDetailedMessage(DetailedMessageT&& value) { SetDetailedMessage(std::forward<DetailedMessageT>(value)); return *this;}
    ///@}
