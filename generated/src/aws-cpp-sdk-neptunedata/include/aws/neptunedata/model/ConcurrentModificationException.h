...
class ConcurrentModificationException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  ConcurrentModificationException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ConcurrentModificationException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  ConcurrentModificationException& WithCode(CodeT&& value) {
