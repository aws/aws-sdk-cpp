...
namespace Model
{
  ...
  {
  public:
    AWS_NEPTUNEDATA_API ListMLDataProcessingJobsResult() = default;
    ...
    template<typename IdsT = Aws::Vector<Aws::String>>
    ListMLDataProcessingJobsResult& WithIds(IdsT&& value) { SetIds(std::forward<IdsT>(value)); return *this;}
    template<typename IdsT = Aws::String>
    ListMLDataProcessingJobsResult& AddIds(IdsT&& value) { m_idsHasBeenSet = true; m_ids.emplace_back(std::forward<IdsT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListMLDataProcessingJobsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
