...
class StatisticsNotAvailableException {
 public:
  ...
  template <typename DetailedMessageT = Aws::String>
  StatisticsNotAvailableException& WithDetailedMessage(DetailedMessageT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StatisticsNotAvailableException& WithRequestId(RequestIdT&& value) {
  ...
  template <typename CodeT = Aws::String>
  StatisticsNotAvailableException& WithCode(CodeT&& value) {
