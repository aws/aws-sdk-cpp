...
QueryLimitExceededException::QueryLimitExceededException(JsonView jsonValue) { *this = jsonValue; }

QueryLimitExceededException& QueryLimitExceededException::operator=(JsonView jsonValue) {
...
JsonValue QueryLimitExceededException::Jsonize() const {
  JsonValue payload;
