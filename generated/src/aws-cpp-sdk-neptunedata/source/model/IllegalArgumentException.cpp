...
IllegalArgumentException::IllegalArgumentException(JsonView jsonValue) { *this = jsonValue; }

IllegalArgumentException& IllegalArgumentException::operator=(JsonView jsonValue) {
...
JsonValue IllegalArgumentException::Jsonize() const {
  JsonValue payload;
