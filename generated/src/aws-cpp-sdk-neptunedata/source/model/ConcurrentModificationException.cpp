...
ConcurrentModificationException::ConcurrentModificationException(JsonView jsonValue) { *this = jsonValue; }

ConcurrentModificationException& ConcurrentModificationException::operator=(JsonView jsonValue) {
...
JsonValue ConcurrentModificationException::Jsonize() const {
  JsonValue payload;
