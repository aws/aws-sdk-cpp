...
QueryTooLargeException::QueryTooLargeException(JsonView jsonValue) { *this = jsonValue; }

QueryTooLargeException& QueryTooLargeException::operator=(JsonView jsonValue) {
...
JsonValue QueryTooLargeException::Jsonize() const {
  JsonValue payload;
