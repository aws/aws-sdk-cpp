...
TimeLimitExceededException::TimeLimitExceededException(JsonView jsonValue) { *this = jsonValue; }

TimeLimitExceededException& TimeLimitExceededException::operator=(JsonView jsonValue) {
...
JsonValue TimeLimitExceededException::Jsonize() const {
  JsonValue payload;
