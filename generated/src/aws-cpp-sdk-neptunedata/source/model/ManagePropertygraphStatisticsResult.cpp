...
ManagePropertygraphStatisticsResult::ManagePropertygraphStatisticsResult()
{
}

ManagePropertygraphStatisticsResult::ManagePropertygraphStatisticsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
