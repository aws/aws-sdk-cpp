...
InvalidArgumentException::InvalidArgumentException(JsonView jsonValue) { *this = jsonValue; }

InvalidArgumentException& InvalidArgumentException::operator=(JsonView jsonValue) {
...
JsonValue InvalidArgumentException::Jsonize() const {
  JsonValue payload;
