...
InvalidNumericDataException::InvalidNumericDataException(JsonView jsonValue) { *this = jsonValue; }

InvalidNumericDataException& InvalidNumericDataException::operator=(JsonView jsonValue) {
...
JsonValue InvalidNumericDataException::Jsonize() const {
  JsonValue payload;
