...
BulkLoadIdNotFoundException::BulkLoadIdNotFoundException(JsonView jsonValue) { *this = jsonValue; }

BulkLoadIdNotFoundException& BulkLoadIdNotFoundException::operator=(JsonView jsonValue) {
...
JsonValue BulkLoadIdNotFoundException::Jsonize() const {
  JsonValue payload;
