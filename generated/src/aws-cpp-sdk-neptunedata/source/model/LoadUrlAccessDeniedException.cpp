...
LoadUrlAccessDeniedException::LoadUrlAccessDeniedException(JsonView jsonValue) { *this = jsonValue; }

LoadUrlAccessDeniedException& LoadUrlAccessDeniedException::operator=(JsonView jsonValue) {
...
JsonValue LoadUrlAccessDeniedException::Jsonize() const {
  JsonValue payload;
