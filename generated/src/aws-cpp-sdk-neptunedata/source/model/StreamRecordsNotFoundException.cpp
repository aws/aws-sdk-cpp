...
StreamRecordsNotFoundException::StreamRecordsNotFoundException(JsonView jsonValue) { *this = jsonValue; }

StreamRecordsNotFoundException& StreamRecordsNotFoundException::operator=(JsonView jsonValue) {
...
JsonValue StreamRecordsNotFoundException::Jsonize() const {
  JsonValue payload;
