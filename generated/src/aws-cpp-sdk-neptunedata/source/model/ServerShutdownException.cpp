...
ServerShutdownException::ServerShutdownException(JsonView jsonValue) { *this = jsonValue; }

ServerShutdownException& ServerShutdownException::operator=(JsonView jsonValue) {
...
JsonValue ServerShutdownException::Jsonize() const {
  JsonValue payload;
