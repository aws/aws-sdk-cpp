...
PreconditionsFailedException::PreconditionsFailedException(JsonView jsonValue) { *this = jsonValue; }

PreconditionsFailedException& PreconditionsFailedException::operator=(JsonView jsonValue) {
...
JsonValue PreconditionsFailedException::Jsonize() const {
  JsonValue payload;
