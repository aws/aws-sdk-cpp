...
ClientTimeoutException::ClientTimeoutException(JsonView jsonValue) { *this = jsonValue; }

ClientTimeoutException& ClientTimeoutException::operator=(JsonView jsonValue) {
...
JsonValue ClientTimeoutException::Jsonize() const {
  JsonValue payload;
