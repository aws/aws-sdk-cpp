...
ReadOnlyViolationException::ReadOnlyViolationException(JsonView jsonValue) { *this = jsonValue; }

ReadOnlyViolationException& ReadOnlyViolationException::operator=(JsonView jsonValue) {
...
JsonValue ReadOnlyViolationException::Jsonize() const {
  JsonValue payload;
