...
PropertygraphSummary::PropertygraphSummary(JsonView jsonValue) { *this = jsonValue; }

PropertygraphSummary& PropertygraphSummary::operator=(JsonView jsonValue) {
...
JsonValue PropertygraphSummary::Jsonize() const {
  JsonValue payload;
