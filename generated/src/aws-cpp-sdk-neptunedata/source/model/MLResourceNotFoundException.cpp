...
MLResourceNotFoundException::MLResourceNotFoundException(JsonView jsonValue) { *this = jsonValue; }

MLResourceNotFoundException& MLResourceNotFoundException::operator=(JsonView jsonValue) {
...
JsonValue MLResourceNotFoundException::Jsonize() const {
  JsonValue payload;
