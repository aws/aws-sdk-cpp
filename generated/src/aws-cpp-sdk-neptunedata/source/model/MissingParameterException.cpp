...
MissingParameterException::MissingParameterException(JsonView jsonValue) { *this = jsonValue; }

MissingParameterException& MissingParameterException::operator=(JsonView jsonValue) {
...
JsonValue MissingParameterException::Jsonize() const {
  JsonValue payload;
