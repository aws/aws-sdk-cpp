...
StatisticsNotAvailableException::StatisticsNotAvailableException(JsonView jsonValue) { *this = jsonValue; }

StatisticsNotAvailableException& StatisticsNotAvailableException::operator=(JsonView jsonValue) {
...
JsonValue StatisticsNotAvailableException::Jsonize() const {
  JsonValue payload;
