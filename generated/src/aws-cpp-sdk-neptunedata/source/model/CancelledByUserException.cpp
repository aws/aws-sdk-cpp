...
CancelledByUserException::CancelledByUserException(JsonView jsonValue) { *this = jsonValue; }

CancelledByUserException& CancelledByUserException::operator=(JsonView jsonValue) {
...
JsonValue CancelledByUserException::Jsonize() const {
  JsonValue payload;
