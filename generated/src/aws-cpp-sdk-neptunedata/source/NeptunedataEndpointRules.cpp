...
{
const size_t NeptunedataEndpointRules::RulesBlobStrLen = 3740;
const size_t NeptunedataEndpointRules::RulesBlobSize = 3741;
...
'"','h','t','t','p','s',':','/','/','n','e','p','t','u','n','e','-','d','b','-','f','i','p','s','.',
...
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','n','e','p','t',
'u','n','e','-','d','b','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'"',':','"','h','t','t','p','s',':','/','/','n','e','p','t','u','n','e','-','d','b','.','{','R','e',
...
':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o',
'i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','n','e','p','t',
'u','n','e','-','d','b','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* NeptunedataEndpointRules::GetRulesBlob()
{
