...
template <>
AWS_NEPTUNEDATA_API QueryLimitExceededException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API ExpiredStreamException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::EXPIRED_STREAM);
  return ExpiredStreamException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API QueryLimitException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::QUERY_LIMIT);
  return QueryLimitException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API ConcurrentModificationException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API CancelledByUserException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::CANCELLED_BY_USER);
  return CancelledByUserException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API StreamRecordsNotFoundException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API InvalidNumericDataException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API AccessDeniedException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::ACCESS_DENIED);
  return AccessDeniedException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API UnsupportedOperationException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API ConstraintViolationException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API ServerShutdownException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::SERVER_SHUTDOWN);
  return ServerShutdownException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API InvalidArgumentException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::INVALID_ARGUMENT);
  return InvalidArgumentException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API LoadUrlAccessDeniedException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API MethodNotAllowedException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::METHOD_NOT_ALLOWED);
  return MethodNotAllowedException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API InternalFailureException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::INTERNAL_FAILURE);
  return InternalFailureException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API MemoryLimitExceededException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API ThrottlingException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API MissingParameterException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::MISSING_PARAMETER);
  return MissingParameterException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API TooManyRequestsException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::TOO_MANY_REQUESTS);
  return TooManyRequestsException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API MLResourceNotFoundException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API BadRequestException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::BAD_REQUEST);
  return BadRequestException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API PreconditionsFailedException NeptunedataError::GetModeledError() {
...
template <>
AWS_NEPTUNEDATA_API TimeLimitExceededException NeptunedataError::GetModeledError() {
  assert(this->GetErrorType() == NeptunedataErrors::TIME_LIMIT_EXCEEDED);
  return TimeLimitExceededException(this->GetJsonPayload().View());
}

template <>
AWS_NEPTUNEDATA_API FailureByQueryException NeptunedataError::GetModeledError() {
...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == QUERY_LIMIT_EXCEEDED_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(NeptunedataErrors::TOO_MANY_REQUESTS), RetryableType::RETRYABLE_THROTTLING);
