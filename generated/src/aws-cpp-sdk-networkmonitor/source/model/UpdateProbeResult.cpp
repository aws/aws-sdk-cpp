...
UpdateProbeResult::UpdateProbeResult() : 
    m_destinationPort(0),
...
UpdateProbeResult::UpdateProbeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) : 
    m_destinationPort(0),
    m_protocol(Protocol::NOT_SET),
    m_packetSize(0),
    m_addressFamily(AddressFamily::NOT_SET),
...
UpdateProbeResult& UpdateProbeResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
