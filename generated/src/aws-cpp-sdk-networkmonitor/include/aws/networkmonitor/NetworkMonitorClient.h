...
class AWS_NETWORKMONITOR_API NetworkMonitorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  NetworkMonitorClient(const Aws::NetworkMonitor::NetworkMonitorClientConfiguration& clientConfiguration =
  ...
  NetworkMonitorClient(const Aws::Auth::AWSCredentials& credentials,
                       std::shared_ptr<NetworkMonitorEndpointProviderBase> endpointProvider = nullptr,
                       const Aws::NetworkMonitor::NetworkMonitorClientConfiguration& clientConfiguration =
                           Aws::NetworkMonitor::NetworkMonitorClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  NetworkMonitorClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
  ...
  /**
   * An Async wrapper for CreateProbe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateProbeRequestT = Model::CreateProbeRequest>
  void CreateProbeAsync(const CreateProbeRequestT& request, const CreateProbeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteProbe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteProbeRequestT = Model::DeleteProbeRequest>
  void DeleteProbeAsync(const DeleteProbeRequestT& request, const DeleteProbeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetProbe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetProbeRequestT = Model::GetProbeRequest>
  void GetProbeAsync(const GetProbeRequestT& request, const GetProbeResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateProbe that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateProbeRequestT = Model::UpdateProbeRequest>
  void UpdateProbeAsync(const UpdateProbeRequestT& request, const UpdateProbeResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&NetworkMonitorClient::UpdateProbe, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<NetworkMonitorEndpointProviderBase>& accessEndpointProvider();
