...
class CreateMonitorResult {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  CreateMonitorResult& WithMonitorName(MonitorNameT&& value) {
  ...
  inline CreateMonitorResult& WithState(MonitorState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMonitorResult& WithAggregationPeriod(long long value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateMonitorResult& WithTags(TagsT&& value) {
