...
class CreateProbeResult {
 public:
  ...
  void SetProbeId(ProbeIdT&& value) {
    m_probeIdHasBeenSet = true;
    m_probeId = std::forward<ProbeIdT>(value);
  }
  template <typename ProbeIdT = Aws::String>
  CreateProbeResult& WithProbeId(ProbeIdT&& value) {
    SetProbeId(std::forward<ProbeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProbeArn(ProbeArnT&& value) {
    m_probeArnHasBeenSet = true;
    m_probeArn = std::forward<ProbeArnT>(value);
  }
  template <typename ProbeArnT = Aws::String>
  CreateProbeResult& WithProbeArn(ProbeArnT&& value) {
    SetProbeArn(std::forward<ProbeArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SourceArnT = Aws::String>
  CreateProbeResult& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  CreateProbeResult& WithDestination(DestinationT&& value) {
  ...
  inline CreateProbeResult& WithDestinationPort(int value) {
  ...
  inline CreateProbeResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPacketSize(int value) {
    m_packetSizeHasBeenSet = true;
    m_packetSize = value;
  }
  inline CreateProbeResult& WithPacketSize(int value) {
    SetPacketSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateProbeResult& WithAddressFamily(AddressFamily value) {
  ...
  template <typename VpcIdT = Aws::String>
  CreateProbeResult& WithVpcId(VpcIdT&& value) {
  ...
  inline void SetState(ProbeState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline CreateProbeResult& WithState(ProbeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateProbeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  CreateProbeResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateProbeResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateProbeResult& WithRequestId(RequestIdT&& value) {
