...
namespace Model
{
  ...
  /**
   */
  class DeleteMonitorRequest : public NetworkMonitorRequest
  {
  public:
    AWS_NETWORKMONITOR_API DeleteMonitorRequest();
    ...
    /**
     * <p>The name of the monitor to delete. Use the <code>ListMonitors</code> action
     * to get a list of your current monitors. </p>
     */
