...
class GetMonitorResult {
 public:
  ...
  inline GetMonitorResult& WithState(MonitorState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline GetMonitorResult& WithAggregationPeriod(long long value) {
  ...
  template <typename ProbesT = Aws::Vector<Probe>>
  GetMonitorResult& WithProbes(ProbesT&& value) {
    SetProbes(std::forward<ProbesT>(value));
    return *this;
  }
  template <typename ProbesT = Probe>
  GetMonitorResult& AddProbes(ProbesT&& value) {
    m_probesHasBeenSet = true;
