...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMONITOR_API GetProbeResult() = default;
    AWS_NETWORKMONITOR_API GetProbeResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKMONITOR_API GetProbeResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    template<typename ProbeIdT = Aws::String>
    GetProbeResult& WithProbeId(ProbeIdT&& value) { SetProbeId(std::forward<ProbeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProbeArnT = Aws::String>
    GetProbeResult& WithProbeArn(ProbeArnT&& value) { SetProbeArn(std::forward<ProbeArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceArnT = Aws::String>
    GetProbeResult& WithSourceArn(SourceArnT&& value) { SetSourceArn(std::forward<SourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationT = Aws::String>
    GetProbeResult& WithDestination(DestinationT&& value) { SetDestination(std::forward<DestinationT>(value)); return *this;}
    ///@}
    ...
    inline GetProbeResult& WithProtocol(Protocol value) { SetProtocol(value); return *this;}
    ///@}
    ...
    inline GetProbeResult& WithAddressFamily(AddressFamily value) { SetAddressFamily(value); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    GetProbeResult& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    inline GetProbeResult& WithState(ProbeState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetProbeResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    GetProbeResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    GetProbeResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    GetProbeResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    GetProbeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
