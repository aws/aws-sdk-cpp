...
class GetProbeResult {
 public:
  ...
  template <typename ProbeIdT = Aws::String>
  GetProbeResult& WithProbeId(ProbeIdT&& value) {
  ...
  template <typename ProbeArnT = Aws::String>
  GetProbeResult& WithProbeArn(ProbeArnT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  GetProbeResult& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  GetProbeResult& WithDestination(DestinationT&& value) {
  ...
  inline GetProbeResult& WithDestinationPort(int value) {
  ...
  inline GetProbeResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline GetProbeResult& WithPacketSize(int value) {
    SetPacketSize(value);
    return *this;
  }
  ///@}
  ...
  inline GetProbeResult& WithAddressFamily(AddressFamily value) {
  ...
  template <typename VpcIdT = Aws::String>
  GetProbeResult& WithVpcId(VpcIdT&& value) {
  ...
  inline GetProbeResult& WithState(ProbeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetProbeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  GetProbeResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetProbeResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetProbeResult& WithRequestId(RequestIdT&& value) {
