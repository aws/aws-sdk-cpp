...
class UpdateMonitorResult {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  UpdateMonitorResult& WithMonitorName(MonitorNameT&& value) {
  ...
  inline UpdateMonitorResult& WithState(MonitorState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateMonitorResult& WithAggregationPeriod(long long value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateMonitorResult& WithTags(TagsT&& value) {
