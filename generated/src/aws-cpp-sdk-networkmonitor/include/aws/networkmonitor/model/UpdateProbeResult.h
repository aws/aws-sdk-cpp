...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMONITOR_API UpdateProbeResult() = default;
    ...
    template<typename ProbeIdT = Aws::String>
    UpdateProbeResult& WithProbeId(ProbeIdT&& value) { SetProbeId(std::forward<ProbeIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ProbeArnT = Aws::String>
    UpdateProbeResult& WithProbeArn(ProbeArnT&& value) { SetProbeArn(std::forward<ProbeArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceArnT = Aws::String>
    UpdateProbeResult& WithSourceArn(SourceArnT&& value) { SetSourceArn(std::forward<SourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationT = Aws::String>
    UpdateProbeResult& WithDestination(DestinationT&& value) { SetDestination(std::forward<DestinationT>(value)); return *this;}
    ///@}
    ...
    inline UpdateProbeResult& WithProtocol(Protocol value) { SetProtocol(value); return *this;}
    ///@}
    ...
    inline UpdateProbeResult& WithAddressFamily(AddressFamily value) { SetAddressFamily(value); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    UpdateProbeResult& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateProbeResult& WithState(ProbeState value) { SetState(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    UpdateProbeResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename ModifiedAtT = Aws::Utils::DateTime>
    UpdateProbeResult& WithModifiedAt(ModifiedAtT&& value) { SetModifiedAt(std::forward<ModifiedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    UpdateProbeResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
    UpdateProbeResult& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    ...
    template<typename RequestIdT = Aws::String>
    UpdateProbeResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
