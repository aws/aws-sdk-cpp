...
class UpdateProbeResult {
 public:
  ...
  template <typename ProbeIdT = Aws::String>
  UpdateProbeResult& WithProbeId(ProbeIdT&& value) {
  ...
  template <typename ProbeArnT = Aws::String>
  UpdateProbeResult& WithProbeArn(ProbeArnT&& value) {
  ...
  template <typename SourceArnT = Aws::String>
  UpdateProbeResult& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  UpdateProbeResult& WithDestination(DestinationT&& value) {
  ...
  inline UpdateProbeResult& WithDestinationPort(int value) {
  ...
  inline UpdateProbeResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProbeResult& WithPacketSize(int value) {
    SetPacketSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProbeResult& WithAddressFamily(AddressFamily value) {
  ...
  template <typename VpcIdT = Aws::String>
  UpdateProbeResult& WithVpcId(VpcIdT&& value) {
  ...
  inline UpdateProbeResult& WithState(ProbeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  UpdateProbeResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  UpdateProbeResult& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  UpdateProbeResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateProbeResult& WithRequestId(RequestIdT&& value) {
