...
class CreateMonitorProbeInput {
 public:
  ...
  template <typename SourceArnT = Aws::String>
  CreateMonitorProbeInput& WithSourceArn(SourceArnT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  CreateMonitorProbeInput& WithDestination(DestinationT&& value) {
  ...
  inline CreateMonitorProbeInput& WithDestinationPort(int value) {
  ...
  inline CreateMonitorProbeInput& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateMonitorProbeInput& WithPacketSize(int value) {
    SetPacketSize(value);
    return *this;
  }
  ///@}
  ...
  void SetProbeTags(ProbeTagsT&& value) {
    m_probeTagsHasBeenSet = true;
    m_probeTags = std::forward<ProbeTagsT>(value);
  }
  template <typename ProbeTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateMonitorProbeInput& WithProbeTags(ProbeTagsT&& value) {
    SetProbeTags(std::forward<ProbeTagsT>(value));
    return *this;
  }
  ...
  CreateMonitorProbeInput& AddProbeTags(ProbeTagsKeyT&& key, ProbeTagsValueT&& value) {
    m_probeTagsHasBeenSet = true;
    m_probeTags.emplace(std::forward<ProbeTagsKeyT>(key), std::forward<ProbeTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
