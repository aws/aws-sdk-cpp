...
class CreateMonitorRequest : public NetworkMonitorRequest {
 public:
  ...
  void SetProbes(ProbesT&& value) {
    m_probesHasBeenSet = true;
    m_probes = std::forward<ProbesT>(value);
  }
  template <typename ProbesT = Aws::Vector<CreateMonitorProbeInput>>
  CreateMonitorRequest& WithProbes(ProbesT&& value) {
    SetProbes(std::forward<ProbesT>(value));
    return *this;
  }
  template <typename ProbesT = CreateMonitorProbeInput>
  CreateMonitorRequest& AddProbes(ProbesT&& value) {
    m_probesHasBeenSet = true;
    m_probes.emplace_back(std::forward<ProbesT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateMonitorRequest& WithAggregationPeriod(long long value) {
