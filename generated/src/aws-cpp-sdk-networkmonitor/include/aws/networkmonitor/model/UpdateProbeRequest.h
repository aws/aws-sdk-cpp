...
class UpdateProbeRequest : public NetworkMonitorRequest {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  UpdateProbeRequest& WithMonitorName(MonitorNameT&& value) {
  ...
  template <typename ProbeIdT = Aws::String>
  UpdateProbeRequest& WithProbeId(ProbeIdT&& value) {
  ...
  inline UpdateProbeRequest& WithState(ProbeState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename DestinationT = Aws::String>
  UpdateProbeRequest& WithDestination(DestinationT&& value) {
  ...
  inline UpdateProbeRequest& WithDestinationPort(int value) {
  ...
  inline UpdateProbeRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProbeRequest& WithPacketSize(int value) {
    SetPacketSize(value);
    return *this;
  }
  ///@}
