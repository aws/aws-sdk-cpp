...
namespace Model
{
  ...
  {
  public:
    AWS_NETWORKMONITOR_API ListTagsForResourceResult() = default;
    AWS_NETWORKMONITOR_API ListTagsForResourceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_NETWORKMONITOR_API ListTagsForResourceResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
