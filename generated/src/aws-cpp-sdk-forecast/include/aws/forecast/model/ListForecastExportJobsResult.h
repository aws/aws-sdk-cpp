...
class ListForecastExportJobsResult {
 public:
  ...
  void SetForecastExportJobs(ForecastExportJobsT&& value) {
    m_forecastExportJobsHasBeenSet = true;
    m_forecastExportJobs = std::forward<ForecastExportJobsT>(value);
  }
  template <typename ForecastExportJobsT = Aws::Vector<ForecastExportJobSummary>>
  ListForecastExportJobsResult& WithForecastExportJobs(ForecastExportJobsT&& value) {
    SetForecastExportJobs(std::forward<ForecastExportJobsT>(value));
    return *this;
  }
  template <typename ForecastExportJobsT = ForecastExportJobSummary>
  ListForecastExportJobsResult& AddForecastExportJobs(ForecastExportJobsT&& value) {
    m_forecastExportJobsHasBeenSet = true;
    m_forecastExportJobs.emplace_back(std::forward<ForecastExportJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListForecastExportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListForecastExportJobsResult& WithRequestId(RequestIdT&& value) {
