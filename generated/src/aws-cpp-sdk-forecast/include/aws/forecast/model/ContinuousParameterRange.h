...
class ContinuousParameterRange {
 public:
  ...
  inline ContinuousParameterRange& WithMaxValue(double value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline ContinuousParameterRange& WithMinValue(double value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline ContinuousParameterRange& WithScalingType(ScalingType value) {
