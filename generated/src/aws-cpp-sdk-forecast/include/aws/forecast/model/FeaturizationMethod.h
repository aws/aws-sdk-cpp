...
class FeaturizationMethod {
 public:
  ...
  inline void SetFeaturizationMethodName(FeaturizationMethodName value) {
    m_featurizationMethodNameHasBeenSet = true;
    m_featurizationMethodName = value;
  }
  inline FeaturizationMethod& WithFeaturizationMethodName(FeaturizationMethodName value) {
    SetFeaturizationMethodName(value);
    return *this;
  }
  ///@}
  ...
  void SetFeaturizationMethodParameters(FeaturizationMethodParametersT&& value) {
    ...
    m_featurizationMethodParameters = std::forward<FeaturizationMethodParametersT>(value);
  }
  template <typename FeaturizationMethodParametersT = Aws::Map<Aws::String, Aws::String>>
  FeaturizationMethod& WithFeaturizationMethodParameters(FeaturizationMethodParametersT&& value) {
    SetFeaturizationMethodParameters(std::forward<FeaturizationMethodParametersT>(value));
    return *this;
  }
  template <typename FeaturizationMethodParametersKeyT = Aws::String, typename FeaturizationMethodParametersValueT = Aws::String>
  FeaturizationMethod& AddFeaturizationMethodParameters(FeaturizationMethodParametersKeyT&& key,
                                                        FeaturizationMethodParametersValueT&& value) {
    m_featurizationMethodParametersHasBeenSet = true;
    m_featurizationMethodParameters.emplace(std::forward<FeaturizationMethodParametersKeyT>(key),
                                            std::forward<FeaturizationMethodParametersValueT>(value));
    return *this;
  }
  ///@}
 private:
