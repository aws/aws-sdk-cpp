...
namespace Model
{
  ...
  public:
    ...
    inline ListForecastsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListForecastsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListForecastsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
