...
namespace Model
{
  ...
  /**
   */
  class DescribeDatasetImportJobRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API DescribeDatasetImportJobRequest() = default;
    ...
    template<typename DatasetImportJobArnT = Aws::String>
    DescribeDatasetImportJobRequest& WithDatasetImportJobArn(DatasetImportJobArnT&& value) { SetDatasetImportJobArn(std::forward<DatasetImportJobArnT>(value)); return *this;}
    ///@}
  private:
