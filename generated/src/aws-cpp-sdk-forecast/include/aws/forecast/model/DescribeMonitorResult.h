...
class DescribeMonitorResult {
 public:
  ...
  template <typename MonitorNameT = Aws::String>
  DescribeMonitorResult& WithMonitorName(MonitorNameT&& value) {
  ...
  template <typename MonitorArnT = Aws::String>
  DescribeMonitorResult& WithMonitorArn(MonitorArnT&& value) {
  ...
  template <typename ResourceArnT = Aws::String>
  DescribeMonitorResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DescribeMonitorResult& WithStatus(StatusT&& value) {
  ...
  void SetLastEvaluationTime(LastEvaluationTimeT&& value) {
    m_lastEvaluationTimeHasBeenSet = true;
    m_lastEvaluationTime = std::forward<LastEvaluationTimeT>(value);
  }
  template <typename LastEvaluationTimeT = Aws::Utils::DateTime>
  DescribeMonitorResult& WithLastEvaluationTime(LastEvaluationTimeT&& value) {
    SetLastEvaluationTime(std::forward<LastEvaluationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastEvaluationState(LastEvaluationStateT&& value) {
    m_lastEvaluationStateHasBeenSet = true;
    m_lastEvaluationState = std::forward<LastEvaluationStateT>(value);
  }
  template <typename LastEvaluationStateT = Aws::String>
  DescribeMonitorResult& WithLastEvaluationState(LastEvaluationStateT&& value) {
    SetLastEvaluationState(std::forward<LastEvaluationStateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BaselineT = Baseline>
  DescribeMonitorResult& WithBaseline(BaselineT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DescribeMonitorResult& WithMessage(MessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeMonitorResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  DescribeMonitorResult& WithLastModificationTime(LastModificationTimeT&& value) {
  ...
  inline void SetEstimatedEvaluationTimeRemainingInMinutes(long long value) {
    m_estimatedEvaluationTimeRemainingInMinutesHasBeenSet = true;
    m_estimatedEvaluationTimeRemainingInMinutes = value;
  }
  inline DescribeMonitorResult& WithEstimatedEvaluationTimeRemainingInMinutes(long long value) {
    SetEstimatedEvaluationTimeRemainingInMinutes(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMonitorResult& WithRequestId(RequestIdT&& value) {
