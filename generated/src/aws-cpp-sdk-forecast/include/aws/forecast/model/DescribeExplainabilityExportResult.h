...
class DescribeExplainabilityExportResult {
 public:
  ...
  AWS_FORECASTSERVICE_API DescribeExplainabilityExportResult& operator=(
  ...
  void SetExplainabilityExportArn(ExplainabilityExportArnT&& value) {
    m_explainabilityExportArnHasBeenSet = true;
    m_explainabilityExportArn = std::forward<ExplainabilityExportArnT>(value);
  }
  template <typename ExplainabilityExportArnT = Aws::String>
  DescribeExplainabilityExportResult& WithExplainabilityExportArn(ExplainabilityExportArnT&& value) {
    SetExplainabilityExportArn(std::forward<ExplainabilityExportArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExplainabilityExportName(ExplainabilityExportNameT&& value) {
    ...
    m_explainabilityExportName = std::forward<ExplainabilityExportNameT>(value);
  }
  template <typename ExplainabilityExportNameT = Aws::String>
  DescribeExplainabilityExportResult& WithExplainabilityExportName(ExplainabilityExportNameT&& value) {
    SetExplainabilityExportName(std::forward<ExplainabilityExportNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExplainabilityArnT = Aws::String>
  DescribeExplainabilityExportResult& WithExplainabilityArn(ExplainabilityArnT&& value) {
  ...
  template <typename DestinationT = DataDestination>
  DescribeExplainabilityExportResult& WithDestination(DestinationT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DescribeExplainabilityExportResult& WithMessage(MessageT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DescribeExplainabilityExportResult& WithStatus(StatusT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeExplainabilityExportResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  DescribeExplainabilityExportResult& WithLastModificationTime(LastModificationTimeT&& value) {
  ...
  template <typename FormatT = Aws::String>
  DescribeExplainabilityExportResult& WithFormat(FormatT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeExplainabilityExportResult& WithRequestId(RequestIdT&& value) {
