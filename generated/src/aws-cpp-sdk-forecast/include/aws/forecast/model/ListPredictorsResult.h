...
class ListPredictorsResult {
 public:
  ...
  void SetPredictors(PredictorsT&& value) {
    m_predictorsHasBeenSet = true;
    m_predictors = std::forward<PredictorsT>(value);
  }
  template <typename PredictorsT = Aws::Vector<PredictorSummary>>
  ListPredictorsResult& WithPredictors(PredictorsT&& value) {
    SetPredictors(std::forward<PredictorsT>(value));
    return *this;
  }
  template <typename PredictorsT = PredictorSummary>
  ListPredictorsResult& AddPredictors(PredictorsT&& value) {
    m_predictorsHasBeenSet = true;
    m_predictors.emplace_back(std::forward<PredictorsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPredictorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPredictorsResult& WithRequestId(RequestIdT&& value) {
