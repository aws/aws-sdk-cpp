...
class Featurization {
 public:
  ...
  template <typename AttributeNameT = Aws::String>
  Featurization& WithAttributeName(AttributeNameT&& value) {
  ...
  void SetFeaturizationPipeline(FeaturizationPipelineT&& value) {
    m_featurizationPipelineHasBeenSet = true;
    m_featurizationPipeline = std::forward<FeaturizationPipelineT>(value);
  }
  template <typename FeaturizationPipelineT = Aws::Vector<FeaturizationMethod>>
  Featurization& WithFeaturizationPipeline(FeaturizationPipelineT&& value) {
    SetFeaturizationPipeline(std::forward<FeaturizationPipelineT>(value));
    return *this;
  }
  template <typename FeaturizationPipelineT = FeaturizationMethod>
  Featurization& AddFeaturizationPipeline(FeaturizationPipelineT&& value) {
    m_featurizationPipelineHasBeenSet = true;
    m_featurizationPipeline.emplace_back(std::forward<FeaturizationPipelineT>(value));
    return *this;
  }
  ///@}
 private:
