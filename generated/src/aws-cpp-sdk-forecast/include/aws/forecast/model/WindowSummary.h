...
class WindowSummary {
 public:
  ...
  void SetTestWindowStart(TestWindowStartT&& value) {
    ...
    m_testWindowStart = std::forward<TestWindowStartT>(value);
  }
  template <typename TestWindowStartT = Aws::Utils::DateTime>
  WindowSummary& WithTestWindowStart(TestWindowStartT&& value) {
    SetTestWindowStart(std::forward<TestWindowStartT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestWindowEnd(TestWindowEndT&& value) {
    ...
    m_testWindowEnd = std::forward<TestWindowEndT>(value);
  }
  template <typename TestWindowEndT = Aws::Utils::DateTime>
  WindowSummary& WithTestWindowEnd(TestWindowEndT&& value) {
    SetTestWindowEnd(std::forward<TestWindowEndT>(value));
    return *this;
  }
  ///@}
  ...
  inline WindowSummary& WithItemCount(int value) {
    SetItemCount(value);
    return *this;
  }
  ///@}
  ...
  inline WindowSummary& WithEvaluationType(EvaluationType value) {
