...
namespace Model
{
  ...
  {
  public:
    AWS_FORECASTSERVICE_API ListWhatIfForecastsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListWhatIfForecastsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListWhatIfForecastsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListWhatIfForecastsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
