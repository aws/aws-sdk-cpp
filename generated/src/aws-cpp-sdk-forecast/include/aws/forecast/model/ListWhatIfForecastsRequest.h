...
class ListWhatIfForecastsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatIfForecastsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWhatIfForecastsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListWhatIfForecastsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListWhatIfForecastsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
