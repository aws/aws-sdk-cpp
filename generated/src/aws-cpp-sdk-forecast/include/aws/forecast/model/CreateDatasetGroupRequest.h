...
class CreateDatasetGroupRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename DatasetGroupNameT = Aws::String>
  CreateDatasetGroupRequest& WithDatasetGroupName(DatasetGroupNameT&& value) {
  ...
  template <typename DatasetArnsT = Aws::Vector<Aws::String>>
  CreateDatasetGroupRequest& WithDatasetArns(DatasetArnsT&& value) {
    SetDatasetArns(std::forward<DatasetArnsT>(value));
    return *this;
  }
  template <typename DatasetArnsT = Aws::String>
  CreateDatasetGroupRequest& AddDatasetArns(DatasetArnsT&& value) {
    m_datasetArnsHasBeenSet = true;
