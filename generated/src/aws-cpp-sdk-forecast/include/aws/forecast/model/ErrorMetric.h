...
class ErrorMetric {
 public:
  ...
  void SetForecastType(ForecastTypeT&& value) {
    ...
    m_forecastType = std::forward<ForecastTypeT>(value);
  }
  template <typename ForecastTypeT = Aws::String>
  ErrorMetric& WithForecastType(ForecastTypeT&& value) {
    SetForecastType(std::forward<ForecastTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWAPE(double value) {
    m_wAPEHasBeenSet = true;
    m_wAPE = value;
  }
  inline ErrorMetric& WithWAPE(double value) {
    SetWAPE(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRMSE(double value) {
    m_rMSEHasBeenSet = true;
    m_rMSE = value;
  }
  inline ErrorMetric& WithRMSE(double value) {
    SetRMSE(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMASE(double value) {
    m_mASEHasBeenSet = true;
    m_mASE = value;
  }
  inline ErrorMetric& WithMASE(double value) {
    SetMASE(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMAPE(double value) {
    m_mAPEHasBeenSet = true;
    m_mAPE = value;
  }
  inline ErrorMetric& WithMAPE(double value) {
    SetMAPE(value);
    return *this;
  }
  ///@}
