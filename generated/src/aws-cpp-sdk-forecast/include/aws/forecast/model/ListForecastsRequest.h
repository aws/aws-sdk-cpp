...
namespace Model
{
  ...
  /**
   */
  class ListForecastsRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API ListForecastsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListForecastsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListForecastsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListForecastsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
