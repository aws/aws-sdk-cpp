...
class ListForecastsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListForecastsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListForecastsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListForecastsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListForecastsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
