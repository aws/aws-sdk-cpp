...
class PredictorMonitorEvaluation {
 public:
  ...
  void SetEvaluationTime(EvaluationTimeT&& value) {
    ...
    m_evaluationTime = std::forward<EvaluationTimeT>(value);
  }
  template <typename EvaluationTimeT = Aws::Utils::DateTime>
  PredictorMonitorEvaluation& WithEvaluationTime(EvaluationTimeT&& value) {
    SetEvaluationTime(std::forward<EvaluationTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEvaluationState(EvaluationStateT&& value) {
    ...
    m_evaluationState = std::forward<EvaluationStateT>(value);
  }
  template <typename EvaluationStateT = Aws::String>
  PredictorMonitorEvaluation& WithEvaluationState(EvaluationStateT&& value) {
    SetEvaluationState(std::forward<EvaluationStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWindowStartDatetime(WindowStartDatetimeT&& value) {
    ...
    m_windowStartDatetime = std::forward<WindowStartDatetimeT>(value);
  }
  template <typename WindowStartDatetimeT = Aws::Utils::DateTime>
  PredictorMonitorEvaluation& WithWindowStartDatetime(WindowStartDatetimeT&& value) {
    SetWindowStartDatetime(std::forward<WindowStartDatetimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWindowEndDatetime(WindowEndDatetimeT&& value) {
    ...
    m_windowEndDatetime = std::forward<WindowEndDatetimeT>(value);
  }
  template <typename WindowEndDatetimeT = Aws::Utils::DateTime>
  PredictorMonitorEvaluation& WithWindowEndDatetime(WindowEndDatetimeT&& value) {
    SetWindowEndDatetime(std::forward<WindowEndDatetimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPredictorEvent(PredictorEventT&& value) {
    ...
    m_predictorEvent = std::forward<PredictorEventT>(value);
  }
  template <typename PredictorEventT = PredictorEvent>
  PredictorMonitorEvaluation& WithPredictorEvent(PredictorEventT&& value) {
    SetPredictorEvent(std::forward<PredictorEventT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonitorDataSource(MonitorDataSourceT&& value) {
    ...
    m_monitorDataSource = std::forward<MonitorDataSourceT>(value);
  }
  template <typename MonitorDataSourceT = MonitorDataSource>
  PredictorMonitorEvaluation& WithMonitorDataSource(MonitorDataSourceT&& value) {
    SetMonitorDataSource(std::forward<MonitorDataSourceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumItemsEvaluated(long long value) {
    m_numItemsEvaluatedHasBeenSet = true;
    m_numItemsEvaluated = value;
  }
  inline PredictorMonitorEvaluation& WithNumItemsEvaluated(long long value) {
    SetNumItemsEvaluated(value);
    return *this;
  }
  ///@}
