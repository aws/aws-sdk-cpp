...
class PredictorExecutionDetails {
 public:
  ...
  void SetPredictorExecutions(PredictorExecutionsT&& value) {
    ...
    m_predictorExecutions = std::forward<PredictorExecutionsT>(value);
  }
  template <typename PredictorExecutionsT = Aws::Vector<PredictorExecution>>
  PredictorExecutionDetails& WithPredictorExecutions(PredictorExecutionsT&& value) {
    SetPredictorExecutions(std::forward<PredictorExecutionsT>(value));
    return *this;
  }
  ...
  PredictorExecutionDetails& AddPredictorExecutions(PredictorExecutionsT&& value) {
    m_predictorExecutionsHasBeenSet = true;
    m_predictorExecutions.emplace_back(std::forward<PredictorExecutionsT>(value));
    return *this;
  }
  ///@}
 private:
