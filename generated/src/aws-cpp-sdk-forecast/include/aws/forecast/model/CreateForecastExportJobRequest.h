...
class CreateForecastExportJobRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename ForecastExportJobNameT = Aws::String>
  CreateForecastExportJobRequest& WithForecastExportJobName(ForecastExportJobNameT&& value) {
  ...
  template <typename ForecastArnT = Aws::String>
  CreateForecastExportJobRequest& WithForecastArn(ForecastArnT&& value) {
  ...
  template <typename DestinationT = DataDestination>
  CreateForecastExportJobRequest& WithDestination(DestinationT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateForecastExportJobRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateForecastExportJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FormatT = Aws::String>
  CreateForecastExportJobRequest& WithFormat(FormatT&& value) {
