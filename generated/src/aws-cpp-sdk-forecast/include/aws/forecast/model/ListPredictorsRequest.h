...
class ListPredictorsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPredictorsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPredictorsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListPredictorsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListPredictorsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
