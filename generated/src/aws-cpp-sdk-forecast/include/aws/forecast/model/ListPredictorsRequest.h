...
namespace Model
{
  ...
  /**
   */
  class ListPredictorsRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API ListPredictorsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListPredictorsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListPredictorsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListPredictorsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
