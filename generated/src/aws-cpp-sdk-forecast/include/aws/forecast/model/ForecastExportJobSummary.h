...
class ForecastExportJobSummary {
 public:
  ...
  void SetForecastExportJobArn(ForecastExportJobArnT&& value) {
    m_forecastExportJobArnHasBeenSet = true;
    m_forecastExportJobArn = std::forward<ForecastExportJobArnT>(value);
  }
  template <typename ForecastExportJobArnT = Aws::String>
  ForecastExportJobSummary& WithForecastExportJobArn(ForecastExportJobArnT&& value) {
    SetForecastExportJobArn(std::forward<ForecastExportJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForecastExportJobName(ForecastExportJobNameT&& value) {
    m_forecastExportJobNameHasBeenSet = true;
    m_forecastExportJobName = std::forward<ForecastExportJobNameT>(value);
  }
  template <typename ForecastExportJobNameT = Aws::String>
  ForecastExportJobSummary& WithForecastExportJobName(ForecastExportJobNameT&& value) {
    SetForecastExportJobName(std::forward<ForecastExportJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DestinationT = DataDestination>
  ForecastExportJobSummary& WithDestination(DestinationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ForecastExportJobSummary& WithStatus(StatusT&& value) {
  ...
  template <typename MessageT = Aws::String>
  ForecastExportJobSummary& WithMessage(MessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ForecastExportJobSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  ForecastExportJobSummary& WithLastModificationTime(LastModificationTimeT&& value) {
