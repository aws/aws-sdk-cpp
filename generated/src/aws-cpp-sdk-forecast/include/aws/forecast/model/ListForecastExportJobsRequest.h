...
class ListForecastExportJobsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListForecastExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListForecastExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListForecastExportJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListForecastExportJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
