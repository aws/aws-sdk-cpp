...
namespace Model
{
  ...
  /**
   */
  class ListForecastExportJobsRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API ListForecastExportJobsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListForecastExportJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListForecastExportJobsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListForecastExportJobsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
