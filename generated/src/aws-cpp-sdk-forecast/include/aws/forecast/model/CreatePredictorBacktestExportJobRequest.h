...
class CreatePredictorBacktestExportJobRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename PredictorBacktestExportJobNameT = Aws::String>
  CreatePredictorBacktestExportJobRequest& WithPredictorBacktestExportJobName(PredictorBacktestExportJobNameT&& value) {
  ...
  template <typename PredictorArnT = Aws::String>
  CreatePredictorBacktestExportJobRequest& WithPredictorArn(PredictorArnT&& value) {
  ...
  template <typename DestinationT = DataDestination>
  CreatePredictorBacktestExportJobRequest& WithDestination(DestinationT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreatePredictorBacktestExportJobRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreatePredictorBacktestExportJobRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FormatT = Aws::String>
  CreatePredictorBacktestExportJobRequest& WithFormat(FormatT&& value) {
