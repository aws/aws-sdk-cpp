...
class WeightedQuantileLoss {
 public:
  ...
  inline void SetQuantile(double value) {
    m_quantileHasBeenSet = true;
    m_quantile = value;
  }
  inline WeightedQuantileLoss& WithQuantile(double value) {
    SetQuantile(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLossValue(double value) {
    m_lossValueHasBeenSet = true;
    m_lossValue = value;
  }
  inline WeightedQuantileLoss& WithLossValue(double value) {
    SetLossValue(value);
    return *this;
  }
  ///@}
