...
class ListPredictorBacktestExportJobsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListPredictorBacktestExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPredictorBacktestExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListPredictorBacktestExportJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListPredictorBacktestExportJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
