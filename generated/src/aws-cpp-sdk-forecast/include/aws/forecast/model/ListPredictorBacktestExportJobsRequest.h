...
namespace Model
{
  ...
  {
  public:
    AWS_FORECASTSERVICE_API ListPredictorBacktestExportJobsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListPredictorBacktestExportJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListPredictorBacktestExportJobsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListPredictorBacktestExportJobsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
