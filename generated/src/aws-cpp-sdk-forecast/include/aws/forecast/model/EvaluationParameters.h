...
class EvaluationParameters {
 public:
  ...
  inline void SetNumberOfBacktestWindows(int value) {
    m_numberOfBacktestWindowsHasBeenSet = true;
    m_numberOfBacktestWindows = value;
  }
  inline EvaluationParameters& WithNumberOfBacktestWindows(int value) {
    SetNumberOfBacktestWindows(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBackTestWindowOffset(int value) {
    m_backTestWindowOffsetHasBeenSet = true;
    m_backTestWindowOffset = value;
  }
  inline EvaluationParameters& WithBackTestWindowOffset(int value) {
    SetBackTestWindowOffset(value);
    return *this;
  }
  ///@}
 private:
