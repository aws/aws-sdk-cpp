...
namespace Model
{
  ...
  {
  public:
    AWS_FORECASTSERVICE_API StopResourceRequest() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    StopResourceRequest& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
  private:
