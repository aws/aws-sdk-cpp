...
class ListWhatIfForecastsResult {
 public:
  ...
  void SetWhatIfForecasts(WhatIfForecastsT&& value) {
    m_whatIfForecastsHasBeenSet = true;
    m_whatIfForecasts = std::forward<WhatIfForecastsT>(value);
  }
  template <typename WhatIfForecastsT = Aws::Vector<WhatIfForecastSummary>>
  ListWhatIfForecastsResult& WithWhatIfForecasts(WhatIfForecastsT&& value) {
    SetWhatIfForecasts(std::forward<WhatIfForecastsT>(value));
    return *this;
  }
  template <typename WhatIfForecastsT = WhatIfForecastSummary>
  ListWhatIfForecastsResult& AddWhatIfForecasts(WhatIfForecastsT&& value) {
    m_whatIfForecastsHasBeenSet = true;
    m_whatIfForecasts.emplace_back(std::forward<WhatIfForecastsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatIfForecastsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWhatIfForecastsResult& WithRequestId(RequestIdT&& value) {
