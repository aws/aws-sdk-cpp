...
class DescribePredictorBacktestExportJobRequest : public ForecastServiceRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribePredictorBacktestExportJob"; }
  ...
  template <typename PredictorBacktestExportJobArnT = Aws::String>
  DescribePredictorBacktestExportJobRequest& WithPredictorBacktestExportJobArn(PredictorBacktestExportJobArnT&& value) {
