...
namespace Model
{
  ...
  /**
   */
  class ListDatasetImportJobsRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API ListDatasetImportJobsRequest() = default;
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    ListDatasetImportJobsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    ListDatasetImportJobsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
  private:
