...
class ListDatasetGroupsResult {
 public:
  ...
  void SetDatasetGroups(DatasetGroupsT&& value) {
    m_datasetGroupsHasBeenSet = true;
    m_datasetGroups = std::forward<DatasetGroupsT>(value);
  }
  template <typename DatasetGroupsT = Aws::Vector<DatasetGroupSummary>>
  ListDatasetGroupsResult& WithDatasetGroups(DatasetGroupsT&& value) {
    SetDatasetGroups(std::forward<DatasetGroupsT>(value));
    return *this;
  }
  template <typename DatasetGroupsT = DatasetGroupSummary>
  ListDatasetGroupsResult& AddDatasetGroups(DatasetGroupsT&& value) {
    m_datasetGroupsHasBeenSet = true;
    m_datasetGroups.emplace_back(std::forward<DatasetGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDatasetGroupsResult& WithRequestId(RequestIdT&& value) {
