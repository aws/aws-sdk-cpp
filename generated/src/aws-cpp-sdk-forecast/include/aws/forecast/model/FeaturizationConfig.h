...
class FeaturizationConfig {
 public:
  ...
  void SetFeaturizations(FeaturizationsT&& value) {
    m_featurizationsHasBeenSet = true;
    m_featurizations = std::forward<FeaturizationsT>(value);
  }
  template <typename FeaturizationsT = Aws::Vector<Featurization>>
  FeaturizationConfig& WithFeaturizations(FeaturizationsT&& value) {
    SetFeaturizations(std::forward<FeaturizationsT>(value));
    return *this;
  }
  template <typename FeaturizationsT = Featurization>
  FeaturizationConfig& AddFeaturizations(FeaturizationsT&& value) {
    m_featurizationsHasBeenSet = true;
    m_featurizations.emplace_back(std::forward<FeaturizationsT>(value));
    return *this;
  }
  ///@}
 private:
