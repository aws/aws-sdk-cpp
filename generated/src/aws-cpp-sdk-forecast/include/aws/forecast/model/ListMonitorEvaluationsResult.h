...
class ListMonitorEvaluationsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitorEvaluationsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetPredictorMonitorEvaluations(PredictorMonitorEvaluationsT&& value) {
    m_predictorMonitorEvaluationsHasBeenSet = true;
    m_predictorMonitorEvaluations = std::forward<PredictorMonitorEvaluationsT>(value);
  }
  template <typename PredictorMonitorEvaluationsT = Aws::Vector<PredictorMonitorEvaluation>>
  ListMonitorEvaluationsResult& WithPredictorMonitorEvaluations(PredictorMonitorEvaluationsT&& value) {
    SetPredictorMonitorEvaluations(std::forward<PredictorMonitorEvaluationsT>(value));
    return *this;
  }
  template <typename PredictorMonitorEvaluationsT = PredictorMonitorEvaluation>
  ListMonitorEvaluationsResult& AddPredictorMonitorEvaluations(PredictorMonitorEvaluationsT&& value) {
    m_predictorMonitorEvaluationsHasBeenSet = true;
    m_predictorMonitorEvaluations.emplace_back(std::forward<PredictorMonitorEvaluationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMonitorEvaluationsResult& WithRequestId(RequestIdT&& value) {
