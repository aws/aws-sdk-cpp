...
class DescribeForecastExportJobResult {
 public:
  ...
  AWS_FORECASTSERVICE_API DescribeForecastExportJobResult& operator=(
  ...
  template <typename ForecastExportJobArnT = Aws::String>
  DescribeForecastExportJobResult& WithForecastExportJobArn(ForecastExportJobArnT&& value) {
  ...
  template <typename ForecastExportJobNameT = Aws::String>
  DescribeForecastExportJobResult& WithForecastExportJobName(ForecastExportJobNameT&& value) {
  ...
  template <typename ForecastArnT = Aws::String>
  DescribeForecastExportJobResult& WithForecastArn(ForecastArnT&& value) {
  ...
  template <typename DestinationT = DataDestination>
  DescribeForecastExportJobResult& WithDestination(DestinationT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DescribeForecastExportJobResult& WithMessage(MessageT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DescribeForecastExportJobResult& WithStatus(StatusT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeForecastExportJobResult& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  DescribeForecastExportJobResult& WithLastModificationTime(LastModificationTimeT&& value) {
  ...
  template <typename FormatT = Aws::String>
  DescribeForecastExportJobResult& WithFormat(FormatT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeForecastExportJobResult& WithRequestId(RequestIdT&& value) {
