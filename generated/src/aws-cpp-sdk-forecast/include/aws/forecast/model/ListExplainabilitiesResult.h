...
class ListExplainabilitiesResult {
 public:
  ...
  void SetExplainabilities(ExplainabilitiesT&& value) {
    m_explainabilitiesHasBeenSet = true;
    m_explainabilities = std::forward<ExplainabilitiesT>(value);
  }
  template <typename ExplainabilitiesT = Aws::Vector<ExplainabilitySummary>>
  ListExplainabilitiesResult& WithExplainabilities(ExplainabilitiesT&& value) {
    SetExplainabilities(std::forward<ExplainabilitiesT>(value));
    return *this;
  }
  template <typename ExplainabilitiesT = ExplainabilitySummary>
  ListExplainabilitiesResult& AddExplainabilities(ExplainabilitiesT&& value) {
    m_explainabilitiesHasBeenSet = true;
    m_explainabilities.emplace_back(std::forward<ExplainabilitiesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListExplainabilitiesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListExplainabilitiesResult& WithRequestId(RequestIdT&& value) {
