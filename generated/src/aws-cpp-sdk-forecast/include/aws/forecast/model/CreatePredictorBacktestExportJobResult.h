...
class CreatePredictorBacktestExportJobResult {
 public:
  ...
  AWS_FORECASTSERVICE_API CreatePredictorBacktestExportJobResult& operator=(
  ...
  template <typename PredictorBacktestExportJobArnT = Aws::String>
  CreatePredictorBacktestExportJobResult& WithPredictorBacktestExportJobArn(PredictorBacktestExportJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePredictorBacktestExportJobResult& WithRequestId(RequestIdT&& value) {
