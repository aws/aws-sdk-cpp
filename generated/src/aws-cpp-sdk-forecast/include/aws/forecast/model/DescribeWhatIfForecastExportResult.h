...
class DescribeWhatIfForecastExportResult {
 public:
  ...
  AWS_FORECASTSERVICE_API DescribeWhatIfForecastExportResult& operator=(
  ...
  template <typename WhatIfForecastExportArnT = Aws::String>
  DescribeWhatIfForecastExportResult& WithWhatIfForecastExportArn(WhatIfForecastExportArnT&& value) {
  ...
  template <typename WhatIfForecastExportNameT = Aws::String>
  DescribeWhatIfForecastExportResult& WithWhatIfForecastExportName(WhatIfForecastExportNameT&& value) {
  ...
  template <typename WhatIfForecastArnsT = Aws::Vector<Aws::String>>
  DescribeWhatIfForecastExportResult& WithWhatIfForecastArns(WhatIfForecastArnsT&& value) {
    SetWhatIfForecastArns(std::forward<WhatIfForecastArnsT>(value));
    return *this;
  }
  template <typename WhatIfForecastArnsT = Aws::String>
  DescribeWhatIfForecastExportResult& AddWhatIfForecastArns(WhatIfForecastArnsT&& value) {
    m_whatIfForecastArnsHasBeenSet = true;
  ...
  template <typename DestinationT = DataDestination>
  DescribeWhatIfForecastExportResult& WithDestination(DestinationT&& value) {
  ...
  template <typename MessageT = Aws::String>
  DescribeWhatIfForecastExportResult& WithMessage(MessageT&& value) {
  ...
  template <typename StatusT = Aws::String>
  DescribeWhatIfForecastExportResult& WithStatus(StatusT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeWhatIfForecastExportResult& WithCreationTime(CreationTimeT&& value) {
  ...
  inline DescribeWhatIfForecastExportResult& WithEstimatedTimeRemainingInMinutes(long long value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  DescribeWhatIfForecastExportResult& WithLastModificationTime(LastModificationTimeT&& value) {
  ...
  template <typename FormatT = Aws::String>
  DescribeWhatIfForecastExportResult& WithFormat(FormatT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeWhatIfForecastExportResult& WithRequestId(RequestIdT&& value) {
