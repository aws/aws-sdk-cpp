...
namespace Model
{
  ...
  /**
   */
  class GetAccuracyMetricsRequest : public ForecastServiceRequest
  {
  public:
    AWS_FORECASTSERVICE_API GetAccuracyMetricsRequest() = default;
    ...
    template<typename PredictorArnT = Aws::String>
    GetAccuracyMetricsRequest& WithPredictorArn(PredictorArnT&& value) { SetPredictorArn(std::forward<PredictorArnT>(value)); return *this;}
    ///@}
  private:
