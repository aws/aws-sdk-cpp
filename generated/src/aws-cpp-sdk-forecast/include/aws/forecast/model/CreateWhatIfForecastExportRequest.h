...
class CreateWhatIfForecastExportRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename WhatIfForecastExportNameT = Aws::String>
  CreateWhatIfForecastExportRequest& WithWhatIfForecastExportName(WhatIfForecastExportNameT&& value) {
  ...
  template <typename WhatIfForecastArnsT = Aws::Vector<Aws::String>>
  CreateWhatIfForecastExportRequest& WithWhatIfForecastArns(WhatIfForecastArnsT&& value) {
    SetWhatIfForecastArns(std::forward<WhatIfForecastArnsT>(value));
    return *this;
  }
  template <typename WhatIfForecastArnsT = Aws::String>
  CreateWhatIfForecastExportRequest& AddWhatIfForecastArns(WhatIfForecastArnsT&& value) {
    m_whatIfForecastArnsHasBeenSet = true;
  ...
  template <typename DestinationT = DataDestination>
  CreateWhatIfForecastExportRequest& WithDestination(DestinationT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateWhatIfForecastExportRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateWhatIfForecastExportRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename FormatT = Aws::String>
  CreateWhatIfForecastExportRequest& WithFormat(FormatT&& value) {
