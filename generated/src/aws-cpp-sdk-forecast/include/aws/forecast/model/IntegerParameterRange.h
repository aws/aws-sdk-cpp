...
class IntegerParameterRange {
 public:
  ...
  inline IntegerParameterRange& WithMaxValue(int value) {
    SetMaxValue(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerParameterRange& WithMinValue(int value) {
    SetMinValue(value);
    return *this;
  }
  ///@}
  ...
  inline IntegerParameterRange& WithScalingType(ScalingType value) {
