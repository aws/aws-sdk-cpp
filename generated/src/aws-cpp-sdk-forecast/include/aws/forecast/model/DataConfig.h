...
class DataConfig {
 public:
  ...
  template <typename DatasetGroupArnT = Aws::String>
  DataConfig& WithDatasetGroupArn(DatasetGroupArnT&& value) {
  ...
  void SetAttributeConfigs(AttributeConfigsT&& value) {
    m_attributeConfigsHasBeenSet = true;
    m_attributeConfigs = std::forward<AttributeConfigsT>(value);
  }
  template <typename AttributeConfigsT = Aws::Vector<AttributeConfig>>
  DataConfig& WithAttributeConfigs(AttributeConfigsT&& value) {
    SetAttributeConfigs(std::forward<AttributeConfigsT>(value));
    return *this;
  }
  template <typename AttributeConfigsT = AttributeConfig>
  DataConfig& AddAttributeConfigs(AttributeConfigsT&& value) {
    m_attributeConfigsHasBeenSet = true;
    m_attributeConfigs.emplace_back(std::forward<AttributeConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAdditionalDatasets(AdditionalDatasetsT&& value) {
    m_additionalDatasetsHasBeenSet = true;
    m_additionalDatasets = std::forward<AdditionalDatasetsT>(value);
  }
  template <typename AdditionalDatasetsT = Aws::Vector<AdditionalDataset>>
  DataConfig& WithAdditionalDatasets(AdditionalDatasetsT&& value) {
    SetAdditionalDatasets(std::forward<AdditionalDatasetsT>(value));
    return *this;
  }
  template <typename AdditionalDatasetsT = AdditionalDataset>
  DataConfig& AddAdditionalDatasets(AdditionalDatasetsT&& value) {
    m_additionalDatasetsHasBeenSet = true;
    m_additionalDatasets.emplace_back(std::forward<AdditionalDatasetsT>(value));
    return *this;
  }
  ///@}
 private:
