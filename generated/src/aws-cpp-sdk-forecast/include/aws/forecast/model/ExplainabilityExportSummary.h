...
class ExplainabilityExportSummary {
 public:
  ...
  template <typename ExplainabilityExportArnT = Aws::String>
  ExplainabilityExportSummary& WithExplainabilityExportArn(ExplainabilityExportArnT&& value) {
  ...
  template <typename ExplainabilityExportNameT = Aws::String>
  ExplainabilityExportSummary& WithExplainabilityExportName(ExplainabilityExportNameT&& value) {
  ...
  template <typename DestinationT = DataDestination>
  ExplainabilityExportSummary& WithDestination(DestinationT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ExplainabilityExportSummary& WithStatus(StatusT&& value) {
  ...
  template <typename MessageT = Aws::String>
  ExplainabilityExportSummary& WithMessage(MessageT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  ExplainabilityExportSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  ExplainabilityExportSummary& WithLastModificationTime(LastModificationTimeT&& value) {
