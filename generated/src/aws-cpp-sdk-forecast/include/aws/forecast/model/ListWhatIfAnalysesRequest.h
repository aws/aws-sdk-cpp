...
class ListWhatIfAnalysesRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatIfAnalysesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWhatIfAnalysesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListWhatIfAnalysesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListWhatIfAnalysesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
