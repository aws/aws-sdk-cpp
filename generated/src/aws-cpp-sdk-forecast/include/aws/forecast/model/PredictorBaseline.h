...
class PredictorBaseline {
 public:
  ...
  void SetBaselineMetrics(BaselineMetricsT&& value) {
    m_baselineMetricsHasBeenSet = true;
    m_baselineMetrics = std::forward<BaselineMetricsT>(value);
  }
  template <typename BaselineMetricsT = Aws::Vector<BaselineMetric>>
  PredictorBaseline& WithBaselineMetrics(BaselineMetricsT&& value) {
    SetBaselineMetrics(std::forward<BaselineMetricsT>(value));
    return *this;
  }
  template <typename BaselineMetricsT = BaselineMetric>
  PredictorBaseline& AddBaselineMetrics(BaselineMetricsT&& value) {
    m_baselineMetricsHasBeenSet = true;
    m_baselineMetrics.emplace_back(std::forward<BaselineMetricsT>(value));
    return *this;
  }
  ///@}
 private:
