...
class CreateWhatIfForecastExportResult {
 public:
  ...
  AWS_FORECASTSERVICE_API CreateWhatIfForecastExportResult& operator=(
  ...
  template <typename WhatIfForecastExportArnT = Aws::String>
  CreateWhatIfForecastExportResult& WithWhatIfForecastExportArn(WhatIfForecastExportArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWhatIfForecastExportResult& WithRequestId(RequestIdT&& value) {
