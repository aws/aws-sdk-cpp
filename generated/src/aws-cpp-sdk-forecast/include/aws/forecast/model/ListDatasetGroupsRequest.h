...
class ListDatasetGroupsRequest : public ForecastServiceRequest {
 public:
  AWS_FORECASTSERVICE_API ListDatasetGroupsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListDatasetGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDatasetGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
