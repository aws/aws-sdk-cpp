...
class ExplainabilityConfig {
 public:
  ...
  inline void SetTimeSeriesGranularity(TimeSeriesGranularity value) {
    m_timeSeriesGranularityHasBeenSet = true;
    m_timeSeriesGranularity = value;
  }
  inline ExplainabilityConfig& WithTimeSeriesGranularity(TimeSeriesGranularity value) {
    SetTimeSeriesGranularity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTimePointGranularity(TimePointGranularity value) {
    m_timePointGranularityHasBeenSet = true;
    m_timePointGranularity = value;
  }
  inline ExplainabilityConfig& WithTimePointGranularity(TimePointGranularity value) {
    SetTimePointGranularity(value);
    return *this;
  }
  ///@}
 private:
