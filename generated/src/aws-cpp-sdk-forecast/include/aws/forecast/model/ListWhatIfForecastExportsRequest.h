...
class ListWhatIfForecastExportsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatIfForecastExportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWhatIfForecastExportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListWhatIfForecastExportsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListWhatIfForecastExportsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
