...
class ListExplainabilityExportsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListExplainabilityExportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListExplainabilityExportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListExplainabilityExportsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListExplainabilityExportsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
