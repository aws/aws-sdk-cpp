...
namespace Model
{
  ...
  {
  public:
    AWS_FORECASTSERVICE_API ListExplainabilityExportsRequest();
     ...
     * request. Tokens expire after 24 hours.</p>
     */
    inline ListExplainabilityExportsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
     ...
     * request. Tokens expire after 24 hours.</p>
     */
    inline ListExplainabilityExportsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
     ...
     * request. Tokens expire after 24 hours.</p>
     */
    inline ListExplainabilityExportsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
