...
class ListMonitorEvaluationsRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitorEvaluationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMonitorEvaluationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename MonitorArnT = Aws::String>
  ListMonitorEvaluationsRequest& WithMonitorArn(MonitorArnT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListMonitorEvaluationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListMonitorEvaluationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
