...
namespace Model
{
  ...
  {
  public:
    AWS_FORECASTSERVICE_API ListMonitorEvaluationsRequest();
    ...
    inline ListMonitorEvaluationsRequest& WithNextToken(const Aws::String& value) { SetNextToken(value); return *this;}
    inline ListMonitorEvaluationsRequest& WithNextToken(Aws::String&& value) { SetNextToken(std::move(value)); return *this;}
    inline ListMonitorEvaluationsRequest& WithNextToken(const char* value) { SetNextToken(value); return *this;}
    ///@}
    ...
    inline ListMonitorEvaluationsRequest& WithMonitorArn(const Aws::String& value) { SetMonitorArn(value); return *this;}
    inline ListMonitorEvaluationsRequest& WithMonitorArn(Aws::String&& value) { SetMonitorArn(std::move(value)); return *this;}
    inline ListMonitorEvaluationsRequest& WithMonitorArn(const char* value) { SetMonitorArn(value); return *this;}
    ///@}
    ...
    inline ListMonitorEvaluationsRequest& WithFilters(const Aws::Vector<Filter>& value) { SetFilters(value); return *this;}
    inline ListMonitorEvaluationsRequest& WithFilters(Aws::Vector<Filter>&& value) { SetFilters(std::move(value)); return *this;}
    inline ListMonitorEvaluationsRequest& AddFilters(const Filter& value) { m_filtersHasBeenSet = true; m_filters.push_back(value); return *this; }
    inline ListMonitorEvaluationsRequest& AddFilters(Filter&& value) { m_filtersHasBeenSet = true; m_filters.push_back(std::move(value)); return *this; }
    ///@}
  private:
