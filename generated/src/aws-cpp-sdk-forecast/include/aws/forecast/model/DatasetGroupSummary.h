...
class DatasetGroupSummary {
 public:
  ...
  void SetDatasetGroupName(DatasetGroupNameT&& value) {
    ...
    m_datasetGroupName = std::forward<DatasetGroupNameT>(value);
  }
  template <typename DatasetGroupNameT = Aws::String>
  DatasetGroupSummary& WithDatasetGroupName(DatasetGroupNameT&& value) {
    SetDatasetGroupName(std::forward<DatasetGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DatasetGroupSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModificationTimeT = Aws::Utils::DateTime>
  DatasetGroupSummary& WithLastModificationTime(LastModificationTimeT&& value) {
