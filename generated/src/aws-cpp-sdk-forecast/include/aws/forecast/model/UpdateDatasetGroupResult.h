...
namespace Model
{
  ...
  public:
    ...
    inline UpdateDatasetGroupResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateDatasetGroupResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateDatasetGroupResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
