...
class TimeSeriesTransformation {
 public:
  ...
  template <typename ActionT = Action>
  TimeSeriesTransformation& WithAction(ActionT&& value) {
  ...
  void SetTimeSeriesConditions(TimeSeriesConditionsT&& value) {
    m_timeSeriesConditionsHasBeenSet = true;
    m_timeSeriesConditions = std::forward<TimeSeriesConditionsT>(value);
  }
  template <typename TimeSeriesConditionsT = Aws::Vector<TimeSeriesCondition>>
  TimeSeriesTransformation& WithTimeSeriesConditions(TimeSeriesConditionsT&& value) {
    SetTimeSeriesConditions(std::forward<TimeSeriesConditionsT>(value));
    return *this;
  }
  template <typename TimeSeriesConditionsT = TimeSeriesCondition>
  TimeSeriesTransformation& AddTimeSeriesConditions(TimeSeriesConditionsT&& value) {
    m_timeSeriesConditionsHasBeenSet = true;
    m_timeSeriesConditions.emplace_back(std::forward<TimeSeriesConditionsT>(value));
    return *this;
  }
  ///@}
 private:
