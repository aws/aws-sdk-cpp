...
class CreateWhatIfForecastRequest : public ForecastServiceRequest {
 public:
  ...
  template <typename WhatIfForecastNameT = Aws::String>
  CreateWhatIfForecastRequest& WithWhatIfForecastName(WhatIfForecastNameT&& value) {
  ...
  template <typename WhatIfAnalysisArnT = Aws::String>
  CreateWhatIfForecastRequest& WithWhatIfAnalysisArn(WhatIfAnalysisArnT&& value) {
  ...
  template <typename TimeSeriesTransformationsT = Aws::Vector<TimeSeriesTransformation>>
  CreateWhatIfForecastRequest& WithTimeSeriesTransformations(TimeSeriesTransformationsT&& value) {
  ...
  CreateWhatIfForecastRequest& AddTimeSeriesTransformations(TimeSeriesTransformationsT&& value) {
    m_timeSeriesTransformationsHasBeenSet = true;
  ...
  template <typename TimeSeriesReplacementsDataSourceT = TimeSeriesReplacementsDataSource>
  CreateWhatIfForecastRequest& WithTimeSeriesReplacementsDataSource(TimeSeriesReplacementsDataSourceT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateWhatIfForecastRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateWhatIfForecastRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
