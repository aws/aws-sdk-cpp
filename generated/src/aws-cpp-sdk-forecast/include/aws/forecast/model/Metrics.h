...
class Metrics {
 public:
  ...
  void SetWeightedQuantileLosses(WeightedQuantileLossesT&& value) {
    m_weightedQuantileLossesHasBeenSet = true;
    m_weightedQuantileLosses = std::forward<WeightedQuantileLossesT>(value);
  }
  template <typename WeightedQuantileLossesT = Aws::Vector<WeightedQuantileLoss>>
  Metrics& WithWeightedQuantileLosses(WeightedQuantileLossesT&& value) {
    SetWeightedQuantileLosses(std::forward<WeightedQuantileLossesT>(value));
    return *this;
  }
  template <typename WeightedQuantileLossesT = WeightedQuantileLoss>
  Metrics& AddWeightedQuantileLosses(WeightedQuantileLossesT&& value) {
    m_weightedQuantileLossesHasBeenSet = true;
    m_weightedQuantileLosses.emplace_back(std::forward<WeightedQuantileLossesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetErrorMetrics(ErrorMetricsT&& value) {
    ...
    m_errorMetrics = std::forward<ErrorMetricsT>(value);
  }
  template <typename ErrorMetricsT = Aws::Vector<ErrorMetric>>
  Metrics& WithErrorMetrics(ErrorMetricsT&& value) {
    SetErrorMetrics(std::forward<ErrorMetricsT>(value));
    return *this;
  }
  template <typename ErrorMetricsT = ErrorMetric>
  Metrics& AddErrorMetrics(ErrorMetricsT&& value) {
    m_errorMetricsHasBeenSet = true;
    m_errorMetrics.emplace_back(std::forward<ErrorMetricsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAverageWeightedQuantileLoss(double value) {
    m_averageWeightedQuantileLossHasBeenSet = true;
    m_averageWeightedQuantileLoss = value;
  }
  inline Metrics& WithAverageWeightedQuantileLoss(double value) {
    SetAverageWeightedQuantileLoss(value);
    return *this;
  }
  ///@}
 private:
