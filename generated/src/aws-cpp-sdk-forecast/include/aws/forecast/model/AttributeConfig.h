...
class AttributeConfig {
 public:
  ...
  template <typename AttributeNameT = Aws::String>
  AttributeConfig& WithAttributeName(AttributeNameT&& value) {
  ...
  template <typename TransformationsT = Aws::Map<Aws::String, Aws::String>>
  AttributeConfig& WithTransformations(TransformationsT&& value) {
  ...
  AttributeConfig& AddTransformations(TransformationsKeyT&& key, TransformationsValueT&& value) {
    m_transformationsHasBeenSet = true;
    m_transformations.emplace(std::forward<TransformationsKeyT>(key), std::forward<TransformationsValueT>(value));
    return *this;
  }
  ///@}
 private:
