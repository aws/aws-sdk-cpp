...
class EvaluationResult {
 public:
  ...
  template <typename AlgorithmArnT = Aws::String>
  EvaluationResult& WithAlgorithmArn(AlgorithmArnT&& value) {
  ...
  void SetTestWindows(TestWindowsT&& value) {
    m_testWindowsHasBeenSet = true;
    m_testWindows = std::forward<TestWindowsT>(value);
  }
  template <typename TestWindowsT = Aws::Vector<WindowSummary>>
  EvaluationResult& WithTestWindows(TestWindowsT&& value) {
    SetTestWindows(std::forward<TestWindowsT>(value));
    return *this;
  }
  template <typename TestWindowsT = WindowSummary>
  EvaluationResult& AddTestWindows(TestWindowsT&& value) {
    m_testWindowsHasBeenSet = true;
    m_testWindows.emplace_back(std::forward<TestWindowsT>(value));
    return *this;
  }
  ///@}
 private:
