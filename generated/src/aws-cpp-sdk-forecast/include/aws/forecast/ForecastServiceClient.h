...
namespace ForecastService
{
   ...
   */
  class AWS_FORECASTSERVICE_API ForecastServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<ForecastServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::ForecastService::SERVICE_NAME,
