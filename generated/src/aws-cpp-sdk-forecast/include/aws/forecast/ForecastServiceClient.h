...
class AWS_FORECASTSERVICE_API ForecastServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ForecastServiceClient(const Aws::ForecastService::ForecastServiceClientConfiguration& clientConfiguration =
  ...
  ForecastServiceClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<ForecastServiceEndpointProviderBase> endpointProvider = nullptr,
                        const Aws::ForecastService::ForecastServiceClientConfiguration& clientConfiguration =
                            Aws::ForecastService::ForecastServiceClientConfiguration());
  ...
  /**
   * A Callable wrapper for CreateAutoPredictor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAutoPredictor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAutoPredictorRequestT = Model::CreateAutoPredictorRequest>
  void CreateAutoPredictorAsync(const CreateAutoPredictorRequestT& request, const CreateAutoPredictorResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for CreateDatasetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDatasetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDatasetGroupRequestT = Model::CreateDatasetGroupRequest>
  void CreateDatasetGroupAsync(const CreateDatasetGroupRequestT& request, const CreateDatasetGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateDatasetImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDatasetImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateDatasetImportJobRequestT = Model::CreateDatasetImportJobRequest>
  void CreateDatasetImportJobAsync(const CreateDatasetImportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateExplainability that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateExplainability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateExplainabilityRequestT = Model::CreateExplainabilityRequest>
  void CreateExplainabilityAsync(const CreateExplainabilityRequestT& request, const CreateExplainabilityResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateExplainabilityExportOutcome CreateExplainabilityExport(
      const Model::CreateExplainabilityExportRequest& request) const;

  /**
   * A Callable wrapper for CreateExplainabilityExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateExplainabilityExportRequestT = Model::CreateExplainabilityExportRequest>
  Model::CreateExplainabilityExportOutcomeCallable CreateExplainabilityExportCallable(
      const CreateExplainabilityExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::CreateExplainabilityExport, request);
  }

  /**
   * An Async wrapper for CreateExplainabilityExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateExplainabilityExportRequestT = Model::CreateExplainabilityExportRequest>
  void CreateExplainabilityExportAsync(const CreateExplainabilityExportRequestT& request,
                                       const CreateExplainabilityExportResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateForecast that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateForecastRequestT = Model::CreateForecastRequest>
  void CreateForecastAsync(const CreateForecastRequestT& request, const CreateForecastResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateForecastExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateForecastExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateForecastExportJobRequestT = Model::CreateForecastExportJobRequest>
  void CreateForecastExportJobAsync(const CreateForecastExportJobRequestT& request,
  ...
  /**
   * An Async wrapper for CreateMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateMonitorRequestT = Model::CreateMonitorRequest>
  void CreateMonitorAsync(const CreateMonitorRequestT& request, const CreateMonitorResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreatePredictor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreatePredictorRequestT = Model::CreatePredictorRequest>
  void CreatePredictorAsync(const CreatePredictorRequestT& request, const CreatePredictorResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePredictorBacktestExportJobOutcome CreatePredictorBacktestExportJob(
      const Model::CreatePredictorBacktestExportJobRequest& request) const;

  /**
   * A Callable wrapper for CreatePredictorBacktestExportJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreatePredictorBacktestExportJobRequestT = Model::CreatePredictorBacktestExportJobRequest>
  Model::CreatePredictorBacktestExportJobOutcomeCallable CreatePredictorBacktestExportJobCallable(
      const CreatePredictorBacktestExportJobRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::CreatePredictorBacktestExportJob, request);
  }

  /**
   * An Async wrapper for CreatePredictorBacktestExportJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePredictorBacktestExportJobRequestT = Model::CreatePredictorBacktestExportJobRequest>
  void CreatePredictorBacktestExportJobAsync(const CreatePredictorBacktestExportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateWhatIfAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWhatIfAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWhatIfAnalysisRequestT = Model::CreateWhatIfAnalysisRequest>
  void CreateWhatIfAnalysisAsync(const CreateWhatIfAnalysisRequestT& request, const CreateWhatIfAnalysisResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateWhatIfForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWhatIfForecast that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWhatIfForecastRequestT = Model::CreateWhatIfForecastRequest>
  void CreateWhatIfForecastAsync(const CreateWhatIfForecastRequestT& request, const CreateWhatIfForecastResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateWhatIfForecastExportOutcome CreateWhatIfForecastExport(
      const Model::CreateWhatIfForecastExportRequest& request) const;

  /**
   * A Callable wrapper for CreateWhatIfForecastExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateWhatIfForecastExportRequestT = Model::CreateWhatIfForecastExportRequest>
  Model::CreateWhatIfForecastExportOutcomeCallable CreateWhatIfForecastExportCallable(
      const CreateWhatIfForecastExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::CreateWhatIfForecastExport, request);
  }

  /**
   * An Async wrapper for CreateWhatIfForecastExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateWhatIfForecastExportRequestT = Model::CreateWhatIfForecastExportRequest>
  void CreateWhatIfForecastExportAsync(const CreateWhatIfForecastExportRequestT& request,
                                       const CreateWhatIfForecastExportResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDatasetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDatasetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDatasetGroupRequestT = Model::DeleteDatasetGroupRequest>
  void DeleteDatasetGroupAsync(const DeleteDatasetGroupRequestT& request, const DeleteDatasetGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteDatasetImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDatasetImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDatasetImportJobRequestT = Model::DeleteDatasetImportJobRequest>
  void DeleteDatasetImportJobAsync(const DeleteDatasetImportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteExplainability that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExplainability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteExplainabilityRequestT = Model::DeleteExplainabilityRequest>
  void DeleteExplainabilityAsync(const DeleteExplainabilityRequestT& request, const DeleteExplainabilityResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteExplainabilityExportOutcome DeleteExplainabilityExport(
      const Model::DeleteExplainabilityExportRequest& request) const;

  /**
   * A Callable wrapper for DeleteExplainabilityExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteExplainabilityExportRequestT = Model::DeleteExplainabilityExportRequest>
  Model::DeleteExplainabilityExportOutcomeCallable DeleteExplainabilityExportCallable(
      const DeleteExplainabilityExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DeleteExplainabilityExport, request);
  }

  /**
   * An Async wrapper for DeleteExplainabilityExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteExplainabilityExportRequestT = Model::DeleteExplainabilityExportRequest>
  void DeleteExplainabilityExportAsync(const DeleteExplainabilityExportRequestT& request,
                                       const DeleteExplainabilityExportResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteForecast that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteForecastRequestT = Model::DeleteForecastRequest>
  void DeleteForecastAsync(const DeleteForecastRequestT& request, const DeleteForecastResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteForecastExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteForecastExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteForecastExportJobRequestT = Model::DeleteForecastExportJobRequest>
  void DeleteForecastExportJobAsync(const DeleteForecastExportJobRequestT& request,
  ...
  /**
   * An Async wrapper for DeleteMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteMonitorRequestT = Model::DeleteMonitorRequest>
  void DeleteMonitorAsync(const DeleteMonitorRequestT& request, const DeleteMonitorResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeletePredictor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePredictorRequestT = Model::DeletePredictorRequest>
  void DeletePredictorAsync(const DeletePredictorRequestT& request, const DeletePredictorResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeletePredictorBacktestExportJobOutcome DeletePredictorBacktestExportJob(
      const Model::DeletePredictorBacktestExportJobRequest& request) const;

  /**
   * A Callable wrapper for DeletePredictorBacktestExportJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeletePredictorBacktestExportJobRequestT = Model::DeletePredictorBacktestExportJobRequest>
  Model::DeletePredictorBacktestExportJobOutcomeCallable DeletePredictorBacktestExportJobCallable(
      const DeletePredictorBacktestExportJobRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DeletePredictorBacktestExportJob, request);
  }

  /**
   * An Async wrapper for DeletePredictorBacktestExportJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeletePredictorBacktestExportJobRequestT = Model::DeletePredictorBacktestExportJobRequest>
  void DeletePredictorBacktestExportJobAsync(const DeletePredictorBacktestExportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteResourceTree that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteResourceTree that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteResourceTreeRequestT = Model::DeleteResourceTreeRequest>
  void DeleteResourceTreeAsync(const DeleteResourceTreeRequestT& request, const DeleteResourceTreeResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWhatIfAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWhatIfAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWhatIfAnalysisRequestT = Model::DeleteWhatIfAnalysisRequest>
  void DeleteWhatIfAnalysisAsync(const DeleteWhatIfAnalysisRequestT& request, const DeleteWhatIfAnalysisResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteWhatIfForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWhatIfForecast that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWhatIfForecastRequestT = Model::DeleteWhatIfForecastRequest>
  void DeleteWhatIfForecastAsync(const DeleteWhatIfForecastRequestT& request, const DeleteWhatIfForecastResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteWhatIfForecastExportOutcome DeleteWhatIfForecastExport(
      const Model::DeleteWhatIfForecastExportRequest& request) const;

  /**
   * A Callable wrapper for DeleteWhatIfForecastExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteWhatIfForecastExportRequestT = Model::DeleteWhatIfForecastExportRequest>
  Model::DeleteWhatIfForecastExportOutcomeCallable DeleteWhatIfForecastExportCallable(
      const DeleteWhatIfForecastExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DeleteWhatIfForecastExport, request);
  }

  /**
   * An Async wrapper for DeleteWhatIfForecastExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteWhatIfForecastExportRequestT = Model::DeleteWhatIfForecastExportRequest>
  void DeleteWhatIfForecastExportAsync(const DeleteWhatIfForecastExportRequestT& request,
                                       const DeleteWhatIfForecastExportResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAutoPredictor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAutoPredictor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAutoPredictorRequestT = Model::DescribeAutoPredictorRequest>
  void DescribeAutoPredictorAsync(const DescribeAutoPredictorRequestT& request, const DescribeAutoPredictorResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDatasetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDatasetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDatasetGroupRequestT = Model::DescribeDatasetGroupRequest>
  void DescribeDatasetGroupAsync(const DescribeDatasetGroupRequestT& request, const DescribeDatasetGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDatasetImportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDatasetImportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDatasetImportJobRequestT = Model::DescribeDatasetImportJobRequest>
  void DescribeDatasetImportJobAsync(const DescribeDatasetImportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeExplainability that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeExplainability that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeExplainabilityRequestT = Model::DescribeExplainabilityRequest>
  void DescribeExplainabilityAsync(const DescribeExplainabilityRequestT& request,
                                   const DescribeExplainabilityResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeExplainabilityExportOutcome DescribeExplainabilityExport(
      const Model::DescribeExplainabilityExportRequest& request) const;

  /**
   * A Callable wrapper for DescribeExplainabilityExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeExplainabilityExportRequestT = Model::DescribeExplainabilityExportRequest>
  Model::DescribeExplainabilityExportOutcomeCallable DescribeExplainabilityExportCallable(
      const DescribeExplainabilityExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DescribeExplainabilityExport, request);
  }

  /**
   * An Async wrapper for DescribeExplainabilityExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeExplainabilityExportRequestT = Model::DescribeExplainabilityExportRequest>
  void DescribeExplainabilityExportAsync(const DescribeExplainabilityExportRequestT& request,
                                         const DescribeExplainabilityExportResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeForecast that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeForecastRequestT = Model::DescribeForecastRequest>
  void DescribeForecastAsync(const DescribeForecastRequestT& request, const DescribeForecastResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeForecastExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeForecastExportJobRequestT = Model::DescribeForecastExportJobRequest>
  Model::DescribeForecastExportJobOutcomeCallable DescribeForecastExportJobCallable(
      const DescribeForecastExportJobRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DescribeForecastExportJob, request);
  }

  /**
   * An Async wrapper for DescribeForecastExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeForecastExportJobRequestT = Model::DescribeForecastExportJobRequest>
  void DescribeForecastExportJobAsync(const DescribeForecastExportJobRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeMonitorRequestT = Model::DescribeMonitorRequest>
  void DescribeMonitorAsync(const DescribeMonitorRequestT& request, const DescribeMonitorResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePredictor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePredictor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePredictorRequestT = Model::DescribePredictorRequest>
  void DescribePredictorAsync(const DescribePredictorRequestT& request, const DescribePredictorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePredictorBacktestExportJobOutcome DescribePredictorBacktestExportJob(
      const Model::DescribePredictorBacktestExportJobRequest& request) const;

  /**
   * A Callable wrapper for DescribePredictorBacktestExportJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribePredictorBacktestExportJobRequestT = Model::DescribePredictorBacktestExportJobRequest>
  Model::DescribePredictorBacktestExportJobOutcomeCallable DescribePredictorBacktestExportJobCallable(
      const DescribePredictorBacktestExportJobRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DescribePredictorBacktestExportJob, request);
  }

  /**
   * An Async wrapper for DescribePredictorBacktestExportJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribePredictorBacktestExportJobRequestT = Model::DescribePredictorBacktestExportJobRequest>
  void DescribePredictorBacktestExportJobAsync(const DescribePredictorBacktestExportJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeWhatIfAnalysis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWhatIfAnalysis that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWhatIfAnalysisRequestT = Model::DescribeWhatIfAnalysisRequest>
  void DescribeWhatIfAnalysisAsync(const DescribeWhatIfAnalysisRequestT& request,
                                   const DescribeWhatIfAnalysisResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWhatIfForecast that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWhatIfForecast that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWhatIfForecastRequestT = Model::DescribeWhatIfForecastRequest>
  void DescribeWhatIfForecastAsync(const DescribeWhatIfForecastRequestT& request,
                                   const DescribeWhatIfForecastResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeWhatIfForecastExportOutcome DescribeWhatIfForecastExport(
      const Model::DescribeWhatIfForecastExportRequest& request) const;

  /**
   * A Callable wrapper for DescribeWhatIfForecastExport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeWhatIfForecastExportRequestT = Model::DescribeWhatIfForecastExportRequest>
  Model::DescribeWhatIfForecastExportOutcomeCallable DescribeWhatIfForecastExportCallable(
      const DescribeWhatIfForecastExportRequestT& request) const {
    return SubmitCallable(&ForecastServiceClient::DescribeWhatIfForecastExport, request);
  }

  /**
   * An Async wrapper for DescribeWhatIfForecastExport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeWhatIfForecastExportRequestT = Model::DescribeWhatIfForecastExportRequest>
  void DescribeWhatIfForecastExportAsync(const DescribeWhatIfForecastExportRequestT& request,
                                         const DescribeWhatIfForecastExportResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAccuracyMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccuracyMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAccuracyMetricsRequestT = Model::GetAccuracyMetricsRequest>
  void GetAccuracyMetricsAsync(const GetAccuracyMetricsRequestT& request, const GetAccuracyMetricsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListDatasetGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDatasetGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDatasetGroupsRequestT = Model::ListDatasetGroupsRequest>
  void ListDatasetGroupsAsync(const ListDatasetGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListDatasetGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDatasetImportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDatasetImportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDatasetImportJobsRequestT = Model::ListDatasetImportJobsRequest>
  void ListDatasetImportJobsAsync(const ListDatasetImportJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListDatasetImportJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListExplainabilities that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListExplainabilities that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListExplainabilitiesRequestT = Model::ListExplainabilitiesRequest>
  void ListExplainabilitiesAsync(const ListExplainabilitiesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListExplainabilitiesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListExplainabilityExportsOutcome ListExplainabilityExports(
      const Model::ListExplainabilityExportsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListExplainabilityExports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListExplainabilityExportsRequestT = Model::ListExplainabilityExportsRequest>
  Model::ListExplainabilityExportsOutcomeCallable ListExplainabilityExportsCallable(
      const ListExplainabilityExportsRequestT& request = {}) const {
    return SubmitCallable(&ForecastServiceClient::ListExplainabilityExports, request);
  }

  /**
   * An Async wrapper for ListExplainabilityExports that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListExplainabilityExportsRequestT = Model::ListExplainabilityExportsRequest>
  void ListExplainabilityExportsAsync(const ListExplainabilityExportsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListExplainabilityExportsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListForecastExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListForecastExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListForecastExportJobsRequestT = Model::ListForecastExportJobsRequest>
  void ListForecastExportJobsAsync(const ListForecastExportJobsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListForecastExportJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListForecasts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListForecastsRequestT = Model::ListForecastsRequest>
  void ListForecastsAsync(const ListForecastsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListForecastsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMonitorEvaluations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMonitorEvaluations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitorEvaluationsRequestT = Model::ListMonitorEvaluationsRequest>
  void ListMonitorEvaluationsAsync(const ListMonitorEvaluationsRequestT& request,
                                   const ListMonitorEvaluationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListMonitors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListMonitorsRequestT = Model::ListMonitorsRequest>
  void ListMonitorsAsync(const ListMonitorsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListMonitorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPredictorBacktestExportJobsOutcome ListPredictorBacktestExportJobs(
      const Model::ListPredictorBacktestExportJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPredictorBacktestExportJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPredictorBacktestExportJobsRequestT = Model::ListPredictorBacktestExportJobsRequest>
  Model::ListPredictorBacktestExportJobsOutcomeCallable ListPredictorBacktestExportJobsCallable(
      const ListPredictorBacktestExportJobsRequestT& request = {}) const {
    return SubmitCallable(&ForecastServiceClient::ListPredictorBacktestExportJobs, request);
  }

  /**
   * An Async wrapper for ListPredictorBacktestExportJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPredictorBacktestExportJobsRequestT = Model::ListPredictorBacktestExportJobsRequest>
  void ListPredictorBacktestExportJobsAsync(const ListPredictorBacktestExportJobsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const ListPredictorBacktestExportJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListPredictors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPredictorsRequestT = Model::ListPredictorsRequest>
  void ListPredictorsAsync(const ListPredictorsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListPredictorsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWhatIfAnalyses that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWhatIfAnalyses that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWhatIfAnalysesRequestT = Model::ListWhatIfAnalysesRequest>
  void ListWhatIfAnalysesAsync(const ListWhatIfAnalysesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListWhatIfAnalysesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWhatIfForecastExportsOutcome ListWhatIfForecastExports(
      const Model::ListWhatIfForecastExportsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListWhatIfForecastExports that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListWhatIfForecastExportsRequestT = Model::ListWhatIfForecastExportsRequest>
  Model::ListWhatIfForecastExportsOutcomeCallable ListWhatIfForecastExportsCallable(
      const ListWhatIfForecastExportsRequestT& request = {}) const {
    return SubmitCallable(&ForecastServiceClient::ListWhatIfForecastExports, request);
  }

  /**
   * An Async wrapper for ListWhatIfForecastExports that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListWhatIfForecastExportsRequestT = Model::ListWhatIfForecastExportsRequest>
  void ListWhatIfForecastExportsAsync(const ListWhatIfForecastExportsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListWhatIfForecastExportsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWhatIfForecasts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWhatIfForecasts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWhatIfForecastsRequestT = Model::ListWhatIfForecastsRequest>
  void ListWhatIfForecastsAsync(const ListWhatIfForecastsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListWhatIfForecastsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ResumeResource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeResourceRequestT = Model::ResumeResourceRequest>
  void ResumeResourceAsync(const ResumeResourceRequestT& request, const ResumeResourceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopResource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopResourceRequestT = Model::StopResourceRequest>
  void StopResourceAsync(const StopResourceRequestT& request, const StopResourceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDatasetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDatasetGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDatasetGroupRequestT = Model::UpdateDatasetGroupRequest>
  void UpdateDatasetGroupAsync(const UpdateDatasetGroupRequestT& request, const UpdateDatasetGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
