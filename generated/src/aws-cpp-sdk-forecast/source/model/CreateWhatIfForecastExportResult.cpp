...
CreateWhatIfForecastExportResult::CreateWhatIfForecastExportResult()
{
}

CreateWhatIfForecastExportResult::CreateWhatIfForecastExportResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
