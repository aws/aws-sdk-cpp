...
ListPredictorBacktestExportJobsResult& ListPredictorBacktestExportJobsResult::operator=(
  ...
  if (jsonValue.ValueExists("PredictorBacktestExportJobs")) {
    ...
    for (unsigned predictorBacktestExportJobsIndex = 0; predictorBacktestExportJobsIndex < predictorBacktestExportJobsJsonList.GetLength();
         ++predictorBacktestExportJobsIndex) {
