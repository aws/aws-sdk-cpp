...
WhatIfForecastExportSummary::WhatIfForecastExportSummary(JsonView jsonValue) { *this = jsonValue; }
...
WhatIfForecastExportSummary& WhatIfForecastExportSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("WhatIfForecastArns")) {
    ...
    for (unsigned whatIfForecastArnsIndex = 0; whatIfForecastArnsIndex < whatIfForecastArnsJsonList.GetLength();
         ++whatIfForecastArnsIndex) {
