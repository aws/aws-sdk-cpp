...
TimeSeriesTransformation::TimeSeriesTransformation(JsonView jsonValue) { *this = jsonValue; }
...
TimeSeriesTransformation& TimeSeriesTransformation::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TimeSeriesConditions")) {
    ...
    for (unsigned timeSeriesConditionsIndex = 0; timeSeriesConditionsIndex < timeSeriesConditionsJsonList.GetLength();
         ++timeSeriesConditionsIndex) {
