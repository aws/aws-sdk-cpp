...
Aws::String CreateWhatIfForecastRequest::SerializePayload() const {
  ...
  if (m_timeSeriesTransformationsHasBeenSet) {
    ...
    for (unsigned timeSeriesTransformationsIndex = 0; timeSeriesTransformationsIndex < timeSeriesTransformationsJsonList.GetLength();
         ++timeSeriesTransformationsIndex) {
      timeSeriesTransformationsJsonList[timeSeriesTransformationsIndex].AsObject(
          m_timeSeriesTransformations[timeSeriesTransformationsIndex].Jsonize());
    }
