...
{
const size_t ForecastServiceEndpointRules::RulesBlobStrLen = 3400;
const size_t ForecastServiceEndpointRules::RulesBlobSize = 3401;
...
't','t','p','s',':','/','/','f','o','r','e','c','a','s','t','-','f','i','p','s','.','{','R','e','g',
