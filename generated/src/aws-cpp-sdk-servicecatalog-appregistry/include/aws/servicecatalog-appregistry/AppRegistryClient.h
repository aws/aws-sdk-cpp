...
namespace AppRegistry
{
   ...
   */
  class AWS_APPREGISTRY_API AppRegistryClient : Aws::Client::ClientWithAsyncTemplateMethods<AppRegistryClient>,
    smithy::client::AwsSmithyClientT<Aws::AppRegistry::SERVICE_NAME,
