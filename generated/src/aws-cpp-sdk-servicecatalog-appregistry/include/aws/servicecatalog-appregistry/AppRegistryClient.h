...
class AWS_APPREGISTRY_API AppRegistryClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  AppRegistryClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<AppRegistryEndpointProviderBase> endpointProvider = nullptr,
      const Aws::AppRegistry::AppRegistryClientConfiguration& clientConfiguration = Aws::AppRegistry::AppRegistryClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociateAttributeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateAttributeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateAttributeGroupRequestT = Model::AssociateAttributeGroupRequest>
  void AssociateAttributeGroupAsync(const AssociateAttributeGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateAttributeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAttributeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAttributeGroupRequestT = Model::CreateAttributeGroupRequest>
  void CreateAttributeGroupAsync(const CreateAttributeGroupRequestT& request, const CreateAttributeGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAttributeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAttributeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAttributeGroupRequestT = Model::DeleteAttributeGroupRequest>
  void DeleteAttributeGroupAsync(const DeleteAttributeGroupRequestT& request, const DeleteAttributeGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateAttributeGroupOutcome DisassociateAttributeGroup(
      const Model::DisassociateAttributeGroupRequest& request) const;

  /**
   * A Callable wrapper for DisassociateAttributeGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateAttributeGroupRequestT = Model::DisassociateAttributeGroupRequest>
  Model::DisassociateAttributeGroupOutcomeCallable DisassociateAttributeGroupCallable(
      const DisassociateAttributeGroupRequestT& request) const {
    return SubmitCallable(&AppRegistryClient::DisassociateAttributeGroup, request);
  }

  /**
   * An Async wrapper for DisassociateAttributeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateAttributeGroupRequestT = Model::DisassociateAttributeGroupRequest>
  void DisassociateAttributeGroupAsync(const DisassociateAttributeGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAssociatedResource that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAssociatedResource that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAssociatedResourceRequestT = Model::GetAssociatedResourceRequest>
  void GetAssociatedResourceAsync(const GetAssociatedResourceRequestT& request, const GetAssociatedResourceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAttributeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAttributeGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAttributeGroupRequestT = Model::GetAttributeGroupRequest>
  void GetAttributeGroupAsync(const GetAttributeGroupRequestT& request, const GetAttributeGroupResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAssociatedAttributeGroupsOutcome ListAssociatedAttributeGroups(
      const Model::ListAssociatedAttributeGroupsRequest& request) const;

  /**
   * A Callable wrapper for ListAssociatedAttributeGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAssociatedAttributeGroupsRequestT = Model::ListAssociatedAttributeGroupsRequest>
  Model::ListAssociatedAttributeGroupsOutcomeCallable ListAssociatedAttributeGroupsCallable(
      const ListAssociatedAttributeGroupsRequestT& request) const {
    return SubmitCallable(&AppRegistryClient::ListAssociatedAttributeGroups, request);
  }

  /**
   * An Async wrapper for ListAssociatedAttributeGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedAttributeGroupsRequestT = Model::ListAssociatedAttributeGroupsRequest>
  void ListAssociatedAttributeGroupsAsync(const ListAssociatedAttributeGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAssociatedResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssociatedResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedResourcesRequestT = Model::ListAssociatedResourcesRequest>
  void ListAssociatedResourcesAsync(const ListAssociatedResourcesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListAttributeGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAttributeGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAttributeGroupsRequestT = Model::ListAttributeGroupsRequest>
  void ListAttributeGroupsAsync(const ListAttributeGroupsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListAttributeGroupsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAttributeGroupsForApplicationOutcome ListAttributeGroupsForApplication(
      const Model::ListAttributeGroupsForApplicationRequest& request) const;

  /**
   * A Callable wrapper for ListAttributeGroupsForApplication that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListAttributeGroupsForApplicationRequestT = Model::ListAttributeGroupsForApplicationRequest>
  Model::ListAttributeGroupsForApplicationOutcomeCallable ListAttributeGroupsForApplicationCallable(
      const ListAttributeGroupsForApplicationRequestT& request) const {
    return SubmitCallable(&AppRegistryClient::ListAttributeGroupsForApplication, request);
  }

  /**
   * An Async wrapper for ListAttributeGroupsForApplication that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAttributeGroupsForApplicationRequestT = Model::ListAttributeGroupsForApplicationRequest>
  void ListAttributeGroupsForApplicationAsync(const ListAttributeGroupsForApplicationRequestT& request,
                                              const ListAttributeGroupsForApplicationResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutConfiguration that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename PutConfigurationRequestT = Model::PutConfigurationRequest>
  void PutConfigurationAsync(const PutConfigurationRequestT& request, const PutConfigurationResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SyncResource that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SyncResourceRequestT = Model::SyncResourceRequest>
  void SyncResourceAsync(const SyncResourceRequestT& request, const SyncResourceResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAttributeGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAttributeGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAttributeGroupRequestT = Model::UpdateAttributeGroupRequest>
  void UpdateAttributeGroupAsync(const UpdateAttributeGroupRequestT& request, const UpdateAttributeGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&AppRegistryClient::UpdateAttributeGroup, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<AppRegistryEndpointProviderBase>& accessEndpointProvider();
