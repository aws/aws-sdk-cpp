...
class ListAssociatedResourcesRequest : public AppRegistryRequest {
 public:
  ...
  template <typename ApplicationT = Aws::String>
  ListAssociatedResourcesRequest& WithApplication(ApplicationT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedResourcesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssociatedResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
