...
class ListAttributeGroupsForApplicationRequest : public AppRegistryRequest {
 public:
  ...
  template <typename ApplicationT = Aws::String>
  ListAttributeGroupsForApplicationRequest& WithApplication(ApplicationT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAttributeGroupsForApplicationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAttributeGroupsForApplicationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
