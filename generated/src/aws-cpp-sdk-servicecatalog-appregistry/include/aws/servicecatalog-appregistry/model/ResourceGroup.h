...
class ResourceGroup {
 public:
  ...
  inline void SetState(ResourceGroupState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ResourceGroup& WithState(ResourceGroupState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  ResourceGroup& WithErrorMessage(ErrorMessageT&& value) {
