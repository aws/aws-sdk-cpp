...
class GetAssociatedResourceResult {
 public:
  ...
  template <typename ResourceT = Resource>
  GetAssociatedResourceResult& WithResource(ResourceT&& value) {
  ...
  template <typename OptionsT = Aws::Vector<AssociationOption>>
  GetAssociatedResourceResult& WithOptions(OptionsT&& value) {
    SetOptions(std::forward<OptionsT>(value));
    return *this;
  }
  inline GetAssociatedResourceResult& AddOptions(AssociationOption value) {
    m_optionsHasBeenSet = true;
  ...
  void SetApplicationTagResult(ApplicationTagResultT&& value) {
    m_applicationTagResultHasBeenSet = true;
    m_applicationTagResult = std::forward<ApplicationTagResultT>(value);
  }
  template <typename ApplicationTagResultT = ApplicationTagResult>
  GetAssociatedResourceResult& WithApplicationTagResult(ApplicationTagResultT&& value) {
    SetApplicationTagResult(std::forward<ApplicationTagResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAssociatedResourceResult& WithRequestId(RequestIdT&& value) {
