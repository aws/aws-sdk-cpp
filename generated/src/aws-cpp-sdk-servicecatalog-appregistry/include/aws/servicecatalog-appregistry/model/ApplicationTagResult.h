...
class ApplicationTagResult {
 public:
  ...
  inline void SetApplicationTagStatus(ApplicationTagStatus value) {
    m_applicationTagStatusHasBeenSet = true;
    m_applicationTagStatus = value;
  }
  inline ApplicationTagResult& WithApplicationTagStatus(ApplicationTagStatus value) {
    SetApplicationTagStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  ApplicationTagResult& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename ResourcesT = Aws::Vector<ResourcesListItem>>
  ApplicationTagResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ResourcesListItem>
  ApplicationTagResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ApplicationTagResult& WithNextToken(NextTokenT&& value) {
