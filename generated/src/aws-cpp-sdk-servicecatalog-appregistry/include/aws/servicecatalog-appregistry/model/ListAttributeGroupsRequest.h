...
class ListAttributeGroupsRequest : public AppRegistryRequest {
 public:
  AWS_APPREGISTRY_API ListAttributeGroupsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListAttributeGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAttributeGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
