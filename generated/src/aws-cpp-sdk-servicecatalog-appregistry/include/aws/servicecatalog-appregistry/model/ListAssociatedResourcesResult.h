...
class ListAssociatedResourcesResult {
 public:
  ...
  template <typename ResourcesT = Aws::Vector<ResourceInfo>>
  ListAssociatedResourcesResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = ResourceInfo>
  ListAssociatedResourcesResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssociatedResourcesResult& WithRequestId(RequestIdT&& value) {
