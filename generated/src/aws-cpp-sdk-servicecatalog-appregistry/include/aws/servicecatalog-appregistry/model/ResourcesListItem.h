...
class ResourcesListItem {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  ResourcesListItem& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  ResourcesListItem& WithErrorMessage(ErrorMessageT&& value) {
  ...
  template <typename StatusT = Aws::String>
  ResourcesListItem& WithStatus(StatusT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  ResourcesListItem& WithResourceType(ResourceTypeT&& value) {
