...
class DisassociateAttributeGroupResult {
 public:
  ...
  template <typename ApplicationArnT = Aws::String>
  DisassociateAttributeGroupResult& WithApplicationArn(ApplicationArnT&& value) {
  ...
  template <typename AttributeGroupArnT = Aws::String>
  DisassociateAttributeGroupResult& WithAttributeGroupArn(AttributeGroupArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateAttributeGroupResult& WithRequestId(RequestIdT&& value) {
