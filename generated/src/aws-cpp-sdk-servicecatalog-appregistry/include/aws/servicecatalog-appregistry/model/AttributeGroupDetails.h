...
class AttributeGroupDetails {
 public:
  ...
  template <typename IdT = Aws::String>
  AttributeGroupDetails& WithId(IdT&& value) {
  ...
  template <typename ArnT = Aws::String>
  AttributeGroupDetails& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  AttributeGroupDetails& WithName(NameT&& value) {
  ...
  template <typename CreatedByT = Aws::String>
  AttributeGroupDetails& WithCreatedBy(CreatedByT&& value) {
