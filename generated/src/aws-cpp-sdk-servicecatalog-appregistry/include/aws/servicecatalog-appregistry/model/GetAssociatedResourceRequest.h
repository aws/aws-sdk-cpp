...
class GetAssociatedResourceRequest : public AppRegistryRequest {
 public:
  ...
  inline GetAssociatedResourceRequest& WithResourceType(ResourceType value) {
  ...
  void SetResourceTagStatus(ResourceTagStatusT&& value) {
    m_resourceTagStatusHasBeenSet = true;
    m_resourceTagStatus = std::forward<ResourceTagStatusT>(value);
  }
  template <typename ResourceTagStatusT = Aws::Vector<ResourceItemStatus>>
  GetAssociatedResourceRequest& WithResourceTagStatus(ResourceTagStatusT&& value) {
    SetResourceTagStatus(std::forward<ResourceTagStatusT>(value));
    return *this;
  }
  inline GetAssociatedResourceRequest& AddResourceTagStatus(ResourceItemStatus value) {
    m_resourceTagStatusHasBeenSet = true;
    m_resourceTagStatus.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline GetAssociatedResourceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
