...
class Integrations {
 public:
  ...
  template <typename ResourceGroupT = ResourceGroup>
  Integrations& WithResourceGroup(ResourceGroupT&& value) {
  ...
  void SetApplicationTagResourceGroup(ApplicationTagResourceGroupT&& value) {
    m_applicationTagResourceGroupHasBeenSet = true;
    m_applicationTagResourceGroup = std::forward<ApplicationTagResourceGroupT>(value);
  }
  template <typename ApplicationTagResourceGroupT = ResourceGroup>
  Integrations& WithApplicationTagResourceGroup(ApplicationTagResourceGroupT&& value) {
    SetApplicationTagResourceGroup(std::forward<ApplicationTagResourceGroupT>(value));
    return *this;
  }
  ///@}
 private:
