...
class ListAssociatedAttributeGroupsRequest : public AppRegistryRequest {
 public:
  ...
  template <typename ApplicationT = Aws::String>
  ListAssociatedAttributeGroupsRequest& WithApplication(ApplicationT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAssociatedAttributeGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssociatedAttributeGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
