...
class AppRegistryConfiguration {
 public:
  ...
  void SetTagQueryConfiguration(TagQueryConfigurationT&& value) {
    m_tagQueryConfigurationHasBeenSet = true;
    m_tagQueryConfiguration = std::forward<TagQueryConfigurationT>(value);
  }
  template <typename TagQueryConfigurationT = TagQueryConfiguration>
  AppRegistryConfiguration& WithTagQueryConfiguration(TagQueryConfigurationT&& value) {
    SetTagQueryConfiguration(std::forward<TagQueryConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
