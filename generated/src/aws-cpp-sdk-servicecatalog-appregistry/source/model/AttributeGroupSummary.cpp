...
AttributeGroupSummary::AttributeGroupSummary(JsonView jsonValue) { *this = jsonValue; }

AttributeGroupSummary& AttributeGroupSummary::operator=(JsonView jsonValue) {
...
JsonValue AttributeGroupSummary::Jsonize() const {
  JsonValue payload;
