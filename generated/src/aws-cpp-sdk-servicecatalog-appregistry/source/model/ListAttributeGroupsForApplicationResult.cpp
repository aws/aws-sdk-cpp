...
ListAttributeGroupsForApplicationResult& ListAttributeGroupsForApplicationResult::operator=(
  ...
  if (jsonValue.ValueExists("attributeGroupsDetails")) {
    ...
    for (unsigned attributeGroupsDetailsIndex = 0; attributeGroupsDetailsIndex < attributeGroupsDetailsJsonList.GetLength();
         ++attributeGroupsDetailsIndex) {
