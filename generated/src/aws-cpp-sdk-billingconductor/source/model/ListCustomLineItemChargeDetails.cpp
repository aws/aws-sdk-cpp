...
ListCustomLineItemChargeDetails::ListCustomLineItemChargeDetails(JsonView jsonValue) { *this = jsonValue; }

ListCustomLineItemChargeDetails& ListCustomLineItemChargeDetails::operator=(JsonView jsonValue) {
...
JsonValue ListCustomLineItemChargeDetails::Jsonize() const {
  JsonValue payload;
