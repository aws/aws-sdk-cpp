...
static const int PRICING_PLAN_ATTACHED_TO_BILLING_GROUP_DELETE_CONFLICT_HASH =
    HashingUtils::HashString("PRICING_PLAN_ATTACHED_TO_BILLING_GROUP_DELETE_CONFLICT");
static const int PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT_HASH =
    HashingUtils::HashString("PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT");
static const int PRICING_RULE_ATTACHED_TO_PRICING_PLAN_DELETE_CONFLICT_HASH =
    HashingUtils::HashString("PRICING_RULE_ATTACHED_TO_PRICING_PLAN_DELETE_CONFLICT");
...
ConflictExceptionReason GetConflictExceptionReasonForName(const Aws::String& name) {
  ...
  } else if (hashCode == PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT_HASH) {
    return ConflictExceptionReason::PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT;
...
Aws::String GetNameForConflictExceptionReason(ConflictExceptionReason enumValue) {
  switch (enumValue) {
    ...
    case ConflictExceptionReason::PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT:
      return "PRICING_PLAN_REFERENCED_BY_PREFERENCE_DELETE_CONFLICT";
