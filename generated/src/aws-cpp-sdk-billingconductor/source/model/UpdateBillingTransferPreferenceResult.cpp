...
UpdateBillingTransferPreferenceResult::UpdateBillingTransferPreferenceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdateBillingTransferPreferenceResult& UpdateBillingTransferPreferenceResult::operator=(
