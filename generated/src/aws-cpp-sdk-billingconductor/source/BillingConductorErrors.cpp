...
template <>
AWS_BILLINGCONDUCTOR_API ConflictException BillingConductorError::GetModeledError() {
  assert(this->GetErrorType() == BillingConductorErrors::CONFLICT);
  return ConflictException(this->GetJsonPayload().View());
}

template <>
AWS_BILLINGCONDUCTOR_API ThrottlingException BillingConductorError::GetModeledError() {
  assert(this->GetErrorType() == BillingConductorErrors::THROTTLING);
  return ThrottlingException(this->GetJsonPayload().View());
}

template <>
AWS_BILLINGCONDUCTOR_API InternalServerException BillingConductorError::GetModeledError() {
  assert(this->GetErrorType() == BillingConductorErrors::INTERNAL_SERVER);
  return InternalServerException(this->GetJsonPayload().View());
}

template <>
AWS_BILLINGCONDUCTOR_API ResourceNotFoundException BillingConductorError::GetModeledError() {
  assert(this->GetErrorType() == BillingConductorErrors::RESOURCE_NOT_FOUND);
  return ResourceNotFoundException(this->GetJsonPayload().View());
}

template <>
AWS_BILLINGCONDUCTOR_API ValidationException BillingConductorError::GetModeledError() {
  assert(this->GetErrorType() == BillingConductorErrors::VALIDATION);
  return ValidationException(this->GetJsonPayload().View());
}

template <>
AWS_BILLINGCONDUCTOR_API ServiceLimitExceededException BillingConductorError::GetModeledError() {
