...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API ValidationExceptionField() = default;
    AWS_BILLINGCONDUCTOR_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
    AWS_BILLINGCONDUCTOR_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
