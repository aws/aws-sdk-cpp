...
class CustomLineItemChargeDetails {
 public:
  ...
  void SetFlat(FlatT&& value) {
    ...
    m_flat = std::forward<FlatT>(value);
  }
  template <typename FlatT = CustomLineItemFlatChargeDetails>
  CustomLineItemChargeDetails& WithFlat(FlatT&& value) {
    SetFlat(std::forward<FlatT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPercentage(PercentageT&& value) {
    ...
    m_percentage = std::forward<PercentageT>(value);
  }
  template <typename PercentageT = CustomLineItemPercentageChargeDetails>
  CustomLineItemChargeDetails& WithPercentage(PercentageT&& value) {
    SetPercentage(std::forward<PercentageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetType(CustomLineItemType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CustomLineItemChargeDetails& WithType(CustomLineItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
