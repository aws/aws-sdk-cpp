...
class PricingPlanListElement {
 public:
  ...
  template <typename NameT = Aws::String>
  PricingPlanListElement& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  PricingPlanListElement& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PricingPlanListElement& WithDescription(DescriptionT&& value) {
  ...
  inline PricingPlanListElement& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline PricingPlanListElement& WithCreationTime(long long value) {
  ...
  inline PricingPlanListElement& WithLastModifiedTime(long long value) {
