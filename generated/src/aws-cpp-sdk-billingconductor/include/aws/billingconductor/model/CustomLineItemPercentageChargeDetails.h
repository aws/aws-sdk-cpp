...
class CustomLineItemPercentageChargeDetails {
 public:
  ...
  inline void SetPercentageValue(double value) {
    m_percentageValueHasBeenSet = true;
    m_percentageValue = value;
  }
  inline CustomLineItemPercentageChargeDetails& WithPercentageValue(double value) {
  ...
  void SetAssociatedValues(AssociatedValuesT&& value) {
    m_associatedValuesHasBeenSet = true;
    m_associatedValues = std::forward<AssociatedValuesT>(value);
  }
  template <typename AssociatedValuesT = Aws::Vector<Aws::String>>
  CustomLineItemPercentageChargeDetails& WithAssociatedValues(AssociatedValuesT&& value) {
    SetAssociatedValues(std::forward<AssociatedValuesT>(value));
    return *this;
  }
  template <typename AssociatedValuesT = Aws::String>
  CustomLineItemPercentageChargeDetails& AddAssociatedValues(AssociatedValuesT&& value) {
    m_associatedValuesHasBeenSet = true;
    m_associatedValues.emplace_back(std::forward<AssociatedValuesT>(value));
    return *this;
  }
  ///@}
 private:
