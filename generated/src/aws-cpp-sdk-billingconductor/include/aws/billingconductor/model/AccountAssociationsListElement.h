...
class AccountAssociationsListElement {
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AccountAssociationsListElement& WithAccountId(AccountIdT&& value) {
  ...
  template <typename BillingGroupArnT = Aws::String>
  AccountAssociationsListElement& WithBillingGroupArn(BillingGroupArnT&& value) {
  ...
  template <typename AccountNameT = Aws::String>
  AccountAssociationsListElement& WithAccountName(AccountNameT&& value) {
  ...
  void SetAccountEmail(AccountEmailT&& value) {
    m_accountEmailHasBeenSet = true;
    m_accountEmail = std::forward<AccountEmailT>(value);
  }
  template <typename AccountEmailT = Aws::String>
  AccountAssociationsListElement& WithAccountEmail(AccountEmailT&& value) {
    SetAccountEmail(std::forward<AccountEmailT>(value));
    return *this;
  }
  ///@}
 private:
