...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API AssociateAccountsResult() = default;
    ...
    template<typename ArnT = Aws::String>
    AssociateAccountsResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateAccountsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
