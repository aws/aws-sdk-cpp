...
namespace Model
{
  ...
  public:
    ...
    inline AssociateAccountsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline AssociateAccountsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline AssociateAccountsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
