...
class ListPricingPlansRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListPricingPlansRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  template <typename FiltersT = ListPricingPlansFilter>
  ListPricingPlansRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListPricingPlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPricingPlansRequest& WithNextToken(NextTokenT&& value) {
