...
namespace Model {
class GetBillingTransferPreferenceResult {
 public:
  AWS_BILLINGCONDUCTOR_API GetBillingTransferPreferenceResult() = default;
  AWS_BILLINGCONDUCTOR_API GetBillingTransferPreferenceResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_BILLINGCONDUCTOR_API GetBillingTransferPreferenceResult& operator=(
  ...
  template <typename ResponsibilityTransferArnT = Aws::String>
  GetBillingTransferPreferenceResult& WithResponsibilityTransferArn(ResponsibilityTransferArnT&& value) {
  ...
  template <typename AutoBillingTransferBillingGroupCreationT = AutoTransferBillingGroupCreationPreference>
  GetBillingTransferPreferenceResult& WithAutoBillingTransferBillingGroupCreation(AutoBillingTransferBillingGroupCreationT&& value) {
  ...
  ///@{
  /**
   * <p>The most recent time when the preference was modified. This value is empty if
   * the preference has never been set for the billing transfer.</p>
   */
  ...
  inline GetBillingTransferPreferenceResult& WithLastModifiedTime(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetBillingTransferPreferenceResult& WithRequestId(RequestIdT&& value) {
