...
class UpdateCustomLineItemChargeDetails {
 public:
  ...
  template <typename FlatT = UpdateCustomLineItemFlatChargeDetails>
  UpdateCustomLineItemChargeDetails& WithFlat(FlatT&& value) {
  ...
  template <typename PercentageT = UpdateCustomLineItemPercentageChargeDetails>
  UpdateCustomLineItemChargeDetails& WithPercentage(PercentageT&& value) {
  ...
  template <typename LineItemFiltersT = Aws::Vector<LineItemFilter>>
  UpdateCustomLineItemChargeDetails& WithLineItemFilters(LineItemFiltersT&& value) {
    SetLineItemFilters(std::forward<LineItemFiltersT>(value));
    return *this;
  }
  template <typename LineItemFiltersT = LineItemFilter>
  UpdateCustomLineItemChargeDetails& AddLineItemFilters(LineItemFiltersT&& value) {
    m_lineItemFiltersHasBeenSet = true;
