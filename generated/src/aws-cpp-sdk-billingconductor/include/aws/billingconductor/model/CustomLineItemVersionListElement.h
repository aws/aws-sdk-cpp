...
namespace Model
{
  ...
  public:
    ...
    inline CustomLineItemVersionListElement& WithComputationRule(ComputationRuleEnum value) { SetComputationRule(value); return *this;}
    ///@}
    ...
    template<typename PresentationDetailsT = PresentationObject>
    CustomLineItemVersionListElement& WithPresentationDetails(PresentationDetailsT&& value) { SetPresentationDetails(std::forward<PresentationDetailsT>(value)); return *this;}
    ///@}
  private:
