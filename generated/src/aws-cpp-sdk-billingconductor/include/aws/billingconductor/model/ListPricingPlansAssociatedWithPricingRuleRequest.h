...
class ListPricingPlansAssociatedWithPricingRuleRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  void SetPricingRuleArn(PricingRuleArnT&& value) {
    m_pricingRuleArnHasBeenSet = true;
    m_pricingRuleArn = std::forward<PricingRuleArnT>(value);
  }
  template <typename PricingRuleArnT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleRequest& WithPricingRuleArn(PricingRuleArnT&& value) {
    SetPricingRuleArn(std::forward<PricingRuleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListPricingPlansAssociatedWithPricingRuleRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleRequest& WithNextToken(NextTokenT&& value) {
