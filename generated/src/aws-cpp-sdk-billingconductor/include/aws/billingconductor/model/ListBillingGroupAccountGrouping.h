...
class ListBillingGroupAccountGrouping {
 public:
  ...
  inline ListBillingGroupAccountGrouping& WithAutoAssociate(bool value) {
  ...
  ///@{
  /**
   * <p> The Amazon Resource Name (ARN) that identifies the transfer relationship for
   * the billing group. </p>
   */
  ...
  template <typename ResponsibilityTransferArnT = Aws::String>
  ListBillingGroupAccountGrouping& WithResponsibilityTransferArn(ResponsibilityTransferArnT&& value) {
