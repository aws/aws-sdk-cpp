...
class ListCustomLineItemVersionsRequest : public BillingConductorRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListCustomLineItemVersionsRequest& WithArn(ArnT&& value) {
  ...
  inline ListCustomLineItemVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomLineItemVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = ListCustomLineItemVersionsFilter>
  ListCustomLineItemVersionsRequest& WithFilters(FiltersT&& value) {
