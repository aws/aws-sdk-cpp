...
class AccountGrouping {
 public:
  ...
  void SetLinkedAccountIds(LinkedAccountIdsT&& value) {
    ...
    m_linkedAccountIds = std::forward<LinkedAccountIdsT>(value);
  }
  template <typename LinkedAccountIdsT = Aws::Vector<Aws::String>>
  AccountGrouping& WithLinkedAccountIds(LinkedAccountIdsT&& value) {
    SetLinkedAccountIds(std::forward<LinkedAccountIdsT>(value));
    return *this;
  }
  template <typename LinkedAccountIdsT = Aws::String>
  AccountGrouping& AddLinkedAccountIds(LinkedAccountIdsT&& value) {
    m_linkedAccountIdsHasBeenSet = true;
    m_linkedAccountIds.emplace_back(std::forward<LinkedAccountIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline AccountGrouping& WithAutoAssociate(bool value) {
