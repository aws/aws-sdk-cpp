...
class LineItemFilter {
 public:
  ...
  inline void SetAttribute(LineItemFilterAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline LineItemFilter& WithAttribute(LineItemFilterAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline LineItemFilter& WithMatchOption(MatchOption value) {
  ...
  template <typename ValuesT = Aws::Vector<LineItemFilterValue>>
  LineItemFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  inline LineItemFilter& AddValues(LineItemFilterValue value) {
    m_valuesHasBeenSet = true;
