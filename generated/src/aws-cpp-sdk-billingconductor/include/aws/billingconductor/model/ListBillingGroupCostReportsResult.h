...
class ListBillingGroupCostReportsResult {
 public:
  ...
  AWS_BILLINGCONDUCTOR_API ListBillingGroupCostReportsResult& operator=(
  ...
  void SetBillingGroupCostReports(BillingGroupCostReportsT&& value) {
    m_billingGroupCostReportsHasBeenSet = true;
    m_billingGroupCostReports = std::forward<BillingGroupCostReportsT>(value);
  }
  template <typename BillingGroupCostReportsT = Aws::Vector<BillingGroupCostReportElement>>
  ListBillingGroupCostReportsResult& WithBillingGroupCostReports(BillingGroupCostReportsT&& value) {
    SetBillingGroupCostReports(std::forward<BillingGroupCostReportsT>(value));
    return *this;
  }
  template <typename BillingGroupCostReportsT = BillingGroupCostReportElement>
  ListBillingGroupCostReportsResult& AddBillingGroupCostReports(BillingGroupCostReportsT&& value) {
    m_billingGroupCostReportsHasBeenSet = true;
    m_billingGroupCostReports.emplace_back(std::forward<BillingGroupCostReportsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBillingGroupCostReportsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBillingGroupCostReportsResult& WithRequestId(RequestIdT&& value) {
