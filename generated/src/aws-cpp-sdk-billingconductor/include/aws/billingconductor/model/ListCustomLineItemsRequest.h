...
class ListCustomLineItemsRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListCustomLineItemsRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  inline ListCustomLineItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomLineItemsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = ListCustomLineItemsFilter>
  ListCustomLineItemsRequest& WithFilters(FiltersT&& value) {
