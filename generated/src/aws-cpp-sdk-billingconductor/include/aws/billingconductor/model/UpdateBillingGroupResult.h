...
class UpdateBillingGroupResult {
 public:
  ...
  inline UpdateBillingGroupResult& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBillingGroupResult& WithLastModifiedTime(long long value) {
  ...
  inline UpdateBillingGroupResult& WithStatus(BillingGroupStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
