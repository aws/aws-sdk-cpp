...
class ListPricingRulesRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListPricingRulesRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  template <typename FiltersT = ListPricingRulesFilter>
  ListPricingRulesRequest& WithFilters(FiltersT&& value) {
  ...
  inline ListPricingRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPricingRulesRequest& WithNextToken(NextTokenT&& value) {
