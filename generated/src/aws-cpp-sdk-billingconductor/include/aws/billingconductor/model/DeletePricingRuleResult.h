...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API DeletePricingRuleResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeletePricingRuleResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeletePricingRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
