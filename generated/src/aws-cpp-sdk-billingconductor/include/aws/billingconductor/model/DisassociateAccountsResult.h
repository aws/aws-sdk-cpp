...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API DisassociateAccountsResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DisassociateAccountsResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateAccountsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
