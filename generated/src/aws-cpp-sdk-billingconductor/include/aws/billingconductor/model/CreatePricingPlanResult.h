...
namespace Model
{
  ...
  public:
    ...
    inline CreatePricingPlanResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreatePricingPlanResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreatePricingPlanResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
