...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API CreatePricingPlanResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreatePricingPlanResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePricingPlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
