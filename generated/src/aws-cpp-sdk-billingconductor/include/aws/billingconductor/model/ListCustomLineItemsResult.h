...
class ListCustomLineItemsResult {
 public:
  ...
  void SetCustomLineItems(CustomLineItemsT&& value) {
    m_customLineItemsHasBeenSet = true;
    m_customLineItems = std::forward<CustomLineItemsT>(value);
  }
  template <typename CustomLineItemsT = Aws::Vector<CustomLineItemListElement>>
  ListCustomLineItemsResult& WithCustomLineItems(CustomLineItemsT&& value) {
    SetCustomLineItems(std::forward<CustomLineItemsT>(value));
    return *this;
  }
  template <typename CustomLineItemsT = CustomLineItemListElement>
  ListCustomLineItemsResult& AddCustomLineItems(CustomLineItemsT&& value) {
    m_customLineItemsHasBeenSet = true;
    m_customLineItems.emplace_back(std::forward<CustomLineItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomLineItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomLineItemsResult& WithRequestId(RequestIdT&& value) {
