...
class ListCustomLineItemChargeDetails {
 public:
  ...
  template <typename FlatT = ListCustomLineItemFlatChargeDetails>
  ListCustomLineItemChargeDetails& WithFlat(FlatT&& value) {
  ...
  template <typename PercentageT = ListCustomLineItemPercentageChargeDetails>
  ListCustomLineItemChargeDetails& WithPercentage(PercentageT&& value) {
  ...
  inline ListCustomLineItemChargeDetails& WithType(CustomLineItemType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename LineItemFiltersT = Aws::Vector<LineItemFilter>>
  ListCustomLineItemChargeDetails& WithLineItemFilters(LineItemFiltersT&& value) {
    SetLineItemFilters(std::forward<LineItemFiltersT>(value));
    return *this;
  }
  template <typename LineItemFiltersT = LineItemFilter>
  ListCustomLineItemChargeDetails& AddLineItemFilters(LineItemFiltersT&& value) {
    m_lineItemFiltersHasBeenSet = true;
