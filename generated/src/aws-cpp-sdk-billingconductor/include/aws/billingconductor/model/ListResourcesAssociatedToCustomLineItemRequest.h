...
class ListResourcesAssociatedToCustomLineItemRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListResourcesAssociatedToCustomLineItemRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  template <typename ArnT = Aws::String>
  ListResourcesAssociatedToCustomLineItemRequest& WithArn(ArnT&& value) {
  ...
  inline ListResourcesAssociatedToCustomLineItemRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourcesAssociatedToCustomLineItemRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = ListResourcesAssociatedToCustomLineItemFilter>
  ListResourcesAssociatedToCustomLineItemRequest& WithFilters(FiltersT&& value) {
