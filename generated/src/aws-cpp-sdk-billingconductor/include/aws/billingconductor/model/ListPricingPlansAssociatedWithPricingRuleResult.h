...
class ListPricingPlansAssociatedWithPricingRuleResult {
 public:
  ...
  AWS_BILLINGCONDUCTOR_API ListPricingPlansAssociatedWithPricingRuleResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename BillingPeriodT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleResult& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  template <typename PricingRuleArnT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleResult& WithPricingRuleArn(PricingRuleArnT&& value) {
  ...
  void SetPricingPlanArns(PricingPlanArnsT&& value) {
    m_pricingPlanArnsHasBeenSet = true;
    m_pricingPlanArns = std::forward<PricingPlanArnsT>(value);
  }
  template <typename PricingPlanArnsT = Aws::Vector<Aws::String>>
  ListPricingPlansAssociatedWithPricingRuleResult& WithPricingPlanArns(PricingPlanArnsT&& value) {
    SetPricingPlanArns(std::forward<PricingPlanArnsT>(value));
    return *this;
  }
  template <typename PricingPlanArnsT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleResult& AddPricingPlanArns(PricingPlanArnsT&& value) {
    m_pricingPlanArnsHasBeenSet = true;
    m_pricingPlanArns.emplace_back(std::forward<PricingPlanArnsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPricingPlansAssociatedWithPricingRuleResult& WithRequestId(RequestIdT&& value) {
