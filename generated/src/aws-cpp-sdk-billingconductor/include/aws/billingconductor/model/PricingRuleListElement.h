...
class PricingRuleListElement {
 public:
  ...
  template <typename NameT = Aws::String>
  PricingRuleListElement& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  PricingRuleListElement& WithArn(ArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  PricingRuleListElement& WithDescription(DescriptionT&& value) {
  ...
  inline void SetScope(PricingRuleScope value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline PricingRuleListElement& WithScope(PricingRuleScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(PricingRuleType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline PricingRuleListElement& WithType(PricingRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetModifierPercentage(double value) {
    m_modifierPercentageHasBeenSet = true;
    m_modifierPercentage = value;
  }
  inline PricingRuleListElement& WithModifierPercentage(double value) {
    SetModifierPercentage(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceT = Aws::String>
  PricingRuleListElement& WithService(ServiceT&& value) {
  ...
  inline void SetAssociatedPricingPlanCount(long long value) {
    m_associatedPricingPlanCountHasBeenSet = true;
    m_associatedPricingPlanCount = value;
  }
  inline PricingRuleListElement& WithAssociatedPricingPlanCount(long long value) {
    SetAssociatedPricingPlanCount(value);
    return *this;
  }
  ///@}
  ...
  inline PricingRuleListElement& WithCreationTime(long long value) {
  ...
  inline PricingRuleListElement& WithLastModifiedTime(long long value) {
  ...
  void SetBillingEntity(BillingEntityT&& value) {
    ...
    m_billingEntity = std::forward<BillingEntityT>(value);
  }
  template <typename BillingEntityT = Aws::String>
  PricingRuleListElement& WithBillingEntity(BillingEntityT&& value) {
    SetBillingEntity(std::forward<BillingEntityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTiering(TieringT&& value) {
    ...
    m_tiering = std::forward<TieringT>(value);
  }
  template <typename TieringT = Tiering>
  PricingRuleListElement& WithTiering(TieringT&& value) {
    SetTiering(std::forward<TieringT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UsageTypeT = Aws::String>
  PricingRuleListElement& WithUsageType(UsageTypeT&& value) {
  ...
  template <typename OperationT = Aws::String>
  PricingRuleListElement& WithOperation(OperationT&& value) {
