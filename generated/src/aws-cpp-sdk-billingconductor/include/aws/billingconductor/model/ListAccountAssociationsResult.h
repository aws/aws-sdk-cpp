...
class ListAccountAssociationsResult {
 public:
  ...
  template <typename LinkedAccountsT = Aws::Vector<AccountAssociationsListElement>>
  ListAccountAssociationsResult& WithLinkedAccounts(LinkedAccountsT&& value) {
    SetLinkedAccounts(std::forward<LinkedAccountsT>(value));
    return *this;
  }
  template <typename LinkedAccountsT = AccountAssociationsListElement>
  ListAccountAssociationsResult& AddLinkedAccounts(LinkedAccountsT&& value) {
    m_linkedAccountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAccountAssociationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAccountAssociationsResult& WithRequestId(RequestIdT&& value) {
