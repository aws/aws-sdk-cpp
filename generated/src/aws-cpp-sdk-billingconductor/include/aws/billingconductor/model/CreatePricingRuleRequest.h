...
class CreatePricingRuleRequest : public BillingConductorRequest {
 public:
  ...
  inline CreatePricingRuleRequest& WithScope(PricingRuleScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePricingRuleRequest& WithType(PricingRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePricingRuleRequest& WithModifierPercentage(double value) {
