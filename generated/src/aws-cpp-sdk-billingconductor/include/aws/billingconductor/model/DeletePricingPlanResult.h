...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API DeletePricingPlanResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeletePricingPlanResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeletePricingPlanResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
