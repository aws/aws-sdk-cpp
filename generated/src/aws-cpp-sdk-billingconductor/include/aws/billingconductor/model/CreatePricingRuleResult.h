...
namespace Model
{
  ...
  {
  public:
    AWS_BILLINGCONDUCTOR_API CreatePricingRuleResult() = default;
    ...
    template<typename ArnT = Aws::String>
    CreatePricingRuleResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePricingRuleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
