...
class AssociatePricingRulesRequest : public BillingConductorRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  AssociatePricingRulesRequest& WithArn(ArnT&& value) {
  ...
  template <typename PricingRuleArnsT = Aws::Vector<Aws::String>>
  AssociatePricingRulesRequest& WithPricingRuleArns(PricingRuleArnsT&& value) {
    SetPricingRuleArns(std::forward<PricingRuleArnsT>(value));
    return *this;
  }
  template <typename PricingRuleArnsT = Aws::String>
  AssociatePricingRulesRequest& AddPricingRuleArns(PricingRuleArnsT&& value) {
    m_pricingRuleArnsHasBeenSet = true;
