...
class BatchAssociateResourcesToCustomLineItemRequest : public BillingConductorRequest {
 public:
  ...
  template <typename TargetArnT = Aws::String>
  BatchAssociateResourcesToCustomLineItemRequest& WithTargetArn(TargetArnT&& value) {
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  BatchAssociateResourcesToCustomLineItemRequest& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  BatchAssociateResourcesToCustomLineItemRequest& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  template <typename BillingPeriodRangeT = CustomLineItemBillingPeriodRange>
  BatchAssociateResourcesToCustomLineItemRequest& WithBillingPeriodRange(BillingPeriodRangeT&& value) {
