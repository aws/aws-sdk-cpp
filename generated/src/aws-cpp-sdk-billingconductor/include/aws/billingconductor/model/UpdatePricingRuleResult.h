...
class UpdatePricingRuleResult {
 public:
  ...
  inline UpdatePricingRuleResult& WithScope(PricingRuleScope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePricingRuleResult& WithType(PricingRuleType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdatePricingRuleResult& WithModifierPercentage(double value) {
  ...
  inline UpdatePricingRuleResult& WithAssociatedPricingPlanCount(long long value) {
  ...
  inline UpdatePricingRuleResult& WithLastModifiedTime(long long value) {
