...
class ListBillingGroupsRequest : public BillingConductorRequest {
 public:
  ...
  template <typename BillingPeriodT = Aws::String>
  ListBillingGroupsRequest& WithBillingPeriod(BillingPeriodT&& value) {
  ...
  inline ListBillingGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = ListBillingGroupsFilter>
  ListBillingGroupsRequest& WithFilters(FiltersT&& value) {
