...
class ListCustomLineItemVersionsResult {
 public:
  ...
  AWS_BILLINGCONDUCTOR_API ListCustomLineItemVersionsResult& operator=(
  ...
  void SetCustomLineItemVersions(CustomLineItemVersionsT&& value) {
    m_customLineItemVersionsHasBeenSet = true;
    m_customLineItemVersions = std::forward<CustomLineItemVersionsT>(value);
  }
  template <typename CustomLineItemVersionsT = Aws::Vector<CustomLineItemVersionListElement>>
  ListCustomLineItemVersionsResult& WithCustomLineItemVersions(CustomLineItemVersionsT&& value) {
    SetCustomLineItemVersions(std::forward<CustomLineItemVersionsT>(value));
    return *this;
  }
  template <typename CustomLineItemVersionsT = CustomLineItemVersionListElement>
  ListCustomLineItemVersionsResult& AddCustomLineItemVersions(CustomLineItemVersionsT&& value) {
    m_customLineItemVersionsHasBeenSet = true;
    m_customLineItemVersions.emplace_back(std::forward<CustomLineItemVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomLineItemVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomLineItemVersionsResult& WithRequestId(RequestIdT&& value) {
