...
/**
 * <p>Billing Conductor is a fully managed service that you can use to customize a
 * <a
 ...
 * chargeback your end customers. Billing Conductor doesn't change the way you're
 * billed by Amazon Web Services each month by design. Instead, it provides you
 * with a mechanism to configure, generate, and display rates to certain customers
 * over a given billing period. You can also analyze the difference between the
 * rates you apply to your accounting groupings relative to your actual rates from
 * Amazon Web Services. As a result of your Billing Conductor configuration, the
 * payer account can also see the custom rate applied on the billing details page
 * of the <a href="https://console.aws.amazon.com/billing">Billing console</a>, or
 * configure a cost and usage report per billing group.</p> <p>This documentation
 * shows how you can configure Billing Conductor by using its API. For more
 * information about using the <a
 * href="https://console.aws.amazon.com/billingconductor/">Billing Conductor</a>
 * user interface, see the <a
 * href="https://docs.aws.amazon.com/billingconductor/latest/userguide/what-is-billingconductor.html">
 * Billing Conductor User Guide</a>.</p>
 */
class AWS_BILLINGCONDUCTOR_API BillingConductorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  BillingConductorClient(const Aws::BillingConductor::BillingConductorClientConfiguration& clientConfiguration =
  ...
  BillingConductorClient(const Aws::Auth::AWSCredentials& credentials,
                         std::shared_ptr<BillingConductorEndpointProviderBase> endpointProvider = nullptr,
                         const Aws::BillingConductor::BillingConductorClientConfiguration& clientConfiguration =
                             Aws::BillingConductor::BillingConductorClientConfiguration());
  ...
  /**
   * A Callable wrapper for AssociatePricingRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociatePricingRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociatePricingRulesRequestT = Model::AssociatePricingRulesRequest>
  void AssociatePricingRulesAsync(const AssociatePricingRulesRequestT& request, const AssociatePricingRulesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchAssociateResourcesToCustomLineItemOutcome BatchAssociateResourcesToCustomLineItem(
      const Model::BatchAssociateResourcesToCustomLineItemRequest& request) const;

  /**
   * A Callable wrapper for BatchAssociateResourcesToCustomLineItem that returns a future to the operation so that it can be executed in
  ...
  Model::BatchAssociateResourcesToCustomLineItemOutcomeCallable BatchAssociateResourcesToCustomLineItemCallable(
      const BatchAssociateResourcesToCustomLineItemRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::BatchAssociateResourcesToCustomLineItem, request);
  }

  /**
   * An Async wrapper for BatchAssociateResourcesToCustomLineItem that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchAssociateResourcesToCustomLineItemRequestT = Model::BatchAssociateResourcesToCustomLineItemRequest>
  void BatchAssociateResourcesToCustomLineItemAsync(const BatchAssociateResourcesToCustomLineItemRequestT& request,
                                                    const BatchAssociateResourcesToCustomLineItemResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDisassociateResourcesFromCustomLineItemOutcome BatchDisassociateResourcesFromCustomLineItem(
      const Model::BatchDisassociateResourcesFromCustomLineItemRequest& request) const;

  /**
   * A Callable wrapper for BatchDisassociateResourcesFromCustomLineItem that returns a future to the operation so that it can be executed
  ...
  Model::BatchDisassociateResourcesFromCustomLineItemOutcomeCallable BatchDisassociateResourcesFromCustomLineItemCallable(
      const BatchDisassociateResourcesFromCustomLineItemRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::BatchDisassociateResourcesFromCustomLineItem, request);
  }

  /**
   * An Async wrapper for BatchDisassociateResourcesFromCustomLineItem that queues the request into a thread executor and triggers
   * associated callback when operation has finished.
   */
  template <typename BatchDisassociateResourcesFromCustomLineItemRequestT = Model::BatchDisassociateResourcesFromCustomLineItemRequest>
  void BatchDisassociateResourcesFromCustomLineItemAsync(
      const BatchDisassociateResourcesFromCustomLineItemRequestT& request,
      const BatchDisassociateResourcesFromCustomLineItemResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBillingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBillingGroupRequestT = Model::CreateBillingGroupRequest>
  void CreateBillingGroupAsync(const CreateBillingGroupRequestT& request, const CreateBillingGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCustomLineItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCustomLineItem that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomLineItemRequestT = Model::CreateCustomLineItemRequest>
  void CreateCustomLineItemAsync(const CreateCustomLineItemRequestT& request, const CreateCustomLineItemResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePricingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePricingPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePricingPlanRequestT = Model::CreatePricingPlanRequest>
  void CreatePricingPlanAsync(const CreatePricingPlanRequestT& request, const CreatePricingPlanResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePricingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePricingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePricingRuleRequestT = Model::CreatePricingRuleRequest>
  void CreatePricingRuleAsync(const CreatePricingRuleRequestT& request, const CreatePricingRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBillingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBillingGroupRequestT = Model::DeleteBillingGroupRequest>
  void DeleteBillingGroupAsync(const DeleteBillingGroupRequestT& request, const DeleteBillingGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomLineItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomLineItem that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomLineItemRequestT = Model::DeleteCustomLineItemRequest>
  void DeleteCustomLineItemAsync(const DeleteCustomLineItemRequestT& request, const DeleteCustomLineItemResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePricingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePricingPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePricingPlanRequestT = Model::DeletePricingPlanRequest>
  void DeletePricingPlanAsync(const DeletePricingPlanRequestT& request, const DeletePricingPlanResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePricingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePricingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePricingRuleRequestT = Model::DeletePricingRuleRequest>
  void DeletePricingRuleAsync(const DeletePricingRuleRequestT& request, const DeletePricingRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisassociatePricingRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociatePricingRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociatePricingRulesRequestT = Model::DisassociatePricingRulesRequest>
  void DisassociatePricingRulesAsync(const DisassociatePricingRulesRequestT& request,
                                     const DisassociatePricingRulesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * specific billing group.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for GetBillingGroupCostReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetBillingGroupCostReportRequestT = Model::GetBillingGroupCostReportRequest>
  Model::GetBillingGroupCostReportOutcomeCallable GetBillingGroupCostReportCallable(
      const GetBillingGroupCostReportRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::GetBillingGroupCostReport, request);
  }

  /**
   * An Async wrapper for GetBillingGroupCostReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetBillingGroupCostReportRequestT = Model::GetBillingGroupCostReportRequest>
  void GetBillingGroupCostReportAsync(const GetBillingGroupCostReportRequestT& request,
                                      const GetBillingGroupCostReportResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBillingGroupCostReportsOutcome ListBillingGroupCostReports(
      const Model::ListBillingGroupCostReportsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListBillingGroupCostReports that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListBillingGroupCostReportsRequestT = Model::ListBillingGroupCostReportsRequest>
  Model::ListBillingGroupCostReportsOutcomeCallable ListBillingGroupCostReportsCallable(
      const ListBillingGroupCostReportsRequestT& request = {}) const {
    return SubmitCallable(&BillingConductorClient::ListBillingGroupCostReports, request);
  }

  /**
   * An Async wrapper for ListBillingGroupCostReports that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBillingGroupCostReportsRequestT = Model::ListBillingGroupCostReportsRequest>
  void ListBillingGroupCostReportsAsync(const ListBillingGroupCostReportsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListBillingGroupCostReportsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBillingGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBillingGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBillingGroupsRequestT = Model::ListBillingGroupsRequest>
  void ListBillingGroupsAsync(const ListBillingGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListBillingGroupsRequestT& request = {}) const {
  ...
  virtual Model::ListCustomLineItemVersionsOutcome ListCustomLineItemVersions(
      const Model::ListCustomLineItemVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListCustomLineItemVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomLineItemVersionsRequestT = Model::ListCustomLineItemVersionsRequest>
  Model::ListCustomLineItemVersionsOutcomeCallable ListCustomLineItemVersionsCallable(
      const ListCustomLineItemVersionsRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::ListCustomLineItemVersions, request);
  }

  /**
   * An Async wrapper for ListCustomLineItemVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomLineItemVersionsRequestT = Model::ListCustomLineItemVersionsRequest>
  void ListCustomLineItemVersionsAsync(const ListCustomLineItemVersionsRequestT& request,
                                       const ListCustomLineItemVersionsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCustomLineItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCustomLineItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCustomLineItemsRequestT = Model::ListCustomLineItemsRequest>
  void ListCustomLineItemsAsync(const ListCustomLineItemsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListCustomLineItemsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListPricingPlans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPricingPlans that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPricingPlansRequestT = Model::ListPricingPlansRequest>
  void ListPricingPlansAsync(const ListPricingPlansResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListPricingPlansRequestT& request = {}) const {
  ...
  virtual Model::ListPricingPlansAssociatedWithPricingRuleOutcome ListPricingPlansAssociatedWithPricingRule(
      const Model::ListPricingPlansAssociatedWithPricingRuleRequest& request) const;

  /**
   * A Callable wrapper for ListPricingPlansAssociatedWithPricingRule that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListPricingPlansAssociatedWithPricingRuleOutcomeCallable ListPricingPlansAssociatedWithPricingRuleCallable(
      const ListPricingPlansAssociatedWithPricingRuleRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::ListPricingPlansAssociatedWithPricingRule, request);
  }

  /**
   * An Async wrapper for ListPricingPlansAssociatedWithPricingRule that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListPricingPlansAssociatedWithPricingRuleRequestT = Model::ListPricingPlansAssociatedWithPricingRuleRequest>
  void ListPricingPlansAssociatedWithPricingRuleAsync(
      const ListPricingPlansAssociatedWithPricingRuleRequestT& request,
      const ListPricingPlansAssociatedWithPricingRuleResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPricingRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPricingRules that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPricingRulesRequestT = Model::ListPricingRulesRequest>
  void ListPricingRulesAsync(const ListPricingRulesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListPricingRulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPricingRulesAssociatedToPricingPlanOutcome ListPricingRulesAssociatedToPricingPlan(
      const Model::ListPricingRulesAssociatedToPricingPlanRequest& request) const;

  /**
   * A Callable wrapper for ListPricingRulesAssociatedToPricingPlan that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListPricingRulesAssociatedToPricingPlanRequestT = Model::ListPricingRulesAssociatedToPricingPlanRequest>
  Model::ListPricingRulesAssociatedToPricingPlanOutcomeCallable ListPricingRulesAssociatedToPricingPlanCallable(
      const ListPricingRulesAssociatedToPricingPlanRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::ListPricingRulesAssociatedToPricingPlan, request);
  }

  /**
   * An Async wrapper for ListPricingRulesAssociatedToPricingPlan that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListPricingRulesAssociatedToPricingPlanRequestT = Model::ListPricingRulesAssociatedToPricingPlanRequest>
  void ListPricingRulesAssociatedToPricingPlanAsync(const ListPricingRulesAssociatedToPricingPlanRequestT& request,
                                                    const ListPricingRulesAssociatedToPricingPlanResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourcesAssociatedToCustomLineItemOutcome ListResourcesAssociatedToCustomLineItem(
      const Model::ListResourcesAssociatedToCustomLineItemRequest& request) const;

  /**
   * A Callable wrapper for ListResourcesAssociatedToCustomLineItem that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListResourcesAssociatedToCustomLineItemRequestT = Model::ListResourcesAssociatedToCustomLineItemRequest>
  Model::ListResourcesAssociatedToCustomLineItemOutcomeCallable ListResourcesAssociatedToCustomLineItemCallable(
      const ListResourcesAssociatedToCustomLineItemRequestT& request) const {
    return SubmitCallable(&BillingConductorClient::ListResourcesAssociatedToCustomLineItem, request);
  }

  /**
   * An Async wrapper for ListResourcesAssociatedToCustomLineItem that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListResourcesAssociatedToCustomLineItemRequestT = Model::ListResourcesAssociatedToCustomLineItemRequest>
  void ListResourcesAssociatedToCustomLineItemAsync(const ListResourcesAssociatedToCustomLineItemRequestT& request,
                                                    const ListResourcesAssociatedToCustomLineItemResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBillingGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBillingGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateBillingGroupRequestT = Model::UpdateBillingGroupRequest>
  ...
  /**
   * A Callable wrapper for UpdateCustomLineItem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCustomLineItem that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCustomLineItemRequestT = Model::UpdateCustomLineItemRequest>
  void UpdateCustomLineItemAsync(const UpdateCustomLineItemRequestT& request, const UpdateCustomLineItemResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePricingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePricingPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePricingPlanRequestT = Model::UpdatePricingPlanRequest>
  void UpdatePricingPlanAsync(const UpdatePricingPlanRequestT& request, const UpdatePricingPlanResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePricingRule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePricingRule that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePricingRuleRequestT = Model::UpdatePricingRuleRequest>
  void UpdatePricingRuleAsync(const UpdatePricingRuleRequestT& request, const UpdatePricingRuleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
