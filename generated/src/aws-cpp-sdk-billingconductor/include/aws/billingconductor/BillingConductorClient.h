...
namespace BillingConductor
{
   ...
   */
  class AWS_BILLINGCONDUCTOR_API BillingConductorClient : Aws::Client::ClientWithAsyncTemplateMethods<BillingConductorClient>,
    smithy::client::AwsSmithyClientT<Aws::BillingConductor::SERVICE_NAME,
