...
namespace Model
{
  ...
  public:
    ...
    inline GetScreenDataResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetScreenDataResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetScreenDataResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
