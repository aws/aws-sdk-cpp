...
namespace Model
{
  ...
  public:
    ...
    inline QueryTableRowsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline QueryTableRowsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline QueryTableRowsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
