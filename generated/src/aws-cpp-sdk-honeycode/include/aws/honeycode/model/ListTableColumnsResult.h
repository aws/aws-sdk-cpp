...
namespace Model
{
  ...
  public:
    ...
    inline ListTableColumnsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListTableColumnsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListTableColumnsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
