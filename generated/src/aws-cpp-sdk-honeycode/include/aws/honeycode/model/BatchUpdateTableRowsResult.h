...
namespace Model
{
  ...
  public:
    ...
    inline BatchUpdateTableRowsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline BatchUpdateTableRowsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline BatchUpdateTableRowsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
