...
class TextGenerationJobConfig {
 public:
  ...
  void SetTextGenerationHyperParameters(TextGenerationHyperParametersT&& value) {
    ...
    m_textGenerationHyperParameters = std::forward<TextGenerationHyperParametersT>(value);
  }
  template <typename TextGenerationHyperParametersT = Aws::Map<Aws::String, Aws::String>>
  TextGenerationJobConfig& WithTextGenerationHyperParameters(TextGenerationHyperParametersT&& value) {
    SetTextGenerationHyperParameters(std::forward<TextGenerationHyperParametersT>(value));
    return *this;
  }
  template <typename TextGenerationHyperParametersKeyT = Aws::String, typename TextGenerationHyperParametersValueT = Aws::String>
  TextGenerationJobConfig& AddTextGenerationHyperParameters(TextGenerationHyperParametersKeyT&& key,
                                                            TextGenerationHyperParametersValueT&& value) {
    m_textGenerationHyperParametersHasBeenSet = true;
    m_textGenerationHyperParameters.emplace(std::forward<TextGenerationHyperParametersKeyT>(key),
                                            std::forward<TextGenerationHyperParametersValueT>(value));
    return *this;
  }
  ///@}
