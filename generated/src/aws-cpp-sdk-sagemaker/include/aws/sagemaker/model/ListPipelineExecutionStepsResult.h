...
class ListPipelineExecutionStepsResult {
 public:
  ...
  void SetPipelineExecutionSteps(PipelineExecutionStepsT&& value) {
    m_pipelineExecutionStepsHasBeenSet = true;
    m_pipelineExecutionSteps = std::forward<PipelineExecutionStepsT>(value);
  }
  template <typename PipelineExecutionStepsT = Aws::Vector<PipelineExecutionStep>>
  ListPipelineExecutionStepsResult& WithPipelineExecutionSteps(PipelineExecutionStepsT&& value) {
    SetPipelineExecutionSteps(std::forward<PipelineExecutionStepsT>(value));
    return *this;
  }
  template <typename PipelineExecutionStepsT = PipelineExecutionStep>
  ListPipelineExecutionStepsResult& AddPipelineExecutionSteps(PipelineExecutionStepsT&& value) {
    m_pipelineExecutionStepsHasBeenSet = true;
    m_pipelineExecutionSteps.emplace_back(std::forward<PipelineExecutionStepsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineExecutionStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPipelineExecutionStepsResult& WithRequestId(RequestIdT&& value) {
