...
namespace Model
{
  ...
  public:
    ...
    void SetDataCapturedDestinationS3Uri(DataCapturedDestinationS3UriT&& value) { m_dataCapturedDestinationS3UriHasBeenSet = true; m_dataCapturedDestinationS3Uri = std::forward<DataCapturedDestinationS3UriT>(value); }
    template<typename DataCapturedDestinationS3UriT = Aws::String>
    BatchTransformInput& WithDataCapturedDestinationS3Uri(DataCapturedDestinationS3UriT&& value) { SetDataCapturedDestinationS3Uri(std::forward<DataCapturedDestinationS3UriT>(value)); return *this;}
    ///@}
    ...
    void SetDatasetFormat(DatasetFormatT&& value) { m_datasetFormatHasBeenSet = true; m_datasetFormat = std::forward<DatasetFormatT>(value); }
    template<typename DatasetFormatT = MonitoringDatasetFormat>
    BatchTransformInput& WithDatasetFormat(DatasetFormatT&& value) { SetDatasetFormat(std::forward<DatasetFormatT>(value)); return *this;}
    ///@}
    ...
    template<typename LocalPathT = Aws::String>
    BatchTransformInput& WithLocalPath(LocalPathT&& value) { SetLocalPath(std::forward<LocalPathT>(value)); return *this;}
    ///@}
    ...
    inline BatchTransformInput& WithS3InputMode(ProcessingS3InputMode value) { SetS3InputMode(value); return *this;}
    ///@}
    ...
    inline BatchTransformInput& WithS3DataDistributionType(ProcessingS3DataDistributionType value) { SetS3DataDistributionType(value); return *this;}
    ///@}
    ...
    template<typename FeaturesAttributeT = Aws::String>
    BatchTransformInput& WithFeaturesAttribute(FeaturesAttributeT&& value) { SetFeaturesAttribute(std::forward<FeaturesAttributeT>(value)); return *this;}
    ///@}
    ...
    template<typename InferenceAttributeT = Aws::String>
    BatchTransformInput& WithInferenceAttribute(InferenceAttributeT&& value) { SetInferenceAttribute(std::forward<InferenceAttributeT>(value)); return *this;}
    ///@}
    ...
    template<typename ProbabilityAttributeT = Aws::String>
    BatchTransformInput& WithProbabilityAttribute(ProbabilityAttributeT&& value) { SetProbabilityAttribute(std::forward<ProbabilityAttributeT>(value)); return *this;}
    ///@}
    ...
    template<typename StartTimeOffsetT = Aws::String>
    BatchTransformInput& WithStartTimeOffset(StartTimeOffsetT&& value) { SetStartTimeOffset(std::forward<StartTimeOffsetT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeOffsetT = Aws::String>
    BatchTransformInput& WithEndTimeOffset(EndTimeOffsetT&& value) { SetEndTimeOffset(std::forward<EndTimeOffsetT>(value)); return *this;}
    ///@}
    ...
    template<typename ExcludeFeaturesAttributeT = Aws::String>
    BatchTransformInput& WithExcludeFeaturesAttribute(ExcludeFeaturesAttributeT&& value) { SetExcludeFeaturesAttribute(std::forward<ExcludeFeaturesAttributeT>(value)); return *this;}
    ///@}
  private:
