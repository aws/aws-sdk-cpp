...
class DynamicScalingConfiguration {
 public:
  ...
  inline DynamicScalingConfiguration& WithMinCapacity(int value) {
  ...
  inline DynamicScalingConfiguration& WithMaxCapacity(int value) {
  ...
  inline DynamicScalingConfiguration& WithScaleInCooldown(int value) {
  ...
  inline DynamicScalingConfiguration& WithScaleOutCooldown(int value) {
