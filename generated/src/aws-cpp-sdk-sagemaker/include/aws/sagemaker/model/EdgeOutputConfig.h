...
class EdgeOutputConfig {
 public:
  ...
  inline void SetPresetDeploymentType(EdgePresetDeploymentType value) {
    m_presetDeploymentTypeHasBeenSet = true;
    m_presetDeploymentType = value;
  }
  inline EdgeOutputConfig& WithPresetDeploymentType(EdgePresetDeploymentType value) {
    SetPresetDeploymentType(value);
    return *this;
  }
  ///@}
  ...
  void SetPresetDeploymentConfig(PresetDeploymentConfigT&& value) {
    ...
    m_presetDeploymentConfig = std::forward<PresetDeploymentConfigT>(value);
  }
  template <typename PresetDeploymentConfigT = Aws::String>
  EdgeOutputConfig& WithPresetDeploymentConfig(PresetDeploymentConfigT&& value) {
    SetPresetDeploymentConfig(std::forward<PresetDeploymentConfigT>(value));
    return *this;
  }
  ///@}
 private:
