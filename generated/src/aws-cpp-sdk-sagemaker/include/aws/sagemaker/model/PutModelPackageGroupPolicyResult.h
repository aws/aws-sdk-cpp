...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API PutModelPackageGroupPolicyResult() = default;
    ...
    template<typename ModelPackageGroupArnT = Aws::String>
    PutModelPackageGroupPolicyResult& WithModelPackageGroupArn(ModelPackageGroupArnT&& value) { SetModelPackageGroupArn(std::forward<ModelPackageGroupArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    PutModelPackageGroupPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
