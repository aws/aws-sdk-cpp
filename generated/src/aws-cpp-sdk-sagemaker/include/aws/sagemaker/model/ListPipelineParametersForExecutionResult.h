...
class ListPipelineParametersForExecutionResult {
 public:
  ...
  AWS_SAGEMAKER_API ListPipelineParametersForExecutionResult& operator=(
  ...
  template <typename PipelineParametersT = Aws::Vector<Parameter>>
  ListPipelineParametersForExecutionResult& WithPipelineParameters(PipelineParametersT&& value) {
    SetPipelineParameters(std::forward<PipelineParametersT>(value));
    return *this;
  }
  template <typename PipelineParametersT = Parameter>
  ListPipelineParametersForExecutionResult& AddPipelineParameters(PipelineParametersT&& value) {
    m_pipelineParametersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineParametersForExecutionResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPipelineParametersForExecutionResult& WithRequestId(RequestIdT&& value) {
