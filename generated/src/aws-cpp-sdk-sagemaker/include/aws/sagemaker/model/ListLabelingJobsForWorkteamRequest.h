...
class ListLabelingJobsForWorkteamRequest : public SageMakerRequest {
 public:
  ...
  template <typename WorkteamArnT = Aws::String>
  ListLabelingJobsForWorkteamRequest& WithWorkteamArn(WorkteamArnT&& value) {
  ...
  inline ListLabelingJobsForWorkteamRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLabelingJobsForWorkteamRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListLabelingJobsForWorkteamRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListLabelingJobsForWorkteamRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  void SetJobReferenceCodeContains(JobReferenceCodeContainsT&& value) {
    m_jobReferenceCodeContainsHasBeenSet = true;
    m_jobReferenceCodeContains = std::forward<JobReferenceCodeContainsT>(value);
  }
  template <typename JobReferenceCodeContainsT = Aws::String>
  ListLabelingJobsForWorkteamRequest& WithJobReferenceCodeContains(JobReferenceCodeContainsT&& value) {
    SetJobReferenceCodeContains(std::forward<JobReferenceCodeContainsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ListLabelingJobsForWorkteamSortByOptions value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListLabelingJobsForWorkteamRequest& WithSortBy(ListLabelingJobsForWorkteamSortByOptions value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListLabelingJobsForWorkteamRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
