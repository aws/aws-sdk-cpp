...
class ListLabelingJobsResult {
 public:
  ...
  void SetLabelingJobSummaryList(LabelingJobSummaryListT&& value) {
    m_labelingJobSummaryListHasBeenSet = true;
    m_labelingJobSummaryList = std::forward<LabelingJobSummaryListT>(value);
  }
  template <typename LabelingJobSummaryListT = Aws::Vector<LabelingJobSummary>>
  ListLabelingJobsResult& WithLabelingJobSummaryList(LabelingJobSummaryListT&& value) {
    SetLabelingJobSummaryList(std::forward<LabelingJobSummaryListT>(value));
    return *this;
  }
  template <typename LabelingJobSummaryListT = LabelingJobSummary>
  ListLabelingJobsResult& AddLabelingJobSummaryList(LabelingJobSummaryListT&& value) {
    m_labelingJobSummaryListHasBeenSet = true;
    m_labelingJobSummaryList.emplace_back(std::forward<LabelingJobSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLabelingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLabelingJobsResult& WithRequestId(RequestIdT&& value) {
