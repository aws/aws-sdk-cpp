...
class CreateEdgeDeploymentPlanRequest : public SageMakerRequest {
 public:
  ...
  template <typename EdgeDeploymentPlanNameT = Aws::String>
  CreateEdgeDeploymentPlanRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) {
  ...
  template <typename ModelConfigsT = Aws::Vector<EdgeDeploymentModelConfig>>
  CreateEdgeDeploymentPlanRequest& WithModelConfigs(ModelConfigsT&& value) {
    SetModelConfigs(std::forward<ModelConfigsT>(value));
    return *this;
  }
  template <typename ModelConfigsT = EdgeDeploymentModelConfig>
  CreateEdgeDeploymentPlanRequest& AddModelConfigs(ModelConfigsT&& value) {
    m_modelConfigsHasBeenSet = true;
  ...
  template <typename DeviceFleetNameT = Aws::String>
  CreateEdgeDeploymentPlanRequest& WithDeviceFleetName(DeviceFleetNameT&& value) {
  ...
  template <typename StagesT = Aws::Vector<DeploymentStage>>
  CreateEdgeDeploymentPlanRequest& WithStages(StagesT&& value) {
    SetStages(std::forward<StagesT>(value));
    return *this;
  }
  template <typename StagesT = DeploymentStage>
  CreateEdgeDeploymentPlanRequest& AddStages(StagesT&& value) {
    m_stagesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateEdgeDeploymentPlanRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateEdgeDeploymentPlanRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
