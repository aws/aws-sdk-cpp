...
class FileSystemDataSource {
 public:
  ...
  template <typename FileSystemIdT = Aws::String>
  FileSystemDataSource& WithFileSystemId(FileSystemIdT&& value) {
  ...
  inline void SetFileSystemAccessMode(FileSystemAccessMode value) {
    m_fileSystemAccessModeHasBeenSet = true;
    m_fileSystemAccessMode = value;
  }
  inline FileSystemDataSource& WithFileSystemAccessMode(FileSystemAccessMode value) {
    SetFileSystemAccessMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFileSystemType(FileSystemType value) {
    m_fileSystemTypeHasBeenSet = true;
    m_fileSystemType = value;
  }
  inline FileSystemDataSource& WithFileSystemType(FileSystemType value) {
  ...
  template <typename DirectoryPathT = Aws::String>
  FileSystemDataSource& WithDirectoryPath(DirectoryPathT&& value) {
