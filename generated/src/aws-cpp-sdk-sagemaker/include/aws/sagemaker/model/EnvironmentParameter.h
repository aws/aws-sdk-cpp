...
class EnvironmentParameter {
 public:
  ...
  template <typename KeyT = Aws::String>
  EnvironmentParameter& WithKey(KeyT&& value) {
  ...
  void SetValueType(ValueTypeT&& value) {
    m_valueTypeHasBeenSet = true;
    m_valueType = std::forward<ValueTypeT>(value);
  }
  template <typename ValueTypeT = Aws::String>
  EnvironmentParameter& WithValueType(ValueTypeT&& value) {
    SetValueType(std::forward<ValueTypeT>(value));
    return *this;
  }
  ///@}
