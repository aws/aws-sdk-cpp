...
class DescribeOptimizationJobResult {
 public:
  ...
  inline DescribeOptimizationJobResult& WithOptimizationJobStatus(OptimizationJobStatus value) {
  ...
  void SetOptimizationEnvironment(OptimizationEnvironmentT&& value) {
    ...
    m_optimizationEnvironment = std::forward<OptimizationEnvironmentT>(value);
  }
  template <typename OptimizationEnvironmentT = Aws::Map<Aws::String, Aws::String>>
  DescribeOptimizationJobResult& WithOptimizationEnvironment(OptimizationEnvironmentT&& value) {
    SetOptimizationEnvironment(std::forward<OptimizationEnvironmentT>(value));
    return *this;
  }
  ...
  DescribeOptimizationJobResult& AddOptimizationEnvironment(OptimizationEnvironmentKeyT&& key, OptimizationEnvironmentValueT&& value) {
    m_optimizationEnvironmentHasBeenSet = true;
    m_optimizationEnvironment.emplace(std::forward<OptimizationEnvironmentKeyT>(key), std::forward<OptimizationEnvironmentValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeOptimizationJobResult& WithDeploymentInstanceType(OptimizationJobDeploymentInstanceType value) {
  ...
  void SetOptimizationConfigs(OptimizationConfigsT&& value) {
    ...
    m_optimizationConfigs = std::forward<OptimizationConfigsT>(value);
  }
  template <typename OptimizationConfigsT = Aws::Vector<OptimizationConfig>>
  DescribeOptimizationJobResult& WithOptimizationConfigs(OptimizationConfigsT&& value) {
    SetOptimizationConfigs(std::forward<OptimizationConfigsT>(value));
    return *this;
  }
  ...
  DescribeOptimizationJobResult& AddOptimizationConfigs(OptimizationConfigsT&& value) {
    m_optimizationConfigsHasBeenSet = true;
    m_optimizationConfigs.emplace_back(std::forward<OptimizationConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptimizationOutput(OptimizationOutputT&& value) {
    ...
    m_optimizationOutput = std::forward<OptimizationOutputT>(value);
  }
  template <typename OptimizationOutputT = OptimizationOutput>
  DescribeOptimizationJobResult& WithOptimizationOutput(OptimizationOutputT&& value) {
    SetOptimizationOutput(std::forward<OptimizationOutputT>(value));
    return *this;
  }
  ///@}
