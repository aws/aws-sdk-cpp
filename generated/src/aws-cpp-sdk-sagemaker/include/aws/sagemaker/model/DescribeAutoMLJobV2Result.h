...
class DescribeAutoMLJobV2Result {
 public:
  ...
  template <typename AutoMLJobNameT = Aws::String>
  DescribeAutoMLJobV2Result& WithAutoMLJobName(AutoMLJobNameT&& value) {
  ...
  template <typename AutoMLJobArnT = Aws::String>
  DescribeAutoMLJobV2Result& WithAutoMLJobArn(AutoMLJobArnT&& value) {
  ...
  void SetAutoMLJobInputDataConfig(AutoMLJobInputDataConfigT&& value) {
    m_autoMLJobInputDataConfigHasBeenSet = true;
    m_autoMLJobInputDataConfig = std::forward<AutoMLJobInputDataConfigT>(value);
  }
  template <typename AutoMLJobInputDataConfigT = Aws::Vector<AutoMLJobChannel>>
  DescribeAutoMLJobV2Result& WithAutoMLJobInputDataConfig(AutoMLJobInputDataConfigT&& value) {
    SetAutoMLJobInputDataConfig(std::forward<AutoMLJobInputDataConfigT>(value));
    return *this;
  }
  template <typename AutoMLJobInputDataConfigT = AutoMLJobChannel>
  DescribeAutoMLJobV2Result& AddAutoMLJobInputDataConfig(AutoMLJobInputDataConfigT&& value) {
    m_autoMLJobInputDataConfigHasBeenSet = true;
    m_autoMLJobInputDataConfig.emplace_back(std::forward<AutoMLJobInputDataConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OutputDataConfigT = AutoMLOutputDataConfig>
  DescribeAutoMLJobV2Result& WithOutputDataConfig(OutputDataConfigT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  DescribeAutoMLJobV2Result& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename AutoMLJobObjectiveT = AutoMLJobObjective>
  DescribeAutoMLJobV2Result& WithAutoMLJobObjective(AutoMLJobObjectiveT&& value) {
  ...
  void SetAutoMLProblemTypeConfig(AutoMLProblemTypeConfigT&& value) {
    m_autoMLProblemTypeConfigHasBeenSet = true;
    m_autoMLProblemTypeConfig = std::forward<AutoMLProblemTypeConfigT>(value);
  }
  template <typename AutoMLProblemTypeConfigT = AutoMLProblemTypeConfig>
  DescribeAutoMLJobV2Result& WithAutoMLProblemTypeConfig(AutoMLProblemTypeConfigT&& value) {
    SetAutoMLProblemTypeConfig(std::forward<AutoMLProblemTypeConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoMLProblemTypeConfigName(AutoMLProblemTypeConfigName value) {
    m_autoMLProblemTypeConfigNameHasBeenSet = true;
    m_autoMLProblemTypeConfigName = value;
  }
  inline DescribeAutoMLJobV2Result& WithAutoMLProblemTypeConfigName(AutoMLProblemTypeConfigName value) {
    SetAutoMLProblemTypeConfigName(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  DescribeAutoMLJobV2Result& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  DescribeAutoMLJobV2Result& WithEndTime(EndTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  DescribeAutoMLJobV2Result& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename FailureReasonT = Aws::String>
  DescribeAutoMLJobV2Result& WithFailureReason(FailureReasonT&& value) {
  ...
  template <typename PartialFailureReasonsT = Aws::Vector<AutoMLPartialFailureReason>>
  DescribeAutoMLJobV2Result& WithPartialFailureReasons(PartialFailureReasonsT&& value) {
  ...
  DescribeAutoMLJobV2Result& AddPartialFailureReasons(PartialFailureReasonsT&& value) {
    m_partialFailureReasonsHasBeenSet = true;
  ...
  void SetBestCandidate(BestCandidateT&& value) {
    ...
    m_bestCandidate = std::forward<BestCandidateT>(value);
  }
  template <typename BestCandidateT = AutoMLCandidate>
  DescribeAutoMLJobV2Result& WithBestCandidate(BestCandidateT&& value) {
    SetBestCandidate(std::forward<BestCandidateT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAutoMLJobV2Result& WithAutoMLJobStatus(AutoMLJobStatus value) {
  ...
  inline DescribeAutoMLJobV2Result& WithAutoMLJobSecondaryStatus(AutoMLJobSecondaryStatus value) {
  ...
  void SetAutoMLJobArtifacts(AutoMLJobArtifactsT&& value) {
    ...
    m_autoMLJobArtifacts = std::forward<AutoMLJobArtifactsT>(value);
  }
  template <typename AutoMLJobArtifactsT = AutoMLJobArtifacts>
  DescribeAutoMLJobV2Result& WithAutoMLJobArtifacts(AutoMLJobArtifactsT&& value) {
    SetAutoMLJobArtifacts(std::forward<AutoMLJobArtifactsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolvedAttributes(ResolvedAttributesT&& value) {
    ...
    m_resolvedAttributes = std::forward<ResolvedAttributesT>(value);
  }
  template <typename ResolvedAttributesT = AutoMLResolvedAttributes>
  DescribeAutoMLJobV2Result& WithResolvedAttributes(ResolvedAttributesT&& value) {
    SetResolvedAttributes(std::forward<ResolvedAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelDeployConfig(ModelDeployConfigT&& value) {
    ...
    m_modelDeployConfig = std::forward<ModelDeployConfigT>(value);
  }
  template <typename ModelDeployConfigT = ModelDeployConfig>
  DescribeAutoMLJobV2Result& WithModelDeployConfig(ModelDeployConfigT&& value) {
    SetModelDeployConfig(std::forward<ModelDeployConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelDeployResult(ModelDeployResultT&& value) {
    ...
    m_modelDeployResult = std::forward<ModelDeployResultT>(value);
  }
  template <typename ModelDeployResultT = ModelDeployResult>
  DescribeAutoMLJobV2Result& WithModelDeployResult(ModelDeployResultT&& value) {
    SetModelDeployResult(std::forward<ModelDeployResultT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DataSplitConfigT = AutoMLDataSplitConfig>
  DescribeAutoMLJobV2Result& WithDataSplitConfig(DataSplitConfigT&& value) {
  ...
  template <typename SecurityConfigT = AutoMLSecurityConfig>
  DescribeAutoMLJobV2Result& WithSecurityConfig(SecurityConfigT&& value) {
  ...
  void SetAutoMLComputeConfig(AutoMLComputeConfigT&& value) {
    m_autoMLComputeConfigHasBeenSet = true;
    m_autoMLComputeConfig = std::forward<AutoMLComputeConfigT>(value);
  }
  template <typename AutoMLComputeConfigT = AutoMLComputeConfig>
  DescribeAutoMLJobV2Result& WithAutoMLComputeConfig(AutoMLComputeConfigT&& value) {
    SetAutoMLComputeConfig(std::forward<AutoMLComputeConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAutoMLJobV2Result& WithRequestId(RequestIdT&& value) {
