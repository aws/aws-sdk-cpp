...
class LabelCounters {
 public:
  ...
  inline void SetTotalLabeled(int value) {
    m_totalLabeledHasBeenSet = true;
    m_totalLabeled = value;
  }
  inline LabelCounters& WithTotalLabeled(int value) {
    SetTotalLabeled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHumanLabeled(int value) {
    m_humanLabeledHasBeenSet = true;
    m_humanLabeled = value;
  }
  inline LabelCounters& WithHumanLabeled(int value) {
    SetHumanLabeled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMachineLabeled(int value) {
    m_machineLabeledHasBeenSet = true;
    m_machineLabeled = value;
  }
  inline LabelCounters& WithMachineLabeled(int value) {
    SetMachineLabeled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFailedNonRetryableError(int value) {
    m_failedNonRetryableErrorHasBeenSet = true;
    m_failedNonRetryableError = value;
  }
  inline LabelCounters& WithFailedNonRetryableError(int value) {
    SetFailedNonRetryableError(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnlabeled(int value) {
    m_unlabeledHasBeenSet = true;
    m_unlabeled = value;
  }
  inline LabelCounters& WithUnlabeled(int value) {
    SetUnlabeled(value);
    return *this;
  }
  ///@}
