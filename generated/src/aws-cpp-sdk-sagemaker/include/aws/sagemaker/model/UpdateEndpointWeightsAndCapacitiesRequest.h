...
class UpdateEndpointWeightsAndCapacitiesRequest : public SageMakerRequest {
 public:
  ...
  void SetDesiredWeightsAndCapacities(DesiredWeightsAndCapacitiesT&& value) {
    m_desiredWeightsAndCapacitiesHasBeenSet = true;
    m_desiredWeightsAndCapacities = std::forward<DesiredWeightsAndCapacitiesT>(value);
  }
  template <typename DesiredWeightsAndCapacitiesT = Aws::Vector<DesiredWeightAndCapacity>>
  UpdateEndpointWeightsAndCapacitiesRequest& WithDesiredWeightsAndCapacities(DesiredWeightsAndCapacitiesT&& value) {
    SetDesiredWeightsAndCapacities(std::forward<DesiredWeightsAndCapacitiesT>(value));
    return *this;
  }
  ...
  UpdateEndpointWeightsAndCapacitiesRequest& AddDesiredWeightsAndCapacities(DesiredWeightsAndCapacitiesT&& value) {
    m_desiredWeightsAndCapacitiesHasBeenSet = true;
    m_desiredWeightsAndCapacities.emplace_back(std::forward<DesiredWeightsAndCapacitiesT>(value));
    return *this;
  }
  ///@}
 private:
