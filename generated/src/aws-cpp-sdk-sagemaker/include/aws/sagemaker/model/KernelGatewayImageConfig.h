...
class KernelGatewayImageConfig {
 public:
  ...
  void SetFileSystemConfig(FileSystemConfigT&& value) {
    ...
    m_fileSystemConfig = std::forward<FileSystemConfigT>(value);
  }
  template <typename FileSystemConfigT = FileSystemConfig>
  KernelGatewayImageConfig& WithFileSystemConfig(FileSystemConfigT&& value) {
    SetFileSystemConfig(std::forward<FileSystemConfigT>(value));
    return *this;
  }
  ///@}
 private:
