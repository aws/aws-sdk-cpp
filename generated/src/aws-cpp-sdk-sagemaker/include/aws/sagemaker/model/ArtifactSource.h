...
class ArtifactSource {
 public:
  ...
  template <typename SourceUriT = Aws::String>
  ArtifactSource& WithSourceUri(SourceUriT&& value) {
  ...
  void SetSourceTypes(SourceTypesT&& value) {
    m_sourceTypesHasBeenSet = true;
    m_sourceTypes = std::forward<SourceTypesT>(value);
  }
  template <typename SourceTypesT = Aws::Vector<ArtifactSourceType>>
  ArtifactSource& WithSourceTypes(SourceTypesT&& value) {
    SetSourceTypes(std::forward<SourceTypesT>(value));
    return *this;
  }
  template <typename SourceTypesT = ArtifactSourceType>
  ArtifactSource& AddSourceTypes(SourceTypesT&& value) {
    m_sourceTypesHasBeenSet = true;
    m_sourceTypes.emplace_back(std::forward<SourceTypesT>(value));
    return *this;
  }
  ///@}
 private:
