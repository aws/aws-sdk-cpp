...
class ProcessingS3Output {
 public:
  ...
  template <typename S3UriT = Aws::String>
  ProcessingS3Output& WithS3Uri(S3UriT&& value) {
  ...
  template <typename LocalPathT = Aws::String>
  ProcessingS3Output& WithLocalPath(LocalPathT&& value) {
  ...
  inline void SetS3UploadMode(ProcessingS3UploadMode value) {
    m_s3UploadModeHasBeenSet = true;
    m_s3UploadMode = value;
  }
  inline ProcessingS3Output& WithS3UploadMode(ProcessingS3UploadMode value) {
    SetS3UploadMode(value);
    return *this;
  }
  ///@}
 private:
