...
class SharingSettings {
 public:
  ...
  inline void SetNotebookOutputOption(NotebookOutputOption value) {
    m_notebookOutputOptionHasBeenSet = true;
    m_notebookOutputOption = value;
  }
  inline SharingSettings& WithNotebookOutputOption(NotebookOutputOption value) {
    SetNotebookOutputOption(value);
    return *this;
  }
  ///@}
  ...
  void SetS3KmsKeyId(S3KmsKeyIdT&& value) {
    ...
    m_s3KmsKeyId = std::forward<S3KmsKeyIdT>(value);
  }
  template <typename S3KmsKeyIdT = Aws::String>
  SharingSettings& WithS3KmsKeyId(S3KmsKeyIdT&& value) {
    SetS3KmsKeyId(std::forward<S3KmsKeyIdT>(value));
    return *this;
  }
  ///@}
 private:
