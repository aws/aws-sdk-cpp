...
class SchedulerConfig {
 public:
  ...
  void SetPriorityClasses(PriorityClassesT&& value) {
    ...
    m_priorityClasses = std::forward<PriorityClassesT>(value);
  }
  template <typename PriorityClassesT = Aws::Vector<PriorityClass>>
  SchedulerConfig& WithPriorityClasses(PriorityClassesT&& value) {
    SetPriorityClasses(std::forward<PriorityClassesT>(value));
    return *this;
  }
  template <typename PriorityClassesT = PriorityClass>
  SchedulerConfig& AddPriorityClasses(PriorityClassesT&& value) {
    m_priorityClassesHasBeenSet = true;
    m_priorityClasses.emplace_back(std::forward<PriorityClassesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFairShare(FairShare value) {
    m_fairShareHasBeenSet = true;
    m_fairShare = value;
  }
  inline SchedulerConfig& WithFairShare(FairShare value) {
    SetFairShare(value);
    return *this;
  }
  ///@}
