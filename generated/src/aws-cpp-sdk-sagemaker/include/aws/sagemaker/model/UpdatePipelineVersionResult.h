...
class UpdatePipelineVersionResult {
 public:
  ...
  template <typename PipelineArnT = Aws::String>
  UpdatePipelineVersionResult& WithPipelineArn(PipelineArnT&& value) {
  ...
  inline UpdatePipelineVersionResult& WithPipelineVersionId(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePipelineVersionResult& WithRequestId(RequestIdT&& value) {
