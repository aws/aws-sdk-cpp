...
class CreateNotebookInstanceLifecycleConfigRequest : public SageMakerRequest {
 public:
  ...
  void SetOnCreate(OnCreateT&& value) {
    ...
    m_onCreate = std::forward<OnCreateT>(value);
  }
  template <typename OnCreateT = Aws::Vector<NotebookInstanceLifecycleHook>>
  CreateNotebookInstanceLifecycleConfigRequest& WithOnCreate(OnCreateT&& value) {
    SetOnCreate(std::forward<OnCreateT>(value));
    return *this;
  }
  ...
  CreateNotebookInstanceLifecycleConfigRequest& AddOnCreate(OnCreateT&& value) {
    m_onCreateHasBeenSet = true;
    m_onCreate.emplace_back(std::forward<OnCreateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnStart(OnStartT&& value) {
    ...
    m_onStart = std::forward<OnStartT>(value);
  }
  template <typename OnStartT = Aws::Vector<NotebookInstanceLifecycleHook>>
  CreateNotebookInstanceLifecycleConfigRequest& WithOnStart(OnStartT&& value) {
    SetOnStart(std::forward<OnStartT>(value));
    return *this;
  }
  ...
  CreateNotebookInstanceLifecycleConfigRequest& AddOnStart(OnStartT&& value) {
    m_onStartHasBeenSet = true;
    m_onStart.emplace_back(std::forward<OnStartT>(value));
    return *this;
  }
  ///@}
