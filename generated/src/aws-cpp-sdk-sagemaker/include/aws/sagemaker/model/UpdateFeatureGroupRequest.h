...
class UpdateFeatureGroupRequest : public SageMakerRequest {
 public:
  ...
  void SetFeatureAdditions(FeatureAdditionsT&& value) {
    m_featureAdditionsHasBeenSet = true;
    m_featureAdditions = std::forward<FeatureAdditionsT>(value);
  }
  template <typename FeatureAdditionsT = Aws::Vector<FeatureDefinition>>
  UpdateFeatureGroupRequest& WithFeatureAdditions(FeatureAdditionsT&& value) {
    SetFeatureAdditions(std::forward<FeatureAdditionsT>(value));
    return *this;
  }
  ...
  UpdateFeatureGroupRequest& AddFeatureAdditions(FeatureAdditionsT&& value) {
    m_featureAdditionsHasBeenSet = true;
    m_featureAdditions.emplace_back(std::forward<FeatureAdditionsT>(value));
    return *this;
  }
  ///@}
