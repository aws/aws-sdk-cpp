...
class SpaceSettingsSummary {
 public:
  ...
  inline SpaceSettingsSummary& WithAppType(AppType value) {
    SetAppType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRemoteAccess(FeatureStatus value) {
    m_remoteAccessHasBeenSet = true;
    m_remoteAccess = value;
  }
  inline SpaceSettingsSummary& WithRemoteAccess(FeatureStatus value) {
