...
class ListLabelingJobsRequest : public SageMakerRequest {
 public:
  ...
  inline ListLabelingJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListLabelingJobsRequest& WithSortBy(SortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListLabelingJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusEquals(LabelingJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListLabelingJobsRequest& WithStatusEquals(LabelingJobStatus value) {
