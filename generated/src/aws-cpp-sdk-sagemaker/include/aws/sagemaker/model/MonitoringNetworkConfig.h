...
class MonitoringNetworkConfig {
 public:
  ...
  inline MonitoringNetworkConfig& WithEnableInterContainerTrafficEncryption(bool value) {
  ...
  inline MonitoringNetworkConfig& WithEnableNetworkIsolation(bool value) {
