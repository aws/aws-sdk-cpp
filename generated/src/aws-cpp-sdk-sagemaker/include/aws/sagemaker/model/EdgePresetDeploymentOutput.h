...
class EdgePresetDeploymentOutput {
 public:
  ...
  inline void SetType(EdgePresetDeploymentType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline EdgePresetDeploymentOutput& WithType(EdgePresetDeploymentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ArtifactT = Aws::String>
  EdgePresetDeploymentOutput& WithArtifact(ArtifactT&& value) {
  ...
  inline void SetStatus(EdgePresetDeploymentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline EdgePresetDeploymentOutput& WithStatus(EdgePresetDeploymentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  EdgePresetDeploymentOutput& WithStatusMessage(StatusMessageT&& value) {
