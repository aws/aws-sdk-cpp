...
class ParameterRange {
 public:
   ...
   */
  inline const IntegerParameterRangeSpecification& GetIntegerParameterRangeSpecification() const {
    return m_integerParameterRangeSpecification;
  }
  ...
  void SetIntegerParameterRangeSpecification(IntegerParameterRangeSpecificationT&& value) {
    ...
    m_integerParameterRangeSpecification = std::forward<IntegerParameterRangeSpecificationT>(value);
  }
  template <typename IntegerParameterRangeSpecificationT = IntegerParameterRangeSpecification>
  ParameterRange& WithIntegerParameterRangeSpecification(IntegerParameterRangeSpecificationT&& value) {
    SetIntegerParameterRangeSpecification(std::forward<IntegerParameterRangeSpecificationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ContinuousParameterRangeSpecification& GetContinuousParameterRangeSpecification() const {
    return m_continuousParameterRangeSpecification;
  }
  ...
  void SetContinuousParameterRangeSpecification(ContinuousParameterRangeSpecificationT&& value) {
    ...
    m_continuousParameterRangeSpecification = std::forward<ContinuousParameterRangeSpecificationT>(value);
  }
  template <typename ContinuousParameterRangeSpecificationT = ContinuousParameterRangeSpecification>
  ParameterRange& WithContinuousParameterRangeSpecification(ContinuousParameterRangeSpecificationT&& value) {
    SetContinuousParameterRangeSpecification(std::forward<ContinuousParameterRangeSpecificationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const CategoricalParameterRangeSpecification& GetCategoricalParameterRangeSpecification() const {
    return m_categoricalParameterRangeSpecification;
  }
  ...
  void SetCategoricalParameterRangeSpecification(CategoricalParameterRangeSpecificationT&& value) {
    ...
    m_categoricalParameterRangeSpecification = std::forward<CategoricalParameterRangeSpecificationT>(value);
  }
  template <typename CategoricalParameterRangeSpecificationT = CategoricalParameterRangeSpecification>
  ParameterRange& WithCategoricalParameterRangeSpecification(CategoricalParameterRangeSpecificationT&& value) {
    SetCategoricalParameterRangeSpecification(std::forward<CategoricalParameterRangeSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
