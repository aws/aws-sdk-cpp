...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API FeatureParameter() = default;
    ...
    template<typename KeyT = Aws::String>
    FeatureParameter& WithKey(KeyT&& value) { SetKey(std::forward<KeyT>(value)); return *this;}
    ///@}
    ...
    template<typename ValueT = Aws::String>
    FeatureParameter& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
