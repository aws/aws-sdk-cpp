...
class CandidateArtifactLocations {
 public:
  ...
  void SetModelInsights(ModelInsightsT&& value) {
    ...
    m_modelInsights = std::forward<ModelInsightsT>(value);
  }
  template <typename ModelInsightsT = Aws::String>
  CandidateArtifactLocations& WithModelInsights(ModelInsightsT&& value) {
    SetModelInsights(std::forward<ModelInsightsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBacktestResults(BacktestResultsT&& value) {
    ...
    m_backtestResults = std::forward<BacktestResultsT>(value);
  }
  template <typename BacktestResultsT = Aws::String>
  CandidateArtifactLocations& WithBacktestResults(BacktestResultsT&& value) {
    SetBacktestResults(std::forward<BacktestResultsT>(value));
    return *this;
  }
  ///@}
 private:
