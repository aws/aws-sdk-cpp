...
class AdditionalS3DataSource {
 public:
  ...
  inline void SetS3DataType(AdditionalS3DataSourceDataType value) {
    m_s3DataTypeHasBeenSet = true;
    m_s3DataType = value;
  }
  inline AdditionalS3DataSource& WithS3DataType(AdditionalS3DataSourceDataType value) {
    SetS3DataType(value);
    return *this;
  }
  ///@}
  ...
  inline AdditionalS3DataSource& WithCompressionType(CompressionType value) {
