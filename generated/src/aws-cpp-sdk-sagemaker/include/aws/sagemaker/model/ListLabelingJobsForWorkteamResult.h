...
class ListLabelingJobsForWorkteamResult {
 public:
  ...
  template <typename LabelingJobSummaryListT = Aws::Vector<LabelingJobForWorkteamSummary>>
  ListLabelingJobsForWorkteamResult& WithLabelingJobSummaryList(LabelingJobSummaryListT&& value) {
  ...
  ListLabelingJobsForWorkteamResult& AddLabelingJobSummaryList(LabelingJobSummaryListT&& value) {
    m_labelingJobSummaryListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLabelingJobsForWorkteamResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLabelingJobsForWorkteamResult& WithRequestId(RequestIdT&& value) {
