...
class InferenceComponentComputeResourceRequirements {
 public:
  ...
  inline void SetNumberOfCpuCoresRequired(double value) {
    m_numberOfCpuCoresRequiredHasBeenSet = true;
    m_numberOfCpuCoresRequired = value;
  }
  inline InferenceComponentComputeResourceRequirements& WithNumberOfCpuCoresRequired(double value) {
    SetNumberOfCpuCoresRequired(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfAcceleratorDevicesRequired(double value) {
    m_numberOfAcceleratorDevicesRequiredHasBeenSet = true;
    m_numberOfAcceleratorDevicesRequired = value;
  }
  inline InferenceComponentComputeResourceRequirements& WithNumberOfAcceleratorDevicesRequired(double value) {
    SetNumberOfAcceleratorDevicesRequired(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinMemoryRequiredInMb(int value) {
    m_minMemoryRequiredInMbHasBeenSet = true;
    m_minMemoryRequiredInMb = value;
  }
  inline InferenceComponentComputeResourceRequirements& WithMinMemoryRequiredInMb(int value) {
    SetMinMemoryRequiredInMb(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxMemoryRequiredInMb(int value) {
    m_maxMemoryRequiredInMbHasBeenSet = true;
    m_maxMemoryRequiredInMb = value;
  }
  inline InferenceComponentComputeResourceRequirements& WithMaxMemoryRequiredInMb(int value) {
    SetMaxMemoryRequiredInMb(value);
    return *this;
  }
  ///@}
 private:
