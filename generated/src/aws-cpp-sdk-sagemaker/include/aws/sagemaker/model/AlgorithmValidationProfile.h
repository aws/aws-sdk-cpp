...
class AlgorithmValidationProfile {
 public:
  ...
  template <typename ProfileNameT = Aws::String>
  AlgorithmValidationProfile& WithProfileName(ProfileNameT&& value) {
  ...
  template <typename TrainingJobDefinitionT = TrainingJobDefinition>
  AlgorithmValidationProfile& WithTrainingJobDefinition(TrainingJobDefinitionT&& value) {
  ...
  void SetTransformJobDefinition(TransformJobDefinitionT&& value) {
    m_transformJobDefinitionHasBeenSet = true;
    m_transformJobDefinition = std::forward<TransformJobDefinitionT>(value);
  }
  template <typename TransformJobDefinitionT = TransformJobDefinition>
  AlgorithmValidationProfile& WithTransformJobDefinition(TransformJobDefinitionT&& value) {
    SetTransformJobDefinition(std::forward<TransformJobDefinitionT>(value));
    return *this;
  }
  ///@}
 private:
