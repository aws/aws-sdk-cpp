...
class ListAutoMLJobsResult {
 public:
  ...
  void SetAutoMLJobSummaries(AutoMLJobSummariesT&& value) {
    m_autoMLJobSummariesHasBeenSet = true;
    m_autoMLJobSummaries = std::forward<AutoMLJobSummariesT>(value);
  }
  template <typename AutoMLJobSummariesT = Aws::Vector<AutoMLJobSummary>>
  ListAutoMLJobsResult& WithAutoMLJobSummaries(AutoMLJobSummariesT&& value) {
    SetAutoMLJobSummaries(std::forward<AutoMLJobSummariesT>(value));
    return *this;
  }
  template <typename AutoMLJobSummariesT = AutoMLJobSummary>
  ListAutoMLJobsResult& AddAutoMLJobSummaries(AutoMLJobSummariesT&& value) {
    m_autoMLJobSummariesHasBeenSet = true;
    m_autoMLJobSummaries.emplace_back(std::forward<AutoMLJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAutoMLJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAutoMLJobsResult& WithRequestId(RequestIdT&& value) {
