...
class DescribeModelPackageResult {
 public:
  ...
  inline DescribeModelPackageResult& WithModelPackageVersion(int value) {
  ...
  inline DescribeModelPackageResult& WithModelPackageRegistrationType(ModelPackageRegistrationType value) {
  ...
  inline DescribeModelPackageResult& WithModelPackageStatus(ModelPackageStatus value) {
  ...
  inline DescribeModelPackageResult& WithCertifyForMarketplace(bool value) {
  ...
  inline DescribeModelPackageResult& WithModelApprovalStatus(ModelApprovalStatus value) {
  ...
  DescribeModelPackageResult& AddCustomerMetadataProperties(CustomerMetadataPropertiesKeyT&& key,
                                                            CustomerMetadataPropertiesValueT&& value) {
    m_customerMetadataPropertiesHasBeenSet = true;
  ...
  inline DescribeModelPackageResult& WithSkipModelValidation(SkipModelValidation value) {
