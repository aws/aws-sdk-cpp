...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API UpdateClusterResult() = default;
    ...
    template<typename ClusterArnT = Aws::String>
    UpdateClusterResult& WithClusterArn(ClusterArnT&& value) { SetClusterArn(std::forward<ClusterArnT>(value)); return *this;}
    ///@}
