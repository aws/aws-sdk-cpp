...
class ListModelExplainabilityJobDefinitionsResult {
 public:
  AWS_SAGEMAKER_API ListModelExplainabilityJobDefinitionsResult() = default;
  ...
  AWS_SAGEMAKER_API ListModelExplainabilityJobDefinitionsResult& operator=(
  ...
  void SetJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    m_jobDefinitionSummariesHasBeenSet = true;
    m_jobDefinitionSummaries = std::forward<JobDefinitionSummariesT>(value);
  }
  template <typename JobDefinitionSummariesT = Aws::Vector<MonitoringJobDefinitionSummary>>
  ListModelExplainabilityJobDefinitionsResult& WithJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    SetJobDefinitionSummaries(std::forward<JobDefinitionSummariesT>(value));
    return *this;
  }
  template <typename JobDefinitionSummariesT = MonitoringJobDefinitionSummary>
  ListModelExplainabilityJobDefinitionsResult& AddJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    m_jobDefinitionSummariesHasBeenSet = true;
    m_jobDefinitionSummaries.emplace_back(std::forward<JobDefinitionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelExplainabilityJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelExplainabilityJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
