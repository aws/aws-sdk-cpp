...
namespace Model
{
  ...
  public:
    ...
    template<typename JobDefinitionSummariesT = Aws::Vector<MonitoringJobDefinitionSummary>>
    ListModelExplainabilityJobDefinitionsResult& WithJobDefinitionSummaries(JobDefinitionSummariesT&& value) { SetJobDefinitionSummaries(std::forward<JobDefinitionSummariesT>(value)); return *this;}
    template<typename JobDefinitionSummariesT = MonitoringJobDefinitionSummary>
    ListModelExplainabilityJobDefinitionsResult& AddJobDefinitionSummaries(JobDefinitionSummariesT&& value) { m_jobDefinitionSummariesHasBeenSet = true; m_jobDefinitionSummaries.emplace_back(std::forward<JobDefinitionSummariesT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListModelExplainabilityJobDefinitionsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListModelExplainabilityJobDefinitionsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
