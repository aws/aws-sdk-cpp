...
namespace SageMaker {
namespace Model {
class StopAIRecommendationJobResult {
 public:
  AWS_SAGEMAKER_API StopAIRecommendationJobResult() = default;
  AWS_SAGEMAKER_API StopAIRecommendationJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SAGEMAKER_API StopAIRecommendationJobResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AIRecommendationJobArnT = Aws::String>
  StopAIRecommendationJobResult& WithAIRecommendationJobArn(AIRecommendationJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopAIRecommendationJobResult& WithRequestId(RequestIdT&& value) {
