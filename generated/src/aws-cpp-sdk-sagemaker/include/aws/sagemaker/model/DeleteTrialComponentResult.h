...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteTrialComponentResult() = default;
    ...
    template<typename TrialComponentArnT = Aws::String>
    DeleteTrialComponentResult& WithTrialComponentArn(TrialComponentArnT&& value) { SetTrialComponentArn(std::forward<TrialComponentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteTrialComponentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
