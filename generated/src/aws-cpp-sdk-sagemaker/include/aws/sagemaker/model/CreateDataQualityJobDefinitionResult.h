...
class CreateDataQualityJobDefinitionResult {
 public:
  AWS_SAGEMAKER_API CreateDataQualityJobDefinitionResult() = default;
  ...
  template <typename JobDefinitionArnT = Aws::String>
  CreateDataQualityJobDefinitionResult& WithJobDefinitionArn(JobDefinitionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateDataQualityJobDefinitionResult& WithRequestId(RequestIdT&& value) {
