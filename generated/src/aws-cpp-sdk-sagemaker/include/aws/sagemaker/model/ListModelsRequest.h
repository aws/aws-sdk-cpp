...
class ListModelsRequest : public SageMakerRequest {
 public:
   ...
   */
  inline ModelSortKey GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(ModelSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListModelsRequest& WithSortBy(ModelSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelsRequest& WithSortOrder(OrderKey value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  ///@}
 private:
  ModelSortKey m_sortBy{ModelSortKey::NOT_SET};
