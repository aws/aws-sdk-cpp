...
class UpdateEndpointRequest : public SageMakerRequest {
 public:
  ...
  inline void SetRetainAllVariantProperties(bool value) {
    m_retainAllVariantPropertiesHasBeenSet = true;
    m_retainAllVariantProperties = value;
  }
  inline UpdateEndpointRequest& WithRetainAllVariantProperties(bool value) {
    SetRetainAllVariantProperties(value);
    return *this;
  }
  ///@}
  ...
  void SetExcludeRetainedVariantProperties(ExcludeRetainedVariantPropertiesT&& value) {
    m_excludeRetainedVariantPropertiesHasBeenSet = true;
    m_excludeRetainedVariantProperties = std::forward<ExcludeRetainedVariantPropertiesT>(value);
  }
  template <typename ExcludeRetainedVariantPropertiesT = Aws::Vector<VariantProperty>>
  UpdateEndpointRequest& WithExcludeRetainedVariantProperties(ExcludeRetainedVariantPropertiesT&& value) {
    SetExcludeRetainedVariantProperties(std::forward<ExcludeRetainedVariantPropertiesT>(value));
    return *this;
  }
  ...
  UpdateEndpointRequest& AddExcludeRetainedVariantProperties(ExcludeRetainedVariantPropertiesT&& value) {
    m_excludeRetainedVariantPropertiesHasBeenSet = true;
    m_excludeRetainedVariantProperties.emplace_back(std::forward<ExcludeRetainedVariantPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRetainDeploymentConfig(bool value) {
    m_retainDeploymentConfigHasBeenSet = true;
    m_retainDeploymentConfig = value;
  }
  inline UpdateEndpointRequest& WithRetainDeploymentConfig(bool value) {
    SetRetainDeploymentConfig(value);
    return *this;
  }
  ///@}
 private:
