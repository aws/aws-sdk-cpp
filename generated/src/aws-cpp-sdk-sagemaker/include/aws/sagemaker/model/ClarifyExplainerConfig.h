...
class ClarifyExplainerConfig {
 public:
  ...
  void SetEnableExplanations(EnableExplanationsT&& value) {
    ...
    m_enableExplanations = std::forward<EnableExplanationsT>(value);
  }
  template <typename EnableExplanationsT = Aws::String>
  ClarifyExplainerConfig& WithEnableExplanations(EnableExplanationsT&& value) {
    SetEnableExplanations(std::forward<EnableExplanationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShapConfig(ShapConfigT&& value) {
    ...
    m_shapConfig = std::forward<ShapConfigT>(value);
  }
  template <typename ShapConfigT = ClarifyShapConfig>
  ClarifyExplainerConfig& WithShapConfig(ShapConfigT&& value) {
    SetShapConfig(std::forward<ShapConfigT>(value));
    return *this;
  }
  ///@}
 private:
