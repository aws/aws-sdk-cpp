...
class EdgePackagingJobSummary {
 public:
  ...
  void SetEdgePackagingJobArn(EdgePackagingJobArnT&& value) {
    ...
    m_edgePackagingJobArn = std::forward<EdgePackagingJobArnT>(value);
  }
  template <typename EdgePackagingJobArnT = Aws::String>
  EdgePackagingJobSummary& WithEdgePackagingJobArn(EdgePackagingJobArnT&& value) {
    SetEdgePackagingJobArn(std::forward<EdgePackagingJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEdgePackagingJobStatus(EdgePackagingJobStatus value) {
    m_edgePackagingJobStatusHasBeenSet = true;
    m_edgePackagingJobStatus = value;
  }
  inline EdgePackagingJobSummary& WithEdgePackagingJobStatus(EdgePackagingJobStatus value) {
    SetEdgePackagingJobStatus(value);
    return *this;
  }
  ///@}
