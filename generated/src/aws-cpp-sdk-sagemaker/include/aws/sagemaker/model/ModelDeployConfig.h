...
class ModelDeployConfig {
 public:
  ...
  inline void SetAutoGenerateEndpointName(bool value) {
    m_autoGenerateEndpointNameHasBeenSet = true;
    m_autoGenerateEndpointName = value;
  }
  inline ModelDeployConfig& WithAutoGenerateEndpointName(bool value) {
    SetAutoGenerateEndpointName(value);
    return *this;
  }
  ///@}
  ...
  template <typename EndpointNameT = Aws::String>
  ModelDeployConfig& WithEndpointName(EndpointNameT&& value) {
