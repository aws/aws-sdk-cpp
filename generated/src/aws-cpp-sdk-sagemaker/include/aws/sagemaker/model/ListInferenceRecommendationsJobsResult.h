...
class ListInferenceRecommendationsJobsResult {
 public:
  ...
  AWS_SAGEMAKER_API ListInferenceRecommendationsJobsResult& operator=(
  ...
  void SetInferenceRecommendationsJobs(InferenceRecommendationsJobsT&& value) {
    m_inferenceRecommendationsJobsHasBeenSet = true;
    m_inferenceRecommendationsJobs = std::forward<InferenceRecommendationsJobsT>(value);
  }
  template <typename InferenceRecommendationsJobsT = Aws::Vector<InferenceRecommendationsJob>>
  ListInferenceRecommendationsJobsResult& WithInferenceRecommendationsJobs(InferenceRecommendationsJobsT&& value) {
    SetInferenceRecommendationsJobs(std::forward<InferenceRecommendationsJobsT>(value));
    return *this;
  }
  template <typename InferenceRecommendationsJobsT = InferenceRecommendationsJob>
  ListInferenceRecommendationsJobsResult& AddInferenceRecommendationsJobs(InferenceRecommendationsJobsT&& value) {
    m_inferenceRecommendationsJobsHasBeenSet = true;
    m_inferenceRecommendationsJobs.emplace_back(std::forward<InferenceRecommendationsJobsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceRecommendationsJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceRecommendationsJobsResult& WithRequestId(RequestIdT&& value) {
