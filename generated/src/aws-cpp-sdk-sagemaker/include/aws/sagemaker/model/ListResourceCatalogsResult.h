...
class ListResourceCatalogsResult {
 public:
  ...
  void SetResourceCatalogs(ResourceCatalogsT&& value) {
    m_resourceCatalogsHasBeenSet = true;
    m_resourceCatalogs = std::forward<ResourceCatalogsT>(value);
  }
  template <typename ResourceCatalogsT = Aws::Vector<ResourceCatalog>>
  ListResourceCatalogsResult& WithResourceCatalogs(ResourceCatalogsT&& value) {
    SetResourceCatalogs(std::forward<ResourceCatalogsT>(value));
    return *this;
  }
  template <typename ResourceCatalogsT = ResourceCatalog>
  ListResourceCatalogsResult& AddResourceCatalogs(ResourceCatalogsT&& value) {
    m_resourceCatalogsHasBeenSet = true;
    m_resourceCatalogs.emplace_back(std::forward<ResourceCatalogsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceCatalogsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListResourceCatalogsResult& WithRequestId(RequestIdT&& value) {
