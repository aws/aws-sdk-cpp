...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API CreateModelBiasJobDefinitionResult() = default;
    ...
    template<typename JobDefinitionArnT = Aws::String>
    CreateModelBiasJobDefinitionResult& WithJobDefinitionArn(JobDefinitionArnT&& value) { SetJobDefinitionArn(std::forward<JobDefinitionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateModelBiasJobDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
