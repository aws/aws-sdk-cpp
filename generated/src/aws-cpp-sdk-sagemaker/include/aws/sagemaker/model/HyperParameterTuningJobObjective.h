...
class HyperParameterTuningJobObjective {
 public:
  ...
  inline void SetType(HyperParameterTuningJobObjectiveType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline HyperParameterTuningJobObjective& WithType(HyperParameterTuningJobObjectiveType value) {
    SetType(value);
    return *this;
  }
  ///@}
