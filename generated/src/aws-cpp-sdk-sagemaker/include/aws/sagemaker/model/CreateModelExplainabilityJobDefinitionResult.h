...
class CreateModelExplainabilityJobDefinitionResult {
 public:
  ...
  AWS_SAGEMAKER_API CreateModelExplainabilityJobDefinitionResult& operator=(
  ...
  template <typename JobDefinitionArnT = Aws::String>
  CreateModelExplainabilityJobDefinitionResult& WithJobDefinitionArn(JobDefinitionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateModelExplainabilityJobDefinitionResult& WithRequestId(RequestIdT&& value) {
