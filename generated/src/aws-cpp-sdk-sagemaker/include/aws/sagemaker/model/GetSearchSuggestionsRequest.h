...
class GetSearchSuggestionsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetResource(ResourceType value) {
    m_resourceHasBeenSet = true;
    m_resource = value;
  }
  inline GetSearchSuggestionsRequest& WithResource(ResourceType value) {
    SetResource(value);
    return *this;
  }
  ///@}
  ...
  void SetSuggestionQuery(SuggestionQueryT&& value) {
    m_suggestionQueryHasBeenSet = true;
    m_suggestionQuery = std::forward<SuggestionQueryT>(value);
  }
  template <typename SuggestionQueryT = SuggestionQuery>
  GetSearchSuggestionsRequest& WithSuggestionQuery(SuggestionQueryT&& value) {
    SetSuggestionQuery(std::forward<SuggestionQueryT>(value));
    return *this;
  }
  ///@}
 private:
