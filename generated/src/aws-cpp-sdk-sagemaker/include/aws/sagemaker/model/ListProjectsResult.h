...
class ListProjectsResult {
 public:
  ...
  void SetProjectSummaryList(ProjectSummaryListT&& value) {
    m_projectSummaryListHasBeenSet = true;
    m_projectSummaryList = std::forward<ProjectSummaryListT>(value);
  }
  template <typename ProjectSummaryListT = Aws::Vector<ProjectSummary>>
  ListProjectsResult& WithProjectSummaryList(ProjectSummaryListT&& value) {
    SetProjectSummaryList(std::forward<ProjectSummaryListT>(value));
    return *this;
  }
  template <typename ProjectSummaryListT = ProjectSummary>
  ListProjectsResult& AddProjectSummaryList(ProjectSummaryListT&& value) {
    m_projectSummaryListHasBeenSet = true;
    m_projectSummaryList.emplace_back(std::forward<ProjectSummaryListT>(value));
    return *this;
  }
  ///@}
