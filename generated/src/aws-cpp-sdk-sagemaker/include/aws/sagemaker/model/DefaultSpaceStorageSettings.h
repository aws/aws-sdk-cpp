...
class DefaultSpaceStorageSettings {
 public:
  ...
  void SetDefaultEbsStorageSettings(DefaultEbsStorageSettingsT&& value) {
    m_defaultEbsStorageSettingsHasBeenSet = true;
    m_defaultEbsStorageSettings = std::forward<DefaultEbsStorageSettingsT>(value);
  }
  template <typename DefaultEbsStorageSettingsT = DefaultEbsStorageSettings>
  DefaultSpaceStorageSettings& WithDefaultEbsStorageSettings(DefaultEbsStorageSettingsT&& value) {
    SetDefaultEbsStorageSettings(std::forward<DefaultEbsStorageSettingsT>(value));
    return *this;
  }
  ///@}
 private:
