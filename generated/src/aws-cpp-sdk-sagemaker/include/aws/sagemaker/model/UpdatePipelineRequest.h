...
class UpdatePipelineRequest : public SageMakerRequest {
 public:
  ...
  template <typename PipelineDisplayNameT = Aws::String>
  UpdatePipelineRequest& WithPipelineDisplayName(PipelineDisplayNameT&& value) {
  ...
  template <typename PipelineDefinitionT = Aws::String>
  UpdatePipelineRequest& WithPipelineDefinition(PipelineDefinitionT&& value) {
  ...
  template <typename PipelineDefinitionS3LocationT = PipelineDefinitionS3Location>
  UpdatePipelineRequest& WithPipelineDefinitionS3Location(PipelineDefinitionS3LocationT&& value) {
  ...
  template <typename PipelineDescriptionT = Aws::String>
  UpdatePipelineRequest& WithPipelineDescription(PipelineDescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  UpdatePipelineRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename ParallelismConfigurationT = ParallelismConfiguration>
  UpdatePipelineRequest& WithParallelismConfiguration(ParallelismConfigurationT&& value) {
