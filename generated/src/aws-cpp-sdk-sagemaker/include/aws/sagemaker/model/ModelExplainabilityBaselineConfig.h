...
class ModelExplainabilityBaselineConfig {
 public:
  ...
  template <typename BaseliningJobNameT = Aws::String>
  ModelExplainabilityBaselineConfig& WithBaseliningJobName(BaseliningJobNameT&& value) {
  ...
  template <typename ConstraintsResourceT = MonitoringConstraintsResource>
  ModelExplainabilityBaselineConfig& WithConstraintsResource(ConstraintsResourceT&& value) {
