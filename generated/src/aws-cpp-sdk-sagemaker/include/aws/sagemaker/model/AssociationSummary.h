...
class AssociationSummary {
 public:
  ...
  void SetDestinationType(DestinationTypeT&& value) {
    ...
    m_destinationType = std::forward<DestinationTypeT>(value);
  }
  template <typename DestinationTypeT = Aws::String>
  AssociationSummary& WithDestinationType(DestinationTypeT&& value) {
    SetDestinationType(std::forward<DestinationTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAssociationType(AssociationEdgeType value) {
    m_associationTypeHasBeenSet = true;
    m_associationType = value;
  }
  inline AssociationSummary& WithAssociationType(AssociationEdgeType value) {
