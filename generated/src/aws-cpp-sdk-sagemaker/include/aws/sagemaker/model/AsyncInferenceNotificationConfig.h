...
class AsyncInferenceNotificationConfig {
 public:
  ...
  void SetSuccessTopic(SuccessTopicT&& value) {
    ...
    m_successTopic = std::forward<SuccessTopicT>(value);
  }
  template <typename SuccessTopicT = Aws::String>
  AsyncInferenceNotificationConfig& WithSuccessTopic(SuccessTopicT&& value) {
    SetSuccessTopic(std::forward<SuccessTopicT>(value));
    return *this;
  }
  ///@}
  ...
  void SetErrorTopic(ErrorTopicT&& value) {
    ...
    m_errorTopic = std::forward<ErrorTopicT>(value);
  }
  template <typename ErrorTopicT = Aws::String>
  AsyncInferenceNotificationConfig& WithErrorTopic(ErrorTopicT&& value) {
    SetErrorTopic(std::forward<ErrorTopicT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncludeInferenceResponseIn(IncludeInferenceResponseInT&& value) {
    ...
    m_includeInferenceResponseIn = std::forward<IncludeInferenceResponseInT>(value);
  }
  template <typename IncludeInferenceResponseInT = Aws::Vector<AsyncNotificationTopicTypes>>
  AsyncInferenceNotificationConfig& WithIncludeInferenceResponseIn(IncludeInferenceResponseInT&& value) {
    SetIncludeInferenceResponseIn(std::forward<IncludeInferenceResponseInT>(value));
    return *this;
  }
  inline AsyncInferenceNotificationConfig& AddIncludeInferenceResponseIn(AsyncNotificationTopicTypes value) {
    m_includeInferenceResponseInHasBeenSet = true;
    m_includeInferenceResponseIn.push_back(value);
    return *this;
  }
  ///@}
 private:
