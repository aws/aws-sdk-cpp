...
class RetentionPolicy {
 public:
  ...
  inline void SetHomeEfsFileSystem(RetentionType value) {
    m_homeEfsFileSystemHasBeenSet = true;
    m_homeEfsFileSystem = value;
  }
  inline RetentionPolicy& WithHomeEfsFileSystem(RetentionType value) {
    SetHomeEfsFileSystem(value);
    return *this;
  }
  ///@}
 private:
