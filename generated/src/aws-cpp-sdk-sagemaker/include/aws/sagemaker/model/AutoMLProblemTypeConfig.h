...
class AutoMLProblemTypeConfig {
 public:
  ...
  void SetImageClassificationJobConfig(ImageClassificationJobConfigT&& value) {
    m_imageClassificationJobConfigHasBeenSet = true;
    m_imageClassificationJobConfig = std::forward<ImageClassificationJobConfigT>(value);
  }
  template <typename ImageClassificationJobConfigT = ImageClassificationJobConfig>
  AutoMLProblemTypeConfig& WithImageClassificationJobConfig(ImageClassificationJobConfigT&& value) {
    SetImageClassificationJobConfig(std::forward<ImageClassificationJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextClassificationJobConfig(TextClassificationJobConfigT&& value) {
    m_textClassificationJobConfigHasBeenSet = true;
    m_textClassificationJobConfig = std::forward<TextClassificationJobConfigT>(value);
  }
  template <typename TextClassificationJobConfigT = TextClassificationJobConfig>
  AutoMLProblemTypeConfig& WithTextClassificationJobConfig(TextClassificationJobConfigT&& value) {
    SetTextClassificationJobConfig(std::forward<TextClassificationJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeSeriesForecastingJobConfig(TimeSeriesForecastingJobConfigT&& value) {
    m_timeSeriesForecastingJobConfigHasBeenSet = true;
    m_timeSeriesForecastingJobConfig = std::forward<TimeSeriesForecastingJobConfigT>(value);
  }
  template <typename TimeSeriesForecastingJobConfigT = TimeSeriesForecastingJobConfig>
  AutoMLProblemTypeConfig& WithTimeSeriesForecastingJobConfig(TimeSeriesForecastingJobConfigT&& value) {
    SetTimeSeriesForecastingJobConfig(std::forward<TimeSeriesForecastingJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTabularJobConfig(TabularJobConfigT&& value) {
    m_tabularJobConfigHasBeenSet = true;
    m_tabularJobConfig = std::forward<TabularJobConfigT>(value);
  }
  template <typename TabularJobConfigT = TabularJobConfig>
  AutoMLProblemTypeConfig& WithTabularJobConfig(TabularJobConfigT&& value) {
    SetTabularJobConfig(std::forward<TabularJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextGenerationJobConfig(TextGenerationJobConfigT&& value) {
    m_textGenerationJobConfigHasBeenSet = true;
    m_textGenerationJobConfig = std::forward<TextGenerationJobConfigT>(value);
  }
  template <typename TextGenerationJobConfigT = TextGenerationJobConfig>
  AutoMLProblemTypeConfig& WithTextGenerationJobConfig(TextGenerationJobConfigT&& value) {
    SetTextGenerationJobConfig(std::forward<TextGenerationJobConfigT>(value));
    return *this;
  }
  ///@}
 private:
