...
namespace Model
{
  ...
  public:
    ...
    template<typename HubArnT = Aws::String>
    ImportHubContentResult& WithHubArn(HubArnT&& value) { SetHubArn(std::forward<HubArnT>(value)); return *this;}
    ///@}
    ...
    template<typename HubContentArnT = Aws::String>
    ImportHubContentResult& WithHubContentArn(HubContentArnT&& value) { SetHubContentArn(std::forward<HubContentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ImportHubContentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
