...
class ListModelCardVersionsResult {
 public:
  ...
  void SetModelCardVersionSummaryList(ModelCardVersionSummaryListT&& value) {
    m_modelCardVersionSummaryListHasBeenSet = true;
    m_modelCardVersionSummaryList = std::forward<ModelCardVersionSummaryListT>(value);
  }
  template <typename ModelCardVersionSummaryListT = Aws::Vector<ModelCardVersionSummary>>
  ListModelCardVersionsResult& WithModelCardVersionSummaryList(ModelCardVersionSummaryListT&& value) {
    SetModelCardVersionSummaryList(std::forward<ModelCardVersionSummaryListT>(value));
    return *this;
  }
  template <typename ModelCardVersionSummaryListT = ModelCardVersionSummary>
  ListModelCardVersionsResult& AddModelCardVersionSummaryList(ModelCardVersionSummaryListT&& value) {
    m_modelCardVersionSummaryListHasBeenSet = true;
    m_modelCardVersionSummaryList.emplace_back(std::forward<ModelCardVersionSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCardVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelCardVersionsResult& WithRequestId(RequestIdT&& value) {
