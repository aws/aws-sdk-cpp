...
class CreateModelPackageRequest : public SageMakerRequest {
 public:
  ...
  inline CreateModelPackageRequest& WithCertifyForMarketplace(bool value) {
  ...
  inline CreateModelPackageRequest& WithModelApprovalStatus(ModelApprovalStatus value) {
  ...
  inline CreateModelPackageRequest& WithSkipModelValidation(SkipModelValidation value) {
