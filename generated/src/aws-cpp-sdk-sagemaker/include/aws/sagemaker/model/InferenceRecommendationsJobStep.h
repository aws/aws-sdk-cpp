...
class InferenceRecommendationsJobStep {
 public:
  ...
  inline void SetStepType(RecommendationStepType value) {
    m_stepTypeHasBeenSet = true;
    m_stepType = value;
  }
  inline InferenceRecommendationsJobStep& WithStepType(RecommendationStepType value) {
    SetStepType(value);
    return *this;
  }
  ///@}
  ...
  inline InferenceRecommendationsJobStep& WithStatus(RecommendationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetInferenceBenchmark(InferenceBenchmarkT&& value) {
    ...
    m_inferenceBenchmark = std::forward<InferenceBenchmarkT>(value);
  }
  template <typename InferenceBenchmarkT = RecommendationJobInferenceBenchmark>
  InferenceRecommendationsJobStep& WithInferenceBenchmark(InferenceBenchmarkT&& value) {
    SetInferenceBenchmark(std::forward<InferenceBenchmarkT>(value));
    return *this;
  }
  ///@}
 private:
