...
class LabelCountersForWorkteam {
 public:
  ...
  inline LabelCountersForWorkteam& WithHumanLabeled(int value) {
  ...
  inline void SetPendingHuman(int value) {
    m_pendingHumanHasBeenSet = true;
    m_pendingHuman = value;
  }
  inline LabelCountersForWorkteam& WithPendingHuman(int value) {
    SetPendingHuman(value);
    return *this;
  }
  ///@}
  ...
  inline LabelCountersForWorkteam& WithTotal(int value) {
    SetTotal(value);
    return *this;
  }
  ///@}
