...
class HyperParameterTuningJobCompletionDetails {
 public:
  ...
  inline void SetNumberOfTrainingJobsObjectiveNotImproving(int value) {
    m_numberOfTrainingJobsObjectiveNotImprovingHasBeenSet = true;
    m_numberOfTrainingJobsObjectiveNotImproving = value;
  }
  inline HyperParameterTuningJobCompletionDetails& WithNumberOfTrainingJobsObjectiveNotImproving(int value) {
    SetNumberOfTrainingJobsObjectiveNotImproving(value);
    return *this;
  }
  ///@}
  ...
  void SetConvergenceDetectedTime(ConvergenceDetectedTimeT&& value) {
    m_convergenceDetectedTimeHasBeenSet = true;
    m_convergenceDetectedTime = std::forward<ConvergenceDetectedTimeT>(value);
  }
  template <typename ConvergenceDetectedTimeT = Aws::Utils::DateTime>
  HyperParameterTuningJobCompletionDetails& WithConvergenceDetectedTime(ConvergenceDetectedTimeT&& value) {
    SetConvergenceDetectedTime(std::forward<ConvergenceDetectedTimeT>(value));
    return *this;
  }
  ///@}
 private:
