...
class CreateClusterSchedulerConfigResult {
 public:
  ...
  template <typename ClusterSchedulerConfigArnT = Aws::String>
  CreateClusterSchedulerConfigResult& WithClusterSchedulerConfigArn(ClusterSchedulerConfigArnT&& value) {
  ...
  template <typename ClusterSchedulerConfigIdT = Aws::String>
  CreateClusterSchedulerConfigResult& WithClusterSchedulerConfigId(ClusterSchedulerConfigIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateClusterSchedulerConfigResult& WithRequestId(RequestIdT&& value) {
