...
class ListModelBiasJobDefinitionsRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListModelBiasJobDefinitionsRequest() = default;
  ...
  template <typename EndpointNameT = Aws::String>
  ListModelBiasJobDefinitionsRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  inline ListModelBiasJobDefinitionsRequest& WithSortBy(MonitoringJobDefinitionSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelBiasJobDefinitionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelBiasJobDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelBiasJobDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListModelBiasJobDefinitionsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelBiasJobDefinitionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelBiasJobDefinitionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
