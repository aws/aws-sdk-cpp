...
class PartnerAppSummary {
 public:
  ...
  inline PartnerAppSummary& WithType(PartnerAppType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(PartnerAppStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline PartnerAppSummary& WithStatus(PartnerAppStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
