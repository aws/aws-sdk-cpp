...
class RecommendationMetrics {
 public:
  ...
  inline void SetCostPerHour(double value) {
    m_costPerHourHasBeenSet = true;
    m_costPerHour = value;
  }
  inline RecommendationMetrics& WithCostPerHour(double value) {
  ...
  inline void SetCostPerInference(double value) {
    m_costPerInferenceHasBeenSet = true;
    m_costPerInference = value;
  }
  inline RecommendationMetrics& WithCostPerInference(double value) {
    SetCostPerInference(value);
    return *this;
  }
  ///@}
  ...
  inline RecommendationMetrics& WithMaxInvocations(int value) {
  ...
  inline RecommendationMetrics& WithModelLatency(int value) {
  ...
  inline void SetCpuUtilization(double value) {
    m_cpuUtilizationHasBeenSet = true;
    m_cpuUtilization = value;
  }
  inline RecommendationMetrics& WithCpuUtilization(double value) {
    SetCpuUtilization(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMemoryUtilization(double value) {
    m_memoryUtilizationHasBeenSet = true;
    m_memoryUtilization = value;
  }
  inline RecommendationMetrics& WithMemoryUtilization(double value) {
    SetMemoryUtilization(value);
    return *this;
  }
  ///@}
  ...
  inline void SetModelSetupTime(int value) {
    m_modelSetupTimeHasBeenSet = true;
    m_modelSetupTime = value;
  }
  inline RecommendationMetrics& WithModelSetupTime(int value) {
    SetModelSetupTime(value);
    return *this;
  }
  ///@}
 private:
