...
/**
 * <p>The MLflow tracking configuration for logging metrics and parameters to a
 * SageMaker managed MLflow tracking server.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/AIMlflowConfig">AWS
 * API Reference</a></p>
 */
