...
class ListStageDevicesRequest : public SageMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListStageDevicesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListStageDevicesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename EdgeDeploymentPlanNameT = Aws::String>
  ListStageDevicesRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) {
  ...
  inline void SetExcludeDevicesDeployedInOtherStage(bool value) {
    m_excludeDevicesDeployedInOtherStageHasBeenSet = true;
    m_excludeDevicesDeployedInOtherStage = value;
  }
  inline ListStageDevicesRequest& WithExcludeDevicesDeployedInOtherStage(bool value) {
    SetExcludeDevicesDeployedInOtherStage(value);
    return *this;
  }
  ///@}
  ...
  template <typename StageNameT = Aws::String>
  ListStageDevicesRequest& WithStageName(StageNameT&& value) {
