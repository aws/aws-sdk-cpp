...
class MonitoringOutputConfig {
 public:
  ...
  void SetMonitoringOutputs(MonitoringOutputsT&& value) {
    m_monitoringOutputsHasBeenSet = true;
    m_monitoringOutputs = std::forward<MonitoringOutputsT>(value);
  }
  template <typename MonitoringOutputsT = Aws::Vector<MonitoringOutput>>
  MonitoringOutputConfig& WithMonitoringOutputs(MonitoringOutputsT&& value) {
    SetMonitoringOutputs(std::forward<MonitoringOutputsT>(value));
    return *this;
  }
  template <typename MonitoringOutputsT = MonitoringOutput>
  MonitoringOutputConfig& AddMonitoringOutputs(MonitoringOutputsT&& value) {
    m_monitoringOutputsHasBeenSet = true;
    m_monitoringOutputs.emplace_back(std::forward<MonitoringOutputsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyIdT = Aws::String>
  MonitoringOutputConfig& WithKmsKeyId(KmsKeyIdT&& value) {
