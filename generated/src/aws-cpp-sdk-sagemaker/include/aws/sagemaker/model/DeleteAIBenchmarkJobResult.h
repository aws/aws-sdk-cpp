...
namespace SageMaker {
namespace Model {
class DeleteAIBenchmarkJobResult {
 public:
  AWS_SAGEMAKER_API DeleteAIBenchmarkJobResult() = default;
  AWS_SAGEMAKER_API DeleteAIBenchmarkJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SAGEMAKER_API DeleteAIBenchmarkJobResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AIBenchmarkJobArnT = Aws::String>
  DeleteAIBenchmarkJobResult& WithAIBenchmarkJobArn(AIBenchmarkJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAIBenchmarkJobResult& WithRequestId(RequestIdT&& value) {
