...
class CollectionConfiguration {
 public:
  ...
  template <typename CollectionNameT = Aws::String>
  CollectionConfiguration& WithCollectionName(CollectionNameT&& value) {
  ...
  void SetCollectionParameters(CollectionParametersT&& value) {
    m_collectionParametersHasBeenSet = true;
    m_collectionParameters = std::forward<CollectionParametersT>(value);
  }
  template <typename CollectionParametersT = Aws::Map<Aws::String, Aws::String>>
  CollectionConfiguration& WithCollectionParameters(CollectionParametersT&& value) {
    SetCollectionParameters(std::forward<CollectionParametersT>(value));
    return *this;
  }
  ...
  CollectionConfiguration& AddCollectionParameters(CollectionParametersKeyT&& key, CollectionParametersValueT&& value) {
    m_collectionParametersHasBeenSet = true;
    m_collectionParameters.emplace(std::forward<CollectionParametersKeyT>(key), std::forward<CollectionParametersValueT>(value));
    return *this;
  }
  ///@}
 private:
