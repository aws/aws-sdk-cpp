...
class MonitoringJobDefinitionSummary {
 public:
  ...
  template <typename MonitoringJobDefinitionNameT = Aws::String>
  MonitoringJobDefinitionSummary& WithMonitoringJobDefinitionName(MonitoringJobDefinitionNameT&& value) {
  ...
  void SetMonitoringJobDefinitionArn(MonitoringJobDefinitionArnT&& value) {
    m_monitoringJobDefinitionArnHasBeenSet = true;
    m_monitoringJobDefinitionArn = std::forward<MonitoringJobDefinitionArnT>(value);
  }
  template <typename MonitoringJobDefinitionArnT = Aws::String>
  MonitoringJobDefinitionSummary& WithMonitoringJobDefinitionArn(MonitoringJobDefinitionArnT&& value) {
    SetMonitoringJobDefinitionArn(std::forward<MonitoringJobDefinitionArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  MonitoringJobDefinitionSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename EndpointNameT = Aws::String>
  MonitoringJobDefinitionSummary& WithEndpointName(EndpointNameT&& value) {
