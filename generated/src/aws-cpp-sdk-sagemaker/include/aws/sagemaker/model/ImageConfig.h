...
class ImageConfig {
 public:
  ...
  inline void SetRepositoryAccessMode(RepositoryAccessMode value) {
    m_repositoryAccessModeHasBeenSet = true;
    m_repositoryAccessMode = value;
  }
  inline ImageConfig& WithRepositoryAccessMode(RepositoryAccessMode value) {
    SetRepositoryAccessMode(value);
    return *this;
  }
  ///@}
  ...
  void SetRepositoryAuthConfig(RepositoryAuthConfigT&& value) {
    ...
    m_repositoryAuthConfig = std::forward<RepositoryAuthConfigT>(value);
  }
  template <typename RepositoryAuthConfigT = RepositoryAuthConfig>
  ImageConfig& WithRepositoryAuthConfig(RepositoryAuthConfigT&& value) {
    SetRepositoryAuthConfig(std::forward<RepositoryAuthConfigT>(value));
    return *this;
  }
  ///@}
 private:
