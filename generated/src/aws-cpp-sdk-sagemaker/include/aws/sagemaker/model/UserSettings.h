...
class UserSettings {
 public:
  ...
  void SetSharingSettings(SharingSettingsT&& value) {
    ...
    m_sharingSettings = std::forward<SharingSettingsT>(value);
  }
  template <typename SharingSettingsT = SharingSettings>
  UserSettings& WithSharingSettings(SharingSettingsT&& value) {
    SetSharingSettings(std::forward<SharingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJupyterServerAppSettings(JupyterServerAppSettingsT&& value) {
    ...
    m_jupyterServerAppSettings = std::forward<JupyterServerAppSettingsT>(value);
  }
  template <typename JupyterServerAppSettingsT = JupyterServerAppSettings>
  UserSettings& WithJupyterServerAppSettings(JupyterServerAppSettingsT&& value) {
    SetJupyterServerAppSettings(std::forward<JupyterServerAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKernelGatewayAppSettings(KernelGatewayAppSettingsT&& value) {
    ...
    m_kernelGatewayAppSettings = std::forward<KernelGatewayAppSettingsT>(value);
  }
  template <typename KernelGatewayAppSettingsT = KernelGatewayAppSettings>
  UserSettings& WithKernelGatewayAppSettings(KernelGatewayAppSettingsT&& value) {
    SetKernelGatewayAppSettings(std::forward<KernelGatewayAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTensorBoardAppSettings(TensorBoardAppSettingsT&& value) {
    ...
    m_tensorBoardAppSettings = std::forward<TensorBoardAppSettingsT>(value);
  }
  template <typename TensorBoardAppSettingsT = TensorBoardAppSettings>
  UserSettings& WithTensorBoardAppSettings(TensorBoardAppSettingsT&& value) {
    SetTensorBoardAppSettings(std::forward<TensorBoardAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRStudioServerProAppSettings(RStudioServerProAppSettingsT&& value) {
    ...
    m_rStudioServerProAppSettings = std::forward<RStudioServerProAppSettingsT>(value);
  }
  template <typename RStudioServerProAppSettingsT = RStudioServerProAppSettings>
  UserSettings& WithRStudioServerProAppSettings(RStudioServerProAppSettingsT&& value) {
    SetRStudioServerProAppSettings(std::forward<RStudioServerProAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRSessionAppSettings(RSessionAppSettingsT&& value) {
    ...
    m_rSessionAppSettings = std::forward<RSessionAppSettingsT>(value);
  }
  template <typename RSessionAppSettingsT = RSessionAppSettings>
  UserSettings& WithRSessionAppSettings(RSessionAppSettingsT&& value) {
    SetRSessionAppSettings(std::forward<RSessionAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCanvasAppSettings(CanvasAppSettingsT&& value) {
    ...
    m_canvasAppSettings = std::forward<CanvasAppSettingsT>(value);
  }
  template <typename CanvasAppSettingsT = CanvasAppSettings>
  UserSettings& WithCanvasAppSettings(CanvasAppSettingsT&& value) {
    SetCanvasAppSettings(std::forward<CanvasAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeEditorAppSettings(CodeEditorAppSettingsT&& value) {
    ...
    m_codeEditorAppSettings = std::forward<CodeEditorAppSettingsT>(value);
  }
  template <typename CodeEditorAppSettingsT = CodeEditorAppSettings>
  UserSettings& WithCodeEditorAppSettings(CodeEditorAppSettingsT&& value) {
    SetCodeEditorAppSettings(std::forward<CodeEditorAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJupyterLabAppSettings(JupyterLabAppSettingsT&& value) {
    ...
    m_jupyterLabAppSettings = std::forward<JupyterLabAppSettingsT>(value);
  }
  template <typename JupyterLabAppSettingsT = JupyterLabAppSettings>
  UserSettings& WithJupyterLabAppSettings(JupyterLabAppSettingsT&& value) {
    SetJupyterLabAppSettings(std::forward<JupyterLabAppSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpaceStorageSettings(SpaceStorageSettingsT&& value) {
    ...
    m_spaceStorageSettings = std::forward<SpaceStorageSettingsT>(value);
  }
  template <typename SpaceStorageSettingsT = DefaultSpaceStorageSettings>
  UserSettings& WithSpaceStorageSettings(SpaceStorageSettingsT&& value) {
    SetSpaceStorageSettings(std::forward<SpaceStorageSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDefaultLandingUri(DefaultLandingUriT&& value) {
    ...
    m_defaultLandingUri = std::forward<DefaultLandingUriT>(value);
  }
  template <typename DefaultLandingUriT = Aws::String>
  UserSettings& WithDefaultLandingUri(DefaultLandingUriT&& value) {
    SetDefaultLandingUri(std::forward<DefaultLandingUriT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStudioWebPortal(StudioWebPortal value) {
    m_studioWebPortalHasBeenSet = true;
    m_studioWebPortal = value;
  }
  inline UserSettings& WithStudioWebPortal(StudioWebPortal value) {
    SetStudioWebPortal(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomPosixUserConfig(CustomPosixUserConfigT&& value) {
    ...
    m_customPosixUserConfig = std::forward<CustomPosixUserConfigT>(value);
  }
  template <typename CustomPosixUserConfigT = CustomPosixUserConfig>
  UserSettings& WithCustomPosixUserConfig(CustomPosixUserConfigT&& value) {
    SetCustomPosixUserConfig(std::forward<CustomPosixUserConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomFileSystemConfigs(CustomFileSystemConfigsT&& value) {
    ...
    m_customFileSystemConfigs = std::forward<CustomFileSystemConfigsT>(value);
  }
  template <typename CustomFileSystemConfigsT = Aws::Vector<CustomFileSystemConfig>>
  UserSettings& WithCustomFileSystemConfigs(CustomFileSystemConfigsT&& value) {
    SetCustomFileSystemConfigs(std::forward<CustomFileSystemConfigsT>(value));
    return *this;
  }
  ...
  UserSettings& AddCustomFileSystemConfigs(CustomFileSystemConfigsT&& value) {
    m_customFileSystemConfigsHasBeenSet = true;
    m_customFileSystemConfigs.emplace_back(std::forward<CustomFileSystemConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStudioWebPortalSettings(StudioWebPortalSettingsT&& value) {
    ...
    m_studioWebPortalSettings = std::forward<StudioWebPortalSettingsT>(value);
  }
  template <typename StudioWebPortalSettingsT = StudioWebPortalSettings>
  UserSettings& WithStudioWebPortalSettings(StudioWebPortalSettingsT&& value) {
    SetStudioWebPortalSettings(std::forward<StudioWebPortalSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoMountHomeEFS(AutoMountHomeEFS value) {
    m_autoMountHomeEFSHasBeenSet = true;
    m_autoMountHomeEFS = value;
  }
  inline UserSettings& WithAutoMountHomeEFS(AutoMountHomeEFS value) {
    SetAutoMountHomeEFS(value);
    return *this;
  }
  ///@}
 private:
