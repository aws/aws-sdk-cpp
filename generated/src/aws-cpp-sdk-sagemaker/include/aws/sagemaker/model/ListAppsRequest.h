...
class ListAppsRequest : public SageMakerRequest {
 public:
  ...
  inline ListAppsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(AppSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListAppsRequest& WithSortBy(AppSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  void SetDomainIdEquals(DomainIdEqualsT&& value) {
    m_domainIdEqualsHasBeenSet = true;
    m_domainIdEquals = std::forward<DomainIdEqualsT>(value);
  }
  template <typename DomainIdEqualsT = Aws::String>
  ListAppsRequest& WithDomainIdEquals(DomainIdEqualsT&& value) {
    SetDomainIdEquals(std::forward<DomainIdEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserProfileNameEquals(UserProfileNameEqualsT&& value) {
    m_userProfileNameEqualsHasBeenSet = true;
    m_userProfileNameEquals = std::forward<UserProfileNameEqualsT>(value);
  }
  template <typename UserProfileNameEqualsT = Aws::String>
  ListAppsRequest& WithUserProfileNameEquals(UserProfileNameEqualsT&& value) {
    SetUserProfileNameEquals(std::forward<UserProfileNameEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpaceNameEquals(SpaceNameEqualsT&& value) {
    m_spaceNameEqualsHasBeenSet = true;
    m_spaceNameEquals = std::forward<SpaceNameEqualsT>(value);
  }
  template <typename SpaceNameEqualsT = Aws::String>
  ListAppsRequest& WithSpaceNameEquals(SpaceNameEqualsT&& value) {
    SetSpaceNameEquals(std::forward<SpaceNameEqualsT>(value));
    return *this;
  }
  ///@}
 private:
