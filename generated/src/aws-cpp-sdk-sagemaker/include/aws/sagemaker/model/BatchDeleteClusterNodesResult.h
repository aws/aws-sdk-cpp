...
class BatchDeleteClusterNodesResult {
 public:
  ...
  template <typename FailedT = Aws::Vector<BatchDeleteClusterNodesError>>
  BatchDeleteClusterNodesResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = BatchDeleteClusterNodesError>
  BatchDeleteClusterNodesResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename SuccessfulT = Aws::Vector<Aws::String>>
  BatchDeleteClusterNodesResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = Aws::String>
  BatchDeleteClusterNodesResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename FailedNodeLogicalIdsT = Aws::Vector<BatchDeleteClusterNodeLogicalIdsError>>
  BatchDeleteClusterNodesResult& WithFailedNodeLogicalIds(FailedNodeLogicalIdsT&& value) {
  ...
  BatchDeleteClusterNodesResult& AddFailedNodeLogicalIds(FailedNodeLogicalIdsT&& value) {
    m_failedNodeLogicalIdsHasBeenSet = true;
  ...
  template <typename SuccessfulNodeLogicalIdsT = Aws::Vector<Aws::String>>
  BatchDeleteClusterNodesResult& WithSuccessfulNodeLogicalIds(SuccessfulNodeLogicalIdsT&& value) {
  ...
  BatchDeleteClusterNodesResult& AddSuccessfulNodeLogicalIds(SuccessfulNodeLogicalIdsT&& value) {
    m_successfulNodeLogicalIdsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteClusterNodesResult& WithRequestId(RequestIdT&& value) {
