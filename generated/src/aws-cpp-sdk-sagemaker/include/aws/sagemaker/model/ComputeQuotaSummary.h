...
class ComputeQuotaSummary {
 public:
  ...
  inline ComputeQuotaSummary& WithComputeQuotaVersion(int value) {
  ...
  inline ComputeQuotaSummary& WithStatus(SchedulerResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ComputeQuotaSummary& WithActivationState(ActivationState value) {
