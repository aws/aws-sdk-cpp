...
class DataQualityBaselineConfig {
 public:
  ...
  template <typename BaseliningJobNameT = Aws::String>
  DataQualityBaselineConfig& WithBaseliningJobName(BaseliningJobNameT&& value) {
  ...
  template <typename ConstraintsResourceT = MonitoringConstraintsResource>
  DataQualityBaselineConfig& WithConstraintsResource(ConstraintsResourceT&& value) {
  ...
  void SetStatisticsResource(StatisticsResourceT&& value) {
    m_statisticsResourceHasBeenSet = true;
    m_statisticsResource = std::forward<StatisticsResourceT>(value);
  }
  template <typename StatisticsResourceT = MonitoringStatisticsResource>
  DataQualityBaselineConfig& WithStatisticsResource(StatisticsResourceT&& value) {
    SetStatisticsResource(std::forward<StatisticsResourceT>(value));
    return *this;
  }
  ///@}
 private:
