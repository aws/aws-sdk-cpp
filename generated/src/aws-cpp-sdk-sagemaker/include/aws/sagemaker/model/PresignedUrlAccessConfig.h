...
class PresignedUrlAccessConfig {
 public:
  ...
  inline PresignedUrlAccessConfig& WithAcceptEula(bool value) {
    SetAcceptEula(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedS3Url(ExpectedS3UrlT&& value) {
    ...
    m_expectedS3Url = std::forward<ExpectedS3UrlT>(value);
  }
  template <typename ExpectedS3UrlT = Aws::String>
  PresignedUrlAccessConfig& WithExpectedS3Url(ExpectedS3UrlT&& value) {
    SetExpectedS3Url(std::forward<ExpectedS3UrlT>(value));
    return *this;
  }
  ///@}
 private:
