...
class HyperParameterTuningInstanceConfig {
 public:
  ...
  inline HyperParameterTuningInstanceConfig& WithInstanceType(TrainingInstanceType value) {
  ...
  inline HyperParameterTuningInstanceConfig& WithInstanceCount(int value) {
  ...
  inline HyperParameterTuningInstanceConfig& WithVolumeSizeInGB(int value) {
