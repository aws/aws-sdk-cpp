...
class ProductionVariantSummary {
 public:
  ...
  inline void SetCurrentWeight(double value) {
    m_currentWeightHasBeenSet = true;
    m_currentWeight = value;
  }
  inline ProductionVariantSummary& WithCurrentWeight(double value) {
  ...
  inline void SetDesiredWeight(double value) {
    m_desiredWeightHasBeenSet = true;
    m_desiredWeight = value;
  }
  inline ProductionVariantSummary& WithDesiredWeight(double value) {
  ...
  inline ProductionVariantSummary& WithCurrentInstanceCount(int value) {
  ...
  inline void SetDesiredInstanceCount(int value) {
    m_desiredInstanceCountHasBeenSet = true;
    m_desiredInstanceCount = value;
  }
  inline ProductionVariantSummary& WithDesiredInstanceCount(int value) {
    SetDesiredInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  void SetCurrentServerlessConfig(CurrentServerlessConfigT&& value) {
    ...
    m_currentServerlessConfig = std::forward<CurrentServerlessConfigT>(value);
  }
  template <typename CurrentServerlessConfigT = ProductionVariantServerlessConfig>
  ProductionVariantSummary& WithCurrentServerlessConfig(CurrentServerlessConfigT&& value) {
    SetCurrentServerlessConfig(std::forward<CurrentServerlessConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDesiredServerlessConfig(DesiredServerlessConfigT&& value) {
    ...
    m_desiredServerlessConfig = std::forward<DesiredServerlessConfigT>(value);
  }
  template <typename DesiredServerlessConfigT = ProductionVariantServerlessConfig>
  ProductionVariantSummary& WithDesiredServerlessConfig(DesiredServerlessConfigT&& value) {
    SetDesiredServerlessConfig(std::forward<DesiredServerlessConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedInstanceScaling(ManagedInstanceScalingT&& value) {
    ...
    m_managedInstanceScaling = std::forward<ManagedInstanceScalingT>(value);
  }
  template <typename ManagedInstanceScalingT = ProductionVariantManagedInstanceScaling>
  ProductionVariantSummary& WithManagedInstanceScaling(ManagedInstanceScalingT&& value) {
    SetManagedInstanceScaling(std::forward<ManagedInstanceScalingT>(value));
    return *this;
  }
  ///@}
