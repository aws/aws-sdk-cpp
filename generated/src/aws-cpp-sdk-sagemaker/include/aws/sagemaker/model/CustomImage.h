...
class CustomImage {
 public:
  ...
  template <typename ImageNameT = Aws::String>
  CustomImage& WithImageName(ImageNameT&& value) {
  ...
  inline void SetImageVersionNumber(int value) {
    m_imageVersionNumberHasBeenSet = true;
    m_imageVersionNumber = value;
  }
  inline CustomImage& WithImageVersionNumber(int value) {
    SetImageVersionNumber(value);
    return *this;
  }
  ///@}
  ...
  template <typename AppImageConfigNameT = Aws::String>
  CustomImage& WithAppImageConfigName(AppImageConfigNameT&& value) {
