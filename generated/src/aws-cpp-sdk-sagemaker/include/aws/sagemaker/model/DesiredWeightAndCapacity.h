...
class DesiredWeightAndCapacity {
 public:
  ...
  inline DesiredWeightAndCapacity& WithDesiredWeight(double value) {
  ...
  inline DesiredWeightAndCapacity& WithDesiredInstanceCount(int value) {
  ...
  void SetServerlessUpdateConfig(ServerlessUpdateConfigT&& value) {
    ...
    m_serverlessUpdateConfig = std::forward<ServerlessUpdateConfigT>(value);
  }
  template <typename ServerlessUpdateConfigT = ProductionVariantServerlessUpdateConfig>
  DesiredWeightAndCapacity& WithServerlessUpdateConfig(ServerlessUpdateConfigT&& value) {
    SetServerlessUpdateConfig(std::forward<ServerlessUpdateConfigT>(value));
    return *this;
  }
  ///@}
 private:
