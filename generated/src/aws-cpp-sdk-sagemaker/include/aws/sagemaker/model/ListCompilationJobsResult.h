...
class ListCompilationJobsResult {
 public:
  ...
  void SetCompilationJobSummaries(CompilationJobSummariesT&& value) {
    m_compilationJobSummariesHasBeenSet = true;
    m_compilationJobSummaries = std::forward<CompilationJobSummariesT>(value);
  }
  template <typename CompilationJobSummariesT = Aws::Vector<CompilationJobSummary>>
  ListCompilationJobsResult& WithCompilationJobSummaries(CompilationJobSummariesT&& value) {
    SetCompilationJobSummaries(std::forward<CompilationJobSummariesT>(value));
    return *this;
  }
  template <typename CompilationJobSummariesT = CompilationJobSummary>
  ListCompilationJobsResult& AddCompilationJobSummaries(CompilationJobSummariesT&& value) {
    m_compilationJobSummariesHasBeenSet = true;
    m_compilationJobSummaries.emplace_back(std::forward<CompilationJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCompilationJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCompilationJobsResult& WithRequestId(RequestIdT&& value) {
