...
class ProcessingClusterConfig {
 public:
  ...
  inline ProcessingClusterConfig& WithInstanceCount(int value) {
  ...
  inline ProcessingClusterConfig& WithInstanceType(ProcessingInstanceType value) {
  ...
  inline ProcessingClusterConfig& WithVolumeSizeInGB(int value) {
