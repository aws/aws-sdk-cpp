...
class CandidateGenerationConfig {
 public:
  ...
  void SetAlgorithmsConfig(AlgorithmsConfigT&& value) {
    ...
    m_algorithmsConfig = std::forward<AlgorithmsConfigT>(value);
  }
  template <typename AlgorithmsConfigT = Aws::Vector<AutoMLAlgorithmConfig>>
  CandidateGenerationConfig& WithAlgorithmsConfig(AlgorithmsConfigT&& value) {
    SetAlgorithmsConfig(std::forward<AlgorithmsConfigT>(value));
    return *this;
  }
  ...
  CandidateGenerationConfig& AddAlgorithmsConfig(AlgorithmsConfigT&& value) {
    m_algorithmsConfigHasBeenSet = true;
    m_algorithmsConfig.emplace_back(std::forward<AlgorithmsConfigT>(value));
    return *this;
  }
  ///@}
 private:
