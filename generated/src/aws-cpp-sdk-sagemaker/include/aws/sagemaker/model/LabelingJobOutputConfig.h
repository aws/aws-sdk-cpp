...
class LabelingJobOutputConfig {
 public:
  ...
  template <typename S3OutputPathT = Aws::String>
  LabelingJobOutputConfig& WithS3OutputPath(S3OutputPathT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  LabelingJobOutputConfig& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename SnsTopicArnT = Aws::String>
  LabelingJobOutputConfig& WithSnsTopicArn(SnsTopicArnT&& value) {
