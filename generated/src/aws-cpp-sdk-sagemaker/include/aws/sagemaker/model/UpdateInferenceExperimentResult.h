...
class UpdateInferenceExperimentResult {
 public:
  ...
  template <typename InferenceExperimentArnT = Aws::String>
  UpdateInferenceExperimentResult& WithInferenceExperimentArn(InferenceExperimentArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateInferenceExperimentResult& WithRequestId(RequestIdT&& value) {
