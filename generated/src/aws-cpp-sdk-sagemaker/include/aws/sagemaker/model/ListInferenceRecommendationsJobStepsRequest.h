...
class ListInferenceRecommendationsJobStepsRequest : public SageMakerRequest {
 public:
  ...
  template <typename JobNameT = Aws::String>
  ListInferenceRecommendationsJobStepsRequest& WithJobName(JobNameT&& value) {
  ...
  inline ListInferenceRecommendationsJobStepsRequest& WithStatus(RecommendationJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListInferenceRecommendationsJobStepsRequest& WithStepType(RecommendationStepType value) {
    SetStepType(value);
    return *this;
  }
  ///@}
  ...
  inline ListInferenceRecommendationsJobStepsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceRecommendationsJobStepsRequest& WithNextToken(NextTokenT&& value) {
