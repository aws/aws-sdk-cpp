 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/RemoteDebugConfig">AWS
 * API Reference</a></p>
 */
class RemoteDebugConfig {
 public:
  ...
  inline void SetEnableRemoteDebug(bool value) {
    m_enableRemoteDebugHasBeenSet = true;
    m_enableRemoteDebug = value;
  }
  inline RemoteDebugConfig& WithEnableRemoteDebug(bool value) {
    SetEnableRemoteDebug(value);
    return *this;
  }
  ///@}
 private:
