...
class HumanLoopRequestSource {
 public:
  ...
  inline void SetAwsManagedHumanLoopRequestSource(AwsManagedHumanLoopRequestSource value) {
    m_awsManagedHumanLoopRequestSourceHasBeenSet = true;
    m_awsManagedHumanLoopRequestSource = value;
  }
  inline HumanLoopRequestSource& WithAwsManagedHumanLoopRequestSource(AwsManagedHumanLoopRequestSource value) {
    SetAwsManagedHumanLoopRequestSource(value);
    return *this;
  }
  ///@}
 private:
