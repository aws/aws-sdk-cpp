...
class RecommendationJobResourceLimit {
 public:
  ...
  inline void SetMaxNumberOfTests(int value) {
    m_maxNumberOfTestsHasBeenSet = true;
    m_maxNumberOfTests = value;
  }
  inline RecommendationJobResourceLimit& WithMaxNumberOfTests(int value) {
    SetMaxNumberOfTests(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxParallelOfTests(int value) {
    m_maxParallelOfTestsHasBeenSet = true;
    m_maxParallelOfTests = value;
  }
  inline RecommendationJobResourceLimit& WithMaxParallelOfTests(int value) {
    SetMaxParallelOfTests(value);
    return *this;
  }
  ///@}
 private:
