...
class CreatePresignedNotebookInstanceUrlResult {
 public:
  ...
  AWS_SAGEMAKER_API CreatePresignedNotebookInstanceUrlResult& operator=(
  ...
  template <typename AuthorizedUrlT = Aws::String>
  CreatePresignedNotebookInstanceUrlResult& WithAuthorizedUrl(AuthorizedUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreatePresignedNotebookInstanceUrlResult& WithRequestId(RequestIdT&& value) {
