...
class ListTrialsRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListTrialsRequest() = default;
  ...
  template <typename ExperimentNameT = Aws::String>
  ListTrialsRequest& WithExperimentName(ExperimentNameT&& value) {
  ...
  template <typename TrialComponentNameT = Aws::String>
  ListTrialsRequest& WithTrialComponentName(TrialComponentNameT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  ListTrialsRequest& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  ListTrialsRequest& WithCreatedBefore(CreatedBeforeT&& value) {
   ...
   */
  inline SortTrialsBy GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(SortTrialsBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListTrialsRequest& WithSortBy(SortTrialsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListTrialsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListTrialsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTrialsRequest& WithNextToken(NextTokenT&& value) {
 ...
 private:
  ...
  SortTrialsBy m_sortBy{SortTrialsBy::NOT_SET};
