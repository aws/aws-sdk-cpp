...
class ScalingPolicyObjective {
 public:
  ...
  inline void SetMinInvocationsPerMinute(int value) {
    m_minInvocationsPerMinuteHasBeenSet = true;
    m_minInvocationsPerMinute = value;
  }
  inline ScalingPolicyObjective& WithMinInvocationsPerMinute(int value) {
    SetMinInvocationsPerMinute(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxInvocationsPerMinute(int value) {
    m_maxInvocationsPerMinuteHasBeenSet = true;
    m_maxInvocationsPerMinute = value;
  }
  inline ScalingPolicyObjective& WithMaxInvocationsPerMinute(int value) {
    SetMaxInvocationsPerMinute(value);
    return *this;
  }
  ///@}
 private:
