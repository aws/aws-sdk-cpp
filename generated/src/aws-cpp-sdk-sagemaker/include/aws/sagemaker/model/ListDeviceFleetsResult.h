...
class ListDeviceFleetsResult {
 public:
  ...
  void SetDeviceFleetSummaries(DeviceFleetSummariesT&& value) {
    m_deviceFleetSummariesHasBeenSet = true;
    m_deviceFleetSummaries = std::forward<DeviceFleetSummariesT>(value);
  }
  template <typename DeviceFleetSummariesT = Aws::Vector<DeviceFleetSummary>>
  ListDeviceFleetsResult& WithDeviceFleetSummaries(DeviceFleetSummariesT&& value) {
    SetDeviceFleetSummaries(std::forward<DeviceFleetSummariesT>(value));
    return *this;
  }
  template <typename DeviceFleetSummariesT = DeviceFleetSummary>
  ListDeviceFleetsResult& AddDeviceFleetSummaries(DeviceFleetSummariesT&& value) {
    m_deviceFleetSummariesHasBeenSet = true;
    m_deviceFleetSummaries.emplace_back(std::forward<DeviceFleetSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDeviceFleetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDeviceFleetsResult& WithRequestId(RequestIdT&& value) {
