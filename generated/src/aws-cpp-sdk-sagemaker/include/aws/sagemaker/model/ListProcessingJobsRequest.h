...
namespace Model
{
  ...
  public:
    ...
    template<typename CreationTimeAfterT = Aws::Utils::DateTime>
    ListProcessingJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) { SetCreationTimeAfter(std::forward<CreationTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeBeforeT = Aws::Utils::DateTime>
    ListProcessingJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) { SetCreationTimeBefore(std::forward<CreationTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
    ListProcessingJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) { SetLastModifiedTimeAfter(std::forward<LastModifiedTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
    ListProcessingJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) { SetLastModifiedTimeBefore(std::forward<LastModifiedTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListProcessingJobsRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
    ...
    inline void SetStatusEquals(ProcessingJobStatus value) { m_statusEqualsHasBeenSet = true; m_statusEquals = value; }
    inline ListProcessingJobsRequest& WithStatusEquals(ProcessingJobStatus value) { SetStatusEquals(value); return *this;}
    ///@}
    ...
    inline ListProcessingJobsRequest& WithSortBy(SortBy value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline ListProcessingJobsRequest& WithSortOrder(SortOrder value) { SetSortOrder(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListProcessingJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
