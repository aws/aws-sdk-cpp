...
class ListUserProfilesRequest : public SageMakerRequest {
 public:
  ...
  inline ListUserProfilesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListUserProfilesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(UserProfileSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListUserProfilesRequest& WithSortBy(UserProfileSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  void SetUserProfileNameContains(UserProfileNameContainsT&& value) {
    m_userProfileNameContainsHasBeenSet = true;
    m_userProfileNameContains = std::forward<UserProfileNameContainsT>(value);
  }
  template <typename UserProfileNameContainsT = Aws::String>
  ListUserProfilesRequest& WithUserProfileNameContains(UserProfileNameContainsT&& value) {
    SetUserProfileNameContains(std::forward<UserProfileNameContainsT>(value));
    return *this;
  }
  ///@}
 private:
