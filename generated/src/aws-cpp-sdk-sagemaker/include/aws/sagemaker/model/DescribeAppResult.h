...
class DescribeAppResult {
 public:
  ...
  inline DescribeAppResult& WithAppType(AppType value) {
    SetAppType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAppResult& WithStatus(AppStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEffectiveTrustedIdentityPropagationStatus(FeatureStatus value) {
    m_effectiveTrustedIdentityPropagationStatusHasBeenSet = true;
    m_effectiveTrustedIdentityPropagationStatus = value;
  }
  inline DescribeAppResult& WithEffectiveTrustedIdentityPropagationStatus(FeatureStatus value) {
    SetEffectiveTrustedIdentityPropagationStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRecoveryMode(bool value) {
    m_recoveryModeHasBeenSet = true;
    m_recoveryMode = value;
  }
  inline DescribeAppResult& WithRecoveryMode(bool value) {
  ...
  void SetLastHealthCheckTimestamp(LastHealthCheckTimestampT&& value) {
    ...
    m_lastHealthCheckTimestamp = std::forward<LastHealthCheckTimestampT>(value);
  }
  template <typename LastHealthCheckTimestampT = Aws::Utils::DateTime>
  DescribeAppResult& WithLastHealthCheckTimestamp(LastHealthCheckTimestampT&& value) {
    SetLastHealthCheckTimestamp(std::forward<LastHealthCheckTimestampT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastUserActivityTimestamp(LastUserActivityTimestampT&& value) {
    ...
    m_lastUserActivityTimestamp = std::forward<LastUserActivityTimestampT>(value);
  }
  template <typename LastUserActivityTimestampT = Aws::Utils::DateTime>
  DescribeAppResult& WithLastUserActivityTimestamp(LastUserActivityTimestampT&& value) {
    SetLastUserActivityTimestamp(std::forward<LastUserActivityTimestampT>(value));
    return *this;
  }
  ///@}
