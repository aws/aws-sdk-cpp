...
class VariantProperty {
 public:
  ...
  inline void SetVariantPropertyType(VariantPropertyType value) {
    m_variantPropertyTypeHasBeenSet = true;
    m_variantPropertyType = value;
  }
  inline VariantProperty& WithVariantPropertyType(VariantPropertyType value) {
    SetVariantPropertyType(value);
    return *this;
  }
  ///@}
 private:
