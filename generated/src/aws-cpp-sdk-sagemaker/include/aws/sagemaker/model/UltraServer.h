...
class UltraServer {
 public:
  ...
  inline UltraServer& WithInstanceType(ReservedCapacityInstanceType value) {
  ...
  inline UltraServer& WithTotalInstanceCount(int value) {
  ...
  inline void SetConfiguredSpareInstanceCount(int value) {
    m_configuredSpareInstanceCountHasBeenSet = true;
    m_configuredSpareInstanceCount = value;
  }
  inline UltraServer& WithConfiguredSpareInstanceCount(int value) {
    SetConfiguredSpareInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline UltraServer& WithAvailableInstanceCount(int value) {
  ...
  inline UltraServer& WithInUseInstanceCount(int value) {
  ...
  inline void SetAvailableSpareInstanceCount(int value) {
    m_availableSpareInstanceCountHasBeenSet = true;
    m_availableSpareInstanceCount = value;
  }
  inline UltraServer& WithAvailableSpareInstanceCount(int value) {
    SetAvailableSpareInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetUnhealthyInstanceCount(int value) {
    m_unhealthyInstanceCountHasBeenSet = true;
    m_unhealthyInstanceCount = value;
  }
  inline UltraServer& WithUnhealthyInstanceCount(int value) {
    SetUnhealthyInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthStatus(UltraServerHealthStatus value) {
    m_healthStatusHasBeenSet = true;
    m_healthStatus = value;
  }
  inline UltraServer& WithHealthStatus(UltraServerHealthStatus value) {
