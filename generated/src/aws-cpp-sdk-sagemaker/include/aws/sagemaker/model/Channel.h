...
class Channel {
 public:
  ...
  inline Channel& WithCompressionType(CompressionType value) {
  ...
  inline void SetRecordWrapperType(RecordWrapper value) {
    m_recordWrapperTypeHasBeenSet = true;
    m_recordWrapperType = value;
  }
  inline Channel& WithRecordWrapperType(RecordWrapper value) {
    SetRecordWrapperType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInputMode(TrainingInputMode value) {
    m_inputModeHasBeenSet = true;
    m_inputMode = value;
  }
  inline Channel& WithInputMode(TrainingInputMode value) {
    SetInputMode(value);
    return *this;
  }
  ///@}
  ...
  void SetShuffleConfig(ShuffleConfigT&& value) {
    ...
    m_shuffleConfig = std::forward<ShuffleConfigT>(value);
  }
  template <typename ShuffleConfigT = ShuffleConfig>
  Channel& WithShuffleConfig(ShuffleConfigT&& value) {
    SetShuffleConfig(std::forward<ShuffleConfigT>(value));
    return *this;
  }
  ///@}
 private:
