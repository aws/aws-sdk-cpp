...
class ModelBiasJobInput {
 public:
  ...
  template <typename EndpointInputT = EndpointInput>
  ModelBiasJobInput& WithEndpointInput(EndpointInputT&& value) {
  ...
  template <typename BatchTransformInputT = BatchTransformInput>
  ModelBiasJobInput& WithBatchTransformInput(BatchTransformInputT&& value) {
  ...
  void SetGroundTruthS3Input(GroundTruthS3InputT&& value) {
    m_groundTruthS3InputHasBeenSet = true;
    m_groundTruthS3Input = std::forward<GroundTruthS3InputT>(value);
  }
  template <typename GroundTruthS3InputT = MonitoringGroundTruthS3Input>
  ModelBiasJobInput& WithGroundTruthS3Input(GroundTruthS3InputT&& value) {
    SetGroundTruthS3Input(std::forward<GroundTruthS3InputT>(value));
    return *this;
  }
  ///@}
 private:
