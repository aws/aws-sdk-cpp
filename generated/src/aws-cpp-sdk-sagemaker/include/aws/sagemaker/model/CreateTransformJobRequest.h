...
class CreateTransformJobRequest : public SageMakerRequest {
 public:
  ...
  inline CreateTransformJobRequest& WithMaxConcurrentTransforms(int value) {
  ...
  inline CreateTransformJobRequest& WithMaxPayloadInMB(int value) {
  ...
  inline CreateTransformJobRequest& WithBatchStrategy(BatchStrategy value) {
