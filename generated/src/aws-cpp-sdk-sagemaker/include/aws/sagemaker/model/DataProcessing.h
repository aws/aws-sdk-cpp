...
class DataProcessing {
 public:
  ...
  void SetInputFilter(InputFilterT&& value) {
    ...
    m_inputFilter = std::forward<InputFilterT>(value);
  }
  template <typename InputFilterT = Aws::String>
  DataProcessing& WithInputFilter(InputFilterT&& value) {
    SetInputFilter(std::forward<InputFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutputFilter(OutputFilterT&& value) {
    ...
    m_outputFilter = std::forward<OutputFilterT>(value);
  }
  template <typename OutputFilterT = Aws::String>
  DataProcessing& WithOutputFilter(OutputFilterT&& value) {
    SetOutputFilter(std::forward<OutputFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetJoinSource(JoinSource value) {
    m_joinSourceHasBeenSet = true;
    m_joinSource = value;
  }
  inline DataProcessing& WithJoinSource(JoinSource value) {
    SetJoinSource(value);
    return *this;
  }
  ///@}
