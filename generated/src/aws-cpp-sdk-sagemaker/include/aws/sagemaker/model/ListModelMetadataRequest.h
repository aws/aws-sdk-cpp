...
class ListModelMetadataRequest : public SageMakerRequest {
 public:
  ...
  template <typename SearchExpressionT = ModelMetadataSearchExpression>
  ListModelMetadataRequest& WithSearchExpression(SearchExpressionT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListModelMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
