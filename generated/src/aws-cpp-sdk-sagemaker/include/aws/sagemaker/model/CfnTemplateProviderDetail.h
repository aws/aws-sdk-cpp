...
namespace Model
{
  ...
  public:
    ...
    template<typename TemplateNameT = Aws::String>
    CfnTemplateProviderDetail& WithTemplateName(TemplateNameT&& value) { SetTemplateName(std::forward<TemplateNameT>(value)); return *this;}
    ///@}
    ...
    template<typename TemplateURLT = Aws::String>
    CfnTemplateProviderDetail& WithTemplateURL(TemplateURLT&& value) { SetTemplateURL(std::forward<TemplateURLT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleARNT = Aws::String>
    CfnTemplateProviderDetail& WithRoleARN(RoleARNT&& value) { SetRoleARN(std::forward<RoleARNT>(value)); return *this;}
    ///@}
    ...
    template<typename ParametersT = Aws::Vector<CfnStackParameter>>
    CfnTemplateProviderDetail& WithParameters(ParametersT&& value) { SetParameters(std::forward<ParametersT>(value)); return *this;}
    template<typename ParametersT = CfnStackParameter>
    CfnTemplateProviderDetail& AddParameters(ParametersT&& value) { m_parametersHasBeenSet = true; m_parameters.emplace_back(std::forward<ParametersT>(value)); return *this; }
    ///@}
    ...
    void SetStackDetail(StackDetailT&& value) { m_stackDetailHasBeenSet = true; m_stackDetail = std::forward<StackDetailT>(value); }
    template<typename StackDetailT = CfnStackDetail>
    CfnTemplateProviderDetail& WithStackDetail(StackDetailT&& value) { SetStackDetail(std::forward<StackDetailT>(value)); return *this;}
    ///@}
  private:
