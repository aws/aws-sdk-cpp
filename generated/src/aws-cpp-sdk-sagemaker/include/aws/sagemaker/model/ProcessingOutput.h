...
class ProcessingOutput {
 public:
  ...
  void SetS3Output(S3OutputT&& value) {
    ...
    m_s3Output = std::forward<S3OutputT>(value);
  }
  template <typename S3OutputT = ProcessingS3Output>
  ProcessingOutput& WithS3Output(S3OutputT&& value) {
    SetS3Output(std::forward<S3OutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFeatureStoreOutput(FeatureStoreOutputT&& value) {
    ...
    m_featureStoreOutput = std::forward<FeatureStoreOutputT>(value);
  }
  template <typename FeatureStoreOutputT = ProcessingFeatureStoreOutput>
  ProcessingOutput& WithFeatureStoreOutput(FeatureStoreOutputT&& value) {
    SetFeatureStoreOutput(std::forward<FeatureStoreOutputT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAppManaged(bool value) {
    m_appManagedHasBeenSet = true;
    m_appManaged = value;
  }
  inline ProcessingOutput& WithAppManaged(bool value) {
    SetAppManaged(value);
    return *this;
  }
  ///@}
