...
class DescribeNotebookInstanceResult {
 public:
  ...
  inline void SetNotebookInstanceStatus(NotebookInstanceStatus value) {
    m_notebookInstanceStatusHasBeenSet = true;
    m_notebookInstanceStatus = value;
  }
  inline DescribeNotebookInstanceResult& WithNotebookInstanceStatus(NotebookInstanceStatus value) {
    SetNotebookInstanceStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNotebookInstanceResult& WithInstanceType(InstanceType value) {
  ...
  inline DescribeNotebookInstanceResult& WithIpAddressType(IPAddressType value) {
  ...
  inline void SetDirectInternetAccess(DirectInternetAccess value) {
    m_directInternetAccessHasBeenSet = true;
    m_directInternetAccess = value;
  }
  inline DescribeNotebookInstanceResult& WithDirectInternetAccess(DirectInternetAccess value) {
    SetDirectInternetAccess(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNotebookInstanceResult& WithVolumeSizeInGB(int value) {
  ...
  inline DescribeNotebookInstanceResult& AddAcceleratorTypes(NotebookInstanceAcceleratorType value) {
    m_acceleratorTypesHasBeenSet = true;
  ...
  inline DescribeNotebookInstanceResult& WithRootAccess(RootAccess value) {
    SetRootAccess(value);
    return *this;
  }
  ///@}
