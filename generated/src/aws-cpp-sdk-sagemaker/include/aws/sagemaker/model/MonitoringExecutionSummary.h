...
class MonitoringExecutionSummary {
 public:
  ...
  inline void SetMonitoringExecutionStatus(ExecutionStatus value) {
    m_monitoringExecutionStatusHasBeenSet = true;
    m_monitoringExecutionStatus = value;
  }
  inline MonitoringExecutionSummary& WithMonitoringExecutionStatus(ExecutionStatus value) {
    SetMonitoringExecutionStatus(value);
    return *this;
  }
  ///@}
  ...
  inline MonitoringExecutionSummary& WithMonitoringType(MonitoringType value) {
