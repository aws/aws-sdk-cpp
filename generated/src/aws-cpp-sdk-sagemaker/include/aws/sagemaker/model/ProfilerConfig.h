...
class ProfilerConfig {
 public:
  ...
  inline void SetProfilingIntervalInMilliseconds(long long value) {
    m_profilingIntervalInMillisecondsHasBeenSet = true;
    m_profilingIntervalInMilliseconds = value;
  }
  inline ProfilerConfig& WithProfilingIntervalInMilliseconds(long long value) {
    SetProfilingIntervalInMilliseconds(value);
    return *this;
  }
  ///@}
  ...
  void SetProfilingParameters(ProfilingParametersT&& value) {
    ...
    m_profilingParameters = std::forward<ProfilingParametersT>(value);
  }
  template <typename ProfilingParametersT = Aws::Map<Aws::String, Aws::String>>
  ProfilerConfig& WithProfilingParameters(ProfilingParametersT&& value) {
    SetProfilingParameters(std::forward<ProfilingParametersT>(value));
    return *this;
  }
  ...
  ProfilerConfig& AddProfilingParameters(ProfilingParametersKeyT&& key, ProfilingParametersValueT&& value) {
    m_profilingParametersHasBeenSet = true;
    m_profilingParameters.emplace(std::forward<ProfilingParametersKeyT>(key), std::forward<ProfilingParametersValueT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisableProfiler(bool value) {
    m_disableProfilerHasBeenSet = true;
    m_disableProfiler = value;
  }
  inline ProfilerConfig& WithDisableProfiler(bool value) {
    SetDisableProfiler(value);
    return *this;
  }
  ///@}
 private:
