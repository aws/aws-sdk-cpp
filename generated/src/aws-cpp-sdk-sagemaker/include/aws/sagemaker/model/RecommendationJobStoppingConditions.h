...
class RecommendationJobStoppingConditions {
 public:
  ...
  inline void SetMaxInvocations(int value) {
    m_maxInvocationsHasBeenSet = true;
    m_maxInvocations = value;
  }
  inline RecommendationJobStoppingConditions& WithMaxInvocations(int value) {
    SetMaxInvocations(value);
    return *this;
  }
  ///@}
  ...
  void SetModelLatencyThresholds(ModelLatencyThresholdsT&& value) {
    ...
    m_modelLatencyThresholds = std::forward<ModelLatencyThresholdsT>(value);
  }
  template <typename ModelLatencyThresholdsT = Aws::Vector<ModelLatencyThreshold>>
  RecommendationJobStoppingConditions& WithModelLatencyThresholds(ModelLatencyThresholdsT&& value) {
    SetModelLatencyThresholds(std::forward<ModelLatencyThresholdsT>(value));
    return *this;
  }
  ...
  RecommendationJobStoppingConditions& AddModelLatencyThresholds(ModelLatencyThresholdsT&& value) {
    m_modelLatencyThresholdsHasBeenSet = true;
    m_modelLatencyThresholds.emplace_back(std::forward<ModelLatencyThresholdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetFlatInvocations(FlatInvocations value) {
    m_flatInvocationsHasBeenSet = true;
    m_flatInvocations = value;
  }
  inline RecommendationJobStoppingConditions& WithFlatInvocations(FlatInvocations value) {
    SetFlatInvocations(value);
    return *this;
  }
  ///@}
 private:
