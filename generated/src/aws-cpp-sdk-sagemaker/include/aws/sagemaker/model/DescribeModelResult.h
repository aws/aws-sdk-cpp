...
class DescribeModelResult {
 public:
  ...
  inline DescribeModelResult& WithEnableNetworkIsolation(bool value) {
  ...
  void SetDeploymentRecommendation(DeploymentRecommendationT&& value) {
    ...
    m_deploymentRecommendation = std::forward<DeploymentRecommendationT>(value);
  }
  template <typename DeploymentRecommendationT = DeploymentRecommendation>
  DescribeModelResult& WithDeploymentRecommendation(DeploymentRecommendationT&& value) {
    SetDeploymentRecommendation(std::forward<DeploymentRecommendationT>(value));
    return *this;
  }
  ///@}
