...
class AlgorithmSpecification {
 public:
  ...
  void SetTrainingImage(TrainingImageT&& value) {
    ...
    m_trainingImage = std::forward<TrainingImageT>(value);
  }
  template <typename TrainingImageT = Aws::String>
  AlgorithmSpecification& WithTrainingImage(TrainingImageT&& value) {
    SetTrainingImage(std::forward<TrainingImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlgorithmName(AlgorithmNameT&& value) {
    ...
    m_algorithmName = std::forward<AlgorithmNameT>(value);
  }
  template <typename AlgorithmNameT = Aws::String>
  AlgorithmSpecification& WithAlgorithmName(AlgorithmNameT&& value) {
    SetAlgorithmName(std::forward<AlgorithmNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline AlgorithmSpecification& WithTrainingInputMode(TrainingInputMode value) {
  ...
  void SetMetricDefinitions(MetricDefinitionsT&& value) {
    ...
    m_metricDefinitions = std::forward<MetricDefinitionsT>(value);
  }
  template <typename MetricDefinitionsT = Aws::Vector<MetricDefinition>>
  AlgorithmSpecification& WithMetricDefinitions(MetricDefinitionsT&& value) {
    SetMetricDefinitions(std::forward<MetricDefinitionsT>(value));
    return *this;
  }
  ...
  AlgorithmSpecification& AddMetricDefinitions(MetricDefinitionsT&& value) {
    m_metricDefinitionsHasBeenSet = true;
    m_metricDefinitions.emplace_back(std::forward<MetricDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableSageMakerMetricsTimeSeries(bool value) {
    m_enableSageMakerMetricsTimeSeriesHasBeenSet = true;
    m_enableSageMakerMetricsTimeSeries = value;
  }
  inline AlgorithmSpecification& WithEnableSageMakerMetricsTimeSeries(bool value) {
    SetEnableSageMakerMetricsTimeSeries(value);
    return *this;
  }
  ///@}
  ...
  void SetContainerEntrypoint(ContainerEntrypointT&& value) {
    ...
    m_containerEntrypoint = std::forward<ContainerEntrypointT>(value);
  }
  template <typename ContainerEntrypointT = Aws::Vector<Aws::String>>
  AlgorithmSpecification& WithContainerEntrypoint(ContainerEntrypointT&& value) {
    SetContainerEntrypoint(std::forward<ContainerEntrypointT>(value));
    return *this;
  }
  ...
  AlgorithmSpecification& AddContainerEntrypoint(ContainerEntrypointT&& value) {
    m_containerEntrypointHasBeenSet = true;
    m_containerEntrypoint.emplace_back(std::forward<ContainerEntrypointT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingImageConfig(TrainingImageConfigT&& value) {
    ...
    m_trainingImageConfig = std::forward<TrainingImageConfigT>(value);
  }
  template <typename TrainingImageConfigT = TrainingImageConfig>
  AlgorithmSpecification& WithTrainingImageConfig(TrainingImageConfigT&& value) {
    SetTrainingImageConfig(std::forward<TrainingImageConfigT>(value));
    return *this;
  }
  ///@}
 private:
