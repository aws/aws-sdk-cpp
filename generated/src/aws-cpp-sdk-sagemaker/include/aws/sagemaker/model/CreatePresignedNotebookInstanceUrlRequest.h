...
class CreatePresignedNotebookInstanceUrlRequest : public SageMakerRequest {
 public:
  ...
  template <typename NotebookInstanceNameT = Aws::String>
  CreatePresignedNotebookInstanceUrlRequest& WithNotebookInstanceName(NotebookInstanceNameT&& value) {
  ...
  inline CreatePresignedNotebookInstanceUrlRequest& WithSessionExpirationDurationInSeconds(int value) {
