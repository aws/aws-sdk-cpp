...
class DescribeHubContentResult {
 public:
  ...
  inline DescribeHubContentResult& WithHubContentType(HubContentType value) {
  ...
  inline DescribeHubContentResult& WithSupportStatus(HubContentSupportStatus value) {
  ...
  inline DescribeHubContentResult& WithHubContentStatus(HubContentStatus value) {
