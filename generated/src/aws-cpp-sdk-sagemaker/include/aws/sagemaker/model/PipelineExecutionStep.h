...
class PipelineExecutionStep {
 public:
  ...
  void SetStepDisplayName(StepDisplayNameT&& value) {
    ...
    m_stepDisplayName = std::forward<StepDisplayNameT>(value);
  }
  template <typename StepDisplayNameT = Aws::String>
  PipelineExecutionStep& WithStepDisplayName(StepDisplayNameT&& value) {
    SetStepDisplayName(std::forward<StepDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStepDescription(StepDescriptionT&& value) {
    ...
    m_stepDescription = std::forward<StepDescriptionT>(value);
  }
  template <typename StepDescriptionT = Aws::String>
  PipelineExecutionStep& WithStepDescription(StepDescriptionT&& value) {
    SetStepDescription(std::forward<StepDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipelineExecutionStep& WithStepStatus(StepStatus value) {
    SetStepStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCacheHitResult(CacheHitResultT&& value) {
    ...
    m_cacheHitResult = std::forward<CacheHitResultT>(value);
  }
  template <typename CacheHitResultT = CacheHitResult>
  PipelineExecutionStep& WithCacheHitResult(CacheHitResultT&& value) {
    SetCacheHitResult(std::forward<CacheHitResultT>(value));
    return *this;
  }
  ///@}
  ...
  inline PipelineExecutionStep& WithAttemptCount(int value) {
  ...
  void SetSelectiveExecutionResult(SelectiveExecutionResultT&& value) {
    ...
    m_selectiveExecutionResult = std::forward<SelectiveExecutionResultT>(value);
  }
  template <typename SelectiveExecutionResultT = SelectiveExecutionResult>
  PipelineExecutionStep& WithSelectiveExecutionResult(SelectiveExecutionResultT&& value) {
    SetSelectiveExecutionResult(std::forward<SelectiveExecutionResultT>(value));
    return *this;
  }
  ///@}
 private:
