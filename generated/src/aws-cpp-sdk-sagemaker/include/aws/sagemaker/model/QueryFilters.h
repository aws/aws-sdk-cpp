...
class QueryFilters {
 public:
  ...
  template <typename TypesT = Aws::Vector<Aws::String>>
  QueryFilters& WithTypes(TypesT&& value) {
    SetTypes(std::forward<TypesT>(value));
    return *this;
  }
  template <typename TypesT = Aws::String>
  QueryFilters& AddTypes(TypesT&& value) {
    m_typesHasBeenSet = true;
  ...
  void SetLineageTypes(LineageTypesT&& value) {
    m_lineageTypesHasBeenSet = true;
    m_lineageTypes = std::forward<LineageTypesT>(value);
  }
  template <typename LineageTypesT = Aws::Vector<LineageType>>
  QueryFilters& WithLineageTypes(LineageTypesT&& value) {
    SetLineageTypes(std::forward<LineageTypesT>(value));
    return *this;
  }
  inline QueryFilters& AddLineageTypes(LineageType value) {
    m_lineageTypesHasBeenSet = true;
    m_lineageTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedBeforeT = Aws::Utils::DateTime>
  QueryFilters& WithCreatedBefore(CreatedBeforeT&& value) {
  ...
  template <typename CreatedAfterT = Aws::Utils::DateTime>
  QueryFilters& WithCreatedAfter(CreatedAfterT&& value) {
  ...
  void SetModifiedBefore(ModifiedBeforeT&& value) {
    m_modifiedBeforeHasBeenSet = true;
    m_modifiedBefore = std::forward<ModifiedBeforeT>(value);
  }
  template <typename ModifiedBeforeT = Aws::Utils::DateTime>
  QueryFilters& WithModifiedBefore(ModifiedBeforeT&& value) {
    SetModifiedBefore(std::forward<ModifiedBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModifiedAfter(ModifiedAfterT&& value) {
    m_modifiedAfterHasBeenSet = true;
    m_modifiedAfter = std::forward<ModifiedAfterT>(value);
  }
  template <typename ModifiedAfterT = Aws::Utils::DateTime>
  QueryFilters& WithModifiedAfter(ModifiedAfterT&& value) {
    SetModifiedAfter(std::forward<ModifiedAfterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PropertiesT = Aws::Map<Aws::String, Aws::String>>
  QueryFilters& WithProperties(PropertiesT&& value) {
