...
class AutoMLChannel {
 public:
  ...
  inline AutoMLChannel& WithCompressionType(CompressionType value) {
  ...
  inline void SetChannelType(AutoMLChannelType value) {
    m_channelTypeHasBeenSet = true;
    m_channelType = value;
  }
  inline AutoMLChannel& WithChannelType(AutoMLChannelType value) {
