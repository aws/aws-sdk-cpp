...
class ListCodeRepositoriesRequest : public SageMakerRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListCodeRepositoriesRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListCodeRepositoriesRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListCodeRepositoriesRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListCodeRepositoriesRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  inline ListCodeRepositoriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListCodeRepositoriesRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeRepositoriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCodeRepositoriesRequest& WithSortBy(CodeRepositorySortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(CodeRepositorySortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListCodeRepositoriesRequest& WithSortOrder(CodeRepositorySortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
