...
class FeatureDefinition {
 public:
  ...
  inline FeatureDefinition& WithFeatureType(FeatureType value) {
  ...
  inline void SetCollectionType(CollectionType value) {
    m_collectionTypeHasBeenSet = true;
    m_collectionType = value;
  }
  inline FeatureDefinition& WithCollectionType(CollectionType value) {
  ...
  void SetCollectionConfig(CollectionConfigT&& value) {
    ...
    m_collectionConfig = std::forward<CollectionConfigT>(value);
  }
  template <typename CollectionConfigT = CollectionConfig>
  FeatureDefinition& WithCollectionConfig(CollectionConfigT&& value) {
    SetCollectionConfig(std::forward<CollectionConfigT>(value));
    return *this;
  }
  ///@}
 private:
