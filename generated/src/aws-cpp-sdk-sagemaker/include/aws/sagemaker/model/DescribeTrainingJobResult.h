...
class DescribeTrainingJobResult {
 public:
  ...
  void SetTrainingJobName(TrainingJobNameT&& value) {
    ...
    m_trainingJobName = std::forward<TrainingJobNameT>(value);
  }
  template <typename TrainingJobNameT = Aws::String>
  DescribeTrainingJobResult& WithTrainingJobName(TrainingJobNameT&& value) {
    SetTrainingJobName(std::forward<TrainingJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTuningJobArn(TuningJobArnT&& value) {
    ...
    m_tuningJobArn = std::forward<TuningJobArnT>(value);
  }
  template <typename TuningJobArnT = Aws::String>
  DescribeTrainingJobResult& WithTuningJobArn(TuningJobArnT&& value) {
    SetTuningJobArn(std::forward<TuningJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelingJobArn(LabelingJobArnT&& value) {
    ...
    m_labelingJobArn = std::forward<LabelingJobArnT>(value);
  }
  template <typename LabelingJobArnT = Aws::String>
  DescribeTrainingJobResult& WithLabelingJobArn(LabelingJobArnT&& value) {
    SetLabelingJobArn(std::forward<LabelingJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelArtifacts(ModelArtifactsT&& value) {
    ...
    m_modelArtifacts = std::forward<ModelArtifactsT>(value);
  }
  template <typename ModelArtifactsT = ModelArtifacts>
  DescribeTrainingJobResult& WithModelArtifacts(ModelArtifactsT&& value) {
    SetModelArtifacts(std::forward<ModelArtifactsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrainingJobStatus(TrainingJobStatus value) {
    m_trainingJobStatusHasBeenSet = true;
    m_trainingJobStatus = value;
  }
  inline DescribeTrainingJobResult& WithTrainingJobStatus(TrainingJobStatus value) {
    SetTrainingJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSecondaryStatus(SecondaryStatus value) {
    m_secondaryStatusHasBeenSet = true;
    m_secondaryStatus = value;
  }
  inline DescribeTrainingJobResult& WithSecondaryStatus(SecondaryStatus value) {
  ...
  void SetAlgorithmSpecification(AlgorithmSpecificationT&& value) {
    ...
    m_algorithmSpecification = std::forward<AlgorithmSpecificationT>(value);
  }
  template <typename AlgorithmSpecificationT = AlgorithmSpecification>
  DescribeTrainingJobResult& WithAlgorithmSpecification(AlgorithmSpecificationT&& value) {
    SetAlgorithmSpecification(std::forward<AlgorithmSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingStartTime(TrainingStartTimeT&& value) {
    ...
    m_trainingStartTime = std::forward<TrainingStartTimeT>(value);
  }
  template <typename TrainingStartTimeT = Aws::Utils::DateTime>
  DescribeTrainingJobResult& WithTrainingStartTime(TrainingStartTimeT&& value) {
    SetTrainingStartTime(std::forward<TrainingStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingEndTime(TrainingEndTimeT&& value) {
    ...
    m_trainingEndTime = std::forward<TrainingEndTimeT>(value);
  }
  template <typename TrainingEndTimeT = Aws::Utils::DateTime>
  DescribeTrainingJobResult& WithTrainingEndTime(TrainingEndTimeT&& value) {
    SetTrainingEndTime(std::forward<TrainingEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFinalMetricDataList(FinalMetricDataListT&& value) {
    ...
    m_finalMetricDataList = std::forward<FinalMetricDataListT>(value);
  }
  template <typename FinalMetricDataListT = Aws::Vector<MetricData>>
  DescribeTrainingJobResult& WithFinalMetricDataList(FinalMetricDataListT&& value) {
    SetFinalMetricDataList(std::forward<FinalMetricDataListT>(value));
    return *this;
  }
  ...
  DescribeTrainingJobResult& AddFinalMetricDataList(FinalMetricDataListT&& value) {
    m_finalMetricDataListHasBeenSet = true;
    m_finalMetricDataList.emplace_back(std::forward<FinalMetricDataListT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTrainingJobResult& WithEnableNetworkIsolation(bool value) {
  ...
  inline void SetEnableInterContainerTrafficEncryption(bool value) {
    m_enableInterContainerTrafficEncryptionHasBeenSet = true;
    m_enableInterContainerTrafficEncryption = value;
  }
  inline DescribeTrainingJobResult& WithEnableInterContainerTrafficEncryption(bool value) {
    SetEnableInterContainerTrafficEncryption(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeTrainingJobResult& WithEnableManagedSpotTraining(bool value) {
  ...
  void SetCheckpointConfig(CheckpointConfigT&& value) {
    ...
    m_checkpointConfig = std::forward<CheckpointConfigT>(value);
  }
  template <typename CheckpointConfigT = CheckpointConfig>
  DescribeTrainingJobResult& WithCheckpointConfig(CheckpointConfigT&& value) {
    SetCheckpointConfig(std::forward<CheckpointConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrainingTimeInSeconds(int value) {
    m_trainingTimeInSecondsHasBeenSet = true;
    m_trainingTimeInSeconds = value;
  }
  inline DescribeTrainingJobResult& WithTrainingTimeInSeconds(int value) {
    SetTrainingTimeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBillableTimeInSeconds(int value) {
    m_billableTimeInSecondsHasBeenSet = true;
    m_billableTimeInSeconds = value;
  }
  inline DescribeTrainingJobResult& WithBillableTimeInSeconds(int value) {
    SetBillableTimeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetDebugHookConfig(DebugHookConfigT&& value) {
    ...
    m_debugHookConfig = std::forward<DebugHookConfigT>(value);
  }
  template <typename DebugHookConfigT = DebugHookConfig>
  DescribeTrainingJobResult& WithDebugHookConfig(DebugHookConfigT&& value) {
    SetDebugHookConfig(std::forward<DebugHookConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExperimentConfig(ExperimentConfigT&& value) {
    ...
    m_experimentConfig = std::forward<ExperimentConfigT>(value);
  }
  template <typename ExperimentConfigT = ExperimentConfig>
  DescribeTrainingJobResult& WithExperimentConfig(ExperimentConfigT&& value) {
    SetExperimentConfig(std::forward<ExperimentConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDebugRuleConfigurations(DebugRuleConfigurationsT&& value) {
    ...
    m_debugRuleConfigurations = std::forward<DebugRuleConfigurationsT>(value);
  }
  template <typename DebugRuleConfigurationsT = Aws::Vector<DebugRuleConfiguration>>
  DescribeTrainingJobResult& WithDebugRuleConfigurations(DebugRuleConfigurationsT&& value) {
    SetDebugRuleConfigurations(std::forward<DebugRuleConfigurationsT>(value));
    return *this;
  }
  ...
  DescribeTrainingJobResult& AddDebugRuleConfigurations(DebugRuleConfigurationsT&& value) {
    m_debugRuleConfigurationsHasBeenSet = true;
    m_debugRuleConfigurations.emplace_back(std::forward<DebugRuleConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTensorBoardOutputConfig(TensorBoardOutputConfigT&& value) {
    ...
    m_tensorBoardOutputConfig = std::forward<TensorBoardOutputConfigT>(value);
  }
  template <typename TensorBoardOutputConfigT = TensorBoardOutputConfig>
  DescribeTrainingJobResult& WithTensorBoardOutputConfig(TensorBoardOutputConfigT&& value) {
    SetTensorBoardOutputConfig(std::forward<TensorBoardOutputConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDebugRuleEvaluationStatuses(DebugRuleEvaluationStatusesT&& value) {
    ...
    m_debugRuleEvaluationStatuses = std::forward<DebugRuleEvaluationStatusesT>(value);
  }
  template <typename DebugRuleEvaluationStatusesT = Aws::Vector<DebugRuleEvaluationStatus>>
  DescribeTrainingJobResult& WithDebugRuleEvaluationStatuses(DebugRuleEvaluationStatusesT&& value) {
    SetDebugRuleEvaluationStatuses(std::forward<DebugRuleEvaluationStatusesT>(value));
    return *this;
  }
  ...
  DescribeTrainingJobResult& AddDebugRuleEvaluationStatuses(DebugRuleEvaluationStatusesT&& value) {
    m_debugRuleEvaluationStatusesHasBeenSet = true;
    m_debugRuleEvaluationStatuses.emplace_back(std::forward<DebugRuleEvaluationStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProfilerConfig(ProfilerConfigT&& value) {
    ...
    m_profilerConfig = std::forward<ProfilerConfigT>(value);
  }
  template <typename ProfilerConfigT = ProfilerConfig>
  DescribeTrainingJobResult& WithProfilerConfig(ProfilerConfigT&& value) {
    SetProfilerConfig(std::forward<ProfilerConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProfilerRuleConfigurations(ProfilerRuleConfigurationsT&& value) {
    ...
    m_profilerRuleConfigurations = std::forward<ProfilerRuleConfigurationsT>(value);
  }
  template <typename ProfilerRuleConfigurationsT = Aws::Vector<ProfilerRuleConfiguration>>
  DescribeTrainingJobResult& WithProfilerRuleConfigurations(ProfilerRuleConfigurationsT&& value) {
    SetProfilerRuleConfigurations(std::forward<ProfilerRuleConfigurationsT>(value));
    return *this;
  }
  ...
  DescribeTrainingJobResult& AddProfilerRuleConfigurations(ProfilerRuleConfigurationsT&& value) {
    m_profilerRuleConfigurationsHasBeenSet = true;
    m_profilerRuleConfigurations.emplace_back(std::forward<ProfilerRuleConfigurationsT>(value));
    return *this;
  }
  ///@}
   ...
   * training job.</p>
   */
  inline const Aws::Vector<ProfilerRuleEvaluationStatus>& GetProfilerRuleEvaluationStatuses() const {
    return m_profilerRuleEvaluationStatuses;
  }
  ...
  void SetProfilerRuleEvaluationStatuses(ProfilerRuleEvaluationStatusesT&& value) {
    ...
    m_profilerRuleEvaluationStatuses = std::forward<ProfilerRuleEvaluationStatusesT>(value);
  }
  template <typename ProfilerRuleEvaluationStatusesT = Aws::Vector<ProfilerRuleEvaluationStatus>>
  DescribeTrainingJobResult& WithProfilerRuleEvaluationStatuses(ProfilerRuleEvaluationStatusesT&& value) {
    SetProfilerRuleEvaluationStatuses(std::forward<ProfilerRuleEvaluationStatusesT>(value));
    return *this;
  }
  ...
  DescribeTrainingJobResult& AddProfilerRuleEvaluationStatuses(ProfilerRuleEvaluationStatusesT&& value) {
    m_profilerRuleEvaluationStatusesHasBeenSet = true;
    m_profilerRuleEvaluationStatuses.emplace_back(std::forward<ProfilerRuleEvaluationStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProfilingStatus(ProfilingStatus value) {
    m_profilingStatusHasBeenSet = true;
    m_profilingStatus = value;
  }
  inline DescribeTrainingJobResult& WithProfilingStatus(ProfilingStatus value) {
    SetProfilingStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetRetryStrategy(RetryStrategyT&& value) {
    ...
    m_retryStrategy = std::forward<RetryStrategyT>(value);
  }
  template <typename RetryStrategyT = RetryStrategy>
  ...
  void SetRemoteDebugConfig(RemoteDebugConfigT&& value) {
    ...
    m_remoteDebugConfig = std::forward<RemoteDebugConfigT>(value);
  }
  template <typename RemoteDebugConfigT = RemoteDebugConfig>
  DescribeTrainingJobResult& WithRemoteDebugConfig(RemoteDebugConfigT&& value) {
    SetRemoteDebugConfig(std::forward<RemoteDebugConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInfraCheckConfig(InfraCheckConfigT&& value) {
    ...
    m_infraCheckConfig = std::forward<InfraCheckConfigT>(value);
  }
  template <typename InfraCheckConfigT = InfraCheckConfig>
  DescribeTrainingJobResult& WithInfraCheckConfig(InfraCheckConfigT&& value) {
    SetInfraCheckConfig(std::forward<InfraCheckConfigT>(value));
    return *this;
  }
  ///@}
