...
class HubContentDependency {
 public:
  ...
  void SetDependencyOriginPath(DependencyOriginPathT&& value) {
    ...
    m_dependencyOriginPath = std::forward<DependencyOriginPathT>(value);
  }
  template <typename DependencyOriginPathT = Aws::String>
  HubContentDependency& WithDependencyOriginPath(DependencyOriginPathT&& value) {
    SetDependencyOriginPath(std::forward<DependencyOriginPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDependencyCopyPath(DependencyCopyPathT&& value) {
    ...
    m_dependencyCopyPath = std::forward<DependencyCopyPathT>(value);
  }
  template <typename DependencyCopyPathT = Aws::String>
  HubContentDependency& WithDependencyCopyPath(DependencyCopyPathT&& value) {
    SetDependencyCopyPath(std::forward<DependencyCopyPathT>(value));
    return *this;
  }
  ///@}
 private:
