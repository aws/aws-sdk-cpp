...
class TrainingImageConfig {
 public:
  ...
  inline void SetTrainingRepositoryAccessMode(TrainingRepositoryAccessMode value) {
    m_trainingRepositoryAccessModeHasBeenSet = true;
    m_trainingRepositoryAccessMode = value;
  }
  inline TrainingImageConfig& WithTrainingRepositoryAccessMode(TrainingRepositoryAccessMode value) {
    SetTrainingRepositoryAccessMode(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingRepositoryAuthConfig(TrainingRepositoryAuthConfigT&& value) {
    ...
    m_trainingRepositoryAuthConfig = std::forward<TrainingRepositoryAuthConfigT>(value);
  }
  template <typename TrainingRepositoryAuthConfigT = TrainingRepositoryAuthConfig>
  TrainingImageConfig& WithTrainingRepositoryAuthConfig(TrainingRepositoryAuthConfigT&& value) {
    SetTrainingRepositoryAuthConfig(std::forward<TrainingRepositoryAuthConfigT>(value));
    return *this;
  }
  ///@}
 private:
