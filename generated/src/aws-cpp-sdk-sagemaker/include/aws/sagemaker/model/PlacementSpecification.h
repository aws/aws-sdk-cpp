...
class PlacementSpecification {
 public:
  ...
  void SetUltraServerId(UltraServerIdT&& value) {
    ...
    m_ultraServerId = std::forward<UltraServerIdT>(value);
  }
  template <typename UltraServerIdT = Aws::String>
  PlacementSpecification& WithUltraServerId(UltraServerIdT&& value) {
    SetUltraServerId(std::forward<UltraServerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline PlacementSpecification& WithInstanceCount(int value) {
