...
class ProductionVariantCapacityReservationConfig {
 public:
  ...
  inline ProductionVariantCapacityReservationConfig& WithCapacityReservationPreference(CapacityReservationPreference value) {
  ...
  template <typename MlReservationArnT = Aws::String>
  ProductionVariantCapacityReservationConfig& WithMlReservationArn(MlReservationArnT&& value) {
