...
class TrainingRepositoryAuthConfig {
 public:
  ...
  void SetTrainingRepositoryCredentialsProviderArn(TrainingRepositoryCredentialsProviderArnT&& value) {
    m_trainingRepositoryCredentialsProviderArnHasBeenSet = true;
    m_trainingRepositoryCredentialsProviderArn = std::forward<TrainingRepositoryCredentialsProviderArnT>(value);
  }
  template <typename TrainingRepositoryCredentialsProviderArnT = Aws::String>
  TrainingRepositoryAuthConfig& WithTrainingRepositoryCredentialsProviderArn(TrainingRepositoryCredentialsProviderArnT&& value) {
    SetTrainingRepositoryCredentialsProviderArn(std::forward<TrainingRepositoryCredentialsProviderArnT>(value));
    return *this;
  }
  ///@}
 private:
