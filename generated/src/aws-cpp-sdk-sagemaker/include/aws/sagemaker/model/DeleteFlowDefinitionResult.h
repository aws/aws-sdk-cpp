...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteFlowDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteFlowDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
