...
class CfnCreateTemplateProvider {
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  CfnCreateTemplateProvider& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateURLT = Aws::String>
  CfnCreateTemplateProvider& WithTemplateURL(TemplateURLT&& value) {
  ...
  template <typename RoleARNT = Aws::String>
  CfnCreateTemplateProvider& WithRoleARN(RoleARNT&& value) {
  ...
  template <typename ParametersT = Aws::Vector<CfnStackCreateParameter>>
  CfnCreateTemplateProvider& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = CfnStackCreateParameter>
  CfnCreateTemplateProvider& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
