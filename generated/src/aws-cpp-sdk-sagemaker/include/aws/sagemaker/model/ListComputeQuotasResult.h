...
class ListComputeQuotasResult {
 public:
  ...
  void SetComputeQuotaSummaries(ComputeQuotaSummariesT&& value) {
    m_computeQuotaSummariesHasBeenSet = true;
    m_computeQuotaSummaries = std::forward<ComputeQuotaSummariesT>(value);
  }
  template <typename ComputeQuotaSummariesT = Aws::Vector<ComputeQuotaSummary>>
  ListComputeQuotasResult& WithComputeQuotaSummaries(ComputeQuotaSummariesT&& value) {
    SetComputeQuotaSummaries(std::forward<ComputeQuotaSummariesT>(value));
    return *this;
  }
  template <typename ComputeQuotaSummariesT = ComputeQuotaSummary>
  ListComputeQuotasResult& AddComputeQuotaSummaries(ComputeQuotaSummariesT&& value) {
    m_computeQuotaSummariesHasBeenSet = true;
    m_computeQuotaSummaries.emplace_back(std::forward<ComputeQuotaSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListComputeQuotasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListComputeQuotasResult& WithRequestId(RequestIdT&& value) {
