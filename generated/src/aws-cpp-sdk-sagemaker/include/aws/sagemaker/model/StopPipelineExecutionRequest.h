...
class StopPipelineExecutionRequest : public SageMakerRequest {
 public:
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  StopPipelineExecutionRequest& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  StopPipelineExecutionRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
