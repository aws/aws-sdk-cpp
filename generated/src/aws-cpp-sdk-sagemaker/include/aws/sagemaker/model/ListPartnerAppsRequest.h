...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API ListPartnerAppsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListPartnerAppsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
