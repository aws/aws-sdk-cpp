...
class AutoMLDataSplitConfig {
 public:
  ...
  inline void SetValidationFraction(double value) {
    m_validationFractionHasBeenSet = true;
    m_validationFraction = value;
  }
  inline AutoMLDataSplitConfig& WithValidationFraction(double value) {
    SetValidationFraction(value);
    return *this;
  }
  ///@}
 private:
