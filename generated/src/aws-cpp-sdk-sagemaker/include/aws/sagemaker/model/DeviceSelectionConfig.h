...
class DeviceSelectionConfig {
 public:
  ...
  inline void SetDeviceSubsetType(DeviceSubsetType value) {
    m_deviceSubsetTypeHasBeenSet = true;
    m_deviceSubsetType = value;
  }
  inline DeviceSelectionConfig& WithDeviceSubsetType(DeviceSubsetType value) {
    SetDeviceSubsetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPercentage(int value) {
    m_percentageHasBeenSet = true;
    m_percentage = value;
  }
  inline DeviceSelectionConfig& WithPercentage(int value) {
    SetPercentage(value);
    return *this;
  }
  ///@}
  ...
  void SetDeviceNames(DeviceNamesT&& value) {
    m_deviceNamesHasBeenSet = true;
    m_deviceNames = std::forward<DeviceNamesT>(value);
  }
  template <typename DeviceNamesT = Aws::Vector<Aws::String>>
  DeviceSelectionConfig& WithDeviceNames(DeviceNamesT&& value) {
    SetDeviceNames(std::forward<DeviceNamesT>(value));
    return *this;
  }
  template <typename DeviceNamesT = Aws::String>
  DeviceSelectionConfig& AddDeviceNames(DeviceNamesT&& value) {
    m_deviceNamesHasBeenSet = true;
    m_deviceNames.emplace_back(std::forward<DeviceNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceNameContains(DeviceNameContainsT&& value) {
    ...
    m_deviceNameContains = std::forward<DeviceNameContainsT>(value);
  }
  template <typename DeviceNameContainsT = Aws::String>
  DeviceSelectionConfig& WithDeviceNameContains(DeviceNameContainsT&& value) {
    SetDeviceNameContains(std::forward<DeviceNameContainsT>(value));
    return *this;
  }
  ///@}
 private:
