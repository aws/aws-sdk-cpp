...
class ListHubsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(HubSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListHubsRequest& WithSortBy(HubSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
