...
class RetryPipelineExecutionRequest : public SageMakerRequest {
 public:
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  RetryPipelineExecutionRequest& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
  ...
  template <typename ClientRequestTokenT = Aws::String>
  RetryPipelineExecutionRequest& WithClientRequestToken(ClientRequestTokenT&& value) {
  ...
  template <typename ParallelismConfigurationT = ParallelismConfiguration>
  RetryPipelineExecutionRequest& WithParallelismConfiguration(ParallelismConfigurationT&& value) {
