...
class CreateEdgeDeploymentStageRequest : public SageMakerRequest {
 public:
  ...
  template <typename EdgeDeploymentPlanNameT = Aws::String>
  CreateEdgeDeploymentStageRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) {
  ...
  template <typename StagesT = Aws::Vector<DeploymentStage>>
  CreateEdgeDeploymentStageRequest& WithStages(StagesT&& value) {
    SetStages(std::forward<StagesT>(value));
    return *this;
  }
  template <typename StagesT = DeploymentStage>
  CreateEdgeDeploymentStageRequest& AddStages(StagesT&& value) {
    m_stagesHasBeenSet = true;
