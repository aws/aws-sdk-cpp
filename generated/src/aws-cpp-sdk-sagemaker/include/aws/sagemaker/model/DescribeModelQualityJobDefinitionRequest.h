...
class DescribeModelQualityJobDefinitionRequest : public SageMakerRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DescribeModelQualityJobDefinition"; }
  ...
  template <typename JobDefinitionNameT = Aws::String>
  DescribeModelQualityJobDefinitionRequest& WithJobDefinitionName(JobDefinitionNameT&& value) {
