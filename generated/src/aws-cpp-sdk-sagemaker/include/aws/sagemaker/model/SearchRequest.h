...
class SearchRequest : public SageMakerRequest {
 public:
  ...
  inline SearchRequest& WithResource(ResourceType value) {
    SetResource(value);
    return *this;
  }
  ///@}
  ...
  template <typename SearchExpressionT = SearchExpression>
  SearchRequest& WithSearchExpression(SearchExpressionT&& value) {
  ...
  template <typename SortByT = Aws::String>
  SearchRequest& WithSortBy(SortByT&& value) {
  ...
  inline void SetSortOrder(SearchSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline SearchRequest& WithSortOrder(SearchSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline SearchRequest& WithCrossAccountFilterOption(CrossAccountFilterOption value) {
  ...
  void SetVisibilityConditions(VisibilityConditionsT&& value) {
    m_visibilityConditionsHasBeenSet = true;
    m_visibilityConditions = std::forward<VisibilityConditionsT>(value);
  }
  template <typename VisibilityConditionsT = Aws::Vector<VisibilityConditions>>
  SearchRequest& WithVisibilityConditions(VisibilityConditionsT&& value) {
    SetVisibilityConditions(std::forward<VisibilityConditionsT>(value));
    return *this;
  }
  template <typename VisibilityConditionsT = VisibilityConditions>
  SearchRequest& AddVisibilityConditions(VisibilityConditionsT&& value) {
    m_visibilityConditionsHasBeenSet = true;
    m_visibilityConditions.emplace_back(std::forward<VisibilityConditionsT>(value));
    return *this;
  }
  ///@}
 private:
