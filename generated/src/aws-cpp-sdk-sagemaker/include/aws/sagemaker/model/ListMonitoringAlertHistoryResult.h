...
class ListMonitoringAlertHistoryResult {
 public:
  ...
  void SetMonitoringAlertHistory(MonitoringAlertHistoryT&& value) {
    m_monitoringAlertHistoryHasBeenSet = true;
    m_monitoringAlertHistory = std::forward<MonitoringAlertHistoryT>(value);
  }
  template <typename MonitoringAlertHistoryT = Aws::Vector<MonitoringAlertHistorySummary>>
  ListMonitoringAlertHistoryResult& WithMonitoringAlertHistory(MonitoringAlertHistoryT&& value) {
    SetMonitoringAlertHistory(std::forward<MonitoringAlertHistoryT>(value));
    return *this;
  }
  template <typename MonitoringAlertHistoryT = MonitoringAlertHistorySummary>
  ListMonitoringAlertHistoryResult& AddMonitoringAlertHistory(MonitoringAlertHistoryT&& value) {
    m_monitoringAlertHistoryHasBeenSet = true;
    m_monitoringAlertHistory.emplace_back(std::forward<MonitoringAlertHistoryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoringAlertHistoryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMonitoringAlertHistoryResult& WithRequestId(RequestIdT&& value) {
