...
class ListProjectsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(ProjectSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListProjectsRequest& WithSortBy(ProjectSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(ProjectSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListProjectsRequest& WithSortOrder(ProjectSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
