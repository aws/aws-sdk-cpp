...
class DisassociateTrialComponentResult {
 public:
  ...
  template <typename TrialComponentArnT = Aws::String>
  DisassociateTrialComponentResult& WithTrialComponentArn(TrialComponentArnT&& value) {
  ...
  template <typename TrialArnT = Aws::String>
  DisassociateTrialComponentResult& WithTrialArn(TrialArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateTrialComponentResult& WithRequestId(RequestIdT&& value) {
