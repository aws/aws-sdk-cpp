...
class ListPipelineExecutionsRequest : public SageMakerRequest {
 public:
   ...
   */
  inline SortPipelineExecutionsBy GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(SortPipelineExecutionsBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListPipelineExecutionsRequest& WithSortBy(SortPipelineExecutionsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListPipelineExecutionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  SortPipelineExecutionsBy m_sortBy{SortPipelineExecutionsBy::NOT_SET};
