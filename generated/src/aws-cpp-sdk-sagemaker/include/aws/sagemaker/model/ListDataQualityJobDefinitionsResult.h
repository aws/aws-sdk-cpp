...
class ListDataQualityJobDefinitionsResult {
 public:
  ...
  template <typename JobDefinitionSummariesT = Aws::Vector<MonitoringJobDefinitionSummary>>
  ListDataQualityJobDefinitionsResult& WithJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
  ...
  ListDataQualityJobDefinitionsResult& AddJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    m_jobDefinitionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListDataQualityJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
