...
class ListHubContentVersionsRequest : public SageMakerRequest {
 public:
  ...
  template <typename HubNameT = Aws::String>
  ListHubContentVersionsRequest& WithHubName(HubNameT&& value) {
  ...
  inline ListHubContentVersionsRequest& WithHubContentType(HubContentType value) {
  ...
  template <typename HubContentNameT = Aws::String>
  ListHubContentVersionsRequest& WithHubContentName(HubContentNameT&& value) {
  ...
  template <typename MinVersionT = Aws::String>
  ListHubContentVersionsRequest& WithMinVersion(MinVersionT&& value) {
  ...
  template <typename MaxSchemaVersionT = Aws::String>
  ListHubContentVersionsRequest& WithMaxSchemaVersion(MaxSchemaVersionT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListHubContentVersionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListHubContentVersionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  inline ListHubContentVersionsRequest& WithSortBy(HubContentSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubContentVersionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubContentVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHubContentVersionsRequest& WithNextToken(NextTokenT&& value) {
