...
class ListCodeRepositoriesResult {
 public:
  ...
  void SetCodeRepositorySummaryList(CodeRepositorySummaryListT&& value) {
    m_codeRepositorySummaryListHasBeenSet = true;
    m_codeRepositorySummaryList = std::forward<CodeRepositorySummaryListT>(value);
  }
  template <typename CodeRepositorySummaryListT = Aws::Vector<CodeRepositorySummary>>
  ListCodeRepositoriesResult& WithCodeRepositorySummaryList(CodeRepositorySummaryListT&& value) {
    SetCodeRepositorySummaryList(std::forward<CodeRepositorySummaryListT>(value));
    return *this;
  }
  template <typename CodeRepositorySummaryListT = CodeRepositorySummary>
  ListCodeRepositoriesResult& AddCodeRepositorySummaryList(CodeRepositorySummaryListT&& value) {
    m_codeRepositorySummaryListHasBeenSet = true;
    m_codeRepositorySummaryList.emplace_back(std::forward<CodeRepositorySummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCodeRepositoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodeRepositoriesResult& WithRequestId(RequestIdT&& value) {
