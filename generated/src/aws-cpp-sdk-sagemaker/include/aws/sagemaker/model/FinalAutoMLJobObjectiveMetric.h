...
class FinalAutoMLJobObjectiveMetric {
 public:
  ...
  inline void SetType(AutoMLJobObjectiveType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline FinalAutoMLJobObjectiveMetric& WithType(AutoMLJobObjectiveType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline FinalAutoMLJobObjectiveMetric& WithMetricName(AutoMLMetricEnum value) {
    SetMetricName(value);
    return *this;
  }
  ///@}
  ...
  inline FinalAutoMLJobObjectiveMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStandardMetricName(AutoMLMetricEnum value) {
    m_standardMetricNameHasBeenSet = true;
    m_standardMetricName = value;
  }
  inline FinalAutoMLJobObjectiveMetric& WithStandardMetricName(AutoMLMetricEnum value) {
