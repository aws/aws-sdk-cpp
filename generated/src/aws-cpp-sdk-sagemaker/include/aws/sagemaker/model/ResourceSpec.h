...
class ResourceSpec {
 public:
  ...
  void SetSageMakerImageArn(SageMakerImageArnT&& value) {
    ...
    m_sageMakerImageArn = std::forward<SageMakerImageArnT>(value);
  }
  template <typename SageMakerImageArnT = Aws::String>
  ResourceSpec& WithSageMakerImageArn(SageMakerImageArnT&& value) {
    SetSageMakerImageArn(std::forward<SageMakerImageArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSageMakerImageVersionArn(SageMakerImageVersionArnT&& value) {
    ...
    m_sageMakerImageVersionArn = std::forward<SageMakerImageVersionArnT>(value);
  }
  template <typename SageMakerImageVersionArnT = Aws::String>
  ResourceSpec& WithSageMakerImageVersionArn(SageMakerImageVersionArnT&& value) {
    SetSageMakerImageVersionArn(std::forward<SageMakerImageVersionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSageMakerImageVersionAlias(SageMakerImageVersionAliasT&& value) {
    ...
    m_sageMakerImageVersionAlias = std::forward<SageMakerImageVersionAliasT>(value);
  }
  template <typename SageMakerImageVersionAliasT = Aws::String>
  ResourceSpec& WithSageMakerImageVersionAlias(SageMakerImageVersionAliasT&& value) {
    SetSageMakerImageVersionAlias(std::forward<SageMakerImageVersionAliasT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceType(AppInstanceType value) {
    m_instanceTypeHasBeenSet = true;
    m_instanceType = value;
  }
  inline ResourceSpec& WithInstanceType(AppInstanceType value) {
  ...
  void SetLifecycleConfigArn(LifecycleConfigArnT&& value) {
    ...
    m_lifecycleConfigArn = std::forward<LifecycleConfigArnT>(value);
  }
  template <typename LifecycleConfigArnT = Aws::String>
  ResourceSpec& WithLifecycleConfigArn(LifecycleConfigArnT&& value) {
    SetLifecycleConfigArn(std::forward<LifecycleConfigArnT>(value));
    return *this;
  }
  ///@}
 private:
