...
class EnvironmentParameterRanges {
 public:
  ...
  template <typename CategoricalParameterRangesT = Aws::Vector<CategoricalParameter>>
  EnvironmentParameterRanges& WithCategoricalParameterRanges(CategoricalParameterRangesT&& value) {
  ...
  EnvironmentParameterRanges& AddCategoricalParameterRanges(CategoricalParameterRangesT&& value) {
    m_categoricalParameterRangesHasBeenSet = true;
