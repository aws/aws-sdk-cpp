...
class HyperParameterTuningJobConfig {
 public:
  ...
  inline HyperParameterTuningJobConfig& WithStrategy(HyperParameterTuningJobStrategyType value) {
    SetStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetStrategyConfig(StrategyConfigT&& value) {
    ...
    m_strategyConfig = std::forward<StrategyConfigT>(value);
  }
  template <typename StrategyConfigT = HyperParameterTuningJobStrategyConfig>
  HyperParameterTuningJobConfig& WithStrategyConfig(StrategyConfigT&& value) {
    SetStrategyConfig(std::forward<StrategyConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHyperParameterTuningJobObjective(HyperParameterTuningJobObjectiveT&& value) {
    ...
    m_hyperParameterTuningJobObjective = std::forward<HyperParameterTuningJobObjectiveT>(value);
  }
  template <typename HyperParameterTuningJobObjectiveT = HyperParameterTuningJobObjective>
  HyperParameterTuningJobConfig& WithHyperParameterTuningJobObjective(HyperParameterTuningJobObjectiveT&& value) {
    SetHyperParameterTuningJobObjective(std::forward<HyperParameterTuningJobObjectiveT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrainingJobEarlyStoppingType(TrainingJobEarlyStoppingType value) {
    m_trainingJobEarlyStoppingTypeHasBeenSet = true;
    m_trainingJobEarlyStoppingType = value;
  }
  inline HyperParameterTuningJobConfig& WithTrainingJobEarlyStoppingType(TrainingJobEarlyStoppingType value) {
    SetTrainingJobEarlyStoppingType(value);
    return *this;
  }
  ///@}
  ...
  void SetTuningJobCompletionCriteria(TuningJobCompletionCriteriaT&& value) {
    ...
    m_tuningJobCompletionCriteria = std::forward<TuningJobCompletionCriteriaT>(value);
  }
  template <typename TuningJobCompletionCriteriaT = TuningJobCompletionCriteria>
  HyperParameterTuningJobConfig& WithTuningJobCompletionCriteria(TuningJobCompletionCriteriaT&& value) {
    SetTuningJobCompletionCriteria(std::forward<TuningJobCompletionCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  inline HyperParameterTuningJobConfig& WithRandomSeed(int value) {
    SetRandomSeed(value);
    return *this;
  }
  ///@}
