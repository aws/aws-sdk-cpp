...
class AmazonQSettings {
 public:
  ...
  inline AmazonQSettings& WithStatus(FeatureStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetQProfileArn(QProfileArnT&& value) {
    m_qProfileArnHasBeenSet = true;
    m_qProfileArn = std::forward<QProfileArnT>(value);
  }
  template <typename QProfileArnT = Aws::String>
  AmazonQSettings& WithQProfileArn(QProfileArnT&& value) {
    SetQProfileArn(std::forward<QProfileArnT>(value));
    return *this;
  }
  ///@}
 private:
