...
class GetLineageGroupPolicyResult {
 public:
  ...
  template <typename LineageGroupArnT = Aws::String>
  GetLineageGroupPolicyResult& WithLineageGroupArn(LineageGroupArnT&& value) {
  ...
  template <typename ResourcePolicyT = Aws::String>
  GetLineageGroupPolicyResult& WithResourcePolicy(ResourcePolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetLineageGroupPolicyResult& WithRequestId(RequestIdT&& value) {
