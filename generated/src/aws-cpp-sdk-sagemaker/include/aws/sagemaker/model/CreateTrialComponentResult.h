...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API CreateTrialComponentResult() = default;
    ...
    template<typename TrialComponentArnT = Aws::String>
    CreateTrialComponentResult& WithTrialComponentArn(TrialComponentArnT&& value) { SetTrialComponentArn(std::forward<TrialComponentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateTrialComponentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
