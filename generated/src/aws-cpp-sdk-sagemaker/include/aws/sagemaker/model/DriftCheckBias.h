...
class DriftCheckBias {
 public:
  ...
  void SetPreTrainingConstraints(PreTrainingConstraintsT&& value) {
    ...
    m_preTrainingConstraints = std::forward<PreTrainingConstraintsT>(value);
  }
  template <typename PreTrainingConstraintsT = MetricsSource>
  DriftCheckBias& WithPreTrainingConstraints(PreTrainingConstraintsT&& value) {
    SetPreTrainingConstraints(std::forward<PreTrainingConstraintsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostTrainingConstraints(PostTrainingConstraintsT&& value) {
    ...
    m_postTrainingConstraints = std::forward<PostTrainingConstraintsT>(value);
  }
  template <typename PostTrainingConstraintsT = MetricsSource>
  DriftCheckBias& WithPostTrainingConstraints(PostTrainingConstraintsT&& value) {
    SetPostTrainingConstraints(std::forward<PostTrainingConstraintsT>(value));
    return *this;
  }
  ///@}
 private:
