...
class ListClusterNodesResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterNodesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetClusterNodeSummaries(ClusterNodeSummariesT&& value) {
    m_clusterNodeSummariesHasBeenSet = true;
    m_clusterNodeSummaries = std::forward<ClusterNodeSummariesT>(value);
  }
  template <typename ClusterNodeSummariesT = Aws::Vector<ClusterNodeSummary>>
  ListClusterNodesResult& WithClusterNodeSummaries(ClusterNodeSummariesT&& value) {
    SetClusterNodeSummaries(std::forward<ClusterNodeSummariesT>(value));
    return *this;
  }
  template <typename ClusterNodeSummariesT = ClusterNodeSummary>
  ListClusterNodesResult& AddClusterNodeSummaries(ClusterNodeSummariesT&& value) {
    m_clusterNodeSummariesHasBeenSet = true;
    m_clusterNodeSummaries.emplace_back(std::forward<ClusterNodeSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListClusterNodesResult& WithRequestId(RequestIdT&& value) {
