...
class BatchDataCaptureConfig {
 public:
  ...
  template <typename DestinationS3UriT = Aws::String>
  BatchDataCaptureConfig& WithDestinationS3Uri(DestinationS3UriT&& value) {
  ...
  template <typename KmsKeyIdT = Aws::String>
  BatchDataCaptureConfig& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  inline void SetGenerateInferenceId(bool value) {
    m_generateInferenceIdHasBeenSet = true;
    m_generateInferenceId = value;
  }
  inline BatchDataCaptureConfig& WithGenerateInferenceId(bool value) {
    SetGenerateInferenceId(value);
    return *this;
  }
  ///@}
 private:
