...
class EndpointInputConfiguration {
 public:
  ...
  inline EndpointInputConfiguration& WithInstanceType(ProductionVariantInstanceType value) {
  ...
  void SetEnvironmentParameterRanges(EnvironmentParameterRangesT&& value) {
    ...
    m_environmentParameterRanges = std::forward<EnvironmentParameterRangesT>(value);
  }
  template <typename EnvironmentParameterRangesT = EnvironmentParameterRanges>
  EndpointInputConfiguration& WithEnvironmentParameterRanges(EnvironmentParameterRangesT&& value) {
    SetEnvironmentParameterRanges(std::forward<EnvironmentParameterRangesT>(value));
    return *this;
  }
  ///@}
 private:
