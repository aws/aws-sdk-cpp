...
class SubscribedWorkteam {
 public:
  ...
  void SetMarketplaceTitle(MarketplaceTitleT&& value) {
    ...
    m_marketplaceTitle = std::forward<MarketplaceTitleT>(value);
  }
  template <typename MarketplaceTitleT = Aws::String>
  SubscribedWorkteam& WithMarketplaceTitle(MarketplaceTitleT&& value) {
    SetMarketplaceTitle(std::forward<MarketplaceTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSellerName(SellerNameT&& value) {
    ...
    m_sellerName = std::forward<SellerNameT>(value);
  }
  template <typename SellerNameT = Aws::String>
  SubscribedWorkteam& WithSellerName(SellerNameT&& value) {
    SetSellerName(std::forward<SellerNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMarketplaceDescription(MarketplaceDescriptionT&& value) {
    ...
    m_marketplaceDescription = std::forward<MarketplaceDescriptionT>(value);
  }
  template <typename MarketplaceDescriptionT = Aws::String>
  SubscribedWorkteam& WithMarketplaceDescription(MarketplaceDescriptionT&& value) {
    SetMarketplaceDescription(std::forward<MarketplaceDescriptionT>(value));
    return *this;
  }
  ///@}
