...
class LabelingJobForWorkteamSummary {
 public:
  ...
  void SetLabelingJobName(LabelingJobNameT&& value) {
    ...
    m_labelingJobName = std::forward<LabelingJobNameT>(value);
  }
  template <typename LabelingJobNameT = Aws::String>
  LabelingJobForWorkteamSummary& WithLabelingJobName(LabelingJobNameT&& value) {
    SetLabelingJobName(std::forward<LabelingJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJobReferenceCode(JobReferenceCodeT&& value) {
    ...
    m_jobReferenceCode = std::forward<JobReferenceCodeT>(value);
  }
  template <typename JobReferenceCodeT = Aws::String>
  LabelingJobForWorkteamSummary& WithJobReferenceCode(JobReferenceCodeT&& value) {
    SetJobReferenceCode(std::forward<JobReferenceCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkRequesterAccountId(WorkRequesterAccountIdT&& value) {
    ...
    m_workRequesterAccountId = std::forward<WorkRequesterAccountIdT>(value);
  }
  template <typename WorkRequesterAccountIdT = Aws::String>
  LabelingJobForWorkteamSummary& WithWorkRequesterAccountId(WorkRequesterAccountIdT&& value) {
    SetWorkRequesterAccountId(std::forward<WorkRequesterAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  LabelingJobForWorkteamSummary& WithCreationTime(CreationTimeT&& value) {
  ...
  void SetLabelCounters(LabelCountersT&& value) {
    ...
    m_labelCounters = std::forward<LabelCountersT>(value);
  }
  template <typename LabelCountersT = LabelCountersForWorkteam>
  LabelingJobForWorkteamSummary& WithLabelCounters(LabelCountersT&& value) {
    SetLabelCounters(std::forward<LabelCountersT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfHumanWorkersPerDataObject(int value) {
    m_numberOfHumanWorkersPerDataObjectHasBeenSet = true;
    m_numberOfHumanWorkersPerDataObject = value;
  }
  inline LabelingJobForWorkteamSummary& WithNumberOfHumanWorkersPerDataObject(int value) {
    SetNumberOfHumanWorkersPerDataObject(value);
    return *this;
  }
  ///@}
 private:
