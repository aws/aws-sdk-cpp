...
class MonitoringBaselineConfig {
 public:
  ...
  template <typename BaseliningJobNameT = Aws::String>
  MonitoringBaselineConfig& WithBaseliningJobName(BaseliningJobNameT&& value) {
  ...
  template <typename ConstraintsResourceT = MonitoringConstraintsResource>
  MonitoringBaselineConfig& WithConstraintsResource(ConstraintsResourceT&& value) {
  ...
  template <typename StatisticsResourceT = MonitoringStatisticsResource>
  MonitoringBaselineConfig& WithStatisticsResource(StatisticsResourceT&& value) {
