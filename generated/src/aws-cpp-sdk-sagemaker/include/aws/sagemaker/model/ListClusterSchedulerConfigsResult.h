...
class ListClusterSchedulerConfigsResult {
 public:
   ...
   */
  inline const Aws::Vector<ClusterSchedulerConfigSummary>& GetClusterSchedulerConfigSummaries() const {
    return m_clusterSchedulerConfigSummaries;
  }
  template <typename ClusterSchedulerConfigSummariesT = Aws::Vector<ClusterSchedulerConfigSummary>>
  void SetClusterSchedulerConfigSummaries(ClusterSchedulerConfigSummariesT&& value) {
    m_clusterSchedulerConfigSummariesHasBeenSet = true;
    m_clusterSchedulerConfigSummaries = std::forward<ClusterSchedulerConfigSummariesT>(value);
  }
  template <typename ClusterSchedulerConfigSummariesT = Aws::Vector<ClusterSchedulerConfigSummary>>
  ListClusterSchedulerConfigsResult& WithClusterSchedulerConfigSummaries(ClusterSchedulerConfigSummariesT&& value) {
    SetClusterSchedulerConfigSummaries(std::forward<ClusterSchedulerConfigSummariesT>(value));
    return *this;
  }
  template <typename ClusterSchedulerConfigSummariesT = ClusterSchedulerConfigSummary>
  ListClusterSchedulerConfigsResult& AddClusterSchedulerConfigSummaries(ClusterSchedulerConfigSummariesT&& value) {
    m_clusterSchedulerConfigSummariesHasBeenSet = true;
    m_clusterSchedulerConfigSummaries.emplace_back(std::forward<ClusterSchedulerConfigSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterSchedulerConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListClusterSchedulerConfigsResult& WithRequestId(RequestIdT&& value) {
