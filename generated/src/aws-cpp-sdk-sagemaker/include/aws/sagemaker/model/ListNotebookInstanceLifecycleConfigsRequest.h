...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListNotebookInstanceLifecycleConfigsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline void SetSortBy(NotebookInstanceLifecycleConfigSortKey value) { m_sortByHasBeenSet = true; m_sortBy = value; }
    inline ListNotebookInstanceLifecycleConfigsRequest& WithSortBy(NotebookInstanceLifecycleConfigSortKey value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline void SetSortOrder(NotebookInstanceLifecycleConfigSortOrder value) { m_sortOrderHasBeenSet = true; m_sortOrder = value; }
    inline ListNotebookInstanceLifecycleConfigsRequest& WithSortOrder(NotebookInstanceLifecycleConfigSortOrder value) { SetSortOrder(value); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListNotebookInstanceLifecycleConfigsRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeBeforeT = Aws::Utils::DateTime>
    ListNotebookInstanceLifecycleConfigsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) { SetCreationTimeBefore(std::forward<CreationTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeAfterT = Aws::Utils::DateTime>
    ListNotebookInstanceLifecycleConfigsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) { SetCreationTimeAfter(std::forward<CreationTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
    ListNotebookInstanceLifecycleConfigsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) { SetLastModifiedTimeBefore(std::forward<LastModifiedTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
    ListNotebookInstanceLifecycleConfigsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) { SetLastModifiedTimeAfter(std::forward<LastModifiedTimeAfterT>(value)); return *this;}
    ///@}
  private:
