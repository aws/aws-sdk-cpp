...
class ListNotebookInstanceLifecycleConfigsRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListNotebookInstanceLifecycleConfigsRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListNotebookInstanceLifecycleConfigsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListNotebookInstanceLifecycleConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   */
  inline NotebookInstanceLifecycleConfigSortKey GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(NotebookInstanceLifecycleConfigSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListNotebookInstanceLifecycleConfigsRequest& WithSortBy(NotebookInstanceLifecycleConfigSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
   ...
   */
  inline NotebookInstanceLifecycleConfigSortOrder GetSortOrder() const { return m_sortOrder; }
  inline bool SortOrderHasBeenSet() const { return m_sortOrderHasBeenSet; }
  inline void SetSortOrder(NotebookInstanceLifecycleConfigSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListNotebookInstanceLifecycleConfigsRequest& WithSortOrder(NotebookInstanceLifecycleConfigSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListNotebookInstanceLifecycleConfigsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListNotebookInstanceLifecycleConfigsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListNotebookInstanceLifecycleConfigsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListNotebookInstanceLifecycleConfigsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListNotebookInstanceLifecycleConfigsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
