...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteModelExplainabilityJobDefinitionRequest() = default;
    ...
    template<typename JobDefinitionNameT = Aws::String>
    DeleteModelExplainabilityJobDefinitionRequest& WithJobDefinitionName(JobDefinitionNameT&& value) { SetJobDefinitionName(std::forward<JobDefinitionNameT>(value)); return *this;}
    ///@}
  private:
