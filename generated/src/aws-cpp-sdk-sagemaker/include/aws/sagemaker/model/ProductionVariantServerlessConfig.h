...
class ProductionVariantServerlessConfig {
 public:
  ...
  inline void SetMemorySizeInMB(int value) {
    m_memorySizeInMBHasBeenSet = true;
    m_memorySizeInMB = value;
  }
  inline ProductionVariantServerlessConfig& WithMemorySizeInMB(int value) {
    SetMemorySizeInMB(value);
    return *this;
  }
  ///@}
  ...
  inline ProductionVariantServerlessConfig& WithMaxConcurrency(int value) {
  ...
  inline void SetProvisionedConcurrency(int value) {
    m_provisionedConcurrencyHasBeenSet = true;
    m_provisionedConcurrency = value;
  }
  inline ProductionVariantServerlessConfig& WithProvisionedConcurrency(int value) {
    SetProvisionedConcurrency(value);
    return *this;
  }
  ///@}
 private:
