...
class HyperParameterTrainingJobDefinition {
 public:
  ...
  void SetDefinitionName(DefinitionNameT&& value) {
    ...
    m_definitionName = std::forward<DefinitionNameT>(value);
  }
  template <typename DefinitionNameT = Aws::String>
  HyperParameterTrainingJobDefinition& WithDefinitionName(DefinitionNameT&& value) {
    SetDefinitionName(std::forward<DefinitionNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTuningObjective(TuningObjectiveT&& value) {
    ...
    m_tuningObjective = std::forward<TuningObjectiveT>(value);
  }
  template <typename TuningObjectiveT = HyperParameterTuningJobObjective>
  HyperParameterTrainingJobDefinition& WithTuningObjective(TuningObjectiveT&& value) {
    SetTuningObjective(std::forward<TuningObjectiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHyperParameterRanges(HyperParameterRangesT&& value) {
    ...
    m_hyperParameterRanges = std::forward<HyperParameterRangesT>(value);
  }
  template <typename HyperParameterRangesT = ParameterRanges>
  HyperParameterTrainingJobDefinition& WithHyperParameterRanges(HyperParameterRangesT&& value) {
    SetHyperParameterRanges(std::forward<HyperParameterRangesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStaticHyperParameters(StaticHyperParametersT&& value) {
    ...
    m_staticHyperParameters = std::forward<StaticHyperParametersT>(value);
  }
  template <typename StaticHyperParametersT = Aws::Map<Aws::String, Aws::String>>
  HyperParameterTrainingJobDefinition& WithStaticHyperParameters(StaticHyperParametersT&& value) {
    SetStaticHyperParameters(std::forward<StaticHyperParametersT>(value));
    return *this;
  }
  ...
  HyperParameterTrainingJobDefinition& AddStaticHyperParameters(StaticHyperParametersKeyT&& key, StaticHyperParametersValueT&& value) {
    m_staticHyperParametersHasBeenSet = true;
    m_staticHyperParameters.emplace(std::forward<StaticHyperParametersKeyT>(key), std::forward<StaticHyperParametersValueT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const HyperParameterTuningResourceConfig& GetHyperParameterTuningResourceConfig() const {
    return m_hyperParameterTuningResourceConfig;
  }
  ...
  void SetHyperParameterTuningResourceConfig(HyperParameterTuningResourceConfigT&& value) {
    ...
    m_hyperParameterTuningResourceConfig = std::forward<HyperParameterTuningResourceConfigT>(value);
  }
  template <typename HyperParameterTuningResourceConfigT = HyperParameterTuningResourceConfig>
  HyperParameterTrainingJobDefinition& WithHyperParameterTuningResourceConfig(HyperParameterTuningResourceConfigT&& value) {
    SetHyperParameterTuningResourceConfig(std::forward<HyperParameterTuningResourceConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline HyperParameterTrainingJobDefinition& WithEnableNetworkIsolation(bool value) {
  ...
  inline HyperParameterTrainingJobDefinition& WithEnableInterContainerTrafficEncryption(bool value) {
  ...
  inline HyperParameterTrainingJobDefinition& WithEnableManagedSpotTraining(bool value) {
