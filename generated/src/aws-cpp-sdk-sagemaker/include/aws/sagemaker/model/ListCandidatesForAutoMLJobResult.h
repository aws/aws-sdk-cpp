...
class ListCandidatesForAutoMLJobResult {
 public:
  ...
  void SetCandidates(CandidatesT&& value) {
    m_candidatesHasBeenSet = true;
    m_candidates = std::forward<CandidatesT>(value);
  }
  template <typename CandidatesT = Aws::Vector<AutoMLCandidate>>
  ListCandidatesForAutoMLJobResult& WithCandidates(CandidatesT&& value) {
    SetCandidates(std::forward<CandidatesT>(value));
    return *this;
  }
  template <typename CandidatesT = AutoMLCandidate>
  ListCandidatesForAutoMLJobResult& AddCandidates(CandidatesT&& value) {
    m_candidatesHasBeenSet = true;
    m_candidates.emplace_back(std::forward<CandidatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCandidatesForAutoMLJobResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCandidatesForAutoMLJobResult& WithRequestId(RequestIdT&& value) {
