...
class RenderUiTemplateRequest : public SageMakerRequest {
 public:
  ...
  template <typename UiTemplateT = UiTemplate>
  RenderUiTemplateRequest& WithUiTemplate(UiTemplateT&& value) {
  ...
  template <typename TaskT = RenderableTask>
  RenderUiTemplateRequest& WithTask(TaskT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  RenderUiTemplateRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename HumanTaskUiArnT = Aws::String>
  RenderUiTemplateRequest& WithHumanTaskUiArn(HumanTaskUiArnT&& value) {
