...
class DataCaptureConfigSummary {
 public:
  ...
  inline DataCaptureConfigSummary& WithEnableCapture(bool value) {
  ...
  inline void SetCaptureStatus(CaptureStatus value) {
    m_captureStatusHasBeenSet = true;
    m_captureStatus = value;
  }
  inline DataCaptureConfigSummary& WithCaptureStatus(CaptureStatus value) {
  ...
  inline void SetCurrentSamplingPercentage(int value) {
    m_currentSamplingPercentageHasBeenSet = true;
    m_currentSamplingPercentage = value;
  }
  inline DataCaptureConfigSummary& WithCurrentSamplingPercentage(int value) {
    SetCurrentSamplingPercentage(value);
    return *this;
  }
  ///@}
