...
class TransformResources {
 public:
  ...
  inline void SetInstanceType(TransformInstanceType value) {
    m_instanceTypeHasBeenSet = true;
    m_instanceType = value;
  }
  inline TransformResources& WithInstanceType(TransformInstanceType value) {
  ...
  inline TransformResources& WithInstanceCount(int value) {
  ...
  void SetTransformAmiVersion(TransformAmiVersionT&& value) {
    ...
    m_transformAmiVersion = std::forward<TransformAmiVersionT>(value);
  }
  template <typename TransformAmiVersionT = Aws::String>
  TransformResources& WithTransformAmiVersion(TransformAmiVersionT&& value) {
    SetTransformAmiVersion(std::forward<TransformAmiVersionT>(value));
    return *this;
  }
  ///@}
 private:
