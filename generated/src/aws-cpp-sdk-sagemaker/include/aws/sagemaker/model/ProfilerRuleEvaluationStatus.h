...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API ProfilerRuleEvaluationStatus() = default;
    ...
    template<typename RuleConfigurationNameT = Aws::String>
    ProfilerRuleEvaluationStatus& WithRuleConfigurationName(RuleConfigurationNameT&& value) { SetRuleConfigurationName(std::forward<RuleConfigurationNameT>(value)); return *this;}
    ///@}
    ...
    template<typename RuleEvaluationJobArnT = Aws::String>
    ProfilerRuleEvaluationStatus& WithRuleEvaluationJobArn(RuleEvaluationJobArnT&& value) { SetRuleEvaluationJobArn(std::forward<RuleEvaluationJobArnT>(value)); return *this;}
    ///@}
    ...
    inline ProfilerRuleEvaluationStatus& WithRuleEvaluationStatus(RuleEvaluationStatus value) { SetRuleEvaluationStatus(value); return *this;}
    ///@}
    ...
    template<typename StatusDetailsT = Aws::String>
    ProfilerRuleEvaluationStatus& WithStatusDetails(StatusDetailsT&& value) { SetStatusDetails(std::forward<StatusDetailsT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeT = Aws::Utils::DateTime>
    ProfilerRuleEvaluationStatus& WithLastModifiedTime(LastModifiedTimeT&& value) { SetLastModifiedTime(std::forward<LastModifiedTimeT>(value)); return *this;}
    ///@}
  private:
