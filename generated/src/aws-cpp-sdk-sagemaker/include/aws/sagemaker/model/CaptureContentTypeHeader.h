...
class CaptureContentTypeHeader {
 public:
  ...
  void SetCsvContentTypes(CsvContentTypesT&& value) {
    m_csvContentTypesHasBeenSet = true;
    m_csvContentTypes = std::forward<CsvContentTypesT>(value);
  }
  template <typename CsvContentTypesT = Aws::Vector<Aws::String>>
  CaptureContentTypeHeader& WithCsvContentTypes(CsvContentTypesT&& value) {
    SetCsvContentTypes(std::forward<CsvContentTypesT>(value));
    return *this;
  }
  template <typename CsvContentTypesT = Aws::String>
  CaptureContentTypeHeader& AddCsvContentTypes(CsvContentTypesT&& value) {
    m_csvContentTypesHasBeenSet = true;
    m_csvContentTypes.emplace_back(std::forward<CsvContentTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJsonContentTypes(JsonContentTypesT&& value) {
    m_jsonContentTypesHasBeenSet = true;
    m_jsonContentTypes = std::forward<JsonContentTypesT>(value);
  }
  template <typename JsonContentTypesT = Aws::Vector<Aws::String>>
  CaptureContentTypeHeader& WithJsonContentTypes(JsonContentTypesT&& value) {
    SetJsonContentTypes(std::forward<JsonContentTypesT>(value));
    return *this;
  }
  template <typename JsonContentTypesT = Aws::String>
  CaptureContentTypeHeader& AddJsonContentTypes(JsonContentTypesT&& value) {
    m_jsonContentTypesHasBeenSet = true;
    m_jsonContentTypes.emplace_back(std::forward<JsonContentTypesT>(value));
    return *this;
  }
  ///@}
 private:
