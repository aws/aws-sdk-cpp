...
class CfnUpdateTemplateProvider {
 public:
  ...
  template <typename TemplateNameT = Aws::String>
  CfnUpdateTemplateProvider& WithTemplateName(TemplateNameT&& value) {
  ...
  template <typename TemplateURLT = Aws::String>
  CfnUpdateTemplateProvider& WithTemplateURL(TemplateURLT&& value) {
  ...
  template <typename ParametersT = Aws::Vector<CfnStackUpdateParameter>>
  CfnUpdateTemplateProvider& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = CfnStackUpdateParameter>
  CfnUpdateTemplateProvider& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
