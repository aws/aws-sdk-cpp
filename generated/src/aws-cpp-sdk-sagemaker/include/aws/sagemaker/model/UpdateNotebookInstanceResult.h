...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API UpdateNotebookInstanceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateNotebookInstanceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
