...
class DescribeAlgorithmResult {
 public:
  ...
  void SetAlgorithmDescription(AlgorithmDescriptionT&& value) {
    ...
    m_algorithmDescription = std::forward<AlgorithmDescriptionT>(value);
  }
  template <typename AlgorithmDescriptionT = Aws::String>
  DescribeAlgorithmResult& WithAlgorithmDescription(AlgorithmDescriptionT&& value) {
    SetAlgorithmDescription(std::forward<AlgorithmDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingSpecification(TrainingSpecificationT&& value) {
    ...
    m_trainingSpecification = std::forward<TrainingSpecificationT>(value);
  }
  template <typename TrainingSpecificationT = TrainingSpecification>
  DescribeAlgorithmResult& WithTrainingSpecification(TrainingSpecificationT&& value) {
    SetTrainingSpecification(std::forward<TrainingSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAlgorithmStatus(AlgorithmStatus value) {
    m_algorithmStatusHasBeenSet = true;
    m_algorithmStatus = value;
  }
  inline DescribeAlgorithmResult& WithAlgorithmStatus(AlgorithmStatus value) {
    SetAlgorithmStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetAlgorithmStatusDetails(AlgorithmStatusDetailsT&& value) {
    ...
    m_algorithmStatusDetails = std::forward<AlgorithmStatusDetailsT>(value);
  }
  template <typename AlgorithmStatusDetailsT = AlgorithmStatusDetails>
  DescribeAlgorithmResult& WithAlgorithmStatusDetails(AlgorithmStatusDetailsT&& value) {
    SetAlgorithmStatusDetails(std::forward<AlgorithmStatusDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAlgorithmResult& WithCertifyForMarketplace(bool value) {
