...
class ListEdgePackagingJobsResult {
 public:
  ...
  void SetEdgePackagingJobSummaries(EdgePackagingJobSummariesT&& value) {
    m_edgePackagingJobSummariesHasBeenSet = true;
    m_edgePackagingJobSummaries = std::forward<EdgePackagingJobSummariesT>(value);
  }
  template <typename EdgePackagingJobSummariesT = Aws::Vector<EdgePackagingJobSummary>>
  ListEdgePackagingJobsResult& WithEdgePackagingJobSummaries(EdgePackagingJobSummariesT&& value) {
    SetEdgePackagingJobSummaries(std::forward<EdgePackagingJobSummariesT>(value));
    return *this;
  }
  template <typename EdgePackagingJobSummariesT = EdgePackagingJobSummary>
  ListEdgePackagingJobsResult& AddEdgePackagingJobSummaries(EdgePackagingJobSummariesT&& value) {
    m_edgePackagingJobSummariesHasBeenSet = true;
    m_edgePackagingJobSummaries.emplace_back(std::forward<EdgePackagingJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEdgePackagingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEdgePackagingJobsResult& WithRequestId(RequestIdT&& value) {
