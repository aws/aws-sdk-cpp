...
namespace Model
{
  ...
  public:
    ...
    inline ListEdgePackagingJobsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListEdgePackagingJobsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListEdgePackagingJobsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
