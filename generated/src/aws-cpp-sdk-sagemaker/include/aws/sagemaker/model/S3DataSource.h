...
class S3DataSource {
 public:
  ...
  inline void SetS3DataType(S3DataType value) {
    m_s3DataTypeHasBeenSet = true;
    m_s3DataType = value;
  }
  inline S3DataSource& WithS3DataType(S3DataType value) {
    SetS3DataType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetS3DataDistributionType(S3DataDistribution value) {
    m_s3DataDistributionTypeHasBeenSet = true;
    m_s3DataDistributionType = value;
  }
  inline S3DataSource& WithS3DataDistributionType(S3DataDistribution value) {
    SetS3DataDistributionType(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceGroupNames(InstanceGroupNamesT&& value) {
    ...
    m_instanceGroupNames = std::forward<InstanceGroupNamesT>(value);
  }
  template <typename InstanceGroupNamesT = Aws::Vector<Aws::String>>
  S3DataSource& WithInstanceGroupNames(InstanceGroupNamesT&& value) {
    SetInstanceGroupNames(std::forward<InstanceGroupNamesT>(value));
    return *this;
  }
  template <typename InstanceGroupNamesT = Aws::String>
  S3DataSource& AddInstanceGroupNames(InstanceGroupNamesT&& value) {
    m_instanceGroupNamesHasBeenSet = true;
    m_instanceGroupNames.emplace_back(std::forward<InstanceGroupNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelAccessConfig(ModelAccessConfigT&& value) {
    ...
    m_modelAccessConfig = std::forward<ModelAccessConfigT>(value);
  }
  template <typename ModelAccessConfigT = ModelAccessConfig>
  S3DataSource& WithModelAccessConfig(ModelAccessConfigT&& value) {
    SetModelAccessConfig(std::forward<ModelAccessConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHubAccessConfig(HubAccessConfigT&& value) {
    ...
    m_hubAccessConfig = std::forward<HubAccessConfigT>(value);
  }
  template <typename HubAccessConfigT = HubAccessConfig>
  S3DataSource& WithHubAccessConfig(HubAccessConfigT&& value) {
    SetHubAccessConfig(std::forward<HubAccessConfigT>(value));
    return *this;
  }
  ///@}
 private:
