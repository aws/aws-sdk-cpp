...
class ListTransformJobsResult {
 public:
  ...
  void SetTransformJobSummaries(TransformJobSummariesT&& value) {
    m_transformJobSummariesHasBeenSet = true;
    m_transformJobSummaries = std::forward<TransformJobSummariesT>(value);
  }
  template <typename TransformJobSummariesT = Aws::Vector<TransformJobSummary>>
  ListTransformJobsResult& WithTransformJobSummaries(TransformJobSummariesT&& value) {
    SetTransformJobSummaries(std::forward<TransformJobSummariesT>(value));
    return *this;
  }
  template <typename TransformJobSummariesT = TransformJobSummary>
  ListTransformJobsResult& AddTransformJobSummaries(TransformJobSummariesT&& value) {
    m_transformJobSummariesHasBeenSet = true;
    m_transformJobSummaries.emplace_back(std::forward<TransformJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTransformJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTransformJobsResult& WithRequestId(RequestIdT&& value) {
