...
class EndpointOutputConfiguration {
 public:
  ...
  inline EndpointOutputConfiguration& WithInstanceType(ProductionVariantInstanceType value) {
  ...
  inline void SetInitialInstanceCount(int value) {
    m_initialInstanceCountHasBeenSet = true;
    m_initialInstanceCount = value;
  }
  inline EndpointOutputConfiguration& WithInitialInstanceCount(int value) {
    SetInitialInstanceCount(value);
    return *this;
  }
  ///@}
  ...
  void SetServerlessConfig(ServerlessConfigT&& value) {
    ...
    m_serverlessConfig = std::forward<ServerlessConfigT>(value);
  }
  template <typename ServerlessConfigT = ProductionVariantServerlessConfig>
  EndpointOutputConfiguration& WithServerlessConfig(ServerlessConfigT&& value) {
    SetServerlessConfig(std::forward<ServerlessConfigT>(value));
    return *this;
  }
  ///@}
 private:
