...
class RecommendationJobOutputConfig {
 public:
  ...
  void SetCompiledOutputConfig(CompiledOutputConfigT&& value) {
    m_compiledOutputConfigHasBeenSet = true;
    m_compiledOutputConfig = std::forward<CompiledOutputConfigT>(value);
  }
  template <typename CompiledOutputConfigT = RecommendationJobCompiledOutputConfig>
  RecommendationJobOutputConfig& WithCompiledOutputConfig(CompiledOutputConfigT&& value) {
    SetCompiledOutputConfig(std::forward<CompiledOutputConfigT>(value));
    return *this;
  }
  ///@}
 private:
