...
namespace Model
{
  ...
  public:
    ...
    template<typename PipelineExecutionArnT = Aws::String>
    SendPipelineExecutionStepFailureResult& WithPipelineExecutionArn(PipelineExecutionArnT&& value) { SetPipelineExecutionArn(std::forward<PipelineExecutionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    SendPipelineExecutionStepFailureResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
