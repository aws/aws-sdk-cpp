...
class ListModelBiasJobDefinitionsResult {
 public:
  ...
  template <typename JobDefinitionSummariesT = Aws::Vector<MonitoringJobDefinitionSummary>>
  ListModelBiasJobDefinitionsResult& WithJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
  ...
  ListModelBiasJobDefinitionsResult& AddJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    m_jobDefinitionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListModelBiasJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelBiasJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
