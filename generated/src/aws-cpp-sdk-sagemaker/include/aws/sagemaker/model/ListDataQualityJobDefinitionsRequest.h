...
class ListDataQualityJobDefinitionsRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListDataQualityJobDefinitionsRequest() = default;
  ...
  template <typename EndpointNameT = Aws::String>
  ListDataQualityJobDefinitionsRequest& WithEndpointName(EndpointNameT&& value) {
   ...
   */
  inline MonitoringJobDefinitionSortKey GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(MonitoringJobDefinitionSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListDataQualityJobDefinitionsRequest& WithSortBy(MonitoringJobDefinitionSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListDataQualityJobDefinitionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListDataQualityJobDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListDataQualityJobDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListDataQualityJobDefinitionsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListDataQualityJobDefinitionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListDataQualityJobDefinitionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
