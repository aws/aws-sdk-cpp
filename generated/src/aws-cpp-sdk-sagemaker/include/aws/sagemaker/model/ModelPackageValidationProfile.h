...
class ModelPackageValidationProfile {
 public:
  ...
  template <typename ProfileNameT = Aws::String>
  ModelPackageValidationProfile& WithProfileName(ProfileNameT&& value) {
  ...
  template <typename TransformJobDefinitionT = TransformJobDefinition>
  ModelPackageValidationProfile& WithTransformJobDefinition(TransformJobDefinitionT&& value) {
