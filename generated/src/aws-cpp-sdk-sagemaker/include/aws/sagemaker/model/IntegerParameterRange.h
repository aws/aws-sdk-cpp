...
class IntegerParameterRange {
 public:
  ...
  template <typename MinValueT = Aws::String>
  IntegerParameterRange& WithMinValue(MinValueT&& value) {
  ...
  template <typename MaxValueT = Aws::String>
  IntegerParameterRange& WithMaxValue(MaxValueT&& value) {
  ...
  inline void SetScalingType(HyperParameterScalingType value) {
    m_scalingTypeHasBeenSet = true;
    m_scalingType = value;
  }
  inline IntegerParameterRange& WithScalingType(HyperParameterScalingType value) {
