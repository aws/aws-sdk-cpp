...
class CreateDomainRequest : public SageMakerRequest {
 public:
  ...
  inline CreateDomainRequest& WithAuthMode(AuthMode value) {
    SetAuthMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateDomainRequest& WithAppNetworkAccessType(AppNetworkAccessType value) {
  ...
  inline CreateDomainRequest& WithAppSecurityGroupManagement(AppSecurityGroupManagement value) {
  ...
  inline CreateDomainRequest& WithTagPropagation(TagPropagation value) {
