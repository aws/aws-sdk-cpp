...
class ListHubContentVersionsResult {
 public:
  ...
  void SetHubContentSummaries(HubContentSummariesT&& value) {
    m_hubContentSummariesHasBeenSet = true;
    m_hubContentSummaries = std::forward<HubContentSummariesT>(value);
  }
  template <typename HubContentSummariesT = Aws::Vector<HubContentInfo>>
  ListHubContentVersionsResult& WithHubContentSummaries(HubContentSummariesT&& value) {
    SetHubContentSummaries(std::forward<HubContentSummariesT>(value));
    return *this;
  }
  template <typename HubContentSummariesT = HubContentInfo>
  ListHubContentVersionsResult& AddHubContentSummaries(HubContentSummariesT&& value) {
    m_hubContentSummariesHasBeenSet = true;
    m_hubContentSummaries.emplace_back(std::forward<HubContentSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHubContentVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHubContentVersionsResult& WithRequestId(RequestIdT&& value) {
