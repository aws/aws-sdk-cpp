...
class DescribeEndpointResult {
 public:
  ...
  inline DescribeEndpointResult& WithEndpointStatus(EndpointStatus value) {
  ...
  void SetPendingDeploymentSummary(PendingDeploymentSummaryT&& value) {
    ...
    m_pendingDeploymentSummary = std::forward<PendingDeploymentSummaryT>(value);
  }
  template <typename PendingDeploymentSummaryT = PendingDeploymentSummary>
  DescribeEndpointResult& WithPendingDeploymentSummary(PendingDeploymentSummaryT&& value) {
    SetPendingDeploymentSummary(std::forward<PendingDeploymentSummaryT>(value));
    return *this;
  }
  ///@}
