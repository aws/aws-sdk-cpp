...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeletePartnerAppResult() = default;
    ...
    template<typename ArnT = Aws::String>
    DeletePartnerAppResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeletePartnerAppResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
