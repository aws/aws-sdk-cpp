...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteModelBiasJobDefinitionRequest() = default;
    ...
    template<typename JobDefinitionNameT = Aws::String>
    DeleteModelBiasJobDefinitionRequest& WithJobDefinitionName(JobDefinitionNameT&& value) { SetJobDefinitionName(std::forward<JobDefinitionNameT>(value)); return *this;}
    ///@}
  private:
