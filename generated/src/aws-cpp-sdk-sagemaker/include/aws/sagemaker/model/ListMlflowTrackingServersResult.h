...
class ListMlflowTrackingServersResult {
 public:
  ...
  void SetTrackingServerSummaries(TrackingServerSummariesT&& value) {
    m_trackingServerSummariesHasBeenSet = true;
    m_trackingServerSummaries = std::forward<TrackingServerSummariesT>(value);
  }
  template <typename TrackingServerSummariesT = Aws::Vector<TrackingServerSummary>>
  ListMlflowTrackingServersResult& WithTrackingServerSummaries(TrackingServerSummariesT&& value) {
    SetTrackingServerSummaries(std::forward<TrackingServerSummariesT>(value));
    return *this;
  }
  template <typename TrackingServerSummariesT = TrackingServerSummary>
  ListMlflowTrackingServersResult& AddTrackingServerSummaries(TrackingServerSummariesT&& value) {
    m_trackingServerSummariesHasBeenSet = true;
    m_trackingServerSummaries.emplace_back(std::forward<TrackingServerSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMlflowTrackingServersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMlflowTrackingServersResult& WithRequestId(RequestIdT&& value) {
