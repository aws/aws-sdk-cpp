...
namespace SageMaker {
namespace Model {
class DeleteAIWorkloadConfigResult {
 public:
  AWS_SAGEMAKER_API DeleteAIWorkloadConfigResult() = default;
  AWS_SAGEMAKER_API DeleteAIWorkloadConfigResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SAGEMAKER_API DeleteAIWorkloadConfigResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AIWorkloadConfigArnT = Aws::String>
  DeleteAIWorkloadConfigResult& WithAIWorkloadConfigArn(AIWorkloadConfigArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAIWorkloadConfigResult& WithRequestId(RequestIdT&& value) {
