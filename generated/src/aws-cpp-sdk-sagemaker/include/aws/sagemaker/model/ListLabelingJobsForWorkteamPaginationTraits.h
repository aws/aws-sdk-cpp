...
struct ListLabelingJobsForWorkteamPaginationTraits {
  using RequestType = Model::ListLabelingJobsForWorkteamRequest;
  using ResultType = Model::ListLabelingJobsForWorkteamResult;
  using OutcomeType = Model::ListLabelingJobsForWorkteamOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->ListLabelingJobsForWorkteam(request); }
