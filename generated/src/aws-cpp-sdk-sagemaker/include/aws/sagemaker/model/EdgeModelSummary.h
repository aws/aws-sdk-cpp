...
namespace Model
{
  ...
  public:
    ...
    template<typename ModelNameT = Aws::String>
    EdgeModelSummary& WithModelName(ModelNameT&& value) { SetModelName(std::forward<ModelNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ModelVersionT = Aws::String>
    EdgeModelSummary& WithModelVersion(ModelVersionT&& value) { SetModelVersion(std::forward<ModelVersionT>(value)); return *this;}
    ///@}
  private:
