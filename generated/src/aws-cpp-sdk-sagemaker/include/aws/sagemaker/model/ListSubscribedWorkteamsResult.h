...
class ListSubscribedWorkteamsResult {
 public:
  ...
  void SetSubscribedWorkteams(SubscribedWorkteamsT&& value) {
    m_subscribedWorkteamsHasBeenSet = true;
    m_subscribedWorkteams = std::forward<SubscribedWorkteamsT>(value);
  }
  template <typename SubscribedWorkteamsT = Aws::Vector<SubscribedWorkteam>>
  ListSubscribedWorkteamsResult& WithSubscribedWorkteams(SubscribedWorkteamsT&& value) {
    SetSubscribedWorkteams(std::forward<SubscribedWorkteamsT>(value));
    return *this;
  }
  template <typename SubscribedWorkteamsT = SubscribedWorkteam>
  ListSubscribedWorkteamsResult& AddSubscribedWorkteams(SubscribedWorkteamsT&& value) {
    m_subscribedWorkteamsHasBeenSet = true;
    m_subscribedWorkteams.emplace_back(std::forward<SubscribedWorkteamsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscribedWorkteamsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSubscribedWorkteamsResult& WithRequestId(RequestIdT&& value) {
