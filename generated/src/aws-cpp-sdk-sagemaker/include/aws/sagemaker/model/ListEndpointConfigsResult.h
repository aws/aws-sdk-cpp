...
class ListEndpointConfigsResult {
 public:
  ...
  void SetEndpointConfigs(EndpointConfigsT&& value) {
    m_endpointConfigsHasBeenSet = true;
    m_endpointConfigs = std::forward<EndpointConfigsT>(value);
  }
  template <typename EndpointConfigsT = Aws::Vector<EndpointConfigSummary>>
  ListEndpointConfigsResult& WithEndpointConfigs(EndpointConfigsT&& value) {
    SetEndpointConfigs(std::forward<EndpointConfigsT>(value));
    return *this;
  }
  template <typename EndpointConfigsT = EndpointConfigSummary>
  ListEndpointConfigsResult& AddEndpointConfigs(EndpointConfigsT&& value) {
    m_endpointConfigsHasBeenSet = true;
    m_endpointConfigs.emplace_back(std::forward<EndpointConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointConfigsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListEndpointConfigsResult& WithRequestId(RequestIdT&& value) {
