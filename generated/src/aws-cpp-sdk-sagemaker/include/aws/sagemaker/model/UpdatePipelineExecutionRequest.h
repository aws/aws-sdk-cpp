...
class UpdatePipelineExecutionRequest : public SageMakerRequest {
 public:
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  UpdatePipelineExecutionRequest& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
  ...
  template <typename PipelineExecutionDescriptionT = Aws::String>
  UpdatePipelineExecutionRequest& WithPipelineExecutionDescription(PipelineExecutionDescriptionT&& value) {
  ...
  template <typename PipelineExecutionDisplayNameT = Aws::String>
  UpdatePipelineExecutionRequest& WithPipelineExecutionDisplayName(PipelineExecutionDisplayNameT&& value) {
  ...
  template <typename ParallelismConfigurationT = ParallelismConfiguration>
  UpdatePipelineExecutionRequest& WithParallelismConfiguration(ParallelismConfigurationT&& value) {
