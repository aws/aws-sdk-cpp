...
class AutoMLContainerDefinition {
 public:
  ...
  template <typename ImageT = Aws::String>
  AutoMLContainerDefinition& WithImage(ImageT&& value) {
  ...
  template <typename ModelDataUrlT = Aws::String>
  AutoMLContainerDefinition& WithModelDataUrl(ModelDataUrlT&& value) {
  ...
  template <typename EnvironmentT = Aws::Map<Aws::String, Aws::String>>
  AutoMLContainerDefinition& WithEnvironment(EnvironmentT&& value) {
