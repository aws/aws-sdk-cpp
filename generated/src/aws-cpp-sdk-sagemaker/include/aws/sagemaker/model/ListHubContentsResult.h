...
class ListHubContentsResult {
 public:
  ...
  template <typename HubContentSummariesT = Aws::Vector<HubContentInfo>>
  ListHubContentsResult& WithHubContentSummaries(HubContentSummariesT&& value) {
    SetHubContentSummaries(std::forward<HubContentSummariesT>(value));
    return *this;
  }
  template <typename HubContentSummariesT = HubContentInfo>
  ListHubContentsResult& AddHubContentSummaries(HubContentSummariesT&& value) {
    m_hubContentSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListHubContentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHubContentsResult& WithRequestId(RequestIdT&& value) {
