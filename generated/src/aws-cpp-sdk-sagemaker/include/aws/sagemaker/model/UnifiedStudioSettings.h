...
class UnifiedStudioSettings {
 public:
  ...
  inline void SetStudioWebPortalAccess(FeatureStatus value) {
    m_studioWebPortalAccessHasBeenSet = true;
    m_studioWebPortalAccess = value;
  }
  inline UnifiedStudioSettings& WithStudioWebPortalAccess(FeatureStatus value) {
    SetStudioWebPortalAccess(value);
    return *this;
  }
  ///@}
  ...
  void SetDomainAccountId(DomainAccountIdT&& value) {
    ...
    m_domainAccountId = std::forward<DomainAccountIdT>(value);
  }
  template <typename DomainAccountIdT = Aws::String>
  UnifiedStudioSettings& WithDomainAccountId(DomainAccountIdT&& value) {
    SetDomainAccountId(std::forward<DomainAccountIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainRegion(DomainRegionT&& value) {
    ...
    m_domainRegion = std::forward<DomainRegionT>(value);
  }
  template <typename DomainRegionT = Aws::String>
  UnifiedStudioSettings& WithDomainRegion(DomainRegionT&& value) {
    SetDomainRegion(std::forward<DomainRegionT>(value));
    return *this;
  }
  ///@}
