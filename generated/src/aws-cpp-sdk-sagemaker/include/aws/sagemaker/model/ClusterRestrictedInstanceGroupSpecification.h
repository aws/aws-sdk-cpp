...
class ClusterRestrictedInstanceGroupSpecification {
 public:
  ...
  inline ClusterRestrictedInstanceGroupSpecification& WithInstanceCount(int value) {
  ...
  inline ClusterRestrictedInstanceGroupSpecification& WithInstanceType(ClusterInstanceType value) {
  ...
  inline ClusterRestrictedInstanceGroupSpecification& WithThreadsPerCore(int value) {
  ...
  inline ClusterRestrictedInstanceGroupSpecification& AddOnStartDeepHealthChecks(DeepHealthCheckType value) {
    m_onStartDeepHealthChecksHasBeenSet = true;
