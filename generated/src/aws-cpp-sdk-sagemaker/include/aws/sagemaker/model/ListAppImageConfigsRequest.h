...
class ListAppImageConfigsRequest : public SageMakerRequest {
 public:
  ...
  inline ListAppImageConfigsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAppImageConfigsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListAppImageConfigsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListAppImageConfigsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListAppImageConfigsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename ModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListAppImageConfigsRequest& WithModifiedTimeBefore(ModifiedTimeBeforeT&& value) {
  ...
  template <typename ModifiedTimeAfterT = Aws::Utils::DateTime>
  ListAppImageConfigsRequest& WithModifiedTimeAfter(ModifiedTimeAfterT&& value) {
  ...
  inline void SetSortBy(AppImageConfigSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListAppImageConfigsRequest& WithSortBy(AppImageConfigSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListAppImageConfigsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
