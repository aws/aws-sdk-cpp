...
class AutoMLJobConfig {
 public:
  ...
  void SetCompletionCriteria(CompletionCriteriaT&& value) {
    ...
    m_completionCriteria = std::forward<CompletionCriteriaT>(value);
  }
  template <typename CompletionCriteriaT = AutoMLJobCompletionCriteria>
  AutoMLJobConfig& WithCompletionCriteria(CompletionCriteriaT&& value) {
    SetCompletionCriteria(std::forward<CompletionCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCandidateGenerationConfig(CandidateGenerationConfigT&& value) {
    ...
    m_candidateGenerationConfig = std::forward<CandidateGenerationConfigT>(value);
  }
  template <typename CandidateGenerationConfigT = AutoMLCandidateGenerationConfig>
  AutoMLJobConfig& WithCandidateGenerationConfig(CandidateGenerationConfigT&& value) {
    SetCandidateGenerationConfig(std::forward<CandidateGenerationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataSplitConfig(DataSplitConfigT&& value) {
    ...
    m_dataSplitConfig = std::forward<DataSplitConfigT>(value);
  }
  template <typename DataSplitConfigT = AutoMLDataSplitConfig>
  AutoMLJobConfig& WithDataSplitConfig(DataSplitConfigT&& value) {
    SetDataSplitConfig(std::forward<DataSplitConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMode(AutoMLMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline AutoMLJobConfig& WithMode(AutoMLMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
