...
class ShadowModeConfig {
 public:
  ...
  void SetSourceModelVariantName(SourceModelVariantNameT&& value) {
    m_sourceModelVariantNameHasBeenSet = true;
    m_sourceModelVariantName = std::forward<SourceModelVariantNameT>(value);
  }
  template <typename SourceModelVariantNameT = Aws::String>
  ShadowModeConfig& WithSourceModelVariantName(SourceModelVariantNameT&& value) {
    SetSourceModelVariantName(std::forward<SourceModelVariantNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShadowModelVariants(ShadowModelVariantsT&& value) {
    m_shadowModelVariantsHasBeenSet = true;
    m_shadowModelVariants = std::forward<ShadowModelVariantsT>(value);
  }
  template <typename ShadowModelVariantsT = Aws::Vector<ShadowModelVariantConfig>>
  ShadowModeConfig& WithShadowModelVariants(ShadowModelVariantsT&& value) {
    SetShadowModelVariants(std::forward<ShadowModelVariantsT>(value));
    return *this;
  }
  template <typename ShadowModelVariantsT = ShadowModelVariantConfig>
  ShadowModeConfig& AddShadowModelVariants(ShadowModelVariantsT&& value) {
    m_shadowModelVariantsHasBeenSet = true;
    m_shadowModelVariants.emplace_back(std::forward<ShadowModelVariantsT>(value));
    return *this;
  }
  ///@}
 private:
