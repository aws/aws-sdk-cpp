...
class USD {
 public:
  ...
  inline void SetDollars(int value) {
    m_dollarsHasBeenSet = true;
    m_dollars = value;
  }
  inline USD& WithDollars(int value) {
    SetDollars(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCents(int value) {
    m_centsHasBeenSet = true;
    m_cents = value;
  }
  inline USD& WithCents(int value) {
    SetCents(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTenthFractionsOfACent(int value) {
    m_tenthFractionsOfACentHasBeenSet = true;
    m_tenthFractionsOfACent = value;
  }
  inline USD& WithTenthFractionsOfACent(int value) {
    SetTenthFractionsOfACent(value);
    return *this;
  }
  ///@}
 private:
