...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteWorkforceResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteWorkforceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
