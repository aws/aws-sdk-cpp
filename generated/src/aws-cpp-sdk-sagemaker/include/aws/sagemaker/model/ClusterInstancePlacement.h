...
class ClusterInstancePlacement {
 public:
  AWS_SAGEMAKER_API ClusterInstancePlacement() = default;
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ClusterInstancePlacement& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  ClusterInstancePlacement& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
