...
class FinalHyperParameterTuningJobObjectiveMetric {
 public:
  ...
  inline FinalHyperParameterTuningJobObjectiveMetric& WithType(HyperParameterTuningJobObjectiveType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename MetricNameT = Aws::String>
  FinalHyperParameterTuningJobObjectiveMetric& WithMetricName(MetricNameT&& value) {
  ...
  inline FinalHyperParameterTuningJobObjectiveMetric& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
