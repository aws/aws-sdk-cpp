...
class DescribeHyperParameterTuningJobResult {
 public:
  ...
  AWS_SAGEMAKER_API DescribeHyperParameterTuningJobResult& operator=(
  ...
  inline DescribeHyperParameterTuningJobResult& WithHyperParameterTuningJobStatus(HyperParameterTuningJobStatus value) {
