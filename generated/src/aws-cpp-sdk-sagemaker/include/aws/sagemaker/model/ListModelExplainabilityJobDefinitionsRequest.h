...
class ListModelExplainabilityJobDefinitionsRequest : public SageMakerRequest {
 public:
  ...
  template <typename EndpointNameT = Aws::String>
  ListModelExplainabilityJobDefinitionsRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  inline ListModelExplainabilityJobDefinitionsRequest& WithSortBy(MonitoringJobDefinitionSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelExplainabilityJobDefinitionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelExplainabilityJobDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelExplainabilityJobDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListModelExplainabilityJobDefinitionsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelExplainabilityJobDefinitionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelExplainabilityJobDefinitionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
