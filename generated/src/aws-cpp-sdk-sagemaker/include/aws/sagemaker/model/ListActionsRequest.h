...
class ListActionsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(SortActionsBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListActionsRequest& WithSortBy(SortActionsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListActionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
