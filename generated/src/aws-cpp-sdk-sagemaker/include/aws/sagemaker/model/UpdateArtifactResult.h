...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API UpdateArtifactResult() = default;
    ...
    template<typename ArtifactArnT = Aws::String>
    UpdateArtifactResult& WithArtifactArn(ArtifactArnT&& value) { SetArtifactArn(std::forward<ArtifactArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateArtifactResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
