...
class ListProcessingJobsResult {
 public:
  ...
  void SetProcessingJobSummaries(ProcessingJobSummariesT&& value) {
    m_processingJobSummariesHasBeenSet = true;
    m_processingJobSummaries = std::forward<ProcessingJobSummariesT>(value);
  }
  template <typename ProcessingJobSummariesT = Aws::Vector<ProcessingJobSummary>>
  ListProcessingJobsResult& WithProcessingJobSummaries(ProcessingJobSummariesT&& value) {
    SetProcessingJobSummaries(std::forward<ProcessingJobSummariesT>(value));
    return *this;
  }
  template <typename ProcessingJobSummariesT = ProcessingJobSummary>
  ListProcessingJobsResult& AddProcessingJobSummaries(ProcessingJobSummariesT&& value) {
    m_processingJobSummariesHasBeenSet = true;
    m_processingJobSummaries.emplace_back(std::forward<ProcessingJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProcessingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProcessingJobsResult& WithRequestId(RequestIdT&& value) {
