...
class SourceAlgorithmSpecification {
 public:
  ...
  void SetSourceAlgorithms(SourceAlgorithmsT&& value) {
    ...
    m_sourceAlgorithms = std::forward<SourceAlgorithmsT>(value);
  }
  template <typename SourceAlgorithmsT = Aws::Vector<SourceAlgorithm>>
  SourceAlgorithmSpecification& WithSourceAlgorithms(SourceAlgorithmsT&& value) {
    SetSourceAlgorithms(std::forward<SourceAlgorithmsT>(value));
    return *this;
  }
  ...
  SourceAlgorithmSpecification& AddSourceAlgorithms(SourceAlgorithmsT&& value) {
    m_sourceAlgorithmsHasBeenSet = true;
    m_sourceAlgorithms.emplace_back(std::forward<SourceAlgorithmsT>(value));
    return *this;
  }
  ///@}
 private:
