...
class ContainerConfig {
 public:
  ...
  void SetContainerEnvironmentVariables(ContainerEnvironmentVariablesT&& value) {
    ...
    m_containerEnvironmentVariables = std::forward<ContainerEnvironmentVariablesT>(value);
  }
  template <typename ContainerEnvironmentVariablesT = Aws::Map<Aws::String, Aws::String>>
  ContainerConfig& WithContainerEnvironmentVariables(ContainerEnvironmentVariablesT&& value) {
    SetContainerEnvironmentVariables(std::forward<ContainerEnvironmentVariablesT>(value));
    return *this;
  }
  ...
  ContainerConfig& AddContainerEnvironmentVariables(ContainerEnvironmentVariablesKeyT&& key, ContainerEnvironmentVariablesValueT&& value) {
    m_containerEnvironmentVariablesHasBeenSet = true;
    m_containerEnvironmentVariables.emplace(std::forward<ContainerEnvironmentVariablesKeyT>(key),
                                            std::forward<ContainerEnvironmentVariablesValueT>(value));
    return *this;
  }
  ///@}
 private:
