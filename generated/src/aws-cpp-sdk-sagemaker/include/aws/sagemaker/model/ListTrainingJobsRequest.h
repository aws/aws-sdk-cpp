...
class ListTrainingJobsRequest : public SageMakerRequest {
 public:
  ...
  inline ListTrainingJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListTrainingJobsRequest& WithStatusEquals(TrainingJobStatus value) {
  ...
  inline ListTrainingJobsRequest& WithSortBy(SortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListTrainingJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWarmPoolStatusEquals(WarmPoolResourceStatus value) {
    m_warmPoolStatusEqualsHasBeenSet = true;
    m_warmPoolStatusEquals = value;
  }
  inline ListTrainingJobsRequest& WithWarmPoolStatusEquals(WarmPoolResourceStatus value) {
    SetWarmPoolStatusEquals(value);
    return *this;
  }
  ///@}
  ...
  void SetTrainingPlanArnEquals(TrainingPlanArnEqualsT&& value) {
    m_trainingPlanArnEqualsHasBeenSet = true;
    m_trainingPlanArnEquals = std::forward<TrainingPlanArnEqualsT>(value);
  }
  template <typename TrainingPlanArnEqualsT = Aws::String>
  ListTrainingJobsRequest& WithTrainingPlanArnEquals(TrainingPlanArnEqualsT&& value) {
    SetTrainingPlanArnEquals(std::forward<TrainingPlanArnEqualsT>(value));
    return *this;
  }
  ///@}
 private:
