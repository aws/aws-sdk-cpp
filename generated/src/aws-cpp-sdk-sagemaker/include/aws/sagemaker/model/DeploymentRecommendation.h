...
class DeploymentRecommendation {
 public:
  ...
  inline DeploymentRecommendation& WithRecommendationStatus(RecommendationStatus value) {
   ...
   * items.</p>
   */
  inline const Aws::Vector<RealTimeInferenceRecommendation>& GetRealTimeInferenceRecommendations() const {
    return m_realTimeInferenceRecommendations;
  }
  ...
  void SetRealTimeInferenceRecommendations(RealTimeInferenceRecommendationsT&& value) {
    ...
    m_realTimeInferenceRecommendations = std::forward<RealTimeInferenceRecommendationsT>(value);
  }
  template <typename RealTimeInferenceRecommendationsT = Aws::Vector<RealTimeInferenceRecommendation>>
  DeploymentRecommendation& WithRealTimeInferenceRecommendations(RealTimeInferenceRecommendationsT&& value) {
    SetRealTimeInferenceRecommendations(std::forward<RealTimeInferenceRecommendationsT>(value));
    return *this;
  }
  ...
  DeploymentRecommendation& AddRealTimeInferenceRecommendations(RealTimeInferenceRecommendationsT&& value) {
    m_realTimeInferenceRecommendationsHasBeenSet = true;
    m_realTimeInferenceRecommendations.emplace_back(std::forward<RealTimeInferenceRecommendationsT>(value));
    return *this;
  }
  ///@}
 private:
