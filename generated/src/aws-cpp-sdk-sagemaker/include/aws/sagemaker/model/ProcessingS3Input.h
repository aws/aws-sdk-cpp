...
class ProcessingS3Input {
 public:
  ...
  inline void SetS3DataType(ProcessingS3DataType value) {
    m_s3DataTypeHasBeenSet = true;
    m_s3DataType = value;
  }
  inline ProcessingS3Input& WithS3DataType(ProcessingS3DataType value) {
    SetS3DataType(value);
    return *this;
  }
  ///@}
  ...
  inline ProcessingS3Input& WithS3InputMode(ProcessingS3InputMode value) {
  ...
  inline ProcessingS3Input& WithS3DataDistributionType(ProcessingS3DataDistributionType value) {
  ...
  inline void SetS3CompressionType(ProcessingS3CompressionType value) {
    m_s3CompressionTypeHasBeenSet = true;
    m_s3CompressionType = value;
  }
  inline ProcessingS3Input& WithS3CompressionType(ProcessingS3CompressionType value) {
    SetS3CompressionType(value);
    return *this;
  }
  ///@}
 private:
