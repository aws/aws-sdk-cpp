...
class DescribeImageVersionResult {
 public:
  ...
  void SetBaseImage(BaseImageT&& value) {
    ...
    m_baseImage = std::forward<BaseImageT>(value);
  }
  template <typename BaseImageT = Aws::String>
  DescribeImageVersionResult& WithBaseImage(BaseImageT&& value) {
    SetBaseImage(std::forward<BaseImageT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeImageVersionResult& WithImageVersionStatus(ImageVersionStatus value) {
  ...
  inline DescribeImageVersionResult& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVendorGuidance(VendorGuidance value) {
    m_vendorGuidanceHasBeenSet = true;
    m_vendorGuidance = value;
  }
  inline DescribeImageVersionResult& WithVendorGuidance(VendorGuidance value) {
    SetVendorGuidance(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeImageVersionResult& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  void SetMLFramework(MLFrameworkT&& value) {
    ...
    m_mLFramework = std::forward<MLFrameworkT>(value);
  }
  template <typename MLFrameworkT = Aws::String>
  DescribeImageVersionResult& WithMLFramework(MLFrameworkT&& value) {
    SetMLFramework(std::forward<MLFrameworkT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProgrammingLang(ProgrammingLangT&& value) {
    ...
    m_programmingLang = std::forward<ProgrammingLangT>(value);
  }
  template <typename ProgrammingLangT = Aws::String>
  DescribeImageVersionResult& WithProgrammingLang(ProgrammingLangT&& value) {
    SetProgrammingLang(std::forward<ProgrammingLangT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProcessor(Processor value) {
    m_processorHasBeenSet = true;
    m_processor = value;
  }
  inline DescribeImageVersionResult& WithProcessor(Processor value) {
    SetProcessor(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHorovod(bool value) {
    m_horovodHasBeenSet = true;
    m_horovod = value;
  }
  inline DescribeImageVersionResult& WithHorovod(bool value) {
    SetHorovod(value);
    return *this;
  }
  ///@}
