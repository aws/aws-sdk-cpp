...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    ListEdgeDeploymentPlansRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeAfterT = Aws::Utils::DateTime>
    ListEdgeDeploymentPlansRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) { SetCreationTimeAfter(std::forward<CreationTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeBeforeT = Aws::Utils::DateTime>
    ListEdgeDeploymentPlansRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) { SetCreationTimeBefore(std::forward<CreationTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
    ListEdgeDeploymentPlansRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) { SetLastModifiedTimeAfter(std::forward<LastModifiedTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
    ListEdgeDeploymentPlansRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) { SetLastModifiedTimeBefore(std::forward<LastModifiedTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListEdgeDeploymentPlansRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
    ...
    void SetDeviceFleetNameContains(DeviceFleetNameContainsT&& value) { m_deviceFleetNameContainsHasBeenSet = true; m_deviceFleetNameContains = std::forward<DeviceFleetNameContainsT>(value); }
    template<typename DeviceFleetNameContainsT = Aws::String>
    ListEdgeDeploymentPlansRequest& WithDeviceFleetNameContains(DeviceFleetNameContainsT&& value) { SetDeviceFleetNameContains(std::forward<DeviceFleetNameContainsT>(value)); return *this;}
    ///@}
    ...
    inline void SetSortBy(ListEdgeDeploymentPlansSortBy value) { m_sortByHasBeenSet = true; m_sortBy = value; }
    inline ListEdgeDeploymentPlansRequest& WithSortBy(ListEdgeDeploymentPlansSortBy value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline ListEdgeDeploymentPlansRequest& WithSortOrder(SortOrder value) { SetSortOrder(value); return *this;}
    ///@}
  private:
