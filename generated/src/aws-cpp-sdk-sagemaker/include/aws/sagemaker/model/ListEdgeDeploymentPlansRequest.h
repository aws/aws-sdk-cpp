...
class ListEdgeDeploymentPlansRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListEdgeDeploymentPlansRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  ListEdgeDeploymentPlansRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListEdgeDeploymentPlansRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListEdgeDeploymentPlansRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListEdgeDeploymentPlansRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListEdgeDeploymentPlansRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListEdgeDeploymentPlansRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListEdgeDeploymentPlansRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename DeviceFleetNameContainsT = Aws::String>
  void SetDeviceFleetNameContains(DeviceFleetNameContainsT&& value) {
    m_deviceFleetNameContainsHasBeenSet = true;
    m_deviceFleetNameContains = std::forward<DeviceFleetNameContainsT>(value);
  }
  template <typename DeviceFleetNameContainsT = Aws::String>
  ListEdgeDeploymentPlansRequest& WithDeviceFleetNameContains(DeviceFleetNameContainsT&& value) {
    SetDeviceFleetNameContains(std::forward<DeviceFleetNameContainsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline ListEdgeDeploymentPlansSortBy GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(ListEdgeDeploymentPlansSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListEdgeDeploymentPlansRequest& WithSortBy(ListEdgeDeploymentPlansSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListEdgeDeploymentPlansRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
 private:
  ...
  ListEdgeDeploymentPlansSortBy m_sortBy{ListEdgeDeploymentPlansSortBy::NOT_SET};
