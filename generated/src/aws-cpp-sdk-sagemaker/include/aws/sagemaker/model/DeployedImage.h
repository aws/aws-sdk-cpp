...
class DeployedImage {
 public:
  ...
  void SetSpecifiedImage(SpecifiedImageT&& value) {
    m_specifiedImageHasBeenSet = true;
    m_specifiedImage = std::forward<SpecifiedImageT>(value);
  }
  template <typename SpecifiedImageT = Aws::String>
  DeployedImage& WithSpecifiedImage(SpecifiedImageT&& value) {
    SetSpecifiedImage(std::forward<SpecifiedImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolvedImage(ResolvedImageT&& value) {
    m_resolvedImageHasBeenSet = true;
    m_resolvedImage = std::forward<ResolvedImageT>(value);
  }
  template <typename ResolvedImageT = Aws::String>
  DeployedImage& WithResolvedImage(ResolvedImageT&& value) {
    SetResolvedImage(std::forward<ResolvedImageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResolutionTime(ResolutionTimeT&& value) {
    m_resolutionTimeHasBeenSet = true;
    m_resolutionTime = std::forward<ResolutionTimeT>(value);
  }
  template <typename ResolutionTimeT = Aws::Utils::DateTime>
  DeployedImage& WithResolutionTime(ResolutionTimeT&& value) {
    SetResolutionTime(std::forward<ResolutionTimeT>(value));
    return *this;
  }
  ///@}
 private:
