...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API CreateModelQualityJobDefinitionResult() = default;
    ...
    template<typename JobDefinitionArnT = Aws::String>
    CreateModelQualityJobDefinitionResult& WithJobDefinitionArn(JobDefinitionArnT&& value) { SetJobDefinitionArn(std::forward<JobDefinitionArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateModelQualityJobDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
