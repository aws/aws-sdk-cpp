...
class CreateModelQualityJobDefinitionResult {
 public:
  ...
  AWS_SAGEMAKER_API CreateModelQualityJobDefinitionResult& operator=(
  ...
  template <typename JobDefinitionArnT = Aws::String>
  CreateModelQualityJobDefinitionResult& WithJobDefinitionArn(JobDefinitionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateModelQualityJobDefinitionResult& WithRequestId(RequestIdT&& value) {
