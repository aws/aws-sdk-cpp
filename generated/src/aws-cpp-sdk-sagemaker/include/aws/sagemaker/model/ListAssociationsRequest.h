...
class ListAssociationsRequest : public SageMakerRequest {
 public:
  ...
  inline ListAssociationsRequest& WithAssociationType(AssociationEdgeType value) {
   ...
   */
  inline SortAssociationsBy GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(SortAssociationsBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListAssociationsRequest& WithSortBy(SortAssociationsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListAssociationsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  SortAssociationsBy m_sortBy{SortAssociationsBy::NOT_SET};
