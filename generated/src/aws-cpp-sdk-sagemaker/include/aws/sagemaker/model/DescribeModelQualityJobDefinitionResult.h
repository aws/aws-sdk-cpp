...
class DescribeModelQualityJobDefinitionResult {
 public:
  ...
  AWS_SAGEMAKER_API DescribeModelQualityJobDefinitionResult& operator=(
  ...
  void SetModelQualityBaselineConfig(ModelQualityBaselineConfigT&& value) {
    ...
    m_modelQualityBaselineConfig = std::forward<ModelQualityBaselineConfigT>(value);
  }
  template <typename ModelQualityBaselineConfigT = ModelQualityBaselineConfig>
  DescribeModelQualityJobDefinitionResult& WithModelQualityBaselineConfig(ModelQualityBaselineConfigT&& value) {
    SetModelQualityBaselineConfig(std::forward<ModelQualityBaselineConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelQualityAppSpecification(ModelQualityAppSpecificationT&& value) {
    ...
    m_modelQualityAppSpecification = std::forward<ModelQualityAppSpecificationT>(value);
  }
  template <typename ModelQualityAppSpecificationT = ModelQualityAppSpecification>
  DescribeModelQualityJobDefinitionResult& WithModelQualityAppSpecification(ModelQualityAppSpecificationT&& value) {
    SetModelQualityAppSpecification(std::forward<ModelQualityAppSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelQualityJobInput(ModelQualityJobInputT&& value) {
    ...
    m_modelQualityJobInput = std::forward<ModelQualityJobInputT>(value);
  }
  template <typename ModelQualityJobInputT = ModelQualityJobInput>
  DescribeModelQualityJobDefinitionResult& WithModelQualityJobInput(ModelQualityJobInputT&& value) {
    SetModelQualityJobInput(std::forward<ModelQualityJobInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelQualityJobOutputConfig(ModelQualityJobOutputConfigT&& value) {
    ...
    m_modelQualityJobOutputConfig = std::forward<ModelQualityJobOutputConfigT>(value);
  }
  template <typename ModelQualityJobOutputConfigT = MonitoringOutputConfig>
  DescribeModelQualityJobDefinitionResult& WithModelQualityJobOutputConfig(ModelQualityJobOutputConfigT&& value) {
    SetModelQualityJobOutputConfig(std::forward<ModelQualityJobOutputConfigT>(value));
    return *this;
  }
  ///@}
