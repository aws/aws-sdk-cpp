...
class ListInferenceRecommendationsJobsRequest : public SageMakerRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListInferenceRecommendationsJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListInferenceRecommendationsJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListInferenceRecommendationsJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListInferenceRecommendationsJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListInferenceRecommendationsJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline void SetStatusEquals(RecommendationJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListInferenceRecommendationsJobsRequest& WithStatusEquals(RecommendationJobStatus value) {
  ...
  inline void SetSortBy(ListInferenceRecommendationsJobsSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListInferenceRecommendationsJobsRequest& WithSortBy(ListInferenceRecommendationsJobsSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListInferenceRecommendationsJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceRecommendationsJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListInferenceRecommendationsJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetModelNameEquals(ModelNameEqualsT&& value) {
    m_modelNameEqualsHasBeenSet = true;
    m_modelNameEquals = std::forward<ModelNameEqualsT>(value);
  }
  template <typename ModelNameEqualsT = Aws::String>
  ListInferenceRecommendationsJobsRequest& WithModelNameEquals(ModelNameEqualsT&& value) {
    SetModelNameEquals(std::forward<ModelNameEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelPackageVersionArnEquals(ModelPackageVersionArnEqualsT&& value) {
    m_modelPackageVersionArnEqualsHasBeenSet = true;
    m_modelPackageVersionArnEquals = std::forward<ModelPackageVersionArnEqualsT>(value);
  }
  template <typename ModelPackageVersionArnEqualsT = Aws::String>
  ListInferenceRecommendationsJobsRequest& WithModelPackageVersionArnEquals(ModelPackageVersionArnEqualsT&& value) {
    SetModelPackageVersionArnEquals(std::forward<ModelPackageVersionArnEqualsT>(value));
    return *this;
  }
  ///@}
 private:
