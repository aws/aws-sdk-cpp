...
class Pipeline {
 public:
  ...
  void SetPipelineDisplayName(PipelineDisplayNameT&& value) {
    ...
    m_pipelineDisplayName = std::forward<PipelineDisplayNameT>(value);
  }
  template <typename PipelineDisplayNameT = Aws::String>
  Pipeline& WithPipelineDisplayName(PipelineDisplayNameT&& value) {
    SetPipelineDisplayName(std::forward<PipelineDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPipelineDescription(PipelineDescriptionT&& value) {
    ...
    m_pipelineDescription = std::forward<PipelineDescriptionT>(value);
  }
  template <typename PipelineDescriptionT = Aws::String>
  Pipeline& WithPipelineDescription(PipelineDescriptionT&& value) {
    SetPipelineDescription(std::forward<PipelineDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPipelineStatus(PipelineStatus value) {
    m_pipelineStatusHasBeenSet = true;
    m_pipelineStatus = value;
  }
  inline Pipeline& WithPipelineStatus(PipelineStatus value) {
  ...
  void SetLastRunTime(LastRunTimeT&& value) {
    ...
    m_lastRunTime = std::forward<LastRunTimeT>(value);
  }
  template <typename LastRunTimeT = Aws::Utils::DateTime>
  Pipeline& WithLastRunTime(LastRunTimeT&& value) {
    SetLastRunTime(std::forward<LastRunTimeT>(value));
    return *this;
  }
  ///@}
