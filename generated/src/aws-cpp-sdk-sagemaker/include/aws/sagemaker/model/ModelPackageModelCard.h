...
class ModelPackageModelCard {
 public:
  ...
  void SetModelCardContent(ModelCardContentT&& value) {
    m_modelCardContentHasBeenSet = true;
    m_modelCardContent = std::forward<ModelCardContentT>(value);
  }
  template <typename ModelCardContentT = Aws::String>
  ModelPackageModelCard& WithModelCardContent(ModelCardContentT&& value) {
    SetModelCardContent(std::forward<ModelCardContentT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModelPackageModelCard& WithModelCardStatus(ModelCardStatus value) {
