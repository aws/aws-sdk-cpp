...
class ListPipelineVersionsResult {
 public:
  ...
  void SetPipelineVersionSummaries(PipelineVersionSummariesT&& value) {
    m_pipelineVersionSummariesHasBeenSet = true;
    m_pipelineVersionSummaries = std::forward<PipelineVersionSummariesT>(value);
  }
  template <typename PipelineVersionSummariesT = Aws::Vector<PipelineVersionSummary>>
  ListPipelineVersionsResult& WithPipelineVersionSummaries(PipelineVersionSummariesT&& value) {
    SetPipelineVersionSummaries(std::forward<PipelineVersionSummariesT>(value));
    return *this;
  }
  template <typename PipelineVersionSummariesT = PipelineVersionSummary>
  ListPipelineVersionsResult& AddPipelineVersionSummaries(PipelineVersionSummariesT&& value) {
    m_pipelineVersionSummariesHasBeenSet = true;
    m_pipelineVersionSummaries.emplace_back(std::forward<PipelineVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListPipelineVersionsResult& WithRequestId(RequestIdT&& value) {
