...
class ListUltraServersByReservedCapacityResult {
 public:
  ...
  AWS_SAGEMAKER_API ListUltraServersByReservedCapacityResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListUltraServersByReservedCapacityResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetUltraServers(UltraServersT&& value) {
    m_ultraServersHasBeenSet = true;
    m_ultraServers = std::forward<UltraServersT>(value);
  }
  template <typename UltraServersT = Aws::Vector<UltraServer>>
  ListUltraServersByReservedCapacityResult& WithUltraServers(UltraServersT&& value) {
    SetUltraServers(std::forward<UltraServersT>(value));
    return *this;
  }
  template <typename UltraServersT = UltraServer>
  ListUltraServersByReservedCapacityResult& AddUltraServers(UltraServersT&& value) {
    m_ultraServersHasBeenSet = true;
    m_ultraServers.emplace_back(std::forward<UltraServersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListUltraServersByReservedCapacityResult& WithRequestId(RequestIdT&& value) {
