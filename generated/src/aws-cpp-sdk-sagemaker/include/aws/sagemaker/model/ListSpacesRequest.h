...
class ListSpacesRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API ListSpacesRequest() = default;
  ...
  inline ListSpacesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
   ...
   */
  inline SpaceSortKey GetSortBy() const { return m_sortBy; }
  inline bool SortByHasBeenSet() const { return m_sortByHasBeenSet; }
  inline void SetSortBy(SpaceSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListSpacesRequest& WithSortBy(SpaceSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename DomainIdEqualsT = Aws::String>
  ListSpacesRequest& WithDomainIdEquals(DomainIdEqualsT&& value) {
  ...
  template <typename SpaceNameContainsT = Aws::String>
  void SetSpaceNameContains(SpaceNameContainsT&& value) {
    m_spaceNameContainsHasBeenSet = true;
    m_spaceNameContains = std::forward<SpaceNameContainsT>(value);
  }
  template <typename SpaceNameContainsT = Aws::String>
  ListSpacesRequest& WithSpaceNameContains(SpaceNameContainsT&& value) {
    SetSpaceNameContains(std::forward<SpaceNameContainsT>(value));
    return *this;
  }
  ///@}
 private:
