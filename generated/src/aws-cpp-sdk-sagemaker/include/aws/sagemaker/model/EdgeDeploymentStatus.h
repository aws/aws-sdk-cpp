...
class EdgeDeploymentStatus {
 public:
  ...
  inline void SetStageStatus(StageStatus value) {
    m_stageStatusHasBeenSet = true;
    m_stageStatus = value;
  }
  inline EdgeDeploymentStatus& WithStageStatus(StageStatus value) {
  ...
  inline void SetEdgeDeploymentSuccessInStage(int value) {
    m_edgeDeploymentSuccessInStageHasBeenSet = true;
    m_edgeDeploymentSuccessInStage = value;
  }
  inline EdgeDeploymentStatus& WithEdgeDeploymentSuccessInStage(int value) {
    SetEdgeDeploymentSuccessInStage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEdgeDeploymentPendingInStage(int value) {
    m_edgeDeploymentPendingInStageHasBeenSet = true;
    m_edgeDeploymentPendingInStage = value;
  }
  inline EdgeDeploymentStatus& WithEdgeDeploymentPendingInStage(int value) {
    SetEdgeDeploymentPendingInStage(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEdgeDeploymentFailedInStage(int value) {
    m_edgeDeploymentFailedInStageHasBeenSet = true;
    m_edgeDeploymentFailedInStage = value;
  }
  inline EdgeDeploymentStatus& WithEdgeDeploymentFailedInStage(int value) {
    SetEdgeDeploymentFailedInStage(value);
    return *this;
  }
  ///@}
  ...
  void SetEdgeDeploymentStatusMessage(EdgeDeploymentStatusMessageT&& value) {
    ...
    m_edgeDeploymentStatusMessage = std::forward<EdgeDeploymentStatusMessageT>(value);
  }
  template <typename EdgeDeploymentStatusMessageT = Aws::String>
  EdgeDeploymentStatus& WithEdgeDeploymentStatusMessage(EdgeDeploymentStatusMessageT&& value) {
    SetEdgeDeploymentStatusMessage(std::forward<EdgeDeploymentStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEdgeDeploymentStageStartTime(EdgeDeploymentStageStartTimeT&& value) {
    ...
    m_edgeDeploymentStageStartTime = std::forward<EdgeDeploymentStageStartTimeT>(value);
  }
  template <typename EdgeDeploymentStageStartTimeT = Aws::Utils::DateTime>
  EdgeDeploymentStatus& WithEdgeDeploymentStageStartTime(EdgeDeploymentStageStartTimeT&& value) {
    SetEdgeDeploymentStageStartTime(std::forward<EdgeDeploymentStageStartTimeT>(value));
    return *this;
  }
  ///@}
 private:
