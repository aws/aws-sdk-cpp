...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API StopPipelineExecutionResult() = default;
    ...
    template<typename PipelineExecutionArnT = Aws::String>
    StopPipelineExecutionResult& WithPipelineExecutionArn(PipelineExecutionArnT&& value) { SetPipelineExecutionArn(std::forward<PipelineExecutionArnT>(value)); return *this;}
    ///@}
