...
class MonitoringAlertActions {
 public:
  ...
  void SetModelDashboardIndicator(ModelDashboardIndicatorT&& value) {
    m_modelDashboardIndicatorHasBeenSet = true;
    m_modelDashboardIndicator = std::forward<ModelDashboardIndicatorT>(value);
  }
  template <typename ModelDashboardIndicatorT = ModelDashboardIndicatorAction>
  MonitoringAlertActions& WithModelDashboardIndicator(ModelDashboardIndicatorT&& value) {
    SetModelDashboardIndicator(std::forward<ModelDashboardIndicatorT>(value));
    return *this;
  }
  ///@}
 private:
