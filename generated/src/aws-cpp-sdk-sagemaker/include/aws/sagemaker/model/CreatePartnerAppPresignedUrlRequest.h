...
class CreatePartnerAppPresignedUrlRequest : public SageMakerRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreatePartnerAppPresignedUrlRequest& WithArn(ArnT&& value) {
  ...
  inline CreatePartnerAppPresignedUrlRequest& WithExpiresInSeconds(int value) {
  ...
  inline CreatePartnerAppPresignedUrlRequest& WithSessionExpirationDurationInSeconds(int value) {
