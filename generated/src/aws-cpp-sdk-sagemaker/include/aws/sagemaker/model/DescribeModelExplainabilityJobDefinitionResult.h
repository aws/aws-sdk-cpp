...
class DescribeModelExplainabilityJobDefinitionResult {
 public:
  ...
  AWS_SAGEMAKER_API DescribeModelExplainabilityJobDefinitionResult& operator=(
   ...
   */
  inline const ModelExplainabilityBaselineConfig& GetModelExplainabilityBaselineConfig() const {
    return m_modelExplainabilityBaselineConfig;
  }
  ...
  void SetModelExplainabilityBaselineConfig(ModelExplainabilityBaselineConfigT&& value) {
    ...
    m_modelExplainabilityBaselineConfig = std::forward<ModelExplainabilityBaselineConfigT>(value);
  }
  template <typename ModelExplainabilityBaselineConfigT = ModelExplainabilityBaselineConfig>
  DescribeModelExplainabilityJobDefinitionResult& WithModelExplainabilityBaselineConfig(ModelExplainabilityBaselineConfigT&& value) {
    SetModelExplainabilityBaselineConfig(std::forward<ModelExplainabilityBaselineConfigT>(value));
    return *this;
  }
  ///@}
   ...
   * image.</p>
   */
  inline const ModelExplainabilityAppSpecification& GetModelExplainabilityAppSpecification() const {
    return m_modelExplainabilityAppSpecification;
  }
  ...
  void SetModelExplainabilityAppSpecification(ModelExplainabilityAppSpecificationT&& value) {
    ...
    m_modelExplainabilityAppSpecification = std::forward<ModelExplainabilityAppSpecificationT>(value);
  }
  template <typename ModelExplainabilityAppSpecificationT = ModelExplainabilityAppSpecification>
  DescribeModelExplainabilityJobDefinitionResult& WithModelExplainabilityAppSpecification(ModelExplainabilityAppSpecificationT&& value) {
    SetModelExplainabilityAppSpecification(std::forward<ModelExplainabilityAppSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelExplainabilityJobInput(ModelExplainabilityJobInputT&& value) {
    ...
    m_modelExplainabilityJobInput = std::forward<ModelExplainabilityJobInputT>(value);
  }
  template <typename ModelExplainabilityJobInputT = ModelExplainabilityJobInput>
  DescribeModelExplainabilityJobDefinitionResult& WithModelExplainabilityJobInput(ModelExplainabilityJobInputT&& value) {
    SetModelExplainabilityJobInput(std::forward<ModelExplainabilityJobInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelExplainabilityJobOutputConfig(ModelExplainabilityJobOutputConfigT&& value) {
    ...
    m_modelExplainabilityJobOutputConfig = std::forward<ModelExplainabilityJobOutputConfigT>(value);
  }
  template <typename ModelExplainabilityJobOutputConfigT = MonitoringOutputConfig>
  DescribeModelExplainabilityJobDefinitionResult& WithModelExplainabilityJobOutputConfig(ModelExplainabilityJobOutputConfigT&& value) {
    SetModelExplainabilityJobOutputConfig(std::forward<ModelExplainabilityJobOutputConfigT>(value));
    return *this;
  }
  ///@}
