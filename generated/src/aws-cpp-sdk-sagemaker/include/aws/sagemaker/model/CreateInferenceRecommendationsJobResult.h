...
namespace Model
{
  ...
  public:
    ...
    template<typename JobArnT = Aws::String>
    CreateInferenceRecommendationsJobResult& WithJobArn(JobArnT&& value) { SetJobArn(std::forward<JobArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateInferenceRecommendationsJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
