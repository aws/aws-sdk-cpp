...
class AnnotationConsolidationConfig {
 public:
  ...
  void SetAnnotationConsolidationLambdaArn(AnnotationConsolidationLambdaArnT&& value) {
    ...
    m_annotationConsolidationLambdaArn = std::forward<AnnotationConsolidationLambdaArnT>(value);
  }
  template <typename AnnotationConsolidationLambdaArnT = Aws::String>
  AnnotationConsolidationConfig& WithAnnotationConsolidationLambdaArn(AnnotationConsolidationLambdaArnT&& value) {
    SetAnnotationConsolidationLambdaArn(std::forward<AnnotationConsolidationLambdaArnT>(value));
    return *this;
  }
  ///@}
 private:
