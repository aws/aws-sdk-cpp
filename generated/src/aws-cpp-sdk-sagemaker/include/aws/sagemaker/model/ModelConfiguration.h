...
class ModelConfiguration {
 public:
  ...
  template <typename InferenceSpecificationNameT = Aws::String>
  ModelConfiguration& WithInferenceSpecificationName(InferenceSpecificationNameT&& value) {
  ...
  template <typename EnvironmentParametersT = Aws::Vector<EnvironmentParameter>>
  ModelConfiguration& WithEnvironmentParameters(EnvironmentParametersT&& value) {
  ...
  ModelConfiguration& AddEnvironmentParameters(EnvironmentParametersT&& value) {
    m_environmentParametersHasBeenSet = true;
  ...
  template <typename CompilationJobNameT = Aws::String>
  ModelConfiguration& WithCompilationJobName(CompilationJobNameT&& value) {
