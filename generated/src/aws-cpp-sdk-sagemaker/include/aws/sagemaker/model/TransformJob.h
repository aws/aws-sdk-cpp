...
class TransformJob {
 public:
  ...
  inline TransformJob& WithTransformJobStatus(TransformJobStatus value) {
  ...
  inline TransformJob& WithMaxConcurrentTransforms(int value) {
  ...
  inline TransformJob& WithMaxPayloadInMB(int value) {
  ...
  inline TransformJob& WithBatchStrategy(BatchStrategy value) {
