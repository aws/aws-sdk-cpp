...
class CreateNotebookInstanceLifecycleConfigResult {
 public:
  ...
  AWS_SAGEMAKER_API CreateNotebookInstanceLifecycleConfigResult& operator=(
  ...
  void SetNotebookInstanceLifecycleConfigArn(NotebookInstanceLifecycleConfigArnT&& value) {
    ...
    m_notebookInstanceLifecycleConfigArn = std::forward<NotebookInstanceLifecycleConfigArnT>(value);
  }
  template <typename NotebookInstanceLifecycleConfigArnT = Aws::String>
  CreateNotebookInstanceLifecycleConfigResult& WithNotebookInstanceLifecycleConfigArn(NotebookInstanceLifecycleConfigArnT&& value) {
    SetNotebookInstanceLifecycleConfigArn(std::forward<NotebookInstanceLifecycleConfigArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateNotebookInstanceLifecycleConfigResult& WithRequestId(RequestIdT&& value) {
