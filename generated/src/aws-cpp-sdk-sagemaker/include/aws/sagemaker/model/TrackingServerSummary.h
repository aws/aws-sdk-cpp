...
class TrackingServerSummary {
 public:
  ...
  inline TrackingServerSummary& WithTrackingServerStatus(TrackingServerStatus value) {
  ...
  inline void SetIsActive(IsTrackingServerActive value) {
    m_isActiveHasBeenSet = true;
    m_isActive = value;
  }
  inline TrackingServerSummary& WithIsActive(IsTrackingServerActive value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
