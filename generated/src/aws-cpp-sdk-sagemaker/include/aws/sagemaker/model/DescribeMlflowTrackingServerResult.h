...
class DescribeMlflowTrackingServerResult {
 public:
  ...
  inline DescribeMlflowTrackingServerResult& WithTrackingServerSize(TrackingServerSize value) {
  ...
  inline DescribeMlflowTrackingServerResult& WithTrackingServerStatus(TrackingServerStatus value) {
  ...
  inline void SetTrackingServerMaintenanceStatus(TrackingServerMaintenanceStatus value) {
    m_trackingServerMaintenanceStatusHasBeenSet = true;
    m_trackingServerMaintenanceStatus = value;
  }
  inline DescribeMlflowTrackingServerResult& WithTrackingServerMaintenanceStatus(TrackingServerMaintenanceStatus value) {
    SetTrackingServerMaintenanceStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeMlflowTrackingServerResult& WithIsActive(IsTrackingServerActive value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
  ...
  void SetTrackingServerUrl(TrackingServerUrlT&& value) {
    ...
    m_trackingServerUrl = std::forward<TrackingServerUrlT>(value);
  }
  template <typename TrackingServerUrlT = Aws::String>
  DescribeMlflowTrackingServerResult& WithTrackingServerUrl(TrackingServerUrlT&& value) {
    SetTrackingServerUrl(std::forward<TrackingServerUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeMlflowTrackingServerResult& WithAutomaticModelRegistration(bool value) {
