...
class BestObjectiveNotImproving {
 public:
  ...
  inline void SetMaxNumberOfTrainingJobsNotImproving(int value) {
    m_maxNumberOfTrainingJobsNotImprovingHasBeenSet = true;
    m_maxNumberOfTrainingJobsNotImproving = value;
  }
  inline BestObjectiveNotImproving& WithMaxNumberOfTrainingJobsNotImproving(int value) {
    SetMaxNumberOfTrainingJobsNotImproving(value);
    return *this;
  }
  ///@}
 private:
