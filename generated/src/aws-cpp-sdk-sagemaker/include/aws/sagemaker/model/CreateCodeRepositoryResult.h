...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API CreateCodeRepositoryResult() = default;
    ...
    template<typename CodeRepositoryArnT = Aws::String>
    CreateCodeRepositoryResult& WithCodeRepositoryArn(CodeRepositoryArnT&& value) { SetCodeRepositoryArn(std::forward<CodeRepositoryArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateCodeRepositoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
