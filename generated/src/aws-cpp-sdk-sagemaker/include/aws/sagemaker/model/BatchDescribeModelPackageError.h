...
class BatchDescribeModelPackageError {
 public:
  ...
  template <typename ErrorCodeT = Aws::String>
  BatchDescribeModelPackageError& WithErrorCode(ErrorCodeT&& value) {
  ...
  void SetErrorResponse(ErrorResponseT&& value) {
    m_errorResponseHasBeenSet = true;
    m_errorResponse = std::forward<ErrorResponseT>(value);
  }
  template <typename ErrorResponseT = Aws::String>
  BatchDescribeModelPackageError& WithErrorResponse(ErrorResponseT&& value) {
    SetErrorResponse(std::forward<ErrorResponseT>(value));
    return *this;
  }
  ///@}
 private:
