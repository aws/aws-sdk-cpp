...
class ListAlgorithmsResult {
 public:
  ...
  void SetAlgorithmSummaryList(AlgorithmSummaryListT&& value) {
    m_algorithmSummaryListHasBeenSet = true;
    m_algorithmSummaryList = std::forward<AlgorithmSummaryListT>(value);
  }
  template <typename AlgorithmSummaryListT = Aws::Vector<AlgorithmSummary>>
  ListAlgorithmsResult& WithAlgorithmSummaryList(AlgorithmSummaryListT&& value) {
    SetAlgorithmSummaryList(std::forward<AlgorithmSummaryListT>(value));
    return *this;
  }
  template <typename AlgorithmSummaryListT = AlgorithmSummary>
  ListAlgorithmsResult& AddAlgorithmSummaryList(AlgorithmSummaryListT&& value) {
    m_algorithmSummaryListHasBeenSet = true;
    m_algorithmSummaryList.emplace_back(std::forward<AlgorithmSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAlgorithmsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAlgorithmsResult& WithRequestId(RequestIdT&& value) {
