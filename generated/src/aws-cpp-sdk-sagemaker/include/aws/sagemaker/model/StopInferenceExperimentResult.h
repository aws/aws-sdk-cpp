...
namespace Model
{
  ...
  public:
    ...
    template<typename InferenceExperimentArnT = Aws::String>
    StopInferenceExperimentResult& WithInferenceExperimentArn(InferenceExperimentArnT&& value) { SetInferenceExperimentArn(std::forward<InferenceExperimentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StopInferenceExperimentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
