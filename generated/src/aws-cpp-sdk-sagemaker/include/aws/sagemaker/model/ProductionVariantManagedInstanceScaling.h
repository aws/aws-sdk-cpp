...
class ProductionVariantManagedInstanceScaling {
 public:
  ...
  inline void SetStatus(ManagedInstanceScalingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ProductionVariantManagedInstanceScaling& WithStatus(ManagedInstanceScalingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ProductionVariantManagedInstanceScaling& WithMinInstanceCount(int value) {
  ...
  inline ProductionVariantManagedInstanceScaling& WithMaxInstanceCount(int value) {
