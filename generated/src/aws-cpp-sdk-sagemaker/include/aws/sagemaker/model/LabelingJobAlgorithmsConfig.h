...
class LabelingJobAlgorithmsConfig {
 public:
  ...
  void SetLabelingJobAlgorithmSpecificationArn(LabelingJobAlgorithmSpecificationArnT&& value) {
    ...
    m_labelingJobAlgorithmSpecificationArn = std::forward<LabelingJobAlgorithmSpecificationArnT>(value);
  }
  template <typename LabelingJobAlgorithmSpecificationArnT = Aws::String>
  LabelingJobAlgorithmsConfig& WithLabelingJobAlgorithmSpecificationArn(LabelingJobAlgorithmSpecificationArnT&& value) {
    SetLabelingJobAlgorithmSpecificationArn(std::forward<LabelingJobAlgorithmSpecificationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInitialActiveLearningModelArn(InitialActiveLearningModelArnT&& value) {
    ...
    m_initialActiveLearningModelArn = std::forward<InitialActiveLearningModelArnT>(value);
  }
  template <typename InitialActiveLearningModelArnT = Aws::String>
  LabelingJobAlgorithmsConfig& WithInitialActiveLearningModelArn(InitialActiveLearningModelArnT&& value) {
    SetInitialActiveLearningModelArn(std::forward<InitialActiveLearningModelArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelingJobResourceConfig(LabelingJobResourceConfigT&& value) {
    ...
    m_labelingJobResourceConfig = std::forward<LabelingJobResourceConfigT>(value);
  }
  template <typename LabelingJobResourceConfigT = LabelingJobResourceConfig>
  LabelingJobAlgorithmsConfig& WithLabelingJobResourceConfig(LabelingJobResourceConfigT&& value) {
    SetLabelingJobResourceConfig(std::forward<LabelingJobResourceConfigT>(value));
    return *this;
  }
  ///@}
 private:
