...
class ListOptimizationJobsRequest : public SageMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListOptimizationJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListOptimizationJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListOptimizationJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListOptimizationJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListOptimizationJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListOptimizationJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  void SetOptimizationContains(OptimizationContainsT&& value) {
    m_optimizationContainsHasBeenSet = true;
    m_optimizationContains = std::forward<OptimizationContainsT>(value);
  }
  template <typename OptimizationContainsT = Aws::String>
  ListOptimizationJobsRequest& WithOptimizationContains(OptimizationContainsT&& value) {
    SetOptimizationContains(std::forward<OptimizationContainsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListOptimizationJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline void SetStatusEquals(OptimizationJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListOptimizationJobsRequest& WithStatusEquals(OptimizationJobStatus value) {
  ...
  inline void SetSortBy(ListOptimizationJobsSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListOptimizationJobsRequest& WithSortBy(ListOptimizationJobsSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListOptimizationJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
