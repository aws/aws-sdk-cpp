...
class SearchTrainingPlanOfferingsRequest : public SageMakerRequest {
 public:
  ...
  inline SearchTrainingPlanOfferingsRequest& WithInstanceType(ReservedCapacityInstanceType value) {
  ...
  inline SearchTrainingPlanOfferingsRequest& WithInstanceCount(int value) {
  ...
  inline SearchTrainingPlanOfferingsRequest& WithUltraServerCount(int value) {
  ...
  inline SearchTrainingPlanOfferingsRequest& WithDurationHours(long long value) {
   ...
   * SageMaker Endpoints, Studio apps) to search for in the offerings.</p>
  ...
  inline SearchTrainingPlanOfferingsRequest& AddTargetResources(SageMakerResourceName value) {
    m_targetResourcesHasBeenSet = true;
