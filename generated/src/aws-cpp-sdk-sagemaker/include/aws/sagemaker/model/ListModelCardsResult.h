...
class ListModelCardsResult {
 public:
  ...
  void SetModelCardSummaries(ModelCardSummariesT&& value) {
    m_modelCardSummariesHasBeenSet = true;
    m_modelCardSummaries = std::forward<ModelCardSummariesT>(value);
  }
  template <typename ModelCardSummariesT = Aws::Vector<ModelCardSummary>>
  ListModelCardsResult& WithModelCardSummaries(ModelCardSummariesT&& value) {
    SetModelCardSummaries(std::forward<ModelCardSummariesT>(value));
    return *this;
  }
  template <typename ModelCardSummariesT = ModelCardSummary>
  ListModelCardsResult& AddModelCardSummaries(ModelCardSummariesT&& value) {
    m_modelCardSummariesHasBeenSet = true;
    m_modelCardSummaries.emplace_back(std::forward<ModelCardSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCardsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelCardsResult& WithRequestId(RequestIdT&& value) {
