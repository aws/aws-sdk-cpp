...
class SpaceStorageSettings {
 public:
  ...
  void SetEbsStorageSettings(EbsStorageSettingsT&& value) {
    m_ebsStorageSettingsHasBeenSet = true;
    m_ebsStorageSettings = std::forward<EbsStorageSettingsT>(value);
  }
  template <typename EbsStorageSettingsT = EbsStorageSettings>
  SpaceStorageSettings& WithEbsStorageSettings(EbsStorageSettingsT&& value) {
    SetEbsStorageSettings(std::forward<EbsStorageSettingsT>(value));
    return *this;
  }
  ///@}
 private:
