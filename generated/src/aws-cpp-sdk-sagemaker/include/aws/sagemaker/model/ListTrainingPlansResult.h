...
class ListTrainingPlansResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainingPlansResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTrainingPlanSummaries(TrainingPlanSummariesT&& value) {
    m_trainingPlanSummariesHasBeenSet = true;
    m_trainingPlanSummaries = std::forward<TrainingPlanSummariesT>(value);
  }
  template <typename TrainingPlanSummariesT = Aws::Vector<TrainingPlanSummary>>
  ListTrainingPlansResult& WithTrainingPlanSummaries(TrainingPlanSummariesT&& value) {
    SetTrainingPlanSummaries(std::forward<TrainingPlanSummariesT>(value));
    return *this;
  }
  template <typename TrainingPlanSummariesT = TrainingPlanSummary>
  ListTrainingPlansResult& AddTrainingPlanSummaries(TrainingPlanSummariesT&& value) {
    m_trainingPlanSummariesHasBeenSet = true;
    m_trainingPlanSummaries.emplace_back(std::forward<TrainingPlanSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTrainingPlansResult& WithRequestId(RequestIdT&& value) {
