...
class DescribeMonitoringScheduleResult {
 public:
  ...
  inline DescribeMonitoringScheduleResult& WithMonitoringScheduleStatus(ScheduleStatus value) {
  ...
  inline DescribeMonitoringScheduleResult& WithMonitoringType(MonitoringType value) {
