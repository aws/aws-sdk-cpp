...
class DeleteEdgeDeploymentStageRequest : public SageMakerRequest {
 public:
  ...
  template <typename EdgeDeploymentPlanNameT = Aws::String>
  DeleteEdgeDeploymentStageRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) {
  ...
  template <typename StageNameT = Aws::String>
  DeleteEdgeDeploymentStageRequest& WithStageName(StageNameT&& value) {
