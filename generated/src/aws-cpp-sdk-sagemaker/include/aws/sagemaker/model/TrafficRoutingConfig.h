...
class TrafficRoutingConfig {
 public:
  ...
  inline void SetType(TrafficRoutingConfigType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline TrafficRoutingConfig& WithType(TrafficRoutingConfigType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline TrafficRoutingConfig& WithWaitIntervalInSeconds(int value) {
  ...
  void SetCanarySize(CanarySizeT&& value) {
    ...
    m_canarySize = std::forward<CanarySizeT>(value);
  }
  template <typename CanarySizeT = CapacitySize>
  TrafficRoutingConfig& WithCanarySize(CanarySizeT&& value) {
    SetCanarySize(std::forward<CanarySizeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLinearStepSize(LinearStepSizeT&& value) {
    ...
    m_linearStepSize = std::forward<LinearStepSizeT>(value);
  }
  template <typename LinearStepSizeT = CapacitySize>
  TrafficRoutingConfig& WithLinearStepSize(LinearStepSizeT&& value) {
    SetLinearStepSize(std::forward<LinearStepSizeT>(value));
    return *this;
  }
  ///@}
 private:
