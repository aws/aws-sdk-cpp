...
class ListImageVersionsRequest : public SageMakerRequest {
 public:
  ...
  inline ListImageVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ImageVersionSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListImageVersionsRequest& WithSortBy(ImageVersionSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(ImageVersionSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListImageVersionsRequest& WithSortOrder(ImageVersionSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
