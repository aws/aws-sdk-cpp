...
class CandidateProperties {
 public:
  ...
  void SetCandidateArtifactLocations(CandidateArtifactLocationsT&& value) {
    ...
    m_candidateArtifactLocations = std::forward<CandidateArtifactLocationsT>(value);
  }
  template <typename CandidateArtifactLocationsT = CandidateArtifactLocations>
  CandidateProperties& WithCandidateArtifactLocations(CandidateArtifactLocationsT&& value) {
    SetCandidateArtifactLocations(std::forward<CandidateArtifactLocationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCandidateMetrics(CandidateMetricsT&& value) {
    ...
    m_candidateMetrics = std::forward<CandidateMetricsT>(value);
  }
  template <typename CandidateMetricsT = Aws::Vector<MetricDatum>>
  CandidateProperties& WithCandidateMetrics(CandidateMetricsT&& value) {
    SetCandidateMetrics(std::forward<CandidateMetricsT>(value));
    return *this;
  }
  template <typename CandidateMetricsT = MetricDatum>
  CandidateProperties& AddCandidateMetrics(CandidateMetricsT&& value) {
    m_candidateMetricsHasBeenSet = true;
    m_candidateMetrics.emplace_back(std::forward<CandidateMetricsT>(value));
    return *this;
  }
  ///@}
 private:
