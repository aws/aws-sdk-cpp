...
class CustomFileSystemConfig {
 public:
  ...
  void SetEFSFileSystemConfig(EFSFileSystemConfigT&& value) {
    ...
    m_eFSFileSystemConfig = std::forward<EFSFileSystemConfigT>(value);
  }
  template <typename EFSFileSystemConfigT = EFSFileSystemConfig>
  CustomFileSystemConfig& WithEFSFileSystemConfig(EFSFileSystemConfigT&& value) {
    SetEFSFileSystemConfig(std::forward<EFSFileSystemConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFSxLustreFileSystemConfig(FSxLustreFileSystemConfigT&& value) {
    ...
    m_fSxLustreFileSystemConfig = std::forward<FSxLustreFileSystemConfigT>(value);
  }
  template <typename FSxLustreFileSystemConfigT = FSxLustreFileSystemConfig>
  CustomFileSystemConfig& WithFSxLustreFileSystemConfig(FSxLustreFileSystemConfigT&& value) {
    SetFSxLustreFileSystemConfig(std::forward<FSxLustreFileSystemConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetS3FileSystemConfig(S3FileSystemConfigT&& value) {
    ...
    m_s3FileSystemConfig = std::forward<S3FileSystemConfigT>(value);
  }
  template <typename S3FileSystemConfigT = S3FileSystemConfig>
  CustomFileSystemConfig& WithS3FileSystemConfig(S3FileSystemConfigT&& value) {
    SetS3FileSystemConfig(std::forward<S3FileSystemConfigT>(value));
    return *this;
  }
  ///@}
 private:
