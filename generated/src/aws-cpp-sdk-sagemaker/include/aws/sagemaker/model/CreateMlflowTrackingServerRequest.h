...
class CreateMlflowTrackingServerRequest : public SageMakerRequest {
 public:
  ...
  template <typename TrackingServerNameT = Aws::String>
  CreateMlflowTrackingServerRequest& WithTrackingServerName(TrackingServerNameT&& value) {
  ...
  template <typename ArtifactStoreUriT = Aws::String>
  CreateMlflowTrackingServerRequest& WithArtifactStoreUri(ArtifactStoreUriT&& value) {
  ...
  inline void SetTrackingServerSize(TrackingServerSize value) {
    m_trackingServerSizeHasBeenSet = true;
    m_trackingServerSize = value;
  }
  inline CreateMlflowTrackingServerRequest& WithTrackingServerSize(TrackingServerSize value) {
    SetTrackingServerSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename MlflowVersionT = Aws::String>
  CreateMlflowTrackingServerRequest& WithMlflowVersion(MlflowVersionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  CreateMlflowTrackingServerRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetAutomaticModelRegistration(bool value) {
    m_automaticModelRegistrationHasBeenSet = true;
    m_automaticModelRegistration = value;
  }
  inline CreateMlflowTrackingServerRequest& WithAutomaticModelRegistration(bool value) {
    SetAutomaticModelRegistration(value);
    return *this;
  }
  ///@}
  ...
  template <typename WeeklyMaintenanceWindowStartT = Aws::String>
  CreateMlflowTrackingServerRequest& WithWeeklyMaintenanceWindowStart(WeeklyMaintenanceWindowStartT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateMlflowTrackingServerRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateMlflowTrackingServerRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
   ...
   * artifact storage. Defaults to caller's account ID if not provided.</p>
   */
  ...
  template <typename S3BucketOwnerAccountIdT = Aws::String>
  CreateMlflowTrackingServerRequest& WithS3BucketOwnerAccountId(S3BucketOwnerAccountIdT&& value) {
  ...
  ///@{
  /**
   * <p>Enable Amazon S3 Ownership checks when interacting with Amazon S3 buckets
   * from a SageMaker Managed MLflow Tracking Server. Defaults to <code>True</code>
   * if not provided. </p>
   */
  ...
  inline CreateMlflowTrackingServerRequest& WithS3BucketOwnerVerification(bool value) {
