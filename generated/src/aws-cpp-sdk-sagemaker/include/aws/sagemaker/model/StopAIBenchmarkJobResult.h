...
namespace SageMaker {
namespace Model {
class StopAIBenchmarkJobResult {
 public:
  AWS_SAGEMAKER_API StopAIBenchmarkJobResult() = default;
  AWS_SAGEMAKER_API StopAIBenchmarkJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SAGEMAKER_API StopAIBenchmarkJobResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AIBenchmarkJobArnT = Aws::String>
  StopAIBenchmarkJobResult& WithAIBenchmarkJobArn(AIBenchmarkJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StopAIBenchmarkJobResult& WithRequestId(RequestIdT&& value) {
