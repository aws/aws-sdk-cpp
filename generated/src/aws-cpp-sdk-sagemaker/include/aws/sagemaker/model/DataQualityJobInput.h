...
class DataQualityJobInput {
 public:
  ...
  void SetEndpointInput(EndpointInputT&& value) {
    m_endpointInputHasBeenSet = true;
    m_endpointInput = std::forward<EndpointInputT>(value);
  }
  template <typename EndpointInputT = EndpointInput>
  DataQualityJobInput& WithEndpointInput(EndpointInputT&& value) {
    SetEndpointInput(std::forward<EndpointInputT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BatchTransformInputT = BatchTransformInput>
  DataQualityJobInput& WithBatchTransformInput(BatchTransformInputT&& value) {
