...
class UpdateHubContentReferenceResult {
 public:
  ...
  template <typename HubArnT = Aws::String>
  UpdateHubContentReferenceResult& WithHubArn(HubArnT&& value) {
  ...
  template <typename HubContentArnT = Aws::String>
  UpdateHubContentReferenceResult& WithHubContentArn(HubContentArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateHubContentReferenceResult& WithRequestId(RequestIdT&& value) {
