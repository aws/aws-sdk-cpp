...
class FileSystemConfig {
 public:
  ...
  inline void SetDefaultUid(int value) {
    m_defaultUidHasBeenSet = true;
    m_defaultUid = value;
  }
  inline FileSystemConfig& WithDefaultUid(int value) {
    SetDefaultUid(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultGid(int value) {
    m_defaultGidHasBeenSet = true;
    m_defaultGid = value;
  }
  inline FileSystemConfig& WithDefaultGid(int value) {
    SetDefaultGid(value);
    return *this;
  }
  ///@}
