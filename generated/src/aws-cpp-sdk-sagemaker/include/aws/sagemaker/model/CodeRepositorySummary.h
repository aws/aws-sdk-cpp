...
class CodeRepositorySummary {
 public:
  ...
  template <typename CodeRepositoryNameT = Aws::String>
  CodeRepositorySummary& WithCodeRepositoryName(CodeRepositoryNameT&& value) {
  ...
  void SetCodeRepositoryArn(CodeRepositoryArnT&& value) {
    ...
    m_codeRepositoryArn = std::forward<CodeRepositoryArnT>(value);
  }
  template <typename CodeRepositoryArnT = Aws::String>
  CodeRepositorySummary& WithCodeRepositoryArn(CodeRepositoryArnT&& value) {
    SetCodeRepositoryArn(std::forward<CodeRepositoryArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  CodeRepositorySummary& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  CodeRepositorySummary& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  void SetGitConfig(GitConfigT&& value) {
    ...
    m_gitConfig = std::forward<GitConfigT>(value);
  }
  template <typename GitConfigT = GitConfig>
  CodeRepositorySummary& WithGitConfig(GitConfigT&& value) {
    SetGitConfig(std::forward<GitConfigT>(value));
    return *this;
  }
  ///@}
 private:
