...
class ListContextsResult {
 public:
  ...
  void SetContextSummaries(ContextSummariesT&& value) {
    m_contextSummariesHasBeenSet = true;
    m_contextSummaries = std::forward<ContextSummariesT>(value);
  }
  template <typename ContextSummariesT = Aws::Vector<ContextSummary>>
  ListContextsResult& WithContextSummaries(ContextSummariesT&& value) {
    SetContextSummaries(std::forward<ContextSummariesT>(value));
    return *this;
  }
  template <typename ContextSummariesT = ContextSummary>
  ListContextsResult& AddContextSummaries(ContextSummariesT&& value) {
    m_contextSummariesHasBeenSet = true;
    m_contextSummaries.emplace_back(std::forward<ContextSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListContextsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContextsResult& WithRequestId(RequestIdT&& value) {
