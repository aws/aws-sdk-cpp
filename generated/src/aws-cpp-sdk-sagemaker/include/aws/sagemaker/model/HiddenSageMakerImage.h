...
class HiddenSageMakerImage {
 public:
  ...
  inline void SetSageMakerImageName(SageMakerImageName value) {
    m_sageMakerImageNameHasBeenSet = true;
    m_sageMakerImageName = value;
  }
  inline HiddenSageMakerImage& WithSageMakerImageName(SageMakerImageName value) {
    SetSageMakerImageName(value);
    return *this;
  }
  ///@}
  ...
  void SetVersionAliases(VersionAliasesT&& value) {
    m_versionAliasesHasBeenSet = true;
    m_versionAliases = std::forward<VersionAliasesT>(value);
  }
  template <typename VersionAliasesT = Aws::Vector<Aws::String>>
  HiddenSageMakerImage& WithVersionAliases(VersionAliasesT&& value) {
    SetVersionAliases(std::forward<VersionAliasesT>(value));
    return *this;
  }
  template <typename VersionAliasesT = Aws::String>
  HiddenSageMakerImage& AddVersionAliases(VersionAliasesT&& value) {
    m_versionAliasesHasBeenSet = true;
    m_versionAliases.emplace_back(std::forward<VersionAliasesT>(value));
    return *this;
  }
  ///@}
 private:
