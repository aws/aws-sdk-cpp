...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DescribeOptimizationJobRequest() = default;
    ...
    template<typename OptimizationJobNameT = Aws::String>
    DescribeOptimizationJobRequest& WithOptimizationJobName(OptimizationJobNameT&& value) { SetOptimizationJobName(std::forward<OptimizationJobNameT>(value)); return *this;}
    ///@}
  private:
