...
class ListMonitoringAlertsResult {
 public:
  ...
  template <typename MonitoringAlertSummariesT = Aws::Vector<MonitoringAlertSummary>>
  ListMonitoringAlertsResult& WithMonitoringAlertSummaries(MonitoringAlertSummariesT&& value) {
  ...
  ListMonitoringAlertsResult& AddMonitoringAlertSummaries(MonitoringAlertSummariesT&& value) {
    m_monitoringAlertSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoringAlertsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMonitoringAlertsResult& WithRequestId(RequestIdT&& value) {
