...
class EndpointInput {
 public:
  ...
  inline EndpointInput& WithS3InputMode(ProcessingS3InputMode value) {
  ...
  inline EndpointInput& WithS3DataDistributionType(ProcessingS3DataDistributionType value) {
  ...
  inline EndpointInput& WithProbabilityThresholdAttribute(double value) {
