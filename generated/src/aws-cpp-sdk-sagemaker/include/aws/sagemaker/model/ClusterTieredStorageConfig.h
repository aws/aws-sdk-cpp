...
class ClusterTieredStorageConfig {
 public:
  ...
  inline void SetMode(ClusterConfigMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ClusterTieredStorageConfig& WithMode(ClusterConfigMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceMemoryAllocationPercentage(int value) {
    m_instanceMemoryAllocationPercentageHasBeenSet = true;
    m_instanceMemoryAllocationPercentage = value;
  }
  inline ClusterTieredStorageConfig& WithInstanceMemoryAllocationPercentage(int value) {
    SetInstanceMemoryAllocationPercentage(value);
    return *this;
  }
  ///@}
 private:
