...
class ProductionVariantServerlessUpdateConfig {
 public:
  ...
  inline ProductionVariantServerlessUpdateConfig& WithMaxConcurrency(int value) {
  ...
  inline ProductionVariantServerlessUpdateConfig& WithProvisionedConcurrency(int value) {
