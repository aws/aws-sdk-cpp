...
class CreateModelRequest : public SageMakerRequest {
 public:
  ...
  void SetInferenceExecutionConfig(InferenceExecutionConfigT&& value) {
    ...
    m_inferenceExecutionConfig = std::forward<InferenceExecutionConfigT>(value);
  }
  template <typename InferenceExecutionConfigT = InferenceExecutionConfig>
  CreateModelRequest& WithInferenceExecutionConfig(InferenceExecutionConfigT&& value) {
    SetInferenceExecutionConfig(std::forward<InferenceExecutionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateModelRequest& WithEnableNetworkIsolation(bool value) {
