...
class ListModelCardsRequest : public SageMakerRequest {
 public:
  ...
  inline ListModelCardsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelCardsRequest& WithModelCardStatus(ModelCardStatus value) {
  ...
  inline void SetSortBy(ModelCardSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListModelCardsRequest& WithSortBy(ModelCardSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelCardsRequest& WithSortOrder(ModelCardSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
