...
class ListModelCardExportJobsResult {
 public:
  ...
  void SetModelCardExportJobSummaries(ModelCardExportJobSummariesT&& value) {
    m_modelCardExportJobSummariesHasBeenSet = true;
    m_modelCardExportJobSummaries = std::forward<ModelCardExportJobSummariesT>(value);
  }
  template <typename ModelCardExportJobSummariesT = Aws::Vector<ModelCardExportJobSummary>>
  ListModelCardExportJobsResult& WithModelCardExportJobSummaries(ModelCardExportJobSummariesT&& value) {
    SetModelCardExportJobSummaries(std::forward<ModelCardExportJobSummariesT>(value));
    return *this;
  }
  template <typename ModelCardExportJobSummariesT = ModelCardExportJobSummary>
  ListModelCardExportJobsResult& AddModelCardExportJobSummaries(ModelCardExportJobSummariesT&& value) {
    m_modelCardExportJobSummariesHasBeenSet = true;
    m_modelCardExportJobSummaries.emplace_back(std::forward<ModelCardExportJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCardExportJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelCardExportJobsResult& WithRequestId(RequestIdT&& value) {
