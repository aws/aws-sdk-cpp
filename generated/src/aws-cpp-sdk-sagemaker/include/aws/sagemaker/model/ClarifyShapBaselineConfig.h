...
class ClarifyShapBaselineConfig {
 public:
  ...
  void SetShapBaseline(ShapBaselineT&& value) {
    m_shapBaselineHasBeenSet = true;
    m_shapBaseline = std::forward<ShapBaselineT>(value);
  }
  template <typename ShapBaselineT = Aws::String>
  ClarifyShapBaselineConfig& WithShapBaseline(ShapBaselineT&& value) {
    SetShapBaseline(std::forward<ShapBaselineT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShapBaselineUri(ShapBaselineUriT&& value) {
    m_shapBaselineUriHasBeenSet = true;
    m_shapBaselineUri = std::forward<ShapBaselineUriT>(value);
  }
  template <typename ShapBaselineUriT = Aws::String>
  ClarifyShapBaselineConfig& WithShapBaselineUri(ShapBaselineUriT&& value) {
    SetShapBaselineUri(std::forward<ShapBaselineUriT>(value));
    return *this;
  }
  ///@}
 private:
