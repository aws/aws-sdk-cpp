...
class ListHyperParameterTuningJobsResult {
 public:
   ...
   */
  inline const Aws::Vector<HyperParameterTuningJobSummary>& GetHyperParameterTuningJobSummaries() const {
    return m_hyperParameterTuningJobSummaries;
  }
  template <typename HyperParameterTuningJobSummariesT = Aws::Vector<HyperParameterTuningJobSummary>>
  void SetHyperParameterTuningJobSummaries(HyperParameterTuningJobSummariesT&& value) {
    m_hyperParameterTuningJobSummariesHasBeenSet = true;
    m_hyperParameterTuningJobSummaries = std::forward<HyperParameterTuningJobSummariesT>(value);
  }
  template <typename HyperParameterTuningJobSummariesT = Aws::Vector<HyperParameterTuningJobSummary>>
  ListHyperParameterTuningJobsResult& WithHyperParameterTuningJobSummaries(HyperParameterTuningJobSummariesT&& value) {
    SetHyperParameterTuningJobSummaries(std::forward<HyperParameterTuningJobSummariesT>(value));
    return *this;
  }
  template <typename HyperParameterTuningJobSummariesT = HyperParameterTuningJobSummary>
  ListHyperParameterTuningJobsResult& AddHyperParameterTuningJobSummaries(HyperParameterTuningJobSummariesT&& value) {
    m_hyperParameterTuningJobSummariesHasBeenSet = true;
    m_hyperParameterTuningJobSummaries.emplace_back(std::forward<HyperParameterTuningJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListHyperParameterTuningJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListHyperParameterTuningJobsResult& WithRequestId(RequestIdT&& value) {
