...
namespace Model
{
  ...
  public:
    ...
    inline ListHyperParameterTuningJobsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListHyperParameterTuningJobsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListHyperParameterTuningJobsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
