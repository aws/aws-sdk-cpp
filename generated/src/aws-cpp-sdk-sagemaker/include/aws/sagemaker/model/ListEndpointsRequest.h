...
class ListEndpointsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(EndpointSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListEndpointsRequest& WithSortBy(EndpointSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListEndpointsRequest& WithSortOrder(OrderKey value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusEquals(EndpointStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListEndpointsRequest& WithStatusEquals(EndpointStatus value) {
