...
class ListAssociationsResult {
 public:
  ...
  void SetAssociationSummaries(AssociationSummariesT&& value) {
    m_associationSummariesHasBeenSet = true;
    m_associationSummaries = std::forward<AssociationSummariesT>(value);
  }
  template <typename AssociationSummariesT = Aws::Vector<AssociationSummary>>
  ListAssociationsResult& WithAssociationSummaries(AssociationSummariesT&& value) {
    SetAssociationSummaries(std::forward<AssociationSummariesT>(value));
    return *this;
  }
  template <typename AssociationSummariesT = AssociationSummary>
  ListAssociationsResult& AddAssociationSummaries(AssociationSummariesT&& value) {
    m_associationSummariesHasBeenSet = true;
    m_associationSummaries.emplace_back(std::forward<AssociationSummariesT>(value));
    return *this;
  }
  ///@}
