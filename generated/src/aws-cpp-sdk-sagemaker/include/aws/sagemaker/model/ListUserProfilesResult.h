...
class ListUserProfilesResult {
 public:
  ...
  void SetUserProfiles(UserProfilesT&& value) {
    m_userProfilesHasBeenSet = true;
    m_userProfiles = std::forward<UserProfilesT>(value);
  }
  template <typename UserProfilesT = Aws::Vector<UserProfileDetails>>
  ListUserProfilesResult& WithUserProfiles(UserProfilesT&& value) {
    SetUserProfiles(std::forward<UserProfilesT>(value));
    return *this;
  }
  template <typename UserProfilesT = UserProfileDetails>
  ListUserProfilesResult& AddUserProfiles(UserProfilesT&& value) {
    m_userProfilesHasBeenSet = true;
    m_userProfiles.emplace_back(std::forward<UserProfilesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListUserProfilesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUserProfilesResult& WithRequestId(RequestIdT&& value) {
