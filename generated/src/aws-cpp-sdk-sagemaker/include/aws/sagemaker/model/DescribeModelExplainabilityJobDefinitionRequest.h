...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DescribeModelExplainabilityJobDefinitionRequest() = default;
    ...
    template<typename JobDefinitionNameT = Aws::String>
    DescribeModelExplainabilityJobDefinitionRequest& WithJobDefinitionName(JobDefinitionNameT&& value) { SetJobDefinitionName(std::forward<JobDefinitionNameT>(value)); return *this;}
    ///@}
  private:
