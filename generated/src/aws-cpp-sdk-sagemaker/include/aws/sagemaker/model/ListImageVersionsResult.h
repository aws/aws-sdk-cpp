...
class ListImageVersionsResult {
 public:
  ...
  void SetImageVersions(ImageVersionsT&& value) {
    m_imageVersionsHasBeenSet = true;
    m_imageVersions = std::forward<ImageVersionsT>(value);
  }
  template <typename ImageVersionsT = Aws::Vector<ImageVersion>>
  ListImageVersionsResult& WithImageVersions(ImageVersionsT&& value) {
    SetImageVersions(std::forward<ImageVersionsT>(value));
    return *this;
  }
  template <typename ImageVersionsT = ImageVersion>
  ListImageVersionsResult& AddImageVersions(ImageVersionsT&& value) {
    m_imageVersionsHasBeenSet = true;
    m_imageVersions.emplace_back(std::forward<ImageVersionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListImageVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListImageVersionsResult& WithRequestId(RequestIdT&& value) {
