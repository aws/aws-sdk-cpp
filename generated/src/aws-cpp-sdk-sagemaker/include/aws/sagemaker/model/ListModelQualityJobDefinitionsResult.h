...
class ListModelQualityJobDefinitionsResult {
 public:
  ...
  template <typename JobDefinitionSummariesT = Aws::Vector<MonitoringJobDefinitionSummary>>
  ListModelQualityJobDefinitionsResult& WithJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
  ...
  ListModelQualityJobDefinitionsResult& AddJobDefinitionSummaries(JobDefinitionSummariesT&& value) {
    m_jobDefinitionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListModelQualityJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelQualityJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
