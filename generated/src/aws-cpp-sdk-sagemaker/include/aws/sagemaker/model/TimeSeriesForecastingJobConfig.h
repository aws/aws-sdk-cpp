...
class TimeSeriesForecastingJobConfig {
 public:
  ...
  void SetFeatureSpecificationS3Uri(FeatureSpecificationS3UriT&& value) {
    ...
    m_featureSpecificationS3Uri = std::forward<FeatureSpecificationS3UriT>(value);
  }
  template <typename FeatureSpecificationS3UriT = Aws::String>
  TimeSeriesForecastingJobConfig& WithFeatureSpecificationS3Uri(FeatureSpecificationS3UriT&& value) {
    SetFeatureSpecificationS3Uri(std::forward<FeatureSpecificationS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForecastFrequency(ForecastFrequencyT&& value) {
    ...
    m_forecastFrequency = std::forward<ForecastFrequencyT>(value);
  }
  template <typename ForecastFrequencyT = Aws::String>
  TimeSeriesForecastingJobConfig& WithForecastFrequency(ForecastFrequencyT&& value) {
    SetForecastFrequency(std::forward<ForecastFrequencyT>(value));
    return *this;
  }
  ///@}
  ...
  inline TimeSeriesForecastingJobConfig& WithForecastHorizon(int value) {
  ...
  void SetForecastQuantiles(ForecastQuantilesT&& value) {
    ...
    m_forecastQuantiles = std::forward<ForecastQuantilesT>(value);
  }
  template <typename ForecastQuantilesT = Aws::Vector<Aws::String>>
  TimeSeriesForecastingJobConfig& WithForecastQuantiles(ForecastQuantilesT&& value) {
    SetForecastQuantiles(std::forward<ForecastQuantilesT>(value));
    return *this;
  }
  ...
  TimeSeriesForecastingJobConfig& AddForecastQuantiles(ForecastQuantilesT&& value) {
    m_forecastQuantilesHasBeenSet = true;
    m_forecastQuantiles.emplace_back(std::forward<ForecastQuantilesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformations(TransformationsT&& value) {
    ...
    m_transformations = std::forward<TransformationsT>(value);
  }
  template <typename TransformationsT = TimeSeriesTransformations>
  TimeSeriesForecastingJobConfig& WithTransformations(TransformationsT&& value) {
    SetTransformations(std::forward<TransformationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeSeriesConfig(TimeSeriesConfigT&& value) {
    ...
    m_timeSeriesConfig = std::forward<TimeSeriesConfigT>(value);
  }
  template <typename TimeSeriesConfigT = TimeSeriesConfig>
  TimeSeriesForecastingJobConfig& WithTimeSeriesConfig(TimeSeriesConfigT&& value) {
    SetTimeSeriesConfig(std::forward<TimeSeriesConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHolidayConfig(HolidayConfigT&& value) {
    ...
    m_holidayConfig = std::forward<HolidayConfigT>(value);
  }
  template <typename HolidayConfigT = Aws::Vector<HolidayConfigAttributes>>
  TimeSeriesForecastingJobConfig& WithHolidayConfig(HolidayConfigT&& value) {
    SetHolidayConfig(std::forward<HolidayConfigT>(value));
    return *this;
  }
  ...
  TimeSeriesForecastingJobConfig& AddHolidayConfig(HolidayConfigT&& value) {
    m_holidayConfigHasBeenSet = true;
    m_holidayConfig.emplace_back(std::forward<HolidayConfigT>(value));
    return *this;
  }
  ///@}
