...
class UpdateEndpointWeightsAndCapacitiesResult {
 public:
  ...
  AWS_SAGEMAKER_API UpdateEndpointWeightsAndCapacitiesResult& operator=(
  ...
  template <typename EndpointArnT = Aws::String>
  UpdateEndpointWeightsAndCapacitiesResult& WithEndpointArn(EndpointArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateEndpointWeightsAndCapacitiesResult& WithRequestId(RequestIdT&& value) {
