...
class ClusterMetadata {
 public:
  ...
  template <typename FailureMessageT = Aws::String>
  ClusterMetadata& WithFailureMessage(FailureMessageT&& value) {
  ...
  void SetEksRoleAccessEntries(EksRoleAccessEntriesT&& value) {
    m_eksRoleAccessEntriesHasBeenSet = true;
    m_eksRoleAccessEntries = std::forward<EksRoleAccessEntriesT>(value);
  }
  template <typename EksRoleAccessEntriesT = Aws::Vector<Aws::String>>
  ClusterMetadata& WithEksRoleAccessEntries(EksRoleAccessEntriesT&& value) {
    SetEksRoleAccessEntries(std::forward<EksRoleAccessEntriesT>(value));
    return *this;
  }
  template <typename EksRoleAccessEntriesT = Aws::String>
  ClusterMetadata& AddEksRoleAccessEntries(EksRoleAccessEntriesT&& value) {
    m_eksRoleAccessEntriesHasBeenSet = true;
    m_eksRoleAccessEntries.emplace_back(std::forward<EksRoleAccessEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlrAccessEntry(SlrAccessEntryT&& value) {
    m_slrAccessEntryHasBeenSet = true;
    m_slrAccessEntry = std::forward<SlrAccessEntryT>(value);
  }
  template <typename SlrAccessEntryT = Aws::String>
  ClusterMetadata& WithSlrAccessEntry(SlrAccessEntryT&& value) {
    SetSlrAccessEntry(std::forward<SlrAccessEntryT>(value));
    return *this;
  }
  ///@}
 private:
