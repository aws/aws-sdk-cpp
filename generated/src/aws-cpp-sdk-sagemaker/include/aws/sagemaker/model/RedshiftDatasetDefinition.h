...
class RedshiftDatasetDefinition {
 public:
  ...
  void SetClusterRoleArn(ClusterRoleArnT&& value) {
    ...
    m_clusterRoleArn = std::forward<ClusterRoleArnT>(value);
  }
  template <typename ClusterRoleArnT = Aws::String>
  RedshiftDatasetDefinition& WithClusterRoleArn(ClusterRoleArnT&& value) {
    SetClusterRoleArn(std::forward<ClusterRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOutputFormat(RedshiftResultFormat value) {
    m_outputFormatHasBeenSet = true;
    m_outputFormat = value;
  }
  inline RedshiftDatasetDefinition& WithOutputFormat(RedshiftResultFormat value) {
  ...
  inline void SetOutputCompression(RedshiftResultCompressionType value) {
    m_outputCompressionHasBeenSet = true;
    m_outputCompression = value;
  }
  inline RedshiftDatasetDefinition& WithOutputCompression(RedshiftResultCompressionType value) {
    SetOutputCompression(value);
    return *this;
  }
  ///@}
 private:
