...
/**
 */
class StopJobRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API StopJobRequest() = default;
  ...
  template <typename JobNameT = Aws::String>
  StopJobRequest& WithJobName(JobNameT&& value) {
  ...
  inline StopJobRequest& WithJobCategory(JobCategory value) {
