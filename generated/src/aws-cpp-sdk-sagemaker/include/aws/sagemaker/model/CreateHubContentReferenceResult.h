...
namespace Model
{
  ...
  public:
    ...
    template<typename HubArnT = Aws::String>
    CreateHubContentReferenceResult& WithHubArn(HubArnT&& value) { SetHubArn(std::forward<HubArnT>(value)); return *this;}
    ///@}
    ...
    template<typename HubContentArnT = Aws::String>
    CreateHubContentReferenceResult& WithHubContentArn(HubContentArnT&& value) { SetHubContentArn(std::forward<HubContentArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateHubContentReferenceResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
