...
class ListFeatureGroupsResult {
 public:
  ...
  void SetFeatureGroupSummaries(FeatureGroupSummariesT&& value) {
    ...
    m_featureGroupSummaries = std::forward<FeatureGroupSummariesT>(value);
  }
  template <typename FeatureGroupSummariesT = Aws::Vector<FeatureGroupSummary>>
  ListFeatureGroupsResult& WithFeatureGroupSummaries(FeatureGroupSummariesT&& value) {
    SetFeatureGroupSummaries(std::forward<FeatureGroupSummariesT>(value));
    return *this;
  }
  ...
  ListFeatureGroupsResult& AddFeatureGroupSummaries(FeatureGroupSummariesT&& value) {
    m_featureGroupSummariesHasBeenSet = true;
    m_featureGroupSummaries.emplace_back(std::forward<FeatureGroupSummariesT>(value));
    return *this;
  }
  ///@}
