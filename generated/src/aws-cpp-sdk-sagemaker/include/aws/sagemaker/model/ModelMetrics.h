...
class ModelMetrics {
 public:
  ...
  void SetModelQuality(ModelQualityT&& value) {
    ...
    m_modelQuality = std::forward<ModelQualityT>(value);
  }
  template <typename ModelQualityT = ModelQuality>
  ModelMetrics& WithModelQuality(ModelQualityT&& value) {
    SetModelQuality(std::forward<ModelQualityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelDataQuality(ModelDataQualityT&& value) {
    ...
    m_modelDataQuality = std::forward<ModelDataQualityT>(value);
  }
  template <typename ModelDataQualityT = ModelDataQuality>
  ModelMetrics& WithModelDataQuality(ModelDataQualityT&& value) {
    SetModelDataQuality(std::forward<ModelDataQualityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBias(BiasT&& value) {
    ...
    m_bias = std::forward<BiasT>(value);
  }
  template <typename BiasT = Bias>
  ModelMetrics& WithBias(BiasT&& value) {
    SetBias(std::forward<BiasT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExplainability(ExplainabilityT&& value) {
    ...
    m_explainability = std::forward<ExplainabilityT>(value);
  }
  template <typename ExplainabilityT = Explainability>
  ModelMetrics& WithExplainability(ExplainabilityT&& value) {
    SetExplainability(std::forward<ExplainabilityT>(value));
    return *this;
  }
  ///@}
 private:
