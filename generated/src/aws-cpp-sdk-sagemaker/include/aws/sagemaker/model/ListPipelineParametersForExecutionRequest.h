...
class ListPipelineParametersForExecutionRequest : public SageMakerRequest {
 public:
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  ListPipelineParametersForExecutionRequest& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPipelineParametersForExecutionRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListPipelineParametersForExecutionRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
