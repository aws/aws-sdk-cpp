...
class DescribeHubResult {
 public:
  ...
  void SetS3StorageConfig(S3StorageConfigT&& value) {
    ...
    m_s3StorageConfig = std::forward<S3StorageConfigT>(value);
  }
  template <typename S3StorageConfigT = HubS3StorageConfig>
  DescribeHubResult& WithS3StorageConfig(S3StorageConfigT&& value) {
    SetS3StorageConfig(std::forward<S3StorageConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHubStatus(HubStatus value) {
    m_hubStatusHasBeenSet = true;
    m_hubStatus = value;
  }
  inline DescribeHubResult& WithHubStatus(HubStatus value) {
    SetHubStatus(value);
    return *this;
  }
  ///@}
