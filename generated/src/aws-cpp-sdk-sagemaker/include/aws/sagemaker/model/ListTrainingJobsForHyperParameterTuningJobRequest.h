...
class ListTrainingJobsForHyperParameterTuningJobRequest : public SageMakerRequest {
 public:
  ...
  template <typename HyperParameterTuningJobNameT = Aws::String>
  ListTrainingJobsForHyperParameterTuningJobRequest& WithHyperParameterTuningJobName(HyperParameterTuningJobNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainingJobsForHyperParameterTuningJobRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTrainingJobsForHyperParameterTuningJobRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatusEquals(TrainingJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListTrainingJobsForHyperParameterTuningJobRequest& WithStatusEquals(TrainingJobStatus value) {
  ...
  inline void SetSortBy(TrainingJobSortByOptions value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListTrainingJobsForHyperParameterTuningJobRequest& WithSortBy(TrainingJobSortByOptions value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListTrainingJobsForHyperParameterTuningJobRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
