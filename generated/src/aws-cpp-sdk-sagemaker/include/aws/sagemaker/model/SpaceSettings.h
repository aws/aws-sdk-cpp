...
class SpaceSettings {
 public:
  ...
  inline SpaceSettings& WithAppType(AppType value) {
    SetAppType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpaceManagedResources(FeatureStatus value) {
    m_spaceManagedResourcesHasBeenSet = true;
    m_spaceManagedResources = value;
  }
  inline SpaceSettings& WithSpaceManagedResources(FeatureStatus value) {
    SetSpaceManagedResources(value);
    return *this;
  }
  ///@}
  ...
  void SetCustomFileSystems(CustomFileSystemsT&& value) {
    ...
    m_customFileSystems = std::forward<CustomFileSystemsT>(value);
  }
  template <typename CustomFileSystemsT = Aws::Vector<CustomFileSystem>>
  SpaceSettings& WithCustomFileSystems(CustomFileSystemsT&& value) {
    SetCustomFileSystems(std::forward<CustomFileSystemsT>(value));
    return *this;
  }
  template <typename CustomFileSystemsT = CustomFileSystem>
  SpaceSettings& AddCustomFileSystems(CustomFileSystemsT&& value) {
    m_customFileSystemsHasBeenSet = true;
    m_customFileSystems.emplace_back(std::forward<CustomFileSystemsT>(value));
    return *this;
  }
  ///@}
  ...
  inline SpaceSettings& WithRemoteAccess(FeatureStatus value) {
