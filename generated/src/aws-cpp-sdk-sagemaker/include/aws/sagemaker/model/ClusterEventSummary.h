...
class ClusterEventSummary {
 public:
  ...
  inline void SetResourceType(ClusterEventResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ClusterEventSummary& WithResourceType(ClusterEventResourceType value) {
  ...
  inline ClusterEventSummary& WithEventLevel(ClusterEventLevel value) {
    SetEventLevel(value);
    return *this;
  }
  ///@}
