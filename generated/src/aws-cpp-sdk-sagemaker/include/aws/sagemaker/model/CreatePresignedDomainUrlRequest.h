...
class CreatePresignedDomainUrlRequest : public SageMakerRequest {
 public:
  ...
  inline CreatePresignedDomainUrlRequest& WithSessionExpirationDurationInSeconds(int value) {
  ...
  inline CreatePresignedDomainUrlRequest& WithExpiresInSeconds(int value) {
  ...
  void SetLandingUri(LandingUriT&& value) {
    m_landingUriHasBeenSet = true;
    m_landingUri = std::forward<LandingUriT>(value);
  }
  template <typename LandingUriT = Aws::String>
  CreatePresignedDomainUrlRequest& WithLandingUri(LandingUriT&& value) {
    SetLandingUri(std::forward<LandingUriT>(value));
    return *this;
  }
  ///@}
 private:
