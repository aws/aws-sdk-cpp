...
class RecommendationJobCompiledOutputConfig {
 public:
  ...
  void SetS3OutputUri(S3OutputUriT&& value) {
    m_s3OutputUriHasBeenSet = true;
    m_s3OutputUri = std::forward<S3OutputUriT>(value);
  }
  template <typename S3OutputUriT = Aws::String>
  RecommendationJobCompiledOutputConfig& WithS3OutputUri(S3OutputUriT&& value) {
    SetS3OutputUri(std::forward<S3OutputUriT>(value));
    return *this;
  }
  ///@}
 private:
