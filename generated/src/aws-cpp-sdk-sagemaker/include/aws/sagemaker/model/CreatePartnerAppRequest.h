...
class CreatePartnerAppRequest : public SageMakerRequest {
 public:
  ...
  inline void SetType(PartnerAppType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CreatePartnerAppRequest& WithType(PartnerAppType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePartnerAppRequest& WithAuthType(PartnerAppAuthType value) {
    SetAuthType(value);
    return *this;
  }
  ///@}
  ...
  inline CreatePartnerAppRequest& WithEnableIamSessionBasedIdentity(bool value) {
   ...
   * window, if one is available. Default is <code>FALSE</code>.</p>
   */
  ...
  inline CreatePartnerAppRequest& WithEnableAutoMinorVersionUpgrade(bool value) {
