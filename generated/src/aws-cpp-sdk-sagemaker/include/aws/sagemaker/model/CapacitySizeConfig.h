...
class CapacitySizeConfig {
 public:
  ...
  inline void SetType(NodeUnavailabilityType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline CapacitySizeConfig& WithType(NodeUnavailabilityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CapacitySizeConfig& WithValue(int value) {
    SetValue(value);
    return *this;
  }
  ///@}
