...
class ModelCard {
 public:
  ...
  void SetModelCardArn(ModelCardArnT&& value) {
    ...
    m_modelCardArn = std::forward<ModelCardArnT>(value);
  }
  template <typename ModelCardArnT = Aws::String>
  ModelCard& WithModelCardArn(ModelCardArnT&& value) {
    SetModelCardArn(std::forward<ModelCardArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModelCard& WithModelCardVersion(int value) {
  ...
  inline ModelCard& WithModelCardStatus(ModelCardStatus value) {
  ...
  void SetRiskRating(RiskRatingT&& value) {
    ...
    m_riskRating = std::forward<RiskRatingT>(value);
  }
  template <typename RiskRatingT = Aws::String>
  ModelCard& WithRiskRating(RiskRatingT&& value) {
    SetRiskRating(std::forward<RiskRatingT>(value));
    return *this;
  }
  ///@}
