...
class ListNotebookInstancesResult {
 public:
  ...
  void SetNotebookInstances(NotebookInstancesT&& value) {
    ...
    m_notebookInstances = std::forward<NotebookInstancesT>(value);
  }
  template <typename NotebookInstancesT = Aws::Vector<NotebookInstanceSummary>>
  ListNotebookInstancesResult& WithNotebookInstances(NotebookInstancesT&& value) {
    SetNotebookInstances(std::forward<NotebookInstancesT>(value));
    return *this;
  }
  ...
  ListNotebookInstancesResult& AddNotebookInstances(NotebookInstancesT&& value) {
    m_notebookInstancesHasBeenSet = true;
    m_notebookInstances.emplace_back(std::forward<NotebookInstancesT>(value));
    return *this;
  }
  ///@}
