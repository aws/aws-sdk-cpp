...
class DescribeEdgePackagingJobResult {
 public:
  ...
  inline DescribeEdgePackagingJobResult& WithEdgePackagingJobStatus(EdgePackagingJobStatus value) {
  ...
  void SetEdgePackagingJobStatusMessage(EdgePackagingJobStatusMessageT&& value) {
    ...
    m_edgePackagingJobStatusMessage = std::forward<EdgePackagingJobStatusMessageT>(value);
  }
  template <typename EdgePackagingJobStatusMessageT = Aws::String>
  DescribeEdgePackagingJobResult& WithEdgePackagingJobStatusMessage(EdgePackagingJobStatusMessageT&& value) {
    SetEdgePackagingJobStatusMessage(std::forward<EdgePackagingJobStatusMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelArtifact(ModelArtifactT&& value) {
    ...
    m_modelArtifact = std::forward<ModelArtifactT>(value);
  }
  template <typename ModelArtifactT = Aws::String>
  DescribeEdgePackagingJobResult& WithModelArtifact(ModelArtifactT&& value) {
    SetModelArtifact(std::forward<ModelArtifactT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelSignature(ModelSignatureT&& value) {
    ...
    m_modelSignature = std::forward<ModelSignatureT>(value);
  }
  template <typename ModelSignatureT = Aws::String>
  DescribeEdgePackagingJobResult& WithModelSignature(ModelSignatureT&& value) {
    SetModelSignature(std::forward<ModelSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPresetDeploymentOutput(PresetDeploymentOutputT&& value) {
    ...
    m_presetDeploymentOutput = std::forward<PresetDeploymentOutputT>(value);
  }
  template <typename PresetDeploymentOutputT = EdgePresetDeploymentOutput>
  DescribeEdgePackagingJobResult& WithPresetDeploymentOutput(PresetDeploymentOutputT&& value) {
    SetPresetDeploymentOutput(std::forward<PresetDeploymentOutputT>(value));
    return *this;
  }
  ///@}
