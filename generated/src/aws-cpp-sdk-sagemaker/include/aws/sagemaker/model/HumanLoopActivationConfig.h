...
class HumanLoopActivationConfig {
 public:
   ...
   * human loop.</p>
   */
  inline const HumanLoopActivationConditionsConfig& GetHumanLoopActivationConditionsConfig() const {
    return m_humanLoopActivationConditionsConfig;
  }
  ...
  void SetHumanLoopActivationConditionsConfig(HumanLoopActivationConditionsConfigT&& value) {
    ...
    m_humanLoopActivationConditionsConfig = std::forward<HumanLoopActivationConditionsConfigT>(value);
  }
  template <typename HumanLoopActivationConditionsConfigT = HumanLoopActivationConditionsConfig>
  HumanLoopActivationConfig& WithHumanLoopActivationConditionsConfig(HumanLoopActivationConditionsConfigT&& value) {
    SetHumanLoopActivationConditionsConfig(std::forward<HumanLoopActivationConditionsConfigT>(value));
    return *this;
  }
  ///@}
 private:
