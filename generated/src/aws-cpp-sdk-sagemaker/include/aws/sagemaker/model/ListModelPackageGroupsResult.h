...
class ListModelPackageGroupsResult {
 public:
  ...
  void SetModelPackageGroupSummaryList(ModelPackageGroupSummaryListT&& value) {
    m_modelPackageGroupSummaryListHasBeenSet = true;
    m_modelPackageGroupSummaryList = std::forward<ModelPackageGroupSummaryListT>(value);
  }
  template <typename ModelPackageGroupSummaryListT = Aws::Vector<ModelPackageGroupSummary>>
  ListModelPackageGroupsResult& WithModelPackageGroupSummaryList(ModelPackageGroupSummaryListT&& value) {
    SetModelPackageGroupSummaryList(std::forward<ModelPackageGroupSummaryListT>(value));
    return *this;
  }
  template <typename ModelPackageGroupSummaryListT = ModelPackageGroupSummary>
  ListModelPackageGroupsResult& AddModelPackageGroupSummaryList(ModelPackageGroupSummaryListT&& value) {
    m_modelPackageGroupSummaryListHasBeenSet = true;
    m_modelPackageGroupSummaryList.emplace_back(std::forward<ModelPackageGroupSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelPackageGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelPackageGroupsResult& WithRequestId(RequestIdT&& value) {
