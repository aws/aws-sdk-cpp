...
class DescribeClusterSchedulerConfigRequest : public SageMakerRequest {
 public:
  ...
  template <typename ClusterSchedulerConfigIdT = Aws::String>
  DescribeClusterSchedulerConfigRequest& WithClusterSchedulerConfigId(ClusterSchedulerConfigIdT&& value) {
  ...
  inline DescribeClusterSchedulerConfigRequest& WithClusterSchedulerConfigVersion(int value) {
