...
class ListModelPackagesResult {
 public:
  ...
  void SetModelPackageSummaryList(ModelPackageSummaryListT&& value) {
    m_modelPackageSummaryListHasBeenSet = true;
    m_modelPackageSummaryList = std::forward<ModelPackageSummaryListT>(value);
  }
  template <typename ModelPackageSummaryListT = Aws::Vector<ModelPackageSummary>>
  ListModelPackagesResult& WithModelPackageSummaryList(ModelPackageSummaryListT&& value) {
    SetModelPackageSummaryList(std::forward<ModelPackageSummaryListT>(value));
    return *this;
  }
  template <typename ModelPackageSummaryListT = ModelPackageSummary>
  ListModelPackagesResult& AddModelPackageSummaryList(ModelPackageSummaryListT&& value) {
    m_modelPackageSummaryListHasBeenSet = true;
    m_modelPackageSummaryList.emplace_back(std::forward<ModelPackageSummaryListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelPackagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListModelPackagesResult& WithRequestId(RequestIdT&& value) {
