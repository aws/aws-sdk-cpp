...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API UpdateExperimentResult() = default;
    ...
    template<typename ExperimentArnT = Aws::String>
    UpdateExperimentResult& WithExperimentArn(ExperimentArnT&& value) { SetExperimentArn(std::forward<ExperimentArnT>(value)); return *this;}
    ///@}
