...
class RecommendationJobContainerConfig {
 public:
  ...
  void SetNearestModelName(NearestModelNameT&& value) {
    ...
    m_nearestModelName = std::forward<NearestModelNameT>(value);
  }
  template <typename NearestModelNameT = Aws::String>
  RecommendationJobContainerConfig& WithNearestModelName(NearestModelNameT&& value) {
    SetNearestModelName(std::forward<NearestModelNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSupportedEndpointType(RecommendationJobSupportedEndpointType value) {
    m_supportedEndpointTypeHasBeenSet = true;
    m_supportedEndpointType = value;
  }
  inline RecommendationJobContainerConfig& WithSupportedEndpointType(RecommendationJobSupportedEndpointType value) {
    SetSupportedEndpointType(value);
    return *this;
  }
  ///@}
  ...
  void SetDataInputConfig(DataInputConfigT&& value) {
    ...
    m_dataInputConfig = std::forward<DataInputConfigT>(value);
  }
  template <typename DataInputConfigT = Aws::String>
  RecommendationJobContainerConfig& WithDataInputConfig(DataInputConfigT&& value) {
    SetDataInputConfig(std::forward<DataInputConfigT>(value));
    return *this;
  }
  ///@}
