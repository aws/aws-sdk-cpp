...
class CanvasAppSettings {
 public:
  ...
  void SetTimeSeriesForecastingSettings(TimeSeriesForecastingSettingsT&& value) {
    ...
    m_timeSeriesForecastingSettings = std::forward<TimeSeriesForecastingSettingsT>(value);
  }
  template <typename TimeSeriesForecastingSettingsT = TimeSeriesForecastingSettings>
  CanvasAppSettings& WithTimeSeriesForecastingSettings(TimeSeriesForecastingSettingsT&& value) {
    SetTimeSeriesForecastingSettings(std::forward<TimeSeriesForecastingSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModelRegisterSettings(ModelRegisterSettingsT&& value) {
    ...
    m_modelRegisterSettings = std::forward<ModelRegisterSettingsT>(value);
  }
  template <typename ModelRegisterSettingsT = ModelRegisterSettings>
  CanvasAppSettings& WithModelRegisterSettings(ModelRegisterSettingsT&& value) {
    SetModelRegisterSettings(std::forward<ModelRegisterSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWorkspaceSettings(WorkspaceSettingsT&& value) {
    ...
    m_workspaceSettings = std::forward<WorkspaceSettingsT>(value);
  }
  template <typename WorkspaceSettingsT = WorkspaceSettings>
  CanvasAppSettings& WithWorkspaceSettings(WorkspaceSettingsT&& value) {
    SetWorkspaceSettings(std::forward<WorkspaceSettingsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<IdentityProviderOAuthSetting>& GetIdentityProviderOAuthSettings() const {
    return m_identityProviderOAuthSettings;
  }
  ...
  void SetIdentityProviderOAuthSettings(IdentityProviderOAuthSettingsT&& value) {
    ...
    m_identityProviderOAuthSettings = std::forward<IdentityProviderOAuthSettingsT>(value);
  }
  template <typename IdentityProviderOAuthSettingsT = Aws::Vector<IdentityProviderOAuthSetting>>
  CanvasAppSettings& WithIdentityProviderOAuthSettings(IdentityProviderOAuthSettingsT&& value) {
    SetIdentityProviderOAuthSettings(std::forward<IdentityProviderOAuthSettingsT>(value));
    return *this;
  }
  ...
  CanvasAppSettings& AddIdentityProviderOAuthSettings(IdentityProviderOAuthSettingsT&& value) {
    m_identityProviderOAuthSettingsHasBeenSet = true;
    m_identityProviderOAuthSettings.emplace_back(std::forward<IdentityProviderOAuthSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDirectDeploySettings(DirectDeploySettingsT&& value) {
    ...
    m_directDeploySettings = std::forward<DirectDeploySettingsT>(value);
  }
  template <typename DirectDeploySettingsT = DirectDeploySettings>
  CanvasAppSettings& WithDirectDeploySettings(DirectDeploySettingsT&& value) {
    SetDirectDeploySettings(std::forward<DirectDeploySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetKendraSettings(KendraSettingsT&& value) {
    ...
    m_kendraSettings = std::forward<KendraSettingsT>(value);
  }
  template <typename KendraSettingsT = KendraSettings>
  CanvasAppSettings& WithKendraSettings(KendraSettingsT&& value) {
    SetKendraSettings(std::forward<KendraSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEmrServerlessSettings(EmrServerlessSettingsT&& value) {
    ...
    m_emrServerlessSettings = std::forward<EmrServerlessSettingsT>(value);
  }
  template <typename EmrServerlessSettingsT = EmrServerlessSettings>
  CanvasAppSettings& WithEmrServerlessSettings(EmrServerlessSettingsT&& value) {
    SetEmrServerlessSettings(std::forward<EmrServerlessSettingsT>(value));
    return *this;
  }
  ///@}
 private:
