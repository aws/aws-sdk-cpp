...
class DeploymentConfig {
 public:
  ...
  void SetBlueGreenUpdatePolicy(BlueGreenUpdatePolicyT&& value) {
    ...
    m_blueGreenUpdatePolicy = std::forward<BlueGreenUpdatePolicyT>(value);
  }
  template <typename BlueGreenUpdatePolicyT = BlueGreenUpdatePolicy>
  DeploymentConfig& WithBlueGreenUpdatePolicy(BlueGreenUpdatePolicyT&& value) {
    SetBlueGreenUpdatePolicy(std::forward<BlueGreenUpdatePolicyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRollingUpdatePolicy(RollingUpdatePolicyT&& value) {
    ...
    m_rollingUpdatePolicy = std::forward<RollingUpdatePolicyT>(value);
  }
  template <typename RollingUpdatePolicyT = RollingUpdatePolicy>
  DeploymentConfig& WithRollingUpdatePolicy(RollingUpdatePolicyT&& value) {
    SetRollingUpdatePolicy(std::forward<RollingUpdatePolicyT>(value));
    return *this;
  }
  ///@}
