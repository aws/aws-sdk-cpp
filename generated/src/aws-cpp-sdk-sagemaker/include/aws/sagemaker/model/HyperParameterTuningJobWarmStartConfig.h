...
class HyperParameterTuningJobWarmStartConfig {
 public:
   ...
   */
  inline const Aws::Vector<ParentHyperParameterTuningJob>& GetParentHyperParameterTuningJobs() const {
    return m_parentHyperParameterTuningJobs;
  }
  ...
  void SetParentHyperParameterTuningJobs(ParentHyperParameterTuningJobsT&& value) {
    m_parentHyperParameterTuningJobsHasBeenSet = true;
    m_parentHyperParameterTuningJobs = std::forward<ParentHyperParameterTuningJobsT>(value);
  }
  template <typename ParentHyperParameterTuningJobsT = Aws::Vector<ParentHyperParameterTuningJob>>
  HyperParameterTuningJobWarmStartConfig& WithParentHyperParameterTuningJobs(ParentHyperParameterTuningJobsT&& value) {
    SetParentHyperParameterTuningJobs(std::forward<ParentHyperParameterTuningJobsT>(value));
    return *this;
  }
  template <typename ParentHyperParameterTuningJobsT = ParentHyperParameterTuningJob>
  HyperParameterTuningJobWarmStartConfig& AddParentHyperParameterTuningJobs(ParentHyperParameterTuningJobsT&& value) {
    m_parentHyperParameterTuningJobsHasBeenSet = true;
    m_parentHyperParameterTuningJobs.emplace_back(std::forward<ParentHyperParameterTuningJobsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetWarmStartType(HyperParameterTuningJobWarmStartType value) {
    m_warmStartTypeHasBeenSet = true;
    m_warmStartType = value;
  }
  inline HyperParameterTuningJobWarmStartConfig& WithWarmStartType(HyperParameterTuningJobWarmStartType value) {
    SetWarmStartType(value);
    return *this;
  }
  ///@}
 private:
