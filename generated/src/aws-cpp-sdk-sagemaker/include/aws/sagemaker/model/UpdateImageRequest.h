...
class UpdateImageRequest : public SageMakerRequest {
 public:
  ...
  void SetDeleteProperties(DeletePropertiesT&& value) {
    m_deletePropertiesHasBeenSet = true;
    m_deleteProperties = std::forward<DeletePropertiesT>(value);
  }
  template <typename DeletePropertiesT = Aws::Vector<Aws::String>>
  UpdateImageRequest& WithDeleteProperties(DeletePropertiesT&& value) {
    SetDeleteProperties(std::forward<DeletePropertiesT>(value));
    return *this;
  }
  template <typename DeletePropertiesT = Aws::String>
  UpdateImageRequest& AddDeleteProperties(DeletePropertiesT&& value) {
    m_deletePropertiesHasBeenSet = true;
    m_deleteProperties.emplace_back(std::forward<DeletePropertiesT>(value));
    return *this;
  }
  ///@}
