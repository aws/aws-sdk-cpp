...
class ListContextsRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(SortContextsBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListContextsRequest& WithSortBy(SortContextsBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListContextsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListContextsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
