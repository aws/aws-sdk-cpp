...
class ListInferenceComponentsResult {
 public:
  ...
  template <typename InferenceComponentsT = Aws::Vector<InferenceComponentSummary>>
  ListInferenceComponentsResult& WithInferenceComponents(InferenceComponentsT&& value) {
  ...
  ListInferenceComponentsResult& AddInferenceComponents(InferenceComponentsT&& value) {
    m_inferenceComponentsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceComponentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceComponentsResult& WithRequestId(RequestIdT&& value) {
