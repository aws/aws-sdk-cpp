...
class ResourceCatalog {
 public:
  ...
  void SetResourceCatalogArn(ResourceCatalogArnT&& value) {
    ...
    m_resourceCatalogArn = std::forward<ResourceCatalogArnT>(value);
  }
  template <typename ResourceCatalogArnT = Aws::String>
  ResourceCatalog& WithResourceCatalogArn(ResourceCatalogArnT&& value) {
    SetResourceCatalogArn(std::forward<ResourceCatalogArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceCatalogName(ResourceCatalogNameT&& value) {
    ...
    m_resourceCatalogName = std::forward<ResourceCatalogNameT>(value);
  }
  template <typename ResourceCatalogNameT = Aws::String>
  ResourceCatalog& WithResourceCatalogName(ResourceCatalogNameT&& value) {
    SetResourceCatalogName(std::forward<ResourceCatalogNameT>(value));
    return *this;
  }
  ///@}
