...
class ListTrainingJobsForHyperParameterTuningJobResult {
 public:
  ...
  AWS_SAGEMAKER_API ListTrainingJobsForHyperParameterTuningJobResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename TrainingJobSummariesT = Aws::Vector<HyperParameterTrainingJobSummary>>
  ListTrainingJobsForHyperParameterTuningJobResult& WithTrainingJobSummaries(TrainingJobSummariesT&& value) {
  ...
  ListTrainingJobsForHyperParameterTuningJobResult& AddTrainingJobSummaries(TrainingJobSummariesT&& value) {
    m_trainingJobSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainingJobsForHyperParameterTuningJobResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrainingJobsForHyperParameterTuningJobResult& WithRequestId(RequestIdT&& value) {
