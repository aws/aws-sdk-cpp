...
class ListModelPackageGroupsRequest : public SageMakerRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelPackageGroupsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelPackageGroupsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline ListModelPackageGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListModelPackageGroupsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListModelPackageGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline void SetSortBy(ModelPackageGroupSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListModelPackageGroupsRequest& WithSortBy(ModelPackageGroupSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelPackageGroupsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCrossAccountFilterOption(CrossAccountFilterOption value) {
    m_crossAccountFilterOptionHasBeenSet = true;
    m_crossAccountFilterOption = value;
  }
  inline ListModelPackageGroupsRequest& WithCrossAccountFilterOption(CrossAccountFilterOption value) {
    SetCrossAccountFilterOption(value);
    return *this;
  }
  ///@}
 private:
