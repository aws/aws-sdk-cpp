...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API ModelExplainabilityJobInput() = default;
    AWS_SAGEMAKER_API ModelExplainabilityJobInput(Aws::Utils::Json::JsonView jsonValue);
    AWS_SAGEMAKER_API ModelExplainabilityJobInput& operator=(Aws::Utils::Json::JsonView jsonValue);
    ...
    template<typename EndpointInputT = EndpointInput>
    ModelExplainabilityJobInput& WithEndpointInput(EndpointInputT&& value) { SetEndpointInput(std::forward<EndpointInputT>(value)); return *this;}
    ///@}
    ...
    template<typename BatchTransformInputT = BatchTransformInput>
    ModelExplainabilityJobInput& WithBatchTransformInput(BatchTransformInputT&& value) { SetBatchTransformInput(std::forward<BatchTransformInputT>(value)); return *this;}
    ///@}
  private:
