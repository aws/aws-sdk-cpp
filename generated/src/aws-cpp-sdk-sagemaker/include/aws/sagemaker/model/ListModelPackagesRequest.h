...
class ListModelPackagesRequest : public SageMakerRequest {
 public:
  ...
  inline ListModelPackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelPackagesRequest& WithModelApprovalStatus(ModelApprovalStatus value) {
  ...
  inline void SetModelPackageType(ModelPackageType value) {
    m_modelPackageTypeHasBeenSet = true;
    m_modelPackageType = value;
  }
  inline ListModelPackagesRequest& WithModelPackageType(ModelPackageType value) {
    SetModelPackageType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ModelPackageSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListModelPackagesRequest& WithSortBy(ModelPackageSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListModelPackagesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
