...
class ChannelSpecification {
 public:
  ...
  inline ChannelSpecification& WithIsRequired(bool value) {
    SetIsRequired(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedCompressionTypes(SupportedCompressionTypesT&& value) {
    ...
    m_supportedCompressionTypes = std::forward<SupportedCompressionTypesT>(value);
  }
  template <typename SupportedCompressionTypesT = Aws::Vector<CompressionType>>
  ChannelSpecification& WithSupportedCompressionTypes(SupportedCompressionTypesT&& value) {
    SetSupportedCompressionTypes(std::forward<SupportedCompressionTypesT>(value));
    return *this;
  }
  inline ChannelSpecification& AddSupportedCompressionTypes(CompressionType value) {
    m_supportedCompressionTypesHasBeenSet = true;
    m_supportedCompressionTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedInputModes(SupportedInputModesT&& value) {
    ...
    m_supportedInputModes = std::forward<SupportedInputModesT>(value);
  }
  template <typename SupportedInputModesT = Aws::Vector<TrainingInputMode>>
  ChannelSpecification& WithSupportedInputModes(SupportedInputModesT&& value) {
    SetSupportedInputModes(std::forward<SupportedInputModesT>(value));
    return *this;
  }
  inline ChannelSpecification& AddSupportedInputModes(TrainingInputMode value) {
    m_supportedInputModesHasBeenSet = true;
    m_supportedInputModes.push_back(value);
    return *this;
  }
  ///@}
 private:
