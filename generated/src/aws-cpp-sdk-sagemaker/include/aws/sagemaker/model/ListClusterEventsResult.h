...
class ListClusterEventsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterEventsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename EventsT = Aws::Vector<ClusterEventSummary>>
  ListClusterEventsResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = ClusterEventSummary>
  ListClusterEventsResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListClusterEventsResult& WithRequestId(RequestIdT&& value) {
