...
class ListSubscribedWorkteamsRequest : public SageMakerRequest {
 public:
  ...
  template <typename NameContainsT = Aws::String>
  ListSubscribedWorkteamsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListSubscribedWorkteamsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListSubscribedWorkteamsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
