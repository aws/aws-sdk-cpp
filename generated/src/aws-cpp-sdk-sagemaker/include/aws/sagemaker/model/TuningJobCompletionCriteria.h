...
class TuningJobCompletionCriteria {
 public:
  ...
  inline void SetTargetObjectiveMetricValue(double value) {
    m_targetObjectiveMetricValueHasBeenSet = true;
    m_targetObjectiveMetricValue = value;
  }
  inline TuningJobCompletionCriteria& WithTargetObjectiveMetricValue(double value) {
    SetTargetObjectiveMetricValue(value);
    return *this;
  }
  ///@}
  ...
  void SetBestObjectiveNotImproving(BestObjectiveNotImprovingT&& value) {
    ...
    m_bestObjectiveNotImproving = std::forward<BestObjectiveNotImprovingT>(value);
  }
  template <typename BestObjectiveNotImprovingT = BestObjectiveNotImproving>
  TuningJobCompletionCriteria& WithBestObjectiveNotImproving(BestObjectiveNotImprovingT&& value) {
    SetBestObjectiveNotImproving(std::forward<BestObjectiveNotImprovingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConvergenceDetected(ConvergenceDetectedT&& value) {
    ...
    m_convergenceDetected = std::forward<ConvergenceDetectedT>(value);
  }
  template <typename ConvergenceDetectedT = ConvergenceDetected>
  TuningJobCompletionCriteria& WithConvergenceDetected(ConvergenceDetectedT&& value) {
    SetConvergenceDetected(std::forward<ConvergenceDetectedT>(value));
    return *this;
  }
  ///@}
 private:
