...
class ListModelCardExportJobsRequest : public SageMakerRequest {
 public:
  ...
  template <typename ModelCardNameT = Aws::String>
  ListModelCardExportJobsRequest& WithModelCardName(ModelCardNameT&& value) {
  ...
  inline ListModelCardExportJobsRequest& WithModelCardVersion(int value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListModelCardExportJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListModelCardExportJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  void SetModelCardExportJobNameContains(ModelCardExportJobNameContainsT&& value) {
    m_modelCardExportJobNameContainsHasBeenSet = true;
    m_modelCardExportJobNameContains = std::forward<ModelCardExportJobNameContainsT>(value);
  }
  template <typename ModelCardExportJobNameContainsT = Aws::String>
  ListModelCardExportJobsRequest& WithModelCardExportJobNameContains(ModelCardExportJobNameContainsT&& value) {
    SetModelCardExportJobNameContains(std::forward<ModelCardExportJobNameContainsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatusEquals(ModelCardExportJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListModelCardExportJobsRequest& WithStatusEquals(ModelCardExportJobStatus value) {
  ...
  inline void SetSortBy(ModelCardExportJobSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListModelCardExportJobsRequest& WithSortBy(ModelCardExportJobSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(ModelCardExportJobSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListModelCardExportJobsRequest& WithSortOrder(ModelCardExportJobSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListModelCardExportJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListModelCardExportJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
