...
class ListTransformJobsRequest : public SageMakerRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListTransformJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListTransformJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListTransformJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListTransformJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListTransformJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  inline void SetStatusEquals(TransformJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListTransformJobsRequest& WithStatusEquals(TransformJobStatus value) {
  ...
  inline ListTransformJobsRequest& WithSortBy(SortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListTransformJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTransformJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTransformJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
