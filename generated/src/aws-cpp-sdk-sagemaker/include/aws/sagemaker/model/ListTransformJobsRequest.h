...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API ListTransformJobsRequest() = default;
    ...
    template<typename CreationTimeAfterT = Aws::Utils::DateTime>
    ListTransformJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) { SetCreationTimeAfter(std::forward<CreationTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeBeforeT = Aws::Utils::DateTime>
    ListTransformJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) { SetCreationTimeBefore(std::forward<CreationTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
    ListTransformJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) { SetLastModifiedTimeAfter(std::forward<LastModifiedTimeAfterT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
    ListTransformJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) { SetLastModifiedTimeBefore(std::forward<LastModifiedTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListTransformJobsRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
     ...
     */
    inline TransformJobStatus GetStatusEquals() const { return m_statusEquals; }
    inline bool StatusEqualsHasBeenSet() const { return m_statusEqualsHasBeenSet; }
    inline void SetStatusEquals(TransformJobStatus value) { m_statusEqualsHasBeenSet = true; m_statusEquals = value; }
    inline ListTransformJobsRequest& WithStatusEquals(TransformJobStatus value) { SetStatusEquals(value); return *this;}
    ///@}
    ...
    inline ListTransformJobsRequest& WithSortBy(SortBy value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline ListTransformJobsRequest& WithSortOrder(SortOrder value) { SetSortOrder(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListTransformJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  ...
  private:
    ...
    TransformJobStatus m_statusEquals{TransformJobStatus::NOT_SET};
