...
class UpdateModelPackageRequest : public SageMakerRequest {
 public:
  ...
  void SetCustomerMetadataPropertiesToRemove(CustomerMetadataPropertiesToRemoveT&& value) {
    m_customerMetadataPropertiesToRemoveHasBeenSet = true;
    m_customerMetadataPropertiesToRemove = std::forward<CustomerMetadataPropertiesToRemoveT>(value);
  }
  template <typename CustomerMetadataPropertiesToRemoveT = Aws::Vector<Aws::String>>
  UpdateModelPackageRequest& WithCustomerMetadataPropertiesToRemove(CustomerMetadataPropertiesToRemoveT&& value) {
    SetCustomerMetadataPropertiesToRemove(std::forward<CustomerMetadataPropertiesToRemoveT>(value));
    return *this;
  }
  ...
  UpdateModelPackageRequest& AddCustomerMetadataPropertiesToRemove(CustomerMetadataPropertiesToRemoveT&& value) {
    m_customerMetadataPropertiesToRemoveHasBeenSet = true;
    m_customerMetadataPropertiesToRemove.emplace_back(std::forward<CustomerMetadataPropertiesToRemoveT>(value));
    return *this;
  }
  ///@}
   ...
   * artifacts.</p>
   */
  inline const Aws::Vector<AdditionalInferenceSpecificationDefinition>& GetAdditionalInferenceSpecificationsToAdd() const {
    return m_additionalInferenceSpecificationsToAdd;
  }
  ...
  void SetAdditionalInferenceSpecificationsToAdd(AdditionalInferenceSpecificationsToAddT&& value) {
    m_additionalInferenceSpecificationsToAddHasBeenSet = true;
    m_additionalInferenceSpecificationsToAdd = std::forward<AdditionalInferenceSpecificationsToAddT>(value);
  }
  template <typename AdditionalInferenceSpecificationsToAddT = Aws::Vector<AdditionalInferenceSpecificationDefinition>>
  UpdateModelPackageRequest& WithAdditionalInferenceSpecificationsToAdd(AdditionalInferenceSpecificationsToAddT&& value) {
    SetAdditionalInferenceSpecificationsToAdd(std::forward<AdditionalInferenceSpecificationsToAddT>(value));
    return *this;
  }
  ...
  UpdateModelPackageRequest& AddAdditionalInferenceSpecificationsToAdd(AdditionalInferenceSpecificationsToAddT&& value) {
    m_additionalInferenceSpecificationsToAddHasBeenSet = true;
    m_additionalInferenceSpecificationsToAdd.emplace_back(std::forward<AdditionalInferenceSpecificationsToAddT>(value));
    return *this;
  }
  ///@}
