...
class ListClustersRequest : public SageMakerRequest {
 public:
  ...
  inline void SetSortBy(ClusterSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListClustersRequest& WithSortBy(ClusterSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListClustersRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
