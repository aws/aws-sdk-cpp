...
class ListTrainingJobsResult {
 public:
  ...
  void SetTrainingJobSummaries(TrainingJobSummariesT&& value) {
    m_trainingJobSummariesHasBeenSet = true;
    m_trainingJobSummaries = std::forward<TrainingJobSummariesT>(value);
  }
  template <typename TrainingJobSummariesT = Aws::Vector<TrainingJobSummary>>
  ListTrainingJobsResult& WithTrainingJobSummaries(TrainingJobSummariesT&& value) {
    SetTrainingJobSummaries(std::forward<TrainingJobSummariesT>(value));
    return *this;
  }
  template <typename TrainingJobSummariesT = TrainingJobSummary>
  ListTrainingJobsResult& AddTrainingJobSummaries(TrainingJobSummariesT&& value) {
    m_trainingJobSummariesHasBeenSet = true;
    m_trainingJobSummaries.emplace_back(std::forward<TrainingJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTrainingJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTrainingJobsResult& WithRequestId(RequestIdT&& value) {
