...
class SelectiveExecutionResult {
 public:
  ...
  void SetSourcePipelineExecutionArn(SourcePipelineExecutionArnT&& value) {
    ...
    m_sourcePipelineExecutionArn = std::forward<SourcePipelineExecutionArnT>(value);
  }
  template <typename SourcePipelineExecutionArnT = Aws::String>
  SelectiveExecutionResult& WithSourcePipelineExecutionArn(SourcePipelineExecutionArnT&& value) {
    SetSourcePipelineExecutionArn(std::forward<SourcePipelineExecutionArnT>(value));
    return *this;
  }
  ///@}
 private:
