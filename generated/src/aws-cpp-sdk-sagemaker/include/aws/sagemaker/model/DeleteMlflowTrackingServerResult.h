...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteMlflowTrackingServerResult() = default;
    ...
    template<typename TrackingServerArnT = Aws::String>
    DeleteMlflowTrackingServerResult& WithTrackingServerArn(TrackingServerArnT&& value) { SetTrackingServerArn(std::forward<TrackingServerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteMlflowTrackingServerResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
