...
class DescribeTransformJobResult {
 public:
  ...
  void SetTransformJobName(TransformJobNameT&& value) {
    ...
    m_transformJobName = std::forward<TransformJobNameT>(value);
  }
  template <typename TransformJobNameT = Aws::String>
  DescribeTransformJobResult& WithTransformJobName(TransformJobNameT&& value) {
    SetTransformJobName(std::forward<TransformJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformJobArn(TransformJobArnT&& value) {
    ...
    m_transformJobArn = std::forward<TransformJobArnT>(value);
  }
  template <typename TransformJobArnT = Aws::String>
  DescribeTransformJobResult& WithTransformJobArn(TransformJobArnT&& value) {
    SetTransformJobArn(std::forward<TransformJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTransformJobStatus(TransformJobStatus value) {
    m_transformJobStatusHasBeenSet = true;
    m_transformJobStatus = value;
  }
  inline DescribeTransformJobResult& WithTransformJobStatus(TransformJobStatus value) {
    SetTransformJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxConcurrentTransforms(int value) {
    m_maxConcurrentTransformsHasBeenSet = true;
    m_maxConcurrentTransforms = value;
  }
  inline DescribeTransformJobResult& WithMaxConcurrentTransforms(int value) {
    SetMaxConcurrentTransforms(value);
    return *this;
  }
  ///@}
  ...
  void SetModelClientConfig(ModelClientConfigT&& value) {
    ...
    m_modelClientConfig = std::forward<ModelClientConfigT>(value);
  }
  template <typename ModelClientConfigT = ModelClientConfig>
  DescribeTransformJobResult& WithModelClientConfig(ModelClientConfigT&& value) {
    SetModelClientConfig(std::forward<ModelClientConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxPayloadInMB(int value) {
    m_maxPayloadInMBHasBeenSet = true;
    m_maxPayloadInMB = value;
  }
  inline DescribeTransformJobResult& WithMaxPayloadInMB(int value) {
    SetMaxPayloadInMB(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBatchStrategy(BatchStrategy value) {
    m_batchStrategyHasBeenSet = true;
    m_batchStrategy = value;
  }
  inline DescribeTransformJobResult& WithBatchStrategy(BatchStrategy value) {
    SetBatchStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetTransformInput(TransformInputT&& value) {
    ...
    m_transformInput = std::forward<TransformInputT>(value);
  }
  template <typename TransformInputT = TransformInput>
  DescribeTransformJobResult& WithTransformInput(TransformInputT&& value) {
    SetTransformInput(std::forward<TransformInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformOutput(TransformOutputT&& value) {
    ...
    m_transformOutput = std::forward<TransformOutputT>(value);
  }
  template <typename TransformOutputT = TransformOutput>
  DescribeTransformJobResult& WithTransformOutput(TransformOutputT&& value) {
    SetTransformOutput(std::forward<TransformOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformResources(TransformResourcesT&& value) {
    ...
    m_transformResources = std::forward<TransformResourcesT>(value);
  }
  template <typename TransformResourcesT = TransformResources>
  DescribeTransformJobResult& WithTransformResources(TransformResourcesT&& value) {
    SetTransformResources(std::forward<TransformResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformStartTime(TransformStartTimeT&& value) {
    ...
    m_transformStartTime = std::forward<TransformStartTimeT>(value);
  }
  template <typename TransformStartTimeT = Aws::Utils::DateTime>
  DescribeTransformJobResult& WithTransformStartTime(TransformStartTimeT&& value) {
    SetTransformStartTime(std::forward<TransformStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransformEndTime(TransformEndTimeT&& value) {
    ...
    m_transformEndTime = std::forward<TransformEndTimeT>(value);
  }
  template <typename TransformEndTimeT = Aws::Utils::DateTime>
  DescribeTransformJobResult& WithTransformEndTime(TransformEndTimeT&& value) {
    SetTransformEndTime(std::forward<TransformEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataProcessing(DataProcessingT&& value) {
    ...
    m_dataProcessing = std::forward<DataProcessingT>(value);
  }
  template <typename DataProcessingT = DataProcessing>
  DescribeTransformJobResult& WithDataProcessing(DataProcessingT&& value) {
    SetDataProcessing(std::forward<DataProcessingT>(value));
    return *this;
  }
  ///@}
