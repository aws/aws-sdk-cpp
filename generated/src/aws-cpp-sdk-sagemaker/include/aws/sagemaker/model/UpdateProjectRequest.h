...
class UpdateProjectRequest : public SageMakerRequest {
 public:
   ...
   */
  inline const ServiceCatalogProvisioningUpdateDetails& GetServiceCatalogProvisioningUpdateDetails() const {
    return m_serviceCatalogProvisioningUpdateDetails;
  }
  ...
  void SetServiceCatalogProvisioningUpdateDetails(ServiceCatalogProvisioningUpdateDetailsT&& value) {
    m_serviceCatalogProvisioningUpdateDetailsHasBeenSet = true;
    m_serviceCatalogProvisioningUpdateDetails = std::forward<ServiceCatalogProvisioningUpdateDetailsT>(value);
  }
  template <typename ServiceCatalogProvisioningUpdateDetailsT = ServiceCatalogProvisioningUpdateDetails>
  UpdateProjectRequest& WithServiceCatalogProvisioningUpdateDetails(ServiceCatalogProvisioningUpdateDetailsT&& value) {
    SetServiceCatalogProvisioningUpdateDetails(std::forward<ServiceCatalogProvisioningUpdateDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateProvidersToUpdate(TemplateProvidersToUpdateT&& value) {
    m_templateProvidersToUpdateHasBeenSet = true;
    m_templateProvidersToUpdate = std::forward<TemplateProvidersToUpdateT>(value);
  }
  template <typename TemplateProvidersToUpdateT = Aws::Vector<UpdateTemplateProvider>>
  UpdateProjectRequest& WithTemplateProvidersToUpdate(TemplateProvidersToUpdateT&& value) {
    SetTemplateProvidersToUpdate(std::forward<TemplateProvidersToUpdateT>(value));
    return *this;
  }
  template <typename TemplateProvidersToUpdateT = UpdateTemplateProvider>
  UpdateProjectRequest& AddTemplateProvidersToUpdate(TemplateProvidersToUpdateT&& value) {
    m_templateProvidersToUpdateHasBeenSet = true;
    m_templateProvidersToUpdate.emplace_back(std::forward<TemplateProvidersToUpdateT>(value));
    return *this;
  }
  ///@}
 private:
