...
class ServiceCatalogProvisioningUpdateDetails {
 public:
  ...
  template <typename ProvisioningArtifactIdT = Aws::String>
  ServiceCatalogProvisioningUpdateDetails& WithProvisioningArtifactId(ProvisioningArtifactIdT&& value) {
  ...
  template <typename ProvisioningParametersT = Aws::Vector<ProvisioningParameter>>
  ServiceCatalogProvisioningUpdateDetails& WithProvisioningParameters(ProvisioningParametersT&& value) {
  ...
  ServiceCatalogProvisioningUpdateDetails& AddProvisioningParameters(ProvisioningParametersT&& value) {
    m_provisioningParametersHasBeenSet = true;
