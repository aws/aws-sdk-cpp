...
class InferenceRecommendation {
 public:
  ...
  void SetInvocationEndTime(InvocationEndTimeT&& value) {
    ...
    m_invocationEndTime = std::forward<InvocationEndTimeT>(value);
  }
  template <typename InvocationEndTimeT = Aws::Utils::DateTime>
  InferenceRecommendation& WithInvocationEndTime(InvocationEndTimeT&& value) {
    SetInvocationEndTime(std::forward<InvocationEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInvocationStartTime(InvocationStartTimeT&& value) {
    ...
    m_invocationStartTime = std::forward<InvocationStartTimeT>(value);
  }
  template <typename InvocationStartTimeT = Aws::Utils::DateTime>
  InferenceRecommendation& WithInvocationStartTime(InvocationStartTimeT&& value) {
    SetInvocationStartTime(std::forward<InvocationStartTimeT>(value));
    return *this;
  }
  ///@}
 private:
