...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainExecutionRoleArnT = Aws::String>
    RStudioServerProDomainSettingsForUpdate& WithDomainExecutionRoleArn(DomainExecutionRoleArnT&& value) { SetDomainExecutionRoleArn(std::forward<DomainExecutionRoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultResourceSpecT = ResourceSpec>
    RStudioServerProDomainSettingsForUpdate& WithDefaultResourceSpec(DefaultResourceSpecT&& value) { SetDefaultResourceSpec(std::forward<DefaultResourceSpecT>(value)); return *this;}
    ///@}
    ...
    template<typename RStudioConnectUrlT = Aws::String>
    RStudioServerProDomainSettingsForUpdate& WithRStudioConnectUrl(RStudioConnectUrlT&& value) { SetRStudioConnectUrl(std::forward<RStudioConnectUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RStudioPackageManagerUrlT = Aws::String>
    RStudioServerProDomainSettingsForUpdate& WithRStudioPackageManagerUrl(RStudioPackageManagerUrlT&& value) { SetRStudioPackageManagerUrl(std::forward<RStudioPackageManagerUrlT>(value)); return *this;}
    ///@}
  private:
