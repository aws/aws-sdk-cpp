...
class TransformJobDefinition {
 public:
  ...
  inline TransformJobDefinition& WithMaxConcurrentTransforms(int value) {
  ...
  inline TransformJobDefinition& WithMaxPayloadInMB(int value) {
  ...
  inline TransformJobDefinition& WithBatchStrategy(BatchStrategy value) {
