...
class ListResourceCatalogsRequest : public SageMakerRequest {
 public:
  ...
  template <typename NameContainsT = Aws::String>
  ListResourceCatalogsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListResourceCatalogsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListResourceCatalogsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline void SetSortOrder(ResourceCatalogSortOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline ListResourceCatalogsRequest& WithSortOrder(ResourceCatalogSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(ResourceCatalogSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListResourceCatalogsRequest& WithSortBy(ResourceCatalogSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListResourceCatalogsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListResourceCatalogsRequest& WithNextToken(NextTokenT&& value) {
