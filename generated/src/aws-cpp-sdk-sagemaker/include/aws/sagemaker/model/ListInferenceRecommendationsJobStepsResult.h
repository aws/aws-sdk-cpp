...
class ListInferenceRecommendationsJobStepsResult {
 public:
  ...
  AWS_SAGEMAKER_API ListInferenceRecommendationsJobStepsResult& operator=(
  ...
  template <typename StepsT = Aws::Vector<InferenceRecommendationsJobStep>>
  ListInferenceRecommendationsJobStepsResult& WithSteps(StepsT&& value) {
    SetSteps(std::forward<StepsT>(value));
    return *this;
  }
  template <typename StepsT = InferenceRecommendationsJobStep>
  ListInferenceRecommendationsJobStepsResult& AddSteps(StepsT&& value) {
    m_stepsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceRecommendationsJobStepsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceRecommendationsJobStepsResult& WithRequestId(RequestIdT&& value) {
