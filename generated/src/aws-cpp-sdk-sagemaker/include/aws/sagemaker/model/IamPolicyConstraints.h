...
class IamPolicyConstraints {
 public:
  ...
  inline void SetSourceIp(EnabledOrDisabled value) {
    m_sourceIpHasBeenSet = true;
    m_sourceIp = value;
  }
  inline IamPolicyConstraints& WithSourceIp(EnabledOrDisabled value) {
    SetSourceIp(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVpcSourceIp(EnabledOrDisabled value) {
    m_vpcSourceIpHasBeenSet = true;
    m_vpcSourceIp = value;
  }
  inline IamPolicyConstraints& WithVpcSourceIp(EnabledOrDisabled value) {
    SetVpcSourceIp(value);
    return *this;
  }
  ///@}
 private:
