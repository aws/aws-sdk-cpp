...
class CreateImageVersionRequest : public SageMakerRequest {
 public:
  ...
  inline CreateImageVersionRequest& WithVendorGuidance(VendorGuidance value) {
  ...
  inline CreateImageVersionRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateImageVersionRequest& WithProcessor(Processor value) {
    SetProcessor(value);
    return *this;
  }
  ///@}
  ...
  inline CreateImageVersionRequest& WithHorovod(bool value) {
    SetHorovod(value);
    return *this;
  }
  ///@}
