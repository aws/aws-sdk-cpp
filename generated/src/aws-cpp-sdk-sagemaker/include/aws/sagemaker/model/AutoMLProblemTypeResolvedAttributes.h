...
class AutoMLProblemTypeResolvedAttributes {
 public:
  ...
  void SetTabularResolvedAttributes(TabularResolvedAttributesT&& value) {
    m_tabularResolvedAttributesHasBeenSet = true;
    m_tabularResolvedAttributes = std::forward<TabularResolvedAttributesT>(value);
  }
  template <typename TabularResolvedAttributesT = TabularResolvedAttributes>
  AutoMLProblemTypeResolvedAttributes& WithTabularResolvedAttributes(TabularResolvedAttributesT&& value) {
    SetTabularResolvedAttributes(std::forward<TabularResolvedAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextGenerationResolvedAttributes(TextGenerationResolvedAttributesT&& value) {
    m_textGenerationResolvedAttributesHasBeenSet = true;
    m_textGenerationResolvedAttributes = std::forward<TextGenerationResolvedAttributesT>(value);
  }
  template <typename TextGenerationResolvedAttributesT = TextGenerationResolvedAttributes>
  AutoMLProblemTypeResolvedAttributes& WithTextGenerationResolvedAttributes(TextGenerationResolvedAttributesT&& value) {
    SetTextGenerationResolvedAttributes(std::forward<TextGenerationResolvedAttributesT>(value));
    return *this;
  }
  ///@}
 private:
