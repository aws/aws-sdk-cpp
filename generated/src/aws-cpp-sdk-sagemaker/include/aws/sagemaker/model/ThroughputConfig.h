...
class ThroughputConfig {
 public:
  ...
  inline ThroughputConfig& WithThroughputMode(ThroughputMode value) {
  ...
  inline ThroughputConfig& WithProvisionedReadCapacityUnits(int value) {
  ...
  inline ThroughputConfig& WithProvisionedWriteCapacityUnits(int value) {
