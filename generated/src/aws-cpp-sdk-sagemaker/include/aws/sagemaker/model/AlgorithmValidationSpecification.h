...
class AlgorithmValidationSpecification {
 public:
  ...
  template <typename ValidationRoleT = Aws::String>
  AlgorithmValidationSpecification& WithValidationRole(ValidationRoleT&& value) {
  ...
  template <typename ValidationProfilesT = Aws::Vector<AlgorithmValidationProfile>>
  AlgorithmValidationSpecification& WithValidationProfiles(ValidationProfilesT&& value) {
  ...
  AlgorithmValidationSpecification& AddValidationProfiles(ValidationProfilesT&& value) {
    m_validationProfilesHasBeenSet = true;
