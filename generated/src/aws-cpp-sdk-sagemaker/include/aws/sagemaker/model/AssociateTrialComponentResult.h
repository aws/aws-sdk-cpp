...
class AssociateTrialComponentResult {
 public:
  ...
  template <typename TrialComponentArnT = Aws::String>
  AssociateTrialComponentResult& WithTrialComponentArn(TrialComponentArnT&& value) {
  ...
  template <typename TrialArnT = Aws::String>
  AssociateTrialComponentResult& WithTrialArn(TrialArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateTrialComponentResult& WithRequestId(RequestIdT&& value) {
