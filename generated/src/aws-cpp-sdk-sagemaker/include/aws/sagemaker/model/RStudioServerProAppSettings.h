...
class RStudioServerProAppSettings {
 public:
  ...
  inline void SetAccessStatus(RStudioServerProAccessStatus value) {
    m_accessStatusHasBeenSet = true;
    m_accessStatus = value;
  }
  inline RStudioServerProAppSettings& WithAccessStatus(RStudioServerProAccessStatus value) {
  ...
  inline void SetUserGroup(RStudioServerProUserGroup value) {
    m_userGroupHasBeenSet = true;
    m_userGroup = value;
  }
  inline RStudioServerProAppSettings& WithUserGroup(RStudioServerProUserGroup value) {
    SetUserGroup(value);
    return *this;
  }
  ///@}
