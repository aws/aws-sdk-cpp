...
class AutoMLJobArtifacts {
 public:
  ...
  void SetCandidateDefinitionNotebookLocation(CandidateDefinitionNotebookLocationT&& value) {
    ...
    m_candidateDefinitionNotebookLocation = std::forward<CandidateDefinitionNotebookLocationT>(value);
  }
  template <typename CandidateDefinitionNotebookLocationT = Aws::String>
  AutoMLJobArtifacts& WithCandidateDefinitionNotebookLocation(CandidateDefinitionNotebookLocationT&& value) {
    SetCandidateDefinitionNotebookLocation(std::forward<CandidateDefinitionNotebookLocationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataExplorationNotebookLocation(DataExplorationNotebookLocationT&& value) {
    ...
    m_dataExplorationNotebookLocation = std::forward<DataExplorationNotebookLocationT>(value);
  }
  template <typename DataExplorationNotebookLocationT = Aws::String>
  AutoMLJobArtifacts& WithDataExplorationNotebookLocation(DataExplorationNotebookLocationT&& value) {
    SetDataExplorationNotebookLocation(std::forward<DataExplorationNotebookLocationT>(value));
    return *this;
  }
  ///@}
 private:
