...
class ListFlowDefinitionsRequest : public SageMakerRequest {
 public:
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListFlowDefinitionsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListFlowDefinitionsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  inline ListFlowDefinitionsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFlowDefinitionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListFlowDefinitionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
