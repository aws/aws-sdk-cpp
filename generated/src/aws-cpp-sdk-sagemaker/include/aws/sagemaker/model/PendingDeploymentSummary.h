...
class PendingDeploymentSummary {
 public:
  ...
  template <typename EndpointConfigNameT = Aws::String>
  PendingDeploymentSummary& WithEndpointConfigName(EndpointConfigNameT&& value) {
  ...
  template <typename ProductionVariantsT = Aws::Vector<PendingProductionVariantSummary>>
  PendingDeploymentSummary& WithProductionVariants(ProductionVariantsT&& value) {
  ...
  PendingDeploymentSummary& AddProductionVariants(ProductionVariantsT&& value) {
    m_productionVariantsHasBeenSet = true;
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  PendingDeploymentSummary& WithStartTime(StartTimeT&& value) {
  ...
  template <typename ShadowProductionVariantsT = Aws::Vector<PendingProductionVariantSummary>>
  PendingDeploymentSummary& WithShadowProductionVariants(ShadowProductionVariantsT&& value) {
  ...
  PendingDeploymentSummary& AddShadowProductionVariants(ShadowProductionVariantsT&& value) {
    m_shadowProductionVariantsHasBeenSet = true;
