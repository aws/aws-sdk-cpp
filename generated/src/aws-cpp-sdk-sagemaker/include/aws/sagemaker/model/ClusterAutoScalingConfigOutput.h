...
class ClusterAutoScalingConfigOutput {
 public:
  ...
  inline void SetMode(ClusterAutoScalingMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ClusterAutoScalingConfigOutput& WithMode(ClusterAutoScalingMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAutoScalerType(ClusterAutoScalerType value) {
    m_autoScalerTypeHasBeenSet = true;
    m_autoScalerType = value;
  }
  inline ClusterAutoScalingConfigOutput& WithAutoScalerType(ClusterAutoScalerType value) {
    SetAutoScalerType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ClusterAutoScalingStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ClusterAutoScalingConfigOutput& WithStatus(ClusterAutoScalingStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureMessageT = Aws::String>
  ClusterAutoScalingConfigOutput& WithFailureMessage(FailureMessageT&& value) {
