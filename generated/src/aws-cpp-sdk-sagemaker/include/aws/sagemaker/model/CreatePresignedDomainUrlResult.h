...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API CreatePresignedDomainUrlResult() = default;
    ...
    template<typename AuthorizedUrlT = Aws::String>
    CreatePresignedDomainUrlResult& WithAuthorizedUrl(AuthorizedUrlT&& value) { SetAuthorizedUrl(std::forward<AuthorizedUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePresignedDomainUrlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
