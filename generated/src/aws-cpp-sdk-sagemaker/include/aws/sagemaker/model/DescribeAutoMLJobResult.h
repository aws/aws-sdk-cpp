...
class DescribeAutoMLJobResult {
 public:
  ...
  inline DescribeAutoMLJobResult& WithProblemType(ProblemType value) {
  ...
  void SetAutoMLJobConfig(AutoMLJobConfigT&& value) {
    ...
    m_autoMLJobConfig = std::forward<AutoMLJobConfigT>(value);
  }
  template <typename AutoMLJobConfigT = AutoMLJobConfig>
  DescribeAutoMLJobResult& WithAutoMLJobConfig(AutoMLJobConfigT&& value) {
    SetAutoMLJobConfig(std::forward<AutoMLJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAutoMLJobResult& WithAutoMLJobStatus(AutoMLJobStatus value) {
  ...
  inline DescribeAutoMLJobResult& WithAutoMLJobSecondaryStatus(AutoMLJobSecondaryStatus value) {
  ...
  inline DescribeAutoMLJobResult& WithGenerateCandidateDefinitionsOnly(bool value) {
