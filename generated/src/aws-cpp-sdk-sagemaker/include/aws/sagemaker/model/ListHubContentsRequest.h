...
class ListHubContentsRequest : public SageMakerRequest {
 public:
  ...
  inline ListHubContentsRequest& WithHubContentType(HubContentType value) {
  ...
  void SetMaxSchemaVersion(MaxSchemaVersionT&& value) {
    m_maxSchemaVersionHasBeenSet = true;
    m_maxSchemaVersion = std::forward<MaxSchemaVersionT>(value);
  }
  template <typename MaxSchemaVersionT = Aws::String>
  ListHubContentsRequest& WithMaxSchemaVersion(MaxSchemaVersionT&& value) {
    SetMaxSchemaVersion(std::forward<MaxSchemaVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(HubContentSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListHubContentsRequest& WithSortBy(HubContentSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubContentsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListHubContentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
