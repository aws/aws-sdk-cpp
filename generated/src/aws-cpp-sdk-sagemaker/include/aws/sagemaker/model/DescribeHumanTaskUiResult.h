...
class DescribeHumanTaskUiResult {
 public:
  ...
  inline void SetHumanTaskUiStatus(HumanTaskUiStatus value) {
    m_humanTaskUiStatusHasBeenSet = true;
    m_humanTaskUiStatus = value;
  }
  inline DescribeHumanTaskUiResult& WithHumanTaskUiStatus(HumanTaskUiStatus value) {
    SetHumanTaskUiStatus(value);
    return *this;
  }
  ///@}
