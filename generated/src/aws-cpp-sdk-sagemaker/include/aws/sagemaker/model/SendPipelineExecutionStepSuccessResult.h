...
class SendPipelineExecutionStepSuccessResult {
 public:
  ...
  AWS_SAGEMAKER_API SendPipelineExecutionStepSuccessResult& operator=(
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  SendPipelineExecutionStepSuccessResult& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SendPipelineExecutionStepSuccessResult& WithRequestId(RequestIdT&& value) {
