...
class UpdateImageVersionRequest : public SageMakerRequest {
 public:
  ...
  inline UpdateImageVersionRequest& WithVersion(int value) {
    SetVersion(value);
    return *this;
  }
  ///@}
  ...
  void SetAliasesToAdd(AliasesToAddT&& value) {
    m_aliasesToAddHasBeenSet = true;
    m_aliasesToAdd = std::forward<AliasesToAddT>(value);
  }
  template <typename AliasesToAddT = Aws::Vector<Aws::String>>
  UpdateImageVersionRequest& WithAliasesToAdd(AliasesToAddT&& value) {
    SetAliasesToAdd(std::forward<AliasesToAddT>(value));
    return *this;
  }
  template <typename AliasesToAddT = Aws::String>
  UpdateImageVersionRequest& AddAliasesToAdd(AliasesToAddT&& value) {
    m_aliasesToAddHasBeenSet = true;
    m_aliasesToAdd.emplace_back(std::forward<AliasesToAddT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAliasesToDelete(AliasesToDeleteT&& value) {
    m_aliasesToDeleteHasBeenSet = true;
    m_aliasesToDelete = std::forward<AliasesToDeleteT>(value);
  }
  template <typename AliasesToDeleteT = Aws::Vector<Aws::String>>
  UpdateImageVersionRequest& WithAliasesToDelete(AliasesToDeleteT&& value) {
    SetAliasesToDelete(std::forward<AliasesToDeleteT>(value));
    return *this;
  }
  template <typename AliasesToDeleteT = Aws::String>
  UpdateImageVersionRequest& AddAliasesToDelete(AliasesToDeleteT&& value) {
    m_aliasesToDeleteHasBeenSet = true;
    m_aliasesToDelete.emplace_back(std::forward<AliasesToDeleteT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateImageVersionRequest& WithVendorGuidance(VendorGuidance value) {
  ...
  inline UpdateImageVersionRequest& WithJobType(JobType value) {
    SetJobType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateImageVersionRequest& WithProcessor(Processor value) {
    SetProcessor(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateImageVersionRequest& WithHorovod(bool value) {
    SetHorovod(value);
    return *this;
  }
  ///@}
