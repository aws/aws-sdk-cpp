...
class DeploymentStageStatusSummary {
 public:
  ...
  template <typename StageNameT = Aws::String>
  DeploymentStageStatusSummary& WithStageName(StageNameT&& value) {
  ...
  void SetDeviceSelectionConfig(DeviceSelectionConfigT&& value) {
    m_deviceSelectionConfigHasBeenSet = true;
    m_deviceSelectionConfig = std::forward<DeviceSelectionConfigT>(value);
  }
  template <typename DeviceSelectionConfigT = DeviceSelectionConfig>
  DeploymentStageStatusSummary& WithDeviceSelectionConfig(DeviceSelectionConfigT&& value) {
    SetDeviceSelectionConfig(std::forward<DeviceSelectionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DeploymentConfigT = EdgeDeploymentConfig>
  DeploymentStageStatusSummary& WithDeploymentConfig(DeploymentConfigT&& value) {
  ...
  void SetDeploymentStatus(DeploymentStatusT&& value) {
    ...
    m_deploymentStatus = std::forward<DeploymentStatusT>(value);
  }
  template <typename DeploymentStatusT = EdgeDeploymentStatus>
  DeploymentStageStatusSummary& WithDeploymentStatus(DeploymentStatusT&& value) {
    SetDeploymentStatus(std::forward<DeploymentStatusT>(value));
    return *this;
  }
  ///@}
 private:
