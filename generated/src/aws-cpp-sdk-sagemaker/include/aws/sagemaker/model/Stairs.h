...
class Stairs {
 public:
  ...
  inline Stairs& WithDurationInSeconds(int value) {
  ...
  inline void SetNumberOfSteps(int value) {
    m_numberOfStepsHasBeenSet = true;
    m_numberOfSteps = value;
  }
  inline Stairs& WithNumberOfSteps(int value) {
  ...
  inline void SetUsersPerStep(int value) {
    m_usersPerStepHasBeenSet = true;
    m_usersPerStep = value;
  }
  inline Stairs& WithUsersPerStep(int value) {
    SetUsersPerStep(value);
    return *this;
  }
  ///@}
 private:
