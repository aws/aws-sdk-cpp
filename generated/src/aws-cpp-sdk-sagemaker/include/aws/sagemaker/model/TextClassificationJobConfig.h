...
class TextClassificationJobConfig {
 public:
  ...
  void SetContentColumn(ContentColumnT&& value) {
    ...
    m_contentColumn = std::forward<ContentColumnT>(value);
  }
  template <typename ContentColumnT = Aws::String>
  TextClassificationJobConfig& WithContentColumn(ContentColumnT&& value) {
    SetContentColumn(std::forward<ContentColumnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetLabelColumn(TargetLabelColumnT&& value) {
    ...
    m_targetLabelColumn = std::forward<TargetLabelColumnT>(value);
  }
  template <typename TargetLabelColumnT = Aws::String>
  TextClassificationJobConfig& WithTargetLabelColumn(TargetLabelColumnT&& value) {
    SetTargetLabelColumn(std::forward<TargetLabelColumnT>(value));
    return *this;
  }
  ///@}
 private:
