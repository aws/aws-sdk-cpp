...
class ShadowModelVariantConfig {
 public:
  ...
  void SetShadowModelVariantName(ShadowModelVariantNameT&& value) {
    m_shadowModelVariantNameHasBeenSet = true;
    m_shadowModelVariantName = std::forward<ShadowModelVariantNameT>(value);
  }
  template <typename ShadowModelVariantNameT = Aws::String>
  ShadowModelVariantConfig& WithShadowModelVariantName(ShadowModelVariantNameT&& value) {
    SetShadowModelVariantName(std::forward<ShadowModelVariantNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline ShadowModelVariantConfig& WithSamplingPercentage(int value) {
