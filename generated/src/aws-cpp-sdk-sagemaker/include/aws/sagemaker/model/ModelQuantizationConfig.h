...
namespace Model
{
  ...
  public:
    ...
    template<typename ImageT = Aws::String>
    ModelQuantizationConfig& WithImage(ImageT&& value) { SetImage(std::forward<ImageT>(value)); return *this;}
    ///@}
    ...
    template<typename OverrideEnvironmentT = Aws::Map<Aws::String, Aws::String>>
    ModelQuantizationConfig& WithOverrideEnvironment(OverrideEnvironmentT&& value) { SetOverrideEnvironment(std::forward<OverrideEnvironmentT>(value)); return *this;}
