...
class ModelCompilationConfig {
 public:
  ...
  template <typename ImageT = Aws::String>
  ModelCompilationConfig& WithImage(ImageT&& value) {
  ...
  void SetOverrideEnvironment(OverrideEnvironmentT&& value) {
    ...
    m_overrideEnvironment = std::forward<OverrideEnvironmentT>(value);
  }
  template <typename OverrideEnvironmentT = Aws::Map<Aws::String, Aws::String>>
  ModelCompilationConfig& WithOverrideEnvironment(OverrideEnvironmentT&& value) {
    SetOverrideEnvironment(std::forward<OverrideEnvironmentT>(value));
    return *this;
  }
  ...
  ModelCompilationConfig& AddOverrideEnvironment(OverrideEnvironmentKeyT&& key, OverrideEnvironmentValueT&& value) {
    m_overrideEnvironmentHasBeenSet = true;
    m_overrideEnvironment.emplace(std::forward<OverrideEnvironmentKeyT>(key), std::forward<OverrideEnvironmentValueT>(value));
    return *this;
  }
  ///@}
 private:
