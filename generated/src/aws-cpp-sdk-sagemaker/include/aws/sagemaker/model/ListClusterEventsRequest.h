...
class ListClusterEventsRequest : public SageMakerRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  ListClusterEventsRequest& WithClusterName(ClusterNameT&& value) {
  ...
  template <typename InstanceGroupNameT = Aws::String>
  ListClusterEventsRequest& WithInstanceGroupName(InstanceGroupNameT&& value) {
  ...
  template <typename NodeIdT = Aws::String>
  ListClusterEventsRequest& WithNodeId(NodeIdT&& value) {
  ...
  void SetEventTimeAfter(EventTimeAfterT&& value) {
    m_eventTimeAfterHasBeenSet = true;
    m_eventTimeAfter = std::forward<EventTimeAfterT>(value);
  }
  template <typename EventTimeAfterT = Aws::Utils::DateTime>
  ListClusterEventsRequest& WithEventTimeAfter(EventTimeAfterT&& value) {
    SetEventTimeAfter(std::forward<EventTimeAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEventTimeBefore(EventTimeBeforeT&& value) {
    m_eventTimeBeforeHasBeenSet = true;
    m_eventTimeBefore = std::forward<EventTimeBeforeT>(value);
  }
  template <typename EventTimeBeforeT = Aws::Utils::DateTime>
  ListClusterEventsRequest& WithEventTimeBefore(EventTimeBeforeT&& value) {
    SetEventTimeBefore(std::forward<EventTimeBeforeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(EventSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListClusterEventsRequest& WithSortBy(EventSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListClusterEventsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline ListClusterEventsRequest& WithResourceType(ClusterEventResourceType value) {
  ...
  inline ListClusterEventsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListClusterEventsRequest& WithNextToken(NextTokenT&& value) {
