...
class ContainerDefinition {
 public:
  ...
  void SetContainerHostname(ContainerHostnameT&& value) {
    ...
    m_containerHostname = std::forward<ContainerHostnameT>(value);
  }
  template <typename ContainerHostnameT = Aws::String>
  ContainerDefinition& WithContainerHostname(ContainerHostnameT&& value) {
    SetContainerHostname(std::forward<ContainerHostnameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMode(ContainerMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline ContainerDefinition& WithMode(ContainerMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  void SetMultiModelConfig(MultiModelConfigT&& value) {
    ...
    m_multiModelConfig = std::forward<MultiModelConfigT>(value);
  }
  template <typename MultiModelConfigT = MultiModelConfig>
  ContainerDefinition& WithMultiModelConfig(MultiModelConfigT&& value) {
    SetMultiModelConfig(std::forward<MultiModelConfigT>(value));
    return *this;
  }
  ///@}
 private:
