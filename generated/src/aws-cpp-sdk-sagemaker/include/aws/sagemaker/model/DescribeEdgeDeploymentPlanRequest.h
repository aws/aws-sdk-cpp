...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DescribeEdgeDeploymentPlanRequest() = default;
    ...
    template<typename EdgeDeploymentPlanNameT = Aws::String>
    DescribeEdgeDeploymentPlanRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) { SetEdgeDeploymentPlanName(std::forward<EdgeDeploymentPlanNameT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeEdgeDeploymentPlanRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
