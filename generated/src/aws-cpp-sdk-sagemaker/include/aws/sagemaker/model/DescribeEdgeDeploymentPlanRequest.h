...
class DescribeEdgeDeploymentPlanRequest : public SageMakerRequest {
 public:
  ...
  template <typename EdgeDeploymentPlanNameT = Aws::String>
  DescribeEdgeDeploymentPlanRequest& WithEdgeDeploymentPlanName(EdgeDeploymentPlanNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeEdgeDeploymentPlanRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeEdgeDeploymentPlanRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
