...
class AutoMLCandidateStep {
 public:
  ...
  inline void SetCandidateStepType(CandidateStepType value) {
    m_candidateStepTypeHasBeenSet = true;
    m_candidateStepType = value;
  }
  inline AutoMLCandidateStep& WithCandidateStepType(CandidateStepType value) {
    SetCandidateStepType(value);
    return *this;
  }
  ///@}
  ...
  void SetCandidateStepArn(CandidateStepArnT&& value) {
    ...
    m_candidateStepArn = std::forward<CandidateStepArnT>(value);
  }
  template <typename CandidateStepArnT = Aws::String>
  AutoMLCandidateStep& WithCandidateStepArn(CandidateStepArnT&& value) {
    SetCandidateStepArn(std::forward<CandidateStepArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCandidateStepName(CandidateStepNameT&& value) {
    ...
    m_candidateStepName = std::forward<CandidateStepNameT>(value);
  }
  template <typename CandidateStepNameT = Aws::String>
  AutoMLCandidateStep& WithCandidateStepName(CandidateStepNameT&& value) {
    SetCandidateStepName(std::forward<CandidateStepNameT>(value));
    return *this;
  }
  ///@}
 private:
