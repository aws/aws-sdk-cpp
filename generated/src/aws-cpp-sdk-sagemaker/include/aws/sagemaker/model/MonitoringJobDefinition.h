...
class MonitoringJobDefinition {
 public:
  ...
  void SetBaselineConfig(BaselineConfigT&& value) {
    ...
    m_baselineConfig = std::forward<BaselineConfigT>(value);
  }
  template <typename BaselineConfigT = MonitoringBaselineConfig>
  MonitoringJobDefinition& WithBaselineConfig(BaselineConfigT&& value) {
    SetBaselineConfig(std::forward<BaselineConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonitoringOutputConfig(MonitoringOutputConfigT&& value) {
    ...
    m_monitoringOutputConfig = std::forward<MonitoringOutputConfigT>(value);
  }
  template <typename MonitoringOutputConfigT = MonitoringOutputConfig>
  MonitoringJobDefinition& WithMonitoringOutputConfig(MonitoringOutputConfigT&& value) {
    SetMonitoringOutputConfig(std::forward<MonitoringOutputConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonitoringResources(MonitoringResourcesT&& value) {
    ...
    m_monitoringResources = std::forward<MonitoringResourcesT>(value);
  }
  template <typename MonitoringResourcesT = MonitoringResources>
  MonitoringJobDefinition& WithMonitoringResources(MonitoringResourcesT&& value) {
    SetMonitoringResources(std::forward<MonitoringResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMonitoringAppSpecification(MonitoringAppSpecificationT&& value) {
    ...
    m_monitoringAppSpecification = std::forward<MonitoringAppSpecificationT>(value);
  }
  template <typename MonitoringAppSpecificationT = MonitoringAppSpecification>
  MonitoringJobDefinition& WithMonitoringAppSpecification(MonitoringAppSpecificationT&& value) {
    SetMonitoringAppSpecification(std::forward<MonitoringAppSpecificationT>(value));
    return *this;
  }
  ///@}
