...
class NestedFilters {
 public:
  ...
  void SetNestedPropertyName(NestedPropertyNameT&& value) {
    m_nestedPropertyNameHasBeenSet = true;
    m_nestedPropertyName = std::forward<NestedPropertyNameT>(value);
  }
  template <typename NestedPropertyNameT = Aws::String>
  NestedFilters& WithNestedPropertyName(NestedPropertyNameT&& value) {
    SetNestedPropertyName(std::forward<NestedPropertyNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  NestedFilters& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  NestedFilters& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
