...
class ListInferenceExperimentsResult {
 public:
  ...
  void SetInferenceExperiments(InferenceExperimentsT&& value) {
    m_inferenceExperimentsHasBeenSet = true;
    m_inferenceExperiments = std::forward<InferenceExperimentsT>(value);
  }
  template <typename InferenceExperimentsT = Aws::Vector<InferenceExperimentSummary>>
  ListInferenceExperimentsResult& WithInferenceExperiments(InferenceExperimentsT&& value) {
    SetInferenceExperiments(std::forward<InferenceExperimentsT>(value));
    return *this;
  }
  template <typename InferenceExperimentsT = InferenceExperimentSummary>
  ListInferenceExperimentsResult& AddInferenceExperiments(InferenceExperimentsT&& value) {
    m_inferenceExperimentsHasBeenSet = true;
    m_inferenceExperiments.emplace_back(std::forward<InferenceExperimentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListInferenceExperimentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListInferenceExperimentsResult& WithRequestId(RequestIdT&& value) {
