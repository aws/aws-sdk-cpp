...
class CreateProjectRequest : public SageMakerRequest {
 public:
   ...
   */
  inline const ServiceCatalogProvisioningDetails& GetServiceCatalogProvisioningDetails() const {
    return m_serviceCatalogProvisioningDetails;
  }
  ...
  void SetServiceCatalogProvisioningDetails(ServiceCatalogProvisioningDetailsT&& value) {
    ...
    m_serviceCatalogProvisioningDetails = std::forward<ServiceCatalogProvisioningDetailsT>(value);
  }
  template <typename ServiceCatalogProvisioningDetailsT = ServiceCatalogProvisioningDetails>
  CreateProjectRequest& WithServiceCatalogProvisioningDetails(ServiceCatalogProvisioningDetailsT&& value) {
    SetServiceCatalogProvisioningDetails(std::forward<ServiceCatalogProvisioningDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateProviders(TemplateProvidersT&& value) {
    m_templateProvidersHasBeenSet = true;
    m_templateProviders = std::forward<TemplateProvidersT>(value);
  }
  template <typename TemplateProvidersT = Aws::Vector<CreateTemplateProvider>>
  CreateProjectRequest& WithTemplateProviders(TemplateProvidersT&& value) {
    SetTemplateProviders(std::forward<TemplateProvidersT>(value));
    return *this;
  }
  template <typename TemplateProvidersT = CreateTemplateProvider>
  CreateProjectRequest& AddTemplateProviders(TemplateProvidersT&& value) {
    m_templateProvidersHasBeenSet = true;
    m_templateProviders.emplace_back(std::forward<TemplateProvidersT>(value));
    return *this;
  }
  ///@}
 private:
