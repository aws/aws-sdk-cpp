...
class PendingProductionVariantSummary {
 public:
  ...
  inline PendingProductionVariantSummary& WithCurrentWeight(double value) {
  ...
  inline PendingProductionVariantSummary& WithDesiredWeight(double value) {
  ...
  inline PendingProductionVariantSummary& WithCurrentInstanceCount(int value) {
  ...
  inline PendingProductionVariantSummary& WithDesiredInstanceCount(int value) {
  ...
  inline PendingProductionVariantSummary& WithInstanceType(ProductionVariantInstanceType value) {
  ...
  inline void SetAcceleratorType(ProductionVariantAcceleratorType value) {
    m_acceleratorTypeHasBeenSet = true;
    m_acceleratorType = value;
  }
  inline PendingProductionVariantSummary& WithAcceleratorType(ProductionVariantAcceleratorType value) {
