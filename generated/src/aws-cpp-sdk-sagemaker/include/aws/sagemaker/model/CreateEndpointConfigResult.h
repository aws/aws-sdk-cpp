...
class CreateEndpointConfigResult {
 public:
  ...
  void SetEndpointConfigArn(EndpointConfigArnT&& value) {
    ...
    m_endpointConfigArn = std::forward<EndpointConfigArnT>(value);
  }
  template <typename EndpointConfigArnT = Aws::String>
  CreateEndpointConfigResult& WithEndpointConfigArn(EndpointConfigArnT&& value) {
    SetEndpointConfigArn(std::forward<EndpointConfigArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateEndpointConfigResult& WithRequestId(RequestIdT&& value) {
