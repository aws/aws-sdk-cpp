...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainIdT = Aws::String>
    DescribeAppRequest& WithDomainId(DomainIdT&& value) { SetDomainId(std::forward<DomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename UserProfileNameT = Aws::String>
    DescribeAppRequest& WithUserProfileName(UserProfileNameT&& value) { SetUserProfileName(std::forward<UserProfileNameT>(value)); return *this;}
    ///@}
    ...
    template<typename SpaceNameT = Aws::String>
    DescribeAppRequest& WithSpaceName(SpaceNameT&& value) { SetSpaceName(std::forward<SpaceNameT>(value)); return *this;}
    ///@}
    ...
    inline DescribeAppRequest& WithAppType(AppType value) { SetAppType(value); return *this;}
    ///@}
    ...
    template<typename AppNameT = Aws::String>
    DescribeAppRequest& WithAppName(AppNameT&& value) { SetAppName(std::forward<AppNameT>(value)); return *this;}
    ///@}
  private:
