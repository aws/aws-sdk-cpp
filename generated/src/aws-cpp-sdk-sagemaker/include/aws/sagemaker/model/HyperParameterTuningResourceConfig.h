...
class HyperParameterTuningResourceConfig {
 public:
  ...
  inline HyperParameterTuningResourceConfig& WithInstanceType(TrainingInstanceType value) {
  ...
  inline HyperParameterTuningResourceConfig& WithInstanceCount(int value) {
  ...
  inline HyperParameterTuningResourceConfig& WithVolumeSizeInGB(int value) {
  ...
  inline void SetAllocationStrategy(HyperParameterTuningAllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline HyperParameterTuningResourceConfig& WithAllocationStrategy(HyperParameterTuningAllocationStrategy value) {
