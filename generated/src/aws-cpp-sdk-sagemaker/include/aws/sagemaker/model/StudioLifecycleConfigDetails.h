...
class StudioLifecycleConfigDetails {
 public:
  ...
  template <typename StudioLifecycleConfigArnT = Aws::String>
  StudioLifecycleConfigDetails& WithStudioLifecycleConfigArn(StudioLifecycleConfigArnT&& value) {
  ...
  template <typename StudioLifecycleConfigNameT = Aws::String>
  StudioLifecycleConfigDetails& WithStudioLifecycleConfigName(StudioLifecycleConfigNameT&& value) {
  ...
  template <typename CreationTimeT = Aws::Utils::DateTime>
  StudioLifecycleConfigDetails& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  StudioLifecycleConfigDetails& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  inline StudioLifecycleConfigDetails& WithStudioLifecycleConfigAppType(StudioLifecycleConfigAppType value) {
