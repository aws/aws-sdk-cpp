...
class DeviceStats {
 public:
  ...
  inline void SetConnectedDeviceCount(long long value) {
    m_connectedDeviceCountHasBeenSet = true;
    m_connectedDeviceCount = value;
  }
  inline DeviceStats& WithConnectedDeviceCount(long long value) {
    SetConnectedDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRegisteredDeviceCount(long long value) {
    m_registeredDeviceCountHasBeenSet = true;
    m_registeredDeviceCount = value;
  }
  inline DeviceStats& WithRegisteredDeviceCount(long long value) {
    SetRegisteredDeviceCount(value);
    return *this;
  }
  ///@}
 private:
