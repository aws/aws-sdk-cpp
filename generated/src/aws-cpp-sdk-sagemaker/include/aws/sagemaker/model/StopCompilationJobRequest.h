...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API StopCompilationJobRequest() = default;
    ...
    template<typename CompilationJobNameT = Aws::String>
    StopCompilationJobRequest& WithCompilationJobName(CompilationJobNameT&& value) { SetCompilationJobName(std::forward<CompilationJobNameT>(value)); return *this;}
    ///@}
  private:
