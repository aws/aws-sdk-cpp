...
class ModelPackageValidationSpecification {
 public:
  ...
  void SetValidationRole(ValidationRoleT&& value) {
    m_validationRoleHasBeenSet = true;
    m_validationRole = std::forward<ValidationRoleT>(value);
  }
  template <typename ValidationRoleT = Aws::String>
  ModelPackageValidationSpecification& WithValidationRole(ValidationRoleT&& value) {
    SetValidationRole(std::forward<ValidationRoleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidationProfiles(ValidationProfilesT&& value) {
    m_validationProfilesHasBeenSet = true;
    m_validationProfiles = std::forward<ValidationProfilesT>(value);
  }
  template <typename ValidationProfilesT = Aws::Vector<ModelPackageValidationProfile>>
  ModelPackageValidationSpecification& WithValidationProfiles(ValidationProfilesT&& value) {
    SetValidationProfiles(std::forward<ValidationProfilesT>(value));
    return *this;
  }
  template <typename ValidationProfilesT = ModelPackageValidationProfile>
  ModelPackageValidationSpecification& AddValidationProfiles(ValidationProfilesT&& value) {
    m_validationProfilesHasBeenSet = true;
    m_validationProfiles.emplace_back(std::forward<ValidationProfilesT>(value));
    return *this;
  }
  ///@}
 private:
