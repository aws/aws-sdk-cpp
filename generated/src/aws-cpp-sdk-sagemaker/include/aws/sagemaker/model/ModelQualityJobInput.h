...
class ModelQualityJobInput {
 public:
  ...
  template <typename EndpointInputT = EndpointInput>
  ModelQualityJobInput& WithEndpointInput(EndpointInputT&& value) {
  ...
  template <typename BatchTransformInputT = BatchTransformInput>
  ModelQualityJobInput& WithBatchTransformInput(BatchTransformInputT&& value) {
  ...
  template <typename GroundTruthS3InputT = MonitoringGroundTruthS3Input>
  ModelQualityJobInput& WithGroundTruthS3Input(GroundTruthS3InputT&& value) {
