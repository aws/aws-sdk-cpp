...
class ListMonitoringSchedulesRequest : public SageMakerRequest {
 public:
  ...
  template <typename EndpointNameT = Aws::String>
  ListMonitoringSchedulesRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  inline void SetSortBy(MonitoringScheduleSortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListMonitoringSchedulesRequest& WithSortBy(MonitoringScheduleSortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListMonitoringSchedulesRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoringSchedulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMonitoringSchedulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListMonitoringSchedulesRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListMonitoringSchedulesRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListMonitoringSchedulesRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListMonitoringSchedulesRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListMonitoringSchedulesRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  inline void SetStatusEquals(ScheduleStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListMonitoringSchedulesRequest& WithStatusEquals(ScheduleStatus value) {
  ...
  template <typename MonitoringJobDefinitionNameT = Aws::String>
  ListMonitoringSchedulesRequest& WithMonitoringJobDefinitionName(MonitoringJobDefinitionNameT&& value) {
  ...
  inline void SetMonitoringTypeEquals(MonitoringType value) {
    m_monitoringTypeEqualsHasBeenSet = true;
    m_monitoringTypeEquals = value;
  }
  inline ListMonitoringSchedulesRequest& WithMonitoringTypeEquals(MonitoringType value) {
    SetMonitoringTypeEquals(value);
    return *this;
  }
  ///@}
 private:
