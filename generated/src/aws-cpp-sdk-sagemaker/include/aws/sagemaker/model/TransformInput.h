...
class TransformInput {
 public:
  ...
  inline TransformInput& WithCompressionType(CompressionType value) {
  ...
  inline void SetSplitType(SplitType value) {
    m_splitTypeHasBeenSet = true;
    m_splitType = value;
  }
  inline TransformInput& WithSplitType(SplitType value) {
    SetSplitType(value);
    return *this;
  }
  ///@}
