...
class OptimizationOutput {
 public:
  ...
  void SetRecommendedInferenceImage(RecommendedInferenceImageT&& value) {
    m_recommendedInferenceImageHasBeenSet = true;
    m_recommendedInferenceImage = std::forward<RecommendedInferenceImageT>(value);
  }
  template <typename RecommendedInferenceImageT = Aws::String>
  OptimizationOutput& WithRecommendedInferenceImage(RecommendedInferenceImageT&& value) {
    SetRecommendedInferenceImage(std::forward<RecommendedInferenceImageT>(value));
    return *this;
  }
  ///@}
 private:
