...
class SearchExpression {
 public:
  ...
  void SetNestedFilters(NestedFiltersT&& value) {
    ...
    m_nestedFilters = std::forward<NestedFiltersT>(value);
  }
  template <typename NestedFiltersT = Aws::Vector<NestedFilters>>
  SearchExpression& WithNestedFilters(NestedFiltersT&& value) {
    SetNestedFilters(std::forward<NestedFiltersT>(value));
    return *this;
  }
  template <typename NestedFiltersT = NestedFilters>
  SearchExpression& AddNestedFilters(NestedFiltersT&& value) {
    m_nestedFiltersHasBeenSet = true;
    m_nestedFilters.emplace_back(std::forward<NestedFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubExpressions(SubExpressionsT&& value) {
    ...
    m_subExpressions = std::forward<SubExpressionsT>(value);
  }
  template <typename SubExpressionsT = Aws::Vector<SearchExpression>>
  SearchExpression& WithSubExpressions(SubExpressionsT&& value) {
    SetSubExpressions(std::forward<SubExpressionsT>(value));
    return *this;
  }
  template <typename SubExpressionsT = SearchExpression>
  SearchExpression& AddSubExpressions(SubExpressionsT&& value) {
    m_subExpressionsHasBeenSet = true;
    m_subExpressions.emplace_back(std::forward<SubExpressionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOperator(BooleanOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline SearchExpression& WithOperator(BooleanOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
