...
class TrainingPlanFilter {
 public:
  ...
  inline void SetName(TrainingPlanFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline TrainingPlanFilter& WithName(TrainingPlanFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  TrainingPlanFilter& WithValue(ValueT&& value) {
