...
class GetDeviceFleetReportResult {
 public:
  ...
  void SetDeviceFleetArn(DeviceFleetArnT&& value) {
    ...
    m_deviceFleetArn = std::forward<DeviceFleetArnT>(value);
  }
  template <typename DeviceFleetArnT = Aws::String>
  GetDeviceFleetReportResult& WithDeviceFleetArn(DeviceFleetArnT&& value) {
    SetDeviceFleetArn(std::forward<DeviceFleetArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReportGenerated(ReportGeneratedT&& value) {
    ...
    m_reportGenerated = std::forward<ReportGeneratedT>(value);
  }
  template <typename ReportGeneratedT = Aws::Utils::DateTime>
  GetDeviceFleetReportResult& WithReportGenerated(ReportGeneratedT&& value) {
    SetReportGenerated(std::forward<ReportGeneratedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeviceStats(DeviceStatsT&& value) {
    ...
    m_deviceStats = std::forward<DeviceStatsT>(value);
  }
  template <typename DeviceStatsT = DeviceStats>
  GetDeviceFleetReportResult& WithDeviceStats(DeviceStatsT&& value) {
    SetDeviceStats(std::forward<DeviceStatsT>(value));
    return *this;
  }
  ///@}
