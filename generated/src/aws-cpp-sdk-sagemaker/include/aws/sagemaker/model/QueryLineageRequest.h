...
class QueryLineageRequest : public SageMakerRequest {
 public:
  ...
  void SetStartArns(StartArnsT&& value) {
    m_startArnsHasBeenSet = true;
    m_startArns = std::forward<StartArnsT>(value);
  }
  template <typename StartArnsT = Aws::Vector<Aws::String>>
  QueryLineageRequest& WithStartArns(StartArnsT&& value) {
    SetStartArns(std::forward<StartArnsT>(value));
    return *this;
  }
  template <typename StartArnsT = Aws::String>
  QueryLineageRequest& AddStartArns(StartArnsT&& value) {
    m_startArnsHasBeenSet = true;
    m_startArns.emplace_back(std::forward<StartArnsT>(value));
    return *this;
  }
  ///@}
  ...
  inline QueryLineageRequest& WithDirection(Direction value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeEdges(bool value) {
    m_includeEdgesHasBeenSet = true;
    m_includeEdges = value;
  }
  inline QueryLineageRequest& WithIncludeEdges(bool value) {
  ...
  inline QueryLineageRequest& WithMaxDepth(int value) {
    SetMaxDepth(value);
    return *this;
  }
  ///@}
  ...
  inline QueryLineageRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
