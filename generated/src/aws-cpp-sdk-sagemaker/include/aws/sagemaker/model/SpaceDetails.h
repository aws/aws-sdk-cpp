...
class SpaceDetails {
 public:
  ...
  inline SpaceDetails& WithStatus(SpaceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetSpaceSettingsSummary(SpaceSettingsSummaryT&& value) {
    ...
    m_spaceSettingsSummary = std::forward<SpaceSettingsSummaryT>(value);
  }
  template <typename SpaceSettingsSummaryT = SpaceSettingsSummary>
  SpaceDetails& WithSpaceSettingsSummary(SpaceSettingsSummaryT&& value) {
    SetSpaceSettingsSummary(std::forward<SpaceSettingsSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpaceSharingSettingsSummary(SpaceSharingSettingsSummaryT&& value) {
    ...
    m_spaceSharingSettingsSummary = std::forward<SpaceSharingSettingsSummaryT>(value);
  }
  template <typename SpaceSharingSettingsSummaryT = SpaceSharingSettingsSummary>
  SpaceDetails& WithSpaceSharingSettingsSummary(SpaceSharingSettingsSummaryT&& value) {
    SetSpaceSharingSettingsSummary(std::forward<SpaceSharingSettingsSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOwnershipSettingsSummary(OwnershipSettingsSummaryT&& value) {
    ...
    m_ownershipSettingsSummary = std::forward<OwnershipSettingsSummaryT>(value);
  }
  template <typename OwnershipSettingsSummaryT = OwnershipSettingsSummary>
  SpaceDetails& WithOwnershipSettingsSummary(OwnershipSettingsSummaryT&& value) {
    SetOwnershipSettingsSummary(std::forward<OwnershipSettingsSummaryT>(value));
    return *this;
  }
  ///@}
