...
namespace Model
{
  ...
  public:
    ...
    inline void SetSortBy(EndpointConfigSortKey value) { m_sortByHasBeenSet = true; m_sortBy = value; }
    inline ListEndpointConfigsRequest& WithSortBy(EndpointConfigSortKey value) { SetSortBy(value); return *this;}
    ///@}
    ...
    inline ListEndpointConfigsRequest& WithSortOrder(OrderKey value) { SetSortOrder(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListEndpointConfigsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListEndpointConfigsRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeBeforeT = Aws::Utils::DateTime>
    ListEndpointConfigsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) { SetCreationTimeBefore(std::forward<CreationTimeBeforeT>(value)); return *this;}
    ///@}
    ...
    template<typename CreationTimeAfterT = Aws::Utils::DateTime>
    ListEndpointConfigsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) { SetCreationTimeAfter(std::forward<CreationTimeAfterT>(value)); return *this;}
    ///@}
  private:
