...
namespace Model
{
  ...
  public:
    ...
    inline DeleteHumanTaskUiResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DeleteHumanTaskUiResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DeleteHumanTaskUiResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
