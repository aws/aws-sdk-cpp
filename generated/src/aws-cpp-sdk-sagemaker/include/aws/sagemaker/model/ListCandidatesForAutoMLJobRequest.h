...
class ListCandidatesForAutoMLJobRequest : public SageMakerRequest {
 public:
  ...
  template <typename AutoMLJobNameT = Aws::String>
  ListCandidatesForAutoMLJobRequest& WithAutoMLJobName(AutoMLJobNameT&& value) {
  ...
  inline void SetStatusEquals(CandidateStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListCandidatesForAutoMLJobRequest& WithStatusEquals(CandidateStatus value) {
  ...
  void SetCandidateNameEquals(CandidateNameEqualsT&& value) {
    m_candidateNameEqualsHasBeenSet = true;
    m_candidateNameEquals = std::forward<CandidateNameEqualsT>(value);
  }
  template <typename CandidateNameEqualsT = Aws::String>
  ListCandidatesForAutoMLJobRequest& WithCandidateNameEquals(CandidateNameEqualsT&& value) {
    SetCandidateNameEquals(std::forward<CandidateNameEqualsT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListCandidatesForAutoMLJobRequest& WithSortOrder(AutoMLSortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(CandidateSortBy value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListCandidatesForAutoMLJobRequest& WithSortBy(CandidateSortBy value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListCandidatesForAutoMLJobRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCandidatesForAutoMLJobRequest& WithNextToken(NextTokenT&& value) {
