...
namespace Model
{
  ...
  public:
    ...
    template<typename MonitoringScheduleNameT = Aws::String>
    DescribeMonitoringScheduleRequest& WithMonitoringScheduleName(MonitoringScheduleNameT&& value) { SetMonitoringScheduleName(std::forward<MonitoringScheduleNameT>(value)); return *this;}
    ///@}
  private:
