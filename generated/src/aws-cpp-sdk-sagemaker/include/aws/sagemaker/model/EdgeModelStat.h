...
class EdgeModelStat {
 public:
  ...
  inline void SetOfflineDeviceCount(long long value) {
    m_offlineDeviceCountHasBeenSet = true;
    m_offlineDeviceCount = value;
  }
  inline EdgeModelStat& WithOfflineDeviceCount(long long value) {
    SetOfflineDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline EdgeModelStat& WithConnectedDeviceCount(long long value) {
  ...
  inline void SetActiveDeviceCount(long long value) {
    m_activeDeviceCountHasBeenSet = true;
    m_activeDeviceCount = value;
  }
  inline EdgeModelStat& WithActiveDeviceCount(long long value) {
    SetActiveDeviceCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSamplingDeviceCount(long long value) {
    m_samplingDeviceCountHasBeenSet = true;
    m_samplingDeviceCount = value;
  }
  inline EdgeModelStat& WithSamplingDeviceCount(long long value) {
    SetSamplingDeviceCount(value);
    return *this;
  }
  ///@}
 private:
