...
class DescribePipelineExecutionResult {
 public:
  ...
  inline void SetPipelineExecutionStatus(PipelineExecutionStatus value) {
    m_pipelineExecutionStatusHasBeenSet = true;
    m_pipelineExecutionStatus = value;
  }
  inline DescribePipelineExecutionResult& WithPipelineExecutionStatus(PipelineExecutionStatus value) {
    SetPipelineExecutionStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetPipelineExperimentConfig(PipelineExperimentConfigT&& value) {
    ...
    m_pipelineExperimentConfig = std::forward<PipelineExperimentConfigT>(value);
  }
  template <typename PipelineExperimentConfigT = PipelineExperimentConfig>
  DescribePipelineExecutionResult& WithPipelineExperimentConfig(PipelineExperimentConfigT&& value) {
    SetPipelineExperimentConfig(std::forward<PipelineExperimentConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribePipelineExecutionResult& WithPipelineVersionId(long long value) {
