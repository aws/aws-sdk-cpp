...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API StopNotebookInstanceRequest() = default;
    ...
    template<typename NotebookInstanceNameT = Aws::String>
    StopNotebookInstanceRequest& WithNotebookInstanceName(NotebookInstanceNameT&& value) { SetNotebookInstanceName(std::forward<NotebookInstanceNameT>(value)); return *this;}
    ///@}
  private:
