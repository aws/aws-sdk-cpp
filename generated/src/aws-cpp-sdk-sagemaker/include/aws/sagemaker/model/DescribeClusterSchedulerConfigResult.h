...
class DescribeClusterSchedulerConfigResult {
 public:
  ...
  template <typename NameT = Aws::String>
  DescribeClusterSchedulerConfigResult& WithName(NameT&& value) {
  ...
  inline DescribeClusterSchedulerConfigResult& WithClusterSchedulerConfigVersion(int value) {
  ...
  inline DescribeClusterSchedulerConfigResult& WithStatus(SchedulerResourceStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
