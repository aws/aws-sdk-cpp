...
class UpdateModelCardRequest : public SageMakerRequest {
 public:
  ...
  template <typename ModelCardNameT = Aws::String>
  UpdateModelCardRequest& WithModelCardName(ModelCardNameT&& value) {
  ...
  template <typename ContentT = Aws::String>
  UpdateModelCardRequest& WithContent(ContentT&& value) {
  ...
  inline UpdateModelCardRequest& WithModelCardStatus(ModelCardStatus value) {
