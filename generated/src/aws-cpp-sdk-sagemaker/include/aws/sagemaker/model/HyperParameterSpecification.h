...
class HyperParameterSpecification {
 public:
  ...
  inline HyperParameterSpecification& WithType(ParameterType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline HyperParameterSpecification& WithIsTunable(bool value) {
    SetIsTunable(value);
    return *this;
  }
  ///@}
  ...
  inline HyperParameterSpecification& WithIsRequired(bool value) {
    SetIsRequired(value);
    return *this;
  }
  ///@}
