...
namespace SageMaker {
namespace Model {
class DeleteAIRecommendationJobResult {
 public:
  AWS_SAGEMAKER_API DeleteAIRecommendationJobResult() = default;
  AWS_SAGEMAKER_API DeleteAIRecommendationJobResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SAGEMAKER_API DeleteAIRecommendationJobResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AIRecommendationJobArnT = Aws::String>
  DeleteAIRecommendationJobResult& WithAIRecommendationJobArn(AIRecommendationJobArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteAIRecommendationJobResult& WithRequestId(RequestIdT&& value) {
