...
class ReservedCapacityOffering {
 public:
  ...
  inline ReservedCapacityOffering& WithReservedCapacityType(ReservedCapacityType value) {
  ...
  inline ReservedCapacityOffering& WithUltraServerCount(int value) {
  ...
  inline ReservedCapacityOffering& WithInstanceType(ReservedCapacityInstanceType value) {
  ...
  inline ReservedCapacityOffering& WithInstanceCount(int value) {
  ...
  inline ReservedCapacityOffering& WithDurationHours(long long value) {
  ...
  inline ReservedCapacityOffering& WithDurationMinutes(long long value) {
