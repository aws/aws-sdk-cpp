...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DeleteModelPackageGroupRequest();
     ...
     * <p>The name of the model group to delete.</p>
     */
    inline DeleteModelPackageGroupRequest& WithModelPackageGroupName(const Aws::String& value) { SetModelPackageGroupName(value); return *this;}

    /**
     * <p>The name of the model group to delete.</p>
     */
    inline DeleteModelPackageGroupRequest& WithModelPackageGroupName(Aws::String&& value) { SetModelPackageGroupName(std::move(value)); return *this;}

    /**
     * <p>The name of the model group to delete.</p>
     */
    inline DeleteModelPackageGroupRequest& WithModelPackageGroupName(const char* value) { SetModelPackageGroupName(value); return *this;}
