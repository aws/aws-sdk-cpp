...
class BatchAddClusterNodesResult {
 public:
  ...
  template <typename SuccessfulT = Aws::Vector<NodeAdditionResult>>
  BatchAddClusterNodesResult& WithSuccessful(SuccessfulT&& value) {
    SetSuccessful(std::forward<SuccessfulT>(value));
    return *this;
  }
  template <typename SuccessfulT = NodeAdditionResult>
  BatchAddClusterNodesResult& AddSuccessful(SuccessfulT&& value) {
    m_successfulHasBeenSet = true;
  ...
  template <typename FailedT = Aws::Vector<BatchAddClusterNodesError>>
  BatchAddClusterNodesResult& WithFailed(FailedT&& value) {
    SetFailed(std::forward<FailedT>(value));
    return *this;
  }
  template <typename FailedT = BatchAddClusterNodesError>
  BatchAddClusterNodesResult& AddFailed(FailedT&& value) {
    m_failedHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchAddClusterNodesResult& WithRequestId(RequestIdT&& value) {
