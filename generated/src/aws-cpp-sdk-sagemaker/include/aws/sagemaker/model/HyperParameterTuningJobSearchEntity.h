...
class HyperParameterTuningJobSearchEntity {
 public:
  ...
  void SetHyperParameterTuningJobConfig(HyperParameterTuningJobConfigT&& value) {
    ...
    m_hyperParameterTuningJobConfig = std::forward<HyperParameterTuningJobConfigT>(value);
  }
  template <typename HyperParameterTuningJobConfigT = HyperParameterTuningJobConfig>
  HyperParameterTuningJobSearchEntity& WithHyperParameterTuningJobConfig(HyperParameterTuningJobConfigT&& value) {
    SetHyperParameterTuningJobConfig(std::forward<HyperParameterTuningJobConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingJobDefinition(TrainingJobDefinitionT&& value) {
    ...
    m_trainingJobDefinition = std::forward<TrainingJobDefinitionT>(value);
  }
  template <typename TrainingJobDefinitionT = HyperParameterTrainingJobDefinition>
  HyperParameterTuningJobSearchEntity& WithTrainingJobDefinition(TrainingJobDefinitionT&& value) {
    SetTrainingJobDefinition(std::forward<TrainingJobDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTrainingJobDefinitions(TrainingJobDefinitionsT&& value) {
    ...
    m_trainingJobDefinitions = std::forward<TrainingJobDefinitionsT>(value);
  }
  template <typename TrainingJobDefinitionsT = Aws::Vector<HyperParameterTrainingJobDefinition>>
  HyperParameterTuningJobSearchEntity& WithTrainingJobDefinitions(TrainingJobDefinitionsT&& value) {
    SetTrainingJobDefinitions(std::forward<TrainingJobDefinitionsT>(value));
    return *this;
  }
  ...
  HyperParameterTuningJobSearchEntity& AddTrainingJobDefinitions(TrainingJobDefinitionsT&& value) {
    m_trainingJobDefinitionsHasBeenSet = true;
    m_trainingJobDefinitions.emplace_back(std::forward<TrainingJobDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline HyperParameterTuningJobSearchEntity& WithHyperParameterTuningJobStatus(HyperParameterTuningJobStatus value) {
  ...
  void SetBestTrainingJob(BestTrainingJobT&& value) {
    ...
    m_bestTrainingJob = std::forward<BestTrainingJobT>(value);
  }
  template <typename BestTrainingJobT = HyperParameterTrainingJobSummary>
  HyperParameterTuningJobSearchEntity& WithBestTrainingJob(BestTrainingJobT&& value) {
    SetBestTrainingJob(std::forward<BestTrainingJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOverallBestTrainingJob(OverallBestTrainingJobT&& value) {
    ...
    m_overallBestTrainingJob = std::forward<OverallBestTrainingJobT>(value);
  }
  template <typename OverallBestTrainingJobT = HyperParameterTrainingJobSummary>
  HyperParameterTuningJobSearchEntity& WithOverallBestTrainingJob(OverallBestTrainingJobT&& value) {
    SetOverallBestTrainingJob(std::forward<OverallBestTrainingJobT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWarmStartConfig(WarmStartConfigT&& value) {
    ...
    m_warmStartConfig = std::forward<WarmStartConfigT>(value);
  }
  template <typename WarmStartConfigT = HyperParameterTuningJobWarmStartConfig>
  HyperParameterTuningJobSearchEntity& WithWarmStartConfig(WarmStartConfigT&& value) {
    SetWarmStartConfig(std::forward<WarmStartConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTuningJobCompletionDetails(TuningJobCompletionDetailsT&& value) {
    ...
    m_tuningJobCompletionDetails = std::forward<TuningJobCompletionDetailsT>(value);
  }
  template <typename TuningJobCompletionDetailsT = HyperParameterTuningJobCompletionDetails>
  HyperParameterTuningJobSearchEntity& WithTuningJobCompletionDetails(TuningJobCompletionDetailsT&& value) {
    SetTuningJobCompletionDetails(std::forward<TuningJobCompletionDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConsumedResources(ConsumedResourcesT&& value) {
    ...
    m_consumedResources = std::forward<ConsumedResourcesT>(value);
  }
  template <typename ConsumedResourcesT = HyperParameterTuningJobConsumedResources>
  HyperParameterTuningJobSearchEntity& WithConsumedResources(ConsumedResourcesT&& value) {
    SetConsumedResources(std::forward<ConsumedResourcesT>(value));
    return *this;
  }
  ///@}
