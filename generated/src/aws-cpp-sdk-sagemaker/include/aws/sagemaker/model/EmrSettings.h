...
class EmrSettings {
 public:
  ...
  void SetAssumableRoleArns(AssumableRoleArnsT&& value) {
    ...
    m_assumableRoleArns = std::forward<AssumableRoleArnsT>(value);
  }
  template <typename AssumableRoleArnsT = Aws::Vector<Aws::String>>
  EmrSettings& WithAssumableRoleArns(AssumableRoleArnsT&& value) {
    SetAssumableRoleArns(std::forward<AssumableRoleArnsT>(value));
    return *this;
  }
  template <typename AssumableRoleArnsT = Aws::String>
  EmrSettings& AddAssumableRoleArns(AssumableRoleArnsT&& value) {
    m_assumableRoleArnsHasBeenSet = true;
    m_assumableRoleArns.emplace_back(std::forward<AssumableRoleArnsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExecutionRoleArns(ExecutionRoleArnsT&& value) {
    ...
    m_executionRoleArns = std::forward<ExecutionRoleArnsT>(value);
  }
  template <typename ExecutionRoleArnsT = Aws::Vector<Aws::String>>
  EmrSettings& WithExecutionRoleArns(ExecutionRoleArnsT&& value) {
    SetExecutionRoleArns(std::forward<ExecutionRoleArnsT>(value));
    return *this;
  }
  template <typename ExecutionRoleArnsT = Aws::String>
  EmrSettings& AddExecutionRoleArns(ExecutionRoleArnsT&& value) {
    m_executionRoleArnsHasBeenSet = true;
    m_executionRoleArns.emplace_back(std::forward<ExecutionRoleArnsT>(value));
    return *this;
  }
  ///@}
 private:
