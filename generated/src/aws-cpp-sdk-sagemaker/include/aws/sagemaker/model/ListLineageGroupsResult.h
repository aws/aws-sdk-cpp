...
class ListLineageGroupsResult {
 public:
  ...
  void SetLineageGroupSummaries(LineageGroupSummariesT&& value) {
    m_lineageGroupSummariesHasBeenSet = true;
    m_lineageGroupSummaries = std::forward<LineageGroupSummariesT>(value);
  }
  template <typename LineageGroupSummariesT = Aws::Vector<LineageGroupSummary>>
  ListLineageGroupsResult& WithLineageGroupSummaries(LineageGroupSummariesT&& value) {
    SetLineageGroupSummaries(std::forward<LineageGroupSummariesT>(value));
    return *this;
  }
  template <typename LineageGroupSummariesT = LineageGroupSummary>
  ListLineageGroupsResult& AddLineageGroupSummaries(LineageGroupSummariesT&& value) {
    m_lineageGroupSummariesHasBeenSet = true;
    m_lineageGroupSummaries.emplace_back(std::forward<LineageGroupSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLineageGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLineageGroupsResult& WithRequestId(RequestIdT&& value) {
