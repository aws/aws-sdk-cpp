...
class MonitoringClusterConfig {
 public:
  ...
  inline MonitoringClusterConfig& WithInstanceCount(int value) {
  ...
  inline MonitoringClusterConfig& WithInstanceType(ProcessingInstanceType value) {
  ...
  inline MonitoringClusterConfig& WithVolumeSizeInGB(int value) {
