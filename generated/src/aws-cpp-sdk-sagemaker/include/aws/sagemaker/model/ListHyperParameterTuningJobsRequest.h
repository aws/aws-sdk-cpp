...
class ListHyperParameterTuningJobsRequest : public SageMakerRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListHyperParameterTuningJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHyperParameterTuningJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(HyperParameterTuningJobSortByOptions value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListHyperParameterTuningJobsRequest& WithSortBy(HyperParameterTuningJobSortByOptions value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListHyperParameterTuningJobsRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NameContainsT = Aws::String>
  ListHyperParameterTuningJobsRequest& WithNameContains(NameContainsT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListHyperParameterTuningJobsRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListHyperParameterTuningJobsRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename LastModifiedTimeAfterT = Aws::Utils::DateTime>
  ListHyperParameterTuningJobsRequest& WithLastModifiedTimeAfter(LastModifiedTimeAfterT&& value) {
  ...
  template <typename LastModifiedTimeBeforeT = Aws::Utils::DateTime>
  ListHyperParameterTuningJobsRequest& WithLastModifiedTimeBefore(LastModifiedTimeBeforeT&& value) {
  ...
  inline void SetStatusEquals(HyperParameterTuningJobStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListHyperParameterTuningJobsRequest& WithStatusEquals(HyperParameterTuningJobStatus value) {
