...
class ProcessingJob {
 public:
  ...
  void SetProcessingInputs(ProcessingInputsT&& value) {
    ...
    m_processingInputs = std::forward<ProcessingInputsT>(value);
  }
  template <typename ProcessingInputsT = Aws::Vector<ProcessingInput>>
  ProcessingJob& WithProcessingInputs(ProcessingInputsT&& value) {
    SetProcessingInputs(std::forward<ProcessingInputsT>(value));
    return *this;
  }
  template <typename ProcessingInputsT = ProcessingInput>
  ProcessingJob& AddProcessingInputs(ProcessingInputsT&& value) {
    m_processingInputsHasBeenSet = true;
    m_processingInputs.emplace_back(std::forward<ProcessingInputsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingOutputConfig(ProcessingOutputConfigT&& value) {
    ...
    m_processingOutputConfig = std::forward<ProcessingOutputConfigT>(value);
  }
  template <typename ProcessingOutputConfigT = ProcessingOutputConfig>
  ProcessingJob& WithProcessingOutputConfig(ProcessingOutputConfigT&& value) {
    SetProcessingOutputConfig(std::forward<ProcessingOutputConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingJobName(ProcessingJobNameT&& value) {
    ...
    m_processingJobName = std::forward<ProcessingJobNameT>(value);
  }
  template <typename ProcessingJobNameT = Aws::String>
  ProcessingJob& WithProcessingJobName(ProcessingJobNameT&& value) {
    SetProcessingJobName(std::forward<ProcessingJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingResources(ProcessingResourcesT&& value) {
    ...
    m_processingResources = std::forward<ProcessingResourcesT>(value);
  }
  template <typename ProcessingResourcesT = ProcessingResources>
  ProcessingJob& WithProcessingResources(ProcessingResourcesT&& value) {
    SetProcessingResources(std::forward<ProcessingResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAppSpecification(AppSpecificationT&& value) {
    ...
    m_appSpecification = std::forward<AppSpecificationT>(value);
  }
  template <typename AppSpecificationT = AppSpecification>
  ProcessingJob& WithAppSpecification(AppSpecificationT&& value) {
    SetAppSpecification(std::forward<AppSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingJobArn(ProcessingJobArnT&& value) {
    ...
    m_processingJobArn = std::forward<ProcessingJobArnT>(value);
  }
  template <typename ProcessingJobArnT = Aws::String>
  ProcessingJob& WithProcessingJobArn(ProcessingJobArnT&& value) {
    SetProcessingJobArn(std::forward<ProcessingJobArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProcessingJobStatus(ProcessingJobStatus value) {
    m_processingJobStatusHasBeenSet = true;
    m_processingJobStatus = value;
  }
  inline ProcessingJob& WithProcessingJobStatus(ProcessingJobStatus value) {
    SetProcessingJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetExitMessage(ExitMessageT&& value) {
    ...
    m_exitMessage = std::forward<ExitMessageT>(value);
  }
  template <typename ExitMessageT = Aws::String>
  ProcessingJob& WithExitMessage(ExitMessageT&& value) {
    SetExitMessage(std::forward<ExitMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingEndTime(ProcessingEndTimeT&& value) {
    ...
    m_processingEndTime = std::forward<ProcessingEndTimeT>(value);
  }
  template <typename ProcessingEndTimeT = Aws::Utils::DateTime>
  ProcessingJob& WithProcessingEndTime(ProcessingEndTimeT&& value) {
    SetProcessingEndTime(std::forward<ProcessingEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProcessingStartTime(ProcessingStartTimeT&& value) {
    ...
    m_processingStartTime = std::forward<ProcessingStartTimeT>(value);
  }
  template <typename ProcessingStartTimeT = Aws::Utils::DateTime>
  ProcessingJob& WithProcessingStartTime(ProcessingStartTimeT&& value) {
    SetProcessingStartTime(std::forward<ProcessingStartTimeT>(value));
    return *this;
  }
  ///@}
