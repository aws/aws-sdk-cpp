...
namespace Model
{
  ...
  public:
    ...
    template<typename AuthorizedUrlT = Aws::String>
    CreatePresignedMlflowTrackingServerUrlResult& WithAuthorizedUrl(AuthorizedUrlT&& value) { SetAuthorizedUrl(std::forward<AuthorizedUrlT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreatePresignedMlflowTrackingServerUrlResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
