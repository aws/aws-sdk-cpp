...
class HumanLoopConfig {
 public:
  ...
  void SetWorkteamArn(WorkteamArnT&& value) {
    ...
    m_workteamArn = std::forward<WorkteamArnT>(value);
  }
  template <typename WorkteamArnT = Aws::String>
  HumanLoopConfig& WithWorkteamArn(WorkteamArnT&& value) {
    SetWorkteamArn(std::forward<WorkteamArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHumanTaskUiArn(HumanTaskUiArnT&& value) {
    ...
    m_humanTaskUiArn = std::forward<HumanTaskUiArnT>(value);
  }
  template <typename HumanTaskUiArnT = Aws::String>
  HumanLoopConfig& WithHumanTaskUiArn(HumanTaskUiArnT&& value) {
    SetHumanTaskUiArn(std::forward<HumanTaskUiArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskTitle(TaskTitleT&& value) {
    ...
    m_taskTitle = std::forward<TaskTitleT>(value);
  }
  template <typename TaskTitleT = Aws::String>
  HumanLoopConfig& WithTaskTitle(TaskTitleT&& value) {
    SetTaskTitle(std::forward<TaskTitleT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTaskDescription(TaskDescriptionT&& value) {
    ...
    m_taskDescription = std::forward<TaskDescriptionT>(value);
  }
  template <typename TaskDescriptionT = Aws::String>
  HumanLoopConfig& WithTaskDescription(TaskDescriptionT&& value) {
    SetTaskDescription(std::forward<TaskDescriptionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTaskCount(int value) {
    m_taskCountHasBeenSet = true;
    m_taskCount = value;
  }
  inline HumanLoopConfig& WithTaskCount(int value) {
    SetTaskCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTaskAvailabilityLifetimeInSeconds(int value) {
    m_taskAvailabilityLifetimeInSecondsHasBeenSet = true;
    m_taskAvailabilityLifetimeInSeconds = value;
  }
  inline HumanLoopConfig& WithTaskAvailabilityLifetimeInSeconds(int value) {
    SetTaskAvailabilityLifetimeInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTaskTimeLimitInSeconds(int value) {
    m_taskTimeLimitInSecondsHasBeenSet = true;
    m_taskTimeLimitInSeconds = value;
  }
  inline HumanLoopConfig& WithTaskTimeLimitInSeconds(int value) {
    SetTaskTimeLimitInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetTaskKeywords(TaskKeywordsT&& value) {
    ...
    m_taskKeywords = std::forward<TaskKeywordsT>(value);
  }
  template <typename TaskKeywordsT = Aws::Vector<Aws::String>>
  HumanLoopConfig& WithTaskKeywords(TaskKeywordsT&& value) {
    SetTaskKeywords(std::forward<TaskKeywordsT>(value));
    return *this;
  }
  template <typename TaskKeywordsT = Aws::String>
  HumanLoopConfig& AddTaskKeywords(TaskKeywordsT&& value) {
    m_taskKeywordsHasBeenSet = true;
    m_taskKeywords.emplace_back(std::forward<TaskKeywordsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPublicWorkforceTaskPrice(PublicWorkforceTaskPriceT&& value) {
    ...
    m_publicWorkforceTaskPrice = std::forward<PublicWorkforceTaskPriceT>(value);
  }
  template <typename PublicWorkforceTaskPriceT = PublicWorkforceTaskPrice>
  HumanLoopConfig& WithPublicWorkforceTaskPrice(PublicWorkforceTaskPriceT&& value) {
    SetPublicWorkforceTaskPrice(std::forward<PublicWorkforceTaskPriceT>(value));
    return *this;
  }
  ///@}
 private:
