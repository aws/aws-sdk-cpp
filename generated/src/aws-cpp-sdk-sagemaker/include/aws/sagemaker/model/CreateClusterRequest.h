...
class CreateClusterRequest : public SageMakerRequest {
 public:
  ...
  inline CreateClusterRequest& WithNodeRecovery(ClusterNodeRecovery value) {
  ...
  inline CreateClusterRequest& WithNodeProvisioningMode(ClusterNodeProvisioningMode value) {
