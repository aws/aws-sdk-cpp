...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API InferenceComponentRollingUpdatePolicy();
    ...
    inline void SetMaximumBatchSize(const InferenceComponentCapacitySize& value) { m_maximumBatchSizeHasBeenSet = true; m_maximumBatchSize = value; }
    inline void SetMaximumBatchSize(InferenceComponentCapacitySize&& value) { m_maximumBatchSizeHasBeenSet = true; m_maximumBatchSize = std::move(value); }
    inline InferenceComponentRollingUpdatePolicy& WithMaximumBatchSize(const InferenceComponentCapacitySize& value) { SetMaximumBatchSize(value); return *this;}
    inline InferenceComponentRollingUpdatePolicy& WithMaximumBatchSize(InferenceComponentCapacitySize&& value) { SetMaximumBatchSize(std::move(value)); return *this;}
    ///@}
    ...
    inline void SetRollbackMaximumBatchSize(const InferenceComponentCapacitySize& value) { m_rollbackMaximumBatchSizeHasBeenSet = true; m_rollbackMaximumBatchSize = value; }
    inline void SetRollbackMaximumBatchSize(InferenceComponentCapacitySize&& value) { m_rollbackMaximumBatchSizeHasBeenSet = true; m_rollbackMaximumBatchSize = std::move(value); }
    inline InferenceComponentRollingUpdatePolicy& WithRollbackMaximumBatchSize(const InferenceComponentCapacitySize& value) { SetRollbackMaximumBatchSize(value); return *this;}
    inline InferenceComponentRollingUpdatePolicy& WithRollbackMaximumBatchSize(InferenceComponentCapacitySize&& value) { SetRollbackMaximumBatchSize(std::move(value)); return *this;}
    ///@}
  private:
