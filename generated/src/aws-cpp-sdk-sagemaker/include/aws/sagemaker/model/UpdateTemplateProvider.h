...
class UpdateTemplateProvider {
 public:
  ...
  void SetCfnTemplateProvider(CfnTemplateProviderT&& value) {
    m_cfnTemplateProviderHasBeenSet = true;
    m_cfnTemplateProvider = std::forward<CfnTemplateProviderT>(value);
  }
  template <typename CfnTemplateProviderT = CfnUpdateTemplateProvider>
  UpdateTemplateProvider& WithCfnTemplateProvider(CfnTemplateProviderT&& value) {
    SetCfnTemplateProvider(std::forward<CfnTemplateProviderT>(value));
    return *this;
  }
  ///@}
 private:
