...
class ListMonitoringAlertHistoryRequest : public SageMakerRequest {
 public:
  ...
  template <typename MonitoringScheduleNameT = Aws::String>
  ListMonitoringAlertHistoryRequest& WithMonitoringScheduleName(MonitoringScheduleNameT&& value) {
  ...
  template <typename MonitoringAlertNameT = Aws::String>
  ListMonitoringAlertHistoryRequest& WithMonitoringAlertName(MonitoringAlertNameT&& value) {
  ...
  inline void SetSortBy(MonitoringAlertHistorySortKey value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListMonitoringAlertHistoryRequest& WithSortBy(MonitoringAlertHistorySortKey value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListMonitoringAlertHistoryRequest& WithSortOrder(SortOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoringAlertHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMonitoringAlertHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeBeforeT = Aws::Utils::DateTime>
  ListMonitoringAlertHistoryRequest& WithCreationTimeBefore(CreationTimeBeforeT&& value) {
  ...
  template <typename CreationTimeAfterT = Aws::Utils::DateTime>
  ListMonitoringAlertHistoryRequest& WithCreationTimeAfter(CreationTimeAfterT&& value) {
  ...
  inline void SetStatusEquals(MonitoringAlertStatus value) {
    m_statusEqualsHasBeenSet = true;
    m_statusEquals = value;
  }
  inline ListMonitoringAlertHistoryRequest& WithStatusEquals(MonitoringAlertStatus value) {
