...
class PipelineVersion {
 public:
  ...
  inline PipelineVersion& WithPipelineVersionId(long long value) {
  ...
  void SetLastExecutedPipelineExecutionArn(LastExecutedPipelineExecutionArnT&& value) {
    ...
    m_lastExecutedPipelineExecutionArn = std::forward<LastExecutedPipelineExecutionArnT>(value);
  }
  template <typename LastExecutedPipelineExecutionArnT = Aws::String>
  PipelineVersion& WithLastExecutedPipelineExecutionArn(LastExecutedPipelineExecutionArnT&& value) {
    SetLastExecutedPipelineExecutionArn(std::forward<LastExecutedPipelineExecutionArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastExecutedPipelineExecutionDisplayName(LastExecutedPipelineExecutionDisplayNameT&& value) {
    ...
    m_lastExecutedPipelineExecutionDisplayName = std::forward<LastExecutedPipelineExecutionDisplayNameT>(value);
  }
  template <typename LastExecutedPipelineExecutionDisplayNameT = Aws::String>
  PipelineVersion& WithLastExecutedPipelineExecutionDisplayName(LastExecutedPipelineExecutionDisplayNameT&& value) {
    SetLastExecutedPipelineExecutionDisplayName(std::forward<LastExecutedPipelineExecutionDisplayNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLastExecutedPipelineExecutionStatus(PipelineExecutionStatus value) {
    m_lastExecutedPipelineExecutionStatusHasBeenSet = true;
    m_lastExecutedPipelineExecutionStatus = value;
  }
  inline PipelineVersion& WithLastExecutedPipelineExecutionStatus(PipelineExecutionStatus value) {
    SetLastExecutedPipelineExecutionStatus(value);
    return *this;
  }
  ///@}
 private:
