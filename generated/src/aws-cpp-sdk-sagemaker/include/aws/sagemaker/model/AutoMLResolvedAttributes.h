...
class AutoMLResolvedAttributes {
 public:
   ...
   */
  inline const AutoMLProblemTypeResolvedAttributes& GetAutoMLProblemTypeResolvedAttributes() const {
    return m_autoMLProblemTypeResolvedAttributes;
  }
  ...
  void SetAutoMLProblemTypeResolvedAttributes(AutoMLProblemTypeResolvedAttributesT&& value) {
    ...
    m_autoMLProblemTypeResolvedAttributes = std::forward<AutoMLProblemTypeResolvedAttributesT>(value);
  }
  template <typename AutoMLProblemTypeResolvedAttributesT = AutoMLProblemTypeResolvedAttributes>
  AutoMLResolvedAttributes& WithAutoMLProblemTypeResolvedAttributes(AutoMLProblemTypeResolvedAttributesT&& value) {
    SetAutoMLProblemTypeResolvedAttributes(std::forward<AutoMLProblemTypeResolvedAttributesT>(value));
    return *this;
  }
  ///@}
 private:
