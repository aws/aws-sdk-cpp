...
class DomainSettings {
 public:
  ...
  void SetRStudioServerProDomainSettings(RStudioServerProDomainSettingsT&& value) {
    ...
    m_rStudioServerProDomainSettings = std::forward<RStudioServerProDomainSettingsT>(value);
  }
  template <typename RStudioServerProDomainSettingsT = RStudioServerProDomainSettings>
  DomainSettings& WithRStudioServerProDomainSettings(RStudioServerProDomainSettingsT&& value) {
    SetRStudioServerProDomainSettings(std::forward<RStudioServerProDomainSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DomainSettings& WithExecutionRoleIdentityConfig(ExecutionRoleIdentityConfig value) {
  ...
  inline DomainSettings& WithIpAddressType(IPAddressType value) {
