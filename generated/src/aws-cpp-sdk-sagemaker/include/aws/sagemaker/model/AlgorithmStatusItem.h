...
class AlgorithmStatusItem {
 public:
  ...
  template <typename NameT = Aws::String>
  AlgorithmStatusItem& WithName(NameT&& value) {
  ...
  inline void SetStatus(DetailedAlgorithmStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline AlgorithmStatusItem& WithStatus(DetailedAlgorithmStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonT = Aws::String>
  AlgorithmStatusItem& WithFailureReason(FailureReasonT&& value) {
