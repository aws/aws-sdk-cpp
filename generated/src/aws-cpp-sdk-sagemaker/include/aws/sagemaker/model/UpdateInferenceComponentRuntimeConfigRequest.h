...
class UpdateInferenceComponentRuntimeConfigRequest : public SageMakerRequest {
 public:
  ...
  template <typename InferenceComponentNameT = Aws::String>
  UpdateInferenceComponentRuntimeConfigRequest& WithInferenceComponentName(InferenceComponentNameT&& value) {
  ...
  void SetDesiredRuntimeConfig(DesiredRuntimeConfigT&& value) {
    m_desiredRuntimeConfigHasBeenSet = true;
    m_desiredRuntimeConfig = std::forward<DesiredRuntimeConfigT>(value);
  }
  template <typename DesiredRuntimeConfigT = InferenceComponentRuntimeConfig>
  UpdateInferenceComponentRuntimeConfigRequest& WithDesiredRuntimeConfig(DesiredRuntimeConfigT&& value) {
    SetDesiredRuntimeConfig(std::forward<DesiredRuntimeConfigT>(value));
    return *this;
  }
  ///@}
 private:
