...
class DescribeClusterNodeResult {
 public:
  ...
  void SetNodeDetails(NodeDetailsT&& value) {
    ...
    m_nodeDetails = std::forward<NodeDetailsT>(value);
  }
  template <typename NodeDetailsT = ClusterNodeDetails>
  DescribeClusterNodeResult& WithNodeDetails(NodeDetailsT&& value) {
    SetNodeDetails(std::forward<NodeDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeClusterNodeResult& WithRequestId(RequestIdT&& value) {
