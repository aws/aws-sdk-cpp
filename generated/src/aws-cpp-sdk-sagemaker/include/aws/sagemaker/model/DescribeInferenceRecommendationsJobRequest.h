...
namespace Model
{
  ...
  {
  public:
    AWS_SAGEMAKER_API DescribeInferenceRecommendationsJobRequest() = default;
    ...
    template<typename JobNameT = Aws::String>
    DescribeInferenceRecommendationsJobRequest& WithJobName(JobNameT&& value) { SetJobName(std::forward<JobNameT>(value)); return *this;}
    ///@}
  private:
