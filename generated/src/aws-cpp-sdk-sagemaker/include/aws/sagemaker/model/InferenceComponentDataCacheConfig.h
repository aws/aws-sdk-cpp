...
namespace Model
{
  ...
  public:
    ...
    inline void SetEnableCaching(bool value) { m_enableCachingHasBeenSet = true; m_enableCaching = value; }
    inline InferenceComponentDataCacheConfig& WithEnableCaching(bool value) { SetEnableCaching(value); return *this;}
    ///@}
  private:
