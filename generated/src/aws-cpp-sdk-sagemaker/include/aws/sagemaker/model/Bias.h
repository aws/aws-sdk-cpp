...
class Bias {
 public:
  ...
  void SetPreTrainingReport(PreTrainingReportT&& value) {
    ...
    m_preTrainingReport = std::forward<PreTrainingReportT>(value);
  }
  template <typename PreTrainingReportT = MetricsSource>
  Bias& WithPreTrainingReport(PreTrainingReportT&& value) {
    SetPreTrainingReport(std::forward<PreTrainingReportT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPostTrainingReport(PostTrainingReportT&& value) {
    ...
    m_postTrainingReport = std::forward<PostTrainingReportT>(value);
  }
  template <typename PostTrainingReportT = MetricsSource>
  Bias& WithPostTrainingReport(PostTrainingReportT&& value) {
    SetPostTrainingReport(std::forward<PostTrainingReportT>(value));
    return *this;
  }
  ///@}
 private:
