...
class HyperbandStrategyConfig {
 public:
  ...
  inline void SetMinResource(int value) {
    m_minResourceHasBeenSet = true;
    m_minResource = value;
  }
  inline HyperbandStrategyConfig& WithMinResource(int value) {
    SetMinResource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxResource(int value) {
    m_maxResourceHasBeenSet = true;
    m_maxResource = value;
  }
  inline HyperbandStrategyConfig& WithMaxResource(int value) {
