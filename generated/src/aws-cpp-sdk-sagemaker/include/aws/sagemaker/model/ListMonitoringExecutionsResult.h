...
class ListMonitoringExecutionsResult {
 public:
  ...
  void SetMonitoringExecutionSummaries(MonitoringExecutionSummariesT&& value) {
    m_monitoringExecutionSummariesHasBeenSet = true;
    m_monitoringExecutionSummaries = std::forward<MonitoringExecutionSummariesT>(value);
  }
  template <typename MonitoringExecutionSummariesT = Aws::Vector<MonitoringExecutionSummary>>
  ListMonitoringExecutionsResult& WithMonitoringExecutionSummaries(MonitoringExecutionSummariesT&& value) {
    SetMonitoringExecutionSummaries(std::forward<MonitoringExecutionSummariesT>(value));
    return *this;
  }
  template <typename MonitoringExecutionSummariesT = MonitoringExecutionSummary>
  ListMonitoringExecutionsResult& AddMonitoringExecutionSummaries(MonitoringExecutionSummariesT&& value) {
    m_monitoringExecutionSummariesHasBeenSet = true;
    m_monitoringExecutionSummaries.emplace_back(std::forward<MonitoringExecutionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMonitoringExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMonitoringExecutionsResult& WithRequestId(RequestIdT&& value) {
