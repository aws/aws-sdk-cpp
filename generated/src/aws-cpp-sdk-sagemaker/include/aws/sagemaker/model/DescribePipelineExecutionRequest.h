...
/**
 */
class DescribePipelineExecutionRequest : public SageMakerRequest {
 public:
  AWS_SAGEMAKER_API DescribePipelineExecutionRequest() = default;
  ...
  template <typename PipelineExecutionArnT = Aws::String>
  DescribePipelineExecutionRequest& WithPipelineExecutionArn(PipelineExecutionArnT&& value) {
