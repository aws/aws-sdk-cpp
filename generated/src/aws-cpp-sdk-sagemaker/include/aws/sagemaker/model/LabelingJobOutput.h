...
class LabelingJobOutput {
 public:
  ...
  void SetOutputDatasetS3Uri(OutputDatasetS3UriT&& value) {
    m_outputDatasetS3UriHasBeenSet = true;
    m_outputDatasetS3Uri = std::forward<OutputDatasetS3UriT>(value);
  }
  template <typename OutputDatasetS3UriT = Aws::String>
  LabelingJobOutput& WithOutputDatasetS3Uri(OutputDatasetS3UriT&& value) {
    SetOutputDatasetS3Uri(std::forward<OutputDatasetS3UriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFinalActiveLearningModelArn(FinalActiveLearningModelArnT&& value) {
    m_finalActiveLearningModelArnHasBeenSet = true;
    m_finalActiveLearningModelArn = std::forward<FinalActiveLearningModelArnT>(value);
  }
  template <typename FinalActiveLearningModelArnT = Aws::String>
  LabelingJobOutput& WithFinalActiveLearningModelArn(FinalActiveLearningModelArnT&& value) {
    SetFinalActiveLearningModelArn(std::forward<FinalActiveLearningModelArnT>(value));
    return *this;
  }
  ///@}
 private:
