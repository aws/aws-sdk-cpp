    ...
    public:
      ...
      typedef SageMakerEndpointProvider EndpointProviderType;
        ...
        */
         ...
         * job.</p> <p>Find the best-performing model after you run an AutoML job by
         * calling <a
         ...
         *  <p> <code>CreateAutoMLJob</code> only accepts tabular input data. We
         * recommend using <a
         * href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateAutoMLJobV2.html">CreateAutoMLJobV2</a>
         * for all problem types. <code>CreateAutoMLJobV2</code> can process the same
         * tabular data as its previous version <code>CreateAutoMLJob</code>, as well as
         * non-tabular data for problem types such as image or text classification.</p>
         ...
         * a CreateAutoMLJob to CreateAutoMLJobV2</a>.</p> <p><h3>See Also:</h3>  
         * <a
        ...
        /**
         * <p>Creates an Autopilot job also referred to as Autopilot experiment or AutoML
         * job V2.</p> <p>We recommend using <a
         * href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateAutoMLJobV2.html">CreateAutoMLJobV2</a>
         * for all problem types. <code>CreateAutoMLJobV2</code> can process the same
         * tabular data as its previous version <code>CreateAutoMLJob</code>, as well as
         * non-tabular data for problem types such as image or text classification.</p>
         ...
         * <code>CreateAutoMLJobV2</code> in <a
         * href="https://docs.aws.amazon.com/sagemaker/latest/dg/autopilot-automate-model-development-create-experiment-api.html#autopilot-create-experiment-api-migrate-v1-v2">Migrate
         * a CreateAutoMLJob to CreateAutoMLJobV2</a>.</p> <p>For the list of available
         * problem types supported by <code>CreateAutoMLJobV2</code>, see <a
         ...
         * <p>Find the best-performing model after you run an AutoML job V2 by calling <a
         * href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_DescribeAutoMLJobV2.html">DescribeAutoMLJobV2</a>.
         * Calling <a
         * href="https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_DescribeAutoMLJob.html">DescribeAutoMLJob</a>
         * on a AutoML job V2 results in an error.</p><p><h3>See Also:</h3>   <a
        ...
        /**
         * <p>Returns information about an AutoML job V2 created by calling <a
