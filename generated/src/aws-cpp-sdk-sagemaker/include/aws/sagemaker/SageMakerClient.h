...
class AWS_SAGEMAKER_API SageMakerClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SageMakerClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SageMakerEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for AddAssociation that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddAssociationRequestT = Model::AddAssociationRequest>
  void AddAssociationAsync(const AddAssociationRequestT& request, const AddAssociationResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateTrialComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateTrialComponentRequestT = Model::AssociateTrialComponentRequest>
  void AssociateTrialComponentAsync(const AssociateTrialComponentRequestT& request,
  ...
  /**
   * A Callable wrapper for AttachClusterNodeVolume that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AttachClusterNodeVolume that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AttachClusterNodeVolumeRequestT = Model::AttachClusterNodeVolumeRequest>
  void AttachClusterNodeVolumeAsync(const AttachClusterNodeVolumeRequestT& request,
                                    const AttachClusterNodeVolumeResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchAddClusterNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchAddClusterNodes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchAddClusterNodesRequestT = Model::BatchAddClusterNodesRequest>
  void BatchAddClusterNodesAsync(const BatchAddClusterNodesRequestT& request, const BatchAddClusterNodesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDeleteClusterNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDeleteClusterNodes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteClusterNodesRequestT = Model::BatchDeleteClusterNodesRequest>
  void BatchDeleteClusterNodesAsync(const BatchDeleteClusterNodesRequestT& request,
                                    const BatchDeleteClusterNodesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDescribeModelPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename BatchDescribeModelPackageRequestT = Model::BatchDescribeModelPackageRequest>
  Model::BatchDescribeModelPackageOutcomeCallable BatchDescribeModelPackageCallable(
      const BatchDescribeModelPackageRequestT& request) const {
    return SubmitCallable(&SageMakerClient::BatchDescribeModelPackage, request);
  }

  /**
   * An Async wrapper for BatchDescribeModelPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDescribeModelPackageRequestT = Model::BatchDescribeModelPackageRequest>
  void BatchDescribeModelPackageAsync(const BatchDescribeModelPackageRequestT& request,
                                      const BatchDescribeModelPackageResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAction that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateActionRequestT = Model::CreateActionRequest>
  void CreateActionAsync(const CreateActionRequestT& request, const CreateActionResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAlgorithm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAlgorithmRequestT = Model::CreateAlgorithmRequest>
  void CreateAlgorithmAsync(const CreateAlgorithmRequestT& request, const CreateAlgorithmResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppImageConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppImageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAppImageConfigRequestT = Model::CreateAppImageConfigRequest>
  void CreateAppImageConfigAsync(const CreateAppImageConfigRequestT& request, const CreateAppImageConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateArtifact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateArtifactRequestT = Model::CreateArtifactRequest>
  void CreateArtifactAsync(const CreateArtifactRequestT& request, const CreateArtifactResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAutoMLJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAutoMLJobRequestT = Model::CreateAutoMLJobRequest>
  void CreateAutoMLJobAsync(const CreateAutoMLJobRequestT& request, const CreateAutoMLJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAutoMLJobV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAutoMLJobV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAutoMLJobV2RequestT = Model::CreateAutoMLJobV2Request>
  void CreateAutoMLJobV2Async(const CreateAutoMLJobV2RequestT& request, const CreateAutoMLJobV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateClusterSchedulerConfigOutcome CreateClusterSchedulerConfig(
      const Model::CreateClusterSchedulerConfigRequest& request) const;

  /**
   * A Callable wrapper for CreateClusterSchedulerConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateClusterSchedulerConfigRequestT = Model::CreateClusterSchedulerConfigRequest>
  Model::CreateClusterSchedulerConfigOutcomeCallable CreateClusterSchedulerConfigCallable(
      const CreateClusterSchedulerConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateClusterSchedulerConfig, request);
  }

  /**
   * An Async wrapper for CreateClusterSchedulerConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClusterSchedulerConfigRequestT = Model::CreateClusterSchedulerConfigRequest>
  void CreateClusterSchedulerConfigAsync(const CreateClusterSchedulerConfigRequestT& request,
                                         const CreateClusterSchedulerConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCodeRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCodeRepository that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCodeRepositoryRequestT = Model::CreateCodeRepositoryRequest>
  void CreateCodeRepositoryAsync(const CreateCodeRepositoryRequestT& request, const CreateCodeRepositoryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateCompilationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateCompilationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCompilationJobRequestT = Model::CreateCompilationJobRequest>
  void CreateCompilationJobAsync(const CreateCompilationJobRequestT& request, const CreateCompilationJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateComputeQuota that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateComputeQuota that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateComputeQuotaRequestT = Model::CreateComputeQuotaRequest>
  void CreateComputeQuotaAsync(const CreateComputeQuotaRequestT& request, const CreateComputeQuotaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateContext that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateContextRequestT = Model::CreateContextRequest>
  void CreateContextAsync(const CreateContextRequestT& request, const CreateContextResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateDataQualityJobDefinitionOutcome CreateDataQualityJobDefinition(
      const Model::CreateDataQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateDataQualityJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateDataQualityJobDefinitionRequestT = Model::CreateDataQualityJobDefinitionRequest>
  Model::CreateDataQualityJobDefinitionOutcomeCallable CreateDataQualityJobDefinitionCallable(
      const CreateDataQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateDataQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for CreateDataQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateDataQualityJobDefinitionRequestT = Model::CreateDataQualityJobDefinitionRequest>
  void CreateDataQualityJobDefinitionAsync(const CreateDataQualityJobDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateDeviceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateDeviceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateDeviceFleetRequestT = Model::CreateDeviceFleetRequest>
  void CreateDeviceFleetAsync(const CreateDeviceFleetRequestT& request, const CreateDeviceFleetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEdgeDeploymentPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEdgeDeploymentPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEdgeDeploymentPlanRequestT = Model::CreateEdgeDeploymentPlanRequest>
  void CreateEdgeDeploymentPlanAsync(const CreateEdgeDeploymentPlanRequestT& request,
                                     const CreateEdgeDeploymentPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEdgeDeploymentStage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateEdgeDeploymentStageRequestT = Model::CreateEdgeDeploymentStageRequest>
  Model::CreateEdgeDeploymentStageOutcomeCallable CreateEdgeDeploymentStageCallable(
      const CreateEdgeDeploymentStageRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateEdgeDeploymentStage, request);
  }

  /**
   * An Async wrapper for CreateEdgeDeploymentStage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEdgeDeploymentStageRequestT = Model::CreateEdgeDeploymentStageRequest>
  void CreateEdgeDeploymentStageAsync(const CreateEdgeDeploymentStageRequestT& request,
                                      const CreateEdgeDeploymentStageResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEdgePackagingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEdgePackagingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEdgePackagingJobRequestT = Model::CreateEdgePackagingJobRequest>
  void CreateEdgePackagingJobAsync(const CreateEdgePackagingJobRequestT& request,
  ...
  /**
   * An Async wrapper for CreateEndpoint that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateEndpointRequestT = Model::CreateEndpointRequest>
  void CreateEndpointAsync(const CreateEndpointRequestT& request, const CreateEndpointResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEndpointConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEndpointConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEndpointConfigRequestT = Model::CreateEndpointConfigRequest>
  void CreateEndpointConfigAsync(const CreateEndpointConfigRequestT& request, const CreateEndpointConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateExperiment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateExperimentRequestT = Model::CreateExperimentRequest>
  void CreateExperimentAsync(const CreateExperimentRequestT& request, const CreateExperimentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFeatureGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFeatureGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateFeatureGroupRequestT = Model::CreateFeatureGroupRequest>
  void CreateFeatureGroupAsync(const CreateFeatureGroupRequestT& request, const CreateFeatureGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFlowDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFlowDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFlowDefinitionRequestT = Model::CreateFlowDefinitionRequest>
  void CreateFlowDefinitionAsync(const CreateFlowDefinitionRequestT& request, const CreateFlowDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateHub that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateHubRequestT = Model::CreateHubRequest>
  void CreateHubAsync(const CreateHubRequestT& request, const CreateHubResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateHubContentPresignedUrlsOutcome CreateHubContentPresignedUrls(
      const Model::CreateHubContentPresignedUrlsRequest& request) const;

  /**
   * A Callable wrapper for CreateHubContentPresignedUrls that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateHubContentPresignedUrlsRequestT = Model::CreateHubContentPresignedUrlsRequest>
  Model::CreateHubContentPresignedUrlsOutcomeCallable CreateHubContentPresignedUrlsCallable(
      const CreateHubContentPresignedUrlsRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateHubContentPresignedUrls, request);
  }

  /**
   * An Async wrapper for CreateHubContentPresignedUrls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHubContentPresignedUrlsRequestT = Model::CreateHubContentPresignedUrlsRequest>
  void CreateHubContentPresignedUrlsAsync(const CreateHubContentPresignedUrlsRequestT& request,
                                          const CreateHubContentPresignedUrlsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHubContentReference that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateHubContentReferenceRequestT = Model::CreateHubContentReferenceRequest>
  Model::CreateHubContentReferenceOutcomeCallable CreateHubContentReferenceCallable(
      const CreateHubContentReferenceRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateHubContentReference, request);
  }

  /**
   * An Async wrapper for CreateHubContentReference that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHubContentReferenceRequestT = Model::CreateHubContentReferenceRequest>
  void CreateHubContentReferenceAsync(const CreateHubContentReferenceRequestT& request,
                                      const CreateHubContentReferenceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHumanTaskUi that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHumanTaskUi that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateHumanTaskUiRequestT = Model::CreateHumanTaskUiRequest>
  void CreateHumanTaskUiAsync(const CreateHumanTaskUiRequestT& request, const CreateHumanTaskUiResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateHyperParameterTuningJobOutcome CreateHyperParameterTuningJob(
      const Model::CreateHyperParameterTuningJobRequest& request) const;

  /**
   * A Callable wrapper for CreateHyperParameterTuningJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateHyperParameterTuningJobRequestT = Model::CreateHyperParameterTuningJobRequest>
  Model::CreateHyperParameterTuningJobOutcomeCallable CreateHyperParameterTuningJobCallable(
      const CreateHyperParameterTuningJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateHyperParameterTuningJob, request);
  }

  /**
   * An Async wrapper for CreateHyperParameterTuningJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHyperParameterTuningJobRequestT = Model::CreateHyperParameterTuningJobRequest>
  void CreateHyperParameterTuningJobAsync(const CreateHyperParameterTuningJobRequestT& request,
  ...
  /**
   * An Async wrapper for CreateImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateImageRequestT = Model::CreateImageRequest>
  void CreateImageAsync(const CreateImageRequestT& request, const CreateImageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateImageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateImageVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateImageVersionRequestT = Model::CreateImageVersionRequest>
  void CreateImageVersionAsync(const CreateImageVersionRequestT& request, const CreateImageVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInferenceComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateInferenceComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInferenceComponentRequestT = Model::CreateInferenceComponentRequest>
  void CreateInferenceComponentAsync(const CreateInferenceComponentRequestT& request,
                                     const CreateInferenceComponentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateInferenceExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateInferenceExperimentRequestT = Model::CreateInferenceExperimentRequest>
  Model::CreateInferenceExperimentOutcomeCallable CreateInferenceExperimentCallable(
      const CreateInferenceExperimentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateInferenceExperiment, request);
  }

  /**
   * An Async wrapper for CreateInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateInferenceExperimentRequestT = Model::CreateInferenceExperimentRequest>
  void CreateInferenceExperimentAsync(const CreateInferenceExperimentRequestT& request,
                                      const CreateInferenceExperimentResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateInferenceRecommendationsJobOutcome CreateInferenceRecommendationsJob(
      const Model::CreateInferenceRecommendationsJobRequest& request) const;

  /**
   * A Callable wrapper for CreateInferenceRecommendationsJob that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateInferenceRecommendationsJobRequestT = Model::CreateInferenceRecommendationsJobRequest>
  Model::CreateInferenceRecommendationsJobOutcomeCallable CreateInferenceRecommendationsJobCallable(
      const CreateInferenceRecommendationsJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateInferenceRecommendationsJob, request);
  }

  /**
   * An Async wrapper for CreateInferenceRecommendationsJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateInferenceRecommendationsJobRequestT = Model::CreateInferenceRecommendationsJobRequest>
  void CreateInferenceRecommendationsJobAsync(const CreateInferenceRecommendationsJobRequestT& request,
                                              const CreateInferenceRecommendationsJobResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateLabelingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateLabelingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateLabelingJobRequestT = Model::CreateLabelingJobRequest>
  void CreateLabelingJobAsync(const CreateLabelingJobRequestT& request, const CreateLabelingJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMlflowTrackingServerOutcome CreateMlflowTrackingServer(
      const Model::CreateMlflowTrackingServerRequest& request) const;

  /**
   * A Callable wrapper for CreateMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMlflowTrackingServerRequestT = Model::CreateMlflowTrackingServerRequest>
  Model::CreateMlflowTrackingServerOutcomeCallable CreateMlflowTrackingServerCallable(
      const CreateMlflowTrackingServerRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateMlflowTrackingServer, request);
  }

  /**
   * An Async wrapper for CreateMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMlflowTrackingServerRequestT = Model::CreateMlflowTrackingServerRequest>
  void CreateMlflowTrackingServerAsync(const CreateMlflowTrackingServerRequestT& request,
                                       const CreateMlflowTrackingServerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateModelBiasJobDefinitionOutcome CreateModelBiasJobDefinition(
      const Model::CreateModelBiasJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateModelBiasJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateModelBiasJobDefinitionRequestT = Model::CreateModelBiasJobDefinitionRequest>
  Model::CreateModelBiasJobDefinitionOutcomeCallable CreateModelBiasJobDefinitionCallable(
      const CreateModelBiasJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateModelBiasJobDefinition, request);
  }

  /**
   * An Async wrapper for CreateModelBiasJobDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelBiasJobDefinitionRequestT = Model::CreateModelBiasJobDefinitionRequest>
  void CreateModelBiasJobDefinitionAsync(const CreateModelBiasJobDefinitionRequestT& request,
  ...
  /**
   * An Async wrapper for CreateModelCard that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateModelCardRequestT = Model::CreateModelCardRequest>
  void CreateModelCardAsync(const CreateModelCardRequestT& request, const CreateModelCardResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateModelCardExportJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelCardExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelCardExportJobRequestT = Model::CreateModelCardExportJobRequest>
  void CreateModelCardExportJobAsync(const CreateModelCardExportJobRequestT& request,
                                     const CreateModelCardExportJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateModelExplainabilityJobDefinitionOutcome CreateModelExplainabilityJobDefinition(
      const Model::CreateModelExplainabilityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateModelExplainabilityJobDefinition that returns a future to the operation so that it can be executed in
  ...
  Model::CreateModelExplainabilityJobDefinitionOutcomeCallable CreateModelExplainabilityJobDefinitionCallable(
      const CreateModelExplainabilityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateModelExplainabilityJobDefinition, request);
  }

  /**
   * An Async wrapper for CreateModelExplainabilityJobDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateModelExplainabilityJobDefinitionRequestT = Model::CreateModelExplainabilityJobDefinitionRequest>
  void CreateModelExplainabilityJobDefinitionAsync(const CreateModelExplainabilityJobDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateModelPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelPackage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateModelPackageRequestT = Model::CreateModelPackageRequest>
  void CreateModelPackageAsync(const CreateModelPackageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const CreateModelPackageRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateModelPackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateModelPackageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateModelPackageGroupRequestT = Model::CreateModelPackageGroupRequest>
  void CreateModelPackageGroupAsync(const CreateModelPackageGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateModelQualityJobDefinitionOutcome CreateModelQualityJobDefinition(
      const Model::CreateModelQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for CreateModelQualityJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateModelQualityJobDefinitionRequestT = Model::CreateModelQualityJobDefinitionRequest>
  Model::CreateModelQualityJobDefinitionOutcomeCallable CreateModelQualityJobDefinitionCallable(
      const CreateModelQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateModelQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for CreateModelQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateModelQualityJobDefinitionRequestT = Model::CreateModelQualityJobDefinitionRequest>
  void CreateModelQualityJobDefinitionAsync(const CreateModelQualityJobDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMonitoringScheduleRequestT = Model::CreateMonitoringScheduleRequest>
  void CreateMonitoringScheduleAsync(const CreateMonitoringScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateNotebookInstanceRequestT = Model::CreateNotebookInstanceRequest>
  void CreateNotebookInstanceAsync(const CreateNotebookInstanceRequestT& request,
  ...
  virtual Model::CreateNotebookInstanceLifecycleConfigOutcome CreateNotebookInstanceLifecycleConfig(
      const Model::CreateNotebookInstanceLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for CreateNotebookInstanceLifecycleConfig that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreateNotebookInstanceLifecycleConfigRequestT = Model::CreateNotebookInstanceLifecycleConfigRequest>
  Model::CreateNotebookInstanceLifecycleConfigOutcomeCallable CreateNotebookInstanceLifecycleConfigCallable(
      const CreateNotebookInstanceLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateNotebookInstanceLifecycleConfig, request);
  }

  /**
   * An Async wrapper for CreateNotebookInstanceLifecycleConfig that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreateNotebookInstanceLifecycleConfigRequestT = Model::CreateNotebookInstanceLifecycleConfigRequest>
  void CreateNotebookInstanceLifecycleConfigAsync(const CreateNotebookInstanceLifecycleConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateOptimizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateOptimizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateOptimizationJobRequestT = Model::CreateOptimizationJobRequest>
  void CreateOptimizationJobAsync(const CreateOptimizationJobRequestT& request, const CreateOptimizationJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePartnerApp that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePartnerApp that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePartnerAppRequestT = Model::CreatePartnerAppRequest>
  void CreatePartnerAppAsync(const CreatePartnerAppRequestT& request, const CreatePartnerAppResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePartnerAppPresignedUrlOutcome CreatePartnerAppPresignedUrl(
      const Model::CreatePartnerAppPresignedUrlRequest& request) const;

  /**
   * A Callable wrapper for CreatePartnerAppPresignedUrl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreatePartnerAppPresignedUrlRequestT = Model::CreatePartnerAppPresignedUrlRequest>
  Model::CreatePartnerAppPresignedUrlOutcomeCallable CreatePartnerAppPresignedUrlCallable(
      const CreatePartnerAppPresignedUrlRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreatePartnerAppPresignedUrl, request);
  }

  /**
   * An Async wrapper for CreatePartnerAppPresignedUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePartnerAppPresignedUrlRequestT = Model::CreatePartnerAppPresignedUrlRequest>
  void CreatePartnerAppPresignedUrlAsync(const CreatePartnerAppPresignedUrlRequestT& request,
                                         const CreatePartnerAppPresignedUrlResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePresignedDomainUrl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePresignedDomainUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreatePresignedDomainUrlRequestT = Model::CreatePresignedDomainUrlRequest>
  void CreatePresignedDomainUrlAsync(const CreatePresignedDomainUrlRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePresignedMlflowTrackingServerUrlOutcome CreatePresignedMlflowTrackingServerUrl(
      const Model::CreatePresignedMlflowTrackingServerUrlRequest& request) const;

  /**
   * A Callable wrapper for CreatePresignedMlflowTrackingServerUrl that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename CreatePresignedMlflowTrackingServerUrlRequestT = Model::CreatePresignedMlflowTrackingServerUrlRequest>
  Model::CreatePresignedMlflowTrackingServerUrlOutcomeCallable CreatePresignedMlflowTrackingServerUrlCallable(
      const CreatePresignedMlflowTrackingServerUrlRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreatePresignedMlflowTrackingServerUrl, request);
  }

  /**
   * An Async wrapper for CreatePresignedMlflowTrackingServerUrl that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename CreatePresignedMlflowTrackingServerUrlRequestT = Model::CreatePresignedMlflowTrackingServerUrlRequest>
  void CreatePresignedMlflowTrackingServerUrlAsync(const CreatePresignedMlflowTrackingServerUrlRequestT& request,
                                                   const CreatePresignedMlflowTrackingServerUrlResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreatePresignedNotebookInstanceUrlOutcome CreatePresignedNotebookInstanceUrl(
      const Model::CreatePresignedNotebookInstanceUrlRequest& request) const;

  /**
   * A Callable wrapper for CreatePresignedNotebookInstanceUrl that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreatePresignedNotebookInstanceUrlRequestT = Model::CreatePresignedNotebookInstanceUrlRequest>
  Model::CreatePresignedNotebookInstanceUrlOutcomeCallable CreatePresignedNotebookInstanceUrlCallable(
      const CreatePresignedNotebookInstanceUrlRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreatePresignedNotebookInstanceUrl, request);
  }

  /**
   * An Async wrapper for CreatePresignedNotebookInstanceUrl that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreatePresignedNotebookInstanceUrlRequestT = Model::CreatePresignedNotebookInstanceUrlRequest>
  void CreatePresignedNotebookInstanceUrlAsync(const CreatePresignedNotebookInstanceUrlRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProcessingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateProcessingJobRequestT = Model::CreateProcessingJobRequest>
  void CreateProcessingJobAsync(const CreateProcessingJobRequestT& request, const CreateProcessingJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateStudioLifecycleConfigOutcome CreateStudioLifecycleConfig(
      const Model::CreateStudioLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for CreateStudioLifecycleConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateStudioLifecycleConfigRequestT = Model::CreateStudioLifecycleConfigRequest>
  Model::CreateStudioLifecycleConfigOutcomeCallable CreateStudioLifecycleConfigCallable(
      const CreateStudioLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::CreateStudioLifecycleConfig, request);
  }

  /**
   * An Async wrapper for CreateStudioLifecycleConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateStudioLifecycleConfigRequestT = Model::CreateStudioLifecycleConfigRequest>
  void CreateStudioLifecycleConfigAsync(const CreateStudioLifecycleConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrainingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTrainingJobRequestT = Model::CreateTrainingJobRequest>
  void CreateTrainingJobAsync(const CreateTrainingJobRequestT& request, const CreateTrainingJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTrainingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrainingPlan that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTrainingPlanRequestT = Model::CreateTrainingPlanRequest>
  void CreateTrainingPlanAsync(const CreateTrainingPlanRequestT& request, const CreateTrainingPlanResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * image versions for the transform job.</p> </li> </ul> <p>For more information
   * about how batch transformation works, see <a
  ...
  /**
   * A Callable wrapper for CreateTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTransformJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateTransformJobRequestT = Model::CreateTransformJobRequest>
  void CreateTransformJobAsync(const CreateTransformJobRequestT& request, const CreateTransformJobResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTrial that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTrialRequestT = Model::CreateTrialRequest>
  void CreateTrialAsync(const CreateTrialRequestT& request, const CreateTrialResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateTrialComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateTrialComponentRequestT = Model::CreateTrialComponentRequest>
  void CreateTrialComponentAsync(const CreateTrialComponentRequestT& request, const CreateTrialComponentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateUserProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUserProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateUserProfileRequestT = Model::CreateUserProfileRequest>
  void CreateUserProfileAsync(const CreateUserProfileRequestT& request, const CreateUserProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateWorkforce that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWorkforceRequestT = Model::CreateWorkforceRequest>
  void CreateWorkforceAsync(const CreateWorkforceRequestT& request, const CreateWorkforceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateWorkteam that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateWorkteamRequestT = Model::CreateWorkteamRequest>
  void CreateWorkteamAsync(const CreateWorkteamRequestT& request, const CreateWorkteamResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAction that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteActionRequestT = Model::DeleteActionRequest>
  void DeleteActionAsync(const DeleteActionRequestT& request, const DeleteActionResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAlgorithm that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAlgorithmRequestT = Model::DeleteAlgorithmRequest>
  void DeleteAlgorithmAsync(const DeleteAlgorithmRequestT& request, const DeleteAlgorithmResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppImageConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppImageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAppImageConfigRequestT = Model::DeleteAppImageConfigRequest>
  void DeleteAppImageConfigAsync(const DeleteAppImageConfigRequestT& request, const DeleteAppImageConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename DeleteArtifactRequestT = Model::DeleteArtifactRequest>
  void DeleteArtifactAsync(const DeleteArtifactResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const DeleteArtifactRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAssociation that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAssociationRequestT = Model::DeleteAssociationRequest>
  void DeleteAssociationAsync(const DeleteAssociationRequestT& request, const DeleteAssociationResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteClusterSchedulerConfigOutcome DeleteClusterSchedulerConfig(
      const Model::DeleteClusterSchedulerConfigRequest& request) const;

  /**
   * A Callable wrapper for DeleteClusterSchedulerConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteClusterSchedulerConfigRequestT = Model::DeleteClusterSchedulerConfigRequest>
  Model::DeleteClusterSchedulerConfigOutcomeCallable DeleteClusterSchedulerConfigCallable(
      const DeleteClusterSchedulerConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteClusterSchedulerConfig, request);
  }

  /**
   * An Async wrapper for DeleteClusterSchedulerConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClusterSchedulerConfigRequestT = Model::DeleteClusterSchedulerConfigRequest>
  void DeleteClusterSchedulerConfigAsync(const DeleteClusterSchedulerConfigRequestT& request,
                                         const DeleteClusterSchedulerConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCodeRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCodeRepository that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCodeRepositoryRequestT = Model::DeleteCodeRepositoryRequest>
  void DeleteCodeRepositoryAsync(const DeleteCodeRepositoryRequestT& request, const DeleteCodeRepositoryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCompilationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCompilationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCompilationJobRequestT = Model::DeleteCompilationJobRequest>
  void DeleteCompilationJobAsync(const DeleteCompilationJobRequestT& request, const DeleteCompilationJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteComputeQuota that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteComputeQuota that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteComputeQuotaRequestT = Model::DeleteComputeQuotaRequest>
  void DeleteComputeQuotaAsync(const DeleteComputeQuotaRequestT& request, const DeleteComputeQuotaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteContext that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteContextRequestT = Model::DeleteContextRequest>
  void DeleteContextAsync(const DeleteContextRequestT& request, const DeleteContextResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDataQualityJobDefinitionOutcome DeleteDataQualityJobDefinition(
      const Model::DeleteDataQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteDataQualityJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDataQualityJobDefinitionRequestT = Model::DeleteDataQualityJobDefinitionRequest>
  Model::DeleteDataQualityJobDefinitionOutcomeCallable DeleteDataQualityJobDefinitionCallable(
      const DeleteDataQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteDataQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for DeleteDataQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteDataQualityJobDefinitionRequestT = Model::DeleteDataQualityJobDefinitionRequest>
  void DeleteDataQualityJobDefinitionAsync(const DeleteDataQualityJobDefinitionRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteDeviceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteDeviceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteDeviceFleetRequestT = Model::DeleteDeviceFleetRequest>
  void DeleteDeviceFleetAsync(const DeleteDeviceFleetRequestT& request, const DeleteDeviceFleetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEdgeDeploymentPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEdgeDeploymentPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEdgeDeploymentPlanRequestT = Model::DeleteEdgeDeploymentPlanRequest>
  void DeleteEdgeDeploymentPlanAsync(const DeleteEdgeDeploymentPlanRequestT& request,
                                     const DeleteEdgeDeploymentPlanResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEdgeDeploymentStage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteEdgeDeploymentStageRequestT = Model::DeleteEdgeDeploymentStageRequest>
  Model::DeleteEdgeDeploymentStageOutcomeCallable DeleteEdgeDeploymentStageCallable(
      const DeleteEdgeDeploymentStageRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteEdgeDeploymentStage, request);
  }

  /**
   * An Async wrapper for DeleteEdgeDeploymentStage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEdgeDeploymentStageRequestT = Model::DeleteEdgeDeploymentStageRequest>
  void DeleteEdgeDeploymentStageAsync(const DeleteEdgeDeploymentStageRequestT& request,
                                      const DeleteEdgeDeploymentStageResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEndpointConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEndpointConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEndpointConfigRequestT = Model::DeleteEndpointConfigRequest>
  void DeleteEndpointConfigAsync(const DeleteEndpointConfigRequestT& request, const DeleteEndpointConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteExperiment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteExperimentRequestT = Model::DeleteExperimentRequest>
  void DeleteExperimentAsync(const DeleteExperimentRequestT& request, const DeleteExperimentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFeatureGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFeatureGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteFeatureGroupRequestT = Model::DeleteFeatureGroupRequest>
  void DeleteFeatureGroupAsync(const DeleteFeatureGroupRequestT& request, const DeleteFeatureGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFlowDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFlowDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFlowDefinitionRequestT = Model::DeleteFlowDefinitionRequest>
  void DeleteFlowDefinitionAsync(const DeleteFlowDefinitionRequestT& request, const DeleteFlowDefinitionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteHub that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteHubRequestT = Model::DeleteHubRequest>
  void DeleteHubAsync(const DeleteHubRequestT& request, const DeleteHubResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteHubContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHubContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteHubContentRequestT = Model::DeleteHubContentRequest>
  void DeleteHubContentAsync(const DeleteHubContentRequestT& request, const DeleteHubContentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteHubContentReference that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteHubContentReferenceRequestT = Model::DeleteHubContentReferenceRequest>
  Model::DeleteHubContentReferenceOutcomeCallable DeleteHubContentReferenceCallable(
      const DeleteHubContentReferenceRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteHubContentReference, request);
  }

  /**
   * An Async wrapper for DeleteHubContentReference that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHubContentReferenceRequestT = Model::DeleteHubContentReferenceRequest>
  void DeleteHubContentReferenceAsync(const DeleteHubContentReferenceRequestT& request,
                                      const DeleteHubContentReferenceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteHumanTaskUi that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHumanTaskUi that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteHumanTaskUiRequestT = Model::DeleteHumanTaskUiRequest>
  void DeleteHumanTaskUiAsync(const DeleteHumanTaskUiRequestT& request, const DeleteHumanTaskUiResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteHyperParameterTuningJobOutcome DeleteHyperParameterTuningJob(
      const Model::DeleteHyperParameterTuningJobRequest& request) const;

  /**
   * A Callable wrapper for DeleteHyperParameterTuningJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteHyperParameterTuningJobRequestT = Model::DeleteHyperParameterTuningJobRequest>
  Model::DeleteHyperParameterTuningJobOutcomeCallable DeleteHyperParameterTuningJobCallable(
      const DeleteHyperParameterTuningJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteHyperParameterTuningJob, request);
  }

  /**
   * An Async wrapper for DeleteHyperParameterTuningJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHyperParameterTuningJobRequestT = Model::DeleteHyperParameterTuningJobRequest>
  void DeleteHyperParameterTuningJobAsync(const DeleteHyperParameterTuningJobRequestT& request,
                                          const DeleteHyperParameterTuningJobResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteImageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteImageVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteImageVersionRequestT = Model::DeleteImageVersionRequest>
  void DeleteImageVersionAsync(const DeleteImageVersionRequestT& request, const DeleteImageVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInferenceComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteInferenceComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInferenceComponentRequestT = Model::DeleteInferenceComponentRequest>
  void DeleteInferenceComponentAsync(const DeleteInferenceComponentRequestT& request,
                                     const DeleteInferenceComponentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteInferenceExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteInferenceExperimentRequestT = Model::DeleteInferenceExperimentRequest>
  Model::DeleteInferenceExperimentOutcomeCallable DeleteInferenceExperimentCallable(
      const DeleteInferenceExperimentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteInferenceExperiment, request);
  }

  /**
   * An Async wrapper for DeleteInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteInferenceExperimentRequestT = Model::DeleteInferenceExperimentRequest>
  void DeleteInferenceExperimentAsync(const DeleteInferenceExperimentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMlflowTrackingServerOutcome DeleteMlflowTrackingServer(
      const Model::DeleteMlflowTrackingServerRequest& request) const;

  /**
   * A Callable wrapper for DeleteMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMlflowTrackingServerRequestT = Model::DeleteMlflowTrackingServerRequest>
  Model::DeleteMlflowTrackingServerOutcomeCallable DeleteMlflowTrackingServerCallable(
      const DeleteMlflowTrackingServerRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteMlflowTrackingServer, request);
  }

  /**
   * An Async wrapper for DeleteMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMlflowTrackingServerRequestT = Model::DeleteMlflowTrackingServerRequest>
  void DeleteMlflowTrackingServerAsync(const DeleteMlflowTrackingServerRequestT& request,
                                       const DeleteMlflowTrackingServerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteModelBiasJobDefinitionOutcome DeleteModelBiasJobDefinition(
      const Model::DeleteModelBiasJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteModelBiasJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteModelBiasJobDefinitionRequestT = Model::DeleteModelBiasJobDefinitionRequest>
  Model::DeleteModelBiasJobDefinitionOutcomeCallable DeleteModelBiasJobDefinitionCallable(
      const DeleteModelBiasJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteModelBiasJobDefinition, request);
  }

  /**
   * An Async wrapper for DeleteModelBiasJobDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteModelBiasJobDefinitionRequestT = Model::DeleteModelBiasJobDefinitionRequest>
  void DeleteModelBiasJobDefinitionAsync(const DeleteModelBiasJobDefinitionRequestT& request,
                                         const DeleteModelBiasJobDefinitionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteModelCard that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteModelCardRequestT = Model::DeleteModelCardRequest>
  void DeleteModelCardAsync(const DeleteModelCardRequestT& request, const DeleteModelCardResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteModelExplainabilityJobDefinitionOutcome DeleteModelExplainabilityJobDefinition(
      const Model::DeleteModelExplainabilityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteModelExplainabilityJobDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteModelExplainabilityJobDefinitionRequestT = Model::DeleteModelExplainabilityJobDefinitionRequest>
  Model::DeleteModelExplainabilityJobDefinitionOutcomeCallable DeleteModelExplainabilityJobDefinitionCallable(
      const DeleteModelExplainabilityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteModelExplainabilityJobDefinition, request);
  }

  /**
   * An Async wrapper for DeleteModelExplainabilityJobDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteModelExplainabilityJobDefinitionRequestT = Model::DeleteModelExplainabilityJobDefinitionRequest>
  void DeleteModelExplainabilityJobDefinitionAsync(const DeleteModelExplainabilityJobDefinitionRequestT& request,
                                                   const DeleteModelExplainabilityJobDefinitionResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteModelPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteModelPackage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteModelPackageRequestT = Model::DeleteModelPackageRequest>
  void DeleteModelPackageAsync(const DeleteModelPackageRequestT& request, const DeleteModelPackageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteModelPackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteModelPackageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteModelPackageGroupRequestT = Model::DeleteModelPackageGroupRequest>
  void DeleteModelPackageGroupAsync(const DeleteModelPackageGroupRequestT& request,
                                    const DeleteModelPackageGroupResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteModelPackageGroupPolicyOutcome DeleteModelPackageGroupPolicy(
      const Model::DeleteModelPackageGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteModelPackageGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteModelPackageGroupPolicyRequestT = Model::DeleteModelPackageGroupPolicyRequest>
  Model::DeleteModelPackageGroupPolicyOutcomeCallable DeleteModelPackageGroupPolicyCallable(
      const DeleteModelPackageGroupPolicyRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteModelPackageGroupPolicy, request);
  }

  /**
   * An Async wrapper for DeleteModelPackageGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteModelPackageGroupPolicyRequestT = Model::DeleteModelPackageGroupPolicyRequest>
  void DeleteModelPackageGroupPolicyAsync(const DeleteModelPackageGroupPolicyRequestT& request,
                                          const DeleteModelPackageGroupPolicyResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DeleteModelQualityJobDefinitionOutcome DeleteModelQualityJobDefinition(
      const Model::DeleteModelQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DeleteModelQualityJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteModelQualityJobDefinitionRequestT = Model::DeleteModelQualityJobDefinitionRequest>
  Model::DeleteModelQualityJobDefinitionOutcomeCallable DeleteModelQualityJobDefinitionCallable(
      const DeleteModelQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteModelQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for DeleteModelQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteModelQualityJobDefinitionRequestT = Model::DeleteModelQualityJobDefinitionRequest>
  void DeleteModelQualityJobDefinitionAsync(const DeleteModelQualityJobDefinitionRequestT& request,
                                            const DeleteModelQualityJobDefinitionResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMonitoringScheduleRequestT = Model::DeleteMonitoringScheduleRequest>
  void DeleteMonitoringScheduleAsync(const DeleteMonitoringScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteNotebookInstanceRequestT = Model::DeleteNotebookInstanceRequest>
  void DeleteNotebookInstanceAsync(const DeleteNotebookInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteNotebookInstanceLifecycleConfigOutcome DeleteNotebookInstanceLifecycleConfig(
      const Model::DeleteNotebookInstanceLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for DeleteNotebookInstanceLifecycleConfig that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DeleteNotebookInstanceLifecycleConfigRequestT = Model::DeleteNotebookInstanceLifecycleConfigRequest>
  Model::DeleteNotebookInstanceLifecycleConfigOutcomeCallable DeleteNotebookInstanceLifecycleConfigCallable(
      const DeleteNotebookInstanceLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteNotebookInstanceLifecycleConfig, request);
  }

  /**
   * An Async wrapper for DeleteNotebookInstanceLifecycleConfig that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DeleteNotebookInstanceLifecycleConfigRequestT = Model::DeleteNotebookInstanceLifecycleConfigRequest>
  void DeleteNotebookInstanceLifecycleConfigAsync(const DeleteNotebookInstanceLifecycleConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteOptimizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteOptimizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteOptimizationJobRequestT = Model::DeleteOptimizationJobRequest>
  void DeleteOptimizationJobAsync(const DeleteOptimizationJobRequestT& request, const DeleteOptimizationJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePartnerApp that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePartnerApp that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePartnerAppRequestT = Model::DeletePartnerAppRequest>
  void DeletePartnerAppAsync(const DeletePartnerAppRequestT& request, const DeletePartnerAppResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteStudioLifecycleConfigOutcome DeleteStudioLifecycleConfig(
      const Model::DeleteStudioLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for DeleteStudioLifecycleConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteStudioLifecycleConfigRequestT = Model::DeleteStudioLifecycleConfigRequest>
  Model::DeleteStudioLifecycleConfigOutcomeCallable DeleteStudioLifecycleConfigCallable(
      const DeleteStudioLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DeleteStudioLifecycleConfig, request);
  }

  /**
   * An Async wrapper for DeleteStudioLifecycleConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteStudioLifecycleConfigRequestT = Model::DeleteStudioLifecycleConfigRequest>
  void DeleteStudioLifecycleConfigAsync(const DeleteStudioLifecycleConfigRequestT& request,
                                        const DeleteStudioLifecycleConfigResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTags that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTagsRequestT = Model::DeleteTagsRequest>
  ...
  /**
   * An Async wrapper for DeleteTrial that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTrialRequestT = Model::DeleteTrialRequest>
  void DeleteTrialAsync(const DeleteTrialRequestT& request, const DeleteTrialResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteTrialComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteTrialComponentRequestT = Model::DeleteTrialComponentRequest>
  void DeleteTrialComponentAsync(const DeleteTrialComponentRequestT& request, const DeleteTrialComponentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUserProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUserProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUserProfileRequestT = Model::DeleteUserProfileRequest>
  void DeleteUserProfileAsync(const DeleteUserProfileRequestT& request, const DeleteUserProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWorkforce that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWorkforceRequestT = Model::DeleteWorkforceRequest>
  void DeleteWorkforceAsync(const DeleteWorkforceRequestT& request, const DeleteWorkforceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteWorkteam that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteWorkteamRequestT = Model::DeleteWorkteamRequest>
  void DeleteWorkteamAsync(const DeleteWorkteamRequestT& request, const DeleteWorkteamResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterDevicesRequestT = Model::DeregisterDevicesRequest>
  ...
  /**
   * A Callable wrapper for DescribeAlgorithm that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAlgorithm that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAlgorithmRequestT = Model::DescribeAlgorithmRequest>
  void DescribeAlgorithmAsync(const DescribeAlgorithmRequestT& request, const DescribeAlgorithmResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAppImageConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAppImageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAppImageConfigRequestT = Model::DescribeAppImageConfigRequest>
  void DescribeAppImageConfigAsync(const DescribeAppImageConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeArtifact that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeArtifact that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeArtifactRequestT = Model::DescribeArtifactRequest>
  void DescribeArtifactAsync(const DescribeArtifactRequestT& request, const DescribeArtifactResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAutoMLJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAutoMLJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAutoMLJobRequestT = Model::DescribeAutoMLJobRequest>
  void DescribeAutoMLJobAsync(const DescribeAutoMLJobRequestT& request, const DescribeAutoMLJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAutoMLJobV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAutoMLJobV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAutoMLJobV2RequestT = Model::DescribeAutoMLJobV2Request>
  void DescribeAutoMLJobV2Async(const DescribeAutoMLJobV2RequestT& request, const DescribeAutoMLJobV2ResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterEvent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterEvent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterEventRequestT = Model::DescribeClusterEventRequest>
  void DescribeClusterEventAsync(const DescribeClusterEventRequestT& request, const DescribeClusterEventResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterNode that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterNode that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeClusterNodeRequestT = Model::DescribeClusterNodeRequest>
  void DescribeClusterNodeAsync(const DescribeClusterNodeRequestT& request, const DescribeClusterNodeResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClusterSchedulerConfigOutcome DescribeClusterSchedulerConfig(
      const Model::DescribeClusterSchedulerConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeClusterSchedulerConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterSchedulerConfigRequestT = Model::DescribeClusterSchedulerConfigRequest>
  Model::DescribeClusterSchedulerConfigOutcomeCallable DescribeClusterSchedulerConfigCallable(
      const DescribeClusterSchedulerConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeClusterSchedulerConfig, request);
  }

  /**
   * An Async wrapper for DescribeClusterSchedulerConfig that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeClusterSchedulerConfigRequestT = Model::DescribeClusterSchedulerConfigRequest>
  void DescribeClusterSchedulerConfigAsync(const DescribeClusterSchedulerConfigRequestT& request,
                                           const DescribeClusterSchedulerConfigResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeCodeRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCodeRepository that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCodeRepositoryRequestT = Model::DescribeCodeRepositoryRequest>
  void DescribeCodeRepositoryAsync(const DescribeCodeRepositoryRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeCompilationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeCompilationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCompilationJobRequestT = Model::DescribeCompilationJobRequest>
  void DescribeCompilationJobAsync(const DescribeCompilationJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeComputeQuota that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeComputeQuota that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeComputeQuotaRequestT = Model::DescribeComputeQuotaRequest>
  void DescribeComputeQuotaAsync(const DescribeComputeQuotaRequestT& request, const DescribeComputeQuotaResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeContext that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeContextRequestT = Model::DescribeContextRequest>
  void DescribeContextAsync(const DescribeContextRequestT& request, const DescribeContextResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeDataQualityJobDefinitionOutcome DescribeDataQualityJobDefinition(
      const Model::DescribeDataQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DescribeDataQualityJobDefinition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDataQualityJobDefinitionRequestT = Model::DescribeDataQualityJobDefinitionRequest>
  Model::DescribeDataQualityJobDefinitionOutcomeCallable DescribeDataQualityJobDefinitionCallable(
      const DescribeDataQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeDataQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for DescribeDataQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDataQualityJobDefinitionRequestT = Model::DescribeDataQualityJobDefinitionRequest>
  void DescribeDataQualityJobDefinitionAsync(const DescribeDataQualityJobDefinitionRequestT& request,
                                             const DescribeDataQualityJobDefinitionResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeDevice that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeDeviceRequestT = Model::DescribeDeviceRequest>
  void DescribeDeviceAsync(const DescribeDeviceRequestT& request, const DescribeDeviceResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeDeviceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDeviceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDeviceFleetRequestT = Model::DescribeDeviceFleetRequest>
  void DescribeDeviceFleetAsync(const DescribeDeviceFleetRequestT& request, const DescribeDeviceFleetResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEdgeDeploymentPlanOutcome DescribeEdgeDeploymentPlan(
      const Model::DescribeEdgeDeploymentPlanRequest& request) const;

  /**
   * A Callable wrapper for DescribeEdgeDeploymentPlan that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEdgeDeploymentPlanRequestT = Model::DescribeEdgeDeploymentPlanRequest>
  Model::DescribeEdgeDeploymentPlanOutcomeCallable DescribeEdgeDeploymentPlanCallable(
      const DescribeEdgeDeploymentPlanRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeEdgeDeploymentPlan, request);
  }

  /**
   * An Async wrapper for DescribeEdgeDeploymentPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEdgeDeploymentPlanRequestT = Model::DescribeEdgeDeploymentPlanRequest>
  void DescribeEdgeDeploymentPlanAsync(const DescribeEdgeDeploymentPlanRequestT& request,
                                       const DescribeEdgeDeploymentPlanResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEdgePackagingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEdgePackagingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEdgePackagingJobRequestT = Model::DescribeEdgePackagingJobRequest>
  void DescribeEdgePackagingJobAsync(const DescribeEdgePackagingJobRequestT& request,
                                     const DescribeEdgePackagingJobResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpoint that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeEndpointRequestT = Model::DescribeEndpointRequest>
  void DescribeEndpointAsync(const DescribeEndpointRequestT& request, const DescribeEndpointResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpointConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpointConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointConfigRequestT = Model::DescribeEndpointConfigRequest>
  void DescribeEndpointConfigAsync(const DescribeEndpointConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeExperiment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeExperimentRequestT = Model::DescribeExperimentRequest>
  void DescribeExperimentAsync(const DescribeExperimentRequestT& request, const DescribeExperimentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFeatureGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFeatureGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFeatureGroupRequestT = Model::DescribeFeatureGroupRequest>
  void DescribeFeatureGroupAsync(const DescribeFeatureGroupRequestT& request, const DescribeFeatureGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFeatureMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFeatureMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFeatureMetadataRequestT = Model::DescribeFeatureMetadataRequest>
  void DescribeFeatureMetadataAsync(const DescribeFeatureMetadataRequestT& request,
                                    const DescribeFeatureMetadataResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFlowDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFlowDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFlowDefinitionRequestT = Model::DescribeFlowDefinitionRequest>
  void DescribeFlowDefinitionAsync(const DescribeFlowDefinitionRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeHub that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeHubRequestT = Model::DescribeHubRequest>
  void DescribeHubAsync(const DescribeHubRequestT& request, const DescribeHubResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeHubContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeHubContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeHubContentRequestT = Model::DescribeHubContentRequest>
  void DescribeHubContentAsync(const DescribeHubContentRequestT& request, const DescribeHubContentResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeHumanTaskUi that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeHumanTaskUi that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeHumanTaskUiRequestT = Model::DescribeHumanTaskUiRequest>
  void DescribeHumanTaskUiAsync(const DescribeHumanTaskUiRequestT& request, const DescribeHumanTaskUiResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHyperParameterTuningJobOutcome DescribeHyperParameterTuningJob(
      const Model::DescribeHyperParameterTuningJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeHyperParameterTuningJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeHyperParameterTuningJobRequestT = Model::DescribeHyperParameterTuningJobRequest>
  Model::DescribeHyperParameterTuningJobOutcomeCallable DescribeHyperParameterTuningJobCallable(
      const DescribeHyperParameterTuningJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeHyperParameterTuningJob, request);
  }

  /**
   * An Async wrapper for DescribeHyperParameterTuningJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeHyperParameterTuningJobRequestT = Model::DescribeHyperParameterTuningJobRequest>
  void DescribeHyperParameterTuningJobAsync(const DescribeHyperParameterTuningJobRequestT& request,
  ...
  /**
   * An Async wrapper for DescribeImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeImageRequestT = Model::DescribeImageRequest>
  void DescribeImageAsync(const DescribeImageRequestT& request, const DescribeImageResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeImageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeImageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeImageVersionRequestT = Model::DescribeImageVersionRequest>
  void DescribeImageVersionAsync(const DescribeImageVersionRequestT& request, const DescribeImageVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInferenceComponentOutcome DescribeInferenceComponent(
      const Model::DescribeInferenceComponentRequest& request) const;

  /**
   * A Callable wrapper for DescribeInferenceComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInferenceComponentRequestT = Model::DescribeInferenceComponentRequest>
  Model::DescribeInferenceComponentOutcomeCallable DescribeInferenceComponentCallable(
      const DescribeInferenceComponentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeInferenceComponent, request);
  }

  /**
   * An Async wrapper for DescribeInferenceComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInferenceComponentRequestT = Model::DescribeInferenceComponentRequest>
  void DescribeInferenceComponentAsync(const DescribeInferenceComponentRequestT& request,
                                       const DescribeInferenceComponentResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInferenceExperimentOutcome DescribeInferenceExperiment(
      const Model::DescribeInferenceExperimentRequest& request) const;

  /**
   * A Callable wrapper for DescribeInferenceExperiment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeInferenceExperimentRequestT = Model::DescribeInferenceExperimentRequest>
  Model::DescribeInferenceExperimentOutcomeCallable DescribeInferenceExperimentCallable(
      const DescribeInferenceExperimentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeInferenceExperiment, request);
  }

  /**
   * An Async wrapper for DescribeInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeInferenceExperimentRequestT = Model::DescribeInferenceExperimentRequest>
  void DescribeInferenceExperimentAsync(const DescribeInferenceExperimentRequestT& request,
                                        const DescribeInferenceExperimentResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeInferenceRecommendationsJobOutcome DescribeInferenceRecommendationsJob(
      const Model::DescribeInferenceRecommendationsJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeInferenceRecommendationsJob that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeInferenceRecommendationsJobRequestT = Model::DescribeInferenceRecommendationsJobRequest>
  Model::DescribeInferenceRecommendationsJobOutcomeCallable DescribeInferenceRecommendationsJobCallable(
      const DescribeInferenceRecommendationsJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeInferenceRecommendationsJob, request);
  }

  /**
   * An Async wrapper for DescribeInferenceRecommendationsJob that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeInferenceRecommendationsJobRequestT = Model::DescribeInferenceRecommendationsJobRequest>
  void DescribeInferenceRecommendationsJobAsync(const DescribeInferenceRecommendationsJobRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeLabelingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLabelingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeLabelingJobRequestT = Model::DescribeLabelingJobRequest>
  void DescribeLabelingJobAsync(const DescribeLabelingJobRequestT& request, const DescribeLabelingJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeLineageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLineageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLineageGroupRequestT = Model::DescribeLineageGroupRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMlflowTrackingServerOutcome DescribeMlflowTrackingServer(
      const Model::DescribeMlflowTrackingServerRequest& request) const;

  /**
   * A Callable wrapper for DescribeMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMlflowTrackingServerRequestT = Model::DescribeMlflowTrackingServerRequest>
  Model::DescribeMlflowTrackingServerOutcomeCallable DescribeMlflowTrackingServerCallable(
      const DescribeMlflowTrackingServerRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeMlflowTrackingServer, request);
  }

  /**
   * An Async wrapper for DescribeMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMlflowTrackingServerRequestT = Model::DescribeMlflowTrackingServerRequest>
  void DescribeMlflowTrackingServerAsync(const DescribeMlflowTrackingServerRequestT& request,
                                         const DescribeMlflowTrackingServerResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeModelBiasJobDefinitionOutcome DescribeModelBiasJobDefinition(
      const Model::DescribeModelBiasJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DescribeModelBiasJobDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeModelBiasJobDefinitionRequestT = Model::DescribeModelBiasJobDefinitionRequest>
  Model::DescribeModelBiasJobDefinitionOutcomeCallable DescribeModelBiasJobDefinitionCallable(
      const DescribeModelBiasJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeModelBiasJobDefinition, request);
  }

  /**
   * An Async wrapper for DescribeModelBiasJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeModelBiasJobDefinitionRequestT = Model::DescribeModelBiasJobDefinitionRequest>
  void DescribeModelBiasJobDefinitionAsync(const DescribeModelBiasJobDefinitionRequestT& request,
                                           const DescribeModelBiasJobDefinitionResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeModelCard that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeModelCard that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeModelCardRequestT = Model::DescribeModelCardRequest>
  void DescribeModelCardAsync(const DescribeModelCardRequestT& request, const DescribeModelCardResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeModelCardExportJobOutcome DescribeModelCardExportJob(
      const Model::DescribeModelCardExportJobRequest& request) const;

  /**
   * A Callable wrapper for DescribeModelCardExportJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeModelCardExportJobRequestT = Model::DescribeModelCardExportJobRequest>
  Model::DescribeModelCardExportJobOutcomeCallable DescribeModelCardExportJobCallable(
      const DescribeModelCardExportJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeModelCardExportJob, request);
  }

  /**
   * An Async wrapper for DescribeModelCardExportJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeModelCardExportJobRequestT = Model::DescribeModelCardExportJobRequest>
  void DescribeModelCardExportJobAsync(const DescribeModelCardExportJobRequestT& request,
                                       const DescribeModelCardExportJobResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeModelExplainabilityJobDefinitionOutcome DescribeModelExplainabilityJobDefinition(
      const Model::DescribeModelExplainabilityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DescribeModelExplainabilityJobDefinition that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeModelExplainabilityJobDefinitionRequestT = Model::DescribeModelExplainabilityJobDefinitionRequest>
  Model::DescribeModelExplainabilityJobDefinitionOutcomeCallable DescribeModelExplainabilityJobDefinitionCallable(
      const DescribeModelExplainabilityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeModelExplainabilityJobDefinition, request);
  }

  /**
   * An Async wrapper for DescribeModelExplainabilityJobDefinition that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeModelExplainabilityJobDefinitionRequestT = Model::DescribeModelExplainabilityJobDefinitionRequest>
  void DescribeModelExplainabilityJobDefinitionAsync(
      const DescribeModelExplainabilityJobDefinitionRequestT& request,
      const DescribeModelExplainabilityJobDefinitionResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeModelPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeModelPackage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeModelPackageRequestT = Model::DescribeModelPackageRequest>
  void DescribeModelPackageAsync(const DescribeModelPackageRequestT& request, const DescribeModelPackageResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeModelPackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeModelPackageGroupRequestT = Model::DescribeModelPackageGroupRequest>
  Model::DescribeModelPackageGroupOutcomeCallable DescribeModelPackageGroupCallable(
      const DescribeModelPackageGroupRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeModelPackageGroup, request);
  }

  /**
   * An Async wrapper for DescribeModelPackageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeModelPackageGroupRequestT = Model::DescribeModelPackageGroupRequest>
  void DescribeModelPackageGroupAsync(const DescribeModelPackageGroupRequestT& request,
                                      const DescribeModelPackageGroupResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeModelQualityJobDefinitionOutcome DescribeModelQualityJobDefinition(
      const Model::DescribeModelQualityJobDefinitionRequest& request) const;

  /**
   * A Callable wrapper for DescribeModelQualityJobDefinition that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeModelQualityJobDefinitionRequestT = Model::DescribeModelQualityJobDefinitionRequest>
  Model::DescribeModelQualityJobDefinitionOutcomeCallable DescribeModelQualityJobDefinitionCallable(
      const DescribeModelQualityJobDefinitionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeModelQualityJobDefinition, request);
  }

  /**
   * An Async wrapper for DescribeModelQualityJobDefinition that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeModelQualityJobDefinitionRequestT = Model::DescribeModelQualityJobDefinitionRequest>
  void DescribeModelQualityJobDefinitionAsync(const DescribeModelQualityJobDefinitionRequestT& request,
                                              const DescribeModelQualityJobDefinitionResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMonitoringScheduleOutcome DescribeMonitoringSchedule(
      const Model::DescribeMonitoringScheduleRequest& request) const;

  /**
   * A Callable wrapper for DescribeMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeMonitoringScheduleRequestT = Model::DescribeMonitoringScheduleRequest>
  Model::DescribeMonitoringScheduleOutcomeCallable DescribeMonitoringScheduleCallable(
      const DescribeMonitoringScheduleRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeMonitoringSchedule, request);
  }

  /**
   * An Async wrapper for DescribeMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMonitoringScheduleRequestT = Model::DescribeMonitoringScheduleRequest>
  void DescribeMonitoringScheduleAsync(const DescribeMonitoringScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeNotebookInstanceRequestT = Model::DescribeNotebookInstanceRequest>
  void DescribeNotebookInstanceAsync(const DescribeNotebookInstanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNotebookInstanceLifecycleConfigOutcome DescribeNotebookInstanceLifecycleConfig(
      const Model::DescribeNotebookInstanceLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeNotebookInstanceLifecycleConfig that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribeNotebookInstanceLifecycleConfigRequestT = Model::DescribeNotebookInstanceLifecycleConfigRequest>
  Model::DescribeNotebookInstanceLifecycleConfigOutcomeCallable DescribeNotebookInstanceLifecycleConfigCallable(
      const DescribeNotebookInstanceLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeNotebookInstanceLifecycleConfig, request);
  }

  /**
   * An Async wrapper for DescribeNotebookInstanceLifecycleConfig that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeNotebookInstanceLifecycleConfigRequestT = Model::DescribeNotebookInstanceLifecycleConfigRequest>
  void DescribeNotebookInstanceLifecycleConfigAsync(const DescribeNotebookInstanceLifecycleConfigRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeOptimizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeOptimizationJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeOptimizationJobRequestT = Model::DescribeOptimizationJobRequest>
  void DescribeOptimizationJobAsync(const DescribeOptimizationJobRequestT& request,
                                    const DescribeOptimizationJobResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePartnerApp that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePartnerApp that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePartnerAppRequestT = Model::DescribePartnerAppRequest>
  void DescribePartnerAppAsync(const DescribePartnerAppRequestT& request, const DescribePartnerAppResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribePipelineDefinitionForExecutionOutcome DescribePipelineDefinitionForExecution(
      const Model::DescribePipelineDefinitionForExecutionRequest& request) const;

  /**
   * A Callable wrapper for DescribePipelineDefinitionForExecution that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DescribePipelineDefinitionForExecutionRequestT = Model::DescribePipelineDefinitionForExecutionRequest>
  Model::DescribePipelineDefinitionForExecutionOutcomeCallable DescribePipelineDefinitionForExecutionCallable(
      const DescribePipelineDefinitionForExecutionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribePipelineDefinitionForExecution, request);
  }

  /**
   * An Async wrapper for DescribePipelineDefinitionForExecution that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribePipelineDefinitionForExecutionRequestT = Model::DescribePipelineDefinitionForExecutionRequest>
  void DescribePipelineDefinitionForExecutionAsync(const DescribePipelineDefinitionForExecutionRequestT& request,
                                                   const DescribePipelineDefinitionForExecutionResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProcessingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProcessingJobRequestT = Model::DescribeProcessingJobRequest>
  void DescribeProcessingJobAsync(const DescribeProcessingJobRequestT& request, const DescribeProcessingJobResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeReservedCapacity that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeReservedCapacity that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReservedCapacityRequestT = Model::DescribeReservedCapacityRequest>
  void DescribeReservedCapacityAsync(const DescribeReservedCapacityRequestT& request,
                                     const DescribeReservedCapacityResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeSpace that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeSpaceRequestT = Model::DescribeSpaceRequest>
  void DescribeSpaceAsync(const DescribeSpaceRequestT& request, const DescribeSpaceResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeStudioLifecycleConfigOutcome DescribeStudioLifecycleConfig(
      const Model::DescribeStudioLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for DescribeStudioLifecycleConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeStudioLifecycleConfigRequestT = Model::DescribeStudioLifecycleConfigRequest>
  Model::DescribeStudioLifecycleConfigOutcomeCallable DescribeStudioLifecycleConfigCallable(
      const DescribeStudioLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeStudioLifecycleConfig, request);
  }

  /**
   * An Async wrapper for DescribeStudioLifecycleConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStudioLifecycleConfigRequestT = Model::DescribeStudioLifecycleConfigRequest>
  void DescribeStudioLifecycleConfigAsync(const DescribeStudioLifecycleConfigRequestT& request,
                                          const DescribeStudioLifecycleConfigResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSubscribedWorkteamOutcome DescribeSubscribedWorkteam(
      const Model::DescribeSubscribedWorkteamRequest& request) const;

  /**
   * A Callable wrapper for DescribeSubscribedWorkteam that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSubscribedWorkteamRequestT = Model::DescribeSubscribedWorkteamRequest>
  Model::DescribeSubscribedWorkteamOutcomeCallable DescribeSubscribedWorkteamCallable(
      const DescribeSubscribedWorkteamRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DescribeSubscribedWorkteam, request);
  }

  /**
   * An Async wrapper for DescribeSubscribedWorkteam that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSubscribedWorkteamRequestT = Model::DescribeSubscribedWorkteamRequest>
  void DescribeSubscribedWorkteamAsync(const DescribeSubscribedWorkteamRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTrainingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeTrainingJobRequestT = Model::DescribeTrainingJobRequest>
  void DescribeTrainingJobAsync(const DescribeTrainingJobRequestT& request, const DescribeTrainingJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTrainingPlan that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTrainingPlan that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTrainingPlanRequestT = Model::DescribeTrainingPlanRequest>
  void DescribeTrainingPlanAsync(const DescribeTrainingPlanRequestT& request, const DescribeTrainingPlanResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTransformJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTransformJobRequestT = Model::DescribeTransformJobRequest>
  void DescribeTransformJobAsync(const DescribeTransformJobRequestT& request, const DescribeTransformJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeTrial that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTrialRequestT = Model::DescribeTrialRequest>
  void DescribeTrialAsync(const DescribeTrialRequestT& request, const DescribeTrialResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTrialComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTrialComponentRequestT = Model::DescribeTrialComponentRequest>
  void DescribeTrialComponentAsync(const DescribeTrialComponentRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeUserProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUserProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeUserProfileRequestT = Model::DescribeUserProfileRequest>
  void DescribeUserProfileAsync(const DescribeUserProfileRequestT& request, const DescribeUserProfileResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkforce that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkforce that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWorkforceRequestT = Model::DescribeWorkforceRequest>
  void DescribeWorkforceAsync(const DescribeWorkforceRequestT& request, const DescribeWorkforceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeWorkteam that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeWorkteam that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeWorkteamRequestT = Model::DescribeWorkteamRequest>
  void DescribeWorkteamAsync(const DescribeWorkteamRequestT& request, const DescribeWorkteamResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DetachClusterNodeVolume that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DetachClusterNodeVolume that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DetachClusterNodeVolumeRequestT = Model::DetachClusterNodeVolumeRequest>
  void DetachClusterNodeVolumeAsync(const DetachClusterNodeVolumeRequestT& request,
                                    const DetachClusterNodeVolumeResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableSagemakerServicecatalogPortfolioOutcome DisableSagemakerServicecatalogPortfolio(
      const Model::DisableSagemakerServicecatalogPortfolioRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableSagemakerServicecatalogPortfolio that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisableSagemakerServicecatalogPortfolioRequestT = Model::DisableSagemakerServicecatalogPortfolioRequest>
  Model::DisableSagemakerServicecatalogPortfolioOutcomeCallable DisableSagemakerServicecatalogPortfolioCallable(
      const DisableSagemakerServicecatalogPortfolioRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::DisableSagemakerServicecatalogPortfolio, request);
  }

  /**
   * An Async wrapper for DisableSagemakerServicecatalogPortfolio that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableSagemakerServicecatalogPortfolioRequestT = Model::DisableSagemakerServicecatalogPortfolioRequest>
  void DisableSagemakerServicecatalogPortfolioAsync(const DisableSagemakerServicecatalogPortfolioResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                    const DisableSagemakerServicecatalogPortfolioRequestT& request = {}) const {
  ...
  virtual Model::DisassociateTrialComponentOutcome DisassociateTrialComponent(
      const Model::DisassociateTrialComponentRequest& request) const;

  /**
   * A Callable wrapper for DisassociateTrialComponent that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateTrialComponentRequestT = Model::DisassociateTrialComponentRequest>
  Model::DisassociateTrialComponentOutcomeCallable DisassociateTrialComponentCallable(
      const DisassociateTrialComponentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::DisassociateTrialComponent, request);
  }

  /**
   * An Async wrapper for DisassociateTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateTrialComponentRequestT = Model::DisassociateTrialComponentRequest>
  void DisassociateTrialComponentAsync(const DisassociateTrialComponentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableSagemakerServicecatalogPortfolioOutcome EnableSagemakerServicecatalogPortfolio(
      const Model::EnableSagemakerServicecatalogPortfolioRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableSagemakerServicecatalogPortfolio that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename EnableSagemakerServicecatalogPortfolioRequestT = Model::EnableSagemakerServicecatalogPortfolioRequest>
  Model::EnableSagemakerServicecatalogPortfolioOutcomeCallable EnableSagemakerServicecatalogPortfolioCallable(
  ...
  /**
   * An Async wrapper for EnableSagemakerServicecatalogPortfolio that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename EnableSagemakerServicecatalogPortfolioRequestT = Model::EnableSagemakerServicecatalogPortfolioRequest>
  void EnableSagemakerServicecatalogPortfolioAsync(const EnableSagemakerServicecatalogPortfolioResponseReceivedHandler& handler,
                                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                   const EnableSagemakerServicecatalogPortfolioRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetDeviceFleetReport that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDeviceFleetReport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDeviceFleetReportRequestT = Model::GetDeviceFleetReportRequest>
  void GetDeviceFleetReportAsync(const GetDeviceFleetReportRequestT& request, const GetDeviceFleetReportResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetLineageGroupPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetLineageGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetLineageGroupPolicyRequestT = Model::GetLineageGroupPolicyRequest>
  void GetLineageGroupPolicyAsync(const GetLineageGroupPolicyRequestT& request, const GetLineageGroupPolicyResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetModelPackageGroupPolicyOutcome GetModelPackageGroupPolicy(
      const Model::GetModelPackageGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetModelPackageGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetModelPackageGroupPolicyRequestT = Model::GetModelPackageGroupPolicyRequest>
  Model::GetModelPackageGroupPolicyOutcomeCallable GetModelPackageGroupPolicyCallable(
      const GetModelPackageGroupPolicyRequestT& request) const {
    return SubmitCallable(&SageMakerClient::GetModelPackageGroupPolicy, request);
  }

  /**
   * An Async wrapper for GetModelPackageGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetModelPackageGroupPolicyRequestT = Model::GetModelPackageGroupPolicyRequest>
  void GetModelPackageGroupPolicyAsync(const GetModelPackageGroupPolicyRequestT& request,
                                       const GetModelPackageGroupPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSagemakerServicecatalogPortfolioStatusOutcome GetSagemakerServicecatalogPortfolioStatus(
      const Model::GetSagemakerServicecatalogPortfolioStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for GetSagemakerServicecatalogPortfolioStatus that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetSagemakerServicecatalogPortfolioStatusOutcomeCallable GetSagemakerServicecatalogPortfolioStatusCallable(
      const GetSagemakerServicecatalogPortfolioStatusRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::GetSagemakerServicecatalogPortfolioStatus, request);
  }

  /**
   * An Async wrapper for GetSagemakerServicecatalogPortfolioStatus that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetSagemakerServicecatalogPortfolioStatusRequestT = Model::GetSagemakerServicecatalogPortfolioStatusRequest>
  void GetSagemakerServicecatalogPortfolioStatusAsync(const GetSagemakerServicecatalogPortfolioStatusResponseReceivedHandler& handler,
                                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                      const GetSagemakerServicecatalogPortfolioStatusRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetScalingConfigurationRecommendationOutcome GetScalingConfigurationRecommendation(
      const Model::GetScalingConfigurationRecommendationRequest& request) const;

  /**
   * A Callable wrapper for GetScalingConfigurationRecommendation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename GetScalingConfigurationRecommendationRequestT = Model::GetScalingConfigurationRecommendationRequest>
  Model::GetScalingConfigurationRecommendationOutcomeCallable GetScalingConfigurationRecommendationCallable(
      const GetScalingConfigurationRecommendationRequestT& request) const {
    return SubmitCallable(&SageMakerClient::GetScalingConfigurationRecommendation, request);
  }

  /**
   * An Async wrapper for GetScalingConfigurationRecommendation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetScalingConfigurationRecommendationRequestT = Model::GetScalingConfigurationRecommendationRequest>
  void GetScalingConfigurationRecommendationAsync(const GetScalingConfigurationRecommendationRequestT& request,
                                                  const GetScalingConfigurationRecommendationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetSearchSuggestions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSearchSuggestions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSearchSuggestionsRequestT = Model::GetSearchSuggestionsRequest>
  void GetSearchSuggestionsAsync(const GetSearchSuggestionsRequestT& request, const GetSearchSuggestionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ImportHubContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ImportHubContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ImportHubContentRequestT = Model::ImportHubContentRequest>
  ...
  /**
   * An Async wrapper for ListAlgorithms that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAlgorithmsRequestT = Model::ListAlgorithmsRequest>
  void ListAlgorithmsAsync(const ListAlgorithmsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAlgorithmsRequestT& request = {}) const {
   ...
   */
  template <typename ListAliasesRequestT = Model::ListAliasesRequest>
  void ListAliasesAsync(const ListAliasesRequestT& request, const ListAliasesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAppImageConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAppImageConfigs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAppImageConfigsRequestT = Model::ListAppImageConfigsRequest>
  void ListAppImageConfigsAsync(const ListAppImageConfigsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListAppImageConfigsRequestT& request = {}) const {
   ...
   */
  template <typename ListArtifactsRequestT = Model::ListArtifactsRequest>
  void ListArtifactsAsync(const ListArtifactsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListArtifactsRequestT& request = {}) const {
   ...
   */
  template <typename ListAssociationsRequestT = Model::ListAssociationsRequest>
  void ListAssociationsAsync(const ListAssociationsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * An Async wrapper for ListAutoMLJobs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAutoMLJobsRequestT = Model::ListAutoMLJobsRequest>
  void ListAutoMLJobsAsync(const ListAutoMLJobsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListAutoMLJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCandidatesForAutoMLJobOutcome ListCandidatesForAutoMLJob(
      const Model::ListCandidatesForAutoMLJobRequest& request) const;

  /**
   * A Callable wrapper for ListCandidatesForAutoMLJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCandidatesForAutoMLJobRequestT = Model::ListCandidatesForAutoMLJobRequest>
  Model::ListCandidatesForAutoMLJobOutcomeCallable ListCandidatesForAutoMLJobCallable(
      const ListCandidatesForAutoMLJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListCandidatesForAutoMLJob, request);
  }

  /**
   * An Async wrapper for ListCandidatesForAutoMLJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCandidatesForAutoMLJobRequestT = Model::ListCandidatesForAutoMLJobRequest>
  void ListCandidatesForAutoMLJobAsync(const ListCandidatesForAutoMLJobRequestT& request,
  ...
  /**
   * A Callable wrapper for ListClusterEvents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterEvents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListClusterEventsRequestT = Model::ListClusterEventsRequest>
  void ListClusterEventsAsync(const ListClusterEventsRequestT& request, const ListClusterEventsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListClusterNodes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListClusterNodes that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListClusterNodesRequestT = Model::ListClusterNodesRequest>
  void ListClusterNodesAsync(const ListClusterNodesRequestT& request, const ListClusterNodesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListClusterSchedulerConfigsOutcome ListClusterSchedulerConfigs(
      const Model::ListClusterSchedulerConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListClusterSchedulerConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListClusterSchedulerConfigsRequestT = Model::ListClusterSchedulerConfigsRequest>
  Model::ListClusterSchedulerConfigsOutcomeCallable ListClusterSchedulerConfigsCallable(
      const ListClusterSchedulerConfigsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListClusterSchedulerConfigs, request);
  }

  /**
   * An Async wrapper for ListClusterSchedulerConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListClusterSchedulerConfigsRequestT = Model::ListClusterSchedulerConfigsRequest>
  void ListClusterSchedulerConfigsAsync(const ListClusterSchedulerConfigsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListClusterSchedulerConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCodeRepositories that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCodeRepositories that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCodeRepositoriesRequestT = Model::ListCodeRepositoriesRequest>
  void ListCodeRepositoriesAsync(const ListCodeRepositoriesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListCodeRepositoriesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCompilationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCompilationJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCompilationJobsRequestT = Model::ListCompilationJobsRequest>
  void ListCompilationJobsAsync(const ListCompilationJobsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListCompilationJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListComputeQuotas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListComputeQuotas that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListComputeQuotasRequestT = Model::ListComputeQuotasRequest>
  void ListComputeQuotasAsync(const ListComputeQuotasResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListComputeQuotasRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListContexts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListContextsRequestT = Model::ListContextsRequest>
  void ListContextsAsync(const ListContextsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListContextsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListDataQualityJobDefinitionsOutcome ListDataQualityJobDefinitions(
      const Model::ListDataQualityJobDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListDataQualityJobDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListDataQualityJobDefinitionsRequestT = Model::ListDataQualityJobDefinitionsRequest>
  Model::ListDataQualityJobDefinitionsOutcomeCallable ListDataQualityJobDefinitionsCallable(
      const ListDataQualityJobDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListDataQualityJobDefinitions, request);
  }

  /**
   * An Async wrapper for ListDataQualityJobDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListDataQualityJobDefinitionsRequestT = Model::ListDataQualityJobDefinitionsRequest>
  void ListDataQualityJobDefinitionsAsync(const ListDataQualityJobDefinitionsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListDataQualityJobDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListDeviceFleets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListDeviceFleets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListDeviceFleetsRequestT = Model::ListDeviceFleetsRequest>
  void ListDeviceFleetsAsync(const ListDeviceFleetsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListDeviceFleetsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListDevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListDevicesRequestT = Model::ListDevicesRequest>
  void ListDevicesAsync(const ListDevicesResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListDevicesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEdgeDeploymentPlans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEdgeDeploymentPlans that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEdgeDeploymentPlansRequestT = Model::ListEdgeDeploymentPlansRequest>
  void ListEdgeDeploymentPlansAsync(const ListEdgeDeploymentPlansResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListEdgeDeploymentPlansRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEdgePackagingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEdgePackagingJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEdgePackagingJobsRequestT = Model::ListEdgePackagingJobsRequest>
  void ListEdgePackagingJobsAsync(const ListEdgePackagingJobsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListEdgePackagingJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListEndpointConfigs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEndpointConfigs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEndpointConfigsRequestT = Model::ListEndpointConfigsRequest>
  void ListEndpointConfigsAsync(const ListEndpointConfigsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListEndpointConfigsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListEndpoints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListEndpointsRequestT = Model::ListEndpointsRequest>
  void ListEndpointsAsync(const ListEndpointsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListEndpointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFeatureGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFeatureGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFeatureGroupsRequestT = Model::ListFeatureGroupsRequest>
  void ListFeatureGroupsAsync(const ListFeatureGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListFeatureGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFlowDefinitions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFlowDefinitions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListFlowDefinitionsRequestT = Model::ListFlowDefinitionsRequest>
  void ListFlowDefinitionsAsync(const ListFlowDefinitionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListFlowDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListHubContentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHubContentVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHubContentVersionsRequestT = Model::ListHubContentVersionsRequest>
  void ListHubContentVersionsAsync(const ListHubContentVersionsRequestT& request,
                                   const ListHubContentVersionsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListHubContents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHubContentsRequestT = Model::ListHubContentsRequest>
  void ListHubContentsAsync(const ListHubContentsRequestT& request, const ListHubContentsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListHubs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHubsRequestT = Model::ListHubsRequest>
  void ListHubsAsync(const ListHubsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListHubsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListHumanTaskUis that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListHumanTaskUis that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListHumanTaskUisRequestT = Model::ListHumanTaskUisRequest>
  void ListHumanTaskUisAsync(const ListHumanTaskUisResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListHumanTaskUisRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListHyperParameterTuningJobsOutcome ListHyperParameterTuningJobs(
      const Model::ListHyperParameterTuningJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListHyperParameterTuningJobs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListHyperParameterTuningJobsRequestT = Model::ListHyperParameterTuningJobsRequest>
  Model::ListHyperParameterTuningJobsOutcomeCallable ListHyperParameterTuningJobsCallable(
      const ListHyperParameterTuningJobsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListHyperParameterTuningJobs, request);
  }

  /**
   * An Async wrapper for ListHyperParameterTuningJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHyperParameterTuningJobsRequestT = Model::ListHyperParameterTuningJobsRequest>
  void ListHyperParameterTuningJobsAsync(const ListHyperParameterTuningJobsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListHyperParameterTuningJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListImageVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListImageVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListImageVersionsRequestT = Model::ListImageVersionsRequest>
  void ListImageVersionsAsync(const ListImageVersionsRequestT& request, const ListImageVersionsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListImagesRequestT = Model::ListImagesRequest>
  void ListImagesAsync(const ListImagesResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListImagesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInferenceComponents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListInferenceComponents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInferenceComponentsRequestT = Model::ListInferenceComponentsRequest>
  void ListInferenceComponentsAsync(const ListInferenceComponentsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListInferenceComponentsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListInferenceExperiments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListInferenceExperimentsRequestT = Model::ListInferenceExperimentsRequest>
  Model::ListInferenceExperimentsOutcomeCallable ListInferenceExperimentsCallable(
      const ListInferenceExperimentsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListInferenceExperiments, request);
  }

  /**
   * An Async wrapper for ListInferenceExperiments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListInferenceExperimentsRequestT = Model::ListInferenceExperimentsRequest>
  void ListInferenceExperimentsAsync(const ListInferenceExperimentsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListInferenceExperimentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListInferenceRecommendationsJobStepsOutcome ListInferenceRecommendationsJobSteps(
      const Model::ListInferenceRecommendationsJobStepsRequest& request) const;

  /**
   * A Callable wrapper for ListInferenceRecommendationsJobSteps that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListInferenceRecommendationsJobStepsRequestT = Model::ListInferenceRecommendationsJobStepsRequest>
  Model::ListInferenceRecommendationsJobStepsOutcomeCallable ListInferenceRecommendationsJobStepsCallable(
      const ListInferenceRecommendationsJobStepsRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListInferenceRecommendationsJobSteps, request);
  }

  /**
   * An Async wrapper for ListInferenceRecommendationsJobSteps that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListInferenceRecommendationsJobStepsRequestT = Model::ListInferenceRecommendationsJobStepsRequest>
  void ListInferenceRecommendationsJobStepsAsync(const ListInferenceRecommendationsJobStepsRequestT& request,
                                                 const ListInferenceRecommendationsJobStepsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListInferenceRecommendationsJobsOutcome ListInferenceRecommendationsJobs(
      const Model::ListInferenceRecommendationsJobsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListInferenceRecommendationsJobs that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListInferenceRecommendationsJobsRequestT = Model::ListInferenceRecommendationsJobsRequest>
  Model::ListInferenceRecommendationsJobsOutcomeCallable ListInferenceRecommendationsJobsCallable(
      const ListInferenceRecommendationsJobsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListInferenceRecommendationsJobs, request);
  }

  /**
   * An Async wrapper for ListInferenceRecommendationsJobs that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListInferenceRecommendationsJobsRequestT = Model::ListInferenceRecommendationsJobsRequest>
  void ListInferenceRecommendationsJobsAsync(const ListInferenceRecommendationsJobsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListInferenceRecommendationsJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListLabelingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLabelingJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLabelingJobsRequestT = Model::ListLabelingJobsRequest>
  void ListLabelingJobsAsync(const ListLabelingJobsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListLabelingJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLabelingJobsForWorkteamOutcome ListLabelingJobsForWorkteam(
      const Model::ListLabelingJobsForWorkteamRequest& request) const;

  /**
   * A Callable wrapper for ListLabelingJobsForWorkteam that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLabelingJobsForWorkteamRequestT = Model::ListLabelingJobsForWorkteamRequest>
  Model::ListLabelingJobsForWorkteamOutcomeCallable ListLabelingJobsForWorkteamCallable(
      const ListLabelingJobsForWorkteamRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListLabelingJobsForWorkteam, request);
  }

  /**
   * An Async wrapper for ListLabelingJobsForWorkteam that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLabelingJobsForWorkteamRequestT = Model::ListLabelingJobsForWorkteamRequest>
  void ListLabelingJobsForWorkteamAsync(const ListLabelingJobsForWorkteamRequestT& request,
  ...
  /**
   * A Callable wrapper for ListLineageGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListLineageGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListLineageGroupsRequestT = Model::ListLineageGroupsRequest>
  void ListLineageGroupsAsync(const ListLineageGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMlflowTrackingServersOutcome ListMlflowTrackingServers(
      const Model::ListMlflowTrackingServersRequest& request = {}) const;

  /**
   * A Callable wrapper for ListMlflowTrackingServers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListMlflowTrackingServersRequestT = Model::ListMlflowTrackingServersRequest>
  Model::ListMlflowTrackingServersOutcomeCallable ListMlflowTrackingServersCallable(
      const ListMlflowTrackingServersRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListMlflowTrackingServers, request);
  }

  /**
   * An Async wrapper for ListMlflowTrackingServers that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMlflowTrackingServersRequestT = Model::ListMlflowTrackingServersRequest>
  void ListMlflowTrackingServersAsync(const ListMlflowTrackingServersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListMlflowTrackingServersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListModelBiasJobDefinitionsOutcome ListModelBiasJobDefinitions(
      const Model::ListModelBiasJobDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListModelBiasJobDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListModelBiasJobDefinitionsRequestT = Model::ListModelBiasJobDefinitionsRequest>
  Model::ListModelBiasJobDefinitionsOutcomeCallable ListModelBiasJobDefinitionsCallable(
      const ListModelBiasJobDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListModelBiasJobDefinitions, request);
  }

  /**
   * An Async wrapper for ListModelBiasJobDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelBiasJobDefinitionsRequestT = Model::ListModelBiasJobDefinitionsRequest>
  void ListModelBiasJobDefinitionsAsync(const ListModelBiasJobDefinitionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListModelBiasJobDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelCardExportJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelCardExportJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelCardExportJobsRequestT = Model::ListModelCardExportJobsRequest>
  void ListModelCardExportJobsAsync(const ListModelCardExportJobsRequestT& request,
                                    const ListModelCardExportJobsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListModelCardVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelCardVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelCardVersionsRequestT = Model::ListModelCardVersionsRequest>
  void ListModelCardVersionsAsync(const ListModelCardVersionsRequestT& request, const ListModelCardVersionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListModelCards that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListModelCardsRequestT = Model::ListModelCardsRequest>
  void ListModelCardsAsync(const ListModelCardsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListModelCardsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListModelExplainabilityJobDefinitionsOutcome ListModelExplainabilityJobDefinitions(
      const Model::ListModelExplainabilityJobDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListModelExplainabilityJobDefinitions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListModelExplainabilityJobDefinitionsRequestT = Model::ListModelExplainabilityJobDefinitionsRequest>
  Model::ListModelExplainabilityJobDefinitionsOutcomeCallable ListModelExplainabilityJobDefinitionsCallable(
      const ListModelExplainabilityJobDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListModelExplainabilityJobDefinitions, request);
  }

  /**
   * An Async wrapper for ListModelExplainabilityJobDefinitions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListModelExplainabilityJobDefinitionsRequestT = Model::ListModelExplainabilityJobDefinitionsRequest>
  void ListModelExplainabilityJobDefinitionsAsync(const ListModelExplainabilityJobDefinitionsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                  const ListModelExplainabilityJobDefinitionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelMetadata that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelMetadataRequestT = Model::ListModelMetadataRequest>
  void ListModelMetadataAsync(const ListModelMetadataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListModelMetadataRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelPackageGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelPackageGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListModelPackageGroupsRequestT = Model::ListModelPackageGroupsRequest>
  void ListModelPackageGroupsAsync(const ListModelPackageGroupsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListModelPackageGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListModelPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListModelPackages that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListModelPackagesRequestT = Model::ListModelPackagesRequest>
  void ListModelPackagesAsync(const ListModelPackagesResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListModelPackagesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListModelQualityJobDefinitionsOutcome ListModelQualityJobDefinitions(
      const Model::ListModelQualityJobDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListModelQualityJobDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListModelQualityJobDefinitionsRequestT = Model::ListModelQualityJobDefinitionsRequest>
  Model::ListModelQualityJobDefinitionsOutcomeCallable ListModelQualityJobDefinitionsCallable(
      const ListModelQualityJobDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListModelQualityJobDefinitions, request);
  }

  /**
   * An Async wrapper for ListModelQualityJobDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListModelQualityJobDefinitionsRequestT = Model::ListModelQualityJobDefinitionsRequest>
  void ListModelQualityJobDefinitionsAsync(const ListModelQualityJobDefinitionsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListModelQualityJobDefinitionsRequestT& request = {}) const {
   ...
   */
  template <typename ListModelsRequestT = Model::ListModelsRequest>
  void ListModelsAsync(const ListModelsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListModelsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMonitoringAlertHistoryOutcome ListMonitoringAlertHistory(
      const Model::ListMonitoringAlertHistoryRequest& request = {}) const;

  /**
   * A Callable wrapper for ListMonitoringAlertHistory that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMonitoringAlertHistoryRequestT = Model::ListMonitoringAlertHistoryRequest>
  Model::ListMonitoringAlertHistoryOutcomeCallable ListMonitoringAlertHistoryCallable(
      const ListMonitoringAlertHistoryRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListMonitoringAlertHistory, request);
  }

  /**
   * An Async wrapper for ListMonitoringAlertHistory that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitoringAlertHistoryRequestT = Model::ListMonitoringAlertHistoryRequest>
  void ListMonitoringAlertHistoryAsync(const ListMonitoringAlertHistoryResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListMonitoringAlertHistoryRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMonitoringAlerts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMonitoringAlerts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitoringAlertsRequestT = Model::ListMonitoringAlertsRequest>
  void ListMonitoringAlertsAsync(const ListMonitoringAlertsRequestT& request, const ListMonitoringAlertsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMonitoringExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListMonitoringExecutionsRequestT = Model::ListMonitoringExecutionsRequest>
  Model::ListMonitoringExecutionsOutcomeCallable ListMonitoringExecutionsCallable(
      const ListMonitoringExecutionsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListMonitoringExecutions, request);
  }

  /**
   * An Async wrapper for ListMonitoringExecutions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitoringExecutionsRequestT = Model::ListMonitoringExecutionsRequest>
  void ListMonitoringExecutionsAsync(const ListMonitoringExecutionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const ListMonitoringExecutionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListMonitoringSchedules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMonitoringSchedules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMonitoringSchedulesRequestT = Model::ListMonitoringSchedulesRequest>
  void ListMonitoringSchedulesAsync(const ListMonitoringSchedulesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListMonitoringSchedulesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListNotebookInstanceLifecycleConfigsOutcome ListNotebookInstanceLifecycleConfigs(
      const Model::ListNotebookInstanceLifecycleConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListNotebookInstanceLifecycleConfigs that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListNotebookInstanceLifecycleConfigsRequestT = Model::ListNotebookInstanceLifecycleConfigsRequest>
  Model::ListNotebookInstanceLifecycleConfigsOutcomeCallable ListNotebookInstanceLifecycleConfigsCallable(
      const ListNotebookInstanceLifecycleConfigsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListNotebookInstanceLifecycleConfigs, request);
  }

  /**
   * An Async wrapper for ListNotebookInstanceLifecycleConfigs that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListNotebookInstanceLifecycleConfigsRequestT = Model::ListNotebookInstanceLifecycleConfigsRequest>
  void ListNotebookInstanceLifecycleConfigsAsync(const ListNotebookInstanceLifecycleConfigsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                 const ListNotebookInstanceLifecycleConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListNotebookInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListNotebookInstances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListNotebookInstancesRequestT = Model::ListNotebookInstancesRequest>
  void ListNotebookInstancesAsync(const ListNotebookInstancesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListNotebookInstancesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListOptimizationJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListOptimizationJobs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListOptimizationJobsRequestT = Model::ListOptimizationJobsRequest>
  void ListOptimizationJobsAsync(const ListOptimizationJobsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListOptimizationJobsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListPartnerApps that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPartnerAppsRequestT = Model::ListPartnerAppsRequest>
  void ListPartnerAppsAsync(const ListPartnerAppsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListPartnerAppsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPipelineExecutionStepsOutcome ListPipelineExecutionSteps(
      const Model::ListPipelineExecutionStepsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListPipelineExecutionSteps that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPipelineExecutionStepsRequestT = Model::ListPipelineExecutionStepsRequest>
  Model::ListPipelineExecutionStepsOutcomeCallable ListPipelineExecutionStepsCallable(
      const ListPipelineExecutionStepsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListPipelineExecutionSteps, request);
  }

  /**
   * An Async wrapper for ListPipelineExecutionSteps that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPipelineExecutionStepsRequestT = Model::ListPipelineExecutionStepsRequest>
  void ListPipelineExecutionStepsAsync(const ListPipelineExecutionStepsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListPipelineExecutionStepsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListPipelineParametersForExecutionOutcome ListPipelineParametersForExecution(
      const Model::ListPipelineParametersForExecutionRequest& request) const;

  /**
   * A Callable wrapper for ListPipelineParametersForExecution that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListPipelineParametersForExecutionRequestT = Model::ListPipelineParametersForExecutionRequest>
  Model::ListPipelineParametersForExecutionOutcomeCallable ListPipelineParametersForExecutionCallable(
      const ListPipelineParametersForExecutionRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListPipelineParametersForExecution, request);
  }

  /**
   * An Async wrapper for ListPipelineParametersForExecution that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPipelineParametersForExecutionRequestT = Model::ListPipelineParametersForExecutionRequest>
  void ListPipelineParametersForExecutionAsync(const ListPipelineParametersForExecutionRequestT& request,
                                               const ListPipelineParametersForExecutionResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPipelineVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPipelineVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPipelineVersionsRequestT = Model::ListPipelineVersionsRequest>
  void ListPipelineVersionsAsync(const ListPipelineVersionsRequestT& request, const ListPipelineVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListProcessingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProcessingJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListProcessingJobsRequestT = Model::ListProcessingJobsRequest>
  void ListProcessingJobsAsync(const ListProcessingJobsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListProcessingJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListResourceCatalogs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListResourceCatalogs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListResourceCatalogsRequestT = Model::ListResourceCatalogsRequest>
  void ListResourceCatalogsAsync(const ListResourceCatalogsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListResourceCatalogsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListStageDevices that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListStageDevices that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListStageDevicesRequestT = Model::ListStageDevicesRequest>
  void ListStageDevicesAsync(const ListStageDevicesRequestT& request, const ListStageDevicesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStudioLifecycleConfigsOutcome ListStudioLifecycleConfigs(
      const Model::ListStudioLifecycleConfigsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListStudioLifecycleConfigs that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListStudioLifecycleConfigsRequestT = Model::ListStudioLifecycleConfigsRequest>
  Model::ListStudioLifecycleConfigsOutcomeCallable ListStudioLifecycleConfigsCallable(
      const ListStudioLifecycleConfigsRequestT& request = {}) const {
    return SubmitCallable(&SageMakerClient::ListStudioLifecycleConfigs, request);
  }

  /**
   * An Async wrapper for ListStudioLifecycleConfigs that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListStudioLifecycleConfigsRequestT = Model::ListStudioLifecycleConfigsRequest>
  void ListStudioLifecycleConfigsAsync(const ListStudioLifecycleConfigsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListStudioLifecycleConfigsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListSubscribedWorkteams that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSubscribedWorkteams that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubscribedWorkteamsRequestT = Model::ListSubscribedWorkteamsRequest>
  void ListSubscribedWorkteamsAsync(const ListSubscribedWorkteamsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const ListSubscribedWorkteamsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTrainingJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrainingJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrainingJobsRequestT = Model::ListTrainingJobsRequest>
  void ListTrainingJobsAsync(const ListTrainingJobsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListTrainingJobsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTrainingJobsForHyperParameterTuningJobOutcome ListTrainingJobsForHyperParameterTuningJob(
      const Model::ListTrainingJobsForHyperParameterTuningJobRequest& request) const;

  /**
   * A Callable wrapper for ListTrainingJobsForHyperParameterTuningJob that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListTrainingJobsForHyperParameterTuningJobOutcomeCallable ListTrainingJobsForHyperParameterTuningJobCallable(
      const ListTrainingJobsForHyperParameterTuningJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListTrainingJobsForHyperParameterTuningJob, request);
  }

  /**
   * An Async wrapper for ListTrainingJobsForHyperParameterTuningJob that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListTrainingJobsForHyperParameterTuningJobRequestT = Model::ListTrainingJobsForHyperParameterTuningJobRequest>
  void ListTrainingJobsForHyperParameterTuningJobAsync(
      const ListTrainingJobsForHyperParameterTuningJobRequestT& request,
      const ListTrainingJobsForHyperParameterTuningJobResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTrainingPlans that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrainingPlans that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrainingPlansRequestT = Model::ListTrainingPlansRequest>
  void ListTrainingPlansAsync(const ListTrainingPlansResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListTrainingPlansRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTransformJobs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTransformJobs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTransformJobsRequestT = Model::ListTransformJobsRequest>
  void ListTransformJobsAsync(const ListTransformJobsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListTransformJobsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTrialComponents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTrialComponents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTrialComponentsRequestT = Model::ListTrialComponentsRequest>
  void ListTrialComponentsAsync(const ListTrialComponentsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const ListTrialComponentsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListTrials that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTrialsRequestT = Model::ListTrialsRequest>
  void ListTrialsAsync(const ListTrialsResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListTrialsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListUltraServersByReservedCapacityOutcome ListUltraServersByReservedCapacity(
      const Model::ListUltraServersByReservedCapacityRequest& request) const;

  /**
   * A Callable wrapper for ListUltraServersByReservedCapacity that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListUltraServersByReservedCapacityRequestT = Model::ListUltraServersByReservedCapacityRequest>
  Model::ListUltraServersByReservedCapacityOutcomeCallable ListUltraServersByReservedCapacityCallable(
      const ListUltraServersByReservedCapacityRequestT& request) const {
    return SubmitCallable(&SageMakerClient::ListUltraServersByReservedCapacity, request);
  }

  /**
   * An Async wrapper for ListUltraServersByReservedCapacity that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListUltraServersByReservedCapacityRequestT = Model::ListUltraServersByReservedCapacityRequest>
  void ListUltraServersByReservedCapacityAsync(const ListUltraServersByReservedCapacityRequestT& request,
                                               const ListUltraServersByReservedCapacityResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListUserProfiles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUserProfiles that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListUserProfilesRequestT = Model::ListUserProfilesRequest>
  void ListUserProfilesAsync(const ListUserProfilesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListUserProfilesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListWorkforces that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWorkforcesRequestT = Model::ListWorkforcesRequest>
  void ListWorkforcesAsync(const ListWorkforcesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListWorkforcesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListWorkteams that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListWorkteamsRequestT = Model::ListWorkteamsRequest>
  void ListWorkteamsAsync(const ListWorkteamsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const ListWorkteamsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutModelPackageGroupPolicyOutcome PutModelPackageGroupPolicy(
      const Model::PutModelPackageGroupPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutModelPackageGroupPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutModelPackageGroupPolicyRequestT = Model::PutModelPackageGroupPolicyRequest>
  Model::PutModelPackageGroupPolicyOutcomeCallable PutModelPackageGroupPolicyCallable(
      const PutModelPackageGroupPolicyRequestT& request) const {
    return SubmitCallable(&SageMakerClient::PutModelPackageGroupPolicy, request);
  }

  /**
   * An Async wrapper for PutModelPackageGroupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutModelPackageGroupPolicyRequestT = Model::PutModelPackageGroupPolicyRequest>
  void PutModelPackageGroupPolicyAsync(const PutModelPackageGroupPolicyRequestT& request,
                                       const PutModelPackageGroupPolicyResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for QueryLineage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename QueryLineageRequestT = Model::QueryLineageRequest>
  void QueryLineageAsync(const QueryLineageResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const QueryLineageRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for RegisterDevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RegisterDevicesRequestT = Model::RegisterDevicesRequest>
  void RegisterDevicesAsync(const RegisterDevicesRequestT& request, const RegisterDevicesResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RenderUiTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RenderUiTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RenderUiTemplateRequestT = Model::RenderUiTemplateRequest>
  void RenderUiTemplateAsync(const RenderUiTemplateRequestT& request, const RenderUiTemplateResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RetryPipelineExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RetryPipelineExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RetryPipelineExecutionRequestT = Model::RetryPipelineExecutionRequest>
  void RetryPipelineExecutionAsync(const RetryPipelineExecutionRequestT& request,
                                   const RetryPipelineExecutionResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename SearchRequestT = Model::SearchRequest>
  void SearchAsync(const SearchRequestT& request, const SearchResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for SearchTrainingPlanOfferings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchTrainingPlanOfferingsRequestT = Model::SearchTrainingPlanOfferingsRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::SendPipelineExecutionStepFailureOutcome SendPipelineExecutionStepFailure(
      const Model::SendPipelineExecutionStepFailureRequest& request) const;

  /**
   * A Callable wrapper for SendPipelineExecutionStepFailure that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SendPipelineExecutionStepFailureRequestT = Model::SendPipelineExecutionStepFailureRequest>
  Model::SendPipelineExecutionStepFailureOutcomeCallable SendPipelineExecutionStepFailureCallable(
      const SendPipelineExecutionStepFailureRequestT& request) const {
    return SubmitCallable(&SageMakerClient::SendPipelineExecutionStepFailure, request);
  }

  /**
   * An Async wrapper for SendPipelineExecutionStepFailure that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SendPipelineExecutionStepFailureRequestT = Model::SendPipelineExecutionStepFailureRequest>
  void SendPipelineExecutionStepFailureAsync(const SendPipelineExecutionStepFailureRequestT& request,
                                             const SendPipelineExecutionStepFailureResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SendPipelineExecutionStepSuccessOutcome SendPipelineExecutionStepSuccess(
      const Model::SendPipelineExecutionStepSuccessRequest& request) const;

  /**
   * A Callable wrapper for SendPipelineExecutionStepSuccess that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename SendPipelineExecutionStepSuccessRequestT = Model::SendPipelineExecutionStepSuccessRequest>
  Model::SendPipelineExecutionStepSuccessOutcomeCallable SendPipelineExecutionStepSuccessCallable(
      const SendPipelineExecutionStepSuccessRequestT& request) const {
    return SubmitCallable(&SageMakerClient::SendPipelineExecutionStepSuccess, request);
  }

  /**
   * An Async wrapper for SendPipelineExecutionStepSuccess that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename SendPipelineExecutionStepSuccessRequestT = Model::SendPipelineExecutionStepSuccessRequest>
  void SendPipelineExecutionStepSuccessAsync(const SendPipelineExecutionStepSuccessRequestT& request,
                                             const SendPipelineExecutionStepSuccessResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartEdgeDeploymentStage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartEdgeDeploymentStage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartEdgeDeploymentStageRequestT = Model::StartEdgeDeploymentStageRequest>
  void StartEdgeDeploymentStageAsync(const StartEdgeDeploymentStageRequestT& request,
                                     const StartEdgeDeploymentStageResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartInferenceExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartInferenceExperimentRequestT = Model::StartInferenceExperimentRequest>
  void StartInferenceExperimentAsync(const StartInferenceExperimentRequestT& request,
                                     const StartInferenceExperimentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename StartMlflowTrackingServerRequestT = Model::StartMlflowTrackingServerRequest>
  Model::StartMlflowTrackingServerOutcomeCallable StartMlflowTrackingServerCallable(
      const StartMlflowTrackingServerRequestT& request) const {
    return SubmitCallable(&SageMakerClient::StartMlflowTrackingServer, request);
  }

  /**
   * An Async wrapper for StartMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMlflowTrackingServerRequestT = Model::StartMlflowTrackingServerRequest>
  void StartMlflowTrackingServerAsync(const StartMlflowTrackingServerRequestT& request,
                                      const StartMlflowTrackingServerResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartMonitoringScheduleRequestT = Model::StartMonitoringScheduleRequest>
  void StartMonitoringScheduleAsync(const StartMonitoringScheduleRequestT& request,
                                    const StartMonitoringScheduleResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartNotebookInstanceRequestT = Model::StartNotebookInstanceRequest>
  void StartNotebookInstanceAsync(const StartNotebookInstanceRequestT& request, const StartNotebookInstanceResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopAutoMLJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopAutoMLJobRequestT = Model::StopAutoMLJobRequest>
  void StopAutoMLJobAsync(const StopAutoMLJobRequestT& request, const StopAutoMLJobResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopCompilationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopCompilationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopCompilationJobRequestT = Model::StopCompilationJobRequest>
  void StopCompilationJobAsync(const StopCompilationJobRequestT& request, const StopCompilationJobResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopEdgeDeploymentStage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEdgeDeploymentStage that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEdgeDeploymentStageRequestT = Model::StopEdgeDeploymentStageRequest>
  void StopEdgeDeploymentStageAsync(const StopEdgeDeploymentStageRequestT& request,
                                    const StopEdgeDeploymentStageResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopEdgePackagingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopEdgePackagingJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopEdgePackagingJobRequestT = Model::StopEdgePackagingJobRequest>
  void StopEdgePackagingJobAsync(const StopEdgePackagingJobRequestT& request, const StopEdgePackagingJobResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StopHyperParameterTuningJobOutcome StopHyperParameterTuningJob(
      const Model::StopHyperParameterTuningJobRequest& request) const;

  /**
   * A Callable wrapper for StopHyperParameterTuningJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopHyperParameterTuningJobRequestT = Model::StopHyperParameterTuningJobRequest>
  Model::StopHyperParameterTuningJobOutcomeCallable StopHyperParameterTuningJobCallable(
      const StopHyperParameterTuningJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::StopHyperParameterTuningJob, request);
  }

  /**
   * An Async wrapper for StopHyperParameterTuningJob that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopHyperParameterTuningJobRequestT = Model::StopHyperParameterTuningJobRequest>
  void StopHyperParameterTuningJobAsync(const StopHyperParameterTuningJobRequestT& request,
                                        const StopHyperParameterTuningJobResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopInferenceExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopInferenceExperimentRequestT = Model::StopInferenceExperimentRequest>
  void StopInferenceExperimentAsync(const StopInferenceExperimentRequestT& request,
                                    const StopInferenceExperimentResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::StopInferenceRecommendationsJobOutcome StopInferenceRecommendationsJob(
      const Model::StopInferenceRecommendationsJobRequest& request) const;

  /**
   * A Callable wrapper for StopInferenceRecommendationsJob that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StopInferenceRecommendationsJobRequestT = Model::StopInferenceRecommendationsJobRequest>
  Model::StopInferenceRecommendationsJobOutcomeCallable StopInferenceRecommendationsJobCallable(
      const StopInferenceRecommendationsJobRequestT& request) const {
    return SubmitCallable(&SageMakerClient::StopInferenceRecommendationsJob, request);
  }

  /**
   * An Async wrapper for StopInferenceRecommendationsJob that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename StopInferenceRecommendationsJobRequestT = Model::StopInferenceRecommendationsJobRequest>
  void StopInferenceRecommendationsJobAsync(const StopInferenceRecommendationsJobRequestT& request,
  ...
  /**
   * An Async wrapper for StopLabelingJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopLabelingJobRequestT = Model::StopLabelingJobRequest>
  void StopLabelingJobAsync(const StopLabelingJobRequestT& request, const StopLabelingJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopMlflowTrackingServerRequestT = Model::StopMlflowTrackingServerRequest>
  void StopMlflowTrackingServerAsync(const StopMlflowTrackingServerRequestT& request,
                                     const StopMlflowTrackingServerResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopMonitoringScheduleRequestT = Model::StopMonitoringScheduleRequest>
  void StopMonitoringScheduleAsync(const StopMonitoringScheduleRequestT& request,
                                   const StopMonitoringScheduleResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopNotebookInstanceRequestT = Model::StopNotebookInstanceRequest>
  void StopNotebookInstanceAsync(const StopNotebookInstanceRequestT& request, const StopNotebookInstanceResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopOptimizationJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopOptimizationJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopOptimizationJobRequestT = Model::StopOptimizationJobRequest>
  void StopOptimizationJobAsync(const StopOptimizationJobRequestT& request, const StopOptimizationJobResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopPipelineExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopPipelineExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopPipelineExecutionRequestT = Model::StopPipelineExecutionRequest>
  void StopPipelineExecutionAsync(const StopPipelineExecutionRequestT& request, const StopPipelineExecutionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopProcessingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopProcessingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopProcessingJobRequestT = Model::StopProcessingJobRequest>
  void StopProcessingJobAsync(const StopProcessingJobRequestT& request, const StopProcessingJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for StopTrainingJob that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StopTrainingJobRequestT = Model::StopTrainingJobRequest>
  void StopTrainingJobAsync(const StopTrainingJobRequestT& request, const StopTrainingJobResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopTransformJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopTransformJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StopTransformJobRequestT = Model::StopTransformJobRequest>
  void StopTransformJobAsync(const StopTransformJobRequestT& request, const StopTransformJobResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAction that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateActionRequestT = Model::UpdateActionRequest>
  void UpdateActionAsync(const UpdateActionRequestT& request, const UpdateActionResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppImageConfig that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppImageConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAppImageConfigRequestT = Model::UpdateAppImageConfigRequest>
  void UpdateAppImageConfigAsync(const UpdateAppImageConfigRequestT& request, const UpdateAppImageConfigResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateArtifact that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateArtifactRequestT = Model::UpdateArtifactRequest>
  void UpdateArtifactAsync(const UpdateArtifactRequestT& request, const UpdateArtifactResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateClusterSchedulerConfigOutcome UpdateClusterSchedulerConfig(
      const Model::UpdateClusterSchedulerConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateClusterSchedulerConfig that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateClusterSchedulerConfigRequestT = Model::UpdateClusterSchedulerConfigRequest>
  Model::UpdateClusterSchedulerConfigOutcomeCallable UpdateClusterSchedulerConfigCallable(
      const UpdateClusterSchedulerConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateClusterSchedulerConfig, request);
  }

  /**
   * An Async wrapper for UpdateClusterSchedulerConfig that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterSchedulerConfigRequestT = Model::UpdateClusterSchedulerConfigRequest>
  void UpdateClusterSchedulerConfigAsync(const UpdateClusterSchedulerConfigRequestT& request,
                                         const UpdateClusterSchedulerConfigResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateClusterSoftware that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateClusterSoftware that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateClusterSoftwareRequestT = Model::UpdateClusterSoftwareRequest>
  void UpdateClusterSoftwareAsync(const UpdateClusterSoftwareRequestT& request, const UpdateClusterSoftwareResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateCodeRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateCodeRepository that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCodeRepositoryRequestT = Model::UpdateCodeRepositoryRequest>
  void UpdateCodeRepositoryAsync(const UpdateCodeRepositoryRequestT& request, const UpdateCodeRepositoryResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateComputeQuota that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateComputeQuota that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateComputeQuotaRequestT = Model::UpdateComputeQuotaRequest>
  void UpdateComputeQuotaAsync(const UpdateComputeQuotaRequestT& request, const UpdateComputeQuotaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateContext that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateContextRequestT = Model::UpdateContextRequest>
  void UpdateContextAsync(const UpdateContextRequestT& request, const UpdateContextResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateDeviceFleet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateDeviceFleet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateDeviceFleetRequestT = Model::UpdateDeviceFleetRequest>
  void UpdateDeviceFleetAsync(const UpdateDeviceFleetRequestT& request, const UpdateDeviceFleetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateDevices that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateDevicesRequestT = Model::UpdateDevicesRequest>
  void UpdateDevicesAsync(const UpdateDevicesRequestT& request, const UpdateDevicesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEndpointWeightsAndCapacitiesOutcome UpdateEndpointWeightsAndCapacities(
      const Model::UpdateEndpointWeightsAndCapacitiesRequest& request) const;

  /**
   * A Callable wrapper for UpdateEndpointWeightsAndCapacities that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateEndpointWeightsAndCapacitiesRequestT = Model::UpdateEndpointWeightsAndCapacitiesRequest>
  Model::UpdateEndpointWeightsAndCapacitiesOutcomeCallable UpdateEndpointWeightsAndCapacitiesCallable(
      const UpdateEndpointWeightsAndCapacitiesRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateEndpointWeightsAndCapacities, request);
  }

  /**
   * An Async wrapper for UpdateEndpointWeightsAndCapacities that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateEndpointWeightsAndCapacitiesRequestT = Model::UpdateEndpointWeightsAndCapacitiesRequest>
  void UpdateEndpointWeightsAndCapacitiesAsync(const UpdateEndpointWeightsAndCapacitiesRequestT& request,
                                               const UpdateEndpointWeightsAndCapacitiesResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateExperiment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateExperimentRequestT = Model::UpdateExperimentRequest>
  void UpdateExperimentAsync(const UpdateExperimentRequestT& request, const UpdateExperimentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFeatureGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFeatureGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateFeatureGroupRequestT = Model::UpdateFeatureGroupRequest>
  void UpdateFeatureGroupAsync(const UpdateFeatureGroupRequestT& request, const UpdateFeatureGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFeatureMetadata that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFeatureMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFeatureMetadataRequestT = Model::UpdateFeatureMetadataRequest>
  void UpdateFeatureMetadataAsync(const UpdateFeatureMetadataRequestT& request, const UpdateFeatureMetadataResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateHub that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateHubRequestT = Model::UpdateHubRequest>
  void UpdateHubAsync(const UpdateHubRequestT& request, const UpdateHubResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHubContent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHubContent that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateHubContentRequestT = Model::UpdateHubContentRequest>
  void UpdateHubContentAsync(const UpdateHubContentRequestT& request, const UpdateHubContentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHubContentReference that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateHubContentReferenceRequestT = Model::UpdateHubContentReferenceRequest>
  Model::UpdateHubContentReferenceOutcomeCallable UpdateHubContentReferenceCallable(
      const UpdateHubContentReferenceRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateHubContentReference, request);
  }

  /**
   * An Async wrapper for UpdateHubContentReference that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateHubContentReferenceRequestT = Model::UpdateHubContentReferenceRequest>
  void UpdateHubContentReferenceAsync(const UpdateHubContentReferenceRequestT& request,
                                      const UpdateHubContentReferenceResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateImage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateImageRequestT = Model::UpdateImageRequest>
  void UpdateImageAsync(const UpdateImageRequestT& request, const UpdateImageResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateImageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateImageVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateImageVersionRequestT = Model::UpdateImageVersionRequest>
  void UpdateImageVersionAsync(const UpdateImageVersionRequestT& request, const UpdateImageVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInferenceComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateInferenceComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInferenceComponentRequestT = Model::UpdateInferenceComponentRequest>
  void UpdateInferenceComponentAsync(const UpdateInferenceComponentRequestT& request,
                                     const UpdateInferenceComponentResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateInferenceComponentRuntimeConfigOutcome UpdateInferenceComponentRuntimeConfig(
      const Model::UpdateInferenceComponentRuntimeConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateInferenceComponentRuntimeConfig that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateInferenceComponentRuntimeConfigRequestT = Model::UpdateInferenceComponentRuntimeConfigRequest>
  Model::UpdateInferenceComponentRuntimeConfigOutcomeCallable UpdateInferenceComponentRuntimeConfigCallable(
      const UpdateInferenceComponentRuntimeConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateInferenceComponentRuntimeConfig, request);
  }

  /**
   * An Async wrapper for UpdateInferenceComponentRuntimeConfig that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateInferenceComponentRuntimeConfigRequestT = Model::UpdateInferenceComponentRuntimeConfigRequest>
  void UpdateInferenceComponentRuntimeConfigAsync(const UpdateInferenceComponentRuntimeConfigRequestT& request,
                                                  const UpdateInferenceComponentRuntimeConfigResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateInferenceExperiment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateInferenceExperimentRequestT = Model::UpdateInferenceExperimentRequest>
  Model::UpdateInferenceExperimentOutcomeCallable UpdateInferenceExperimentCallable(
      const UpdateInferenceExperimentRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateInferenceExperiment, request);
  }

  /**
   * An Async wrapper for UpdateInferenceExperiment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateInferenceExperimentRequestT = Model::UpdateInferenceExperimentRequest>
  void UpdateInferenceExperimentAsync(const UpdateInferenceExperimentRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMlflowTrackingServerOutcome UpdateMlflowTrackingServer(
      const Model::UpdateMlflowTrackingServerRequest& request) const;

  /**
   * A Callable wrapper for UpdateMlflowTrackingServer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMlflowTrackingServerRequestT = Model::UpdateMlflowTrackingServerRequest>
  Model::UpdateMlflowTrackingServerOutcomeCallable UpdateMlflowTrackingServerCallable(
      const UpdateMlflowTrackingServerRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateMlflowTrackingServer, request);
  }

  /**
   * An Async wrapper for UpdateMlflowTrackingServer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMlflowTrackingServerRequestT = Model::UpdateMlflowTrackingServerRequest>
  void UpdateMlflowTrackingServerAsync(const UpdateMlflowTrackingServerRequestT& request,
                                       const UpdateMlflowTrackingServerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateModelCard that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateModelCardRequestT = Model::UpdateModelCardRequest>
  void UpdateModelCardAsync(const UpdateModelCardRequestT& request, const UpdateModelCardResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateModelPackage that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateModelPackage that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateModelPackageRequestT = Model::UpdateModelPackageRequest>
  void UpdateModelPackageAsync(const UpdateModelPackageRequestT& request, const UpdateModelPackageResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMonitoringAlert that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMonitoringAlert that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMonitoringAlertRequestT = Model::UpdateMonitoringAlertRequest>
  void UpdateMonitoringAlertAsync(const UpdateMonitoringAlertRequestT& request, const UpdateMonitoringAlertResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMonitoringSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMonitoringSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMonitoringScheduleRequestT = Model::UpdateMonitoringScheduleRequest>
  void UpdateMonitoringScheduleAsync(const UpdateMonitoringScheduleRequestT& request,
                                     const UpdateMonitoringScheduleResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateNotebookInstance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateNotebookInstance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNotebookInstanceRequestT = Model::UpdateNotebookInstanceRequest>
  void UpdateNotebookInstanceAsync(const UpdateNotebookInstanceRequestT& request,
                                   const UpdateNotebookInstanceResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateNotebookInstanceLifecycleConfigOutcome UpdateNotebookInstanceLifecycleConfig(
      const Model::UpdateNotebookInstanceLifecycleConfigRequest& request) const;

  /**
   * A Callable wrapper for UpdateNotebookInstanceLifecycleConfig that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateNotebookInstanceLifecycleConfigRequestT = Model::UpdateNotebookInstanceLifecycleConfigRequest>
  Model::UpdateNotebookInstanceLifecycleConfigOutcomeCallable UpdateNotebookInstanceLifecycleConfigCallable(
      const UpdateNotebookInstanceLifecycleConfigRequestT& request) const {
    return SubmitCallable(&SageMakerClient::UpdateNotebookInstanceLifecycleConfig, request);
  }

  /**
   * An Async wrapper for UpdateNotebookInstanceLifecycleConfig that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateNotebookInstanceLifecycleConfigRequestT = Model::UpdateNotebookInstanceLifecycleConfigRequest>
  void UpdateNotebookInstanceLifecycleConfigAsync(const UpdateNotebookInstanceLifecycleConfigRequestT& request,
                                                  const UpdateNotebookInstanceLifecycleConfigResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePartnerApp that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePartnerApp that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePartnerAppRequestT = Model::UpdatePartnerAppRequest>
  void UpdatePartnerAppAsync(const UpdatePartnerAppRequestT& request, const UpdatePartnerAppResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePipelineExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePipelineExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePipelineExecutionRequestT = Model::UpdatePipelineExecutionRequest>
  void UpdatePipelineExecutionAsync(const UpdatePipelineExecutionRequestT& request,
                                    const UpdatePipelineExecutionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePipelineVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePipelineVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePipelineVersionRequestT = Model::UpdatePipelineVersionRequest>
  void UpdatePipelineVersionAsync(const UpdatePipelineVersionRequestT& request, const UpdatePipelineVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTrainingJob that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTrainingJob that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateTrainingJobRequestT = Model::UpdateTrainingJobRequest>
  void UpdateTrainingJobAsync(const UpdateTrainingJobRequestT& request, const UpdateTrainingJobResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTrial that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTrialRequestT = Model::UpdateTrialRequest>
  void UpdateTrialAsync(const UpdateTrialRequestT& request, const UpdateTrialResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateTrialComponent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateTrialComponent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateTrialComponentRequestT = Model::UpdateTrialComponentRequest>
  void UpdateTrialComponentAsync(const UpdateTrialComponentRequestT& request, const UpdateTrialComponentResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateUserProfile that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateUserProfile that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateUserProfileRequestT = Model::UpdateUserProfileRequest>
  void UpdateUserProfileAsync(const UpdateUserProfileRequestT& request, const UpdateUserProfileResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWorkforce that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWorkforceRequestT = Model::UpdateWorkforceRequest>
  void UpdateWorkforceAsync(const UpdateWorkforceRequestT& request, const UpdateWorkforceResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateWorkteam that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateWorkteamRequestT = Model::UpdateWorkteamRequest>
  void UpdateWorkteamAsync(const UpdateWorkteamRequestT& request, const UpdateWorkteamResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
