...
BatchDescribeModelPackageResult::BatchDescribeModelPackageResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
BatchDescribeModelPackageResult& BatchDescribeModelPackageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("BatchDescribeModelPackageErrorMap")) {
    Aws::Map<Aws::String, JsonView> batchDescribeModelPackageErrorMapJsonMap =
        jsonValue.GetObject("BatchDescribeModelPackageErrorMap").GetAllObjects();
    for (auto& batchDescribeModelPackageErrorMapItem : batchDescribeModelPackageErrorMapJsonMap) {
      m_batchDescribeModelPackageErrorMap[batchDescribeModelPackageErrorMapItem.first] =
          batchDescribeModelPackageErrorMapItem.second.AsObject();
    }
