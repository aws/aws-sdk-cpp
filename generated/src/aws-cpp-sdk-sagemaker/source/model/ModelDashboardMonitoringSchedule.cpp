...
ModelDashboardMonitoringSchedule::ModelDashboardMonitoringSchedule(JsonView jsonValue) { *this = jsonValue; }
...
ModelDashboardMonitoringSchedule& ModelDashboardMonitoringSchedule::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MonitoringAlertSummaries")) {
    ...
    for (unsigned monitoringAlertSummariesIndex = 0; monitoringAlertSummariesIndex < monitoringAlertSummariesJsonList.GetLength();
         ++monitoringAlertSummariesIndex) {
...
JsonValue ModelDashboardMonitoringSchedule::Jsonize() const {
  ...
  if (m_monitoringAlertSummariesHasBeenSet) {
    ...
    for (unsigned monitoringAlertSummariesIndex = 0; monitoringAlertSummariesIndex < monitoringAlertSummariesJsonList.GetLength();
         ++monitoringAlertSummariesIndex) {
      monitoringAlertSummariesJsonList[monitoringAlertSummariesIndex].AsObject(
          m_monitoringAlertSummaries[monitoringAlertSummariesIndex].Jsonize());
    }
