...
HubContent::HubContent(JsonView jsonValue) { *this = jsonValue; }

HubContent& HubContent::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("HubContentDependencies")) {
    ...
    for (unsigned hubContentDependenciesIndex = 0; hubContentDependenciesIndex < hubContentDependenciesJsonList.GetLength();
         ++hubContentDependenciesIndex) {
...
JsonValue HubContent::Jsonize() const {
  JsonValue payload;
  ...
  if (m_referenceMinVersionHasBeenSet) {
    payload.WithString("ReferenceMinVersion", m_referenceMinVersion);
  }
  ...
  if (m_hubContentDependenciesHasBeenSet) {
    Aws::Utils::Array<JsonValue> hubContentDependenciesJsonList(m_hubContentDependencies.size());
    for (unsigned hubContentDependenciesIndex = 0; hubContentDependenciesIndex < hubContentDependenciesJsonList.GetLength();
         ++hubContentDependenciesIndex) {
      hubContentDependenciesJsonList[hubContentDependenciesIndex].AsObject(m_hubContentDependencies[hubContentDependenciesIndex].Jsonize());
    }
    payload.WithArray("HubContentDependencies", std::move(hubContentDependenciesJsonList));
  }
