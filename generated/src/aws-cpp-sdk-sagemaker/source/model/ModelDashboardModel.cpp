...
ModelDashboardModel::ModelDashboardModel(JsonView jsonValue) { *this = jsonValue; }
...
ModelDashboardModel& ModelDashboardModel::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MonitoringSchedules")) {
    ...
    for (unsigned monitoringSchedulesIndex = 0; monitoringSchedulesIndex < monitoringSchedulesJsonList.GetLength();
         ++monitoringSchedulesIndex) {
