...
AIAdapterSource::AIAdapterSource(JsonView jsonValue) { *this = jsonValue; }

AIAdapterSource& AIAdapterSource::operator=(JsonView jsonValue) {
...
JsonValue AIAdapterSource::Jsonize() const {
  JsonValue payload;
