...
DomainSettings::DomainSettings(JsonView jsonValue) { *this = jsonValue; }
...
DomainSettings& DomainSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExecutionRoleIdentityConfig")) {
    m_executionRoleIdentityConfig =
        ExecutionRoleIdentityConfigMapper::GetExecutionRoleIdentityConfigForName(jsonValue.GetString("ExecutionRoleIdentityConfig"));
...
JsonValue DomainSettings::Jsonize() const {
  ...
  if (m_executionRoleIdentityConfigHasBeenSet) {
    payload.WithString("ExecutionRoleIdentityConfig",
                       ExecutionRoleIdentityConfigMapper::GetNameForExecutionRoleIdentityConfig(m_executionRoleIdentityConfig));
  }
