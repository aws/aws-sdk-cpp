...
CreateEdgeDeploymentPlanResult::CreateEdgeDeploymentPlanResult()
{
}

CreateEdgeDeploymentPlanResult::CreateEdgeDeploymentPlanResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
