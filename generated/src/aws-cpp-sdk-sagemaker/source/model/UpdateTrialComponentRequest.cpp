...
Aws::String UpdateTrialComponentRequest::SerializePayload() const {
  ...
  if (m_parametersToRemoveHasBeenSet) {
    ...
    for (unsigned parametersToRemoveIndex = 0; parametersToRemoveIndex < parametersToRemoveJsonList.GetLength();
         ++parametersToRemoveIndex) {
  ...
  if (m_inputArtifactsToRemoveHasBeenSet) {
    ...
    for (unsigned inputArtifactsToRemoveIndex = 0; inputArtifactsToRemoveIndex < inputArtifactsToRemoveJsonList.GetLength();
         ++inputArtifactsToRemoveIndex) {
  ...
  if (m_outputArtifactsToRemoveHasBeenSet) {
    ...
    for (unsigned outputArtifactsToRemoveIndex = 0; outputArtifactsToRemoveIndex < outputArtifactsToRemoveJsonList.GetLength();
         ++outputArtifactsToRemoveIndex) {
