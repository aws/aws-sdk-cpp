  ...
  namespace SageMaker
  {
    namespace Model
    {
      namespace AppInstanceTypeMapper
      {
        ...
        static constexpr uint32_t ml_t3_micro_HASH = ConstExprHashingUtils::HashString("ml.t3.micro");
        static constexpr uint32_t ml_t3_small_HASH = ConstExprHashingUtils::HashString("ml.t3.small");
        static constexpr uint32_t ml_t3_medium_HASH = ConstExprHashingUtils::HashString("ml.t3.medium");
        static constexpr uint32_t ml_t3_large_HASH = ConstExprHashingUtils::HashString("ml.t3.large");
        static constexpr uint32_t ml_t3_xlarge_HASH = ConstExprHashingUtils::HashString("ml.t3.xlarge");
        static constexpr uint32_t ml_t3_2xlarge_HASH = ConstExprHashingUtils::HashString("ml.t3.2xlarge");
        ...
        static constexpr uint32_t ml_m5_8xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5.8xlarge");
        static constexpr uint32_t ml_m5_12xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5.12xlarge");
        static constexpr uint32_t ml_m5_16xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5.16xlarge");
        ...
        static constexpr uint32_t ml_m5d_8xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5d.8xlarge");
        static constexpr uint32_t ml_m5d_12xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5d.12xlarge");
        static constexpr uint32_t ml_m5d_16xlarge_HASH = ConstExprHashingUtils::HashString("ml.m5d.16xlarge");
        ...
        static constexpr uint32_t ml_c5_12xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5.12xlarge");
        static constexpr uint32_t ml_c5_18xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5.18xlarge");
        static constexpr uint32_t ml_c5_24xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5.24xlarge");
        ...
        static constexpr uint32_t ml_p3dn_24xlarge_HASH = ConstExprHashingUtils::HashString("ml.p3dn.24xlarge");
        ...
        static constexpr uint32_t ml_r5_8xlarge_HASH = ConstExprHashingUtils::HashString("ml.r5.8xlarge");
        static constexpr uint32_t ml_r5_12xlarge_HASH = ConstExprHashingUtils::HashString("ml.r5.12xlarge");
        static constexpr uint32_t ml_r5_16xlarge_HASH = ConstExprHashingUtils::HashString("ml.r5.16xlarge");
        ...
        static constexpr uint32_t ml_geospatial_interactive_HASH = ConstExprHashingUtils::HashString("ml.geospatial.interactive");
