...
Aws::String BatchReplaceClusterNodesRequest::SerializePayload() const {
  JsonValue payload;
...
Aws::Http::HeaderValueCollection BatchReplaceClusterNodesRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.BatchReplaceClusterNodes"));
  return headers;
}
