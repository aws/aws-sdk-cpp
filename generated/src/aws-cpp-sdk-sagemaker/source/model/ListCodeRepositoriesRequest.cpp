...
ListCodeRepositoriesRequest::ListCodeRepositoriesRequest() : 
    ...
    m_sortBy(CodeRepositorySortBy::NOT_SET),
    m_sortByHasBeenSet(false),
    m_sortOrder(CodeRepositorySortOrder::NOT_SET),
    m_sortOrderHasBeenSet(false)
{
}

Aws::String ListCodeRepositoriesRequest::SerializePayload() const
{
  JsonValue payload;
  ...
  {
   payload.WithString("SortOrder", CodeRepositorySortOrderMapper::GetNameForCodeRepositorySortOrder(m_sortOrder));
  }

  return payload.View().WriteReadable();
}

Aws::Http::HeaderValueCollection ListCodeRepositoriesRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.ListCodeRepositories"));
  return headers;
