...
ListInferenceRecommendationsJobsResult& ListInferenceRecommendationsJobsResult::operator=(
  ...
  if (jsonValue.ValueExists("InferenceRecommendationsJobs")) {
    ...
    for (unsigned inferenceRecommendationsJobsIndex = 0;
         inferenceRecommendationsJobsIndex < inferenceRecommendationsJobsJsonList.GetLength(); ++inferenceRecommendationsJobsIndex) {
      m_inferenceRecommendationsJobs.push_back(inferenceRecommendationsJobsJsonList[inferenceRecommendationsJobsIndex].AsObject());
    }
    m_inferenceRecommendationsJobsHasBeenSet = true;
  }
