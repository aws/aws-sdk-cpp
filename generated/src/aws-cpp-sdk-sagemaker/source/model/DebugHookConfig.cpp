...
DebugHookConfig::DebugHookConfig(JsonView jsonValue) { *this = jsonValue; }
...
DebugHookConfig& DebugHookConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CollectionConfigurations")) {
    ...
    for (unsigned collectionConfigurationsIndex = 0; collectionConfigurationsIndex < collectionConfigurationsJsonList.GetLength();
         ++collectionConfigurationsIndex) {
...
JsonValue DebugHookConfig::Jsonize() const {
  ...
  if (m_collectionConfigurationsHasBeenSet) {
    ...
    for (unsigned collectionConfigurationsIndex = 0; collectionConfigurationsIndex < collectionConfigurationsJsonList.GetLength();
         ++collectionConfigurationsIndex) {
      collectionConfigurationsJsonList[collectionConfigurationsIndex].AsObject(
          m_collectionConfigurations[collectionConfigurationsIndex].Jsonize());
    }
