...
DeviceDeploymentSummary::DeviceDeploymentSummary(JsonView jsonValue) { *this = jsonValue; }
...
DeviceDeploymentSummary& DeviceDeploymentSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DeviceDeploymentStatus")) {
    m_deviceDeploymentStatus =
        DeviceDeploymentStatusMapper::GetDeviceDeploymentStatusForName(jsonValue.GetString("DeviceDeploymentStatus"));
