...
ListModelPackageGroupsResult::ListModelPackageGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelPackageGroupsResult& ListModelPackageGroupsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ModelPackageGroupSummaryList")) {
    ...
    for (unsigned modelPackageGroupSummaryListIndex = 0;
         modelPackageGroupSummaryListIndex < modelPackageGroupSummaryListJsonList.GetLength(); ++modelPackageGroupSummaryListIndex) {
