...
DescribeTrainingJobResult::DescribeTrainingJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeTrainingJobResult& DescribeTrainingJobResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FinalMetricDataList")) {
    ...
    for (unsigned finalMetricDataListIndex = 0; finalMetricDataListIndex < finalMetricDataListJsonList.GetLength();
         ++finalMetricDataListIndex) {
  ...
  if (jsonValue.ValueExists("DebugRuleConfigurations")) {
    ...
    for (unsigned debugRuleConfigurationsIndex = 0; debugRuleConfigurationsIndex < debugRuleConfigurationsJsonList.GetLength();
         ++debugRuleConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("DebugRuleEvaluationStatuses")) {
    ...
    for (unsigned debugRuleEvaluationStatusesIndex = 0; debugRuleEvaluationStatusesIndex < debugRuleEvaluationStatusesJsonList.GetLength();
         ++debugRuleEvaluationStatusesIndex) {
  ...
  if (jsonValue.ValueExists("ProfilerRuleConfigurations")) {
    ...
    for (unsigned profilerRuleConfigurationsIndex = 0; profilerRuleConfigurationsIndex < profilerRuleConfigurationsJsonList.GetLength();
         ++profilerRuleConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("ProfilerRuleEvaluationStatuses")) {
    ...
    for (unsigned profilerRuleEvaluationStatusesIndex = 0;
         profilerRuleEvaluationStatusesIndex < profilerRuleEvaluationStatusesJsonList.GetLength(); ++profilerRuleEvaluationStatusesIndex) {
