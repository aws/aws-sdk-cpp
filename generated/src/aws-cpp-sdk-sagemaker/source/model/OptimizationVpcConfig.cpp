...
OptimizationVpcConfig::OptimizationVpcConfig(JsonView jsonValue) { *this = jsonValue; }

OptimizationVpcConfig& OptimizationVpcConfig::operator=(JsonView jsonValue) {
...
JsonValue OptimizationVpcConfig::Jsonize() const {
  JsonValue payload;
