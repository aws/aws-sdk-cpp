...
HyperParameterTuningJobSearchEntity::HyperParameterTuningJobSearchEntity(JsonView jsonValue) { *this = jsonValue; }
...
HyperParameterTuningJobSearchEntity& HyperParameterTuningJobSearchEntity::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TrainingJobDefinitions")) {
    ...
    for (unsigned trainingJobDefinitionsIndex = 0; trainingJobDefinitionsIndex < trainingJobDefinitionsJsonList.GetLength();
         ++trainingJobDefinitionsIndex) {
