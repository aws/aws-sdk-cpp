...
Aws::String CreateClusterRequest::SerializePayload() const {
  ...
  if (m_restrictedInstanceGroupsHasBeenSet) {
    ...
    for (unsigned restrictedInstanceGroupsIndex = 0; restrictedInstanceGroupsIndex < restrictedInstanceGroupsJsonList.GetLength();
         ++restrictedInstanceGroupsIndex) {
      restrictedInstanceGroupsJsonList[restrictedInstanceGroupsIndex].AsObject(
          m_restrictedInstanceGroups[restrictedInstanceGroupsIndex].Jsonize());
    }
