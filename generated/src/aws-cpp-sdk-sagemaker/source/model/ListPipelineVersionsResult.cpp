...
ListPipelineVersionsResult::ListPipelineVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListPipelineVersionsResult& ListPipelineVersionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("PipelineVersionSummaries")) {
    ...
    for (unsigned pipelineVersionSummariesIndex = 0; pipelineVersionSummariesIndex < pipelineVersionSummariesJsonList.GetLength();
         ++pipelineVersionSummariesIndex) {
