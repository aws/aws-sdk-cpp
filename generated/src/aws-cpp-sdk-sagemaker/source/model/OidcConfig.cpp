...
OidcConfig::OidcConfig(JsonView jsonValue) { *this = jsonValue; }
...
OidcConfig& OidcConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AuthenticationRequestExtraParams")) {
    Aws::Map<Aws::String, JsonView> authenticationRequestExtraParamsJsonMap =
        jsonValue.GetObject("AuthenticationRequestExtraParams").GetAllObjects();
    for (auto& authenticationRequestExtraParamsItem : authenticationRequestExtraParamsJsonMap) {
      m_authenticationRequestExtraParams[authenticationRequestExtraParamsItem.first] =
          authenticationRequestExtraParamsItem.second.AsString();
    }
...
JsonValue OidcConfig::Jsonize() const {
  ...
  if (m_authenticationRequestExtraParamsHasBeenSet) {
    ...
    for (auto& authenticationRequestExtraParamsItem : m_authenticationRequestExtraParams) {
      authenticationRequestExtraParamsJsonMap.WithString(authenticationRequestExtraParamsItem.first,
                                                         authenticationRequestExtraParamsItem.second);
    }
