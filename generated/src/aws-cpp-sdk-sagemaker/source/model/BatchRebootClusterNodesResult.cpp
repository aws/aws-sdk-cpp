...
BatchRebootClusterNodesResult::BatchRebootClusterNodesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchRebootClusterNodesResult& BatchRebootClusterNodesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
