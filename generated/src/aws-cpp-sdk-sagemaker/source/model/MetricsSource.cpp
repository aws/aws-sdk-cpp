...
MetricsSource::MetricsSource(JsonView jsonValue) { *this = jsonValue; }

MetricsSource& MetricsSource::operator=(JsonView jsonValue) {
...
JsonValue MetricsSource::Jsonize() const {
  JsonValue payload;
