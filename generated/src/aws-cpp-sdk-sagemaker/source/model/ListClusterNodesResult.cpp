...
ListClusterNodesResult::ListClusterNodesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListClusterNodesResult& ListClusterNodesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ClusterNodeSummaries")) {
    ...
    for (unsigned clusterNodeSummariesIndex = 0; clusterNodeSummariesIndex < clusterNodeSummariesJsonList.GetLength();
         ++clusterNodeSummariesIndex) {
