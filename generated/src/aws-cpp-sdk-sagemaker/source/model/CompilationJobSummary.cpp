...
CompilationJobSummary::CompilationJobSummary(JsonView jsonValue) { *this = jsonValue; }
...
CompilationJobSummary& CompilationJobSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CompilationTargetPlatformArch")) {
    m_compilationTargetPlatformArch =
        TargetPlatformArchMapper::GetTargetPlatformArchForName(jsonValue.GetString("CompilationTargetPlatformArch"));
    m_compilationTargetPlatformArchHasBeenSet = true;
  }
  if (jsonValue.ValueExists("CompilationTargetPlatformAccelerator")) {
    m_compilationTargetPlatformAccelerator =
        TargetPlatformAcceleratorMapper::GetTargetPlatformAcceleratorForName(jsonValue.GetString("CompilationTargetPlatformAccelerator"));
...
JsonValue CompilationJobSummary::Jsonize() const {
  ...
  if (m_compilationTargetPlatformArchHasBeenSet) {
    payload.WithString("CompilationTargetPlatformArch",
                       TargetPlatformArchMapper::GetNameForTargetPlatformArch(m_compilationTargetPlatformArch));
  }

  if (m_compilationTargetPlatformAcceleratorHasBeenSet) {
    payload.WithString("CompilationTargetPlatformAccelerator",
                       TargetPlatformAcceleratorMapper::GetNameForTargetPlatformAccelerator(m_compilationTargetPlatformAccelerator));
  }
