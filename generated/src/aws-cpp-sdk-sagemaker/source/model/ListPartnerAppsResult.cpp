...
ListPartnerAppsResult::ListPartnerAppsResult()
{
}

ListPartnerAppsResult::ListPartnerAppsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListPartnerAppsResult& ListPartnerAppsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
