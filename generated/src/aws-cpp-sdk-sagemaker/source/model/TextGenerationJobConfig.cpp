...
TextGenerationJobConfig::TextGenerationJobConfig(JsonView jsonValue) { *this = jsonValue; }
...
TextGenerationJobConfig& TextGenerationJobConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TextGenerationHyperParameters")) {
    Aws::Map<Aws::String, JsonView> textGenerationHyperParametersJsonMap =
        jsonValue.GetObject("TextGenerationHyperParameters").GetAllObjects();
