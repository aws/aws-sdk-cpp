...
ListDataQualityJobDefinitionsResult::ListDataQualityJobDefinitionsResult()
{
}

ListDataQualityJobDefinitionsResult::ListDataQualityJobDefinitionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListDataQualityJobDefinitionsResult& ListDataQualityJobDefinitionsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
