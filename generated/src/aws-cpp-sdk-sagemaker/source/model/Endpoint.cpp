...
Endpoint& Endpoint::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ProductionVariants")) {
    ...
    for (unsigned productionVariantsIndex = 0; productionVariantsIndex < productionVariantsJsonList.GetLength();
         ++productionVariantsIndex) {
  ...
  if (jsonValue.ValueExists("ShadowProductionVariants")) {
    ...
    for (unsigned shadowProductionVariantsIndex = 0; shadowProductionVariantsIndex < shadowProductionVariantsJsonList.GetLength();
         ++shadowProductionVariantsIndex) {
...
JsonValue Endpoint::Jsonize() const {
  ...
  if (m_shadowProductionVariantsHasBeenSet) {
    ...
    for (unsigned shadowProductionVariantsIndex = 0; shadowProductionVariantsIndex < shadowProductionVariantsJsonList.GetLength();
         ++shadowProductionVariantsIndex) {
      shadowProductionVariantsJsonList[shadowProductionVariantsIndex].AsObject(
          m_shadowProductionVariants[shadowProductionVariantsIndex].Jsonize());
    }
