...
ListTrainingJobsForHyperParameterTuningJobResult& ListTrainingJobsForHyperParameterTuningJobResult::operator=(
  ...
  if (jsonValue.ValueExists("TrainingJobSummaries")) {
    ...
    for (unsigned trainingJobSummariesIndex = 0; trainingJobSummariesIndex < trainingJobSummariesJsonList.GetLength();
         ++trainingJobSummariesIndex) {
      m_trainingJobSummaries.push_back(trainingJobSummariesJsonList[trainingJobSummariesIndex].AsObject());
    }
    m_trainingJobSummariesHasBeenSet = true;
  }
