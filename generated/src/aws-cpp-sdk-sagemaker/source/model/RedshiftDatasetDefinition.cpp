...
RedshiftDatasetDefinition::RedshiftDatasetDefinition(JsonView jsonValue) { *this = jsonValue; }
...
RedshiftDatasetDefinition& RedshiftDatasetDefinition::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("OutputCompression")) {
    m_outputCompression =
        RedshiftResultCompressionTypeMapper::GetRedshiftResultCompressionTypeForName(jsonValue.GetString("OutputCompression"));
...
JsonValue RedshiftDatasetDefinition::Jsonize() const {
  ...
  if (m_outputCompressionHasBeenSet) {
    payload.WithString("OutputCompression",
                       RedshiftResultCompressionTypeMapper::GetNameForRedshiftResultCompressionType(m_outputCompression));
  }
