...
ListHubContentsResult::ListHubContentsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListHubContentsResult& ListHubContentsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("HubContentSummaries")) {
    ...
    for (unsigned hubContentSummariesIndex = 0; hubContentSummariesIndex < hubContentSummariesJsonList.GetLength();
         ++hubContentSummariesIndex) {
      m_hubContentSummaries.push_back(hubContentSummariesJsonList[hubContentSummariesIndex].AsObject());
    }
    m_hubContentSummariesHasBeenSet = true;
  }
