...
AttachClusterNodeVolumeResult::AttachClusterNodeVolumeResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

AttachClusterNodeVolumeResult& AttachClusterNodeVolumeResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
