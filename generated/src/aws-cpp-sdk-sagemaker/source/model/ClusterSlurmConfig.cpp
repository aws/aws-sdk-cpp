...
ClusterSlurmConfig::ClusterSlurmConfig(JsonView jsonValue) { *this = jsonValue; }

ClusterSlurmConfig& ClusterSlurmConfig::operator=(JsonView jsonValue) {
...
JsonValue ClusterSlurmConfig::Jsonize() const {
  JsonValue payload;
