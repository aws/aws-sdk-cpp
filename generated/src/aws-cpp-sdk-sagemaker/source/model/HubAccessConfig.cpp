...
HubAccessConfig::HubAccessConfig(JsonView jsonValue) { *this = jsonValue; }

HubAccessConfig& HubAccessConfig::operator=(JsonView jsonValue) {
...
JsonValue HubAccessConfig::Jsonize() const {
  JsonValue payload;
