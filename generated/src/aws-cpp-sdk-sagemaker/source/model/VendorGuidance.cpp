  ...
  namespace SageMaker
  {
    namespace Model
    {
      namespace VendorGuidanceMapper
      {
        ...
        static constexpr uint32_t NOT_PROVIDED_HASH = ConstExprHashingUtils::HashString("NOT_PROVIDED");
        static constexpr uint32_t STABLE_HASH = ConstExprHashingUtils::HashString("STABLE");
        static constexpr uint32_t TO_BE_ARCHIVED_HASH = ConstExprHashingUtils::HashString("TO_BE_ARCHIVED");
