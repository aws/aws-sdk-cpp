...
ModelDashboardModelCard::ModelDashboardModelCard(JsonView jsonValue) { *this = jsonValue; }

ModelDashboardModelCard& ModelDashboardModelCard::operator=(JsonView jsonValue) {
...
JsonValue ModelDashboardModelCard::Jsonize() const {
  JsonValue payload;
