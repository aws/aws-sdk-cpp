...
ProcessingInstancePreference::ProcessingInstancePreference(JsonView jsonValue) { *this = jsonValue; }

ProcessingInstancePreference& ProcessingInstancePreference::operator=(JsonView jsonValue) {
...
JsonValue ProcessingInstancePreference::Jsonize() const {
  JsonValue payload;
