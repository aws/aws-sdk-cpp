...
ListContextsResult::ListContextsResult()
{
}

ListContextsResult::ListContextsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListContextsResult& ListContextsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
