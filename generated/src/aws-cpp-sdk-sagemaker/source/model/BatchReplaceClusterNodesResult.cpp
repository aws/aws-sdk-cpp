...
BatchReplaceClusterNodesResult::BatchReplaceClusterNodesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

BatchReplaceClusterNodesResult& BatchReplaceClusterNodesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("FailedNodeLogicalIds")) {
    ...
    for (unsigned failedNodeLogicalIdsIndex = 0; failedNodeLogicalIdsIndex < failedNodeLogicalIdsJsonList.GetLength();
         ++failedNodeLogicalIdsIndex) {
  ...
  if (jsonValue.ValueExists("SuccessfulNodeLogicalIds")) {
    ...
    for (unsigned successfulNodeLogicalIdsIndex = 0; successfulNodeLogicalIdsIndex < successfulNodeLogicalIdsJsonList.GetLength();
         ++successfulNodeLogicalIdsIndex) {
