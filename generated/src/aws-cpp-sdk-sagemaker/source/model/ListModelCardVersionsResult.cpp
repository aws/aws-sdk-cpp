...
ListModelCardVersionsResult::ListModelCardVersionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelCardVersionsResult& ListModelCardVersionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ModelCardVersionSummaryList")) {
    ...
    for (unsigned modelCardVersionSummaryListIndex = 0; modelCardVersionSummaryListIndex < modelCardVersionSummaryListJsonList.GetLength();
         ++modelCardVersionSummaryListIndex) {
      m_modelCardVersionSummaryList.push_back(modelCardVersionSummaryListJsonList[modelCardVersionSummaryListIndex].AsObject());
    }
    m_modelCardVersionSummaryListHasBeenSet = true;
  }
