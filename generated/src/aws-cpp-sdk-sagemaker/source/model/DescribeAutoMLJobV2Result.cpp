...
DescribeAutoMLJobV2Result::DescribeAutoMLJobV2Result(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeAutoMLJobV2Result& DescribeAutoMLJobV2Result::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("AutoMLJobInputDataConfig")) {
    ...
    for (unsigned autoMLJobInputDataConfigIndex = 0; autoMLJobInputDataConfigIndex < autoMLJobInputDataConfigJsonList.GetLength();
         ++autoMLJobInputDataConfigIndex) {
  ...
  if (jsonValue.ValueExists("AutoMLProblemTypeConfigName")) {
    m_autoMLProblemTypeConfigName =
        AutoMLProblemTypeConfigNameMapper::GetAutoMLProblemTypeConfigNameForName(jsonValue.GetString("AutoMLProblemTypeConfigName"));
