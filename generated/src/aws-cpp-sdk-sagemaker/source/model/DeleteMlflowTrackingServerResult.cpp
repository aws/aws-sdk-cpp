...
DeleteMlflowTrackingServerResult::DeleteMlflowTrackingServerResult()
{
}

DeleteMlflowTrackingServerResult::DeleteMlflowTrackingServerResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
