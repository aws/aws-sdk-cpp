...
Aws::String UpdateEndpointWeightsAndCapacitiesRequest::SerializePayload() const {
  ...
  if (m_desiredWeightsAndCapacitiesHasBeenSet) {
    ...
    for (unsigned desiredWeightsAndCapacitiesIndex = 0; desiredWeightsAndCapacitiesIndex < desiredWeightsAndCapacitiesJsonList.GetLength();
         ++desiredWeightsAndCapacitiesIndex) {
      desiredWeightsAndCapacitiesJsonList[desiredWeightsAndCapacitiesIndex].AsObject(
          m_desiredWeightsAndCapacities[desiredWeightsAndCapacitiesIndex].Jsonize());
    }
