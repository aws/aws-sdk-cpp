...
Trial::Trial(JsonView jsonValue) { *this = jsonValue; }
...
Trial& Trial::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TrialComponentSummaries")) {
    ...
    for (unsigned trialComponentSummariesIndex = 0; trialComponentSummariesIndex < trialComponentSummariesJsonList.GetLength();
         ++trialComponentSummariesIndex) {
...
JsonValue Trial::Jsonize() const {
  ...
  if (m_trialComponentSummariesHasBeenSet) {
    ...
    for (unsigned trialComponentSummariesIndex = 0; trialComponentSummariesIndex < trialComponentSummariesJsonList.GetLength();
         ++trialComponentSummariesIndex) {
      trialComponentSummariesJsonList[trialComponentSummariesIndex].AsObject(
          m_trialComponentSummaries[trialComponentSummariesIndex].Jsonize());
    }
