...
FeatureGroup::FeatureGroup(JsonView jsonValue) { *this = jsonValue; }
...
FeatureGroup& FeatureGroup::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("FeatureDefinitions")) {
    ...
    for (unsigned featureDefinitionsIndex = 0; featureDefinitionsIndex < featureDefinitionsJsonList.GetLength();
         ++featureDefinitionsIndex) {
