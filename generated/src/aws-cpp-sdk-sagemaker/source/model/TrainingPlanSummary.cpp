...
TrainingPlanSummary::TrainingPlanSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue TrainingPlanSummary::Jsonize() const {
  ...
  if (m_reservedCapacitySummariesHasBeenSet) {
    ...
    for (unsigned reservedCapacitySummariesIndex = 0; reservedCapacitySummariesIndex < reservedCapacitySummariesJsonList.GetLength();
         ++reservedCapacitySummariesIndex) {
      reservedCapacitySummariesJsonList[reservedCapacitySummariesIndex].AsObject(
          m_reservedCapacitySummaries[reservedCapacitySummariesIndex].Jsonize());
    }
