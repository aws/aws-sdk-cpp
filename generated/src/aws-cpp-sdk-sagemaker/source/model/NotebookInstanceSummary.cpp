...
NotebookInstanceSummary::NotebookInstanceSummary(JsonView jsonValue) { *this = jsonValue; }
...
NotebookInstanceSummary& NotebookInstanceSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("NotebookInstanceStatus")) {
    m_notebookInstanceStatus =
        NotebookInstanceStatusMapper::GetNotebookInstanceStatusForName(jsonValue.GetString("NotebookInstanceStatus"));
  ...
  if (jsonValue.ValueExists("AdditionalCodeRepositories")) {
    ...
    for (unsigned additionalCodeRepositoriesIndex = 0; additionalCodeRepositoriesIndex < additionalCodeRepositoriesJsonList.GetLength();
         ++additionalCodeRepositoriesIndex) {
...
JsonValue NotebookInstanceSummary::Jsonize() const {
  ...
  if (m_additionalCodeRepositoriesHasBeenSet) {
    ...
    for (unsigned additionalCodeRepositoriesIndex = 0; additionalCodeRepositoriesIndex < additionalCodeRepositoriesJsonList.GetLength();
         ++additionalCodeRepositoriesIndex) {
      additionalCodeRepositoriesJsonList[additionalCodeRepositoriesIndex].AsString(
          m_additionalCodeRepositories[additionalCodeRepositoriesIndex]);
    }
