...
DescribeEdgePackagingJobResult::DescribeEdgePackagingJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeEdgePackagingJobResult& DescribeEdgePackagingJobResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EdgePackagingJobStatus")) {
    m_edgePackagingJobStatus =
        EdgePackagingJobStatusMapper::GetEdgePackagingJobStatusForName(jsonValue.GetString("EdgePackagingJobStatus"));
