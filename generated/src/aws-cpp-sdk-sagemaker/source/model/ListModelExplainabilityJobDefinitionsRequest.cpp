...
Aws::String ListModelExplainabilityJobDefinitionsRequest::SerializePayload() const
{
  JsonValue payload;
...
Aws::Http::HeaderValueCollection ListModelExplainabilityJobDefinitionsRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.ListModelExplainabilityJobDefinitions"));
  return headers;
