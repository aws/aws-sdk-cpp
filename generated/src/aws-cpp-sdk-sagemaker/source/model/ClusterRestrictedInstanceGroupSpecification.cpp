...
ClusterRestrictedInstanceGroupSpecification::ClusterRestrictedInstanceGroupSpecification(JsonView jsonValue) { *this = jsonValue; }

ClusterRestrictedInstanceGroupSpecification& ClusterRestrictedInstanceGroupSpecification::operator=(JsonView jsonValue) {
...
JsonValue ClusterRestrictedInstanceGroupSpecification::Jsonize() const {
  JsonValue payload;
