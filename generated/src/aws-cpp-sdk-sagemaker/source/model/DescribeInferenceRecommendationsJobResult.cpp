...
DescribeInferenceRecommendationsJobResult& DescribeInferenceRecommendationsJobResult::operator=(
  ...
  if (jsonValue.ValueExists("InferenceRecommendations")) {
    ...
    for (unsigned inferenceRecommendationsIndex = 0; inferenceRecommendationsIndex < inferenceRecommendationsJsonList.GetLength();
         ++inferenceRecommendationsIndex) {
  ...
  if (jsonValue.ValueExists("EndpointPerformances")) {
    ...
    for (unsigned endpointPerformancesIndex = 0; endpointPerformancesIndex < endpointPerformancesJsonList.GetLength();
         ++endpointPerformancesIndex) {
