...
ModelQuantizationConfig::ModelQuantizationConfig(JsonView jsonValue) { *this = jsonValue; }

ModelQuantizationConfig& ModelQuantizationConfig::operator=(JsonView jsonValue) {
...
JsonValue ModelQuantizationConfig::Jsonize() const {
  JsonValue payload;
