...
ListModelPackagesResult::ListModelPackagesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListModelPackagesResult& ListModelPackagesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("ModelPackageSummaryList")) {
    ...
    for (unsigned modelPackageSummaryListIndex = 0; modelPackageSummaryListIndex < modelPackageSummaryListJsonList.GetLength();
         ++modelPackageSummaryListIndex) {
