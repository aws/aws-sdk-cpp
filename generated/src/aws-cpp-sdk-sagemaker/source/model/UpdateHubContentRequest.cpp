...
Aws::String UpdateHubContentRequest::SerializePayload() const {
  JsonValue payload;
  ...
  if (m_hubContentSearchKeywordsHasBeenSet) {
    ...
    for (unsigned hubContentSearchKeywordsIndex = 0; hubContentSearchKeywordsIndex < hubContentSearchKeywordsJsonList.GetLength();
         ++hubContentSearchKeywordsIndex) {
...
Aws::Http::HeaderValueCollection UpdateHubContentRequest::GetRequestSpecificHeaders() const {
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "SageMaker.UpdateHubContent"));
  return headers;
}
