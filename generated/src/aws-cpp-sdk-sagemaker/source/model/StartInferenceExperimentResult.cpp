...
StartInferenceExperimentResult::StartInferenceExperimentResult()
{
}

StartInferenceExperimentResult::StartInferenceExperimentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
