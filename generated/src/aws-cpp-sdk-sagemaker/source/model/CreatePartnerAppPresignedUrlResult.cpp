...
CreatePartnerAppPresignedUrlResult::CreatePartnerAppPresignedUrlResult()
{
}

CreatePartnerAppPresignedUrlResult::CreatePartnerAppPresignedUrlResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
