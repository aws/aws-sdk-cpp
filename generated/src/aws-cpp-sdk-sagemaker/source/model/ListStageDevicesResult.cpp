...
ListStageDevicesResult::ListStageDevicesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListStageDevicesResult& ListStageDevicesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("DeviceDeploymentSummaries")) {
    ...
    for (unsigned deviceDeploymentSummariesIndex = 0; deviceDeploymentSummariesIndex < deviceDeploymentSummariesJsonList.GetLength();
         ++deviceDeploymentSummariesIndex) {
      m_deviceDeploymentSummaries.push_back(deviceDeploymentSummariesJsonList[deviceDeploymentSummariesIndex].AsObject());
    }
    m_deviceDeploymentSummariesHasBeenSet = true;
  }
