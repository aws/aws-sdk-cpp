...
RecommendationJobContainerConfig::RecommendationJobContainerConfig(JsonView jsonValue) { *this = jsonValue; }
...
RecommendationJobContainerConfig& RecommendationJobContainerConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("SupportedEndpointType")) {
    m_supportedEndpointType = RecommendationJobSupportedEndpointTypeMapper::GetRecommendationJobSupportedEndpointTypeForName(
        jsonValue.GetString("SupportedEndpointType"));
...
JsonValue RecommendationJobContainerConfig::Jsonize() const {
  ...
  if (m_supportedEndpointTypeHasBeenSet) {
    payload.WithString(
        ...
        RecommendationJobSupportedEndpointTypeMapper::GetNameForRecommendationJobSupportedEndpointType(m_supportedEndpointType));
  }
