...
DescribeTrainingPlanExtensionHistoryResult::DescribeTrainingPlanExtensionHistoryResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

DescribeTrainingPlanExtensionHistoryResult& DescribeTrainingPlanExtensionHistoryResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
