...
ListAliasesResult::ListAliasesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAliasesResult& ListAliasesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("SageMakerImageVersionAliases")) {
    ...
    for (unsigned sageMakerImageVersionAliasesIndex = 0;
         sageMakerImageVersionAliasesIndex < sageMakerImageVersionAliasesJsonList.GetLength(); ++sageMakerImageVersionAliasesIndex) {
