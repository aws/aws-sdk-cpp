...
AlgorithmValidationSpecification::AlgorithmValidationSpecification(JsonView jsonValue) { *this = jsonValue; }
...
AlgorithmValidationSpecification& AlgorithmValidationSpecification::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ValidationProfiles")) {
    ...
    for (unsigned validationProfilesIndex = 0; validationProfilesIndex < validationProfilesJsonList.GetLength();
         ++validationProfilesIndex) {
