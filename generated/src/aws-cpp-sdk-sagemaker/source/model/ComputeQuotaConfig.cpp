...
ComputeQuotaConfig::ComputeQuotaConfig(JsonView jsonValue) { *this = jsonValue; }
...
ComputeQuotaConfig& ComputeQuotaConfig::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ComputeQuotaResources")) {
    ...
    for (unsigned computeQuotaResourcesIndex = 0; computeQuotaResourcesIndex < computeQuotaResourcesJsonList.GetLength();
         ++computeQuotaResourcesIndex) {
