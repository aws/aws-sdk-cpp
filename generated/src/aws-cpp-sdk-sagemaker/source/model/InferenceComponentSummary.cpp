...
InferenceComponentSummary::InferenceComponentSummary(JsonView jsonValue) { *this = jsonValue; }
...
JsonValue InferenceComponentSummary::Jsonize() const {
  ...
  if (m_inferenceComponentStatusHasBeenSet) {
    payload.WithString("InferenceComponentStatus",
                       InferenceComponentStatusMapper::GetNameForInferenceComponentStatus(m_inferenceComponentStatus));
  }
