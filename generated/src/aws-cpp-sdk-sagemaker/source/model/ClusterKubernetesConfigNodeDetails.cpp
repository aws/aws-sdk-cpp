...
ClusterKubernetesConfigNodeDetails::ClusterKubernetesConfigNodeDetails(JsonView jsonValue) { *this = jsonValue; }

ClusterKubernetesConfigNodeDetails& ClusterKubernetesConfigNodeDetails::operator=(JsonView jsonValue) {
...
JsonValue ClusterKubernetesConfigNodeDetails::Jsonize() const {
  JsonValue payload;
