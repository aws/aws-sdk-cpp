...
ClusterRestrictedInstanceGroupsConfigOutput::ClusterRestrictedInstanceGroupsConfigOutput(JsonView jsonValue) { *this = jsonValue; }

ClusterRestrictedInstanceGroupsConfigOutput& ClusterRestrictedInstanceGroupsConfigOutput::operator=(JsonView jsonValue) {
...
JsonValue ClusterRestrictedInstanceGroupsConfigOutput::Jsonize() const {
  JsonValue payload;
