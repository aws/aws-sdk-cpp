...
UpdateCodeRepositoryResult::UpdateCodeRepositoryResult()
{
}

UpdateCodeRepositoryResult::UpdateCodeRepositoryResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
