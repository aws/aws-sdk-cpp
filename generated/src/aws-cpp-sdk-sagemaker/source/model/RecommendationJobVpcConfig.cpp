...
RecommendationJobVpcConfig::RecommendationJobVpcConfig(JsonView jsonValue) { *this = jsonValue; }

RecommendationJobVpcConfig& RecommendationJobVpcConfig::operator=(JsonView jsonValue) {
...
JsonValue RecommendationJobVpcConfig::Jsonize() const {
  JsonValue payload;
