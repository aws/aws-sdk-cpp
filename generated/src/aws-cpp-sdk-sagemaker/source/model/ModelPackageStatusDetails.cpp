...
ModelPackageStatusDetails::ModelPackageStatusDetails(JsonView jsonValue) { *this = jsonValue; }

ModelPackageStatusDetails& ModelPackageStatusDetails::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ValidationStatuses")) {
    ...
    for (unsigned validationStatusesIndex = 0; validationStatusesIndex < validationStatusesJsonList.GetLength();
         ++validationStatusesIndex) {
...
JsonValue ModelPackageStatusDetails::Jsonize() const {
  JsonValue payload;
