...
DockerSettings::DockerSettings(JsonView jsonValue) { *this = jsonValue; }
...
DockerSettings& DockerSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("VpcOnlyTrustedAccounts")) {
    ...
    for (unsigned vpcOnlyTrustedAccountsIndex = 0; vpcOnlyTrustedAccountsIndex < vpcOnlyTrustedAccountsJsonList.GetLength();
         ++vpcOnlyTrustedAccountsIndex) {
