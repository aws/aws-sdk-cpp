...
RecommendationJobStoppingConditions::RecommendationJobStoppingConditions(JsonView jsonValue) { *this = jsonValue; }
...
RecommendationJobStoppingConditions& RecommendationJobStoppingConditions::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ModelLatencyThresholds")) {
    ...
    for (unsigned modelLatencyThresholdsIndex = 0; modelLatencyThresholdsIndex < modelLatencyThresholdsJsonList.GetLength();
         ++modelLatencyThresholdsIndex) {
