...
JupyterLabAppSettings::JupyterLabAppSettings(JsonView jsonValue) { *this = jsonValue; }
...
JupyterLabAppSettings& JupyterLabAppSettings::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LifecycleConfigArns")) {
    ...
    for (unsigned lifecycleConfigArnsIndex = 0; lifecycleConfigArnsIndex < lifecycleConfigArnsJsonList.GetLength();
         ++lifecycleConfigArnsIndex) {
