...
AIRecommendationOutputResult::AIRecommendationOutputResult(JsonView jsonValue) { *this = jsonValue; }

AIRecommendationOutputResult& AIRecommendationOutputResult::operator=(JsonView jsonValue) {
...
JsonValue AIRecommendationOutputResult::Jsonize() const {
  JsonValue payload;
