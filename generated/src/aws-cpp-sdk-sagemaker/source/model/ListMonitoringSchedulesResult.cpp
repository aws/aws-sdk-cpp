...
ListMonitoringSchedulesResult::ListMonitoringSchedulesResult()
{
}

ListMonitoringSchedulesResult::ListMonitoringSchedulesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
