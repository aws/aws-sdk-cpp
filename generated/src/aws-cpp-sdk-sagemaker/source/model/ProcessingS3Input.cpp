...
ProcessingS3Input::ProcessingS3Input(JsonView jsonValue) { *this = jsonValue; }
...
ProcessingS3Input& ProcessingS3Input::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("S3CompressionType")) {
    m_s3CompressionType =
        ProcessingS3CompressionTypeMapper::GetProcessingS3CompressionTypeForName(jsonValue.GetString("S3CompressionType"));
