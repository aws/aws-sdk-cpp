  ...
  namespace SageMaker
  {
    namespace Model
    {
      namespace TrainingInstanceTypeMapper
      {
        ...
        static constexpr uint32_t ml_c5n_xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5n.xlarge");
        static constexpr uint32_t ml_c5n_2xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5n.2xlarge");
        static constexpr uint32_t ml_c5n_4xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5n.4xlarge");
        static constexpr uint32_t ml_c5n_9xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5n.9xlarge");
        static constexpr uint32_t ml_c5n_18xlarge_HASH = ConstExprHashingUtils::HashString("ml.c5n.18xlarge");
        ...
        static constexpr uint32_t ml_trn1n_32xlarge_HASH = ConstExprHashingUtils::HashString("ml.trn1n.32xlarge");
