...
UpdateInferenceComponentResult::UpdateInferenceComponentResult()
{
}

UpdateInferenceComponentResult::UpdateInferenceComponentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
