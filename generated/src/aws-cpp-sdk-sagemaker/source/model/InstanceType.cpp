...
static bool GetEnumForNameHelper0(int hashCode, InstanceType& enumValue) {
  if (hashCode == ml_t2_medium_HASH) {
    ...
    enumValue = InstanceType::ml_inf2_xlarge;
    return true;
  } else if (hashCode == ml_inf2_8xlarge_HASH) {
    enumValue = InstanceType::ml_inf2_8xlarge;
    return true;
  } else if (hashCode == ml_inf2_24xlarge_HASH) {
    enumValue = InstanceType::ml_inf2_24xlarge;
    return true;
  } else if (hashCode == ml_inf2_48xlarge_HASH) {
    enumValue = InstanceType::ml_inf2_48xlarge;
    return true;
    ...
    enumValue = InstanceType::ml_p6_b200_48xlarge;
    return true;
...
static bool GetEnumForNameHelper1(int hashCode, InstanceType& enumValue) {
  if (hashCode == ml_r6i_2xlarge_HASH) {
    ...
    enumValue = InstanceType::ml_g7e_2xlarge;
    return true;
  } else if (hashCode == ml_g7e_4xlarge_HASH) {
    enumValue = InstanceType::ml_g7e_4xlarge;
    return true;
  } else if (hashCode == ml_g7e_8xlarge_HASH) {
    enumValue = InstanceType::ml_g7e_8xlarge;
    return true;
  } else if (hashCode == ml_g7e_12xlarge_HASH) {
    enumValue = InstanceType::ml_g7e_12xlarge;
    return true;
  } else if (hashCode == ml_g7e_24xlarge_HASH) {
    enumValue = InstanceType::ml_g7e_24xlarge;
    return true;
  } else if (hashCode == ml_g7e_48xlarge_HASH) {
    enumValue = InstanceType::ml_g7e_48xlarge;
    return true;
...
static bool GetNameForEnumHelper0(InstanceType enumValue, Aws::String& value) {
  switch (enumValue) {
    ...
    case InstanceType::ml_trn1n_32xlarge:
      ...
      return true;
    case InstanceType::ml_inf2_xlarge:
      value = "ml.inf2.xlarge";
      return true;
    case InstanceType::ml_inf2_8xlarge:
      value = "ml.inf2.8xlarge";
      return true;
    case InstanceType::ml_inf2_24xlarge:
      value = "ml.inf2.24xlarge";
      return true;
    case InstanceType::ml_inf2_48xlarge:
    ...
    case InstanceType::ml_p5_48xlarge:
      ...
      return true;
    case InstanceType::ml_p6_b200_48xlarge:
...
static bool GetNameForEnumHelper1(InstanceType enumValue, Aws::String& value) {
  switch (enumValue) {
    ...
    case InstanceType::ml_g6_48xlarge:
      ...
      return true;
    case InstanceType::ml_g7e_2xlarge:
      value = "ml.g7e.2xlarge";
      return true;
    case InstanceType::ml_g7e_4xlarge:
      value = "ml.g7e.4xlarge";
      return true;
    case InstanceType::ml_g7e_8xlarge:
      value = "ml.g7e.8xlarge";
      return true;
    case InstanceType::ml_g7e_12xlarge:
      value = "ml.g7e.12xlarge";
      return true;
    case InstanceType::ml_g7e_24xlarge:
      value = "ml.g7e.24xlarge";
      return true;
    case InstanceType::ml_g7e_48xlarge:
