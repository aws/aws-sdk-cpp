...
ListEdgeDeploymentPlansResult::ListEdgeDeploymentPlansResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListEdgeDeploymentPlansResult& ListEdgeDeploymentPlansResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("EdgeDeploymentPlanSummaries")) {
    ...
    for (unsigned edgeDeploymentPlanSummariesIndex = 0; edgeDeploymentPlanSummariesIndex < edgeDeploymentPlanSummariesJsonList.GetLength();
         ++edgeDeploymentPlanSummariesIndex) {
