...
namespace SageMaker
{
const size_t SageMakerEndpointRules::RulesBlobStrLen = 3964;
const size_t SageMakerEndpointRules::RulesBlobSize = 3965;
...
'k','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'h','t','t','p','s',':','/','/','a','p','i','-','f','i','p','s','.','s','a','g','e','m','a','k','e',
...
'"','r','u','l','e','s','"',':','[','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',
',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',
':','/','/','a','p','i','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}',
...
'p','i','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a',
...
const char* SageMakerEndpointRules::GetRulesBlob()
{
