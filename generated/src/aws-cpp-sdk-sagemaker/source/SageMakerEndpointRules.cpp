...
namespace SageMaker
{
const size_t SageMakerEndpointRules::RulesBlobStrLen = 4015;
const size_t SageMakerEndpointRules::RulesBlobSize = 4016;
...
't','t','p','s',':','/','/','a','p','i','-','f','i','p','s','.','s','a','g','e','m','a','k','e','r',
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','p','i','-','f',
'i','p','s','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o','n','}','.','a','m',
'a','z','o','n','a','w','s','.','c','o','m','"',',','"','p','r','o','p','e','r','t','i','e','s','"',
':','{','}',',','"','h','e','a','d','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':',
'"','e','n','d','p','o','i','n','t','"','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',
':','[',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t',
't','p','s',':','/','/','a','p','i','.','s','a','g','e','m','a','k','e','r','-','f','i','p','s','.',
