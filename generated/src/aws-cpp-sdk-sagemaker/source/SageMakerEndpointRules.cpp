...
namespace SageMaker
{
const size_t SageMakerEndpointRules::RulesBlobStrLen = 4221;
const size_t SageMakerEndpointRules::RulesBlobSize = 4222;
...
'p','s',':','/','/','a','p','i','.','s','a','g','e','m','a','k','e','r','.','{','R','e','g','i','o',
