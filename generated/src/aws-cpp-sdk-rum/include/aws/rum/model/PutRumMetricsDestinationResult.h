...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHRUM_API PutRumMetricsDestinationResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutRumMetricsDestinationResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
