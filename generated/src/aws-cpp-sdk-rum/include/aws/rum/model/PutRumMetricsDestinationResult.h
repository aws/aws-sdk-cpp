...
namespace Model
{
  ...
  public:
    ...
    inline PutRumMetricsDestinationResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline PutRumMetricsDestinationResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline PutRumMetricsDestinationResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
