...
class CreateAppMonitorRequest : public CloudWatchRUMRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  CreateAppMonitorRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainListT = Aws::Vector<Aws::String>>
  CreateAppMonitorRequest& WithDomainList(DomainListT&& value) {
    SetDomainList(std::forward<DomainListT>(value));
    return *this;
  }
  template <typename DomainListT = Aws::String>
  CreateAppMonitorRequest& AddDomainList(DomainListT&& value) {
    m_domainListHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateAppMonitorRequest& WithTags(TagsT&& value) {
