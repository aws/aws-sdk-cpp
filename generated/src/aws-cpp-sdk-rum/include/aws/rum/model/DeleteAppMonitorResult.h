...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHRUM_API DeleteAppMonitorResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteAppMonitorResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
