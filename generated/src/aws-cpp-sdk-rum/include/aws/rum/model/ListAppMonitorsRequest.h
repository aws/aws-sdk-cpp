...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHRUM_API ListAppMonitorsRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListAppMonitorsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
