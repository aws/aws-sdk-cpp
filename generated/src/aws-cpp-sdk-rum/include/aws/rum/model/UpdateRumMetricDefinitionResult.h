...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHRUM_API UpdateRumMetricDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRumMetricDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
