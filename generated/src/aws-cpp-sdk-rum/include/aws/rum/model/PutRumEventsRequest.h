...
class PutRumEventsRequest : public CloudWatchRUMRequest {
 public:
  ...
  void SetAppMonitorDetails(AppMonitorDetailsT&& value) {
    m_appMonitorDetailsHasBeenSet = true;
    m_appMonitorDetails = std::forward<AppMonitorDetailsT>(value);
  }
  template <typename AppMonitorDetailsT = AppMonitorDetails>
  PutRumEventsRequest& WithAppMonitorDetails(AppMonitorDetailsT&& value) {
    SetAppMonitorDetails(std::forward<AppMonitorDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRumEvents(RumEventsT&& value) {
    m_rumEventsHasBeenSet = true;
    m_rumEvents = std::forward<RumEventsT>(value);
  }
  template <typename RumEventsT = Aws::Vector<RumEvent>>
  PutRumEventsRequest& WithRumEvents(RumEventsT&& value) {
    SetRumEvents(std::forward<RumEventsT>(value));
    return *this;
  }
  template <typename RumEventsT = RumEvent>
  PutRumEventsRequest& AddRumEvents(RumEventsT&& value) {
    m_rumEventsHasBeenSet = true;
    m_rumEvents.emplace_back(std::forward<RumEventsT>(value));
    return *this;
  }
  ///@}
