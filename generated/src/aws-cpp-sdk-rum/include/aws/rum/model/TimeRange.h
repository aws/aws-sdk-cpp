...
class TimeRange {
 public:
  ...
  inline void SetAfter(long long value) {
    m_afterHasBeenSet = true;
    m_after = value;
  }
  inline TimeRange& WithAfter(long long value) {
    SetAfter(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBefore(long long value) {
    m_beforeHasBeenSet = true;
    m_before = value;
  }
  inline TimeRange& WithBefore(long long value) {
    SetBefore(value);
    return *this;
  }
  ///@}
