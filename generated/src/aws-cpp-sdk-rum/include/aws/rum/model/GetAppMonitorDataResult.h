...
class GetAppMonitorDataResult {
 public:
  ...
  template <typename EventsT = Aws::Vector<Aws::String>>
  GetAppMonitorDataResult& WithEvents(EventsT&& value) {
    SetEvents(std::forward<EventsT>(value));
    return *this;
  }
  template <typename EventsT = Aws::String>
  GetAppMonitorDataResult& AddEvents(EventsT&& value) {
    m_eventsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetAppMonitorDataResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAppMonitorDataResult& WithRequestId(RequestIdT&& value) {
