...
class ListRumMetricsDestinationsResult {
 public:
  ...
  template <typename DestinationsT = Aws::Vector<MetricDestinationSummary>>
  ListRumMetricsDestinationsResult& WithDestinations(DestinationsT&& value) {
    SetDestinations(std::forward<DestinationsT>(value));
    return *this;
  }
  template <typename DestinationsT = MetricDestinationSummary>
  ListRumMetricsDestinationsResult& AddDestinations(DestinationsT&& value) {
    m_destinationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRumMetricsDestinationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRumMetricsDestinationsResult& WithRequestId(RequestIdT&& value) {
