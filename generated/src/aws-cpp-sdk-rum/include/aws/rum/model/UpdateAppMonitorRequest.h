...
class UpdateAppMonitorRequest : public CloudWatchRUMRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateAppMonitorRequest& WithName(NameT&& value) {
  ...
  template <typename DomainT = Aws::String>
  UpdateAppMonitorRequest& WithDomain(DomainT&& value) {
  ...
  void SetDomainList(DomainListT&& value) {
    m_domainListHasBeenSet = true;
    m_domainList = std::forward<DomainListT>(value);
  }
  template <typename DomainListT = Aws::Vector<Aws::String>>
  UpdateAppMonitorRequest& WithDomainList(DomainListT&& value) {
    SetDomainList(std::forward<DomainListT>(value));
    return *this;
  }
  template <typename DomainListT = Aws::String>
  UpdateAppMonitorRequest& AddDomainList(DomainListT&& value) {
    m_domainListHasBeenSet = true;
    m_domainList.emplace_back(std::forward<DomainListT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AppMonitorConfigurationT = AppMonitorConfiguration>
  UpdateAppMonitorRequest& WithAppMonitorConfiguration(AppMonitorConfigurationT&& value) {
  ...
  inline UpdateAppMonitorRequest& WithCwLogEnabled(bool value) {
  ...
  template <typename CustomEventsT = CustomEvents>
  UpdateAppMonitorRequest& WithCustomEvents(CustomEventsT&& value) {
  ...
  template <typename DeobfuscationConfigurationT = DeobfuscationConfiguration>
  UpdateAppMonitorRequest& WithDeobfuscationConfiguration(DeobfuscationConfigurationT&& value) {
