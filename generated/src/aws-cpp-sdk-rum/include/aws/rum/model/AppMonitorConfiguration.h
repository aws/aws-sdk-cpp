...
class AppMonitorConfiguration {
 public:
  ...
  void SetExcludedPages(ExcludedPagesT&& value) {
    m_excludedPagesHasBeenSet = true;
    m_excludedPages = std::forward<ExcludedPagesT>(value);
  }
  template <typename ExcludedPagesT = Aws::Vector<Aws::String>>
  AppMonitorConfiguration& WithExcludedPages(ExcludedPagesT&& value) {
    SetExcludedPages(std::forward<ExcludedPagesT>(value));
    return *this;
  }
  template <typename ExcludedPagesT = Aws::String>
  AppMonitorConfiguration& AddExcludedPages(ExcludedPagesT&& value) {
    m_excludedPagesHasBeenSet = true;
    m_excludedPages.emplace_back(std::forward<ExcludedPagesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFavoritePages(FavoritePagesT&& value) {
    m_favoritePagesHasBeenSet = true;
    m_favoritePages = std::forward<FavoritePagesT>(value);
  }
  template <typename FavoritePagesT = Aws::Vector<Aws::String>>
  AppMonitorConfiguration& WithFavoritePages(FavoritePagesT&& value) {
    SetFavoritePages(std::forward<FavoritePagesT>(value));
    return *this;
  }
  ...
  void SetGuestRoleArn(GuestRoleArnT&& value) {
    m_guestRoleArnHasBeenSet = true;
    m_guestRoleArn = std::forward<GuestRoleArnT>(value);
  }
  template <typename GuestRoleArnT = Aws::String>
  AppMonitorConfiguration& WithGuestRoleArn(GuestRoleArnT&& value) {
    SetGuestRoleArn(std::forward<GuestRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTelemetries(TelemetriesT&& value) {
    m_telemetriesHasBeenSet = true;
    m_telemetries = std::forward<TelemetriesT>(value);
  }
  template <typename TelemetriesT = Aws::Vector<Telemetry>>
  AppMonitorConfiguration& WithTelemetries(TelemetriesT&& value) {
    SetTelemetries(std::forward<TelemetriesT>(value));
    return *this;
  }
  inline AppMonitorConfiguration& AddTelemetries(Telemetry value) {
    m_telemetriesHasBeenSet = true;
    m_telemetries.push_back(value);
    return *this;
  }
  ///@}
