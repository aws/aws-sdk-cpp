...
class DeleteRumMetricsDestinationRequest : public CloudWatchRUMRequest {
 public:
  ...
  template <typename AppMonitorNameT = Aws::String>
  DeleteRumMetricsDestinationRequest& WithAppMonitorName(AppMonitorNameT&& value) {
  ...
  inline DeleteRumMetricsDestinationRequest& WithDestination(MetricDestination value) {
  ...
  template <typename DestinationArnT = Aws::String>
  DeleteRumMetricsDestinationRequest& WithDestinationArn(DestinationArnT&& value) {
