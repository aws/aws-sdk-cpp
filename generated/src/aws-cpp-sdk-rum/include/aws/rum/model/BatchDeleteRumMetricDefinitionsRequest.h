...
class BatchDeleteRumMetricDefinitionsRequest : public CloudWatchRUMRequest {
 public:
  ...
  template <typename AppMonitorNameT = Aws::String>
  BatchDeleteRumMetricDefinitionsRequest& WithAppMonitorName(AppMonitorNameT&& value) {
  ...
  inline BatchDeleteRumMetricDefinitionsRequest& WithDestination(MetricDestination value) {
  ...
  template <typename DestinationArnT = Aws::String>
  BatchDeleteRumMetricDefinitionsRequest& WithDestinationArn(DestinationArnT&& value) {
  ...
  template <typename MetricDefinitionIdsT = Aws::Vector<Aws::String>>
  BatchDeleteRumMetricDefinitionsRequest& WithMetricDefinitionIds(MetricDefinitionIdsT&& value) {
    SetMetricDefinitionIds(std::forward<MetricDefinitionIdsT>(value));
    return *this;
  }
  template <typename MetricDefinitionIdsT = Aws::String>
  BatchDeleteRumMetricDefinitionsRequest& AddMetricDefinitionIds(MetricDefinitionIdsT&& value) {
    m_metricDefinitionIdsHasBeenSet = true;
