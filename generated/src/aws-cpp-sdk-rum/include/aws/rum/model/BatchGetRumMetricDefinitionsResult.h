...
class BatchGetRumMetricDefinitionsResult {
 public:
  ...
  AWS_CLOUDWATCHRUM_API BatchGetRumMetricDefinitionsResult& operator=(
  ...
  template <typename MetricDefinitionsT = Aws::Vector<MetricDefinition>>
  BatchGetRumMetricDefinitionsResult& WithMetricDefinitions(MetricDefinitionsT&& value) {
    SetMetricDefinitions(std::forward<MetricDefinitionsT>(value));
    return *this;
  }
  template <typename MetricDefinitionsT = MetricDefinition>
  BatchGetRumMetricDefinitionsResult& AddMetricDefinitions(MetricDefinitionsT&& value) {
    m_metricDefinitionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  BatchGetRumMetricDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  BatchGetRumMetricDefinitionsResult& WithRequestId(RequestIdT&& value) {
