...
namespace Model
{
  ...
  {
  public:
    AWS_CLOUDWATCHRUM_API PutRumEventsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    PutRumEventsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
