...
class BatchDeleteRumMetricDefinitionsResult {
 public:
  ...
  AWS_CLOUDWATCHRUM_API BatchDeleteRumMetricDefinitionsResult& operator=(
  ...
  template <typename ErrorsT = Aws::Vector<BatchDeleteRumMetricDefinitionsError>>
  BatchDeleteRumMetricDefinitionsResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = BatchDeleteRumMetricDefinitionsError>
  BatchDeleteRumMetricDefinitionsResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  void SetMetricDefinitionIds(MetricDefinitionIdsT&& value) {
    m_metricDefinitionIdsHasBeenSet = true;
    m_metricDefinitionIds = std::forward<MetricDefinitionIdsT>(value);
  }
  template <typename MetricDefinitionIdsT = Aws::Vector<Aws::String>>
  BatchDeleteRumMetricDefinitionsResult& WithMetricDefinitionIds(MetricDefinitionIdsT&& value) {
    SetMetricDefinitionIds(std::forward<MetricDefinitionIdsT>(value));
    return *this;
  }
  template <typename MetricDefinitionIdsT = Aws::String>
  BatchDeleteRumMetricDefinitionsResult& AddMetricDefinitionIds(MetricDefinitionIdsT&& value) {
    m_metricDefinitionIdsHasBeenSet = true;
    m_metricDefinitionIds.emplace_back(std::forward<MetricDefinitionIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteRumMetricDefinitionsResult& WithRequestId(RequestIdT&& value) {
