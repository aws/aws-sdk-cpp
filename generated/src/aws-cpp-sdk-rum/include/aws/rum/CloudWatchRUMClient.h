...
class AWS_CLOUDWATCHRUM_API CloudWatchRUMClient : public Aws::Client::AWSJsonClient,
                                                  ...
                                                  public CloudWatchRUMWaiter<CloudWatchRUMClient> {
 public:
   ...
   */
  CloudWatchRUMClient(const Aws::CloudWatchRUM::CloudWatchRUMClientConfiguration& clientConfiguration =
  ...
  CloudWatchRUMClient(const Aws::Auth::AWSCredentials& credentials,
                      std::shared_ptr<CloudWatchRUMEndpointProviderBase> endpointProvider = nullptr,
                      const Aws::CloudWatchRUM::CloudWatchRUMClientConfiguration& clientConfiguration =
                          Aws::CloudWatchRUM::CloudWatchRUMClientConfiguration());
   ...
   * is not specified, it will be initialized to default values.
   */
  CloudWatchRUMClient(const Aws::Auth::AWSCredentials& credentials, const Aws::Client::ClientConfiguration& clientConfiguration);
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchCreateRumMetricDefinitionsOutcome BatchCreateRumMetricDefinitions(
      const Model::BatchCreateRumMetricDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateRumMetricDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchCreateRumMetricDefinitionsRequestT = Model::BatchCreateRumMetricDefinitionsRequest>
  Model::BatchCreateRumMetricDefinitionsOutcomeCallable BatchCreateRumMetricDefinitionsCallable(
      const BatchCreateRumMetricDefinitionsRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::BatchCreateRumMetricDefinitions, request);
  }

  /**
   * An Async wrapper for BatchCreateRumMetricDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchCreateRumMetricDefinitionsRequestT = Model::BatchCreateRumMetricDefinitionsRequest>
  void BatchCreateRumMetricDefinitionsAsync(const BatchCreateRumMetricDefinitionsRequestT& request,
                                            const BatchCreateRumMetricDefinitionsResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteRumMetricDefinitionsOutcome BatchDeleteRumMetricDefinitions(
      const Model::BatchDeleteRumMetricDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteRumMetricDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteRumMetricDefinitionsRequestT = Model::BatchDeleteRumMetricDefinitionsRequest>
  Model::BatchDeleteRumMetricDefinitionsOutcomeCallable BatchDeleteRumMetricDefinitionsCallable(
      const BatchDeleteRumMetricDefinitionsRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::BatchDeleteRumMetricDefinitions, request);
  }

  /**
   * An Async wrapper for BatchDeleteRumMetricDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDeleteRumMetricDefinitionsRequestT = Model::BatchDeleteRumMetricDefinitionsRequest>
  void BatchDeleteRumMetricDefinitionsAsync(const BatchDeleteRumMetricDefinitionsRequestT& request,
                                            const BatchDeleteRumMetricDefinitionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetRumMetricDefinitionsOutcome BatchGetRumMetricDefinitions(
      const Model::BatchGetRumMetricDefinitionsRequest& request) const;

  /**
   * A Callable wrapper for BatchGetRumMetricDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchGetRumMetricDefinitionsRequestT = Model::BatchGetRumMetricDefinitionsRequest>
  Model::BatchGetRumMetricDefinitionsOutcomeCallable BatchGetRumMetricDefinitionsCallable(
      const BatchGetRumMetricDefinitionsRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::BatchGetRumMetricDefinitions, request);
  }

  /**
   * An Async wrapper for BatchGetRumMetricDefinitions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetRumMetricDefinitionsRequestT = Model::BatchGetRumMetricDefinitionsRequest>
  void BatchGetRumMetricDefinitionsAsync(const BatchGetRumMetricDefinitionsRequestT& request,
                                         const BatchGetRumMetricDefinitionsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAppMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAppMonitor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAppMonitorRequestT = Model::CreateAppMonitorRequest>
  void CreateAppMonitorAsync(const CreateAppMonitorRequestT& request, const CreateAppMonitorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAppMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAppMonitor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAppMonitorRequestT = Model::DeleteAppMonitorRequest>
  void DeleteAppMonitorAsync(const DeleteAppMonitorRequestT& request, const DeleteAppMonitorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CloudWatchRUMClient::DeleteAppMonitor, request, handler, context);
  }

  /**
   * <p>Removes the association of a resource-based policy from an app
   * monitor.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/rum-2018-05-10/DeleteResourcePolicy">AWS
   * API Reference</a></p>
   */
  ...
  Model::DeleteResourcePolicyOutcomeCallable DeleteResourcePolicyCallable(const DeleteResourcePolicyRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::DeleteResourcePolicy, request);
  }
  ...
  void DeleteResourcePolicyAsync(const DeleteResourcePolicyRequestT& request, const DeleteResourcePolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CloudWatchRUMClient::DeleteResourcePolicy, request, handler, context);
  }
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRumMetricsDestinationOutcome DeleteRumMetricsDestination(
      const Model::DeleteRumMetricsDestinationRequest& request) const;

  /**
   * A Callable wrapper for DeleteRumMetricsDestination that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRumMetricsDestinationRequestT = Model::DeleteRumMetricsDestinationRequest>
  Model::DeleteRumMetricsDestinationOutcomeCallable DeleteRumMetricsDestinationCallable(
      const DeleteRumMetricsDestinationRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::DeleteRumMetricsDestination, request);
  }

  /**
   * An Async wrapper for DeleteRumMetricsDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRumMetricsDestinationRequestT = Model::DeleteRumMetricsDestinationRequest>
  void DeleteRumMetricsDestinationAsync(const DeleteRumMetricsDestinationRequestT& request,
                                        const DeleteRumMetricsDestinationResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAppMonitor that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAppMonitorRequestT = Model::GetAppMonitorRequest>
  void GetAppMonitorAsync(const GetAppMonitorRequestT& request, const GetAppMonitorResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAppMonitorData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAppMonitorData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAppMonitorDataRequestT = Model::GetAppMonitorDataRequest>
  void GetAppMonitorDataAsync(const GetAppMonitorDataRequestT& request, const GetAppMonitorDataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CloudWatchRUMClient::GetAppMonitorData, request, handler, context);
  }

  /**
   * <p>Use this operation to retrieve information about a resource-based policy that
   * is attached to an app monitor.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/rum-2018-05-10/GetResourcePolicy">AWS
   * API Reference</a></p>
   */
  ...
  Model::GetResourcePolicyOutcomeCallable GetResourcePolicyCallable(const GetResourcePolicyRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::GetResourcePolicy, request);
  }
  ...
  void GetResourcePolicyAsync(const GetResourcePolicyRequestT& request, const GetResourcePolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CloudWatchRUMClient::GetResourcePolicy, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for ListAppMonitors that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAppMonitorsRequestT = Model::ListAppMonitorsRequest>
  void ListAppMonitorsAsync(const ListAppMonitorsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListAppMonitorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListRumMetricsDestinationsOutcome ListRumMetricsDestinations(
      const Model::ListRumMetricsDestinationsRequest& request) const;

  /**
   * A Callable wrapper for ListRumMetricsDestinations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListRumMetricsDestinationsRequestT = Model::ListRumMetricsDestinationsRequest>
  Model::ListRumMetricsDestinationsOutcomeCallable ListRumMetricsDestinationsCallable(
      const ListRumMetricsDestinationsRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::ListRumMetricsDestinations, request);
  }

  /**
   * An Async wrapper for ListRumMetricsDestinations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRumMetricsDestinationsRequestT = Model::ListRumMetricsDestinationsRequest>
  void ListRumMetricsDestinationsAsync(const ListRumMetricsDestinationsRequestT& request,
                                       const ListRumMetricsDestinationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * <p>Use this operation to assign a resource-based policy to a CloudWatch RUM app
   ...
   * resource policies with RUM, see <a
   * href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-RUM-resource-policies.html">Using
   * resource-based policies with CloudWatch RUM</a>.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/rum-2018-05-10/PutResourcePolicy">AWS
   * API Reference</a></p>
   */
  ...
  Model::PutResourcePolicyOutcomeCallable PutResourcePolicyCallable(const PutResourcePolicyRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::PutResourcePolicy, request);
  }
  ...
  void PutResourcePolicyAsync(const PutResourcePolicyRequestT& request, const PutResourcePolicyResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&CloudWatchRUMClient::PutResourcePolicy, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for PutRumEvents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutRumEventsRequestT = Model::PutRumEventsRequest>
  void PutRumEventsAsync(const PutRumEventsRequestT& request, const PutRumEventsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutRumMetricsDestination that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutRumMetricsDestination that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutRumMetricsDestinationRequestT = Model::PutRumMetricsDestinationRequest>
  void PutRumMetricsDestinationAsync(const PutRumMetricsDestinationRequestT& request,
                                     const PutRumMetricsDestinationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAppMonitor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAppMonitor that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAppMonitorRequestT = Model::UpdateAppMonitorRequest>
  void UpdateAppMonitorAsync(const UpdateAppMonitorRequestT& request, const UpdateAppMonitorResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateRumMetricDefinition that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateRumMetricDefinitionRequestT = Model::UpdateRumMetricDefinitionRequest>
  Model::UpdateRumMetricDefinitionOutcomeCallable UpdateRumMetricDefinitionCallable(
      const UpdateRumMetricDefinitionRequestT& request) const {
    return SubmitCallable(&CloudWatchRUMClient::UpdateRumMetricDefinition, request);
  }

  /**
   * An Async wrapper for UpdateRumMetricDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateRumMetricDefinitionRequestT = Model::UpdateRumMetricDefinitionRequest>
  void UpdateRumMetricDefinitionAsync(const UpdateRumMetricDefinitionRequestT& request,
                                      const UpdateRumMetricDefinitionResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
 ...
 private:
  ...
  typedef Aws::Utils::Outcome<Aws::AmazonWebServiceResult<RESPONSE>, CloudWatchRUMError> InvokeOperationOutcome;
