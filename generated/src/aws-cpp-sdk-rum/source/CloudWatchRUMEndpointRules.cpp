...
{
const size_t CloudWatchRUMEndpointRules::RulesBlobStrLen = 3460;
const size_t CloudWatchRUMEndpointRules::RulesBlobSize = 3461;
...
':','/','/','r','u','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'p','s',':','/','/','r','u','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* CloudWatchRUMEndpointRules::GetRulesBlob()
{
