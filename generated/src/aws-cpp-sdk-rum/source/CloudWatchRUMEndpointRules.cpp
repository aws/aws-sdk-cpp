...
{
const size_t CloudWatchRUMEndpointRules::RulesBlobStrLen = 3442;
const size_t CloudWatchRUMEndpointRules::RulesBlobSize = 3443;
...
'"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','r','u','m','.','{','R','e','g','i','o',
