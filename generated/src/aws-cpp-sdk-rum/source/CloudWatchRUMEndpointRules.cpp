...
{
const size_t CloudWatchRUMEndpointRules::RulesBlobStrLen = 3712;
const size_t CloudWatchRUMEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','r','u','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
