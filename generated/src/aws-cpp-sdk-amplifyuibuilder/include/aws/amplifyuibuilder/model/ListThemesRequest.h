...
/**
 */
class ListThemesRequest : public AmplifyUIBuilderRequest {
 public:
  AWS_AMPLIFYUIBUILDER_API ListThemesRequest() = default;
  ...
  template <typename AppIdT = Aws::String>
  ListThemesRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  ListThemesRequest& WithEnvironmentName(EnvironmentNameT&& value) {
