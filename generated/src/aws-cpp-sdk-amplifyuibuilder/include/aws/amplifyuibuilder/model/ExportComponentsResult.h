...
class ExportComponentsResult {
 public:
  ...
  template <typename EntitiesT = Aws::Vector<Component>>
  ExportComponentsResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = Component>
  ExportComponentsResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ExportComponentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportComponentsResult& WithRequestId(RequestIdT&& value) {
