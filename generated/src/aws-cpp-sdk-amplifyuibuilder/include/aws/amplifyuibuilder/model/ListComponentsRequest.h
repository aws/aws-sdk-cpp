...
namespace Model
{
  ...
  {
  public:
    AWS_AMPLIFYUIBUILDER_API ListComponentsRequest() = default;
    ...
    template<typename AppIdT = Aws::String>
    ListComponentsRequest& WithAppId(AppIdT&& value) { SetAppId(std::forward<AppIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EnvironmentNameT = Aws::String>
    ListComponentsRequest& WithEnvironmentName(EnvironmentNameT&& value) { SetEnvironmentName(std::forward<EnvironmentNameT>(value)); return *this;}
    ///@}
