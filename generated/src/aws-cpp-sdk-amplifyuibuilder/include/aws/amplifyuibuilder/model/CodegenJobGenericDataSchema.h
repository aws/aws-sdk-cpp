...
class CodegenJobGenericDataSchema {
 public:
  ...
  inline void SetDataSourceType(CodegenJobGenericDataSourceType value) {
    m_dataSourceTypeHasBeenSet = true;
    m_dataSourceType = value;
  }
  inline CodegenJobGenericDataSchema& WithDataSourceType(CodegenJobGenericDataSourceType value) {
  ...
  template <typename ModelsT = Aws::Map<Aws::String, CodegenGenericDataModel>>
  CodegenJobGenericDataSchema& WithModels(ModelsT&& value) {
  ...
  CodegenJobGenericDataSchema& AddModels(ModelsKeyT&& key, ModelsValueT&& value) {
    m_modelsHasBeenSet = true;
    m_models.emplace(std::forward<ModelsKeyT>(key), std::forward<ModelsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnums(EnumsT&& value) {
    m_enumsHasBeenSet = true;
    m_enums = std::forward<EnumsT>(value);
  }
  template <typename EnumsT = Aws::Map<Aws::String, CodegenGenericDataEnum>>
  CodegenJobGenericDataSchema& WithEnums(EnumsT&& value) {
    SetEnums(std::forward<EnumsT>(value));
    return *this;
  }
  ...
  CodegenJobGenericDataSchema& AddEnums(EnumsKeyT&& key, EnumsValueT&& value) {
    m_enumsHasBeenSet = true;
    m_enums.emplace(std::forward<EnumsKeyT>(key), std::forward<EnumsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNonModels(NonModelsT&& value) {
    m_nonModelsHasBeenSet = true;
    m_nonModels = std::forward<NonModelsT>(value);
  }
  template <typename NonModelsT = Aws::Map<Aws::String, CodegenGenericDataNonModel>>
  CodegenJobGenericDataSchema& WithNonModels(NonModelsT&& value) {
    SetNonModels(std::forward<NonModelsT>(value));
    return *this;
  }
  ...
  CodegenJobGenericDataSchema& AddNonModels(NonModelsKeyT&& key, NonModelsValueT&& value) {
    m_nonModelsHasBeenSet = true;
    m_nonModels.emplace(std::forward<NonModelsKeyT>(key), std::forward<NonModelsValueT>(value));
    return *this;
  }
  ///@}
 private:
