...
class ReactStartCodegenJobData {
 public:
  ...
  inline void SetModule(JSModule value) {
    m_moduleHasBeenSet = true;
    m_module = value;
  }
  inline ReactStartCodegenJobData& WithModule(JSModule value) {
    SetModule(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTarget(JSTarget value) {
    m_targetHasBeenSet = true;
    m_target = value;
  }
  inline ReactStartCodegenJobData& WithTarget(JSTarget value) {
    SetTarget(value);
    return *this;
  }
  ///@}
  ...
  inline void SetScript(JSScript value) {
    m_scriptHasBeenSet = true;
    m_script = value;
  }
  inline ReactStartCodegenJobData& WithScript(JSScript value) {
    SetScript(value);
    return *this;
  }
  ///@}
  ...
  inline void SetRenderTypeDeclarations(bool value) {
    m_renderTypeDeclarationsHasBeenSet = true;
    m_renderTypeDeclarations = value;
  }
  inline ReactStartCodegenJobData& WithRenderTypeDeclarations(bool value) {
    SetRenderTypeDeclarations(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInlineSourceMap(bool value) {
    m_inlineSourceMapHasBeenSet = true;
    m_inlineSourceMap = value;
  }
  inline ReactStartCodegenJobData& WithInlineSourceMap(bool value) {
    SetInlineSourceMap(value);
    return *this;
  }
  ///@}
  ...
  void SetApiConfiguration(ApiConfigurationT&& value) {
    ...
    m_apiConfiguration = std::forward<ApiConfigurationT>(value);
  }
  template <typename ApiConfigurationT = ApiConfiguration>
  ReactStartCodegenJobData& WithApiConfiguration(ApiConfigurationT&& value) {
    SetApiConfiguration(std::forward<ApiConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  ReactStartCodegenJobData& AddDependencies(DependenciesKeyT&& key, DependenciesValueT&& value) {
    m_dependenciesHasBeenSet = true;
    m_dependencies.emplace(std::forward<DependenciesKeyT>(key), std::forward<DependenciesValueT>(value));
    return *this;
  }
  ///@}
 private:
