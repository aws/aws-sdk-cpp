...
class ListCodegenJobsResult {
 public:
  AWS_AMPLIFYUIBUILDER_API ListCodegenJobsResult() = default;
  ...
  template <typename EntitiesT = Aws::Vector<CodegenJobSummary>>
  void SetEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
    m_entities = std::forward<EntitiesT>(value);
  }
  template <typename EntitiesT = Aws::Vector<CodegenJobSummary>>
  ListCodegenJobsResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = CodegenJobSummary>
  ListCodegenJobsResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCodegenJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCodegenJobsResult& WithRequestId(RequestIdT&& value) {
