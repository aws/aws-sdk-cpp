...
class ComponentConditionProperty {
 public:
   ...
   */
  inline const ComponentProperty& GetThen() const { return *m_then; }
  ...
  ComponentConditionProperty& WithThen(ThenT&& value) {
    SetThen(std::forward<ThenT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ComponentProperty& GetElse() const { return *m_else; }
  ...
  ComponentConditionProperty& WithElse(ElseT&& value) {
    SetElse(std::forward<ElseT>(value));
    return *this;
  }
  ///@}
