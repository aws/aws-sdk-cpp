...
class UpdateComponentRequest : public AmplifyUIBuilderRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  UpdateComponentRequest& WithId(IdT&& value) {
  ...
  void SetUpdatedComponent(UpdatedComponentT&& value) {
    m_updatedComponentHasBeenSet = true;
    m_updatedComponent = std::forward<UpdatedComponentT>(value);
  }
  template <typename UpdatedComponentT = UpdateComponentData>
  UpdateComponentRequest& WithUpdatedComponent(UpdatedComponentT&& value) {
    SetUpdatedComponent(std::forward<UpdatedComponentT>(value));
    return *this;
  }
  ///@}
 private:
