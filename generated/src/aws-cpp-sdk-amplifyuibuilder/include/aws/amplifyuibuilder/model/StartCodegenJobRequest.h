...
class StartCodegenJobRequest : public AmplifyUIBuilderRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  StartCodegenJobRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  StartCodegenJobRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  StartCodegenJobRequest& WithClientToken(ClientTokenT&& value) {
  ...
  void SetCodegenJobToCreate(CodegenJobToCreateT&& value) {
    m_codegenJobToCreateHasBeenSet = true;
    m_codegenJobToCreate = std::forward<CodegenJobToCreateT>(value);
  }
  template <typename CodegenJobToCreateT = StartCodegenJobData>
  StartCodegenJobRequest& WithCodegenJobToCreate(CodegenJobToCreateT&& value) {
    SetCodegenJobToCreate(std::forward<CodegenJobToCreateT>(value));
    return *this;
  }
  ///@}
 private:
