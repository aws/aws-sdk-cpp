...
class CreateThemeData {
 public:
  AWS_AMPLIFYUIBUILDER_API CreateThemeData() = default;
  ...
  template <typename NameT = Aws::String>
  CreateThemeData& WithName(NameT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<ThemeValues>>
  CreateThemeData& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = ThemeValues>
  CreateThemeData& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  template <typename OverridesT = Aws::Vector<ThemeValues>>
  CreateThemeData& WithOverrides(OverridesT&& value) {
    SetOverrides(std::forward<OverridesT>(value));
    return *this;
  }
  template <typename OverridesT = ThemeValues>
  CreateThemeData& AddOverrides(OverridesT&& value) {
    m_overridesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateThemeData& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateThemeData& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
