...
class ExportThemesRequest : public AmplifyUIBuilderRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ExportThemesRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  ExportThemesRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ExportThemesRequest& WithNextToken(NextTokenT&& value) {
