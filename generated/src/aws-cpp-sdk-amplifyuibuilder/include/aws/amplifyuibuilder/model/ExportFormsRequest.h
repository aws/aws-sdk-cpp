...
class ExportFormsRequest : public AmplifyUIBuilderRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ExportFormsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  ExportFormsRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ExportFormsRequest& WithNextToken(NextTokenT&& value) {
