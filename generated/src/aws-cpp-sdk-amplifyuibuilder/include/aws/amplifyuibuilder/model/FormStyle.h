...
class FormStyle {
 public:
  ...
  void SetHorizontalGap(HorizontalGapT&& value) {
    ...
    m_horizontalGap = std::forward<HorizontalGapT>(value);
  }
  template <typename HorizontalGapT = FormStyleConfig>
  FormStyle& WithHorizontalGap(HorizontalGapT&& value) {
    SetHorizontalGap(std::forward<HorizontalGapT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerticalGap(VerticalGapT&& value) {
    ...
    m_verticalGap = std::forward<VerticalGapT>(value);
  }
  template <typename VerticalGapT = FormStyleConfig>
  FormStyle& WithVerticalGap(VerticalGapT&& value) {
    SetVerticalGap(std::forward<VerticalGapT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOuterPadding(OuterPaddingT&& value) {
    ...
    m_outerPadding = std::forward<OuterPaddingT>(value);
  }
  template <typename OuterPaddingT = FormStyleConfig>
  FormStyle& WithOuterPadding(OuterPaddingT&& value) {
    SetOuterPadding(std::forward<OuterPaddingT>(value));
    return *this;
  }
  ///@}
 private:
