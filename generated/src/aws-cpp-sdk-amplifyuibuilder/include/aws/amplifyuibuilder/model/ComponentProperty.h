...
class ComponentProperty {
 public:
  ...
  void SetCollectionBindingProperties(CollectionBindingPropertiesT&& value) {
    ...
    m_collectionBindingProperties = std::forward<CollectionBindingPropertiesT>(value);
  }
  template <typename CollectionBindingPropertiesT = ComponentPropertyBindingProperties>
  ComponentProperty& WithCollectionBindingProperties(CollectionBindingPropertiesT&& value) {
    SetCollectionBindingProperties(std::forward<CollectionBindingPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBindings(BindingsT&& value) {
    ...
    m_bindings = std::forward<BindingsT>(value);
  }
  template <typename BindingsT = Aws::Map<Aws::String, FormBindingElement>>
  ComponentProperty& WithBindings(BindingsT&& value) {
    SetBindings(std::forward<BindingsT>(value));
    return *this;
  }
  ...
  ComponentProperty& AddBindings(BindingsKeyT&& key, BindingsValueT&& value) {
    m_bindingsHasBeenSet = true;
    m_bindings.emplace(std::forward<BindingsKeyT>(key), std::forward<BindingsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserAttribute(UserAttributeT&& value) {
    ...
    m_userAttribute = std::forward<UserAttributeT>(value);
  }
  template <typename UserAttributeT = Aws::String>
  ComponentProperty& WithUserAttribute(UserAttributeT&& value) {
    SetUserAttribute(std::forward<UserAttributeT>(value));
    return *this;
  }
  ///@}
   ...
   * property.</p>
   */
  inline const ComponentConditionProperty& GetCondition() const { return *m_condition; }
  ...
  inline ComponentProperty& WithConfigured(bool value) {
    SetConfigured(value);
    return *this;
  }
  ///@}
  ...
  void SetImportedValue(ImportedValueT&& value) {
    ...
    m_importedValue = std::forward<ImportedValueT>(value);
  }
  template <typename ImportedValueT = Aws::String>
  ComponentProperty& WithImportedValue(ImportedValueT&& value) {
    SetImportedValue(std::forward<ImportedValueT>(value));
    return *this;
  }
  ///@}
