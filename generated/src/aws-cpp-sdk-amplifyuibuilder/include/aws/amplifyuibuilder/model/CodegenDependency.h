...
class CodegenDependency {
 public:
  ...
  void SetSupportedVersion(SupportedVersionT&& value) {
    ...
    m_supportedVersion = std::forward<SupportedVersionT>(value);
  }
  template <typename SupportedVersionT = Aws::String>
  CodegenDependency& WithSupportedVersion(SupportedVersionT&& value) {
    SetSupportedVersion(std::forward<SupportedVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsSemVer(bool value) {
    m_isSemVerHasBeenSet = true;
    m_isSemVer = value;
  }
  inline CodegenDependency& WithIsSemVer(bool value) {
    SetIsSemVer(value);
    return *this;
  }
  ///@}
