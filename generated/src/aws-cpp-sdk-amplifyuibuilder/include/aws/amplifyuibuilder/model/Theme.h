...
class Theme {
 public:
  ...
  template <typename EnvironmentNameT = Aws::String>
  Theme& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  Theme& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename ModifiedAtT = Aws::Utils::DateTime>
  Theme& WithModifiedAt(ModifiedAtT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<ThemeValues>>
  Theme& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = ThemeValues>
  Theme& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
