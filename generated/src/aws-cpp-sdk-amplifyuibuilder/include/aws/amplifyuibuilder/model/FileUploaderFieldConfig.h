...
class FileUploaderFieldConfig {
 public:
  ...
  inline void SetAccessLevel(StorageAccessLevel value) {
    m_accessLevelHasBeenSet = true;
    m_accessLevel = value;
  }
  inline FileUploaderFieldConfig& WithAccessLevel(StorageAccessLevel value) {
  ...
  inline void SetShowThumbnails(bool value) {
    m_showThumbnailsHasBeenSet = true;
    m_showThumbnails = value;
  }
  inline FileUploaderFieldConfig& WithShowThumbnails(bool value) {
  ...
  inline void SetIsResumable(bool value) {
    m_isResumableHasBeenSet = true;
    m_isResumable = value;
  }
  inline FileUploaderFieldConfig& WithIsResumable(bool value) {
    SetIsResumable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxFileCount(int value) {
    m_maxFileCountHasBeenSet = true;
    m_maxFileCount = value;
  }
  inline FileUploaderFieldConfig& WithMaxFileCount(int value) {
  ...
  inline FileUploaderFieldConfig& WithMaxSize(int value) {
    SetMaxSize(value);
    return *this;
  }
  ///@}
