...
class FieldPosition {
 public:
  ...
  inline void SetFixed(FixedPosition value) {
    m_fixedHasBeenSet = true;
    m_fixed = value;
  }
  inline FieldPosition& WithFixed(FixedPosition value) {
    SetFixed(value);
    return *this;
  }
  ///@}
  ...
  void SetRightOf(RightOfT&& value) {
    ...
    m_rightOf = std::forward<RightOfT>(value);
  }
  template <typename RightOfT = Aws::String>
  FieldPosition& WithRightOf(RightOfT&& value) {
    SetRightOf(std::forward<RightOfT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBelow(BelowT&& value) {
    ...
    m_below = std::forward<BelowT>(value);
  }
  template <typename BelowT = Aws::String>
  FieldPosition& WithBelow(BelowT&& value) {
    SetBelow(std::forward<BelowT>(value));
    return *this;
  }
  ///@}
 private:
