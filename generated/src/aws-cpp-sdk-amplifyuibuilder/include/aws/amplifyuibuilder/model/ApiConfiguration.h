...
class ApiConfiguration {
 public:
  ...
  void SetGraphQLConfig(GraphQLConfigT&& value) {
    ...
    m_graphQLConfig = std::forward<GraphQLConfigT>(value);
  }
  template <typename GraphQLConfigT = GraphQLRenderConfig>
  ApiConfiguration& WithGraphQLConfig(GraphQLConfigT&& value) {
    SetGraphQLConfig(std::forward<GraphQLConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataStoreConfig(DataStoreConfigT&& value) {
    ...
    m_dataStoreConfig = std::forward<DataStoreConfigT>(value);
  }
  template <typename DataStoreConfigT = DataStoreRenderConfig>
  ApiConfiguration& WithDataStoreConfig(DataStoreConfigT&& value) {
    SetDataStoreConfig(std::forward<DataStoreConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNoApiConfig(NoApiConfigT&& value) {
    ...
    m_noApiConfig = std::forward<NoApiConfigT>(value);
  }
  template <typename NoApiConfigT = NoApiRenderConfig>
  ApiConfiguration& WithNoApiConfig(NoApiConfigT&& value) {
    SetNoApiConfig(std::forward<NoApiConfigT>(value));
    return *this;
  }
  ///@}
 private:
