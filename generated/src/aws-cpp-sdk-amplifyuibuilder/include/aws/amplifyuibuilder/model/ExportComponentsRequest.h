...
class ExportComponentsRequest : public AmplifyUIBuilderRequest {
 public:
  ...
  template <typename AppIdT = Aws::String>
  ExportComponentsRequest& WithAppId(AppIdT&& value) {
  ...
  template <typename EnvironmentNameT = Aws::String>
  ExportComponentsRequest& WithEnvironmentName(EnvironmentNameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ExportComponentsRequest& WithNextToken(NextTokenT&& value) {
