...
class FormCTA {
 public:
  ...
  inline void SetPosition(FormButtonsPosition value) {
    m_positionHasBeenSet = true;
    m_position = value;
  }
  inline FormCTA& WithPosition(FormButtonsPosition value) {
    SetPosition(value);
    return *this;
  }
  ///@}
  ...
  void SetClear(ClearT&& value) {
    ...
    m_clear = std::forward<ClearT>(value);
  }
  template <typename ClearT = FormButton>
  FormCTA& WithClear(ClearT&& value) {
    SetClear(std::forward<ClearT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCancel(CancelT&& value) {
    ...
    m_cancel = std::forward<CancelT>(value);
  }
  template <typename CancelT = FormButton>
  FormCTA& WithCancel(CancelT&& value) {
    SetCancel(std::forward<CancelT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubmit(SubmitT&& value) {
    ...
    m_submit = std::forward<SubmitT>(value);
  }
  template <typename SubmitT = FormButton>
  FormCTA& WithSubmit(SubmitT&& value) {
    SetSubmit(std::forward<SubmitT>(value));
    return *this;
  }
  ///@}
 private:
