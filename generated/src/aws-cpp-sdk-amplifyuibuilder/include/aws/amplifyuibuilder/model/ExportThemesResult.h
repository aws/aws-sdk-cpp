...
class ExportThemesResult {
 public:
  ...
  template <typename EntitiesT = Aws::Vector<Theme>>
  ExportThemesResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = Theme>
  ExportThemesResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ExportThemesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportThemesResult& WithRequestId(RequestIdT&& value) {
