...
class ExportFormsResult {
 public:
  ...
  template <typename EntitiesT = Aws::Vector<Form>>
  ExportFormsResult& WithEntities(EntitiesT&& value) {
    SetEntities(std::forward<EntitiesT>(value));
    return *this;
  }
  template <typename EntitiesT = Form>
  ExportFormsResult& AddEntities(EntitiesT&& value) {
    m_entitiesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ExportFormsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ExportFormsResult& WithRequestId(RequestIdT&& value) {
