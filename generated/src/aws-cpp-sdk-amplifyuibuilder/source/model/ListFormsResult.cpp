...
ListFormsResult::ListFormsResult()
{
}

ListFormsResult::ListFormsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListFormsResult& ListFormsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
