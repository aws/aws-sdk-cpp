...
UpdateThemeData::UpdateThemeData(JsonView jsonValue) { *this = jsonValue; }

UpdateThemeData& UpdateThemeData::operator=(JsonView jsonValue) {
...
JsonValue UpdateThemeData::Jsonize() const {
  JsonValue payload;
