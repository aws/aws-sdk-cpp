...
CodegenGenericDataRelationshipType::CodegenGenericDataRelationshipType(JsonView jsonValue) { *this = jsonValue; }
...
CodegenGenericDataRelationshipType& CodegenGenericDataRelationshipType::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("relatedModelFields")) {
    ...
    for (unsigned relatedModelFieldsIndex = 0; relatedModelFieldsIndex < relatedModelFieldsJsonList.GetLength();
         ++relatedModelFieldsIndex) {
