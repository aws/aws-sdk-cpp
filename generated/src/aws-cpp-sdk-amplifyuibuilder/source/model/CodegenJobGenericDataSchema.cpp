...
CodegenJobGenericDataSchema::CodegenJobGenericDataSchema(JsonView jsonValue) { *this = jsonValue; }
...
CodegenJobGenericDataSchema& CodegenJobGenericDataSchema::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("dataSourceType")) {
    m_dataSourceType =
        CodegenJobGenericDataSourceTypeMapper::GetCodegenJobGenericDataSourceTypeForName(jsonValue.GetString("dataSourceType"));
...
JsonValue CodegenJobGenericDataSchema::Jsonize() const {
  ...
  if (m_dataSourceTypeHasBeenSet) {
    payload.WithString("dataSourceType",
                       CodegenJobGenericDataSourceTypeMapper::GetNameForCodegenJobGenericDataSourceType(m_dataSourceType));
  }
