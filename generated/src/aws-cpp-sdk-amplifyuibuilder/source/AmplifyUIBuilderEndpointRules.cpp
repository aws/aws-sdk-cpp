...
{
const size_t AmplifyUIBuilderEndpointRules::RulesBlobStrLen = 3764;
const size_t AmplifyUIBuilderEndpointRules::RulesBlobSize = 3765;
...
't','t','p','s',':','/','/','a','m','p','l','i','f','y','u','i','b','u','i','l','d','e','r','.','{',
