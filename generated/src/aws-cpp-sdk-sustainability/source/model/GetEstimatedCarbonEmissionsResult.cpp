...
GetEstimatedCarbonEmissionsResult::GetEstimatedCarbonEmissionsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetEstimatedCarbonEmissionsResult& GetEstimatedCarbonEmissionsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
