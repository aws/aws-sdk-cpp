...
GetEstimatedCarbonEmissionsDimensionValuesResult::GetEstimatedCarbonEmissionsDimensionValuesResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetEstimatedCarbonEmissionsDimensionValuesResult& GetEstimatedCarbonEmissionsDimensionValuesResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
