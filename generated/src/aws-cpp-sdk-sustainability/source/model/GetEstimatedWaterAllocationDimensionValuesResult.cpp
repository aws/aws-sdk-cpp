...
GetEstimatedWaterAllocationDimensionValuesResult::GetEstimatedWaterAllocationDimensionValuesResult(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

GetEstimatedWaterAllocationDimensionValuesResult& GetEstimatedWaterAllocationDimensionValuesResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
