...
/**
 */
class GetEstimatedWaterAllocationDimensionValuesRequest : public SustainabilityRequest {
 public:
  AWS_SUSTAINABILITY_API GetEstimatedWaterAllocationDimensionValuesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetEstimatedWaterAllocationDimensionValues"; }
   ...
   * start date of a year for that year's data to be included in the response. </p>
   */
  ...
  template <typename TimePeriodT = TimePeriod>
  GetEstimatedWaterAllocationDimensionValuesRequest& WithTimePeriod(TimePeriodT&& value) {
  ...
  template <typename DimensionsT = Aws::Vector<Dimension>>
  GetEstimatedWaterAllocationDimensionValuesRequest& WithDimensions(DimensionsT&& value) {
    SetDimensions(std::forward<DimensionsT>(value));
    return *this;
  }
  inline GetEstimatedWaterAllocationDimensionValuesRequest& AddDimensions(Dimension value) {
    m_dimensionsHasBeenSet = true;
  ...
  inline GetEstimatedWaterAllocationDimensionValuesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetEstimatedWaterAllocationDimensionValuesRequest& WithNextToken(NextTokenT&& value) {
