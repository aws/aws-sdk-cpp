...
class CreateWhatsAppMessageTemplateFromLibraryRequest : public SocialMessagingRequest {
 public:
  ...
  void SetMetaLibraryTemplate(MetaLibraryTemplateT&& value) {
    m_metaLibraryTemplateHasBeenSet = true;
    m_metaLibraryTemplate = std::forward<MetaLibraryTemplateT>(value);
  }
  template <typename MetaLibraryTemplateT = MetaLibraryTemplate>
  CreateWhatsAppMessageTemplateFromLibraryRequest& WithMetaLibraryTemplate(MetaLibraryTemplateT&& value) {
    SetMetaLibraryTemplate(std::forward<MetaLibraryTemplateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  CreateWhatsAppMessageTemplateFromLibraryRequest& WithId(IdT&& value) {
