...
class LibraryTemplateButtonList {
 public:
  ...
  template <typename TypeT = Aws::String>
  LibraryTemplateButtonList& WithType(TypeT&& value) {
  ...
  template <typename TextT = Aws::String>
  LibraryTemplateButtonList& WithText(TextT&& value) {
  ...
  template <typename UrlT = Aws::String>
  LibraryTemplateButtonList& WithUrl(UrlT&& value) {
  ...
  inline LibraryTemplateButtonList& WithZeroTapTermsAccepted(bool value) {
