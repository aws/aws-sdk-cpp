...
class WhatsAppSignupCallbackResult {
 public:
   ...
   */
  inline const Aws::Map<Aws::String, LinkedWhatsAppBusinessAccountIdMetaData>& GetLinkedAccountsWithIncompleteSetup() const {
    return m_linkedAccountsWithIncompleteSetup;
  }
  ...
  void SetLinkedAccountsWithIncompleteSetup(LinkedAccountsWithIncompleteSetupT&& value) {
    ...
    m_linkedAccountsWithIncompleteSetup = std::forward<LinkedAccountsWithIncompleteSetupT>(value);
  }
  template <typename LinkedAccountsWithIncompleteSetupT = Aws::Map<Aws::String, LinkedWhatsAppBusinessAccountIdMetaData>>
  WhatsAppSignupCallbackResult& WithLinkedAccountsWithIncompleteSetup(LinkedAccountsWithIncompleteSetupT&& value) {
    SetLinkedAccountsWithIncompleteSetup(std::forward<LinkedAccountsWithIncompleteSetupT>(value));
    return *this;
  }
  template <typename LinkedAccountsWithIncompleteSetupKeyT = Aws::String,
            typename LinkedAccountsWithIncompleteSetupValueT = LinkedWhatsAppBusinessAccountIdMetaData>
  WhatsAppSignupCallbackResult& AddLinkedAccountsWithIncompleteSetup(LinkedAccountsWithIncompleteSetupKeyT&& key,
                                                                     LinkedAccountsWithIncompleteSetupValueT&& value) {
    m_linkedAccountsWithIncompleteSetupHasBeenSet = true;
    m_linkedAccountsWithIncompleteSetup.emplace(std::forward<LinkedAccountsWithIncompleteSetupKeyT>(key),
                                                std::forward<LinkedAccountsWithIncompleteSetupValueT>(value));
    return *this;
  }
  ///@}
 private:
