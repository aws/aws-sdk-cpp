...
class CreateWhatsAppMessageTemplateMediaResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateMediaResult& operator=(
  ...
  void SetMetaHeaderHandle(MetaHeaderHandleT&& value) {
    m_metaHeaderHandleHasBeenSet = true;
    m_metaHeaderHandle = std::forward<MetaHeaderHandleT>(value);
  }
  template <typename MetaHeaderHandleT = Aws::String>
  CreateWhatsAppMessageTemplateMediaResult& WithMetaHeaderHandle(MetaHeaderHandleT&& value) {
    SetMetaHeaderHandle(std::forward<MetaHeaderHandleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateWhatsAppMessageTemplateMediaResult& WithRequestId(RequestIdT&& value) {
