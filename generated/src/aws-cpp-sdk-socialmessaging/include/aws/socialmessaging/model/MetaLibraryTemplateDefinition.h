...
class MetaLibraryTemplateDefinition {
 public:
  ...
  void SetTemplateTopic(TemplateTopicT&& value) {
    m_templateTopicHasBeenSet = true;
    m_templateTopic = std::forward<TemplateTopicT>(value);
  }
  template <typename TemplateTopicT = Aws::String>
  MetaLibraryTemplateDefinition& WithTemplateTopic(TemplateTopicT&& value) {
    SetTemplateTopic(std::forward<TemplateTopicT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateUseCase(TemplateUseCaseT&& value) {
    m_templateUseCaseHasBeenSet = true;
    m_templateUseCase = std::forward<TemplateUseCaseT>(value);
  }
  template <typename TemplateUseCaseT = Aws::String>
  MetaLibraryTemplateDefinition& WithTemplateUseCase(TemplateUseCaseT&& value) {
    SetTemplateUseCase(std::forward<TemplateUseCaseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateHeader(TemplateHeaderT&& value) {
    m_templateHeaderHasBeenSet = true;
    m_templateHeader = std::forward<TemplateHeaderT>(value);
  }
  template <typename TemplateHeaderT = Aws::String>
  MetaLibraryTemplateDefinition& WithTemplateHeader(TemplateHeaderT&& value) {
    SetTemplateHeader(std::forward<TemplateHeaderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateButtons(TemplateButtonsT&& value) {
    m_templateButtonsHasBeenSet = true;
    m_templateButtons = std::forward<TemplateButtonsT>(value);
  }
  template <typename TemplateButtonsT = Aws::Vector<LibraryTemplateButtonList>>
  MetaLibraryTemplateDefinition& WithTemplateButtons(TemplateButtonsT&& value) {
    SetTemplateButtons(std::forward<TemplateButtonsT>(value));
    return *this;
  }
  ...
  MetaLibraryTemplateDefinition& AddTemplateButtons(TemplateButtonsT&& value) {
    m_templateButtonsHasBeenSet = true;
    m_templateButtons.emplace_back(std::forward<TemplateButtonsT>(value));
    return *this;
  }
  ///@}
