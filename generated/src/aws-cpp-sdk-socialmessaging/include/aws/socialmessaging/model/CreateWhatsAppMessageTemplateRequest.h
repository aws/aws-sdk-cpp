...
class CreateWhatsAppMessageTemplateRequest : public SocialMessagingRequest {
 public:
  ...
  void SetTemplateDefinition(TemplateDefinitionT&& value) {
    m_templateDefinitionHasBeenSet = true;
    m_templateDefinition = std::forward<TemplateDefinitionT>(value);
  }
  template <typename TemplateDefinitionT = Aws::Utils::ByteBuffer>
  CreateWhatsAppMessageTemplateRequest& WithTemplateDefinition(TemplateDefinitionT&& value) {
    SetTemplateDefinition(std::forward<TemplateDefinitionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  CreateWhatsAppMessageTemplateRequest& WithId(IdT&& value) {
