...
class CreateWhatsAppMessageTemplateMediaRequest : public SocialMessagingRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  CreateWhatsAppMessageTemplateMediaRequest& WithId(IdT&& value) {
  ...
  void SetSourceS3File(SourceS3FileT&& value) {
    m_sourceS3FileHasBeenSet = true;
    m_sourceS3File = std::forward<SourceS3FileT>(value);
  }
  template <typename SourceS3FileT = S3File>
  CreateWhatsAppMessageTemplateMediaRequest& WithSourceS3File(SourceS3FileT&& value) {
    SetSourceS3File(std::forward<SourceS3FileT>(value));
    return *this;
  }
  ///@}
 private:
