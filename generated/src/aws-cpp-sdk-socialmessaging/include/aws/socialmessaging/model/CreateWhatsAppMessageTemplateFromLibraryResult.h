...
class CreateWhatsAppMessageTemplateFromLibraryResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateFromLibraryResult(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateFromLibraryResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename MetaTemplateIdT = Aws::String>
  CreateWhatsAppMessageTemplateFromLibraryResult& WithMetaTemplateId(MetaTemplateIdT&& value) {
  ...
  template <typename TemplateStatusT = Aws::String>
  CreateWhatsAppMessageTemplateFromLibraryResult& WithTemplateStatus(TemplateStatusT&& value) {
  ...
  template <typename CategoryT = Aws::String>
  CreateWhatsAppMessageTemplateFromLibraryResult& WithCategory(CategoryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWhatsAppMessageTemplateFromLibraryResult& WithRequestId(RequestIdT&& value) {
