...
class ListWhatsAppTemplateLibraryRequest : public SocialMessagingRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatsAppTemplateLibraryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWhatsAppTemplateLibraryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  ListWhatsAppTemplateLibraryRequest& WithId(IdT&& value) {
  ...
  template <typename FiltersT = Aws::Map<Aws::String, Aws::String>>
  ListWhatsAppTemplateLibraryRequest& WithFilters(FiltersT&& value) {
