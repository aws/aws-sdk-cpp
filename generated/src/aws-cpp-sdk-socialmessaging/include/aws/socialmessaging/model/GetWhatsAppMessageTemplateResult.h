...
class GetWhatsAppMessageTemplateResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API GetWhatsAppMessageTemplateResult& operator=(
  ...
  template <typename TemplateT = Aws::String>
  GetWhatsAppMessageTemplateResult& WithTemplate(TemplateT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetWhatsAppMessageTemplateResult& WithRequestId(RequestIdT&& value) {
