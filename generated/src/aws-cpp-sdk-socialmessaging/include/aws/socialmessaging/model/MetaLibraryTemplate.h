...
class MetaLibraryTemplate {
 public:
  ...
  void SetLibraryTemplateName(LibraryTemplateNameT&& value) {
    ...
    m_libraryTemplateName = std::forward<LibraryTemplateNameT>(value);
  }
  template <typename LibraryTemplateNameT = Aws::String>
  MetaLibraryTemplate& WithLibraryTemplateName(LibraryTemplateNameT&& value) {
    SetLibraryTemplateName(std::forward<LibraryTemplateNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateCategory(TemplateCategoryT&& value) {
    ...
    m_templateCategory = std::forward<TemplateCategoryT>(value);
  }
  template <typename TemplateCategoryT = Aws::String>
  MetaLibraryTemplate& WithTemplateCategory(TemplateCategoryT&& value) {
    SetTemplateCategory(std::forward<TemplateCategoryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateLanguage(TemplateLanguageT&& value) {
    ...
    m_templateLanguage = std::forward<TemplateLanguageT>(value);
  }
  template <typename TemplateLanguageT = Aws::String>
  MetaLibraryTemplate& WithTemplateLanguage(TemplateLanguageT&& value) {
    SetTemplateLanguage(std::forward<TemplateLanguageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLibraryTemplateButtonInputs(LibraryTemplateButtonInputsT&& value) {
    ...
    m_libraryTemplateButtonInputs = std::forward<LibraryTemplateButtonInputsT>(value);
  }
  template <typename LibraryTemplateButtonInputsT = Aws::Vector<LibraryTemplateButtonInput>>
  MetaLibraryTemplate& WithLibraryTemplateButtonInputs(LibraryTemplateButtonInputsT&& value) {
    SetLibraryTemplateButtonInputs(std::forward<LibraryTemplateButtonInputsT>(value));
    return *this;
  }
  ...
  MetaLibraryTemplate& AddLibraryTemplateButtonInputs(LibraryTemplateButtonInputsT&& value) {
    m_libraryTemplateButtonInputsHasBeenSet = true;
    m_libraryTemplateButtonInputs.emplace_back(std::forward<LibraryTemplateButtonInputsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLibraryTemplateBodyInputs(LibraryTemplateBodyInputsT&& value) {
    ...
    m_libraryTemplateBodyInputs = std::forward<LibraryTemplateBodyInputsT>(value);
  }
  template <typename LibraryTemplateBodyInputsT = LibraryTemplateBodyInputs>
  MetaLibraryTemplate& WithLibraryTemplateBodyInputs(LibraryTemplateBodyInputsT&& value) {
    SetLibraryTemplateBodyInputs(std::forward<LibraryTemplateBodyInputsT>(value));
    return *this;
  }
  ///@}
 private:
