...
class ListWhatsAppTemplateLibraryResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API ListWhatsAppTemplateLibraryResult& operator=(
  ...
  void SetMetaLibraryTemplates(MetaLibraryTemplatesT&& value) {
    m_metaLibraryTemplatesHasBeenSet = true;
    m_metaLibraryTemplates = std::forward<MetaLibraryTemplatesT>(value);
  }
  template <typename MetaLibraryTemplatesT = Aws::Vector<MetaLibraryTemplateDefinition>>
  ListWhatsAppTemplateLibraryResult& WithMetaLibraryTemplates(MetaLibraryTemplatesT&& value) {
    SetMetaLibraryTemplates(std::forward<MetaLibraryTemplatesT>(value));
    return *this;
  }
  template <typename MetaLibraryTemplatesT = MetaLibraryTemplateDefinition>
  ListWhatsAppTemplateLibraryResult& AddMetaLibraryTemplates(MetaLibraryTemplatesT&& value) {
    m_metaLibraryTemplatesHasBeenSet = true;
    m_metaLibraryTemplates.emplace_back(std::forward<MetaLibraryTemplatesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatsAppTemplateLibraryResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWhatsAppTemplateLibraryResult& WithRequestId(RequestIdT&& value) {
