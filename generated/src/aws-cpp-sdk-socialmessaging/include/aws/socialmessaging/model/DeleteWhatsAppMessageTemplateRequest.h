...
class DeleteWhatsAppMessageTemplateRequest : public SocialMessagingRequest {
 public:
  ...
  template <typename MetaTemplateIdT = Aws::String>
  DeleteWhatsAppMessageTemplateRequest& WithMetaTemplateId(MetaTemplateIdT&& value) {
  ...
  inline void SetDeleteAllLanguages(bool value) {
    m_deleteAllLanguagesHasBeenSet = true;
    m_deleteAllLanguages = value;
  }
  inline DeleteWhatsAppMessageTemplateRequest& WithDeleteAllLanguages(bool value) {
    SetDeleteAllLanguages(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  DeleteWhatsAppMessageTemplateRequest& WithId(IdT&& value) {
  ...
  template <typename TemplateNameT = Aws::String>
  DeleteWhatsAppMessageTemplateRequest& WithTemplateName(TemplateNameT&& value) {
