...
namespace Model
{
  ...
  {
  public:
    AWS_SOCIALMESSAGING_API GetLinkedWhatsAppBusinessAccountRequest();
    ...
    inline GetLinkedWhatsAppBusinessAccountRequest& WithId(const Aws::String& value) { SetId(value); return *this;}
    inline GetLinkedWhatsAppBusinessAccountRequest& WithId(Aws::String&& value) { SetId(std::move(value)); return *this;}
    inline GetLinkedWhatsAppBusinessAccountRequest& WithId(const char* value) { SetId(value); return *this;}
    ///@}
  private:
