...
class ListWhatsAppMessageTemplatesResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API ListWhatsAppMessageTemplatesResult& operator=(
  ...
  template <typename TemplatesT = Aws::Vector<TemplateSummary>>
  ListWhatsAppMessageTemplatesResult& WithTemplates(TemplatesT&& value) {
    SetTemplates(std::forward<TemplatesT>(value));
    return *this;
  }
  template <typename TemplatesT = TemplateSummary>
  ListWhatsAppMessageTemplatesResult& AddTemplates(TemplatesT&& value) {
    m_templatesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatsAppMessageTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListWhatsAppMessageTemplatesResult& WithRequestId(RequestIdT&& value) {
