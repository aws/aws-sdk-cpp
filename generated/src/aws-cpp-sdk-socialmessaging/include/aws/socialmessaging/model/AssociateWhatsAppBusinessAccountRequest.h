...
class AssociateWhatsAppBusinessAccountRequest : public SocialMessagingRequest {
 public:
  ...
  void SetSignupCallback(SignupCallbackT&& value) {
    m_signupCallbackHasBeenSet = true;
    m_signupCallback = std::forward<SignupCallbackT>(value);
  }
  template <typename SignupCallbackT = WhatsAppSignupCallback>
  AssociateWhatsAppBusinessAccountRequest& WithSignupCallback(SignupCallbackT&& value) {
    SetSignupCallback(std::forward<SignupCallbackT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSetupFinalization(SetupFinalizationT&& value) {
    m_setupFinalizationHasBeenSet = true;
    m_setupFinalization = std::forward<SetupFinalizationT>(value);
  }
  template <typename SetupFinalizationT = WhatsAppSetupFinalization>
  AssociateWhatsAppBusinessAccountRequest& WithSetupFinalization(SetupFinalizationT&& value) {
    SetSetupFinalization(std::forward<SetupFinalizationT>(value));
    return *this;
  }
  ///@}
 private:
