...
class ListLinkedWhatsAppBusinessAccountsResult {
 public:
  ...
  AWS_SOCIALMESSAGING_API ListLinkedWhatsAppBusinessAccountsResult& operator=(
  ...
  template <typename LinkedAccountsT = Aws::Vector<LinkedWhatsAppBusinessAccountSummary>>
  ListLinkedWhatsAppBusinessAccountsResult& WithLinkedAccounts(LinkedAccountsT&& value) {
  ...
  ListLinkedWhatsAppBusinessAccountsResult& AddLinkedAccounts(LinkedAccountsT&& value) {
    m_linkedAccountsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListLinkedWhatsAppBusinessAccountsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLinkedWhatsAppBusinessAccountsResult& WithRequestId(RequestIdT&& value) {
