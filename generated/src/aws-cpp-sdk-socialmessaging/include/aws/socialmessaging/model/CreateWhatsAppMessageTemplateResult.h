...
namespace Model {
class CreateWhatsAppMessageTemplateResult {
 public:
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateResult() = default;
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_SOCIALMESSAGING_API CreateWhatsAppMessageTemplateResult& operator=(
  ...
  void SetMetaTemplateId(MetaTemplateIdT&& value) {
    ...
    m_metaTemplateId = std::forward<MetaTemplateIdT>(value);
  }
  template <typename MetaTemplateIdT = Aws::String>
  CreateWhatsAppMessageTemplateResult& WithMetaTemplateId(MetaTemplateIdT&& value) {
    SetMetaTemplateId(std::forward<MetaTemplateIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTemplateStatus(TemplateStatusT&& value) {
    ...
    m_templateStatus = std::forward<TemplateStatusT>(value);
  }
  template <typename TemplateStatusT = Aws::String>
  CreateWhatsAppMessageTemplateResult& WithTemplateStatus(TemplateStatusT&& value) {
    SetTemplateStatus(std::forward<TemplateStatusT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CategoryT = Aws::String>
  CreateWhatsAppMessageTemplateResult& WithCategory(CategoryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateWhatsAppMessageTemplateResult& WithRequestId(RequestIdT&& value) {
