...
/**
 */
class PublishWhatsAppFlowRequest : public SocialMessagingRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "PublishWhatsAppFlow"; }
