...
class ListWhatsAppMessageTemplatesRequest : public SocialMessagingRequest {
 public:
  ...
  template <typename IdT = Aws::String>
  ListWhatsAppMessageTemplatesRequest& WithId(IdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListWhatsAppMessageTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWhatsAppMessageTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
