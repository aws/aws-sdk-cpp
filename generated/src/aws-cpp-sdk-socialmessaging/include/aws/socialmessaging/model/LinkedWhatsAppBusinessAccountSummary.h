...
class LinkedWhatsAppBusinessAccountSummary {
 public:
  ...
  void SetWabaId(WabaIdT&& value) {
    ...
    m_wabaId = std::forward<WabaIdT>(value);
  }
  template <typename WabaIdT = Aws::String>
  LinkedWhatsAppBusinessAccountSummary& WithWabaId(WabaIdT&& value) {
    SetWabaId(std::forward<WabaIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline LinkedWhatsAppBusinessAccountSummary& WithRegistrationStatus(RegistrationStatus value) {
  ...
  void SetLinkDate(LinkDateT&& value) {
    ...
    m_linkDate = std::forward<LinkDateT>(value);
  }
  template <typename LinkDateT = Aws::Utils::DateTime>
  LinkedWhatsAppBusinessAccountSummary& WithLinkDate(LinkDateT&& value) {
    SetLinkDate(std::forward<LinkDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetWabaName(WabaNameT&& value) {
    ...
    m_wabaName = std::forward<WabaNameT>(value);
  }
  template <typename WabaNameT = Aws::String>
  LinkedWhatsAppBusinessAccountSummary& WithWabaName(WabaNameT&& value) {
    SetWabaName(std::forward<WabaNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarketingMessagesOnboardingStatusT = Aws::String>
  LinkedWhatsAppBusinessAccountSummary& WithMarketingMessagesOnboardingStatus(MarketingMessagesOnboardingStatusT&& value) {
