...
namespace Model
{
  ...
  {
  public:
    AWS_SOCIALMESSAGING_API WhatsAppPhoneNumberSummary();
    ...
    inline WhatsAppPhoneNumberSummary& WithArn(const Aws::String& value) { SetArn(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithArn(Aws::String&& value) { SetArn(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithArn(const char* value) { SetArn(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithPhoneNumber(const Aws::String& value) { SetPhoneNumber(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithPhoneNumber(Aws::String&& value) { SetPhoneNumber(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithPhoneNumber(const char* value) { SetPhoneNumber(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithPhoneNumberId(const Aws::String& value) { SetPhoneNumberId(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithPhoneNumberId(Aws::String&& value) { SetPhoneNumberId(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithPhoneNumberId(const char* value) { SetPhoneNumberId(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithMetaPhoneNumberId(const Aws::String& value) { SetMetaPhoneNumberId(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithMetaPhoneNumberId(Aws::String&& value) { SetMetaPhoneNumberId(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithMetaPhoneNumberId(const char* value) { SetMetaPhoneNumberId(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumberName(const Aws::String& value) { SetDisplayPhoneNumberName(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumberName(Aws::String&& value) { SetDisplayPhoneNumberName(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumberName(const char* value) { SetDisplayPhoneNumberName(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumber(const Aws::String& value) { SetDisplayPhoneNumber(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumber(Aws::String&& value) { SetDisplayPhoneNumber(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithDisplayPhoneNumber(const char* value) { SetDisplayPhoneNumber(value); return *this;}
    ///@}
    ...
    inline WhatsAppPhoneNumberSummary& WithQualityRating(const Aws::String& value) { SetQualityRating(value); return *this;}
    inline WhatsAppPhoneNumberSummary& WithQualityRating(Aws::String&& value) { SetQualityRating(std::move(value)); return *this;}
    inline WhatsAppPhoneNumberSummary& WithQualityRating(const char* value) { SetQualityRating(value); return *this;}
    ///@}
  private:
