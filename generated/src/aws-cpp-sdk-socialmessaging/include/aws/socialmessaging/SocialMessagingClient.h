...
namespace SocialMessaging
{
   ...
   */
  class AWS_SOCIALMESSAGING_API SocialMessagingClient : smithy::client::AwsSmithyClientT<Aws::SocialMessaging::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<SocialMessagingClient>
  {
    public:
