...
WhatsAppSignupCallbackResult::WhatsAppSignupCallbackResult(JsonView jsonValue) { *this = jsonValue; }
...
WhatsAppSignupCallbackResult& WhatsAppSignupCallbackResult::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("linkedAccountsWithIncompleteSetup")) {
    Aws::Map<Aws::String, JsonView> linkedAccountsWithIncompleteSetupJsonMap =
        jsonValue.GetObject("linkedAccountsWithIncompleteSetup").GetAllObjects();
    for (auto& linkedAccountsWithIncompleteSetupItem : linkedAccountsWithIncompleteSetupJsonMap) {
      m_linkedAccountsWithIncompleteSetup[linkedAccountsWithIncompleteSetupItem.first] =
          linkedAccountsWithIncompleteSetupItem.second.AsObject();
    }
...
JsonValue WhatsAppSignupCallbackResult::Jsonize() const {
  ...
  if (m_linkedAccountsWithIncompleteSetupHasBeenSet) {
    ...
    for (auto& linkedAccountsWithIncompleteSetupItem : m_linkedAccountsWithIncompleteSetup) {
      linkedAccountsWithIncompleteSetupJsonMap.WithObject(linkedAccountsWithIncompleteSetupItem.first,
                                                          linkedAccountsWithIncompleteSetupItem.second.Jsonize());
    }
