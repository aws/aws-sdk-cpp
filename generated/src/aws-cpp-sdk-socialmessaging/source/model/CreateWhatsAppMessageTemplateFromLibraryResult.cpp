...
CreateWhatsAppMessageTemplateFromLibraryResult::CreateWhatsAppMessageTemplateFromLibraryResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

CreateWhatsAppMessageTemplateFromLibraryResult& CreateWhatsAppMessageTemplateFromLibraryResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
