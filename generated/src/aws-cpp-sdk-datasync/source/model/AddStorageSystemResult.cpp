...
#include <aws/datasync/model/AddStorageSystemResult.h>
...
AddStorageSystemResult& AddStorageSystemResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
