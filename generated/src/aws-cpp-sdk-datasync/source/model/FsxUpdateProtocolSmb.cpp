...
FsxUpdateProtocolSmb::FsxUpdateProtocolSmb() : 
...
FsxUpdateProtocolSmb::FsxUpdateProtocolSmb(JsonView jsonValue)
  : FsxUpdateProtocolSmb()
{
  *this = jsonValue;
}

FsxUpdateProtocolSmb& FsxUpdateProtocolSmb::operator =(JsonView jsonValue)
{
...
JsonValue FsxUpdateProtocolSmb::Jsonize() const
{
  JsonValue payload;
