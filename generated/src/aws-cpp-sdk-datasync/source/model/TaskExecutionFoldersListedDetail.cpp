...
TaskExecutionFoldersListedDetail::TaskExecutionFoldersListedDetail(JsonView jsonValue) { *this = jsonValue; }

TaskExecutionFoldersListedDetail& TaskExecutionFoldersListedDetail::operator=(JsonView jsonValue) {
...
JsonValue TaskExecutionFoldersListedDetail::Jsonize() const {
  JsonValue payload;
