...
TaskExecutionFoldersFailedDetail::TaskExecutionFoldersFailedDetail(JsonView jsonValue) { *this = jsonValue; }

TaskExecutionFoldersFailedDetail& TaskExecutionFoldersFailedDetail::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("List")) {
    m_list = jsonValue.GetInt64("List");
...
JsonValue TaskExecutionFoldersFailedDetail::Jsonize() const {
  JsonValue payload;

  if (m_listHasBeenSet) {
    payload.WithInt64("List", m_list);
  }
