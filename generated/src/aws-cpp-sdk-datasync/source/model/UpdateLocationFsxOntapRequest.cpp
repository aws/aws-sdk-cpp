...
Aws::Http::HeaderValueCollection UpdateLocationFsxOntapRequest::GetRequestSpecificHeaders() const
{
  Aws::Http::HeaderValueCollection headers;
  headers.insert(Aws::Http::HeaderValuePair("X-Amz-Target", "FmrsService.UpdateLocationFsxOntap"));
  return headers;
