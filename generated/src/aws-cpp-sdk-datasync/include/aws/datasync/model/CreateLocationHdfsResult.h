...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API CreateLocationHdfsResult() = default;
    ...
    template<typename LocationArnT = Aws::String>
    CreateLocationHdfsResult& WithLocationArn(LocationArnT&& value) { SetLocationArn(std::forward<LocationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateLocationHdfsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
