...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Specifies the user who has the permissions to access files, folders, and
     * metadata in your file system.</p> <p>For information about choosing a user with
     * the right level of access for your transfer, see <a
     ...
     * belongs to.</p> <p>If you have multiple domains in your environment, configuring
     * this parameter makes sure that DataSync connects to the right file server.</p>
     ...
     * and folders in the file system.</p> <p>For more information, see <a
     * href="https://docs.aws.amazon.com/datasync/latest/userguide/create-fsx-location.html#create-fsx-windows-location-permissions">required
     * permissions</a> for FSx for Windows File Server locations.</p>
     */
