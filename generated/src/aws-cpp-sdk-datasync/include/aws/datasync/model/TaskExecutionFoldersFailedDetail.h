 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/datasync-2018-11-09/TaskExecutionFoldersFailedDetail">AWS
 * API Reference</a></p>
 */
class TaskExecutionFoldersFailedDetail {
 public:
   ...
   * execution.</p>
   */
  inline long long GetList() const { return m_list; }
  inline bool ListHasBeenSet() const { return m_listHasBeenSet; }
  inline void SetList(long long value) {
    m_listHasBeenSet = true;
    m_list = value;
  }
  inline TaskExecutionFoldersFailedDetail& WithList(long long value) {
    SetList(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrepare(long long value) {
    m_prepareHasBeenSet = true;
    m_prepare = value;
  }
  inline TaskExecutionFoldersFailedDetail& WithPrepare(long long value) {
    SetPrepare(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransfer(long long value) {
    m_transferHasBeenSet = true;
    m_transfer = value;
  }
  inline TaskExecutionFoldersFailedDetail& WithTransfer(long long value) {
    SetTransfer(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVerify(long long value) {
    m_verifyHasBeenSet = true;
    m_verify = value;
  }
  inline TaskExecutionFoldersFailedDetail& WithVerify(long long value) {
    SetVerify(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDelete(long long value) {
    m_deleteHasBeenSet = true;
    m_delete = value;
  }
  inline TaskExecutionFoldersFailedDetail& WithDelete(long long value) {
    SetDelete(value);
    return *this;
  }
  ///@}
