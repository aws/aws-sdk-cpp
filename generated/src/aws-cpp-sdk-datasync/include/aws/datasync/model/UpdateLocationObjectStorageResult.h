...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationObjectStorageResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationObjectStorageResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
