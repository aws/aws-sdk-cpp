...
class CreateLocationEfsRequest : public DataSyncRequest {
 public:
  ...
  void SetEfsFilesystemArn(EfsFilesystemArnT&& value) {
    m_efsFilesystemArnHasBeenSet = true;
    m_efsFilesystemArn = std::forward<EfsFilesystemArnT>(value);
  }
  template <typename EfsFilesystemArnT = Aws::String>
  CreateLocationEfsRequest& WithEfsFilesystemArn(EfsFilesystemArnT&& value) {
    SetEfsFilesystemArn(std::forward<EfsFilesystemArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateLocationEfsRequest& WithInTransitEncryption(EfsInTransitEncryption value) {
