...
class TaskExecutionListEntry {
 public:
  ...
  template <typename TaskExecutionArnT = Aws::String>
  TaskExecutionListEntry& WithTaskExecutionArn(TaskExecutionArnT&& value) {
  ...
  inline TaskExecutionListEntry& WithStatus(TaskExecutionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline TaskExecutionListEntry& WithTaskMode(TaskMode value) {
    SetTaskMode(value);
    return *this;
  }
  ///@}
