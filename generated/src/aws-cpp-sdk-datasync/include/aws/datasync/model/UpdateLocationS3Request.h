...
class UpdateLocationS3Request : public DataSyncRequest {
 public:
  ...
  template <typename LocationArnT = Aws::String>
  UpdateLocationS3Request& WithLocationArn(LocationArnT&& value) {
  ...
  template <typename SubdirectoryT = Aws::String>
  UpdateLocationS3Request& WithSubdirectory(SubdirectoryT&& value) {
  ...
  inline UpdateLocationS3Request& WithS3StorageClass(S3StorageClass value) {
  ...
  template <typename S3ConfigT = S3Config>
  UpdateLocationS3Request& WithS3Config(S3ConfigT&& value) {
