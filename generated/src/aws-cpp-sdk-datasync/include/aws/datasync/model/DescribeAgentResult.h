...
class DescribeAgentResult {
 public:
  ...
  inline DescribeAgentResult& WithStatus(AgentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastConnectionTime(LastConnectionTimeT&& value) {
    ...
    m_lastConnectionTime = std::forward<LastConnectionTimeT>(value);
  }
  template <typename LastConnectionTimeT = Aws::Utils::DateTime>
  DescribeAgentResult& WithLastConnectionTime(LastConnectionTimeT&& value) {
    SetLastConnectionTime(std::forward<LastConnectionTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeAgentResult& WithEndpointType(EndpointType value) {
  ...
  void SetPrivateLinkConfig(PrivateLinkConfigT&& value) {
    ...
    m_privateLinkConfig = std::forward<PrivateLinkConfigT>(value);
  }
  template <typename PrivateLinkConfigT = PrivateLinkConfig>
  DescribeAgentResult& WithPrivateLinkConfig(PrivateLinkConfigT&& value) {
    SetPrivateLinkConfig(std::forward<PrivateLinkConfigT>(value));
    return *this;
  }
  ///@}
