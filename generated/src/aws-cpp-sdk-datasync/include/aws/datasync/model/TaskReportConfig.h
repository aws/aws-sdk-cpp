...
class TaskReportConfig {
 public:
  ...
  inline void SetOutputType(ReportOutputType value) {
    m_outputTypeHasBeenSet = true;
    m_outputType = value;
  }
  inline TaskReportConfig& WithOutputType(ReportOutputType value) {
    SetOutputType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReportLevel(ReportLevel value) {
    m_reportLevelHasBeenSet = true;
    m_reportLevel = value;
  }
  inline TaskReportConfig& WithReportLevel(ReportLevel value) {
  ...
  inline void SetObjectVersionIds(ObjectVersionIds value) {
    m_objectVersionIdsHasBeenSet = true;
    m_objectVersionIds = value;
  }
  inline TaskReportConfig& WithObjectVersionIds(ObjectVersionIds value) {
    SetObjectVersionIds(value);
    return *this;
  }
  ///@}
