...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateDiscoveryJobRequest() = default;
    ...
    template<typename DiscoveryJobArnT = Aws::String>
    UpdateDiscoveryJobRequest& WithDiscoveryJobArn(DiscoveryJobArnT&& value) { SetDiscoveryJobArn(std::forward<DiscoveryJobArnT>(value)); return *this;}
    ///@}
