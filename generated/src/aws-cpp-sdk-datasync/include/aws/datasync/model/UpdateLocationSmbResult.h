...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationSmbResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationSmbResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
