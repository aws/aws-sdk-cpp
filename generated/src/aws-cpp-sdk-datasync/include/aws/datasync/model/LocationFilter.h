...
class LocationFilter {
 public:
  ...
  inline void SetName(LocationFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline LocationFilter& WithName(LocationFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  LocationFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  LocationFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(Operator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline LocationFilter& WithOperator(Operator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
