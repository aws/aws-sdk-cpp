...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API GenerateRecommendationsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    GenerateRecommendationsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
