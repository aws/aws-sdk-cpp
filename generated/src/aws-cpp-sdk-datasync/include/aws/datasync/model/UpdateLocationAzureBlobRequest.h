...
class UpdateLocationAzureBlobRequest : public DataSyncRequest {
 public:
  ...
  inline UpdateLocationAzureBlobRequest& WithAuthenticationType(AzureBlobAuthenticationType value) {
  ...
  inline UpdateLocationAzureBlobRequest& WithBlobType(AzureBlobType value) {
    SetBlobType(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLocationAzureBlobRequest& WithAccessTier(AzureAccessTier value) {
    SetAccessTier(value);
    return *this;
  }
  ///@}
