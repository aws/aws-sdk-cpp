...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API DescribeLocationHdfsRequest() = default;
    ...
    template<typename LocationArnT = Aws::String>
    DescribeLocationHdfsRequest& WithLocationArn(LocationArnT&& value) { SetLocationArn(std::forward<LocationArnT>(value)); return *this;}
    ///@}
  private:
