...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationFsxOpenZfsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationFsxOpenZfsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
