...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateDiscoveryJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateDiscoveryJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
