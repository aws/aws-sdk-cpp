...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class DescribeLocationSmbRequest : public DataSyncRequest
  {
  public:
    AWS_DATASYNC_API DescribeLocationSmbRequest() = default;
    ...
    ///@{
    /**
     * <p>Specifies the Amazon Resource Name (ARN) of the SMB location that you want
     * information about.</p>
     */
    ...
    template<typename LocationArnT = Aws::String>
    DescribeLocationSmbRequest& WithLocationArn(LocationArnT&& value) { SetLocationArn(std::forward<LocationArnT>(value)); return *this;}
    ///@}
  private:
