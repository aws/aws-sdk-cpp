...
class ReportOverrides {
 public:
  ...
  void SetTransferred(TransferredT&& value) {
    ...
    m_transferred = std::forward<TransferredT>(value);
  }
  template <typename TransferredT = ReportOverride>
  ReportOverrides& WithTransferred(TransferredT&& value) {
    SetTransferred(std::forward<TransferredT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerified(VerifiedT&& value) {
    ...
    m_verified = std::forward<VerifiedT>(value);
  }
  template <typename VerifiedT = ReportOverride>
  ReportOverrides& WithVerified(VerifiedT&& value) {
    SetVerified(std::forward<VerifiedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSkipped(SkippedT&& value) {
    ...
    m_skipped = std::forward<SkippedT>(value);
  }
  template <typename SkippedT = ReportOverride>
  ReportOverrides& WithSkipped(SkippedT&& value) {
    SetSkipped(std::forward<SkippedT>(value));
    return *this;
  }
  ///@}
 private:
