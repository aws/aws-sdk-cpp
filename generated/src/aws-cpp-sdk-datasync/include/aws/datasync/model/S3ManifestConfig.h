...
class S3ManifestConfig {
 public:
  ...
  void SetManifestObjectPath(ManifestObjectPathT&& value) {
    m_manifestObjectPathHasBeenSet = true;
    m_manifestObjectPath = std::forward<ManifestObjectPathT>(value);
  }
  template <typename ManifestObjectPathT = Aws::String>
  S3ManifestConfig& WithManifestObjectPath(ManifestObjectPathT&& value) {
    SetManifestObjectPath(std::forward<ManifestObjectPathT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename BucketAccessRoleArnT = Aws::String>
  S3ManifestConfig& WithBucketAccessRoleArn(BucketAccessRoleArnT&& value) {
  ...
  template <typename S3BucketArnT = Aws::String>
  S3ManifestConfig& WithS3BucketArn(S3BucketArnT&& value) {
  ...
  void SetManifestObjectVersionId(ManifestObjectVersionIdT&& value) {
    m_manifestObjectVersionIdHasBeenSet = true;
    m_manifestObjectVersionId = std::forward<ManifestObjectVersionIdT>(value);
  }
  template <typename ManifestObjectVersionIdT = Aws::String>
  S3ManifestConfig& WithManifestObjectVersionId(ManifestObjectVersionIdT&& value) {
    SetManifestObjectVersionId(std::forward<ManifestObjectVersionIdT>(value));
    return *this;
  }
  ///@}
 private:
