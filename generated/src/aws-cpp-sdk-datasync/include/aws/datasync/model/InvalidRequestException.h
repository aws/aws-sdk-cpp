...
class InvalidRequestException {
 public:
  ...
  void SetDatasyncErrorCode(DatasyncErrorCodeT&& value) {
    m_datasyncErrorCodeHasBeenSet = true;
    m_datasyncErrorCode = std::forward<DatasyncErrorCodeT>(value);
  }
  template <typename DatasyncErrorCodeT = Aws::String>
  InvalidRequestException& WithDatasyncErrorCode(DatasyncErrorCodeT&& value) {
    SetDatasyncErrorCode(std::forward<DatasyncErrorCodeT>(value));
    return *this;
  }
  ///@}
 private:
