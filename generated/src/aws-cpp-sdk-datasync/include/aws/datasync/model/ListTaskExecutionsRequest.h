...
class ListTaskExecutionsRequest : public DataSyncRequest {
 public:
  AWS_DATASYNC_API ListTaskExecutionsRequest() = default;
  ...
  template <typename TaskArnT = Aws::String>
  ListTaskExecutionsRequest& WithTaskArn(TaskArnT&& value) {
  ...
  inline ListTaskExecutionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTaskExecutionsRequest& WithNextToken(NextTokenT&& value) {
