...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationEfsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationEfsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
