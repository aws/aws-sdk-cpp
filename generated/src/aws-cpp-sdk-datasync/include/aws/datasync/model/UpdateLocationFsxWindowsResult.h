...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationFsxWindowsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationFsxWindowsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
