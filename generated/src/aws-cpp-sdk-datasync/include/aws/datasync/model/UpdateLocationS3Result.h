...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationS3Result() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationS3Result& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
