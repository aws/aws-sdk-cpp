...
class UpdateLocationHdfsRequest : public DataSyncRequest {
 public:
  ...
  inline UpdateLocationHdfsRequest& WithBlockSize(int value) {
    SetBlockSize(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateLocationHdfsRequest& WithReplicationFactor(int value) {
  ...
  inline UpdateLocationHdfsRequest& WithAuthenticationType(HdfsAuthenticationType value) {
