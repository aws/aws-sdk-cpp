...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class CreateLocationNfsResult
  {
  public:
    AWS_DATASYNC_API CreateLocationNfsResult();
    ...
    /**
     * <p>The ARN of the transfer location that you created for your NFS file
     * server.</p>
     */
    ...
    inline CreateLocationNfsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateLocationNfsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateLocationNfsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
