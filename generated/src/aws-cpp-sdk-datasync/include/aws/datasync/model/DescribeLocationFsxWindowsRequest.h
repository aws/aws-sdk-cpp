...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API DescribeLocationFsxWindowsRequest() = default;
    ...
    template<typename LocationArnT = Aws::String>
    DescribeLocationFsxWindowsRequest& WithLocationArn(LocationArnT&& value) { SetLocationArn(std::forward<LocationArnT>(value)); return *this;}
    ///@}
  private:
