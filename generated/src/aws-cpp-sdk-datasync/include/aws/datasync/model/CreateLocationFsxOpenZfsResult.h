...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API CreateLocationFsxOpenZfsResult() = default;
    ...
    template<typename LocationArnT = Aws::String>
    CreateLocationFsxOpenZfsResult& WithLocationArn(LocationArnT&& value) { SetLocationArn(std::forward<LocationArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateLocationFsxOpenZfsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
