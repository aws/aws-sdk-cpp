...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API StopDiscoveryJobResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    StopDiscoveryJobResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
