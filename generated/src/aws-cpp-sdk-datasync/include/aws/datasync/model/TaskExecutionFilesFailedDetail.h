...
class TaskExecutionFilesFailedDetail {
 public:
  ...
  inline TaskExecutionFilesFailedDetail& WithPrepare(long long value) {
    SetPrepare(value);
    return *this;
  }
  ///@}
  ...
  inline TaskExecutionFilesFailedDetail& WithTransfer(long long value) {
    SetTransfer(value);
    return *this;
  }
  ///@}
  ...
  inline TaskExecutionFilesFailedDetail& WithVerify(long long value) {
    SetVerify(value);
    return *this;
  }
  ///@}
  ...
  inline TaskExecutionFilesFailedDetail& WithDelete(long long value) {
    SetDelete(value);
    return *this;
  }
  ///@}
