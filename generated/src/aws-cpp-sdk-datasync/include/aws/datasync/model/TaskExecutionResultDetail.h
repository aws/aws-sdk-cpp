...
class TaskExecutionResultDetail {
 public:
  ...
  inline void SetPrepareDuration(long long value) {
    m_prepareDurationHasBeenSet = true;
    m_prepareDuration = value;
  }
  inline TaskExecutionResultDetail& WithPrepareDuration(long long value) {
    SetPrepareDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrepareStatus(PhaseStatus value) {
    m_prepareStatusHasBeenSet = true;
    m_prepareStatus = value;
  }
  inline TaskExecutionResultDetail& WithPrepareStatus(PhaseStatus value) {
  ...
  inline void SetTotalDuration(long long value) {
    m_totalDurationHasBeenSet = true;
    m_totalDuration = value;
  }
  inline TaskExecutionResultDetail& WithTotalDuration(long long value) {
  ...
  inline void SetTransferDuration(long long value) {
    m_transferDurationHasBeenSet = true;
    m_transferDuration = value;
  }
  inline TaskExecutionResultDetail& WithTransferDuration(long long value) {
  ...
  inline void SetTransferStatus(PhaseStatus value) {
    m_transferStatusHasBeenSet = true;
    m_transferStatus = value;
  }
  inline TaskExecutionResultDetail& WithTransferStatus(PhaseStatus value) {
  ...
  inline void SetVerifyDuration(long long value) {
    m_verifyDurationHasBeenSet = true;
    m_verifyDuration = value;
  }
  inline TaskExecutionResultDetail& WithVerifyDuration(long long value) {
    SetVerifyDuration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetVerifyStatus(PhaseStatus value) {
    m_verifyStatusHasBeenSet = true;
    m_verifyStatus = value;
  }
  inline TaskExecutionResultDetail& WithVerifyStatus(PhaseStatus value) {
