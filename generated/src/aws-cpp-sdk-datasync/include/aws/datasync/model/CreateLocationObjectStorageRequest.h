...
class CreateLocationObjectStorageRequest : public DataSyncRequest {
 public:
  ...
  inline CreateLocationObjectStorageRequest& WithServerPort(int value) {
    SetServerPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLocationObjectStorageRequest& WithServerProtocol(ObjectStorageServerProtocol value) {
