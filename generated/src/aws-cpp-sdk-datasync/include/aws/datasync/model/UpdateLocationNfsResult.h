...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationNfsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationNfsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
