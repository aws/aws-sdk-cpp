...
class TaskScheduleDetails {
 public:
  ...
  void SetStatusUpdateTime(StatusUpdateTimeT&& value) {
    ...
    m_statusUpdateTime = std::forward<StatusUpdateTimeT>(value);
  }
  template <typename StatusUpdateTimeT = Aws::Utils::DateTime>
  TaskScheduleDetails& WithStatusUpdateTime(StatusUpdateTimeT&& value) {
    SetStatusUpdateTime(std::forward<StatusUpdateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisabledBy(ScheduleDisabledBy value) {
    m_disabledByHasBeenSet = true;
    m_disabledBy = value;
  }
  inline TaskScheduleDetails& WithDisabledBy(ScheduleDisabledBy value) {
    SetDisabledBy(value);
    return *this;
  }
  ///@}
