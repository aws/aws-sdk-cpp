 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/datasync-2018-11-09/TaskExecutionFoldersListedDetail">AWS
 * API Reference</a></p>
 */
class TaskExecutionFoldersListedDetail {
 public:
  AWS_DATASYNC_API TaskExecutionFoldersListedDetail() = default;
  AWS_DATASYNC_API TaskExecutionFoldersListedDetail(Aws::Utils::Json::JsonView jsonValue);
  AWS_DATASYNC_API TaskExecutionFoldersListedDetail& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline void SetAtSource(long long value) {
    m_atSourceHasBeenSet = true;
    m_atSource = value;
  }
  inline TaskExecutionFoldersListedDetail& WithAtSource(long long value) {
    SetAtSource(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The number of directories that DataSync finds at your destination location.
  ...
  inline void SetAtDestinationForDelete(long long value) {
    m_atDestinationForDeleteHasBeenSet = true;
    m_atDestinationForDelete = value;
  }
  inline TaskExecutionFoldersListedDetail& WithAtDestinationForDelete(long long value) {
    SetAtDestinationForDelete(value);
    return *this;
  }
  ///@}
 private:
