...
namespace Model
{
  ...
  {
  public:
    AWS_DATASYNC_API UpdateLocationFsxOntapResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateLocationFsxOntapResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
