...
class CreateLocationAzureBlobRequest : public DataSyncRequest {
 public:
  ...
  void SetContainerUrl(ContainerUrlT&& value) {
    m_containerUrlHasBeenSet = true;
    m_containerUrl = std::forward<ContainerUrlT>(value);
  }
  template <typename ContainerUrlT = Aws::String>
  CreateLocationAzureBlobRequest& WithContainerUrl(ContainerUrlT&& value) {
    SetContainerUrl(std::forward<ContainerUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateLocationAzureBlobRequest& WithAuthenticationType(AzureBlobAuthenticationType value) {
  ...
  void SetSasConfiguration(SasConfigurationT&& value) {
    m_sasConfigurationHasBeenSet = true;
    m_sasConfiguration = std::forward<SasConfigurationT>(value);
  }
  template <typename SasConfigurationT = AzureBlobSasConfiguration>
  CreateLocationAzureBlobRequest& WithSasConfiguration(SasConfigurationT&& value) {
    SetSasConfiguration(std::forward<SasConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateLocationAzureBlobRequest& WithBlobType(AzureBlobType value) {
    SetBlobType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLocationAzureBlobRequest& WithAccessTier(AzureAccessTier value) {
    SetAccessTier(value);
    return *this;
  }
  ///@}
