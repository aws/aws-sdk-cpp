...
namespace DataSync
{
   ...
   * User Guide</a> </i>.</p>
   */
  class AWS_DATASYNC_API DataSyncClient : Aws::Client::ClientWithAsyncTemplateMethods<DataSyncClient>,
    smithy::client::AwsSmithyClientT<Aws::DataSync::SERVICE_NAME,
