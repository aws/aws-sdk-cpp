...
namespace GlobalAccelerator
{
   ...
   */
  class AWS_GLOBALACCELERATOR_API GlobalAcceleratorClient : Aws::Client::ClientWithAsyncTemplateMethods<GlobalAcceleratorClient>,
    smithy::client::AwsSmithyClientT<Aws::GlobalAccelerator::SERVICE_NAME,
