...
class AWS_GLOBALACCELERATOR_API GlobalAcceleratorClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  GlobalAcceleratorClient(const Aws::GlobalAccelerator::GlobalAcceleratorClientConfiguration& clientConfiguration =
                              Aws::GlobalAccelerator::GlobalAcceleratorClientConfiguration(),
  ...
  GlobalAcceleratorClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<GlobalAcceleratorEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::GlobalAccelerator::GlobalAcceleratorClientConfiguration& clientConfiguration =
                              Aws::GlobalAccelerator::GlobalAcceleratorClientConfiguration());
  ...
  /**
   * A Callable wrapper for AddCustomRoutingEndpoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AddCustomRoutingEndpointsRequestT = Model::AddCustomRoutingEndpointsRequest>
  Model::AddCustomRoutingEndpointsOutcomeCallable AddCustomRoutingEndpointsCallable(
      const AddCustomRoutingEndpointsRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::AddCustomRoutingEndpoints, request);
  }

  /**
   * An Async wrapper for AddCustomRoutingEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AddCustomRoutingEndpointsRequestT = Model::AddCustomRoutingEndpointsRequest>
  void AddCustomRoutingEndpointsAsync(const AddCustomRoutingEndpointsRequestT& request,
                                      const AddCustomRoutingEndpointsResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for AddEndpoints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddEndpointsRequestT = Model::AddEndpointsRequest>
  void AddEndpointsAsync(const AddEndpointsRequestT& request, const AddEndpointsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AdvertiseByoipCidr that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AdvertiseByoipCidr that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AdvertiseByoipCidrRequestT = Model::AdvertiseByoipCidrRequest>
  void AdvertiseByoipCidrAsync(const AdvertiseByoipCidrRequestT& request, const AdvertiseByoipCidrResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AllowCustomRoutingTraffic that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename AllowCustomRoutingTrafficRequestT = Model::AllowCustomRoutingTrafficRequest>
  Model::AllowCustomRoutingTrafficOutcomeCallable AllowCustomRoutingTrafficCallable(
      const AllowCustomRoutingTrafficRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::AllowCustomRoutingTraffic, request);
  }

  /**
   * An Async wrapper for AllowCustomRoutingTraffic that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AllowCustomRoutingTrafficRequestT = Model::AllowCustomRoutingTrafficRequest>
  void AllowCustomRoutingTrafficAsync(const AllowCustomRoutingTrafficRequestT& request,
                                      const AllowCustomRoutingTrafficResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAccelerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAccelerator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAcceleratorRequestT = Model::CreateAcceleratorRequest>
  void CreateAcceleratorAsync(const CreateAcceleratorRequestT& request, const CreateAcceleratorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCrossAccountAttachmentOutcome CreateCrossAccountAttachment(
      const Model::CreateCrossAccountAttachmentRequest& request) const;

  /**
   * A Callable wrapper for CreateCrossAccountAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCrossAccountAttachmentRequestT = Model::CreateCrossAccountAttachmentRequest>
  Model::CreateCrossAccountAttachmentOutcomeCallable CreateCrossAccountAttachmentCallable(
      const CreateCrossAccountAttachmentRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::CreateCrossAccountAttachment, request);
  }

  /**
   * An Async wrapper for CreateCrossAccountAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCrossAccountAttachmentRequestT = Model::CreateCrossAccountAttachmentRequest>
  void CreateCrossAccountAttachmentAsync(const CreateCrossAccountAttachmentRequestT& request,
                                         const CreateCrossAccountAttachmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomRoutingAcceleratorOutcome CreateCustomRoutingAccelerator(
      const Model::CreateCustomRoutingAcceleratorRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomRoutingAccelerator that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomRoutingAcceleratorRequestT = Model::CreateCustomRoutingAcceleratorRequest>
  Model::CreateCustomRoutingAcceleratorOutcomeCallable CreateCustomRoutingAcceleratorCallable(
      const CreateCustomRoutingAcceleratorRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::CreateCustomRoutingAccelerator, request);
  }

  /**
   * An Async wrapper for CreateCustomRoutingAccelerator that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateCustomRoutingAcceleratorRequestT = Model::CreateCustomRoutingAcceleratorRequest>
  void CreateCustomRoutingAcceleratorAsync(const CreateCustomRoutingAcceleratorRequestT& request,
                                           const CreateCustomRoutingAcceleratorResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomRoutingEndpointGroupOutcome CreateCustomRoutingEndpointGroup(
      const Model::CreateCustomRoutingEndpointGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomRoutingEndpointGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateCustomRoutingEndpointGroupRequestT = Model::CreateCustomRoutingEndpointGroupRequest>
  Model::CreateCustomRoutingEndpointGroupOutcomeCallable CreateCustomRoutingEndpointGroupCallable(
      const CreateCustomRoutingEndpointGroupRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::CreateCustomRoutingEndpointGroup, request);
  }

  /**
   * An Async wrapper for CreateCustomRoutingEndpointGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateCustomRoutingEndpointGroupRequestT = Model::CreateCustomRoutingEndpointGroupRequest>
  void CreateCustomRoutingEndpointGroupAsync(const CreateCustomRoutingEndpointGroupRequestT& request,
                                             const CreateCustomRoutingEndpointGroupResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::CreateCustomRoutingListenerOutcome CreateCustomRoutingListener(
      const Model::CreateCustomRoutingListenerRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomRoutingListener that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomRoutingListenerRequestT = Model::CreateCustomRoutingListenerRequest>
  Model::CreateCustomRoutingListenerOutcomeCallable CreateCustomRoutingListenerCallable(
      const CreateCustomRoutingListenerRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::CreateCustomRoutingListener, request);
  }

  /**
   * An Async wrapper for CreateCustomRoutingListener that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomRoutingListenerRequestT = Model::CreateCustomRoutingListenerRequest>
  void CreateCustomRoutingListenerAsync(const CreateCustomRoutingListenerRequestT& request,
                                        const CreateCustomRoutingListenerResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEndpointGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEndpointGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateEndpointGroupRequestT = Model::CreateEndpointGroupRequest>
  void CreateEndpointGroupAsync(const CreateEndpointGroupRequestT& request, const CreateEndpointGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAccelerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAccelerator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAcceleratorRequestT = Model::DeleteAcceleratorRequest>
  void DeleteAcceleratorAsync(const DeleteAcceleratorRequestT& request, const DeleteAcceleratorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCrossAccountAttachmentOutcome DeleteCrossAccountAttachment(
      const Model::DeleteCrossAccountAttachmentRequest& request) const;

  /**
   * A Callable wrapper for DeleteCrossAccountAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCrossAccountAttachmentRequestT = Model::DeleteCrossAccountAttachmentRequest>
  Model::DeleteCrossAccountAttachmentOutcomeCallable DeleteCrossAccountAttachmentCallable(
      const DeleteCrossAccountAttachmentRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DeleteCrossAccountAttachment, request);
  }

  /**
   * An Async wrapper for DeleteCrossAccountAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCrossAccountAttachmentRequestT = Model::DeleteCrossAccountAttachmentRequest>
  void DeleteCrossAccountAttachmentAsync(const DeleteCrossAccountAttachmentRequestT& request,
                                         const DeleteCrossAccountAttachmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomRoutingAcceleratorOutcome DeleteCustomRoutingAccelerator(
      const Model::DeleteCustomRoutingAcceleratorRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomRoutingAccelerator that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomRoutingAcceleratorRequestT = Model::DeleteCustomRoutingAcceleratorRequest>
  Model::DeleteCustomRoutingAcceleratorOutcomeCallable DeleteCustomRoutingAcceleratorCallable(
      const DeleteCustomRoutingAcceleratorRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DeleteCustomRoutingAccelerator, request);
  }

  /**
   * An Async wrapper for DeleteCustomRoutingAccelerator that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCustomRoutingAcceleratorRequestT = Model::DeleteCustomRoutingAcceleratorRequest>
  void DeleteCustomRoutingAcceleratorAsync(const DeleteCustomRoutingAcceleratorRequestT& request,
                                           const DeleteCustomRoutingAcceleratorResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomRoutingEndpointGroupOutcome DeleteCustomRoutingEndpointGroup(
      const Model::DeleteCustomRoutingEndpointGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomRoutingEndpointGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteCustomRoutingEndpointGroupRequestT = Model::DeleteCustomRoutingEndpointGroupRequest>
  Model::DeleteCustomRoutingEndpointGroupOutcomeCallable DeleteCustomRoutingEndpointGroupCallable(
      const DeleteCustomRoutingEndpointGroupRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DeleteCustomRoutingEndpointGroup, request);
  }

  /**
   * An Async wrapper for DeleteCustomRoutingEndpointGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteCustomRoutingEndpointGroupRequestT = Model::DeleteCustomRoutingEndpointGroupRequest>
  void DeleteCustomRoutingEndpointGroupAsync(const DeleteCustomRoutingEndpointGroupRequestT& request,
                                             const DeleteCustomRoutingEndpointGroupResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomRoutingListenerOutcome DeleteCustomRoutingListener(
      const Model::DeleteCustomRoutingListenerRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomRoutingListener that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomRoutingListenerRequestT = Model::DeleteCustomRoutingListenerRequest>
  Model::DeleteCustomRoutingListenerOutcomeCallable DeleteCustomRoutingListenerCallable(
      const DeleteCustomRoutingListenerRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DeleteCustomRoutingListener, request);
  }

  /**
   * An Async wrapper for DeleteCustomRoutingListener that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomRoutingListenerRequestT = Model::DeleteCustomRoutingListenerRequest>
  void DeleteCustomRoutingListenerAsync(const DeleteCustomRoutingListenerRequestT& request,
                                        const DeleteCustomRoutingListenerResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEndpointGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEndpointGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteEndpointGroupRequestT = Model::DeleteEndpointGroupRequest>
  void DeleteEndpointGroupAsync(const DeleteEndpointGroupRequestT& request, const DeleteEndpointGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DenyCustomRoutingTraffic that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DenyCustomRoutingTraffic that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DenyCustomRoutingTrafficRequestT = Model::DenyCustomRoutingTrafficRequest>
  void DenyCustomRoutingTrafficAsync(const DenyCustomRoutingTrafficRequestT& request,
                                     const DenyCustomRoutingTrafficResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeprovisionByoipCidr that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeprovisionByoipCidr that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeprovisionByoipCidrRequestT = Model::DeprovisionByoipCidrRequest>
  void DeprovisionByoipCidrAsync(const DeprovisionByoipCidrRequestT& request, const DeprovisionByoipCidrResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAccelerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccelerator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeAcceleratorRequestT = Model::DescribeAcceleratorRequest>
  void DescribeAcceleratorAsync(const DescribeAcceleratorRequestT& request, const DescribeAcceleratorResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeAcceleratorAttributesOutcome DescribeAcceleratorAttributes(
      const Model::DescribeAcceleratorAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeAcceleratorAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAcceleratorAttributesRequestT = Model::DescribeAcceleratorAttributesRequest>
  Model::DescribeAcceleratorAttributesOutcomeCallable DescribeAcceleratorAttributesCallable(
      const DescribeAcceleratorAttributesRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeAcceleratorAttributes, request);
  }

  /**
   * An Async wrapper for DescribeAcceleratorAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAcceleratorAttributesRequestT = Model::DescribeAcceleratorAttributesRequest>
  void DescribeAcceleratorAttributesAsync(const DescribeAcceleratorAttributesRequestT& request,
                                          const DescribeAcceleratorAttributesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCrossAccountAttachmentOutcome DescribeCrossAccountAttachment(
      const Model::DescribeCrossAccountAttachmentRequest& request) const;

  /**
   * A Callable wrapper for DescribeCrossAccountAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCrossAccountAttachmentRequestT = Model::DescribeCrossAccountAttachmentRequest>
  Model::DescribeCrossAccountAttachmentOutcomeCallable DescribeCrossAccountAttachmentCallable(
      const DescribeCrossAccountAttachmentRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeCrossAccountAttachment, request);
  }

  /**
   * An Async wrapper for DescribeCrossAccountAttachment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCrossAccountAttachmentRequestT = Model::DescribeCrossAccountAttachmentRequest>
  void DescribeCrossAccountAttachmentAsync(const DescribeCrossAccountAttachmentRequestT& request,
                                           const DescribeCrossAccountAttachmentResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomRoutingAcceleratorOutcome DescribeCustomRoutingAccelerator(
      const Model::DescribeCustomRoutingAcceleratorRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomRoutingAccelerator that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeCustomRoutingAcceleratorRequestT = Model::DescribeCustomRoutingAcceleratorRequest>
  Model::DescribeCustomRoutingAcceleratorOutcomeCallable DescribeCustomRoutingAcceleratorCallable(
      const DescribeCustomRoutingAcceleratorRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeCustomRoutingAccelerator, request);
  }

  /**
   * An Async wrapper for DescribeCustomRoutingAccelerator that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCustomRoutingAcceleratorRequestT = Model::DescribeCustomRoutingAcceleratorRequest>
  void DescribeCustomRoutingAcceleratorAsync(const DescribeCustomRoutingAcceleratorRequestT& request,
                                             const DescribeCustomRoutingAcceleratorResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomRoutingAcceleratorAttributesOutcome DescribeCustomRoutingAcceleratorAttributes(
      const Model::DescribeCustomRoutingAcceleratorAttributesRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomRoutingAcceleratorAttributes that returns a future to the operation so that it can be executed in
  ...
  Model::DescribeCustomRoutingAcceleratorAttributesOutcomeCallable DescribeCustomRoutingAcceleratorAttributesCallable(
      const DescribeCustomRoutingAcceleratorAttributesRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeCustomRoutingAcceleratorAttributes, request);
  }

  /**
   * An Async wrapper for DescribeCustomRoutingAcceleratorAttributes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DescribeCustomRoutingAcceleratorAttributesRequestT = Model::DescribeCustomRoutingAcceleratorAttributesRequest>
  void DescribeCustomRoutingAcceleratorAttributesAsync(
      const DescribeCustomRoutingAcceleratorAttributesRequestT& request,
      const DescribeCustomRoutingAcceleratorAttributesResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomRoutingEndpointGroupOutcome DescribeCustomRoutingEndpointGroup(
      const Model::DescribeCustomRoutingEndpointGroupRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomRoutingEndpointGroup that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeCustomRoutingEndpointGroupRequestT = Model::DescribeCustomRoutingEndpointGroupRequest>
  Model::DescribeCustomRoutingEndpointGroupOutcomeCallable DescribeCustomRoutingEndpointGroupCallable(
      const DescribeCustomRoutingEndpointGroupRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeCustomRoutingEndpointGroup, request);
  }

  /**
   * An Async wrapper for DescribeCustomRoutingEndpointGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCustomRoutingEndpointGroupRequestT = Model::DescribeCustomRoutingEndpointGroupRequest>
  void DescribeCustomRoutingEndpointGroupAsync(const DescribeCustomRoutingEndpointGroupRequestT& request,
                                               const DescribeCustomRoutingEndpointGroupResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomRoutingListenerOutcome DescribeCustomRoutingListener(
      const Model::DescribeCustomRoutingListenerRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomRoutingListener that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeCustomRoutingListenerRequestT = Model::DescribeCustomRoutingListenerRequest>
  Model::DescribeCustomRoutingListenerOutcomeCallable DescribeCustomRoutingListenerCallable(
      const DescribeCustomRoutingListenerRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::DescribeCustomRoutingListener, request);
  }

  /**
   * An Async wrapper for DescribeCustomRoutingListener that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeCustomRoutingListenerRequestT = Model::DescribeCustomRoutingListenerRequest>
  void DescribeCustomRoutingListenerAsync(const DescribeCustomRoutingListenerRequestT& request,
                                          const DescribeCustomRoutingListenerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeEndpointGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpointGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointGroupRequestT = Model::DescribeEndpointGroupRequest>
  void DescribeEndpointGroupAsync(const DescribeEndpointGroupRequestT& request, const DescribeEndpointGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeListener that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeListener that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeListenerRequestT = Model::DescribeListenerRequest>
  void DescribeListenerAsync(const DescribeListenerRequestT& request, const DescribeListenerResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAccelerators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAccelerators that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAcceleratorsRequestT = Model::ListAcceleratorsRequest>
  void ListAcceleratorsAsync(const ListAcceleratorsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListAcceleratorsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListByoipCidrs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListByoipCidrsRequestT = Model::ListByoipCidrsRequest>
  void ListByoipCidrsAsync(const ListByoipCidrsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const ListByoipCidrsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCrossAccountAttachmentsOutcome ListCrossAccountAttachments(
      const Model::ListCrossAccountAttachmentsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCrossAccountAttachments that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCrossAccountAttachmentsRequestT = Model::ListCrossAccountAttachmentsRequest>
  Model::ListCrossAccountAttachmentsOutcomeCallable ListCrossAccountAttachmentsCallable(
      const ListCrossAccountAttachmentsRequestT& request = {}) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCrossAccountAttachments, request);
  }

  /**
   * An Async wrapper for ListCrossAccountAttachments that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCrossAccountAttachmentsRequestT = Model::ListCrossAccountAttachmentsRequest>
  void ListCrossAccountAttachmentsAsync(const ListCrossAccountAttachmentsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const ListCrossAccountAttachmentsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCrossAccountResourceAccountsOutcome ListCrossAccountResourceAccounts(
      const Model::ListCrossAccountResourceAccountsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCrossAccountResourceAccounts that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListCrossAccountResourceAccountsRequestT = Model::ListCrossAccountResourceAccountsRequest>
  Model::ListCrossAccountResourceAccountsOutcomeCallable ListCrossAccountResourceAccountsCallable(
      const ListCrossAccountResourceAccountsRequestT& request = {}) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCrossAccountResourceAccounts, request);
  }

  /**
   * An Async wrapper for ListCrossAccountResourceAccounts that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCrossAccountResourceAccountsRequestT = Model::ListCrossAccountResourceAccountsRequest>
  void ListCrossAccountResourceAccountsAsync(const ListCrossAccountResourceAccountsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const ListCrossAccountResourceAccountsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCrossAccountResources that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCrossAccountResourcesRequestT = Model::ListCrossAccountResourcesRequest>
  Model::ListCrossAccountResourcesOutcomeCallable ListCrossAccountResourcesCallable(
      const ListCrossAccountResourcesRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCrossAccountResources, request);
  }

  /**
   * An Async wrapper for ListCrossAccountResources that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCrossAccountResourcesRequestT = Model::ListCrossAccountResourcesRequest>
  void ListCrossAccountResourcesAsync(const ListCrossAccountResourcesRequestT& request,
                                      const ListCrossAccountResourcesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomRoutingAcceleratorsOutcome ListCustomRoutingAccelerators(
      const Model::ListCustomRoutingAcceleratorsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListCustomRoutingAccelerators that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomRoutingAcceleratorsRequestT = Model::ListCustomRoutingAcceleratorsRequest>
  Model::ListCustomRoutingAcceleratorsOutcomeCallable ListCustomRoutingAcceleratorsCallable(
      const ListCustomRoutingAcceleratorsRequestT& request = {}) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCustomRoutingAccelerators, request);
  }

  /**
   * An Async wrapper for ListCustomRoutingAccelerators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomRoutingAcceleratorsRequestT = Model::ListCustomRoutingAcceleratorsRequest>
  void ListCustomRoutingAcceleratorsAsync(const ListCustomRoutingAcceleratorsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const ListCustomRoutingAcceleratorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomRoutingEndpointGroupsOutcome ListCustomRoutingEndpointGroups(
      const Model::ListCustomRoutingEndpointGroupsRequest& request) const;

  /**
   * A Callable wrapper for ListCustomRoutingEndpointGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomRoutingEndpointGroupsRequestT = Model::ListCustomRoutingEndpointGroupsRequest>
  Model::ListCustomRoutingEndpointGroupsOutcomeCallable ListCustomRoutingEndpointGroupsCallable(
      const ListCustomRoutingEndpointGroupsRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCustomRoutingEndpointGroups, request);
  }

  /**
   * An Async wrapper for ListCustomRoutingEndpointGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListCustomRoutingEndpointGroupsRequestT = Model::ListCustomRoutingEndpointGroupsRequest>
  void ListCustomRoutingEndpointGroupsAsync(const ListCustomRoutingEndpointGroupsRequestT& request,
                                            const ListCustomRoutingEndpointGroupsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomRoutingListenersOutcome ListCustomRoutingListeners(
      const Model::ListCustomRoutingListenersRequest& request) const;

  /**
   * A Callable wrapper for ListCustomRoutingListeners that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomRoutingListenersRequestT = Model::ListCustomRoutingListenersRequest>
  Model::ListCustomRoutingListenersOutcomeCallable ListCustomRoutingListenersCallable(
      const ListCustomRoutingListenersRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCustomRoutingListeners, request);
  }

  /**
   * An Async wrapper for ListCustomRoutingListeners that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomRoutingListenersRequestT = Model::ListCustomRoutingListenersRequest>
  void ListCustomRoutingListenersAsync(const ListCustomRoutingListenersRequestT& request,
                                       const ListCustomRoutingListenersResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomRoutingPortMappingsOutcome ListCustomRoutingPortMappings(
      const Model::ListCustomRoutingPortMappingsRequest& request) const;

  /**
   * A Callable wrapper for ListCustomRoutingPortMappings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListCustomRoutingPortMappingsRequestT = Model::ListCustomRoutingPortMappingsRequest>
  Model::ListCustomRoutingPortMappingsOutcomeCallable ListCustomRoutingPortMappingsCallable(
      const ListCustomRoutingPortMappingsRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCustomRoutingPortMappings, request);
  }

  /**
   * An Async wrapper for ListCustomRoutingPortMappings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomRoutingPortMappingsRequestT = Model::ListCustomRoutingPortMappingsRequest>
  void ListCustomRoutingPortMappingsAsync(const ListCustomRoutingPortMappingsRequestT& request,
                                          const ListCustomRoutingPortMappingsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListCustomRoutingPortMappingsByDestinationOutcome ListCustomRoutingPortMappingsByDestination(
      const Model::ListCustomRoutingPortMappingsByDestinationRequest& request) const;

  /**
   * A Callable wrapper for ListCustomRoutingPortMappingsByDestination that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::ListCustomRoutingPortMappingsByDestinationOutcomeCallable ListCustomRoutingPortMappingsByDestinationCallable(
      const ListCustomRoutingPortMappingsByDestinationRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::ListCustomRoutingPortMappingsByDestination, request);
  }

  /**
   * An Async wrapper for ListCustomRoutingPortMappingsByDestination that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListCustomRoutingPortMappingsByDestinationRequestT = Model::ListCustomRoutingPortMappingsByDestinationRequest>
  void ListCustomRoutingPortMappingsByDestinationAsync(
      const ListCustomRoutingPortMappingsByDestinationRequestT& request,
      const ListCustomRoutingPortMappingsByDestinationResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListEndpointGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListEndpointGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListEndpointGroupsRequestT = Model::ListEndpointGroupsRequest>
  void ListEndpointGroupsAsync(const ListEndpointGroupsRequestT& request, const ListEndpointGroupsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ProvisionByoipCidr that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ProvisionByoipCidr that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ProvisionByoipCidrRequestT = Model::ProvisionByoipCidrRequest>
  void ProvisionByoipCidrAsync(const ProvisionByoipCidrRequestT& request, const ProvisionByoipCidrResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RemoveCustomRoutingEndpointsOutcome RemoveCustomRoutingEndpoints(
      const Model::RemoveCustomRoutingEndpointsRequest& request) const;

  /**
   * A Callable wrapper for RemoveCustomRoutingEndpoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RemoveCustomRoutingEndpointsRequestT = Model::RemoveCustomRoutingEndpointsRequest>
  Model::RemoveCustomRoutingEndpointsOutcomeCallable RemoveCustomRoutingEndpointsCallable(
      const RemoveCustomRoutingEndpointsRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::RemoveCustomRoutingEndpoints, request);
  }

  /**
   * An Async wrapper for RemoveCustomRoutingEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveCustomRoutingEndpointsRequestT = Model::RemoveCustomRoutingEndpointsRequest>
  void RemoveCustomRoutingEndpointsAsync(const RemoveCustomRoutingEndpointsRequestT& request,
                                         const RemoveCustomRoutingEndpointsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RemoveEndpoints that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RemoveEndpointsRequestT = Model::RemoveEndpointsRequest>
  void RemoveEndpointsAsync(const RemoveEndpointsRequestT& request, const RemoveEndpointsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAccelerator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAccelerator that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAcceleratorRequestT = Model::UpdateAcceleratorRequest>
  void UpdateAcceleratorAsync(const UpdateAcceleratorRequestT& request, const UpdateAcceleratorResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateAcceleratorAttributesOutcome UpdateAcceleratorAttributes(
      const Model::UpdateAcceleratorAttributesRequest& request) const;

  /**
   * A Callable wrapper for UpdateAcceleratorAttributes that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateAcceleratorAttributesRequestT = Model::UpdateAcceleratorAttributesRequest>
  Model::UpdateAcceleratorAttributesOutcomeCallable UpdateAcceleratorAttributesCallable(
      const UpdateAcceleratorAttributesRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::UpdateAcceleratorAttributes, request);
  }

  /**
   * An Async wrapper for UpdateAcceleratorAttributes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAcceleratorAttributesRequestT = Model::UpdateAcceleratorAttributesRequest>
  void UpdateAcceleratorAttributesAsync(const UpdateAcceleratorAttributesRequestT& request,
                                        const UpdateAcceleratorAttributesResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCrossAccountAttachmentOutcome UpdateCrossAccountAttachment(
      const Model::UpdateCrossAccountAttachmentRequest& request) const;

  /**
   * A Callable wrapper for UpdateCrossAccountAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCrossAccountAttachmentRequestT = Model::UpdateCrossAccountAttachmentRequest>
  Model::UpdateCrossAccountAttachmentOutcomeCallable UpdateCrossAccountAttachmentCallable(
      const UpdateCrossAccountAttachmentRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::UpdateCrossAccountAttachment, request);
  }

  /**
   * An Async wrapper for UpdateCrossAccountAttachment that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCrossAccountAttachmentRequestT = Model::UpdateCrossAccountAttachmentRequest>
  void UpdateCrossAccountAttachmentAsync(const UpdateCrossAccountAttachmentRequestT& request,
                                         const UpdateCrossAccountAttachmentResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCustomRoutingAcceleratorOutcome UpdateCustomRoutingAccelerator(
      const Model::UpdateCustomRoutingAcceleratorRequest& request) const;

  /**
   * A Callable wrapper for UpdateCustomRoutingAccelerator that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCustomRoutingAcceleratorRequestT = Model::UpdateCustomRoutingAcceleratorRequest>
  Model::UpdateCustomRoutingAcceleratorOutcomeCallable UpdateCustomRoutingAcceleratorCallable(
      const UpdateCustomRoutingAcceleratorRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::UpdateCustomRoutingAccelerator, request);
  }

  /**
   * An Async wrapper for UpdateCustomRoutingAccelerator that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateCustomRoutingAcceleratorRequestT = Model::UpdateCustomRoutingAcceleratorRequest>
  void UpdateCustomRoutingAcceleratorAsync(const UpdateCustomRoutingAcceleratorRequestT& request,
                                           const UpdateCustomRoutingAcceleratorResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateCustomRoutingAcceleratorAttributesOutcome UpdateCustomRoutingAcceleratorAttributes(
      const Model::UpdateCustomRoutingAcceleratorAttributesRequest& request) const;

  /**
   * A Callable wrapper for UpdateCustomRoutingAcceleratorAttributes that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateCustomRoutingAcceleratorAttributesRequestT = Model::UpdateCustomRoutingAcceleratorAttributesRequest>
  Model::UpdateCustomRoutingAcceleratorAttributesOutcomeCallable UpdateCustomRoutingAcceleratorAttributesCallable(
      const UpdateCustomRoutingAcceleratorAttributesRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::UpdateCustomRoutingAcceleratorAttributes, request);
  }

  /**
   * An Async wrapper for UpdateCustomRoutingAcceleratorAttributes that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateCustomRoutingAcceleratorAttributesRequestT = Model::UpdateCustomRoutingAcceleratorAttributesRequest>
  void UpdateCustomRoutingAcceleratorAttributesAsync(
      const UpdateCustomRoutingAcceleratorAttributesRequestT& request,
      const UpdateCustomRoutingAcceleratorAttributesResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateCustomRoutingListenerOutcome UpdateCustomRoutingListener(
      const Model::UpdateCustomRoutingListenerRequest& request) const;

  /**
   * A Callable wrapper for UpdateCustomRoutingListener that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateCustomRoutingListenerRequestT = Model::UpdateCustomRoutingListenerRequest>
  Model::UpdateCustomRoutingListenerOutcomeCallable UpdateCustomRoutingListenerCallable(
      const UpdateCustomRoutingListenerRequestT& request) const {
    return SubmitCallable(&GlobalAcceleratorClient::UpdateCustomRoutingListener, request);
  }

  /**
   * An Async wrapper for UpdateCustomRoutingListener that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateCustomRoutingListenerRequestT = Model::UpdateCustomRoutingListenerRequest>
  void UpdateCustomRoutingListenerAsync(const UpdateCustomRoutingListenerRequestT& request,
                                        const UpdateCustomRoutingListenerResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateEndpointGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateEndpointGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateEndpointGroupRequestT = Model::UpdateEndpointGroupRequest>
  void UpdateEndpointGroupAsync(const UpdateEndpointGroupRequestT& request, const UpdateEndpointGroupResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for WithdrawByoipCidr that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for WithdrawByoipCidr that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename WithdrawByoipCidrRequestT = Model::WithdrawByoipCidrRequest>
  void WithdrawByoipCidrAsync(const WithdrawByoipCidrRequestT& request, const WithdrawByoipCidrResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
