...
class UpdateListenerRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  UpdateListenerRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  template <typename PortRangesT = Aws::Vector<PortRange>>
  UpdateListenerRequest& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = PortRange>
  UpdateListenerRequest& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
  ...
  inline UpdateListenerRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateListenerRequest& WithClientAffinity(ClientAffinity value) {
