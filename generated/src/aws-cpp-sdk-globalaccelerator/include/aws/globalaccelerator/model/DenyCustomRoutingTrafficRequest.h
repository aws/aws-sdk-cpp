...
class DenyCustomRoutingTrafficRequest : public GlobalAcceleratorRequest {
 public:
  ...
  inline DenyCustomRoutingTrafficRequest& AddDestinationPorts(int value) {
    m_destinationPortsHasBeenSet = true;
  ...
  inline void SetDenyAllTrafficToEndpoint(bool value) {
    m_denyAllTrafficToEndpointHasBeenSet = true;
    m_denyAllTrafficToEndpoint = value;
  }
  inline DenyCustomRoutingTrafficRequest& WithDenyAllTrafficToEndpoint(bool value) {
    SetDenyAllTrafficToEndpoint(value);
    return *this;
  }
  ///@}
 private:
