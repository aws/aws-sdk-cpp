...
class ListEndpointGroupsRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename ListenerArnT = Aws::String>
  ListEndpointGroupsRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  inline ListEndpointGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListEndpointGroupsRequest& WithNextToken(NextTokenT&& value) {
