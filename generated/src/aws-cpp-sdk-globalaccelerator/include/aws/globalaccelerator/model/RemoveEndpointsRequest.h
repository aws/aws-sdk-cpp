...
class RemoveEndpointsRequest : public GlobalAcceleratorRequest {
 public:
  ...
  void SetEndpointIdentifiers(EndpointIdentifiersT&& value) {
    m_endpointIdentifiersHasBeenSet = true;
    m_endpointIdentifiers = std::forward<EndpointIdentifiersT>(value);
  }
  template <typename EndpointIdentifiersT = Aws::Vector<EndpointIdentifier>>
  RemoveEndpointsRequest& WithEndpointIdentifiers(EndpointIdentifiersT&& value) {
    SetEndpointIdentifiers(std::forward<EndpointIdentifiersT>(value));
    return *this;
  }
  ...
  RemoveEndpointsRequest& AddEndpointIdentifiers(EndpointIdentifiersT&& value) {
    m_endpointIdentifiersHasBeenSet = true;
    m_endpointIdentifiers.emplace_back(std::forward<EndpointIdentifiersT>(value));
    return *this;
  }
  ///@}
