...
class ListCustomRoutingListenersRequest : public GlobalAcceleratorRequest {
 public:
  AWS_GLOBALACCELERATOR_API ListCustomRoutingListenersRequest() = default;
  ...
  template <typename AcceleratorArnT = Aws::String>
  ListCustomRoutingListenersRequest& WithAcceleratorArn(AcceleratorArnT&& value) {
  ...
  inline ListCustomRoutingListenersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingListenersRequest& WithNextToken(NextTokenT&& value) {
