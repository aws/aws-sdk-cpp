...
class CreateCustomRoutingAcceleratorRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateCustomRoutingAcceleratorRequest& WithName(NameT&& value) {
  ...
  inline CreateCustomRoutingAcceleratorRequest& WithIpAddressType(IpAddressType value) {
  ...
  template <typename IpAddressesT = Aws::Vector<Aws::String>>
  CreateCustomRoutingAcceleratorRequest& WithIpAddresses(IpAddressesT&& value) {
    SetIpAddresses(std::forward<IpAddressesT>(value));
    return *this;
  }
  template <typename IpAddressesT = Aws::String>
  CreateCustomRoutingAcceleratorRequest& AddIpAddresses(IpAddressesT&& value) {
    m_ipAddressesHasBeenSet = true;
  ...
  inline CreateCustomRoutingAcceleratorRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdempotencyTokenT = Aws::String>
  CreateCustomRoutingAcceleratorRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateCustomRoutingAcceleratorRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateCustomRoutingAcceleratorRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
