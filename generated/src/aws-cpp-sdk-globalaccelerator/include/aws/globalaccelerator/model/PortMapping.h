...
class PortMapping {
 public:
  ...
  inline void SetAcceleratorPort(int value) {
    m_acceleratorPortHasBeenSet = true;
    m_acceleratorPort = value;
  }
  inline PortMapping& WithAcceleratorPort(int value) {
    SetAcceleratorPort(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationSocketAddress(DestinationSocketAddressT&& value) {
    ...
    m_destinationSocketAddress = std::forward<DestinationSocketAddressT>(value);
  }
  template <typename DestinationSocketAddressT = SocketAddress>
  PortMapping& WithDestinationSocketAddress(DestinationSocketAddressT&& value) {
    SetDestinationSocketAddress(std::forward<DestinationSocketAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline PortMapping& AddProtocols(CustomRoutingProtocol value) {
    m_protocolsHasBeenSet = true;
  ...
  inline void SetDestinationTrafficState(CustomRoutingDestinationTrafficState value) {
    m_destinationTrafficStateHasBeenSet = true;
    m_destinationTrafficState = value;
  }
  inline PortMapping& WithDestinationTrafficState(CustomRoutingDestinationTrafficState value) {
    SetDestinationTrafficState(value);
    return *this;
  }
  ///@}
 private:
