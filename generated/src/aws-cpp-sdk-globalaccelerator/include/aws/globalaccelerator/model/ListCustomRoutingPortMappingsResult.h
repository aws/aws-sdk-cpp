...
class ListCustomRoutingPortMappingsResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API ListCustomRoutingPortMappingsResult& operator=(
  ...
  template <typename PortMappingsT = Aws::Vector<PortMapping>>
  ListCustomRoutingPortMappingsResult& WithPortMappings(PortMappingsT&& value) {
    SetPortMappings(std::forward<PortMappingsT>(value));
    return *this;
  }
  template <typename PortMappingsT = PortMapping>
  ListCustomRoutingPortMappingsResult& AddPortMappings(PortMappingsT&& value) {
    m_portMappingsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingPortMappingsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomRoutingPortMappingsResult& WithRequestId(RequestIdT&& value) {
