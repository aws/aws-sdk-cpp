...
class UpdateAcceleratorAttributesResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API UpdateAcceleratorAttributesResult& operator=(
  ...
  template <typename AcceleratorAttributesT = AcceleratorAttributes>
  UpdateAcceleratorAttributesResult& WithAcceleratorAttributes(AcceleratorAttributesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateAcceleratorAttributesResult& WithRequestId(RequestIdT&& value) {
