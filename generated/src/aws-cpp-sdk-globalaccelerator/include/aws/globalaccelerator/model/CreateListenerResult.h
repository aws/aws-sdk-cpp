...
namespace Model
{
  ...
  {
  public:
    AWS_GLOBALACCELERATOR_API CreateListenerResult() = default;
    ...
    template<typename ListenerT = Listener>
    CreateListenerResult& WithListener(ListenerT&& value) { SetListener(std::forward<ListenerT>(value)); return *this;}
    ///@}
