...
class DescribeCustomRoutingEndpointGroupResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API DescribeCustomRoutingEndpointGroupResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename EndpointGroupT = CustomRoutingEndpointGroup>
  DescribeCustomRoutingEndpointGroupResult& WithEndpointGroup(EndpointGroupT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCustomRoutingEndpointGroupResult& WithRequestId(RequestIdT&& value) {
