...
namespace Model
{
  ...
  /**
   */
  class DeleteCustomRoutingEndpointGroupRequest : public GlobalAcceleratorRequest
  {
  public:
    AWS_GLOBALACCELERATOR_API DeleteCustomRoutingEndpointGroupRequest() = default;
    ...
    template<typename EndpointGroupArnT = Aws::String>
    DeleteCustomRoutingEndpointGroupRequest& WithEndpointGroupArn(EndpointGroupArnT&& value) { SetEndpointGroupArn(std::forward<EndpointGroupArnT>(value)); return *this;}
    ///@}
  private:
