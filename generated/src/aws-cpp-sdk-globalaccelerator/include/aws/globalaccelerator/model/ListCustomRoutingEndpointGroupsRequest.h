...
class ListCustomRoutingEndpointGroupsRequest : public GlobalAcceleratorRequest {
 public:
  AWS_GLOBALACCELERATOR_API ListCustomRoutingEndpointGroupsRequest() = default;
  ...
  template <typename ListenerArnT = Aws::String>
  ListCustomRoutingEndpointGroupsRequest& WithListenerArn(ListenerArnT&& value) {
  ...
  inline ListCustomRoutingEndpointGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingEndpointGroupsRequest& WithNextToken(NextTokenT&& value) {
