...
class UpdateCrossAccountAttachmentResult {
 public:
  AWS_GLOBALACCELERATOR_API UpdateCrossAccountAttachmentResult() = default;
  ...
  AWS_GLOBALACCELERATOR_API UpdateCrossAccountAttachmentResult& operator=(
  ...
  void SetCrossAccountAttachment(CrossAccountAttachmentT&& value) {
    m_crossAccountAttachmentHasBeenSet = true;
    m_crossAccountAttachment = std::forward<CrossAccountAttachmentT>(value);
  }
  template <typename CrossAccountAttachmentT = Attachment>
  UpdateCrossAccountAttachmentResult& WithCrossAccountAttachment(CrossAccountAttachmentT&& value) {
    SetCrossAccountAttachment(std::forward<CrossAccountAttachmentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCrossAccountAttachmentResult& WithRequestId(RequestIdT&& value) {
