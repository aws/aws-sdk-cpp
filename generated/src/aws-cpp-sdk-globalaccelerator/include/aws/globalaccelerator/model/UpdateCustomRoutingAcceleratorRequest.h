...
class UpdateCustomRoutingAcceleratorRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename AcceleratorArnT = Aws::String>
  UpdateCustomRoutingAcceleratorRequest& WithAcceleratorArn(AcceleratorArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateCustomRoutingAcceleratorRequest& WithName(NameT&& value) {
  ...
  inline UpdateCustomRoutingAcceleratorRequest& WithIpAddressType(IpAddressType value) {
  ...
  template <typename IpAddressesT = Aws::Vector<Aws::String>>
  UpdateCustomRoutingAcceleratorRequest& WithIpAddresses(IpAddressesT&& value) {
    SetIpAddresses(std::forward<IpAddressesT>(value));
    return *this;
  }
  template <typename IpAddressesT = Aws::String>
  UpdateCustomRoutingAcceleratorRequest& AddIpAddresses(IpAddressesT&& value) {
    m_ipAddressesHasBeenSet = true;
  ...
  inline UpdateCustomRoutingAcceleratorRequest& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
