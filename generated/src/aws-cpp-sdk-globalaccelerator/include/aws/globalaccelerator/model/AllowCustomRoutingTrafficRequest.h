...
class AllowCustomRoutingTrafficRequest : public GlobalAcceleratorRequest {
 public:
  ...
  void SetDestinationPorts(DestinationPortsT&& value) {
    ...
    m_destinationPorts = std::forward<DestinationPortsT>(value);
  }
  template <typename DestinationPortsT = Aws::Vector<int>>
  AllowCustomRoutingTrafficRequest& WithDestinationPorts(DestinationPortsT&& value) {
    SetDestinationPorts(std::forward<DestinationPortsT>(value));
    return *this;
  }
  inline AllowCustomRoutingTrafficRequest& AddDestinationPorts(int value) {
    m_destinationPortsHasBeenSet = true;
    m_destinationPorts.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowAllTrafficToEndpoint(bool value) {
    m_allowAllTrafficToEndpointHasBeenSet = true;
    m_allowAllTrafficToEndpoint = value;
  }
  inline AllowCustomRoutingTrafficRequest& WithAllowAllTrafficToEndpoint(bool value) {
    SetAllowAllTrafficToEndpoint(value);
    return *this;
  }
  ///@}
 private:
