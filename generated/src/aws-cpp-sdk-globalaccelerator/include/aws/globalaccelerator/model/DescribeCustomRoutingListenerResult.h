...
class DescribeCustomRoutingListenerResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API DescribeCustomRoutingListenerResult& operator=(
  ...
  template <typename ListenerT = CustomRoutingListener>
  DescribeCustomRoutingListenerResult& WithListener(ListenerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCustomRoutingListenerResult& WithRequestId(RequestIdT&& value) {
