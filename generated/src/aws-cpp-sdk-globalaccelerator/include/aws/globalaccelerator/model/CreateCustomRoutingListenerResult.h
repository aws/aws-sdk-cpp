...
class CreateCustomRoutingListenerResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API CreateCustomRoutingListenerResult& operator=(
  ...
  template <typename ListenerT = CustomRoutingListener>
  CreateCustomRoutingListenerResult& WithListener(ListenerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCustomRoutingListenerResult& WithRequestId(RequestIdT&& value) {
