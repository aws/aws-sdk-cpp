...
class ListCustomRoutingListenersResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API ListCustomRoutingListenersResult& operator=(
  ...
  template <typename ListenersT = Aws::Vector<CustomRoutingListener>>
  ListCustomRoutingListenersResult& WithListeners(ListenersT&& value) {
    SetListeners(std::forward<ListenersT>(value));
    return *this;
  }
  template <typename ListenersT = CustomRoutingListener>
  ListCustomRoutingListenersResult& AddListeners(ListenersT&& value) {
    m_listenersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingListenersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomRoutingListenersResult& WithRequestId(RequestIdT&& value) {
