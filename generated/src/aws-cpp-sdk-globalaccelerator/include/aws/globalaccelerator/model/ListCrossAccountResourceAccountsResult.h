...
class ListCrossAccountResourceAccountsResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API ListCrossAccountResourceAccountsResult& operator=(
  ...
  void SetResourceOwnerAwsAccountIds(ResourceOwnerAwsAccountIdsT&& value) {
    m_resourceOwnerAwsAccountIdsHasBeenSet = true;
    m_resourceOwnerAwsAccountIds = std::forward<ResourceOwnerAwsAccountIdsT>(value);
  }
  template <typename ResourceOwnerAwsAccountIdsT = Aws::Vector<Aws::String>>
  ListCrossAccountResourceAccountsResult& WithResourceOwnerAwsAccountIds(ResourceOwnerAwsAccountIdsT&& value) {
    SetResourceOwnerAwsAccountIds(std::forward<ResourceOwnerAwsAccountIdsT>(value));
    return *this;
  }
  template <typename ResourceOwnerAwsAccountIdsT = Aws::String>
  ListCrossAccountResourceAccountsResult& AddResourceOwnerAwsAccountIds(ResourceOwnerAwsAccountIdsT&& value) {
    m_resourceOwnerAwsAccountIdsHasBeenSet = true;
    m_resourceOwnerAwsAccountIds.emplace_back(std::forward<ResourceOwnerAwsAccountIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCrossAccountResourceAccountsResult& WithRequestId(RequestIdT&& value) {
