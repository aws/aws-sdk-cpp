...
class CustomRoutingDestinationDescription {
 public:
  ...
  inline CustomRoutingDestinationDescription& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline CustomRoutingDestinationDescription& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  inline CustomRoutingDestinationDescription& AddProtocols(Protocol value) {
    m_protocolsHasBeenSet = true;
