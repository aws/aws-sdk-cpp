...
namespace Model
{
  ...
  public:
    ...
    template<typename ByoipCidrT = ByoipCidr>
    ProvisionByoipCidrResult& WithByoipCidr(ByoipCidrT&& value) { SetByoipCidr(std::forward<ByoipCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ProvisionByoipCidrResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
