...
class DescribeCustomRoutingAcceleratorAttributesResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API DescribeCustomRoutingAcceleratorAttributesResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename AcceleratorAttributesT = CustomRoutingAcceleratorAttributes>
  DescribeCustomRoutingAcceleratorAttributesResult& WithAcceleratorAttributes(AcceleratorAttributesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeCustomRoutingAcceleratorAttributesResult& WithRequestId(RequestIdT&& value) {
