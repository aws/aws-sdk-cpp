...
namespace Model
{
  ...
  {
  public:
    AWS_GLOBALACCELERATOR_API ListByoipCidrsResult() = default;
    ...
    template<typename ByoipCidrsT = Aws::Vector<ByoipCidr>>
    ListByoipCidrsResult& WithByoipCidrs(ByoipCidrsT&& value) { SetByoipCidrs(std::forward<ByoipCidrsT>(value)); return *this;}
    template<typename ByoipCidrsT = ByoipCidr>
    ListByoipCidrsResult& AddByoipCidrs(ByoipCidrsT&& value) { m_byoipCidrsHasBeenSet = true; m_byoipCidrs.emplace_back(std::forward<ByoipCidrsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListByoipCidrsResult& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    ListByoipCidrsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
