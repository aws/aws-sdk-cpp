...
class CustomRoutingDestinationConfiguration {
 public:
  ...
  inline CustomRoutingDestinationConfiguration& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline CustomRoutingDestinationConfiguration& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  inline CustomRoutingDestinationConfiguration& AddProtocols(CustomRoutingProtocol value) {
    m_protocolsHasBeenSet = true;
