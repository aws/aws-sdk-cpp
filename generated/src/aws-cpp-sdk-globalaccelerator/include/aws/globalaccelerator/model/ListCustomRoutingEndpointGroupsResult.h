...
class ListCustomRoutingEndpointGroupsResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API ListCustomRoutingEndpointGroupsResult& operator=(
  ...
  template <typename EndpointGroupsT = Aws::Vector<CustomRoutingEndpointGroup>>
  ListCustomRoutingEndpointGroupsResult& WithEndpointGroups(EndpointGroupsT&& value) {
    SetEndpointGroups(std::forward<EndpointGroupsT>(value));
    return *this;
  }
  template <typename EndpointGroupsT = CustomRoutingEndpointGroup>
  ListCustomRoutingEndpointGroupsResult& AddEndpointGroups(EndpointGroupsT&& value) {
    m_endpointGroupsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingEndpointGroupsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomRoutingEndpointGroupsResult& WithRequestId(RequestIdT&& value) {
