...
namespace Model
{
  ...
  /**
   */
  class UpdateEndpointGroupRequest : public GlobalAcceleratorRequest
  {
  public:
    ...
    template<typename EndpointGroupArnT = Aws::String>
    UpdateEndpointGroupRequest& WithEndpointGroupArn(EndpointGroupArnT&& value) { SetEndpointGroupArn(std::forward<EndpointGroupArnT>(value)); return *this;}
    ///@}
    ...
    template<typename EndpointConfigurationsT = Aws::Vector<EndpointConfiguration>>
    UpdateEndpointGroupRequest& WithEndpointConfigurations(EndpointConfigurationsT&& value) { SetEndpointConfigurations(std::forward<EndpointConfigurationsT>(value)); return *this;}
    template<typename EndpointConfigurationsT = EndpointConfiguration>
    UpdateEndpointGroupRequest& AddEndpointConfigurations(EndpointConfigurationsT&& value) { m_endpointConfigurationsHasBeenSet = true; m_endpointConfigurations.emplace_back(std::forward<EndpointConfigurationsT>(value)); return *this; }
    ///@}
    ...
    inline UpdateEndpointGroupRequest& WithHealthCheckProtocol(HealthCheckProtocol value) { SetHealthCheckProtocol(value); return *this;}
    ///@}
    ...
    template<typename HealthCheckPathT = Aws::String>
    UpdateEndpointGroupRequest& WithHealthCheckPath(HealthCheckPathT&& value) { SetHealthCheckPath(std::forward<HealthCheckPathT>(value)); return *this;}
    ///@}
    ...
    template<typename PortOverridesT = Aws::Vector<PortOverride>>
    UpdateEndpointGroupRequest& WithPortOverrides(PortOverridesT&& value) { SetPortOverrides(std::forward<PortOverridesT>(value)); return *this;}
    template<typename PortOverridesT = PortOverride>
    UpdateEndpointGroupRequest& AddPortOverrides(PortOverridesT&& value) { m_portOverridesHasBeenSet = true; m_portOverrides.emplace_back(std::forward<PortOverridesT>(value)); return *this; }
    ///@}
  private:
