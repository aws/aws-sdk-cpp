...
class UpdateEndpointGroupRequest : public GlobalAcceleratorRequest {
 public:
  ...
  inline UpdateEndpointGroupRequest& WithTrafficDialPercentage(double value) {
  ...
  inline UpdateEndpointGroupRequest& WithHealthCheckPort(int value) {
  ...
  inline UpdateEndpointGroupRequest& WithHealthCheckProtocol(HealthCheckProtocol value) {
  ...
  inline UpdateEndpointGroupRequest& WithHealthCheckIntervalSeconds(int value) {
  ...
  inline UpdateEndpointGroupRequest& WithThresholdCount(int value) {
