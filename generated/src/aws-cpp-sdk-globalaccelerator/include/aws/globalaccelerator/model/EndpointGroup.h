...
class EndpointGroup {
 public:
  ...
  void SetEndpointGroupRegion(EndpointGroupRegionT&& value) {
    ...
    m_endpointGroupRegion = std::forward<EndpointGroupRegionT>(value);
  }
  template <typename EndpointGroupRegionT = Aws::String>
  EndpointGroup& WithEndpointGroupRegion(EndpointGroupRegionT&& value) {
    SetEndpointGroupRegion(std::forward<EndpointGroupRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndpointDescriptions(EndpointDescriptionsT&& value) {
    ...
    m_endpointDescriptions = std::forward<EndpointDescriptionsT>(value);
  }
  template <typename EndpointDescriptionsT = Aws::Vector<EndpointDescription>>
  EndpointGroup& WithEndpointDescriptions(EndpointDescriptionsT&& value) {
    SetEndpointDescriptions(std::forward<EndpointDescriptionsT>(value));
    return *this;
  }
  ...
  EndpointGroup& AddEndpointDescriptions(EndpointDescriptionsT&& value) {
    m_endpointDescriptionsHasBeenSet = true;
    m_endpointDescriptions.emplace_back(std::forward<EndpointDescriptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTrafficDialPercentage(double value) {
    m_trafficDialPercentageHasBeenSet = true;
    m_trafficDialPercentage = value;
  }
  inline EndpointGroup& WithTrafficDialPercentage(double value) {
    SetTrafficDialPercentage(value);
    return *this;
  }
  ///@}
  ...
  inline EndpointGroup& WithHealthCheckPort(int value) {
  ...
  inline void SetHealthCheckProtocol(HealthCheckProtocol value) {
    m_healthCheckProtocolHasBeenSet = true;
    m_healthCheckProtocol = value;
  }
  inline EndpointGroup& WithHealthCheckProtocol(HealthCheckProtocol value) {
    SetHealthCheckProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthCheckIntervalSeconds(int value) {
    m_healthCheckIntervalSecondsHasBeenSet = true;
    m_healthCheckIntervalSeconds = value;
  }
  inline EndpointGroup& WithHealthCheckIntervalSeconds(int value) {
    SetHealthCheckIntervalSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetThresholdCount(int value) {
    m_thresholdCountHasBeenSet = true;
    m_thresholdCount = value;
  }
  inline EndpointGroup& WithThresholdCount(int value) {
    SetThresholdCount(value);
    return *this;
  }
  ///@}
  ...
  void SetPortOverrides(PortOverridesT&& value) {
    ...
    m_portOverrides = std::forward<PortOverridesT>(value);
  }
  template <typename PortOverridesT = Aws::Vector<PortOverride>>
  EndpointGroup& WithPortOverrides(PortOverridesT&& value) {
    SetPortOverrides(std::forward<PortOverridesT>(value));
    return *this;
  }
  template <typename PortOverridesT = PortOverride>
  EndpointGroup& AddPortOverrides(PortOverridesT&& value) {
    m_portOverridesHasBeenSet = true;
    m_portOverrides.emplace_back(std::forward<PortOverridesT>(value));
    return *this;
  }
  ///@}
 private:
