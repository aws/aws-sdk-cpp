...
class Listener {
 public:
  ...
  inline Listener& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline Listener& WithClientAffinity(ClientAffinity value) {
