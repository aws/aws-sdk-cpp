...
namespace Model
{
  ...
  {
  public:
    AWS_GLOBALACCELERATOR_API DeprovisionByoipCidrResult() = default;
    ...
    template<typename ByoipCidrT = ByoipCidr>
    DeprovisionByoipCidrResult& WithByoipCidr(ByoipCidrT&& value) { SetByoipCidr(std::forward<ByoipCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeprovisionByoipCidrResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
