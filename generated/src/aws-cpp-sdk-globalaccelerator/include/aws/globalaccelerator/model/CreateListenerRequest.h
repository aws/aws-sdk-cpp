...
class CreateListenerRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename AcceleratorArnT = Aws::String>
  CreateListenerRequest& WithAcceleratorArn(AcceleratorArnT&& value) {
  ...
  template <typename PortRangesT = Aws::Vector<PortRange>>
  CreateListenerRequest& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = PortRange>
  CreateListenerRequest& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
  ...
  inline CreateListenerRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClientAffinity(ClientAffinity value) {
    m_clientAffinityHasBeenSet = true;
    m_clientAffinity = value;
  }
  inline CreateListenerRequest& WithClientAffinity(ClientAffinity value) {
    SetClientAffinity(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdempotencyTokenT = Aws::String>
  CreateListenerRequest& WithIdempotencyToken(IdempotencyTokenT&& value) {
