...
class UpdateCustomRoutingAcceleratorAttributesRequest : public GlobalAcceleratorRequest {
 public:
  ...
  template <typename AcceleratorArnT = Aws::String>
  UpdateCustomRoutingAcceleratorAttributesRequest& WithAcceleratorArn(AcceleratorArnT&& value) {
  ...
  inline UpdateCustomRoutingAcceleratorAttributesRequest& WithFlowLogsEnabled(bool value) {
  ...
  template <typename FlowLogsS3BucketT = Aws::String>
  UpdateCustomRoutingAcceleratorAttributesRequest& WithFlowLogsS3Bucket(FlowLogsS3BucketT&& value) {
  ...
  template <typename FlowLogsS3PrefixT = Aws::String>
  UpdateCustomRoutingAcceleratorAttributesRequest& WithFlowLogsS3Prefix(FlowLogsS3PrefixT&& value) {
