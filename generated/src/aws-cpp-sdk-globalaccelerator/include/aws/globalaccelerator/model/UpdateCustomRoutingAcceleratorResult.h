...
class UpdateCustomRoutingAcceleratorResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API UpdateCustomRoutingAcceleratorResult& operator=(
  ...
  template <typename AcceleratorT = CustomRoutingAccelerator>
  UpdateCustomRoutingAcceleratorResult& WithAccelerator(AcceleratorT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateCustomRoutingAcceleratorResult& WithRequestId(RequestIdT&& value) {
