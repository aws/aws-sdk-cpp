...
class EndpointDescription {
 public:
  ...
  inline EndpointDescription& WithWeight(int value) {
    SetWeight(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHealthState(HealthState value) {
    m_healthStateHasBeenSet = true;
    m_healthState = value;
  }
  inline EndpointDescription& WithHealthState(HealthState value) {
  ...
  void SetHealthReason(HealthReasonT&& value) {
    ...
    m_healthReason = std::forward<HealthReasonT>(value);
  }
  template <typename HealthReasonT = Aws::String>
  EndpointDescription& WithHealthReason(HealthReasonT&& value) {
    SetHealthReason(std::forward<HealthReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline EndpointDescription& WithClientIPPreservationEnabled(bool value) {
