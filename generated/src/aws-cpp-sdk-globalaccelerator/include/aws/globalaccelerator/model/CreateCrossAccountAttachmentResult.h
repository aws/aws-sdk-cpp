...
class CreateCrossAccountAttachmentResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API CreateCrossAccountAttachmentResult& operator=(
  ...
  template <typename CrossAccountAttachmentT = Attachment>
  CreateCrossAccountAttachmentResult& WithCrossAccountAttachment(CrossAccountAttachmentT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCrossAccountAttachmentResult& WithRequestId(RequestIdT&& value) {
