...
class ListCustomRoutingAcceleratorsResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API ListCustomRoutingAcceleratorsResult& operator=(
  ...
  template <typename AcceleratorsT = Aws::Vector<CustomRoutingAccelerator>>
  ListCustomRoutingAcceleratorsResult& WithAccelerators(AcceleratorsT&& value) {
    SetAccelerators(std::forward<AcceleratorsT>(value));
    return *this;
  }
  template <typename AcceleratorsT = CustomRoutingAccelerator>
  ListCustomRoutingAcceleratorsResult& AddAccelerators(AcceleratorsT&& value) {
    m_acceleratorsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomRoutingAcceleratorsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomRoutingAcceleratorsResult& WithRequestId(RequestIdT&& value) {
