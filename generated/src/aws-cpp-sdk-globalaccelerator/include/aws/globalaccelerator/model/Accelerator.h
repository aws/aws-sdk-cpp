...
class Accelerator {
 public:
  ...
  inline Accelerator& WithIpAddressType(IpAddressType value) {
  ...
  inline Accelerator& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  Accelerator& AddIpSets(IpSetsT&& value) {
    m_ipSetsHasBeenSet = true;
    m_ipSets.emplace_back(std::forward<IpSetsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(AcceleratorStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Accelerator& WithStatus(AcceleratorStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetDualStackDnsName(DualStackDnsNameT&& value) {
    ...
    m_dualStackDnsName = std::forward<DualStackDnsNameT>(value);
  }
  template <typename DualStackDnsNameT = Aws::String>
  Accelerator& WithDualStackDnsName(DualStackDnsNameT&& value) {
    SetDualStackDnsName(std::forward<DualStackDnsNameT>(value));
    return *this;
  }
  ///@}
