...
class AddCustomRoutingEndpointsResult {
 public:
  ...
  AWS_GLOBALACCELERATOR_API AddCustomRoutingEndpointsResult& operator=(
  ...
  template <typename EndpointDescriptionsT = Aws::Vector<CustomRoutingEndpointDescription>>
  AddCustomRoutingEndpointsResult& WithEndpointDescriptions(EndpointDescriptionsT&& value) {
  ...
  AddCustomRoutingEndpointsResult& AddEndpointDescriptions(EndpointDescriptionsT&& value) {
    m_endpointDescriptionsHasBeenSet = true;
  ...
  template <typename EndpointGroupArnT = Aws::String>
  AddCustomRoutingEndpointsResult& WithEndpointGroupArn(EndpointGroupArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AddCustomRoutingEndpointsResult& WithRequestId(RequestIdT&& value) {
