...
class CreateEndpointGroupRequest : public GlobalAcceleratorRequest {
 public:
  ...
  inline CreateEndpointGroupRequest& WithTrafficDialPercentage(double value) {
  ...
  inline CreateEndpointGroupRequest& WithHealthCheckPort(int value) {
  ...
  inline CreateEndpointGroupRequest& WithHealthCheckProtocol(HealthCheckProtocol value) {
  ...
  inline CreateEndpointGroupRequest& WithHealthCheckIntervalSeconds(int value) {
  ...
  inline CreateEndpointGroupRequest& WithThresholdCount(int value) {
