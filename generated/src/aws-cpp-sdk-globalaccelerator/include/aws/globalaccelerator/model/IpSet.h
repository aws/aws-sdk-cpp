...
class IpSet {
 public:
  ...
  inline void SetIpAddressFamily(IpAddressFamily value) {
    m_ipAddressFamilyHasBeenSet = true;
    m_ipAddressFamily = value;
  }
  inline IpSet& WithIpAddressFamily(IpAddressFamily value) {
    SetIpAddressFamily(value);
    return *this;
  }
  ///@}
 private:
