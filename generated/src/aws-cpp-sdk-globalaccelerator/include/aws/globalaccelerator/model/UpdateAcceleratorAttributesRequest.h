...
class UpdateAcceleratorAttributesRequest : public GlobalAcceleratorRequest {
 public:
  ...
  inline void SetFlowLogsEnabled(bool value) {
    m_flowLogsEnabledHasBeenSet = true;
    m_flowLogsEnabled = value;
  }
  inline UpdateAcceleratorAttributesRequest& WithFlowLogsEnabled(bool value) {
    SetFlowLogsEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetFlowLogsS3Bucket(FlowLogsS3BucketT&& value) {
    ...
    m_flowLogsS3Bucket = std::forward<FlowLogsS3BucketT>(value);
  }
  template <typename FlowLogsS3BucketT = Aws::String>
  UpdateAcceleratorAttributesRequest& WithFlowLogsS3Bucket(FlowLogsS3BucketT&& value) {
    SetFlowLogsS3Bucket(std::forward<FlowLogsS3BucketT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFlowLogsS3Prefix(FlowLogsS3PrefixT&& value) {
    ...
    m_flowLogsS3Prefix = std::forward<FlowLogsS3PrefixT>(value);
  }
  template <typename FlowLogsS3PrefixT = Aws::String>
  UpdateAcceleratorAttributesRequest& WithFlowLogsS3Prefix(FlowLogsS3PrefixT&& value) {
    SetFlowLogsS3Prefix(std::forward<FlowLogsS3PrefixT>(value));
    return *this;
  }
  ///@}
 private:
