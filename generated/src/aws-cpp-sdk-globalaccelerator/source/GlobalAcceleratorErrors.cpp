...
AWSError<CoreErrors> GetErrorForName(const char* errorName) {
  ...
  if (hashCode == ENDPOINT_ALREADY_EXISTS_HASH) {
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(GlobalAcceleratorErrors::ENDPOINT_GROUP_ALREADY_EXISTS),
    ...
    return AWSError<CoreErrors>(static_cast<CoreErrors>(GlobalAcceleratorErrors::ASSOCIATED_ENDPOINT_GROUP_FOUND),
                                RetryableType::NOT_RETRYABLE);
