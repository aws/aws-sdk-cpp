...
DestinationPortMapping::DestinationPortMapping(JsonView jsonValue) { *this = jsonValue; }
...
DestinationPortMapping& DestinationPortMapping::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AcceleratorSocketAddresses")) {
    ...
    for (unsigned acceleratorSocketAddressesIndex = 0; acceleratorSocketAddressesIndex < acceleratorSocketAddressesJsonList.GetLength();
         ++acceleratorSocketAddressesIndex) {
...
JsonValue DestinationPortMapping::Jsonize() const {
  ...
  if (m_acceleratorSocketAddressesHasBeenSet) {
    ...
    for (unsigned acceleratorSocketAddressesIndex = 0; acceleratorSocketAddressesIndex < acceleratorSocketAddressesJsonList.GetLength();
         ++acceleratorSocketAddressesIndex) {
      acceleratorSocketAddressesJsonList[acceleratorSocketAddressesIndex].AsObject(
          m_acceleratorSocketAddresses[acceleratorSocketAddressesIndex].Jsonize());
    }
