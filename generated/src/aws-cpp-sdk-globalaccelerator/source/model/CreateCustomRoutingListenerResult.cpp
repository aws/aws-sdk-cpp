...
CreateCustomRoutingListenerResult::CreateCustomRoutingListenerResult()
{
}

CreateCustomRoutingListenerResult::CreateCustomRoutingListenerResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
