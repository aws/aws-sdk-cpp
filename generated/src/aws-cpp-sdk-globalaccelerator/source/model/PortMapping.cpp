...
PortMapping& PortMapping::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("DestinationTrafficState")) {
    m_destinationTrafficState = CustomRoutingDestinationTrafficStateMapper::GetCustomRoutingDestinationTrafficStateForName(
        jsonValue.GetString("DestinationTrafficState"));
...
JsonValue PortMapping::Jsonize() const {
  ...
  if (m_destinationTrafficStateHasBeenSet) {
    payload.WithString(
        ...
        CustomRoutingDestinationTrafficStateMapper::GetNameForCustomRoutingDestinationTrafficState(m_destinationTrafficState));
  }
