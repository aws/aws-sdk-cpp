...
'"','h','t','t','p','s',':','/','/','w','i','s','d','o','m','-','f','i','p','s','.','{','R','e','g',
...
':','/','/','w','i','s','d','o','m','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'r','r','o','r','"','}',']',',','"','t','y','p','e','"',':','"','t','r','e','e','"','}',']','}','\0'
}};

const char* QConnectEndpointRules::GetRulesBlob()
{
