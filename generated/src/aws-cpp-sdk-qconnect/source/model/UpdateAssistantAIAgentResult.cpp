...
UpdateAssistantAIAgentResult::UpdateAssistantAIAgentResult()
{
}

UpdateAssistantAIAgentResult::UpdateAssistantAIAgentResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
