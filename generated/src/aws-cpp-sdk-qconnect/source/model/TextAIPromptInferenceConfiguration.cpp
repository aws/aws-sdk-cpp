...
TextAIPromptInferenceConfiguration::TextAIPromptInferenceConfiguration(JsonView jsonValue) { *this = jsonValue; }

TextAIPromptInferenceConfiguration& TextAIPromptInferenceConfiguration::operator=(JsonView jsonValue) {
...
JsonValue TextAIPromptInferenceConfiguration::Jsonize() const {
  JsonValue payload;
