...
MultiAgentInstruction::MultiAgentInstruction(JsonView jsonValue) { *this = jsonValue; }

MultiAgentInstruction& MultiAgentInstruction::operator=(JsonView jsonValue) {
...
JsonValue MultiAgentInstruction::Jsonize() const {
  JsonValue payload;
