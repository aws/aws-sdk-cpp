...
GetNextMessageResult::GetNextMessageResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
GetNextMessageResult& GetNextMessageResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("conversationSessionData")) {
    ...
    for (unsigned conversationSessionDataIndex = 0; conversationSessionDataIndex < conversationSessionDataJsonList.GetLength();
         ++conversationSessionDataIndex) {
