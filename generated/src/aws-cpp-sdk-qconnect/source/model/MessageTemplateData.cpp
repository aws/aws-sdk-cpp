...
MessageTemplateData::MessageTemplateData(JsonView jsonValue) { *this = jsonValue; }

MessageTemplateData& MessageTemplateData::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("attributeTypes")) {
    ...
    for (unsigned attributeTypesIndex = 0; attributeTypesIndex < attributeTypesJsonList.GetLength(); ++attributeTypesIndex) {
      m_attributeTypes.push_back(MessageTemplateAttributeTypeMapper::GetMessageTemplateAttributeTypeForName(
          attributeTypesJsonList[attributeTypesIndex].AsString()));
    }
...
JsonValue MessageTemplateData::Jsonize() const {
  JsonValue payload;
  ...
  if (m_attributeTypesHasBeenSet) {
    ...
    for (unsigned attributeTypesIndex = 0; attributeTypesIndex < attributeTypesJsonList.GetLength(); ++attributeTypesIndex) {
      attributeTypesJsonList[attributeTypesIndex].AsString(
          MessageTemplateAttributeTypeMapper::GetNameForMessageTemplateAttributeType(m_attributeTypes[attributeTypesIndex]));
    }
