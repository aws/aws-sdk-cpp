...
SearchMessageTemplatesResult::SearchMessageTemplatesResult()
{
}

SearchMessageTemplatesResult::SearchMessageTemplatesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
