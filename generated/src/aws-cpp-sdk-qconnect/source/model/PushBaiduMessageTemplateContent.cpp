...
PushBaiduMessageTemplateContent::PushBaiduMessageTemplateContent(JsonView jsonValue) { *this = jsonValue; }

PushBaiduMessageTemplateContent& PushBaiduMessageTemplateContent::operator=(JsonView jsonValue) {
...
JsonValue PushBaiduMessageTemplateContent::Jsonize() const {
  JsonValue payload;
