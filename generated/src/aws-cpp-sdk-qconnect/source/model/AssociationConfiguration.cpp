...
AssociationConfiguration::AssociationConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
AssociationConfiguration& AssociationConfiguration::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("associationType")) {
    m_associationType =
        AIAgentAssociationConfigurationTypeMapper::GetAIAgentAssociationConfigurationTypeForName(jsonValue.GetString("associationType"));
...
JsonValue AssociationConfiguration::Jsonize() const {
  ...
  if (m_associationTypeHasBeenSet) {
    payload.WithString("associationType",
                       AIAgentAssociationConfigurationTypeMapper::GetNameForAIAgentAssociationConfigurationType(m_associationType));
  }
