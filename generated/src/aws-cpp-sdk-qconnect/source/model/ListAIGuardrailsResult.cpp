...
ListAIGuardrailsResult::ListAIGuardrailsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAIGuardrailsResult& ListAIGuardrailsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("aiGuardrailSummaries")) {
    ...
    for (unsigned aiGuardrailSummariesIndex = 0; aiGuardrailSummariesIndex < aiGuardrailSummariesJsonList.GetLength();
         ++aiGuardrailSummariesIndex) {
