...
EmailOverviewChunkDataDetails::EmailOverviewChunkDataDetails(JsonView jsonValue) { *this = jsonValue; }

EmailOverviewChunkDataDetails& EmailOverviewChunkDataDetails::operator=(JsonView jsonValue) {
...
JsonValue EmailOverviewChunkDataDetails::Jsonize() const {
  JsonValue payload;
