...
NotesChunkDataDetails::NotesChunkDataDetails(JsonView jsonValue) { *this = jsonValue; }

NotesChunkDataDetails& NotesChunkDataDetails::operator=(JsonView jsonValue) {
...
JsonValue NotesChunkDataDetails::Jsonize() const {
  JsonValue payload;
