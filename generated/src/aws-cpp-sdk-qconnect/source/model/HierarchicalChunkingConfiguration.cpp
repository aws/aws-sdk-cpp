...
HierarchicalChunkingConfiguration::HierarchicalChunkingConfiguration(JsonView jsonValue) { *this = jsonValue; }
...
HierarchicalChunkingConfiguration& HierarchicalChunkingConfiguration::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("levelConfigurations")) {
    ...
    for (unsigned levelConfigurationsIndex = 0; levelConfigurationsIndex < levelConfigurationsJsonList.GetLength();
         ++levelConfigurationsIndex) {
