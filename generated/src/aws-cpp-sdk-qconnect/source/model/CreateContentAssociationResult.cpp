...
CreateContentAssociationResult::CreateContentAssociationResult()
{
}

CreateContentAssociationResult::CreateContentAssociationResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
