...
RetrieveSdkResult::RetrieveSdkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

RetrieveSdkResult& RetrieveSdkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
