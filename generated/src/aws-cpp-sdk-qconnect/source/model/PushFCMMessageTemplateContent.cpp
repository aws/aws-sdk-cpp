...
PushFCMMessageTemplateContent::PushFCMMessageTemplateContent(JsonView jsonValue) { *this = jsonValue; }

PushFCMMessageTemplateContent& PushFCMMessageTemplateContent::operator=(JsonView jsonValue) {
...
JsonValue PushFCMMessageTemplateContent::Jsonize() const {
  JsonValue payload;
