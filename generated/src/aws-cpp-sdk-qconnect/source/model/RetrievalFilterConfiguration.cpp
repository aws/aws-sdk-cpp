...
RetrievalFilterConfiguration::RetrievalFilterConfiguration(JsonView jsonValue) { *this = jsonValue; }

RetrievalFilterConfiguration& RetrievalFilterConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RetrievalFilterConfiguration::Jsonize() const {
  JsonValue payload;
