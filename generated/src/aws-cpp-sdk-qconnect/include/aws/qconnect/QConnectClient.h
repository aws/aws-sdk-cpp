...
namespace QConnect
{
   ...
   */
  class AWS_QCONNECT_API QConnectClient : smithy::client::AwsSmithyClientT<Aws::QConnect::SERVICE_NAME,
    ...
    Aws::Client::ClientWithAsyncTemplateMethods<QConnectClient>
  {
    public:
