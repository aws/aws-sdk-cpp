...
class AWS_QCONNECT_API QConnectClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  QConnectClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<QConnectEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for ActivateMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ActivateMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ActivateMessageTemplateRequestT = Model::ActivateMessageTemplateRequest>
  void ActivateMessageTemplateAsync(const ActivateMessageTemplateRequestT& request,
                                    const ActivateMessageTemplateResponseReceivedHandler& handler,
  ...
  /**
   * An Async wrapper for CreateAIAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAIAgentRequestT = Model::CreateAIAgentRequest>
  void CreateAIAgentAsync(const CreateAIAgentRequestT& request, const CreateAIAgentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAIAgentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAIAgentVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAIAgentVersionRequestT = Model::CreateAIAgentVersionRequest>
  void CreateAIAgentVersionAsync(const CreateAIAgentVersionRequestT& request, const CreateAIAgentVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAIGuardrail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAIGuardrail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAIGuardrailRequestT = Model::CreateAIGuardrailRequest>
  void CreateAIGuardrailAsync(const CreateAIGuardrailRequestT& request, const CreateAIGuardrailResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAIGuardrailVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAIGuardrailVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAIGuardrailVersionRequestT = Model::CreateAIGuardrailVersionRequest>
  void CreateAIGuardrailVersionAsync(const CreateAIGuardrailVersionRequestT& request,
                                     const CreateAIGuardrailVersionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateAIPrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateAIPromptRequestT = Model::CreateAIPromptRequest>
  void CreateAIPromptAsync(const CreateAIPromptRequestT& request, const CreateAIPromptResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAIPromptVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAIPromptVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAIPromptVersionRequestT = Model::CreateAIPromptVersionRequest>
  void CreateAIPromptVersionAsync(const CreateAIPromptVersionRequestT& request, const CreateAIPromptVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateContentAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateContentAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateContentAssociationRequestT = Model::CreateContentAssociationRequest>
  void CreateContentAssociationAsync(const CreateContentAssociationRequestT& request,
                                     const CreateContentAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMessageTemplateRequestT = Model::CreateMessageTemplateRequest>
  void CreateMessageTemplateAsync(const CreateMessageTemplateRequestT& request, const CreateMessageTemplateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMessageTemplateAttachmentOutcome CreateMessageTemplateAttachment(
      const Model::CreateMessageTemplateAttachmentRequest& request) const;

  /**
   * A Callable wrapper for CreateMessageTemplateAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMessageTemplateAttachmentRequestT = Model::CreateMessageTemplateAttachmentRequest>
  Model::CreateMessageTemplateAttachmentOutcomeCallable CreateMessageTemplateAttachmentCallable(
      const CreateMessageTemplateAttachmentRequestT& request) const {
    return SubmitCallable(&QConnectClient::CreateMessageTemplateAttachment, request);
  }

  /**
   * An Async wrapper for CreateMessageTemplateAttachment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateMessageTemplateAttachmentRequestT = Model::CreateMessageTemplateAttachmentRequest>
  void CreateMessageTemplateAttachmentAsync(const CreateMessageTemplateAttachmentRequestT& request,
                                            const CreateMessageTemplateAttachmentResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateMessageTemplateVersionOutcome CreateMessageTemplateVersion(
      const Model::CreateMessageTemplateVersionRequest& request) const;

  /**
   * A Callable wrapper for CreateMessageTemplateVersion that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateMessageTemplateVersionRequestT = Model::CreateMessageTemplateVersionRequest>
  Model::CreateMessageTemplateVersionOutcomeCallable CreateMessageTemplateVersionCallable(
      const CreateMessageTemplateVersionRequestT& request) const {
    return SubmitCallable(&QConnectClient::CreateMessageTemplateVersion, request);
  }

  /**
   * An Async wrapper for CreateMessageTemplateVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateMessageTemplateVersionRequestT = Model::CreateMessageTemplateVersionRequest>
  void CreateMessageTemplateVersionAsync(const CreateMessageTemplateVersionRequestT& request,
                                         const CreateMessageTemplateVersionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeactivateMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeactivateMessageTemplateRequestT = Model::DeactivateMessageTemplateRequest>
  Model::DeactivateMessageTemplateOutcomeCallable DeactivateMessageTemplateCallable(
      const DeactivateMessageTemplateRequestT& request) const {
    return SubmitCallable(&QConnectClient::DeactivateMessageTemplate, request);
  }

  /**
   * An Async wrapper for DeactivateMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeactivateMessageTemplateRequestT = Model::DeactivateMessageTemplateRequest>
  void DeactivateMessageTemplateAsync(const DeactivateMessageTemplateRequestT& request,
                                      const DeactivateMessageTemplateResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAIAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAIAgentRequestT = Model::DeleteAIAgentRequest>
  void DeleteAIAgentAsync(const DeleteAIAgentRequestT& request, const DeleteAIAgentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAIAgentVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAIAgentVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAIAgentVersionRequestT = Model::DeleteAIAgentVersionRequest>
  void DeleteAIAgentVersionAsync(const DeleteAIAgentVersionRequestT& request, const DeleteAIAgentVersionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAIGuardrail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAIGuardrail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAIGuardrailRequestT = Model::DeleteAIGuardrailRequest>
  void DeleteAIGuardrailAsync(const DeleteAIGuardrailRequestT& request, const DeleteAIGuardrailResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAIGuardrailVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAIGuardrailVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAIGuardrailVersionRequestT = Model::DeleteAIGuardrailVersionRequest>
  void DeleteAIGuardrailVersionAsync(const DeleteAIGuardrailVersionRequestT& request,
                                     const DeleteAIGuardrailVersionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteAIPrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteAIPromptRequestT = Model::DeleteAIPromptRequest>
  void DeleteAIPromptAsync(const DeleteAIPromptRequestT& request, const DeleteAIPromptResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAIPromptVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAIPromptVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAIPromptVersionRequestT = Model::DeleteAIPromptVersionRequest>
  void DeleteAIPromptVersionAsync(const DeleteAIPromptVersionRequestT& request, const DeleteAIPromptVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteContentAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteContentAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteContentAssociationRequestT = Model::DeleteContentAssociationRequest>
  void DeleteContentAssociationAsync(const DeleteContentAssociationRequestT& request,
                                     const DeleteContentAssociationResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteMessageTemplateRequestT = Model::DeleteMessageTemplateRequest>
  void DeleteMessageTemplateAsync(const DeleteMessageTemplateRequestT& request, const DeleteMessageTemplateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteMessageTemplateAttachmentOutcome DeleteMessageTemplateAttachment(
      const Model::DeleteMessageTemplateAttachmentRequest& request) const;

  /**
   * A Callable wrapper for DeleteMessageTemplateAttachment that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteMessageTemplateAttachmentRequestT = Model::DeleteMessageTemplateAttachmentRequest>
  Model::DeleteMessageTemplateAttachmentOutcomeCallable DeleteMessageTemplateAttachmentCallable(
      const DeleteMessageTemplateAttachmentRequestT& request) const {
    return SubmitCallable(&QConnectClient::DeleteMessageTemplateAttachment, request);
  }

  /**
   * An Async wrapper for DeleteMessageTemplateAttachment that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteMessageTemplateAttachmentRequestT = Model::DeleteMessageTemplateAttachmentRequest>
  void DeleteMessageTemplateAttachmentAsync(const DeleteMessageTemplateAttachmentRequestT& request,
                                            const DeleteMessageTemplateAttachmentResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAIAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAIAgentRequestT = Model::GetAIAgentRequest>
  void GetAIAgentAsync(const GetAIAgentRequestT& request, const GetAIAgentResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAIGuardrail that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAIGuardrailRequestT = Model::GetAIGuardrailRequest>
  void GetAIGuardrailAsync(const GetAIGuardrailRequestT& request, const GetAIGuardrailResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetAIPrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAIPromptRequestT = Model::GetAIPromptRequest>
  void GetAIPromptAsync(const GetAIPromptRequestT& request, const GetAIPromptResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetContentAssociation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetContentAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetContentAssociationRequestT = Model::GetContentAssociationRequest>
  void GetContentAssociationAsync(const GetContentAssociationRequestT& request, const GetContentAssociationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMessageTemplate that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMessageTemplateRequestT = Model::GetMessageTemplateRequest>
  void GetMessageTemplateAsync(const GetMessageTemplateRequestT& request, const GetMessageTemplateResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetNextMessage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetNextMessageRequestT = Model::GetNextMessageRequest>
  void GetNextMessageAsync(const GetNextMessageRequestT& request, const GetNextMessageResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAIAgentVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAIAgentVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAIAgentVersionsRequestT = Model::ListAIAgentVersionsRequest>
  void ListAIAgentVersionsAsync(const ListAIAgentVersionsRequestT& request, const ListAIAgentVersionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAIAgents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAIAgentsRequestT = Model::ListAIAgentsRequest>
  void ListAIAgentsAsync(const ListAIAgentsRequestT& request, const ListAIAgentsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAIGuardrailVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAIGuardrailVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAIGuardrailVersionsRequestT = Model::ListAIGuardrailVersionsRequest>
  void ListAIGuardrailVersionsAsync(const ListAIGuardrailVersionsRequestT& request,
                                    const ListAIGuardrailVersionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAIGuardrails that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAIGuardrails that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAIGuardrailsRequestT = Model::ListAIGuardrailsRequest>
  void ListAIGuardrailsAsync(const ListAIGuardrailsRequestT& request, const ListAIGuardrailsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAIPromptVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAIPromptVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAIPromptVersionsRequestT = Model::ListAIPromptVersionsRequest>
  void ListAIPromptVersionsAsync(const ListAIPromptVersionsRequestT& request, const ListAIPromptVersionsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListAIPrompts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAIPromptsRequestT = Model::ListAIPromptsRequest>
  void ListAIPromptsAsync(const ListAIPromptsRequestT& request, const ListAIPromptsResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListContentAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListContentAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListContentAssociationsRequestT = Model::ListContentAssociationsRequest>
  void ListContentAssociationsAsync(const ListContentAssociationsRequestT& request,
                                    const ListContentAssociationsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListMessageTemplateVersionsOutcome ListMessageTemplateVersions(
      const Model::ListMessageTemplateVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListMessageTemplateVersions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListMessageTemplateVersionsRequestT = Model::ListMessageTemplateVersionsRequest>
  Model::ListMessageTemplateVersionsOutcomeCallable ListMessageTemplateVersionsCallable(
      const ListMessageTemplateVersionsRequestT& request) const {
    return SubmitCallable(&QConnectClient::ListMessageTemplateVersions, request);
  }

  /**
   * An Async wrapper for ListMessageTemplateVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMessageTemplateVersionsRequestT = Model::ListMessageTemplateVersionsRequest>
  void ListMessageTemplateVersionsAsync(const ListMessageTemplateVersionsRequestT& request,
                                        const ListMessageTemplateVersionsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMessageTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMessageTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMessageTemplatesRequestT = Model::ListMessageTemplatesRequest>
  void ListMessageTemplatesAsync(const ListMessageTemplatesRequestT& request, const ListMessageTemplatesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RemoveAssistantAIAgent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RemoveAssistantAIAgent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RemoveAssistantAIAgentRequestT = Model::RemoveAssistantAIAgentRequest>
  void RemoveAssistantAIAgentAsync(const RemoveAssistantAIAgentRequestT& request,
                                   const RemoveAssistantAIAgentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RenderMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RenderMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RenderMessageTemplateRequestT = Model::RenderMessageTemplateRequest>
  ...
  /**
   * A Callable wrapper for SearchMessageTemplates that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for SearchMessageTemplates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchMessageTemplatesRequestT = Model::SearchMessageTemplatesRequest>
  void SearchMessageTemplatesAsync(const SearchMessageTemplatesRequestT& request,
                                   const SearchMessageTemplatesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAIAgent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAIAgentRequestT = Model::UpdateAIAgentRequest>
  void UpdateAIAgentAsync(const UpdateAIAgentRequestT& request, const UpdateAIAgentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAIGuardrail that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAIGuardrail that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAIGuardrailRequestT = Model::UpdateAIGuardrailRequest>
  void UpdateAIGuardrailAsync(const UpdateAIGuardrailRequestT& request, const UpdateAIGuardrailResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateAIPrompt that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateAIPromptRequestT = Model::UpdateAIPromptRequest>
  void UpdateAIPromptAsync(const UpdateAIPromptRequestT& request, const UpdateAIPromptResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAssistantAIAgent that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAssistantAIAgent that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAssistantAIAgentRequestT = Model::UpdateAssistantAIAgentRequest>
  void UpdateAssistantAIAgentAsync(const UpdateAssistantAIAgentRequestT& request,
                                   const UpdateAssistantAIAgentResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateMessageTemplate that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateMessageTemplate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMessageTemplateRequestT = Model::UpdateMessageTemplateRequest>
  void UpdateMessageTemplateAsync(const UpdateMessageTemplateRequestT& request, const UpdateMessageTemplateResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateMessageTemplateMetadataOutcome UpdateMessageTemplateMetadata(
      const Model::UpdateMessageTemplateMetadataRequest& request) const;

  /**
   * A Callable wrapper for UpdateMessageTemplateMetadata that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateMessageTemplateMetadataRequestT = Model::UpdateMessageTemplateMetadataRequest>
  Model::UpdateMessageTemplateMetadataOutcomeCallable UpdateMessageTemplateMetadataCallable(
      const UpdateMessageTemplateMetadataRequestT& request) const {
    return SubmitCallable(&QConnectClient::UpdateMessageTemplateMetadata, request);
  }

  /**
   * An Async wrapper for UpdateMessageTemplateMetadata that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateMessageTemplateMetadataRequestT = Model::UpdateMessageTemplateMetadataRequest>
  void UpdateMessageTemplateMetadataAsync(const UpdateMessageTemplateMetadataRequestT& request,
                                          const UpdateMessageTemplateMetadataResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSession that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSessionRequestT = Model::UpdateSessionRequest>
  void UpdateSessionAsync(const UpdateSessionRequestT& request, const UpdateSessionResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSessionData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSessionData that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSessionDataRequestT = Model::UpdateSessionDataRequest>
  void UpdateSessionDataAsync(const UpdateSessionDataRequestT& request, const UpdateSessionDataResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
