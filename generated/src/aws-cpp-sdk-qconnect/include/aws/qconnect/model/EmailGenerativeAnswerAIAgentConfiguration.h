...
namespace Model
{
  ...
  public:
    ...
    void SetEmailGenerativeAnswerAIPromptId(EmailGenerativeAnswerAIPromptIdT&& value) { m_emailGenerativeAnswerAIPromptIdHasBeenSet = true; m_emailGenerativeAnswerAIPromptId = std::forward<EmailGenerativeAnswerAIPromptIdT>(value); }
    template<typename EmailGenerativeAnswerAIPromptIdT = Aws::String>
    EmailGenerativeAnswerAIAgentConfiguration& WithEmailGenerativeAnswerAIPromptId(EmailGenerativeAnswerAIPromptIdT&& value) { SetEmailGenerativeAnswerAIPromptId(std::forward<EmailGenerativeAnswerAIPromptIdT>(value)); return *this;}
    ///@}
    ...
    template<typename EmailQueryReformulationAIPromptIdT = Aws::String>
    EmailGenerativeAnswerAIAgentConfiguration& WithEmailQueryReformulationAIPromptId(EmailQueryReformulationAIPromptIdT&& value) { SetEmailQueryReformulationAIPromptId(std::forward<EmailQueryReformulationAIPromptIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocaleT = Aws::String>
    EmailGenerativeAnswerAIAgentConfiguration& WithLocale(LocaleT&& value) { SetLocale(std::forward<LocaleT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationConfigurationsT = Aws::Vector<AssociationConfiguration>>
    EmailGenerativeAnswerAIAgentConfiguration& WithAssociationConfigurations(AssociationConfigurationsT&& value) { SetAssociationConfigurations(std::forward<AssociationConfigurationsT>(value)); return *this;}
    template<typename AssociationConfigurationsT = AssociationConfiguration>
    EmailGenerativeAnswerAIAgentConfiguration& AddAssociationConfigurations(AssociationConfigurationsT&& value) { m_associationConfigurationsHasBeenSet = true; m_associationConfigurations.emplace_back(std::forward<AssociationConfigurationsT>(value)); return *this; }
    ///@}
  private:
