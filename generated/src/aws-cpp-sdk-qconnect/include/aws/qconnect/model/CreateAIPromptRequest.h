...
class CreateAIPromptRequest : public QConnectRequest {
 public:
  ...
  inline CreateAIPromptRequest& WithType(AIPromptType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateAIPromptRequest& WithVisibilityStatus(VisibilityStatus value) {
  ...
  inline CreateAIPromptRequest& WithTemplateType(AIPromptTemplateType value) {
  ...
  inline CreateAIPromptRequest& WithApiFormat(AIPromptAPIFormat value) {
    SetApiFormat(value);
    return *this;
  }
  ///@}
