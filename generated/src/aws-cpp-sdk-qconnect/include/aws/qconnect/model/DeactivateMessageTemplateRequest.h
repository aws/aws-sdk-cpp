...
class DeactivateMessageTemplateRequest : public QConnectRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  DeactivateMessageTemplateRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  DeactivateMessageTemplateRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  inline DeactivateMessageTemplateRequest& WithVersionNumber(long long value) {
