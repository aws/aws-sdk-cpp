...
class QueryConditionItem {
 public:
  ...
  inline void SetField(QueryConditionFieldName value) {
    m_fieldHasBeenSet = true;
    m_field = value;
  }
  inline QueryConditionItem& WithField(QueryConditionFieldName value) {
    SetField(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComparator(QueryConditionComparisonOperator value) {
    m_comparatorHasBeenSet = true;
    m_comparator = value;
  }
  inline QueryConditionItem& WithComparator(QueryConditionComparisonOperator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
