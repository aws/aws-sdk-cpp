...
class AIAgentSummary {
 public:
  ...
  inline AIAgentSummary& WithType(AIAgentType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline AIAgentSummary& WithVisibilityStatus(VisibilityStatus value) {
  ...
  inline AIAgentSummary& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
  ...
  inline AIAgentSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
