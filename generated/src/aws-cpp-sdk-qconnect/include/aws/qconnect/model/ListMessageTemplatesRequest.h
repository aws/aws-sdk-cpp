...
class ListMessageTemplatesRequest : public QConnectRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMessageTemplatesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMessageTemplatesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListMessageTemplatesRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
