...
class SearchMessageTemplatesResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<MessageTemplateSearchResultData>>
  SearchMessageTemplatesResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = MessageTemplateSearchResultData>
  SearchMessageTemplatesResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchMessageTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchMessageTemplatesResult& WithRequestId(RequestIdT&& value) {
