...
class CustomerProfileAttributes {
 public:
  ...
  void SetShippingAddress1(ShippingAddress1T&& value) {
    ...
    m_shippingAddress1 = std::forward<ShippingAddress1T>(value);
  }
  template <typename ShippingAddress1T = Aws::String>
  CustomerProfileAttributes& WithShippingAddress1(ShippingAddress1T&& value) {
    SetShippingAddress1(std::forward<ShippingAddress1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingAddress2(ShippingAddress2T&& value) {
    ...
    m_shippingAddress2 = std::forward<ShippingAddress2T>(value);
  }
  template <typename ShippingAddress2T = Aws::String>
  CustomerProfileAttributes& WithShippingAddress2(ShippingAddress2T&& value) {
    SetShippingAddress2(std::forward<ShippingAddress2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingAddress3(ShippingAddress3T&& value) {
    ...
    m_shippingAddress3 = std::forward<ShippingAddress3T>(value);
  }
  template <typename ShippingAddress3T = Aws::String>
  CustomerProfileAttributes& WithShippingAddress3(ShippingAddress3T&& value) {
    SetShippingAddress3(std::forward<ShippingAddress3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingAddress4(ShippingAddress4T&& value) {
    ...
    m_shippingAddress4 = std::forward<ShippingAddress4T>(value);
  }
  template <typename ShippingAddress4T = Aws::String>
  CustomerProfileAttributes& WithShippingAddress4(ShippingAddress4T&& value) {
    SetShippingAddress4(std::forward<ShippingAddress4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingCity(ShippingCityT&& value) {
    ...
    m_shippingCity = std::forward<ShippingCityT>(value);
  }
  template <typename ShippingCityT = Aws::String>
  CustomerProfileAttributes& WithShippingCity(ShippingCityT&& value) {
    SetShippingCity(std::forward<ShippingCityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingCounty(ShippingCountyT&& value) {
    ...
    m_shippingCounty = std::forward<ShippingCountyT>(value);
  }
  template <typename ShippingCountyT = Aws::String>
  CustomerProfileAttributes& WithShippingCounty(ShippingCountyT&& value) {
    SetShippingCounty(std::forward<ShippingCountyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingCountry(ShippingCountryT&& value) {
    ...
    m_shippingCountry = std::forward<ShippingCountryT>(value);
  }
  template <typename ShippingCountryT = Aws::String>
  CustomerProfileAttributes& WithShippingCountry(ShippingCountryT&& value) {
    SetShippingCountry(std::forward<ShippingCountryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingPostalCode(ShippingPostalCodeT&& value) {
    ...
    m_shippingPostalCode = std::forward<ShippingPostalCodeT>(value);
  }
  template <typename ShippingPostalCodeT = Aws::String>
  CustomerProfileAttributes& WithShippingPostalCode(ShippingPostalCodeT&& value) {
    SetShippingPostalCode(std::forward<ShippingPostalCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingProvince(ShippingProvinceT&& value) {
    ...
    m_shippingProvince = std::forward<ShippingProvinceT>(value);
  }
  template <typename ShippingProvinceT = Aws::String>
  CustomerProfileAttributes& WithShippingProvince(ShippingProvinceT&& value) {
    SetShippingProvince(std::forward<ShippingProvinceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetShippingState(ShippingStateT&& value) {
    ...
    m_shippingState = std::forward<ShippingStateT>(value);
  }
  template <typename ShippingStateT = Aws::String>
  CustomerProfileAttributes& WithShippingState(ShippingStateT&& value) {
    SetShippingState(std::forward<ShippingStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingAddress1(MailingAddress1T&& value) {
    ...
    m_mailingAddress1 = std::forward<MailingAddress1T>(value);
  }
  template <typename MailingAddress1T = Aws::String>
  CustomerProfileAttributes& WithMailingAddress1(MailingAddress1T&& value) {
    SetMailingAddress1(std::forward<MailingAddress1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingAddress2(MailingAddress2T&& value) {
    ...
    m_mailingAddress2 = std::forward<MailingAddress2T>(value);
  }
  template <typename MailingAddress2T = Aws::String>
  CustomerProfileAttributes& WithMailingAddress2(MailingAddress2T&& value) {
    SetMailingAddress2(std::forward<MailingAddress2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingAddress3(MailingAddress3T&& value) {
    ...
    m_mailingAddress3 = std::forward<MailingAddress3T>(value);
  }
  template <typename MailingAddress3T = Aws::String>
  CustomerProfileAttributes& WithMailingAddress3(MailingAddress3T&& value) {
    SetMailingAddress3(std::forward<MailingAddress3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingAddress4(MailingAddress4T&& value) {
    ...
    m_mailingAddress4 = std::forward<MailingAddress4T>(value);
  }
  template <typename MailingAddress4T = Aws::String>
  CustomerProfileAttributes& WithMailingAddress4(MailingAddress4T&& value) {
    SetMailingAddress4(std::forward<MailingAddress4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingCity(MailingCityT&& value) {
    ...
    m_mailingCity = std::forward<MailingCityT>(value);
  }
  template <typename MailingCityT = Aws::String>
  CustomerProfileAttributes& WithMailingCity(MailingCityT&& value) {
    SetMailingCity(std::forward<MailingCityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingCounty(MailingCountyT&& value) {
    ...
    m_mailingCounty = std::forward<MailingCountyT>(value);
  }
  template <typename MailingCountyT = Aws::String>
  CustomerProfileAttributes& WithMailingCounty(MailingCountyT&& value) {
    SetMailingCounty(std::forward<MailingCountyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingCountry(MailingCountryT&& value) {
    ...
    m_mailingCountry = std::forward<MailingCountryT>(value);
  }
  template <typename MailingCountryT = Aws::String>
  CustomerProfileAttributes& WithMailingCountry(MailingCountryT&& value) {
    SetMailingCountry(std::forward<MailingCountryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingPostalCode(MailingPostalCodeT&& value) {
    ...
    m_mailingPostalCode = std::forward<MailingPostalCodeT>(value);
  }
  template <typename MailingPostalCodeT = Aws::String>
  CustomerProfileAttributes& WithMailingPostalCode(MailingPostalCodeT&& value) {
    SetMailingPostalCode(std::forward<MailingPostalCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingProvince(MailingProvinceT&& value) {
    ...
    m_mailingProvince = std::forward<MailingProvinceT>(value);
  }
  template <typename MailingProvinceT = Aws::String>
  CustomerProfileAttributes& WithMailingProvince(MailingProvinceT&& value) {
    SetMailingProvince(std::forward<MailingProvinceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMailingState(MailingStateT&& value) {
    ...
    m_mailingState = std::forward<MailingStateT>(value);
  }
  template <typename MailingStateT = Aws::String>
  CustomerProfileAttributes& WithMailingState(MailingStateT&& value) {
    SetMailingState(std::forward<MailingStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingAddress1(BillingAddress1T&& value) {
    ...
    m_billingAddress1 = std::forward<BillingAddress1T>(value);
  }
  template <typename BillingAddress1T = Aws::String>
  CustomerProfileAttributes& WithBillingAddress1(BillingAddress1T&& value) {
    SetBillingAddress1(std::forward<BillingAddress1T>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingAddress2(BillingAddress2T&& value) {
    ...
    m_billingAddress2 = std::forward<BillingAddress2T>(value);
  }
  template <typename BillingAddress2T = Aws::String>
  CustomerProfileAttributes& WithBillingAddress2(BillingAddress2T&& value) {
    SetBillingAddress2(std::forward<BillingAddress2T>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingAddress3(BillingAddress3T&& value) {
    ...
    m_billingAddress3 = std::forward<BillingAddress3T>(value);
  }
  template <typename BillingAddress3T = Aws::String>
  CustomerProfileAttributes& WithBillingAddress3(BillingAddress3T&& value) {
    SetBillingAddress3(std::forward<BillingAddress3T>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingAddress4(BillingAddress4T&& value) {
    ...
    m_billingAddress4 = std::forward<BillingAddress4T>(value);
  }
  template <typename BillingAddress4T = Aws::String>
  CustomerProfileAttributes& WithBillingAddress4(BillingAddress4T&& value) {
    SetBillingAddress4(std::forward<BillingAddress4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingCity(BillingCityT&& value) {
    ...
    m_billingCity = std::forward<BillingCityT>(value);
  }
  template <typename BillingCityT = Aws::String>
  CustomerProfileAttributes& WithBillingCity(BillingCityT&& value) {
    SetBillingCity(std::forward<BillingCityT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingCounty(BillingCountyT&& value) {
    ...
    m_billingCounty = std::forward<BillingCountyT>(value);
  }
  template <typename BillingCountyT = Aws::String>
  CustomerProfileAttributes& WithBillingCounty(BillingCountyT&& value) {
    SetBillingCounty(std::forward<BillingCountyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingCountry(BillingCountryT&& value) {
    ...
    m_billingCountry = std::forward<BillingCountryT>(value);
  }
  template <typename BillingCountryT = Aws::String>
  CustomerProfileAttributes& WithBillingCountry(BillingCountryT&& value) {
    SetBillingCountry(std::forward<BillingCountryT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingPostalCode(BillingPostalCodeT&& value) {
    ...
    m_billingPostalCode = std::forward<BillingPostalCodeT>(value);
  }
  template <typename BillingPostalCodeT = Aws::String>
  CustomerProfileAttributes& WithBillingPostalCode(BillingPostalCodeT&& value) {
    SetBillingPostalCode(std::forward<BillingPostalCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingProvince(BillingProvinceT&& value) {
    ...
    m_billingProvince = std::forward<BillingProvinceT>(value);
  }
  template <typename BillingProvinceT = Aws::String>
  CustomerProfileAttributes& WithBillingProvince(BillingProvinceT&& value) {
    SetBillingProvince(std::forward<BillingProvinceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingState(BillingStateT&& value) {
    ...
    m_billingState = std::forward<BillingStateT>(value);
  }
  template <typename BillingStateT = Aws::String>
  CustomerProfileAttributes& WithBillingState(BillingStateT&& value) {
    SetBillingState(std::forward<BillingStateT>(value));
    return *this;
  }
  ///@}
  ...
  CustomerProfileAttributes& AddCustom(CustomKeyT&& key, CustomValueT&& value) {
    m_customHasBeenSet = true;
    m_custom.emplace(std::forward<CustomKeyT>(key), std::forward<CustomValueT>(value));
    return *this;
  }
  ///@}
 private:
