...
class CreateContentAssociationResult {
 public:
  ...
  void SetContentAssociation(ContentAssociationT&& value) {
    m_contentAssociationHasBeenSet = true;
    m_contentAssociation = std::forward<ContentAssociationT>(value);
  }
  template <typename ContentAssociationT = ContentAssociationData>
  CreateContentAssociationResult& WithContentAssociation(ContentAssociationT&& value) {
    SetContentAssociation(std::forward<ContentAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  CreateContentAssociationResult& WithRequestId(RequestIdT&& value) {
