...
class ListAIAgentsResult {
 public:
  ...
  void SetAiAgentSummaries(AiAgentSummariesT&& value) {
    m_aiAgentSummariesHasBeenSet = true;
    m_aiAgentSummaries = std::forward<AiAgentSummariesT>(value);
  }
  template <typename AiAgentSummariesT = Aws::Vector<AIAgentSummary>>
  ListAIAgentsResult& WithAiAgentSummaries(AiAgentSummariesT&& value) {
    SetAiAgentSummaries(std::forward<AiAgentSummariesT>(value));
    return *this;
  }
  template <typename AiAgentSummariesT = AIAgentSummary>
  ListAIAgentsResult& AddAiAgentSummaries(AiAgentSummariesT&& value) {
    m_aiAgentSummariesHasBeenSet = true;
    m_aiAgentSummaries.emplace_back(std::forward<AiAgentSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAIAgentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAIAgentsResult& WithRequestId(RequestIdT&& value) {
