...
class ConversationContext {
 public:
   ...
   * session.</p>
   */
  inline const Aws::Vector<SelfServiceConversationHistory>& GetSelfServiceConversationHistory() const {
    return m_selfServiceConversationHistory;
  }
  ...
  void SetSelfServiceConversationHistory(SelfServiceConversationHistoryT&& value) {
    ...
    m_selfServiceConversationHistory = std::forward<SelfServiceConversationHistoryT>(value);
  }
  template <typename SelfServiceConversationHistoryT = Aws::Vector<SelfServiceConversationHistory>>
  ConversationContext& WithSelfServiceConversationHistory(SelfServiceConversationHistoryT&& value) {
    SetSelfServiceConversationHistory(std::forward<SelfServiceConversationHistoryT>(value));
    return *this;
  }
  ...
  ConversationContext& AddSelfServiceConversationHistory(SelfServiceConversationHistoryT&& value) {
    m_selfServiceConversationHistoryHasBeenSet = true;
    m_selfServiceConversationHistory.emplace_back(std::forward<SelfServiceConversationHistoryT>(value));
    return *this;
  }
  ///@}
 private:
