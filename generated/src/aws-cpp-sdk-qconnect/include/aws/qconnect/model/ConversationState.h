...
class ConversationState {
 public:
  ...
  inline void SetStatus(ConversationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ConversationState& WithStatus(ConversationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReason(ConversationStatusReason value) {
    m_reasonHasBeenSet = true;
    m_reason = value;
  }
  inline ConversationState& WithReason(ConversationStatusReason value) {
    SetReason(value);
    return *this;
  }
  ///@}
