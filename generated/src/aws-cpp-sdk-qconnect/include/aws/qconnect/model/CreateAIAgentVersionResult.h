...
class CreateAIAgentVersionResult {
 public:
  ...
  template <typename AiAgentT = AIAgentData>
  CreateAIAgentVersionResult& WithAiAgent(AiAgentT&& value) {
  ...
  inline CreateAIAgentVersionResult& WithVersionNumber(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAIAgentVersionResult& WithRequestId(RequestIdT&& value) {
