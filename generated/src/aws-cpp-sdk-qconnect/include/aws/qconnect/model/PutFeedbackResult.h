...
class PutFeedbackResult {
 public:
  ...
  inline PutFeedbackResult& WithTargetType(TargetType value) {
    SetTargetType(value);
    return *this;
  }
  ///@}
  ...
  void SetContentFeedback(ContentFeedbackT&& value) {
    ...
    m_contentFeedback = std::forward<ContentFeedbackT>(value);
  }
  template <typename ContentFeedbackT = ContentFeedbackData>
  PutFeedbackResult& WithContentFeedback(ContentFeedbackT&& value) {
    SetContentFeedback(std::forward<ContentFeedbackT>(value));
    return *this;
  }
  ///@}
