...
/**
 */
class SearchContentRequest : public QConnectRequest {
 public:
  AWS_QCONNECT_API SearchContentRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  SearchContentRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchContentRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  SearchContentRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  void SetSearchExpression(SearchExpressionT&& value) {
    m_searchExpressionHasBeenSet = true;
    m_searchExpression = std::forward<SearchExpressionT>(value);
  }
  template <typename SearchExpressionT = SearchExpression>
  SearchContentRequest& WithSearchExpression(SearchExpressionT&& value) {
    SetSearchExpression(std::forward<SearchExpressionT>(value));
    return *this;
  }
  ///@}
 private:
