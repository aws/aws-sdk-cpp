...
class GetAIGuardrailResult {
 public:
  ...
  template <typename AiGuardrailT = AIGuardrailData>
  GetAIGuardrailResult& WithAiGuardrail(AiGuardrailT&& value) {
  ...
  inline GetAIGuardrailResult& WithVersionNumber(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAIGuardrailResult& WithRequestId(RequestIdT&& value) {
