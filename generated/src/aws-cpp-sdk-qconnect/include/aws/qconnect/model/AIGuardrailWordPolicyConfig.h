...
class AIGuardrailWordPolicyConfig {
 public:
  ...
  template <typename WordsConfigT = Aws::Vector<GuardrailWordConfig>>
  AIGuardrailWordPolicyConfig& WithWordsConfig(WordsConfigT&& value) {
    SetWordsConfig(std::forward<WordsConfigT>(value));
    return *this;
  }
  template <typename WordsConfigT = GuardrailWordConfig>
  AIGuardrailWordPolicyConfig& AddWordsConfig(WordsConfigT&& value) {
    m_wordsConfigHasBeenSet = true;
  ...
  template <typename ManagedWordListsConfigT = Aws::Vector<GuardrailManagedWordsConfig>>
  AIGuardrailWordPolicyConfig& WithManagedWordListsConfig(ManagedWordListsConfigT&& value) {
  ...
  AIGuardrailWordPolicyConfig& AddManagedWordListsConfig(ManagedWordListsConfigT&& value) {
    m_managedWordListsConfigHasBeenSet = true;
