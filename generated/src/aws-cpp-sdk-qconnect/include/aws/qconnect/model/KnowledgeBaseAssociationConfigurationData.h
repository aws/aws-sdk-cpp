...
class KnowledgeBaseAssociationConfigurationData {
 public:
  ...
  void SetContentTagFilter(ContentTagFilterT&& value) {
    ...
    m_contentTagFilter = std::forward<ContentTagFilterT>(value);
  }
  template <typename ContentTagFilterT = TagFilter>
  KnowledgeBaseAssociationConfigurationData& WithContentTagFilter(ContentTagFilterT&& value) {
    SetContentTagFilter(std::forward<ContentTagFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline KnowledgeBaseAssociationConfigurationData& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline KnowledgeBaseAssociationConfigurationData& WithOverrideKnowledgeBaseSearchType(KnowledgeBaseSearchType value) {
