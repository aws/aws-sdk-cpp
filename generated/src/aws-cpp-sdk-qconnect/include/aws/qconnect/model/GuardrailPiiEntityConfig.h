...
/**
 * <p>The PII entity to configure for the AI Guardrail.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/qconnect-2020-10-19/GuardrailPiiEntityConfig">AWS
 * API Reference</a></p>
 */
class GuardrailPiiEntityConfig {
 public:
  ...
  ///@{
  /**
   * <p>Configure AI Guardrail type when the PII entity is detected.</p> <p>The
   ...
   * entity type does not include titles, such as Dr., Mr., Mrs., or Miss. AI
   * Guardrail doesn't apply this entity type to names that are part of organizations
   * or addresses. For example, AI Guardrail recognizes the "John Doe Organization"
   * as an organization, and it recognizes "Jane Doe Street" as an address. </p>
   * </li> <li> <p> <b>EMAIL</b> </p> <p>An email address, such as
   ...
   * <i>month/year</i> or <i>MM/YY</i>. AI Guardrail recognizes expiration dates such
   ...
   * filter</b> - You can use a regular expressions to define patterns for an AI
  ...
  inline GuardrailPiiEntityConfig& WithType(GuardrailPiiEntityType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAction(GuardrailSensitiveInformationAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline GuardrailPiiEntityConfig& WithAction(GuardrailSensitiveInformationAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
