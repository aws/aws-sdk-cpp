...
namespace Model
{
  ...
  public:
    ...
    template<typename KnowledgeBaseIdT = Aws::String>
    RenderMessageTemplateRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) { SetKnowledgeBaseId(std::forward<KnowledgeBaseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageTemplateIdT = Aws::String>
    RenderMessageTemplateRequest& WithMessageTemplateId(MessageTemplateIdT&& value) { SetMessageTemplateId(std::forward<MessageTemplateIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AttributesT = MessageTemplateAttributes>
    RenderMessageTemplateRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ///@}
  private:
