...
class RenderMessageTemplateRequest : public QConnectRequest {
 public:
  AWS_QCONNECT_API RenderMessageTemplateRequest() = default;
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  RenderMessageTemplateRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  RenderMessageTemplateRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename AttributesT = MessageTemplateAttributes>
  void SetAttributes(AttributesT&& value) {
    m_attributesHasBeenSet = true;
    m_attributes = std::forward<AttributesT>(value);
  }
  template <typename AttributesT = MessageTemplateAttributes>
  RenderMessageTemplateRequest& WithAttributes(AttributesT&& value) {
