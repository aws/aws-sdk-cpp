...
class ListQuickResponsesRequest : public QConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListQuickResponses"; }
  ...
  template <typename NextTokenT = Aws::String>
  ListQuickResponsesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQuickResponsesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListQuickResponsesRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
