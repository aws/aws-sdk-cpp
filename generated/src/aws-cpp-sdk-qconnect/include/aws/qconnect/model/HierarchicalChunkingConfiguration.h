...
class HierarchicalChunkingConfiguration {
 public:
  ...
  void SetLevelConfigurations(LevelConfigurationsT&& value) {
    ...
    m_levelConfigurations = std::forward<LevelConfigurationsT>(value);
  }
  template <typename LevelConfigurationsT = Aws::Vector<HierarchicalChunkingLevelConfiguration>>
  HierarchicalChunkingConfiguration& WithLevelConfigurations(LevelConfigurationsT&& value) {
    SetLevelConfigurations(std::forward<LevelConfigurationsT>(value));
    return *this;
  }
  ...
  HierarchicalChunkingConfiguration& AddLevelConfigurations(LevelConfigurationsT&& value) {
    m_levelConfigurationsHasBeenSet = true;
    m_levelConfigurations.emplace_back(std::forward<LevelConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOverlapTokens(int value) {
    m_overlapTokensHasBeenSet = true;
    m_overlapTokens = value;
  }
  inline HierarchicalChunkingConfiguration& WithOverlapTokens(int value) {
    SetOverlapTokens(value);
    return *this;
  }
  ///@}
 private:
