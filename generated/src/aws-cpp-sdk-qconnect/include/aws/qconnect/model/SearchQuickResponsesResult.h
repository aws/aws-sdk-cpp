...
class SearchQuickResponsesResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<QuickResponseSearchResultData>>
  SearchQuickResponsesResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = QuickResponseSearchResultData>
  SearchQuickResponsesResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchQuickResponsesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchQuickResponsesResult& WithRequestId(RequestIdT&& value) {
