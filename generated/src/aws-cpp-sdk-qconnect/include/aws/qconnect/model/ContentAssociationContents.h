...
class ContentAssociationContents {
 public:
  ...
  void SetAmazonConnectGuideAssociation(AmazonConnectGuideAssociationT&& value) {
    m_amazonConnectGuideAssociationHasBeenSet = true;
    m_amazonConnectGuideAssociation = std::forward<AmazonConnectGuideAssociationT>(value);
  }
  template <typename AmazonConnectGuideAssociationT = AmazonConnectGuideAssociationData>
  ContentAssociationContents& WithAmazonConnectGuideAssociation(AmazonConnectGuideAssociationT&& value) {
    SetAmazonConnectGuideAssociation(std::forward<AmazonConnectGuideAssociationT>(value));
    return *this;
  }
  ///@}
 private:
