...
class MessageTemplateAttributes {
 public:
  ...
  void SetSystemAttributes(SystemAttributesT&& value) {
    ...
    m_systemAttributes = std::forward<SystemAttributesT>(value);
  }
  template <typename SystemAttributesT = SystemAttributes>
  MessageTemplateAttributes& WithSystemAttributes(SystemAttributesT&& value) {
    SetSystemAttributes(std::forward<SystemAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAgentAttributes(AgentAttributesT&& value) {
    ...
    m_agentAttributes = std::forward<AgentAttributesT>(value);
  }
  template <typename AgentAttributesT = AgentAttributes>
  MessageTemplateAttributes& WithAgentAttributes(AgentAttributesT&& value) {
    SetAgentAttributes(std::forward<AgentAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomerProfileAttributes(CustomerProfileAttributesT&& value) {
    ...
    m_customerProfileAttributes = std::forward<CustomerProfileAttributesT>(value);
  }
  template <typename CustomerProfileAttributesT = CustomerProfileAttributes>
  MessageTemplateAttributes& WithCustomerProfileAttributes(CustomerProfileAttributesT&& value) {
    SetCustomerProfileAttributes(std::forward<CustomerProfileAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  MessageTemplateAttributes& AddCustomAttributes(CustomAttributesKeyT&& key, CustomAttributesValueT&& value) {
    m_customAttributesHasBeenSet = true;
    m_customAttributes.emplace(std::forward<CustomAttributesKeyT>(key), std::forward<CustomAttributesValueT>(value));
    return *this;
  }
  ///@}
 private:
