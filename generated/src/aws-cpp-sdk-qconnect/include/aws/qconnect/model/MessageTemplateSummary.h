...
class MessageTemplateSummary {
 public:
  ...
  inline MessageTemplateSummary& WithChannelSubtype(ChannelSubtype value) {
  ...
  inline void SetActiveVersionNumber(long long value) {
    m_activeVersionNumberHasBeenSet = true;
    m_activeVersionNumber = value;
  }
  inline MessageTemplateSummary& WithActiveVersionNumber(long long value) {
