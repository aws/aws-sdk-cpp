...
class ContentDataDetails {
 public:
  ...
  void SetTextData(TextDataT&& value) {
    m_textDataHasBeenSet = true;
    m_textData = std::forward<TextDataT>(value);
  }
  template <typename TextDataT = TextData>
  ContentDataDetails& WithTextData(TextDataT&& value) {
    SetTextData(std::forward<TextDataT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRankingData(RankingDataT&& value) {
    ...
    m_rankingData = std::forward<RankingDataT>(value);
  }
  template <typename RankingDataT = RankingData>
  ContentDataDetails& WithRankingData(RankingDataT&& value) {
    SetRankingData(std::forward<RankingDataT>(value));
    return *this;
  }
  ///@}
 private:
