...
class ActivateMessageTemplateRequest : public QConnectRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ActivateMessageTemplateRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  ActivateMessageTemplateRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  inline ActivateMessageTemplateRequest& WithVersionNumber(long long value) {
