...
namespace Model
{
  ...
  {
  public:
    AWS_QCONNECT_API ActivateMessageTemplateRequest() = default;
    ...
    template<typename KnowledgeBaseIdT = Aws::String>
    ActivateMessageTemplateRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) { SetKnowledgeBaseId(std::forward<KnowledgeBaseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageTemplateIdT = Aws::String>
    ActivateMessageTemplateRequest& WithMessageTemplateId(MessageTemplateIdT&& value) { SetMessageTemplateId(std::forward<MessageTemplateIdT>(value)); return *this;}
    ///@}
