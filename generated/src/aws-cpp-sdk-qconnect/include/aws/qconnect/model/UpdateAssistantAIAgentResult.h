...
namespace Model
{
  ...
  public:
    ...
    template<typename AssistantT = AssistantData>
    UpdateAssistantAIAgentResult& WithAssistant(AssistantT&& value) { SetAssistant(std::forward<AssistantT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateAssistantAIAgentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
