...
namespace Model
{
  ...
  public:
    ...
    void SetEmailResponseAIPromptId(EmailResponseAIPromptIdT&& value) { m_emailResponseAIPromptIdHasBeenSet = true; m_emailResponseAIPromptId = std::forward<EmailResponseAIPromptIdT>(value); }
    template<typename EmailResponseAIPromptIdT = Aws::String>
    EmailResponseAIAgentConfiguration& WithEmailResponseAIPromptId(EmailResponseAIPromptIdT&& value) { SetEmailResponseAIPromptId(std::forward<EmailResponseAIPromptIdT>(value)); return *this;}
    ///@}
    ...
    void SetEmailQueryReformulationAIPromptId(EmailQueryReformulationAIPromptIdT&& value) { m_emailQueryReformulationAIPromptIdHasBeenSet = true; m_emailQueryReformulationAIPromptId = std::forward<EmailQueryReformulationAIPromptIdT>(value); }
    template<typename EmailQueryReformulationAIPromptIdT = Aws::String>
    EmailResponseAIAgentConfiguration& WithEmailQueryReformulationAIPromptId(EmailQueryReformulationAIPromptIdT&& value) { SetEmailQueryReformulationAIPromptId(std::forward<EmailQueryReformulationAIPromptIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocaleT = Aws::String>
    EmailResponseAIAgentConfiguration& WithLocale(LocaleT&& value) { SetLocale(std::forward<LocaleT>(value)); return *this;}
    ///@}
    ...
    template<typename AssociationConfigurationsT = Aws::Vector<AssociationConfiguration>>
    EmailResponseAIAgentConfiguration& WithAssociationConfigurations(AssociationConfigurationsT&& value) { SetAssociationConfigurations(std::forward<AssociationConfigurationsT>(value)); return *this;}
    template<typename AssociationConfigurationsT = AssociationConfiguration>
    EmailResponseAIAgentConfiguration& AddAssociationConfigurations(AssociationConfigurationsT&& value) { m_associationConfigurationsHasBeenSet = true; m_associationConfigurations.emplace_back(std::forward<AssociationConfigurationsT>(value)); return *this; }
    ///@}
  private:
