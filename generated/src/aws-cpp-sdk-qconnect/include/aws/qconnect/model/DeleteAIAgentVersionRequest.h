...
class DeleteAIAgentVersionRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  DeleteAIAgentVersionRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiAgentIdT = Aws::String>
  DeleteAIAgentVersionRequest& WithAiAgentId(AiAgentIdT&& value) {
  ...
  inline DeleteAIAgentVersionRequest& WithVersionNumber(long long value) {
