...
class AIGuardrailVersionSummary {
 public:
  ...
  void SetAiGuardrailSummary(AiGuardrailSummaryT&& value) {
    ...
    m_aiGuardrailSummary = std::forward<AiGuardrailSummaryT>(value);
  }
  template <typename AiGuardrailSummaryT = AIGuardrailSummary>
  AIGuardrailVersionSummary& WithAiGuardrailSummary(AiGuardrailSummaryT&& value) {
    SetAiGuardrailSummary(std::forward<AiGuardrailSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline AIGuardrailVersionSummary& WithVersionNumber(long long value) {
