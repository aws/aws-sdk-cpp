...
class MessageTemplateData {
 public:
  ...
  template <typename MessageTemplateArnT = Aws::String>
  MessageTemplateData& WithMessageTemplateArn(MessageTemplateArnT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  MessageTemplateData& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename KnowledgeBaseArnT = Aws::String>
  MessageTemplateData& WithKnowledgeBaseArn(KnowledgeBaseArnT&& value) {
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  MessageTemplateData& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  inline MessageTemplateData& WithChannelSubtype(ChannelSubtype value) {
  ...
  template <typename CreatedTimeT = Aws::Utils::DateTime>
  MessageTemplateData& WithCreatedTime(CreatedTimeT&& value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  MessageTemplateData& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename LastModifiedByT = Aws::String>
  MessageTemplateData& WithLastModifiedBy(LastModifiedByT&& value) {
  ...
  template <typename ContentT = MessageTemplateContentProvider>
  MessageTemplateData& WithContent(ContentT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  MessageTemplateData& WithDescription(DescriptionT&& value) {
  ...
  template <typename LanguageT = Aws::String>
  MessageTemplateData& WithLanguage(LanguageT&& value) {
  ...
  template <typename GroupingConfigurationT = GroupingConfiguration>
  MessageTemplateData& WithGroupingConfiguration(GroupingConfigurationT&& value) {
  ...
  template <typename DefaultAttributesT = MessageTemplateAttributes>
  MessageTemplateData& WithDefaultAttributes(DefaultAttributesT&& value) {
  ...
  template <typename AttributeTypesT = Aws::Vector<MessageTemplateAttributeType>>
  MessageTemplateData& WithAttributeTypes(AttributeTypesT&& value) {
    SetAttributeTypes(std::forward<AttributeTypesT>(value));
    return *this;
  }
  inline MessageTemplateData& AddAttributeTypes(MessageTemplateAttributeType value) {
    m_attributeTypesHasBeenSet = true;
  ...
  template <typename MessageTemplateContentSha256T = Aws::String>
  MessageTemplateData& WithMessageTemplateContentSha256(MessageTemplateContentSha256T&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  MessageTemplateData& WithTags(TagsT&& value) {
