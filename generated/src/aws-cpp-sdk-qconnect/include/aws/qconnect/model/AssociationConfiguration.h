...
class AssociationConfiguration {
 public:
  ...
  template <typename AssociationIdT = Aws::String>
  AssociationConfiguration& WithAssociationId(AssociationIdT&& value) {
  ...
  inline void SetAssociationType(AIAgentAssociationConfigurationType value) {
    m_associationTypeHasBeenSet = true;
    m_associationType = value;
  }
  inline AssociationConfiguration& WithAssociationType(AIAgentAssociationConfigurationType value) {
  ...
  void SetAssociationConfigurationData(AssociationConfigurationDataT&& value) {
    m_associationConfigurationDataHasBeenSet = true;
    m_associationConfigurationData = std::forward<AssociationConfigurationDataT>(value);
  }
  template <typename AssociationConfigurationDataT = AssociationConfigurationData>
  AssociationConfiguration& WithAssociationConfigurationData(AssociationConfigurationDataT&& value) {
    SetAssociationConfigurationData(std::forward<AssociationConfigurationDataT>(value));
    return *this;
  }
  ///@}
 private:
