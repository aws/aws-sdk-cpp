...
class GetNextMessageResult {
 public:
  ...
  inline GetNextMessageResult& WithType(MessageType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetConversationState(ConversationStateT&& value) {
    ...
    m_conversationState = std::forward<ConversationStateT>(value);
  }
  template <typename ConversationStateT = ConversationState>
  GetNextMessageResult& WithConversationState(ConversationStateT&& value) {
    SetConversationState(std::forward<ConversationStateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConversationSessionData(ConversationSessionDataT&& value) {
    ...
    m_conversationSessionData = std::forward<ConversationSessionDataT>(value);
  }
  template <typename ConversationSessionDataT = Aws::Vector<RuntimeSessionData>>
  GetNextMessageResult& WithConversationSessionData(ConversationSessionDataT&& value) {
    SetConversationSessionData(std::forward<ConversationSessionDataT>(value));
    return *this;
  }
  ...
  GetNextMessageResult& AddConversationSessionData(ConversationSessionDataT&& value) {
    m_conversationSessionDataHasBeenSet = true;
    m_conversationSessionData.emplace_back(std::forward<ConversationSessionDataT>(value));
    return *this;
  }
  ///@}
