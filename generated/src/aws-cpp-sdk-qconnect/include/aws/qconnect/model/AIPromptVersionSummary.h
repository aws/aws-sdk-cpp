...
class AIPromptVersionSummary {
 public:
  ...
  void SetAiPromptSummary(AiPromptSummaryT&& value) {
    ...
    m_aiPromptSummary = std::forward<AiPromptSummaryT>(value);
  }
  template <typename AiPromptSummaryT = AIPromptSummary>
  AIPromptVersionSummary& WithAiPromptSummary(AiPromptSummaryT&& value) {
    SetAiPromptSummary(std::forward<AiPromptSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline AIPromptVersionSummary& WithVersionNumber(long long value) {
