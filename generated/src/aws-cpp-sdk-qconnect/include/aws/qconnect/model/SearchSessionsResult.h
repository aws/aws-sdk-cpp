...
class SearchSessionsResult {
 public:
  ...
  template <typename SessionSummariesT = Aws::Vector<SessionSummary>>
  SearchSessionsResult& WithSessionSummaries(SessionSummariesT&& value) {
    SetSessionSummaries(std::forward<SessionSummariesT>(value));
    return *this;
  }
  template <typename SessionSummariesT = SessionSummary>
  SearchSessionsResult& AddSessionSummaries(SessionSummariesT&& value) {
    m_sessionSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchSessionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SearchSessionsResult& WithRequestId(RequestIdT&& value) {
