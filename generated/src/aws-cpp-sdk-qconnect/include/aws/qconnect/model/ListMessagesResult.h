...
class ListMessagesResult {
 public:
  ...
  template <typename MessagesT = Aws::Vector<MessageOutput>>
  ListMessagesResult& WithMessages(MessagesT&& value) {
    SetMessages(std::forward<MessagesT>(value));
    return *this;
  }
  template <typename MessagesT = MessageOutput>
  ListMessagesResult& AddMessages(MessagesT&& value) {
    m_messagesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListMessagesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMessagesResult& WithRequestId(RequestIdT&& value) {
