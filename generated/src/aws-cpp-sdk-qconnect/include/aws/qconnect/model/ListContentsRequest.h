...
class ListContentsRequest : public QConnectRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListContentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListContentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListContentsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
