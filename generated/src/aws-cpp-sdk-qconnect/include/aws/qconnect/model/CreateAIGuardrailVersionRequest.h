...
class CreateAIGuardrailVersionRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  CreateAIGuardrailVersionRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  void SetAiGuardrailId(AiGuardrailIdT&& value) {
    ...
    m_aiGuardrailId = std::forward<AiGuardrailIdT>(value);
  }
  template <typename AiGuardrailIdT = Aws::String>
  CreateAIGuardrailVersionRequest& WithAiGuardrailId(AiGuardrailIdT&& value) {
    SetAiGuardrailId(std::forward<AiGuardrailIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ModifiedTimeT = Aws::Utils::DateTime>
  CreateAIGuardrailVersionRequest& WithModifiedTime(ModifiedTimeT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateAIGuardrailVersionRequest& WithClientToken(ClientTokenT&& value) {
