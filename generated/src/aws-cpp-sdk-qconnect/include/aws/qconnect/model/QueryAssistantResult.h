...
namespace Model
{
  ...
  {
  public:
    AWS_QCONNECT_API QueryAssistantResult();
    AWS_QCONNECT_API QueryAssistantResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    AWS_QCONNECT_API QueryAssistantResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    ...
    inline QueryAssistantResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline QueryAssistantResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline QueryAssistantResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
