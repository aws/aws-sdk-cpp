...
class RenderMessageTemplateResult {
 public:
  ...
  void SetAttributesNotInterpolated(AttributesNotInterpolatedT&& value) {
    ...
    m_attributesNotInterpolated = std::forward<AttributesNotInterpolatedT>(value);
  }
  template <typename AttributesNotInterpolatedT = Aws::Vector<Aws::String>>
  RenderMessageTemplateResult& WithAttributesNotInterpolated(AttributesNotInterpolatedT&& value) {
    SetAttributesNotInterpolated(std::forward<AttributesNotInterpolatedT>(value));
    return *this;
  }
  ...
  RenderMessageTemplateResult& AddAttributesNotInterpolated(AttributesNotInterpolatedT&& value) {
    m_attributesNotInterpolatedHasBeenSet = true;
    m_attributesNotInterpolated.emplace_back(std::forward<AttributesNotInterpolatedT>(value));
    return *this;
  }
  ///@}
