...
class MessageTemplateSearchExpression {
 public:
  ...
  template <typename QueriesT = Aws::Vector<MessageTemplateQueryField>>
  MessageTemplateSearchExpression& WithQueries(QueriesT&& value) {
    SetQueries(std::forward<QueriesT>(value));
    return *this;
  }
  template <typename QueriesT = MessageTemplateQueryField>
  MessageTemplateSearchExpression& AddQueries(QueriesT&& value) {
    m_queriesHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<MessageTemplateFilterField>>
  MessageTemplateSearchExpression& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = MessageTemplateFilterField>
  MessageTemplateSearchExpression& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename OrderOnFieldT = MessageTemplateOrderField>
  MessageTemplateSearchExpression& WithOrderOnField(OrderOnFieldT&& value) {
