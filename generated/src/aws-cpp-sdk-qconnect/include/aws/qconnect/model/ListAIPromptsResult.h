...
class ListAIPromptsResult {
 public:
  ...
  void SetAiPromptSummaries(AiPromptSummariesT&& value) {
    m_aiPromptSummariesHasBeenSet = true;
    m_aiPromptSummaries = std::forward<AiPromptSummariesT>(value);
  }
  template <typename AiPromptSummariesT = Aws::Vector<AIPromptSummary>>
  ListAIPromptsResult& WithAiPromptSummaries(AiPromptSummariesT&& value) {
    SetAiPromptSummaries(std::forward<AiPromptSummariesT>(value));
    return *this;
  }
  template <typename AiPromptSummariesT = AIPromptSummary>
  ListAIPromptsResult& AddAiPromptSummaries(AiPromptSummariesT&& value) {
    m_aiPromptSummariesHasBeenSet = true;
    m_aiPromptSummaries.emplace_back(std::forward<AiPromptSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAIPromptsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAIPromptsResult& WithRequestId(RequestIdT&& value) {
