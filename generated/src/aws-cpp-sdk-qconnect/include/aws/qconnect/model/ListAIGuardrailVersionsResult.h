...
class ListAIGuardrailVersionsResult {
 public:
  ...
  void SetAiGuardrailVersionSummaries(AiGuardrailVersionSummariesT&& value) {
    m_aiGuardrailVersionSummariesHasBeenSet = true;
    m_aiGuardrailVersionSummaries = std::forward<AiGuardrailVersionSummariesT>(value);
  }
  template <typename AiGuardrailVersionSummariesT = Aws::Vector<AIGuardrailVersionSummary>>
  ListAIGuardrailVersionsResult& WithAiGuardrailVersionSummaries(AiGuardrailVersionSummariesT&& value) {
    SetAiGuardrailVersionSummaries(std::forward<AiGuardrailVersionSummariesT>(value));
    return *this;
  }
  template <typename AiGuardrailVersionSummariesT = AIGuardrailVersionSummary>
  ListAIGuardrailVersionsResult& AddAiGuardrailVersionSummaries(AiGuardrailVersionSummariesT&& value) {
    m_aiGuardrailVersionSummariesHasBeenSet = true;
    m_aiGuardrailVersionSummaries.emplace_back(std::forward<AiGuardrailVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAIGuardrailVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAIGuardrailVersionsResult& WithRequestId(RequestIdT&& value) {
