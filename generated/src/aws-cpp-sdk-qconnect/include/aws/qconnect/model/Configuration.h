...
class Configuration {
 public:
  ...
  void SetConnectConfiguration(ConnectConfigurationT&& value) {
    m_connectConfigurationHasBeenSet = true;
    m_connectConfiguration = std::forward<ConnectConfigurationT>(value);
  }
  template <typename ConnectConfigurationT = ConnectConfiguration>
  Configuration& WithConnectConfiguration(ConnectConfigurationT&& value) {
    SetConnectConfiguration(std::forward<ConnectConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
