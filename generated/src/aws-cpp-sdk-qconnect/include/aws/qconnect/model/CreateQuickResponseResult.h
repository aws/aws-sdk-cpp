...
class CreateQuickResponseResult {
 public:
  AWS_QCONNECT_API CreateQuickResponseResult() = default;
  ...
  template <typename QuickResponseT = QuickResponseData>
  CreateQuickResponseResult& WithQuickResponse(QuickResponseT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateQuickResponseResult& WithRequestId(RequestIdT&& value) {
