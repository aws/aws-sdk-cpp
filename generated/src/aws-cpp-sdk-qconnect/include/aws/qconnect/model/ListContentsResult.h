...
class ListContentsResult {
 public:
  AWS_QCONNECT_API ListContentsResult() = default;
  ...
  template <typename ContentSummariesT = Aws::Vector<ContentSummary>>
  ListContentsResult& WithContentSummaries(ContentSummariesT&& value) {
    SetContentSummaries(std::forward<ContentSummariesT>(value));
    return *this;
  }
  template <typename ContentSummariesT = ContentSummary>
  ListContentsResult& AddContentSummaries(ContentSummariesT&& value) {
    m_contentSummariesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListContentsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListContentsResult& WithRequestId(RequestIdT&& value) {
