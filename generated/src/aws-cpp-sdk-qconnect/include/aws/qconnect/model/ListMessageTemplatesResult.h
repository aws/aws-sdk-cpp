...
class ListMessageTemplatesResult {
 public:
  ...
  void SetMessageTemplateSummaries(MessageTemplateSummariesT&& value) {
    m_messageTemplateSummariesHasBeenSet = true;
    m_messageTemplateSummaries = std::forward<MessageTemplateSummariesT>(value);
  }
  template <typename MessageTemplateSummariesT = Aws::Vector<MessageTemplateSummary>>
  ListMessageTemplatesResult& WithMessageTemplateSummaries(MessageTemplateSummariesT&& value) {
    SetMessageTemplateSummaries(std::forward<MessageTemplateSummariesT>(value));
    return *this;
  }
  template <typename MessageTemplateSummariesT = MessageTemplateSummary>
  ListMessageTemplatesResult& AddMessageTemplateSummaries(MessageTemplateSummariesT&& value) {
    m_messageTemplateSummariesHasBeenSet = true;
    m_messageTemplateSummaries.emplace_back(std::forward<MessageTemplateSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMessageTemplatesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMessageTemplatesResult& WithRequestId(RequestIdT&& value) {
