...
class ListAIPromptVersionsRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  ListAIPromptVersionsRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiPromptIdT = Aws::String>
  ListAIPromptVersionsRequest& WithAiPromptId(AiPromptIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAIPromptVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAIPromptVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAIPromptVersionsRequest& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
