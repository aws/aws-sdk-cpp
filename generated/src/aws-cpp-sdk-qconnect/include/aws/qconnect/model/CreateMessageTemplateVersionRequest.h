...
class CreateMessageTemplateVersionRequest : public QConnectRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  CreateMessageTemplateVersionRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  CreateMessageTemplateVersionRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename MessageTemplateContentSha256T = Aws::String>
  CreateMessageTemplateVersionRequest& WithMessageTemplateContentSha256(MessageTemplateContentSha256T&& value) {
