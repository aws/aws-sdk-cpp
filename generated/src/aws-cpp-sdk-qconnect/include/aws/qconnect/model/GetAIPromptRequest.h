...
namespace Model
{
  ...
  {
  public:
    AWS_QCONNECT_API GetAIPromptRequest() = default;
    ...
    template<typename AssistantIdT = Aws::String>
    GetAIPromptRequest& WithAssistantId(AssistantIdT&& value) { SetAssistantId(std::forward<AssistantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AiPromptIdT = Aws::String>
    GetAIPromptRequest& WithAiPromptId(AiPromptIdT&& value) { SetAiPromptId(std::forward<AiPromptIdT>(value)); return *this;}
    ///@}
  private:
