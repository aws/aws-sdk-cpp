...
class AIPromptTemplateConfiguration {
 public:
   ...
   */
  inline const TextFullAIPromptEditTemplateConfiguration& GetTextFullAIPromptEditTemplateConfiguration() const {
    return m_textFullAIPromptEditTemplateConfiguration;
  }
  ...
  void SetTextFullAIPromptEditTemplateConfiguration(TextFullAIPromptEditTemplateConfigurationT&& value) {
    m_textFullAIPromptEditTemplateConfigurationHasBeenSet = true;
    m_textFullAIPromptEditTemplateConfiguration = std::forward<TextFullAIPromptEditTemplateConfigurationT>(value);
  }
  template <typename TextFullAIPromptEditTemplateConfigurationT = TextFullAIPromptEditTemplateConfiguration>
  AIPromptTemplateConfiguration& WithTextFullAIPromptEditTemplateConfiguration(TextFullAIPromptEditTemplateConfigurationT&& value) {
    SetTextFullAIPromptEditTemplateConfiguration(std::forward<TextFullAIPromptEditTemplateConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
