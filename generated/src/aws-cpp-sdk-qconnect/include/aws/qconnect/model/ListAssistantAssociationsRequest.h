...
class ListAssistantAssociationsRequest : public QConnectRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListAssistantAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAssistantAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename AssistantIdT = Aws::String>
  ListAssistantAssociationsRequest& WithAssistantId(AssistantIdT&& value) {
