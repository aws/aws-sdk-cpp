...
class MessageConfiguration {
 public:
  ...
  inline void SetGenerateFillerMessage(bool value) {
    m_generateFillerMessageHasBeenSet = true;
    m_generateFillerMessage = value;
  }
  inline MessageConfiguration& WithGenerateFillerMessage(bool value) {
    SetGenerateFillerMessage(value);
    return *this;
  }
  ///@}
