...
class ChunkingConfiguration {
 public:
  ...
  inline void SetChunkingStrategy(ChunkingStrategy value) {
    m_chunkingStrategyHasBeenSet = true;
    m_chunkingStrategy = value;
  }
  inline ChunkingConfiguration& WithChunkingStrategy(ChunkingStrategy value) {
  ...
  void SetFixedSizeChunkingConfiguration(FixedSizeChunkingConfigurationT&& value) {
    ...
    m_fixedSizeChunkingConfiguration = std::forward<FixedSizeChunkingConfigurationT>(value);
  }
  template <typename FixedSizeChunkingConfigurationT = FixedSizeChunkingConfiguration>
  ChunkingConfiguration& WithFixedSizeChunkingConfiguration(FixedSizeChunkingConfigurationT&& value) {
    SetFixedSizeChunkingConfiguration(std::forward<FixedSizeChunkingConfigurationT>(value));
    return *this;
  }
  ///@}
   ...
   * first layer.</p>
   */
  inline const HierarchicalChunkingConfiguration& GetHierarchicalChunkingConfiguration() const {
    return m_hierarchicalChunkingConfiguration;
  }
  ...
  void SetHierarchicalChunkingConfiguration(HierarchicalChunkingConfigurationT&& value) {
    ...
    m_hierarchicalChunkingConfiguration = std::forward<HierarchicalChunkingConfigurationT>(value);
  }
  template <typename HierarchicalChunkingConfigurationT = HierarchicalChunkingConfiguration>
  ChunkingConfiguration& WithHierarchicalChunkingConfiguration(HierarchicalChunkingConfigurationT&& value) {
    SetHierarchicalChunkingConfiguration(std::forward<HierarchicalChunkingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSemanticChunkingConfiguration(SemanticChunkingConfigurationT&& value) {
    ...
    m_semanticChunkingConfiguration = std::forward<SemanticChunkingConfigurationT>(value);
  }
  template <typename SemanticChunkingConfigurationT = SemanticChunkingConfiguration>
  ChunkingConfiguration& WithSemanticChunkingConfiguration(SemanticChunkingConfigurationT&& value) {
    SetSemanticChunkingConfiguration(std::forward<SemanticChunkingConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
