...
class CreateAIGuardrailVersionResult {
 public:
  ...
  void SetAiGuardrail(AiGuardrailT&& value) {
    m_aiGuardrailHasBeenSet = true;
    m_aiGuardrail = std::forward<AiGuardrailT>(value);
  }
  template <typename AiGuardrailT = AIGuardrailData>
  CreateAIGuardrailVersionResult& WithAiGuardrail(AiGuardrailT&& value) {
    SetAiGuardrail(std::forward<AiGuardrailT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateAIGuardrailVersionResult& WithVersionNumber(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAIGuardrailVersionResult& WithRequestId(RequestIdT&& value) {
