...
class ExtendedMessageTemplateData {
 public:
  ...
  inline ExtendedMessageTemplateData& WithChannelSubtype(ChannelSubtype value) {
  ...
  void SetAttributeTypes(AttributeTypesT&& value) {
    m_attributeTypesHasBeenSet = true;
    m_attributeTypes = std::forward<AttributeTypesT>(value);
  }
  template <typename AttributeTypesT = Aws::Vector<MessageTemplateAttributeType>>
  ExtendedMessageTemplateData& WithAttributeTypes(AttributeTypesT&& value) {
    SetAttributeTypes(std::forward<AttributeTypesT>(value));
    return *this;
  }
  inline ExtendedMessageTemplateData& AddAttributeTypes(MessageTemplateAttributeType value) {
    m_attributeTypesHasBeenSet = true;
    m_attributeTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ExtendedMessageTemplateData& WithIsActive(bool value) {
    SetIsActive(value);
    return *this;
  }
  ///@}
  ...
  inline ExtendedMessageTemplateData& WithVersionNumber(long long value) {
  ...
  void SetMessageTemplateContentSha256(MessageTemplateContentSha256T&& value) {
    ...
    m_messageTemplateContentSha256 = std::forward<MessageTemplateContentSha256T>(value);
  }
  template <typename MessageTemplateContentSha256T = Aws::String>
  ExtendedMessageTemplateData& WithMessageTemplateContentSha256(MessageTemplateContentSha256T&& value) {
    SetMessageTemplateContentSha256(std::forward<MessageTemplateContentSha256T>(value));
    return *this;
  }
  ///@}
