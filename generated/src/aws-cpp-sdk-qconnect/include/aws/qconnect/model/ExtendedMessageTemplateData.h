...
namespace Model
{
  ...
  public:
    ...
    template<typename AttachmentsT = Aws::Vector<MessageTemplateAttachment>>
    ExtendedMessageTemplateData& WithAttachments(AttachmentsT&& value) { SetAttachments(std::forward<AttachmentsT>(value)); return *this;}
    template<typename AttachmentsT = MessageTemplateAttachment>
    ExtendedMessageTemplateData& AddAttachments(AttachmentsT&& value) { m_attachmentsHasBeenSet = true; m_attachments.emplace_back(std::forward<AttachmentsT>(value)); return *this; }
    ///@}
    ...
    template<typename AttributeTypesT = Aws::Vector<MessageTemplateAttributeType>>
    ExtendedMessageTemplateData& WithAttributeTypes(AttributeTypesT&& value) { SetAttributeTypes(std::forward<AttributeTypesT>(value)); return *this;}
    inline ExtendedMessageTemplateData& AddAttributeTypes(MessageTemplateAttributeType value) { m_attributeTypesHasBeenSet = true; m_attributeTypes.push_back(value); return *this; }
    ///@}
    ...
    inline ExtendedMessageTemplateData& WithChannelSubtype(ChannelSubtype value) { SetChannelSubtype(value); return *this;}
    ///@}
    ...
    template<typename ContentT = MessageTemplateContentProvider>
    ExtendedMessageTemplateData& WithContent(ContentT&& value) { SetContent(std::forward<ContentT>(value)); return *this;}
    ///@}
    ...
    template<typename CreatedTimeT = Aws::Utils::DateTime>
    ExtendedMessageTemplateData& WithCreatedTime(CreatedTimeT&& value) { SetCreatedTime(std::forward<CreatedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename DefaultAttributesT = MessageTemplateAttributes>
    ExtendedMessageTemplateData& WithDefaultAttributes(DefaultAttributesT&& value) { SetDefaultAttributes(std::forward<DefaultAttributesT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    ExtendedMessageTemplateData& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupingConfigurationT = GroupingConfiguration>
    ExtendedMessageTemplateData& WithGroupingConfiguration(GroupingConfigurationT&& value) { SetGroupingConfiguration(std::forward<GroupingConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename KnowledgeBaseArnT = Aws::String>
    ExtendedMessageTemplateData& WithKnowledgeBaseArn(KnowledgeBaseArnT&& value) { SetKnowledgeBaseArn(std::forward<KnowledgeBaseArnT>(value)); return *this;}
    ///@}
    ...
    template<typename KnowledgeBaseIdT = Aws::String>
    ExtendedMessageTemplateData& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) { SetKnowledgeBaseId(std::forward<KnowledgeBaseIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LanguageT = Aws::String>
    ExtendedMessageTemplateData& WithLanguage(LanguageT&& value) { SetLanguage(std::forward<LanguageT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedByT = Aws::String>
    ExtendedMessageTemplateData& WithLastModifiedBy(LastModifiedByT&& value) { SetLastModifiedBy(std::forward<LastModifiedByT>(value)); return *this;}
    ///@}
    ...
    template<typename LastModifiedTimeT = Aws::Utils::DateTime>
    ExtendedMessageTemplateData& WithLastModifiedTime(LastModifiedTimeT&& value) { SetLastModifiedTime(std::forward<LastModifiedTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageTemplateArnT = Aws::String>
    ExtendedMessageTemplateData& WithMessageTemplateArn(MessageTemplateArnT&& value) { SetMessageTemplateArn(std::forward<MessageTemplateArnT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageTemplateContentSha256T = Aws::String>
    ExtendedMessageTemplateData& WithMessageTemplateContentSha256(MessageTemplateContentSha256T&& value) { SetMessageTemplateContentSha256(std::forward<MessageTemplateContentSha256T>(value)); return *this;}
    ///@}
    ...
    template<typename MessageTemplateIdT = Aws::String>
    ExtendedMessageTemplateData& WithMessageTemplateId(MessageTemplateIdT&& value) { SetMessageTemplateId(std::forward<MessageTemplateIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    ExtendedMessageTemplateData& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ExtendedMessageTemplateData& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
