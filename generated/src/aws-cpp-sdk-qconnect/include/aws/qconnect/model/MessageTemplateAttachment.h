...
class MessageTemplateAttachment {
 public:
  ...
  inline void SetContentDisposition(ContentDisposition value) {
    m_contentDispositionHasBeenSet = true;
    m_contentDisposition = value;
  }
  inline MessageTemplateAttachment& WithContentDisposition(ContentDisposition value) {
  ...
  void SetUploadedTime(UploadedTimeT&& value) {
    ...
    m_uploadedTime = std::forward<UploadedTimeT>(value);
  }
  template <typename UploadedTimeT = Aws::Utils::DateTime>
  MessageTemplateAttachment& WithUploadedTime(UploadedTimeT&& value) {
    SetUploadedTime(std::forward<UploadedTimeT>(value));
    return *this;
  }
  ///@}
