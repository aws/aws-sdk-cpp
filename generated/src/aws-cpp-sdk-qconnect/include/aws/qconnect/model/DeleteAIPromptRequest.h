...
class DeleteAIPromptRequest : public QConnectRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteAIPrompt"; }
  ...
  template <typename AssistantIdT = Aws::String>
  DeleteAIPromptRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiPromptIdT = Aws::String>
  DeleteAIPromptRequest& WithAiPromptId(AiPromptIdT&& value) {
