...
class ListAIGuardrailVersionsRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  ListAIGuardrailVersionsRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiGuardrailIdT = Aws::String>
  ListAIGuardrailVersionsRequest& WithAiGuardrailId(AiGuardrailIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAIGuardrailVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAIGuardrailVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
