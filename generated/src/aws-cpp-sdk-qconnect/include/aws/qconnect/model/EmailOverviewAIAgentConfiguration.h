...
namespace Model
{
  ...
  public:
    ...
    void SetEmailOverviewAIPromptId(EmailOverviewAIPromptIdT&& value) { m_emailOverviewAIPromptIdHasBeenSet = true; m_emailOverviewAIPromptId = std::forward<EmailOverviewAIPromptIdT>(value); }
    template<typename EmailOverviewAIPromptIdT = Aws::String>
    EmailOverviewAIAgentConfiguration& WithEmailOverviewAIPromptId(EmailOverviewAIPromptIdT&& value) { SetEmailOverviewAIPromptId(std::forward<EmailOverviewAIPromptIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocaleT = Aws::String>
    EmailOverviewAIAgentConfiguration& WithLocale(LocaleT&& value) { SetLocale(std::forward<LocaleT>(value)); return *this;}
    ///@}
  private:
