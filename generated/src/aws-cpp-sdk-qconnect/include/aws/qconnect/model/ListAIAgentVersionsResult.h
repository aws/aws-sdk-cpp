...
class ListAIAgentVersionsResult {
 public:
  ...
  void SetAiAgentVersionSummaries(AiAgentVersionSummariesT&& value) {
    m_aiAgentVersionSummariesHasBeenSet = true;
    m_aiAgentVersionSummaries = std::forward<AiAgentVersionSummariesT>(value);
  }
  template <typename AiAgentVersionSummariesT = Aws::Vector<AIAgentVersionSummary>>
  ListAIAgentVersionsResult& WithAiAgentVersionSummaries(AiAgentVersionSummariesT&& value) {
    SetAiAgentVersionSummaries(std::forward<AiAgentVersionSummariesT>(value));
    return *this;
  }
  template <typename AiAgentVersionSummariesT = AIAgentVersionSummary>
  ListAIAgentVersionsResult& AddAiAgentVersionSummaries(AiAgentVersionSummariesT&& value) {
    m_aiAgentVersionSummariesHasBeenSet = true;
    m_aiAgentVersionSummaries.emplace_back(std::forward<AiAgentVersionSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAIAgentVersionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAIAgentVersionsResult& WithRequestId(RequestIdT&& value) {
