...
class CreateAIPromptVersionResult {
 public:
  ...
  template <typename AiPromptT = AIPromptData>
  CreateAIPromptVersionResult& WithAiPrompt(AiPromptT&& value) {
  ...
  inline CreateAIPromptVersionResult& WithVersionNumber(long long value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateAIPromptVersionResult& WithRequestId(RequestIdT&& value) {
