...
class SemanticChunkingConfiguration {
 public:
  ...
  inline SemanticChunkingConfiguration& WithMaxTokens(int value) {
    SetMaxTokens(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBufferSize(int value) {
    m_bufferSizeHasBeenSet = true;
    m_bufferSize = value;
  }
  inline SemanticChunkingConfiguration& WithBufferSize(int value) {
    SetBufferSize(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBreakpointPercentileThreshold(int value) {
    m_breakpointPercentileThresholdHasBeenSet = true;
    m_breakpointPercentileThreshold = value;
  }
  inline SemanticChunkingConfiguration& WithBreakpointPercentileThreshold(int value) {
    SetBreakpointPercentileThreshold(value);
    return *this;
  }
  ///@}
 private:
