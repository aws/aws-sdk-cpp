...
class DeleteAIGuardrailVersionRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  DeleteAIGuardrailVersionRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiGuardrailIdT = Aws::String>
  DeleteAIGuardrailVersionRequest& WithAiGuardrailId(AiGuardrailIdT&& value) {
  ...
  inline DeleteAIGuardrailVersionRequest& WithVersionNumber(long long value) {
