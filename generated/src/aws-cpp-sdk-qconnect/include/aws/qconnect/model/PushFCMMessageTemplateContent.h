...
/**
 * <p>The content of the push message template that applies to FCM (Firebase Cloud
 * Messaging) notification service.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/qconnect-2020-10-19/PushFCMMessageTemplateContent">AWS
 * API Reference</a></p>
 */
class PushFCMMessageTemplateContent {
 public:
  AWS_QCONNECT_API PushFCMMessageTemplateContent() = default;
  AWS_QCONNECT_API PushFCMMessageTemplateContent(Aws::Utils::Json::JsonView jsonValue);
  AWS_QCONNECT_API PushFCMMessageTemplateContent& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename TitleT = Aws::String>
  PushFCMMessageTemplateContent& WithTitle(TitleT&& value) {
  ...
  template <typename BodyT = MessageTemplateBodyContentProvider>
  PushFCMMessageTemplateContent& WithBody(BodyT&& value) {
  ...
  inline PushFCMMessageTemplateContent& WithAction(PushMessageAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  template <typename SoundT = Aws::String>
  PushFCMMessageTemplateContent& WithSound(SoundT&& value) {
  ...
  template <typename UrlT = Aws::String>
  PushFCMMessageTemplateContent& WithUrl(UrlT&& value) {
  ...
  template <typename ImageUrlT = Aws::String>
  PushFCMMessageTemplateContent& WithImageUrl(ImageUrlT&& value) {
  ...
  template <typename ImageIconUrlT = Aws::String>
  PushFCMMessageTemplateContent& WithImageIconUrl(ImageIconUrlT&& value) {
  ...
  template <typename SmallImageIconUrlT = Aws::String>
  PushFCMMessageTemplateContent& WithSmallImageIconUrl(SmallImageIconUrlT&& value) {
  ...
  template <typename RawContentT = MessageTemplateBodyContentProvider>
  PushFCMMessageTemplateContent& WithRawContent(RawContentT&& value) {
