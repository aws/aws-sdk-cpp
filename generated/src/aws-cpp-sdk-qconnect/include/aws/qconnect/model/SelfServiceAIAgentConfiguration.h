...
class SelfServiceAIAgentConfiguration {
 public:
  ...
  void SetSelfServicePreProcessingAIPromptId(SelfServicePreProcessingAIPromptIdT&& value) {
    m_selfServicePreProcessingAIPromptIdHasBeenSet = true;
    m_selfServicePreProcessingAIPromptId = std::forward<SelfServicePreProcessingAIPromptIdT>(value);
  }
  template <typename SelfServicePreProcessingAIPromptIdT = Aws::String>
  SelfServiceAIAgentConfiguration& WithSelfServicePreProcessingAIPromptId(SelfServicePreProcessingAIPromptIdT&& value) {
    SetSelfServicePreProcessingAIPromptId(std::forward<SelfServicePreProcessingAIPromptIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfServiceAnswerGenerationAIPromptId(SelfServiceAnswerGenerationAIPromptIdT&& value) {
    m_selfServiceAnswerGenerationAIPromptIdHasBeenSet = true;
    m_selfServiceAnswerGenerationAIPromptId = std::forward<SelfServiceAnswerGenerationAIPromptIdT>(value);
  }
  template <typename SelfServiceAnswerGenerationAIPromptIdT = Aws::String>
  SelfServiceAIAgentConfiguration& WithSelfServiceAnswerGenerationAIPromptId(SelfServiceAnswerGenerationAIPromptIdT&& value) {
    SetSelfServiceAnswerGenerationAIPromptId(std::forward<SelfServiceAnswerGenerationAIPromptIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSelfServiceAIGuardrailId(SelfServiceAIGuardrailIdT&& value) {
    m_selfServiceAIGuardrailIdHasBeenSet = true;
    m_selfServiceAIGuardrailId = std::forward<SelfServiceAIGuardrailIdT>(value);
  }
  template <typename SelfServiceAIGuardrailIdT = Aws::String>
  SelfServiceAIAgentConfiguration& WithSelfServiceAIGuardrailId(SelfServiceAIGuardrailIdT&& value) {
    SetSelfServiceAIGuardrailId(std::forward<SelfServiceAIGuardrailIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename AssociationConfigurationsT = Aws::Vector<AssociationConfiguration>>
  SelfServiceAIAgentConfiguration& WithAssociationConfigurations(AssociationConfigurationsT&& value) {
  ...
  SelfServiceAIAgentConfiguration& AddAssociationConfigurations(AssociationConfigurationsT&& value) {
    m_associationConfigurationsHasBeenSet = true;
