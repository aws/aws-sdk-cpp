...
class MessageTemplateQueryField {
 public:
  ...
  inline void SetOperator(MessageTemplateQueryOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline MessageTemplateQueryField& WithOperator(MessageTemplateQueryOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline MessageTemplateQueryField& WithAllowFuzziness(bool value) {
  ...
  inline MessageTemplateQueryField& WithPriority(Priority value) {
    SetPriority(value);
    return *this;
  }
  ///@}
