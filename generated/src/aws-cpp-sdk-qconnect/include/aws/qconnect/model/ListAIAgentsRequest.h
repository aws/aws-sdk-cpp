...
class ListAIAgentsRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  ListAIAgentsRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAIAgentsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAIAgentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAIAgentsRequest& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
