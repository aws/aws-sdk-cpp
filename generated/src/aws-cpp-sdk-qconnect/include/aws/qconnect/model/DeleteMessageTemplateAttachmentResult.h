...
namespace Model
{
  ...
  {
  public:
    AWS_QCONNECT_API DeleteMessageTemplateAttachmentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteMessageTemplateAttachmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
