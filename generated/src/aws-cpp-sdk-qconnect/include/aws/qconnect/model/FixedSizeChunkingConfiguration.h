 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/qconnect-2020-10-19/FixedSizeChunkingConfiguration">AWS
 * API Reference</a></p>
 */
class FixedSizeChunkingConfiguration {
 public:
  AWS_QCONNECT_API FixedSizeChunkingConfiguration() = default;
  ...
  inline FixedSizeChunkingConfiguration& WithMaxTokens(int value) {
    SetMaxTokens(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOverlapPercentage(int value) {
    m_overlapPercentageHasBeenSet = true;
    m_overlapPercentage = value;
  }
  inline FixedSizeChunkingConfiguration& WithOverlapPercentage(int value) {
    SetOverlapPercentage(value);
    return *this;
  }
  ///@}
 private:
