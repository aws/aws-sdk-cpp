...
/**
 * <p>The content of the push message template that applies to Baidu notification
 * service.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/qconnect-2020-10-19/PushBaiduMessageTemplateContent">AWS
 * API Reference</a></p>
 */
class PushBaiduMessageTemplateContent {
 public:
  ...
  inline PushBaiduMessageTemplateContent& WithAction(PushMessageAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
