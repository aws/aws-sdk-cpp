...
namespace Model
{
  ...
  public:
    ...
    template<typename CompletionT = Aws::String>
    EmailOverviewChunkDataDetails& WithCompletion(CompletionT&& value) { SetCompletion(std::forward<CompletionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextChunkTokenT = Aws::String>
    EmailOverviewChunkDataDetails& WithNextChunkToken(NextChunkTokenT&& value) { SetNextChunkToken(std::forward<NextChunkTokenT>(value)); return *this;}
    ///@}
  private:
