...
namespace Model
{
  ...
  public:
    ...
    template<typename AssistantIdT = Aws::String>
    AssistantData& WithAssistantId(AssistantIdT&& value) { SetAssistantId(std::forward<AssistantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AssistantArnT = Aws::String>
    AssistantData& WithAssistantArn(AssistantArnT&& value) { SetAssistantArn(std::forward<AssistantArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    AssistantData& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline AssistantData& WithType(AssistantType value) { SetType(value); return *this;}
    ///@}
    ...
    inline AssistantData& WithStatus(AssistantStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    AssistantData& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    AssistantData& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename ServerSideEncryptionConfigurationT = ServerSideEncryptionConfiguration>
    AssistantData& WithServerSideEncryptionConfiguration(ServerSideEncryptionConfigurationT&& value) { SetServerSideEncryptionConfiguration(std::forward<ServerSideEncryptionConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename IntegrationConfigurationT = AssistantIntegrationConfiguration>
    AssistantData& WithIntegrationConfiguration(IntegrationConfigurationT&& value) { SetIntegrationConfiguration(std::forward<IntegrationConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename CapabilityConfigurationT = AssistantCapabilityConfiguration>
    AssistantData& WithCapabilityConfiguration(CapabilityConfigurationT&& value) { SetCapabilityConfiguration(std::forward<CapabilityConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename AiAgentConfigurationT = Aws::Map<AIAgentType, AIAgentConfigurationData>>
    AssistantData& WithAiAgentConfiguration(AiAgentConfigurationT&& value) { SetAiAgentConfiguration(std::forward<AiAgentConfigurationT>(value)); return *this;}
    inline AssistantData& AddAiAgentConfiguration(AIAgentType key, AIAgentConfigurationData value) {
