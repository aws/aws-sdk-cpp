...
class MessageTemplateFilterField {
 public:
  ...
  template <typename NameT = Aws::String>
  MessageTemplateFilterField& WithName(NameT&& value) {
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  MessageTemplateFilterField& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  MessageTemplateFilterField& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(MessageTemplateFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline MessageTemplateFilterField& WithOperator(MessageTemplateFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeNoExistence(bool value) {
    m_includeNoExistenceHasBeenSet = true;
    m_includeNoExistence = value;
  }
  inline MessageTemplateFilterField& WithIncludeNoExistence(bool value) {
    SetIncludeNoExistence(value);
    return *this;
  }
  ///@}
 private:
