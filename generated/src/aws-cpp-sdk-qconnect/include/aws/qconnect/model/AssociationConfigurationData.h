...
class AssociationConfigurationData {
 public:
   ...
   */
  inline const KnowledgeBaseAssociationConfigurationData& GetKnowledgeBaseAssociationConfigurationData() const {
    return m_knowledgeBaseAssociationConfigurationData;
  }
  ...
  void SetKnowledgeBaseAssociationConfigurationData(KnowledgeBaseAssociationConfigurationDataT&& value) {
    m_knowledgeBaseAssociationConfigurationDataHasBeenSet = true;
    m_knowledgeBaseAssociationConfigurationData = std::forward<KnowledgeBaseAssociationConfigurationDataT>(value);
  }
  template <typename KnowledgeBaseAssociationConfigurationDataT = KnowledgeBaseAssociationConfigurationData>
  AssociationConfigurationData& WithKnowledgeBaseAssociationConfigurationData(KnowledgeBaseAssociationConfigurationDataT&& value) {
    SetKnowledgeBaseAssociationConfigurationData(std::forward<KnowledgeBaseAssociationConfigurationDataT>(value));
    return *this;
  }
  ///@}
 private:
