...
class SourceConfiguration {
 public:
  ...
  void SetAppIntegrations(AppIntegrationsT&& value) {
    ...
    m_appIntegrations = std::forward<AppIntegrationsT>(value);
  }
  template <typename AppIntegrationsT = AppIntegrationsConfiguration>
  SourceConfiguration& WithAppIntegrations(AppIntegrationsT&& value) {
    SetAppIntegrations(std::forward<AppIntegrationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedSourceConfiguration(ManagedSourceConfigurationT&& value) {
    ...
    m_managedSourceConfiguration = std::forward<ManagedSourceConfigurationT>(value);
  }
  template <typename ManagedSourceConfigurationT = ManagedSourceConfiguration>
  SourceConfiguration& WithManagedSourceConfiguration(ManagedSourceConfigurationT&& value) {
    SetManagedSourceConfiguration(std::forward<ManagedSourceConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
