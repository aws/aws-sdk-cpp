...
class ListAIAgentVersionsRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  ListAIAgentVersionsRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiAgentIdT = Aws::String>
  ListAIAgentVersionsRequest& WithAiAgentId(AiAgentIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAIAgentVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAIAgentVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAIAgentVersionsRequest& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
