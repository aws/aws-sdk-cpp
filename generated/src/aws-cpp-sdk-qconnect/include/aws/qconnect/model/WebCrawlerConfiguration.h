...
class WebCrawlerConfiguration {
 public:
  ...
  void SetUrlConfiguration(UrlConfigurationT&& value) {
    ...
    m_urlConfiguration = std::forward<UrlConfigurationT>(value);
  }
  template <typename UrlConfigurationT = UrlConfiguration>
  WebCrawlerConfiguration& WithUrlConfiguration(UrlConfigurationT&& value) {
    SetUrlConfiguration(std::forward<UrlConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCrawlerLimits(CrawlerLimitsT&& value) {
    m_crawlerLimitsHasBeenSet = true;
    m_crawlerLimits = std::forward<CrawlerLimitsT>(value);
  }
  template <typename CrawlerLimitsT = WebCrawlerLimits>
  WebCrawlerConfiguration& WithCrawlerLimits(CrawlerLimitsT&& value) {
    SetCrawlerLimits(std::forward<CrawlerLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetScope(WebScopeType value) {
    m_scopeHasBeenSet = true;
    m_scope = value;
  }
  inline WebCrawlerConfiguration& WithScope(WebScopeType value) {
    SetScope(value);
    return *this;
  }
  ///@}
