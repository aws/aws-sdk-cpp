...
class AIPromptSummary {
 public:
  ...
  template <typename NameT = Aws::String>
  AIPromptSummary& WithName(NameT&& value) {
  ...
  template <typename AssistantIdT = Aws::String>
  AIPromptSummary& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AssistantArnT = Aws::String>
  AIPromptSummary& WithAssistantArn(AssistantArnT&& value) {
  ...
  template <typename AiPromptIdT = Aws::String>
  AIPromptSummary& WithAiPromptId(AiPromptIdT&& value) {
  ...
  inline void SetType(AIPromptType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline AIPromptSummary& WithType(AIPromptType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  void SetAiPromptArn(AiPromptArnT&& value) {
    ...
    m_aiPromptArn = std::forward<AiPromptArnT>(value);
  }
  template <typename AiPromptArnT = Aws::String>
  AIPromptSummary& WithAiPromptArn(AiPromptArnT&& value) {
    SetAiPromptArn(std::forward<AiPromptArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModifiedTime(ModifiedTimeT&& value) {
    ...
    m_modifiedTime = std::forward<ModifiedTimeT>(value);
  }
  template <typename ModifiedTimeT = Aws::Utils::DateTime>
  AIPromptSummary& WithModifiedTime(ModifiedTimeT&& value) {
    SetModifiedTime(std::forward<ModifiedTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTemplateType(AIPromptTemplateType value) {
    m_templateTypeHasBeenSet = true;
    m_templateType = value;
  }
  inline AIPromptSummary& WithTemplateType(AIPromptTemplateType value) {
  ...
  template <typename ModelIdT = Aws::String>
  AIPromptSummary& WithModelId(ModelIdT&& value) {
  ...
  inline void SetApiFormat(AIPromptAPIFormat value) {
    m_apiFormatHasBeenSet = true;
    m_apiFormat = value;
  }
  inline AIPromptSummary& WithApiFormat(AIPromptAPIFormat value) {
    SetApiFormat(value);
    return *this;
  }
  ///@}
  ...
  inline AIPromptSummary& WithVisibilityStatus(VisibilityStatus value) {
  ...
  inline AIPromptSummary& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  AIPromptSummary& WithDescription(DescriptionT&& value) {
  ...
  inline AIPromptSummary& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  AIPromptSummary& WithTags(TagsT&& value) {
