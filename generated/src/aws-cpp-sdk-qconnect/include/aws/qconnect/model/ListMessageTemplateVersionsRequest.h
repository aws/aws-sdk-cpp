...
class ListMessageTemplateVersionsRequest : public QConnectRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListMessageTemplateVersionsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  ListMessageTemplateVersionsRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMessageTemplateVersionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMessageTemplateVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
