...
class CreateAIPromptVersionRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  CreateAIPromptVersionRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename AiPromptIdT = Aws::String>
  CreateAIPromptVersionRequest& WithAiPromptId(AiPromptIdT&& value) {
  ...
  template <typename ModifiedTimeT = Aws::Utils::DateTime>
  CreateAIPromptVersionRequest& WithModifiedTime(ModifiedTimeT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateAIPromptVersionRequest& WithClientToken(ClientTokenT&& value) {
