...
class DeleteMessageTemplateAttachmentRequest : public QConnectRequest {
 public:
  AWS_QCONNECT_API DeleteMessageTemplateAttachmentRequest() = default;
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  DeleteMessageTemplateAttachmentRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  DeleteMessageTemplateAttachmentRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename AttachmentIdT = Aws::String>
  DeleteMessageTemplateAttachmentRequest& WithAttachmentId(AttachmentIdT&& value) {
