...
namespace Model
{
  ...
  public:
    ...
    template<typename AssistantIdT = Aws::String>
    ListMessagesRequest& WithAssistantId(AssistantIdT&& value) { SetAssistantId(std::forward<AssistantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename SessionIdT = Aws::String>
    ListMessagesRequest& WithSessionId(SessionIdT&& value) { SetSessionId(std::forward<SessionIdT>(value)); return *this;}
    ///@}
  private:
