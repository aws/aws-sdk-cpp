...
/**
 */
class DeleteAssistantRequest : public QConnectRequest {
 public:
  AWS_QCONNECT_API DeleteAssistantRequest() = default;
  ...
  template <typename AssistantIdT = Aws::String>
  DeleteAssistantRequest& WithAssistantId(AssistantIdT&& value) {
