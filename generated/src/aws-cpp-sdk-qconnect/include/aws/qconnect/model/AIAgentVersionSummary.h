...
class AIAgentVersionSummary {
 public:
  ...
  void SetAiAgentSummary(AiAgentSummaryT&& value) {
    ...
    m_aiAgentSummary = std::forward<AiAgentSummaryT>(value);
  }
  template <typename AiAgentSummaryT = AIAgentSummary>
  AIAgentVersionSummary& WithAiAgentSummary(AiAgentSummaryT&& value) {
    SetAiAgentSummary(std::forward<AiAgentSummaryT>(value));
    return *this;
  }
  ///@}
  ...
  inline AIAgentVersionSummary& WithVersionNumber(long long value) {
