...
namespace Model
{
  ...
  public:
    ...
    inline void SetAiAgentSummary(const AIAgentSummary& value) { m_aiAgentSummaryHasBeenSet = true; m_aiAgentSummary = value; }
    inline void SetAiAgentSummary(AIAgentSummary&& value) { m_aiAgentSummaryHasBeenSet = true; m_aiAgentSummary = std::move(value); }
    inline AIAgentVersionSummary& WithAiAgentSummary(const AIAgentSummary& value) { SetAiAgentSummary(value); return *this;}
    inline AIAgentVersionSummary& WithAiAgentSummary(AIAgentSummary&& value) { SetAiAgentSummary(std::move(value)); return *this;}
    ///@}
