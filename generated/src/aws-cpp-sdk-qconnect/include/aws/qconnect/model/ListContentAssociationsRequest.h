...
class ListContentAssociationsRequest : public QConnectRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListContentAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListContentAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  ListContentAssociationsRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename ContentIdT = Aws::String>
  ListContentAssociationsRequest& WithContentId(ContentIdT&& value) {
