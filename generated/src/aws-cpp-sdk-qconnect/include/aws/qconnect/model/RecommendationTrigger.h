...
class RecommendationTrigger {
 public:
  ...
  inline void SetType(RecommendationTriggerType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RecommendationTrigger& WithType(RecommendationTriggerType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSource(RecommendationSourceType value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline RecommendationTrigger& WithSource(RecommendationSourceType value) {
    SetSource(value);
    return *this;
  }
  ///@}
