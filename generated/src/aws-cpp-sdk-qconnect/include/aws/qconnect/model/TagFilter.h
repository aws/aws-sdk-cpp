...
class TagFilter {
 public:
  ...
  template <typename TagConditionT = TagCondition>
  TagFilter& WithTagCondition(TagConditionT&& value) {
  ...
  template <typename AndConditionsT = Aws::Vector<TagCondition>>
  TagFilter& WithAndConditions(AndConditionsT&& value) {
    SetAndConditions(std::forward<AndConditionsT>(value));
    return *this;
  }
  template <typename AndConditionsT = TagCondition>
  TagFilter& AddAndConditions(AndConditionsT&& value) {
    m_andConditionsHasBeenSet = true;
  ...
  template <typename OrConditionsT = Aws::Vector<OrCondition>>
  TagFilter& WithOrConditions(OrConditionsT&& value) {
    SetOrConditions(std::forward<OrConditionsT>(value));
    return *this;
  }
  template <typename OrConditionsT = OrCondition>
  TagFilter& AddOrConditions(OrConditionsT&& value) {
    m_orConditionsHasBeenSet = true;
