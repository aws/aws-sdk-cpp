...
namespace Model
{
  ...
  public:
    ...
    template<typename FirstNameT = Aws::String>
    AgentAttributes& WithFirstName(FirstNameT&& value) { SetFirstName(std::forward<FirstNameT>(value)); return *this;}
    ///@}
    ...
    template<typename LastNameT = Aws::String>
    AgentAttributes& WithLastName(LastNameT&& value) { SetLastName(std::forward<LastNameT>(value)); return *this;}
    ///@}
  private:
