...
class ListAIPromptsRequest : public QConnectRequest {
 public:
  ...
  template <typename AssistantIdT = Aws::String>
  ListAIPromptsRequest& WithAssistantId(AssistantIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListAIPromptsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListAIPromptsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListAIPromptsRequest& WithOrigin(Origin value) {
    SetOrigin(value);
    return *this;
  }
  ///@}
