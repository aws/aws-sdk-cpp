...
namespace Model
{
  ...
  {
  public:
    AWS_QCONNECT_API ListAIPromptsRequest() = default;
    ...
    template<typename AssistantIdT = Aws::String>
    ListAIPromptsRequest& WithAssistantId(AssistantIdT&& value) { SetAssistantId(std::forward<AssistantIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListAIPromptsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline ListAIPromptsRequest& WithOrigin(Origin value) { SetOrigin(value); return *this;}
    ///@}
  private:
