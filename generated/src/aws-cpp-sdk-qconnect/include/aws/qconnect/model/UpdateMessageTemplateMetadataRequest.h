...
class UpdateMessageTemplateMetadataRequest : public QConnectRequest {
 public:
  ...
  template <typename KnowledgeBaseIdT = Aws::String>
  UpdateMessageTemplateMetadataRequest& WithKnowledgeBaseId(KnowledgeBaseIdT&& value) {
  ...
  template <typename MessageTemplateIdT = Aws::String>
  UpdateMessageTemplateMetadataRequest& WithMessageTemplateId(MessageTemplateIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  UpdateMessageTemplateMetadataRequest& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateMessageTemplateMetadataRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename GroupingConfigurationT = GroupingConfiguration>
  UpdateMessageTemplateMetadataRequest& WithGroupingConfiguration(GroupingConfigurationT&& value) {
