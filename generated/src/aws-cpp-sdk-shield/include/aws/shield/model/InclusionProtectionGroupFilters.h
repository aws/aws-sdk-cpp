...
class InclusionProtectionGroupFilters {
 public:
  ...
  void SetProtectionGroupIds(ProtectionGroupIdsT&& value) {
    m_protectionGroupIdsHasBeenSet = true;
    m_protectionGroupIds = std::forward<ProtectionGroupIdsT>(value);
  }
  template <typename ProtectionGroupIdsT = Aws::Vector<Aws::String>>
  InclusionProtectionGroupFilters& WithProtectionGroupIds(ProtectionGroupIdsT&& value) {
    SetProtectionGroupIds(std::forward<ProtectionGroupIdsT>(value));
    return *this;
  }
  template <typename ProtectionGroupIdsT = Aws::String>
  InclusionProtectionGroupFilters& AddProtectionGroupIds(ProtectionGroupIdsT&& value) {
    m_protectionGroupIdsHasBeenSet = true;
    m_protectionGroupIds.emplace_back(std::forward<ProtectionGroupIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename PatternsT = Aws::Vector<ProtectionGroupPattern>>
  InclusionProtectionGroupFilters& WithPatterns(PatternsT&& value) {
    SetPatterns(std::forward<PatternsT>(value));
    return *this;
  }
  inline InclusionProtectionGroupFilters& AddPatterns(ProtectionGroupPattern value) {
    m_patternsHasBeenSet = true;
    m_patterns.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypesT = Aws::Vector<ProtectedResourceType>>
  InclusionProtectionGroupFilters& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline InclusionProtectionGroupFilters& AddResourceTypes(ProtectedResourceType value) {
    m_resourceTypesHasBeenSet = true;
  ...
  template <typename AggregationsT = Aws::Vector<ProtectionGroupAggregation>>
  InclusionProtectionGroupFilters& WithAggregations(AggregationsT&& value) {
    SetAggregations(std::forward<AggregationsT>(value));
    return *this;
  }
  inline InclusionProtectionGroupFilters& AddAggregations(ProtectionGroupAggregation value) {
    m_aggregationsHasBeenSet = true;
    m_aggregations.push_back(value);
    return *this;
  }
  ///@}
 private:
