...
class DescribeDRTAccessResult {
 public:
  ...
  void SetLogBucketList(LogBucketListT&& value) {
    m_logBucketListHasBeenSet = true;
    m_logBucketList = std::forward<LogBucketListT>(value);
  }
  template <typename LogBucketListT = Aws::Vector<Aws::String>>
  DescribeDRTAccessResult& WithLogBucketList(LogBucketListT&& value) {
    SetLogBucketList(std::forward<LogBucketListT>(value));
    return *this;
  }
  template <typename LogBucketListT = Aws::String>
  DescribeDRTAccessResult& AddLogBucketList(LogBucketListT&& value) {
    m_logBucketListHasBeenSet = true;
    m_logBucketList.emplace_back(std::forward<LogBucketListT>(value));
    return *this;
  }
  ///@}
