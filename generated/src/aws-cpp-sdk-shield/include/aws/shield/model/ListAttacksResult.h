...
class ListAttacksResult {
 public:
  ...
  void SetAttackSummaries(AttackSummariesT&& value) {
    m_attackSummariesHasBeenSet = true;
    m_attackSummaries = std::forward<AttackSummariesT>(value);
  }
  template <typename AttackSummariesT = Aws::Vector<AttackSummary>>
  ListAttacksResult& WithAttackSummaries(AttackSummariesT&& value) {
    SetAttackSummaries(std::forward<AttackSummariesT>(value));
    return *this;
  }
  template <typename AttackSummariesT = AttackSummary>
  ListAttacksResult& AddAttackSummaries(AttackSummariesT&& value) {
    m_attackSummariesHasBeenSet = true;
    m_attackSummaries.emplace_back(std::forward<AttackSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListAttacksResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAttacksResult& WithRequestId(RequestIdT&& value) {
