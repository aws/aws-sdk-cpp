...
namespace Model
{
  ...
  public:
    ...
    template<typename ProtectionIdT = Aws::String>
    AssociateHealthCheckRequest& WithProtectionId(ProtectionIdT&& value) { SetProtectionId(std::forward<ProtectionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename HealthCheckArnT = Aws::String>
    AssociateHealthCheckRequest& WithHealthCheckArn(HealthCheckArnT&& value) { SetHealthCheckArn(std::forward<HealthCheckArnT>(value)); return *this;}
    ///@}
  private:
