...
class ListProtectionGroupsRequest : public ShieldRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListProtectionGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListProtectionGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename InclusionFiltersT = InclusionProtectionGroupFilters>
  ListProtectionGroupsRequest& WithInclusionFilters(InclusionFiltersT&& value) {
