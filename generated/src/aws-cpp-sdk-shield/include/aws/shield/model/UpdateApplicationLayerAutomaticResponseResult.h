...
namespace Model
{
  ...
  public:
    ...
    inline UpdateApplicationLayerAutomaticResponseResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateApplicationLayerAutomaticResponseResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateApplicationLayerAutomaticResponseResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
