...
class SubscriptionLimits {
 public:
  ...
  void SetProtectionLimits(ProtectionLimitsT&& value) {
    ...
    m_protectionLimits = std::forward<ProtectionLimitsT>(value);
  }
  template <typename ProtectionLimitsT = ProtectionLimits>
  SubscriptionLimits& WithProtectionLimits(ProtectionLimitsT&& value) {
    SetProtectionLimits(std::forward<ProtectionLimitsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProtectionGroupLimits(ProtectionGroupLimitsT&& value) {
    ...
    m_protectionGroupLimits = std::forward<ProtectionGroupLimitsT>(value);
  }
  template <typename ProtectionGroupLimitsT = ProtectionGroupLimits>
  SubscriptionLimits& WithProtectionGroupLimits(ProtectionGroupLimitsT&& value) {
    SetProtectionGroupLimits(std::forward<ProtectionGroupLimitsT>(value));
    return *this;
  }
  ///@}
 private:
