...
class ProtectionGroupLimits {
 public:
  ...
  inline void SetMaxProtectionGroups(long long value) {
    m_maxProtectionGroupsHasBeenSet = true;
    m_maxProtectionGroups = value;
  }
  inline ProtectionGroupLimits& WithMaxProtectionGroups(long long value) {
    SetMaxProtectionGroups(value);
    return *this;
  }
  ///@}
  ...
  void SetPatternTypeLimits(PatternTypeLimitsT&& value) {
    ...
    m_patternTypeLimits = std::forward<PatternTypeLimitsT>(value);
  }
  template <typename PatternTypeLimitsT = ProtectionGroupPatternTypeLimits>
  ProtectionGroupLimits& WithPatternTypeLimits(PatternTypeLimitsT&& value) {
    SetPatternTypeLimits(std::forward<PatternTypeLimitsT>(value));
    return *this;
  }
  ///@}
 private:
