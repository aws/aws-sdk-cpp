...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API DisableProactiveEngagementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisableProactiveEngagementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
