...
class Protection {
 public:
  ...
  void SetHealthCheckIds(HealthCheckIdsT&& value) {
    ...
    m_healthCheckIds = std::forward<HealthCheckIdsT>(value);
  }
  template <typename HealthCheckIdsT = Aws::Vector<Aws::String>>
  Protection& WithHealthCheckIds(HealthCheckIdsT&& value) {
    SetHealthCheckIds(std::forward<HealthCheckIdsT>(value));
    return *this;
  }
  template <typename HealthCheckIdsT = Aws::String>
  Protection& AddHealthCheckIds(HealthCheckIdsT&& value) {
    m_healthCheckIdsHasBeenSet = true;
    m_healthCheckIds.emplace_back(std::forward<HealthCheckIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProtectionArn(ProtectionArnT&& value) {
    ...
    m_protectionArn = std::forward<ProtectionArnT>(value);
  }
  template <typename ProtectionArnT = Aws::String>
  Protection& WithProtectionArn(ProtectionArnT&& value) {
    SetProtectionArn(std::forward<ProtectionArnT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ApplicationLayerAutomaticResponseConfiguration& GetApplicationLayerAutomaticResponseConfiguration() const {
    return m_applicationLayerAutomaticResponseConfiguration;
  }
  inline bool ApplicationLayerAutomaticResponseConfigurationHasBeenSet() const {
    return m_applicationLayerAutomaticResponseConfigurationHasBeenSet;
  }
  ...
  void SetApplicationLayerAutomaticResponseConfiguration(ApplicationLayerAutomaticResponseConfigurationT&& value) {
    ...
    m_applicationLayerAutomaticResponseConfiguration = std::forward<ApplicationLayerAutomaticResponseConfigurationT>(value);
  }
  template <typename ApplicationLayerAutomaticResponseConfigurationT = ApplicationLayerAutomaticResponseConfiguration>
  Protection& WithApplicationLayerAutomaticResponseConfiguration(ApplicationLayerAutomaticResponseConfigurationT&& value) {
    SetApplicationLayerAutomaticResponseConfiguration(std::forward<ApplicationLayerAutomaticResponseConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
