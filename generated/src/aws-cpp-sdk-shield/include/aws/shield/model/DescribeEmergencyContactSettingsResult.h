...
class DescribeEmergencyContactSettingsResult {
 public:
  ...
  template <typename EmergencyContactListT = Aws::Vector<EmergencyContact>>
  DescribeEmergencyContactSettingsResult& WithEmergencyContactList(EmergencyContactListT&& value) {
    SetEmergencyContactList(std::forward<EmergencyContactListT>(value));
    return *this;
  }
  template <typename EmergencyContactListT = EmergencyContact>
  DescribeEmergencyContactSettingsResult& AddEmergencyContactList(EmergencyContactListT&& value) {
    m_emergencyContactListHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeEmergencyContactSettingsResult& WithRequestId(RequestIdT&& value) {
