...
class AttackDetail {
 public:
  ...
  void SetAttackId(AttackIdT&& value) {
    ...
    m_attackId = std::forward<AttackIdT>(value);
  }
  template <typename AttackIdT = Aws::String>
  AttackDetail& WithAttackId(AttackIdT&& value) {
    SetAttackId(std::forward<AttackIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubResources(SubResourcesT&& value) {
    ...
    m_subResources = std::forward<SubResourcesT>(value);
  }
  template <typename SubResourcesT = Aws::Vector<SubResourceSummary>>
  AttackDetail& WithSubResources(SubResourcesT&& value) {
    SetSubResources(std::forward<SubResourcesT>(value));
    return *this;
  }
  template <typename SubResourcesT = SubResourceSummary>
  AttackDetail& AddSubResources(SubResourcesT&& value) {
    m_subResourcesHasBeenSet = true;
    m_subResources.emplace_back(std::forward<SubResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttackCounters(AttackCountersT&& value) {
    ...
    m_attackCounters = std::forward<AttackCountersT>(value);
  }
  template <typename AttackCountersT = Aws::Vector<SummarizedCounter>>
  AttackDetail& WithAttackCounters(AttackCountersT&& value) {
    SetAttackCounters(std::forward<AttackCountersT>(value));
    return *this;
  }
  template <typename AttackCountersT = SummarizedCounter>
  AttackDetail& AddAttackCounters(AttackCountersT&& value) {
    m_attackCountersHasBeenSet = true;
    m_attackCounters.emplace_back(std::forward<AttackCountersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAttackProperties(AttackPropertiesT&& value) {
    ...
    m_attackProperties = std::forward<AttackPropertiesT>(value);
  }
  template <typename AttackPropertiesT = Aws::Vector<AttackProperty>>
  AttackDetail& WithAttackProperties(AttackPropertiesT&& value) {
    SetAttackProperties(std::forward<AttackPropertiesT>(value));
    return *this;
  }
  template <typename AttackPropertiesT = AttackProperty>
  AttackDetail& AddAttackProperties(AttackPropertiesT&& value) {
    m_attackPropertiesHasBeenSet = true;
    m_attackProperties.emplace_back(std::forward<AttackPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMitigations(MitigationsT&& value) {
    ...
    m_mitigations = std::forward<MitigationsT>(value);
  }
  template <typename MitigationsT = Aws::Vector<Mitigation>>
  AttackDetail& WithMitigations(MitigationsT&& value) {
    SetMitigations(std::forward<MitigationsT>(value));
    return *this;
  }
  template <typename MitigationsT = Mitigation>
  AttackDetail& AddMitigations(MitigationsT&& value) {
    m_mitigationsHasBeenSet = true;
    m_mitigations.emplace_back(std::forward<MitigationsT>(value));
    return *this;
  }
  ///@}
 private:
