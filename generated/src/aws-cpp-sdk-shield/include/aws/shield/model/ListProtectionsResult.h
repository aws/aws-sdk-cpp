...
class ListProtectionsResult {
 public:
  ...
  void SetProtections(ProtectionsT&& value) {
    m_protectionsHasBeenSet = true;
    m_protections = std::forward<ProtectionsT>(value);
  }
  template <typename ProtectionsT = Aws::Vector<Protection>>
  ListProtectionsResult& WithProtections(ProtectionsT&& value) {
    SetProtections(std::forward<ProtectionsT>(value));
    return *this;
  }
  template <typename ProtectionsT = Protection>
  ListProtectionsResult& AddProtections(ProtectionsT&& value) {
    m_protectionsHasBeenSet = true;
    m_protections.emplace_back(std::forward<ProtectionsT>(value));
    return *this;
  }
  ///@}
