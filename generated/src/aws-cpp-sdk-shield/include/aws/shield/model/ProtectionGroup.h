...
class ProtectionGroup {
 public:
  ...
  inline void SetAggregation(ProtectionGroupAggregation value) {
    m_aggregationHasBeenSet = true;
    m_aggregation = value;
  }
  inline ProtectionGroup& WithAggregation(ProtectionGroupAggregation value) {
  ...
  inline void SetPattern(ProtectionGroupPattern value) {
    m_patternHasBeenSet = true;
    m_pattern = value;
  }
  inline ProtectionGroup& WithPattern(ProtectionGroupPattern value) {
    SetPattern(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceType(ProtectedResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline ProtectionGroup& WithResourceType(ProtectedResourceType value) {
  ...
  void SetProtectionGroupArn(ProtectionGroupArnT&& value) {
    ...
    m_protectionGroupArn = std::forward<ProtectionGroupArnT>(value);
  }
  template <typename ProtectionGroupArnT = Aws::String>
  ProtectionGroup& WithProtectionGroupArn(ProtectionGroupArnT&& value) {
    SetProtectionGroupArn(std::forward<ProtectionGroupArnT>(value));
    return *this;
  }
  ///@}
 private:
