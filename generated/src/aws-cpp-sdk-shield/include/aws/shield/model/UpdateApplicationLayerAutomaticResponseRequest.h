...
class UpdateApplicationLayerAutomaticResponseRequest : public ShieldRequest {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  UpdateApplicationLayerAutomaticResponseRequest& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename ActionT = ResponseAction>
  UpdateApplicationLayerAutomaticResponseRequest& WithAction(ActionT&& value) {
