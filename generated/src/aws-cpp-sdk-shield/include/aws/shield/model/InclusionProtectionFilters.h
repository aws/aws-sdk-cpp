...
class InclusionProtectionFilters {
 public:
  ...
  template <typename ResourceArnsT = Aws::Vector<Aws::String>>
  InclusionProtectionFilters& WithResourceArns(ResourceArnsT&& value) {
    SetResourceArns(std::forward<ResourceArnsT>(value));
    return *this;
  }
  template <typename ResourceArnsT = Aws::String>
  InclusionProtectionFilters& AddResourceArns(ResourceArnsT&& value) {
    m_resourceArnsHasBeenSet = true;
  ...
  void SetProtectionNames(ProtectionNamesT&& value) {
    m_protectionNamesHasBeenSet = true;
    m_protectionNames = std::forward<ProtectionNamesT>(value);
  }
  template <typename ProtectionNamesT = Aws::Vector<Aws::String>>
  InclusionProtectionFilters& WithProtectionNames(ProtectionNamesT&& value) {
    SetProtectionNames(std::forward<ProtectionNamesT>(value));
    return *this;
  }
  template <typename ProtectionNamesT = Aws::String>
  InclusionProtectionFilters& AddProtectionNames(ProtectionNamesT&& value) {
    m_protectionNamesHasBeenSet = true;
    m_protectionNames.emplace_back(std::forward<ProtectionNamesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResourceTypesT = Aws::Vector<ProtectedResourceType>>
  InclusionProtectionFilters& WithResourceTypes(ResourceTypesT&& value) {
    SetResourceTypes(std::forward<ResourceTypesT>(value));
    return *this;
  }
  inline InclusionProtectionFilters& AddResourceTypes(ProtectedResourceType value) {
    m_resourceTypesHasBeenSet = true;
