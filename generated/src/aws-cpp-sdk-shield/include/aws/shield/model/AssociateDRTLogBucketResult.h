...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API AssociateDRTLogBucketResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    AssociateDRTLogBucketResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
