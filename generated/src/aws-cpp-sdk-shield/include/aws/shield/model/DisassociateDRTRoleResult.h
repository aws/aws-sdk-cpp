...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API DisassociateDRTRoleResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateDRTRoleResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
