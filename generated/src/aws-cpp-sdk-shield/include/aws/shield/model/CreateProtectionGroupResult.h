...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API CreateProtectionGroupResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateProtectionGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
