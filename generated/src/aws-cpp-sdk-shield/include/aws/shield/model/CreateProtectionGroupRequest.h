...
class CreateProtectionGroupRequest : public ShieldRequest {
 public:
  ...
  inline CreateProtectionGroupRequest& WithAggregation(ProtectionGroupAggregation value) {
  ...
  inline CreateProtectionGroupRequest& WithPattern(ProtectionGroupPattern value) {
    SetPattern(value);
    return *this;
  }
  ///@}
  ...
  inline CreateProtectionGroupRequest& WithResourceType(ProtectedResourceType value) {
