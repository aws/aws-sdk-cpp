...
class UpdateProtectionGroupRequest : public ShieldRequest {
 public:
  ...
  inline UpdateProtectionGroupRequest& WithAggregation(ProtectionGroupAggregation value) {
  ...
  inline UpdateProtectionGroupRequest& WithPattern(ProtectionGroupPattern value) {
    SetPattern(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateProtectionGroupRequest& WithResourceType(ProtectedResourceType value) {
