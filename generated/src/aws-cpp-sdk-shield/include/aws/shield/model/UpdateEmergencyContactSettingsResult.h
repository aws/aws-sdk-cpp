...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API UpdateEmergencyContactSettingsResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateEmergencyContactSettingsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
