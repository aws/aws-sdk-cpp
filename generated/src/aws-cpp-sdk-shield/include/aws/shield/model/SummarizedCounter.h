...
class SummarizedCounter {
 public:
  ...
  inline SummarizedCounter& WithMax(double value) {
    SetMax(value);
    return *this;
  }
  ///@}
  ...
  inline SummarizedCounter& WithAverage(double value) {
    SetAverage(value);
    return *this;
  }
  ///@}
  ...
  inline SummarizedCounter& WithSum(double value) {
    SetSum(value);
    return *this;
  }
  ///@}
  ...
  inline SummarizedCounter& WithN(int value) {
    SetN(value);
    return *this;
  }
  ///@}
