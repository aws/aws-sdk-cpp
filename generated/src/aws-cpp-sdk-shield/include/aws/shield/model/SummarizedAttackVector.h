...
class SummarizedAttackVector {
 public:
  ...
  void SetVectorType(VectorTypeT&& value) {
    ...
    m_vectorType = std::forward<VectorTypeT>(value);
  }
  template <typename VectorTypeT = Aws::String>
  SummarizedAttackVector& WithVectorType(VectorTypeT&& value) {
    SetVectorType(std::forward<VectorTypeT>(value));
    return *this;
  }
  ///@}
