...
class AttackVolume {
 public:
  ...
  void SetBitsPerSecond(BitsPerSecondT&& value) {
    ...
    m_bitsPerSecond = std::forward<BitsPerSecondT>(value);
  }
  template <typename BitsPerSecondT = AttackVolumeStatistics>
  AttackVolume& WithBitsPerSecond(BitsPerSecondT&& value) {
    SetBitsPerSecond(std::forward<BitsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPacketsPerSecond(PacketsPerSecondT&& value) {
    ...
    m_packetsPerSecond = std::forward<PacketsPerSecondT>(value);
  }
  template <typename PacketsPerSecondT = AttackVolumeStatistics>
  AttackVolume& WithPacketsPerSecond(PacketsPerSecondT&& value) {
    SetPacketsPerSecond(std::forward<PacketsPerSecondT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestsPerSecond(RequestsPerSecondT&& value) {
    ...
    m_requestsPerSecond = std::forward<RequestsPerSecondT>(value);
  }
  template <typename RequestsPerSecondT = AttackVolumeStatistics>
  AttackVolume& WithRequestsPerSecond(RequestsPerSecondT&& value) {
    SetRequestsPerSecond(std::forward<RequestsPerSecondT>(value));
    return *this;
  }
  ///@}
 private:
