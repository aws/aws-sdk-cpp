...
class DisableApplicationLayerAutomaticResponseRequest : public ShieldRequest {
 public:
  AWS_SHIELD_API DisableApplicationLayerAutomaticResponseRequest() = default;
  ...
  template <typename ResourceArnT = Aws::String>
  DisableApplicationLayerAutomaticResponseRequest& WithResourceArn(ResourceArnT&& value) {
