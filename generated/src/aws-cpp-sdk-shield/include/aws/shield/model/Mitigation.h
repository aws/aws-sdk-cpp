...
class Mitigation {
 public:
  ...
  void SetMitigationName(MitigationNameT&& value) {
    m_mitigationNameHasBeenSet = true;
    m_mitigationName = std::forward<MitigationNameT>(value);
  }
  template <typename MitigationNameT = Aws::String>
  Mitigation& WithMitigationName(MitigationNameT&& value) {
    SetMitigationName(std::forward<MitigationNameT>(value));
    return *this;
  }
  ///@}
 private:
