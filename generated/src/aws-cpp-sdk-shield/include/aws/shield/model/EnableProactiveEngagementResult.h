...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API EnableProactiveEngagementResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    EnableProactiveEngagementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
