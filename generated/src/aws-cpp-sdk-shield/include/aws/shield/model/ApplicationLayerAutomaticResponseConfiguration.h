...
class ApplicationLayerAutomaticResponseConfiguration {
 public:
  ...
  inline void SetStatus(ApplicationLayerAutomaticResponseStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ApplicationLayerAutomaticResponseConfiguration& WithStatus(ApplicationLayerAutomaticResponseStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
