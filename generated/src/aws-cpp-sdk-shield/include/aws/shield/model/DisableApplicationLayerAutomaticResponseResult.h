...
namespace Model
{
  ...
  public:
    ...
    inline DisableApplicationLayerAutomaticResponseResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisableApplicationLayerAutomaticResponseResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisableApplicationLayerAutomaticResponseResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
