...
class AttackStatisticsDataItem {
 public:
  ...
  void SetAttackVolume(AttackVolumeT&& value) {
    ...
    m_attackVolume = std::forward<AttackVolumeT>(value);
  }
  template <typename AttackVolumeT = AttackVolume>
  AttackStatisticsDataItem& WithAttackVolume(AttackVolumeT&& value) {
    SetAttackVolume(std::forward<AttackVolumeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAttackCount(long long value) {
    m_attackCountHasBeenSet = true;
    m_attackCount = value;
  }
  inline AttackStatisticsDataItem& WithAttackCount(long long value) {
    SetAttackCount(value);
    return *this;
  }
  ///@}
 private:
