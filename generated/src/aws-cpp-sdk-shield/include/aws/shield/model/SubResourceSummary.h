...
class SubResourceSummary {
 public:
  ...
  inline void SetType(SubResourceType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline SubResourceSummary& WithType(SubResourceType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  SubResourceSummary& AddCounters(CountersT&& value) {
    m_countersHasBeenSet = true;
    m_counters.emplace_back(std::forward<CountersT>(value));
    return *this;
  }
  ///@}
 private:
