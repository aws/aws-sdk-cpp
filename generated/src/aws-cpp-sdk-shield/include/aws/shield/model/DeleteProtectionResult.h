...
namespace Model
{
  ...
  {
  public:
    AWS_SHIELD_API DeleteProtectionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteProtectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
