...
class AWS_SHIELD_API ShieldClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  ShieldClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<ShieldEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for AssociateDRTLogBucket that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateDRTLogBucket that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDRTLogBucketRequestT = Model::AssociateDRTLogBucketRequest>
  void AssociateDRTLogBucketAsync(const AssociateDRTLogBucketRequestT& request, const AssociateDRTLogBucketResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for AssociateDRTRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateDRTRole that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AssociateDRTRoleRequestT = Model::AssociateDRTRoleRequest>
  void AssociateDRTRoleAsync(const AssociateDRTRoleRequestT& request, const AssociateDRTRoleResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AssociateHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AssociateHealthCheck that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateHealthCheckRequestT = Model::AssociateHealthCheckRequest>
  void AssociateHealthCheckAsync(const AssociateHealthCheckRequestT& request, const AssociateHealthCheckResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateProactiveEngagementDetailsOutcome AssociateProactiveEngagementDetails(
      const Model::AssociateProactiveEngagementDetailsRequest& request) const;

  /**
   * A Callable wrapper for AssociateProactiveEngagementDetails that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AssociateProactiveEngagementDetailsRequestT = Model::AssociateProactiveEngagementDetailsRequest>
  Model::AssociateProactiveEngagementDetailsOutcomeCallable AssociateProactiveEngagementDetailsCallable(
      const AssociateProactiveEngagementDetailsRequestT& request) const {
    return SubmitCallable(&ShieldClient::AssociateProactiveEngagementDetails, request);
  }

  /**
   * An Async wrapper for AssociateProactiveEngagementDetails that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AssociateProactiveEngagementDetailsRequestT = Model::AssociateProactiveEngagementDetailsRequest>
  void AssociateProactiveEngagementDetailsAsync(const AssociateProactiveEngagementDetailsRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProtection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateProtectionRequestT = Model::CreateProtectionRequest>
  void CreateProtectionAsync(const CreateProtectionRequestT& request, const CreateProtectionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateProtectionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateProtectionGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateProtectionGroupRequestT = Model::CreateProtectionGroupRequest>
  void CreateProtectionGroupAsync(const CreateProtectionGroupRequestT& request, const CreateProtectionGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename CreateSubscriptionRequestT = Model::CreateSubscriptionRequest>
  void CreateSubscriptionAsync(const CreateSubscriptionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const CreateSubscriptionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DeleteProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProtection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteProtectionRequestT = Model::DeleteProtectionRequest>
  void DeleteProtectionAsync(const DeleteProtectionRequestT& request, const DeleteProtectionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteProtectionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteProtectionGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteProtectionGroupRequestT = Model::DeleteProtectionGroupRequest>
  void DeleteProtectionGroupAsync(const DeleteProtectionGroupRequestT& request, const DeleteProtectionGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeAttack that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeAttackRequestT = Model::DescribeAttackRequest>
  void DescribeAttackAsync(const DescribeAttackRequestT& request, const DescribeAttackResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAttackStatistics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeAttackStatisticsRequestT = Model::DescribeAttackStatisticsRequest>
  Model::DescribeAttackStatisticsOutcomeCallable DescribeAttackStatisticsCallable(
      const DescribeAttackStatisticsRequestT& request = {}) const {
    return SubmitCallable(&ShieldClient::DescribeAttackStatistics, request);
  }

  /**
   * An Async wrapper for DescribeAttackStatistics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAttackStatisticsRequestT = Model::DescribeAttackStatisticsRequest>
  void DescribeAttackStatisticsAsync(const DescribeAttackStatisticsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeAttackStatisticsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDRTAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDRTAccess that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDRTAccessRequestT = Model::DescribeDRTAccessRequest>
  void DescribeDRTAccessAsync(const DescribeDRTAccessResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeDRTAccessRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEmergencyContactSettingsOutcome DescribeEmergencyContactSettings(
      const Model::DescribeEmergencyContactSettingsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEmergencyContactSettings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeEmergencyContactSettingsRequestT = Model::DescribeEmergencyContactSettingsRequest>
  Model::DescribeEmergencyContactSettingsOutcomeCallable DescribeEmergencyContactSettingsCallable(
      const DescribeEmergencyContactSettingsRequestT& request = {}) const {
    return SubmitCallable(&ShieldClient::DescribeEmergencyContactSettings, request);
  }

  /**
   * An Async wrapper for DescribeEmergencyContactSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeEmergencyContactSettingsRequestT = Model::DescribeEmergencyContactSettingsRequest>
  void DescribeEmergencyContactSettingsAsync(const DescribeEmergencyContactSettingsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeEmergencyContactSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProtection that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProtection that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeProtectionRequestT = Model::DescribeProtectionRequest>
  void DescribeProtectionAsync(const DescribeProtectionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeProtectionRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProtectionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProtectionGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeProtectionGroupRequestT = Model::DescribeProtectionGroupRequest>
  void DescribeProtectionGroupAsync(const DescribeProtectionGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSubscriptionRequestT = Model::DescribeSubscriptionRequest>
  void DescribeSubscriptionAsync(const DescribeSubscriptionResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeSubscriptionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableApplicationLayerAutomaticResponseOutcome DisableApplicationLayerAutomaticResponse(
      const Model::DisableApplicationLayerAutomaticResponseRequest& request) const;

  /**
   * A Callable wrapper for DisableApplicationLayerAutomaticResponse that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisableApplicationLayerAutomaticResponseRequestT = Model::DisableApplicationLayerAutomaticResponseRequest>
  Model::DisableApplicationLayerAutomaticResponseOutcomeCallable DisableApplicationLayerAutomaticResponseCallable(
      const DisableApplicationLayerAutomaticResponseRequestT& request) const {
    return SubmitCallable(&ShieldClient::DisableApplicationLayerAutomaticResponse, request);
  }

  /**
   * An Async wrapper for DisableApplicationLayerAutomaticResponse that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisableApplicationLayerAutomaticResponseRequestT = Model::DisableApplicationLayerAutomaticResponseRequest>
  void DisableApplicationLayerAutomaticResponseAsync(
      const DisableApplicationLayerAutomaticResponseRequestT& request,
      const DisableApplicationLayerAutomaticResponseResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DisableProactiveEngagementOutcome DisableProactiveEngagement(
      const Model::DisableProactiveEngagementRequest& request = {}) const;

  /**
   * A Callable wrapper for DisableProactiveEngagement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableProactiveEngagementRequestT = Model::DisableProactiveEngagementRequest>
  Model::DisableProactiveEngagementOutcomeCallable DisableProactiveEngagementCallable(
      const DisableProactiveEngagementRequestT& request = {}) const {
    return SubmitCallable(&ShieldClient::DisableProactiveEngagement, request);
  }

  /**
   * An Async wrapper for DisableProactiveEngagement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableProactiveEngagementRequestT = Model::DisableProactiveEngagementRequest>
  void DisableProactiveEngagementAsync(const DisableProactiveEngagementResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DisableProactiveEngagementRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateDRTLogBucket that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateDRTLogBucket that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateDRTLogBucketRequestT = Model::DisassociateDRTLogBucketRequest>
  void DisassociateDRTLogBucketAsync(const DisassociateDRTLogBucketRequestT& request,
  ...
  /**
   * A Callable wrapper for DisassociateDRTRole that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateDRTRole that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateDRTRoleRequestT = Model::DisassociateDRTRoleRequest>
  void DisassociateDRTRoleAsync(const DisassociateDRTRoleResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DisassociateDRTRoleRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateHealthCheck that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateHealthCheck that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateHealthCheckRequestT = Model::DisassociateHealthCheckRequest>
  void DisassociateHealthCheckAsync(const DisassociateHealthCheckRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableApplicationLayerAutomaticResponseOutcome EnableApplicationLayerAutomaticResponse(
      const Model::EnableApplicationLayerAutomaticResponseRequest& request) const;

  /**
   * A Callable wrapper for EnableApplicationLayerAutomaticResponse that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename EnableApplicationLayerAutomaticResponseRequestT = Model::EnableApplicationLayerAutomaticResponseRequest>
  Model::EnableApplicationLayerAutomaticResponseOutcomeCallable EnableApplicationLayerAutomaticResponseCallable(
      const EnableApplicationLayerAutomaticResponseRequestT& request) const {
    return SubmitCallable(&ShieldClient::EnableApplicationLayerAutomaticResponse, request);
  }

  /**
   * An Async wrapper for EnableApplicationLayerAutomaticResponse that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename EnableApplicationLayerAutomaticResponseRequestT = Model::EnableApplicationLayerAutomaticResponseRequest>
  void EnableApplicationLayerAutomaticResponseAsync(const EnableApplicationLayerAutomaticResponseRequestT& request,
                                                    const EnableApplicationLayerAutomaticResponseResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableProactiveEngagementOutcome EnableProactiveEngagement(
      const Model::EnableProactiveEngagementRequest& request = {}) const;

  /**
   * A Callable wrapper for EnableProactiveEngagement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename EnableProactiveEngagementRequestT = Model::EnableProactiveEngagementRequest>
  Model::EnableProactiveEngagementOutcomeCallable EnableProactiveEngagementCallable(
      const EnableProactiveEngagementRequestT& request = {}) const {
    return SubmitCallable(&ShieldClient::EnableProactiveEngagement, request);
  }

  /**
   * An Async wrapper for EnableProactiveEngagement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename EnableProactiveEngagementRequestT = Model::EnableProactiveEngagementRequest>
  void EnableProactiveEngagementAsync(const EnableProactiveEngagementResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const EnableProactiveEngagementRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetSubscriptionState that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetSubscriptionState that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSubscriptionStateRequestT = Model::GetSubscriptionStateRequest>
  void GetSubscriptionStateAsync(const GetSubscriptionStateResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const GetSubscriptionStateRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListAttacks that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListAttacksRequestT = Model::ListAttacksRequest>
  void ListAttacksAsync(const ListAttacksResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const ListAttacksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProtectionGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProtectionGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProtectionGroupsRequestT = Model::ListProtectionGroupsRequest>
  void ListProtectionGroupsAsync(const ListProtectionGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const ListProtectionGroupsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListProtections that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListProtectionsRequestT = Model::ListProtectionsRequest>
  void ListProtectionsAsync(const ListProtectionsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const ListProtectionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListResourcesInProtectionGroupOutcome ListResourcesInProtectionGroup(
      const Model::ListResourcesInProtectionGroupRequest& request) const;

  /**
   * A Callable wrapper for ListResourcesInProtectionGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListResourcesInProtectionGroupRequestT = Model::ListResourcesInProtectionGroupRequest>
  Model::ListResourcesInProtectionGroupOutcomeCallable ListResourcesInProtectionGroupCallable(
      const ListResourcesInProtectionGroupRequestT& request) const {
    return SubmitCallable(&ShieldClient::ListResourcesInProtectionGroup, request);
  }

  /**
   * An Async wrapper for ListResourcesInProtectionGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListResourcesInProtectionGroupRequestT = Model::ListResourcesInProtectionGroupRequest>
  void ListResourcesInProtectionGroupAsync(const ListResourcesInProtectionGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateApplicationLayerAutomaticResponseOutcome UpdateApplicationLayerAutomaticResponse(
      const Model::UpdateApplicationLayerAutomaticResponseRequest& request) const;

  /**
   * A Callable wrapper for UpdateApplicationLayerAutomaticResponse that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateApplicationLayerAutomaticResponseRequestT = Model::UpdateApplicationLayerAutomaticResponseRequest>
  Model::UpdateApplicationLayerAutomaticResponseOutcomeCallable UpdateApplicationLayerAutomaticResponseCallable(
      const UpdateApplicationLayerAutomaticResponseRequestT& request) const {
    return SubmitCallable(&ShieldClient::UpdateApplicationLayerAutomaticResponse, request);
  }

  /**
   * An Async wrapper for UpdateApplicationLayerAutomaticResponse that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateApplicationLayerAutomaticResponseRequestT = Model::UpdateApplicationLayerAutomaticResponseRequest>
  void UpdateApplicationLayerAutomaticResponseAsync(const UpdateApplicationLayerAutomaticResponseRequestT& request,
                                                    const UpdateApplicationLayerAutomaticResponseResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateEmergencyContactSettingsOutcome UpdateEmergencyContactSettings(
      const Model::UpdateEmergencyContactSettingsRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateEmergencyContactSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateEmergencyContactSettingsRequestT = Model::UpdateEmergencyContactSettingsRequest>
  Model::UpdateEmergencyContactSettingsOutcomeCallable UpdateEmergencyContactSettingsCallable(
      const UpdateEmergencyContactSettingsRequestT& request = {}) const {
    return SubmitCallable(&ShieldClient::UpdateEmergencyContactSettings, request);
  }

  /**
   * An Async wrapper for UpdateEmergencyContactSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateEmergencyContactSettingsRequestT = Model::UpdateEmergencyContactSettingsRequest>
  void UpdateEmergencyContactSettingsAsync(const UpdateEmergencyContactSettingsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const UpdateEmergencyContactSettingsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateProtectionGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateProtectionGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateProtectionGroupRequestT = Model::UpdateProtectionGroupRequest>
  void UpdateProtectionGroupAsync(const UpdateProtectionGroupRequestT& request, const UpdateProtectionGroupResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename UpdateSubscriptionRequestT = Model::UpdateSubscriptionRequest>
  void UpdateSubscriptionAsync(const UpdateSubscriptionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const UpdateSubscriptionRequestT& request = {}) const {
