...
AttackProperty::AttackProperty(JsonView jsonValue) { *this = jsonValue; }
...
AttackProperty& AttackProperty::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AttackPropertyIdentifier")) {
    m_attackPropertyIdentifier =
        AttackPropertyIdentifierMapper::GetAttackPropertyIdentifierForName(jsonValue.GetString("AttackPropertyIdentifier"));
...
JsonValue AttackProperty::Jsonize() const {
  ...
  if (m_attackPropertyIdentifierHasBeenSet) {
    payload.WithString("AttackPropertyIdentifier",
                       AttackPropertyIdentifierMapper::GetNameForAttackPropertyIdentifier(m_attackPropertyIdentifier));
  }
