...
class DeleteTriggerRequest : public DevOpsAgentRequest {
 public:
  AWS_DEVOPSAGENT_API DeleteTriggerRequest() = default;
  ...
  template <typename AgentSpaceIdT = Aws::String>
  DeleteTriggerRequest& WithAgentSpaceId(AgentSpaceIdT&& value) {
  ...
  template <typename TriggerIdT = Aws::String>
  DeleteTriggerRequest& WithTriggerId(TriggerIdT&& value) {
