...
/**
 * <p>Request structure for deleting an asset file</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/DeleteAssetFileRequest">AWS
 * API Reference</a></p>
 */
class DeleteAssetFileRequest : public DevOpsAgentRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteAssetFile"; }
