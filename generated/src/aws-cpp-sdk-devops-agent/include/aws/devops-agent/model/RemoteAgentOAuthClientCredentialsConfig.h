...
/**
 * <p>OAuth client credentials configuration for remote A2A agent.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/RemoteAgentOAuthClientCredentialsConfig">AWS
 * API Reference</a></p>
 */
class RemoteAgentOAuthClientCredentialsConfig {
 public:
  AWS_DEVOPSAGENT_API RemoteAgentOAuthClientCredentialsConfig() = default;
  AWS_DEVOPSAGENT_API RemoteAgentOAuthClientCredentialsConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API RemoteAgentOAuthClientCredentialsConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ClientNameT = Aws::String>
  RemoteAgentOAuthClientCredentialsConfig& WithClientName(ClientNameT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  RemoteAgentOAuthClientCredentialsConfig& WithClientId(ClientIdT&& value) {
  ...
  template <typename ExchangeParametersT = Aws::Map<Aws::String, Aws::String>>
  RemoteAgentOAuthClientCredentialsConfig& WithExchangeParameters(ExchangeParametersT&& value) {
  ...
  RemoteAgentOAuthClientCredentialsConfig& AddExchangeParameters(ExchangeParametersKeyT&& key, ExchangeParametersValueT&& value) {
    m_exchangeParametersHasBeenSet = true;
  ...
  template <typename ClientSecretT = Aws::String>
  RemoteAgentOAuthClientCredentialsConfig& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ExchangeUrlT = Aws::String>
  RemoteAgentOAuthClientCredentialsConfig& WithExchangeUrl(ExchangeUrlT&& value) {
  ...
  template <typename ScopesT = Aws::Vector<Aws::String>>
  RemoteAgentOAuthClientCredentialsConfig& WithScopes(ScopesT&& value) {
    SetScopes(std::forward<ScopesT>(value));
    return *this;
  }
  template <typename ScopesT = Aws::String>
  RemoteAgentOAuthClientCredentialsConfig& AddScopes(ScopesT&& value) {
    m_scopesHasBeenSet = true;
