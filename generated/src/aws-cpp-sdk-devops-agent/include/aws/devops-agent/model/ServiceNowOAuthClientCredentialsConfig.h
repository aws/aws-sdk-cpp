...
/**
 * <p>OAuth client credentials configuration for ServiceNow.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/ServiceNowOAuthClientCredentialsConfig">AWS
 * API Reference</a></p>
 */
class ServiceNowOAuthClientCredentialsConfig {
 public:
  AWS_DEVOPSAGENT_API ServiceNowOAuthClientCredentialsConfig() = default;
  AWS_DEVOPSAGENT_API ServiceNowOAuthClientCredentialsConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API ServiceNowOAuthClientCredentialsConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ClientNameT = Aws::String>
  ServiceNowOAuthClientCredentialsConfig& WithClientName(ClientNameT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  ServiceNowOAuthClientCredentialsConfig& WithClientId(ClientIdT&& value) {
  ...
  template <typename ExchangeParametersT = Aws::Map<Aws::String, Aws::String>>
  ServiceNowOAuthClientCredentialsConfig& WithExchangeParameters(ExchangeParametersT&& value) {
  ...
  ServiceNowOAuthClientCredentialsConfig& AddExchangeParameters(ExchangeParametersKeyT&& key, ExchangeParametersValueT&& value) {
    m_exchangeParametersHasBeenSet = true;
  ...
  template <typename ClientSecretT = Aws::String>
  ServiceNowOAuthClientCredentialsConfig& WithClientSecret(ClientSecretT&& value) {
