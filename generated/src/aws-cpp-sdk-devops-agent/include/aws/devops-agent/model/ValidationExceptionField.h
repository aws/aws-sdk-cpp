 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/ValidationExceptionField">AWS
 * API Reference</a></p>
 */
class ValidationExceptionField {
 public:
  AWS_DEVOPSAGENT_API ValidationExceptionField() = default;
  AWS_DEVOPSAGENT_API ValidationExceptionField(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API ValidationExceptionField& operator=(Aws::Utils::Json::JsonView jsonValue);
