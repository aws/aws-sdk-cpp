...
/**
 * <p>Complete service details for MCP server integration.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/MCPServerDetails">AWS
 * API Reference</a></p>
 */
class MCPServerDetails {
 public:
  AWS_DEVOPSAGENT_API MCPServerDetails() = default;
  AWS_DEVOPSAGENT_API MCPServerDetails(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API MCPServerDetails& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename NameT = Aws::String>
  MCPServerDetails& WithName(NameT&& value) {
  ...
  template <typename EndpointT = Aws::String>
  MCPServerDetails& WithEndpoint(EndpointT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  MCPServerDetails& WithDescription(DescriptionT&& value) {
  ...
  template <typename AuthorizationConfigT = MCPServerAuthorizationConfig>
  MCPServerDetails& WithAuthorizationConfig(AuthorizationConfigT&& value) {
