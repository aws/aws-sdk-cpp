...
namespace Model {
/**
 * <p>Output containing a list of service associations and pagination
 * token.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/ListAssociationsOutput">AWS
 * API Reference</a></p>
 */
