...
/**
 * <p>Input for updating the certificate of a Private Connection.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/UpdatePrivateConnectionCertificateInput">AWS
 * API Reference</a></p>
 */
class UpdatePrivateConnectionCertificateRequest : public DevOpsAgentRequest {
 public:
  AWS_DEVOPSAGENT_API UpdatePrivateConnectionCertificateRequest() = default;
  ...
  template <typename NameT = Aws::String>
  UpdatePrivateConnectionCertificateRequest& WithName(NameT&& value) {
