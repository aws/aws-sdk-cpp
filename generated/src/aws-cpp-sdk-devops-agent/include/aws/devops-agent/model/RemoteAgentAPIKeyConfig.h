...
/**
 * <p>API key configuration for remote A2A agent.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/RemoteAgentAPIKeyConfig">AWS
 * API Reference</a></p>
 */
class RemoteAgentAPIKeyConfig {
 public:
  AWS_DEVOPSAGENT_API RemoteAgentAPIKeyConfig() = default;
  AWS_DEVOPSAGENT_API RemoteAgentAPIKeyConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API RemoteAgentAPIKeyConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ApiKeyNameT = Aws::String>
  RemoteAgentAPIKeyConfig& WithApiKeyName(ApiKeyNameT&& value) {
  ...
  template <typename ApiKeyValueT = Aws::String>
  RemoteAgentAPIKeyConfig& WithApiKeyValue(ApiKeyValueT&& value) {
  ...
  template <typename ApiKeyHeaderT = Aws::String>
  RemoteAgentAPIKeyConfig& WithApiKeyHeader(ApiKeyHeaderT&& value) {
