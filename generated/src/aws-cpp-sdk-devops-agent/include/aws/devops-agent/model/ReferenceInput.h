...
/**
 * <p>Reference information linking a task to external systems - for input with
 * validation</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/ReferenceInput">AWS
 * API Reference</a></p>
 */
