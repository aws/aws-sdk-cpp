...
/**
 * <p>Request structure for getting an asset</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/GetAssetRequest">AWS
 * API Reference</a></p>
 */
class GetAssetRequest : public DevOpsAgentRequest {
 public:
  AWS_DEVOPSAGENT_API GetAssetRequest() = default;
  ...
  template <typename AgentSpaceIdT = Aws::String>
  GetAssetRequest& WithAgentSpaceId(AgentSpaceIdT&& value) {
  ...
  template <typename AssetIdT = Aws::String>
  GetAssetRequest& WithAssetId(AssetIdT&& value) {
  ...
  ///@{
  /**
   * <p>The specific version of the asset to retrieve. If omitted, the latest version
   * is returned.</p>
   */
  ...
  inline GetAssetRequest& WithAssetVersion(int value) {
