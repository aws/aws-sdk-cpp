...
class CreatePrivateConnectionResult {
 public:
  ...
  inline CreatePrivateConnectionResult& WithDnsResolution(ResourceConfigDnsResolution value) {
  ...
  ///@{
  /**
   * <p>Message describing the reason for a failed Private Connection creation, if
   * applicable.</p>
   */
