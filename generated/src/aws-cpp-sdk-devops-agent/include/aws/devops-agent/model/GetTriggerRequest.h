...
/**
 * <p>Request structure for getting a Trigger</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/GetTriggerRequest">AWS
 * API Reference</a></p>
 */
class GetTriggerRequest : public DevOpsAgentRequest {
 public:
  AWS_DEVOPSAGENT_API GetTriggerRequest() = default;
  ...
  template <typename AgentSpaceIdT = Aws::String>
  GetTriggerRequest& WithAgentSpaceId(AgentSpaceIdT&& value) {
  ...
  template <typename TriggerIdT = Aws::String>
  GetTriggerRequest& WithTriggerId(TriggerIdT&& value) {
