...
/**
 * <p>Input for creating a new service association within an
 * AgentSpace.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/AssociateServiceInput">AWS
 * API Reference</a></p>
 */
class AssociateServiceRequest : public DevOpsAgentRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AssociateService"; }
  ...
  template <typename CapabilitiesT = Aws::Map<CapabilityType, CapabilityConfiguration>>
  AssociateServiceRequest& WithCapabilities(CapabilitiesT&& value) {
    SetCapabilities(std::forward<CapabilitiesT>(value));
    return *this;
  }
  inline AssociateServiceRequest& AddCapabilities(CapabilityType key, CapabilityConfiguration value) {
    m_capabilitiesHasBeenSet = true;
