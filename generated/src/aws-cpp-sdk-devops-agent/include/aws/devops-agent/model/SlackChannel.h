...
/**
 * <p>Represents a Slack channel with its ID and optional name.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/SlackChannel">AWS
 * API Reference</a></p>
 */
class SlackChannel {
 public:
