...
/**
 * <p>OAuth client credentials configuration for Dynatrace.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/DynatraceOAuthClientCredentialsConfig">AWS
 * API Reference</a></p>
 */
class DynatraceOAuthClientCredentialsConfig {
 public:
  AWS_DEVOPSAGENT_API DynatraceOAuthClientCredentialsConfig() = default;
  AWS_DEVOPSAGENT_API DynatraceOAuthClientCredentialsConfig(Aws::Utils::Json::JsonView jsonValue);
  AWS_DEVOPSAGENT_API DynatraceOAuthClientCredentialsConfig& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename ClientNameT = Aws::String>
  DynatraceOAuthClientCredentialsConfig& WithClientName(ClientNameT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  DynatraceOAuthClientCredentialsConfig& WithClientId(ClientIdT&& value) {
  ...
  template <typename ExchangeParametersT = Aws::Map<Aws::String, Aws::String>>
  DynatraceOAuthClientCredentialsConfig& WithExchangeParameters(ExchangeParametersT&& value) {
  ...
  DynatraceOAuthClientCredentialsConfig& AddExchangeParameters(ExchangeParametersKeyT&& key, ExchangeParametersValueT&& value) {
    m_exchangeParametersHasBeenSet = true;
  ...
  template <typename ClientSecretT = Aws::String>
  DynatraceOAuthClientCredentialsConfig& WithClientSecret(ClientSecretT&& value) {
