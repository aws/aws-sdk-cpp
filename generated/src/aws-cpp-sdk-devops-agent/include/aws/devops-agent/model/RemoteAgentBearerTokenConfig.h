...
/**
 * <p>Bearer token configuration for remote A2A agent (RFC 6750).</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/RemoteAgentBearerTokenConfig">AWS
 * API Reference</a></p>
 */
