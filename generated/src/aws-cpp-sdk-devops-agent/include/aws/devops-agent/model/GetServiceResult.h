...
namespace Model {
/**
 * <p>Output containing the requested service details.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/GetServiceOutput">AWS
 * API Reference</a></p>
 */
class GetServiceResult {
 public:
  ...
  inline const RegisteredService& GetService() const { return m_service; }
  template <typename ServiceT = RegisteredService>
