...
/**
 * <p>Request structure for updating an asset file</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/UpdateAssetFileRequest">AWS
 * API Reference</a></p>
 */
class UpdateAssetFileRequest : public DevOpsAgentRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "UpdateAssetFile"; }
