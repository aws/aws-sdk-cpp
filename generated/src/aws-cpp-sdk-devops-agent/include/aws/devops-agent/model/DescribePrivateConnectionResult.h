...
namespace Model {
/**
 * <p>Output containing the Private Connection details.</p><p><h3>See Also:</h3>
 * <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/devops-agent-2026-01-01/DescribePrivateConnectionOutput">AWS
 * API Reference</a></p>
 */
