...
ListBacklogTasksResult::ListBacklogTasksResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListBacklogTasksResult& ListBacklogTasksResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
