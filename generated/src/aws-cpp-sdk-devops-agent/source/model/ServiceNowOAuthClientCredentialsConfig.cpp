...
ServiceNowOAuthClientCredentialsConfig::ServiceNowOAuthClientCredentialsConfig(JsonView jsonValue) { *this = jsonValue; }

ServiceNowOAuthClientCredentialsConfig& ServiceNowOAuthClientCredentialsConfig::operator=(JsonView jsonValue) {
...
JsonValue ServiceNowOAuthClientCredentialsConfig::Jsonize() const {
  JsonValue payload;
