...
PagerDutyAuthorizationConfig::PagerDutyAuthorizationConfig(JsonView jsonValue) { *this = jsonValue; }

PagerDutyAuthorizationConfig& PagerDutyAuthorizationConfig::operator=(JsonView jsonValue) {
...
JsonValue PagerDutyAuthorizationConfig::Jsonize() const {
  JsonValue payload;
