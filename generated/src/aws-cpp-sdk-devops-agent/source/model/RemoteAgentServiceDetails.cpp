...
RemoteAgentServiceDetails::RemoteAgentServiceDetails(JsonView jsonValue) { *this = jsonValue; }

RemoteAgentServiceDetails& RemoteAgentServiceDetails::operator=(JsonView jsonValue) {
...
JsonValue RemoteAgentServiceDetails::Jsonize() const {
  JsonValue payload;
