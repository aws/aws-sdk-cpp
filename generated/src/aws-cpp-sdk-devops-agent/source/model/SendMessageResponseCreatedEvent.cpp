...
SendMessageResponseCreatedEvent::SendMessageResponseCreatedEvent(JsonView jsonValue) { *this = jsonValue; }

SendMessageResponseCreatedEvent& SendMessageResponseCreatedEvent::operator=(JsonView jsonValue) {
...
JsonValue SendMessageResponseCreatedEvent::Jsonize() const {
  JsonValue payload;
