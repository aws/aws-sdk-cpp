...
UpdatePrivateConnectionCertificateResult::UpdatePrivateConnectionCertificateResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

UpdatePrivateConnectionCertificateResult& UpdatePrivateConnectionCertificateResult::operator=(
