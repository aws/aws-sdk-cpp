...
PagerDutyOAuthClientCredentialsConfig::PagerDutyOAuthClientCredentialsConfig(JsonView jsonValue) { *this = jsonValue; }

PagerDutyOAuthClientCredentialsConfig& PagerDutyOAuthClientCredentialsConfig::operator=(JsonView jsonValue) {
...
JsonValue PagerDutyOAuthClientCredentialsConfig::Jsonize() const {
  JsonValue payload;
