...
MCPServerSigV4ServiceDetails::MCPServerSigV4ServiceDetails(JsonView jsonValue) { *this = jsonValue; }

MCPServerSigV4ServiceDetails& MCPServerSigV4ServiceDetails::operator=(JsonView jsonValue) {
...
JsonValue MCPServerSigV4ServiceDetails::Jsonize() const {
  JsonValue payload;
