...
RemoteAgentOAuthClientCredentialsConfig::RemoteAgentOAuthClientCredentialsConfig(JsonView jsonValue) { *this = jsonValue; }

RemoteAgentOAuthClientCredentialsConfig& RemoteAgentOAuthClientCredentialsConfig::operator=(JsonView jsonValue) {
...
JsonValue RemoteAgentOAuthClientCredentialsConfig::Jsonize() const {
  JsonValue payload;
