...
ReferenceOutput::ReferenceOutput(JsonView jsonValue) { *this = jsonValue; }

ReferenceOutput& ReferenceOutput::operator=(JsonView jsonValue) {
...
JsonValue ReferenceOutput::Jsonize() const {
  JsonValue payload;
