...
MCPServerDetails::MCPServerDetails(JsonView jsonValue) { *this = jsonValue; }

MCPServerDetails& MCPServerDetails::operator=(JsonView jsonValue) {
...
JsonValue MCPServerDetails::Jsonize() const {
  JsonValue payload;
