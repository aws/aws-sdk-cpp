...
RemoteAgentSigV4ServiceDetails::RemoteAgentSigV4ServiceDetails(JsonView jsonValue) { *this = jsonValue; }

RemoteAgentSigV4ServiceDetails& RemoteAgentSigV4ServiceDetails::operator=(JsonView jsonValue) {
...
JsonValue RemoteAgentSigV4ServiceDetails::Jsonize() const {
  JsonValue payload;
