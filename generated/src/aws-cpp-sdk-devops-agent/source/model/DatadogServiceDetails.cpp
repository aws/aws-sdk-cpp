...
DatadogServiceDetails::DatadogServiceDetails(JsonView jsonValue) { *this = jsonValue; }

DatadogServiceDetails& DatadogServiceDetails::operator=(JsonView jsonValue) {
...
JsonValue DatadogServiceDetails::Jsonize() const {
  JsonValue payload;
