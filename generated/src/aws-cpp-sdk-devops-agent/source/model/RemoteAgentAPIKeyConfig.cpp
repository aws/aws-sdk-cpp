...
RemoteAgentAPIKeyConfig::RemoteAgentAPIKeyConfig(JsonView jsonValue) { *this = jsonValue; }

RemoteAgentAPIKeyConfig& RemoteAgentAPIKeyConfig::operator=(JsonView jsonValue) {
...
JsonValue RemoteAgentAPIKeyConfig::Jsonize() const {
  JsonValue payload;
