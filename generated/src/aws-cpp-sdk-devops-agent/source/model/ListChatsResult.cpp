...
ListChatsResult::ListChatsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListChatsResult& ListChatsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
