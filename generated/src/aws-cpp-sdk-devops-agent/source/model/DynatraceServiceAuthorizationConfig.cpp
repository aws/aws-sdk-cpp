...
DynatraceServiceAuthorizationConfig::DynatraceServiceAuthorizationConfig(JsonView jsonValue) { *this = jsonValue; }

DynatraceServiceAuthorizationConfig& DynatraceServiceAuthorizationConfig::operator=(JsonView jsonValue) {
...
JsonValue DynatraceServiceAuthorizationConfig::Jsonize() const {
  JsonValue payload;
