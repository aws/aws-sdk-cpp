...
RemoteAgentBearerTokenConfig::RemoteAgentBearerTokenConfig(JsonView jsonValue) { *this = jsonValue; }

RemoteAgentBearerTokenConfig& RemoteAgentBearerTokenConfig::operator=(JsonView jsonValue) {
...
JsonValue RemoteAgentBearerTokenConfig::Jsonize() const {
  JsonValue payload;
