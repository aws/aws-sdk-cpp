...
class ResolveCustomerRequest : public MarketplaceMeteringRequest {
 public:
   ...
   * <code>LicenseArn</code>.</p>  <p>For new SaaS product integrations, the
   * <code>CustomerIdentifier</code> field is not populated. Use
   * <code>CustomerAWSAccountId</code> and <code>LicenseArn</code> for customer
   * identification.</p>
   */
  ...
  template <typename RegistrationTokenT = Aws::String>
  ResolveCustomerRequest& WithRegistrationToken(RegistrationTokenT&& value) {
