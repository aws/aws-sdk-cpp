...
class BatchMeterUsageResult {
 public:
  ...
  template <typename ResultsT = Aws::Vector<UsageRecordResult>>
  BatchMeterUsageResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = UsageRecordResult>
  BatchMeterUsageResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  void SetUnprocessedRecords(UnprocessedRecordsT&& value) {
    m_unprocessedRecordsHasBeenSet = true;
    m_unprocessedRecords = std::forward<UnprocessedRecordsT>(value);
  }
  template <typename UnprocessedRecordsT = Aws::Vector<UsageRecord>>
  BatchMeterUsageResult& WithUnprocessedRecords(UnprocessedRecordsT&& value) {
    SetUnprocessedRecords(std::forward<UnprocessedRecordsT>(value));
    return *this;
  }
  template <typename UnprocessedRecordsT = UsageRecord>
  BatchMeterUsageResult& AddUnprocessedRecords(UnprocessedRecordsT&& value) {
    m_unprocessedRecordsHasBeenSet = true;
    m_unprocessedRecords.emplace_back(std::forward<UnprocessedRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  BatchMeterUsageResult& WithRequestId(RequestIdT&& value) {
