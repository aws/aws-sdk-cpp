...
class BatchMeterUsageRequest : public MarketplaceMeteringRequest {
 public:
  ...
  void SetUsageRecords(UsageRecordsT&& value) {
    m_usageRecordsHasBeenSet = true;
    m_usageRecords = std::forward<UsageRecordsT>(value);
  }
  template <typename UsageRecordsT = Aws::Vector<UsageRecord>>
  BatchMeterUsageRequest& WithUsageRecords(UsageRecordsT&& value) {
    SetUsageRecords(std::forward<UsageRecordsT>(value));
    return *this;
  }
  template <typename UsageRecordsT = UsageRecord>
  BatchMeterUsageRequest& AddUsageRecords(UsageRecordsT&& value) {
    m_usageRecordsHasBeenSet = true;
    m_usageRecords.emplace_back(std::forward<UsageRecordsT>(value));
    return *this;
  }
  ///@}
