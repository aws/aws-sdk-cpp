...
class UsageRecordResult {
 public:
  ...
  void SetUsageRecord(UsageRecordT&& value) {
    m_usageRecordHasBeenSet = true;
    m_usageRecord = std::forward<UsageRecordT>(value);
  }
  template <typename UsageRecordT = UsageRecord>
  UsageRecordResult& WithUsageRecord(UsageRecordT&& value) {
    SetUsageRecord(std::forward<UsageRecordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMeteringRecordId(MeteringRecordIdT&& value) {
    m_meteringRecordIdHasBeenSet = true;
    m_meteringRecordId = std::forward<MeteringRecordIdT>(value);
  }
  template <typename MeteringRecordIdT = Aws::String>
  UsageRecordResult& WithMeteringRecordId(MeteringRecordIdT&& value) {
    SetMeteringRecordId(std::forward<MeteringRecordIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(UsageRecordResultStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UsageRecordResult& WithStatus(UsageRecordResultStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
