...
namespace MarketplaceMetering
{
   ...
   */
  class AWS_MARKETPLACEMETERING_API MarketplaceMeteringClient : Aws::Client::ClientWithAsyncTemplateMethods<MarketplaceMeteringClient>,
    smithy::client::AwsSmithyClientT<Aws::MarketplaceMetering::SERVICE_NAME,
