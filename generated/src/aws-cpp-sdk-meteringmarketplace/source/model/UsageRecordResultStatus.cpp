  ...
  namespace MarketplaceMetering
  {
    namespace Model
    {
      namespace UsageRecordResultStatusMapper
      {
        ...
        static constexpr uint32_t CustomerNotSubscribed_HASH = ConstExprHashingUtils::HashString("CustomerNotSubscribed");
        static constexpr uint32_t DuplicateRecord_HASH = ConstExprHashingUtils::HashString("DuplicateRecord");
