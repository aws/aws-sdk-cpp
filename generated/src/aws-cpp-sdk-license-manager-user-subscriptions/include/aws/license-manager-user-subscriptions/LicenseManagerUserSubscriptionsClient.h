...
class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API LicenseManagerUserSubscriptionsClient
 ...
 public:
  ...
  LicenseManagerUserSubscriptionsClient(
      const Aws::LicenseManagerUserSubscriptions::LicenseManagerUserSubscriptionsClientConfiguration& clientConfiguration =
  ...
  /**
   * An Async wrapper for AssociateUser that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AssociateUserRequestT = Model::AssociateUserRequest>
  void AssociateUserAsync(const AssociateUserRequestT& request, const AssociateUserResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateLicenseServerEndpointOutcome CreateLicenseServerEndpoint(
      const Model::CreateLicenseServerEndpointRequest& request) const;

  /**
   * A Callable wrapper for CreateLicenseServerEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateLicenseServerEndpointRequestT = Model::CreateLicenseServerEndpointRequest>
  Model::CreateLicenseServerEndpointOutcomeCallable CreateLicenseServerEndpointCallable(
      const CreateLicenseServerEndpointRequestT& request) const {
    return SubmitCallable(&LicenseManagerUserSubscriptionsClient::CreateLicenseServerEndpoint, request);
  }

  /**
   * An Async wrapper for CreateLicenseServerEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateLicenseServerEndpointRequestT = Model::CreateLicenseServerEndpointRequest>
  void CreateLicenseServerEndpointAsync(const CreateLicenseServerEndpointRequestT& request,
                                        const CreateLicenseServerEndpointResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteLicenseServerEndpointOutcome DeleteLicenseServerEndpoint(
      const Model::DeleteLicenseServerEndpointRequest& request) const;

  /**
   * A Callable wrapper for DeleteLicenseServerEndpoint that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteLicenseServerEndpointRequestT = Model::DeleteLicenseServerEndpointRequest>
  Model::DeleteLicenseServerEndpointOutcomeCallable DeleteLicenseServerEndpointCallable(
      const DeleteLicenseServerEndpointRequestT& request) const {
    return SubmitCallable(&LicenseManagerUserSubscriptionsClient::DeleteLicenseServerEndpoint, request);
  }

  /**
   * An Async wrapper for DeleteLicenseServerEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteLicenseServerEndpointRequestT = Model::DeleteLicenseServerEndpointRequest>
  void DeleteLicenseServerEndpointAsync(const DeleteLicenseServerEndpointRequestT& request,
                                        const DeleteLicenseServerEndpointResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeregisterIdentityProviderOutcome DeregisterIdentityProvider(
      const Model::DeregisterIdentityProviderRequest& request = {}) const;

  /**
   * A Callable wrapper for DeregisterIdentityProvider that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeregisterIdentityProviderRequestT = Model::DeregisterIdentityProviderRequest>
  Model::DeregisterIdentityProviderOutcomeCallable DeregisterIdentityProviderCallable(
      const DeregisterIdentityProviderRequestT& request = {}) const {
    return SubmitCallable(&LicenseManagerUserSubscriptionsClient::DeregisterIdentityProvider, request);
  }

  /**
   * An Async wrapper for DeregisterIdentityProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeregisterIdentityProviderRequestT = Model::DeregisterIdentityProviderRequest>
  void DeregisterIdentityProviderAsync(const DeregisterIdentityProviderResponseReceivedHandler& handler,
  ...
  /**
   * A Callable wrapper for DisassociateUser that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateUser that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateUserRequestT = Model::DisassociateUserRequest>
  void DisassociateUserAsync(const DisassociateUserResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DisassociateUserRequestT& request = {}) const {
   ...
   */
  template <typename ListIdentityProvidersRequestT = Model::ListIdentityProvidersRequest>
  void ListIdentityProvidersAsync(const ListIdentityProvidersResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListIdentityProvidersRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListLicenseServerEndpointsOutcome ListLicenseServerEndpoints(
      const Model::ListLicenseServerEndpointsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListLicenseServerEndpoints that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListLicenseServerEndpointsRequestT = Model::ListLicenseServerEndpointsRequest>
  Model::ListLicenseServerEndpointsOutcomeCallable ListLicenseServerEndpointsCallable(
      const ListLicenseServerEndpointsRequestT& request = {}) const {
    return SubmitCallable(&LicenseManagerUserSubscriptionsClient::ListLicenseServerEndpoints, request);
  }

  /**
   * An Async wrapper for ListLicenseServerEndpoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListLicenseServerEndpointsRequestT = Model::ListLicenseServerEndpointsRequest>
  void ListLicenseServerEndpointsAsync(const ListLicenseServerEndpointsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const ListLicenseServerEndpointsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListProductSubscriptions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListProductSubscriptions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListProductSubscriptionsRequestT = Model::ListProductSubscriptionsRequest>
  void ListProductSubscriptionsAsync(const ListProductSubscriptionsRequestT& request,
                                     const ListProductSubscriptionsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListUserAssociations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUserAssociations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListUserAssociationsRequestT = Model::ListUserAssociationsRequest>
  void ListUserAssociationsAsync(const ListUserAssociationsRequestT& request, const ListUserAssociationsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterIdentityProvider that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterIdentityProvider that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RegisterIdentityProviderRequestT = Model::RegisterIdentityProviderRequest>
  void RegisterIdentityProviderAsync(const RegisterIdentityProviderRequestT& request,
                                     const RegisterIdentityProviderResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartProductSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartProductSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartProductSubscriptionRequestT = Model::StartProductSubscriptionRequest>
  void StartProductSubscriptionAsync(const StartProductSubscriptionRequestT& request,
                                     const StartProductSubscriptionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StopProductSubscription that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopProductSubscription that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopProductSubscriptionRequestT = Model::StopProductSubscriptionRequest>
  void StopProductSubscriptionAsync(const StopProductSubscriptionResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const StopProductSubscriptionRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateIdentityProviderSettingsOutcome UpdateIdentityProviderSettings(
      const Model::UpdateIdentityProviderSettingsRequest& request) const;

  /**
   * A Callable wrapper for UpdateIdentityProviderSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateIdentityProviderSettingsRequestT = Model::UpdateIdentityProviderSettingsRequest>
  Model::UpdateIdentityProviderSettingsOutcomeCallable UpdateIdentityProviderSettingsCallable(
      const UpdateIdentityProviderSettingsRequestT& request) const {
    return SubmitCallable(&LicenseManagerUserSubscriptionsClient::UpdateIdentityProviderSettings, request);
  }

  /**
   * An Async wrapper for UpdateIdentityProviderSettings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateIdentityProviderSettingsRequestT = Model::UpdateIdentityProviderSettingsRequest>
  void UpdateIdentityProviderSettingsAsync(const UpdateIdentityProviderSettingsRequestT& request,
                                           const UpdateIdentityProviderSettingsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<LicenseManagerUserSubscriptionsEndpointProviderBase>& accessEndpointProvider();
