...
namespace LicenseManagerUserSubscriptions
{
   ...
   */
  class AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API LicenseManagerUserSubscriptionsClient : Aws::Client::ClientWithAsyncTemplateMethods<LicenseManagerUserSubscriptionsClient>,
    smithy::client::AwsSmithyClientT<Aws::LicenseManagerUserSubscriptions::SERVICE_NAME,
