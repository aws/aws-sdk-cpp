...
class ListProductSubscriptionsResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListProductSubscriptionsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetProductUserSummaries(ProductUserSummariesT&& value) {
    m_productUserSummariesHasBeenSet = true;
    m_productUserSummaries = std::forward<ProductUserSummariesT>(value);
  }
  template <typename ProductUserSummariesT = Aws::Vector<ProductUserSummary>>
  ListProductSubscriptionsResult& WithProductUserSummaries(ProductUserSummariesT&& value) {
    SetProductUserSummaries(std::forward<ProductUserSummariesT>(value));
    return *this;
  }
  template <typename ProductUserSummariesT = ProductUserSummary>
  ListProductSubscriptionsResult& AddProductUserSummaries(ProductUserSummariesT&& value) {
    m_productUserSummariesHasBeenSet = true;
    m_productUserSummaries.emplace_back(std::forward<ProductUserSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListProductSubscriptionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListProductSubscriptionsResult& WithRequestId(RequestIdT&& value) {
