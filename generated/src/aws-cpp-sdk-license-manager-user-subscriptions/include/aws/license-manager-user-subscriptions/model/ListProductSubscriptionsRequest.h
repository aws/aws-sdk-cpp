...
class ListProductSubscriptionsRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename ProductT = Aws::String>
  ListProductSubscriptionsRequest& WithProduct(ProductT&& value) {
  ...
  template <typename IdentityProviderT = IdentityProvider>
  ListProductSubscriptionsRequest& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  inline ListProductSubscriptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListProductSubscriptionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListProductSubscriptionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListProductSubscriptionsRequest& WithNextToken(NextTokenT&& value) {
