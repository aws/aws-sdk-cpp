...
namespace Model
{
  ...
  /**
   */
  class ListTagsForResourceRequest : public LicenseManagerUserSubscriptionsRequest
  {
  public:
    AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListTagsForResourceRequest() = default;
