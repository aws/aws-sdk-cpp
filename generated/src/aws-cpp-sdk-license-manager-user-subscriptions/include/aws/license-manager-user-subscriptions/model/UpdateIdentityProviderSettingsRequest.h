...
class UpdateIdentityProviderSettingsRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename IdentityProviderT = IdentityProvider>
  UpdateIdentityProviderSettingsRequest& WithIdentityProvider(IdentityProviderT&& value) {
   ...
   * | <code>OFFICE_PROFESSIONAL_PLUS</code> | <code>OFFICE_STANDARD</code> |
   * <code>REMOTE_DESKTOP_SERVICES</code> </p>
   */
  ...
  template <typename ProductT = Aws::String>
  UpdateIdentityProviderSettingsRequest& WithProduct(ProductT&& value) {
  ...
  template <typename IdentityProviderArnT = Aws::String>
  UpdateIdentityProviderSettingsRequest& WithIdentityProviderArn(IdentityProviderArnT&& value) {
  ...
  void SetUpdateSettings(UpdateSettingsT&& value) {
    m_updateSettingsHasBeenSet = true;
    m_updateSettings = std::forward<UpdateSettingsT>(value);
  }
  template <typename UpdateSettingsT = UpdateSettings>
  UpdateIdentityProviderSettingsRequest& WithUpdateSettings(UpdateSettingsT&& value) {
    SetUpdateSettings(std::forward<UpdateSettingsT>(value));
    return *this;
  }
  ///@}
 private:
