...
class RdsSalSettings {
 public:
  ...
  void SetRdsSalCredentialsProvider(RdsSalCredentialsProviderT&& value) {
    m_rdsSalCredentialsProviderHasBeenSet = true;
    m_rdsSalCredentialsProvider = std::forward<RdsSalCredentialsProviderT>(value);
  }
  template <typename RdsSalCredentialsProviderT = CredentialsProvider>
  RdsSalSettings& WithRdsSalCredentialsProvider(RdsSalCredentialsProviderT&& value) {
    SetRdsSalCredentialsProvider(std::forward<RdsSalCredentialsProviderT>(value));
    return *this;
  }
  ///@}
 private:
