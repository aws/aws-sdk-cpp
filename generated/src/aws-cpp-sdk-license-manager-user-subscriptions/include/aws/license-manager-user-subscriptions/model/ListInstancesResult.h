...
class ListInstancesResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListInstancesResult& operator=(
  ...
  void SetInstanceSummaries(InstanceSummariesT&& value) {
    m_instanceSummariesHasBeenSet = true;
    m_instanceSummaries = std::forward<InstanceSummariesT>(value);
  }
  template <typename InstanceSummariesT = Aws::Vector<InstanceSummary>>
  ListInstancesResult& WithInstanceSummaries(InstanceSummariesT&& value) {
    SetInstanceSummaries(std::forward<InstanceSummariesT>(value));
    return *this;
  }
  template <typename InstanceSummariesT = InstanceSummary>
  ListInstancesResult& AddInstanceSummaries(InstanceSummariesT&& value) {
    m_instanceSummariesHasBeenSet = true;
    m_instanceSummaries.emplace_back(std::forward<InstanceSummariesT>(value));
    return *this;
  }
  ///@}
