...
class ActiveDirectorySettings {
 public:
  ...
  template <typename DomainNameT = Aws::String>
  ActiveDirectorySettings& WithDomainName(DomainNameT&& value) {
  ...
  void SetDomainIpv4List(DomainIpv4ListT&& value) {
    m_domainIpv4ListHasBeenSet = true;
    m_domainIpv4List = std::forward<DomainIpv4ListT>(value);
  }
  template <typename DomainIpv4ListT = Aws::Vector<Aws::String>>
  ActiveDirectorySettings& WithDomainIpv4List(DomainIpv4ListT&& value) {
    SetDomainIpv4List(std::forward<DomainIpv4ListT>(value));
    return *this;
  }
  template <typename DomainIpv4ListT = Aws::String>
  ActiveDirectorySettings& AddDomainIpv4List(DomainIpv4ListT&& value) {
    m_domainIpv4ListHasBeenSet = true;
    m_domainIpv4List.emplace_back(std::forward<DomainIpv4ListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainIpv6List(DomainIpv6ListT&& value) {
    m_domainIpv6ListHasBeenSet = true;
    m_domainIpv6List = std::forward<DomainIpv6ListT>(value);
  }
  template <typename DomainIpv6ListT = Aws::Vector<Aws::String>>
  ActiveDirectorySettings& WithDomainIpv6List(DomainIpv6ListT&& value) {
    SetDomainIpv6List(std::forward<DomainIpv6ListT>(value));
    return *this;
  }
  template <typename DomainIpv6ListT = Aws::String>
  ActiveDirectorySettings& AddDomainIpv6List(DomainIpv6ListT&& value) {
    m_domainIpv6ListHasBeenSet = true;
    m_domainIpv6List.emplace_back(std::forward<DomainIpv6ListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainCredentialsProvider(DomainCredentialsProviderT&& value) {
    m_domainCredentialsProviderHasBeenSet = true;
    m_domainCredentialsProvider = std::forward<DomainCredentialsProviderT>(value);
  }
  template <typename DomainCredentialsProviderT = CredentialsProvider>
  ActiveDirectorySettings& WithDomainCredentialsProvider(DomainCredentialsProviderT&& value) {
    SetDomainCredentialsProvider(std::forward<DomainCredentialsProviderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDomainNetworkSettings(DomainNetworkSettingsT&& value) {
    m_domainNetworkSettingsHasBeenSet = true;
    m_domainNetworkSettings = std::forward<DomainNetworkSettingsT>(value);
  }
  template <typename DomainNetworkSettingsT = DomainNetworkSettings>
  ActiveDirectorySettings& WithDomainNetworkSettings(DomainNetworkSettingsT&& value) {
    SetDomainNetworkSettings(std::forward<DomainNetworkSettingsT>(value));
    return *this;
  }
  ///@}
 private:
