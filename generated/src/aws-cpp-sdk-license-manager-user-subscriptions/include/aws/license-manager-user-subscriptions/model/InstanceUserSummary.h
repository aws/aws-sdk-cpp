...
class InstanceUserSummary {
 public:
  ...
  template <typename UsernameT = Aws::String>
  InstanceUserSummary& WithUsername(UsernameT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  InstanceUserSummary& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IdentityProviderT = IdentityProvider>
  InstanceUserSummary& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename StatusT = Aws::String>
  InstanceUserSummary& WithStatus(StatusT&& value) {
  ...
  void SetInstanceUserArn(InstanceUserArnT&& value) {
    m_instanceUserArnHasBeenSet = true;
    m_instanceUserArn = std::forward<InstanceUserArnT>(value);
  }
  template <typename InstanceUserArnT = Aws::String>
  InstanceUserSummary& WithInstanceUserArn(InstanceUserArnT&& value) {
    SetInstanceUserArn(std::forward<InstanceUserArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  InstanceUserSummary& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename DomainT = Aws::String>
  InstanceUserSummary& WithDomain(DomainT&& value) {
  ...
  void SetAssociationDate(AssociationDateT&& value) {
    m_associationDateHasBeenSet = true;
    m_associationDate = std::forward<AssociationDateT>(value);
  }
  template <typename AssociationDateT = Aws::String>
  InstanceUserSummary& WithAssociationDate(AssociationDateT&& value) {
    SetAssociationDate(std::forward<AssociationDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisassociationDate(DisassociationDateT&& value) {
    m_disassociationDateHasBeenSet = true;
    m_disassociationDate = std::forward<DisassociationDateT>(value);
  }
  template <typename DisassociationDateT = Aws::String>
  InstanceUserSummary& WithDisassociationDate(DisassociationDateT&& value) {
    SetDisassociationDate(std::forward<DisassociationDateT>(value));
    return *this;
  }
  ///@}
 private:
