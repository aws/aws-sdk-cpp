...
class DeregisterIdentityProviderResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API DeregisterIdentityProviderResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename IdentityProviderSummaryT = IdentityProviderSummary>
  DeregisterIdentityProviderResult& WithIdentityProviderSummary(IdentityProviderSummaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeregisterIdentityProviderResult& WithRequestId(RequestIdT&& value) {
