...
class AssociateUserResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API AssociateUserResult& operator=(
  ...
  template <typename InstanceUserSummaryT = InstanceUserSummary>
  AssociateUserResult& WithInstanceUserSummary(InstanceUserSummaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  AssociateUserResult& WithRequestId(RequestIdT&& value) {
