...
class DisassociateUserRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename UsernameT = Aws::String>
  DisassociateUserRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  DisassociateUserRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IdentityProviderT = IdentityProvider>
  DisassociateUserRequest& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename InstanceUserArnT = Aws::String>
  DisassociateUserRequest& WithInstanceUserArn(InstanceUserArnT&& value) {
  ...
  template <typename DomainT = Aws::String>
  DisassociateUserRequest& WithDomain(DomainT&& value) {
