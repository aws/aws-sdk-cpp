...
class LicenseServerEndpoint {
 public:
  ...
  inline LicenseServerEndpoint& WithServerType(ServerType value) {
    SetServerType(value);
    return *this;
  }
  ///@}
  ...
  void SetLicenseServerEndpointId(LicenseServerEndpointIdT&& value) {
    ...
    m_licenseServerEndpointId = std::forward<LicenseServerEndpointIdT>(value);
  }
  template <typename LicenseServerEndpointIdT = Aws::String>
  LicenseServerEndpoint& WithLicenseServerEndpointId(LicenseServerEndpointIdT&& value) {
    SetLicenseServerEndpointId(std::forward<LicenseServerEndpointIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLicenseServerEndpointArn(LicenseServerEndpointArnT&& value) {
    ...
    m_licenseServerEndpointArn = std::forward<LicenseServerEndpointArnT>(value);
  }
  template <typename LicenseServerEndpointArnT = Aws::String>
  LicenseServerEndpoint& WithLicenseServerEndpointArn(LicenseServerEndpointArnT&& value) {
    SetLicenseServerEndpointArn(std::forward<LicenseServerEndpointArnT>(value));
    return *this;
  }
  ///@}
   ...
   * endpoint</p>
   */
  inline LicenseServerEndpointProvisioningStatus GetLicenseServerEndpointProvisioningStatus() const {
    return m_licenseServerEndpointProvisioningStatus;
  }
  ...
  inline void SetLicenseServerEndpointProvisioningStatus(LicenseServerEndpointProvisioningStatus value) {
    m_licenseServerEndpointProvisioningStatusHasBeenSet = true;
    m_licenseServerEndpointProvisioningStatus = value;
  }
  inline LicenseServerEndpoint& WithLicenseServerEndpointProvisioningStatus(LicenseServerEndpointProvisioningStatus value) {
    SetLicenseServerEndpointProvisioningStatus(value);
    return *this;
  }
  ///@}
