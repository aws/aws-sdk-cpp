...
class StopProductSubscriptionRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename UsernameT = Aws::String>
  StopProductSubscriptionRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename IdentityProviderT = IdentityProvider>
  StopProductSubscriptionRequest& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename ProductT = Aws::String>
  StopProductSubscriptionRequest& WithProduct(ProductT&& value) {
  ...
  void SetProductUserArn(ProductUserArnT&& value) {
    ...
    m_productUserArn = std::forward<ProductUserArnT>(value);
  }
  template <typename ProductUserArnT = Aws::String>
  StopProductSubscriptionRequest& WithProductUserArn(ProductUserArnT&& value) {
    SetProductUserArn(std::forward<ProductUserArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DomainT = Aws::String>
  StopProductSubscriptionRequest& WithDomain(DomainT&& value) {
