...
class ListLicenseServerEndpointsResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListLicenseServerEndpointsResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetLicenseServerEndpoints(LicenseServerEndpointsT&& value) {
    m_licenseServerEndpointsHasBeenSet = true;
    m_licenseServerEndpoints = std::forward<LicenseServerEndpointsT>(value);
  }
  template <typename LicenseServerEndpointsT = Aws::Vector<LicenseServerEndpoint>>
  ListLicenseServerEndpointsResult& WithLicenseServerEndpoints(LicenseServerEndpointsT&& value) {
    SetLicenseServerEndpoints(std::forward<LicenseServerEndpointsT>(value));
    return *this;
  }
  template <typename LicenseServerEndpointsT = LicenseServerEndpoint>
  ListLicenseServerEndpointsResult& AddLicenseServerEndpoints(LicenseServerEndpointsT&& value) {
    m_licenseServerEndpointsHasBeenSet = true;
    m_licenseServerEndpoints.emplace_back(std::forward<LicenseServerEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListLicenseServerEndpointsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListLicenseServerEndpointsResult& WithRequestId(RequestIdT&& value) {
