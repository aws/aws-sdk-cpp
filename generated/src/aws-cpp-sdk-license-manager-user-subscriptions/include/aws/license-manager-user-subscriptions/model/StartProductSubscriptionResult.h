...
class StartProductSubscriptionResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API StartProductSubscriptionResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename ProductUserSummaryT = ProductUserSummary>
  StartProductSubscriptionResult& WithProductUserSummary(ProductUserSummaryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  StartProductSubscriptionResult& WithRequestId(RequestIdT&& value) {
