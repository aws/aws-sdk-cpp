...
class ListIdentityProvidersResult {
 public:
  ...
  AWS_LICENSEMANAGERUSERSUBSCRIPTIONS_API ListIdentityProvidersResult& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  void SetIdentityProviderSummaries(IdentityProviderSummariesT&& value) {
    m_identityProviderSummariesHasBeenSet = true;
    m_identityProviderSummaries = std::forward<IdentityProviderSummariesT>(value);
  }
  template <typename IdentityProviderSummariesT = Aws::Vector<IdentityProviderSummary>>
  ListIdentityProvidersResult& WithIdentityProviderSummaries(IdentityProviderSummariesT&& value) {
    SetIdentityProviderSummaries(std::forward<IdentityProviderSummariesT>(value));
    return *this;
  }
  template <typename IdentityProviderSummariesT = IdentityProviderSummary>
  ListIdentityProvidersResult& AddIdentityProviderSummaries(IdentityProviderSummariesT&& value) {
    m_identityProviderSummariesHasBeenSet = true;
    m_identityProviderSummaries.emplace_back(std::forward<IdentityProviderSummariesT>(value));
    return *this;
  }
  ///@}
