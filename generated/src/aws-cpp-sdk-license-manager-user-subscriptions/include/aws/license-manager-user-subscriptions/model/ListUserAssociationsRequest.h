...
class ListUserAssociationsRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ListUserAssociationsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ListUserAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  ListUserAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  ListUserAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListUserAssociationsRequest& WithNextToken(NextTokenT&& value) {
