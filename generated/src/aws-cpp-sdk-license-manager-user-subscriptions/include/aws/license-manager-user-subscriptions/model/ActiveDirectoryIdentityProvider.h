...
class ActiveDirectoryIdentityProvider {
 public:
  ...
  void SetActiveDirectorySettings(ActiveDirectorySettingsT&& value) {
    ...
    m_activeDirectorySettings = std::forward<ActiveDirectorySettingsT>(value);
  }
  template <typename ActiveDirectorySettingsT = ActiveDirectorySettings>
  ActiveDirectoryIdentityProvider& WithActiveDirectorySettings(ActiveDirectorySettingsT&& value) {
    SetActiveDirectorySettings(std::forward<ActiveDirectorySettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetActiveDirectoryType(ActiveDirectoryType value) {
    m_activeDirectoryTypeHasBeenSet = true;
    m_activeDirectoryType = value;
  }
  inline ActiveDirectoryIdentityProvider& WithActiveDirectoryType(ActiveDirectoryType value) {
    SetActiveDirectoryType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsSharedActiveDirectory(bool value) {
    m_isSharedActiveDirectoryHasBeenSet = true;
    m_isSharedActiveDirectory = value;
  }
  inline ActiveDirectoryIdentityProvider& WithIsSharedActiveDirectory(bool value) {
    SetIsSharedActiveDirectory(value);
    return *this;
  }
  ///@}
 private:
