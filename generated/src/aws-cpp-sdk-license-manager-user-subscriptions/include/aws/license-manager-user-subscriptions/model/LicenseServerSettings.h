...
class LicenseServerSettings {
 public:
  ...
  inline LicenseServerSettings& WithServerType(ServerType value) {
    SetServerType(value);
    return *this;
  }
  ///@}
  ...
  void SetServerSettings(ServerSettingsT&& value) {
    ...
    m_serverSettings = std::forward<ServerSettingsT>(value);
  }
  template <typename ServerSettingsT = ServerSettings>
  LicenseServerSettings& WithServerSettings(ServerSettingsT&& value) {
    SetServerSettings(std::forward<ServerSettingsT>(value));
    return *this;
  }
  ///@}
 private:
