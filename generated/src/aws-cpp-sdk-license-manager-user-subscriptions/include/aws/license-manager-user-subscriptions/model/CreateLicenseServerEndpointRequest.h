...
class CreateLicenseServerEndpointRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename IdentityProviderArnT = Aws::String>
  CreateLicenseServerEndpointRequest& WithIdentityProviderArn(IdentityProviderArnT&& value) {
  ...
  void SetLicenseServerSettings(LicenseServerSettingsT&& value) {
    m_licenseServerSettingsHasBeenSet = true;
    m_licenseServerSettings = std::forward<LicenseServerSettingsT>(value);
  }
  template <typename LicenseServerSettingsT = LicenseServerSettings>
  CreateLicenseServerEndpointRequest& WithLicenseServerSettings(LicenseServerSettingsT&& value) {
    SetLicenseServerSettings(std::forward<LicenseServerSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateLicenseServerEndpointRequest& WithTags(TagsT&& value) {
