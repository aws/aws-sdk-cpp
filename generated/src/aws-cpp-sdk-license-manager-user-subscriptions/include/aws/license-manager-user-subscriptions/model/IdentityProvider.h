...
class IdentityProvider {
 public:
  ...
  void SetActiveDirectoryIdentityProvider(ActiveDirectoryIdentityProviderT&& value) {
    ...
    m_activeDirectoryIdentityProvider = std::forward<ActiveDirectoryIdentityProviderT>(value);
  }
  template <typename ActiveDirectoryIdentityProviderT = ActiveDirectoryIdentityProvider>
  IdentityProvider& WithActiveDirectoryIdentityProvider(ActiveDirectoryIdentityProviderT&& value) {
    SetActiveDirectoryIdentityProvider(std::forward<ActiveDirectoryIdentityProviderT>(value));
    return *this;
  }
  ///@}
 private:
