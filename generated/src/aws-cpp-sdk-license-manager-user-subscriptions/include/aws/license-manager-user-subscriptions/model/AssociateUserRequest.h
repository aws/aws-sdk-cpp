...
class AssociateUserRequest : public LicenseManagerUserSubscriptionsRequest {
 public:
  ...
  template <typename UsernameT = Aws::String>
  AssociateUserRequest& WithUsername(UsernameT&& value) {
  ...
  template <typename InstanceIdT = Aws::String>
  AssociateUserRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename IdentityProviderT = IdentityProvider>
  AssociateUserRequest& WithIdentityProvider(IdentityProviderT&& value) {
  ...
  template <typename DomainT = Aws::String>
  AssociateUserRequest& WithDomain(DomainT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  AssociateUserRequest& WithTags(TagsT&& value) {
