...
class LicenseServer {
 public:
  ...
  inline void SetProvisioningStatus(LicenseServerEndpointProvisioningStatus value) {
    m_provisioningStatusHasBeenSet = true;
    m_provisioningStatus = value;
  }
  inline LicenseServer& WithProvisioningStatus(LicenseServerEndpointProvisioningStatus value) {
  ...
  inline void SetHealthStatus(LicenseServerHealthStatus value) {
    m_healthStatusHasBeenSet = true;
    m_healthStatus = value;
  }
  inline LicenseServer& WithHealthStatus(LicenseServerHealthStatus value) {
  ...
  template <typename Ipv6AddressT = Aws::String>
  LicenseServer& WithIpv6Address(Ipv6AddressT&& value) {
