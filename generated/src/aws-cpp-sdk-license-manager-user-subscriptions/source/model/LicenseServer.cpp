...
LicenseServer::LicenseServer(JsonView jsonValue) { *this = jsonValue; }

LicenseServer& LicenseServer::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("ProvisioningStatus")) {
    m_provisioningStatus = LicenseServerEndpointProvisioningStatusMapper::GetLicenseServerEndpointProvisioningStatusForName(
        jsonValue.GetString("ProvisioningStatus"));
...
JsonValue LicenseServer::Jsonize() const {
  ...
  if (m_provisioningStatusHasBeenSet) {
    payload.WithString(
        "ProvisioningStatus",
        LicenseServerEndpointProvisioningStatusMapper::GetNameForLicenseServerEndpointProvisioningStatus(m_provisioningStatus));
  }
