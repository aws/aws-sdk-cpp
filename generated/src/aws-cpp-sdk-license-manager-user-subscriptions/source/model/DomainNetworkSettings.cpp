...
DomainNetworkSettings::DomainNetworkSettings(JsonView jsonValue) { *this = jsonValue; }

DomainNetworkSettings& DomainNetworkSettings::operator=(JsonView jsonValue) {
...
JsonValue DomainNetworkSettings::Jsonize() const {
  JsonValue payload;
