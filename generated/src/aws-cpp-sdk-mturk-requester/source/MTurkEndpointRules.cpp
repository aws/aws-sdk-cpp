...
namespace MTurk
{
const size_t MTurkEndpointRules::RulesBlobStrLen = 3731;
const size_t MTurkEndpointRules::RulesBlobSize = 3732;
...
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','t','u','r','k','-',
'r','e','q','u','e','s','t','e','r','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{',
...
'"','h','t','t','p','s',':','/','/','m','t','u','r','k','-','r','e','q','u','e','s','t','e','r','-',
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','t','u','r','k','-','r','e','q','u','e',
's','t','e','r','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o','n','R',
...
'"','r','e','f','"',':','"','R','e','g','i','o','n','"','}',',','"','s','a','n','d','b','o','x','"',
']','}',']',',','"','e','n','d','p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t',
't','p','s',':','/','/','m','t','u','r','k','-','r','e','q','u','e','s','t','e','r','-','s','a','n',
'd','b','o','x','.','u','s','-','e','a','s','t','-','1','.','a','m','a','z','o','n','a','w','s','.',
'c','o','m','"',',','"','p','r','o','p','e','r','t','i','e','s','"',':','{','}',',','"','h','e','a',
'd','e','r','s','"',':','{','}','}',',','"','t','y','p','e','"',':','"','e','n','d','p','o','i','n',
't','"','}',',','{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d',
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','m','t',
'u','r','k','-','r','e','q','u','e','s','t','e','r','.','{','R','e','g','i','o','n','}','.','{','P',
...
const char* MTurkEndpointRules::GetRulesBlob()
{
