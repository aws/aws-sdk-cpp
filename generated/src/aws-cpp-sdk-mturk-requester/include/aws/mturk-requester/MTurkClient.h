...
class AWS_MTURK_API MTurkClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  MTurkClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<MTurkEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptQualificationRequestOutcome AcceptQualificationRequest(
      const Model::AcceptQualificationRequestRequest& request) const;

  /**
   * A Callable wrapper for AcceptQualificationRequest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AcceptQualificationRequestRequestT = Model::AcceptQualificationRequestRequest>
  Model::AcceptQualificationRequestOutcomeCallable AcceptQualificationRequestCallable(
      const AcceptQualificationRequestRequestT& request) const {
    return SubmitCallable(&MTurkClient::AcceptQualificationRequest, request);
  }

  /**
   * An Async wrapper for AcceptQualificationRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptQualificationRequestRequestT = Model::AcceptQualificationRequestRequest>
  void AcceptQualificationRequestAsync(const AcceptQualificationRequestRequestT& request,
  ...
  /**
   * A Callable wrapper for ApproveAssignment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ApproveAssignment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ApproveAssignmentRequestT = Model::ApproveAssignmentRequest>
  void ApproveAssignmentAsync(const ApproveAssignmentRequestT& request, const ApproveAssignmentResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateQualificationWithWorkerOutcome AssociateQualificationWithWorker(
      const Model::AssociateQualificationWithWorkerRequest& request) const;

  /**
   * A Callable wrapper for AssociateQualificationWithWorker that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename AssociateQualificationWithWorkerRequestT = Model::AssociateQualificationWithWorkerRequest>
  Model::AssociateQualificationWithWorkerOutcomeCallable AssociateQualificationWithWorkerCallable(
      const AssociateQualificationWithWorkerRequestT& request) const {
    return SubmitCallable(&MTurkClient::AssociateQualificationWithWorker, request);
  }

  /**
   * An Async wrapper for AssociateQualificationWithWorker that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename AssociateQualificationWithWorkerRequestT = Model::AssociateQualificationWithWorkerRequest>
  void AssociateQualificationWithWorkerAsync(const AssociateQualificationWithWorkerRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAdditionalAssignmentsForHITOutcome CreateAdditionalAssignmentsForHIT(
      const Model::CreateAdditionalAssignmentsForHITRequest& request) const;

  /**
   * A Callable wrapper for CreateAdditionalAssignmentsForHIT that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename CreateAdditionalAssignmentsForHITRequestT = Model::CreateAdditionalAssignmentsForHITRequest>
  Model::CreateAdditionalAssignmentsForHITOutcomeCallable CreateAdditionalAssignmentsForHITCallable(
      const CreateAdditionalAssignmentsForHITRequestT& request) const {
    return SubmitCallable(&MTurkClient::CreateAdditionalAssignmentsForHIT, request);
  }

  /**
   * An Async wrapper for CreateAdditionalAssignmentsForHIT that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateAdditionalAssignmentsForHITRequestT = Model::CreateAdditionalAssignmentsForHITRequest>
  void CreateAdditionalAssignmentsForHITAsync(const CreateAdditionalAssignmentsForHITRequestT& request,
  ...
  /**
   * An Async wrapper for CreateHIT that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateHITRequestT = Model::CreateHITRequest>
  void CreateHITAsync(const CreateHITRequestT& request, const CreateHITResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateHITType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateHITTypeRequestT = Model::CreateHITTypeRequest>
  void CreateHITTypeAsync(const CreateHITTypeRequestT& request, const CreateHITTypeResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateHITWithHITType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHITWithHITType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHITWithHITTypeRequestT = Model::CreateHITWithHITTypeRequest>
  void CreateHITWithHITTypeAsync(const CreateHITWithHITTypeRequestT& request, const CreateHITWithHITTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateQualificationType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateQualificationType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateQualificationTypeRequestT = Model::CreateQualificationTypeRequest>
  void CreateQualificationTypeAsync(const CreateQualificationTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateWorkerBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateWorkerBlock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateWorkerBlockRequestT = Model::CreateWorkerBlockRequest>
  void CreateWorkerBlockAsync(const CreateWorkerBlockRequestT& request, const CreateWorkerBlockResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteHIT that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteHITRequestT = Model::DeleteHITRequest>
  void DeleteHITAsync(const DeleteHITRequestT& request, const DeleteHITResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteQualificationType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteQualificationType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteQualificationTypeRequestT = Model::DeleteQualificationTypeRequest>
  void DeleteQualificationTypeAsync(const DeleteQualificationTypeRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteWorkerBlock that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteWorkerBlock that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteWorkerBlockRequestT = Model::DeleteWorkerBlockRequest>
  void DeleteWorkerBlockAsync(const DeleteWorkerBlockRequestT& request, const DeleteWorkerBlockResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateQualificationFromWorkerOutcome DisassociateQualificationFromWorker(
      const Model::DisassociateQualificationFromWorkerRequest& request) const;

  /**
   * A Callable wrapper for DisassociateQualificationFromWorker that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename DisassociateQualificationFromWorkerRequestT = Model::DisassociateQualificationFromWorkerRequest>
  Model::DisassociateQualificationFromWorkerOutcomeCallable DisassociateQualificationFromWorkerCallable(
      const DisassociateQualificationFromWorkerRequestT& request) const {
    return SubmitCallable(&MTurkClient::DisassociateQualificationFromWorker, request);
  }

  /**
   * An Async wrapper for DisassociateQualificationFromWorker that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename DisassociateQualificationFromWorkerRequestT = Model::DisassociateQualificationFromWorkerRequest>
  void DisassociateQualificationFromWorkerAsync(const DisassociateQualificationFromWorkerRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAccountBalance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAccountBalance that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAccountBalanceRequestT = Model::GetAccountBalanceRequest>
  void GetAccountBalanceAsync(const GetAccountBalanceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const GetAccountBalanceRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetAssignment that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAssignmentRequestT = Model::GetAssignmentRequest>
  void GetAssignmentAsync(const GetAssignmentRequestT& request, const GetAssignmentResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFileUploadURL that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFileUploadURL that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFileUploadURLRequestT = Model::GetFileUploadURLRequest>
  void GetFileUploadURLAsync(const GetFileUploadURLRequestT& request, const GetFileUploadURLResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetHIT that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetHITRequestT = Model::GetHITRequest>
  void GetHITAsync(const GetHITRequestT& request, const GetHITResponseReceivedHandler& handler,
                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQualificationScore that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQualificationScore that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQualificationScoreRequestT = Model::GetQualificationScoreRequest>
  void GetQualificationScoreAsync(const GetQualificationScoreRequestT& request, const GetQualificationScoreResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetQualificationType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetQualificationType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetQualificationTypeRequestT = Model::GetQualificationTypeRequest>
  void GetQualificationTypeAsync(const GetQualificationTypeRequestT& request, const GetQualificationTypeResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssignmentsForHIT that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssignmentsForHIT that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssignmentsForHITRequestT = Model::ListAssignmentsForHITRequest>
  void ListAssignmentsForHITAsync(const ListAssignmentsForHITRequestT& request, const ListAssignmentsForHITResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBonusPayments that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBonusPayments that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBonusPaymentsRequestT = Model::ListBonusPaymentsRequest>
  void ListBonusPaymentsAsync(const ListBonusPaymentsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListBonusPaymentsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListHITs that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListHITsRequestT = Model::ListHITsRequest>
  void ListHITsAsync(const ListHITsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListHITsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListHITsForQualificationTypeOutcome ListHITsForQualificationType(
      const Model::ListHITsForQualificationTypeRequest& request) const;

  /**
   * A Callable wrapper for ListHITsForQualificationType that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListHITsForQualificationTypeRequestT = Model::ListHITsForQualificationTypeRequest>
  Model::ListHITsForQualificationTypeOutcomeCallable ListHITsForQualificationTypeCallable(
      const ListHITsForQualificationTypeRequestT& request) const {
    return SubmitCallable(&MTurkClient::ListHITsForQualificationType, request);
  }

  /**
   * An Async wrapper for ListHITsForQualificationType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListHITsForQualificationTypeRequestT = Model::ListHITsForQualificationTypeRequest>
  void ListHITsForQualificationTypeAsync(const ListHITsForQualificationTypeRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListQualificationRequestsOutcome ListQualificationRequests(
      const Model::ListQualificationRequestsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListQualificationRequests that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListQualificationRequestsRequestT = Model::ListQualificationRequestsRequest>
  Model::ListQualificationRequestsOutcomeCallable ListQualificationRequestsCallable(
      const ListQualificationRequestsRequestT& request = {}) const {
    return SubmitCallable(&MTurkClient::ListQualificationRequests, request);
  }

  /**
   * An Async wrapper for ListQualificationRequests that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQualificationRequestsRequestT = Model::ListQualificationRequestsRequest>
  void ListQualificationRequestsAsync(const ListQualificationRequestsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListQualificationRequestsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListQualificationTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListQualificationTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListQualificationTypesRequestT = Model::ListQualificationTypesRequest>
  void ListQualificationTypesAsync(const ListQualificationTypesRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListReviewPolicyResultsForHITOutcome ListReviewPolicyResultsForHIT(
      const Model::ListReviewPolicyResultsForHITRequest& request) const;

  /**
   * A Callable wrapper for ListReviewPolicyResultsForHIT that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListReviewPolicyResultsForHITRequestT = Model::ListReviewPolicyResultsForHITRequest>
  Model::ListReviewPolicyResultsForHITOutcomeCallable ListReviewPolicyResultsForHITCallable(
      const ListReviewPolicyResultsForHITRequestT& request) const {
    return SubmitCallable(&MTurkClient::ListReviewPolicyResultsForHIT, request);
  }

  /**
   * An Async wrapper for ListReviewPolicyResultsForHIT that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListReviewPolicyResultsForHITRequestT = Model::ListReviewPolicyResultsForHITRequest>
  void ListReviewPolicyResultsForHITAsync(const ListReviewPolicyResultsForHITRequestT& request,
  ...
  /**
   * A Callable wrapper for ListReviewableHITs that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListReviewableHITs that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListReviewableHITsRequestT = Model::ListReviewableHITsRequest>
  void ListReviewableHITsAsync(const ListReviewableHITsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListReviewableHITsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListWorkerBlocks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListWorkerBlocks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListWorkerBlocksRequestT = Model::ListWorkerBlocksRequest>
  void ListWorkerBlocksAsync(const ListWorkerBlocksResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListWorkerBlocksRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListWorkersWithQualificationTypeOutcome ListWorkersWithQualificationType(
      const Model::ListWorkersWithQualificationTypeRequest& request) const;

  /**
   * A Callable wrapper for ListWorkersWithQualificationType that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListWorkersWithQualificationTypeRequestT = Model::ListWorkersWithQualificationTypeRequest>
  Model::ListWorkersWithQualificationTypeOutcomeCallable ListWorkersWithQualificationTypeCallable(
      const ListWorkersWithQualificationTypeRequestT& request) const {
    return SubmitCallable(&MTurkClient::ListWorkersWithQualificationType, request);
  }

  /**
   * An Async wrapper for ListWorkersWithQualificationType that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListWorkersWithQualificationTypeRequestT = Model::ListWorkersWithQualificationTypeRequest>
  void ListWorkersWithQualificationTypeAsync(const ListWorkersWithQualificationTypeRequestT& request,
  ...
  /**
   * An Async wrapper for NotifyWorkers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename NotifyWorkersRequestT = Model::NotifyWorkersRequest>
  void NotifyWorkersAsync(const NotifyWorkersRequestT& request, const NotifyWorkersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RejectAssignment that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RejectAssignment that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RejectAssignmentRequestT = Model::RejectAssignmentRequest>
  void RejectAssignmentAsync(const RejectAssignmentRequestT& request, const RejectAssignmentResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RejectQualificationRequestOutcome RejectQualificationRequest(
      const Model::RejectQualificationRequestRequest& request) const;

  /**
   * A Callable wrapper for RejectQualificationRequest that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RejectQualificationRequestRequestT = Model::RejectQualificationRequestRequest>
  Model::RejectQualificationRequestOutcomeCallable RejectQualificationRequestCallable(
      const RejectQualificationRequestRequestT& request) const {
    return SubmitCallable(&MTurkClient::RejectQualificationRequest, request);
  }

  /**
   * An Async wrapper for RejectQualificationRequest that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RejectQualificationRequestRequestT = Model::RejectQualificationRequestRequest>
  void RejectQualificationRequestAsync(const RejectQualificationRequestRequestT& request,
  ...
  /**
   * An Async wrapper for SendBonus that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename SendBonusRequestT = Model::SendBonusRequest>
  void SendBonusAsync(const SendBonusRequestT& request, const SendBonusResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for SendTestEventNotification that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename SendTestEventNotificationRequestT = Model::SendTestEventNotificationRequest>
  Model::SendTestEventNotificationOutcomeCallable SendTestEventNotificationCallable(
      const SendTestEventNotificationRequestT& request) const {
    return SubmitCallable(&MTurkClient::SendTestEventNotification, request);
  }

  /**
   * An Async wrapper for SendTestEventNotification that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SendTestEventNotificationRequestT = Model::SendTestEventNotificationRequest>
  void SendTestEventNotificationAsync(const SendTestEventNotificationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateExpirationForHIT that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateExpirationForHIT that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateExpirationForHITRequestT = Model::UpdateExpirationForHITRequest>
  void UpdateExpirationForHITAsync(const UpdateExpirationForHITRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateHITReviewStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHITReviewStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateHITReviewStatusRequestT = Model::UpdateHITReviewStatusRequest>
  void UpdateHITReviewStatusAsync(const UpdateHITReviewStatusRequestT& request, const UpdateHITReviewStatusResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateHITTypeOfHIT that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateHITTypeOfHIT that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateHITTypeOfHITRequestT = Model::UpdateHITTypeOfHITRequest>
  void UpdateHITTypeOfHITAsync(const UpdateHITTypeOfHITRequestT& request, const UpdateHITTypeOfHITResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateNotificationSettingsOutcome UpdateNotificationSettings(
      const Model::UpdateNotificationSettingsRequest& request) const;

  /**
   * A Callable wrapper for UpdateNotificationSettings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateNotificationSettingsRequestT = Model::UpdateNotificationSettingsRequest>
  Model::UpdateNotificationSettingsOutcomeCallable UpdateNotificationSettingsCallable(
      const UpdateNotificationSettingsRequestT& request) const {
    return SubmitCallable(&MTurkClient::UpdateNotificationSettings, request);
  }

  /**
   * An Async wrapper for UpdateNotificationSettings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateNotificationSettingsRequestT = Model::UpdateNotificationSettingsRequest>
  void UpdateNotificationSettingsAsync(const UpdateNotificationSettingsRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateQualificationType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateQualificationType that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateQualificationTypeRequestT = Model::UpdateQualificationTypeRequest>
  void UpdateQualificationTypeAsync(const UpdateQualificationTypeRequestT& request,
