...
class ListReviewPolicyResultsForHITResult {
 public:
  ...
  template <typename HITIdT = Aws::String>
  ListReviewPolicyResultsForHITResult& WithHITId(HITIdT&& value) {
  ...
  template <typename AssignmentReviewPolicyT = ReviewPolicy>
  ListReviewPolicyResultsForHITResult& WithAssignmentReviewPolicy(AssignmentReviewPolicyT&& value) {
  ...
  template <typename HITReviewPolicyT = ReviewPolicy>
  ListReviewPolicyResultsForHITResult& WithHITReviewPolicy(HITReviewPolicyT&& value) {
  ...
  void SetAssignmentReviewReport(AssignmentReviewReportT&& value) {
    m_assignmentReviewReportHasBeenSet = true;
    m_assignmentReviewReport = std::forward<AssignmentReviewReportT>(value);
  }
  template <typename AssignmentReviewReportT = ReviewReport>
  ListReviewPolicyResultsForHITResult& WithAssignmentReviewReport(AssignmentReviewReportT&& value) {
    SetAssignmentReviewReport(std::forward<AssignmentReviewReportT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHITReviewReport(HITReviewReportT&& value) {
    m_hITReviewReportHasBeenSet = true;
    m_hITReviewReport = std::forward<HITReviewReportT>(value);
  }
  template <typename HITReviewReportT = ReviewReport>
  ListReviewPolicyResultsForHITResult& WithHITReviewReport(HITReviewReportT&& value) {
    SetHITReviewReport(std::forward<HITReviewReportT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReviewPolicyResultsForHITResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListReviewPolicyResultsForHITResult& WithRequestId(RequestIdT&& value) {
