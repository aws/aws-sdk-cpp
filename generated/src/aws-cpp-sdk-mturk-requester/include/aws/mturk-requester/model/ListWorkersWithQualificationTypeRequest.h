...
class ListWorkersWithQualificationTypeRequest : public MTurkRequest {
 public:
  ...
  template <typename QualificationTypeIdT = Aws::String>
  ListWorkersWithQualificationTypeRequest& WithQualificationTypeId(QualificationTypeIdT&& value) {
  ...
  inline void SetStatus(QualificationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListWorkersWithQualificationTypeRequest& WithStatus(QualificationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkersWithQualificationTypeRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkersWithQualificationTypeRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
