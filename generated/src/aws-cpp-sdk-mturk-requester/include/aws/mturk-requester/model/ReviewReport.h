...
class ReviewReport {
 public:
  ...
  void SetReviewResults(ReviewResultsT&& value) {
    ...
    m_reviewResults = std::forward<ReviewResultsT>(value);
  }
  template <typename ReviewResultsT = Aws::Vector<ReviewResultDetail>>
  ReviewReport& WithReviewResults(ReviewResultsT&& value) {
    SetReviewResults(std::forward<ReviewResultsT>(value));
    return *this;
  }
  template <typename ReviewResultsT = ReviewResultDetail>
  ReviewReport& AddReviewResults(ReviewResultsT&& value) {
    m_reviewResultsHasBeenSet = true;
    m_reviewResults.emplace_back(std::forward<ReviewResultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReviewActions(ReviewActionsT&& value) {
    ...
    m_reviewActions = std::forward<ReviewActionsT>(value);
  }
  template <typename ReviewActionsT = Aws::Vector<ReviewActionDetail>>
  ReviewReport& WithReviewActions(ReviewActionsT&& value) {
    SetReviewActions(std::forward<ReviewActionsT>(value));
    return *this;
  }
  template <typename ReviewActionsT = ReviewActionDetail>
  ReviewReport& AddReviewActions(ReviewActionsT&& value) {
    m_reviewActionsHasBeenSet = true;
    m_reviewActions.emplace_back(std::forward<ReviewActionsT>(value));
    return *this;
  }
  ///@}
 private:
