...
class ListReviewableHITsRequest : public MTurkRequest {
 public:
  ...
  template <typename HITTypeIdT = Aws::String>
  ListReviewableHITsRequest& WithHITTypeId(HITTypeIdT&& value) {
  ...
  inline void SetStatus(ReviewableHITStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListReviewableHITsRequest& WithStatus(ReviewableHITStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListReviewableHITsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReviewableHITsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
