...
class BonusPayment {
 public:
  ...
  template <typename WorkerIdT = Aws::String>
  BonusPayment& WithWorkerId(WorkerIdT&& value) {
  ...
  template <typename BonusAmountT = Aws::String>
  BonusPayment& WithBonusAmount(BonusAmountT&& value) {
  ...
  template <typename AssignmentIdT = Aws::String>
  BonusPayment& WithAssignmentId(AssignmentIdT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  BonusPayment& WithReason(ReasonT&& value) {
  ...
  void SetGrantTime(GrantTimeT&& value) {
    ...
    m_grantTime = std::forward<GrantTimeT>(value);
  }
  template <typename GrantTimeT = Aws::Utils::DateTime>
  BonusPayment& WithGrantTime(GrantTimeT&& value) {
    SetGrantTime(std::forward<GrantTimeT>(value));
    return *this;
  }
  ///@}
 private:
