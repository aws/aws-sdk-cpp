...
class GetAccountBalanceResult {
 public:
  ...
  void SetAvailableBalance(AvailableBalanceT&& value) {
    m_availableBalanceHasBeenSet = true;
    m_availableBalance = std::forward<AvailableBalanceT>(value);
  }
  template <typename AvailableBalanceT = Aws::String>
  GetAccountBalanceResult& WithAvailableBalance(AvailableBalanceT&& value) {
    SetAvailableBalance(std::forward<AvailableBalanceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnHoldBalance(OnHoldBalanceT&& value) {
    m_onHoldBalanceHasBeenSet = true;
    m_onHoldBalance = std::forward<OnHoldBalanceT>(value);
  }
  template <typename OnHoldBalanceT = Aws::String>
  GetAccountBalanceResult& WithOnHoldBalance(OnHoldBalanceT&& value) {
    SetOnHoldBalance(std::forward<OnHoldBalanceT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetAccountBalanceResult& WithRequestId(RequestIdT&& value) {
