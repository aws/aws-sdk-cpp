...
class QualificationRequirement {
 public:
  ...
  inline QualificationRequirement& WithComparator(Comparator value) {
    SetComparator(value);
    return *this;
  }
  ///@}
  ...
  void SetIntegerValues(IntegerValuesT&& value) {
    ...
    m_integerValues = std::forward<IntegerValuesT>(value);
  }
  template <typename IntegerValuesT = Aws::Vector<int>>
  QualificationRequirement& WithIntegerValues(IntegerValuesT&& value) {
    SetIntegerValues(std::forward<IntegerValuesT>(value));
    return *this;
  }
  inline QualificationRequirement& AddIntegerValues(int value) {
    m_integerValuesHasBeenSet = true;
  ...
  void SetLocaleValues(LocaleValuesT&& value) {
    m_localeValuesHasBeenSet = true;
    m_localeValues = std::forward<LocaleValuesT>(value);
  }
  template <typename LocaleValuesT = Aws::Vector<Locale>>
  QualificationRequirement& WithLocaleValues(LocaleValuesT&& value) {
    SetLocaleValues(std::forward<LocaleValuesT>(value));
    return *this;
  }
  template <typename LocaleValuesT = Locale>
  QualificationRequirement& AddLocaleValues(LocaleValuesT&& value) {
    m_localeValuesHasBeenSet = true;
    m_localeValues.emplace_back(std::forward<LocaleValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetActionsGuarded(HITAccessActions value) {
    m_actionsGuardedHasBeenSet = true;
    m_actionsGuarded = value;
  }
  inline QualificationRequirement& WithActionsGuarded(HITAccessActions value) {
    SetActionsGuarded(value);
    return *this;
  }
  ///@}
 private:
