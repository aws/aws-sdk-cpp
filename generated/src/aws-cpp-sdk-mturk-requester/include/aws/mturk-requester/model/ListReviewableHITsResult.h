...
class ListReviewableHITsResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListReviewableHITsResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListReviewableHITsResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename HITsT = Aws::Vector<HIT>>
  ListReviewableHITsResult& WithHITs(HITsT&& value) {
    SetHITs(std::forward<HITsT>(value));
    return *this;
  }
  template <typename HITsT = HIT>
  ListReviewableHITsResult& AddHITs(HITsT&& value) {
    m_hITsHasBeenSet = true;
    m_hITs.emplace_back(std::forward<HITsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListReviewableHITsResult& WithRequestId(RequestIdT&& value) {
