...
namespace Model
{
  ...
  public:
    ...
    inline DisassociateQualificationFromWorkerResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline DisassociateQualificationFromWorkerResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline DisassociateQualificationFromWorkerResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
