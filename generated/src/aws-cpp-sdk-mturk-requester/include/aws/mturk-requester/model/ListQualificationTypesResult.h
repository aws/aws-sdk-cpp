...
class ListQualificationTypesResult {
 public:
  ...
  inline ListQualificationTypesResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQualificationTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetQualificationTypes(QualificationTypesT&& value) {
    m_qualificationTypesHasBeenSet = true;
    m_qualificationTypes = std::forward<QualificationTypesT>(value);
  }
  template <typename QualificationTypesT = Aws::Vector<QualificationType>>
  ListQualificationTypesResult& WithQualificationTypes(QualificationTypesT&& value) {
    SetQualificationTypes(std::forward<QualificationTypesT>(value));
    return *this;
  }
  template <typename QualificationTypesT = QualificationType>
  ListQualificationTypesResult& AddQualificationTypes(QualificationTypesT&& value) {
    m_qualificationTypesHasBeenSet = true;
    m_qualificationTypes.emplace_back(std::forward<QualificationTypesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListQualificationTypesResult& WithRequestId(RequestIdT&& value) {
