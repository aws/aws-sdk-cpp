...
namespace Model
{
  ...
  {
  public:
    AWS_MTURK_API CreateAdditionalAssignmentsForHITResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateAdditionalAssignmentsForHITResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
