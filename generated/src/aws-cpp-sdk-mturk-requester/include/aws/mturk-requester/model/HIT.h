...
class HIT {
 public:
  ...
  void SetHITId(HITIdT&& value) {
    ...
    m_hITId = std::forward<HITIdT>(value);
  }
  template <typename HITIdT = Aws::String>
  HIT& WithHITId(HITIdT&& value) {
    SetHITId(std::forward<HITIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHITGroupId(HITGroupIdT&& value) {
    ...
    m_hITGroupId = std::forward<HITGroupIdT>(value);
  }
  template <typename HITGroupIdT = Aws::String>
  HIT& WithHITGroupId(HITGroupIdT&& value) {
    SetHITGroupId(std::forward<HITGroupIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHITLayoutId(HITLayoutIdT&& value) {
    ...
    m_hITLayoutId = std::forward<HITLayoutIdT>(value);
  }
  template <typename HITLayoutIdT = Aws::String>
  HIT& WithHITLayoutId(HITLayoutIdT&& value) {
    SetHITLayoutId(std::forward<HITLayoutIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQuestion(QuestionT&& value) {
    ...
    m_question = std::forward<QuestionT>(value);
  }
  template <typename QuestionT = Aws::String>
  HIT& WithQuestion(QuestionT&& value) {
    SetQuestion(std::forward<QuestionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHITStatus(HITStatus value) {
    m_hITStatusHasBeenSet = true;
    m_hITStatus = value;
  }
  inline HIT& WithHITStatus(HITStatus value) {
    SetHITStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxAssignments(int value) {
    m_maxAssignmentsHasBeenSet = true;
    m_maxAssignments = value;
  }
  inline HIT& WithMaxAssignments(int value) {
    SetMaxAssignments(value);
    return *this;
  }
  ///@}
  ...
  void SetReward(RewardT&& value) {
    ...
    m_reward = std::forward<RewardT>(value);
  }
  template <typename RewardT = Aws::String>
  HIT& WithReward(RewardT&& value) {
    SetReward(std::forward<RewardT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAutoApprovalDelayInSeconds(long long value) {
    m_autoApprovalDelayInSecondsHasBeenSet = true;
    m_autoApprovalDelayInSeconds = value;
  }
  inline HIT& WithAutoApprovalDelayInSeconds(long long value) {
    SetAutoApprovalDelayInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAssignmentDurationInSeconds(long long value) {
    m_assignmentDurationInSecondsHasBeenSet = true;
    m_assignmentDurationInSeconds = value;
  }
  inline HIT& WithAssignmentDurationInSeconds(long long value) {
    SetAssignmentDurationInSeconds(value);
    return *this;
  }
  ///@}
  ...
  void SetRequesterAnnotation(RequesterAnnotationT&& value) {
    ...
    m_requesterAnnotation = std::forward<RequesterAnnotationT>(value);
  }
  template <typename RequesterAnnotationT = Aws::String>
  HIT& WithRequesterAnnotation(RequesterAnnotationT&& value) {
    SetRequesterAnnotation(std::forward<RequesterAnnotationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQualificationRequirements(QualificationRequirementsT&& value) {
    ...
    m_qualificationRequirements = std::forward<QualificationRequirementsT>(value);
  }
  template <typename QualificationRequirementsT = Aws::Vector<QualificationRequirement>>
  HIT& WithQualificationRequirements(QualificationRequirementsT&& value) {
    SetQualificationRequirements(std::forward<QualificationRequirementsT>(value));
    return *this;
  }
  ...
  HIT& AddQualificationRequirements(QualificationRequirementsT&& value) {
    m_qualificationRequirementsHasBeenSet = true;
    m_qualificationRequirements.emplace_back(std::forward<QualificationRequirementsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHITReviewStatus(HITReviewStatus value) {
    m_hITReviewStatusHasBeenSet = true;
    m_hITReviewStatus = value;
  }
  inline HIT& WithHITReviewStatus(HITReviewStatus value) {
    SetHITReviewStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfAssignmentsPending(int value) {
    m_numberOfAssignmentsPendingHasBeenSet = true;
    m_numberOfAssignmentsPending = value;
  }
  inline HIT& WithNumberOfAssignmentsPending(int value) {
    SetNumberOfAssignmentsPending(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfAssignmentsAvailable(int value) {
    m_numberOfAssignmentsAvailableHasBeenSet = true;
    m_numberOfAssignmentsAvailable = value;
  }
  inline HIT& WithNumberOfAssignmentsAvailable(int value) {
    SetNumberOfAssignmentsAvailable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfAssignmentsCompleted(int value) {
    m_numberOfAssignmentsCompletedHasBeenSet = true;
    m_numberOfAssignmentsCompleted = value;
  }
  inline HIT& WithNumberOfAssignmentsCompleted(int value) {
    SetNumberOfAssignmentsCompleted(value);
    return *this;
  }
  ///@}
 private:
