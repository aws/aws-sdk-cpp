...
class ListWorkersWithQualificationTypeResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListWorkersWithQualificationTypeResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListWorkersWithQualificationTypeResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  void SetQualifications(QualificationsT&& value) {
    m_qualificationsHasBeenSet = true;
    m_qualifications = std::forward<QualificationsT>(value);
  }
  template <typename QualificationsT = Aws::Vector<Qualification>>
  ListWorkersWithQualificationTypeResult& WithQualifications(QualificationsT&& value) {
    SetQualifications(std::forward<QualificationsT>(value));
    return *this;
  }
  template <typename QualificationsT = Qualification>
  ListWorkersWithQualificationTypeResult& AddQualifications(QualificationsT&& value) {
    m_qualificationsHasBeenSet = true;
    m_qualifications.emplace_back(std::forward<QualificationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListWorkersWithQualificationTypeResult& WithRequestId(RequestIdT&& value) {
