...
namespace Model
{
  ...
  {
  public:
    AWS_MTURK_API CreateWorkerBlockResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    CreateWorkerBlockResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
