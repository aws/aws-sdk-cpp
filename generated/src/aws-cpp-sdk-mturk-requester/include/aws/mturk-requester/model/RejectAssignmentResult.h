...
namespace Model
{
  ...
  {
  public:
    AWS_MTURK_API RejectAssignmentResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    RejectAssignmentResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
