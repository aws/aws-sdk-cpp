...
class DisassociateQualificationFromWorkerRequest : public MTurkRequest {
 public:
  ...
  template <typename WorkerIdT = Aws::String>
  DisassociateQualificationFromWorkerRequest& WithWorkerId(WorkerIdT&& value) {
  ...
  template <typename QualificationTypeIdT = Aws::String>
  DisassociateQualificationFromWorkerRequest& WithQualificationTypeId(QualificationTypeIdT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  DisassociateQualificationFromWorkerRequest& WithReason(ReasonT&& value) {
