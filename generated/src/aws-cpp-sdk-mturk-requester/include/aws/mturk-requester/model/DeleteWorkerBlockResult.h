...
namespace Model
{
  ...
  {
  public:
    AWS_MTURK_API DeleteWorkerBlockResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteWorkerBlockResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
