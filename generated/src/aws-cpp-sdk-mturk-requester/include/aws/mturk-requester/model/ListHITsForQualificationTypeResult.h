...
class ListHITsForQualificationTypeResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListHITsForQualificationTypeResult& WithNextToken(NextTokenT&& value) {
  ...
  inline ListHITsForQualificationTypeResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename HITsT = Aws::Vector<HIT>>
  ListHITsForQualificationTypeResult& WithHITs(HITsT&& value) {
    SetHITs(std::forward<HITsT>(value));
    return *this;
  }
  template <typename HITsT = HIT>
  ListHITsForQualificationTypeResult& AddHITs(HITsT&& value) {
    m_hITsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListHITsForQualificationTypeResult& WithRequestId(RequestIdT&& value) {
