...
class NotifyWorkersResult {
 public:
  ...
  void SetNotifyWorkersFailureStatuses(NotifyWorkersFailureStatusesT&& value) {
    m_notifyWorkersFailureStatusesHasBeenSet = true;
    m_notifyWorkersFailureStatuses = std::forward<NotifyWorkersFailureStatusesT>(value);
  }
  template <typename NotifyWorkersFailureStatusesT = Aws::Vector<NotifyWorkersFailureStatus>>
  NotifyWorkersResult& WithNotifyWorkersFailureStatuses(NotifyWorkersFailureStatusesT&& value) {
    SetNotifyWorkersFailureStatuses(std::forward<NotifyWorkersFailureStatusesT>(value));
    return *this;
  }
  template <typename NotifyWorkersFailureStatusesT = NotifyWorkersFailureStatus>
  NotifyWorkersResult& AddNotifyWorkersFailureStatuses(NotifyWorkersFailureStatusesT&& value) {
    m_notifyWorkersFailureStatusesHasBeenSet = true;
    m_notifyWorkersFailureStatuses.emplace_back(std::forward<NotifyWorkersFailureStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  NotifyWorkersResult& WithRequestId(RequestIdT&& value) {
