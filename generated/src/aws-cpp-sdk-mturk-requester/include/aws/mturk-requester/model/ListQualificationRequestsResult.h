...
class ListQualificationRequestsResult {
 public:
  ...
  inline ListQualificationRequestsResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQualificationRequestsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetQualificationRequests(QualificationRequestsT&& value) {
    m_qualificationRequestsHasBeenSet = true;
    m_qualificationRequests = std::forward<QualificationRequestsT>(value);
  }
  template <typename QualificationRequestsT = Aws::Vector<QualificationRequest>>
  ListQualificationRequestsResult& WithQualificationRequests(QualificationRequestsT&& value) {
    SetQualificationRequests(std::forward<QualificationRequestsT>(value));
    return *this;
  }
  template <typename QualificationRequestsT = QualificationRequest>
  ListQualificationRequestsResult& AddQualificationRequests(QualificationRequestsT&& value) {
    m_qualificationRequestsHasBeenSet = true;
    m_qualificationRequests.emplace_back(std::forward<QualificationRequestsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListQualificationRequestsResult& WithRequestId(RequestIdT&& value) {
