...
class NotifyWorkersFailureStatus {
 public:
  ...
  inline void SetNotifyWorkersFailureCode(NotifyWorkersFailureCode value) {
    m_notifyWorkersFailureCodeHasBeenSet = true;
    m_notifyWorkersFailureCode = value;
  }
  inline NotifyWorkersFailureStatus& WithNotifyWorkersFailureCode(NotifyWorkersFailureCode value) {
    SetNotifyWorkersFailureCode(value);
    return *this;
  }
  ///@}
  ...
  void SetNotifyWorkersFailureMessage(NotifyWorkersFailureMessageT&& value) {
    ...
    m_notifyWorkersFailureMessage = std::forward<NotifyWorkersFailureMessageT>(value);
  }
  template <typename NotifyWorkersFailureMessageT = Aws::String>
  NotifyWorkersFailureStatus& WithNotifyWorkersFailureMessage(NotifyWorkersFailureMessageT&& value) {
    SetNotifyWorkersFailureMessage(std::forward<NotifyWorkersFailureMessageT>(value));
    return *this;
  }
  ///@}
