...
class UpdateQualificationTypeRequest : public MTurkRequest {
 public:
  ...
  template <typename QualificationTypeIdT = Aws::String>
  UpdateQualificationTypeRequest& WithQualificationTypeId(QualificationTypeIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateQualificationTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  inline UpdateQualificationTypeRequest& WithQualificationTypeStatus(QualificationTypeStatus value) {
  ...
  template <typename TestT = Aws::String>
  UpdateQualificationTypeRequest& WithTest(TestT&& value) {
  ...
  template <typename AnswerKeyT = Aws::String>
  UpdateQualificationTypeRequest& WithAnswerKey(AnswerKeyT&& value) {
  ...
  inline UpdateQualificationTypeRequest& WithTestDurationInSeconds(long long value) {
  ...
  inline UpdateQualificationTypeRequest& WithRetryDelayInSeconds(long long value) {
  ...
  inline UpdateQualificationTypeRequest& WithAutoGranted(bool value) {
  ...
  inline UpdateQualificationTypeRequest& WithAutoGrantedValue(int value) {
