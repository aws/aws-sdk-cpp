...
class GetFileUploadURLRequest : public MTurkRequest {
 public:
  ...
  template <typename AssignmentIdT = Aws::String>
  GetFileUploadURLRequest& WithAssignmentId(AssignmentIdT&& value) {
  ...
  void SetQuestionIdentifier(QuestionIdentifierT&& value) {
    m_questionIdentifierHasBeenSet = true;
    m_questionIdentifier = std::forward<QuestionIdentifierT>(value);
  }
  template <typename QuestionIdentifierT = Aws::String>
  GetFileUploadURLRequest& WithQuestionIdentifier(QuestionIdentifierT&& value) {
    SetQuestionIdentifier(std::forward<QuestionIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
