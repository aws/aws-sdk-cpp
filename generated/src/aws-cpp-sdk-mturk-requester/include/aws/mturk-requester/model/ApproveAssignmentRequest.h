...
class ApproveAssignmentRequest : public MTurkRequest {
 public:
  ...
  inline void SetOverrideRejection(bool value) {
    m_overrideRejectionHasBeenSet = true;
    m_overrideRejection = value;
  }
  inline ApproveAssignmentRequest& WithOverrideRejection(bool value) {
    SetOverrideRejection(value);
    return *this;
  }
  ///@}
 private:
