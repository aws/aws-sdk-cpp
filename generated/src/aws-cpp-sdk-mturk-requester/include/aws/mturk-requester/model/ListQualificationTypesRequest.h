...
class ListQualificationTypesRequest : public MTurkRequest {
 public:
  ...
  template <typename QueryT = Aws::String>
  ListQualificationTypesRequest& WithQuery(QueryT&& value) {
  ...
  inline void SetMustBeRequestable(bool value) {
    m_mustBeRequestableHasBeenSet = true;
    m_mustBeRequestable = value;
  }
  inline ListQualificationTypesRequest& WithMustBeRequestable(bool value) {
    SetMustBeRequestable(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMustBeOwnedByCaller(bool value) {
    m_mustBeOwnedByCallerHasBeenSet = true;
    m_mustBeOwnedByCaller = value;
  }
  inline ListQualificationTypesRequest& WithMustBeOwnedByCaller(bool value) {
    SetMustBeOwnedByCaller(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListQualificationTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQualificationTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
