...
class ListBonusPaymentsResult {
 public:
  ...
  inline ListBonusPaymentsResult& WithNumResults(int value) {
    SetNumResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBonusPaymentsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetBonusPayments(BonusPaymentsT&& value) {
    m_bonusPaymentsHasBeenSet = true;
    m_bonusPayments = std::forward<BonusPaymentsT>(value);
  }
  template <typename BonusPaymentsT = Aws::Vector<BonusPayment>>
  ListBonusPaymentsResult& WithBonusPayments(BonusPaymentsT&& value) {
    SetBonusPayments(std::forward<BonusPaymentsT>(value));
    return *this;
  }
  template <typename BonusPaymentsT = BonusPayment>
  ListBonusPaymentsResult& AddBonusPayments(BonusPaymentsT&& value) {
    m_bonusPaymentsHasBeenSet = true;
    m_bonusPayments.emplace_back(std::forward<BonusPaymentsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBonusPaymentsResult& WithRequestId(RequestIdT&& value) {
