...
class UpdateHITReviewStatusRequest : public MTurkRequest {
 public:
  ...
  template <typename HITIdT = Aws::String>
  UpdateHITReviewStatusRequest& WithHITId(HITIdT&& value) {
  ...
  inline void SetRevert(bool value) {
    m_revertHasBeenSet = true;
    m_revert = value;
  }
  inline UpdateHITReviewStatusRequest& WithRevert(bool value) {
    SetRevert(value);
    return *this;
  }
  ///@}
