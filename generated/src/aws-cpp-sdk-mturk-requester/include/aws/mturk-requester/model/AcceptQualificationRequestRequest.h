...
class AcceptQualificationRequestRequest : public MTurkRequest {
 public:
  ...
  template <typename QualificationRequestIdT = Aws::String>
  AcceptQualificationRequestRequest& WithQualificationRequestId(QualificationRequestIdT&& value) {
  ...
  inline AcceptQualificationRequestRequest& WithIntegerValue(int value) {
