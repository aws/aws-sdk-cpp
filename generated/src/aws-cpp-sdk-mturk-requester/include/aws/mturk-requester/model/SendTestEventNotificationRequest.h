...
class SendTestEventNotificationRequest : public MTurkRequest {
 public:
  ...
  inline void SetTestEventType(EventType value) {
    m_testEventTypeHasBeenSet = true;
    m_testEventType = value;
  }
  inline SendTestEventNotificationRequest& WithTestEventType(EventType value) {
    SetTestEventType(value);
    return *this;
  }
  ///@}
 private:
