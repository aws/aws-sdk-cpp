...
class CreateQualificationTypeRequest : public MTurkRequest {
 public:
  ...
  template <typename NameT = Aws::String>
  CreateQualificationTypeRequest& WithName(NameT&& value) {
  ...
  template <typename KeywordsT = Aws::String>
  CreateQualificationTypeRequest& WithKeywords(KeywordsT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateQualificationTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  inline CreateQualificationTypeRequest& WithQualificationTypeStatus(QualificationTypeStatus value) {
  ...
  inline CreateQualificationTypeRequest& WithRetryDelayInSeconds(long long value) {
  ...
  template <typename TestT = Aws::String>
  CreateQualificationTypeRequest& WithTest(TestT&& value) {
  ...
  template <typename AnswerKeyT = Aws::String>
  CreateQualificationTypeRequest& WithAnswerKey(AnswerKeyT&& value) {
  ...
  inline CreateQualificationTypeRequest& WithTestDurationInSeconds(long long value) {
  ...
  inline CreateQualificationTypeRequest& WithAutoGranted(bool value) {
  ...
  inline CreateQualificationTypeRequest& WithAutoGrantedValue(int value) {
