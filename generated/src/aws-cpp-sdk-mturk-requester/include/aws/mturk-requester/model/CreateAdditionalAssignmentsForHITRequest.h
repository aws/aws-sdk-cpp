...
class CreateAdditionalAssignmentsForHITRequest : public MTurkRequest {
 public:
  ...
  template <typename HITIdT = Aws::String>
  CreateAdditionalAssignmentsForHITRequest& WithHITId(HITIdT&& value) {
  ...
  inline void SetNumberOfAdditionalAssignments(int value) {
    m_numberOfAdditionalAssignmentsHasBeenSet = true;
    m_numberOfAdditionalAssignments = value;
  }
  inline CreateAdditionalAssignmentsForHITRequest& WithNumberOfAdditionalAssignments(int value) {
    SetNumberOfAdditionalAssignments(value);
    return *this;
  }
  ///@}
  ...
  template <typename UniqueRequestTokenT = Aws::String>
  CreateAdditionalAssignmentsForHITRequest& WithUniqueRequestToken(UniqueRequestTokenT&& value) {
