...
class ListQualificationRequestsRequest : public MTurkRequest {
 public:
  ...
  template <typename QualificationTypeIdT = Aws::String>
  ListQualificationRequestsRequest& WithQualificationTypeId(QualificationTypeIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListQualificationRequestsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListQualificationRequestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
