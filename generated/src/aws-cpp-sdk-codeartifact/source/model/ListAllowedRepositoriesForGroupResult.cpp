...
ListAllowedRepositoriesForGroupResult& ListAllowedRepositoriesForGroupResult::operator=(
  ...
  if (jsonValue.ValueExists("allowedRepositories")) {
    ...
    for (unsigned allowedRepositoriesIndex = 0; allowedRepositoriesIndex < allowedRepositoriesJsonList.GetLength();
         ++allowedRepositoriesIndex) {
