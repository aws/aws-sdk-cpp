...
ListAssociatedPackagesResult::ListAssociatedPackagesResult()
{
}

ListAssociatedPackagesResult::ListAssociatedPackagesResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListAssociatedPackagesResult& ListAssociatedPackagesResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
