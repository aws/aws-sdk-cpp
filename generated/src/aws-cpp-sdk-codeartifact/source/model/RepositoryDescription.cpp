...
RepositoryDescription::RepositoryDescription(JsonView jsonValue) { *this = jsonValue; }
...
RepositoryDescription& RepositoryDescription::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("externalConnections")) {
    ...
    for (unsigned externalConnectionsIndex = 0; externalConnectionsIndex < externalConnectionsJsonList.GetLength();
         ++externalConnectionsIndex) {
