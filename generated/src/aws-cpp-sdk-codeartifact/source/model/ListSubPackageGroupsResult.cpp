...
ListSubPackageGroupsResult::ListSubPackageGroupsResult()
{
}

ListSubPackageGroupsResult::ListSubPackageGroupsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
