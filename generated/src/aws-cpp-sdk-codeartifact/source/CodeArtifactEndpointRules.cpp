...
{
const size_t CodeArtifactEndpointRules::RulesBlobStrLen = 3416;
const size_t CodeArtifactEndpointRules::RulesBlobSize = 3417;
...
't','t','p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t','-','f','i','p','s','.',
...
']',',','"','t','y','p','e','"',':','"','t','r','e','e','"',',','"','r','u','l','e','s','"',':','[',
'{','"','c','o','n','d','i','t','i','o','n','s','"',':','[',']',',','"','e','n','d','p','o','i','n',
't','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','a','r',
't','i','f','a','c','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'a','r','t','i','f','a','c','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
'r','l','"',':','"','h','t','t','p','s',':','/','/','c','o','d','e','a','r','t','i','f','a','c','t',
...
const char* CodeArtifactEndpointRules::GetRulesBlob()
{
