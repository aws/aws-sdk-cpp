...
class DeleteRepositoryRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DeleteRepositoryRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DeleteRepositoryRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  DeleteRepositoryRequest& WithRepository(RepositoryT&& value) {
