...
class ListAssociatedPackagesRequest : public CodeArtifactRequest {
 public:
  ...
  inline ListAssociatedPackagesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPreview(bool value) {
    m_previewHasBeenSet = true;
    m_preview = value;
  }
  inline ListAssociatedPackagesRequest& WithPreview(bool value) {
    SetPreview(value);
    return *this;
  }
  ///@}
