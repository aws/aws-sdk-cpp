...
class RepositoryExternalConnectionInfo {
 public:
  ...
  void SetExternalConnectionName(ExternalConnectionNameT&& value) {
    ...
    m_externalConnectionName = std::forward<ExternalConnectionNameT>(value);
  }
  template <typename ExternalConnectionNameT = Aws::String>
  RepositoryExternalConnectionInfo& WithExternalConnectionName(ExternalConnectionNameT&& value) {
    SetExternalConnectionName(std::forward<ExternalConnectionNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPackageFormat(PackageFormat value) {
    m_packageFormatHasBeenSet = true;
    m_packageFormat = value;
  }
  inline RepositoryExternalConnectionInfo& WithPackageFormat(PackageFormat value) {
  ...
  inline void SetStatus(ExternalConnectionStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline RepositoryExternalConnectionInfo& WithStatus(ExternalConnectionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
