...
namespace Model
{
  ...
  /**
   */
  class GetPackageVersionReadmeRequest : public CodeArtifactRequest
  {
  public:
    AWS_CODEARTIFACT_API GetPackageVersionReadmeRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetPackageVersionReadme"; }
     ...
     * package version with the requested readme file. </p>
     */
    ...
    template<typename DomainT = Aws::String>
    GetPackageVersionReadmeRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    GetPackageVersionReadmeRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p> The repository that contains the package with the requested readme file.
     * </p>
     */
    ...
    template<typename RepositoryT = Aws::String>
    GetPackageVersionReadmeRequest& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
    ...
    inline GetPackageVersionReadmeRequest& WithFormat(PackageFormat value) { SetFormat(value); return *this;}
    ///@}
     ...
     * example:</p>  <p>The namespace is required when requesting the readme from
    ...
    template<typename NamespaceT = Aws::String>
    GetPackageVersionReadmeRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p> The name of the package version that contains the requested readme file.
     * </p>
     */
    ...
    template<typename PackageT = Aws::String>
    GetPackageVersionReadmeRequest& WithPackage(PackageT&& value) { SetPackage(std::forward<PackageT>(value)); return *this;}
    ///@}
    ...
    template<typename PackageVersionT = Aws::String>
    GetPackageVersionReadmeRequest& WithPackageVersion(PackageVersionT&& value) { SetPackageVersion(std::forward<PackageVersionT>(value)); return *this;}
    ///@}
  private:
