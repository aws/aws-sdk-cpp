...
class GetPackageVersionReadmeRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  GetPackageVersionReadmeRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  GetPackageVersionReadmeRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  GetPackageVersionReadmeRequest& WithRepository(RepositoryT&& value) {
  ...
  inline GetPackageVersionReadmeRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  GetPackageVersionReadmeRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  GetPackageVersionReadmeRequest& WithPackage(PackageT&& value) {
  ...
  template <typename PackageVersionT = Aws::String>
  GetPackageVersionReadmeRequest& WithPackageVersion(PackageVersionT&& value) {
