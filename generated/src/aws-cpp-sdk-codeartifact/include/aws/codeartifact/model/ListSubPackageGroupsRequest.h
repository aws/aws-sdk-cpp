...
class ListSubPackageGroupsRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListSubPackageGroupsRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  ListSubPackageGroupsRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename PackageGroupT = Aws::String>
  ListSubPackageGroupsRequest& WithPackageGroup(PackageGroupT&& value) {
  ...
  inline ListSubPackageGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSubPackageGroupsRequest& WithNextToken(NextTokenT&& value) {
