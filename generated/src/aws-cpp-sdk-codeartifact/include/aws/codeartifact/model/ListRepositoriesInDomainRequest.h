...
class ListRepositoriesInDomainRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListRepositoriesInDomainRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  ListRepositoriesInDomainRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  void SetAdministratorAccount(AdministratorAccountT&& value) {
    ...
    m_administratorAccount = std::forward<AdministratorAccountT>(value);
  }
  template <typename AdministratorAccountT = Aws::String>
  ListRepositoriesInDomainRequest& WithAdministratorAccount(AdministratorAccountT&& value) {
    SetAdministratorAccount(std::forward<AdministratorAccountT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRepositoryPrefix(RepositoryPrefixT&& value) {
    m_repositoryPrefixHasBeenSet = true;
    m_repositoryPrefix = std::forward<RepositoryPrefixT>(value);
  }
  template <typename RepositoryPrefixT = Aws::String>
  ListRepositoriesInDomainRequest& WithRepositoryPrefix(RepositoryPrefixT&& value) {
    SetRepositoryPrefix(std::forward<RepositoryPrefixT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListRepositoriesInDomainRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoriesInDomainRequest& WithNextToken(NextTokenT&& value) {
