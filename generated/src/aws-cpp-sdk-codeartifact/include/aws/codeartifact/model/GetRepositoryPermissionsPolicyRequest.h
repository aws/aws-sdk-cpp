...
namespace Model
{
  ...
  /**
   */
  class GetRepositoryPermissionsPolicyRequest : public CodeArtifactRequest
  {
  public:
    AWS_CODEARTIFACT_API GetRepositoryPermissionsPolicyRequest() = default;
    ...
    template<typename DomainT = Aws::String>
    GetRepositoryPermissionsPolicyRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    GetRepositoryPermissionsPolicyRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryT = Aws::String>
    GetRepositoryPermissionsPolicyRequest& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
  private:
