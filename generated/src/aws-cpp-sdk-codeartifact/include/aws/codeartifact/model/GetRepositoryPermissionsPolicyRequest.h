...
class GetRepositoryPermissionsPolicyRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  GetRepositoryPermissionsPolicyRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  GetRepositoryPermissionsPolicyRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  GetRepositoryPermissionsPolicyRequest& WithRepository(RepositoryT&& value) {
