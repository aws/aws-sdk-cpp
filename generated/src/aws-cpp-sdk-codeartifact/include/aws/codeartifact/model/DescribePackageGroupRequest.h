...
class DescribePackageGroupRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DescribePackageGroupRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DescribePackageGroupRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename PackageGroupT = Aws::String>
  DescribePackageGroupRequest& WithPackageGroup(PackageGroupT&& value) {
