...
class ListPackageVersionAssetsRequest : public CodeArtifactRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "ListPackageVersionAssets"; }
  ...
  template <typename DomainT = Aws::String>
  ListPackageVersionAssetsRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  ListPackageVersionAssetsRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  ListPackageVersionAssetsRequest& WithRepository(RepositoryT&& value) {
  ...
  inline ListPackageVersionAssetsRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  ListPackageVersionAssetsRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  ListPackageVersionAssetsRequest& WithPackage(PackageT&& value) {
  ...
  template <typename PackageVersionT = Aws::String>
  ListPackageVersionAssetsRequest& WithPackageVersion(PackageVersionT&& value) {
  ...
  inline ListPackageVersionAssetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPackageVersionAssetsRequest& WithNextToken(NextTokenT&& value) {
