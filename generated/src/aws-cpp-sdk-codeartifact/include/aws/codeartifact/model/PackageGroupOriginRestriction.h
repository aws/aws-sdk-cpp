...
class PackageGroupOriginRestriction {
 public:
  ...
  inline void SetMode(PackageGroupOriginRestrictionMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline PackageGroupOriginRestriction& WithMode(PackageGroupOriginRestrictionMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEffectiveMode(PackageGroupOriginRestrictionMode value) {
    m_effectiveModeHasBeenSet = true;
    m_effectiveMode = value;
  }
  inline PackageGroupOriginRestriction& WithEffectiveMode(PackageGroupOriginRestrictionMode value) {
  ...
  void SetInheritedFrom(InheritedFromT&& value) {
    ...
    m_inheritedFrom = std::forward<InheritedFromT>(value);
  }
  template <typename InheritedFromT = PackageGroupReference>
  PackageGroupOriginRestriction& WithInheritedFrom(InheritedFromT&& value) {
    SetInheritedFrom(std::forward<InheritedFromT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRepositoriesCount(long long value) {
    m_repositoriesCountHasBeenSet = true;
    m_repositoriesCount = value;
  }
  inline PackageGroupOriginRestriction& WithRepositoriesCount(long long value) {
    SetRepositoriesCount(value);
    return *this;
  }
  ///@}
 private:
