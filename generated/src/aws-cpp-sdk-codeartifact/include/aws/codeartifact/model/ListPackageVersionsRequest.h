...
class ListPackageVersionsRequest : public CodeArtifactRequest {
 public:
  ...
  inline ListPackageVersionsRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ListPackageVersionsRequest& WithStatus(PackageVersionStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortBy(PackageVersionSortType value) {
    m_sortByHasBeenSet = true;
    m_sortBy = value;
  }
  inline ListPackageVersionsRequest& WithSortBy(PackageVersionSortType value) {
    SetSortBy(value);
    return *this;
  }
  ///@}
  ...
  inline ListPackageVersionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOriginType(PackageVersionOriginType value) {
    m_originTypeHasBeenSet = true;
    m_originType = value;
  }
  inline ListPackageVersionsRequest& WithOriginType(PackageVersionOriginType value) {
    SetOriginType(value);
    return *this;
  }
  ///@}
