...
class PutRepositoryPermissionsPolicyRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  PutRepositoryPermissionsPolicyRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  PutRepositoryPermissionsPolicyRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  PutRepositoryPermissionsPolicyRequest& WithRepository(RepositoryT&& value) {
  ...
  template <typename PolicyRevisionT = Aws::String>
  PutRepositoryPermissionsPolicyRequest& WithPolicyRevision(PolicyRevisionT&& value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  PutRepositoryPermissionsPolicyRequest& WithPolicyDocument(PolicyDocumentT&& value) {
