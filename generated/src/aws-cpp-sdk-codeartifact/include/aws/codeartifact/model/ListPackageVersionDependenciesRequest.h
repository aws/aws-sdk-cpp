...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API ListPackageVersionDependenciesRequest() = default;
    ...
    template<typename DomainT = Aws::String>
    ListPackageVersionDependenciesRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    ListPackageVersionDependenciesRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryT = Aws::String>
    ListPackageVersionDependenciesRequest& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
    ...
    inline ListPackageVersionDependenciesRequest& WithFormat(PackageFormat value) { SetFormat(value); return *this;}
    ///@}
    ...
    template<typename NamespaceT = Aws::String>
    ListPackageVersionDependenciesRequest& WithNamespace(NamespaceT&& value) { SetNamespace(std::forward<NamespaceT>(value)); return *this;}
    ///@}
    ...
    template<typename PackageT = Aws::String>
    ListPackageVersionDependenciesRequest& WithPackage(PackageT&& value) { SetPackage(std::forward<PackageT>(value)); return *this;}
    ///@}
    ...
    template<typename PackageVersionT = Aws::String>
    ListPackageVersionDependenciesRequest& WithPackageVersion(PackageVersionT&& value) { SetPackageVersion(std::forward<PackageVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListPackageVersionDependenciesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
