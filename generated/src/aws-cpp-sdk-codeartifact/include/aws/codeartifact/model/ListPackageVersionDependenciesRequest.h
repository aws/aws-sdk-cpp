...
class ListPackageVersionDependenciesRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListPackageVersionDependenciesRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  ListPackageVersionDependenciesRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  ListPackageVersionDependenciesRequest& WithRepository(RepositoryT&& value) {
  ...
  inline ListPackageVersionDependenciesRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  ListPackageVersionDependenciesRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  ListPackageVersionDependenciesRequest& WithPackage(PackageT&& value) {
  ...
  template <typename PackageVersionT = Aws::String>
  ListPackageVersionDependenciesRequest& WithPackageVersion(PackageVersionT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListPackageVersionDependenciesRequest& WithNextToken(NextTokenT&& value) {
