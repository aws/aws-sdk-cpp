...
class PutRepositoryPermissionsPolicyResult {
 public:
  ...
  AWS_CODEARTIFACT_API PutRepositoryPermissionsPolicyResult& operator=(
  ...
  template <typename PolicyT = ResourcePolicy>
  PutRepositoryPermissionsPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRepositoryPermissionsPolicyResult& WithRequestId(RequestIdT&& value) {
