...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API DeleteRepositoryPermissionsPolicyResult() = default;
    ...
    template<typename PolicyT = ResourcePolicy>
    DeleteRepositoryPermissionsPolicyResult& WithPolicy(PolicyT&& value) { SetPolicy(std::forward<PolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteRepositoryPermissionsPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
