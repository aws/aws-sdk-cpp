...
class DeleteRepositoryPermissionsPolicyResult {
 public:
  ...
  AWS_CODEARTIFACT_API DeleteRepositoryPermissionsPolicyResult& operator=(
  ...
  template <typename PolicyT = ResourcePolicy>
  DeleteRepositoryPermissionsPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteRepositoryPermissionsPolicyResult& WithRequestId(RequestIdT&& value) {
