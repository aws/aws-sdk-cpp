...
class PackageVersionError {
 public:
  ...
  inline void SetErrorCode(PackageVersionErrorCode value) {
    m_errorCodeHasBeenSet = true;
    m_errorCode = value;
  }
  inline PackageVersionError& WithErrorCode(PackageVersionErrorCode value) {
    SetErrorCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorMessageT = Aws::String>
  PackageVersionError& WithErrorMessage(ErrorMessageT&& value) {
