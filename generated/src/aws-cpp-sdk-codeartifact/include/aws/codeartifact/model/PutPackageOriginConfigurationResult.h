...
class PutPackageOriginConfigurationResult {
 public:
  ...
  AWS_CODEARTIFACT_API PutPackageOriginConfigurationResult& operator=(
  ...
  void SetOriginConfiguration(OriginConfigurationT&& value) {
    ...
    m_originConfiguration = std::forward<OriginConfigurationT>(value);
  }
  template <typename OriginConfigurationT = PackageOriginConfiguration>
  PutPackageOriginConfigurationResult& WithOriginConfiguration(OriginConfigurationT&& value) {
    SetOriginConfiguration(std::forward<OriginConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutPackageOriginConfigurationResult& WithRequestId(RequestIdT&& value) {
