...
class ListRepositoriesInDomainResult {
 public:
  ...
  template <typename RepositoriesT = Aws::Vector<RepositorySummary>>
  ListRepositoriesInDomainResult& WithRepositories(RepositoriesT&& value) {
    SetRepositories(std::forward<RepositoriesT>(value));
    return *this;
  }
  template <typename RepositoriesT = RepositorySummary>
  ListRepositoriesInDomainResult& AddRepositories(RepositoriesT&& value) {
    m_repositoriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListRepositoriesInDomainResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRepositoriesInDomainResult& WithRequestId(RequestIdT&& value) {
