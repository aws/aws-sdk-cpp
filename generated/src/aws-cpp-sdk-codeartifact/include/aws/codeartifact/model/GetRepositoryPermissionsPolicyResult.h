...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API GetRepositoryPermissionsPolicyResult() = default;
    ...
    template<typename PolicyT = ResourcePolicy>
    GetRepositoryPermissionsPolicyResult& WithPolicy(PolicyT&& value) { SetPolicy(std::forward<PolicyT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetRepositoryPermissionsPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
