...
class GetRepositoryPermissionsPolicyResult {
 public:
  ...
  AWS_CODEARTIFACT_API GetRepositoryPermissionsPolicyResult& operator=(
  ...
  template <typename PolicyT = ResourcePolicy>
  GetRepositoryPermissionsPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetRepositoryPermissionsPolicyResult& WithRequestId(RequestIdT&& value) {
