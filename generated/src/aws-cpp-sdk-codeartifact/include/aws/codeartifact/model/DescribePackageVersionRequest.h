...
class DescribePackageVersionRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DescribePackageVersionRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DescribePackageVersionRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  DescribePackageVersionRequest& WithRepository(RepositoryT&& value) {
  ...
  inline DescribePackageVersionRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  DescribePackageVersionRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  DescribePackageVersionRequest& WithPackage(PackageT&& value) {
