...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API DisassociateExternalConnectionResult() = default;
    ...
    template<typename RepositoryT = RepositoryDescription>
    DisassociateExternalConnectionResult& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DisassociateExternalConnectionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
