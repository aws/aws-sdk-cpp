...
class DisassociateExternalConnectionResult {
 public:
  ...
  AWS_CODEARTIFACT_API DisassociateExternalConnectionResult& operator=(
  ...
  template <typename RepositoryT = RepositoryDescription>
  DisassociateExternalConnectionResult& WithRepository(RepositoryT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DisassociateExternalConnectionResult& WithRequestId(RequestIdT&& value) {
