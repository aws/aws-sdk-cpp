...
class DeletePackageGroupRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DeletePackageGroupRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DeletePackageGroupRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename PackageGroupT = Aws::String>
  DeletePackageGroupRequest& WithPackageGroup(PackageGroupT&& value) {
