...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API DeletePackageGroupRequest() = default;
    ...
    template<typename DomainT = Aws::String>
    DeletePackageGroupRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    DeletePackageGroupRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename PackageGroupT = Aws::String>
    DeletePackageGroupRequest& WithPackageGroup(PackageGroupT&& value) { SetPackageGroup(std::forward<PackageGroupT>(value)); return *this;}
    ///@}
  private:
