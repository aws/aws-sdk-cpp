...
class GetAuthorizationTokenRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  GetAuthorizationTokenRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  GetAuthorizationTokenRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  inline GetAuthorizationTokenRequest& WithDurationSeconds(long long value) {
