...
class DeleteRepositoryPermissionsPolicyRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DeleteRepositoryPermissionsPolicyRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DeleteRepositoryPermissionsPolicyRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  DeleteRepositoryPermissionsPolicyRequest& WithRepository(RepositoryT&& value) {
  ...
  template <typename PolicyRevisionT = Aws::String>
  DeleteRepositoryPermissionsPolicyRequest& WithPolicyRevision(PolicyRevisionT&& value) {
