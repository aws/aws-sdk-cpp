...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainT = Aws::String>
    DisassociateExternalConnectionRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    DisassociateExternalConnectionRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}
    ...
    template<typename RepositoryT = Aws::String>
    DisassociateExternalConnectionRequest& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
    ...
    template<typename ExternalConnectionT = Aws::String>
    DisassociateExternalConnectionRequest& WithExternalConnection(ExternalConnectionT&& value) { SetExternalConnection(std::forward<ExternalConnectionT>(value)); return *this;}
    ///@}
  private:
