...
class DisassociateExternalConnectionRequest : public CodeArtifactRequest {
 public:
  ...
  void SetExternalConnection(ExternalConnectionT&& value) {
    m_externalConnectionHasBeenSet = true;
    m_externalConnection = std::forward<ExternalConnectionT>(value);
  }
  template <typename ExternalConnectionT = Aws::String>
  DisassociateExternalConnectionRequest& WithExternalConnection(ExternalConnectionT&& value) {
    SetExternalConnection(std::forward<ExternalConnectionT>(value));
    return *this;
  }
  ///@}
 private:
