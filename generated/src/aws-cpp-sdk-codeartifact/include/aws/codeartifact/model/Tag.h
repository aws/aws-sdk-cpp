...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API Tag() = default;
    AWS_CODEARTIFACT_API Tag(Aws::Utils::Json::JsonView jsonValue);
    AWS_CODEARTIFACT_API Tag& operator=(Aws::Utils::Json::JsonView jsonValue);
