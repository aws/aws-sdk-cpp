...
/**
 */
class DescribeRepositoryRequest : public CodeArtifactRequest {
 public:
  AWS_CODEARTIFACT_API DescribeRepositoryRequest() = default;
  ...
  template <typename DomainT = Aws::String>
  DescribeRepositoryRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DescribeRepositoryRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  DescribeRepositoryRequest& WithRepository(RepositoryT&& value) {
