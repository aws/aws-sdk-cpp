...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API UpdateRepositoryResult() = default;
    ...
    template<typename RepositoryT = RepositoryDescription>
    UpdateRepositoryResult& WithRepository(RepositoryT&& value) { SetRepository(std::forward<RepositoryT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    UpdateRepositoryResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
