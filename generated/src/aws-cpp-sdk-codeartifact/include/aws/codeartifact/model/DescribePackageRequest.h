...
class DescribePackageRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  DescribePackageRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  DescribePackageRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  DescribePackageRequest& WithRepository(RepositoryT&& value) {
  ...
  inline DescribePackageRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  DescribePackageRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  DescribePackageRequest& WithPackage(PackageT&& value) {
