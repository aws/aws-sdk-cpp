...
class PackageDependency {
 public:
  ...
  void SetDependencyType(DependencyTypeT&& value) {
    ...
    m_dependencyType = std::forward<DependencyTypeT>(value);
  }
  template <typename DependencyTypeT = Aws::String>
  PackageDependency& WithDependencyType(DependencyTypeT&& value) {
    SetDependencyType(std::forward<DependencyTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVersionRequirement(VersionRequirementT&& value) {
    ...
    m_versionRequirement = std::forward<VersionRequirementT>(value);
  }
  template <typename VersionRequirementT = Aws::String>
  PackageDependency& WithVersionRequirement(VersionRequirementT&& value) {
    SetVersionRequirement(std::forward<VersionRequirementT>(value));
    return *this;
  }
  ///@}
 private:
