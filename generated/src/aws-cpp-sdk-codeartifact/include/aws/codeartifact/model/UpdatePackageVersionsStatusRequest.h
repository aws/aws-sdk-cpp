...
class UpdatePackageVersionsStatusRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  UpdatePackageVersionsStatusRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  UpdatePackageVersionsStatusRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  template <typename RepositoryT = Aws::String>
  UpdatePackageVersionsStatusRequest& WithRepository(RepositoryT&& value) {
  ...
  inline UpdatePackageVersionsStatusRequest& WithFormat(PackageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename NamespaceT = Aws::String>
  UpdatePackageVersionsStatusRequest& WithNamespace(NamespaceT&& value) {
  ...
  template <typename PackageT = Aws::String>
  UpdatePackageVersionsStatusRequest& WithPackage(PackageT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<Aws::String>>
  UpdatePackageVersionsStatusRequest& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = Aws::String>
  UpdatePackageVersionsStatusRequest& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  template <typename VersionRevisionsT = Aws::Map<Aws::String, Aws::String>>
  UpdatePackageVersionsStatusRequest& WithVersionRevisions(VersionRevisionsT&& value) {
  ...
  inline UpdatePackageVersionsStatusRequest& WithExpectedStatus(PackageVersionStatus value) {
  ...
  inline void SetTargetStatus(PackageVersionStatus value) {
    m_targetStatusHasBeenSet = true;
    m_targetStatus = value;
  }
  inline UpdatePackageVersionsStatusRequest& WithTargetStatus(PackageVersionStatus value) {
