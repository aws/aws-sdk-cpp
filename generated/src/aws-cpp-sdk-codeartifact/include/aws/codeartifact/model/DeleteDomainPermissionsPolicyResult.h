...
class DeleteDomainPermissionsPolicyResult {
 public:
  ...
  AWS_CODEARTIFACT_API DeleteDomainPermissionsPolicyResult& operator=(
  ...
  template <typename PolicyT = ResourcePolicy>
  DeleteDomainPermissionsPolicyResult& WithPolicy(PolicyT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteDomainPermissionsPolicyResult& WithRequestId(RequestIdT&& value) {
