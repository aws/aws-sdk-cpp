...
class ListPackageGroupsRequest : public CodeArtifactRequest {
 public:
  ...
  template <typename DomainT = Aws::String>
  ListPackageGroupsRequest& WithDomain(DomainT&& value) {
  ...
  template <typename DomainOwnerT = Aws::String>
  ListPackageGroupsRequest& WithDomainOwner(DomainOwnerT&& value) {
  ...
  inline ListPackageGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListPackageGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PrefixT = Aws::String>
  ListPackageGroupsRequest& WithPrefix(PrefixT&& value) {
