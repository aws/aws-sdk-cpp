...
namespace Model
{
  ...
  {
  public:
    AWS_CODEARTIFACT_API GetDomainPermissionsPolicyRequest() = default;
    ...
    template<typename DomainT = Aws::String>
    GetDomainPermissionsPolicyRequest& WithDomain(DomainT&& value) { SetDomain(std::forward<DomainT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainOwnerT = Aws::String>
    GetDomainPermissionsPolicyRequest& WithDomainOwner(DomainOwnerT&& value) { SetDomainOwner(std::forward<DomainOwnerT>(value)); return *this;}
    ///@}
  private:
