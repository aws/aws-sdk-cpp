...
class UpdatePackageVersionsStatusResult {
 public:
  ...
  template <typename SuccessfulVersionsT = Aws::Map<Aws::String, SuccessfulPackageVersionInfo>>
  UpdatePackageVersionsStatusResult& WithSuccessfulVersions(SuccessfulVersionsT&& value) {
  ...
  template <typename FailedVersionsT = Aws::Map<Aws::String, PackageVersionError>>
  UpdatePackageVersionsStatusResult& WithFailedVersions(FailedVersionsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdatePackageVersionsStatusResult& WithRequestId(RequestIdT&& value) {
