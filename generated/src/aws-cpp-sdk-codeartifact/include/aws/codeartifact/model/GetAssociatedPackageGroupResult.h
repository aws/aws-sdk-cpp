...
class GetAssociatedPackageGroupResult {
 public:
  ...
  template <typename PackageGroupT = PackageGroupDescription>
  GetAssociatedPackageGroupResult& WithPackageGroup(PackageGroupT&& value) {
  ...
  inline void SetAssociationType(PackageGroupAssociationType value) {
    m_associationTypeHasBeenSet = true;
    m_associationType = value;
  }
  inline GetAssociatedPackageGroupResult& WithAssociationType(PackageGroupAssociationType value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetAssociatedPackageGroupResult& WithRequestId(RequestIdT&& value) {
