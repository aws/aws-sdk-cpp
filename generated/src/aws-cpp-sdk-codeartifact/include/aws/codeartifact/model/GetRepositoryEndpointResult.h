...
class GetRepositoryEndpointResult {
 public:
  ...
  void SetRepositoryEndpoint(RepositoryEndpointT&& value) {
    m_repositoryEndpointHasBeenSet = true;
    m_repositoryEndpoint = std::forward<RepositoryEndpointT>(value);
  }
  template <typename RepositoryEndpointT = Aws::String>
  GetRepositoryEndpointResult& WithRepositoryEndpoint(RepositoryEndpointT&& value) {
    SetRepositoryEndpoint(std::forward<RepositoryEndpointT>(value));
    return *this;
  }
  ///@}
