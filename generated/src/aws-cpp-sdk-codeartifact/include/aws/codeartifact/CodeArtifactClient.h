...
class AWS_CODEARTIFACT_API CodeArtifactClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  CodeArtifactClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<CodeArtifactEndpointProviderBase> endpointProvider = nullptr,
      const Aws::CodeArtifact::CodeArtifactClientConfiguration& clientConfiguration = Aws::CodeArtifact::CodeArtifactClientConfiguration());
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateExternalConnectionOutcome AssociateExternalConnection(
      const Model::AssociateExternalConnectionRequest& request) const;

  /**
   * A Callable wrapper for AssociateExternalConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateExternalConnectionRequestT = Model::AssociateExternalConnectionRequest>
  Model::AssociateExternalConnectionOutcomeCallable AssociateExternalConnectionCallable(
      const AssociateExternalConnectionRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::AssociateExternalConnection, request);
  }

  /**
   * An Async wrapper for AssociateExternalConnection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateExternalConnectionRequestT = Model::AssociateExternalConnectionRequest>
  void AssociateExternalConnectionAsync(const AssociateExternalConnectionRequestT& request,
  ...
  /**
   * A Callable wrapper for CopyPackageVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CopyPackageVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CopyPackageVersionsRequestT = Model::CopyPackageVersionsRequest>
  void CopyPackageVersionsAsync(const CopyPackageVersionsRequestT& request, const CopyPackageVersionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreatePackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreatePackageGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreatePackageGroupRequestT = Model::CreatePackageGroupRequest>
  void CreatePackageGroupAsync(const CreatePackageGroupRequestT& request, const CreatePackageGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteDomainPermissionsPolicyOutcome DeleteDomainPermissionsPolicy(
      const Model::DeleteDomainPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteDomainPermissionsPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteDomainPermissionsPolicyRequestT = Model::DeleteDomainPermissionsPolicyRequest>
  Model::DeleteDomainPermissionsPolicyOutcomeCallable DeleteDomainPermissionsPolicyCallable(
      const DeleteDomainPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::DeleteDomainPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for DeleteDomainPermissionsPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteDomainPermissionsPolicyRequestT = Model::DeleteDomainPermissionsPolicyRequest>
  void DeleteDomainPermissionsPolicyAsync(const DeleteDomainPermissionsPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DeletePackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePackageGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeletePackageGroupRequestT = Model::DeletePackageGroupRequest>
  void DeletePackageGroupAsync(const DeletePackageGroupRequestT& request, const DeletePackageGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeletePackageVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeletePackageVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeletePackageVersionsRequestT = Model::DeletePackageVersionsRequest>
  void DeletePackageVersionsAsync(const DeletePackageVersionsRequestT& request, const DeletePackageVersionsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRepositoryPermissionsPolicyOutcome DeleteRepositoryPermissionsPolicy(
      const Model::DeleteRepositoryPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for DeleteRepositoryPermissionsPolicy that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DeleteRepositoryPermissionsPolicyRequestT = Model::DeleteRepositoryPermissionsPolicyRequest>
  Model::DeleteRepositoryPermissionsPolicyOutcomeCallable DeleteRepositoryPermissionsPolicyCallable(
      const DeleteRepositoryPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::DeleteRepositoryPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for DeleteRepositoryPermissionsPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteRepositoryPermissionsPolicyRequestT = Model::DeleteRepositoryPermissionsPolicyRequest>
  void DeleteRepositoryPermissionsPolicyAsync(const DeleteRepositoryPermissionsPolicyRequestT& request,
  ...
  /**
   * An Async wrapper for DescribePackage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribePackageRequestT = Model::DescribePackageRequest>
  void DescribePackageAsync(const DescribePackageRequestT& request, const DescribePackageResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePackageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePackageGroupRequestT = Model::DescribePackageGroupRequest>
  void DescribePackageGroupAsync(const DescribePackageGroupRequestT& request, const DescribePackageGroupResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribePackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribePackageVersionRequestT = Model::DescribePackageVersionRequest>
  void DescribePackageVersionAsync(const DescribePackageVersionRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeRepository that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeRepositoryRequestT = Model::DescribeRepositoryRequest>
  void DescribeRepositoryAsync(const DescribeRepositoryRequestT& request, const DescribeRepositoryResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateExternalConnectionOutcome DisassociateExternalConnection(
      const Model::DisassociateExternalConnectionRequest& request) const;

  /**
   * A Callable wrapper for DisassociateExternalConnection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateExternalConnectionRequestT = Model::DisassociateExternalConnectionRequest>
  Model::DisassociateExternalConnectionOutcomeCallable DisassociateExternalConnectionCallable(
      const DisassociateExternalConnectionRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::DisassociateExternalConnection, request);
  }

  /**
   * An Async wrapper for DisassociateExternalConnection that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisassociateExternalConnectionRequestT = Model::DisassociateExternalConnectionRequest>
  void DisassociateExternalConnectionAsync(const DisassociateExternalConnectionRequestT& request,
  ...
  /**
   * A Callable wrapper for DisposePackageVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisposePackageVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisposePackageVersionsRequestT = Model::DisposePackageVersionsRequest>
  void DisposePackageVersionsAsync(const DisposePackageVersionsRequestT& request,
  ...
  /**
   * A Callable wrapper for GetAssociatedPackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename GetAssociatedPackageGroupRequestT = Model::GetAssociatedPackageGroupRequest>
  Model::GetAssociatedPackageGroupOutcomeCallable GetAssociatedPackageGroupCallable(
      const GetAssociatedPackageGroupRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::GetAssociatedPackageGroup, request);
  }

  /**
   * An Async wrapper for GetAssociatedPackageGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetAssociatedPackageGroupRequestT = Model::GetAssociatedPackageGroupRequest>
  void GetAssociatedPackageGroupAsync(const GetAssociatedPackageGroupRequestT& request,
                                      const GetAssociatedPackageGroupResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetAuthorizationTokenRequestT = Model::GetAuthorizationTokenRequest>
  void GetAuthorizationTokenAsync(const GetAuthorizationTokenRequestT& request, const GetAuthorizationTokenResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetDomainPermissionsPolicyOutcome GetDomainPermissionsPolicy(
      const Model::GetDomainPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetDomainPermissionsPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetDomainPermissionsPolicyRequestT = Model::GetDomainPermissionsPolicyRequest>
  Model::GetDomainPermissionsPolicyOutcomeCallable GetDomainPermissionsPolicyCallable(
      const GetDomainPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::GetDomainPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for GetDomainPermissionsPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetDomainPermissionsPolicyRequestT = Model::GetDomainPermissionsPolicyRequest>
  void GetDomainPermissionsPolicyAsync(const GetDomainPermissionsPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for GetPackageVersionAsset that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPackageVersionAsset that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPackageVersionAssetRequestT = Model::GetPackageVersionAssetRequest>
  void GetPackageVersionAssetAsync(const GetPackageVersionAssetRequestT& request,
  ...
  /**
   * A Callable wrapper for GetPackageVersionReadme that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetPackageVersionReadme that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetPackageVersionReadmeRequestT = Model::GetPackageVersionReadmeRequest>
  void GetPackageVersionReadmeAsync(const GetPackageVersionReadmeRequestT& request,
  ...
  /**
   * A Callable wrapper for GetRepositoryEndpoint that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetRepositoryEndpoint that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetRepositoryEndpointRequestT = Model::GetRepositoryEndpointRequest>
  void GetRepositoryEndpointAsync(const GetRepositoryEndpointRequestT& request, const GetRepositoryEndpointResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRepositoryPermissionsPolicyOutcome GetRepositoryPermissionsPolicy(
      const Model::GetRepositoryPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for GetRepositoryPermissionsPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetRepositoryPermissionsPolicyRequestT = Model::GetRepositoryPermissionsPolicyRequest>
  Model::GetRepositoryPermissionsPolicyOutcomeCallable GetRepositoryPermissionsPolicyCallable(
      const GetRepositoryPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::GetRepositoryPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for GetRepositoryPermissionsPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRepositoryPermissionsPolicyRequestT = Model::GetRepositoryPermissionsPolicyRequest>
  void GetRepositoryPermissionsPolicyAsync(const GetRepositoryPermissionsPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAllowedRepositoriesForGroupOutcome ListAllowedRepositoriesForGroup(
      const Model::ListAllowedRepositoriesForGroupRequest& request) const;

  /**
   * A Callable wrapper for ListAllowedRepositoriesForGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAllowedRepositoriesForGroupRequestT = Model::ListAllowedRepositoriesForGroupRequest>
  Model::ListAllowedRepositoriesForGroupOutcomeCallable ListAllowedRepositoriesForGroupCallable(
      const ListAllowedRepositoriesForGroupRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::ListAllowedRepositoriesForGroup, request);
  }

  /**
   * An Async wrapper for ListAllowedRepositoriesForGroup that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAllowedRepositoriesForGroupRequestT = Model::ListAllowedRepositoriesForGroupRequest>
  void ListAllowedRepositoriesForGroupAsync(const ListAllowedRepositoriesForGroupRequestT& request,
                                            const ListAllowedRepositoriesForGroupResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssociatedPackages that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssociatedPackages that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAssociatedPackagesRequestT = Model::ListAssociatedPackagesRequest>
  void ListAssociatedPackagesAsync(const ListAssociatedPackagesRequestT& request,
                                   const ListAssociatedPackagesResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPackageGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackageGroups that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPackageGroupsRequestT = Model::ListPackageGroupsRequest>
  void ListPackageGroupsAsync(const ListPackageGroupsRequestT& request, const ListPackageGroupsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListPackageVersionAssets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackageVersionAssets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListPackageVersionAssetsRequestT = Model::ListPackageVersionAssetsRequest>
  void ListPackageVersionAssetsAsync(const ListPackageVersionAssetsRequestT& request,
  ...
  virtual Model::ListPackageVersionDependenciesOutcome ListPackageVersionDependencies(
      const Model::ListPackageVersionDependenciesRequest& request) const;

  /**
   * A Callable wrapper for ListPackageVersionDependencies that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListPackageVersionDependenciesRequestT = Model::ListPackageVersionDependenciesRequest>
  Model::ListPackageVersionDependenciesOutcomeCallable ListPackageVersionDependenciesCallable(
      const ListPackageVersionDependenciesRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::ListPackageVersionDependencies, request);
  }

  /**
   * An Async wrapper for ListPackageVersionDependencies that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListPackageVersionDependenciesRequestT = Model::ListPackageVersionDependenciesRequest>
  void ListPackageVersionDependenciesAsync(const ListPackageVersionDependenciesRequestT& request,
  ...
  /**
   * A Callable wrapper for ListPackageVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListPackageVersions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListPackageVersionsRequestT = Model::ListPackageVersionsRequest>
  void ListPackageVersionsAsync(const ListPackageVersionsRequestT& request, const ListPackageVersionsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListPackages that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListPackagesRequestT = Model::ListPackagesRequest>
  void ListPackagesAsync(const ListPackagesRequestT& request, const ListPackagesResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRepositoriesInDomain that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRepositoriesInDomain that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRepositoriesInDomainRequestT = Model::ListRepositoriesInDomainRequest>
  void ListRepositoriesInDomainAsync(const ListRepositoriesInDomainRequestT& request,
  ...
  /**
   * A Callable wrapper for ListSubPackageGroups that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSubPackageGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSubPackageGroupsRequestT = Model::ListSubPackageGroupsRequest>
  void ListSubPackageGroupsAsync(const ListSubPackageGroupsRequestT& request, const ListSubPackageGroupsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PublishPackageVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PublishPackageVersion that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PublishPackageVersionRequestT = Model::PublishPackageVersionRequest>
  void PublishPackageVersionAsync(const PublishPackageVersionRequestT& request, const PublishPackageVersionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutDomainPermissionsPolicyOutcome PutDomainPermissionsPolicy(
      const Model::PutDomainPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutDomainPermissionsPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutDomainPermissionsPolicyRequestT = Model::PutDomainPermissionsPolicyRequest>
  Model::PutDomainPermissionsPolicyOutcomeCallable PutDomainPermissionsPolicyCallable(
      const PutDomainPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::PutDomainPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for PutDomainPermissionsPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutDomainPermissionsPolicyRequestT = Model::PutDomainPermissionsPolicyRequest>
  void PutDomainPermissionsPolicyAsync(const PutDomainPermissionsPolicyRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::PutPackageOriginConfigurationOutcome PutPackageOriginConfiguration(
      const Model::PutPackageOriginConfigurationRequest& request) const;

  /**
   * A Callable wrapper for PutPackageOriginConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutPackageOriginConfigurationRequestT = Model::PutPackageOriginConfigurationRequest>
  Model::PutPackageOriginConfigurationOutcomeCallable PutPackageOriginConfigurationCallable(
      const PutPackageOriginConfigurationRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::PutPackageOriginConfiguration, request);
  }

  /**
   * An Async wrapper for PutPackageOriginConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutPackageOriginConfigurationRequestT = Model::PutPackageOriginConfigurationRequest>
  void PutPackageOriginConfigurationAsync(const PutPackageOriginConfigurationRequestT& request,
                                          const PutPackageOriginConfigurationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::PutRepositoryPermissionsPolicyOutcome PutRepositoryPermissionsPolicy(
      const Model::PutRepositoryPermissionsPolicyRequest& request) const;

  /**
   * A Callable wrapper for PutRepositoryPermissionsPolicy that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PutRepositoryPermissionsPolicyRequestT = Model::PutRepositoryPermissionsPolicyRequest>
  Model::PutRepositoryPermissionsPolicyOutcomeCallable PutRepositoryPermissionsPolicyCallable(
      const PutRepositoryPermissionsPolicyRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::PutRepositoryPermissionsPolicy, request);
  }

  /**
   * An Async wrapper for PutRepositoryPermissionsPolicy that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename PutRepositoryPermissionsPolicyRequestT = Model::PutRepositoryPermissionsPolicyRequest>
  void PutRepositoryPermissionsPolicyAsync(const PutRepositoryPermissionsPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdatePackageGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePackageGroup that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePackageGroupRequestT = Model::UpdatePackageGroupRequest>
  void UpdatePackageGroupAsync(const UpdatePackageGroupRequestT& request, const UpdatePackageGroupResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePackageGroupOriginConfigurationOutcome UpdatePackageGroupOriginConfiguration(
      const Model::UpdatePackageGroupOriginConfigurationRequest& request) const;

  /**
   * A Callable wrapper for UpdatePackageGroupOriginConfiguration that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdatePackageGroupOriginConfigurationRequestT = Model::UpdatePackageGroupOriginConfigurationRequest>
  Model::UpdatePackageGroupOriginConfigurationOutcomeCallable UpdatePackageGroupOriginConfigurationCallable(
      const UpdatePackageGroupOriginConfigurationRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::UpdatePackageGroupOriginConfiguration, request);
  }

  /**
   * An Async wrapper for UpdatePackageGroupOriginConfiguration that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdatePackageGroupOriginConfigurationRequestT = Model::UpdatePackageGroupOriginConfigurationRequest>
  void UpdatePackageGroupOriginConfigurationAsync(const UpdatePackageGroupOriginConfigurationRequestT& request,
                                                  const UpdatePackageGroupOriginConfigurationResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdatePackageVersionsStatusOutcome UpdatePackageVersionsStatus(
      const Model::UpdatePackageVersionsStatusRequest& request) const;

  /**
   * A Callable wrapper for UpdatePackageVersionsStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdatePackageVersionsStatusRequestT = Model::UpdatePackageVersionsStatusRequest>
  Model::UpdatePackageVersionsStatusOutcomeCallable UpdatePackageVersionsStatusCallable(
      const UpdatePackageVersionsStatusRequestT& request) const {
    return SubmitCallable(&CodeArtifactClient::UpdatePackageVersionsStatus, request);
  }

  /**
   * An Async wrapper for UpdatePackageVersionsStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdatePackageVersionsStatusRequestT = Model::UpdatePackageVersionsStatusRequest>
  void UpdatePackageVersionsStatusAsync(const UpdatePackageVersionsStatusRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateRepository that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateRepository that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateRepositoryRequestT = Model::UpdateRepositoryRequest>
  void UpdateRepositoryAsync(const UpdateRepositoryRequestT& request, const UpdateRepositoryResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
