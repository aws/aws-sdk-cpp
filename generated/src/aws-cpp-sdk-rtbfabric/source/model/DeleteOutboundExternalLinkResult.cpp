...
DeleteOutboundExternalLinkResult::DeleteOutboundExternalLinkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteOutboundExternalLinkResult& DeleteOutboundExternalLinkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
