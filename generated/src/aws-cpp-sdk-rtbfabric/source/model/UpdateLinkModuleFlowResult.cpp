...
UpdateLinkModuleFlowResult::UpdateLinkModuleFlowResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateLinkModuleFlowResult& UpdateLinkModuleFlowResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
