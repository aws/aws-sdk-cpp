...
GetCertificateAssociationResult::GetCertificateAssociationResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetCertificateAssociationResult& GetCertificateAssociationResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
