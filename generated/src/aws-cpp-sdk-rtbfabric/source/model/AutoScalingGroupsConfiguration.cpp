...
AutoScalingGroupsConfiguration::AutoScalingGroupsConfiguration(JsonView jsonValue)
{
  *this = jsonValue;
}
...
AutoScalingGroupsConfiguration& AutoScalingGroupsConfiguration::operator =(JsonView jsonValue)
{
  if(jsonValue.ValueExists("autoScalingGroupNames"))
  {
    ...
    for(unsigned autoScalingGroupNamesIndex = 0; autoScalingGroupNamesIndex < autoScalingGroupNamesJsonList.GetLength(); ++autoScalingGroupNamesIndex)
    {
