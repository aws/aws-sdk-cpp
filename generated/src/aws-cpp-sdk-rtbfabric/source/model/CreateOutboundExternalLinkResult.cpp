...
CreateOutboundExternalLinkResult::CreateOutboundExternalLinkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateOutboundExternalLinkResult& CreateOutboundExternalLinkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
