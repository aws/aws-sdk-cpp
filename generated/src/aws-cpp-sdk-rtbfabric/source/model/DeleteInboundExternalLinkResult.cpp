...
DeleteInboundExternalLinkResult::DeleteInboundExternalLinkResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

DeleteInboundExternalLinkResult& DeleteInboundExternalLinkResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
