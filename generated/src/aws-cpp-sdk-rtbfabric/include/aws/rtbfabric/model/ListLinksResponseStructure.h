...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdT = Aws::String>
    ListLinksResponseStructure& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PeerGatewayIdT = Aws::String>
    ListLinksResponseStructure& WithPeerGatewayId(PeerGatewayIdT&& value) { SetPeerGatewayId(std::forward<PeerGatewayIdT>(value)); return *this;}
    ///@}
    ...
    inline ListLinksResponseStructure& WithStatus(LinkStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    ListLinksResponseStructure& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    ListLinksResponseStructure& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    inline ListLinksResponseStructure& WithDirection(LinkDirection value) { SetDirection(value); return *this;}
    ///@}
    ...
    template<typename FlowModulesT = Aws::Vector<ModuleConfiguration>>
    ListLinksResponseStructure& WithFlowModules(FlowModulesT&& value) { SetFlowModules(std::forward<FlowModulesT>(value)); return *this;}
    template<typename FlowModulesT = ModuleConfiguration>
    ListLinksResponseStructure& AddFlowModules(FlowModulesT&& value) { m_flowModulesHasBeenSet = true; m_flowModules.emplace_back(std::forward<FlowModulesT>(value)); return *this; }
    ///@}
    ...
    template<typename PendingFlowModulesT = Aws::Vector<ModuleConfiguration>>
    ListLinksResponseStructure& WithPendingFlowModules(PendingFlowModulesT&& value) { SetPendingFlowModules(std::forward<PendingFlowModulesT>(value)); return *this;}
    template<typename PendingFlowModulesT = ModuleConfiguration>
    ListLinksResponseStructure& AddPendingFlowModules(PendingFlowModulesT&& value) { m_pendingFlowModulesHasBeenSet = true; m_pendingFlowModules.emplace_back(std::forward<PendingFlowModulesT>(value)); return *this; }
    ///@}
    ...
    template<typename AttributesT = LinkAttributes>
    ListLinksResponseStructure& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    ListLinksResponseStructure& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    ListLinksResponseStructure& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
