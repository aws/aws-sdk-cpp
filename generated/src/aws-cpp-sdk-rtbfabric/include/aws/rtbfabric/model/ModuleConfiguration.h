...
class ModuleConfiguration {
 public:
  ...
  template <typename VersionT = Aws::String>
  ModuleConfiguration& WithVersion(VersionT&& value) {
  ...
  template <typename NameT = Aws::String>
  ModuleConfiguration& WithName(NameT&& value) {
  ...
  template <typename DependsOnT = Aws::Vector<Aws::String>>
  ModuleConfiguration& WithDependsOn(DependsOnT&& value) {
    SetDependsOn(std::forward<DependsOnT>(value));
    return *this;
  }
  template <typename DependsOnT = Aws::String>
  ModuleConfiguration& AddDependsOn(DependsOnT&& value) {
    m_dependsOnHasBeenSet = true;
  ...
  void SetModuleParameters(ModuleParametersT&& value) {
    m_moduleParametersHasBeenSet = true;
    m_moduleParameters = std::forward<ModuleParametersT>(value);
  }
  template <typename ModuleParametersT = ModuleParameters>
  ModuleConfiguration& WithModuleParameters(ModuleParametersT&& value) {
    SetModuleParameters(std::forward<ModuleParametersT>(value));
    return *this;
  }
  ///@}
 private:
