...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdT = Aws::String>
    GetLinkResult& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PeerGatewayIdT = Aws::String>
    GetLinkResult& WithPeerGatewayId(PeerGatewayIdT&& value) { SetPeerGatewayId(std::forward<PeerGatewayIdT>(value)); return *this;}
    ///@}
    ...
    inline GetLinkResult& WithStatus(LinkStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename CreatedAtT = Aws::Utils::DateTime>
    GetLinkResult& WithCreatedAt(CreatedAtT&& value) { SetCreatedAt(std::forward<CreatedAtT>(value)); return *this;}
    ///@}
    ...
    template<typename UpdatedAtT = Aws::Utils::DateTime>
    GetLinkResult& WithUpdatedAt(UpdatedAtT&& value) { SetUpdatedAt(std::forward<UpdatedAtT>(value)); return *this;}
    ///@}
    ...
    inline GetLinkResult& WithDirection(LinkDirection value) { SetDirection(value); return *this;}
    ///@}
    ...
    template<typename FlowModulesT = Aws::Vector<ModuleConfiguration>>
    GetLinkResult& WithFlowModules(FlowModulesT&& value) { SetFlowModules(std::forward<FlowModulesT>(value)); return *this;}
    template<typename FlowModulesT = ModuleConfiguration>
    GetLinkResult& AddFlowModules(FlowModulesT&& value) { m_flowModulesHasBeenSet = true; m_flowModules.emplace_back(std::forward<FlowModulesT>(value)); return *this; }
    ///@}
    ...
    template<typename PendingFlowModulesT = Aws::Vector<ModuleConfiguration>>
    GetLinkResult& WithPendingFlowModules(PendingFlowModulesT&& value) { SetPendingFlowModules(std::forward<PendingFlowModulesT>(value)); return *this;}
    template<typename PendingFlowModulesT = ModuleConfiguration>
    GetLinkResult& AddPendingFlowModules(PendingFlowModulesT&& value) { m_pendingFlowModulesHasBeenSet = true; m_pendingFlowModules.emplace_back(std::forward<PendingFlowModulesT>(value)); return *this; }
    ///@}
    ...
    template<typename AttributesT = LinkAttributes>
    GetLinkResult& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    GetLinkResult& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Map<Aws::String, Aws::String>>
    GetLinkResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    ...
    template<typename LogSettingsT = LinkLogSettings>
    GetLinkResult& WithLogSettings(LogSettingsT&& value) { SetLogSettings(std::forward<LogSettingsT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    GetLinkResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
