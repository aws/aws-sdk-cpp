...
namespace Model
{
  ...
  public:
    ...
    inline void SetErrorLog(double value) { m_errorLogHasBeenSet = true; m_errorLog = value; }
    inline LinkApplicationLogSampling& WithErrorLog(double value) { SetErrorLog(value); return *this;}
    ///@}
    ...
    inline void SetFilterLog(double value) { m_filterLogHasBeenSet = true; m_filterLog = value; }
    inline LinkApplicationLogSampling& WithFilterLog(double value) { SetFilterLog(value); return *this;}
    ///@}
  private:
