...
namespace Model
{
  ...
  public:
    ...
    template<typename ClientTokenT = Aws::String>
    UpdateLinkModuleFlowRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayIdT = Aws::String>
    UpdateLinkModuleFlowRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    UpdateLinkModuleFlowRequest& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
    ...
    void SetModules(ModulesT&& value) { m_modulesHasBeenSet = true; m_modules = std::forward<ModulesT>(value); }
    template<typename ModulesT = Aws::Vector<ModuleConfiguration>>
    UpdateLinkModuleFlowRequest& WithModules(ModulesT&& value) { SetModules(std::forward<ModulesT>(value)); return *this;}
    template<typename ModulesT = ModuleConfiguration>
    UpdateLinkModuleFlowRequest& AddModules(ModulesT&& value) { m_modulesHasBeenSet = true; m_modules.emplace_back(std::forward<ModulesT>(value)); return *this; }
    ///@}
  private:
