...
class AssociateCertificateResult {
 public:
  AWS_RTBFABRIC_API AssociateCertificateResult() = default;
  AWS_RTBFABRIC_API AssociateCertificateResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_RTBFABRIC_API AssociateCertificateResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename GatewayIdT = Aws::String>
  AssociateCertificateResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename AcmCertificateArnT = Aws::String>
  AssociateCertificateResult& WithAcmCertificateArn(AcmCertificateArnT&& value) {
  ...
  inline AssociateCertificateResult& WithStatus(CertificateAssociationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
