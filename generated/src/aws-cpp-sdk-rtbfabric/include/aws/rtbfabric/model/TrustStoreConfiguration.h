...
namespace Model
{
  ...
  public:
    ...
    void SetCertificateAuthorityCertificates(CertificateAuthorityCertificatesT&& value) { m_certificateAuthorityCertificatesHasBeenSet = true; m_certificateAuthorityCertificates = std::forward<CertificateAuthorityCertificatesT>(value); }
    template<typename CertificateAuthorityCertificatesT = Aws::Vector<Aws::String>>
    TrustStoreConfiguration& WithCertificateAuthorityCertificates(CertificateAuthorityCertificatesT&& value) { SetCertificateAuthorityCertificates(std::forward<CertificateAuthorityCertificatesT>(value)); return *this;}
    template<typename CertificateAuthorityCertificatesT = Aws::String>
    TrustStoreConfiguration& AddCertificateAuthorityCertificates(CertificateAuthorityCertificatesT&& value) { m_certificateAuthorityCertificatesHasBeenSet = true; m_certificateAuthorityCertificates.emplace_back(std::forward<CertificateAuthorityCertificatesT>(value)); return *this; }
    ///@}
  private:
