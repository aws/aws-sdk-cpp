...
namespace Model
{
  ...
  public:
    ...
    template<typename HttpCodeT = Aws::String>
    ResponderErrorMaskingForHttpCode& WithHttpCode(HttpCodeT&& value) { SetHttpCode(std::forward<HttpCodeT>(value)); return *this;}
    ///@}
    ...
    inline void SetAction(ResponderErrorMaskingAction value) { m_actionHasBeenSet = true; m_action = value; }
    inline ResponderErrorMaskingForHttpCode& WithAction(ResponderErrorMaskingAction value) { SetAction(value); return *this;}
    ///@}
    ...
    void SetLoggingTypes(LoggingTypesT&& value) { m_loggingTypesHasBeenSet = true; m_loggingTypes = std::forward<LoggingTypesT>(value); }
    template<typename LoggingTypesT = Aws::Vector<ResponderErrorMaskingLoggingType>>
    ResponderErrorMaskingForHttpCode& WithLoggingTypes(LoggingTypesT&& value) { SetLoggingTypes(std::forward<LoggingTypesT>(value)); return *this;}
    inline ResponderErrorMaskingForHttpCode& AddLoggingTypes(ResponderErrorMaskingLoggingType value) { m_loggingTypesHasBeenSet = true; m_loggingTypes.push_back(value); return *this; }
    ///@}
    ...
    inline void SetResponseLoggingPercentage(double value) { m_responseLoggingPercentageHasBeenSet = true; m_responseLoggingPercentage = value; }
    inline ResponderErrorMaskingForHttpCode& WithResponseLoggingPercentage(double value) { SetResponseLoggingPercentage(value); return *this;}
    ///@}
  private:
