...
class ManagedEndpointConfiguration {
 public:
  ...
  template <typename AutoScalingGroupsT = AutoScalingGroupsConfiguration>
  ManagedEndpointConfiguration& WithAutoScalingGroups(AutoScalingGroupsT&& value) {
  ...
  void SetEksEndpoints(EksEndpointsT&& value) {
    m_eksEndpointsHasBeenSet = true;
    m_eksEndpoints = std::forward<EksEndpointsT>(value);
  }
  template <typename EksEndpointsT = EksEndpointsConfiguration>
  ManagedEndpointConfiguration& WithEksEndpoints(EksEndpointsT&& value) {
    SetEksEndpoints(std::forward<EksEndpointsT>(value));
    return *this;
  }
  ///@}
 private:
