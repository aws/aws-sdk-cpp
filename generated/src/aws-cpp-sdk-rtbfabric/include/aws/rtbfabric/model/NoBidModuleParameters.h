...
namespace Model
{
  ...
  public:
    ...
    template<typename ReasonT = Aws::String>
    NoBidModuleParameters& WithReason(ReasonT&& value) { SetReason(std::forward<ReasonT>(value)); return *this;}
    ///@}
    ...
    inline void SetReasonCode(int value) { m_reasonCodeHasBeenSet = true; m_reasonCode = value; }
    inline NoBidModuleParameters& WithReasonCode(int value) { SetReasonCode(value); return *this;}
    ///@}
    ...
    inline void SetPassThroughPercentage(double value) { m_passThroughPercentageHasBeenSet = true; m_passThroughPercentage = value; }
    inline NoBidModuleParameters& WithPassThroughPercentage(double value) { SetPassThroughPercentage(value); return *this;}
    ///@}
  private:
