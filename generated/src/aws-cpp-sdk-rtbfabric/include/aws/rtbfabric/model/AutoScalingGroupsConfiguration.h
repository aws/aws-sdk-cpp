...
namespace Model
{
  ...
  public:
    ...
    template<typename AutoScalingGroupNamesT = Aws::Vector<Aws::String>>
    AutoScalingGroupsConfiguration& WithAutoScalingGroupNames(AutoScalingGroupNamesT&& value) { SetAutoScalingGroupNames(std::forward<AutoScalingGroupNamesT>(value)); return *this;}
    template<typename AutoScalingGroupNamesT = Aws::String>
    AutoScalingGroupsConfiguration& AddAutoScalingGroupNames(AutoScalingGroupNamesT&& value) { m_autoScalingGroupNamesHasBeenSet = true; m_autoScalingGroupNames.emplace_back(std::forward<AutoScalingGroupNamesT>(value)); return *this; }
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    AutoScalingGroupsConfiguration& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
  private:
