...
namespace Model
{
  ...
  public:
    ...
    template<typename LinkIdT = Aws::String>
    UpdateLinkResult& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateLinkResult& WithStatus(LinkStatus value) { SetStatus(value); return *this;}
    ///@}
