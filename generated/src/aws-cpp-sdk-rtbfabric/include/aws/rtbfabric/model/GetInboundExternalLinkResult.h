...
class GetInboundExternalLinkResult {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  GetInboundExternalLinkResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  GetInboundExternalLinkResult& WithLinkId(LinkIdT&& value) {
  ...
  inline GetInboundExternalLinkResult& WithStatus(LinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DomainNameT = Aws::String>
  GetInboundExternalLinkResult& WithDomainName(DomainNameT&& value) {
  ...
  template <typename FlowModulesT = Aws::Vector<ModuleConfiguration>>
  GetInboundExternalLinkResult& WithFlowModules(FlowModulesT&& value) {
    SetFlowModules(std::forward<FlowModulesT>(value));
    return *this;
  }
  template <typename FlowModulesT = ModuleConfiguration>
  GetInboundExternalLinkResult& AddFlowModules(FlowModulesT&& value) {
    m_flowModulesHasBeenSet = true;
  ...
  template <typename PendingFlowModulesT = Aws::Vector<ModuleConfiguration>>
  GetInboundExternalLinkResult& WithPendingFlowModules(PendingFlowModulesT&& value) {
    SetPendingFlowModules(std::forward<PendingFlowModulesT>(value));
    return *this;
  }
  template <typename PendingFlowModulesT = ModuleConfiguration>
  GetInboundExternalLinkResult& AddPendingFlowModules(PendingFlowModulesT&& value) {
    m_pendingFlowModulesHasBeenSet = true;
  ...
  template <typename AttributesT = LinkAttributes>
  GetInboundExternalLinkResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetInboundExternalLinkResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetInboundExternalLinkResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetInboundExternalLinkResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetInboundExternalLinkResult& WithRequestId(RequestIdT&& value) {
