...
namespace Model
{
  ...
  public:
    ...
    void SetResponderErrorMasking(ResponderErrorMaskingT&& value) { m_responderErrorMaskingHasBeenSet = true; m_responderErrorMasking = std::forward<ResponderErrorMaskingT>(value); }
    template<typename ResponderErrorMaskingT = Aws::Vector<ResponderErrorMaskingForHttpCode>>
    LinkAttributes& WithResponderErrorMasking(ResponderErrorMaskingT&& value) { SetResponderErrorMasking(std::forward<ResponderErrorMaskingT>(value)); return *this;}
    template<typename ResponderErrorMaskingT = ResponderErrorMaskingForHttpCode>
    LinkAttributes& AddResponderErrorMasking(ResponderErrorMaskingT&& value) { m_responderErrorMaskingHasBeenSet = true; m_responderErrorMasking.emplace_back(std::forward<ResponderErrorMaskingT>(value)); return *this; }
    ///@}
    ...
    template<typename CustomerProvidedIdT = Aws::String>
    LinkAttributes& WithCustomerProvidedId(CustomerProvidedIdT&& value) { SetCustomerProvidedId(std::forward<CustomerProvidedIdT>(value)); return *this;}
    ///@}
  private:
