...
namespace Model
{
  ...
  public:
    ...
    inline void SetNoBidReasonCode(int value) { m_noBidReasonCodeHasBeenSet = true; m_noBidReasonCode = value; }
    inline NoBidAction& WithNoBidReasonCode(int value) { SetNoBidReasonCode(value); return *this;}
    ///@}
  private:
