...
class RejectLinkResult {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  RejectLinkResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename PeerGatewayIdT = Aws::String>
  RejectLinkResult& WithPeerGatewayId(PeerGatewayIdT&& value) {
  ...
  inline RejectLinkResult& WithStatus(LinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  RejectLinkResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RejectLinkResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline RejectLinkResult& WithDirection(LinkDirection value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  template <typename FlowModulesT = Aws::Vector<ModuleConfiguration>>
  RejectLinkResult& WithFlowModules(FlowModulesT&& value) {
    SetFlowModules(std::forward<FlowModulesT>(value));
    return *this;
  }
  template <typename FlowModulesT = ModuleConfiguration>
  RejectLinkResult& AddFlowModules(FlowModulesT&& value) {
    m_flowModulesHasBeenSet = true;
  ...
  template <typename PendingFlowModulesT = Aws::Vector<ModuleConfiguration>>
  RejectLinkResult& WithPendingFlowModules(PendingFlowModulesT&& value) {
    SetPendingFlowModules(std::forward<PendingFlowModulesT>(value));
    return *this;
  }
  template <typename PendingFlowModulesT = ModuleConfiguration>
  RejectLinkResult& AddPendingFlowModules(PendingFlowModulesT&& value) {
    m_pendingFlowModulesHasBeenSet = true;
  ...
  template <typename AttributesT = LinkAttributes>
  RejectLinkResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  RejectLinkResult& WithLinkId(LinkIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RejectLinkResult& WithRequestId(RequestIdT&& value) {
