...
/**
 */
class UntagResourceRequest : public RTBFabricRequest {
 public:
  AWS_RTBFABRIC_API UntagResourceRequest() = default;
  ...
  ///@{
  /**
   * <p>The keys of the key-value pairs for the tag or tags you want to remove from
