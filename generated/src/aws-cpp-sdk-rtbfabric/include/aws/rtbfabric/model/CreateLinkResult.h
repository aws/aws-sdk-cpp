...
class CreateLinkResult {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  CreateLinkResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename PeerGatewayIdT = Aws::String>
  CreateLinkResult& WithPeerGatewayId(PeerGatewayIdT&& value) {
  ...
  inline CreateLinkResult& WithStatus(LinkStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  CreateLinkResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  CreateLinkResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  inline CreateLinkResult& WithDirection(LinkDirection value) {
    SetDirection(value);
    return *this;
  }
  ///@}
  ...
  template <typename FlowModulesT = Aws::Vector<ModuleConfiguration>>
  CreateLinkResult& WithFlowModules(FlowModulesT&& value) {
    SetFlowModules(std::forward<FlowModulesT>(value));
    return *this;
  }
  template <typename FlowModulesT = ModuleConfiguration>
  CreateLinkResult& AddFlowModules(FlowModulesT&& value) {
    m_flowModulesHasBeenSet = true;
  ...
  template <typename PendingFlowModulesT = Aws::Vector<ModuleConfiguration>>
  CreateLinkResult& WithPendingFlowModules(PendingFlowModulesT&& value) {
    SetPendingFlowModules(std::forward<PendingFlowModulesT>(value));
    return *this;
  }
  template <typename PendingFlowModulesT = ModuleConfiguration>
  CreateLinkResult& AddPendingFlowModules(PendingFlowModulesT&& value) {
    m_pendingFlowModulesHasBeenSet = true;
  ...
  template <typename AttributesT = LinkAttributes>
  CreateLinkResult& WithAttributes(AttributesT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  CreateLinkResult& WithLinkId(LinkIdT&& value) {
  ...
  template <typename CustomerProvidedIdT = Aws::String>
  CreateLinkResult& WithCustomerProvidedId(CustomerProvidedIdT&& value) {
