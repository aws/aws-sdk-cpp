...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdT = Aws::String>
    UpdateLinkRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LogSettingsT = LinkLogSettings>
    UpdateLinkRequest& WithLogSettings(LogSettingsT&& value) { SetLogSettings(std::forward<LogSettingsT>(value)); return *this;}
    ///@}
  private:
