...
class AcceptLinkRequest : public RTBFabricRequest {
 public:
  ...
  template <typename GatewayIdT = Aws::String>
  AcceptLinkRequest& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename LinkIdT = Aws::String>
  AcceptLinkRequest& WithLinkId(LinkIdT&& value) {
  ...
  template <typename AttributesT = LinkAttributes>
  AcceptLinkRequest& WithAttributes(AttributesT&& value) {
  ...
  template <typename LogSettingsT = LinkLogSettings>
  AcceptLinkRequest& WithLogSettings(LogSettingsT&& value) {
  ...
  inline AcceptLinkRequest& WithTimeoutInMillis(long long value) {
