...
namespace Model
{
  ...
  /**
   */
  class AcceptLinkRequest : public RTBFabricRequest
  {
  public:
    AWS_RTBFABRIC_API AcceptLinkRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "AcceptLink"; }
    ...
    template<typename GatewayIdT = Aws::String>
    AcceptLinkRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    AcceptLinkRequest& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AttributesT = LinkAttributes>
    AcceptLinkRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ///@}
    ...
    template<typename LogSettingsT = LinkLogSettings>
    AcceptLinkRequest& WithLogSettings(LogSettingsT&& value) { SetLogSettings(std::forward<LogSettingsT>(value)); return *this;}
    ///@}
  private:
