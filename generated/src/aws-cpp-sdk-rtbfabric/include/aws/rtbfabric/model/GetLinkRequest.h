...
namespace Model
{
  ...
  /**
   */
  class GetLinkRequest : public RTBFabricRequest
  {
  public:
    AWS_RTBFABRIC_API GetLinkRequest() = default;
    ...
    template<typename GatewayIdT = Aws::String>
    GetLinkRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LinkIdT = Aws::String>
    GetLinkRequest& WithLinkId(LinkIdT&& value) { SetLinkId(std::forward<LinkIdT>(value)); return *this;}
    ///@}
  private:
