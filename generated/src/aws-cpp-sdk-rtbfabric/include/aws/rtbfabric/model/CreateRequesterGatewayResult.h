...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdT = Aws::String>
    CreateRequesterGatewayResult& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DomainNameT = Aws::String>
    CreateRequesterGatewayResult& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    inline CreateRequesterGatewayResult& WithStatus(RequesterGatewayStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateRequesterGatewayResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
