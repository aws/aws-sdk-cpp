...
namespace Model
{
  ...
  public:
    ...
    template<typename DomainNameT = Aws::String>
    UpdateResponderGatewayRequest& WithDomainName(DomainNameT&& value) { SetDomainName(std::forward<DomainNameT>(value)); return *this;}
    ///@}
    ...
    inline UpdateResponderGatewayRequest& WithPort(int value) { SetPort(value); return *this;}
    ///@}
    ...
    inline UpdateResponderGatewayRequest& WithProtocol(Protocol value) { SetProtocol(value); return *this;}
    ///@}
    ...
    template<typename TrustStoreConfigurationT = TrustStoreConfiguration>
    UpdateResponderGatewayRequest& WithTrustStoreConfiguration(TrustStoreConfigurationT&& value) { SetTrustStoreConfiguration(std::forward<TrustStoreConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ManagedEndpointConfigurationT = ManagedEndpointConfiguration>
    UpdateResponderGatewayRequest& WithManagedEndpointConfiguration(ManagedEndpointConfigurationT&& value) { SetManagedEndpointConfiguration(std::forward<ManagedEndpointConfigurationT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    UpdateResponderGatewayRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayIdT = Aws::String>
    UpdateResponderGatewayRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    UpdateResponderGatewayRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
  private:
