...
class CreateInboundExternalLinkRequest : public RTBFabricRequest {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateInboundExternalLinkRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename GatewayIdT = Aws::String>
  CreateInboundExternalLinkRequest& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename AttributesT = LinkAttributes>
  CreateInboundExternalLinkRequest& WithAttributes(AttributesT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateInboundExternalLinkRequest& WithTags(TagsT&& value) {
