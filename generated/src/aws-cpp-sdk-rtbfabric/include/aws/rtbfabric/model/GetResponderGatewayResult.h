...
class GetResponderGatewayResult {
 public:
  ...
  template <typename VpcIdT = Aws::String>
  GetResponderGatewayResult& WithVpcId(VpcIdT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  GetResponderGatewayResult& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  GetResponderGatewayResult& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename SecurityGroupIdsT = Aws::Vector<Aws::String>>
  GetResponderGatewayResult& WithSecurityGroupIds(SecurityGroupIdsT&& value) {
    SetSecurityGroupIds(std::forward<SecurityGroupIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupIdsT = Aws::String>
  GetResponderGatewayResult& AddSecurityGroupIds(SecurityGroupIdsT&& value) {
    m_securityGroupIdsHasBeenSet = true;
  ...
  inline GetResponderGatewayResult& WithStatus(ResponderGatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  GetResponderGatewayResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  GetResponderGatewayResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  GetResponderGatewayResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename DomainNameT = Aws::String>
  GetResponderGatewayResult& WithDomainName(DomainNameT&& value) {
  ...
  inline GetResponderGatewayResult& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline GetResponderGatewayResult& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  template <typename TrustStoreConfigurationT = TrustStoreConfiguration>
  GetResponderGatewayResult& WithTrustStoreConfiguration(TrustStoreConfigurationT&& value) {
  ...
  template <typename ManagedEndpointConfigurationT = ManagedEndpointConfiguration>
  GetResponderGatewayResult& WithManagedEndpointConfiguration(ManagedEndpointConfigurationT&& value) {
  ...
  template <typename GatewayIdT = Aws::String>
  GetResponderGatewayResult& WithGatewayId(GatewayIdT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  GetResponderGatewayResult& WithTags(TagsT&& value) {
  ...
  inline GetResponderGatewayResult& WithActiveLinksCount(int value) {
  ...
  inline GetResponderGatewayResult& WithTotalLinksCount(int value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetResponderGatewayResult& WithRequestId(RequestIdT&& value) {
