...
namespace Model
{
  ...
  public:
    ...
    template<typename LinksT = Aws::Vector<ListLinksResponseStructure>>
    ListLinksResult& WithLinks(LinksT&& value) { SetLinks(std::forward<LinksT>(value)); return *this;}
    template<typename LinksT = ListLinksResponseStructure>
    ListLinksResult& AddLinks(LinksT&& value) { m_linksHasBeenSet = true; m_links.emplace_back(std::forward<LinksT>(value)); return *this; }
    ///@}
