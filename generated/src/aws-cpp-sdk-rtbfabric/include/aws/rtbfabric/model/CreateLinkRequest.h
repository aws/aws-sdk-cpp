...
namespace Model
{
  ...
  public:
    ...
    template<typename GatewayIdT = Aws::String>
    CreateLinkRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename PeerGatewayIdT = Aws::String>
    CreateLinkRequest& WithPeerGatewayId(PeerGatewayIdT&& value) { SetPeerGatewayId(std::forward<PeerGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename AttributesT = LinkAttributes>
    CreateLinkRequest& WithAttributes(AttributesT&& value) { SetAttributes(std::forward<AttributesT>(value)); return *this;}
    ///@}
    ...
    inline void SetHttpResponderAllowed(bool value) { m_httpResponderAllowedHasBeenSet = true; m_httpResponderAllowed = value; }
    inline CreateLinkRequest& WithHttpResponderAllowed(bool value) { SetHttpResponderAllowed(value); return *this;}
    ///@}
    ...
    template<typename LogSettingsT = LinkLogSettings>
    CreateLinkRequest& WithLogSettings(LogSettingsT&& value) { SetLogSettings(std::forward<LogSettingsT>(value)); return *this;}
    ///@}
  private:
