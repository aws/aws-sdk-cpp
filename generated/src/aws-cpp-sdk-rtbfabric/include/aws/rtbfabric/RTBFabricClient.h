...
namespace RTBFabric
{
   ...
   */
  class AWS_RTBFABRIC_API RTBFabricClient : public Aws::Client::AWSJsonClient, public Aws::Client::ClientWithAsyncTemplateMethods<RTBFabricClient>
  {
    public:
      ...
      typedef RTBFabricEndpointProvider EndpointProviderType;
        ...
        * is not specified, it will be initialized to default values.
        */
        RTBFabricClient(const Aws::Auth::AWSCredentials& credentials,
                        std::shared_ptr<RTBFabricEndpointProviderBase> endpointProvider = nullptr,
        ...
        */
        ...
        /**
         * An Async wrapper for AcceptLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename AcceptLinkRequestT = Model::AcceptLinkRequest>
        void AcceptLinkAsync(const AcceptLinkRequestT& request, const AcceptLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for CreateInboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename CreateInboundExternalLinkRequestT = Model::CreateInboundExternalLinkRequest>
        Model::CreateInboundExternalLinkOutcomeCallable CreateInboundExternalLinkCallable(const CreateInboundExternalLinkRequestT& request) const
        {
            return SubmitCallable(&RTBFabricClient::CreateInboundExternalLink, request);
        }

        /**
         * An Async wrapper for CreateInboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CreateInboundExternalLinkRequestT = Model::CreateInboundExternalLinkRequest>
        void CreateInboundExternalLinkAsync(const CreateInboundExternalLinkRequestT& request, const CreateInboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::CreateOutboundExternalLinkOutcome CreateOutboundExternalLink(const Model::CreateOutboundExternalLinkRequest& request) const;

        /**
         * A Callable wrapper for CreateOutboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename CreateOutboundExternalLinkRequestT = Model::CreateOutboundExternalLinkRequest>
        Model::CreateOutboundExternalLinkOutcomeCallable CreateOutboundExternalLinkCallable(const CreateOutboundExternalLinkRequestT& request) const
        {
            return SubmitCallable(&RTBFabricClient::CreateOutboundExternalLink, request);
        }

        /**
         * An Async wrapper for CreateOutboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CreateOutboundExternalLinkRequestT = Model::CreateOutboundExternalLinkRequest>
        void CreateOutboundExternalLinkAsync(const CreateOutboundExternalLinkRequestT& request, const CreateOutboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for CreateRequesterGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CreateRequesterGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CreateRequesterGatewayRequestT = Model::CreateRequesterGatewayRequest>
        void CreateRequesterGatewayAsync(const CreateRequesterGatewayRequestT& request, const CreateRequesterGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for CreateResponderGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for CreateResponderGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename CreateResponderGatewayRequestT = Model::CreateResponderGatewayRequest>
        void CreateResponderGatewayAsync(const CreateResponderGatewayRequestT& request, const CreateResponderGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for DeleteInboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename DeleteInboundExternalLinkRequestT = Model::DeleteInboundExternalLinkRequest>
        Model::DeleteInboundExternalLinkOutcomeCallable DeleteInboundExternalLinkCallable(const DeleteInboundExternalLinkRequestT& request) const
        {
            return SubmitCallable(&RTBFabricClient::DeleteInboundExternalLink, request);
        }

        /**
         * An Async wrapper for DeleteInboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DeleteInboundExternalLinkRequestT = Model::DeleteInboundExternalLinkRequest>
        void DeleteInboundExternalLinkAsync(const DeleteInboundExternalLinkRequestT& request, const DeleteInboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
         ...
         * API Reference</a></p>
         */
        virtual Model::DeleteOutboundExternalLinkOutcome DeleteOutboundExternalLink(const Model::DeleteOutboundExternalLinkRequest& request) const;

        /**
         * A Callable wrapper for DeleteOutboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        template<typename DeleteOutboundExternalLinkRequestT = Model::DeleteOutboundExternalLinkRequest>
        Model::DeleteOutboundExternalLinkOutcomeCallable DeleteOutboundExternalLinkCallable(const DeleteOutboundExternalLinkRequestT& request) const
        {
            return SubmitCallable(&RTBFabricClient::DeleteOutboundExternalLink, request);
        }

        /**
         * An Async wrapper for DeleteOutboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DeleteOutboundExternalLinkRequestT = Model::DeleteOutboundExternalLinkRequest>
        void DeleteOutboundExternalLinkAsync(const DeleteOutboundExternalLinkRequestT& request, const DeleteOutboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for DeleteRequesterGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeleteRequesterGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DeleteRequesterGatewayRequestT = Model::DeleteRequesterGatewayRequest>
        void DeleteRequesterGatewayAsync(const DeleteRequesterGatewayRequestT& request, const DeleteRequesterGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for DeleteResponderGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for DeleteResponderGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename DeleteResponderGatewayRequestT = Model::DeleteResponderGatewayRequest>
        void DeleteResponderGatewayAsync(const DeleteResponderGatewayRequestT& request, const DeleteResponderGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetInboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetInboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetInboundExternalLinkRequestT = Model::GetInboundExternalLinkRequest>
        void GetInboundExternalLinkAsync(const GetInboundExternalLinkRequestT& request, const GetInboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetOutboundExternalLink that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetOutboundExternalLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetOutboundExternalLinkRequestT = Model::GetOutboundExternalLinkRequest>
        void GetOutboundExternalLinkAsync(const GetOutboundExternalLinkRequestT& request, const GetOutboundExternalLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetRequesterGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetRequesterGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetRequesterGatewayRequestT = Model::GetRequesterGatewayRequest>
        void GetRequesterGatewayAsync(const GetRequesterGatewayRequestT& request, const GetRequesterGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for GetResponderGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for GetResponderGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename GetResponderGatewayRequestT = Model::GetResponderGatewayRequest>
        void GetResponderGatewayAsync(const GetResponderGatewayRequestT& request, const GetResponderGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for ListRequesterGateways that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListRequesterGateways that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListRequesterGatewaysRequestT = Model::ListRequesterGatewaysRequest>
        void ListRequesterGatewaysAsync(const ListRequesterGatewaysResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ListRequesterGatewaysRequestT& request = {}) const
        {
        ...
        /**
         * A Callable wrapper for ListResponderGateways that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for ListResponderGateways that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename ListResponderGatewaysRequestT = Model::ListResponderGatewaysRequest>
        void ListResponderGatewaysAsync(const ListResponderGatewaysResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr, const ListResponderGatewaysRequestT& request = {}) const
        {
        ...
        /**
         * An Async wrapper for RejectLink that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename RejectLinkRequestT = Model::RejectLinkRequest>
        void RejectLinkAsync(const RejectLinkRequestT& request, const RejectLinkResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for UpdateLinkModuleFlow that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdateLinkModuleFlow that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdateLinkModuleFlowRequestT = Model::UpdateLinkModuleFlowRequest>
        void UpdateLinkModuleFlowAsync(const UpdateLinkModuleFlowRequestT& request, const UpdateLinkModuleFlowResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for UpdateRequesterGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdateRequesterGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdateRequesterGatewayRequestT = Model::UpdateRequesterGatewayRequest>
        void UpdateRequesterGatewayAsync(const UpdateRequesterGatewayRequestT& request, const UpdateRequesterGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
        ...
        /**
         * A Callable wrapper for UpdateResponderGateway that returns a future to the operation so that it can be executed in parallel to other requests.
         */
        ...
        /**
         * An Async wrapper for UpdateResponderGateway that queues the request into a thread executor and triggers associated callback when operation has finished.
         */
        template<typename UpdateResponderGatewayRequestT = Model::UpdateResponderGatewayRequest>
        void UpdateResponderGatewayAsync(const UpdateResponderGatewayRequestT& request, const UpdateResponderGatewayResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const
        {
