...
namespace Batch
{
const size_t BatchEndpointRules::RulesBlobStrLen = 4168;
const size_t BatchEndpointRules::RulesBlobSize = 4169;
...
'n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','f','i','p','s','.',
'b','a','t','c','h','.','{','R','e','g','i','o','n','}','.','a','m','a','z','o','n','a','w','s','.',
...
't','c','h','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
':','"','h','t','t','p','s',':','/','/','b','a','t','c','h','.','{','R','e','g','i','o','n','}','.',
...
const char* BatchEndpointRules::GetRulesBlob()
{
