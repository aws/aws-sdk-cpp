...
CreateQuotaShareResult::CreateQuotaShareResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CreateQuotaShareResult& CreateQuotaShareResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
