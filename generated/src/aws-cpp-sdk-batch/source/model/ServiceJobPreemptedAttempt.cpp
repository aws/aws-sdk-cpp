...
ServiceJobPreemptedAttempt::ServiceJobPreemptedAttempt(JsonView jsonValue) { *this = jsonValue; }

ServiceJobPreemptedAttempt& ServiceJobPreemptedAttempt::operator=(JsonView jsonValue) {
...
JsonValue ServiceJobPreemptedAttempt::Jsonize() const {
  JsonValue payload;
