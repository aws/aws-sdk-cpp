...
CRUpdateAllocationStrategy GetCRUpdateAllocationStrategyForName(const Aws::String& name) {
  ...
  if (hashCode == BEST_FIT_PROGRESSIVE_HASH) {
    ...
    return CRUpdateAllocationStrategy::BEST_FIT_PROGRESSIVE_ORDERED;
    ...
    return CRUpdateAllocationStrategy::SPOT_CAPACITY_OPTIMIZED_PRIORITIZED;
  }
...
Aws::String GetNameForCRUpdateAllocationStrategy(CRUpdateAllocationStrategy enumValue) {
  switch (enumValue) {
    ...
    case CRUpdateAllocationStrategy::BEST_FIT_PROGRESSIVE_ORDERED:
    ...
    case CRUpdateAllocationStrategy::SPOT_CAPACITY_OPTIMIZED_PRIORITIZED:
