...
QuotaShareCapacityLimit::QuotaShareCapacityLimit(JsonView jsonValue) { *this = jsonValue; }

QuotaShareCapacityLimit& QuotaShareCapacityLimit::operator=(JsonView jsonValue) {
...
JsonValue QuotaShareCapacityLimit::Jsonize() const {
  JsonValue payload;
