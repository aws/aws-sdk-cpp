...
TerminateJobsResult::TerminateJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

TerminateJobsResult& TerminateJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
