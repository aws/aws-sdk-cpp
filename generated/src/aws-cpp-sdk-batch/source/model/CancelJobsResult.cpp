...
CancelJobsResult::CancelJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

CancelJobsResult& CancelJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
