...
TaskContainerProperties::TaskContainerProperties(JsonView jsonValue) { *this = jsonValue; }

TaskContainerProperties& TaskContainerProperties::operator=(JsonView jsonValue) {
...
JsonValue TaskContainerProperties::Jsonize() const {
  JsonValue payload;
