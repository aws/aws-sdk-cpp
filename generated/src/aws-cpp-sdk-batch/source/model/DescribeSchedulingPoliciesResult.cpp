...
DescribeSchedulingPoliciesResult::DescribeSchedulingPoliciesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeSchedulingPoliciesResult& DescribeSchedulingPoliciesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("schedulingPolicies")) {
    ...
    for (unsigned schedulingPoliciesIndex = 0; schedulingPoliciesIndex < schedulingPoliciesJsonList.GetLength();
         ++schedulingPoliciesIndex) {
