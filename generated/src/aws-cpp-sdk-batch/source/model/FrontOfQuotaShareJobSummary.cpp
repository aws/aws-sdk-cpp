...
FrontOfQuotaShareJobSummary::FrontOfQuotaShareJobSummary(JsonView jsonValue) { *this = jsonValue; }

FrontOfQuotaShareJobSummary& FrontOfQuotaShareJobSummary::operator=(JsonView jsonValue) {
...
JsonValue FrontOfQuotaShareJobSummary::Jsonize() const {
  JsonValue payload;
