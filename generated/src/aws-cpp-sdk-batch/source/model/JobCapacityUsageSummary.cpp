...
JobCapacityUsageSummary::JobCapacityUsageSummary(JsonView jsonValue) { *this = jsonValue; }

JobCapacityUsageSummary& JobCapacityUsageSummary::operator=(JsonView jsonValue) {
...
JsonValue JobCapacityUsageSummary::Jsonize() const {
  JsonValue payload;
