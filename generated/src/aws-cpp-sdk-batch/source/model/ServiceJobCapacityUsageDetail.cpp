...
ServiceJobCapacityUsageDetail::ServiceJobCapacityUsageDetail(JsonView jsonValue) { *this = jsonValue; }

ServiceJobCapacityUsageDetail& ServiceJobCapacityUsageDetail::operator=(JsonView jsonValue) {
...
JsonValue ServiceJobCapacityUsageDetail::Jsonize() const {
  JsonValue payload;
