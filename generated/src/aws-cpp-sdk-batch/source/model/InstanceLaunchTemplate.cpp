...
InstanceLaunchTemplate::InstanceLaunchTemplate(JsonView jsonValue) { *this = jsonValue; }
...
InstanceLaunchTemplate& InstanceLaunchTemplate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("capacityOptionType")) {
    m_capacityOptionType = jsonValue.GetString("capacityOptionType");
...
JsonValue InstanceLaunchTemplate::Jsonize() const {
  ...
  if (m_capacityOptionTypeHasBeenSet) {
    payload.WithString("capacityOptionType", m_capacityOptionType);
  }
