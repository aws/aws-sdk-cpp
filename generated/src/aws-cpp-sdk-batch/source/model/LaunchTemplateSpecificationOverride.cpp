...
LaunchTemplateSpecificationOverride::LaunchTemplateSpecificationOverride(JsonView jsonValue) { *this = jsonValue; }
...
LaunchTemplateSpecificationOverride& LaunchTemplateSpecificationOverride::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("targetInstanceTypes")) {
    ...
    for (unsigned targetInstanceTypesIndex = 0; targetInstanceTypesIndex < targetInstanceTypesJsonList.GetLength();
         ++targetInstanceTypesIndex) {
