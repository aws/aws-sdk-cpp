...
ComputeResourceUpdate::ComputeResourceUpdate(JsonView jsonValue) { *this = jsonValue; }
...
ComputeResourceUpdate& ComputeResourceUpdate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("allocationStrategy")) {
    m_allocationStrategy =
        CRUpdateAllocationStrategyMapper::GetCRUpdateAllocationStrategyForName(jsonValue.GetString("allocationStrategy"));
