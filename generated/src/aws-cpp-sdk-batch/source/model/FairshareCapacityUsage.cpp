...
FairshareCapacityUsage::FairshareCapacityUsage(JsonView jsonValue) { *this = jsonValue; }

FairshareCapacityUsage& FairshareCapacityUsage::operator=(JsonView jsonValue) {
...
JsonValue FairshareCapacityUsage::Jsonize() const {
  JsonValue payload;
