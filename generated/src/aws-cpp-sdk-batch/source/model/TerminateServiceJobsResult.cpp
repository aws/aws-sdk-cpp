...
TerminateServiceJobsResult::TerminateServiceJobsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

TerminateServiceJobsResult& TerminateServiceJobsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
