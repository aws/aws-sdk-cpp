...
QuotaShareCapacityUsage::QuotaShareCapacityUsage(JsonView jsonValue) { *this = jsonValue; }

QuotaShareCapacityUsage& QuotaShareCapacityUsage::operator=(JsonView jsonValue) {
...
JsonValue QuotaShareCapacityUsage::Jsonize() const {
  JsonValue payload;
