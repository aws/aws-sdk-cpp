...
class CreateComputeEnvironmentResult {
 public:
  AWS_BATCH_API CreateComputeEnvironmentResult() = default;
  ...
  template <typename ComputeEnvironmentNameT = Aws::String>
  CreateComputeEnvironmentResult& WithComputeEnvironmentName(ComputeEnvironmentNameT&& value) {
  ...
  template <typename ComputeEnvironmentArnT = Aws::String>
  CreateComputeEnvironmentResult& WithComputeEnvironmentArn(ComputeEnvironmentArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateComputeEnvironmentResult& WithRequestId(RequestIdT&& value) {
