...
class ServiceJobRetryStrategy {
 public:
  ...
  inline ServiceJobRetryStrategy& WithAttempts(int value) {
    SetAttempts(value);
    return *this;
  }
  ///@}
  ...
  void SetEvaluateOnExit(EvaluateOnExitT&& value) {
    ...
    m_evaluateOnExit = std::forward<EvaluateOnExitT>(value);
  }
  template <typename EvaluateOnExitT = Aws::Vector<ServiceJobEvaluateOnExit>>
  ServiceJobRetryStrategy& WithEvaluateOnExit(EvaluateOnExitT&& value) {
    SetEvaluateOnExit(std::forward<EvaluateOnExitT>(value));
    return *this;
  }
  ...
  ServiceJobRetryStrategy& AddEvaluateOnExit(EvaluateOnExitT&& value) {
    m_evaluateOnExitHasBeenSet = true;
    m_evaluateOnExit.emplace_back(std::forward<EvaluateOnExitT>(value));
    return *this;
  }
  ///@}
 private:
