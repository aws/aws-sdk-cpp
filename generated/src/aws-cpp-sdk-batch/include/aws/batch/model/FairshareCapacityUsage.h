...
/**
 * <p>The capacity usage for a fairshare scheduling job queue.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/FairshareCapacityUsage">AWS
 * API Reference</a></p>
 */
class FairshareCapacityUsage {
 public:
  AWS_BATCH_API FairshareCapacityUsage() = default;
  AWS_BATCH_API FairshareCapacityUsage(Aws::Utils::Json::JsonView jsonValue);
  AWS_BATCH_API FairshareCapacityUsage& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename CapacityUnitT = Aws::String>
  FairshareCapacityUsage& WithCapacityUnit(CapacityUnitT&& value) {
  ...
  inline FairshareCapacityUsage& WithQuantity(double value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
