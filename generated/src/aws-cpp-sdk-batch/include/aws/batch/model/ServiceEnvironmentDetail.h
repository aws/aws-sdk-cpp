...
class ServiceEnvironmentDetail {
 public:
  ...
  inline ServiceEnvironmentDetail& WithServiceEnvironmentType(ServiceEnvironmentType value) {
  ...
  inline ServiceEnvironmentDetail& WithState(ServiceEnvironmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ServiceEnvironmentStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ServiceEnvironmentDetail& WithStatus(ServiceEnvironmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
