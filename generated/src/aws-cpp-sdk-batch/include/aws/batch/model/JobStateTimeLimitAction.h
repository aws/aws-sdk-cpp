...
class JobStateTimeLimitAction {
 public:
  ...
  inline void SetState(JobStateTimeLimitActionsState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline JobStateTimeLimitAction& WithState(JobStateTimeLimitActionsState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxTimeSeconds(int value) {
    m_maxTimeSecondsHasBeenSet = true;
    m_maxTimeSeconds = value;
  }
  inline JobStateTimeLimitAction& WithMaxTimeSeconds(int value) {
    SetMaxTimeSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAction(JobStateTimeLimitActionsAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline JobStateTimeLimitAction& WithAction(JobStateTimeLimitActionsAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
