...
class ListConsumableResourcesRequest : public BatchRequest {
 public:
  ...
  template <typename FiltersT = Aws::Vector<KeyValuesPair>>
  ListConsumableResourcesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = KeyValuesPair>
  ListConsumableResourcesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListConsumableResourcesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConsumableResourcesRequest& WithNextToken(NextTokenT&& value) {
