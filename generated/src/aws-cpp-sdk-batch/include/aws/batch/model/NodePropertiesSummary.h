...
class NodePropertiesSummary {
 public:
  ...
  inline void SetIsMainNode(bool value) {
    m_isMainNodeHasBeenSet = true;
    m_isMainNode = value;
  }
  inline NodePropertiesSummary& WithIsMainNode(bool value) {
    SetIsMainNode(value);
    return *this;
  }
  ///@}
  ...
  inline NodePropertiesSummary& WithNumNodes(int value) {
    SetNumNodes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNodeIndex(int value) {
    m_nodeIndexHasBeenSet = true;
    m_nodeIndex = value;
  }
  inline NodePropertiesSummary& WithNodeIndex(int value) {
    SetNodeIndex(value);
    return *this;
  }
  ///@}
