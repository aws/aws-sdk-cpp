...
class ListServiceJobsResult {
 public:
  ...
  template <typename JobSummaryListT = Aws::Vector<ServiceJobSummary>>
  ListServiceJobsResult& WithJobSummaryList(JobSummaryListT&& value) {
    SetJobSummaryList(std::forward<JobSummaryListT>(value));
    return *this;
  }
  template <typename JobSummaryListT = ServiceJobSummary>
  ListServiceJobsResult& AddJobSummaryList(JobSummaryListT&& value) {
    m_jobSummaryListHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListServiceJobsResult& WithRequestId(RequestIdT&& value) {
