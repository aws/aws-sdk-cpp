...
class DescribeJobDefinitionsResult {
 public:
  ...
  void SetJobDefinitions(JobDefinitionsT&& value) {
    m_jobDefinitionsHasBeenSet = true;
    m_jobDefinitions = std::forward<JobDefinitionsT>(value);
  }
  template <typename JobDefinitionsT = Aws::Vector<JobDefinition>>
  DescribeJobDefinitionsResult& WithJobDefinitions(JobDefinitionsT&& value) {
    SetJobDefinitions(std::forward<JobDefinitionsT>(value));
    return *this;
  }
  template <typename JobDefinitionsT = JobDefinition>
  DescribeJobDefinitionsResult& AddJobDefinitions(JobDefinitionsT&& value) {
    m_jobDefinitionsHasBeenSet = true;
    m_jobDefinitions.emplace_back(std::forward<JobDefinitionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeJobDefinitionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeJobDefinitionsResult& WithRequestId(RequestIdT&& value) {
