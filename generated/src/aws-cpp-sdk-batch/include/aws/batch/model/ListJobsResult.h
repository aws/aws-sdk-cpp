...
class ListJobsResult {
 public:
  ...
  void SetJobSummaryList(JobSummaryListT&& value) {
    m_jobSummaryListHasBeenSet = true;
    m_jobSummaryList = std::forward<JobSummaryListT>(value);
  }
  template <typename JobSummaryListT = Aws::Vector<JobSummary>>
  ListJobsResult& WithJobSummaryList(JobSummaryListT&& value) {
    SetJobSummaryList(std::forward<JobSummaryListT>(value));
    return *this;
  }
  template <typename JobSummaryListT = JobSummary>
  ListJobsResult& AddJobSummaryList(JobSummaryListT&& value) {
    m_jobSummaryListHasBeenSet = true;
    m_jobSummaryList.emplace_back(std::forward<JobSummaryListT>(value));
    return *this;
  }
  ///@}
