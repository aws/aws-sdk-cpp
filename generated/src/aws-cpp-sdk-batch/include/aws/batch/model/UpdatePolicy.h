...
class UpdatePolicy {
 public:
  ...
  inline void SetTerminateJobsOnUpdate(bool value) {
    m_terminateJobsOnUpdateHasBeenSet = true;
    m_terminateJobsOnUpdate = value;
  }
  inline UpdatePolicy& WithTerminateJobsOnUpdate(bool value) {
    SetTerminateJobsOnUpdate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetJobExecutionTimeoutMinutes(long long value) {
    m_jobExecutionTimeoutMinutesHasBeenSet = true;
    m_jobExecutionTimeoutMinutes = value;
  }
  inline UpdatePolicy& WithJobExecutionTimeoutMinutes(long long value) {
    SetJobExecutionTimeoutMinutes(value);
    return *this;
  }
  ///@}
 private:
