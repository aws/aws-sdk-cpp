...
class DescribeComputeEnvironmentsRequest : public BatchRequest {
 public:
  ...
  void SetComputeEnvironments(ComputeEnvironmentsT&& value) {
    ...
    m_computeEnvironments = std::forward<ComputeEnvironmentsT>(value);
  }
  template <typename ComputeEnvironmentsT = Aws::Vector<Aws::String>>
  DescribeComputeEnvironmentsRequest& WithComputeEnvironments(ComputeEnvironmentsT&& value) {
    SetComputeEnvironments(std::forward<ComputeEnvironmentsT>(value));
    return *this;
  }
  ...
  DescribeComputeEnvironmentsRequest& AddComputeEnvironments(ComputeEnvironmentsT&& value) {
    m_computeEnvironmentsHasBeenSet = true;
    m_computeEnvironments.emplace_back(std::forward<ComputeEnvironmentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeComputeEnvironmentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
