...
class DescribeServiceJobResult {
 public:
  ...
  void SetAttempts(AttemptsT&& value) {
    ...
    m_attempts = std::forward<AttemptsT>(value);
  }
  template <typename AttemptsT = Aws::Vector<ServiceJobAttemptDetail>>
  DescribeServiceJobResult& WithAttempts(AttemptsT&& value) {
    SetAttempts(std::forward<AttemptsT>(value));
    return *this;
  }
  ...
  inline DescribeServiceJobResult& WithCreatedAt(long long value) {
    SetCreatedAt(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeServiceJobResult& WithIsTerminated(bool value) {
  ...
  void SetLatestAttempt(LatestAttemptT&& value) {
    ...
    m_latestAttempt = std::forward<LatestAttemptT>(value);
  }
  template <typename LatestAttemptT = LatestServiceJobAttempt>
  ...
  inline DescribeServiceJobResult& WithSchedulingPriority(int value) {
  ...
  void SetServiceRequestPayload(ServiceRequestPayloadT&& value) {
    ...
    m_serviceRequestPayload = std::forward<ServiceRequestPayloadT>(value);
  }
  template <typename ServiceRequestPayloadT = Aws::String>
  DescribeServiceJobResult& WithServiceRequestPayload(ServiceRequestPayloadT&& value) {
    SetServiceRequestPayload(std::forward<ServiceRequestPayloadT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetServiceJobType(ServiceJobType value) {
    m_serviceJobTypeHasBeenSet = true;
    m_serviceJobType = value;
  }
  inline DescribeServiceJobResult& WithServiceJobType(ServiceJobType value) {
    SetServiceJobType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeServiceJobResult& WithStartedAt(long long value) {
    SetStartedAt(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(ServiceJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeServiceJobResult& WithStatus(ServiceJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeServiceJobResult& WithStoppedAt(long long value) {
    SetStoppedAt(value);
    return *this;
  }
  ///@}
