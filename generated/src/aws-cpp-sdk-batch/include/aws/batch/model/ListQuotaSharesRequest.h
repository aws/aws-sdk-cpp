...
/**
 */
class ListQuotaSharesRequest : public BatchRequest {
 public:
  AWS_BATCH_API ListQuotaSharesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ListQuotaShares"; }
  ...
  template <typename JobQueueT = Aws::String>
  ListQuotaSharesRequest& WithJobQueue(JobQueueT&& value) {
   ...
   * the initial request by sending another <code>ListQuotaShares</code> request with
   * the returned <code>nextToken</code> value. This value can be between 1 and 100.
   * If this parameter isn't used, <code>ListQuotaShares</code> returns up to 100
  ...
  inline ListQuotaSharesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   * <code>ListQuotaShares</code> request where <code>maxResults</code> was used and
  ...
  template <typename NextTokenT = Aws::String>
  ListQuotaSharesRequest& WithNextToken(NextTokenT&& value) {
