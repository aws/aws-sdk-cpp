...
class UpdateComputeEnvironmentResult {
 public:
  ...
  template <typename ComputeEnvironmentNameT = Aws::String>
  UpdateComputeEnvironmentResult& WithComputeEnvironmentName(ComputeEnvironmentNameT&& value) {
  ...
  template <typename ComputeEnvironmentArnT = Aws::String>
  UpdateComputeEnvironmentResult& WithComputeEnvironmentArn(ComputeEnvironmentArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateComputeEnvironmentResult& WithRequestId(RequestIdT&& value) {
