...
class DescribeServiceEnvironmentsResult {
 public:
  ...
  void SetServiceEnvironments(ServiceEnvironmentsT&& value) {
    ...
    m_serviceEnvironments = std::forward<ServiceEnvironmentsT>(value);
  }
  template <typename ServiceEnvironmentsT = Aws::Vector<ServiceEnvironmentDetail>>
  DescribeServiceEnvironmentsResult& WithServiceEnvironments(ServiceEnvironmentsT&& value) {
    SetServiceEnvironments(std::forward<ServiceEnvironmentsT>(value));
    return *this;
  }
  ...
  DescribeServiceEnvironmentsResult& AddServiceEnvironments(ServiceEnvironmentsT&& value) {
    m_serviceEnvironmentsHasBeenSet = true;
    m_serviceEnvironments.emplace_back(std::forward<ServiceEnvironmentsT>(value));
    return *this;
  }
  ///@}
