...
class ServiceJobEvaluateOnExit {
 public:
  ...
  inline void SetAction(ServiceJobRetryAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline ServiceJobEvaluateOnExit& WithAction(ServiceJobRetryAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  void SetOnStatusReason(OnStatusReasonT&& value) {
    ...
    m_onStatusReason = std::forward<OnStatusReasonT>(value);
  }
  template <typename OnStatusReasonT = Aws::String>
  ServiceJobEvaluateOnExit& WithOnStatusReason(OnStatusReasonT&& value) {
    SetOnStatusReason(std::forward<OnStatusReasonT>(value));
    return *this;
  }
  ///@}
 private:
