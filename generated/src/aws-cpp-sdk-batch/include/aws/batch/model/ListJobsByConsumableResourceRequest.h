...
class ListJobsByConsumableResourceRequest : public BatchRequest {
 public:
  ...
  template <typename ConsumableResourceT = Aws::String>
  ListJobsByConsumableResourceRequest& WithConsumableResource(ConsumableResourceT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<KeyValuesPair>>
  ListJobsByConsumableResourceRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = KeyValuesPair>
  ListJobsByConsumableResourceRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListJobsByConsumableResourceRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListJobsByConsumableResourceRequest& WithNextToken(NextTokenT&& value) {
