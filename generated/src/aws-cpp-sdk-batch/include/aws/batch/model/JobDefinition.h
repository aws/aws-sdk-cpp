...
class JobDefinition {
 public:
  ...
  void SetJobDefinitionArn(JobDefinitionArnT&& value) {
    ...
    m_jobDefinitionArn = std::forward<JobDefinitionArnT>(value);
  }
  template <typename JobDefinitionArnT = Aws::String>
  JobDefinition& WithJobDefinitionArn(JobDefinitionArnT&& value) {
    SetJobDefinitionArn(std::forward<JobDefinitionArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobDefinition& WithRevision(int value) {
    SetRevision(value);
    return *this;
  }
  ///@}
  ...
  inline JobDefinition& WithSchedulingPriority(int value) {
  ...
  void SetContainerProperties(ContainerPropertiesT&& value) {
    ...
    m_containerProperties = std::forward<ContainerPropertiesT>(value);
  }
  template <typename ContainerPropertiesT = ContainerProperties>
  JobDefinition& WithContainerProperties(ContainerPropertiesT&& value) {
    SetContainerProperties(std::forward<ContainerPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeout(TimeoutT&& value) {
    ...
    m_timeout = std::forward<TimeoutT>(value);
  }
  template <typename TimeoutT = JobTimeout>
  JobDefinition& WithTimeout(TimeoutT&& value) {
    SetTimeout(std::forward<TimeoutT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPropagateTags(bool value) {
    m_propagateTagsHasBeenSet = true;
    m_propagateTags = value;
  }
  inline JobDefinition& WithPropagateTags(bool value) {
  ...
  void SetPlatformCapabilities(PlatformCapabilitiesT&& value) {
    ...
    m_platformCapabilities = std::forward<PlatformCapabilitiesT>(value);
  }
  template <typename PlatformCapabilitiesT = Aws::Vector<PlatformCapability>>
  JobDefinition& WithPlatformCapabilities(PlatformCapabilitiesT&& value) {
    SetPlatformCapabilities(std::forward<PlatformCapabilitiesT>(value));
    return *this;
  }
  inline JobDefinition& AddPlatformCapabilities(PlatformCapability value) {
    m_platformCapabilitiesHasBeenSet = true;
    m_platformCapabilities.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetEcsProperties(EcsPropertiesT&& value) {
    ...
    m_ecsProperties = std::forward<EcsPropertiesT>(value);
  }
  template <typename EcsPropertiesT = EcsProperties>
  JobDefinition& WithEcsProperties(EcsPropertiesT&& value) {
    SetEcsProperties(std::forward<EcsPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEksProperties(EksPropertiesT&& value) {
    ...
    m_eksProperties = std::forward<EksPropertiesT>(value);
  }
  template <typename EksPropertiesT = EksProperties>
  JobDefinition& WithEksProperties(EksPropertiesT&& value) {
    SetEksProperties(std::forward<EksPropertiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline JobDefinition& WithContainerOrchestrationType(OrchestrationType value) {
  ...
  void SetConsumableResourceProperties(ConsumableResourcePropertiesT&& value) {
    ...
    m_consumableResourceProperties = std::forward<ConsumableResourcePropertiesT>(value);
  }
  template <typename ConsumableResourcePropertiesT = ConsumableResourceProperties>
  JobDefinition& WithConsumableResourceProperties(ConsumableResourcePropertiesT&& value) {
    SetConsumableResourceProperties(std::forward<ConsumableResourcePropertiesT>(value));
    return *this;
  }
  ///@}
 private:
