...
namespace Model
{
  ...
  {
  public:
    AWS_BATCH_API DeregisterJobDefinitionResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeregisterJobDefinitionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
