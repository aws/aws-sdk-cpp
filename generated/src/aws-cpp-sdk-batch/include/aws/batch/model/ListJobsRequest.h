...
class ListJobsRequest : public BatchRequest {
 public:
  ...
  void SetArrayJobId(ArrayJobIdT&& value) {
    m_arrayJobIdHasBeenSet = true;
    m_arrayJobId = std::forward<ArrayJobIdT>(value);
  }
  template <typename ArrayJobIdT = Aws::String>
  ListJobsRequest& WithArrayJobId(ArrayJobIdT&& value) {
    SetArrayJobId(std::forward<ArrayJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiNodeJobId(MultiNodeJobIdT&& value) {
    m_multiNodeJobIdHasBeenSet = true;
    m_multiNodeJobId = std::forward<MultiNodeJobIdT>(value);
  }
  template <typename MultiNodeJobIdT = Aws::String>
  ListJobsRequest& WithMultiNodeJobId(MultiNodeJobIdT&& value) {
    SetMultiNodeJobId(std::forward<MultiNodeJobIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListJobsRequest& WithJobStatus(JobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
