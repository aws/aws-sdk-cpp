...
class RegisterJobDefinitionRequest : public BatchRequest {
 public:
  ...
  inline void SetType(JobDefinitionType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline RegisterJobDefinitionRequest& WithType(JobDefinitionType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline RegisterJobDefinitionRequest& WithSchedulingPriority(int value) {
  ...
  inline RegisterJobDefinitionRequest& WithPropagateTags(bool value) {
  ...
  inline RegisterJobDefinitionRequest& AddPlatformCapabilities(PlatformCapability value) {
    m_platformCapabilitiesHasBeenSet = true;
