...
class EFSVolumeConfiguration {
 public:
  ...
  inline void SetTransitEncryption(EFSTransitEncryption value) {
    m_transitEncryptionHasBeenSet = true;
    m_transitEncryption = value;
  }
  inline EFSVolumeConfiguration& WithTransitEncryption(EFSTransitEncryption value) {
    SetTransitEncryption(value);
    return *this;
  }
  ///@}
  ...
  inline EFSVolumeConfiguration& WithTransitEncryptionPort(int value) {
