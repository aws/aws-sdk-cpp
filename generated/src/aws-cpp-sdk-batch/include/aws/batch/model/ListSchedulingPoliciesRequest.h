...
class ListSchedulingPoliciesRequest : public BatchRequest {
 public:
  AWS_BATCH_API ListSchedulingPoliciesRequest() = default;
  ...
  inline ListSchedulingPoliciesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSchedulingPoliciesRequest& WithNextToken(NextTokenT&& value) {
