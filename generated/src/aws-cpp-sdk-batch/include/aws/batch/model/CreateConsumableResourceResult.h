...
class CreateConsumableResourceResult {
 public:
  ...
  template <typename ConsumableResourceNameT = Aws::String>
  CreateConsumableResourceResult& WithConsumableResourceName(ConsumableResourceNameT&& value) {
  ...
  template <typename ConsumableResourceArnT = Aws::String>
  CreateConsumableResourceResult& WithConsumableResourceArn(ConsumableResourceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateConsumableResourceResult& WithRequestId(RequestIdT&& value) {
