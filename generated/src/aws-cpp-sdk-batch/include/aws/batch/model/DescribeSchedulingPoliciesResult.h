...
class DescribeSchedulingPoliciesResult {
 public:
  ...
  void SetSchedulingPolicies(SchedulingPoliciesT&& value) {
    ...
    m_schedulingPolicies = std::forward<SchedulingPoliciesT>(value);
  }
  template <typename SchedulingPoliciesT = Aws::Vector<SchedulingPolicyDetail>>
  DescribeSchedulingPoliciesResult& WithSchedulingPolicies(SchedulingPoliciesT&& value) {
    SetSchedulingPolicies(std::forward<SchedulingPoliciesT>(value));
    return *this;
  }
  ...
  DescribeSchedulingPoliciesResult& AddSchedulingPolicies(SchedulingPoliciesT&& value) {
    m_schedulingPoliciesHasBeenSet = true;
    m_schedulingPolicies.emplace_back(std::forward<SchedulingPoliciesT>(value));
    return *this;
  }
  ///@}
