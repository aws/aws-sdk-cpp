...
class ContainerDetail {
 public:
  ...
  inline ContainerDetail& WithVcpus(int value) {
    SetVcpus(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDetail& WithMemory(int value) {
    SetMemory(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDetail& WithReadonlyRootFilesystem(bool value) {
  ...
  inline ContainerDetail& WithPrivileged(bool value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDetail& WithExitCode(int value) {
    SetExitCode(value);
    return *this;
  }
  ///@}
  ...
  inline ContainerDetail& WithEnableExecuteCommand(bool value) {
