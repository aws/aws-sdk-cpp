...
class Ec2Configuration {
 public:
   ...
   * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html">Amazon
   * ECS-optimized Amazon Linux 2023 AMI</a> (<code>ECS_AL2023</code>) is used. If a
   ...
   * used.</p>  <p>Amazon Web Services is ending support for Amazon ECS
   * Amazon Linux 2-optimized and accelerated AMIs on June 30, 2026. On January 12,
   * 2026, Batch changed the default AMI for new Amazon ECS compute environments from
   * Amazon Linux 2 to Amazon Linux 2023. Effective June 30, 2026, Batch will block
   * creation of new Amazon ECS compute environments using Batch-provided Amazon
   * Linux 2 AMIs. We strongly recommend migrating your existing Batch Amazon ECS
   * compute environments to Amazon Linux 2023 prior to June 30, 2026. For more
   ...
   * Linux 2 (GPU)</a>: Used for GPU instance families (for example <code>P4</code>
   * and <code>G4</code>) and non Amazon Web Services Graviton-based instance
   * types.</p> </dd> <dt>ECS_AL2023</dt> <dd> <p> <a
   * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html">Amazon
   * Linux 2023</a>: Default for all non-GPU instance families.</p>  <p>Amazon
   * Linux 2023 does not support <code>A1</code> instances.</p>  </dd>
   * <dt>ECS_AL2023_NVIDIA</dt> <dd> <p> <a
   * href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#gpuami">Amazon
   * Linux 2023 (GPU)</a>: Default for all GPU instance families and can be used for
   * all non Amazon Web Services Graviton-based instance types.</p>
   ...
   * EKS.</p> <p>Amazon Web Services ended support for Amazon EKS AL2-optimized and
   ...
   * 2023. For more information on upgrading from AL2 to AL2023, see <a
   ...
   * Amazon ECS-optimized Amazon Linux 2023 AMI. For more information, see <a
