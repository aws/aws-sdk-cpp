...
class FairsharePolicy {
 public:
  ...
  inline void SetShareDecaySeconds(int value) {
    m_shareDecaySecondsHasBeenSet = true;
    m_shareDecaySeconds = value;
  }
  inline FairsharePolicy& WithShareDecaySeconds(int value) {
    SetShareDecaySeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetComputeReservation(int value) {
    m_computeReservationHasBeenSet = true;
    m_computeReservation = value;
  }
  inline FairsharePolicy& WithComputeReservation(int value) {
    SetComputeReservation(value);
    return *this;
  }
  ///@}
  ...
  void SetShareDistribution(ShareDistributionT&& value) {
    ...
    m_shareDistribution = std::forward<ShareDistributionT>(value);
  }
  template <typename ShareDistributionT = Aws::Vector<ShareAttributes>>
  FairsharePolicy& WithShareDistribution(ShareDistributionT&& value) {
    SetShareDistribution(std::forward<ShareDistributionT>(value));
    return *this;
  }
  template <typename ShareDistributionT = ShareAttributes>
  FairsharePolicy& AddShareDistribution(ShareDistributionT&& value) {
    m_shareDistributionHasBeenSet = true;
    m_shareDistribution.emplace_back(std::forward<ShareDistributionT>(value));
    return *this;
  }
  ///@}
 private:
