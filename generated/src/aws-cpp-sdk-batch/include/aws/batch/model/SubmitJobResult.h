...
class SubmitJobResult {
 public:
  ...
  template <typename JobArnT = Aws::String>
  SubmitJobResult& WithJobArn(JobArnT&& value) {
  ...
  template <typename JobNameT = Aws::String>
  SubmitJobResult& WithJobName(JobNameT&& value) {
  ...
  template <typename JobIdT = Aws::String>
  SubmitJobResult& WithJobId(JobIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  SubmitJobResult& WithRequestId(RequestIdT&& value) {
