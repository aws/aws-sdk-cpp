...
class ComputeResource {
 public:
  ...
  inline void SetType(CRType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline ComputeResource& WithType(CRType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllocationStrategy(CRAllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline ComputeResource& WithAllocationStrategy(CRAllocationStrategy value) {
  ...
  inline void SetMinvCpus(int value) {
    m_minvCpusHasBeenSet = true;
    m_minvCpus = value;
  }
  inline ComputeResource& WithMinvCpus(int value) {
    SetMinvCpus(value);
    return *this;
  }
  ///@}
  ...
  inline ComputeResource& WithMaxvCpus(int value) {
    SetMaxvCpus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDesiredvCpus(int value) {
    m_desiredvCpusHasBeenSet = true;
    m_desiredvCpus = value;
  }
  inline ComputeResource& WithDesiredvCpus(int value) {
    SetDesiredvCpus(value);
    return *this;
  }
  ///@}
   ...
   * you choose one of the following:</p> <ul> <li> <p> <code>default_x86_64</code>
   * to choose x86 based instance types (from the <code>m6i</code>, <code>c6i</code>,
   * <code>r6i</code>, and <code>c7i</code> instance families) that matches the
   * resource demands of the job queue.</p> </li> <li> <p> <code>default_arm64</code>
   * to choose ARM based instance types (from the <code>m6g</code>, <code>c6g</code>,
   * <code>r6g</code>, and <code>c7g</code> instance families) that matches the
   * resource demands of the job queue.</p> </li> <li> <p> <code>optimal</code>
   * Semantically equivalent to <code>default_x86_64</code>, see <a
   * href="https://docs.aws.amazon.com/batch/latest/userguide/optimal-default-instance-troubleshooting.html">Optimal
   * instance type configuration to receive automatic instance family updates</a> for
   * details.</p> </li> </ul>  <p>Instance family availability varies by Amazon
  ...
  void SetEc2KeyPair(Ec2KeyPairT&& value) {
    ...
    m_ec2KeyPair = std::forward<Ec2KeyPairT>(value);
  }
  template <typename Ec2KeyPairT = Aws::String>
  ComputeResource& WithEc2KeyPair(Ec2KeyPairT&& value) {
    SetEc2KeyPair(std::forward<Ec2KeyPairT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetBidPercentage(int value) {
    m_bidPercentageHasBeenSet = true;
    m_bidPercentage = value;
  }
  inline ComputeResource& WithBidPercentage(int value) {
  ...
  void SetSpotIamFleetRole(SpotIamFleetRoleT&& value) {
    ...
    m_spotIamFleetRole = std::forward<SpotIamFleetRoleT>(value);
  }
  template <typename SpotIamFleetRoleT = Aws::String>
  ComputeResource& WithSpotIamFleetRole(SpotIamFleetRoleT&& value) {
    SetSpotIamFleetRole(std::forward<SpotIamFleetRoleT>(value));
    return *this;
  }
  ///@}
  ...
  ComputeResource& AddEc2Configuration(Ec2ConfigurationT&& value) {
    m_ec2ConfigurationHasBeenSet = true;
    m_ec2Configuration.emplace_back(std::forward<Ec2ConfigurationT>(value));
    return *this;
  }
  ///@}
