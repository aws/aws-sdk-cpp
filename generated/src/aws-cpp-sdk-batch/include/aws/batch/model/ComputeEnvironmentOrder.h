...
class ComputeEnvironmentOrder {
 public:
  ...
  inline ComputeEnvironmentOrder& WithOrder(int value) {
    SetOrder(value);
    return *this;
  }
  ///@}
  ...
  void SetComputeEnvironment(ComputeEnvironmentT&& value) {
    ...
    m_computeEnvironment = std::forward<ComputeEnvironmentT>(value);
  }
  template <typename ComputeEnvironmentT = Aws::String>
  ComputeEnvironmentOrder& WithComputeEnvironment(ComputeEnvironmentT&& value) {
    SetComputeEnvironment(std::forward<ComputeEnvironmentT>(value));
    return *this;
  }
  ///@}
 private:
