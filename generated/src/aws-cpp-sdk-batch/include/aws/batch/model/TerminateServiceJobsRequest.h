...
/**
 * <p>Specifies the service jobs to terminate and the reason for the
 * termination.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/TerminateServiceJobsRequest">AWS
 * API Reference</a></p>
 */
class TerminateServiceJobsRequest : public BatchRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "TerminateServiceJobs"; }
