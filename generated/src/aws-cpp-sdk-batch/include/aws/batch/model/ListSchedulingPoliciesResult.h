...
class ListSchedulingPoliciesResult {
 public:
  ...
  template <typename SchedulingPoliciesT = Aws::Vector<SchedulingPolicyListingDetail>>
  ListSchedulingPoliciesResult& WithSchedulingPolicies(SchedulingPoliciesT&& value) {
  ...
  ListSchedulingPoliciesResult& AddSchedulingPolicies(SchedulingPoliciesT&& value) {
    m_schedulingPoliciesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSchedulingPoliciesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSchedulingPoliciesResult& WithRequestId(RequestIdT&& value) {
