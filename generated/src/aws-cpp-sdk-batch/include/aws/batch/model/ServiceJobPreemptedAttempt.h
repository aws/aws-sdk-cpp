...
/**
 * <p>Detailed information about a preempted attempt of a service
 * job.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/ServiceJobPreemptedAttempt">AWS
 * API Reference</a></p>
 */
class ServiceJobPreemptedAttempt {
 public:
  ...
  void SetServiceResourceId(ServiceResourceIdT&& value) {
    ...
    m_serviceResourceId = std::forward<ServiceResourceIdT>(value);
  }
  template <typename ServiceResourceIdT = ServiceResourceId>
  ServiceJobPreemptedAttempt& WithServiceResourceId(ServiceResourceIdT&& value) {
    SetServiceResourceId(std::forward<ServiceResourceIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ServiceJobPreemptedAttempt& WithStartedAt(long long value) {
    SetStartedAt(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceJobPreemptedAttempt& WithStoppedAt(long long value) {
    SetStoppedAt(value);
    return *this;
  }
  ///@}
