...
class ListJobsByConsumableResourceResult {
 public:
  ...
  template <typename JobsT = Aws::Vector<ListJobsByConsumableResourceSummary>>
  ListJobsByConsumableResourceResult& WithJobs(JobsT&& value) {
    SetJobs(std::forward<JobsT>(value));
    return *this;
  }
  template <typename JobsT = ListJobsByConsumableResourceSummary>
  ListJobsByConsumableResourceResult& AddJobs(JobsT&& value) {
    m_jobsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListJobsByConsumableResourceResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListJobsByConsumableResourceResult& WithRequestId(RequestIdT&& value) {
