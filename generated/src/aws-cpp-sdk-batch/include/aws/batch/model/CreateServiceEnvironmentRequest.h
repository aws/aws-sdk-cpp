...
class CreateServiceEnvironmentRequest : public BatchRequest {
 public:
  ...
  inline void SetServiceEnvironmentType(ServiceEnvironmentType value) {
    m_serviceEnvironmentTypeHasBeenSet = true;
    m_serviceEnvironmentType = value;
  }
  inline CreateServiceEnvironmentRequest& WithServiceEnvironmentType(ServiceEnvironmentType value) {
    SetServiceEnvironmentType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateServiceEnvironmentRequest& WithState(ServiceEnvironmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
