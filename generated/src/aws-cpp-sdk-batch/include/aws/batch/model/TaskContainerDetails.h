...
class TaskContainerDetails {
 public:
  ...
  inline TaskContainerDetails& WithEssential(bool value) {
    SetEssential(value);
    return *this;
  }
  ///@}
  ...
  inline TaskContainerDetails& WithPrivileged(bool value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
  ...
  inline TaskContainerDetails& WithReadonlyRootFilesystem(bool value) {
  ...
  inline TaskContainerDetails& WithStartTimeout(int value) {
  ...
  inline TaskContainerDetails& WithStopTimeout(int value) {
  ...
  inline TaskContainerDetails& WithExitCode(int value) {
    SetExitCode(value);
    return *this;
  }
  ///@}
