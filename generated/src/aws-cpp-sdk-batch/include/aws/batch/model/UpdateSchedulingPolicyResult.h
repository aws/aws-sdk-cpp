...
namespace Model
{
  ...
  {
  public:
    AWS_BATCH_API UpdateSchedulingPolicyResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    UpdateSchedulingPolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
