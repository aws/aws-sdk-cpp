...
class CreateJobQueueRequest : public BatchRequest {
 public:
  ...
  inline CreateJobQueueRequest& WithState(JQState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateJobQueueRequest& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  inline CreateJobQueueRequest& WithJobQueueType(JobQueueType value) {
