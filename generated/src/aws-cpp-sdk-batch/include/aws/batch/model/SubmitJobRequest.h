...
class SubmitJobRequest : public BatchRequest {
 public:
  ...
  inline void SetSchedulingPriorityOverride(int value) {
    m_schedulingPriorityOverrideHasBeenSet = true;
    m_schedulingPriorityOverride = value;
  }
  inline SubmitJobRequest& WithSchedulingPriorityOverride(int value) {
    SetSchedulingPriorityOverride(value);
    return *this;
  }
  ///@}
  ...
  void SetNodeOverrides(NodeOverridesT&& value) {
    m_nodeOverridesHasBeenSet = true;
    m_nodeOverrides = std::forward<NodeOverridesT>(value);
  }
  template <typename NodeOverridesT = NodeOverrides>
  SubmitJobRequest& WithNodeOverrides(NodeOverridesT&& value) {
    SetNodeOverrides(std::forward<NodeOverridesT>(value));
    return *this;
  }
  ///@}
  ...
  inline SubmitJobRequest& WithPropagateTags(bool value) {
  ...
  void SetEksPropertiesOverride(EksPropertiesOverrideT&& value) {
    ...
    m_eksPropertiesOverride = std::forward<EksPropertiesOverrideT>(value);
  }
  template <typename EksPropertiesOverrideT = EksPropertiesOverride>
  SubmitJobRequest& WithEksPropertiesOverride(EksPropertiesOverrideT&& value) {
    SetEksPropertiesOverride(std::forward<EksPropertiesOverrideT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEcsPropertiesOverride(EcsPropertiesOverrideT&& value) {
    ...
    m_ecsPropertiesOverride = std::forward<EcsPropertiesOverrideT>(value);
  }
  template <typename EcsPropertiesOverrideT = EcsPropertiesOverride>
  SubmitJobRequest& WithEcsPropertiesOverride(EcsPropertiesOverrideT&& value) {
    SetEcsPropertiesOverride(std::forward<EcsPropertiesOverrideT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const ConsumableResourceProperties& GetConsumableResourcePropertiesOverride() const {
    return m_consumableResourcePropertiesOverride;
  }
  ...
  void SetConsumableResourcePropertiesOverride(ConsumableResourcePropertiesOverrideT&& value) {
    ...
    m_consumableResourcePropertiesOverride = std::forward<ConsumableResourcePropertiesOverrideT>(value);
  }
  template <typename ConsumableResourcePropertiesOverrideT = ConsumableResourceProperties>
  SubmitJobRequest& WithConsumableResourcePropertiesOverride(ConsumableResourcePropertiesOverrideT&& value) {
    SetConsumableResourcePropertiesOverride(std::forward<ConsumableResourcePropertiesOverrideT>(value));
    return *this;
  }
  ///@}
 private:
