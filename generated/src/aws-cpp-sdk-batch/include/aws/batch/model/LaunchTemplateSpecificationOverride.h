...
class LaunchTemplateSpecificationOverride {
 public:
  ...
  void SetTargetInstanceTypes(TargetInstanceTypesT&& value) {
    m_targetInstanceTypesHasBeenSet = true;
    m_targetInstanceTypes = std::forward<TargetInstanceTypesT>(value);
  }
  template <typename TargetInstanceTypesT = Aws::Vector<Aws::String>>
  LaunchTemplateSpecificationOverride& WithTargetInstanceTypes(TargetInstanceTypesT&& value) {
    SetTargetInstanceTypes(std::forward<TargetInstanceTypesT>(value));
    return *this;
  }
  ...
  LaunchTemplateSpecificationOverride& AddTargetInstanceTypes(TargetInstanceTypesT&& value) {
    m_targetInstanceTypesHasBeenSet = true;
    m_targetInstanceTypes.emplace_back(std::forward<TargetInstanceTypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateSpecificationOverride& WithUserdataType(UserdataType value) {
