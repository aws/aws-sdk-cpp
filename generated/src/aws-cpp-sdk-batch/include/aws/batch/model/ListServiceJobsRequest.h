...
class ListServiceJobsRequest : public BatchRequest {
 public:
  ...
  template <typename JobQueueT = Aws::String>
  ListServiceJobsRequest& WithJobQueue(JobQueueT&& value) {
  ...
  inline void SetJobStatus(ServiceJobStatus value) {
    m_jobStatusHasBeenSet = true;
    m_jobStatus = value;
  }
  inline ListServiceJobsRequest& WithJobStatus(ServiceJobStatus value) {
    SetJobStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ListServiceJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListServiceJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<KeyValuesPair>>
  ListServiceJobsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = KeyValuesPair>
  ListServiceJobsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
