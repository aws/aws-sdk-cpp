 ...
 * <code>TerminateJobs</code> operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/TerminateJobsErrorDetail">AWS
 * API Reference</a></p>
 */
class TerminateJobsErrorDetail {
 public:
  ...
  ///@{
  /**
   * <p>An error code that identifies the reason the job couldn't be terminated.
   * Valid values are:</p> <ul> <li> <p> <code>ValidationException</code> – A job
   * identifier in the request is malformed or isn't valid.</p> </li> <li> <p>
   * <code>ClientException</code> – The request failed because of a client error.</p>
   * </li> <li> <p> <code>ThrottlingException</code> – The request was throttled.
   * Retry the request.</p> </li> <li> <p> <code>ServerException</code> – An internal
   * error occurred. Retry the request.</p> </li> <li> <p> <code>AccessDenied</code>
   * – The caller isn't authorized to perform the action on the specified job.</p>
   * </li> </ul>
   */
