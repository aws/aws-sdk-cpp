...
class ListConsumableResourcesResult {
 public:
  ...
  void SetConsumableResources(ConsumableResourcesT&& value) {
    m_consumableResourcesHasBeenSet = true;
    m_consumableResources = std::forward<ConsumableResourcesT>(value);
  }
  template <typename ConsumableResourcesT = Aws::Vector<ConsumableResourceSummary>>
  ListConsumableResourcesResult& WithConsumableResources(ConsumableResourcesT&& value) {
    SetConsumableResources(std::forward<ConsumableResourcesT>(value));
    return *this;
  }
  template <typename ConsumableResourcesT = ConsumableResourceSummary>
  ListConsumableResourcesResult& AddConsumableResources(ConsumableResourcesT&& value) {
    m_consumableResourcesHasBeenSet = true;
    m_consumableResources.emplace_back(std::forward<ConsumableResourcesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListConsumableResourcesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListConsumableResourcesResult& WithRequestId(RequestIdT&& value) {
