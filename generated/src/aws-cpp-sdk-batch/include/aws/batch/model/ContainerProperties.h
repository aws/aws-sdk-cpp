...
class ContainerProperties {
 public:
  ...
  void SetJobRoleArn(JobRoleArnT&& value) {
    ...
    m_jobRoleArn = std::forward<JobRoleArnT>(value);
  }
  template <typename JobRoleArnT = Aws::String>
  ContainerProperties& WithJobRoleArn(JobRoleArnT&& value) {
    SetJobRoleArn(std::forward<JobRoleArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline ContainerProperties& WithReadonlyRootFilesystem(bool value) {
  ...
  inline ContainerProperties& WithPrivileged(bool value) {
    SetPrivileged(value);
    return *this;
  }
  ///@}
  ...
  void SetResourceRequirements(ResourceRequirementsT&& value) {
    ...
    m_resourceRequirements = std::forward<ResourceRequirementsT>(value);
  }
  template <typename ResourceRequirementsT = Aws::Vector<ResourceRequirement>>
  ContainerProperties& WithResourceRequirements(ResourceRequirementsT&& value) {
    SetResourceRequirements(std::forward<ResourceRequirementsT>(value));
    return *this;
  }
  ...
  ContainerProperties& AddResourceRequirements(ResourceRequirementsT&& value) {
    m_resourceRequirementsHasBeenSet = true;
    m_resourceRequirements.emplace_back(std::forward<ResourceRequirementsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFargatePlatformConfiguration(FargatePlatformConfigurationT&& value) {
    ...
    m_fargatePlatformConfiguration = std::forward<FargatePlatformConfigurationT>(value);
  }
  template <typename FargatePlatformConfigurationT = FargatePlatformConfiguration>
  ContainerProperties& WithFargatePlatformConfiguration(FargatePlatformConfigurationT&& value) {
    SetFargatePlatformConfiguration(std::forward<FargatePlatformConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline ContainerProperties& WithEnableExecuteCommand(bool value) {
