...
class ConsumableResourceProperties {
 public:
  ...
  void SetConsumableResourceList(ConsumableResourceListT&& value) {
    m_consumableResourceListHasBeenSet = true;
    m_consumableResourceList = std::forward<ConsumableResourceListT>(value);
  }
  template <typename ConsumableResourceListT = Aws::Vector<ConsumableResourceRequirement>>
  ConsumableResourceProperties& WithConsumableResourceList(ConsumableResourceListT&& value) {
    SetConsumableResourceList(std::forward<ConsumableResourceListT>(value));
    return *this;
  }
  template <typename ConsumableResourceListT = ConsumableResourceRequirement>
  ConsumableResourceProperties& AddConsumableResourceList(ConsumableResourceListT&& value) {
    m_consumableResourceListHasBeenSet = true;
    m_consumableResourceList.emplace_back(std::forward<ConsumableResourceListT>(value));
    return *this;
  }
  ///@}
 private:
