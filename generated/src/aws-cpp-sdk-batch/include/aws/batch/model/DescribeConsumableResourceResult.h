...
class DescribeConsumableResourceResult {
 public:
  ...
  inline DescribeConsumableResourceResult& WithTotalQuantity(long long value) {
  ...
  inline DescribeConsumableResourceResult& WithInUseQuantity(long long value) {
  ...
  inline void SetAvailableQuantity(long long value) {
    m_availableQuantityHasBeenSet = true;
    m_availableQuantity = value;
  }
  inline DescribeConsumableResourceResult& WithAvailableQuantity(long long value) {
  ...
  inline DescribeConsumableResourceResult& WithCreatedAt(long long value) {
    SetCreatedAt(value);
    return *this;
  }
  ///@}
