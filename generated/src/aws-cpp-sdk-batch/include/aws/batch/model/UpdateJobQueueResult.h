...
class UpdateJobQueueResult {
 public:
  ...
  template <typename JobQueueNameT = Aws::String>
  UpdateJobQueueResult& WithJobQueueName(JobQueueNameT&& value) {
  ...
  template <typename JobQueueArnT = Aws::String>
  UpdateJobQueueResult& WithJobQueueArn(JobQueueArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateJobQueueResult& WithRequestId(RequestIdT&& value) {
