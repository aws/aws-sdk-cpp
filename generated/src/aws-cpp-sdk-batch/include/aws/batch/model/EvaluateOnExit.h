...
class EvaluateOnExit {
 public:
  ...
  void SetOnReason(OnReasonT&& value) {
    ...
    m_onReason = std::forward<OnReasonT>(value);
  }
  template <typename OnReasonT = Aws::String>
  EvaluateOnExit& WithOnReason(OnReasonT&& value) {
    SetOnReason(std::forward<OnReasonT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOnExitCode(OnExitCodeT&& value) {
    ...
    m_onExitCode = std::forward<OnExitCodeT>(value);
  }
  template <typename OnExitCodeT = Aws::String>
  EvaluateOnExit& WithOnExitCode(OnExitCodeT&& value) {
    SetOnExitCode(std::forward<OnExitCodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAction(RetryAction value) {
    m_actionHasBeenSet = true;
    m_action = value;
  }
  inline EvaluateOnExit& WithAction(RetryAction value) {
    SetAction(value);
    return *this;
  }
  ///@}
