...
class AWS_REDSHIFT_API RedshiftClient : public Aws::Client::AWSXMLClient,
 ...
 public:
   ...
   */
  RedshiftClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<RedshiftEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::AcceptReservedNodeExchangeOutcome AcceptReservedNodeExchange(
      const Model::AcceptReservedNodeExchangeRequest& request) const;

  /**
   * A Callable wrapper for AcceptReservedNodeExchange that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AcceptReservedNodeExchangeRequestT = Model::AcceptReservedNodeExchangeRequest>
  Model::AcceptReservedNodeExchangeOutcomeCallable AcceptReservedNodeExchangeCallable(
      const AcceptReservedNodeExchangeRequestT& request) const {
    return SubmitCallable(&RedshiftClient::AcceptReservedNodeExchange, request);
  }

  /**
   * An Async wrapper for AcceptReservedNodeExchange that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptReservedNodeExchangeRequestT = Model::AcceptReservedNodeExchangeRequest>
  void AcceptReservedNodeExchangeAsync(const AcceptReservedNodeExchangeRequestT& request,
  ...
  /**
   * An Async wrapper for AddPartner that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename AddPartnerRequestT = Model::AddPartnerRequest>
  void AddPartnerAsync(const AddPartnerRequestT& request, const AddPartnerResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AssociateDataShareConsumerOutcome AssociateDataShareConsumer(
      const Model::AssociateDataShareConsumerRequest& request) const;

  /**
   * A Callable wrapper for AssociateDataShareConsumer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AssociateDataShareConsumerRequestT = Model::AssociateDataShareConsumerRequest>
  Model::AssociateDataShareConsumerOutcomeCallable AssociateDataShareConsumerCallable(
      const AssociateDataShareConsumerRequestT& request) const {
    return SubmitCallable(&RedshiftClient::AssociateDataShareConsumer, request);
  }

  /**
   * An Async wrapper for AssociateDataShareConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AssociateDataShareConsumerRequestT = Model::AssociateDataShareConsumerRequest>
  void AssociateDataShareConsumerAsync(const AssociateDataShareConsumerRequestT& request,
                                       const AssociateDataShareConsumerResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::AuthorizeClusterSecurityGroupIngressOutcome AuthorizeClusterSecurityGroupIngress(
      const Model::AuthorizeClusterSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for AuthorizeClusterSecurityGroupIngress that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename AuthorizeClusterSecurityGroupIngressRequestT = Model::AuthorizeClusterSecurityGroupIngressRequest>
  Model::AuthorizeClusterSecurityGroupIngressOutcomeCallable AuthorizeClusterSecurityGroupIngressCallable(
      const AuthorizeClusterSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&RedshiftClient::AuthorizeClusterSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for AuthorizeClusterSecurityGroupIngress that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename AuthorizeClusterSecurityGroupIngressRequestT = Model::AuthorizeClusterSecurityGroupIngressRequest>
  void AuthorizeClusterSecurityGroupIngressAsync(const AuthorizeClusterSecurityGroupIngressRequestT& request,
  ...
  /**
   * A Callable wrapper for AuthorizeDataShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AuthorizeDataShare that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename AuthorizeDataShareRequestT = Model::AuthorizeDataShareRequest>
  void AuthorizeDataShareAsync(const AuthorizeDataShareRequestT& request, const AuthorizeDataShareResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AuthorizeEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AuthorizeEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AuthorizeEndpointAccessRequestT = Model::AuthorizeEndpointAccessRequest>
  void AuthorizeEndpointAccessAsync(const AuthorizeEndpointAccessRequestT& request,
                                    const AuthorizeEndpointAccessResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for AuthorizeSnapshotAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for AuthorizeSnapshotAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AuthorizeSnapshotAccessRequestT = Model::AuthorizeSnapshotAccessRequest>
  void AuthorizeSnapshotAccessAsync(const AuthorizeSnapshotAccessRequestT& request,
  ...
  virtual Model::BatchDeleteClusterSnapshotsOutcome BatchDeleteClusterSnapshots(
      const Model::BatchDeleteClusterSnapshotsRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteClusterSnapshots that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteClusterSnapshotsRequestT = Model::BatchDeleteClusterSnapshotsRequest>
  Model::BatchDeleteClusterSnapshotsOutcomeCallable BatchDeleteClusterSnapshotsCallable(
      const BatchDeleteClusterSnapshotsRequestT& request) const {
    return SubmitCallable(&RedshiftClient::BatchDeleteClusterSnapshots, request);
  }

  /**
   * An Async wrapper for BatchDeleteClusterSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteClusterSnapshotsRequestT = Model::BatchDeleteClusterSnapshotsRequest>
  void BatchDeleteClusterSnapshotsAsync(const BatchDeleteClusterSnapshotsRequestT& request,
  ...
  virtual Model::BatchModifyClusterSnapshotsOutcome BatchModifyClusterSnapshots(
      const Model::BatchModifyClusterSnapshotsRequest& request) const;

  /**
   * A Callable wrapper for BatchModifyClusterSnapshots that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchModifyClusterSnapshotsRequestT = Model::BatchModifyClusterSnapshotsRequest>
  Model::BatchModifyClusterSnapshotsOutcomeCallable BatchModifyClusterSnapshotsCallable(
      const BatchModifyClusterSnapshotsRequestT& request) const {
    return SubmitCallable(&RedshiftClient::BatchModifyClusterSnapshots, request);
  }

  /**
   * An Async wrapper for BatchModifyClusterSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchModifyClusterSnapshotsRequestT = Model::BatchModifyClusterSnapshotsRequest>
  void BatchModifyClusterSnapshotsAsync(const BatchModifyClusterSnapshotsRequestT& request,
  ...
  /**
   * An Async wrapper for CancelResize that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelResizeRequestT = Model::CancelResizeRequest>
  void CancelResizeAsync(const CancelResizeRequestT& request, const CancelResizeResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CopyClusterSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CopyClusterSnapshot that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CopyClusterSnapshotRequestT = Model::CopyClusterSnapshotRequest>
  void CopyClusterSnapshotAsync(const CopyClusterSnapshotRequestT& request, const CopyClusterSnapshotResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateAuthenticationProfileOutcome CreateAuthenticationProfile(
      const Model::CreateAuthenticationProfileRequest& request) const;

  /**
   * A Callable wrapper for CreateAuthenticationProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateAuthenticationProfileRequestT = Model::CreateAuthenticationProfileRequest>
  Model::CreateAuthenticationProfileOutcomeCallable CreateAuthenticationProfileCallable(
      const CreateAuthenticationProfileRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateAuthenticationProfile, request);
  }

  /**
   * An Async wrapper for CreateAuthenticationProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAuthenticationProfileRequestT = Model::CreateAuthenticationProfileRequest>
  void CreateAuthenticationProfileAsync(const CreateAuthenticationProfileRequestT& request,
                                        const CreateAuthenticationProfileResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateClusterParameterGroupOutcome CreateClusterParameterGroup(
      const Model::CreateClusterParameterGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateClusterParameterGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateClusterParameterGroupRequestT = Model::CreateClusterParameterGroupRequest>
  Model::CreateClusterParameterGroupOutcomeCallable CreateClusterParameterGroupCallable(
      const CreateClusterParameterGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateClusterParameterGroup, request);
  }

  /**
   * An Async wrapper for CreateClusterParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClusterParameterGroupRequestT = Model::CreateClusterParameterGroupRequest>
  void CreateClusterParameterGroupAsync(const CreateClusterParameterGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateClusterSecurityGroupOutcome CreateClusterSecurityGroup(
      const Model::CreateClusterSecurityGroupRequest& request) const;

  /**
   * A Callable wrapper for CreateClusterSecurityGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateClusterSecurityGroupRequestT = Model::CreateClusterSecurityGroupRequest>
  Model::CreateClusterSecurityGroupOutcomeCallable CreateClusterSecurityGroupCallable(
      const CreateClusterSecurityGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateClusterSecurityGroup, request);
  }

  /**
   * An Async wrapper for CreateClusterSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClusterSecurityGroupRequestT = Model::CreateClusterSecurityGroupRequest>
  void CreateClusterSecurityGroupAsync(const CreateClusterSecurityGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateClusterSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateClusterSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClusterSnapshotRequestT = Model::CreateClusterSnapshotRequest>
  void CreateClusterSnapshotAsync(const CreateClusterSnapshotRequestT& request, const CreateClusterSnapshotResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateClusterSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateClusterSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateClusterSubnetGroupRequestT = Model::CreateClusterSubnetGroupRequest>
  void CreateClusterSubnetGroupAsync(const CreateClusterSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateCustomDomainAssociationOutcome CreateCustomDomainAssociation(
      const Model::CreateCustomDomainAssociationRequest& request) const;

  /**
   * A Callable wrapper for CreateCustomDomainAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateCustomDomainAssociationRequestT = Model::CreateCustomDomainAssociationRequest>
  Model::CreateCustomDomainAssociationOutcomeCallable CreateCustomDomainAssociationCallable(
      const CreateCustomDomainAssociationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateCustomDomainAssociation, request);
  }

  /**
   * An Async wrapper for CreateCustomDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateCustomDomainAssociationRequestT = Model::CreateCustomDomainAssociationRequest>
  void CreateCustomDomainAssociationAsync(const CreateCustomDomainAssociationRequestT& request,
                                          const CreateCustomDomainAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateEndpointAccessRequestT = Model::CreateEndpointAccessRequest>
  void CreateEndpointAccessAsync(const CreateEndpointAccessRequestT& request, const CreateEndpointAccessResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateHsmClientCertificateOutcome CreateHsmClientCertificate(
      const Model::CreateHsmClientCertificateRequest& request) const;

  /**
   * A Callable wrapper for CreateHsmClientCertificate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateHsmClientCertificateRequestT = Model::CreateHsmClientCertificateRequest>
  Model::CreateHsmClientCertificateOutcomeCallable CreateHsmClientCertificateCallable(
      const CreateHsmClientCertificateRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateHsmClientCertificate, request);
  }

  /**
   * An Async wrapper for CreateHsmClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHsmClientCertificateRequestT = Model::CreateHsmClientCertificateRequest>
  void CreateHsmClientCertificateAsync(const CreateHsmClientCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateHsmConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateHsmConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateHsmConfigurationRequestT = Model::CreateHsmConfigurationRequest>
  void CreateHsmConfigurationAsync(const CreateHsmConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateRedshiftIdcApplicationOutcome CreateRedshiftIdcApplication(
      const Model::CreateRedshiftIdcApplicationRequest& request) const;

  /**
   * A Callable wrapper for CreateRedshiftIdcApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateRedshiftIdcApplicationRequestT = Model::CreateRedshiftIdcApplicationRequest>
  Model::CreateRedshiftIdcApplicationOutcomeCallable CreateRedshiftIdcApplicationCallable(
      const CreateRedshiftIdcApplicationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::CreateRedshiftIdcApplication, request);
  }

  /**
   * An Async wrapper for CreateRedshiftIdcApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateRedshiftIdcApplicationRequestT = Model::CreateRedshiftIdcApplicationRequest>
  void CreateRedshiftIdcApplicationAsync(const CreateRedshiftIdcApplicationRequestT& request,
                                         const CreateRedshiftIdcApplicationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateScheduledAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateScheduledAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateScheduledActionRequestT = Model::CreateScheduledActionRequest>
  void CreateScheduledActionAsync(const CreateScheduledActionRequestT& request, const CreateScheduledActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateSnapshotCopyGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSnapshotCopyGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSnapshotCopyGrantRequestT = Model::CreateSnapshotCopyGrantRequest>
  void CreateSnapshotCopyGrantAsync(const CreateSnapshotCopyGrantRequestT& request,
  ...
  /**
   * A Callable wrapper for CreateSnapshotSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateSnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateSnapshotScheduleRequestT = Model::CreateSnapshotScheduleRequest>
  void CreateSnapshotScheduleAsync(const CreateSnapshotScheduleResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const CreateSnapshotScheduleRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for CreateUsageLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateUsageLimit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateUsageLimitRequestT = Model::CreateUsageLimitRequest>
  void CreateUsageLimitAsync(const CreateUsageLimitRequestT& request, const CreateUsageLimitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeauthorizeDataShare that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeauthorizeDataShare that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeauthorizeDataShareRequestT = Model::DeauthorizeDataShareRequest>
  void DeauthorizeDataShareAsync(const DeauthorizeDataShareRequestT& request, const DeauthorizeDataShareResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteAuthenticationProfileOutcome DeleteAuthenticationProfile(
      const Model::DeleteAuthenticationProfileRequest& request) const;

  /**
   * A Callable wrapper for DeleteAuthenticationProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteAuthenticationProfileRequestT = Model::DeleteAuthenticationProfileRequest>
  Model::DeleteAuthenticationProfileOutcomeCallable DeleteAuthenticationProfileCallable(
      const DeleteAuthenticationProfileRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteAuthenticationProfile, request);
  }

  /**
   * An Async wrapper for DeleteAuthenticationProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAuthenticationProfileRequestT = Model::DeleteAuthenticationProfileRequest>
  void DeleteAuthenticationProfileAsync(const DeleteAuthenticationProfileRequestT& request,
                                        const DeleteAuthenticationProfileResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteClusterParameterGroupOutcome DeleteClusterParameterGroup(
      const Model::DeleteClusterParameterGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteClusterParameterGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteClusterParameterGroupRequestT = Model::DeleteClusterParameterGroupRequest>
  Model::DeleteClusterParameterGroupOutcomeCallable DeleteClusterParameterGroupCallable(
      const DeleteClusterParameterGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteClusterParameterGroup, request);
  }

  /**
   * An Async wrapper for DeleteClusterParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClusterParameterGroupRequestT = Model::DeleteClusterParameterGroupRequest>
  void DeleteClusterParameterGroupAsync(const DeleteClusterParameterGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteClusterSecurityGroupOutcome DeleteClusterSecurityGroup(
      const Model::DeleteClusterSecurityGroupRequest& request) const;

  /**
   * A Callable wrapper for DeleteClusterSecurityGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteClusterSecurityGroupRequestT = Model::DeleteClusterSecurityGroupRequest>
  Model::DeleteClusterSecurityGroupOutcomeCallable DeleteClusterSecurityGroupCallable(
      const DeleteClusterSecurityGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteClusterSecurityGroup, request);
  }

  /**
   * An Async wrapper for DeleteClusterSecurityGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClusterSecurityGroupRequestT = Model::DeleteClusterSecurityGroupRequest>
  void DeleteClusterSecurityGroupAsync(const DeleteClusterSecurityGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteClusterSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClusterSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClusterSnapshotRequestT = Model::DeleteClusterSnapshotRequest>
  void DeleteClusterSnapshotAsync(const DeleteClusterSnapshotRequestT& request, const DeleteClusterSnapshotResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteClusterSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteClusterSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteClusterSubnetGroupRequestT = Model::DeleteClusterSubnetGroupRequest>
  void DeleteClusterSubnetGroupAsync(const DeleteClusterSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteCustomDomainAssociationOutcome DeleteCustomDomainAssociation(
      const Model::DeleteCustomDomainAssociationRequest& request) const;

  /**
   * A Callable wrapper for DeleteCustomDomainAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteCustomDomainAssociationRequestT = Model::DeleteCustomDomainAssociationRequest>
  Model::DeleteCustomDomainAssociationOutcomeCallable DeleteCustomDomainAssociationCallable(
      const DeleteCustomDomainAssociationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteCustomDomainAssociation, request);
  }

  /**
   * An Async wrapper for DeleteCustomDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomDomainAssociationRequestT = Model::DeleteCustomDomainAssociationRequest>
  void DeleteCustomDomainAssociationAsync(const DeleteCustomDomainAssociationRequestT& request,
                                          const DeleteCustomDomainAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteEndpointAccessRequestT = Model::DeleteEndpointAccessRequest>
  void DeleteEndpointAccessAsync(const DeleteEndpointAccessRequestT& request, const DeleteEndpointAccessResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteHsmClientCertificateOutcome DeleteHsmClientCertificate(
      const Model::DeleteHsmClientCertificateRequest& request) const;

  /**
   * A Callable wrapper for DeleteHsmClientCertificate that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteHsmClientCertificateRequestT = Model::DeleteHsmClientCertificateRequest>
  Model::DeleteHsmClientCertificateOutcomeCallable DeleteHsmClientCertificateCallable(
      const DeleteHsmClientCertificateRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteHsmClientCertificate, request);
  }

  /**
   * An Async wrapper for DeleteHsmClientCertificate that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHsmClientCertificateRequestT = Model::DeleteHsmClientCertificateRequest>
  void DeleteHsmClientCertificateAsync(const DeleteHsmClientCertificateRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteHsmConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteHsmConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteHsmConfigurationRequestT = Model::DeleteHsmConfigurationRequest>
  void DeleteHsmConfigurationAsync(const DeleteHsmConfigurationRequestT& request,
  ...
  /**
   * An Async wrapper for DeletePartner that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeletePartnerRequestT = Model::DeletePartnerRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteRedshiftIdcApplicationOutcome DeleteRedshiftIdcApplication(
      const Model::DeleteRedshiftIdcApplicationRequest& request) const;

  /**
   * A Callable wrapper for DeleteRedshiftIdcApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteRedshiftIdcApplicationRequestT = Model::DeleteRedshiftIdcApplicationRequest>
  Model::DeleteRedshiftIdcApplicationOutcomeCallable DeleteRedshiftIdcApplicationCallable(
      const DeleteRedshiftIdcApplicationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DeleteRedshiftIdcApplication, request);
  }

  /**
   * An Async wrapper for DeleteRedshiftIdcApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteRedshiftIdcApplicationRequestT = Model::DeleteRedshiftIdcApplicationRequest>
  void DeleteRedshiftIdcApplicationAsync(const DeleteRedshiftIdcApplicationRequestT& request,
                                         const DeleteRedshiftIdcApplicationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteSnapshotCopyGrant that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSnapshotCopyGrant that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSnapshotCopyGrantRequestT = Model::DeleteSnapshotCopyGrantRequest>
  void DeleteSnapshotCopyGrantAsync(const DeleteSnapshotCopyGrantRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteSnapshotSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteSnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteSnapshotScheduleRequestT = Model::DeleteSnapshotScheduleRequest>
  void DeleteSnapshotScheduleAsync(const DeleteSnapshotScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteUsageLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUsageLimit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUsageLimitRequestT = Model::DeleteUsageLimitRequest>
  void DeleteUsageLimitAsync(const DeleteUsageLimitRequestT& request, const DeleteUsageLimitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeregisterNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeregisterNamespace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeregisterNamespaceRequestT = Model::DeregisterNamespaceRequest>
  void DeregisterNamespaceAsync(const DeregisterNamespaceRequestT& request, const DeregisterNamespaceResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAuthenticationProfilesOutcome DescribeAuthenticationProfiles(
      const Model::DescribeAuthenticationProfilesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAuthenticationProfiles that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAuthenticationProfilesRequestT = Model::DescribeAuthenticationProfilesRequest>
  Model::DescribeAuthenticationProfilesOutcomeCallable DescribeAuthenticationProfilesCallable(
      const DescribeAuthenticationProfilesRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeAuthenticationProfiles, request);
  }

  /**
   * An Async wrapper for DescribeAuthenticationProfiles that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeAuthenticationProfilesRequestT = Model::DescribeAuthenticationProfilesRequest>
  void DescribeAuthenticationProfilesAsync(const DescribeAuthenticationProfilesResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeAuthenticationProfilesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClusterDbRevisionsOutcome DescribeClusterDbRevisions(
      const Model::DescribeClusterDbRevisionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeClusterDbRevisions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterDbRevisionsRequestT = Model::DescribeClusterDbRevisionsRequest>
  Model::DescribeClusterDbRevisionsOutcomeCallable DescribeClusterDbRevisionsCallable(
      const DescribeClusterDbRevisionsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterDbRevisions, request);
  }

  /**
   * An Async wrapper for DescribeClusterDbRevisions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterDbRevisionsRequestT = Model::DescribeClusterDbRevisionsRequest>
  void DescribeClusterDbRevisionsAsync(const DescribeClusterDbRevisionsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeClusterDbRevisionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClusterParameterGroupsOutcome DescribeClusterParameterGroups(
      const Model::DescribeClusterParameterGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeClusterParameterGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterParameterGroupsRequestT = Model::DescribeClusterParameterGroupsRequest>
  Model::DescribeClusterParameterGroupsOutcomeCallable DescribeClusterParameterGroupsCallable(
      const DescribeClusterParameterGroupsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterParameterGroups, request);
  }

  /**
   * An Async wrapper for DescribeClusterParameterGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeClusterParameterGroupsRequestT = Model::DescribeClusterParameterGroupsRequest>
  void DescribeClusterParameterGroupsAsync(const DescribeClusterParameterGroupsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const DescribeClusterParameterGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeClusterParametersRequestT = Model::DescribeClusterParametersRequest>
  Model::DescribeClusterParametersOutcomeCallable DescribeClusterParametersCallable(
      const DescribeClusterParametersRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterParameters, request);
  }

  /**
   * An Async wrapper for DescribeClusterParameters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterParametersRequestT = Model::DescribeClusterParametersRequest>
  void DescribeClusterParametersAsync(const DescribeClusterParametersRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClusterSecurityGroupsOutcome DescribeClusterSecurityGroups(
      const Model::DescribeClusterSecurityGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeClusterSecurityGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterSecurityGroupsRequestT = Model::DescribeClusterSecurityGroupsRequest>
  Model::DescribeClusterSecurityGroupsOutcomeCallable DescribeClusterSecurityGroupsCallable(
      const DescribeClusterSecurityGroupsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterSecurityGroups, request);
  }

  /**
   * An Async wrapper for DescribeClusterSecurityGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterSecurityGroupsRequestT = Model::DescribeClusterSecurityGroupsRequest>
  void DescribeClusterSecurityGroupsAsync(const DescribeClusterSecurityGroupsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeClusterSecurityGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterSnapshots that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeClusterSnapshotsRequestT = Model::DescribeClusterSnapshotsRequest>
  Model::DescribeClusterSnapshotsOutcomeCallable DescribeClusterSnapshotsCallable(
      const DescribeClusterSnapshotsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterSnapshots, request);
  }

  /**
   * An Async wrapper for DescribeClusterSnapshots that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterSnapshotsRequestT = Model::DescribeClusterSnapshotsRequest>
  void DescribeClusterSnapshotsAsync(const DescribeClusterSnapshotsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                     const DescribeClusterSnapshotsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeClusterSubnetGroupsOutcome DescribeClusterSubnetGroups(
      const Model::DescribeClusterSubnetGroupsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeClusterSubnetGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeClusterSubnetGroupsRequestT = Model::DescribeClusterSubnetGroupsRequest>
  Model::DescribeClusterSubnetGroupsOutcomeCallable DescribeClusterSubnetGroupsCallable(
      const DescribeClusterSubnetGroupsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeClusterSubnetGroups, request);
  }

  /**
   * An Async wrapper for DescribeClusterSubnetGroups that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterSubnetGroupsRequestT = Model::DescribeClusterSubnetGroupsRequest>
  void DescribeClusterSubnetGroupsAsync(const DescribeClusterSubnetGroupsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                        const DescribeClusterSubnetGroupsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterTracks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterTracks that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterTracksRequestT = Model::DescribeClusterTracksRequest>
  void DescribeClusterTracksAsync(const DescribeClusterTracksResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeClusterTracksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeClusterVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeClusterVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeClusterVersionsRequestT = Model::DescribeClusterVersionsRequest>
  void DescribeClusterVersionsAsync(const DescribeClusterVersionsResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                    const DescribeClusterVersionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeCustomDomainAssociationsOutcome DescribeCustomDomainAssociations(
      const Model::DescribeCustomDomainAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeCustomDomainAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeCustomDomainAssociationsRequestT = Model::DescribeCustomDomainAssociationsRequest>
  Model::DescribeCustomDomainAssociationsOutcomeCallable DescribeCustomDomainAssociationsCallable(
      const DescribeCustomDomainAssociationsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeCustomDomainAssociations, request);
  }

  /**
   * An Async wrapper for DescribeCustomDomainAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCustomDomainAssociationsRequestT = Model::DescribeCustomDomainAssociationsRequest>
  void DescribeCustomDomainAssociationsAsync(const DescribeCustomDomainAssociationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                             const DescribeCustomDomainAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeDataShares that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeDataShares that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeDataSharesRequestT = Model::DescribeDataSharesRequest>
  void DescribeDataSharesAsync(const DescribeDataSharesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeDataSharesRequestT& request = {}) const {
  ...
  virtual Model::DescribeDataSharesForConsumerOutcome DescribeDataSharesForConsumer(
      const Model::DescribeDataSharesForConsumerRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDataSharesForConsumer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDataSharesForConsumerRequestT = Model::DescribeDataSharesForConsumerRequest>
  Model::DescribeDataSharesForConsumerOutcomeCallable DescribeDataSharesForConsumerCallable(
      const DescribeDataSharesForConsumerRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeDataSharesForConsumer, request);
  }

  /**
   * An Async wrapper for DescribeDataSharesForConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataSharesForConsumerRequestT = Model::DescribeDataSharesForConsumerRequest>
  void DescribeDataSharesForConsumerAsync(const DescribeDataSharesForConsumerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeDataSharesForConsumerRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDataSharesForProducerOutcome DescribeDataSharesForProducer(
      const Model::DescribeDataSharesForProducerRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDataSharesForProducer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeDataSharesForProducerRequestT = Model::DescribeDataSharesForProducerRequest>
  Model::DescribeDataSharesForProducerOutcomeCallable DescribeDataSharesForProducerCallable(
      const DescribeDataSharesForProducerRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeDataSharesForProducer, request);
  }

  /**
   * An Async wrapper for DescribeDataSharesForProducer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDataSharesForProducerRequestT = Model::DescribeDataSharesForProducerRequest>
  void DescribeDataSharesForProducerAsync(const DescribeDataSharesForProducerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeDataSharesForProducerRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDefaultClusterParametersOutcome DescribeDefaultClusterParameters(
      const Model::DescribeDefaultClusterParametersRequest& request) const;

  /**
   * A Callable wrapper for DescribeDefaultClusterParameters that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeDefaultClusterParametersRequestT = Model::DescribeDefaultClusterParametersRequest>
  Model::DescribeDefaultClusterParametersOutcomeCallable DescribeDefaultClusterParametersCallable(
      const DescribeDefaultClusterParametersRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DescribeDefaultClusterParameters, request);
  }

  /**
   * An Async wrapper for DescribeDefaultClusterParameters that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeDefaultClusterParametersRequestT = Model::DescribeDefaultClusterParametersRequest>
  void DescribeDefaultClusterParametersAsync(const DescribeDefaultClusterParametersRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointAccessRequestT = Model::DescribeEndpointAccessRequest>
  void DescribeEndpointAccessAsync(const DescribeEndpointAccessResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const DescribeEndpointAccessRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeEndpointAuthorizationOutcome DescribeEndpointAuthorization(
      const Model::DescribeEndpointAuthorizationRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeEndpointAuthorization that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeEndpointAuthorizationRequestT = Model::DescribeEndpointAuthorizationRequest>
  Model::DescribeEndpointAuthorizationOutcomeCallable DescribeEndpointAuthorizationCallable(
      const DescribeEndpointAuthorizationRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeEndpointAuthorization, request);
  }

  /**
   * An Async wrapper for DescribeEndpointAuthorization that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeEndpointAuthorizationRequestT = Model::DescribeEndpointAuthorizationRequest>
  void DescribeEndpointAuthorizationAsync(const DescribeEndpointAuthorizationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeEndpointAuthorizationRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHsmClientCertificatesOutcome DescribeHsmClientCertificates(
      const Model::DescribeHsmClientCertificatesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeHsmClientCertificates that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeHsmClientCertificatesRequestT = Model::DescribeHsmClientCertificatesRequest>
  Model::DescribeHsmClientCertificatesOutcomeCallable DescribeHsmClientCertificatesCallable(
      const DescribeHsmClientCertificatesRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeHsmClientCertificates, request);
  }

  /**
   * An Async wrapper for DescribeHsmClientCertificates that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHsmClientCertificatesRequestT = Model::DescribeHsmClientCertificatesRequest>
  void DescribeHsmClientCertificatesAsync(const DescribeHsmClientCertificatesResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeHsmClientCertificatesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeHsmConfigurationsOutcome DescribeHsmConfigurations(
      const Model::DescribeHsmConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeHsmConfigurations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeHsmConfigurationsRequestT = Model::DescribeHsmConfigurationsRequest>
  Model::DescribeHsmConfigurationsOutcomeCallable DescribeHsmConfigurationsCallable(
      const DescribeHsmConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeHsmConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeHsmConfigurations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeHsmConfigurationsRequestT = Model::DescribeHsmConfigurationsRequest>
  void DescribeHsmConfigurationsAsync(const DescribeHsmConfigurationsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeHsmConfigurationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeLoggingStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeLoggingStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeLoggingStatusRequestT = Model::DescribeLoggingStatusRequest>
  void DescribeLoggingStatusAsync(const DescribeLoggingStatusRequestT& request, const DescribeLoggingStatusResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeNodeConfigurationOptionsOutcome DescribeNodeConfigurationOptions(
      const Model::DescribeNodeConfigurationOptionsRequest& request) const;

  /**
   * A Callable wrapper for DescribeNodeConfigurationOptions that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeNodeConfigurationOptionsRequestT = Model::DescribeNodeConfigurationOptionsRequest>
  Model::DescribeNodeConfigurationOptionsOutcomeCallable DescribeNodeConfigurationOptionsCallable(
      const DescribeNodeConfigurationOptionsRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DescribeNodeConfigurationOptions, request);
  }

  /**
   * An Async wrapper for DescribeNodeConfigurationOptions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeNodeConfigurationOptionsRequestT = Model::DescribeNodeConfigurationOptionsRequest>
  void DescribeNodeConfigurationOptionsAsync(const DescribeNodeConfigurationOptionsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeOrderableClusterOptionsOutcome DescribeOrderableClusterOptions(
      const Model::DescribeOrderableClusterOptionsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeOrderableClusterOptions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeOrderableClusterOptionsRequestT = Model::DescribeOrderableClusterOptionsRequest>
  Model::DescribeOrderableClusterOptionsOutcomeCallable DescribeOrderableClusterOptionsCallable(
      const DescribeOrderableClusterOptionsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeOrderableClusterOptions, request);
  }

  /**
   * An Async wrapper for DescribeOrderableClusterOptions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeOrderableClusterOptionsRequestT = Model::DescribeOrderableClusterOptionsRequest>
  void DescribeOrderableClusterOptionsAsync(const DescribeOrderableClusterOptionsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeOrderableClusterOptionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribePartners that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribePartners that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribePartnersRequestT = Model::DescribePartnersRequest>
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeRedshiftIdcApplicationsOutcome DescribeRedshiftIdcApplications(
      const Model::DescribeRedshiftIdcApplicationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeRedshiftIdcApplications that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeRedshiftIdcApplicationsRequestT = Model::DescribeRedshiftIdcApplicationsRequest>
  Model::DescribeRedshiftIdcApplicationsOutcomeCallable DescribeRedshiftIdcApplicationsCallable(
      const DescribeRedshiftIdcApplicationsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeRedshiftIdcApplications, request);
  }

  /**
   * An Async wrapper for DescribeRedshiftIdcApplications that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeRedshiftIdcApplicationsRequestT = Model::DescribeRedshiftIdcApplicationsRequest>
  void DescribeRedshiftIdcApplicationsAsync(const DescribeRedshiftIdcApplicationsResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                            const DescribeRedshiftIdcApplicationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReservedNodeExchangeStatusOutcome DescribeReservedNodeExchangeStatus(
      const Model::DescribeReservedNodeExchangeStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedNodeExchangeStatus that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeReservedNodeExchangeStatusRequestT = Model::DescribeReservedNodeExchangeStatusRequest>
  Model::DescribeReservedNodeExchangeStatusOutcomeCallable DescribeReservedNodeExchangeStatusCallable(
      const DescribeReservedNodeExchangeStatusRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeReservedNodeExchangeStatus, request);
  }

  /**
   * An Async wrapper for DescribeReservedNodeExchangeStatus that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeReservedNodeExchangeStatusRequestT = Model::DescribeReservedNodeExchangeStatusRequest>
  void DescribeReservedNodeExchangeStatusAsync(const DescribeReservedNodeExchangeStatusResponseReceivedHandler& handler,
                                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                               const DescribeReservedNodeExchangeStatusRequestT& request = {}) const {
  ...
  virtual Model::DescribeReservedNodeOfferingsOutcome DescribeReservedNodeOfferings(
      const Model::DescribeReservedNodeOfferingsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReservedNodeOfferings that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeReservedNodeOfferingsRequestT = Model::DescribeReservedNodeOfferingsRequest>
  Model::DescribeReservedNodeOfferingsOutcomeCallable DescribeReservedNodeOfferingsCallable(
      const DescribeReservedNodeOfferingsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeReservedNodeOfferings, request);
  }

  /**
   * An Async wrapper for DescribeReservedNodeOfferings that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeReservedNodeOfferingsRequestT = Model::DescribeReservedNodeOfferingsRequest>
  void DescribeReservedNodeOfferingsAsync(const DescribeReservedNodeOfferingsResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                          const DescribeReservedNodeOfferingsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeResize that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeResizeRequestT = Model::DescribeResizeRequest>
  void DescribeResizeAsync(const DescribeResizeRequestT& request, const DescribeResizeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSnapshotCopyGrantsOutcome DescribeSnapshotCopyGrants(
      const Model::DescribeSnapshotCopyGrantsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeSnapshotCopyGrants that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeSnapshotCopyGrantsRequestT = Model::DescribeSnapshotCopyGrantsRequest>
  Model::DescribeSnapshotCopyGrantsOutcomeCallable DescribeSnapshotCopyGrantsCallable(
      const DescribeSnapshotCopyGrantsRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeSnapshotCopyGrants, request);
  }

  /**
   * An Async wrapper for DescribeSnapshotCopyGrants that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSnapshotCopyGrantsRequestT = Model::DescribeSnapshotCopyGrantsRequest>
  void DescribeSnapshotCopyGrantsAsync(const DescribeSnapshotCopyGrantsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeSnapshotCopyGrantsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeSnapshotSchedulesOutcome DescribeSnapshotSchedules(
      const Model::DescribeSnapshotSchedulesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeSnapshotSchedules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeSnapshotSchedulesRequestT = Model::DescribeSnapshotSchedulesRequest>
  Model::DescribeSnapshotSchedulesOutcomeCallable DescribeSnapshotSchedulesCallable(
      const DescribeSnapshotSchedulesRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeSnapshotSchedules, request);
  }

  /**
   * An Async wrapper for DescribeSnapshotSchedules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSnapshotSchedulesRequestT = Model::DescribeSnapshotSchedulesRequest>
  void DescribeSnapshotSchedulesAsync(const DescribeSnapshotSchedulesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeSnapshotSchedulesRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DescribeStorage that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeStorageRequestT = Model::DescribeStorageRequest>
  void DescribeStorageAsync(const DescribeStorageResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const DescribeStorageRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTableRestoreStatusOutcome DescribeTableRestoreStatus(
      const Model::DescribeTableRestoreStatusRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeTableRestoreStatus that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeTableRestoreStatusRequestT = Model::DescribeTableRestoreStatusRequest>
  Model::DescribeTableRestoreStatusOutcomeCallable DescribeTableRestoreStatusCallable(
      const DescribeTableRestoreStatusRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::DescribeTableRestoreStatus, request);
  }

  /**
   * An Async wrapper for DescribeTableRestoreStatus that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTableRestoreStatusRequestT = Model::DescribeTableRestoreStatusRequest>
  void DescribeTableRestoreStatusAsync(const DescribeTableRestoreStatusResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeTableRestoreStatusRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeUsageLimits that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeUsageLimits that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeUsageLimitsRequestT = Model::DescribeUsageLimitsRequest>
  void DescribeUsageLimitsAsync(const DescribeUsageLimitsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeUsageLimitsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DisableLogging that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DisableLoggingRequestT = Model::DisableLoggingRequest>
  void DisableLoggingAsync(const DisableLoggingRequestT& request, const DisableLoggingResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DisableSnapshotCopy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableSnapshotCopy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableSnapshotCopyRequestT = Model::DisableSnapshotCopyRequest>
  void DisableSnapshotCopyAsync(const DisableSnapshotCopyRequestT& request, const DisableSnapshotCopyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DisassociateDataShareConsumerOutcome DisassociateDataShareConsumer(
      const Model::DisassociateDataShareConsumerRequest& request) const;

  /**
   * A Callable wrapper for DisassociateDataShareConsumer that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisassociateDataShareConsumerRequestT = Model::DisassociateDataShareConsumerRequest>
  Model::DisassociateDataShareConsumerOutcomeCallable DisassociateDataShareConsumerCallable(
      const DisassociateDataShareConsumerRequestT& request) const {
    return SubmitCallable(&RedshiftClient::DisassociateDataShareConsumer, request);
  }

  /**
   * An Async wrapper for DisassociateDataShareConsumer that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisassociateDataShareConsumerRequestT = Model::DisassociateDataShareConsumerRequest>
  void DisassociateDataShareConsumerAsync(const DisassociateDataShareConsumerRequestT& request,
                                          const DisassociateDataShareConsumerResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for EnableLogging that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename EnableLoggingRequestT = Model::EnableLoggingRequest>
  void EnableLoggingAsync(const EnableLoggingRequestT& request, const EnableLoggingResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for EnableSnapshotCopy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableSnapshotCopy that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableSnapshotCopyRequestT = Model::EnableSnapshotCopyRequest>
  void EnableSnapshotCopyAsync(const EnableSnapshotCopyRequestT& request, const EnableSnapshotCopyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for FailoverPrimaryCompute that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for FailoverPrimaryCompute that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename FailoverPrimaryComputeRequestT = Model::FailoverPrimaryComputeRequest>
  void FailoverPrimaryComputeAsync(const FailoverPrimaryComputeRequestT& request,
                                   const FailoverPrimaryComputeResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetClusterCredentials that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetClusterCredentials that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClusterCredentialsRequestT = Model::GetClusterCredentialsRequest>
  void GetClusterCredentialsAsync(const GetClusterCredentialsRequestT& request, const GetClusterCredentialsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetClusterCredentialsWithIAMOutcome GetClusterCredentialsWithIAM(
      const Model::GetClusterCredentialsWithIAMRequest& request = {}) const;

  /**
   * A Callable wrapper for GetClusterCredentialsWithIAM that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetClusterCredentialsWithIAMRequestT = Model::GetClusterCredentialsWithIAMRequest>
  Model::GetClusterCredentialsWithIAMOutcomeCallable GetClusterCredentialsWithIAMCallable(
      const GetClusterCredentialsWithIAMRequestT& request = {}) const {
    return SubmitCallable(&RedshiftClient::GetClusterCredentialsWithIAM, request);
  }

  /**
   * An Async wrapper for GetClusterCredentialsWithIAM that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetClusterCredentialsWithIAMRequestT = Model::GetClusterCredentialsWithIAMRequest>
  void GetClusterCredentialsWithIAMAsync(const GetClusterCredentialsWithIAMResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const GetClusterCredentialsWithIAMRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetReservedNodeExchangeConfigurationOptionsOutcome GetReservedNodeExchangeConfigurationOptions(
      const Model::GetReservedNodeExchangeConfigurationOptionsRequest& request) const;

  /**
   * A Callable wrapper for GetReservedNodeExchangeConfigurationOptions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  ...
  Model::GetReservedNodeExchangeConfigurationOptionsOutcomeCallable GetReservedNodeExchangeConfigurationOptionsCallable(
      const GetReservedNodeExchangeConfigurationOptionsRequestT& request) const {
    return SubmitCallable(&RedshiftClient::GetReservedNodeExchangeConfigurationOptions, request);
  }

  /**
   * An Async wrapper for GetReservedNodeExchangeConfigurationOptions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename GetReservedNodeExchangeConfigurationOptionsRequestT = Model::GetReservedNodeExchangeConfigurationOptionsRequest>
  void GetReservedNodeExchangeConfigurationOptionsAsync(
      const GetReservedNodeExchangeConfigurationOptionsRequestT& request,
      const GetReservedNodeExchangeConfigurationOptionsResponseReceivedHandler& handler,
      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetReservedNodeExchangeOfferingsOutcome GetReservedNodeExchangeOfferings(
      const Model::GetReservedNodeExchangeOfferingsRequest& request) const;

  /**
   * A Callable wrapper for GetReservedNodeExchangeOfferings that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetReservedNodeExchangeOfferingsRequestT = Model::GetReservedNodeExchangeOfferingsRequest>
  Model::GetReservedNodeExchangeOfferingsOutcomeCallable GetReservedNodeExchangeOfferingsCallable(
      const GetReservedNodeExchangeOfferingsRequestT& request) const {
    return SubmitCallable(&RedshiftClient::GetReservedNodeExchangeOfferings, request);
  }

  /**
   * An Async wrapper for GetReservedNodeExchangeOfferings that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetReservedNodeExchangeOfferingsRequestT = Model::GetReservedNodeExchangeOfferingsRequest>
  void GetReservedNodeExchangeOfferingsAsync(const GetReservedNodeExchangeOfferingsRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyAquaConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyAquaConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyAquaConfigurationRequestT = Model::ModifyAquaConfigurationRequest>
  void ModifyAquaConfigurationAsync(const ModifyAquaConfigurationRequestT& request,
                                    const ModifyAquaConfigurationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyAuthenticationProfileOutcome ModifyAuthenticationProfile(
      const Model::ModifyAuthenticationProfileRequest& request) const;

  /**
   * A Callable wrapper for ModifyAuthenticationProfile that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyAuthenticationProfileRequestT = Model::ModifyAuthenticationProfileRequest>
  Model::ModifyAuthenticationProfileOutcomeCallable ModifyAuthenticationProfileCallable(
      const ModifyAuthenticationProfileRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifyAuthenticationProfile, request);
  }

  /**
   * An Async wrapper for ModifyAuthenticationProfile that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyAuthenticationProfileRequestT = Model::ModifyAuthenticationProfileRequest>
  void ModifyAuthenticationProfileAsync(const ModifyAuthenticationProfileRequestT& request,
                                        const ModifyAuthenticationProfileResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ModifyCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ModifyClusterRequestT = Model::ModifyClusterRequest>
  void ModifyClusterAsync(const ModifyClusterRequestT& request, const ModifyClusterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyClusterDbRevision that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClusterDbRevision that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterDbRevisionRequestT = Model::ModifyClusterDbRevisionRequest>
  void ModifyClusterDbRevisionAsync(const ModifyClusterDbRevisionRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyClusterIamRoles that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClusterIamRoles that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterIamRolesRequestT = Model::ModifyClusterIamRolesRequest>
  void ModifyClusterIamRolesAsync(const ModifyClusterIamRolesRequestT& request, const ModifyClusterIamRolesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyClusterMaintenance that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClusterMaintenance that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterMaintenanceRequestT = Model::ModifyClusterMaintenanceRequest>
  void ModifyClusterMaintenanceAsync(const ModifyClusterMaintenanceRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyClusterParameterGroupOutcome ModifyClusterParameterGroup(
      const Model::ModifyClusterParameterGroupRequest& request) const;

  /**
   * A Callable wrapper for ModifyClusterParameterGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyClusterParameterGroupRequestT = Model::ModifyClusterParameterGroupRequest>
  Model::ModifyClusterParameterGroupOutcomeCallable ModifyClusterParameterGroupCallable(
      const ModifyClusterParameterGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifyClusterParameterGroup, request);
  }

  /**
   * An Async wrapper for ModifyClusterParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterParameterGroupRequestT = Model::ModifyClusterParameterGroupRequest>
  void ModifyClusterParameterGroupAsync(const ModifyClusterParameterGroupRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyClusterSnapshot that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClusterSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterSnapshotRequestT = Model::ModifyClusterSnapshotRequest>
  void ModifyClusterSnapshotAsync(const ModifyClusterSnapshotRequestT& request, const ModifyClusterSnapshotResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyClusterSnapshotScheduleOutcome ModifyClusterSnapshotSchedule(
      const Model::ModifyClusterSnapshotScheduleRequest& request) const;

  /**
   * A Callable wrapper for ModifyClusterSnapshotSchedule that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyClusterSnapshotScheduleRequestT = Model::ModifyClusterSnapshotScheduleRequest>
  Model::ModifyClusterSnapshotScheduleOutcomeCallable ModifyClusterSnapshotScheduleCallable(
      const ModifyClusterSnapshotScheduleRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifyClusterSnapshotSchedule, request);
  }

  /**
   * An Async wrapper for ModifyClusterSnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterSnapshotScheduleRequestT = Model::ModifyClusterSnapshotScheduleRequest>
  void ModifyClusterSnapshotScheduleAsync(const ModifyClusterSnapshotScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyClusterSubnetGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyClusterSubnetGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyClusterSubnetGroupRequestT = Model::ModifyClusterSubnetGroupRequest>
  void ModifyClusterSubnetGroupAsync(const ModifyClusterSubnetGroupRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyCustomDomainAssociationOutcome ModifyCustomDomainAssociation(
      const Model::ModifyCustomDomainAssociationRequest& request) const;

  /**
   * A Callable wrapper for ModifyCustomDomainAssociation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyCustomDomainAssociationRequestT = Model::ModifyCustomDomainAssociationRequest>
  Model::ModifyCustomDomainAssociationOutcomeCallable ModifyCustomDomainAssociationCallable(
      const ModifyCustomDomainAssociationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifyCustomDomainAssociation, request);
  }

  /**
   * An Async wrapper for ModifyCustomDomainAssociation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyCustomDomainAssociationRequestT = Model::ModifyCustomDomainAssociationRequest>
  void ModifyCustomDomainAssociationAsync(const ModifyCustomDomainAssociationRequestT& request,
                                          const ModifyCustomDomainAssociationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyEndpointAccessRequestT = Model::ModifyEndpointAccessRequest>
  void ModifyEndpointAccessAsync(const ModifyEndpointAccessRequestT& request, const ModifyEndpointAccessResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyRedshiftIdcApplicationOutcome ModifyRedshiftIdcApplication(
      const Model::ModifyRedshiftIdcApplicationRequest& request) const;

  /**
   * A Callable wrapper for ModifyRedshiftIdcApplication that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyRedshiftIdcApplicationRequestT = Model::ModifyRedshiftIdcApplicationRequest>
  Model::ModifyRedshiftIdcApplicationOutcomeCallable ModifyRedshiftIdcApplicationCallable(
      const ModifyRedshiftIdcApplicationRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifyRedshiftIdcApplication, request);
  }

  /**
   * An Async wrapper for ModifyRedshiftIdcApplication that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyRedshiftIdcApplicationRequestT = Model::ModifyRedshiftIdcApplicationRequest>
  void ModifyRedshiftIdcApplicationAsync(const ModifyRedshiftIdcApplicationRequestT& request,
                                         const ModifyRedshiftIdcApplicationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ModifyScheduledAction that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyScheduledAction that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifyScheduledActionRequestT = Model::ModifyScheduledActionRequest>
  void ModifyScheduledActionAsync(const ModifyScheduledActionRequestT& request, const ModifyScheduledActionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifySnapshotCopyRetentionPeriodOutcome ModifySnapshotCopyRetentionPeriod(
      const Model::ModifySnapshotCopyRetentionPeriodRequest& request) const;

  /**
   * A Callable wrapper for ModifySnapshotCopyRetentionPeriod that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ModifySnapshotCopyRetentionPeriodRequestT = Model::ModifySnapshotCopyRetentionPeriodRequest>
  Model::ModifySnapshotCopyRetentionPeriodOutcomeCallable ModifySnapshotCopyRetentionPeriodCallable(
      const ModifySnapshotCopyRetentionPeriodRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ModifySnapshotCopyRetentionPeriod, request);
  }

  /**
   * An Async wrapper for ModifySnapshotCopyRetentionPeriod that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ModifySnapshotCopyRetentionPeriodRequestT = Model::ModifySnapshotCopyRetentionPeriodRequest>
  void ModifySnapshotCopyRetentionPeriodAsync(const ModifySnapshotCopyRetentionPeriodRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifySnapshotSchedule that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifySnapshotSchedule that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ModifySnapshotScheduleRequestT = Model::ModifySnapshotScheduleRequest>
  void ModifySnapshotScheduleAsync(const ModifySnapshotScheduleRequestT& request,
  ...
  /**
   * A Callable wrapper for ModifyUsageLimit that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ModifyUsageLimit that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ModifyUsageLimitRequestT = Model::ModifyUsageLimitRequest>
  void ModifyUsageLimitAsync(const ModifyUsageLimitRequestT& request, const ModifyUsageLimitResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PauseCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PauseClusterRequestT = Model::PauseClusterRequest>
  void PauseClusterAsync(const PauseClusterRequestT& request, const PauseClusterResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::PurchaseReservedNodeOfferingOutcome PurchaseReservedNodeOffering(
      const Model::PurchaseReservedNodeOfferingRequest& request) const;

  /**
   * A Callable wrapper for PurchaseReservedNodeOffering that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename PurchaseReservedNodeOfferingRequestT = Model::PurchaseReservedNodeOfferingRequest>
  Model::PurchaseReservedNodeOfferingOutcomeCallable PurchaseReservedNodeOfferingCallable(
      const PurchaseReservedNodeOfferingRequestT& request) const {
    return SubmitCallable(&RedshiftClient::PurchaseReservedNodeOffering, request);
  }

  /**
   * An Async wrapper for PurchaseReservedNodeOffering that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PurchaseReservedNodeOfferingRequestT = Model::PurchaseReservedNodeOfferingRequest>
  void PurchaseReservedNodeOfferingAsync(const PurchaseReservedNodeOfferingRequestT& request,
  ...
  /**
   * An Async wrapper for RebootCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RebootClusterRequestT = Model::RebootClusterRequest>
  void RebootClusterAsync(const RebootClusterRequestT& request, const RebootClusterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RegisterNamespace that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RegisterNamespace that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RegisterNamespaceRequestT = Model::RegisterNamespaceRequest>
  void RegisterNamespaceAsync(const RegisterNamespaceRequestT& request, const RegisterNamespaceResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RejectDataShare that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RejectDataShareRequestT = Model::RejectDataShareRequest>
  void RejectDataShareAsync(const RejectDataShareRequestT& request, const RejectDataShareResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ResetClusterParameterGroupOutcome ResetClusterParameterGroup(
      const Model::ResetClusterParameterGroupRequest& request) const;

  /**
   * A Callable wrapper for ResetClusterParameterGroup that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ResetClusterParameterGroupRequestT = Model::ResetClusterParameterGroupRequest>
  Model::ResetClusterParameterGroupOutcomeCallable ResetClusterParameterGroupCallable(
      const ResetClusterParameterGroupRequestT& request) const {
    return SubmitCallable(&RedshiftClient::ResetClusterParameterGroup, request);
  }

  /**
   * An Async wrapper for ResetClusterParameterGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ResetClusterParameterGroupRequestT = Model::ResetClusterParameterGroupRequest>
  void ResetClusterParameterGroupAsync(const ResetClusterParameterGroupRequestT& request,
  ...
  /**
   * An Async wrapper for ResizeCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResizeClusterRequestT = Model::ResizeClusterRequest>
  void ResizeClusterAsync(const ResizeClusterRequestT& request, const ResizeClusterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreFromClusterSnapshotOutcome RestoreFromClusterSnapshot(
      const Model::RestoreFromClusterSnapshotRequest& request) const;

  /**
   * A Callable wrapper for RestoreFromClusterSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreFromClusterSnapshotRequestT = Model::RestoreFromClusterSnapshotRequest>
  Model::RestoreFromClusterSnapshotOutcomeCallable RestoreFromClusterSnapshotCallable(
      const RestoreFromClusterSnapshotRequestT& request) const {
    return SubmitCallable(&RedshiftClient::RestoreFromClusterSnapshot, request);
  }

  /**
   * An Async wrapper for RestoreFromClusterSnapshot that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RestoreFromClusterSnapshotRequestT = Model::RestoreFromClusterSnapshotRequest>
  void RestoreFromClusterSnapshotAsync(const RestoreFromClusterSnapshotRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::RestoreTableFromClusterSnapshotOutcome RestoreTableFromClusterSnapshot(
      const Model::RestoreTableFromClusterSnapshotRequest& request) const;

  /**
   * A Callable wrapper for RestoreTableFromClusterSnapshot that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename RestoreTableFromClusterSnapshotRequestT = Model::RestoreTableFromClusterSnapshotRequest>
  Model::RestoreTableFromClusterSnapshotOutcomeCallable RestoreTableFromClusterSnapshotCallable(
      const RestoreTableFromClusterSnapshotRequestT& request) const {
    return SubmitCallable(&RedshiftClient::RestoreTableFromClusterSnapshot, request);
  }

  /**
   * An Async wrapper for RestoreTableFromClusterSnapshot that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RestoreTableFromClusterSnapshotRequestT = Model::RestoreTableFromClusterSnapshotRequest>
  void RestoreTableFromClusterSnapshotAsync(const RestoreTableFromClusterSnapshotRequestT& request,
  ...
  /**
   * An Async wrapper for ResumeCluster that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ResumeClusterRequestT = Model::ResumeClusterRequest>
  void ResumeClusterAsync(const ResumeClusterRequestT& request, const ResumeClusterResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::RevokeClusterSecurityGroupIngressOutcome RevokeClusterSecurityGroupIngress(
      const Model::RevokeClusterSecurityGroupIngressRequest& request) const;

  /**
   * A Callable wrapper for RevokeClusterSecurityGroupIngress that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename RevokeClusterSecurityGroupIngressRequestT = Model::RevokeClusterSecurityGroupIngressRequest>
  Model::RevokeClusterSecurityGroupIngressOutcomeCallable RevokeClusterSecurityGroupIngressCallable(
      const RevokeClusterSecurityGroupIngressRequestT& request) const {
    return SubmitCallable(&RedshiftClient::RevokeClusterSecurityGroupIngress, request);
  }

  /**
   * An Async wrapper for RevokeClusterSecurityGroupIngress that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename RevokeClusterSecurityGroupIngressRequestT = Model::RevokeClusterSecurityGroupIngressRequest>
  void RevokeClusterSecurityGroupIngressAsync(const RevokeClusterSecurityGroupIngressRequestT& request,
  ...
  /**
   * A Callable wrapper for RevokeEndpointAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RevokeEndpointAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RevokeEndpointAccessRequestT = Model::RevokeEndpointAccessRequest>
  void RevokeEndpointAccessAsync(const RevokeEndpointAccessResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const RevokeEndpointAccessRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for RevokeSnapshotAccess that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RevokeSnapshotAccess that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename RevokeSnapshotAccessRequestT = Model::RevokeSnapshotAccessRequest>
  void RevokeSnapshotAccessAsync(const RevokeSnapshotAccessRequestT& request, const RevokeSnapshotAccessResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for RotateEncryptionKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for RotateEncryptionKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename RotateEncryptionKeyRequestT = Model::RotateEncryptionKeyRequest>
  void RotateEncryptionKeyAsync(const RotateEncryptionKeyRequestT& request, const RotateEncryptionKeyResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdatePartnerStatus that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdatePartnerStatus that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdatePartnerStatusRequestT = Model::UpdatePartnerStatusRequest>
  void UpdatePartnerStatusAsync(const UpdatePartnerStatusRequestT& request, const UpdatePartnerStatusResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&RedshiftClient::UpdatePartnerStatus, request, handler, context);
  }

  virtual void OverrideEndpoint(const Aws::String& endpoint);
  virtual std::shared_ptr<RedshiftEndpointProviderBase>& accessEndpointProvider();
