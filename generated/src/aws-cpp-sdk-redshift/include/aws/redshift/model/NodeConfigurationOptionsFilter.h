...
class NodeConfigurationOptionsFilter {
 public:
  ...
  inline void SetName(NodeConfigurationOptionsFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline NodeConfigurationOptionsFilter& WithName(NodeConfigurationOptionsFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline NodeConfigurationOptionsFilter& WithOperator(OperatorType value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  NodeConfigurationOptionsFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  NodeConfigurationOptionsFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
