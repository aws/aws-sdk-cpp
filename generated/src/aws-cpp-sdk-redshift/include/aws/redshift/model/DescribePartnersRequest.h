...
namespace Model
{
  ...
  /**
   */
  class DescribePartnersRequest : public RedshiftRequest
  {
  public:
  ...
  public:
    ...
    template<typename AccountIdT = Aws::String>
    DescribePartnersRequest& WithAccountId(AccountIdT&& value) { SetAccountId(std::forward<AccountIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterIdentifierT = Aws::String>
    DescribePartnersRequest& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename DatabaseNameT = Aws::String>
    DescribePartnersRequest& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnerNameT = Aws::String>
    DescribePartnersRequest& WithPartnerName(PartnerNameT&& value) { SetPartnerName(std::forward<PartnerNameT>(value)); return *this;}
    ///@}
  private:
