...
class CreateSnapshotCopyGrantResult {
 public:
  ...
  void SetSnapshotCopyGrant(SnapshotCopyGrantT&& value) {
    m_snapshotCopyGrantHasBeenSet = true;
    m_snapshotCopyGrant = std::forward<SnapshotCopyGrantT>(value);
  }
  template <typename SnapshotCopyGrantT = SnapshotCopyGrant>
  CreateSnapshotCopyGrantResult& WithSnapshotCopyGrant(SnapshotCopyGrantT&& value) {
    SetSnapshotCopyGrant(std::forward<SnapshotCopyGrantT>(value));
    return *this;
  }
  ///@}
