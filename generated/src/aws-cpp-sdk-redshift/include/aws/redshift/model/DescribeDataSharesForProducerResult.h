...
class DescribeDataSharesForProducerResult {
 public:
  ...
  void SetDataShares(DataSharesT&& value) {
    m_dataSharesHasBeenSet = true;
    m_dataShares = std::forward<DataSharesT>(value);
  }
  template <typename DataSharesT = Aws::Vector<DataShare>>
  DescribeDataSharesForProducerResult& WithDataShares(DataSharesT&& value) {
    SetDataShares(std::forward<DataSharesT>(value));
    return *this;
  }
  template <typename DataSharesT = DataShare>
  DescribeDataSharesForProducerResult& AddDataShares(DataSharesT&& value) {
    m_dataSharesHasBeenSet = true;
    m_dataShares.emplace_back(std::forward<DataSharesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataSharesForProducerResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDataSharesForProducerResult& WithResponseMetadata(ResponseMetadataT&& value) {
