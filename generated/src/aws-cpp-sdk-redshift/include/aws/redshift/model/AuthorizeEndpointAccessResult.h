...
class AuthorizeEndpointAccessResult {
 public:
  ...
  inline AuthorizeEndpointAccessResult& WithStatus(AuthorizationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AuthorizeEndpointAccessResult& WithAllowedAllVPCs(bool value) {
  ...
  inline AuthorizeEndpointAccessResult& WithEndpointCount(int value) {
