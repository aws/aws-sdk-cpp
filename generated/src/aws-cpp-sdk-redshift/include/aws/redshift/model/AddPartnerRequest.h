...
class AddPartnerRequest : public RedshiftRequest {
 public:
  AWS_REDSHIFT_API AddPartnerRequest() = default;
 ...
 public:
  ...
  template <typename AccountIdT = Aws::String>
  AddPartnerRequest& WithAccountId(AccountIdT&& value) {
  ...
  template <typename ClusterIdentifierT = Aws::String>
  AddPartnerRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename DatabaseNameT = Aws::String>
  AddPartnerRequest& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename PartnerNameT = Aws::String>
  AddPartnerRequest& WithPartnerName(PartnerNameT&& value) {
