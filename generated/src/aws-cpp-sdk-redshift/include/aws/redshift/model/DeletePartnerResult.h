...
class DeletePartnerResult {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  DeletePartnerResult& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename PartnerNameT = Aws::String>
  DeletePartnerResult& WithPartnerName(PartnerNameT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeletePartnerResult& WithResponseMetadata(ResponseMetadataT&& value) {
