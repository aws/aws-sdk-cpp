...
class ReservedNode {
 public:
  ...
  void SetReservedNodeOfferingId(ReservedNodeOfferingIdT&& value) {
    ...
    m_reservedNodeOfferingId = std::forward<ReservedNodeOfferingIdT>(value);
  }
  template <typename ReservedNodeOfferingIdT = Aws::String>
  ReservedNode& WithReservedNodeOfferingId(ReservedNodeOfferingIdT&& value) {
    SetReservedNodeOfferingId(std::forward<ReservedNodeOfferingIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReservedNode& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNode& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNode& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNode& WithNodeCount(int value) {
    SetNodeCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReservedNodeOfferingType(ReservedNodeOfferingType value) {
    m_reservedNodeOfferingTypeHasBeenSet = true;
    m_reservedNodeOfferingType = value;
  }
  inline ReservedNode& WithReservedNodeOfferingType(ReservedNodeOfferingType value) {
    SetReservedNodeOfferingType(value);
    return *this;
  }
  ///@}
 private:
