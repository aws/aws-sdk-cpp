...
class DescribeIntegrationsFilter {
 public:
  ...
  inline void SetName(DescribeIntegrationsFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline DescribeIntegrationsFilter& WithName(DescribeIntegrationsFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  DescribeIntegrationsFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  DescribeIntegrationsFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
