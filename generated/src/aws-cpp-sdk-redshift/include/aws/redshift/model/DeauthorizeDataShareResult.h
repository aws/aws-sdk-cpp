...
class DeauthorizeDataShareResult {
 public:
  ...
  inline DeauthorizeDataShareResult& WithAllowPubliclyAccessibleConsumers(bool value) {
  ...
  inline DeauthorizeDataShareResult& WithDataShareType(DataShareType value) {
