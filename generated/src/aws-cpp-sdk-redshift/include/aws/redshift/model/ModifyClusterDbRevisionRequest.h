...
class ModifyClusterDbRevisionRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ModifyClusterDbRevisionRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  void SetRevisionTarget(RevisionTargetT&& value) {
    m_revisionTargetHasBeenSet = true;
    m_revisionTarget = std::forward<RevisionTargetT>(value);
  }
  template <typename RevisionTargetT = Aws::String>
  ModifyClusterDbRevisionRequest& WithRevisionTarget(RevisionTargetT&& value) {
    SetRevisionTarget(std::forward<RevisionTargetT>(value));
    return *this;
  }
  ///@}
 private:
