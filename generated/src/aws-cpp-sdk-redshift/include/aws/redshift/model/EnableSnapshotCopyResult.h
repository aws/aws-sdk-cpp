...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API EnableSnapshotCopyResult() = default;
    ...
    template<typename ClusterT = Cluster>
    EnableSnapshotCopyResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EnableSnapshotCopyResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
