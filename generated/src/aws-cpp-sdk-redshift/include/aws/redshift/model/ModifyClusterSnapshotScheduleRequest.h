...
class ModifyClusterSnapshotScheduleRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline void SetDisassociateSchedule(bool value) {
    m_disassociateScheduleHasBeenSet = true;
    m_disassociateSchedule = value;
  }
  inline ModifyClusterSnapshotScheduleRequest& WithDisassociateSchedule(bool value) {
    SetDisassociateSchedule(value);
    return *this;
  }
  ///@}
 private:
