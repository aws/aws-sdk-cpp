...
class PurchaseReservedNodeOfferingResult {
 public:
  ...
  template <typename ReservedNodeT = ReservedNode>
  PurchaseReservedNodeOfferingResult& WithReservedNode(ReservedNodeT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  PurchaseReservedNodeOfferingResult& WithResponseMetadata(ResponseMetadataT&& value) {
