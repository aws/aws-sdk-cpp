...
class DescribeDataSharesForProducerRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ProducerArnT = Aws::String>
  DescribeDataSharesForProducerRequest& WithProducerArn(ProducerArnT&& value) {
  ...
  inline void SetStatus(DataShareStatusForProducer value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeDataSharesForProducerRequest& WithStatus(DataShareStatusForProducer value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDataSharesForProducerRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataSharesForProducerRequest& WithMarker(MarkerT&& value) {
