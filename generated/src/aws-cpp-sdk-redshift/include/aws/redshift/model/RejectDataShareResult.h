...
class RejectDataShareResult {
 public:
  ...
  template <typename DataShareArnT = Aws::String>
  RejectDataShareResult& WithDataShareArn(DataShareArnT&& value) {
  ...
  template <typename ProducerArnT = Aws::String>
  RejectDataShareResult& WithProducerArn(ProducerArnT&& value) {
  ...
  inline RejectDataShareResult& WithAllowPubliclyAccessibleConsumers(bool value) {
  ...
  template <typename DataShareAssociationsT = Aws::Vector<DataShareAssociation>>
  RejectDataShareResult& WithDataShareAssociations(DataShareAssociationsT&& value) {
  ...
  RejectDataShareResult& AddDataShareAssociations(DataShareAssociationsT&& value) {
    m_dataShareAssociationsHasBeenSet = true;
  ...
  template <typename ManagedByT = Aws::String>
  RejectDataShareResult& WithManagedBy(ManagedByT&& value) {
  ...
  inline RejectDataShareResult& WithDataShareType(DataShareType value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RejectDataShareResult& WithResponseMetadata(ResponseMetadataT&& value) {
