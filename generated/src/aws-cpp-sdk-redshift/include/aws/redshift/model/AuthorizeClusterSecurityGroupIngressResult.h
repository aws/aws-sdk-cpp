...
class AuthorizeClusterSecurityGroupIngressResult {
 public:
  ...
  AWS_REDSHIFT_API AuthorizeClusterSecurityGroupIngressResult& operator=(
  ...
  template <typename ClusterSecurityGroupT = ClusterSecurityGroup>
  AuthorizeClusterSecurityGroupIngressResult& WithClusterSecurityGroup(ClusterSecurityGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AuthorizeClusterSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadataT&& value) {
