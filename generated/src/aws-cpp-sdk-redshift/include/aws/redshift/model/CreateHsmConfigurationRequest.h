...
class CreateHsmConfigurationRequest : public RedshiftRequest {
 ...
 public:
  ...
  void SetHsmIpAddress(HsmIpAddressT&& value) {
    ...
    m_hsmIpAddress = std::forward<HsmIpAddressT>(value);
  }
  template <typename HsmIpAddressT = Aws::String>
  CreateHsmConfigurationRequest& WithHsmIpAddress(HsmIpAddressT&& value) {
    SetHsmIpAddress(std::forward<HsmIpAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHsmPartitionName(HsmPartitionNameT&& value) {
    ...
    m_hsmPartitionName = std::forward<HsmPartitionNameT>(value);
  }
  template <typename HsmPartitionNameT = Aws::String>
  CreateHsmConfigurationRequest& WithHsmPartitionName(HsmPartitionNameT&& value) {
    SetHsmPartitionName(std::forward<HsmPartitionNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHsmPartitionPassword(HsmPartitionPasswordT&& value) {
    m_hsmPartitionPasswordHasBeenSet = true;
    m_hsmPartitionPassword = std::forward<HsmPartitionPasswordT>(value);
  }
  template <typename HsmPartitionPasswordT = Aws::String>
  CreateHsmConfigurationRequest& WithHsmPartitionPassword(HsmPartitionPasswordT&& value) {
    SetHsmPartitionPassword(std::forward<HsmPartitionPasswordT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHsmServerPublicCertificate(HsmServerPublicCertificateT&& value) {
    m_hsmServerPublicCertificateHasBeenSet = true;
    m_hsmServerPublicCertificate = std::forward<HsmServerPublicCertificateT>(value);
  }
  template <typename HsmServerPublicCertificateT = Aws::String>
  CreateHsmConfigurationRequest& WithHsmServerPublicCertificate(HsmServerPublicCertificateT&& value) {
    SetHsmServerPublicCertificate(std::forward<HsmServerPublicCertificateT>(value));
    return *this;
  }
  ///@}
