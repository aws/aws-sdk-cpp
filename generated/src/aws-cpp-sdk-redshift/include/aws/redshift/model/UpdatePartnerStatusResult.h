...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API UpdatePartnerStatusResult() = default;
    ...
    template<typename DatabaseNameT = Aws::String>
    UpdatePartnerStatusResult& WithDatabaseName(DatabaseNameT&& value) { SetDatabaseName(std::forward<DatabaseNameT>(value)); return *this;}
    ///@}
    ...
    template<typename PartnerNameT = Aws::String>
    UpdatePartnerStatusResult& WithPartnerName(PartnerNameT&& value) { SetPartnerName(std::forward<PartnerNameT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    UpdatePartnerStatusResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
