...
class DisableLoggingResult {
 public:
  ...
  inline DisableLoggingResult& WithLoggingEnabled(bool value) {
  ...
  template <typename BucketNameT = Aws::String>
  DisableLoggingResult& WithBucketName(BucketNameT&& value) {
  ...
  template <typename S3KeyPrefixT = Aws::String>
  DisableLoggingResult& WithS3KeyPrefix(S3KeyPrefixT&& value) {
  ...
  template <typename LastSuccessfulDeliveryTimeT = Aws::Utils::DateTime>
  DisableLoggingResult& WithLastSuccessfulDeliveryTime(LastSuccessfulDeliveryTimeT&& value) {
  ...
  template <typename LastFailureTimeT = Aws::Utils::DateTime>
  DisableLoggingResult& WithLastFailureTime(LastFailureTimeT&& value) {
  ...
  template <typename LastFailureMessageT = Aws::String>
  DisableLoggingResult& WithLastFailureMessage(LastFailureMessageT&& value) {
  ...
  inline DisableLoggingResult& WithLogDestinationType(LogDestinationType value) {
  ...
  template <typename LogExportsT = Aws::Vector<Aws::String>>
  DisableLoggingResult& WithLogExports(LogExportsT&& value) {
    SetLogExports(std::forward<LogExportsT>(value));
    return *this;
  }
  template <typename LogExportsT = Aws::String>
  DisableLoggingResult& AddLogExports(LogExportsT&& value) {
    m_logExportsHasBeenSet = true;
  ...
  template <typename S3TablesT = S3TablePublishStatus>
  DisableLoggingResult& WithS3Tables(S3TablesT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableLoggingResult& WithResponseMetadata(ResponseMetadataT&& value) {
