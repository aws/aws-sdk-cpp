...
class DescribeClusterParametersResult {
 public:
  AWS_REDSHIFT_API DescribeClusterParametersResult() = default;
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  DescribeClusterParametersResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  DescribeClusterParametersResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeClusterParametersResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClusterParametersResult& WithResponseMetadata(ResponseMetadataT&& value) {
