...
class DescribeClusterTracksResult {
 public:
  ...
  void SetMaintenanceTracks(MaintenanceTracksT&& value) {
    m_maintenanceTracksHasBeenSet = true;
    m_maintenanceTracks = std::forward<MaintenanceTracksT>(value);
  }
  template <typename MaintenanceTracksT = Aws::Vector<MaintenanceTrack>>
  DescribeClusterTracksResult& WithMaintenanceTracks(MaintenanceTracksT&& value) {
    SetMaintenanceTracks(std::forward<MaintenanceTracksT>(value));
    return *this;
  }
  template <typename MaintenanceTracksT = MaintenanceTrack>
  DescribeClusterTracksResult& AddMaintenanceTracks(MaintenanceTracksT&& value) {
    m_maintenanceTracksHasBeenSet = true;
    m_maintenanceTracks.emplace_back(std::forward<MaintenanceTracksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeClusterTracksResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClusterTracksResult& WithResponseMetadata(ResponseMetadataT&& value) {
