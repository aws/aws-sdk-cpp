...
class DescribeReservedNodesResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedNodesResult& WithMarker(MarkerT&& value) {
  ...
  void SetReservedNodes(ReservedNodesT&& value) {
    m_reservedNodesHasBeenSet = true;
    m_reservedNodes = std::forward<ReservedNodesT>(value);
  }
  template <typename ReservedNodesT = Aws::Vector<ReservedNode>>
  DescribeReservedNodesResult& WithReservedNodes(ReservedNodesT&& value) {
    SetReservedNodes(std::forward<ReservedNodesT>(value));
    return *this;
  }
  template <typename ReservedNodesT = ReservedNode>
  DescribeReservedNodesResult& AddReservedNodes(ReservedNodesT&& value) {
    m_reservedNodesHasBeenSet = true;
    m_reservedNodes.emplace_back(std::forward<ReservedNodesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedNodesResult& WithResponseMetadata(ResponseMetadataT&& value) {
