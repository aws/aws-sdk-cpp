...
class Snapshot {
 public:
  ...
  void SetEngineFullVersion(EngineFullVersionT&& value) {
    ...
    m_engineFullVersion = std::forward<EngineFullVersionT>(value);
  }
  template <typename EngineFullVersionT = Aws::String>
  Snapshot& WithEngineFullVersion(EngineFullVersionT&& value) {
    SetEngineFullVersion(std::forward<EngineFullVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline Snapshot& WithNumberOfNodes(int value) {
  ...
  inline Snapshot& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEncryptedWithHSM(bool value) {
    m_encryptedWithHSMHasBeenSet = true;
    m_encryptedWithHSM = value;
  }
  inline Snapshot& WithEncryptedWithHSM(bool value) {
    SetEncryptedWithHSM(value);
    return *this;
  }
  ///@}
  ...
  void SetAccountsWithRestoreAccess(AccountsWithRestoreAccessT&& value) {
    ...
    m_accountsWithRestoreAccess = std::forward<AccountsWithRestoreAccessT>(value);
  }
  template <typename AccountsWithRestoreAccessT = Aws::Vector<AccountWithRestoreAccess>>
  Snapshot& WithAccountsWithRestoreAccess(AccountsWithRestoreAccessT&& value) {
    SetAccountsWithRestoreAccess(std::forward<AccountsWithRestoreAccessT>(value));
    return *this;
  }
  ...
  Snapshot& AddAccountsWithRestoreAccess(AccountsWithRestoreAccessT&& value) {
    m_accountsWithRestoreAccessHasBeenSet = true;
    m_accountsWithRestoreAccess.emplace_back(std::forward<AccountsWithRestoreAccessT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalBackupSizeInMegaBytes(double value) {
    m_totalBackupSizeInMegaBytesHasBeenSet = true;
    m_totalBackupSizeInMegaBytes = value;
  }
  inline Snapshot& WithTotalBackupSizeInMegaBytes(double value) {
    SetTotalBackupSizeInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActualIncrementalBackupSizeInMegaBytes(double value) {
    m_actualIncrementalBackupSizeInMegaBytesHasBeenSet = true;
    m_actualIncrementalBackupSizeInMegaBytes = value;
  }
  inline Snapshot& WithActualIncrementalBackupSizeInMegaBytes(double value) {
    SetActualIncrementalBackupSizeInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBackupProgressInMegaBytes(double value) {
    m_backupProgressInMegaBytesHasBeenSet = true;
    m_backupProgressInMegaBytes = value;
  }
  inline Snapshot& WithBackupProgressInMegaBytes(double value) {
    SetBackupProgressInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetCurrentBackupRateInMegaBytesPerSecond(double value) {
    m_currentBackupRateInMegaBytesPerSecondHasBeenSet = true;
    m_currentBackupRateInMegaBytesPerSecond = value;
  }
  inline Snapshot& WithCurrentBackupRateInMegaBytesPerSecond(double value) {
    SetCurrentBackupRateInMegaBytesPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEstimatedSecondsToCompletion(long long value) {
    m_estimatedSecondsToCompletionHasBeenSet = true;
    m_estimatedSecondsToCompletion = value;
  }
  inline Snapshot& WithEstimatedSecondsToCompletion(long long value) {
    SetEstimatedSecondsToCompletion(value);
    return *this;
  }
  ///@}
  ...
  inline void SetElapsedTimeInSeconds(long long value) {
    m_elapsedTimeInSecondsHasBeenSet = true;
    m_elapsedTimeInSeconds = value;
  }
  inline Snapshot& WithElapsedTimeInSeconds(long long value) {
  ...
  void SetRestorableNodeTypes(RestorableNodeTypesT&& value) {
    ...
    m_restorableNodeTypes = std::forward<RestorableNodeTypesT>(value);
  }
  template <typename RestorableNodeTypesT = Aws::Vector<Aws::String>>
  Snapshot& WithRestorableNodeTypes(RestorableNodeTypesT&& value) {
    SetRestorableNodeTypes(std::forward<RestorableNodeTypesT>(value));
    return *this;
  }
  template <typename RestorableNodeTypesT = Aws::String>
  Snapshot& AddRestorableNodeTypes(RestorableNodeTypesT&& value) {
    m_restorableNodeTypesHasBeenSet = true;
    m_restorableNodeTypes.emplace_back(std::forward<RestorableNodeTypesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Snapshot& WithEnhancedVpcRouting(bool value) {
  ...
  inline Snapshot& WithManualSnapshotRetentionPeriod(int value) {
  ...
  inline void SetManualSnapshotRemainingDays(int value) {
    m_manualSnapshotRemainingDaysHasBeenSet = true;
    m_manualSnapshotRemainingDays = value;
  }
  inline Snapshot& WithManualSnapshotRemainingDays(int value) {
    SetManualSnapshotRemainingDays(value);
    return *this;
  }
  ///@}
  ...
  void SetSnapshotRetentionStartTime(SnapshotRetentionStartTimeT&& value) {
    ...
    m_snapshotRetentionStartTime = std::forward<SnapshotRetentionStartTimeT>(value);
  }
  template <typename SnapshotRetentionStartTimeT = Aws::Utils::DateTime>
  Snapshot& WithSnapshotRetentionStartTime(SnapshotRetentionStartTimeT&& value) {
    SetSnapshotRetentionStartTime(std::forward<SnapshotRetentionStartTimeT>(value));
    return *this;
  }
  ///@}
