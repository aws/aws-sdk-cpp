...
class DescribeNodeConfigurationOptionsRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline DescribeNodeConfigurationOptionsRequest& WithActionType(ActionType value) {
    SetActionType(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<NodeConfigurationOptionsFilter>>
  ...
  template <typename FiltersT = NodeConfigurationOptionsFilter>
  ...
  inline DescribeNodeConfigurationOptionsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
