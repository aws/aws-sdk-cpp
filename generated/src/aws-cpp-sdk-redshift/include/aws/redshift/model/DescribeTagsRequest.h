...
class DescribeTagsRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ResourceNameT = Aws::String>
  DescribeTagsRequest& WithResourceName(ResourceNameT&& value) {
  ...
  template <typename ResourceTypeT = Aws::String>
  DescribeTagsRequest& WithResourceType(ResourceTypeT&& value) {
  ...
  inline DescribeTagsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeTagsRequest& WithMarker(MarkerT&& value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  DescribeTagsRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  DescribeTagsRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
  ...
  template <typename TagValuesT = Aws::Vector<Aws::String>>
  DescribeTagsRequest& WithTagValues(TagValuesT&& value) {
    SetTagValues(std::forward<TagValuesT>(value));
    return *this;
  }
  template <typename TagValuesT = Aws::String>
  DescribeTagsRequest& AddTagValues(TagValuesT&& value) {
    m_tagValuesHasBeenSet = true;
