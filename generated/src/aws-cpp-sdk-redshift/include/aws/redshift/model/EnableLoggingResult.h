...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API EnableLoggingResult() = default;
    ...
    template<typename BucketNameT = Aws::String>
    EnableLoggingResult& WithBucketName(BucketNameT&& value) { SetBucketName(std::forward<BucketNameT>(value)); return *this;}
    ///@}
    ...
    template<typename S3KeyPrefixT = Aws::String>
    EnableLoggingResult& WithS3KeyPrefix(S3KeyPrefixT&& value) { SetS3KeyPrefix(std::forward<S3KeyPrefixT>(value)); return *this;}
    ///@}
    ...
    template<typename LastSuccessfulDeliveryTimeT = Aws::Utils::DateTime>
    EnableLoggingResult& WithLastSuccessfulDeliveryTime(LastSuccessfulDeliveryTimeT&& value) { SetLastSuccessfulDeliveryTime(std::forward<LastSuccessfulDeliveryTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastFailureTimeT = Aws::Utils::DateTime>
    EnableLoggingResult& WithLastFailureTime(LastFailureTimeT&& value) { SetLastFailureTime(std::forward<LastFailureTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename LastFailureMessageT = Aws::String>
    EnableLoggingResult& WithLastFailureMessage(LastFailureMessageT&& value) { SetLastFailureMessage(std::forward<LastFailureMessageT>(value)); return *this;}
    ///@}
    ...
    inline EnableLoggingResult& WithLogDestinationType(LogDestinationType value) { SetLogDestinationType(value); return *this;}
    ///@}
    ...
    template<typename LogExportsT = Aws::Vector<Aws::String>>
    EnableLoggingResult& WithLogExports(LogExportsT&& value) { SetLogExports(std::forward<LogExportsT>(value)); return *this;}
    template<typename LogExportsT = Aws::String>
    EnableLoggingResult& AddLogExports(LogExportsT&& value) { m_logExportsHasBeenSet = true; m_logExports.emplace_back(std::forward<LogExportsT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EnableLoggingResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
