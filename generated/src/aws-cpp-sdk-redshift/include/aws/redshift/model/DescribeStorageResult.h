...
class DescribeStorageResult {
 public:
  ...
  inline DescribeStorageResult& WithTotalBackupSizeInMegaBytes(double value) {
  ...
  inline void SetTotalProvisionedStorageInMegaBytes(double value) {
    m_totalProvisionedStorageInMegaBytesHasBeenSet = true;
    m_totalProvisionedStorageInMegaBytes = value;
  }
  inline DescribeStorageResult& WithTotalProvisionedStorageInMegaBytes(double value) {
    SetTotalProvisionedStorageInMegaBytes(value);
    return *this;
  }
  ///@}
