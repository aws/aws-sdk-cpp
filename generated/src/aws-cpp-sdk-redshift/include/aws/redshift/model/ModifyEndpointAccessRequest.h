...
class ModifyEndpointAccessRequest : public RedshiftRequest {
 public:
  AWS_REDSHIFT_API ModifyEndpointAccessRequest() = default;
 ...
 public:
  ...
  template <typename EndpointNameT = Aws::String>
  ModifyEndpointAccessRequest& WithEndpointName(EndpointNameT&& value) {
  ...
  template <typename VpcSecurityGroupIdsT = Aws::Vector<Aws::String>>
  ModifyEndpointAccessRequest& WithVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    SetVpcSecurityGroupIds(std::forward<VpcSecurityGroupIdsT>(value));
    return *this;
  }
  template <typename VpcSecurityGroupIdsT = Aws::String>
  ModifyEndpointAccessRequest& AddVpcSecurityGroupIds(VpcSecurityGroupIdsT&& value) {
    m_vpcSecurityGroupIdsHasBeenSet = true;
