...
class DescribeDataSharesForConsumerRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ConsumerArnT = Aws::String>
  DescribeDataSharesForConsumerRequest& WithConsumerArn(ConsumerArnT&& value) {
  ...
  inline void SetStatus(DataShareStatusForConsumer value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DescribeDataSharesForConsumerRequest& WithStatus(DataShareStatusForConsumer value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDataSharesForConsumerRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataSharesForConsumerRequest& WithMarker(MarkerT&& value) {
