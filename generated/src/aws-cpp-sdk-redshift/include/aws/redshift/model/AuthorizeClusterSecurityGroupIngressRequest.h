...
class AuthorizeClusterSecurityGroupIngressRequest : public RedshiftRequest {
 ...
 public:
  ...
  void SetClusterSecurityGroupName(ClusterSecurityGroupNameT&& value) {
    ...
    m_clusterSecurityGroupName = std::forward<ClusterSecurityGroupNameT>(value);
  }
  template <typename ClusterSecurityGroupNameT = Aws::String>
  AuthorizeClusterSecurityGroupIngressRequest& WithClusterSecurityGroupName(ClusterSecurityGroupNameT&& value) {
    SetClusterSecurityGroupName(std::forward<ClusterSecurityGroupNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CIDRIPT = Aws::String>
  AuthorizeClusterSecurityGroupIngressRequest& WithCIDRIP(CIDRIPT&& value) {
  ...
  template <typename EC2SecurityGroupNameT = Aws::String>
  AuthorizeClusterSecurityGroupIngressRequest& WithEC2SecurityGroupName(EC2SecurityGroupNameT&& value) {
  ...
  template <typename EC2SecurityGroupOwnerIdT = Aws::String>
  AuthorizeClusterSecurityGroupIngressRequest& WithEC2SecurityGroupOwnerId(EC2SecurityGroupOwnerIdT&& value) {
