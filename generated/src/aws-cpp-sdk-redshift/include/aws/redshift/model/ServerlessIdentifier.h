...
class ServerlessIdentifier {
 public:
  ...
  template <typename NamespaceIdentifierT = Aws::String>
  ServerlessIdentifier& WithNamespaceIdentifier(NamespaceIdentifierT&& value) {
  ...
  void SetWorkgroupIdentifier(WorkgroupIdentifierT&& value) {
    m_workgroupIdentifierHasBeenSet = true;
    m_workgroupIdentifier = std::forward<WorkgroupIdentifierT>(value);
  }
  template <typename WorkgroupIdentifierT = Aws::String>
  ServerlessIdentifier& WithWorkgroupIdentifier(WorkgroupIdentifierT&& value) {
    SetWorkgroupIdentifier(std::forward<WorkgroupIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
