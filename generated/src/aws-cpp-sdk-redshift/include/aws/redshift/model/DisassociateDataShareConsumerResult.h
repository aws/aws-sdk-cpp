...
class DisassociateDataShareConsumerResult {
 public:
  ...
  template <typename DataShareArnT = Aws::String>
  DisassociateDataShareConsumerResult& WithDataShareArn(DataShareArnT&& value) {
  ...
  void SetProducerArn(ProducerArnT&& value) {
    ...
    m_producerArn = std::forward<ProducerArnT>(value);
  }
  template <typename ProducerArnT = Aws::String>
  DisassociateDataShareConsumerResult& WithProducerArn(ProducerArnT&& value) {
    SetProducerArn(std::forward<ProducerArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAllowPubliclyAccessibleConsumers(bool value) {
    m_allowPubliclyAccessibleConsumersHasBeenSet = true;
    m_allowPubliclyAccessibleConsumers = value;
  }
  inline DisassociateDataShareConsumerResult& WithAllowPubliclyAccessibleConsumers(bool value) {
    SetAllowPubliclyAccessibleConsumers(value);
    return *this;
  }
  ///@}
  ...
  void SetDataShareAssociations(DataShareAssociationsT&& value) {
    ...
    m_dataShareAssociations = std::forward<DataShareAssociationsT>(value);
  }
  template <typename DataShareAssociationsT = Aws::Vector<DataShareAssociation>>
  DisassociateDataShareConsumerResult& WithDataShareAssociations(DataShareAssociationsT&& value) {
    SetDataShareAssociations(std::forward<DataShareAssociationsT>(value));
    return *this;
  }
  template <typename DataShareAssociationsT = DataShareAssociation>
  DisassociateDataShareConsumerResult& AddDataShareAssociations(DataShareAssociationsT&& value) {
    m_dataShareAssociationsHasBeenSet = true;
    m_dataShareAssociations.emplace_back(std::forward<DataShareAssociationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ManagedByT = Aws::String>
  DisassociateDataShareConsumerResult& WithManagedBy(ManagedByT&& value) {
  ...
  inline void SetDataShareType(DataShareType value) {
    m_dataShareTypeHasBeenSet = true;
    m_dataShareType = value;
  }
  inline DisassociateDataShareConsumerResult& WithDataShareType(DataShareType value) {
    SetDataShareType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateDataShareConsumerResult& WithResponseMetadata(ResponseMetadataT&& value) {
