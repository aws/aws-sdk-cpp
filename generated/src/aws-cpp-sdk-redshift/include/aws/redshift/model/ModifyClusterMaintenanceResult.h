...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API ModifyClusterMaintenanceResult() = default;
    ...
    template<typename ClusterT = Cluster>
    ModifyClusterMaintenanceResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyClusterMaintenanceResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
