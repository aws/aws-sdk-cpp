...
class ClusterDbRevision {
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ClusterDbRevision& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  void SetCurrentDatabaseRevision(CurrentDatabaseRevisionT&& value) {
    m_currentDatabaseRevisionHasBeenSet = true;
    m_currentDatabaseRevision = std::forward<CurrentDatabaseRevisionT>(value);
  }
  template <typename CurrentDatabaseRevisionT = Aws::String>
  ClusterDbRevision& WithCurrentDatabaseRevision(CurrentDatabaseRevisionT&& value) {
    SetCurrentDatabaseRevision(std::forward<CurrentDatabaseRevisionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DatabaseRevisionReleaseDateT = Aws::Utils::DateTime>
  ClusterDbRevision& WithDatabaseRevisionReleaseDate(DatabaseRevisionReleaseDateT&& value) {
  ...
  void SetRevisionTargets(RevisionTargetsT&& value) {
    m_revisionTargetsHasBeenSet = true;
    m_revisionTargets = std::forward<RevisionTargetsT>(value);
  }
  template <typename RevisionTargetsT = Aws::Vector<RevisionTarget>>
  ClusterDbRevision& WithRevisionTargets(RevisionTargetsT&& value) {
    SetRevisionTargets(std::forward<RevisionTargetsT>(value));
    return *this;
  }
  template <typename RevisionTargetsT = RevisionTarget>
  ClusterDbRevision& AddRevisionTargets(RevisionTargetsT&& value) {
    m_revisionTargetsHasBeenSet = true;
    m_revisionTargets.emplace_back(std::forward<RevisionTargetsT>(value));
    return *this;
  }
  ///@}
 private:
