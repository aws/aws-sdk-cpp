...
class DescribeReservedNodeExchangeStatusRequest : public RedshiftRequest {
 ...
 public:
  ...
  void SetReservedNodeExchangeRequestId(ReservedNodeExchangeRequestIdT&& value) {
    ...
    m_reservedNodeExchangeRequestId = std::forward<ReservedNodeExchangeRequestIdT>(value);
  }
  template <typename ReservedNodeExchangeRequestIdT = Aws::String>
  DescribeReservedNodeExchangeStatusRequest& WithReservedNodeExchangeRequestId(ReservedNodeExchangeRequestIdT&& value) {
    SetReservedNodeExchangeRequestId(std::forward<ReservedNodeExchangeRequestIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeReservedNodeExchangeStatusRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
