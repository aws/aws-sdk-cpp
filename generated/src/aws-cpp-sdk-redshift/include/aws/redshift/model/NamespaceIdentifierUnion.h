...
class NamespaceIdentifierUnion {
 public:
  ...
  void SetServerlessIdentifier(ServerlessIdentifierT&& value) {
    ...
    m_serverlessIdentifier = std::forward<ServerlessIdentifierT>(value);
  }
  template <typename ServerlessIdentifierT = ServerlessIdentifier>
  NamespaceIdentifierUnion& WithServerlessIdentifier(ServerlessIdentifierT&& value) {
    SetServerlessIdentifier(std::forward<ServerlessIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProvisionedIdentifier(ProvisionedIdentifierT&& value) {
    ...
    m_provisionedIdentifier = std::forward<ProvisionedIdentifierT>(value);
  }
  template <typename ProvisionedIdentifierT = ProvisionedIdentifier>
  NamespaceIdentifierUnion& WithProvisionedIdentifier(ProvisionedIdentifierT&& value) {
    SetProvisionedIdentifier(std::forward<ProvisionedIdentifierT>(value));
    return *this;
  }
  ///@}
 private:
