...
class DescribeClusterSecurityGroupsResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeClusterSecurityGroupsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ClusterSecurityGroupsT = Aws::Vector<ClusterSecurityGroup>>
  DescribeClusterSecurityGroupsResult& WithClusterSecurityGroups(ClusterSecurityGroupsT&& value) {
  ...
  DescribeClusterSecurityGroupsResult& AddClusterSecurityGroups(ClusterSecurityGroupsT&& value) {
    m_clusterSecurityGroupsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClusterSecurityGroupsResult& WithResponseMetadata(ResponseMetadataT&& value) {
