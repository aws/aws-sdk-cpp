...
class SnapshotSortingEntity {
 public:
  ...
  inline void SetAttribute(SnapshotAttributeToSortBy value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline SnapshotSortingEntity& WithAttribute(SnapshotAttributeToSortBy value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSortOrder(SortByOrder value) {
    m_sortOrderHasBeenSet = true;
    m_sortOrder = value;
  }
  inline SnapshotSortingEntity& WithSortOrder(SortByOrder value) {
    SetSortOrder(value);
    return *this;
  }
  ///@}
