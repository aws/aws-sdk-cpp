...
class ServiceIntegrationsUnion {
 public:
  ...
  void SetS3AccessGrants(S3AccessGrantsT&& value) {
    ...
    m_s3AccessGrants = std::forward<S3AccessGrantsT>(value);
  }
  template <typename S3AccessGrantsT = Aws::Vector<S3AccessGrantsScopeUnion>>
  ServiceIntegrationsUnion& WithS3AccessGrants(S3AccessGrantsT&& value) {
    SetS3AccessGrants(std::forward<S3AccessGrantsT>(value));
    return *this;
  }
  ...
  ServiceIntegrationsUnion& AddS3AccessGrants(S3AccessGrantsT&& value) {
    m_s3AccessGrantsHasBeenSet = true;
    m_s3AccessGrants.emplace_back(std::forward<S3AccessGrantsT>(value));
    return *this;
  }
  ///@}
