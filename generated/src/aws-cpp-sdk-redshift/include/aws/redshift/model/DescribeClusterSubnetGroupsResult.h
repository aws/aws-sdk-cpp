...
class DescribeClusterSubnetGroupsResult {
 public:
  ...
  void SetClusterSubnetGroups(ClusterSubnetGroupsT&& value) {
    m_clusterSubnetGroupsHasBeenSet = true;
    m_clusterSubnetGroups = std::forward<ClusterSubnetGroupsT>(value);
  }
  template <typename ClusterSubnetGroupsT = Aws::Vector<ClusterSubnetGroup>>
  DescribeClusterSubnetGroupsResult& WithClusterSubnetGroups(ClusterSubnetGroupsT&& value) {
    SetClusterSubnetGroups(std::forward<ClusterSubnetGroupsT>(value));
    return *this;
  }
  ...
  DescribeClusterSubnetGroupsResult& AddClusterSubnetGroups(ClusterSubnetGroupsT&& value) {
    m_clusterSubnetGroupsHasBeenSet = true;
    m_clusterSubnetGroups.emplace_back(std::forward<ClusterSubnetGroupsT>(value));
    return *this;
  }
  ///@}
