...
class ReservedNodeConfigurationOption {
 public:
  ...
  void SetSourceReservedNode(SourceReservedNodeT&& value) {
    m_sourceReservedNodeHasBeenSet = true;
    m_sourceReservedNode = std::forward<SourceReservedNodeT>(value);
  }
  template <typename SourceReservedNodeT = ReservedNode>
  ReservedNodeConfigurationOption& WithSourceReservedNode(SourceReservedNodeT&& value) {
    SetSourceReservedNode(std::forward<SourceReservedNodeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReservedNodeConfigurationOption& WithTargetReservedNodeCount(int value) {
  ...
  void SetTargetReservedNodeOffering(TargetReservedNodeOfferingT&& value) {
    ...
    m_targetReservedNodeOffering = std::forward<TargetReservedNodeOfferingT>(value);
  }
  template <typename TargetReservedNodeOfferingT = ReservedNodeOffering>
  ReservedNodeConfigurationOption& WithTargetReservedNodeOffering(TargetReservedNodeOfferingT&& value) {
    SetTargetReservedNodeOffering(std::forward<TargetReservedNodeOfferingT>(value));
    return *this;
  }
  ///@}
 private:
