...
class CreateHsmClientCertificateResult {
 public:
  ...
  void SetHsmClientCertificate(HsmClientCertificateT&& value) {
    m_hsmClientCertificateHasBeenSet = true;
    m_hsmClientCertificate = std::forward<HsmClientCertificateT>(value);
  }
  template <typename HsmClientCertificateT = HsmClientCertificate>
  CreateHsmClientCertificateResult& WithHsmClientCertificate(HsmClientCertificateT&& value) {
    SetHsmClientCertificate(std::forward<HsmClientCertificateT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateHsmClientCertificateResult& WithResponseMetadata(ResponseMetadataT&& value) {
