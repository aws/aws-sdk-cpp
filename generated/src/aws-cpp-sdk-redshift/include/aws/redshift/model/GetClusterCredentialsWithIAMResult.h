...
class GetClusterCredentialsWithIAMResult {
 public:
  ...
  template <typename DbUserT = Aws::String>
  GetClusterCredentialsWithIAMResult& WithDbUser(DbUserT&& value) {
  ...
  template <typename DbPasswordT = Aws::String>
  GetClusterCredentialsWithIAMResult& WithDbPassword(DbPasswordT&& value) {
  ...
  template <typename ExpirationT = Aws::Utils::DateTime>
  GetClusterCredentialsWithIAMResult& WithExpiration(ExpirationT&& value) {
  ...
  template <typename NextRefreshTimeT = Aws::Utils::DateTime>
  GetClusterCredentialsWithIAMResult& WithNextRefreshTime(NextRefreshTimeT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetClusterCredentialsWithIAMResult& WithResponseMetadata(ResponseMetadataT&& value) {
