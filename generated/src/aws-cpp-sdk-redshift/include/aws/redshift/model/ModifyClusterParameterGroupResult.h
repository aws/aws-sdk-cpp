...
class ModifyClusterParameterGroupResult {
 public:
  ...
  template <typename ParameterGroupNameT = Aws::String>
  ModifyClusterParameterGroupResult& WithParameterGroupName(ParameterGroupNameT&& value) {
  ...
  template <typename ParameterGroupStatusT = Aws::String>
  ModifyClusterParameterGroupResult& WithParameterGroupStatus(ParameterGroupStatusT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyClusterParameterGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
