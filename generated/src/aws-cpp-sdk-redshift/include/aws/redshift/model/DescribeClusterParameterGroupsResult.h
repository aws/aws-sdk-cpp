...
class DescribeClusterParameterGroupsResult {
 public:
  ...
  void SetParameterGroups(ParameterGroupsT&& value) {
    ...
    m_parameterGroups = std::forward<ParameterGroupsT>(value);
  }
  template <typename ParameterGroupsT = Aws::Vector<ClusterParameterGroup>>
  DescribeClusterParameterGroupsResult& WithParameterGroups(ParameterGroupsT&& value) {
    SetParameterGroups(std::forward<ParameterGroupsT>(value));
    return *this;
  }
  ...
  DescribeClusterParameterGroupsResult& AddParameterGroups(ParameterGroupsT&& value) {
    m_parameterGroupsHasBeenSet = true;
    m_parameterGroups.emplace_back(std::forward<ParameterGroupsT>(value));
    return *this;
  }
  ///@}
