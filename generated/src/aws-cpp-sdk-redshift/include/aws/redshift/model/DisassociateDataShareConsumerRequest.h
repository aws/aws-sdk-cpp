...
class DisassociateDataShareConsumerRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename DataShareArnT = Aws::String>
  DisassociateDataShareConsumerRequest& WithDataShareArn(DataShareArnT&& value) {
  ...
  inline void SetDisassociateEntireAccount(bool value) {
    m_disassociateEntireAccountHasBeenSet = true;
    m_disassociateEntireAccount = value;
  }
  inline DisassociateDataShareConsumerRequest& WithDisassociateEntireAccount(bool value) {
    SetDisassociateEntireAccount(value);
    return *this;
  }
  ///@}
  ...
  template <typename ConsumerArnT = Aws::String>
  DisassociateDataShareConsumerRequest& WithConsumerArn(ConsumerArnT&& value) {
  ...
  template <typename ConsumerRegionT = Aws::String>
  DisassociateDataShareConsumerRequest& WithConsumerRegion(ConsumerRegionT&& value) {
