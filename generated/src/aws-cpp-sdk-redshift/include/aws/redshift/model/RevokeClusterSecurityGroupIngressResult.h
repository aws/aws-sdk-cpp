...
class RevokeClusterSecurityGroupIngressResult {
 public:
  ...
  AWS_REDSHIFT_API RevokeClusterSecurityGroupIngressResult& operator=(
  ...
  template <typename ClusterSecurityGroupT = ClusterSecurityGroup>
  RevokeClusterSecurityGroupIngressResult& WithClusterSecurityGroup(ClusterSecurityGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RevokeClusterSecurityGroupIngressResult& WithResponseMetadata(ResponseMetadataT&& value) {
