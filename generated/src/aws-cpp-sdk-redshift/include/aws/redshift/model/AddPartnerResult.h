...
class AddPartnerResult {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  AddPartnerResult& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename PartnerNameT = Aws::String>
  AddPartnerResult& WithPartnerName(PartnerNameT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AddPartnerResult& WithResponseMetadata(ResponseMetadataT&& value) {
