...
class ScheduledActionFilter {
 public:
  ...
  inline void SetName(ScheduledActionFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ScheduledActionFilter& WithName(ScheduledActionFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ScheduledActionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ScheduledActionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
