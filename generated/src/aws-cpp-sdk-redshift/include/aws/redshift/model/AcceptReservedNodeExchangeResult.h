...
class AcceptReservedNodeExchangeResult {
 public:
  ...
  void SetExchangedReservedNode(ExchangedReservedNodeT&& value) {
    m_exchangedReservedNodeHasBeenSet = true;
    m_exchangedReservedNode = std::forward<ExchangedReservedNodeT>(value);
  }
  template <typename ExchangedReservedNodeT = ReservedNode>
  AcceptReservedNodeExchangeResult& WithExchangedReservedNode(ExchangedReservedNodeT&& value) {
    SetExchangedReservedNode(std::forward<ExchangedReservedNodeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptReservedNodeExchangeResult& WithResponseMetadata(ResponseMetadataT&& value) {
