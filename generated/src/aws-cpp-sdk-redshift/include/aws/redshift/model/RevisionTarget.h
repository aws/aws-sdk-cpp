...
class RevisionTarget {
 public:
  ...
  void SetDatabaseRevision(DatabaseRevisionT&& value) {
    m_databaseRevisionHasBeenSet = true;
    m_databaseRevision = std::forward<DatabaseRevisionT>(value);
  }
  template <typename DatabaseRevisionT = Aws::String>
  RevisionTarget& WithDatabaseRevision(DatabaseRevisionT&& value) {
    SetDatabaseRevision(std::forward<DatabaseRevisionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  RevisionTarget& WithDescription(DescriptionT&& value) {
  ...
  void SetDatabaseRevisionReleaseDate(DatabaseRevisionReleaseDateT&& value) {
    m_databaseRevisionReleaseDateHasBeenSet = true;
    m_databaseRevisionReleaseDate = std::forward<DatabaseRevisionReleaseDateT>(value);
  }
  template <typename DatabaseRevisionReleaseDateT = Aws::Utils::DateTime>
  RevisionTarget& WithDatabaseRevisionReleaseDate(DatabaseRevisionReleaseDateT&& value) {
    SetDatabaseRevisionReleaseDate(std::forward<DatabaseRevisionReleaseDateT>(value));
    return *this;
  }
  ///@}
 private:
