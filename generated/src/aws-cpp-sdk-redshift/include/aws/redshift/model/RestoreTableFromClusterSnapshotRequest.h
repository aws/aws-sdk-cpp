...
class RestoreTableFromClusterSnapshotRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  template <typename SnapshotIdentifierT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithSnapshotIdentifier(SnapshotIdentifierT&& value) {
  ...
  template <typename SourceDatabaseNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithSourceDatabaseName(SourceDatabaseNameT&& value) {
  ...
  template <typename SourceSchemaNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithSourceSchemaName(SourceSchemaNameT&& value) {
  ...
  template <typename SourceTableNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithSourceTableName(SourceTableNameT&& value) {
  ...
  template <typename TargetDatabaseNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithTargetDatabaseName(TargetDatabaseNameT&& value) {
  ...
  template <typename TargetSchemaNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithTargetSchemaName(TargetSchemaNameT&& value) {
  ...
  template <typename NewTableNameT = Aws::String>
  RestoreTableFromClusterSnapshotRequest& WithNewTableName(NewTableNameT&& value) {
  ...
  inline void SetEnableCaseSensitiveIdentifier(bool value) {
    m_enableCaseSensitiveIdentifierHasBeenSet = true;
    m_enableCaseSensitiveIdentifier = value;
  }
  inline RestoreTableFromClusterSnapshotRequest& WithEnableCaseSensitiveIdentifier(bool value) {
    SetEnableCaseSensitiveIdentifier(value);
    return *this;
  }
  ///@}
 private:
