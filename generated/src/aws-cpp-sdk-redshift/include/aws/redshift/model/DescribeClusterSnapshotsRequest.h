...
class DescribeClusterSnapshotsRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline DescribeClusterSnapshotsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  inline void SetClusterExists(bool value) {
    m_clusterExistsHasBeenSet = true;
    m_clusterExists = value;
  }
  inline DescribeClusterSnapshotsRequest& WithClusterExists(bool value) {
    SetClusterExists(value);
    return *this;
  }
  ///@}
  ...
  void SetSortingEntities(SortingEntitiesT&& value) {
    m_sortingEntitiesHasBeenSet = true;
    m_sortingEntities = std::forward<SortingEntitiesT>(value);
  }
  template <typename SortingEntitiesT = Aws::Vector<SnapshotSortingEntity>>
  DescribeClusterSnapshotsRequest& WithSortingEntities(SortingEntitiesT&& value) {
    SetSortingEntities(std::forward<SortingEntitiesT>(value));
    return *this;
  }
  ...
  DescribeClusterSnapshotsRequest& AddSortingEntities(SortingEntitiesT&& value) {
    m_sortingEntitiesHasBeenSet = true;
    m_sortingEntities.emplace_back(std::forward<SortingEntitiesT>(value));
    return *this;
  }
  ///@}
 private:
