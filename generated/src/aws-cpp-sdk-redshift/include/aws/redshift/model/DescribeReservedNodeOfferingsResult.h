...
class DescribeReservedNodeOfferingsResult {
 public:
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedNodeOfferingsResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ReservedNodeOfferingsT = Aws::Vector<ReservedNodeOffering>>
  DescribeReservedNodeOfferingsResult& WithReservedNodeOfferings(ReservedNodeOfferingsT&& value) {
  ...
  DescribeReservedNodeOfferingsResult& AddReservedNodeOfferings(ReservedNodeOfferingsT&& value) {
    m_reservedNodeOfferingsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedNodeOfferingsResult& WithResponseMetadata(ResponseMetadataT&& value) {
