...
class CreateClusterRequest : public RedshiftRequest {
 ...
 public:
   ...
   * RG or RA3 node types. Set the automated retention period from 1-35 days.</p>
  ...
  inline CreateClusterRequest& WithAutomatedSnapshotRetentionPeriod(int value) {
  ...
  inline CreateClusterRequest& WithManualSnapshotRetentionPeriod(int value) {
   ...
   * </p> <ul> <li> <p>For clusters with RG or RA3 nodes - Select a port within the
   * ranges <code>5431-5455</code> or <code>8191-8215</code>. (If you have an
   * existing cluster with RG or RA3 nodes, it isn't required that you change the
  ...
  inline CreateClusterRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline CreateClusterRequest& WithAllowVersionUpgrade(bool value) {
  ...
  inline CreateClusterRequest& WithNumberOfNodes(int value) {
  ...
  inline CreateClusterRequest& WithPubliclyAccessible(bool value) {
  ...
  inline CreateClusterRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline CreateClusterRequest& WithEnhancedVpcRouting(bool value) {
  ...
  inline CreateClusterRequest& WithAvailabilityZoneRelocation(bool value) {
  ...
  inline CreateClusterRequest& WithAquaConfigurationStatus(AquaConfigurationStatus value) {
  ...
  void SetLoadSampleData(LoadSampleDataT&& value) {
    m_loadSampleDataHasBeenSet = true;
    m_loadSampleData = std::forward<LoadSampleDataT>(value);
  }
  template <typename LoadSampleDataT = Aws::String>
  CreateClusterRequest& WithLoadSampleData(LoadSampleDataT&& value) {
    SetLoadSampleData(std::forward<LoadSampleDataT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateClusterRequest& WithManageMasterPassword(bool value) {
  ...
  inline CreateClusterRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
