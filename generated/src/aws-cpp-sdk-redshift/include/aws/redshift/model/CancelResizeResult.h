...
namespace Model
{
  ...
  public:
    ...
    template<typename TargetNodeTypeT = Aws::String>
    CancelResizeResult& WithTargetNodeType(TargetNodeTypeT&& value) { SetTargetNodeType(std::forward<TargetNodeTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetClusterTypeT = Aws::String>
    CancelResizeResult& WithTargetClusterType(TargetClusterTypeT&& value) { SetTargetClusterType(std::forward<TargetClusterTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename StatusT = Aws::String>
    CancelResizeResult& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename ImportTablesCompletedT = Aws::Vector<Aws::String>>
    CancelResizeResult& WithImportTablesCompleted(ImportTablesCompletedT&& value) { SetImportTablesCompleted(std::forward<ImportTablesCompletedT>(value)); return *this;}
    template<typename ImportTablesCompletedT = Aws::String>
    CancelResizeResult& AddImportTablesCompleted(ImportTablesCompletedT&& value) { m_importTablesCompletedHasBeenSet = true; m_importTablesCompleted.emplace_back(std::forward<ImportTablesCompletedT>(value)); return *this; }
    ///@}
    ...
    template<typename ImportTablesInProgressT = Aws::Vector<Aws::String>>
    CancelResizeResult& WithImportTablesInProgress(ImportTablesInProgressT&& value) { SetImportTablesInProgress(std::forward<ImportTablesInProgressT>(value)); return *this;}
    template<typename ImportTablesInProgressT = Aws::String>
    CancelResizeResult& AddImportTablesInProgress(ImportTablesInProgressT&& value) { m_importTablesInProgressHasBeenSet = true; m_importTablesInProgress.emplace_back(std::forward<ImportTablesInProgressT>(value)); return *this; }
    ///@}
    ...
    template<typename ImportTablesNotStartedT = Aws::Vector<Aws::String>>
    CancelResizeResult& WithImportTablesNotStarted(ImportTablesNotStartedT&& value) { SetImportTablesNotStarted(std::forward<ImportTablesNotStartedT>(value)); return *this;}
    template<typename ImportTablesNotStartedT = Aws::String>
    CancelResizeResult& AddImportTablesNotStarted(ImportTablesNotStartedT&& value) { m_importTablesNotStartedHasBeenSet = true; m_importTablesNotStarted.emplace_back(std::forward<ImportTablesNotStartedT>(value)); return *this; }
    ///@}
    ...
    template<typename ResizeTypeT = Aws::String>
    CancelResizeResult& WithResizeType(ResizeTypeT&& value) { SetResizeType(std::forward<ResizeTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    CancelResizeResult& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename TargetEncryptionTypeT = Aws::String>
    CancelResizeResult& WithTargetEncryptionType(TargetEncryptionTypeT&& value) { SetTargetEncryptionType(std::forward<TargetEncryptionTypeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CancelResizeResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
