...
class CancelResizeResult {
 public:
  ...
  inline CancelResizeResult& WithTargetNumberOfNodes(int value) {
  ...
  inline CancelResizeResult& WithAvgResizeRateInMegaBytesPerSecond(double value) {
  ...
  inline CancelResizeResult& WithTotalResizeDataInMegaBytes(long long value) {
  ...
  inline CancelResizeResult& WithProgressInMegaBytes(long long value) {
  ...
  inline CancelResizeResult& WithElapsedTimeInSeconds(long long value) {
  ...
  inline CancelResizeResult& WithEstimatedTimeToCompletionInSeconds(long long value) {
  ...
  inline CancelResizeResult& WithDataTransferProgressPercent(double value) {
