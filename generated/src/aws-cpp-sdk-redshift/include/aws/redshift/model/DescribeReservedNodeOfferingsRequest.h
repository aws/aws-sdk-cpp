...
class DescribeReservedNodeOfferingsRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ReservedNodeOfferingIdT = Aws::String>
  DescribeReservedNodeOfferingsRequest& WithReservedNodeOfferingId(ReservedNodeOfferingIdT&& value) {
  ...
  inline DescribeReservedNodeOfferingsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedNodeOfferingsRequest& WithMarker(MarkerT&& value) {
