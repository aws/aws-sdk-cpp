...
class CopyClusterSnapshotRequest : public RedshiftRequest {
 ...
 public:
  ...
  void SetSourceSnapshotIdentifier(SourceSnapshotIdentifierT&& value) {
    m_sourceSnapshotIdentifierHasBeenSet = true;
    m_sourceSnapshotIdentifier = std::forward<SourceSnapshotIdentifierT>(value);
  }
  template <typename SourceSnapshotIdentifierT = Aws::String>
  CopyClusterSnapshotRequest& WithSourceSnapshotIdentifier(SourceSnapshotIdentifierT&& value) {
    SetSourceSnapshotIdentifier(std::forward<SourceSnapshotIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSourceSnapshotClusterIdentifier(SourceSnapshotClusterIdentifierT&& value) {
    m_sourceSnapshotClusterIdentifierHasBeenSet = true;
    m_sourceSnapshotClusterIdentifier = std::forward<SourceSnapshotClusterIdentifierT>(value);
  }
  template <typename SourceSnapshotClusterIdentifierT = Aws::String>
  CopyClusterSnapshotRequest& WithSourceSnapshotClusterIdentifier(SourceSnapshotClusterIdentifierT&& value) {
    SetSourceSnapshotClusterIdentifier(std::forward<SourceSnapshotClusterIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetSnapshotIdentifier(TargetSnapshotIdentifierT&& value) {
    m_targetSnapshotIdentifierHasBeenSet = true;
    m_targetSnapshotIdentifier = std::forward<TargetSnapshotIdentifierT>(value);
  }
  template <typename TargetSnapshotIdentifierT = Aws::String>
  CopyClusterSnapshotRequest& WithTargetSnapshotIdentifier(TargetSnapshotIdentifierT&& value) {
    SetTargetSnapshotIdentifier(std::forward<TargetSnapshotIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline CopyClusterSnapshotRequest& WithManualSnapshotRetentionPeriod(int value) {
