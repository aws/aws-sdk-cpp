...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API ModifyClusterDbRevisionResult() = default;
    ...
    template<typename ClusterT = Cluster>
    ModifyClusterDbRevisionResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyClusterDbRevisionResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
