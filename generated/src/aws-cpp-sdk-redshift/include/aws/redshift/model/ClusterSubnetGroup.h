...
class ClusterSubnetGroup {
 public:
  ...
  void SetSupportedClusterIpAddressTypes(SupportedClusterIpAddressTypesT&& value) {
    ...
    m_supportedClusterIpAddressTypes = std::forward<SupportedClusterIpAddressTypesT>(value);
  }
  template <typename SupportedClusterIpAddressTypesT = Aws::Vector<Aws::String>>
  ClusterSubnetGroup& WithSupportedClusterIpAddressTypes(SupportedClusterIpAddressTypesT&& value) {
    SetSupportedClusterIpAddressTypes(std::forward<SupportedClusterIpAddressTypesT>(value));
    return *this;
  }
  ...
  ClusterSubnetGroup& AddSupportedClusterIpAddressTypes(SupportedClusterIpAddressTypesT&& value) {
    m_supportedClusterIpAddressTypesHasBeenSet = true;
    m_supportedClusterIpAddressTypes.emplace_back(std::forward<SupportedClusterIpAddressTypesT>(value));
    return *this;
  }
  ///@}
 private:
