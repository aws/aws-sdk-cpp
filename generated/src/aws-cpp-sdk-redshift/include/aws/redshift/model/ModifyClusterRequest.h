...
class ModifyClusterRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline ModifyClusterRequest& WithNumberOfNodes(int value) {
   ...
   * <code>ManageMasterPassword</code> is <code>true</code>.</p> <p>If your admin
   * user account is locked, this operation also unlocks your account and resets the
   * failed-login counter. This option is available only when account lockout
   * security is enabled for the cluster.</p>  <p>Operations never return the
   * password, so this operation provides a way to regain access to the admin user
   * account for a cluster if the password is lost.</p>  <p>Default: Uses
   * existing setting.</p> <p>Constraints:</p> <ul> <li> <p>Must be between 8 and 64
  ...
  inline ModifyClusterRequest& WithAutomatedSnapshotRetentionPeriod(int value) {
  ...
  inline ModifyClusterRequest& WithManualSnapshotRetentionPeriod(int value) {
  ...
  inline ModifyClusterRequest& WithAllowVersionUpgrade(bool value) {
  ...
  void SetNewClusterIdentifier(NewClusterIdentifierT&& value) {
    m_newClusterIdentifierHasBeenSet = true;
    m_newClusterIdentifier = std::forward<NewClusterIdentifierT>(value);
  }
  template <typename NewClusterIdentifierT = Aws::String>
  ModifyClusterRequest& WithNewClusterIdentifier(NewClusterIdentifierT&& value) {
    SetNewClusterIdentifier(std::forward<NewClusterIdentifierT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyClusterRequest& WithPubliclyAccessible(bool value) {
  ...
  inline ModifyClusterRequest& WithEnhancedVpcRouting(bool value) {
  ...
  inline ModifyClusterRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyClusterRequest& WithAvailabilityZoneRelocation(bool value) {
  ...
  inline ModifyClusterRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyClusterRequest& WithManageMasterPassword(bool value) {
  ...
  inline ModifyClusterRequest& WithMultiAZ(bool value) {
    SetMultiAZ(value);
    return *this;
  }
  ///@}
