...
namespace Model
{
  ...
  public:
    ...
    template<typename GrantorT = Aws::String>
    RevokeEndpointAccessResult& WithGrantor(GrantorT&& value) { SetGrantor(std::forward<GrantorT>(value)); return *this;}
    ///@}
    ...
    template<typename GranteeT = Aws::String>
    RevokeEndpointAccessResult& WithGrantee(GranteeT&& value) { SetGrantee(std::forward<GranteeT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterIdentifierT = Aws::String>
    RevokeEndpointAccessResult& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthorizeTimeT = Aws::Utils::DateTime>
    RevokeEndpointAccessResult& WithAuthorizeTime(AuthorizeTimeT&& value) { SetAuthorizeTime(std::forward<AuthorizeTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterStatusT = Aws::String>
    RevokeEndpointAccessResult& WithClusterStatus(ClusterStatusT&& value) { SetClusterStatus(std::forward<ClusterStatusT>(value)); return *this;}
    ///@}
    ...
    inline RevokeEndpointAccessResult& WithStatus(AuthorizationStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename AllowedVPCsT = Aws::Vector<Aws::String>>
    RevokeEndpointAccessResult& WithAllowedVPCs(AllowedVPCsT&& value) { SetAllowedVPCs(std::forward<AllowedVPCsT>(value)); return *this;}
    template<typename AllowedVPCsT = Aws::String>
    RevokeEndpointAccessResult& AddAllowedVPCs(AllowedVPCsT&& value) { m_allowedVPCsHasBeenSet = true; m_allowedVPCs.emplace_back(std::forward<AllowedVPCsT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RevokeEndpointAccessResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
