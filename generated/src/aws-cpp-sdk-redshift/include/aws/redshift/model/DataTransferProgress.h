...
class DataTransferProgress {
 public:
  ...
  inline void SetCurrentRateInMegaBytesPerSecond(double value) {
    m_currentRateInMegaBytesPerSecondHasBeenSet = true;
    m_currentRateInMegaBytesPerSecond = value;
  }
  inline DataTransferProgress& WithCurrentRateInMegaBytesPerSecond(double value) {
    SetCurrentRateInMegaBytesPerSecond(value);
    return *this;
  }
  ///@}
  ...
  inline DataTransferProgress& WithTotalDataInMegaBytes(long long value) {
  ...
  inline void SetDataTransferredInMegaBytes(long long value) {
    m_dataTransferredInMegaBytesHasBeenSet = true;
    m_dataTransferredInMegaBytes = value;
  }
  inline DataTransferProgress& WithDataTransferredInMegaBytes(long long value) {
    SetDataTransferredInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  inline DataTransferProgress& WithEstimatedTimeToCompletionInSeconds(long long value) {
  ...
  inline DataTransferProgress& WithElapsedTimeInSeconds(long long value) {
