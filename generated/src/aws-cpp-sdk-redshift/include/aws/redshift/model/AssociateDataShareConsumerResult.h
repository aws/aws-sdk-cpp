...
class AssociateDataShareConsumerResult {
 public:
  ...
  template <typename DataShareArnT = Aws::String>
  AssociateDataShareConsumerResult& WithDataShareArn(DataShareArnT&& value) {
  ...
  template <typename ProducerArnT = Aws::String>
  AssociateDataShareConsumerResult& WithProducerArn(ProducerArnT&& value) {
  ...
  inline AssociateDataShareConsumerResult& WithAllowPubliclyAccessibleConsumers(bool value) {
  ...
  template <typename DataShareAssociationsT = Aws::Vector<DataShareAssociation>>
  AssociateDataShareConsumerResult& WithDataShareAssociations(DataShareAssociationsT&& value) {
  ...
  AssociateDataShareConsumerResult& AddDataShareAssociations(DataShareAssociationsT&& value) {
    m_dataShareAssociationsHasBeenSet = true;
  ...
  template <typename ManagedByT = Aws::String>
  AssociateDataShareConsumerResult& WithManagedBy(ManagedByT&& value) {
  ...
  inline AssociateDataShareConsumerResult& WithDataShareType(DataShareType value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateDataShareConsumerResult& WithResponseMetadata(ResponseMetadataT&& value) {
