...
class DescribeDataSharesForConsumerResult {
 public:
  ...
  template <typename DataSharesT = Aws::Vector<DataShare>>
  DescribeDataSharesForConsumerResult& WithDataShares(DataSharesT&& value) {
    SetDataShares(std::forward<DataSharesT>(value));
    return *this;
  }
  template <typename DataSharesT = DataShare>
  DescribeDataSharesForConsumerResult& AddDataShares(DataSharesT&& value) {
    m_dataSharesHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataSharesForConsumerResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDataSharesForConsumerResult& WithResponseMetadata(ResponseMetadataT&& value) {
