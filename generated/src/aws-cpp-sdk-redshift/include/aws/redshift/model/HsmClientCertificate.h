...
class HsmClientCertificate {
 public:
  ...
  void SetHsmClientCertificatePublicKey(HsmClientCertificatePublicKeyT&& value) {
    ...
    m_hsmClientCertificatePublicKey = std::forward<HsmClientCertificatePublicKeyT>(value);
  }
  template <typename HsmClientCertificatePublicKeyT = Aws::String>
  HsmClientCertificate& WithHsmClientCertificatePublicKey(HsmClientCertificatePublicKeyT&& value) {
    SetHsmClientCertificatePublicKey(std::forward<HsmClientCertificatePublicKeyT>(value));
    return *this;
  }
  ///@}
