...
class DescribeDataSharesResult {
 public:
  ...
  template <typename DataSharesT = Aws::Vector<DataShare>>
  DescribeDataSharesResult& WithDataShares(DataSharesT&& value) {
    SetDataShares(std::forward<DataSharesT>(value));
    return *this;
  }
  template <typename DataSharesT = DataShare>
  DescribeDataSharesResult& AddDataShares(DataSharesT&& value) {
    m_dataSharesHasBeenSet = true;
  ...
  template <typename MarkerT = Aws::String>
  DescribeDataSharesResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDataSharesResult& WithResponseMetadata(ResponseMetadataT&& value) {
