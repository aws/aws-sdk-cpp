...
class Cluster {
 public:
  ...
  void SetClusterStatus(ClusterStatusT&& value) {
    ...
    m_clusterStatus = std::forward<ClusterStatusT>(value);
  }
  template <typename ClusterStatusT = Aws::String>
  Cluster& WithClusterStatus(ClusterStatusT&& value) {
    SetClusterStatus(std::forward<ClusterStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterAvailabilityStatus(ClusterAvailabilityStatusT&& value) {
    ...
    m_clusterAvailabilityStatus = std::forward<ClusterAvailabilityStatusT>(value);
  }
  template <typename ClusterAvailabilityStatusT = Aws::String>
  Cluster& WithClusterAvailabilityStatus(ClusterAvailabilityStatusT&& value) {
    SetClusterAvailabilityStatus(std::forward<ClusterAvailabilityStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetModifyStatus(ModifyStatusT&& value) {
    ...
    m_modifyStatus = std::forward<ModifyStatusT>(value);
  }
  template <typename ModifyStatusT = Aws::String>
  Cluster& WithModifyStatus(ModifyStatusT&& value) {
    SetModifyStatus(std::forward<ModifyStatusT>(value));
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithAutomatedSnapshotRetentionPeriod(int value) {
  ...
  inline Cluster& WithManualSnapshotRetentionPeriod(int value) {
  ...
  void SetClusterParameterGroups(ClusterParameterGroupsT&& value) {
    ...
    m_clusterParameterGroups = std::forward<ClusterParameterGroupsT>(value);
  }
  template <typename ClusterParameterGroupsT = Aws::Vector<ClusterParameterGroupStatus>>
  Cluster& WithClusterParameterGroups(ClusterParameterGroupsT&& value) {
    SetClusterParameterGroups(std::forward<ClusterParameterGroupsT>(value));
    return *this;
  }
  ...
  Cluster& AddClusterParameterGroups(ClusterParameterGroupsT&& value) {
    m_clusterParameterGroupsHasBeenSet = true;
    m_clusterParameterGroups.emplace_back(std::forward<ClusterParameterGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithAllowVersionUpgrade(bool value) {
  ...
  inline Cluster& WithNumberOfNodes(int value) {
  ...
  inline Cluster& WithPubliclyAccessible(bool value) {
  ...
  inline Cluster& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  void SetRestoreStatus(RestoreStatusT&& value) {
    ...
    m_restoreStatus = std::forward<RestoreStatusT>(value);
  }
  template <typename RestoreStatusT = RestoreStatus>
  Cluster& WithRestoreStatus(RestoreStatusT&& value) {
    SetRestoreStatus(std::forward<RestoreStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDataTransferProgress(DataTransferProgressT&& value) {
    ...
    m_dataTransferProgress = std::forward<DataTransferProgressT>(value);
  }
  template <typename DataTransferProgressT = DataTransferProgress>
  Cluster& WithDataTransferProgress(DataTransferProgressT&& value) {
    SetDataTransferProgress(std::forward<DataTransferProgressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHsmStatus(HsmStatusT&& value) {
    ...
    m_hsmStatus = std::forward<HsmStatusT>(value);
  }
  template <typename HsmStatusT = HsmStatus>
  Cluster& WithHsmStatus(HsmStatusT&& value) {
    SetHsmStatus(std::forward<HsmStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterSnapshotCopyStatus(ClusterSnapshotCopyStatusT&& value) {
    ...
    m_clusterSnapshotCopyStatus = std::forward<ClusterSnapshotCopyStatusT>(value);
  }
  template <typename ClusterSnapshotCopyStatusT = ClusterSnapshotCopyStatus>
  Cluster& WithClusterSnapshotCopyStatus(ClusterSnapshotCopyStatusT&& value) {
    SetClusterSnapshotCopyStatus(std::forward<ClusterSnapshotCopyStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterPublicKey(ClusterPublicKeyT&& value) {
    ...
    m_clusterPublicKey = std::forward<ClusterPublicKeyT>(value);
  }
  template <typename ClusterPublicKeyT = Aws::String>
  Cluster& WithClusterPublicKey(ClusterPublicKeyT&& value) {
    SetClusterPublicKey(std::forward<ClusterPublicKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterNodes(ClusterNodesT&& value) {
    ...
    m_clusterNodes = std::forward<ClusterNodesT>(value);
  }
  template <typename ClusterNodesT = Aws::Vector<ClusterNode>>
  Cluster& WithClusterNodes(ClusterNodesT&& value) {
    SetClusterNodes(std::forward<ClusterNodesT>(value));
    return *this;
  }
  template <typename ClusterNodesT = ClusterNode>
  Cluster& AddClusterNodes(ClusterNodesT&& value) {
    m_clusterNodesHasBeenSet = true;
    m_clusterNodes.emplace_back(std::forward<ClusterNodesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElasticIpStatus(ElasticIpStatusT&& value) {
    ...
    m_elasticIpStatus = std::forward<ElasticIpStatusT>(value);
  }
  template <typename ElasticIpStatusT = ElasticIpStatus>
  Cluster& WithElasticIpStatus(ElasticIpStatusT&& value) {
    SetElasticIpStatus(std::forward<ElasticIpStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterRevisionNumber(ClusterRevisionNumberT&& value) {
    ...
    m_clusterRevisionNumber = std::forward<ClusterRevisionNumberT>(value);
  }
  template <typename ClusterRevisionNumberT = Aws::String>
  Cluster& WithClusterRevisionNumber(ClusterRevisionNumberT&& value) {
    SetClusterRevisionNumber(std::forward<ClusterRevisionNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline Cluster& WithEnhancedVpcRouting(bool value) {
  ...
  void SetPendingActions(PendingActionsT&& value) {
    ...
    m_pendingActions = std::forward<PendingActionsT>(value);
  }
  template <typename PendingActionsT = Aws::Vector<Aws::String>>
  Cluster& WithPendingActions(PendingActionsT&& value) {
    SetPendingActions(std::forward<PendingActionsT>(value));
    return *this;
  }
  template <typename PendingActionsT = Aws::String>
  Cluster& AddPendingActions(PendingActionsT&& value) {
    m_pendingActionsHasBeenSet = true;
    m_pendingActions.emplace_back(std::forward<PendingActionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElasticResizeNumberOfNodeOptions(ElasticResizeNumberOfNodeOptionsT&& value) {
    ...
    m_elasticResizeNumberOfNodeOptions = std::forward<ElasticResizeNumberOfNodeOptionsT>(value);
  }
  template <typename ElasticResizeNumberOfNodeOptionsT = Aws::String>
  Cluster& WithElasticResizeNumberOfNodeOptions(ElasticResizeNumberOfNodeOptionsT&& value) {
    SetElasticResizeNumberOfNodeOptions(std::forward<ElasticResizeNumberOfNodeOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeferredMaintenanceWindows(DeferredMaintenanceWindowsT&& value) {
    ...
    m_deferredMaintenanceWindows = std::forward<DeferredMaintenanceWindowsT>(value);
  }
  template <typename DeferredMaintenanceWindowsT = Aws::Vector<DeferredMaintenanceWindow>>
  Cluster& WithDeferredMaintenanceWindows(DeferredMaintenanceWindowsT&& value) {
    SetDeferredMaintenanceWindows(std::forward<DeferredMaintenanceWindowsT>(value));
    return *this;
  }
  ...
  Cluster& AddDeferredMaintenanceWindows(DeferredMaintenanceWindowsT&& value) {
    m_deferredMaintenanceWindowsHasBeenSet = true;
    m_deferredMaintenanceWindows.emplace_back(std::forward<DeferredMaintenanceWindowsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshotScheduleState(ScheduleState value) {
    m_snapshotScheduleStateHasBeenSet = true;
    m_snapshotScheduleState = value;
  }
  inline Cluster& WithSnapshotScheduleState(ScheduleState value) {
    SetSnapshotScheduleState(value);
    return *this;
  }
  ///@}
  ...
  void SetExpectedNextSnapshotScheduleTime(ExpectedNextSnapshotScheduleTimeT&& value) {
    ...
    m_expectedNextSnapshotScheduleTime = std::forward<ExpectedNextSnapshotScheduleTimeT>(value);
  }
  template <typename ExpectedNextSnapshotScheduleTimeT = Aws::Utils::DateTime>
  Cluster& WithExpectedNextSnapshotScheduleTime(ExpectedNextSnapshotScheduleTimeT&& value) {
    SetExpectedNextSnapshotScheduleTime(std::forward<ExpectedNextSnapshotScheduleTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpectedNextSnapshotScheduleTimeStatus(ExpectedNextSnapshotScheduleTimeStatusT&& value) {
    ...
    m_expectedNextSnapshotScheduleTimeStatus = std::forward<ExpectedNextSnapshotScheduleTimeStatusT>(value);
  }
  template <typename ExpectedNextSnapshotScheduleTimeStatusT = Aws::String>
  Cluster& WithExpectedNextSnapshotScheduleTimeStatus(ExpectedNextSnapshotScheduleTimeStatusT&& value) {
    SetExpectedNextSnapshotScheduleTimeStatus(std::forward<ExpectedNextSnapshotScheduleTimeStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextMaintenanceWindowStartTime(NextMaintenanceWindowStartTimeT&& value) {
    ...
    m_nextMaintenanceWindowStartTime = std::forward<NextMaintenanceWindowStartTimeT>(value);
  }
  template <typename NextMaintenanceWindowStartTimeT = Aws::Utils::DateTime>
  Cluster& WithNextMaintenanceWindowStartTime(NextMaintenanceWindowStartTimeT&& value) {
    SetNextMaintenanceWindowStartTime(std::forward<NextMaintenanceWindowStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResizeInfo(ResizeInfoT&& value) {
    ...
    m_resizeInfo = std::forward<ResizeInfoT>(value);
  }
  template <typename ResizeInfoT = ResizeInfo>
  Cluster& WithResizeInfo(ResizeInfoT&& value) {
    SetResizeInfo(std::forward<ResizeInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailabilityZoneRelocationStatus(AvailabilityZoneRelocationStatusT&& value) {
    ...
    m_availabilityZoneRelocationStatus = std::forward<AvailabilityZoneRelocationStatusT>(value);
  }
  template <typename AvailabilityZoneRelocationStatusT = Aws::String>
  Cluster& WithAvailabilityZoneRelocationStatus(AvailabilityZoneRelocationStatusT&& value) {
    SetAvailabilityZoneRelocationStatus(std::forward<AvailabilityZoneRelocationStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetClusterNamespaceArn(ClusterNamespaceArnT&& value) {
    ...
    m_clusterNamespaceArn = std::forward<ClusterNamespaceArnT>(value);
  }
  template <typename ClusterNamespaceArnT = Aws::String>
  Cluster& WithClusterNamespaceArn(ClusterNamespaceArnT&& value) {
    SetClusterNamespaceArn(std::forward<ClusterNamespaceArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalStorageCapacityInMegaBytes(long long value) {
    m_totalStorageCapacityInMegaBytesHasBeenSet = true;
    m_totalStorageCapacityInMegaBytes = value;
  }
  inline Cluster& WithTotalStorageCapacityInMegaBytes(long long value) {
    SetTotalStorageCapacityInMegaBytes(value);
    return *this;
  }
  ///@}
  ...
  void SetAquaConfiguration(AquaConfigurationT&& value) {
    ...
    m_aquaConfiguration = std::forward<AquaConfigurationT>(value);
  }
  template <typename AquaConfigurationT = AquaConfiguration>
  Cluster& WithAquaConfiguration(AquaConfigurationT&& value) {
    SetAquaConfiguration(std::forward<AquaConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedNodeExchangeStatus(ReservedNodeExchangeStatusT&& value) {
    ...
    m_reservedNodeExchangeStatus = std::forward<ReservedNodeExchangeStatusT>(value);
  }
  template <typename ReservedNodeExchangeStatusT = ReservedNodeExchangeStatus>
  Cluster& WithReservedNodeExchangeStatus(ReservedNodeExchangeStatusT&& value) {
    SetReservedNodeExchangeStatus(std::forward<ReservedNodeExchangeStatusT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomDomainCertificateExpiryDate(CustomDomainCertificateExpiryDateT&& value) {
    ...
    m_customDomainCertificateExpiryDate = std::forward<CustomDomainCertificateExpiryDateT>(value);
  }
  template <typename CustomDomainCertificateExpiryDateT = Aws::Utils::DateTime>
  Cluster& WithCustomDomainCertificateExpiryDate(CustomDomainCertificateExpiryDateT&& value) {
    SetCustomDomainCertificateExpiryDate(std::forward<CustomDomainCertificateExpiryDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMasterPasswordSecretArn(MasterPasswordSecretArnT&& value) {
    ...
    m_masterPasswordSecretArn = std::forward<MasterPasswordSecretArnT>(value);
  }
  template <typename MasterPasswordSecretArnT = Aws::String>
  Cluster& WithMasterPasswordSecretArn(MasterPasswordSecretArnT&& value) {
    SetMasterPasswordSecretArn(std::forward<MasterPasswordSecretArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetMultiAZSecondary(MultiAZSecondaryT&& value) {
    ...
    m_multiAZSecondary = std::forward<MultiAZSecondaryT>(value);
  }
  template <typename MultiAZSecondaryT = SecondaryClusterInfo>
  Cluster& WithMultiAZSecondary(MultiAZSecondaryT&& value) {
    SetMultiAZSecondary(std::forward<MultiAZSecondaryT>(value));
    return *this;
  }
  ///@}
