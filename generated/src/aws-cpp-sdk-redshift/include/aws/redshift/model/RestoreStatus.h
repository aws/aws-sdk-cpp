...
class RestoreStatus {
 public:
  ...
  inline RestoreStatus& WithCurrentRestoreRateInMegaBytesPerSecond(double value) {
  ...
  inline RestoreStatus& WithSnapshotSizeInMegaBytes(long long value) {
  ...
  inline RestoreStatus& WithProgressInMegaBytes(long long value) {
  ...
  inline RestoreStatus& WithElapsedTimeInSeconds(long long value) {
  ...
  inline RestoreStatus& WithEstimatedTimeToCompletionInSeconds(long long value) {
