...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API RotateEncryptionKeyResult() = default;
    ...
    template<typename ClusterT = Cluster>
    RotateEncryptionKeyResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RotateEncryptionKeyResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
