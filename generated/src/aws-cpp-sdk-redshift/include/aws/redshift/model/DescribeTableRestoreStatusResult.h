...
class DescribeTableRestoreStatusResult {
 public:
  ...
  void SetTableRestoreStatusDetails(TableRestoreStatusDetailsT&& value) {
    m_tableRestoreStatusDetailsHasBeenSet = true;
    m_tableRestoreStatusDetails = std::forward<TableRestoreStatusDetailsT>(value);
  }
  template <typename TableRestoreStatusDetailsT = Aws::Vector<TableRestoreStatus>>
  DescribeTableRestoreStatusResult& WithTableRestoreStatusDetails(TableRestoreStatusDetailsT&& value) {
    SetTableRestoreStatusDetails(std::forward<TableRestoreStatusDetailsT>(value));
    return *this;
  }
  template <typename TableRestoreStatusDetailsT = TableRestoreStatus>
  DescribeTableRestoreStatusResult& AddTableRestoreStatusDetails(TableRestoreStatusDetailsT&& value) {
    m_tableRestoreStatusDetailsHasBeenSet = true;
    m_tableRestoreStatusDetails.emplace_back(std::forward<TableRestoreStatusDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeTableRestoreStatusResult& WithMarker(MarkerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTableRestoreStatusResult& WithResponseMetadata(ResponseMetadataT&& value) {
