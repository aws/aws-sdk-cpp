...
class ModifyAquaConfigurationResult {
 public:
  ...
  template <typename AquaConfigurationT = AquaConfiguration>
  ModifyAquaConfigurationResult& WithAquaConfiguration(AquaConfigurationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyAquaConfigurationResult& WithResponseMetadata(ResponseMetadataT&& value) {
