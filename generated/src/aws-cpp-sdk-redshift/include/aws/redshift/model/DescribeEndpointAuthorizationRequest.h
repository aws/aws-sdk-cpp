...
class DescribeEndpointAuthorizationRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline void SetGrantee(bool value) {
    m_granteeHasBeenSet = true;
    m_grantee = value;
  }
  inline DescribeEndpointAuthorizationRequest& WithGrantee(bool value) {
    SetGrantee(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeEndpointAuthorizationRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
