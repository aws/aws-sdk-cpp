...
class GetClusterCredentialsWithIAMRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename DbNameT = Aws::String>
  GetClusterCredentialsWithIAMRequest& WithDbName(DbNameT&& value) {
  ...
  template <typename ClusterIdentifierT = Aws::String>
  GetClusterCredentialsWithIAMRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  inline GetClusterCredentialsWithIAMRequest& WithDurationSeconds(int value) {
  ...
  template <typename CustomDomainNameT = Aws::String>
  GetClusterCredentialsWithIAMRequest& WithCustomDomainName(CustomDomainNameT&& value) {
