...
class BatchModifyClusterSnapshotsRequest : public RedshiftRequest {
 ...
 public:
  ...
  void SetSnapshotIdentifierList(SnapshotIdentifierListT&& value) {
    m_snapshotIdentifierListHasBeenSet = true;
    m_snapshotIdentifierList = std::forward<SnapshotIdentifierListT>(value);
  }
  template <typename SnapshotIdentifierListT = Aws::Vector<Aws::String>>
  BatchModifyClusterSnapshotsRequest& WithSnapshotIdentifierList(SnapshotIdentifierListT&& value) {
    SetSnapshotIdentifierList(std::forward<SnapshotIdentifierListT>(value));
    return *this;
  }
  ...
  BatchModifyClusterSnapshotsRequest& AddSnapshotIdentifierList(SnapshotIdentifierListT&& value) {
    m_snapshotIdentifierListHasBeenSet = true;
    m_snapshotIdentifierList.emplace_back(std::forward<SnapshotIdentifierListT>(value));
    return *this;
  }
  ///@}
  ...
  inline BatchModifyClusterSnapshotsRequest& WithManualSnapshotRetentionPeriod(int value) {
  ...
  inline BatchModifyClusterSnapshotsRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
