...
class CreateUsageLimitRequest : public RedshiftRequest {
 ...
 public:
  ...
  inline CreateUsageLimitRequest& WithFeatureType(UsageLimitFeatureType value) {
  ...
  inline CreateUsageLimitRequest& WithLimitType(UsageLimitLimitType value) {
    SetLimitType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitRequest& WithAmount(long long value) {
    SetAmount(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitRequest& WithPeriod(UsageLimitPeriod value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitRequest& WithBreachAction(UsageLimitBreachAction value) {
