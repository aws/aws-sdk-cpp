...
class AuthorizedTokenIssuer {
 public:
  ...
  template <typename TrustedTokenIssuerArnT = Aws::String>
  AuthorizedTokenIssuer& WithTrustedTokenIssuerArn(TrustedTokenIssuerArnT&& value) {
  ...
  void SetAuthorizedAudiencesList(AuthorizedAudiencesListT&& value) {
    m_authorizedAudiencesListHasBeenSet = true;
    m_authorizedAudiencesList = std::forward<AuthorizedAudiencesListT>(value);
  }
  template <typename AuthorizedAudiencesListT = Aws::Vector<Aws::String>>
  AuthorizedTokenIssuer& WithAuthorizedAudiencesList(AuthorizedAudiencesListT&& value) {
    SetAuthorizedAudiencesList(std::forward<AuthorizedAudiencesListT>(value));
    return *this;
  }
  template <typename AuthorizedAudiencesListT = Aws::String>
  AuthorizedTokenIssuer& AddAuthorizedAudiencesList(AuthorizedAudiencesListT&& value) {
    m_authorizedAudiencesListHasBeenSet = true;
    m_authorizedAudiencesList.emplace_back(std::forward<AuthorizedAudiencesListT>(value));
    return *this;
  }
  ///@}
 private:
