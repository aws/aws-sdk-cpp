...
class DescribeSnapshotSchedulesResult {
 public:
  ...
  void SetSnapshotSchedules(SnapshotSchedulesT&& value) {
    ...
    m_snapshotSchedules = std::forward<SnapshotSchedulesT>(value);
  }
  template <typename SnapshotSchedulesT = Aws::Vector<SnapshotSchedule>>
  DescribeSnapshotSchedulesResult& WithSnapshotSchedules(SnapshotSchedulesT&& value) {
    SetSnapshotSchedules(std::forward<SnapshotSchedulesT>(value));
    return *this;
  }
  ...
  DescribeSnapshotSchedulesResult& AddSnapshotSchedules(SnapshotSchedulesT&& value) {
    m_snapshotSchedulesHasBeenSet = true;
    m_snapshotSchedules.emplace_back(std::forward<SnapshotSchedulesT>(value));
    return *this;
  }
  ///@}
