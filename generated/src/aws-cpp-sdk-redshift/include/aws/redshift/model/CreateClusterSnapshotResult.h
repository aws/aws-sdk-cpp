...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API CreateClusterSnapshotResult() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateClusterSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
