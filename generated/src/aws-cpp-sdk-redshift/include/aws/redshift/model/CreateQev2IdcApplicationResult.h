...
class CreateQev2IdcApplicationResult {
 public:
  AWS_REDSHIFT_API CreateQev2IdcApplicationResult() = default;
  AWS_REDSHIFT_API CreateQev2IdcApplicationResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_REDSHIFT_API CreateQev2IdcApplicationResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename Qev2IdcApplicationT = Qev2IdcApplication>
  CreateQev2IdcApplicationResult& WithQev2IdcApplication(Qev2IdcApplicationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateQev2IdcApplicationResult& WithResponseMetadata(ResponseMetadataT&& value) {
