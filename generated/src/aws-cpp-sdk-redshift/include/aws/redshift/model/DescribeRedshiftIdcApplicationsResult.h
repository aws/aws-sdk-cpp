...
class DescribeRedshiftIdcApplicationsResult {
 public:
  ...
  AWS_REDSHIFT_API DescribeRedshiftIdcApplicationsResult& operator=(
  ...
  void SetRedshiftIdcApplications(RedshiftIdcApplicationsT&& value) {
    ...
    m_redshiftIdcApplications = std::forward<RedshiftIdcApplicationsT>(value);
  }
  template <typename RedshiftIdcApplicationsT = Aws::Vector<RedshiftIdcApplication>>
  DescribeRedshiftIdcApplicationsResult& WithRedshiftIdcApplications(RedshiftIdcApplicationsT&& value) {
    SetRedshiftIdcApplications(std::forward<RedshiftIdcApplicationsT>(value));
    return *this;
  }
  ...
  DescribeRedshiftIdcApplicationsResult& AddRedshiftIdcApplications(RedshiftIdcApplicationsT&& value) {
    m_redshiftIdcApplicationsHasBeenSet = true;
    m_redshiftIdcApplications.emplace_back(std::forward<RedshiftIdcApplicationsT>(value));
    return *this;
  }
  ///@}
