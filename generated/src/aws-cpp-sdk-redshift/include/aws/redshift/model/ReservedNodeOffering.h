...
class ReservedNodeOffering {
 public:
  ...
  inline ReservedNodeOffering& WithDuration(int value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNodeOffering& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNodeOffering& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedNodeOffering& WithReservedNodeOfferingType(ReservedNodeOfferingType value) {
