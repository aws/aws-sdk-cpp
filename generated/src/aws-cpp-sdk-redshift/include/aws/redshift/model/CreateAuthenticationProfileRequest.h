...
namespace Model
{
  ...
  public:
    ...
    template<typename AuthenticationProfileNameT = Aws::String>
    CreateAuthenticationProfileRequest& WithAuthenticationProfileName(AuthenticationProfileNameT&& value) { SetAuthenticationProfileName(std::forward<AuthenticationProfileNameT>(value)); return *this;}
    ///@}
    ...
    template<typename AuthenticationProfileContentT = Aws::String>
    CreateAuthenticationProfileRequest& WithAuthenticationProfileContent(AuthenticationProfileContentT&& value) { SetAuthenticationProfileContent(std::forward<AuthenticationProfileContentT>(value)); return *this;}
    ///@}
  private:
