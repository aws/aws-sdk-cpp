...
class CreateAuthenticationProfileResult {
 public:
  ...
  void SetAuthenticationProfileContent(AuthenticationProfileContentT&& value) {
    ...
    m_authenticationProfileContent = std::forward<AuthenticationProfileContentT>(value);
  }
  template <typename AuthenticationProfileContentT = Aws::String>
  CreateAuthenticationProfileResult& WithAuthenticationProfileContent(AuthenticationProfileContentT&& value) {
    SetAuthenticationProfileContent(std::forward<AuthenticationProfileContentT>(value));
    return *this;
  }
  ///@}
