...
class GetReservedNodeExchangeOfferingsRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ReservedNodeIdT = Aws::String>
  GetReservedNodeExchangeOfferingsRequest& WithReservedNodeId(ReservedNodeIdT&& value) {
  ...
  inline GetReservedNodeExchangeOfferingsRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  GetReservedNodeExchangeOfferingsRequest& WithMarker(MarkerT&& value) {
