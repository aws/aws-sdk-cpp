...
class ModifyIntegrationRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename IntegrationArnT = Aws::String>
  ModifyIntegrationRequest& WithIntegrationArn(IntegrationArnT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ModifyIntegrationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename IntegrationNameT = Aws::String>
  ModifyIntegrationRequest& WithIntegrationName(IntegrationNameT&& value) {
