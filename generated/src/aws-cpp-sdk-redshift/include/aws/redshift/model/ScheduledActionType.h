...
class ScheduledActionType {
 public:
  ...
  void SetResizeCluster(ResizeClusterT&& value) {
    m_resizeClusterHasBeenSet = true;
    m_resizeCluster = std::forward<ResizeClusterT>(value);
  }
  template <typename ResizeClusterT = ResizeClusterMessage>
  ScheduledActionType& WithResizeCluster(ResizeClusterT&& value) {
    SetResizeCluster(std::forward<ResizeClusterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPauseCluster(PauseClusterT&& value) {
    m_pauseClusterHasBeenSet = true;
    m_pauseCluster = std::forward<PauseClusterT>(value);
  }
  template <typename PauseClusterT = PauseClusterMessage>
  ScheduledActionType& WithPauseCluster(PauseClusterT&& value) {
    SetPauseCluster(std::forward<PauseClusterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResumeCluster(ResumeClusterT&& value) {
    m_resumeClusterHasBeenSet = true;
    m_resumeCluster = std::forward<ResumeClusterT>(value);
  }
  template <typename ResumeClusterT = ResumeClusterMessage>
  ScheduledActionType& WithResumeCluster(ResumeClusterT&& value) {
    SetResumeCluster(std::forward<ResumeClusterT>(value));
    return *this;
  }
  ///@}
 private:
