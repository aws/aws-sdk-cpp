...
class DescribeReservedNodesRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ReservedNodeIdT = Aws::String>
  DescribeReservedNodesRequest& WithReservedNodeId(ReservedNodeIdT&& value) {
  ...
  inline DescribeReservedNodesRequest& WithMaxRecords(int value) {
    SetMaxRecords(value);
    return *this;
  }
  ///@}
  ...
  template <typename MarkerT = Aws::String>
  DescribeReservedNodesRequest& WithMarker(MarkerT&& value) {
