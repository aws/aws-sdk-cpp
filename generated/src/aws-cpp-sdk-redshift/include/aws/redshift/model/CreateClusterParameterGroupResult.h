...
class CreateClusterParameterGroupResult {
 public:
  ...
  void SetClusterParameterGroup(ClusterParameterGroupT&& value) {
    m_clusterParameterGroupHasBeenSet = true;
    m_clusterParameterGroup = std::forward<ClusterParameterGroupT>(value);
  }
  template <typename ClusterParameterGroupT = ClusterParameterGroup>
  CreateClusterParameterGroupResult& WithClusterParameterGroup(ClusterParameterGroupT&& value) {
    SetClusterParameterGroup(std::forward<ClusterParameterGroupT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateClusterParameterGroupResult& WithResponseMetadata(ResponseMetadataT&& value) {
