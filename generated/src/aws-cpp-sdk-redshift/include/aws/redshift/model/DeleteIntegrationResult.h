...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API DeleteIntegrationResult();
    ...
    inline DeleteIntegrationResult& WithStatus(const ZeroETLIntegrationStatus& value) { SetStatus(value); return *this;}
    inline DeleteIntegrationResult& WithStatus(ZeroETLIntegrationStatus&& value) { SetStatus(std::move(value)); return *this;}
    ///@}
