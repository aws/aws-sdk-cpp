...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API ModifySnapshotCopyRetentionPeriodResult() = default;
    ...
    template<typename ClusterT = Cluster>
    ModifySnapshotCopyRetentionPeriodResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifySnapshotCopyRetentionPeriodResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
