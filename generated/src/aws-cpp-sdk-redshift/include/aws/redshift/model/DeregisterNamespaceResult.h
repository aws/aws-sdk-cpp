...
class DeregisterNamespaceResult {
 public:
  ...
  inline void SetStatus(NamespaceRegistrationStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DeregisterNamespaceResult& WithStatus(NamespaceRegistrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeregisterNamespaceResult& WithResponseMetadata(ResponseMetadataT&& value) {
