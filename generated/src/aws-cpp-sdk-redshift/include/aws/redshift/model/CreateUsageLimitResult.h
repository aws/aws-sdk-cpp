...
namespace Model
{
  ...
  public:
    ...
    template<typename UsageLimitIdT = Aws::String>
    CreateUsageLimitResult& WithUsageLimitId(UsageLimitIdT&& value) { SetUsageLimitId(std::forward<UsageLimitIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClusterIdentifierT = Aws::String>
    CreateUsageLimitResult& WithClusterIdentifier(ClusterIdentifierT&& value) { SetClusterIdentifier(std::forward<ClusterIdentifierT>(value)); return *this;}
    ///@}
    ...
    inline CreateUsageLimitResult& WithFeatureType(UsageLimitFeatureType value) { SetFeatureType(value); return *this;}
    ///@}
    ...
    inline CreateUsageLimitResult& WithLimitType(UsageLimitLimitType value) { SetLimitType(value); return *this;}
    ///@}
    ...
    inline CreateUsageLimitResult& WithPeriod(UsageLimitPeriod value) { SetPeriod(value); return *this;}
    ///@}
    ...
    inline CreateUsageLimitResult& WithBreachAction(UsageLimitBreachAction value) { SetBreachAction(value); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    CreateUsageLimitResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    CreateUsageLimitResult& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateUsageLimitResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
