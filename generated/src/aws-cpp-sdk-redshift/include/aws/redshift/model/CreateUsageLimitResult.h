...
class CreateUsageLimitResult {
 public:
  ...
  inline CreateUsageLimitResult& WithFeatureType(UsageLimitFeatureType value) {
  ...
  inline CreateUsageLimitResult& WithLimitType(UsageLimitLimitType value) {
    SetLimitType(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitResult& WithAmount(long long value) {
    SetAmount(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitResult& WithPeriod(UsageLimitPeriod value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  inline CreateUsageLimitResult& WithBreachAction(UsageLimitBreachAction value) {
