...
class AquaConfiguration {
 public:
  ...
  inline void SetAquaStatus(AquaStatus value) {
    m_aquaStatusHasBeenSet = true;
    m_aquaStatus = value;
  }
  inline AquaConfiguration& WithAquaStatus(AquaStatus value) {
    SetAquaStatus(value);
    return *this;
  }
  ///@}
  ...
  inline AquaConfiguration& WithAquaConfigurationStatus(AquaConfigurationStatus value) {
