...
class ClusterParameterGroupStatus {
 public:
  ...
  void SetClusterParameterStatusList(ClusterParameterStatusListT&& value) {
    ...
    m_clusterParameterStatusList = std::forward<ClusterParameterStatusListT>(value);
  }
  template <typename ClusterParameterStatusListT = Aws::Vector<ClusterParameterStatus>>
  ClusterParameterGroupStatus& WithClusterParameterStatusList(ClusterParameterStatusListT&& value) {
    SetClusterParameterStatusList(std::forward<ClusterParameterStatusListT>(value));
    return *this;
  }
  ...
  ClusterParameterGroupStatus& AddClusterParameterStatusList(ClusterParameterStatusListT&& value) {
    m_clusterParameterStatusListHasBeenSet = true;
    m_clusterParameterStatusList.emplace_back(std::forward<ClusterParameterStatusListT>(value));
    return *this;
  }
  ///@}
 private:
