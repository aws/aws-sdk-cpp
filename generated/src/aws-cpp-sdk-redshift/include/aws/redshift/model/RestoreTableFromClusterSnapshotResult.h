...
class RestoreTableFromClusterSnapshotResult {
 public:
  ...
  AWS_REDSHIFT_API RestoreTableFromClusterSnapshotResult& operator=(
  ...
  template <typename TableRestoreStatusT = TableRestoreStatus>
  RestoreTableFromClusterSnapshotResult& WithTableRestoreStatus(TableRestoreStatusT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RestoreTableFromClusterSnapshotResult& WithResponseMetadata(ResponseMetadataT&& value) {
