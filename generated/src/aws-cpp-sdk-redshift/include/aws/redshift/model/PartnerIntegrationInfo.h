...
class PartnerIntegrationInfo {
 public:
  ...
  template <typename DatabaseNameT = Aws::String>
  PartnerIntegrationInfo& WithDatabaseName(DatabaseNameT&& value) {
  ...
  template <typename PartnerNameT = Aws::String>
  PartnerIntegrationInfo& WithPartnerName(PartnerNameT&& value) {
  ...
  inline PartnerIntegrationInfo& WithStatus(PartnerIntegrationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  PartnerIntegrationInfo& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  PartnerIntegrationInfo& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  PartnerIntegrationInfo& WithUpdatedAt(UpdatedAtT&& value) {
