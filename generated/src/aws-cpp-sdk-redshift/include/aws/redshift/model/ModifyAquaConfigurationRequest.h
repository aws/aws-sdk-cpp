...
class ModifyAquaConfigurationRequest : public RedshiftRequest {
 ...
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  ModifyAquaConfigurationRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
  ...
  inline ModifyAquaConfigurationRequest& WithAquaConfigurationStatus(AquaConfigurationStatus value) {
