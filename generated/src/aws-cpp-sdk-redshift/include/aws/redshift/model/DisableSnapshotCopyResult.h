...
namespace Model
{
  ...
  {
  public:
    AWS_REDSHIFT_API DisableSnapshotCopyResult() = default;
    ...
    template<typename ClusterT = Cluster>
    DisableSnapshotCopyResult& WithCluster(ClusterT&& value) { SetCluster(std::forward<ClusterT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisableSnapshotCopyResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
