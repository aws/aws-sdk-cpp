...
class ClusterAssociatedToSchedule {
 public:
  ...
  inline void SetScheduleAssociationState(ScheduleState value) {
    m_scheduleAssociationStateHasBeenSet = true;
    m_scheduleAssociationState = value;
  }
  inline ClusterAssociatedToSchedule& WithScheduleAssociationState(ScheduleState value) {
    SetScheduleAssociationState(value);
    return *this;
  }
  ///@}
 private:
