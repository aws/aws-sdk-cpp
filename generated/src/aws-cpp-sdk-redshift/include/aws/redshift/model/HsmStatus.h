...
class HsmStatus {
 public:
  ...
  template <typename HsmClientCertificateIdentifierT = Aws::String>
  HsmStatus& WithHsmClientCertificateIdentifier(HsmClientCertificateIdentifierT&& value) {
  ...
  template <typename HsmConfigurationIdentifierT = Aws::String>
  HsmStatus& WithHsmConfigurationIdentifier(HsmConfigurationIdentifierT&& value) {
  ...
  template <typename StatusT = Aws::String>
  HsmStatus& WithStatus(StatusT&& value) {
