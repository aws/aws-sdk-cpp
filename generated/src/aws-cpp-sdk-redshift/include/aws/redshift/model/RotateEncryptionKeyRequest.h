 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/RotateEncryptionKeyMessage">AWS
 * API Reference</a></p>
 */
class RotateEncryptionKeyRequest : public RedshiftRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "RotateEncryptionKey"; }
 ...
 public:
  ...
  template <typename ClusterIdentifierT = Aws::String>
  RotateEncryptionKeyRequest& WithClusterIdentifier(ClusterIdentifierT&& value) {
