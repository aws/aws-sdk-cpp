...
class MaintenanceTrack {
 public:
  ...
  template <typename MaintenanceTrackNameT = Aws::String>
  MaintenanceTrack& WithMaintenanceTrackName(MaintenanceTrackNameT&& value) {
  ...
  template <typename DatabaseVersionT = Aws::String>
  MaintenanceTrack& WithDatabaseVersion(DatabaseVersionT&& value) {
  ...
  void SetUpdateTargets(UpdateTargetsT&& value) {
    ...
    m_updateTargets = std::forward<UpdateTargetsT>(value);
  }
  template <typename UpdateTargetsT = Aws::Vector<UpdateTarget>>
  MaintenanceTrack& WithUpdateTargets(UpdateTargetsT&& value) {
    SetUpdateTargets(std::forward<UpdateTargetsT>(value));
    return *this;
  }
  template <typename UpdateTargetsT = UpdateTarget>
  MaintenanceTrack& AddUpdateTargets(UpdateTargetsT&& value) {
    m_updateTargetsHasBeenSet = true;
    m_updateTargets.emplace_back(std::forward<UpdateTargetsT>(value));
    return *this;
  }
  ///@}
 private:
