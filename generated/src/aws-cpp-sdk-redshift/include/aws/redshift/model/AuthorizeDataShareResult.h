...
namespace Model
{
  ...
  public:
    ...
    inline AuthorizeDataShareResult& WithDataShareType(const DataShareType& value) { SetDataShareType(value); return *this;}
    inline AuthorizeDataShareResult& WithDataShareType(DataShareType&& value) { SetDataShareType(std::move(value)); return *this;}
    ///@}
