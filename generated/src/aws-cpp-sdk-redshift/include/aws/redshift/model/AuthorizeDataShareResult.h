...
class AuthorizeDataShareResult {
 public:
  AWS_REDSHIFT_API AuthorizeDataShareResult() = default;
  ...
  template <typename DataShareArnT = Aws::String>
  AuthorizeDataShareResult& WithDataShareArn(DataShareArnT&& value) {
  ...
  template <typename ProducerArnT = Aws::String>
  AuthorizeDataShareResult& WithProducerArn(ProducerArnT&& value) {
  ...
  inline AuthorizeDataShareResult& WithAllowPubliclyAccessibleConsumers(bool value) {
  ...
  template <typename DataShareAssociationsT = Aws::Vector<DataShareAssociation>>
  AuthorizeDataShareResult& WithDataShareAssociations(DataShareAssociationsT&& value) {
  ...
  AuthorizeDataShareResult& AddDataShareAssociations(DataShareAssociationsT&& value) {
    m_dataShareAssociationsHasBeenSet = true;
  ...
  template <typename ManagedByT = Aws::String>
  AuthorizeDataShareResult& WithManagedBy(ManagedByT&& value) {
  ...
  inline AuthorizeDataShareResult& WithDataShareType(DataShareType value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AuthorizeDataShareResult& WithResponseMetadata(ResponseMetadataT&& value) {
