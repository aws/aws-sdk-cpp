...
namespace Model
{
  ...
  public:
    ...
    template<typename DataShareArnT = Aws::String>
    AuthorizeDataShareResult& WithDataShareArn(DataShareArnT&& value) { SetDataShareArn(std::forward<DataShareArnT>(value)); return *this;}
    ///@}
    ...
    template<typename ProducerArnT = Aws::String>
    AuthorizeDataShareResult& WithProducerArn(ProducerArnT&& value) { SetProducerArn(std::forward<ProducerArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DataShareAssociationsT = Aws::Vector<DataShareAssociation>>
    AuthorizeDataShareResult& WithDataShareAssociations(DataShareAssociationsT&& value) { SetDataShareAssociations(std::forward<DataShareAssociationsT>(value)); return *this;}
    template<typename DataShareAssociationsT = DataShareAssociation>
    AuthorizeDataShareResult& AddDataShareAssociations(DataShareAssociationsT&& value) { m_dataShareAssociationsHasBeenSet = true; m_dataShareAssociations.emplace_back(std::forward<DataShareAssociationsT>(value)); return *this; }
    ///@}
    ...
    template<typename ManagedByT = Aws::String>
    AuthorizeDataShareResult& WithManagedBy(ManagedByT&& value) { SetManagedBy(std::forward<ManagedByT>(value)); return *this;}
    ///@}
    ...
    inline AuthorizeDataShareResult& WithDataShareType(DataShareType value) { SetDataShareType(value); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    AuthorizeDataShareResult& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
