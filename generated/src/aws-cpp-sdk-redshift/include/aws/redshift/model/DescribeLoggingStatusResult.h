...
class DescribeLoggingStatusResult {
 public:
  ...
  inline DescribeLoggingStatusResult& WithLoggingEnabled(bool value) {
  ...
  inline DescribeLoggingStatusResult& WithLogDestinationType(LogDestinationType value) {
  ...
  template <typename S3TablesT = S3TablePublishStatus>
  DescribeLoggingStatusResult& WithS3Tables(S3TablesT&& value) {
