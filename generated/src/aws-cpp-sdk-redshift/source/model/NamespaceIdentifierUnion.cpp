...
NamespaceIdentifierUnion::NamespaceIdentifierUnion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void NamespaceIdentifierUnion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
