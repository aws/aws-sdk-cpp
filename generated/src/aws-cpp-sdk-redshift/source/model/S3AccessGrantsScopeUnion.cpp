...
S3AccessGrantsScopeUnion::S3AccessGrantsScopeUnion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void S3AccessGrantsScopeUnion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
