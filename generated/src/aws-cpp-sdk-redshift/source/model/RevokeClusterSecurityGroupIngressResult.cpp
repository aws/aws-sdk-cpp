...
RevokeClusterSecurityGroupIngressResult& RevokeClusterSecurityGroupIngressResult::operator=(
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::RevokeClusterSecurityGroupIngressResult",
