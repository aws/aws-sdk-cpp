...
ClusterSecurityGroupMembership::ClusterSecurityGroupMembership(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ClusterSecurityGroupMembership::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
