...
DescribeClusterVersionsResult::DescribeClusterVersionsResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeClusterVersionsResult& DescribeClusterVersionsResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!clusterVersionsNode.IsNull()) {
      ...
      m_clusterVersionsHasBeenSet = !clusterVersionsMember.IsNull();
