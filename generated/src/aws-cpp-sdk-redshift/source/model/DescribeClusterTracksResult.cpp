...
DescribeClusterTracksResult::DescribeClusterTracksResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeClusterTracksResult& DescribeClusterTracksResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!maintenanceTracksNode.IsNull()) {
      ...
      m_maintenanceTracksHasBeenSet = true;
    }
