...
DescribeOrderableClusterOptionsResult& DescribeOrderableClusterOptionsResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!orderableClusterOptionsNode.IsNull()) {
      ...
      m_orderableClusterOptionsHasBeenSet = !orderableClusterOptionsMember.IsNull();
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::DescribeOrderableClusterOptionsResult",
