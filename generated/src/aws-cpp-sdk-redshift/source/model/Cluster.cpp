...
Cluster& Cluster::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!automatedSnapshotRetentionPeriodNode.IsNull()) {
      m_automatedSnapshotRetentionPeriod = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(automatedSnapshotRetentionPeriodNode.GetText()).c_str()).c_str());
    ...
    if (!manualSnapshotRetentionPeriodNode.IsNull()) {
      m_manualSnapshotRetentionPeriod = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(manualSnapshotRetentionPeriodNode.GetText()).c_str()).c_str());
    ...
    if (!allowVersionUpgradeNode.IsNull()) {
      m_allowVersionUpgrade = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(allowVersionUpgradeNode.GetText()).c_str()).c_str());
    ...
    if (!enhancedVpcRoutingNode.IsNull()) {
      m_enhancedVpcRouting = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(enhancedVpcRoutingNode.GetText()).c_str()).c_str());
    ...
    if (!snapshotScheduleStateNode.IsNull()) {
      m_snapshotScheduleState = ScheduleStateMapper::GetScheduleStateForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(snapshotScheduleStateNode.GetText()).c_str()));
    ...
    if (!expectedNextSnapshotScheduleTimeNode.IsNull()) {
      m_expectedNextSnapshotScheduleTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(expectedNextSnapshotScheduleTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!expectedNextSnapshotScheduleTimeStatusNode.IsNull()) {
      m_expectedNextSnapshotScheduleTimeStatus =
          Aws::Utils::Xml::DecodeEscapedXmlText(expectedNextSnapshotScheduleTimeStatusNode.GetText());
    ...
    if (!nextMaintenanceWindowStartTimeNode.IsNull()) {
      m_nextMaintenanceWindowStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(nextMaintenanceWindowStartTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
    ...
    if (!totalStorageCapacityInMegaBytesNode.IsNull()) {
      m_totalStorageCapacityInMegaBytes = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalStorageCapacityInMegaBytesNode.GetText()).c_str()).c_str());
    ...
    if (!customDomainCertificateExpiryDateNode.IsNull()) {
      m_customDomainCertificateExpiryDate = DateTime(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(customDomainCertificateExpiryDateNode.GetText()).c_str()).c_str(),
          Aws::Utils::DateFormat::ISO_8601);
...
void Cluster::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_clusterAvailabilityStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".ClusterAvailabilityStatus=" << StringUtils::URLEncode(m_clusterAvailabilityStatus.c_str()) << "&";
  }
  ...
  if (m_clusterSecurityGroupsHasBeenSet) {
    ...
    for (auto& item : m_clusterSecurityGroups) {
      ...
      clusterSecurityGroupsSs << location << index << locationValue << ".ClusterSecurityGroups.ClusterSecurityGroup."
                              << clusterSecurityGroupsIdx++;
  ...
  if (m_clusterParameterGroupsHasBeenSet) {
    ...
    for (auto& item : m_clusterParameterGroups) {
      ...
      clusterParameterGroupsSs << location << index << locationValue << ".ClusterParameterGroups.ClusterParameterGroup."
                               << clusterParameterGroupsIdx++;
  ...
  if (m_pendingActionsHasBeenSet) {
    ...
    for (auto& item : m_pendingActions) {
      oStream << location << index << locationValue << ".PendingActions.member." << pendingActionsIdx++ << "="
  ...
  if (m_elasticResizeNumberOfNodeOptionsHasBeenSet) {
    oStream << location << index << locationValue
            << ".ElasticResizeNumberOfNodeOptions=" << StringUtils::URLEncode(m_elasticResizeNumberOfNodeOptions.c_str()) << "&";
  }
  ...
  if (m_deferredMaintenanceWindowsHasBeenSet) {
    ...
    for (auto& item : m_deferredMaintenanceWindows) {
      ...
      deferredMaintenanceWindowsSs << location << index << locationValue << ".DeferredMaintenanceWindows.DeferredMaintenanceWindow."
                                   << deferredMaintenanceWindowsIdx++;
  ...
  if (m_snapshotScheduleIdentifierHasBeenSet) {
    oStream << location << index << locationValue
            << ".SnapshotScheduleIdentifier=" << StringUtils::URLEncode(m_snapshotScheduleIdentifier.c_str()) << "&";
  }

  if (m_snapshotScheduleStateHasBeenSet) {
    oStream << location << index << locationValue
            << ".SnapshotScheduleState=" << StringUtils::URLEncode(ScheduleStateMapper::GetNameForScheduleState(m_snapshotScheduleState))
            << "&";
  }

  if (m_expectedNextSnapshotScheduleTimeHasBeenSet) {
    oStream << location << index << locationValue << ".ExpectedNextSnapshotScheduleTime="
            << StringUtils::URLEncode(m_expectedNextSnapshotScheduleTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_expectedNextSnapshotScheduleTimeStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".ExpectedNextSnapshotScheduleTimeStatus=" << StringUtils::URLEncode(m_expectedNextSnapshotScheduleTimeStatus.c_str())
            << "&";
  }

  if (m_nextMaintenanceWindowStartTimeHasBeenSet) {
    oStream << location << index << locationValue << ".NextMaintenanceWindowStartTime="
            << StringUtils::URLEncode(m_nextMaintenanceWindowStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  ...
  if (m_availabilityZoneRelocationStatusHasBeenSet) {
    oStream << location << index << locationValue
            << ".AvailabilityZoneRelocationStatus=" << StringUtils::URLEncode(m_availabilityZoneRelocationStatus.c_str()) << "&";
  }
  ...
  if (m_customDomainCertificateArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".CustomDomainCertificateArn=" << StringUtils::URLEncode(m_customDomainCertificateArn.c_str()) << "&";
  }

  if (m_customDomainCertificateExpiryDateHasBeenSet) {
    oStream << location << index << locationValue << ".CustomDomainCertificateExpiryDate="
            << StringUtils::URLEncode(m_customDomainCertificateExpiryDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }

  if (m_masterPasswordSecretArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".MasterPasswordSecretArn=" << StringUtils::URLEncode(m_masterPasswordSecretArn.c_str()) << "&";
  }

  if (m_masterPasswordSecretKmsKeyIdHasBeenSet) {
    oStream << location << index << locationValue
            << ".MasterPasswordSecretKmsKeyId=" << StringUtils::URLEncode(m_masterPasswordSecretKmsKeyId.c_str()) << "&";
  }
...
void Cluster::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_deferredMaintenanceWindowsHasBeenSet) {
    ...
    for (auto& item : m_deferredMaintenanceWindows) {
      Aws::StringStream deferredMaintenanceWindowsSs;
      deferredMaintenanceWindowsSs << location << ".DeferredMaintenanceWindows.DeferredMaintenanceWindow."
                                   << deferredMaintenanceWindowsIdx++;
      item.OutputToStream(oStream, deferredMaintenanceWindowsSs.str().c_str());
    }
  }
  ...
  if (m_expectedNextSnapshotScheduleTimeHasBeenSet) {
    oStream << location << ".ExpectedNextSnapshotScheduleTime="
            << StringUtils::URLEncode(m_expectedNextSnapshotScheduleTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_expectedNextSnapshotScheduleTimeStatusHasBeenSet) {
    oStream << location
  ...
  if (m_nextMaintenanceWindowStartTimeHasBeenSet) {
    oStream << location << ".NextMaintenanceWindowStartTime="
            << StringUtils::URLEncode(m_nextMaintenanceWindowStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_resizeInfoHasBeenSet) {
  ...
  if (m_customDomainCertificateExpiryDateHasBeenSet) {
    oStream << location << ".CustomDomainCertificateExpiryDate="
            << StringUtils::URLEncode(m_customDomainCertificateExpiryDate.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_masterPasswordSecretArnHasBeenSet) {
