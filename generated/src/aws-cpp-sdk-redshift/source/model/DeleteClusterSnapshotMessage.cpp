...
DeleteClusterSnapshotMessage::DeleteClusterSnapshotMessage(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DeleteClusterSnapshotMessage::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
