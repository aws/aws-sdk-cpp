...
DescribeSnapshotSchedulesResult::DescribeSnapshotSchedulesResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }
...
DescribeSnapshotSchedulesResult& DescribeSnapshotSchedulesResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!snapshotSchedulesNode.IsNull()) {
      ...
      m_snapshotSchedulesHasBeenSet = !snapshotSchedulesMember.IsNull();
      ...
      m_snapshotSchedulesHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::DescribeSnapshotSchedulesResult",
