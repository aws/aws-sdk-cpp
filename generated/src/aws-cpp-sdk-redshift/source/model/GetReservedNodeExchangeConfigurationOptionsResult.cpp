...
GetReservedNodeExchangeConfigurationOptionsResult& GetReservedNodeExchangeConfigurationOptionsResult::operator=(
    const Aws::AmazonWebServiceResult<XmlDocument>& result) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!reservedNodeConfigurationOptionListNode.IsNull()) {
      XmlNode reservedNodeConfigurationOptionListMember =
          reservedNodeConfigurationOptionListNode.FirstChild("ReservedNodeConfigurationOption");
      ...
      m_reservedNodeConfigurationOptionListHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::GetReservedNodeExchangeConfigurationOptionsResult",
