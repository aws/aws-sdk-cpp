...
UsageLimit::UsageLimit(const XmlNode& xmlNode) { *this = xmlNode; }
...
UsageLimit& UsageLimit::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!featureTypeNode.IsNull()) {
      m_featureType = UsageLimitFeatureTypeMapper::GetUsageLimitFeatureTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(featureTypeNode.GetText()).c_str()));
      m_featureTypeHasBeenSet = true;
    }
    XmlNode limitTypeNode = resultNode.FirstChild("LimitType");
    if (!limitTypeNode.IsNull()) {
      m_limitType = UsageLimitLimitTypeMapper::GetUsageLimitLimitTypeForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(limitTypeNode.GetText()).c_str()));
      m_limitTypeHasBeenSet = true;
    }
    XmlNode amountNode = resultNode.FirstChild("Amount");
    if (!amountNode.IsNull()) {
      m_amount =
          StringUtils::ConvertToInt64(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(amountNode.GetText()).c_str()).c_str());
      m_amountHasBeenSet = true;
    }
    XmlNode periodNode = resultNode.FirstChild("Period");
    if (!periodNode.IsNull()) {
      m_period = UsageLimitPeriodMapper::GetUsageLimitPeriodForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(periodNode.GetText()).c_str()));
      m_periodHasBeenSet = true;
    }
    XmlNode breachActionNode = resultNode.FirstChild("BreachAction");
    if (!breachActionNode.IsNull()) {
      m_breachAction = UsageLimitBreachActionMapper::GetUsageLimitBreachActionForName(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(breachActionNode.GetText()).c_str()));
...
void UsageLimit::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_featureTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".FeatureType=" << StringUtils::URLEncode(UsageLimitFeatureTypeMapper::GetNameForUsageLimitFeatureType(m_featureType))
            << "&";
  }

  if (m_limitTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".LimitType=" << StringUtils::URLEncode(UsageLimitLimitTypeMapper::GetNameForUsageLimitLimitType(m_limitType)) << "&";
  }
  ...
  if (m_periodHasBeenSet) {
    oStream << location << index << locationValue
            << ".Period=" << StringUtils::URLEncode(UsageLimitPeriodMapper::GetNameForUsageLimitPeriod(m_period)) << "&";
  }

  if (m_breachActionHasBeenSet) {
    oStream << location << index << locationValue
            << ".BreachAction=" << StringUtils::URLEncode(UsageLimitBreachActionMapper::GetNameForUsageLimitBreachAction(m_breachAction))
            << "&";
  }
