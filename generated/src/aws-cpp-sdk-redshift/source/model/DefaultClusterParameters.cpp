...
DefaultClusterParameters::DefaultClusterParameters(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DefaultClusterParameters::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
