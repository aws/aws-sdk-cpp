...
CreateHsmClientCertificateResult& CreateHsmClientCertificateResult::operator =(const Aws::AmazonWebServiceResult<XmlDocument>& result)
{
  ...
  if (!rootNode.IsNull() && (rootNode.GetName() != "CreateHsmClientCertificateResult"))
  {
  ...
  if(!resultNode.IsNull())
  {
    ...
    if(!hsmClientCertificateNode.IsNull())
    {
      ...
      m_hsmClientCertificateHasBeenSet = true;
    }
  }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::CreateHsmClientCertificateResult", "x-amzn-request-id: " << m_responseMetadata.GetRequestId() );
  }
  return *this;
}
