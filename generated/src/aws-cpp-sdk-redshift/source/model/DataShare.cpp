...
DataShare::DataShare(const XmlNode& xmlNode) { *this = xmlNode; }
...
void DataShare::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_allowPubliclyAccessibleConsumersHasBeenSet) {
    oStream << location << index << locationValue << ".AllowPubliclyAccessibleConsumers=" << std::boolalpha
  ...
  if (m_dataShareTypeHasBeenSet) {
    oStream << location << index << locationValue
            << ".DataShareType=" << StringUtils::URLEncode(DataShareTypeMapper::GetNameForDataShareType(m_dataShareType)) << "&";
  }
