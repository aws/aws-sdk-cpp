...
Snapshot& Snapshot::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!encryptedWithHSMNode.IsNull()) {
      m_encryptedWithHSM = StringUtils::ConvertToBool(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(encryptedWithHSMNode.GetText()).c_str()).c_str());
    ...
    if (!totalBackupSizeInMegaBytesNode.IsNull()) {
      m_totalBackupSizeInMegaBytes = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(totalBackupSizeInMegaBytesNode.GetText()).c_str()).c_str());
    ...
    if (!actualIncrementalBackupSizeInMegaBytesNode.IsNull()) {
      m_actualIncrementalBackupSizeInMegaBytes = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(actualIncrementalBackupSizeInMegaBytesNode.GetText()).c_str()).c_str());
    ...
    if (!backupProgressInMegaBytesNode.IsNull()) {
      m_backupProgressInMegaBytes = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(backupProgressInMegaBytesNode.GetText()).c_str()).c_str());
    ...
    if (!currentBackupRateInMegaBytesPerSecondNode.IsNull()) {
      m_currentBackupRateInMegaBytesPerSecond = StringUtils::ConvertToDouble(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(currentBackupRateInMegaBytesPerSecondNode.GetText()).c_str()).c_str());
    ...
    if (!estimatedSecondsToCompletionNode.IsNull()) {
      m_estimatedSecondsToCompletion = StringUtils::ConvertToInt64(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(estimatedSecondsToCompletionNode.GetText()).c_str()).c_str());
    ...
    if (!manualSnapshotRemainingDaysNode.IsNull()) {
      m_manualSnapshotRemainingDays = StringUtils::ConvertToInt32(
          StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(manualSnapshotRemainingDaysNode.GetText()).c_str()).c_str());
    ...
    if (!snapshotRetentionStartTimeNode.IsNull()) {
      m_snapshotRetentionStartTime =
          DateTime(StringUtils::Trim(Aws::Utils::Xml::DecodeEscapedXmlText(snapshotRetentionStartTimeNode.GetText()).c_str()).c_str(),
                   Aws::Utils::DateFormat::ISO_8601);
...
void Snapshot::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_accountsWithRestoreAccessHasBeenSet) {
    ...
    for (auto& item : m_accountsWithRestoreAccess) {
      ...
      accountsWithRestoreAccessSs << location << index << locationValue << ".AccountsWithRestoreAccess.AccountWithRestoreAccess."
                                  << accountsWithRestoreAccessIdx++;
  ...
  if (m_actualIncrementalBackupSizeInMegaBytesHasBeenSet) {
    oStream << location << index << locationValue
            << ".ActualIncrementalBackupSizeInMegaBytes=" << StringUtils::URLEncode(m_actualIncrementalBackupSizeInMegaBytes) << "&";
  }
  ...
  if (m_currentBackupRateInMegaBytesPerSecondHasBeenSet) {
    oStream << location << index << locationValue
            << ".CurrentBackupRateInMegaBytesPerSecond=" << StringUtils::URLEncode(m_currentBackupRateInMegaBytesPerSecond) << "&";
  }
  ...
  if (m_restorableNodeTypesHasBeenSet) {
    ...
    for (auto& item : m_restorableNodeTypes) {
      oStream << location << index << locationValue << ".RestorableNodeTypes.NodeType." << restorableNodeTypesIdx++ << "="
  ...
  if (m_snapshotRetentionStartTimeHasBeenSet) {
    oStream << location << index << locationValue << ".SnapshotRetentionStartTime="
            << StringUtils::URLEncode(m_snapshotRetentionStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
...
void Snapshot::OutputToStream(Aws::OStream& oStream, const char* location) const {
  ...
  if (m_snapshotRetentionStartTimeHasBeenSet) {
    oStream << location << ".SnapshotRetentionStartTime="
            << StringUtils::URLEncode(m_snapshotRetentionStartTime.ToGmtString(Aws::Utils::DateFormat::ISO_8601).c_str()) << "&";
  }
  if (m_masterPasswordSecretArnHasBeenSet) {
