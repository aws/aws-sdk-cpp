...
PartnerIntegrationInfo::PartnerIntegrationInfo(const XmlNode& xmlNode) { *this = xmlNode; }
...
PartnerIntegrationInfo& PartnerIntegrationInfo::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!statusNode.IsNull()) {
      m_status = PartnerIntegrationStatusMapper::GetPartnerIntegrationStatusForName(
...
void PartnerIntegrationInfo::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_statusHasBeenSet) {
    oStream << location << index << locationValue
            << ".Status=" << StringUtils::URLEncode(PartnerIntegrationStatusMapper::GetNameForPartnerIntegrationStatus(m_status)) << "&";
  }
