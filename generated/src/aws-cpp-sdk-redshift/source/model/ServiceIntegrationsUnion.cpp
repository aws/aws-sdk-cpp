...
ServiceIntegrationsUnion::ServiceIntegrationsUnion(const XmlNode& xmlNode) { *this = xmlNode; }
...
void ServiceIntegrationsUnion::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
