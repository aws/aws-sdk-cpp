...
DescribeRedshiftIdcApplicationsResult& DescribeRedshiftIdcApplicationsResult::operator=(
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!redshiftIdcApplicationsNode.IsNull()) {
      ...
      m_redshiftIdcApplicationsHasBeenSet = true;
    }
  ...
  if (!rootNode.IsNull()) {
    ...
    AWS_LOGSTREAM_DEBUG("Aws::Redshift::Model::DescribeRedshiftIdcApplicationsResult",
