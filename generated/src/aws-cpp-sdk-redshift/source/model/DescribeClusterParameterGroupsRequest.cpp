...
Aws::String DescribeClusterParameterGroupsRequest::SerializePayload() const {
  Aws::StringStream ss;
  ss << "Action=DescribeClusterParameterGroups&";
...
void DescribeClusterParameterGroupsRequest::DumpBodyToUrl(Aws::Http::URI& uri) const { uri.SetQueryString(SerializePayload()); }
