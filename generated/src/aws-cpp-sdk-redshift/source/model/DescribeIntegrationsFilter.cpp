...
DescribeIntegrationsFilter::DescribeIntegrationsFilter(const XmlNode& xmlNode) { *this = xmlNode; }
...
DescribeIntegrationsFilter& DescribeIntegrationsFilter::operator=(const XmlNode& xmlNode) {
  ...
  if (!resultNode.IsNull()) {
    ...
    if (!nameNode.IsNull()) {
      m_name = DescribeIntegrationsFilterNameMapper::GetDescribeIntegrationsFilterNameForName(
...
void DescribeIntegrationsFilter::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index,
                                                const char* locationValue) const {
  if (m_nameHasBeenSet) {
    oStream << location << index << locationValue
            << ".Name=" << StringUtils::URLEncode(DescribeIntegrationsFilterNameMapper::GetNameForDescribeIntegrationsFilterName(m_name))
            << "&";
  }
