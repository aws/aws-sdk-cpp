...
RedshiftIdcApplication::RedshiftIdcApplication(const XmlNode& xmlNode) { *this = xmlNode; }
...
void RedshiftIdcApplication::OutputToStream(Aws::OStream& oStream, const char* location, unsigned index, const char* locationValue) const {
  ...
  if (m_redshiftIdcApplicationNameHasBeenSet) {
    oStream << location << index << locationValue
            << ".RedshiftIdcApplicationName=" << StringUtils::URLEncode(m_redshiftIdcApplicationName.c_str()) << "&";
  }

  if (m_redshiftIdcApplicationArnHasBeenSet) {
    oStream << location << index << locationValue
            << ".RedshiftIdcApplicationArn=" << StringUtils::URLEncode(m_redshiftIdcApplicationArn.c_str()) << "&";
  }
  ...
  if (m_authorizedTokenIssuerListHasBeenSet) {
    ...
    for (auto& item : m_authorizedTokenIssuerList) {
      ...
      authorizedTokenIssuerListSs << location << index << locationValue << ".AuthorizedTokenIssuerList.member."
                                  << authorizedTokenIssuerListIdx++;
  ...
  if (m_ssoTagKeysHasBeenSet) {
    ...
    for (auto& item : m_ssoTagKeys) {
      oStream << location << index << locationValue << ".SsoTagKeys.TagKey." << ssoTagKeysIdx++ << "="
