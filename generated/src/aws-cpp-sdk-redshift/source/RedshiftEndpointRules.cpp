...
namespace Redshift
{
const size_t RedshiftEndpointRules::RulesBlobStrLen = 4142;
const size_t RedshiftEndpointRules::RulesBlobSize = 4143;
...
's','h','i','f','t','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t',
...
'd','s','h','i','f','t','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
':','"','h','t','t','p','s',':','/','/','r','e','d','s','h','i','f','t','.','u','s','-','g','o','v',
...
const char* RedshiftEndpointRules::GetRulesBlob()
{
