...
namespace EC2InstanceConnect
{
   ...
   */
  class AWS_EC2INSTANCECONNECT_API EC2InstanceConnectClient : Aws::Client::ClientWithAsyncTemplateMethods<EC2InstanceConnectClient>,
    smithy::client::AwsSmithyClientT<Aws::EC2InstanceConnect::SERVICE_NAME,
