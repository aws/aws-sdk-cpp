...
class SendSerialConsoleSSHPublicKeyResult {
 public:
  ...
  AWS_EC2INSTANCECONNECT_API SendSerialConsoleSSHPublicKeyResult& operator=(
  ...
  template <typename RequestIdT = Aws::String>
  SendSerialConsoleSSHPublicKeyResult& WithRequestId(RequestIdT&& value) {
  ...
  inline SendSerialConsoleSSHPublicKeyResult& WithSuccess(bool value) {
    SetSuccess(value);
    return *this;
  }
  ///@}
