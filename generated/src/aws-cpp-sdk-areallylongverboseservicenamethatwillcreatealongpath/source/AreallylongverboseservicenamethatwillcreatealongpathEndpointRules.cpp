...
{
const size_t AreallylongverboseservicenamethatwillcreatealongpathEndpointRules::RulesBlobStrLen = 1954;
const size_t AreallylongverboseservicenamethatwillcreatealongpathEndpointRules::RulesBlobSize = 1955;

using RulesBlobT = Aws::Array<const char, AreallylongverboseservicenamethatwillcreatealongpathEndpointRules::RulesBlobSize>;
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','a','r','e','a','l','l','y','l','o','n','g',
'v','e','r','b','o','s','e','s','e','r','v','i','c','e','n','a','m','e','t','h','a','t','w','i','l',
'l','c','r','e','a','t','e','a','l','o','n','g','p','a','t','h','-','f','i','p','s','.','{','P','a',
...
't','p','s',':','/','/','a','r','e','a','l','l','y','l','o','n','g','v','e','r','b','o','s','e','s',
'e','r','v','i','c','e','n','a','m','e','t','h','a','t','w','i','l','l','c','r','e','a','t','e','a',
'l','o','n','g','p','a','t','h','.','{','P','a','r','t','i','t','i','o','n','R','e','s','u','l','t',
...
const char* AreallylongverboseservicenamethatwillcreatealongpathEndpointRules::GetRulesBlob()
{
