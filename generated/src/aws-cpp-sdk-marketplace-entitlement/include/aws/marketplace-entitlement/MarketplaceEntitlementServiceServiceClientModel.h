...
using MarketplaceEntitlementServiceEndpointProviderBase =
    Aws::MarketplaceEntitlementService::Endpoint::MarketplaceEntitlementServiceEndpointProviderBase;
using MarketplaceEntitlementServiceEndpointProvider =
    Aws::MarketplaceEntitlementService::Endpoint::MarketplaceEntitlementServiceEndpointProvider;
...
typedef std::function<void(const MarketplaceEntitlementServiceClient*, const Model::GetEntitlementsRequest&,
                           const Model::GetEntitlementsOutcome&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&)>
    GetEntitlementsResponseReceivedHandler;
