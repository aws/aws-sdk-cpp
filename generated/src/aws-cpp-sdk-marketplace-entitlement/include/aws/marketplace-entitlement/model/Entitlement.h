...
class Entitlement {
 public:
  ...
  AWS_MARKETPLACEENTITLEMENTSERVICE_API Entitlement(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  AWS_MARKETPLACEENTITLEMENTSERVICE_API Entitlement& operator=(const std::shared_ptr<Aws::Crt::Cbor::CborDecoder>& decoder);
  ...
  template <typename ProductCodeT = Aws::String>
  Entitlement& WithProductCode(ProductCodeT&& value) {
  ...
  template <typename DimensionT = Aws::String>
  Entitlement& WithDimension(DimensionT&& value) {
  ...
  template <typename CustomerIdentifierT = Aws::String>
  Entitlement& WithCustomerIdentifier(CustomerIdentifierT&& value) {
  ...
  template <typename CustomerAWSAccountIdT = Aws::String>
  Entitlement& WithCustomerAWSAccountId(CustomerAWSAccountIdT&& value) {
  ...
  template <typename ExpirationDateT = Aws::Utils::DateTime>
  Entitlement& WithExpirationDate(ExpirationDateT&& value) {
