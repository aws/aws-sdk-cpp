...
class EntitlementValue {
 public:
  ...
  inline EntitlementValue& WithDoubleValue(double value) {
  ...
  inline EntitlementValue& WithBooleanValue(bool value) {
  ...
  template <typename StringValueT = Aws::String>
  EntitlementValue& WithStringValue(StringValueT&& value) {
