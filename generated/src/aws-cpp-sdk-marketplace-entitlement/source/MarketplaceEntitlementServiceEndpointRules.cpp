...
{
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobStrLen = 4475;
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobSize = 4476;
...
'"',':','"','h','t','t','p','s',':','/','/','e','n','t','i','t','l','e','m','e','n','t','.','m','a',
