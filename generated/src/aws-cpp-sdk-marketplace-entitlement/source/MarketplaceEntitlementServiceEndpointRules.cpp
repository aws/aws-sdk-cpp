...
{
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobStrLen = 3990;
const size_t MarketplaceEntitlementServiceEndpointRules::RulesBlobSize = 3991;
...
'c','e','.','c','n','-','n','o','r','t','h','w','e','s','t','-','1','.','a','m','a','z','o','n','a',
