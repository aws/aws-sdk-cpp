...
MarketplaceEntitlementServiceClient::MarketplaceEntitlementServiceClient(
    const AWSCredentials& credentials, std::shared_ptr<MarketplaceEntitlementServiceEndpointProviderBase> endpointProvider,
    const MarketplaceEntitlementService::MarketplaceEntitlementServiceClientConfiguration& clientConfiguration)
    : BASECLASS(clientConfiguration,
...
MarketplaceEntitlementServiceClient::~MarketplaceEntitlementServiceClient() { ShutdownSdkClient(this, -1); }
...
void MarketplaceEntitlementServiceClient::init(
    const MarketplaceEntitlementService::MarketplaceEntitlementServiceClientConfiguration& config) {
...
MarketplaceEntitlementServiceClient::InvokeOperationOutcome MarketplaceEntitlementServiceClient::InvokeServiceOperation(
  ...
  return TracingUtils::MakeCallWithTiming<InvokeOperationOutcome>(
      [&]() -> InvokeOperationOutcome {
        ...
        AWS_OPERATION_CHECK_SUCCESS(endpointResolutionOutcome, GetEntitlements, CoreErrors, CoreErrors::ENDPOINT_RESOLUTION_FAILURE,
                                    endpointResolutionOutcome.GetError().GetMessage());
        auto result =
            MakeRequest(request, endpointResolutionOutcome.GetResult(), Aws::Http::HttpMethod::HTTP_POST, Aws::Auth::SIGV4_SIGNER);
        return result.IsSuccess() ? GetEntitlementsOutcome(GetEntitlementsResult(result.GetResultWithOwnership()))
                                  : GetEntitlementsOutcome(result.GetError());
      },
