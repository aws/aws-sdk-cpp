...
namespace Model
{
  ...
  public:
    ...
    template<typename DeletionMessageT = Aws::String>
    DeleteParameterGroupResult& WithDeletionMessage(DeletionMessageT&& value) { SetDeletionMessage(std::forward<DeletionMessageT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteParameterGroupResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
