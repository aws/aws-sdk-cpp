...
class Parameter {
 public:
  ...
  inline void SetParameterType(ParameterType value) {
    m_parameterTypeHasBeenSet = true;
    m_parameterType = value;
  }
  inline Parameter& WithParameterType(ParameterType value) {
  ...
  void SetNodeTypeSpecificValues(NodeTypeSpecificValuesT&& value) {
    ...
    m_nodeTypeSpecificValues = std::forward<NodeTypeSpecificValuesT>(value);
  }
  template <typename NodeTypeSpecificValuesT = Aws::Vector<NodeTypeSpecificValue>>
  Parameter& WithNodeTypeSpecificValues(NodeTypeSpecificValuesT&& value) {
    SetNodeTypeSpecificValues(std::forward<NodeTypeSpecificValuesT>(value));
    return *this;
  }
  ...
  Parameter& AddNodeTypeSpecificValues(NodeTypeSpecificValuesT&& value) {
    m_nodeTypeSpecificValuesHasBeenSet = true;
    m_nodeTypeSpecificValues.emplace_back(std::forward<NodeTypeSpecificValuesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsModifiable(IsModifiable value) {
    m_isModifiableHasBeenSet = true;
    m_isModifiable = value;
  }
  inline Parameter& WithIsModifiable(IsModifiable value) {
  ...
  inline Parameter& WithChangeType(ChangeType value) {
    SetChangeType(value);
    return *this;
  }
  ///@}
