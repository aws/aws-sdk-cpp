...
class DescribeSubnetGroupsRequest : public DAXRequest {
 public:
  ...
  void SetSubnetGroupNames(SubnetGroupNamesT&& value) {
    m_subnetGroupNamesHasBeenSet = true;
    m_subnetGroupNames = std::forward<SubnetGroupNamesT>(value);
  }
  template <typename SubnetGroupNamesT = Aws::Vector<Aws::String>>
  DescribeSubnetGroupsRequest& WithSubnetGroupNames(SubnetGroupNamesT&& value) {
    SetSubnetGroupNames(std::forward<SubnetGroupNamesT>(value));
    return *this;
  }
  template <typename SubnetGroupNamesT = Aws::String>
  DescribeSubnetGroupsRequest& AddSubnetGroupNames(SubnetGroupNamesT&& value) {
    m_subnetGroupNamesHasBeenSet = true;
    m_subnetGroupNames.emplace_back(std::forward<SubnetGroupNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSubnetGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
