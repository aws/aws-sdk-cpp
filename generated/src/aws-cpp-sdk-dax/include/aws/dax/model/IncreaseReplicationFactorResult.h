...
namespace Model
{
  ...
  public:
    ...
    inline IncreaseReplicationFactorResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline IncreaseReplicationFactorResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline IncreaseReplicationFactorResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
