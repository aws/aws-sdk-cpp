...
class DecreaseReplicationFactorRequest : public DAXRequest {
 public:
  ...
  template <typename ClusterNameT = Aws::String>
  DecreaseReplicationFactorRequest& WithClusterName(ClusterNameT&& value) {
  ...
  inline DecreaseReplicationFactorRequest& WithNewReplicationFactor(int value) {
  ...
  template <typename AvailabilityZonesT = Aws::Vector<Aws::String>>
  DecreaseReplicationFactorRequest& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = Aws::String>
  DecreaseReplicationFactorRequest& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  void SetNodeIdsToRemove(NodeIdsToRemoveT&& value) {
    ...
    m_nodeIdsToRemove = std::forward<NodeIdsToRemoveT>(value);
  }
  template <typename NodeIdsToRemoveT = Aws::Vector<Aws::String>>
  DecreaseReplicationFactorRequest& WithNodeIdsToRemove(NodeIdsToRemoveT&& value) {
    SetNodeIdsToRemove(std::forward<NodeIdsToRemoveT>(value));
    return *this;
  }
  template <typename NodeIdsToRemoveT = Aws::String>
  DecreaseReplicationFactorRequest& AddNodeIdsToRemove(NodeIdsToRemoveT&& value) {
    m_nodeIdsToRemoveHasBeenSet = true;
    m_nodeIdsToRemove.emplace_back(std::forward<NodeIdsToRemoveT>(value));
    return *this;
  }
  ///@}
 private:
