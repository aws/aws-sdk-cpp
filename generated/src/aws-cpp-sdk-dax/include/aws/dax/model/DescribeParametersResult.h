...
class DescribeParametersResult {
 public:
  AWS_DAX_API DescribeParametersResult() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeParametersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ParametersT = Aws::Vector<Parameter>>
  DescribeParametersResult& WithParameters(ParametersT&& value) {
    SetParameters(std::forward<ParametersT>(value));
    return *this;
  }
  template <typename ParametersT = Parameter>
  DescribeParametersResult& AddParameters(ParametersT&& value) {
    m_parametersHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeParametersResult& WithRequestId(RequestIdT&& value) {
