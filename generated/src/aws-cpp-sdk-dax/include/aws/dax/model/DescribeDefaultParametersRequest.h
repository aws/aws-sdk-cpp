...
/**
 */
class DescribeDefaultParametersRequest : public DAXRequest {
 public:
  AWS_DAX_API DescribeDefaultParametersRequest() = default;
  ...
  inline DescribeDefaultParametersRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDefaultParametersRequest& WithNextToken(NextTokenT&& value) {
