...
namespace Model
{
  ...
  {
  public:
    AWS_DAX_API UntagResourceResult() = default;
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    UntagResourceResult& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    UntagResourceResult& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
