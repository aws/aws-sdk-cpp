...
class CreateClusterRequest : public DAXRequest {
 public:
  ...
  inline CreateClusterRequest& WithReplicationFactor(int value) {
  ...
  inline CreateClusterRequest& WithClusterEndpointEncryptionType(ClusterEndpointEncryptionType value) {
