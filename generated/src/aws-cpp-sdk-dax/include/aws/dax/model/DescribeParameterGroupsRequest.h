...
class DescribeParameterGroupsRequest : public DAXRequest {
 public:
  ...
  void SetParameterGroupNames(ParameterGroupNamesT&& value) {
    m_parameterGroupNamesHasBeenSet = true;
    m_parameterGroupNames = std::forward<ParameterGroupNamesT>(value);
  }
  template <typename ParameterGroupNamesT = Aws::Vector<Aws::String>>
  DescribeParameterGroupsRequest& WithParameterGroupNames(ParameterGroupNamesT&& value) {
    SetParameterGroupNames(std::forward<ParameterGroupNamesT>(value));
    return *this;
  }
  ...
  DescribeParameterGroupsRequest& AddParameterGroupNames(ParameterGroupNamesT&& value) {
    m_parameterGroupNamesHasBeenSet = true;
    m_parameterGroupNames.emplace_back(std::forward<ParameterGroupNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeParameterGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
