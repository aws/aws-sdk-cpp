...
class ParameterGroupStatus {
 public:
  ...
  void SetNodeIdsToReboot(NodeIdsToRebootT&& value) {
    ...
    m_nodeIdsToReboot = std::forward<NodeIdsToRebootT>(value);
  }
  template <typename NodeIdsToRebootT = Aws::Vector<Aws::String>>
  ParameterGroupStatus& WithNodeIdsToReboot(NodeIdsToRebootT&& value) {
    SetNodeIdsToReboot(std::forward<NodeIdsToRebootT>(value));
    return *this;
  }
  template <typename NodeIdsToRebootT = Aws::String>
  ParameterGroupStatus& AddNodeIdsToReboot(NodeIdsToRebootT&& value) {
    m_nodeIdsToRebootHasBeenSet = true;
    m_nodeIdsToReboot.emplace_back(std::forward<NodeIdsToRebootT>(value));
    return *this;
  }
  ///@}
 private:
