...
namespace Model
{
  ...
  public:
    ...
    inline RebootNodeResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline RebootNodeResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline RebootNodeResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
