...
class Cluster {
 public:
  ...
  inline Cluster& WithTotalNodes(int value) {
    SetTotalNodes(value);
    return *this;
  }
  ///@}
  ...
  inline void SetActiveNodes(int value) {
    m_activeNodesHasBeenSet = true;
    m_activeNodes = value;
  }
  inline Cluster& WithActiveNodes(int value) {
  ...
  void SetClusterDiscoveryEndpoint(ClusterDiscoveryEndpointT&& value) {
    ...
    m_clusterDiscoveryEndpoint = std::forward<ClusterDiscoveryEndpointT>(value);
  }
  template <typename ClusterDiscoveryEndpointT = Endpoint>
  Cluster& WithClusterDiscoveryEndpoint(ClusterDiscoveryEndpointT&& value) {
    SetClusterDiscoveryEndpoint(std::forward<ClusterDiscoveryEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetClusterEndpointEncryptionType(ClusterEndpointEncryptionType value) {
    m_clusterEndpointEncryptionTypeHasBeenSet = true;
    m_clusterEndpointEncryptionType = value;
  }
  inline Cluster& WithClusterEndpointEncryptionType(ClusterEndpointEncryptionType value) {
    SetClusterEndpointEncryptionType(value);
    return *this;
  }
  ///@}
