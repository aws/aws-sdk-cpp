...
class AWS_DAX_API DAXClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  DAXClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<DAXEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * A Callable wrapper for DecreaseReplicationFactor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DecreaseReplicationFactorRequestT = Model::DecreaseReplicationFactorRequest>
  Model::DecreaseReplicationFactorOutcomeCallable DecreaseReplicationFactorCallable(
      const DecreaseReplicationFactorRequestT& request) const {
    return SubmitCallable(&DAXClient::DecreaseReplicationFactor, request);
  }

  /**
   * An Async wrapper for DecreaseReplicationFactor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DecreaseReplicationFactorRequestT = Model::DecreaseReplicationFactorRequest>
  void DecreaseReplicationFactorAsync(const DecreaseReplicationFactorRequestT& request,
                                      const DecreaseReplicationFactorResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeDefaultParametersOutcome DescribeDefaultParameters(
      const Model::DescribeDefaultParametersRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeDefaultParameters that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeDefaultParametersRequestT = Model::DescribeDefaultParametersRequest>
  Model::DescribeDefaultParametersOutcomeCallable DescribeDefaultParametersCallable(
      const DescribeDefaultParametersRequestT& request = {}) const {
    return SubmitCallable(&DAXClient::DescribeDefaultParameters, request);
  }

  /**
   * An Async wrapper for DescribeDefaultParameters that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeDefaultParametersRequestT = Model::DescribeDefaultParametersRequest>
  void DescribeDefaultParametersAsync(const DescribeDefaultParametersResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const DescribeDefaultParametersRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for IncreaseReplicationFactor that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename IncreaseReplicationFactorRequestT = Model::IncreaseReplicationFactorRequest>
  Model::IncreaseReplicationFactorOutcomeCallable IncreaseReplicationFactorCallable(
      const IncreaseReplicationFactorRequestT& request) const {
    return SubmitCallable(&DAXClient::IncreaseReplicationFactor, request);
  }

  /**
   * An Async wrapper for IncreaseReplicationFactor that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename IncreaseReplicationFactorRequestT = Model::IncreaseReplicationFactorRequest>
  void IncreaseReplicationFactorAsync(const IncreaseReplicationFactorRequestT& request,
                                      const IncreaseReplicationFactorResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for RebootNode that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename RebootNodeRequestT = Model::RebootNodeRequest>
  void RebootNodeAsync(const RebootNodeRequestT& request, const RebootNodeResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
