...
namespace LexModelsV2
{
   ...
   * <p/>
   */
  class AWS_LEXMODELSV2_API LexModelsV2Client : Aws::Client::ClientWithAsyncTemplateMethods<LexModelsV2Client>,
    smithy::client::AwsSmithyClientT<Aws::LexModelsV2::SERVICE_NAME,
