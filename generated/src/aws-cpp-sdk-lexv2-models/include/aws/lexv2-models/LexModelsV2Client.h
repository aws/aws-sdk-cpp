...
#include <aws/lexv2-models/LexModelsV2Waiter.h>
#include <aws/lexv2-models/LexModelsV2_EXPORTS.h>

namespace Aws {
namespace LexModelsV2 {
/**
 * <p>This document provides detailed information about the Amazon Lex V2 API
 * actions and their parameters.</p> <p>For information about the IAM access
 * control permissions you need to use this API, see <a
 * href="https://docs.aws.amazon.com/lexv2/latest/dg/security_iam_service-with-iam.html">Identity-based
 * policies for Amazon Lex V2</a>.</p> <p>Amazon Lex V2 Model Building V2
 * operations let you build and manage bots.</p> <p>If you use a custom HTTP client
 * to call Amazon Lex Model Building V2 operations, you must set the "Content-Type"
 * HTTP header to "application/x-amz-json-1.1". Otherwise, you receive an HTTP 404
 * - UnknownOperationException in the response.</p> <p>Amazon Lex Model Building V2
 * operations return the responses with the "application/x-amz-json-1.1" content
 * type.</p> <p>You can use <a href="http://aws.amazon.com/tools/#sdk">Amazon Web
 * Services SDKs</a> to access Amazon Lex V2 APIs using your favorite programming
 * language. The SDKs automatically perform useful tasks for you, such as:</p> <ul>
 * <li> <p>Cryptographically sign your service requests</p> </li> <li> <p>Retry
 * requests</p> </li> <li> <p>Handle error responses</p> </li> </ul> <p>The
 * following resources provide additional information about the Amazon Lex V2 Model
 * Building API.</p> <ul> <li> <p> <i>Amazon Web Services General Reference</i>
 * </p> <ul> <li> <p> <a
 * href="https://docs.aws.amazon.com/general/latest/gr/lex.html">Amazon Lex V2
 * Endpoints for each region</a>.</p> </li> </ul> </li> <li> <p> <i>Command Line
 * Interface</i> </p> <ul> <li> <p> <a
 * href="https://docs.aws.amazon.com/cli/latest/reference/lexv2-models/index.html">
 * Amazon Lex Model Building V2 CLI commands</a>.</p> </li> </ul> </li> </ul>
 */
class AWS_LEXMODELSV2_API LexModelsV2Client : public Aws::Client::AWSJsonClient,
                                              ...
                                              public LexModelsV2Waiter<LexModelsV2Client> {
 public:
   ...
   */
  LexModelsV2Client(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<LexModelsV2EndpointProviderBase> endpointProvider = nullptr,
      const Aws::LexModelsV2::LexModelsV2ClientConfiguration& clientConfiguration = Aws::LexModelsV2::LexModelsV2ClientConfiguration());
  ...
  virtual Model::BatchCreateCustomVocabularyItemOutcome BatchCreateCustomVocabularyItem(
      const Model::BatchCreateCustomVocabularyItemRequest& request) const;

  /**
   * A Callable wrapper for BatchCreateCustomVocabularyItem that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchCreateCustomVocabularyItemRequestT = Model::BatchCreateCustomVocabularyItemRequest>
  Model::BatchCreateCustomVocabularyItemOutcomeCallable BatchCreateCustomVocabularyItemCallable(
      const BatchCreateCustomVocabularyItemRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::BatchCreateCustomVocabularyItem, request);
  }

  /**
   * An Async wrapper for BatchCreateCustomVocabularyItem that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchCreateCustomVocabularyItemRequestT = Model::BatchCreateCustomVocabularyItemRequest>
  void BatchCreateCustomVocabularyItemAsync(const BatchCreateCustomVocabularyItemRequestT& request,
                                            const BatchCreateCustomVocabularyItemResponseReceivedHandler& handler,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteCustomVocabularyItemOutcome BatchDeleteCustomVocabularyItem(
      const Model::BatchDeleteCustomVocabularyItemRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteCustomVocabularyItem that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteCustomVocabularyItemRequestT = Model::BatchDeleteCustomVocabularyItemRequest>
  Model::BatchDeleteCustomVocabularyItemOutcomeCallable BatchDeleteCustomVocabularyItemCallable(
      const BatchDeleteCustomVocabularyItemRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::BatchDeleteCustomVocabularyItem, request);
  }

  /**
   * An Async wrapper for BatchDeleteCustomVocabularyItem that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchDeleteCustomVocabularyItemRequestT = Model::BatchDeleteCustomVocabularyItemRequest>
  void BatchDeleteCustomVocabularyItemAsync(const BatchDeleteCustomVocabularyItemRequestT& request,
                                            const BatchDeleteCustomVocabularyItemResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateCustomVocabularyItemOutcome BatchUpdateCustomVocabularyItem(
      const Model::BatchUpdateCustomVocabularyItemRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateCustomVocabularyItem that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchUpdateCustomVocabularyItemRequestT = Model::BatchUpdateCustomVocabularyItemRequest>
  Model::BatchUpdateCustomVocabularyItemOutcomeCallable BatchUpdateCustomVocabularyItemCallable(
      const BatchUpdateCustomVocabularyItemRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::BatchUpdateCustomVocabularyItem, request);
  }

  /**
   * An Async wrapper for BatchUpdateCustomVocabularyItem that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename BatchUpdateCustomVocabularyItemRequestT = Model::BatchUpdateCustomVocabularyItemRequest>
  void BatchUpdateCustomVocabularyItemAsync(const BatchUpdateCustomVocabularyItemRequestT& request,
                                            const BatchUpdateCustomVocabularyItemResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for BuildBotLocale that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename BuildBotLocaleRequestT = Model::BuildBotLocaleRequest>
  void BuildBotLocaleAsync(const BuildBotLocaleRequestT& request, const BuildBotLocaleResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateBotAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBotAliasRequestT = Model::CreateBotAliasRequest>
  void CreateBotAliasAsync(const CreateBotAliasRequestT& request, const CreateBotAliasResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateBotLocale that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateBotLocaleRequestT = Model::CreateBotLocaleRequest>
  void CreateBotLocaleAsync(const CreateBotLocaleRequestT& request, const CreateBotLocaleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBotReplica that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBotReplica that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBotReplicaRequestT = Model::CreateBotReplicaRequest>
  void CreateBotReplicaAsync(const CreateBotReplicaRequestT& request, const CreateBotReplicaResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateBotVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateBotVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateBotVersionRequestT = Model::CreateBotVersionRequest>
  void CreateBotVersionAsync(const CreateBotVersionRequestT& request, const CreateBotVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateIntentRequestT = Model::CreateIntentRequest>
  void CreateIntentAsync(const CreateIntentRequestT& request, const CreateIntentResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateResourcePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateResourcePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourcePolicyRequestT = Model::CreateResourcePolicyRequest>
  void CreateResourcePolicyAsync(const CreateResourcePolicyRequestT& request, const CreateResourcePolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateResourcePolicyStatementOutcome CreateResourcePolicyStatement(
      const Model::CreateResourcePolicyStatementRequest& request) const;

  /**
   * A Callable wrapper for CreateResourcePolicyStatement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateResourcePolicyStatementRequestT = Model::CreateResourcePolicyStatementRequest>
  Model::CreateResourcePolicyStatementOutcomeCallable CreateResourcePolicyStatementCallable(
      const CreateResourcePolicyStatementRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::CreateResourcePolicyStatement, request);
  }

  /**
   * An Async wrapper for CreateResourcePolicyStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateResourcePolicyStatementRequestT = Model::CreateResourcePolicyStatementRequest>
  void CreateResourcePolicyStatementAsync(const CreateResourcePolicyStatementRequestT& request,
                                          const CreateResourcePolicyStatementResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSlot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSlotRequestT = Model::CreateSlotRequest>
  void CreateSlotAsync(const CreateSlotRequestT& request, const CreateSlotResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateSlotType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSlotTypeRequestT = Model::CreateSlotTypeRequest>
  void CreateSlotTypeAsync(const CreateSlotTypeRequestT& request, const CreateSlotTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateTestSetDiscrepancyReportOutcome CreateTestSetDiscrepancyReport(
      const Model::CreateTestSetDiscrepancyReportRequest& request) const;

  /**
   * A Callable wrapper for CreateTestSetDiscrepancyReport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateTestSetDiscrepancyReportRequestT = Model::CreateTestSetDiscrepancyReportRequest>
  Model::CreateTestSetDiscrepancyReportOutcomeCallable CreateTestSetDiscrepancyReportCallable(
      const CreateTestSetDiscrepancyReportRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::CreateTestSetDiscrepancyReport, request);
  }

  /**
   * An Async wrapper for CreateTestSetDiscrepancyReport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateTestSetDiscrepancyReportRequestT = Model::CreateTestSetDiscrepancyReportRequest>
  void CreateTestSetDiscrepancyReportAsync(const CreateTestSetDiscrepancyReportRequestT& request,
                                           const CreateTestSetDiscrepancyReportResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateUploadUrl that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateUploadUrlRequestT = Model::CreateUploadUrlRequest>
  void CreateUploadUrlAsync(const CreateUploadUrlResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                            const CreateUploadUrlRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for DeleteBotAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBotAliasRequestT = Model::DeleteBotAliasRequest>
  void DeleteBotAliasAsync(const DeleteBotAliasRequestT& request, const DeleteBotAliasResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteBotLocale that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteBotLocaleRequestT = Model::DeleteBotLocaleRequest>
  void DeleteBotLocaleAsync(const DeleteBotLocaleRequestT& request, const DeleteBotLocaleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBotReplica that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBotReplica that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBotReplicaRequestT = Model::DeleteBotReplicaRequest>
  void DeleteBotReplicaAsync(const DeleteBotReplicaRequestT& request, const DeleteBotReplicaResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteBotVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteBotVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteBotVersionRequestT = Model::DeleteBotVersionRequest>
  void DeleteBotVersionAsync(const DeleteBotVersionRequestT& request, const DeleteBotVersionResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteCustomVocabulary that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteCustomVocabulary that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteCustomVocabularyRequestT = Model::DeleteCustomVocabularyRequest>
  void DeleteCustomVocabularyAsync(const DeleteCustomVocabularyRequestT& request,
                                   const DeleteCustomVocabularyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteImport that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteImportRequestT = Model::DeleteImportRequest>
  void DeleteImportAsync(const DeleteImportRequestT& request, const DeleteImportResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteIntentRequestT = Model::DeleteIntentRequest>
  void DeleteIntentAsync(const DeleteIntentRequestT& request, const DeleteIntentResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteResourcePolicyStatementOutcome DeleteResourcePolicyStatement(
      const Model::DeleteResourcePolicyStatementRequest& request) const;

  /**
   * A Callable wrapper for DeleteResourcePolicyStatement that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteResourcePolicyStatementRequestT = Model::DeleteResourcePolicyStatementRequest>
  Model::DeleteResourcePolicyStatementOutcomeCallable DeleteResourcePolicyStatementCallable(
      const DeleteResourcePolicyStatementRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DeleteResourcePolicyStatement, request);
  }

  /**
   * An Async wrapper for DeleteResourcePolicyStatement that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteResourcePolicyStatementRequestT = Model::DeleteResourcePolicyStatementRequest>
  void DeleteResourcePolicyStatementAsync(const DeleteResourcePolicyStatementRequestT& request,
                                          const DeleteResourcePolicyStatementResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSlot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSlotRequestT = Model::DeleteSlotRequest>
  void DeleteSlotAsync(const DeleteSlotRequestT& request, const DeleteSlotResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteSlotType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSlotTypeRequestT = Model::DeleteSlotTypeRequest>
  void DeleteSlotTypeAsync(const DeleteSlotTypeRequestT& request, const DeleteSlotTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteTestSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteTestSetRequestT = Model::DeleteTestSetRequest>
  void DeleteTestSetAsync(const DeleteTestSetRequestT& request, const DeleteTestSetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteUtterances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteUtterances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteUtterancesRequestT = Model::DeleteUtterancesRequest>
  void DeleteUtterancesAsync(const DeleteUtterancesRequestT& request, const DeleteUtterancesResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeBot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeBotRequestT = Model::DescribeBotRequest>
  void DescribeBotAsync(const DescribeBotRequestT& request, const DescribeBotResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBotAlias that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBotAlias that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBotAliasRequestT = Model::DescribeBotAliasRequest>
  ...
  /**
   * A Callable wrapper for DescribeBotLocale that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBotLocale that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBotLocaleRequestT = Model::DescribeBotLocaleRequest>
  void DescribeBotLocaleAsync(const DescribeBotLocaleRequestT& request, const DescribeBotLocaleResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBotRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeBotRecommendationRequestT = Model::DescribeBotRecommendationRequest>
  Model::DescribeBotRecommendationOutcomeCallable DescribeBotRecommendationCallable(
      const DescribeBotRecommendationRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DescribeBotRecommendation, request);
  }

  /**
   * An Async wrapper for DescribeBotRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBotRecommendationRequestT = Model::DescribeBotRecommendationRequest>
  void DescribeBotRecommendationAsync(const DescribeBotRecommendationRequestT& request,
                                      const DescribeBotRecommendationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBotReplica that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBotReplica that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBotReplicaRequestT = Model::DescribeBotReplicaRequest>
  void DescribeBotReplicaAsync(const DescribeBotReplicaRequestT& request, const DescribeBotReplicaResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeBotResourceGenerationOutcome DescribeBotResourceGeneration(
      const Model::DescribeBotResourceGenerationRequest& request) const;

  /**
   * A Callable wrapper for DescribeBotResourceGeneration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeBotResourceGenerationRequestT = Model::DescribeBotResourceGenerationRequest>
  Model::DescribeBotResourceGenerationOutcomeCallable DescribeBotResourceGenerationCallable(
      const DescribeBotResourceGenerationRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DescribeBotResourceGeneration, request);
  }

  /**
   * An Async wrapper for DescribeBotResourceGeneration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBotResourceGenerationRequestT = Model::DescribeBotResourceGenerationRequest>
  void DescribeBotResourceGenerationAsync(const DescribeBotResourceGenerationRequestT& request,
                                          const DescribeBotResourceGenerationResponseReceivedHandler& handler,
                                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeBotVersion that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBotVersion that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeBotVersionRequestT = Model::DescribeBotVersionRequest>
  void DescribeBotVersionAsync(const DescribeBotVersionRequestT& request, const DescribeBotVersionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::DescribeCustomVocabularyMetadataOutcome DescribeCustomVocabularyMetadata(
      const Model::DescribeCustomVocabularyMetadataRequest& request) const;

  /**
   * A Callable wrapper for DescribeCustomVocabularyMetadata that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeCustomVocabularyMetadataRequestT = Model::DescribeCustomVocabularyMetadataRequest>
  Model::DescribeCustomVocabularyMetadataOutcomeCallable DescribeCustomVocabularyMetadataCallable(
      const DescribeCustomVocabularyMetadataRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DescribeCustomVocabularyMetadata, request);
  }

  /**
   * An Async wrapper for DescribeCustomVocabularyMetadata that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeCustomVocabularyMetadataRequestT = Model::DescribeCustomVocabularyMetadataRequest>
  void DescribeCustomVocabularyMetadataAsync(const DescribeCustomVocabularyMetadataRequestT& request,
                                             const DescribeCustomVocabularyMetadataResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeExport that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeExportRequestT = Model::DescribeExportRequest>
  void DescribeExportAsync(const DescribeExportRequestT& request, const DescribeExportResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeImport that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeImportRequestT = Model::DescribeImportRequest>
  void DescribeImportAsync(const DescribeImportRequestT& request, const DescribeImportResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeIntentRequestT = Model::DescribeIntentRequest>
  void DescribeIntentAsync(const DescribeIntentRequestT& request, const DescribeIntentResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeSlot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeSlotRequestT = Model::DescribeSlotRequest>
  void DescribeSlotAsync(const DescribeSlotRequestT& request, const DescribeSlotResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeSlotType that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSlotType that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeSlotTypeRequestT = Model::DescribeSlotTypeRequest>
  void DescribeSlotTypeAsync(const DescribeSlotTypeRequestT& request, const DescribeSlotTypeResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTestExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeTestExecution that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTestExecutionRequestT = Model::DescribeTestExecutionRequest>
  void DescribeTestExecutionAsync(const DescribeTestExecutionRequestT& request, const DescribeTestExecutionResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DescribeTestSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DescribeTestSetRequestT = Model::DescribeTestSetRequest>
  void DescribeTestSetAsync(const DescribeTestSetRequestT& request, const DescribeTestSetResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeTestSetDiscrepancyReportOutcome DescribeTestSetDiscrepancyReport(
      const Model::DescribeTestSetDiscrepancyReportRequest& request) const;

  /**
   * A Callable wrapper for DescribeTestSetDiscrepancyReport that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeTestSetDiscrepancyReportRequestT = Model::DescribeTestSetDiscrepancyReportRequest>
  Model::DescribeTestSetDiscrepancyReportOutcomeCallable DescribeTestSetDiscrepancyReportCallable(
      const DescribeTestSetDiscrepancyReportRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DescribeTestSetDiscrepancyReport, request);
  }

  /**
   * An Async wrapper for DescribeTestSetDiscrepancyReport that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeTestSetDiscrepancyReportRequestT = Model::DescribeTestSetDiscrepancyReportRequest>
  void DescribeTestSetDiscrepancyReportAsync(const DescribeTestSetDiscrepancyReportRequestT& request,
                                             const DescribeTestSetDiscrepancyReportResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeTestSetGeneration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeTestSetGenerationRequestT = Model::DescribeTestSetGenerationRequest>
  Model::DescribeTestSetGenerationOutcomeCallable DescribeTestSetGenerationCallable(
      const DescribeTestSetGenerationRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::DescribeTestSetGeneration, request);
  }

  /**
   * An Async wrapper for DescribeTestSetGeneration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeTestSetGenerationRequestT = Model::DescribeTestSetGenerationRequest>
  void DescribeTestSetGenerationAsync(const DescribeTestSetGenerationRequestT& request,
                                      const DescribeTestSetGenerationResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GenerateBotElement that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GenerateBotElement that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GenerateBotElementRequestT = Model::GenerateBotElementRequest>
  void GenerateBotElementAsync(const GenerateBotElementRequestT& request, const GenerateBotElementResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetTestExecutionArtifactsUrlOutcome GetTestExecutionArtifactsUrl(
      const Model::GetTestExecutionArtifactsUrlRequest& request) const;

  /**
   * A Callable wrapper for GetTestExecutionArtifactsUrl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetTestExecutionArtifactsUrlRequestT = Model::GetTestExecutionArtifactsUrlRequest>
  Model::GetTestExecutionArtifactsUrlOutcomeCallable GetTestExecutionArtifactsUrlCallable(
      const GetTestExecutionArtifactsUrlRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::GetTestExecutionArtifactsUrl, request);
  }

  /**
   * An Async wrapper for GetTestExecutionArtifactsUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetTestExecutionArtifactsUrlRequestT = Model::GetTestExecutionArtifactsUrlRequest>
  void GetTestExecutionArtifactsUrlAsync(const GetTestExecutionArtifactsUrlRequestT& request,
                                         const GetTestExecutionArtifactsUrlResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAggregatedUtterances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAggregatedUtterances that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAggregatedUtterancesRequestT = Model::ListAggregatedUtterancesRequest>
  void ListAggregatedUtterancesAsync(const ListAggregatedUtterancesRequestT& request,
                                     const ListAggregatedUtterancesResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBotAliasReplicas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBotAliasReplicas that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBotAliasReplicasRequestT = Model::ListBotAliasReplicasRequest>
  void ListBotAliasReplicasAsync(const ListBotAliasReplicasRequestT& request, const ListBotAliasReplicasResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListBotAliases that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBotAliasesRequestT = Model::ListBotAliasesRequest>
  ...
  /**
   * An Async wrapper for ListBotLocales that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBotLocalesRequestT = Model::ListBotLocalesRequest>
  void ListBotLocalesAsync(const ListBotLocalesRequestT& request, const ListBotLocalesResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBotRecommendations that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBotRecommendations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBotRecommendationsRequestT = Model::ListBotRecommendationsRequest>
  void ListBotRecommendationsAsync(const ListBotRecommendationsRequestT& request,
                                   const ListBotRecommendationsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListBotReplicas that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBotReplicasRequestT = Model::ListBotReplicasRequest>
  void ListBotReplicasAsync(const ListBotReplicasRequestT& request, const ListBotReplicasResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBotResourceGenerationsOutcome ListBotResourceGenerations(
      const Model::ListBotResourceGenerationsRequest& request) const;

  /**
   * A Callable wrapper for ListBotResourceGenerations that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListBotResourceGenerationsRequestT = Model::ListBotResourceGenerationsRequest>
  Model::ListBotResourceGenerationsOutcomeCallable ListBotResourceGenerationsCallable(
      const ListBotResourceGenerationsRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::ListBotResourceGenerations, request);
  }

  /**
   * An Async wrapper for ListBotResourceGenerations that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBotResourceGenerationsRequestT = Model::ListBotResourceGenerationsRequest>
  void ListBotResourceGenerationsAsync(const ListBotResourceGenerationsRequestT& request,
                                       const ListBotResourceGenerationsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBotVersionReplicas that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBotVersionReplicas that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBotVersionReplicasRequestT = Model::ListBotVersionReplicasRequest>
  void ListBotVersionReplicasAsync(const ListBotVersionReplicasRequestT& request,
                                   const ListBotVersionReplicasResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListBotVersions that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListBotVersionsRequestT = Model::ListBotVersionsRequest>
  void ListBotVersionsAsync(const ListBotVersionsRequestT& request, const ListBotVersionsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListBotsRequestT = Model::ListBotsRequest>
  void ListBotsAsync(const ListBotsResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                     const ListBotsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListBuiltInIntents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBuiltInIntents that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListBuiltInIntentsRequestT = Model::ListBuiltInIntentsRequest>
  void ListBuiltInIntentsAsync(const ListBuiltInIntentsRequestT& request, const ListBuiltInIntentsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListBuiltInSlotTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListBuiltInSlotTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListBuiltInSlotTypesRequestT = Model::ListBuiltInSlotTypesRequest>
  void ListBuiltInSlotTypesAsync(const ListBuiltInSlotTypesRequestT& request, const ListBuiltInSlotTypesResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListCustomVocabularyItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListCustomVocabularyItemsRequestT = Model::ListCustomVocabularyItemsRequest>
  Model::ListCustomVocabularyItemsOutcomeCallable ListCustomVocabularyItemsCallable(
      const ListCustomVocabularyItemsRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::ListCustomVocabularyItems, request);
  }

  /**
   * An Async wrapper for ListCustomVocabularyItems that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListCustomVocabularyItemsRequestT = Model::ListCustomVocabularyItemsRequest>
  void ListCustomVocabularyItemsAsync(const ListCustomVocabularyItemsRequestT& request,
                                      const ListCustomVocabularyItemsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListIntentMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIntentMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListIntentMetricsRequestT = Model::ListIntentMetricsRequest>
  void ListIntentMetricsAsync(const ListIntentMetricsRequestT& request, const ListIntentMetricsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIntentPaths that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIntentPathsRequestT = Model::ListIntentPathsRequest>
  void ListIntentPathsAsync(const ListIntentPathsRequestT& request, const ListIntentPathsResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListIntentStageMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListIntentStageMetrics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListIntentStageMetricsRequestT = Model::ListIntentStageMetricsRequest>
  void ListIntentStageMetricsAsync(const ListIntentStageMetricsRequestT& request,
                                   const ListIntentStageMetricsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListIntents that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListIntentsRequestT = Model::ListIntentsRequest>
  void ListIntentsAsync(const ListIntentsRequestT& request, const ListIntentsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListRecommendedIntents that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListRecommendedIntents that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListRecommendedIntentsRequestT = Model::ListRecommendedIntentsRequest>
  void ListRecommendedIntentsAsync(const ListRecommendedIntentsRequestT& request,
                                   const ListRecommendedIntentsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSessionAnalyticsData that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSessionAnalyticsData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListSessionAnalyticsDataRequestT = Model::ListSessionAnalyticsDataRequest>
  void ListSessionAnalyticsDataAsync(const ListSessionAnalyticsDataRequestT& request,
                                     const ListSessionAnalyticsDataResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListSessionMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListSessionMetrics that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListSessionMetricsRequestT = Model::ListSessionMetricsRequest>
  void ListSessionMetricsAsync(const ListSessionMetricsRequestT& request, const ListSessionMetricsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSlotTypes that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSlotTypesRequestT = Model::ListSlotTypesRequest>
  void ListSlotTypesAsync(const ListSlotTypesRequestT& request, const ListSlotTypesResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListSlots that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSlotsRequestT = Model::ListSlotsRequest>
  void ListSlotsAsync(const ListSlotsRequestT& request, const ListSlotsResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListTestExecutionResultItemsOutcome ListTestExecutionResultItems(
      const Model::ListTestExecutionResultItemsRequest& request) const;

  /**
   * A Callable wrapper for ListTestExecutionResultItems that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListTestExecutionResultItemsRequestT = Model::ListTestExecutionResultItemsRequest>
  Model::ListTestExecutionResultItemsOutcomeCallable ListTestExecutionResultItemsCallable(
      const ListTestExecutionResultItemsRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::ListTestExecutionResultItems, request);
  }

  /**
   * An Async wrapper for ListTestExecutionResultItems that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListTestExecutionResultItemsRequestT = Model::ListTestExecutionResultItemsRequest>
  void ListTestExecutionResultItemsAsync(const ListTestExecutionResultItemsRequestT& request,
                                         const ListTestExecutionResultItemsResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListTestExecutions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTestExecutions that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTestExecutionsRequestT = Model::ListTestExecutionsRequest>
  void ListTestExecutionsAsync(const ListTestExecutionsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const ListTestExecutionsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListTestSetRecords that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListTestSetRecords that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListTestSetRecordsRequestT = Model::ListTestSetRecordsRequest>
  void ListTestSetRecordsAsync(const ListTestSetRecordsRequestT& request, const ListTestSetRecordsResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for ListTestSets that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListTestSetsRequestT = Model::ListTestSetsRequest>
  void ListTestSetsAsync(const ListTestSetsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const ListTestSetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListUtteranceAnalyticsDataOutcome ListUtteranceAnalyticsData(
      const Model::ListUtteranceAnalyticsDataRequest& request) const;

  /**
   * A Callable wrapper for ListUtteranceAnalyticsData that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListUtteranceAnalyticsDataRequestT = Model::ListUtteranceAnalyticsDataRequest>
  Model::ListUtteranceAnalyticsDataOutcomeCallable ListUtteranceAnalyticsDataCallable(
      const ListUtteranceAnalyticsDataRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::ListUtteranceAnalyticsData, request);
  }

  /**
   * An Async wrapper for ListUtteranceAnalyticsData that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListUtteranceAnalyticsDataRequestT = Model::ListUtteranceAnalyticsDataRequest>
  void ListUtteranceAnalyticsDataAsync(const ListUtteranceAnalyticsDataRequestT& request,
                                       const ListUtteranceAnalyticsDataResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListUtteranceMetrics that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListUtteranceMetrics that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListUtteranceMetricsRequestT = Model::ListUtteranceMetricsRequest>
  void ListUtteranceMetricsAsync(const ListUtteranceMetricsRequestT& request, const ListUtteranceMetricsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::SearchAssociatedTranscriptsOutcome SearchAssociatedTranscripts(
      const Model::SearchAssociatedTranscriptsRequest& request) const;

  /**
   * A Callable wrapper for SearchAssociatedTranscripts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename SearchAssociatedTranscriptsRequestT = Model::SearchAssociatedTranscriptsRequest>
  Model::SearchAssociatedTranscriptsOutcomeCallable SearchAssociatedTranscriptsCallable(
      const SearchAssociatedTranscriptsRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::SearchAssociatedTranscripts, request);
  }

  /**
   * An Async wrapper for SearchAssociatedTranscripts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename SearchAssociatedTranscriptsRequestT = Model::SearchAssociatedTranscriptsRequest>
  void SearchAssociatedTranscriptsAsync(const SearchAssociatedTranscriptsRequestT& request,
                                        const SearchAssociatedTranscriptsResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartBotRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartBotRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartBotRecommendationRequestT = Model::StartBotRecommendationRequest>
  void StartBotRecommendationAsync(const StartBotRecommendationRequestT& request,
                                   const StartBotRecommendationResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartBotResourceGenerationOutcome StartBotResourceGeneration(
      const Model::StartBotResourceGenerationRequest& request) const;

  /**
   * A Callable wrapper for StartBotResourceGeneration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename StartBotResourceGenerationRequestT = Model::StartBotResourceGenerationRequest>
  Model::StartBotResourceGenerationOutcomeCallable StartBotResourceGenerationCallable(
      const StartBotResourceGenerationRequestT& request) const {
    return SubmitCallable(&LexModelsV2Client::StartBotResourceGeneration, request);
  }

  /**
   * An Async wrapper for StartBotResourceGeneration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartBotResourceGenerationRequestT = Model::StartBotResourceGenerationRequest>
  void StartBotResourceGenerationAsync(const StartBotResourceGenerationRequestT& request,
                                       const StartBotResourceGenerationResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTestExecution that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTestExecution that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartTestExecutionRequestT = Model::StartTestExecutionRequest>
  void StartTestExecutionAsync(const StartTestExecutionRequestT& request, const StartTestExecutionResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartTestSetGeneration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartTestSetGeneration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartTestSetGenerationRequestT = Model::StartTestSetGenerationRequest>
  void StartTestSetGenerationAsync(const StartTestSetGenerationRequestT& request,
  ...
  /**
   * A Callable wrapper for StopBotRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StopBotRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StopBotRecommendationRequestT = Model::StopBotRecommendationRequest>
  void StopBotRecommendationAsync(const StopBotRecommendationRequestT& request, const StopBotRecommendationResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateBotAlias that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateBotAliasRequestT = Model::UpdateBotAliasRequest>
  void UpdateBotAliasAsync(const UpdateBotAliasRequestT& request, const UpdateBotAliasResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateBotLocale that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateBotLocaleRequestT = Model::UpdateBotLocaleRequest>
  void UpdateBotLocaleAsync(const UpdateBotLocaleRequestT& request, const UpdateBotLocaleResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateBotRecommendation that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateBotRecommendation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateBotRecommendationRequestT = Model::UpdateBotRecommendationRequest>
  void UpdateBotRecommendationAsync(const UpdateBotRecommendationRequestT& request,
                                    const UpdateBotRecommendationResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateIntent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateIntentRequestT = Model::UpdateIntentRequest>
  void UpdateIntentAsync(const UpdateIntentRequestT& request, const UpdateIntentResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateResourcePolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateResourcePolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateResourcePolicyRequestT = Model::UpdateResourcePolicyRequest>
  void UpdateResourcePolicyAsync(const UpdateResourcePolicyRequestT& request, const UpdateResourcePolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSlot that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSlotRequestT = Model::UpdateSlotRequest>
  void UpdateSlotAsync(const UpdateSlotRequestT& request, const UpdateSlotResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateSlotType that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSlotTypeRequestT = Model::UpdateSlotTypeRequest>
  void UpdateSlotTypeAsync(const UpdateSlotTypeRequestT& request, const UpdateSlotTypeResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateTestSet that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateTestSetRequestT = Model::UpdateTestSetRequest>
  void UpdateTestSetAsync(const UpdateTestSetRequestT& request, const UpdateTestSetResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
