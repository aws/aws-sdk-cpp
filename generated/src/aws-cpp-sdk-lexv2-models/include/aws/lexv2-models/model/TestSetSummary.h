...
class TestSetSummary {
 public:
  AWS_LEXMODELSV2_API TestSetSummary() = default;
  ...
  template <typename TestSetIdT = Aws::String>
  TestSetSummary& WithTestSetId(TestSetIdT&& value) {
  ...
  template <typename TestSetNameT = Aws::String>
  TestSetSummary& WithTestSetName(TestSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  TestSetSummary& WithDescription(DescriptionT&& value) {
  ...
  inline TestSetSummary& WithModality(TestSetModality value) {
    SetModality(value);
    return *this;
  }
  ///@}
  ...
  inline TestSetSummary& WithStatus(TestSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  TestSetSummary& WithRoleArn(RoleArnT&& value) {
  ...
  inline TestSetSummary& WithNumTurns(int value) {
    SetNumTurns(value);
    return *this;
  }
  ///@}
  ...
  template <typename StorageLocationT = TestSetStorageLocation>
  TestSetSummary& WithStorageLocation(StorageLocationT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  TestSetSummary& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  TestSetSummary& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
