...
class DescribeBotRecommendationResult {
 public:
  ...
  inline DescribeBotRecommendationResult& WithBotRecommendationStatus(BotRecommendationStatus value) {
  ...
  void SetBotRecommendationResults(BotRecommendationResultsT&& value) {
    ...
    m_botRecommendationResults = std::forward<BotRecommendationResultsT>(value);
  }
  template <typename BotRecommendationResultsT = BotRecommendationResults>
  DescribeBotRecommendationResult& WithBotRecommendationResults(BotRecommendationResultsT&& value) {
    SetBotRecommendationResults(std::forward<BotRecommendationResultsT>(value));
    return *this;
  }
  ///@}
