...
class BuildtimeSettings {
 public:
  ...
  void SetDescriptiveBotBuilder(DescriptiveBotBuilderT&& value) {
    ...
    m_descriptiveBotBuilder = std::forward<DescriptiveBotBuilderT>(value);
  }
  template <typename DescriptiveBotBuilderT = DescriptiveBotBuilderSpecification>
  BuildtimeSettings& WithDescriptiveBotBuilder(DescriptiveBotBuilderT&& value) {
    SetDescriptiveBotBuilder(std::forward<DescriptiveBotBuilderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSampleUtteranceGeneration(SampleUtteranceGenerationT&& value) {
    ...
    m_sampleUtteranceGeneration = std::forward<SampleUtteranceGenerationT>(value);
  }
  template <typename SampleUtteranceGenerationT = SampleUtteranceGenerationSpecification>
  BuildtimeSettings& WithSampleUtteranceGeneration(SampleUtteranceGenerationT&& value) {
    SetSampleUtteranceGeneration(std::forward<SampleUtteranceGenerationT>(value));
    return *this;
  }
  ///@}
 private:
