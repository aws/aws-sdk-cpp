...
class FulfillmentStartResponseSpecification {
 public:
  ...
  inline void SetDelayInSeconds(int value) {
    m_delayInSecondsHasBeenSet = true;
    m_delayInSeconds = value;
  }
  inline FulfillmentStartResponseSpecification& WithDelayInSeconds(int value) {
  ...
  inline FulfillmentStartResponseSpecification& WithAllowInterrupt(bool value) {
