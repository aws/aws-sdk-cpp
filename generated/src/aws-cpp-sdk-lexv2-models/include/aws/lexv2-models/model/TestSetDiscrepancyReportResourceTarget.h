...
class TestSetDiscrepancyReportResourceTarget {
 public:
  ...
  void SetBotAliasTarget(BotAliasTargetT&& value) {
    ...
    m_botAliasTarget = std::forward<BotAliasTargetT>(value);
  }
  template <typename BotAliasTargetT = TestSetDiscrepancyReportBotAliasTarget>
  TestSetDiscrepancyReportResourceTarget& WithBotAliasTarget(BotAliasTargetT&& value) {
    SetBotAliasTarget(std::forward<BotAliasTargetT>(value));
    return *this;
  }
  ///@}
 private:
