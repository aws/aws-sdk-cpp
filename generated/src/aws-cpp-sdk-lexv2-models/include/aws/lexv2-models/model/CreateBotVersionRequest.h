...
class CreateBotVersionRequest : public LexModelsV2Request {
 public:
   ...
   */
  inline const Aws::Map<Aws::String, BotVersionLocaleDetails>& GetBotVersionLocaleSpecification() const {
    return m_botVersionLocaleSpecification;
  }
  ...
  void SetBotVersionLocaleSpecification(BotVersionLocaleSpecificationT&& value) {
    ...
    m_botVersionLocaleSpecification = std::forward<BotVersionLocaleSpecificationT>(value);
  }
  template <typename BotVersionLocaleSpecificationT = Aws::Map<Aws::String, BotVersionLocaleDetails>>
  CreateBotVersionRequest& WithBotVersionLocaleSpecification(BotVersionLocaleSpecificationT&& value) {
    SetBotVersionLocaleSpecification(std::forward<BotVersionLocaleSpecificationT>(value));
    return *this;
  }
  template <typename BotVersionLocaleSpecificationKeyT = Aws::String,
            typename BotVersionLocaleSpecificationValueT = BotVersionLocaleDetails>
  CreateBotVersionRequest& AddBotVersionLocaleSpecification(BotVersionLocaleSpecificationKeyT&& key,
                                                            BotVersionLocaleSpecificationValueT&& value) {
    m_botVersionLocaleSpecificationHasBeenSet = true;
    m_botVersionLocaleSpecification.emplace(std::forward<BotVersionLocaleSpecificationKeyT>(key),
                                            std::forward<BotVersionLocaleSpecificationValueT>(value));
    return *this;
  }
  ///@}
 private:
