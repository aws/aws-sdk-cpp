...
class CreateResourcePolicyResult {
 public:
  ...
  template <typename ResourceArnT = Aws::String>
  CreateResourcePolicyResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateResourcePolicyResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResourcePolicyResult& WithRequestId(RequestIdT&& value) {
