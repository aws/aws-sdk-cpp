...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API CreateResourcePolicyResult() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    CreateResourcePolicyResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    CreateResourcePolicyResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    CreateResourcePolicyResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
