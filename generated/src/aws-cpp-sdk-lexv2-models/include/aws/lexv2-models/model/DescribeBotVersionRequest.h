...
namespace Model
{
  ...
  public:
    ...
    template<typename BotIdT = Aws::String>
    DescribeBotVersionRequest& WithBotId(BotIdT&& value) { SetBotId(std::forward<BotIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BotVersionT = Aws::String>
    DescribeBotVersionRequest& WithBotVersion(BotVersionT&& value) { SetBotVersion(std::forward<BotVersionT>(value)); return *this;}
    ///@}
  private:
