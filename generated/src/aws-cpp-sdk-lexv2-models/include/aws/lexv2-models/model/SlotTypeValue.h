...
class SlotTypeValue {
 public:
  ...
  void SetSampleValue(SampleValueT&& value) {
    m_sampleValueHasBeenSet = true;
    m_sampleValue = std::forward<SampleValueT>(value);
  }
  template <typename SampleValueT = SampleValue>
  SlotTypeValue& WithSampleValue(SampleValueT&& value) {
    SetSampleValue(std::forward<SampleValueT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SynonymsT = Aws::Vector<SampleValue>>
  SlotTypeValue& WithSynonyms(SynonymsT&& value) {
    SetSynonyms(std::forward<SynonymsT>(value));
    return *this;
  }
  template <typename SynonymsT = SampleValue>
  SlotTypeValue& AddSynonyms(SynonymsT&& value) {
    m_synonymsHasBeenSet = true;
