...
class AnalyticsSessionMetricResult {
 public:
  ...
  inline void SetName(AnalyticsSessionMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsSessionMetricResult& WithName(AnalyticsSessionMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsSessionMetricResult& WithStatistic(AnalyticsMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsSessionMetricResult& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
