...
class ConditionalSpecification {
 public:
  ...
  inline ConditionalSpecification& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  void SetConditionalBranches(ConditionalBranchesT&& value) {
    ...
    m_conditionalBranches = std::forward<ConditionalBranchesT>(value);
  }
  template <typename ConditionalBranchesT = Aws::Vector<ConditionalBranch>>
  ConditionalSpecification& WithConditionalBranches(ConditionalBranchesT&& value) {
    SetConditionalBranches(std::forward<ConditionalBranchesT>(value));
    return *this;
  }
  ...
  ConditionalSpecification& AddConditionalBranches(ConditionalBranchesT&& value) {
    m_conditionalBranchesHasBeenSet = true;
    m_conditionalBranches.emplace_back(std::forward<ConditionalBranchesT>(value));
    return *this;
  }
  ///@}
