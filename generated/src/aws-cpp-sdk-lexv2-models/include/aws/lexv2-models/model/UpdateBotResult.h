...
class UpdateBotResult {
 public:
  ...
  inline UpdateBotResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline UpdateBotResult& WithBotStatus(BotStatus value) {
    SetBotStatus(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBotResult& WithBotType(BotType value) {
    SetBotType(value);
    return *this;
  }
  ///@}
