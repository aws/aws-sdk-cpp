...
class TestSetSortBy {
 public:
  ...
  inline void SetAttribute(TestSetSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline TestSetSortBy& WithAttribute(TestSetSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline TestSetSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
