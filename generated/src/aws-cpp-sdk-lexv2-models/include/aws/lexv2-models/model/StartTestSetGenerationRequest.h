...
class StartTestSetGenerationRequest : public LexModelsV2Request {
 public:
  ...
  template <typename TestSetNameT = Aws::String>
  StartTestSetGenerationRequest& WithTestSetName(TestSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  StartTestSetGenerationRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename StorageLocationT = TestSetStorageLocation>
  StartTestSetGenerationRequest& WithStorageLocation(StorageLocationT&& value) {
  ...
  template <typename GenerationDataSourceT = TestSetGenerationDataSource>
  StartTestSetGenerationRequest& WithGenerationDataSource(GenerationDataSourceT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  StartTestSetGenerationRequest& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename TestSetTagsT = Aws::Map<Aws::String, Aws::String>>
  StartTestSetGenerationRequest& WithTestSetTags(TestSetTagsT&& value) {
