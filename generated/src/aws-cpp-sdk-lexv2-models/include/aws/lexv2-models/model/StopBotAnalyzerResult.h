...
class StopBotAnalyzerResult {
 public:
  ...
  ///@{
  /**
   * <p>The updated status of the analysis. The status will be <code>Stopping</code>
   * and will eventually transition to <code>Stopped</code>.</p> <p>Valid Values:
  ...
  inline StopBotAnalyzerResult& WithBotAnalyzerStatus(BotAnalyzerStatus value) {
