...
class ListCustomVocabularyItemsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListCustomVocabularyItemsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListCustomVocabularyItemsResult& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListCustomVocabularyItemsResult& WithLocaleId(LocaleIdT&& value) {
  ...
  void SetCustomVocabularyItems(CustomVocabularyItemsT&& value) {
    m_customVocabularyItemsHasBeenSet = true;
    m_customVocabularyItems = std::forward<CustomVocabularyItemsT>(value);
  }
  template <typename CustomVocabularyItemsT = Aws::Vector<CustomVocabularyItem>>
  ListCustomVocabularyItemsResult& WithCustomVocabularyItems(CustomVocabularyItemsT&& value) {
    SetCustomVocabularyItems(std::forward<CustomVocabularyItemsT>(value));
    return *this;
  }
  template <typename CustomVocabularyItemsT = CustomVocabularyItem>
  ListCustomVocabularyItemsResult& AddCustomVocabularyItems(CustomVocabularyItemsT&& value) {
    m_customVocabularyItemsHasBeenSet = true;
    m_customVocabularyItems.emplace_back(std::forward<CustomVocabularyItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomVocabularyItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCustomVocabularyItemsResult& WithRequestId(RequestIdT&& value) {
