...
class ElicitationCodeHookInvocationSetting {
 public:
  ...
  inline void SetEnableCodeHookInvocation(bool value) {
    m_enableCodeHookInvocationHasBeenSet = true;
    m_enableCodeHookInvocation = value;
  }
  inline ElicitationCodeHookInvocationSetting& WithEnableCodeHookInvocation(bool value) {
    SetEnableCodeHookInvocation(value);
    return *this;
  }
  ///@}
  ...
  void SetInvocationLabel(InvocationLabelT&& value) {
    ...
    m_invocationLabel = std::forward<InvocationLabelT>(value);
  }
  template <typename InvocationLabelT = Aws::String>
  ElicitationCodeHookInvocationSetting& WithInvocationLabel(InvocationLabelT&& value) {
    SetInvocationLabel(std::forward<InvocationLabelT>(value));
    return *this;
  }
  ///@}
 private:
