...
class ListUtteranceMetricsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListUtteranceMetricsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsUtteranceResult>>
  ListUtteranceMetricsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsUtteranceResult>
  ListUtteranceMetricsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListUtteranceMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListUtteranceMetricsResult& WithRequestId(RequestIdT&& value) {
