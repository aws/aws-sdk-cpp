...
class ImportResourceSpecification {
 public:
  ...
  void SetBotImportSpecification(BotImportSpecificationT&& value) {
    ...
    m_botImportSpecification = std::forward<BotImportSpecificationT>(value);
  }
  template <typename BotImportSpecificationT = BotImportSpecification>
  ImportResourceSpecification& WithBotImportSpecification(BotImportSpecificationT&& value) {
    SetBotImportSpecification(std::forward<BotImportSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotLocaleImportSpecification(BotLocaleImportSpecificationT&& value) {
    ...
    m_botLocaleImportSpecification = std::forward<BotLocaleImportSpecificationT>(value);
  }
  template <typename BotLocaleImportSpecificationT = BotLocaleImportSpecification>
  ImportResourceSpecification& WithBotLocaleImportSpecification(BotLocaleImportSpecificationT&& value) {
    SetBotLocaleImportSpecification(std::forward<BotLocaleImportSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline const CustomVocabularyImportSpecification& GetCustomVocabularyImportSpecification() const {
    return m_customVocabularyImportSpecification;
  }
  ...
  void SetCustomVocabularyImportSpecification(CustomVocabularyImportSpecificationT&& value) {
    ...
    m_customVocabularyImportSpecification = std::forward<CustomVocabularyImportSpecificationT>(value);
  }
  template <typename CustomVocabularyImportSpecificationT = CustomVocabularyImportSpecification>
  ImportResourceSpecification& WithCustomVocabularyImportSpecification(CustomVocabularyImportSpecificationT&& value) {
    SetCustomVocabularyImportSpecification(std::forward<CustomVocabularyImportSpecificationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const TestSetImportResourceSpecification& GetTestSetImportResourceSpecification() const {
    return m_testSetImportResourceSpecification;
  }
  ...
  void SetTestSetImportResourceSpecification(TestSetImportResourceSpecificationT&& value) {
    ...
    m_testSetImportResourceSpecification = std::forward<TestSetImportResourceSpecificationT>(value);
  }
  template <typename TestSetImportResourceSpecificationT = TestSetImportResourceSpecification>
  ImportResourceSpecification& WithTestSetImportResourceSpecification(TestSetImportResourceSpecificationT&& value) {
    SetTestSetImportResourceSpecification(std::forward<TestSetImportResourceSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
