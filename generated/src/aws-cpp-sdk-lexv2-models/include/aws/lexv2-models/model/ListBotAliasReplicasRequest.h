...
class ListBotAliasReplicasRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotAliasReplicasRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  ListBotAliasReplicasRequest& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  inline ListBotAliasReplicasRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotAliasReplicasRequest& WithNextToken(NextTokenT&& value) {
