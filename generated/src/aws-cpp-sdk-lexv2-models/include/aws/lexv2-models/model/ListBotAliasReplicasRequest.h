...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API ListBotAliasReplicasRequest() = default;
    ...
    template<typename BotIdT = Aws::String>
    ListBotAliasReplicasRequest& WithBotId(BotIdT&& value) { SetBotId(std::forward<BotIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ReplicaRegionT = Aws::String>
    ListBotAliasReplicasRequest& WithReplicaRegion(ReplicaRegionT&& value) { SetReplicaRegion(std::forward<ReplicaRegionT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListBotAliasReplicasRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
