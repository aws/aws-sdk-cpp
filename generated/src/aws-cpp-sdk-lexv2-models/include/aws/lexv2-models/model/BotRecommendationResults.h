...
class BotRecommendationResults {
 public:
  ...
  void SetBotLocaleExportUrl(BotLocaleExportUrlT&& value) {
    ...
    m_botLocaleExportUrl = std::forward<BotLocaleExportUrlT>(value);
  }
  template <typename BotLocaleExportUrlT = Aws::String>
  BotRecommendationResults& WithBotLocaleExportUrl(BotLocaleExportUrlT&& value) {
    SetBotLocaleExportUrl(std::forward<BotLocaleExportUrlT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociatedTranscriptsUrl(AssociatedTranscriptsUrlT&& value) {
    ...
    m_associatedTranscriptsUrl = std::forward<AssociatedTranscriptsUrlT>(value);
  }
  template <typename AssociatedTranscriptsUrlT = Aws::String>
  BotRecommendationResults& WithAssociatedTranscriptsUrl(AssociatedTranscriptsUrlT&& value) {
    SetAssociatedTranscriptsUrl(std::forward<AssociatedTranscriptsUrlT>(value));
    return *this;
  }
  ///@}
