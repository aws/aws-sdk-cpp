...
class UpdateTestSetResult {
 public:
  ...
  template <typename TestSetIdT = Aws::String>
  UpdateTestSetResult& WithTestSetId(TestSetIdT&& value) {
  ...
  template <typename TestSetNameT = Aws::String>
  UpdateTestSetResult& WithTestSetName(TestSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateTestSetResult& WithDescription(DescriptionT&& value) {
  ...
  inline void SetModality(TestSetModality value) {
    m_modalityHasBeenSet = true;
    m_modality = value;
  }
  inline UpdateTestSetResult& WithModality(TestSetModality value) {
    SetModality(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(TestSetStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline UpdateTestSetResult& WithStatus(TestSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  UpdateTestSetResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline void SetNumTurns(int value) {
    m_numTurnsHasBeenSet = true;
    m_numTurns = value;
  }
  inline UpdateTestSetResult& WithNumTurns(int value) {
    SetNumTurns(value);
    return *this;
  }
  ///@}
  ...
  void SetStorageLocation(StorageLocationT&& value) {
    ...
    m_storageLocation = std::forward<StorageLocationT>(value);
  }
  template <typename StorageLocationT = TestSetStorageLocation>
  UpdateTestSetResult& WithStorageLocation(StorageLocationT&& value) {
    SetStorageLocation(std::forward<StorageLocationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  UpdateTestSetResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  UpdateTestSetResult& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateTestSetResult& WithRequestId(RequestIdT&& value) {
