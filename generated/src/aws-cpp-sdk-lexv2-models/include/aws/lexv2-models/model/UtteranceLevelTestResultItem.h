...
class UtteranceLevelTestResultItem {
 public:
  ...
  inline UtteranceLevelTestResultItem& WithRecordNumber(long long value) {
  ...
  template <typename ConversationIdT = Aws::String>
  UtteranceLevelTestResultItem& WithConversationId(ConversationIdT&& value) {
  ...
  void SetTurnResult(TurnResultT&& value) {
    m_turnResultHasBeenSet = true;
    m_turnResult = std::forward<TurnResultT>(value);
  }
  template <typename TurnResultT = TestSetTurnResult>
  UtteranceLevelTestResultItem& WithTurnResult(TurnResultT&& value) {
    SetTurnResult(std::forward<TurnResultT>(value));
    return *this;
  }
  ///@}
 private:
