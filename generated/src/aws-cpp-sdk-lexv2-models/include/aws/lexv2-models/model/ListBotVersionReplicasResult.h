...
class ListBotVersionReplicasResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotVersionReplicasResult& WithBotId(BotIdT&& value) {
  ...
  template <typename SourceRegionT = Aws::String>
  ListBotVersionReplicasResult& WithSourceRegion(SourceRegionT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  ListBotVersionReplicasResult& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  void SetBotVersionReplicaSummaries(BotVersionReplicaSummariesT&& value) {
    m_botVersionReplicaSummariesHasBeenSet = true;
    m_botVersionReplicaSummaries = std::forward<BotVersionReplicaSummariesT>(value);
  }
  template <typename BotVersionReplicaSummariesT = Aws::Vector<BotVersionReplicaSummary>>
  ListBotVersionReplicasResult& WithBotVersionReplicaSummaries(BotVersionReplicaSummariesT&& value) {
    SetBotVersionReplicaSummaries(std::forward<BotVersionReplicaSummariesT>(value));
    return *this;
  }
  template <typename BotVersionReplicaSummariesT = BotVersionReplicaSummary>
  ListBotVersionReplicasResult& AddBotVersionReplicaSummaries(BotVersionReplicaSummariesT&& value) {
    m_botVersionReplicaSummariesHasBeenSet = true;
    m_botVersionReplicaSummaries.emplace_back(std::forward<BotVersionReplicaSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotVersionReplicasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBotVersionReplicasResult& WithRequestId(RequestIdT&& value) {
