...
class PostFulfillmentStatusSpecification {
 public:
  AWS_LEXMODELSV2_API PostFulfillmentStatusSpecification() = default;
  ...
  template <typename SuccessResponseT = ResponseSpecification>
  PostFulfillmentStatusSpecification& WithSuccessResponse(SuccessResponseT&& value) {
  ...
  template <typename FailureResponseT = ResponseSpecification>
  PostFulfillmentStatusSpecification& WithFailureResponse(FailureResponseT&& value) {
  ...
  template <typename TimeoutResponseT = ResponseSpecification>
  PostFulfillmentStatusSpecification& WithTimeoutResponse(TimeoutResponseT&& value) {
  ...
  template <typename SuccessNextStepT = DialogState>
  PostFulfillmentStatusSpecification& WithSuccessNextStep(SuccessNextStepT&& value) {
  ...
  template <typename SuccessConditionalT = ConditionalSpecification>
  PostFulfillmentStatusSpecification& WithSuccessConditional(SuccessConditionalT&& value) {
  ...
  template <typename FailureNextStepT = DialogState>
  PostFulfillmentStatusSpecification& WithFailureNextStep(FailureNextStepT&& value) {
  ...
  template <typename FailureConditionalT = ConditionalSpecification>
  PostFulfillmentStatusSpecification& WithFailureConditional(FailureConditionalT&& value) {
  ...
  template <typename TimeoutNextStepT = DialogState>
  PostFulfillmentStatusSpecification& WithTimeoutNextStep(TimeoutNextStepT&& value) {
  ...
  template <typename TimeoutConditionalT = ConditionalSpecification>
  PostFulfillmentStatusSpecification& WithTimeoutConditional(TimeoutConditionalT&& value) {
