...
class ExportResourceSpecification {
 public:
  ...
  void SetBotExportSpecification(BotExportSpecificationT&& value) {
    ...
    m_botExportSpecification = std::forward<BotExportSpecificationT>(value);
  }
  template <typename BotExportSpecificationT = BotExportSpecification>
  ExportResourceSpecification& WithBotExportSpecification(BotExportSpecificationT&& value) {
    SetBotExportSpecification(std::forward<BotExportSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotLocaleExportSpecification(BotLocaleExportSpecificationT&& value) {
    ...
    m_botLocaleExportSpecification = std::forward<BotLocaleExportSpecificationT>(value);
  }
  template <typename BotLocaleExportSpecificationT = BotLocaleExportSpecification>
  ExportResourceSpecification& WithBotLocaleExportSpecification(BotLocaleExportSpecificationT&& value) {
    SetBotLocaleExportSpecification(std::forward<BotLocaleExportSpecificationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const CustomVocabularyExportSpecification& GetCustomVocabularyExportSpecification() const {
    return m_customVocabularyExportSpecification;
  }
  ...
  void SetCustomVocabularyExportSpecification(CustomVocabularyExportSpecificationT&& value) {
    ...
    m_customVocabularyExportSpecification = std::forward<CustomVocabularyExportSpecificationT>(value);
  }
  template <typename CustomVocabularyExportSpecificationT = CustomVocabularyExportSpecification>
  ExportResourceSpecification& WithCustomVocabularyExportSpecification(CustomVocabularyExportSpecificationT&& value) {
    SetCustomVocabularyExportSpecification(std::forward<CustomVocabularyExportSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestSetExportSpecification(TestSetExportSpecificationT&& value) {
    ...
    m_testSetExportSpecification = std::forward<TestSetExportSpecificationT>(value);
  }
  template <typename TestSetExportSpecificationT = TestSetExportSpecification>
  ExportResourceSpecification& WithTestSetExportSpecification(TestSetExportSpecificationT&& value) {
    SetTestSetExportSpecification(std::forward<TestSetExportSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
