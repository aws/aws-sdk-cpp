...
class UtteranceAggregationDuration {
 public:
  ...
  void SetRelativeAggregationDuration(RelativeAggregationDurationT&& value) {
    ...
    m_relativeAggregationDuration = std::forward<RelativeAggregationDurationT>(value);
  }
  template <typename RelativeAggregationDurationT = RelativeAggregationDuration>
  UtteranceAggregationDuration& WithRelativeAggregationDuration(RelativeAggregationDurationT&& value) {
    SetRelativeAggregationDuration(std::forward<RelativeAggregationDurationT>(value));
    return *this;
  }
  ///@}
 private:
