...
class SlotResolutionImprovementSpecification {
 public:
  ...
  inline SlotResolutionImprovementSpecification& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetBedrockModelSpecification(BedrockModelSpecificationT&& value) {
    m_bedrockModelSpecificationHasBeenSet = true;
    m_bedrockModelSpecification = std::forward<BedrockModelSpecificationT>(value);
  }
  template <typename BedrockModelSpecificationT = BedrockModelSpecification>
  SlotResolutionImprovementSpecification& WithBedrockModelSpecification(BedrockModelSpecificationT&& value) {
    SetBedrockModelSpecification(std::forward<BedrockModelSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
