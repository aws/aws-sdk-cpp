...
class DeleteSlotRequest : public LexModelsV2Request {
 public:
  ...
  template <typename SlotIdT = Aws::String>
  DeleteSlotRequest& WithSlotId(SlotIdT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  DeleteSlotRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DeleteSlotRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DeleteSlotRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename IntentIdT = Aws::String>
  DeleteSlotRequest& WithIntentId(IntentIdT&& value) {
