...
class TestSetTurnRecord {
 public:
  ...
  inline void SetRecordNumber(long long value) {
    m_recordNumberHasBeenSet = true;
    m_recordNumber = value;
  }
  inline TestSetTurnRecord& WithRecordNumber(long long value) {
  ...
  template <typename ConversationIdT = Aws::String>
  TestSetTurnRecord& WithConversationId(ConversationIdT&& value) {
  ...
  inline void SetTurnNumber(int value) {
    m_turnNumberHasBeenSet = true;
    m_turnNumber = value;
  }
  inline TestSetTurnRecord& WithTurnNumber(int value) {
    SetTurnNumber(value);
    return *this;
  }
  ///@}
  ...
  void SetTurnSpecification(TurnSpecificationT&& value) {
    m_turnSpecificationHasBeenSet = true;
    m_turnSpecification = std::forward<TurnSpecificationT>(value);
  }
  template <typename TurnSpecificationT = TurnSpecification>
  TestSetTurnRecord& WithTurnSpecification(TurnSpecificationT&& value) {
    SetTurnSpecification(std::forward<TurnSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
