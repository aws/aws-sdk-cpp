...
class ListBotVersionReplicasRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotVersionReplicasRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  ListBotVersionReplicasRequest& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  inline ListBotVersionReplicasRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotVersionReplicasRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SortByT = BotVersionReplicaSortBy>
  ListBotVersionReplicasRequest& WithSortBy(SortByT&& value) {
