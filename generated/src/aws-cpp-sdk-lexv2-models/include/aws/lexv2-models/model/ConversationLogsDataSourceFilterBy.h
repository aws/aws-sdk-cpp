...
class ConversationLogsDataSourceFilterBy {
 public:
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  ConversationLogsDataSourceFilterBy& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  ConversationLogsDataSourceFilterBy& WithEndTime(EndTimeT&& value) {
  ...
  inline void SetInputMode(ConversationLogsInputModeFilter value) {
    m_inputModeHasBeenSet = true;
    m_inputMode = value;
  }
  inline ConversationLogsDataSourceFilterBy& WithInputMode(ConversationLogsInputModeFilter value) {
    SetInputMode(value);
    return *this;
  }
  ///@}
