...
class BotAliasLocaleSettings {
 public:
  ...
  inline BotAliasLocaleSettings& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetCodeHookSpecification(CodeHookSpecificationT&& value) {
    ...
    m_codeHookSpecification = std::forward<CodeHookSpecificationT>(value);
  }
  template <typename CodeHookSpecificationT = CodeHookSpecification>
  BotAliasLocaleSettings& WithCodeHookSpecification(CodeHookSpecificationT&& value) {
    SetCodeHookSpecification(std::forward<CodeHookSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
