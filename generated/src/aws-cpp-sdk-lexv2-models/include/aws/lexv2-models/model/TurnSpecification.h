...
class TurnSpecification {
 public:
  ...
  void SetAgentTurn(AgentTurnT&& value) {
    ...
    m_agentTurn = std::forward<AgentTurnT>(value);
  }
  template <typename AgentTurnT = AgentTurnSpecification>
  TurnSpecification& WithAgentTurn(AgentTurnT&& value) {
    SetAgentTurn(std::forward<AgentTurnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUserTurn(UserTurnT&& value) {
    ...
    m_userTurn = std::forward<UserTurnT>(value);
  }
  template <typename UserTurnT = UserTurnSpecification>
  TurnSpecification& WithUserTurn(UserTurnT&& value) {
    SetUserTurn(std::forward<UserTurnT>(value));
    return *this;
  }
  ///@}
 private:
