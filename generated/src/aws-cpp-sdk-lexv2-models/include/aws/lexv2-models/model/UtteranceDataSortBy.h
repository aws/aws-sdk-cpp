...
class UtteranceDataSortBy {
 public:
  ...
  inline void SetName(AnalyticsUtteranceSortByName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline UtteranceDataSortBy& WithName(AnalyticsUtteranceSortByName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline UtteranceDataSortBy& WithOrder(AnalyticsSortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
