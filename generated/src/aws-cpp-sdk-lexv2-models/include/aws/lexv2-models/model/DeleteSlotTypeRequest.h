...
class DeleteSlotTypeRequest : public LexModelsV2Request {
 public:
  ...
  template <typename SlotTypeIdT = Aws::String>
  DeleteSlotTypeRequest& WithSlotTypeId(SlotTypeIdT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  DeleteSlotTypeRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DeleteSlotTypeRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DeleteSlotTypeRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  inline DeleteSlotTypeRequest& WithSkipResourceInUseCheck(bool value) {
