...
class GenerateBotElementResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  GenerateBotElementResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  GenerateBotElementResult& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  GenerateBotElementResult& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename IntentIdT = Aws::String>
  GenerateBotElementResult& WithIntentId(IntentIdT&& value) {
  ...
  template <typename SampleUtterancesT = Aws::Vector<SampleUtterance>>
  GenerateBotElementResult& WithSampleUtterances(SampleUtterancesT&& value) {
    SetSampleUtterances(std::forward<SampleUtterancesT>(value));
    return *this;
  }
  template <typename SampleUtterancesT = SampleUtterance>
  GenerateBotElementResult& AddSampleUtterances(SampleUtterancesT&& value) {
    m_sampleUtterancesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  GenerateBotElementResult& WithRequestId(RequestIdT&& value) {
