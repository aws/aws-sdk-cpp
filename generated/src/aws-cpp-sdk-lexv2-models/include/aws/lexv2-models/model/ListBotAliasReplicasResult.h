...
class ListBotAliasReplicasResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotAliasReplicasResult& WithBotId(BotIdT&& value) {
  ...
  template <typename SourceRegionT = Aws::String>
  ListBotAliasReplicasResult& WithSourceRegion(SourceRegionT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  ListBotAliasReplicasResult& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  void SetBotAliasReplicaSummaries(BotAliasReplicaSummariesT&& value) {
    m_botAliasReplicaSummariesHasBeenSet = true;
    m_botAliasReplicaSummaries = std::forward<BotAliasReplicaSummariesT>(value);
  }
  template <typename BotAliasReplicaSummariesT = Aws::Vector<BotAliasReplicaSummary>>
  ListBotAliasReplicasResult& WithBotAliasReplicaSummaries(BotAliasReplicaSummariesT&& value) {
    SetBotAliasReplicaSummaries(std::forward<BotAliasReplicaSummariesT>(value));
    return *this;
  }
  template <typename BotAliasReplicaSummariesT = BotAliasReplicaSummary>
  ListBotAliasReplicasResult& AddBotAliasReplicaSummaries(BotAliasReplicaSummariesT&& value) {
    m_botAliasReplicaSummariesHasBeenSet = true;
    m_botAliasReplicaSummaries.emplace_back(std::forward<BotAliasReplicaSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotAliasReplicasResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBotAliasReplicasResult& WithRequestId(RequestIdT&& value) {
