...
class IntentFilter {
 public:
  ...
  inline void SetName(IntentFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline IntentFilter& WithName(IntentFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  IntentFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  IntentFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(IntentFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline IntentFilter& WithOperator(IntentFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
