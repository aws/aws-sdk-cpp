...
class TestSetDiscrepancyReportBotAliasTarget {
 public:
  ...
  template <typename BotIdT = Aws::String>
  TestSetDiscrepancyReportBotAliasTarget& WithBotId(BotIdT&& value) {
  ...
  template <typename BotAliasIdT = Aws::String>
  TestSetDiscrepancyReportBotAliasTarget& WithBotAliasId(BotAliasIdT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  TestSetDiscrepancyReportBotAliasTarget& WithLocaleId(LocaleIdT&& value) {
