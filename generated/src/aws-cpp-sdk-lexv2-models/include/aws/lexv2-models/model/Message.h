...
class Message {
 public:
  ...
  void SetPlainTextMessage(PlainTextMessageT&& value) {
    ...
    m_plainTextMessage = std::forward<PlainTextMessageT>(value);
  }
  template <typename PlainTextMessageT = PlainTextMessage>
  Message& WithPlainTextMessage(PlainTextMessageT&& value) {
    SetPlainTextMessage(std::forward<PlainTextMessageT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCustomPayload(CustomPayloadT&& value) {
    ...
    m_customPayload = std::forward<CustomPayloadT>(value);
  }
  template <typename CustomPayloadT = CustomPayload>
  Message& WithCustomPayload(CustomPayloadT&& value) {
    SetCustomPayload(std::forward<CustomPayloadT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSsmlMessage(SsmlMessageT&& value) {
    ...
    m_ssmlMessage = std::forward<SsmlMessageT>(value);
  }
  template <typename SsmlMessageT = SSMLMessage>
  Message& WithSsmlMessage(SsmlMessageT&& value) {
    SetSsmlMessage(std::forward<SsmlMessageT>(value));
    return *this;
  }
  ///@}
