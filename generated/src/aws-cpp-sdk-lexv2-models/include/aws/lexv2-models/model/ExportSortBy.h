...
class ExportSortBy {
 public:
  ...
  inline void SetAttribute(ExportSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline ExportSortBy& WithAttribute(ExportSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline ExportSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
