...
class TranscriptFilter {
 public:
  ...
  void SetLexTranscriptFilter(LexTranscriptFilterT&& value) {
    m_lexTranscriptFilterHasBeenSet = true;
    m_lexTranscriptFilter = std::forward<LexTranscriptFilterT>(value);
  }
  template <typename LexTranscriptFilterT = LexTranscriptFilter>
  TranscriptFilter& WithLexTranscriptFilter(LexTranscriptFilterT&& value) {
    SetLexTranscriptFilter(std::forward<LexTranscriptFilterT>(value));
    return *this;
  }
  ///@}
 private:
