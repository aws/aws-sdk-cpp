...
class OpensearchConfiguration {
 public:
  ...
  inline OpensearchConfiguration& WithExactResponse(bool value) {
  ...
  void SetExactResponseFields(ExactResponseFieldsT&& value) {
    ...
    m_exactResponseFields = std::forward<ExactResponseFieldsT>(value);
  }
  template <typename ExactResponseFieldsT = ExactResponseFields>
  OpensearchConfiguration& WithExactResponseFields(ExactResponseFieldsT&& value) {
    SetExactResponseFields(std::forward<ExactResponseFieldsT>(value));
    return *this;
  }
  ///@}
