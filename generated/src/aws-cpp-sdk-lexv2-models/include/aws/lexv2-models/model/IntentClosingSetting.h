...
class IntentClosingSetting {
 public:
  ...
  void SetClosingResponse(ClosingResponseT&& value) {
    ...
    m_closingResponse = std::forward<ClosingResponseT>(value);
  }
  template <typename ClosingResponseT = ResponseSpecification>
  IntentClosingSetting& WithClosingResponse(ClosingResponseT&& value) {
    SetClosingResponse(std::forward<ClosingResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline IntentClosingSetting& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
