...
class AudioLogSetting {
 public:
  ...
  inline AudioLogSetting& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelectiveLoggingEnabled(bool value) {
    m_selectiveLoggingEnabledHasBeenSet = true;
    m_selectiveLoggingEnabled = value;
  }
  inline AudioLogSetting& WithSelectiveLoggingEnabled(bool value) {
    SetSelectiveLoggingEnabled(value);
    return *this;
  }
  ///@}
 private:
