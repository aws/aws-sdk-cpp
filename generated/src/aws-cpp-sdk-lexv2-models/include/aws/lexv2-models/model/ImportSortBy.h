...
class ImportSortBy {
 public:
  ...
  inline void SetAttribute(ImportSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline ImportSortBy& WithAttribute(ImportSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline ImportSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
