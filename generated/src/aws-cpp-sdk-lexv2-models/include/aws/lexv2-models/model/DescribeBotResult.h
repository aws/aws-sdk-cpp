...
class DescribeBotResult {
 public:
  ...
  inline DescribeBotResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline DescribeBotResult& WithBotStatus(BotStatus value) {
    SetBotStatus(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeBotResult& WithBotType(BotType value) {
    SetBotType(value);
    return *this;
  }
  ///@}
