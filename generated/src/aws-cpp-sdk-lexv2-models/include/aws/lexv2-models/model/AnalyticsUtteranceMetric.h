...
class AnalyticsUtteranceMetric {
 public:
  ...
  inline void SetName(AnalyticsUtteranceMetricName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsUtteranceMetric& WithName(AnalyticsUtteranceMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsUtteranceMetric& WithStatistic(AnalyticsMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsUtteranceMetric& WithOrder(AnalyticsSortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
