...
class SubSlotSetting {
 public:
  ...
  void SetSlotSpecifications(SlotSpecificationsT&& value) {
    ...
    m_slotSpecifications = std::forward<SlotSpecificationsT>(value);
  }
  template <typename SlotSpecificationsT = Aws::Map<Aws::String, Specifications>>
  SubSlotSetting& WithSlotSpecifications(SlotSpecificationsT&& value) {
    SetSlotSpecifications(std::forward<SlotSpecificationsT>(value));
    return *this;
  }
  ...
  SubSlotSetting& AddSlotSpecifications(SlotSpecificationsKeyT&& key, SlotSpecificationsValueT&& value) {
    m_slotSpecificationsHasBeenSet = true;
    m_slotSpecifications.emplace(std::forward<SlotSpecificationsKeyT>(key), std::forward<SlotSpecificationsValueT>(value));
    return *this;
  }
  ///@}
 private:
