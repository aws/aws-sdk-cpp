...
class BatchDeleteCustomVocabularyItemResult {
 public:
  AWS_LEXMODELSV2_API BatchDeleteCustomVocabularyItemResult() = default;
  ...
  AWS_LEXMODELSV2_API BatchDeleteCustomVocabularyItemResult& operator=(
  ...
  template <typename BotIdT = Aws::String>
  BatchDeleteCustomVocabularyItemResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  BatchDeleteCustomVocabularyItemResult& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  BatchDeleteCustomVocabularyItemResult& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename ErrorsT = Aws::Vector<FailedCustomVocabularyItem>>
  BatchDeleteCustomVocabularyItemResult& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = FailedCustomVocabularyItem>
  BatchDeleteCustomVocabularyItemResult& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>A list of custom vocabulary items that were successfully deleted during the
   * operation.</p>
   */
  ...
  template <typename ResourcesT = Aws::Vector<CustomVocabularyItem>>
  BatchDeleteCustomVocabularyItemResult& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = CustomVocabularyItem>
  BatchDeleteCustomVocabularyItemResult& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  BatchDeleteCustomVocabularyItemResult& WithRequestId(RequestIdT&& value) {
