...
class ListCustomVocabularyItemsRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListCustomVocabularyItemsRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListCustomVocabularyItemsRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListCustomVocabularyItemsRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  inline ListCustomVocabularyItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCustomVocabularyItemsRequest& WithNextToken(NextTokenT&& value) {
