...
class DescribeSlotTypeRequest : public LexModelsV2Request {
 public:
  ...
  template <typename SlotTypeIdT = Aws::String>
  DescribeSlotTypeRequest& WithSlotTypeId(SlotTypeIdT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  DescribeSlotTypeRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DescribeSlotTypeRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DescribeSlotTypeRequest& WithLocaleId(LocaleIdT&& value) {
