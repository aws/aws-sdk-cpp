...
class ListBotReplicasResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotReplicasResult& WithBotId(BotIdT&& value) {
  ...
  template <typename SourceRegionT = Aws::String>
  ListBotReplicasResult& WithSourceRegion(SourceRegionT&& value) {
  ...
  void SetBotReplicaSummaries(BotReplicaSummariesT&& value) {
    m_botReplicaSummariesHasBeenSet = true;
    m_botReplicaSummaries = std::forward<BotReplicaSummariesT>(value);
  }
  template <typename BotReplicaSummariesT = Aws::Vector<BotReplicaSummary>>
  ListBotReplicasResult& WithBotReplicaSummaries(BotReplicaSummariesT&& value) {
    SetBotReplicaSummaries(std::forward<BotReplicaSummariesT>(value));
    return *this;
  }
  template <typename BotReplicaSummariesT = BotReplicaSummary>
  ListBotReplicasResult& AddBotReplicaSummaries(BotReplicaSummariesT&& value) {
    m_botReplicaSummariesHasBeenSet = true;
    m_botReplicaSummaries.emplace_back(std::forward<BotReplicaSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListBotReplicasResult& WithRequestId(RequestIdT&& value) {
