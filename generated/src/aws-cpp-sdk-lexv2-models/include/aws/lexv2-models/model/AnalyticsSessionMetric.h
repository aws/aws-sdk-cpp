...
class AnalyticsSessionMetric {
 public:
  ...
  inline AnalyticsSessionMetric& WithName(AnalyticsSessionMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsSessionMetric& WithStatistic(AnalyticsMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsSessionMetric& WithOrder(AnalyticsSortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
