...
class SessionSpecification {
 public:
  ...
  void SetConversationStartTime(ConversationStartTimeT&& value) {
    ...
    m_conversationStartTime = std::forward<ConversationStartTimeT>(value);
  }
  template <typename ConversationStartTimeT = Aws::Utils::DateTime>
  SessionSpecification& WithConversationStartTime(ConversationStartTimeT&& value) {
    SetConversationStartTime(std::forward<ConversationStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConversationEndTime(ConversationEndTimeT&& value) {
    ...
    m_conversationEndTime = std::forward<ConversationEndTimeT>(value);
  }
  template <typename ConversationEndTimeT = Aws::Utils::DateTime>
  SessionSpecification& WithConversationEndTime(ConversationEndTimeT&& value) {
    SetConversationEndTime(std::forward<ConversationEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetConversationDurationSeconds(long long value) {
    m_conversationDurationSecondsHasBeenSet = true;
    m_conversationDurationSeconds = value;
  }
  inline SessionSpecification& WithConversationDurationSeconds(long long value) {
    SetConversationDurationSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline void SetConversationEndState(ConversationEndState value) {
    m_conversationEndStateHasBeenSet = true;
    m_conversationEndState = value;
  }
  inline SessionSpecification& WithConversationEndState(ConversationEndState value) {
    SetConversationEndState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMode(AnalyticsModality value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline SessionSpecification& WithMode(AnalyticsModality value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetNumberOfTurns(long long value) {
    m_numberOfTurnsHasBeenSet = true;
    m_numberOfTurns = value;
  }
  inline SessionSpecification& WithNumberOfTurns(long long value) {
    SetNumberOfTurns(value);
    return *this;
  }
  ///@}
  ...
  void SetInvokedIntentSamples(InvokedIntentSamplesT&& value) {
    ...
    m_invokedIntentSamples = std::forward<InvokedIntentSamplesT>(value);
  }
  template <typename InvokedIntentSamplesT = Aws::Vector<InvokedIntentSample>>
  SessionSpecification& WithInvokedIntentSamples(InvokedIntentSamplesT&& value) {
    SetInvokedIntentSamples(std::forward<InvokedIntentSamplesT>(value));
    return *this;
  }
  ...
  SessionSpecification& AddInvokedIntentSamples(InvokedIntentSamplesT&& value) {
    m_invokedIntentSamplesHasBeenSet = true;
    m_invokedIntentSamples.emplace_back(std::forward<InvokedIntentSamplesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOriginatingRequestId(OriginatingRequestIdT&& value) {
    ...
    m_originatingRequestId = std::forward<OriginatingRequestIdT>(value);
  }
  template <typename OriginatingRequestIdT = Aws::String>
  SessionSpecification& WithOriginatingRequestId(OriginatingRequestIdT&& value) {
    SetOriginatingRequestId(std::forward<OriginatingRequestIdT>(value));
    return *this;
  }
  ///@}
 private:
