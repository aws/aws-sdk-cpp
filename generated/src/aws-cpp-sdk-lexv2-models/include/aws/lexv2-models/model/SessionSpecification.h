...
namespace Model
{
  ...
  public:
     ...
     * with.</p>
     */
    inline SessionSpecification& WithChannel(const BotChannelType& value) { SetChannel(value); return *this;}

    /**
     * <p>The channel that is integrated with the bot that the session was held
     * with.</p>
     */
    inline SessionSpecification& WithChannel(BotChannelType&& value) { SetChannel(std::move(value)); return *this;}
