...
class CreateUploadUrlResult {
 public:
  ...
  template <typename ImportIdT = Aws::String>
  CreateUploadUrlResult& WithImportId(ImportIdT&& value) {
  ...
  template <typename UploadUrlT = Aws::String>
  CreateUploadUrlResult& WithUploadUrl(UploadUrlT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateUploadUrlResult& WithRequestId(RequestIdT&& value) {
