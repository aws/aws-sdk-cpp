...
class DescribeTestSetResult {
 public:
  AWS_LEXMODELSV2_API DescribeTestSetResult() = default;
  ...
  template <typename TestSetIdT = Aws::String>
  DescribeTestSetResult& WithTestSetId(TestSetIdT&& value) {
  ...
  template <typename TestSetNameT = Aws::String>
  DescribeTestSetResult& WithTestSetName(TestSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeTestSetResult& WithDescription(DescriptionT&& value) {
  ...
  inline DescribeTestSetResult& WithModality(TestSetModality value) {
    SetModality(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeTestSetResult& WithStatus(TestSetStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoleArnT = Aws::String>
  DescribeTestSetResult& WithRoleArn(RoleArnT&& value) {
  ...
  inline DescribeTestSetResult& WithNumTurns(int value) {
    SetNumTurns(value);
    return *this;
  }
  ///@}
  ...
  template <typename StorageLocationT = TestSetStorageLocation>
  DescribeTestSetResult& WithStorageLocation(StorageLocationT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  DescribeTestSetResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  DescribeTestSetResult& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTestSetResult& WithRequestId(RequestIdT&& value) {
