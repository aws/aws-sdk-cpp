...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API BatchUpdateCustomVocabularyItemResult() = default;
    ...
    template<typename BotIdT = Aws::String>
    BatchUpdateCustomVocabularyItemResult& WithBotId(BotIdT&& value) { SetBotId(std::forward<BotIdT>(value)); return *this;}
    ///@}
    ...
    template<typename BotVersionT = Aws::String>
    BatchUpdateCustomVocabularyItemResult& WithBotVersion(BotVersionT&& value) { SetBotVersion(std::forward<BotVersionT>(value)); return *this;}
    ///@}
    ...
    template<typename LocaleIdT = Aws::String>
    BatchUpdateCustomVocabularyItemResult& WithLocaleId(LocaleIdT&& value) { SetLocaleId(std::forward<LocaleIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ErrorsT = Aws::Vector<FailedCustomVocabularyItem>>
    BatchUpdateCustomVocabularyItemResult& WithErrors(ErrorsT&& value) { SetErrors(std::forward<ErrorsT>(value)); return *this;}
    template<typename ErrorsT = FailedCustomVocabularyItem>
    BatchUpdateCustomVocabularyItemResult& AddErrors(ErrorsT&& value) { m_errorsHasBeenSet = true; m_errors.emplace_back(std::forward<ErrorsT>(value)); return *this; }
    ///@}
    ...
    template<typename ResourcesT = Aws::Vector<CustomVocabularyItem>>
    BatchUpdateCustomVocabularyItemResult& WithResources(ResourcesT&& value) { SetResources(std::forward<ResourcesT>(value)); return *this;}
    template<typename ResourcesT = CustomVocabularyItem>
    BatchUpdateCustomVocabularyItemResult& AddResources(ResourcesT&& value) { m_resourcesHasBeenSet = true; m_resources.emplace_back(std::forward<ResourcesT>(value)); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    BatchUpdateCustomVocabularyItemResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
