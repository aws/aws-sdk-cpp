...
class DTMFSpecification {
 public:
  ...
  inline DTMFSpecification& WithMaxLength(int value) {
    SetMaxLength(value);
    return *this;
  }
  ///@}
  ...
  inline DTMFSpecification& WithEndTimeoutMs(int value) {
  ...
  void SetDeletionCharacter(DeletionCharacterT&& value) {
    ...
    m_deletionCharacter = std::forward<DeletionCharacterT>(value);
  }
  template <typename DeletionCharacterT = Aws::String>
  DTMFSpecification& WithDeletionCharacter(DeletionCharacterT&& value) {
    SetDeletionCharacter(std::forward<DeletionCharacterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEndCharacter(EndCharacterT&& value) {
    ...
    m_endCharacter = std::forward<EndCharacterT>(value);
  }
  template <typename EndCharacterT = Aws::String>
  DTMFSpecification& WithEndCharacter(EndCharacterT&& value) {
    SetEndCharacter(std::forward<EndCharacterT>(value));
    return *this;
  }
  ///@}
 private:
