...
class TestExecutionSummary {
 public:
  ...
  inline TestExecutionSummary& WithTestExecutionStatus(TestExecutionStatus value) {
  ...
  inline TestExecutionSummary& WithApiMode(TestExecutionApiMode value) {
    SetApiMode(value);
    return *this;
  }
  ///@}
  ...
  inline TestExecutionSummary& WithTestExecutionModality(TestExecutionModality value) {
