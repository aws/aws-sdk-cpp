...
class QInConnectIntentConfiguration {
 public:
  ...
  void SetQInConnectAssistantConfiguration(QInConnectAssistantConfigurationT&& value) {
    ...
    m_qInConnectAssistantConfiguration = std::forward<QInConnectAssistantConfigurationT>(value);
  }
  template <typename QInConnectAssistantConfigurationT = QInConnectAssistantConfiguration>
  QInConnectIntentConfiguration& WithQInConnectAssistantConfiguration(QInConnectAssistantConfigurationT&& value) {
    SetQInConnectAssistantConfiguration(std::forward<QInConnectAssistantConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
