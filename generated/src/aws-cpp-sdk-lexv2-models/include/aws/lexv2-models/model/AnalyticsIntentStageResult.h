...
class AnalyticsIntentStageResult {
 public:
  ...
  template <typename BinKeysT = Aws::Vector<AnalyticsBinKey>>
  AnalyticsIntentStageResult& WithBinKeys(BinKeysT&& value) {
    SetBinKeys(std::forward<BinKeysT>(value));
    return *this;
  }
  template <typename BinKeysT = AnalyticsBinKey>
  AnalyticsIntentStageResult& AddBinKeys(BinKeysT&& value) {
    m_binKeysHasBeenSet = true;
  ...
  template <typename GroupByKeysT = Aws::Vector<AnalyticsIntentStageGroupByKey>>
  AnalyticsIntentStageResult& WithGroupByKeys(GroupByKeysT&& value) {
    SetGroupByKeys(std::forward<GroupByKeysT>(value));
    return *this;
  }
  template <typename GroupByKeysT = AnalyticsIntentStageGroupByKey>
  AnalyticsIntentStageResult& AddGroupByKeys(GroupByKeysT&& value) {
    m_groupByKeysHasBeenSet = true;
  ...
  template <typename MetricsResultsT = Aws::Vector<AnalyticsIntentStageMetricResult>>
  AnalyticsIntentStageResult& WithMetricsResults(MetricsResultsT&& value) {
    SetMetricsResults(std::forward<MetricsResultsT>(value));
    return *this;
  }
  template <typename MetricsResultsT = AnalyticsIntentStageMetricResult>
  AnalyticsIntentStageResult& AddMetricsResults(MetricsResultsT&& value) {
    m_metricsResultsHasBeenSet = true;
