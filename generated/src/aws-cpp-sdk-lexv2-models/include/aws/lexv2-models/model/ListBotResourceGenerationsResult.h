...
class ListBotResourceGenerationsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListBotResourceGenerationsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListBotResourceGenerationsResult& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListBotResourceGenerationsResult& WithLocaleId(LocaleIdT&& value) {
  ...
  void SetGenerationSummaries(GenerationSummariesT&& value) {
    m_generationSummariesHasBeenSet = true;
    m_generationSummaries = std::forward<GenerationSummariesT>(value);
  }
  template <typename GenerationSummariesT = Aws::Vector<GenerationSummary>>
  ListBotResourceGenerationsResult& WithGenerationSummaries(GenerationSummariesT&& value) {
    SetGenerationSummaries(std::forward<GenerationSummariesT>(value));
    return *this;
  }
  template <typename GenerationSummariesT = GenerationSummary>
  ListBotResourceGenerationsResult& AddGenerationSummaries(GenerationSummariesT&& value) {
    m_generationSummariesHasBeenSet = true;
    m_generationSummaries.emplace_back(std::forward<GenerationSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotResourceGenerationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBotResourceGenerationsResult& WithRequestId(RequestIdT&& value) {
