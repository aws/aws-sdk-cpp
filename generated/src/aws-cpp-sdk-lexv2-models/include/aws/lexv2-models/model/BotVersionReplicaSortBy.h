...
class BotVersionReplicaSortBy {
 public:
  ...
  inline void SetAttribute(BotVersionReplicaSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline BotVersionReplicaSortBy& WithAttribute(BotVersionReplicaSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline BotVersionReplicaSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
