...
class DescribeCustomVocabularyMetadataRequest : public LexModelsV2Request {
 public:
  AWS_LEXMODELSV2_API DescribeCustomVocabularyMetadataRequest() = default;
  ...
  template <typename BotIdT = Aws::String>
  DescribeCustomVocabularyMetadataRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DescribeCustomVocabularyMetadataRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DescribeCustomVocabularyMetadataRequest& WithLocaleId(LocaleIdT&& value) {
