...
class TestSetStorageLocation {
 public:
  ...
  template <typename S3BucketNameT = Aws::String>
  TestSetStorageLocation& WithS3BucketName(S3BucketNameT&& value) {
  ...
  template <typename S3PathT = Aws::String>
  TestSetStorageLocation& WithS3Path(S3PathT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  TestSetStorageLocation& WithKmsKeyArn(KmsKeyArnT&& value) {
