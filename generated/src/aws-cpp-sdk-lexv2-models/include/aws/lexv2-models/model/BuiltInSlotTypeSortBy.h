...
class BuiltInSlotTypeSortBy {
 public:
  ...
  inline void SetAttribute(BuiltInSlotTypeSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline BuiltInSlotTypeSortBy& WithAttribute(BuiltInSlotTypeSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline BuiltInSlotTypeSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
