...
class BedrockModelSpecification {
 public:
  ...
  inline void SetTraceStatus(BedrockTraceStatus value) {
    m_traceStatusHasBeenSet = true;
    m_traceStatus = value;
  }
  inline BedrockModelSpecification& WithTraceStatus(BedrockTraceStatus value) {
  ...
  void SetCustomPrompt(CustomPromptT&& value) {
    ...
    m_customPrompt = std::forward<CustomPromptT>(value);
  }
  template <typename CustomPromptT = Aws::String>
  BedrockModelSpecification& WithCustomPrompt(CustomPromptT&& value) {
    SetCustomPrompt(std::forward<CustomPromptT>(value));
    return *this;
  }
  ///@}
 private:
