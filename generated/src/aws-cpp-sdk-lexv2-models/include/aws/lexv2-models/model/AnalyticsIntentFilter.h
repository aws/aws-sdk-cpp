...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API AnalyticsIntentFilter();
     ...
     */
    inline const AnalyticsIntentFilterName& GetName() const{ return m_name; }
     ...
     * <code>IntentEndState</code> – The final state of the intent.</p> </li> </ul>
     */
    inline void SetName(const AnalyticsIntentFilterName& value) { m_nameHasBeenSet = true; m_name = value; }
     ...
     * <code>IntentEndState</code> – The final state of the intent.</p> </li> </ul>
     */
    inline void SetName(AnalyticsIntentFilterName&& value) { m_nameHasBeenSet = true; m_name = std::move(value); }
     ...
     * <code>IntentEndState</code> – The final state of the intent.</p> </li> </ul>
     */
    inline AnalyticsIntentFilter& WithName(const AnalyticsIntentFilterName& value) { SetName(value); return *this;}
     ...
     * <code>IntentEndState</code> – The final state of the intent.</p> </li> </ul>
     */
    inline AnalyticsIntentFilter& WithName(AnalyticsIntentFilterName&& value) { SetName(std::move(value)); return *this;}
     ...
     * <code>IntentEndState</code> – <code>EQ</code>, <code>CO</code>.</p> </li> </ul>
     */
    inline AnalyticsIntentFilter& WithOperator(const AnalyticsFilterOperator& value) { SetOperator(value); return *this;}
     ...
     * <code>IntentEndState</code> – <code>EQ</code>, <code>CO</code>.</p> </li> </ul>
     */
    inline AnalyticsIntentFilter& WithOperator(AnalyticsFilterOperator&& value) { SetOperator(std::move(value)); return *this;}
     ...
     * or <code>Text</code>.</p>
     */
    inline AnalyticsIntentFilter& WithValues(const Aws::Vector<Aws::String>& value) { SetValues(value); return *this;}
     ...
     * or <code>Text</code>.</p>
     */
    inline AnalyticsIntentFilter& WithValues(Aws::Vector<Aws::String>&& value) { SetValues(std::move(value)); return *this;}
     ...
     * or <code>Text</code>.</p>
     */
    inline AnalyticsIntentFilter& AddValues(const Aws::String& value) { m_valuesHasBeenSet = true; m_values.push_back(value); return *this; }
     ...
     * or <code>Text</code>.</p>
     */
    inline AnalyticsIntentFilter& AddValues(Aws::String&& value) { m_valuesHasBeenSet = true; m_values.push_back(std::move(value)); return *this; }
     ...
     * or <code>Text</code>.</p>
     */
    inline AnalyticsIntentFilter& AddValues(const char* value) { m_valuesHasBeenSet = true; m_values.push_back(value); return *this; }

  private:

    AnalyticsIntentFilterName m_name;
