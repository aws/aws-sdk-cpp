...
class AnalyticsIntentFilter {
 public:
  ...
  inline void SetName(AnalyticsIntentFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsIntentFilter& WithName(AnalyticsIntentFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsIntentFilter& WithOperator(AnalyticsFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AnalyticsIntentFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AnalyticsIntentFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
