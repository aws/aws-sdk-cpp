...
class DescribeBotResourceGenerationResult {
 public:
  ...
  AWS_LEXMODELSV2_API DescribeBotResourceGenerationResult& operator=(
  ...
  inline DescribeBotResourceGenerationResult& WithGenerationStatus(GenerationStatus value) {
  ...
  void SetGeneratedBotLocaleUrl(GeneratedBotLocaleUrlT&& value) {
    ...
    m_generatedBotLocaleUrl = std::forward<GeneratedBotLocaleUrlT>(value);
  }
  template <typename GeneratedBotLocaleUrlT = Aws::String>
  DescribeBotResourceGenerationResult& WithGeneratedBotLocaleUrl(GeneratedBotLocaleUrlT&& value) {
    SetGeneratedBotLocaleUrl(std::forward<GeneratedBotLocaleUrlT>(value));
    return *this;
  }
  ///@}
