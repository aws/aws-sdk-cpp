...
class SampleUtteranceGenerationSpecification {
 public:
  ...
  inline SampleUtteranceGenerationSpecification& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename BedrockModelSpecificationT = BedrockModelSpecification>
  SampleUtteranceGenerationSpecification& WithBedrockModelSpecification(BedrockModelSpecificationT&& value) {
