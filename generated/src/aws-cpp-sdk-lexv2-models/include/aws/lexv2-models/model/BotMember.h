...
class BotMember {
 public:
  ...
  void SetBotMemberId(BotMemberIdT&& value) {
    ...
    m_botMemberId = std::forward<BotMemberIdT>(value);
  }
  template <typename BotMemberIdT = Aws::String>
  BotMember& WithBotMemberId(BotMemberIdT&& value) {
    SetBotMemberId(std::forward<BotMemberIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotMemberName(BotMemberNameT&& value) {
    ...
    m_botMemberName = std::forward<BotMemberNameT>(value);
  }
  template <typename BotMemberNameT = Aws::String>
  BotMember& WithBotMemberName(BotMemberNameT&& value) {
    SetBotMemberName(std::forward<BotMemberNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotMemberAliasId(BotMemberAliasIdT&& value) {
    ...
    m_botMemberAliasId = std::forward<BotMemberAliasIdT>(value);
  }
  template <typename BotMemberAliasIdT = Aws::String>
  BotMember& WithBotMemberAliasId(BotMemberAliasIdT&& value) {
    SetBotMemberAliasId(std::forward<BotMemberAliasIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotMemberAliasName(BotMemberAliasNameT&& value) {
    ...
    m_botMemberAliasName = std::forward<BotMemberAliasNameT>(value);
  }
  template <typename BotMemberAliasNameT = Aws::String>
  BotMember& WithBotMemberAliasName(BotMemberAliasNameT&& value) {
    SetBotMemberAliasName(std::forward<BotMemberAliasNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotMemberVersion(BotMemberVersionT&& value) {
    ...
    m_botMemberVersion = std::forward<BotMemberVersionT>(value);
  }
  template <typename BotMemberVersionT = Aws::String>
  BotMember& WithBotMemberVersion(BotMemberVersionT&& value) {
    SetBotMemberVersion(std::forward<BotMemberVersionT>(value));
    return *this;
  }
  ///@}
 private:
