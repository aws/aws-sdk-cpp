...
class AllowedInputTypes {
 public:
  ...
  inline void SetAllowAudioInput(bool value) {
    m_allowAudioInputHasBeenSet = true;
    m_allowAudioInput = value;
  }
  inline AllowedInputTypes& WithAllowAudioInput(bool value) {
    SetAllowAudioInput(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAllowDTMFInput(bool value) {
    m_allowDTMFInputHasBeenSet = true;
    m_allowDTMFInput = value;
  }
  inline AllowedInputTypes& WithAllowDTMFInput(bool value) {
    SetAllowDTMFInput(value);
    return *this;
  }
  ///@}
 private:
