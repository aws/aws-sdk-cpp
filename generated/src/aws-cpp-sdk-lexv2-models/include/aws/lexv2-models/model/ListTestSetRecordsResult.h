...
class ListTestSetRecordsResult {
 public:
  ...
  void SetTestSetRecords(TestSetRecordsT&& value) {
    m_testSetRecordsHasBeenSet = true;
    m_testSetRecords = std::forward<TestSetRecordsT>(value);
  }
  template <typename TestSetRecordsT = Aws::Vector<TestSetTurnRecord>>
  ListTestSetRecordsResult& WithTestSetRecords(TestSetRecordsT&& value) {
    SetTestSetRecords(std::forward<TestSetRecordsT>(value));
    return *this;
  }
  template <typename TestSetRecordsT = TestSetTurnRecord>
  ListTestSetRecordsResult& AddTestSetRecords(TestSetRecordsT&& value) {
    m_testSetRecordsHasBeenSet = true;
    m_testSetRecords.emplace_back(std::forward<TestSetRecordsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestSetRecordsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestSetRecordsResult& WithRequestId(RequestIdT&& value) {
