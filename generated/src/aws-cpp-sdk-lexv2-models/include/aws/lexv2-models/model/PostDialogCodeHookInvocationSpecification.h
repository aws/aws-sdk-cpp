...
class PostDialogCodeHookInvocationSpecification {
 public:
  ...
  void SetSuccessResponse(SuccessResponseT&& value) {
    m_successResponseHasBeenSet = true;
    m_successResponse = std::forward<SuccessResponseT>(value);
  }
  template <typename SuccessResponseT = ResponseSpecification>
  PostDialogCodeHookInvocationSpecification& WithSuccessResponse(SuccessResponseT&& value) {
    SetSuccessResponse(std::forward<SuccessResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSuccessNextStep(SuccessNextStepT&& value) {
    m_successNextStepHasBeenSet = true;
    m_successNextStep = std::forward<SuccessNextStepT>(value);
  }
  template <typename SuccessNextStepT = DialogState>
  PostDialogCodeHookInvocationSpecification& WithSuccessNextStep(SuccessNextStepT&& value) {
    SetSuccessNextStep(std::forward<SuccessNextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSuccessConditional(SuccessConditionalT&& value) {
    m_successConditionalHasBeenSet = true;
    m_successConditional = std::forward<SuccessConditionalT>(value);
  }
  template <typename SuccessConditionalT = ConditionalSpecification>
  PostDialogCodeHookInvocationSpecification& WithSuccessConditional(SuccessConditionalT&& value) {
    SetSuccessConditional(std::forward<SuccessConditionalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureResponse(FailureResponseT&& value) {
    ...
    m_failureResponse = std::forward<FailureResponseT>(value);
  }
  template <typename FailureResponseT = ResponseSpecification>
  PostDialogCodeHookInvocationSpecification& WithFailureResponse(FailureResponseT&& value) {
    SetFailureResponse(std::forward<FailureResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureNextStep(FailureNextStepT&& value) {
    ...
    m_failureNextStep = std::forward<FailureNextStepT>(value);
  }
  template <typename FailureNextStepT = DialogState>
  PostDialogCodeHookInvocationSpecification& WithFailureNextStep(FailureNextStepT&& value) {
    SetFailureNextStep(std::forward<FailureNextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureConditional(FailureConditionalT&& value) {
    ...
    m_failureConditional = std::forward<FailureConditionalT>(value);
  }
  template <typename FailureConditionalT = ConditionalSpecification>
  PostDialogCodeHookInvocationSpecification& WithFailureConditional(FailureConditionalT&& value) {
    SetFailureConditional(std::forward<FailureConditionalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeoutResponse(TimeoutResponseT&& value) {
    m_timeoutResponseHasBeenSet = true;
    m_timeoutResponse = std::forward<TimeoutResponseT>(value);
  }
  template <typename TimeoutResponseT = ResponseSpecification>
  PostDialogCodeHookInvocationSpecification& WithTimeoutResponse(TimeoutResponseT&& value) {
    SetTimeoutResponse(std::forward<TimeoutResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeoutNextStep(TimeoutNextStepT&& value) {
    m_timeoutNextStepHasBeenSet = true;
    m_timeoutNextStep = std::forward<TimeoutNextStepT>(value);
  }
  template <typename TimeoutNextStepT = DialogState>
  PostDialogCodeHookInvocationSpecification& WithTimeoutNextStep(TimeoutNextStepT&& value) {
    SetTimeoutNextStep(std::forward<TimeoutNextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTimeoutConditional(TimeoutConditionalT&& value) {
    m_timeoutConditionalHasBeenSet = true;
    m_timeoutConditional = std::forward<TimeoutConditionalT>(value);
  }
  template <typename TimeoutConditionalT = ConditionalSpecification>
  PostDialogCodeHookInvocationSpecification& WithTimeoutConditional(TimeoutConditionalT&& value) {
    SetTimeoutConditional(std::forward<TimeoutConditionalT>(value));
    return *this;
  }
  ///@}
 private:
