...
class CreateBotReplicaResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  CreateBotReplicaResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  CreateBotReplicaResult& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  template <typename SourceRegionT = Aws::String>
  CreateBotReplicaResult& WithSourceRegion(SourceRegionT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  CreateBotReplicaResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  inline CreateBotReplicaResult& WithBotReplicaStatus(BotReplicaStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateBotReplicaResult& WithRequestId(RequestIdT&& value) {
