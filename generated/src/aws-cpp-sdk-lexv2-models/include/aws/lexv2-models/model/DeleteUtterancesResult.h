...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API DeleteUtterancesResult() = default;
    ...
    template<typename RequestIdT = Aws::String>
    DeleteUtterancesResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
