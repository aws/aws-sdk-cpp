...
class BatchDeleteCustomVocabularyItemRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  BatchDeleteCustomVocabularyItemRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  BatchDeleteCustomVocabularyItemRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  BatchDeleteCustomVocabularyItemRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename CustomVocabularyItemListT = Aws::Vector<CustomVocabularyEntryId>>
  BatchDeleteCustomVocabularyItemRequest& WithCustomVocabularyItemList(CustomVocabularyItemListT&& value) {
  ...
  BatchDeleteCustomVocabularyItemRequest& AddCustomVocabularyItemList(CustomVocabularyItemListT&& value) {
    m_customVocabularyItemListHasBeenSet = true;
