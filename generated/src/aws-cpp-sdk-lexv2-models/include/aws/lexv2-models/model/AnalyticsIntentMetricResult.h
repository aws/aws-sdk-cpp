...
class AnalyticsIntentMetricResult {
 public:
  ...
  inline AnalyticsIntentMetricResult& WithName(AnalyticsIntentMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsIntentMetricResult& WithStatistic(AnalyticsMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsIntentMetricResult& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
