...
class StartTestExecutionRequest : public LexModelsV2Request {
 public:
  ...
  inline StartTestExecutionRequest& WithApiMode(TestExecutionApiMode value) {
    SetApiMode(value);
    return *this;
  }
  ///@}
  ...
  inline StartTestExecutionRequest& WithTestExecutionModality(TestExecutionModality value) {
