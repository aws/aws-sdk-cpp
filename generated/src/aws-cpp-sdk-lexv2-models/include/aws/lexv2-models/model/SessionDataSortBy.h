...
class SessionDataSortBy {
 public:
  ...
  inline void SetName(AnalyticsSessionSortByName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SessionDataSortBy& WithName(AnalyticsSessionSortByName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline SessionDataSortBy& WithOrder(AnalyticsSortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
