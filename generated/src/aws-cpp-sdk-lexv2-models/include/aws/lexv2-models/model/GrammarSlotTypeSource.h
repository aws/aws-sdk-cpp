...
class GrammarSlotTypeSource {
 public:
  ...
  template <typename S3BucketNameT = Aws::String>
  GrammarSlotTypeSource& WithS3BucketName(S3BucketNameT&& value) {
  ...
  template <typename S3ObjectKeyT = Aws::String>
  GrammarSlotTypeSource& WithS3ObjectKey(S3ObjectKeyT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  GrammarSlotTypeSource& WithKmsKeyArn(KmsKeyArnT&& value) {
