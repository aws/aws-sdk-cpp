...
class TestExecutionResultItems {
 public:
  ...
  void SetOverallTestResults(OverallTestResultsT&& value) {
    ...
    m_overallTestResults = std::forward<OverallTestResultsT>(value);
  }
  template <typename OverallTestResultsT = OverallTestResults>
  TestExecutionResultItems& WithOverallTestResults(OverallTestResultsT&& value) {
    SetOverallTestResults(std::forward<OverallTestResultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConversationLevelTestResults(ConversationLevelTestResultsT&& value) {
    ...
    m_conversationLevelTestResults = std::forward<ConversationLevelTestResultsT>(value);
  }
  template <typename ConversationLevelTestResultsT = ConversationLevelTestResults>
  TestExecutionResultItems& WithConversationLevelTestResults(ConversationLevelTestResultsT&& value) {
    SetConversationLevelTestResults(std::forward<ConversationLevelTestResultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIntentClassificationTestResults(IntentClassificationTestResultsT&& value) {
    ...
    m_intentClassificationTestResults = std::forward<IntentClassificationTestResultsT>(value);
  }
  template <typename IntentClassificationTestResultsT = IntentClassificationTestResults>
  TestExecutionResultItems& WithIntentClassificationTestResults(IntentClassificationTestResultsT&& value) {
    SetIntentClassificationTestResults(std::forward<IntentClassificationTestResultsT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const IntentLevelSlotResolutionTestResults& GetIntentLevelSlotResolutionTestResults() const {
    return m_intentLevelSlotResolutionTestResults;
  }
  ...
  void SetIntentLevelSlotResolutionTestResults(IntentLevelSlotResolutionTestResultsT&& value) {
    ...
    m_intentLevelSlotResolutionTestResults = std::forward<IntentLevelSlotResolutionTestResultsT>(value);
  }
  template <typename IntentLevelSlotResolutionTestResultsT = IntentLevelSlotResolutionTestResults>
  TestExecutionResultItems& WithIntentLevelSlotResolutionTestResults(IntentLevelSlotResolutionTestResultsT&& value) {
    SetIntentLevelSlotResolutionTestResults(std::forward<IntentLevelSlotResolutionTestResultsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUtteranceLevelTestResults(UtteranceLevelTestResultsT&& value) {
    ...
    m_utteranceLevelTestResults = std::forward<UtteranceLevelTestResultsT>(value);
  }
  template <typename UtteranceLevelTestResultsT = UtteranceLevelTestResults>
  TestExecutionResultItems& WithUtteranceLevelTestResults(UtteranceLevelTestResultsT&& value) {
    SetUtteranceLevelTestResults(std::forward<UtteranceLevelTestResultsT>(value));
    return *this;
  }
  ///@}
 private:
