...
class DataSourceConfiguration {
 public:
   ...
   */
  inline const BedrockKnowledgeStoreConfiguration& GetBedrockKnowledgeStoreConfiguration() const {
    return m_bedrockKnowledgeStoreConfiguration;
  }
  ...
  void SetBedrockKnowledgeStoreConfiguration(BedrockKnowledgeStoreConfigurationT&& value) {
    ...
    m_bedrockKnowledgeStoreConfiguration = std::forward<BedrockKnowledgeStoreConfigurationT>(value);
  }
  template <typename BedrockKnowledgeStoreConfigurationT = BedrockKnowledgeStoreConfiguration>
  DataSourceConfiguration& WithBedrockKnowledgeStoreConfiguration(BedrockKnowledgeStoreConfigurationT&& value) {
    SetBedrockKnowledgeStoreConfiguration(std::forward<BedrockKnowledgeStoreConfigurationT>(value));
    return *this;
  }
  ///@}
 private:
