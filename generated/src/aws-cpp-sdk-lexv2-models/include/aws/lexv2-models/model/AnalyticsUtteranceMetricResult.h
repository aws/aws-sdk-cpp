...
class AnalyticsUtteranceMetricResult {
 public:
  ...
  inline AnalyticsUtteranceMetricResult& WithName(AnalyticsUtteranceMetricName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsUtteranceMetricResult& WithStatistic(AnalyticsMetricStatistic value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsUtteranceMetricResult& WithValue(double value) {
    SetValue(value);
    return *this;
  }
  ///@}
