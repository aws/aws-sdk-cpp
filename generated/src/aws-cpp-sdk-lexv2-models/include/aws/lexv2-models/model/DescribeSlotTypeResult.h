...
class DescribeSlotTypeResult {
 public:
  ...
  template <typename SlotTypeIdT = Aws::String>
  DescribeSlotTypeResult& WithSlotTypeId(SlotTypeIdT&& value) {
  ...
  template <typename SlotTypeNameT = Aws::String>
  DescribeSlotTypeResult& WithSlotTypeName(SlotTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  DescribeSlotTypeResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename SlotTypeValuesT = Aws::Vector<SlotTypeValue>>
  DescribeSlotTypeResult& WithSlotTypeValues(SlotTypeValuesT&& value) {
    SetSlotTypeValues(std::forward<SlotTypeValuesT>(value));
    return *this;
  }
  template <typename SlotTypeValuesT = SlotTypeValue>
  DescribeSlotTypeResult& AddSlotTypeValues(SlotTypeValuesT&& value) {
    m_slotTypeValuesHasBeenSet = true;
  ...
  template <typename ValueSelectionSettingT = SlotValueSelectionSetting>
  DescribeSlotTypeResult& WithValueSelectionSetting(ValueSelectionSettingT&& value) {
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  DescribeSlotTypeResult& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  DescribeSlotTypeResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DescribeSlotTypeResult& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DescribeSlotTypeResult& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  DescribeSlotTypeResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename LastUpdatedDateTimeT = Aws::Utils::DateTime>
  DescribeSlotTypeResult& WithLastUpdatedDateTime(LastUpdatedDateTimeT&& value) {
  ...
  template <typename ExternalSourceSettingT = ExternalSourceSetting>
  DescribeSlotTypeResult& WithExternalSourceSetting(ExternalSourceSettingT&& value) {
  ...
  template <typename CompositeSlotTypeSettingT = CompositeSlotTypeSetting>
  DescribeSlotTypeResult& WithCompositeSlotTypeSetting(CompositeSlotTypeSettingT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeSlotTypeResult& WithRequestId(RequestIdT&& value) {
