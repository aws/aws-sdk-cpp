...
class IntentSortBy {
 public:
  ...
  inline void SetAttribute(IntentSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline IntentSortBy& WithAttribute(IntentSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline IntentSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
