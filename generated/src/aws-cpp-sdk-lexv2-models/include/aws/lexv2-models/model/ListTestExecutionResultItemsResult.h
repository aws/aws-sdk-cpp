...
class ListTestExecutionResultItemsResult {
 public:
  ...
  void SetTestExecutionResults(TestExecutionResultsT&& value) {
    m_testExecutionResultsHasBeenSet = true;
    m_testExecutionResults = std::forward<TestExecutionResultsT>(value);
  }
  template <typename TestExecutionResultsT = TestExecutionResultItems>
  ListTestExecutionResultItemsResult& WithTestExecutionResults(TestExecutionResultsT&& value) {
    SetTestExecutionResults(std::forward<TestExecutionResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestExecutionResultItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestExecutionResultItemsResult& WithRequestId(RequestIdT&& value) {
