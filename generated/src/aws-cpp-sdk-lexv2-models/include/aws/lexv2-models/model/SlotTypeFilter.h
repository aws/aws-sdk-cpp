...
class SlotTypeFilter {
 public:
  ...
  inline void SetName(SlotTypeFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline SlotTypeFilter& WithName(SlotTypeFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  SlotTypeFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  SlotTypeFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(SlotTypeFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline SlotTypeFilter& WithOperator(SlotTypeFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
