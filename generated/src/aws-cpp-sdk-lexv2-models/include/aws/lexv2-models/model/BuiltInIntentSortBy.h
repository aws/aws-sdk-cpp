...
class BuiltInIntentSortBy {
 public:
  ...
  inline void SetAttribute(BuiltInIntentSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline BuiltInIntentSortBy& WithAttribute(BuiltInIntentSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline BuiltInIntentSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
