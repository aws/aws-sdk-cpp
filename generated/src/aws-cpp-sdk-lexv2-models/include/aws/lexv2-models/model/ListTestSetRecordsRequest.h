...
class ListTestSetRecordsRequest : public LexModelsV2Request {
 public:
  ...
  template <typename TestSetIdT = Aws::String>
  ListTestSetRecordsRequest& WithTestSetId(TestSetIdT&& value) {
  ...
  inline ListTestSetRecordsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestSetRecordsRequest& WithNextToken(NextTokenT&& value) {
