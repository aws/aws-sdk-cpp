...
class DescribeTestSetDiscrepancyReportResult {
 public:
  ...
  AWS_LEXMODELSV2_API DescribeTestSetDiscrepancyReportResult& operator=(
  ...
  template <typename TestSetDiscrepancyReportIdT = Aws::String>
  DescribeTestSetDiscrepancyReportResult& WithTestSetDiscrepancyReportId(TestSetDiscrepancyReportIdT&& value) {
  ...
  template <typename TestSetIdT = Aws::String>
  DescribeTestSetDiscrepancyReportResult& WithTestSetId(TestSetIdT&& value) {
  ...
  template <typename CreationDateTimeT = Aws::Utils::DateTime>
  DescribeTestSetDiscrepancyReportResult& WithCreationDateTime(CreationDateTimeT&& value) {
  ...
  template <typename TargetT = TestSetDiscrepancyReportResourceTarget>
  DescribeTestSetDiscrepancyReportResult& WithTarget(TargetT&& value) {
  ...
  inline void SetTestSetDiscrepancyReportStatus(TestSetDiscrepancyReportStatus value) {
    m_testSetDiscrepancyReportStatusHasBeenSet = true;
    m_testSetDiscrepancyReportStatus = value;
  }
  inline DescribeTestSetDiscrepancyReportResult& WithTestSetDiscrepancyReportStatus(TestSetDiscrepancyReportStatus value) {
    SetTestSetDiscrepancyReportStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastUpdatedDataTime(LastUpdatedDataTimeT&& value) {
    m_lastUpdatedDataTimeHasBeenSet = true;
    m_lastUpdatedDataTime = std::forward<LastUpdatedDataTimeT>(value);
  }
  template <typename LastUpdatedDataTimeT = Aws::Utils::DateTime>
  DescribeTestSetDiscrepancyReportResult& WithLastUpdatedDataTime(LastUpdatedDataTimeT&& value) {
    SetLastUpdatedDataTime(std::forward<LastUpdatedDataTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestSetDiscrepancyTopErrors(TestSetDiscrepancyTopErrorsT&& value) {
    m_testSetDiscrepancyTopErrorsHasBeenSet = true;
    m_testSetDiscrepancyTopErrors = std::forward<TestSetDiscrepancyTopErrorsT>(value);
  }
  template <typename TestSetDiscrepancyTopErrorsT = TestSetDiscrepancyErrors>
  DescribeTestSetDiscrepancyReportResult& WithTestSetDiscrepancyTopErrors(TestSetDiscrepancyTopErrorsT&& value) {
    SetTestSetDiscrepancyTopErrors(std::forward<TestSetDiscrepancyTopErrorsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTestSetDiscrepancyRawOutputUrl(TestSetDiscrepancyRawOutputUrlT&& value) {
    m_testSetDiscrepancyRawOutputUrlHasBeenSet = true;
    m_testSetDiscrepancyRawOutputUrl = std::forward<TestSetDiscrepancyRawOutputUrlT>(value);
  }
  template <typename TestSetDiscrepancyRawOutputUrlT = Aws::String>
  DescribeTestSetDiscrepancyReportResult& WithTestSetDiscrepancyRawOutputUrl(TestSetDiscrepancyRawOutputUrlT&& value) {
    SetTestSetDiscrepancyRawOutputUrl(std::forward<TestSetDiscrepancyRawOutputUrlT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FailureReasonsT = Aws::Vector<Aws::String>>
  DescribeTestSetDiscrepancyReportResult& WithFailureReasons(FailureReasonsT&& value) {
    SetFailureReasons(std::forward<FailureReasonsT>(value));
    return *this;
  }
  template <typename FailureReasonsT = Aws::String>
  DescribeTestSetDiscrepancyReportResult& AddFailureReasons(FailureReasonsT&& value) {
    m_failureReasonsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeTestSetDiscrepancyReportResult& WithRequestId(RequestIdT&& value) {
