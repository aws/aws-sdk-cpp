...
class ExportFilter {
 public:
  ...
  inline void SetName(ExportFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ExportFilter& WithName(ExportFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ExportFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ExportFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(ExportFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline ExportFilter& WithOperator(ExportFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
