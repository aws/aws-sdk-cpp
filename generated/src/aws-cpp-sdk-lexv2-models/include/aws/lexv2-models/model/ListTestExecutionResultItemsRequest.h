...
class ListTestExecutionResultItemsRequest : public LexModelsV2Request {
 public:
  ...
  template <typename TestExecutionIdT = Aws::String>
  ListTestExecutionResultItemsRequest& WithTestExecutionId(TestExecutionIdT&& value) {
  ...
  void SetResultFilterBy(ResultFilterByT&& value) {
    m_resultFilterByHasBeenSet = true;
    m_resultFilterBy = std::forward<ResultFilterByT>(value);
  }
  template <typename ResultFilterByT = TestExecutionResultFilterBy>
  ListTestExecutionResultItemsRequest& WithResultFilterBy(ResultFilterByT&& value) {
    SetResultFilterBy(std::forward<ResultFilterByT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListTestExecutionResultItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestExecutionResultItemsRequest& WithNextToken(NextTokenT&& value) {
