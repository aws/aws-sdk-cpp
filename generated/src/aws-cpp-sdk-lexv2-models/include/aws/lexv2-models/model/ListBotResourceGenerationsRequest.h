...
class ListBotResourceGenerationsRequest : public LexModelsV2Request {
 public:
  AWS_LEXMODELSV2_API ListBotResourceGenerationsRequest() = default;
  ...
  template <typename BotIdT = Aws::String>
  ListBotResourceGenerationsRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListBotResourceGenerationsRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListBotResourceGenerationsRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename SortByT = GenerationSortBy>
  void SetSortBy(SortByT&& value) {
    m_sortByHasBeenSet = true;
    m_sortBy = std::forward<SortByT>(value);
  }
  template <typename SortByT = GenerationSortBy>
  ListBotResourceGenerationsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListBotResourceGenerationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBotResourceGenerationsRequest& WithNextToken(NextTokenT&& value) {
