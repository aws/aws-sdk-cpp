...
class SlotValueElicitationSetting {
 public:
  ...
  inline SlotValueElicitationSetting& WithSlotConstraint(SlotConstraint value) {
  ...
  void SetSlotCaptureSetting(SlotCaptureSettingT&& value) {
    m_slotCaptureSettingHasBeenSet = true;
    m_slotCaptureSetting = std::forward<SlotCaptureSettingT>(value);
  }
  template <typename SlotCaptureSettingT = SlotCaptureSetting>
  SlotValueElicitationSetting& WithSlotCaptureSetting(SlotCaptureSettingT&& value) {
    SetSlotCaptureSetting(std::forward<SlotCaptureSettingT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlotResolutionSetting(SlotResolutionSettingT&& value) {
    m_slotResolutionSettingHasBeenSet = true;
    m_slotResolutionSetting = std::forward<SlotResolutionSettingT>(value);
  }
  template <typename SlotResolutionSettingT = SlotResolutionSetting>
  SlotValueElicitationSetting& WithSlotResolutionSetting(SlotResolutionSettingT&& value) {
    SetSlotResolutionSetting(std::forward<SlotResolutionSettingT>(value));
    return *this;
  }
  ///@}
 private:
