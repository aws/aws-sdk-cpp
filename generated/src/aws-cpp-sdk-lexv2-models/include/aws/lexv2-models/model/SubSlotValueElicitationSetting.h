...
class SubSlotValueElicitationSetting {
 public:
  ...
  void SetDefaultValueSpecification(DefaultValueSpecificationT&& value) {
    ...
    m_defaultValueSpecification = std::forward<DefaultValueSpecificationT>(value);
  }
  template <typename DefaultValueSpecificationT = SlotDefaultValueSpecification>
  SubSlotValueElicitationSetting& WithDefaultValueSpecification(DefaultValueSpecificationT&& value) {
    SetDefaultValueSpecification(std::forward<DefaultValueSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPromptSpecification(PromptSpecificationT&& value) {
    ...
    m_promptSpecification = std::forward<PromptSpecificationT>(value);
  }
  template <typename PromptSpecificationT = PromptSpecification>
  SubSlotValueElicitationSetting& WithPromptSpecification(PromptSpecificationT&& value) {
    SetPromptSpecification(std::forward<PromptSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SampleUtterancesT = Aws::Vector<SampleUtterance>>
  SubSlotValueElicitationSetting& WithSampleUtterances(SampleUtterancesT&& value) {
    SetSampleUtterances(std::forward<SampleUtterancesT>(value));
    return *this;
  }
  template <typename SampleUtterancesT = SampleUtterance>
  SubSlotValueElicitationSetting& AddSampleUtterances(SampleUtterancesT&& value) {
    m_sampleUtterancesHasBeenSet = true;
  ...
  void SetWaitAndContinueSpecification(WaitAndContinueSpecificationT&& value) {
    ...
    m_waitAndContinueSpecification = std::forward<WaitAndContinueSpecificationT>(value);
  }
  template <typename WaitAndContinueSpecificationT = WaitAndContinueSpecification>
  SubSlotValueElicitationSetting& WithWaitAndContinueSpecification(WaitAndContinueSpecificationT&& value) {
    SetWaitAndContinueSpecification(std::forward<WaitAndContinueSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
