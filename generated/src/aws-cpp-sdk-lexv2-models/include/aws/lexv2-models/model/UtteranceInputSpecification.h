...
class UtteranceInputSpecification {
 public:
  ...
  void SetTextInput(TextInputT&& value) {
    ...
    m_textInput = std::forward<TextInputT>(value);
  }
  template <typename TextInputT = Aws::String>
  UtteranceInputSpecification& WithTextInput(TextInputT&& value) {
    SetTextInput(std::forward<TextInputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAudioInput(AudioInputT&& value) {
    m_audioInputHasBeenSet = true;
    m_audioInput = std::forward<AudioInputT>(value);
  }
  template <typename AudioInputT = UtteranceAudioInputSpecification>
  UtteranceInputSpecification& WithAudioInput(AudioInputT&& value) {
    SetAudioInput(std::forward<AudioInputT>(value));
    return *this;
  }
  ///@}
 private:
