...
class DescribeCustomVocabularyMetadataResult {
 public:
  ...
  AWS_LEXMODELSV2_API DescribeCustomVocabularyMetadataResult& operator=(
  ...
  template <typename BotIdT = Aws::String>
  DescribeCustomVocabularyMetadataResult& WithBotId(BotIdT&& value) {
  ...
  inline DescribeCustomVocabularyMetadataResult& WithCustomVocabularyStatus(CustomVocabularyStatus value) {
