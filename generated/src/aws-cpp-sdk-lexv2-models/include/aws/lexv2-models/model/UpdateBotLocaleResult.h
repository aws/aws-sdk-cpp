...
class UpdateBotLocaleResult {
 public:
  ...
  inline UpdateBotLocaleResult& WithNluIntentConfidenceThreshold(double value) {
  ...
  inline UpdateBotLocaleResult& WithBotLocaleStatus(BotLocaleStatus value) {
  ...
  ///@{
  /**
   * <p>The updated sensitivity level for voice activity detection (VAD) in the bot
   * locale.</p>
   */
  ...
  inline UpdateBotLocaleResult& WithSpeechDetectionSensitivity(SpeechDetectionSensitivity value) {
  ...
  template <typename SpeakerDiarizationSettingsT = SpeakerDiarizationSettings>
  UpdateBotLocaleResult& WithSpeakerDiarizationSettings(SpeakerDiarizationSettingsT&& value) {
