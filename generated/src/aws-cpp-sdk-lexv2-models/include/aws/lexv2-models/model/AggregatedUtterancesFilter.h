...
class AggregatedUtterancesFilter {
 public:
  ...
  inline void SetName(AggregatedUtterancesFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AggregatedUtterancesFilter& WithName(AggregatedUtterancesFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AggregatedUtterancesFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AggregatedUtterancesFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(AggregatedUtterancesFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline AggregatedUtterancesFilter& WithOperator(AggregatedUtterancesFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
