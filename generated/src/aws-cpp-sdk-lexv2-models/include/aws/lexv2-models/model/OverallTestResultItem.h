...
class OverallTestResultItem {
 public:
  ...
  inline void SetMultiTurnConversation(bool value) {
    m_multiTurnConversationHasBeenSet = true;
    m_multiTurnConversation = value;
  }
  inline OverallTestResultItem& WithMultiTurnConversation(bool value) {
    SetMultiTurnConversation(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalResultCount(int value) {
    m_totalResultCountHasBeenSet = true;
    m_totalResultCount = value;
  }
  inline OverallTestResultItem& WithTotalResultCount(int value) {
   ...
   */
  inline const Aws::Map<TestResultMatchStatus, int>& GetSpeechTranscriptionResultCounts() const {
    return m_speechTranscriptionResultCounts;
  }
  ...
  void SetSpeechTranscriptionResultCounts(SpeechTranscriptionResultCountsT&& value) {
    ...
    m_speechTranscriptionResultCounts = std::forward<SpeechTranscriptionResultCountsT>(value);
  }
  template <typename SpeechTranscriptionResultCountsT = Aws::Map<TestResultMatchStatus, int>>
  OverallTestResultItem& WithSpeechTranscriptionResultCounts(SpeechTranscriptionResultCountsT&& value) {
    SetSpeechTranscriptionResultCounts(std::forward<SpeechTranscriptionResultCountsT>(value));
    return *this;
  }
  inline OverallTestResultItem& AddSpeechTranscriptionResultCounts(TestResultMatchStatus key, int value) {
    m_speechTranscriptionResultCountsHasBeenSet = true;
    m_speechTranscriptionResultCounts.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  void SetEndToEndResultCounts(EndToEndResultCountsT&& value) {
    ...
    m_endToEndResultCounts = std::forward<EndToEndResultCountsT>(value);
  }
  template <typename EndToEndResultCountsT = Aws::Map<TestResultMatchStatus, int>>
  OverallTestResultItem& WithEndToEndResultCounts(EndToEndResultCountsT&& value) {
    SetEndToEndResultCounts(std::forward<EndToEndResultCountsT>(value));
    return *this;
  }
  inline OverallTestResultItem& AddEndToEndResultCounts(TestResultMatchStatus key, int value) {
    m_endToEndResultCountsHasBeenSet = true;
    m_endToEndResultCounts.emplace(key, value);
    return *this;
  }
  ///@}
 private:
