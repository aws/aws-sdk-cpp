...
class WaitAndContinueSpecification {
 public:
  ...
  void SetWaitingResponse(WaitingResponseT&& value) {
    ...
    m_waitingResponse = std::forward<WaitingResponseT>(value);
  }
  template <typename WaitingResponseT = ResponseSpecification>
  WaitAndContinueSpecification& WithWaitingResponse(WaitingResponseT&& value) {
    SetWaitingResponse(std::forward<WaitingResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContinueResponse(ContinueResponseT&& value) {
    ...
    m_continueResponse = std::forward<ContinueResponseT>(value);
  }
  template <typename ContinueResponseT = ResponseSpecification>
  WaitAndContinueSpecification& WithContinueResponse(ContinueResponseT&& value) {
    SetContinueResponse(std::forward<ContinueResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetStillWaitingResponse(StillWaitingResponseT&& value) {
    ...
    m_stillWaitingResponse = std::forward<StillWaitingResponseT>(value);
  }
  template <typename StillWaitingResponseT = StillWaitingResponseSpecification>
  WaitAndContinueSpecification& WithStillWaitingResponse(StillWaitingResponseT&& value) {
    SetStillWaitingResponse(std::forward<StillWaitingResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline WaitAndContinueSpecification& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
