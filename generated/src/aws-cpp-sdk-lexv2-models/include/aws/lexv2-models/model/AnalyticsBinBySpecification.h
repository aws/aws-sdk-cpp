...
class AnalyticsBinBySpecification {
 public:
  ...
  inline AnalyticsBinBySpecification& WithName(AnalyticsBinByName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInterval(AnalyticsInterval value) {
    m_intervalHasBeenSet = true;
    m_interval = value;
  }
  inline AnalyticsBinBySpecification& WithInterval(AnalyticsInterval value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsBinBySpecification& WithOrder(AnalyticsSortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
