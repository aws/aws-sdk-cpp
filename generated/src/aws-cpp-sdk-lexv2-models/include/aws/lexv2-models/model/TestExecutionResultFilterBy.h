...
class TestExecutionResultFilterBy {
 public:
  ...
  inline void SetResultTypeFilter(TestResultTypeFilter value) {
    m_resultTypeFilterHasBeenSet = true;
    m_resultTypeFilter = value;
  }
  inline TestExecutionResultFilterBy& WithResultTypeFilter(TestResultTypeFilter value) {
   ...
   * results.</p>
   */
  inline const ConversationLevelTestResultsFilterBy& GetConversationLevelTestResultsFilterBy() const {
    return m_conversationLevelTestResultsFilterBy;
  }
  ...
  void SetConversationLevelTestResultsFilterBy(ConversationLevelTestResultsFilterByT&& value) {
    m_conversationLevelTestResultsFilterByHasBeenSet = true;
    m_conversationLevelTestResultsFilterBy = std::forward<ConversationLevelTestResultsFilterByT>(value);
  }
  template <typename ConversationLevelTestResultsFilterByT = ConversationLevelTestResultsFilterBy>
  TestExecutionResultFilterBy& WithConversationLevelTestResultsFilterBy(ConversationLevelTestResultsFilterByT&& value) {
    SetConversationLevelTestResultsFilterBy(std::forward<ConversationLevelTestResultsFilterByT>(value));
    return *this;
  }
  ///@}
 private:
