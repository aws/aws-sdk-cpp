...
class S3BucketTranscriptSource {
 public:
  ...
  template <typename S3BucketNameT = Aws::String>
  S3BucketTranscriptSource& WithS3BucketName(S3BucketNameT&& value) {
  ...
  void SetPathFormat(PathFormatT&& value) {
    m_pathFormatHasBeenSet = true;
    m_pathFormat = std::forward<PathFormatT>(value);
  }
  template <typename PathFormatT = PathFormat>
  S3BucketTranscriptSource& WithPathFormat(PathFormatT&& value) {
    SetPathFormat(std::forward<PathFormatT>(value));
    return *this;
  }
  ///@}
  ...
  inline S3BucketTranscriptSource& WithTranscriptFormat(TranscriptFormat value) {
  ...
  void SetTranscriptFilter(TranscriptFilterT&& value) {
    ...
    m_transcriptFilter = std::forward<TranscriptFilterT>(value);
  }
  template <typename TranscriptFilterT = TranscriptFilter>
  S3BucketTranscriptSource& WithTranscriptFilter(TranscriptFilterT&& value) {
    SetTranscriptFilter(std::forward<TranscriptFilterT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename KmsKeyArnT = Aws::String>
  S3BucketTranscriptSource& WithKmsKeyArn(KmsKeyArnT&& value) {
