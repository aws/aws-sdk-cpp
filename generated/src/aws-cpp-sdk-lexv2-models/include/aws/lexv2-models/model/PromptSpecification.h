...
class PromptSpecification {
 public:
  ...
  inline PromptSpecification& WithMaxRetries(int value) {
    SetMaxRetries(value);
    return *this;
  }
  ///@}
  ...
  inline PromptSpecification& WithAllowInterrupt(bool value) {
  ...
  inline void SetMessageSelectionStrategy(MessageSelectionStrategy value) {
    m_messageSelectionStrategyHasBeenSet = true;
    m_messageSelectionStrategy = value;
  }
  inline PromptSpecification& WithMessageSelectionStrategy(MessageSelectionStrategy value) {
    SetMessageSelectionStrategy(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Map<PromptAttempt, PromptAttemptSpecification>& GetPromptAttemptsSpecification() const {
    return m_promptAttemptsSpecification;
  }
  ...
  void SetPromptAttemptsSpecification(PromptAttemptsSpecificationT&& value) {
    ...
    m_promptAttemptsSpecification = std::forward<PromptAttemptsSpecificationT>(value);
  }
  template <typename PromptAttemptsSpecificationT = Aws::Map<PromptAttempt, PromptAttemptSpecification>>
  PromptSpecification& WithPromptAttemptsSpecification(PromptAttemptsSpecificationT&& value) {
    SetPromptAttemptsSpecification(std::forward<PromptAttemptsSpecificationT>(value));
    return *this;
  }
  inline PromptSpecification& AddPromptAttemptsSpecification(PromptAttempt key, PromptAttemptSpecification value) {
    m_promptAttemptsSpecificationHasBeenSet = true;
    m_promptAttemptsSpecification.emplace(key, value);
    return *this;
  }
  ///@}
 private:
