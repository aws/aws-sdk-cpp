...
class ListBotsResult {
 public:
  ...
  void SetBotSummaries(BotSummariesT&& value) {
    m_botSummariesHasBeenSet = true;
    m_botSummaries = std::forward<BotSummariesT>(value);
  }
  template <typename BotSummariesT = Aws::Vector<BotSummary>>
  ListBotsResult& WithBotSummaries(BotSummariesT&& value) {
    SetBotSummaries(std::forward<BotSummariesT>(value));
    return *this;
  }
  template <typename BotSummariesT = BotSummary>
  ListBotsResult& AddBotSummaries(BotSummariesT&& value) {
    m_botSummariesHasBeenSet = true;
    m_botSummaries.emplace_back(std::forward<BotSummariesT>(value));
    return *this;
  }
  ///@}
