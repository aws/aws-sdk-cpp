...
class AggregatedUtterancesSummary {
 public:
  ...
  void SetUtterance(UtteranceT&& value) {
    ...
    m_utterance = std::forward<UtteranceT>(value);
  }
  template <typename UtteranceT = Aws::String>
  AggregatedUtterancesSummary& WithUtterance(UtteranceT&& value) {
    SetUtterance(std::forward<UtteranceT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetHitCount(int value) {
    m_hitCountHasBeenSet = true;
    m_hitCount = value;
  }
  inline AggregatedUtterancesSummary& WithHitCount(int value) {
    SetHitCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMissedCount(int value) {
    m_missedCountHasBeenSet = true;
    m_missedCount = value;
  }
  inline AggregatedUtterancesSummary& WithMissedCount(int value) {
   ...
   */
  inline const Aws::Utils::DateTime& GetUtteranceFirstRecordedInAggregationDuration() const {
    return m_utteranceFirstRecordedInAggregationDuration;
  }
  inline bool UtteranceFirstRecordedInAggregationDurationHasBeenSet() const {
    return m_utteranceFirstRecordedInAggregationDurationHasBeenSet;
  }
  ...
  void SetUtteranceFirstRecordedInAggregationDuration(UtteranceFirstRecordedInAggregationDurationT&& value) {
    ...
    m_utteranceFirstRecordedInAggregationDuration = std::forward<UtteranceFirstRecordedInAggregationDurationT>(value);
  }
  template <typename UtteranceFirstRecordedInAggregationDurationT = Aws::Utils::DateTime>
  AggregatedUtterancesSummary& WithUtteranceFirstRecordedInAggregationDuration(UtteranceFirstRecordedInAggregationDurationT&& value) {
    SetUtteranceFirstRecordedInAggregationDuration(std::forward<UtteranceFirstRecordedInAggregationDurationT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Utils::DateTime& GetUtteranceLastRecordedInAggregationDuration() const {
    return m_utteranceLastRecordedInAggregationDuration;
  }
  inline bool UtteranceLastRecordedInAggregationDurationHasBeenSet() const {
    return m_utteranceLastRecordedInAggregationDurationHasBeenSet;
  }
  ...
  void SetUtteranceLastRecordedInAggregationDuration(UtteranceLastRecordedInAggregationDurationT&& value) {
    ...
    m_utteranceLastRecordedInAggregationDuration = std::forward<UtteranceLastRecordedInAggregationDurationT>(value);
  }
  template <typename UtteranceLastRecordedInAggregationDurationT = Aws::Utils::DateTime>
  AggregatedUtterancesSummary& WithUtteranceLastRecordedInAggregationDuration(UtteranceLastRecordedInAggregationDurationT&& value) {
    SetUtteranceLastRecordedInAggregationDuration(std::forward<UtteranceLastRecordedInAggregationDurationT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContainsDataFromDeletedResources(bool value) {
    m_containsDataFromDeletedResourcesHasBeenSet = true;
    m_containsDataFromDeletedResources = value;
  }
  inline AggregatedUtterancesSummary& WithContainsDataFromDeletedResources(bool value) {
    SetContainsDataFromDeletedResources(value);
    return *this;
  }
  ///@}
 private:
