...
class RuntimeHintDetails {
 public:
  ...
  void SetRuntimeHintValues(RuntimeHintValuesT&& value) {
    ...
    m_runtimeHintValues = std::forward<RuntimeHintValuesT>(value);
  }
  template <typename RuntimeHintValuesT = Aws::Vector<RuntimeHintValue>>
  RuntimeHintDetails& WithRuntimeHintValues(RuntimeHintValuesT&& value) {
    SetRuntimeHintValues(std::forward<RuntimeHintValuesT>(value));
    return *this;
  }
  template <typename RuntimeHintValuesT = RuntimeHintValue>
  RuntimeHintDetails& AddRuntimeHintValues(RuntimeHintValuesT&& value) {
    m_runtimeHintValuesHasBeenSet = true;
    m_runtimeHintValues.emplace_back(std::forward<RuntimeHintValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubSlotHints(SubSlotHintsT&& value) {
    ...
    m_subSlotHints = std::forward<SubSlotHintsT>(value);
  }
  template <typename SubSlotHintsT = Aws::Map<Aws::String, RuntimeHintDetails>>
  RuntimeHintDetails& WithSubSlotHints(SubSlotHintsT&& value) {
    SetSubSlotHints(std::forward<SubSlotHintsT>(value));
    return *this;
  }
  ...
  RuntimeHintDetails& AddSubSlotHints(SubSlotHintsKeyT&& key, SubSlotHintsValueT&& value) {
    m_subSlotHintsHasBeenSet = true;
    m_subSlotHints.emplace(std::forward<SubSlotHintsKeyT>(key), std::forward<SubSlotHintsValueT>(value));
    return *this;
  }
  ///@}
 private:
