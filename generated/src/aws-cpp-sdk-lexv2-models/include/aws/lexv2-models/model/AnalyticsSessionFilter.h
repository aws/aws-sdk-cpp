...
class AnalyticsSessionFilter {
 public:
  ...
  inline void SetName(AnalyticsSessionFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsSessionFilter& WithName(AnalyticsSessionFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline AnalyticsSessionFilter& WithOperator(AnalyticsFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AnalyticsSessionFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AnalyticsSessionFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
