...
class UserTurnInputSpecification {
 public:
  ...
  void SetUtteranceInput(UtteranceInputT&& value) {
    m_utteranceInputHasBeenSet = true;
    m_utteranceInput = std::forward<UtteranceInputT>(value);
  }
  template <typename UtteranceInputT = UtteranceInputSpecification>
  UserTurnInputSpecification& WithUtteranceInput(UtteranceInputT&& value) {
    SetUtteranceInput(std::forward<UtteranceInputT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestAttributesT = Aws::Map<Aws::String, Aws::String>>
  UserTurnInputSpecification& WithRequestAttributes(RequestAttributesT&& value) {
  ...
  template <typename SessionStateT = InputSessionStateSpecification>
  UserTurnInputSpecification& WithSessionState(SessionStateT&& value) {
