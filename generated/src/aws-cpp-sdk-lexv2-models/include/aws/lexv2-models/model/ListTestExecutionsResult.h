...
class ListTestExecutionsResult {
 public:
  ...
  void SetTestExecutions(TestExecutionsT&& value) {
    m_testExecutionsHasBeenSet = true;
    m_testExecutions = std::forward<TestExecutionsT>(value);
  }
  template <typename TestExecutionsT = Aws::Vector<TestExecutionSummary>>
  ListTestExecutionsResult& WithTestExecutions(TestExecutionsT&& value) {
    SetTestExecutions(std::forward<TestExecutionsT>(value));
    return *this;
  }
  template <typename TestExecutionsT = TestExecutionSummary>
  ListTestExecutionsResult& AddTestExecutions(TestExecutionsT&& value) {
    m_testExecutionsHasBeenSet = true;
    m_testExecutions.emplace_back(std::forward<TestExecutionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestExecutionsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestExecutionsResult& WithRequestId(RequestIdT&& value) {
