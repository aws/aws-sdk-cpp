...
class GenerativeAISettings {
 public:
  ...
  void SetRuntimeSettings(RuntimeSettingsT&& value) {
    ...
    m_runtimeSettings = std::forward<RuntimeSettingsT>(value);
  }
  template <typename RuntimeSettingsT = RuntimeSettings>
  GenerativeAISettings& WithRuntimeSettings(RuntimeSettingsT&& value) {
    SetRuntimeSettings(std::forward<RuntimeSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBuildtimeSettings(BuildtimeSettingsT&& value) {
    ...
    m_buildtimeSettings = std::forward<BuildtimeSettingsT>(value);
  }
  template <typename BuildtimeSettingsT = BuildtimeSettings>
  GenerativeAISettings& WithBuildtimeSettings(BuildtimeSettingsT&& value) {
    SetBuildtimeSettings(std::forward<BuildtimeSettingsT>(value));
    return *this;
  }
  ///@}
 private:
