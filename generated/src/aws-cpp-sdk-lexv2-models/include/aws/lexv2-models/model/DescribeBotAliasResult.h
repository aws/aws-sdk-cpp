...
class DescribeBotAliasResult {
 public:
  ...
  void SetBotAliasName(BotAliasNameT&& value) {
    ...
    m_botAliasName = std::forward<BotAliasNameT>(value);
  }
  template <typename BotAliasNameT = Aws::String>
  DescribeBotAliasResult& WithBotAliasName(BotAliasNameT&& value) {
    SetBotAliasName(std::forward<BotAliasNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotAliasLocaleSettings(BotAliasLocaleSettingsT&& value) {
    ...
    m_botAliasLocaleSettings = std::forward<BotAliasLocaleSettingsT>(value);
  }
  template <typename BotAliasLocaleSettingsT = Aws::Map<Aws::String, BotAliasLocaleSettings>>
  DescribeBotAliasResult& WithBotAliasLocaleSettings(BotAliasLocaleSettingsT&& value) {
    SetBotAliasLocaleSettings(std::forward<BotAliasLocaleSettingsT>(value));
    return *this;
  }
  ...
  DescribeBotAliasResult& AddBotAliasLocaleSettings(BotAliasLocaleSettingsKeyT&& key, BotAliasLocaleSettingsValueT&& value) {
    m_botAliasLocaleSettingsHasBeenSet = true;
    m_botAliasLocaleSettings.emplace(std::forward<BotAliasLocaleSettingsKeyT>(key), std::forward<BotAliasLocaleSettingsValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConversationLogSettings(ConversationLogSettingsT&& value) {
    ...
    m_conversationLogSettings = std::forward<ConversationLogSettingsT>(value);
  }
  template <typename ConversationLogSettingsT = ConversationLogSettings>
  DescribeBotAliasResult& WithConversationLogSettings(ConversationLogSettingsT&& value) {
    SetConversationLogSettings(std::forward<ConversationLogSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSentimentAnalysisSettings(SentimentAnalysisSettingsT&& value) {
    ...
    m_sentimentAnalysisSettings = std::forward<SentimentAnalysisSettingsT>(value);
  }
  template <typename SentimentAnalysisSettingsT = SentimentAnalysisSettings>
  DescribeBotAliasResult& WithSentimentAnalysisSettings(SentimentAnalysisSettingsT&& value) {
    SetSentimentAnalysisSettings(std::forward<SentimentAnalysisSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotAliasHistoryEvents(BotAliasHistoryEventsT&& value) {
    ...
    m_botAliasHistoryEvents = std::forward<BotAliasHistoryEventsT>(value);
  }
  template <typename BotAliasHistoryEventsT = Aws::Vector<BotAliasHistoryEvent>>
  DescribeBotAliasResult& WithBotAliasHistoryEvents(BotAliasHistoryEventsT&& value) {
    SetBotAliasHistoryEvents(std::forward<BotAliasHistoryEventsT>(value));
    return *this;
  }
  ...
  DescribeBotAliasResult& AddBotAliasHistoryEvents(BotAliasHistoryEventsT&& value) {
    m_botAliasHistoryEventsHasBeenSet = true;
    m_botAliasHistoryEvents.emplace_back(std::forward<BotAliasHistoryEventsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBotAliasResult& WithBotAliasStatus(BotAliasStatus value) {
  ...
  void SetParentBotNetworks(ParentBotNetworksT&& value) {
    ...
    m_parentBotNetworks = std::forward<ParentBotNetworksT>(value);
  }
  template <typename ParentBotNetworksT = Aws::Vector<ParentBotNetwork>>
  DescribeBotAliasResult& WithParentBotNetworks(ParentBotNetworksT&& value) {
    SetParentBotNetworks(std::forward<ParentBotNetworksT>(value));
    return *this;
  }
  ...
  DescribeBotAliasResult& AddParentBotNetworks(ParentBotNetworksT&& value) {
    m_parentBotNetworksHasBeenSet = true;
    m_parentBotNetworks.emplace_back(std::forward<ParentBotNetworksT>(value));
    return *this;
  }
  ///@}
