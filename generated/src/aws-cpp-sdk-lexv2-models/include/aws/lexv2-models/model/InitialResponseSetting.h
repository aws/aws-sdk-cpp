...
class InitialResponseSetting {
 public:
  ...
  void SetInitialResponse(InitialResponseT&& value) {
    ...
    m_initialResponse = std::forward<InitialResponseT>(value);
  }
  template <typename InitialResponseT = ResponseSpecification>
  InitialResponseSetting& WithInitialResponse(InitialResponseT&& value) {
    SetInitialResponse(std::forward<InitialResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNextStep(NextStepT&& value) {
    ...
    m_nextStep = std::forward<NextStepT>(value);
  }
  template <typename NextStepT = DialogState>
  InitialResponseSetting& WithNextStep(NextStepT&& value) {
    SetNextStep(std::forward<NextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConditional(ConditionalT&& value) {
    ...
    m_conditional = std::forward<ConditionalT>(value);
  }
  template <typename ConditionalT = ConditionalSpecification>
  InitialResponseSetting& WithConditional(ConditionalT&& value) {
    SetConditional(std::forward<ConditionalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCodeHook(CodeHookT&& value) {
    ...
    m_codeHook = std::forward<CodeHookT>(value);
  }
  template <typename CodeHookT = DialogCodeHookInvocationSetting>
  InitialResponseSetting& WithCodeHook(CodeHookT&& value) {
    SetCodeHook(std::forward<CodeHookT>(value));
    return *this;
  }
  ///@}
 private:
