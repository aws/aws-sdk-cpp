...
class AnalyticsIntentNodeSummary {
 public:
  ...
  void SetIntentPath(IntentPathT&& value) {
    ...
    m_intentPath = std::forward<IntentPathT>(value);
  }
  template <typename IntentPathT = Aws::String>
  AnalyticsIntentNodeSummary& WithIntentPath(IntentPathT&& value) {
    SetIntentPath(std::forward<IntentPathT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIntentCount(int value) {
    m_intentCountHasBeenSet = true;
    m_intentCount = value;
  }
  inline AnalyticsIntentNodeSummary& WithIntentCount(int value) {
  ...
  inline void SetIntentLevel(int value) {
    m_intentLevelHasBeenSet = true;
    m_intentLevel = value;
  }
  inline AnalyticsIntentNodeSummary& WithIntentLevel(int value) {
  ...
  inline void SetNodeType(AnalyticsNodeType value) {
    m_nodeTypeHasBeenSet = true;
    m_nodeType = value;
  }
  inline AnalyticsIntentNodeSummary& WithNodeType(AnalyticsNodeType value) {
    SetNodeType(value);
    return *this;
  }
  ///@}
