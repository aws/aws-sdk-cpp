...
class ListSessionAnalyticsDataRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListSessionAnalyticsDataRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename StartDateTimeT = Aws::Utils::DateTime>
  ListSessionAnalyticsDataRequest& WithStartDateTime(StartDateTimeT&& value) {
  ...
  template <typename EndDateTimeT = Aws::Utils::DateTime>
  ListSessionAnalyticsDataRequest& WithEndDateTime(EndDateTimeT&& value) {
  ...
  template <typename SortByT = SessionDataSortBy>
  ListSessionAnalyticsDataRequest& WithSortBy(SortByT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<AnalyticsSessionFilter>>
  ListSessionAnalyticsDataRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = AnalyticsSessionFilter>
  ListSessionAnalyticsDataRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListSessionAnalyticsDataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSessionAnalyticsDataRequest& WithNextToken(NextTokenT&& value) {
