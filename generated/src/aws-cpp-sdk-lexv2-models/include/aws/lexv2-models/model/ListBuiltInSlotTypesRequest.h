...
class ListBuiltInSlotTypesRequest : public LexModelsV2Request {
 public:
  ...
  template <typename LocaleIdT = Aws::String>
  ListBuiltInSlotTypesRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename SortByT = BuiltInSlotTypeSortBy>
  ListBuiltInSlotTypesRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListBuiltInSlotTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBuiltInSlotTypesRequest& WithNextToken(NextTokenT&& value) {
