...
class UpdateSlotTypeRequest : public LexModelsV2Request {
 public:
  ...
  template <typename SlotTypeIdT = Aws::String>
  UpdateSlotTypeRequest& WithSlotTypeId(SlotTypeIdT&& value) {
  ...
  template <typename SlotTypeNameT = Aws::String>
  UpdateSlotTypeRequest& WithSlotTypeName(SlotTypeNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  UpdateSlotTypeRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename SlotTypeValuesT = Aws::Vector<SlotTypeValue>>
  UpdateSlotTypeRequest& WithSlotTypeValues(SlotTypeValuesT&& value) {
    SetSlotTypeValues(std::forward<SlotTypeValuesT>(value));
    return *this;
  }
  template <typename SlotTypeValuesT = SlotTypeValue>
  UpdateSlotTypeRequest& AddSlotTypeValues(SlotTypeValuesT&& value) {
    m_slotTypeValuesHasBeenSet = true;
  ...
  template <typename ValueSelectionSettingT = SlotValueSelectionSetting>
  UpdateSlotTypeRequest& WithValueSelectionSetting(ValueSelectionSettingT&& value) {
  ...
  template <typename ParentSlotTypeSignatureT = Aws::String>
  UpdateSlotTypeRequest& WithParentSlotTypeSignature(ParentSlotTypeSignatureT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  UpdateSlotTypeRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  UpdateSlotTypeRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  UpdateSlotTypeRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename ExternalSourceSettingT = ExternalSourceSetting>
  UpdateSlotTypeRequest& WithExternalSourceSetting(ExternalSourceSettingT&& value) {
  ...
  template <typename CompositeSlotTypeSettingT = CompositeSlotTypeSetting>
  UpdateSlotTypeRequest& WithCompositeSlotTypeSetting(CompositeSlotTypeSettingT&& value) {
