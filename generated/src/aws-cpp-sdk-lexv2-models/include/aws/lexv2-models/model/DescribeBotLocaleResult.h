...
class DescribeBotLocaleResult {
 public:
  ...
  void SetLocaleName(LocaleNameT&& value) {
    ...
    m_localeName = std::forward<LocaleNameT>(value);
  }
  template <typename LocaleNameT = Aws::String>
  DescribeBotLocaleResult& WithLocaleName(LocaleNameT&& value) {
    SetLocaleName(std::forward<LocaleNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeBotLocaleResult& WithNluIntentConfidenceThreshold(double value) {
  ...
  inline void SetIntentsCount(int value) {
    m_intentsCountHasBeenSet = true;
    m_intentsCount = value;
  }
  inline DescribeBotLocaleResult& WithIntentsCount(int value) {
    SetIntentsCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSlotTypesCount(int value) {
    m_slotTypesCountHasBeenSet = true;
    m_slotTypesCount = value;
  }
  inline DescribeBotLocaleResult& WithSlotTypesCount(int value) {
    SetSlotTypesCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetBotLocaleStatus(BotLocaleStatus value) {
    m_botLocaleStatusHasBeenSet = true;
    m_botLocaleStatus = value;
  }
  inline DescribeBotLocaleResult& WithBotLocaleStatus(BotLocaleStatus value) {
    SetBotLocaleStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastBuildSubmittedDateTime(LastBuildSubmittedDateTimeT&& value) {
    ...
    m_lastBuildSubmittedDateTime = std::forward<LastBuildSubmittedDateTimeT>(value);
  }
  template <typename LastBuildSubmittedDateTimeT = Aws::Utils::DateTime>
  DescribeBotLocaleResult& WithLastBuildSubmittedDateTime(LastBuildSubmittedDateTimeT&& value) {
    SetLastBuildSubmittedDateTime(std::forward<LastBuildSubmittedDateTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBotLocaleHistoryEvents(BotLocaleHistoryEventsT&& value) {
    ...
    m_botLocaleHistoryEvents = std::forward<BotLocaleHistoryEventsT>(value);
  }
  template <typename BotLocaleHistoryEventsT = Aws::Vector<BotLocaleHistoryEvent>>
  DescribeBotLocaleResult& WithBotLocaleHistoryEvents(BotLocaleHistoryEventsT&& value) {
    SetBotLocaleHistoryEvents(std::forward<BotLocaleHistoryEventsT>(value));
    return *this;
  }
  ...
  DescribeBotLocaleResult& AddBotLocaleHistoryEvents(BotLocaleHistoryEventsT&& value) {
    m_botLocaleHistoryEventsHasBeenSet = true;
    m_botLocaleHistoryEvents.emplace_back(std::forward<BotLocaleHistoryEventsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SpeakerDiarizationSettingsT = SpeakerDiarizationSettings>
  DescribeBotLocaleResult& WithSpeakerDiarizationSettings(SpeakerDiarizationSettingsT&& value) {
