...
class BuiltInSlotTypeSummary {
 public:
  ...
  void SetSlotTypeSignature(SlotTypeSignatureT&& value) {
    m_slotTypeSignatureHasBeenSet = true;
    m_slotTypeSignature = std::forward<SlotTypeSignatureT>(value);
  }
  template <typename SlotTypeSignatureT = Aws::String>
  BuiltInSlotTypeSummary& WithSlotTypeSignature(SlotTypeSignatureT&& value) {
    SetSlotTypeSignature(std::forward<SlotTypeSignatureT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  BuiltInSlotTypeSummary& WithDescription(DescriptionT&& value) {
