...
class BotLocaleSortBy {
 public:
  ...
  inline void SetAttribute(BotLocaleSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline BotLocaleSortBy& WithAttribute(BotLocaleSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline BotLocaleSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
