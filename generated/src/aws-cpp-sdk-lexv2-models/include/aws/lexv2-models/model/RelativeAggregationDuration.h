...
class RelativeAggregationDuration {
 public:
  ...
  inline void SetTimeDimension(TimeDimension value) {
    m_timeDimensionHasBeenSet = true;
    m_timeDimension = value;
  }
  inline RelativeAggregationDuration& WithTimeDimension(TimeDimension value) {
  ...
  inline RelativeAggregationDuration& WithTimeValue(int value) {
    SetTimeValue(value);
    return *this;
  }
  ///@}
