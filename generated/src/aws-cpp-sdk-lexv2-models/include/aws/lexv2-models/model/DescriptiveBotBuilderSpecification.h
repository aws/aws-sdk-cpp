...
class DescriptiveBotBuilderSpecification {
 public:
  ...
  inline DescriptiveBotBuilderSpecification& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename BedrockModelSpecificationT = BedrockModelSpecification>
  DescriptiveBotBuilderSpecification& WithBedrockModelSpecification(BedrockModelSpecificationT&& value) {
