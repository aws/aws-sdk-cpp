...
class DeleteImportResult {
 public:
  ...
  template <typename ImportIdT = Aws::String>
  DeleteImportResult& WithImportId(ImportIdT&& value) {
  ...
  inline DeleteImportResult& WithImportStatus(ImportStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteImportResult& WithRequestId(RequestIdT&& value) {
