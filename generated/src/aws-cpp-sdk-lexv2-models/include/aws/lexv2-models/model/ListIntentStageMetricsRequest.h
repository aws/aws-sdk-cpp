...
class ListIntentStageMetricsRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListIntentStageMetricsRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename StartDateTimeT = Aws::Utils::DateTime>
  ListIntentStageMetricsRequest& WithStartDateTime(StartDateTimeT&& value) {
  ...
  template <typename EndDateTimeT = Aws::Utils::DateTime>
  ListIntentStageMetricsRequest& WithEndDateTime(EndDateTimeT&& value) {
  ...
  template <typename MetricsT = Aws::Vector<AnalyticsIntentStageMetric>>
  ListIntentStageMetricsRequest& WithMetrics(MetricsT&& value) {
    SetMetrics(std::forward<MetricsT>(value));
    return *this;
  }
  template <typename MetricsT = AnalyticsIntentStageMetric>
  ListIntentStageMetricsRequest& AddMetrics(MetricsT&& value) {
    m_metricsHasBeenSet = true;
  ...
  template <typename BinByT = Aws::Vector<AnalyticsBinBySpecification>>
  ListIntentStageMetricsRequest& WithBinBy(BinByT&& value) {
    SetBinBy(std::forward<BinByT>(value));
    return *this;
  }
  template <typename BinByT = AnalyticsBinBySpecification>
  ListIntentStageMetricsRequest& AddBinBy(BinByT&& value) {
    m_binByHasBeenSet = true;
  ...
  template <typename GroupByT = Aws::Vector<AnalyticsIntentStageGroupBySpecification>>
  ListIntentStageMetricsRequest& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  template <typename GroupByT = AnalyticsIntentStageGroupBySpecification>
  ListIntentStageMetricsRequest& AddGroupBy(GroupByT&& value) {
    m_groupByHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<AnalyticsIntentStageFilter>>
  ListIntentStageMetricsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = AnalyticsIntentStageFilter>
  ListIntentStageMetricsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListIntentStageMetricsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListIntentStageMetricsRequest& WithNextToken(NextTokenT&& value) {
