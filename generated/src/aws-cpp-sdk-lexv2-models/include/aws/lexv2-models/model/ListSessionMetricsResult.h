...
class ListSessionMetricsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListSessionMetricsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsSessionResult>>
  ListSessionMetricsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsSessionResult>
  ListSessionMetricsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSessionMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListSessionMetricsResult& WithRequestId(RequestIdT&& value) {
