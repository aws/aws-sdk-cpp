...
namespace Model
{
  ...
  public:
    ...
    template<typename BotNameT = Aws::String>
    CreateBotRequest& WithBotName(BotNameT&& value) { SetBotName(std::forward<BotNameT>(value)); return *this;}
    ///@}
    ...
    template<typename DescriptionT = Aws::String>
    CreateBotRequest& WithDescription(DescriptionT&& value) { SetDescription(std::forward<DescriptionT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    CreateBotRequest& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename DataPrivacyT = DataPrivacy>
    CreateBotRequest& WithDataPrivacy(DataPrivacyT&& value) { SetDataPrivacy(std::forward<DataPrivacyT>(value)); return *this;}
    ///@}
    ...
    template<typename BotTagsT = Aws::Map<Aws::String, Aws::String>>
    CreateBotRequest& WithBotTags(BotTagsT&& value) { SetBotTags(std::forward<BotTagsT>(value)); return *this;}
    ...
    template<typename TestBotAliasTagsT = Aws::Map<Aws::String, Aws::String>>
    CreateBotRequest& WithTestBotAliasTags(TestBotAliasTagsT&& value) { SetTestBotAliasTags(std::forward<TestBotAliasTagsT>(value)); return *this;}
    ...
    inline CreateBotRequest& WithBotType(BotType value) { SetBotType(value); return *this;}
    ///@}
    ...
    template<typename BotMembersT = Aws::Vector<BotMember>>
    CreateBotRequest& WithBotMembers(BotMembersT&& value) { SetBotMembers(std::forward<BotMembersT>(value)); return *this;}
