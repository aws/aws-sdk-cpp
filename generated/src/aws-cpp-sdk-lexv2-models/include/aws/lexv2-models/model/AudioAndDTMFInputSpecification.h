...
class AudioAndDTMFInputSpecification {
 public:
  ...
  inline AudioAndDTMFInputSpecification& WithStartTimeoutMs(int value) {
  ...
  void SetAudioSpecification(AudioSpecificationT&& value) {
    m_audioSpecificationHasBeenSet = true;
    m_audioSpecification = std::forward<AudioSpecificationT>(value);
  }
  template <typename AudioSpecificationT = AudioSpecification>
  AudioAndDTMFInputSpecification& WithAudioSpecification(AudioSpecificationT&& value) {
    SetAudioSpecification(std::forward<AudioSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDtmfSpecification(DtmfSpecificationT&& value) {
    m_dtmfSpecificationHasBeenSet = true;
    m_dtmfSpecification = std::forward<DtmfSpecificationT>(value);
  }
  template <typename DtmfSpecificationT = DTMFSpecification>
  AudioAndDTMFInputSpecification& WithDtmfSpecification(DtmfSpecificationT&& value) {
    SetDtmfSpecification(std::forward<DtmfSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
