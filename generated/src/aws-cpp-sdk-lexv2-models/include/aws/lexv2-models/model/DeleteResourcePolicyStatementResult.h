...
class DeleteResourcePolicyStatementResult {
 public:
  ...
  AWS_LEXMODELSV2_API DeleteResourcePolicyStatementResult& operator=(
  ...
  template <typename ResourceArnT = Aws::String>
  DeleteResourcePolicyStatementResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  DeleteResourcePolicyStatementResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteResourcePolicyStatementResult& WithRequestId(RequestIdT&& value) {
