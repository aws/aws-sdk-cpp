...
namespace Model
{
  ...
  {
  public:
    AWS_LEXMODELSV2_API DeleteResourcePolicyStatementResult() = default;
    ...
    template<typename ResourceArnT = Aws::String>
    DeleteResourcePolicyStatementResult& WithResourceArn(ResourceArnT&& value) { SetResourceArn(std::forward<ResourceArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RevisionIdT = Aws::String>
    DeleteResourcePolicyStatementResult& WithRevisionId(RevisionIdT&& value) { SetRevisionId(std::forward<RevisionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    DeleteResourcePolicyStatementResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
