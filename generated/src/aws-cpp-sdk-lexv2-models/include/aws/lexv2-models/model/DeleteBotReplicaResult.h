...
class DeleteBotReplicaResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  DeleteBotReplicaResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ReplicaRegionT = Aws::String>
  DeleteBotReplicaResult& WithReplicaRegion(ReplicaRegionT&& value) {
  ...
  inline DeleteBotReplicaResult& WithBotReplicaStatus(BotReplicaStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  DeleteBotReplicaResult& WithRequestId(RequestIdT&& value) {
