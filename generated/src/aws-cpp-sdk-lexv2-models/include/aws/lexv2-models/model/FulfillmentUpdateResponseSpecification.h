...
class FulfillmentUpdateResponseSpecification {
 public:
  ...
  inline void SetFrequencyInSeconds(int value) {
    m_frequencyInSecondsHasBeenSet = true;
    m_frequencyInSeconds = value;
  }
  inline FulfillmentUpdateResponseSpecification& WithFrequencyInSeconds(int value) {
    SetFrequencyInSeconds(value);
    return *this;
  }
  ///@}
  ...
  inline FulfillmentUpdateResponseSpecification& WithAllowInterrupt(bool value) {
