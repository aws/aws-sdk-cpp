...
class BotVersionSortBy {
 public:
  ...
  inline void SetAttribute(BotVersionSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline BotVersionSortBy& WithAttribute(BotVersionSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline BotVersionSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
