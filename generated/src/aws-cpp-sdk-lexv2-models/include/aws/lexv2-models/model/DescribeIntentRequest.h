...
class DescribeIntentRequest : public LexModelsV2Request {
 public:
  AWS_LEXMODELSV2_API DescribeIntentRequest() = default;
  ...
  template <typename IntentIdT = Aws::String>
  DescribeIntentRequest& WithIntentId(IntentIdT&& value) {
  ...
  template <typename BotIdT = Aws::String>
  DescribeIntentRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  DescribeIntentRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  DescribeIntentRequest& WithLocaleId(LocaleIdT&& value) {
