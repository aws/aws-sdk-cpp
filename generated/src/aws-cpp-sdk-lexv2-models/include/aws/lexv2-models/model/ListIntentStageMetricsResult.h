...
class ListIntentStageMetricsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListIntentStageMetricsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsIntentStageResult>>
  ListIntentStageMetricsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsIntentStageResult>
  ListIntentStageMetricsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIntentStageMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIntentStageMetricsResult& WithRequestId(RequestIdT&& value) {
