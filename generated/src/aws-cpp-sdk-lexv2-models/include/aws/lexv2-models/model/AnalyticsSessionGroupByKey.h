...
class AnalyticsSessionGroupByKey {
 public:
  ...
  inline void SetName(AnalyticsSessionField value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsSessionGroupByKey& WithName(AnalyticsSessionField value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValueT = Aws::String>
  AnalyticsSessionGroupByKey& WithValue(ValueT&& value) {
