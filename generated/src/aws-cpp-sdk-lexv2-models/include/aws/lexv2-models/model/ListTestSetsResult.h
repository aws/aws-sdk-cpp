...
class ListTestSetsResult {
 public:
  ...
  void SetTestSets(TestSetsT&& value) {
    m_testSetsHasBeenSet = true;
    m_testSets = std::forward<TestSetsT>(value);
  }
  template <typename TestSetsT = Aws::Vector<TestSetSummary>>
  ListTestSetsResult& WithTestSets(TestSetsT&& value) {
    SetTestSets(std::forward<TestSetsT>(value));
    return *this;
  }
  template <typename TestSetsT = TestSetSummary>
  ListTestSetsResult& AddTestSets(TestSetsT&& value) {
    m_testSetsHasBeenSet = true;
    m_testSets.emplace_back(std::forward<TestSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTestSetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListTestSetsResult& WithRequestId(RequestIdT&& value) {
