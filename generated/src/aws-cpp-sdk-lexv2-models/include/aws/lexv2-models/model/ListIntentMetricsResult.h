...
class ListIntentMetricsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListIntentMetricsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename ResultsT = Aws::Vector<AnalyticsIntentResult>>
  ListIntentMetricsResult& WithResults(ResultsT&& value) {
    SetResults(std::forward<ResultsT>(value));
    return *this;
  }
  template <typename ResultsT = AnalyticsIntentResult>
  ListIntentMetricsResult& AddResults(ResultsT&& value) {
    m_resultsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListIntentMetricsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListIntentMetricsResult& WithRequestId(RequestIdT&& value) {
