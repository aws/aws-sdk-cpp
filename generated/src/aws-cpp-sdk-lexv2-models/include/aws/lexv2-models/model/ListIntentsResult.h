...
class ListIntentsResult {
 public:
  ...
  void SetIntentSummaries(IntentSummariesT&& value) {
    m_intentSummariesHasBeenSet = true;
    m_intentSummaries = std::forward<IntentSummariesT>(value);
  }
  template <typename IntentSummariesT = Aws::Vector<IntentSummary>>
  ListIntentsResult& WithIntentSummaries(IntentSummariesT&& value) {
    SetIntentSummaries(std::forward<IntentSummariesT>(value));
    return *this;
  }
  template <typename IntentSummariesT = IntentSummary>
  ListIntentsResult& AddIntentSummaries(IntentSummariesT&& value) {
    m_intentSummariesHasBeenSet = true;
    m_intentSummaries.emplace_back(std::forward<IntentSummariesT>(value));
    return *this;
  }
  ///@}
