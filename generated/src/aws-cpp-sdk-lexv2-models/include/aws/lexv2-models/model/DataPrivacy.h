 ...
 * <code>DataPrivacy</code> structure provides settings that determine how Amazon
 * Lex handles special cases of securing the data for your bot. </p><p><h3>See
 * Also:</h3>   <a
...
class DataPrivacy {
 public:
  ...
  inline DataPrivacy& WithChildDirected(bool value) {
