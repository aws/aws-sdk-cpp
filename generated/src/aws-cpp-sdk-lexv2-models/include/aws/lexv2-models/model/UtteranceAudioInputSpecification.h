...
class UtteranceAudioInputSpecification {
 public:
  ...
  void SetAudioFileS3Location(AudioFileS3LocationT&& value) {
    m_audioFileS3LocationHasBeenSet = true;
    m_audioFileS3Location = std::forward<AudioFileS3LocationT>(value);
  }
  template <typename AudioFileS3LocationT = Aws::String>
  UtteranceAudioInputSpecification& WithAudioFileS3Location(AudioFileS3LocationT&& value) {
    SetAudioFileS3Location(std::forward<AudioFileS3LocationT>(value));
    return *this;
  }
  ///@}
 private:
