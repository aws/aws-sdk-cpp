...
class AnalyticsUtteranceFilter {
 public:
  ...
  inline void SetName(AnalyticsUtteranceFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AnalyticsUtteranceFilter& WithName(AnalyticsUtteranceFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOperator(AnalyticsFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline AnalyticsUtteranceFilter& WithOperator(AnalyticsFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AnalyticsUtteranceFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AnalyticsUtteranceFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
