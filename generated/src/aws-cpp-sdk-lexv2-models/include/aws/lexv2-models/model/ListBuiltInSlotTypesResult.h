...
class ListBuiltInSlotTypesResult {
 public:
  ...
  void SetBuiltInSlotTypeSummaries(BuiltInSlotTypeSummariesT&& value) {
    m_builtInSlotTypeSummariesHasBeenSet = true;
    m_builtInSlotTypeSummaries = std::forward<BuiltInSlotTypeSummariesT>(value);
  }
  template <typename BuiltInSlotTypeSummariesT = Aws::Vector<BuiltInSlotTypeSummary>>
  ListBuiltInSlotTypesResult& WithBuiltInSlotTypeSummaries(BuiltInSlotTypeSummariesT&& value) {
    SetBuiltInSlotTypeSummaries(std::forward<BuiltInSlotTypeSummariesT>(value));
    return *this;
  }
  template <typename BuiltInSlotTypeSummariesT = BuiltInSlotTypeSummary>
  ListBuiltInSlotTypesResult& AddBuiltInSlotTypeSummaries(BuiltInSlotTypeSummariesT&& value) {
    m_builtInSlotTypeSummariesHasBeenSet = true;
    m_builtInSlotTypeSummaries.emplace_back(std::forward<BuiltInSlotTypeSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBuiltInSlotTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListBuiltInSlotTypesResult& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBuiltInSlotTypesResult& WithRequestId(RequestIdT&& value) {
