...
class FulfillmentUpdatesSpecification {
 public:
  ...
  inline FulfillmentUpdatesSpecification& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  void SetStartResponse(StartResponseT&& value) {
    ...
    m_startResponse = std::forward<StartResponseT>(value);
  }
  template <typename StartResponseT = FulfillmentStartResponseSpecification>
  FulfillmentUpdatesSpecification& WithStartResponse(StartResponseT&& value) {
    SetStartResponse(std::forward<StartResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUpdateResponse(UpdateResponseT&& value) {
    ...
    m_updateResponse = std::forward<UpdateResponseT>(value);
  }
  template <typename UpdateResponseT = FulfillmentUpdateResponseSpecification>
  FulfillmentUpdatesSpecification& WithUpdateResponse(UpdateResponseT&& value) {
    SetUpdateResponse(std::forward<UpdateResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline FulfillmentUpdatesSpecification& WithTimeoutInSeconds(int value) {
