...
class ListImportsResult {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListImportsResult& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListImportsResult& WithBotVersion(BotVersionT&& value) {
  ...
  void SetImportSummaries(ImportSummariesT&& value) {
    m_importSummariesHasBeenSet = true;
    m_importSummaries = std::forward<ImportSummariesT>(value);
  }
  template <typename ImportSummariesT = Aws::Vector<ImportSummary>>
  ListImportsResult& WithImportSummaries(ImportSummariesT&& value) {
    SetImportSummaries(std::forward<ImportSummariesT>(value));
    return *this;
  }
  template <typename ImportSummariesT = ImportSummary>
  ListImportsResult& AddImportSummaries(ImportSummariesT&& value) {
    m_importSummariesHasBeenSet = true;
    m_importSummaries.emplace_back(std::forward<ImportSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename LocaleIdT = Aws::String>
  ListImportsResult& WithLocaleId(LocaleIdT&& value) {
