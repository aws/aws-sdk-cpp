...
class BotLocaleFilter {
 public:
  ...
  inline void SetName(BotLocaleFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline BotLocaleFilter& WithName(BotLocaleFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  BotLocaleFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  BotLocaleFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(BotLocaleFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline BotLocaleFilter& WithOperator(BotLocaleFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
