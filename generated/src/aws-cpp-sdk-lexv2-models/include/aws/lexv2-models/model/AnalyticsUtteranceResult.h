...
class AnalyticsUtteranceResult {
 public:
  ...
  void SetAttributeResults(AttributeResultsT&& value) {
    m_attributeResultsHasBeenSet = true;
    m_attributeResults = std::forward<AttributeResultsT>(value);
  }
  template <typename AttributeResultsT = Aws::Vector<AnalyticsUtteranceAttributeResult>>
  AnalyticsUtteranceResult& WithAttributeResults(AttributeResultsT&& value) {
    SetAttributeResults(std::forward<AttributeResultsT>(value));
    return *this;
  }
  ...
  AnalyticsUtteranceResult& AddAttributeResults(AttributeResultsT&& value) {
    m_attributeResultsHasBeenSet = true;
    m_attributeResults.emplace_back(std::forward<AttributeResultsT>(value));
    return *this;
  }
  ///@}
 private:
