...
class ConversationLevelResultDetail {
 public:
  ...
  inline ConversationLevelResultDetail& WithEndToEndResult(TestResultMatchStatus value) {
  ...
  inline ConversationLevelResultDetail& WithSpeechTranscriptionResult(TestResultMatchStatus value) {
