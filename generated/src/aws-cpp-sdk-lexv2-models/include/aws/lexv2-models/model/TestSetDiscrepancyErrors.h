...
class TestSetDiscrepancyErrors {
 public:
  ...
  void SetIntentDiscrepancies(IntentDiscrepanciesT&& value) {
    m_intentDiscrepanciesHasBeenSet = true;
    m_intentDiscrepancies = std::forward<IntentDiscrepanciesT>(value);
  }
  template <typename IntentDiscrepanciesT = Aws::Vector<TestSetIntentDiscrepancyItem>>
  TestSetDiscrepancyErrors& WithIntentDiscrepancies(IntentDiscrepanciesT&& value) {
    SetIntentDiscrepancies(std::forward<IntentDiscrepanciesT>(value));
    return *this;
  }
  template <typename IntentDiscrepanciesT = TestSetIntentDiscrepancyItem>
  TestSetDiscrepancyErrors& AddIntentDiscrepancies(IntentDiscrepanciesT&& value) {
    m_intentDiscrepanciesHasBeenSet = true;
    m_intentDiscrepancies.emplace_back(std::forward<IntentDiscrepanciesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSlotDiscrepancies(SlotDiscrepanciesT&& value) {
    m_slotDiscrepanciesHasBeenSet = true;
    m_slotDiscrepancies = std::forward<SlotDiscrepanciesT>(value);
  }
  template <typename SlotDiscrepanciesT = Aws::Vector<TestSetSlotDiscrepancyItem>>
  TestSetDiscrepancyErrors& WithSlotDiscrepancies(SlotDiscrepanciesT&& value) {
    SetSlotDiscrepancies(std::forward<SlotDiscrepanciesT>(value));
    return *this;
  }
  template <typename SlotDiscrepanciesT = TestSetSlotDiscrepancyItem>
  TestSetDiscrepancyErrors& AddSlotDiscrepancies(SlotDiscrepanciesT&& value) {
    m_slotDiscrepanciesHasBeenSet = true;
    m_slotDiscrepancies.emplace_back(std::forward<SlotDiscrepanciesT>(value));
    return *this;
  }
  ///@}
 private:
