...
class GenerationSortBy {
 public:
  ...
  inline void SetAttribute(GenerationSortByAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline GenerationSortBy& WithAttribute(GenerationSortByAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline GenerationSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
