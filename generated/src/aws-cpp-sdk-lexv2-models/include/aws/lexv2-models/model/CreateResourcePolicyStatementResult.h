...
class CreateResourcePolicyStatementResult {
 public:
  AWS_LEXMODELSV2_API CreateResourcePolicyStatementResult() = default;
  AWS_LEXMODELSV2_API CreateResourcePolicyStatementResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_LEXMODELSV2_API CreateResourcePolicyStatementResult& operator=(
  ...
  template <typename ResourceArnT = Aws::String>
  CreateResourcePolicyStatementResult& WithResourceArn(ResourceArnT&& value) {
  ...
  template <typename RevisionIdT = Aws::String>
  CreateResourcePolicyStatementResult& WithRevisionId(RevisionIdT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateResourcePolicyStatementResult& WithRequestId(RequestIdT&& value) {
