...
class BotVersionReplicaSummary {
 public:
  ...
  inline void SetBotVersionReplicationStatus(BotVersionReplicationStatus value) {
    m_botVersionReplicationStatusHasBeenSet = true;
    m_botVersionReplicationStatus = value;
  }
  inline BotVersionReplicaSummary& WithBotVersionReplicationStatus(BotVersionReplicationStatus value) {
    SetBotVersionReplicationStatus(value);
    return *this;
  }
  ///@}
