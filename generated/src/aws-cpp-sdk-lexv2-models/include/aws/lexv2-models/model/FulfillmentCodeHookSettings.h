...
class FulfillmentCodeHookSettings {
 public:
  ...
  inline FulfillmentCodeHookSettings& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const PostFulfillmentStatusSpecification& GetPostFulfillmentStatusSpecification() const {
    return m_postFulfillmentStatusSpecification;
  }
  ...
  void SetPostFulfillmentStatusSpecification(PostFulfillmentStatusSpecificationT&& value) {
    ...
    m_postFulfillmentStatusSpecification = std::forward<PostFulfillmentStatusSpecificationT>(value);
  }
  template <typename PostFulfillmentStatusSpecificationT = PostFulfillmentStatusSpecification>
  FulfillmentCodeHookSettings& WithPostFulfillmentStatusSpecification(PostFulfillmentStatusSpecificationT&& value) {
    SetPostFulfillmentStatusSpecification(std::forward<PostFulfillmentStatusSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFulfillmentUpdatesSpecification(FulfillmentUpdatesSpecificationT&& value) {
    ...
    m_fulfillmentUpdatesSpecification = std::forward<FulfillmentUpdatesSpecificationT>(value);
  }
  template <typename FulfillmentUpdatesSpecificationT = FulfillmentUpdatesSpecification>
  FulfillmentCodeHookSettings& WithFulfillmentUpdatesSpecification(FulfillmentUpdatesSpecificationT&& value) {
    SetFulfillmentUpdatesSpecification(std::forward<FulfillmentUpdatesSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  inline FulfillmentCodeHookSettings& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
