...
class IntentConfirmationSetting {
 public:
  ...
  void SetDeclinationResponse(DeclinationResponseT&& value) {
    ...
    m_declinationResponse = std::forward<DeclinationResponseT>(value);
  }
  template <typename DeclinationResponseT = ResponseSpecification>
  IntentConfirmationSetting& WithDeclinationResponse(DeclinationResponseT&& value) {
    SetDeclinationResponse(std::forward<DeclinationResponseT>(value));
    return *this;
  }
  ///@}
  ...
  inline IntentConfirmationSetting& WithActive(bool value) {
    SetActive(value);
    return *this;
  }
  ///@}
  ...
  void SetConfirmationResponse(ConfirmationResponseT&& value) {
    ...
    m_confirmationResponse = std::forward<ConfirmationResponseT>(value);
  }
  template <typename ConfirmationResponseT = ResponseSpecification>
  IntentConfirmationSetting& WithConfirmationResponse(ConfirmationResponseT&& value) {
    SetConfirmationResponse(std::forward<ConfirmationResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfirmationNextStep(ConfirmationNextStepT&& value) {
    ...
    m_confirmationNextStep = std::forward<ConfirmationNextStepT>(value);
  }
  template <typename ConfirmationNextStepT = DialogState>
  IntentConfirmationSetting& WithConfirmationNextStep(ConfirmationNextStepT&& value) {
    SetConfirmationNextStep(std::forward<ConfirmationNextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetConfirmationConditional(ConfirmationConditionalT&& value) {
    ...
    m_confirmationConditional = std::forward<ConfirmationConditionalT>(value);
  }
  template <typename ConfirmationConditionalT = ConditionalSpecification>
  IntentConfirmationSetting& WithConfirmationConditional(ConfirmationConditionalT&& value) {
    SetConfirmationConditional(std::forward<ConfirmationConditionalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeclinationNextStep(DeclinationNextStepT&& value) {
    ...
    m_declinationNextStep = std::forward<DeclinationNextStepT>(value);
  }
  template <typename DeclinationNextStepT = DialogState>
  IntentConfirmationSetting& WithDeclinationNextStep(DeclinationNextStepT&& value) {
    SetDeclinationNextStep(std::forward<DeclinationNextStepT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDeclinationConditional(DeclinationConditionalT&& value) {
    ...
    m_declinationConditional = std::forward<DeclinationConditionalT>(value);
  }
  template <typename DeclinationConditionalT = ConditionalSpecification>
  IntentConfirmationSetting& WithDeclinationConditional(DeclinationConditionalT&& value) {
    SetDeclinationConditional(std::forward<DeclinationConditionalT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElicitationCodeHook(ElicitationCodeHookT&& value) {
    ...
    m_elicitationCodeHook = std::forward<ElicitationCodeHookT>(value);
  }
  template <typename ElicitationCodeHookT = ElicitationCodeHookInvocationSetting>
  IntentConfirmationSetting& WithElicitationCodeHook(ElicitationCodeHookT&& value) {
    SetElicitationCodeHook(std::forward<ElicitationCodeHookT>(value));
    return *this;
  }
  ///@}
 private:
