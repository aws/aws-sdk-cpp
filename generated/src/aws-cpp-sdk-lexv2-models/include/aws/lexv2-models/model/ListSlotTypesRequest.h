...
class ListSlotTypesRequest : public LexModelsV2Request {
 public:
  ...
  template <typename BotIdT = Aws::String>
  ListSlotTypesRequest& WithBotId(BotIdT&& value) {
  ...
  template <typename BotVersionT = Aws::String>
  ListSlotTypesRequest& WithBotVersion(BotVersionT&& value) {
  ...
  template <typename LocaleIdT = Aws::String>
  ListSlotTypesRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename SortByT = SlotTypeSortBy>
  ListSlotTypesRequest& WithSortBy(SortByT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<SlotTypeFilter>>
  ListSlotTypesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = SlotTypeFilter>
  ListSlotTypesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline ListSlotTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSlotTypesRequest& WithNextToken(NextTokenT&& value) {
