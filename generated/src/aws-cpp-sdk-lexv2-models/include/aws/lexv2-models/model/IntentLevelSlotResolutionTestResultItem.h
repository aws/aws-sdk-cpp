...
class IntentLevelSlotResolutionTestResultItem {
 public:
  ...
  template <typename IntentNameT = Aws::String>
  IntentLevelSlotResolutionTestResultItem& WithIntentName(IntentNameT&& value) {
  ...
  inline IntentLevelSlotResolutionTestResultItem& WithMultiTurnConversation(bool value) {
  ...
  void SetSlotResolutionResults(SlotResolutionResultsT&& value) {
    ...
    m_slotResolutionResults = std::forward<SlotResolutionResultsT>(value);
  }
  template <typename SlotResolutionResultsT = Aws::Vector<SlotResolutionTestResultItem>>
  IntentLevelSlotResolutionTestResultItem& WithSlotResolutionResults(SlotResolutionResultsT&& value) {
    SetSlotResolutionResults(std::forward<SlotResolutionResultsT>(value));
    return *this;
  }
  template <typename SlotResolutionResultsT = SlotResolutionTestResultItem>
  IntentLevelSlotResolutionTestResultItem& AddSlotResolutionResults(SlotResolutionResultsT&& value) {
    m_slotResolutionResultsHasBeenSet = true;
    m_slotResolutionResults.emplace_back(std::forward<SlotResolutionResultsT>(value));
    return *this;
  }
  ///@}
 private:
