...
class ImportSummary {
 public:
  ...
  inline ImportSummary& WithMergeStrategy(MergeStrategy value) {
  ...
  inline void SetImportedResourceType(ImportResourceType value) {
    m_importedResourceTypeHasBeenSet = true;
    m_importedResourceType = value;
  }
  inline ImportSummary& WithImportedResourceType(ImportResourceType value) {
    SetImportedResourceType(value);
    return *this;
  }
  ///@}
 private:
