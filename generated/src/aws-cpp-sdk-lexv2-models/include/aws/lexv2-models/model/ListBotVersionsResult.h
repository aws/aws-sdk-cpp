...
class ListBotVersionsResult {
 public:
  ...
  void SetBotVersionSummaries(BotVersionSummariesT&& value) {
    ...
    m_botVersionSummaries = std::forward<BotVersionSummariesT>(value);
  }
  template <typename BotVersionSummariesT = Aws::Vector<BotVersionSummary>>
  ListBotVersionsResult& WithBotVersionSummaries(BotVersionSummariesT&& value) {
    SetBotVersionSummaries(std::forward<BotVersionSummariesT>(value));
    return *this;
  }
  ...
  ListBotVersionsResult& AddBotVersionSummaries(BotVersionSummariesT&& value) {
    m_botVersionSummariesHasBeenSet = true;
    m_botVersionSummaries.emplace_back(std::forward<BotVersionSummariesT>(value));
    return *this;
  }
  ///@}
