 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/ImageResponseCard">AWS
 * API Reference</a></p>
 */
class ImageResponseCard {
 public:
  ...
  void SetButtons(ButtonsT&& value) {
    ...
    m_buttons = std::forward<ButtonsT>(value);
  }
  template <typename ButtonsT = Aws::Vector<Button>>
  ImageResponseCard& WithButtons(ButtonsT&& value) {
    SetButtons(std::forward<ButtonsT>(value));
    return *this;
  }
  template <typename ButtonsT = Button>
  ImageResponseCard& AddButtons(ButtonsT&& value) {
    m_buttonsHasBeenSet = true;
    m_buttons.emplace_back(std::forward<ButtonsT>(value));
    return *this;
  }
  ///@}
 private:
