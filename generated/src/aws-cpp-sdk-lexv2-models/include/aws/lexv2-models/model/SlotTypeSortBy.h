...
class SlotTypeSortBy {
 public:
  ...
  inline void SetAttribute(SlotTypeSortAttribute value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline SlotTypeSortBy& WithAttribute(SlotTypeSortAttribute value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline SlotTypeSortBy& WithOrder(SortOrder value) {
    SetOrder(value);
    return *this;
  }
  ///@}
