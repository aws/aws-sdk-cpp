...
class AssociatedTranscriptFilter {
 public:
  ...
  inline void SetName(AssociatedTranscriptFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline AssociatedTranscriptFilter& WithName(AssociatedTranscriptFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  AssociatedTranscriptFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  AssociatedTranscriptFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
