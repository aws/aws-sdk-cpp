...
class ListBuiltInIntentsRequest : public LexModelsV2Request {
 public:
  ...
  template <typename LocaleIdT = Aws::String>
  ListBuiltInIntentsRequest& WithLocaleId(LocaleIdT&& value) {
  ...
  template <typename SortByT = BuiltInIntentSortBy>
  ListBuiltInIntentsRequest& WithSortBy(SortByT&& value) {
  ...
  inline ListBuiltInIntentsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBuiltInIntentsRequest& WithNextToken(NextTokenT&& value) {
