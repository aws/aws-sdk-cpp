...
class QnAKendraConfiguration {
 public:
  ...
  template <typename KendraIndexT = Aws::String>
  QnAKendraConfiguration& WithKendraIndex(KendraIndexT&& value) {
  ...
  inline void SetQueryFilterStringEnabled(bool value) {
    m_queryFilterStringEnabledHasBeenSet = true;
    m_queryFilterStringEnabled = value;
  }
  inline QnAKendraConfiguration& WithQueryFilterStringEnabled(bool value) {
    SetQueryFilterStringEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename QueryFilterStringT = Aws::String>
  QnAKendraConfiguration& WithQueryFilterString(QueryFilterStringT&& value) {
  ...
  inline void SetExactResponse(bool value) {
    m_exactResponseHasBeenSet = true;
    m_exactResponse = value;
  }
  inline QnAKendraConfiguration& WithExactResponse(bool value) {
    SetExactResponse(value);
    return *this;
  }
  ///@}
 private:
