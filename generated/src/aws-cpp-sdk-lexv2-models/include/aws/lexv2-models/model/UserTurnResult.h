...
class UserTurnResult {
 public:
  ...
  void SetExpectedOutput(ExpectedOutputT&& value) {
    ...
    m_expectedOutput = std::forward<ExpectedOutputT>(value);
  }
  template <typename ExpectedOutputT = UserTurnOutputSpecification>
  UserTurnResult& WithExpectedOutput(ExpectedOutputT&& value) {
    SetExpectedOutput(std::forward<ExpectedOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActualOutput(ActualOutputT&& value) {
    ...
    m_actualOutput = std::forward<ActualOutputT>(value);
  }
  template <typename ActualOutputT = UserTurnOutputSpecification>
  UserTurnResult& WithActualOutput(ActualOutputT&& value) {
    SetActualOutput(std::forward<ActualOutputT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEndToEndResult(TestResultMatchStatus value) {
    m_endToEndResultHasBeenSet = true;
    m_endToEndResult = value;
  }
  inline UserTurnResult& WithEndToEndResult(TestResultMatchStatus value) {
    SetEndToEndResult(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIntentMatchResult(TestResultMatchStatus value) {
    m_intentMatchResultHasBeenSet = true;
    m_intentMatchResult = value;
  }
  inline UserTurnResult& WithIntentMatchResult(TestResultMatchStatus value) {
    SetIntentMatchResult(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSlotMatchResult(TestResultMatchStatus value) {
    m_slotMatchResultHasBeenSet = true;
    m_slotMatchResult = value;
  }
  inline UserTurnResult& WithSlotMatchResult(TestResultMatchStatus value) {
    SetSlotMatchResult(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSpeechTranscriptionResult(TestResultMatchStatus value) {
    m_speechTranscriptionResultHasBeenSet = true;
    m_speechTranscriptionResult = value;
  }
  inline UserTurnResult& WithSpeechTranscriptionResult(TestResultMatchStatus value) {
    SetSpeechTranscriptionResult(value);
    return *this;
  }
  ///@}
  ...
  void SetConversationLevelResult(ConversationLevelResultT&& value) {
    ...
    m_conversationLevelResult = std::forward<ConversationLevelResultT>(value);
  }
  template <typename ConversationLevelResultT = ConversationLevelResultDetail>
  UserTurnResult& WithConversationLevelResult(ConversationLevelResultT&& value) {
    SetConversationLevelResult(std::forward<ConversationLevelResultT>(value));
    return *this;
  }
  ///@}
 private:
