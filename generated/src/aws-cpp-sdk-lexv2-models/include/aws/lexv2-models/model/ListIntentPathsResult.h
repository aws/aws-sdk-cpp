...
class ListIntentPathsResult {
 public:
  ...
  void SetNodeSummaries(NodeSummariesT&& value) {
    m_nodeSummariesHasBeenSet = true;
    m_nodeSummaries = std::forward<NodeSummariesT>(value);
  }
  template <typename NodeSummariesT = Aws::Vector<AnalyticsIntentNodeSummary>>
  ListIntentPathsResult& WithNodeSummaries(NodeSummariesT&& value) {
    SetNodeSummaries(std::forward<NodeSummariesT>(value));
    return *this;
  }
  template <typename NodeSummariesT = AnalyticsIntentNodeSummary>
  ListIntentPathsResult& AddNodeSummaries(NodeSummariesT&& value) {
    m_nodeSummariesHasBeenSet = true;
    m_nodeSummaries.emplace_back(std::forward<NodeSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListIntentPathsResult& WithRequestId(RequestIdT&& value) {
