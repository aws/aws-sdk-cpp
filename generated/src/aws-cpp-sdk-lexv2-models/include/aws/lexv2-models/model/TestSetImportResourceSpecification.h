...
class TestSetImportResourceSpecification {
 public:
  ...
  template <typename TestSetNameT = Aws::String>
  TestSetImportResourceSpecification& WithTestSetName(TestSetNameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  TestSetImportResourceSpecification& WithDescription(DescriptionT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  TestSetImportResourceSpecification& WithRoleArn(RoleArnT&& value) {
  ...
  template <typename StorageLocationT = TestSetStorageLocation>
  TestSetImportResourceSpecification& WithStorageLocation(StorageLocationT&& value) {
  ...
  void SetImportInputLocation(ImportInputLocationT&& value) {
    m_importInputLocationHasBeenSet = true;
    m_importInputLocation = std::forward<ImportInputLocationT>(value);
  }
  template <typename ImportInputLocationT = TestSetImportInputLocation>
  TestSetImportResourceSpecification& WithImportInputLocation(ImportInputLocationT&& value) {
    SetImportInputLocation(std::forward<ImportInputLocationT>(value));
    return *this;
  }
  ///@}
  ...
  inline TestSetImportResourceSpecification& WithModality(TestSetModality value) {
    SetModality(value);
    return *this;
  }
  ///@}
  ...
  void SetTestSetTags(TestSetTagsT&& value) {
    m_testSetTagsHasBeenSet = true;
    m_testSetTags = std::forward<TestSetTagsT>(value);
  }
  template <typename TestSetTagsT = Aws::Map<Aws::String, Aws::String>>
  TestSetImportResourceSpecification& WithTestSetTags(TestSetTagsT&& value) {
    SetTestSetTags(std::forward<TestSetTagsT>(value));
    return *this;
  }
  ...
  TestSetImportResourceSpecification& AddTestSetTags(TestSetTagsKeyT&& key, TestSetTagsValueT&& value) {
    m_testSetTagsHasBeenSet = true;
    m_testSetTags.emplace(std::forward<TestSetTagsKeyT>(key), std::forward<TestSetTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
