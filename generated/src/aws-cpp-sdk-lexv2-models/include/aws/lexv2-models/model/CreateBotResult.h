...
class CreateBotResult {
 public:
  ...
  inline CreateBotResult& WithIdleSessionTTLInSeconds(int value) {
  ...
  inline void SetBotStatus(BotStatus value) {
    m_botStatusHasBeenSet = true;
    m_botStatus = value;
  }
  inline CreateBotResult& WithBotStatus(BotStatus value) {
    SetBotStatus(value);
    return *this;
  }
  ///@}
  ...
  inline CreateBotResult& WithBotType(BotType value) {
    SetBotType(value);
    return *this;
  }
  ///@}
