...
class ImportFilter {
 public:
  ...
  inline void SetName(ImportFilterName value) {
    m_nameHasBeenSet = true;
    m_name = value;
  }
  inline ImportFilter& WithName(ImportFilterName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ValuesT = Aws::Vector<Aws::String>>
  ImportFilter& WithValues(ValuesT&& value) {
    SetValues(std::forward<ValuesT>(value));
    return *this;
  }
  template <typename ValuesT = Aws::String>
  ImportFilter& AddValues(ValuesT&& value) {
    m_valuesHasBeenSet = true;
  ...
  inline void SetOperator(ImportFilterOperator value) {
    m_operatorHasBeenSet = true;
    m_operator = value;
  }
  inline ImportFilter& WithOperator(ImportFilterOperator value) {
    SetOperator(value);
    return *this;
  }
  ///@}
