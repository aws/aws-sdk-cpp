...
class PromptAttemptSpecification {
 public:
  ...
  inline PromptAttemptSpecification& WithAllowInterrupt(bool value) {
  ...
  void SetAllowedInputTypes(AllowedInputTypesT&& value) {
    ...
    m_allowedInputTypes = std::forward<AllowedInputTypesT>(value);
  }
  template <typename AllowedInputTypesT = AllowedInputTypes>
  PromptAttemptSpecification& WithAllowedInputTypes(AllowedInputTypesT&& value) {
    SetAllowedInputTypes(std::forward<AllowedInputTypesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAudioAndDTMFInputSpecification(AudioAndDTMFInputSpecificationT&& value) {
    ...
    m_audioAndDTMFInputSpecification = std::forward<AudioAndDTMFInputSpecificationT>(value);
  }
  template <typename AudioAndDTMFInputSpecificationT = AudioAndDTMFInputSpecification>
  PromptAttemptSpecification& WithAudioAndDTMFInputSpecification(AudioAndDTMFInputSpecificationT&& value) {
    SetAudioAndDTMFInputSpecification(std::forward<AudioAndDTMFInputSpecificationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTextInputSpecification(TextInputSpecificationT&& value) {
    ...
    m_textInputSpecification = std::forward<TextInputSpecificationT>(value);
  }
  template <typename TextInputSpecificationT = TextInputSpecification>
  PromptAttemptSpecification& WithTextInputSpecification(TextInputSpecificationT&& value) {
    SetTextInputSpecification(std::forward<TextInputSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
