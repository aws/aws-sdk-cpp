...
class ObfuscationSetting {
 public:
  ...
  inline void SetObfuscationSettingType(ObfuscationSettingType value) {
    m_obfuscationSettingTypeHasBeenSet = true;
    m_obfuscationSettingType = value;
  }
  inline ObfuscationSetting& WithObfuscationSettingType(ObfuscationSettingType value) {
    SetObfuscationSettingType(value);
    return *this;
  }
  ///@}
 private:
