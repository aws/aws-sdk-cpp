...
{
const size_t LexModelsV2EndpointRules::RulesBlobStrLen = 3420;
const size_t LexModelsV2EndpointRules::RulesBlobSize = 3421;
...
't','t','p','s',':','/','/','m','o','d','e','l','s','-','v','2','-','l','e','x','-','f','i','p','s',
...
's','-','v','2','-','l','e','x','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P',
...
'd','e','l','s','-','v','2','-','l','e','x','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
const char* LexModelsV2EndpointRules::GetRulesBlob()
{
