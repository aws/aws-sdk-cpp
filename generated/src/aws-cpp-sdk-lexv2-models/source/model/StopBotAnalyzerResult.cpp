...
StopBotAnalyzerResult::StopBotAnalyzerResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StopBotAnalyzerResult& StopBotAnalyzerResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
