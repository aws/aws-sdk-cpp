...
ListCustomVocabularyItemsResult::ListCustomVocabularyItemsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListCustomVocabularyItemsResult& ListCustomVocabularyItemsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("customVocabularyItems")) {
    ...
    for (unsigned customVocabularyItemsIndex = 0; customVocabularyItemsIndex < customVocabularyItemsJsonList.GetLength();
         ++customVocabularyItemsIndex) {
