...
ListBotAliasReplicasResult::ListBotAliasReplicasResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListBotAliasReplicasResult& ListBotAliasReplicasResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("botAliasReplicaSummaries")) {
    ...
    for (unsigned botAliasReplicaSummariesIndex = 0; botAliasReplicaSummariesIndex < botAliasReplicaSummariesJsonList.GetLength();
