...
ListAggregatedUtterancesResult::ListAggregatedUtterancesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListAggregatedUtterancesResult& ListAggregatedUtterancesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("aggregatedUtterancesSummaries")) {
    ...
    for (unsigned aggregatedUtterancesSummariesIndex = 0;
         aggregatedUtterancesSummariesIndex < aggregatedUtterancesSummariesJsonList.GetLength(); ++aggregatedUtterancesSummariesIndex) {
