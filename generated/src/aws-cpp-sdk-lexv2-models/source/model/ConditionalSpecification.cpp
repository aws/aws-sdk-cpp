...
ConditionalSpecification::ConditionalSpecification(JsonView jsonValue) { *this = jsonValue; }
...
ConditionalSpecification& ConditionalSpecification::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("conditionalBranches")) {
    ...
    for (unsigned conditionalBranchesIndex = 0; conditionalBranchesIndex < conditionalBranchesJsonList.GetLength();
         ++conditionalBranchesIndex) {
