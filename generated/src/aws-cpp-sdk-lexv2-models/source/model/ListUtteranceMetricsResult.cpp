...
ListUtteranceMetricsResult::ListUtteranceMetricsResult()
{
}

ListUtteranceMetricsResult::ListUtteranceMetricsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
