...
ListIntentStageMetricsResult::ListIntentStageMetricsResult()
{
}

ListIntentStageMetricsResult::ListIntentStageMetricsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
