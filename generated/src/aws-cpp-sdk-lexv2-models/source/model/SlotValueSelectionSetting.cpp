...
SlotValueSelectionSetting::SlotValueSelectionSetting(JsonView jsonValue) { *this = jsonValue; }
...
SlotValueSelectionSetting& SlotValueSelectionSetting::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("resolutionStrategy")) {
    m_resolutionStrategy =
        SlotValueResolutionStrategyMapper::GetSlotValueResolutionStrategyForName(jsonValue.GetString("resolutionStrategy"));
...
JsonValue SlotValueSelectionSetting::Jsonize() const {
  ...
  if (m_resolutionStrategyHasBeenSet) {
    payload.WithString("resolutionStrategy",
                       SlotValueResolutionStrategyMapper::GetNameForSlotValueResolutionStrategy(m_resolutionStrategy));
  }
