...
ConversationLevelTestResultItem::ConversationLevelTestResultItem(JsonView jsonValue) { *this = jsonValue; }
...
ConversationLevelTestResultItem& ConversationLevelTestResultItem::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("speechTranscriptionResult")) {
    m_speechTranscriptionResult =
        TestResultMatchStatusMapper::GetTestResultMatchStatusForName(jsonValue.GetString("speechTranscriptionResult"));
  ...
  if (jsonValue.ValueExists("intentClassificationResults")) {
    ...
    for (unsigned intentClassificationResultsIndex = 0; intentClassificationResultsIndex < intentClassificationResultsJsonList.GetLength();
         ++intentClassificationResultsIndex) {
...
JsonValue ConversationLevelTestResultItem::Jsonize() const {
  ...
  if (m_speechTranscriptionResultHasBeenSet) {
    payload.WithString("speechTranscriptionResult",
                       TestResultMatchStatusMapper::GetNameForTestResultMatchStatus(m_speechTranscriptionResult));
  }
  ...
  if (m_intentClassificationResultsHasBeenSet) {
    ...
    for (unsigned intentClassificationResultsIndex = 0; intentClassificationResultsIndex < intentClassificationResultsJsonList.GetLength();
         ++intentClassificationResultsIndex) {
      intentClassificationResultsJsonList[intentClassificationResultsIndex].AsObject(
          m_intentClassificationResults[intentClassificationResultsIndex].Jsonize());
    }
