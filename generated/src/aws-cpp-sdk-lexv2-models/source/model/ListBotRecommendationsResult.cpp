...
ListBotRecommendationsResult::ListBotRecommendationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListBotRecommendationsResult& ListBotRecommendationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("botRecommendationSummaries")) {
    ...
    for (unsigned botRecommendationSummariesIndex = 0; botRecommendationSummariesIndex < botRecommendationSummariesJsonList.GetLength();
         ++botRecommendationSummariesIndex) {
