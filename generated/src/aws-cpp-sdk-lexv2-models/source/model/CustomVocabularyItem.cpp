...
CustomVocabularyItem::CustomVocabularyItem(JsonView jsonValue) { *this = jsonValue; }

CustomVocabularyItem& CustomVocabularyItem::operator=(JsonView jsonValue) {
...
JsonValue CustomVocabularyItem::Jsonize() const {
  JsonValue payload;
