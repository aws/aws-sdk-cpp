...
AnalyticsIntentStageFilter::AnalyticsIntentStageFilter(JsonView jsonValue) { *this = jsonValue; }

AnalyticsIntentStageFilter& AnalyticsIntentStageFilter::operator=(JsonView jsonValue) {
...
JsonValue AnalyticsIntentStageFilter::Jsonize() const {
  JsonValue payload;

  if (m_nameHasBeenSet) {
    payload.WithString("name", AnalyticsIntentStageFilterNameMapper::GetNameForAnalyticsIntentStageFilterName(m_name));
  }
