...
ListBotResourceGenerationsResult::ListBotResourceGenerationsResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListBotResourceGenerationsResult& ListBotResourceGenerationsResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("generationSummaries")) {
    ...
    for (unsigned generationSummariesIndex = 0; generationSummariesIndex < generationSummariesJsonList.GetLength();
         ++generationSummariesIndex) {
