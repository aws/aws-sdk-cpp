...
UtteranceLevelTestResults::UtteranceLevelTestResults(JsonView jsonValue) { *this = jsonValue; }

UtteranceLevelTestResults& UtteranceLevelTestResults::operator=(JsonView jsonValue) {
...
JsonValue UtteranceLevelTestResults::Jsonize() const {
  JsonValue payload;
