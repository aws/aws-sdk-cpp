...
DescribeTestSetDiscrepancyReportResult& DescribeTestSetDiscrepancyReportResult::operator=(
  ...
  if (jsonValue.ValueExists("testSetDiscrepancyReportStatus")) {
    m_testSetDiscrepancyReportStatus = TestSetDiscrepancyReportStatusMapper::GetTestSetDiscrepancyReportStatusForName(
        jsonValue.GetString("testSetDiscrepancyReportStatus"));
