...
ListIntentMetricsResult::ListIntentMetricsResult()
{
}

ListIntentMetricsResult::ListIntentMetricsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListIntentMetricsResult& ListIntentMetricsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
