...
OverallTestResults::OverallTestResults(JsonView jsonValue) { *this = jsonValue; }

OverallTestResults& OverallTestResults::operator=(JsonView jsonValue) {
...
JsonValue OverallTestResults::Jsonize() const {
  JsonValue payload;
