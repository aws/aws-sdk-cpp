...
SlotResolutionTestResultItemCounts::SlotResolutionTestResultItemCounts(JsonView jsonValue) { *this = jsonValue; }
...
SlotResolutionTestResultItemCounts& SlotResolutionTestResultItemCounts::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("slotMatchResultCounts")) {
    ...
    for (auto& slotMatchResultCountsItem : slotMatchResultCountsJsonMap) {
      m_slotMatchResultCounts[TestResultMatchStatusMapper::GetTestResultMatchStatusForName(slotMatchResultCountsItem.first)] =
          slotMatchResultCountsItem.second.AsInteger();
    }
...
JsonValue SlotResolutionTestResultItemCounts::Jsonize() const {
  ...
  if (m_slotMatchResultCountsHasBeenSet) {
    ...
    for (auto& slotMatchResultCountsItem : m_slotMatchResultCounts) {
      slotMatchResultCountsJsonMap.WithInteger(
          TestResultMatchStatusMapper::GetNameForTestResultMatchStatus(slotMatchResultCountsItem.first), slotMatchResultCountsItem.second);
    }
