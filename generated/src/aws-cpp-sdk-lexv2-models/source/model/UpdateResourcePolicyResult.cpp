...
UpdateResourcePolicyResult::UpdateResourcePolicyResult()
{
}

UpdateResourcePolicyResult::UpdateResourcePolicyResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
