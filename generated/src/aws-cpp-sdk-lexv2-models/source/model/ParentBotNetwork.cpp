...
ParentBotNetwork::ParentBotNetwork(JsonView jsonValue) { *this = jsonValue; }

ParentBotNetwork& ParentBotNetwork::operator=(JsonView jsonValue) {
...
JsonValue ParentBotNetwork::Jsonize() const {
  JsonValue payload;
