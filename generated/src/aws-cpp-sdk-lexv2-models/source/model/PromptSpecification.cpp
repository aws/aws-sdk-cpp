...
PromptSpecification::PromptSpecification(JsonView jsonValue) { *this = jsonValue; }
...
PromptSpecification& PromptSpecification::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("messageSelectionStrategy")) {
    m_messageSelectionStrategy =
        MessageSelectionStrategyMapper::GetMessageSelectionStrategyForName(jsonValue.GetString("messageSelectionStrategy"));
  ...
  if (jsonValue.ValueExists("promptAttemptsSpecification")) {
    ...
    for (auto& promptAttemptsSpecificationItem : promptAttemptsSpecificationJsonMap) {
      m_promptAttemptsSpecification[PromptAttemptMapper::GetPromptAttemptForName(promptAttemptsSpecificationItem.first)] =
          promptAttemptsSpecificationItem.second.AsObject();
    }
...
JsonValue PromptSpecification::Jsonize() const {
  ...
  if (m_messageSelectionStrategyHasBeenSet) {
    payload.WithString("messageSelectionStrategy",
                       MessageSelectionStrategyMapper::GetNameForMessageSelectionStrategy(m_messageSelectionStrategy));
  }
  ...
  if (m_promptAttemptsSpecificationHasBeenSet) {
    ...
    for (auto& promptAttemptsSpecificationItem : m_promptAttemptsSpecification) {
      promptAttemptsSpecificationJsonMap.WithObject(PromptAttemptMapper::GetNameForPromptAttempt(promptAttemptsSpecificationItem.first),
                                                    promptAttemptsSpecificationItem.second.Jsonize());
    }
