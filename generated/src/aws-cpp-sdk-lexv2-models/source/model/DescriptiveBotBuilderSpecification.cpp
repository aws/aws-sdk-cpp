...
DescriptiveBotBuilderSpecification::DescriptiveBotBuilderSpecification(JsonView jsonValue) { *this = jsonValue; }

DescriptiveBotBuilderSpecification& DescriptiveBotBuilderSpecification::operator=(JsonView jsonValue) {
...
JsonValue DescriptiveBotBuilderSpecification::Jsonize() const {
  JsonValue payload;
