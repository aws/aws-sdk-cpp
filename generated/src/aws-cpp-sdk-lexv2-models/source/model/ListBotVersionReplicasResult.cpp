...
ListBotVersionReplicasResult::ListBotVersionReplicasResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
ListBotVersionReplicasResult& ListBotVersionReplicasResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("botVersionReplicaSummaries")) {
    ...
    for (unsigned botVersionReplicaSummariesIndex = 0; botVersionReplicaSummariesIndex < botVersionReplicaSummariesJsonList.GetLength();
         ++botVersionReplicaSummariesIndex) {
