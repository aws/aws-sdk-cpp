...
ListSessionMetricsResult::ListSessionMetricsResult()
{
}

ListSessionMetricsResult::ListSessionMetricsResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}

ListSessionMetricsResult& ListSessionMetricsResult::operator =(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
