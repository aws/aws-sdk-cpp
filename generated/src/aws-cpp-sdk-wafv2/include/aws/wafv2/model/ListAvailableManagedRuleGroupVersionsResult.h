...
class ListAvailableManagedRuleGroupVersionsResult {
 public:
  ...
  AWS_WAFV2_API ListAvailableManagedRuleGroupVersionsResult& operator=(
  ...
  template <typename NextMarkerT = Aws::String>
  ListAvailableManagedRuleGroupVersionsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename VersionsT = Aws::Vector<ManagedRuleGroupVersion>>
  ListAvailableManagedRuleGroupVersionsResult& WithVersions(VersionsT&& value) {
    SetVersions(std::forward<VersionsT>(value));
    return *this;
  }
  template <typename VersionsT = ManagedRuleGroupVersion>
  ListAvailableManagedRuleGroupVersionsResult& AddVersions(VersionsT&& value) {
    m_versionsHasBeenSet = true;
  ...
  void SetCurrentDefaultVersion(CurrentDefaultVersionT&& value) {
    m_currentDefaultVersionHasBeenSet = true;
    m_currentDefaultVersion = std::forward<CurrentDefaultVersionT>(value);
  }
  template <typename CurrentDefaultVersionT = Aws::String>
  ListAvailableManagedRuleGroupVersionsResult& WithCurrentDefaultVersion(CurrentDefaultVersionT&& value) {
    SetCurrentDefaultVersion(std::forward<CurrentDefaultVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailableManagedRuleGroupVersionsResult& WithRequestId(RequestIdT&& value) {
