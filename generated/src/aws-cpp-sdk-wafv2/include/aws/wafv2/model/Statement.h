...
class Statement {
 public:
  ...
  void SetByteMatchStatement(ByteMatchStatementT&& value) {
    ...
    m_byteMatchStatement = std::forward<ByteMatchStatementT>(value);
  }
  template <typename ByteMatchStatementT = ByteMatchStatement>
  Statement& WithByteMatchStatement(ByteMatchStatementT&& value) {
    SetByteMatchStatement(std::forward<ByteMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSqliMatchStatement(SqliMatchStatementT&& value) {
    ...
    m_sqliMatchStatement = std::forward<SqliMatchStatementT>(value);
  }
  template <typename SqliMatchStatementT = SqliMatchStatement>
  Statement& WithSqliMatchStatement(SqliMatchStatementT&& value) {
    SetSqliMatchStatement(std::forward<SqliMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetXssMatchStatement(XssMatchStatementT&& value) {
    ...
    m_xssMatchStatement = std::forward<XssMatchStatementT>(value);
  }
  template <typename XssMatchStatementT = XssMatchStatement>
  Statement& WithXssMatchStatement(XssMatchStatementT&& value) {
    SetXssMatchStatement(std::forward<XssMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSizeConstraintStatement(SizeConstraintStatementT&& value) {
    ...
    m_sizeConstraintStatement = std::forward<SizeConstraintStatementT>(value);
  }
  template <typename SizeConstraintStatementT = SizeConstraintStatement>
  Statement& WithSizeConstraintStatement(SizeConstraintStatementT&& value) {
    SetSizeConstraintStatement(std::forward<SizeConstraintStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGeoMatchStatement(GeoMatchStatementT&& value) {
    ...
    m_geoMatchStatement = std::forward<GeoMatchStatementT>(value);
  }
  template <typename GeoMatchStatementT = GeoMatchStatement>
  Statement& WithGeoMatchStatement(GeoMatchStatementT&& value) {
    SetGeoMatchStatement(std::forward<GeoMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRuleGroupReferenceStatement(RuleGroupReferenceStatementT&& value) {
    ...
    m_ruleGroupReferenceStatement = std::forward<RuleGroupReferenceStatementT>(value);
  }
  template <typename RuleGroupReferenceStatementT = RuleGroupReferenceStatement>
  Statement& WithRuleGroupReferenceStatement(RuleGroupReferenceStatementT&& value) {
    SetRuleGroupReferenceStatement(std::forward<RuleGroupReferenceStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIPSetReferenceStatement(IPSetReferenceStatementT&& value) {
    ...
    m_iPSetReferenceStatement = std::forward<IPSetReferenceStatementT>(value);
  }
  template <typename IPSetReferenceStatementT = IPSetReferenceStatement>
  Statement& WithIPSetReferenceStatement(IPSetReferenceStatementT&& value) {
    SetIPSetReferenceStatement(std::forward<IPSetReferenceStatementT>(value));
    return *this;
  }
  ///@}
   ...
   * it.</p>
   */
  inline const RegexPatternSetReferenceStatement& GetRegexPatternSetReferenceStatement() const {
    return m_regexPatternSetReferenceStatement;
  }
  ...
  void SetRegexPatternSetReferenceStatement(RegexPatternSetReferenceStatementT&& value) {
    ...
    m_regexPatternSetReferenceStatement = std::forward<RegexPatternSetReferenceStatementT>(value);
  }
  template <typename RegexPatternSetReferenceStatementT = RegexPatternSetReferenceStatement>
  Statement& WithRegexPatternSetReferenceStatement(RegexPatternSetReferenceStatementT&& value) {
    SetRegexPatternSetReferenceStatement(std::forward<RegexPatternSetReferenceStatementT>(value));
    return *this;
  }
  ///@}
   ...
   * management by WAF. </p>
   */
  inline const RateBasedStatement& GetRateBasedStatement() const { return *m_rateBasedStatement; }
  ...
  Statement& WithRateBasedStatement(RateBasedStatementT&& value) {
    SetRateBasedStatement(std::forward<RateBasedStatementT>(value));
    return *this;
  }
  ///@}
  ...
  Statement& WithAndStatement(AndStatementT&& value) {
    SetAndStatement(std::forward<AndStatementT>(value));
    return *this;
  }
  ///@}
  ...
  Statement& WithOrStatement(OrStatementT&& value) {
    SetOrStatement(std::forward<OrStatementT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const NotStatement& GetNotStatement() const { return *m_notStatement; }
  ...
  Statement& WithNotStatement(NotStatementT&& value) {
    SetNotStatement(std::forward<NotStatementT>(value));
    return *this;
  }
  ///@}
  ...
  Statement& WithManagedRuleGroupStatement(ManagedRuleGroupStatementT&& value) {
    SetManagedRuleGroupStatement(std::forward<ManagedRuleGroupStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLabelMatchStatement(LabelMatchStatementT&& value) {
    ...
    m_labelMatchStatement = std::forward<LabelMatchStatementT>(value);
  }
  template <typename LabelMatchStatementT = LabelMatchStatement>
  Statement& WithLabelMatchStatement(LabelMatchStatementT&& value) {
    SetLabelMatchStatement(std::forward<LabelMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegexMatchStatement(RegexMatchStatementT&& value) {
    ...
    m_regexMatchStatement = std::forward<RegexMatchStatementT>(value);
  }
  template <typename RegexMatchStatementT = RegexMatchStatement>
  Statement& WithRegexMatchStatement(RegexMatchStatementT&& value) {
    SetRegexMatchStatement(std::forward<RegexMatchStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAsnMatchStatement(AsnMatchStatementT&& value) {
    ...
    m_asnMatchStatement = std::forward<AsnMatchStatementT>(value);
  }
  template <typename AsnMatchStatementT = AsnMatchStatement>
  Statement& WithAsnMatchStatement(AsnMatchStatementT&& value) {
    SetAsnMatchStatement(std::forward<AsnMatchStatementT>(value));
    return *this;
  }
  ///@}
 private:
