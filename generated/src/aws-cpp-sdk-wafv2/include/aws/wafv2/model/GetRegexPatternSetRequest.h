...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API GetRegexPatternSetRequest() = default;
    ...
    template<typename NameT = Aws::String>
    GetRegexPatternSetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline GetRegexPatternSetRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetRegexPatternSetRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
