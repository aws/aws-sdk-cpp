...
class GetRuleGroupRequest : public WAFV2Request {
 public:
  ...
  template <typename NameT = Aws::String>
  GetRuleGroupRequest& WithName(NameT&& value) {
  ...
  inline GetRuleGroupRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  GetRuleGroupRequest& WithId(IdT&& value) {
  ...
  template <typename ARNT = Aws::String>
  GetRuleGroupRequest& WithARN(ARNT&& value) {
