...
class ListAvailableManagedRuleGroupVersionsRequest : public WAFV2Request {
 public:
  ...
  template <typename VendorNameT = Aws::String>
  ListAvailableManagedRuleGroupVersionsRequest& WithVendorName(VendorNameT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListAvailableManagedRuleGroupVersionsRequest& WithName(NameT&& value) {
  ...
  inline ListAvailableManagedRuleGroupVersionsRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListAvailableManagedRuleGroupVersionsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListAvailableManagedRuleGroupVersionsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
