...
class ManagedRuleGroupSummary {
 public:
  ...
  inline void SetVersioningSupported(bool value) {
    m_versioningSupportedHasBeenSet = true;
    m_versioningSupported = value;
  }
  inline ManagedRuleGroupSummary& WithVersioningSupported(bool value) {
    SetVersioningSupported(value);
    return *this;
  }
  ///@}
