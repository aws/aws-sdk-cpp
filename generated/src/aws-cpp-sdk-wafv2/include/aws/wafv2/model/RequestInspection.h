...
class RequestInspection {
 public:
  ...
  inline void SetPayloadType(PayloadType value) {
    m_payloadTypeHasBeenSet = true;
    m_payloadType = value;
  }
  inline RequestInspection& WithPayloadType(PayloadType value) {
  ...
  void SetUsernameField(UsernameFieldT&& value) {
    ...
    m_usernameField = std::forward<UsernameFieldT>(value);
  }
  template <typename UsernameFieldT = UsernameField>
  RequestInspection& WithUsernameField(UsernameFieldT&& value) {
    SetUsernameField(std::forward<UsernameFieldT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPasswordField(PasswordFieldT&& value) {
    ...
    m_passwordField = std::forward<PasswordFieldT>(value);
  }
  template <typename PasswordFieldT = PasswordField>
  RequestInspection& WithPasswordField(PasswordFieldT&& value) {
    SetPasswordField(std::forward<PasswordFieldT>(value));
    return *this;
  }
  ///@}
 private:
