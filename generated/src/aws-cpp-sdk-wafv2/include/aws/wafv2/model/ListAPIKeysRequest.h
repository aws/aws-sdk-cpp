...
namespace Model
{
  ...
  /**
   */
  class ListAPIKeysRequest : public WAFV2Request
  {
  public:
    AWS_WAFV2_API ListAPIKeysRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ListAPIKeys"; }
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListAPIKeysRequest& WithScope(const Scope& value) { SetScope(value); return *this;}
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListAPIKeysRequest& WithScope(Scope&& value) { SetScope(std::move(value)); return *this;}
     ...
     * request.</p>
     */
    inline ListAPIKeysRequest& WithNextMarker(const Aws::String& value) { SetNextMarker(value); return *this;}
     ...
     * request.</p>
     */
    inline ListAPIKeysRequest& WithNextMarker(Aws::String&& value) { SetNextMarker(std::move(value)); return *this;}
     ...
     * request.</p>
     */
    inline ListAPIKeysRequest& WithNextMarker(const char* value) { SetNextMarker(value); return *this;}
     ...
     * next batch of objects.</p>
     */
    inline ListAPIKeysRequest& WithLimit(int value) { SetLimit(value); return *this;}
