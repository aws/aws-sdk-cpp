...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API ListAPIKeysRequest() = default;
    ...
    inline ListAPIKeysRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListAPIKeysRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
