...
class FieldToMatch {
 public:
  ...
  void SetSingleQueryArgument(SingleQueryArgumentT&& value) {
    ...
    m_singleQueryArgument = std::forward<SingleQueryArgumentT>(value);
  }
  template <typename SingleQueryArgumentT = SingleQueryArgument>
  FieldToMatch& WithSingleQueryArgument(SingleQueryArgumentT&& value) {
    SetSingleQueryArgument(std::forward<SingleQueryArgumentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllQueryArguments(AllQueryArgumentsT&& value) {
    ...
    m_allQueryArguments = std::forward<AllQueryArgumentsT>(value);
  }
  template <typename AllQueryArgumentsT = AllQueryArguments>
  FieldToMatch& WithAllQueryArguments(AllQueryArgumentsT&& value) {
    SetAllQueryArguments(std::forward<AllQueryArgumentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJsonBody(JsonBodyT&& value) {
    ...
    m_jsonBody = std::forward<JsonBodyT>(value);
  }
  template <typename JsonBodyT = JsonBody>
  FieldToMatch& WithJsonBody(JsonBodyT&& value) {
    SetJsonBody(std::forward<JsonBodyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetHeaderOrder(HeaderOrderT&& value) {
    ...
    m_headerOrder = std::forward<HeaderOrderT>(value);
  }
  template <typename HeaderOrderT = HeaderOrder>
  FieldToMatch& WithHeaderOrder(HeaderOrderT&& value) {
    SetHeaderOrder(std::forward<HeaderOrderT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUriFragment(UriFragmentT&& value) {
    ...
    m_uriFragment = std::forward<UriFragmentT>(value);
  }
  template <typename UriFragmentT = UriFragment>
  FieldToMatch& WithUriFragment(UriFragmentT&& value) {
    SetUriFragment(std::forward<UriFragmentT>(value));
    return *this;
  }
  ///@}
 private:
