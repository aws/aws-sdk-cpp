...
class ListAvailableManagedRuleGroupsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListAvailableManagedRuleGroupsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetManagedRuleGroups(ManagedRuleGroupsT&& value) {
    m_managedRuleGroupsHasBeenSet = true;
    m_managedRuleGroups = std::forward<ManagedRuleGroupsT>(value);
  }
  template <typename ManagedRuleGroupsT = Aws::Vector<ManagedRuleGroupSummary>>
  ListAvailableManagedRuleGroupsResult& WithManagedRuleGroups(ManagedRuleGroupsT&& value) {
    SetManagedRuleGroups(std::forward<ManagedRuleGroupsT>(value));
    return *this;
  }
  template <typename ManagedRuleGroupsT = ManagedRuleGroupSummary>
  ListAvailableManagedRuleGroupsResult& AddManagedRuleGroups(ManagedRuleGroupsT&& value) {
    m_managedRuleGroupsHasBeenSet = true;
    m_managedRuleGroups.emplace_back(std::forward<ManagedRuleGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListAvailableManagedRuleGroupsResult& WithRequestId(RequestIdT&& value) {
