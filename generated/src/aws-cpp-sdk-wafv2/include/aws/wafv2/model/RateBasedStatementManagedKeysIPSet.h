...
class RateBasedStatementManagedKeysIPSet {
 public:
  ...
  inline void SetIPAddressVersion(IPAddressVersion value) {
    m_iPAddressVersionHasBeenSet = true;
    m_iPAddressVersion = value;
  }
  inline RateBasedStatementManagedKeysIPSet& WithIPAddressVersion(IPAddressVersion value) {
    SetIPAddressVersion(value);
    return *this;
  }
  ///@}
  ...
  template <typename AddressesT = Aws::Vector<Aws::String>>
  RateBasedStatementManagedKeysIPSet& WithAddresses(AddressesT&& value) {
    SetAddresses(std::forward<AddressesT>(value));
    return *this;
  }
  template <typename AddressesT = Aws::String>
  RateBasedStatementManagedKeysIPSet& AddAddresses(AddressesT&& value) {
    m_addressesHasBeenSet = true;
