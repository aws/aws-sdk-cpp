...
class IPSetForwardedIPConfig {
 public:
  ...
  template <typename HeaderNameT = Aws::String>
  IPSetForwardedIPConfig& WithHeaderName(HeaderNameT&& value) {
  ...
  inline IPSetForwardedIPConfig& WithFallbackBehavior(FallbackBehavior value) {
  ...
  inline void SetPosition(ForwardedIPPosition value) {
    m_positionHasBeenSet = true;
    m_position = value;
  }
  inline IPSetForwardedIPConfig& WithPosition(ForwardedIPPosition value) {
    SetPosition(value);
    return *this;
  }
  ///@}
