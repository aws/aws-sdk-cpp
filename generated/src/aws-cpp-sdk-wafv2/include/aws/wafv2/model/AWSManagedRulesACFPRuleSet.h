...
class AWSManagedRulesACFPRuleSet {
 public:
  ...
  void SetCreationPath(CreationPathT&& value) {
    m_creationPathHasBeenSet = true;
    m_creationPath = std::forward<CreationPathT>(value);
  }
  template <typename CreationPathT = Aws::String>
  AWSManagedRulesACFPRuleSet& WithCreationPath(CreationPathT&& value) {
    SetCreationPath(std::forward<CreationPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRegistrationPagePath(RegistrationPagePathT&& value) {
    m_registrationPagePathHasBeenSet = true;
    m_registrationPagePath = std::forward<RegistrationPagePathT>(value);
  }
  template <typename RegistrationPagePathT = Aws::String>
  AWSManagedRulesACFPRuleSet& WithRegistrationPagePath(RegistrationPagePathT&& value) {
    SetRegistrationPagePath(std::forward<RegistrationPagePathT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestInspectionT = RequestInspectionACFP>
  AWSManagedRulesACFPRuleSet& WithRequestInspection(RequestInspectionT&& value) {
  ...
  template <typename ResponseInspectionT = ResponseInspection>
  AWSManagedRulesACFPRuleSet& WithResponseInspection(ResponseInspectionT&& value) {
  ...
  inline AWSManagedRulesACFPRuleSet& WithEnableRegexInPath(bool value) {
