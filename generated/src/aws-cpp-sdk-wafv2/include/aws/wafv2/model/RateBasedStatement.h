...
class RateBasedStatement {
 public:
  ...
  inline void SetLimit(long long value) {
    m_limitHasBeenSet = true;
    m_limit = value;
  }
  inline RateBasedStatement& WithLimit(long long value) {
    SetLimit(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEvaluationWindowSec(long long value) {
    m_evaluationWindowSecHasBeenSet = true;
    m_evaluationWindowSec = value;
  }
  inline RateBasedStatement& WithEvaluationWindowSec(long long value) {
    SetEvaluationWindowSec(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAggregateKeyType(RateBasedStatementAggregateKeyType value) {
    m_aggregateKeyTypeHasBeenSet = true;
    m_aggregateKeyType = value;
  }
  inline RateBasedStatement& WithAggregateKeyType(RateBasedStatementAggregateKeyType value) {
    SetAggregateKeyType(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Statement& GetScopeDownStatement() const { return *m_scopeDownStatement; }
  ...
  RateBasedStatement& WithScopeDownStatement(ScopeDownStatementT&& value) {
    SetScopeDownStatement(std::forward<ScopeDownStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForwardedIPConfig(ForwardedIPConfigT&& value) {
    ...
    m_forwardedIPConfig = std::forward<ForwardedIPConfigT>(value);
  }
  template <typename ForwardedIPConfigT = ForwardedIPConfig>
  RateBasedStatement& WithForwardedIPConfig(ForwardedIPConfigT&& value) {
    SetForwardedIPConfig(std::forward<ForwardedIPConfigT>(value));
    return *this;
  }
  ///@}
