...
class ManagedProductDescriptor {
 public:
  ...
  void SetManagedRuleSetName(ManagedRuleSetNameT&& value) {
    ...
    m_managedRuleSetName = std::forward<ManagedRuleSetNameT>(value);
  }
  template <typename ManagedRuleSetNameT = Aws::String>
  ManagedProductDescriptor& WithManagedRuleSetName(ManagedRuleSetNameT&& value) {
    SetManagedRuleSetName(std::forward<ManagedRuleSetNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetProductLink(ProductLinkT&& value) {
    ...
    m_productLink = std::forward<ProductLinkT>(value);
  }
  template <typename ProductLinkT = Aws::String>
  ManagedProductDescriptor& WithProductLink(ProductLinkT&& value) {
    SetProductLink(std::forward<ProductLinkT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsVersioningSupported(bool value) {
    m_isVersioningSupportedHasBeenSet = true;
    m_isVersioningSupported = value;
  }
  inline ManagedProductDescriptor& WithIsVersioningSupported(bool value) {
    SetIsVersioningSupported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIsAdvancedManagedRuleSet(bool value) {
    m_isAdvancedManagedRuleSetHasBeenSet = true;
    m_isAdvancedManagedRuleSet = value;
  }
  inline ManagedProductDescriptor& WithIsAdvancedManagedRuleSet(bool value) {
    SetIsAdvancedManagedRuleSet(value);
    return *this;
  }
  ///@}
 private:
