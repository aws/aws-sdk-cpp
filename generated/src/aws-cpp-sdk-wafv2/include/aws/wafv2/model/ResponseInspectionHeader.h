...
class ResponseInspectionHeader {
 public:
  ...
  void SetSuccessValues(SuccessValuesT&& value) {
    m_successValuesHasBeenSet = true;
    m_successValues = std::forward<SuccessValuesT>(value);
  }
  template <typename SuccessValuesT = Aws::Vector<Aws::String>>
  ResponseInspectionHeader& WithSuccessValues(SuccessValuesT&& value) {
    SetSuccessValues(std::forward<SuccessValuesT>(value));
    return *this;
  }
  template <typename SuccessValuesT = Aws::String>
  ResponseInspectionHeader& AddSuccessValues(SuccessValuesT&& value) {
    m_successValuesHasBeenSet = true;
    m_successValues.emplace_back(std::forward<SuccessValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFailureValues(FailureValuesT&& value) {
    m_failureValuesHasBeenSet = true;
    m_failureValues = std::forward<FailureValuesT>(value);
  }
  template <typename FailureValuesT = Aws::Vector<Aws::String>>
  ResponseInspectionHeader& WithFailureValues(FailureValuesT&& value) {
    SetFailureValues(std::forward<FailureValuesT>(value));
    return *this;
  }
  template <typename FailureValuesT = Aws::String>
  ResponseInspectionHeader& AddFailureValues(FailureValuesT&& value) {
    m_failureValuesHasBeenSet = true;
    m_failureValues.emplace_back(std::forward<FailureValuesT>(value));
    return *this;
  }
  ///@}
 private:
