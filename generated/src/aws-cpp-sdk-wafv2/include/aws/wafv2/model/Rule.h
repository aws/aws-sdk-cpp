...
class Rule {
 public:
  ...
  inline Rule& WithPriority(int value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  void SetRuleLabels(RuleLabelsT&& value) {
    ...
    m_ruleLabels = std::forward<RuleLabelsT>(value);
  }
  template <typename RuleLabelsT = Aws::Vector<Label>>
  Rule& WithRuleLabels(RuleLabelsT&& value) {
    SetRuleLabels(std::forward<RuleLabelsT>(value));
    return *this;
  }
  template <typename RuleLabelsT = Label>
  Rule& AddRuleLabels(RuleLabelsT&& value) {
    m_ruleLabelsHasBeenSet = true;
    m_ruleLabels.emplace_back(std::forward<RuleLabelsT>(value));
    return *this;
  }
  ///@}
