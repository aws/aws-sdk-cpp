...
class ForwardedIPConfig {
 public:
  ...
  template <typename HeaderNameT = Aws::String>
  ForwardedIPConfig& WithHeaderName(HeaderNameT&& value) {
  ...
  inline void SetFallbackBehavior(FallbackBehavior value) {
    m_fallbackBehaviorHasBeenSet = true;
    m_fallbackBehavior = value;
  }
  inline ForwardedIPConfig& WithFallbackBehavior(FallbackBehavior value) {
