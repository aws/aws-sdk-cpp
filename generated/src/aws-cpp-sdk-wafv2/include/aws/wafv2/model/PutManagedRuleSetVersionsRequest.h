...
class PutManagedRuleSetVersionsRequest : public WAFV2Request {
 public:
  ...
  inline PutManagedRuleSetVersionsRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  void SetVersionsToPublish(VersionsToPublishT&& value) {
    m_versionsToPublishHasBeenSet = true;
    m_versionsToPublish = std::forward<VersionsToPublishT>(value);
  }
  template <typename VersionsToPublishT = Aws::Map<Aws::String, VersionToPublish>>
  PutManagedRuleSetVersionsRequest& WithVersionsToPublish(VersionsToPublishT&& value) {
    SetVersionsToPublish(std::forward<VersionsToPublishT>(value));
    return *this;
  }
  ...
  PutManagedRuleSetVersionsRequest& AddVersionsToPublish(VersionsToPublishKeyT&& key, VersionsToPublishValueT&& value) {
    m_versionsToPublishHasBeenSet = true;
    m_versionsToPublish.emplace(std::forward<VersionsToPublishKeyT>(key), std::forward<VersionsToPublishValueT>(value));
    return *this;
  }
  ///@}
 private:
