...
class ClientSideAction {
 public:
  ...
  inline void SetUsageOfAction(UsageOfAction value) {
    ...
    m_usageOfAction = value;
  }
  inline ClientSideAction& WithUsageOfAction(UsageOfAction value) {
    SetUsageOfAction(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSensitivity(SensitivityToAct value) {
    m_sensitivityHasBeenSet = true;
    m_sensitivity = value;
  }
  inline ClientSideAction& WithSensitivity(SensitivityToAct value) {
  ...
  void SetExemptUriRegularExpressions(ExemptUriRegularExpressionsT&& value) {
    ...
    m_exemptUriRegularExpressions = std::forward<ExemptUriRegularExpressionsT>(value);
  }
  template <typename ExemptUriRegularExpressionsT = Aws::Vector<Regex>>
  ClientSideAction& WithExemptUriRegularExpressions(ExemptUriRegularExpressionsT&& value) {
    SetExemptUriRegularExpressions(std::forward<ExemptUriRegularExpressionsT>(value));
    return *this;
  }
  ...
  ClientSideAction& AddExemptUriRegularExpressions(ExemptUriRegularExpressionsT&& value) {
    m_exemptUriRegularExpressionsHasBeenSet = true;
    m_exemptUriRegularExpressions.emplace_back(std::forward<ExemptUriRegularExpressionsT>(value));
    return *this;
  }
  ///@}
 private:
