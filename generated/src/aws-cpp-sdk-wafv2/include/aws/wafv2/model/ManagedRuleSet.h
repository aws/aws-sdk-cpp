...
class ManagedRuleSet {
 public:
  ...
  void SetPublishedVersions(PublishedVersionsT&& value) {
    ...
    m_publishedVersions = std::forward<PublishedVersionsT>(value);
  }
  template <typename PublishedVersionsT = Aws::Map<Aws::String, ManagedRuleSetVersion>>
  ManagedRuleSet& WithPublishedVersions(PublishedVersionsT&& value) {
    SetPublishedVersions(std::forward<PublishedVersionsT>(value));
    return *this;
  }
  ...
  ManagedRuleSet& AddPublishedVersions(PublishedVersionsKeyT&& key, PublishedVersionsValueT&& value) {
    m_publishedVersionsHasBeenSet = true;
    m_publishedVersions.emplace(std::forward<PublishedVersionsKeyT>(key), std::forward<PublishedVersionsValueT>(value));
    return *this;
  }
  ///@}
