...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Strings in the body of the response that indicate a successful login attempt.
     ...
     * success and failure strings. </p> <p>JSON example: <code>"SuccessStrings": [
    ...
    /**
     * <p>Strings in the body of the response that indicate a failed login attempt. To
     ...
     * failure strings. </p> <p>JSON example: <code>"FailureStrings": [ "Login failed"
     * ]</code> </p>
     */
