...
namespace Model
{
  ...
  public:
    ...
    template<typename NameT = Aws::String>
    GetManagedRuleSetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline GetManagedRuleSetRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    GetManagedRuleSetRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
  private:
