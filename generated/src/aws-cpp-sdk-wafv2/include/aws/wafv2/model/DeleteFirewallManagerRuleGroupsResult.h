...
class DeleteFirewallManagerRuleGroupsResult {
 public:
  ...
  void SetNextWebACLLockToken(NextWebACLLockTokenT&& value) {
    m_nextWebACLLockTokenHasBeenSet = true;
    m_nextWebACLLockToken = std::forward<NextWebACLLockTokenT>(value);
  }
  template <typename NextWebACLLockTokenT = Aws::String>
  DeleteFirewallManagerRuleGroupsResult& WithNextWebACLLockToken(NextWebACLLockTokenT&& value) {
    SetNextWebACLLockToken(std::forward<NextWebACLLockTokenT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DeleteFirewallManagerRuleGroupsResult& WithRequestId(RequestIdT&& value) {
