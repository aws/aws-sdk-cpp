...
class ManagedRuleGroupConfig {
 public:
  ...
  void SetAWSManagedRulesBotControlRuleSet(AWSManagedRulesBotControlRuleSetT&& value) {
    ...
    m_aWSManagedRulesBotControlRuleSet = std::forward<AWSManagedRulesBotControlRuleSetT>(value);
  }
  template <typename AWSManagedRulesBotControlRuleSetT = AWSManagedRulesBotControlRuleSet>
  ManagedRuleGroupConfig& WithAWSManagedRulesBotControlRuleSet(AWSManagedRulesBotControlRuleSetT&& value) {
    SetAWSManagedRulesBotControlRuleSet(std::forward<AWSManagedRulesBotControlRuleSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAWSManagedRulesATPRuleSet(AWSManagedRulesATPRuleSetT&& value) {
    ...
    m_aWSManagedRulesATPRuleSet = std::forward<AWSManagedRulesATPRuleSetT>(value);
  }
  template <typename AWSManagedRulesATPRuleSetT = AWSManagedRulesATPRuleSet>
  ManagedRuleGroupConfig& WithAWSManagedRulesATPRuleSet(AWSManagedRulesATPRuleSetT&& value) {
    SetAWSManagedRulesATPRuleSet(std::forward<AWSManagedRulesATPRuleSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAWSManagedRulesACFPRuleSet(AWSManagedRulesACFPRuleSetT&& value) {
    ...
    m_aWSManagedRulesACFPRuleSet = std::forward<AWSManagedRulesACFPRuleSetT>(value);
  }
  template <typename AWSManagedRulesACFPRuleSetT = AWSManagedRulesACFPRuleSet>
  ManagedRuleGroupConfig& WithAWSManagedRulesACFPRuleSet(AWSManagedRulesACFPRuleSetT&& value) {
    SetAWSManagedRulesACFPRuleSet(std::forward<AWSManagedRulesACFPRuleSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAWSManagedRulesAntiDDoSRuleSet(AWSManagedRulesAntiDDoSRuleSetT&& value) {
    ...
    m_aWSManagedRulesAntiDDoSRuleSet = std::forward<AWSManagedRulesAntiDDoSRuleSetT>(value);
  }
  template <typename AWSManagedRulesAntiDDoSRuleSetT = AWSManagedRulesAntiDDoSRuleSet>
  ManagedRuleGroupConfig& WithAWSManagedRulesAntiDDoSRuleSet(AWSManagedRulesAntiDDoSRuleSetT&& value) {
    SetAWSManagedRulesAntiDDoSRuleSet(std::forward<AWSManagedRulesAntiDDoSRuleSetT>(value));
    return *this;
  }
  ///@}
 private:
