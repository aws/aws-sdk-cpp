...
class ListMobileSdkReleasesRequest : public WAFV2Request {
 public:
  AWS_WAFV2_API ListMobileSdkReleasesRequest() = default;
  ...
  inline ListMobileSdkReleasesRequest& WithPlatform(Platform value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListMobileSdkReleasesRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListMobileSdkReleasesRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
