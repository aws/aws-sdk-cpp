...
class DeleteWebACLRequest : public WAFV2Request {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteWebACLRequest& WithName(NameT&& value) {
  ...
  inline DeleteWebACLRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  DeleteWebACLRequest& WithId(IdT&& value) {
  ...
  template <typename LockTokenT = Aws::String>
  DeleteWebACLRequest& WithLockToken(LockTokenT&& value) {
