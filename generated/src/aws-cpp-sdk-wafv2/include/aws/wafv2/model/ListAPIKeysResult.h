...
class ListAPIKeysResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListAPIKeysResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetAPIKeySummaries(APIKeySummariesT&& value) {
    m_aPIKeySummariesHasBeenSet = true;
    m_aPIKeySummaries = std::forward<APIKeySummariesT>(value);
  }
  template <typename APIKeySummariesT = Aws::Vector<APIKeySummary>>
  ListAPIKeysResult& WithAPIKeySummaries(APIKeySummariesT&& value) {
    SetAPIKeySummaries(std::forward<APIKeySummariesT>(value));
    return *this;
  }
  template <typename APIKeySummariesT = APIKeySummary>
  ListAPIKeysResult& AddAPIKeySummaries(APIKeySummariesT&& value) {
    m_aPIKeySummariesHasBeenSet = true;
    m_aPIKeySummaries.emplace_back(std::forward<APIKeySummariesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationIntegrationURL(ApplicationIntegrationURLT&& value) {
    ...
    m_applicationIntegrationURL = std::forward<ApplicationIntegrationURLT>(value);
  }
  template <typename ApplicationIntegrationURLT = Aws::String>
  ListAPIKeysResult& WithApplicationIntegrationURL(ApplicationIntegrationURLT&& value) {
    SetApplicationIntegrationURL(std::forward<ApplicationIntegrationURLT>(value));
    return *this;
  }
  ///@}
