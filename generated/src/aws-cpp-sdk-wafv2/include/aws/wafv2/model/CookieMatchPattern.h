...
class CookieMatchPattern {
 public:
  ...
  void SetAll(AllT&& value) {
    ...
    m_all = std::forward<AllT>(value);
  }
  template <typename AllT = All>
  CookieMatchPattern& WithAll(AllT&& value) {
    SetAll(std::forward<AllT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIncludedCookies(IncludedCookiesT&& value) {
    ...
    m_includedCookies = std::forward<IncludedCookiesT>(value);
  }
  template <typename IncludedCookiesT = Aws::Vector<Aws::String>>
  CookieMatchPattern& WithIncludedCookies(IncludedCookiesT&& value) {
    SetIncludedCookies(std::forward<IncludedCookiesT>(value));
    return *this;
  }
  template <typename IncludedCookiesT = Aws::String>
  CookieMatchPattern& AddIncludedCookies(IncludedCookiesT&& value) {
    m_includedCookiesHasBeenSet = true;
    m_includedCookies.emplace_back(std::forward<IncludedCookiesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludedCookies(ExcludedCookiesT&& value) {
    ...
    m_excludedCookies = std::forward<ExcludedCookiesT>(value);
  }
  template <typename ExcludedCookiesT = Aws::Vector<Aws::String>>
  CookieMatchPattern& WithExcludedCookies(ExcludedCookiesT&& value) {
    SetExcludedCookies(std::forward<ExcludedCookiesT>(value));
    return *this;
  }
  template <typename ExcludedCookiesT = Aws::String>
  CookieMatchPattern& AddExcludedCookies(ExcludedCookiesT&& value) {
    m_excludedCookiesHasBeenSet = true;
    m_excludedCookies.emplace_back(std::forward<ExcludedCookiesT>(value));
    return *this;
  }
  ///@}
 private:
