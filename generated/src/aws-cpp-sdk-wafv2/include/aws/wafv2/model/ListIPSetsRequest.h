...
namespace Model
{
  ...
  /**
   */
  class ListIPSetsRequest : public WAFV2Request
  {
  public:
    AWS_WAFV2_API ListIPSetsRequest() = default;
    ...
    inline ListIPSetsRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListIPSetsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
