...
class UpdateManagedRuleSetVersionExpiryDateRequest : public WAFV2Request {
 public:
  ...
  template <typename NameT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateRequest& WithName(NameT&& value) {
  ...
  inline UpdateManagedRuleSetVersionExpiryDateRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateRequest& WithId(IdT&& value) {
  ...
  template <typename LockTokenT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateRequest& WithLockToken(LockTokenT&& value) {
  ...
  void SetVersionToExpire(VersionToExpireT&& value) {
    m_versionToExpireHasBeenSet = true;
    m_versionToExpire = std::forward<VersionToExpireT>(value);
  }
  template <typename VersionToExpireT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateRequest& WithVersionToExpire(VersionToExpireT&& value) {
    SetVersionToExpire(std::forward<VersionToExpireT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExpiryTimestamp(ExpiryTimestampT&& value) {
    ...
    m_expiryTimestamp = std::forward<ExpiryTimestampT>(value);
  }
  template <typename ExpiryTimestampT = Aws::Utils::DateTime>
  UpdateManagedRuleSetVersionExpiryDateRequest& WithExpiryTimestamp(ExpiryTimestampT&& value) {
    SetExpiryTimestamp(std::forward<ExpiryTimestampT>(value));
    return *this;
  }
  ///@}
 private:
