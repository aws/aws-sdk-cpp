...
class UpdateManagedRuleSetVersionExpiryDateResult {
 public:
  ...
  AWS_WAFV2_API UpdateManagedRuleSetVersionExpiryDateResult& operator=(
  ...
  void SetExpiringVersion(ExpiringVersionT&& value) {
    m_expiringVersionHasBeenSet = true;
    m_expiringVersion = std::forward<ExpiringVersionT>(value);
  }
  template <typename ExpiringVersionT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateResult& WithExpiringVersion(ExpiringVersionT&& value) {
    SetExpiringVersion(std::forward<ExpiringVersionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ExpiryTimestampT = Aws::Utils::DateTime>
  UpdateManagedRuleSetVersionExpiryDateResult& WithExpiryTimestamp(ExpiryTimestampT&& value) {
  ...
  template <typename NextLockTokenT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateResult& WithNextLockToken(NextLockTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateManagedRuleSetVersionExpiryDateResult& WithRequestId(RequestIdT&& value) {
