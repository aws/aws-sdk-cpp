...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API DeleteIPSetRequest() = default;
    ...
    template<typename NameT = Aws::String>
    DeleteIPSetRequest& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
    ...
    inline DeleteIPSetRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename IdT = Aws::String>
    DeleteIPSetRequest& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename LockTokenT = Aws::String>
    DeleteIPSetRequest& WithLockToken(LockTokenT&& value) { SetLockToken(std::forward<LockTokenT>(value)); return *this;}
    ///@}
  private:
