...
class DeleteIPSetRequest : public WAFV2Request {
 public:
  ...
  template <typename NameT = Aws::String>
  DeleteIPSetRequest& WithName(NameT&& value) {
  ...
  inline DeleteIPSetRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename IdT = Aws::String>
  DeleteIPSetRequest& WithId(IdT&& value) {
  ...
  template <typename LockTokenT = Aws::String>
  DeleteIPSetRequest& WithLockToken(LockTokenT&& value) {
