...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API DeleteLoggingConfigurationRequest() = default;
    ...
    inline DeleteLoggingConfigurationRequest& WithLogType(LogType value) { SetLogType(value); return *this;}
    ///@}
    ...
    inline DeleteLoggingConfigurationRequest& WithLogScope(LogScope value) { SetLogScope(value); return *this;}
    ///@}
  private:
