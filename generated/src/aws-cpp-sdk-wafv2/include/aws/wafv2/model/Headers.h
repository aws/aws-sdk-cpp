...
class Headers {
 public:
  ...
  inline void SetMatchScope(MapMatchScope value) {
    m_matchScopeHasBeenSet = true;
    m_matchScope = value;
  }
  inline Headers& WithMatchScope(MapMatchScope value) {
    SetMatchScope(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOversizeHandling(OversizeHandling value) {
    m_oversizeHandlingHasBeenSet = true;
    m_oversizeHandling = value;
  }
  inline Headers& WithOversizeHandling(OversizeHandling value) {
    SetOversizeHandling(value);
    return *this;
  }
  ///@}
 private:
