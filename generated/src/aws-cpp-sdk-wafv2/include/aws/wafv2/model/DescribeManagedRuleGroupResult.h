...
class DescribeManagedRuleGroupResult {
 public:
  ...
  inline DescribeManagedRuleGroupResult& WithCapacity(long long value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
