...
class RateBasedStatementCustomKey {
 public:
  ...
  void SetCookie(CookieT&& value) {
    ...
    m_cookie = std::forward<CookieT>(value);
  }
  template <typename CookieT = RateLimitCookie>
  RateBasedStatementCustomKey& WithCookie(CookieT&& value) {
    SetCookie(std::forward<CookieT>(value));
    return *this;
  }
  ///@}
  ...
  void SetQueryArgument(QueryArgumentT&& value) {
    ...
    m_queryArgument = std::forward<QueryArgumentT>(value);
  }
  template <typename QueryArgumentT = RateLimitQueryArgument>
  RateBasedStatementCustomKey& WithQueryArgument(QueryArgumentT&& value) {
    SetQueryArgument(std::forward<QueryArgumentT>(value));
    return *this;
  }
  ///@}
  ...
  void SetForwardedIP(ForwardedIPT&& value) {
    ...
    m_forwardedIP = std::forward<ForwardedIPT>(value);
  }
  template <typename ForwardedIPT = RateLimitForwardedIP>
  RateBasedStatementCustomKey& WithForwardedIP(ForwardedIPT&& value) {
    SetForwardedIP(std::forward<ForwardedIPT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJA3Fingerprint(JA3FingerprintT&& value) {
    ...
    m_jA3Fingerprint = std::forward<JA3FingerprintT>(value);
  }
  template <typename JA3FingerprintT = RateLimitJA3Fingerprint>
  RateBasedStatementCustomKey& WithJA3Fingerprint(JA3FingerprintT&& value) {
    SetJA3Fingerprint(std::forward<JA3FingerprintT>(value));
    return *this;
  }
  ///@}
  ...
  void SetJA4Fingerprint(JA4FingerprintT&& value) {
    ...
    m_jA4Fingerprint = std::forward<JA4FingerprintT>(value);
  }
  template <typename JA4FingerprintT = RateLimitJA4Fingerprint>
  RateBasedStatementCustomKey& WithJA4Fingerprint(JA4FingerprintT&& value) {
    SetJA4Fingerprint(std::forward<JA4FingerprintT>(value));
    return *this;
  }
  ///@}
