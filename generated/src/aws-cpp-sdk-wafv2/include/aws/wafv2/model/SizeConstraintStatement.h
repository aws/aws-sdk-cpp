...
class SizeConstraintStatement {
 public:
  ...
  inline SizeConstraintStatement& WithComparisonOperator(ComparisonOperator value) {
  ...
  inline SizeConstraintStatement& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  template <typename PreParseTextTransformationsT = Aws::Vector<PreParseTextTransformation>>
  SizeConstraintStatement& WithPreParseTextTransformations(PreParseTextTransformationsT&& value) {
  ...
  SizeConstraintStatement& AddPreParseTextTransformations(PreParseTextTransformationsT&& value) {
    m_preParseTextTransformationsHasBeenSet = true;
