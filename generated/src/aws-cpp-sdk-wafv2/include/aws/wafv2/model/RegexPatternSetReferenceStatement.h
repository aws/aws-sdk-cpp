...
class RegexPatternSetReferenceStatement {
 public:
  ...
  template <typename PreParseTextTransformationsT = Aws::Vector<PreParseTextTransformation>>
  RegexPatternSetReferenceStatement& WithPreParseTextTransformations(PreParseTextTransformationsT&& value) {
  ...
  RegexPatternSetReferenceStatement& AddPreParseTextTransformations(PreParseTextTransformationsT&& value) {
    m_preParseTextTransformationsHasBeenSet = true;
