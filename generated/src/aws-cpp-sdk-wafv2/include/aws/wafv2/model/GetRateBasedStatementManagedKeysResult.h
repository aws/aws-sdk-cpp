...
class GetRateBasedStatementManagedKeysResult {
 public:
  ...
  void SetManagedKeysIPV4(ManagedKeysIPV4T&& value) {
    m_managedKeysIPV4HasBeenSet = true;
    m_managedKeysIPV4 = std::forward<ManagedKeysIPV4T>(value);
  }
  template <typename ManagedKeysIPV4T = RateBasedStatementManagedKeysIPSet>
  GetRateBasedStatementManagedKeysResult& WithManagedKeysIPV4(ManagedKeysIPV4T&& value) {
    SetManagedKeysIPV4(std::forward<ManagedKeysIPV4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetManagedKeysIPV6(ManagedKeysIPV6T&& value) {
    m_managedKeysIPV6HasBeenSet = true;
    m_managedKeysIPV6 = std::forward<ManagedKeysIPV6T>(value);
  }
  template <typename ManagedKeysIPV6T = RateBasedStatementManagedKeysIPSet>
  GetRateBasedStatementManagedKeysResult& WithManagedKeysIPV6(ManagedKeysIPV6T&& value) {
    SetManagedKeysIPV6(std::forward<ManagedKeysIPV6T>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetRateBasedStatementManagedKeysResult& WithRequestId(RequestIdT&& value) {
