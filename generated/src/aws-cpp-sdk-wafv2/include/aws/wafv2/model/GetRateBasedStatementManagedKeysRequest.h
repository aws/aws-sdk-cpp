...
class GetRateBasedStatementManagedKeysRequest : public WAFV2Request {
 public:
  ...
  inline GetRateBasedStatementManagedKeysRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  void SetWebACLName(WebACLNameT&& value) {
    m_webACLNameHasBeenSet = true;
    m_webACLName = std::forward<WebACLNameT>(value);
  }
  template <typename WebACLNameT = Aws::String>
  GetRateBasedStatementManagedKeysRequest& WithWebACLName(WebACLNameT&& value) {
    SetWebACLName(std::forward<WebACLNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename WebACLIdT = Aws::String>
  GetRateBasedStatementManagedKeysRequest& WithWebACLId(WebACLIdT&& value) {
  ...
  void SetRuleGroupRuleName(RuleGroupRuleNameT&& value) {
    m_ruleGroupRuleNameHasBeenSet = true;
    m_ruleGroupRuleName = std::forward<RuleGroupRuleNameT>(value);
  }
  template <typename RuleGroupRuleNameT = Aws::String>
  GetRateBasedStatementManagedKeysRequest& WithRuleGroupRuleName(RuleGroupRuleNameT&& value) {
    SetRuleGroupRuleName(std::forward<RuleGroupRuleNameT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RuleNameT = Aws::String>
  GetRateBasedStatementManagedKeysRequest& WithRuleName(RuleNameT&& value) {
