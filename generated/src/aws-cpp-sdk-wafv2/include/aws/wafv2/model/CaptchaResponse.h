...
class CaptchaResponse {
 public:
  ...
  inline CaptchaResponse& WithResponseCode(int value) {
  ...
  inline void SetSolveTimestamp(long long value) {
    m_solveTimestampHasBeenSet = true;
    m_solveTimestamp = value;
  }
  inline CaptchaResponse& WithSolveTimestamp(long long value) {
    SetSolveTimestamp(value);
    return *this;
  }
  ///@}
  ...
  inline CaptchaResponse& WithFailureReason(FailureReason value) {
