...
class AWSManagedRulesATPRuleSet {
 public:
  ...
  void SetLoginPath(LoginPathT&& value) {
    m_loginPathHasBeenSet = true;
    m_loginPath = std::forward<LoginPathT>(value);
  }
  template <typename LoginPathT = Aws::String>
  AWSManagedRulesATPRuleSet& WithLoginPath(LoginPathT&& value) {
    SetLoginPath(std::forward<LoginPathT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequestInspection(RequestInspectionT&& value) {
    m_requestInspectionHasBeenSet = true;
    m_requestInspection = std::forward<RequestInspectionT>(value);
  }
  template <typename RequestInspectionT = RequestInspection>
  AWSManagedRulesATPRuleSet& WithRequestInspection(RequestInspectionT&& value) {
    SetRequestInspection(std::forward<RequestInspectionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResponseInspection(ResponseInspectionT&& value) {
    m_responseInspectionHasBeenSet = true;
    m_responseInspection = std::forward<ResponseInspectionT>(value);
  }
  template <typename ResponseInspectionT = ResponseInspection>
  AWSManagedRulesATPRuleSet& WithResponseInspection(ResponseInspectionT&& value) {
    SetResponseInspection(std::forward<ResponseInspectionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEnableRegexInPath(bool value) {
    m_enableRegexInPathHasBeenSet = true;
    m_enableRegexInPath = value;
  }
  inline AWSManagedRulesATPRuleSet& WithEnableRegexInPath(bool value) {
