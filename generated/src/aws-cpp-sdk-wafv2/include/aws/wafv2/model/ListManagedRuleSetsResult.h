...
class ListManagedRuleSetsResult {
 public:
  ...
  template <typename NextMarkerT = Aws::String>
  ListManagedRuleSetsResult& WithNextMarker(NextMarkerT&& value) {
  ...
  void SetManagedRuleSets(ManagedRuleSetsT&& value) {
    m_managedRuleSetsHasBeenSet = true;
    m_managedRuleSets = std::forward<ManagedRuleSetsT>(value);
  }
  template <typename ManagedRuleSetsT = Aws::Vector<ManagedRuleSetSummary>>
  ListManagedRuleSetsResult& WithManagedRuleSets(ManagedRuleSetsT&& value) {
    SetManagedRuleSets(std::forward<ManagedRuleSetsT>(value));
    return *this;
  }
  template <typename ManagedRuleSetsT = ManagedRuleSetSummary>
  ListManagedRuleSetsResult& AddManagedRuleSets(ManagedRuleSetsT&& value) {
    m_managedRuleSetsHasBeenSet = true;
    m_managedRuleSets.emplace_back(std::forward<ManagedRuleSetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListManagedRuleSetsResult& WithRequestId(RequestIdT&& value) {
