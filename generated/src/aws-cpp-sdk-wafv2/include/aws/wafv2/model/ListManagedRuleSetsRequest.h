...
namespace Model
{
  ...
  /**
   */
  class ListManagedRuleSetsRequest : public WAFV2Request
  {
  public:
    AWS_WAFV2_API ListManagedRuleSetsRequest();

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "ListManagedRuleSets"; }
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListManagedRuleSetsRequest& WithScope(const Scope& value) { SetScope(value); return *this;}
     ...
     * the Region endpoint us-east-1. </p> </li> </ul>
     */
    inline ListManagedRuleSetsRequest& WithScope(Scope&& value) { SetScope(std::move(value)); return *this;}
     ...
     * request.</p>
     */
    inline ListManagedRuleSetsRequest& WithNextMarker(const Aws::String& value) { SetNextMarker(value); return *this;}
     ...
     * request.</p>
     */
    inline ListManagedRuleSetsRequest& WithNextMarker(Aws::String&& value) { SetNextMarker(std::move(value)); return *this;}
     ...
     * request.</p>
     */
    inline ListManagedRuleSetsRequest& WithNextMarker(const char* value) { SetNextMarker(value); return *this;}
     ...
     * next batch of objects.</p>
     */
    inline ListManagedRuleSetsRequest& WithLimit(int value) { SetLimit(value); return *this;}
