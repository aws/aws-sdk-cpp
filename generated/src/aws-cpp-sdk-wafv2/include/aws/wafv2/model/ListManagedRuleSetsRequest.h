...
class ListManagedRuleSetsRequest : public WAFV2Request {
 public:
  ...
  inline ListManagedRuleSetsRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListManagedRuleSetsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListManagedRuleSetsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
