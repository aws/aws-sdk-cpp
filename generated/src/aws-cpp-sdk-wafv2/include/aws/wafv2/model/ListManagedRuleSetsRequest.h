...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API ListManagedRuleSetsRequest() = default;
    ...
    inline ListManagedRuleSetsRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListManagedRuleSetsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
