...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API UpdateIPSetResult() = default;
    ...
    template<typename NextLockTokenT = Aws::String>
    UpdateIPSetResult& WithNextLockToken(NextLockTokenT&& value) { SetNextLockToken(std::forward<NextLockTokenT>(value)); return *this;}
    ///@}
