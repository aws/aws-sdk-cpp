...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>Status codes in the response that indicate a successful login attempt. To be
     * counted as a successful login, the response status code must match one of these.
     * Each code must be unique among the success and failure status codes. </p>
    ...
    /**
     * <p>Status codes in the response that indicate a failed login attempt. To be
