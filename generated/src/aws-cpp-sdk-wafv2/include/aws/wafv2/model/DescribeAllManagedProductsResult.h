...
class DescribeAllManagedProductsResult {
 public:
  ...
  void SetManagedProducts(ManagedProductsT&& value) {
    m_managedProductsHasBeenSet = true;
    m_managedProducts = std::forward<ManagedProductsT>(value);
  }
  template <typename ManagedProductsT = Aws::Vector<ManagedProductDescriptor>>
  DescribeAllManagedProductsResult& WithManagedProducts(ManagedProductsT&& value) {
    SetManagedProducts(std::forward<ManagedProductsT>(value));
    return *this;
  }
  template <typename ManagedProductsT = ManagedProductDescriptor>
  DescribeAllManagedProductsResult& AddManagedProducts(ManagedProductsT&& value) {
    m_managedProductsHasBeenSet = true;
    m_managedProducts.emplace_back(std::forward<ManagedProductsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeAllManagedProductsResult& WithRequestId(RequestIdT&& value) {
