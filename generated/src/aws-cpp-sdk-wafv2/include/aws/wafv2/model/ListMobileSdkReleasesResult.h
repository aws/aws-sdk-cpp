...
class ListMobileSdkReleasesResult {
 public:
  ...
  void SetReleaseSummaries(ReleaseSummariesT&& value) {
    m_releaseSummariesHasBeenSet = true;
    m_releaseSummaries = std::forward<ReleaseSummariesT>(value);
  }
  template <typename ReleaseSummariesT = Aws::Vector<ReleaseSummary>>
  ListMobileSdkReleasesResult& WithReleaseSummaries(ReleaseSummariesT&& value) {
    SetReleaseSummaries(std::forward<ReleaseSummariesT>(value));
    return *this;
  }
  template <typename ReleaseSummariesT = ReleaseSummary>
  ListMobileSdkReleasesResult& AddReleaseSummaries(ReleaseSummariesT&& value) {
    m_releaseSummariesHasBeenSet = true;
    m_releaseSummaries.emplace_back(std::forward<ReleaseSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListMobileSdkReleasesResult& WithNextMarker(NextMarkerT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListMobileSdkReleasesResult& WithRequestId(RequestIdT&& value) {
