 ...
 * user pool, App Runner service, Amplify application, Amazon Web Services Verified
 * Access instance, and Amazon Bedrock AgentCore Gateway. </p><p><h3>See Also:</h3>
 * <a href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/WebACL">AWS API
 * Reference</a></p>
 */
class WebACL {
 public:
  ...
  void SetDataProtectionConfig(DataProtectionConfigT&& value) {
    ...
    m_dataProtectionConfig = std::forward<DataProtectionConfigT>(value);
  }
  template <typename DataProtectionConfigT = DataProtectionConfig>
  WebACL& WithDataProtectionConfig(DataProtectionConfigT&& value) {
    SetDataProtectionConfig(std::forward<DataProtectionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline WebACL& WithCapacity(long long value) {
    SetCapacity(value);
    return *this;
  }
  ///@}
   ...
   * processing order.</p>
   */
  inline const Aws::Vector<FirewallManagerRuleGroup>& GetPreProcessFirewallManagerRuleGroups() const {
    return m_preProcessFirewallManagerRuleGroups;
  }
  ...
  void SetPreProcessFirewallManagerRuleGroups(PreProcessFirewallManagerRuleGroupsT&& value) {
    ...
    m_preProcessFirewallManagerRuleGroups = std::forward<PreProcessFirewallManagerRuleGroupsT>(value);
  }
  template <typename PreProcessFirewallManagerRuleGroupsT = Aws::Vector<FirewallManagerRuleGroup>>
  WebACL& WithPreProcessFirewallManagerRuleGroups(PreProcessFirewallManagerRuleGroupsT&& value) {
    SetPreProcessFirewallManagerRuleGroups(std::forward<PreProcessFirewallManagerRuleGroupsT>(value));
    return *this;
  }
  ...
  WebACL& AddPreProcessFirewallManagerRuleGroups(PreProcessFirewallManagerRuleGroupsT&& value) {
    m_preProcessFirewallManagerRuleGroupsHasBeenSet = true;
    m_preProcessFirewallManagerRuleGroups.emplace_back(std::forward<PreProcessFirewallManagerRuleGroupsT>(value));
    return *this;
  }
  ///@}
   ...
   * processing order.</p>
   */
  inline const Aws::Vector<FirewallManagerRuleGroup>& GetPostProcessFirewallManagerRuleGroups() const {
    return m_postProcessFirewallManagerRuleGroups;
  }
  ...
  void SetPostProcessFirewallManagerRuleGroups(PostProcessFirewallManagerRuleGroupsT&& value) {
    ...
    m_postProcessFirewallManagerRuleGroups = std::forward<PostProcessFirewallManagerRuleGroupsT>(value);
  }
  template <typename PostProcessFirewallManagerRuleGroupsT = Aws::Vector<FirewallManagerRuleGroup>>
  WebACL& WithPostProcessFirewallManagerRuleGroups(PostProcessFirewallManagerRuleGroupsT&& value) {
    SetPostProcessFirewallManagerRuleGroups(std::forward<PostProcessFirewallManagerRuleGroupsT>(value));
    return *this;
  }
  ...
  WebACL& AddPostProcessFirewallManagerRuleGroups(PostProcessFirewallManagerRuleGroupsT&& value) {
    m_postProcessFirewallManagerRuleGroupsHasBeenSet = true;
    m_postProcessFirewallManagerRuleGroups.emplace_back(std::forward<PostProcessFirewallManagerRuleGroupsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetManagedByFirewallManager(bool value) {
    m_managedByFirewallManagerHasBeenSet = true;
    m_managedByFirewallManager = value;
  }
  inline WebACL& WithManagedByFirewallManager(bool value) {
    SetManagedByFirewallManager(value);
    return *this;
  }
  ///@}
  ...
  void SetLabelNamespace(LabelNamespaceT&& value) {
    ...
    m_labelNamespace = std::forward<LabelNamespaceT>(value);
  }
  template <typename LabelNamespaceT = Aws::String>
  WebACL& WithLabelNamespace(LabelNamespaceT&& value) {
    SetLabelNamespace(std::forward<LabelNamespaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCaptchaConfig(CaptchaConfigT&& value) {
    ...
    m_captchaConfig = std::forward<CaptchaConfigT>(value);
  }
  template <typename CaptchaConfigT = CaptchaConfig>
  WebACL& WithCaptchaConfig(CaptchaConfigT&& value) {
    SetCaptchaConfig(std::forward<CaptchaConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetChallengeConfig(ChallengeConfigT&& value) {
    ...
    m_challengeConfig = std::forward<ChallengeConfigT>(value);
  }
  template <typename ChallengeConfigT = ChallengeConfig>
  WebACL& WithChallengeConfig(ChallengeConfigT&& value) {
    SetChallengeConfig(std::forward<ChallengeConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTokenDomains(TokenDomainsT&& value) {
    ...
    m_tokenDomains = std::forward<TokenDomainsT>(value);
  }
  template <typename TokenDomainsT = Aws::Vector<Aws::String>>
  WebACL& WithTokenDomains(TokenDomainsT&& value) {
    SetTokenDomains(std::forward<TokenDomainsT>(value));
    return *this;
  }
  template <typename TokenDomainsT = Aws::String>
  WebACL& AddTokenDomains(TokenDomainsT&& value) {
    m_tokenDomainsHasBeenSet = true;
    m_tokenDomains.emplace_back(std::forward<TokenDomainsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssociationConfig(AssociationConfigT&& value) {
    ...
    m_associationConfig = std::forward<AssociationConfigT>(value);
  }
  template <typename AssociationConfigT = AssociationConfig>
  WebACL& WithAssociationConfig(AssociationConfigT&& value) {
    SetAssociationConfig(std::forward<AssociationConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRetrofittedByFirewallManager(bool value) {
    m_retrofittedByFirewallManagerHasBeenSet = true;
    m_retrofittedByFirewallManager = value;
  }
  inline WebACL& WithRetrofittedByFirewallManager(bool value) {
    SetRetrofittedByFirewallManager(value);
    return *this;
  }
  ///@}
  ...
  void SetOnSourceDDoSProtectionConfig(OnSourceDDoSProtectionConfigT&& value) {
    ...
    m_onSourceDDoSProtectionConfig = std::forward<OnSourceDDoSProtectionConfigT>(value);
  }
  template <typename OnSourceDDoSProtectionConfigT = OnSourceDDoSProtectionConfig>
  WebACL& WithOnSourceDDoSProtectionConfig(OnSourceDDoSProtectionConfigT&& value) {
    SetOnSourceDDoSProtectionConfig(std::forward<OnSourceDDoSProtectionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetApplicationConfig(ApplicationConfigT&& value) {
    ...
    m_applicationConfig = std::forward<ApplicationConfigT>(value);
  }
  template <typename ApplicationConfigT = ApplicationConfig>
