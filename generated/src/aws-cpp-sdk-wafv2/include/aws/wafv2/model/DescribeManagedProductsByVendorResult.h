...
class DescribeManagedProductsByVendorResult {
 public:
  ...
  template <typename ManagedProductsT = Aws::Vector<ManagedProductDescriptor>>
  DescribeManagedProductsByVendorResult& WithManagedProducts(ManagedProductsT&& value) {
    SetManagedProducts(std::forward<ManagedProductsT>(value));
    return *this;
  }
  template <typename ManagedProductsT = ManagedProductDescriptor>
  DescribeManagedProductsByVendorResult& AddManagedProducts(ManagedProductsT&& value) {
    m_managedProductsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeManagedProductsByVendorResult& WithRequestId(RequestIdT&& value) {
