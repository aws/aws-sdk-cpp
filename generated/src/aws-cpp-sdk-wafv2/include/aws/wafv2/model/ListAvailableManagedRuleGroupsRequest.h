...
class ListAvailableManagedRuleGroupsRequest : public WAFV2Request {
 public:
  ...
  inline ListAvailableManagedRuleGroupsRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextMarkerT = Aws::String>
  ListAvailableManagedRuleGroupsRequest& WithNextMarker(NextMarkerT&& value) {
  ...
  inline ListAvailableManagedRuleGroupsRequest& WithLimit(int value) {
    SetLimit(value);
    return *this;
  }
  ///@}
