...
namespace Model
{
  ...
  {
  public:
    AWS_WAFV2_API ListAvailableManagedRuleGroupsRequest() = default;
    ...
    inline ListAvailableManagedRuleGroupsRequest& WithScope(Scope value) { SetScope(value); return *this;}
    ///@}
    ...
    template<typename NextMarkerT = Aws::String>
    ListAvailableManagedRuleGroupsRequest& WithNextMarker(NextMarkerT&& value) { SetNextMarker(std::forward<NextMarkerT>(value)); return *this;}
    ///@}
