...
class HeaderMatchPattern {
 public:
  ...
  void SetIncludedHeaders(IncludedHeadersT&& value) {
    ...
    m_includedHeaders = std::forward<IncludedHeadersT>(value);
  }
  template <typename IncludedHeadersT = Aws::Vector<Aws::String>>
  HeaderMatchPattern& WithIncludedHeaders(IncludedHeadersT&& value) {
    SetIncludedHeaders(std::forward<IncludedHeadersT>(value));
    return *this;
  }
  template <typename IncludedHeadersT = Aws::String>
  HeaderMatchPattern& AddIncludedHeaders(IncludedHeadersT&& value) {
    m_includedHeadersHasBeenSet = true;
    m_includedHeaders.emplace_back(std::forward<IncludedHeadersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludedHeaders(ExcludedHeadersT&& value) {
    ...
    m_excludedHeaders = std::forward<ExcludedHeadersT>(value);
  }
  template <typename ExcludedHeadersT = Aws::Vector<Aws::String>>
  HeaderMatchPattern& WithExcludedHeaders(ExcludedHeadersT&& value) {
    SetExcludedHeaders(std::forward<ExcludedHeadersT>(value));
    return *this;
  }
  template <typename ExcludedHeadersT = Aws::String>
  HeaderMatchPattern& AddExcludedHeaders(ExcludedHeadersT&& value) {
    m_excludedHeadersHasBeenSet = true;
    m_excludedHeaders.emplace_back(std::forward<ExcludedHeadersT>(value));
    return *this;
  }
  ///@}
 private:
