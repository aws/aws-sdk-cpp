...
class FieldToProtect {
 public:
  ...
  inline void SetFieldType(FieldToProtectType value) {
    m_fieldTypeHasBeenSet = true;
    m_fieldType = value;
  }
  inline FieldToProtect& WithFieldType(FieldToProtectType value) {
    SetFieldType(value);
    return *this;
  }
  ///@}
  ...
  void SetFieldKeys(FieldKeysT&& value) {
    ...
    m_fieldKeys = std::forward<FieldKeysT>(value);
  }
  template <typename FieldKeysT = Aws::Vector<Aws::String>>
  FieldToProtect& WithFieldKeys(FieldKeysT&& value) {
    SetFieldKeys(std::forward<FieldKeysT>(value));
    return *this;
  }
  template <typename FieldKeysT = Aws::String>
  FieldToProtect& AddFieldKeys(FieldKeysT&& value) {
    m_fieldKeysHasBeenSet = true;
    m_fieldKeys.emplace_back(std::forward<FieldKeysT>(value));
    return *this;
  }
  ///@}
 private:
