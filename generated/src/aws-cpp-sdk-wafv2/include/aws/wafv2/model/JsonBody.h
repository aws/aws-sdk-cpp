...
class JsonBody {
 public:
  ...
  inline void SetMatchScope(JsonMatchScope value) {
    m_matchScopeHasBeenSet = true;
    m_matchScope = value;
  }
  inline JsonBody& WithMatchScope(JsonMatchScope value) {
    SetMatchScope(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInvalidFallbackBehavior(BodyParsingFallbackBehavior value) {
    m_invalidFallbackBehaviorHasBeenSet = true;
    m_invalidFallbackBehavior = value;
  }
  inline JsonBody& WithInvalidFallbackBehavior(BodyParsingFallbackBehavior value) {
    SetInvalidFallbackBehavior(value);
    return *this;
  }
  ///@}
  ...
  inline JsonBody& WithOversizeHandling(OversizeHandling value) {
