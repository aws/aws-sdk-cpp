...
namespace Model
{
  ...
  public:
     ...
     * priority setting, and then uses the component contents. </p>
     */
    inline RateLimitCookie& WithTextTransformations(const Aws::Vector<TextTransformation>& value) { SetTextTransformations(value); return *this;}
     ...
     * priority setting, and then uses the component contents. </p>
     */
    inline RateLimitCookie& WithTextTransformations(Aws::Vector<TextTransformation>&& value) { SetTextTransformations(std::move(value)); return *this;}
     ...
     * priority setting, and then uses the component contents. </p>
     */
    inline RateLimitCookie& AddTextTransformations(TextTransformation&& value) { m_textTransformationsHasBeenSet = true; m_textTransformations.push_back(std::move(value)); return *this; }
