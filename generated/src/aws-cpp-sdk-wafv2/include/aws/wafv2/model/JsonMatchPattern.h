...
class JsonMatchPattern {
 public:
  ...
  void SetIncludedPaths(IncludedPathsT&& value) {
    ...
    m_includedPaths = std::forward<IncludedPathsT>(value);
  }
  template <typename IncludedPathsT = Aws::Vector<Aws::String>>
  JsonMatchPattern& WithIncludedPaths(IncludedPathsT&& value) {
    SetIncludedPaths(std::forward<IncludedPathsT>(value));
    return *this;
  }
  template <typename IncludedPathsT = Aws::String>
  JsonMatchPattern& AddIncludedPaths(IncludedPathsT&& value) {
    m_includedPathsHasBeenSet = true;
    m_includedPaths.emplace_back(std::forward<IncludedPathsT>(value));
    return *this;
  }
  ///@}
 private:
