...
class GetSampledRequestsRequest : public WAFV2Request {
 public:
  ...
  void SetRuleMetricName(RuleMetricNameT&& value) {
    m_ruleMetricNameHasBeenSet = true;
    m_ruleMetricName = std::forward<RuleMetricNameT>(value);
  }
  template <typename RuleMetricNameT = Aws::String>
  GetSampledRequestsRequest& WithRuleMetricName(RuleMetricNameT&& value) {
    SetRuleMetricName(std::forward<RuleMetricNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetSampledRequestsRequest& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxItems(long long value) {
    m_maxItemsHasBeenSet = true;
    m_maxItems = value;
  }
  inline GetSampledRequestsRequest& WithMaxItems(long long value) {
    SetMaxItems(value);
    return *this;
  }
  ///@}
