...
class AWS_WAFV2_API WAFV2Client : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  WAFV2Client(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<WAFV2EndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * An Async wrapper for CheckCapacity that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CheckCapacityRequestT = Model::CheckCapacityRequest>
  void CheckCapacityAsync(const CheckCapacityRequestT& request, const CheckCapacityResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteFirewallManagerRuleGroupsOutcome DeleteFirewallManagerRuleGroups(
      const Model::DeleteFirewallManagerRuleGroupsRequest& request) const;

  /**
   * A Callable wrapper for DeleteFirewallManagerRuleGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteFirewallManagerRuleGroupsRequestT = Model::DeleteFirewallManagerRuleGroupsRequest>
  Model::DeleteFirewallManagerRuleGroupsOutcomeCallable DeleteFirewallManagerRuleGroupsCallable(
      const DeleteFirewallManagerRuleGroupsRequestT& request) const {
    return SubmitCallable(&WAFV2Client::DeleteFirewallManagerRuleGroups, request);
  }

  /**
   * An Async wrapper for DeleteFirewallManagerRuleGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteFirewallManagerRuleGroupsRequestT = Model::DeleteFirewallManagerRuleGroupsRequest>
  void DeleteFirewallManagerRuleGroupsAsync(const DeleteFirewallManagerRuleGroupsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAllManagedProductsOutcome DescribeAllManagedProducts(
      const Model::DescribeAllManagedProductsRequest& request) const;

  /**
   * A Callable wrapper for DescribeAllManagedProducts that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAllManagedProductsRequestT = Model::DescribeAllManagedProductsRequest>
  Model::DescribeAllManagedProductsOutcomeCallable DescribeAllManagedProductsCallable(
      const DescribeAllManagedProductsRequestT& request) const {
    return SubmitCallable(&WAFV2Client::DescribeAllManagedProducts, request);
  }

  /**
   * An Async wrapper for DescribeAllManagedProducts that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAllManagedProductsRequestT = Model::DescribeAllManagedProductsRequest>
  void DescribeAllManagedProductsAsync(const DescribeAllManagedProductsRequestT& request,
                                       const DescribeAllManagedProductsResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeManagedProductsByVendorOutcome DescribeManagedProductsByVendor(
      const Model::DescribeManagedProductsByVendorRequest& request) const;

  /**
   * A Callable wrapper for DescribeManagedProductsByVendor that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeManagedProductsByVendorRequestT = Model::DescribeManagedProductsByVendorRequest>
  Model::DescribeManagedProductsByVendorOutcomeCallable DescribeManagedProductsByVendorCallable(
      const DescribeManagedProductsByVendorRequestT& request) const {
    return SubmitCallable(&WAFV2Client::DescribeManagedProductsByVendor, request);
  }

  /**
   * An Async wrapper for DescribeManagedProductsByVendor that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeManagedProductsByVendorRequestT = Model::DescribeManagedProductsByVendorRequest>
  void DescribeManagedProductsByVendorAsync(const DescribeManagedProductsByVendorRequestT& request,
                                            const DescribeManagedProductsByVendorResponseReceivedHandler& handler,
                                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeManagedRuleGroup that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeManagedRuleGroup that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeManagedRuleGroupRequestT = Model::DescribeManagedRuleGroupRequest>
  void DescribeManagedRuleGroupAsync(const DescribeManagedRuleGroupRequestT& request,
  ...
  virtual Model::GenerateMobileSdkReleaseUrlOutcome GenerateMobileSdkReleaseUrl(
      const Model::GenerateMobileSdkReleaseUrlRequest& request) const;

  /**
   * A Callable wrapper for GenerateMobileSdkReleaseUrl that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GenerateMobileSdkReleaseUrlRequestT = Model::GenerateMobileSdkReleaseUrlRequest>
  Model::GenerateMobileSdkReleaseUrlOutcomeCallable GenerateMobileSdkReleaseUrlCallable(
      const GenerateMobileSdkReleaseUrlRequestT& request) const {
    return SubmitCallable(&WAFV2Client::GenerateMobileSdkReleaseUrl, request);
  }

  /**
   * An Async wrapper for GenerateMobileSdkReleaseUrl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GenerateMobileSdkReleaseUrlRequestT = Model::GenerateMobileSdkReleaseUrlRequest>
  void GenerateMobileSdkReleaseUrlAsync(const GenerateMobileSdkReleaseUrlRequestT& request,
                                        const GenerateMobileSdkReleaseUrlResponseReceivedHandler& handler,
                                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetDecryptedAPIKey that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetDecryptedAPIKey that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetDecryptedAPIKeyRequestT = Model::GetDecryptedAPIKeyRequest>
  void GetDecryptedAPIKeyAsync(const GetDecryptedAPIKeyRequestT& request, const GetDecryptedAPIKeyResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetManagedRuleSet that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetManagedRuleSet that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetManagedRuleSetRequestT = Model::GetManagedRuleSetRequest>
  void GetManagedRuleSetAsync(const GetManagedRuleSetRequestT& request, const GetManagedRuleSetResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetMobileSdkRelease that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetMobileSdkRelease that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetMobileSdkReleaseRequestT = Model::GetMobileSdkReleaseRequest>
  void GetMobileSdkReleaseAsync(const GetMobileSdkReleaseRequestT& request, const GetMobileSdkReleaseResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetRateBasedStatementManagedKeysOutcome GetRateBasedStatementManagedKeys(
      const Model::GetRateBasedStatementManagedKeysRequest& request) const;

  /**
   * A Callable wrapper for GetRateBasedStatementManagedKeys that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetRateBasedStatementManagedKeysRequestT = Model::GetRateBasedStatementManagedKeysRequest>
  Model::GetRateBasedStatementManagedKeysOutcomeCallable GetRateBasedStatementManagedKeysCallable(
      const GetRateBasedStatementManagedKeysRequestT& request) const {
    return SubmitCallable(&WAFV2Client::GetRateBasedStatementManagedKeys, request);
  }

  /**
   * An Async wrapper for GetRateBasedStatementManagedKeys that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetRateBasedStatementManagedKeysRequestT = Model::GetRateBasedStatementManagedKeysRequest>
  void GetRateBasedStatementManagedKeysAsync(const GetRateBasedStatementManagedKeysRequestT& request,
   ...
   */
  template <typename GetRuleGroupRequestT = Model::GetRuleGroupRequest>
  void GetRuleGroupAsync(const GetRuleGroupResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                         const GetRuleGroupRequestT& request = {}) const {
   ...
   */
  template <typename GetWebACLRequestT = Model::GetWebACLRequest>
  void GetWebACLAsync(const GetWebACLResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const GetWebACLRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableManagedRuleGroupVersionsOutcome ListAvailableManagedRuleGroupVersions(
      const Model::ListAvailableManagedRuleGroupVersionsRequest& request) const;

  /**
   * A Callable wrapper for ListAvailableManagedRuleGroupVersions that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListAvailableManagedRuleGroupVersionsRequestT = Model::ListAvailableManagedRuleGroupVersionsRequest>
  Model::ListAvailableManagedRuleGroupVersionsOutcomeCallable ListAvailableManagedRuleGroupVersionsCallable(
      const ListAvailableManagedRuleGroupVersionsRequestT& request) const {
    return SubmitCallable(&WAFV2Client::ListAvailableManagedRuleGroupVersions, request);
  }

  /**
   * An Async wrapper for ListAvailableManagedRuleGroupVersions that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListAvailableManagedRuleGroupVersionsRequestT = Model::ListAvailableManagedRuleGroupVersionsRequest>
  void ListAvailableManagedRuleGroupVersionsAsync(const ListAvailableManagedRuleGroupVersionsRequestT& request,
                                                  const ListAvailableManagedRuleGroupVersionsResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListAvailableManagedRuleGroupsOutcome ListAvailableManagedRuleGroups(
      const Model::ListAvailableManagedRuleGroupsRequest& request) const;

  /**
   * A Callable wrapper for ListAvailableManagedRuleGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListAvailableManagedRuleGroupsRequestT = Model::ListAvailableManagedRuleGroupsRequest>
  Model::ListAvailableManagedRuleGroupsOutcomeCallable ListAvailableManagedRuleGroupsCallable(
      const ListAvailableManagedRuleGroupsRequestT& request) const {
    return SubmitCallable(&WAFV2Client::ListAvailableManagedRuleGroups, request);
  }

  /**
   * An Async wrapper for ListAvailableManagedRuleGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListAvailableManagedRuleGroupsRequestT = Model::ListAvailableManagedRuleGroupsRequest>
  void ListAvailableManagedRuleGroupsAsync(const ListAvailableManagedRuleGroupsRequestT& request,
   ...
   */
  template <typename ListLoggingConfigurationsRequestT = Model::ListLoggingConfigurationsRequest>
  void ListLoggingConfigurationsAsync(const ListLoggingConfigurationsRequestT& request,
  ...
  /**
   * A Callable wrapper for ListManagedRuleSets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListManagedRuleSets that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListManagedRuleSetsRequestT = Model::ListManagedRuleSetsRequest>
  void ListManagedRuleSetsAsync(const ListManagedRuleSetsRequestT& request, const ListManagedRuleSetsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListMobileSdkReleases that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListMobileSdkReleases that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListMobileSdkReleasesRequestT = Model::ListMobileSdkReleasesRequest>
  void ListMobileSdkReleasesAsync(const ListMobileSdkReleasesRequestT& request, const ListMobileSdkReleasesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListRegexPatternSetsRequestT = Model::ListRegexPatternSetsRequest>
  void ListRegexPatternSetsAsync(const ListRegexPatternSetsRequestT& request, const ListRegexPatternSetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename ListWebACLsRequestT = Model::ListWebACLsRequest>
  void ListWebACLsAsync(const ListWebACLsRequestT& request, const ListWebACLsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutManagedRuleSetVersions that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutManagedRuleSetVersionsRequestT = Model::PutManagedRuleSetVersionsRequest>
  Model::PutManagedRuleSetVersionsOutcomeCallable PutManagedRuleSetVersionsCallable(
      const PutManagedRuleSetVersionsRequestT& request) const {
    return SubmitCallable(&WAFV2Client::PutManagedRuleSetVersions, request);
  }

  /**
   * An Async wrapper for PutManagedRuleSetVersions that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutManagedRuleSetVersionsRequestT = Model::PutManagedRuleSetVersionsRequest>
  void PutManagedRuleSetVersionsAsync(const PutManagedRuleSetVersionsRequestT& request,
                                      const PutManagedRuleSetVersionsResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateManagedRuleSetVersionExpiryDateOutcome UpdateManagedRuleSetVersionExpiryDate(
      const Model::UpdateManagedRuleSetVersionExpiryDateRequest& request) const;

  /**
   * A Callable wrapper for UpdateManagedRuleSetVersionExpiryDate that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename UpdateManagedRuleSetVersionExpiryDateRequestT = Model::UpdateManagedRuleSetVersionExpiryDateRequest>
  Model::UpdateManagedRuleSetVersionExpiryDateOutcomeCallable UpdateManagedRuleSetVersionExpiryDateCallable(
      const UpdateManagedRuleSetVersionExpiryDateRequestT& request) const {
    return SubmitCallable(&WAFV2Client::UpdateManagedRuleSetVersionExpiryDate, request);
  }

  /**
   * An Async wrapper for UpdateManagedRuleSetVersionExpiryDate that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename UpdateManagedRuleSetVersionExpiryDateRequestT = Model::UpdateManagedRuleSetVersionExpiryDateRequest>
  void UpdateManagedRuleSetVersionExpiryDateAsync(const UpdateManagedRuleSetVersionExpiryDateRequestT& request,
                                                  const UpdateManagedRuleSetVersionExpiryDateResponseReceivedHandler& handler,
                                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual std::shared_ptr<WAFV2EndpointProviderBase>& accessEndpointProvider();
