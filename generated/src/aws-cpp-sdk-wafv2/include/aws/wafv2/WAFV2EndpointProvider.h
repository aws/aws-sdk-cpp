 ...
 */
using WAFV2EndpointProviderBase = EndpointProviderBase<WAFV2ClientConfiguration, WAFV2BuiltInParameters, WAFV2ClientContextParameters>;

using WAFV2DefaultEpProviderBase = DefaultEndpointProvider<WAFV2ClientConfiguration, WAFV2BuiltInParameters, WAFV2ClientContextParameters>;
