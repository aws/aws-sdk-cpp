...
WebACL& WebACL::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("PreProcessFirewallManagerRuleGroups")) {
    ...
    for (unsigned preProcessFirewallManagerRuleGroupsIndex = 0;
         preProcessFirewallManagerRuleGroupsIndex < preProcessFirewallManagerRuleGroupsJsonList.GetLength();
         ++preProcessFirewallManagerRuleGroupsIndex) {
      m_preProcessFirewallManagerRuleGroups.push_back(
          preProcessFirewallManagerRuleGroupsJsonList[preProcessFirewallManagerRuleGroupsIndex].AsObject());
    }
  ...
  if (jsonValue.ValueExists("PostProcessFirewallManagerRuleGroups")) {
    ...
    for (unsigned postProcessFirewallManagerRuleGroupsIndex = 0;
         postProcessFirewallManagerRuleGroupsIndex < postProcessFirewallManagerRuleGroupsJsonList.GetLength();
         ++postProcessFirewallManagerRuleGroupsIndex) {
      m_postProcessFirewallManagerRuleGroups.push_back(
          postProcessFirewallManagerRuleGroupsJsonList[postProcessFirewallManagerRuleGroupsIndex].AsObject());
    }
...
JsonValue WebACL::Jsonize() const {
  ...
  if (m_preProcessFirewallManagerRuleGroupsHasBeenSet) {
    ...
    for (unsigned preProcessFirewallManagerRuleGroupsIndex = 0;
         ...
         ++preProcessFirewallManagerRuleGroupsIndex) {
      preProcessFirewallManagerRuleGroupsJsonList[preProcessFirewallManagerRuleGroupsIndex].AsObject(
          m_preProcessFirewallManagerRuleGroups[preProcessFirewallManagerRuleGroupsIndex].Jsonize());
    }
  ...
  if (m_postProcessFirewallManagerRuleGroupsHasBeenSet) {
    ...
    for (unsigned postProcessFirewallManagerRuleGroupsIndex = 0;
         ...
         ++postProcessFirewallManagerRuleGroupsIndex) {
      postProcessFirewallManagerRuleGroupsJsonList[postProcessFirewallManagerRuleGroupsIndex].AsObject(
          m_postProcessFirewallManagerRuleGroups[postProcessFirewallManagerRuleGroupsIndex].Jsonize());
    }
