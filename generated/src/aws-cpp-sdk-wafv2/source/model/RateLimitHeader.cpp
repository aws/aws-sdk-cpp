...
RateLimitHeader::RateLimitHeader(JsonView jsonValue) { *this = jsonValue; }

RateLimitHeader& RateLimitHeader::operator=(JsonView jsonValue) {
...
JsonValue RateLimitHeader::Jsonize() const {
  JsonValue payload;
