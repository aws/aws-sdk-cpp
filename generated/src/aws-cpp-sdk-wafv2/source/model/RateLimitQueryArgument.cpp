...
RateLimitQueryArgument::RateLimitQueryArgument(JsonView jsonValue) { *this = jsonValue; }

RateLimitQueryArgument& RateLimitQueryArgument::operator=(JsonView jsonValue) {
...
JsonValue RateLimitQueryArgument::Jsonize() const {
  JsonValue payload;
