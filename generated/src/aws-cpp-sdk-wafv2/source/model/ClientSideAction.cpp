...
ClientSideAction::ClientSideAction(JsonView jsonValue) { *this = jsonValue; }
...
ClientSideAction& ClientSideAction::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ExemptUriRegularExpressions")) {
    ...
    for (unsigned exemptUriRegularExpressionsIndex = 0; exemptUriRegularExpressionsIndex < exemptUriRegularExpressionsJsonList.GetLength();
         ++exemptUriRegularExpressionsIndex) {
...
JsonValue ClientSideAction::Jsonize() const {
  ...
  if (m_exemptUriRegularExpressionsHasBeenSet) {
    ...
    for (unsigned exemptUriRegularExpressionsIndex = 0; exemptUriRegularExpressionsIndex < exemptUriRegularExpressionsJsonList.GetLength();
         ++exemptUriRegularExpressionsIndex) {
      exemptUriRegularExpressionsJsonList[exemptUriRegularExpressionsIndex].AsObject(
          m_exemptUriRegularExpressions[exemptUriRegularExpressionsIndex].Jsonize());
    }
