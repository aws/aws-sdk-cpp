...
RateBasedStatement::RateBasedStatement(JsonView jsonValue) { *this = jsonValue; }
...
RateBasedStatement& RateBasedStatement::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("AggregateKeyType")) {
    m_aggregateKeyType =
        RateBasedStatementAggregateKeyTypeMapper::GetRateBasedStatementAggregateKeyTypeForName(jsonValue.GetString("AggregateKeyType"));
...
JsonValue RateBasedStatement::Jsonize() const {
  ...
  if (m_aggregateKeyTypeHasBeenSet) {
    payload.WithString("AggregateKeyType",
                       RateBasedStatementAggregateKeyTypeMapper::GetNameForRateBasedStatementAggregateKeyType(m_aggregateKeyType));
  }
