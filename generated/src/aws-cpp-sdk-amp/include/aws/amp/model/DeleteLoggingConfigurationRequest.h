...
/**
 * <p>Represents the input of a <code>DeleteLoggingConfiguration</code>
 * operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/amp-2020-08-01/DeleteLoggingConfigurationRequest">AWS
 * API Reference</a></p>
 */
class DeleteLoggingConfigurationRequest : public PrometheusServiceRequest {
 public:
  AWS_PROMETHEUSSERVICE_API DeleteLoggingConfigurationRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteLoggingConfigurationRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteLoggingConfigurationRequest& WithClientToken(ClientTokenT&& value) {
