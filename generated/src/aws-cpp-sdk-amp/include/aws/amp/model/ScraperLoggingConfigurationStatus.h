...
class ScraperLoggingConfigurationStatus {
 public:
  ...
  inline void SetStatusCode(ScraperLoggingConfigurationStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline ScraperLoggingConfigurationStatus& WithStatusCode(ScraperLoggingConfigurationStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  ScraperLoggingConfigurationStatus& WithStatusReason(StatusReasonT&& value) {
