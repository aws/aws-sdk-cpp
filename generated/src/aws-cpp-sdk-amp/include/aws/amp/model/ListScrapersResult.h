...
class ListScrapersResult {
 public:
  ...
  void SetScrapers(ScrapersT&& value) {
    m_scrapersHasBeenSet = true;
    m_scrapers = std::forward<ScrapersT>(value);
  }
  template <typename ScrapersT = Aws::Vector<ScraperSummary>>
  ListScrapersResult& WithScrapers(ScrapersT&& value) {
    SetScrapers(std::forward<ScrapersT>(value));
    return *this;
  }
  template <typename ScrapersT = ScraperSummary>
  ListScrapersResult& AddScrapers(ScrapersT&& value) {
    m_scrapersHasBeenSet = true;
    m_scrapers.emplace_back(std::forward<ScrapersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListScrapersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListScrapersResult& WithRequestId(RequestIdT&& value) {
