...
class PutRuleGroupsNamespaceResult {
 public:
  ...
  template <typename NameT = Aws::String>
  PutRuleGroupsNamespaceResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  PutRuleGroupsNamespaceResult& WithArn(ArnT&& value) {
  ...
  template <typename StatusT = RuleGroupsNamespaceStatus>
  PutRuleGroupsNamespaceResult& WithStatus(StatusT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  PutRuleGroupsNamespaceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  PutRuleGroupsNamespaceResult& WithRequestId(RequestIdT&& value) {
