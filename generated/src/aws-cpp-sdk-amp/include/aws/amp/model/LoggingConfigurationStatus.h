...
class LoggingConfigurationStatus {
 public:
  ...
  inline void SetStatusCode(LoggingConfigurationStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline LoggingConfigurationStatus& WithStatusCode(LoggingConfigurationStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  LoggingConfigurationStatus& WithStatusReason(StatusReasonT&& value) {
