...
class PutAlertManagerDefinitionRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  PutAlertManagerDefinitionRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  PutAlertManagerDefinitionRequest& WithData(DataT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  PutAlertManagerDefinitionRequest& WithClientToken(ClientTokenT&& value) {
