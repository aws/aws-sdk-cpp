...
class UpdateLoggingConfigurationRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  UpdateLoggingConfigurationRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename LogGroupArnT = Aws::String>
  UpdateLoggingConfigurationRequest& WithLogGroupArn(LogGroupArnT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateLoggingConfigurationRequest& WithClientToken(ClientTokenT&& value) {
