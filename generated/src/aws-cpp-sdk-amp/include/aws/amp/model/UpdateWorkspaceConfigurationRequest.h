...
class UpdateWorkspaceConfigurationRequest : public PrometheusServiceRequest {
 public:
  ...
  void SetLimitsPerLabelSet(LimitsPerLabelSetT&& value) {
    ...
    m_limitsPerLabelSet = std::forward<LimitsPerLabelSetT>(value);
  }
  template <typename LimitsPerLabelSetT = Aws::Vector<LimitsPerLabelSet>>
  UpdateWorkspaceConfigurationRequest& WithLimitsPerLabelSet(LimitsPerLabelSetT&& value) {
    SetLimitsPerLabelSet(std::forward<LimitsPerLabelSetT>(value));
    return *this;
  }
  ...
  UpdateWorkspaceConfigurationRequest& AddLimitsPerLabelSet(LimitsPerLabelSetT&& value) {
    m_limitsPerLabelSetHasBeenSet = true;
    m_limitsPerLabelSet.emplace_back(std::forward<LimitsPerLabelSetT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateWorkspaceConfigurationRequest& WithRetentionPeriodInDays(int value) {
