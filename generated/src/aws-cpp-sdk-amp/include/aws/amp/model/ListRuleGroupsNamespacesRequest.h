...
class ListRuleGroupsNamespacesRequest : public PrometheusServiceRequest {
 public:
  AWS_PROMETHEUSSERVICE_API ListRuleGroupsNamespacesRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  ListRuleGroupsNamespacesRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListRuleGroupsNamespacesRequest& WithName(NameT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListRuleGroupsNamespacesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListRuleGroupsNamespacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
