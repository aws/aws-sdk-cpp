...
class UpdateScraperLoggingConfigurationResult {
 public:
  ...
  AWS_PROMETHEUSSERVICE_API UpdateScraperLoggingConfigurationResult& operator=(
  ...
  template <typename StatusT = ScraperLoggingConfigurationStatus>
  UpdateScraperLoggingConfigurationResult& WithStatus(StatusT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateScraperLoggingConfigurationResult& WithRequestId(RequestIdT&& value) {
