...
class ListRuleGroupsNamespacesResult {
 public:
  ...
  AWS_PROMETHEUSSERVICE_API ListRuleGroupsNamespacesResult& operator=(
  ...
  void SetRuleGroupsNamespaces(RuleGroupsNamespacesT&& value) {
    m_ruleGroupsNamespacesHasBeenSet = true;
    m_ruleGroupsNamespaces = std::forward<RuleGroupsNamespacesT>(value);
  }
  template <typename RuleGroupsNamespacesT = Aws::Vector<RuleGroupsNamespaceSummary>>
  ListRuleGroupsNamespacesResult& WithRuleGroupsNamespaces(RuleGroupsNamespacesT&& value) {
    SetRuleGroupsNamespaces(std::forward<RuleGroupsNamespacesT>(value));
    return *this;
  }
  template <typename RuleGroupsNamespacesT = RuleGroupsNamespaceSummary>
  ListRuleGroupsNamespacesResult& AddRuleGroupsNamespaces(RuleGroupsNamespacesT&& value) {
    m_ruleGroupsNamespacesHasBeenSet = true;
    m_ruleGroupsNamespaces.emplace_back(std::forward<RuleGroupsNamespacesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListRuleGroupsNamespacesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListRuleGroupsNamespacesResult& WithRequestId(RequestIdT&& value) {
