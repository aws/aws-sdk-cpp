...
class CreateRuleGroupsNamespaceRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  CreateRuleGroupsNamespaceRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  CreateRuleGroupsNamespaceRequest& WithName(NameT&& value) {
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  CreateRuleGroupsNamespaceRequest& WithData(DataT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRuleGroupsNamespaceRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRuleGroupsNamespaceRequest& WithTags(TagsT&& value) {
