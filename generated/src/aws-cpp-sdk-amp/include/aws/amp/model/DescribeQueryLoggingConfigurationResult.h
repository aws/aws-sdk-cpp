...
class DescribeQueryLoggingConfigurationResult {
 public:
  ...
  AWS_PROMETHEUSSERVICE_API DescribeQueryLoggingConfigurationResult& operator=(
  ...
  void SetQueryLoggingConfiguration(QueryLoggingConfigurationT&& value) {
    m_queryLoggingConfigurationHasBeenSet = true;
    m_queryLoggingConfiguration = std::forward<QueryLoggingConfigurationT>(value);
  }
  template <typename QueryLoggingConfigurationT = QueryLoggingConfigurationMetadata>
  DescribeQueryLoggingConfigurationResult& WithQueryLoggingConfiguration(QueryLoggingConfigurationT&& value) {
    SetQueryLoggingConfiguration(std::forward<QueryLoggingConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeQueryLoggingConfigurationResult& WithRequestId(RequestIdT&& value) {
