...
/**
 */
class DeleteResourcePolicyRequest : public PrometheusServiceRequest {
 public:
  AWS_PROMETHEUSSERVICE_API DeleteResourcePolicyRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteResourcePolicyRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteResourcePolicyRequest& WithClientToken(ClientTokenT&& value) {
  ...
  ///@{
  /**
   * <p>The revision ID of the policy to delete. Use this parameter to ensure that
   * you are deleting the correct version of the policy.</p>
   */
