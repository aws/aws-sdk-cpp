...
namespace Model
{
  ...
  /**
   * <p>A representation of an EKS source.</p><p><h3>See Also:</h3>   <a
  ...
  public:
    ...
    /**
     * <p>A list of security group IDs specified for VPC configuration.</p>
     */
    ...
    /**
     * <p>A list of subnet IDs specified for VPC configuration.</p>
     */
