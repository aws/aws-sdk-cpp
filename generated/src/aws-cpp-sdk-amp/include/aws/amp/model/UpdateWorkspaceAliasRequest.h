...
class UpdateWorkspaceAliasRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  UpdateWorkspaceAliasRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename AliasT = Aws::String>
  UpdateWorkspaceAliasRequest& WithAlias(AliasT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  UpdateWorkspaceAliasRequest& WithClientToken(ClientTokenT&& value) {
