...
class PutRuleGroupsNamespaceRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  PutRuleGroupsNamespaceRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  PutRuleGroupsNamespaceRequest& WithName(NameT&& value) {
  ...
  template <typename DataT = Aws::Utils::ByteBuffer>
  PutRuleGroupsNamespaceRequest& WithData(DataT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  PutRuleGroupsNamespaceRequest& WithClientToken(ClientTokenT&& value) {
