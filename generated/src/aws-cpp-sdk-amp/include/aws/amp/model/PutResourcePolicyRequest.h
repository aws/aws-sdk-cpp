...
/**
 */
class PutResourcePolicyRequest : public PrometheusServiceRequest {
 public:
  AWS_PROMETHEUSSERVICE_API PutResourcePolicyRequest() = default;
  ...
  template <typename WorkspaceIdT = Aws::String>
  PutResourcePolicyRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  ///@{
  /**
   * <p>The JSON policy document to use as the resource-based policy. This policy
  ...
  ///@{
  /**
   * <p>The revision ID of the policy to update. Use this parameter to ensure that
   * you are updating the correct version of the policy. If you don't specify a
   * revision ID, the policy is updated regardless of its current revision.</p>
   * <p>For the first <b>PUT</b> request on a workspace that doesn't have an existing
   * resource policy, you can specify <code>NO_POLICY</code> as the revision ID.</p>
   */
