...
class DeleteRuleGroupsNamespaceRequest : public PrometheusServiceRequest {
 public:
  ...
  template <typename WorkspaceIdT = Aws::String>
  DeleteRuleGroupsNamespaceRequest& WithWorkspaceId(WorkspaceIdT&& value) {
  ...
  template <typename NameT = Aws::String>
  DeleteRuleGroupsNamespaceRequest& WithName(NameT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteRuleGroupsNamespaceRequest& WithClientToken(ClientTokenT&& value) {
