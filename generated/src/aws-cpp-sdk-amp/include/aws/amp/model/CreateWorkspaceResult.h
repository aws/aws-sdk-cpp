...
class CreateWorkspaceResult {
 public:
  ...
  template <typename ArnT = Aws::String>
  CreateWorkspaceResult& WithArn(ArnT&& value) {
  ...
  template <typename StatusT = WorkspaceStatus>
  CreateWorkspaceResult& WithStatus(StatusT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateWorkspaceResult& WithTags(TagsT&& value) {
  ...
  template <typename KmsKeyArnT = Aws::String>
  CreateWorkspaceResult& WithKmsKeyArn(KmsKeyArnT&& value) {
