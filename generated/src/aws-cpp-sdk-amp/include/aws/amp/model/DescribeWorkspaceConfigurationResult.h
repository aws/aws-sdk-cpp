...
class DescribeWorkspaceConfigurationResult {
 public:
  ...
  AWS_PROMETHEUSSERVICE_API DescribeWorkspaceConfigurationResult& operator=(
  ...
  template <typename WorkspaceConfigurationT = WorkspaceConfigurationDescription>
  DescribeWorkspaceConfigurationResult& WithWorkspaceConfiguration(WorkspaceConfigurationT&& value) {
