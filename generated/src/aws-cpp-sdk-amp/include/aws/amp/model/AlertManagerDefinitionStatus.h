...
class AlertManagerDefinitionStatus {
 public:
  ...
  inline void SetStatusCode(AlertManagerDefinitionStatusCode value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline AlertManagerDefinitionStatus& WithStatusCode(AlertManagerDefinitionStatusCode value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonT = Aws::String>
  AlertManagerDefinitionStatus& WithStatusReason(StatusReasonT&& value) {
