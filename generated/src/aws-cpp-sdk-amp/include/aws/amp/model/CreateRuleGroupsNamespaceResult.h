...
class CreateRuleGroupsNamespaceResult {
 public:
  ...
  AWS_PROMETHEUSSERVICE_API CreateRuleGroupsNamespaceResult& operator=(
  ...
  template <typename NameT = Aws::String>
  CreateRuleGroupsNamespaceResult& WithName(NameT&& value) {
  ...
  template <typename ArnT = Aws::String>
  CreateRuleGroupsNamespaceResult& WithArn(ArnT&& value) {
  ...
  template <typename StatusT = RuleGroupsNamespaceStatus>
  CreateRuleGroupsNamespaceResult& WithStatus(StatusT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRuleGroupsNamespaceResult& WithTags(TagsT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateRuleGroupsNamespaceResult& WithRequestId(RequestIdT&& value) {
