...
namespace PrometheusService
{
   ...
   */
  class AWS_PROMETHEUSSERVICE_API PrometheusServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<PrometheusServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::PrometheusService::SERVICE_NAME,
