...
{
const size_t PrometheusServiceEndpointRules::RulesBlobStrLen = 3712;
const size_t PrometheusServiceEndpointRules::RulesBlobSize = 3713;
...
't','p','s',':','/','/','a','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
