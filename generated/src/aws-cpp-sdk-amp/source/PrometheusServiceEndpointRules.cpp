...
{
const size_t PrometheusServiceEndpointRules::RulesBlobStrLen = 3460;
const size_t PrometheusServiceEndpointRules::RulesBlobSize = 3461;
...
':','/','/','a','p','s','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r',
...
'p','s',':','/','/','a','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t',
...
const char* PrometheusServiceEndpointRules::GetRulesBlob()
{
