...
DescribeWorkspaceConfigurationResult& DescribeWorkspaceConfigurationResult::operator=(
    const Aws::AmazonWebServiceResult<JsonValue>& result) {
  JsonView jsonValue = result.GetPayload().View();
  if (jsonValue.ValueExists("workspaceConfiguration")) {
    m_workspaceConfiguration = jsonValue.GetObject("workspaceConfiguration");
