...
PutRuleGroupsNamespaceResult::PutRuleGroupsNamespaceResult()
{
}

PutRuleGroupsNamespaceResult::PutRuleGroupsNamespaceResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
