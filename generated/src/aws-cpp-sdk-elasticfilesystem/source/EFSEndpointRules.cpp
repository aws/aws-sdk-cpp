...
namespace EFS
{
const size_t EFSEndpointRules::RulesBlobStrLen = 3516;
const size_t EFSEndpointRules::RulesBlobSize = 3517;
...
't','i','c','f','i','l','e','s','y','s','t','e','m','-','f','i','p','s','.','{','R','e','g','i','o',
...
'a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','-','f','i','p','s','.','{','R','e','g',
