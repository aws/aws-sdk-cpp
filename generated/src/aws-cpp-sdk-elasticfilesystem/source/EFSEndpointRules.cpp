...
namespace EFS
{
const size_t EFSEndpointRules::RulesBlobStrLen = 3768;
const size_t EFSEndpointRules::RulesBlobSize = 3769;
...
'l','"',':','"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','f','i','l','e','s','y',
's','t','e','m','-','f','i','p','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i',
...
'"','h','t','t','p','s',':','/','/','e','l','a','s','t','i','c','f','i','l','e','s','y','s','t','e',
...
'a','s','t','i','c','f','i','l','e','s','y','s','t','e','m','.','{','R','e','g','i','o','n','}','.',
