...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API ThroughputLimitExceeded() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    ThroughputLimitExceeded& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    ThroughputLimitExceeded& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
