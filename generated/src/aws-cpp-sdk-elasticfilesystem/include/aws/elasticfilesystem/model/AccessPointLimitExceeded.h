...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API AccessPointLimitExceeded() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    AccessPointLimitExceeded& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    AccessPointLimitExceeded& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
