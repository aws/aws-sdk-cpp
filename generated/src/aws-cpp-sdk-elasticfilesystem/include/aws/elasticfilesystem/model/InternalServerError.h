...
namespace Model
{
  ...
  /**
   * <p>Returned if an error occurred on the server side.</p><p><h3>See Also:</h3>  
   * <a
  ...
  public:
    ...
    inline InternalServerError& WithErrorCode(const Aws::String& value) { SetErrorCode(value); return *this;}

    
    inline InternalServerError& WithErrorCode(Aws::String&& value) { SetErrorCode(std::move(value)); return *this;}

    
    inline InternalServerError& WithErrorCode(const char* value) { SetErrorCode(value); return *this;}
