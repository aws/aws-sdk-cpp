...
class DescribeMountTargetSecurityGroupsResult {
 public:
  AWS_EFS_API DescribeMountTargetSecurityGroupsResult() = default;
  ...
  template <typename SecurityGroupsT = Aws::Vector<Aws::String>>
  DescribeMountTargetSecurityGroupsResult& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = Aws::String>
  DescribeMountTargetSecurityGroupsResult& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeMountTargetSecurityGroupsResult& WithRequestId(RequestIdT&& value) {
