...
namespace Model
{
  ...
  public:
    ...
    template<typename ErrorCodeT = Aws::String>
    SecurityGroupNotFound& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    SecurityGroupNotFound& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
