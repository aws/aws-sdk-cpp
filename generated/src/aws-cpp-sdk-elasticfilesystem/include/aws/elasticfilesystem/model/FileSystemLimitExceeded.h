...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API FileSystemLimitExceeded() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    FileSystemLimitExceeded& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    FileSystemLimitExceeded& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
