...
class UpdateFileSystemResult {
 public:
  ...
  inline UpdateFileSystemResult& WithLifeCycleState(LifeCycleState value) {
  ...
  inline UpdateFileSystemResult& WithNumberOfMountTargets(int value) {
  ...
  inline UpdateFileSystemResult& WithPerformanceMode(PerformanceMode value) {
  ...
  inline UpdateFileSystemResult& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFileSystemResult& WithThroughputMode(ThroughputMode value) {
  ...
  inline UpdateFileSystemResult& WithProvisionedThroughputInMibps(double value) {
