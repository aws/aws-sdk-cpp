...
class DescribeLifecycleConfigurationResult {
 public:
  ...
  template <typename LifecyclePoliciesT = Aws::Vector<LifecyclePolicy>>
  DescribeLifecycleConfigurationResult& WithLifecyclePolicies(LifecyclePoliciesT&& value) {
    SetLifecyclePolicies(std::forward<LifecyclePoliciesT>(value));
    return *this;
  }
  template <typename LifecyclePoliciesT = LifecyclePolicy>
  DescribeLifecycleConfigurationResult& AddLifecyclePolicies(LifecyclePoliciesT&& value) {
    m_lifecyclePoliciesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLifecycleConfigurationResult& WithRequestId(RequestIdT&& value) {
