...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API NoFreeAddressesInSubnet() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    NoFreeAddressesInSubnet& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    NoFreeAddressesInSubnet& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
