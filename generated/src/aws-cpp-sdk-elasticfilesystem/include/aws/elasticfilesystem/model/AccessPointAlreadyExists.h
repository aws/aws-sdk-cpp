...
class AccessPointAlreadyExists {
 public:
  ...
  template <typename ErrorCodeT = Aws::String>
  AccessPointAlreadyExists& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename MessageT = Aws::String>
  AccessPointAlreadyExists& WithMessage(MessageT&& value) {
  ...
  template <typename AccessPointIdT = Aws::String>
  AccessPointAlreadyExists& WithAccessPointId(AccessPointIdT&& value) {
