...
class DescribeReplicationConfigurationsResult {
 public:
  ...
  template <typename ReplicationsT = Aws::Vector<ReplicationConfigurationDescription>>
  DescribeReplicationConfigurationsResult& WithReplications(ReplicationsT&& value) {
    SetReplications(std::forward<ReplicationsT>(value));
    return *this;
  }
  template <typename ReplicationsT = ReplicationConfigurationDescription>
  DescribeReplicationConfigurationsResult& AddReplications(ReplicationsT&& value) {
    m_replicationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReplicationConfigurationsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  DescribeReplicationConfigurationsResult& WithRequestId(RequestIdT&& value) {
