...
class CreateFileSystemResult {
 public:
  ...
  void SetCreationToken(CreationTokenT&& value) {
    ...
    m_creationToken = std::forward<CreationTokenT>(value);
  }
  template <typename CreationTokenT = Aws::String>
  CreateFileSystemResult& WithCreationToken(CreationTokenT&& value) {
    SetCreationToken(std::forward<CreationTokenT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetLifeCycleState(LifeCycleState value) {
    m_lifeCycleStateHasBeenSet = true;
    m_lifeCycleState = value;
  }
  inline CreateFileSystemResult& WithLifeCycleState(LifeCycleState value) {
  ...
  inline void SetNumberOfMountTargets(int value) {
    m_numberOfMountTargetsHasBeenSet = true;
    m_numberOfMountTargets = value;
  }
  inline CreateFileSystemResult& WithNumberOfMountTargets(int value) {
    SetNumberOfMountTargets(value);
    return *this;
  }
  ///@}
  ...
  void SetSizeInBytes(SizeInBytesT&& value) {
    ...
    m_sizeInBytes = std::forward<SizeInBytesT>(value);
  }
  template <typename SizeInBytesT = FileSystemSize>
  CreateFileSystemResult& WithSizeInBytes(SizeInBytesT&& value) {
    SetSizeInBytes(std::forward<SizeInBytesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPerformanceMode(PerformanceMode value) {
    m_performanceModeHasBeenSet = true;
    m_performanceMode = value;
  }
  inline CreateFileSystemResult& WithPerformanceMode(PerformanceMode value) {
  ...
  inline CreateFileSystemResult& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFileSystemResult& WithThroughputMode(ThroughputMode value) {
  ...
  inline CreateFileSystemResult& WithProvisionedThroughputInMibps(double value) {
  ...
  void SetFileSystemProtection(FileSystemProtectionT&& value) {
    ...
    m_fileSystemProtection = std::forward<FileSystemProtectionT>(value);
  }
  template <typename FileSystemProtectionT = FileSystemProtectionDescription>
  CreateFileSystemResult& WithFileSystemProtection(FileSystemProtectionT&& value) {
    SetFileSystemProtection(std::forward<FileSystemProtectionT>(value));
    return *this;
  }
  ///@}
