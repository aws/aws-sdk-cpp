...
class CreateFileSystemRequest : public EFSRequest {
 public:
  ...
  inline CreateFileSystemRequest& WithPerformanceMode(PerformanceMode value) {
  ...
  inline CreateFileSystemRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline CreateFileSystemRequest& WithThroughputMode(ThroughputMode value) {
  ...
  inline CreateFileSystemRequest& WithProvisionedThroughputInMibps(double value) {
  ...
  inline void SetBackup(bool value) {
    m_backupHasBeenSet = true;
    m_backup = value;
  }
  inline CreateFileSystemRequest& WithBackup(bool value) {
    SetBackup(value);
    return *this;
  }
  ///@}
