...
namespace Model
{
  ...
  public:
    ...
    inline AvailabilityZonesMismatch& WithErrorCode(const Aws::String& value) { SetErrorCode(value); return *this;}

    
    inline AvailabilityZonesMismatch& WithErrorCode(Aws::String&& value) { SetErrorCode(std::move(value)); return *this;}

    
    inline AvailabilityZonesMismatch& WithErrorCode(const char* value) { SetErrorCode(value); return *this;}
    ...
    inline AvailabilityZonesMismatch& WithMessage(const Aws::String& value) { SetMessage(value); return *this;}

    
    inline AvailabilityZonesMismatch& WithMessage(Aws::String&& value) { SetMessage(std::move(value)); return *this;}

    
    inline AvailabilityZonesMismatch& WithMessage(const char* value) { SetMessage(value); return *this;}
