...
class FileSystemSize {
 public:
  ...
  inline FileSystemSize& WithValue(long long value) {
    SetValue(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValueInIA(long long value) {
    m_valueInIAHasBeenSet = true;
    m_valueInIA = value;
  }
  inline FileSystemSize& WithValueInIA(long long value) {
    SetValueInIA(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValueInStandard(long long value) {
    m_valueInStandardHasBeenSet = true;
    m_valueInStandard = value;
  }
  inline FileSystemSize& WithValueInStandard(long long value) {
    SetValueInStandard(value);
    return *this;
  }
  ///@}
  ...
  inline void SetValueInArchive(long long value) {
    m_valueInArchiveHasBeenSet = true;
    m_valueInArchive = value;
  }
  inline FileSystemSize& WithValueInArchive(long long value) {
    SetValueInArchive(value);
    return *this;
  }
  ///@}
 private:
