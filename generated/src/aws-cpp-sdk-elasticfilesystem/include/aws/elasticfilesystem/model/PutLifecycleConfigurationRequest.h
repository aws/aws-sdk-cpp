...
class PutLifecycleConfigurationRequest : public EFSRequest {
 public:
  ...
  template <typename FileSystemIdT = Aws::String>
  PutLifecycleConfigurationRequest& WithFileSystemId(FileSystemIdT&& value) {
  ...
  template <typename LifecyclePoliciesT = Aws::Vector<LifecyclePolicy>>
  PutLifecycleConfigurationRequest& WithLifecyclePolicies(LifecyclePoliciesT&& value) {
    SetLifecyclePolicies(std::forward<LifecyclePoliciesT>(value));
    return *this;
  }
  template <typename LifecyclePoliciesT = LifecyclePolicy>
  PutLifecycleConfigurationRequest& AddLifecyclePolicies(LifecyclePoliciesT&& value) {
    m_lifecyclePoliciesHasBeenSet = true;
