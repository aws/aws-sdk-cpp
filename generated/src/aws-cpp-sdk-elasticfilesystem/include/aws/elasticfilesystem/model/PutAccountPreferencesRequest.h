...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API PutAccountPreferencesRequest() = default;
    ...
    inline PutAccountPreferencesRequest& WithResourceIdType(ResourceIdType value) { SetResourceIdType(value); return *this;}
    ///@}
  private:
