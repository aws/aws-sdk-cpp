...
class FileSystemDescription {
 public:
  ...
  inline FileSystemDescription& WithLifeCycleState(LifeCycleState value) {
  ...
  inline FileSystemDescription& WithNumberOfMountTargets(int value) {
  ...
  inline FileSystemDescription& WithPerformanceMode(PerformanceMode value) {
  ...
  inline FileSystemDescription& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline FileSystemDescription& WithThroughputMode(ThroughputMode value) {
  ...
  inline FileSystemDescription& WithProvisionedThroughputInMibps(double value) {
