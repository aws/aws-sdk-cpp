...
class DescribeAccountPreferencesRequest : public EFSRequest {
 public:
  AWS_EFS_API DescribeAccountPreferencesRequest() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAccountPreferencesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeAccountPreferencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
