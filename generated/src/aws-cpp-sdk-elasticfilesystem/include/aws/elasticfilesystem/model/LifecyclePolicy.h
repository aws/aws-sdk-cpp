...
class LifecyclePolicy {
 public:
  ...
  inline void SetTransitionToIA(TransitionToIARules value) {
    m_transitionToIAHasBeenSet = true;
    m_transitionToIA = value;
  }
  inline LifecyclePolicy& WithTransitionToIA(TransitionToIARules value) {
    SetTransitionToIA(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransitionToPrimaryStorageClass(TransitionToPrimaryStorageClassRules value) {
    m_transitionToPrimaryStorageClassHasBeenSet = true;
    m_transitionToPrimaryStorageClass = value;
  }
  inline LifecyclePolicy& WithTransitionToPrimaryStorageClass(TransitionToPrimaryStorageClassRules value) {
    SetTransitionToPrimaryStorageClass(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransitionToArchive(TransitionToArchiveRules value) {
    m_transitionToArchiveHasBeenSet = true;
    m_transitionToArchive = value;
  }
  inline LifecyclePolicy& WithTransitionToArchive(TransitionToArchiveRules value) {
    SetTransitionToArchive(value);
    return *this;
  }
  ///@}
 private:
