...
namespace Model
{
  ...
  {
  public:
    AWS_EFS_API MountTargetNotFound() = default;
    ...
    template<typename ErrorCodeT = Aws::String>
    MountTargetNotFound& WithErrorCode(ErrorCodeT&& value) { SetErrorCode(std::forward<ErrorCodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    MountTargetNotFound& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
