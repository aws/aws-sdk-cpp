...
class Destination {
 public:
  ...
  inline Destination& WithStatus(ReplicationStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLastReplicatedTimestamp(LastReplicatedTimestampT&& value) {
    ...
    m_lastReplicatedTimestamp = std::forward<LastReplicatedTimestampT>(value);
  }
  template <typename LastReplicatedTimestampT = Aws::Utils::DateTime>
  Destination& WithLastReplicatedTimestamp(LastReplicatedTimestampT&& value) {
    SetLastReplicatedTimestamp(std::forward<LastReplicatedTimestampT>(value));
    return *this;
  }
  ///@}
