...
class ResourceIdPreference {
 public:
  ...
  inline void SetResourceIdType(ResourceIdType value) {
    m_resourceIdTypeHasBeenSet = true;
    m_resourceIdType = value;
  }
  inline ResourceIdPreference& WithResourceIdType(ResourceIdType value) {
    SetResourceIdType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourcesT = Aws::Vector<Resource>>
  ResourceIdPreference& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  inline ResourceIdPreference& AddResources(Resource value) {
    m_resourcesHasBeenSet = true;
