...
class AWS_EFS_API EFSClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  EFSClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<EFSEndpointProviderBase> endpointProvider = nullptr,
   ...
   * API Reference</a></p>
   */
  virtual Model::CreateReplicationConfigurationOutcome CreateReplicationConfiguration(
      const Model::CreateReplicationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for CreateReplicationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename CreateReplicationConfigurationRequestT = Model::CreateReplicationConfigurationRequest>
  Model::CreateReplicationConfigurationOutcomeCallable CreateReplicationConfigurationCallable(
      const CreateReplicationConfigurationRequestT& request) const {
    return SubmitCallable(&EFSClient::CreateReplicationConfiguration, request);
  }

  /**
   * An Async wrapper for CreateReplicationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename CreateReplicationConfigurationRequestT = Model::CreateReplicationConfigurationRequest>
  void CreateReplicationConfigurationAsync(const CreateReplicationConfigurationRequestT& request,
                                           const CreateReplicationConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DeleteReplicationConfigurationOutcome DeleteReplicationConfiguration(
      const Model::DeleteReplicationConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DeleteReplicationConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DeleteReplicationConfigurationRequestT = Model::DeleteReplicationConfigurationRequest>
  Model::DeleteReplicationConfigurationOutcomeCallable DeleteReplicationConfigurationCallable(
      const DeleteReplicationConfigurationRequestT& request) const {
    return SubmitCallable(&EFSClient::DeleteReplicationConfiguration, request);
  }

  /**
   * An Async wrapper for DeleteReplicationConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DeleteReplicationConfigurationRequestT = Model::DeleteReplicationConfigurationRequest>
  void DeleteReplicationConfigurationAsync(const DeleteReplicationConfigurationRequestT& request,
                                           const DeleteReplicationConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeAccessPoints that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeAccessPoints that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccessPointsRequestT = Model::DescribeAccessPointsRequest>
  void DescribeAccessPointsAsync(const DescribeAccessPointsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeAccessPointsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeAccountPreferencesOutcome DescribeAccountPreferences(
      const Model::DescribeAccountPreferencesRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeAccountPreferences that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeAccountPreferencesRequestT = Model::DescribeAccountPreferencesRequest>
  Model::DescribeAccountPreferencesOutcomeCallable DescribeAccountPreferencesCallable(
      const DescribeAccountPreferencesRequestT& request = {}) const {
    return SubmitCallable(&EFSClient::DescribeAccountPreferences, request);
  }

  /**
   * An Async wrapper for DescribeAccountPreferences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeAccountPreferencesRequestT = Model::DescribeAccountPreferencesRequest>
  void DescribeAccountPreferencesAsync(const DescribeAccountPreferencesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                       const DescribeAccountPreferencesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeBackupPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeBackupPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeBackupPolicyRequestT = Model::DescribeBackupPolicyRequest>
  void DescribeBackupPolicyAsync(const DescribeBackupPolicyRequestT& request, const DescribeBackupPolicyResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DescribeFileSystemPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFileSystemPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeFileSystemPolicyRequestT = Model::DescribeFileSystemPolicyRequest>
  void DescribeFileSystemPolicyAsync(const DescribeFileSystemPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeFileSystems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeFileSystems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeFileSystemsRequestT = Model::DescribeFileSystemsRequest>
  void DescribeFileSystemsAsync(const DescribeFileSystemsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const DescribeFileSystemsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeLifecycleConfigurationOutcome DescribeLifecycleConfiguration(
      const Model::DescribeLifecycleConfigurationRequest& request) const;

  /**
   * A Callable wrapper for DescribeLifecycleConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DescribeLifecycleConfigurationRequestT = Model::DescribeLifecycleConfigurationRequest>
  Model::DescribeLifecycleConfigurationOutcomeCallable DescribeLifecycleConfigurationCallable(
      const DescribeLifecycleConfigurationRequestT& request) const {
    return SubmitCallable(&EFSClient::DescribeLifecycleConfiguration, request);
  }

  /**
   * An Async wrapper for DescribeLifecycleConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeLifecycleConfigurationRequestT = Model::DescribeLifecycleConfigurationRequest>
  void DescribeLifecycleConfigurationAsync(const DescribeLifecycleConfigurationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeMountTargetSecurityGroupsOutcome DescribeMountTargetSecurityGroups(
      const Model::DescribeMountTargetSecurityGroupsRequest& request) const;

  /**
   * A Callable wrapper for DescribeMountTargetSecurityGroups that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeMountTargetSecurityGroupsRequestT = Model::DescribeMountTargetSecurityGroupsRequest>
  Model::DescribeMountTargetSecurityGroupsOutcomeCallable DescribeMountTargetSecurityGroupsCallable(
      const DescribeMountTargetSecurityGroupsRequestT& request) const {
    return SubmitCallable(&EFSClient::DescribeMountTargetSecurityGroups, request);
  }

  /**
   * An Async wrapper for DescribeMountTargetSecurityGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeMountTargetSecurityGroupsRequestT = Model::DescribeMountTargetSecurityGroupsRequest>
  void DescribeMountTargetSecurityGroupsAsync(const DescribeMountTargetSecurityGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeMountTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeMountTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeMountTargetsRequestT = Model::DescribeMountTargetsRequest>
  void DescribeMountTargetsAsync(const DescribeMountTargetsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DescribeMountTargetsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::DescribeReplicationConfigurationsOutcome DescribeReplicationConfigurations(
      const Model::DescribeReplicationConfigurationsRequest& request = {}) const;

  /**
   * A Callable wrapper for DescribeReplicationConfigurations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename DescribeReplicationConfigurationsRequestT = Model::DescribeReplicationConfigurationsRequest>
  Model::DescribeReplicationConfigurationsOutcomeCallable DescribeReplicationConfigurationsCallable(
      const DescribeReplicationConfigurationsRequestT& request = {}) const {
    return SubmitCallable(&EFSClient::DescribeReplicationConfigurations, request);
  }

  /**
   * An Async wrapper for DescribeReplicationConfigurations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DescribeReplicationConfigurationsRequestT = Model::DescribeReplicationConfigurationsRequest>
  void DescribeReplicationConfigurationsAsync(const DescribeReplicationConfigurationsResponseReceivedHandler& handler,
                                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                              const DescribeReplicationConfigurationsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ModifyMountTargetSecurityGroupsOutcome ModifyMountTargetSecurityGroups(
      const Model::ModifyMountTargetSecurityGroupsRequest& request) const;

  /**
   * A Callable wrapper for ModifyMountTargetSecurityGroups that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ModifyMountTargetSecurityGroupsRequestT = Model::ModifyMountTargetSecurityGroupsRequest>
  Model::ModifyMountTargetSecurityGroupsOutcomeCallable ModifyMountTargetSecurityGroupsCallable(
      const ModifyMountTargetSecurityGroupsRequestT& request) const {
    return SubmitCallable(&EFSClient::ModifyMountTargetSecurityGroups, request);
  }

  /**
   * An Async wrapper for ModifyMountTargetSecurityGroups that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ModifyMountTargetSecurityGroupsRequestT = Model::ModifyMountTargetSecurityGroupsRequest>
  void ModifyMountTargetSecurityGroupsAsync(const ModifyMountTargetSecurityGroupsRequestT& request,
  ...
  /**
   * A Callable wrapper for PutAccountPreferences that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for PutAccountPreferences that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutAccountPreferencesRequestT = Model::PutAccountPreferencesRequest>
  void PutAccountPreferencesAsync(const PutAccountPreferencesRequestT& request, const PutAccountPreferencesResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for PutBackupPolicy that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutBackupPolicyRequestT = Model::PutBackupPolicyRequest>
  void PutBackupPolicyAsync(const PutBackupPolicyRequestT& request, const PutBackupPolicyResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for PutLifecycleConfiguration that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename PutLifecycleConfigurationRequestT = Model::PutLifecycleConfigurationRequest>
  Model::PutLifecycleConfigurationOutcomeCallable PutLifecycleConfigurationCallable(
      const PutLifecycleConfigurationRequestT& request) const {
    return SubmitCallable(&EFSClient::PutLifecycleConfiguration, request);
  }

  /**
   * An Async wrapper for PutLifecycleConfiguration that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename PutLifecycleConfigurationRequestT = Model::PutLifecycleConfigurationRequest>
  void PutLifecycleConfigurationAsync(const PutLifecycleConfigurationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateFileSystem that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFileSystem that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateFileSystemRequestT = Model::UpdateFileSystemRequest>
  void UpdateFileSystemAsync(const UpdateFileSystemRequestT& request, const UpdateFileSystemResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateFileSystemProtectionOutcome UpdateFileSystemProtection(
      const Model::UpdateFileSystemProtectionRequest& request) const;

  /**
   * A Callable wrapper for UpdateFileSystemProtection that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateFileSystemProtectionRequestT = Model::UpdateFileSystemProtectionRequest>
  Model::UpdateFileSystemProtectionOutcomeCallable UpdateFileSystemProtectionCallable(
      const UpdateFileSystemProtectionRequestT& request) const {
    return SubmitCallable(&EFSClient::UpdateFileSystemProtection, request);
  }

  /**
   * An Async wrapper for UpdateFileSystemProtection that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFileSystemProtectionRequestT = Model::UpdateFileSystemProtectionRequest>
  void UpdateFileSystemProtectionAsync(const UpdateFileSystemProtectionRequestT& request,
                                       const UpdateFileSystemProtectionResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
