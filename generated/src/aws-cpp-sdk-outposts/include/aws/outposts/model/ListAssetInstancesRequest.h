...
class ListAssetInstancesRequest : public OutpostsRequest {
 public:
  ...
  void SetAssetIdFilter(AssetIdFilterT&& value) {
    m_assetIdFilterHasBeenSet = true;
    m_assetIdFilter = std::forward<AssetIdFilterT>(value);
  }
  template <typename AssetIdFilterT = Aws::Vector<Aws::String>>
  ListAssetInstancesRequest& WithAssetIdFilter(AssetIdFilterT&& value) {
    SetAssetIdFilter(std::forward<AssetIdFilterT>(value));
    return *this;
  }
  template <typename AssetIdFilterT = Aws::String>
  ListAssetInstancesRequest& AddAssetIdFilter(AssetIdFilterT&& value) {
    m_assetIdFilterHasBeenSet = true;
    m_assetIdFilter.emplace_back(std::forward<AssetIdFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceTypeFilter(InstanceTypeFilterT&& value) {
    m_instanceTypeFilterHasBeenSet = true;
    m_instanceTypeFilter = std::forward<InstanceTypeFilterT>(value);
  }
  template <typename InstanceTypeFilterT = Aws::Vector<Aws::String>>
  ListAssetInstancesRequest& WithInstanceTypeFilter(InstanceTypeFilterT&& value) {
    SetInstanceTypeFilter(std::forward<InstanceTypeFilterT>(value));
    return *this;
  }
  ...
  ListAssetInstancesRequest& AddInstanceTypeFilter(InstanceTypeFilterT&& value) {
    m_instanceTypeFilterHasBeenSet = true;
    m_instanceTypeFilter.emplace_back(std::forward<InstanceTypeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccountIdFilter(AccountIdFilterT&& value) {
    m_accountIdFilterHasBeenSet = true;
    m_accountIdFilter = std::forward<AccountIdFilterT>(value);
  }
  template <typename AccountIdFilterT = Aws::Vector<Aws::String>>
  ListAssetInstancesRequest& WithAccountIdFilter(AccountIdFilterT&& value) {
    SetAccountIdFilter(std::forward<AccountIdFilterT>(value));
    return *this;
  }
  template <typename AccountIdFilterT = Aws::String>
  ListAssetInstancesRequest& AddAccountIdFilter(AccountIdFilterT&& value) {
    m_accountIdFilterHasBeenSet = true;
    m_accountIdFilter.emplace_back(std::forward<AccountIdFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAwsServiceFilter(AwsServiceFilterT&& value) {
    m_awsServiceFilterHasBeenSet = true;
    m_awsServiceFilter = std::forward<AwsServiceFilterT>(value);
  }
  template <typename AwsServiceFilterT = Aws::Vector<AWSServiceName>>
  ListAssetInstancesRequest& WithAwsServiceFilter(AwsServiceFilterT&& value) {
    SetAwsServiceFilter(std::forward<AwsServiceFilterT>(value));
    return *this;
  }
  inline ListAssetInstancesRequest& AddAwsServiceFilter(AWSServiceName value) {
    m_awsServiceFilterHasBeenSet = true;
    m_awsServiceFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ListAssetInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
