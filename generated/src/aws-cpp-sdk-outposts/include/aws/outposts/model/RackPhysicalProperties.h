...
class RackPhysicalProperties {
 public:
  ...
  inline RackPhysicalProperties& WithPowerDrawKva(PowerDrawKva value) {
  ...
  inline RackPhysicalProperties& WithPowerPhase(PowerPhase value) {
    SetPowerPhase(value);
    return *this;
  }
  ///@}
  ...
  inline RackPhysicalProperties& WithPowerConnector(PowerConnector value) {
  ...
  inline RackPhysicalProperties& WithPowerFeedDrop(PowerFeedDrop value) {
  ...
  inline RackPhysicalProperties& WithUplinkGbps(UplinkGbps value) {
    SetUplinkGbps(value);
    return *this;
  }
  ///@}
  ...
  inline RackPhysicalProperties& WithUplinkCount(UplinkCount value) {
  ...
  inline RackPhysicalProperties& WithFiberOpticCableType(FiberOpticCableType value) {
  ...
  inline RackPhysicalProperties& WithOpticalStandard(OpticalStandard value) {
  ...
  inline RackPhysicalProperties& WithMaximumSupportedWeightLbs(MaximumSupportedWeightLbs value) {
