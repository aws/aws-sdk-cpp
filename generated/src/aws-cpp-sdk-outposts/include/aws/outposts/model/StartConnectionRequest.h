...
class StartConnectionRequest : public OutpostsRequest {
 public:
  ...
  void SetDeviceSerialNumber(DeviceSerialNumberT&& value) {
    ...
    m_deviceSerialNumber = std::forward<DeviceSerialNumberT>(value);
  }
  template <typename DeviceSerialNumberT = Aws::String>
  StartConnectionRequest& WithDeviceSerialNumber(DeviceSerialNumberT&& value) {
    SetDeviceSerialNumber(std::forward<DeviceSerialNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetNetworkInterfaceDeviceIndex(int value) {
    m_networkInterfaceDeviceIndexHasBeenSet = true;
    m_networkInterfaceDeviceIndex = value;
  }
  inline StartConnectionRequest& WithNetworkInterfaceDeviceIndex(int value) {
    SetNetworkInterfaceDeviceIndex(value);
    return *this;
  }
  ///@}
 private:
