...
class ListSitesRequest : public OutpostsRequest {
 public:
  ...
  inline ListSitesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetOperatingAddressCountryCodeFilter(OperatingAddressCountryCodeFilterT&& value) {
    m_operatingAddressCountryCodeFilterHasBeenSet = true;
    m_operatingAddressCountryCodeFilter = std::forward<OperatingAddressCountryCodeFilterT>(value);
  }
  template <typename OperatingAddressCountryCodeFilterT = Aws::Vector<Aws::String>>
  ListSitesRequest& WithOperatingAddressCountryCodeFilter(OperatingAddressCountryCodeFilterT&& value) {
    SetOperatingAddressCountryCodeFilter(std::forward<OperatingAddressCountryCodeFilterT>(value));
    return *this;
  }
  ...
  ListSitesRequest& AddOperatingAddressCountryCodeFilter(OperatingAddressCountryCodeFilterT&& value) {
    m_operatingAddressCountryCodeFilterHasBeenSet = true;
    m_operatingAddressCountryCodeFilter.emplace_back(std::forward<OperatingAddressCountryCodeFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperatingAddressStateOrRegionFilter(OperatingAddressStateOrRegionFilterT&& value) {
    m_operatingAddressStateOrRegionFilterHasBeenSet = true;
    m_operatingAddressStateOrRegionFilter = std::forward<OperatingAddressStateOrRegionFilterT>(value);
  }
  template <typename OperatingAddressStateOrRegionFilterT = Aws::Vector<Aws::String>>
  ListSitesRequest& WithOperatingAddressStateOrRegionFilter(OperatingAddressStateOrRegionFilterT&& value) {
    SetOperatingAddressStateOrRegionFilter(std::forward<OperatingAddressStateOrRegionFilterT>(value));
    return *this;
  }
  ...
  ListSitesRequest& AddOperatingAddressStateOrRegionFilter(OperatingAddressStateOrRegionFilterT&& value) {
    m_operatingAddressStateOrRegionFilterHasBeenSet = true;
    m_operatingAddressStateOrRegionFilter.emplace_back(std::forward<OperatingAddressStateOrRegionFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperatingAddressCityFilter(OperatingAddressCityFilterT&& value) {
    m_operatingAddressCityFilterHasBeenSet = true;
    m_operatingAddressCityFilter = std::forward<OperatingAddressCityFilterT>(value);
  }
  template <typename OperatingAddressCityFilterT = Aws::Vector<Aws::String>>
  ListSitesRequest& WithOperatingAddressCityFilter(OperatingAddressCityFilterT&& value) {
    SetOperatingAddressCityFilter(std::forward<OperatingAddressCityFilterT>(value));
    return *this;
  }
  ...
  ListSitesRequest& AddOperatingAddressCityFilter(OperatingAddressCityFilterT&& value) {
    m_operatingAddressCityFilterHasBeenSet = true;
    m_operatingAddressCityFilter.emplace_back(std::forward<OperatingAddressCityFilterT>(value));
    return *this;
  }
  ///@}
 private:
