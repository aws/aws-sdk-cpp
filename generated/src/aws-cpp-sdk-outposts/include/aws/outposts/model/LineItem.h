...
class LineItem {
 public:
  ...
  void SetCatalogItemId(CatalogItemIdT&& value) {
    ...
    m_catalogItemId = std::forward<CatalogItemIdT>(value);
  }
  template <typename CatalogItemIdT = Aws::String>
  LineItem& WithCatalogItemId(CatalogItemIdT&& value) {
    SetCatalogItemId(std::forward<CatalogItemIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLineItemId(LineItemIdT&& value) {
    ...
    m_lineItemId = std::forward<LineItemIdT>(value);
  }
  template <typename LineItemIdT = Aws::String>
  LineItem& WithLineItemId(LineItemIdT&& value) {
    SetLineItemId(std::forward<LineItemIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline LineItem& WithQuantity(int value) {
    SetQuantity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStatus(LineItemStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline LineItem& WithStatus(LineItemStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetShipmentInformation(ShipmentInformationT&& value) {
    ...
    m_shipmentInformation = std::forward<ShipmentInformationT>(value);
  }
  template <typename ShipmentInformationT = ShipmentInformation>
  LineItem& WithShipmentInformation(ShipmentInformationT&& value) {
    SetShipmentInformation(std::forward<ShipmentInformationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAssetInformationList(AssetInformationListT&& value) {
    ...
    m_assetInformationList = std::forward<AssetInformationListT>(value);
  }
  template <typename AssetInformationListT = Aws::Vector<LineItemAssetInformation>>
  LineItem& WithAssetInformationList(AssetInformationListT&& value) {
    SetAssetInformationList(std::forward<AssetInformationListT>(value));
    return *this;
  }
  ...
  LineItem& AddAssetInformationList(AssetInformationListT&& value) {
    m_assetInformationListHasBeenSet = true;
    m_assetInformationList.emplace_back(std::forward<AssetInformationListT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousLineItemId(PreviousLineItemIdT&& value) {
    ...
    m_previousLineItemId = std::forward<PreviousLineItemIdT>(value);
  }
  template <typename PreviousLineItemIdT = Aws::String>
  LineItem& WithPreviousLineItemId(PreviousLineItemIdT&& value) {
    SetPreviousLineItemId(std::forward<PreviousLineItemIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPreviousOrderId(PreviousOrderIdT&& value) {
    ...
    m_previousOrderId = std::forward<PreviousOrderIdT>(value);
  }
  template <typename PreviousOrderIdT = Aws::String>
  LineItem& WithPreviousOrderId(PreviousOrderIdT&& value) {
    SetPreviousOrderId(std::forward<PreviousOrderIdT>(value));
    return *this;
  }
  ///@}
 private:
