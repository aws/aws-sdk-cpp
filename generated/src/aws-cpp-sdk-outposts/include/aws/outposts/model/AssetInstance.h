...
class AssetInstance {
 public:
  ...
  inline void SetAwsServiceName(AWSServiceName value) {
    m_awsServiceNameHasBeenSet = true;
    m_awsServiceName = value;
  }
  inline AssetInstance& WithAwsServiceName(AWSServiceName value) {
    SetAwsServiceName(value);
    return *this;
  }
  ///@}
 private:
