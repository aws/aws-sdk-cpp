...
namespace Model
{
  ...
  public:
    ...
    inline void SetStatus(DecommissionRequestStatus value) { m_statusHasBeenSet = true; m_status = value; }
    inline StartOutpostDecommissionResult& WithStatus(DecommissionRequestStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    void SetBlockingResourceTypes(BlockingResourceTypesT&& value) { m_blockingResourceTypesHasBeenSet = true; m_blockingResourceTypes = std::forward<BlockingResourceTypesT>(value); }
    template<typename BlockingResourceTypesT = Aws::Vector<BlockingResourceType>>
    StartOutpostDecommissionResult& WithBlockingResourceTypes(BlockingResourceTypesT&& value) { SetBlockingResourceTypes(std::forward<BlockingResourceTypesT>(value)); return *this;}
    inline StartOutpostDecommissionResult& AddBlockingResourceTypes(BlockingResourceType value) { m_blockingResourceTypesHasBeenSet = true; m_blockingResourceTypes.push_back(value); return *this; }
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    StartOutpostDecommissionResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
