...
class ComputeAttributes {
 public:
  ...
  inline void SetState(ComputeAssetState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ComputeAttributes& WithState(ComputeAssetState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceFamilies(InstanceFamiliesT&& value) {
    ...
    m_instanceFamilies = std::forward<InstanceFamiliesT>(value);
  }
  template <typename InstanceFamiliesT = Aws::Vector<Aws::String>>
  ComputeAttributes& WithInstanceFamilies(InstanceFamiliesT&& value) {
    SetInstanceFamilies(std::forward<InstanceFamiliesT>(value));
    return *this;
  }
  template <typename InstanceFamiliesT = Aws::String>
  ComputeAttributes& AddInstanceFamilies(InstanceFamiliesT&& value) {
    m_instanceFamiliesHasBeenSet = true;
    m_instanceFamilies.emplace_back(std::forward<InstanceFamiliesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetInstanceTypeCapacities(InstanceTypeCapacitiesT&& value) {
    ...
    m_instanceTypeCapacities = std::forward<InstanceTypeCapacitiesT>(value);
  }
  template <typename InstanceTypeCapacitiesT = Aws::Vector<AssetInstanceTypeCapacity>>
  ComputeAttributes& WithInstanceTypeCapacities(InstanceTypeCapacitiesT&& value) {
    SetInstanceTypeCapacities(std::forward<InstanceTypeCapacitiesT>(value));
    return *this;
  }
  ...
  ComputeAttributes& AddInstanceTypeCapacities(InstanceTypeCapacitiesT&& value) {
    m_instanceTypeCapacitiesHasBeenSet = true;
    m_instanceTypeCapacities.emplace_back(std::forward<InstanceTypeCapacitiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxVcpus(int value) {
    m_maxVcpusHasBeenSet = true;
    m_maxVcpus = value;
  }
  inline ComputeAttributes& WithMaxVcpus(int value) {
    SetMaxVcpus(value);
    return *this;
  }
  ///@}
