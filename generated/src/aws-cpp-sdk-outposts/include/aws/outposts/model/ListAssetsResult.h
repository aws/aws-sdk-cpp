...
class ListAssetsResult {
 public:
  ...
  template <typename AssetsT = Aws::Vector<AssetInfo>>
  ListAssetsResult& WithAssets(AssetsT&& value) {
    SetAssets(std::forward<AssetsT>(value));
    return *this;
  }
  template <typename AssetsT = AssetInfo>
  ListAssetsResult& AddAssets(AssetsT&& value) {
    m_assetsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListAssetsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListAssetsResult& WithRequestId(RequestIdT&& value) {
