...
class CreateSiteRequest : public OutpostsRequest {
 public:
  ...
  void SetOperatingAddress(OperatingAddressT&& value) {
    m_operatingAddressHasBeenSet = true;
    m_operatingAddress = std::forward<OperatingAddressT>(value);
  }
  template <typename OperatingAddressT = Address>
  CreateSiteRequest& WithOperatingAddress(OperatingAddressT&& value) {
    SetOperatingAddress(std::forward<OperatingAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRackPhysicalProperties(RackPhysicalPropertiesT&& value) {
    ...
    m_rackPhysicalProperties = std::forward<RackPhysicalPropertiesT>(value);
  }
  template <typename RackPhysicalPropertiesT = RackPhysicalProperties>
  CreateSiteRequest& WithRackPhysicalProperties(RackPhysicalPropertiesT&& value) {
    SetRackPhysicalProperties(std::forward<RackPhysicalPropertiesT>(value));
    return *this;
  }
  ///@}
 private:
