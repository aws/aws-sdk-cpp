...
class OrderSummary {
 public:
  ...
  template <typename OutpostIdT = Aws::String>
  OrderSummary& WithOutpostId(OutpostIdT&& value) {
  ...
  template <typename OrderIdT = Aws::String>
  OrderSummary& WithOrderId(OrderIdT&& value) {
  ...
  inline OrderSummary& WithOrderType(OrderType value) {
    SetOrderType(value);
    return *this;
  }
  ///@}
  ...
  inline OrderSummary& WithStatus(OrderStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLineItemCountsByStatus(LineItemCountsByStatusT&& value) {
    m_lineItemCountsByStatusHasBeenSet = true;
    m_lineItemCountsByStatus = std::forward<LineItemCountsByStatusT>(value);
  }
  template <typename LineItemCountsByStatusT = Aws::Map<LineItemStatus, int>>
  OrderSummary& WithLineItemCountsByStatus(LineItemCountsByStatusT&& value) {
    SetLineItemCountsByStatus(std::forward<LineItemCountsByStatusT>(value));
    return *this;
  }
  inline OrderSummary& AddLineItemCountsByStatus(LineItemStatus key, int value) {
    m_lineItemCountsByStatusHasBeenSet = true;
    m_lineItemCountsByStatus.emplace(key, value);
    return *this;
  }
  ///@}
  ...
  template <typename OrderSubmissionDateT = Aws::Utils::DateTime>
  OrderSummary& WithOrderSubmissionDate(OrderSubmissionDateT&& value) {
  ...
  template <typename OrderFulfilledDateT = Aws::Utils::DateTime>
  OrderSummary& WithOrderFulfilledDate(OrderFulfilledDateT&& value) {
