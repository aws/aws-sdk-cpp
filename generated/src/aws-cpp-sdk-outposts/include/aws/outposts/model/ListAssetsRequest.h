...
class ListAssetsRequest : public OutpostsRequest {
 public:
  ...
  void SetHostIdFilter(HostIdFilterT&& value) {
    m_hostIdFilterHasBeenSet = true;
    m_hostIdFilter = std::forward<HostIdFilterT>(value);
  }
  template <typename HostIdFilterT = Aws::Vector<Aws::String>>
  ListAssetsRequest& WithHostIdFilter(HostIdFilterT&& value) {
    SetHostIdFilter(std::forward<HostIdFilterT>(value));
    return *this;
  }
  template <typename HostIdFilterT = Aws::String>
  ListAssetsRequest& AddHostIdFilter(HostIdFilterT&& value) {
    m_hostIdFilterHasBeenSet = true;
    m_hostIdFilter.emplace_back(std::forward<HostIdFilterT>(value));
    return *this;
  }
  ///@}
  ...
  inline ListAssetsRequest& AddStatusFilter(AssetState value) {
    m_statusFilterHasBeenSet = true;
