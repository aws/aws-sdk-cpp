...
class CatalogItem {
 public:
  ...
  inline void SetItemStatus(CatalogItemStatus value) {
    m_itemStatusHasBeenSet = true;
    m_itemStatus = value;
  }
  inline CatalogItem& WithItemStatus(CatalogItemStatus value) {
    SetItemStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPowerKva(double value) {
    m_powerKvaHasBeenSet = true;
    m_powerKva = value;
  }
  inline CatalogItem& WithPowerKva(double value) {
    SetPowerKva(value);
    return *this;
  }
  ///@}
  ...
  inline void SetWeightLbs(int value) {
    m_weightLbsHasBeenSet = true;
    m_weightLbs = value;
  }
  inline CatalogItem& WithWeightLbs(int value) {
    SetWeightLbs(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedUplinkGbps(SupportedUplinkGbpsT&& value) {
    ...
    m_supportedUplinkGbps = std::forward<SupportedUplinkGbpsT>(value);
  }
  template <typename SupportedUplinkGbpsT = Aws::Vector<int>>
  CatalogItem& WithSupportedUplinkGbps(SupportedUplinkGbpsT&& value) {
    SetSupportedUplinkGbps(std::forward<SupportedUplinkGbpsT>(value));
    return *this;
  }
  inline CatalogItem& AddSupportedUplinkGbps(int value) {
    m_supportedUplinkGbpsHasBeenSet = true;
    m_supportedUplinkGbps.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedStorage(SupportedStorageT&& value) {
    ...
    m_supportedStorage = std::forward<SupportedStorageT>(value);
  }
  template <typename SupportedStorageT = Aws::Vector<SupportedStorageEnum>>
  CatalogItem& WithSupportedStorage(SupportedStorageT&& value) {
    SetSupportedStorage(std::forward<SupportedStorageT>(value));
    return *this;
  }
  inline CatalogItem& AddSupportedStorage(SupportedStorageEnum value) {
    m_supportedStorageHasBeenSet = true;
    m_supportedStorage.push_back(value);
    return *this;
  }
  ///@}
 private:
