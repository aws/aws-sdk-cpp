...
class StartCapacityTaskResult {
 public:
  ...
  void SetRequestedInstancePools(RequestedInstancePoolsT&& value) {
    ...
    m_requestedInstancePools = std::forward<RequestedInstancePoolsT>(value);
  }
  template <typename RequestedInstancePoolsT = Aws::Vector<InstanceTypeCapacity>>
  StartCapacityTaskResult& WithRequestedInstancePools(RequestedInstancePoolsT&& value) {
    SetRequestedInstancePools(std::forward<RequestedInstancePoolsT>(value));
    return *this;
  }
  ...
  StartCapacityTaskResult& AddRequestedInstancePools(RequestedInstancePoolsT&& value) {
    m_requestedInstancePoolsHasBeenSet = true;
    m_requestedInstancePools.emplace_back(std::forward<RequestedInstancePoolsT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartCapacityTaskResult& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline StartCapacityTaskResult& WithCapacityTaskStatus(CapacityTaskStatus value) {
  ...
  inline StartCapacityTaskResult& WithTaskActionOnBlockingInstances(TaskActionOnBlockingInstances value) {
