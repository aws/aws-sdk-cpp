...
class ListBlockingInstancesForCapacityTaskResult {
 public:
  ...
  AWS_OUTPOSTS_API ListBlockingInstancesForCapacityTaskResult& operator=(
  ...
  void SetBlockingInstances(BlockingInstancesT&& value) {
    m_blockingInstancesHasBeenSet = true;
    m_blockingInstances = std::forward<BlockingInstancesT>(value);
  }
  template <typename BlockingInstancesT = Aws::Vector<BlockingInstance>>
  ListBlockingInstancesForCapacityTaskResult& WithBlockingInstances(BlockingInstancesT&& value) {
    SetBlockingInstances(std::forward<BlockingInstancesT>(value));
    return *this;
  }
  template <typename BlockingInstancesT = BlockingInstance>
  ListBlockingInstancesForCapacityTaskResult& AddBlockingInstances(BlockingInstancesT&& value) {
    m_blockingInstancesHasBeenSet = true;
    m_blockingInstances.emplace_back(std::forward<BlockingInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListBlockingInstancesForCapacityTaskResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListBlockingInstancesForCapacityTaskResult& WithRequestId(RequestIdT&& value) {
