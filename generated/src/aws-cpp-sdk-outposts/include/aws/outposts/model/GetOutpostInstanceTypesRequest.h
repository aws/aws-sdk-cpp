...
class GetOutpostInstanceTypesRequest : public OutpostsRequest {
 public:
  ...
  template <typename OutpostIdT = Aws::String>
  GetOutpostInstanceTypesRequest& WithOutpostId(OutpostIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetOutpostInstanceTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetOutpostInstanceTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
