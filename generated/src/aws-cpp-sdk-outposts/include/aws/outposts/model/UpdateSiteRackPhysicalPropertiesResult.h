...
class UpdateSiteRackPhysicalPropertiesResult {
 public:
  ...
  AWS_OUTPOSTS_API UpdateSiteRackPhysicalPropertiesResult& operator=(
  ...
  template <typename SiteT = Site>
  UpdateSiteRackPhysicalPropertiesResult& WithSite(SiteT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateSiteRackPhysicalPropertiesResult& WithRequestId(RequestIdT&& value) {
