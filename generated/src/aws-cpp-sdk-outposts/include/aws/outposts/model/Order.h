...
class Order {
 public:
  ...
  inline void SetStatus(OrderStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline Order& WithStatus(OrderStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetLineItems(LineItemsT&& value) {
    ...
    m_lineItems = std::forward<LineItemsT>(value);
  }
  template <typename LineItemsT = Aws::Vector<LineItem>>
  Order& WithLineItems(LineItemsT&& value) {
    SetLineItems(std::forward<LineItemsT>(value));
    return *this;
  }
  template <typename LineItemsT = LineItem>
  Order& AddLineItems(LineItemsT&& value) {
    m_lineItemsHasBeenSet = true;
    m_lineItems.emplace_back(std::forward<LineItemsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Order& WithPaymentOption(PaymentOption value) {
  ...
  void SetOrderSubmissionDate(OrderSubmissionDateT&& value) {
    ...
    m_orderSubmissionDate = std::forward<OrderSubmissionDateT>(value);
  }
  template <typename OrderSubmissionDateT = Aws::Utils::DateTime>
  Order& WithOrderSubmissionDate(OrderSubmissionDateT&& value) {
    SetOrderSubmissionDate(std::forward<OrderSubmissionDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrderFulfilledDate(OrderFulfilledDateT&& value) {
    ...
    m_orderFulfilledDate = std::forward<OrderFulfilledDateT>(value);
  }
  template <typename OrderFulfilledDateT = Aws::Utils::DateTime>
  Order& WithOrderFulfilledDate(OrderFulfilledDateT&& value) {
    SetOrderFulfilledDate(std::forward<OrderFulfilledDateT>(value));
    return *this;
  }
  ///@}
  ...
  inline Order& WithPaymentTerm(PaymentTerm value) {
  ...
  inline Order& WithOrderType(OrderType value) {
    SetOrderType(value);
    return *this;
  }
  ///@}
