...
class GetOutpostSupportedInstanceTypesResult {
 public:
  ...
  AWS_OUTPOSTS_API GetOutpostSupportedInstanceTypesResult& operator=(
  ...
  template <typename InstanceTypesT = Aws::Vector<InstanceTypeItem>>
  GetOutpostSupportedInstanceTypesResult& WithInstanceTypes(InstanceTypesT&& value) {
    SetInstanceTypes(std::forward<InstanceTypesT>(value));
    return *this;
  }
  template <typename InstanceTypesT = InstanceTypeItem>
  GetOutpostSupportedInstanceTypesResult& AddInstanceTypes(InstanceTypesT&& value) {
    m_instanceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetOutpostSupportedInstanceTypesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  GetOutpostSupportedInstanceTypesResult& WithRequestId(RequestIdT&& value) {
