...
/**
 * <p>Information about a quote for an Outpost. A quote provides pricing and
 * configuration options based on the requested capacity.</p><p><h3>See Also:</h3>
 * <a href="http://docs.aws.amazon.com/goto/WebAPI/outposts-2019-12-03/Quote">AWS
 * API Reference</a></p>
 */
class Quote {
 public:
  ...
  ///@{
  /**
   * <p>The status of the quote.</p> <ul> <li> <p> <code>CREATED</code> - The quote
   * has been created and is available for review.</p> </li> <li> <p>
   * <code>ORDER_SUBMITTED</code> - An order has been submitted for the quote.</p>
   * </li> <li> <p> <code>EXPIRED</code> - The quote has expired and can no longer be
   * used to submit an order.</p> </li> </ul>
   */
  ...
  inline Quote& WithQuoteStatus(QuoteStatus value) {
  ...
  inline Quote& AddRequestedPaymentOptions(PaymentOption value) {
    m_requestedPaymentOptionsHasBeenSet = true;
  ...
  inline Quote& AddRequestedPaymentTerms(PaymentTerm value) {
    m_requestedPaymentTermsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The configuration and pricing options for the quote. Each option includes
   * capacity details, physical specifications, and pricing information.</p>
   */
  ...
  ///@{
  /**
   * <p>The requirements that must be met before an order can be submitted for the
   * quote.</p>
   */
  inline const Aws::Vector<OrderingRequirement>& GetOrderingRequirements() const { return m_orderingRequirements; }
  inline bool OrderingRequirementsHasBeenSet() const { return m_orderingRequirementsHasBeenSet; }
  template <typename OrderingRequirementsT = Aws::Vector<OrderingRequirement>>
  void SetOrderingRequirements(OrderingRequirementsT&& value) {
    m_orderingRequirementsHasBeenSet = true;
    m_orderingRequirements = std::forward<OrderingRequirementsT>(value);
  }
  template <typename OrderingRequirementsT = Aws::Vector<OrderingRequirement>>
  Quote& WithOrderingRequirements(OrderingRequirementsT&& value) {
    SetOrderingRequirements(std::forward<OrderingRequirementsT>(value));
    return *this;
  }
  template <typename OrderingRequirementsT = OrderingRequirement>
  Quote& AddOrderingRequirements(OrderingRequirementsT&& value) {
    m_orderingRequirementsHasBeenSet = true;
    m_orderingRequirements.emplace_back(std::forward<OrderingRequirementsT>(value));
    return *this;
  }
  ///@}
 ...
 private:
  ...
  Aws::Vector<OrderingRequirement> m_orderingRequirements;
  ...
  bool m_orderingRequirementsHasBeenSet = false;
