...
class ListCatalogItemsResult {
 public:
  ...
  void SetCatalogItems(CatalogItemsT&& value) {
    m_catalogItemsHasBeenSet = true;
    m_catalogItems = std::forward<CatalogItemsT>(value);
  }
  template <typename CatalogItemsT = Aws::Vector<CatalogItem>>
  ListCatalogItemsResult& WithCatalogItems(CatalogItemsT&& value) {
    SetCatalogItems(std::forward<CatalogItemsT>(value));
    return *this;
  }
  template <typename CatalogItemsT = CatalogItem>
  ListCatalogItemsResult& AddCatalogItems(CatalogItemsT&& value) {
    m_catalogItemsHasBeenSet = true;
    m_catalogItems.emplace_back(std::forward<CatalogItemsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCatalogItemsResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListCatalogItemsResult& WithRequestId(RequestIdT&& value) {
