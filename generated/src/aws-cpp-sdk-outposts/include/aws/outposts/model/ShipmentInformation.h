...
class ShipmentInformation {
 public:
  ...
  void SetShipmentTrackingNumber(ShipmentTrackingNumberT&& value) {
    ...
    m_shipmentTrackingNumber = std::forward<ShipmentTrackingNumberT>(value);
  }
  template <typename ShipmentTrackingNumberT = Aws::String>
  ShipmentInformation& WithShipmentTrackingNumber(ShipmentTrackingNumberT&& value) {
    SetShipmentTrackingNumber(std::forward<ShipmentTrackingNumberT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetShipmentCarrier(ShipmentCarrier value) {
    m_shipmentCarrierHasBeenSet = true;
    m_shipmentCarrier = value;
  }
  inline ShipmentInformation& WithShipmentCarrier(ShipmentCarrier value) {
    SetShipmentCarrier(value);
    return *this;
  }
  ///@}
 private:
