...
class Subscription {
 public:
  ...
  inline Subscription& WithSubscriptionType(SubscriptionType value) {
  ...
  inline Subscription& WithSubscriptionStatus(SubscriptionStatus value) {
  ...
  void SetOrderIds(OrderIdsT&& value) {
    ...
    m_orderIds = std::forward<OrderIdsT>(value);
  }
  template <typename OrderIdsT = Aws::Vector<Aws::String>>
  Subscription& WithOrderIds(OrderIdsT&& value) {
    SetOrderIds(std::forward<OrderIdsT>(value));
    return *this;
  }
  template <typename OrderIdsT = Aws::String>
  Subscription& AddOrderIds(OrderIdsT&& value) {
    m_orderIdsHasBeenSet = true;
    m_orderIds.emplace_back(std::forward<OrderIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline Subscription& WithMonthlyRecurringPrice(double value) {
  ...
  inline Subscription& WithUpfrontPrice(double value) {
