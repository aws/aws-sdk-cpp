...
class ListOrdersResult {
 public:
  ...
  void SetOrders(OrdersT&& value) {
    m_ordersHasBeenSet = true;
    m_orders = std::forward<OrdersT>(value);
  }
  template <typename OrdersT = Aws::Vector<OrderSummary>>
  ListOrdersResult& WithOrders(OrdersT&& value) {
    SetOrders(std::forward<OrdersT>(value));
    return *this;
  }
  template <typename OrdersT = OrderSummary>
  ListOrdersResult& AddOrders(OrdersT&& value) {
    m_ordersHasBeenSet = true;
    m_orders.emplace_back(std::forward<OrdersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListOrdersResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListOrdersResult& WithRequestId(RequestIdT&& value) {
