...
class ListOutpostsRequest : public OutpostsRequest {
 public:
  ...
  inline ListOutpostsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetLifeCycleStatusFilter(LifeCycleStatusFilterT&& value) {
    m_lifeCycleStatusFilterHasBeenSet = true;
    m_lifeCycleStatusFilter = std::forward<LifeCycleStatusFilterT>(value);
  }
  template <typename LifeCycleStatusFilterT = Aws::Vector<Aws::String>>
  ListOutpostsRequest& WithLifeCycleStatusFilter(LifeCycleStatusFilterT&& value) {
    SetLifeCycleStatusFilter(std::forward<LifeCycleStatusFilterT>(value));
    return *this;
  }
  ...
  ListOutpostsRequest& AddLifeCycleStatusFilter(LifeCycleStatusFilterT&& value) {
    m_lifeCycleStatusFilterHasBeenSet = true;
    m_lifeCycleStatusFilter.emplace_back(std::forward<LifeCycleStatusFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailabilityZoneFilter(AvailabilityZoneFilterT&& value) {
    m_availabilityZoneFilterHasBeenSet = true;
    m_availabilityZoneFilter = std::forward<AvailabilityZoneFilterT>(value);
  }
  template <typename AvailabilityZoneFilterT = Aws::Vector<Aws::String>>
  ListOutpostsRequest& WithAvailabilityZoneFilter(AvailabilityZoneFilterT&& value) {
    SetAvailabilityZoneFilter(std::forward<AvailabilityZoneFilterT>(value));
    return *this;
  }
  ...
  ListOutpostsRequest& AddAvailabilityZoneFilter(AvailabilityZoneFilterT&& value) {
    m_availabilityZoneFilterHasBeenSet = true;
    m_availabilityZoneFilter.emplace_back(std::forward<AvailabilityZoneFilterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAvailabilityZoneIdFilter(AvailabilityZoneIdFilterT&& value) {
    m_availabilityZoneIdFilterHasBeenSet = true;
    m_availabilityZoneIdFilter = std::forward<AvailabilityZoneIdFilterT>(value);
  }
  template <typename AvailabilityZoneIdFilterT = Aws::Vector<Aws::String>>
  ListOutpostsRequest& WithAvailabilityZoneIdFilter(AvailabilityZoneIdFilterT&& value) {
    SetAvailabilityZoneIdFilter(std::forward<AvailabilityZoneIdFilterT>(value));
    return *this;
  }
  ...
  ListOutpostsRequest& AddAvailabilityZoneIdFilter(AvailabilityZoneIdFilterT&& value) {
    m_availabilityZoneIdFilterHasBeenSet = true;
    m_availabilityZoneIdFilter.emplace_back(std::forward<AvailabilityZoneIdFilterT>(value));
    return *this;
  }
  ///@}
 private:
