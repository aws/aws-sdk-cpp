...
class LineItemAssetInformation {
 public:
  ...
  template <typename AssetIdT = Aws::String>
  LineItemAssetInformation& WithAssetId(AssetIdT&& value) {
  ...
  void SetMacAddressList(MacAddressListT&& value) {
    m_macAddressListHasBeenSet = true;
    m_macAddressList = std::forward<MacAddressListT>(value);
  }
  template <typename MacAddressListT = Aws::Vector<Aws::String>>
  LineItemAssetInformation& WithMacAddressList(MacAddressListT&& value) {
    SetMacAddressList(std::forward<MacAddressListT>(value));
    return *this;
  }
  template <typename MacAddressListT = Aws::String>
  LineItemAssetInformation& AddMacAddressList(MacAddressListT&& value) {
    m_macAddressListHasBeenSet = true;
    m_macAddressList.emplace_back(std::forward<MacAddressListT>(value));
    return *this;
  }
  ///@}
 private:
