...
class Address {
 public:
  ...
  void SetContactName(ContactNameT&& value) {
    ...
    m_contactName = std::forward<ContactNameT>(value);
  }
  template <typename ContactNameT = Aws::String>
  Address& WithContactName(ContactNameT&& value) {
    SetContactName(std::forward<ContactNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetContactPhoneNumber(ContactPhoneNumberT&& value) {
    ...
    m_contactPhoneNumber = std::forward<ContactPhoneNumberT>(value);
  }
  template <typename ContactPhoneNumberT = Aws::String>
  Address& WithContactPhoneNumber(ContactPhoneNumberT&& value) {
    SetContactPhoneNumber(std::forward<ContactPhoneNumberT>(value));
    return *this;
  }
  ///@}
