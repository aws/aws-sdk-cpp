...
class Site {
 public:
  ...
  void SetOperatingAddressCountryCode(OperatingAddressCountryCodeT&& value) {
    ...
    m_operatingAddressCountryCode = std::forward<OperatingAddressCountryCodeT>(value);
  }
  template <typename OperatingAddressCountryCodeT = Aws::String>
  Site& WithOperatingAddressCountryCode(OperatingAddressCountryCodeT&& value) {
    SetOperatingAddressCountryCode(std::forward<OperatingAddressCountryCodeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperatingAddressStateOrRegion(OperatingAddressStateOrRegionT&& value) {
    ...
    m_operatingAddressStateOrRegion = std::forward<OperatingAddressStateOrRegionT>(value);
  }
  template <typename OperatingAddressStateOrRegionT = Aws::String>
  Site& WithOperatingAddressStateOrRegion(OperatingAddressStateOrRegionT&& value) {
    SetOperatingAddressStateOrRegion(std::forward<OperatingAddressStateOrRegionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOperatingAddressCity(OperatingAddressCityT&& value) {
    ...
    m_operatingAddressCity = std::forward<OperatingAddressCityT>(value);
  }
  template <typename OperatingAddressCityT = Aws::String>
  Site& WithOperatingAddressCity(OperatingAddressCityT&& value) {
    SetOperatingAddressCity(std::forward<OperatingAddressCityT>(value));
    return *this;
  }
  ///@}
