...
class ListCatalogItemsRequest : public OutpostsRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListCatalogItemsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCatalogItemsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetItemClassFilter(ItemClassFilterT&& value) {
    m_itemClassFilterHasBeenSet = true;
    m_itemClassFilter = std::forward<ItemClassFilterT>(value);
  }
  template <typename ItemClassFilterT = Aws::Vector<CatalogItemClass>>
  ListCatalogItemsRequest& WithItemClassFilter(ItemClassFilterT&& value) {
    SetItemClassFilter(std::forward<ItemClassFilterT>(value));
    return *this;
  }
  inline ListCatalogItemsRequest& AddItemClassFilter(CatalogItemClass value) {
    m_itemClassFilterHasBeenSet = true;
    m_itemClassFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedStorageFilter(SupportedStorageFilterT&& value) {
    m_supportedStorageFilterHasBeenSet = true;
    m_supportedStorageFilter = std::forward<SupportedStorageFilterT>(value);
  }
  template <typename SupportedStorageFilterT = Aws::Vector<SupportedStorageEnum>>
  ListCatalogItemsRequest& WithSupportedStorageFilter(SupportedStorageFilterT&& value) {
    SetSupportedStorageFilter(std::forward<SupportedStorageFilterT>(value));
    return *this;
  }
  inline ListCatalogItemsRequest& AddSupportedStorageFilter(SupportedStorageEnum value) {
    m_supportedStorageFilterHasBeenSet = true;
    m_supportedStorageFilter.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetEC2FamilyFilter(EC2FamilyFilterT&& value) {
    m_eC2FamilyFilterHasBeenSet = true;
    m_eC2FamilyFilter = std::forward<EC2FamilyFilterT>(value);
  }
  template <typename EC2FamilyFilterT = Aws::Vector<Aws::String>>
  ListCatalogItemsRequest& WithEC2FamilyFilter(EC2FamilyFilterT&& value) {
    SetEC2FamilyFilter(std::forward<EC2FamilyFilterT>(value));
    return *this;
  }
  template <typename EC2FamilyFilterT = Aws::String>
  ListCatalogItemsRequest& AddEC2FamilyFilter(EC2FamilyFilterT&& value) {
    m_eC2FamilyFilterHasBeenSet = true;
    m_eC2FamilyFilter.emplace_back(std::forward<EC2FamilyFilterT>(value));
    return *this;
  }
  ///@}
 private:
