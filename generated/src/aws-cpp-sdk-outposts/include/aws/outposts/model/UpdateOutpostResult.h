...
namespace Model
{
  ...
  {
  public:
    AWS_OUTPOSTS_API UpdateOutpostResult();
    ...
    inline UpdateOutpostResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline UpdateOutpostResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline UpdateOutpostResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
