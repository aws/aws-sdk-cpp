...
class UpdateOutpostResult {
 public:
  ...
  void SetOutpost(OutpostT&& value) {
    m_outpostHasBeenSet = true;
    m_outpost = std::forward<OutpostT>(value);
  }
  template <typename OutpostT = Outpost>
  UpdateOutpostResult& WithOutpost(OutpostT&& value) {
    SetOutpost(std::forward<OutpostT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  UpdateOutpostResult& WithRequestId(RequestIdT&& value) {
