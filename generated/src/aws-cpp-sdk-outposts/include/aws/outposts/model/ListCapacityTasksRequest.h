...
class ListCapacityTasksRequest : public OutpostsRequest {
 public:
  ...
  template <typename OutpostIdentifierFilterT = Aws::String>
  ListCapacityTasksRequest& WithOutpostIdentifierFilter(OutpostIdentifierFilterT&& value) {
  ...
  inline ListCapacityTasksRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCapacityTasksRequest& WithNextToken(NextTokenT&& value) {
  ...
  void SetCapacityTaskStatusFilter(CapacityTaskStatusFilterT&& value) {
    m_capacityTaskStatusFilterHasBeenSet = true;
    m_capacityTaskStatusFilter = std::forward<CapacityTaskStatusFilterT>(value);
  }
  template <typename CapacityTaskStatusFilterT = Aws::Vector<CapacityTaskStatus>>
  ListCapacityTasksRequest& WithCapacityTaskStatusFilter(CapacityTaskStatusFilterT&& value) {
    SetCapacityTaskStatusFilter(std::forward<CapacityTaskStatusFilterT>(value));
    return *this;
  }
  inline ListCapacityTasksRequest& AddCapacityTaskStatusFilter(CapacityTaskStatus value) {
    m_capacityTaskStatusFilterHasBeenSet = true;
    m_capacityTaskStatusFilter.push_back(value);
    return *this;
  }
  ///@}
 private:
