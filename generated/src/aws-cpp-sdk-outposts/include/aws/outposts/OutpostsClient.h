...
#include <aws/outposts/OutpostsWaiter.h>
...
class AWS_OUTPOSTS_API OutpostsClient : public Aws::Client::AWSJsonClient,
                                        ...
                                        public OutpostsWaiter<OutpostsClient> {
 public:
   ...
   */
  OutpostsClient(const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<OutpostsEndpointProviderBase> endpointProvider = nullptr,
  ...
  /**
   * <p>Cancels the capacity task.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/outposts-2019-12-03/CancelCapacityTask">AWS
   * API Reference</a></p>
   */
  virtual Model::CancelCapacityTaskOutcome CancelCapacityTask(const Model::CancelCapacityTaskRequest& request) const;

  /**
   * A Callable wrapper for CancelCapacityTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::CancelCapacityTaskOutcomeCallable CancelCapacityTaskCallable(const CancelCapacityTaskRequestT& request) const {
    return SubmitCallable(&OutpostsClient::CancelCapacityTask, request);
  }

  /**
   * An Async wrapper for CancelCapacityTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CancelCapacityTaskRequestT = Model::CancelCapacityTaskRequest>
  void CancelCapacityTaskAsync(const CancelCapacityTaskRequestT& request, const CancelCapacityTaskResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OutpostsClient::CancelCapacityTask, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for CancelOrder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CancelOrderRequestT = Model::CancelOrderRequest>
  void CancelOrderAsync(const CancelOrderRequestT& request, const CancelOrderResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateOrder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateOrderRequestT = Model::CreateOrderRequest>
  void CreateOrderAsync(const CreateOrderRequestT& request, const CreateOrderResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateOutpost that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateOutpostRequestT = Model::CreateOutpostRequest>
  ...
  /**
   * An Async wrapper for CreateSite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateSiteRequestT = Model::CreateSiteRequest>
  void CreateSiteAsync(const CreateSiteRequestT& request, const CreateSiteResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for DeleteOutpost that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteOutpostRequestT = Model::DeleteOutpostRequest>
  ...
  /**
   * An Async wrapper for DeleteSite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename DeleteSiteRequestT = Model::DeleteSiteRequest>
  void DeleteSiteAsync(const DeleteSiteRequestT& request, const DeleteSiteResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OutpostsClient::DeleteSite, request, handler, context);
  }

  /**
   * <p>Gets details of the specified capacity task.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/outposts-2019-12-03/GetCapacityTask">AWS
   * API Reference</a></p>
   */
  ...
  Model::GetCapacityTaskOutcomeCallable GetCapacityTaskCallable(const GetCapacityTaskRequestT& request) const {
    return SubmitCallable(&OutpostsClient::GetCapacityTask, request);
  }

  /**
   * An Async wrapper for GetCapacityTask that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCapacityTaskRequestT = Model::GetCapacityTaskRequest>
  void GetCapacityTaskAsync(const GetCapacityTaskRequestT& request, const GetCapacityTaskResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OutpostsClient::GetCapacityTask, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for GetCatalogItem that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetCatalogItemRequestT = Model::GetCatalogItemRequest>
  void GetCatalogItemAsync(const GetCatalogItemRequestT& request, const GetCatalogItemResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOrder that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOrderRequestT = Model::GetOrderRequest>
  void GetOrderAsync(const GetOrderRequestT& request, const GetOrderResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetOutpost that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetOutpostRequestT = Model::GetOutpostRequest>
  void GetOutpostAsync(const GetOutpostRequestT& request, const GetOutpostResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetOutpostBillingInformationOutcome GetOutpostBillingInformation(
      const Model::GetOutpostBillingInformationRequest& request) const;

  /**
   * A Callable wrapper for GetOutpostBillingInformation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetOutpostBillingInformationRequestT = Model::GetOutpostBillingInformationRequest>
  Model::GetOutpostBillingInformationOutcomeCallable GetOutpostBillingInformationCallable(
      const GetOutpostBillingInformationRequestT& request) const {
    return SubmitCallable(&OutpostsClient::GetOutpostBillingInformation, request);
  }

  /**
   * An Async wrapper for GetOutpostBillingInformation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOutpostBillingInformationRequestT = Model::GetOutpostBillingInformationRequest>
  void GetOutpostBillingInformationAsync(const GetOutpostBillingInformationRequestT& request,
                                         const GetOutpostBillingInformationResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetOutpostInstanceTypes that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetOutpostInstanceTypes that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetOutpostInstanceTypesRequestT = Model::GetOutpostInstanceTypesRequest>
  void GetOutpostInstanceTypesAsync(const GetOutpostInstanceTypesRequestT& request,
  ...
  /**
   * <p>Gets the instance types that an Outpost can support in
   * <code>InstanceTypeCapacity</code>. This will generally include instance types
   * that are not currently configured and therefore cannot be launched with the
   * current Outpost capacity configuration.</p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/outposts-2019-12-03/GetOutpostSupportedInstanceTypes">AWS
   * API Reference</a></p>
   */
  virtual Model::GetOutpostSupportedInstanceTypesOutcome GetOutpostSupportedInstanceTypes(
      const Model::GetOutpostSupportedInstanceTypesRequest& request) const;

  /**
   * A Callable wrapper for GetOutpostSupportedInstanceTypes that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetOutpostSupportedInstanceTypesRequestT = Model::GetOutpostSupportedInstanceTypesRequest>
  Model::GetOutpostSupportedInstanceTypesOutcomeCallable GetOutpostSupportedInstanceTypesCallable(
      const GetOutpostSupportedInstanceTypesRequestT& request) const {
    return SubmitCallable(&OutpostsClient::GetOutpostSupportedInstanceTypes, request);
  }

  /**
   * An Async wrapper for GetOutpostSupportedInstanceTypes that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetOutpostSupportedInstanceTypesRequestT = Model::GetOutpostSupportedInstanceTypesRequest>
  void GetOutpostSupportedInstanceTypesAsync(const GetOutpostSupportedInstanceTypesRequestT& request,
  ...
  /**
   * An Async wrapper for GetSite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSiteRequestT = Model::GetSiteRequest>
  void GetSiteAsync(const GetSiteRequestT& request, const GetSiteResponseReceivedHandler& handler,
                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetSiteAddress that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetSiteAddressRequestT = Model::GetSiteAddressRequest>
  void GetSiteAddressAsync(const GetSiteAddressRequestT& request, const GetSiteAddressResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAssetInstances that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAssetInstances that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAssetInstancesRequestT = Model::ListAssetInstancesRequest>
  void ListAssetInstancesAsync(const ListAssetInstancesRequestT& request, const ListAssetInstancesResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListBlockingInstancesForCapacityTaskOutcome ListBlockingInstancesForCapacityTask(
      const Model::ListBlockingInstancesForCapacityTaskRequest& request) const;

  /**
   * A Callable wrapper for ListBlockingInstancesForCapacityTask that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListBlockingInstancesForCapacityTaskRequestT = Model::ListBlockingInstancesForCapacityTaskRequest>
  Model::ListBlockingInstancesForCapacityTaskOutcomeCallable ListBlockingInstancesForCapacityTaskCallable(
      const ListBlockingInstancesForCapacityTaskRequestT& request) const {
    return SubmitCallable(&OutpostsClient::ListBlockingInstancesForCapacityTask, request);
  }

  /**
   * An Async wrapper for ListBlockingInstancesForCapacityTask that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListBlockingInstancesForCapacityTaskRequestT = Model::ListBlockingInstancesForCapacityTaskRequest>
  void ListBlockingInstancesForCapacityTaskAsync(const ListBlockingInstancesForCapacityTaskRequestT& request,
                                                 const ListBlockingInstancesForCapacityTaskResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OutpostsClient::ListBlockingInstancesForCapacityTask, request, handler, context);
  }

  /**
   * <p>Lists the capacity tasks for your Amazon Web Services account.</p> <p>Use
   * filters to return specific results. If you specify multiple filters, the results
   * include only the resources that match all of the specified filters. For a filter
   * where you can specify multiple values, the results include items that match any
   * of the values that you specify for the filter.</p><p><h3>See Also:</h3>   <a
  ...
  /**
   * A Callable wrapper for ListCapacityTasks that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCapacityTasks that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCapacityTasksRequestT = Model::ListCapacityTasksRequest>
  void ListCapacityTasksAsync(const ListCapacityTasksResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListCapacityTasksRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListCatalogItems that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListCatalogItems that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListCatalogItemsRequestT = Model::ListCatalogItemsRequest>
  void ListCatalogItemsAsync(const ListCatalogItemsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListCatalogItemsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListOrders that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOrdersRequestT = Model::ListOrdersRequest>
  void ListOrdersAsync(const ListOrdersResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                       const ListOrdersRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for ListOutposts that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListOutpostsRequestT = Model::ListOutpostsRequest>
  void ListOutpostsAsync(const ListOutpostsResponseReceivedHandler& handler,
                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * An Async wrapper for ListSites that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename ListSitesRequestT = Model::ListSitesRequest>
  void ListSitesAsync(const ListSitesResponseReceivedHandler& handler,
                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                      const ListSitesRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for StartCapacityTask that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  Model::StartCapacityTaskOutcomeCallable StartCapacityTaskCallable(const StartCapacityTaskRequestT& request) const {
    return SubmitCallable(&OutpostsClient::StartCapacityTask, request);
  }

  /**
   * An Async wrapper for StartCapacityTask that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename StartCapacityTaskRequestT = Model::StartCapacityTaskRequest>
  void StartCapacityTaskAsync(const StartCapacityTaskRequestT& request, const StartCapacityTaskResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&OutpostsClient::StartCapacityTask, request, handler, context);
  }
  ...
  /**
   * An Async wrapper for StartConnection that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename StartConnectionRequestT = Model::StartConnectionRequest>
  void StartConnectionAsync(const StartConnectionRequestT& request, const StartConnectionResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for StartOutpostDecommission that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for StartOutpostDecommission that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename StartOutpostDecommissionRequestT = Model::StartOutpostDecommissionRequest>
  void StartOutpostDecommissionAsync(const StartOutpostDecommissionRequestT& request,
                                     const StartOutpostDecommissionResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateOutpost that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateOutpostRequestT = Model::UpdateOutpostRequest>
  ...
  /**
   * An Async wrapper for UpdateSite that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateSiteRequestT = Model::UpdateSiteRequest>
  void UpdateSiteAsync(const UpdateSiteRequestT& request, const UpdateSiteResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSiteAddress that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSiteAddress that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateSiteAddressRequestT = Model::UpdateSiteAddressRequest>
  void UpdateSiteAddressAsync(const UpdateSiteAddressRequestT& request, const UpdateSiteAddressResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  virtual Model::UpdateSiteRackPhysicalPropertiesOutcome UpdateSiteRackPhysicalProperties(
      const Model::UpdateSiteRackPhysicalPropertiesRequest& request) const;

  /**
   * A Callable wrapper for UpdateSiteRackPhysicalProperties that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename UpdateSiteRackPhysicalPropertiesRequestT = Model::UpdateSiteRackPhysicalPropertiesRequest>
  Model::UpdateSiteRackPhysicalPropertiesOutcomeCallable UpdateSiteRackPhysicalPropertiesCallable(
      const UpdateSiteRackPhysicalPropertiesRequestT& request) const {
    return SubmitCallable(&OutpostsClient::UpdateSiteRackPhysicalProperties, request);
  }

  /**
   * An Async wrapper for UpdateSiteRackPhysicalProperties that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateSiteRackPhysicalPropertiesRequestT = Model::UpdateSiteRackPhysicalPropertiesRequest>
  void UpdateSiteRackPhysicalPropertiesAsync(const UpdateSiteRackPhysicalPropertiesRequestT& request,
                                             const UpdateSiteRackPhysicalPropertiesResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
