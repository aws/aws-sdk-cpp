...
namespace Outposts
{
   ...
   * needs.</p>
   */
  class AWS_OUTPOSTS_API OutpostsClient : Aws::Client::ClientWithAsyncTemplateMethods<OutpostsClient>,
    smithy::client::AwsSmithyClientT<Aws::Outposts::SERVICE_NAME,
