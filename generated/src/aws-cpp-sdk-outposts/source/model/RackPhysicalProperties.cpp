...
RackPhysicalProperties::RackPhysicalProperties(JsonView jsonValue) { *this = jsonValue; }
...
RackPhysicalProperties& RackPhysicalProperties::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MaximumSupportedWeightLbs")) {
    m_maximumSupportedWeightLbs =
        MaximumSupportedWeightLbsMapper::GetMaximumSupportedWeightLbsForName(jsonValue.GetString("MaximumSupportedWeightLbs"));
...
JsonValue RackPhysicalProperties::Jsonize() const {
  ...
  if (m_maximumSupportedWeightLbsHasBeenSet) {
    payload.WithString("MaximumSupportedWeightLbs",
                       MaximumSupportedWeightLbsMapper::GetNameForMaximumSupportedWeightLbs(m_maximumSupportedWeightLbs));
  }
