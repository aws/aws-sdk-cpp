...
Aws::String StartCapacityTaskRequest::SerializePayload() const {
  ...
  if (m_taskActionOnBlockingInstancesHasBeenSet) {
    payload.WithString("TaskActionOnBlockingInstances",
                       TaskActionOnBlockingInstancesMapper::GetNameForTaskActionOnBlockingInstances(m_taskActionOnBlockingInstances));
  }
