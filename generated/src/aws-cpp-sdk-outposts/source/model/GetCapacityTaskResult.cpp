...
GetCapacityTaskResult::GetCapacityTaskResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

GetCapacityTaskResult& GetCapacityTaskResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("RequestedInstancePools")) {
    ...
    for (unsigned requestedInstancePoolsIndex = 0; requestedInstancePoolsIndex < requestedInstancePoolsJsonList.GetLength();
         ++requestedInstancePoolsIndex) {
  ...
  if (jsonValue.ValueExists("TaskActionOnBlockingInstances")) {
    m_taskActionOnBlockingInstances =
        TaskActionOnBlockingInstancesMapper::GetTaskActionOnBlockingInstancesForName(jsonValue.GetString("TaskActionOnBlockingInstances"));
