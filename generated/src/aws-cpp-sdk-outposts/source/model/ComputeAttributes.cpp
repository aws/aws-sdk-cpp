...
ComputeAttributes::ComputeAttributes(JsonView jsonValue) { *this = jsonValue; }
...
ComputeAttributes& ComputeAttributes::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("InstanceTypeCapacities")) {
    ...
    for (unsigned instanceTypeCapacitiesIndex = 0; instanceTypeCapacitiesIndex < instanceTypeCapacitiesJsonList.GetLength();
         ++instanceTypeCapacitiesIndex) {
