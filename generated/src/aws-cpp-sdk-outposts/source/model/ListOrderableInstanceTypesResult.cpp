...
ListOrderableInstanceTypesResult::ListOrderableInstanceTypesResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

ListOrderableInstanceTypesResult& ListOrderableInstanceTypesResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
