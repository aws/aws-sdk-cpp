...
OrderSummary::OrderSummary(JsonView jsonValue) { *this = jsonValue; }
...
OrderSummary& OrderSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("LineItemCountsByStatus")) {
    ...
    for (auto& lineItemCountsByStatusItem : lineItemCountsByStatusJsonMap) {
      m_lineItemCountsByStatus[LineItemStatusMapper::GetLineItemStatusForName(lineItemCountsByStatusItem.first)] =
          lineItemCountsByStatusItem.second.AsInteger();
    }
...
JsonValue OrderSummary::Jsonize() const {
  ...
  if (m_lineItemCountsByStatusHasBeenSet) {
    ...
    for (auto& lineItemCountsByStatusItem : m_lineItemCountsByStatus) {
      lineItemCountsByStatusJsonMap.WithInteger(LineItemStatusMapper::GetNameForLineItemStatus(lineItemCountsByStatusItem.first),
                                                lineItemCountsByStatusItem.second);
    }
