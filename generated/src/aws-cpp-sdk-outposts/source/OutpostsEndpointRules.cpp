...
namespace Outposts
{
const size_t OutpostsEndpointRules::RulesBlobStrLen = 4142;
const size_t OutpostsEndpointRules::RulesBlobSize = 4143;
...
'p','o','i','n','t','"',':','{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','u',
't','p','o','s','t','s','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
'{','"','u','r','l','"',':','"','h','t','t','p','s',':','/','/','o','u','t','p','o','s','t','s','.',
...
':','"','h','t','t','p','s',':','/','/','o','u','t','p','o','s','t','s','.','u','s','-','g','o','v',
