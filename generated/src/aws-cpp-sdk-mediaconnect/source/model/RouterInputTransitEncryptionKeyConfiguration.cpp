...
RouterInputTransitEncryptionKeyConfiguration::RouterInputTransitEncryptionKeyConfiguration(JsonView jsonValue) { *this = jsonValue; }

RouterInputTransitEncryptionKeyConfiguration& RouterInputTransitEncryptionKeyConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RouterInputTransitEncryptionKeyConfiguration::Jsonize() const {
  JsonValue payload;
