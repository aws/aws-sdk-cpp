...
MonitoringConfig::MonitoringConfig(JsonView jsonValue) { *this = jsonValue; }
...
MonitoringConfig& MonitoringConfig::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("audioMonitoringSettings")) {
    ...
    for (unsigned audioMonitoringSettingsIndex = 0; audioMonitoringSettingsIndex < audioMonitoringSettingsJsonList.GetLength();
         ++audioMonitoringSettingsIndex) {
  ...
  if (jsonValue.ValueExists("contentQualityAnalysisState")) {
    m_contentQualityAnalysisState =
        ContentQualityAnalysisStateMapper::GetContentQualityAnalysisStateForName(jsonValue.GetString("contentQualityAnalysisState"));
  ...
  if (jsonValue.ValueExists("videoMonitoringSettings")) {
    ...
    for (unsigned videoMonitoringSettingsIndex = 0; videoMonitoringSettingsIndex < videoMonitoringSettingsJsonList.GetLength();
         ++videoMonitoringSettingsIndex) {
...
JsonValue MonitoringConfig::Jsonize() const {
  ...
  if (m_audioMonitoringSettingsHasBeenSet) {
    ...
    for (unsigned audioMonitoringSettingsIndex = 0; audioMonitoringSettingsIndex < audioMonitoringSettingsJsonList.GetLength();
         ++audioMonitoringSettingsIndex) {
      audioMonitoringSettingsJsonList[audioMonitoringSettingsIndex].AsObject(
          m_audioMonitoringSettings[audioMonitoringSettingsIndex].Jsonize());
    }
  ...
  if (m_contentQualityAnalysisStateHasBeenSet) {
    payload.WithString("contentQualityAnalysisState",
                       ContentQualityAnalysisStateMapper::GetNameForContentQualityAnalysisState(m_contentQualityAnalysisState));
  }
  ...
  if (m_videoMonitoringSettingsHasBeenSet) {
    ...
    for (unsigned videoMonitoringSettingsIndex = 0; videoMonitoringSettingsIndex < videoMonitoringSettingsJsonList.GetLength();
         ++videoMonitoringSettingsIndex) {
      videoMonitoringSettingsJsonList[videoMonitoringSettingsIndex].AsObject(
          m_videoMonitoringSettings[videoMonitoringSettingsIndex].Jsonize());
    }
