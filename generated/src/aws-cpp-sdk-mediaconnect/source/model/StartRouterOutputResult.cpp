...
StartRouterOutputResult::StartRouterOutputResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartRouterOutputResult& StartRouterOutputResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
