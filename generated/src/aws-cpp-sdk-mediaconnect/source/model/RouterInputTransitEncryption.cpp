...
RouterInputTransitEncryption::RouterInputTransitEncryption(JsonView jsonValue) { *this = jsonValue; }

RouterInputTransitEncryption& RouterInputTransitEncryption::operator=(JsonView jsonValue) {
  if (jsonValue.ValueExists("encryptionKeyType")) {
    m_encryptionKeyType =
        RouterInputTransitEncryptionKeyTypeMapper::GetRouterInputTransitEncryptionKeyTypeForName(jsonValue.GetString("encryptionKeyType"));
...
JsonValue RouterInputTransitEncryption::Jsonize() const {
  JsonValue payload;

  if (m_encryptionKeyTypeHasBeenSet) {
    payload.WithString("encryptionKeyType",
                       RouterInputTransitEncryptionKeyTypeMapper::GetNameForRouterInputTransitEncryptionKeyType(m_encryptionKeyType));
  }
