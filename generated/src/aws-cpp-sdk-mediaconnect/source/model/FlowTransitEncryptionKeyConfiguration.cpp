...
FlowTransitEncryptionKeyConfiguration::FlowTransitEncryptionKeyConfiguration(JsonView jsonValue) { *this = jsonValue; }

FlowTransitEncryptionKeyConfiguration& FlowTransitEncryptionKeyConfiguration::operator=(JsonView jsonValue) {
...
JsonValue FlowTransitEncryptionKeyConfiguration::Jsonize() const {
  JsonValue payload;
