...
RouterInputStreamDetails::RouterInputStreamDetails(JsonView jsonValue) { *this = jsonValue; }

RouterInputStreamDetails& RouterInputStreamDetails::operator=(JsonView jsonValue) {
...
JsonValue RouterInputStreamDetails::Jsonize() const {
  JsonValue payload;
