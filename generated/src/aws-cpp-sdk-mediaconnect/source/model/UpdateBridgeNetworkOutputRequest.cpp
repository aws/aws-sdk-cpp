...
UpdateBridgeNetworkOutputRequest::UpdateBridgeNetworkOutputRequest(JsonView jsonValue) { *this = jsonValue; }

UpdateBridgeNetworkOutputRequest& UpdateBridgeNetworkOutputRequest::operator=(JsonView jsonValue) {
...
JsonValue UpdateBridgeNetworkOutputRequest::Jsonize() const {
  JsonValue payload;
