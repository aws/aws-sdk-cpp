...
FailoverRouterInputProtocolConfiguration::FailoverRouterInputProtocolConfiguration(JsonView jsonValue) { *this = jsonValue; }

FailoverRouterInputProtocolConfiguration& FailoverRouterInputProtocolConfiguration::operator=(JsonView jsonValue) {
...
JsonValue FailoverRouterInputProtocolConfiguration::Jsonize() const {
  JsonValue payload;
