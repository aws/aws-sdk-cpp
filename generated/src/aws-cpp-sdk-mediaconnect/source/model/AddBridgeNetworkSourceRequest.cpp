...
AddBridgeNetworkSourceRequest::AddBridgeNetworkSourceRequest(JsonView jsonValue) { *this = jsonValue; }

AddBridgeNetworkSourceRequest& AddBridgeNetworkSourceRequest::operator=(JsonView jsonValue) {
...
JsonValue AddBridgeNetworkSourceRequest::Jsonize() const {
  JsonValue payload;
