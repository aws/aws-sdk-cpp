...
BatchGetRouterNetworkInterfaceResult::BatchGetRouterNetworkInterfaceResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

BatchGetRouterNetworkInterfaceResult& BatchGetRouterNetworkInterfaceResult::operator=(
