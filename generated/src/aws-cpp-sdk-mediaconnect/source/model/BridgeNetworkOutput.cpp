...
BridgeNetworkOutput::BridgeNetworkOutput(JsonView jsonValue) { *this = jsonValue; }

BridgeNetworkOutput& BridgeNetworkOutput::operator=(JsonView jsonValue) {
...
JsonValue BridgeNetworkOutput::Jsonize() const {
  JsonValue payload;
