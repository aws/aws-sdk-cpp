...
FailoverRouterInputStreamDetails::FailoverRouterInputStreamDetails(JsonView jsonValue) { *this = jsonValue; }

FailoverRouterInputStreamDetails& FailoverRouterInputStreamDetails::operator=(JsonView jsonValue) {
...
JsonValue FailoverRouterInputStreamDetails::Jsonize() const {
  JsonValue payload;
