...
SilentAudioConfiguration::SilentAudioConfiguration(JsonView jsonValue) { *this = jsonValue; }

SilentAudioConfiguration& SilentAudioConfiguration::operator=(JsonView jsonValue) {
...
JsonValue SilentAudioConfiguration::Jsonize() const {
  JsonValue payload;
