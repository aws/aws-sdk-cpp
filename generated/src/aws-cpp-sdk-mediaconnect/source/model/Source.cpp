...
Source& Source::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("mediaStreamSourceConfigurations")) {
    ...
    for (unsigned mediaStreamSourceConfigurationsIndex = 0;
         mediaStreamSourceConfigurationsIndex < mediaStreamSourceConfigurationsJsonList.GetLength();
         ++mediaStreamSourceConfigurationsIndex) {
  ...
  if (jsonValue.ValueExists("routerIntegrationTransitDecryption")) {
    m_routerIntegrationTransitDecryption = jsonValue.GetObject("routerIntegrationTransitDecryption");
    m_routerIntegrationTransitDecryptionHasBeenSet = true;
  }
  if (jsonValue.ValueExists("connectedRouterOutputArn")) {
    m_connectedRouterOutputArn = jsonValue.GetString("connectedRouterOutputArn");
...
JsonValue Source::Jsonize() const {
  ...
  if (m_mediaStreamSourceConfigurationsHasBeenSet) {
    ...
    for (unsigned mediaStreamSourceConfigurationsIndex = 0;
         mediaStreamSourceConfigurationsIndex < mediaStreamSourceConfigurationsJsonList.GetLength();
         ++mediaStreamSourceConfigurationsIndex) {
      mediaStreamSourceConfigurationsJsonList[mediaStreamSourceConfigurationsIndex].AsObject(
          m_mediaStreamSourceConfigurations[mediaStreamSourceConfigurationsIndex].Jsonize());
    }
  ...
  if (m_connectedRouterOutputArnHasBeenSet) {
    payload.WithString("connectedRouterOutputArn", m_connectedRouterOutputArn);
  }
