...
SrtDecryptionConfiguration::SrtDecryptionConfiguration(JsonView jsonValue) { *this = jsonValue; }

SrtDecryptionConfiguration& SrtDecryptionConfiguration::operator=(JsonView jsonValue) {
...
JsonValue SrtDecryptionConfiguration::Jsonize() const {
  JsonValue payload;
