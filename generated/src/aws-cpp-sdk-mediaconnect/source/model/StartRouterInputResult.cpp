...
StartRouterInputResult::StartRouterInputResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StartRouterInputResult& StartRouterInputResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
