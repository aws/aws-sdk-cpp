...
RouterOutputConfiguration::RouterOutputConfiguration(JsonView jsonValue) { *this = jsonValue; }

RouterOutputConfiguration& RouterOutputConfiguration::operator=(JsonView jsonValue) {
...
JsonValue RouterOutputConfiguration::Jsonize() const {
  JsonValue payload;
