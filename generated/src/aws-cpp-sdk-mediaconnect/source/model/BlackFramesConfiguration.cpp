...
BlackFramesConfiguration::BlackFramesConfiguration(JsonView jsonValue) { *this = jsonValue; }

BlackFramesConfiguration& BlackFramesConfiguration::operator=(JsonView jsonValue) {
...
JsonValue BlackFramesConfiguration::Jsonize() const {
  JsonValue payload;
