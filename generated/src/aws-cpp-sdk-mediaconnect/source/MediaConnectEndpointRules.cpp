...
{
const size_t MediaConnectEndpointRules::RulesBlobStrLen = 3748;
const size_t MediaConnectEndpointRules::RulesBlobSize = 3749;
...
't','t','p','s',':','/','/','m','e','d','i','a','c','o','n','n','e','c','t','-','f','i','p','s','.',
...
const char* MediaConnectEndpointRules::GetRulesBlob()
{
