...
namespace Model
{
  ...
  public:
    ...
    template<typename BridgeArnT = Aws::String>
    UpdateGatewayBridgeSourceRequest& WithBridgeArn(BridgeArnT&& value) { SetBridgeArn(std::forward<BridgeArnT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcInterfaceAttachmentT = VpcInterfaceAttachment>
    UpdateGatewayBridgeSourceRequest& WithVpcInterfaceAttachment(VpcInterfaceAttachmentT&& value) { SetVpcInterfaceAttachment(std::forward<VpcInterfaceAttachmentT>(value)); return *this;}
    ///@}
  private:
