...
class ResourceSpecification {
 public:
  ...
  inline void SetReservedBitrate(int value) {
    m_reservedBitrateHasBeenSet = true;
    m_reservedBitrate = value;
  }
  inline ResourceSpecification& WithReservedBitrate(int value) {
    SetReservedBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceSpecification& WithResourceType(ResourceType value) {
