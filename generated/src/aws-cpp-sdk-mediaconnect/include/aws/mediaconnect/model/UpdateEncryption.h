...
namespace Model
{
  ...
  public:
    ...
    inline UpdateEncryption& WithAlgorithm(Algorithm value) { SetAlgorithm(value); return *this;}
    ///@}
    ...
    template<typename ConstantInitializationVectorT = Aws::String>
    UpdateEncryption& WithConstantInitializationVector(ConstantInitializationVectorT&& value) { SetConstantInitializationVector(std::forward<ConstantInitializationVectorT>(value)); return *this;}
    ///@}
    ...
    template<typename DeviceIdT = Aws::String>
    UpdateEncryption& WithDeviceId(DeviceIdT&& value) { SetDeviceId(std::forward<DeviceIdT>(value)); return *this;}
    ///@}
    ...
    inline UpdateEncryption& WithKeyType(KeyType value) { SetKeyType(value); return *this;}
    ///@}
    ...
    template<typename RegionT = Aws::String>
    UpdateEncryption& WithRegion(RegionT&& value) { SetRegion(std::forward<RegionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    UpdateEncryption& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RoleArnT = Aws::String>
    UpdateEncryption& WithRoleArn(RoleArnT&& value) { SetRoleArn(std::forward<RoleArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SecretArnT = Aws::String>
    UpdateEncryption& WithSecretArn(SecretArnT&& value) { SetSecretArn(std::forward<SecretArnT>(value)); return *this;}
    ///@}
    ...
    template<typename UrlT = Aws::String>
    UpdateEncryption& WithUrl(UrlT&& value) { SetUrl(std::forward<UrlT>(value)); return *this;}
    ///@}
  private:
