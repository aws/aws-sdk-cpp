...
class IngressGatewayBridge {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  IngressGatewayBridge& WithInstanceId(InstanceIdT&& value) {
  ...
  inline IngressGatewayBridge& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxOutputs(int value) {
    m_maxOutputsHasBeenSet = true;
    m_maxOutputs = value;
  }
  inline IngressGatewayBridge& WithMaxOutputs(int value) {
    SetMaxOutputs(value);
    return *this;
  }
  ///@}
