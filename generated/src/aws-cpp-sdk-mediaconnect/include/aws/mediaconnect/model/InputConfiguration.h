...
class InputConfiguration {
 public:
  ...
  void SetInputIp(InputIpT&& value) {
    m_inputIpHasBeenSet = true;
    m_inputIp = std::forward<InputIpT>(value);
  }
  template <typename InputIpT = Aws::String>
  InputConfiguration& WithInputIp(InputIpT&& value) {
    SetInputIp(std::forward<InputIpT>(value));
    return *this;
  }
  ///@}
  ...
  inline InputConfiguration& WithInputPort(int value) {
    SetInputPort(value);
    return *this;
  }
  ///@}
