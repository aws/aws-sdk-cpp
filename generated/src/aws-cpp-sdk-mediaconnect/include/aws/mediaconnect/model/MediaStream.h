...
class MediaStream {
 public:
  ...
  inline MediaStream& WithClockRate(int value) {
    SetClockRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFmt(int value) {
    m_fmtHasBeenSet = true;
    m_fmt = value;
  }
  inline MediaStream& WithFmt(int value) {
    SetFmt(value);
    return *this;
  }
  ///@}
  ...
  inline MediaStream& WithMediaStreamId(int value) {
  ...
  inline MediaStream& WithMediaStreamType(MediaStreamType value) {
