...
class Fmtp {
 public:
  ...
  void SetChannelOrder(ChannelOrderT&& value) {
    ...
    m_channelOrder = std::forward<ChannelOrderT>(value);
  }
  template <typename ChannelOrderT = Aws::String>
  Fmtp& WithChannelOrder(ChannelOrderT&& value) {
    SetChannelOrder(std::forward<ChannelOrderT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetColorimetry(Colorimetry value) {
    m_colorimetryHasBeenSet = true;
    m_colorimetry = value;
  }
  inline Fmtp& WithColorimetry(Colorimetry value) {
  ...
  void SetExactFramerate(ExactFramerateT&& value) {
    ...
    m_exactFramerate = std::forward<ExactFramerateT>(value);
  }
  template <typename ExactFramerateT = Aws::String>
  Fmtp& WithExactFramerate(ExactFramerateT&& value) {
    SetExactFramerate(std::forward<ExactFramerateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPar(ParT&& value) {
    ...
    m_par = std::forward<ParT>(value);
  }
  template <typename ParT = Aws::String>
  Fmtp& WithPar(ParT&& value) {
    SetPar(std::forward<ParT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetRange(Range value) {
    m_rangeHasBeenSet = true;
    m_range = value;
  }
  inline Fmtp& WithRange(Range value) {
    SetRange(value);
    return *this;
  }
  ///@}
  ...
  inline Fmtp& WithScanMode(ScanMode value) {
    SetScanMode(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTcs(Tcs value) {
    m_tcsHasBeenSet = true;
    m_tcs = value;
  }
  inline Fmtp& WithTcs(Tcs value) {
    SetTcs(value);
    return *this;
  }
  ///@}
