...
class UpdateFlowEntitlementRequest : public MediaConnectRequest {
 public:
  ...
  inline void SetEntitlementStatus(EntitlementStatus value) {
    m_entitlementStatusHasBeenSet = true;
    m_entitlementStatus = value;
  }
  inline UpdateFlowEntitlementRequest& WithEntitlementStatus(EntitlementStatus value) {
    SetEntitlementStatus(value);
    return *this;
  }
  ///@}
