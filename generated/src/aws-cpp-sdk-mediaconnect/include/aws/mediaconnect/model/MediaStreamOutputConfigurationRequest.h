...
class MediaStreamOutputConfigurationRequest {
 public:
  ...
  template <typename DestinationConfigurationsT = Aws::Vector<DestinationConfigurationRequest>>
  MediaStreamOutputConfigurationRequest& WithDestinationConfigurations(DestinationConfigurationsT&& value) {
  ...
  MediaStreamOutputConfigurationRequest& AddDestinationConfigurations(DestinationConfigurationsT&& value) {
    m_destinationConfigurationsHasBeenSet = true;
    m_destinationConfigurations.emplace_back(std::forward<DestinationConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline MediaStreamOutputConfigurationRequest& WithEncodingName(EncodingName value) {
  ...
  void SetEncodingParameters(EncodingParametersT&& value) {
    m_encodingParametersHasBeenSet = true;
    m_encodingParameters = std::forward<EncodingParametersT>(value);
  }
  template <typename EncodingParametersT = EncodingParametersRequest>
  MediaStreamOutputConfigurationRequest& WithEncodingParameters(EncodingParametersT&& value) {
    SetEncodingParameters(std::forward<EncodingParametersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename MediaStreamNameT = Aws::String>
  MediaStreamOutputConfigurationRequest& WithMediaStreamName(MediaStreamNameT&& value) {
