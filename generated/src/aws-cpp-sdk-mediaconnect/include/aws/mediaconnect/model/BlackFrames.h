...
/**
 * <p> Configures settings for the <code>BlackFrames</code> metric.</p><p><h3>See
 * Also:</h3>   <a
...
class BlackFrames {
 public:
  ...
  inline BlackFrames& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p> Specifies the number of consecutive seconds of black frames that triggers an
   * event or alert.</p>
   */
  ...
  inline BlackFrames& WithThresholdSeconds(int value) {
