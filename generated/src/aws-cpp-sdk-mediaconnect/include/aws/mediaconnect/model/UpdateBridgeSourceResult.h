...
class UpdateBridgeSourceResult {
 public:
  ...
  template <typename BridgeArnT = Aws::String>
  UpdateBridgeSourceResult& WithBridgeArn(BridgeArnT&& value) {
  ...
  template <typename SourceT = BridgeSource>
  UpdateBridgeSourceResult& WithSource(SourceT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateBridgeSourceResult& WithRequestId(RequestIdT&& value) {
