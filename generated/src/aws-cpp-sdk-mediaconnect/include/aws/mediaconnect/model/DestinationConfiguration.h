...
class DestinationConfiguration {
 public:
  ...
  inline DestinationConfiguration& WithDestinationPort(int value) {
  ...
  void SetInterface(InterfaceT&& value) {
    m_interfaceHasBeenSet = true;
    m_interface = std::forward<InterfaceT>(value);
  }
  template <typename InterfaceT = Interface>
  DestinationConfiguration& WithInterface(InterfaceT&& value) {
    SetInterface(std::forward<InterfaceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutboundIp(OutboundIpT&& value) {
    m_outboundIpHasBeenSet = true;
    m_outboundIp = std::forward<OutboundIpT>(value);
  }
  template <typename OutboundIpT = Aws::String>
  DestinationConfiguration& WithOutboundIp(OutboundIpT&& value) {
    SetOutboundIp(std::forward<OutboundIpT>(value));
    return *this;
  }
  ///@}
 private:
