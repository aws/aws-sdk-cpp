...
class CreateFlowRequest : public MediaConnectRequest {
 public:
  ...
  inline CreateFlowRequest& WithFlowSize(FlowSize value) {
    SetFlowSize(value);
    return *this;
  }
  ///@}
  ...
  void SetFlowTags(FlowTagsT&& value) {
    m_flowTagsHasBeenSet = true;
    m_flowTags = std::forward<FlowTagsT>(value);
  }
  template <typename FlowTagsT = Aws::Map<Aws::String, Aws::String>>
  CreateFlowRequest& WithFlowTags(FlowTagsT&& value) {
    SetFlowTags(std::forward<FlowTagsT>(value));
    return *this;
  }
  ...
  CreateFlowRequest& AddFlowTags(FlowTagsKeyT&& key, FlowTagsValueT&& value) {
    m_flowTagsHasBeenSet = true;
    m_flowTags.emplace(std::forward<FlowTagsKeyT>(key), std::forward<FlowTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
