...
class FailoverConfig {
 public:
  ...
  inline FailoverConfig& WithFailoverMode(FailoverMode value) {
  ...
  inline FailoverConfig& WithRecoveryWindow(int value) {
  ...
  inline FailoverConfig& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
