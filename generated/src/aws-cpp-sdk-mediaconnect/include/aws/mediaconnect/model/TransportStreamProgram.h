...
class TransportStreamProgram {
 public:
  ...
  inline TransportStreamProgram& WithPcrPid(int value) {
    SetPcrPid(value);
    return *this;
  }
  ///@}
  ...
  inline TransportStreamProgram& WithProgramNumber(int value) {
  ...
  inline void SetProgramPid(int value) {
    m_programPidHasBeenSet = true;
    m_programPid = value;
  }
  inline TransportStreamProgram& WithProgramPid(int value) {
    SetProgramPid(value);
    return *this;
  }
  ///@}
