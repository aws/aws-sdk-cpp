...
namespace Model
{
  ...
  /**
   */
  class ListReservationsRequest : public MediaConnectRequest
  {
  public:
    AWS_MEDIACONNECT_API ListReservationsRequest() = default;
     ...
     * example, you submit a <code>ListReservations</code> request with
     ...
     * NextToken value that you can use to fetch the next batch of results.) </p>
     * <p>The service might return fewer results than the <code>MaxResults</code>
     * value. If <code>MaxResults</code> is not included in the request, the service
     * defaults to pagination with a maximum of 10 results per page.</p>
     */
