...
class NdiDiscoveryServerConfig {
 public:
  ...
  void SetDiscoveryServerAddress(DiscoveryServerAddressT&& value) {
    m_discoveryServerAddressHasBeenSet = true;
    m_discoveryServerAddress = std::forward<DiscoveryServerAddressT>(value);
  }
  template <typename DiscoveryServerAddressT = Aws::String>
  NdiDiscoveryServerConfig& WithDiscoveryServerAddress(DiscoveryServerAddressT&& value) {
    SetDiscoveryServerAddress(std::forward<DiscoveryServerAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDiscoveryServerPort(int value) {
    m_discoveryServerPortHasBeenSet = true;
    m_discoveryServerPort = value;
  }
  inline NdiDiscoveryServerConfig& WithDiscoveryServerPort(int value) {
    SetDiscoveryServerPort(value);
    return *this;
  }
  ///@}
  ...
  void SetVpcInterfaceAdapter(VpcInterfaceAdapterT&& value) {
    m_vpcInterfaceAdapterHasBeenSet = true;
    m_vpcInterfaceAdapter = std::forward<VpcInterfaceAdapterT>(value);
  }
  template <typename VpcInterfaceAdapterT = Aws::String>
  NdiDiscoveryServerConfig& WithVpcInterfaceAdapter(VpcInterfaceAdapterT&& value) {
    SetVpcInterfaceAdapter(std::forward<VpcInterfaceAdapterT>(value));
    return *this;
  }
  ///@}
 private:
