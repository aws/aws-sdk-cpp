...
class EncodingParameters {
 public:
  ...
  inline void SetCompressionFactor(double value) {
    m_compressionFactorHasBeenSet = true;
    m_compressionFactor = value;
  }
  inline EncodingParameters& WithCompressionFactor(double value) {
    SetCompressionFactor(value);
    return *this;
  }
  ///@}
   ...
   * JPEG XS protocol, with a flow source that uses the CDI protocol.</p>
   */
  ...
  inline void SetEncoderProfile(EncoderProfile value) {
    m_encoderProfileHasBeenSet = true;
    m_encoderProfile = value;
  }
  inline EncodingParameters& WithEncoderProfile(EncoderProfile value) {
    SetEncoderProfile(value);
    return *this;
  }
  ///@}
 private:
