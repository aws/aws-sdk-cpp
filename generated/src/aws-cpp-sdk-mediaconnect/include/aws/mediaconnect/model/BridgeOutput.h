...
class BridgeOutput {
 public:
  ...
  void SetFlowOutput(FlowOutputT&& value) {
    m_flowOutputHasBeenSet = true;
    m_flowOutput = std::forward<FlowOutputT>(value);
  }
  template <typename FlowOutputT = BridgeFlowOutput>
  BridgeOutput& WithFlowOutput(FlowOutputT&& value) {
    SetFlowOutput(std::forward<FlowOutputT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNetworkOutput(NetworkOutputT&& value) {
    m_networkOutputHasBeenSet = true;
    m_networkOutput = std::forward<NetworkOutputT>(value);
  }
  template <typename NetworkOutputT = BridgeNetworkOutput>
  BridgeOutput& WithNetworkOutput(NetworkOutputT&& value) {
    SetNetworkOutput(std::forward<NetworkOutputT>(value));
    return *this;
  }
  ///@}
 private:
