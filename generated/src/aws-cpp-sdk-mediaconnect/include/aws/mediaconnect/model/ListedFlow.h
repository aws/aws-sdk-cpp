...
class ListedFlow {
 public:
  ...
  template <typename AvailabilityZoneT = Aws::String>
  ListedFlow& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  ListedFlow& WithDescription(DescriptionT&& value) {
  ...
  template <typename FlowArnT = Aws::String>
  ListedFlow& WithFlowArn(FlowArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ListedFlow& WithName(NameT&& value) {
  ...
  inline ListedFlow& WithSourceType(SourceType value) {
    SetSourceType(value);
    return *this;
  }
  ///@}
  ...
  inline ListedFlow& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename MaintenanceT = Maintenance>
  ListedFlow& WithMaintenance(MaintenanceT&& value) {
