...
class ListedEntitlement {
 public:
  ...
  inline ListedEntitlement& WithDataTransferSubscriberFeePercent(int value) {
  ...
  template <typename EntitlementArnT = Aws::String>
  ListedEntitlement& WithEntitlementArn(EntitlementArnT&& value) {
  ...
  template <typename EntitlementNameT = Aws::String>
  ListedEntitlement& WithEntitlementName(EntitlementNameT&& value) {
