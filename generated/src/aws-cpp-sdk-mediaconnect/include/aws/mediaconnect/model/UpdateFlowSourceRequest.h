...
class UpdateFlowSourceRequest : public MediaConnectRequest {
 public:
  ...
  inline UpdateFlowSourceRequest& WithIngestPort(int value) {
    SetIngestPort(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFlowSourceRequest& WithMaxBitrate(int value) {
    SetMaxBitrate(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFlowSourceRequest& WithMaxLatency(int value) {
    SetMaxLatency(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFlowSourceRequest& WithMaxSyncBuffer(int value) {
  ...
  inline UpdateFlowSourceRequest& WithMinLatency(int value) {
    SetMinLatency(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFlowSourceRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateFlowSourceRequest& WithSenderControlPort(int value) {
  ...
  inline UpdateFlowSourceRequest& WithSourceListenerPort(int value) {
