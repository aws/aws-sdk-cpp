...
class Output {
 public:
  ...
  inline Output& WithDataTransferSubscriberFeePercent(int value) {
  ...
  void SetListenerAddress(ListenerAddressT&& value) {
    ...
    m_listenerAddress = std::forward<ListenerAddressT>(value);
  }
  template <typename ListenerAddressT = Aws::String>
  Output& WithListenerAddress(ListenerAddressT&& value) {
    SetListenerAddress(std::forward<ListenerAddressT>(value));
    return *this;
  }
  ///@}
   ...
   * output.</p>
   */
  inline const Aws::Vector<MediaStreamOutputConfiguration>& GetMediaStreamOutputConfigurations() const {
  ...
  inline Output& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  void SetBridgePorts(BridgePortsT&& value) {
    ...
    m_bridgePorts = std::forward<BridgePortsT>(value);
  }
  template <typename BridgePortsT = Aws::Vector<int>>
  Output& WithBridgePorts(BridgePortsT&& value) {
    SetBridgePorts(std::forward<BridgePortsT>(value));
    return *this;
  }
  inline Output& AddBridgePorts(int value) {
    m_bridgePortsHasBeenSet = true;
    m_bridgePorts.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline Output& WithOutputStatus(OutputStatus value) {
