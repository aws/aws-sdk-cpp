...
/**
 */
class CreateRouterOutputRequest : public MediaConnectRequest {
 public:
  AWS_MEDIACONNECT_API CreateRouterOutputRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateRouterOutput"; }
  ...
  template <typename NameT = Aws::String>
  CreateRouterOutputRequest& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = RouterOutputConfiguration>
  CreateRouterOutputRequest& WithConfiguration(ConfigurationT&& value) {
  ...
  inline CreateRouterOutputRequest& WithMaximumBitrate(long long value) {
  ...
  inline CreateRouterOutputRequest& WithRoutingScope(RoutingScope value) {
  ...
  inline CreateRouterOutputRequest& WithTier(RouterOutputTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The Amazon Web Services Region for the router output. Defaults to the current
  ...
  template <typename RegionNameT = Aws::String>
  CreateRouterOutputRequest& WithRegionName(RegionNameT&& value) {
  ...
  ///@{
  /**
   * <p>The Availability Zone where you want to create the router output. This must
   * be a valid Availability Zone for the region specified by
   * <code>regionName</code>, or the current region if no <code>regionName</code> is
   * provided. </p>
   */
  ...
  template <typename AvailabilityZoneT = Aws::String>
  CreateRouterOutputRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  ///@{
  /**
   * <p>The maintenance configuration settings for the router output, including
  ...
  template <typename MaintenanceConfigurationT = MaintenanceConfiguration>
  CreateRouterOutputRequest& WithMaintenanceConfiguration(MaintenanceConfigurationT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRouterOutputRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateRouterOutputRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRouterOutputRequest& WithClientToken(ClientTokenT&& value) {
