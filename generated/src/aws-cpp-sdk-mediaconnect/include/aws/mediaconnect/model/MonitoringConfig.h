...
class MonitoringConfig {
 public:
  ...
  inline void SetThumbnailState(ThumbnailState value) {
    m_thumbnailStateHasBeenSet = true;
    m_thumbnailState = value;
  }
  inline MonitoringConfig& WithThumbnailState(ThumbnailState value) {
  ...
  void SetAudioMonitoringSettings(AudioMonitoringSettingsT&& value) {
    ...
    m_audioMonitoringSettings = std::forward<AudioMonitoringSettingsT>(value);
  }
  template <typename AudioMonitoringSettingsT = Aws::Vector<AudioMonitoringSetting>>
  MonitoringConfig& WithAudioMonitoringSettings(AudioMonitoringSettingsT&& value) {
    SetAudioMonitoringSettings(std::forward<AudioMonitoringSettingsT>(value));
    return *this;
  }
  ...
  MonitoringConfig& AddAudioMonitoringSettings(AudioMonitoringSettingsT&& value) {
    m_audioMonitoringSettingsHasBeenSet = true;
    m_audioMonitoringSettings.emplace_back(std::forward<AudioMonitoringSettingsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetContentQualityAnalysisState(ContentQualityAnalysisState value) {
    m_contentQualityAnalysisStateHasBeenSet = true;
    m_contentQualityAnalysisState = value;
  }
  inline MonitoringConfig& WithContentQualityAnalysisState(ContentQualityAnalysisState value) {
    SetContentQualityAnalysisState(value);
    return *this;
  }
  ///@}
  ...
  void SetVideoMonitoringSettings(VideoMonitoringSettingsT&& value) {
    ...
    m_videoMonitoringSettings = std::forward<VideoMonitoringSettingsT>(value);
  }
  template <typename VideoMonitoringSettingsT = Aws::Vector<VideoMonitoringSetting>>
  MonitoringConfig& WithVideoMonitoringSettings(VideoMonitoringSettingsT&& value) {
    SetVideoMonitoringSettings(std::forward<VideoMonitoringSettingsT>(value));
    return *this;
  }
  ...
  MonitoringConfig& AddVideoMonitoringSettings(VideoMonitoringSettingsT&& value) {
    m_videoMonitoringSettingsHasBeenSet = true;
    m_videoMonitoringSettings.emplace_back(std::forward<VideoMonitoringSettingsT>(value));
    return *this;
  }
  ///@}
 private:
