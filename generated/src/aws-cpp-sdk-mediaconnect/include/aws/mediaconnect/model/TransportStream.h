...
class TransportStream {
 public:
  ...
  inline TransportStream& WithChannels(int value) {
    SetChannels(value);
    return *this;
  }
  ///@}
  ...
  inline TransportStream& WithPid(int value) {
    SetPid(value);
    return *this;
  }
  ///@}
  ...
  inline TransportStream& WithSampleRate(int value) {
    SetSampleRate(value);
    return *this;
  }
  ///@}
  ...
  inline TransportStream& WithSampleSize(int value) {
    SetSampleSize(value);
    return *this;
  }
  ///@}
