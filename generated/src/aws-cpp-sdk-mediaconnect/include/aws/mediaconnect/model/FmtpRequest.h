...
class FmtpRequest {
 public:
  ...
  inline FmtpRequest& WithColorimetry(Colorimetry value) {
  ...
  inline FmtpRequest& WithRange(Range value) {
    SetRange(value);
    return *this;
  }
  ///@}
  ...
  inline FmtpRequest& WithScanMode(ScanMode value) {
    SetScanMode(value);
    return *this;
  }
  ///@}
  ...
  inline FmtpRequest& WithTcs(Tcs value) {
    SetTcs(value);
    return *this;
  }
  ///@}
