...
class Bridge {
 public:
  ...
  void SetBridgeMessages(BridgeMessagesT&& value) {
    ...
    m_bridgeMessages = std::forward<BridgeMessagesT>(value);
  }
  template <typename BridgeMessagesT = Aws::Vector<MessageDetail>>
  Bridge& WithBridgeMessages(BridgeMessagesT&& value) {
    SetBridgeMessages(std::forward<BridgeMessagesT>(value));
    return *this;
  }
  template <typename BridgeMessagesT = MessageDetail>
  Bridge& AddBridgeMessages(BridgeMessagesT&& value) {
    m_bridgeMessagesHasBeenSet = true;
    m_bridgeMessages.emplace_back(std::forward<BridgeMessagesT>(value));
    return *this;
  }
  ///@}
  ...
  inline Bridge& WithBridgeState(BridgeState value) {
