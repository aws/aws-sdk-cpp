...
class AddFlowOutputsResult {
 public:
  ...
  template <typename FlowArnT = Aws::String>
  AddFlowOutputsResult& WithFlowArn(FlowArnT&& value) {
  ...
  template <typename OutputsT = Aws::Vector<Output>>
  AddFlowOutputsResult& WithOutputs(OutputsT&& value) {
    SetOutputs(std::forward<OutputsT>(value));
    return *this;
  }
  template <typename OutputsT = Output>
  AddFlowOutputsResult& AddOutputs(OutputsT&& value) {
    m_outputsHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AddFlowOutputsResult& WithRequestId(RequestIdT&& value) {
