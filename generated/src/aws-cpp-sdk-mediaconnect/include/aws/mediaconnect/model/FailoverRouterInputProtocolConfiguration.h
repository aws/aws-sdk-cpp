...
/**
 * <p>Protocol configuration settings for failover router inputs.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/FailoverRouterInputProtocolConfiguration">AWS
 * API Reference</a></p>
 */
class FailoverRouterInputProtocolConfiguration {
 public:
  AWS_MEDIACONNECT_API FailoverRouterInputProtocolConfiguration() = default;
  AWS_MEDIACONNECT_API FailoverRouterInputProtocolConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONNECT_API FailoverRouterInputProtocolConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  template <typename RistT = RistRouterInputConfiguration>
  FailoverRouterInputProtocolConfiguration& WithRist(RistT&& value) {
  ...
  template <typename SrtListenerT = SrtListenerRouterInputConfiguration>
  FailoverRouterInputProtocolConfiguration& WithSrtListener(SrtListenerT&& value) {
  ...
  template <typename SrtCallerT = SrtCallerRouterInputConfiguration>
  FailoverRouterInputProtocolConfiguration& WithSrtCaller(SrtCallerT&& value) {
