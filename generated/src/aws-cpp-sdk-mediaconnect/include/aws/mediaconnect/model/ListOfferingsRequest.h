...
namespace Model
{
  ...
  /**
   */
  class ListOfferingsRequest : public MediaConnectRequest
  {
  public:
    AWS_MEDIACONNECT_API ListOfferingsRequest() = default;
     ...
     * example, you submit a <code>ListOfferings</code> request with
