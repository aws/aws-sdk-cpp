...
/**
 * <p>Add a network output to an existing bridge. </p><p><h3>See Also:</h3>   <a
...
class AddBridgeNetworkOutputRequest {
 public:
  ...
  template <typename IpAddressT = Aws::String>
  AddBridgeNetworkOutputRequest& WithIpAddress(IpAddressT&& value) {
  ...
  ///@{
  /**
   * <p> The network output name. This name is used to reference the output and must
   * be unique among outputs in this bridge. </p>
   */
  ...
  template <typename NameT = Aws::String>
  AddBridgeNetworkOutputRequest& WithName(NameT&& value) {
  ...
  template <typename NetworkNameT = Aws::String>
  AddBridgeNetworkOutputRequest& WithNetworkName(NetworkNameT&& value) {
  ...
  inline AddBridgeNetworkOutputRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline AddBridgeNetworkOutputRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline AddBridgeNetworkOutputRequest& WithTtl(int value) {
    SetTtl(value);
    return *this;
  }
  ///@}
