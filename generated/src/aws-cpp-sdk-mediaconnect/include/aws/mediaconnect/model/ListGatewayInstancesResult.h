...
class ListGatewayInstancesResult {
 public:
  ...
  template <typename InstancesT = Aws::Vector<ListedGatewayInstance>>
  ListGatewayInstancesResult& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = ListedGatewayInstance>
  ListGatewayInstancesResult& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListGatewayInstancesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  ListGatewayInstancesResult& WithRequestId(RequestIdT&& value) {
