...
class MediaStreamSourceConfiguration {
 public:
  ...
  inline MediaStreamSourceConfiguration& WithEncodingName(EncodingName value) {
  ...
  template <typename InputConfigurationsT = Aws::Vector<InputConfiguration>>
  MediaStreamSourceConfiguration& WithInputConfigurations(InputConfigurationsT&& value) {
    SetInputConfigurations(std::forward<InputConfigurationsT>(value));
    return *this;
  }
  template <typename InputConfigurationsT = InputConfiguration>
  MediaStreamSourceConfiguration& AddInputConfigurations(InputConfigurationsT&& value) {
    m_inputConfigurationsHasBeenSet = true;
  ...
  template <typename MediaStreamNameT = Aws::String>
  MediaStreamSourceConfiguration& WithMediaStreamName(MediaStreamNameT&& value) {
