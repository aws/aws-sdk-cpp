...
/**
 * <p>Detects black frames in the router input's source content and reports them
 * through a CloudWatch metric, an EventBridge event, and a router input
 * message.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/BlackFramesConfiguration">AWS
 * API Reference</a></p>
 */
class BlackFramesConfiguration {
 public:
  AWS_MEDIACONNECT_API BlackFramesConfiguration() = default;
  AWS_MEDIACONNECT_API BlackFramesConfiguration(Aws::Utils::Json::JsonView jsonValue);
  AWS_MEDIACONNECT_API BlackFramesConfiguration& operator=(Aws::Utils::Json::JsonView jsonValue);
  ...
  inline BlackFramesConfiguration& WithState(ContentQualityAnalysisState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The number of consecutive seconds of black frames that MediaConnect must
  ...
  inline BlackFramesConfiguration& WithThresholdSeconds(int value) {
