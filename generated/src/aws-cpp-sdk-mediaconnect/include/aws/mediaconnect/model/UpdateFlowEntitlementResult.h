...
class UpdateFlowEntitlementResult {
 public:
  ...
  template <typename EntitlementT = Entitlement>
  UpdateFlowEntitlementResult& WithEntitlement(EntitlementT&& value) {
  ...
  template <typename FlowArnT = Aws::String>
  UpdateFlowEntitlementResult& WithFlowArn(FlowArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateFlowEntitlementResult& WithRequestId(RequestIdT&& value) {
