...
class AddFlowSourcesResult {
 public:
  ...
  template <typename FlowArnT = Aws::String>
  AddFlowSourcesResult& WithFlowArn(FlowArnT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<Source>>
  AddFlowSourcesResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = Source>
  AddFlowSourcesResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AddFlowSourcesResult& WithRequestId(RequestIdT&& value) {
