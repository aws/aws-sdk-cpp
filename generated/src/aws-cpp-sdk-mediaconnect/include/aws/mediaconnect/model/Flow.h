...
class Flow {
 public:
  ...
  void SetEgressIp(EgressIpT&& value) {
    ...
    m_egressIp = std::forward<EgressIpT>(value);
  }
  template <typename EgressIpT = Aws::String>
  Flow& WithEgressIp(EgressIpT&& value) {
    SetEgressIp(std::forward<EgressIpT>(value));
    return *this;
  }
  ///@}
  ...
  inline Flow& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline Flow& WithFlowSize(FlowSize value) {
    SetFlowSize(value);
    return *this;
  }
  ///@}
