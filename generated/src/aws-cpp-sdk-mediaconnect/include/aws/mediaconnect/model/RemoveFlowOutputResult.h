...
class RemoveFlowOutputResult {
 public:
  ...
  template <typename FlowArnT = Aws::String>
  RemoveFlowOutputResult& WithFlowArn(FlowArnT&& value) {
  ...
  template <typename OutputArnT = Aws::String>
  RemoveFlowOutputResult& WithOutputArn(OutputArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RemoveFlowOutputResult& WithRequestId(RequestIdT&& value) {
