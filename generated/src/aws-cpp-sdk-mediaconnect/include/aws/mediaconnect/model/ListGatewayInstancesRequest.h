...
class ListGatewayInstancesRequest : public MediaConnectRequest {
 public:
  ...
  template <typename FilterArnT = Aws::String>
  ListGatewayInstancesRequest& WithFilterArn(FilterArnT&& value) {
  ...
  inline ListGatewayInstancesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListGatewayInstancesRequest& WithNextToken(NextTokenT&& value) {
