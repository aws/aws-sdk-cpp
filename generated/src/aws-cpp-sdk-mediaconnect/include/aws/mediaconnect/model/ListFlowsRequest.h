...
namespace Model
{
  ...
  {
  public:
    AWS_MEDIACONNECT_API ListFlowsRequest() = default;
     ...
     * example, you submit a <code>ListFlows</code> request with MaxResults set at 5.
     * Although 20 items match your request, the service returns no more than the first
     * 5 items. (The service also returns a <code>NextToken</code> value that you can
     * use to fetch the next batch of results.) </p> <p>The service might return fewer
     * results than the <code>MaxResults</code> value. If <code>MaxResults</code> is
     * not included in the request, the service defaults to pagination with a maximum
     * of 10 results per page.</p>
     */
