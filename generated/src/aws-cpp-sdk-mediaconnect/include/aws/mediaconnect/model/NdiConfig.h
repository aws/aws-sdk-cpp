...
class NdiConfig {
 public:
  ...
  inline void SetNdiState(NdiState value) {
    m_ndiStateHasBeenSet = true;
    m_ndiState = value;
  }
  inline NdiConfig& WithNdiState(NdiState value) {
    SetNdiState(value);
    return *this;
  }
  ///@}
  ...
  void SetMachineName(MachineNameT&& value) {
    ...
    m_machineName = std::forward<MachineNameT>(value);
  }
  template <typename MachineNameT = Aws::String>
  NdiConfig& WithMachineName(MachineNameT&& value) {
    SetMachineName(std::forward<MachineNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetNdiDiscoveryServers(NdiDiscoveryServersT&& value) {
    ...
    m_ndiDiscoveryServers = std::forward<NdiDiscoveryServersT>(value);
  }
  template <typename NdiDiscoveryServersT = Aws::Vector<NdiDiscoveryServerConfig>>
  NdiConfig& WithNdiDiscoveryServers(NdiDiscoveryServersT&& value) {
    SetNdiDiscoveryServers(std::forward<NdiDiscoveryServersT>(value));
    return *this;
  }
  ...
  NdiConfig& AddNdiDiscoveryServers(NdiDiscoveryServersT&& value) {
    m_ndiDiscoveryServersHasBeenSet = true;
    m_ndiDiscoveryServers.emplace_back(std::forward<NdiDiscoveryServersT>(value));
    return *this;
  }
  ///@}
 private:
