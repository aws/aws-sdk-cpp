...
class AddBridgeSourcesResult {
 public:
  ...
  template <typename BridgeArnT = Aws::String>
  AddBridgeSourcesResult& WithBridgeArn(BridgeArnT&& value) {
  ...
  template <typename SourcesT = Aws::Vector<BridgeSource>>
  AddBridgeSourcesResult& WithSources(SourcesT&& value) {
    SetSources(std::forward<SourcesT>(value));
    return *this;
  }
  template <typename SourcesT = BridgeSource>
  AddBridgeSourcesResult& AddSources(SourcesT&& value) {
    m_sourcesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  AddBridgeSourcesResult& WithRequestId(RequestIdT&& value) {
