...
class UpdateFailoverConfig {
 public:
  ...
  inline UpdateFailoverConfig& WithFailoverMode(FailoverMode value) {
  ...
  inline void SetRecoveryWindow(int value) {
    m_recoveryWindowHasBeenSet = true;
    m_recoveryWindow = value;
  }
  inline UpdateFailoverConfig& WithRecoveryWindow(int value) {
    SetRecoveryWindow(value);
    return *this;
  }
  ///@}
  ...
  void SetSourcePriority(SourcePriorityT&& value) {
    ...
    m_sourcePriority = std::forward<SourcePriorityT>(value);
  }
  template <typename SourcePriorityT = SourcePriority>
  UpdateFailoverConfig& WithSourcePriority(SourcePriorityT&& value) {
    SetSourcePriority(std::forward<SourcePriorityT>(value));
    return *this;
  }
  ///@}
  ...
  inline UpdateFailoverConfig& WithState(State value) {
    SetState(value);
    return *this;
  }
  ///@}
