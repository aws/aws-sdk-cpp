...
/**
 * <p>Configuration settings for flow transit encryption keys.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/FlowTransitEncryptionKeyConfiguration">AWS
 * API Reference</a></p>
 */
