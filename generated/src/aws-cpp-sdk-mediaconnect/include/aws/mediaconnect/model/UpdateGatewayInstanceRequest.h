...
class UpdateGatewayInstanceRequest : public MediaConnectRequest {
 public:
  ...
  inline void SetBridgePlacement(BridgePlacement value) {
    m_bridgePlacementHasBeenSet = true;
    m_bridgePlacement = value;
  }
  inline UpdateGatewayInstanceRequest& WithBridgePlacement(BridgePlacement value) {
    SetBridgePlacement(value);
    return *this;
  }
  ///@}
  ...
  template <typename GatewayInstanceArnT = Aws::String>
  UpdateGatewayInstanceRequest& WithGatewayInstanceArn(GatewayInstanceArnT&& value) {
