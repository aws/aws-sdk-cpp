...
class FrameResolution {
 public:
  ...
  inline void SetFrameHeight(int value) {
    m_frameHeightHasBeenSet = true;
    m_frameHeight = value;
  }
  inline FrameResolution& WithFrameHeight(int value) {
  ...
  inline void SetFrameWidth(int value) {
    m_frameWidthHasBeenSet = true;
    m_frameWidth = value;
  }
  inline FrameResolution& WithFrameWidth(int value) {
    SetFrameWidth(value);
    return *this;
  }
  ///@}
