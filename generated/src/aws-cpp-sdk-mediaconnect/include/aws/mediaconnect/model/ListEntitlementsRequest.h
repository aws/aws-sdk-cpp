...
namespace Model
{
  ...
  /**
   */
  class ListEntitlementsRequest : public MediaConnectRequest
  {
  public:
    AWS_MEDIACONNECT_API ListEntitlementsRequest() = default;
     ...
     * example, you submit a <code>ListEntitlements</code> request with set at 5.
     ...
     * the next batch of results.) </p> <p>The service might return fewer results than
     * the <code>MaxResults</code> value. If <code>MaxResults</code> is not included in
     * the request, the service defaults to pagination with a maximum of 20 results per
     * page.</p>
     */
    ...
    template<typename NextTokenT = Aws::String>
    ListEntitlementsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
