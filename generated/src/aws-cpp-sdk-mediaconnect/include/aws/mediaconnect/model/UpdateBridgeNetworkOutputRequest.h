...
class UpdateBridgeNetworkOutputRequest {
 public:
  ...
  inline UpdateBridgeNetworkOutputRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBridgeNetworkOutputRequest& WithProtocol(Protocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline UpdateBridgeNetworkOutputRequest& WithTtl(int value) {
    SetTtl(value);
    return *this;
  }
  ///@}
