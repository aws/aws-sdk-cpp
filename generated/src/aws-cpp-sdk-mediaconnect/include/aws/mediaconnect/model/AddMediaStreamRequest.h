...
class AddMediaStreamRequest {
 public:
  ...
  inline AddMediaStreamRequest& WithClockRate(int value) {
    SetClockRate(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMediaStreamId(int value) {
    m_mediaStreamIdHasBeenSet = true;
    m_mediaStreamId = value;
  }
  inline AddMediaStreamRequest& WithMediaStreamId(int value) {
    SetMediaStreamId(value);
    return *this;
  }
  ///@}
  ...
  inline AddMediaStreamRequest& WithMediaStreamType(MediaStreamType value) {
  ...
  void SetMediaStreamTags(MediaStreamTagsT&& value) {
    m_mediaStreamTagsHasBeenSet = true;
    m_mediaStreamTags = std::forward<MediaStreamTagsT>(value);
  }
  template <typename MediaStreamTagsT = Aws::Map<Aws::String, Aws::String>>
  AddMediaStreamRequest& WithMediaStreamTags(MediaStreamTagsT&& value) {
    SetMediaStreamTags(std::forward<MediaStreamTagsT>(value));
    return *this;
  }
  ...
  AddMediaStreamRequest& AddMediaStreamTags(MediaStreamTagsKeyT&& key, MediaStreamTagsValueT&& value) {
    m_mediaStreamTagsHasBeenSet = true;
    m_mediaStreamTags.emplace(std::forward<MediaStreamTagsKeyT>(key), std::forward<MediaStreamTagsValueT>(value));
    return *this;
  }
  ///@}
 private:
