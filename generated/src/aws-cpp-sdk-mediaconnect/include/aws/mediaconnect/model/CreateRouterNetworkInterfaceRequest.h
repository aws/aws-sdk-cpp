...
/**
 */
class CreateRouterNetworkInterfaceRequest : public MediaConnectRequest {
 public:
  AWS_MEDIACONNECT_API CreateRouterNetworkInterfaceRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateRouterNetworkInterface"; }
  ...
  template <typename NameT = Aws::String>
  CreateRouterNetworkInterfaceRequest& WithName(NameT&& value) {
  ...
  template <typename ConfigurationT = RouterNetworkInterfaceConfiguration>
  CreateRouterNetworkInterfaceRequest& WithConfiguration(ConfigurationT&& value) {
  ...
  template <typename RegionNameT = Aws::String>
  CreateRouterNetworkInterfaceRequest& WithRegionName(RegionNameT&& value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  CreateRouterNetworkInterfaceRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsKeyT = Aws::String, typename TagsValueT = Aws::String>
  CreateRouterNetworkInterfaceRequest& AddTags(TagsKeyT&& key, TagsValueT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateRouterNetworkInterfaceRequest& WithClientToken(ClientTokenT&& value) {
