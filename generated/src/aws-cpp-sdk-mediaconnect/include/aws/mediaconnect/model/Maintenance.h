...
class Maintenance {
 public:
  ...
  inline Maintenance& WithMaintenanceDay(MaintenanceDay value) {
  ...
  template <typename MaintenanceDeadlineT = Aws::String>
  Maintenance& WithMaintenanceDeadline(MaintenanceDeadlineT&& value) {
  ...
  template <typename MaintenanceScheduledDateT = Aws::String>
  Maintenance& WithMaintenanceScheduledDate(MaintenanceScheduledDateT&& value) {
  ...
  template <typename MaintenanceStartHourT = Aws::String>
  Maintenance& WithMaintenanceStartHour(MaintenanceStartHourT&& value) {
