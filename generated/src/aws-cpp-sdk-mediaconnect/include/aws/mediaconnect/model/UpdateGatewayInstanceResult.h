...
class UpdateGatewayInstanceResult {
 public:
  ...
  inline UpdateGatewayInstanceResult& WithBridgePlacement(BridgePlacement value) {
  ...
  template <typename GatewayInstanceArnT = Aws::String>
  UpdateGatewayInstanceResult& WithGatewayInstanceArn(GatewayInstanceArnT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateGatewayInstanceResult& WithRequestId(RequestIdT&& value) {
