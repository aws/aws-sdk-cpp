...
'p','s',':','/','/','f','i','p','s','.','t','r','a','n','s','c','r','i','b','e','.','{','R','e','g',
...
's','c','r','i','b','e','.','{','R','e','g','i','o','n','}','.','{','P','a','r','t','i','t','i','o',
...
const char* TranscribeServiceEndpointRules::GetRulesBlob()
{
