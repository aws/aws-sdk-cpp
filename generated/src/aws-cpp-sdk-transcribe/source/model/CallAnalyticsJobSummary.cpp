...
CallAnalyticsJobSummary::CallAnalyticsJobSummary(JsonView jsonValue) { *this = jsonValue; }
...
CallAnalyticsJobSummary& CallAnalyticsJobSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("CallAnalyticsJobStatus")) {
    m_callAnalyticsJobStatus =
        CallAnalyticsJobStatusMapper::GetCallAnalyticsJobStatusForName(jsonValue.GetString("CallAnalyticsJobStatus"));
