...
MedicalTranscriptionJob::MedicalTranscriptionJob(JsonView jsonValue) { *this = jsonValue; }
...
MedicalTranscriptionJob& MedicalTranscriptionJob::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("ContentIdentificationType")) {
    m_contentIdentificationType = MedicalContentIdentificationTypeMapper::GetMedicalContentIdentificationTypeForName(
