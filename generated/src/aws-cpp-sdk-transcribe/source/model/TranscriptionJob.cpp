...
TranscriptionJob::TranscriptionJob(JsonView jsonValue) { *this = jsonValue; }
...
TranscriptionJob& TranscriptionJob::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("TranscriptionJobStatus")) {
    m_transcriptionJobStatus =
        TranscriptionJobStatusMapper::GetTranscriptionJobStatusForName(jsonValue.GetString("TranscriptionJobStatus"));
  ...
  if (jsonValue.ValueExists("LanguageIdSettings")) {
    ...
    for (auto& languageIdSettingsItem : languageIdSettingsJsonMap) {
      m_languageIdSettings[LanguageCodeMapper::GetLanguageCodeForName(languageIdSettingsItem.first)] =
          languageIdSettingsItem.second.AsObject();
    }
