...
MedicalScribeJobSummary::MedicalScribeJobSummary(JsonView jsonValue) { *this = jsonValue; }
...
MedicalScribeJobSummary& MedicalScribeJobSummary::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("MedicalScribeJobStatus")) {
    m_medicalScribeJobStatus =
        MedicalScribeJobStatusMapper::GetMedicalScribeJobStatusForName(jsonValue.GetString("MedicalScribeJobStatus"));
