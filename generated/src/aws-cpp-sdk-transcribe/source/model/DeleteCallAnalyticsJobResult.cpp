...
DeleteCallAnalyticsJobResult::DeleteCallAnalyticsJobResult()
{
}

DeleteCallAnalyticsJobResult::DeleteCallAnalyticsJobResult(const Aws::AmazonWebServiceResult<JsonValue>& result)
{
  *this = result;
}
