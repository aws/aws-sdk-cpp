...
namespace TranscribeService
{
   ...
   * details.</p> </li> </ul>
   */
  class AWS_TRANSCRIBESERVICE_API TranscribeServiceClient : Aws::Client::ClientWithAsyncTemplateMethods<TranscribeServiceClient>,
    smithy::client::AwsSmithyClientT<Aws::TranscribeService::SERVICE_NAME,
