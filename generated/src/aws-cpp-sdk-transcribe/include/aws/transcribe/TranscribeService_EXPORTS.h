...
#ifdef AWS_TRANSCRIBESERVICE_EXPORTS
#define AWS_TRANSCRIBESERVICE_API __declspec(dllexport)
#else
...
#define AWS_TRANSCRIBESERVICE_LOCAL
#else  // defined (USE_WINDOWS_DLL_SEMANTICS) || defined (WIN32)
#define AWS_TRANSCRIBESERVICE_API
#define AWS_TRANSCRIBESERVICE_EXTERN extern
#if __GNUC__ >= 4
#define AWS_TRANSCRIBESERVICE_LOCAL __attribute__((visibility("hidden")))
#else
#define AWS_TRANSCRIBESERVICE_LOCAL
#endif
