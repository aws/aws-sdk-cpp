...
class CreateVocabularyFilterRequest : public TranscribeServiceRequest {
 public:
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  CreateVocabularyFilterRequest& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  inline CreateVocabularyFilterRequest& WithLanguageCode(LanguageCode value) {
  ...
  template <typename WordsT = Aws::Vector<Aws::String>>
  CreateVocabularyFilterRequest& WithWords(WordsT&& value) {
    SetWords(std::forward<WordsT>(value));
    return *this;
  }
  template <typename WordsT = Aws::String>
  CreateVocabularyFilterRequest& AddWords(WordsT&& value) {
    m_wordsHasBeenSet = true;
  ...
  template <typename VocabularyFilterFileUriT = Aws::String>
  CreateVocabularyFilterRequest& WithVocabularyFilterFileUri(VocabularyFilterFileUriT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateVocabularyFilterRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateVocabularyFilterRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  CreateVocabularyFilterRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  ///@{
  /**
   * <p>Specifies the encryption configuration for your custom vocabulary filter.
   * Your vocabulary filter artifacts are encrypted with the specified KMS key or
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  CreateVocabularyFilterRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
