...
class CreateCallAnalyticsCategoryResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API CreateCallAnalyticsCategoryResult& operator=(
  ...
  template <typename CategoryPropertiesT = CategoryProperties>
  CreateCallAnalyticsCategoryResult& WithCategoryProperties(CategoryPropertiesT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateCallAnalyticsCategoryResult& WithRequestId(RequestIdT&& value) {
