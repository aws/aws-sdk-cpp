...
class CallAnalyticsJobSettings {
 public:
  ...
  inline CallAnalyticsJobSettings& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
  ...
  inline CallAnalyticsJobSettings& AddLanguageOptions(LanguageCode value) {
    m_languageOptionsHasBeenSet = true;
    m_languageOptions.push_back(value);
    return *this;
  }
  ///@}
