...
class AbsoluteTimeRange {
 public:
  ...
  inline AbsoluteTimeRange& WithStartTime(long long value) {
    SetStartTime(value);
    return *this;
  }
  ///@}
  ...
  inline AbsoluteTimeRange& WithEndTime(long long value) {
    SetEndTime(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFirst(long long value) {
    m_firstHasBeenSet = true;
    m_first = value;
  }
  inline AbsoluteTimeRange& WithFirst(long long value) {
    SetFirst(value);
    return *this;
  }
  ///@}
  ...
  inline void SetLast(long long value) {
    m_lastHasBeenSet = true;
    m_last = value;
  }
  inline AbsoluteTimeRange& WithLast(long long value) {
    SetLast(value);
    return *this;
  }
  ///@}
