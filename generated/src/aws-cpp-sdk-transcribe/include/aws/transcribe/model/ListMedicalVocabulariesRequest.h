...
class ListMedicalVocabulariesRequest : public TranscribeServiceRequest {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListMedicalVocabulariesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMedicalVocabulariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStateEquals(VocabularyState value) {
    m_stateEqualsHasBeenSet = true;
    m_stateEquals = value;
  }
  inline ListMedicalVocabulariesRequest& WithStateEquals(VocabularyState value) {
  ...
  template <typename NameContainsT = Aws::String>
  ListMedicalVocabulariesRequest& WithNameContains(NameContainsT&& value) {
