...
class CallAnalyticsSkippedFeature {
 public:
  ...
  inline void SetFeature(CallAnalyticsFeature value) {
    m_featureHasBeenSet = true;
    m_feature = value;
  }
  inline CallAnalyticsSkippedFeature& WithFeature(CallAnalyticsFeature value) {
    SetFeature(value);
    return *this;
  }
  ///@}
  ...
  inline void SetReasonCode(CallAnalyticsSkippedReasonCode value) {
    m_reasonCodeHasBeenSet = true;
    m_reasonCode = value;
  }
  inline CallAnalyticsSkippedFeature& WithReasonCode(CallAnalyticsSkippedReasonCode value) {
    SetReasonCode(value);
    return *this;
  }
  ///@}
