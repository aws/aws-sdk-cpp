...
class ListMedicalScribeJobsResult {
 public:
  ...
  inline ListMedicalScribeJobsResult& WithStatus(MedicalScribeJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMedicalScribeJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetMedicalScribeJobSummaries(MedicalScribeJobSummariesT&& value) {
    m_medicalScribeJobSummariesHasBeenSet = true;
    m_medicalScribeJobSummaries = std::forward<MedicalScribeJobSummariesT>(value);
  }
  template <typename MedicalScribeJobSummariesT = Aws::Vector<MedicalScribeJobSummary>>
  ListMedicalScribeJobsResult& WithMedicalScribeJobSummaries(MedicalScribeJobSummariesT&& value) {
    SetMedicalScribeJobSummaries(std::forward<MedicalScribeJobSummariesT>(value));
    return *this;
  }
  template <typename MedicalScribeJobSummariesT = MedicalScribeJobSummary>
  ListMedicalScribeJobsResult& AddMedicalScribeJobSummaries(MedicalScribeJobSummariesT&& value) {
    m_medicalScribeJobSummariesHasBeenSet = true;
    m_medicalScribeJobSummaries.emplace_back(std::forward<MedicalScribeJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMedicalScribeJobsResult& WithRequestId(RequestIdT&& value) {
