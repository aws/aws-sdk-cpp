...
class MedicalScribeSettings {
 public:
  ...
  inline MedicalScribeSettings& WithShowSpeakerLabels(bool value) {
  ...
  inline MedicalScribeSettings& WithMaxSpeakerLabels(int value) {
  ...
  inline MedicalScribeSettings& WithChannelIdentification(bool value) {
  ...
  inline MedicalScribeSettings& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
