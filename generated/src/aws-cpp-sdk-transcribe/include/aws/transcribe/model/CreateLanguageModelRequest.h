...
class CreateLanguageModelRequest : public TranscribeServiceRequest {
 public:
  ...
  inline CreateLanguageModelRequest& WithLanguageCode(CLMLanguageCode value) {
  ...
  inline CreateLanguageModelRequest& WithBaseModelName(BaseModelName value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateLanguageModelRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateLanguageModelRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
