...
class CreateVocabularyFilterResult {
 public:
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  CreateVocabularyFilterResult& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  inline CreateVocabularyFilterResult& WithLanguageCode(LanguageCode value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  CreateVocabularyFilterResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateVocabularyFilterResult& WithRequestId(RequestIdT&& value) {
