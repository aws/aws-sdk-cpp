...
namespace Model
{
  ...
  public:
    ...
    inline CreateVocabularyFilterResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline CreateVocabularyFilterResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline CreateVocabularyFilterResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
