...
class ListCallAnalyticsJobsResult {
 public:
  ...
  inline void SetStatus(CallAnalyticsJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListCallAnalyticsJobsResult& WithStatus(CallAnalyticsJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListCallAnalyticsJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetCallAnalyticsJobSummaries(CallAnalyticsJobSummariesT&& value) {
    m_callAnalyticsJobSummariesHasBeenSet = true;
    m_callAnalyticsJobSummaries = std::forward<CallAnalyticsJobSummariesT>(value);
  }
  template <typename CallAnalyticsJobSummariesT = Aws::Vector<CallAnalyticsJobSummary>>
  ListCallAnalyticsJobsResult& WithCallAnalyticsJobSummaries(CallAnalyticsJobSummariesT&& value) {
    SetCallAnalyticsJobSummaries(std::forward<CallAnalyticsJobSummariesT>(value));
    return *this;
  }
  template <typename CallAnalyticsJobSummariesT = CallAnalyticsJobSummary>
  ListCallAnalyticsJobsResult& AddCallAnalyticsJobSummaries(CallAnalyticsJobSummariesT&& value) {
    m_callAnalyticsJobSummariesHasBeenSet = true;
    m_callAnalyticsJobSummaries.emplace_back(std::forward<CallAnalyticsJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListCallAnalyticsJobsResult& WithRequestId(RequestIdT&& value) {
