...
class LanguageModel {
 public:
  ...
  inline LanguageModel& WithLanguageCode(CLMLanguageCode value) {
  ...
  inline LanguageModel& WithBaseModelName(BaseModelName value) {
  ...
  inline LanguageModel& WithModelStatus(ModelStatus value) {
  ...
  inline void SetUpgradeAvailability(bool value) {
    m_upgradeAvailabilityHasBeenSet = true;
    m_upgradeAvailability = value;
  }
  inline LanguageModel& WithUpgradeAvailability(bool value) {
    SetUpgradeAvailability(value);
    return *this;
  }
  ///@}
