...
class DescribeLanguageModelResult {
 public:
  ...
  void SetLanguageModel(LanguageModelT&& value) {
    m_languageModelHasBeenSet = true;
    m_languageModel = std::forward<LanguageModelT>(value);
  }
  template <typename LanguageModelT = LanguageModel>
  DescribeLanguageModelResult& WithLanguageModel(LanguageModelT&& value) {
    SetLanguageModel(std::forward<LanguageModelT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  DescribeLanguageModelResult& WithRequestId(RequestIdT&& value) {
