...
class MedicalTranscriptionJob {
 public:
  ...
  void SetMedicalTranscriptionJobName(MedicalTranscriptionJobNameT&& value) {
    ...
    m_medicalTranscriptionJobName = std::forward<MedicalTranscriptionJobNameT>(value);
  }
  template <typename MedicalTranscriptionJobNameT = Aws::String>
  MedicalTranscriptionJob& WithMedicalTranscriptionJobName(MedicalTranscriptionJobNameT&& value) {
    SetMedicalTranscriptionJobName(std::forward<MedicalTranscriptionJobNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline MedicalTranscriptionJob& WithTranscriptionJobStatus(TranscriptionJobStatus value) {
  ...
  inline MedicalTranscriptionJob& WithLanguageCode(LanguageCode value) {
  ...
  inline MedicalTranscriptionJob& WithMediaSampleRateHertz(int value) {
  ...
  inline MedicalTranscriptionJob& WithMediaFormat(MediaFormat value) {
  ...
  inline MedicalTranscriptionJob& WithContentIdentificationType(MedicalContentIdentificationType value) {
  ...
  inline MedicalTranscriptionJob& WithSpecialty(Specialty value) {
    SetSpecialty(value);
    return *this;
  }
  ///@}
  ...
  inline MedicalTranscriptionJob& WithType(Type value) {
    SetType(value);
    return *this;
  }
  ///@}
