...
class SentimentFilter {
 public:
  ...
  void SetSentiments(SentimentsT&& value) {
    m_sentimentsHasBeenSet = true;
    m_sentiments = std::forward<SentimentsT>(value);
  }
  template <typename SentimentsT = Aws::Vector<SentimentValue>>
  SentimentFilter& WithSentiments(SentimentsT&& value) {
    SetSentiments(std::forward<SentimentsT>(value));
    return *this;
  }
  inline SentimentFilter& AddSentiments(SentimentValue value) {
    m_sentimentsHasBeenSet = true;
    m_sentiments.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetAbsoluteTimeRange(AbsoluteTimeRangeT&& value) {
    m_absoluteTimeRangeHasBeenSet = true;
    m_absoluteTimeRange = std::forward<AbsoluteTimeRangeT>(value);
  }
  template <typename AbsoluteTimeRangeT = AbsoluteTimeRange>
  SentimentFilter& WithAbsoluteTimeRange(AbsoluteTimeRangeT&& value) {
    SetAbsoluteTimeRange(std::forward<AbsoluteTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRelativeTimeRange(RelativeTimeRangeT&& value) {
    m_relativeTimeRangeHasBeenSet = true;
    m_relativeTimeRange = std::forward<RelativeTimeRangeT>(value);
  }
  template <typename RelativeTimeRangeT = RelativeTimeRange>
  SentimentFilter& WithRelativeTimeRange(RelativeTimeRangeT&& value) {
    SetRelativeTimeRange(std::forward<RelativeTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  inline SentimentFilter& WithParticipantRole(ParticipantRole value) {
  ...
  inline SentimentFilter& WithNegate(bool value) {
    SetNegate(value);
    return *this;
  }
  ///@}
