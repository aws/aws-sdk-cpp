...
class UpdateVocabularyFilterResult {
 public:
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  UpdateVocabularyFilterResult& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  inline UpdateVocabularyFilterResult& WithLanguageCode(LanguageCode value) {
  ...
  template <typename LastModifiedTimeT = Aws::Utils::DateTime>
  UpdateVocabularyFilterResult& WithLastModifiedTime(LastModifiedTimeT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  UpdateVocabularyFilterResult& WithRequestId(RequestIdT&& value) {
