...
namespace Model
{
  ...
  public:
    ...
    inline GetVocabularyFilterResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline GetVocabularyFilterResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline GetVocabularyFilterResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
