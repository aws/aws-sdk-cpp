...
class ListTranscriptionJobsResult {
 public:
  ...
  inline ListTranscriptionJobsResult& WithStatus(TranscriptionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListTranscriptionJobsResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetTranscriptionJobSummaries(TranscriptionJobSummariesT&& value) {
    m_transcriptionJobSummariesHasBeenSet = true;
    m_transcriptionJobSummaries = std::forward<TranscriptionJobSummariesT>(value);
  }
  template <typename TranscriptionJobSummariesT = Aws::Vector<TranscriptionJobSummary>>
  ListTranscriptionJobsResult& WithTranscriptionJobSummaries(TranscriptionJobSummariesT&& value) {
    SetTranscriptionJobSummaries(std::forward<TranscriptionJobSummariesT>(value));
    return *this;
  }
  template <typename TranscriptionJobSummariesT = TranscriptionJobSummary>
  ListTranscriptionJobsResult& AddTranscriptionJobSummaries(TranscriptionJobSummariesT&& value) {
    m_transcriptionJobSummariesHasBeenSet = true;
    m_transcriptionJobSummaries.emplace_back(std::forward<TranscriptionJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListTranscriptionJobsResult& WithRequestId(RequestIdT&& value) {
