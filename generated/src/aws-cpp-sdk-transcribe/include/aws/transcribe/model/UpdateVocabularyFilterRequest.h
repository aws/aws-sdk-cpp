...
class UpdateVocabularyFilterRequest : public TranscribeServiceRequest {
 public:
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  UpdateVocabularyFilterRequest& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  void SetWords(WordsT&& value) {
    ...
    m_words = std::forward<WordsT>(value);
  }
  template <typename WordsT = Aws::Vector<Aws::String>>
  UpdateVocabularyFilterRequest& WithWords(WordsT&& value) {
    SetWords(std::forward<WordsT>(value));
    return *this;
  }
  template <typename WordsT = Aws::String>
  UpdateVocabularyFilterRequest& AddWords(WordsT&& value) {
    m_wordsHasBeenSet = true;
    m_words.emplace_back(std::forward<WordsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVocabularyFilterFileUri(VocabularyFilterFileUriT&& value) {
    m_vocabularyFilterFileUriHasBeenSet = true;
    m_vocabularyFilterFileUri = std::forward<VocabularyFilterFileUriT>(value);
  }
  template <typename VocabularyFilterFileUriT = Aws::String>
  UpdateVocabularyFilterRequest& WithVocabularyFilterFileUri(VocabularyFilterFileUriT&& value) {
    SetVocabularyFilterFileUri(std::forward<VocabularyFilterFileUriT>(value));
    return *this;
  }
  ///@}
   ...
   * vocabulary filter). If you include <code>EncryptionConfiguration</code> in your
  ...
  template <typename DataAccessRoleArnT = Aws::String>
  UpdateVocabularyFilterRequest& WithDataAccessRoleArn(DataAccessRoleArnT&& value) {
  ...
  ///@{
  /**
   * <p>Specifies the new encryption configuration for your custom vocabulary filter.
   * The vocabulary filter artifacts are re-encrypted in place using the specified
   * KMS key or with an AWS-owned key if a key is not supplied.</p>
   */
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  UpdateVocabularyFilterRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
