...
class Media {
 public:
  ...
  void SetMediaFileUri(MediaFileUriT&& value) {
    ...
    m_mediaFileUri = std::forward<MediaFileUriT>(value);
  }
  template <typename MediaFileUriT = Aws::String>
  Media& WithMediaFileUri(MediaFileUriT&& value) {
    SetMediaFileUri(std::forward<MediaFileUriT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRedactedMediaFileUri(RedactedMediaFileUriT&& value) {
    ...
    m_redactedMediaFileUri = std::forward<RedactedMediaFileUriT>(value);
  }
  template <typename RedactedMediaFileUriT = Aws::String>
  Media& WithRedactedMediaFileUri(RedactedMediaFileUriT&& value) {
    SetRedactedMediaFileUri(std::forward<RedactedMediaFileUriT>(value));
    return *this;
  }
  ///@}
 private:
