...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSCRIBESERVICE_API ListVocabularyFiltersRequest() = default;
    ...
    template<typename NextTokenT = Aws::String>
    ListVocabularyFiltersRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename NameContainsT = Aws::String>
    ListVocabularyFiltersRequest& WithNameContains(NameContainsT&& value) { SetNameContains(std::forward<NameContainsT>(value)); return *this;}
    ///@}
  private:
