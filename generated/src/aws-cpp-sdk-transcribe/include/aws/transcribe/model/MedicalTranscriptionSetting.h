...
class MedicalTranscriptionSetting {
 public:
  ...
  inline MedicalTranscriptionSetting& WithShowSpeakerLabels(bool value) {
  ...
  inline MedicalTranscriptionSetting& WithMaxSpeakerLabels(int value) {
  ...
  inline MedicalTranscriptionSetting& WithChannelIdentification(bool value) {
  ...
  inline MedicalTranscriptionSetting& WithShowAlternatives(bool value) {
  ...
  inline MedicalTranscriptionSetting& WithMaxAlternatives(int value) {
