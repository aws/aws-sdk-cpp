...
class SubtitlesOutput {
 public:
  ...
  void SetFormats(FormatsT&& value) {
    ...
    m_formats = std::forward<FormatsT>(value);
  }
  template <typename FormatsT = Aws::Vector<SubtitleFormat>>
  SubtitlesOutput& WithFormats(FormatsT&& value) {
    SetFormats(std::forward<FormatsT>(value));
    return *this;
  }
  inline SubtitlesOutput& AddFormats(SubtitleFormat value) {
    m_formatsHasBeenSet = true;
    m_formats.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetSubtitleFileUris(SubtitleFileUrisT&& value) {
    ...
    m_subtitleFileUris = std::forward<SubtitleFileUrisT>(value);
  }
  template <typename SubtitleFileUrisT = Aws::Vector<Aws::String>>
  SubtitlesOutput& WithSubtitleFileUris(SubtitleFileUrisT&& value) {
    SetSubtitleFileUris(std::forward<SubtitleFileUrisT>(value));
    return *this;
  }
  template <typename SubtitleFileUrisT = Aws::String>
  SubtitlesOutput& AddSubtitleFileUris(SubtitleFileUrisT&& value) {
    m_subtitleFileUrisHasBeenSet = true;
    m_subtitleFileUris.emplace_back(std::forward<SubtitleFileUrisT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetOutputStartIndex(int value) {
    m_outputStartIndexHasBeenSet = true;
    m_outputStartIndex = value;
  }
  inline SubtitlesOutput& WithOutputStartIndex(int value) {
    SetOutputStartIndex(value);
    return *this;
  }
  ///@}
 private:
