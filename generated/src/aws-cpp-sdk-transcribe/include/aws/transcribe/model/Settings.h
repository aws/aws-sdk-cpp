...
class Settings {
 public:
  ...
  inline void SetShowSpeakerLabels(bool value) {
    m_showSpeakerLabelsHasBeenSet = true;
    m_showSpeakerLabels = value;
  }
  inline Settings& WithShowSpeakerLabels(bool value) {
    SetShowSpeakerLabels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMaxSpeakerLabels(int value) {
    m_maxSpeakerLabelsHasBeenSet = true;
    m_maxSpeakerLabels = value;
  }
  inline Settings& WithMaxSpeakerLabels(int value) {
    SetMaxSpeakerLabels(value);
    return *this;
  }
  ///@}
  ...
  inline void SetChannelIdentification(bool value) {
    m_channelIdentificationHasBeenSet = true;
    m_channelIdentification = value;
  }
  inline Settings& WithChannelIdentification(bool value) {
    SetChannelIdentification(value);
    return *this;
  }
  ///@}
  ...
  inline void SetShowAlternatives(bool value) {
    m_showAlternativesHasBeenSet = true;
    m_showAlternatives = value;
  }
  inline Settings& WithShowAlternatives(bool value) {
  ...
  inline void SetMaxAlternatives(int value) {
    m_maxAlternativesHasBeenSet = true;
    m_maxAlternatives = value;
  }
  inline Settings& WithMaxAlternatives(int value) {
    SetMaxAlternatives(value);
    return *this;
  }
  ///@}
  ...
  inline Settings& WithVocabularyFilterMethod(VocabularyFilterMethod value) {
