...
class NonTalkTimeFilter {
 public:
  ...
  inline void SetThreshold(long long value) {
    m_thresholdHasBeenSet = true;
    m_threshold = value;
  }
  inline NonTalkTimeFilter& WithThreshold(long long value) {
    SetThreshold(value);
    return *this;
  }
  ///@}
  ...
  template <typename AbsoluteTimeRangeT = AbsoluteTimeRange>
  NonTalkTimeFilter& WithAbsoluteTimeRange(AbsoluteTimeRangeT&& value) {
  ...
  template <typename RelativeTimeRangeT = RelativeTimeRange>
  NonTalkTimeFilter& WithRelativeTimeRange(RelativeTimeRangeT&& value) {
  ...
  inline NonTalkTimeFilter& WithNegate(bool value) {
    SetNegate(value);
    return *this;
  }
  ///@}
