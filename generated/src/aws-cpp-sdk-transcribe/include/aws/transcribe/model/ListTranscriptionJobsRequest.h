...
class ListTranscriptionJobsRequest : public TranscribeServiceRequest {
 public:
  ...
  inline ListTranscriptionJobsRequest& WithStatus(TranscriptionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobNameContainsT = Aws::String>
  ListTranscriptionJobsRequest& WithJobNameContains(JobNameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListTranscriptionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListTranscriptionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
