...
namespace Model
{
  ...
  {
  public:
    AWS_TRANSCRIBESERVICE_API ListCallAnalyticsJobsRequest() = default;
    ...
    inline ListCallAnalyticsJobsRequest& WithStatus(CallAnalyticsJobStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename JobNameContainsT = Aws::String>
    ListCallAnalyticsJobsRequest& WithJobNameContains(JobNameContainsT&& value) { SetJobNameContains(std::forward<JobNameContainsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListCallAnalyticsJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
