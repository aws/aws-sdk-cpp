...
class ListCallAnalyticsJobsRequest : public TranscribeServiceRequest {
 public:
  ...
  inline ListCallAnalyticsJobsRequest& WithStatus(CallAnalyticsJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobNameContainsT = Aws::String>
  ListCallAnalyticsJobsRequest& WithJobNameContains(JobNameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListCallAnalyticsJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListCallAnalyticsJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
