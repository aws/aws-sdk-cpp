...
class ListCallAnalyticsCategoriesResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API ListCallAnalyticsCategoriesResult& operator=(
  ...
  template <typename NextTokenT = Aws::String>
  ListCallAnalyticsCategoriesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CategoriesT = Aws::Vector<CategoryProperties>>
  ListCallAnalyticsCategoriesResult& WithCategories(CategoriesT&& value) {
    SetCategories(std::forward<CategoriesT>(value));
    return *this;
  }
  template <typename CategoriesT = CategoryProperties>
  ListCallAnalyticsCategoriesResult& AddCategories(CategoriesT&& value) {
    m_categoriesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListCallAnalyticsCategoriesResult& WithRequestId(RequestIdT&& value) {
