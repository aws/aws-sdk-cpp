...
class CreateVocabularyRequest : public TranscribeServiceRequest {
 public:
  ...
  inline CreateVocabularyRequest& WithLanguageCode(LanguageCode value) {
  ...
  void SetVocabularyFileUri(VocabularyFileUriT&& value) {
    m_vocabularyFileUriHasBeenSet = true;
    m_vocabularyFileUri = std::forward<VocabularyFileUriT>(value);
  }
  template <typename VocabularyFileUriT = Aws::String>
  CreateVocabularyRequest& WithVocabularyFileUri(VocabularyFileUriT&& value) {
    SetVocabularyFileUri(std::forward<VocabularyFileUriT>(value));
    return *this;
  }
  ///@}
  ...
  CreateVocabularyRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>Specifies the encryption configuration for your custom vocabulary. Your
   * vocabulary artifacts are encrypted with the specified KMS key or with an
   * AWS-owned key if a key is not supplied.</p>
   */
  ...
  template <typename EncryptionConfigurationT = EncryptionConfiguration>
  CreateVocabularyRequest& WithEncryptionConfiguration(EncryptionConfigurationT&& value) {
