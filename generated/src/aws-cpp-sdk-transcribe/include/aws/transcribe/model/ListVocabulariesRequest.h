...
class ListVocabulariesRequest : public TranscribeServiceRequest {
 public:
  ...
  inline ListVocabulariesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
   ...
   * include <code>StateEquals</code>, all custom medical vocabularies are
   * returned.</p>
   */
  ...
  inline ListVocabulariesRequest& WithStateEquals(VocabularyState value) {
