...
class GetMedicalScribeJobRequest : public TranscribeServiceRequest {
 public:
  ...
  void SetMedicalScribeJobName(MedicalScribeJobNameT&& value) {
    ...
    m_medicalScribeJobName = std::forward<MedicalScribeJobNameT>(value);
  }
  template <typename MedicalScribeJobNameT = Aws::String>
  GetMedicalScribeJobRequest& WithMedicalScribeJobName(MedicalScribeJobNameT&& value) {
    SetMedicalScribeJobName(std::forward<MedicalScribeJobNameT>(value));
    return *this;
  }
  ///@}
 private:
