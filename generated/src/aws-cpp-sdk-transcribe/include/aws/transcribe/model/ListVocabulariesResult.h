...
class ListVocabulariesResult {
 public:
  ...
  inline ListVocabulariesResult& WithStatus(VocabularyState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListVocabulariesResult& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VocabulariesT = Aws::Vector<VocabularyInfo>>
  ListVocabulariesResult& WithVocabularies(VocabulariesT&& value) {
    SetVocabularies(std::forward<VocabulariesT>(value));
    return *this;
  }
  template <typename VocabulariesT = VocabularyInfo>
  ListVocabulariesResult& AddVocabularies(VocabulariesT&& value) {
    m_vocabulariesHasBeenSet = true;
  ...
  template <typename RequestIdT = Aws::String>
  ListVocabulariesResult& WithRequestId(RequestIdT&& value) {
