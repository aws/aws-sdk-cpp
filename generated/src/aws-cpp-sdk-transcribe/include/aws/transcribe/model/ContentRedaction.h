...
class ContentRedaction {
 public:
  ...
  inline void SetRedactionType(RedactionType value) {
    m_redactionTypeHasBeenSet = true;
    m_redactionType = value;
  }
  inline ContentRedaction& WithRedactionType(RedactionType value) {
  ...
  inline void SetRedactionOutput(RedactionOutput value) {
    m_redactionOutputHasBeenSet = true;
    m_redactionOutput = value;
  }
  inline ContentRedaction& WithRedactionOutput(RedactionOutput value) {
    SetRedactionOutput(value);
    return *this;
  }
  ///@}
  ...
  inline ContentRedaction& AddPiiEntityTypes(PiiEntityType value) {
    m_piiEntityTypesHasBeenSet = true;
