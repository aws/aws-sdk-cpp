...
class UpdateMedicalVocabularyResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API UpdateMedicalVocabularyResult& operator=(
  ...
  inline UpdateMedicalVocabularyResult& WithLanguageCode(LanguageCode value) {
  ...
  inline UpdateMedicalVocabularyResult& WithVocabularyState(VocabularyState value) {
