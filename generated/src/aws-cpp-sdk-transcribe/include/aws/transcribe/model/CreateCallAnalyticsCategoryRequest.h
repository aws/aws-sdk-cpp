...
class CreateCallAnalyticsCategoryRequest : public TranscribeServiceRequest {
 public:
  ...
  template <typename CategoryNameT = Aws::String>
  CreateCallAnalyticsCategoryRequest& WithCategoryName(CategoryNameT&& value) {
  ...
  template <typename RulesT = Aws::Vector<Rule>>
  CreateCallAnalyticsCategoryRequest& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = Rule>
  CreateCallAnalyticsCategoryRequest& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  CreateCallAnalyticsCategoryRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  CreateCallAnalyticsCategoryRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline CreateCallAnalyticsCategoryRequest& WithInputType(InputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
