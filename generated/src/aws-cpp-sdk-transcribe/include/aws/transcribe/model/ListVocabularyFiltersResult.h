...
class ListVocabularyFiltersResult {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  ListVocabularyFiltersResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetVocabularyFilters(VocabularyFiltersT&& value) {
    m_vocabularyFiltersHasBeenSet = true;
    m_vocabularyFilters = std::forward<VocabularyFiltersT>(value);
  }
  template <typename VocabularyFiltersT = Aws::Vector<VocabularyFilterInfo>>
  ListVocabularyFiltersResult& WithVocabularyFilters(VocabularyFiltersT&& value) {
    SetVocabularyFilters(std::forward<VocabularyFiltersT>(value));
    return *this;
  }
  template <typename VocabularyFiltersT = VocabularyFilterInfo>
  ListVocabularyFiltersResult& AddVocabularyFilters(VocabularyFiltersT&& value) {
    m_vocabularyFiltersHasBeenSet = true;
    m_vocabularyFilters.emplace_back(std::forward<VocabularyFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListVocabularyFiltersResult& WithRequestId(RequestIdT&& value) {
