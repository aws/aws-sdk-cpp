...
class ListMedicalTranscriptionJobsResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API ListMedicalTranscriptionJobsResult& operator=(
  ...
  inline void SetStatus(TranscriptionJobStatus value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListMedicalTranscriptionJobsResult& WithStatus(TranscriptionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMedicalTranscriptionJobsResult& WithNextToken(NextTokenT&& value) {
   ...
   */
  inline const Aws::Vector<MedicalTranscriptionJobSummary>& GetMedicalTranscriptionJobSummaries() const {
    return m_medicalTranscriptionJobSummaries;
  }
  template <typename MedicalTranscriptionJobSummariesT = Aws::Vector<MedicalTranscriptionJobSummary>>
  void SetMedicalTranscriptionJobSummaries(MedicalTranscriptionJobSummariesT&& value) {
    m_medicalTranscriptionJobSummariesHasBeenSet = true;
    m_medicalTranscriptionJobSummaries = std::forward<MedicalTranscriptionJobSummariesT>(value);
  }
  template <typename MedicalTranscriptionJobSummariesT = Aws::Vector<MedicalTranscriptionJobSummary>>
  ListMedicalTranscriptionJobsResult& WithMedicalTranscriptionJobSummaries(MedicalTranscriptionJobSummariesT&& value) {
    SetMedicalTranscriptionJobSummaries(std::forward<MedicalTranscriptionJobSummariesT>(value));
    return *this;
  }
  template <typename MedicalTranscriptionJobSummariesT = MedicalTranscriptionJobSummary>
  ListMedicalTranscriptionJobsResult& AddMedicalTranscriptionJobSummaries(MedicalTranscriptionJobSummariesT&& value) {
    m_medicalTranscriptionJobSummariesHasBeenSet = true;
    m_medicalTranscriptionJobSummaries.emplace_back(std::forward<MedicalTranscriptionJobSummariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMedicalTranscriptionJobsResult& WithRequestId(RequestIdT&& value) {
