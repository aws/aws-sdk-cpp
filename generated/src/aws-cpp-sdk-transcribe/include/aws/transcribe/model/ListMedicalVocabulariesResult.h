...
class ListMedicalVocabulariesResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API ListMedicalVocabulariesResult& operator=(
  ...
  inline void SetStatus(VocabularyState value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline ListMedicalVocabulariesResult& WithStatus(VocabularyState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListMedicalVocabulariesResult& WithNextToken(NextTokenT&& value) {
  ...
  void SetVocabularies(VocabulariesT&& value) {
    m_vocabulariesHasBeenSet = true;
    m_vocabularies = std::forward<VocabulariesT>(value);
  }
  template <typename VocabulariesT = Aws::Vector<VocabularyInfo>>
  ListMedicalVocabulariesResult& WithVocabularies(VocabulariesT&& value) {
    SetVocabularies(std::forward<VocabulariesT>(value));
    return *this;
  }
  template <typename VocabulariesT = VocabularyInfo>
  ListMedicalVocabulariesResult& AddVocabularies(VocabulariesT&& value) {
    m_vocabulariesHasBeenSet = true;
    m_vocabularies.emplace_back(std::forward<VocabulariesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  ListMedicalVocabulariesResult& WithRequestId(RequestIdT&& value) {
