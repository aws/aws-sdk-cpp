...
namespace Model
{
  ...
  public:
    ...
    inline ListMedicalScribeJobsRequest& WithStatus(MedicalScribeJobStatus value) { SetStatus(value); return *this;}
    ///@}
    ...
    template<typename JobNameContainsT = Aws::String>
    ListMedicalScribeJobsRequest& WithJobNameContains(JobNameContainsT&& value) { SetJobNameContains(std::forward<JobNameContainsT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    ListMedicalScribeJobsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
