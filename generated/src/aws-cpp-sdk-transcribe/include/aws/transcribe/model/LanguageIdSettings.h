...
class LanguageIdSettings {
 public:
  ...
  template <typename VocabularyNameT = Aws::String>
  LanguageIdSettings& WithVocabularyName(VocabularyNameT&& value) {
  ...
  template <typename VocabularyFilterNameT = Aws::String>
  LanguageIdSettings& WithVocabularyFilterName(VocabularyFilterNameT&& value) {
  ...
  template <typename LanguageModelNameT = Aws::String>
  LanguageIdSettings& WithLanguageModelName(LanguageModelNameT&& value) {
