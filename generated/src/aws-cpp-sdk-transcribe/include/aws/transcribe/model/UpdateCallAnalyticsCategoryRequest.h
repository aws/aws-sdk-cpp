...
class UpdateCallAnalyticsCategoryRequest : public TranscribeServiceRequest {
 public:
  ...
  template <typename CategoryNameT = Aws::String>
  UpdateCallAnalyticsCategoryRequest& WithCategoryName(CategoryNameT&& value) {
  ...
  template <typename RulesT = Aws::Vector<Rule>>
  UpdateCallAnalyticsCategoryRequest& WithRules(RulesT&& value) {
    SetRules(std::forward<RulesT>(value));
    return *this;
  }
  template <typename RulesT = Rule>
  UpdateCallAnalyticsCategoryRequest& AddRules(RulesT&& value) {
    m_rulesHasBeenSet = true;
  ...
  inline UpdateCallAnalyticsCategoryRequest& WithInputType(InputType value) {
    SetInputType(value);
    return *this;
  }
  ///@}
