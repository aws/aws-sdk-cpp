...
class MedicalScribeJobSummary {
 public:
  ...
  inline MedicalScribeJobSummary& WithLanguageCode(MedicalScribeLanguageCode value) {
  ...
  inline void SetMedicalScribeJobStatus(MedicalScribeJobStatus value) {
    m_medicalScribeJobStatusHasBeenSet = true;
    m_medicalScribeJobStatus = value;
  }
  inline MedicalScribeJobSummary& WithMedicalScribeJobStatus(MedicalScribeJobStatus value) {
    SetMedicalScribeJobStatus(value);
    return *this;
  }
  ///@}
