...
class CreateLanguageModelResult {
 public:
  ...
  inline void SetLanguageCode(CLMLanguageCode value) {
    m_languageCodeHasBeenSet = true;
    m_languageCode = value;
  }
  inline CreateLanguageModelResult& WithLanguageCode(CLMLanguageCode value) {
  ...
  inline void SetBaseModelName(BaseModelName value) {
    m_baseModelNameHasBeenSet = true;
    m_baseModelName = value;
  }
  inline CreateLanguageModelResult& WithBaseModelName(BaseModelName value) {
    SetBaseModelName(value);
    return *this;
  }
  ///@}
  ...
  template <typename ModelNameT = Aws::String>
  CreateLanguageModelResult& WithModelName(ModelNameT&& value) {
  ...
  template <typename InputDataConfigT = InputDataConfig>
  CreateLanguageModelResult& WithInputDataConfig(InputDataConfigT&& value) {
  ...
  inline CreateLanguageModelResult& WithModelStatus(ModelStatus value) {
  ...
  template <typename RequestIdT = Aws::String>
  CreateLanguageModelResult& WithRequestId(RequestIdT&& value) {
