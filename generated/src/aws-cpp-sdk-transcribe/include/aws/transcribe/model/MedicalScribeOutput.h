...
class MedicalScribeOutput {
 public:
  ...
  template <typename TranscriptFileUriT = Aws::String>
  MedicalScribeOutput& WithTranscriptFileUri(TranscriptFileUriT&& value) {
  ...
  void SetClinicalDocumentUri(ClinicalDocumentUriT&& value) {
    m_clinicalDocumentUriHasBeenSet = true;
    m_clinicalDocumentUri = std::forward<ClinicalDocumentUriT>(value);
  }
  template <typename ClinicalDocumentUriT = Aws::String>
  MedicalScribeOutput& WithClinicalDocumentUri(ClinicalDocumentUriT&& value) {
    SetClinicalDocumentUri(std::forward<ClinicalDocumentUriT>(value));
    return *this;
  }
  ///@}
 private:
