...
namespace Model
{
  ...
  public:
    ...
    inline ListLanguageModelsResult& WithRequestId(const Aws::String& value) { SetRequestId(value); return *this;}

    
    inline ListLanguageModelsResult& WithRequestId(Aws::String&& value) { SetRequestId(std::move(value)); return *this;}

    
    inline ListLanguageModelsResult& WithRequestId(const char* value) { SetRequestId(value); return *this;}
