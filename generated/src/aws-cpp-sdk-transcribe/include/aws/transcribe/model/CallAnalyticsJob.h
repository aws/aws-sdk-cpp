...
class CallAnalyticsJob {
 public:
  ...
  inline void SetCallAnalyticsJobStatus(CallAnalyticsJobStatus value) {
    m_callAnalyticsJobStatusHasBeenSet = true;
    m_callAnalyticsJobStatus = value;
  }
  inline CallAnalyticsJob& WithCallAnalyticsJobStatus(CallAnalyticsJobStatus value) {
    SetCallAnalyticsJobStatus(value);
    return *this;
  }
  ///@}
  ...
  void SetCallAnalyticsJobDetails(CallAnalyticsJobDetailsT&& value) {
    ...
    m_callAnalyticsJobDetails = std::forward<CallAnalyticsJobDetailsT>(value);
  }
  template <typename CallAnalyticsJobDetailsT = CallAnalyticsJobDetails>
  CallAnalyticsJob& WithCallAnalyticsJobDetails(CallAnalyticsJobDetailsT&& value) {
    SetCallAnalyticsJobDetails(std::forward<CallAnalyticsJobDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  inline CallAnalyticsJob& WithLanguageCode(LanguageCode value) {
  ...
  inline CallAnalyticsJob& WithMediaSampleRateHertz(int value) {
  ...
  inline CallAnalyticsJob& WithMediaFormat(MediaFormat value) {
  ...
  inline CallAnalyticsJob& WithIdentifiedLanguageScore(double value) {
