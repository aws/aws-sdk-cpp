...
class ListMedicalTranscriptionJobsRequest : public TranscribeServiceRequest {
 public:
  ...
  inline ListMedicalTranscriptionJobsRequest& WithStatus(TranscriptionJobStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename JobNameContainsT = Aws::String>
  ListMedicalTranscriptionJobsRequest& WithJobNameContains(JobNameContainsT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  ListMedicalTranscriptionJobsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListMedicalTranscriptionJobsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
