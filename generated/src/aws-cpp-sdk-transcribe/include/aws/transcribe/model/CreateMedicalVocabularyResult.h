...
class CreateMedicalVocabularyResult {
 public:
  ...
  AWS_TRANSCRIBESERVICE_API CreateMedicalVocabularyResult& operator=(
  ...
  inline CreateMedicalVocabularyResult& WithLanguageCode(LanguageCode value) {
  ...
  inline CreateMedicalVocabularyResult& WithVocabularyState(VocabularyState value) {
