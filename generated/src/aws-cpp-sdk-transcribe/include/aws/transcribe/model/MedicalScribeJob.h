...
class MedicalScribeJob {
 public:
  ...
  inline MedicalScribeJob& WithMedicalScribeJobStatus(MedicalScribeJobStatus value) {
  ...
  inline MedicalScribeJob& WithLanguageCode(MedicalScribeLanguageCode value) {
  ...
  void SetMedicalScribeOutput(MedicalScribeOutputT&& value) {
    ...
    m_medicalScribeOutput = std::forward<MedicalScribeOutputT>(value);
  }
  template <typename MedicalScribeOutputT = MedicalScribeOutput>
  MedicalScribeJob& WithMedicalScribeOutput(MedicalScribeOutputT&& value) {
    SetMedicalScribeOutput(std::forward<MedicalScribeOutputT>(value));
    return *this;
  }
  ///@}
  ...
  inline MedicalScribeJob& WithMedicalScribeContextProvided(bool value) {
