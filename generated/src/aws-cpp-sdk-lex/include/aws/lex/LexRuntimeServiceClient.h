...
class AWS_LEXRUNTIMESERVICE_API LexRuntimeServiceClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  LexRuntimeServiceClient(const Aws::LexRuntimeService::LexRuntimeServiceClientConfiguration& clientConfiguration =
  ...
  LexRuntimeServiceClient(const Aws::Auth::AWSCredentials& credentials,
                          std::shared_ptr<LexRuntimeServiceEndpointProviderBase> endpointProvider = nullptr,
                          const Aws::LexRuntimeService::LexRuntimeServiceClientConfiguration& clientConfiguration =
                              Aws::LexRuntimeService::LexRuntimeServiceClientConfiguration());
  ...
  Model::DeleteSessionOutcomeCallable DeleteSessionCallable(const DeleteSessionRequestT& request) const {
    return SubmitCallable(&LexRuntimeServiceClient::DeleteSession, request);
  }
  ...
  void DeleteSessionAsync(const DeleteSessionRequestT& request, const DeleteSessionResponseReceivedHandler& handler,
    ...
    return SubmitAsync(&LexRuntimeServiceClient::DeleteSession, request, handler, context);
  }
  ...
  Model::GetSessionOutcomeCallable GetSessionCallable(const GetSessionRequestT& request) const {
    return SubmitCallable(&LexRuntimeServiceClient::GetSession, request);
  }
  ...
  void GetSessionAsync(const GetSessionRequestT& request, const GetSessionResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&LexRuntimeServiceClient::GetSession, request, handler, context);
  }
   ...
   */
  template <typename PostContentRequestT = Model::PostContentRequest>
  Model::PostContentOutcomeCallable PostContentCallable(const PostContentRequestT& request) const {
    return SubmitCallable(&LexRuntimeServiceClient::PostContent, request);
  }

  /**
   * An Async wrapper for PostContent that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PostContentRequestT = Model::PostContentRequest>
  void PostContentAsync(const PostContentRequestT& request, const PostContentResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&LexRuntimeServiceClient::PostContent, request, handler, context);
  }
   ...
   */
  template <typename PostTextRequestT = Model::PostTextRequest>
  Model::PostTextOutcomeCallable PostTextCallable(const PostTextRequestT& request) const {
    return SubmitCallable(&LexRuntimeServiceClient::PostText, request);
  }

  /**
   * An Async wrapper for PostText that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PostTextRequestT = Model::PostTextRequest>
  void PostTextAsync(const PostTextRequestT& request, const PostTextResponseReceivedHandler& handler,
                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&LexRuntimeServiceClient::PostText, request, handler, context);
  }
  ...
  Model::PutSessionOutcomeCallable PutSessionCallable(const PutSessionRequestT& request) const {
    return SubmitCallable(&LexRuntimeServiceClient::PutSession, request);
  }
