...
class PostContentResult {
 public:
  ...
  void SetNluIntentConfidence(NluIntentConfidenceT&& value) {
    ...
    m_nluIntentConfidence = std::forward<NluIntentConfidenceT>(value);
  }
  template <typename NluIntentConfidenceT = Aws::String>
  PostContentResult& WithNluIntentConfidence(NluIntentConfidenceT&& value) {
    SetNluIntentConfidence(std::forward<NluIntentConfidenceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAlternativeIntents(AlternativeIntentsT&& value) {
    ...
    m_alternativeIntents = std::forward<AlternativeIntentsT>(value);
  }
  template <typename AlternativeIntentsT = Aws::String>
  PostContentResult& WithAlternativeIntents(AlternativeIntentsT&& value) {
    SetAlternativeIntents(std::forward<AlternativeIntentsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSessionAttributes(SessionAttributesT&& value) {
    ...
    m_sessionAttributes = std::forward<SessionAttributesT>(value);
  }
  template <typename SessionAttributesT = Aws::String>
  PostContentResult& WithSessionAttributes(SessionAttributesT&& value) {
    SetSessionAttributes(std::forward<SessionAttributesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSentimentResponse(SentimentResponseT&& value) {
    ...
    m_sentimentResponse = std::forward<SentimentResponseT>(value);
  }
  template <typename SentimentResponseT = Aws::String>
  PostContentResult& WithSentimentResponse(SentimentResponseT&& value) {
    SetSentimentResponse(std::forward<SentimentResponseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncodedMessage(EncodedMessageT&& value) {
    ...
    m_encodedMessage = std::forward<EncodedMessageT>(value);
  }
  template <typename EncodedMessageT = Aws::String>
  PostContentResult& WithEncodedMessage(EncodedMessageT&& value) {
    SetEncodedMessage(std::forward<EncodedMessageT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMessageFormat(MessageFormatType value) {
    m_messageFormatHasBeenSet = true;
    m_messageFormat = value;
  }
  inline PostContentResult& WithMessageFormat(MessageFormatType value) {
  ...
  inline void SetDialogState(DialogState value) {
    m_dialogStateHasBeenSet = true;
    m_dialogState = value;
  }
  inline PostContentResult& WithDialogState(DialogState value) {
  ...
  void SetSlotToElicit(SlotToElicitT&& value) {
    ...
    m_slotToElicit = std::forward<SlotToElicitT>(value);
  }
  template <typename SlotToElicitT = Aws::String>
  PostContentResult& WithSlotToElicit(SlotToElicitT&& value) {
    SetSlotToElicit(std::forward<SlotToElicitT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncodedInputTranscript(EncodedInputTranscriptT&& value) {
    ...
    m_encodedInputTranscript = std::forward<EncodedInputTranscriptT>(value);
  }
  template <typename EncodedInputTranscriptT = Aws::String>
  PostContentResult& WithEncodedInputTranscript(EncodedInputTranscriptT&& value) {
    SetEncodedInputTranscript(std::forward<EncodedInputTranscriptT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActiveContexts(ActiveContextsT&& value) {
    ...
    m_activeContexts = std::forward<ActiveContextsT>(value);
  }
  template <typename ActiveContextsT = Aws::String>
  PostContentResult& WithActiveContexts(ActiveContextsT&& value) {
    SetActiveContexts(std::forward<ActiveContextsT>(value));
    return *this;
  }
  ///@}
