...
class GetSessionRequest : public LexRuntimeServiceRequest {
 public:
  ...
  void SetCheckpointLabelFilter(CheckpointLabelFilterT&& value) {
    m_checkpointLabelFilterHasBeenSet = true;
    m_checkpointLabelFilter = std::forward<CheckpointLabelFilterT>(value);
  }
  template <typename CheckpointLabelFilterT = Aws::String>
  GetSessionRequest& WithCheckpointLabelFilter(CheckpointLabelFilterT&& value) {
    SetCheckpointLabelFilter(std::forward<CheckpointLabelFilterT>(value));
    return *this;
  }
  ///@}
 private:
