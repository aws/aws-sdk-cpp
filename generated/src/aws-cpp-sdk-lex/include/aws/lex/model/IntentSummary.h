...
class IntentSummary {
 public:
  ...
  void SetCheckpointLabel(CheckpointLabelT&& value) {
    ...
    m_checkpointLabel = std::forward<CheckpointLabelT>(value);
  }
  template <typename CheckpointLabelT = Aws::String>
  IntentSummary& WithCheckpointLabel(CheckpointLabelT&& value) {
    SetCheckpointLabel(std::forward<CheckpointLabelT>(value));
    return *this;
  }
  ///@}
  ...
  inline IntentSummary& WithConfirmationStatus(ConfirmationStatus value) {
  ...
  inline void SetDialogActionType(DialogActionType value) {
    m_dialogActionTypeHasBeenSet = true;
    m_dialogActionType = value;
  }
  inline IntentSummary& WithDialogActionType(DialogActionType value) {
    SetDialogActionType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFulfillmentState(FulfillmentState value) {
    m_fulfillmentStateHasBeenSet = true;
    m_fulfillmentState = value;
  }
  inline IntentSummary& WithFulfillmentState(FulfillmentState value) {
