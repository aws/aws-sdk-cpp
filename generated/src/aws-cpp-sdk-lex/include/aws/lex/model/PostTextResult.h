...
class PostTextResult {
 public:
  ...
  PostTextResult& AddAlternativeIntents(AlternativeIntentsT&& value) {
    m_alternativeIntentsHasBeenSet = true;
    m_alternativeIntents.emplace_back(std::forward<AlternativeIntentsT>(value));
    return *this;
  }
  ///@}
  ...
  inline PostTextResult& WithMessageFormat(MessageFormatType value) {
  ...
  inline PostTextResult& WithDialogState(DialogState value) {
