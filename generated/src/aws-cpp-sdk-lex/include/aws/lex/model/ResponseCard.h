...
class ResponseCard {
 public:
  ...
  inline ResponseCard& WithContentType(ContentType value) {
  ...
  void SetGenericAttachments(GenericAttachmentsT&& value) {
    ...
    m_genericAttachments = std::forward<GenericAttachmentsT>(value);
  }
  template <typename GenericAttachmentsT = Aws::Vector<GenericAttachment>>
  ResponseCard& WithGenericAttachments(GenericAttachmentsT&& value) {
    SetGenericAttachments(std::forward<GenericAttachmentsT>(value));
    return *this;
  }
  template <typename GenericAttachmentsT = GenericAttachment>
  ResponseCard& AddGenericAttachments(GenericAttachmentsT&& value) {
    m_genericAttachmentsHasBeenSet = true;
    m_genericAttachments.emplace_back(std::forward<GenericAttachmentsT>(value));
    return *this;
  }
  ///@}
 private:
