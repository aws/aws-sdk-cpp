...
class GetSessionResult {
 public:
  ...
  void SetRecentIntentSummaryView(RecentIntentSummaryViewT&& value) {
    ...
    m_recentIntentSummaryView = std::forward<RecentIntentSummaryViewT>(value);
  }
  template <typename RecentIntentSummaryViewT = Aws::Vector<IntentSummary>>
  GetSessionResult& WithRecentIntentSummaryView(RecentIntentSummaryViewT&& value) {
    SetRecentIntentSummaryView(std::forward<RecentIntentSummaryViewT>(value));
    return *this;
  }
  template <typename RecentIntentSummaryViewT = IntentSummary>
  GetSessionResult& AddRecentIntentSummaryView(RecentIntentSummaryViewT&& value) {
    m_recentIntentSummaryViewHasBeenSet = true;
    m_recentIntentSummaryView.emplace_back(std::forward<RecentIntentSummaryViewT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename SessionAttributesT = Aws::Map<Aws::String, Aws::String>>
  GetSessionResult& WithSessionAttributes(SessionAttributesT&& value) {
  ...
  GetSessionResult& AddSessionAttributes(SessionAttributesKeyT&& key, SessionAttributesValueT&& value) {
    m_sessionAttributesHasBeenSet = true;
    m_sessionAttributes.emplace(std::forward<SessionAttributesKeyT>(key), std::forward<SessionAttributesValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDialogAction(DialogActionT&& value) {
    ...
    m_dialogAction = std::forward<DialogActionT>(value);
  }
  template <typename DialogActionT = DialogAction>
  GetSessionResult& WithDialogAction(DialogActionT&& value) {
    SetDialogAction(std::forward<DialogActionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ActiveContextsT = Aws::Vector<ActiveContext>>
  GetSessionResult& WithActiveContexts(ActiveContextsT&& value) {
    SetActiveContexts(std::forward<ActiveContextsT>(value));
    return *this;
  }
  template <typename ActiveContextsT = ActiveContext>
  GetSessionResult& AddActiveContexts(ActiveContextsT&& value) {
    m_activeContextsHasBeenSet = true;
    m_activeContexts.emplace_back(std::forward<ActiveContextsT>(value));
    return *this;
  }
  ///@}
