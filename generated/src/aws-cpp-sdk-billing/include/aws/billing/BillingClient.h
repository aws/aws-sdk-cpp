...
namespace Billing
{
  AWS_BILLING_API extern const char SERVICE_NAME[];
  /**
   ...
   */
  class AWS_BILLING_API BillingClient : Aws::Client::ClientWithAsyncTemplateMethods<BillingClient>,
    smithy::client::AwsSmithyClientT<Aws::Billing::SERVICE_NAME,
      ...
      Aws::Client::BillingErrorMarshaller>
  {
    public:
      static const char* GetServiceName();
      static const char* GetAllocationTag();
      inline const char* GetServiceClientName() const override { return "Billing"; }
