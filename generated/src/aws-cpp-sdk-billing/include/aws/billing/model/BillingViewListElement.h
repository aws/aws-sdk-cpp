...
class BillingViewListElement {
 public:
  ...
  template <typename SourceAccountIdT = Aws::String>
  BillingViewListElement& WithSourceAccountId(SourceAccountIdT&& value) {
  ...
  inline BillingViewListElement& WithBillingViewType(BillingViewType value) {
  ...
  template <typename HealthStatusT = BillingViewHealthStatus>
  BillingViewListElement& WithHealthStatus(HealthStatusT&& value) {
