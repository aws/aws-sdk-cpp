...
class ActiveTimeRange {
 public:
  ...
  void SetActiveAfterInclusive(ActiveAfterInclusiveT&& value) {
    ...
    m_activeAfterInclusive = std::forward<ActiveAfterInclusiveT>(value);
  }
  template <typename ActiveAfterInclusiveT = Aws::Utils::DateTime>
  ActiveTimeRange& WithActiveAfterInclusive(ActiveAfterInclusiveT&& value) {
    SetActiveAfterInclusive(std::forward<ActiveAfterInclusiveT>(value));
    return *this;
  }
  ///@}
  ...
  void SetActiveBeforeInclusive(ActiveBeforeInclusiveT&& value) {
    ...
    m_activeBeforeInclusive = std::forward<ActiveBeforeInclusiveT>(value);
  }
  template <typename ActiveBeforeInclusiveT = Aws::Utils::DateTime>
  ActiveTimeRange& WithActiveBeforeInclusive(ActiveBeforeInclusiveT&& value) {
    SetActiveBeforeInclusive(std::forward<ActiveBeforeInclusiveT>(value));
    return *this;
  }
  ///@}
 private:
