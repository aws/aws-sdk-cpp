...
namespace Model
{
  ...
  /**
   */
  class DisassociateSourceViewsRequest : public BillingRequest
  {
  public:
    AWS_BILLING_API DisassociateSourceViewsRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "DisassociateSourceViews"; }
    ...
    ///@{
    /**
     * <p> The Amazon Resource Name (ARN) of the billing view to disassociate source
     * views from. </p>
     */
    ...
    template<typename ArnT = Aws::String>
    DisassociateSourceViewsRequest& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename SourceViewsT = Aws::Vector<Aws::String>>
    DisassociateSourceViewsRequest& WithSourceViews(SourceViewsT&& value) { SetSourceViews(std::forward<SourceViewsT>(value)); return *this;}
    template<typename SourceViewsT = Aws::String>
    DisassociateSourceViewsRequest& AddSourceViews(SourceViewsT&& value) { m_sourceViewsHasBeenSet = true; m_sourceViews.emplace_back(std::forward<SourceViewsT>(value)); return *this; }
    ///@}
  private:
