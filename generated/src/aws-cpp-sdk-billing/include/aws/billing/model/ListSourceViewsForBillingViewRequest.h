...
class ListSourceViewsForBillingViewRequest : public BillingRequest {
 public:
  ...
  template <typename ArnT = Aws::String>
  ListSourceViewsForBillingViewRequest& WithArn(ArnT&& value) {
  ...
  inline ListSourceViewsForBillingViewRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListSourceViewsForBillingViewRequest& WithNextToken(NextTokenT&& value) {
