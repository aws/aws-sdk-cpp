...
namespace Model
{
  ...
  /**
   * <p> You've reached the limit of resources you can create, or exceeded the size
   * of an individual resource. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/billing-2023-09-07/ServiceQuotaExceededException">AWS
   * API Reference</a></p>
   */
  class ServiceQuotaExceededException
  {
  public:
    AWS_BILLING_API ServiceQuotaExceededException();
