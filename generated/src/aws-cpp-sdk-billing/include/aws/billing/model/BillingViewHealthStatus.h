...
class BillingViewHealthStatus {
 public:
  ...
  inline void SetStatusCode(BillingViewStatus value) {
    m_statusCodeHasBeenSet = true;
    m_statusCode = value;
  }
  inline BillingViewHealthStatus& WithStatusCode(BillingViewStatus value) {
    SetStatusCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusReasonsT = Aws::Vector<BillingViewStatusReason>>
  BillingViewHealthStatus& WithStatusReasons(StatusReasonsT&& value) {
    SetStatusReasons(std::forward<StatusReasonsT>(value));
    return *this;
  }
  inline BillingViewHealthStatus& AddStatusReasons(BillingViewStatusReason value) {
    m_statusReasonsHasBeenSet = true;
