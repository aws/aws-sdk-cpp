...
class GetBillingViewResult {
 public:
  ...
  void SetBillingView(BillingViewT&& value) {
    m_billingViewHasBeenSet = true;
    m_billingView = std::forward<BillingViewT>(value);
  }
  template <typename BillingViewT = BillingViewElement>
  GetBillingViewResult& WithBillingView(BillingViewT&& value) {
    SetBillingView(std::forward<BillingViewT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  GetBillingViewResult& WithRequestId(RequestIdT&& value) {
