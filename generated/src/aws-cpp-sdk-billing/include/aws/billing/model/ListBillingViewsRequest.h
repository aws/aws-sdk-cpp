...
class ListBillingViewsRequest : public BillingRequest {
 public:
  ...
  void SetActiveTimeRange(ActiveTimeRangeT&& value) {
    m_activeTimeRangeHasBeenSet = true;
    m_activeTimeRange = std::forward<ActiveTimeRangeT>(value);
  }
  template <typename ActiveTimeRangeT = ActiveTimeRange>
  ListBillingViewsRequest& WithActiveTimeRange(ActiveTimeRangeT&& value) {
    SetActiveTimeRange(std::forward<ActiveTimeRangeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBillingViewTypes(BillingViewTypesT&& value) {
    m_billingViewTypesHasBeenSet = true;
    m_billingViewTypes = std::forward<BillingViewTypesT>(value);
  }
  template <typename BillingViewTypesT = Aws::Vector<BillingViewType>>
  ListBillingViewsRequest& WithBillingViewTypes(BillingViewTypesT&& value) {
    SetBillingViewTypes(std::forward<BillingViewTypesT>(value));
    return *this;
  }
  inline ListBillingViewsRequest& AddBillingViewTypes(BillingViewType value) {
    m_billingViewTypesHasBeenSet = true;
    m_billingViewTypes.push_back(value);
    return *this;
  }
  ///@}
  ...
  template <typename SourceAccountIdT = Aws::String>
  ListBillingViewsRequest& WithSourceAccountId(SourceAccountIdT&& value) {
  ...
  inline ListBillingViewsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
