...
/**
 * <p>The request structure for GetEnterpriseSupportChargeSummary.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/billing-2023-09-07/GetEnterpriseSupportChargeSummaryRequest">AWS
 * API Reference</a></p>
 */
class GetEnterpriseSupportChargeSummaryRequest : public BillingRequest {
 public:
  AWS_BILLING_API GetEnterpriseSupportChargeSummaryRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetEnterpriseSupportChargeSummary"; }
  ...
  template <typename BillingMonthT = Aws::String>
  GetEnterpriseSupportChargeSummaryRequest& WithBillingMonth(BillingMonthT&& value) {
