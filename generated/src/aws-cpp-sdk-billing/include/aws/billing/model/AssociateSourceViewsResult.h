...
namespace Model
{
  class AssociateSourceViewsResult
  {
  public:
    ...
    template<typename ArnT = Aws::String>
    AssociateSourceViewsResult& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RequestIdT = Aws::String>
    AssociateSourceViewsResult& WithRequestId(RequestIdT&& value) { SetRequestId(std::forward<RequestIdT>(value)); return *this;}
    ///@}
  private:
