...
namespace Billing
{
const size_t BillingEndpointRules::RulesBlobStrLen = 1864;
const size_t BillingEndpointRules::RulesBlobSize = 1865;
...
'u','r','l','"',':','"','h','t','t','p','s',':','/','/','b','i','l','l','i','n','g','-','f','i','p',
...
'"',':','"','h','t','t','p','s',':','/','/','b','i','l','l','i','n','g','.','{','P','a','r','t','i',
