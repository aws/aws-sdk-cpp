...
class EnableAwsNetworkPerformanceMetricSubscriptionRequest : public EC2Request {
 ...
 public:
  ...
  template <typename SourceT = Aws::String>
  EnableAwsNetworkPerformanceMetricSubscriptionRequest& WithSource(SourceT&& value) {
  ...
  template <typename DestinationT = Aws::String>
  EnableAwsNetworkPerformanceMetricSubscriptionRequest& WithDestination(DestinationT&& value) {
  ...
  inline EnableAwsNetworkPerformanceMetricSubscriptionRequest& WithMetric(MetricType value) {
    SetMetric(value);
    return *this;
  }
  ///@}
  ...
  inline EnableAwsNetworkPerformanceMetricSubscriptionRequest& WithStatistic(StatisticType value) {
    SetStatistic(value);
    return *this;
  }
  ///@}
  ...
  inline EnableAwsNetworkPerformanceMetricSubscriptionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
