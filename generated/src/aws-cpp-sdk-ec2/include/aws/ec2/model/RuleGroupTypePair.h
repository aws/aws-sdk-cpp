...
class RuleGroupTypePair {
 public:
  ...
  template <typename RuleGroupArnT = Aws::String>
  RuleGroupTypePair& WithRuleGroupArn(RuleGroupArnT&& value) {
  ...
  void SetRuleGroupType(RuleGroupTypeT&& value) {
    m_ruleGroupTypeHasBeenSet = true;
    m_ruleGroupType = std::forward<RuleGroupTypeT>(value);
  }
  template <typename RuleGroupTypeT = Aws::String>
  RuleGroupTypePair& WithRuleGroupType(RuleGroupTypeT&& value) {
    SetRuleGroupType(std::forward<RuleGroupTypeT>(value));
    return *this;
  }
  ///@}
 private:
