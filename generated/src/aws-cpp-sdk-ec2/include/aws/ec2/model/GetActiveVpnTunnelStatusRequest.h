...
namespace Model
{
  ...
  /**
   */
  class GetActiveVpnTunnelStatusRequest : public EC2Request
  {
  public:
    AWS_EC2_API GetActiveVpnTunnelStatusRequest() = default;

    // Service request name is the Operation name which will send this request out,
    // each operation should has unique request name, so that we can get operation's name from this request.
    // Note: this is not true for response, multiple operations may have the same response name,
    // so we can not get operation's name from response.
    inline virtual const char* GetServiceRequestName() const override { return "GetActiveVpnTunnelStatus"; }
  ...
  public:
    ...
    ///@{
    /**
     * <p>The ID of the VPN connection for which to retrieve the active tunnel
     * status.</p>
     */
    ...
    template<typename VpnConnectionIdT = Aws::String>
    GetActiveVpnTunnelStatusRequest& WithVpnConnectionId(VpnConnectionIdT&& value) { SetVpnConnectionId(std::forward<VpnConnectionIdT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>The external IP address of the VPN tunnel for which to retrieve the active
     * status.</p>
     */
    ...
    template<typename VpnTunnelOutsideIpAddressT = Aws::String>
    GetActiveVpnTunnelStatusRequest& WithVpnTunnelOutsideIpAddress(VpnTunnelOutsideIpAddressT&& value) { SetVpnTunnelOutsideIpAddress(std::forward<VpnTunnelOutsideIpAddressT>(value)); return *this;}
    ///@}

    ///@{
    /**
     * <p>Checks whether you have the required permissions for the action, without
     * actually making the request.</p>
     */
    inline bool GetDryRun() const { return m_dryRun; }
    inline bool DryRunHasBeenSet() const { return m_dryRunHasBeenSet; }
    inline void SetDryRun(bool value) { m_dryRunHasBeenSet = true; m_dryRun = value; }
    inline GetActiveVpnTunnelStatusRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
  private:
