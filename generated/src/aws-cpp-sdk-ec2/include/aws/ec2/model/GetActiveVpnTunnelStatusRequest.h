...
class GetActiveVpnTunnelStatusRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VpnConnectionIdT = Aws::String>
  GetActiveVpnTunnelStatusRequest& WithVpnConnectionId(VpnConnectionIdT&& value) {
  ...
  void SetVpnTunnelOutsideIpAddress(VpnTunnelOutsideIpAddressT&& value) {
    ...
    m_vpnTunnelOutsideIpAddress = std::forward<VpnTunnelOutsideIpAddressT>(value);
  }
  template <typename VpnTunnelOutsideIpAddressT = Aws::String>
  GetActiveVpnTunnelStatusRequest& WithVpnTunnelOutsideIpAddress(VpnTunnelOutsideIpAddressT&& value) {
    SetVpnTunnelOutsideIpAddress(std::forward<VpnTunnelOutsideIpAddressT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetActiveVpnTunnelStatusRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
