...
class DescribeIpamPoolsResponse {
 public:
  AWS_EC2_API DescribeIpamPoolsResponse() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIpamPoolsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename IpamPoolsT = Aws::Vector<IpamPool>>
  void SetIpamPools(IpamPoolsT&& value) {
    m_ipamPoolsHasBeenSet = true;
    m_ipamPools = std::forward<IpamPoolsT>(value);
  }
  template <typename IpamPoolsT = Aws::Vector<IpamPool>>
  DescribeIpamPoolsResponse& WithIpamPools(IpamPoolsT&& value) {
    SetIpamPools(std::forward<IpamPoolsT>(value));
    return *this;
  }
  template <typename IpamPoolsT = IpamPool>
  DescribeIpamPoolsResponse& AddIpamPools(IpamPoolsT&& value) {
    m_ipamPoolsHasBeenSet = true;
    m_ipamPools.emplace_back(std::forward<IpamPoolsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeIpamPoolsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
