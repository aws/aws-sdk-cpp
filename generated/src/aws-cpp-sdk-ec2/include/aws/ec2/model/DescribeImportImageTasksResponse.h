...
class DescribeImportImageTasksResponse {
 public:
  ...
  void SetImportImageTasks(ImportImageTasksT&& value) {
    m_importImageTasksHasBeenSet = true;
    m_importImageTasks = std::forward<ImportImageTasksT>(value);
  }
  template <typename ImportImageTasksT = Aws::Vector<ImportImageTask>>
  DescribeImportImageTasksResponse& WithImportImageTasks(ImportImageTasksT&& value) {
    SetImportImageTasks(std::forward<ImportImageTasksT>(value));
    return *this;
  }
  template <typename ImportImageTasksT = ImportImageTask>
  DescribeImportImageTasksResponse& AddImportImageTasks(ImportImageTasksT&& value) {
    m_importImageTasksHasBeenSet = true;
    m_importImageTasks.emplace_back(std::forward<ImportImageTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImportImageTasksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeImportImageTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
