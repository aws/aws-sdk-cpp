...
class LaunchTemplateInstanceNetworkInterfaceSpecificationRequest {
 public:
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithAssociateCarrierIpAddress(bool value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithAssociatePublicIpAddress(bool value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithDeleteOnTermination(bool value) {
  ...
  template <typename DescriptionT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithDescription(DescriptionT&& value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithDeviceIndex(int value) {
  ...
  template <typename GroupsT = Aws::Vector<Aws::String>>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename InterfaceTypeT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithInterfaceType(InterfaceTypeT&& value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv6AddressCount(int value) {
  ...
  template <typename Ipv6AddressesT = Aws::Vector<InstanceIpv6AddressRequest>>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv6Addresses(Ipv6AddressesT&& value) {
    SetIpv6Addresses(std::forward<Ipv6AddressesT>(value));
    return *this;
  }
  template <typename Ipv6AddressesT = InstanceIpv6AddressRequest>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& AddIpv6Addresses(Ipv6AddressesT&& value) {
    m_ipv6AddressesHasBeenSet = true;
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename PrivateIpAddressT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithPrivateIpAddress(PrivateIpAddressT&& value) {
  ...
  template <typename PrivateIpAddressesT = Aws::Vector<PrivateIpAddressSpecification>>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithPrivateIpAddresses(PrivateIpAddressesT&& value) {
  ...
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& AddPrivateIpAddresses(PrivateIpAddressesT&& value) {
    m_privateIpAddressesHasBeenSet = true;
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithSecondaryPrivateIpAddressCount(int value) {
  ...
  template <typename SubnetIdT = Aws::String>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithSubnetId(SubnetIdT&& value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithNetworkCardIndex(int value) {
  ...
  template <typename Ipv4PrefixesT = Aws::Vector<Ipv4PrefixSpecificationRequest>>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv4Prefixes(Ipv4PrefixesT&& value) {
    SetIpv4Prefixes(std::forward<Ipv4PrefixesT>(value));
    return *this;
  }
  template <typename Ipv4PrefixesT = Ipv4PrefixSpecificationRequest>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& AddIpv4Prefixes(Ipv4PrefixesT&& value) {
    m_ipv4PrefixesHasBeenSet = true;
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv4PrefixCount(int value) {
  ...
  template <typename Ipv6PrefixesT = Aws::Vector<Ipv6PrefixSpecificationRequest>>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv6Prefixes(Ipv6PrefixesT&& value) {
    SetIpv6Prefixes(std::forward<Ipv6PrefixesT>(value));
    return *this;
  }
  template <typename Ipv6PrefixesT = Ipv6PrefixSpecificationRequest>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& AddIpv6Prefixes(Ipv6PrefixesT&& value) {
    m_ipv6PrefixesHasBeenSet = true;
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithIpv6PrefixCount(int value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithPrimaryIpv6(bool value) {
  ...
  template <typename EnaSrdSpecificationT = EnaSrdSpecificationRequest>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithEnaSrdSpecification(EnaSrdSpecificationT&& value) {
  ...
  template <typename ConnectionTrackingSpecificationT = ConnectionTrackingSpecificationRequest>
  LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithConnectionTrackingSpecification(
      ConnectionTrackingSpecificationT&& value) {
  ...
  inline LaunchTemplateInstanceNetworkInterfaceSpecificationRequest& WithEnaQueueCount(int value) {
