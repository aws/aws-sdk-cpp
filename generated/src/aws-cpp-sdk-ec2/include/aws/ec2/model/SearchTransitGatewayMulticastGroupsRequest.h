...
class SearchTransitGatewayMulticastGroupsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  SearchTransitGatewayMulticastGroupsRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  SearchTransitGatewayMulticastGroupsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  SearchTransitGatewayMulticastGroupsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline SearchTransitGatewayMulticastGroupsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchTransitGatewayMulticastGroupsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline SearchTransitGatewayMulticastGroupsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
