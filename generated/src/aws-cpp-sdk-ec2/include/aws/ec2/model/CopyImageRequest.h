...
class CopyImageRequest : public EC2Request {
 ...
 public:
  ...
  inline CopyImageRequest& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationOutpostArn(DestinationOutpostArnT&& value) {
    m_destinationOutpostArnHasBeenSet = true;
    m_destinationOutpostArn = std::forward<DestinationOutpostArnT>(value);
  }
  template <typename DestinationOutpostArnT = Aws::String>
  CopyImageRequest& WithDestinationOutpostArn(DestinationOutpostArnT&& value) {
    SetDestinationOutpostArn(std::forward<DestinationOutpostArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetCopyImageTags(bool value) {
    m_copyImageTagsHasBeenSet = true;
    m_copyImageTags = value;
  }
  inline CopyImageRequest& WithCopyImageTags(bool value) {
    SetCopyImageTags(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSnapshotCopyCompletionDurationMinutes(long long value) {
    m_snapshotCopyCompletionDurationMinutesHasBeenSet = true;
    m_snapshotCopyCompletionDurationMinutes = value;
  }
  inline CopyImageRequest& WithSnapshotCopyCompletionDurationMinutes(long long value) {
    SetSnapshotCopyCompletionDurationMinutes(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationAvailabilityZone(DestinationAvailabilityZoneT&& value) {
    m_destinationAvailabilityZoneHasBeenSet = true;
    m_destinationAvailabilityZone = std::forward<DestinationAvailabilityZoneT>(value);
  }
  template <typename DestinationAvailabilityZoneT = Aws::String>
  CopyImageRequest& WithDestinationAvailabilityZone(DestinationAvailabilityZoneT&& value) {
    SetDestinationAvailabilityZone(std::forward<DestinationAvailabilityZoneT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationAvailabilityZoneId(DestinationAvailabilityZoneIdT&& value) {
    m_destinationAvailabilityZoneIdHasBeenSet = true;
    m_destinationAvailabilityZoneId = std::forward<DestinationAvailabilityZoneIdT>(value);
  }
  template <typename DestinationAvailabilityZoneIdT = Aws::String>
  CopyImageRequest& WithDestinationAvailabilityZoneId(DestinationAvailabilityZoneIdT&& value) {
    SetDestinationAvailabilityZoneId(std::forward<DestinationAvailabilityZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline CopyImageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
