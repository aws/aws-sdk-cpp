...
/**
 */
class DeleteIpamRoutingPolicyRegistrationRequest : public EC2Request {
 public:
  AWS_EC2_API DeleteIpamRoutingPolicyRegistrationRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "DeleteIpamRoutingPolicyRegistration"; }
 ...
 public:
  ...
  inline DeleteIpamRoutingPolicyRegistrationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamInternetRegistryAssociationIdT = Aws::String>
  DeleteIpamRoutingPolicyRegistrationRequest& WithIpamInternetRegistryAssociationId(IpamInternetRegistryAssociationIdT&& value) {
  ...
  template <typename CidrT = Aws::String>
  DeleteIpamRoutingPolicyRegistrationRequest& WithCidr(CidrT&& value) {
  ...
  ///@{
  /**
   * <p>Forces the deletion even if it conflicts with an announced route. Default:
   * <code>false</code>.</p>
   */
  ...
  inline DeleteIpamRoutingPolicyRegistrationRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteIpamRoutingPolicyRegistrationRequest& WithClientToken(ClientTokenT&& value) {
