...
class RejectVpcEndpointConnectionsResponse {
 public:
  ...
  template <typename UnsuccessfulT = Aws::Vector<UnsuccessfulItem>>
  RejectVpcEndpointConnectionsResponse& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = UnsuccessfulItem>
  RejectVpcEndpointConnectionsResponse& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RejectVpcEndpointConnectionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
