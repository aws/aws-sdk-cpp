...
class CreateNetworkInsightsAccessScopeRequest : public EC2Request {
 ...
 public:
  ...
  template <typename MatchPathsT = Aws::Vector<AccessScopePathRequest>>
  CreateNetworkInsightsAccessScopeRequest& WithMatchPaths(MatchPathsT&& value) {
    SetMatchPaths(std::forward<MatchPathsT>(value));
    return *this;
  }
  template <typename MatchPathsT = AccessScopePathRequest>
  CreateNetworkInsightsAccessScopeRequest& AddMatchPaths(MatchPathsT&& value) {
    m_matchPathsHasBeenSet = true;
    m_matchPaths.emplace_back(std::forward<MatchPathsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetExcludePaths(ExcludePathsT&& value) {
    ...
    m_excludePaths = std::forward<ExcludePathsT>(value);
  }
  template <typename ExcludePathsT = Aws::Vector<AccessScopePathRequest>>
  CreateNetworkInsightsAccessScopeRequest& WithExcludePaths(ExcludePathsT&& value) {
    SetExcludePaths(std::forward<ExcludePathsT>(value));
    return *this;
  }
  template <typename ExcludePathsT = AccessScopePathRequest>
  CreateNetworkInsightsAccessScopeRequest& AddExcludePaths(ExcludePathsT&& value) {
    m_excludePathsHasBeenSet = true;
    m_excludePaths.emplace_back(std::forward<ExcludePathsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateNetworkInsightsAccessScopeRequest& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateNetworkInsightsAccessScopeRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateNetworkInsightsAccessScopeRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  inline CreateNetworkInsightsAccessScopeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
