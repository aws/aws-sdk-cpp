...
class DisassociateClientVpnTargetNetworkResponse {
 public:
  ...
  AWS_EC2_API DisassociateClientVpnTargetNetworkResponse& operator=(
  ...
  template <typename AssociationIdT = Aws::String>
  DisassociateClientVpnTargetNetworkResponse& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename StatusT = AssociationStatus>
  DisassociateClientVpnTargetNetworkResponse& WithStatus(StatusT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateClientVpnTargetNetworkResponse& WithResponseMetadata(ResponseMetadataT&& value) {
