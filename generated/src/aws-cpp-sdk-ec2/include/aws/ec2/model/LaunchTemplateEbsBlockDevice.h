...
class LaunchTemplateEbsBlockDevice {
 public:
  ...
  inline LaunchTemplateEbsBlockDevice& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateEbsBlockDevice& WithDeleteOnTermination(bool value) {
  ...
  inline LaunchTemplateEbsBlockDevice& WithIops(int value) {
    SetIops(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateEbsBlockDevice& WithVolumeSize(int value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateEbsBlockDevice& WithVolumeType(VolumeType value) {
    SetVolumeType(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateEbsBlockDevice& WithThroughput(int value) {
    SetThroughput(value);
    return *this;
  }
  ///@}
  ...
  inline LaunchTemplateEbsBlockDevice& WithVolumeInitializationRate(int value) {
  ...
  inline LaunchTemplateEbsBlockDevice& WithEbsCardIndex(int value) {
