...
namespace Model
{
  ...
  public:
    ...
    AWS_EC2_API DeleteLocalGatewayVirtualInterfaceResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
    ...
    template<typename LocalGatewayVirtualInterfaceT = LocalGatewayVirtualInterface>
    DeleteLocalGatewayVirtualInterfaceResponse& WithLocalGatewayVirtualInterface(LocalGatewayVirtualInterfaceT&& value) { SetLocalGatewayVirtualInterface(std::forward<LocalGatewayVirtualInterfaceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteLocalGatewayVirtualInterfaceResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
