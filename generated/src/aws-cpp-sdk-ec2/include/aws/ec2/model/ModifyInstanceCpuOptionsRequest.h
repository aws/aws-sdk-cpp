...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyInstanceCpuOptionsRequest();
  ...
  public:
    ...
    inline ModifyInstanceCpuOptionsRequest& WithInstanceId(const Aws::String& value) { SetInstanceId(value); return *this;}
    inline ModifyInstanceCpuOptionsRequest& WithInstanceId(Aws::String&& value) { SetInstanceId(std::move(value)); return *this;}
    inline ModifyInstanceCpuOptionsRequest& WithInstanceId(const char* value) { SetInstanceId(value); return *this;}
    ///@}
