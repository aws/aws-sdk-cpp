...
class IpamResourceDiscoveryAssociation {
 public:
  ...
  void SetIpamResourceDiscoveryAssociationId(IpamResourceDiscoveryAssociationIdT&& value) {
    ...
    m_ipamResourceDiscoveryAssociationId = std::forward<IpamResourceDiscoveryAssociationIdT>(value);
  }
  template <typename IpamResourceDiscoveryAssociationIdT = Aws::String>
  IpamResourceDiscoveryAssociation& WithIpamResourceDiscoveryAssociationId(IpamResourceDiscoveryAssociationIdT&& value) {
    SetIpamResourceDiscoveryAssociationId(std::forward<IpamResourceDiscoveryAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpamResourceDiscoveryAssociationArn(IpamResourceDiscoveryAssociationArnT&& value) {
    ...
    m_ipamResourceDiscoveryAssociationArn = std::forward<IpamResourceDiscoveryAssociationArnT>(value);
  }
  template <typename IpamResourceDiscoveryAssociationArnT = Aws::String>
  IpamResourceDiscoveryAssociation& WithIpamResourceDiscoveryAssociationArn(IpamResourceDiscoveryAssociationArnT&& value) {
    SetIpamResourceDiscoveryAssociationArn(std::forward<IpamResourceDiscoveryAssociationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline IpamResourceDiscoveryAssociation& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline void SetResourceDiscoveryStatus(IpamAssociatedResourceDiscoveryStatus value) {
    m_resourceDiscoveryStatusHasBeenSet = true;
    m_resourceDiscoveryStatus = value;
  }
  inline IpamResourceDiscoveryAssociation& WithResourceDiscoveryStatus(IpamAssociatedResourceDiscoveryStatus value) {
    SetResourceDiscoveryStatus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(IpamResourceDiscoveryAssociationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline IpamResourceDiscoveryAssociation& WithState(IpamResourceDiscoveryAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
