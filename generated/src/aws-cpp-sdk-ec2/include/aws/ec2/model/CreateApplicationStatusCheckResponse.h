...
namespace EC2 {
namespace Model {
class CreateApplicationStatusCheckResponse {
 public:
  AWS_EC2_API CreateApplicationStatusCheckResponse() = default;
  AWS_EC2_API CreateApplicationStatusCheckResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateApplicationStatusCheckResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ApplicationStatusCheckT = ApplicationStatusCheckResponseObject>
  CreateApplicationStatusCheckResponse& WithApplicationStatusCheck(ApplicationStatusCheckT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateApplicationStatusCheckResponse& WithResponseMetadata(ResponseMetadataT&& value) {
