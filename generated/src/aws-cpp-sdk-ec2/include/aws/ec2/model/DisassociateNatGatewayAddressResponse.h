...
class DisassociateNatGatewayAddressResponse {
 public:
  AWS_EC2_API DisassociateNatGatewayAddressResponse() = default;
  ...
  template <typename NatGatewayIdT = Aws::String>
  DisassociateNatGatewayAddressResponse& WithNatGatewayId(NatGatewayIdT&& value) {
  ...
  template <typename NatGatewayAddressesT = Aws::Vector<NatGatewayAddress>>
  DisassociateNatGatewayAddressResponse& WithNatGatewayAddresses(NatGatewayAddressesT&& value) {
    SetNatGatewayAddresses(std::forward<NatGatewayAddressesT>(value));
    return *this;
  }
  template <typename NatGatewayAddressesT = NatGatewayAddress>
  DisassociateNatGatewayAddressResponse& AddNatGatewayAddresses(NatGatewayAddressesT&& value) {
    m_natGatewayAddressesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateNatGatewayAddressResponse& WithResponseMetadata(ResponseMetadataT&& value) {
