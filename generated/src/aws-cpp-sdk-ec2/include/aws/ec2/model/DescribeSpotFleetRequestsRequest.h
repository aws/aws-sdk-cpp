...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DescribeSpotFleetRequestsRequest() = default;
  ...
  public:
    ...
    template<typename SpotFleetRequestIdsT = Aws::Vector<Aws::String>>
    DescribeSpotFleetRequestsRequest& WithSpotFleetRequestIds(SpotFleetRequestIdsT&& value) { SetSpotFleetRequestIds(std::forward<SpotFleetRequestIdsT>(value)); return *this;}
    template<typename SpotFleetRequestIdsT = Aws::String>
    DescribeSpotFleetRequestsRequest& AddSpotFleetRequestIds(SpotFleetRequestIdsT&& value) { m_spotFleetRequestIdsHasBeenSet = true; m_spotFleetRequestIds.emplace_back(std::forward<SpotFleetRequestIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeSpotFleetRequestsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
