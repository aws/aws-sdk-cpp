...
class DescribeSpotFleetRequestsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeSpotFleetRequestsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetSpotFleetRequestIds(SpotFleetRequestIdsT&& value) {
    m_spotFleetRequestIdsHasBeenSet = true;
    m_spotFleetRequestIds = std::forward<SpotFleetRequestIdsT>(value);
  }
  template <typename SpotFleetRequestIdsT = Aws::Vector<Aws::String>>
  DescribeSpotFleetRequestsRequest& WithSpotFleetRequestIds(SpotFleetRequestIdsT&& value) {
    SetSpotFleetRequestIds(std::forward<SpotFleetRequestIdsT>(value));
    return *this;
  }
  ...
  DescribeSpotFleetRequestsRequest& AddSpotFleetRequestIds(SpotFleetRequestIdsT&& value) {
    m_spotFleetRequestIdsHasBeenSet = true;
    m_spotFleetRequestIds.emplace_back(std::forward<SpotFleetRequestIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeSpotFleetRequestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
