...
class TransitGatewayPeeringAttachment {
 public:
  ...
  void SetAccepterTransitGatewayAttachmentId(AccepterTransitGatewayAttachmentIdT&& value) {
    ...
    m_accepterTransitGatewayAttachmentId = std::forward<AccepterTransitGatewayAttachmentIdT>(value);
  }
  template <typename AccepterTransitGatewayAttachmentIdT = Aws::String>
  TransitGatewayPeeringAttachment& WithAccepterTransitGatewayAttachmentId(AccepterTransitGatewayAttachmentIdT&& value) {
    SetAccepterTransitGatewayAttachmentId(std::forward<AccepterTransitGatewayAttachmentIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRequesterTgwInfo(RequesterTgwInfoT&& value) {
    ...
    m_requesterTgwInfo = std::forward<RequesterTgwInfoT>(value);
  }
  template <typename RequesterTgwInfoT = PeeringTgwInfo>
  TransitGatewayPeeringAttachment& WithRequesterTgwInfo(RequesterTgwInfoT&& value) {
    SetRequesterTgwInfo(std::forward<RequesterTgwInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAccepterTgwInfo(AccepterTgwInfoT&& value) {
    ...
    m_accepterTgwInfo = std::forward<AccepterTgwInfoT>(value);
  }
  template <typename AccepterTgwInfoT = PeeringTgwInfo>
  TransitGatewayPeeringAttachment& WithAccepterTgwInfo(AccepterTgwInfoT&& value) {
    SetAccepterTgwInfo(std::forward<AccepterTgwInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline TransitGatewayPeeringAttachment& WithState(TransitGatewayAttachmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
