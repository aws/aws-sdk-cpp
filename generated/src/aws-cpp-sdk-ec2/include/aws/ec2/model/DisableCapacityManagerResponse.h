...
class DisableCapacityManagerResponse {
 public:
  ...
  inline DisableCapacityManagerResponse& WithCapacityManagerStatus(CapacityManagerStatus value) {
  ...
  inline DisableCapacityManagerResponse& WithOrganizationsAccess(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableCapacityManagerResponse& WithResponseMetadata(ResponseMetadataT&& value) {
