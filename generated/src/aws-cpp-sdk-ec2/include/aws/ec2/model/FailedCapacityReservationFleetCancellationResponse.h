...
class FailedCapacityReservationFleetCancellationResponse {
 public:
  ...
  template <typename CapacityReservationFleetIdT = Aws::String>
  FailedCapacityReservationFleetCancellationResponse& WithCapacityReservationFleetId(CapacityReservationFleetIdT&& value) {
   ...
   */
  inline const CancelCapacityReservationFleetError& GetCancelCapacityReservationFleetError() const {
    return m_cancelCapacityReservationFleetError;
  }
  ...
  void SetCancelCapacityReservationFleetError(CancelCapacityReservationFleetErrorT&& value) {
    m_cancelCapacityReservationFleetErrorHasBeenSet = true;
    m_cancelCapacityReservationFleetError = std::forward<CancelCapacityReservationFleetErrorT>(value);
  }
  template <typename CancelCapacityReservationFleetErrorT = CancelCapacityReservationFleetError>
  FailedCapacityReservationFleetCancellationResponse& WithCancelCapacityReservationFleetError(
      CancelCapacityReservationFleetErrorT&& value) {
    SetCancelCapacityReservationFleetError(std::forward<CancelCapacityReservationFleetErrorT>(value));
    return *this;
  }
  ///@}
 private:
