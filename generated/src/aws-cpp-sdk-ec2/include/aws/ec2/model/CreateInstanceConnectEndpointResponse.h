...
class CreateInstanceConnectEndpointResponse {
 public:
  ...
  template <typename InstanceConnectEndpointT = Ec2InstanceConnectEndpoint>
  CreateInstanceConnectEndpointResponse& WithInstanceConnectEndpoint(InstanceConnectEndpointT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateInstanceConnectEndpointResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateInstanceConnectEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
