...
class DescribeTrafficMirrorSessionsRequest : public EC2Request {
 ...
 public:
  ...
  void SetTrafficMirrorSessionIds(TrafficMirrorSessionIdsT&& value) {
    m_trafficMirrorSessionIdsHasBeenSet = true;
    m_trafficMirrorSessionIds = std::forward<TrafficMirrorSessionIdsT>(value);
  }
  template <typename TrafficMirrorSessionIdsT = Aws::Vector<Aws::String>>
  DescribeTrafficMirrorSessionsRequest& WithTrafficMirrorSessionIds(TrafficMirrorSessionIdsT&& value) {
    SetTrafficMirrorSessionIds(std::forward<TrafficMirrorSessionIdsT>(value));
    return *this;
  }
  template <typename TrafficMirrorSessionIdsT = Aws::String>
  DescribeTrafficMirrorSessionsRequest& AddTrafficMirrorSessionIds(TrafficMirrorSessionIdsT&& value) {
    m_trafficMirrorSessionIdsHasBeenSet = true;
    m_trafficMirrorSessionIds.emplace_back(std::forward<TrafficMirrorSessionIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTrafficMirrorSessionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeTrafficMirrorSessionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeTrafficMirrorSessionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeTrafficMirrorSessionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorSessionsRequest& WithNextToken(NextTokenT&& value) {
