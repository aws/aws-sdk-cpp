...
class S3Storage {
 public:
  ...
  void SetAWSAccessKeyId(AWSAccessKeyIdT&& value) {
    ...
    m_aWSAccessKeyId = std::forward<AWSAccessKeyIdT>(value);
  }
  template <typename AWSAccessKeyIdT = Aws::String>
  S3Storage& WithAWSAccessKeyId(AWSAccessKeyIdT&& value) {
    SetAWSAccessKeyId(std::forward<AWSAccessKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUploadPolicySignature(UploadPolicySignatureT&& value) {
    ...
    m_uploadPolicySignature = std::forward<UploadPolicySignatureT>(value);
  }
  template <typename UploadPolicySignatureT = Aws::String>
  S3Storage& WithUploadPolicySignature(UploadPolicySignatureT&& value) {
    SetUploadPolicySignature(std::forward<UploadPolicySignatureT>(value));
    return *this;
  }
  ///@}
 private:
