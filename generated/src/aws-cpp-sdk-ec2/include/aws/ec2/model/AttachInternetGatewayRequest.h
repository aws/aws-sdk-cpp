...
namespace Model
{
  ...
  /**
   */
  class AttachInternetGatewayRequest : public EC2Request
  {
  public:
  ...
  public:
    ...
    template<typename InternetGatewayIdT = Aws::String>
    AttachInternetGatewayRequest& WithInternetGatewayId(InternetGatewayIdT&& value) { SetInternetGatewayId(std::forward<InternetGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    AttachInternetGatewayRequest& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
  private:
