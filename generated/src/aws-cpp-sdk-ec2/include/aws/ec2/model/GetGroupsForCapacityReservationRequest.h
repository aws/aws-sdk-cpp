...
class GetGroupsForCapacityReservationRequest : public EC2Request {
 public:
  AWS_EC2_API GetGroupsForCapacityReservationRequest() = default;
 ...
 public:
  ...
  template <typename CapacityReservationIdT = Aws::String>
  GetGroupsForCapacityReservationRequest& WithCapacityReservationId(CapacityReservationIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetGroupsForCapacityReservationRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetGroupsForCapacityReservationRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline GetGroupsForCapacityReservationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
