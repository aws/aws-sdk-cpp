...
class DescribeAwsNetworkPerformanceMetricSubscriptionsResponse {
 public:
  AWS_EC2_API DescribeAwsNetworkPerformanceMetricSubscriptionsResponse() = default;
  AWS_EC2_API DescribeAwsNetworkPerformanceMetricSubscriptionsResponse(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DescribeAwsNetworkPerformanceMetricSubscriptionsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAwsNetworkPerformanceMetricSubscriptionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SubscriptionsT = Aws::Vector<Subscription>>
  DescribeAwsNetworkPerformanceMetricSubscriptionsResponse& WithSubscriptions(SubscriptionsT&& value) {
    SetSubscriptions(std::forward<SubscriptionsT>(value));
    return *this;
  }
  template <typename SubscriptionsT = Subscription>
  DescribeAwsNetworkPerformanceMetricSubscriptionsResponse& AddSubscriptions(SubscriptionsT&& value) {
    m_subscriptionsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAwsNetworkPerformanceMetricSubscriptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
