...
class TransitGatewayMulticastDomainOptions {
 public:
  ...
  inline void SetIgmpv2Support(Igmpv2SupportValue value) {
    m_igmpv2SupportHasBeenSet = true;
    m_igmpv2Support = value;
  }
  inline TransitGatewayMulticastDomainOptions& WithIgmpv2Support(Igmpv2SupportValue value) {
    SetIgmpv2Support(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStaticSourcesSupport(StaticSourcesSupportValue value) {
    m_staticSourcesSupportHasBeenSet = true;
    m_staticSourcesSupport = value;
  }
  inline TransitGatewayMulticastDomainOptions& WithStaticSourcesSupport(StaticSourcesSupportValue value) {
    SetStaticSourcesSupport(value);
    return *this;
  }
  ///@}
  ...
  inline void SetAutoAcceptSharedAssociations(AutoAcceptSharedAssociationsValue value) {
    m_autoAcceptSharedAssociationsHasBeenSet = true;
    m_autoAcceptSharedAssociations = value;
  }
  inline TransitGatewayMulticastDomainOptions& WithAutoAcceptSharedAssociations(AutoAcceptSharedAssociationsValue value) {
    SetAutoAcceptSharedAssociations(value);
    return *this;
  }
  ///@}
 private:
