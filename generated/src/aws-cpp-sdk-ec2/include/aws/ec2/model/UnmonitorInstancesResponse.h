...
class UnmonitorInstancesResponse {
 public:
  ...
  void SetInstanceMonitorings(InstanceMonitoringsT&& value) {
    m_instanceMonitoringsHasBeenSet = true;
    m_instanceMonitorings = std::forward<InstanceMonitoringsT>(value);
  }
  template <typename InstanceMonitoringsT = Aws::Vector<InstanceMonitoring>>
  UnmonitorInstancesResponse& WithInstanceMonitorings(InstanceMonitoringsT&& value) {
    SetInstanceMonitorings(std::forward<InstanceMonitoringsT>(value));
    return *this;
  }
  template <typename InstanceMonitoringsT = InstanceMonitoring>
  UnmonitorInstancesResponse& AddInstanceMonitorings(InstanceMonitoringsT&& value) {
    m_instanceMonitoringsHasBeenSet = true;
    m_instanceMonitorings.emplace_back(std::forward<InstanceMonitoringsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UnmonitorInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
