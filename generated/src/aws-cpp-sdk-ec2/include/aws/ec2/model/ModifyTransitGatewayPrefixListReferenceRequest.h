...
class ModifyTransitGatewayPrefixListReferenceRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  ModifyTransitGatewayPrefixListReferenceRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename PrefixListIdT = Aws::String>
  ModifyTransitGatewayPrefixListReferenceRequest& WithPrefixListId(PrefixListIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  ModifyTransitGatewayPrefixListReferenceRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline ModifyTransitGatewayPrefixListReferenceRequest& WithBlackhole(bool value) {
    SetBlackhole(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyTransitGatewayPrefixListReferenceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
