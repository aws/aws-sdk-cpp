...
/**
 * <p>Describes an unsuccessful application status check association.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/UnsuccessfulAssociationResponseObject">AWS
 * API Reference</a></p>
 */
