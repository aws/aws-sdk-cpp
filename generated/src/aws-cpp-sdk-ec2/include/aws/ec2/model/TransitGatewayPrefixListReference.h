...
class TransitGatewayPrefixListReference {
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  TransitGatewayPrefixListReference& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename PrefixListIdT = Aws::String>
  TransitGatewayPrefixListReference& WithPrefixListId(PrefixListIdT&& value) {
  ...
  void SetPrefixListOwnerId(PrefixListOwnerIdT&& value) {
    m_prefixListOwnerIdHasBeenSet = true;
    m_prefixListOwnerId = std::forward<PrefixListOwnerIdT>(value);
  }
  template <typename PrefixListOwnerIdT = Aws::String>
  TransitGatewayPrefixListReference& WithPrefixListOwnerId(PrefixListOwnerIdT&& value) {
    SetPrefixListOwnerId(std::forward<PrefixListOwnerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(TransitGatewayPrefixListReferenceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline TransitGatewayPrefixListReference& WithState(TransitGatewayPrefixListReferenceState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline TransitGatewayPrefixListReference& WithBlackhole(bool value) {
    SetBlackhole(value);
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayAttachmentT = TransitGatewayPrefixListAttachment>
  TransitGatewayPrefixListReference& WithTransitGatewayAttachment(TransitGatewayAttachmentT&& value) {
