...
class CreateSpotDatafeedSubscriptionResponse {
 public:
  ...
  void SetSpotDatafeedSubscription(SpotDatafeedSubscriptionT&& value) {
    m_spotDatafeedSubscriptionHasBeenSet = true;
    m_spotDatafeedSubscription = std::forward<SpotDatafeedSubscriptionT>(value);
  }
  template <typename SpotDatafeedSubscriptionT = SpotDatafeedSubscription>
  CreateSpotDatafeedSubscriptionResponse& WithSpotDatafeedSubscription(SpotDatafeedSubscriptionT&& value) {
    SetSpotDatafeedSubscription(std::forward<SpotDatafeedSubscriptionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateSpotDatafeedSubscriptionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
