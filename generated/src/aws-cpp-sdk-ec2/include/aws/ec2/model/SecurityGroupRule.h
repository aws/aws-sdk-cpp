...
class SecurityGroupRule {
 public:
  ...
  void SetSecurityGroupRuleId(SecurityGroupRuleIdT&& value) {
    ...
    m_securityGroupRuleId = std::forward<SecurityGroupRuleIdT>(value);
  }
  template <typename SecurityGroupRuleIdT = Aws::String>
  SecurityGroupRule& WithSecurityGroupRuleId(SecurityGroupRuleIdT&& value) {
    SetSecurityGroupRuleId(std::forward<SecurityGroupRuleIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupOwnerId(GroupOwnerIdT&& value) {
    ...
    m_groupOwnerId = std::forward<GroupOwnerIdT>(value);
  }
  template <typename GroupOwnerIdT = Aws::String>
  SecurityGroupRule& WithGroupOwnerId(GroupOwnerIdT&& value) {
    SetGroupOwnerId(std::forward<GroupOwnerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIsEgress(bool value) {
    m_isEgressHasBeenSet = true;
    m_isEgress = value;
  }
  inline SecurityGroupRule& WithIsEgress(bool value) {
    SetIsEgress(value);
    return *this;
  }
  ///@}
  ...
  inline SecurityGroupRule& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline SecurityGroupRule& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
  ...
  void SetCidrIpv4(CidrIpv4T&& value) {
    ...
    m_cidrIpv4 = std::forward<CidrIpv4T>(value);
  }
  template <typename CidrIpv4T = Aws::String>
  SecurityGroupRule& WithCidrIpv4(CidrIpv4T&& value) {
    SetCidrIpv4(std::forward<CidrIpv4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetReferencedGroupInfo(ReferencedGroupInfoT&& value) {
    ...
    m_referencedGroupInfo = std::forward<ReferencedGroupInfoT>(value);
  }
  template <typename ReferencedGroupInfoT = ReferencedSecurityGroup>
  SecurityGroupRule& WithReferencedGroupInfo(ReferencedGroupInfoT&& value) {
    SetReferencedGroupInfo(std::forward<ReferencedGroupInfoT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecurityGroupRuleArn(SecurityGroupRuleArnT&& value) {
    ...
    m_securityGroupRuleArn = std::forward<SecurityGroupRuleArnT>(value);
  }
  template <typename SecurityGroupRuleArnT = Aws::String>
  SecurityGroupRule& WithSecurityGroupRuleArn(SecurityGroupRuleArnT&& value) {
    SetSecurityGroupRuleArn(std::forward<SecurityGroupRuleArnT>(value));
    return *this;
  }
  ///@}
 private:
