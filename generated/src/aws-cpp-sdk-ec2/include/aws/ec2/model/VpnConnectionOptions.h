...
class VpnConnectionOptions {
 public:
  ...
  inline void SetEnableAcceleration(bool value) {
    m_enableAccelerationHasBeenSet = true;
    m_enableAcceleration = value;
  }
  inline VpnConnectionOptions& WithEnableAcceleration(bool value) {
    SetEnableAcceleration(value);
    return *this;
  }
  ///@}
  ...
  inline void SetStaticRoutesOnly(bool value) {
    m_staticRoutesOnlyHasBeenSet = true;
    m_staticRoutesOnly = value;
  }
  inline VpnConnectionOptions& WithStaticRoutesOnly(bool value) {
    SetStaticRoutesOnly(value);
    return *this;
  }
  ///@}
  ...
  void SetLocalIpv4NetworkCidr(LocalIpv4NetworkCidrT&& value) {
    ...
    m_localIpv4NetworkCidr = std::forward<LocalIpv4NetworkCidrT>(value);
  }
  template <typename LocalIpv4NetworkCidrT = Aws::String>
  VpnConnectionOptions& WithLocalIpv4NetworkCidr(LocalIpv4NetworkCidrT&& value) {
    SetLocalIpv4NetworkCidr(std::forward<LocalIpv4NetworkCidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteIpv4NetworkCidr(RemoteIpv4NetworkCidrT&& value) {
    ...
    m_remoteIpv4NetworkCidr = std::forward<RemoteIpv4NetworkCidrT>(value);
  }
  template <typename RemoteIpv4NetworkCidrT = Aws::String>
  VpnConnectionOptions& WithRemoteIpv4NetworkCidr(RemoteIpv4NetworkCidrT&& value) {
    SetRemoteIpv4NetworkCidr(std::forward<RemoteIpv4NetworkCidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLocalIpv6NetworkCidr(LocalIpv6NetworkCidrT&& value) {
    ...
    m_localIpv6NetworkCidr = std::forward<LocalIpv6NetworkCidrT>(value);
  }
  template <typename LocalIpv6NetworkCidrT = Aws::String>
  VpnConnectionOptions& WithLocalIpv6NetworkCidr(LocalIpv6NetworkCidrT&& value) {
    SetLocalIpv6NetworkCidr(std::forward<LocalIpv6NetworkCidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoteIpv6NetworkCidr(RemoteIpv6NetworkCidrT&& value) {
    ...
    m_remoteIpv6NetworkCidr = std::forward<RemoteIpv6NetworkCidrT>(value);
  }
  template <typename RemoteIpv6NetworkCidrT = Aws::String>
  VpnConnectionOptions& WithRemoteIpv6NetworkCidr(RemoteIpv6NetworkCidrT&& value) {
    SetRemoteIpv6NetworkCidr(std::forward<RemoteIpv6NetworkCidrT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOutsideIpAddressType(OutsideIpAddressTypeT&& value) {
    ...
    m_outsideIpAddressType = std::forward<OutsideIpAddressTypeT>(value);
  }
  template <typename OutsideIpAddressTypeT = Aws::String>
  VpnConnectionOptions& WithOutsideIpAddressType(OutsideIpAddressTypeT&& value) {
    SetOutsideIpAddressType(std::forward<OutsideIpAddressTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTransportTransitGatewayAttachmentId(TransportTransitGatewayAttachmentIdT&& value) {
    ...
    m_transportTransitGatewayAttachmentId = std::forward<TransportTransitGatewayAttachmentIdT>(value);
  }
  template <typename TransportTransitGatewayAttachmentIdT = Aws::String>
  VpnConnectionOptions& WithTransportTransitGatewayAttachmentId(TransportTransitGatewayAttachmentIdT&& value) {
    SetTransportTransitGatewayAttachmentId(std::forward<TransportTransitGatewayAttachmentIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTunnelInsideIpVersion(TunnelInsideIpVersion value) {
    m_tunnelInsideIpVersionHasBeenSet = true;
    m_tunnelInsideIpVersion = value;
  }
  inline VpnConnectionOptions& WithTunnelInsideIpVersion(TunnelInsideIpVersion value) {
    SetTunnelInsideIpVersion(value);
    return *this;
  }
  ///@}
