...
class GetCapacityManagerMetricDataRequest : public EC2Request {
 ...
 public:
  ...
  template <typename MetricNamesT = Aws::Vector<Metric>>
  GetCapacityManagerMetricDataRequest& WithMetricNames(MetricNamesT&& value) {
    SetMetricNames(std::forward<MetricNamesT>(value));
    return *this;
  }
  inline GetCapacityManagerMetricDataRequest& AddMetricNames(Metric value) {
    m_metricNamesHasBeenSet = true;
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  GetCapacityManagerMetricDataRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename EndTimeT = Aws::Utils::DateTime>
  GetCapacityManagerMetricDataRequest& WithEndTime(EndTimeT&& value) {
  ...
  inline GetCapacityManagerMetricDataRequest& WithPeriod(int value) {
    SetPeriod(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupByT = Aws::Vector<GroupBy>>
  GetCapacityManagerMetricDataRequest& WithGroupBy(GroupByT&& value) {
    SetGroupBy(std::forward<GroupByT>(value));
    return *this;
  }
  inline GetCapacityManagerMetricDataRequest& AddGroupBy(GroupBy value) {
    m_groupByHasBeenSet = true;
  ...
  template <typename FilterByT = Aws::Vector<CapacityManagerCondition>>
  GetCapacityManagerMetricDataRequest& WithFilterBy(FilterByT&& value) {
    SetFilterBy(std::forward<FilterByT>(value));
    return *this;
  }
  template <typename FilterByT = CapacityManagerCondition>
  GetCapacityManagerMetricDataRequest& AddFilterBy(FilterByT&& value) {
    m_filterByHasBeenSet = true;
  ...
  inline GetCapacityManagerMetricDataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetCapacityManagerMetricDataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetCapacityManagerMetricDataRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
