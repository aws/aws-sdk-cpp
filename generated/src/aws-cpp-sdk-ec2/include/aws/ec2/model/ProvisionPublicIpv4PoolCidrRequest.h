...
class ProvisionPublicIpv4PoolCidrRequest : public EC2Request {
 ...
 public:
  ...
  inline ProvisionPublicIpv4PoolCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamPoolIdT = Aws::String>
  ProvisionPublicIpv4PoolCidrRequest& WithIpamPoolId(IpamPoolIdT&& value) {
  ...
  template <typename PoolIdT = Aws::String>
  ProvisionPublicIpv4PoolCidrRequest& WithPoolId(PoolIdT&& value) {
  ...
  inline ProvisionPublicIpv4PoolCidrRequest& WithNetmaskLength(int value) {
  ...
  template <typename NetworkBorderGroupT = Aws::String>
  ProvisionPublicIpv4PoolCidrRequest& WithNetworkBorderGroup(NetworkBorderGroupT&& value) {
