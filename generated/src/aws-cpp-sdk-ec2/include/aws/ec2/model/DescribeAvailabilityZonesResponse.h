...
class DescribeAvailabilityZonesResponse {
 public:
  ...
  template <typename AvailabilityZonesT = Aws::Vector<AvailabilityZone>>
  DescribeAvailabilityZonesResponse& WithAvailabilityZones(AvailabilityZonesT&& value) {
    SetAvailabilityZones(std::forward<AvailabilityZonesT>(value));
    return *this;
  }
  template <typename AvailabilityZonesT = AvailabilityZone>
  DescribeAvailabilityZonesResponse& AddAvailabilityZones(AvailabilityZonesT&& value) {
    m_availabilityZonesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAvailabilityZonesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
