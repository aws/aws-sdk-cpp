...
class DescribeInstanceAttributeRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeInstanceAttributeRequest() = default;
 ...
 public:
  ...
  inline DescribeInstanceAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  DescribeInstanceAttributeRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline DescribeInstanceAttributeRequest& WithAttribute(InstanceAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
