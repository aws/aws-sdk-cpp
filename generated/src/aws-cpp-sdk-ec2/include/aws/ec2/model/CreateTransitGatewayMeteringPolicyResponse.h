...
namespace EC2 {
namespace Model {
class CreateTransitGatewayMeteringPolicyResponse {
 public:
  AWS_EC2_API CreateTransitGatewayMeteringPolicyResponse() = default;
  AWS_EC2_API CreateTransitGatewayMeteringPolicyResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateTransitGatewayMeteringPolicyResponse& operator=(
  ...
  template <typename TransitGatewayMeteringPolicyT = TransitGatewayMeteringPolicy>
  CreateTransitGatewayMeteringPolicyResponse& WithTransitGatewayMeteringPolicy(TransitGatewayMeteringPolicyT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayMeteringPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
