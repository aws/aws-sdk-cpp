...
class ModifyFpgaImageAttributeResponse {
 public:
  ...
  void SetFpgaImageAttribute(FpgaImageAttributeT&& value) {
    m_fpgaImageAttributeHasBeenSet = true;
    m_fpgaImageAttribute = std::forward<FpgaImageAttributeT>(value);
  }
  template <typename FpgaImageAttributeT = FpgaImageAttribute>
  ModifyFpgaImageAttributeResponse& WithFpgaImageAttribute(FpgaImageAttributeT&& value) {
    SetFpgaImageAttribute(std::forward<FpgaImageAttributeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyFpgaImageAttributeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
