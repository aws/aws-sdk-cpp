...
/**
 */
class EnableImageDeregistrationProtectionRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "EnableImageDeregistrationProtection"; }
 ...
 public:
  ...
  inline void SetWithCooldown(bool value) {
    m_withCooldownHasBeenSet = true;
    m_withCooldown = value;
  }
  inline EnableImageDeregistrationProtectionRequest& WithWithCooldown(bool value) {
    SetWithCooldown(value);
    return *this;
  }
  ///@}
  ...
  inline EnableImageDeregistrationProtectionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
