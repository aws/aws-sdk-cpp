...
class FleetLaunchTemplateSpecification {
 public:
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  FleetLaunchTemplateSpecification& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  FleetLaunchTemplateSpecification& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  FleetLaunchTemplateSpecification& WithVersion(VersionT&& value) {
