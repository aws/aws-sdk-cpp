...
class DescribeCapacityReservationsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityReservationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename CapacityReservationsT = Aws::Vector<CapacityReservation>>
  DescribeCapacityReservationsResponse& WithCapacityReservations(CapacityReservationsT&& value) {
  ...
  DescribeCapacityReservationsResponse& AddCapacityReservations(CapacityReservationsT&& value) {
    m_capacityReservationsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCapacityReservationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
