...
namespace EC2 {
namespace Model {
class DeleteSecondaryNetworkResponse {
 public:
  AWS_EC2_API DeleteSecondaryNetworkResponse() = default;
  AWS_EC2_API DeleteSecondaryNetworkResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteSecondaryNetworkResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename SecondaryNetworkT = SecondaryNetwork>
  DeleteSecondaryNetworkResponse& WithSecondaryNetwork(SecondaryNetworkT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteSecondaryNetworkResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteSecondaryNetworkResponse& WithResponseMetadata(ResponseMetadataT&& value) {
