...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeregisterTransitGatewayMulticastGroupMembersRequest() = default;
  ...
  public:
    ...
    template<typename TransitGatewayMulticastDomainIdT = Aws::String>
    DeregisterTransitGatewayMulticastGroupMembersRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) { SetTransitGatewayMulticastDomainId(std::forward<TransitGatewayMulticastDomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIpAddressT = Aws::String>
    DeregisterTransitGatewayMulticastGroupMembersRequest& WithGroupIpAddress(GroupIpAddressT&& value) { SetGroupIpAddress(std::forward<GroupIpAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
    DeregisterTransitGatewayMulticastGroupMembersRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) { SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value)); return *this;}
    template<typename NetworkInterfaceIdsT = Aws::String>
    DeregisterTransitGatewayMulticastGroupMembersRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) { m_networkInterfaceIdsHasBeenSet = true; m_networkInterfaceIds.emplace_back(std::forward<NetworkInterfaceIdsT>(value)); return *this; }
    ///@}
