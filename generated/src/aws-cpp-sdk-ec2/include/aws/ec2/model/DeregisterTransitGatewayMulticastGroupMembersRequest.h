...
class DeregisterTransitGatewayMulticastGroupMembersRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  DeregisterTransitGatewayMulticastGroupMembersRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename GroupIpAddressT = Aws::String>
  DeregisterTransitGatewayMulticastGroupMembersRequest& WithGroupIpAddress(GroupIpAddressT&& value) {
  ...
  template <typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  DeregisterTransitGatewayMulticastGroupMembersRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value));
    return *this;
  }
  template <typename NetworkInterfaceIdsT = Aws::String>
  DeregisterTransitGatewayMulticastGroupMembersRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    m_networkInterfaceIdsHasBeenSet = true;
  ...
  inline DeregisterTransitGatewayMulticastGroupMembersRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
