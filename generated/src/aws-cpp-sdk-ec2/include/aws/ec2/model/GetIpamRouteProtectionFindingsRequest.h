...
/**
 */
class GetIpamRouteProtectionFindingsRequest : public EC2Request {
 public:
  AWS_EC2_API GetIpamRouteProtectionFindingsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetIpamRouteProtectionFindings"; }
 ...
 public:
  ...
  inline GetIpamRouteProtectionFindingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamIdT = Aws::String>
  GetIpamRouteProtectionFindingsRequest& WithIpamId(IpamIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetIpamRouteProtectionFindingsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetIpamRouteProtectionFindingsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamRouteProtectionFindingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIpamRouteProtectionFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
