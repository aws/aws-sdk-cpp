...
class GetSpotPlacementScoresRequest : public EC2Request {
 ...
 public:
  ...
  template <typename InstanceTypesT = Aws::Vector<Aws::String>>
  GetSpotPlacementScoresRequest& WithInstanceTypes(InstanceTypesT&& value) {
    SetInstanceTypes(std::forward<InstanceTypesT>(value));
    return *this;
  }
  template <typename InstanceTypesT = Aws::String>
  GetSpotPlacementScoresRequest& AddInstanceTypes(InstanceTypesT&& value) {
    m_instanceTypesHasBeenSet = true;
  ...
  inline GetSpotPlacementScoresRequest& WithTargetCapacity(int value) {
  ...
  inline GetSpotPlacementScoresRequest& WithTargetCapacityUnitType(TargetCapacityUnitType value) {
  ...
  inline GetSpotPlacementScoresRequest& WithSingleAvailabilityZone(bool value) {
  ...
  template <typename RegionNamesT = Aws::Vector<Aws::String>>
  GetSpotPlacementScoresRequest& WithRegionNames(RegionNamesT&& value) {
    SetRegionNames(std::forward<RegionNamesT>(value));
    return *this;
  }
  template <typename RegionNamesT = Aws::String>
  GetSpotPlacementScoresRequest& AddRegionNames(RegionNamesT&& value) {
    m_regionNamesHasBeenSet = true;
   ...
   */
  inline const InstanceRequirementsWithMetadataRequest& GetInstanceRequirementsWithMetadata() const {
    return m_instanceRequirementsWithMetadata;
  }
  ...
  void SetInstanceRequirementsWithMetadata(InstanceRequirementsWithMetadataT&& value) {
    m_instanceRequirementsWithMetadataHasBeenSet = true;
    m_instanceRequirementsWithMetadata = std::forward<InstanceRequirementsWithMetadataT>(value);
  }
  template <typename InstanceRequirementsWithMetadataT = InstanceRequirementsWithMetadataRequest>
  GetSpotPlacementScoresRequest& WithInstanceRequirementsWithMetadata(InstanceRequirementsWithMetadataT&& value) {
    SetInstanceRequirementsWithMetadata(std::forward<InstanceRequirementsWithMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetSpotPlacementScoresRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline GetSpotPlacementScoresRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSpotPlacementScoresRequest& WithNextToken(NextTokenT&& value) {
