...
class DeleteFleetsResponse {
 public:
  ...
  void SetSuccessfulFleetDeletions(SuccessfulFleetDeletionsT&& value) {
    m_successfulFleetDeletionsHasBeenSet = true;
    m_successfulFleetDeletions = std::forward<SuccessfulFleetDeletionsT>(value);
  }
  template <typename SuccessfulFleetDeletionsT = Aws::Vector<DeleteFleetSuccessItem>>
  DeleteFleetsResponse& WithSuccessfulFleetDeletions(SuccessfulFleetDeletionsT&& value) {
    SetSuccessfulFleetDeletions(std::forward<SuccessfulFleetDeletionsT>(value));
    return *this;
  }
  template <typename SuccessfulFleetDeletionsT = DeleteFleetSuccessItem>
  DeleteFleetsResponse& AddSuccessfulFleetDeletions(SuccessfulFleetDeletionsT&& value) {
    m_successfulFleetDeletionsHasBeenSet = true;
    m_successfulFleetDeletions.emplace_back(std::forward<SuccessfulFleetDeletionsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetUnsuccessfulFleetDeletions(UnsuccessfulFleetDeletionsT&& value) {
    m_unsuccessfulFleetDeletionsHasBeenSet = true;
    m_unsuccessfulFleetDeletions = std::forward<UnsuccessfulFleetDeletionsT>(value);
  }
  template <typename UnsuccessfulFleetDeletionsT = Aws::Vector<DeleteFleetErrorItem>>
  DeleteFleetsResponse& WithUnsuccessfulFleetDeletions(UnsuccessfulFleetDeletionsT&& value) {
    SetUnsuccessfulFleetDeletions(std::forward<UnsuccessfulFleetDeletionsT>(value));
    return *this;
  }
  template <typename UnsuccessfulFleetDeletionsT = DeleteFleetErrorItem>
  DeleteFleetsResponse& AddUnsuccessfulFleetDeletions(UnsuccessfulFleetDeletionsT&& value) {
    m_unsuccessfulFleetDeletionsHasBeenSet = true;
    m_unsuccessfulFleetDeletions.emplace_back(std::forward<UnsuccessfulFleetDeletionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteFleetsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
