...
class DeleteSecurityGroupResponse {
 public:
  ...
  inline DeleteSecurityGroupResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::String>
  DeleteSecurityGroupResponse& WithGroupId(GroupIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteSecurityGroupResponse& WithResponseMetadata(ResponseMetadataT&& value) {
