...
class DescribeFleetsInstances {
 public:
  ...
  template <typename LaunchTemplateAndOverridesT = LaunchTemplateAndOverridesResponse>
  DescribeFleetsInstances& WithLaunchTemplateAndOverrides(LaunchTemplateAndOverridesT&& value) {
  ...
  inline DescribeFleetsInstances& WithLifecycle(InstanceLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  DescribeFleetsInstances& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  DescribeFleetsInstances& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  inline DescribeFleetsInstances& WithInstanceType(InstanceType value) {
  ...
  inline DescribeFleetsInstances& WithPlatform(PlatformValues value) {
    SetPlatform(value);
    return *this;
  }
  ///@}
