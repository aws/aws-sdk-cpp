...
class ProvisionIpamPoolCidrRequest : public EC2Request {
 ...
 public:
  ...
  inline ProvisionIpamPoolCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline ProvisionIpamPoolCidrRequest& WithNetmaskLength(int value) {
  ...
  inline void SetVerificationMethod(VerificationMethod value) {
    m_verificationMethodHasBeenSet = true;
    m_verificationMethod = value;
  }
  inline ProvisionIpamPoolCidrRequest& WithVerificationMethod(VerificationMethod value) {
