...
class VerifiedAccessEndpointTarget {
 public:
  ...
  template <typename VerifiedAccessEndpointIdT = Aws::String>
  VerifiedAccessEndpointTarget& WithVerifiedAccessEndpointId(VerifiedAccessEndpointIdT&& value) {
  ...
  void SetVerifiedAccessEndpointTargetIpAddress(VerifiedAccessEndpointTargetIpAddressT&& value) {
    m_verifiedAccessEndpointTargetIpAddressHasBeenSet = true;
    m_verifiedAccessEndpointTargetIpAddress = std::forward<VerifiedAccessEndpointTargetIpAddressT>(value);
  }
  template <typename VerifiedAccessEndpointTargetIpAddressT = Aws::String>
  VerifiedAccessEndpointTarget& WithVerifiedAccessEndpointTargetIpAddress(VerifiedAccessEndpointTargetIpAddressT&& value) {
    SetVerifiedAccessEndpointTargetIpAddress(std::forward<VerifiedAccessEndpointTargetIpAddressT>(value));
    return *this;
  }
  ///@}
  ...
  void SetVerifiedAccessEndpointTargetDns(VerifiedAccessEndpointTargetDnsT&& value) {
    m_verifiedAccessEndpointTargetDnsHasBeenSet = true;
    m_verifiedAccessEndpointTargetDns = std::forward<VerifiedAccessEndpointTargetDnsT>(value);
  }
  template <typename VerifiedAccessEndpointTargetDnsT = Aws::String>
  VerifiedAccessEndpointTarget& WithVerifiedAccessEndpointTargetDns(VerifiedAccessEndpointTargetDnsT&& value) {
    SetVerifiedAccessEndpointTargetDns(std::forward<VerifiedAccessEndpointTargetDnsT>(value));
    return *this;
  }
  ///@}
 private:
