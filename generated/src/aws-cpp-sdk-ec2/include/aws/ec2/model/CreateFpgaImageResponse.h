...
class CreateFpgaImageResponse {
 public:
  ...
  template <typename FpgaImageIdT = Aws::String>
  CreateFpgaImageResponse& WithFpgaImageId(FpgaImageIdT&& value) {
  ...
  template <typename FpgaImageGlobalIdT = Aws::String>
  CreateFpgaImageResponse& WithFpgaImageGlobalId(FpgaImageGlobalIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateFpgaImageResponse& WithResponseMetadata(ResponseMetadataT&& value) {
