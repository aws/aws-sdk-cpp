...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API GetDefaultCreditSpecificationResponse() = default;
    ...
    template<typename InstanceFamilyCreditSpecificationT = InstanceFamilyCreditSpecification>
    GetDefaultCreditSpecificationResponse& WithInstanceFamilyCreditSpecification(InstanceFamilyCreditSpecificationT&& value) { SetInstanceFamilyCreditSpecification(std::forward<InstanceFamilyCreditSpecificationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    GetDefaultCreditSpecificationResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
