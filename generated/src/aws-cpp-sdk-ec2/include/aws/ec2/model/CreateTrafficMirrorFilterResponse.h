...
class CreateTrafficMirrorFilterResponse {
 public:
  ...
  template <typename TrafficMirrorFilterT = TrafficMirrorFilter>
  CreateTrafficMirrorFilterResponse& WithTrafficMirrorFilter(TrafficMirrorFilterT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorFilterResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTrafficMirrorFilterResponse& WithResponseMetadata(ResponseMetadataT&& value) {
