...
class DeleteTrafficMirrorSessionRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TrafficMirrorSessionIdT = Aws::String>
  DeleteTrafficMirrorSessionRequest& WithTrafficMirrorSessionId(TrafficMirrorSessionIdT&& value) {
  ...
  inline DeleteTrafficMirrorSessionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
