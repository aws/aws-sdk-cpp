...
class DescribeReplaceRootVolumeTasksResponse {
 public:
  ...
  void SetReplaceRootVolumeTasks(ReplaceRootVolumeTasksT&& value) {
    m_replaceRootVolumeTasksHasBeenSet = true;
    m_replaceRootVolumeTasks = std::forward<ReplaceRootVolumeTasksT>(value);
  }
  template <typename ReplaceRootVolumeTasksT = Aws::Vector<ReplaceRootVolumeTask>>
  DescribeReplaceRootVolumeTasksResponse& WithReplaceRootVolumeTasks(ReplaceRootVolumeTasksT&& value) {
    SetReplaceRootVolumeTasks(std::forward<ReplaceRootVolumeTasksT>(value));
    return *this;
  }
  template <typename ReplaceRootVolumeTasksT = ReplaceRootVolumeTask>
  DescribeReplaceRootVolumeTasksResponse& AddReplaceRootVolumeTasks(ReplaceRootVolumeTasksT&& value) {
    m_replaceRootVolumeTasksHasBeenSet = true;
    m_replaceRootVolumeTasks.emplace_back(std::forward<ReplaceRootVolumeTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeReplaceRootVolumeTasksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReplaceRootVolumeTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
