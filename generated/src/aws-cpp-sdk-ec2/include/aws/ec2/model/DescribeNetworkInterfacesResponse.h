...
class DescribeNetworkInterfacesResponse {
 public:
  AWS_EC2_API DescribeNetworkInterfacesResponse() = default;
  ...
  template <typename NetworkInterfacesT = Aws::Vector<NetworkInterface>>
  DescribeNetworkInterfacesResponse& WithNetworkInterfaces(NetworkInterfacesT&& value) {
    SetNetworkInterfaces(std::forward<NetworkInterfacesT>(value));
    return *this;
  }
  template <typename NetworkInterfacesT = NetworkInterface>
  DescribeNetworkInterfacesResponse& AddNetworkInterfaces(NetworkInterfacesT&& value) {
    m_networkInterfacesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkInterfacesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeNetworkInterfacesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
