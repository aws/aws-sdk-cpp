...
class ModifyTrafficMirrorFilterNetworkServicesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TrafficMirrorFilterIdT = Aws::String>
  ModifyTrafficMirrorFilterNetworkServicesRequest& WithTrafficMirrorFilterId(TrafficMirrorFilterIdT&& value) {
  ...
  void SetAddNetworkServices(AddNetworkServicesT&& value) {
    m_addNetworkServicesHasBeenSet = true;
    m_addNetworkServices = std::forward<AddNetworkServicesT>(value);
  }
  template <typename AddNetworkServicesT = Aws::Vector<TrafficMirrorNetworkService>>
  ModifyTrafficMirrorFilterNetworkServicesRequest& WithAddNetworkServices(AddNetworkServicesT&& value) {
    SetAddNetworkServices(std::forward<AddNetworkServicesT>(value));
    return *this;
  }
  inline ModifyTrafficMirrorFilterNetworkServicesRequest& AddAddNetworkServices(TrafficMirrorNetworkService value) {
    m_addNetworkServicesHasBeenSet = true;
    m_addNetworkServices.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetRemoveNetworkServices(RemoveNetworkServicesT&& value) {
    m_removeNetworkServicesHasBeenSet = true;
    m_removeNetworkServices = std::forward<RemoveNetworkServicesT>(value);
  }
  template <typename RemoveNetworkServicesT = Aws::Vector<TrafficMirrorNetworkService>>
  ModifyTrafficMirrorFilterNetworkServicesRequest& WithRemoveNetworkServices(RemoveNetworkServicesT&& value) {
    SetRemoveNetworkServices(std::forward<RemoveNetworkServicesT>(value));
    return *this;
  }
  inline ModifyTrafficMirrorFilterNetworkServicesRequest& AddRemoveNetworkServices(TrafficMirrorNetworkService value) {
    m_removeNetworkServicesHasBeenSet = true;
    m_removeNetworkServices.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyTrafficMirrorFilterNetworkServicesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
