...
class CreateLocalGatewayVirtualInterfaceResponse {
 public:
  ...
  AWS_EC2_API CreateLocalGatewayVirtualInterfaceResponse& operator=(
  ...
  template <typename LocalGatewayVirtualInterfaceT = LocalGatewayVirtualInterface>
  CreateLocalGatewayVirtualInterfaceResponse& WithLocalGatewayVirtualInterface(LocalGatewayVirtualInterfaceT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateLocalGatewayVirtualInterfaceResponse& WithResponseMetadata(ResponseMetadataT&& value) {
