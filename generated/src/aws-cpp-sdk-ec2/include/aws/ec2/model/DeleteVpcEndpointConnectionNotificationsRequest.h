...
class DeleteVpcEndpointConnectionNotificationsRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteVpcEndpointConnectionNotificationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectionNotificationIds(ConnectionNotificationIdsT&& value) {
    m_connectionNotificationIdsHasBeenSet = true;
    m_connectionNotificationIds = std::forward<ConnectionNotificationIdsT>(value);
  }
  template <typename ConnectionNotificationIdsT = Aws::Vector<Aws::String>>
  DeleteVpcEndpointConnectionNotificationsRequest& WithConnectionNotificationIds(ConnectionNotificationIdsT&& value) {
    SetConnectionNotificationIds(std::forward<ConnectionNotificationIdsT>(value));
    return *this;
  }
  ...
  DeleteVpcEndpointConnectionNotificationsRequest& AddConnectionNotificationIds(ConnectionNotificationIdsT&& value) {
    m_connectionNotificationIdsHasBeenSet = true;
    m_connectionNotificationIds.emplace_back(std::forward<ConnectionNotificationIdsT>(value));
    return *this;
  }
  ///@}
 private:
