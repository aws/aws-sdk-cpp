...
class DescribeVpcBlockPublicAccessOptionsResponse {
 public:
  ...
  AWS_EC2_API DescribeVpcBlockPublicAccessOptionsResponse& operator=(
  ...
  template <typename VpcBlockPublicAccessOptionsT = VpcBlockPublicAccessOptions>
  DescribeVpcBlockPublicAccessOptionsResponse& WithVpcBlockPublicAccessOptions(VpcBlockPublicAccessOptionsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpcBlockPublicAccessOptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
