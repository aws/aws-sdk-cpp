...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateTransitGatewayRouteResponse() = default;
    ...
    template<typename RouteT = TransitGatewayRoute>
    CreateTransitGatewayRouteResponse& WithRoute(RouteT&& value) { SetRoute(std::forward<RouteT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateTransitGatewayRouteResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
