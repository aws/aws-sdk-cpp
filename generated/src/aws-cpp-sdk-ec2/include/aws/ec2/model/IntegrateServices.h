...
class IntegrateServices {
 public:
  ...
  void SetAthenaIntegrations(AthenaIntegrationsT&& value) {
    ...
    m_athenaIntegrations = std::forward<AthenaIntegrationsT>(value);
  }
  template <typename AthenaIntegrationsT = Aws::Vector<AthenaIntegration>>
  IntegrateServices& WithAthenaIntegrations(AthenaIntegrationsT&& value) {
    SetAthenaIntegrations(std::forward<AthenaIntegrationsT>(value));
    return *this;
  }
  template <typename AthenaIntegrationsT = AthenaIntegration>
  IntegrateServices& AddAthenaIntegrations(AthenaIntegrationsT&& value) {
    m_athenaIntegrationsHasBeenSet = true;
    m_athenaIntegrations.emplace_back(std::forward<AthenaIntegrationsT>(value));
    return *this;
  }
  ///@}
 private:
