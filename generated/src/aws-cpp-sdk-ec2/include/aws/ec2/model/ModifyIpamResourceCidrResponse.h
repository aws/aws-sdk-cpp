...
class ModifyIpamResourceCidrResponse {
 public:
  ...
  void SetIpamResourceCidr(IpamResourceCidrT&& value) {
    m_ipamResourceCidrHasBeenSet = true;
    m_ipamResourceCidr = std::forward<IpamResourceCidrT>(value);
  }
  template <typename IpamResourceCidrT = IpamResourceCidr>
  ModifyIpamResourceCidrResponse& WithIpamResourceCidr(IpamResourceCidrT&& value) {
    SetIpamResourceCidr(std::forward<IpamResourceCidrT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyIpamResourceCidrResponse& WithResponseMetadata(ResponseMetadataT&& value) {
