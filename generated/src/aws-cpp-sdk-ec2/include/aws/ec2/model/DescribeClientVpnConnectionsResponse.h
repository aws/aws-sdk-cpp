...
class DescribeClientVpnConnectionsResponse {
 public:
  ...
  template <typename ConnectionsT = Aws::Vector<ClientVpnConnection>>
  DescribeClientVpnConnectionsResponse& WithConnections(ConnectionsT&& value) {
    SetConnections(std::forward<ConnectionsT>(value));
    return *this;
  }
  template <typename ConnectionsT = ClientVpnConnection>
  DescribeClientVpnConnectionsResponse& AddConnections(ConnectionsT&& value) {
    m_connectionsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClientVpnConnectionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClientVpnConnectionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
