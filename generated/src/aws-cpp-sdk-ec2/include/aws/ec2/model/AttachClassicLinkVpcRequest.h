...
namespace Model
{
  ...
  public:
    ...
    template<typename InstanceIdT = Aws::String>
    AttachClassicLinkVpcRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcIdT = Aws::String>
    AttachClassicLinkVpcRequest& WithVpcId(VpcIdT&& value) { SetVpcId(std::forward<VpcIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupsT = Aws::Vector<Aws::String>>
    AttachClassicLinkVpcRequest& WithGroups(GroupsT&& value) { SetGroups(std::forward<GroupsT>(value)); return *this;}
    template<typename GroupsT = Aws::String>
    AttachClassicLinkVpcRequest& AddGroups(GroupsT&& value) { m_groupsHasBeenSet = true; m_groups.emplace_back(std::forward<GroupsT>(value)); return *this; }
    ///@}
  private:
