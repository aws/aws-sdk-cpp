...
class DescribeFpgaImagesResponse {
 public:
  ...
  void SetFpgaImages(FpgaImagesT&& value) {
    m_fpgaImagesHasBeenSet = true;
    m_fpgaImages = std::forward<FpgaImagesT>(value);
  }
  template <typename FpgaImagesT = Aws::Vector<FpgaImage>>
  DescribeFpgaImagesResponse& WithFpgaImages(FpgaImagesT&& value) {
    SetFpgaImages(std::forward<FpgaImagesT>(value));
    return *this;
  }
  template <typename FpgaImagesT = FpgaImage>
  DescribeFpgaImagesResponse& AddFpgaImages(FpgaImagesT&& value) {
    m_fpgaImagesHasBeenSet = true;
    m_fpgaImages.emplace_back(std::forward<FpgaImagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFpgaImagesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFpgaImagesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
