...
class SpotOptionsRequest {
 public:
  ...
  inline void SetAllocationStrategy(SpotAllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline SpotOptionsRequest& WithAllocationStrategy(SpotAllocationStrategy value) {
  ...
  template <typename MaintenanceStrategiesT = FleetSpotMaintenanceStrategiesRequest>
  void SetMaintenanceStrategies(MaintenanceStrategiesT&& value) {
    m_maintenanceStrategiesHasBeenSet = true;
    m_maintenanceStrategies = std::forward<MaintenanceStrategiesT>(value);
  }
  template <typename MaintenanceStrategiesT = FleetSpotMaintenanceStrategiesRequest>
  SpotOptionsRequest& WithMaintenanceStrategies(MaintenanceStrategiesT&& value) {
    SetMaintenanceStrategies(std::forward<MaintenanceStrategiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceInterruptionBehavior(SpotInstanceInterruptionBehavior value) {
    m_instanceInterruptionBehaviorHasBeenSet = true;
    m_instanceInterruptionBehavior = value;
  }
  inline SpotOptionsRequest& WithInstanceInterruptionBehavior(SpotInstanceInterruptionBehavior value) {
  ...
  inline void SetInstancePoolsToUseCount(int value) {
    m_instancePoolsToUseCountHasBeenSet = true;
    m_instancePoolsToUseCount = value;
  }
  inline SpotOptionsRequest& WithInstancePoolsToUseCount(int value) {
    SetInstancePoolsToUseCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSingleInstanceType(bool value) {
    m_singleInstanceTypeHasBeenSet = true;
    m_singleInstanceType = value;
  }
  inline SpotOptionsRequest& WithSingleInstanceType(bool value) {
    SetSingleInstanceType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSingleAvailabilityZone(bool value) {
    m_singleAvailabilityZoneHasBeenSet = true;
    m_singleAvailabilityZone = value;
  }
  inline SpotOptionsRequest& WithSingleAvailabilityZone(bool value) {
    SetSingleAvailabilityZone(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinTargetCapacity(int value) {
    m_minTargetCapacityHasBeenSet = true;
    m_minTargetCapacity = value;
  }
  inline SpotOptionsRequest& WithMinTargetCapacity(int value) {
    SetMinTargetCapacity(value);
    return *this;
  }
  ///@}
  ...
  void SetMaxTotalPrice(MaxTotalPriceT&& value) {
    ...
    m_maxTotalPrice = std::forward<MaxTotalPriceT>(value);
  }
  template <typename MaxTotalPriceT = Aws::String>
  SpotOptionsRequest& WithMaxTotalPrice(MaxTotalPriceT&& value) {
    SetMaxTotalPrice(std::forward<MaxTotalPriceT>(value));
    return *this;
  }
  ///@}
 private:
