...
namespace Model
{
  ...
  public:
    ...
    inline SpotOptionsRequest& WithAllocationStrategy(SpotAllocationStrategy value) { SetAllocationStrategy(value); return *this;}
    ///@}
    ...
    template<typename MaintenanceStrategiesT = FleetSpotMaintenanceStrategiesRequest>
    SpotOptionsRequest& WithMaintenanceStrategies(MaintenanceStrategiesT&& value) { SetMaintenanceStrategies(std::forward<MaintenanceStrategiesT>(value)); return *this;}
    ///@}
    ...
    inline SpotOptionsRequest& WithInstanceInterruptionBehavior(SpotInstanceInterruptionBehavior value) { SetInstanceInterruptionBehavior(value); return *this;}
    ///@}
    ...
    template<typename MaxTotalPriceT = Aws::String>
    SpotOptionsRequest& WithMaxTotalPrice(MaxTotalPriceT&& value) { SetMaxTotalPrice(std::forward<MaxTotalPriceT>(value)); return *this;}
    ///@}
  private:
