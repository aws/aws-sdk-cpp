...
class DeleteTrafficMirrorFilterResponse {
 public:
  ...
  template <typename TrafficMirrorFilterIdT = Aws::String>
  DeleteTrafficMirrorFilterResponse& WithTrafficMirrorFilterId(TrafficMirrorFilterIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTrafficMirrorFilterResponse& WithResponseMetadata(ResponseMetadataT&& value) {
