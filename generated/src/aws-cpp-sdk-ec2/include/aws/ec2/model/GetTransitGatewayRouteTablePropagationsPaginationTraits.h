...
struct GetTransitGatewayRouteTablePropagationsPaginationTraits {
  ...
  using OutcomeType = Model::GetTransitGatewayRouteTablePropagationsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->GetTransitGatewayRouteTablePropagations(request); }
