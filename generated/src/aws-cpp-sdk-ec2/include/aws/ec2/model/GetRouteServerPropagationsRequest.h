...
/**
 */
class GetRouteServerPropagationsRequest : public EC2Request {
 public:
  AWS_EC2_API GetRouteServerPropagationsRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetRouteServerPropagations"; }
 ...
 public:
  ...
  template <typename RouteServerIdT = Aws::String>
  GetRouteServerPropagationsRequest& WithRouteServerId(RouteServerIdT&& value) {
  ...
  template <typename RouteTableIdT = Aws::String>
  GetRouteServerPropagationsRequest& WithRouteTableId(RouteTableIdT&& value) {
  ...
  inline GetRouteServerPropagationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
