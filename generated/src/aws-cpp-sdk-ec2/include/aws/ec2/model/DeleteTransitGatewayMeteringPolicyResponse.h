...
namespace EC2 {
namespace Model {
class DeleteTransitGatewayMeteringPolicyResponse {
 public:
  AWS_EC2_API DeleteTransitGatewayMeteringPolicyResponse() = default;
  AWS_EC2_API DeleteTransitGatewayMeteringPolicyResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteTransitGatewayMeteringPolicyResponse& operator=(
  ...
  template <typename TransitGatewayMeteringPolicyT = TransitGatewayMeteringPolicy>
  DeleteTransitGatewayMeteringPolicyResponse& WithTransitGatewayMeteringPolicy(TransitGatewayMeteringPolicyT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayMeteringPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
