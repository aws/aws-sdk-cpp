...
class DescribeOutpostLagsRequest : public EC2Request {
 ...
 public:
  ...
  void SetOutpostLagIds(OutpostLagIdsT&& value) {
    m_outpostLagIdsHasBeenSet = true;
    m_outpostLagIds = std::forward<OutpostLagIdsT>(value);
  }
  template <typename OutpostLagIdsT = Aws::Vector<Aws::String>>
  DescribeOutpostLagsRequest& WithOutpostLagIds(OutpostLagIdsT&& value) {
    SetOutpostLagIds(std::forward<OutpostLagIdsT>(value));
    return *this;
  }
  template <typename OutpostLagIdsT = Aws::String>
  DescribeOutpostLagsRequest& AddOutpostLagIds(OutpostLagIdsT&& value) {
    m_outpostLagIdsHasBeenSet = true;
    m_outpostLagIds.emplace_back(std::forward<OutpostLagIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeOutpostLagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeOutpostLagsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
