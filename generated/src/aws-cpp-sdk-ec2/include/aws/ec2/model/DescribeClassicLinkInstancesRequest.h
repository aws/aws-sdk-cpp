...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DescribeClassicLinkInstancesRequest() = default;
  ...
  public:
    ...
    template<typename InstanceIdsT = Aws::Vector<Aws::String>>
    DescribeClassicLinkInstancesRequest& WithInstanceIds(InstanceIdsT&& value) { SetInstanceIds(std::forward<InstanceIdsT>(value)); return *this;}
    template<typename InstanceIdsT = Aws::String>
    DescribeClassicLinkInstancesRequest& AddInstanceIds(InstanceIdsT&& value) { m_instanceIdsHasBeenSet = true; m_instanceIds.emplace_back(std::forward<InstanceIdsT>(value)); return *this; }
    ///@}
     ...
     * the tag value.</p> </li> <li> <p> <code>vpc-id</code> - The ID of the VPC to
     * which the instance is linked.</p> </li> </ul>
     */
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeClassicLinkInstancesRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeClassicLinkInstancesRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeClassicLinkInstancesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
