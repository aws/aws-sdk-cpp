...
class DisableAllowedImagesSettingsResponse {
 public:
  AWS_EC2_API DisableAllowedImagesSettingsResponse() = default;
   ...
   * an error.</p>
   */
  inline AllowedImagesSettingsDisabledState GetAllowedImagesSettingsState() const { return m_allowedImagesSettingsState; }
  inline void SetAllowedImagesSettingsState(AllowedImagesSettingsDisabledState value) {
    m_allowedImagesSettingsStateHasBeenSet = true;
    m_allowedImagesSettingsState = value;
  }
  inline DisableAllowedImagesSettingsResponse& WithAllowedImagesSettingsState(AllowedImagesSettingsDisabledState value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableAllowedImagesSettingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
