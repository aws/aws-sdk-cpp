...
/**
 */
class ModifyApplicationStatusCheckRequest : public EC2Request {
 public:
  AWS_EC2_API ModifyApplicationStatusCheckRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ModifyApplicationStatusCheck"; }
 ...
 public:
  ...
  inline ModifyApplicationStatusCheckRequest& WithAggregation(AggregationStatusEnum value) {
  ...
  inline ModifyApplicationStatusCheckRequest& WithProtocol(NetworkProtocolEnum value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithDeviceIndex(int value) {
  ...
  inline ModifyApplicationStatusCheckRequest& WithIpVersion(IpVersionEnum value) {
    SetIpVersion(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithIpScope(IpScopeEnum value) {
    SetIpScope(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithTimeout(int value) {
    SetTimeout(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyApplicationStatusCheckRequest& WithFailureThreshold(int value) {
  ...
  inline ModifyApplicationStatusCheckRequest& WithSuccessThreshold(int value) {
   ...
   * than the second value. Maximum length: 64 characters.</p>
   */
  ...
  inline ModifyApplicationStatusCheckRequest& WithInitializationGracePeriodSeconds(int value) {
  ...
  inline ModifyApplicationStatusCheckRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
