...
class DeclarativePoliciesReport {
 public:
   ...
   */
  inline ReportState GetStatus() const { return m_status; }
  inline bool StatusHasBeenSet() const { return m_statusHasBeenSet; }
  inline void SetStatus(ReportState value) {
    m_statusHasBeenSet = true;
    m_status = value;
  }
  inline DeclarativePoliciesReport& WithStatus(ReportState value) {
    SetStatus(value);
    return *this;
  }
  ///@}
 ...
 private:
  ...
  ReportState m_status{ReportState::NOT_SET};
