...
class GetAwsNetworkPerformanceDataResponse {
 public:
  ...
  void SetDataResponses(DataResponsesT&& value) {
    m_dataResponsesHasBeenSet = true;
    m_dataResponses = std::forward<DataResponsesT>(value);
  }
  template <typename DataResponsesT = Aws::Vector<DataResponse>>
  GetAwsNetworkPerformanceDataResponse& WithDataResponses(DataResponsesT&& value) {
    SetDataResponses(std::forward<DataResponsesT>(value));
    return *this;
  }
  template <typename DataResponsesT = DataResponse>
  GetAwsNetworkPerformanceDataResponse& AddDataResponses(DataResponsesT&& value) {
    m_dataResponsesHasBeenSet = true;
    m_dataResponses.emplace_back(std::forward<DataResponsesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAwsNetworkPerformanceDataResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetAwsNetworkPerformanceDataResponse& WithResponseMetadata(ResponseMetadataT&& value) {
