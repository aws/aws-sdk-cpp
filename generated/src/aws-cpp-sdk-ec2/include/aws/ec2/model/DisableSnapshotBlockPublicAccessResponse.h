...
class DisableSnapshotBlockPublicAccessResponse {
 public:
  ...
  inline DisableSnapshotBlockPublicAccessResponse& WithState(SnapshotBlockPublicAccessState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableSnapshotBlockPublicAccessResponse& WithResponseMetadata(ResponseMetadataT&& value) {
