...
namespace Model
{
  ...
  public:
    ...
    inline RouteServerBgpOptionsRequest& WithPeerAsn(long long value) { SetPeerAsn(value); return *this;}
    ///@}
    ...
    inline RouteServerBgpOptionsRequest& WithPeerLivenessDetection(RouteServerPeerLivenessMode value) { SetPeerLivenessDetection(value); return *this;}
    ///@}
  private:
