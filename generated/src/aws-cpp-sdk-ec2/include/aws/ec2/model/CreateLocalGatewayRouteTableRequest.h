...
class CreateLocalGatewayRouteTableRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetMode(LocalGatewayRouteTableMode value) {
    m_modeHasBeenSet = true;
    m_mode = value;
  }
  inline CreateLocalGatewayRouteTableRequest& WithMode(LocalGatewayRouteTableMode value) {
    SetMode(value);
    return *this;
  }
  ///@}
  ...
  inline CreateLocalGatewayRouteTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
