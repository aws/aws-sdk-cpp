...
class VerifiedAccessInstanceOpenVpnClientConfiguration {
 public:
  ...
  template <typename ConfigT = Aws::String>
  VerifiedAccessInstanceOpenVpnClientConfiguration& WithConfig(ConfigT&& value) {
  ...
  template <typename RoutesT = Aws::Vector<VerifiedAccessInstanceOpenVpnClientConfigurationRoute>>
  VerifiedAccessInstanceOpenVpnClientConfiguration& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = VerifiedAccessInstanceOpenVpnClientConfigurationRoute>
  VerifiedAccessInstanceOpenVpnClientConfiguration& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
