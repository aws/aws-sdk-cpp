...
class AssociateIpamResourceDiscoveryResponse {
 public:
  ...
  template <typename IpamResourceDiscoveryAssociationT = IpamResourceDiscoveryAssociation>
  AssociateIpamResourceDiscoveryResponse& WithIpamResourceDiscoveryAssociation(IpamResourceDiscoveryAssociationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateIpamResourceDiscoveryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
