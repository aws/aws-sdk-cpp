...
class LaunchPermission {
 public:
  ...
  void SetOrganizationArn(OrganizationArnT&& value) {
    ...
    m_organizationArn = std::forward<OrganizationArnT>(value);
  }
  template <typename OrganizationArnT = Aws::String>
  LaunchPermission& WithOrganizationArn(OrganizationArnT&& value) {
    SetOrganizationArn(std::forward<OrganizationArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOrganizationalUnitArn(OrganizationalUnitArnT&& value) {
    m_organizationalUnitArnHasBeenSet = true;
    m_organizationalUnitArn = std::forward<OrganizationalUnitArnT>(value);
  }
  template <typename OrganizationalUnitArnT = Aws::String>
  LaunchPermission& WithOrganizationalUnitArn(OrganizationalUnitArnT&& value) {
    SetOrganizationalUnitArn(std::forward<OrganizationalUnitArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename UserIdT = Aws::String>
  LaunchPermission& WithUserId(UserIdT&& value) {
  ...
  inline void SetGroup(PermissionGroup value) {
    m_groupHasBeenSet = true;
    m_group = value;
  }
  inline LaunchPermission& WithGroup(PermissionGroup value) {
    SetGroup(value);
    return *this;
  }
  ///@}
