...
namespace Model
{
  ...
  public:
    ...
    inline void SetDimension(FilterByDimension value) { m_dimensionHasBeenSet = true; m_dimension = value; }
    inline DimensionCondition& WithDimension(FilterByDimension value) { SetDimension(value); return *this;}
    ///@}
    ...
    inline DimensionCondition& WithComparison(Comparison value) { SetComparison(value); return *this;}
    ///@}
    ...
    template<typename ValuesT = Aws::Vector<Aws::String>>
    DimensionCondition& WithValues(ValuesT&& value) { SetValues(std::forward<ValuesT>(value)); return *this;}
    template<typename ValuesT = Aws::String>
    DimensionCondition& AddValues(ValuesT&& value) { m_valuesHasBeenSet = true; m_values.emplace_back(std::forward<ValuesT>(value)); return *this; }
    ///@}
  private:
