...
class DisassociateInstanceEventWindowRequest : public EC2Request {
 ...
 public:
  ...
  inline DisassociateInstanceEventWindowRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetAssociationTarget(AssociationTargetT&& value) {
    ...
    m_associationTarget = std::forward<AssociationTargetT>(value);
  }
  template <typename AssociationTargetT = InstanceEventWindowDisassociationRequest>
  DisassociateInstanceEventWindowRequest& WithAssociationTarget(AssociationTargetT&& value) {
    SetAssociationTarget(std::forward<AssociationTargetT>(value));
    return *this;
  }
  ///@}
 private:
