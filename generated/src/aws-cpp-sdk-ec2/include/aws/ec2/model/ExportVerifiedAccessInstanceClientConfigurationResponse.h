...
class ExportVerifiedAccessInstanceClientConfigurationResponse {
 public:
  ...
  AWS_EC2_API ExportVerifiedAccessInstanceClientConfigurationResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename VersionT = Aws::String>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithVersion(VersionT&& value) {
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename RegionT = Aws::String>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithRegion(RegionT&& value) {
  ...
  void SetDeviceTrustProviders(DeviceTrustProvidersT&& value) {
    m_deviceTrustProvidersHasBeenSet = true;
    m_deviceTrustProviders = std::forward<DeviceTrustProvidersT>(value);
  }
  template <typename DeviceTrustProvidersT = Aws::Vector<DeviceTrustProviderType>>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithDeviceTrustProviders(DeviceTrustProvidersT&& value) {
    SetDeviceTrustProviders(std::forward<DeviceTrustProvidersT>(value));
    return *this;
  }
  inline ExportVerifiedAccessInstanceClientConfigurationResponse& AddDeviceTrustProviders(DeviceTrustProviderType value) {
    m_deviceTrustProvidersHasBeenSet = true;
    m_deviceTrustProviders.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetUserTrustProvider(UserTrustProviderT&& value) {
    m_userTrustProviderHasBeenSet = true;
    m_userTrustProvider = std::forward<UserTrustProviderT>(value);
  }
  template <typename UserTrustProviderT = VerifiedAccessInstanceUserTrustProviderClientConfiguration>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithUserTrustProvider(UserTrustProviderT&& value) {
    SetUserTrustProvider(std::forward<UserTrustProviderT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<VerifiedAccessInstanceOpenVpnClientConfiguration>& GetOpenVpnConfigurations() const {
    return m_openVpnConfigurations;
  }
  template <typename OpenVpnConfigurationsT = Aws::Vector<VerifiedAccessInstanceOpenVpnClientConfiguration>>
  void SetOpenVpnConfigurations(OpenVpnConfigurationsT&& value) {
    m_openVpnConfigurationsHasBeenSet = true;
    m_openVpnConfigurations = std::forward<OpenVpnConfigurationsT>(value);
  }
  template <typename OpenVpnConfigurationsT = Aws::Vector<VerifiedAccessInstanceOpenVpnClientConfiguration>>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithOpenVpnConfigurations(OpenVpnConfigurationsT&& value) {
    SetOpenVpnConfigurations(std::forward<OpenVpnConfigurationsT>(value));
    return *this;
  }
  template <typename OpenVpnConfigurationsT = VerifiedAccessInstanceOpenVpnClientConfiguration>
  ExportVerifiedAccessInstanceClientConfigurationResponse& AddOpenVpnConfigurations(OpenVpnConfigurationsT&& value) {
    m_openVpnConfigurationsHasBeenSet = true;
    m_openVpnConfigurations.emplace_back(std::forward<OpenVpnConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ExportVerifiedAccessInstanceClientConfigurationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
