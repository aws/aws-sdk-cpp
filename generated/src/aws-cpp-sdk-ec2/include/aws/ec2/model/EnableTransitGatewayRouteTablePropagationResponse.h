...
class EnableTransitGatewayRouteTablePropagationResponse {
 public:
  ...
  AWS_EC2_API EnableTransitGatewayRouteTablePropagationResponse& operator=(
  ...
  void SetPropagation(PropagationT&& value) {
    m_propagationHasBeenSet = true;
    m_propagation = std::forward<PropagationT>(value);
  }
  template <typename PropagationT = TransitGatewayPropagation>
  EnableTransitGatewayRouteTablePropagationResponse& WithPropagation(PropagationT&& value) {
    SetPropagation(std::forward<PropagationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableTransitGatewayRouteTablePropagationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
