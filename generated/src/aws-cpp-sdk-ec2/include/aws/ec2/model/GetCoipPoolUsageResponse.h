...
class GetCoipPoolUsageResponse {
 public:
  ...
  void SetCoipAddressUsages(CoipAddressUsagesT&& value) {
    ...
    m_coipAddressUsages = std::forward<CoipAddressUsagesT>(value);
  }
  template <typename CoipAddressUsagesT = Aws::Vector<CoipAddressUsage>>
  GetCoipPoolUsageResponse& WithCoipAddressUsages(CoipAddressUsagesT&& value) {
    SetCoipAddressUsages(std::forward<CoipAddressUsagesT>(value));
    return *this;
  }
  ...
  GetCoipPoolUsageResponse& AddCoipAddressUsages(CoipAddressUsagesT&& value) {
    m_coipAddressUsagesHasBeenSet = true;
    m_coipAddressUsages.emplace_back(std::forward<CoipAddressUsagesT>(value));
    return *this;
  }
  ///@}
