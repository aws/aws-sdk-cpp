...
class DescribeDhcpOptionsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename DhcpOptionsIdsT = Aws::Vector<Aws::String>>
  void SetDhcpOptionsIds(DhcpOptionsIdsT&& value) {
    m_dhcpOptionsIdsHasBeenSet = true;
    m_dhcpOptionsIds = std::forward<DhcpOptionsIdsT>(value);
  }
  template <typename DhcpOptionsIdsT = Aws::Vector<Aws::String>>
  DescribeDhcpOptionsRequest& WithDhcpOptionsIds(DhcpOptionsIdsT&& value) {
    SetDhcpOptionsIds(std::forward<DhcpOptionsIdsT>(value));
    return *this;
  }
  template <typename DhcpOptionsIdsT = Aws::String>
  DescribeDhcpOptionsRequest& AddDhcpOptionsIds(DhcpOptionsIdsT&& value) {
    m_dhcpOptionsIdsHasBeenSet = true;
    m_dhcpOptionsIds.emplace_back(std::forward<DhcpOptionsIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeDhcpOptionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeDhcpOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
   ...
   * DHCP options set.</p> </li> <li> <p> <code>tag</code> - The key/value
