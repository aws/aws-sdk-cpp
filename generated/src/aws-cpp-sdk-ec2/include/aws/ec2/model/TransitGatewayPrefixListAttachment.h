...
class TransitGatewayPrefixListAttachment {
 public:
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  TransitGatewayPrefixListAttachment& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline TransitGatewayPrefixListAttachment& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  template <typename ResourceIdT = Aws::String>
  TransitGatewayPrefixListAttachment& WithResourceId(ResourceIdT&& value) {
