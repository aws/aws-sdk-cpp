...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API TransitGatewayPrefixListAttachment() = default;
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    TransitGatewayPrefixListAttachment& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
    ...
    inline TransitGatewayPrefixListAttachment& WithResourceType(TransitGatewayAttachmentResourceType value) { SetResourceType(value); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    TransitGatewayPrefixListAttachment& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
  private:
