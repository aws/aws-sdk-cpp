...
class DeleteNetworkInterfacePermissionResponse {
 public:
  ...
  inline DeleteNetworkInterfacePermissionResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteNetworkInterfacePermissionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
