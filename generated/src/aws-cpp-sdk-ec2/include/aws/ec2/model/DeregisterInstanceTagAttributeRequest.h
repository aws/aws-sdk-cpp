...
class DeregisterInstanceTagAttributeRequest {
 public:
  ...
  inline void SetIncludeAllTagsOfInstance(bool value) {
    m_includeAllTagsOfInstanceHasBeenSet = true;
    m_includeAllTagsOfInstance = value;
  }
  inline DeregisterInstanceTagAttributeRequest& WithIncludeAllTagsOfInstance(bool value) {
    SetIncludeAllTagsOfInstance(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceTagKeys(InstanceTagKeysT&& value) {
    m_instanceTagKeysHasBeenSet = true;
    m_instanceTagKeys = std::forward<InstanceTagKeysT>(value);
  }
  template <typename InstanceTagKeysT = Aws::Vector<Aws::String>>
  DeregisterInstanceTagAttributeRequest& WithInstanceTagKeys(InstanceTagKeysT&& value) {
    SetInstanceTagKeys(std::forward<InstanceTagKeysT>(value));
    return *this;
  }
  template <typename InstanceTagKeysT = Aws::String>
  DeregisterInstanceTagAttributeRequest& AddInstanceTagKeys(InstanceTagKeysT&& value) {
    m_instanceTagKeysHasBeenSet = true;
    m_instanceTagKeys.emplace_back(std::forward<InstanceTagKeysT>(value));
    return *this;
  }
  ///@}
 private:
