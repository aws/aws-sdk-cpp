...
namespace Model
{
   ...
   * API Reference</a></p>
   */
  class CreateVpnConnectionRouteRequest : public EC2Request
  {
  public:
    AWS_EC2_API CreateVpnConnectionRouteRequest() = default;
  ...
  public:
    ...
    template<typename DestinationCidrBlockT = Aws::String>
    CreateVpnConnectionRouteRequest& WithDestinationCidrBlock(DestinationCidrBlockT&& value) { SetDestinationCidrBlock(std::forward<DestinationCidrBlockT>(value)); return *this;}
    ///@}
    ...
    template<typename VpnConnectionIdT = Aws::String>
    CreateVpnConnectionRouteRequest& WithVpnConnectionId(VpnConnectionIdT&& value) { SetVpnConnectionId(std::forward<VpnConnectionIdT>(value)); return *this;}
    ///@}
  private:
