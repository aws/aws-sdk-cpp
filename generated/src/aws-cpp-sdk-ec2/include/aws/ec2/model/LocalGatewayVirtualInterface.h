...
class LocalGatewayVirtualInterface {
 public:
  ...
  void SetLocalGatewayVirtualInterfaceArn(LocalGatewayVirtualInterfaceArnT&& value) {
    ...
    m_localGatewayVirtualInterfaceArn = std::forward<LocalGatewayVirtualInterfaceArnT>(value);
  }
  template <typename LocalGatewayVirtualInterfaceArnT = Aws::String>
  LocalGatewayVirtualInterface& WithLocalGatewayVirtualInterfaceArn(LocalGatewayVirtualInterfaceArnT&& value) {
    SetLocalGatewayVirtualInterfaceArn(std::forward<LocalGatewayVirtualInterfaceArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline LocalGatewayVirtualInterface& WithVlan(int value) {
    SetVlan(value);
    return *this;
  }
  ///@}
  ...
  inline LocalGatewayVirtualInterface& WithLocalBgpAsn(int value) {
  ...
  inline LocalGatewayVirtualInterface& WithPeerBgpAsn(int value) {
    SetPeerBgpAsn(value);
    return *this;
  }
  ///@}
  ...
  inline LocalGatewayVirtualInterface& WithPeerBgpAsnExtended(long long value) {
  ...
  inline void SetConfigurationState(LocalGatewayVirtualInterfaceConfigurationState value) {
    m_configurationStateHasBeenSet = true;
    m_configurationState = value;
  }
  inline LocalGatewayVirtualInterface& WithConfigurationState(LocalGatewayVirtualInterfaceConfigurationState value) {
