...
class DescribeStoreImageTasksResponse {
 public:
  ...
  void SetStoreImageTaskResults(StoreImageTaskResultsT&& value) {
    m_storeImageTaskResultsHasBeenSet = true;
    m_storeImageTaskResults = std::forward<StoreImageTaskResultsT>(value);
  }
  template <typename StoreImageTaskResultsT = Aws::Vector<StoreImageTaskResponse>>
  DescribeStoreImageTasksResponse& WithStoreImageTaskResults(StoreImageTaskResultsT&& value) {
    SetStoreImageTaskResults(std::forward<StoreImageTaskResultsT>(value));
    return *this;
  }
  template <typename StoreImageTaskResultsT = StoreImageTaskResponse>
  DescribeStoreImageTasksResponse& AddStoreImageTaskResults(StoreImageTaskResultsT&& value) {
    m_storeImageTaskResultsHasBeenSet = true;
    m_storeImageTaskResults.emplace_back(std::forward<StoreImageTaskResultsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeStoreImageTasksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeStoreImageTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
