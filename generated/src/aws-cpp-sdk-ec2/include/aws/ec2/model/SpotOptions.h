...
class SpotOptions {
 public:
  ...
  inline SpotOptions& WithInstanceInterruptionBehavior(SpotInstanceInterruptionBehavior value) {
  ...
  inline SpotOptions& WithInstancePoolsToUseCount(int value) {
  ...
  inline SpotOptions& WithSingleInstanceType(bool value) {
  ...
  inline SpotOptions& WithSingleAvailabilityZone(bool value) {
  ...
  inline SpotOptions& WithMinTargetCapacity(int value) {
