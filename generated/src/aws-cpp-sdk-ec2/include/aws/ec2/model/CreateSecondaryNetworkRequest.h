...
/**
 */
class CreateSecondaryNetworkRequest : public EC2Request {
 public:
  AWS_EC2_API CreateSecondaryNetworkRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "CreateSecondaryNetwork"; }
 ...
 public:
  ...
  inline CreateSecondaryNetworkRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The IPv4 CIDR block for the secondary network. The CIDR block size must be
   * between /12 and /28.</p>
   */
   ...
   */
  inline SecondaryNetworkType GetNetworkType() const { return m_networkType; }
  inline bool NetworkTypeHasBeenSet() const { return m_networkTypeHasBeenSet; }
  inline void SetNetworkType(SecondaryNetworkType value) {
    m_networkTypeHasBeenSet = true;
    m_networkType = value;
  }
  inline CreateSecondaryNetworkRequest& WithNetworkType(SecondaryNetworkType value) {
 ...
 private:
  ...
  SecondaryNetworkType m_networkType{SecondaryNetworkType::NOT_SET};
