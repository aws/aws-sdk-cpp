...
class DescribeTrafficMirrorSessionsResponse {
 public:
  ...
  void SetTrafficMirrorSessions(TrafficMirrorSessionsT&& value) {
    m_trafficMirrorSessionsHasBeenSet = true;
    m_trafficMirrorSessions = std::forward<TrafficMirrorSessionsT>(value);
  }
  template <typename TrafficMirrorSessionsT = Aws::Vector<TrafficMirrorSession>>
  DescribeTrafficMirrorSessionsResponse& WithTrafficMirrorSessions(TrafficMirrorSessionsT&& value) {
    SetTrafficMirrorSessions(std::forward<TrafficMirrorSessionsT>(value));
    return *this;
  }
  template <typename TrafficMirrorSessionsT = TrafficMirrorSession>
  DescribeTrafficMirrorSessionsResponse& AddTrafficMirrorSessions(TrafficMirrorSessionsT&& value) {
    m_trafficMirrorSessionsHasBeenSet = true;
    m_trafficMirrorSessions.emplace_back(std::forward<TrafficMirrorSessionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorSessionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTrafficMirrorSessionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
