...
class ModifyAvailabilityZoneGroupRequest : public EC2Request {
 ...
 public:
  ...
  template <typename GroupNameT = Aws::String>
  ModifyAvailabilityZoneGroupRequest& WithGroupName(GroupNameT&& value) {
  ...
  inline void SetOptInStatus(ModifyAvailabilityZoneOptInStatus value) {
    m_optInStatusHasBeenSet = true;
    m_optInStatus = value;
  }
  inline ModifyAvailabilityZoneGroupRequest& WithOptInStatus(ModifyAvailabilityZoneOptInStatus value) {
  ...
  inline ModifyAvailabilityZoneGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
