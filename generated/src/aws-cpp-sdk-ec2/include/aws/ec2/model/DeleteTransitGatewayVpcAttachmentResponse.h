...
class DeleteTransitGatewayVpcAttachmentResponse {
 public:
  ...
  template <typename TransitGatewayVpcAttachmentT = TransitGatewayVpcAttachment>
  DeleteTransitGatewayVpcAttachmentResponse& WithTransitGatewayVpcAttachment(TransitGatewayVpcAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayVpcAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
