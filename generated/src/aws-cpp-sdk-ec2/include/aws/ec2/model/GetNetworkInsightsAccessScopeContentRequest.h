...
class GetNetworkInsightsAccessScopeContentRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NetworkInsightsAccessScopeIdT = Aws::String>
  GetNetworkInsightsAccessScopeContentRequest& WithNetworkInsightsAccessScopeId(NetworkInsightsAccessScopeIdT&& value) {
  ...
  inline GetNetworkInsightsAccessScopeContentRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
