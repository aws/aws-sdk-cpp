...
class DescribeAddressesAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetAttribute(AddressAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline DescribeAddressesAttributeRequest& WithAttribute(AddressAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAddressesAttributeRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeAddressesAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
