...
class ProductCode {
 public:
  ...
  void SetProductCodeId(ProductCodeIdT&& value) {
    ...
    m_productCodeId = std::forward<ProductCodeIdT>(value);
  }
  template <typename ProductCodeIdT = Aws::String>
  ProductCode& WithProductCodeId(ProductCodeIdT&& value) {
    SetProductCodeId(std::forward<ProductCodeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetProductCodeType(ProductCodeValues value) {
    m_productCodeTypeHasBeenSet = true;
    m_productCodeType = value;
  }
  inline ProductCode& WithProductCodeType(ProductCodeValues value) {
    SetProductCodeType(value);
    return *this;
  }
  ///@}
 private:
