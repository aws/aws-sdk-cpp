...
class CreateIpamRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateIpamRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename DescriptionT = Aws::String>
  CreateIpamRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename OperatingRegionsT = Aws::Vector<AddIpamOperatingRegion>>
  CreateIpamRequest& WithOperatingRegions(OperatingRegionsT&& value) {
    SetOperatingRegions(std::forward<OperatingRegionsT>(value));
    return *this;
  }
  template <typename OperatingRegionsT = AddIpamOperatingRegion>
  CreateIpamRequest& AddOperatingRegions(OperatingRegionsT&& value) {
    m_operatingRegionsHasBeenSet = true;
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateIpamRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateIpamRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateIpamRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline void SetTier(IpamTier value) {
    m_tierHasBeenSet = true;
    m_tier = value;
  }
  inline CreateIpamRequest& WithTier(IpamTier value) {
    SetTier(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnablePrivateGua(bool value) {
    m_enablePrivateGuaHasBeenSet = true;
    m_enablePrivateGua = value;
  }
  inline CreateIpamRequest& WithEnablePrivateGua(bool value) {
    SetEnablePrivateGua(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMeteredAccount(IpamMeteredAccount value) {
    m_meteredAccountHasBeenSet = true;
    m_meteredAccount = value;
  }
  inline CreateIpamRequest& WithMeteredAccount(IpamMeteredAccount value) {
