...
class CapacityReservation {
 public:
  ...
  void SetCapacityReservationArn(CapacityReservationArnT&& value) {
    ...
    m_capacityReservationArn = std::forward<CapacityReservationArnT>(value);
  }
  template <typename CapacityReservationArnT = Aws::String>
  CapacityReservation& WithCapacityReservationArn(CapacityReservationArnT&& value) {
    SetCapacityReservationArn(std::forward<CapacityReservationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline CapacityReservation& WithInstancePlatform(CapacityReservationInstancePlatform value) {
  ...
  inline CapacityReservation& WithTenancy(CapacityReservationTenancy value) {
    SetTenancy(value);
    return *this;
  }
  ///@}
  ...
  inline CapacityReservation& WithTotalInstanceCount(int value) {
  ...
  inline CapacityReservation& WithAvailableInstanceCount(int value) {
  ...
  inline CapacityReservation& WithEbsOptimized(bool value) {
  ...
  inline CapacityReservation& WithEphemeralStorage(bool value) {
  ...
  inline CapacityReservation& WithState(CapacityReservationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CapacityReservation& WithEndDateType(EndDateType value) {
  ...
  inline CapacityReservation& WithInstanceMatchCriteria(InstanceMatchCriteria value) {
  ...
  void SetCapacityAllocations(CapacityAllocationsT&& value) {
    ...
    m_capacityAllocations = std::forward<CapacityAllocationsT>(value);
  }
  template <typename CapacityAllocationsT = Aws::Vector<CapacityAllocation>>
  CapacityReservation& WithCapacityAllocations(CapacityAllocationsT&& value) {
    SetCapacityAllocations(std::forward<CapacityAllocationsT>(value));
    return *this;
  }
  ...
  CapacityReservation& AddCapacityAllocations(CapacityAllocationsT&& value) {
    m_capacityAllocationsHasBeenSet = true;
    m_capacityAllocations.emplace_back(std::forward<CapacityAllocationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetReservationType(CapacityReservationType value) {
    m_reservationTypeHasBeenSet = true;
    m_reservationType = value;
  }
  inline CapacityReservation& WithReservationType(CapacityReservationType value) {
  ...
  void SetCommitmentInfo(CommitmentInfoT&& value) {
    ...
    m_commitmentInfo = std::forward<CommitmentInfoT>(value);
  }
  template <typename CommitmentInfoT = CapacityReservationCommitmentInfo>
  CapacityReservation& WithCommitmentInfo(CommitmentInfoT&& value) {
    SetCommitmentInfo(std::forward<CommitmentInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline CapacityReservation& WithDeliveryPreference(CapacityReservationDeliveryPreference value) {
  ...
  ///@{
  /**
   * <p> Contains allocation details for interruptible reservations, including
   * current allocated instances and target instance counts within the
   * interruptibleCapacityAllocation object. </p>
   */
  ...
  inline bool InterruptibleCapacityAllocationHasBeenSet() const { return m_interruptibleCapacityAllocationHasBeenSet; }
  ...
  ///@{
  /**
   * <p> Information about the interruption configuration and association with the
   * source reservation for interruptible Capacity Reservations. </p>
   */
  inline const InterruptionInfo& GetInterruptionInfo() const { return m_interruptionInfo; }
  inline bool InterruptionInfoHasBeenSet() const { return m_interruptionInfoHasBeenSet; }
