...
class ClientVpnRouteStatus {
 public:
  ...
  inline void SetCode(ClientVpnRouteStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClientVpnRouteStatus& WithCode(ClientVpnRouteStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClientVpnRouteStatus& WithMessage(MessageT&& value) {
