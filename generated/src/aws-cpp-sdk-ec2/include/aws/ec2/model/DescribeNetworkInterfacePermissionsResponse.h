...
class DescribeNetworkInterfacePermissionsResponse {
 public:
  ...
  AWS_EC2_API DescribeNetworkInterfacePermissionsResponse& operator=(
  ...
  void SetNetworkInterfacePermissions(NetworkInterfacePermissionsT&& value) {
    m_networkInterfacePermissionsHasBeenSet = true;
    m_networkInterfacePermissions = std::forward<NetworkInterfacePermissionsT>(value);
  }
  template <typename NetworkInterfacePermissionsT = Aws::Vector<NetworkInterfacePermission>>
  DescribeNetworkInterfacePermissionsResponse& WithNetworkInterfacePermissions(NetworkInterfacePermissionsT&& value) {
    SetNetworkInterfacePermissions(std::forward<NetworkInterfacePermissionsT>(value));
    return *this;
  }
  template <typename NetworkInterfacePermissionsT = NetworkInterfacePermission>
  DescribeNetworkInterfacePermissionsResponse& AddNetworkInterfacePermissions(NetworkInterfacePermissionsT&& value) {
    m_networkInterfacePermissionsHasBeenSet = true;
    m_networkInterfacePermissions.emplace_back(std::forward<NetworkInterfacePermissionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkInterfacePermissionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeNetworkInterfacePermissionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
