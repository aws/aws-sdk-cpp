...
class DetachInternetGatewayRequest : public EC2Request {
 ...
 public:
  ...
  inline DetachInternetGatewayRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InternetGatewayIdT = Aws::String>
  DetachInternetGatewayRequest& WithInternetGatewayId(InternetGatewayIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  DetachInternetGatewayRequest& WithVpcId(VpcIdT&& value) {
