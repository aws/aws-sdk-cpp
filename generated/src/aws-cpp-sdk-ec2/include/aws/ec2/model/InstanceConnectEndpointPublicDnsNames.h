...
class InstanceConnectEndpointPublicDnsNames {
 public:
  ...
  void SetIpv4(Ipv4T&& value) {
    ...
    m_ipv4 = std::forward<Ipv4T>(value);
  }
  template <typename Ipv4T = InstanceConnectEndpointDnsNames>
  InstanceConnectEndpointPublicDnsNames& WithIpv4(Ipv4T&& value) {
    SetIpv4(std::forward<Ipv4T>(value));
    return *this;
  }
  ///@}
  ...
  void SetDualstack(DualstackT&& value) {
    m_dualstackHasBeenSet = true;
    m_dualstack = std::forward<DualstackT>(value);
  }
  template <typename DualstackT = InstanceConnectEndpointDnsNames>
  InstanceConnectEndpointPublicDnsNames& WithDualstack(DualstackT&& value) {
    SetDualstack(std::forward<DualstackT>(value));
    return *this;
  }
  ///@}
 private:
