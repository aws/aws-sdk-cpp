...
class EnableIpamOrganizationAdminAccountRequest : public EC2Request {
 ...
 public:
  ...
  inline EnableIpamOrganizationAdminAccountRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename DelegatedAdminAccountIdT = Aws::String>
  EnableIpamOrganizationAdminAccountRequest& WithDelegatedAdminAccountId(DelegatedAdminAccountIdT&& value) {
