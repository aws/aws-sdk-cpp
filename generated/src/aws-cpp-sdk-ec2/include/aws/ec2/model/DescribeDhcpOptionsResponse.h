...
class DescribeDhcpOptionsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeDhcpOptionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetDhcpOptions(DhcpOptionsT&& value) {
    m_dhcpOptionsHasBeenSet = true;
    m_dhcpOptions = std::forward<DhcpOptionsT>(value);
  }
  template <typename DhcpOptionsT = Aws::Vector<DhcpOptions>>
  DescribeDhcpOptionsResponse& WithDhcpOptions(DhcpOptionsT&& value) {
    SetDhcpOptions(std::forward<DhcpOptionsT>(value));
    return *this;
  }
  template <typename DhcpOptionsT = DhcpOptions>
  DescribeDhcpOptionsResponse& AddDhcpOptions(DhcpOptionsT&& value) {
    m_dhcpOptionsHasBeenSet = true;
    m_dhcpOptions.emplace_back(std::forward<DhcpOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeDhcpOptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
