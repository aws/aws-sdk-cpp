...
class DescribeFastLaunchImagesResponse {
 public:
  ...
  void SetFastLaunchImages(FastLaunchImagesT&& value) {
    m_fastLaunchImagesHasBeenSet = true;
    m_fastLaunchImages = std::forward<FastLaunchImagesT>(value);
  }
  template <typename FastLaunchImagesT = Aws::Vector<DescribeFastLaunchImagesSuccessItem>>
  DescribeFastLaunchImagesResponse& WithFastLaunchImages(FastLaunchImagesT&& value) {
    SetFastLaunchImages(std::forward<FastLaunchImagesT>(value));
    return *this;
  }
  template <typename FastLaunchImagesT = DescribeFastLaunchImagesSuccessItem>
  DescribeFastLaunchImagesResponse& AddFastLaunchImages(FastLaunchImagesT&& value) {
    m_fastLaunchImagesHasBeenSet = true;
    m_fastLaunchImages.emplace_back(std::forward<FastLaunchImagesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFastLaunchImagesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFastLaunchImagesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
