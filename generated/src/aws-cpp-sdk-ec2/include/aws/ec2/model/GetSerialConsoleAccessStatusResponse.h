...
class GetSerialConsoleAccessStatusResponse {
 public:
  ...
  inline GetSerialConsoleAccessStatusResponse& WithSerialConsoleAccessEnabled(bool value) {
  ...
  inline GetSerialConsoleAccessStatusResponse& WithManagedBy(ManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetSerialConsoleAccessStatusResponse& WithResponseMetadata(ResponseMetadataT&& value) {
