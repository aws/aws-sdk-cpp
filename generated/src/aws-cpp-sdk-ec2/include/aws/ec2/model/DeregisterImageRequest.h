...
class DeregisterImageRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetDeleteAssociatedSnapshots(bool value) {
    m_deleteAssociatedSnapshotsHasBeenSet = true;
    m_deleteAssociatedSnapshots = value;
  }
  inline DeregisterImageRequest& WithDeleteAssociatedSnapshots(bool value) {
    SetDeleteAssociatedSnapshots(value);
    return *this;
  }
  ///@}
  ...
  inline DeregisterImageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
