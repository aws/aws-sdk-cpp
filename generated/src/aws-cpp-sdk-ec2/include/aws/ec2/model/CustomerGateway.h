...
class CustomerGateway {
 public:
  ...
  void SetBgpAsnExtended(BgpAsnExtendedT&& value) {
    ...
    m_bgpAsnExtended = std::forward<BgpAsnExtendedT>(value);
  }
  template <typename BgpAsnExtendedT = Aws::String>
  CustomerGateway& WithBgpAsnExtended(BgpAsnExtendedT&& value) {
    SetBgpAsnExtended(std::forward<BgpAsnExtendedT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBgpAsn(BgpAsnT&& value) {
    ...
    m_bgpAsn = std::forward<BgpAsnT>(value);
  }
  template <typename BgpAsnT = Aws::String>
  CustomerGateway& WithBgpAsn(BgpAsnT&& value) {
    SetBgpAsn(std::forward<BgpAsnT>(value));
    return *this;
  }
  ///@}
 private:
