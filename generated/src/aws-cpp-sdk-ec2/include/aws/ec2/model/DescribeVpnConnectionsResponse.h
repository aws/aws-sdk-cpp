...
class DescribeVpnConnectionsResponse {
 public:
  ...
  void SetVpnConnections(VpnConnectionsT&& value) {
    m_vpnConnectionsHasBeenSet = true;
    m_vpnConnections = std::forward<VpnConnectionsT>(value);
  }
  template <typename VpnConnectionsT = Aws::Vector<VpnConnection>>
  DescribeVpnConnectionsResponse& WithVpnConnections(VpnConnectionsT&& value) {
    SetVpnConnections(std::forward<VpnConnectionsT>(value));
    return *this;
  }
  template <typename VpnConnectionsT = VpnConnection>
  DescribeVpnConnectionsResponse& AddVpnConnections(VpnConnectionsT&& value) {
    m_vpnConnectionsHasBeenSet = true;
    m_vpnConnections.emplace_back(std::forward<VpnConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpnConnectionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
