...
class AllocateIpamPoolCidrResponse {
 public:
  ...
  void SetIpamPoolAllocation(IpamPoolAllocationT&& value) {
    m_ipamPoolAllocationHasBeenSet = true;
    m_ipamPoolAllocation = std::forward<IpamPoolAllocationT>(value);
  }
  template <typename IpamPoolAllocationT = IpamPoolAllocation>
  AllocateIpamPoolCidrResponse& WithIpamPoolAllocation(IpamPoolAllocationT&& value) {
    SetIpamPoolAllocation(std::forward<IpamPoolAllocationT>(value));
    return *this;
  }
  ///@}
