 ...
 * trust provider using the <code>user</code> type.</p><p><h3>See Also:</h3>   <a
...
class CreateVerifiedAccessTrustProviderOidcOptions {
 public:
  ...
  template <typename IssuerT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithIssuer(IssuerT&& value) {
  ...
  template <typename AuthorizationEndpointT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) {
  ...
  template <typename TokenEndpointT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithTokenEndpoint(TokenEndpointT&& value) {
  ...
  template <typename UserInfoEndpointT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithUserInfoEndpoint(UserInfoEndpointT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ScopeT = Aws::String>
  CreateVerifiedAccessTrustProviderOidcOptions& WithScope(ScopeT&& value) {
