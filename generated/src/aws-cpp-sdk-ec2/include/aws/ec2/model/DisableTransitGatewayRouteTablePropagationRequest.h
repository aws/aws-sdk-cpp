...
class DisableTransitGatewayRouteTablePropagationRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  DisableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  DisableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline DisableTransitGatewayRouteTablePropagationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayRouteTableAnnouncementIdT = Aws::String>
  DisableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableAnnouncementId(
