...
class DiskInfo {
 public:
  ...
  inline void SetSizeInGB(long long value) {
    m_sizeInGBHasBeenSet = true;
    m_sizeInGB = value;
  }
  inline DiskInfo& WithSizeInGB(long long value) {
    SetSizeInGB(value);
    return *this;
  }
  ///@}
  ...
  inline DiskInfo& WithCount(int value) {
    SetCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetType(DiskType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline DiskInfo& WithType(DiskType value) {
    SetType(value);
    return *this;
  }
  ///@}
