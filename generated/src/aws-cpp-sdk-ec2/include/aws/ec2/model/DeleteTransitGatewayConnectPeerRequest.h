...
class DeleteTransitGatewayConnectPeerRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayConnectPeerIdT = Aws::String>
  DeleteTransitGatewayConnectPeerRequest& WithTransitGatewayConnectPeerId(TransitGatewayConnectPeerIdT&& value) {
  ...
  inline DeleteTransitGatewayConnectPeerRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
