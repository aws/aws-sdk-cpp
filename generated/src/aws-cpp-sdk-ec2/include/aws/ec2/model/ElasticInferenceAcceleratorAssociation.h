...
class ElasticInferenceAcceleratorAssociation {
 public:
  ...
  void SetElasticInferenceAcceleratorArn(ElasticInferenceAcceleratorArnT&& value) {
    m_elasticInferenceAcceleratorArnHasBeenSet = true;
    m_elasticInferenceAcceleratorArn = std::forward<ElasticInferenceAcceleratorArnT>(value);
  }
  template <typename ElasticInferenceAcceleratorArnT = Aws::String>
  ElasticInferenceAcceleratorAssociation& WithElasticInferenceAcceleratorArn(ElasticInferenceAcceleratorArnT&& value) {
    SetElasticInferenceAcceleratorArn(std::forward<ElasticInferenceAcceleratorArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetElasticInferenceAcceleratorAssociationId(ElasticInferenceAcceleratorAssociationIdT&& value) {
    m_elasticInferenceAcceleratorAssociationIdHasBeenSet = true;
    m_elasticInferenceAcceleratorAssociationId = std::forward<ElasticInferenceAcceleratorAssociationIdT>(value);
  }
  template <typename ElasticInferenceAcceleratorAssociationIdT = Aws::String>
  ElasticInferenceAcceleratorAssociation& WithElasticInferenceAcceleratorAssociationId(ElasticInferenceAcceleratorAssociationIdT&& value) {
    SetElasticInferenceAcceleratorAssociationId(std::forward<ElasticInferenceAcceleratorAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline bool ElasticInferenceAcceleratorAssociationStateHasBeenSet() const {
    return m_elasticInferenceAcceleratorAssociationStateHasBeenSet;
  }
  template <typename ElasticInferenceAcceleratorAssociationStateT = Aws::String>
  void SetElasticInferenceAcceleratorAssociationState(ElasticInferenceAcceleratorAssociationStateT&& value) {
    m_elasticInferenceAcceleratorAssociationStateHasBeenSet = true;
    m_elasticInferenceAcceleratorAssociationState = std::forward<ElasticInferenceAcceleratorAssociationStateT>(value);
  }
  template <typename ElasticInferenceAcceleratorAssociationStateT = Aws::String>
  ElasticInferenceAcceleratorAssociation& WithElasticInferenceAcceleratorAssociationState(
      ElasticInferenceAcceleratorAssociationStateT&& value) {
    SetElasticInferenceAcceleratorAssociationState(std::forward<ElasticInferenceAcceleratorAssociationStateT>(value));
    return *this;
  }
  ///@}
   ...
   * instance. </p>
   */
  inline const Aws::Utils::DateTime& GetElasticInferenceAcceleratorAssociationTime() const {
    return m_elasticInferenceAcceleratorAssociationTime;
  }
  inline bool ElasticInferenceAcceleratorAssociationTimeHasBeenSet() const {
    return m_elasticInferenceAcceleratorAssociationTimeHasBeenSet;
  }
  template <typename ElasticInferenceAcceleratorAssociationTimeT = Aws::Utils::DateTime>
  void SetElasticInferenceAcceleratorAssociationTime(ElasticInferenceAcceleratorAssociationTimeT&& value) {
    m_elasticInferenceAcceleratorAssociationTimeHasBeenSet = true;
    m_elasticInferenceAcceleratorAssociationTime = std::forward<ElasticInferenceAcceleratorAssociationTimeT>(value);
  }
  template <typename ElasticInferenceAcceleratorAssociationTimeT = Aws::Utils::DateTime>
  ElasticInferenceAcceleratorAssociation& WithElasticInferenceAcceleratorAssociationTime(
      ElasticInferenceAcceleratorAssociationTimeT&& value) {
    SetElasticInferenceAcceleratorAssociationTime(std::forward<ElasticInferenceAcceleratorAssociationTimeT>(value));
    return *this;
  }
  ///@}
 private:
