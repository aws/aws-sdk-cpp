...
class ModifyIpamResourceCidrRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyIpamResourceCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetCurrentIpamScopeId(CurrentIpamScopeIdT&& value) {
    m_currentIpamScopeIdHasBeenSet = true;
    m_currentIpamScopeId = std::forward<CurrentIpamScopeIdT>(value);
  }
  template <typename CurrentIpamScopeIdT = Aws::String>
  ModifyIpamResourceCidrRequest& WithCurrentIpamScopeId(CurrentIpamScopeIdT&& value) {
    SetCurrentIpamScopeId(std::forward<CurrentIpamScopeIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationIpamScopeId(DestinationIpamScopeIdT&& value) {
    m_destinationIpamScopeIdHasBeenSet = true;
    m_destinationIpamScopeId = std::forward<DestinationIpamScopeIdT>(value);
  }
  template <typename DestinationIpamScopeIdT = Aws::String>
  ModifyIpamResourceCidrRequest& WithDestinationIpamScopeId(DestinationIpamScopeIdT&& value) {
    SetDestinationIpamScopeId(std::forward<DestinationIpamScopeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMonitored(bool value) {
    m_monitoredHasBeenSet = true;
    m_monitored = value;
  }
  inline ModifyIpamResourceCidrRequest& WithMonitored(bool value) {
    SetMonitored(value);
    return *this;
  }
  ///@}
