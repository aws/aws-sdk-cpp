...
class DescribeScheduledInstancesResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeScheduledInstancesResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetScheduledInstanceSet(ScheduledInstanceSetT&& value) {
    m_scheduledInstanceSetHasBeenSet = true;
    m_scheduledInstanceSet = std::forward<ScheduledInstanceSetT>(value);
  }
  template <typename ScheduledInstanceSetT = Aws::Vector<ScheduledInstance>>
  DescribeScheduledInstancesResponse& WithScheduledInstanceSet(ScheduledInstanceSetT&& value) {
    SetScheduledInstanceSet(std::forward<ScheduledInstanceSetT>(value));
    return *this;
  }
  template <typename ScheduledInstanceSetT = ScheduledInstance>
  DescribeScheduledInstancesResponse& AddScheduledInstanceSet(ScheduledInstanceSetT&& value) {
    m_scheduledInstanceSetHasBeenSet = true;
    m_scheduledInstanceSet.emplace_back(std::forward<ScheduledInstanceSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeScheduledInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
