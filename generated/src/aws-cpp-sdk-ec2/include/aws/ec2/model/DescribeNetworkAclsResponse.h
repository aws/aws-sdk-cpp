...
class DescribeNetworkAclsResponse {
 public:
  ...
  void SetNetworkAcls(NetworkAclsT&& value) {
    m_networkAclsHasBeenSet = true;
    m_networkAcls = std::forward<NetworkAclsT>(value);
  }
  template <typename NetworkAclsT = Aws::Vector<NetworkAcl>>
  DescribeNetworkAclsResponse& WithNetworkAcls(NetworkAclsT&& value) {
    SetNetworkAcls(std::forward<NetworkAclsT>(value));
    return *this;
  }
  template <typename NetworkAclsT = NetworkAcl>
  DescribeNetworkAclsResponse& AddNetworkAcls(NetworkAclsT&& value) {
    m_networkAclsHasBeenSet = true;
    m_networkAcls.emplace_back(std::forward<NetworkAclsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkAclsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeNetworkAclsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
