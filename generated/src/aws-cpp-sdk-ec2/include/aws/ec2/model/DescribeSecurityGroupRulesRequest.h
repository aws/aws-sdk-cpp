...
class DescribeSecurityGroupRulesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeSecurityGroupRulesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeSecurityGroupRulesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename SecurityGroupRuleIdsT = Aws::Vector<Aws::String>>
  DescribeSecurityGroupRulesRequest& WithSecurityGroupRuleIds(SecurityGroupRuleIdsT&& value) {
    SetSecurityGroupRuleIds(std::forward<SecurityGroupRuleIdsT>(value));
    return *this;
  }
  template <typename SecurityGroupRuleIdsT = Aws::String>
  DescribeSecurityGroupRulesRequest& AddSecurityGroupRuleIds(SecurityGroupRuleIdsT&& value) {
    m_securityGroupRuleIdsHasBeenSet = true;
  ...
  inline DescribeSecurityGroupRulesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSecurityGroupRulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSecurityGroupRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
