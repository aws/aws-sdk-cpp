...
class VpcIpv6CidrBlockAssociation {
 public:
  ...
  void SetIpv6CidrBlockState(Ipv6CidrBlockStateT&& value) {
    ...
    m_ipv6CidrBlockState = std::forward<Ipv6CidrBlockStateT>(value);
  }
  template <typename Ipv6CidrBlockStateT = VpcCidrBlockState>
  VpcIpv6CidrBlockAssociation& WithIpv6CidrBlockState(Ipv6CidrBlockStateT&& value) {
    SetIpv6CidrBlockState(std::forward<Ipv6CidrBlockStateT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIpv6AddressAttribute(Ipv6AddressAttribute value) {
    m_ipv6AddressAttributeHasBeenSet = true;
    m_ipv6AddressAttribute = value;
  }
  inline VpcIpv6CidrBlockAssociation& WithIpv6AddressAttribute(Ipv6AddressAttribute value) {
    SetIpv6AddressAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIpSource(IpSource value) {
    m_ipSourceHasBeenSet = true;
    m_ipSource = value;
  }
  inline VpcIpv6CidrBlockAssociation& WithIpSource(IpSource value) {
    SetIpSource(value);
    return *this;
  }
  ///@}
