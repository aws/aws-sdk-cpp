...
class ModifyTransitGatewayOptions {
 public:
  ...
  void SetAddTransitGatewayCidrBlocks(AddTransitGatewayCidrBlocksT&& value) {
    ...
    m_addTransitGatewayCidrBlocks = std::forward<AddTransitGatewayCidrBlocksT>(value);
  }
  template <typename AddTransitGatewayCidrBlocksT = Aws::Vector<Aws::String>>
  ModifyTransitGatewayOptions& WithAddTransitGatewayCidrBlocks(AddTransitGatewayCidrBlocksT&& value) {
    SetAddTransitGatewayCidrBlocks(std::forward<AddTransitGatewayCidrBlocksT>(value));
    return *this;
  }
  ...
  ModifyTransitGatewayOptions& AddAddTransitGatewayCidrBlocks(AddTransitGatewayCidrBlocksT&& value) {
    m_addTransitGatewayCidrBlocksHasBeenSet = true;
    m_addTransitGatewayCidrBlocks.emplace_back(std::forward<AddTransitGatewayCidrBlocksT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveTransitGatewayCidrBlocks(RemoveTransitGatewayCidrBlocksT&& value) {
    ...
    m_removeTransitGatewayCidrBlocks = std::forward<RemoveTransitGatewayCidrBlocksT>(value);
  }
  template <typename RemoveTransitGatewayCidrBlocksT = Aws::Vector<Aws::String>>
  ModifyTransitGatewayOptions& WithRemoveTransitGatewayCidrBlocks(RemoveTransitGatewayCidrBlocksT&& value) {
    SetRemoveTransitGatewayCidrBlocks(std::forward<RemoveTransitGatewayCidrBlocksT>(value));
    return *this;
  }
  ...
  ModifyTransitGatewayOptions& AddRemoveTransitGatewayCidrBlocks(RemoveTransitGatewayCidrBlocksT&& value) {
    m_removeTransitGatewayCidrBlocksHasBeenSet = true;
    m_removeTransitGatewayCidrBlocks.emplace_back(std::forward<RemoveTransitGatewayCidrBlocksT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyTransitGatewayOptions& WithVpnEcmpSupport(VpnEcmpSupportValue value) {
  ...
  inline ModifyTransitGatewayOptions& WithDnsSupport(DnsSupportValue value) {
    SetDnsSupport(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyTransitGatewayOptions& WithSecurityGroupReferencingSupport(SecurityGroupReferencingSupportValue value) {
  ...
  inline ModifyTransitGatewayOptions& WithAutoAcceptSharedAttachments(AutoAcceptSharedAttachmentsValue value) {
  ...
  inline ModifyTransitGatewayOptions& WithDefaultRouteTableAssociation(DefaultRouteTableAssociationValue value) {
  ...
  inline ModifyTransitGatewayOptions& WithDefaultRouteTablePropagation(DefaultRouteTablePropagationValue value) {
  ...
  inline ModifyTransitGatewayOptions& WithAmazonSideAsn(long long value) {
