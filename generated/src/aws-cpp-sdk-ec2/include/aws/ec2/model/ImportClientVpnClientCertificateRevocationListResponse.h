...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ImportClientVpnClientCertificateRevocationListResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ImportClientVpnClientCertificateRevocationListResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
