...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API InstanceCreditSpecification() = default;
    AWS_EC2_API InstanceCreditSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_EC2_API InstanceCreditSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    template<typename InstanceIdT = Aws::String>
    InstanceCreditSpecification& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CpuCreditsT = Aws::String>
    InstanceCreditSpecification& WithCpuCredits(CpuCreditsT&& value) { SetCpuCredits(std::forward<CpuCreditsT>(value)); return *this;}
    ///@}
  private:
