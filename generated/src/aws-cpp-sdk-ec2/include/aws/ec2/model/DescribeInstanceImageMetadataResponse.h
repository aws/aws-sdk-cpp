...
class DescribeInstanceImageMetadataResponse {
 public:
  ...
  void SetInstanceImageMetadata(InstanceImageMetadataT&& value) {
    m_instanceImageMetadataHasBeenSet = true;
    m_instanceImageMetadata = std::forward<InstanceImageMetadataT>(value);
  }
  template <typename InstanceImageMetadataT = Aws::Vector<InstanceImageMetadata>>
  DescribeInstanceImageMetadataResponse& WithInstanceImageMetadata(InstanceImageMetadataT&& value) {
    SetInstanceImageMetadata(std::forward<InstanceImageMetadataT>(value));
    return *this;
  }
  template <typename InstanceImageMetadataT = InstanceImageMetadata>
  DescribeInstanceImageMetadataResponse& AddInstanceImageMetadata(InstanceImageMetadataT&& value) {
    m_instanceImageMetadataHasBeenSet = true;
    m_instanceImageMetadata.emplace_back(std::forward<InstanceImageMetadataT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceImageMetadataResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeInstanceImageMetadataResponse& WithResponseMetadata(ResponseMetadataT&& value) {
