...
class ExportToS3Task {
 public:
  ...
  inline void SetContainerFormat(ContainerFormat value) {
    m_containerFormatHasBeenSet = true;
    m_containerFormat = value;
  }
  inline ExportToS3Task& WithContainerFormat(ContainerFormat value) {
    SetContainerFormat(value);
    return *this;
  }
  ///@}
  ...
  inline ExportToS3Task& WithDiskImageFormat(DiskImageFormat value) {
