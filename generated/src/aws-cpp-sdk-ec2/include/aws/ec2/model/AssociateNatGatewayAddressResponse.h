...
class AssociateNatGatewayAddressResponse {
 public:
  ...
  template <typename NatGatewayIdT = Aws::String>
  AssociateNatGatewayAddressResponse& WithNatGatewayId(NatGatewayIdT&& value) {
  ...
  template <typename NatGatewayAddressesT = Aws::Vector<NatGatewayAddress>>
  AssociateNatGatewayAddressResponse& WithNatGatewayAddresses(NatGatewayAddressesT&& value) {
    SetNatGatewayAddresses(std::forward<NatGatewayAddressesT>(value));
    return *this;
  }
  template <typename NatGatewayAddressesT = NatGatewayAddress>
  AssociateNatGatewayAddressResponse& AddNatGatewayAddresses(NatGatewayAddressesT&& value) {
    m_natGatewayAddressesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateNatGatewayAddressResponse& WithResponseMetadata(ResponseMetadataT&& value) {
