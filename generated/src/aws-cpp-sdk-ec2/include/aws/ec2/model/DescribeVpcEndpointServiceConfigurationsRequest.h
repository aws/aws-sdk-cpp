...
class DescribeVpcEndpointServiceConfigurationsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVpcEndpointServiceConfigurationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceIdsT = Aws::Vector<Aws::String>>
  DescribeVpcEndpointServiceConfigurationsRequest& WithServiceIds(ServiceIdsT&& value) {
    SetServiceIds(std::forward<ServiceIdsT>(value));
    return *this;
  }
  template <typename ServiceIdsT = Aws::String>
  DescribeVpcEndpointServiceConfigurationsRequest& AddServiceIds(ServiceIdsT&& value) {
    m_serviceIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeVpcEndpointServiceConfigurationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeVpcEndpointServiceConfigurationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeVpcEndpointServiceConfigurationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcEndpointServiceConfigurationsRequest& WithNextToken(NextTokenT&& value) {
