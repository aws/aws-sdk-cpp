...
class DescribeHostReservationOfferingsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeHostReservationOfferingsRequest& WithMaxDuration(int value) {
  ...
  inline DescribeHostReservationOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline void SetMinDuration(int value) {
    m_minDurationHasBeenSet = true;
    m_minDuration = value;
  }
  inline DescribeHostReservationOfferingsRequest& WithMinDuration(int value) {
