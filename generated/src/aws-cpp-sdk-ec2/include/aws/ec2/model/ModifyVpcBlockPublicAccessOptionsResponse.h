...
class ModifyVpcBlockPublicAccessOptionsResponse {
 public:
  ...
  void SetVpcBlockPublicAccessOptions(VpcBlockPublicAccessOptionsT&& value) {
    m_vpcBlockPublicAccessOptionsHasBeenSet = true;
    m_vpcBlockPublicAccessOptions = std::forward<VpcBlockPublicAccessOptionsT>(value);
  }
  template <typename VpcBlockPublicAccessOptionsT = VpcBlockPublicAccessOptions>
  ModifyVpcBlockPublicAccessOptionsResponse& WithVpcBlockPublicAccessOptions(VpcBlockPublicAccessOptionsT&& value) {
    SetVpcBlockPublicAccessOptions(std::forward<VpcBlockPublicAccessOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVpcBlockPublicAccessOptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
