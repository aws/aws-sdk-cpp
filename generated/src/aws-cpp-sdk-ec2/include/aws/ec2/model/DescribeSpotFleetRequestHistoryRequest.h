...
class DescribeSpotFleetRequestHistoryRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeSpotFleetRequestHistoryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename SpotFleetRequestIdT = Aws::String>
  DescribeSpotFleetRequestHistoryRequest& WithSpotFleetRequestId(SpotFleetRequestIdT&& value) {
  ...
  inline DescribeSpotFleetRequestHistoryRequest& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  DescribeSpotFleetRequestHistoryRequest& WithStartTime(StartTimeT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSpotFleetRequestHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeSpotFleetRequestHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
