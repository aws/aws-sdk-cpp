...
class RevokeClientVpnIngressRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetRevokeAllGroups(bool value) {
    m_revokeAllGroupsHasBeenSet = true;
    m_revokeAllGroups = value;
  }
  inline RevokeClientVpnIngressRequest& WithRevokeAllGroups(bool value) {
    SetRevokeAllGroups(value);
    return *this;
  }
  ///@}
  ...
  inline RevokeClientVpnIngressRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
