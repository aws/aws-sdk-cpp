...
namespace EC2 {
namespace Model {
class AcceptTransitGatewayClientVpnAttachmentResponse {
 public:
  AWS_EC2_API AcceptTransitGatewayClientVpnAttachmentResponse() = default;
  AWS_EC2_API AcceptTransitGatewayClientVpnAttachmentResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API AcceptTransitGatewayClientVpnAttachmentResponse& operator=(
  ...
  template <typename TransitGatewayClientVpnAttachmentT = TransitGatewayClientVpnAttachment>
  AcceptTransitGatewayClientVpnAttachmentResponse& WithTransitGatewayClientVpnAttachment(TransitGatewayClientVpnAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptTransitGatewayClientVpnAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
