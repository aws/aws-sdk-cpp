...
class DescribeTransitGatewayRouteTablesRequest : public EC2Request {
 ...
 public:
  ...
  void SetTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) {
    m_transitGatewayRouteTableIdsHasBeenSet = true;
    m_transitGatewayRouteTableIds = std::forward<TransitGatewayRouteTableIdsT>(value);
  }
  template <typename TransitGatewayRouteTableIdsT = Aws::Vector<Aws::String>>
  DescribeTransitGatewayRouteTablesRequest& WithTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) {
    SetTransitGatewayRouteTableIds(std::forward<TransitGatewayRouteTableIdsT>(value));
    return *this;
  }
  ...
  DescribeTransitGatewayRouteTablesRequest& AddTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) {
    m_transitGatewayRouteTableIdsHasBeenSet = true;
    m_transitGatewayRouteTableIds.emplace_back(std::forward<TransitGatewayRouteTableIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewayRouteTablesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewayRouteTablesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
