...
namespace Model
{
  ...
  /**
   */
  class DescribeTransitGatewayRouteTablesRequest : public EC2Request
  {
  public:
  ...
  public:
    ...
    template<typename TransitGatewayRouteTableIdsT = Aws::Vector<Aws::String>>
    void SetTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) { m_transitGatewayRouteTableIdsHasBeenSet = true; m_transitGatewayRouteTableIds = std::forward<TransitGatewayRouteTableIdsT>(value); }
    template<typename TransitGatewayRouteTableIdsT = Aws::Vector<Aws::String>>
    DescribeTransitGatewayRouteTablesRequest& WithTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) { SetTransitGatewayRouteTableIds(std::forward<TransitGatewayRouteTableIdsT>(value)); return *this;}
    template<typename TransitGatewayRouteTableIdsT = Aws::String>
    DescribeTransitGatewayRouteTablesRequest& AddTransitGatewayRouteTableIds(TransitGatewayRouteTableIdsT&& value) { m_transitGatewayRouteTableIdsHasBeenSet = true; m_transitGatewayRouteTableIds.emplace_back(std::forward<TransitGatewayRouteTableIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeTransitGatewayRouteTablesRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeTransitGatewayRouteTablesRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeTransitGatewayRouteTablesRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
