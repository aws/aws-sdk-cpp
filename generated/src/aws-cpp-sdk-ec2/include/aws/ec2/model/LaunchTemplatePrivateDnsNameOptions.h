...
class LaunchTemplatePrivateDnsNameOptions {
 public:
  ...
  inline LaunchTemplatePrivateDnsNameOptions& WithHostnameType(HostnameType value) {
  ...
  inline LaunchTemplatePrivateDnsNameOptions& WithEnableResourceNameDnsARecord(bool value) {
  ...
  inline LaunchTemplatePrivateDnsNameOptions& WithEnableResourceNameDnsAAAARecord(bool value) {
