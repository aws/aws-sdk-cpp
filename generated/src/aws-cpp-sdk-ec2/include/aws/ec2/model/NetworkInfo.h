...
class NetworkInfo {
 public:
  ...
  inline NetworkInfo& WithMaximumNetworkInterfaces(int value) {
  ...
  inline void SetMaximumNetworkCards(int value) {
    m_maximumNetworkCardsHasBeenSet = true;
    m_maximumNetworkCards = value;
  }
  inline NetworkInfo& WithMaximumNetworkCards(int value) {
    SetMaximumNetworkCards(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultNetworkCardIndex(int value) {
    m_defaultNetworkCardIndexHasBeenSet = true;
    m_defaultNetworkCardIndex = value;
  }
  inline NetworkInfo& WithDefaultNetworkCardIndex(int value) {
    SetDefaultNetworkCardIndex(value);
    return *this;
  }
  ///@}
  ...
  void SetNetworkCards(NetworkCardsT&& value) {
    ...
    m_networkCards = std::forward<NetworkCardsT>(value);
  }
  template <typename NetworkCardsT = Aws::Vector<NetworkCardInfo>>
  NetworkInfo& WithNetworkCards(NetworkCardsT&& value) {
    SetNetworkCards(std::forward<NetworkCardsT>(value));
    return *this;
  }
  template <typename NetworkCardsT = NetworkCardInfo>
  NetworkInfo& AddNetworkCards(NetworkCardsT&& value) {
    m_networkCardsHasBeenSet = true;
    m_networkCards.emplace_back(std::forward<NetworkCardsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIpv4AddressesPerInterface(int value) {
    m_ipv4AddressesPerInterfaceHasBeenSet = true;
    m_ipv4AddressesPerInterface = value;
  }
  inline NetworkInfo& WithIpv4AddressesPerInterface(int value) {
    SetIpv4AddressesPerInterface(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIpv6AddressesPerInterface(int value) {
    m_ipv6AddressesPerInterfaceHasBeenSet = true;
    m_ipv6AddressesPerInterface = value;
  }
  inline NetworkInfo& WithIpv6AddressesPerInterface(int value) {
    SetIpv6AddressesPerInterface(value);
    return *this;
  }
  ///@}
  ...
  inline void SetIpv6Supported(bool value) {
    m_ipv6SupportedHasBeenSet = true;
    m_ipv6Supported = value;
  }
  inline NetworkInfo& WithIpv6Supported(bool value) {
    SetIpv6Supported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnaSupport(EnaSupport value) {
    m_enaSupportHasBeenSet = true;
    m_enaSupport = value;
  }
  inline NetworkInfo& WithEnaSupport(EnaSupport value) {
    SetEnaSupport(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEfaSupported(bool value) {
    m_efaSupportedHasBeenSet = true;
    m_efaSupported = value;
  }
  inline NetworkInfo& WithEfaSupported(bool value) {
    SetEfaSupported(value);
    return *this;
  }
  ///@}
  ...
  void SetEfaInfo(EfaInfoT&& value) {
    ...
    m_efaInfo = std::forward<EfaInfoT>(value);
  }
  template <typename EfaInfoT = EfaInfo>
  NetworkInfo& WithEfaInfo(EfaInfoT&& value) {
    SetEfaInfo(std::forward<EfaInfoT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetEncryptionInTransitSupported(bool value) {
    m_encryptionInTransitSupportedHasBeenSet = true;
    m_encryptionInTransitSupported = value;
  }
  inline NetworkInfo& WithEncryptionInTransitSupported(bool value) {
    SetEncryptionInTransitSupported(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnaSrdSupported(bool value) {
    m_enaSrdSupportedHasBeenSet = true;
    m_enaSrdSupported = value;
  }
  inline NetworkInfo& WithEnaSrdSupported(bool value) {
    SetEnaSrdSupported(value);
    return *this;
  }
  ///@}
  ...
  void SetBandwidthWeightings(BandwidthWeightingsT&& value) {
    ...
    m_bandwidthWeightings = std::forward<BandwidthWeightingsT>(value);
  }
  template <typename BandwidthWeightingsT = Aws::Vector<BandwidthWeightingType>>
  NetworkInfo& WithBandwidthWeightings(BandwidthWeightingsT&& value) {
    SetBandwidthWeightings(std::forward<BandwidthWeightingsT>(value));
    return *this;
  }
  inline NetworkInfo& AddBandwidthWeightings(BandwidthWeightingType value) {
    m_bandwidthWeightingsHasBeenSet = true;
    m_bandwidthWeightings.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetFlexibleEnaQueuesSupport(FlexibleEnaQueuesSupport value) {
    m_flexibleEnaQueuesSupportHasBeenSet = true;
    m_flexibleEnaQueuesSupport = value;
  }
  inline NetworkInfo& WithFlexibleEnaQueuesSupport(FlexibleEnaQueuesSupport value) {
    SetFlexibleEnaQueuesSupport(value);
    return *this;
  }
  ///@}
 private:
