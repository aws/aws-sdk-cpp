...
class DescribeSubnetsResponse {
 public:
  AWS_EC2_API DescribeSubnetsResponse() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSubnetsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SubnetsT = Aws::Vector<Subnet>>
  DescribeSubnetsResponse& WithSubnets(SubnetsT&& value) {
    SetSubnets(std::forward<SubnetsT>(value));
    return *this;
  }
  template <typename SubnetsT = Subnet>
  DescribeSubnetsResponse& AddSubnets(SubnetsT&& value) {
    m_subnetsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSubnetsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
