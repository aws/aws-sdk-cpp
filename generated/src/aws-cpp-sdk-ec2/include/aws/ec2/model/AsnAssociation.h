...
class AsnAssociation {
 public:
  ...
  template <typename AsnT = Aws::String>
  AsnAssociation& WithAsn(AsnT&& value) {
  ...
  template <typename CidrT = Aws::String>
  AsnAssociation& WithCidr(CidrT&& value) {
  ...
  template <typename StatusMessageT = Aws::String>
  AsnAssociation& WithStatusMessage(StatusMessageT&& value) {
  ...
  inline void SetState(AsnAssociationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AsnAssociation& WithState(AsnAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
