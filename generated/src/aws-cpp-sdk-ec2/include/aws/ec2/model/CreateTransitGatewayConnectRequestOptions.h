...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateTransitGatewayConnectRequestOptions() = default;
    ...
    inline CreateTransitGatewayConnectRequestOptions& WithProtocol(ProtocolValue value) { SetProtocol(value); return *this;}
    ///@}
  private:
