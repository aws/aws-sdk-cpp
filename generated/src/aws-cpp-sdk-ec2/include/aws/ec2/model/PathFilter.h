...
class PathFilter {
 public:
  ...
  template <typename SourceAddressT = Aws::String>
  PathFilter& WithSourceAddress(SourceAddressT&& value) {
  ...
  template <typename SourcePortRangeT = FilterPortRange>
  PathFilter& WithSourcePortRange(SourcePortRangeT&& value) {
  ...
  template <typename DestinationAddressT = Aws::String>
  PathFilter& WithDestinationAddress(DestinationAddressT&& value) {
  ...
  template <typename DestinationPortRangeT = FilterPortRange>
  PathFilter& WithDestinationPortRange(DestinationPortRangeT&& value) {
