...
class DetachClassicLinkVpcRequest : public EC2Request {
 ...
 public:
  ...
  inline DetachClassicLinkVpcRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  DetachClassicLinkVpcRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  DetachClassicLinkVpcRequest& WithVpcId(VpcIdT&& value) {
