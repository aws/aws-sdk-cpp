...
class CreateCapacityManagerDataExportResponse {
 public:
  ...
  template <typename CapacityManagerDataExportIdT = Aws::String>
  CreateCapacityManagerDataExportResponse& WithCapacityManagerDataExportId(CapacityManagerDataExportIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateCapacityManagerDataExportResponse& WithResponseMetadata(ResponseMetadataT&& value) {
