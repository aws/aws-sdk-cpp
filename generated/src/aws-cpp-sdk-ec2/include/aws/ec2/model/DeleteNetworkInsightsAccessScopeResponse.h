...
class DeleteNetworkInsightsAccessScopeResponse {
 public:
  ...
  template <typename NetworkInsightsAccessScopeIdT = Aws::String>
  DeleteNetworkInsightsAccessScopeResponse& WithNetworkInsightsAccessScopeId(NetworkInsightsAccessScopeIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteNetworkInsightsAccessScopeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
