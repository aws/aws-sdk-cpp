...
class CreateIpamScopeResponse {
 public:
  ...
  void SetIpamScope(IpamScopeT&& value) {
    m_ipamScopeHasBeenSet = true;
    m_ipamScope = std::forward<IpamScopeT>(value);
  }
  template <typename IpamScopeT = IpamScope>
  CreateIpamScopeResponse& WithIpamScope(IpamScopeT&& value) {
    SetIpamScope(std::forward<IpamScopeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamScopeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
