...
class ModifyVerifiedAccessInstanceLoggingConfigurationRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  ModifyVerifiedAccessInstanceLoggingConfigurationRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename AccessLogsT = VerifiedAccessLogOptions>
  ModifyVerifiedAccessInstanceLoggingConfigurationRequest& WithAccessLogs(AccessLogsT&& value) {
  ...
  inline ModifyVerifiedAccessInstanceLoggingConfigurationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  ModifyVerifiedAccessInstanceLoggingConfigurationRequest& WithClientToken(ClientTokenT&& value) {
