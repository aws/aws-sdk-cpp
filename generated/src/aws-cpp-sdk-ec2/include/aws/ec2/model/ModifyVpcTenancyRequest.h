...
class ModifyVpcTenancyRequest : public EC2Request {
 ...
 public:
   ...
   */
  inline VpcTenancy GetInstanceTenancy() const { return m_instanceTenancy; }
  inline bool InstanceTenancyHasBeenSet() const { return m_instanceTenancyHasBeenSet; }
  inline void SetInstanceTenancy(VpcTenancy value) {
    m_instanceTenancyHasBeenSet = true;
    m_instanceTenancy = value;
  }
  inline ModifyVpcTenancyRequest& WithInstanceTenancy(VpcTenancy value) {
  ...
  inline ModifyVpcTenancyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
