...
class ScheduledInstanceRecurrence {
 public:
  ...
  template <typename FrequencyT = Aws::String>
  ScheduledInstanceRecurrence& WithFrequency(FrequencyT&& value) {
  ...
  inline ScheduledInstanceRecurrence& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  void SetOccurrenceDaySet(OccurrenceDaySetT&& value) {
    m_occurrenceDaySetHasBeenSet = true;
    m_occurrenceDaySet = std::forward<OccurrenceDaySetT>(value);
  }
  template <typename OccurrenceDaySetT = Aws::Vector<int>>
  ScheduledInstanceRecurrence& WithOccurrenceDaySet(OccurrenceDaySetT&& value) {
    SetOccurrenceDaySet(std::forward<OccurrenceDaySetT>(value));
    return *this;
  }
  inline ScheduledInstanceRecurrence& AddOccurrenceDaySet(int value) {
    m_occurrenceDaySetHasBeenSet = true;
    m_occurrenceDaySet.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline ScheduledInstanceRecurrence& WithOccurrenceRelativeToEnd(bool value) {
  ...
  template <typename OccurrenceUnitT = Aws::String>
  ScheduledInstanceRecurrence& WithOccurrenceUnit(OccurrenceUnitT&& value) {
