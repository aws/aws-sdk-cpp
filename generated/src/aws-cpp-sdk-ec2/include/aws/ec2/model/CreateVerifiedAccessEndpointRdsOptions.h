...
class CreateVerifiedAccessEndpointRdsOptions {
 public:
  ...
  inline CreateVerifiedAccessEndpointRdsOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVerifiedAccessEndpointRdsOptions& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
