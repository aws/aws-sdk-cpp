...
/**
 * <p>Describes an unsuccessful application status check suppression.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/UnsuccessfulSuppressionResponseObject">AWS
 * API Reference</a></p>
 */
class UnsuccessfulSuppressionResponseObject {
 public:
  AWS_EC2_API UnsuccessfulSuppressionResponseObject() = default;
  AWS_EC2_API UnsuccessfulSuppressionResponseObject(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API UnsuccessfulSuppressionResponseObject& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename InstanceIdT = Aws::String>
  UnsuccessfulSuppressionResponseObject& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename SuppressAtT = Aws::Utils::DateTime>
  UnsuccessfulSuppressionResponseObject& WithSuppressAt(SuppressAtT&& value) {
  ...
  template <typename ResumeAtT = Aws::Utils::DateTime>
  UnsuccessfulSuppressionResponseObject& WithResumeAt(ResumeAtT&& value) {
  ...
  template <typename ReasonT = Aws::String>
  UnsuccessfulSuppressionResponseObject& WithReason(ReasonT&& value) {
