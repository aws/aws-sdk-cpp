...
class DescribeNetworkInsightsAnalysesRequest : public EC2Request {
 ...
 public:
  ...
  void SetNetworkInsightsAnalysisIds(NetworkInsightsAnalysisIdsT&& value) {
    m_networkInsightsAnalysisIdsHasBeenSet = true;
    m_networkInsightsAnalysisIds = std::forward<NetworkInsightsAnalysisIdsT>(value);
  }
  template <typename NetworkInsightsAnalysisIdsT = Aws::Vector<Aws::String>>
  DescribeNetworkInsightsAnalysesRequest& WithNetworkInsightsAnalysisIds(NetworkInsightsAnalysisIdsT&& value) {
    SetNetworkInsightsAnalysisIds(std::forward<NetworkInsightsAnalysisIdsT>(value));
    return *this;
  }
  ...
  DescribeNetworkInsightsAnalysesRequest& AddNetworkInsightsAnalysisIds(NetworkInsightsAnalysisIdsT&& value) {
    m_networkInsightsAnalysisIdsHasBeenSet = true;
    m_networkInsightsAnalysisIds.emplace_back(std::forward<NetworkInsightsAnalysisIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnalysisStartTime(AnalysisStartTimeT&& value) {
    m_analysisStartTimeHasBeenSet = true;
    m_analysisStartTime = std::forward<AnalysisStartTimeT>(value);
  }
  template <typename AnalysisStartTimeT = Aws::Utils::DateTime>
  DescribeNetworkInsightsAnalysesRequest& WithAnalysisStartTime(AnalysisStartTimeT&& value) {
    SetAnalysisStartTime(std::forward<AnalysisStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAnalysisEndTime(AnalysisEndTimeT&& value) {
    m_analysisEndTimeHasBeenSet = true;
    m_analysisEndTime = std::forward<AnalysisEndTimeT>(value);
  }
  template <typename AnalysisEndTimeT = Aws::Utils::DateTime>
  DescribeNetworkInsightsAnalysesRequest& WithAnalysisEndTime(AnalysisEndTimeT&& value) {
    SetAnalysisEndTime(std::forward<AnalysisEndTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeNetworkInsightsAnalysesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNetworkInsightsAnalysesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
