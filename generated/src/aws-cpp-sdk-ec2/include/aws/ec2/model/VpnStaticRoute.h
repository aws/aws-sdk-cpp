...
class VpnStaticRoute {
 public:
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  VpnStaticRoute& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  inline void SetSource(VpnStaticRouteSource value) {
    m_sourceHasBeenSet = true;
    m_source = value;
  }
  inline VpnStaticRoute& WithSource(VpnStaticRouteSource value) {
    SetSource(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(VpnState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline VpnStaticRoute& WithState(VpnState value) {
    SetState(value);
    return *this;
  }
  ///@}
