...
namespace EC2 {
namespace Model {
class DisassociateApplicationStatusCheckResponse {
 public:
  AWS_EC2_API DisassociateApplicationStatusCheckResponse() = default;
  AWS_EC2_API DisassociateApplicationStatusCheckResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DisassociateApplicationStatusCheckResponse& operator=(
  ...
  template <typename SuccessfulResultsT = Aws::Vector<SuccessfulAssociationResponseObject>>
  DisassociateApplicationStatusCheckResponse& WithSuccessfulResults(SuccessfulResultsT&& value) {
  ...
  DisassociateApplicationStatusCheckResponse& AddSuccessfulResults(SuccessfulResultsT&& value) {
    m_successfulResultsHasBeenSet = true;
  ...
  template <typename UnsuccessfulResultsT = Aws::Vector<UnsuccessfulAssociationResponseObject>>
  DisassociateApplicationStatusCheckResponse& WithUnsuccessfulResults(UnsuccessfulResultsT&& value) {
  ...
  DisassociateApplicationStatusCheckResponse& AddUnsuccessfulResults(UnsuccessfulResultsT&& value) {
    m_unsuccessfulResultsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateApplicationStatusCheckResponse& WithResponseMetadata(ResponseMetadataT&& value) {
