...
#include <aws/ec2/model/SecondaryInterfacePrivateIpAddressSpecification.h>
...
/**
 * <p>Describes a secondary interface specification in a launch
 * template.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateInstanceSecondaryInterfaceSpecification">AWS
 * API Reference</a></p>
 */
class LaunchTemplateInstanceSecondaryInterfaceSpecification {
 public:
  AWS_EC2_API LaunchTemplateInstanceSecondaryInterfaceSpecification() = default;
  AWS_EC2_API LaunchTemplateInstanceSecondaryInterfaceSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API LaunchTemplateInstanceSecondaryInterfaceSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline LaunchTemplateInstanceSecondaryInterfaceSpecification& WithDeleteOnTermination(bool value) {
  ...
  inline LaunchTemplateInstanceSecondaryInterfaceSpecification& WithDeviceIndex(int value) {
  ...
  ///@{
  /**
   * <p>The private IPv4 addresses to assign to the secondary interface.</p> <p>If
   * you specify <code>privateIpAddresses</code> you cannot specify
   * <code>privateIpAddressCount</code> </p>
   */
  inline const Aws::Vector<SecondaryInterfacePrivateIpAddressSpecification>& GetPrivateIpAddresses() const { return m_privateIpAddresses; }
  inline bool PrivateIpAddressesHasBeenSet() const { return m_privateIpAddressesHasBeenSet; }
  template <typename PrivateIpAddressesT = Aws::Vector<SecondaryInterfacePrivateIpAddressSpecification>>
  void SetPrivateIpAddresses(PrivateIpAddressesT&& value) {
    m_privateIpAddressesHasBeenSet = true;
    m_privateIpAddresses = std::forward<PrivateIpAddressesT>(value);
  }
  template <typename PrivateIpAddressesT = Aws::Vector<SecondaryInterfacePrivateIpAddressSpecification>>
  LaunchTemplateInstanceSecondaryInterfaceSpecification& WithPrivateIpAddresses(PrivateIpAddressesT&& value) {
    SetPrivateIpAddresses(std::forward<PrivateIpAddressesT>(value));
    return *this;
  }
  template <typename PrivateIpAddressesT = SecondaryInterfacePrivateIpAddressSpecification>
  LaunchTemplateInstanceSecondaryInterfaceSpecification& AddPrivateIpAddresses(PrivateIpAddressesT&& value) {
    m_privateIpAddressesHasBeenSet = true;
   ...
   * interface.</p> <p>If you specify <code>privateIpAddressCount</code> you cannot
   * specify <code>privateIpAddresses</code> </p>
   */
  ...
  inline LaunchTemplateInstanceSecondaryInterfaceSpecification& WithPrivateIpAddressCount(int value) {
  ...
  template <typename SecondarySubnetIdT = Aws::String>
  LaunchTemplateInstanceSecondaryInterfaceSpecification& WithSecondarySubnetId(SecondarySubnetIdT&& value) {
  ...
  inline LaunchTemplateInstanceSecondaryInterfaceSpecification& WithInterfaceType(SecondaryInterfaceType value) {
  ...
  inline LaunchTemplateInstanceSecondaryInterfaceSpecification& WithNetworkCardIndex(int value) {
 ...
 private:
  ...
  Aws::Vector<SecondaryInterfacePrivateIpAddressSpecification> m_privateIpAddresses;
