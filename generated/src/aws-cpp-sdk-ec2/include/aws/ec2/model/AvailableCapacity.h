...
class AvailableCapacity {
 public:
  ...
  void SetAvailableInstanceCapacity(AvailableInstanceCapacityT&& value) {
    m_availableInstanceCapacityHasBeenSet = true;
    m_availableInstanceCapacity = std::forward<AvailableInstanceCapacityT>(value);
  }
  template <typename AvailableInstanceCapacityT = Aws::Vector<InstanceCapacity>>
  AvailableCapacity& WithAvailableInstanceCapacity(AvailableInstanceCapacityT&& value) {
    SetAvailableInstanceCapacity(std::forward<AvailableInstanceCapacityT>(value));
    return *this;
  }
  template <typename AvailableInstanceCapacityT = InstanceCapacity>
  AvailableCapacity& AddAvailableInstanceCapacity(AvailableInstanceCapacityT&& value) {
    m_availableInstanceCapacityHasBeenSet = true;
    m_availableInstanceCapacity.emplace_back(std::forward<AvailableInstanceCapacityT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAvailableVCpus(int value) {
    m_availableVCpusHasBeenSet = true;
    m_availableVCpus = value;
  }
  inline AvailableCapacity& WithAvailableVCpus(int value) {
    SetAvailableVCpus(value);
    return *this;
  }
  ///@}
 private:
