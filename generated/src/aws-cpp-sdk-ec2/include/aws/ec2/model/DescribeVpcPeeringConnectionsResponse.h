...
class DescribeVpcPeeringConnectionsResponse {
 public:
  ...
  void SetVpcPeeringConnections(VpcPeeringConnectionsT&& value) {
    m_vpcPeeringConnectionsHasBeenSet = true;
    m_vpcPeeringConnections = std::forward<VpcPeeringConnectionsT>(value);
  }
  template <typename VpcPeeringConnectionsT = Aws::Vector<VpcPeeringConnection>>
  DescribeVpcPeeringConnectionsResponse& WithVpcPeeringConnections(VpcPeeringConnectionsT&& value) {
    SetVpcPeeringConnections(std::forward<VpcPeeringConnectionsT>(value));
    return *this;
  }
  template <typename VpcPeeringConnectionsT = VpcPeeringConnection>
  DescribeVpcPeeringConnectionsResponse& AddVpcPeeringConnections(VpcPeeringConnectionsT&& value) {
    m_vpcPeeringConnectionsHasBeenSet = true;
    m_vpcPeeringConnections.emplace_back(std::forward<VpcPeeringConnectionsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcPeeringConnectionsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpcPeeringConnectionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
