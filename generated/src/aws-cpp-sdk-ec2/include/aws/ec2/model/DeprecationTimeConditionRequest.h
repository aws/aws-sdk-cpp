...
class DeprecationTimeConditionRequest {
 public:
  ...
  inline void SetMaximumDaysSinceDeprecated(int value) {
    m_maximumDaysSinceDeprecatedHasBeenSet = true;
    m_maximumDaysSinceDeprecated = value;
  }
  inline DeprecationTimeConditionRequest& WithMaximumDaysSinceDeprecated(int value) {
    SetMaximumDaysSinceDeprecated(value);
    return *this;
  }
  ///@}
 private:
