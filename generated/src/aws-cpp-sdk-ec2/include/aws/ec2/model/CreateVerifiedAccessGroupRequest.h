...
class CreateVerifiedAccessGroupRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  CreateVerifiedAccessGroupRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  CreateVerifiedAccessGroupRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  CreateVerifiedAccessGroupRequest& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateVerifiedAccessGroupRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateVerifiedAccessGroupRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateVerifiedAccessGroupRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline CreateVerifiedAccessGroupRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename SseSpecificationT = VerifiedAccessSseSpecificationRequest>
  CreateVerifiedAccessGroupRequest& WithSseSpecification(SseSpecificationT&& value) {
