...
class GetVpnConnectionDeviceSampleConfigurationRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VpnConnectionIdT = Aws::String>
  GetVpnConnectionDeviceSampleConfigurationRequest& WithVpnConnectionId(VpnConnectionIdT&& value) {
  ...
  template <typename VpnConnectionDeviceTypeIdT = Aws::String>
  GetVpnConnectionDeviceSampleConfigurationRequest& WithVpnConnectionDeviceTypeId(VpnConnectionDeviceTypeIdT&& value) {
  ...
  void SetInternetKeyExchangeVersion(InternetKeyExchangeVersionT&& value) {
    m_internetKeyExchangeVersionHasBeenSet = true;
    m_internetKeyExchangeVersion = std::forward<InternetKeyExchangeVersionT>(value);
  }
  template <typename InternetKeyExchangeVersionT = Aws::String>
  GetVpnConnectionDeviceSampleConfigurationRequest& WithInternetKeyExchangeVersion(InternetKeyExchangeVersionT&& value) {
    SetInternetKeyExchangeVersion(std::forward<InternetKeyExchangeVersionT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSampleType(SampleTypeT&& value) {
    m_sampleTypeHasBeenSet = true;
    m_sampleType = std::forward<SampleTypeT>(value);
  }
  template <typename SampleTypeT = Aws::String>
  GetVpnConnectionDeviceSampleConfigurationRequest& WithSampleType(SampleTypeT&& value) {
    SetSampleType(std::forward<SampleTypeT>(value));
    return *this;
  }
  ///@}
  ...
  inline GetVpnConnectionDeviceSampleConfigurationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
