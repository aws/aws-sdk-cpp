...
class HistoryRecord {
 public:
  ...
  void SetEventInformation(EventInformationT&& value) {
    ...
    m_eventInformation = std::forward<EventInformationT>(value);
  }
  template <typename EventInformationT = EventInformation>
  HistoryRecord& WithEventInformation(EventInformationT&& value) {
    SetEventInformation(std::forward<EventInformationT>(value));
    return *this;
  }
  ///@}
  ...
  inline HistoryRecord& WithEventType(EventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
