...
class AttributeValue {
 public:
  AWS_EC2_API AttributeValue() = default;
  AWS_EC2_API AttributeValue(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API AttributeValue& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
