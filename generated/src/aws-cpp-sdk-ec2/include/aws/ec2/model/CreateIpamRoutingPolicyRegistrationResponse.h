...
namespace EC2 {
namespace Model {
class CreateIpamRoutingPolicyRegistrationResponse {
 public:
  AWS_EC2_API CreateIpamRoutingPolicyRegistrationResponse() = default;
  AWS_EC2_API CreateIpamRoutingPolicyRegistrationResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateIpamRoutingPolicyRegistrationResponse& operator=(
  ...
  template <typename IpamRoutingPolicyRegistrationDeltaT = IpamRoutingPolicyRegistrationDelta>
  CreateIpamRoutingPolicyRegistrationResponse& WithIpamRoutingPolicyRegistrationDelta(IpamRoutingPolicyRegistrationDeltaT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamRoutingPolicyRegistrationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
