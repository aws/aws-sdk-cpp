...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeleteManagedPrefixListResponse() = default;
    ...
    template<typename PrefixListT = ManagedPrefixList>
    DeleteManagedPrefixListResponse& WithPrefixList(PrefixListT&& value) { SetPrefixList(std::forward<PrefixListT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeleteManagedPrefixListResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
