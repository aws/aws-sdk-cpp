...
class GetTransitGatewayPrefixListReferencesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  GetTransitGatewayPrefixListReferencesRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetTransitGatewayPrefixListReferencesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetTransitGatewayPrefixListReferencesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetTransitGatewayPrefixListReferencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayPrefixListReferencesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetTransitGatewayPrefixListReferencesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
