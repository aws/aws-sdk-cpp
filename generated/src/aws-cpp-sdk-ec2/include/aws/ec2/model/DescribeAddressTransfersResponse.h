...
class DescribeAddressTransfersResponse {
 public:
  ...
  void SetAddressTransfers(AddressTransfersT&& value) {
    m_addressTransfersHasBeenSet = true;
    m_addressTransfers = std::forward<AddressTransfersT>(value);
  }
  template <typename AddressTransfersT = Aws::Vector<AddressTransfer>>
  DescribeAddressTransfersResponse& WithAddressTransfers(AddressTransfersT&& value) {
    SetAddressTransfers(std::forward<AddressTransfersT>(value));
    return *this;
  }
  template <typename AddressTransfersT = AddressTransfer>
  DescribeAddressTransfersResponse& AddAddressTransfers(AddressTransfersT&& value) {
    m_addressTransfersHasBeenSet = true;
    m_addressTransfers.emplace_back(std::forward<AddressTransfersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeAddressTransfersResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAddressTransfersResponse& WithResponseMetadata(ResponseMetadataT&& value) {
