...
/**
 */
class DeprovisionByoipCidrRequest : public EC2Request {
 public:
  AWS_EC2_API DeprovisionByoipCidrRequest() = default;
 ...
 public:
  ...
  template <typename CidrT = Aws::String>
  DeprovisionByoipCidrRequest& WithCidr(CidrT&& value) {
  ...
  inline DeprovisionByoipCidrRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
