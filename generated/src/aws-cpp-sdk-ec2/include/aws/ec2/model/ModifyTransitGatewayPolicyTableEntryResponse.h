...
namespace EC2 {
namespace Model {
class ModifyTransitGatewayPolicyTableEntryResponse {
 public:
  AWS_EC2_API ModifyTransitGatewayPolicyTableEntryResponse() = default;
  AWS_EC2_API ModifyTransitGatewayPolicyTableEntryResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API ModifyTransitGatewayPolicyTableEntryResponse& operator=(
  ...
  template <typename TransitGatewayPolicyTableEntryT = TransitGatewayPolicyTableEntry>
  ModifyTransitGatewayPolicyTableEntryResponse& WithTransitGatewayPolicyTableEntry(TransitGatewayPolicyTableEntryT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyTransitGatewayPolicyTableEntryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
