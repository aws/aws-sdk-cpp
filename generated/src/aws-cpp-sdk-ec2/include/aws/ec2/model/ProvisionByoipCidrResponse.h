...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ProvisionByoipCidrResponse() = default;
    ...
    template<typename ByoipCidrT = ByoipCidr>
    ProvisionByoipCidrResponse& WithByoipCidr(ByoipCidrT&& value) { SetByoipCidr(std::forward<ByoipCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ProvisionByoipCidrResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
