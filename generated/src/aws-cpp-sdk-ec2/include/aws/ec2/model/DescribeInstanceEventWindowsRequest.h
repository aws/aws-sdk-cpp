...
class DescribeInstanceEventWindowsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeInstanceEventWindowsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetInstanceEventWindowIds(InstanceEventWindowIdsT&& value) {
    m_instanceEventWindowIdsHasBeenSet = true;
    m_instanceEventWindowIds = std::forward<InstanceEventWindowIdsT>(value);
  }
  template <typename InstanceEventWindowIdsT = Aws::Vector<Aws::String>>
  DescribeInstanceEventWindowsRequest& WithInstanceEventWindowIds(InstanceEventWindowIdsT&& value) {
    SetInstanceEventWindowIds(std::forward<InstanceEventWindowIdsT>(value));
    return *this;
  }
  ...
  DescribeInstanceEventWindowsRequest& AddInstanceEventWindowIds(InstanceEventWindowIdsT&& value) {
    m_instanceEventWindowIdsHasBeenSet = true;
    m_instanceEventWindowIds.emplace_back(std::forward<InstanceEventWindowIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeInstanceEventWindowsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
