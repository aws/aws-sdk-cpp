...
class VerifiedAccessLogKinesisDataFirehoseDestination {
 public:
  ...
  inline VerifiedAccessLogKinesisDataFirehoseDestination& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeliveryStatusT = VerifiedAccessLogDeliveryStatus>
  VerifiedAccessLogKinesisDataFirehoseDestination& WithDeliveryStatus(DeliveryStatusT&& value) {
  ...
  template <typename DeliveryStreamT = Aws::String>
  VerifiedAccessLogKinesisDataFirehoseDestination& WithDeliveryStream(DeliveryStreamT&& value) {
