...
namespace Model
{
  ...
  /**
   */
  class GetIpamPoolCidrsRequest : public EC2Request
  {
  public:
  ...
  public:
    ...
    template<typename IpamPoolIdT = Aws::String>
    GetIpamPoolCidrsRequest& WithIpamPoolId(IpamPoolIdT&& value) { SetIpamPoolId(std::forward<IpamPoolIdT>(value)); return *this;}
    ///@}
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    GetIpamPoolCidrsRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    GetIpamPoolCidrsRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetIpamPoolCidrsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
