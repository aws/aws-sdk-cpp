...
class EbsStatusDetails {
 public:
  ...
  template <typename ImpairedSinceT = Aws::Utils::DateTime>
  EbsStatusDetails& WithImpairedSince(ImpairedSinceT&& value) {
  ...
  inline EbsStatusDetails& WithName(StatusName value) {
    SetName(value);
    return *this;
  }
  ///@}
  ...
  inline EbsStatusDetails& WithStatus(StatusType value) {
    SetStatus(value);
    return *this;
  }
  ///@}
