...
class UnassignPrivateNatGatewayAddressResponse {
 public:
  ...
  template <typename NatGatewayIdT = Aws::String>
  UnassignPrivateNatGatewayAddressResponse& WithNatGatewayId(NatGatewayIdT&& value) {
  ...
  template <typename NatGatewayAddressesT = Aws::Vector<NatGatewayAddress>>
  UnassignPrivateNatGatewayAddressResponse& WithNatGatewayAddresses(NatGatewayAddressesT&& value) {
    SetNatGatewayAddresses(std::forward<NatGatewayAddressesT>(value));
    return *this;
  }
  template <typename NatGatewayAddressesT = NatGatewayAddress>
  UnassignPrivateNatGatewayAddressResponse& AddNatGatewayAddresses(NatGatewayAddressesT&& value) {
    m_natGatewayAddressesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UnassignPrivateNatGatewayAddressResponse& WithResponseMetadata(ResponseMetadataT&& value) {
