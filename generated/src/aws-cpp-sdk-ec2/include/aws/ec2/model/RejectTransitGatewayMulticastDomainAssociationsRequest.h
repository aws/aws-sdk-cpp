...
class RejectTransitGatewayMulticastDomainAssociationsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  RejectTransitGatewayMulticastDomainAssociationsRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  RejectTransitGatewayMulticastDomainAssociationsRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  RejectTransitGatewayMulticastDomainAssociationsRequest& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  RejectTransitGatewayMulticastDomainAssociationsRequest& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  inline RejectTransitGatewayMulticastDomainAssociationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
