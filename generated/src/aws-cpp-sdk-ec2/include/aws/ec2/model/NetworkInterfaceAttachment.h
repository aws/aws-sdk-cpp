...
class NetworkInterfaceAttachment {
 public:
  ...
  inline NetworkInterfaceAttachment& WithDeleteOnTermination(bool value) {
  ...
  inline NetworkInterfaceAttachment& WithDeviceIndex(int value) {
  ...
  inline NetworkInterfaceAttachment& WithNetworkCardIndex(int value) {
  ...
  inline NetworkInterfaceAttachment& WithStatus(AttachmentStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline NetworkInterfaceAttachment& WithEnaQueueCount(int value) {
