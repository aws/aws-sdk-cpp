...
class CreateTransitGatewayPeeringAttachmentResponse {
 public:
  AWS_EC2_API CreateTransitGatewayPeeringAttachmentResponse() = default;
  ...
  AWS_EC2_API CreateTransitGatewayPeeringAttachmentResponse& operator=(
  ...
  template <typename TransitGatewayPeeringAttachmentT = TransitGatewayPeeringAttachment>
  CreateTransitGatewayPeeringAttachmentResponse& WithTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayPeeringAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
