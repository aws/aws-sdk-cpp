...
class NetworkInterfaceAttachmentChanges {
 public:
  ...
  inline void SetDefaultEnaQueueCount(bool value) {
    m_defaultEnaQueueCountHasBeenSet = true;
    m_defaultEnaQueueCount = value;
  }
  inline NetworkInterfaceAttachmentChanges& WithDefaultEnaQueueCount(bool value) {
    SetDefaultEnaQueueCount(value);
    return *this;
  }
  ///@}
  ...
  inline NetworkInterfaceAttachmentChanges& WithEnaQueueCount(int value) {
  ...
  inline NetworkInterfaceAttachmentChanges& WithDeleteOnTermination(bool value) {
