...
class ClientCertificateRevocationListStatus {
 public:
  ...
  inline void SetCode(ClientCertificateRevocationListStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClientCertificateRevocationListStatus& WithCode(ClientCertificateRevocationListStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClientCertificateRevocationListStatus& WithMessage(MessageT&& value) {
