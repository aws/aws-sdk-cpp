...
class InstanceMetadataDefaultsResponse {
 public:
  ...
  inline InstanceMetadataDefaultsResponse& WithHttpTokens(HttpTokensState value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataDefaultsResponse& WithHttpPutResponseHopLimit(int value) {
  ...
  inline InstanceMetadataDefaultsResponse& WithHttpEndpoint(InstanceMetadataEndpointState value) {
  ...
  inline InstanceMetadataDefaultsResponse& WithInstanceMetadataTags(InstanceMetadataTagsState value) {
  ...
  inline InstanceMetadataDefaultsResponse& WithManagedBy(ManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
  ...
  void SetManagedExceptionMessage(ManagedExceptionMessageT&& value) {
    m_managedExceptionMessageHasBeenSet = true;
    m_managedExceptionMessage = std::forward<ManagedExceptionMessageT>(value);
  }
  template <typename ManagedExceptionMessageT = Aws::String>
  InstanceMetadataDefaultsResponse& WithManagedExceptionMessage(ManagedExceptionMessageT&& value) {
    SetManagedExceptionMessage(std::forward<ManagedExceptionMessageT>(value));
    return *this;
  }
  ///@}
 private:
