...
namespace Model
{
   ...
   * <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateEnaSrdUdpSpecification">AWS
   * API Reference</a></p>
   */
  class LaunchTemplateEnaSrdUdpSpecification
  {
  public:
    AWS_EC2_API LaunchTemplateEnaSrdUdpSpecification() = default;
    AWS_EC2_API LaunchTemplateEnaSrdUdpSpecification(const Aws::Utils::Xml::XmlNode& xmlNode);
    AWS_EC2_API LaunchTemplateEnaSrdUdpSpecification& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
    ...
    inline LaunchTemplateEnaSrdUdpSpecification& WithEnaSrdUdpEnabled(bool value) { SetEnaSrdUdpEnabled(value); return *this;}
    ///@}
  private:
