...
class CreateVerifiedAccessEndpointCidrOptions {
 public:
  ...
  inline CreateVerifiedAccessEndpointCidrOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateVerifiedAccessEndpointCidrOptions& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateVerifiedAccessEndpointCidrOptions& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename CidrT = Aws::String>
  CreateVerifiedAccessEndpointCidrOptions& WithCidr(CidrT&& value) {
  ...
  template <typename PortRangesT = Aws::Vector<CreateVerifiedAccessEndpointPortRange>>
  CreateVerifiedAccessEndpointCidrOptions& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = CreateVerifiedAccessEndpointPortRange>
  CreateVerifiedAccessEndpointCidrOptions& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
