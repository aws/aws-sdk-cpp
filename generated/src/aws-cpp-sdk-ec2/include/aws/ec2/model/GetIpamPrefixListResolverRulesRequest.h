...
/**
 */
class GetIpamPrefixListResolverRulesRequest : public EC2Request {
 public:
  AWS_EC2_API GetIpamPrefixListResolverRulesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetIpamPrefixListResolverRules"; }
 ...
 public:
  ...
  inline GetIpamPrefixListResolverRulesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamPrefixListResolverIdT = Aws::String>
  GetIpamPrefixListResolverRulesRequest& WithIpamPrefixListResolverId(IpamPrefixListResolverIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetIpamPrefixListResolverRulesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetIpamPrefixListResolverRulesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetIpamPrefixListResolverRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamPrefixListResolverRulesRequest& WithNextToken(NextTokenT&& value) {
