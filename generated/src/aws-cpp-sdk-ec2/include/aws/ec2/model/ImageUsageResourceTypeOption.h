...
class ImageUsageResourceTypeOption {
 public:
  ...
  template <typename OptionNameT = Aws::String>
  ImageUsageResourceTypeOption& WithOptionName(OptionNameT&& value) {
  ...
  void SetOptionValues(OptionValuesT&& value) {
    m_optionValuesHasBeenSet = true;
    m_optionValues = std::forward<OptionValuesT>(value);
  }
  template <typename OptionValuesT = Aws::Vector<Aws::String>>
  ImageUsageResourceTypeOption& WithOptionValues(OptionValuesT&& value) {
    SetOptionValues(std::forward<OptionValuesT>(value));
    return *this;
  }
  template <typename OptionValuesT = Aws::String>
  ImageUsageResourceTypeOption& AddOptionValues(OptionValuesT&& value) {
    m_optionValuesHasBeenSet = true;
    m_optionValues.emplace_back(std::forward<OptionValuesT>(value));
    return *this;
  }
  ///@}
 private:
