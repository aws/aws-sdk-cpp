...
class DescribeClientVpnConnectionsRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeClientVpnConnectionsRequest() = default;
 ...
 public:
  ...
  inline DescribeClientVpnConnectionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClientVpnConnectionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
