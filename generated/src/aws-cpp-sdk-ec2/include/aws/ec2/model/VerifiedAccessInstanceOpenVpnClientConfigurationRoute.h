...
namespace Model
{
  ...
  public:
    ...
    inline VerifiedAccessInstanceOpenVpnClientConfigurationRoute& WithCidr(const Aws::String& value) { SetCidr(value); return *this;}
    inline VerifiedAccessInstanceOpenVpnClientConfigurationRoute& WithCidr(Aws::String&& value) { SetCidr(std::move(value)); return *this;}
    inline VerifiedAccessInstanceOpenVpnClientConfigurationRoute& WithCidr(const char* value) { SetCidr(value); return *this;}
    ///@}
  private:
