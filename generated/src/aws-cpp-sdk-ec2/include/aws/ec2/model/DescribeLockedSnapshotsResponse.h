...
class DescribeLockedSnapshotsResponse {
 public:
  ...
  template <typename SnapshotsT = Aws::Vector<LockedSnapshotsInfo>>
  DescribeLockedSnapshotsResponse& WithSnapshots(SnapshotsT&& value) {
    SetSnapshots(std::forward<SnapshotsT>(value));
    return *this;
  }
  template <typename SnapshotsT = LockedSnapshotsInfo>
  DescribeLockedSnapshotsResponse& AddSnapshots(SnapshotsT&& value) {
    m_snapshotsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLockedSnapshotsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeLockedSnapshotsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
