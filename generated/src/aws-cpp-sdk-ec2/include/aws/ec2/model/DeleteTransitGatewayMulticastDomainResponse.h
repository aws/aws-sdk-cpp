...
class DeleteTransitGatewayMulticastDomainResponse {
 public:
  ...
  AWS_EC2_API DeleteTransitGatewayMulticastDomainResponse& operator=(
  ...
  void SetTransitGatewayMulticastDomain(TransitGatewayMulticastDomainT&& value) {
    m_transitGatewayMulticastDomainHasBeenSet = true;
    m_transitGatewayMulticastDomain = std::forward<TransitGatewayMulticastDomainT>(value);
  }
  template <typename TransitGatewayMulticastDomainT = TransitGatewayMulticastDomain>
  DeleteTransitGatewayMulticastDomainResponse& WithTransitGatewayMulticastDomain(TransitGatewayMulticastDomainT&& value) {
    SetTransitGatewayMulticastDomain(std::forward<TransitGatewayMulticastDomainT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) {
