...
class TransitGatewayAttachmentPropagation {
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  TransitGatewayAttachmentPropagation& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  inline void SetState(TransitGatewayPropagationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline TransitGatewayAttachmentPropagation& WithState(TransitGatewayPropagationState value) {
    SetState(value);
    return *this;
  }
  ///@}
