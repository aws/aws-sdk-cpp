...
class DescribeSpotFleetRequestsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSpotFleetRequestsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetSpotFleetRequestConfigs(SpotFleetRequestConfigsT&& value) {
    m_spotFleetRequestConfigsHasBeenSet = true;
    m_spotFleetRequestConfigs = std::forward<SpotFleetRequestConfigsT>(value);
  }
  template <typename SpotFleetRequestConfigsT = Aws::Vector<SpotFleetRequestConfig>>
  DescribeSpotFleetRequestsResponse& WithSpotFleetRequestConfigs(SpotFleetRequestConfigsT&& value) {
    SetSpotFleetRequestConfigs(std::forward<SpotFleetRequestConfigsT>(value));
    return *this;
  }
  template <typename SpotFleetRequestConfigsT = SpotFleetRequestConfig>
  DescribeSpotFleetRequestsResponse& AddSpotFleetRequestConfigs(SpotFleetRequestConfigsT&& value) {
    m_spotFleetRequestConfigsHasBeenSet = true;
    m_spotFleetRequestConfigs.emplace_back(std::forward<SpotFleetRequestConfigsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSpotFleetRequestsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
