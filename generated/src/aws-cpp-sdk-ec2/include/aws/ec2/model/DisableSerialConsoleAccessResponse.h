...
class DisableSerialConsoleAccessResponse {
 public:
  ...
  inline DisableSerialConsoleAccessResponse& WithSerialConsoleAccessEnabled(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableSerialConsoleAccessResponse& WithResponseMetadata(ResponseMetadataT&& value) {
