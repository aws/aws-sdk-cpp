...
class CapacityReservationTargetResponse {
 public:
  ...
  template <typename CapacityReservationIdT = Aws::String>
  CapacityReservationTargetResponse& WithCapacityReservationId(CapacityReservationIdT&& value) {
  ...
  template <typename CapacityReservationResourceGroupArnT = Aws::String>
  CapacityReservationTargetResponse& WithCapacityReservationResourceGroupArn(CapacityReservationResourceGroupArnT&& value) {
