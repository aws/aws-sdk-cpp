...
class GetVerifiedAccessEndpointPolicyRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessEndpointIdT = Aws::String>
  GetVerifiedAccessEndpointPolicyRequest& WithVerifiedAccessEndpointId(VerifiedAccessEndpointIdT&& value) {
  ...
  inline GetVerifiedAccessEndpointPolicyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
