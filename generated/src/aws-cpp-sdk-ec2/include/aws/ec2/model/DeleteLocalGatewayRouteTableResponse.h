...
class DeleteLocalGatewayRouteTableResponse {
 public:
  ...
  void SetLocalGatewayRouteTable(LocalGatewayRouteTableT&& value) {
    m_localGatewayRouteTableHasBeenSet = true;
    m_localGatewayRouteTable = std::forward<LocalGatewayRouteTableT>(value);
  }
  template <typename LocalGatewayRouteTableT = LocalGatewayRouteTable>
  DeleteLocalGatewayRouteTableResponse& WithLocalGatewayRouteTable(LocalGatewayRouteTableT&& value) {
    SetLocalGatewayRouteTable(std::forward<LocalGatewayRouteTableT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteLocalGatewayRouteTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
