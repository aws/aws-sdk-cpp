...
class GetConsoleOutputResponse {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetConsoleOutputResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename TimestampT = Aws::Utils::DateTime>
  GetConsoleOutputResponse& WithTimestamp(TimestampT&& value) {
  ...
  template <typename OutputT = Aws::String>
  GetConsoleOutputResponse& WithOutput(OutputT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetConsoleOutputResponse& WithResponseMetadata(ResponseMetadataT&& value) {
