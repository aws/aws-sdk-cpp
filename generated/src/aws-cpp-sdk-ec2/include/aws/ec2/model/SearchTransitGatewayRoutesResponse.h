...
class SearchTransitGatewayRoutesResponse {
 public:
  ...
  template <typename RoutesT = Aws::Vector<TransitGatewayRoute>>
  SearchTransitGatewayRoutesResponse& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = TransitGatewayRoute>
  SearchTransitGatewayRoutesResponse& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  inline void SetAdditionalRoutesAvailable(bool value) {
    m_additionalRoutesAvailableHasBeenSet = true;
    m_additionalRoutesAvailable = value;
  }
  inline SearchTransitGatewayRoutesResponse& WithAdditionalRoutesAvailable(bool value) {
    SetAdditionalRoutesAvailable(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  SearchTransitGatewayRoutesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SearchTransitGatewayRoutesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
