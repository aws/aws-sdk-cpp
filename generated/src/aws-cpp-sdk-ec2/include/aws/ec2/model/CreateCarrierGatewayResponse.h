...
class CreateCarrierGatewayResponse {
 public:
  ...
  void SetCarrierGateway(CarrierGatewayT&& value) {
    m_carrierGatewayHasBeenSet = true;
    m_carrierGateway = std::forward<CarrierGatewayT>(value);
  }
  template <typename CarrierGatewayT = CarrierGateway>
  CreateCarrierGatewayResponse& WithCarrierGateway(CarrierGatewayT&& value) {
    SetCarrierGateway(std::forward<CarrierGatewayT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateCarrierGatewayResponse& WithResponseMetadata(ResponseMetadataT&& value) {
