...
class GetTransitGatewayPolicyTableAssociationsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayPolicyTableIdT = Aws::String>
  GetTransitGatewayPolicyTableAssociationsRequest& WithTransitGatewayPolicyTableId(TransitGatewayPolicyTableIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetTransitGatewayPolicyTableAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetTransitGatewayPolicyTableAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetTransitGatewayPolicyTableAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayPolicyTableAssociationsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetTransitGatewayPolicyTableAssociationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
