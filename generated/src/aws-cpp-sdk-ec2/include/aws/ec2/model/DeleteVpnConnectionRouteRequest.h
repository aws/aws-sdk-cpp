...
class DeleteVpnConnectionRouteRequest : public EC2Request {
 ...
 public:
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  DeleteVpnConnectionRouteRequest& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  template <typename VpnConnectionIdT = Aws::String>
  DeleteVpnConnectionRouteRequest& WithVpnConnectionId(VpnConnectionIdT&& value) {
