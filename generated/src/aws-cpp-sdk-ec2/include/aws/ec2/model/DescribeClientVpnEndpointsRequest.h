...
class DescribeClientVpnEndpointsRequest : public EC2Request {
 ...
 public:
  ...
  void SetClientVpnEndpointIds(ClientVpnEndpointIdsT&& value) {
    m_clientVpnEndpointIdsHasBeenSet = true;
    m_clientVpnEndpointIds = std::forward<ClientVpnEndpointIdsT>(value);
  }
  template <typename ClientVpnEndpointIdsT = Aws::Vector<Aws::String>>
  DescribeClientVpnEndpointsRequest& WithClientVpnEndpointIds(ClientVpnEndpointIdsT&& value) {
    SetClientVpnEndpointIds(std::forward<ClientVpnEndpointIdsT>(value));
    return *this;
  }
  ...
  DescribeClientVpnEndpointsRequest& AddClientVpnEndpointIds(ClientVpnEndpointIdsT&& value) {
    m_clientVpnEndpointIdsHasBeenSet = true;
    m_clientVpnEndpointIds.emplace_back(std::forward<ClientVpnEndpointIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeClientVpnEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeClientVpnEndpointsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
