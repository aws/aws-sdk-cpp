...
class DescribeFleetError {
 public:
  AWS_EC2_API DescribeFleetError() = default;
  ...
  template <typename LaunchTemplateAndOverridesT = LaunchTemplateAndOverridesResponse>
  DescribeFleetError& WithLaunchTemplateAndOverrides(LaunchTemplateAndOverridesT&& value) {
  ...
  inline DescribeFleetError& WithLifecycle(InstanceLifecycle value) {
    SetLifecycle(value);
    return *this;
  }
  ///@}
  ...
  template <typename ErrorCodeT = Aws::String>
  DescribeFleetError& WithErrorCode(ErrorCodeT&& value) {
  ...
  template <typename ErrorMessageT = Aws::String>
  DescribeFleetError& WithErrorMessage(ErrorMessageT&& value) {
