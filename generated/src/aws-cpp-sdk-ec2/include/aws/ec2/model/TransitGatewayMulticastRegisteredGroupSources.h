...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API TransitGatewayMulticastRegisteredGroupSources() = default;
    ...
    template<typename TransitGatewayMulticastDomainIdT = Aws::String>
    TransitGatewayMulticastRegisteredGroupSources& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) { SetTransitGatewayMulticastDomainId(std::forward<TransitGatewayMulticastDomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename RegisteredNetworkInterfaceIdsT = Aws::Vector<Aws::String>>
    TransitGatewayMulticastRegisteredGroupSources& WithRegisteredNetworkInterfaceIds(RegisteredNetworkInterfaceIdsT&& value) { SetRegisteredNetworkInterfaceIds(std::forward<RegisteredNetworkInterfaceIdsT>(value)); return *this;}
    template<typename RegisteredNetworkInterfaceIdsT = Aws::String>
    TransitGatewayMulticastRegisteredGroupSources& AddRegisteredNetworkInterfaceIds(RegisteredNetworkInterfaceIdsT&& value) { m_registeredNetworkInterfaceIdsHasBeenSet = true; m_registeredNetworkInterfaceIds.emplace_back(std::forward<RegisteredNetworkInterfaceIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename GroupIpAddressT = Aws::String>
    TransitGatewayMulticastRegisteredGroupSources& WithGroupIpAddress(GroupIpAddressT&& value) { SetGroupIpAddress(std::forward<GroupIpAddressT>(value)); return *this;}
    ///@}
  private:
