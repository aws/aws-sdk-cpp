...
class GetRouteServerPropagationsResponse {
 public:
  ...
  void SetRouteServerPropagations(RouteServerPropagationsT&& value) {
    m_routeServerPropagationsHasBeenSet = true;
    m_routeServerPropagations = std::forward<RouteServerPropagationsT>(value);
  }
  template <typename RouteServerPropagationsT = Aws::Vector<RouteServerPropagation>>
  GetRouteServerPropagationsResponse& WithRouteServerPropagations(RouteServerPropagationsT&& value) {
    SetRouteServerPropagations(std::forward<RouteServerPropagationsT>(value));
    return *this;
  }
  template <typename RouteServerPropagationsT = RouteServerPropagation>
  GetRouteServerPropagationsResponse& AddRouteServerPropagations(RouteServerPropagationsT&& value) {
    m_routeServerPropagationsHasBeenSet = true;
    m_routeServerPropagations.emplace_back(std::forward<RouteServerPropagationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetRouteServerPropagationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
