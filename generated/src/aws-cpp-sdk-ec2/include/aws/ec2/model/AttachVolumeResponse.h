...
class AttachVolumeResponse {
 public:
  ...
  inline AttachVolumeResponse& WithDeleteOnTermination(bool value) {
  ...
  void SetInstanceOwningService(InstanceOwningServiceT&& value) {
    ...
    m_instanceOwningService = std::forward<InstanceOwningServiceT>(value);
  }
  template <typename InstanceOwningServiceT = Aws::String>
  AttachVolumeResponse& WithInstanceOwningService(InstanceOwningServiceT&& value) {
    SetInstanceOwningService(std::forward<InstanceOwningServiceT>(value));
    return *this;
  }
  ///@}
  ...
  inline AttachVolumeResponse& WithEbsCardIndex(int value) {
  ...
  inline void SetState(VolumeAttachmentState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AttachVolumeResponse& WithState(VolumeAttachmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
