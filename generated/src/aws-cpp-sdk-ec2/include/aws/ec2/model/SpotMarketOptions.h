...
class SpotMarketOptions {
 public:
  ...
  inline SpotMarketOptions& WithSpotInstanceType(SpotInstanceType value) {
  ...
  inline SpotMarketOptions& WithBlockDurationMinutes(int value) {
  ...
  inline SpotMarketOptions& WithInstanceInterruptionBehavior(InstanceInterruptionBehavior value) {
