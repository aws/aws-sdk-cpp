...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyTransitGatewayResponse() = default;
    ...
    template<typename TransitGatewayT = TransitGateway>
    ModifyTransitGatewayResponse& WithTransitGateway(TransitGatewayT&& value) { SetTransitGateway(std::forward<TransitGatewayT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyTransitGatewayResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
