...
class CreateNatGatewayResponse {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateNatGatewayResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename NatGatewayT = NatGateway>
  CreateNatGatewayResponse& WithNatGateway(NatGatewayT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateNatGatewayResponse& WithResponseMetadata(ResponseMetadataT&& value) {
