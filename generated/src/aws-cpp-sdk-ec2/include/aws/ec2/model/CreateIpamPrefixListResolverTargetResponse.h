...
namespace EC2 {
namespace Model {
class CreateIpamPrefixListResolverTargetResponse {
 public:
  AWS_EC2_API CreateIpamPrefixListResolverTargetResponse() = default;
  AWS_EC2_API CreateIpamPrefixListResolverTargetResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateIpamPrefixListResolverTargetResponse& operator=(
  ...
  template <typename IpamPrefixListResolverTargetT = IpamPrefixListResolverTarget>
  CreateIpamPrefixListResolverTargetResponse& WithIpamPrefixListResolverTarget(IpamPrefixListResolverTargetT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamPrefixListResolverTargetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
