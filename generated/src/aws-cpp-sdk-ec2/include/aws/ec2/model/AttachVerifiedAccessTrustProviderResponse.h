...
class AttachVerifiedAccessTrustProviderResponse {
 public:
  ...
  template <typename VerifiedAccessTrustProviderT = VerifiedAccessTrustProvider>
  AttachVerifiedAccessTrustProviderResponse& WithVerifiedAccessTrustProvider(VerifiedAccessTrustProviderT&& value) {
  ...
  template <typename VerifiedAccessInstanceT = VerifiedAccessInstance>
  AttachVerifiedAccessTrustProviderResponse& WithVerifiedAccessInstance(VerifiedAccessInstanceT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AttachVerifiedAccessTrustProviderResponse& WithResponseMetadata(ResponseMetadataT&& value) {
