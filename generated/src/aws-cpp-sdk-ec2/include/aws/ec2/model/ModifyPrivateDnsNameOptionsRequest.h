...
class ModifyPrivateDnsNameOptionsRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyPrivateDnsNameOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  ModifyPrivateDnsNameOptionsRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline void SetPrivateDnsHostnameType(HostnameType value) {
    m_privateDnsHostnameTypeHasBeenSet = true;
    m_privateDnsHostnameType = value;
  }
  inline ModifyPrivateDnsNameOptionsRequest& WithPrivateDnsHostnameType(HostnameType value) {
    SetPrivateDnsHostnameType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableResourceNameDnsARecord(bool value) {
    m_enableResourceNameDnsARecordHasBeenSet = true;
    m_enableResourceNameDnsARecord = value;
  }
  inline ModifyPrivateDnsNameOptionsRequest& WithEnableResourceNameDnsARecord(bool value) {
    SetEnableResourceNameDnsARecord(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEnableResourceNameDnsAAAARecord(bool value) {
    m_enableResourceNameDnsAAAARecordHasBeenSet = true;
    m_enableResourceNameDnsAAAARecord = value;
  }
  inline ModifyPrivateDnsNameOptionsRequest& WithEnableResourceNameDnsAAAARecord(bool value) {
    SetEnableResourceNameDnsAAAARecord(value);
    return *this;
  }
  ///@}
 private:
