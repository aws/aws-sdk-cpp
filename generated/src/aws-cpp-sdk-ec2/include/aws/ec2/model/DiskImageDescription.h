...
class DiskImageDescription {
 public:
  ...
  inline void SetFormat(DiskImageFormat value) {
    m_formatHasBeenSet = true;
    m_format = value;
  }
  inline DiskImageDescription& WithFormat(DiskImageFormat value) {
    SetFormat(value);
    return *this;
  }
  ///@}
  ...
  void SetImportManifestUrl(ImportManifestUrlT&& value) {
    ...
    m_importManifestUrl = std::forward<ImportManifestUrlT>(value);
  }
  template <typename ImportManifestUrlT = Aws::String>
  DiskImageDescription& WithImportManifestUrl(ImportManifestUrlT&& value) {
    SetImportManifestUrl(std::forward<ImportManifestUrlT>(value));
    return *this;
  }
  ///@}
  ...
  inline DiskImageDescription& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
