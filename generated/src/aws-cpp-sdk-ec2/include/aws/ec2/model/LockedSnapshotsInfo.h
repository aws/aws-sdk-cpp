...
class LockedSnapshotsInfo {
 public:
  ...
  inline LockedSnapshotsInfo& WithLockState(LockState value) {
    SetLockState(value);
    return *this;
  }
  ///@}
  ...
  inline LockedSnapshotsInfo& WithLockDuration(int value) {
  ...
  inline LockedSnapshotsInfo& WithCoolOffPeriod(int value) {
