...
class ReservedInstanceReservationValue {
 public:
  ...
  template <typename ReservationValueT = ReservationValue>
  ReservedInstanceReservationValue& WithReservationValue(ReservationValueT&& value) {
  ...
  template <typename ReservedInstanceIdT = Aws::String>
  ReservedInstanceReservationValue& WithReservedInstanceId(ReservedInstanceIdT&& value) {
