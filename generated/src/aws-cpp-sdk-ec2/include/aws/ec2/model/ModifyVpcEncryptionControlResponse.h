...
namespace EC2 {
namespace Model {
class ModifyVpcEncryptionControlResponse {
 public:
  AWS_EC2_API ModifyVpcEncryptionControlResponse() = default;
  AWS_EC2_API ModifyVpcEncryptionControlResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API ModifyVpcEncryptionControlResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename VpcEncryptionControlT = VpcEncryptionControl>
  ModifyVpcEncryptionControlResponse& WithVpcEncryptionControl(VpcEncryptionControlT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVpcEncryptionControlResponse& WithResponseMetadata(ResponseMetadataT&& value) {
