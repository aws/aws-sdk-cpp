...
class CreateTrafficMirrorFilterRequest : public EC2Request {
 ...
 public:
  ...
  template <typename DescriptionT = Aws::String>
  CreateTrafficMirrorFilterRequest& WithDescription(DescriptionT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateTrafficMirrorFilterRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateTrafficMirrorFilterRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  inline CreateTrafficMirrorFilterRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorFilterRequest& WithClientToken(ClientTokenT&& value) {
