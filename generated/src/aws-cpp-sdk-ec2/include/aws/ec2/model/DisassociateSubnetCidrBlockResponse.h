...
class DisassociateSubnetCidrBlockResponse {
 public:
  ...
  template <typename Ipv6CidrBlockAssociationT = SubnetIpv6CidrBlockAssociation>
  DisassociateSubnetCidrBlockResponse& WithIpv6CidrBlockAssociation(Ipv6CidrBlockAssociationT&& value) {
  ...
  template <typename SubnetIdT = Aws::String>
  DisassociateSubnetCidrBlockResponse& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateSubnetCidrBlockResponse& WithResponseMetadata(ResponseMetadataT&& value) {
