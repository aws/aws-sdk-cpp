...
class ModifyVpcEndpointServicePayerResponsibilityRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyVpcEndpointServicePayerResponsibilityRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceIdT = Aws::String>
  ModifyVpcEndpointServicePayerResponsibilityRequest& WithServiceId(ServiceIdT&& value) {
  ...
  inline ModifyVpcEndpointServicePayerResponsibilityRequest& WithPayerResponsibility(PayerResponsibility value) {
