...
class DeregisterInstanceEventNotificationAttributesResponse {
 public:
  ...
  AWS_EC2_API DeregisterInstanceEventNotificationAttributesResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename InstanceTagAttributeT = InstanceTagNotificationAttribute>
  DeregisterInstanceEventNotificationAttributesResponse& WithInstanceTagAttribute(InstanceTagAttributeT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeregisterInstanceEventNotificationAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
