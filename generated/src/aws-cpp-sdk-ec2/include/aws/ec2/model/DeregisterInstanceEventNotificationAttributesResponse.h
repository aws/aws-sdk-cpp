...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeregisterInstanceEventNotificationAttributesResponse() = default;
    ...
    template<typename InstanceTagAttributeT = InstanceTagNotificationAttribute>
    DeregisterInstanceEventNotificationAttributesResponse& WithInstanceTagAttribute(InstanceTagAttributeT&& value) { SetInstanceTagAttribute(std::forward<InstanceTagAttributeT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeregisterInstanceEventNotificationAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
