...
class DescribeCapacityManagerDataExportsRequest : public EC2Request {
 ...
 public:
  ...
  void SetCapacityManagerDataExportIds(CapacityManagerDataExportIdsT&& value) {
    m_capacityManagerDataExportIdsHasBeenSet = true;
    m_capacityManagerDataExportIds = std::forward<CapacityManagerDataExportIdsT>(value);
  }
  template <typename CapacityManagerDataExportIdsT = Aws::Vector<Aws::String>>
  DescribeCapacityManagerDataExportsRequest& WithCapacityManagerDataExportIds(CapacityManagerDataExportIdsT&& value) {
    SetCapacityManagerDataExportIds(std::forward<CapacityManagerDataExportIdsT>(value));
    return *this;
  }
  template <typename CapacityManagerDataExportIdsT = Aws::String>
  DescribeCapacityManagerDataExportsRequest& AddCapacityManagerDataExportIds(CapacityManagerDataExportIdsT&& value) {
    m_capacityManagerDataExportIdsHasBeenSet = true;
    m_capacityManagerDataExportIds.emplace_back(std::forward<CapacityManagerDataExportIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeCapacityManagerDataExportsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityManagerDataExportsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeCapacityManagerDataExportsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeCapacityManagerDataExportsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeCapacityManagerDataExportsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
