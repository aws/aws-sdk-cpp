...
class CreateTrafficMirrorFilterRuleResponse {
 public:
  ...
  void SetTrafficMirrorFilterRule(TrafficMirrorFilterRuleT&& value) {
    m_trafficMirrorFilterRuleHasBeenSet = true;
    m_trafficMirrorFilterRule = std::forward<TrafficMirrorFilterRuleT>(value);
  }
  template <typename TrafficMirrorFilterRuleT = TrafficMirrorFilterRule>
  CreateTrafficMirrorFilterRuleResponse& WithTrafficMirrorFilterRule(TrafficMirrorFilterRuleT&& value) {
    SetTrafficMirrorFilterRule(std::forward<TrafficMirrorFilterRuleT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorFilterRuleResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTrafficMirrorFilterRuleResponse& WithResponseMetadata(ResponseMetadataT&& value) {
