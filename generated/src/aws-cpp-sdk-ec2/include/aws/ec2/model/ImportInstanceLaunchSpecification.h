...
class ImportInstanceLaunchSpecification {
 public:
  ...
  inline ImportInstanceLaunchSpecification& WithArchitecture(ArchitectureValues value) {
  ...
  inline ImportInstanceLaunchSpecification& WithInstanceType(InstanceType value) {
  ...
  inline void SetMonitoring(bool value) {
    m_monitoringHasBeenSet = true;
    m_monitoring = value;
  }
  inline ImportInstanceLaunchSpecification& WithMonitoring(bool value) {
    SetMonitoring(value);
    return *this;
  }
  ///@}
  ...
  inline ImportInstanceLaunchSpecification& WithInstanceInitiatedShutdownBehavior(ShutdownBehavior value) {
