...
class DeleteQueuedReservedInstancesError {
 public:
  ...
  inline void SetCode(DeleteQueuedReservedInstancesErrorCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline DeleteQueuedReservedInstancesError& WithCode(DeleteQueuedReservedInstancesErrorCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  DeleteQueuedReservedInstancesError& WithMessage(MessageT&& value) {
