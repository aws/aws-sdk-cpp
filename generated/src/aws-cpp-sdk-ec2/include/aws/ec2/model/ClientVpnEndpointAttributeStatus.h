...
class ClientVpnEndpointAttributeStatus {
 public:
  ...
  inline void SetCode(ClientVpnEndpointAttributeStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClientVpnEndpointAttributeStatus& WithCode(ClientVpnEndpointAttributeStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClientVpnEndpointAttributeStatus& WithMessage(MessageT&& value) {
