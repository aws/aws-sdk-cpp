...
class GetVpnTunnelReplacementStatusRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VpnConnectionIdT = Aws::String>
  GetVpnTunnelReplacementStatusRequest& WithVpnConnectionId(VpnConnectionIdT&& value) {
  ...
  template <typename VpnTunnelOutsideIpAddressT = Aws::String>
  GetVpnTunnelReplacementStatusRequest& WithVpnTunnelOutsideIpAddress(VpnTunnelOutsideIpAddressT&& value) {
  ...
  inline GetVpnTunnelReplacementStatusRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
