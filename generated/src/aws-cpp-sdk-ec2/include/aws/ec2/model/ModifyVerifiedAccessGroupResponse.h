...
class ModifyVerifiedAccessGroupResponse {
 public:
  ...
  template <typename VerifiedAccessGroupT = VerifiedAccessGroup>
  ModifyVerifiedAccessGroupResponse& WithVerifiedAccessGroup(VerifiedAccessGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVerifiedAccessGroupResponse& WithResponseMetadata(ResponseMetadataT&& value) {
