...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyVerifiedAccessGroupResponse() = default;
    ...
    template<typename VerifiedAccessGroupT = VerifiedAccessGroup>
    ModifyVerifiedAccessGroupResponse& WithVerifiedAccessGroup(VerifiedAccessGroupT&& value) { SetVerifiedAccessGroup(std::forward<VerifiedAccessGroupT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyVerifiedAccessGroupResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
