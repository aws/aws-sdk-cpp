...
class EnableSnapshotBlockPublicAccessRequest : public EC2Request {
 ...
 public:
  ...
  inline EnableSnapshotBlockPublicAccessRequest& WithState(SnapshotBlockPublicAccessState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline EnableSnapshotBlockPublicAccessRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
