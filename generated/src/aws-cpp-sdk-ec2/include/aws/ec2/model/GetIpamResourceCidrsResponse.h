...
class GetIpamResourceCidrsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamResourceCidrsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetIpamResourceCidrs(IpamResourceCidrsT&& value) {
    m_ipamResourceCidrsHasBeenSet = true;
    m_ipamResourceCidrs = std::forward<IpamResourceCidrsT>(value);
  }
  template <typename IpamResourceCidrsT = Aws::Vector<IpamResourceCidr>>
  GetIpamResourceCidrsResponse& WithIpamResourceCidrs(IpamResourceCidrsT&& value) {
    SetIpamResourceCidrs(std::forward<IpamResourceCidrsT>(value));
    return *this;
  }
  template <typename IpamResourceCidrsT = IpamResourceCidr>
  GetIpamResourceCidrsResponse& AddIpamResourceCidrs(IpamResourceCidrsT&& value) {
    m_ipamResourceCidrsHasBeenSet = true;
    m_ipamResourceCidrs.emplace_back(std::forward<IpamResourceCidrsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIpamResourceCidrsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
