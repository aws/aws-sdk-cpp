...
class CreateTransitGatewayConnectResponse {
 public:
  ...
  template <typename TransitGatewayConnectT = TransitGatewayConnect>
  CreateTransitGatewayConnectResponse& WithTransitGatewayConnect(TransitGatewayConnectT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayConnectResponse& WithResponseMetadata(ResponseMetadataT&& value) {
