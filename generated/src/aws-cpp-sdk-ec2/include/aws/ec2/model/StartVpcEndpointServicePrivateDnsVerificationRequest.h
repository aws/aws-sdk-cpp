...
class StartVpcEndpointServicePrivateDnsVerificationRequest : public EC2Request {
 ...
 public:
  ...
  inline StartVpcEndpointServicePrivateDnsVerificationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ServiceIdT = Aws::String>
  StartVpcEndpointServicePrivateDnsVerificationRequest& WithServiceId(ServiceIdT&& value) {
