...
/**
 * <p>Describes the source for a health check path.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/HealthCheckPathSourceResponseObject">AWS
 * API Reference</a></p>
 */
class HealthCheckPathSourceResponseObject {
 public:
  AWS_EC2_API HealthCheckPathSourceResponseObject() = default;
  AWS_EC2_API HealthCheckPathSourceResponseObject(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API HealthCheckPathSourceResponseObject& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename SubnetIdT = Aws::String>
  HealthCheckPathSourceResponseObject& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename SecurityGroupIdT = Aws::String>
  HealthCheckPathSourceResponseObject& WithSecurityGroupId(SecurityGroupIdT&& value) {
