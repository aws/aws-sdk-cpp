...
class VCpuInfo {
 public:
  ...
  inline void SetDefaultVCpus(int value) {
    m_defaultVCpusHasBeenSet = true;
    m_defaultVCpus = value;
  }
  inline VCpuInfo& WithDefaultVCpus(int value) {
    SetDefaultVCpus(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultCores(int value) {
    m_defaultCoresHasBeenSet = true;
    m_defaultCores = value;
  }
  inline VCpuInfo& WithDefaultCores(int value) {
    SetDefaultCores(value);
    return *this;
  }
  ///@}
  ...
  inline void SetDefaultThreadsPerCore(int value) {
    m_defaultThreadsPerCoreHasBeenSet = true;
    m_defaultThreadsPerCore = value;
  }
  inline VCpuInfo& WithDefaultThreadsPerCore(int value) {
    SetDefaultThreadsPerCore(value);
    return *this;
  }
  ///@}
  ...
  void SetValidCores(ValidCoresT&& value) {
    ...
    m_validCores = std::forward<ValidCoresT>(value);
  }
  template <typename ValidCoresT = Aws::Vector<int>>
  VCpuInfo& WithValidCores(ValidCoresT&& value) {
    SetValidCores(std::forward<ValidCoresT>(value));
    return *this;
  }
  inline VCpuInfo& AddValidCores(int value) {
    m_validCoresHasBeenSet = true;
    m_validCores.push_back(value);
    return *this;
  }
  ///@}
  ...
  void SetValidThreadsPerCore(ValidThreadsPerCoreT&& value) {
    ...
    m_validThreadsPerCore = std::forward<ValidThreadsPerCoreT>(value);
  }
  template <typename ValidThreadsPerCoreT = Aws::Vector<int>>
  VCpuInfo& WithValidThreadsPerCore(ValidThreadsPerCoreT&& value) {
    SetValidThreadsPerCore(std::forward<ValidThreadsPerCoreT>(value));
    return *this;
  }
  inline VCpuInfo& AddValidThreadsPerCore(int value) {
    m_validThreadsPerCoreHasBeenSet = true;
    m_validThreadsPerCore.push_back(value);
    return *this;
  }
  ///@}
 private:
