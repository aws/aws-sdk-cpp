...
class LaunchTemplateTagSpecification {
 public:
  AWS_EC2_API LaunchTemplateTagSpecification() = default;
  ...
  inline LaunchTemplateTagSpecification& WithResourceType(ResourceType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  LaunchTemplateTagSpecification& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  LaunchTemplateTagSpecification& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
