...
namespace EC2 {
namespace Model {
class CreateIpamPrefixListResolverResponse {
 public:
  AWS_EC2_API CreateIpamPrefixListResolverResponse() = default;
  AWS_EC2_API CreateIpamPrefixListResolverResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateIpamPrefixListResolverResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename IpamPrefixListResolverT = IpamPrefixListResolver>
  CreateIpamPrefixListResolverResponse& WithIpamPrefixListResolver(IpamPrefixListResolverT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamPrefixListResolverResponse& WithResponseMetadata(ResponseMetadataT&& value) {
