...
class EnableEbsEncryptionByDefaultResponse {
 public:
  ...
  inline EnableEbsEncryptionByDefaultResponse& WithEbsEncryptionByDefault(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableEbsEncryptionByDefaultResponse& WithResponseMetadata(ResponseMetadataT&& value) {
