...
class PrivateDnsNameOptionsResponse {
 public:
  AWS_EC2_API PrivateDnsNameOptionsResponse() = default;
  ...
  inline void SetHostnameType(HostnameType value) {
    m_hostnameTypeHasBeenSet = true;
    m_hostnameType = value;
  }
  inline PrivateDnsNameOptionsResponse& WithHostnameType(HostnameType value) {
  ...
  inline PrivateDnsNameOptionsResponse& WithEnableResourceNameDnsARecord(bool value) {
  ...
  inline PrivateDnsNameOptionsResponse& WithEnableResourceNameDnsAAAARecord(bool value) {
