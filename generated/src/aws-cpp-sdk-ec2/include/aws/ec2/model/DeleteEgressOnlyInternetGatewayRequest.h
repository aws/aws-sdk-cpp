...
class DeleteEgressOnlyInternetGatewayRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteEgressOnlyInternetGatewayRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename EgressOnlyInternetGatewayIdT = Aws::String>
  DeleteEgressOnlyInternetGatewayRequest& WithEgressOnlyInternetGatewayId(EgressOnlyInternetGatewayIdT&& value) {
