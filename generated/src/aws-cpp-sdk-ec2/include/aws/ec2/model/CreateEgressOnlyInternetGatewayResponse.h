...
class CreateEgressOnlyInternetGatewayResponse {
 public:
  ...
  template <typename ClientTokenT = Aws::String>
  CreateEgressOnlyInternetGatewayResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename EgressOnlyInternetGatewayT = EgressOnlyInternetGateway>
  CreateEgressOnlyInternetGatewayResponse& WithEgressOnlyInternetGateway(EgressOnlyInternetGatewayT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateEgressOnlyInternetGatewayResponse& WithResponseMetadata(ResponseMetadataT&& value) {
