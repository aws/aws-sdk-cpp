...
class ScheduledInstanceRecurrenceRequest {
 public:
  ...
  void SetFrequency(FrequencyT&& value) {
    ...
    m_frequency = std::forward<FrequencyT>(value);
  }
  template <typename FrequencyT = Aws::String>
  ScheduledInstanceRecurrenceRequest& WithFrequency(FrequencyT&& value) {
    SetFrequency(std::forward<FrequencyT>(value));
    return *this;
  }
  ///@}
  ...
  inline ScheduledInstanceRecurrenceRequest& WithInterval(int value) {
    SetInterval(value);
    return *this;
  }
  ///@}
  ...
  void SetOccurrenceDays(OccurrenceDaysT&& value) {
    m_occurrenceDaysHasBeenSet = true;
    m_occurrenceDays = std::forward<OccurrenceDaysT>(value);
  }
  template <typename OccurrenceDaysT = Aws::Vector<int>>
  ScheduledInstanceRecurrenceRequest& WithOccurrenceDays(OccurrenceDaysT&& value) {
    SetOccurrenceDays(std::forward<OccurrenceDaysT>(value));
    return *this;
  }
  inline ScheduledInstanceRecurrenceRequest& AddOccurrenceDays(int value) {
    m_occurrenceDaysHasBeenSet = true;
    m_occurrenceDays.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetOccurrenceRelativeToEnd(bool value) {
    m_occurrenceRelativeToEndHasBeenSet = true;
    m_occurrenceRelativeToEnd = value;
  }
  inline ScheduledInstanceRecurrenceRequest& WithOccurrenceRelativeToEnd(bool value) {
    SetOccurrenceRelativeToEnd(value);
    return *this;
  }
  ///@}
  ...
  void SetOccurrenceUnit(OccurrenceUnitT&& value) {
    m_occurrenceUnitHasBeenSet = true;
    m_occurrenceUnit = std::forward<OccurrenceUnitT>(value);
  }
  template <typename OccurrenceUnitT = Aws::String>
  ScheduledInstanceRecurrenceRequest& WithOccurrenceUnit(OccurrenceUnitT&& value) {
    SetOccurrenceUnit(std::forward<OccurrenceUnitT>(value));
    return *this;
  }
  ///@}
 private:
