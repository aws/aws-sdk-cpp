...
class DescribePublicIpv4PoolsResponse {
 public:
  ...
  void SetPublicIpv4Pools(PublicIpv4PoolsT&& value) {
    m_publicIpv4PoolsHasBeenSet = true;
    m_publicIpv4Pools = std::forward<PublicIpv4PoolsT>(value);
  }
  template <typename PublicIpv4PoolsT = Aws::Vector<PublicIpv4Pool>>
  DescribePublicIpv4PoolsResponse& WithPublicIpv4Pools(PublicIpv4PoolsT&& value) {
    SetPublicIpv4Pools(std::forward<PublicIpv4PoolsT>(value));
    return *this;
  }
  template <typename PublicIpv4PoolsT = PublicIpv4Pool>
  DescribePublicIpv4PoolsResponse& AddPublicIpv4Pools(PublicIpv4PoolsT&& value) {
    m_publicIpv4PoolsHasBeenSet = true;
    m_publicIpv4Pools.emplace_back(std::forward<PublicIpv4PoolsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePublicIpv4PoolsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribePublicIpv4PoolsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
