...
class StartDeclarativePoliciesReportResponse {
 public:
  ...
  template <typename ReportIdT = Aws::String>
  StartDeclarativePoliciesReportResponse& WithReportId(ReportIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartDeclarativePoliciesReportResponse& WithResponseMetadata(ResponseMetadataT&& value) {
