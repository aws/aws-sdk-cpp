...
class SearchLocalGatewayRoutesResponse {
 public:
  ...
  template <typename RoutesT = Aws::Vector<LocalGatewayRoute>>
  SearchLocalGatewayRoutesResponse& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = LocalGatewayRoute>
  SearchLocalGatewayRoutesResponse& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  SearchLocalGatewayRoutesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  SearchLocalGatewayRoutesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
