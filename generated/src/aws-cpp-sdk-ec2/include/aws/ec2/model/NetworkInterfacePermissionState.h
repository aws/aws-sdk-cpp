...
class NetworkInterfacePermissionState {
 public:
  ...
  inline void SetState(NetworkInterfacePermissionStateCode value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline NetworkInterfacePermissionState& WithState(NetworkInterfacePermissionStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  NetworkInterfacePermissionState& WithStatusMessage(StatusMessageT&& value) {
