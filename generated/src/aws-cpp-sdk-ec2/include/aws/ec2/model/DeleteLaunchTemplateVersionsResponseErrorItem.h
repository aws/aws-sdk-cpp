...
class DeleteLaunchTemplateVersionsResponseErrorItem {
 public:
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  DeleteLaunchTemplateVersionsResponseErrorItem& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  DeleteLaunchTemplateVersionsResponseErrorItem& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
  ...
  inline DeleteLaunchTemplateVersionsResponseErrorItem& WithVersionNumber(long long value) {
  ...
  void SetResponseError(ResponseErrorT&& value) {
    m_responseErrorHasBeenSet = true;
    m_responseError = std::forward<ResponseErrorT>(value);
  }
  template <typename ResponseErrorT = ResponseError>
  DeleteLaunchTemplateVersionsResponseErrorItem& WithResponseError(ResponseErrorT&& value) {
    SetResponseError(std::forward<ResponseErrorT>(value));
    return *this;
  }
  ///@}
 private:
