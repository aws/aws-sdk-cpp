...
class ServiceDetail {
 public:
  ...
  ServiceDetail& AddServiceType(ServiceTypeT&& value) {
    m_serviceTypeHasBeenSet = true;
    m_serviceType.emplace_back(std::forward<ServiceTypeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetBaseEndpointDnsNames(BaseEndpointDnsNamesT&& value) {
    ...
    m_baseEndpointDnsNames = std::forward<BaseEndpointDnsNamesT>(value);
  }
  template <typename BaseEndpointDnsNamesT = Aws::Vector<Aws::String>>
  ServiceDetail& WithBaseEndpointDnsNames(BaseEndpointDnsNamesT&& value) {
    SetBaseEndpointDnsNames(std::forward<BaseEndpointDnsNamesT>(value));
    return *this;
  }
  template <typename BaseEndpointDnsNamesT = Aws::String>
  ServiceDetail& AddBaseEndpointDnsNames(BaseEndpointDnsNamesT&& value) {
    m_baseEndpointDnsNamesHasBeenSet = true;
    m_baseEndpointDnsNames.emplace_back(std::forward<BaseEndpointDnsNamesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPrivateDnsNames(PrivateDnsNamesT&& value) {
    ...
    m_privateDnsNames = std::forward<PrivateDnsNamesT>(value);
  }
  template <typename PrivateDnsNamesT = Aws::Vector<PrivateDnsDetails>>
  ServiceDetail& WithPrivateDnsNames(PrivateDnsNamesT&& value) {
    SetPrivateDnsNames(std::forward<PrivateDnsNamesT>(value));
    return *this;
  }
  template <typename PrivateDnsNamesT = PrivateDnsDetails>
  ServiceDetail& AddPrivateDnsNames(PrivateDnsNamesT&& value) {
    m_privateDnsNamesHasBeenSet = true;
    m_privateDnsNames.emplace_back(std::forward<PrivateDnsNamesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetVpcEndpointPolicySupported(bool value) {
    m_vpcEndpointPolicySupportedHasBeenSet = true;
    m_vpcEndpointPolicySupported = value;
  }
  inline ServiceDetail& WithVpcEndpointPolicySupported(bool value) {
    SetVpcEndpointPolicySupported(value);
    return *this;
  }
  ///@}
  ...
  inline ServiceDetail& WithAcceptanceRequired(bool value) {
  ...
  inline void SetManagesVpcEndpoints(bool value) {
    m_managesVpcEndpointsHasBeenSet = true;
    m_managesVpcEndpoints = value;
  }
  inline ServiceDetail& WithManagesVpcEndpoints(bool value) {
    SetManagesVpcEndpoints(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPayerResponsibility(PayerResponsibility value) {
    m_payerResponsibilityHasBeenSet = true;
    m_payerResponsibility = value;
  }
  inline ServiceDetail& WithPayerResponsibility(PayerResponsibility value) {
  ...
  inline void SetPrivateDnsNameVerificationState(DnsNameState value) {
    m_privateDnsNameVerificationStateHasBeenSet = true;
    m_privateDnsNameVerificationState = value;
  }
  inline ServiceDetail& WithPrivateDnsNameVerificationState(DnsNameState value) {
    SetPrivateDnsNameVerificationState(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedIpAddressTypes(SupportedIpAddressTypesT&& value) {
    ...
    m_supportedIpAddressTypes = std::forward<SupportedIpAddressTypesT>(value);
  }
  template <typename SupportedIpAddressTypesT = Aws::Vector<ServiceConnectivityType>>
  ServiceDetail& WithSupportedIpAddressTypes(SupportedIpAddressTypesT&& value) {
    SetSupportedIpAddressTypes(std::forward<SupportedIpAddressTypesT>(value));
    return *this;
  }
  inline ServiceDetail& AddSupportedIpAddressTypes(ServiceConnectivityType value) {
    m_supportedIpAddressTypesHasBeenSet = true;
    m_supportedIpAddressTypes.push_back(value);
    return *this;
  }
  ///@}
 private:
