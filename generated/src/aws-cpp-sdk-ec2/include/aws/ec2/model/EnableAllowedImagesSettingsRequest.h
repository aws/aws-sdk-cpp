...
class EnableAllowedImagesSettingsRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetAllowedImagesSettingsState(AllowedImagesSettingsEnabledState value) {
    m_allowedImagesSettingsStateHasBeenSet = true;
    m_allowedImagesSettingsState = value;
  }
  inline EnableAllowedImagesSettingsRequest& WithAllowedImagesSettingsState(AllowedImagesSettingsEnabledState value) {
    SetAllowedImagesSettingsState(value);
    return *this;
  }
  ///@}
  ...
  inline EnableAllowedImagesSettingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
