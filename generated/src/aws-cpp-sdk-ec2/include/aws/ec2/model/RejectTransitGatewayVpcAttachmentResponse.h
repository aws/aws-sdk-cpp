...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API RejectTransitGatewayVpcAttachmentResponse() = default;
    ...
    template<typename TransitGatewayVpcAttachmentT = TransitGatewayVpcAttachment>
    RejectTransitGatewayVpcAttachmentResponse& WithTransitGatewayVpcAttachment(TransitGatewayVpcAttachmentT&& value) { SetTransitGatewayVpcAttachment(std::forward<TransitGatewayVpcAttachmentT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RejectTransitGatewayVpcAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
