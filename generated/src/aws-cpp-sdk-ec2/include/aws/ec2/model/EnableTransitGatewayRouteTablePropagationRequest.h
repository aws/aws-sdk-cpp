...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API EnableTransitGatewayRouteTablePropagationRequest() = default;
  ...
  public:
    ...
    template<typename TransitGatewayRouteTableIdT = Aws::String>
    EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) { SetTransitGatewayRouteTableId(std::forward<TransitGatewayRouteTableIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayRouteTableAnnouncementIdT = Aws::String>
    EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableAnnouncementId(TransitGatewayRouteTableAnnouncementIdT&& value) { SetTransitGatewayRouteTableAnnouncementId(std::forward<TransitGatewayRouteTableAnnouncementIdT>(value)); return *this;}
    ///@}
  private:
