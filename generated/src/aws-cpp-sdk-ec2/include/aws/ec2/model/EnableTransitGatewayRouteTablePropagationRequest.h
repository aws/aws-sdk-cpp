...
class EnableTransitGatewayRouteTablePropagationRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline EnableTransitGatewayRouteTablePropagationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayRouteTableAnnouncementIdT = Aws::String>
  EnableTransitGatewayRouteTablePropagationRequest& WithTransitGatewayRouteTableAnnouncementId(
