...
class MaintenanceDetails {
 public:
  ...
  template <typename PendingMaintenanceT = Aws::String>
  MaintenanceDetails& WithPendingMaintenance(PendingMaintenanceT&& value) {
  ...
  void SetMaintenanceAutoAppliedAfter(MaintenanceAutoAppliedAfterT&& value) {
    m_maintenanceAutoAppliedAfterHasBeenSet = true;
    m_maintenanceAutoAppliedAfter = std::forward<MaintenanceAutoAppliedAfterT>(value);
  }
  template <typename MaintenanceAutoAppliedAfterT = Aws::Utils::DateTime>
  MaintenanceDetails& WithMaintenanceAutoAppliedAfter(MaintenanceAutoAppliedAfterT&& value) {
    SetMaintenanceAutoAppliedAfter(std::forward<MaintenanceAutoAppliedAfterT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLastMaintenanceApplied(LastMaintenanceAppliedT&& value) {
    m_lastMaintenanceAppliedHasBeenSet = true;
    m_lastMaintenanceApplied = std::forward<LastMaintenanceAppliedT>(value);
  }
  template <typename LastMaintenanceAppliedT = Aws::Utils::DateTime>
  MaintenanceDetails& WithLastMaintenanceApplied(LastMaintenanceAppliedT&& value) {
    SetLastMaintenanceApplied(std::forward<LastMaintenanceAppliedT>(value));
    return *this;
  }
  ///@}
 private:
