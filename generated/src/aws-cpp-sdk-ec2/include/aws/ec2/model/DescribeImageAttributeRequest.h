...
class DescribeImageAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetAttribute(ImageAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline DescribeImageAttributeRequest& WithAttribute(ImageAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeImageAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
