...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API UpdateSecurityGroupRuleDescriptionsIngressRequest() = default;
  ...
  public:
    ...
    template<typename GroupIdT = Aws::String>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& WithGroupId(GroupIdT&& value) { SetGroupId(std::forward<GroupIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupNameT = Aws::String>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& WithGroupName(GroupNameT&& value) { SetGroupName(std::forward<GroupNameT>(value)); return *this;}
    ///@}
    ...
    template<typename IpPermissionsT = Aws::Vector<IpPermission>>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& WithIpPermissions(IpPermissionsT&& value) { SetIpPermissions(std::forward<IpPermissionsT>(value)); return *this;}
    template<typename IpPermissionsT = IpPermission>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& AddIpPermissions(IpPermissionsT&& value) { m_ipPermissionsHasBeenSet = true; m_ipPermissions.emplace_back(std::forward<IpPermissionsT>(value)); return *this; }
    ///@}
    ...
    template<typename SecurityGroupRuleDescriptionsT = Aws::Vector<SecurityGroupRuleDescription>>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& WithSecurityGroupRuleDescriptions(SecurityGroupRuleDescriptionsT&& value) { SetSecurityGroupRuleDescriptions(std::forward<SecurityGroupRuleDescriptionsT>(value)); return *this;}
    template<typename SecurityGroupRuleDescriptionsT = SecurityGroupRuleDescription>
    UpdateSecurityGroupRuleDescriptionsIngressRequest& AddSecurityGroupRuleDescriptions(SecurityGroupRuleDescriptionsT&& value) { m_securityGroupRuleDescriptionsHasBeenSet = true; m_securityGroupRuleDescriptions.emplace_back(std::forward<SecurityGroupRuleDescriptionsT>(value)); return *this; }
    ///@}
  private:
