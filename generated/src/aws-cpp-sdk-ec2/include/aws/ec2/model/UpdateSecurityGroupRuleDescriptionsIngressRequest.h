...
class UpdateSecurityGroupRuleDescriptionsIngressRequest : public EC2Request {
 ...
 public:
  ...
  inline UpdateSecurityGroupRuleDescriptionsIngressRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::String>
  UpdateSecurityGroupRuleDescriptionsIngressRequest& WithGroupId(GroupIdT&& value) {
  ...
  template <typename GroupNameT = Aws::String>
  UpdateSecurityGroupRuleDescriptionsIngressRequest& WithGroupName(GroupNameT&& value) {
  ...
  template <typename IpPermissionsT = Aws::Vector<IpPermission>>
  UpdateSecurityGroupRuleDescriptionsIngressRequest& WithIpPermissions(IpPermissionsT&& value) {
    SetIpPermissions(std::forward<IpPermissionsT>(value));
    return *this;
  }
  template <typename IpPermissionsT = IpPermission>
  UpdateSecurityGroupRuleDescriptionsIngressRequest& AddIpPermissions(IpPermissionsT&& value) {
    m_ipPermissionsHasBeenSet = true;
  ...
  template <typename SecurityGroupRuleDescriptionsT = Aws::Vector<SecurityGroupRuleDescription>>
  UpdateSecurityGroupRuleDescriptionsIngressRequest& WithSecurityGroupRuleDescriptions(SecurityGroupRuleDescriptionsT&& value) {
  ...
  UpdateSecurityGroupRuleDescriptionsIngressRequest& AddSecurityGroupRuleDescriptions(SecurityGroupRuleDescriptionsT&& value) {
    m_securityGroupRuleDescriptionsHasBeenSet = true;
