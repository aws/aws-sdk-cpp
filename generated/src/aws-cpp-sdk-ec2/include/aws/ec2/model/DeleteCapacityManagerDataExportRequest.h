...
namespace Model
{
  ...
  public:
    ...
    template<typename CapacityManagerDataExportIdT = Aws::String>
    DeleteCapacityManagerDataExportRequest& WithCapacityManagerDataExportId(CapacityManagerDataExportIdT&& value) { SetCapacityManagerDataExportId(std::forward<CapacityManagerDataExportIdT>(value)); return *this;}
    ///@}
    ...
    inline DeleteCapacityManagerDataExportRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
  private:
