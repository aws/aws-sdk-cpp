...
class ModifyVerifiedAccessNativeApplicationOidcOptions {
 public:
  ...
  template <typename PublicSigningKeyEndpointT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithPublicSigningKeyEndpoint(PublicSigningKeyEndpointT&& value) {
  ...
  template <typename IssuerT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithIssuer(IssuerT&& value) {
  ...
  template <typename AuthorizationEndpointT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) {
  ...
  template <typename TokenEndpointT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithTokenEndpoint(TokenEndpointT&& value) {
  ...
  template <typename UserInfoEndpointT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithUserInfoEndpoint(UserInfoEndpointT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithClientSecret(ClientSecretT&& value) {
  ...
  template <typename ScopeT = Aws::String>
  ModifyVerifiedAccessNativeApplicationOidcOptions& WithScope(ScopeT&& value) {
