...
class GetVpnConnectionDeviceTypesRequest : public EC2Request {
 ...
 public:
  ...
  inline GetVpnConnectionDeviceTypesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetVpnConnectionDeviceTypesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetVpnConnectionDeviceTypesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
