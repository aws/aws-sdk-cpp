...
class DescribeCapacityBlockStatusResponse {
 public:
  ...
  void SetCapacityBlockStatuses(CapacityBlockStatusesT&& value) {
    m_capacityBlockStatusesHasBeenSet = true;
    m_capacityBlockStatuses = std::forward<CapacityBlockStatusesT>(value);
  }
  template <typename CapacityBlockStatusesT = Aws::Vector<CapacityBlockStatus>>
  DescribeCapacityBlockStatusResponse& WithCapacityBlockStatuses(CapacityBlockStatusesT&& value) {
    SetCapacityBlockStatuses(std::forward<CapacityBlockStatusesT>(value));
    return *this;
  }
  template <typename CapacityBlockStatusesT = CapacityBlockStatus>
  DescribeCapacityBlockStatusResponse& AddCapacityBlockStatuses(CapacityBlockStatusesT&& value) {
    m_capacityBlockStatusesHasBeenSet = true;
    m_capacityBlockStatuses.emplace_back(std::forward<CapacityBlockStatusesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityBlockStatusResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeCapacityBlockStatusResponse& WithResponseMetadata(ResponseMetadataT&& value) {
