...
class AssociateClientVpnTargetNetworkResponse {
 public:
  ...
  template <typename AssociationIdT = Aws::String>
  AssociateClientVpnTargetNetworkResponse& WithAssociationId(AssociationIdT&& value) {
  ...
  template <typename StatusT = AssociationStatus>
  AssociateClientVpnTargetNetworkResponse& WithStatus(StatusT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateClientVpnTargetNetworkResponse& WithResponseMetadata(ResponseMetadataT&& value) {
