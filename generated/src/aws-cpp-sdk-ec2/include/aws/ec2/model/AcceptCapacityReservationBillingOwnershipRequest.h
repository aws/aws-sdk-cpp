...
class AcceptCapacityReservationBillingOwnershipRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AcceptCapacityReservationBillingOwnership"; }
 ...
 public:
  ...
  inline AcceptCapacityReservationBillingOwnershipRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityReservationIdT = Aws::String>
  AcceptCapacityReservationBillingOwnershipRequest& WithCapacityReservationId(CapacityReservationIdT&& value) {
