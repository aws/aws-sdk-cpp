...
class AcceptVpcEndpointConnectionsResponse {
 public:
  ...
  template <typename UnsuccessfulT = Aws::Vector<UnsuccessfulItem>>
  AcceptVpcEndpointConnectionsResponse& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = UnsuccessfulItem>
  AcceptVpcEndpointConnectionsResponse& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptVpcEndpointConnectionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
