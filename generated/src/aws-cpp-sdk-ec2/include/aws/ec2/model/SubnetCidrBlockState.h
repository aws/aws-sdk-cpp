...
class SubnetCidrBlockState {
 public:
  ...
  inline void SetState(SubnetCidrBlockStateCode value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline SubnetCidrBlockState& WithState(SubnetCidrBlockStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  SubnetCidrBlockState& WithStatusMessage(StatusMessageT&& value) {
