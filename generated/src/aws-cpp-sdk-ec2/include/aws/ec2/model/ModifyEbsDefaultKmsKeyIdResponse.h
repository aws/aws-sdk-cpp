...
class ModifyEbsDefaultKmsKeyIdResponse {
 public:
  AWS_EC2_API ModifyEbsDefaultKmsKeyIdResponse() = default;
  ...
  template <typename KmsKeyIdT = Aws::String>
  ModifyEbsDefaultKmsKeyIdResponse& WithKmsKeyId(KmsKeyIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyEbsDefaultKmsKeyIdResponse& WithResponseMetadata(ResponseMetadataT&& value) {
