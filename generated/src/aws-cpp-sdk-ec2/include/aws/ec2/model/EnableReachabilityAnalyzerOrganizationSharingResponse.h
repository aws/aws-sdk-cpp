...
namespace Model
{
  ...
  public:
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EnableReachabilityAnalyzerOrganizationSharingResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
