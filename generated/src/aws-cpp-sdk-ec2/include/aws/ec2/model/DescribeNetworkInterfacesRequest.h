...
class DescribeNetworkInterfacesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkInterfacesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeNetworkInterfacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNetworkInterfacesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  DescribeNetworkInterfacesRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value));
    return *this;
  }
  template <typename NetworkInterfaceIdsT = Aws::String>
  DescribeNetworkInterfacesRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    m_networkInterfaceIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeNetworkInterfacesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeNetworkInterfacesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
