...
class DeleteSnapshotReturnCode {
 public:
  ...
  template <typename SnapshotIdT = Aws::String>
  DeleteSnapshotReturnCode& WithSnapshotId(SnapshotIdT&& value) {
  ...
  inline void SetReturnCode(SnapshotReturnCodes value) {
    m_returnCodeHasBeenSet = true;
    m_returnCode = value;
  }
  inline DeleteSnapshotReturnCode& WithReturnCode(SnapshotReturnCodes value) {
    SetReturnCode(value);
    return *this;
  }
  ///@}
