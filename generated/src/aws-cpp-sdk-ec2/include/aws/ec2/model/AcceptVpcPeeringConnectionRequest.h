...
class AcceptVpcPeeringConnectionRequest : public EC2Request {
 ...
 public:
  ...
  inline AcceptVpcPeeringConnectionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename VpcPeeringConnectionIdT = Aws::String>
  AcceptVpcPeeringConnectionRequest& WithVpcPeeringConnectionId(VpcPeeringConnectionIdT&& value) {
