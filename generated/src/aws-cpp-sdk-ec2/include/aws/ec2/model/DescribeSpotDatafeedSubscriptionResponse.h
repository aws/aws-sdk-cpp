...
class DescribeSpotDatafeedSubscriptionResponse {
 public:
  ...
  template <typename SpotDatafeedSubscriptionT = SpotDatafeedSubscription>
  DescribeSpotDatafeedSubscriptionResponse& WithSpotDatafeedSubscription(SpotDatafeedSubscriptionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSpotDatafeedSubscriptionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
