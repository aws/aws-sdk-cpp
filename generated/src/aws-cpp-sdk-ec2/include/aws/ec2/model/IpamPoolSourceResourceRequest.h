...
class IpamPoolSourceResourceRequest {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  IpamPoolSourceResourceRequest& WithResourceId(ResourceIdT&& value) {
  ...
  inline void SetResourceType(IpamPoolSourceResourceType value) {
    m_resourceTypeHasBeenSet = true;
    m_resourceType = value;
  }
  inline IpamPoolSourceResourceRequest& WithResourceType(IpamPoolSourceResourceType value) {
  ...
  template <typename ResourceRegionT = Aws::String>
  IpamPoolSourceResourceRequest& WithResourceRegion(ResourceRegionT&& value) {
  ...
  template <typename ResourceOwnerT = Aws::String>
  IpamPoolSourceResourceRequest& WithResourceOwner(ResourceOwnerT&& value) {
