...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyVerifiedAccessTrustProviderResponse() = default;
    ...
    template<typename VerifiedAccessTrustProviderT = VerifiedAccessTrustProvider>
    ModifyVerifiedAccessTrustProviderResponse& WithVerifiedAccessTrustProvider(VerifiedAccessTrustProviderT&& value) { SetVerifiedAccessTrustProvider(std::forward<VerifiedAccessTrustProviderT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyVerifiedAccessTrustProviderResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
