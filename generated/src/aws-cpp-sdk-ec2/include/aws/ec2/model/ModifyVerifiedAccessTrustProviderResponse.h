...
class ModifyVerifiedAccessTrustProviderResponse {
 public:
  ...
  template <typename VerifiedAccessTrustProviderT = VerifiedAccessTrustProvider>
  ModifyVerifiedAccessTrustProviderResponse& WithVerifiedAccessTrustProvider(VerifiedAccessTrustProviderT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVerifiedAccessTrustProviderResponse& WithResponseMetadata(ResponseMetadataT&& value) {
