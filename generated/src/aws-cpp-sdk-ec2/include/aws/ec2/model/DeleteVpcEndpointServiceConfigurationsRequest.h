...
class DeleteVpcEndpointServiceConfigurationsRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteVpcEndpointServiceConfigurationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
