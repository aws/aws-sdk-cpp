...
class GetAssociatedEnclaveCertificateIamRolesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename CertificateArnT = Aws::String>
  GetAssociatedEnclaveCertificateIamRolesRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  inline GetAssociatedEnclaveCertificateIamRolesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
