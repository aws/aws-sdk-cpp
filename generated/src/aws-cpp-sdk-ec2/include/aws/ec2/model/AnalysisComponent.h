...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API AnalysisComponent() = default;
    ...
    template<typename IdT = Aws::String>
    AnalysisComponent& WithId(IdT&& value) { SetId(std::forward<IdT>(value)); return *this;}
    ///@}
    ...
    template<typename ArnT = Aws::String>
    AnalysisComponent& WithArn(ArnT&& value) { SetArn(std::forward<ArnT>(value)); return *this;}
    ///@}
    ...
    template<typename NameT = Aws::String>
    AnalysisComponent& WithName(NameT&& value) { SetName(std::forward<NameT>(value)); return *this;}
    ///@}
  private:
