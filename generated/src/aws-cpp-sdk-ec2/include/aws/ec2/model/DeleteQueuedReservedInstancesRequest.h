...
class DeleteQueuedReservedInstancesRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteQueuedReservedInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReservedInstancesIdsT = Aws::Vector<Aws::String>>
  DeleteQueuedReservedInstancesRequest& WithReservedInstancesIds(ReservedInstancesIdsT&& value) {
    SetReservedInstancesIds(std::forward<ReservedInstancesIdsT>(value));
    return *this;
  }
  template <typename ReservedInstancesIdsT = Aws::String>
  DeleteQueuedReservedInstancesRequest& AddReservedInstancesIds(ReservedInstancesIdsT&& value) {
    m_reservedInstancesIdsHasBeenSet = true;
