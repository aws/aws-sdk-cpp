...
class DisableImageDeregistrationProtectionResponse {
 public:
  ...
  AWS_EC2_API DisableImageDeregistrationProtectionResponse& operator=(
  ...
  template <typename ReturnT = Aws::String>
  DisableImageDeregistrationProtectionResponse& WithReturn(ReturnT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableImageDeregistrationProtectionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
