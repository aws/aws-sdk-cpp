...
class CapacityReservationInfo {
 public:
  ...
  template <typename InstanceTypeT = Aws::String>
  CapacityReservationInfo& WithInstanceType(InstanceTypeT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  CapacityReservationInfo& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  inline CapacityReservationInfo& WithTenancy(CapacityReservationTenancy value) {
    SetTenancy(value);
    return *this;
  }
  ///@}
  ...
  template <typename AvailabilityZoneIdT = Aws::String>
  CapacityReservationInfo& WithAvailabilityZoneId(AvailabilityZoneIdT&& value) {
