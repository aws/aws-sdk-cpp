...
class DisassociateIpamResourceDiscoveryResponse {
 public:
  ...
  void SetIpamResourceDiscoveryAssociation(IpamResourceDiscoveryAssociationT&& value) {
    m_ipamResourceDiscoveryAssociationHasBeenSet = true;
    m_ipamResourceDiscoveryAssociation = std::forward<IpamResourceDiscoveryAssociationT>(value);
  }
  template <typename IpamResourceDiscoveryAssociationT = IpamResourceDiscoveryAssociation>
  DisassociateIpamResourceDiscoveryResponse& WithIpamResourceDiscoveryAssociation(IpamResourceDiscoveryAssociationT&& value) {
    SetIpamResourceDiscoveryAssociation(std::forward<IpamResourceDiscoveryAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateIpamResourceDiscoveryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
