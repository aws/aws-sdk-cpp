...
class DescribeVpcEndpointConnectionNotificationsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVpcEndpointConnectionNotificationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectionNotificationId(ConnectionNotificationIdT&& value) {
    ...
    m_connectionNotificationId = std::forward<ConnectionNotificationIdT>(value);
  }
  template <typename ConnectionNotificationIdT = Aws::String>
  DescribeVpcEndpointConnectionNotificationsRequest& WithConnectionNotificationId(ConnectionNotificationIdT&& value) {
    SetConnectionNotificationId(std::forward<ConnectionNotificationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeVpcEndpointConnectionNotificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
