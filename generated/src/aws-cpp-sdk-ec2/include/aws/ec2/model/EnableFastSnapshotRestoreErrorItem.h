...
class EnableFastSnapshotRestoreErrorItem {
 public:
  ...
  template <typename SnapshotIdT = Aws::String>
  EnableFastSnapshotRestoreErrorItem& WithSnapshotId(SnapshotIdT&& value) {
   ...
   * <p>The errors.</p>
   */
  inline const Aws::Vector<EnableFastSnapshotRestoreStateErrorItem>& GetFastSnapshotRestoreStateErrors() const {
  ...
  template <typename FastSnapshotRestoreStateErrorsT = Aws::Vector<EnableFastSnapshotRestoreStateErrorItem>>
  EnableFastSnapshotRestoreErrorItem& WithFastSnapshotRestoreStateErrors(FastSnapshotRestoreStateErrorsT&& value) {
  ...
  EnableFastSnapshotRestoreErrorItem& AddFastSnapshotRestoreStateErrors(FastSnapshotRestoreStateErrorsT&& value) {
    m_fastSnapshotRestoreStateErrorsHasBeenSet = true;
