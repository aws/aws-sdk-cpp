...
class DescribeNatGatewaysResponse {
 public:
  ...
  void SetNatGateways(NatGatewaysT&& value) {
    m_natGatewaysHasBeenSet = true;
    m_natGateways = std::forward<NatGatewaysT>(value);
  }
  template <typename NatGatewaysT = Aws::Vector<NatGateway>>
  DescribeNatGatewaysResponse& WithNatGateways(NatGatewaysT&& value) {
    SetNatGateways(std::forward<NatGatewaysT>(value));
    return *this;
  }
  template <typename NatGatewaysT = NatGateway>
  DescribeNatGatewaysResponse& AddNatGateways(NatGatewaysT&& value) {
    m_natGatewaysHasBeenSet = true;
    m_natGateways.emplace_back(std::forward<NatGatewaysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNatGatewaysResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeNatGatewaysResponse& WithResponseMetadata(ResponseMetadataT&& value) {
