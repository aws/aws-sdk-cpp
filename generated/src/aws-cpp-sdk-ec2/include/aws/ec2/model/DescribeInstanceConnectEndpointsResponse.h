...
class DescribeInstanceConnectEndpointsResponse {
 public:
  ...
  void SetInstanceConnectEndpoints(InstanceConnectEndpointsT&& value) {
    m_instanceConnectEndpointsHasBeenSet = true;
    m_instanceConnectEndpoints = std::forward<InstanceConnectEndpointsT>(value);
  }
  template <typename InstanceConnectEndpointsT = Aws::Vector<Ec2InstanceConnectEndpoint>>
  DescribeInstanceConnectEndpointsResponse& WithInstanceConnectEndpoints(InstanceConnectEndpointsT&& value) {
    SetInstanceConnectEndpoints(std::forward<InstanceConnectEndpointsT>(value));
    return *this;
  }
  template <typename InstanceConnectEndpointsT = Ec2InstanceConnectEndpoint>
  DescribeInstanceConnectEndpointsResponse& AddInstanceConnectEndpoints(InstanceConnectEndpointsT&& value) {
    m_instanceConnectEndpointsHasBeenSet = true;
    m_instanceConnectEndpoints.emplace_back(std::forward<InstanceConnectEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceConnectEndpointsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeInstanceConnectEndpointsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
