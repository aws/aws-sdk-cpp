...
class CreateCapacityReservationFleetRequest : public EC2Request {
 ...
 public:
   ...
   */
  inline const Aws::Vector<ReservationFleetInstanceSpecification>& GetInstanceTypeSpecifications() const {
    return m_instanceTypeSpecifications;
  }
  ...
  inline CreateCapacityReservationFleetRequest& WithTenancy(FleetCapacityReservationTenancy value) {
    SetTenancy(value);
    return *this;
  }
  ///@}
  ...
  inline CreateCapacityReservationFleetRequest& WithTotalTargetCapacity(int value) {
  ...
  inline CreateCapacityReservationFleetRequest& WithInstanceMatchCriteria(FleetInstanceMatchCriteria value) {
  ...
  inline CreateCapacityReservationFleetRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
