...
class DescribePrincipalIdFormatResponse {
 public:
  AWS_EC2_API DescribePrincipalIdFormatResponse() = default;
  ...
  template <typename PrincipalsT = Aws::Vector<PrincipalIdFormat>>
  void SetPrincipals(PrincipalsT&& value) {
    m_principalsHasBeenSet = true;
    m_principals = std::forward<PrincipalsT>(value);
  }
  template <typename PrincipalsT = Aws::Vector<PrincipalIdFormat>>
  DescribePrincipalIdFormatResponse& WithPrincipals(PrincipalsT&& value) {
    SetPrincipals(std::forward<PrincipalsT>(value));
    return *this;
  }
  template <typename PrincipalsT = PrincipalIdFormat>
  DescribePrincipalIdFormatResponse& AddPrincipals(PrincipalsT&& value) {
    m_principalsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribePrincipalIdFormatResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribePrincipalIdFormatResponse& WithResponseMetadata(ResponseMetadataT&& value) {
