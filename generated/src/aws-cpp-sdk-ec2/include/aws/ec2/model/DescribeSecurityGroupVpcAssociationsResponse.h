...
class DescribeSecurityGroupVpcAssociationsResponse {
 public:
  ...
  AWS_EC2_API DescribeSecurityGroupVpcAssociationsResponse& operator=(
  ...
  void SetSecurityGroupVpcAssociations(SecurityGroupVpcAssociationsT&& value) {
    ...
    m_securityGroupVpcAssociations = std::forward<SecurityGroupVpcAssociationsT>(value);
  }
  template <typename SecurityGroupVpcAssociationsT = Aws::Vector<SecurityGroupVpcAssociation>>
  DescribeSecurityGroupVpcAssociationsResponse& WithSecurityGroupVpcAssociations(SecurityGroupVpcAssociationsT&& value) {
    SetSecurityGroupVpcAssociations(std::forward<SecurityGroupVpcAssociationsT>(value));
    return *this;
  }
  ...
  DescribeSecurityGroupVpcAssociationsResponse& AddSecurityGroupVpcAssociations(SecurityGroupVpcAssociationsT&& value) {
    m_securityGroupVpcAssociationsHasBeenSet = true;
    m_securityGroupVpcAssociations.emplace_back(std::forward<SecurityGroupVpcAssociationsT>(value));
    return *this;
  }
  ///@}
