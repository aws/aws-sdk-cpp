...
class UpdateSecurityGroupRuleDescriptionsEgressResponse {
 public:
  ...
  AWS_EC2_API UpdateSecurityGroupRuleDescriptionsEgressResponse& operator=(
  ...
  inline UpdateSecurityGroupRuleDescriptionsEgressResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UpdateSecurityGroupRuleDescriptionsEgressResponse& WithResponseMetadata(ResponseMetadataT&& value) {
