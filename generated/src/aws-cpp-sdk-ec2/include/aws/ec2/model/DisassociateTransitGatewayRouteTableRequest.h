...
namespace Model
{
  ...
  /**
   */
  class DisassociateTransitGatewayRouteTableRequest : public EC2Request
  {
  public:
    AWS_EC2_API DisassociateTransitGatewayRouteTableRequest() = default;
  ...
  public:
    ...
    template<typename TransitGatewayRouteTableIdT = Aws::String>
    DisassociateTransitGatewayRouteTableRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) { SetTransitGatewayRouteTableId(std::forward<TransitGatewayRouteTableIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    DisassociateTransitGatewayRouteTableRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
