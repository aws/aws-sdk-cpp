...
class DisassociateTransitGatewayRouteTableRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  DisassociateTransitGatewayRouteTableRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  DisassociateTransitGatewayRouteTableRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline DisassociateTransitGatewayRouteTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
