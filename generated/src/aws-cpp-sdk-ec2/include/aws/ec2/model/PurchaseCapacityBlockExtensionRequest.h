...
class PurchaseCapacityBlockExtensionRequest : public EC2Request {
 ...
 public:
  ...
  void SetCapacityBlockExtensionOfferingId(CapacityBlockExtensionOfferingIdT&& value) {
    ...
    m_capacityBlockExtensionOfferingId = std::forward<CapacityBlockExtensionOfferingIdT>(value);
  }
  template <typename CapacityBlockExtensionOfferingIdT = Aws::String>
  PurchaseCapacityBlockExtensionRequest& WithCapacityBlockExtensionOfferingId(CapacityBlockExtensionOfferingIdT&& value) {
    SetCapacityBlockExtensionOfferingId(std::forward<CapacityBlockExtensionOfferingIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CapacityReservationIdT = Aws::String>
  PurchaseCapacityBlockExtensionRequest& WithCapacityReservationId(CapacityReservationIdT&& value) {
  ...
  inline PurchaseCapacityBlockExtensionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
