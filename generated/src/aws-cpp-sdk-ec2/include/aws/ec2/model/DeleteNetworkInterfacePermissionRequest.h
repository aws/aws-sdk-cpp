...
class DeleteNetworkInterfacePermissionRequest : public EC2Request {
 ...
 public:
  ...
  void SetNetworkInterfacePermissionId(NetworkInterfacePermissionIdT&& value) {
    m_networkInterfacePermissionIdHasBeenSet = true;
    m_networkInterfacePermissionId = std::forward<NetworkInterfacePermissionIdT>(value);
  }
  template <typename NetworkInterfacePermissionIdT = Aws::String>
  DeleteNetworkInterfacePermissionRequest& WithNetworkInterfacePermissionId(NetworkInterfacePermissionIdT&& value) {
    SetNetworkInterfacePermissionId(std::forward<NetworkInterfacePermissionIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteNetworkInterfacePermissionRequest& WithForce(bool value) {
    SetForce(value);
    return *this;
  }
  ///@}
  ...
  inline DeleteNetworkInterfacePermissionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
