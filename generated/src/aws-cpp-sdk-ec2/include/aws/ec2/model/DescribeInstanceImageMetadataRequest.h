...
class DescribeInstanceImageMetadataRequest : public EC2Request {
 ...
 public:
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeInstanceImageMetadataRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeInstanceImageMetadataRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  DescribeInstanceImageMetadataRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  DescribeInstanceImageMetadataRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  inline DescribeInstanceImageMetadataRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceImageMetadataRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeInstanceImageMetadataRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
