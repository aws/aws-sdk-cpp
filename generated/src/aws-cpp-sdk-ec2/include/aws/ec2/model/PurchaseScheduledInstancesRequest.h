...
class PurchaseScheduledInstancesRequest : public EC2Request {
 ...
 public:
  ...
  inline PurchaseScheduledInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetPurchaseRequests(PurchaseRequestsT&& value) {
    m_purchaseRequestsHasBeenSet = true;
    m_purchaseRequests = std::forward<PurchaseRequestsT>(value);
  }
  template <typename PurchaseRequestsT = Aws::Vector<PurchaseRequest>>
  PurchaseScheduledInstancesRequest& WithPurchaseRequests(PurchaseRequestsT&& value) {
    SetPurchaseRequests(std::forward<PurchaseRequestsT>(value));
    return *this;
  }
  ...
  PurchaseScheduledInstancesRequest& AddPurchaseRequests(PurchaseRequestsT&& value) {
    m_purchaseRequestsHasBeenSet = true;
    m_purchaseRequests.emplace_back(std::forward<PurchaseRequestsT>(value));
    return *this;
  }
  ///@}
 private:
