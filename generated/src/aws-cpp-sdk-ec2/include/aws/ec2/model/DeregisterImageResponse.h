...
class DeregisterImageResponse {
 public:
  ...
  inline DeregisterImageResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  void SetDeleteSnapshotResults(DeleteSnapshotResultsT&& value) {
    ...
    m_deleteSnapshotResults = std::forward<DeleteSnapshotResultsT>(value);
  }
  template <typename DeleteSnapshotResultsT = Aws::Vector<DeleteSnapshotReturnCode>>
  DeregisterImageResponse& WithDeleteSnapshotResults(DeleteSnapshotResultsT&& value) {
    SetDeleteSnapshotResults(std::forward<DeleteSnapshotResultsT>(value));
    return *this;
  }
  ...
  DeregisterImageResponse& AddDeleteSnapshotResults(DeleteSnapshotResultsT&& value) {
    m_deleteSnapshotResultsHasBeenSet = true;
    m_deleteSnapshotResults.emplace_back(std::forward<DeleteSnapshotResultsT>(value));
    return *this;
  }
  ///@}
