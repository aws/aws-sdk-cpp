...
class ModifyPublicIpDnsNameOptionsResponse {
 public:
  ...
  inline void SetSuccessful(bool value) {
    m_successfulHasBeenSet = true;
    m_successful = value;
  }
  inline ModifyPublicIpDnsNameOptionsResponse& WithSuccessful(bool value) {
    SetSuccessful(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyPublicIpDnsNameOptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
