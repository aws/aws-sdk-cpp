 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ReservedCapacityFallbackOptionsRequest">AWS
 * API Reference</a></p>
 */
class ReservedCapacityFallbackOptionsRequest {
 public:
  AWS_EC2_API ReservedCapacityFallbackOptionsRequest() = default;
  AWS_EC2_API ReservedCapacityFallbackOptionsRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API ReservedCapacityFallbackOptionsRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename MarketTypesT = Aws::Vector<ReservedCapacityFallbackMarketType>>
  ReservedCapacityFallbackOptionsRequest& WithMarketTypes(MarketTypesT&& value) {
    SetMarketTypes(std::forward<MarketTypesT>(value));
    return *this;
  }
  inline ReservedCapacityFallbackOptionsRequest& AddMarketTypes(ReservedCapacityFallbackMarketType value) {
    m_marketTypesHasBeenSet = true;
