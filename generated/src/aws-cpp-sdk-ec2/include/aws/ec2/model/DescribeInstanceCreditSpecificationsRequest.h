...
class DescribeInstanceCreditSpecificationsRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeInstanceCreditSpecificationsRequest() = default;
 ...
 public:
  ...
  inline DescribeInstanceCreditSpecificationsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeInstanceCreditSpecificationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeInstanceCreditSpecificationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  DescribeInstanceCreditSpecificationsRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  DescribeInstanceCreditSpecificationsRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  inline DescribeInstanceCreditSpecificationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceCreditSpecificationsRequest& WithNextToken(NextTokenT&& value) {
