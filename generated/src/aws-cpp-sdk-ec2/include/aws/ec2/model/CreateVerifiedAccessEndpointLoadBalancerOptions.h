...
class CreateVerifiedAccessEndpointLoadBalancerOptions {
 public:
  ...
  inline CreateVerifiedAccessEndpointLoadBalancerOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline CreateVerifiedAccessEndpointLoadBalancerOptions& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename LoadBalancerArnT = Aws::String>
  CreateVerifiedAccessEndpointLoadBalancerOptions& WithLoadBalancerArn(LoadBalancerArnT&& value) {
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  CreateVerifiedAccessEndpointLoadBalancerOptions& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  CreateVerifiedAccessEndpointLoadBalancerOptions& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  template <typename PortRangesT = Aws::Vector<CreateVerifiedAccessEndpointPortRange>>
  CreateVerifiedAccessEndpointLoadBalancerOptions& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = CreateVerifiedAccessEndpointPortRange>
  CreateVerifiedAccessEndpointLoadBalancerOptions& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
