...
class ScheduledInstancesIamInstanceProfile {
 public:
  AWS_EC2_API ScheduledInstancesIamInstanceProfile() = default;
  ...
  template <typename ArnT = Aws::String>
  ScheduledInstancesIamInstanceProfile& WithArn(ArnT&& value) {
  ...
  template <typename NameT = Aws::String>
  ScheduledInstancesIamInstanceProfile& WithName(NameT&& value) {
