...
class DeleteClientVpnRouteRequest : public EC2Request {
 ...
 public:
  ...
  void SetTargetVpcSubnetId(TargetVpcSubnetIdT&& value) {
    m_targetVpcSubnetIdHasBeenSet = true;
    m_targetVpcSubnetId = std::forward<TargetVpcSubnetIdT>(value);
  }
  template <typename TargetVpcSubnetIdT = Aws::String>
  DeleteClientVpnRouteRequest& WithTargetVpcSubnetId(TargetVpcSubnetIdT&& value) {
    SetTargetVpcSubnetId(std::forward<TargetVpcSubnetIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteClientVpnRouteRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
