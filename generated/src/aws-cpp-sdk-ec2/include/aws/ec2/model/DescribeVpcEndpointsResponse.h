...
class DescribeVpcEndpointsResponse {
 public:
  ...
  template <typename VpcEndpointsT = Aws::Vector<VpcEndpoint>>
  DescribeVpcEndpointsResponse& WithVpcEndpoints(VpcEndpointsT&& value) {
    SetVpcEndpoints(std::forward<VpcEndpointsT>(value));
    return *this;
  }
  template <typename VpcEndpointsT = VpcEndpoint>
  DescribeVpcEndpointsResponse& AddVpcEndpoints(VpcEndpointsT&& value) {
    m_vpcEndpointsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcEndpointsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpcEndpointsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
