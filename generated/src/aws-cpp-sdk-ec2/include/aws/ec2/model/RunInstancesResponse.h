...
class RunInstancesResponse {
 public:
  ...
  template <typename ReservationIdT = Aws::String>
  RunInstancesResponse& WithReservationId(ReservationIdT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  RunInstancesResponse& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename RequesterIdT = Aws::String>
  RunInstancesResponse& WithRequesterId(RequesterIdT&& value) {
  ...
  template <typename GroupsT = Aws::Vector<GroupIdentifier>>
  RunInstancesResponse& WithGroups(GroupsT&& value) {
    SetGroups(std::forward<GroupsT>(value));
    return *this;
  }
  template <typename GroupsT = GroupIdentifier>
  RunInstancesResponse& AddGroups(GroupsT&& value) {
    m_groupsHasBeenSet = true;
  ...
  template <typename InstancesT = Aws::Vector<Instance>>
  RunInstancesResponse& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = Instance>
  RunInstancesResponse& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RunInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
