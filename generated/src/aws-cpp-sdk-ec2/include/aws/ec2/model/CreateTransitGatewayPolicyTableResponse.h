...
namespace Model
{
  ...
  public:
    ...
    template<typename TransitGatewayPolicyTableT = TransitGatewayPolicyTable>
    CreateTransitGatewayPolicyTableResponse& WithTransitGatewayPolicyTable(TransitGatewayPolicyTableT&& value) { SetTransitGatewayPolicyTable(std::forward<TransitGatewayPolicyTableT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateTransitGatewayPolicyTableResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
