...
class DescribeVolumesResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVolumesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename VolumesT = Aws::Vector<Volume>>
  DescribeVolumesResponse& WithVolumes(VolumesT&& value) {
    SetVolumes(std::forward<VolumesT>(value));
    return *this;
  }
  template <typename VolumesT = Volume>
  DescribeVolumesResponse& AddVolumes(VolumesT&& value) {
    m_volumesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVolumesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
