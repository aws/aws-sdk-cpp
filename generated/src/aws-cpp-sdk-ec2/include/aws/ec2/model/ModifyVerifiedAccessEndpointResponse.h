...
class ModifyVerifiedAccessEndpointResponse {
 public:
  ...
  template <typename VerifiedAccessEndpointT = VerifiedAccessEndpoint>
  ModifyVerifiedAccessEndpointResponse& WithVerifiedAccessEndpoint(VerifiedAccessEndpointT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVerifiedAccessEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
