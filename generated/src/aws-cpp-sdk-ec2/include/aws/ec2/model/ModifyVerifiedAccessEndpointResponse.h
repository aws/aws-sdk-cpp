...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyVerifiedAccessEndpointResponse() = default;
    ...
    template<typename VerifiedAccessEndpointT = VerifiedAccessEndpoint>
    ModifyVerifiedAccessEndpointResponse& WithVerifiedAccessEndpoint(VerifiedAccessEndpointT&& value) { SetVerifiedAccessEndpoint(std::forward<VerifiedAccessEndpointT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyVerifiedAccessEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
