...
class StartNetworkInsightsAccessScopeAnalysisRequest : public EC2Request {
 ...
 public:
  ...
  void SetNetworkInsightsAccessScopeId(NetworkInsightsAccessScopeIdT&& value) {
    ...
    m_networkInsightsAccessScopeId = std::forward<NetworkInsightsAccessScopeIdT>(value);
  }
  template <typename NetworkInsightsAccessScopeIdT = Aws::String>
  StartNetworkInsightsAccessScopeAnalysisRequest& WithNetworkInsightsAccessScopeId(NetworkInsightsAccessScopeIdT&& value) {
    SetNetworkInsightsAccessScopeId(std::forward<NetworkInsightsAccessScopeIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline StartNetworkInsightsAccessScopeAnalysisRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  StartNetworkInsightsAccessScopeAnalysisRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  StartNetworkInsightsAccessScopeAnalysisRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  StartNetworkInsightsAccessScopeAnalysisRequest& WithClientToken(ClientTokenT&& value) {
