...
class CancelImportTaskRequest : public EC2Request {
 ...
 public:
  ...
  void SetCancelReason(CancelReasonT&& value) {
    m_cancelReasonHasBeenSet = true;
    m_cancelReason = std::forward<CancelReasonT>(value);
  }
  template <typename CancelReasonT = Aws::String>
  CancelImportTaskRequest& WithCancelReason(CancelReasonT&& value) {
    SetCancelReason(std::forward<CancelReasonT>(value));
    return *this;
  }
  ///@}
  ...
  inline CancelImportTaskRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ImportTaskIdT = Aws::String>
  CancelImportTaskRequest& WithImportTaskId(ImportTaskIdT&& value) {
