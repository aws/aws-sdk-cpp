...
class CreateTransitGatewayVpcAttachmentRequestOptions {
 public:
  ...
  inline CreateTransitGatewayVpcAttachmentRequestOptions& WithDnsSupport(DnsSupportValue value) {
    SetDnsSupport(value);
    return *this;
  }
  ///@}
  ...
  inline CreateTransitGatewayVpcAttachmentRequestOptions& WithSecurityGroupReferencingSupport(SecurityGroupReferencingSupportValue value) {
  ...
  inline void SetIpv6Support(Ipv6SupportValue value) {
    m_ipv6SupportHasBeenSet = true;
    m_ipv6Support = value;
  }
  inline CreateTransitGatewayVpcAttachmentRequestOptions& WithIpv6Support(Ipv6SupportValue value) {
    SetIpv6Support(value);
    return *this;
  }
  ///@}
  ...
  inline void SetApplianceModeSupport(ApplianceModeSupportValue value) {
    m_applianceModeSupportHasBeenSet = true;
    m_applianceModeSupport = value;
  }
  inline CreateTransitGatewayVpcAttachmentRequestOptions& WithApplianceModeSupport(ApplianceModeSupportValue value) {
    SetApplianceModeSupport(value);
    return *this;
  }
  ///@}
 private:
