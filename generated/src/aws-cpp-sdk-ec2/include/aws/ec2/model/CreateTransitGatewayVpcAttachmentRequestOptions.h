...
namespace Model
{
  ...
  public:
     ...
     * feature.</p> <p>If you don't enable or disable SecurityGroupReferencingSupport
     * in the request, the attachment will inherit the security group referencing
     * support setting on the transit gateway.</p>
     */
