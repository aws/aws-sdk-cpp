...
namespace Model
{
  ...
  public:
     ...
     * by default.</p> <p>If you don't enable or disable
     * SecurityGroupReferencingSupport in the request, the attachment will inherit the
     * security group referencing support setting on the transit gateway.</p> <p>For
     * more information about security group referencing, see <a
