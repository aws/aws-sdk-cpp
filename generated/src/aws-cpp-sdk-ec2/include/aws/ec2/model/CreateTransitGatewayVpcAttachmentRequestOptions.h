...
namespace Model
{
  ...
  public:
     ...
     * default and there are no additional costs to use this feature.</p> <p>If you
     * don't enable or disable SecurityGroupReferencingSupport in the request, the
     * attachment will inherit the security group referencing support setting on the
     * transit gateway.</p> <p>For important information about this feature, see <a
