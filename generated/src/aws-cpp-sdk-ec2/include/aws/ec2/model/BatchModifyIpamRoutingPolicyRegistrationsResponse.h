...
namespace EC2 {
namespace Model {
class BatchModifyIpamRoutingPolicyRegistrationsResponse {
 public:
  AWS_EC2_API BatchModifyIpamRoutingPolicyRegistrationsResponse() = default;
  AWS_EC2_API BatchModifyIpamRoutingPolicyRegistrationsResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API BatchModifyIpamRoutingPolicyRegistrationsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);

  ///@{
  /**
   * <p>Information about the routing policy registration delta created by this batch
   * operation.</p>
   */
  ...
  template <typename IpamRoutingPolicyRegistrationDeltaT = IpamRoutingPolicyRegistrationDelta>
  BatchModifyIpamRoutingPolicyRegistrationsResponse& WithIpamRoutingPolicyRegistrationDelta(IpamRoutingPolicyRegistrationDeltaT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  BatchModifyIpamRoutingPolicyRegistrationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
