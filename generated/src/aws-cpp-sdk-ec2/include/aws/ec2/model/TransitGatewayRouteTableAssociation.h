...
class TransitGatewayRouteTableAssociation {
 public:
  ...
  inline TransitGatewayRouteTableAssociation& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  inline TransitGatewayRouteTableAssociation& WithState(TransitGatewayAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
