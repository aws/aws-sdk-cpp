...
class ListImagesInRecycleBinRequest : public EC2Request {
 public:
  AWS_EC2_API ListImagesInRecycleBinRequest() = default;
 ...
 public:
  ...
  template <typename ImageIdsT = Aws::Vector<Aws::String>>
  ListImagesInRecycleBinRequest& WithImageIds(ImageIdsT&& value) {
    SetImageIds(std::forward<ImageIdsT>(value));
    return *this;
  }
  template <typename ImageIdsT = Aws::String>
  ListImagesInRecycleBinRequest& AddImageIds(ImageIdsT&& value) {
    m_imageIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListImagesInRecycleBinRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline ListImagesInRecycleBinRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline ListImagesInRecycleBinRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
