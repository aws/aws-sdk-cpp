...
class DescribeNetworkInsightsAnalysesResponse {
 public:
  ...
  void SetNetworkInsightsAnalyses(NetworkInsightsAnalysesT&& value) {
    m_networkInsightsAnalysesHasBeenSet = true;
    m_networkInsightsAnalyses = std::forward<NetworkInsightsAnalysesT>(value);
  }
  template <typename NetworkInsightsAnalysesT = Aws::Vector<NetworkInsightsAnalysis>>
  DescribeNetworkInsightsAnalysesResponse& WithNetworkInsightsAnalyses(NetworkInsightsAnalysesT&& value) {
    SetNetworkInsightsAnalyses(std::forward<NetworkInsightsAnalysesT>(value));
    return *this;
  }
  template <typename NetworkInsightsAnalysesT = NetworkInsightsAnalysis>
  DescribeNetworkInsightsAnalysesResponse& AddNetworkInsightsAnalyses(NetworkInsightsAnalysesT&& value) {
    m_networkInsightsAnalysesHasBeenSet = true;
    m_networkInsightsAnalyses.emplace_back(std::forward<NetworkInsightsAnalysesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkInsightsAnalysesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeNetworkInsightsAnalysesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
