...
class GetInstanceTpmEkPubResponse {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetInstanceTpmEkPubResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  inline GetInstanceTpmEkPubResponse& WithKeyType(EkPubKeyType value) {
    SetKeyType(value);
    return *this;
  }
  ///@}
  ...
  inline GetInstanceTpmEkPubResponse& WithKeyFormat(EkPubKeyFormat value) {
    SetKeyFormat(value);
    return *this;
  }
  ///@}
  ...
  template <typename KeyValueT = Aws::String>
  GetInstanceTpmEkPubResponse& WithKeyValue(KeyValueT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetInstanceTpmEkPubResponse& WithResponseMetadata(ResponseMetadataT&& value) {
