...
class CreateVerifiedAccessEndpointResponse {
 public:
  ...
  template <typename VerifiedAccessEndpointT = VerifiedAccessEndpoint>
  CreateVerifiedAccessEndpointResponse& WithVerifiedAccessEndpoint(VerifiedAccessEndpointT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateVerifiedAccessEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
