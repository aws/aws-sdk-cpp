...
class CreateSnapshotResponse {
 public:
  ...
  void SetOwnerAlias(OwnerAliasT&& value) {
    ...
    m_ownerAlias = std::forward<OwnerAliasT>(value);
  }
  template <typename OwnerAliasT = Aws::String>
  CreateSnapshotResponse& WithOwnerAlias(OwnerAliasT&& value) {
    SetOwnerAlias(std::forward<OwnerAliasT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotResponse& WithStorageTier(StorageTier value) {
  ...
  void SetRestoreExpiryTime(RestoreExpiryTimeT&& value) {
    ...
    m_restoreExpiryTime = std::forward<RestoreExpiryTimeT>(value);
  }
  template <typename RestoreExpiryTimeT = Aws::Utils::DateTime>
  CreateSnapshotResponse& WithRestoreExpiryTime(RestoreExpiryTimeT&& value) {
    SetRestoreExpiryTime(std::forward<RestoreExpiryTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotResponse& WithSseType(SSEType value) {
    SetSseType(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTransferType(TransferType value) {
    m_transferTypeHasBeenSet = true;
    m_transferType = value;
  }
  inline CreateSnapshotResponse& WithTransferType(TransferType value) {
  ...
  inline void SetCompletionDurationMinutes(int value) {
    m_completionDurationMinutesHasBeenSet = true;
    m_completionDurationMinutes = value;
  }
  inline CreateSnapshotResponse& WithCompletionDurationMinutes(int value) {
    SetCompletionDurationMinutes(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotResponse& WithFullSnapshotSizeInBytes(long long value) {
  ...
  inline CreateSnapshotResponse& WithState(SnapshotState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotResponse& WithVolumeSize(int value) {
    SetVolumeSize(value);
    return *this;
  }
  ///@}
  ...
  inline CreateSnapshotResponse& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  void SetDataEncryptionKeyId(DataEncryptionKeyIdT&& value) {
    ...
    m_dataEncryptionKeyId = std::forward<DataEncryptionKeyIdT>(value);
  }
  template <typename DataEncryptionKeyIdT = Aws::String>
  CreateSnapshotResponse& WithDataEncryptionKeyId(DataEncryptionKeyIdT&& value) {
    SetDataEncryptionKeyId(std::forward<DataEncryptionKeyIdT>(value));
    return *this;
  }
  ///@}
