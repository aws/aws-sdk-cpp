...
class CreateVpcPeeringConnectionRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateVpcPeeringConnectionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetPeerOwnerId(PeerOwnerIdT&& value) {
    m_peerOwnerIdHasBeenSet = true;
    m_peerOwnerId = std::forward<PeerOwnerIdT>(value);
  }
  template <typename PeerOwnerIdT = Aws::String>
  CreateVpcPeeringConnectionRequest& WithPeerOwnerId(PeerOwnerIdT&& value) {
    SetPeerOwnerId(std::forward<PeerOwnerIdT>(value));
    return *this;
  }
  ///@}
 private:
