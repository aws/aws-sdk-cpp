...
namespace Model
{
  ...
  public:
    ...
    template<typename TransitGatewayRouteTableIdT = Aws::String>
    TransitGatewayAssociation& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) { SetTransitGatewayRouteTableId(std::forward<TransitGatewayRouteTableIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayAttachmentIdT = Aws::String>
    TransitGatewayAssociation& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) { SetTransitGatewayAttachmentId(std::forward<TransitGatewayAttachmentIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ResourceIdT = Aws::String>
    TransitGatewayAssociation& WithResourceId(ResourceIdT&& value) { SetResourceId(std::forward<ResourceIdT>(value)); return *this;}
    ///@}
    ...
    inline TransitGatewayAssociation& WithResourceType(TransitGatewayAttachmentResourceType value) { SetResourceType(value); return *this;}
    ///@}
    ...
    inline TransitGatewayAssociation& WithState(TransitGatewayAssociationState value) { SetState(value); return *this;}
    ///@}
  private:
