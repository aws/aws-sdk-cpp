...
class TransitGatewayAssociation {
 public:
  ...
  inline TransitGatewayAssociation& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  inline TransitGatewayAssociation& WithState(TransitGatewayAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
