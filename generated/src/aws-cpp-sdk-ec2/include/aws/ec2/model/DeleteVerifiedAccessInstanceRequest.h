...
class DeleteVerifiedAccessInstanceRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  DeleteVerifiedAccessInstanceRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  inline DeleteVerifiedAccessInstanceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteVerifiedAccessInstanceRequest& WithClientToken(ClientTokenT&& value) {
