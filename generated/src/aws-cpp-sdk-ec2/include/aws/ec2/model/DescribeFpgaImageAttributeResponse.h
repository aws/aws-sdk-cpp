...
class DescribeFpgaImageAttributeResponse {
 public:
  AWS_EC2_API DescribeFpgaImageAttributeResponse() = default;
  ...
  template <typename FpgaImageAttributeT = FpgaImageAttribute>
  DescribeFpgaImageAttributeResponse& WithFpgaImageAttribute(FpgaImageAttributeT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFpgaImageAttributeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
