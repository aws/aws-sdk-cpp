...
class CreateNatGatewayRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateNatGatewayRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline CreateNatGatewayRequest& WithConnectivityType(ConnectivityType value) {
  ...
  void SetSecondaryAllocationIds(SecondaryAllocationIdsT&& value) {
    m_secondaryAllocationIdsHasBeenSet = true;
    m_secondaryAllocationIds = std::forward<SecondaryAllocationIdsT>(value);
  }
  template <typename SecondaryAllocationIdsT = Aws::Vector<Aws::String>>
  CreateNatGatewayRequest& WithSecondaryAllocationIds(SecondaryAllocationIdsT&& value) {
    SetSecondaryAllocationIds(std::forward<SecondaryAllocationIdsT>(value));
    return *this;
  }
  ...
  CreateNatGatewayRequest& AddSecondaryAllocationIds(SecondaryAllocationIdsT&& value) {
    m_secondaryAllocationIdsHasBeenSet = true;
    m_secondaryAllocationIds.emplace_back(std::forward<SecondaryAllocationIdsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSecondaryPrivateIpAddresses(SecondaryPrivateIpAddressesT&& value) {
    m_secondaryPrivateIpAddressesHasBeenSet = true;
    m_secondaryPrivateIpAddresses = std::forward<SecondaryPrivateIpAddressesT>(value);
  }
  template <typename SecondaryPrivateIpAddressesT = Aws::Vector<Aws::String>>
  CreateNatGatewayRequest& WithSecondaryPrivateIpAddresses(SecondaryPrivateIpAddressesT&& value) {
    SetSecondaryPrivateIpAddresses(std::forward<SecondaryPrivateIpAddressesT>(value));
    return *this;
  }
  ...
  CreateNatGatewayRequest& AddSecondaryPrivateIpAddresses(SecondaryPrivateIpAddressesT&& value) {
    m_secondaryPrivateIpAddressesHasBeenSet = true;
    m_secondaryPrivateIpAddresses.emplace_back(std::forward<SecondaryPrivateIpAddressesT>(value));
    return *this;
  }
  ///@}
  ...
  inline CreateNatGatewayRequest& WithSecondaryPrivateIpAddressCount(int value) {
