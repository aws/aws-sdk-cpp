...
class DescribeMacModificationTasksResponse {
 public:
  ...
  void SetMacModificationTasks(MacModificationTasksT&& value) {
    m_macModificationTasksHasBeenSet = true;
    m_macModificationTasks = std::forward<MacModificationTasksT>(value);
  }
  template <typename MacModificationTasksT = Aws::Vector<MacModificationTask>>
  DescribeMacModificationTasksResponse& WithMacModificationTasks(MacModificationTasksT&& value) {
    SetMacModificationTasks(std::forward<MacModificationTasksT>(value));
    return *this;
  }
  template <typename MacModificationTasksT = MacModificationTask>
  DescribeMacModificationTasksResponse& AddMacModificationTasks(MacModificationTasksT&& value) {
    m_macModificationTasksHasBeenSet = true;
    m_macModificationTasks.emplace_back(std::forward<MacModificationTasksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMacModificationTasksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeMacModificationTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
