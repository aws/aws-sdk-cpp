...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeleteVpcPeeringConnectionResponse();
    ...
    inline DeleteVpcPeeringConnectionResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
