...
class ModifyVpnTunnelCertificateResponse {
 public:
  ...
  template <typename VpnConnectionT = VpnConnection>
  ModifyVpnTunnelCertificateResponse& WithVpnConnection(VpnConnectionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVpnTunnelCertificateResponse& WithResponseMetadata(ResponseMetadataT&& value) {
