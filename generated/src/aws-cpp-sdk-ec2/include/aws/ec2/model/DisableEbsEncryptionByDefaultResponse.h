...
class DisableEbsEncryptionByDefaultResponse {
 public:
  ...
  inline DisableEbsEncryptionByDefaultResponse& WithEbsEncryptionByDefault(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableEbsEncryptionByDefaultResponse& WithResponseMetadata(ResponseMetadataT&& value) {
