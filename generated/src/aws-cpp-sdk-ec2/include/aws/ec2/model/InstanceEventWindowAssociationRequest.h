...
class InstanceEventWindowAssociationRequest {
 public:
  ...
  template <typename InstanceIdsT = Aws::Vector<Aws::String>>
  InstanceEventWindowAssociationRequest& WithInstanceIds(InstanceIdsT&& value) {
    SetInstanceIds(std::forward<InstanceIdsT>(value));
    return *this;
  }
  template <typename InstanceIdsT = Aws::String>
  InstanceEventWindowAssociationRequest& AddInstanceIds(InstanceIdsT&& value) {
    m_instanceIdsHasBeenSet = true;
  ...
  template <typename InstanceTagsT = Aws::Vector<Tag>>
  InstanceEventWindowAssociationRequest& WithInstanceTags(InstanceTagsT&& value) {
    SetInstanceTags(std::forward<InstanceTagsT>(value));
    return *this;
  }
  template <typename InstanceTagsT = Tag>
  InstanceEventWindowAssociationRequest& AddInstanceTags(InstanceTagsT&& value) {
    m_instanceTagsHasBeenSet = true;
  ...
  template <typename DedicatedHostIdsT = Aws::Vector<Aws::String>>
  InstanceEventWindowAssociationRequest& WithDedicatedHostIds(DedicatedHostIdsT&& value) {
    SetDedicatedHostIds(std::forward<DedicatedHostIdsT>(value));
    return *this;
  }
  template <typename DedicatedHostIdsT = Aws::String>
  InstanceEventWindowAssociationRequest& AddDedicatedHostIds(DedicatedHostIdsT&& value) {
    m_dedicatedHostIdsHasBeenSet = true;
