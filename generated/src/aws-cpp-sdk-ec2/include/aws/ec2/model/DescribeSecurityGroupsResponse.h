...
class DescribeSecurityGroupsResponse {
 public:
  AWS_EC2_API DescribeSecurityGroupsResponse() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeSecurityGroupsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename SecurityGroupsT = Aws::Vector<SecurityGroup>>
  DescribeSecurityGroupsResponse& WithSecurityGroups(SecurityGroupsT&& value) {
    SetSecurityGroups(std::forward<SecurityGroupsT>(value));
    return *this;
  }
  template <typename SecurityGroupsT = SecurityGroup>
  DescribeSecurityGroupsResponse& AddSecurityGroups(SecurityGroupsT&& value) {
    m_securityGroupsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeSecurityGroupsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
