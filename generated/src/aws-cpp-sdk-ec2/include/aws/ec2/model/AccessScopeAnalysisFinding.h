...
class AccessScopeAnalysisFinding {
 public:
  ...
  void SetFindingComponents(FindingComponentsT&& value) {
    ...
    m_findingComponents = std::forward<FindingComponentsT>(value);
  }
  template <typename FindingComponentsT = Aws::Vector<PathComponent>>
  AccessScopeAnalysisFinding& WithFindingComponents(FindingComponentsT&& value) {
    SetFindingComponents(std::forward<FindingComponentsT>(value));
    return *this;
  }
  ...
  AccessScopeAnalysisFinding& AddFindingComponents(FindingComponentsT&& value) {
    m_findingComponentsHasBeenSet = true;
    m_findingComponents.emplace_back(std::forward<FindingComponentsT>(value));
    return *this;
  }
  ///@}
 private:
