...
class ReservationValue {
 public:
  ...
  void SetHourlyPrice(HourlyPriceT&& value) {
    ...
    m_hourlyPrice = std::forward<HourlyPriceT>(value);
  }
  template <typename HourlyPriceT = Aws::String>
  ReservationValue& WithHourlyPrice(HourlyPriceT&& value) {
    SetHourlyPrice(std::forward<HourlyPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemainingTotalValue(RemainingTotalValueT&& value) {
    ...
    m_remainingTotalValue = std::forward<RemainingTotalValueT>(value);
  }
  template <typename RemainingTotalValueT = Aws::String>
  ReservationValue& WithRemainingTotalValue(RemainingTotalValueT&& value) {
    SetRemainingTotalValue(std::forward<RemainingTotalValueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemainingUpfrontValue(RemainingUpfrontValueT&& value) {
    ...
    m_remainingUpfrontValue = std::forward<RemainingUpfrontValueT>(value);
  }
  template <typename RemainingUpfrontValueT = Aws::String>
  ReservationValue& WithRemainingUpfrontValue(RemainingUpfrontValueT&& value) {
    SetRemainingUpfrontValue(std::forward<RemainingUpfrontValueT>(value));
    return *this;
  }
  ///@}
 private:
