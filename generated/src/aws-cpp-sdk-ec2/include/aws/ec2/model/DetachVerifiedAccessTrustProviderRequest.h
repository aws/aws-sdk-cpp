...
class DetachVerifiedAccessTrustProviderRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  DetachVerifiedAccessTrustProviderRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename VerifiedAccessTrustProviderIdT = Aws::String>
  DetachVerifiedAccessTrustProviderRequest& WithVerifiedAccessTrustProviderId(VerifiedAccessTrustProviderIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DetachVerifiedAccessTrustProviderRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline DetachVerifiedAccessTrustProviderRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
