...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DetachVerifiedAccessTrustProviderRequest();
  ...
  public:
     ...
     * Idempotency</a>.</p>
     */
    inline DetachVerifiedAccessTrustProviderRequest& WithClientToken(const Aws::String& value) { SetClientToken(value); return *this;}
     ...
     * Idempotency</a>.</p>
     */
    inline DetachVerifiedAccessTrustProviderRequest& WithClientToken(Aws::String&& value) { SetClientToken(std::move(value)); return *this;}
     ...
     * Idempotency</a>.</p>
     */
    inline DetachVerifiedAccessTrustProviderRequest& WithClientToken(const char* value) { SetClientToken(value); return *this;}
