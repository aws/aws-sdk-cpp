...
class AssociateEnclaveCertificateIamRoleRequest : public EC2Request {
 ...
 public:
  ...
  template <typename CertificateArnT = Aws::String>
  AssociateEnclaveCertificateIamRoleRequest& WithCertificateArn(CertificateArnT&& value) {
  ...
  template <typename RoleArnT = Aws::String>
  AssociateEnclaveCertificateIamRoleRequest& WithRoleArn(RoleArnT&& value) {
  ...
  inline AssociateEnclaveCertificateIamRoleRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
