...
class VerifiedAccessLogs {
 public:
  ...
  template <typename S3T = VerifiedAccessLogS3Destination>
  VerifiedAccessLogs& WithS3(S3T&& value) {
  ...
  template <typename CloudWatchLogsT = VerifiedAccessLogCloudWatchLogsDestination>
  VerifiedAccessLogs& WithCloudWatchLogs(CloudWatchLogsT&& value) {
  ...
  void SetKinesisDataFirehose(KinesisDataFirehoseT&& value) {
    m_kinesisDataFirehoseHasBeenSet = true;
    m_kinesisDataFirehose = std::forward<KinesisDataFirehoseT>(value);
  }
  template <typename KinesisDataFirehoseT = VerifiedAccessLogKinesisDataFirehoseDestination>
  VerifiedAccessLogs& WithKinesisDataFirehose(KinesisDataFirehoseT&& value) {
    SetKinesisDataFirehose(std::forward<KinesisDataFirehoseT>(value));
    return *this;
  }
  ///@}
  ...
  void SetLogVersion(LogVersionT&& value) {
    m_logVersionHasBeenSet = true;
    m_logVersion = std::forward<LogVersionT>(value);
  }
  template <typename LogVersionT = Aws::String>
  VerifiedAccessLogs& WithLogVersion(LogVersionT&& value) {
    SetLogVersion(std::forward<LogVersionT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludeTrustContext(bool value) {
    m_includeTrustContextHasBeenSet = true;
    m_includeTrustContext = value;
  }
  inline VerifiedAccessLogs& WithIncludeTrustContext(bool value) {
    SetIncludeTrustContext(value);
    return *this;
  }
  ///@}
 private:
