...
class GetSpotPlacementScoresResponse {
 public:
  ...
  void SetSpotPlacementScores(SpotPlacementScoresT&& value) {
    m_spotPlacementScoresHasBeenSet = true;
    m_spotPlacementScores = std::forward<SpotPlacementScoresT>(value);
  }
  template <typename SpotPlacementScoresT = Aws::Vector<SpotPlacementScore>>
  GetSpotPlacementScoresResponse& WithSpotPlacementScores(SpotPlacementScoresT&& value) {
    SetSpotPlacementScores(std::forward<SpotPlacementScoresT>(value));
    return *this;
  }
  template <typename SpotPlacementScoresT = SpotPlacementScore>
  GetSpotPlacementScoresResponse& AddSpotPlacementScores(SpotPlacementScoresT&& value) {
    m_spotPlacementScoresHasBeenSet = true;
    m_spotPlacementScores.emplace_back(std::forward<SpotPlacementScoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSpotPlacementScoresResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetSpotPlacementScoresResponse& WithResponseMetadata(ResponseMetadataT&& value) {
