...
namespace Model
{
  ...
  public:
    ...
    template<typename GroupByT = Aws::Vector<GroupBy>>
    GetCapacityManagerMetricDimensionsRequest& WithGroupBy(GroupByT&& value) { SetGroupBy(std::forward<GroupByT>(value)); return *this;}
    inline GetCapacityManagerMetricDimensionsRequest& AddGroupBy(GroupBy value) { m_groupByHasBeenSet = true; m_groupBy.push_back(value); return *this; }
    ///@}
    ...
    template<typename FilterByT = Aws::Vector<CapacityManagerCondition>>
    GetCapacityManagerMetricDimensionsRequest& WithFilterBy(FilterByT&& value) { SetFilterBy(std::forward<FilterByT>(value)); return *this;}
    template<typename FilterByT = CapacityManagerCondition>
    GetCapacityManagerMetricDimensionsRequest& AddFilterBy(FilterByT&& value) { m_filterByHasBeenSet = true; m_filterBy.emplace_back(std::forward<FilterByT>(value)); return *this; }
    ///@}
    ...
    template<typename StartTimeT = Aws::Utils::DateTime>
    GetCapacityManagerMetricDimensionsRequest& WithStartTime(StartTimeT&& value) { SetStartTime(std::forward<StartTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename EndTimeT = Aws::Utils::DateTime>
    GetCapacityManagerMetricDimensionsRequest& WithEndTime(EndTimeT&& value) { SetEndTime(std::forward<EndTimeT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricNamesT = Aws::Vector<Metric>>
    GetCapacityManagerMetricDimensionsRequest& WithMetricNames(MetricNamesT&& value) { SetMetricNames(std::forward<MetricNamesT>(value)); return *this;}
    inline GetCapacityManagerMetricDimensionsRequest& AddMetricNames(Metric value) { m_metricNamesHasBeenSet = true; m_metricNames.push_back(value); return *this; }
    ///@}
    ...
    inline GetCapacityManagerMetricDimensionsRequest& WithMaxResults(int value) { SetMaxResults(value); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetCapacityManagerMetricDimensionsRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    inline GetCapacityManagerMetricDimensionsRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
  private:
