...
class MacModificationTask {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  MacModificationTask& WithInstanceId(InstanceIdT&& value) {
  ...
  void SetMacModificationTaskId(MacModificationTaskIdT&& value) {
    m_macModificationTaskIdHasBeenSet = true;
    m_macModificationTaskId = std::forward<MacModificationTaskIdT>(value);
  }
  template <typename MacModificationTaskIdT = Aws::String>
  MacModificationTask& WithMacModificationTaskId(MacModificationTaskIdT&& value) {
    SetMacModificationTaskId(std::forward<MacModificationTaskIdT>(value));
    return *this;
  }
  ///@}
   ...
   */
  inline const MacSystemIntegrityProtectionConfiguration& GetMacSystemIntegrityProtectionConfig() const {
    return m_macSystemIntegrityProtectionConfig;
  }
  ...
  void SetMacSystemIntegrityProtectionConfig(MacSystemIntegrityProtectionConfigT&& value) {
    m_macSystemIntegrityProtectionConfigHasBeenSet = true;
    m_macSystemIntegrityProtectionConfig = std::forward<MacSystemIntegrityProtectionConfigT>(value);
  }
  template <typename MacSystemIntegrityProtectionConfigT = MacSystemIntegrityProtectionConfiguration>
  MacModificationTask& WithMacSystemIntegrityProtectionConfig(MacSystemIntegrityProtectionConfigT&& value) {
    SetMacSystemIntegrityProtectionConfig(std::forward<MacSystemIntegrityProtectionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename StartTimeT = Aws::Utils::DateTime>
  MacModificationTask& WithStartTime(StartTimeT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  MacModificationTask& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  MacModificationTask& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  inline void SetTaskState(MacModificationTaskState value) {
    m_taskStateHasBeenSet = true;
    m_taskState = value;
  }
  inline MacModificationTask& WithTaskState(MacModificationTaskState value) {
    SetTaskState(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTaskType(MacModificationTaskType value) {
    m_taskTypeHasBeenSet = true;
    m_taskType = value;
  }
  inline MacModificationTask& WithTaskType(MacModificationTaskType value) {
    SetTaskType(value);
    return *this;
  }
  ///@}
