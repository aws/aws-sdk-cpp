...
class ModifyTransitGatewayVpcAttachmentResponse {
 public:
  ...
  template <typename TransitGatewayVpcAttachmentT = TransitGatewayVpcAttachment>
  ModifyTransitGatewayVpcAttachmentResponse& WithTransitGatewayVpcAttachment(TransitGatewayVpcAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyTransitGatewayVpcAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
