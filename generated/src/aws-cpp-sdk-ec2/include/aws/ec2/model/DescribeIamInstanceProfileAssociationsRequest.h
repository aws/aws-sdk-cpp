...
class DescribeIamInstanceProfileAssociationsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename AssociationIdsT = Aws::Vector<Aws::String>>
  DescribeIamInstanceProfileAssociationsRequest& WithAssociationIds(AssociationIdsT&& value) {
    SetAssociationIds(std::forward<AssociationIdsT>(value));
    return *this;
  }
  template <typename AssociationIdsT = Aws::String>
  DescribeIamInstanceProfileAssociationsRequest& AddAssociationIds(AssociationIdsT&& value) {
    m_associationIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeIamInstanceProfileAssociationsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeIamInstanceProfileAssociationsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeIamInstanceProfileAssociationsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIamInstanceProfileAssociationsRequest& WithNextToken(NextTokenT&& value) {
