...
class FleetLaunchTemplateOverridesRequest {
 public:
  ...
  inline FleetLaunchTemplateOverridesRequest& WithInstanceType(InstanceType value) {
  ...
  template <typename MaxPriceT = Aws::String>
  FleetLaunchTemplateOverridesRequest& WithMaxPrice(MaxPriceT&& value) {
  ...
  template <typename SubnetIdT = Aws::String>
  FleetLaunchTemplateOverridesRequest& WithSubnetId(SubnetIdT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  FleetLaunchTemplateOverridesRequest& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  inline void SetWeightedCapacity(double value) {
    m_weightedCapacityHasBeenSet = true;
    m_weightedCapacity = value;
  }
  inline FleetLaunchTemplateOverridesRequest& WithWeightedCapacity(double value) {
    SetWeightedCapacity(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPriority(double value) {
    m_priorityHasBeenSet = true;
    m_priority = value;
  }
  inline FleetLaunchTemplateOverridesRequest& WithPriority(double value) {
    SetPriority(value);
    return *this;
  }
  ///@}
  ...
  template <typename PlacementT = Placement>
  FleetLaunchTemplateOverridesRequest& WithPlacement(PlacementT&& value) {
  ...
  template <typename BlockDeviceMappingsT = Aws::Vector<FleetBlockDeviceMappingRequest>>
  FleetLaunchTemplateOverridesRequest& WithBlockDeviceMappings(BlockDeviceMappingsT&& value) {
  ...
  template <typename InstanceRequirementsT = InstanceRequirementsRequest>
  FleetLaunchTemplateOverridesRequest& WithInstanceRequirements(InstanceRequirementsT&& value) {
  ...
  template <typename ImageIdT = Aws::String>
  FleetLaunchTemplateOverridesRequest& WithImageId(ImageIdT&& value) {
