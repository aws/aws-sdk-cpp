...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API RestoreImageFromRecycleBinResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RestoreImageFromRecycleBinResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
