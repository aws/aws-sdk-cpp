...
class EnableIpamOrganizationAdminAccountResponse {
 public:
  ...
  AWS_EC2_API EnableIpamOrganizationAdminAccountResponse& operator=(
  ...
  inline EnableIpamOrganizationAdminAccountResponse& WithSuccess(bool value) {
    SetSuccess(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableIpamOrganizationAdminAccountResponse& WithResponseMetadata(ResponseMetadataT&& value) {
