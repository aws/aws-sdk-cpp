...
namespace Model
{
  ...
  public:
    ...
    template<typename DimensionT = CapacityManagerDimension>
    MetricDataResponse& WithDimension(DimensionT&& value) { SetDimension(std::forward<DimensionT>(value)); return *this;}
    ///@}
    ...
    template<typename TimestampT = Aws::Utils::DateTime>
    MetricDataResponse& WithTimestamp(TimestampT&& value) { SetTimestamp(std::forward<TimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename MetricValuesT = Aws::Vector<MetricValue>>
    MetricDataResponse& WithMetricValues(MetricValuesT&& value) { SetMetricValues(std::forward<MetricValuesT>(value)); return *this;}
    template<typename MetricValuesT = MetricValue>
    MetricDataResponse& AddMetricValues(MetricValuesT&& value) { m_metricValuesHasBeenSet = true; m_metricValues.emplace_back(std::forward<MetricValuesT>(value)); return *this; }
    ///@}
  private:
