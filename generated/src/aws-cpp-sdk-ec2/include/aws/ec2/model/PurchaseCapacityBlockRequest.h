...
class PurchaseCapacityBlockRequest : public EC2Request {
 ...
 public:
  ...
  inline PurchaseCapacityBlockRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetCapacityBlockOfferingId(CapacityBlockOfferingIdT&& value) {
    ...
    m_capacityBlockOfferingId = std::forward<CapacityBlockOfferingIdT>(value);
  }
  template <typename CapacityBlockOfferingIdT = Aws::String>
  PurchaseCapacityBlockRequest& WithCapacityBlockOfferingId(CapacityBlockOfferingIdT&& value) {
    SetCapacityBlockOfferingId(std::forward<CapacityBlockOfferingIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline PurchaseCapacityBlockRequest& WithInstancePlatform(CapacityReservationInstancePlatform value) {
