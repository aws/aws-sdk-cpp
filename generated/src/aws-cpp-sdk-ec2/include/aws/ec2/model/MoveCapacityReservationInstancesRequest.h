...
class MoveCapacityReservationInstancesRequest : public EC2Request {
 ...
 public:
  ...
  inline MoveCapacityReservationInstancesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetDestinationCapacityReservationId(DestinationCapacityReservationIdT&& value) {
    m_destinationCapacityReservationIdHasBeenSet = true;
    m_destinationCapacityReservationId = std::forward<DestinationCapacityReservationIdT>(value);
  }
  template <typename DestinationCapacityReservationIdT = Aws::String>
  MoveCapacityReservationInstancesRequest& WithDestinationCapacityReservationId(DestinationCapacityReservationIdT&& value) {
    SetDestinationCapacityReservationId(std::forward<DestinationCapacityReservationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline MoveCapacityReservationInstancesRequest& WithInstanceCount(int value) {
