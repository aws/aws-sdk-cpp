...
class TransitGatewayMulticastDeregisteredGroupMembers {
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  TransitGatewayMulticastDeregisteredGroupMembers& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename DeregisteredNetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  TransitGatewayMulticastDeregisteredGroupMembers& WithDeregisteredNetworkInterfaceIds(DeregisteredNetworkInterfaceIdsT&& value) {
  ...
  TransitGatewayMulticastDeregisteredGroupMembers& AddDeregisteredNetworkInterfaceIds(DeregisteredNetworkInterfaceIdsT&& value) {
    m_deregisteredNetworkInterfaceIdsHasBeenSet = true;
  ...
  template <typename GroupIpAddressT = Aws::String>
  TransitGatewayMulticastDeregisteredGroupMembers& WithGroupIpAddress(GroupIpAddressT&& value) {
