...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API TransitGatewayMulticastDeregisteredGroupMembers() = default;
    ...
    template<typename TransitGatewayMulticastDomainIdT = Aws::String>
    TransitGatewayMulticastDeregisteredGroupMembers& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) { SetTransitGatewayMulticastDomainId(std::forward<TransitGatewayMulticastDomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DeregisteredNetworkInterfaceIdsT = Aws::Vector<Aws::String>>
    TransitGatewayMulticastDeregisteredGroupMembers& WithDeregisteredNetworkInterfaceIds(DeregisteredNetworkInterfaceIdsT&& value) { SetDeregisteredNetworkInterfaceIds(std::forward<DeregisteredNetworkInterfaceIdsT>(value)); return *this;}
    template<typename DeregisteredNetworkInterfaceIdsT = Aws::String>
    TransitGatewayMulticastDeregisteredGroupMembers& AddDeregisteredNetworkInterfaceIds(DeregisteredNetworkInterfaceIdsT&& value) { m_deregisteredNetworkInterfaceIdsHasBeenSet = true; m_deregisteredNetworkInterfaceIds.emplace_back(std::forward<DeregisteredNetworkInterfaceIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename GroupIpAddressT = Aws::String>
    TransitGatewayMulticastDeregisteredGroupMembers& WithGroupIpAddress(GroupIpAddressT&& value) { SetGroupIpAddress(std::forward<GroupIpAddressT>(value)); return *this;}
    ///@}
  private:
