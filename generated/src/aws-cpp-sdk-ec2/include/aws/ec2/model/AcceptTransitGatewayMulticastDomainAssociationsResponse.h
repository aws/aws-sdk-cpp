...
class AcceptTransitGatewayMulticastDomainAssociationsResponse {
 public:
  ...
  AWS_EC2_API AcceptTransitGatewayMulticastDomainAssociationsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename AssociationsT = TransitGatewayMulticastDomainAssociations>
  AcceptTransitGatewayMulticastDomainAssociationsResponse& WithAssociations(AssociationsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptTransitGatewayMulticastDomainAssociationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
