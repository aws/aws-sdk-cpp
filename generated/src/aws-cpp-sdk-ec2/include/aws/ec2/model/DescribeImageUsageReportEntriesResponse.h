...
class DescribeImageUsageReportEntriesResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageUsageReportEntriesResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetImageUsageReportEntries(ImageUsageReportEntriesT&& value) {
    m_imageUsageReportEntriesHasBeenSet = true;
    m_imageUsageReportEntries = std::forward<ImageUsageReportEntriesT>(value);
  }
  template <typename ImageUsageReportEntriesT = Aws::Vector<ImageUsageReportEntry>>
  DescribeImageUsageReportEntriesResponse& WithImageUsageReportEntries(ImageUsageReportEntriesT&& value) {
    SetImageUsageReportEntries(std::forward<ImageUsageReportEntriesT>(value));
    return *this;
  }
  template <typename ImageUsageReportEntriesT = ImageUsageReportEntry>
  DescribeImageUsageReportEntriesResponse& AddImageUsageReportEntries(ImageUsageReportEntriesT&& value) {
    m_imageUsageReportEntriesHasBeenSet = true;
    m_imageUsageReportEntries.emplace_back(std::forward<ImageUsageReportEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeImageUsageReportEntriesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
