...
namespace EC2 {
namespace Model {
class DeleteVpcEncryptionControlResponse {
 public:
  AWS_EC2_API DeleteVpcEncryptionControlResponse() = default;
  AWS_EC2_API DeleteVpcEncryptionControlResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteVpcEncryptionControlResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename VpcEncryptionControlT = VpcEncryptionControl>
  DeleteVpcEncryptionControlResponse& WithVpcEncryptionControl(VpcEncryptionControlT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteVpcEncryptionControlResponse& WithResponseMetadata(ResponseMetadataT&& value) {
