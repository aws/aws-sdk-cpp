...
class CreateVpcBlockPublicAccessExclusionResponse {
 public:
  ...
  AWS_EC2_API CreateVpcBlockPublicAccessExclusionResponse& operator=(
  ...
  template <typename VpcBlockPublicAccessExclusionT = VpcBlockPublicAccessExclusion>
  CreateVpcBlockPublicAccessExclusionResponse& WithVpcBlockPublicAccessExclusion(VpcBlockPublicAccessExclusionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateVpcBlockPublicAccessExclusionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
