...
class DeleteNetworkInsightsAccessScopeAnalysisRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NetworkInsightsAccessScopeAnalysisIdT = Aws::String>
  DeleteNetworkInsightsAccessScopeAnalysisRequest& WithNetworkInsightsAccessScopeAnalysisId(NetworkInsightsAccessScopeAnalysisIdT&& value) {
  ...
  inline DeleteNetworkInsightsAccessScopeAnalysisRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
