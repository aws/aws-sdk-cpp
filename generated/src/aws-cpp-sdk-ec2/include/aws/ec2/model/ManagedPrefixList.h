...
class ManagedPrefixList {
 public:
  ...
  inline void SetState(PrefixListState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ManagedPrefixList& WithState(PrefixListState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetPrefixListName(PrefixListNameT&& value) {
    ...
    m_prefixListName = std::forward<PrefixListNameT>(value);
  }
  template <typename PrefixListNameT = Aws::String>
  ManagedPrefixList& WithPrefixListName(PrefixListNameT&& value) {
    SetPrefixListName(std::forward<PrefixListNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetMaxEntries(int value) {
    m_maxEntriesHasBeenSet = true;
    m_maxEntries = value;
  }
  inline ManagedPrefixList& WithMaxEntries(int value) {
    SetMaxEntries(value);
    return *this;
  }
  ///@}
  ...
  inline ManagedPrefixList& WithVersion(long long value) {
    SetVersion(value);
    return *this;
  }
  ///@}
