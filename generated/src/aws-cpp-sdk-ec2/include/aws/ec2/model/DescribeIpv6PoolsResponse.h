...
class DescribeIpv6PoolsResponse {
 public:
  ...
  void SetIpv6Pools(Ipv6PoolsT&& value) {
    m_ipv6PoolsHasBeenSet = true;
    m_ipv6Pools = std::forward<Ipv6PoolsT>(value);
  }
  template <typename Ipv6PoolsT = Aws::Vector<Ipv6Pool>>
  DescribeIpv6PoolsResponse& WithIpv6Pools(Ipv6PoolsT&& value) {
    SetIpv6Pools(std::forward<Ipv6PoolsT>(value));
    return *this;
  }
  template <typename Ipv6PoolsT = Ipv6Pool>
  DescribeIpv6PoolsResponse& AddIpv6Pools(Ipv6PoolsT&& value) {
    m_ipv6PoolsHasBeenSet = true;
    m_ipv6Pools.emplace_back(std::forward<Ipv6PoolsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeIpv6PoolsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeIpv6PoolsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
