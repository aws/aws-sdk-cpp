...
class DescribeSpotPriceHistoryResponse {
 public:
  ...
  void SetSpotPriceHistory(SpotPriceHistoryT&& value) {
    ...
    m_spotPriceHistory = std::forward<SpotPriceHistoryT>(value);
  }
  template <typename SpotPriceHistoryT = Aws::Vector<SpotPrice>>
  DescribeSpotPriceHistoryResponse& WithSpotPriceHistory(SpotPriceHistoryT&& value) {
    SetSpotPriceHistory(std::forward<SpotPriceHistoryT>(value));
    return *this;
  }
  ...
  DescribeSpotPriceHistoryResponse& AddSpotPriceHistory(SpotPriceHistoryT&& value) {
    m_spotPriceHistoryHasBeenSet = true;
    m_spotPriceHistory.emplace_back(std::forward<SpotPriceHistoryT>(value));
    return *this;
  }
  ///@}
