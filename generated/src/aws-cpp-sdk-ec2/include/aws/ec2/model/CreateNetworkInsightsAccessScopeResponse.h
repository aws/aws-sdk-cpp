...
class CreateNetworkInsightsAccessScopeResponse {
 public:
  ...
  void SetNetworkInsightsAccessScope(NetworkInsightsAccessScopeT&& value) {
    m_networkInsightsAccessScopeHasBeenSet = true;
    m_networkInsightsAccessScope = std::forward<NetworkInsightsAccessScopeT>(value);
  }
  template <typename NetworkInsightsAccessScopeT = NetworkInsightsAccessScope>
  CreateNetworkInsightsAccessScopeResponse& WithNetworkInsightsAccessScope(NetworkInsightsAccessScopeT&& value) {
    SetNetworkInsightsAccessScope(std::forward<NetworkInsightsAccessScopeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInsightsAccessScopeContentT = NetworkInsightsAccessScopeContent>
  CreateNetworkInsightsAccessScopeResponse& WithNetworkInsightsAccessScopeContent(NetworkInsightsAccessScopeContentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateNetworkInsightsAccessScopeResponse& WithResponseMetadata(ResponseMetadataT&& value) {
