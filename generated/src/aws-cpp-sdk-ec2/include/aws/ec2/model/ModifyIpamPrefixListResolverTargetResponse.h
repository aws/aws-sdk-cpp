...
namespace EC2 {
namespace Model {
class ModifyIpamPrefixListResolverTargetResponse {
 public:
  AWS_EC2_API ModifyIpamPrefixListResolverTargetResponse() = default;
  AWS_EC2_API ModifyIpamPrefixListResolverTargetResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API ModifyIpamPrefixListResolverTargetResponse& operator=(
  ...
  template <typename IpamPrefixListResolverTargetT = IpamPrefixListResolverTarget>
  ModifyIpamPrefixListResolverTargetResponse& WithIpamPrefixListResolverTarget(IpamPrefixListResolverTargetT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyIpamPrefixListResolverTargetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
