...
namespace EC2 {
namespace Model {
class DisableApplicationStatusCheckSuppressionResponse {
 public:
  AWS_EC2_API DisableApplicationStatusCheckSuppressionResponse() = default;
  AWS_EC2_API DisableApplicationStatusCheckSuppressionResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DisableApplicationStatusCheckSuppressionResponse& operator=(
  ...
  template <typename SuccessfulResultsT = Aws::Vector<SuccessfulSuppressionResponseObject>>
  DisableApplicationStatusCheckSuppressionResponse& WithSuccessfulResults(SuccessfulResultsT&& value) {
  ...
  DisableApplicationStatusCheckSuppressionResponse& AddSuccessfulResults(SuccessfulResultsT&& value) {
    m_successfulResultsHasBeenSet = true;
  ...
  template <typename UnsuccessfulResultsT = Aws::Vector<UnsuccessfulSuppressionResponseObject>>
  DisableApplicationStatusCheckSuppressionResponse& WithUnsuccessfulResults(UnsuccessfulResultsT&& value) {
  ...
  DisableApplicationStatusCheckSuppressionResponse& AddUnsuccessfulResults(UnsuccessfulResultsT&& value) {
    m_unsuccessfulResultsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableApplicationStatusCheckSuppressionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
