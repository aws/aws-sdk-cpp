...
class DescribeInstanceTypeOfferingsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeInstanceTypeOfferingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeInstanceTypeOfferingsRequest& WithLocationType(LocationType value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeInstanceTypeOfferingsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeInstanceTypeOfferingsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeInstanceTypeOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceTypeOfferingsRequest& WithNextToken(NextTokenT&& value) {
