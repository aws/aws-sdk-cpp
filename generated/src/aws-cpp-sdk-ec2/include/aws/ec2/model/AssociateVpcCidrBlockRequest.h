...
class AssociateVpcCidrBlockRequest : public EC2Request {
 ...
 public:
  ...
  inline AssociateVpcCidrBlockRequest& WithIpv4NetmaskLength(int value) {
  ...
  inline AssociateVpcCidrBlockRequest& WithIpv6NetmaskLength(int value) {
  ...
  inline AssociateVpcCidrBlockRequest& WithAmazonProvidedIpv6CidrBlock(bool value) {
