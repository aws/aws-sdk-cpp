...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DeprovisionByoipCidrResponse() = default;
    ...
    template<typename ByoipCidrT = ByoipCidr>
    DeprovisionByoipCidrResponse& WithByoipCidr(ByoipCidrT&& value) { SetByoipCidr(std::forward<ByoipCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DeprovisionByoipCidrResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
