...
struct DescribeSecurityGroupVpcAssociationsPaginationTraits {
  ...
  using OutcomeType = Model::DescribeSecurityGroupVpcAssociationsOutcome;
  using ClientType = Client;

  static OutcomeType Invoke(Client* client, const RequestType& request) { return client->DescribeSecurityGroupVpcAssociations(request); }
