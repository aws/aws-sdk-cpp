...
class TargetCapacitySpecificationRequest {
 public:
  ...
  inline TargetCapacitySpecificationRequest& WithTotalTargetCapacity(int value) {
  ...
  inline TargetCapacitySpecificationRequest& WithOnDemandTargetCapacity(int value) {
  ...
  inline TargetCapacitySpecificationRequest& WithSpotTargetCapacity(int value) {
  ...
  inline TargetCapacitySpecificationRequest& WithDefaultTargetCapacityType(DefaultTargetCapacityType value) {
  ...
  inline TargetCapacitySpecificationRequest& WithTargetCapacityUnitType(TargetCapacityUnitType value) {
