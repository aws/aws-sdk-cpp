...
class FleetSpotCapacityRebalance {
 public:
  ...
  inline FleetSpotCapacityRebalance& WithReplacementStrategy(FleetReplacementStrategy value) {
  ...
  inline FleetSpotCapacityRebalance& WithTerminationDelay(int value) {
