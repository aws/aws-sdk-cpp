...
class DeleteVerifiedAccessGroupResponse {
 public:
  ...
  template <typename VerifiedAccessGroupT = VerifiedAccessGroup>
  DeleteVerifiedAccessGroupResponse& WithVerifiedAccessGroup(VerifiedAccessGroupT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteVerifiedAccessGroupResponse& WithResponseMetadata(ResponseMetadataT&& value) {
