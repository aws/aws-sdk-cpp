...
class GetInstanceTypesFromInstanceRequirementsResponse {
 public:
  ...
  AWS_EC2_API GetInstanceTypesFromInstanceRequirementsResponse& operator=(
  ...
  template <typename InstanceTypesT = Aws::Vector<InstanceTypeInfoFromInstanceRequirements>>
  GetInstanceTypesFromInstanceRequirementsResponse& WithInstanceTypes(InstanceTypesT&& value) {
  ...
  GetInstanceTypesFromInstanceRequirementsResponse& AddInstanceTypes(InstanceTypesT&& value) {
    m_instanceTypesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetInstanceTypesFromInstanceRequirementsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetInstanceTypesFromInstanceRequirementsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
