...
class ReservedInstancesConfiguration {
 public:
  ...
  inline ReservedInstancesConfiguration& WithInstanceCount(int value) {
  ...
  inline ReservedInstancesConfiguration& WithInstanceType(InstanceType value) {
  ...
  inline ReservedInstancesConfiguration& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
