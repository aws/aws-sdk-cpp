...
class ModifyVpcEndpointConnectionNotificationResponse {
 public:
  ...
  AWS_EC2_API ModifyVpcEndpointConnectionNotificationResponse& operator=(
  ...
  inline ModifyVpcEndpointConnectionNotificationResponse& WithReturnValue(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVpcEndpointConnectionNotificationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
