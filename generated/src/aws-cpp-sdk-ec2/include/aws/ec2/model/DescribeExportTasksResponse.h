...
class DescribeExportTasksResponse {
 public:
  ...
  template <typename ExportTasksT = Aws::Vector<ExportTask>>
  DescribeExportTasksResponse& WithExportTasks(ExportTasksT&& value) {
    SetExportTasks(std::forward<ExportTasksT>(value));
    return *this;
  }
  template <typename ExportTasksT = ExportTask>
  DescribeExportTasksResponse& AddExportTasks(ExportTasksT&& value) {
    m_exportTasksHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeExportTasksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
