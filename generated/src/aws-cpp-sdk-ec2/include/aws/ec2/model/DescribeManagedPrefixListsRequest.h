...
class DescribeManagedPrefixListsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeManagedPrefixListsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeManagedPrefixListsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeManagedPrefixListsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeManagedPrefixListsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeManagedPrefixListsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename PrefixListIdsT = Aws::Vector<Aws::String>>
  DescribeManagedPrefixListsRequest& WithPrefixListIds(PrefixListIdsT&& value) {
    SetPrefixListIds(std::forward<PrefixListIdsT>(value));
    return *this;
  }
  template <typename PrefixListIdsT = Aws::String>
  DescribeManagedPrefixListsRequest& AddPrefixListIds(PrefixListIdsT&& value) {
    m_prefixListIdsHasBeenSet = true;
