...
class GetIpamDiscoveredPublicAddressesRequest : public EC2Request {
 ...
 public:
  ...
  inline GetIpamDiscoveredPublicAddressesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamResourceDiscoveryIdT = Aws::String>
  GetIpamDiscoveredPublicAddressesRequest& WithIpamResourceDiscoveryId(IpamResourceDiscoveryIdT&& value) {
  ...
  template <typename AddressRegionT = Aws::String>
  GetIpamDiscoveredPublicAddressesRequest& WithAddressRegion(AddressRegionT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetIpamDiscoveredPublicAddressesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetIpamDiscoveredPublicAddressesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamDiscoveredPublicAddressesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIpamDiscoveredPublicAddressesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
