...
class DescribeReservedInstancesOfferingsRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetIncludeMarketplace(bool value) {
    m_includeMarketplaceHasBeenSet = true;
    m_includeMarketplace = value;
  }
  inline DescribeReservedInstancesOfferingsRequest& WithIncludeMarketplace(bool value) {
    SetIncludeMarketplace(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithInstanceType(InstanceType value) {
  ...
  inline void SetMaxDuration(long long value) {
    m_maxDurationHasBeenSet = true;
    m_maxDuration = value;
  }
  inline DescribeReservedInstancesOfferingsRequest& WithMaxDuration(long long value) {
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithMaxInstanceCount(int value) {
  ...
  inline void SetMinDuration(long long value) {
    m_minDurationHasBeenSet = true;
    m_minDuration = value;
  }
  inline DescribeReservedInstancesOfferingsRequest& WithMinDuration(long long value) {
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithOfferingClass(OfferingClassType value) {
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithProductDescription(RIProductDescription value) {
  ...
  void SetReservedInstancesOfferingIds(ReservedInstancesOfferingIdsT&& value) {
    m_reservedInstancesOfferingIdsHasBeenSet = true;
    m_reservedInstancesOfferingIds = std::forward<ReservedInstancesOfferingIdsT>(value);
  }
  template <typename ReservedInstancesOfferingIdsT = Aws::Vector<Aws::String>>
  DescribeReservedInstancesOfferingsRequest& WithReservedInstancesOfferingIds(ReservedInstancesOfferingIdsT&& value) {
    SetReservedInstancesOfferingIds(std::forward<ReservedInstancesOfferingIdsT>(value));
    return *this;
  }
  ...
  DescribeReservedInstancesOfferingsRequest& AddReservedInstancesOfferingIds(ReservedInstancesOfferingIdsT&& value) {
    m_reservedInstancesOfferingIdsHasBeenSet = true;
    m_reservedInstancesOfferingIds.emplace_back(std::forward<ReservedInstancesOfferingIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithInstanceTenancy(Tenancy value) {
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithOfferingType(OfferingTypeValues value) {
  ...
  inline DescribeReservedInstancesOfferingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
