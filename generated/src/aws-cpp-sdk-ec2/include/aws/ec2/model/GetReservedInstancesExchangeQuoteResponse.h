...
class GetReservedInstancesExchangeQuoteResponse {
 public:
  ...
  inline void SetIsValidExchange(bool value) {
    m_isValidExchangeHasBeenSet = true;
    m_isValidExchange = value;
  }
  inline GetReservedInstancesExchangeQuoteResponse& WithIsValidExchange(bool value) {
    SetIsValidExchange(value);
    return *this;
  }
  ///@}
  ...
  void SetOutputReservedInstancesWillExpireAt(OutputReservedInstancesWillExpireAtT&& value) {
    ...
    m_outputReservedInstancesWillExpireAt = std::forward<OutputReservedInstancesWillExpireAtT>(value);
  }
  template <typename OutputReservedInstancesWillExpireAtT = Aws::Utils::DateTime>
  GetReservedInstancesExchangeQuoteResponse& WithOutputReservedInstancesWillExpireAt(OutputReservedInstancesWillExpireAtT&& value) {
    SetOutputReservedInstancesWillExpireAt(std::forward<OutputReservedInstancesWillExpireAtT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPaymentDue(PaymentDueT&& value) {
    ...
    m_paymentDue = std::forward<PaymentDueT>(value);
  }
  template <typename PaymentDueT = Aws::String>
  GetReservedInstancesExchangeQuoteResponse& WithPaymentDue(PaymentDueT&& value) {
    SetPaymentDue(std::forward<PaymentDueT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedInstanceValueRollup(ReservedInstanceValueRollupT&& value) {
    ...
    m_reservedInstanceValueRollup = std::forward<ReservedInstanceValueRollupT>(value);
  }
  template <typename ReservedInstanceValueRollupT = ReservationValue>
  GetReservedInstancesExchangeQuoteResponse& WithReservedInstanceValueRollup(ReservedInstanceValueRollupT&& value) {
    SetReservedInstanceValueRollup(std::forward<ReservedInstanceValueRollupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReservedInstanceValueSet(ReservedInstanceValueSetT&& value) {
    ...
    m_reservedInstanceValueSet = std::forward<ReservedInstanceValueSetT>(value);
  }
  template <typename ReservedInstanceValueSetT = Aws::Vector<ReservedInstanceReservationValue>>
  GetReservedInstancesExchangeQuoteResponse& WithReservedInstanceValueSet(ReservedInstanceValueSetT&& value) {
    SetReservedInstanceValueSet(std::forward<ReservedInstanceValueSetT>(value));
    return *this;
  }
  ...
  GetReservedInstancesExchangeQuoteResponse& AddReservedInstanceValueSet(ReservedInstanceValueSetT&& value) {
    m_reservedInstanceValueSetHasBeenSet = true;
    m_reservedInstanceValueSet.emplace_back(std::forward<ReservedInstanceValueSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetConfigurationValueRollup(TargetConfigurationValueRollupT&& value) {
    ...
    m_targetConfigurationValueRollup = std::forward<TargetConfigurationValueRollupT>(value);
  }
  template <typename TargetConfigurationValueRollupT = ReservationValue>
  GetReservedInstancesExchangeQuoteResponse& WithTargetConfigurationValueRollup(TargetConfigurationValueRollupT&& value) {
    SetTargetConfigurationValueRollup(std::forward<TargetConfigurationValueRollupT>(value));
    return *this;
  }
  ///@}
  ...
  void SetTargetConfigurationValueSet(TargetConfigurationValueSetT&& value) {
    ...
    m_targetConfigurationValueSet = std::forward<TargetConfigurationValueSetT>(value);
  }
  template <typename TargetConfigurationValueSetT = Aws::Vector<TargetReservationValue>>
  GetReservedInstancesExchangeQuoteResponse& WithTargetConfigurationValueSet(TargetConfigurationValueSetT&& value) {
    SetTargetConfigurationValueSet(std::forward<TargetConfigurationValueSetT>(value));
    return *this;
  }
  ...
  GetReservedInstancesExchangeQuoteResponse& AddTargetConfigurationValueSet(TargetConfigurationValueSetT&& value) {
    m_targetConfigurationValueSetHasBeenSet = true;
    m_targetConfigurationValueSet.emplace_back(std::forward<TargetConfigurationValueSetT>(value));
    return *this;
  }
  ///@}
  ...
  void SetValidationFailureReason(ValidationFailureReasonT&& value) {
    ...
    m_validationFailureReason = std::forward<ValidationFailureReasonT>(value);
  }
  template <typename ValidationFailureReasonT = Aws::String>
  GetReservedInstancesExchangeQuoteResponse& WithValidationFailureReason(ValidationFailureReasonT&& value) {
    SetValidationFailureReason(std::forward<ValidationFailureReasonT>(value));
    return *this;
  }
  ///@}
