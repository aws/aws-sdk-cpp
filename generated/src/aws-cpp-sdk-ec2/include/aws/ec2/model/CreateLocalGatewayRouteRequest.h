...
class CreateLocalGatewayRouteRequest : public EC2Request {
 ...
 public:
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  CreateLocalGatewayRouteRequest& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  template <typename LocalGatewayRouteTableIdT = Aws::String>
  CreateLocalGatewayRouteRequest& WithLocalGatewayRouteTableId(LocalGatewayRouteTableIdT&& value) {
  ...
  template <typename LocalGatewayVirtualInterfaceGroupIdT = Aws::String>
  CreateLocalGatewayRouteRequest& WithLocalGatewayVirtualInterfaceGroupId(LocalGatewayVirtualInterfaceGroupIdT&& value) {
  ...
  inline CreateLocalGatewayRouteRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  CreateLocalGatewayRouteRequest& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename DestinationPrefixListIdT = Aws::String>
  CreateLocalGatewayRouteRequest& WithDestinationPrefixListId(DestinationPrefixListIdT&& value) {
