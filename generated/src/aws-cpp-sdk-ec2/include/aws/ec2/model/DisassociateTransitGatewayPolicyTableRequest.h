...
class DisassociateTransitGatewayPolicyTableRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayPolicyTableIdT = Aws::String>
  DisassociateTransitGatewayPolicyTableRequest& WithTransitGatewayPolicyTableId(TransitGatewayPolicyTableIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  DisassociateTransitGatewayPolicyTableRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline DisassociateTransitGatewayPolicyTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
