...
class RegionalSummary {
 public:
  ...
  template <typename RegionNameT = Aws::String>
  RegionalSummary& WithRegionName(RegionNameT&& value) {
  ...
  inline RegionalSummary& WithNumberOfMatchedAccounts(int value) {
  ...
  inline RegionalSummary& WithNumberOfUnmatchedAccounts(int value) {
