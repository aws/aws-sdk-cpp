...
class AssociateRouteServerResponse {
 public:
  ...
  void SetRouteServerAssociation(RouteServerAssociationT&& value) {
    ...
    m_routeServerAssociation = std::forward<RouteServerAssociationT>(value);
  }
  template <typename RouteServerAssociationT = RouteServerAssociation>
  AssociateRouteServerResponse& WithRouteServerAssociation(RouteServerAssociationT&& value) {
    SetRouteServerAssociation(std::forward<RouteServerAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateRouteServerResponse& WithResponseMetadata(ResponseMetadataT&& value) {
