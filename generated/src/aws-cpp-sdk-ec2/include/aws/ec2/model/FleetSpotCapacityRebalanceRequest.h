...
class FleetSpotCapacityRebalanceRequest {
 public:
  AWS_EC2_API FleetSpotCapacityRebalanceRequest() = default;
  ...
  inline void SetReplacementStrategy(FleetReplacementStrategy value) {
    m_replacementStrategyHasBeenSet = true;
    m_replacementStrategy = value;
  }
  inline FleetSpotCapacityRebalanceRequest& WithReplacementStrategy(FleetReplacementStrategy value) {
  ...
  inline FleetSpotCapacityRebalanceRequest& WithTerminationDelay(int value) {
