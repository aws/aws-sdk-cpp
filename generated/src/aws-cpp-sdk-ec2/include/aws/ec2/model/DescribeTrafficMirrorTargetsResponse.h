...
class DescribeTrafficMirrorTargetsResponse {
 public:
  ...
  void SetTrafficMirrorTargets(TrafficMirrorTargetsT&& value) {
    m_trafficMirrorTargetsHasBeenSet = true;
    m_trafficMirrorTargets = std::forward<TrafficMirrorTargetsT>(value);
  }
  template <typename TrafficMirrorTargetsT = Aws::Vector<TrafficMirrorTarget>>
  DescribeTrafficMirrorTargetsResponse& WithTrafficMirrorTargets(TrafficMirrorTargetsT&& value) {
    SetTrafficMirrorTargets(std::forward<TrafficMirrorTargetsT>(value));
    return *this;
  }
  template <typename TrafficMirrorTargetsT = TrafficMirrorTarget>
  DescribeTrafficMirrorTargetsResponse& AddTrafficMirrorTargets(TrafficMirrorTargetsT&& value) {
    m_trafficMirrorTargetsHasBeenSet = true;
    m_trafficMirrorTargets.emplace_back(std::forward<TrafficMirrorTargetsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorTargetsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTrafficMirrorTargetsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
