...
namespace EC2 {
namespace Model {
class CreateTransitGatewayMeteringPolicyEntryResponse {
 public:
  AWS_EC2_API CreateTransitGatewayMeteringPolicyEntryResponse() = default;
  AWS_EC2_API CreateTransitGatewayMeteringPolicyEntryResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateTransitGatewayMeteringPolicyEntryResponse& operator=(
  ...
  template <typename TransitGatewayMeteringPolicyEntryT = TransitGatewayMeteringPolicyEntry>
  CreateTransitGatewayMeteringPolicyEntryResponse& WithTransitGatewayMeteringPolicyEntry(TransitGatewayMeteringPolicyEntryT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayMeteringPolicyEntryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
