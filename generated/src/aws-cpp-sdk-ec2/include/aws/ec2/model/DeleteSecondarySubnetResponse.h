...
namespace EC2 {
namespace Model {
class DeleteSecondarySubnetResponse {
 public:
  AWS_EC2_API DeleteSecondarySubnetResponse() = default;
  AWS_EC2_API DeleteSecondarySubnetResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteSecondarySubnetResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename SecondarySubnetT = SecondarySubnet>
  DeleteSecondarySubnetResponse& WithSecondarySubnet(SecondarySubnetT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  DeleteSecondarySubnetResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteSecondarySubnetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
