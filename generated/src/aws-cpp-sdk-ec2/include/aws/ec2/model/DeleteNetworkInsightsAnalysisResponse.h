...
class DeleteNetworkInsightsAnalysisResponse {
 public:
  ...
  template <typename NetworkInsightsAnalysisIdT = Aws::String>
  DeleteNetworkInsightsAnalysisResponse& WithNetworkInsightsAnalysisId(NetworkInsightsAnalysisIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteNetworkInsightsAnalysisResponse& WithResponseMetadata(ResponseMetadataT&& value) {
