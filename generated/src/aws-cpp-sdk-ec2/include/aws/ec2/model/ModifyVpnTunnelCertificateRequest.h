...
class ModifyVpnTunnelCertificateRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VpnConnectionIdT = Aws::String>
  ModifyVpnTunnelCertificateRequest& WithVpnConnectionId(VpnConnectionIdT&& value) {
  ...
  template <typename VpnTunnelOutsideIpAddressT = Aws::String>
  ModifyVpnTunnelCertificateRequest& WithVpnTunnelOutsideIpAddress(VpnTunnelOutsideIpAddressT&& value) {
  ...
  inline ModifyVpnTunnelCertificateRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
