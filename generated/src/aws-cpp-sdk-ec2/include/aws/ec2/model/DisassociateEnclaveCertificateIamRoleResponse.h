...
class DisassociateEnclaveCertificateIamRoleResponse {
 public:
  ...
  AWS_EC2_API DisassociateEnclaveCertificateIamRoleResponse& operator=(
  ...
  inline DisassociateEnclaveCertificateIamRoleResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisassociateEnclaveCertificateIamRoleResponse& WithResponseMetadata(ResponseMetadataT&& value) {
