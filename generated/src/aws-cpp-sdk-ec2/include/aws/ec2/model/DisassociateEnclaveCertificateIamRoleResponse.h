...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DisassociateEnclaveCertificateIamRoleResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisassociateEnclaveCertificateIamRoleResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
