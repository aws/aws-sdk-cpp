...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline DisassociateEnclaveCertificateIamRoleResponse& WithReturn(bool value) { SetReturn(value); return *this;}
    ...
    inline DisassociateEnclaveCertificateIamRoleResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline DisassociateEnclaveCertificateIamRoleResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
