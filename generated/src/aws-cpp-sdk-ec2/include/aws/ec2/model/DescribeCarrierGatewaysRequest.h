...
class DescribeCarrierGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  void SetCarrierGatewayIds(CarrierGatewayIdsT&& value) {
    m_carrierGatewayIdsHasBeenSet = true;
    m_carrierGatewayIds = std::forward<CarrierGatewayIdsT>(value);
  }
  template <typename CarrierGatewayIdsT = Aws::Vector<Aws::String>>
  DescribeCarrierGatewaysRequest& WithCarrierGatewayIds(CarrierGatewayIdsT&& value) {
    SetCarrierGatewayIds(std::forward<CarrierGatewayIdsT>(value));
    return *this;
  }
  ...
  DescribeCarrierGatewaysRequest& AddCarrierGatewayIds(CarrierGatewayIdsT&& value) {
    m_carrierGatewayIdsHasBeenSet = true;
    m_carrierGatewayIds.emplace_back(std::forward<CarrierGatewayIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeCarrierGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeCarrierGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
