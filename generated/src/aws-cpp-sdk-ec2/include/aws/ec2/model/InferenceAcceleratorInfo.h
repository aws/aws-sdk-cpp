...
class InferenceAcceleratorInfo {
 public:
  ...
  inline void SetTotalInferenceMemoryInMiB(int value) {
    m_totalInferenceMemoryInMiBHasBeenSet = true;
    m_totalInferenceMemoryInMiB = value;
  }
  inline InferenceAcceleratorInfo& WithTotalInferenceMemoryInMiB(int value) {
    SetTotalInferenceMemoryInMiB(value);
    return *this;
  }
  ///@}
 private:
