...
class CreateInstanceEventWindowResponse {
 public:
  ...
  template <typename InstanceEventWindowT = InstanceEventWindow>
  CreateInstanceEventWindowResponse& WithInstanceEventWindow(InstanceEventWindowT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateInstanceEventWindowResponse& WithResponseMetadata(ResponseMetadataT&& value) {
