...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateInstanceEventWindowResponse() = default;
    ...
    template<typename InstanceEventWindowT = InstanceEventWindow>
    CreateInstanceEventWindowResponse& WithInstanceEventWindow(InstanceEventWindowT&& value) { SetInstanceEventWindow(std::forward<InstanceEventWindowT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateInstanceEventWindowResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
