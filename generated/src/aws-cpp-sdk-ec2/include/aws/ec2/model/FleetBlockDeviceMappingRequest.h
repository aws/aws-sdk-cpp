...
class FleetBlockDeviceMappingRequest {
 public:
  ...
  template <typename DeviceNameT = Aws::String>
  FleetBlockDeviceMappingRequest& WithDeviceName(DeviceNameT&& value) {
  ...
  template <typename VirtualNameT = Aws::String>
  FleetBlockDeviceMappingRequest& WithVirtualName(VirtualNameT&& value) {
  ...
  template <typename EbsT = FleetEbsBlockDeviceRequest>
  FleetBlockDeviceMappingRequest& WithEbs(EbsT&& value) {
  ...
  template <typename NoDeviceT = Aws::String>
  FleetBlockDeviceMappingRequest& WithNoDevice(NoDeviceT&& value) {
