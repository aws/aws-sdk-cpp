...
namespace EC2 {
namespace Model {
class DeleteTransitGatewayPolicyTableEntryResponse {
 public:
  AWS_EC2_API DeleteTransitGatewayPolicyTableEntryResponse() = default;
  AWS_EC2_API DeleteTransitGatewayPolicyTableEntryResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteTransitGatewayPolicyTableEntryResponse& operator=(
  ...
  template <typename TransitGatewayPolicyTableEntryT = TransitGatewayPolicyTableEntry>
  DeleteTransitGatewayPolicyTableEntryResponse& WithTransitGatewayPolicyTableEntry(TransitGatewayPolicyTableEntryT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayPolicyTableEntryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
