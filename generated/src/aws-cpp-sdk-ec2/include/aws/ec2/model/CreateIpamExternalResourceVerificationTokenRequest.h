...
class CreateIpamExternalResourceVerificationTokenRequest : public EC2Request {
 ...
 public:
  ...
  inline CreateIpamExternalResourceVerificationTokenRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamIdT = Aws::String>
  CreateIpamExternalResourceVerificationTokenRequest& WithIpamId(IpamIdT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateIpamExternalResourceVerificationTokenRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateIpamExternalResourceVerificationTokenRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename ClientTokenT = Aws::String>
  CreateIpamExternalResourceVerificationTokenRequest& WithClientToken(ClientTokenT&& value) {
