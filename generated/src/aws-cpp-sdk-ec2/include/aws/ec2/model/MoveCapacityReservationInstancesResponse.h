...
class MoveCapacityReservationInstancesResponse {
 public:
  ...
  void SetSourceCapacityReservation(SourceCapacityReservationT&& value) {
    m_sourceCapacityReservationHasBeenSet = true;
    m_sourceCapacityReservation = std::forward<SourceCapacityReservationT>(value);
  }
  template <typename SourceCapacityReservationT = CapacityReservation>
  MoveCapacityReservationInstancesResponse& WithSourceCapacityReservation(SourceCapacityReservationT&& value) {
    SetSourceCapacityReservation(std::forward<SourceCapacityReservationT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDestinationCapacityReservation(DestinationCapacityReservationT&& value) {
    m_destinationCapacityReservationHasBeenSet = true;
    m_destinationCapacityReservation = std::forward<DestinationCapacityReservationT>(value);
  }
  template <typename DestinationCapacityReservationT = CapacityReservation>
  MoveCapacityReservationInstancesResponse& WithDestinationCapacityReservation(DestinationCapacityReservationT&& value) {
    SetDestinationCapacityReservation(std::forward<DestinationCapacityReservationT>(value));
    return *this;
  }
  ///@}
  ...
  inline MoveCapacityReservationInstancesResponse& WithInstanceCount(int value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  MoveCapacityReservationInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
