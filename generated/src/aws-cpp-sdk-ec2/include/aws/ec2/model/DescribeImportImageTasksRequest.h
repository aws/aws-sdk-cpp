...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DescribeImportImageTasksRequest() = default;
  ...
  public:
    ...
    template<typename FiltersT = Aws::Vector<Filter>>
    DescribeImportImageTasksRequest& WithFilters(FiltersT&& value) { SetFilters(std::forward<FiltersT>(value)); return *this;}
    template<typename FiltersT = Filter>
    DescribeImportImageTasksRequest& AddFilters(FiltersT&& value) { m_filtersHasBeenSet = true; m_filters.emplace_back(std::forward<FiltersT>(value)); return *this; }
    ///@}
    ...
    template<typename ImportTaskIdsT = Aws::Vector<Aws::String>>
    DescribeImportImageTasksRequest& WithImportTaskIds(ImportTaskIdsT&& value) { SetImportTaskIds(std::forward<ImportTaskIdsT>(value)); return *this;}
    template<typename ImportTaskIdsT = Aws::String>
    DescribeImportImageTasksRequest& AddImportTaskIds(ImportTaskIdsT&& value) { m_importTaskIdsHasBeenSet = true; m_importTaskIds.emplace_back(std::forward<ImportTaskIdsT>(value)); return *this; }
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    DescribeImportImageTasksRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
  private:
