...
namespace EC2 {
namespace Model {
class CreateIpamPolicyResponse {
 public:
  AWS_EC2_API CreateIpamPolicyResponse() = default;
  AWS_EC2_API CreateIpamPolicyResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateIpamPolicyResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);

  ///@{
  /**
   * <p>Information about the created IPAM policy.</p> <p>An IPAM policy is a set of
  ...
  template <typename IpamPolicyT = IpamPolicy>
  CreateIpamPolicyResponse& WithIpamPolicy(IpamPolicyT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
