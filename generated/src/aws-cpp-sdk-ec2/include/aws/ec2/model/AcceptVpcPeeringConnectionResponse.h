...
class AcceptVpcPeeringConnectionResponse {
 public:
  ...
  template <typename VpcPeeringConnectionT = VpcPeeringConnection>
  AcceptVpcPeeringConnectionResponse& WithVpcPeeringConnection(VpcPeeringConnectionT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptVpcPeeringConnectionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
