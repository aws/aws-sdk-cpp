...
class ClientConnectResponseOptions {
 public:
  ...
  inline ClientConnectResponseOptions& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename LambdaFunctionArnT = Aws::String>
  ClientConnectResponseOptions& WithLambdaFunctionArn(LambdaFunctionArnT&& value) {
  ...
  template <typename StatusT = ClientVpnEndpointAttributeStatus>
  ClientConnectResponseOptions& WithStatus(StatusT&& value) {
