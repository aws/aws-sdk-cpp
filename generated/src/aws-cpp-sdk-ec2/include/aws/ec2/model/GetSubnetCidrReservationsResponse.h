...
class GetSubnetCidrReservationsResponse {
 public:
  ...
  void SetSubnetIpv4CidrReservations(SubnetIpv4CidrReservationsT&& value) {
    m_subnetIpv4CidrReservationsHasBeenSet = true;
    m_subnetIpv4CidrReservations = std::forward<SubnetIpv4CidrReservationsT>(value);
  }
  template <typename SubnetIpv4CidrReservationsT = Aws::Vector<SubnetCidrReservation>>
  GetSubnetCidrReservationsResponse& WithSubnetIpv4CidrReservations(SubnetIpv4CidrReservationsT&& value) {
    SetSubnetIpv4CidrReservations(std::forward<SubnetIpv4CidrReservationsT>(value));
    return *this;
  }
  template <typename SubnetIpv4CidrReservationsT = SubnetCidrReservation>
  GetSubnetCidrReservationsResponse& AddSubnetIpv4CidrReservations(SubnetIpv4CidrReservationsT&& value) {
    m_subnetIpv4CidrReservationsHasBeenSet = true;
    m_subnetIpv4CidrReservations.emplace_back(std::forward<SubnetIpv4CidrReservationsT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSubnetIpv6CidrReservations(SubnetIpv6CidrReservationsT&& value) {
    m_subnetIpv6CidrReservationsHasBeenSet = true;
    m_subnetIpv6CidrReservations = std::forward<SubnetIpv6CidrReservationsT>(value);
  }
  template <typename SubnetIpv6CidrReservationsT = Aws::Vector<SubnetCidrReservation>>
  GetSubnetCidrReservationsResponse& WithSubnetIpv6CidrReservations(SubnetIpv6CidrReservationsT&& value) {
    SetSubnetIpv6CidrReservations(std::forward<SubnetIpv6CidrReservationsT>(value));
    return *this;
  }
  template <typename SubnetIpv6CidrReservationsT = SubnetCidrReservation>
  GetSubnetCidrReservationsResponse& AddSubnetIpv6CidrReservations(SubnetIpv6CidrReservationsT&& value) {
    m_subnetIpv6CidrReservationsHasBeenSet = true;
    m_subnetIpv6CidrReservations.emplace_back(std::forward<SubnetIpv6CidrReservationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetSubnetCidrReservationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetSubnetCidrReservationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
