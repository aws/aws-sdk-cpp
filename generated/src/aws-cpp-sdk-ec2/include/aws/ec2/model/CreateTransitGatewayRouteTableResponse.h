...
class CreateTransitGatewayRouteTableResponse {
 public:
  ...
  template <typename TransitGatewayRouteTableT = TransitGatewayRouteTable>
  CreateTransitGatewayRouteTableResponse& WithTransitGatewayRouteTable(TransitGatewayRouteTableT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayRouteTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
