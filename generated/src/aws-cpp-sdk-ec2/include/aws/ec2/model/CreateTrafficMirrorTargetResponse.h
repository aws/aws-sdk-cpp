...
class CreateTrafficMirrorTargetResponse {
 public:
  ...
  void SetTrafficMirrorTarget(TrafficMirrorTargetT&& value) {
    m_trafficMirrorTargetHasBeenSet = true;
    m_trafficMirrorTarget = std::forward<TrafficMirrorTargetT>(value);
  }
  template <typename TrafficMirrorTargetT = TrafficMirrorTarget>
  CreateTrafficMirrorTargetResponse& WithTrafficMirrorTarget(TrafficMirrorTargetT&& value) {
    SetTrafficMirrorTarget(std::forward<TrafficMirrorTargetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateTrafficMirrorTargetResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTrafficMirrorTargetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
