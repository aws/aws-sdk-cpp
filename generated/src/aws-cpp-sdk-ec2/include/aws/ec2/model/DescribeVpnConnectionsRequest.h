...
class DescribeVpnConnectionsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVpnConnectionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
