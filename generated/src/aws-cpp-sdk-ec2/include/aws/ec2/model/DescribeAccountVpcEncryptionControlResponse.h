...
namespace EC2 {
namespace Model {
class DescribeAccountVpcEncryptionControlResponse {
 public:
  AWS_EC2_API DescribeAccountVpcEncryptionControlResponse() = default;
  AWS_EC2_API DescribeAccountVpcEncryptionControlResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DescribeAccountVpcEncryptionControlResponse& operator=(
  ...
  template <typename AccountVpcEncryptionControlT = AccountVpcEncryptionControl>
  DescribeAccountVpcEncryptionControlResponse& WithAccountVpcEncryptionControl(AccountVpcEncryptionControlT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeAccountVpcEncryptionControlResponse& WithResponseMetadata(ResponseMetadataT&& value) {
