 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/VerifiedAccessEndpointPortRange">AWS
 * API Reference</a></p>
 */
class VerifiedAccessEndpointPortRange {
 public:
  ...
  inline VerifiedAccessEndpointPortRange& WithFromPort(int value) {
    SetFromPort(value);
    return *this;
  }
  ///@}
  ...
  inline VerifiedAccessEndpointPortRange& WithToPort(int value) {
    SetToPort(value);
    return *this;
  }
  ///@}
