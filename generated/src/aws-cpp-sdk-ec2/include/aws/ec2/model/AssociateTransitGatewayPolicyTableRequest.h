...
class AssociateTransitGatewayPolicyTableRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayPolicyTableIdT = Aws::String>
  AssociateTransitGatewayPolicyTableRequest& WithTransitGatewayPolicyTableId(TransitGatewayPolicyTableIdT&& value) {
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  AssociateTransitGatewayPolicyTableRequest& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  inline AssociateTransitGatewayPolicyTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
