...
class DeleteEgressOnlyInternetGatewayResponse {
 public:
  ...
  inline void SetReturnCode(bool value) {
    m_returnCodeHasBeenSet = true;
    m_returnCode = value;
  }
  inline DeleteEgressOnlyInternetGatewayResponse& WithReturnCode(bool value) {
    SetReturnCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteEgressOnlyInternetGatewayResponse& WithResponseMetadata(ResponseMetadataT&& value) {
