...
class DescribeInternetGatewaysResponse {
 public:
  ...
  void SetInternetGateways(InternetGatewaysT&& value) {
    m_internetGatewaysHasBeenSet = true;
    m_internetGateways = std::forward<InternetGatewaysT>(value);
  }
  template <typename InternetGatewaysT = Aws::Vector<InternetGateway>>
  DescribeInternetGatewaysResponse& WithInternetGateways(InternetGatewaysT&& value) {
    SetInternetGateways(std::forward<InternetGatewaysT>(value));
    return *this;
  }
  template <typename InternetGatewaysT = InternetGateway>
  DescribeInternetGatewaysResponse& AddInternetGateways(InternetGatewaysT&& value) {
    m_internetGatewaysHasBeenSet = true;
    m_internetGateways.emplace_back(std::forward<InternetGatewaysT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInternetGatewaysResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeInternetGatewaysResponse& WithResponseMetadata(ResponseMetadataT&& value) {
