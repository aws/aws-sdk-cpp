...
class CreateTransitGatewayMulticastDomainRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayIdT = Aws::String>
  CreateTransitGatewayMulticastDomainRequest& WithTransitGatewayId(TransitGatewayIdT&& value) {
  ...
  template <typename OptionsT = CreateTransitGatewayMulticastDomainRequestOptions>
  CreateTransitGatewayMulticastDomainRequest& WithOptions(OptionsT&& value) {
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateTransitGatewayMulticastDomainRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateTransitGatewayMulticastDomainRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  inline CreateTransitGatewayMulticastDomainRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
