...
class DeleteFlowLogsResponse {
 public:
  ...
  template <typename UnsuccessfulT = Aws::Vector<UnsuccessfulItem>>
  DeleteFlowLogsResponse& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = UnsuccessfulItem>
  DeleteFlowLogsResponse& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteFlowLogsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
