...
namespace EC2 {
namespace Model {
class ModifyIpamRoutingPolicyRegistrationResponse {
 public:
  AWS_EC2_API ModifyIpamRoutingPolicyRegistrationResponse() = default;
  AWS_EC2_API ModifyIpamRoutingPolicyRegistrationResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API ModifyIpamRoutingPolicyRegistrationResponse& operator=(
  ...
  template <typename IpamRoutingPolicyRegistrationDeltaT = IpamRoutingPolicyRegistrationDelta>
  ModifyIpamRoutingPolicyRegistrationResponse& WithIpamRoutingPolicyRegistrationDelta(IpamRoutingPolicyRegistrationDeltaT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyIpamRoutingPolicyRegistrationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
