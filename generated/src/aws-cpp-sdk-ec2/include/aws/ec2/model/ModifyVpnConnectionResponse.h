...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyVpnConnectionResponse() = default;
    ...
    template<typename VpnConnectionT = VpnConnection>
    ModifyVpnConnectionResponse& WithVpnConnection(VpnConnectionT&& value) { SetVpnConnection(std::forward<VpnConnectionT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyVpnConnectionResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
