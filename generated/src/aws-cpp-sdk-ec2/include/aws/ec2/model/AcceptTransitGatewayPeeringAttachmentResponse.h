...
class AcceptTransitGatewayPeeringAttachmentResponse {
 public:
  ...
  AWS_EC2_API AcceptTransitGatewayPeeringAttachmentResponse& operator=(
  ...
  void SetTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachmentT&& value) {
    m_transitGatewayPeeringAttachmentHasBeenSet = true;
    m_transitGatewayPeeringAttachment = std::forward<TransitGatewayPeeringAttachmentT>(value);
  }
  template <typename TransitGatewayPeeringAttachmentT = TransitGatewayPeeringAttachment>
  AcceptTransitGatewayPeeringAttachmentResponse& WithTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachmentT&& value) {
    SetTransitGatewayPeeringAttachment(std::forward<TransitGatewayPeeringAttachmentT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptTransitGatewayPeeringAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
