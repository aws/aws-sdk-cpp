...
class ExportClientVpnClientConfigurationResponse {
 public:
  ...
  AWS_EC2_API ExportClientVpnClientConfigurationResponse& operator=(
  ...
  void SetClientConfiguration(ClientConfigurationT&& value) {
    m_clientConfigurationHasBeenSet = true;
    m_clientConfiguration = std::forward<ClientConfigurationT>(value);
  }
  template <typename ClientConfigurationT = Aws::String>
  ExportClientVpnClientConfigurationResponse& WithClientConfiguration(ClientConfigurationT&& value) {
    SetClientConfiguration(std::forward<ClientConfigurationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ExportClientVpnClientConfigurationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
