...
class GetManagedPrefixListEntriesResponse {
 public:
  ...
  template <typename EntriesT = Aws::Vector<PrefixListEntry>>
  GetManagedPrefixListEntriesResponse& WithEntries(EntriesT&& value) {
    SetEntries(std::forward<EntriesT>(value));
    return *this;
  }
  template <typename EntriesT = PrefixListEntry>
  GetManagedPrefixListEntriesResponse& AddEntries(EntriesT&& value) {
    m_entriesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetManagedPrefixListEntriesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetManagedPrefixListEntriesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
