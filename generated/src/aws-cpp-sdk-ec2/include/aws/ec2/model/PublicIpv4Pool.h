...
class PublicIpv4Pool {
 public:
  ...
  void SetPoolAddressRanges(PoolAddressRangesT&& value) {
    ...
    m_poolAddressRanges = std::forward<PoolAddressRangesT>(value);
  }
  template <typename PoolAddressRangesT = Aws::Vector<PublicIpv4PoolRange>>
  PublicIpv4Pool& WithPoolAddressRanges(PoolAddressRangesT&& value) {
    SetPoolAddressRanges(std::forward<PoolAddressRangesT>(value));
    return *this;
  }
  template <typename PoolAddressRangesT = PublicIpv4PoolRange>
  PublicIpv4Pool& AddPoolAddressRanges(PoolAddressRangesT&& value) {
    m_poolAddressRangesHasBeenSet = true;
    m_poolAddressRanges.emplace_back(std::forward<PoolAddressRangesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalAddressCount(int value) {
    m_totalAddressCountHasBeenSet = true;
    m_totalAddressCount = value;
  }
  inline PublicIpv4Pool& WithTotalAddressCount(int value) {
    SetTotalAddressCount(value);
    return *this;
  }
  ///@}
  ...
  inline void SetTotalAvailableAddressCount(int value) {
    m_totalAvailableAddressCountHasBeenSet = true;
    m_totalAvailableAddressCount = value;
  }
  inline PublicIpv4Pool& WithTotalAvailableAddressCount(int value) {
    SetTotalAvailableAddressCount(value);
    return *this;
  }
  ///@}
