...
class DescribeInstanceTopologyRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeInstanceTopologyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeInstanceTopologyRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
