...
class ModifyTrafficMirrorFilterRuleResponse {
 public:
  ...
  template <typename TrafficMirrorFilterRuleT = TrafficMirrorFilterRule>
  ModifyTrafficMirrorFilterRuleResponse& WithTrafficMirrorFilterRule(TrafficMirrorFilterRuleT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyTrafficMirrorFilterRuleResponse& WithResponseMetadata(ResponseMetadataT&& value) {
