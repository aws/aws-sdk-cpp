...
class DeleteIpamResourceDiscoveryRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteIpamResourceDiscoveryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamResourceDiscoveryIdT = Aws::String>
  DeleteIpamResourceDiscoveryRequest& WithIpamResourceDiscoveryId(IpamResourceDiscoveryIdT&& value) {
