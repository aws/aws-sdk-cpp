...
/**
 * <p>The matching criteria for a transit gateway policy table entry.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TransitGatewayRequestPolicyRule">AWS
 * API Reference</a></p>
 */
class TransitGatewayRequestPolicyRule {
 public:
  AWS_EC2_API TransitGatewayRequestPolicyRule() = default;
  AWS_EC2_API TransitGatewayRequestPolicyRule(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API TransitGatewayRequestPolicyRule& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename SourceCidrBlockT = Aws::String>
  TransitGatewayRequestPolicyRule& WithSourceCidrBlock(SourceCidrBlockT&& value) {
  ...
  ///@{
  /**
   * <p>The source port or port range for the policy rule. You can specify a port
   * range only when <code>Protocol</code> is <code>6</code> (TCP) or <code>17</code>
   * (UDP); for all other protocols, this value must be <code>*</code>.</p>
   */
  ...
  template <typename SourcePortRangeT = Aws::String>
  TransitGatewayRequestPolicyRule& WithSourcePortRange(SourcePortRangeT&& value) {
  ...
  template <typename DestinationCidrBlockT = Aws::String>
  TransitGatewayRequestPolicyRule& WithDestinationCidrBlock(DestinationCidrBlockT&& value) {
  ...
  ///@{
  /**
   * <p>The destination port or port range for the policy rule. You can specify a
   * port range only when <code>Protocol</code> is <code>6</code> (TCP) or
   * <code>17</code> (UDP); for all other protocols, this value must be
   * <code>*</code>.</p>
   */
  ...
  template <typename DestinationPortRangeT = Aws::String>
  TransitGatewayRequestPolicyRule& WithDestinationPortRange(DestinationPortRangeT&& value) {
  ...
  ///@{
  /**
   * <p>The protocol for the policy rule. Valid values are <code>1</code> (ICMP),
   * <code>6</code> (TCP), <code>17</code> (UDP), <code>47</code> (GRE), or
   * <code>*</code> for all protocols.</p>
   */
  ...
  template <typename ProtocolT = Aws::String>
  TransitGatewayRequestPolicyRule& WithProtocol(ProtocolT&& value) {
   ...
   */
  inline const TransitGatewayRequestPolicyRuleMetaData& GetMetaData() const { return m_metaData; }
  inline bool MetaDataHasBeenSet() const { return m_metaDataHasBeenSet; }
  template <typename MetaDataT = TransitGatewayRequestPolicyRuleMetaData>
  void SetMetaData(MetaDataT&& value) {
    m_metaDataHasBeenSet = true;
    m_metaData = std::forward<MetaDataT>(value);
  }
  template <typename MetaDataT = TransitGatewayRequestPolicyRuleMetaData>
  TransitGatewayRequestPolicyRule& WithMetaData(MetaDataT&& value) {
 ...
 private:
  ...
  TransitGatewayRequestPolicyRuleMetaData m_metaData;
