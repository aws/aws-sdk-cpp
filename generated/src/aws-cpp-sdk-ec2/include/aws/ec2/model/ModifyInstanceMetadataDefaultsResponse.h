...
class ModifyInstanceMetadataDefaultsResponse {
 public:
  ...
  inline ModifyInstanceMetadataDefaultsResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyInstanceMetadataDefaultsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
