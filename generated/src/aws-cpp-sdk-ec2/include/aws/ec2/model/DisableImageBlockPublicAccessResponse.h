...
class DisableImageBlockPublicAccessResponse {
 public:
  ...
  inline void SetImageBlockPublicAccessState(ImageBlockPublicAccessDisabledState value) {
    m_imageBlockPublicAccessStateHasBeenSet = true;
    m_imageBlockPublicAccessState = value;
  }
  inline DisableImageBlockPublicAccessResponse& WithImageBlockPublicAccessState(ImageBlockPublicAccessDisabledState value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableImageBlockPublicAccessResponse& WithResponseMetadata(ResponseMetadataT&& value) {
