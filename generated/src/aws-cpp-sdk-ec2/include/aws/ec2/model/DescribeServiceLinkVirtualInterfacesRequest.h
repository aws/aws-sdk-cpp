...
class DescribeServiceLinkVirtualInterfacesRequest : public EC2Request {
 ...
 public:
  ...
  void SetServiceLinkVirtualInterfaceIds(ServiceLinkVirtualInterfaceIdsT&& value) {
    ...
    m_serviceLinkVirtualInterfaceIds = std::forward<ServiceLinkVirtualInterfaceIdsT>(value);
  }
  template <typename ServiceLinkVirtualInterfaceIdsT = Aws::Vector<Aws::String>>
  DescribeServiceLinkVirtualInterfacesRequest& WithServiceLinkVirtualInterfaceIds(ServiceLinkVirtualInterfaceIdsT&& value) {
    SetServiceLinkVirtualInterfaceIds(std::forward<ServiceLinkVirtualInterfaceIdsT>(value));
    return *this;
  }
  template <typename ServiceLinkVirtualInterfaceIdsT = Aws::String>
  DescribeServiceLinkVirtualInterfacesRequest& AddServiceLinkVirtualInterfaceIds(ServiceLinkVirtualInterfaceIdsT&& value) {
    m_serviceLinkVirtualInterfaceIdsHasBeenSet = true;
    m_serviceLinkVirtualInterfaceIds.emplace_back(std::forward<ServiceLinkVirtualInterfaceIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeServiceLinkVirtualInterfacesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeServiceLinkVirtualInterfacesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeServiceLinkVirtualInterfacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeServiceLinkVirtualInterfacesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeServiceLinkVirtualInterfacesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
