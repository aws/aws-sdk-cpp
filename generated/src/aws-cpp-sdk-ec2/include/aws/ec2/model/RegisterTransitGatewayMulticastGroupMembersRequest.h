...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API RegisterTransitGatewayMulticastGroupMembersRequest() = default;
  ...
  public:
    ...
    template<typename TransitGatewayMulticastDomainIdT = Aws::String>
    RegisterTransitGatewayMulticastGroupMembersRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) { SetTransitGatewayMulticastDomainId(std::forward<TransitGatewayMulticastDomainIdT>(value)); return *this;}
    ///@}
    ...
    template<typename GroupIpAddressT = Aws::String>
    RegisterTransitGatewayMulticastGroupMembersRequest& WithGroupIpAddress(GroupIpAddressT&& value) { SetGroupIpAddress(std::forward<GroupIpAddressT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
    RegisterTransitGatewayMulticastGroupMembersRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) { SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value)); return *this;}
    template<typename NetworkInterfaceIdsT = Aws::String>
    RegisterTransitGatewayMulticastGroupMembersRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) { m_networkInterfaceIdsHasBeenSet = true; m_networkInterfaceIds.emplace_back(std::forward<NetworkInterfaceIdsT>(value)); return *this; }
    ///@}
