...
class RegisterTransitGatewayMulticastGroupMembersRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  RegisterTransitGatewayMulticastGroupMembersRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename GroupIpAddressT = Aws::String>
  RegisterTransitGatewayMulticastGroupMembersRequest& WithGroupIpAddress(GroupIpAddressT&& value) {
  ...
  template <typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  RegisterTransitGatewayMulticastGroupMembersRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value));
    return *this;
  }
  template <typename NetworkInterfaceIdsT = Aws::String>
  RegisterTransitGatewayMulticastGroupMembersRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    m_networkInterfaceIdsHasBeenSet = true;
  ...
  inline RegisterTransitGatewayMulticastGroupMembersRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
