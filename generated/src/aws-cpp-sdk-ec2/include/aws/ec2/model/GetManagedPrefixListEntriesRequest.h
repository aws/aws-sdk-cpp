...
class GetManagedPrefixListEntriesRequest : public EC2Request {
 public:
  AWS_EC2_API GetManagedPrefixListEntriesRequest() = default;
 ...
 public:
  ...
  inline GetManagedPrefixListEntriesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrefixListIdT = Aws::String>
  GetManagedPrefixListEntriesRequest& WithPrefixListId(PrefixListIdT&& value) {
  ...
  inline void SetTargetVersion(long long value) {
    m_targetVersionHasBeenSet = true;
    m_targetVersion = value;
  }
  inline GetManagedPrefixListEntriesRequest& WithTargetVersion(long long value) {
  ...
  inline GetManagedPrefixListEntriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetManagedPrefixListEntriesRequest& WithNextToken(NextTokenT&& value) {
