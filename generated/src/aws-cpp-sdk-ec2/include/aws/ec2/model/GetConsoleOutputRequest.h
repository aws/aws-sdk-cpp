...
class GetConsoleOutputRequest : public EC2Request {
 public:
  AWS_EC2_API GetConsoleOutputRequest() = default;
 ...
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetConsoleOutputRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline GetConsoleOutputRequest& WithLatest(bool value) {
    SetLatest(value);
    return *this;
  }
  ///@}
  ...
  inline GetConsoleOutputRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
