...
class DescribeVpcEndpointAssociationsResponse {
 public:
  ...
  void SetVpcEndpointAssociations(VpcEndpointAssociationsT&& value) {
    ...
    m_vpcEndpointAssociations = std::forward<VpcEndpointAssociationsT>(value);
  }
  template <typename VpcEndpointAssociationsT = Aws::Vector<VpcEndpointAssociation>>
  DescribeVpcEndpointAssociationsResponse& WithVpcEndpointAssociations(VpcEndpointAssociationsT&& value) {
    SetVpcEndpointAssociations(std::forward<VpcEndpointAssociationsT>(value));
    return *this;
  }
  ...
  DescribeVpcEndpointAssociationsResponse& AddVpcEndpointAssociations(VpcEndpointAssociationsT&& value) {
    m_vpcEndpointAssociationsHasBeenSet = true;
    m_vpcEndpointAssociations.emplace_back(std::forward<VpcEndpointAssociationsT>(value));
    return *this;
  }
  ///@}
