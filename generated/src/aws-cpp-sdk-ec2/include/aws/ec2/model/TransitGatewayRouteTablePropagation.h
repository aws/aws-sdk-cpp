...
class TransitGatewayRouteTablePropagation {
 public:
  ...
  template <typename TransitGatewayAttachmentIdT = Aws::String>
  TransitGatewayRouteTablePropagation& WithTransitGatewayAttachmentId(TransitGatewayAttachmentIdT&& value) {
  ...
  template <typename ResourceIdT = Aws::String>
  TransitGatewayRouteTablePropagation& WithResourceId(ResourceIdT&& value) {
  ...
  inline TransitGatewayRouteTablePropagation& WithResourceType(TransitGatewayAttachmentResourceType value) {
  ...
  inline TransitGatewayRouteTablePropagation& WithState(TransitGatewayPropagationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename TransitGatewayRouteTableAnnouncementIdT = Aws::String>
  TransitGatewayRouteTablePropagation& WithTransitGatewayRouteTableAnnouncementId(TransitGatewayRouteTableAnnouncementIdT&& value) {
