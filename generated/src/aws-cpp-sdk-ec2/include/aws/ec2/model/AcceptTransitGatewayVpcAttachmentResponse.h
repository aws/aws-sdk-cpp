...
class AcceptTransitGatewayVpcAttachmentResponse {
 public:
  ...
  template <typename TransitGatewayVpcAttachmentT = TransitGatewayVpcAttachment>
  AcceptTransitGatewayVpcAttachmentResponse& WithTransitGatewayVpcAttachment(TransitGatewayVpcAttachmentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AcceptTransitGatewayVpcAttachmentResponse& WithResponseMetadata(ResponseMetadataT&& value) {
