...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API Phase1IntegrityAlgorithmsRequestListValue() = default;
    ...
    template<typename ValueT = Aws::String>
    Phase1IntegrityAlgorithmsRequestListValue& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
