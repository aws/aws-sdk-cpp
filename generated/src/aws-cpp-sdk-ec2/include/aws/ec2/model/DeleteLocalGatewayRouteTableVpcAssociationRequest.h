...
class DeleteLocalGatewayRouteTableVpcAssociationRequest : public EC2Request {
 ...
 public:
  ...
  void SetLocalGatewayRouteTableVpcAssociationId(LocalGatewayRouteTableVpcAssociationIdT&& value) {
    ...
    m_localGatewayRouteTableVpcAssociationId = std::forward<LocalGatewayRouteTableVpcAssociationIdT>(value);
  }
  template <typename LocalGatewayRouteTableVpcAssociationIdT = Aws::String>
  DeleteLocalGatewayRouteTableVpcAssociationRequest& WithLocalGatewayRouteTableVpcAssociationId(
      LocalGatewayRouteTableVpcAssociationIdT&& value) {
    SetLocalGatewayRouteTableVpcAssociationId(std::forward<LocalGatewayRouteTableVpcAssociationIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteLocalGatewayRouteTableVpcAssociationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
