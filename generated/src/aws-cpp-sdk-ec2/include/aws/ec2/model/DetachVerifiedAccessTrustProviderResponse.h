...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DetachVerifiedAccessTrustProviderResponse() = default;
    ...
    template<typename VerifiedAccessTrustProviderT = VerifiedAccessTrustProvider>
    DetachVerifiedAccessTrustProviderResponse& WithVerifiedAccessTrustProvider(VerifiedAccessTrustProviderT&& value) { SetVerifiedAccessTrustProvider(std::forward<VerifiedAccessTrustProviderT>(value)); return *this;}
    ///@}
    ...
    template<typename VerifiedAccessInstanceT = VerifiedAccessInstance>
    DetachVerifiedAccessTrustProviderResponse& WithVerifiedAccessInstance(VerifiedAccessInstanceT&& value) { SetVerifiedAccessInstance(std::forward<VerifiedAccessInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DetachVerifiedAccessTrustProviderResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
