...
class DeleteLaunchTemplateRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteLaunchTemplateRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  DeleteLaunchTemplateRequest& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  DeleteLaunchTemplateRequest& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
