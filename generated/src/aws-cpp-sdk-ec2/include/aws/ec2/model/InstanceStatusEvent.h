...
class InstanceStatusEvent {
 public:
  ...
  inline void SetCode(EventCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline InstanceStatusEvent& WithCode(EventCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  void SetNotBeforeDeadline(NotBeforeDeadlineT&& value) {
    ...
    m_notBeforeDeadline = std::forward<NotBeforeDeadlineT>(value);
  }
  template <typename NotBeforeDeadlineT = Aws::Utils::DateTime>
  InstanceStatusEvent& WithNotBeforeDeadline(NotBeforeDeadlineT&& value) {
    SetNotBeforeDeadline(std::forward<NotBeforeDeadlineT>(value));
    return *this;
  }
  ///@}
 private:
