...
class ModifyVpcBlockPublicAccessExclusionRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyVpcBlockPublicAccessExclusionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ExclusionIdT = Aws::String>
  ModifyVpcBlockPublicAccessExclusionRequest& WithExclusionId(ExclusionIdT&& value) {
  ...
  inline void SetInternetGatewayExclusionMode(InternetGatewayExclusionMode value) {
    m_internetGatewayExclusionModeHasBeenSet = true;
    m_internetGatewayExclusionMode = value;
  }
  inline ModifyVpcBlockPublicAccessExclusionRequest& WithInternetGatewayExclusionMode(InternetGatewayExclusionMode value) {
    SetInternetGatewayExclusionMode(value);
    return *this;
  }
  ///@}
 private:
