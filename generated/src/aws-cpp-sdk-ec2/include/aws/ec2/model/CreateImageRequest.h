...
class CreateImageRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetSnapshotLocation(SnapshotLocationEnum value) {
    m_snapshotLocationHasBeenSet = true;
    m_snapshotLocation = value;
  }
  ...
  inline CreateImageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline CreateImageRequest& WithNoReboot(bool value) {
    SetNoReboot(value);
    return *this;
  }
  ///@}
