...
class DeleteTransitGatewayMulticastDomainRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  DeleteTransitGatewayMulticastDomainRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  inline DeleteTransitGatewayMulticastDomainRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
