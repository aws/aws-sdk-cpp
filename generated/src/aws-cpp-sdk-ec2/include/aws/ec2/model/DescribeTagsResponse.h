...
class DescribeTagsResponse {
 public:
  AWS_EC2_API DescribeTagsResponse() = default;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTagsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename TagsT = Aws::Vector<TagDescription>>
  DescribeTagsResponse& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = TagDescription>
  DescribeTagsResponse& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTagsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
