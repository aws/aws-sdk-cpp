...
class AthenaIntegration {
 public:
  ...
  void SetIntegrationResultS3DestinationArn(IntegrationResultS3DestinationArnT&& value) {
    m_integrationResultS3DestinationArnHasBeenSet = true;
    m_integrationResultS3DestinationArn = std::forward<IntegrationResultS3DestinationArnT>(value);
  }
  template <typename IntegrationResultS3DestinationArnT = Aws::String>
  AthenaIntegration& WithIntegrationResultS3DestinationArn(IntegrationResultS3DestinationArnT&& value) {
    SetIntegrationResultS3DestinationArn(std::forward<IntegrationResultS3DestinationArnT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetPartitionLoadFrequency(PartitionLoadFrequency value) {
    m_partitionLoadFrequencyHasBeenSet = true;
    m_partitionLoadFrequency = value;
  }
  inline AthenaIntegration& WithPartitionLoadFrequency(PartitionLoadFrequency value) {
    SetPartitionLoadFrequency(value);
    return *this;
  }
  ///@}
  ...
  void SetPartitionStartDate(PartitionStartDateT&& value) {
    m_partitionStartDateHasBeenSet = true;
    m_partitionStartDate = std::forward<PartitionStartDateT>(value);
  }
  template <typename PartitionStartDateT = Aws::Utils::DateTime>
  AthenaIntegration& WithPartitionStartDate(PartitionStartDateT&& value) {
    SetPartitionStartDate(std::forward<PartitionStartDateT>(value));
    return *this;
  }
  ///@}
  ...
  void SetPartitionEndDate(PartitionEndDateT&& value) {
    m_partitionEndDateHasBeenSet = true;
    m_partitionEndDate = std::forward<PartitionEndDateT>(value);
  }
  template <typename PartitionEndDateT = Aws::Utils::DateTime>
  AthenaIntegration& WithPartitionEndDate(PartitionEndDateT&& value) {
    SetPartitionEndDate(std::forward<PartitionEndDateT>(value));
    return *this;
  }
  ///@}
 private:
