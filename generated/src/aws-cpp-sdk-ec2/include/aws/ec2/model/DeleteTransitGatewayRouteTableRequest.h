...
class DeleteTransitGatewayRouteTableRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayRouteTableIdT = Aws::String>
  DeleteTransitGatewayRouteTableRequest& WithTransitGatewayRouteTableId(TransitGatewayRouteTableIdT&& value) {
  ...
  inline DeleteTransitGatewayRouteTableRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
