...
class CreateReservedInstancesListingResponse {
 public:
  ...
  template <typename ReservedInstancesListingsT = Aws::Vector<ReservedInstancesListing>>
  CreateReservedInstancesListingResponse& WithReservedInstancesListings(ReservedInstancesListingsT&& value) {
  ...
  CreateReservedInstancesListingResponse& AddReservedInstancesListings(ReservedInstancesListingsT&& value) {
    m_reservedInstancesListingsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateReservedInstancesListingResponse& WithResponseMetadata(ResponseMetadataT&& value) {
