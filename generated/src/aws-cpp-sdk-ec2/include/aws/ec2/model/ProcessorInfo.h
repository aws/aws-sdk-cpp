...
class ProcessorInfo {
 public:
  ...
  void SetSupportedArchitectures(SupportedArchitecturesT&& value) {
    ...
    m_supportedArchitectures = std::forward<SupportedArchitecturesT>(value);
  }
  template <typename SupportedArchitecturesT = Aws::Vector<ArchitectureType>>
  ProcessorInfo& WithSupportedArchitectures(SupportedArchitecturesT&& value) {
    SetSupportedArchitectures(std::forward<SupportedArchitecturesT>(value));
    return *this;
  }
  inline ProcessorInfo& AddSupportedArchitectures(ArchitectureType value) {
    m_supportedArchitecturesHasBeenSet = true;
    m_supportedArchitectures.push_back(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSustainedClockSpeedInGhz(double value) {
    m_sustainedClockSpeedInGhzHasBeenSet = true;
    m_sustainedClockSpeedInGhz = value;
  }
  inline ProcessorInfo& WithSustainedClockSpeedInGhz(double value) {
    SetSustainedClockSpeedInGhz(value);
    return *this;
  }
  ///@}
  ...
  void SetSupportedFeatures(SupportedFeaturesT&& value) {
    ...
    m_supportedFeatures = std::forward<SupportedFeaturesT>(value);
  }
  template <typename SupportedFeaturesT = Aws::Vector<SupportedAdditionalProcessorFeature>>
  ProcessorInfo& WithSupportedFeatures(SupportedFeaturesT&& value) {
    SetSupportedFeatures(std::forward<SupportedFeaturesT>(value));
    return *this;
  }
  inline ProcessorInfo& AddSupportedFeatures(SupportedAdditionalProcessorFeature value) {
    m_supportedFeaturesHasBeenSet = true;
    m_supportedFeatures.push_back(value);
    return *this;
  }
  ///@}
