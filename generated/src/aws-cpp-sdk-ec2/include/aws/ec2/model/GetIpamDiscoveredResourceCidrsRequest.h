...
class GetIpamDiscoveredResourceCidrsRequest : public EC2Request {
 ...
 public:
  ...
  inline GetIpamDiscoveredResourceCidrsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamResourceDiscoveryIdT = Aws::String>
  GetIpamDiscoveredResourceCidrsRequest& WithIpamResourceDiscoveryId(IpamResourceDiscoveryIdT&& value) {
  ...
  template <typename ResourceRegionT = Aws::String>
  GetIpamDiscoveredResourceCidrsRequest& WithResourceRegion(ResourceRegionT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetIpamDiscoveredResourceCidrsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetIpamDiscoveredResourceCidrsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamDiscoveredResourceCidrsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIpamDiscoveredResourceCidrsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
