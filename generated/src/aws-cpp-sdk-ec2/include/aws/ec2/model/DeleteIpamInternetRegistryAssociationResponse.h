...
namespace EC2 {
namespace Model {
class DeleteIpamInternetRegistryAssociationResponse {
 public:
  AWS_EC2_API DeleteIpamInternetRegistryAssociationResponse() = default;
  AWS_EC2_API DeleteIpamInternetRegistryAssociationResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API DeleteIpamInternetRegistryAssociationResponse& operator=(
  ...
  template <typename IpamInternetRegistryAssociationT = IpamInternetRegistryAssociation>
  DeleteIpamInternetRegistryAssociationResponse& WithIpamInternetRegistryAssociation(IpamInternetRegistryAssociationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteIpamInternetRegistryAssociationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
