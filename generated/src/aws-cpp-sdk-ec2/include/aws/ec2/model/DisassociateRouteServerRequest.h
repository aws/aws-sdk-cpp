...
class DisassociateRouteServerRequest : public EC2Request {
 ...
 public:
  ...
  template <typename RouteServerIdT = Aws::String>
  DisassociateRouteServerRequest& WithRouteServerId(RouteServerIdT&& value) {
  ...
  template <typename VpcIdT = Aws::String>
  DisassociateRouteServerRequest& WithVpcId(VpcIdT&& value) {
  ...
  inline DisassociateRouteServerRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
