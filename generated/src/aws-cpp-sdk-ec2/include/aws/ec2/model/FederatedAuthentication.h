...
class FederatedAuthentication {
 public:
  ...
  template <typename SamlProviderArnT = Aws::String>
  FederatedAuthentication& WithSamlProviderArn(SamlProviderArnT&& value) {
  ...
  template <typename SelfServiceSamlProviderArnT = Aws::String>
  FederatedAuthentication& WithSelfServiceSamlProviderArn(SelfServiceSamlProviderArnT&& value) {
