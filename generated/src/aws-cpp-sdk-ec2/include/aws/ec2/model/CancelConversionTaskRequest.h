...
class CancelConversionTaskRequest : public EC2Request {
 ...
 public:
  ...
  inline CancelConversionTaskRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetConversionTaskId(ConversionTaskIdT&& value) {
    m_conversionTaskIdHasBeenSet = true;
    m_conversionTaskId = std::forward<ConversionTaskIdT>(value);
  }
  template <typename ConversionTaskIdT = Aws::String>
  CancelConversionTaskRequest& WithConversionTaskId(ConversionTaskIdT&& value) {
    SetConversionTaskId(std::forward<ConversionTaskIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetReasonMessage(ReasonMessageT&& value) {
    m_reasonMessageHasBeenSet = true;
    m_reasonMessage = std::forward<ReasonMessageT>(value);
  }
  template <typename ReasonMessageT = Aws::String>
  CancelConversionTaskRequest& WithReasonMessage(ReasonMessageT&& value) {
    SetReasonMessage(std::forward<ReasonMessageT>(value));
    return *this;
  }
  ///@}
 private:
