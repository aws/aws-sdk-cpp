...
class DeleteIpamResourceDiscoveryResponse {
 public:
  AWS_EC2_API DeleteIpamResourceDiscoveryResponse() = default;
  ...
  void SetIpamResourceDiscovery(IpamResourceDiscoveryT&& value) {
    m_ipamResourceDiscoveryHasBeenSet = true;
    m_ipamResourceDiscovery = std::forward<IpamResourceDiscoveryT>(value);
  }
  template <typename IpamResourceDiscoveryT = IpamResourceDiscovery>
  DeleteIpamResourceDiscoveryResponse& WithIpamResourceDiscovery(IpamResourceDiscoveryT&& value) {
    SetIpamResourceDiscovery(std::forward<IpamResourceDiscoveryT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteIpamResourceDiscoveryResponse& WithResponseMetadata(ResponseMetadataT&& value) {
