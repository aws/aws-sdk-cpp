...
class ModifyInstanceNetworkPerformanceOptionsResponse {
 public:
  ...
  AWS_EC2_API ModifyInstanceNetworkPerformanceOptionsResponse& operator=(
  ...
  template <typename InstanceIdT = Aws::String>
  ModifyInstanceNetworkPerformanceOptionsResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  inline ModifyInstanceNetworkPerformanceOptionsResponse& WithBandwidthWeighting(InstanceBandwidthWeighting value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyInstanceNetworkPerformanceOptionsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
