...
class DescribeIpamsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeIpamsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeIpamsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  void SetIpamIds(IpamIdsT&& value) {
    m_ipamIdsHasBeenSet = true;
    m_ipamIds = std::forward<IpamIdsT>(value);
  }
  template <typename IpamIdsT = Aws::Vector<Aws::String>>
  DescribeIpamsRequest& WithIpamIds(IpamIdsT&& value) {
    SetIpamIds(std::forward<IpamIdsT>(value));
    return *this;
  }
  template <typename IpamIdsT = Aws::String>
  DescribeIpamsRequest& AddIpamIds(IpamIdsT&& value) {
    m_ipamIdsHasBeenSet = true;
    m_ipamIds.emplace_back(std::forward<IpamIdsT>(value));
    return *this;
  }
  ///@}
 private:
