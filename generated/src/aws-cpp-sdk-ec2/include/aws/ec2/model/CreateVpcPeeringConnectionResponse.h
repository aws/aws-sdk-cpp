...
class CreateVpcPeeringConnectionResponse {
 public:
  ...
  void SetVpcPeeringConnection(VpcPeeringConnectionT&& value) {
    ...
    m_vpcPeeringConnection = std::forward<VpcPeeringConnectionT>(value);
  }
  template <typename VpcPeeringConnectionT = VpcPeeringConnection>
  CreateVpcPeeringConnectionResponse& WithVpcPeeringConnection(VpcPeeringConnectionT&& value) {
    SetVpcPeeringConnection(std::forward<VpcPeeringConnectionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateVpcPeeringConnectionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
