...
class DescribeVpcEndpointConnectionNotificationsResponse {
 public:
  ...
  AWS_EC2_API DescribeVpcEndpointConnectionNotificationsResponse& operator=(
  ...
  void SetConnectionNotificationSet(ConnectionNotificationSetT&& value) {
    ...
    m_connectionNotificationSet = std::forward<ConnectionNotificationSetT>(value);
  }
  template <typename ConnectionNotificationSetT = Aws::Vector<ConnectionNotification>>
  DescribeVpcEndpointConnectionNotificationsResponse& WithConnectionNotificationSet(ConnectionNotificationSetT&& value) {
    SetConnectionNotificationSet(std::forward<ConnectionNotificationSetT>(value));
    return *this;
  }
  ...
  DescribeVpcEndpointConnectionNotificationsResponse& AddConnectionNotificationSet(ConnectionNotificationSetT&& value) {
    m_connectionNotificationSetHasBeenSet = true;
    m_connectionNotificationSet.emplace_back(std::forward<ConnectionNotificationSetT>(value));
    return *this;
  }
  ///@}
