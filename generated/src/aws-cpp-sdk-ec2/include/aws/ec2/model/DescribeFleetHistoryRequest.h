...
class DescribeFleetHistoryRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeFleetHistoryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetEventType(FleetEventType value) {
    m_eventTypeHasBeenSet = true;
    m_eventType = value;
  }
  inline DescribeFleetHistoryRequest& WithEventType(FleetEventType value) {
    SetEventType(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeFleetHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
