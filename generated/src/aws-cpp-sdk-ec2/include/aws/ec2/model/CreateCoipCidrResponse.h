...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateCoipCidrResponse() = default;
    ...
    template<typename CoipCidrT = CoipCidr>
    CreateCoipCidrResponse& WithCoipCidr(CoipCidrT&& value) { SetCoipCidr(std::forward<CoipCidrT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateCoipCidrResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
