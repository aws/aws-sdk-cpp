...
class DescribeAvailabilityZonesRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeAvailabilityZonesRequest& WithAllAvailabilityZones(bool value) {
  ...
  inline DescribeAvailabilityZonesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
