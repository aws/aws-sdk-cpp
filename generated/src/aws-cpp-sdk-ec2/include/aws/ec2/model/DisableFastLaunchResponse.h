...
class DisableFastLaunchResponse {
 public:
  ...
  inline DisableFastLaunchResponse& WithResourceType(FastLaunchResourceType value) {
  ...
  inline DisableFastLaunchResponse& WithMaxParallelLaunches(int value) {
  ...
  inline DisableFastLaunchResponse& WithState(FastLaunchStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
