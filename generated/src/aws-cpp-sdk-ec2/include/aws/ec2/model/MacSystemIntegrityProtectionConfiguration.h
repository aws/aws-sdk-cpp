...
namespace Model
{
  ...
  public:
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithAppleInternal(MacSystemIntegrityProtectionSettingStatus value) { SetAppleInternal(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithBaseSystem(MacSystemIntegrityProtectionSettingStatus value) { SetBaseSystem(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithDebuggingRestrictions(MacSystemIntegrityProtectionSettingStatus value) { SetDebuggingRestrictions(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithDTraceRestrictions(MacSystemIntegrityProtectionSettingStatus value) { SetDTraceRestrictions(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithFilesystemProtections(MacSystemIntegrityProtectionSettingStatus value) { SetFilesystemProtections(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithKextSigning(MacSystemIntegrityProtectionSettingStatus value) { SetKextSigning(value); return *this;}
    ///@}
    ...
    inline MacSystemIntegrityProtectionConfiguration& WithNvramProtections(MacSystemIntegrityProtectionSettingStatus value) { SetNvramProtections(value); return *this;}
    ///@}
    ...
    inline void SetStatus(MacSystemIntegrityProtectionSettingStatus value) { m_statusHasBeenSet = true; m_status = value; }
    inline MacSystemIntegrityProtectionConfiguration& WithStatus(MacSystemIntegrityProtectionSettingStatus value) { SetStatus(value); return *this;}
    ///@}
  private:
