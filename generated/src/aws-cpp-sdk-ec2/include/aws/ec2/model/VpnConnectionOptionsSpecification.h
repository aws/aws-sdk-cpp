...
class VpnConnectionOptionsSpecification {
 public:
  ...
  inline VpnConnectionOptionsSpecification& WithEnableAcceleration(bool value) {
  ...
  inline VpnConnectionOptionsSpecification& WithTunnelInsideIpVersion(TunnelInsideIpVersion value) {
  ...
  inline VpnConnectionOptionsSpecification& WithStaticRoutesOnly(bool value) {
