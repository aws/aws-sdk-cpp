...
class GetNetworkInsightsAccessScopeAnalysisFindingsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename NetworkInsightsAccessScopeAnalysisIdT = Aws::String>
  GetNetworkInsightsAccessScopeAnalysisFindingsRequest& WithNetworkInsightsAccessScopeAnalysisId(
  ...
  inline GetNetworkInsightsAccessScopeAnalysisFindingsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkInsightsAccessScopeAnalysisFindingsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetNetworkInsightsAccessScopeAnalysisFindingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
