...
class ModifyReservedInstancesResponse {
 public:
  ...
  template <typename ReservedInstancesModificationIdT = Aws::String>
  ModifyReservedInstancesResponse& WithReservedInstancesModificationId(ReservedInstancesModificationIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyReservedInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
