...
class IpamResourceDiscovery {
 public:
  ...
  void SetIpamResourceDiscoveryArn(IpamResourceDiscoveryArnT&& value) {
    ...
    m_ipamResourceDiscoveryArn = std::forward<IpamResourceDiscoveryArnT>(value);
  }
  template <typename IpamResourceDiscoveryArnT = Aws::String>
  IpamResourceDiscovery& WithIpamResourceDiscoveryArn(IpamResourceDiscoveryArnT&& value) {
    SetIpamResourceDiscoveryArn(std::forward<IpamResourceDiscoveryArnT>(value));
    return *this;
  }
  ///@}
  ...
  void SetIpamResourceDiscoveryRegion(IpamResourceDiscoveryRegionT&& value) {
    ...
    m_ipamResourceDiscoveryRegion = std::forward<IpamResourceDiscoveryRegionT>(value);
  }
  template <typename IpamResourceDiscoveryRegionT = Aws::String>
  IpamResourceDiscovery& WithIpamResourceDiscoveryRegion(IpamResourceDiscoveryRegionT&& value) {
    SetIpamResourceDiscoveryRegion(std::forward<IpamResourceDiscoveryRegionT>(value));
    return *this;
  }
  ///@}
  ...
  inline IpamResourceDiscovery& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  inline void SetState(IpamResourceDiscoveryState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline IpamResourceDiscovery& WithState(IpamResourceDiscoveryState value) {
    SetState(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::Vector<IpamOrganizationalUnitExclusion>& GetOrganizationalUnitExclusions() const {
    return m_organizationalUnitExclusions;
  }
  ...
  void SetOrganizationalUnitExclusions(OrganizationalUnitExclusionsT&& value) {
    ...
    m_organizationalUnitExclusions = std::forward<OrganizationalUnitExclusionsT>(value);
  }
  template <typename OrganizationalUnitExclusionsT = Aws::Vector<IpamOrganizationalUnitExclusion>>
  IpamResourceDiscovery& WithOrganizationalUnitExclusions(OrganizationalUnitExclusionsT&& value) {
    SetOrganizationalUnitExclusions(std::forward<OrganizationalUnitExclusionsT>(value));
    return *this;
  }
  ...
  IpamResourceDiscovery& AddOrganizationalUnitExclusions(OrganizationalUnitExclusionsT&& value) {
    m_organizationalUnitExclusionsHasBeenSet = true;
    m_organizationalUnitExclusions.emplace_back(std::forward<OrganizationalUnitExclusionsT>(value));
    return *this;
  }
  ///@}
 private:
