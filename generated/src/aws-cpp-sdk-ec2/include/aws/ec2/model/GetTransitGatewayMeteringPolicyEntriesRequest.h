...
/**
 */
class GetTransitGatewayMeteringPolicyEntriesRequest : public EC2Request {
 public:
  AWS_EC2_API GetTransitGatewayMeteringPolicyEntriesRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "GetTransitGatewayMeteringPolicyEntries"; }
 ...
 public:
  ...
  template <typename TransitGatewayMeteringPolicyIdT = Aws::String>
  GetTransitGatewayMeteringPolicyEntriesRequest& WithTransitGatewayMeteringPolicyId(TransitGatewayMeteringPolicyIdT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetTransitGatewayMeteringPolicyEntriesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetTransitGatewayMeteringPolicyEntriesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetTransitGatewayMeteringPolicyEntriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayMeteringPolicyEntriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetTransitGatewayMeteringPolicyEntriesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
