...
class IpamPoolCidrFailureReason {
 public:
  ...
  inline void SetCode(IpamPoolCidrFailureCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline IpamPoolCidrFailureReason& WithCode(IpamPoolCidrFailureCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  IpamPoolCidrFailureReason& WithMessage(MessageT&& value) {
