...
class ClientVpnConnectionStatus {
 public:
  ...
  inline void SetCode(ClientVpnConnectionStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline ClientVpnConnectionStatus& WithCode(ClientVpnConnectionStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  ClientVpnConnectionStatus& WithMessage(MessageT&& value) {
