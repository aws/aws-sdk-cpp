...
/**
 */
class ModifyTransitGatewayPolicyTableEntryRequest : public EC2Request {
 public:
  AWS_EC2_API ModifyTransitGatewayPolicyTableEntryRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "ModifyTransitGatewayPolicyTableEntry"; }
 ...
 public:
  ...
  template <typename TransitGatewayPolicyTableIdT = Aws::String>
  ModifyTransitGatewayPolicyTableEntryRequest& WithTransitGatewayPolicyTableId(TransitGatewayPolicyTableIdT&& value) {
  ...
  template <typename PolicyRuleNumberT = Aws::String>
  ModifyTransitGatewayPolicyTableEntryRequest& WithPolicyRuleNumber(PolicyRuleNumberT&& value) {
  ...
  ///@{
  /**
   * <p>The updated matching criteria for the policy table entry. Unspecified fields
  ...
  template <typename PolicyRuleT = TransitGatewayRequestPolicyRule>
  ModifyTransitGatewayPolicyTableEntryRequest& WithPolicyRule(PolicyRuleT&& value) {
  ...
  template <typename TargetRouteTableIdT = Aws::String>
  ModifyTransitGatewayPolicyTableEntryRequest& WithTargetRouteTableId(TargetRouteTableIdT&& value) {
  ...
  inline ModifyTransitGatewayPolicyTableEntryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
