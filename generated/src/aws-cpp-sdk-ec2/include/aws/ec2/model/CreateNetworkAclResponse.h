...
class CreateNetworkAclResponse {
 public:
  ...
  void SetNetworkAcl(NetworkAclT&& value) {
    m_networkAclHasBeenSet = true;
    m_networkAcl = std::forward<NetworkAclT>(value);
  }
  template <typename NetworkAclT = NetworkAcl>
  CreateNetworkAclResponse& WithNetworkAcl(NetworkAclT&& value) {
    SetNetworkAcl(std::forward<NetworkAclT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  CreateNetworkAclResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateNetworkAclResponse& WithResponseMetadata(ResponseMetadataT&& value) {
