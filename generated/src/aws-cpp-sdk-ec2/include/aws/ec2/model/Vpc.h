...
class Vpc {
 public:
  ...
  inline Vpc& WithInstanceTenancy(Tenancy value) {
  ...
  void SetCidrBlockAssociationSet(CidrBlockAssociationSetT&& value) {
    ...
    m_cidrBlockAssociationSet = std::forward<CidrBlockAssociationSetT>(value);
  }
  template <typename CidrBlockAssociationSetT = Aws::Vector<VpcCidrBlockAssociation>>
  Vpc& WithCidrBlockAssociationSet(CidrBlockAssociationSetT&& value) {
    SetCidrBlockAssociationSet(std::forward<CidrBlockAssociationSetT>(value));
    return *this;
  }
  ...
  Vpc& AddCidrBlockAssociationSet(CidrBlockAssociationSetT&& value) {
    m_cidrBlockAssociationSetHasBeenSet = true;
    m_cidrBlockAssociationSet.emplace_back(std::forward<CidrBlockAssociationSetT>(value));
    return *this;
  }
  ///@}
  ...
  inline Vpc& WithIsDefault(bool value) {
    SetIsDefault(value);
    return *this;
  }
  ///@}
  ...
  void SetEncryptionControl(EncryptionControlT&& value) {
    ...
    m_encryptionControl = std::forward<EncryptionControlT>(value);
  }
  template <typename EncryptionControlT = VpcEncryptionControl>
  Vpc& WithEncryptionControl(EncryptionControlT&& value) {
    SetEncryptionControl(std::forward<EncryptionControlT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(VpcState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline Vpc& WithState(VpcState value) {
    SetState(value);
    return *this;
  }
  ///@}
