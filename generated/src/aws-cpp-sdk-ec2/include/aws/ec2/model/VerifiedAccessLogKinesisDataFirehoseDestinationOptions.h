...
class VerifiedAccessLogKinesisDataFirehoseDestinationOptions {
 public:
  ...
  inline VerifiedAccessLogKinesisDataFirehoseDestinationOptions& WithEnabled(bool value) {
    SetEnabled(value);
    return *this;
  }
  ///@}
  ...
  template <typename DeliveryStreamT = Aws::String>
  VerifiedAccessLogKinesisDataFirehoseDestinationOptions& WithDeliveryStream(DeliveryStreamT&& value) {
