...
class DescribeCapacityReservationBillingRequestsRequest : public EC2Request {
 ...
 public:
  ...
  template <typename CapacityReservationIdsT = Aws::Vector<Aws::String>>
  DescribeCapacityReservationBillingRequestsRequest& WithCapacityReservationIds(CapacityReservationIdsT&& value) {
    SetCapacityReservationIds(std::forward<CapacityReservationIdsT>(value));
    return *this;
  }
  template <typename CapacityReservationIdsT = Aws::String>
  DescribeCapacityReservationBillingRequestsRequest& AddCapacityReservationIds(CapacityReservationIdsT&& value) {
    m_capacityReservationIdsHasBeenSet = true;
  ...
  inline void SetRole(CallerRole value) {
    m_roleHasBeenSet = true;
    m_role = value;
  }
  inline DescribeCapacityReservationBillingRequestsRequest& WithRole(CallerRole value) {
    SetRole(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityReservationBillingRequestsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeCapacityReservationBillingRequestsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeCapacityReservationBillingRequestsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeCapacityReservationBillingRequestsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeCapacityReservationBillingRequestsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
