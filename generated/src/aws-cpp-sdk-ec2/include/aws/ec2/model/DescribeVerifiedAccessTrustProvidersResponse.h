...
class DescribeVerifiedAccessTrustProvidersResponse {
 public:
  ...
  AWS_EC2_API DescribeVerifiedAccessTrustProvidersResponse& operator=(
  ...
  template <typename VerifiedAccessTrustProvidersT = Aws::Vector<VerifiedAccessTrustProvider>>
  DescribeVerifiedAccessTrustProvidersResponse& WithVerifiedAccessTrustProviders(VerifiedAccessTrustProvidersT&& value) {
  ...
  DescribeVerifiedAccessTrustProvidersResponse& AddVerifiedAccessTrustProviders(VerifiedAccessTrustProvidersT&& value) {
    m_verifiedAccessTrustProvidersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVerifiedAccessTrustProvidersResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVerifiedAccessTrustProvidersResponse& WithResponseMetadata(ResponseMetadataT&& value) {
