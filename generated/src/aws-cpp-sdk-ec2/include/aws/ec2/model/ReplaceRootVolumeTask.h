...
class ReplaceRootVolumeTask {
 public:
  ...
  void SetReplaceRootVolumeTaskId(ReplaceRootVolumeTaskIdT&& value) {
    ...
    m_replaceRootVolumeTaskId = std::forward<ReplaceRootVolumeTaskIdT>(value);
  }
  template <typename ReplaceRootVolumeTaskIdT = Aws::String>
  ReplaceRootVolumeTask& WithReplaceRootVolumeTaskId(ReplaceRootVolumeTaskIdT&& value) {
    SetReplaceRootVolumeTaskId(std::forward<ReplaceRootVolumeTaskIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTaskState(ReplaceRootVolumeTaskState value) {
    m_taskStateHasBeenSet = true;
    m_taskState = value;
  }
  inline ReplaceRootVolumeTask& WithTaskState(ReplaceRootVolumeTaskState value) {
    SetTaskState(value);
    return *this;
  }
  ///@}
  ...
  void SetCompleteTime(CompleteTimeT&& value) {
    ...
    m_completeTime = std::forward<CompleteTimeT>(value);
  }
  template <typename CompleteTimeT = Aws::String>
  ReplaceRootVolumeTask& WithCompleteTime(CompleteTimeT&& value) {
    SetCompleteTime(std::forward<CompleteTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReplaceRootVolumeTask& WithDeleteReplacedRootVolume(bool value) {
