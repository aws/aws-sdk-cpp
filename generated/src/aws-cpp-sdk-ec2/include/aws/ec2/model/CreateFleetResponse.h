...
class CreateFleetResponse {
 public:
  ...
  template <typename FleetIdT = Aws::String>
  CreateFleetResponse& WithFleetId(FleetIdT&& value) {
  ...
  template <typename ErrorsT = Aws::Vector<CreateFleetError>>
  CreateFleetResponse& WithErrors(ErrorsT&& value) {
    SetErrors(std::forward<ErrorsT>(value));
    return *this;
  }
  template <typename ErrorsT = CreateFleetError>
  CreateFleetResponse& AddErrors(ErrorsT&& value) {
    m_errorsHasBeenSet = true;
  ...
  template <typename InstancesT = Aws::Vector<CreateFleetInstance>>
  CreateFleetResponse& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = CreateFleetInstance>
  CreateFleetResponse& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateFleetResponse& WithResponseMetadata(ResponseMetadataT&& value) {
