...
class ExportVerifiedAccessInstanceClientConfigurationRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  ExportVerifiedAccessInstanceClientConfigurationRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  inline ExportVerifiedAccessInstanceClientConfigurationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
