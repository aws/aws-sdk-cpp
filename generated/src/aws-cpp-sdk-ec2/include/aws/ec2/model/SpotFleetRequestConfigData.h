...
class SpotFleetRequestConfigData {
 public:
  ...
  inline SpotFleetRequestConfigData& WithAllocationStrategy(AllocationStrategy value) {
  ...
  inline void SetOnDemandAllocationStrategy(OnDemandAllocationStrategy value) {
    m_onDemandAllocationStrategyHasBeenSet = true;
    m_onDemandAllocationStrategy = value;
  }
  inline SpotFleetRequestConfigData& WithOnDemandAllocationStrategy(OnDemandAllocationStrategy value) {
    SetOnDemandAllocationStrategy(value);
    return *this;
  }
  ///@}
  ...
  void SetSpotMaintenanceStrategies(SpotMaintenanceStrategiesT&& value) {
    ...
    m_spotMaintenanceStrategies = std::forward<SpotMaintenanceStrategiesT>(value);
  }
  template <typename SpotMaintenanceStrategiesT = SpotMaintenanceStrategies>
  SpotFleetRequestConfigData& WithSpotMaintenanceStrategies(SpotMaintenanceStrategiesT&& value) {
    SetSpotMaintenanceStrategies(std::forward<SpotMaintenanceStrategiesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetExcessCapacityTerminationPolicy(ExcessCapacityTerminationPolicy value) {
    m_excessCapacityTerminationPolicyHasBeenSet = true;
    m_excessCapacityTerminationPolicy = value;
  }
  inline SpotFleetRequestConfigData& WithExcessCapacityTerminationPolicy(ExcessCapacityTerminationPolicy value) {
  ...
  inline SpotFleetRequestConfigData& WithFulfilledCapacity(double value) {
  ...
  inline void SetOnDemandFulfilledCapacity(double value) {
    m_onDemandFulfilledCapacityHasBeenSet = true;
    m_onDemandFulfilledCapacity = value;
  }
  inline SpotFleetRequestConfigData& WithOnDemandFulfilledCapacity(double value) {
    SetOnDemandFulfilledCapacity(value);
    return *this;
  }
  ///@}
  ...
  void SetIamFleetRole(IamFleetRoleT&& value) {
    ...
    m_iamFleetRole = std::forward<IamFleetRoleT>(value);
  }
  template <typename IamFleetRoleT = Aws::String>
  SpotFleetRequestConfigData& WithIamFleetRole(IamFleetRoleT&& value) {
    SetIamFleetRole(std::forward<IamFleetRoleT>(value));
    return *this;
  }
  ///@}
  ...
  SpotFleetRequestConfigData& AddLaunchSpecifications(LaunchSpecificationsT&& value) {
    m_launchSpecificationsHasBeenSet = true;
    m_launchSpecifications.emplace_back(std::forward<LaunchSpecificationsT>(value));
    return *this;
  }
  ///@}
  ...
  inline SpotFleetRequestConfigData& WithTargetCapacity(int value) {
  ...
  inline SpotFleetRequestConfigData& WithOnDemandTargetCapacity(int value) {
  ...
  void SetOnDemandMaxTotalPrice(OnDemandMaxTotalPriceT&& value) {
    ...
    m_onDemandMaxTotalPrice = std::forward<OnDemandMaxTotalPriceT>(value);
  }
  template <typename OnDemandMaxTotalPriceT = Aws::String>
  SpotFleetRequestConfigData& WithOnDemandMaxTotalPrice(OnDemandMaxTotalPriceT&& value) {
    SetOnDemandMaxTotalPrice(std::forward<OnDemandMaxTotalPriceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetSpotMaxTotalPrice(SpotMaxTotalPriceT&& value) {
    ...
    m_spotMaxTotalPrice = std::forward<SpotMaxTotalPriceT>(value);
  }
  template <typename SpotMaxTotalPriceT = Aws::String>
  SpotFleetRequestConfigData& WithSpotMaxTotalPrice(SpotMaxTotalPriceT&& value) {
    SetSpotMaxTotalPrice(std::forward<SpotMaxTotalPriceT>(value));
    return *this;
  }
  ///@}
  ...
  inline SpotFleetRequestConfigData& WithTerminateInstancesWithExpiration(bool value) {
  ...
  inline SpotFleetRequestConfigData& WithType(FleetType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  inline SpotFleetRequestConfigData& WithReplaceUnhealthyInstances(bool value) {
  ...
  inline SpotFleetRequestConfigData& WithInstanceInterruptionBehavior(InstanceInterruptionBehavior value) {
  ...
  void SetLoadBalancersConfig(LoadBalancersConfigT&& value) {
    ...
    m_loadBalancersConfig = std::forward<LoadBalancersConfigT>(value);
  }
  template <typename LoadBalancersConfigT = LoadBalancersConfig>
  SpotFleetRequestConfigData& WithLoadBalancersConfig(LoadBalancersConfigT&& value) {
    SetLoadBalancersConfig(std::forward<LoadBalancersConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline SpotFleetRequestConfigData& WithInstancePoolsToUseCount(int value) {
  ...
  inline SpotFleetRequestConfigData& WithTargetCapacityUnitType(TargetCapacityUnitType value) {
