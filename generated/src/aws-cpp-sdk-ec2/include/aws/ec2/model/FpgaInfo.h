...
class FpgaInfo {
 public:
  ...
  void SetFpgas(FpgasT&& value) {
    ...
    m_fpgas = std::forward<FpgasT>(value);
  }
  template <typename FpgasT = Aws::Vector<FpgaDeviceInfo>>
  FpgaInfo& WithFpgas(FpgasT&& value) {
    SetFpgas(std::forward<FpgasT>(value));
    return *this;
  }
  template <typename FpgasT = FpgaDeviceInfo>
  FpgaInfo& AddFpgas(FpgasT&& value) {
    m_fpgasHasBeenSet = true;
    m_fpgas.emplace_back(std::forward<FpgasT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalFpgaMemoryInMiB(int value) {
    m_totalFpgaMemoryInMiBHasBeenSet = true;
    m_totalFpgaMemoryInMiB = value;
  }
  inline FpgaInfo& WithTotalFpgaMemoryInMiB(int value) {
    SetTotalFpgaMemoryInMiB(value);
    return *this;
  }
  ///@}
 private:
