...
/**
 * <p>Information about a requested IPAM policy allocation rule.</p> <p>Allocation
 ...
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/IpamPolicyAllocationRuleRequest">AWS
 * API Reference</a></p>
 */
class IpamPolicyAllocationRuleRequest {
 public:
  AWS_EC2_API IpamPolicyAllocationRuleRequest() = default;
  AWS_EC2_API IpamPolicyAllocationRuleRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API IpamPolicyAllocationRuleRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  ///@{
  /**
   * <p>The ID of the source IPAM pool for the requested allocation rule.</p> <p>An
   * IPAM pool is a collection of IP addresses in IPAM that can be allocated to
  ...
  template <typename SourceIpamPoolIdT = Aws::String>
  IpamPolicyAllocationRuleRequest& WithSourceIpamPoolId(SourceIpamPoolIdT&& value) {
