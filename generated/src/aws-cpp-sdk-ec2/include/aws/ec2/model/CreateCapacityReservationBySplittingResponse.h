...
class CreateCapacityReservationBySplittingResponse {
 public:
  ...
  AWS_EC2_API CreateCapacityReservationBySplittingResponse& operator=(
  ...
  template <typename SourceCapacityReservationT = CapacityReservation>
  CreateCapacityReservationBySplittingResponse& WithSourceCapacityReservation(SourceCapacityReservationT&& value) {
  ...
  template <typename DestinationCapacityReservationT = CapacityReservation>
  CreateCapacityReservationBySplittingResponse& WithDestinationCapacityReservation(DestinationCapacityReservationT&& value) {
  ...
  inline CreateCapacityReservationBySplittingResponse& WithInstanceCount(int value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateCapacityReservationBySplittingResponse& WithResponseMetadata(ResponseMetadataT&& value) {
