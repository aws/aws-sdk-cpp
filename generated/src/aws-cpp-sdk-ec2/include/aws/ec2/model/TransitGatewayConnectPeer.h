...
class TransitGatewayConnectPeer {
 public:
  ...
  void SetTransitGatewayConnectPeerId(TransitGatewayConnectPeerIdT&& value) {
    ...
    m_transitGatewayConnectPeerId = std::forward<TransitGatewayConnectPeerIdT>(value);
  }
  template <typename TransitGatewayConnectPeerIdT = Aws::String>
  TransitGatewayConnectPeer& WithTransitGatewayConnectPeerId(TransitGatewayConnectPeerIdT&& value) {
    SetTransitGatewayConnectPeerId(std::forward<TransitGatewayConnectPeerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(TransitGatewayConnectPeerState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline TransitGatewayConnectPeer& WithState(TransitGatewayConnectPeerState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetConnectPeerConfiguration(ConnectPeerConfigurationT&& value) {
    ...
    m_connectPeerConfiguration = std::forward<ConnectPeerConfigurationT>(value);
  }
  template <typename ConnectPeerConfigurationT = TransitGatewayConnectPeerConfiguration>
  TransitGatewayConnectPeer& WithConnectPeerConfiguration(ConnectPeerConfigurationT&& value) {
    SetConnectPeerConfiguration(std::forward<ConnectPeerConfigurationT>(value));
    return *this;
  }
  ///@}
