...
class DescribeFastSnapshotRestoresResponse {
 public:
  ...
  void SetFastSnapshotRestores(FastSnapshotRestoresT&& value) {
    m_fastSnapshotRestoresHasBeenSet = true;
    m_fastSnapshotRestores = std::forward<FastSnapshotRestoresT>(value);
  }
  template <typename FastSnapshotRestoresT = Aws::Vector<DescribeFastSnapshotRestoreSuccessItem>>
  DescribeFastSnapshotRestoresResponse& WithFastSnapshotRestores(FastSnapshotRestoresT&& value) {
    SetFastSnapshotRestores(std::forward<FastSnapshotRestoresT>(value));
    return *this;
  }
  template <typename FastSnapshotRestoresT = DescribeFastSnapshotRestoreSuccessItem>
  DescribeFastSnapshotRestoresResponse& AddFastSnapshotRestores(FastSnapshotRestoresT&& value) {
    m_fastSnapshotRestoresHasBeenSet = true;
    m_fastSnapshotRestores.emplace_back(std::forward<FastSnapshotRestoresT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFastSnapshotRestoresResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFastSnapshotRestoresResponse& WithResponseMetadata(ResponseMetadataT&& value) {
