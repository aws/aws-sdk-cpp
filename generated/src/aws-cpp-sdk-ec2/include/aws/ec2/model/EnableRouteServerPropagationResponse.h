...
class EnableRouteServerPropagationResponse {
 public:
  ...
  template <typename RouteServerPropagationT = RouteServerPropagation>
  EnableRouteServerPropagationResponse& WithRouteServerPropagation(RouteServerPropagationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableRouteServerPropagationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
