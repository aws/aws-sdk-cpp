...
class PeeringConnectionOptions {
 public:
  ...
  inline PeeringConnectionOptions& WithAllowDnsResolutionFromRemoteVpc(bool value) {
  ...
  inline PeeringConnectionOptions& WithAllowEgressFromLocalClassicLinkToRemoteVpc(bool value) {
  ...
  inline PeeringConnectionOptions& WithAllowEgressFromLocalVpcToRemoteClassicLink(bool value) {
