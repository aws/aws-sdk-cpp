...
class DescribeClientVpnAuthorizationRulesRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeClientVpnAuthorizationRulesRequest() = default;
 ...
 public:
  ...
  template <typename ClientVpnEndpointIdT = Aws::String>
  DescribeClientVpnAuthorizationRulesRequest& WithClientVpnEndpointId(ClientVpnEndpointIdT&& value) {
  ...
  inline DescribeClientVpnAuthorizationRulesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClientVpnAuthorizationRulesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeClientVpnAuthorizationRulesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeClientVpnAuthorizationRulesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeClientVpnAuthorizationRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
