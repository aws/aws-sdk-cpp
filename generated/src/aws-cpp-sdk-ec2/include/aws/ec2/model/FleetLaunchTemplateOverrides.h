...
class FleetLaunchTemplateOverrides {
 public:
  ...
  inline FleetLaunchTemplateOverrides& WithInstanceType(InstanceType value) {
  ...
  inline FleetLaunchTemplateOverrides& WithWeightedCapacity(double value) {
  ...
  inline FleetLaunchTemplateOverrides& WithPriority(double value) {
    SetPriority(value);
    return *this;
  }
  ///@}
