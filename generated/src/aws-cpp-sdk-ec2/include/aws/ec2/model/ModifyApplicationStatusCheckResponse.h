...
namespace EC2 {
namespace Model {
class ModifyApplicationStatusCheckResponse {
 public:
  AWS_EC2_API ModifyApplicationStatusCheckResponse() = default;
  AWS_EC2_API ModifyApplicationStatusCheckResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API ModifyApplicationStatusCheckResponse& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ApplicationStatusCheckT = ApplicationStatusCheckResponseObject>
  ModifyApplicationStatusCheckResponse& WithApplicationStatusCheck(ApplicationStatusCheckT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyApplicationStatusCheckResponse& WithResponseMetadata(ResponseMetadataT&& value) {
