...
class LaunchTemplateTagSpecificationRequest {
 public:
  ...
  inline LaunchTemplateTagSpecificationRequest& WithResourceType(ResourceType value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  LaunchTemplateTagSpecificationRequest& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  LaunchTemplateTagSpecificationRequest& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
