...
namespace Model
{
  ...
  public:
     ...
     * | <code>spot-instances-request</code>. If the instance does include the resource
     * type that you specify, the instance launch fails. For example, not all instance
     * types include an Elastic GPU.</p> <p>To tag a resource after it has been
     * created, see <a
