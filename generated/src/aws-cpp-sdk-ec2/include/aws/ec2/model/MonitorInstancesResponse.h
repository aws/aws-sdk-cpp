...
class MonitorInstancesResponse {
 public:
  ...
  template <typename InstanceMonitoringsT = Aws::Vector<InstanceMonitoring>>
  MonitorInstancesResponse& WithInstanceMonitorings(InstanceMonitoringsT&& value) {
    SetInstanceMonitorings(std::forward<InstanceMonitoringsT>(value));
    return *this;
  }
  template <typename InstanceMonitoringsT = InstanceMonitoring>
  MonitorInstancesResponse& AddInstanceMonitorings(InstanceMonitoringsT&& value) {
    m_instanceMonitoringsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  MonitorInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
