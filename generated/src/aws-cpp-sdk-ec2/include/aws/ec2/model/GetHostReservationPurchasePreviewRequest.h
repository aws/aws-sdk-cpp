...
class GetHostReservationPurchasePreviewRequest : public EC2Request {
 ...
 public:
  ...
  void SetHostIdSet(HostIdSetT&& value) {
    ...
    m_hostIdSet = std::forward<HostIdSetT>(value);
  }
  template <typename HostIdSetT = Aws::Vector<Aws::String>>
  GetHostReservationPurchasePreviewRequest& WithHostIdSet(HostIdSetT&& value) {
    SetHostIdSet(std::forward<HostIdSetT>(value));
    return *this;
  }
  template <typename HostIdSetT = Aws::String>
  GetHostReservationPurchasePreviewRequest& AddHostIdSet(HostIdSetT&& value) {
    m_hostIdSetHasBeenSet = true;
    m_hostIdSet.emplace_back(std::forward<HostIdSetT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename OfferingIdT = Aws::String>
  GetHostReservationPurchasePreviewRequest& WithOfferingId(OfferingIdT&& value) {
