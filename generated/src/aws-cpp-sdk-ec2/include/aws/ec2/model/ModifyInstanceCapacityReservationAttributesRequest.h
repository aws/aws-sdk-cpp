...
class ModifyInstanceCapacityReservationAttributesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ModifyInstanceCapacityReservationAttributesRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename CapacityReservationSpecificationT = CapacityReservationSpecification>
  ModifyInstanceCapacityReservationAttributesRequest& WithCapacityReservationSpecification(CapacityReservationSpecificationT&& value) {
  ...
  inline ModifyInstanceCapacityReservationAttributesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
