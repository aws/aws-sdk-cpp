...
class DeleteTransitGatewayPolicyTableResponse {
 public:
  ...
  template <typename TransitGatewayPolicyTableT = TransitGatewayPolicyTable>
  DeleteTransitGatewayPolicyTableResponse& WithTransitGatewayPolicyTable(TransitGatewayPolicyTableT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayPolicyTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
