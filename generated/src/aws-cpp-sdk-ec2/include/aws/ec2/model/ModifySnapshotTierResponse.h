...
class ModifySnapshotTierResponse {
 public:
  ...
  template <typename SnapshotIdT = Aws::String>
  ModifySnapshotTierResponse& WithSnapshotId(SnapshotIdT&& value) {
  ...
  void SetTieringStartTime(TieringStartTimeT&& value) {
    m_tieringStartTimeHasBeenSet = true;
    m_tieringStartTime = std::forward<TieringStartTimeT>(value);
  }
  template <typename TieringStartTimeT = Aws::Utils::DateTime>
  ModifySnapshotTierResponse& WithTieringStartTime(TieringStartTimeT&& value) {
    SetTieringStartTime(std::forward<TieringStartTimeT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifySnapshotTierResponse& WithResponseMetadata(ResponseMetadataT&& value) {
