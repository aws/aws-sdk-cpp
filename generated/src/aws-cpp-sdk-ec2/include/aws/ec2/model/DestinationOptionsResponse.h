...
class DestinationOptionsResponse {
 public:
  ...
  inline void SetFileFormat(DestinationFileFormat value) {
    m_fileFormatHasBeenSet = true;
    m_fileFormat = value;
  }
  inline DestinationOptionsResponse& WithFileFormat(DestinationFileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline void SetHiveCompatiblePartitions(bool value) {
    m_hiveCompatiblePartitionsHasBeenSet = true;
    m_hiveCompatiblePartitions = value;
  }
  inline DestinationOptionsResponse& WithHiveCompatiblePartitions(bool value) {
    SetHiveCompatiblePartitions(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPerHourPartition(bool value) {
    m_perHourPartitionHasBeenSet = true;
    m_perHourPartition = value;
  }
  inline DestinationOptionsResponse& WithPerHourPartition(bool value) {
    SetPerHourPartition(value);
    return *this;
  }
  ///@}
 private:
