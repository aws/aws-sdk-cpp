...
class DescribeImageReferencesRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetIncludeAllResourceTypes(bool value) {
    m_includeAllResourceTypesHasBeenSet = true;
    m_includeAllResourceTypes = value;
  }
  inline DescribeImageReferencesRequest& WithIncludeAllResourceTypes(bool value) {
    SetIncludeAllResourceTypes(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeImageReferencesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeImageReferencesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
