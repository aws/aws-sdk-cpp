...
class DescribeReservedInstancesListingsResponse {
 public:
  AWS_EC2_API DescribeReservedInstancesListingsResponse() = default;
  ...
  void SetReservedInstancesListings(ReservedInstancesListingsT&& value) {
    m_reservedInstancesListingsHasBeenSet = true;
    m_reservedInstancesListings = std::forward<ReservedInstancesListingsT>(value);
  }
  template <typename ReservedInstancesListingsT = Aws::Vector<ReservedInstancesListing>>
  DescribeReservedInstancesListingsResponse& WithReservedInstancesListings(ReservedInstancesListingsT&& value) {
    SetReservedInstancesListings(std::forward<ReservedInstancesListingsT>(value));
    return *this;
  }
  template <typename ReservedInstancesListingsT = ReservedInstancesListing>
  DescribeReservedInstancesListingsResponse& AddReservedInstancesListings(ReservedInstancesListingsT&& value) {
    m_reservedInstancesListingsHasBeenSet = true;
    m_reservedInstancesListings.emplace_back(std::forward<ReservedInstancesListingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeReservedInstancesListingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
