...
class IpamPoolCidr {
 public:
  ...
  inline void SetState(IpamPoolCidrState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline IpamPoolCidr& WithState(IpamPoolCidrState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  void SetIpamPoolCidrId(IpamPoolCidrIdT&& value) {
    ...
    m_ipamPoolCidrId = std::forward<IpamPoolCidrIdT>(value);
  }
  template <typename IpamPoolCidrIdT = Aws::String>
  IpamPoolCidr& WithIpamPoolCidrId(IpamPoolCidrIdT&& value) {
    SetIpamPoolCidrId(std::forward<IpamPoolCidrIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline IpamPoolCidr& WithNetmaskLength(int value) {
