...
class MacHost {
 public:
  ...
  template <typename HostIdT = Aws::String>
  MacHost& WithHostId(HostIdT&& value) {
  ...
  void SetMacOSLatestSupportedVersions(MacOSLatestSupportedVersionsT&& value) {
    m_macOSLatestSupportedVersionsHasBeenSet = true;
    m_macOSLatestSupportedVersions = std::forward<MacOSLatestSupportedVersionsT>(value);
  }
  template <typename MacOSLatestSupportedVersionsT = Aws::Vector<Aws::String>>
  MacHost& WithMacOSLatestSupportedVersions(MacOSLatestSupportedVersionsT&& value) {
    SetMacOSLatestSupportedVersions(std::forward<MacOSLatestSupportedVersionsT>(value));
    return *this;
  }
  template <typename MacOSLatestSupportedVersionsT = Aws::String>
  MacHost& AddMacOSLatestSupportedVersions(MacOSLatestSupportedVersionsT&& value) {
    m_macOSLatestSupportedVersionsHasBeenSet = true;
    m_macOSLatestSupportedVersions.emplace_back(std::forward<MacOSLatestSupportedVersionsT>(value));
    return *this;
  }
  ///@}
 private:
