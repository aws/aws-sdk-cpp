...
namespace Model
{
  ...
  public:
    ...
    template<typename CapacityReservationIdT = Aws::String>
    GetCapacityReservationUsageRequest& WithCapacityReservationId(CapacityReservationIdT&& value) { SetCapacityReservationId(std::forward<CapacityReservationIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NextTokenT = Aws::String>
    GetCapacityReservationUsageRequest& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
