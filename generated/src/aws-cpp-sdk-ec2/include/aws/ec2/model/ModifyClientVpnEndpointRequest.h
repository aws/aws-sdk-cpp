...
class ModifyClientVpnEndpointRequest : public EC2Request {
 ...
 public:
  ...
  void SetDnsServers(DnsServersT&& value) {
    ...
    m_dnsServers = std::forward<DnsServersT>(value);
  }
  template <typename DnsServersT = DnsServersOptionsModifyStructure>
  ModifyClientVpnEndpointRequest& WithDnsServers(DnsServersT&& value) {
    SetDnsServers(std::forward<DnsServersT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyClientVpnEndpointRequest& WithVpnPort(int value) {
    SetVpnPort(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyClientVpnEndpointRequest& WithSplitTunnel(bool value) {
  ...
  inline ModifyClientVpnEndpointRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetSelfServicePortal(SelfServicePortal value) {
    m_selfServicePortalHasBeenSet = true;
    m_selfServicePortal = value;
  }
  inline ModifyClientVpnEndpointRequest& WithSelfServicePortal(SelfServicePortal value) {
    SetSelfServicePortal(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyClientVpnEndpointRequest& WithSessionTimeoutHours(int value) {
  ...
  void SetClientRouteEnforcementOptions(ClientRouteEnforcementOptionsT&& value) {
    ...
    m_clientRouteEnforcementOptions = std::forward<ClientRouteEnforcementOptionsT>(value);
  }
  template <typename ClientRouteEnforcementOptionsT = ClientRouteEnforcementOptions>
  ModifyClientVpnEndpointRequest& WithClientRouteEnforcementOptions(ClientRouteEnforcementOptionsT&& value) {
    SetClientRouteEnforcementOptions(std::forward<ClientRouteEnforcementOptionsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetDisconnectOnSessionTimeout(bool value) {
    m_disconnectOnSessionTimeoutHasBeenSet = true;
    m_disconnectOnSessionTimeout = value;
  }
  inline ModifyClientVpnEndpointRequest& WithDisconnectOnSessionTimeout(bool value) {
    SetDisconnectOnSessionTimeout(value);
    return *this;
  }
  ///@}
 private:
