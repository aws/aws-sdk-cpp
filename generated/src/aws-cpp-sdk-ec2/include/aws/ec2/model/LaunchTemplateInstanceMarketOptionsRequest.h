...
class LaunchTemplateInstanceMarketOptionsRequest {
 public:
  ...
  inline LaunchTemplateInstanceMarketOptionsRequest& WithMarketType(MarketType value) {
    SetMarketType(value);
    return *this;
  }
  ///@}
  ...
  template <typename SpotOptionsT = LaunchTemplateSpotMarketOptionsRequest>
  LaunchTemplateInstanceMarketOptionsRequest& WithSpotOptions(SpotOptionsT&& value) {
