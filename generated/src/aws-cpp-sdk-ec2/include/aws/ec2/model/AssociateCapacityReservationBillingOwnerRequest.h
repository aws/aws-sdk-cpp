...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API AssociateCapacityReservationBillingOwnerRequest();
  ...
  public:
    ...
    inline AssociateCapacityReservationBillingOwnerRequest& WithDryRun(bool value) { SetDryRun(value); return *this;}
    ///@}
    ...
    inline AssociateCapacityReservationBillingOwnerRequest& WithCapacityReservationId(const Aws::String& value) { SetCapacityReservationId(value); return *this;}
    inline AssociateCapacityReservationBillingOwnerRequest& WithCapacityReservationId(Aws::String&& value) { SetCapacityReservationId(std::move(value)); return *this;}
    inline AssociateCapacityReservationBillingOwnerRequest& WithCapacityReservationId(const char* value) { SetCapacityReservationId(value); return *this;}
    ///@}
    ...
    inline AssociateCapacityReservationBillingOwnerRequest& WithUnusedReservationBillingOwnerId(const Aws::String& value) { SetUnusedReservationBillingOwnerId(value); return *this;}
    inline AssociateCapacityReservationBillingOwnerRequest& WithUnusedReservationBillingOwnerId(Aws::String&& value) { SetUnusedReservationBillingOwnerId(std::move(value)); return *this;}
    inline AssociateCapacityReservationBillingOwnerRequest& WithUnusedReservationBillingOwnerId(const char* value) { SetUnusedReservationBillingOwnerId(value); return *this;}
    ///@}
  private:
