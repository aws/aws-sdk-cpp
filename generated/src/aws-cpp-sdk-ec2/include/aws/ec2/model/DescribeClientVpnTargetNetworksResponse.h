...
class DescribeClientVpnTargetNetworksResponse {
 public:
  ...
  void SetClientVpnTargetNetworks(ClientVpnTargetNetworksT&& value) {
    m_clientVpnTargetNetworksHasBeenSet = true;
    m_clientVpnTargetNetworks = std::forward<ClientVpnTargetNetworksT>(value);
  }
  template <typename ClientVpnTargetNetworksT = Aws::Vector<TargetNetwork>>
  DescribeClientVpnTargetNetworksResponse& WithClientVpnTargetNetworks(ClientVpnTargetNetworksT&& value) {
    SetClientVpnTargetNetworks(std::forward<ClientVpnTargetNetworksT>(value));
    return *this;
  }
  template <typename ClientVpnTargetNetworksT = TargetNetwork>
  DescribeClientVpnTargetNetworksResponse& AddClientVpnTargetNetworks(ClientVpnTargetNetworksT&& value) {
    m_clientVpnTargetNetworksHasBeenSet = true;
    m_clientVpnTargetNetworks.emplace_back(std::forward<ClientVpnTargetNetworksT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClientVpnTargetNetworksResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClientVpnTargetNetworksResponse& WithResponseMetadata(ResponseMetadataT&& value) {
