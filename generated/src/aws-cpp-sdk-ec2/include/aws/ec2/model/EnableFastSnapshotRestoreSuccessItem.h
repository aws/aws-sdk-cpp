...
class EnableFastSnapshotRestoreSuccessItem {
 public:
  AWS_EC2_API EnableFastSnapshotRestoreSuccessItem() = default;
  ...
  template <typename SnapshotIdT = Aws::String>
  EnableFastSnapshotRestoreSuccessItem& WithSnapshotId(SnapshotIdT&& value) {
  ...
  template <typename AvailabilityZoneT = Aws::String>
  EnableFastSnapshotRestoreSuccessItem& WithAvailabilityZone(AvailabilityZoneT&& value) {
  ...
  inline void SetState(FastSnapshotRestoreStateCode value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline EnableFastSnapshotRestoreSuccessItem& WithState(FastSnapshotRestoreStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StateTransitionReasonT = Aws::String>
  EnableFastSnapshotRestoreSuccessItem& WithStateTransitionReason(StateTransitionReasonT&& value) {
  ...
  template <typename OwnerIdT = Aws::String>
  EnableFastSnapshotRestoreSuccessItem& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename OwnerAliasT = Aws::String>
  EnableFastSnapshotRestoreSuccessItem& WithOwnerAlias(OwnerAliasT&& value) {
  ...
  void SetEnablingTime(EnablingTimeT&& value) {
    m_enablingTimeHasBeenSet = true;
    m_enablingTime = std::forward<EnablingTimeT>(value);
  }
  template <typename EnablingTimeT = Aws::Utils::DateTime>
  EnableFastSnapshotRestoreSuccessItem& WithEnablingTime(EnablingTimeT&& value) {
    SetEnablingTime(std::forward<EnablingTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetOptimizingTime(OptimizingTimeT&& value) {
    m_optimizingTimeHasBeenSet = true;
    m_optimizingTime = std::forward<OptimizingTimeT>(value);
  }
  template <typename OptimizingTimeT = Aws::Utils::DateTime>
  EnableFastSnapshotRestoreSuccessItem& WithOptimizingTime(OptimizingTimeT&& value) {
    SetOptimizingTime(std::forward<OptimizingTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEnabledTime(EnabledTimeT&& value) {
    m_enabledTimeHasBeenSet = true;
    m_enabledTime = std::forward<EnabledTimeT>(value);
  }
  template <typename EnabledTimeT = Aws::Utils::DateTime>
  EnableFastSnapshotRestoreSuccessItem& WithEnabledTime(EnabledTimeT&& value) {
    SetEnabledTime(std::forward<EnabledTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisablingTime(DisablingTimeT&& value) {
    m_disablingTimeHasBeenSet = true;
    m_disablingTime = std::forward<DisablingTimeT>(value);
  }
  template <typename DisablingTimeT = Aws::Utils::DateTime>
  EnableFastSnapshotRestoreSuccessItem& WithDisablingTime(DisablingTimeT&& value) {
    SetDisablingTime(std::forward<DisablingTimeT>(value));
    return *this;
  }
  ///@}
  ...
  void SetDisabledTime(DisabledTimeT&& value) {
    m_disabledTimeHasBeenSet = true;
    m_disabledTime = std::forward<DisabledTimeT>(value);
  }
  template <typename DisabledTimeT = Aws::Utils::DateTime>
  EnableFastSnapshotRestoreSuccessItem& WithDisabledTime(DisabledTimeT&& value) {
    SetDisabledTime(std::forward<DisabledTimeT>(value));
    return *this;
  }
  ///@}
 private:
