...
class DescribeVpcEndpointServicesResponse {
 public:
  ...
  template <typename ServiceNamesT = Aws::Vector<Aws::String>>
  DescribeVpcEndpointServicesResponse& WithServiceNames(ServiceNamesT&& value) {
    SetServiceNames(std::forward<ServiceNamesT>(value));
    return *this;
  }
  template <typename ServiceNamesT = Aws::String>
  DescribeVpcEndpointServicesResponse& AddServiceNames(ServiceNamesT&& value) {
    m_serviceNamesHasBeenSet = true;
  ...
  template <typename ServiceDetailsT = Aws::Vector<ServiceDetail>>
  DescribeVpcEndpointServicesResponse& WithServiceDetails(ServiceDetailsT&& value) {
    SetServiceDetails(std::forward<ServiceDetailsT>(value));
    return *this;
  }
  template <typename ServiceDetailsT = ServiceDetail>
  DescribeVpcEndpointServicesResponse& AddServiceDetails(ServiceDetailsT&& value) {
    m_serviceDetailsHasBeenSet = true;
    m_serviceDetails.emplace_back(std::forward<ServiceDetailsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcEndpointServicesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVpcEndpointServicesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
