...
class DestinationOptionsRequest {
 public:
  ...
  inline DestinationOptionsRequest& WithFileFormat(DestinationFileFormat value) {
    SetFileFormat(value);
    return *this;
  }
  ///@}
  ...
  inline DestinationOptionsRequest& WithHiveCompatiblePartitions(bool value) {
  ...
  inline DestinationOptionsRequest& WithPerHourPartition(bool value) {
