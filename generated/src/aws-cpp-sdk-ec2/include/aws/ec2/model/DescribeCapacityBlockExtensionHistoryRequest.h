...
class DescribeCapacityBlockExtensionHistoryRequest : public EC2Request {
 ...
 public:
  ...
  template <typename CapacityReservationIdsT = Aws::Vector<Aws::String>>
  DescribeCapacityBlockExtensionHistoryRequest& WithCapacityReservationIds(CapacityReservationIdsT&& value) {
    SetCapacityReservationIds(std::forward<CapacityReservationIdsT>(value));
    return *this;
  }
  template <typename CapacityReservationIdsT = Aws::String>
  DescribeCapacityBlockExtensionHistoryRequest& AddCapacityReservationIds(CapacityReservationIdsT&& value) {
    m_capacityReservationIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeCapacityBlockExtensionHistoryRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeCapacityBlockExtensionHistoryRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeCapacityBlockExtensionHistoryRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeCapacityBlockExtensionHistoryRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeCapacityBlockExtensionHistoryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
