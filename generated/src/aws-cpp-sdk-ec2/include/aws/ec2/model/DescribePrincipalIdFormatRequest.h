...
class DescribePrincipalIdFormatRequest : public EC2Request {
 public:
  AWS_EC2_API DescribePrincipalIdFormatRequest() = default;
 ...
 public:
  ...
  inline DescribePrincipalIdFormatRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResourcesT = Aws::Vector<Aws::String>>
  DescribePrincipalIdFormatRequest& WithResources(ResourcesT&& value) {
    SetResources(std::forward<ResourcesT>(value));
    return *this;
  }
  template <typename ResourcesT = Aws::String>
  DescribePrincipalIdFormatRequest& AddResources(ResourcesT&& value) {
    m_resourcesHasBeenSet = true;
  ...
  inline DescribePrincipalIdFormatRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribePrincipalIdFormatRequest& WithNextToken(NextTokenT&& value) {
