...
class DeleteTrafficMirrorSessionResponse {
 public:
  ...
  template <typename TrafficMirrorSessionIdT = Aws::String>
  DeleteTrafficMirrorSessionResponse& WithTrafficMirrorSessionId(TrafficMirrorSessionIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTrafficMirrorSessionResponse& WithResponseMetadata(ResponseMetadataT&& value) {
