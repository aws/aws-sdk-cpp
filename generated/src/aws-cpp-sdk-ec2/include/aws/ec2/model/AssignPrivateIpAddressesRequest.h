...
class AssignPrivateIpAddressesRequest : public EC2Request {
 ...
 public:
  ...
  inline AssignPrivateIpAddressesRequest& WithIpv4PrefixCount(int value) {
  ...
  inline AssignPrivateIpAddressesRequest& WithSecondaryPrivateIpAddressCount(int value) {
  ...
  inline void SetAllowReassignment(bool value) {
    m_allowReassignmentHasBeenSet = true;
    m_allowReassignment = value;
  }
  inline AssignPrivateIpAddressesRequest& WithAllowReassignment(bool value) {
    SetAllowReassignment(value);
    return *this;
  }
  ///@}
 private:
