...
class DescribeTrafficMirrorTargetsRequest : public EC2Request {
 ...
 public:
  ...
  void SetTrafficMirrorTargetIds(TrafficMirrorTargetIdsT&& value) {
    m_trafficMirrorTargetIdsHasBeenSet = true;
    m_trafficMirrorTargetIds = std::forward<TrafficMirrorTargetIdsT>(value);
  }
  template <typename TrafficMirrorTargetIdsT = Aws::Vector<Aws::String>>
  DescribeTrafficMirrorTargetsRequest& WithTrafficMirrorTargetIds(TrafficMirrorTargetIdsT&& value) {
    SetTrafficMirrorTargetIds(std::forward<TrafficMirrorTargetIdsT>(value));
    return *this;
  }
  template <typename TrafficMirrorTargetIdsT = Aws::String>
  DescribeTrafficMirrorTargetsRequest& AddTrafficMirrorTargetIds(TrafficMirrorTargetIdsT&& value) {
    m_trafficMirrorTargetIdsHasBeenSet = true;
    m_trafficMirrorTargetIds.emplace_back(std::forward<TrafficMirrorTargetIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTrafficMirrorTargetsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeTrafficMirrorTargetsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeTrafficMirrorTargetsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeTrafficMirrorTargetsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorTargetsRequest& WithNextToken(NextTokenT&& value) {
