...
class DeleteInstanceConnectEndpointRequest : public EC2Request {
 ...
 public:
  ...
  inline DeleteInstanceConnectEndpointRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceConnectEndpointIdT = Aws::String>
  DeleteInstanceConnectEndpointRequest& WithInstanceConnectEndpointId(InstanceConnectEndpointIdT&& value) {
