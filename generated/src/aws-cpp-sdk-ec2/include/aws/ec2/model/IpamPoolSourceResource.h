...
class IpamPoolSourceResource {
 public:
  ...
  template <typename ResourceIdT = Aws::String>
  IpamPoolSourceResource& WithResourceId(ResourceIdT&& value) {
  ...
  inline IpamPoolSourceResource& WithResourceType(IpamPoolSourceResourceType value) {
  ...
  template <typename ResourceRegionT = Aws::String>
  IpamPoolSourceResource& WithResourceRegion(ResourceRegionT&& value) {
  ...
  template <typename ResourceOwnerT = Aws::String>
  IpamPoolSourceResource& WithResourceOwner(ResourceOwnerT&& value) {
