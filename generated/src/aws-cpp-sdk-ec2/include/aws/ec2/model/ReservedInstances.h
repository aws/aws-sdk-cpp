...
class ReservedInstances {
 public:
  ...
  inline ReservedInstances& WithCurrencyCode(CurrencyCodeValues value) {
  ...
  inline ReservedInstances& WithInstanceTenancy(Tenancy value) {
  ...
  inline ReservedInstances& WithOfferingClass(OfferingClassType value) {
  ...
  inline ReservedInstances& WithOfferingType(OfferingTypeValues value) {
  ...
  inline ReservedInstances& WithScope(Scope value) {
    SetScope(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstances& WithInstanceType(InstanceType value) {
  ...
  inline ReservedInstances& WithDuration(long long value) {
    SetDuration(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstances& WithUsagePrice(double value) {
    SetUsagePrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstances& WithFixedPrice(double value) {
    SetFixedPrice(value);
    return *this;
  }
  ///@}
  ...
  inline ReservedInstances& WithInstanceCount(int value) {
  ...
  inline ReservedInstances& WithProductDescription(RIProductDescription value) {
  ...
  inline void SetState(ReservedInstanceState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline ReservedInstances& WithState(ReservedInstanceState value) {
    SetState(value);
    return *this;
  }
  ///@}
