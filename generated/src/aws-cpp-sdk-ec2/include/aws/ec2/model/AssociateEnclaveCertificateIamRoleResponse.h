...
class AssociateEnclaveCertificateIamRoleResponse {
 public:
  ...
  AWS_EC2_API AssociateEnclaveCertificateIamRoleResponse& operator=(
  ...
  void SetCertificateS3BucketName(CertificateS3BucketNameT&& value) {
    ...
    m_certificateS3BucketName = std::forward<CertificateS3BucketNameT>(value);
  }
  template <typename CertificateS3BucketNameT = Aws::String>
  AssociateEnclaveCertificateIamRoleResponse& WithCertificateS3BucketName(CertificateS3BucketNameT&& value) {
    SetCertificateS3BucketName(std::forward<CertificateS3BucketNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetCertificateS3ObjectKey(CertificateS3ObjectKeyT&& value) {
    ...
    m_certificateS3ObjectKey = std::forward<CertificateS3ObjectKeyT>(value);
  }
  template <typename CertificateS3ObjectKeyT = Aws::String>
  AssociateEnclaveCertificateIamRoleResponse& WithCertificateS3ObjectKey(CertificateS3ObjectKeyT&& value) {
    SetCertificateS3ObjectKey(std::forward<CertificateS3ObjectKeyT>(value));
    return *this;
  }
  ///@}
  ...
  void SetEncryptionKmsKeyId(EncryptionKmsKeyIdT&& value) {
    ...
    m_encryptionKmsKeyId = std::forward<EncryptionKmsKeyIdT>(value);
  }
  template <typename EncryptionKmsKeyIdT = Aws::String>
  AssociateEnclaveCertificateIamRoleResponse& WithEncryptionKmsKeyId(EncryptionKmsKeyIdT&& value) {
    SetEncryptionKmsKeyId(std::forward<EncryptionKmsKeyIdT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateEnclaveCertificateIamRoleResponse& WithResponseMetadata(ResponseMetadataT&& value) {
