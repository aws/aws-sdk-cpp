...
class GetDefaultCreditSpecificationRequest : public EC2Request {
 ...
 public:
  ...
  inline GetDefaultCreditSpecificationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline GetDefaultCreditSpecificationRequest& WithInstanceFamily(UnlimitedSupportedInstanceFamily value) {
