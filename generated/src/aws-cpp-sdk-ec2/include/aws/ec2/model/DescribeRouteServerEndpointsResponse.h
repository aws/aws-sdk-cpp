...
class DescribeRouteServerEndpointsResponse {
 public:
  ...
  void SetRouteServerEndpoints(RouteServerEndpointsT&& value) {
    m_routeServerEndpointsHasBeenSet = true;
    m_routeServerEndpoints = std::forward<RouteServerEndpointsT>(value);
  }
  template <typename RouteServerEndpointsT = Aws::Vector<RouteServerEndpoint>>
  DescribeRouteServerEndpointsResponse& WithRouteServerEndpoints(RouteServerEndpointsT&& value) {
    SetRouteServerEndpoints(std::forward<RouteServerEndpointsT>(value));
    return *this;
  }
  template <typename RouteServerEndpointsT = RouteServerEndpoint>
  DescribeRouteServerEndpointsResponse& AddRouteServerEndpoints(RouteServerEndpointsT&& value) {
    m_routeServerEndpointsHasBeenSet = true;
    m_routeServerEndpoints.emplace_back(std::forward<RouteServerEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeRouteServerEndpointsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeRouteServerEndpointsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
