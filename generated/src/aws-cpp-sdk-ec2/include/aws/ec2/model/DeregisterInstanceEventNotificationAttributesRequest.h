...
class DeregisterInstanceEventNotificationAttributesRequest : public EC2Request {
 ...
 public:
  ...
  inline DeregisterInstanceEventNotificationAttributesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceTagAttributeT = DeregisterInstanceTagAttributeRequest>
  DeregisterInstanceEventNotificationAttributesRequest& WithInstanceTagAttribute(InstanceTagAttributeT&& value) {
