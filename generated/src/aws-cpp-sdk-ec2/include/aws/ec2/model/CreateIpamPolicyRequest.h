...
/**
 */
class CreateIpamPolicyRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "CreateIpamPolicy"; }
 ...
 public:
  ...
  inline CreateIpamPolicyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>A unique, case-sensitive identifier to ensure the idempotency of the
   * request.</p>
   */
