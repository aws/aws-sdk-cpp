...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyAvailabilityZoneGroupResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyAvailabilityZoneGroupResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
