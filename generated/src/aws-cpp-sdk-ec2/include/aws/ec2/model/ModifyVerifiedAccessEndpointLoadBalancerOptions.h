...
class ModifyVerifiedAccessEndpointLoadBalancerOptions {
 public:
  ...
  template <typename SubnetIdsT = Aws::Vector<Aws::String>>
  ModifyVerifiedAccessEndpointLoadBalancerOptions& WithSubnetIds(SubnetIdsT&& value) {
    SetSubnetIds(std::forward<SubnetIdsT>(value));
    return *this;
  }
  template <typename SubnetIdsT = Aws::String>
  ModifyVerifiedAccessEndpointLoadBalancerOptions& AddSubnetIds(SubnetIdsT&& value) {
    m_subnetIdsHasBeenSet = true;
  ...
  inline ModifyVerifiedAccessEndpointLoadBalancerOptions& WithProtocol(VerifiedAccessEndpointProtocol value) {
    SetProtocol(value);
    return *this;
  }
  ///@}
  ...
  inline ModifyVerifiedAccessEndpointLoadBalancerOptions& WithPort(int value) {
    SetPort(value);
    return *this;
  }
  ///@}
  ...
  template <typename PortRangesT = Aws::Vector<ModifyVerifiedAccessEndpointPortRange>>
  ModifyVerifiedAccessEndpointLoadBalancerOptions& WithPortRanges(PortRangesT&& value) {
    SetPortRanges(std::forward<PortRangesT>(value));
    return *this;
  }
  template <typename PortRangesT = ModifyVerifiedAccessEndpointPortRange>
  ModifyVerifiedAccessEndpointLoadBalancerOptions& AddPortRanges(PortRangesT&& value) {
    m_portRangesHasBeenSet = true;
