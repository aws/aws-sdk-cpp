...
namespace Model
{
  ...
  public:
    ...
    template<typename CodeT = Aws::String>
    UnsuccessfulItemError& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
    ...
    template<typename MessageT = Aws::String>
    UnsuccessfulItemError& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
  private:
