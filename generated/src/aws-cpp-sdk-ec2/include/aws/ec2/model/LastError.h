...
namespace Model
{
  ...
  public:
    ...
    template<typename MessageT = Aws::String>
    LastError& WithMessage(MessageT&& value) { SetMessage(std::forward<MessageT>(value)); return *this;}
    ///@}
    ...
    template<typename CodeT = Aws::String>
    LastError& WithCode(CodeT&& value) { SetCode(std::forward<CodeT>(value)); return *this;}
    ///@}
  private:
