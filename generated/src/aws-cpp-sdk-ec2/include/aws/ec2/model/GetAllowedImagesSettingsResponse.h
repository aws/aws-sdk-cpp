...
class GetAllowedImagesSettingsResponse {
 public:
  ...
  template <typename StateT = Aws::String>
  GetAllowedImagesSettingsResponse& WithState(StateT&& value) {
  ...
  template <typename ImageCriteriaT = Aws::Vector<ImageCriterion>>
  GetAllowedImagesSettingsResponse& WithImageCriteria(ImageCriteriaT&& value) {
    SetImageCriteria(std::forward<ImageCriteriaT>(value));
    return *this;
  }
  template <typename ImageCriteriaT = ImageCriterion>
  GetAllowedImagesSettingsResponse& AddImageCriteria(ImageCriteriaT&& value) {
    m_imageCriteriaHasBeenSet = true;
  ...
  inline GetAllowedImagesSettingsResponse& WithManagedBy(ManagedBy value) {
    SetManagedBy(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetAllowedImagesSettingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
