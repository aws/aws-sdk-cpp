...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API Phase2IntegrityAlgorithmsRequestListValue() = default;
    ...
    template<typename ValueT = Aws::String>
    Phase2IntegrityAlgorithmsRequestListValue& WithValue(ValueT&& value) { SetValue(std::forward<ValueT>(value)); return *this;}
    ///@}
  private:
