...
class DeleteTransitGatewayConnectPeerResponse {
 public:
  ...
  template <typename TransitGatewayConnectPeerT = TransitGatewayConnectPeer>
  DeleteTransitGatewayConnectPeerResponse& WithTransitGatewayConnectPeer(TransitGatewayConnectPeerT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteTransitGatewayConnectPeerResponse& WithResponseMetadata(ResponseMetadataT&& value) {
