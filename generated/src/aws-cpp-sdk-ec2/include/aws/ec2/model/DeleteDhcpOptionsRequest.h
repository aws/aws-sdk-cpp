...
class DeleteDhcpOptionsRequest : public EC2Request {
 ...
 public:
  ...
  void SetDhcpOptionsId(DhcpOptionsIdT&& value) {
    ...
    m_dhcpOptionsId = std::forward<DhcpOptionsIdT>(value);
  }
  template <typename DhcpOptionsIdT = Aws::String>
  DeleteDhcpOptionsRequest& WithDhcpOptionsId(DhcpOptionsIdT&& value) {
    SetDhcpOptionsId(std::forward<DhcpOptionsIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline DeleteDhcpOptionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
