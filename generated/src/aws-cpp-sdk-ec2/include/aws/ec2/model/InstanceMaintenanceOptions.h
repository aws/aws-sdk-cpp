...
class InstanceMaintenanceOptions {
 public:
  ...
  inline InstanceMaintenanceOptions& WithAutoRecovery(InstanceAutoRecoveryState value) {
  ...
  inline InstanceMaintenanceOptions& WithRebootMigration(InstanceRebootMigrationState value) {
