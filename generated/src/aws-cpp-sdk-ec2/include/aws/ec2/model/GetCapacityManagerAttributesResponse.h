...
namespace Model
{
  ...
  public:
    ...
    inline GetCapacityManagerAttributesResponse& WithCapacityManagerStatus(CapacityManagerStatus value) { SetCapacityManagerStatus(value); return *this;}
    ///@}
    ...
    inline GetCapacityManagerAttributesResponse& WithOrganizationsAccess(bool value) { SetOrganizationsAccess(value); return *this;}
    ///@}
    ...
    inline void SetDataExportCount(int value) { m_dataExportCountHasBeenSet = true; m_dataExportCount = value; }
    inline GetCapacityManagerAttributesResponse& WithDataExportCount(int value) { SetDataExportCount(value); return *this;}
    ///@}
    ...
    inline GetCapacityManagerAttributesResponse& WithIngestionStatus(IngestionStatus value) { SetIngestionStatus(value); return *this;}
    ///@}
    ...
    void SetIngestionStatusMessage(IngestionStatusMessageT&& value) { m_ingestionStatusMessageHasBeenSet = true; m_ingestionStatusMessage = std::forward<IngestionStatusMessageT>(value); }
    template<typename IngestionStatusMessageT = Aws::String>
    GetCapacityManagerAttributesResponse& WithIngestionStatusMessage(IngestionStatusMessageT&& value) { SetIngestionStatusMessage(std::forward<IngestionStatusMessageT>(value)); return *this;}
    ///@}
    ...
    void SetEarliestDatapointTimestamp(EarliestDatapointTimestampT&& value) { m_earliestDatapointTimestampHasBeenSet = true; m_earliestDatapointTimestamp = std::forward<EarliestDatapointTimestampT>(value); }
    template<typename EarliestDatapointTimestampT = Aws::Utils::DateTime>
    GetCapacityManagerAttributesResponse& WithEarliestDatapointTimestamp(EarliestDatapointTimestampT&& value) { SetEarliestDatapointTimestamp(std::forward<EarliestDatapointTimestampT>(value)); return *this;}
    ///@}
    ...
    void SetLatestDatapointTimestamp(LatestDatapointTimestampT&& value) { m_latestDatapointTimestampHasBeenSet = true; m_latestDatapointTimestamp = std::forward<LatestDatapointTimestampT>(value); }
    template<typename LatestDatapointTimestampT = Aws::Utils::DateTime>
    GetCapacityManagerAttributesResponse& WithLatestDatapointTimestamp(LatestDatapointTimestampT&& value) { SetLatestDatapointTimestamp(std::forward<LatestDatapointTimestampT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    GetCapacityManagerAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
