...
class InstanceMetadataOptionsRequest {
 public:
  ...
  inline InstanceMetadataOptionsRequest& WithHttpTokens(HttpTokensState value) {
    SetHttpTokens(value);
    return *this;
  }
  ///@}
  ...
  inline InstanceMetadataOptionsRequest& WithHttpEndpoint(InstanceMetadataEndpointState value) {
  ...
  inline InstanceMetadataOptionsRequest& WithHttpProtocolIpv6(InstanceMetadataProtocolState value) {
  ...
  inline InstanceMetadataOptionsRequest& WithInstanceMetadataTags(InstanceMetadataTagsState value) {
