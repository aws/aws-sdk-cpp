...
class DeleteFpgaImageRequest : public EC2Request {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "DeleteFpgaImage"; }
 ...
 public:
  ...
  inline DeleteFpgaImageRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FpgaImageIdT = Aws::String>
  DeleteFpgaImageRequest& WithFpgaImageId(FpgaImageIdT&& value) {
