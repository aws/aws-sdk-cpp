...
class ReplaceRouteRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetLocalTarget(bool value) {
    m_localTargetHasBeenSet = true;
    m_localTarget = value;
  }
  inline ReplaceRouteRequest& WithLocalTarget(bool value) {
  ...
  inline ReplaceRouteRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
