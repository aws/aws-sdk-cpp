...
namespace Model
{
  ...
  public:
    ...
    template<typename DestinationPrefixListIdT = Aws::String>
    ReplaceRouteRequest& WithDestinationPrefixListId(DestinationPrefixListIdT&& value) { SetDestinationPrefixListId(std::forward<DestinationPrefixListIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcEndpointIdT = Aws::String>
    ReplaceRouteRequest& WithVpcEndpointId(VpcEndpointIdT&& value) { SetVpcEndpointId(std::forward<VpcEndpointIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TransitGatewayIdT = Aws::String>
    ReplaceRouteRequest& WithTransitGatewayId(TransitGatewayIdT&& value) { SetTransitGatewayId(std::forward<TransitGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename LocalGatewayIdT = Aws::String>
    ReplaceRouteRequest& WithLocalGatewayId(LocalGatewayIdT&& value) { SetLocalGatewayId(std::forward<LocalGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CarrierGatewayIdT = Aws::String>
    ReplaceRouteRequest& WithCarrierGatewayId(CarrierGatewayIdT&& value) { SetCarrierGatewayId(std::forward<CarrierGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename CoreNetworkArnT = Aws::String>
    ReplaceRouteRequest& WithCoreNetworkArn(CoreNetworkArnT&& value) { SetCoreNetworkArn(std::forward<CoreNetworkArnT>(value)); return *this;}
    ///@}
    ...
    template<typename OdbNetworkArnT = Aws::String>
    ReplaceRouteRequest& WithOdbNetworkArn(OdbNetworkArnT&& value) { SetOdbNetworkArn(std::forward<OdbNetworkArnT>(value)); return *this;}
    ///@}
    ...
    template<typename RouteTableIdT = Aws::String>
    ReplaceRouteRequest& WithRouteTableId(RouteTableIdT&& value) { SetRouteTableId(std::forward<RouteTableIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationCidrBlockT = Aws::String>
    ReplaceRouteRequest& WithDestinationCidrBlock(DestinationCidrBlockT&& value) { SetDestinationCidrBlock(std::forward<DestinationCidrBlockT>(value)); return *this;}
    ///@}
    ...
    template<typename GatewayIdT = Aws::String>
    ReplaceRouteRequest& WithGatewayId(GatewayIdT&& value) { SetGatewayId(std::forward<GatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename DestinationIpv6CidrBlockT = Aws::String>
    ReplaceRouteRequest& WithDestinationIpv6CidrBlock(DestinationIpv6CidrBlockT&& value) { SetDestinationIpv6CidrBlock(std::forward<DestinationIpv6CidrBlockT>(value)); return *this;}
    ///@}
    ...
    template<typename EgressOnlyInternetGatewayIdT = Aws::String>
    ReplaceRouteRequest& WithEgressOnlyInternetGatewayId(EgressOnlyInternetGatewayIdT&& value) { SetEgressOnlyInternetGatewayId(std::forward<EgressOnlyInternetGatewayIdT>(value)); return *this;}
    ///@}
    ...
    template<typename InstanceIdT = Aws::String>
    ReplaceRouteRequest& WithInstanceId(InstanceIdT&& value) { SetInstanceId(std::forward<InstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NetworkInterfaceIdT = Aws::String>
    ReplaceRouteRequest& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) { SetNetworkInterfaceId(std::forward<NetworkInterfaceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VpcPeeringConnectionIdT = Aws::String>
    ReplaceRouteRequest& WithVpcPeeringConnectionId(VpcPeeringConnectionIdT&& value) { SetVpcPeeringConnectionId(std::forward<VpcPeeringConnectionIdT>(value)); return *this;}
    ///@}
    ...
    template<typename NatGatewayIdT = Aws::String>
    ReplaceRouteRequest& WithNatGatewayId(NatGatewayIdT&& value) { SetNatGatewayId(std::forward<NatGatewayIdT>(value)); return *this;}
    ///@}
  private:
