...
class DescribeConversionTasksRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeConversionTasksRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetConversionTaskIds(ConversionTaskIdsT&& value) {
    m_conversionTaskIdsHasBeenSet = true;
    m_conversionTaskIds = std::forward<ConversionTaskIdsT>(value);
  }
  template <typename ConversionTaskIdsT = Aws::Vector<Aws::String>>
  DescribeConversionTasksRequest& WithConversionTaskIds(ConversionTaskIdsT&& value) {
    SetConversionTaskIds(std::forward<ConversionTaskIdsT>(value));
    return *this;
  }
  template <typename ConversionTaskIdsT = Aws::String>
  DescribeConversionTasksRequest& AddConversionTaskIds(ConversionTaskIdsT&& value) {
    m_conversionTaskIdsHasBeenSet = true;
    m_conversionTaskIds.emplace_back(std::forward<ConversionTaskIdsT>(value));
    return *this;
  }
  ///@}
 private:
