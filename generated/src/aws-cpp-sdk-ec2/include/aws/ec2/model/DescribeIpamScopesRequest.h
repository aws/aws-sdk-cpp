...
/**
 */
class DescribeIpamScopesRequest : public EC2Request {
 public:
 ...
 public:
  ...
  inline DescribeIpamScopesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeIpamScopesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamScopeIdsT = Aws::Vector<Aws::String>>
  void SetIpamScopeIds(IpamScopeIdsT&& value) {
    m_ipamScopeIdsHasBeenSet = true;
    m_ipamScopeIds = std::forward<IpamScopeIdsT>(value);
  }
  template <typename IpamScopeIdsT = Aws::Vector<Aws::String>>
  DescribeIpamScopesRequest& WithIpamScopeIds(IpamScopeIdsT&& value) {
    SetIpamScopeIds(std::forward<IpamScopeIdsT>(value));
    return *this;
  }
  template <typename IpamScopeIdsT = Aws::String>
  DescribeIpamScopesRequest& AddIpamScopeIds(IpamScopeIdsT&& value) {
    m_ipamScopeIdsHasBeenSet = true;
    m_ipamScopeIds.emplace_back(std::forward<IpamScopeIdsT>(value));
    return *this;
  }
  ///@}
 private:
  ...
  bool m_ipamScopeIdsHasBeenSet = false;
};
