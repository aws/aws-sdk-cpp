...
class ReplaceNetworkAclEntryRequest : public EC2Request {
 ...
 public:
  ...
  inline ReplaceNetworkAclEntryRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline ReplaceNetworkAclEntryRequest& WithRuleNumber(int value) {
    SetRuleNumber(value);
    return *this;
  }
  ///@}
  ...
  inline ReplaceNetworkAclEntryRequest& WithRuleAction(RuleAction value) {
    SetRuleAction(value);
    return *this;
  }
  ///@}
  ...
  inline ReplaceNetworkAclEntryRequest& WithEgress(bool value) {
    SetEgress(value);
    return *this;
  }
  ///@}
