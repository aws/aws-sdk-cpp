...
class NeuronInfo {
 public:
  ...
  void SetNeuronDevices(NeuronDevicesT&& value) {
    ...
    m_neuronDevices = std::forward<NeuronDevicesT>(value);
  }
  template <typename NeuronDevicesT = Aws::Vector<NeuronDeviceInfo>>
  NeuronInfo& WithNeuronDevices(NeuronDevicesT&& value) {
    SetNeuronDevices(std::forward<NeuronDevicesT>(value));
    return *this;
  }
  template <typename NeuronDevicesT = NeuronDeviceInfo>
  NeuronInfo& AddNeuronDevices(NeuronDevicesT&& value) {
    m_neuronDevicesHasBeenSet = true;
    m_neuronDevices.emplace_back(std::forward<NeuronDevicesT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetTotalNeuronDeviceMemoryInMiB(int value) {
    m_totalNeuronDeviceMemoryInMiBHasBeenSet = true;
    m_totalNeuronDeviceMemoryInMiB = value;
  }
  inline NeuronInfo& WithTotalNeuronDeviceMemoryInMiB(int value) {
    SetTotalNeuronDeviceMemoryInMiB(value);
    return *this;
  }
  ///@}
 private:
