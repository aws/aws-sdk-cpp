...
class GetNetworkInsightsAccessScopeAnalysisFindingsResponse {
 public:
  ...
  AWS_EC2_API GetNetworkInsightsAccessScopeAnalysisFindingsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetNetworkInsightsAccessScopeAnalysisId(NetworkInsightsAccessScopeAnalysisIdT&& value) {
    ...
    m_networkInsightsAccessScopeAnalysisId = std::forward<NetworkInsightsAccessScopeAnalysisIdT>(value);
  }
  template <typename NetworkInsightsAccessScopeAnalysisIdT = Aws::String>
  GetNetworkInsightsAccessScopeAnalysisFindingsResponse& WithNetworkInsightsAccessScopeAnalysisId(
      NetworkInsightsAccessScopeAnalysisIdT&& value) {
    SetNetworkInsightsAccessScopeAnalysisId(std::forward<NetworkInsightsAccessScopeAnalysisIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetAnalysisStatus(AnalysisStatus value) {
    m_analysisStatusHasBeenSet = true;
    m_analysisStatus = value;
  }
  inline GetNetworkInsightsAccessScopeAnalysisFindingsResponse& WithAnalysisStatus(AnalysisStatus value) {
  ...
  void SetAnalysisFindings(AnalysisFindingsT&& value) {
    m_analysisFindingsHasBeenSet = true;
    m_analysisFindings = std::forward<AnalysisFindingsT>(value);
  }
  template <typename AnalysisFindingsT = Aws::Vector<AccessScopeAnalysisFinding>>
  GetNetworkInsightsAccessScopeAnalysisFindingsResponse& WithAnalysisFindings(AnalysisFindingsT&& value) {
    SetAnalysisFindings(std::forward<AnalysisFindingsT>(value));
    return *this;
  }
  template <typename AnalysisFindingsT = AccessScopeAnalysisFinding>
  GetNetworkInsightsAccessScopeAnalysisFindingsResponse& AddAnalysisFindings(AnalysisFindingsT&& value) {
    m_analysisFindingsHasBeenSet = true;
    m_analysisFindings.emplace_back(std::forward<AnalysisFindingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetNetworkInsightsAccessScopeAnalysisFindingsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetNetworkInsightsAccessScopeAnalysisFindingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
