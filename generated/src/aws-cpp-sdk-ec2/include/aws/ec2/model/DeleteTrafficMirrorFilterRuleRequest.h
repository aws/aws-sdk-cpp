...
class DeleteTrafficMirrorFilterRuleRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TrafficMirrorFilterRuleIdT = Aws::String>
  DeleteTrafficMirrorFilterRuleRequest& WithTrafficMirrorFilterRuleId(TrafficMirrorFilterRuleIdT&& value) {
  ...
  inline DeleteTrafficMirrorFilterRuleRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
