...
class DescribeElasticGpusRequest : public EC2Request {
 ...
 public:
  ...
  void SetElasticGpuIds(ElasticGpuIdsT&& value) {
    m_elasticGpuIdsHasBeenSet = true;
    m_elasticGpuIds = std::forward<ElasticGpuIdsT>(value);
  }
  template <typename ElasticGpuIdsT = Aws::Vector<Aws::String>>
  DescribeElasticGpusRequest& WithElasticGpuIds(ElasticGpuIdsT&& value) {
    SetElasticGpuIds(std::forward<ElasticGpuIdsT>(value));
    return *this;
  }
  template <typename ElasticGpuIdsT = Aws::String>
  DescribeElasticGpusRequest& AddElasticGpuIds(ElasticGpuIdsT&& value) {
    m_elasticGpuIdsHasBeenSet = true;
    m_elasticGpuIds.emplace_back(std::forward<ElasticGpuIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeElasticGpusRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeElasticGpusRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
