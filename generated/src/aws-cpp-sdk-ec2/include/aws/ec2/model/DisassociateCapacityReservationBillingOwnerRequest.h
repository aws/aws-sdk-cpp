...
class DisassociateCapacityReservationBillingOwnerRequest : public EC2Request {
 ...
 public:
  ...
  inline DisassociateCapacityReservationBillingOwnerRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename CapacityReservationIdT = Aws::String>
  DisassociateCapacityReservationBillingOwnerRequest& WithCapacityReservationId(CapacityReservationIdT&& value) {
  ...
  template <typename UnusedReservationBillingOwnerIdT = Aws::String>
  DisassociateCapacityReservationBillingOwnerRequest& WithUnusedReservationBillingOwnerId(UnusedReservationBillingOwnerIdT&& value) {
