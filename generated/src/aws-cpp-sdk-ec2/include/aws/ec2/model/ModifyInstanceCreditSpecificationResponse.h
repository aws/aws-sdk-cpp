...
class ModifyInstanceCreditSpecificationResponse {
 public:
   ...
   */
  inline const Aws::Vector<SuccessfulInstanceCreditSpecificationItem>& GetSuccessfulInstanceCreditSpecifications() const {
    return m_successfulInstanceCreditSpecifications;
  }
  ...
  void SetSuccessfulInstanceCreditSpecifications(SuccessfulInstanceCreditSpecificationsT&& value) {
    ...
    m_successfulInstanceCreditSpecifications = std::forward<SuccessfulInstanceCreditSpecificationsT>(value);
  }
  template <typename SuccessfulInstanceCreditSpecificationsT = Aws::Vector<SuccessfulInstanceCreditSpecificationItem>>
  ModifyInstanceCreditSpecificationResponse& WithSuccessfulInstanceCreditSpecifications(SuccessfulInstanceCreditSpecificationsT&& value) {
    SetSuccessfulInstanceCreditSpecifications(std::forward<SuccessfulInstanceCreditSpecificationsT>(value));
    return *this;
  }
  ...
  ModifyInstanceCreditSpecificationResponse& AddSuccessfulInstanceCreditSpecifications(SuccessfulInstanceCreditSpecificationsT&& value) {
    m_successfulInstanceCreditSpecificationsHasBeenSet = true;
    m_successfulInstanceCreditSpecifications.emplace_back(std::forward<SuccessfulInstanceCreditSpecificationsT>(value));
    return *this;
  }
  ///@}
   ...
   * modified.</p>
   */
  inline const Aws::Vector<UnsuccessfulInstanceCreditSpecificationItem>& GetUnsuccessfulInstanceCreditSpecifications() const {
    return m_unsuccessfulInstanceCreditSpecifications;
  }
  ...
  void SetUnsuccessfulInstanceCreditSpecifications(UnsuccessfulInstanceCreditSpecificationsT&& value) {
    ...
    m_unsuccessfulInstanceCreditSpecifications = std::forward<UnsuccessfulInstanceCreditSpecificationsT>(value);
  }
  template <typename UnsuccessfulInstanceCreditSpecificationsT = Aws::Vector<UnsuccessfulInstanceCreditSpecificationItem>>
  ModifyInstanceCreditSpecificationResponse& WithUnsuccessfulInstanceCreditSpecifications(
      UnsuccessfulInstanceCreditSpecificationsT&& value) {
    SetUnsuccessfulInstanceCreditSpecifications(std::forward<UnsuccessfulInstanceCreditSpecificationsT>(value));
    return *this;
  }
  ...
  ModifyInstanceCreditSpecificationResponse& AddUnsuccessfulInstanceCreditSpecifications(
      UnsuccessfulInstanceCreditSpecificationsT&& value) {
    m_unsuccessfulInstanceCreditSpecificationsHasBeenSet = true;
    m_unsuccessfulInstanceCreditSpecifications.emplace_back(std::forward<UnsuccessfulInstanceCreditSpecificationsT>(value));
    return *this;
  }
  ///@}
