...
class ResetImageAttributeRequest : public EC2Request {
 ...
 public:
  ...
  inline void SetAttribute(ResetImageAttributeName value) {
    m_attributeHasBeenSet = true;
    m_attribute = value;
  }
  inline ResetImageAttributeRequest& WithAttribute(ResetImageAttributeName value) {
    SetAttribute(value);
    return *this;
  }
  ///@}
  ...
  inline ResetImageAttributeRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
