...
class GetManagedPrefixListAssociationsResponse {
 public:
  ...
  template <typename PrefixListAssociationsT = Aws::Vector<PrefixListAssociation>>
  GetManagedPrefixListAssociationsResponse& WithPrefixListAssociations(PrefixListAssociationsT&& value) {
  ...
  GetManagedPrefixListAssociationsResponse& AddPrefixListAssociations(PrefixListAssociationsT&& value) {
    m_prefixListAssociationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetManagedPrefixListAssociationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetManagedPrefixListAssociationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
