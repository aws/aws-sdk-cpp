...
/**
 * <p>Describes the memory available to the media accelerator.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/MediaDeviceMemoryInfo">AWS
 * API Reference</a></p>
 */
class MediaDeviceMemoryInfo {
 public:
  ...
  inline MediaDeviceMemoryInfo& WithSizeInMiB(int value) {
    SetSizeInMiB(value);
    return *this;
  }
  ///@}
