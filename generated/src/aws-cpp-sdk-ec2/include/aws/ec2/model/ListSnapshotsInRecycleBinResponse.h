...
class ListSnapshotsInRecycleBinResponse {
 public:
  ...
  template <typename SnapshotsT = Aws::Vector<SnapshotRecycleBinInfo>>
  ListSnapshotsInRecycleBinResponse& WithSnapshots(SnapshotsT&& value) {
    SetSnapshots(std::forward<SnapshotsT>(value));
    return *this;
  }
  template <typename SnapshotsT = SnapshotRecycleBinInfo>
  ListSnapshotsInRecycleBinResponse& AddSnapshots(SnapshotsT&& value) {
    m_snapshotsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  ListSnapshotsInRecycleBinResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ListSnapshotsInRecycleBinResponse& WithResponseMetadata(ResponseMetadataT&& value) {
