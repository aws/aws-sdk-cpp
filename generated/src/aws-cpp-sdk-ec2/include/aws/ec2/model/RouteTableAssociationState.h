...
class RouteTableAssociationState {
 public:
  ...
  inline void SetState(RouteTableAssociationStateCode value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline RouteTableAssociationState& WithState(RouteTableAssociationStateCode value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  RouteTableAssociationState& WithStatusMessage(StatusMessageT&& value) {
