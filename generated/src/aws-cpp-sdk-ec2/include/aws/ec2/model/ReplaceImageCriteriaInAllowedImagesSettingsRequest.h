...
class ReplaceImageCriteriaInAllowedImagesSettingsRequest : public EC2Request {
 ...
 public:
  ...
  void SetImageCriteria(ImageCriteriaT&& value) {
    m_imageCriteriaHasBeenSet = true;
    m_imageCriteria = std::forward<ImageCriteriaT>(value);
  }
  template <typename ImageCriteriaT = Aws::Vector<ImageCriterionRequest>>
  ReplaceImageCriteriaInAllowedImagesSettingsRequest& WithImageCriteria(ImageCriteriaT&& value) {
    SetImageCriteria(std::forward<ImageCriteriaT>(value));
    return *this;
  }
  template <typename ImageCriteriaT = ImageCriterionRequest>
  ReplaceImageCriteriaInAllowedImagesSettingsRequest& AddImageCriteria(ImageCriteriaT&& value) {
    m_imageCriteriaHasBeenSet = true;
    m_imageCriteria.emplace_back(std::forward<ImageCriteriaT>(value));
    return *this;
  }
  ///@}
  ...
  inline ReplaceImageCriteriaInAllowedImagesSettingsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
