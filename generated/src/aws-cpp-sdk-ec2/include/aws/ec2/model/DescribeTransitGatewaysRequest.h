...
class DescribeTransitGatewaysRequest : public EC2Request {
 ...
 public:
  ...
  void SetTransitGatewayIds(TransitGatewayIdsT&& value) {
    m_transitGatewayIdsHasBeenSet = true;
    m_transitGatewayIds = std::forward<TransitGatewayIdsT>(value);
  }
  template <typename TransitGatewayIdsT = Aws::Vector<Aws::String>>
  DescribeTransitGatewaysRequest& WithTransitGatewayIds(TransitGatewayIdsT&& value) {
    SetTransitGatewayIds(std::forward<TransitGatewayIdsT>(value));
    return *this;
  }
  ...
  DescribeTransitGatewaysRequest& AddTransitGatewayIds(TransitGatewayIdsT&& value) {
    m_transitGatewayIdsHasBeenSet = true;
    m_transitGatewayIds.emplace_back(std::forward<TransitGatewayIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewaysRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeTransitGatewaysRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
