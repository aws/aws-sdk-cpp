...
class DescribeNetworkInsightsPathsRequest : public EC2Request {
 ...
 public:
  ...
  void SetNetworkInsightsPathIds(NetworkInsightsPathIdsT&& value) {
    m_networkInsightsPathIdsHasBeenSet = true;
    m_networkInsightsPathIds = std::forward<NetworkInsightsPathIdsT>(value);
  }
  template <typename NetworkInsightsPathIdsT = Aws::Vector<Aws::String>>
  DescribeNetworkInsightsPathsRequest& WithNetworkInsightsPathIds(NetworkInsightsPathIdsT&& value) {
    SetNetworkInsightsPathIds(std::forward<NetworkInsightsPathIdsT>(value));
    return *this;
  }
  template <typename NetworkInsightsPathIdsT = Aws::String>
  DescribeNetworkInsightsPathsRequest& AddNetworkInsightsPathIds(NetworkInsightsPathIdsT&& value) {
    m_networkInsightsPathIdsHasBeenSet = true;
    m_networkInsightsPathIds.emplace_back(std::forward<NetworkInsightsPathIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeNetworkInsightsPathsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeNetworkInsightsPathsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeNetworkInsightsPathsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeNetworkInsightsPathsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeNetworkInsightsPathsRequest& WithNextToken(NextTokenT&& value) {
