...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API EnableVpcClassicLinkDnsSupportResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    EnableVpcClassicLinkDnsSupportResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
