...
class EnableVpcClassicLinkDnsSupportResponse {
 public:
  ...
  inline EnableVpcClassicLinkDnsSupportResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableVpcClassicLinkDnsSupportResponse& WithResponseMetadata(ResponseMetadataT&& value) {
