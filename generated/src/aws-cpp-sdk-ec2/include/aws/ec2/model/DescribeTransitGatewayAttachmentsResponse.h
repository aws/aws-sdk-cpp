...
class DescribeTransitGatewayAttachmentsResponse {
 public:
  ...
  void SetTransitGatewayAttachments(TransitGatewayAttachmentsT&& value) {
    ...
    m_transitGatewayAttachments = std::forward<TransitGatewayAttachmentsT>(value);
  }
  template <typename TransitGatewayAttachmentsT = Aws::Vector<TransitGatewayAttachment>>
  DescribeTransitGatewayAttachmentsResponse& WithTransitGatewayAttachments(TransitGatewayAttachmentsT&& value) {
    SetTransitGatewayAttachments(std::forward<TransitGatewayAttachmentsT>(value));
    return *this;
  }
  ...
  DescribeTransitGatewayAttachmentsResponse& AddTransitGatewayAttachments(TransitGatewayAttachmentsT&& value) {
    m_transitGatewayAttachmentsHasBeenSet = true;
    m_transitGatewayAttachments.emplace_back(std::forward<TransitGatewayAttachmentsT>(value));
    return *this;
  }
  ///@}
