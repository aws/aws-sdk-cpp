...
class DescribeKeyPairsRequest : public EC2Request {
 ...
 public:
  ...
  void SetKeyNames(KeyNamesT&& value) {
    m_keyNamesHasBeenSet = true;
    m_keyNames = std::forward<KeyNamesT>(value);
  }
  template <typename KeyNamesT = Aws::Vector<Aws::String>>
  DescribeKeyPairsRequest& WithKeyNames(KeyNamesT&& value) {
    SetKeyNames(std::forward<KeyNamesT>(value));
    return *this;
  }
  template <typename KeyNamesT = Aws::String>
  DescribeKeyPairsRequest& AddKeyNames(KeyNamesT&& value) {
    m_keyNamesHasBeenSet = true;
    m_keyNames.emplace_back(std::forward<KeyNamesT>(value));
    return *this;
  }
  ///@}
  ...
  DescribeKeyPairsRequest& AddKeyPairIds(KeyPairIdsT&& value) {
    m_keyPairIdsHasBeenSet = true;
    m_keyPairIds.emplace_back(std::forward<KeyPairIdsT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetIncludePublicKey(bool value) {
    m_includePublicKeyHasBeenSet = true;
    m_includePublicKey = value;
  }
  inline DescribeKeyPairsRequest& WithIncludePublicKey(bool value) {
    SetIncludePublicKey(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeKeyPairsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
