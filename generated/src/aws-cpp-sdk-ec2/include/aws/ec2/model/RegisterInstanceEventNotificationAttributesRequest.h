...
class RegisterInstanceEventNotificationAttributesRequest : public EC2Request {
 ...
 public:
  ...
  inline RegisterInstanceEventNotificationAttributesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceTagAttributeT = RegisterInstanceTagAttributeRequest>
  RegisterInstanceEventNotificationAttributesRequest& WithInstanceTagAttribute(InstanceTagAttributeT&& value) {
