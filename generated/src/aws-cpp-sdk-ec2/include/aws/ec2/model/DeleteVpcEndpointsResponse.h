...
class DeleteVpcEndpointsResponse {
 public:
  AWS_EC2_API DeleteVpcEndpointsResponse() = default;
  ...
  template <typename UnsuccessfulT = Aws::Vector<UnsuccessfulItem>>
  DeleteVpcEndpointsResponse& WithUnsuccessful(UnsuccessfulT&& value) {
    SetUnsuccessful(std::forward<UnsuccessfulT>(value));
    return *this;
  }
  template <typename UnsuccessfulT = UnsuccessfulItem>
  DeleteVpcEndpointsResponse& AddUnsuccessful(UnsuccessfulT&& value) {
    m_unsuccessfulHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteVpcEndpointsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
