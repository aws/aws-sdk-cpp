...
class DescribeTagsRequest : public EC2Request {
 public:
  AWS_EC2_API DescribeTagsRequest() = default;
 ...
 public:
  ...
  inline DescribeTagsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeTagsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeTagsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  ///@{
  /**
   * <p>The maximum number of items to return for this request. This value can be
   * between 5 and 1000. To get the next page of items, make another request with the
   * token returned in the output. For more information, see <a
  ...
  inline DescribeTagsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTagsRequest& WithNextToken(NextTokenT&& value) {
