...
class StopInstancesResponse {
 public:
  ...
  void SetStoppingInstances(StoppingInstancesT&& value) {
    m_stoppingInstancesHasBeenSet = true;
    m_stoppingInstances = std::forward<StoppingInstancesT>(value);
  }
  template <typename StoppingInstancesT = Aws::Vector<InstanceStateChange>>
  StopInstancesResponse& WithStoppingInstances(StoppingInstancesT&& value) {
    SetStoppingInstances(std::forward<StoppingInstancesT>(value));
    return *this;
  }
  template <typename StoppingInstancesT = InstanceStateChange>
  StopInstancesResponse& AddStoppingInstances(StoppingInstancesT&& value) {
    m_stoppingInstancesHasBeenSet = true;
    m_stoppingInstances.emplace_back(std::forward<StoppingInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StopInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
