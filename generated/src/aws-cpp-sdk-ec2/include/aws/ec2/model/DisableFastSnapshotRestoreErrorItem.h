...
class DisableFastSnapshotRestoreErrorItem {
 public:
  ...
  template <typename SnapshotIdT = Aws::String>
  DisableFastSnapshotRestoreErrorItem& WithSnapshotId(SnapshotIdT&& value) {
   ...
   * <p>The errors.</p>
   */
  inline const Aws::Vector<DisableFastSnapshotRestoreStateErrorItem>& GetFastSnapshotRestoreStateErrors() const {
    return m_fastSnapshotRestoreStateErrors;
  }
  ...
  void SetFastSnapshotRestoreStateErrors(FastSnapshotRestoreStateErrorsT&& value) {
    m_fastSnapshotRestoreStateErrorsHasBeenSet = true;
    m_fastSnapshotRestoreStateErrors = std::forward<FastSnapshotRestoreStateErrorsT>(value);
  }
  template <typename FastSnapshotRestoreStateErrorsT = Aws::Vector<DisableFastSnapshotRestoreStateErrorItem>>
  DisableFastSnapshotRestoreErrorItem& WithFastSnapshotRestoreStateErrors(FastSnapshotRestoreStateErrorsT&& value) {
    SetFastSnapshotRestoreStateErrors(std::forward<FastSnapshotRestoreStateErrorsT>(value));
    return *this;
  }
  template <typename FastSnapshotRestoreStateErrorsT = DisableFastSnapshotRestoreStateErrorItem>
  DisableFastSnapshotRestoreErrorItem& AddFastSnapshotRestoreStateErrors(FastSnapshotRestoreStateErrorsT&& value) {
    m_fastSnapshotRestoreStateErrorsHasBeenSet = true;
    m_fastSnapshotRestoreStateErrors.emplace_back(std::forward<FastSnapshotRestoreStateErrorsT>(value));
    return *this;
  }
  ///@}
 private:
