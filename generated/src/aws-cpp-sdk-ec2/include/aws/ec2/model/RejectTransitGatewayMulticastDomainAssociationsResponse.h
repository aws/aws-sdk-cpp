...
class RejectTransitGatewayMulticastDomainAssociationsResponse {
 public:
  ...
  AWS_EC2_API RejectTransitGatewayMulticastDomainAssociationsResponse(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API RejectTransitGatewayMulticastDomainAssociationsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename AssociationsT = TransitGatewayMulticastDomainAssociations>
  RejectTransitGatewayMulticastDomainAssociationsResponse& WithAssociations(AssociationsT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  RejectTransitGatewayMulticastDomainAssociationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
