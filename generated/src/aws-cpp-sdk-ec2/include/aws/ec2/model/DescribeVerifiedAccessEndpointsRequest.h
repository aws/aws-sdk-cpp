...
class DescribeVerifiedAccessEndpointsRequest : public EC2Request {
 ...
 public:
  ...
  void SetVerifiedAccessEndpointIds(VerifiedAccessEndpointIdsT&& value) {
    m_verifiedAccessEndpointIdsHasBeenSet = true;
    m_verifiedAccessEndpointIds = std::forward<VerifiedAccessEndpointIdsT>(value);
  }
  template <typename VerifiedAccessEndpointIdsT = Aws::Vector<Aws::String>>
  DescribeVerifiedAccessEndpointsRequest& WithVerifiedAccessEndpointIds(VerifiedAccessEndpointIdsT&& value) {
    SetVerifiedAccessEndpointIds(std::forward<VerifiedAccessEndpointIdsT>(value));
    return *this;
  }
  template <typename VerifiedAccessEndpointIdsT = Aws::String>
  DescribeVerifiedAccessEndpointsRequest& AddVerifiedAccessEndpointIds(VerifiedAccessEndpointIdsT&& value) {
    m_verifiedAccessEndpointIdsHasBeenSet = true;
    m_verifiedAccessEndpointIds.emplace_back(std::forward<VerifiedAccessEndpointIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  DescribeVerifiedAccessEndpointsRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename VerifiedAccessGroupIdT = Aws::String>
  DescribeVerifiedAccessEndpointsRequest& WithVerifiedAccessGroupId(VerifiedAccessGroupIdT&& value) {
  ...
  inline DescribeVerifiedAccessEndpointsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVerifiedAccessEndpointsRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeVerifiedAccessEndpointsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeVerifiedAccessEndpointsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeVerifiedAccessEndpointsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
