...
class DescribeVpcBlockPublicAccessExclusionsRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeVpcBlockPublicAccessExclusionsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeVpcBlockPublicAccessExclusionsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeVpcBlockPublicAccessExclusionsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  void SetExclusionIds(ExclusionIdsT&& value) {
    m_exclusionIdsHasBeenSet = true;
    m_exclusionIds = std::forward<ExclusionIdsT>(value);
  }
  template <typename ExclusionIdsT = Aws::Vector<Aws::String>>
  DescribeVpcBlockPublicAccessExclusionsRequest& WithExclusionIds(ExclusionIdsT&& value) {
    SetExclusionIds(std::forward<ExclusionIdsT>(value));
    return *this;
  }
  template <typename ExclusionIdsT = Aws::String>
  DescribeVpcBlockPublicAccessExclusionsRequest& AddExclusionIds(ExclusionIdsT&& value) {
    m_exclusionIdsHasBeenSet = true;
    m_exclusionIds.emplace_back(std::forward<ExclusionIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVpcBlockPublicAccessExclusionsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeVpcBlockPublicAccessExclusionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
