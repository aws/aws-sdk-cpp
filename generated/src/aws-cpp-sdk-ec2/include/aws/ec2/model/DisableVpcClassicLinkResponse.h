...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DisableVpcClassicLinkResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisableVpcClassicLinkResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
