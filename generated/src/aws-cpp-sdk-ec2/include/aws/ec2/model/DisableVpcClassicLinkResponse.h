...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline DisableVpcClassicLinkResponse& WithReturn(bool value) { SetReturn(value); return *this;}
    ...
    inline DisableVpcClassicLinkResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline DisableVpcClassicLinkResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
