...
class TransitGatewayVpcAttachment {
 public:
  ...
  void SetVpcOwnerId(VpcOwnerIdT&& value) {
    ...
    m_vpcOwnerId = std::forward<VpcOwnerIdT>(value);
  }
  template <typename VpcOwnerIdT = Aws::String>
  TransitGatewayVpcAttachment& WithVpcOwnerId(VpcOwnerIdT&& value) {
    SetVpcOwnerId(std::forward<VpcOwnerIdT>(value));
    return *this;
  }
  ///@}
  ...
  inline TransitGatewayVpcAttachment& WithState(TransitGatewayAttachmentState value) {
    SetState(value);
    return *this;
  }
  ///@}
