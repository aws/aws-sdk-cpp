...
class DeregisterTransitGatewayMulticastGroupSourcesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename TransitGatewayMulticastDomainIdT = Aws::String>
  DeregisterTransitGatewayMulticastGroupSourcesRequest& WithTransitGatewayMulticastDomainId(TransitGatewayMulticastDomainIdT&& value) {
  ...
  template <typename GroupIpAddressT = Aws::String>
  DeregisterTransitGatewayMulticastGroupSourcesRequest& WithGroupIpAddress(GroupIpAddressT&& value) {
  ...
  template <typename NetworkInterfaceIdsT = Aws::Vector<Aws::String>>
  DeregisterTransitGatewayMulticastGroupSourcesRequest& WithNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    SetNetworkInterfaceIds(std::forward<NetworkInterfaceIdsT>(value));
    return *this;
  }
  template <typename NetworkInterfaceIdsT = Aws::String>
  DeregisterTransitGatewayMulticastGroupSourcesRequest& AddNetworkInterfaceIds(NetworkInterfaceIdsT&& value) {
    m_networkInterfaceIdsHasBeenSet = true;
  ...
  inline DeregisterTransitGatewayMulticastGroupSourcesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
