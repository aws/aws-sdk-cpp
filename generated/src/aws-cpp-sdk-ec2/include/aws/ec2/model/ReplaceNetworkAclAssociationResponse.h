...
class ReplaceNetworkAclAssociationResponse {
 public:
  ...
  template <typename NewAssociationIdT = Aws::String>
  ReplaceNetworkAclAssociationResponse& WithNewAssociationId(NewAssociationIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ReplaceNetworkAclAssociationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
