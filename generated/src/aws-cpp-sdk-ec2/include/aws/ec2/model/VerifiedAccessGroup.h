...
class VerifiedAccessGroup {
 public:
  ...
  template <typename VerifiedAccessGroupIdT = Aws::String>
  VerifiedAccessGroup& WithVerifiedAccessGroupId(VerifiedAccessGroupIdT&& value) {
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  VerifiedAccessGroup& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  VerifiedAccessGroup& WithDescription(DescriptionT&& value) {
  ...
  template <typename OwnerT = Aws::String>
  VerifiedAccessGroup& WithOwner(OwnerT&& value) {
  ...
  void SetVerifiedAccessGroupArn(VerifiedAccessGroupArnT&& value) {
    m_verifiedAccessGroupArnHasBeenSet = true;
    m_verifiedAccessGroupArn = std::forward<VerifiedAccessGroupArnT>(value);
  }
  template <typename VerifiedAccessGroupArnT = Aws::String>
  VerifiedAccessGroup& WithVerifiedAccessGroupArn(VerifiedAccessGroupArnT&& value) {
    SetVerifiedAccessGroupArn(std::forward<VerifiedAccessGroupArnT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename CreationTimeT = Aws::String>
  VerifiedAccessGroup& WithCreationTime(CreationTimeT&& value) {
  ...
  template <typename LastUpdatedTimeT = Aws::String>
  VerifiedAccessGroup& WithLastUpdatedTime(LastUpdatedTimeT&& value) {
  ...
  template <typename DeletionTimeT = Aws::String>
  VerifiedAccessGroup& WithDeletionTime(DeletionTimeT&& value) {
  ...
  template <typename TagsT = Aws::Vector<Tag>>
  VerifiedAccessGroup& WithTags(TagsT&& value) {
    SetTags(std::forward<TagsT>(value));
    return *this;
  }
  template <typename TagsT = Tag>
  VerifiedAccessGroup& AddTags(TagsT&& value) {
    m_tagsHasBeenSet = true;
  ...
  template <typename SseSpecificationT = VerifiedAccessSseSpecificationResponse>
  VerifiedAccessGroup& WithSseSpecification(SseSpecificationT&& value) {
