...
class UpdateSecurityGroupRuleDescriptionsIngressResponse {
 public:
  ...
  AWS_EC2_API UpdateSecurityGroupRuleDescriptionsIngressResponse& operator=(
  ...
  inline UpdateSecurityGroupRuleDescriptionsIngressResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  UpdateSecurityGroupRuleDescriptionsIngressResponse& WithResponseMetadata(ResponseMetadataT&& value) {
