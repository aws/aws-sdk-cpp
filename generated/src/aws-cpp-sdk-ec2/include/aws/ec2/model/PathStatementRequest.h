...
class PathStatementRequest {
 public:
  ...
  void SetPacketHeaderStatement(PacketHeaderStatementT&& value) {
    m_packetHeaderStatementHasBeenSet = true;
    m_packetHeaderStatement = std::forward<PacketHeaderStatementT>(value);
  }
  template <typename PacketHeaderStatementT = PacketHeaderStatementRequest>
  PathStatementRequest& WithPacketHeaderStatement(PacketHeaderStatementT&& value) {
    SetPacketHeaderStatement(std::forward<PacketHeaderStatementT>(value));
    return *this;
  }
  ///@}
  ...
  void SetResourceStatement(ResourceStatementT&& value) {
    ...
    m_resourceStatement = std::forward<ResourceStatementT>(value);
  }
  template <typename ResourceStatementT = ResourceStatementRequest>
  PathStatementRequest& WithResourceStatement(ResourceStatementT&& value) {
    SetResourceStatement(std::forward<ResourceStatementT>(value));
    return *this;
  }
  ///@}
 private:
