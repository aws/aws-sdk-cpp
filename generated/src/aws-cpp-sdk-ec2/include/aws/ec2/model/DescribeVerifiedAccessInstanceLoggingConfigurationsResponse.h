...
class DescribeVerifiedAccessInstanceLoggingConfigurationsResponse {
 public:
  ...
  AWS_EC2_API DescribeVerifiedAccessInstanceLoggingConfigurationsResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  void SetLoggingConfigurations(LoggingConfigurationsT&& value) {
    ...
    m_loggingConfigurations = std::forward<LoggingConfigurationsT>(value);
  }
  template <typename LoggingConfigurationsT = Aws::Vector<VerifiedAccessInstanceLoggingConfiguration>>
  DescribeVerifiedAccessInstanceLoggingConfigurationsResponse& WithLoggingConfigurations(LoggingConfigurationsT&& value) {
    SetLoggingConfigurations(std::forward<LoggingConfigurationsT>(value));
    return *this;
  }
  template <typename LoggingConfigurationsT = VerifiedAccessInstanceLoggingConfiguration>
  DescribeVerifiedAccessInstanceLoggingConfigurationsResponse& AddLoggingConfigurations(LoggingConfigurationsT&& value) {
    m_loggingConfigurationsHasBeenSet = true;
    m_loggingConfigurations.emplace_back(std::forward<LoggingConfigurationsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVerifiedAccessInstanceLoggingConfigurationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVerifiedAccessInstanceLoggingConfigurationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
