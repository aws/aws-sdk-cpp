...
class GetIpamDiscoveredAccountsRequest : public EC2Request {
 ...
 public:
  ...
  inline GetIpamDiscoveredAccountsRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamResourceDiscoveryIdT = Aws::String>
  GetIpamDiscoveredAccountsRequest& WithIpamResourceDiscoveryId(IpamResourceDiscoveryIdT&& value) {
  ...
  void SetDiscoveryRegion(DiscoveryRegionT&& value) {
    ...
    m_discoveryRegion = std::forward<DiscoveryRegionT>(value);
  }
  template <typename DiscoveryRegionT = Aws::String>
  GetIpamDiscoveredAccountsRequest& WithDiscoveryRegion(DiscoveryRegionT&& value) {
    SetDiscoveryRegion(std::forward<DiscoveryRegionT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetIpamDiscoveredAccountsRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetIpamDiscoveredAccountsRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamDiscoveredAccountsRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetIpamDiscoveredAccountsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
