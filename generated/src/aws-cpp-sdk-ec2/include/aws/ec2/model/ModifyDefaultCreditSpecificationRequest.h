...
class ModifyDefaultCreditSpecificationRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyDefaultCreditSpecificationRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline void SetInstanceFamily(UnlimitedSupportedInstanceFamily value) {
    m_instanceFamilyHasBeenSet = true;
    m_instanceFamily = value;
  }
  inline ModifyDefaultCreditSpecificationRequest& WithInstanceFamily(UnlimitedSupportedInstanceFamily value) {
    SetInstanceFamily(value);
    return *this;
  }
  ///@}
  ...
  void SetCpuCredits(CpuCreditsT&& value) {
    ...
    m_cpuCredits = std::forward<CpuCreditsT>(value);
  }
  template <typename CpuCreditsT = Aws::String>
  ModifyDefaultCreditSpecificationRequest& WithCpuCredits(CpuCreditsT&& value) {
    SetCpuCredits(std::forward<CpuCreditsT>(value));
    return *this;
  }
  ///@}
 private:
