...
class ModifyVerifiedAccessGroupPolicyRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessGroupIdT = Aws::String>
  ModifyVerifiedAccessGroupPolicyRequest& WithVerifiedAccessGroupId(VerifiedAccessGroupIdT&& value) {
  ...
  inline ModifyVerifiedAccessGroupPolicyRequest& WithPolicyEnabled(bool value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  ModifyVerifiedAccessGroupPolicyRequest& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  ModifyVerifiedAccessGroupPolicyRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline ModifyVerifiedAccessGroupPolicyRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename SseSpecificationT = VerifiedAccessSseSpecificationRequest>
  ModifyVerifiedAccessGroupPolicyRequest& WithSseSpecification(SseSpecificationT&& value) {
