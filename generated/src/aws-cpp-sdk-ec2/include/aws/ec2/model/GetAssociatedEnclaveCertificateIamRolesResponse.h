...
class GetAssociatedEnclaveCertificateIamRolesResponse {
 public:
  ...
  AWS_EC2_API GetAssociatedEnclaveCertificateIamRolesResponse& operator=(
  ...
  template <typename AssociatedRolesT = Aws::Vector<AssociatedRole>>
  GetAssociatedEnclaveCertificateIamRolesResponse& WithAssociatedRoles(AssociatedRolesT&& value) {
    SetAssociatedRoles(std::forward<AssociatedRolesT>(value));
    return *this;
  }
  template <typename AssociatedRolesT = AssociatedRole>
  GetAssociatedEnclaveCertificateIamRolesResponse& AddAssociatedRoles(AssociatedRolesT&& value) {
    m_associatedRolesHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetAssociatedEnclaveCertificateIamRolesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
