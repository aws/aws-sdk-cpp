...
class DescribeTrafficMirrorFiltersResponse {
 public:
  ...
  void SetTrafficMirrorFilters(TrafficMirrorFiltersT&& value) {
    m_trafficMirrorFiltersHasBeenSet = true;
    m_trafficMirrorFilters = std::forward<TrafficMirrorFiltersT>(value);
  }
  template <typename TrafficMirrorFiltersT = Aws::Vector<TrafficMirrorFilter>>
  DescribeTrafficMirrorFiltersResponse& WithTrafficMirrorFilters(TrafficMirrorFiltersT&& value) {
    SetTrafficMirrorFilters(std::forward<TrafficMirrorFiltersT>(value));
    return *this;
  }
  template <typename TrafficMirrorFiltersT = TrafficMirrorFilter>
  DescribeTrafficMirrorFiltersResponse& AddTrafficMirrorFilters(TrafficMirrorFiltersT&& value) {
    m_trafficMirrorFiltersHasBeenSet = true;
    m_trafficMirrorFilters.emplace_back(std::forward<TrafficMirrorFiltersT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorFiltersResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTrafficMirrorFiltersResponse& WithResponseMetadata(ResponseMetadataT&& value) {
