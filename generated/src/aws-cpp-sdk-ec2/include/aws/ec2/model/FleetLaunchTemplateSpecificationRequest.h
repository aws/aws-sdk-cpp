...
class FleetLaunchTemplateSpecificationRequest {
 public:
  ...
  template <typename LaunchTemplateIdT = Aws::String>
  FleetLaunchTemplateSpecificationRequest& WithLaunchTemplateId(LaunchTemplateIdT&& value) {
  ...
  template <typename LaunchTemplateNameT = Aws::String>
  FleetLaunchTemplateSpecificationRequest& WithLaunchTemplateName(LaunchTemplateNameT&& value) {
  ...
  template <typename VersionT = Aws::String>
  FleetLaunchTemplateSpecificationRequest& WithVersion(VersionT&& value) {
