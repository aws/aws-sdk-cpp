...
class DescribeLocalGatewayVirtualInterfacesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename LocalGatewayVirtualInterfaceIdsT = Aws::Vector<Aws::String>>
  DescribeLocalGatewayVirtualInterfacesRequest& WithLocalGatewayVirtualInterfaceIds(LocalGatewayVirtualInterfaceIdsT&& value) {
  ...
  DescribeLocalGatewayVirtualInterfacesRequest& AddLocalGatewayVirtualInterfaceIds(LocalGatewayVirtualInterfaceIdsT&& value) {
    m_localGatewayVirtualInterfaceIdsHasBeenSet = true;
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeLocalGatewayVirtualInterfacesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeLocalGatewayVirtualInterfacesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeLocalGatewayVirtualInterfacesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeLocalGatewayVirtualInterfacesRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline DescribeLocalGatewayVirtualInterfacesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
