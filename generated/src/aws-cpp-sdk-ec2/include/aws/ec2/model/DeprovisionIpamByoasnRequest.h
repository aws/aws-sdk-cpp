...
class DeprovisionIpamByoasnRequest : public EC2Request {
 ...
 public:
  ...
  inline DeprovisionIpamByoasnRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename IpamIdT = Aws::String>
  DeprovisionIpamByoasnRequest& WithIpamId(IpamIdT&& value) {
  ...
  template <typename AsnT = Aws::String>
  DeprovisionIpamByoasnRequest& WithAsn(AsnT&& value) {
