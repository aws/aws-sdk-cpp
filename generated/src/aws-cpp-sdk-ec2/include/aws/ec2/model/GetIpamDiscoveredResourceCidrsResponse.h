...
class GetIpamDiscoveredResourceCidrsResponse {
 public:
  ...
  void SetIpamDiscoveredResourceCidrs(IpamDiscoveredResourceCidrsT&& value) {
    m_ipamDiscoveredResourceCidrsHasBeenSet = true;
    m_ipamDiscoveredResourceCidrs = std::forward<IpamDiscoveredResourceCidrsT>(value);
  }
  template <typename IpamDiscoveredResourceCidrsT = Aws::Vector<IpamDiscoveredResourceCidr>>
  GetIpamDiscoveredResourceCidrsResponse& WithIpamDiscoveredResourceCidrs(IpamDiscoveredResourceCidrsT&& value) {
    SetIpamDiscoveredResourceCidrs(std::forward<IpamDiscoveredResourceCidrsT>(value));
    return *this;
  }
  template <typename IpamDiscoveredResourceCidrsT = IpamDiscoveredResourceCidr>
  GetIpamDiscoveredResourceCidrsResponse& AddIpamDiscoveredResourceCidrs(IpamDiscoveredResourceCidrsT&& value) {
    m_ipamDiscoveredResourceCidrsHasBeenSet = true;
    m_ipamDiscoveredResourceCidrs.emplace_back(std::forward<IpamDiscoveredResourceCidrsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetIpamDiscoveredResourceCidrsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetIpamDiscoveredResourceCidrsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
