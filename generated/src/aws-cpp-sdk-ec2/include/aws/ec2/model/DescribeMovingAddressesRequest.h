...
class DescribeMovingAddressesRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeMovingAddressesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename PublicIpsT = Aws::Vector<Aws::String>>
  DescribeMovingAddressesRequest& WithPublicIps(PublicIpsT&& value) {
    SetPublicIps(std::forward<PublicIpsT>(value));
    return *this;
  }
  template <typename PublicIpsT = Aws::String>
  DescribeMovingAddressesRequest& AddPublicIps(PublicIpsT&& value) {
    m_publicIpsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeMovingAddressesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeMovingAddressesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeMovingAddressesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeMovingAddressesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
