...
class CreateReplaceRootVolumeTaskRequest : public EC2Request {
 ...
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  CreateReplaceRootVolumeTaskRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename SnapshotIdT = Aws::String>
  CreateReplaceRootVolumeTaskRequest& WithSnapshotId(SnapshotIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  CreateReplaceRootVolumeTaskRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline CreateReplaceRootVolumeTaskRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename TagSpecificationsT = Aws::Vector<TagSpecification>>
  CreateReplaceRootVolumeTaskRequest& WithTagSpecifications(TagSpecificationsT&& value) {
    SetTagSpecifications(std::forward<TagSpecificationsT>(value));
    return *this;
  }
  template <typename TagSpecificationsT = TagSpecification>
  CreateReplaceRootVolumeTaskRequest& AddTagSpecifications(TagSpecificationsT&& value) {
    m_tagSpecificationsHasBeenSet = true;
  ...
  template <typename ImageIdT = Aws::String>
  CreateReplaceRootVolumeTaskRequest& WithImageId(ImageIdT&& value) {
  ...
  inline void SetDeleteReplacedRootVolume(bool value) {
    m_deleteReplacedRootVolumeHasBeenSet = true;
    m_deleteReplacedRootVolume = value;
  }
  inline CreateReplaceRootVolumeTaskRequest& WithDeleteReplacedRootVolume(bool value) {
    SetDeleteReplacedRootVolume(value);
    return *this;
  }
  ///@}
  ...
  inline CreateReplaceRootVolumeTaskRequest& WithVolumeInitializationRate(long long value) {
