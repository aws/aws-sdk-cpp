...
class DeleteSubnetCidrReservationResponse {
 public:
  ...
  void SetDeletedSubnetCidrReservation(DeletedSubnetCidrReservationT&& value) {
    m_deletedSubnetCidrReservationHasBeenSet = true;
    m_deletedSubnetCidrReservation = std::forward<DeletedSubnetCidrReservationT>(value);
  }
  template <typename DeletedSubnetCidrReservationT = SubnetCidrReservation>
  DeleteSubnetCidrReservationResponse& WithDeletedSubnetCidrReservation(DeletedSubnetCidrReservationT&& value) {
    SetDeletedSubnetCidrReservation(std::forward<DeletedSubnetCidrReservationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DeleteSubnetCidrReservationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
