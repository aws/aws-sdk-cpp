...
class ModifyIdentityIdFormatRequest : public EC2Request {
 ...
 public:
  ...
  template <typename ResourceT = Aws::String>
  ModifyIdentityIdFormatRequest& WithResource(ResourceT&& value) {
  ...
  inline ModifyIdentityIdFormatRequest& WithUseLongIds(bool value) {
    SetUseLongIds(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrincipalArnT = Aws::String>
  ModifyIdentityIdFormatRequest& WithPrincipalArn(PrincipalArnT&& value) {
