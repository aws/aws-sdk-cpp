...
class DescribeTransitGatewayPolicyTablesResponse {
 public:
  ...
  AWS_EC2_API DescribeTransitGatewayPolicyTablesResponse& operator=(
  ...
  void SetTransitGatewayPolicyTables(TransitGatewayPolicyTablesT&& value) {
    m_transitGatewayPolicyTablesHasBeenSet = true;
    m_transitGatewayPolicyTables = std::forward<TransitGatewayPolicyTablesT>(value);
  }
  template <typename TransitGatewayPolicyTablesT = Aws::Vector<TransitGatewayPolicyTable>>
  DescribeTransitGatewayPolicyTablesResponse& WithTransitGatewayPolicyTables(TransitGatewayPolicyTablesT&& value) {
    SetTransitGatewayPolicyTables(std::forward<TransitGatewayPolicyTablesT>(value));
    return *this;
  }
  template <typename TransitGatewayPolicyTablesT = TransitGatewayPolicyTable>
  DescribeTransitGatewayPolicyTablesResponse& AddTransitGatewayPolicyTables(TransitGatewayPolicyTablesT&& value) {
    m_transitGatewayPolicyTablesHasBeenSet = true;
    m_transitGatewayPolicyTables.emplace_back(std::forward<TransitGatewayPolicyTablesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTransitGatewayPolicyTablesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeTransitGatewayPolicyTablesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
