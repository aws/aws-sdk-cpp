...
class CreateTransitGatewayMulticastDomainResponse {
 public:
  ...
  AWS_EC2_API CreateTransitGatewayMulticastDomainResponse& operator=(
  ...
  template <typename TransitGatewayMulticastDomainT = TransitGatewayMulticastDomain>
  CreateTransitGatewayMulticastDomainResponse& WithTransitGatewayMulticastDomain(TransitGatewayMulticastDomainT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) {
