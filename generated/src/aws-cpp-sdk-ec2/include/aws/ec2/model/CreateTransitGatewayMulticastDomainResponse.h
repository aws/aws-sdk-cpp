...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API CreateTransitGatewayMulticastDomainResponse() = default;
    ...
    template<typename TransitGatewayMulticastDomainT = TransitGatewayMulticastDomain>
    CreateTransitGatewayMulticastDomainResponse& WithTransitGatewayMulticastDomain(TransitGatewayMulticastDomainT&& value) { SetTransitGatewayMulticastDomain(std::forward<TransitGatewayMulticastDomainT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateTransitGatewayMulticastDomainResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
