...
namespace Model
{
  ...
  public:
    ...
    template<typename NextTokenT = Aws::String>
    DescribeDeclarativePoliciesReportsResponse& WithNextToken(NextTokenT&& value) { SetNextToken(std::forward<NextTokenT>(value)); return *this;}
    ///@}
    ...
    template<typename ReportsT = Aws::Vector<DeclarativePoliciesReport>>
    DescribeDeclarativePoliciesReportsResponse& WithReports(ReportsT&& value) { SetReports(std::forward<ReportsT>(value)); return *this;}
    template<typename ReportsT = DeclarativePoliciesReport>
    DescribeDeclarativePoliciesReportsResponse& AddReports(ReportsT&& value) { m_reportsHasBeenSet = true; m_reports.emplace_back(std::forward<ReportsT>(value)); return *this; }
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DescribeDeclarativePoliciesReportsResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
