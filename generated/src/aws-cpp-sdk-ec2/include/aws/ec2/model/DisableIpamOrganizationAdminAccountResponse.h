...
class DisableIpamOrganizationAdminAccountResponse {
 public:
  ...
  AWS_EC2_API DisableIpamOrganizationAdminAccountResponse& operator=(
  ...
  inline DisableIpamOrganizationAdminAccountResponse& WithSuccess(bool value) {
    SetSuccess(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DisableIpamOrganizationAdminAccountResponse& WithResponseMetadata(ResponseMetadataT&& value) {
