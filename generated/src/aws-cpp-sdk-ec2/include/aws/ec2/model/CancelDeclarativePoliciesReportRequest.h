...
class CancelDeclarativePoliciesReportRequest : public EC2Request {
 public:
  AWS_EC2_API CancelDeclarativePoliciesReportRequest() = default;
 ...
 public:
  ...
  inline CancelDeclarativePoliciesReportRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename ReportIdT = Aws::String>
  CancelDeclarativePoliciesReportRequest& WithReportId(ReportIdT&& value) {
