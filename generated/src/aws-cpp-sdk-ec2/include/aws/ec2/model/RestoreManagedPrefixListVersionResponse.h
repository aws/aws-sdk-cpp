...
namespace Model
{
  ...
  public:
    ...
    template<typename PrefixListT = ManagedPrefixList>
    RestoreManagedPrefixListVersionResponse& WithPrefixList(PrefixListT&& value) { SetPrefixList(std::forward<PrefixListT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RestoreManagedPrefixListVersionResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
