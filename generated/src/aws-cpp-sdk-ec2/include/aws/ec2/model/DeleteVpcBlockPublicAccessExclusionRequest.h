...
class DeleteVpcBlockPublicAccessExclusionRequest : public EC2Request {
 public:
  AWS_EC2_API DeleteVpcBlockPublicAccessExclusionRequest() = default;
 ...
 public:
  ...
  inline DeleteVpcBlockPublicAccessExclusionRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetExclusionId(ExclusionIdT&& value) {
    ...
    m_exclusionId = std::forward<ExclusionIdT>(value);
  }
  template <typename ExclusionIdT = Aws::String>
  DeleteVpcBlockPublicAccessExclusionRequest& WithExclusionId(ExclusionIdT&& value) {
    SetExclusionId(std::forward<ExclusionIdT>(value));
    return *this;
  }
  ///@}
 private:
