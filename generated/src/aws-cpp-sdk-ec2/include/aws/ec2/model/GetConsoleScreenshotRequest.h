...
class GetConsoleScreenshotRequest : public EC2Request {
 ...
 public:
  ...
  inline GetConsoleScreenshotRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename InstanceIdT = Aws::String>
  GetConsoleScreenshotRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  inline GetConsoleScreenshotRequest& WithWakeUp(bool value) {
    SetWakeUp(value);
    return *this;
  }
  ///@}
