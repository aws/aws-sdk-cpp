...
class DescribeInstanceTypeOfferingsResponse {
 public:
  ...
  void SetInstanceTypeOfferings(InstanceTypeOfferingsT&& value) {
    m_instanceTypeOfferingsHasBeenSet = true;
    m_instanceTypeOfferings = std::forward<InstanceTypeOfferingsT>(value);
  }
  template <typename InstanceTypeOfferingsT = Aws::Vector<InstanceTypeOffering>>
  DescribeInstanceTypeOfferingsResponse& WithInstanceTypeOfferings(InstanceTypeOfferingsT&& value) {
    SetInstanceTypeOfferings(std::forward<InstanceTypeOfferingsT>(value));
    return *this;
  }
  template <typename InstanceTypeOfferingsT = InstanceTypeOffering>
  DescribeInstanceTypeOfferingsResponse& AddInstanceTypeOfferings(InstanceTypeOfferingsT&& value) {
    m_instanceTypeOfferingsHasBeenSet = true;
    m_instanceTypeOfferings.emplace_back(std::forward<InstanceTypeOfferingsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeInstanceTypeOfferingsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeInstanceTypeOfferingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
