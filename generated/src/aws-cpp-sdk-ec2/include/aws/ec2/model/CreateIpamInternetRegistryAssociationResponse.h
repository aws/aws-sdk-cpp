...
namespace EC2 {
namespace Model {
class CreateIpamInternetRegistryAssociationResponse {
 public:
  AWS_EC2_API CreateIpamInternetRegistryAssociationResponse() = default;
  AWS_EC2_API CreateIpamInternetRegistryAssociationResponse(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_EC2_API CreateIpamInternetRegistryAssociationResponse& operator=(
  ...
  template <typename IpamInternetRegistryAssociationT = IpamInternetRegistryAssociation>
  CreateIpamInternetRegistryAssociationResponse& WithIpamInternetRegistryAssociation(IpamInternetRegistryAssociationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateIpamInternetRegistryAssociationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
