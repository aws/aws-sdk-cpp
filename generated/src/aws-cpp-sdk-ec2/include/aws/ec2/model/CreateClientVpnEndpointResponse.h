...
class CreateClientVpnEndpointResponse {
 public:
  ...
  template <typename ClientVpnEndpointIdT = Aws::String>
  CreateClientVpnEndpointResponse& WithClientVpnEndpointId(ClientVpnEndpointIdT&& value) {
  ...
  template <typename StatusT = ClientVpnEndpointStatus>
  CreateClientVpnEndpointResponse& WithStatus(StatusT&& value) {
  ...
  template <typename DnsNameT = Aws::String>
  CreateClientVpnEndpointResponse& WithDnsName(DnsNameT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  CreateClientVpnEndpointResponse& WithResponseMetadata(ResponseMetadataT&& value) {
