...
class VerifiedAccessInstanceUserTrustProviderClientConfiguration {
 public:
  ...
  inline void SetType(UserTrustProviderType value) {
    m_typeHasBeenSet = true;
    m_type = value;
  }
  inline VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithType(UserTrustProviderType value) {
    SetType(value);
    return *this;
  }
  ///@}
  ...
  template <typename ScopesT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithScopes(ScopesT&& value) {
  ...
  template <typename IssuerT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithIssuer(IssuerT&& value) {
  ...
  template <typename AuthorizationEndpointT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithAuthorizationEndpoint(AuthorizationEndpointT&& value) {
  ...
  void SetPublicSigningKeyEndpoint(PublicSigningKeyEndpointT&& value) {
    ...
    m_publicSigningKeyEndpoint = std::forward<PublicSigningKeyEndpointT>(value);
  }
  template <typename PublicSigningKeyEndpointT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithPublicSigningKeyEndpoint(PublicSigningKeyEndpointT&& value) {
    SetPublicSigningKeyEndpoint(std::forward<PublicSigningKeyEndpointT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TokenEndpointT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithTokenEndpoint(TokenEndpointT&& value) {
  ...
  template <typename UserInfoEndpointT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithUserInfoEndpoint(UserInfoEndpointT&& value) {
  ...
  template <typename ClientIdT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithClientId(ClientIdT&& value) {
  ...
  template <typename ClientSecretT = Aws::String>
  VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithClientSecret(ClientSecretT&& value) {
  ...
  inline VerifiedAccessInstanceUserTrustProviderClientConfiguration& WithPkceEnabled(bool value) {
    SetPkceEnabled(value);
    return *this;
  }
  ///@}
 private:
