...
class PurchaseReservedInstancesOfferingRequest : public EC2Request {
 ...
 public:
  ...
  inline PurchaseReservedInstancesOfferingRequest& WithInstanceCount(int value) {
  ...
  void SetPurchaseTime(PurchaseTimeT&& value) {
    m_purchaseTimeHasBeenSet = true;
    m_purchaseTime = std::forward<PurchaseTimeT>(value);
  }
  template <typename PurchaseTimeT = Aws::Utils::DateTime>
  PurchaseReservedInstancesOfferingRequest& WithPurchaseTime(PurchaseTimeT&& value) {
    SetPurchaseTime(std::forward<PurchaseTimeT>(value));
    return *this;
  }
  ///@}
  ...
  inline PurchaseReservedInstancesOfferingRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  void SetLimitPrice(LimitPriceT&& value) {
    m_limitPriceHasBeenSet = true;
    m_limitPrice = std::forward<LimitPriceT>(value);
  }
  template <typename LimitPriceT = ReservedInstanceLimitPrice>
  PurchaseReservedInstancesOfferingRequest& WithLimitPrice(LimitPriceT&& value) {
    SetLimitPrice(std::forward<LimitPriceT>(value));
    return *this;
  }
  ///@}
 private:
