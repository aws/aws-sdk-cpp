...
namespace Model
{
  ...
  public:
    ...
    template<typename VerifiedAccessInstanceT = VerifiedAccessInstance>
    CreateVerifiedAccessInstanceResponse& WithVerifiedAccessInstance(VerifiedAccessInstanceT&& value) { SetVerifiedAccessInstance(std::forward<VerifiedAccessInstanceT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateVerifiedAccessInstanceResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
