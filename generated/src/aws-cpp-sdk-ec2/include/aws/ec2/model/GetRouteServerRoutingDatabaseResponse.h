...
class GetRouteServerRoutingDatabaseResponse {
 public:
  ...
  inline void SetAreRoutesPersisted(bool value) {
    m_areRoutesPersistedHasBeenSet = true;
    m_areRoutesPersisted = value;
  }
  inline GetRouteServerRoutingDatabaseResponse& WithAreRoutesPersisted(bool value) {
    SetAreRoutesPersisted(value);
    return *this;
  }
  ///@}
  ...
  template <typename RoutesT = Aws::Vector<RouteServerRoute>>
  GetRouteServerRoutingDatabaseResponse& WithRoutes(RoutesT&& value) {
    SetRoutes(std::forward<RoutesT>(value));
    return *this;
  }
  template <typename RoutesT = RouteServerRoute>
  GetRouteServerRoutingDatabaseResponse& AddRoutes(RoutesT&& value) {
    m_routesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetRouteServerRoutingDatabaseResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetRouteServerRoutingDatabaseResponse& WithResponseMetadata(ResponseMetadataT&& value) {
