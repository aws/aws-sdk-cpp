...
class ModifyInstanceEventWindowResponse {
 public:
  AWS_EC2_API ModifyInstanceEventWindowResponse() = default;
  ...
  template <typename InstanceEventWindowT = InstanceEventWindow>
  ModifyInstanceEventWindowResponse& WithInstanceEventWindow(InstanceEventWindowT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyInstanceEventWindowResponse& WithResponseMetadata(ResponseMetadataT&& value) {
