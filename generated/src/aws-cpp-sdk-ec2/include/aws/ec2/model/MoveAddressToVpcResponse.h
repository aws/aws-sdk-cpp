...
class MoveAddressToVpcResponse {
 public:
  ...
  template <typename AllocationIdT = Aws::String>
  MoveAddressToVpcResponse& WithAllocationId(AllocationIdT&& value) {
  ...
  inline MoveAddressToVpcResponse& WithStatus(Status value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  MoveAddressToVpcResponse& WithResponseMetadata(ResponseMetadataT&& value) {
