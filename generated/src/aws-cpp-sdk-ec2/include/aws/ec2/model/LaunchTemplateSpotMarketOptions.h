...
class LaunchTemplateSpotMarketOptions {
 public:
  ...
  template <typename MaxPriceT = Aws::String>
  LaunchTemplateSpotMarketOptions& WithMaxPrice(MaxPriceT&& value) {
  ...
  inline LaunchTemplateSpotMarketOptions& WithSpotInstanceType(SpotInstanceType value) {
  ...
  inline LaunchTemplateSpotMarketOptions& WithBlockDurationMinutes(int value) {
  ...
  template <typename ValidUntilT = Aws::Utils::DateTime>
  LaunchTemplateSpotMarketOptions& WithValidUntil(ValidUntilT&& value) {
  ...
  inline LaunchTemplateSpotMarketOptions& WithInstanceInterruptionBehavior(InstanceInterruptionBehavior value) {
