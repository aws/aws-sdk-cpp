...
class DescribeImageUsageReportsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageUsageReportsResponse& WithNextToken(NextTokenT&& value) {
  ...
  void SetImageUsageReports(ImageUsageReportsT&& value) {
    m_imageUsageReportsHasBeenSet = true;
    m_imageUsageReports = std::forward<ImageUsageReportsT>(value);
  }
  template <typename ImageUsageReportsT = Aws::Vector<ImageUsageReport>>
  DescribeImageUsageReportsResponse& WithImageUsageReports(ImageUsageReportsT&& value) {
    SetImageUsageReports(std::forward<ImageUsageReportsT>(value));
    return *this;
  }
  template <typename ImageUsageReportsT = ImageUsageReport>
  DescribeImageUsageReportsResponse& AddImageUsageReports(ImageUsageReportsT&& value) {
    m_imageUsageReportsHasBeenSet = true;
    m_imageUsageReports.emplace_back(std::forward<ImageUsageReportsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeImageUsageReportsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
