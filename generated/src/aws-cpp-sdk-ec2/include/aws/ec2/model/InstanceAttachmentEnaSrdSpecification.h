 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/InstanceAttachmentEnaSrdSpecification">AWS
 * API Reference</a></p>
 */
class InstanceAttachmentEnaSrdSpecification {
 public:
  ...
  inline void SetEnaSrdEnabled(bool value) {
    m_enaSrdEnabledHasBeenSet = true;
    m_enaSrdEnabled = value;
  }
  inline InstanceAttachmentEnaSrdSpecification& WithEnaSrdEnabled(bool value) {
    SetEnaSrdEnabled(value);
    return *this;
  }
  ///@}
  ...
  void SetEnaSrdUdpSpecification(EnaSrdUdpSpecificationT&& value) {
    ...
    m_enaSrdUdpSpecification = std::forward<EnaSrdUdpSpecificationT>(value);
  }
  template <typename EnaSrdUdpSpecificationT = InstanceAttachmentEnaSrdUdpSpecification>
  InstanceAttachmentEnaSrdSpecification& WithEnaSrdUdpSpecification(EnaSrdUdpSpecificationT&& value) {
    SetEnaSrdUdpSpecification(std::forward<EnaSrdUdpSpecificationT>(value));
    return *this;
  }
  ///@}
 private:
