...
class ModifyVerifiedAccessGroupPolicyResponse {
 public:
  ...
  inline ModifyVerifiedAccessGroupPolicyResponse& WithPolicyEnabled(bool value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  ModifyVerifiedAccessGroupPolicyResponse& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename SseSpecificationT = VerifiedAccessSseSpecificationResponse>
  ModifyVerifiedAccessGroupPolicyResponse& WithSseSpecification(SseSpecificationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyVerifiedAccessGroupPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
