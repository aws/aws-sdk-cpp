...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API ModifyVerifiedAccessGroupPolicyResponse() = default;
    ...
    template<typename PolicyDocumentT = Aws::String>
    ModifyVerifiedAccessGroupPolicyResponse& WithPolicyDocument(PolicyDocumentT&& value) { SetPolicyDocument(std::forward<PolicyDocumentT>(value)); return *this;}
    ///@}
    ...
    template<typename SseSpecificationT = VerifiedAccessSseSpecificationResponse>
    ModifyVerifiedAccessGroupPolicyResponse& WithSseSpecification(SseSpecificationT&& value) { SetSseSpecification(std::forward<SseSpecificationT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyVerifiedAccessGroupPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
