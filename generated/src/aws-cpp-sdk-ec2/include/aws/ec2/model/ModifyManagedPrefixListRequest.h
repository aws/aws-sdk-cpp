...
class ModifyManagedPrefixListRequest : public EC2Request {
 ...
 public:
  ...
  inline ModifyManagedPrefixListRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename PrefixListIdT = Aws::String>
  ModifyManagedPrefixListRequest& WithPrefixListId(PrefixListIdT&& value) {
  ...
  inline ModifyManagedPrefixListRequest& WithCurrentVersion(long long value) {
  ...
  template <typename PrefixListNameT = Aws::String>
  ModifyManagedPrefixListRequest& WithPrefixListName(PrefixListNameT&& value) {
  ...
  void SetAddEntries(AddEntriesT&& value) {
    m_addEntriesHasBeenSet = true;
    m_addEntries = std::forward<AddEntriesT>(value);
  }
  template <typename AddEntriesT = Aws::Vector<AddPrefixListEntry>>
  ModifyManagedPrefixListRequest& WithAddEntries(AddEntriesT&& value) {
    SetAddEntries(std::forward<AddEntriesT>(value));
    return *this;
  }
  template <typename AddEntriesT = AddPrefixListEntry>
  ModifyManagedPrefixListRequest& AddAddEntries(AddEntriesT&& value) {
    m_addEntriesHasBeenSet = true;
    m_addEntries.emplace_back(std::forward<AddEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetRemoveEntries(RemoveEntriesT&& value) {
    m_removeEntriesHasBeenSet = true;
    m_removeEntries = std::forward<RemoveEntriesT>(value);
  }
  template <typename RemoveEntriesT = Aws::Vector<RemovePrefixListEntry>>
  ModifyManagedPrefixListRequest& WithRemoveEntries(RemoveEntriesT&& value) {
    SetRemoveEntries(std::forward<RemoveEntriesT>(value));
    return *this;
  }
  template <typename RemoveEntriesT = RemovePrefixListEntry>
  ModifyManagedPrefixListRequest& AddRemoveEntries(RemoveEntriesT&& value) {
    m_removeEntriesHasBeenSet = true;
    m_removeEntries.emplace_back(std::forward<RemoveEntriesT>(value));
    return *this;
  }
  ///@}
  ...
  inline ModifyManagedPrefixListRequest& WithMaxEntries(int value) {
    SetMaxEntries(value);
    return *this;
  }
  ///@}
