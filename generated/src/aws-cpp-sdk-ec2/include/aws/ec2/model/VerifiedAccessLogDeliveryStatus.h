...
class VerifiedAccessLogDeliveryStatus {
 public:
  ...
  inline void SetCode(VerifiedAccessLogDeliveryStatusCode value) {
    m_codeHasBeenSet = true;
    m_code = value;
  }
  inline VerifiedAccessLogDeliveryStatus& WithCode(VerifiedAccessLogDeliveryStatusCode value) {
    SetCode(value);
    return *this;
  }
  ///@}
  ...
  template <typename MessageT = Aws::String>
  VerifiedAccessLogDeliveryStatus& WithMessage(MessageT&& value) {
