...
class ConfirmProductInstanceResponse {
 public:
  ...
  inline ConfirmProductInstanceResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename OwnerIdT = Aws::String>
  ConfirmProductInstanceResponse& WithOwnerId(OwnerIdT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ConfirmProductInstanceResponse& WithResponseMetadata(ResponseMetadataT&& value) {
