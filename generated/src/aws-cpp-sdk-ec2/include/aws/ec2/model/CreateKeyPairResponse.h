...
namespace Model
{
  ...
  public:
    ...
    template<typename KeyPairIdT = Aws::String>
    CreateKeyPairResponse& WithKeyPairId(KeyPairIdT&& value) { SetKeyPairId(std::forward<KeyPairIdT>(value)); return *this;}
    ///@}
    ...
    template<typename TagsT = Aws::Vector<Tag>>
    CreateKeyPairResponse& WithTags(TagsT&& value) { SetTags(std::forward<TagsT>(value)); return *this;}
    template<typename TagsT = Tag>
    CreateKeyPairResponse& AddTags(TagsT&& value) { m_tagsHasBeenSet = true; m_tags.emplace_back(std::forward<TagsT>(value)); return *this; }
    ///@}
    ...
    template<typename KeyNameT = Aws::String>
    CreateKeyPairResponse& WithKeyName(KeyNameT&& value) { SetKeyName(std::forward<KeyNameT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyFingerprintT = Aws::String>
    CreateKeyPairResponse& WithKeyFingerprint(KeyFingerprintT&& value) { SetKeyFingerprint(std::forward<KeyFingerprintT>(value)); return *this;}
    ///@}
    ...
    template<typename KeyMaterialT = Aws::String>
    CreateKeyPairResponse& WithKeyMaterial(KeyMaterialT&& value) { SetKeyMaterial(std::forward<KeyMaterialT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    CreateKeyPairResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
