...
class AssociateTransitGatewayRouteTableResponse {
 public:
  ...
  template <typename AssociationT = TransitGatewayAssociation>
  AssociateTransitGatewayRouteTableResponse& WithAssociation(AssociationT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateTransitGatewayRouteTableResponse& WithResponseMetadata(ResponseMetadataT&& value) {
