...
class DescribeImageUsageReportEntriesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename ImageIdsT = Aws::Vector<Aws::String>>
  DescribeImageUsageReportEntriesRequest& WithImageIds(ImageIdsT&& value) {
    SetImageIds(std::forward<ImageIdsT>(value));
    return *this;
  }
  template <typename ImageIdsT = Aws::String>
  DescribeImageUsageReportEntriesRequest& AddImageIds(ImageIdsT&& value) {
    m_imageIdsHasBeenSet = true;
  ...
  template <typename ReportIdsT = Aws::Vector<Aws::String>>
  DescribeImageUsageReportEntriesRequest& WithReportIds(ReportIdsT&& value) {
    SetReportIds(std::forward<ReportIdsT>(value));
    return *this;
  }
  template <typename ReportIdsT = Aws::String>
  DescribeImageUsageReportEntriesRequest& AddReportIds(ReportIdsT&& value) {
    m_reportIdsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeImageUsageReportEntriesRequest& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeImageUsageReportEntriesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeImageUsageReportEntriesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeImageUsageReportEntriesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  inline DescribeImageUsageReportEntriesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
