...
class GetTransitGatewayRouteTableAssociationsResponse {
 public:
  AWS_EC2_API GetTransitGatewayRouteTableAssociationsResponse() = default;
  ...
  AWS_EC2_API GetTransitGatewayRouteTableAssociationsResponse& operator=(
  ...
  template <typename AssociationsT = Aws::Vector<TransitGatewayRouteTableAssociation>>
  void SetAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
    m_associations = std::forward<AssociationsT>(value);
  }
  template <typename AssociationsT = Aws::Vector<TransitGatewayRouteTableAssociation>>
  GetTransitGatewayRouteTableAssociationsResponse& WithAssociations(AssociationsT&& value) {
    SetAssociations(std::forward<AssociationsT>(value));
    return *this;
  }
  template <typename AssociationsT = TransitGatewayRouteTableAssociation>
  GetTransitGatewayRouteTableAssociationsResponse& AddAssociations(AssociationsT&& value) {
    m_associationsHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  GetTransitGatewayRouteTableAssociationsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetTransitGatewayRouteTableAssociationsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
