...
class ModifyInstanceCapacityReservationAttributesResponse {
 public:
  AWS_EC2_API ModifyInstanceCapacityReservationAttributesResponse() = default;
  ...
  AWS_EC2_API ModifyInstanceCapacityReservationAttributesResponse& operator=(
  ...
  inline ModifyInstanceCapacityReservationAttributesResponse& WithReturn(bool value) {
    SetReturn(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  ModifyInstanceCapacityReservationAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
