...
namespace Model
{
  ...
  public:
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    ModifyInstanceCapacityReservationAttributesResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
