...
class DescribeClientVpnEndpointsResponse {
 public:
  ...
  void SetClientVpnEndpoints(ClientVpnEndpointsT&& value) {
    m_clientVpnEndpointsHasBeenSet = true;
    m_clientVpnEndpoints = std::forward<ClientVpnEndpointsT>(value);
  }
  template <typename ClientVpnEndpointsT = Aws::Vector<ClientVpnEndpoint>>
  DescribeClientVpnEndpointsResponse& WithClientVpnEndpoints(ClientVpnEndpointsT&& value) {
    SetClientVpnEndpoints(std::forward<ClientVpnEndpointsT>(value));
    return *this;
  }
  template <typename ClientVpnEndpointsT = ClientVpnEndpoint>
  DescribeClientVpnEndpointsResponse& AddClientVpnEndpoints(ClientVpnEndpointsT&& value) {
    m_clientVpnEndpointsHasBeenSet = true;
    m_clientVpnEndpoints.emplace_back(std::forward<ClientVpnEndpointsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClientVpnEndpointsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClientVpnEndpointsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
