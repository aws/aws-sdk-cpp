...
class EnableAllowedImagesSettingsResponse {
 public:
  ...
  inline EnableAllowedImagesSettingsResponse& WithAllowedImagesSettingsState(AllowedImagesSettingsEnabledState value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  EnableAllowedImagesSettingsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
