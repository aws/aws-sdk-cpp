...
class DescribeTrafficMirrorFilterRulesRequest : public EC2Request {
 ...
 public:
  ...
  void SetTrafficMirrorFilterRuleIds(TrafficMirrorFilterRuleIdsT&& value) {
    m_trafficMirrorFilterRuleIdsHasBeenSet = true;
    m_trafficMirrorFilterRuleIds = std::forward<TrafficMirrorFilterRuleIdsT>(value);
  }
  template <typename TrafficMirrorFilterRuleIdsT = Aws::Vector<Aws::String>>
  DescribeTrafficMirrorFilterRulesRequest& WithTrafficMirrorFilterRuleIds(TrafficMirrorFilterRuleIdsT&& value) {
    SetTrafficMirrorFilterRuleIds(std::forward<TrafficMirrorFilterRuleIdsT>(value));
    return *this;
  }
  template <typename TrafficMirrorFilterRuleIdsT = Aws::String>
  DescribeTrafficMirrorFilterRulesRequest& AddTrafficMirrorFilterRuleIds(TrafficMirrorFilterRuleIdsT&& value) {
    m_trafficMirrorFilterRuleIdsHasBeenSet = true;
    m_trafficMirrorFilterRuleIds.emplace_back(std::forward<TrafficMirrorFilterRuleIdsT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename TrafficMirrorFilterIdT = Aws::String>
  DescribeTrafficMirrorFilterRulesRequest& WithTrafficMirrorFilterId(TrafficMirrorFilterIdT&& value) {
  ...
  inline DescribeTrafficMirrorFilterRulesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  DescribeTrafficMirrorFilterRulesRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  DescribeTrafficMirrorFilterRulesRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline DescribeTrafficMirrorFilterRulesRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeTrafficMirrorFilterRulesRequest& WithNextToken(NextTokenT&& value) {
