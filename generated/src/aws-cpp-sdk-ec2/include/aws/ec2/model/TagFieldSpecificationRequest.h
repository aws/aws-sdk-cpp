 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TagFieldSpecificationRequest">AWS
 * API Reference</a></p>
 */
class TagFieldSpecificationRequest {
 public:
  AWS_EC2_API TagFieldSpecificationRequest() = default;
  AWS_EC2_API TagFieldSpecificationRequest(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API TagFieldSpecificationRequest& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  inline TagFieldSpecificationRequest& WithResourceType(TaggableResourceType value) {
  ...
  template <typename TagKeysT = Aws::Vector<Aws::String>>
  TagFieldSpecificationRequest& WithTagKeys(TagKeysT&& value) {
    SetTagKeys(std::forward<TagKeysT>(value));
    return *this;
  }
  template <typename TagKeysT = Aws::String>
  TagFieldSpecificationRequest& AddTagKeys(TagKeysT&& value) {
    m_tagKeysHasBeenSet = true;
