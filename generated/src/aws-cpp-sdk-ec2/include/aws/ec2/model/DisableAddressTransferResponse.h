...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API DisableAddressTransferResponse() = default;
    ...
    template<typename AddressTransferT = AddressTransfer>
    DisableAddressTransferResponse& WithAddressTransfer(AddressTransferT&& value) { SetAddressTransfer(std::forward<AddressTransferT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    DisableAddressTransferResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
