...
class DescribeClassicLinkInstancesResponse {
 public:
  AWS_EC2_API DescribeClassicLinkInstancesResponse() = default;
  ...
  template <typename InstancesT = Aws::Vector<ClassicLinkInstance>>
  void SetInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
    m_instances = std::forward<InstancesT>(value);
  }
  template <typename InstancesT = Aws::Vector<ClassicLinkInstance>>
  DescribeClassicLinkInstancesResponse& WithInstances(InstancesT&& value) {
    SetInstances(std::forward<InstancesT>(value));
    return *this;
  }
  template <typename InstancesT = ClassicLinkInstance>
  DescribeClassicLinkInstancesResponse& AddInstances(InstancesT&& value) {
    m_instancesHasBeenSet = true;
  ...
  template <typename NextTokenT = Aws::String>
  DescribeClassicLinkInstancesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeClassicLinkInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
