...
class GetVerifiedAccessGroupPolicyResponse {
 public:
  ...
  inline GetVerifiedAccessGroupPolicyResponse& WithPolicyEnabled(bool value) {
  ...
  template <typename PolicyDocumentT = Aws::String>
  GetVerifiedAccessGroupPolicyResponse& WithPolicyDocument(PolicyDocumentT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetVerifiedAccessGroupPolicyResponse& WithResponseMetadata(ResponseMetadataT&& value) {
