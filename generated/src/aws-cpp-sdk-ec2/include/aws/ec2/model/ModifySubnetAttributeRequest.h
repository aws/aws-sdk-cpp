...
namespace Model
{
  ...
  public:
     ...
     * destinations.</p>  <p>You must first configure a NAT gateway in a public
     * subnet (separate from the subnet containing the IPv6-only workloads). For
     * example, the subnet containing the NAT gateway should have a
     * <code>0.0.0.0/0</code> route pointing to the internet gateway. For more
     * information, see <a
