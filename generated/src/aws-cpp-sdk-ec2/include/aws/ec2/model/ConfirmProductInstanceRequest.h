...
class ConfirmProductInstanceRequest : public EC2Request {
 ...
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  ConfirmProductInstanceRequest& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename ProductCodeT = Aws::String>
  ConfirmProductInstanceRequest& WithProductCode(ProductCodeT&& value) {
  ...
  inline ConfirmProductInstanceRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
