...
class LaunchTemplatePrivateDnsNameOptionsRequest {
 public:
  AWS_EC2_API LaunchTemplatePrivateDnsNameOptionsRequest() = default;
  ...
  inline LaunchTemplatePrivateDnsNameOptionsRequest& WithHostnameType(HostnameType value) {
  ...
  inline LaunchTemplatePrivateDnsNameOptionsRequest& WithEnableResourceNameDnsARecord(bool value) {
  ...
  inline LaunchTemplatePrivateDnsNameOptionsRequest& WithEnableResourceNameDnsAAAARecord(bool value) {
