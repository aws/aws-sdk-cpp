...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API RevokeClientVpnIngressResponse() = default;
    ...
    template<typename StatusT = ClientVpnAuthorizationRuleStatus>
    RevokeClientVpnIngressResponse& WithStatus(StatusT&& value) { SetStatus(std::forward<StatusT>(value)); return *this;}
    ///@}
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    RevokeClientVpnIngressResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
