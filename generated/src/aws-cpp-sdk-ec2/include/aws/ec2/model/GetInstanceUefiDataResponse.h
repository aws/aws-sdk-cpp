...
class GetInstanceUefiDataResponse {
 public:
  ...
  template <typename InstanceIdT = Aws::String>
  GetInstanceUefiDataResponse& WithInstanceId(InstanceIdT&& value) {
  ...
  template <typename UefiDataT = Aws::String>
  GetInstanceUefiDataResponse& WithUefiData(UefiDataT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  GetInstanceUefiDataResponse& WithResponseMetadata(ResponseMetadataT&& value) {
