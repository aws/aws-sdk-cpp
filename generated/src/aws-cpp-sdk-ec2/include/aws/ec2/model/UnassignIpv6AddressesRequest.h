...
class UnassignIpv6AddressesRequest : public EC2Request {
 ...
 public:
  ...
  template <typename Ipv6PrefixesT = Aws::Vector<Aws::String>>
  UnassignIpv6AddressesRequest& WithIpv6Prefixes(Ipv6PrefixesT&& value) {
    SetIpv6Prefixes(std::forward<Ipv6PrefixesT>(value));
    return *this;
  }
  template <typename Ipv6PrefixesT = Aws::String>
  UnassignIpv6AddressesRequest& AddIpv6Prefixes(Ipv6PrefixesT&& value) {
    m_ipv6PrefixesHasBeenSet = true;
  ...
  template <typename NetworkInterfaceIdT = Aws::String>
  UnassignIpv6AddressesRequest& WithNetworkInterfaceId(NetworkInterfaceIdT&& value) {
  ...
  template <typename Ipv6AddressesT = Aws::Vector<Aws::String>>
  UnassignIpv6AddressesRequest& WithIpv6Addresses(Ipv6AddressesT&& value) {
    SetIpv6Addresses(std::forward<Ipv6AddressesT>(value));
    return *this;
  }
  template <typename Ipv6AddressesT = Aws::String>
  UnassignIpv6AddressesRequest& AddIpv6Addresses(Ipv6AddressesT&& value) {
    m_ipv6AddressesHasBeenSet = true;
