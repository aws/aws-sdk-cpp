...
class GetSecurityGroupsForVpcRequest : public EC2Request {
 public:
  AWS_EC2_API GetSecurityGroupsForVpcRequest() = default;
 ...
 public:
  ...
  template <typename VpcIdT = Aws::String>
  GetSecurityGroupsForVpcRequest& WithVpcId(VpcIdT&& value) {
  ...
  template <typename NextTokenT = Aws::String>
  GetSecurityGroupsForVpcRequest& WithNextToken(NextTokenT&& value) {
  ...
  inline GetSecurityGroupsForVpcRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename FiltersT = Aws::Vector<Filter>>
  GetSecurityGroupsForVpcRequest& WithFilters(FiltersT&& value) {
    SetFilters(std::forward<FiltersT>(value));
    return *this;
  }
  template <typename FiltersT = Filter>
  GetSecurityGroupsForVpcRequest& AddFilters(FiltersT&& value) {
    m_filtersHasBeenSet = true;
  ...
  inline GetSecurityGroupsForVpcRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
