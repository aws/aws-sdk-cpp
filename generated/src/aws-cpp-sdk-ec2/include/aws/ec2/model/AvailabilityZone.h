...
class AvailabilityZone {
 public:
  ...
  inline void SetOptInStatus(AvailabilityZoneOptInStatus value) {
    m_optInStatusHasBeenSet = true;
    m_optInStatus = value;
  }
  inline AvailabilityZone& WithOptInStatus(AvailabilityZoneOptInStatus value) {
  ...
  void SetParentZoneName(ParentZoneNameT&& value) {
    ...
    m_parentZoneName = std::forward<ParentZoneNameT>(value);
  }
  template <typename ParentZoneNameT = Aws::String>
  AvailabilityZone& WithParentZoneName(ParentZoneNameT&& value) {
    SetParentZoneName(std::forward<ParentZoneNameT>(value));
    return *this;
  }
  ///@}
  ...
  void SetParentZoneId(ParentZoneIdT&& value) {
    ...
    m_parentZoneId = std::forward<ParentZoneIdT>(value);
  }
  template <typename ParentZoneIdT = Aws::String>
  AvailabilityZone& WithParentZoneId(ParentZoneIdT&& value) {
    SetParentZoneId(std::forward<ParentZoneIdT>(value));
    return *this;
  }
  ///@}
  ...
  void SetGroupLongName(GroupLongNameT&& value) {
    ...
    m_groupLongName = std::forward<GroupLongNameT>(value);
  }
  template <typename GroupLongNameT = Aws::String>
  AvailabilityZone& WithGroupLongName(GroupLongNameT&& value) {
    SetGroupLongName(std::forward<GroupLongNameT>(value));
    return *this;
  }
  ///@}
  ...
  inline void SetState(AvailabilityZoneState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AvailabilityZone& WithState(AvailabilityZoneState value) {
    SetState(value);
    return *this;
  }
  ///@}
