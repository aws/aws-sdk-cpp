...
class AttachVerifiedAccessTrustProviderRequest : public EC2Request {
 ...
 public:
  ...
  template <typename VerifiedAccessInstanceIdT = Aws::String>
  AttachVerifiedAccessTrustProviderRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) {
  ...
  template <typename VerifiedAccessTrustProviderIdT = Aws::String>
  AttachVerifiedAccessTrustProviderRequest& WithVerifiedAccessTrustProviderId(VerifiedAccessTrustProviderIdT&& value) {
  ...
  template <typename ClientTokenT = Aws::String>
  AttachVerifiedAccessTrustProviderRequest& WithClientToken(ClientTokenT&& value) {
  ...
  inline AttachVerifiedAccessTrustProviderRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
