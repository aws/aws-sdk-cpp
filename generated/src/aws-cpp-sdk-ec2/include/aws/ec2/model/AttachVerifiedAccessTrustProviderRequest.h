...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API AttachVerifiedAccessTrustProviderRequest() = default;
  ...
  public:
    ...
    template<typename VerifiedAccessInstanceIdT = Aws::String>
    AttachVerifiedAccessTrustProviderRequest& WithVerifiedAccessInstanceId(VerifiedAccessInstanceIdT&& value) { SetVerifiedAccessInstanceId(std::forward<VerifiedAccessInstanceIdT>(value)); return *this;}
    ///@}
    ...
    template<typename VerifiedAccessTrustProviderIdT = Aws::String>
    AttachVerifiedAccessTrustProviderRequest& WithVerifiedAccessTrustProviderId(VerifiedAccessTrustProviderIdT&& value) { SetVerifiedAccessTrustProviderId(std::forward<VerifiedAccessTrustProviderIdT>(value)); return *this;}
    ///@}
    ...
    template<typename ClientTokenT = Aws::String>
    AttachVerifiedAccessTrustProviderRequest& WithClientToken(ClientTokenT&& value) { SetClientToken(std::forward<ClientTokenT>(value)); return *this;}
    ///@}
