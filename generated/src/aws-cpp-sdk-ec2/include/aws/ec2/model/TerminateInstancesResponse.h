...
class TerminateInstancesResponse {
 public:
  ...
  void SetTerminatingInstances(TerminatingInstancesT&& value) {
    m_terminatingInstancesHasBeenSet = true;
    m_terminatingInstances = std::forward<TerminatingInstancesT>(value);
  }
  template <typename TerminatingInstancesT = Aws::Vector<InstanceStateChange>>
  TerminateInstancesResponse& WithTerminatingInstances(TerminatingInstancesT&& value) {
    SetTerminatingInstances(std::forward<TerminatingInstancesT>(value));
    return *this;
  }
  template <typename TerminatingInstancesT = InstanceStateChange>
  TerminateInstancesResponse& AddTerminatingInstances(TerminatingInstancesT&& value) {
    m_terminatingInstancesHasBeenSet = true;
    m_terminatingInstances.emplace_back(std::forward<TerminatingInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  TerminateInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
