...
class AssociateSecurityGroupVpcResponse {
 public:
  ...
  inline void SetState(SecurityGroupVpcAssociationState value) {
    m_stateHasBeenSet = true;
    m_state = value;
  }
  inline AssociateSecurityGroupVpcResponse& WithState(SecurityGroupVpcAssociationState value) {
    SetState(value);
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateSecurityGroupVpcResponse& WithResponseMetadata(ResponseMetadataT&& value) {
