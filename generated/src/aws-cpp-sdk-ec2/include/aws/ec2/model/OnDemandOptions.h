...
class OnDemandOptions {
 public:
  ...
  inline void SetAllocationStrategy(FleetOnDemandAllocationStrategy value) {
    m_allocationStrategyHasBeenSet = true;
    m_allocationStrategy = value;
  }
  inline OnDemandOptions& WithAllocationStrategy(FleetOnDemandAllocationStrategy value) {
  ...
  inline OnDemandOptions& WithSingleInstanceType(bool value) {
  ...
  inline OnDemandOptions& WithSingleAvailabilityZone(bool value) {
  ...
  inline OnDemandOptions& WithMinTargetCapacity(int value) {
