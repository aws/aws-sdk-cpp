...
class AssociateTrunkInterfaceResponse {
 public:
  ...
  void SetInterfaceAssociation(InterfaceAssociationT&& value) {
    m_interfaceAssociationHasBeenSet = true;
    m_interfaceAssociation = std::forward<InterfaceAssociationT>(value);
  }
  template <typename InterfaceAssociationT = TrunkInterfaceAssociation>
  AssociateTrunkInterfaceResponse& WithInterfaceAssociation(InterfaceAssociationT&& value) {
    SetInterfaceAssociation(std::forward<InterfaceAssociationT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ClientTokenT = Aws::String>
  AssociateTrunkInterfaceResponse& WithClientToken(ClientTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  AssociateTrunkInterfaceResponse& WithResponseMetadata(ResponseMetadataT&& value) {
