...
class DescribeFleetsResponse {
 public:
  ...
  template <typename NextTokenT = Aws::String>
  DescribeFleetsResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename FleetsT = Aws::Vector<FleetData>>
  DescribeFleetsResponse& WithFleets(FleetsT&& value) {
    SetFleets(std::forward<FleetsT>(value));
    return *this;
  }
  template <typename FleetsT = FleetData>
  DescribeFleetsResponse& AddFleets(FleetsT&& value) {
    m_fleetsHasBeenSet = true;
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeFleetsResponse& WithResponseMetadata(ResponseMetadataT&& value) {
