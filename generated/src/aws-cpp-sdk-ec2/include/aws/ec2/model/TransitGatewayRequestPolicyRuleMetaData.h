...
/**
 * <p>A metadata key-value pair for a transit gateway policy rule.</p><p><h3>See
 * Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TransitGatewayRequestPolicyRuleMetaData">AWS
 * API Reference</a></p>
 */
class TransitGatewayRequestPolicyRuleMetaData {
 public:
  AWS_EC2_API TransitGatewayRequestPolicyRuleMetaData() = default;
  AWS_EC2_API TransitGatewayRequestPolicyRuleMetaData(const Aws::Utils::Xml::XmlNode& xmlNode);
  AWS_EC2_API TransitGatewayRequestPolicyRuleMetaData& operator=(const Aws::Utils::Xml::XmlNode& xmlNode);
  ...
  template <typename MetaDataKeyT = Aws::String>
  TransitGatewayRequestPolicyRuleMetaData& WithMetaDataKey(MetaDataKeyT&& value) {
  ...
  template <typename MetaDataValueT = Aws::String>
  TransitGatewayRequestPolicyRuleMetaData& WithMetaDataValue(MetaDataValueT&& value) {
