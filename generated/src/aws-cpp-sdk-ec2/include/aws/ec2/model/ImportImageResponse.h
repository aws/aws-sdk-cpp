...
class ImportImageResponse {
 public:
  ...
  inline ImportImageResponse& WithEncrypted(bool value) {
    SetEncrypted(value);
    return *this;
  }
  ///@}
  ...
  void SetHypervisor(HypervisorT&& value) {
    ...
    m_hypervisor = std::forward<HypervisorT>(value);
  }
  template <typename HypervisorT = Aws::String>
  ImportImageResponse& WithHypervisor(HypervisorT&& value) {
    SetHypervisor(std::forward<HypervisorT>(value));
    return *this;
  }
  ///@}
