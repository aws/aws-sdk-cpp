...
namespace Model
{
  ...
  public:
     ...
     * error.</p>
     */
    inline StartVpcEndpointServicePrivateDnsVerificationResponse& WithReturnValue(bool value) { SetReturnValue(value); return *this;}
    ...
    inline StartVpcEndpointServicePrivateDnsVerificationResponse& WithResponseMetadata(const ResponseMetadata& value) { SetResponseMetadata(value); return *this;}

    
    inline StartVpcEndpointServicePrivateDnsVerificationResponse& WithResponseMetadata(ResponseMetadata&& value) { SetResponseMetadata(std::move(value)); return *this;}
