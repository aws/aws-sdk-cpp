...
namespace Model
{
  ...
  {
  public:
    AWS_EC2_API StartVpcEndpointServicePrivateDnsVerificationResponse() = default;
    ...
    template<typename ResponseMetadataT = ResponseMetadata>
    StartVpcEndpointServicePrivateDnsVerificationResponse& WithResponseMetadata(ResponseMetadataT&& value) { SetResponseMetadata(std::forward<ResponseMetadataT>(value)); return *this;}
    ///@}
  private:
