...
class StartVpcEndpointServicePrivateDnsVerificationResponse {
 public:
  ...
  AWS_EC2_API StartVpcEndpointServicePrivateDnsVerificationResponse& operator=(
      const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  inline StartVpcEndpointServicePrivateDnsVerificationResponse& WithReturnValue(bool value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartVpcEndpointServicePrivateDnsVerificationResponse& WithResponseMetadata(ResponseMetadataT&& value) {
