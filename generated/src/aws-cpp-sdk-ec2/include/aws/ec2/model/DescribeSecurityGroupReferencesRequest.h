...
class DescribeSecurityGroupReferencesRequest : public EC2Request {
 ...
 public:
  ...
  inline DescribeSecurityGroupReferencesRequest& WithDryRun(bool value) {
    SetDryRun(value);
    return *this;
  }
  ///@}
  ...
  template <typename GroupIdT = Aws::Vector<Aws::String>>
  DescribeSecurityGroupReferencesRequest& WithGroupId(GroupIdT&& value) {
    SetGroupId(std::forward<GroupIdT>(value));
    return *this;
  }
  template <typename GroupIdT = Aws::String>
  DescribeSecurityGroupReferencesRequest& AddGroupId(GroupIdT&& value) {
    m_groupIdHasBeenSet = true;
    m_groupId.emplace_back(std::forward<GroupIdT>(value));
    return *this;
  }
  ///@}
 private:
