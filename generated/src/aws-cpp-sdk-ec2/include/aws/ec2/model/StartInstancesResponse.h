...
class StartInstancesResponse {
 public:
  ...
  void SetStartingInstances(StartingInstancesT&& value) {
    m_startingInstancesHasBeenSet = true;
    m_startingInstances = std::forward<StartingInstancesT>(value);
  }
  template <typename StartingInstancesT = Aws::Vector<InstanceStateChange>>
  StartInstancesResponse& WithStartingInstances(StartingInstancesT&& value) {
    SetStartingInstances(std::forward<StartingInstancesT>(value));
    return *this;
  }
  template <typename StartingInstancesT = InstanceStateChange>
  StartInstancesResponse& AddStartingInstances(StartingInstancesT&& value) {
    m_startingInstancesHasBeenSet = true;
    m_startingInstances.emplace_back(std::forward<StartingInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  StartInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
