...
class DescribeVerifiedAccessInstancesResponse {
 public:
  ...
  void SetVerifiedAccessInstances(VerifiedAccessInstancesT&& value) {
    m_verifiedAccessInstancesHasBeenSet = true;
    m_verifiedAccessInstances = std::forward<VerifiedAccessInstancesT>(value);
  }
  template <typename VerifiedAccessInstancesT = Aws::Vector<VerifiedAccessInstance>>
  DescribeVerifiedAccessInstancesResponse& WithVerifiedAccessInstances(VerifiedAccessInstancesT&& value) {
    SetVerifiedAccessInstances(std::forward<VerifiedAccessInstancesT>(value));
    return *this;
  }
  template <typename VerifiedAccessInstancesT = VerifiedAccessInstance>
  DescribeVerifiedAccessInstancesResponse& AddVerifiedAccessInstances(VerifiedAccessInstancesT&& value) {
    m_verifiedAccessInstancesHasBeenSet = true;
    m_verifiedAccessInstances.emplace_back(std::forward<VerifiedAccessInstancesT>(value));
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  DescribeVerifiedAccessInstancesResponse& WithNextToken(NextTokenT&& value) {
  ...
  template <typename ResponseMetadataT = ResponseMetadata>
  DescribeVerifiedAccessInstancesResponse& WithResponseMetadata(ResponseMetadataT&& value) {
